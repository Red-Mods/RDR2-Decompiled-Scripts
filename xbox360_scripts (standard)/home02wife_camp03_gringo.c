	...
	if (SQUAD_IS_VALID(bParam2))
	{
		...
		while (bVar0 <= SQUAD_GET_SIZE(bParam2))
		{
			...
			if (IS_ACTOR_VALID(bVar5))
			{
				...
				{
					if (Function_16(GET_OBJECT_FROM_GRINGO(fVar6), bParam4))
					{
...
void Function_10(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0x9F5 / 2549
{
	bool bVar0;
	bool bVar1;
...
bool Function_49(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2B89 / 11145
{
...
void Function_58(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2E97 / 11927
{
	bool bVar0;
	bool bVar1;
...
void Function_79() //Position: 0x37A1 / 14241
{
	...
	{
		SNAP_ACTOR_TO_GRINGO(bLocal_3, GET_OBJECT_FROM_GRINGO(bLocal_5), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(bLocal_3, bLocal_5, "UseCase1", 4294967295, 1);
		Function_34(51);
	}
	else
	{
		TASK_GO_NEAR_COORD(bLocal_3, &vLocal_6, 2.0f, true);
	}
...
void Function_88(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4149 / 16713
{
	bool bVar0;
...
bool Function_89(bool bParam0, bool bParam1) //Position: 0x419D / 16797
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_94(int iParam0, bool bParam1) //Position: 0x434D / 17229
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_102(int iParam0) //Position: 0x4646 / 17990
{
	bool bVar0;
	bool bVar1;
...
bool Function_103(int iParam0) //Position: 0x4740 / 18240
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x4ABB / 19131
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x4AFB / 19195
{
	int iVar0;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4B26 / 19238
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_107() //Position: 0x4B37 / 19255
{
	if (!Function_151(128))
	{
		return;
...
void Function_108(int iParam0, bool bParam1) //Position: 0x4B79 / 19321
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4BFD / 19453
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C26 / 19494
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x4C77 / 19575
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x4C87 / 19591
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4C9B / 19611
{
	int iVar0;
...
var Function_114() //Position: 0x4CC0 / 19648
{
	return "PackedMetadata";
}

void Function_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CD7 / 19671
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_116() //Position: 0x4DFD / 19965
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_117() //Position: 0x4E0E / 19982
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_118() //Position: 0x4E1F / 19999
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_119(var uParam0, int iParam1) //Position: 0x4E30 / 20016
{
...
var Function_120(var uParam0, int iParam1, bool bParam2) //Position: 0x4E53 / 20051
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x4E72 / 20082
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122() //Position: 0x4E7E / 20094
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x4E89 / 20105
{
	int iVar0;
...
var Function_124() //Position: 0x4EB7 / 20151
{
	return "PackedWeapon";
}

int Function_125(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4ECC / 20172
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_126() //Position: 0x4FD0 / 20432
{
	return "MPItemGiver";
}

struct<32> Function_127(bool bParam0) //Position: 0x4FE4 / 20452
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0, char* cParam1, char* cParam2) //Position: 0x504E / 20558
{
	char* cVar0[32];
...
var Function_129() //Position: 0x506D / 20589
{
	return "PBox_";
}

var Function_130() //Position: 0x507B / 20603
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x50A1 / 20641
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x50C9 / 20681
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x50EF / 20719
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5250 / 21072
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x52EB / 21227
{
	int iVar0;
	vector3 vVar1;
...
void Function_136(int iParam0) //Position: 0x544C / 21580
{
...
var Function_137() //Position: 0x54AD / 21677
{
	int iVar0;
...
var Function_138(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54B5 / 21685
{
	return Function_139(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_139(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x54CE / 21710
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x57C1 / 22465
{
	int iVar0;
...
void Function_141() //Position: 0x5875 / 22645
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x58AF / 22703
{
	int iVar0;
...
void Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58DC / 22748
{
	bool bVar0;
...
void Function_144() //Position: 0x5A2D / 23085
{
	int iVar0;
...
var Function_145(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A78 / 23160
{
	int iVar0;
...
int Function_146() //Position: 0x5B48 / 23368
{
	int iVar0;
...
int Function_147() //Position: 0x5CA4 / 23716
{
	int iVar0;
...
bool Function_148(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DC4 / 24004
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_149(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5E94 / 24212
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_150(bool bParam0) //Position: 0x5FC6 / 24518
{
	bool bVar0;
...
bool Function_151(int iParam0) //Position: 0x5FE5 / 24549
{
	int iVar0;
...
int Function_152() //Position: 0x6001 / 24577
{
	if (Function_154())
	{
...
int Function_153() //Position: 0x601A / 24602
{
	return Global_79349.f_16;
}

bool Function_154() //Position: 0x6026 / 24614
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_155(int iParam0, bool bParam1, bool bParam2) //Position: 0x602F / 24623
{
	var uVar0;
...
var Function_156(var uParam0, int iParam1, int iParam2) //Position: 0x60AC / 24748
{
	int iVar0;
