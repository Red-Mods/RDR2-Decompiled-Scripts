...
bool Function_26(var uParam0, bool bParam1) //Position: 0x1D06 / 7430
{
	bParam1 = bParam1;
	uParam0 = uParam0;
...
bool Function_27(bool bParam0) //Position: 0x1D2E / 7470
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D4D / 7501
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D53 / 7507
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D61 / 7521
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D6C / 7532
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D86 / 7558
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DA4 / 7588
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DC3 / 7619
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DF6 / 7670
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E15 / 7701
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E2F / 7727
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E42 / 7746
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x212A / 8490
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2132 / 8498
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x214F / 8527
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x215E / 8542
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2180 / 8576
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21A4 / 8612
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21C1 / 8641
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21E1 / 8673
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2201 / 8705
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22AF / 8879
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x231F / 8991
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2335 / 9013
{
...
var Function_51(bool bParam0) //Position: 0x2356 / 9046
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2376 / 9078
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x238A / 9098
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2394 / 9108
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x239B / 9115
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23AA / 9130
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23E9 / 9193
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2414 / 9236
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x241F / 9247
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2515 / 9493
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2537 / 9527
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x255E / 9566
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x281D / 10269
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x287A / 10362
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28D7 / 10455
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28E1 / 10465
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28FF / 10495
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2914 / 10516
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x299B / 10651
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29BE / 10686
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29DC / 10716
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29FF / 10751
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B1A / 11034
{
...
int Function_74(bool bParam0) //Position: 0x2B45 / 11077
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C4A / 11338
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C57 / 11351
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CCA / 11466
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31C8 / 12744
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x31FF / 12799
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x321C / 12828
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3254 / 12884
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x325E / 12894
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, bool bParam1) //Position: 0x327F / 12927
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bParam1 = bParam1;
	bParam0 = bParam0;
	if (iLocal_0 && IS_ACTOR_VALID(bParam0))
	{
		if (IS_ACTOR_ALIVE(bParam0))
		{
			bVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
			if (STRING_CONTAINS_STRING(bVar0, "leanWall"))
			{
				if (GRINGO_COMPONENT_CHECK_NAME("UseCase1", bParam1))
				{
					...
					{
						bVar2 = RAND_INT_RANGE_DIFFERENT(bVar1, true, 3);
						SET_CRIPPLE_FLAG(bParam0, bVar1);
						SET_CRIPPLE_FLAG(bParam0, bVar2);
					}
					else
					{
						bVar2 = 4294967295;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36DD / 14045
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x36EB / 14059
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3704 / 14084
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x371E / 14110
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3756 / 14166
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x376D / 14189
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A36 / 14902
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A53 / 14931
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3AEF / 15087
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B0E / 15118
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B1D / 15133
{
...
void Function_98(int iParam0) //Position: 0x3B39 / 15161
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B43 / 15171
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BA5 / 15269
{
...
void Function_101(int iParam0) //Position: 0x3BB9 / 15289
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BC3 / 15299
{
