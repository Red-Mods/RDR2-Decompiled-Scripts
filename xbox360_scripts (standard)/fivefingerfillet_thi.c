...
bool Function_20() //Position: 0x9E1 / 2529
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30668[1], &iLocal_24 + 4, &iLocal_24 + 24, &iLocal_24 + 28))
			{
				Function_26(&(Global_30668[1]));
				Function_25(&iLocal_24 + 4);
				Function_19(Global_30668[1]);
				*(&iLocal_24 + 156[03]) = { StackVal, StackVal, Function_19(Global_30668[1]) };
				Function_18(Global_30668[1]);
				*(&iLocal_24 + 156[13]) = { StackVal, StackVal, Function_18(Global_30668[1]) };
				iLocal_24 = Local_5;
...
int Function_29() //Position: 0x11F9 / 4601
{
	return Function_30(0);
}

int Function_30(int iParam0) //Position: 0x1203 / 4611
{
...
var Function_31(int iParam0) //Position: 0x1244 / 4676
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_32(int iParam0) //Position: 0x125E / 4702
{
...
int Function_33(var uParam0, int iParam1) //Position: 0x127A / 4730
{
	int iVar0;
...
bool Function_34(int iParam0) //Position: 0x1296 / 4758
{
...
void Function_35() //Position: 0x12AC / 4780
{
	Function_1();
	return;
}

void Function_36() //Position: 0x12B5 / 4789
{
...
void Function_37(int iParam0) //Position: 0x1301 / 4865
{
...
void Function_38(var uParam0, float fParam1) //Position: 0x1316 / 4886
{
...
void Function_39(var uParam0, int iParam1) //Position: 0x1337 / 4919
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_40(var uParam0, int iParam1) //Position: 0x134A / 4938
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_41(int iParam0) //Position: 0x1359 / 4953
{
	return Function_42(*iParam0, 1);
}

int Function_42(var uParam0, bool bParam1) //Position: 0x1366 / 4966
{
	return (uParam0 && bParam1) == 0;
}

void Function_43() //Position: 0x1373 / 4979
{
	return;
}

void Function_44(bool bParam0, bool bParam1) //Position: 0x1379 / 4985
{
	bool bVar0;
...
void Function_45(var uParam0) //Position: 0x13D0 / 5072
{
	int iVar0;
...
var Function_46() //Position: 0x13ED / 5101
{
	var uVar0;
