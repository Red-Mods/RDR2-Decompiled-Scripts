...
void Function_3() //Position: 0x1F9 / 505
{
	...
	Function_4(6, uLocal_5, uVar0, iLocal_6, 4294967295);
	return;
}
...
void Function_13(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA56 / 2646
{
	bool bVar0;
	bool bVar1;
...
bool Function_44(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2A29 / 10793
{
...
void Function_53(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2D37 / 11575
{
	bool bVar0;
	bool bVar1;
	...
	if (Function_79(&uLocal_5, 29, 1))
	{
		...
		if (IS_DOOR_VALID(bLocal_3) && IS_DOOR_VALID(bLocal_4))
		{
			if (Function_75(&bLocal_7, "mexarmy04mobile", iParam1))
			{
				...
				iLocal_6 = CREATE_LAYOUT(Function_132());
				return 1;
			}
		}
	}
...
bool Function_75(var uParam0, bool bParam1, int iParam2) //Position: 0x36F4 / 14068
{
...
void Function_83(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3F03 / 16131
{
	bool bVar0;
...
bool Function_84(bool bParam0, bool bParam1) //Position: 0x3F57 / 16215
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_89(int iParam0, bool bParam1) //Position: 0x410A / 16650
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(int iParam0) //Position: 0x4477 / 17527
{
	bool bVar0;
	bool bVar1;
...
bool Function_98(int iParam0) //Position: 0x4571 / 17777
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x48EC / 18668
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x492C / 18732
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x4957 / 18775
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x4968 / 18792
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x49AA / 18858
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4A2E / 18990
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4A57 / 19031
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4AA8 / 19112
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4AB8 / 19128
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4ACC / 19148
{
	int iVar0;
...
var Function_109() //Position: 0x4AF1 / 19185
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4B08 / 19208
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4C2E / 19502
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4C3F / 19519
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4C50 / 19536
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4C61 / 19553
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4C84 / 19588
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4CA3 / 19619
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4CAF / 19631
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x4CBA / 19642
{
	int iVar0;
...
var Function_119() //Position: 0x4CE8 / 19688
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4CFD / 19709
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4E01 / 19969
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4E15 / 19989
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4E7F / 20095
{
	char* cVar0[32];
...
var Function_124() //Position: 0x4E9E / 20126
{
	return "PBox_";
}

var Function_125() //Position: 0x4EAC / 20140
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x4ED2 / 20178
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x4EFA / 20218
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x4F20 / 20256
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5081 / 20609
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x511C / 20764
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x527D / 21117
{
...
var Function_132() //Position: 0x52DE / 21214
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x52E6 / 21222
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x52FF / 21247
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x55F2 / 22002
{
	int iVar0;
...
void Function_136() //Position: 0x56A6 / 22182
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x56E0 / 22240
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x570D / 22285
{
	bool bVar0;
...
void Function_139() //Position: 0x585E / 22622
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x58A9 / 22697
{
	int iVar0;
...
int Function_141() //Position: 0x5979 / 22905
{
	int iVar0;
...
int Function_142() //Position: 0x5AD5 / 23253
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5BF5 / 23541
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5CC5 / 23749
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5CE3 / 23779
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5E15 / 24085
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x5E34 / 24116
{
	int iVar0;
...
int Function_148() //Position: 0x5E50 / 24144
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x5E69 / 24169
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x5E75 / 24181
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x5E7E / 24190
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x5EFB / 24315
{
	int iVar0;
