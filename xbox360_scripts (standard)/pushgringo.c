	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_41(iParam0, bVar8, &iLocal_79, &bLocal_78);
...
bool Function_26(bool bParam0, bool bParam1) //Position: 0x1D01 / 7425
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
float Function_27(bool bParam0) //Position: 0x1DE3 / 7651
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_28(bool bParam0) //Position: 0x1DEE / 7662
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_29(bool bParam0) //Position: 0x1EE4 / 7908
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_30(bool bParam0) //Position: 0x1F06 / 7942
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_31() //Position: 0x1F25 / 7973
{
	return;
}

void Function_32(var uParam0, int iParam1) //Position: 0x1F2B / 7979
{
	bool bVar0;
	vector3 vVar1;
	
	bVar0 = GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT());
	vVar1 = { 0.0f, 0.0f, 0.0f };
	SET_PROP_VELOCITY_ON_AXIS(bVar0, &vVar1, 2);
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
}

bool Function_33(int iParam0) //Position: 0x1F51 / 8017
{
	iParam0 = iParam0;
	return 1;
}

bool Function_34(bool bParam0) //Position: 0x1F5C / 8028
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_35(bool bParam0, int iParam1) //Position: 0x1F76 / 8054
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_36(bool bParam0) //Position: 0x1F94 / 8084
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1FB3 / 8115
{
	int iVar0;
	int iVar1;
...
bool Function_38(bool bParam0) //Position: 0x1FE6 / 8166
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_39(bool bParam0) //Position: 0x2005 / 8197
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x201F / 8223
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_41(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2032 / 8242
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	PRINTNL();
	bVar2 = Function_49(uParam0->f_12, &bVar0);
...
var Function_42() //Position: 0x231A / 8986
{
	int iVar0;
...
bool Function_43(bool bParam0, bool bParam1) //Position: 0x2322 / 8994
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_44() //Position: 0x233F / 9023
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x234E / 9038
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2370 / 9072
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_47(bool bParam0) //Position: 0x2394 / 9108
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x23B1 / 9137
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x23D1 / 9169
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x23F1 / 9201
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_51(bool bParam0, bool bParam1, bool bParam2) //Position: 0x249F / 9375
{
	bool bVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x250F / 9487
{
	if (!Function_14(iParam0))
	{
...
void Function_53(int iParam0, float fParam1) //Position: 0x2525 / 9509
{
...
var Function_54(bool bParam0) //Position: 0x2546 / 9542
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_55(int iParam0) //Position: 0x2566 / 9574
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_56(var uParam0) //Position: 0x257A / 9594
{
	uParam0 = uParam0;
	return;
}

int Function_57() //Position: 0x2584 / 9604
{
	return 1;
}

void Function_58(var uParam0, int iParam1) //Position: 0x258B / 9611
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_59(bool bParam0, var uParam1, int iParam2) //Position: 0x259A / 9626
{
	bool bVar0;
...
bool Function_60(bool bParam0) //Position: 0x25D9 / 9689
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

bool Function_61(bool bParam0) //Position: 0x2604 / 9732
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x262B / 9771
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x28EA / 10474
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2947 / 10567
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x29A4 / 10660
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x29AE / 10670
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x29CC / 10700
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x29E1 / 10721
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_69(bool bParam0, int iParam1) //Position: 0x29F0 / 10736
{
...
int Function_70(bool bParam0) //Position: 0x2A1B / 10779
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B20 / 11040
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(int iParam0) //Position: 0x2B2D / 11053
{
	if (Function_71(iParam0->f_40, 16))
	{
...
void Function_73(int iParam0, bool bParam1) //Position: 0x2BA0 / 11168
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x309E / 12446
{
	bool bVar0;
...
bool Function_75(bool bParam0) //Position: 0x30D5 / 12501
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_76(var uParam0, int iParam1) //Position: 0x30F2 / 12530
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x312A / 12586
{
	iParam0 = iParam0;
	return;
}

bool Function_78(bool bParam0) //Position: 0x3134 / 12596
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_79(var uParam0, int iParam1) //Position: 0x3155 / 12629
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x3163 / 12643
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x326B / 12907
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_82(int iParam0) //Position: 0x3281 / 12929
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3537 / 13623
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_84(bool bParam0) //Position: 0x358D / 13709
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_85(bool bParam0) //Position: 0x35A6 / 13734
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_86(bool bParam0, int iParam1) //Position: 0x35C0 / 13760
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x35F8 / 13816
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_88(int iParam0, int iParam1) //Position: 0x360F / 13839
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_89(bool bParam0) //Position: 0x38D8 / 14552
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_90(bool bParam0, bool bParam1) //Position: 0x38F5 / 14581
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_91(int iParam0) //Position: 0x3991 / 14737
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x39B0 / 14768
{
	float fVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_93(int iParam0) //Position: 0x3A32 / 14898
{
...
void Function_94(int iParam0) //Position: 0x3A4E / 14926
{
	iParam0 = iParam0;
	return;
}

void Function_95(bool bParam0, int iParam1) //Position: 0x3A58 / 14936
{
	bool bVar0;
	bool bVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x3ABA / 15034
{
...
void Function_97(int iParam0) //Position: 0x3ACE / 15054
{
	iParam0 = iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x3AD8 / 15064
{
