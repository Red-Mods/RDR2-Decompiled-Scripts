...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 228) = 2;
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			bVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, bVar1, 0, 0, "ped_bad_guys_generic", 5,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(bVar0);
...
void Function_11(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1484 / 5252
{
	bool bVar0;
	bool bVar1;
...
bool Function_24(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x1BA5 / 7077
{
...
void Function_26(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1C13 / 7187
{
	bool bVar0;
	bool bVar1;
...
void Function_34(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x1F1D / 7965
{
	bool bVar0;
	bool bVar1;
...
var Function_56(var uParam0, var uParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x2814 / 10260
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_64(var uParam0, bool bParam1, int iParam2) //Position: 0x2F64 / 12132
{
	int iVar0;
...
vector3 Function_78() //Position: 0x371D / 14109
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_79() //Position: 0x372E / 14126
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_80() //Position: 0x373F / 14143
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_81(var uParam0, int iParam1) //Position: 0x3750 / 14160
{
...
var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x3773 / 14195
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x3792 / 14226
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x379E / 14238
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x37A9 / 14249
{
	int iVar0;
...
var Function_86() //Position: 0x37D7 / 14295
{
	return "PackedWeapon";
}

int Function_87(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x37EC / 14316
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_88() //Position: 0x38F0 / 14576
{
	return "MPItemGiver";
}

struct<32> Function_89(bool bParam0) //Position: 0x3904 / 14596
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0, char* cParam1, char* cParam2) //Position: 0x396E / 14702
{
	char* cVar0[32];
...
var Function_91() //Position: 0x398D / 14733
{
	return "PBox_";
}

var Function_92() //Position: 0x399B / 14747
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x39C1 / 14785
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x39E9 / 14825
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3A0F / 14863
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3B70 / 15216
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x3C0B / 15371
{
	int iVar0;
	vector3 vVar1;
...
void Function_98(int iParam0) //Position: 0x3D6C / 15724
{
...
var Function_99() //Position: 0x3DCD / 15821
{
	int iVar0;
...
var Function_100(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3DD5 / 15829
{
	return Function_101(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_101(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x3DEE / 15854
{
	bool bVar0;
	bool bVar1;
	int iVar2;
