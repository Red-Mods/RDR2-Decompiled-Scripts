...
int Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x1C4A / 7242
{
	return Function_76(Global_29006, uParam0, uParam1, iParam2);
}

int Function_76(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x1C5C / 7260
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
void Function_77() //Position: 0x1CF8 / 7416
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
void Function_78(int iParam0, int iParam1) //Position: 0x2172 / 8562
{
	switch (iParam1)
	{
		case 0x00000000:
