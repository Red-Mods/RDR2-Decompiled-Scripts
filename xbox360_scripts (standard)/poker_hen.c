...
void Function_18() //Position: 0x5B0 / 1456
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5B9 / 1465
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x5DA / 1498
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x610 / 1552
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x62B / 1579
{
...
vector3 Function_23(int iParam0) //Position: 0x725 / 1829
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x81F / 2079
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xD99 / 3481
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xDEE / 3566
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF00 / 3840
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x10EF / 4335
{
...
bool Function_29() //Position: 0x11A5 / 4517
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11BC / 4540
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11C7 / 4551
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x11D5 / 4565
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x11E2 / 4578
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1224 / 4644
{
	return Function_35(0);
}

int Function_35(int iParam0) //Position: 0x122E / 4654
{
...
var Function_36(int iParam0) //Position: 0x126F / 4719
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_37() //Position: 0x1289 / 4745
{
	Function_1();
	return;
}

void Function_38() //Position: 0x1292 / 4754
{
...
void Function_39(int iParam0) //Position: 0x12E1 / 4833
{
...
void Function_40(var uParam0, float fParam1) //Position: 0x12F6 / 4854
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x1317 / 4887
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x132A / 4906
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0x1339 / 4921
{
	return Function_44(*iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0x1346 / 4934
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x1353 / 4947
{
	return;
}

void Function_46() //Position: 0x1359 / 4953
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x135F / 4959
{
	bool bVar0;
...
void Function_48(var uParam0) //Position: 0x13B6 / 5046
{
	int iVar0;
...
var Function_49() //Position: 0x13D3 / 5075
{
	var uVar0;
