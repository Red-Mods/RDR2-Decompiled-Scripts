...
void Function_17() //Position: 0x4A7 / 1191
{
	...
	SET_ACTOR_INVULNERABILITY(Function_18(), false);
...
void Function_37(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x109D / 4253
{
	struct<13> Var0;
...
void Function_43(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x1264 / 4708
{
	int iVar0;
...
void Function_44() //Position: 0x12AF / 4783
{
	switch (iLocal_5)
	{
		case 0x00000000:
...
void Function_45() //Position: 0x131F / 4895
{
	switch (iLocal_5)
	{
		case 0x00000006:
