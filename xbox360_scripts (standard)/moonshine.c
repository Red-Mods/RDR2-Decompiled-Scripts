...
void Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x2309 / 8969
{
	...
	*iParam2 = 0;
	...
	{
		Function_53("already_moonshine", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_53(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x246B / 9323
{
	int iVar0;
...
int Function_54(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x24B6 / 9398
{
	int iVar0;
	int iVar1;
...
int Function_55(bool bParam0, bool bParam1, bool bParam2) //Position: 0x26D6 / 9942
{
...
bool Function_56() //Position: 0x278C / 10124
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_57(bool bParam0) //Position: 0x27A3 / 10147
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_58(bool bParam0) //Position: 0x27AE / 10158
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_59(bool bParam0) //Position: 0x27BC / 10172
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_60(int iParam0, bool bParam1) //Position: 0x27D6 / 10198
{
	bool bVar0;
	bool bVar1;
