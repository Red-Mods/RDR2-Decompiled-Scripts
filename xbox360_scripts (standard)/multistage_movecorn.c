...
void Function_94(bool bParam0, bool bParam1) //Position: 0x3C47 / 15431
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_95(bool bParam0, bool bParam1) //Position: 0x3D53 / 15699
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_96(bool bParam0, bool bParam1) //Position: 0x3E5B / 15963
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_97(int iParam0) //Position: 0x3E71 / 15985
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_98(var uParam0, int iParam1) //Position: 0x4129 / 16681
{
	uParam0 = uParam0;
	iParam1 = iParam1;
...
void Function_99(var uParam0, bool bParam1) //Position: 0x413D / 16701
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_100(bool bParam0) //Position: 0x41E9 / 16873
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_101(bool bParam0) //Position: 0x4202 / 16898
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_102(bool bParam0, int iParam1) //Position: 0x421C / 16924
{
	bool bVar0;
	int iVar1;
...
bool Function_103(var uParam0, int iParam1) //Position: 0x4254 / 16980
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_104(int iParam0, int iParam1) //Position: 0x426B / 17003
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_105(bool bParam0) //Position: 0x4534 / 17716
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_106(bool bParam0, bool bParam1) //Position: 0x4551 / 17745
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_107(int iParam0) //Position: 0x45ED / 17901
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_108(bool bParam0, int iParam1) //Position: 0x460C / 17932
{
	bool bVar0;
	struct<8> Var1;
	...
	if (DECOR_CHECK_EXIST(bParam0, "MoveObj_Dest"))
	{
		...
		Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_110("corngrpset") };
...
void Function_109(var uParam0, bool bParam1, bool bParam2) //Position: 0x4687 / 18055
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
struct<32> Function_110(bool bParam0) //Position: 0x477E / 18302
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_111(char* cParam0, char* cParam1, char* cParam2) //Position: 0x47E8 / 18408
{
	char* cVar0[32];
...
bool Function_112(int iParam0) //Position: 0x4807 / 18439
{
...
void Function_113(int iParam0) //Position: 0x4823 / 18467
{
	iParam0 = iParam0;
	return;
}

void Function_114(bool bParam0, int iParam1) //Position: 0x482D / 18477
{
	bool bVar0;
	bool bVar1;
...
void Function_115(int iParam0, int iParam1) //Position: 0x488F / 18575
{
...
void Function_116(int iParam0) //Position: 0x48A3 / 18595
{
	iParam0 = iParam0;
	return;
}

void Function_117(int iParam0) //Position: 0x48AD / 18605
{
