	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_79, &bLocal_78);
...
void Function_29(var uParam0, int iParam1) //Position: 0x1D37 / 7479
{
	...
	iVar3 = FIND_NEAREST_DOOR(&vVar0, 1.0f);
	OPEN_DOOR_DIRECTION(iVar3, true);
	SET_DOOR_CURRENT_SPEED(iVar3, 2.0f, 2.0f);
	return;
}

vector3 Function_30(bool bParam0) //Position: 0x1D64 / 7524
{
	vector3 vVar0;
...
bool Function_31(int iParam0) //Position: 0x1D8B / 7563
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1D96 / 7574
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DB0 / 7600
{
...
bool Function_36(bool bParam0) //Position: 0x1E20 / 7712
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1E3F / 7743
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1E59 / 7769
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E6C / 7788
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_40() //Position: 0x2154 / 8532
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x215C / 8540
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x2179 / 8569
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2188 / 8584
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x21AA / 8618
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x21CE / 8654
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21EB / 8683
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x220B / 8715
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x222B / 8747
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22D9 / 8921
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2349 / 9033
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x235F / 9055
{
...
var Function_52(bool bParam0) //Position: 0x2380 / 9088
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x23A0 / 9120
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x23B4 / 9140
{
	uParam0 = uParam0;
	return;
}

int Function_55() //Position: 0x23BE / 9150
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x23C5 / 9157
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x23D4 / 9172
{
	bool bVar0;
...
bool Function_58(bool bParam0) //Position: 0x2413 / 9235
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(bool bParam0) //Position: 0x243E / 9278
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_60(bool bParam0) //Position: 0x2449 / 9289
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_61(bool bParam0) //Position: 0x253F / 9535
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_62(bool bParam0) //Position: 0x2561 / 9569
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(bool bParam0) //Position: 0x2588 / 9608
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2847 / 10311
{
	vector3 vVar0;
...
vector3 Function_65(vector3 vParam0) //Position: 0x28A4 / 10404
{
	vector3 vVar0;
...
void Function_66(int iParam0) //Position: 0x2901 / 10497
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x290B / 10507
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2929 / 10537
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x293E / 10558
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x29C5 / 10693
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29E8 / 10728
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2A06 / 10758
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x2A29 / 10793
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2B44 / 11076
{
...
int Function_75(bool bParam0) //Position: 0x2B6F / 11119
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2C74 / 11380
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2C81 / 11393
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2CF4 / 11508
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x31F2 / 12786
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x3229 / 12841
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3246 / 12870
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x327E / 12926
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x3288 / 12936
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32A9 / 12969
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x32B7 / 12983
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x33BF / 13247
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x33D5 / 13269
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x368B / 13963
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_89(bool bParam0) //Position: 0x3699 / 13977
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x36B2 / 14002
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, int iParam1) //Position: 0x36CC / 14028
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3704 / 14084
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x371B / 14107
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x39E4 / 14820
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3A01 / 14849
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3A9D / 15005
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3ABC / 15036
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3ACB / 15051
{
...
void Function_99(int iParam0) //Position: 0x3AE7 / 15079
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3AF1 / 15089
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3B53 / 15187
{
...
void Function_102(int iParam0) //Position: 0x3B67 / 15207
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3B71 / 15217
{
