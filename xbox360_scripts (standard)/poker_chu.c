...
void Function_18() //Position: 0x5BD / 1469
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5C6 / 1478
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x5E7 / 1511
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x61D / 1565
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x638 / 1592
{
...
vector3 Function_23(int iParam0) //Position: 0x732 / 1842
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x82C / 2092
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xDA6 / 3494
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xDFB / 3579
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF0D / 3853
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x10FC / 4348
{
...
bool Function_29() //Position: 0x11B2 / 4530
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11C9 / 4553
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11D4 / 4564
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x11E2 / 4578
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x11EF / 4591
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1231 / 4657
{
	return Function_35(0);
}

int Function_35(int iParam0) //Position: 0x123B / 4667
{
...
var Function_36(int iParam0) //Position: 0x127C / 4732
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_37(int iParam0) //Position: 0x1296 / 4758
{
...
int Function_38(var uParam0, int iParam1) //Position: 0x12B2 / 4786
{
	int iVar0;
...
bool Function_39(int iParam0) //Position: 0x12CE / 4814
{
...
void Function_40() //Position: 0x12E4 / 4836
{
	Function_1();
	return;
}

void Function_41() //Position: 0x12ED / 4845
{
	bLocal_5 = CREATE_LAYOUT(Function_52());
	Function_50(0, 1);
	Function_49();
	Function_48();
...
void Function_42(int iParam0) //Position: 0x133C / 4924
{
...
void Function_43(var uParam0, float fParam1) //Position: 0x1351 / 4945
{
...
void Function_44(var uParam0, int iParam1) //Position: 0x1372 / 4978
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, int iParam1) //Position: 0x1385 / 4997
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_46(int iParam0) //Position: 0x1394 / 5012
{
	return Function_47(*iParam0, 1);
}

int Function_47(var uParam0, bool bParam1) //Position: 0x13A1 / 5025
{
	return (uParam0 && bParam1) == 0;
}

void Function_48() //Position: 0x13AE / 5038
{
	return;
}

void Function_49() //Position: 0x13B4 / 5044
{
	return;
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x13BA / 5050
{
	bool bVar0;
...
void Function_51(var uParam0) //Position: 0x1411 / 5137
{
	int iVar0;
...
var Function_52() //Position: 0x142E / 5166
{
	var uVar0;
