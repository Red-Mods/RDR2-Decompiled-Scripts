				...
				switch (iVar0)
				{
					case 0x00000000:
						if (Function_118(&uLocal_188) && IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								bLocal_193 = CREATE_GRINGO_IN_LAYOUT(bLocal_192, Function_117(), "RCM_AztecGold_Treasure", -546,032f, 16,218f, 3990,79f, 0.0f, 0.0f, 0.0f);
								CLEAR_AREA_OF_GRASS(*(&Global_63541[755] + 100), 1.0f);
								iVar0 = 5;
							}
					...
					case 0x00000006:
						...
						{
							Function_114("AztecGold4_SHORT", 0x40f00000, 1, 2, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "AztecGold4_OBJ", 0, 3, false);
							Function_113(Global_63541[ScriptParam_055].f_140, 0);
							Function_34(7, 1, 1, 0);
							Function_30(Function_32(1, 1, 1, 0, 0), 1);
							Function_9(Global_30707[0]);
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x296 / 662
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x2B1 / 689
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x2CE / 718
{
	RELEASE_LAYOUT_REF(bLocal_197);
	return;
}

void Function_4(int iParam0) //Position: 0x2D9 / 729
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x2FF / 767
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x42D / 1069
{
	int iVar0;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x447 / 1095
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x464 / 1124
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_9(int iParam0) //Position: 0x473 / 1139
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_10() //Position: 0x572 / 1394
{
	return NET_IS_MANAGER_INITIALIZED();
}

float Function_11(int iParam0) //Position: 0x57B / 1403
{
...
float Function_12(int iParam0) //Position: 0x5B8 / 1464
{
	if (!iParam0 != 4294967295)
	{
...
void Function_13(int iParam0, bool bParam1) //Position: 0x5F1 / 1521
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x658 / 1624
{
	int iVar0;
...
bool Function_15(int iParam0) //Position: 0x6B0 / 1712
{
...
int Function_16(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6C6 / 1734
{
	int iVar0;
	int iVar1;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x8E6 / 2278
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18(int iParam0) //Position: 0xF13 / 3859
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xF24 / 3876
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0, char* cParam1) //Position: 0x1019 / 4121
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1032 / 4146
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x1097 / 4247
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x10A9 / 4265
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x10BB / 4283
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x11EB / 4587
{
	return Global_35278[iParam020].f_48;
}

void Function_26(int iParam0) //Position: 0x11FA / 4602
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1394 / 5012
{
	int iVar0;
	int iVar1;
...
void Function_28(var uParam0, int iParam1) //Position: 0x15AE / 5550
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_29(var uParam0, int iParam1) //Position: 0x15BD / 5565
{
	int iVar0;
...
int Function_30(bool bParam0, bool bParam1) //Position: 0x15D9 / 5593
{
	bool bVar0;
...
int Function_31(int iParam0) //Position: 0x16A4 / 5796
{
	if (iParam0 == 4294967295)
	{
...
var Function_32(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x16E5 / 5861
{
	bool bVar0;
...
var Function_33(bool bParam0) //Position: 0x17E7 / 6119
{
	bool bVar0;
...
void Function_34(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x18D8 / 6360
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_35(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1E0D / 7693
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_36() //Position: 0x1F80 / 8064
{
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x1F86 / 8070
{
	if (Global_3381)
	{
		return;
...
void Function_38(bool bParam0) //Position: 0x1FC8 / 8136
{
...
void Function_39() //Position: 0x2019 / 8217
{
	Function_52();
	Function_51();
	Function_51();
...
void Function_41() //Position: 0x2152 / 8530
{
	float fVar0;
...
void Function_42() //Position: 0x2185 / 8581
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_43() //Position: 0x2313 / 8979
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_44() //Position: 0x24C7 / 9415
{
	Function_45(&Global_28260, 1, 0);
	return;
}

void Function_45(int iParam0, bool bParam1, var uParam2) //Position: 0x24D5 / 9429
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_46() //Position: 0x26C6 / 9926
{
...
struct<8> Function_47() //Position: 0x26DB / 9947
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_48(int iParam0, bool bParam1, bool bParam2) //Position: 0x2776 / 10102
{
	int iVar0;
...
struct<8> Function_49() //Position: 0x2A11 / 10769
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_50() //Position: 0x2A9A / 10906
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_51() //Position: 0x2B31 / 11057
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_52() //Position: 0x2BB0 / 11184
{
...
int Function_53(int iParam0, bool bParam1, int iParam2) //Position: 0x2BD6 / 11222
{
	int iVar0;
	int iVar1;
...
void Function_54() //Position: 0x2DE0 / 11744
{
	vector3 vVar0;
	var uVar3;
...
bool Function_55(vector3 vParam0) //Position: 0x2E81 / 11905
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_56(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2E99 / 11929
{
	int iVar0;
...
vector3 Function_57() //Position: 0x2F80 / 12160
{
...
int Function_59(bool bParam0, bool bParam1) //Position: 0x2F9F / 12191
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_60(vector3 vParam0, vector3 vParam3) //Position: 0x3066 / 12390
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_61(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3083 / 12419
{
	uParam0 = uParam0;
...
void Function_62(bool bParam0) //Position: 0x3127 / 12583
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_63(int iParam0, int iParam1) //Position: 0x32C9 / 13001
{
	int iVar0;
	bool bVar1;
...
void Function_64(int iParam0) //Position: 0x3383 / 13187
{
	float fVar0;
	bool bVar1;
...
int Function_65(var uParam0, int iParam1) //Position: 0x3425 / 13349
{
	int iVar0;
	var uVar1;
...
void Function_66(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3586 / 13702
{
	struct<8> Var0;
...
struct<32> Function_67(bool bParam0) //Position: 0x3621 / 13857
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x368B / 13963
{
	char* cVar0[32];
...
int Function_69(bool bParam0) //Position: 0x36AA / 13994
{
	int iVar0;
	vector3 vVar1;
...
float Function_70(bool bParam0, vector3 vParam1) //Position: 0x380B / 14347
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0) //Position: 0x3885 / 14469
{
	vector3 vVar0;
...
void Function_72(int iParam0) //Position: 0x38EF / 14575
{
...
void Function_73(int iParam0, int iParam1) //Position: 0x3950 / 14672
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_74(bool bParam0) //Position: 0x3A95 / 14997
{
...
var Function_75(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x3AC1 / 15041
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_76(int iParam0) //Position: 0x3ADD / 15069
{
...
bool Function_77(int iParam0, int iParam1) //Position: 0x3AF2 / 15090
{
...
bool Function_78(int iParam0, int iParam1) //Position: 0x3C07 / 15367
{
	int iVar0;
...
bool Function_79(int iParam0) //Position: 0x3D4B / 15691
{
...
bool Function_80(int iParam0) //Position: 0x3D6F / 15727
{
...
bool Function_81(int iParam0) //Position: 0x3D84 / 15748
{
...
var Function_82(int iParam0) //Position: 0x3D9B / 15771
{
...
bool Function_83(int iParam0) //Position: 0x3DB5 / 15797
{
...
bool Function_84(int iParam0) //Position: 0x3DCB / 15819
{
	return StackVal;
}

bool Function_85(var uParam0, int iParam1) //Position: 0x3DDB / 15835
{
	int iVar0;
...
bool Function_86(int iParam0) //Position: 0x3DF7 / 15863
{
	if (!iParam0->f_152)
	{
...
bool Function_87(int iParam0) //Position: 0x3E3E / 15934
{
...
bool Function_88(int iParam0) //Position: 0x3E97 / 16023
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x3EB3 / 16051
{
...
bool Function_90(int iParam0) //Position: 0x3EC8 / 16072
{
...
int Function_91(int iParam0) //Position: 0x3EDD / 16093
{
...
bool Function_92(var uParam0, bool bParam1) //Position: 0x3EF2 / 16114
{
	return (uParam0 && bParam1) == 0;
}

void Function_93() //Position: 0x3EFF / 16127
{
...
var Function_94(int iParam0, int iParam1) //Position: 0x3F7A / 16250
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
void Function_114(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x508C / 20620
{
	int iVar0;
...
void Function_115() //Position: 0x50DF / 20703
{
	var uVar0;
...
void Function_116(int iParam0, int iParam1) //Position: 0x5106 / 20742
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_117() //Position: 0x514F / 20815
{
	int iVar0;
...
int Function_118(int iParam0) //Position: 0x5157 / 20823
{
	int iVar0;
	int iVar1;
...
void Function_119() //Position: 0x54D2 / 21714
{
	if (!Function_88(128))
	{
		return;
...
bool Function_120() //Position: 0x5512 / 21778
{
	int iVar0;
...
void Function_121(var uParam0, int iParam1) //Position: 0x553D / 21821
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_122() //Position: 0x554E / 21838
{
	if (!Function_88(128))
	{
		return;
...
var Function_123(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5590 / 21904
{
	int iVar0;
	bool bVar1;
...
var Function_124(var uParam0, int iParam1, int iParam2) //Position: 0x55C8 / 21960
{
	int iVar0;
