...
int Function_44(bool bParam0) //Position: 0x2062 / 8290
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_66(bParam0, iVar0))
			{
				Function_57(bParam0, iVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000003:
			if (!Function_47(bParam0, iVar0, &iLocal_2))
			{
				iLocal_1 = 4;
			}
			iVar1 = 0;
...
void Function_45(bool bParam0, bool bParam1, int iParam2) //Position: 0x210B / 8459
{
	...
	*iParam2 = 0;
	...
	Function_46(471, CEIL(bLocal_12), 0, 0);
...
int Function_46(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x21E4 / 8676
{
	int iVar0;
	int iVar1;
...
bool Function_47(bool bParam0, bool bParam1, int iParam2) //Position: 0x2404 / 9220
{
	bool bVar0;
	float fVar1;
	var uVar2;
	...
	if (*iParam2 && !((Global_3378 || HUD_IS_FADING()) || HUD_IS_FADED()))
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar0) && iLocal_3)
		{
			...
			if (IS_BUTTON_PRESSED(Function_49(), 5, 1, 0))
			{
		...
		else if (!iLocal_3)
		{
			...
			else
			{
				...
				Function_48(&vVar29, 89.0f, -89.0f);
...
void Function_48(var uParam0, float fParam1, float fParam2) //Position: 0x27AB / 10155
{
	if (*uParam0 > fParam2)
	{
		*uParam0 = fParam2;
...
int Function_49() //Position: 0x27D0 / 10192
{
	bool bVar0;
...
bool Function_50() //Position: 0x27EA / 10218
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (!IS_OBJECT_VALID(bLocal_4))
	{
		bLocal_4 = CREATE_CAMERA_IN_LAYOUT(Function_51(), "bino_camera", 0);
	}
	if (!IS_OBJECT_VALID(bLocal_5))
	{
		bLocal_5 = CREATE_AIMRAMP_IN_LAYOUT(Function_51(), "bino_camera_ar");
	}
	if (IS_OBJECT_VALID(bLocal_4))
	{
		if (UNK_0x00EF33EF())
...
var Function_51() //Position: 0x2946 / 10566
{
	bool bVar0;
...
void Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x29B2 / 10674
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(bParam1, bVar1, Function_54(bVar1, "AttachBone", &iVar2), Function_54(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_53(bVar1, bParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_53(bool bParam0, int iParam1) //Position: 0x2A3C / 10812
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_54(bool bParam0, bool bParam1, int iParam2) //Position: 0x2AEA / 10986
{
	int iVar0;
	bool bVar1;
...
var Function_55(bool bParam0) //Position: 0x2B2F / 11055
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_56(bool bParam0) //Position: 0x2B45 / 11077
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2B5B / 11099
{
	Function_65("BINOCULARS: StartUse");
	uParam0 = Function_64(uParam0);
	*iParam2 = 0;
	if (DECOR_CHECK_EXIST(bParam1, "BinocularsStart"))
	{
		DECOR_REMOVE(bParam1, "BinocularsStart");
	...
	{
		Function_63("item_binoculars_fail", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
		iLocal_3 = 0;
	}
	else
	{
		if (((Function_59(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || DECOR_CHECK_EXIST(Global_34573, "anthro04"))
		{
			iLocal_3 = 0;
		}
		...
		else if (Function_58(Global_63084.f_32, 1))
		{
			*iParam2 = 0;
			Function_63("item_binoculars_fail", 0x41200000, 1, 0, 2, 1, 0);
		}
...
bool Function_58(var uParam0, int iParam1) //Position: 0x2D77 / 11639
{
	return (uParam0 && iParam1) == 0;
}

int Function_59(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2D84 / 11652
{
...
bool Function_60() //Position: 0x2E3A / 11834
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_61(bool bParam0) //Position: 0x2E51 / 11857
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_62(bool bParam0) //Position: 0x2E5C / 11868
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_63(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2E6A / 11882
{
	int iVar0;
...
var Function_64(bool bParam0) //Position: 0x2EB5 / 11957
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

void Function_65(int iParam0) //Position: 0x2ECF / 11983
{
	LOG_OBJECT2(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), iParam0, 0, 0, 0);
	return;
}

bool Function_66(int iParam0, bool bParam1) //Position: 0x2EE3 / 12003
{
	bool bVar0;
	bool bVar1;
