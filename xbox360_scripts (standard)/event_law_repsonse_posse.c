...
void main() //Position: 0x0 / 0
{
	...
	bLocal_9 = false;
	bVar1 = 250;
	Function_303(&Local_11, &ScriptParam_0);
	TOGGLE_ACTOR_ACTION_SIGNAL_ON(Global_34573, false, "red_wanted");
	if (Function_302(0x1000000))
	{
		bVar4 = true;
		if (StackVal <= 1000.0f)
		{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		{
			Function_299(Local_11.f_576, "posse_criminal_dead", 5.0f, ScriptParam_0.f_64, 20.0f, 1, 1);
			iLocal_10 = 3;
			bVar1 = false;
		}
		...
		switch (iLocal_10)
		{
			case 0x00000000:
				...
				if (Function_293(&Local_11 + 8) && Function_293(&Local_11 + 60))
				{
					Local_11.f_476 = GET_CURRENT_GAME_TIME();
					iLocal_10 = 1;
					bVar1 = false;
				}
				Function_291(&Local_11, &ScriptParam_0);
				break;
				break;
			
			case 0x00000001:
				if (Function_250(&Local_11, &ScriptParam_0))
				{
					Local_11.f_476 = GET_CURRENT_GAME_TIME();
					Function_249(1);
					if (bVar4)
					{
						Function_248(0x1000000);
						Function_247();
						*(&Global_26316 + 156) = { StackVal, StackVal, Function_247() };
					}
					PLAYER_RUMBLE("RUMBLE_MED", 4294967295, 0);
					if (Function_246())
					{
						Function_245("tutorial_law_posse_spawn_mp", 0x41200000, 1, 0, 2, 1, 0);
						Function_223();
					}
					Local_11.f_648 = 0;
					iLocal_10 = 2;
			...
			case 0x00000002:
				if (Function_246())
				{
					Function_202(&Local_11);
				}
				bVar9 = Function_200(Local_11.f_576, ScriptParam_0.f_48, 1, 0);
				if (IS_ACTOR_VALID(bVar9))
				{
					GET_POSITION(bVar9, &Local_11 + 428);
				}
				else
				{
					*(&Local_11 + 428) = { 0.0f, 0.0f, 0.0f };
				}
				if ((((!Function_199(ScriptParam_0.f_48) && !IS_ACTOR_IN_HOGTIE(ScriptParam_0.f_48)) && !IS_GRINGO_VALID(GET_CURRENT_GRINGO(ScriptParam_0.f_48))) && !IS_ACTOR_RIDING_VEHICLE(ScriptParam_0.f_48)) && !IS_ACTOR_RIDING(ScriptParam_0.f_48))
				{
					Function_176(&Local_11, &ScriptParam_0);
					Function_169(&Local_11, &ScriptParam_0);
				}
				else if (IS_SCRIPT_USE_CONTEXT_VALID(Local_11.f_712))
				{
					RELEASE_SCRIPT_USE_CONTEXT(Local_11.f_712);
				}
				Function_167(&Local_11, &ScriptParam_0);
				Function_165(&Local_11, &ScriptParam_0);
				Function_164(&Local_11);
				Function_159();
				if (Function_153(&Local_11, &ScriptParam_0, 1))
				{
					Local_11.f_648 = 24;
					iLocal_10 = 3;
					bVar1 = false;
				}
				bVar1 = Function_95(bVar1, Function_96(&Local_11, &ScriptParam_0));
				Function_90(&Local_11, &ScriptParam_0);
				Function_79(&Local_11);
				Function_77(&Local_11, &ScriptParam_0);
				Function_76(&Local_11);
				if (Local_11.f_720)
				{
					iLocal_10 = 3;
				}
				...
				{
					GET_POSITION(SQUAD_GET_ACTOR_BY_INDEX(Local_11.f_576, bVar0), &vVar6);
					if (VDIST(vVar6, *(&Local_11 + 416)) > 250.0f)
					{
						bVar2 = false;
					}
					bVar0++;
				...
				bVar10 = false;
				if (Function_75(&Local_11, 1) != 0 && !bVar2)
				{
				...
				if (!Function_246())
				{
					...
					if (IS_ACTOR_VALID(Function_74()))
					{
						...
						{
							if (Function_73(bVar11, Local_11.f_576, 0))
							{
								bLocal_197 = true;
							}
						}
			...
			case 0x00000003:
				...
				bVar1 = Function_96(&Local_11, &ScriptParam_0);
				bVar0 = false;
				while (bVar0 <= SQUAD_GET_SIZE(Local_11.f_576))
				{
					if (!Local_11.f_552)
					{
						...
						else if ((!Function_72(SQUAD_GET_ACTOR_BY_INDEX(Local_11.f_576, bVar0), 1.0f, 75.0f, 1, 1, 0) || HUD_IS_FADED()) && !IS_ACTOR_HOGTIED(SQUAD_GET_ACTOR_BY_INDEX(Local_11.f_576, bVar0)))
						{
					...
					{
						bVar12 = SQUAD_GET_ACTOR_BY_INDEX(Local_11.f_576, bVar0);
	...
	{
		Function_46(&Local_11 + 576, 0, 0, 0);
	}
	else if (Local_11.f_552)
	{
		Function_46(&Local_11 + 576, 0, 0, 1);
	}
	if (!Local_11.f_556)
	{
		Function_44();
	}
	Function_43(Local_11.f_580);
	Function_42(&Local_11 + 580, 0, 0);
	Function_40(&Local_11, 1);
	if (IS_SCRIPT_USE_CONTEXT_VALID(Local_11.f_712))
	{
		RELEASE_SCRIPT_USE_CONTEXT(Local_11.f_712);
	}
			...
			if (bLocal_197)
			{
				if (IS_ACTOR_VALID(Function_74()))
				{
					if (!IS_ACTOR_ALIVE(Function_74()))
					{
						...
						Function_35(Function_38(Global_26316[Local_11.f_724]), Function_36(Local_11.f_724), Local_11.f_724);
					}
				}
			}
		}
	}
	Function_31(&Local_11 + 8);
	Function_29(0);
	Function_39(1024);
	Global_13094 = 1.0f;
...
void Function_17(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0xA6E / 2670
{
	...
	if (IS_EARLIER_THAN((*&Global_26316 + 88)[iParam0], bVar0) || Function_18((*&Global_26316 + 88)[iParam0]))
	{
						...
						if (IS_ACTOR_HORSE(bVar6))
						{
							if (IS_ACTOR_ALIVE(bVar6))
							{
								if (GET_RIDER(bVar6) == "")
								{
									...
									if ((iVar7 == 1 || Function_246()) || bParam1)
									{
...
void Function_50(bool bParam0, bool bParam1) //Position: 0x1596 / 5526
{
	bool bVar0;
	bool bVar1;
...
struct<32> Function_58(char* cParam0, char* cParam1) //Position: 0x205D / 8285
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x2656 / 9814
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_68(int iParam0, bool bParam1) //Position: 0x27DD / 10205
{
	if (!Function_37(iParam0))
	{
		return;
...
int Function_69(int iParam0) //Position: 0x281E / 10270
{
	if (iParam0 == 4294967295)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x285F / 10335
{
	int iVar0;
...
void Function_71(bool bParam0) //Position: 0x2ACB / 10955
{
	if (!SQUAD_IS_VALID(bParam0))
	{
		return;
...
bool Function_72(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2AE0 / 10976
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

bool Function_73(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2AFA / 11002
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_74() //Position: 0x2B3A / 11066
{
...
int Function_75(int iParam0, bool bParam1) //Position: 0x2B4F / 11087
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_76(int iParam0) //Position: 0x2BC9 / 11209
{
	bool bVar0;
	bool bVar1;
...
void Function_77(var uParam0, int iParam1) //Position: 0x2D65 / 11621
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2F5D / 12125
{
...
void Function_79(int iParam0) //Position: 0x2F94 / 12180
{
	bool bVar0;
...
void Function_80(int iParam0) //Position: 0x2FC7 / 12231
{
	struct<9> Var0;
...
int Function_81() //Position: 0x312D / 12589
{
...
var Function_82(bool bParam0, int iParam1) //Position: 0x3150 / 12624
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int Function_83(bool bParam0) //Position: 0x3301 / 13057
{
...
bool Function_84(bool bParam0, int iParam1) //Position: 0x3332 / 13106
{
...
void Function_85(int iParam0, bool bParam1) //Position: 0x3361 / 13153
{
	bool bVar0;
...
float Function_86(int iParam0) //Position: 0x3460 / 13408
{
	bool bVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x34EB / 13547
{
	return (*&Global_12976 + 104)[iParam0];
}

void Function_88(bool bParam0) //Position: 0x34FA / 13562
{
	Function_89(bParam0);
...
void Function_89(bool bParam0) //Position: 0x3542 / 13634
{
	bool bVar0;
...
var Function_90(int iParam0, int iParam1) //Position: 0x356E / 13678
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_91(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x369A / 13978
{
	float fVar0;
	vector3 vVar1;
...
bool Function_92(int iParam0) //Position: 0x379B / 14235
{
...
bool Function_93(bool bParam0, bool bParam1, float fParam2, bool bParam3) //Position: 0x37E6 / 14310
{
	vector3 vVar0;
...
var Function_94(float fParam0, bool bParam1) //Position: 0x39E6 / 14822
{
...
int Function_95(int iParam0, bool bParam1) //Position: 0x3A51 / 14929
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
bool Function_96(int iParam0, int iParam1) //Position: 0x3A63 / 14947
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	*(iParam0 + 524) = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(*(iParam0 + 500), *(iParam0 + 524), StackVal) };
	Function_152(iParam0 + 524, 10.0f, iParam0 + 524, 10);
	switch (iParam0->f_648)
	{
		case 0x00000000:
			Function_151("LAW_AI_STATE: INIT", 11);
			iVar0 = (Function_75(iParam0, 1) / 2);
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			...
			Function_149(iParam0->f_576, 1);
			iParam0->f_648 = 1;
		
		case 0x00000001:
			Function_148(iParam0, iParam1, 0);
			if (!Function_92(iParam0))
			{
				if (Function_147(iParam1->f_52, iParam1->f_48, 1))
				{
					iParam0->f_648 = 4;
					return 0;
				}
				if (Function_145(iParam0->f_576, iParam1->f_48, 20.0f, 1))
				{
					iParam0->f_648 = 4;
					return 0;
				}
				if (Function_145(iParam0->f_580, iParam1->f_48, 20.0f, 1))
				{
					iParam0->f_648 = 4;
					return 0;
				}
		...
		case 0x00000004:
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			Function_151("LAW_AI_STATE: ARREST - SHOOT", 11);
			...
			if (iParam0->f_536 > 0.0f)
			{
				...
				{
					Function_148(iParam0, iParam1, 1);
				}
			}
			iParam0->f_648 = 5;
		...
		case 0x00000005:
			...
			if (!bVar18)
			{
				if (!Function_147(iParam1->f_52, iParam1->f_48, 1))
				{
					if (!Function_141(iParam0, 5.0f))
					{
						if (!Function_139(StackVal, StackVal, iParam0->f_576, *(iParam0 + 416), 20.0f))
						{
				...
				if (iParam0->f_408)
				{
					if (!iParam0->f_568)
					{
						...
						{
							if (StackVal && !Function_139(StackVal, (StackVal && Function_139(StackVal, Function_141(iParam0, 10.0f), iParam0->f_576, *(iParam0 + 416), 15.0f)), iParam0->f_576, *(iParam0 + 416), 5.0f))
							{
								iParam0->f_648 = 4;
								return 0;
							}
			...
			if (SQUAD_IS_VALID(iParam0->f_576))
			{
				if (!Function_138(iParam0->f_576, iParam1->f_48, 0))
				{
					if (!iParam0->f_568 && !Function_92(iParam0))
					{
						iParam0->f_648 = 6;
			...
			{
				if (Function_145(iParam0->f_576, Function_74(), 25.0f, 0))
				{
		...
		case 0x00000006:
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			Function_151("LAW_AI_STATE: GIVE CHASE", 11);
			SQUAD_GOAL_ADD_GENERAL_TASK(iParam0->f_576, false, 1, 4294967295);
		...
		case 0x00000007:
			...
			*(iParam0 + 524) = { StackVal, StackVal, *(iParam0 + 500) };
			...
			if (Function_139(StackVal, StackVal, iParam0->f_576, *(iParam0 + 416), 80.0f))
			{
				if (!iParam0->f_568)
				{
					iParam0->f_648 = 4;
			...
			if (!bVar18)
			{
				...
				if (!Function_141(iParam0, 20.0f) && !Global_29006 != Global_30693[1])
				{
					if (!iParam0->f_568)
					{
						iParam0->f_648 = 8;
		...
		case 0x00000008:
			Function_151("LAW_AI_STATE: PURSUE", 11);
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			if (!IS_OBJECT_VALID(iParam0->f_664))
			{
		...
		case 0x00000009:
			...
			bVar21 = Function_133(iParam1->f_48, 3);
			...
			if (IS_OBJECT_VALID(iParam0->f_664))
			{
				if (Function_132(iParam0->f_580) >= 0)
				{
			...
			if (Function_141(iParam0, 0x3f800000))
			{
				if (!iParam0->f_568)
				{
					iParam0->f_648 = 4;
			...
			if (!Function_141(iParam0, 20.0f) && !Global_3386)
			{
				if (!iParam0->f_568)
				{
					iParam0->f_648 = 10;
		...
		case 0x0000000D:
			Function_151("LAW_AI_STATE: SURROUND", 11);
			if (!Function_78(iParam0->f_576, 95, iParam1->f_48))
			{
				Function_299(iParam0->f_576, "law_surround", 5.0f, iParam1->f_64, 30.0f, 0, 0);
			}
			Function_136(iParam0, 0);
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			...
			if (!Function_131(iParam0))
			{
				if (IS_OBJECT_VALID(iParam0->f_668) && GET_OBJECT_TYPE(iParam0->f_668) != 9)
				{
					...
					fVar16 = (5.0f + (Function_130(vVar3.x, vVar3.z) / 2.0f));
				...
				else if (IS_OBJECT_VALID(iParam0->f_668) && GET_OBJECT_TYPE(iParam0->f_668) != 10)
				{
					...
					while (IS_OBJECT_VALID(bVar13))
					{
						...
						fVar16 = (fVar16 + Function_130((5.0f + (Function_130(vVar3.x, vVar3.z) / 2.0f)), 20.0f));
				...
				GET_OBJECT_POSITION(iParam0->f_668, &vVar6);
				uVar12 = Function_127(iParam0->f_336, 2, fVar16);
				...
				while (bVar2 <= GET_NUM_FORMATION_LOCATIONS(uVar12))
				{
					...
					iVar17 = Function_125(StackVal, StackVal, StackVal, StackVal, vVar9, vVar6);
					Function_152(&vVar9, 15.0f, &vVar3, 2);
			...
			{
				Function_151("LAW_AI_STATE: SURROUND (RIVERBOAT)", 11);
				SQUAD_GOAL_ADD_STAY_WITHIN_VOLUME(iParam0->f_576, 0, iParam0->f_412, 3, 0);
				SQUAD_GOAL_ADD_GENERAL_TASK(iParam0->f_576, true, 0, 4294967295);
				TASK_KILL_CHAR(false, iParam1->f_48);
				SQUAD_GOAL_ADD_SHARE_PERCEPTION(iParam0->f_576, 15);
			}
			Function_123(iParam0 + 576);
			Function_122(iParam0->f_576, 1);
			SQUAD_GOAL_ADD_SHARE_PERCEPTION(iParam0->f_576, 15);
			SQUAD_GOALS_CLEAR(iParam0->f_580);
			Function_150(iParam0->f_580);
			SQUAD_GOAL_ADD_GENERAL_TASK(iParam0->f_580, false, 1, 4294967295);
		...
		case 0x0000000F:
			Function_151("LAW_AI_STATE: SUBMIT CUTSCENE", 11);
			iParam0->f_648 = 16;
			Function_121(&Global_76847, 0x1000000);
			Function_116(0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 0, 1);
			Function_115(iParam0->f_576, iParam1->f_48, 2);
		...
		case 0x00000015:
			Function_151("LAW_AI_STATE: BRIBE CUTSCENE", 11);
			...
			Function_116(0, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1);
			if (IS_ACTOR_HOGTIED(bVar14))
			{
				FREE_FROM_HOGTIE(bVar14);
			}
			if (Function_103(&bVar25, &vVar26))
			{
				SET_ACTOR_HEADING(iParam1->f_48, bVar25, 1);
			}
			else
			{
				bVar25 = Function_102(iParam1->f_48);
				Function_101(bVar14);
			...
			iParam0->f_708 = Function_97(StackVal, StackVal, iParam1->f_48, bVar25, vVar26);
		...
		case 0x00000018:
			Function_151("LAW_AI_STATE: CLEANUP", 11);
			SQUAD_GOALS_CLEAR(iParam0->f_576);
			Function_150(iParam0->f_576);
			Function_50(iParam0->f_576, 0);
...
var Function_97(bool bParam0, var uParam1, vector3 vParam2) //Position: 0x4C1D / 19485
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_98(vector3 vParam0) //Position: 0x4C98 / 19608
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_99(vector3 vParam0, var uParam3, vector3 vParam4, vector3 vParam7, var uParam10, var uParam11) //Position: 0x4CB0 / 19632
{
	struct<5> Var0;
	vector3 vVar6;
	vector3 vVar9;
...
vector3 Function_100(vector3 vParam0, var uParam3) //Position: 0x4FB5 / 20405
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
...
vector3 Function_101(bool bParam0) //Position: 0x501D / 20509
{
	vector3 vVar0;
...
bool Function_102(bool bParam0) //Position: 0x502E / 20526
{
	return GET_HEADING(bParam0);
}

bool Function_103(float fParam0, int iParam1) //Position: 0x5039 / 20537
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	while (iVar13 <= 36)
	{
		...
		if (Function_106(StackVal, StackVal, StackVal, StackVal, vVar0, vVar3))
		{
			...
			{
				fVar10 = Function_125(StackVal, StackVal, StackVal, StackVal, vVar3, vVar0);
				fVar11 = fVar14;
				*iParam1 = { StackVal, StackVal, vVar0 };
				iVar12 = 1;
			}
...
vector3 Function_104(vector3 vParam0) //Position: 0x5116 / 20758
{
	vector3 vVar0;
...
float Function_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x5190 / 20880
{
	struct<5> Var0;
	var uVar6;
	float fVar9;
...
bool Function_106(vector3 vParam0) //Position: 0x51D0 / 20944
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_107(bool bParam0, bool bParam1) //Position: 0x523B / 21051
{
	bool bVar0;
	bool bVar1;
	float fVar2;
...
float Function_108(bool bParam0, bool bParam1) //Position: 0x52F8 / 21240
{
	var uVar0;
	var uVar3;
	int iVar6;
...
var Function_109(var uParam0, bool bParam1) //Position: 0x5317 / 21271
{
	vector3 vVar0;
	bool bVar3;
...
void Function_110(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x5335 / 21301
{
	int iVar0;
...
void Function_111(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9) //Position: 0x537C / 21372
{
	bool bVar0;
...
void Function_112(bool bParam0) //Position: 0x546C / 21612
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
...
void Function_113() //Position: 0x5511 / 21777
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_114(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5526 / 21798
{
	int iVar0;
	int iVar1;
...
void Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5746 / 22342
{
	bool bVar0;
	bool bVar1;
...
void Function_116(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x578B / 22411
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_120()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
		DESTROY_CAMERA(GET_CAMERA_FROM_OBJECT(Function_120()));
	...
	if (Function_119(0x4000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
		Function_117(0x4000000);
	}
	if (Function_119(0x8000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
...
void Function_117(int iParam0) //Position: 0x5A34 / 23092
{
	int iVar0;
	
	if (Function_118(iParam0, 1) && Function_118(Global_26119, 1))
	{
	}
...
var Function_118(var uParam0, int iParam1) //Position: 0x5A68 / 23144
{
	return (uParam0 && iParam1) == 0;
}

bool Function_119(int iParam0) //Position: 0x5A75 / 23157
{
	int iVar0;
...
var Function_120() //Position: 0x5A91 / 23185
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_121(var uParam0, int iParam1) //Position: 0x5B10 / 23312
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_122(bool bParam0, bool bParam1) //Position: 0x5B1F / 23327
{
	bool bVar0;
	bool bVar1;
...
void Function_123(var uParam0) //Position: 0x5B67 / 23399
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_124() //Position: 0x5BC9 / 23497
{
	bool bVar0;
...
float Function_125(vector3 vParam0, vector3 vParam3) //Position: 0x5C35 / 23605
{
	var uVar0;
	
	Function_126(StackVal, StackVal, StackVal, StackVal, vParam0, vParam3, &uVar0);
	return UNK_0x9C40E671(&uVar0);
}

void Function_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5C4F / 23631
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

var Function_127(var uParam0, int iParam1, float fParam2) //Position: 0x5C72 / 23666
{
	struct<8> Var0;
	int iVar8;
	bool bVar9;
	...
	Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_128("llr") };
...
struct<32> Function_128(bool bParam0) //Position: 0x5CE9 / 23785
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5D53 / 23891
{
	char* cVar0[32];
...
float Function_130(int iParam0, int iParam1) //Position: 0x5D72 / 23922
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
bool Function_131(int iParam0) //Position: 0x5D85 / 23941
{
...
int Function_132(bool bParam0) //Position: 0x5DA8 / 23976
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
var Function_133(bool bParam0, int iParam1) //Position: 0x5DF8 / 24056
{
	float fVar0;
	bool bVar1;
	bool bVar2;
...
void Function_134(bool bParam0, bool bParam1) //Position: 0x5E94 / 24212
{
	ITERATE_EVERYWHERE(bParam0);
...
bool Function_135(int iParam0) //Position: 0x5EC3 / 24259
{
...
void Function_136(int iParam0, bool bParam1) //Position: 0x5ED8 / 24280
{
	if (bParam1)
	{
...
bool Function_137(int iParam0) //Position: 0x5F04 / 24324
{
...
bool Function_138(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5F48 / 24392
{
	bool bVar0;
	bool bVar1;
...
bool Function_139(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x5FB0 / 24496
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			{
				Function_140(bVar1);
				if (VDIST(Function_140(bVar1), vParam1) >= fParam4)
				{
					iVar2 = 1;
				}
			}
...
vector3 Function_140(bool bParam0) //Position: 0x601E / 24606
{
	vector3 vVar0;
...
bool Function_141(int iParam0, float fParam1) //Position: 0x6088 / 24712
{
...
bool Function_142(int iParam0) //Position: 0x60A0 / 24736
{
	bool bVar0;
	vector3 vVar1;
	...
	if (iParam0->f_648 != 12)
	{
		...
		if (bVar0)
		{
			...
			vVar1 = { StackVal, StackVal, Function_143(iParam0) };
			if (!Function_98(StackVal, StackVal, vVar1))
			{
				if (SQUAD_IS_VALID(iParam0->f_576))
				{
					SQUAD_GOALS_CLEAR(iParam0->f_576);
					Function_150(iParam0->f_576);
					Function_151("LAW_AI_STATE: STAY IN COUNTRY", 11);
...
vector3 Function_143(int iParam0) //Position: 0x61A3 / 24995
{
	int iVar0;
	
	iVar0 = Function_144(iParam0);
	switch (iVar0)
	{
		case 0x00000000:
			if (iParam0->f_724 == 0)
	...
	Function_247();
	return StackVal, StackVal, Function_247();
}

var Function_144(int iParam0) //Position: 0x6274 / 25204
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_145(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x631C / 25372
{
	bool bVar0;
	bool bVar1;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			if (IS_ACTOR_ALIVE(bVar1))
			{
				...
				{
					if (!Function_146(bVar1, 1) || iParam3)
					{
						return 1;
					}
				}
...
bool Function_146(bool bParam0, int iParam1) //Position: 0x63B5 / 25525
{
	bool bVar0;
	int iVar1;
...
bool Function_147(int iParam0, bool bParam1, bool bParam2) //Position: 0x63FF / 25599
{
	bool bVar0;
	vector3 vVar1;
...
void Function_148(int iParam0, var uParam1, int iParam2) //Position: 0x6572 / 25970
{
	if (iParam0->f_536 > 0.0f)
	{
		if ((Function_145(iParam0->f_576, uParam1->f_48, 20.0f, 1) || Function_141(iParam0, 0x3f800000)) || iParam2)
		{
			if (!Function_78(iParam0->f_576, 59, uParam1->f_48))
			{
				if (GET_WEAPON_IN_HAND(uParam1->f_48) == 4294967295)
				{
					Function_299(iParam0->f_576, "law_give_up_unarmed", 2,5f, uParam1->f_64, 20.0f, 1, 0);
				}
				else
				{
					Function_299(iParam0->f_576, "law_give_up", 2,5f, uParam1->f_64, 20.0f, 1, 0);
				}
			}
...
void Function_149(bool bParam0, int iParam1) //Position: 0x661F / 26143
{
	bool bVar0;
	bool bVar1;
...
void Function_150(bool bParam0) //Position: 0x6664 / 26212
{
	bool bVar0;
...
void Function_151(bool bParam0, int iParam1) //Position: 0x6696 / 26262
{
	if (!Function_119(128))
	{
		return;
...
int Function_152(var uParam0, float fParam1, int iParam2, int iParam3) //Position: 0x66D1 / 26321
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_153(int iParam0, var uParam1, bool bParam2) //Position: 0x6803 / 26627
{
	int iVar0;
	float fVar1;
	
	fVar1 = Function_158(iParam0, uParam1->f_48);
	...
	if (bParam2)
	{
		...
		{
			if (Function_147(uParam1->f_56, GET_OBJECT_FROM_ACTOR(uParam1->f_48), 1))
			{
				Global_3405 = 0;
				*(iParam0 + 500) = { StackVal, StackVal, *(iParam0 + 416) };
				GET_ACTOR_VELOCITY(uParam1->f_48, iParam0 + 512);
				iParam0->f_448 = GET_CURRENT_GAME_TIME();
				Function_157(iParam0->f_576, uParam1->f_48, 0);
	...
	iParam0->f_356 = Function_130(Function_130(iParam0->f_440, iParam0->f_444), iParam0->f_448);
	Global_27763 = Function_86(iParam0);
	Global_27764 = iParam0->f_356;
	if (GET_CURRENT_GAME_TIME() < (iParam0->f_356 + Global_27763))
	{
		if (Function_156(iParam0->f_576) >= 0)
		{
			if (!Function_78(iParam0->f_576, 22, uParam1->f_48))
			{
				Function_299(iParam0->f_576, "law_go_unwanted", 5.0f, uParam1->f_64, 20.0f, 0, 0);
			}
		}
		if (Function_246())
		{
			if (Function_154(Global_29006) < Global_78480.f_116)
			{
				iVar0 = 1;
			}
			else
	...
	else if (GET_CURRENT_GAME_TIME() < (iParam0->f_356 + 5.0f))
	{
		...
		if (GET_CURRENT_GAME_TIME() < (iParam0->f_352 + 20.0f))
		{
			if (Function_156(iParam0->f_576) >= 0)
			{
				if (!Function_78(iParam0->f_576, 22, uParam1->f_48))
				{
					Function_299(iParam0->f_576, "law_wanted_lost_track", 2,5f, uParam1->f_64, 20.0f, 0, 1);
				}
			}
...
int Function_154(int iParam0) //Position: 0x6A25 / 27173
{
	int iVar0;
	bool bVar1;
...
bool Function_155(int iParam0) //Position: 0x6A6F / 27247
{
...
int Function_156(bool bParam0) //Position: 0x6A85 / 27269
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_157(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6AD2 / 27346
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_158(var uParam0, int iParam1) //Position: 0x6B3D / 27453
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar1 <= SQUAD_GET_SIZE(uParam0->f_576))
	{
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			if (IS_ACTOR_ALIVE(bVar2))
			{
				...
				iVar3 = Function_130(MEMORY_GET_POSITION_LAST_KNOWN_TIME(bVar2, iParam1), iVar3);
			}
		}
		bVar1++;
	}
...
void Function_159() //Position: 0x6BE3 / 27619
{
	if (Global_3386)
	{
		if (Function_162(32768))
		{
			Function_160(32768);
		}
	}
	else if (!Function_162(32768))
	{
		Function_11(32768);
	}
	return;
...
void Function_160(int iParam0) //Position: 0x6C15 / 27669
{
	Function_161(&Global_28842, iParam0);
	return;
}

void Function_161(var uParam0, int iParam1) //Position: 0x6C23 / 27683
{
	int iVar0;
...
bool Function_162(int iParam0) //Position: 0x6C46 / 27718
{
	return Function_163(&Global_28842, iParam0);
}

int Function_163(var uParam0, int iParam1) //Position: 0x6C54 / 27732
{
	int iVar0;
...
void Function_164(int iParam0) //Position: 0x6C70 / 27760
{
	bool bVar0;
	bool bVar1;
...
void Function_165(var uParam0, int iParam1) //Position: 0x6CC6 / 27846
{
	if ((((((uParam0->f_544 || uParam0->f_540) || uParam0->f_548) || uParam0->f_552) || uParam0->f_568) || uParam0->f_572) || uParam0->f_648 < 14)
	{
		return;
	}
	if ((((Global_26401[iParam1->f_64] <= 15 || (GET_CURRENT_GAME_TIME() <= (uParam0->f_480 + 20.0f) && uParam0->f_480 < 0.0f)) || *uParam0 != 2) || *uParam0 != 3) || Function_246())
	{
		Function_166(uParam0, iParam1);
	}
	return;
}

void Function_166(var uParam0, int iParam1) //Position: 0x6D3A / 27962
{
	bool bVar0;
	bool bVar1;
...
void Function_167(var uParam0, int iParam1) //Position: 0x6DC9 / 28105
{
	int iVar0;
	bool bVar1;
	...
	if (GET_CURRENT_GAME_TIME() <= uParam0->f_736)
	{
		...
		{
			uParam0->f_668 = Function_168(iParam1->f_48, 258);
		}
		else
		{
			uParam0->f_668 = "";
...
var Function_168(bool bParam0, int iParam1) //Position: 0x6EE0 / 28384
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_169(int iParam0, int iParam1) //Position: 0x7079 / 28793
{
	float fVar0;
	bool bVar1;
	bool bVar2;
	...
	if ((((((Function_173(iParam1->f_48, 0, 0) || Global_3405) || Function_75(iParam0, 1) != 0) || Global_63096) || iParam0->f_552) || IS_ACTOR_RAGDOLL(iParam1->f_48)) || !IS_ACTOR_ALIVE(iParam1->f_48))
	{
	...
	fVar0 = Function_171(GET_TIME_SINCE_LAST_MOVESTICK_INPUT(GET_PLAYER_PADINDEX(iParam1->f_48)), GET_TIME_SINCE_LAST_BUTTON_INPUT(GET_PLAYER_PADINDEX(iParam1->f_48)));
...
int Function_170() //Position: 0x753F / 30015
{
	return Global_12976.f_152;
}

var Function_171(int iParam0, int iParam1) //Position: 0x754A / 30026
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
void Function_172(int iParam0, int iParam1) //Position: 0x755D / 30045
{
	if (SQUAD_IS_VALID(iParam0->f_576))
	{
		AI_CLEAR_DONT_HARM_ACTOR(iParam1->f_48);
...
bool Function_173(bool bParam0, bool bParam1, bool bParam2) //Position: 0x758E / 30094
{
...
bool Function_174() //Position: 0x7644 / 30276
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_175(bool bParam0) //Position: 0x765B / 30299
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

void Function_176(int iParam0, int iParam1) //Position: 0x7666 / 30310
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = false;
	if (!Function_302(524288))
	{
		if (Function_145(iParam0->f_576, iParam1->f_48, 10.0f, 1))
		{
	...
	if (((((!iParam0->f_540 && !iParam0->f_568) && !iParam0->f_548) && !iParam0->f_552) && Function_302(0x2000000)) && Function_75(iParam0, 1) < 0)
	{
		if (Function_198(iParam0->f_576, iParam1->f_48, 10.0f, 0,5f))
		{
			bVar1 = false;
			if (Function_196(iParam0->f_576, iParam1->f_48, 25.0f, 0) == 1)
			{
				if (Function_193(iParam0, iParam1))
				{
					Global_3408 = 1;
					bVar1 = true;
					...
					if (IS_SCRIPT_USE_CONTEXT_VALID(iParam0->f_712))
					{
						if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(iParam0->f_712))
						{
							...
							{
								Function_44();
								DECOR_SET_INT(StackVal, Function_191(iParam0->f_576), CEIL((IntToFloat(Function_36("iAdditionalMoney")) / 2.0f)));
								if (CEIL((IntToFloat(Function_36(StackVal)) / 2.0f)) >= Function_69(255))
								{
									Function_53(StackVal, CEIL((IntToFloat(Function_36(255)) / 2.0f)), 0);
								}
								Function_114(253, 1, 0, 0);
								Function_190(CEIL((IntToFloat(Function_36(StackVal)) / 2.0f)), 1);
								if (Function_36(StackVal) <= 100)
								{
									Function_177(4294966896, 1, 0);
								}
								else if (Function_36(StackVal) <= 1000)
								{
									Function_177(4294966296, 1, 0);
								}
								else
								{
									Function_177(4294965296, 1, 0);
								}
								Function_52();
								Function_245("bribe_taken", 0x41200000, 1, 0, 2, 1, 0);
								iParam0->f_640 = 0;
								iParam0->f_636 = 0.0f;
								iParam0->f_648 = 21;
								iParam0->f_552 = 1;
...
void Function_177(int iParam0, bool bParam1, bool bParam2) //Position: 0x79EA / 31210
{
	int iVar0;
	bool bVar1;
	...
	if (bParam1)
	{
		...
		{
			Function_187(1, (4294967295 * bVar1));
			if (!Global_3380)
			{
	...
	{
		Function_114(1, bVar1, 0, 0);
	}
	else
	{
		Function_186(1, (4294967295 * bVar1), 0);
	}
	...
	switch (Global_12976.f_152)
	{
		case 0x00000000:
			if (iVar0 >= 4294962796)
			{
				...
				Function_179(2, Function_185(Global_12976.f_152), 1);
			}
			break;
		...
		case 0x00000001:
			if (iVar0 < 4294962796)
			{
				...
				Function_179(2, Function_185(Global_12976.f_152), 0);
	...
	Function_178(Global_12976.f_152, Global_12976.f_156);
	return;
}

void Function_178(int iParam0, int iParam1) //Position: 0x7CFF / 31999
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_179(int iParam0, char* cParam1, bool bParam2) //Position: 0x7F5D / 32605
{
	bool bVar0;
	int iVar1;
	...
	Function_183(iParam0, cParam1, 0, 1);
	iVar1 = Function_180();
...
int Function_180() //Position: 0x8119 / 33049
{
	int iVar0;
...
void Function_181() //Position: 0x81B8 / 33208
{
	int iVar0;
	int iVar1;
...
void Function_182(int iParam0) //Position: 0x8267 / 33383
{
...
int Function_183(int iParam0, bool bParam1, bool bParam2, var uParam3) //Position: 0x82C5 / 33477
{
	int iVar0;
	var uVar1;
	...
	if (bParam2)
	{
		...
		Function_184(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, iParam0, *(&Global_35278[iParam020] + 16), 3.0f, uParam3);
	}
	return 1;
}

void Function_184(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0x8617 / 34327
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
var Function_185(int iParam0) //Position: 0x869A / 34458
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_186(int iParam0, bool bParam1, int iParam2) //Position: 0x873D / 34621
{
	int iVar0;
	int iVar1;
...
int Function_187(int iParam0, bool bParam1) //Position: 0x8938 / 35128
{
	bool bVar0;
	int iVar1;
	
	Function_186(iParam0, bParam1, 0);
	bVar0 = iParam0;
	if (bVar0 >= 696)
	{
...
var Function_188(int iParam0, int iParam1) //Position: 0x8AD4 / 35540
{
	int iVar0;
...
int Function_189(int iParam0, bool bParam1) //Position: 0x8B15 / 35605
{
	bool bVar0;
	int iVar1;
	
	Function_114(iParam0, bParam1, 0, 0);
	bVar0 = iParam0;
	if (bVar0 >= 696)
	{
...
int Function_190(int iParam0, bool bParam1) //Position: 0x8CB2 / 36018
{
	bool bVar0;
...
int Function_191(bool bParam0) //Position: 0x8D42 / 36162
{
	bool bVar0;
	bool bVar1;
...
int Function_192() //Position: 0x8D88 / 36232
{
	return Function_69(0);
}

bool Function_193(int iParam0, int iParam1) //Position: 0x8D92 / 36242
{
	bool bVar0;
	
	if (((((((CAN_ANYONE_OF_FACTION_SEE_OBJECT(iParam1->f_52, iParam1->f_48) && GET_ATTACHED_HOGTIE_VICTIM(iParam1->f_48) != "") && GET_WEAPON_IN_HAND(iParam1->f_48) != 4294967295) && GET_CURRENT_CAMERA_TYPE_FROM_CHANNEL(0) != 1) && !IS_ACTOR_RAGDOLL(iParam1->f_48)) && !Function_173(Function_74(), 0, 1)) && !Function_195()) && !Function_194())
	{
...
bool Function_194() //Position: 0x8E1C / 36380
{
	return Global_34578 != 3;
}

bool Function_195() //Position: 0x8E27 / 36391
{
	return Global_34578 != 2;
}

int Function_196(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x8E32 / 36402
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		{
			if (Function_197(bVar2, bParam1, uParam2))
			{
				iVar1++;
				if (bParam3)
				{
...
bool Function_197(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8EA1 / 36513
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (IS_ACTOR_VALID(bParam1))
...
bool Function_198(bool bParam0, bool bParam1, bool bParam2, float fParam3) //Position: 0x8FB2 / 36786
{
	bool bVar0;
	bool bVar1;
	struct<5> Var2;
...
bool Function_199(bool bParam0) //Position: 0x9045 / 36933
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_200(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x9053 / 36947
{
	bool bVar0;
	bool bVar1;
	float fVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		{
			fVar3 = Function_201(bVar4, bParam1);
			if (fVar3 > fVar2)
			{
				fVar2 = fVar3;
				bVar1 = bVar0;
...
var Function_201(bool bParam0, bool bParam1) //Position: 0x910D / 37133
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_202(int iParam0) //Position: 0x91FE / 37374
{
...
void Function_203(int iParam0) //Position: 0x920E / 37390
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(iParam0->f_576))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			if (IS_SLOT_VALID(bLocal_9) && GET_LOCAL_SLOT() == bLocal_9)
			{
				...
				if (IS_ACTOR_VALID(bVar2))
				{
					if (Function_204(bLocal_9) != 4294967295)
					{
...
int Function_204(int iParam0) //Position: 0x928A / 37514
{
	return Global_76943[iParam096].f_112;
}

void Function_205(int iParam0) //Position: 0x929A / 37530
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_206(bool bParam0) //Position: 0x9349 / 37705
{
	bool bVar0;
	vector3 vVar1;
	...
	{
		case 0x00000000:
			bVar0 = Function_222(StackVal, StackVal, *(bParam0 + 416));
			if (bParam0->f_700 > 3)
			{
				bVar0 = true;
			}
			if (bParam0->f_620 <= 3)
			{
				Function_219(StackVal, StackVal, StackVal, StackVal, bParam0, *(bParam0 + 416), *(bParam0 + 500), bVar0);
				*(bParam0 + 680) = { StackVal, StackVal, Function_219(StackVal, StackVal, StackVal, StackVal, bParam0, *(bParam0 + 416), *(bParam0 + 500), bVar0) };
			}
			if (Function_98(StackVal, StackVal, *(bParam0 + 680)))
			{
				Function_214(0);
				*(bParam0 + 680) = { StackVal, StackVal, Function_214(0) };
			}
			if (Function_98(StackVal, StackVal, *(bParam0 + 680)))
			{
			...
			{
				if (Function_208(StackVal, StackVal, *(bParam0 + 416), 2096, 0.0f, 150.0f, &vVar1, 0) != "")
				{
				}
				else
				{
		...
		case 0x00000002:
			...
			if (Function_207(StackVal, StackVal, *(bParam0 + 680), 1.0f, 75.0f, 1, 1, 0))
			{
				bParam0->f_672 = 0;
			}
			break;
...
bool Function_207(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x9591 / 38289
{
}

var Function_208(vector3 vParam0, int iParam3, float fParam4, float fParam5, var uParam6, bool bParam7) //Position: 0x95AD / 38317
{
	vector3 vVar0;
	bool bVar3;
	struct<9> Var4;
	...
	bVar10 = -1.0f;
	Function_247();
	*uParam6 = { StackVal, StackVal, Function_247() };
	bVar3 = START_CURVE_QUERY(Global_28841, vParam0, iParam3, fParam4, fParam5, Function_171(((fParam5 - fParam4) / 5.0f), 20.0f), 0);
	if (!GET_NUM_POINTS_IN_CURVE_QUERY(bVar3) < 0)
	{
		Function_210(StackVal, StackVal, bVar3, vParam0, iParam3, fParam4, fParam5, Function_171(((fParam5 - fParam4) / 5.0f), 20.0f));
	}
	else
	{
		bVar11 = false;
...
bool Function_209(bool bParam0) //Position: 0x968B / 38539
{
...
void Function_210(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x96AC / 38572
{
...
void Function_211(bool bParam0) //Position: 0x9763 / 38755
{
	bool bVar0;
	struct<6> Var1;
	...
	while (bVar0 <= GET_NUM_POINTS_IN_CURVE_QUERY(bParam0))
	{
		...
		Function_212(StackVal, StackVal, StackVal, StackVal, StackVal, Var1);
		PRINTSTRING(" from ");
...
void Function_212(struct<17> Param0) //Position: 0x97D2 / 38866
{
	Function_213(&Param0);
	PRINTVECTOR(Function_213(&Param0));
	PRINTSTRING(": t=");
...
vector3 Function_213(bool bParam0) //Position: 0x9807 / 38919
{
	vector3 vVar0;
...
vector3 Function_214(int iParam0) //Position: 0x9826 / 38950
{
	vector3 vVar0;
...
void Function_215(bool bParam0) //Position: 0x9861 / 39009
{
	switch (bParam0)
	{
		case 0x00000004:
...
void Function_216(bool bParam0) //Position: 0x9914 / 39188
{
	if (bParam0 < 0,1f)
	{
...
void Function_217() //Position: 0x9958 / 39256
{
	float fVar0;
	bool bVar1;
	
	Function_218(&fVar0, &bVar1);
	AMBIENT_SET_DISTANCE_FILTER(fVar0, bVar1);
	return;
}

void Function_218(var uParam0, bool bParam1) //Position: 0x996C / 39276
{
	vector3 vVar0;
...
vector3 Function_219(int iParam0, vector3 vParam1, vector3 vParam4, bool bParam7) //Position: 0x99F5 / 39413
{
	bool bVar0;
	bool bVar6;
	float fVar7;
	...
	while (!bVar6 && iVar9 > 10)
	{
		...
		else
		{
			if (!bParam7)
			{
				bVar11 = Function_220(StackVal, StackVal, bVar10, vParam4, 4.0f, 0);
			}
			else
			{
				bVar11 = Function_220(StackVal, StackVal, bVar10, vParam4, 18.0f, 0);
			}
	...
	UNK_0xDF93BD7C(bVar10);
	Function_213(&bVar0);
	vVar12 = { StackVal, StackVal, Function_213(&bVar0) };
	return StackVal, StackVal, vVar12;
}

int Function_220(bool bParam0, vector3 vParam1, float fParam4, int iParam5) //Position: 0x9AED / 39661
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		case 0x00000000:
			while ((StackVal || !(StackVal || FABS(((Function_209(&Var3) || !bVar9) - fParam4 != -1.0f)) > fParam4)) && iVar1 > 10)
			{
		...
		case 0x00000001:
			...
			while (bVar2 <= GET_NUM_POINTS_IN_CURVE_QUERY(bParam0))
			{
				...
				Function_213(&Var3);
				bVar11 = VDIST(Function_213(&Var3), vParam1);
				if (StackVal && (StackVal || FABS((((bVar11 > bVar10 && !Function_209(&Var3)) && !Function_221(&Var3)) - fParam4 != -1.0f)) > fParam4))
				{
					Function_212(StackVal, StackVal, StackVal, StackVal, StackVal, Var3);
					PRINTNL();
					bVar10 = bVar11;
					bVar0 = bVar2;
				}
				else
				{
					...
					else if (Function_209(&Var3))
					{
					}
					else if (Function_221(&Var3))
					{
					}
	...
	if (Function_209(&Var3))
	{
		return 4294967295;
	}
	if (Function_221(&Var3))
	{
		return 4294967295;
	}
	if (Global_30900[1])
	{
		...
		while (bVar2 <= GET_NUM_POINTS_IN_CURVE_QUERY(bParam0))
		{
			...
			Function_213(&iVar12);
			vVar18 = { StackVal, StackVal, Function_213(&iVar12) };
			bVar2++;
		}
		Function_213(&Var3);
		vVar18 = { StackVal, StackVal, Function_213(&Var3) };
	}
	return bVar0;
}

bool Function_221(bool bParam0) //Position: 0x9D50 / 40272
{
	return ((((StackVal && (StackVal && *bParam0 != 0.0f != 0.0f) != 0.0f) && bParam0->f_12 != 0.0f) && bParam0->f_16 != 0.0f) && bParam0->f_20 != 4294967295);
}

int Function_222(vector3 vParam0) //Position: 0x9D7E / 40318
{
	vector3 vVar0;
	int iVar3;
	...
	if (iVar3 >= 0 || Function_118(iVar3, 1024))
	{
		return 1;
	}
	return 0;
...
void Function_223() //Position: 0x9DB2 / 40370
{
	Function_227(0);
...
void Function_224(int iParam0) //Position: 0x9DD7 / 40407
{
	Function_225(&Global_79336, iParam0);
	if (iParam0 & 512 != 0)
	{
...
void Function_225(var uParam0, int iParam1) //Position: 0x9E30 / 40496
{
	Function_226(uParam0, iParam1);
	return;
}

void Function_226(var uParam0, int iParam1) //Position: 0x9E3D / 40509
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_227(int iParam0) //Position: 0x9E4C / 40524
{
...
void Function_228() //Position: 0x9F10 / 40720
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_229(bool bParam0, bool bParam1) //Position: 0x9F29 / 40745
{
	var uVar0;
	...
	Function_237(&Global_78480);
	Function_236(&Global_78480);
	uVar0 = Function_235(37);
	Function_233();
	if (!bParam0)
	{
		Function_232(37, uVar0);
	}
	Function_231(18264, 0);
	Function_230();
	return;
}

void Function_230() //Position: 0x9F75 / 40821
{
...
void Function_231(int iParam0, bool bParam1) //Position: 0x9F94 / 40852
{
	if (bParam1)
	{
		Function_226(&Global_78480 + 124, iParam0);
	}
	else
	{
...
void Function_232(int iParam0, var uParam1) //Position: 0x9FCF / 40911
{
	if (iParam0 > 40)
	{
		return;
...
void Function_233() //Position: 0x9FE9 / 40937
{
	Function_234(&Global_78480 + 220);
	return;
}

void Function_234(int iParam0) //Position: 0x9FF8 / 40952
{
	int iVar0;
...
int Function_235(int iParam0) //Position: 0xA019 / 40985
{
	if (iParam0 > 40)
	{
		return 0;
...
void Function_236(int iParam0) //Position: 0xA032 / 41010
{
	int iVar0;
...
void Function_237(int iParam0) //Position: 0xA056 / 41046
{
	int iVar0;
...
void Function_238() //Position: 0xA07A / 41082
{
	Function_239(&(Global_50170[522]));
	Function_239(&(Global_50170[622]));
	Function_239(&(Global_50170[722]));
	Function_239(&(Global_50170[822]));
	Function_239(&(Global_50170[922]));
	Function_239(&(Global_50170[1022]));
	Function_239(&(Global_50170[1122]));
	return;
}

void Function_239(bool bParam0) //Position: 0xA0C3 / 41155
{
	Global_56092[*bParam0] = 0;
	Function_240(*bParam0, 0.0f, 0, 4294967295, 4294967295, 4294967295);
	return;
}

void Function_240(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xA0DD / 41181
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_243(iParam0), fParam1, true, 0);
	if (bParam2)
	{
		memcpy(&cVar0, StackVal, StackVal, StackVal, Function_242(iParam0), 6);
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_243(iParam0), &cVar0, 2, 2, true);
		Function_241(Function_243(iParam0), 0);
	}
}

void Function_241(bool bParam0, bool bParam1) //Position: 0xA18B / 41355
{
	bool bVar0;
...
struct<16> Function_242(int iParam0) //Position: 0xA1B0 / 41392
{
	char* cVar0[16];
...
var Function_243(int iParam0) //Position: 0xA1E4 / 41444
{
	return Global_50170[iParam022].f_24;
}

void Function_244() //Position: 0xA1F3 / 41459
{
	int iVar0;
...
void Function_245(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0xA21D / 41501
{
	int iVar0;
...
bool Function_246() //Position: 0xA268 / 41576
{
	return NET_IS_MANAGER_INITIALIZED();
}

vector3 Function_247() //Position: 0xA271 / 41585
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_248(int iParam0) //Position: 0xA27A / 41594
{
	int iVar0;
...
void Function_249(int iParam0) //Position: 0xA297 / 41623
{
	if (!Global_8717[iParam0])
	{
...
bool Function_250(int iParam0, int iParam1) //Position: 0xA2CC / 41676
{
	struct<2> Var0;
	vector3 vVar2;
	vector3 vVar5;
	...
	Function_290(5.0f, 8);
	Var0 = { StackVal, Function_290(5.0f, 8) };
	Function_152(iParam0 + 500, 40.0f, &vVar5, 10);
	uVar16 = 16;
	while (iParam0->f_600 <= iParam0->f_596)
	{
		Function_288(&Var0, iParam0->f_600);
		vVar8 = { StackVal, StackVal, Function_288(&Var0, iParam0->f_600) };
		vVar8 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(*(iParam0 + 680), vVar8, StackVal) };
		Function_152(&vVar8, 40.0f, &vVar2, 10);
		...
		{
			bVar14 = Function_272(StackVal, StackVal, StackVal, StackVal, iParam0, iParam0->f_336, vVar2, vVar11, &uVar16, iParam0->f_600, 0, 1, 1);
		}
		if (IS_ACTOR_VALID(bVar14))
		{
			if (IS_ACTOR_ALIVE(bVar14))
			{
				Function_270(iParam0, bVar14, iParam1->f_48);
			}
		}
		iParam0->f_600++;
	}
	Function_290(4.0f, 10);
	Var0 = { StackVal, Function_290(4.0f, 10) };
	while (iParam0->f_608 <= iParam0->f_604)
	{
		Function_288(&Var0, iParam0->f_608);
		vVar8 = { StackVal, StackVal, Function_288(&Var0, iParam0->f_608) };
		vVar8 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(*(iParam0 + 680), vVar8, StackVal) };
		Function_152(&vVar8, 40.0f, &vVar2, 10);
		vVar11 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(vVar2, vVar5, StackVal) };
		vVar11 = { 0.0f, UNK_0x9C40E671(&vVar11), 0.0f };
		if (!Function_98(StackVal, StackVal, vVar2))
		{
			bVar15 = Function_267(StackVal, StackVal, StackVal, StackVal, iParam0->f_336, iParam0 + 332, vVar2, vVar11);
		}
		if (IS_ACTOR_VALID(bVar15))
		{
			Function_251(iParam0, bVar15, iParam1->f_48);
		}
		iParam0->f_608++;
	}
	iParam0->f_672 = 0;
	...
	if (!Function_78(iParam0->f_576, 59, iParam1->f_48))
	{
		...
		{
			Function_299(iParam0->f_576, "law_go_wanted_unarmed", 5.0f, iParam1->f_64, 20.0f, 1, 0);
		}
		else
		{
			Function_299(iParam0->f_576, "law_go_wanted", 5.0f, iParam1->f_64, 20.0f, 1, 0);
		}
	}
	return 1;
}

void Function_251(int iParam0, bool bParam1, bool bParam2) //Position: 0xA505 / 42245
{
	Function_252(bParam1, Function_266(Function_36(iParam0->f_724), *iParam0));
	...
	MEMORY_REPORT_POSITION_AUTO(bParam1, bParam2, true);
...
void Function_252(bool bParam0, int iParam1) //Position: 0xA58E / 42382
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_253(bool bParam0) //Position: 0xA65A / 42586
{
...
void Function_254(var uParam0, bool bParam1) //Position: 0xA9BE / 43454
{
	int iVar0;
...
void Function_255(bool bParam0) //Position: 0xA9E0 / 43488
{
	Function_253(bParam0);
...
void Function_256(bool bParam0, int iParam1) //Position: 0xAB7D / 43901
{
	int iVar0;
...
void Function_257(bool bParam0) //Position: 0xABB0 / 43952
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
	COMBAT_CLASS_AI_SET_ATTRIB_FLOAT(bParam0, 48, 30.0f);
...
void Function_258(bool bParam0) //Position: 0xAD59 / 44377
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
	COMBAT_CLASS_AI_SET_ATTRIB_FLOAT(bParam0, 48, 30.0f);
...
void Function_259(bool bParam0) //Position: 0xAEEA / 44778
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
...
void Function_260(bool bParam0) //Position: 0xB01C / 45084
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
...
void Function_261(bool bParam0) //Position: 0xB1A4 / 45476
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
	COMBAT_CLASS_AI_SET_RANGE_ACCURACY(bParam0, 60.0f);
...
void Function_262(bool bParam0) //Position: 0xB2FE / 45822
{
	Function_253(bParam0);
	Function_256(bParam0, 1);
	COMBAT_CLASS_AI_SET_RANGE_ACCURACY(bParam0, 50.0f);
...
void Function_263(bool bParam0) //Position: 0xB43C / 46140
{
	Function_253(bParam0);
...
void Function_264(bool bParam0) //Position: 0xB45F / 46175
{
	Function_253(bParam0);
	Function_256(bParam0, 0);
	COMBAT_CLASS_AI_SET_RANGE_ACCURACY(bParam0, 50.0f);
...
void Function_265(bool bParam0) //Position: 0xB5C9 / 46537
{
	Function_253(bParam0);
	Function_256(bParam0, 0);
...
int Function_266(int iParam0, bool bParam1) //Position: 0xB604 / 46596
{
...
var Function_267(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5) //Position: 0xB62D / 46637
{
	bool bVar0;
	...
	if (!Function_269(*uParam1, 0, 4294967295, 0))
	{
	}
	bVar0 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, Function_268(uParam0, Function_55(), *uParam1, vParam2, 0, 16, 0), vParam2, vParam5);
	if (Function_246())
	{
...
var Function_268(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0xB67B / 46715
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(bParam0, bParam4, bParam5, bParam6, 1,401298E-45f, vParam1);
}

bool Function_269(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xB693 / 46739
{
...
void Function_270(int iParam0, bool bParam1, bool bParam2) //Position: 0xB6BA / 46778
{
	int iVar0;
	bool bVar1;
...
var Function_271(bool bParam0) //Position: 0xB8ED / 47341
{
	bool bVar0;
...
var Function_272(int iParam0, bool bParam1, vector3 vParam2, vector3 vParam5, var uParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12) //Position: 0xB947 / 47431
{
	bool bVar0;
	char* cVar1[32];
	int iVar9;
	...
	if (!IS_ACTOR_VALID(bVar0) && !(bParam10 && !bParam12))
	{
		...
		if (iParam0->f_588 > 0)
		{
			if (Function_246())
			{
				cVar1 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_279("mplaw", uParam1) };
			}
			else
			{
			...
			if (!bParam11)
			{
				bVar0 = CREATE_ACTOR_IN_LAYOUT(uParam1, &cVar1, Function_278(iParam0), vParam2, vParam5);
			}
			else
			{
				iVar9 = Function_268(StackVal, StackVal, Global_30750[6], vParam2, 4, 23, 0);
				if (Function_277(iVar9, uParam8))
				{
					iVar9 = 976;
				}
				(*uParam8)[iParam9] = iVar9;
				Var10 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_276() };
				bVar0 = Function_274(StackVal, StackVal, StackVal, StackVal, bParam1, &cVar1, Function_278(iParam0), &Var10, iVar9, vParam2, vParam5);
			}
		}
		if (IS_ACTOR_VALID(bVar0))
		{
...
void Function_273(bool bParam0) //Position: 0xBA46 / 47686
{
	if (bParam0->f_588 > 0)
	{
		bParam0->f_616++;
...
bool Function_274(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, vector3 vParam5, vector3 vParam8) //Position: 0xBA71 / 47729
{
	bool bVar0;
	bool bVar1;
...
bool Function_275(int iParam0) //Position: 0xBB96 / 48022
{
...
struct<24> Function_276() //Position: 0xBBAD / 48045
{
	char* cVar0[24];
...
bool Function_277(int iParam0, int iParam1) //Position: 0xBBE8 / 48104
{
	int iVar0;
...
var Function_278(int iParam0) //Position: 0xBC1A / 48154
{
	int iVar0;
...
struct<32> Function_279(bool bParam0, bool bParam1) //Position: 0xBC39 / 48185
{
	struct<8> Var0;
	bool bVar8;
	...
	Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_280(bParam0) };
...
struct<32> Function_280(bool bParam0) //Position: 0xBC88 / 48264
{
	char* cVar0[32];
	struct<4> Var8;
	bool bVar12;
	...
	if (!Function_246())
	{
		return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_128(bParam0);
	}
	if (!IS_STRING_VALID(bParam0))
	{
	}
	else
	{
		...
		{
			memcpy(&Var8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_129("0", &Var8, ""), 4);
		}
		bVar12 = GET_LOCAL_SLOT();
		memcpy(&Var8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_129(I2STR(bVar12), &Var8, ""), 4);
...
void Function_281(int iParam0) //Position: 0xBD37 / 48439
{
	iParam0->f_588 = Function_282(iParam0, 1);
	return;
}

int Function_282(int iParam0, bool bParam1) //Position: 0xBD48 / 48456
{
	bool bVar0;
	bool bVar1;
	...
	while (bVar0 < 11)
	{
		if (Function_285(iParam0, bVar0))
		{
			if (!Function_284(iParam0, bVar0))
			{
				return bVar0;
			}
		}
	...
	if (bParam1)
	{
		...
		return Function_282(iParam0, 0);
	}
	return 4294967295;
}

void Function_283(int iParam0) //Position: 0xBDBF / 48575
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_284(int iParam0, bool bParam1) //Position: 0xBE37 / 48695
{
...
bool Function_285(int iParam0, bool bParam1) //Position: 0xBE4C / 48716
{
	bool bVar0;
...
var Function_286(int iParam0) //Position: 0xBE6E / 48750
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
int Function_287(bool bParam0, bool bParam1) //Position: 0xC00E / 49166
{
	bool bVar0;
	bool bVar1;
...
vector3 Function_288(var uParam0, bool bParam1) //Position: 0xC0B0 / 49328
{
	vector3 vVar0;
...
bool Function_289(int iParam0) //Position: 0xC1F1 / 49649
{
...
struct<8> Function_290(float fParam0, int iParam1) //Position: 0xC213 / 49683
{
	struct<2> Var0;
...
void Function_291(int iParam0, int iParam1) //Position: 0xC22C / 49708
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		case 0x00000000:
			bVar2 = Function_222(StackVal, StackVal, *(iParam0 + 416));
			if (iParam0->f_700 > 3)
			{
				bVar2 = true;
			}
			...
			if (Function_302(0x1000000) && Global_13111 == 1)
			{
				Function_248(0x1000000);
				Function_247();
				*(&Global_26316 + 156) = { StackVal, StackVal, Function_247() };
			}
			if (StackVal && !Function_98(StackVal, Function_302(0x1000000), *(&Global_26316 + 156)))
			{
				if (StackVal <= 1000.0f)
				{
			...
			{
				bVar1 = Function_292(iParam0, "nlaw_spawn");
				if (IS_OBJECT_VALID(bVar1))
				{
					...
					{
						Function_214(0);
						*(iParam0 + 680) = { StackVal, StackVal, Function_214(0) };
					}
				}
			}
			else if (*iParam0 == 3)
			...
			{
				Function_219(StackVal, StackVal, StackVal, StackVal, iParam0, *(iParam0 + 416), *(iParam0 + 500), bVar2);
				*(iParam0 + 680) = { StackVal, StackVal, Function_219(StackVal, StackVal, StackVal, StackVal, iParam0, *(iParam0 + 416), *(iParam0 + 500), bVar2) };
			}
			Function_247();
			*(&Global_26316 + 156) = { StackVal, StackVal, Function_247() };
			...
			{
				if (Function_208(StackVal, StackVal, *(iParam0 + 416), 2096, 0.0f, 150.0f, &vVar9, 0) != "")
				{
				}
				else
				{
		...
		case 0x00000002:
			...
			if (Function_207(StackVal, StackVal, *(iParam0 + 680), 1.0f, 50.0f, 1, 1, 0))
			{
				iParam0->f_672 = 0;
			}
			break;
...
var Function_292(var uParam0, bool bParam1) //Position: 0xC655 / 50773
{
	bool bVar0;
	bool bVar1;
...
int Function_293(int iParam0) //Position: 0xC6A4 / 50852
{
	int iVar0;
	int iVar1;
	...
	if (!Function_34(iParam0[iVar03], 16))
	{
		...
		Function_296(iParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_34(iParam0[iVar03], 4))
		{
			if (!Function_34(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_34(iParam0[03], 8) || iVar1));
						break;
...
void Function_294() //Position: 0xCA1F / 51743
{
	if (!Function_119(128))
	{
		return;
...
bool Function_295() //Position: 0xCA5F / 51807
{
	int iVar0;
...
void Function_296(var uParam0, int iParam1) //Position: 0xCA8A / 51850
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_297() //Position: 0xCA9B / 51867
{
	if (!Function_119(128))
	{
		return;
...
void Function_298(int iParam0) //Position: 0xCADD / 51933
{
...
void Function_299(int iParam0, char* cParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6) //Position: 0xCAF7 / 51959
{
	int iVar0;
...
var Function_300() //Position: 0xCB5A / 52058
{
	int iVar0;
...
void Function_301(int iParam0) //Position: 0xCB99 / 52121
{
	int iVar0;
	float fVar1;
...
bool Function_302(int iParam0) //Position: 0xCBCA / 52170
{
	int iVar0;
...
void Function_303(int iParam0, int iParam1) //Position: 0xCBE8 / 52200
{
	...
	*iParam0 = 1;
	...
	if (iParam1->f_68 == 0)
	{
		iParam1->f_68 = Function_314(iParam1->f_64, iParam1->f_44);
	}
	iParam0->f_596 = iParam1->f_68;
	Function_310(iParam0, iParam0->f_596, 0);
	iParam0->f_604 = Function_309(iParam1->f_44);
	iParam0->f_336 = Function_308("PosseLawResponse");
	...
	iParam0->f_348 = Function_307(iParam1->f_48, 3, 0);
	if (IS_CRIME_VALID(iParam0->f_348))
	{
		GET_CRIME_POSITION(iParam0->f_348, iParam0 + 488);
		iParam0->f_440 = Function_130(GET_CURRENT_GAME_TIME(), Function_130(GET_CRIME_BEGIN_TIMESTAMP(iParam0->f_348), GET_CRIME_END_TIMESTAMP(iParam0->f_348)));
	}
	else
	{
...
void Function_304() //Position: 0xCDD2 / 52690
{
	if (!Function_25(25, 0))
	{
		if (!Function_24(Global_76847, 0x1000000))
		{
			Function_305(&Global_76848, 32768);
		}
	}
	return;
}

void Function_305(var uParam0, int iParam1) //Position: 0xCDFD / 52733
{
	int iVar0;
...
void Function_306(var uParam0, int iParam1) //Position: 0xCE14 / 52756
{
...
var Function_307(bool bParam0, int iParam1, int iParam2) //Position: 0xCFF8 / 53240
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
var Function_308(bool bParam0) //Position: 0xD105 / 53509
{
	int iVar0;
...
int Function_309(int iParam0) //Position: 0xD148 / 53576
{
	if (iParam0 <= 1700)
	{
		return 0;
...
void Function_310(int iParam0, int iParam1, bool bParam2) //Position: 0xD185 / 53637
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (!bParam2)
	{
		iVar3 = Function_313(iParam0->f_724, *iParam0);
	}
	else
	{
		iVar3 = Function_313(iParam0->f_724, 5);
	}
	if (iVar3 > 0)
	{
		iVar4 = 0;
		...
		while (bVar0)
		{
			...
			if (!bParam2)
			{
				Function_311(iParam0, bVar5, 0);
			}
			else
			{
				Function_311(iParam0, bVar5, 1);
			}
			iVar2++;
			(*iParam0 + 260)[bVar5] = 1;
			if (iVar2 == iVar1)
...
void Function_311(int iParam0, bool bParam1, bool bParam2) //Position: 0xD280 / 53888
{
	if (!bParam2)
	{
		switch (*iParam0)
		{
			...
			case 0x00000001:
				if (iParam0->f_724 == 0)
				{
					if (Global_29006 == Global_30717[0])
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 184, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 185, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 186, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 187, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 188, 3, 0);
								break;
						}
					}
					else if (Global_29004 == 2)
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 438, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 424, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 426, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 434, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 435, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 447, 3, 0);
								break;
							
							case 0x00000006:
								Function_312(iParam0 + 60, 448, 3, 0);
								break;
					...
					else if (Global_29004 == 0)
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 436, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 437, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 440, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 441, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 442, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 443, 3, 0);
								break;
							
							case 0x00000006:
								Function_312(iParam0 + 60, 444, 3, 0);
								break;
							
							case 0x00000007:
								Function_312(iParam0 + 60, 445, 3, 0);
								break;
							
							case 0x00000008:
								Function_312(iParam0 + 60, 446, 3, 0);
								break;
							
							case 0x00000009:
								Function_312(iParam0 + 60, 425, 3, 0);
								break;
							
							case 0x0000000A:
								Function_312(iParam0 + 60, 427, 3, 0);
								break;
							
							case 0x0000000B:
								Function_312(iParam0 + 60, 428, 3, 0);
								break;
							
							case 0x0000000C:
								Function_312(iParam0 + 60, 429, 3, 0);
								break;
							
							case 0x0000000D:
								Function_312(iParam0 + 60, 430, 3, 0);
								break;
							
							case 0x0000000E:
								Function_312(iParam0 + 60, 431, 3, 0);
								break;
							
							case 0x0000000F:
								Function_312(iParam0 + 60, 432, 3, 0);
								break;
							
							case 0x00000010:
								Function_312(iParam0 + 60, 433, 3, 0);
								break;
							}
					}
				}
				else if (iParam0->f_724 == 1)
				{
					if (Global_30619 > 3)
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 521, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 522, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 523, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 529, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 530, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 531, 3, 0);
								break;
						}
					}
					else if (Global_29006 == Global_30685[0])
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 461, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 462, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 463, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 464, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 465, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 466, 3, 0);
								break;
						}
					}
					else
					{
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 455, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 456, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 457, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 458, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 459, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 460, 3, 0);
								break;
							}
						}
				}
			...
			case 0x00000002:
				if (iParam0->f_724 == 0)
				{
					...
					{
						case 0x00000000:
							Function_312(iParam0 + 60, 449, 3, 0);
							break;
						
						case 0x00000001:
							Function_312(iParam0 + 60, 450, 3, 0);
							break;
						
						case 0x00000002:
							Function_312(iParam0 + 60, 451, 3, 0);
							break;
						
						case 0x00000003:
							Function_312(iParam0 + 60, 452, 3, 0);
							break;
						
						case 0x00000004:
							Function_312(iParam0 + 60, 453, 3, 0);
							break;
						
						case 0x00000005:
							Function_312(iParam0 + 60, 454, 3, 0);
							break;
					}
				}
				else if (iParam0->f_724 == 1)
				{
					...
					{
						case 0x00000000:
							Function_312(iParam0 + 60, 379, 3, 0);
							break;
						
						case 0x00000001:
							Function_312(iParam0 + 60, 380, 3, 0);
							break;
						
						case 0x00000002:
							Function_312(iParam0 + 60, 381, 3, 0);
							break;
						
						case 0x00000003:
							Function_312(iParam0 + 60, 391, 3, 0);
							break;
						
						case 0x00000004:
							Function_312(iParam0 + 60, 392, 3, 0);
							break;
						
						case 0x00000005:
							Function_312(iParam0 + 60, 393, 3, 0);
							break;
						}
				}
				break;
			...
			case 0x00000003:
				switch (Global_29004)
				{
					case 0x00000000:
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 397, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 398, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 399, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 400, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 401, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 402, 3, 0);
								break;
							
							case 0x00000006:
								Function_312(iParam0 + 60, 403, 3, 0);
								break;
							
							case 0x00000007:
								Function_312(iParam0 + 60, 404, 3, 0);
								break;
							
							case 0x00000008:
								Function_312(iParam0 + 60, 405, 3, 0);
								break;
						}
						break;
					...
					case 0x00000002:
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 415, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 416, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 417, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 418, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 419, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 420, 3, 0);
								break;
							
							case 0x00000006:
								Function_312(iParam0 + 60, 421, 3, 0);
								break;
							
							case 0x00000007:
								Function_312(iParam0 + 60, 422, 3, 0);
								break;
							
							case 0x00000008:
								Function_312(iParam0 + 60, 423, 3, 0);
								break;
						}
						break;
					...
					case 0x00000001:
						...
						{
							case 0x00000000:
								Function_312(iParam0 + 60, 406, 3, 0);
								break;
							
							case 0x00000001:
								Function_312(iParam0 + 60, 407, 3, 0);
								break;
							
							case 0x00000002:
								Function_312(iParam0 + 60, 408, 3, 0);
								break;
							
							case 0x00000003:
								Function_312(iParam0 + 60, 409, 3, 0);
								break;
							
							case 0x00000004:
								Function_312(iParam0 + 60, 410, 3, 0);
								break;
							
							case 0x00000005:
								Function_312(iParam0 + 60, 411, 3, 0);
								break;
							
							case 0x00000006:
								Function_312(iParam0 + 60, 412, 3, 0);
								break;
							
							case 0x00000007:
								Function_312(iParam0 + 60, 413, 3, 0);
								break;
							
							case 0x00000008:
								Function_312(iParam0 + 60, 414, 3, 0);
								break;
						}
						break;
				}
	...
	else if (iParam0->f_724 == 1)
	{
		switch (bParam1)
		{
			...
			case 0x00000006:
				Function_312(iParam0 + 60, 395, 3, 0);
				break;
			
			case 0x00000007:
				Function_312(iParam0 + 60, 396, 3, 0);
				break;
			}
	}
	return;
...
var Function_312(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0xDEC8 / 57032
{
	int iVar0;
	...
	while (iVar0 < (*uParam0 - 1))
	{
		if (!Function_34(uParam0[iVar03], 4))
		{
			...
			Function_296(uParam0[iVar03], 4);
			if (bParam3)
			{
				Function_296(uParam0[iVar03], 8);
			}
			return iVar0;
		}
...
int Function_313(int iParam0, int iParam1) //Position: 0xDF98 / 57240
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_314(int iParam0, int iParam1) //Position: 0xE09F / 57503
{
...
void Function_315(int iParam0) //Position: 0xE0EE / 57582
{
	Function_316(iParam0 + 8, "stand_surrender", 5, 0);
	Function_316(iParam0 + 8, "custom/stand_surrender", 8, 0);
	Function_316(iParam0 + 8, "stand_shakehands", 5, 0);
	Function_316(iParam0 + 8, "custom/stand_shakehands", 8, 0);
	return;
}

var Function_316(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xE176 / 57718
{
	int iVar0;
	bool bVar1;
...
var Function_317(var uParam0, int iParam1, int iParam2) //Position: 0xE1AE / 57774
{
	int iVar0;
