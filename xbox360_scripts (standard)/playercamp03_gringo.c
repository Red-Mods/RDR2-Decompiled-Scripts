...
void main() //Position: 0x0 / 0
{
	...
	*(&Var1 + 228) = 2;
	if (bVar0)
	{
		Function_120(&Var1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp03x");
	}
	else
	{
...
bool Function_59(int iParam0) //Position: 0x2A7E / 10878
{
	...
	*(&Local_0 + 4) = { 1,2023f, 0,008248952f, 1,803332f };
	*(&Local_0 + 4 + 12) = { 0.0f, 91,99133f, 0.0f };
	Function_61(iParam0, &Local_0 + 4);
	Local_0.f_28 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_horse_stay", 1,2023f, 0,008248952f, 1,803332f, 0.0f, 91,99133f, 0.0f);
	*(&Local_0 + 32) = { 0,8178751f, 0,002102481f, -1,287217f };
	*(&Local_0 + 32 + 12) = { 0.0f, 179,551f, 0.0f };
	Function_61(iParam0, &Local_0 + 32);
	Local_0.f_56 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_sit", 0,8178751f, 0,002102481f, -1,287217f, 0.0f, 179,551f, 0.0f);
