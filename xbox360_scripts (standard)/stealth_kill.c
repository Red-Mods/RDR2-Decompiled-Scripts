...
bool Function_67(bool bParam0) //Position: 0x26D4 / 9940
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_68(bool bParam0, bool bParam1) //Position: 0x26F7 / 9975
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_69(bool bParam0, int iParam1) //Position: 0x2812 / 10258
{
...
int Function_70(bool bParam0) //Position: 0x283D / 10301
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2942 / 10562
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(int iParam0) //Position: 0x294F / 10575
{
	if (Function_71(iParam0->f_40, 16))
	{
...
void Function_73(int iParam0, bool bParam1) //Position: 0x29C2 / 10690
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x2EC0 / 11968
{
	bool bVar0;
...
bool Function_75(bool bParam0) //Position: 0x2EF7 / 12023
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_76(var uParam0, int iParam1) //Position: 0x2F14 / 12052
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x2F4C / 12108
{
	iParam0 = iParam0;
	return;
}

bool Function_78(bool bParam0) //Position: 0x2F56 / 12118
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_79(var uParam0, int iParam1) //Position: 0x2F77 / 12151
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x2F85 / 12165
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x308D / 12429
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_82(int iParam0) //Position: 0x30A3 / 12451
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(var uParam0, int iParam1) //Position: 0x3359 / 13145
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_84(bool bParam0) //Position: 0x3367 / 13159
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_85(bool bParam0) //Position: 0x3380 / 13184
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_86(bool bParam0, int iParam1) //Position: 0x339A / 13210
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x33D2 / 13266
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_88(int iParam0, int iParam1) //Position: 0x33E9 / 13289
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_89(bool bParam0) //Position: 0x36B2 / 14002
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_90(bool bParam0, bool bParam1) //Position: 0x36CF / 14031
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_91(int iParam0) //Position: 0x376B / 14187
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x378A / 14218
{
	bool bVar0;
...
bool Function_93(int iParam0) //Position: 0x3813 / 14355
{
...
void Function_94(int iParam0) //Position: 0x382F / 14383
{
	iParam0 = iParam0;
	return;
}

void Function_95(bool bParam0, int iParam1) //Position: 0x3839 / 14393
{
	bool bVar0;
	bool bVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x389B / 14491
{
...
void Function_97(int iParam0) //Position: 0x38AF / 14511
{
	iParam0 = iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x38B9 / 14521
{
