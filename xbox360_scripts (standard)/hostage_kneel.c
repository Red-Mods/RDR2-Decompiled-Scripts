...
void main() //Position: 0x0 / 0
{
	...
	iLocal_53 = 0;
	Function_100(uScriptParam_0, &iLocal_53);
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_58, &bLocal_57);
...
void Function_62(bool bParam0) //Position: 0x2548 / 9544
{
	...
	if (bLocal_0)
	{
		...
		{
			iLocal_1 = 1;
			iLocal_2 = CREATE_LAYOUT("Hostage_Kneel_Layout");
...
var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25A2 / 9634
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2624 / 9764
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x264F / 9807
{
	vector3 vVar0;
...
void Function_66(int iParam0) //Position: 0x26FB / 9979
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x2705 / 9989
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2723 / 10019
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2738 / 10040
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x27BF / 10175
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27E2 / 10210
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2800 / 10240
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x2823 / 10275
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x293E / 10558
{
...
int Function_75(bool bParam0) //Position: 0x2969 / 10601
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A6E / 10862
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2A7B / 10875
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AEE / 10990
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x2FEC / 12268
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x3023 / 12323
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3040 / 12352
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3078 / 12408
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x3082 / 12418
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, bool bParam1) //Position: 0x30A3 / 12451
{
	bParam1 = bParam1;
	uParam0 = uParam0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x30F1 / 12529
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x31F9 / 12793
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x320F / 12815
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x34C5 / 13509
{
	iParam1 = iParam1;
	bLocal_0 = false;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
void Function_91(bool bParam0, int iParam1) //Position: 0x3510 / 13584
{
	bool bVar0;
	int iVar1;
...
void Function_100(bool bParam0, int iParam1) //Position: 0x3935 / 14645
{
	...
	{
		Function_101(&(Local_4[iLocal_5312]), bParam0);
		iLocal_53++;
	}
