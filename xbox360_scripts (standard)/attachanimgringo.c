	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_80, &bLocal_79);
...
void Function_29(bool bParam0, int iParam1) //Position: 0x1D37 / 7479
{
	...
	if (IS_OBJECT_ATTACHED(bVar0))
	{
		...
		if (IS_ATTACHMENT_VALID(bVar1))
		{
			...
			{
				bLocal_1 = ATTACH_OBJECTS_CONTINUOUS(bParam0, bVar2, 4294967295);
			}
		}
	}
	return;
...
bool Function_30(int iParam0) //Position: 0x1D76 / 7542
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D81 / 7553
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D9B / 7579
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DB9 / 7609
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DD8 / 7640
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E0B / 7691
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E2A / 7722
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E44 / 7748
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E57 / 7767
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x213F / 8511
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2147 / 8519
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2164 / 8548
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2173 / 8563
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2195 / 8597
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21B9 / 8633
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21D6 / 8662
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21F6 / 8694
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2216 / 8726
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22C4 / 8900
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2334 / 9012
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x234A / 9034
{
...
var Function_51(bool bParam0) //Position: 0x236B / 9067
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x238B / 9099
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x239F / 9119
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23A9 / 9129
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23B0 / 9136
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23BF / 9151
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23FE / 9214
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2429 / 9257
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2434 / 9268
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x252A / 9514
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x254C / 9548
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2573 / 9587
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2832 / 10290
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x288F / 10383
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28EC / 10476
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28F6 / 10486
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2914 / 10516
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2929 / 10537
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_69(bool bParam0) //Position: 0x2A70 / 10864
{
	bool bVar0;
...
bool Function_70(bool bParam0, int iParam1) //Position: 0x2AED / 10989
{
...
int Function_71(bool bParam0) //Position: 0x2B18 / 11032
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2C1D / 11293
{
	return (uParam0 && iParam1) == 0;
}

void Function_73(int iParam0) //Position: 0x2C2A / 11306
{
	if (Function_72(iParam0->f_40, 16))
	{
...
void Function_74(int iParam0, bool bParam1) //Position: 0x2C9D / 11421
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_75() //Position: 0x319B / 12699
{
	bool bVar0;
...
bool Function_76(bool bParam0) //Position: 0x31D2 / 12754
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_77(var uParam0, int iParam1) //Position: 0x31EF / 12783
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_78(int iParam0) //Position: 0x3227 / 12839
{
	iParam0 = iParam0;
	return;
}

bool Function_79(bool bParam0) //Position: 0x3231 / 12849
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3252 / 12882
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_ATTACHMENT_VALID(bLocal_1))
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x32B6 / 12982
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x33BE / 13246
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_83(int iParam0) //Position: 0x33D4 / 13268
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_84(var uParam0, int iParam1) //Position: 0x368A / 13962
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_85(bool bParam0) //Position: 0x3698 / 13976
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_86(bool bParam0) //Position: 0x36B1 / 14001
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_87(int iParam0, int iParam1) //Position: 0x36CB / 14027
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_88(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3703 / 14083
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_89(int iParam0, int iParam1) //Position: 0x371A / 14106
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_90(bool bParam0) //Position: 0x39E3 / 14819
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_91(bool bParam0, bool bParam1) //Position: 0x3A00 / 14848
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_92(int iParam0) //Position: 0x3A9C / 15004
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_93(var uParam0, int iParam1) //Position: 0x3ABB / 15035
{
	struct<5> Var0;
...
bool Function_94(int iParam0) //Position: 0x3AE3 / 15075
{
...
void Function_95(int iParam0) //Position: 0x3AFF / 15103
{
	iParam0 = iParam0;
	return;
}

void Function_96(bool bParam0, int iParam1) //Position: 0x3B09 / 15113
{
	bool bVar0;
	bool bVar1;
...
void Function_97(int iParam0, int iParam1) //Position: 0x3B6B / 15211
{
...
void Function_98(int iParam0) //Position: 0x3B7F / 15231
{
	iParam0 = iParam0;
	return;
}

void Function_99(int iParam0) //Position: 0x3B89 / 15241
{
