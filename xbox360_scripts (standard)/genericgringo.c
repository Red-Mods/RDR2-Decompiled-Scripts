	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_43(iParam0, bVar8, &iLocal_79, &bLocal_78);
...
void Function_22(bool bParam0, bool bParam1) //Position: 0x1CB2 / 7346
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_23(var uParam0, var uParam1, int iParam2) //Position: 0x1D55 / 7509
{
	bool bVar0;
...
int Function_24(bool bParam0, bool bParam1) //Position: 0x1D7A / 7546
{
	bool bVar0;
	char* cVar1[64];
	bool bVar17;
...
var Function_25(var uParam0, char* cParam1, var uParam2) //Position: 0x1E7A / 7802
{
	var uVar0;
	
	uVar0 = uParam2;
	GET_GRINGO_INT_ATTR(&uVar0, cParam1, uParam0);
	return uVar0;
}

var Function_26() //Position: 0x1E90 / 7824
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_27(bool bParam0) //Position: 0x1E99 / 7833
{
...
float Function_28(bool bParam0) //Position: 0x1EEA / 7914
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_29() //Position: 0x1F00 / 7936
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_30(bool bParam0) //Position: 0x1F0D / 7949
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_31(var uParam0, int iParam1) //Position: 0x1F2D / 7981
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_32(bool bParam0) //Position: 0x1F3C / 7996
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_33() //Position: 0x1F5B / 8027
{
	return;
}

void Function_34(var uParam0, int iParam1) //Position: 0x1F61 / 8033
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_35(int iParam0) //Position: 0x1F6F / 8047
{
	iParam0 = iParam0;
	return 1;
}

bool Function_36(bool bParam0) //Position: 0x1F7A / 8058
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_37(bool bParam0, int iParam1) //Position: 0x1F94 / 8084
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_38(bool bParam0) //Position: 0x1FB2 / 8114
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_39(bool bParam0) //Position: 0x1FD1 / 8145
{
	int iVar0;
	int iVar1;
...
bool Function_40(bool bParam0) //Position: 0x2004 / 8196
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_41(bool bParam0) //Position: 0x2023 / 8227
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_42(var uParam0, int iParam1) //Position: 0x203D / 8253
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_43(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2050 / 8272
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_44() //Position: 0x2338 / 9016
{
	int iVar0;
...
bool Function_45(bool bParam0, bool bParam1) //Position: 0x2340 / 9024
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_46() //Position: 0x235D / 9053
{
...
bool Function_48(bool bParam0, int iParam1) //Position: 0x238E / 9102
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_49(bool bParam0) //Position: 0x23B2 / 9138
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x23CF / 9167
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_51(bool bParam0, int iParam1) //Position: 0x23EF / 9199
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_52(bool bParam0, bool bParam1) //Position: 0x240F / 9231
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_53(bool bParam0, bool bParam1, bool bParam2) //Position: 0x24BD / 9405
{
	bool bVar0;
...
void Function_54(int iParam0, float fParam1) //Position: 0x252D / 9517
{
	if (!Function_14(iParam0))
	{
...
void Function_55(int iParam0, float fParam1) //Position: 0x2543 / 9539
{
...
var Function_56(bool bParam0) //Position: 0x2564 / 9572
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_57(int iParam0) //Position: 0x2584 / 9604
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_58(var uParam0) //Position: 0x2598 / 9624
{
	uParam0 = uParam0;
	return;
}

int Function_59() //Position: 0x25A2 / 9634
{
	return 1;
}

void Function_60(var uParam0, int iParam1) //Position: 0x25A9 / 9641
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_61(bool bParam0, var uParam1, int iParam2) //Position: 0x25B8 / 9656
{
	bool bVar0;
...
bool Function_62(bool bParam0) //Position: 0x25F7 / 9719
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_63(bool bParam0) //Position: 0x2622 / 9762
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_64(bool bParam0) //Position: 0x262D / 9773
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_65(bool bParam0) //Position: 0x2723 / 10019
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_66(bool bParam0) //Position: 0x2745 / 10053
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_67(bool bParam0) //Position: 0x276C / 10092
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_68(vector3 vParam0) //Position: 0x2A2B / 10795
{
	vector3 vVar0;
...
vector3 Function_69(vector3 vParam0) //Position: 0x2A88 / 10888
{
	vector3 vVar0;
...
void Function_70(int iParam0) //Position: 0x2AE5 / 10981
{
	iParam0 = iParam0;
	return;
}

bool Function_71(bool bParam0) //Position: 0x2AEF / 10991
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_72(int iParam0) //Position: 0x2B0D / 11021
{
	if (!Function_14(iParam0))
	{
...
bool Function_73(bool bParam0, bool bParam1) //Position: 0x2B22 / 11042
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_74(int iParam0) //Position: 0x2BA9 / 11177
{
	vector3 vVar0;
...
vector3 Function_75(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2BCC / 11212
{
	vector3 vVar0;
...
bool Function_76(bool bParam0) //Position: 0x2BEA / 11242
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_77(bool bParam0, bool bParam1) //Position: 0x2C0D / 11277
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_78(bool bParam0, int iParam1) //Position: 0x2D28 / 11560
{
...
int Function_79(bool bParam0) //Position: 0x2D53 / 11603
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_80(var uParam0, int iParam1) //Position: 0x2E58 / 11864
{
	return (uParam0 && iParam1) == 0;
}

void Function_81(int iParam0) //Position: 0x2E65 / 11877
{
	if (Function_80(iParam0->f_40, 16))
	{
...
void Function_82(int iParam0, bool bParam1) //Position: 0x2ED8 / 11992
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_83() //Position: 0x33D6 / 13270
{
	bool bVar0;
...
bool Function_84(bool bParam0) //Position: 0x340D / 13325
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_85(var uParam0, int iParam1) //Position: 0x342A / 13354
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_86(int iParam0) //Position: 0x3462 / 13410
{
	iParam0 = iParam0;
	return;
}

bool Function_87(bool bParam0) //Position: 0x346C / 13420
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_88(var uParam0, int iParam1) //Position: 0x348D / 13453
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x349B / 13467
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x35A3 / 13731
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_91(int iParam0) //Position: 0x35B9 / 13753
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_92(var uParam0, int iParam1) //Position: 0x386F / 14447
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_93(bool bParam0) //Position: 0x387D / 14461
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_94(bool bParam0) //Position: 0x3896 / 14486
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_95(int iParam0, int iParam1) //Position: 0x38B0 / 14512
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_96(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_96(var uParam0, int iParam1) //Position: 0x38E8 / 14568
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_97(int iParam0, int iParam1) //Position: 0x38FF / 14591
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_98(bool bParam0) //Position: 0x3BC8 / 15304
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_99(bool bParam0, bool bParam1) //Position: 0x3BE5 / 15333
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_100(int iParam0) //Position: 0x3C81 / 15489
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_101(var uParam0, int iParam1) //Position: 0x3CA0 / 15520
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_102(int iParam0) //Position: 0x3CAF / 15535
{
...
void Function_103(int iParam0) //Position: 0x3CCB / 15563
{
	iParam0 = iParam0;
	return;
}

void Function_104(bool bParam0, int iParam1) //Position: 0x3CD5 / 15573
{
	bool bVar0;
	bool bVar1;
...
void Function_105(int iParam0, int iParam1) //Position: 0x3D37 / 15671
{
...
void Function_106(int iParam0) //Position: 0x3D4B / 15691
{
	iParam0 = iParam0;
	return;
}

void Function_107(int iParam0) //Position: 0x3D55 / 15701
{
