...
void main() //Position: 0x0 / 0
{
	...
	iLocal_187 = 0;
	bLocal_195 = false;
	vLocal_196 = { 696,669f, 78,525f, 1234,57f };
	iLocal_204 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			iVar0 = 3;
			iLocal_188 = 1000;
			bLocal_202 = FIND_NAMED_LAYOUT("Politician_layout");
			...
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					case 0x00000003:
						...
						if (IS_ACTOR_VALID(Global_63541[5755].f_204))
						{
							DESTROY_ACTOR(Global_63541[5755].f_204);
						}
						iVar0 = 5;
						break;
					
					case 0x00000005:
						Function_145(&(Global_63541[5855]), 58, 0x41f00000, 0x42200000, 0);
						iVar0 = 6;
						break;
					
					case 0x00000006:
						if (Function_104("$/cutscene/RCM_31_CS03/RCM_31_CS03", &iLocal_188, 24235, 24228, 23002, 22893, 22470, 22454, 1, 1, 2, 2, 0))
						{
							iVar0 = 8;
						}
						break;
					...
					case 0x00000008:
						Function_103("Politician2_SHORT", 7,5f, 0, 2, 0, 1, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "Politician2_SHORT", 0, 3, false);
						Function_102(Global_63541[ScriptParam_055].f_140, 0);
						Function_5(58, 1, 1, 0);
						Function_4(&Global_63541[5855] + 144, 256);
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x260 / 608
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x27B / 635
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x298 / 664
{
	RELEASE_LAYOUT_REF(bLocal_203);
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x2A3 / 675
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_5(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2B2 / 690
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_6(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x7E7 / 2023
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_7() //Position: 0x95A / 2394
{
	return;
}

void Function_8(var uParam0, var uParam1) //Position: 0x960 / 2400
{
	if (Global_3381)
	{
		return;
...
bool Function_9() //Position: 0x9A2 / 2466
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_10(bool bParam0) //Position: 0x9AB / 2475
{
...
void Function_11() //Position: 0x9FC / 2556
{
	Function_39();
	Function_38();
	Function_38();
...
void Function_12() //Position: 0xA2F / 2607
{
...
void Function_13() //Position: 0xB35 / 2869
{
	float fVar0;
...
void Function_14() //Position: 0xB68 / 2920
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_15() //Position: 0xCF6 / 3318
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_16() //Position: 0xEAA / 3754
{
	Function_17(&Global_28260, 1, 0);
	return;
}

void Function_17(int iParam0, bool bParam1, var uParam2) //Position: 0xEB8 / 3768
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_18() //Position: 0x10A9 / 4265
{
...
struct<8> Function_19() //Position: 0x10BE / 4286
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_20(int iParam0, bool bParam1, bool bParam2) //Position: 0x1159 / 4441
{
	int iVar0;
...
void Function_21(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x13F4 / 5108
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_22() //Position: 0x1A21 / 6689
{
	int iVar0;
...
var Function_23(int iParam0) //Position: 0x1A29 / 6697
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_24(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1A3A / 6714
{
	char* cVar0[32];
...
struct<32> Function_25(char* cParam0, char* cParam1) //Position: 0x1B2F / 6959
{
	char* cVar0[32];
...
void Function_26(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1B48 / 6984
{
	float fVar0;
...
var Function_27(int iParam0, int iParam1) //Position: 0x1BAD / 7085
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_28(int iParam0, bool bParam1) //Position: 0x1BBF / 7103
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_29(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1BD1 / 7121
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_30(int iParam0) //Position: 0x1D01 / 7425
{
	return Global_35278[iParam020].f_48;
}

float Function_31(int iParam0) //Position: 0x1D10 / 7440
{
	if (!iParam0 != 4294967295)
	{
...
var Function_32(int iParam0) //Position: 0x1D49 / 7497
{
	if (iParam0 == 4294967295)
	{
...
void Function_33(int iParam0) //Position: 0x1D86 / 7558
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_34(int iParam0, bool bParam1, bool bParam2) //Position: 0x1F20 / 7968
{
	int iVar0;
	int iVar1;
...
int Function_35(bool bParam0) //Position: 0x213A / 8506
{
...
struct<8> Function_36() //Position: 0x217B / 8571
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_37() //Position: 0x2204 / 8708
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_38() //Position: 0x229B / 8859
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_39() //Position: 0x231A / 8986
{
...
int Function_40(int iParam0, bool bParam1, int iParam2) //Position: 0x2340 / 9024
{
	int iVar0;
	int iVar1;
...
void Function_41() //Position: 0x254A / 9546
{
	vector3 vVar0;
	var uVar3;
...
bool Function_42(vector3 vParam0) //Position: 0x25EB / 9707
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_43(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2603 / 9731
{
	int iVar0;
...
vector3 Function_44() //Position: 0x26EA / 9962
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_45(int iParam0) //Position: 0x26F3 / 9971
{
...
int Function_46(bool bParam0, bool bParam1) //Position: 0x2709 / 9993
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_47(vector3 vParam0, vector3 vParam3) //Position: 0x27D0 / 10192
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x27ED / 10221
{
	uParam0 = uParam0;
...
void Function_49(bool bParam0) //Position: 0x2891 / 10385
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_50(int iParam0, int iParam1) //Position: 0x2A33 / 10803
{
	int iVar0;
	bool bVar1;
...
void Function_51(int iParam0) //Position: 0x2AED / 10989
{
	float fVar0;
	bool bVar1;
...
int Function_52(var uParam0, int iParam1) //Position: 0x2B8F / 11151
{
	int iVar0;
	var uVar1;
...
void Function_53(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x2CF0 / 11504
{
	struct<8> Var0;
...
struct<32> Function_54(bool bParam0) //Position: 0x2D8B / 11659
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_55(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2DF5 / 11765
{
	char* cVar0[32];
...
int Function_56(bool bParam0) //Position: 0x2E14 / 11796
{
	int iVar0;
	vector3 vVar1;
...
float Function_57(bool bParam0, vector3 vParam1) //Position: 0x2F75 / 12149
{
	vector3 vVar0;
...
vector3 Function_58(bool bParam0) //Position: 0x2FEF / 12271
{
	vector3 vVar0;
...
void Function_59(int iParam0) //Position: 0x3059 / 12377
{
...
bool Function_60(int iParam0) //Position: 0x30BA / 12474
{
...
void Function_61(int iParam0, int iParam1) //Position: 0x30D0 / 12496
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_62(bool bParam0) //Position: 0x3215 / 12821
{
...
var Function_63(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x3241 / 12865
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_64(int iParam0) //Position: 0x325D / 12893
{
...
bool Function_65(int iParam0, int iParam1) //Position: 0x3272 / 12914
{
...
bool Function_66(int iParam0, int iParam1) //Position: 0x3387 / 13191
{
	int iVar0;
...
bool Function_67(int iParam0) //Position: 0x34CB / 13515
{
...
bool Function_68(int iParam0) //Position: 0x34EF / 13551
{
...
bool Function_69(int iParam0) //Position: 0x3504 / 13572
{
...
var Function_70(int iParam0) //Position: 0x351B / 13595
{
...
bool Function_71(int iParam0) //Position: 0x3535 / 13621
{
...
bool Function_72(int iParam0) //Position: 0x354B / 13643
{
	return StackVal;
}

bool Function_73(var uParam0, int iParam1) //Position: 0x355B / 13659
{
	int iVar0;
...
bool Function_74(int iParam0) //Position: 0x3577 / 13687
{
	if (!iParam0->f_152)
	{
...
bool Function_75(int iParam0) //Position: 0x35BE / 13758
{
...
bool Function_76(int iParam0) //Position: 0x3617 / 13847
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x3633 / 13875
{
	int iVar0;
...
int Function_78(int iParam0) //Position: 0x364F / 13903
{
...
bool Function_79(int iParam0) //Position: 0x3664 / 13924
{
...
int Function_80(int iParam0) //Position: 0x3679 / 13945
{
...
bool Function_81(var uParam0, bool bParam1) //Position: 0x368E / 13966
{
	return (uParam0 && bParam1) == 0;
}

void Function_82() //Position: 0x369B / 13979
{
...
var Function_83(int iParam0, int iParam1) //Position: 0x3716 / 14102
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_84(int iParam0, bool bParam1) //Position: 0x4308 / 17160
{
	int iVar0;
...
int Function_85(int iParam0) //Position: 0x4345 / 17221
{
	int iVar0;
	int iVar1;
...
bool Function_86(int iParam0) //Position: 0x4394 / 17300
{
...
int Function_87(int iParam0) //Position: 0x43AA / 17322
{
...
void Function_88() //Position: 0x4413 / 17427
{
...
bool Function_89(int iParam0) //Position: 0x4436 / 17462
{
	if (!Function_86(iParam0))
	{
...
bool Function_90(int iParam0, int iParam1) //Position: 0x4487 / 17543
{
	int iVar0;
...
bool Function_91(int iParam0) //Position: 0x44B4 / 17588
{
	if (!Function_86(iParam0))
	{
...
void Function_92(bool bParam0) //Position: 0x4506 / 17670
{
	bool bVar0;
...
void Function_93() //Position: 0x4540 / 17728
{
	bool bVar0;
...
void Function_94(int iParam0, int iParam1) //Position: 0x459E / 17822
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_95(bool bParam0) //Position: 0x45B1 / 17841
{
	PRINTSTRING("Day ");
...
void Function_96(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x45F7 / 17911
{
	bool bVar0;
	char* cVar1[16];
...
void Function_97(char* cParam0, int iParam1) //Position: 0x4663 / 18019
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_98(bool bParam0, var uParam1, int iParam2) //Position: 0x469A / 18074
{
	var uVar0;
	char* cVar1[16];
...
int Function_99(char* cParam0) //Position: 0x4712 / 18194
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_100(int iParam0) //Position: 0x47B3 / 18355
{
	int iVar0;
	int iVar1;
...
bool Function_101(var uParam0, int iParam1) //Position: 0x47F0 / 18416
{
...
void Function_102(bool bParam0, bool bParam1) //Position: 0x4803 / 18435
{
	bool bVar0;
...
void Function_103(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x4828 / 18472
{
	int iVar0;
...
bool Function_104(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x487B / 18555
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_105(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x4924 / 18724
{
	if (!bParam15)
	{
...
void Function_106(bool bParam0) //Position: 0x4F38 / 20280
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_107() //Position: 0x4FDD / 20445
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_108() //Position: 0x5022 / 20514
{
...
void Function_109(bool bParam0, bool bParam1) //Position: 0x5034 / 20532
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_110(bool bParam0) //Position: 0x50B4 / 20660
{
	bool bVar0;
...
float Function_111(int iParam0) //Position: 0x50E3 / 20707
{
...
bool Function_112(int iParam0) //Position: 0x51AB / 20907
{
	return Function_81(*iParam0, 2);
}

bool Function_113(int iParam0) //Position: 0x51B8 / 20920
{
	return Function_81(*iParam0, 1);
}

int Function_114(bool bParam0) //Position: 0x51C5 / 20933
{
	bool bVar0;
	bool bVar1;
...
bool Function_115() //Position: 0x527D / 21117
{
	bool bVar0;
	bool bVar1;
...
void Function_116(int iParam0) //Position: 0x52B7 / 21175
{
	Function_117(iParam0, 0.0f);
	return;
}

void Function_117(var uParam0, float fParam1) //Position: 0x52C3 / 21187
{
...
bool Function_118(int iParam0) //Position: 0x52E4 / 21220
{
	return iParam0->f_20;
}

void Function_119(var uParam0, int iParam1) //Position: 0x52EE / 21230
{
	Function_120(uParam0, iParam1, 0);
	return;
}

void Function_120(var uParam0, bool bParam1, bool bParam2) //Position: 0x52FC / 21244
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_121(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5448 / 21576
{
	int iVar0;
	int iVar1;
...
void Function_122(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5668 / 22120
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_123() //Position: 0x5691 / 22161
{
	bool bVar0;
	bool bVar1;
...
void Function_124() //Position: 0x56DC / 22236
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_125() //Position: 0x57B6 / 22454
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_126() //Position: 0x57C6 / 22470
{
	Function_128(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	Function_127(Global_63541[5855].f_208, 1);
	DESTROY_VOLUME(fLocal_201);
	return 1;
}

void Function_127(bool bParam0, bool bParam1) //Position: 0x57EC / 22508
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_128(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x5868 / 22632
{
	bool bVar0;
...
void Function_129() //Position: 0x5958 / 22872
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_130() //Position: 0x596D / 22893
{
	SNAP_ACTOR_TO_GRINGO(Global_63541[5855].f_204, GET_OBJECT_FROM_GRINGO(Global_63541[5855].f_208), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(Global_63541[5855].f_204, Global_63541[5855].f_208, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, 686,966f, 79,306f, 1241,989f, 245,631f, 1, true, 1);
	return 1;
}

int Function_131() //Position: 0x59DA / 23002
{
	if (!iLocal_204)
	{
		Function_132(StackVal, StackVal, vLocal_196, bLocal_201);
		Function_127(Global_63541[5855].f_208, 0);
		iLocal_204 = 1;
	}
	return 1;
}

void Function_132(vector3 vParam0) //Position: 0x5A00 / 23040
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_133(bool bParam0, bool bParam1) //Position: 0x5B86 / 23430
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_134(bool bParam0, float fParam1) //Position: 0x5C77 / 23671
{
...
void Function_135() //Position: 0x5D75 / 23925
{
...
void Function_136() //Position: 0x5DA7 / 23975
{
...
int Function_137() //Position: 0x5EA4 / 24228
{
	return 1;
}

int Function_138() //Position: 0x5EAB / 24235
{
	bLocal_201 = CREATE_VOLUME_IN_LAYOUT(bLocal_203, "tempcutscenevol", 2, *(&Global_63541[5855] + 100), 0.0f, 0.0f, 0.0f, 7.0f, 5.0f, 5.0f);
	Function_141(0, 1, 0, 1, 0, 1, 1, bLocal_201, 1, 1, 1, 1);
	Function_139(StackVal, StackVal, bLocal_203, *(&Global_63541[5855] + 112), &bLocal_201, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_139(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x5F05 / 24325
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_140(bool bParam0, bool bParam1) //Position: 0x6173 / 24947
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_141(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x61E8 / 25064
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_144(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_22(), 2, Function_144(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_142(int iParam0) //Position: 0x6491 / 25745
{
	int iVar0;
...
var Function_143() //Position: 0x64C5 / 25797
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_144(bool bParam0) //Position: 0x6544 / 25924
{
	vector3 vVar0;
...
int Function_145(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x6555 / 25941
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
float Function_146(float fParam0) //Position: 0x66B6 / 26294
{
...
int Function_147(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x66EB / 26347
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_148() //Position: 0x6931 / 26929
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
...
void Function_149(char* cParam0, vector3 vParam1) //Position: 0x6985 / 27013
{
	char* cVar0[64];
...
bool Function_150(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x6AAD / 27309
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_58(bParam0);
...
int Function_151() //Position: 0x6B37 / 27447
{
	if (IS_PS3())
	{
		return 1;
...
void Function_152() //Position: 0x6B46 / 27462
{
	var uVar0;
	
	Function_153(4, 1);
	uVar0 = uVar0;
	bLocal_203 = CREATE_LAYOUT("Politician_layout");
	return;
}

void Function_153(int iParam0, int iParam1) //Position: 0x6B6E / 27502
{
	switch (iParam1)
	{
		case 0x00000000:
