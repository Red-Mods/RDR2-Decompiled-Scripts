				...
				switch (iVar0)
				{
					case 0x00000000:
						if (Function_118(&uLocal_188) && IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								bLocal_193 = CREATE_GRINGO_IN_LAYOUT(bLocal_192, Function_117(), "RCM_AztecGold_Treasure", -1198,985f, 19,075f, 4963,606f, 0.0f, 180.0f, 0.0f);
								iVar0 = 5;
							}
							else if (!IS_LAYOUTREF_VALID(FIND_NAMED_LAYOUT("AztecGold_layout")))
							{
								Function_115();
								bLocal_192 = bLocal_205;
							}
							else
							{
					...
					case 0x00000006:
						if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(Global_34573)))
						{
							...
							iLocal_203 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_63541[ScriptParam_055].f_140);
							bLocal_204 = false;
							while (bLocal_204 <= iLocal_203)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_63541[ScriptParam_055].f_140, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_63541[ScriptParam_055].f_140, bLocal_204), 4, 0);
								bLocal_204++;
							}
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "AztecGold3_OBJ", 0, 3, false);
							Function_113(Global_63541[ScriptParam_055].f_140, 0);
							Function_34(6, 1, 1, 0);
							Function_30(Function_32(1, 1, 1, 0, 0), 1);
							Function_9(Global_30707[5]);
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x294 / 660
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x2AF / 687
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x2CC / 716
{
	RELEASE_LAYOUT_REF(bLocal_205);
	return;
}

void Function_4(int iParam0) //Position: 0x2D7 / 727
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x2FD / 765
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x42B / 1067
{
	int iVar0;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x445 / 1093
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x462 / 1122
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_9(int iParam0) //Position: 0x471 / 1137
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_10() //Position: 0x570 / 1392
{
	return NET_IS_MANAGER_INITIALIZED();
}

float Function_11(int iParam0) //Position: 0x579 / 1401
{
...
float Function_12(int iParam0) //Position: 0x5B6 / 1462
{
	if (!iParam0 != 4294967295)
	{
...
void Function_13(int iParam0, bool bParam1) //Position: 0x5EF / 1519
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x656 / 1622
{
	int iVar0;
...
bool Function_15(int iParam0) //Position: 0x6AE / 1710
{
...
int Function_16(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6C4 / 1732
{
	int iVar0;
	int iVar1;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x8E4 / 2276
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18(int iParam0) //Position: 0xF11 / 3857
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xF22 / 3874
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0, char* cParam1) //Position: 0x1017 / 4119
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1030 / 4144
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x1095 / 4245
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x10A7 / 4263
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x10B9 / 4281
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x11E9 / 4585
{
	return Global_35278[iParam020].f_48;
}

void Function_26(int iParam0) //Position: 0x11F8 / 4600
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1392 / 5010
{
	int iVar0;
	int iVar1;
...
void Function_28(var uParam0, int iParam1) //Position: 0x15AC / 5548
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_29(var uParam0, int iParam1) //Position: 0x15BB / 5563
{
	int iVar0;
...
int Function_30(bool bParam0, bool bParam1) //Position: 0x15D7 / 5591
{
	bool bVar0;
...
int Function_31(int iParam0) //Position: 0x16A2 / 5794
{
	if (iParam0 == 4294967295)
	{
...
var Function_32(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x16E3 / 5859
{
	bool bVar0;
	...
	if (bParam3)
	{
		if (HAS_ITEM(Function_33(17), Global_34573))
		{
			bVar0 = (bVar0 * 1,2f);
		}
	}
...
var Function_33(bool bParam0) //Position: 0x17E5 / 6117
{
	bool bVar0;
...
void Function_34(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x18D6 / 6358
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!Function_112(Global_76846, 2097152))
	{
		Function_107(Global_34573, 2097152, 1, 0);
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
	{
...
void Function_35(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1E0B / 7691
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_36() //Position: 0x1F7E / 8062
{
	return;
}
...
void Function_38(bool bParam0) //Position: 0x1FC6 / 8134
{
...
void Function_39() //Position: 0x2017 / 8215
{
	Function_52();
	Function_51();
	Function_51();
...
void Function_40() //Position: 0x204A / 8266
{
...
void Function_41() //Position: 0x2150 / 8528
{
	float fVar0;
...
void Function_42() //Position: 0x2183 / 8579
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_43() //Position: 0x2311 / 8977
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_44() //Position: 0x24C5 / 9413
{
	Function_45(&Global_28260, 1, 0);
	return;
}

void Function_45(int iParam0, bool bParam1, var uParam2) //Position: 0x24D3 / 9427
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_46() //Position: 0x26C4 / 9924
{
...
struct<8> Function_47() //Position: 0x26D9 / 9945
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_48(int iParam0, bool bParam1, bool bParam2) //Position: 0x2774 / 10100
{
	int iVar0;
...
struct<8> Function_49() //Position: 0x2A0F / 10767
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_50() //Position: 0x2A98 / 10904
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_51() //Position: 0x2B2F / 11055
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_52() //Position: 0x2BAE / 11182
{
...
int Function_53(int iParam0, bool bParam1, int iParam2) //Position: 0x2BD4 / 11220
{
	int iVar0;
	int iVar1;
...
void Function_54() //Position: 0x2DDE / 11742
{
	vector3 vVar0;
	var uVar3;
...
bool Function_55(vector3 vParam0) //Position: 0x2E7F / 11903
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_56(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2E97 / 11927
{
	int iVar0;
...
vector3 Function_57() //Position: 0x2F7E / 12158
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_58(int iParam0) //Position: 0x2F87 / 12167
{
...
int Function_59(bool bParam0, bool bParam1) //Position: 0x2F9D / 12189
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_60(vector3 vParam0, vector3 vParam3) //Position: 0x3064 / 12388
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_61(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3081 / 12417
{
	uParam0 = uParam0;
...
void Function_62(bool bParam0) //Position: 0x3125 / 12581
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (bVar0)
	{
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_92(Global_63541[iVar155].f_144, 2048))
				{
					iVar3 = iVar1;
					if (Function_77(&(Global_63541[iVar155]), iVar3))
					{
...
void Function_63(int iParam0, int iParam1) //Position: 0x32C7 / 12999
{
	int iVar0;
	bool bVar1;
	...
	if ((((Function_92(iParam0->f_144, 2048) || Global_3380) || Global_3382) || Global_3392) || Global_34165.f_28)
	{
		return;
	}
	iVar0 = iParam0->f_96;
...
void Function_64(int iParam0) //Position: 0x3381 / 13185
{
	float fVar0;
	bool bVar1;
...
int Function_65(var uParam0, int iParam1) //Position: 0x3423 / 13347
{
	int iVar0;
	var uVar1;
...
void Function_66(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3584 / 13700
{
	struct<8> Var0;
...
struct<32> Function_67(bool bParam0) //Position: 0x361F / 13855
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3689 / 13961
{
	char* cVar0[32];
...
int Function_69(bool bParam0) //Position: 0x36A8 / 13992
{
	int iVar0;
	vector3 vVar1;
...
float Function_70(bool bParam0, vector3 vParam1) //Position: 0x3809 / 14345
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0) //Position: 0x3883 / 14467
{
	vector3 vVar0;
...
void Function_72(int iParam0) //Position: 0x38ED / 14573
{
...
void Function_73(int iParam0, int iParam1) //Position: 0x394E / 14670
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if (((StackVal && Function_75(StackVal, Function_76(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_74(iParam1)) || Global_74542[iParam110].f_12 != 1)
	{
...
int Function_74(bool bParam0) //Position: 0x3A93 / 14995
{
...
var Function_75(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x3ABF / 15039
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_76(int iParam0) //Position: 0x3ADB / 15067
{
...
bool Function_77(int iParam0, int iParam1) //Position: 0x3AF0 / 15088
{
	if (Function_92(Global_63541[iParam155].f_144, 64))
	{
		return 1;
	}
	...
	if ((Function_91(iParam1) || Function_90(iParam1)) || Function_89(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
	...
	if (!Function_78(iParam0, iParam1))
	{
		return 0;
	}
	Function_8(&Global_63541[iParam155] + 144, 64);
...
bool Function_78(int iParam0, int iParam1) //Position: 0x3C05 / 15365
{
	int iVar0;
	...
	if (!iParam0->f_172 != 0)
	{
		...
		{
			iVar0 = Function_82(iParam0->f_176);
...
bool Function_79(int iParam0) //Position: 0x3D49 / 15689
{
...
bool Function_80(int iParam0) //Position: 0x3D6D / 15725
{
...
bool Function_81(int iParam0) //Position: 0x3D82 / 15746
{
...
var Function_82(int iParam0) //Position: 0x3D99 / 15769
{
...
bool Function_83(int iParam0) //Position: 0x3DB3 / 15795
{
...
bool Function_84(int iParam0) //Position: 0x3DC9 / 15817
{
	return StackVal;
}

bool Function_85(var uParam0, int iParam1) //Position: 0x3DD9 / 15833
{
	int iVar0;
...
bool Function_86(int iParam0) //Position: 0x3DF5 / 15861
{
	if (!iParam0->f_152)
	{
...
bool Function_87(int iParam0) //Position: 0x3E3C / 15932
{
	if (!Function_88(1048576) || Global_3381)
	{
		return 1;
	}
	if (!Function_92(Global_63541[iParam055].f_144, 32768))
	{
		if ((Global_3403 || Global_3405) || Global_3404)
		{
			if (!Function_112(Global_76847, 0x8000000))
			{
				Function_107(Global_34573, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
bool Function_88(int iParam0) //Position: 0x3E95 / 16021
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x3EB1 / 16049
{
...
bool Function_90(int iParam0) //Position: 0x3EC6 / 16070
{
...
int Function_91(int iParam0) //Position: 0x3EDB / 16091
{
...
bool Function_92(var uParam0, bool bParam1) //Position: 0x3EF0 / 16112
{
	return (uParam0 && bParam1) == 0;
}

void Function_93() //Position: 0x3EFD / 16125
{
	if (Function_97(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_4 = Function_96(Global_28180);
...
var Function_94(int iParam0, int iParam1) //Position: 0x3F78 / 16248
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_95(6, 0) && Function_90(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_95(9, 0) && Function_90(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_95(int iParam0, bool bParam1) //Position: 0x4B6C / 19308
{
	int iVar0;
...
int Function_96(int iParam0) //Position: 0x4BA9 / 19369
{
	int iVar0;
	int iVar1;
...
bool Function_97(int iParam0) //Position: 0x4BF8 / 19448
{
...
int Function_98(int iParam0) //Position: 0x4C0E / 19470
{
...
void Function_99() //Position: 0x4C77 / 19575
{
...
bool Function_100(int iParam0) //Position: 0x4C9A / 19610
{
	if (!Function_97(iParam0))
	{
...
bool Function_101(int iParam0, int iParam1) //Position: 0x4CEB / 19691
{
	int iVar0;
...
bool Function_102(int iParam0) //Position: 0x4D18 / 19736
{
	if (!Function_97(iParam0))
	{
...
void Function_103(bool bParam0) //Position: 0x4D6A / 19818
{
	bool bVar0;
...
void Function_104() //Position: 0x4DA4 / 19876
{
	bool bVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x4E02 / 19970
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_106(bool bParam0) //Position: 0x4E15 / 19989
{
	PRINTSTRING("Day ");
...
void Function_107(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x4E5B / 20059
{
	bool bVar0;
	char* cVar1[16];
...
void Function_108(char* cParam0, int iParam1) //Position: 0x4EC7 / 20167
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_109(bool bParam0, var uParam1, int iParam2) //Position: 0x4EFE / 20222
{
	var uVar0;
	char* cVar1[16];
...
int Function_110(char* cParam0) //Position: 0x4F76 / 20342
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_111(int iParam0) //Position: 0x5017 / 20503
{
	int iVar0;
	int iVar1;
...
bool Function_112(var uParam0, int iParam1) //Position: 0x5054 / 20564
{
...
void Function_113(bool bParam0, bool bParam1) //Position: 0x5067 / 20583
{
	bool bVar0;
...
void Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x508C / 20620
{
...
void Function_115() //Position: 0x50C6 / 20678
{
	var uVar0;
	
	Function_116(4, 1);
	uVar0 = uVar0;
	bLocal_205 = CREATE_LAYOUT("AztecGold_layout");
	return;
}

void Function_116(int iParam0, int iParam1) //Position: 0x50ED / 20717
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_117() //Position: 0x5136 / 20790
{
	int iVar0;
...
int Function_118(int iParam0) //Position: 0x513E / 20798
{
	int iVar0;
	int iVar1;
...
void Function_119() //Position: 0x54B9 / 21689
{
	if (!Function_88(128))
	{
		return;
...
bool Function_120() //Position: 0x54F9 / 21753
{
	int iVar0;
...
void Function_121(var uParam0, int iParam1) //Position: 0x5524 / 21796
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_122() //Position: 0x5535 / 21813
{
	if (!Function_88(128))
	{
		return;
...
var Function_123(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5577 / 21879
{
	int iVar0;
	bool bVar1;
...
var Function_124(var uParam0, int iParam1, int iParam2) //Position: 0x55AF / 21935
{
	int iVar0;
