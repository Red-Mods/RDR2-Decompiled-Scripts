...
void main() //Position: 0x0 / 0
{
	...
	iLocal_97 = 0;
	iLocal_131 = 1;
	vLocal_98 = Global_30723[4];
	if (!Function_202(&vLocal_98))
	{
...
{
	if (!Function_151(&vLocal_98, &bLocal_125, 19598, 1))
	{
		return 0;
	}
	switch (vLocal_98.y)
		...
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				if ((&vLocal_98 + 16)->f_32)
				{
					Function_114(1, "a");
					Function_107(0, "b");
					Function_106("AM_MH_8_help", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
...
bool Function_85(bool bParam0, bool bParam1, float fParam2) //Position: 0x1CAE / 7342
{
	struct<17> Var0;
...
bool Function_86(int iParam0) //Position: 0x1F01 / 7937
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_87(bool bParam0) //Position: 0x1F44 / 8004
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x1F6B / 8043
{
	return *iParam0;
}

void Function_89(var uParam0, int iParam1) //Position: 0x1F74 / 8052
{
	*uParam0 = Local_50[iParam12];
	return;
}

void Function_90(int iParam0) //Position: 0x1F83 / 8067
{
	Function_57(iParam0, 4294967286);
	return;
}

bool Function_91(bool bParam0) //Position: 0x1F91 / 8081
{
	return _IS_CLIENT_DATA_VALID_FOR_SLOT(&Local_50, bParam0);
}

void Function_92(var uParam0, bool bParam1) //Position: 0x1F9E / 8094
{
	if (bParam1)
	{
...
bool Function_93(bool bParam0) //Position: 0x1FB8 / 8120
{
	return Function_37(*bParam0, 2);
}

bool Function_94() //Position: 0x1FC5 / 8133
{
...
bool Function_95(int iParam0, var uParam1, int iParam2) //Position: 0x1FE3 / 8163
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_96(int iParam0, bool bParam1) //Position: 0x2034 / 8244
{
	if (bParam1)
	{
...
bool Function_97(int iParam0) //Position: 0x204E / 8270
{
	return Function_37(*iParam0, 1);
}

void Function_98(int iParam0) //Position: 0x205B / 8283
{
	bool bVar0;
	int iVar1;
	struct<13> Var2;
...
int Function_99(bool bParam0) //Position: 0x2158 / 8536
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_100(int iParam0, float fParam1) //Position: 0x21A8 / 8616
{
	Function_101(iParam0, -fParam1);
	return;
}

void Function_101(var uParam0, float fParam1) //Position: 0x21B6 / 8630
{
	Function_61();
...
void Function_102(var uParam0, var uParam1) //Position: 0x21CA / 8650
{
	uParam0->f_4 = uParam1;
...
void Function_103() //Position: 0x21E7 / 8679
{
	bool bVar0;
...
void Function_104(bool bParam0, bool bParam1) //Position: 0x2211 / 8721
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_105(int iParam0, int iParam1) //Position: 0x22D3 / 8915
{
	if (!Function_64(iParam0))
	{
...
void Function_106(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x22E9 / 8937
{
	int iVar0;
...
void Function_107(char* cParam0, bool bParam1) //Position: 0x2334 / 9012
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	
	iLocal_126 = Function_113();
	...
	{
		case 0x00000003:
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_01", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_02", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_03", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_04", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_05", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_06", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_07", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_08", fVar3, fVar4);
		
		case 0x00000002:
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_09", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_10", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_11", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_12", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_13", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_14", fVar3, fVar4);
		
		case 0x00000001:
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_15", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_16", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_17", fVar3, fVar4);
			Function_108(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_18", fVar3, fVar4);
			break;
	}
	return;
}

void Function_108(var uParam0, char* cParam1, vector3 vParam2, var uParam5, char* cParam6, float fParam7, float fParam8) //Position: 0x2612 / 9746
{
	char* cVar0[32];
	var uVar8;
...
void Function_109(bool bParam0, int iParam1) //Position: 0x2640 / 9792
{
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x2663 / 9827
{
	switch (bParam1)
	{
		case 0x00000000:
...
var Function_111(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x26FC / 9980
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool Function_112(vector3 vParam0) //Position: 0x2788 / 10120
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_113() //Position: 0x27A0 / 10144
{
	int iVar0;
	int iVar1;
...
void Function_114(char* cParam0, int iParam1) //Position: 0x27CF / 10191
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 5.0f;
	fVar4 = 75.0f;
	Function_108(StackVal, StackVal, cParam0, iParam1, vVar0, 1094, "named_cougar_01", fVar3, fVar4);
	return;
}

void Function_115(var uParam0, bool bParam1) //Position: 0x2816 / 10262
{
	struct<9> Var0;
...
void Function_116() //Position: 0x284D / 10317
{
	switch (vLocal_98.z)
	{
		case 0x00000000:
...
void Function_117(int iParam0) //Position: 0x2905 / 10501
{
	var uVar0;
...
int Function_118(int iParam0) //Position: 0x291A / 10522
{
...
void Function_119(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x2942 / 10562
{
	bool bVar0;
	bool bVar1;
...
void Function_120() //Position: 0x29C4 / 10692
{
	switch (vLocal_98.z)
	{
		case 0x00000000:
...
void Function_121(var uParam0, bool bParam1) //Position: 0x2A6F / 10863
{
	bool bVar0;
	bool bVar1;
...
void Function_122() //Position: 0x2B0B / 11019
{
	int iVar0;
	...
	switch (vLocal_98.z)
	{
		...
		case 0x00000006:
			bLocal_125 = CREATE_LAYOUT("cougarWilderness");
...
void Function_123(var uParam0) //Position: 0x2BA3 / 11171
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_126(int iParam0) //Position: 0x2D23 / 11555
{
...
void Function_127(int iParam0) //Position: 0x2DB8 / 11704
{
	int iVar0;
...
void Function_128() //Position: 0x2DDE / 11742
{
	bLocal_132 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_125, "squad_cougar"));
...
void Function_129(var uParam0, bool bParam1) //Position: 0x2E26 / 11814
{
...
void Function_130(int iParam0) //Position: 0x2E97 / 11927
{
	Function_40(&Global_78617 + 52, iParam0);
	return;
}

void Function_131(var uParam0) //Position: 0x2EA8 / 11944
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_132() //Position: 0x2EB6 / 11958
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_133(int iParam0) //Position: 0x2ECF / 11983
{
	int iVar0;
	int iVar1;
...
void Function_134() //Position: 0x324A / 12874
{
	if (!Function_135(128))
	{
		return;
...
bool Function_135(int iParam0) //Position: 0x328A / 12938
{
	int iVar0;
...
bool Function_136() //Position: 0x32A6 / 12966
{
	int iVar0;
...
void Function_137(var uParam0, int iParam1) //Position: 0x32D1 / 13009
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_138() //Position: 0x32E2 / 13026
{
	if (!Function_135(128))
	{
		return;
...
void Function_139() //Position: 0x3324 / 13092
{
	Function_140(&uLocal_127, "mp_action_areas", 10, 0);
	return;
}

var Function_140(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3345 / 13125
{
	int iVar0;
	bool bVar1;
...
var Function_141(var uParam0, int iParam1, int iParam2) //Position: 0x337D / 13181
{
	int iVar0;
...
bool Function_142(int iParam0) //Position: 0x3441 / 13377
{
	switch (iLocal_97)
	{
		case 0x00000000:
...
bool Function_143(int iParam0) //Position: 0x34ED / 13549
{
...
void Function_144(int iParam0) //Position: 0x3503 / 13571
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_145(int iParam0) //Position: 0x3517 / 13591
{
	if (Function_64(iParam0))
	{
...
float Function_146(float fParam0) //Position: 0x3532 / 13618
{
	return -Function_60(fParam0);
}

bool Function_147() //Position: 0x353E / 13630
{
	return iLocal_19;
}

void Function_148() //Position: 0x3546 / 13638
{
	struct<13> Var0;
...
void Function_149(bool bParam0) //Position: 0x3572 / 13682
{
	struct<17> Var0;
	...
	Function_51(&Var0);
	Function_52();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 13757);
	return;
}

void Function_150(int iParam0) //Position: 0x35BD / 13757
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
bool Function_151(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x36C0 / 14016
{
	if (!Function_200())
	{
		return 0;
	...
	switch (iLocal_16)
	{
		case 0x00000000:
		case 0x00000003:
			Function_169(17768, 17448);
			break;
		
		case 0x00000002:
			Function_169(14942, 14213);
			break;
...
int Function_152(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3785 / 14213
{
	bool bVar0;
	int iVar1;
...
int Function_153(int iParam0) //Position: 0x3828 / 14376
{
	return Function_154(0, iParam0);
}

int Function_154(int iParam0, bool bParam1) //Position: 0x3834 / 14388
{
	char* cVar0[64];
...
bool Function_155(bool bParam0) //Position: 0x389B / 14491
{
	char* cVar0[64];
...
var Function_156(int iParam0) //Position: 0x393C / 14652
{
	return (*&Global_78480 + 132)[iParam0];
}

bool Function_157(bool bParam0, int iParam1, int iParam2) //Position: 0x394C / 14668
{
	var uVar0;
...
int Function_158(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x395D / 14685
{
	char* cVar0[32];
...
int Function_159(int iParam0, bool bParam1) //Position: 0x39C2 / 14786
{
	char* cVar0[64];
...
void Function_160(bool bParam0, int iParam1, char* cParam2) //Position: 0x3A30 / 14896
{
	if (bParam0)
	{
		if (Function_161())
...
bool Function_161() //Position: 0x3A51 / 14929
{
	return Function_36(32768);
}

int Function_162() //Position: 0x3A5E / 14942
{
	if (!Function_163(1))
	{
		return 0;
...
bool Function_163(bool bParam0) //Position: 0x3B1A / 15130
{
	char* cVar0[64];
...
void Function_164(bool bParam0) //Position: 0x3B9B / 15259
{
...
var Function_165(int iParam0, bool bParam1) //Position: 0x3C24 / 15396
{
	int iVar0;
...
struct<64> Function_166(var uParam0) //Position: 0x3C44 / 15428
{
...
struct<64> Function_167(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x3C58 / 15448
{
	char* cVar0[64];
...
int Function_168(bool bParam0, bool bParam1) //Position: 0x3C9D / 15517
{
...
void Function_169(int iParam0, int iParam1) //Position: 0x3CD1 / 15569
{
	Function_170(iParam0, iParam1, 17441);
	return;
}

void Function_170(var uParam0, var uParam1, int iParam2) //Position: 0x3CE2 / 15586
{
...
void Function_171() //Position: 0x3E7B / 15995
{
	if (Function_36(4194304))
	{
...
void Function_172(var uParam0, var uParam1, int iParam2) //Position: 0x3F84 / 16260
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_173(bool bParam0, int iParam1, bool bParam2) //Position: 0x40FD / 16637
{
	char* cVar0[64];
	int iVar16;
...
var Function_174(int iParam0) //Position: 0x417E / 16766
{
	switch (iParam0)
	{
		case 0x00000002:
...
void Function_175(bool bParam0) //Position: 0x4407 / 17415
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
int Function_176() //Position: 0x4421 / 17441
{
	return 1;
}

int Function_177(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x4428 / 17448
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
var Function_178(int iParam0, bool bParam1) //Position: 0x44C0 / 17600
{
	char* cVar0[64];
...
var Function_179(int iParam0) //Position: 0x4529 / 17705
{
	return (*&Global_78480 + 176)[iParam0];
}

int Function_180() //Position: 0x4539 / 17721
{
	return Global_78480;
}

int Function_181(bool bParam0) //Position: 0x4543 / 17731
{
	if (!Function_155(bParam0))
	{
		return 4294967295;
...
int Function_182() //Position: 0x4568 / 17768
{
	if (!Function_163(1))
	{
		return 0;
...
void Function_183() //Position: 0x4604 / 17924
{
	if (Function_36(4096))
	{
...
void Function_184(int iParam0) //Position: 0x4641 / 17985
{
	int iVar0;
	int iVar1;
...
void Function_185(int iParam0) //Position: 0x46BA / 18106
{
	struct<13> Var0;
...
void Function_186(int iParam0) //Position: 0x46E5 / 18149
{
	bool bVar0;
...
void Function_187(int iParam0) //Position: 0x472C / 18220
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_188(bool bParam0) //Position: 0x4868 / 18536
{
	vector3 vVar0;
...
int Function_189(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4879 / 18553
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_190(bool bParam0) //Position: 0x495B / 18779
{
	bool bVar0;
...
void Function_191() //Position: 0x49B5 / 18869
{
	Function_192(4);
	return;
}

void Function_192(int iParam0) //Position: 0x49BF / 18879
{
	var uVar0;
	var uVar1;
...
void Function_193(int iParam0) //Position: 0x49F1 / 18929
{
	var uVar0;
...
void Function_194() //Position: 0x4A00 / 18944
{
	bool bVar0;
...
void Function_195() //Position: 0x4A35 / 18997
{
	int iVar0;
...
bool Function_196(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x4A4E / 19022
{
	bool bVar0;
...
bool Function_197(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4AB7 / 19127
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_198(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4BA4 / 19364
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_199(int iParam0) //Position: 0x4C52 / 19538
{
	if (iParam0 > 40)
	{
		return 0;
...
bool Function_200() //Position: 0x4C6B / 19563
{
	int iVar0;
...
void Function_201(bool bParam0) //Position: 0x4C8E / 19598
{
	Function_110(bParam0, NET_ACTOR_GET_SCRIPT_INT(bParam0));
	return;
}

bool Function_202(int iParam0) //Position: 0x4C9E / 19614
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	Function_227(iParam0 + 16 + 8);
	Function_225(iParam0, 21194);
	iVar1 = 0;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 19931);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 19892);
	return 1;
}

void Function_203(int iParam0) //Position: 0x4DB4 / 19892
{
	int iVar0;
...
void Function_204(int iParam0) //Position: 0x4DDB / 19931
{
	struct<13> Var0;
...
void Function_205(int iParam0) //Position: 0x4E52 / 20050
{
	struct<13> Var0;
...
void Function_206(var uParam0, int iParam1) //Position: 0x4E9F / 20127
{
	bool bVar0;
	bool bVar1;
...
void Function_207(int iParam0) //Position: 0x4EF4 / 20212
{
	Function_40(&Global_83864 + 1252, iParam0);
	return;
}

void Function_208(int iParam0) //Position: 0x4F06 / 20230
{
...
void Function_209() //Position: 0x4FCA / 20426
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_210(bool bParam0, bool bParam1) //Position: 0x4FE3 / 20451
{
	var uVar0;
...
void Function_211() //Position: 0x502F / 20527
{
...
void Function_212(int iParam0, bool bParam1) //Position: 0x504E / 20558
{
	if (bParam1)
	{
...
void Function_213(int iParam0, var uParam1) //Position: 0x5089 / 20617
{
	if (iParam0 > 40)
	{
		return;
...
void Function_214() //Position: 0x50A3 / 20643
{
	Function_215(&Global_78480 + 220);
	return;
}

void Function_215(int iParam0) //Position: 0x50B2 / 20658
{
	int iVar0;
...
void Function_216(int iParam0) //Position: 0x50D3 / 20691
{
	int iVar0;
...
void Function_217(int iParam0) //Position: 0x50F7 / 20727
{
	int iVar0;
...
void Function_218() //Position: 0x511B / 20763
{
	Function_219(&(Global_50170[522]));
	Function_219(&(Global_50170[622]));
	Function_219(&(Global_50170[722]));
	Function_219(&(Global_50170[822]));
	Function_219(&(Global_50170[922]));
	Function_219(&(Global_50170[1022]));
	Function_219(&(Global_50170[1122]));
	return;
}

void Function_219(bool bParam0) //Position: 0x5164 / 20836
{
	Global_56092[*bParam0] = 0;
	Function_220(*bParam0, 0.0f, 0, 4294967295, 4294967295, 4294967295);
	return;
}

void Function_220(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x517E / 20862
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_223(iParam0), fParam1, true, 0);
	if (bParam2)
	{
		memcpy(&cVar0, StackVal, StackVal, StackVal, Function_222(iParam0), 6);
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_223(iParam0), &cVar0, 2, 2, true);
		Function_221(Function_223(iParam0), 0);
	}
}

void Function_221(bool bParam0, bool bParam1) //Position: 0x522C / 21036
{
	bool bVar0;
...
struct<16> Function_222(int iParam0) //Position: 0x5251 / 21073
{
	char* cVar0[16];
...
var Function_223(int iParam0) //Position: 0x5285 / 21125
{
	return Global_50170[iParam022].f_24;
}

void Function_224() //Position: 0x5294 / 21140
{
	int iVar0;
...
void Function_225(var uParam0, int iParam1) //Position: 0x52BE / 21182
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_226(var uParam0) //Position: 0x52CA / 21194
{
	uParam0 = uParam0;
	return;
}

void Function_227(int iParam0) //Position: 0x52D4 / 21204
{
	if (!Function_64(iParam0))
	{
...
bool Function_228(var uParam0, bool bParam1) //Position: 0x52E9 / 21225
{
	float fVar0;
	int iVar1;
	bool bVar2;
	...
	bVar2 = Function_229("freemodetest");
...
int Function_229(char* cParam0) //Position: 0x539C / 21404
{
	bool bVar0;
