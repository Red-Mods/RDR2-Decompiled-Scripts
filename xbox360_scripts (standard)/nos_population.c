...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		...
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, bVar2, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, bVar1, 1, 1, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xF21 / 3873
{
	bool bVar0;
...
var Function_4(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xFA1 / 4001
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1109 / 4361
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1175 / 4469
{
	bool bVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x11E1 / 4577
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1226 / 4646
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x129B / 4763
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0x12A8 / 4776
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0x12B4 / 4788
{
	if (!Function_5(128))
	{
		return;
