...
void Function_62(bool bParam0) //Position: 0x2542 / 9538
{
	...
	if (iLocal_2 && !iLocal_3)
	{
		...
		bLocal_1 = Function_63(iLocal_0, 0, Global_34573, 1, 0, 0);
	}
	return;
}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2603 / 9731
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x262E / 9774
{
...
struct<32> Function_66(bool bParam0) //Position: 0x26BA / 9914
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2724 / 10020
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x2743 / 10051
{
	iParam0 = iParam0;
	return;
}

bool Function_69(bool bParam0) //Position: 0x274D / 10061
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x276B / 10091
{
	if (!Function_14(iParam0))
	{
...
bool Function_71(bool bParam0, bool bParam1) //Position: 0x2780 / 10112
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_72(int iParam0) //Position: 0x2807 / 10247
{
	vector3 vVar0;
...
vector3 Function_73(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x282A / 10282
{
	vector3 vVar0;
...
bool Function_74(bool bParam0) //Position: 0x2848 / 10312
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(bool bParam0, bool bParam1) //Position: 0x286B / 10347
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x2986 / 10630
{
...
int Function_77(bool bParam0) //Position: 0x29B1 / 10673
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2AB6 / 10934
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(int iParam0) //Position: 0x2AC3 / 10947
{
	if (Function_78(iParam0->f_40, 16))
	{
...
void Function_80(int iParam0, bool bParam1) //Position: 0x2B36 / 11062
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x3034 / 12340
{
	bool bVar0;
...
bool Function_82(bool bParam0) //Position: 0x306B / 12395
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3088 / 12424
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_84(int iParam0) //Position: 0x30C0 / 12480
{
	iParam0 = iParam0;
	return;
}

bool Function_85(bool bParam0) //Position: 0x30CA / 12490
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, int iParam1) //Position: 0x30EB / 12523
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	iLocal_3 = 0;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x311E / 12574
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x3226 / 12838
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_89(int iParam0) //Position: 0x323C / 12860
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x34F2 / 13554
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
void Function_93(bool bParam0, int iParam1) //Position: 0x353A / 13626
{
	bool bVar0;
	int iVar1;
...
bool Function_99(var uParam0, int iParam1) //Position: 0x392A / 14634
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_100(int iParam0) //Position: 0x3939 / 14649
{
...
void Function_101(int iParam0) //Position: 0x3955 / 14677
{
	iParam0 = iParam0;
	return;
}

void Function_102(bool bParam0, int iParam1) //Position: 0x395F / 14687
{
	bool bVar0;
	bool bVar1;
...
void Function_103(int iParam0, int iParam1) //Position: 0x39C1 / 14785
{
...
void Function_104(int iParam0) //Position: 0x39D5 / 14805
{
	iParam0 = iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x39DF / 14815
{
