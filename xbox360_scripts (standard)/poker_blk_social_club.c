...
void Function_18() //Position: 0x650 / 1616
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x659 / 1625
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x67A / 1658
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x6B0 / 1712
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x6CB / 1739
{
...
vector3 Function_23(int iParam0) //Position: 0x7C5 / 1989
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x8BF / 2239
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xE39 / 3641
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xE8E / 3726
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xFA0 / 4000
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x118F / 4495
{
...
bool Function_29() //Position: 0x1245 / 4677
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x125C / 4700
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x1267 / 4711
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x1275 / 4725
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x1282 / 4738
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x12C4 / 4804
{
	return Function_35(0);
}

int Function_35(int iParam0) //Position: 0x12CE / 4814
{
...
var Function_36(int iParam0) //Position: 0x130F / 4879
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_38() //Position: 0x1332 / 4914
{
	bLocal_5 = CREATE_LAYOUT(Function_49());
	Function_47(0, 1);
	Function_46();
	Function_45();
...
void Function_39(int iParam0) //Position: 0x1381 / 4993
{
...
void Function_40(var uParam0, float fParam1) //Position: 0x1396 / 5014
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x13B7 / 5047
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x13CA / 5066
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0x13D9 / 5081
{
	return Function_44(*iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0x13E6 / 5094
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x13F3 / 5107
{
	return;
}

void Function_46() //Position: 0x13F9 / 5113
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x13FF / 5119
{
	bool bVar0;
...
void Function_48(var uParam0) //Position: 0x1456 / 5206
{
	int iVar0;
...
var Function_49() //Position: 0x1473 / 5235
{
	var uVar0;
