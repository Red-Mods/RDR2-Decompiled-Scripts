...
void main() //Position: 0x0 / 0
{
	...
	iLocal_77 = 0;
	Function_105(uScriptParam_0, &iLocal_77);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_98(&(Local_4[iVar312]), &bVar4))
						{
							Function_96(GRINGO_GET_REQUESTING_ACTOR(), Local_4[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_91("eGRINGO_EndUse: Stop use by request", Local_4[iVar312].f_16);
							Function_90(Local_4[iVar312].f_16, 1);
							...
							{
								Function_83(&(Local_4[iVar312]), 0);
							}
							else if (Local_4[iVar312].f_44 < 8)
							{
								Function_82(&(Local_4[iVar312]));
...
bool Function_16(int iParam0) //Position: 0xA34 / 2612
{
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_81(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1B90 / 7056
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1B9E / 7070
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BCF / 7119
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C43 / 7235
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CB5 / 7349
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CC3 / 7363
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CD9 / 7385
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CE6 / 7398
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D06 / 7430
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1D15 / 7445
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D34 / 7476
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D3A / 7482
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D48 / 7496
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D53 / 7507
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D6D / 7533
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1D8B / 7563
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DAA / 7594
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DDD / 7645
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1DFC / 7676
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E16 / 7702
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E29 / 7721
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x2111 / 8465
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2119 / 8473
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2136 / 8502
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2145 / 8517
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2167 / 8551
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x218B / 8587
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21A8 / 8616
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21C8 / 8648
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x21E8 / 8680
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2296 / 8854
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2306 / 8966
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x231C / 8988
{
...
var Function_51(bool bParam0) //Position: 0x233D / 9021
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x235D / 9053
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2371 / 9073
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x237B / 9083
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2382 / 9090
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2391 / 9105
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23D0 / 9168
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x23FB / 9211
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2406 / 9222
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x24FC / 9468
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x251E / 9502
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2545 / 9541
{
	struct<8> Var0;
	struct<25> Var8;
	...
	{
		iLocal_0 = 1;
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_69("mp_rig_tnt") };
		iLocal_1 = CREATE_LAYOUT(&Var0);
		uLocal_2 = uLocal_2;
		GRINGO_GET_USE_COMPONENT_POSITION(&Var8 + 12, bParam0);
		Var8 = { 0.0f, GRINGO_GET_USE_COMPONENT_HEADING(bParam0), 0.0f };
		Var8.f_24 = 0;
		if (GRINGO_COMPONENT_CHECK_NAME("UseCase2", bParam0))
		{
			uLocal_2 = Function_66(iLocal_1, 0, &Var8, 1, 0, 1);
		}
		else
		{
			uLocal_2 = Function_63(iLocal_1, 0, &Var8, 1, 0, 1);
		}
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25C2 / 9666
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "MP_Rig_TNT_CASE1", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2640 / 9792
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x266B / 9835
{
	vector3 vVar0;
	...
	vVar0 = { 1,321045f, 1,491829f, 0,49707f };
	...
	vVar0 = { 0,714006f, 0,355672f, 0,603069f };
	UNK_0xF76F2BB3(&vVar0, bParam1, bParam1->f_24, 4);
...
var Function_66(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2723 / 10019
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "MP_Rig_TNT", 1, 1);
	}
...
void Function_67(var uParam0, int iParam1) //Position: 0x279B / 10139
{
	bool bVar0;
...
void Function_68(var uParam0, bool bParam1) //Position: 0x27C6 / 10182
{
	vector3 vVar0;
...
struct<32> Function_69(bool bParam0) //Position: 0x287E / 10366
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_70(char* cParam0, char* cParam1, char* cParam2) //Position: 0x28E8 / 10472
{
	char* cVar0[32];
...
void Function_71(int iParam0) //Position: 0x2907 / 10503
{
	iParam0 = iParam0;
	return;
}

bool Function_72(bool bParam0) //Position: 0x2911 / 10513
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_73(int iParam0) //Position: 0x292F / 10543
{
	if (!Function_14(iParam0))
	{
...
bool Function_74(bool bParam0, bool bParam1) //Position: 0x2944 / 10564
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
	...
	{
		return Function_78(bParam0, bParam1);
	}
	uVar4 = Function_77(bParam1);
	uVar5 = Function_57(bParam1);
	Function_75(bParam1);
	vVar6 = { StackVal, StackVal, Function_75(bParam1) };
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(bParam0, &vVar0, &vVar6, uVar4, 0,2f, 1, bVar3, uVar5, 0, 0);
}

vector3 Function_75(int iParam0) //Position: 0x29CB / 10699
{
	vector3 vVar0;
	
	vVar0 = { 0.0f, 0.0f, 0.0f };
	Function_76(StackVal, StackVal, iParam0, "UserOffset", vVar0);
	return StackVal, StackVal, Function_76(StackVal, StackVal, iParam0, "UserOffset", vVar0);
}

vector3 Function_76(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29EE / 10734
{
	vector3 vVar0;
...
bool Function_77(bool bParam0) //Position: 0x2A0C / 10764
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_78(bool bParam0, bool bParam1) //Position: 0x2A2F / 10799
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_79(bool bParam0, int iParam1) //Position: 0x2B4A / 11082
{
...
int Function_80(bool bParam0) //Position: 0x2B75 / 11125
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_81(var uParam0, int iParam1) //Position: 0x2C7A / 11386
{
	return (uParam0 && iParam1) == 0;
}

void Function_82(int iParam0) //Position: 0x2C87 / 11399
{
	if (Function_81(iParam0->f_40, 16))
	{
...
void Function_83(int iParam0, bool bParam1) //Position: 0x2CFA / 11514
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_84() //Position: 0x31F8 / 12792
{
	bool bVar0;
...
bool Function_85(bool bParam0) //Position: 0x322F / 12847
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_86(var uParam0, int iParam1) //Position: 0x324C / 12876
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_87(int iParam0) //Position: 0x3284 / 12932
{
	iParam0 = iParam0;
	return;
}

bool Function_88(bool bParam0) //Position: 0x328E / 12942
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_89(var uParam0, int iParam1) //Position: 0x32AF / 12975
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_LAYOUTREF_VALID(iLocal_1))
	{
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x32CD / 13005
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x33D5 / 13269
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_92(int iParam0) //Position: 0x33EB / 13291
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_93(var uParam0, int iParam1) //Position: 0x36A1 / 13985
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_94(bool bParam0) //Position: 0x36AF / 13999
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_95(bool bParam0) //Position: 0x36C8 / 14024
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_96(bool bParam0, int iParam1) //Position: 0x36E2 / 14050
{
	bool bVar0;
	int iVar1;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x371A / 14106
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_98(int iParam0, int iParam1) //Position: 0x3731 / 14129
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_99(bool bParam0) //Position: 0x39FA / 14842
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_100(bool bParam0, bool bParam1) //Position: 0x3A17 / 14871
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_101(int iParam0) //Position: 0x3AB3 / 15027
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_102(var uParam0, int iParam1) //Position: 0x3AD2 / 15058
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_103(int iParam0) //Position: 0x3AE1 / 15073
{
...
void Function_104(int iParam0) //Position: 0x3AFD / 15101
{
	iParam0 = iParam0;
	return;
}

void Function_105(bool bParam0, int iParam1) //Position: 0x3B07 / 15111
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_106(&(Local_4[iLocal_7712]), bParam0);
		iLocal_77++;
	}
...
void Function_106(int iParam0, int iParam1) //Position: 0x3B69 / 15209
{
...
void Function_107(int iParam0) //Position: 0x3B7D / 15229
{
	iParam0 = iParam0;
	return;
}

void Function_108(int iParam0) //Position: 0x3B87 / 15239
{
