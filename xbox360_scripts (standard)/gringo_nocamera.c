...
void Function_81(var uParam0, int iParam1) //Position: 0x2EF4 / 12020
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F02 / 12034
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x300A / 12298
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x3020 / 12320
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32D6 / 13014
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x32E4 / 13028
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x32FD / 13053
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x3317 / 13079
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x334F / 13135
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3366 / 13158
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x362F / 13871
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x364C / 13900
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36E8 / 14056
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3707 / 14087
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3716 / 14102
{
...
void Function_96(int iParam0) //Position: 0x3732 / 14130
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x373C / 14140
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x379E / 14238
{
...
void Function_99(int iParam0) //Position: 0x37B2 / 14258
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37BC / 14268
{
