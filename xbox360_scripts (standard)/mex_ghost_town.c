...
var Function_3(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x844 / 2116
{
	bool bVar0;
...
var Function_14(bool bParam0, int iParam1) //Position: 0xC1D / 3101
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0xC2A / 3114
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0xC36 / 3126
{
	if (!Function_8(128))
	{
		return;
