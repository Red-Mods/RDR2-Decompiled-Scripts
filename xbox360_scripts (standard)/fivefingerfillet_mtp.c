...
bool Function_20() //Position: 0x9E1 / 2529
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_32(Global_30723[1]))
			{
				iLocal_12 = Function_31(Local_5);
				if (iLocal_12 <= 1)
				{
					iLocal_12 = 1;
				}
				if (Function_29() <= iLocal_12)
				{
					Function_28("FiveFingerFillet_NotEnoughMoney", 4.0f, 1, 2, 0, 0, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_27(Global_30723[1], &iLocal_24 + 4, &iLocal_24 + 24, &iLocal_24 + 28))
			{
				Function_26(&(Global_30723[1]));
				Function_25(&iLocal_24 + 4);
				Function_19(Global_30723[1]);
				*(&iLocal_24 + 156[03]) = { StackVal, StackVal, Function_19(Global_30723[1]) };
				Function_18(Global_30723[1]);
				*(&iLocal_24 + 156[13]) = { StackVal, StackVal, Function_18(Global_30723[1]) };
				iLocal_24 = Local_5;
...
void Function_21() //Position: 0xB79 / 2937
{
	Function_1();
	return;
}

bool Function_22(int iParam0) //Position: 0xB82 / 2946
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_23(int iParam0, bool bParam1) //Position: 0xBA3 / 2979
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_24(int iParam0, int iParam1) //Position: 0xBD9 / 3033
{
	if (!Function_8(iParam0))
	{
		return;
...
void Function_25(int iParam0) //Position: 0xBF4 / 3060
{
	int iVar0;
	bool bVar1;
...
void Function_26(int iParam0) //Position: 0xC49 / 3145
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
bool Function_27(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0xE87 / 3719
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void Function_28(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x11B3 / 4531
{
	int iVar0;
...
int Function_29() //Position: 0x1206 / 4614
{
	return Function_30(0);
}

int Function_30(int iParam0) //Position: 0x1210 / 4624
{
...
var Function_31(int iParam0) //Position: 0x1251 / 4689
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_32(int iParam0) //Position: 0x126B / 4715
{
...
int Function_33(var uParam0, int iParam1) //Position: 0x1287 / 4743
{
	int iVar0;
...
bool Function_34(int iParam0) //Position: 0x12A3 / 4771
{
...
void Function_35() //Position: 0x12B9 / 4793
{
	Function_1();
	return;
}

void Function_36() //Position: 0x12C2 / 4802
{
	bLocal_4 = CREATE_LAYOUT(Function_46());
	Function_44(0, 1);
	Function_43();
	Function_37(&uLocal_13);
	Function_37(&iLocal_19);
	Function_37(&iLocal_16);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
...
void Function_37(int iParam0) //Position: 0x130E / 4878
{
...
void Function_38(var uParam0, float fParam1) //Position: 0x1323 / 4899
{
...
void Function_39(var uParam0, int iParam1) //Position: 0x1344 / 4932
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_40(var uParam0, int iParam1) //Position: 0x1357 / 4951
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_41(int iParam0) //Position: 0x1366 / 4966
{
	return Function_42(*iParam0, 1);
}

int Function_42(var uParam0, bool bParam1) //Position: 0x1373 / 4979
{
...
void Function_44(bool bParam0, bool bParam1) //Position: 0x1386 / 4998
{
	bool bVar0;
...
void Function_45(var uParam0) //Position: 0x13DD / 5085
{
	int iVar0;
...
var Function_46() //Position: 0x13FA / 5114
{
	var uVar0;
