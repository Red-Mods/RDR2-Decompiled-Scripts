...
void main() //Position: 0x0 / 0
{
	...
	iLocal_89 = 0;
	Function_111(uScriptParam_0, &iLocal_89);
			...
			if (iVar3 >= 4294967295)
			{
				...
				switch (GRINGO_GET_MESSAGE_TYPE())
				{
					...
					case 0x00000002:
						...
						{
							Function_114("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_89 - 1))
			{
				if (Function_85(Local_16[iVar012].f_40, 2))
				{
					...
					{
						Function_114("Quitting due to update end");
	...
	{
		Function_114("Removing quit context at script termination");
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
								{
									Function_114("ManagePlayerQuit: Create quit context");
								...
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_96))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
									{
										Function_114("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(bLocal_96);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
										{
											Function_114("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(bLocal_96);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
							{
								Function_114("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(bLocal_96);
							}
						}
					}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_49(iParam0, bVar8, &iLocal_94, &bLocal_93);
...
void Function_17(bool bParam0, int iParam1) //Position: 0x1B7D / 7037
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1B92 / 7058
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1BA0 / 7072
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BD1 / 7121
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C45 / 7237
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CB7 / 7351
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CC5 / 7365
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CDB / 7387
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CE8 / 7400
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D08 / 7432
{
	return Function_27(uParam0, iParam1, &iLocal_15);
}

int Function_27(bool bParam0, bool bParam1, int iParam2) //Position: 0x1D17 / 7447
{
	var uVar0;
	int iVar1;
	int iVar2;
...
vector3 Function_28() //Position: 0x235F / 9055
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_29(vector3 vParam0) //Position: 0x2368 / 9064
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_30(vector3 vParam0) //Position: 0x2380 / 9088
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
int Function_31(bool bParam0, bool bParam1, int iParam2) //Position: 0x246C / 9324
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_32() //Position: 0x2613 / 9747
{
	int iVar0;
...
void Function_33(bool bParam0) //Position: 0x261B / 9755
{
	bool bVar0;
...
var Function_34() //Position: 0x2660 / 9824
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_35(bool bParam0, bool bParam1) //Position: 0x2669 / 9833
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_36(bool bParam0, bool bParam1) //Position: 0x2698 / 9880
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_37(bool bParam0, bool bParam1) //Position: 0x26BA / 9914
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
bool Function_38(bool bParam0) //Position: 0x26E9 / 9961
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_39() //Position: 0x2708 / 9992
{
	return;
}

void Function_40(var uParam0, int iParam1) //Position: 0x270E / 9998
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_41(int iParam0) //Position: 0x271C / 10012
{
	iParam0 = iParam0;
	return 1;
}

bool Function_42(bool bParam0) //Position: 0x2727 / 10023
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2741 / 10049
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_44(bool bParam0) //Position: 0x275F / 10079
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_45(bool bParam0) //Position: 0x277E / 10110
{
	int iVar0;
	int iVar1;
...
bool Function_46(bool bParam0) //Position: 0x27B1 / 10161
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_47(bool bParam0) //Position: 0x27D0 / 10192
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_48(var uParam0, int iParam1) //Position: 0x27EA / 10218
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_49(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x27FD / 10237
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_50(bool bParam0, bool bParam1) //Position: 0x2AE5 / 10981
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_51() //Position: 0x2B02 / 11010
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_52(bool bParam0, int iParam1) //Position: 0x2B11 / 11025
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_53(bool bParam0, int iParam1) //Position: 0x2B33 / 11059
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_54(bool bParam0) //Position: 0x2B57 / 11095
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_55(bool bParam0, int iParam1) //Position: 0x2B74 / 11124
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_56(bool bParam0, int iParam1) //Position: 0x2B94 / 11156
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_57(bool bParam0, bool bParam1) //Position: 0x2BB4 / 11188
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_58(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2C62 / 11362
{
	bool bVar0;
...
void Function_59(int iParam0, float fParam1) //Position: 0x2CD2 / 11474
{
	if (!Function_14(iParam0))
	{
...
void Function_60(int iParam0, float fParam1) //Position: 0x2CE8 / 11496
{
...
var Function_61(bool bParam0) //Position: 0x2D09 / 11529
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_62(int iParam0) //Position: 0x2D29 / 11561
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_63(var uParam0) //Position: 0x2D3D / 11581
{
	uParam0 = uParam0;
	return;
}

int Function_64() //Position: 0x2D47 / 11591
{
	return 1;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2D4E / 11598
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_66(bool bParam0, var uParam1, int iParam2) //Position: 0x2D5D / 11613
{
	bool bVar0;
...
bool Function_67(bool bParam0) //Position: 0x2D9C / 11676
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_68(bool bParam0) //Position: 0x2DC7 / 11719
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_69(bool bParam0) //Position: 0x2DD2 / 11730
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_70(bool bParam0) //Position: 0x2EC8 / 11976
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_71(bool bParam0) //Position: 0x2EEA / 12010
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_72(bool bParam0) //Position: 0x2F11 / 12049
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		Function_114("Failed to create gringo camera");
	}
	return;
}

vector3 Function_73(vector3 vParam0) //Position: 0x31D0 / 12752
{
	vector3 vVar0;
...
vector3 Function_74(vector3 vParam0) //Position: 0x322D / 12845
{
	vector3 vVar0;
...
void Function_75(int iParam0) //Position: 0x328A / 12938
{
	iParam0 = iParam0;
	return;
}

bool Function_76(bool bParam0) //Position: 0x3294 / 12948
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_77(int iParam0) //Position: 0x32B2 / 12978
{
	if (!Function_14(iParam0))
	{
...
bool Function_78(bool bParam0, bool bParam1) //Position: 0x32C7 / 12999
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_79(int iParam0) //Position: 0x334E / 13134
{
	vector3 vVar0;
...
vector3 Function_80(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x3371 / 13169
{
	vector3 vVar0;
...
bool Function_81(bool bParam0) //Position: 0x338F / 13199
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_82(bool bParam0, bool bParam1) //Position: 0x33B2 / 13234
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_83(bool bParam0, int iParam1) //Position: 0x34CD / 13517
{
...
int Function_84(bool bParam0) //Position: 0x34F8 / 13560
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_85(var uParam0, int iParam1) //Position: 0x35FD / 13821
{
	return (uParam0 && iParam1) == 0;
}

void Function_86(int iParam0) //Position: 0x360A / 13834
{
	if (Function_85(iParam0->f_40, 16))
	{
...
void Function_87(int iParam0, bool bParam1) //Position: 0x367D / 13949
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_93));
		iLocal_94 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_47(iParam0->f_12))
...
void Function_88() //Position: 0x3B7B / 15227
{
	bool bVar0;
...
bool Function_89(bool bParam0) //Position: 0x3BB2 / 15282
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_90(var uParam0, int iParam1) //Position: 0x3BCF / 15311
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_91(int iParam0) //Position: 0x3C07 / 15367
{
	iParam0 = iParam0;
	return;
}

bool Function_92(bool bParam0) //Position: 0x3C11 / 15377
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_93(var uParam0, int iParam1) //Position: 0x3C32 / 15410
{
	Function_94(uParam0, iParam1);
	return;
}

void Function_94(bool bParam0, bool bParam1) //Position: 0x3C3F / 15423
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	{
		SET_GRINGO_INT_ATTR(false, "StationsUsed", bParam1);
	}
...
void Function_95(bool bParam0, bool bParam1) //Position: 0x3D4B / 15691
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_114("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_114("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
			{
				if (bParam1)
				{
					Function_114("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(bLocal_96);
			}
		}
	...
	if (bParam1)
	{
		Function_114("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_96(bool bParam0, bool bParam1) //Position: 0x3E53 / 15955
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_97(int iParam0) //Position: 0x3E69 / 15977
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_98(var uParam0, int iParam1) //Position: 0x4121 / 16673
{
	uParam0 = uParam0;
...
void Function_99(var uParam0, bool bParam1) //Position: 0x4131 / 16689
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_100(bool bParam0) //Position: 0x41DD / 16861
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_101(bool bParam0) //Position: 0x41F6 / 16886
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_102(int iParam0, int iParam1) //Position: 0x4210 / 16912
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_103(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_103(var uParam0, int iParam1) //Position: 0x4248 / 16968
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_104(int iParam0, int iParam1) //Position: 0x425F / 16991
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_105(bool bParam0) //Position: 0x4528 / 17704
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_106(bool bParam0, bool bParam1) //Position: 0x4545 / 17733
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_107(int iParam0) //Position: 0x45E1 / 17889
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_108(var uParam0, int iParam1) //Position: 0x4600 / 17920
{
	return Function_31(iParam1, uParam0, &iLocal_15);
}

bool Function_109(int iParam0) //Position: 0x460F / 17935
{
...
void Function_110(int iParam0) //Position: 0x462B / 17963
{
	iParam0 = iParam0;
	return;
}

void Function_111(bool bParam0, int iParam1) //Position: 0x4635 / 17973
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_112(&(Local_16[iLocal_8912]), bParam0);
		iLocal_89++;
	}
...
void Function_112(int iParam0, int iParam1) //Position: 0x4697 / 18071
{
...
void Function_113(int iParam0) //Position: 0x46AB / 18091
{
	iParam0 = iParam0;
	return;
}

void Function_114(int iParam0) //Position: 0x46B5 / 18101
{
