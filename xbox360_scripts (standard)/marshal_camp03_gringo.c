...
bool Function_47(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2B44 / 11076
{
...
void Function_56(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2E52 / 11858
{
	bool bVar0;
	bool bVar1;
...
void Function_77() //Position: 0x37A5 / 14245
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_19, vVar1, 15.0f, 1, true, 1);
	...
	SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_19, bVar0, 1, true);
	...
	TASK_SEQUENCE_RELEASE(bVar5, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(bVar4, bVar0, 1, true);
...
void Function_89(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4468 / 17512
{
	bool bVar0;
...
bool Function_90(bool bParam0, bool bParam1) //Position: 0x44BC / 17596
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0, bool bParam1) //Position: 0x466C / 18028
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_101(int iParam0) //Position: 0x49A1 / 18849
{
	bool bVar0;
	bool bVar1;
...
var Function_102(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A9B / 19099
{
	int iVar0;
	bool bVar1;
...
void Function_103(var uParam0, int iParam1) //Position: 0x4AD3 / 19155
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_104(var uParam0, bool bParam1, int iParam2) //Position: 0x4AE4 / 19172
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4BA8 / 19368
{
	int iVar0;
	int iVar1;
...
void Function_106() //Position: 0x4F23 / 20259
{
	if (!Function_153(128))
	{
		return;
...
bool Function_107() //Position: 0x4F63 / 20323
{
	int iVar0;
...
void Function_108() //Position: 0x4F8E / 20366
{
	if (!Function_153(128))
	{
		return;
...
void Function_109(int iParam0, bool bParam1) //Position: 0x4FD0 / 20432
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5054 / 20564
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x507D / 20605
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x50CE / 20686
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x50DE / 20702
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x50F2 / 20722
{
	int iVar0;
...
var Function_115() //Position: 0x5117 / 20759
{
	return "PackedMetadata";
}

void Function_116(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x512E / 20782
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_117() //Position: 0x5254 / 21076
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_118() //Position: 0x5265 / 21093
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_119() //Position: 0x5276 / 21110
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_120(var uParam0, int iParam1) //Position: 0x5287 / 21127
{
...
var Function_121(var uParam0, int iParam1, bool bParam2) //Position: 0x52AA / 21162
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x52C9 / 21193
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_123() //Position: 0x52D5 / 21205
{
	return Function_124(39);
}

int Function_124(int iParam0) //Position: 0x52E0 / 21216
{
	int iVar0;
...
var Function_125() //Position: 0x530E / 21262
{
	return "PackedWeapon";
}

int Function_126(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5323 / 21283
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_127() //Position: 0x5427 / 21543
{
	return "MPItemGiver";
}

struct<32> Function_128(bool bParam0) //Position: 0x543B / 21563
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0, char* cParam1, char* cParam2) //Position: 0x54A5 / 21669
{
	char* cVar0[32];
...
var Function_130() //Position: 0x54C4 / 21700
{
	return "PBox_";
}

var Function_131() //Position: 0x54D2 / 21714
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x54F8 / 21752
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5520 / 21792
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x5546 / 21830
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x56A7 / 22183
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5742 / 22338
{
	int iVar0;
	vector3 vVar1;
...
void Function_137(int iParam0) //Position: 0x58A3 / 22691
{
...
var Function_138() //Position: 0x5904 / 22788
{
	int iVar0;
...
var Function_139(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x590C / 22796
{
	return Function_140(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5925 / 22821
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x5C18 / 23576
{
	int iVar0;
...
void Function_142() //Position: 0x5CCC / 23756
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x5D06 / 23814
{
	int iVar0;
...
void Function_144(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5D33 / 23859
{
	bool bVar0;
...
void Function_145() //Position: 0x5E84 / 24196
{
	int iVar0;
...
var Function_146(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5ECF / 24271
{
	int iVar0;
...
int Function_147() //Position: 0x5F9F / 24479
{
	int iVar0;
...
int Function_148() //Position: 0x60FB / 24827
{
	int iVar0;
...
bool Function_149(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x621B / 25115
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_150(var uParam0, int iParam1) //Position: 0x62EB / 25323
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_151(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6309 / 25353
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_152(bool bParam0) //Position: 0x643B / 25659
{
	bool bVar0;
...
bool Function_153(int iParam0) //Position: 0x645A / 25690
{
	int iVar0;
...
int Function_154() //Position: 0x6476 / 25718
{
	if (Function_156())
	{
...
int Function_155() //Position: 0x648F / 25743
{
	return Global_79349.f_16;
}

bool Function_156() //Position: 0x649B / 25755
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_157(int iParam0, bool bParam1, bool bParam2) //Position: 0x64A4 / 25764
{
	var uVar0;
