...
bool Function_47(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2B5A / 11098
{
...
void Function_56(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2E68 / 11880
{
	bool bVar0;
	bool bVar1;
...
bool Function_76(int iParam0, int iParam1) //Position: 0x36FD / 14077
{
	...
	if (Function_83(&bLocal_17, &bLocal_4, 8, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_81(&bLocal_20, "marshal01mobile", iParam1))
		{
			...
			{
				Function_80(bVar0, 1);
				OPEN_DOOR_DIRECTION_FAST(bVar0, false);
...
void Function_77() //Position: 0x3827 / 14375
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_17, vVar1, 15.0f, 1, true, 1);
	TASK_STAND_STILL(bLocal_17, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(bLocal_17);
	Function_78(bLocal_17, &bLocal_18, 0, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_17, bVar0, 1, true);
	bVar4 = CREATE_ACTOR_IN_LAYOUT(bLocal_19, "Marshal01deputy", 588, vVar1, 0.0f, 0.0f, 0.0f);
	SNAP_ACTOR_TO_GRINGO(bVar4, GET_OBJECT_FROM_GRINGO(bLocal_24), "UseCase1", true, 0, 0);
	...
	SNAP_ACTOR_TO_GRINGO(bVar4, bVar5, "UseCase1", true, 0, 0);
...
void Function_86(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x43A9 / 17321
{
	bool bVar0;
...
bool Function_87(bool bParam0, bool bParam1) //Position: 0x43FD / 17405
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_92(int iParam0, bool bParam1) //Position: 0x45AD / 17837
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_98(int iParam0) //Position: 0x48E2 / 18658
{
	bool bVar0;
	bool bVar1;
...
var Function_99(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x49DC / 18908
{
	int iVar0;
	bool bVar1;
...
void Function_100(var uParam0, int iParam1) //Position: 0x4A14 / 18964
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_101(var uParam0, bool bParam1, int iParam2) //Position: 0x4A25 / 18981
{
	int iVar0;
...
bool Function_102(int iParam0) //Position: 0x4AE9 / 19177
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x4E64 / 20068
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x4EA4 / 20132
{
	int iVar0;
...
void Function_105() //Position: 0x4ECF / 20175
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(int iParam0, bool bParam1) //Position: 0x4F11 / 20241
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4F95 / 20373
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4FBE / 20414
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x500F / 20495
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x501F / 20511
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5033 / 20531
{
	int iVar0;
...
var Function_112() //Position: 0x5058 / 20568
{
	return "PackedMetadata";
}

void Function_113(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x506F / 20591
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_114() //Position: 0x5195 / 20885
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_115() //Position: 0x51A6 / 20902
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_116() //Position: 0x51B7 / 20919
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_117(var uParam0, int iParam1) //Position: 0x51C8 / 20936
{
...
var Function_118(var uParam0, int iParam1, bool bParam2) //Position: 0x51EB / 20971
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x520A / 21002
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_120() //Position: 0x5216 / 21014
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x5221 / 21025
{
	int iVar0;
...
var Function_122() //Position: 0x524F / 21071
{
	return "PackedWeapon";
}

int Function_123(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5264 / 21092
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_124() //Position: 0x5368 / 21352
{
	return "MPItemGiver";
}

struct<32> Function_125(bool bParam0) //Position: 0x537C / 21372
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0, char* cParam1, char* cParam2) //Position: 0x53E6 / 21478
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5405 / 21509
{
	return "PBox_";
}

var Function_128() //Position: 0x5413 / 21523
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5439 / 21561
{
...
int Function_131(var uParam0, int iParam1) //Position: 0x5487 / 21639
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x55E8 / 21992
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5683 / 22147
{
	int iVar0;
	vector3 vVar1;
...
void Function_134(int iParam0) //Position: 0x57E4 / 22500
{
...
var Function_135() //Position: 0x5845 / 22597
{
	int iVar0;
...
var Function_136(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x584D / 22605
{
	return Function_137(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_137(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5866 / 22630
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_138(int iParam0) //Position: 0x5B59 / 23385
{
	int iVar0;
...
void Function_139() //Position: 0x5C0D / 23565
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x5C47 / 23623
{
	int iVar0;
...
void Function_141(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5C74 / 23668
{
	bool bVar0;
...
void Function_142() //Position: 0x5DC5 / 24005
{
	int iVar0;
...
var Function_143(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5E10 / 24080
{
	int iVar0;
...
int Function_145() //Position: 0x603C / 24636
{
	int iVar0;
...
bool Function_146(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x615C / 24924
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_147(var uParam0, int iParam1) //Position: 0x622C / 25132
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_148(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x624A / 25162
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_149(bool bParam0) //Position: 0x637C / 25468
{
	bool bVar0;
...
bool Function_150(int iParam0) //Position: 0x639B / 25499
{
	int iVar0;
...
int Function_151() //Position: 0x63B7 / 25527
{
	if (Function_153())
	{
...
int Function_152() //Position: 0x63D0 / 25552
{
	return Global_79349.f_16;
}

bool Function_153() //Position: 0x63DC / 25564
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_154(int iParam0, bool bParam1, bool bParam2) //Position: 0x63E5 / 25573
{
	var uVar0;
