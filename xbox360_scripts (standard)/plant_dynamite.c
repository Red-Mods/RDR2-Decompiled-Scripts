	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_88, &bLocal_87);
...
var Function_27() //Position: 0x1D93 / 7571
{
	int iVar0;
...
bool Function_28(bool bParam0) //Position: 0x1D9B / 7579
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1DBA / 7610
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1DC0 / 7616
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x1DCE / 7630
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1DD9 / 7641
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DF3 / 7667
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x1E11 / 7697
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x1E30 / 7728
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1E63 / 7779
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1E82 / 7810
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1E9C / 7836
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EAF / 7855
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2197 / 8599
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21B4 / 8628
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21C3 / 8643
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21E5 / 8677
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2209 / 8713
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2226 / 8742
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2246 / 8774
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2266 / 8806
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2314 / 8980
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2384 / 9092
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x239A / 9114
{
...
var Function_51(bool bParam0) //Position: 0x23BB / 9147
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23DB / 9179
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23EF / 9199
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23F9 / 9209
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2400 / 9216
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x240F / 9231
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x244E / 9294
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2479 / 9337
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2484 / 9348
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x257A / 9594
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x259C / 9628
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25C3 / 9667
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2882 / 10370
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28DF / 10463
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x293C / 10556
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2946 / 10566
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2964 / 10596
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2979 / 10617
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A00 / 10752
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A23 / 10787
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A41 / 10817
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A64 / 10852
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B7F / 11135
{
...
int Function_74(bool bParam0) //Position: 0x2BAA / 11178
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CAF / 11439
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CBC / 11452
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D2F / 11567
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_87));
		iLocal_88 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_37(iParam0->f_12))
...
void Function_78() //Position: 0x322D / 12845
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3264 / 12900
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3281 / 12929
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32B9 / 12985
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32C3 / 12995
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x32E4 / 13028
{
	iParam1 = iParam1;
...
void Function_84(float fParam0, char* cParam1, bool bParam2, int iParam3) //Position: 0x33A7 / 13223
{
	vector3 vVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33C3 / 13251
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x34CB / 13515
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x34E1 / 13537
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x3797 / 14231
{
	iParam1 = iParam1;
...
bool Function_89(bool bParam0) //Position: 0x37AE / 14254
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x37C7 / 14279
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x37E1 / 14305
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3819 / 14361
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x3830 / 14384
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3AF9 / 15097
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3B16 / 15126
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3BB2 / 15282
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3BD1 / 15313
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3BE0 / 15328
{
...
void Function_99(int iParam0) //Position: 0x3BFC / 15356
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C06 / 15366
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3C68 / 15464
{
...
void Function_102(int iParam0) //Position: 0x3C7C / 15484
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3C86 / 15494
{
