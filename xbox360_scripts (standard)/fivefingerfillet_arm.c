...
void Function_7(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0x31B / 795
{
	*uParam3 = iParam0 & 15;
...
bool Function_22() //Position: 0xA23 / 2595
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_34(Global_30640[0]))
			{
				iLocal_12 = Function_33(Local_5);
				if (iLocal_12 <= 1)
				{
					iLocal_12 = 1;
				}
				if (Function_31() <= iLocal_12)
				{
...
int Function_31() //Position: 0x123B / 4667
{
	return Function_32(0);
}

int Function_32(int iParam0) //Position: 0x1245 / 4677
{
...
var Function_33(int iParam0) //Position: 0x1286 / 4742
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_34(int iParam0) //Position: 0x12A0 / 4768
{
...
int Function_35(var uParam0, int iParam1) //Position: 0x12BC / 4796
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0x12D8 / 4824
{
...
void Function_37() //Position: 0x12EE / 4846
{
	Function_1();
	return;
}

void Function_38() //Position: 0x12F7 / 4855
{
...
void Function_39(int iParam0) //Position: 0x134B / 4939
{
...
void Function_40(var uParam0, float fParam1) //Position: 0x1360 / 4960
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x1381 / 4993
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x1394 / 5012
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_43(var uParam0) //Position: 0x13A3 / 5027
{
	return Function_13(*uParam0, 1);
}

void Function_44() //Position: 0x13B0 / 5040
{
	return;
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x13B6 / 5046
{
	bool bVar0;
...
void Function_46(int iParam0) //Position: 0x140D / 5133
{
	int iVar0;
...
void Function_47(int iParam0) //Position: 0x142A / 5162
{
	int iVar0;
...
var Function_48() //Position: 0x145E / 5214
{
	var uVar0;
