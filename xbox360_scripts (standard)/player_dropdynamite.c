...
void Function_27(bool bParam0, bool bParam1) //Position: 0x1D8C / 7564
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_28(bool bParam0) //Position: 0x1D99 / 7577
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1DB8 / 7608
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1DBE / 7614
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x1DCC / 7628
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1DD7 / 7639
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DF1 / 7665
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x1E0F / 7695
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x1E2E / 7726
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1E61 / 7777
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1E80 / 7808
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1E9A / 7834
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EAD / 7853
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_40() //Position: 0x2195 / 8597
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x219D / 8605
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x21BA / 8634
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21C9 / 8649
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x21EB / 8683
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x220F / 8719
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x222C / 8748
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x224C / 8780
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x226C / 8812
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x231A / 8986
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x238A / 9098
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x23A0 / 9120
{
...
var Function_52(bool bParam0) //Position: 0x23C1 / 9153
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x23E1 / 9185
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x23F5 / 9205
{
	uParam0 = uParam0;
	return;
}

int Function_55() //Position: 0x23FF / 9215
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x2406 / 9222
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x2415 / 9237
{
	bool bVar0;
...
bool Function_58(bool bParam0) //Position: 0x2454 / 9300
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(bool bParam0) //Position: 0x247F / 9343
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_60(bool bParam0) //Position: 0x248A / 9354
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_61(bool bParam0) //Position: 0x2580 / 9600
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_62(bool bParam0) //Position: 0x25A2 / 9634
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(bool bParam0) //Position: 0x25C9 / 9673
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2888 / 10376
{
	vector3 vVar0;
...
vector3 Function_65(vector3 vParam0) //Position: 0x28E5 / 10469
{
	vector3 vVar0;
...
void Function_66(int iParam0) //Position: 0x2942 / 10562
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x294C / 10572
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x296A / 10602
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x297F / 10623
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x2A06 / 10758
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A29 / 10793
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2A47 / 10823
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x2A6A / 10858
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2B85 / 11141
{
...
int Function_75(bool bParam0) //Position: 0x2BB0 / 11184
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2CB5 / 11445
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2CC2 / 11458
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2D35 / 11573
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3233 / 12851
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x326A / 12906
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3287 / 12935
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x32BF / 12991
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x32C9 / 13001
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32EA / 13034
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x32FE / 13054
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3406 / 13318
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x341C / 13340
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x36D2 / 14034
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_89(bool bParam0) //Position: 0x36E0 / 14048
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x36F9 / 14073
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x3713 / 14099
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x374B / 14155
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x3762 / 14178
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3A2B / 14891
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3A48 / 14920
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3AE4 / 15076
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3B03 / 15107
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3B12 / 15122
{
...
void Function_99(int iParam0) //Position: 0x3B2E / 15150
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3B38 / 15160
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3B9A / 15258
{
...
void Function_102(int iParam0) //Position: 0x3BAE / 15278
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3BB8 / 15288
{
