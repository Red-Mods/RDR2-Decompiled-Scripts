...
int Function_5(bool bParam0) //Position: 0x49F / 1183
{
	...
	if (GRINGO_HAS_ANIMSET_LOADED(Function_2(bParam0), bVar0))
	{
		if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "bSnap_OpenTrue_CloseFalse"))
		{
			...
			bVar3 = GRINGO_ANIM_GET_ACT_FILENAME(bVar2);
			bVar4 = GRINGO_ANIM_GET_AST_FILENAME(bVar2);
			bVar5 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar2);
			if (DECOR_GET_BOOL(GRINGO_GET_MY_OBJECT_REF(), "bSnap_OpenTrue_CloseFalse"))
			{
				if (!IS_OBJECT_ANIMATOR_VALID(bLocal_2))
				{
					bLocal_2 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(GET_TARGET_OBJECT(), bVar4, bVar3, bVar5);
				}
				if (IS_OBJECT_ANIMATOR_VALID(bLocal_2))
				{
					SET_OBJECT_ANIMATOR_NODE(bLocal_2, "/global/gate/quick_open");
			...
			else
			{
				...
				if (IS_OBJECT_ANIMATOR_VALID(bLocal_2))
				{
					SET_OBJECT_ANIMATOR_NODE(bLocal_2, "/global/gate/quick_close");
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_85, &bLocal_84);
...
void Function_18(bool bParam0, int iParam1) //Position: 0x1CF7 / 7415
{
...
void Function_19(var uParam0, var uParam1) //Position: 0x1D0C / 7436
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_20() //Position: 0x1D1A / 7450
{
	bool bVar0;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1D4B / 7499
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, bool bParam1) //Position: 0x1DBF / 7615
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_23(var uParam0, bool bParam1) //Position: 0x1E31 / 7729
{
	bool bVar0;
	bool bVar1;
...
float Function_24(bool bParam0) //Position: 0x1EF2 / 7922
{
	return Function_12(bParam0, "UseTime", 5.0f);
}

bool Function_25() //Position: 0x1F08 / 7944
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_26(bool bParam0) //Position: 0x1F15 / 7957
{
	return Function_12(bParam0, "MoveAllowance", 1,5f);
}

bool Function_27(bool bParam0, int iParam1) //Position: 0x1F35 / 7989
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_28(bool bParam0) //Position: 0x1F49 / 8009
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1F68 / 8040
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1F6E / 8046
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x1F7C / 8060
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1F87 / 8071
{
	return Function_8(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1FA1 / 8097
{
	return Function_10(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x1FBF / 8127
{
	return Function_8(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x1FDE / 8158
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x2011 / 8209
{
	return Function_8(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x2030 / 8240
{
	return Function_8(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x204A / 8266
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x205D / 8285
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	PRINTNL();
	bVar2 = Function_47(uParam0->f_12, &bVar0);
...
var Function_40() //Position: 0x2345 / 9029
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x234D / 9037
{
	return Function_10(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x236A / 9066
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2379 / 9081
{
	return Function_10(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x239B / 9115
{
	return Function_10(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x23BF / 9151
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x23DC / 9180
{
	return Function_10(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x23FC / 9212
{
	return Function_10(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x241C / 9244
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x24CA / 9418
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x253A / 9530
{
	if (!Function_15(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x2550 / 9552
{
...
var Function_52(bool bParam0) //Position: 0x2571 / 9585
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_12(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x2591 / 9617
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x25A5 / 9637
{
	uParam0 = uParam0;
	return;
}

int Function_55() //Position: 0x25AF / 9647
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x25B6 / 9654
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x25C5 / 9669
{
	bool bVar0;
...
bool Function_58(bool bParam0) //Position: 0x2604 / 9732
{
	return Function_12(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(bool bParam0) //Position: 0x262F / 9775
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_60(bool bParam0) //Position: 0x263A / 9786
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_61(bool bParam0) //Position: 0x2730 / 10032
{
	return Function_8(bParam0, "UsePosActorRelative", 0);
}

bool Function_62(bool bParam0) //Position: 0x2752 / 10066
{
	return Function_12(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(bool bParam0) //Position: 0x2779 / 10105
{
	bool bVar0;
	struct<8> Var1;
	...
	if (iLocal_3 && !iLocal_4)
	{
		...
		if (STRING_CONTAINS_STRING(bVar0, "small"))
		{
			...
			iLocal_5 = CREATE_LAYOUT(&Var1);
			bLocal_6 = Function_64(iLocal_5, 0, Global_34573, 1, 0, 0);
		}
	}
	return;
}

bool Function_64(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x27D3 / 10195
{
	bool bVar0;
...
void Function_65(var uParam0, int iParam1) //Position: 0x2852 / 10322
{
	bool bVar0;
	bool bVar1;
	...
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(bVar1, 20.0f, 1, 0);
	return;
}

void Function_66(var uParam0, bool bParam1) //Position: 0x288A / 10378
{
...
struct<32> Function_67(bool bParam0) //Position: 0x2916 / 10518
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2980 / 10624
{
	char* cVar0[32];
...
void Function_69(int iParam0) //Position: 0x299F / 10655
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x29A9 / 10665
{
	return Function_8(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x29C7 / 10695
{
	if (!Function_15(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x29DC / 10716
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2A63 / 10851
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A86 / 10886
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x2AA4 / 10916
{
	return Function_12(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x2AC7 / 10951
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x2BE2 / 11234
{
...
int Function_78(bool bParam0) //Position: 0x2C0D / 11277
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2D12 / 11538
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2D1F / 11551
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2D92 / 11666
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x3290 / 12944
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x32C7 / 12999
{
	return Function_12(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32E4 / 13028
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x331C / 13084
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x3326 / 13094
{
	return Function_8(bParam0, "BlockBumpReactions", 0);
}

void Function_87(bool bParam0, int iParam1) //Position: 0x3347 / 13127
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	...
	if (IS_LAYOUTREF_VALID(iLocal_5))
	{
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x3384 / 13188
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x348C / 13452
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x34A2 / 13474
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, int iParam1) //Position: 0x3758 / 14168
{
	bParam0 = bParam0;
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_92(bool bParam0) //Position: 0x377B / 14203
{
	return Function_8(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x3794 / 14228
{
	return Function_8(bParam0, "AllowWeapon", 0);
}

void Function_94(bool bParam0, int iParam1) //Position: 0x37AE / 14254
{
	bool bVar0;
	int iVar1;
	
	bParam0 = bParam0;
	iVar1 = Function_95(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_95(var uParam0, int iParam1) //Position: 0x37E6 / 14310
{
	return Function_10(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x37FD / 14333
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x3AC6 / 15046
{
	return Function_12(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x3AE3 / 15075
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(bool bParam0) //Position: 0x3B7F / 15231
{
	return Function_12(bParam0, "ActivationRadius", 2.0f);
}

bool Function_100(int iParam0, bool bParam1) //Position: 0x3B9E / 15262
{
	bool bVar0;
	bool bVar1;
	float fVar2;
...
bool Function_101(int iParam0) //Position: 0x3CAA / 15530
{
...
void Function_102(int iParam0) //Position: 0x3CC6 / 15558
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x3CD0 / 15568
{
	bool bVar0;
	bool bVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x3D32 / 15666
{
...
void Function_105(int iParam0) //Position: 0x3D46 / 15686
{
	GRINGO_LOAD_ANIMATION(Function_2(iParam0));
	return;
}

void Function_106(int iParam0) //Position: 0x3D54 / 15700
{
