	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_84, &bLocal_83);
						...
						else
						{
							...
							if (iVar43 >= 0)
							{
								if (GET_CURRENT_GAME_TIME() - fVar42) <= RAND_FLOAT_RANGE(fVar45, bVar44)
								{
									...
									iVar53 = GRINGO_GET_STRING_ATTR_BY_HANDLE(bVar52, &iVar46);
									iVar54 = 1;
									STRING_CLEAR_TOKENIZER();
									iVar55 = SET_OWNERSHIP_STRAGGLER(iVar53, ",");
									if (iVar55 >= 1)
									{
										...
										iVar53 = STRING_GET_TOKEN(0);
									}
									SAY_SINGLE_LINE_STRING(iParam0->f_16, iVar53, bVar48, bVar47, iVar54, 0, bVar49, bVar50);
								}
							}
						}
					}
...
void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E2C / 7724
{
	...
	{
		iVar6 = Function_43(uParam0->f_12, &bVar5);
		if (bVar5)
		{
			iVar8 = Function_42(uParam0->f_12, &bVar7);
			if (!bVar7)
			{
...
void Function_47(bool bParam0, int iParam1) //Position: 0x21EB / 8683
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_62(int iParam0) //Position: 0x2548 / 9544
{
	...
	if (iLocal_0 && !iLocal_1)
	{
		...
		if (!IS_OBJECTSET_VALID(bLocal_3))
		{
			GET_ACTOR_AXIS(Global_34573, &vVar2, 2);
			GET_POSITION(Global_34573, &vVar5);
			bLocal_3 = CREATE_OBJECTSET_IN_LAYOUT(Function_39(), bLocal_4, 4294967295, 0);
			...
			iVar9 = LOCATE_ACTORS_IN_VOLUME(bVar8, bLocal_3, 0, 1);
			if (iVar9 >= 0)
			{
				bVar10 = false;
				bVar10 = false;
				while (bVar10 < (iVar9 - 1))
				{
					bVar11 = GET_INDEXED_OBJECT_IN_OBJECTSET(bVar10, bLocal_3);
					if (!bVar11 != GET_OBJECT_FROM_ACTOR(Global_34573))
					{
						SET_OBJECT_POSITION_ON_GROUND(bVar11, vVar5);
						vVar5.x = (vVar5.x + 0,5f);
					}
					bVar10++;
				}
			}
			DESTROY_OBJECTSET(bLocal_3);
...
bool Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x26CA / 9930
{
	bool bVar0;
...
void Function_64(int iParam0) //Position: 0x2749 / 10057
{
	int iVar0;
...
void Function_65(int iParam0) //Position: 0x27AA / 10154
{
...
void Function_66(int iParam0) //Position: 0x2814 / 10260
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_67(int iParam0) //Position: 0x287E / 10366
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
bool Function_68(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x28E8 / 10472
{
	bool bVar0;
...
void Function_69(int iParam0) //Position: 0x2967 / 10599
{
	int iVar0;
...
void Function_70(int iParam0) //Position: 0x29C8 / 10696
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_71(int iParam0) //Position: 0x2A32 / 10802
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_72(int iParam0) //Position: 0x2A9C / 10908
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
bool Function_73(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2B06 / 11014
{
	bool bVar0;
...
void Function_74(int iParam0) //Position: 0x2B85 / 11141
{
	int iVar0;
...
void Function_75(int iParam0) //Position: 0x2BE6 / 11238
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_76(int iParam0) //Position: 0x2C50 / 11344
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_77(int iParam0) //Position: 0x2CBA / 11450
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_78(int iParam0) //Position: 0x2D24 / 11556
{
	iParam0 = iParam0;
	return;
}

bool Function_79(bool bParam0) //Position: 0x2D2E / 11566
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_80(int iParam0) //Position: 0x2D4C / 11596
{
	if (!Function_14(iParam0))
	{
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x2D61 / 11617
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_82(int iParam0) //Position: 0x2DE8 / 11752
{
	vector3 vVar0;
...
vector3 Function_83(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2E0B / 11787
{
	vector3 vVar0;
...
bool Function_84(bool bParam0) //Position: 0x2E29 / 11817
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_85(bool bParam0, bool bParam1) //Position: 0x2E4C / 11852
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_86(bool bParam0, int iParam1) //Position: 0x2F67 / 12135
{
...
int Function_87(bool bParam0) //Position: 0x2F92 / 12178
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3097 / 12439
{
	return (uParam0 && iParam1) == 0;
}

void Function_89(int iParam0) //Position: 0x30A4 / 12452
{
	if (Function_88(iParam0->f_40, 16))
	{
...
void Function_90(int iParam0, bool bParam1) //Position: 0x3117 / 12567
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_91() //Position: 0x3615 / 13845
{
	bool bVar0;
...
bool Function_92(bool bParam0) //Position: 0x364C / 13900
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_93(var uParam0, int iParam1) //Position: 0x3669 / 13929
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_94(int iParam0) //Position: 0x36A1 / 13985
{
	iParam0 = iParam0;
	return;
}

bool Function_95(bool bParam0) //Position: 0x36AB / 13995
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_96(var uParam0, int iParam1) //Position: 0x36CC / 14028
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_97(bool bParam0, bool bParam1) //Position: 0x36F2 / 14066
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_98(bool bParam0, bool bParam1) //Position: 0x37FA / 14330
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_99(int iParam0) //Position: 0x3810 / 14352
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_100(bool bParam0, int iParam1) //Position: 0x3AC6 / 15046
{
	iParam1 = iParam1;
	iLocal_0 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_101(bool bParam0) //Position: 0x3ADE / 15070
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_102(bool bParam0) //Position: 0x3AF7 / 15095
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_103(int iParam0, int iParam1) //Position: 0x3B11 / 15121
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_104(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_104(var uParam0, int iParam1) //Position: 0x3B49 / 15177
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_105(int iParam0, int iParam1) //Position: 0x3B60 / 15200
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_106(bool bParam0) //Position: 0x3E29 / 15913
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_107(bool bParam0, bool bParam1) //Position: 0x3E46 / 15942
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_108(int iParam0) //Position: 0x3EE2 / 16098
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_109(var uParam0, int iParam1) //Position: 0x3F01 / 16129
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_110(int iParam0) //Position: 0x3F10 / 16144
{
...
void Function_111(int iParam0) //Position: 0x3F2C / 16172
{
	iParam0 = iParam0;
	return;
}

void Function_112(bool bParam0, int iParam1) //Position: 0x3F36 / 16182
{
	bool bVar0;
	bool bVar1;
...
void Function_113(int iParam0, int iParam1) //Position: 0x3F98 / 16280
{
...
void Function_114(int iParam0) //Position: 0x3FAC / 16300
{
	iParam0 = iParam0;
	return;
}

void Function_115(int iParam0) //Position: 0x3FB6 / 16310
{
