...
void Function_62(bool bParam0) //Position: 0x2542 / 9538
{
	...
	{
		iLocal_1 = 1;
		iLocal_2 = CREATE_LAYOUT("TakeTNT_Layout");
		Function_63(iLocal_2, 0, Global_34573, 1, 0, 0);
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x257B / 9595
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x25F6 / 9718
{
	int iVar0;
	bool bVar1;
...
void Function_66(int iParam0) //Position: 0x26BA / 9914
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26C4 / 9924
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26E2 / 9954
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26F7 / 9975
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x277E / 10110
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27A1 / 10145
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x27BF / 10175
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x27E2 / 10210
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x28FD / 10493
{
...
int Function_75(bool bParam0) //Position: 0x2928 / 10536
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A2D / 10797
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2A3A / 10810
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AAD / 10925
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x2FAB / 12203
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x2FE2 / 12258
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2FFF / 12287
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3037 / 12343
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x3041 / 12353
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(bool bParam0, int iParam1) //Position: 0x3062 / 12386
{
	bool bVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x30CD / 12493
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x31D5 / 12757
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x31EB / 12779
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x34A1 / 13473
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_89(bool bParam0) //Position: 0x34B6 / 13494
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x34CF / 13519
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, int iParam1) //Position: 0x34E9 / 13545
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3521 / 13601
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x3538 / 13624
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3801 / 14337
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x381E / 14366
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x38BA / 14522
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(bool bParam0, int iParam1) //Position: 0x38D9 / 14553
{
	bool bVar0;
	...
	{
		bVar0 = ROUND(_GET_AMMO_AMOUNT(bParam0, 5, 0));
		if (ACTOR_HAS_WEAPON_IN_HAND(bParam0, 24) || GET_WEAPON_EQUIPPED(bParam0, 2) != 24)
		{
			bVar0++;
		}
...
bool Function_98(int iParam0) //Position: 0x3927 / 14631
{
...
void Function_99(int iParam0) //Position: 0x3943 / 14659
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x394D / 14669
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x39AF / 14767
{
...
void Function_102(int iParam0) //Position: 0x39C3 / 14787
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x39CD / 14797
{
