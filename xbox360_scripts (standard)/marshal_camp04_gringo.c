...
void Function_77() //Position: 0x379A / 14234
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_16, vVar1, 15.0f, 1, true, 1);
	...
	SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_16, bVar0, 1, true);
	...
	SET_ACTOR_STAY_WITHIN_VOLUME(bVar5, bVar0, 1, true);
...
void Function_89(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x445C / 17500
{
	bool bVar0;
...
bool Function_90(bool bParam0, bool bParam1) //Position: 0x44B0 / 17584
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0, bool bParam1) //Position: 0x4660 / 18016
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_101(int iParam0) //Position: 0x4995 / 18837
{
	bool bVar0;
	bool bVar1;
...
var Function_102(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A8F / 19087
{
	int iVar0;
	bool bVar1;
...
void Function_103(var uParam0, int iParam1) //Position: 0x4AC7 / 19143
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_104(var uParam0, bool bParam1, int iParam2) //Position: 0x4AD8 / 19160
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4B9C / 19356
{
	int iVar0;
	int iVar1;
...
void Function_106() //Position: 0x4F17 / 20247
{
	if (!Function_153(128))
	{
		return;
...
bool Function_107() //Position: 0x4F57 / 20311
{
	int iVar0;
...
void Function_108() //Position: 0x4F82 / 20354
{
	if (!Function_153(128))
	{
		return;
...
void Function_109(int iParam0, bool bParam1) //Position: 0x4FC4 / 20420
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5048 / 20552
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x5071 / 20593
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x50C2 / 20674
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x50D2 / 20690
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x50E6 / 20710
{
	int iVar0;
...
var Function_115() //Position: 0x510B / 20747
{
	return "PackedMetadata";
}

void Function_116(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5122 / 20770
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_117() //Position: 0x5248 / 21064
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_118() //Position: 0x5259 / 21081
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_119() //Position: 0x526A / 21098
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_120(var uParam0, int iParam1) //Position: 0x527B / 21115
{
...
var Function_121(var uParam0, int iParam1, bool bParam2) //Position: 0x529E / 21150
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x52BD / 21181
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_123() //Position: 0x52C9 / 21193
{
	return Function_124(39);
}

int Function_124(int iParam0) //Position: 0x52D4 / 21204
{
	int iVar0;
...
var Function_125() //Position: 0x5302 / 21250
{
	return "PackedWeapon";
}

int Function_126(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5317 / 21271
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_127() //Position: 0x541B / 21531
{
	return "MPItemGiver";
}

struct<32> Function_128(bool bParam0) //Position: 0x542F / 21551
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5499 / 21657
{
	char* cVar0[32];
...
var Function_130() //Position: 0x54B8 / 21688
{
	return "PBox_";
}

var Function_131() //Position: 0x54C6 / 21702
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x54EC / 21740
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5514 / 21780
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x553A / 21818
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x569B / 22171
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5736 / 22326
{
	int iVar0;
	vector3 vVar1;
...
void Function_137(int iParam0) //Position: 0x5897 / 22679
{
...
var Function_138() //Position: 0x58F8 / 22776
{
	int iVar0;
...
var Function_139(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5900 / 22784
{
	return Function_140(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5919 / 22809
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x5C0C / 23564
{
	int iVar0;
...
void Function_142() //Position: 0x5CC0 / 23744
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x5CFA / 23802
{
	int iVar0;
...
void Function_144(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5D27 / 23847
{
	bool bVar0;
...
void Function_145() //Position: 0x5E78 / 24184
{
	int iVar0;
...
var Function_146(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5EC3 / 24259
{
	int iVar0;
...
int Function_147() //Position: 0x5F93 / 24467
{
	int iVar0;
...
int Function_148() //Position: 0x60EF / 24815
{
	int iVar0;
...
bool Function_149(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x620F / 25103
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_150(var uParam0, int iParam1) //Position: 0x62DF / 25311
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_151(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x62FD / 25341
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_152(bool bParam0) //Position: 0x642F / 25647
{
	bool bVar0;
...
bool Function_153(int iParam0) //Position: 0x644E / 25678
{
	int iVar0;
...
int Function_154() //Position: 0x646A / 25706
{
	if (Function_156())
	{
...
int Function_155() //Position: 0x6483 / 25731
{
	return Global_79349.f_16;
}

bool Function_156() //Position: 0x648F / 25743
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_157(int iParam0, bool bParam1, bool bParam2) //Position: 0x6498 / 25752
{
	var uVar0;
