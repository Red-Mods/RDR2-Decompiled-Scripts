...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F1C / 12060
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3024 / 12324
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x303A / 12346
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32F0 / 13040
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	HUD_ENABLE(false);
...
bool Function_86(bool bParam0) //Position: 0x330D / 13069
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x3326 / 13094
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x3340 / 13120
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3378 / 13176
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x338F / 13199
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3658 / 13912
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3675 / 13941
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x3711 / 14097
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3730 / 14128
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x373F / 14143
{
...
void Function_96(int iParam0) //Position: 0x375B / 14171
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3765 / 14181
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x37C7 / 14279
{
...
void Function_99(int iParam0) //Position: 0x37DB / 14299
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37E5 / 14309
{
