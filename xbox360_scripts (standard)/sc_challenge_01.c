...
void main() //Position: 0x0 / 0
{
	...
	iVar44 = 0;
	iVar45 = 0;
	bVar48 = Function_37(&cScriptParam_0);
	iVar49 = 1;
	bVar50 = false;
	iVar51 = 4294967295;
	iVar56 = Function_36();
	while ((!IS_EXITFLAG_SET() && iVar49) && iVar56 != Function_36())
	{
		switch (iVar46)
		{
			case 0x00000000:
				...
				Function_35(bVar48, &Global_84611, I2STR(bVar48), 0);
				...
				while (bVar43 <= 10)
				{
					memcpy(&uVar33, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_34(uVar31, I2STR(bVar43)), 6);
					if (SC_CHALLENGE_IS_VAR_VALID(cScriptParam_0, &uVar33))
					{
						vVar0[bVar433] = SC_CHALLENGE_GET_VAR_INT(cScriptParam_0, &uVar33);
					}
					memcpy(&uVar33, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_34(cVar32, I2STR(bVar43)), 6);
					if (SC_CHALLENGE_IS_VAR_VALID(cScriptParam_0, &uVar33))
					{
...
int Function_4(var uParam0, int iParam1) //Position: 0x651 / 1617
{
...
void Function_12(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBEE / 3054
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
void Function_25(int iParam0, bool bParam1, int iParam2) //Position: 0x191B / 6427
{
...
int Function_26(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1937 / 6455
{
	int iVar0;
	int iVar1;
...
void Function_27(int iParam0) //Position: 0x1B57 / 6999
{
	if (Function_5(iParam0))
	{
		if (!Function_3(iParam0))
...
void Function_28(int iParam0, int iParam1) //Position: 0x1C16 / 7190
{
	*iParam0 = (*iParam0 || iParam1);
	return;
}

bool Function_29(int iParam0, float fParam1) //Position: 0x1C25 / 7205
{
	if (Function_5(iParam0))
	{
...
void Function_30(int iParam0) //Position: 0x1C41 / 7233
{
	Function_31(iParam0, 0.0f);
	return;
}

void Function_31(var uParam0, float fParam1) //Position: 0x1C4D / 7245
{
...
void Function_32(var uParam0, int iParam1) //Position: 0x1C6E / 7278
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_33(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x1C81 / 7297
{
	int iVar0;
...
struct<32> Function_34(char* cParam0, char* cParam1) //Position: 0x1CCC / 7372
{
	char* cVar0[32];
...
void Function_35(int iParam0, var uParam1, char* cParam2, var uParam3) //Position: 0x1CE5 / 7397
{
	int iVar0;
...
bool Function_36() //Position: 0x1D38 / 7480
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_37(int iParam0) //Position: 0x1D41 / 7489
{
	int iVar0;
	int iVar1;
