...
void Function_62(bool bParam0) //Position: 0x2548 / 9544
{
	bParam0 = bParam0;
	if (iLocal_1 && !iLocal_2)
	{
		iLocal_2 = 1;
		iLocal_3 = CREATE_LAYOUT("BlowTheHatch_Layout");
		bLocal_4 = Function_63(iLocal_3, 0, Global_34573, 1, 0, 0);
	}
	return;
}

bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2587 / 9607
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2601 / 9729
{
	int iVar0;
	bool bVar1;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2639 / 9785
{
...
void Function_66(int iParam0) //Position: 0x26B9 / 9913
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26C3 / 9923
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26E1 / 9953
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26F6 / 9974
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
	...
	if (GRINGO_COMPONENT_CHECK_NAME("UseCase1", bParam1))
	{
		...
		if (fVar7 > 0,5f)
		{
			...
			TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar3, bVar6, 0, true, 1);
			SNAP_OBJECT_TO_GROUND(GET_OBJECT_FROM_ACTOR(bParam0), 10.0f, false, 1092616192);
		}
		else
		{
			fVar7 = ((fVar7 - 0,95f) * -1.0f);
			TELEPORT_ACTOR_WITH_HEADING(StackVal, StackVal, StackVal, StackVal, Function_71(StackVal, StackVal, bParam0, vVar0, vVar0, vVar3), 0, true, 1);
			GET_OBJECT_RELATIVE_POSITION(GET_OBJECT_FROM_ACTOR(bParam0), 0.0f, 0.0f, fVar7, &vVar3);
			TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar3, Function_70(bParam0), 0, true, 1);
			SNAP_OBJECT_TO_GROUND(GET_OBJECT_FROM_ACTOR(bParam0), 10.0f, false, 1092616192);
		}
	}
	return 1;
...
var Function_70(bool bParam0) //Position: 0x27CD / 10189
{
	return GET_HEADING(bParam0);
}

var Function_71(vector3 vParam0, vector3 vParam3) //Position: 0x27D8 / 10200
{
	var uVar0;
...
void Function_72(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x27F2 / 10226
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

var Function_73(bool bParam0, vector3 vParam1) //Position: 0x2815 / 10261
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0) //Position: 0x288F / 10383
{
	vector3 vVar0;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x28F9 / 10489
{
...
int Function_76(bool bParam0) //Position: 0x2924 / 10532
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2A29 / 10793
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2A36 / 10806
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2AA9 / 10921
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x2FA7 / 12199
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x2FDE / 12254
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x2FFB / 12283
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x3033 / 12339
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x303D / 12349
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x305E / 12382
{
	iParam1 = iParam1;
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x30B8 / 12472
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x31C0 / 12736
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x31D6 / 12758
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(bool bParam0, int iParam1) //Position: 0x348C / 13452
{
	iParam1 = iParam1;
...
bool Function_90(bool bParam0) //Position: 0x34B8 / 13496
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x34D1 / 13521
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, int iParam1) //Position: 0x34EB / 13547
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3523 / 13603
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x353A / 13626
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3803 / 14339
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3820 / 14368
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x38BC / 14524
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x38DB / 14555
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_99(int iParam0) //Position: 0x390F / 14607
{
...
void Function_100(int iParam0) //Position: 0x392B / 14635
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3935 / 14645
{
	bool bVar0;
	bool bVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x3997 / 14743
{
...
void Function_103(int iParam0) //Position: 0x39AB / 14763
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x39B5 / 14773
{
