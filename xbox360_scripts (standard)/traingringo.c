...
void Function_53(var uParam0) //Position: 0x2381 / 9089
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x238B / 9099
{
	return 0;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2392 / 9106
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23A1 / 9121
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23E0 / 9184
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x240B / 9227
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2416 / 9238
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x250C / 9484
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x252E / 9518
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2555 / 9557
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x255F / 9567
{
	iParam0 = iParam0;
	return;
}

bool Function_64(bool bParam0) //Position: 0x2569 / 9577
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2587 / 9607
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x259C / 9628
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x2623 / 9763
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2646 / 9798
{
	vector3 vVar0;
...
bool Function_69(bool bParam0) //Position: 0x2664 / 9828
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x2687 / 9863
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_71(bool bParam0, int iParam1) //Position: 0x27A2 / 10146
{
...
int Function_72(bool bParam0) //Position: 0x27CD / 10189
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x28D2 / 10450
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x28DF / 10463
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x2952 / 10578
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x2E50 / 11856
{
	return;
}

bool Function_77(bool bParam0) //Position: 0x2E56 / 11862
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2E73 / 11891
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_79(int iParam0) //Position: 0x2EAB / 11947
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x2EB5 / 11957
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2ED6 / 11990
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_ATTACHMENT_VALID(bLocal_1))
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F33 / 12083
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x303B / 12347
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x3051 / 12369
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_85(iParam0->f_16, bVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_85(var uParam0, int iParam1) //Position: 0x3307 / 13063
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x3315 / 13077
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x332E / 13102
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x3348 / 13128
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3380 / 13184
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3397 / 13207
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3660 / 13920
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x367D / 13949
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x3719 / 14105
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3738 / 14136
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3747 / 14151
{
...
void Function_96(int iParam0) //Position: 0x3763 / 14179
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x376D / 14189
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x37CF / 14287
{
...
void Function_99(int iParam0) //Position: 0x37E3 / 14307
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_100(int iParam0) //Position: 0x3849 / 14409
{
