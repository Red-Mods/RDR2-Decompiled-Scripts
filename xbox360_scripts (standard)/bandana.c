...
int Function_44(bool bParam0) //Position: 0x2062 / 8290
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_60(bParam0, iVar0))
			{
				Function_54(bParam0, iVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_53(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_49(bParam0, iVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
...
bool Function_46(bool bParam0, bool bParam1, int iParam2) //Position: 0x2164 / 8548
{
	bool bVar0;
...
void Function_48(int iParam0, bool bParam1) //Position: 0x222A / 8746
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_49(bool bParam0, bool bParam1, int iParam2) //Position: 0x239D / 9117
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(bParam1, bVar1, Function_51(bVar1, "AttachBone", &iVar2), Function_51(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_50(bVar1, bParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_50(bool bParam0, int iParam1) //Position: 0x2427 / 9255
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x24D5 / 9429
{
	int iVar0;
	bool bVar1;
...
var Function_52(bool bParam0) //Position: 0x251A / 9498
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_53(bool bParam0) //Position: 0x2530 / 9520
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_54(var uParam0, bool bParam1, int iParam2) //Position: 0x2546 / 9542
{
	uParam0 = Function_59(uParam0);
	*iParam2 = 0;
	if (((Function_55(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
	{
		if (Function_47(0))
		{
			Function_48(0, 0);
	...
	else
	{
		...
		if (!Function_47(0))
		{
			DECOR_SET_BOOL(bParam1, "ITEM_ATTACHING", true);
		}
		iLocal_3 = 1;
		*iParam2 = 1;
	}
...
int Function_55(bool bParam0, bool bParam1, bool bParam2) //Position: 0x25F1 / 9713
{
...
bool Function_56() //Position: 0x26A7 / 9895
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_57(bool bParam0) //Position: 0x26BE / 9918
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_58(bool bParam0) //Position: 0x26C9 / 9929
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_59(bool bParam0) //Position: 0x26D7 / 9943
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_60(int iParam0, bool bParam1) //Position: 0x26F1 / 9969
{
	bool bVar0;
	bool bVar1;
	
	iParam0 = iParam0;
	bVar0 = Function_52(iParam0);
	bVar1 = Function_53(iParam0);
	if (IS_GRINGO_COMPONENT_VALID(bVar1))
	{
		if (!iLocal_4)
		{
