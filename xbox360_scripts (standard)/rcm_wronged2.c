...
void main() //Position: 0x0 / 0
{
	...
	iLocal_187 = 0;
	bLocal_196 = false;
	vLocal_200 = { 731,427f, 78,306f, 1312,238f };
	iLocal_204 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iLocal_199)
				{
					...
					case 0x00000004:
						Function_145(&(Global_63541[ScriptParam_055]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iLocal_199 = 5;
						break;
					
					case 0x00000005:
						if (Function_105("$/cutscene/RCM_20_CS02/RCM_20_CS02", &iLocal_188, 24094, 24087, 22874, 22773, 22487, 22471, 1, 1, 2, 2, 0))
						{
							iLocal_199 = 6;
						}
						break;
					...
					case 0x00000006:
						Function_104("Wronged_Help3", 10.0f, 1, 0, 0, 1, 0);
						Function_103("Wronged2_SHORT", 0x40f00000, 1, 2, 0, 0, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "Wronged2_OBJ", 0, 3, false);
						Function_102(Global_63541[ScriptParam_055].f_140, 0);
						Function_6(73, 1, 1, 0);
						ACTOR_DATA_GRAVITY_LIMIT(0);
						Function_5(&Global_63541[7255] + 144, 256);
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x226 / 550
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x241 / 577
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x25E / 606
{
	RELEASE_LAYOUT_REF(bLocal_203);
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x269 / 617
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_5(int iParam0, int iParam1) //Position: 0x278 / 632
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x28B / 651
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_5(&Global_63541[iParam055] + 144, 64);
...
void Function_7(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x7C0 / 1984
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_8() //Position: 0x933 / 2355
{
	return;
}

void Function_9(var uParam0, var uParam1) //Position: 0x939 / 2361
{
	if (Global_3381)
	{
		return;
...
bool Function_10() //Position: 0x97B / 2427
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_11(bool bParam0) //Position: 0x984 / 2436
{
...
void Function_12() //Position: 0x9D5 / 2517
{
	Function_40();
	Function_39();
	Function_39();
...
void Function_13() //Position: 0xA08 / 2568
{
...
void Function_14() //Position: 0xB0E / 2830
{
	float fVar0;
...
void Function_15() //Position: 0xB41 / 2881
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_16() //Position: 0xCCF / 3279
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_17() //Position: 0xE83 / 3715
{
	Function_18(&Global_28260, 1, 0);
	return;
}

void Function_18(int iParam0, bool bParam1, var uParam2) //Position: 0xE91 / 3729
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_19() //Position: 0x1082 / 4226
{
...
struct<8> Function_20() //Position: 0x1097 / 4247
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_21(int iParam0, bool bParam1, bool bParam2) //Position: 0x1132 / 4402
{
	int iVar0;
...
void Function_22(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x13CD / 5069
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_24(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_23(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_23() //Position: 0x19FA / 6650
{
	int iVar0;
...
var Function_24(int iParam0) //Position: 0x1A02 / 6658
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_25(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1A13 / 6675
{
	char* cVar0[32];
...
struct<32> Function_26(char* cParam0, char* cParam1) //Position: 0x1B08 / 6920
{
	char* cVar0[32];
...
void Function_27(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1B21 / 6945
{
	float fVar0;
...
var Function_28(int iParam0, int iParam1) //Position: 0x1B86 / 7046
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_29(int iParam0, bool bParam1) //Position: 0x1B98 / 7064
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_30(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1BAA / 7082
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_31(int iParam0) //Position: 0x1CDA / 7386
{
	return Global_35278[iParam020].f_48;
}

float Function_32(int iParam0) //Position: 0x1CE9 / 7401
{
	if (!iParam0 != 4294967295)
	{
...
var Function_33(int iParam0) //Position: 0x1D22 / 7458
{
	if (iParam0 == 4294967295)
	{
...
void Function_34(int iParam0) //Position: 0x1D5F / 7519
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_35(int iParam0, bool bParam1, bool bParam2) //Position: 0x1EF9 / 7929
{
	int iVar0;
	int iVar1;
...
int Function_36(bool bParam0) //Position: 0x2113 / 8467
{
...
struct<8> Function_37() //Position: 0x2154 / 8532
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_38() //Position: 0x21DD / 8669
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_39() //Position: 0x2274 / 8820
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_40() //Position: 0x22F3 / 8947
{
...
int Function_41(int iParam0, bool bParam1, int iParam2) //Position: 0x2319 / 8985
{
	int iVar0;
	int iVar1;
...
void Function_42() //Position: 0x2523 / 9507
{
	vector3 vVar0;
	var uVar3;
...
bool Function_43(vector3 vParam0) //Position: 0x25C4 / 9668
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_44(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x25DC / 9692
{
	int iVar0;
...
vector3 Function_45() //Position: 0x26C3 / 9923
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_46(int iParam0) //Position: 0x26CC / 9932
{
...
int Function_47(bool bParam0, bool bParam1) //Position: 0x26E2 / 9954
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_48(vector3 vParam0, vector3 vParam3) //Position: 0x27A9 / 10153
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_49(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x27C6 / 10182
{
	uParam0 = uParam0;
...
void Function_50(bool bParam0) //Position: 0x286A / 10346
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_51(int iParam0, int iParam1) //Position: 0x2A0C / 10764
{
	int iVar0;
	bool bVar1;
...
void Function_52(int iParam0) //Position: 0x2AC6 / 10950
{
	float fVar0;
	bool bVar1;
...
int Function_53(var uParam0, int iParam1) //Position: 0x2B68 / 11112
{
	int iVar0;
	var uVar1;
...
void Function_54(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x2CC9 / 11465
{
	struct<8> Var0;
...
struct<32> Function_55(bool bParam0) //Position: 0x2D64 / 11620
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_56(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2DCE / 11726
{
	char* cVar0[32];
...
int Function_57(bool bParam0) //Position: 0x2DED / 11757
{
	int iVar0;
	vector3 vVar1;
...
float Function_58(bool bParam0, vector3 vParam1) //Position: 0x2F4E / 12110
{
	vector3 vVar0;
...
vector3 Function_59(bool bParam0) //Position: 0x2FC8 / 12232
{
	vector3 vVar0;
...
void Function_60(int iParam0) //Position: 0x3032 / 12338
{
...
bool Function_61(int iParam0) //Position: 0x3093 / 12435
{
...
void Function_62(int iParam0, int iParam1) //Position: 0x30A9 / 12457
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_63(bool bParam0) //Position: 0x31EE / 12782
{
...
var Function_64(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x321A / 12826
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_65(int iParam0) //Position: 0x3236 / 12854
{
...
bool Function_66(int iParam0, int iParam1) //Position: 0x324B / 12875
{
...
bool Function_67(int iParam0, int iParam1) //Position: 0x3360 / 13152
{
	int iVar0;
...
bool Function_68(int iParam0) //Position: 0x34A4 / 13476
{
...
bool Function_69(int iParam0) //Position: 0x34C8 / 13512
{
...
bool Function_70(int iParam0) //Position: 0x34DD / 13533
{
...
var Function_71(int iParam0) //Position: 0x34F4 / 13556
{
...
bool Function_72(int iParam0) //Position: 0x350E / 13582
{
...
bool Function_73(int iParam0) //Position: 0x3524 / 13604
{
	return StackVal;
}

bool Function_74(var uParam0, int iParam1) //Position: 0x3534 / 13620
{
	int iVar0;
...
bool Function_75(int iParam0) //Position: 0x3550 / 13648
{
	if (!iParam0->f_152)
	{
...
bool Function_76(int iParam0) //Position: 0x3597 / 13719
{
...
bool Function_77(int iParam0) //Position: 0x35F0 / 13808
{
	int iVar0;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x360C / 13836
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3628 / 13864
{
...
bool Function_80(int iParam0) //Position: 0x363D / 13885
{
...
int Function_81(int iParam0) //Position: 0x3652 / 13906
{
...
bool Function_82(var uParam0, bool bParam1) //Position: 0x3667 / 13927
{
	return (uParam0 && bParam1) == 0;
}

void Function_83() //Position: 0x3674 / 13940
{
...
var Function_84(int iParam0, int iParam1) //Position: 0x36EF / 14063
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_85(int iParam0, bool bParam1) //Position: 0x42E1 / 17121
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x431E / 17182
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x436D / 17261
{
...
int Function_88(int iParam0) //Position: 0x4383 / 17283
{
...
void Function_89() //Position: 0x43EC / 17388
{
...
bool Function_90(int iParam0) //Position: 0x440F / 17423
{
	if (!Function_87(iParam0))
	{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x4460 / 17504
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x448D / 17549
{
	if (!Function_87(iParam0))
	{
...
void Function_93(bool bParam0) //Position: 0x44DF / 17631
{
	bool bVar0;
...
void Function_94() //Position: 0x4519 / 17689
{
	bool bVar0;
...
void Function_95(bool bParam0) //Position: 0x4577 / 17783
{
	PRINTSTRING("Day ");
...
void Function_96(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x45BD / 17853
{
	bool bVar0;
	char* cVar1[16];
...
void Function_97(char* cParam0, int iParam1) //Position: 0x4629 / 17961
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_98(bool bParam0, var uParam1, int iParam2) //Position: 0x4660 / 18016
{
	var uVar0;
	char* cVar1[16];
...
int Function_99(char* cParam0) //Position: 0x46D8 / 18136
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_100(int iParam0) //Position: 0x4779 / 18297
{
	int iVar0;
	int iVar1;
...
bool Function_101(var uParam0, int iParam1) //Position: 0x47B6 / 18358
{
...
void Function_103(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x47EE / 18414
{
	int iVar0;
...
void Function_104(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4841 / 18497
{
	int iVar0;
...
bool Function_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x488C / 18572
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_106(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x4935 / 18741
{
	if (!bParam15)
	{
...
void Function_107(bool bParam0) //Position: 0x4F49 / 20297
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_109() //Position: 0x5033 / 20531
{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x5045 / 20549
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_23(), bParam1, 4294967295, 1);
...
bool Function_111(bool bParam0) //Position: 0x50C5 / 20677
{
	bool bVar0;
...
float Function_112(int iParam0) //Position: 0x50F4 / 20724
{
...
bool Function_113(int iParam0) //Position: 0x51BC / 20924
{
	return Function_82(*iParam0, 2);
}

bool Function_114(int iParam0) //Position: 0x51C9 / 20937
{
	return Function_82(*iParam0, 1);
}

int Function_115(bool bParam0) //Position: 0x51D6 / 20950
{
	bool bVar0;
	bool bVar1;
...
bool Function_116() //Position: 0x528E / 21134
{
	bool bVar0;
	bool bVar1;
...
void Function_117(int iParam0) //Position: 0x52C8 / 21192
{
	Function_118(iParam0, 0.0f);
	return;
}

void Function_118(var uParam0, float fParam1) //Position: 0x52D4 / 21204
{
...
bool Function_119(int iParam0) //Position: 0x52F5 / 21237
{
	return iParam0->f_20;
}

void Function_120(var uParam0, int iParam1) //Position: 0x52FF / 21247
{
	Function_121(uParam0, iParam1, 0);
	return;
}

void Function_121(var uParam0, bool bParam1, bool bParam2) //Position: 0x530D / 21261
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_122(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5459 / 21593
{
	int iVar0;
	int iVar1;
...
void Function_123(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5679 / 22137
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_124() //Position: 0x56A2 / 22178
{
	bool bVar0;
	bool bVar1;
...
void Function_125() //Position: 0x56ED / 22253
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_23(), Global_63535, 15, 0);
	vVar3 = { StackVal, StackVal, Global_34574 };
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_23(), 2, vVar3, 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
...
int Function_126() //Position: 0x57C7 / 22471
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_127() //Position: 0x57D7 / 22487
{
...
void Function_128(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x57F0 / 22512
{
	bool bVar0;
...
void Function_129() //Position: 0x58E0 / 22752
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_130() //Position: 0x58F5 / 22773
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, 720,495f, 78,476f, 1317,025f, 270,412f, 1, true, 1);
	TELEPORT_ACTOR_WITH_HEADING(bLocal_195, *(&Global_63541[7455] + 100), Global_63541[7455].f_124, 1, true, 1);
	TASK_STAND_STILL(bLocal_195, -1.0f, 0, 0);
	Global_63541[7455].f_204 = bLocal_195;
	Global_63541[7355].f_204 = "";
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_131() //Position: 0x595A / 22874
{
	if (!iLocal_204)
	{
...
void Function_132(vector3 vParam0) //Position: 0x5973 / 22899
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_133(bool bParam0, bool bParam1) //Position: 0x5AF9 / 23289
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_134(bool bParam0, float fParam1) //Position: 0x5BEA / 23530
{
...
void Function_135() //Position: 0x5CE8 / 23784
{
...
void Function_136() //Position: 0x5D1A / 23834
{
...
int Function_137() //Position: 0x5E17 / 24087
{
	return 1;
}

int Function_138() //Position: 0x5E1E / 24094
{
	bLocal_205 = CREATE_VOLUME_IN_LAYOUT(bLocal_203, "tempcutscenevol", 2, *(&Global_63541[7355] + 100), 0.0f, 0.0f, 0.0f, 4.0f, 5.0f, 5.0f);
	Function_141(0, 1, 0, 1, 0, 1, 1, bLocal_205, 1, 1, 1, 1);
	Function_139(StackVal, StackVal, bLocal_203, *(&Global_63541[7355] + 112), &bLocal_205, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_139(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x5E78 / 24184
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_140(bool bParam0, bool bParam1) //Position: 0x60E6 / 24806
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_141(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x615B / 24923
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_144(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_23(), 2, Function_144(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_142(int iParam0) //Position: 0x6404 / 25604
{
	int iVar0;
...
var Function_143() //Position: 0x6438 / 25656
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_144(bool bParam0) //Position: 0x64B7 / 25783
{
	vector3 vVar0;
...
int Function_145(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x64C8 / 25800
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_147(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_146(iParam0));
							}
						}
						...
						uVar6 = Function_147(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_146(float fParam0) //Position: 0x6629 / 26153
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_146(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_147(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x665E / 26206
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_150(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_151()) * (fParam7 - fParam6)) * 0,5f))) || bParam12)
	{
	...
	else if ((!Function_150(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_151()) * (fParam7 - fParam6)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_150(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_148() //Position: 0x68A4 / 26788
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &vVar1, &Var4))
		{
			...
			Function_149(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_149(char* cParam0, vector3 vParam1) //Position: 0x68F8 / 26872
{
	char* cVar0[64];
...
bool Function_150(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x6A20 / 27168
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_59(bParam0);
...
int Function_151() //Position: 0x6AAA / 27306
{
	if (IS_PS3())
	{
		return 1;
...
void Function_152() //Position: 0x6AB9 / 27321
{
	var uVar0;
...
void Function_153(int iParam0, int iParam1) //Position: 0x6ADE / 27358
{
	switch (iParam1)
	{
		case 0x00000000:
