	...
	while (IS_GRINGO_ACTIVE())
	{
		switch (iLocal_15)
		{
			...
			case 0x00000003:
				...
				if ((!IS_AREA_OBSTRUCTED2(vLocal_3, 0,7f, GET_PHYSINST_FROM_ACTOR(Global_34573), false, Global_30842[17]) && !IS_ACTOR_RIDING(Global_34573)) && !IS_PLAYER_IN_COMBAT(0))
				{
			...
			case 0x00000007:
				if (!iLocal_2)
				{
					if (Function_5(&iLocal_12) < 2.0f)
					{
						...
						bLocal_1 = iLocal_2 != true;
					}
				}
				if (Function_9(&iLocal_12, 10.0f))
				{
					iLocal_2 = 0;
					iLocal_15 = 0;
				}
...
void Function_1(int iParam0) //Position: 0x3F5 / 1013
{
	int iVar0;
...
void Function_2(var uParam0, int iParam1) //Position: 0x41B / 1051
{
...
void Function_3(var uParam0, int iParam1) //Position: 0x549 / 1353
{
	int iVar0;
...
bool Function_4(var uParam0, int iParam1) //Position: 0x563 / 1379
{
	int iVar0;
...
float Function_5(int iParam0) //Position: 0x580 / 1408
{
...
bool Function_6(int iParam0) //Position: 0x648 / 1608
{
	return Function_7(*iParam0, 2);
}

int Function_7(var uParam0, int iParam1) //Position: 0x655 / 1621
{
...
bool Function_9(int iParam0, int iParam1) //Position: 0x66F / 1647
{
...
void Function_10(int iParam0) //Position: 0x687 / 1671
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_11(var uParam0, float fParam1) //Position: 0x69B / 1691
{
...
void Function_12(int iParam0) //Position: 0x6B7 / 1719
{
	Function_13(iParam0, 0.0f);
	return;
}

void Function_13(var uParam0, float fParam1) //Position: 0x6C3 / 1731
{
...
void Function_14(var uParam0, int iParam1) //Position: 0x6E4 / 1764
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_15(var uParam0, bool bParam1) //Position: 0x6F7 / 1783
{
	*uParam0 = (*uParam0 || bParam1);
	return;
}

var Function_16(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x706 / 1798
{
	bool bVar0;
...
void Function_17(var uParam0, int iParam1) //Position: 0x78F / 1935
{
	bool bVar0;
...
void Function_18(var uParam0, bool bParam1) //Position: 0x7BA / 1978
{
...
void Function_19(bool bParam0, bool bParam1) //Position: 0x846 / 2118
{
	bool bVar0;
	bool bVar1;
...
float Function_20(bool bParam0, bool bParam1) //Position: 0x8A3 / 2211
{
	vector3 vVar0;
...
var Function_21() //Position: 0x8C2 / 2242
{
	int iVar0;
...
struct<32> Function_22(bool bParam0) //Position: 0x8CA / 2250
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_23(char* cParam0, char* cParam1, char* cParam2) //Position: 0x934 / 2356
{
	char* cVar0[32];
...
bool Function_24(int iParam0) //Position: 0x953 / 2387
{
	int iVar0;
	int iVar1;
...
void Function_25() //Position: 0xCCE / 3278
{
	if (!Function_26(128))
	{
		return;
...
bool Function_26(int iParam0) //Position: 0xD0E / 3342
{
	int iVar0;
...
bool Function_27() //Position: 0xD2A / 3370
{
	int iVar0;
...
void Function_28(var uParam0, int iParam1) //Position: 0xD55 / 3413
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_29() //Position: 0xD66 / 3430
{
	if (!Function_26(128))
	{
		return;
...
var Function_30(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xDA8 / 3496
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_31(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_31(var uParam0, int iParam1, int iParam2) //Position: 0xDE0 / 3552
{
	int iVar0;
