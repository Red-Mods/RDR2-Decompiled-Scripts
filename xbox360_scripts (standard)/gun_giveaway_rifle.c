...
void Function_62(bool bParam0) //Position: 0x2542 / 9538
{
	...
	{
		iLocal_1 = 1;
		iLocal_2 = CREATE_LAYOUT("gunGiveRifle_Layout");
		...
		*(&Var0 + 12) = { StackVal, StackVal, Function_67(uVar7) };
		...
		Var0.f_24 = 0;
		Function_63(iLocal_2, 0, &Var0, 1, 0, 0);
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25AE / 9646
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2628 / 9768
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2653 / 9811
{
	vector3 vVar0;
...
vector3 Function_66(bool bParam0) //Position: 0x270B / 9995
{
	vector3 vVar0;
...
vector3 Function_67(bool bParam0) //Position: 0x2732 / 10034
{
	vector3 vVar0;
...
var Function_68(bool bParam0, bool bParam1) //Position: 0x2759 / 10073
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_69(int iParam0) //Position: 0x2766 / 10086
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x2770 / 10096
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x278E / 10126
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x27A3 / 10147
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x282A / 10282
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x284D / 10317
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x286B / 10347
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x288E / 10382
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x29A9 / 10665
{
...
int Function_78(bool bParam0) //Position: 0x29D4 / 10708
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2AD9 / 10969
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2AE6 / 10982
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2B59 / 11097
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x3057 / 12375
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x308E / 12430
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x30AB / 12459
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x30E3 / 12515
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x30ED / 12525
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(bool bParam0, bool bParam1) //Position: 0x310E / 12558
{
	bool bVar0;
	...
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
	{
		...
		else if (STRING_CONTAINS_STRING(bVar0, "rollingblock"))
		{
			...
			GIVE_WEAPON_TO_ACTOR(bParam0, 19, false, 1, 1);
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x31A7 / 12711
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x32AF / 12975
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x32C5 / 12997
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x357B / 13691
{
	bParam1 = bParam1;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
	{
...
bool Function_92(bool bParam0) //Position: 0x35A5 / 13733
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x35BE / 13758
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x35D8 / 13784
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3610 / 13840
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x3627 / 13863
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x38F0 / 14576
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x390D / 14605
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x39A9 / 14761
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x39C8 / 14792
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x39D7 / 14807
{
...
void Function_102(int iParam0) //Position: 0x39F3 / 14835
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x39FD / 14845
{
	bool bVar0;
	bool bVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x3A5F / 14943
{
...
void Function_105(int iParam0) //Position: 0x3A73 / 14963
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3A7D / 14973
{
