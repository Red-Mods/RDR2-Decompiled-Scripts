...
void main() //Position: 0x0 / 0
{
	...
	{
		bVar0 = Function_18("ped_fivefinger", 0);
		Function_16(&bVar0, 86, 1.0f, 0, 0);
		Function_16(&bVar0, 25, 1.0f, 0, 0);
		Function_16(&bVar0, 469, 1.0f, 0, 0);
		Function_16(&bVar0, 404, 1.0f, 0, 0);
		Function_16(&bVar0, 422, 1.0f, 0, 0);
		Function_16(&bVar0, 137, 1.0f, 0, 0);
		Function_16(&bVar0, 162, 1.0f, 0, 0);
	}
	...
	bVar1 = Function_18("People", 0);
	Function_12(&bVar1, 207, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 263, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 325, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 208, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 262, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 205, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 79, 4.0f, 14, 0, 0);
	Function_12(&bVar1, 48, 4.0f, 14, 0, 0);
	...
	bVar5 = Function_18("hawks", 0);
	Function_12(&bVar5, 1146, 8.0f, 15, 0, 0);
	...
	bVar9 = Function_18("raccoon", 0);
	Function_12(&bVar9, 1082, 4.0f, 48, 0, 0);
	bVar10 = Function_18("dog", 0);
	Function_16(&bVar10, 1034, 4.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar13))
	{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_6(bVar14, bVar5, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (!Function_15() && Global_25974[8])
		{
			...
			if (IS_VOLUME_VALID(bVar14))
			{
				bVar15 = Function_7(bVar14, bVar0, 5, 1, 0, 0);
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_7(bVar14, bVar10, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_7(bVar14, bVar9, 3, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_3(bVar14, bVar1, 2, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_3(bVar14, bVar1, 2, 4, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("mtp_pop: Cannot find mtpv_customers1_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_6(bVar14, bVar12, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1355 / 4949
{
	bool bVar0;
...
var Function_6(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x148A / 5258
{
	bool bVar0;
...
var Function_7(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x150A / 5386
{
	bool bVar0;
...
var Function_13(int iParam0) //Position: 0x1672 / 5746
{
	bool bVar0;
...
var Function_14(bool bParam0) //Position: 0x16DE / 5854
{
	bool bVar0;
...
bool Function_15() //Position: 0x174A / 5962
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1753 / 5971
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x17C8 / 6088
{
	int iVar0;
	int iVar1;
...
var Function_18(bool bParam0, int iParam1) //Position: 0x180D / 6157
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_19(int iParam0) //Position: 0x181A / 6170
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_20(bool bParam0, var uParam1) //Position: 0x1826 / 6182
{
	if (!Function_8(128))
	{
		return;
