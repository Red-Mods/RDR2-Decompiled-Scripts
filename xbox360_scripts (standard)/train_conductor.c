...
{
	iParam1 = iParam1;
	if (!IS_ATTACHMENT_VALID(bLocal_0))
	{
		bLocal_0 = ATTACH_OBJECTS_CONTINUOUS(bParam0, GRINGO_GET_MY_OBJECT_REF(), 4294967295);
	}
	return;
}
...
void Function_62(bool bParam0) //Position: 0x2555 / 9557
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2814 / 10260
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2871 / 10353
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28CE / 10446
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28D8 / 10456
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28F6 / 10486
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x290B / 10507
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2992 / 10642
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29B5 / 10677
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29D3 / 10707
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29F6 / 10742
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B11 / 11025
{
...
int Function_74(bool bParam0) //Position: 0x2B3C / 11068
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C41 / 11329
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C4E / 11342
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CC1 / 11457
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31BF / 12735
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x31F6 / 12790
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3213 / 12819
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x324B / 12875
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3255 / 12885
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3276 / 12918
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	if (IS_ATTACHMENT_VALID(bLocal_0))
	{
		REMOVE_OBJECT_ATTACHMENT(bLocal_0);
	}
	return;
}

void Function_84(bool bParam0, bool bParam1) //Position: 0x3291 / 12945
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3399 / 13209
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x33AF / 13231
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3665 / 13925
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x3673 / 13939
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x368C / 13964
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x36A6 / 13990
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36DE / 14046
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36F5 / 14069
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39BE / 14782
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39DB / 14811
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A77 / 14967
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A96 / 14998
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AA5 / 15013
{
...
void Function_98(int iParam0) //Position: 0x3AC1 / 15041
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3ACB / 15051
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B2D / 15149
{
...
void Function_101(int iParam0) //Position: 0x3B41 / 15169
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B4B / 15179
{
