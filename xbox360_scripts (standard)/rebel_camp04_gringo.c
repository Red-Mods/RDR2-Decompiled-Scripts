...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA1F / 2591
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x29A1 / 10657
{
...
void Function_51(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x2CAF / 11439
{
	bool bVar0;
	bool bVar1;
...
void Function_72() //Position: 0x366C / 13932
{
	...
	SNAP_ACTOR_TO_GRINGO(bLocal_29, bVar0, "UseCase1", true, 0, 0);
...
void Function_79() //Position: 0x3BFC / 15356
{
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &vVar1, &Var4))
		{
			...
			Function_80(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		bVar0++;
	}
	return;
...
bool Function_81(bool bParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3D78 / 15736
{
	...
	if (!IS_OBJECTSET_VALID(*uParam1))
	{
		*uParam1 = CREATE_OBJECTSET_IN_LAYOUT(Function_141(), bParam0, 4294967295, 1);
		...
		{
			if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &vVar1, &vVar4))
			{
				cVar23 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
	...
	if (Function_108(iParam2))
	{
		...
		while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
		{
			if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &vVar1, &vVar4))
			{
				bVar24 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
...
var Function_82(bool bParam0) //Position: 0x3E9D / 16029
{
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
	{
		...
		if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &vVar1, &vVar4))
		{
			bVar7 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
...
int Function_83() //Position: 0x3EF4 / 16116
{
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &uVar1, &uVar4))
		{
			bVar7 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
		}
		bVar0++;
...
int Function_84(var uParam0, bool bParam1, int iParam2) //Position: 0x3F22 / 16162
{
...
void Function_89(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4662 / 18018
{
	bool bVar0;
...
bool Function_90(bool bParam0, bool bParam1) //Position: 0x46B6 / 18102
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0, bool bParam1) //Position: 0x4866 / 18534
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_104(int iParam0) //Position: 0x4BE9 / 19433
{
	bool bVar0;
	bool bVar1;
...
var Function_105(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4CE3 / 19683
{
	int iVar0;
	bool bVar1;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4D1B / 19739
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_107(var uParam0, bool bParam1, int iParam2) //Position: 0x4D2C / 19756
{
	int iVar0;
...
bool Function_108(int iParam0) //Position: 0x4DF0 / 19952
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x516B / 20843
{
	if (!Function_156(128))
	{
		return;
...
bool Function_110() //Position: 0x51AB / 20907
{
	int iVar0;
...
void Function_111() //Position: 0x51D6 / 20950
{
	if (!Function_156(128))
	{
		return;
...
void Function_112(int iParam0, bool bParam1) //Position: 0x5218 / 21016
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x529C / 21148
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x52C5 / 21189
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x5316 / 21270
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x5326 / 21286
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x533A / 21306
{
	int iVar0;
...
var Function_118() //Position: 0x535F / 21343
{
	return "PackedMetadata";
}

void Function_119(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5376 / 21366
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_120() //Position: 0x549C / 21660
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_121() //Position: 0x54AD / 21677
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_122() //Position: 0x54BE / 21694
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_123(var uParam0, int iParam1) //Position: 0x54CF / 21711
{
...
var Function_124(var uParam0, int iParam1, bool bParam2) //Position: 0x54F2 / 21746
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x5511 / 21777
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_126() //Position: 0x551D / 21789
{
	return Function_127(39);
}

int Function_127(bool bParam0) //Position: 0x5528 / 21800
{
	bool bVar0;
...
var Function_128() //Position: 0x5556 / 21846
{
	return "PackedWeapon";
}

int Function_129(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x556B / 21867
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_130() //Position: 0x566F / 22127
{
	return "MPItemGiver";
}

struct<32> Function_131(bool bParam0) //Position: 0x5683 / 22147
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0, char* cParam1, char* cParam2) //Position: 0x56ED / 22253
{
	char* cVar0[32];
...
var Function_133() //Position: 0x570C / 22284
{
	return "PBox_";
}

var Function_134() //Position: 0x571A / 22298
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x5740 / 22336
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5768 / 22376
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(var uParam0, int iParam1) //Position: 0x578E / 22414
{
	int iVar0;
	var uVar1;
...
void Function_138(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x58EF / 22767
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x598A / 22922
{
	int iVar0;
	vector3 vVar1;
...
void Function_140(int iParam0) //Position: 0x5AEB / 23275
{
...
var Function_141() //Position: 0x5B4C / 23372
{
	int iVar0;
...
var Function_142(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5B54 / 23380
{
	return Function_143(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5B6D / 23405
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x5E60 / 24160
{
	int iVar0;
...
void Function_145() //Position: 0x5F14 / 24340
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x5F4E / 24398
{
	int iVar0;
...
void Function_147(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5F7B / 24443
{
	bool bVar0;
...
void Function_148() //Position: 0x60CC / 24780
{
	int iVar0;
...
var Function_149(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6117 / 24855
{
	int iVar0;
...
int Function_150() //Position: 0x61E7 / 25063
{
	int iVar0;
...
int Function_151() //Position: 0x6343 / 25411
{
	int iVar0;
...
bool Function_152(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x6463 / 25699
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_153(var uParam0, int iParam1) //Position: 0x6533 / 25907
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_154(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6551 / 25937
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_155(bool bParam0) //Position: 0x6683 / 26243
{
	bool bVar0;
...
bool Function_156(int iParam0) //Position: 0x66A2 / 26274
{
	int iVar0;
...
int Function_157() //Position: 0x66BE / 26302
{
	if (Function_159())
	{
...
int Function_158() //Position: 0x66D7 / 26327
{
	return Global_79349.f_16;
}

bool Function_159() //Position: 0x66E3 / 26339
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_160(int iParam0, bool bParam1, bool bParam2) //Position: 0x66EC / 26348
{
	var uVar0;
