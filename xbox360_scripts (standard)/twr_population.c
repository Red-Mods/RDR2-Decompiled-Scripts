...
var Function_8(int iParam0) //Position: 0xCEC / 3308
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xD58 / 3416
{
	bool bVar0;
...
var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xDC4 / 3524
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xE39 / 3641
{
	int iVar0;
	int iVar1;
...
var Function_12(bool bParam0, int iParam1) //Position: 0xE7E / 3710
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_13(int iParam0) //Position: 0xE8B / 3723
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_14(bool bParam0, var uParam1) //Position: 0xE97 / 3735
{
	if (!Function_3(128))
	{
		return;
