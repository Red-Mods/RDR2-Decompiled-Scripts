		...
		if (IS_ACTOR_VALID(bLocal_21))
		{
			if (!IS_ACTOR_ALIVE(bLocal_21) && !iLocal_24 != 9)
			{
				if (!iLocal_49)
				{
					...
					Function_35("TWR_Obj_DaughterRed", 0x40f00000, 1, 2, 0, 0, 0);
					iLocal_49 = 1;
				}
				if (Function_34(bLocal_21, Global_34573))
				{
					Function_33();
					Function_18(Function_28(0, Global_30640[2], 3));
			...
			switch (iLocal_24)
			{
				...
				case 0x00000001:
					if (Function_8(&bLocal_25))
					{
						...
						SET_ACTOR_ALLOW_WEAPON_REACTIONS(bLocal_21, false);
						...
						if (IS_ACTOR_VALID(bLocal_21))
						{
							if (IS_ACTOR_ALIVE(bLocal_21))
							{
								if (DECOR_CHECK_EXIST(Global_34573, "TaskGirlNow"))
								{
									...
									{
										TASK_PRIORITY_SET(bLocal_21, true);
										SNAP_ACTOR_TO_GRINGO(bLocal_21, GET_OBJECT_FROM_GRINGO(bLocal_22), "GirlUse", true, 0, 0);
...
void Function_1() //Position: 0x450 / 1104
{
...
void Function_2(int iParam0) //Position: 0x488 / 1160
{
	int iVar0;
...
void Function_3(var uParam0, int iParam1) //Position: 0x4AE / 1198
{
...
void Function_4(var uParam0, int iParam1) //Position: 0x5DC / 1500
{
	int iVar0;
...
bool Function_5(var uParam0, int iParam1) //Position: 0x5F6 / 1526
{
	int iVar0;
...
vector3 Function_6(bool bParam0) //Position: 0x613 / 1555
{
	vector3 vVar0;
...
vector3 Function_7(bool bParam0) //Position: 0x63A / 1594
{
	vector3 vVar0;
...
bool Function_8(int iParam0) //Position: 0x661 / 1633
{
	int iVar0;
	int iVar1;
...
void Function_9() //Position: 0x9DC / 2524
{
	if (!Function_10(128))
	{
		return;
...
bool Function_10(int iParam0) //Position: 0xA1C / 2588
{
	int iVar0;
...
bool Function_11() //Position: 0xA38 / 2616
{
	int iVar0;
...
void Function_12(var uParam0, int iParam1) //Position: 0xA63 / 2659
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_13() //Position: 0xA74 / 2676
{
	if (!Function_10(128))
	{
		return;
...
var Function_14(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xAB6 / 2742
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_15(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_15(var uParam0, int iParam1, int iParam2) //Position: 0xAEE / 2798
{
	int iVar0;
...
var Function_16(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0xBB2 / 2994
{
	int iVar0;
...
int Function_17(char* cParam0, var uParam1, var uParam2, var uParam3, char* cParam4, var uParam5) //Position: 0xC82 / 3202
{
	int iVar0;
...
void Function_18(int iParam0) //Position: 0xD01 / 3329
{
	int iVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	if (StackVal == 2)
	{
		Function_21("nDEED_FAIL", iParam0);
	}
...
struct<16> Function_19(int iParam0) //Position: 0xDA7 / 3495
{
	char* cVar0[16];
...
struct<24> Function_20(char* cParam0) //Position: 0xDD1 / 3537
{
	char* cVar0[24];
...
void Function_21(char* cParam0, bool bParam1) //Position: 0x1027 / 4135
{
	struct<4> Var0;
...
struct<16> Function_22(int iParam0) //Position: 0x114B / 4427
{
	char* cVar0[16];
...
var Function_23(int iParam0) //Position: 0x1170 / 4464
{
...
bool Function_24(int iParam0) //Position: 0x1190 / 4496
{
...
int Function_25(bool bParam0) //Position: 0x11A7 / 4519
{
...
bool Function_26(int iParam0) //Position: 0x11C2 / 4546
{
	if (!Function_24(iParam0))
	{
		return 0;
...
bool Function_27(int iParam0) //Position: 0x11E6 / 4582
{
...
int Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x11FB / 4603
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	iVar1 = Function_32(bParam0, bParam1, bParam2);
	iVar0 = 0;
	while (iVar0 <= 275)
	{
		...
		{
			return Function_29(bParam0, bParam1, bParam2, iVar0);
		}
		iVar0++;
	}
	return Function_29(bParam0, bParam1, bParam2, 4294967295);
}

int Function_29(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1259 / 4697
{
	var uVar0;
	...
	uVar0 = Function_32(bParam0, bParam1, bParam2);
	if (bParam3 != 4294967295 || bParam3 <= 275)
	{
		bParam3 = Function_30(uVar0);
	}
...
int Function_30(int iParam0) //Position: 0x13AE / 5038
{
	int iVar0;
...
bool Function_31(int iParam0) //Position: 0x13EC / 5100
{
...
var Function_32(int iParam0, int iParam1, bool bParam2) //Position: 0x1401 / 5121
{
	return (((bParam2 && 15) || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_33() //Position: 0x1421 / 5153
{
	int iVar0;
...
bool Function_34(bool bParam0, bool bParam1) //Position: 0x148A / 5258
{
...
void Function_35(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x14BB / 5307
{
	int iVar0;
