...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			...
			Function_127(&bLocal_188, "$/fragments/p_gen_femur02x", 0, 0);
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000000:
						if (!Function_124(&(Global_63541[ScriptParam_055]), 16, 0, 1))
						{
							Function_123(&Global_63541[ScriptParam_055] + 144, 64);
							Function_121(&(Global_63541[ScriptParam_055]), 16, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_116(&bLocal_188) && IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								bLocal_199 = CREATE_GRINGO_IN_LAYOUT(bLocal_198, "SearchClues1", "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", *(&Global_63541[ScriptParam_055] + 100), 0.0f, 0.0f, 0.0f);
								CREATE_DECAL(2, -1709,4f, 55,217f, 2104,56f, 1.0f, 1, 1);
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(bLocal_198, "RCM_Cannibal2_Bone")))
								{
									CREATE_PROP_IN_LAYOUT(bLocal_198, "RCM_Cannibal2_Bone", "$/fragments/p_gen_femur02x", -1708,451f, 55,217f, 2104,037f, 0.0f, 50.0f, 0.0f, 1);
								}
								if (IS_OBJECT_VALID(bLocal_199))
								{
									iVar0 = 5;
								}
							}
							...
							{
								Function_114();
								bLocal_198 = bLocal_203;
							}
							else
							{
								bLocal_198 = FIND_NAMED_LAYOUT("CannibalFamily_layout");
							}
						}
						break;
					
					case 0x00000005:
						if (GET_CURRENT_GRINGO(Global_34573) == GET_GRINGO_FROM_OBJECT(bLocal_199))
						{
							bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_198, Function_113(), 2, *(&Global_63541[1655] + 100), 0.0f, 0.0f, 0.0f, 10.0f, 10.0f, 10.0f);
							Function_108(-1700,569f, 56,271f, 2106,419f, bVar1);
					...
					case 0x00000006:
						if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(Global_34573)))
						{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "Cannibal2_OBJ", 0, 4, false);
	...
	if (IS_OBJECT_VALID(bLocal_199))
	{
		RELEASE_OBJECT_REF(bLocal_199);
	}
	if (IS_LAYOUTREF_VALID(bLocal_198))
	{
		RELEASE_LAYOUT_OBJECTS(bLocal_198);
	}
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x45E / 1118
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x479 / 1145
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x496 / 1174
{
	RELEASE_LAYOUT_REF(bLocal_203);
	return;
}

void Function_4(int iParam0) //Position: 0x4A1 / 1185
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x4C7 / 1223
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x5F5 / 1525
{
	int iVar0;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x60F / 1551
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x62C / 1580
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_9() //Position: 0x63B / 1595
{
	bool bVar0;
	bool bVar1;
...
void Function_10(bool bParam0) //Position: 0x66C / 1644
{
	bool bVar0;
...
void Function_11() //Position: 0x6A6 / 1702
{
...
void Function_12(bool bParam0) //Position: 0x6C9 / 1737
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_13(int iParam0, int iParam1) //Position: 0x86B / 2155
{
	int iVar0;
	bool bVar1;
...
void Function_14(int iParam0) //Position: 0x925 / 2341
{
	float fVar0;
	bool bVar1;
...
int Function_15(var uParam0, int iParam1) //Position: 0x9C7 / 2503
{
	int iVar0;
	var uVar1;
...
void Function_16(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xB28 / 2856
{
	struct<8> Var0;
...
struct<32> Function_17(bool bParam0) //Position: 0xBC3 / 3011
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_18(char* cParam0, char* cParam1, char* cParam2) //Position: 0xC2D / 3117
{
	char* cVar0[32];
...
int Function_19(bool bParam0) //Position: 0xC4C / 3148
{
	int iVar0;
	vector3 vVar1;
...
float Function_20(bool bParam0, vector3 vParam1) //Position: 0xDAD / 3501
{
	vector3 vVar0;
...
vector3 Function_21(bool bParam0) //Position: 0xE27 / 3623
{
	vector3 vVar0;
...
void Function_22(int iParam0) //Position: 0xE91 / 3729
{
...
bool Function_23(int iParam0) //Position: 0xEF2 / 3826
{
...
void Function_24(int iParam0, int iParam1) //Position: 0xF08 / 3848
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_25(bool bParam0) //Position: 0x104D / 4173
{
...
var Function_26(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x1079 / 4217
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_27(int iParam0) //Position: 0x1095 / 4245
{
...
bool Function_28(int iParam0, int iParam1) //Position: 0x10AA / 4266
{
...
bool Function_29(int iParam0, int iParam1) //Position: 0x11BF / 4543
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x1303 / 4867
{
...
bool Function_31(int iParam0) //Position: 0x1327 / 4903
{
...
bool Function_32(int iParam0) //Position: 0x133C / 4924
{
...
var Function_33(int iParam0) //Position: 0x1353 / 4947
{
...
bool Function_34(int iParam0) //Position: 0x136D / 4973
{
...
bool Function_35(int iParam0) //Position: 0x1383 / 4995
{
	return StackVal;
}

bool Function_36(var uParam0, int iParam1) //Position: 0x1393 / 5011
{
	int iVar0;
...
bool Function_37(int iParam0) //Position: 0x13AF / 5039
{
	if (!iParam0->f_152)
	{
...
bool Function_38(int iParam0) //Position: 0x13F6 / 5110
{
...
void Function_39(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x144F / 5199
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0, int iParam1) //Position: 0x14BB / 5307
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(bool bParam0, var uParam1, int iParam2) //Position: 0x14F2 / 5362
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x156A / 5482
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x160B / 5643
{
	int iVar0;
	int iVar1;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x1648 / 5704
{
...
bool Function_45(int iParam0) //Position: 0x165B / 5723
{
	int iVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x1677 / 5751
{
	int iVar0;
...
int Function_47(int iParam0) //Position: 0x1693 / 5779
{
...
bool Function_48(int iParam0) //Position: 0x16A8 / 5800
{
...
int Function_49(int iParam0) //Position: 0x16BD / 5821
{
...
bool Function_50(var uParam0, bool bParam1) //Position: 0x16D2 / 5842
{
	return (uParam0 && bParam1) == 0;
}

void Function_51() //Position: 0x16DF / 5855
{
...
var Function_52(int iParam0, int iParam1) //Position: 0x175A / 5978
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_53(vector3 vParam0) //Position: 0x234B / 9035
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_54(int iParam0, bool bParam1) //Position: 0x2363 / 9059
{
	int iVar0;
...
int Function_55(int iParam0) //Position: 0x23A0 / 9120
{
	int iVar0;
	int iVar1;
...
bool Function_56(int iParam0) //Position: 0x23EF / 9199
{
...
int Function_57(int iParam0) //Position: 0x2405 / 9221
{
...
bool Function_58(int iParam0) //Position: 0x246E / 9326
{
	if (!Function_56(iParam0))
	{
...
bool Function_59(int iParam0, int iParam1) //Position: 0x24BF / 9407
{
	int iVar0;
...
bool Function_60(int iParam0) //Position: 0x24EC / 9452
{
	if (!Function_56(iParam0))
	{
...
bool Function_61() //Position: 0x253E / 9534
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_62(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2547 / 9543
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2A7C / 10876
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_64() //Position: 0x2BEF / 11247
{
	return;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2BF5 / 11253
{
	if (Global_3381)
	{
		return;
...
void Function_66(bool bParam0) //Position: 0x2C37 / 11319
{
...
void Function_67() //Position: 0x2C88 / 11400
{
	Function_94();
	Function_93();
	Function_93();
...
void Function_68() //Position: 0x2CBB / 11451
{
...
void Function_69() //Position: 0x2DC1 / 11713
{
	float fVar0;
...
void Function_70() //Position: 0x2DF4 / 11764
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x2F82 / 12162
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x3136 / 12598
{
	Function_73(&Global_28260, 1, 0);
	return;
}

void Function_73(int iParam0, bool bParam1, var uParam2) //Position: 0x3144 / 12612
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_74() //Position: 0x3335 / 13109
{
...
struct<8> Function_75() //Position: 0x334A / 13130
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_76(int iParam0, bool bParam1, bool bParam2) //Position: 0x33E5 / 13285
{
	int iVar0;
...
void Function_77(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x3680 / 13952
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_78(int iParam0) //Position: 0x3CAD / 15533
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_79(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3CBE / 15550
{
	char* cVar0[32];
...
struct<32> Function_80(char* cParam0, char* cParam1) //Position: 0x3DB3 / 15795
{
	char* cVar0[32];
...
void Function_81(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3DCC / 15820
{
	float fVar0;
...
var Function_82(int iParam0, int iParam1) //Position: 0x3E31 / 15921
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_83(int iParam0, bool bParam1) //Position: 0x3E43 / 15939
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_84(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3E55 / 15957
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_85(int iParam0) //Position: 0x3F85 / 16261
{
	return Global_35278[iParam020].f_48;
}

float Function_86(int iParam0) //Position: 0x3F94 / 16276
{
	if (!iParam0 != 4294967295)
	{
...
var Function_87(int iParam0) //Position: 0x3FCD / 16333
{
	if (iParam0 == 4294967295)
	{
...
void Function_88(int iParam0) //Position: 0x400A / 16394
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x41A4 / 16804
{
	int iVar0;
	int iVar1;
...
int Function_90(bool bParam0) //Position: 0x43BE / 17342
{
...
struct<8> Function_91() //Position: 0x43FF / 17407
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_92() //Position: 0x4488 / 17544
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x451F / 17695
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_94() //Position: 0x459E / 17822
{
...
int Function_95(int iParam0, bool bParam1, int iParam2) //Position: 0x45C4 / 17860
{
	int iVar0;
	int iVar1;
...
void Function_96() //Position: 0x47CE / 18382
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_97(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x486F / 18543
{
	int iVar0;
...
vector3 Function_98() //Position: 0x4956 / 18774
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_99(int iParam0) //Position: 0x495F / 18783
{
...
int Function_100(bool bParam0, bool bParam1) //Position: 0x4975 / 18805
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_101(vector3 vParam0, vector3 vParam3) //Position: 0x4A3C / 19004
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4A59 / 19033
{
	uParam0 = uParam0;
...
void Function_103() //Position: 0x4AFD / 19197
{
	bool bVar0;
...
void Function_104(bool bParam0) //Position: 0x4B5B / 19291
{
	PRINTSTRING("Day ");
...
void Function_105(bool bParam0, bool bParam1) //Position: 0x4BA1 / 19361
{
	bool bVar0;
...
void Function_106(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4BC6 / 19398
{
	int iVar0;
...
void Function_107(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x4C11 / 19473
{
	int iVar0;
...
void Function_108(vector3 vParam0) //Position: 0x4C64 / 19556
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_109(bool bParam0, bool bParam1) //Position: 0x4DEA / 19946
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_110(bool bParam0, float fParam1) //Position: 0x4EDB / 20187
{
...
void Function_111() //Position: 0x4FD9 / 20441
{
...
void Function_112() //Position: 0x500B / 20491
{
...
var Function_113() //Position: 0x5108 / 20744
{
	bool bVar0;
...
void Function_114() //Position: 0x5110 / 20752
{
	var uVar0;
	
	Function_115(4, 1);
	uVar0 = uVar0;
	bLocal_203 = CREATE_LAYOUT("CannibalFamily_layout");
	return;
}

void Function_115(int iParam0, int iParam1) //Position: 0x513C / 20796
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_116(int iParam0) //Position: 0x5185 / 20869
{
	int iVar0;
	int iVar1;
...
void Function_117() //Position: 0x5500 / 21760
{
	if (!Function_45(128))
	{
		return;
...
bool Function_118() //Position: 0x5540 / 21824
{
	int iVar0;
...
void Function_119(var uParam0, int iParam1) //Position: 0x556B / 21867
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_120() //Position: 0x557C / 21884
{
	if (!Function_45(128))
	{
		return;
...
void Function_121(int iParam0, int iParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x55BE / 21950
{
...
void Function_122(int iParam0) //Position: 0x5768 / 22376
{
...
void Function_123(int iParam0, int iParam1) //Position: 0x57EA / 22506
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_124(int iParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x57FD / 22525
{
	if (!iParam0->f_172 != 0)
	{
		if (Function_36(iParam0 + 172, 4))
...
int Function_125(int iParam0) //Position: 0x58B1 / 22705
{
	if (!iParam0->f_172 != 0)
	{
		switch (Global_63399)
...
bool Function_126(int iParam0, bool bParam1) //Position: 0x595D / 22877
{
...
var Function_127(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5993 / 22931
{
	int iVar0;
	bool bVar1;
...
var Function_128(var uParam0, int iParam1, int iParam2) //Position: 0x59CB / 22987
{
	int iVar0;
