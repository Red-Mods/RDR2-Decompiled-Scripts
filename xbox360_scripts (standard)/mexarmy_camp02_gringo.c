...
void Function_72() //Position: 0x3651 / 13905
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_13, vVar0, 157,073f, 1, true, 1);
	...
	if (IS_PHYSINST_VALID(bVar3))
	{
		...
		if (IS_OBJECT_VALID(bVar4))
		{
			...
			SNAP_ACTOR_TO_GRINGO(bLocal_13, bVar5, "UseCase1", true, 0, 0);
	...
	GIVE_WEAPON_TO_ACTOR(bVar6, 13, false, 1, 1);
	...
	if (IS_PHYSINST_VALID(bVar3))
	{
		...
		if (IS_OBJECT_VALID(bVar11))
		{
			...
			SNAP_ACTOR_TO_GRINGO(bVar6, bVar12, "UseCase1", true, 0, 0);
	...
	OPEN_DOOR_DIRECTION_FAST(bLocal_17, false);
	if (IS_DOOR_LOCKED(bLocal_18))
	{
		Function_73(bLocal_18, 1);
	}
	OPEN_DOOR_DIRECTION_FAST(bLocal_18, true);
	return;
}
...
bool Function_76(var uParam0, bool bParam1, int iParam2) //Position: 0x3AE3 / 15075
{
...
void Function_83(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x42D6 / 17110
{
	bool bVar0;
...
bool Function_84(bool bParam0, bool bParam1) //Position: 0x432A / 17194
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_89(int iParam0, bool bParam1) //Position: 0x44DA / 17626
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(int iParam0) //Position: 0x4847 / 18503
{
	bool bVar0;
	bool bVar1;
...
var Function_98(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4941 / 18753
{
	int iVar0;
	bool bVar1;
...
void Function_99(var uParam0, int iParam1) //Position: 0x4979 / 18809
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_100(var uParam0, bool bParam1, int iParam2) //Position: 0x498A / 18826
{
	int iVar0;
...
bool Function_101(int iParam0) //Position: 0x4A4E / 19022
{
	int iVar0;
	int iVar1;
...
void Function_102() //Position: 0x4DC9 / 19913
{
	if (!Function_149(128))
	{
		return;
...
bool Function_103() //Position: 0x4E09 / 19977
{
	int iVar0;
...
void Function_104() //Position: 0x4E34 / 20020
{
	if (!Function_149(128))
	{
		return;
...
void Function_105(int iParam0, bool bParam1) //Position: 0x4E76 / 20086
{
	char* cVar0[32];
...
void Function_106(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4EFA / 20218
{
	var uVar0;
	var uVar1;
...
void Function_107(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4F23 / 20259
{
...
var Function_108(var uParam0, bool bParam1) //Position: 0x4F74 / 20340
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_109() //Position: 0x4F84 / 20356
{
	return "PackedGrass";
}

var Function_110(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4F98 / 20376
{
	int iVar0;
...
var Function_111() //Position: 0x4FBD / 20413
{
	return "PackedMetadata";
}

void Function_112(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4FD4 / 20436
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_113() //Position: 0x50FA / 20730
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_114() //Position: 0x510B / 20747
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_115() //Position: 0x511C / 20764
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_116(var uParam0, int iParam1) //Position: 0x512D / 20781
{
...
var Function_117(var uParam0, int iParam1, bool bParam2) //Position: 0x5150 / 20816
{
	int iVar0;
...
var Function_118(bool bParam0) //Position: 0x516F / 20847
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_119() //Position: 0x517B / 20859
{
	return Function_120(39);
}

int Function_120(int iParam0) //Position: 0x5186 / 20870
{
	int iVar0;
...
var Function_121() //Position: 0x51B4 / 20916
{
	return "PackedWeapon";
}

int Function_122(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x51C9 / 20937
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_123() //Position: 0x52CD / 21197
{
	return "MPItemGiver";
}

struct<32> Function_124(bool bParam0) //Position: 0x52E1 / 21217
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_125(char* cParam0, char* cParam1, char* cParam2) //Position: 0x534B / 21323
{
	char* cVar0[32];
...
var Function_126() //Position: 0x536A / 21354
{
	return "PBox_";
}

var Function_127() //Position: 0x5378 / 21368
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_128() //Position: 0x539E / 21406
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_129() //Position: 0x53C6 / 21446
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_130(var uParam0, int iParam1) //Position: 0x53EC / 21484
{
	int iVar0;
	var uVar1;
...
void Function_131(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x554D / 21837
{
	struct<8> Var0;
...
int Function_132(bool bParam0) //Position: 0x55E8 / 21992
{
	int iVar0;
	vector3 vVar1;
...
void Function_133(int iParam0) //Position: 0x5749 / 22345
{
...
var Function_134() //Position: 0x57AA / 22442
{
	int iVar0;
...
var Function_135(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x57B2 / 22450
{
	return Function_136(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_136(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x57CB / 22475
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_137(int iParam0) //Position: 0x5ABE / 23230
{
	int iVar0;
...
void Function_138() //Position: 0x5B72 / 23410
{
	int iVar0;
...
bool Function_139(bool bParam0) //Position: 0x5BAC / 23468
{
	int iVar0;
...
void Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5BD9 / 23513
{
	bool bVar0;
...
void Function_141() //Position: 0x5D2A / 23850
{
	int iVar0;
...
var Function_142(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5D75 / 23925
{
	int iVar0;
...
int Function_143() //Position: 0x5E45 / 24133
{
	int iVar0;
...
int Function_144() //Position: 0x5FA1 / 24481
{
	int iVar0;
...
bool Function_145(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x60C1 / 24769
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_146(var uParam0, int iParam1) //Position: 0x6191 / 24977
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_147(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x61AF / 25007
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_148(bool bParam0) //Position: 0x62E1 / 25313
{
	bool bVar0;
...
bool Function_149(int iParam0) //Position: 0x6300 / 25344
{
	int iVar0;
...
int Function_150() //Position: 0x631C / 25372
{
	if (Function_152())
	{
...
int Function_151() //Position: 0x6335 / 25397
{
	return Global_79349.f_16;
}

bool Function_152() //Position: 0x6341 / 25409
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_153(int iParam0, bool bParam1, bool bParam2) //Position: 0x634A / 25418
{
	var uVar0;
