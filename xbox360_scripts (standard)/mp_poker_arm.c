...
int Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x1C45 / 7237
{
	return Function_76(Global_29006, uParam0, uParam1, iParam2);
}

int Function_76(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x1C57 / 7255
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
void Function_77() //Position: 0x1CF3 / 7411
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
void Function_78(int iParam0, int iParam1) //Position: 0x21AD / 8621
{
	switch (iParam1)
	{
		case 0x00000000:
