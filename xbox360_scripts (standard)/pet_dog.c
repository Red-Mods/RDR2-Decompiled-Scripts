...
vector3 Function_63(vector3 vParam0) //Position: 0x27CA / 10186
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2827 / 10279
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2884 / 10372
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x288E / 10382
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28AC / 10412
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x28C1 / 10433
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2948 / 10568
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x296B / 10603
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2989 / 10633
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29AC / 10668
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2AC7 / 10951
{
...
int Function_74(bool bParam0) //Position: 0x2AF2 / 10994
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2BF7 / 11255
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C04 / 11268
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2C77 / 11383
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3175 / 12661
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x31AC / 12716
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x31C9 / 12745
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3201 / 12801
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x320B / 12811
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x322C / 12844
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x323A / 12858
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3342 / 13122
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3358 / 13144
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x360E / 13838
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x361C / 13852
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3635 / 13877
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x364F / 13903
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3687 / 13959
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x369E / 13982
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3967 / 14695
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3984 / 14724
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A20 / 14880
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A3F / 14911
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3A4E / 14926
{
...
void Function_98(int iParam0) //Position: 0x3A6A / 14954
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3A74 / 14964
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3AD6 / 15062
{
...
void Function_101(int iParam0) //Position: 0x3AEA / 15082
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3AF4 / 15092
{
