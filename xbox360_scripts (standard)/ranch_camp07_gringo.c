...
void Function_30(bool bParam0) //Position: 0x23B2 / 9138
{
	...
	if (bParam0)
	{
		...
		SNAP_ACTOR_TO_GRINGO(bLocal_7, GET_OBJECT_FROM_GRINGO(bLocal_15), "UseCase1", false, 0, 0);
	}
	TASK_USE_GRINGO(bLocal_7, bLocal_15, "UseCase1", 4294967295, 1);
	AI_IGNORE_ACTOR(bLocal_7);
	TASK_PRIORITY_SET(bLocal_7, false);
...
void Function_35(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x2AEA / 10986
{
	bool bVar0;
...
bool Function_37(bool bParam0, bool bParam1) //Position: 0x2B56 / 11094
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_42(int iParam0, bool bParam1) //Position: 0x2D06 / 11526
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_66(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x37E3 / 14307
{
...
void Function_74(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3AD9 / 15065
{
	bool bVar0;
	bool bVar1;
...
bool Function_90(var uParam0, bool bParam1, int iParam2) //Position: 0x43D8 / 17368
{
...
bool Function_98(int iParam0) //Position: 0x47BF / 18367
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x4B3A / 19258
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x4B7A / 19322
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x4BA5 / 19365
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x4BB6 / 19382
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4BF8 / 19448
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4C7C / 19580
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4CA5 / 19621
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4CF6 / 19702
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4D06 / 19718
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4D1A / 19738
{
	int iVar0;
...
var Function_109() //Position: 0x4D3F / 19775
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4D56 / 19798
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4E7C / 20092
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4E8D / 20109
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4E9E / 20126
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4EAF / 20143
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4ED2 / 20178
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4EF1 / 20209
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4EFD / 20221
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4F08 / 20232
{
	bool bVar0;
...
var Function_119() //Position: 0x4F36 / 20278
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4F4B / 20299
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x504F / 20559
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x5063 / 20579
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x50CD / 20685
{
	char* cVar0[32];
...
var Function_124() //Position: 0x50EC / 20716
{
	return "PBox_";
}

var Function_125() //Position: 0x50FA / 20730
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x5120 / 20768
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x5148 / 20808
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x516E / 20846
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x52CF / 21199
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x536A / 21354
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x54CB / 21707
{
...
var Function_132() //Position: 0x552C / 21804
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5534 / 21812
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x554D / 21837
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5840 / 22592
{
	int iVar0;
...
void Function_136() //Position: 0x58F4 / 22772
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x592E / 22830
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x595B / 22875
{
	bool bVar0;
...
void Function_139() //Position: 0x5AAC / 23212
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5AF7 / 23287
{
	int iVar0;
...
int Function_141() //Position: 0x5BC7 / 23495
{
	int iVar0;
...
int Function_142() //Position: 0x5D23 / 23843
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5E43 / 24131
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5F13 / 24339
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5F31 / 24369
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x6063 / 24675
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x6082 / 24706
{
	int iVar0;
...
int Function_148() //Position: 0x609E / 24734
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x60B7 / 24759
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x60C3 / 24771
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x60CC / 24780
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x6149 / 24905
{
	int iVar0;
