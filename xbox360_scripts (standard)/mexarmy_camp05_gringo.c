...
void Function_72() //Position: 0x35E8 / 13800
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_7, vVar0, 157,073f, 1, true, 1);
	...
	SNAP_ACTOR_TO_GRINGO(bLocal_7, bVar3, "UseCase1", true, 0, 0);
...
bool Function_75(var uParam0, bool bParam1, int iParam2) //Position: 0x3890 / 14480
{
...
void Function_80(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3FD0 / 16336
{
	bool bVar0;
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x4025 / 16421
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_86(int iParam0, bool bParam1) //Position: 0x41D5 / 16853
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0) //Position: 0x4558 / 17752
{
	bool bVar0;
	bool bVar1;
...
var Function_96(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4652 / 18002
{
	int iVar0;
	bool bVar1;
...
void Function_97(var uParam0, int iParam1) //Position: 0x468A / 18058
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_98(var uParam0, bool bParam1, int iParam2) //Position: 0x469B / 18075
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x475F / 18271
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x4ADA / 19162
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x4B1A / 19226
{
	int iVar0;
...
void Function_102() //Position: 0x4B45 / 19269
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4B87 / 19335
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4C0B / 19467
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C34 / 19508
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4C85 / 19589
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4C95 / 19605
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4CA9 / 19625
{
	int iVar0;
...
var Function_109() //Position: 0x4CCE / 19662
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CE5 / 19685
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4E0B / 19979
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4E1C / 19996
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4E2D / 20013
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4E3E / 20030
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4E61 / 20065
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4E80 / 20096
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4E8C / 20108
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x4E97 / 20119
{
	int iVar0;
...
var Function_119() //Position: 0x4EC5 / 20165
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4EDA / 20186
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4FDE / 20446
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4FF2 / 20466
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x505C / 20572
{
	char* cVar0[32];
...
var Function_124() //Position: 0x507B / 20603
{
	return "PBox_";
}

var Function_125() //Position: 0x5089 / 20617
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x50AF / 20655
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x50D7 / 20695
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x50FD / 20733
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x525E / 21086
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x52F9 / 21241
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x545A / 21594
{
...
var Function_132() //Position: 0x54BB / 21691
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54C3 / 21699
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x54DC / 21724
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x57CF / 22479
{
	int iVar0;
...
void Function_136() //Position: 0x5883 / 22659
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x58BD / 22717
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58EA / 22762
{
	bool bVar0;
...
void Function_139() //Position: 0x5A3B / 23099
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A86 / 23174
{
	int iVar0;
...
int Function_141() //Position: 0x5B56 / 23382
{
	int iVar0;
...
int Function_142() //Position: 0x5CB2 / 23730
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DD2 / 24018
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5EA2 / 24226
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5EC0 / 24256
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5FF2 / 24562
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x6011 / 24593
{
	int iVar0;
...
int Function_148() //Position: 0x602D / 24621
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x6046 / 24646
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x6052 / 24658
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x605B / 24667
{
	var uVar0;
