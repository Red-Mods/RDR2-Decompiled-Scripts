...
int Function_6(bool bParam0) //Position: 0x4CD / 1229
{
	if (!Function_9(bParam0))
	{
		return 4294967295;
...
bool Function_7() //Position: 0x4F4 / 1268
{
	return StackVal;
}

var Function_8(int iParam0, bool bParam1) //Position: 0x500 / 1280
{
	int iVar0;
...
bool Function_9(bool bParam0) //Position: 0x520 / 1312
{
	char* cVar0[64];
...
void Function_10() //Position: 0x5C1 / 1473
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool Function_11() //Position: 0x7F0 / 2032
{
