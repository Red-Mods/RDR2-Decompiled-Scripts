...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC4F / 3151
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xDB7 / 3511
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE23 / 3619
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE8F / 3727
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF04 / 3844
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xF49 / 3913
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0xF56 / 3926
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0xF62 / 3938
{
	if (!Function_4(128))
	{
		return;
