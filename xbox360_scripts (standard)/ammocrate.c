...
float Function_10(char* cParam0) //Position: 0x8D4 / 2260
{
	return Function_11(cParam0, "MinimumUseTime", 0.0f);
}

var Function_11(bool bParam0, char* cParam1, int iParam2) //Position: 0x8F1 / 2289
{
	int iVar0;
	
	iVar0 = iParam2;
	GET_GRINGO_FLOAT_ATTR(&iVar0, cParam1, bParam0);
	return iVar0;
}
...
void Function_18(bool bParam0, var uParam1) //Position: 0x1B8D / 7053
{
	bool bVar0;
	char* cVar1[16];
	bool bVar5;
	...
	while (bVar0 < (17 - 1))
	{
		...
		straddi(&cVar1, bVar0, 16);
		bVar5 = DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "nAmmoType_");
		if (bVar5 != 0)
		{
			PRINTSTRING("Giving ammo type: ");
			PRINTSTRING(GET_AMMO_ENUM_STRING_FROM_ENUM(bVar0));
			PRINTSTRING(", Amount: ");
			PRINTINT(bVar5);
			PRINTSTRING(", to ");
			PRINTSTRING(GET_OBJECT_NAME(bParam0));
			PRINTNL();
			_ADD_AMMO_OF_TYPE(bParam0, bVar0, TO_FLOAT(bVar5), 1, 1);
		}
		bVar0++;
	}
	return;
...
bool Function_19() //Position: 0x1C39 / 7225
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1C6A / 7274
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1CDE / 7390
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1D50 / 7504
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(char* cParam0) //Position: 0x1D5E / 7518
{
	return Function_11(cParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1D74 / 7540
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

var Function_25(char* cParam0) //Position: 0x1D81 / 7553
{
	return Function_11(cParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1DA1 / 7585
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1DB0 / 7600
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DCF / 7631
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DD5 / 7637
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DE3 / 7651
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(char* cParam0) //Position: 0x1DEE / 7662
{
	return Function_7(cParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1E08 / 7688
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(char* cParam0) //Position: 0x1E26 / 7718
{
	return Function_7(cParam0, "LinkToParentAnim", 0);
}

bool Function_34(int iParam0) //Position: 0x1E45 / 7749
{
	int iVar0;
	int iVar1;
...
bool Function_35(char* cParam0) //Position: 0x1E78 / 7800
{
	return Function_7(cParam0, "LinkParentToAnim", 0);
}

bool Function_36(char* cParam0) //Position: 0x1E97 / 7831
{
	return Function_7(cParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1EB1 / 7857
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EC4 / 7876
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x21AC / 8620
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x21B4 / 8628
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21D1 / 8657
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21E0 / 8672
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2202 / 8706
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2226 / 8742
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2243 / 8771
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2263 / 8803
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2283 / 8835
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	iVar0 = GRINGO_GET_FIRST_CHILD(2, bParam0);
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2331 / 9009
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x23A1 / 9121
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23B7 / 9143
{
...
var Function_51(char* cParam0) //Position: 0x23D8 / 9176
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(cParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23F8 / 9208
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x240C / 9228
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2416 / 9238
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x241D / 9245
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x242C / 9260
{
	bool bVar0;
...
var Function_57(bool bParam0) //Position: 0x246B / 9323
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2496 / 9366
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24A1 / 9377
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(char* cParam0) //Position: 0x2597 / 9623
{
	return Function_7(cParam0, "UsePosActorRelative", 0);
}

var Function_61(char* cParam0) //Position: 0x25B9 / 9657
{
	return Function_11(cParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x25E0 / 9696
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x25EA / 9706
{
	iParam0 = iParam0;
	return;
}

bool Function_64(char* cParam0) //Position: 0x25F4 / 9716
{
	return Function_7(cParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2612 / 9746
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x2627 / 9767
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x26AE / 9902
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x26D1 / 9937
{
	vector3 vVar0;
...
var Function_69(bool bParam0) //Position: 0x26EF / 9967
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x2712 / 10002
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_71(char* cParam0, int iParam1) //Position: 0x282D / 10285
{
	*iParam1 = Function_11(cParam0, "AreaClearCheck", -1.0f);
	if (*iParam1 < 0.0f)
	{
		return 1;
	}
...
int Function_72(bool bParam0) //Position: 0x2858 / 10328
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x295D / 10589
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x296A / 10602
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x29DD / 10717
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x2EDB / 11995
{
	return;
}

var Function_77(char* cParam0) //Position: 0x2EE1 / 12001
{
	return Function_11(cParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2EFE / 12030
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x2F36 / 12086
{
	iParam0 = iParam0;
	return;
}

bool Function_80(char* cParam0) //Position: 0x2F40 / 12096
{
	return Function_7(cParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2F61 / 12129
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F94 / 12180
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x309C / 12444
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x30B2 / 12466
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x3368 / 13160
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(char* cParam0) //Position: 0x3376 / 13174
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_87(char* cParam0) //Position: 0x338F / 13199
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x33A9 / 13225
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_89(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_89(var uParam0, int iParam1) //Position: 0x33E1 / 13281
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x33F8 / 13304
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
var Function_91(char* cParam0) //Position: 0x36C1 / 14017
{
	return Function_11(cParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x36DE / 14046
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
var Function_93(int iParam0) //Position: 0x377A / 14202
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3799 / 14233
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
...
bool Function_95(int iParam0) //Position: 0x3813 / 14355
{
...
void Function_96(int iParam0) //Position: 0x382F / 14383
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3839 / 14393
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x389B / 14491
{
...
void Function_99(int iParam0) //Position: 0x38AF / 14511
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x38B9 / 14521
{
