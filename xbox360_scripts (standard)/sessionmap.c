...
void Function_5(bool bParam0) //Position: 0x1B4 / 436
{
	...
	bVar11 = GUI_MAKE_TEXT(fLocal_2, &Var3, bVar2, "tahoma", 0,8f);
...
void Function_7() //Position: 0x2C2 / 706
{
	...
	Var0.f_8 = 1.0f;
	Var0.f_12 = 1.0f;
	bLocal_2 = GUI_MAKE_OVERLAY(bLocal_1, &Local_8, "MP_Session_Item_Containr", &Var0, &Var0, 0);
	return;
}
...
void Function_8() //Position: 0x32B / 811
{
	...
	if (IS_OBJECT_VALID(bLocal_13))
	{
		...
		{
			bVar1 = GUI_MESSAGE_RELEASED_INPUT(iVar0);
			GUI_SET_TEXT_COLOR(bVar1, &uVar2);
		}
	}
	return;
}
...
void Function_9(var uParam0) //Position: 0x374 / 884
{
	...
	fVar0 = (fVar0 - 68.0f);
	fVar1 = (fVar1 - 8.0f);
	GUI_MOVE_WINDOW_ABS(fLocal_3, fVar0, fVar1);
	return;
}
...
void Function_10() //Position: 0x3A1 / 929
{
	...
	Local_4.f_8 = 1230.0f;
	Local_4.f_12 = 670.0f;
	bLocal_1 = GUI_MAKE_OVERLAY(GUI_MAIN_WINDOW(), &Local_4, "MP_Session_map", &Var0, &Var0, 0);
	Function_7();
	Var4 = 50.0f;
	Var4.f_4 = 50.0f;
	...
	Var0.f_8 = 0.0f;
	Var0.f_12 = 0,2f;
	fLocal_3 = GUI_MAKE_OVERLAY(bLocal_1, &Var4, "MP_Session_Item_Highlight", &uVar8, &uVar8, 0);
	return;
}
