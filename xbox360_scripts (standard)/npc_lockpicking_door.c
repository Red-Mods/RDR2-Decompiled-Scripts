...
void Function_29(var uParam0, int iParam1) //Position: 0x1D37 / 7479
{
	...
	if (IS_OBJECT_VALID(bVar0))
	{
		...
		if (!IS_DOOR_CLOSED(iLocal_0[0]))
		{
			CLOSE_DOOR(iLocal_0[0], 1.0f);
		}
		iLocal_0[0] = FIND_NEAREST_DOOR(&uVar1, 1.0f);
		if (IS_DOOR_VALID(iLocal_0[0]))
		{
			if (!IS_DOOR_LOCKED(iLocal_0[0]))
			{
				SET_DOOR_LOCK(iLocal_0[0], 1);
			}
		}
	}
	return;
...
bool Function_30(int iParam0) //Position: 0x1D9A / 7578
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DA5 / 7589
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DBF / 7615
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DDD / 7645
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DFC / 7676
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E2F / 7727
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E4E / 7758
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E68 / 7784
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E7B / 7803
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x2163 / 8547
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x216B / 8555
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2188 / 8584
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2197 / 8599
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21B9 / 8633
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21DD / 8669
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21FA / 8698
{
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x223A / 8762
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22E8 / 8936
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2358 / 9048
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x236E / 9070
{
...
var Function_51(bool bParam0) //Position: 0x238F / 9103
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23AF / 9135
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23C3 / 9155
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23CD / 9165
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23D4 / 9172
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23E3 / 9187
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x2422 / 9250
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x244D / 9293
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2458 / 9304
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x254E / 9550
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2570 / 9584
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2597 / 9623
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2856 / 10326
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28B3 / 10419
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2910 / 10512
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x291A / 10522
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2938 / 10552
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x294D / 10573
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29D4 / 10708
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29F7 / 10743
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A15 / 10773
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A38 / 10808
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B53 / 11091
{
...
int Function_74(bool bParam0) //Position: 0x2B7E / 11134
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C83 / 11395
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C90 / 11408
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D03 / 11523
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3201 / 12801
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3238 / 12856
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3255 / 12885
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x328D / 12941
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3297 / 12951
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x32B8 / 12984
{
	var uVar0;
	...
	iLocal_0[0] = FIND_NEAREST_DOOR(&uVar0, 1.0f);
	if (IS_DOOR_VALID(iLocal_0[0]))
	{
		Function_84(&iLocal_0, 0);
	}
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var uParam0, int iParam1) //Position: 0x32F1 / 13041
{
	int iVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3331 / 13105
{
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3382 / 13186
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x348A / 13450
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x34A0 / 13472
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x3756 / 14166
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x3764 / 14180
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x377D / 14205
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x3797 / 14231
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x37CF / 14287
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x37E6 / 14310
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3AAF / 15023
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3ACC / 15052
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3B68 / 15208
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3B87 / 15239
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3B96 / 15254
{
...
void Function_100(int iParam0) //Position: 0x3BB2 / 15282
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3BBC / 15292
{
	bool bVar0;
	bool bVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x3C1E / 15390
{
...
void Function_103(int iParam0) //Position: 0x3C32 / 15410
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3C3C / 15420
{
