...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uParam0 = Function_58(&uParam0);
	iParam2 = 0;
	bVar0 = 0.0f;
	GET_GRINGO_FLOAT_ATTR(&bVar0, "effectTime", &uParam0);
	if (Function_57(2) > 5)
	{
		DECOR_SET_FLOAT(&uParam1, "survivalist", (bVar0 * 2.0f));
	}
	else
	{
		DECOR_SET_FLOAT(&uParam1, "survivalist", bVar0);
	}
	iLocal_4 = 0;
	iParam2 = 1;
	return;
...
int Function_57(int iParam0) //Position: 0x2D5F / 11615
{
...
var Function_58(int iParam0) //Position: 0x2D87 / 11655
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_59(int iParam0, int iParam1) //Position: 0x2DA2 / 11682
{
	var uVar0;
	var uVar1;
