...
void main() //Position: 0x0 / 0
{
	...
	while (bVar0 <= 5)
	{
		Function_189(&uLocal_336, iLocal_419[bVar0], 3, 0);
		bVar0++;
	}
	Function_187(&uLocal_336, "$/content/DLC/ZombiePack/Gringos/DLC_nun_benchA", 1, 0);
	Function_187(&uLocal_336, "$/content/DLC/ZombiePack/Gringos/DLC_nun_benchB", 1, 0);
	Function_187(&uLocal_336, "$/content/DLC/ZombiePack/Gringos/DLC_nun_benchC", 1, 0);
	Function_186(&iLocal_415);
	while (!IS_EXITFLAG_SET())
	{
		if (Function_185())
		{
			if (IS_ACTOR_VALID(&uLocal_385))
			{
				SET_ACTOR_FACTION(&uLocal_385, 3);
				TASK_FLEE_ACTOR(&uLocal_385, &Global_54076, -1.0f, -1.0f, 0, 0, 0);
			}
			bVar0 = false;
			while (bVar0 <= 5)
			{
				SET_ACTOR_FACTION(&(uLocal_387[bVar0]), 3);
				TASK_FLEE_ACTOR(&(uLocal_387[bVar0]), &Global_54076, -1.0f, -1.0f, 0, 0, 0);
				bVar0++;
			}
			if (Function_184(25))
			{
		...
		switch (iLocal_382)
		{
			case 0x00000000:
				...
				{
					if (IS_LAYOUTREF_VALID(&uLocal_383))
					{
						if (Function_171(&uLocal_336))
						{
							uLocal_385 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_383, "mothersuperior", 613, *(&Global_99725[ScriptParam_043] + 184), Vector(0.0f, 0.0f, 0.0f));
							SET_ACTOR_FACTION(&uLocal_385, 20);
							uLocal_413 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_383, "Mother2_StayOut", 2,802597E-45f, Vector(-1663,512f, 8,941f, 4286,691f), Vector(0.0f, 45,725f, 0.0f), Vector(19,93f, 3,928f, 16,716f));
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_413);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_413);
							GIVE_WEAPON_TO_ACTOR(&uLocal_385, 9, false, 1, 1);
							ACTOR_PUT_WEAPON_IN_HAND(&uLocal_385, 9, 0);
							ACTOR_DRAW_WEAPON(&uLocal_385, 9, 0);
							bVar1 = TASK_SEQUENCE_OPEN();
							TASK_DRAW_HOLSTER_WEAPON(0, 1);
							TASK_GUARD_STAND(0, &Global_99725[ScriptParam_043] + 196, 32.0f);
							TASK_SEQUENCE_CLOSE();
							TASK_SEQUENCE_PERFORM(&uLocal_385, bVar1);
							TASK_PRIORITY_SET(&uLocal_385, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_385, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
							AUDIO_ADD_ALTERNATE_CONTEXT(&uLocal_385, "RCM_CALL_OVER", "RCM_CALL_OVER_PRE2");
							bVar0 = false;
							while (bVar0 <= 5)
							{
								switch (bVar0)
								{
									case 0x00000000:
										uLocal_399[bVar0] = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(&Global_46715, "gringo1", "DLC_nun_benchA", Local_431[bVar02], Local_453[bVar02]));
										break;
									
									case 0x00000001:
										uLocal_399[bVar0] = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(&Global_46715, "gringo2", "DLC_nun_benchB", Local_431[bVar02], Local_453[bVar02]));
										break;
									
									case 0x00000002:
										uLocal_399[bVar0] = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(&Global_46715, "gringo3", "DLC_nun_benchC", Local_431[bVar02], Local_453[bVar02]));
										break;
									
									case 0x00000003:
										uLocal_399[bVar0] = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(&Global_46715, "gringo4", "DLC_nun_benchA", Local_431[bVar02], Local_453[bVar02]));
										break;
									
									case 0x00000004:
										uLocal_399[bVar0] = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(&Global_46715, "gringo5", "DLC_nun_benchB", Local_431[bVar02], Local_453[bVar02]));
										break;
								}
								uLocal_387[bVar0] = CREATE_ACTOR_IN_LAYOUT(&uLocal_383, Function_170(), iLocal_419[bVar0], Local_431[bVar02], Local_453[bVar02]);
								SET_ACTOR_FACTION(&(uLocal_387[bVar0]), 20);
								AI_IGNORE_ACTOR(&(uLocal_387[bVar0]));
								TASK_PRIORITY_SET(&(uLocal_387[bVar0]), true);
								SNAP_ACTOR_TO_GRINGO(&(uLocal_387[bVar0]), GET_OBJECT_FROM_GRINGO(&(uLocal_399[bVar0])), "UseCase1", true, 0, 0);
								TASK_USE_GRINGO(&(uLocal_387[bVar0]), &(uLocal_399[bVar0]), "UseCase1", 4294967295, 1);
								bVar0++;
							}
							Function_163(&(Global_99725[2543]), 25, 0x41f00000, 0x42200000, 0);
							iLocal_382 = 1;
							Function_161(&iLocal_415);
						}
						else if (Function_158(&iLocal_415) < 5.0f)
						{
							Function_161(&iLocal_415);
						}
					}
					...
					{
						uLocal_383 = CREATE_LAYOUT("RCM_Mother_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (StackVal && FABS((StackVal - !Function_154(&Global_54076, 1, 1))) > 2.0f)
					{
						if (Function_150(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
						{
			...
			case 0x00000003:
				if (Function_112("$/cutscene/mother_superior_has_a_gun_2_pt_a_cs/mother_superior_has_a_gun_2_pt_a_cs", &iLocal_370, 33486, 33479, 32078, 31559, 31129, 31113, 1, 1, 2, 2, 0))
				{
					iLocal_382 = 5;
					Function_161(&iLocal_415);
				}
			...
			case 0x00000005:
				...
				{
					Function_111("Mother2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					iLocal_475 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
					bVar0 = false;
					while (bVar0 <= iLocal_475)
					{
						SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, bVar0), 4, 0);
						bVar0++;
					}
					TASK_PRIORITY_SET(&uLocal_385, 2);
					SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_385, 1, 1, false, 1, 0, 2, 1101004800, 1088421888, 1);
					AUDIO_ADD_ALTERNATE_CONTEXT(&uLocal_385, "RCM_STILL_HERE", "RCM_STILL_HERE_POST2");
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "mother2_OBJ", 0, 3, false);
			...
			case 0x00000006:
				if (IS_ACTOR_VALID(&uLocal_385))
				{
					...
					{
						if (!Function_1(&uLocal_385, 0x3f800000, 0x42960000, 1, 1, 0))
						{
							DESTROY_ACTOR(&uLocal_385);
							iLocal_382 = 7;
						}
					}
				}
...
bool Function_1(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x871 / 2161
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_2(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x891 / 2193
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_3(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xD0B / 3339
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_4() //Position: 0xEAC / 3756
{
	return;
}

void Function_5(var uParam0, int iParam1) //Position: 0xEB2 / 3762
{
	if (Global_6624)
	{
		return;
...
void Function_6(bool bParam0) //Position: 0xEF1 / 3825
{
...
void Function_7() //Position: 0xF46 / 3910
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_8() //Position: 0xF91 / 3985
{
...
void Function_9() //Position: 0x1097 / 4247
{
	float fVar0;
...
void Function_10() //Position: 0x10CA / 4298
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x125D / 4701
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0x1416 / 5142
{
	Function_13(&Global_42918, 1, 0);
	return;
}

void Function_13(struct<2317> Param0) //Position: 0x1424 / 5156
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_14() //Position: 0x1641 / 5697
{
...
struct<8> Function_15(int iParam0) //Position: 0x1656 / 5718
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x16FD / 5885
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1999 / 6553
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_18(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_170(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_18(int iParam0) //Position: 0x1FD7 / 8151
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1FE8 / 8168
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x20DF / 8415
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x20FA / 8442
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x2161 / 8545
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x2173 / 8563
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2185 / 8581
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x22B9 / 8889
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x22C8 / 8904
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x2301 / 8961
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x233E / 9022
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x24D8 / 9432
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x271C / 10012
{
...
struct<8> Function_31() //Position: 0x275D / 10077
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x27E6 / 10214
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x287D / 10365
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x28FC / 10492
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x2939 / 10553
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2B45 / 11077
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x2BFC / 11260
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2C14 / 11284
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x2D0C / 11532
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_40(int iParam0) //Position: 0x2D16 / 11542
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x2D2C / 11564
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x2DF8 / 11768
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x2E15 / 11797
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x3641 / 13889
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x367C / 13948
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x3689 / 13961
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3698 / 13976
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x3747 / 14151
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_184(4) && !Function_54(0))
	{
	...
	if (!Function_51(&Global_6667[228] + 184, 2) || ((((((Function_184(14) && Function_184(18)) && Function_184(37)) && Function_184(7)) && Function_184(11)) && Function_184(5)) && Function_184(21)))
	{
	...
	if (!Function_51(&Global_6667[328] + 184, 2) || ((Function_184(27) && Function_184(1)) && Function_184(23)))
	{
	...
	if (!Function_184(7))
	{
		...
		if (((Function_184(6) && Function_49(Global_46949) < 0) && Function_49(Global_46951) < 0) && Function_49(Global_46952) < 0)
		{
	...
	{
		Function_111(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_49(int iParam0) //Position: 0x4069 / 16489
{
...
bool Function_50(int iParam0) //Position: 0x4083 / 16515
{
...
bool Function_51(int iParam0, int iParam1) //Position: 0x409A / 16538
{
	int iVar0;
...
bool Function_52() //Position: 0x40B7 / 16567
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x40C3 / 16579
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x40D8 / 16600
{
...
int Function_55(int iParam0) //Position: 0x413E / 16702
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_56(int iParam0) //Position: 0x4200 / 16896
{
	...
	Function_110(Function_52(), 0);
	return;
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x4249 / 16969
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x4287 / 17031
{
...
bool Function_59(int iParam0) //Position: 0x42A1 / 17057
{
...
void Function_60(bool bParam0) //Position: 0x42B7 / 17079
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_61(struct<229> Param0) //Position: 0x4471 / 17521
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_170(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_62(&Param0);
...
void Function_62(struct<217> Param0) //Position: 0x4541 / 17729
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_170(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_170(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_63(&uVar1, 0);
	return;
}

int Function_63(var uParam0, int iParam1) //Position: 0x45FF / 17919
{
	int iVar0;
	var uVar1;
...
void Function_64(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4769 / 18281
{
	struct<8> Var0;
...
struct<32> Function_65(char* cParam0) //Position: 0x4811 / 18449
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_66(char* cParam0) //Position: 0x487D / 18557
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x489F / 18591
{
	int iVar0;
	struct<2> Var1;
...
float Function_68(int iParam0, struct<2> Param1) //Position: 0x4A0D / 18957
{
	struct<2> Var0;
...
struct<8> Function_69(int iParam0) //Position: 0x4A84 / 19076
{
	struct<2> Var0;
...
void Function_70(int iParam0) //Position: 0x4AF0 / 19184
{
...
bool Function_71(int iParam0) //Position: 0x4B58 / 19288
{
...
void Function_72(struct<153> Param0) //Position: 0x4B6E / 19310
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
void Function_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5084 / 20612
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_74(int iParam0) //Position: 0x510F / 20751
{
	char* cVar0[16];
...
bool Function_75() //Position: 0x514E / 20814
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_76(int iParam0) //Position: 0x517B / 20859
{
...
var Function_77(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x51A7 / 20903
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_78(int iParam0) //Position: 0x51C8 / 20936
{
...
bool Function_79(struct<249> Param0) //Position: 0x51DD / 20957
{
	...
	if ((Function_89(iParam1) || Function_184(iParam1)) || Function_88(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_80(struct<265> Param0) //Position: 0x530D / 21261
{
	int iVar0;
...
bool Function_81(int iParam0) //Position: 0x546E / 21614
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_82(int iParam0) //Position: 0x5492 / 21650
{
...
bool Function_83(int iParam0) //Position: 0x54A7 / 21671
{
	return Global_116927[iParam06].f_16;
}

bool Function_84(struct<237> Param0) //Position: 0x54B7 / 21687
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_85(int iParam0) //Position: 0x5586 / 21894
{
...
bool Function_86(int iParam0) //Position: 0x55E1 / 21985
{
	int iVar0;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x55FD / 22013
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x561A / 22042
{
...
int Function_89(int iParam0) //Position: 0x562F / 22063
{
...
void Function_90() //Position: 0x5644 / 22084
{
...
int Function_91(int iParam0, int iParam1) //Position: 0x56C4 / 22212
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_57(6, 0) && Function_184(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if ((Function_57(9, 0) && Function_184(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
int Function_92(int iParam0) //Position: 0x6327 / 25383
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x6376 / 25462
{
...
int Function_94(int iParam0) //Position: 0x638C / 25484
{
...
void Function_95() //Position: 0x63F5 / 25589
{
...
bool Function_96(int iParam0) //Position: 0x641A / 25626
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x646B / 25707
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x6498 / 25752
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x64EA / 25834
{
	int iVar0;
...
void Function_100() //Position: 0x6524 / 25892
{
	bool bVar0;
...
void Function_101(int iParam0, int iParam1) //Position: 0x6582 / 25986
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_102(int iParam0) //Position: 0x6598 / 26008
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x65E2 / 26082
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x6657 / 26199
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x6691 / 26257
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x670D / 26381
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x67AE / 26542
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x67EB / 26603
{
...
bool Function_109() //Position: 0x67FE / 26622
{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x6819 / 26649
{
	bool bVar0;
...
void Function_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x683E / 26686
{
	struct<4> Var0;
	var uVar4;
...
bool Function_112(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x68D3 / 26835
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_113(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_113(var uParam0, int iParam1, struct<41> Param2) //Position: 0x698C / 27020
{
	if (!&bParam15)
	{
		Function_124(&iParam1, &uParam10);
	}
	switch (iParam1)
	{
		case 0x000003E8:
			if (uParam3 != 99 && (Function_123(&Param2) || Param2.f_40 < 1))
			{
				iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_122())
					{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_158(&iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_158(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && uParam3 == 99) && !Function_123(&Param2))
			{
...
void Function_114(var uParam0, bool bParam1) //Position: 0x6FEE / 28654
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_115() //Position: 0x70BD / 28861
{
	int iVar0;
...
void Function_116() //Position: 0x7135 / 28981
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_117() //Position: 0x717A / 29050
{
...
void Function_118(bool bParam0) //Position: 0x718C / 29068
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_119(var uParam0, int iParam1) //Position: 0x71A9 / 29097
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_170(), &iParam1, 4294967295, 1);
...
bool Function_120(int iParam0) //Position: 0x723B / 29243
{
	bool bVar0;
...
int Function_121(bool bParam0) //Position: 0x726C / 29292
{
	bool bVar0;
	var uVar1;
...
bool Function_122() //Position: 0x732F / 29487
{
	bool bVar0;
	var uVar1;
...
bool Function_123(struct<37> Param0) //Position: 0x736C / 29548
{
	return Param0.f_36;
}

void Function_124(var uParam0, int iParam1) //Position: 0x7377 / 29559
{
	Function_125(&uParam0, &iParam1, 0);
	return;
}

void Function_125(var uParam0, bool bParam1, int iParam2) //Position: 0x7387 / 29575
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_126(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x74FF / 29951
{
	int iVar0;
	int iVar1;
...
void Function_127(bool bParam0) //Position: 0x7727 / 30503
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x77C5 / 30661
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x77EF / 30703
{
	var uVar0;
	var uVar1;
...
void Function_130() //Position: 0x784A / 30794
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_170(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_170(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_131() //Position: 0x7989 / 31113
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x7999 / 31129
{
	...
	AUDIO_MUSIC_FORCE_TRACK("TC_MEX_SONG_02", "nIDLE_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_133(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	if (IS_VOLUME_VALID(&uLocal_411))
	{
		DESTROY_VOLUME(&uLocal_411);
	}
	return 1;
}

void Function_133(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7A63 / 31331
{
	var uVar0;
	...
	Function_114(&uParam9, &bParam10);
}

void Function_134() //Position: 0x7B32 / 31538
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x7B47 / 31559
{
	bool bVar0;
...
int Function_136() //Position: 0x7D4E / 32078
{
	int iVar0;
	...
	if (!iLocal_476)
	{
		...
		while (iVar0 <= 5)
		{
			if (IS_GRINGO_VALID(&(uLocal_399[iVar0])))
			{
				DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&(uLocal_399[iVar0])));
			}
			iVar0++;
		}
		Function_137(StackVal, Vector(-1665,69f, 8,06f, 4276,58f), &uLocal_411);
		iLocal_476 = 1;
	}
	return 1;
}

void Function_137(vector3 vParam0) //Position: 0x7DA5 / 32165
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_37(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_138(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_138(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_138(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_138(int iParam0, int iParam1) //Position: 0x7F4E / 32590
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_139(float fParam0, float fParam1) //Position: 0x807C / 32892
{
...
void Function_140() //Position: 0x818D / 33165
{
...
void Function_141() //Position: 0x81C1 / 33217
{
...
int Function_142() //Position: 0x82C7 / 33479
{
	return 1;
}

int Function_143() //Position: 0x82CE / 33486
{
	...
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("CAUCASIAN_FEMALE_Nun03", &(uLocal_387[0]));
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("HISPANIC_FEMALE_Nun02", &(uLocal_387[1]));
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("HISPANIC_FEMALE_Nun03", &(uLocal_387[2]));
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("RCM_16_Nun", &(uLocal_387[3]));
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("CAUCASIAN_FEMALE_Nun02", &(uLocal_387[4]));
	uLocal_411 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_383, "Mother2_CSVol", 2, *(&Global_99725[2543] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(30.0f, 20.0f, 30.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_146(0, 0, 1, 1, 0, 1, 1, &uLocal_411, 1, 1, 1, 1, 0x3f800000, 0);
	Function_144(StackVal, &uLocal_383, *(&Global_99725[2543] + 196), &uLocal_411, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_144(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8475 / 33909
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_145(var uParam0, float fParam1) //Position: 0x8715 / 34581
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_146(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8797 / 34711
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_149(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_170(), 2, Function_149(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	if (Function_86(0x4000000))
	{
		...
		Function_147(0x4000000);
	}
	if (Function_86(0x8000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
		Function_147(0x8000000);
	}
	SET_TREE_COST_MODIFIER(&uParam12);
	SET_USES_QUAD_IK_FIX(&uParam13);
}

void Function_147(int iParam0) //Position: 0x8A49 / 35401
{
	int iVar0;
...
var Function_148() //Position: 0x8A7D / 35453
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_149(bool bParam0) //Position: 0x8B0B / 35595
{
	struct<2> Var0;
...
bool Function_150(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8B1D / 35613
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_153(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_152(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_151(vector3 vParam0) //Position: 0x8D52 / 36178
{
	var uVar0;
...
float Function_152(var uParam0, bool bParam1) //Position: 0x8DC8 / 36296
{
	struct<2> Var0;
...
void Function_153(var uParam0, bool bParam1) //Position: 0x8DE9 / 36329
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_152(&uParam0, 0) < 2.0f)
	{
...
bool Function_154(int iParam0, bool bParam1, bool bParam2) //Position: 0x8E53 / 36435
{
...
bool Function_155() //Position: 0x8F17 / 36631
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_156(int iParam0) //Position: 0x8F2E / 36654
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_157(int iParam0) //Position: 0x8F3A / 36666
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

float Function_158(vector3 vParam0) //Position: 0x8F49 / 36681
{
	if (Function_160(&vParam0))
	{
		if (Function_159(&vParam0))
		{
			return vParam0.z;
		}
...
bool Function_159(int iParam0) //Position: 0x9016 / 36886
{
	return Function_45(iParam0, 2);
}

bool Function_160(int iParam0) //Position: 0x9024 / 36900
{
	return Function_45(iParam0, 1);
}

void Function_161(int iParam0) //Position: 0x9032 / 36914
{
	Function_162(&iParam0, 0.0f);
	return;
}

void Function_162(vector3 vParam0) //Position: 0x903F / 36927
{
...
int Function_163(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x9064 / 36964
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_165(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_165(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_164(struct<257> Param0) //Position: 0x91EF / 37359
{
...
int Function_165(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x922B / 37419
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_166() //Position: 0x9493 / 38035
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_167(char* cParam0) //Position: 0x94E7 / 38119
{
	char* cVar0[64];
...
bool Function_168(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9610 / 38416
{
...
int Function_169() //Position: 0x969C / 38556
{
	if (IS_PS3())
	{
		return 1;
...
var Function_170() //Position: 0x96AB / 38571
{
	int iVar0;
...
bool Function_171(struct<2>[] Param0) //Position: 0x96B4 / 38580
{
	int iVar0;
	int iVar1;
...
void Function_172() //Position: 0x9A76 / 39542
{
	if (!Function_86(128))
	{
		return;
...
bool Function_173() //Position: 0x9AB6 / 39606
{
	int iVar0;
...
void Function_174(struct<13> Param0) //Position: 0x9AE4 / 39652
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

bool Function_175(struct<13> Param0) //Position: 0x9AF7 / 39671
{
	int iVar0;
...
void Function_176() //Position: 0x9B15 / 39701
{
	if (!Function_86(128))
	{
		return;
...
void Function_177() //Position: 0x9B57 / 39767
{
	int iVar0;
	
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_413);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_413);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		if (!Function_1(&(uLocal_387[iVar0]), 0x3f800000, 0x42960000, 1, 1, 0))
		{
			DESTROY_ACTOR(&(uLocal_387[iVar0]));
		}
		iVar0++;
	}
	ENABLE_CHILD_SECTOR("lsh_garden01x");
...
int Function_178(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9C40 / 40000
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_179(int iParam0) //Position: 0x9C72 / 40050
{
	int iVar0;
...
void Function_180(struct<2>[] Param0, int iParam1) //Position: 0x9C9A / 40090
{
...
void Function_181(struct<13> Param0) //Position: 0x9DE5 / 40421
{
	int iVar0;
...
void Function_182(var uParam0, int iParam1) //Position: 0x9E02 / 40450
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_183(int iParam0, bool bParam1) //Position: 0x9E13 / 40467
{
	char* cVar0[32];
...
bool Function_184(int iParam0) //Position: 0x9F9C / 40860
{
...
bool Function_185() //Position: 0x9FB1 / 40881
{
	int iVar0;
	
	if (IS_ACTOR_VALID(&uLocal_385))
	{
		if (GET_LAST_ATTACKER(&uLocal_385) == &Global_54076)
		{
			return 1;
		}
	}
	...
	while (iVar0 <= 5)
	{
		if (IS_ACTOR_VALID(&(uLocal_387[iVar0])))
		{
			if (GET_LAST_ATTACKER(&(uLocal_387[iVar0])) == &Global_54076)
			{
				return 1;
			}
		}
...
void Function_186(int iParam0) //Position: 0xA006 / 40966
{
...
var Function_187(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA01D / 40989
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_188(&Param0, &uVar1, iParam2);
	if (&bParam3)
	{
		Function_174(&(Param0[iVar02]), 8);
	}
...
var Function_188(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA05B / 41051
{
	int iVar0;
...
var Function_189(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xA12A / 41258
{
	int iVar0;
...
void Function_190() //Position: 0xA206 / 41478
{
	iLocal_419[0] = 63;
	iLocal_419[1] = 243;
	iLocal_419[2] = 244;
	iLocal_419[3] = 354;
	iLocal_419[4] = 62;
	Local_431[02] = Vector(-1661,361f, 8,503f, 4283,604f);
	Local_431[12] = Vector(-1661,899f, 8,507f, 4284,147f);
	Local_431[22] = Vector(-1662,392f, 8,51f, 4284,647f);
	Local_431[32] = Vector(-1661,251f, 8,501f, 4285,29f);
	Local_431[42] = Vector(-1660,544f, 8,501f, 4284,583f);
	Local_453[02] = Vector(0.0f, 225,323f, 0.0f);
	Local_453[12] = Vector(0.0f, 225,323f, 0.0f);
	Local_453[22] = Vector(0.0f, 225,323f, 0.0f);
	Local_453[32] = Vector(0.0f, 45,323f, 0.0f);
	Local_453[42] = Vector(0.0f, 45,323f, 0.0f);
	return;
}
