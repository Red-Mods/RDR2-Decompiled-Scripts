...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_72(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_29(var uParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	...
	if (IS_OBJECT_ATTACHED(&uVar0))
	{
		...
		if (IS_ATTACHMENT_VALID(&uVar1))
		{
			...
			{
				iLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, &uVar2, 4294967295);
			}
		}
	}
	return;
...
bool Function_30(int iParam0) //Position: 0x2041 / 8257
{
	iParam0 = &iParam0;
	return 1;
}
...
bool Function_32(int iParam0, int iParam1) //Position: 0x2069 / 8297
{
...
void Function_37(var uParam0, int iParam1) //Position: 0x211B / 8475
{
...
bool Function_40(int iParam0, int iParam1) //Position: 0x245E / 9310
{
...
bool Function_42(int iParam0, int iParam1) //Position: 0x248C / 9356
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x24B0 / 9392
{
...
void Function_47(int iParam0, int iParam1) //Position: 0x2538 / 9528
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_62(int iParam0) //Position: 0x28DF / 10463
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BC6 / 11206
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C23 / 11299
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C80 / 11392
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C8C / 11404
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CAB / 11435
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CC2 / 11458
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
	...
	if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
	{
		...
		iLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, GET_TARGET_OBJECT(), 4294967295);
	}
	else
	{
		uVar3 = GRINGO_GET_MY_OBJECT_REF();
		uVar3 = Function_69(&uVar3);
		if (IS_OBJECT_VALID(&uVar3))
		{
			if (IS_OBJECT_ATTACHED(&uVar3))
			{
				...
				if (IS_ATTACHMENT_VALID(&uVar4))
				{
					...
					{
						iLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, &uVar5, 4294967295);
					}
				}
			}
		}
...
var Function_69(var uParam0) //Position: 0x2E21 / 11809
{
	int iVar0;
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2EA8 / 11944
{
...
int Function_71(var uParam0) //Position: 0x2ED6 / 11990
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2FEF / 12271
{
	return (uParam0 && iParam1) == 0;
}

void Function_73(struct<69> Param0) //Position: 0x2FFC / 12284
{
	if (Function_72(Param0.f_64, 16))
	{
...
void Function_74(struct<69> Param0) //Position: 0x307E / 12414
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_75() //Position: 0x3629 / 13865
{
	int iVar0;
...
int Function_76(int iParam0) //Position: 0x3663 / 13923
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_77(int iParam0, var uParam1) //Position: 0x3681 / 13953
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_78(int iParam0) //Position: 0x36C2 / 14018
{
	iParam0 = &iParam0;
	return;
}

bool Function_79(int iParam0) //Position: 0x36CE / 14030
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_80(int iParam0, int iParam1) //Position: 0x36F0 / 14064
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_ATTACHMENT_VALID(&iLocal_2))
...
void Function_81(var uParam0, bool bParam1) //Position: 0x375A / 14170
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_82(int iParam0, int iParam1) //Position: 0x386A / 14442
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_83(struct<69> Param0) //Position: 0x3882 / 14466
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_84(int iParam0, int iParam1) //Position: 0x3B9E / 15262
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_85(int iParam0) //Position: 0x3BB0 / 15280
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_86(int iParam0) //Position: 0x3BCA / 15306
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_87(int iParam0, var uParam1) //Position: 0x3BE5 / 15333
{
	bool bVar0;
	int iVar1;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3C23 / 15395
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_89(struct<65> Param0) //Position: 0x3C3C / 15420
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_90(int iParam0) //Position: 0x3F34 / 16180
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_91(var uParam0, int iParam1) //Position: 0x3F52 / 16210
{
	struct<5> Var0;
	float fVar5;
...
int Function_92(int iParam0) //Position: 0x3FF2 / 16370
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_93(var uParam0, float fParam1) //Position: 0x4018 / 16408
{
	struct<5> Var0;
...
bool Function_94(int iParam0) //Position: 0x4044 / 16452
{
...
void Function_95(int iParam0) //Position: 0x4060 / 16480
{
	iParam0 = &iParam0;
	return;
}

void Function_96(var uParam0, int iParam1) //Position: 0x406C / 16492
{
	int iVar0;
	var uVar1;
...
void Function_97(int iParam0, int iParam1) //Position: 0x40D8 / 16600
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_98(int iParam0) //Position: 0x40F0 / 16624
{
	iParam0 = &iParam0;
	return;
}

void Function_99(int iParam0) //Position: 0x40FC / 16636
{
