...
void main() //Position: 0x0 / 0
{
	...
	iLocal_22 = 0;
	Function_100(&uScriptParam_0, &iLocal_22);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_23);
		}
		iVar2 = 0;
		bLocal_30 = false;
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_31))
								{
									...
									{
										bLocal_31 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_31 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_28, &uLocal_26);
...
struct<8> Function_67(int iParam0) //Position: 0x2984 / 10628
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x29A8 / 10664
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x29C7 / 10695
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x29EB / 10731
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B13 / 11027
{
...
int Function_72(var uParam0) //Position: 0x2B41 / 11073
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2C5A / 11354
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2C67 / 11367
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2CE9 / 11497
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_28)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_26));
		iLocal_28 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_76() //Position: 0x3294 / 12948
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x32CE / 13006
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x32EC / 13036
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x332D / 13101
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x3339 / 13113
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x335B / 13147
{
	var uVar0;
	var uVar1;
	...
	{
		if (DECOR_CHECK_EXIST(&uParam0, "HorseLeash"))
		{
			uVar0 = DECOR_GET_OBJECT(&uParam0, "HorseLeash");
			DESTROY_OBJECT(&uVar0);
			DECOR_REMOVE(&uParam0, "HorseLeash");
		}
		DECOR_SET_FLOAT(&uParam0, "LastHitchedTime", GET_CURRENT_GAME_TIME());
		if (!Global_6623)
		{
			TASK_CLEAR(&uParam0);
			TASK_STAND_STILL(&uParam0, -1.0f, 1, 0);
		}
	}
	if (IS_LAYOUTREF_VALID(&Global_46715))
	{
		...
		if (IS_OBJECT_VALID(&uVar1))
		{
			if (Function_82(&uVar1, GRINGO_GET_MY_OBJECT_REF()) > 5.0f)
			{
				GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), 0);
			}
			else
			{
				GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), 1);
			}
		}
	}
	return;
...
float Function_82(var uParam0, int iParam1) //Position: 0x343C / 13372
{
	struct<2> Var0;
	struct<2> Var2;
	...
	if (IS_OBJECT_VALID(&uParam0))
	{
		...
		{
			Function_83(&uParam0);
			Var0 = Function_83(&uParam0);
			Function_83(&iParam1);
			Var2 = Function_83(&iParam1);
...
struct<8> Function_83(int iParam0) //Position: 0x34D9 / 13529
{
	struct<2> Var0;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3547 / 13639
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(bool bParam0, int iParam1) //Position: 0x3657 / 13911
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &bParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x366F / 13935
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_87(int iParam0, var uParam1) //Position: 0x398C / 14732
{
	struct<2> Var0;
	var uVar2;
	struct<2> Var3;
	...
	{
		if (!ACTOR_HAS_ANIM_SET(&Global_54076, "horse_tend"))
		{
			if (!DECOR_CHECK_EXIST(&iParam0, "HorseLeash"))
			{
				Function_88(GRINGO_GET_MY_OBJECT_REF());
				Var0 = Function_88(GRINGO_GET_MY_OBJECT_REF());
				uVar2 = CREATE_LEASH_OBJECT(&iParam0, Function_39(), RAND_FLOAT_RANGE(1,65f, 1,75f), 10, 0, 0,006f, 10.0f, 10000.0f, 200.0f, 8.0f, 100.0f, 1.0f, 0, 0, 1);
				LEASH_ATTACH_TO_WORLD(StackVal, &uVar2, Var0, Vector(0.0f, 0.0f, 0.0f), 0);
				LEASH_ATTACH_TO_OBJECT_BONE(StackVal, StackVal, &uVar2, &iParam0, "LowLip1", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 1, 1, 0);
				DECOR_SET_OBJECT(&iParam0, "HorseLeash", &uVar2);
				LEASH_CONSTRAIN(&uVar2);
				LEASH_SET_CONSTRAINT_LENGTH(&uVar2, 1,55f);
			}
		}
	}
	else if (!DECOR_CHECK_EXIST(&iParam0, "HorseLeash"))
	{
		Function_88(GRINGO_GET_MY_OBJECT_REF());
		Var3 = Function_88(GRINGO_GET_MY_OBJECT_REF());
		iVar5 = CREATE_LEASH_OBJECT(&iParam0, Function_39(), RAND_FLOAT_RANGE(1,65f, 1,75f), 10, 0, 0,006f, 10.0f, 10000.0f, 200.0f, 8.0f, 100.0f, 1.0f, 0, 0, 1);
		LEASH_ATTACH_TO_WORLD(StackVal, &iVar5, Var3, Vector(0.0f, 0.0f, 0.0f), 0);
		LEASH_ATTACH_TO_OBJECT_BONE(StackVal, StackVal, &iVar5, &iParam0, "LowLip1", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 1, 1, 0);
		DECOR_SET_OBJECT(&iParam0, "HorseLeash", &iVar5);
		LEASH_CONSTRAIN(&iVar5);
		LEASH_SET_CONSTRAINT_LENGTH(&iVar5, 1,55f);
	}
	return 1;
}

struct<8> Function_88(bool bParam0) //Position: 0x3B2E / 15150
{
	struct<2> Var0;
...
bool Function_89(int iParam0) //Position: 0x3B57 / 15191
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3B71 / 15217
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3B8C / 15244
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3BCA / 15306
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3BE3 / 15331
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3EDB / 16091
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3EF9 / 16121
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3F99 / 16281
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x3FB9 / 16313
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3FCC / 16332
{
...
void Function_99(int iParam0) //Position: 0x3FE8 / 16360
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x3FF4 / 16372
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_2[iLocal_229]), &uParam0);
		iLocal_22++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x4063 / 16483
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x407B / 16507
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x4087 / 16519
{
