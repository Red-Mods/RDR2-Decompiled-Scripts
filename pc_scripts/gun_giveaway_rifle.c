...
void main() //Position: 0x0 / 0
{
	...
	iLocal_116 = 0;
	Function_103(&uScriptParam_0, &iLocal_116);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(vLocal_6[iVar39]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_6[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", &vLocal_6[iVar39] + 24);
							Function_88(&vLocal_6[iVar39] + 24, 1);
							...
							{
								Function_81(&(vLocal_6[iVar39]), 0);
							}
							else if (vLocal_6[iVar39].f_68 < 8)
							{
								Function_80(&(vLocal_6[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_79(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	{
		iLocal_1 = 1;
		uLocal_2 = CREATE_LAYOUT("gunGiveRifle_Layout");
		uVar4 = Function_68(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1");
		Function_67(&uVar4);
		*(&Var0 + 12) = Function_67(&uVar4);
		Function_66(&uVar4);
		Var0 = Function_66(&uVar4);
		Var0.f_24 = 0;
		Function_63(&uLocal_2, 0, &Var0, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x2916 / 10518
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "GunGiveRifle", 1, 1);
	}
...
void Function_64(Vector3 vParam0, var uParam1) //Position: 0x299F / 10655
{
	var uVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&vParam0, 0, 100.0f, 0);
	return;
}

void Function_65(float fParam0, struct<25> Param1) //Position: 0x29CF / 10703
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	SET_CAMERASHOT_PERSPECTIVE(&fParam0, 1);
	SET_CAMERASHOT_FOV(&fParam0, 43,29395f);
	...
	Var0 = Vector(1,295631f, 1,604782f, 0,447745f);
	...
	Var0 = Vector(0,716617f, 0,105341f, 0,689466f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
...
struct<8> Function_66(int iParam0) //Position: 0x2A94 / 10900
{
	struct<2> Var0;
...
struct<8> Function_67(int iParam0) //Position: 0x2ABD / 10941
{
	struct<2> Var0;
...
var Function_68(var uParam0, int iParam1) //Position: 0x2AE6 / 10982
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_69(int iParam0) //Position: 0x2AF5 / 10997
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2B01 / 11009
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2B20 / 11040
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2B37 / 11063
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_73(int iParam0) //Position: 0x2BC8 / 11208
{
	struct<2> Var0;
...
struct<8> Function_74(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BEC / 11244
{
	struct<2> Var0;
...
int Function_75(int iParam0) //Position: 0x2C0B / 11275
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(var uParam0, int iParam1) //Position: 0x2C2F / 11311
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2D57 / 11607
{
...
int Function_78(var uParam0) //Position: 0x2D85 / 11653
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2E9E / 11934
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(struct<69> Param0) //Position: 0x2EAB / 11947
{
	if (Function_79(Param0.f_64, 16))
	{
...
void Function_81(struct<69> Param0) //Position: 0x2F2D / 12077
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x34D8 / 13528
{
	int iVar0;
...
int Function_83(int iParam0) //Position: 0x3512 / 13586
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_84(int iParam0, var uParam1) //Position: 0x3530 / 13616
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_85(int iParam0) //Position: 0x3571 / 13681
{
	iParam0 = &iParam0;
	return;
}

bool Function_86(int iParam0) //Position: 0x357D / 13693
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_87(var uParam0, int iParam1) //Position: 0x359F / 13727
{
	var uVar0;
	...
	if (GRINGO_COMPONENT_CHECK_NAME("Player", &iParam1))
	{
		...
		if (STRING_CONTAINS_STRING(&uVar0, "winchester"))
		{
			SET_WEAPONENUM_LOCKED(9, 0);
			GIVE_WEAPON_TO_ACTOR(&uParam0, 9, false, 1, 1);
			ACTOR_PUT_WEAPON_IN_HAND(&uParam0, 9, 0);
		}
		else if (STRING_CONTAINS_STRING(&uVar0, "rollingblock"))
		{
			SET_WEAPONENUM_LOCKED(19, 0);
			GIVE_WEAPON_TO_ACTOR(&uParam0, 19, false, 1, 1);
			ACTOR_PUT_WEAPON_IN_HAND(&uParam0, 19, 0);
		}
...
void Function_88(var uParam0, bool bParam1) //Position: 0x3643 / 13891
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_89(int iParam0, int iParam1) //Position: 0x3753 / 14163
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_90(struct<69> Param0) //Position: 0x376B / 14187
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x3A87 / 14983
{
	iParam1 = &iParam1;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", &iParam1))
	{
...
bool Function_92(int iParam0) //Position: 0x3AB5 / 15029
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_93(int iParam0) //Position: 0x3ACF / 15055
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, var uParam1) //Position: 0x3AEA / 15082
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3B28 / 15144
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_96(struct<65> Param0) //Position: 0x3B41 / 15169
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_97(int iParam0) //Position: 0x3E39 / 15929
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3E57 / 15959
{
	struct<5> Var0;
	float fVar5;
...
int Function_99(int iParam0) //Position: 0x3EF7 / 16119
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(int iParam0, var uParam1) //Position: 0x3F17 / 16151
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x3F2A / 16170
{
...
void Function_102(int iParam0) //Position: 0x3F46 / 16198
{
	iParam0 = &iParam0;
	return;
}

void Function_103(var uParam0, int iParam1) //Position: 0x3F52 / 16210
{
	int iVar0;
	var uVar1;
	...
	{
		Function_104(&(vLocal_6[iLocal_1169]), &uParam0);
		iLocal_116++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x3FBE / 16318
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_105(int iParam0) //Position: 0x3FD6 / 16342
{
	iParam0 = &iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3FE2 / 16354
{
