...
void main() //Position: 0x0 / 0
{
	...
	bVar1 = Function_12("ped_graveyard", 0);
	Function_11(&bVar1, 202, 4.0f, 0, 0);
	Function_11(&bVar1, 87, 4.0f, 0, 0);
	Function_11(&bVar1, 235, 4.0f, 0, 0);
	Function_11(&bVar1, 217, 4.0f, 0, 0);
	Function_11(&bVar1, 140, 4.0f, 0, 0);
	Function_11(&bVar1, 137, 4.0f, 0, 0);
	Function_11(&bVar1, 142, 4.0f, 0, 0);
	Function_11(&bVar1, 56, 4.0f, 0, 0);
	Function_11(&bVar1, 74, 4.0f, 0, 0);
	Function_11(&bVar1, 178, 4.0f, 0, 0);
	Function_11(&bVar1, 48, 4.0f, 0, 0);
	Function_11(&bVar1, 203, 4.0f, 0, 0);
	Function_11(&bVar1, 153, 4.0f, 0, 0);
	Function_11(&bVar1, 154, 4.0f, 0, 0);
	...
	uVar3 = FIND_NAMED_LAYOUT("BlackWater_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_streetSpawn_set");
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_sidewalk_docks_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_sidewalk_factory_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_construction_C_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_sidewalk_slums_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_sidewalk_town_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_bank_int_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 1, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("blk_pop: Cannot find blkv_bank_int_set to create population volumes");
		}
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_saloon_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_saloon_lobby_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_barnyard_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_fbi_int_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_hotel_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_hotel_lobby");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_freightStation_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "blkv_train_platform_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &bVar0, 1, 5, 0, 0, 1);
		}
...
void Function_1(var uParam0, var uParam1) //Position: 0x1344 / 4932
{
...
var Function_3(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x13AD / 5037
{
	var uVar0;
...
var Function_4(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x143D / 5181
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0x14CF / 5327
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0x14EB / 5355
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x152B / 5419
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x1548 / 5448
{
...
var Function_9(bool bParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1559 / 5465
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x15A0 / 5536
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_11(bool bParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x15AD / 5549
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, int iParam1) //Position: 0x162F / 5679
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_13(char* cParam0) //Position: 0x163E / 5694
{
	if (!Function_5(128))
	{
		return;
