...
bool Function_107(var uParam0, int iParam1) //Position: 0x4C3D / 19517
{
	...
	if (DECOR_CHECK_EXIST(&uParam0, "MoveObj_Dest"))
	{
		...
		Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_109("corngrpset") };
...
void Function_108(int iParam0, var uParam1, var uParam2) //Position: 0x4CC0 / 19648
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
struct<32> Function_109(char* cParam0) //Position: 0x4DCD / 19917
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_110(char* cParam0) //Position: 0x4E39 / 20025
{
	char* cVar0[32];
...
bool Function_111(int iParam0) //Position: 0x4E5B / 20059
{
...
void Function_112(int iParam0) //Position: 0x4E77 / 20087
{
	iParam0 = &iParam0;
	return;
}

void Function_113(var uParam0, int iParam1) //Position: 0x4E83 / 20099
{
	bool bVar0;
	var uVar1;
...
void Function_114(int iParam0, int iParam1) //Position: 0x4EEF / 20207
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_115(int iParam0) //Position: 0x4F07 / 20231
{
	iParam0 = &iParam0;
	return;
}

void Function_116(int iParam0) //Position: 0x4F13 / 20243
{
