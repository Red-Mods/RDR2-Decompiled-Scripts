				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								Function_187(&(Global_99725[2143]), 21, 0x41f00000, 0x42200000, 0);
								uLocal_361 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "zombieStayOut", 2, *(&Global_99725[2143] + 184), Vector(0.0f, Global_99725[2143].f_208, 0.0f), Vector(10.0f, 10.0f, 10.0f));
								ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_361);
								ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_361);
								iVar0 = 1;
							}
							else
							{
								uLocal_359 = CREATE_LAYOUT("RCM_Missing_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						{
							Function_186(&Global_99725[ScriptParam_043] + 228, 128);
						...
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_358)
							{
								if (StackVal && FABS((StackVal - !Function_177(&Global_54076, 1, 1))) > 2.0f)
								{
									if (Function_176(&uLocal_354, 1.0f))
									{
										if (Function_175() || DECOR_CHECK_EXIST(&Global_54076, "debugRCMMissing2"))
										{
											if (!DECOR_CHECK_EXIST(&Global_54076, "Missing3_ShutUp"))
											{
												if (GATEWAY_UPDATE(&Global_99725[ScriptParam_043] + 288))
												{
													DECOR_SET_BOOL(&Global_54076, "Missing3_ShutUp", true);
												}
											}
											if (Function_171(&Global_99725[ScriptParam_043] + 288, 0, 1, 1, 1, 0))
											{
					...
					case 0x00000003:
						if (Function_130("$/cutscene/MISSING_PERSONS_3_CS_SEQ/MISSING_PERSONS_3_CS_SEQ", &iLocal_336, 33993, 33986, 32697, 32648, 32392, 32376, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_186(&Global_99725[2143] + 228, 256);
							Global_6655 = 1;
							Global_6659 = 7;
							Function_128(1, 0, 1);
							ACTOR_ADD_WEAPON_AMMO(&Global_54076, true, 7.0f);
							_ADD_AMMO_OF_TYPE(&Global_54076, 6, 7.0f, 0, 1);
							Function_126(72, 1);
							if (!Function_125(4, 0))
							{
								Function_115(18, 4, 0, 0, 0);
							}
							else
							{
								Function_115(23, 4, 0, 0, 0);
							}
							Function_114("Missing_END", 7,5f, 0, 2, 0, 0, 0, 0);
							Function_112(407, 1, 0, 0);
							Function_58(21, 1, 1, 0);
							Function_1();
							Function_186(&Global_99725[ScriptParam_043] + 228, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_181();
...
void Function_1() //Position: 0x3BE / 958
{
	bool bVar0;
	bool bVar1;
...
void Function_2(bool bParam0) //Position: 0x3EF / 1007
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_46(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_186(&Global_99725[iVar143] + 228, 64);
...
void Function_3(struct<229> Param0) //Position: 0x5A9 / 1449
{
	float fVar0;
	int iVar1;
...
void Function_4(struct<217> Param0) //Position: 0x679 / 1657
{
	float fVar0;
	var uVar1;
...
int Function_5(var uParam0, int iParam1) //Position: 0x737 / 1847
{
	int iVar0;
	var uVar1;
...
void Function_6(int iParam0, var uParam1, struct<2> Param2) //Position: 0x8A1 / 2209
{
	struct<8> Var0;
...
struct<32> Function_7(char* cParam0) //Position: 0x949 / 2377
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_8(char* cParam0) //Position: 0x9B5 / 2485
{
	char* cVar0[32];
...
int Function_9(int iParam0) //Position: 0x9D7 / 2519
{
	int iVar0;
	struct<2> Var1;
...
float Function_10(int iParam0, struct<2> Param1) //Position: 0xB45 / 2885
{
	struct<2> Var0;
...
void Function_12(int iParam0) //Position: 0xC28 / 3112
{
...
bool Function_13(int iParam0) //Position: 0xC90 / 3216
{
...
var Function_14() //Position: 0xCA6 / 3238
{
	int iVar0;
...
void Function_15(struct<153> Param0) //Position: 0xCAF / 3247
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_21(Function_22(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_20(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_46(Global_99725[iParam143].f_228, 64))
	{
...
void Function_16(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x11C5 / 4549
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_17(int iParam0) //Position: 0x1250 / 4688
{
	char* cVar0[16];
...
bool Function_18() //Position: 0x128F / 4751
{
...
bool Function_19() //Position: 0x12AA / 4778
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(int iParam0) //Position: 0x12D7 / 4823
{
...
var Function_21(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1303 / 4867
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_22(int iParam0) //Position: 0x1324 / 4900
{
...
bool Function_23(struct<249> Param0) //Position: 0x1339 / 4921
{
	...
	{
		Function_186(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_24(struct<265> Param0) //Position: 0x1469 / 5225
{
	int iVar0;
...
bool Function_25(int iParam0) //Position: 0x15CA / 5578
{
...
bool Function_26(int iParam0) //Position: 0x15EE / 5614
{
...
bool Function_27(int iParam0) //Position: 0x1603 / 5635
{
...
var Function_28(int iParam0) //Position: 0x161A / 5658
{
...
bool Function_29(int iParam0) //Position: 0x1634 / 5684
{
...
bool Function_30(int iParam0) //Position: 0x164A / 5706
{
	return Global_116927[iParam06].f_16;
}

bool Function_31(var uParam0, int iParam1) //Position: 0x165A / 5722
{
	int iVar0;
...
bool Function_32(struct<237> Param0) //Position: 0x1677 / 5751
{
	if (!Param0.f_236)
	{
		if (Function_18())
...
bool Function_33(int iParam0) //Position: 0x1746 / 5958
{
...
void Function_34(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x17A1 / 6049
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0) //Position: 0x1816 / 6166
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(int iParam0, var uParam1, int iParam2) //Position: 0x1850 / 6224
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x18CC / 6348
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x196D / 6509
{
	int iVar0;
	int iVar1;
...
void Function_39(int iParam0, int iParam1) //Position: 0x19AA / 6570
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_40(var uParam0, int iParam1) //Position: 0x19C0 / 6592
{
...
bool Function_41(int iParam0) //Position: 0x19D3 / 6611
{
	int iVar0;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x19EF / 6639
{
	int iVar0;
...
int Function_43(int iParam0) //Position: 0x1A0C / 6668
{
...
bool Function_44(int iParam0) //Position: 0x1A21 / 6689
{
...
int Function_45(int iParam0) //Position: 0x1A36 / 6710
{
...
bool Function_46(bool bParam0, bool bParam1) //Position: 0x1A4B / 6731
{
	return (bParam0 && bParam1) == 0;
}

void Function_47() //Position: 0x1A58 / 6744
{
...
int Function_48(int iParam0, int iParam1) //Position: 0x1AD8 / 6872
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_125(6, 0) && Function_44(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if ((Function_125(9, 0) && Function_44(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
bool Function_49(char* cParam0) //Position: 0x273B / 10043
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_50(int iParam0) //Position: 0x2753 / 10067
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x27A2 / 10146
{
...
int Function_52(int iParam0) //Position: 0x27B8 / 10168
{
...
void Function_53() //Position: 0x2821 / 10273
{
...
bool Function_54(int iParam0) //Position: 0x2846 / 10310
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x2897 / 10391
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x28C4 / 10436
{
	if (!Function_51(iParam0))
	{
...
void Function_57(bool bParam0) //Position: 0x2916 / 10518
{
	int iVar0;
...
void Function_58(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2950 / 10576
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2DCA / 11722
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_60() //Position: 0x2F6B / 12139
{
	return;
}

void Function_61(bool bParam0, int iParam1) //Position: 0x2F71 / 12145
{
	if (Global_6624)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x2FB0 / 12208
{
...
void Function_63() //Position: 0x3005 / 12293
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_64() //Position: 0x3050 / 12368
{
...
void Function_65() //Position: 0x3156 / 12630
{
	float fVar0;
...
void Function_66() //Position: 0x3189 / 12681
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x331C / 13084
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x34D5 / 13525
{
	Function_69(&Global_42918, 1, 0);
	return;
}

void Function_69(struct<2317> Param0) //Position: 0x34E3 / 13539
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x3700 / 14080
{
...
struct<8> Function_71(int iParam0) //Position: 0x3715 / 14101
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x37BC / 14268
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3A58 / 14936
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_74(int iParam0) //Position: 0x4096 / 16534
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x40A7 / 16551
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x419E / 16798
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x41B9 / 16825
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x4220 / 16928
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x4232 / 16946
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4244 / 16964
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x4378 / 17272
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x4387 / 17287
{
	if (!iParam0 != 4294967295)
	{
...
var Function_83(int iParam0) //Position: 0x43C0 / 17344
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x43FD / 17405
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_85(int iParam0, bool bParam1, bool bParam2) //Position: 0x4597 / 17815
{
	int iVar0;
	int iVar1;
...
int Function_86(bool bParam0) //Position: 0x47DB / 18395
{
...
struct<8> Function_87() //Position: 0x481C / 18460
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_88() //Position: 0x48A5 / 18597
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x493C / 18748
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_90() //Position: 0x49BB / 18875
{
...
int Function_91(int iParam0, bool bParam1, int iParam2) //Position: 0x49F8 / 18936
{
	int iVar0;
	int iVar1;
...
void Function_92() //Position: 0x4C04 / 19460
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_93(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4CBB / 19643
{
	int iVar0;
...
struct<8> Function_94() //Position: 0x4DB3 / 19891
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_95(int iParam0) //Position: 0x4DBD / 19901
{
...
int Function_96(bool bParam0, bool bParam1) //Position: 0x4DD3 / 19923
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_97(struct<2> Param0, struct<2> Param2) //Position: 0x4E9F / 20127
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_98(float fParam0, int iParam1) //Position: 0x4EBC / 20156
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_99(int iParam0) //Position: 0x56E8 / 22248
{
	var uVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x5723 / 22307
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_101(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x5732 / 22322
{
	iParam0 = &iParam0;
...
void Function_102(int iParam0) //Position: 0x57E1 / 22497
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_44(4) && !Function_106(0))
	{
	...
	if (Function_44(5))
	{
		...
		if (!Function_44(8) && !Function_44(6))
		{
	...
	if (!Function_31(&Global_6667[228] + 184, 2) || ((((((Function_44(14) && Function_44(18)) && Function_44(37)) && Function_44(7)) && Function_44(11)) && Function_44(5)) && Function_44(21)))
	{
	...
	if (!Function_31(&Global_6667[328] + 184, 2) || ((Function_44(27) && Function_44(1)) && Function_44(23)))
	{
	...
	if (!Function_44(7))
	{
		...
		if (((Function_44(6) && Function_103(Global_46949) < 0) && Function_103(Global_46951) < 0) && Function_103(Global_46952) < 0)
		{
...
int Function_103(int iParam0) //Position: 0x6102 / 24834
{
	if (!Function_27(iParam0))
	{
		return 4294967295;
...
bool Function_104() //Position: 0x611C / 24860
{
	return STRING_TO_HASH(Function_105());
}

var Function_105() //Position: 0x6128 / 24872
{
	return "ZOMBIE_STORY";
}

bool Function_106(int iParam0) //Position: 0x613D / 24893
{
...
int Function_107(int iParam0) //Position: 0x61A3 / 24995
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_108(int iParam0) //Position: 0x6265 / 25189
{
...
void Function_109(bool bParam0, bool bParam1) //Position: 0x62AE / 25262
{
	bool bVar0;
...
void Function_110() //Position: 0x62D3 / 25299
{
	bool bVar0;
...
void Function_111(int iParam0) //Position: 0x6331 / 25393
{
	PRINTSTRING("Day ");
...
int Function_112(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x637B / 25467
{
	int iVar0;
	int iVar1;
...
void Function_113(bool bParam0) //Position: 0x65A3 / 26019
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6641 / 26177
{
	struct<4> Var0;
	var uVar4;
...
void Function_115(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x66D6 / 26326
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_55(bParam0, 2))
	{
		...
		if (!&bParam2)
		{
			...
			Function_16(&cVar8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = &bParam2;
	if (!Function_122(bParam0, bParam1))
	{
		...
		if (StackVal && !Function_46(((((!Function_19() && !Global_6623) && !Global_6635) && !Global_6627) && !&bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, 0, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_46((((Function_19() || Global_6623) || Global_6635) || Global_6627), 1))
		{
...
void Function_116(int iParam0, int iParam1) //Position: 0x6975 / 26997
{
	bool bVar0;
...
void Function_117(int iParam0, bool bParam1) //Position: 0x69DF / 27103
{
...
void Function_118(bool bParam0) //Position: 0x6A4E / 27214
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
...
int Function_119(int iParam0) //Position: 0x6BFE / 27646
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_120(int iParam0) //Position: 0x6C55 / 27733
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_121(bool bParam0) //Position: 0x6CAB / 27819
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122(bool bParam0, int iParam1) //Position: 0x6CB7 / 27831
{
	int iVar0;
...
void Function_123(int iParam0, int iParam1) //Position: 0x6D16 / 27926
{
	if (!Function_51(iParam0))
	{
...
bool Function_124(int iParam0) //Position: 0x6D6B / 28011
{
...
bool Function_125(int iParam0, bool bParam1) //Position: 0x6D87 / 28039
{
	int iVar0;
...
int Function_126(bool bParam0, bool bParam1) //Position: 0x6DC5 / 28101
{
	...
	if (&bParam1)
	{
		if (GET_ITEM_COUNT(Function_127(bParam0), Function_70()) >= 0)
		{
			DELETE_ITEM(Function_127(bParam0), Function_70(), 0);
			return 1;
		}
	}
	DELETE_ITEM(Function_127(bParam0), Function_70(), 1);
	return 1;
}

var Function_127(bool bParam0) //Position: 0x6E0D / 28173
{
	int iVar0;
...
int Function_128(bool bParam0, bool bParam1, int iParam2) //Position: 0x6F01 / 28417
{
...
bool Function_129(bool bParam0) //Position: 0x6F5B / 28507
{
	if (bParam0 == 4294967295)
	{
		return 0;
...
bool Function_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6F6D / 28525
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_131(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_131(var uParam0, int iParam1, struct<41> Param2) //Position: 0x7026 / 28710
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_139(&iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_139(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_137(&Global_99170, &Global_10996);
...
void Function_132(var uParam0, bool bParam1) //Position: 0x7688 / 30344
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_133() //Position: 0x7757 / 30551
{
	int iVar0;
...
void Function_134() //Position: 0x77CF / 30671
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_135() //Position: 0x7814 / 30740
{
...
void Function_136(bool bParam0) //Position: 0x7826 / 30758
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_137(var uParam0, int iParam1) //Position: 0x7843 / 30787
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar2))
		{
			...
			if ((&iVar3 == &Global_54076 && !Function_138(&iVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(&iVar3))
			{
...
bool Function_138(int iParam0) //Position: 0x78D5 / 30933
{
	bool bVar0;
...
float Function_139(vector3 vParam0) //Position: 0x7906 / 30982
{
	if (Function_141(&vParam0))
	{
		if (Function_140(&vParam0))
		{
			return vParam0.z;
		}
...
bool Function_140(int iParam0) //Position: 0x79D3 / 31187
{
	return Function_46(iParam0, 2);
}

bool Function_141(int iParam0) //Position: 0x79E1 / 31201
{
	return Function_46(iParam0, 1);
}

int Function_142(bool bParam0) //Position: 0x79EF / 31215
{
	bool bVar0;
	var uVar1;
...
bool Function_143() //Position: 0x7AB2 / 31410
{
	bool bVar0;
	var uVar1;
...
void Function_144(int iParam0) //Position: 0x7AEF / 31471
{
	Function_145(&iParam0, 0.0f);
	return;
}

void Function_145(vector3 vParam0) //Position: 0x7AFC / 31484
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_186(&vParam0, 1);
	Function_39(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_146(struct<37> Param0) //Position: 0x7B21 / 31521
{
	return Param0.f_36;
}

void Function_147(var uParam0, int iParam1) //Position: 0x7B2C / 31532
{
	Function_148(&uParam0, &iParam1, 0);
	return;
}

void Function_148(var uParam0, bool bParam1, bool bParam2) //Position: 0x7B3C / 31548
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_149(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7CB4 / 31924
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_150() //Position: 0x7CDE / 31966
{
	var uVar0;
	var uVar1;
...
void Function_151() //Position: 0x7D39 / 32057
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_152() //Position: 0x7E78 / 32376
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_153() //Position: 0x7E88 / 32392
{
...
void Function_154(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7EA4 / 32420
{
	var uVar0;
	...
	Function_132(&uParam9, &bParam10);
}

void Function_155() //Position: 0x7F73 / 32627
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_156() //Position: 0x7F88 / 32648
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2661,784f, 67,263f, 3426,978f), 293,165f, 1, 1, true);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1073741824, 0);
	return 1;
}

int Function_157() //Position: 0x7FB9 / 32697
{
	if (!iLocal_353)
	{
		Function_158(StackVal, Local_350, &uLocal_348);
		iLocal_353 = 1;
	}
	return 1;
}

void Function_158(vector3 vParam0) //Position: 0x7FD7 / 32727
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_159(int iParam0, int iParam1) //Position: 0x8182 / 33154
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_160(float fParam0, float fParam1) //Position: 0x8277 / 33399
{
...
void Function_161() //Position: 0x8388 / 33672
{
...
void Function_162() //Position: 0x83BC / 33724
{
...
int Function_163() //Position: 0x84C2 / 33986
{
	return 1;
}

int Function_164() //Position: 0x84C9 / 33993
{
	uLocal_348 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "tempcutscenevol", 2,802597E-45f, Vector(-2661,417f, 67,263f, 3429,102f), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 15.0f, 20.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_167(0, 0, 1, 1, 0, 1, 1, &uLocal_348, 1, 1, 1, 1, 0x3f800000, 0);
	Function_165(StackVal, &uLocal_359, *(&Global_99725[2143] + 196), &uLocal_348, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_165(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x856D / 34157
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_166(var uParam0, float fParam1) //Position: 0x880D / 34829
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_167(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x888F / 34959
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_170(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_14(), 2, Function_170(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_168(bool bParam0) //Position: 0x8B41 / 35649
{
	bool bVar0;
	
	if (Function_46(bParam0, 1) && Function_46(Global_39556, 1))
	{
	}
...
var Function_169() //Position: 0x8B75 / 35701
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_170(bool bParam0) //Position: 0x8C03 / 35843
{
	struct<2> Var0;
...
bool Function_171(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8C15 / 35861
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_174(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_173(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_172(vector3 vParam0) //Position: 0x8E4A / 36426
{
	var uVar0;
...
float Function_173(var uParam0, bool bParam1) //Position: 0x8EC0 / 36544
{
	struct<2> Var0;
...
void Function_174(var uParam0, bool bParam1) //Position: 0x8EE1 / 36577
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_173(&uParam0, 0) < 2.0f)
	{
...
int Function_175() //Position: 0x8F4B / 36683
{
	var uVar0;
	var uVar1;
	var uVar2;
	
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "nsearchVol", 2, (&Global_99725[2143] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(50.0f, 20.0f, 50.0f));
	uVar1 = FIND_NAMED_LAYOUT("RCM_Missing2_Layout");
	if (IS_LAYOUTREF_VALID(&uVar1))
	{
		uVar2 = FIND_ACTOR_IN_LAYOUT(&uVar1, "nmillicent");
	}
	if (IS_ACTOR_VALID(&uVar2))
	{
		if (IS_ACTOR_IN_VOLUME(&uVar2, &uVar0))
		{
...
bool Function_176(int iParam0, float fParam1) //Position: 0x8FEF / 36847
{
	if (Function_141(&iParam0))
	{
		if (Function_139(&iParam0) < fParam1)
		{
			return 1;
		}
	}
...
bool Function_177(int iParam0, bool bParam1, bool bParam2) //Position: 0x900D / 36877
{
...
bool Function_178() //Position: 0x90D1 / 37073
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_179(int iParam0) //Position: 0x90E8 / 37096
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_180(bool bParam0) //Position: 0x90F4 / 37108
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_181() //Position: 0x9103 / 37123
{
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_183(0);
	if (IS_LAYOUTREF_VALID(&uLocal_359))
...
int Function_182(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9198 / 37272
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_183(int iParam0) //Position: 0x91CA / 37322
{
	Function_185(0);
	Function_184();
	...
	if (&iParam0 == 1)
	{
		Function_39(&Global_39906 + 8, 4096);
	}
	return;
}

void Function_184() //Position: 0x920D / 37389
{
	Function_39(&Global_39906 + 8, 2);
	Function_39(&Global_39906 + 8, 4);
	Function_39(&Global_39906 + 8, 8);
	Function_39(&Global_39906 + 8, 16);
	Function_39(&Global_39906 + 8, 32);
	Function_39(&Global_39906 + 8, 64);
	Function_39(&Global_39906 + 8, 128);
	Function_39(&Global_39906 + 8, 256);
	Function_39(&Global_39906 + 8, 512);
	Function_39(&Global_39906 + 8, 1024);
	Function_39(&Global_39906 + 8, 2048);
	Function_39(&Global_39906 + 8, 131072);
	Function_39(&Global_39906 + 8, 262144);
	Function_39(&Global_39906 + 8, 524288);
	return;
}

void Function_185(int iParam0) //Position: 0x92A7 / 37543
{
	if (iParam0 == 1)
	{
		Function_186(&Global_39906 + 8, 1);
	}
	else
	{
		Function_39(&Global_39906 + 8, 1);
	}
	return;
}

void Function_186(var uParam0, int iParam1) //Position: 0x92C8 / 37576
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_187(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x92D9 / 37593
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_189(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_188(&iParam0));
							}
						}
						...
						uVar6 = Function_189(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_188(struct<257> Param0) //Position: 0x9464 / 37988
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_188(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_189(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x94A0 / 38048
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_192(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_193()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_192(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_193()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_192(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_190() //Position: 0x9708 / 38664
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_191(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_191(char* cParam0) //Position: 0x975C / 38748
{
	char* cVar0[64];
...
bool Function_192(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9885 / 39045
{
...
int Function_193() //Position: 0x9911 / 39185
{
	if (IS_PS3())
	{
		return 1;
...
void Function_194(var uParam0) //Position: 0x9920 / 39200
{
	if (!Function_141(&uParam0))
	{
		Function_145(&uParam0, 0.0f);
	}
	return;
}
