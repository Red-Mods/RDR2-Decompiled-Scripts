...
void main() //Position: 0x0 / 0
{
	...
	iLocal_325 = 0;
	bLocal_340 = false;
	Local_341 = Vector(-347,897f, 82,317f, 2427,599f);
	iLocal_344 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000005:
						if (Function_123("$/cutscene/RCM_29_CS01/RCM_29_CS01", &iLocal_326, 29678, 29650, 28347, 28233, 27824, 27787, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						...
						Function_113(&uLocal_338, &Global_99725[2143] + 320, "UseCase1", 4294967295, 1, 2);
						Function_122(&Global_99725[2143] + 228, 256);
						Function_111("Corpse1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Corpse1_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_108(406, 1, 0, 0);
						Function_104(Global_46816[7]);
						Function_4(21, 1, 1, 0);
...
float Function_30(int iParam0) //Position: 0x1E06 / 7686
{
	if (iParam0 == 4294967295)
	{
...
void Function_51(int iParam0) //Position: 0x324C / 12876
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_93(int iParam0) //Position: 0x509A / 20634
{
	int iVar0;
...
void Function_104(int iParam0) //Position: 0x53C9 / 21449
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_105(int iParam0, int iParam1) //Position: 0x54BA / 21690
{
	bool bVar0;
...
var Function_106(int iParam0) //Position: 0x5524 / 21796
{
	int iVar0;
...
void Function_107(var uParam0, int iParam1) //Position: 0x557C / 21884
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_108(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x558D / 21901
{
	int iVar0;
	int iVar1;
...
void Function_109(int iParam0) //Position: 0x57B5 / 22453
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_110(char* cParam0, bool bParam1) //Position: 0x5853 / 22611
{
	bool bVar0;
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x5878 / 22648
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_112(int iParam0) //Position: 0x590D / 22797
{
	char* cVar0[16];
...
int Function_113(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x594C / 22860
{
...
int Function_114(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x59F9 / 23033
{
	char* cVar0[32];
...
int Function_115(int iParam0) //Position: 0x5C65 / 23653
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_116(var uParam0, bool bParam1) //Position: 0x5C89 / 23689
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5CAD / 23725
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_118(var uParam0, bool bParam1) //Position: 0x5CD3 / 23763
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_119(var uParam0, bool bParam1) //Position: 0x5CFA / 23802
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_120(bool bParam0) //Position: 0x5D1E / 23838
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_121() //Position: 0x5D3D / 23869
{
...
void Function_122(var uParam0, bool bParam1) //Position: 0x5D8C / 23948
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5D9D / 23965
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_124(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5E56 / 24150
{
	if (!&bParam15)
	{
...
void Function_125(var uParam0, bool bParam1) //Position: 0x64B8 / 25784
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_126() //Position: 0x6587 / 25991
{
	int iVar0;
...
void Function_127() //Position: 0x65FF / 26111
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x6644 / 26180
{
...
void Function_129(var uParam0, int iParam1) //Position: 0x6656 / 26198
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_130(int iParam0) //Position: 0x66E8 / 26344
{
	bool bVar0;
...
float Function_131(vector3 vParam0) //Position: 0x6719 / 26393
{
...
bool Function_132(int iParam0) //Position: 0x67E6 / 26598
{
	return Function_48(iParam0, 2);
}

bool Function_133(int iParam0) //Position: 0x67F4 / 26612
{
	return Function_48(iParam0, 1);
}

int Function_134(bool bParam0) //Position: 0x6802 / 26626
{
	bool bVar0;
	var uVar1;
...
bool Function_135() //Position: 0x68C5 / 26821
{
	bool bVar0;
	var uVar1;
...
void Function_136(int iParam0) //Position: 0x6902 / 26882
{
	Function_137(&iParam0, 0.0f);
	return;
}

void Function_137(vector3 vParam0) //Position: 0x690F / 26895
{
...
bool Function_138(struct<37> Param0) //Position: 0x6934 / 26932
{
	return Param0.f_36;
}

void Function_139(var uParam0, int iParam1) //Position: 0x693F / 26943
{
	Function_140(&uParam0, &iParam1, 0);
	return;
}

void Function_140(var uParam0, bool bParam1, bool bParam2) //Position: 0x694F / 26959
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_141(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6AC7 / 27335
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_142() //Position: 0x6AF1 / 27377
{
	var uVar0;
	var uVar1;
...
void Function_143() //Position: 0x6B4C / 27468
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_144() //Position: 0x6C8B / 27787
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-355,967f, 84,359f, 2436,775f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_145() //Position: 0x6CB0 / 27824
{
	Function_147(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_146(&Global_99725[2143] + 320, 1);
	DESTROY_VOLUME(&uLocal_345);
	return 1;
}

void Function_146(var uParam0, bool bParam1) //Position: 0x6CDC / 27868
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_147(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6D65 / 28005
{
	var uVar0;
...
void Function_148() //Position: 0x6E34 / 28212
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_149() //Position: 0x6E49 / 28233
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[2143] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[2143] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-340,361f, 80,383f, 2429,866f), 113,425f, 1, 1, true);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_150() //Position: 0x6EBB / 28347
{
	if (!iLocal_344)
	{
		Function_151(StackVal, Local_341, &uLocal_345);
		Function_146(&Global_99725[2143] + 320, 0);
		iLocal_344 = 1;
	}
	return 1;
}

void Function_151(vector3 vParam0) //Position: 0x6EE9 / 28393
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_152(int iParam0, int iParam1) //Position: 0x7092 / 28818
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_153(float fParam0, float fParam1) //Position: 0x7187 / 29063
{
...
void Function_154() //Position: 0x7298 / 29336
{
...
void Function_155() //Position: 0x72CC / 29388
{
...
int Function_157() //Position: 0x73EE / 29678
{
	uLocal_345 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_347, "tempcutscenevol", 2, *(&Global_99725[2143] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_160(0, 0, 1, 1, 0, 1, 1, &uLocal_345, 1, 1, 1, 1, 0x3f800000, 0);
	Function_158(StackVal, &iLocal_347, *(&Global_99725[2143] + 196), &uLocal_345, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_158(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7467 / 29799
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_159(var uParam0, float fParam1) //Position: 0x7707 / 30471
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_160(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7789 / 30601
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_163(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_20(), 2, Function_163(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_161(int iParam0) //Position: 0x7A3B / 31291
{
	int iVar0;
...
var Function_162() //Position: 0x7A6F / 31343
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_163(int iParam0) //Position: 0x7AFD / 31485
{
	struct<2> Var0;
...
int Function_164(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7B0F / 31503
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_165(struct<257> Param0) //Position: 0x7C9A / 31898
{
...
int Function_166(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7CD6 / 31958
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_167() //Position: 0x7F3E / 32574
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_168(char* cParam0) //Position: 0x7F92 / 32658
{
	char* cVar0[64];
...
bool Function_169(var uParam0, struct<2> Param1, float fParam3) //Position: 0x80BD / 32957
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_60(&uParam0);
...
int Function_170() //Position: 0x8149 / 33097
{
	if (IS_PS3())
	{
		return 1;
...
void Function_171() //Position: 0x8158 / 33112
{
	var uVar0;
	
	Function_172(4, 1);
	uVar0 = &uVar0;
	iLocal_347 = CREATE_LAYOUT("Corpse_layout");
	return;
}

void Function_172(int iParam0, int iParam1) //Position: 0x8180 / 33152
{
	switch (&iParam1)
	{
		case 0x00000000:
