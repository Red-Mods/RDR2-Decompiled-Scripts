...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_338, Function_87(), bScriptParam_0);
				Function_47(&uLocal_406, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_338);
	Function_8(&uLocal_406);
	Function_6();
...
void Function_8(struct<4>[] Param0) //Position: 0x46D / 1133
{
	int iVar0;
...
void Function_9(var uParam0, vector3[] vParam1) //Position: 0x4D2 / 1234
{
	int iVar0;
...
void Function_10(bool bParam0, int iParam1, int iParam2) //Position: 0x52F / 1327
{
	bool bVar0;
...
void Function_11(bool bParam0, bool bParam1, bool bParam2) //Position: 0x619 / 1561
{
	int iVar0;
...
void Function_12() //Position: 0x798 / 1944
{
	Global_26174.f_20 = 0.0f;
	return;
}

void Function_13(int iParam0) //Position: 0x7A4 / 1956
{
	PRINTSTRING("Day ");
...
void Function_14(int iParam0) //Position: 0x7EE / 2030
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_15(struct<17> Param0) //Position: 0x834 / 2100
{
	int iVar0;
...
bool Function_16(struct<17> Param0) //Position: 0x851 / 2129
{
	int iVar0;
...
void Function_17() //Position: 0x86F / 2159
{
	return;
}

void Function_18() //Position: 0x875 / 2165
{
	return;
}

void Function_19() //Position: 0x87B / 2171
{
	Function_20();
	return;
}

void Function_20() //Position: 0x884 / 2180
{
...
void Function_21(int iParam0) //Position: 0x897 / 2199
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x8BF / 2239
{
...
void Function_23(struct<13> Param0) //Position: 0xA0A / 2570
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xA27 / 2599
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xA45 / 2629
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_26(int iParam0) //Position: 0xAFF / 2815
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB1B / 2843
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xB8E / 2958
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBAB / 2987
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xBB8 / 3000
{
...
void Function_31(int iParam0) //Position: 0xF1F / 3871
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0xF86 / 3974
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x12CE / 4814
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x15AE / 5550
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D04 / 7428
{
...
int Function_36(int iParam0) //Position: 0x1D19 / 7449
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D3B / 7483
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1DC4 / 7620
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1DE4 / 7652
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1E59 / 7769
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1E93 / 7827
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F0F / 7951
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x1FB0 / 8112
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x1FED / 8173
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2003 / 8195
{
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x2030 / 8240
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x2451 / 9297
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x2464 / 9316
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x2481 / 9345
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x2493 / 9363
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x251D / 9501
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x2975 / 10613
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2A66 / 10854
{
...
float Function_55(int iParam0) //Position: 0x2AA3 / 10915
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2ADC / 10972
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2B46 / 11078
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2B9E / 11166
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2DC6 / 11718
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2E64 / 11876
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x34A2 / 13474
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34AB / 13483
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x34BC / 13500
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x35B3 / 13747
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x35CE / 13774
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3635 / 13877
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3647 / 13895
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x377B / 14203
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x378A / 14218
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3924 / 14628
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3B68 / 15208
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3B75 / 15221
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3B9F / 15263
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3E52 / 15954
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3EC5 / 16069
{
...
bool Function_76(bool bParam0) //Position: 0x3EFB / 16123
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3F71 / 16241
{
...
bool Function_78() //Position: 0x3F82 / 16258
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3F9B / 16283
{
...
bool Function_80(int iParam0) //Position: 0x3FB1 / 16305
{
...
bool Function_81(int iParam0) //Position: 0x3FC6 / 16326
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3FE4 / 16356
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x4093 / 16531
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x40A6 / 16550
{
	int iVar0;
	bool bVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x4120 / 16672
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x4149 / 16713
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x4169 / 16745
{
...
void Function_88(struct<82> Param0) //Position: 0x417E / 16766
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x56B7 / 22199
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x58B4 / 22708
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5A9E / 23198
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5ECD / 24269
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x6053 / 24659
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x60AD / 24749
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x60E7 / 24807
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x611B / 24859
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x612A / 24874
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_99(int iParam0) //Position: 0x6381 / 25473
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x63D8 / 25560
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x644F / 25679
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x64BB / 25787
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x662C / 26156
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6926 / 26918
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x69B4 / 27060
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A1D / 27165
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6AAE / 27310
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6B3F / 27455
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6BD5 / 27605
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C10 / 27664
{
	bool bVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6C54 / 27732
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6D98 / 28056
{
...
void Function_113() //Position: 0x6DAA / 28074
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6DBF / 28095
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x70C7 / 28871
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x7395 / 29589
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x7459 / 29785
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x7866 / 30822
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x78B1 / 30897
{
...
void Function_120() //Position: 0x79B7 / 31159
{
	float fVar0;
...
void Function_121() //Position: 0x79EA / 31210
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7B7D / 31613
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7D36 / 32054
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7D44 / 32068
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x7F61 / 32609
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x8009 / 32777
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x82A5 / 33445
{
...
struct<8> Function_128() //Position: 0x82E6 / 33510
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x836F / 33647
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x8485 / 33925
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x84C2 / 33986
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x86CE / 34510
{
...
bool Function_134(int iParam0) //Position: 0x86E8 / 34536
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x86FE / 34558
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x876A / 34666
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x886A / 34922
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x88C2 / 35010
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8A7C / 35452
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8A9E / 35486
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8ABC / 35516
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8ACF / 35535
{
...
var Function_143(int iParam0) //Position: 0x8D1D / 36125
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8D29 / 36137
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8D3B / 36155
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8D53 / 36179
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x9169 / 37225
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x925E / 37470
{
...
bool Function_149() //Position: 0x9322 / 37666
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x9339 / 37689
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x9345 / 37701
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x9354 / 37716
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x93DF / 37855
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x941E / 37918
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x9439 / 37945
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x94CE / 38094
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x95B6 / 38326
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x9777 / 38775
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9AE1 / 39649
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9B05 / 39685
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9E24 / 40484
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA0C7 / 41159
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA120 / 41248
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA194 / 41364
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA556 / 42326
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA596 / 42390
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA5C4 / 42436
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA5D7 / 42455
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA619 / 42521
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA657 / 42583
{
	int iVar0;
...
bool Function_171() //Position: 0xA726 / 42790
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA81F / 43039
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAA81 / 43649
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAF01 / 44801
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xAF93 / 44947
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB29D / 45725
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB2D9 / 45785
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB3B7 / 46007
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB406 / 46086
{
	bool bVar0;
...
void Function_182() //Position: 0xB44B / 46155
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB499 / 46233
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB4AC / 46252
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB4D9 / 46297
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB5DA / 46554
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB631 / 46641
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB683 / 46723
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB6C2 / 46786
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB78D / 46989
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB867 / 47207
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB8C6 / 47302
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA09 / 47625
{
...
void Function_194() //Position: 0xBB8F / 48015
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBBFB / 48123
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBD3A / 48442
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBD5E / 48478
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBD6F / 48495
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBDAD / 48557
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBDC4 / 48580
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE22 / 48674
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xBF86 / 49030
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xBFC4 / 49092
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xBFD9 / 49113
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xBFF9 / 49145
{
	iParam0 = iParam0;
	return;
}

void Function_206(char* cParam0) //Position: 0xC005 / 49157
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC045 / 49221
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC135 / 49461
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC148 / 49480
{
	Function_210(0, 0.0f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC162 / 49506
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC270 / 49776
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC27E / 49790
{
...
void Function_213() //Position: 0xC29D / 49821
{
...
void Function_214(var uParam0) //Position: 0xC2B9 / 49849
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC2C3 / 49859
{
	return;
}

void Function_216(int iParam0) //Position: 0xC2C9 / 49865
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC2D3 / 49875
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC2ED / 49901
{
	int iVar0;
...
void Function_219() //Position: 0xC30A / 49930
{
	return;
}

void Function_220() //Position: 0xC310 / 49936
{
	return;
}

void Function_221(int iParam0) //Position: 0xC316 / 49942
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC320 / 49952
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC624 / 50724
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC830 / 51248
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC841 / 51265
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF28 / 53032
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF37 / 53047
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCF88 / 53128
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xCFD7 / 53207
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD00B / 53259
{
	int iVar0;
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD028 / 53288
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD0DE / 53470
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD14A / 53578
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD16C / 53612
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD172 / 53618
{
...
int Function_236(int iParam0) //Position: 0xD195 / 53653
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD1B1 / 53681
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD1B8 / 53688
{
	Function_239(&uLocal_406, &cLocal_7, "house01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "house01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "house03", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "storageShack01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "wall01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "wall01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "wall01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_406, &cLocal_7, "wall01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD2D1 / 53969
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD3D4 / 54228
{
	int iVar0;
...
void Function_241() //Position: 0xD405 / 54277
{
	Function_242(&uLocal_9, &uLocal_338, 4, &iLocal_238 + 8, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 64, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 32, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 40, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 48, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 56, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 72, 4294967295, 264);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 80, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 88, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 24, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_338, 5, &iLocal_238 + 16, 4294967295, 264);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD4CF / 54479
{
...
void Function_243(struct<5> Param0) //Position: 0xD5BC / 54716
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD5CD / 54733
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD643 / 54851
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD6E1 / 55009
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD6EA / 55018
{
	cLocal_7 = Function_248(&iLocal_178, "tesoroazul", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD708 / 55048
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD72B / 55083
{
	return Function_250();
}

int Function_250() //Position: 0xD734 / 55092
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_238 = FIND_NAMED_LAYOUT("TesoroAzul_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_238))
	{
		iLocal_238 = CREATE_LAYOUT("TesoroAzul_layout");
	}
	*(&iLocal_238 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_region", 4,203895E-45f, Vector(-3268.0f, 42,51661f, 4548.0f), Vector(0.0f, 2,059098f, 0.0f), Vector(55,6089f, 5,869164f, 40,03247f));
	*(&iLocal_238 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_slum02", 2,802597E-45f, Vector(-3270,508f, 40,5763f, 4557,929f), Vector(0.0f, 0.0f, 0.0f), Vector(4,024736f, 3,233022f, 6,71979f));
	*(&iLocal_238 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_slum01", 2,802597E-45f, Vector(-3292,831f, 40,17634f, 4563,538f), Vector(0.0f, 0.0f, 0.0f), Vector(3,839462f, 2,3492f, 7,736873f));
	*(&iLocal_238 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_house01", 2,802597E-45f, Vector(-3244,309f, 40,82811f, 4563,317f), Vector(0.0f, 0.0f, 0.0f), Vector(7,019796f, 3,41498f, 7,15522f));
	*(&iLocal_238 + 40) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_house02", 2,802597E-45f, Vector(-3241,93f, 40,27744f, 4537,018f), Vector(0.0f, 0.0f, 0.0f), Vector(8,314919f, 3,703863f, 8,652699f));
	*(&iLocal_238 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_house03", 2,802597E-45f, Vector(-3254,116f, 39,66972f, 4536,829f), Vector(0.0f, -24,26345f, 0.0f), Vector(6,501832f, 3,365815f, 6,882619f));
	*(&iLocal_238 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_house04", 2,802597E-45f, Vector(-3282,6f, 39,82164f, 4559,172f), Vector(0.0f, 33,97321f, 0.0f), Vector(7,726635f, 4,719211f, 10,56236f));
	*(&iLocal_238 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_church", 2,802597E-45f, Vector(-3258,244f, 40,40887f, 4562,516f), Vector(0.0f, 0.0f, 0.0f), Vector(9,201859f, 4,15086f, 12,08486f));
	*(&iLocal_238 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_supplyshack", 2,802597E-45f, Vector(-3272,856f, 39,96004f, 4538,217f), Vector(0.0f, 0.0f, 0.0f), Vector(9,238083f, 3,97908f, 7,864083f));
	*(&iLocal_238 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_stable01", 2,802597E-45f, Vector(-3284,762f, 39,08134f, 4533,825f), Vector(0.0f, 0.0f, 0.0f), Vector(4,904342f, 2,665865f, 9,314976f));
	*(&iLocal_238 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_stable02", 2,802597E-45f, Vector(-3292,403f, 39,41367f, 4532,225f), Vector(0.0f, 0.0f, 0.0f), Vector(2,948453f, 2,750417f, 5,629602f));
	*(&iLocal_238 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "tesv_bossVol", 2,802597E-45f, Vector(-3128f, 36,34066f, 4548.0f), Vector(0.0f, 0.0f, 0.0f), Vector(4,87413f, 2,286958f, 5,099445f));
	*(&iLocal_238 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "v_pimpOutside", 2,802597E-45f, Vector(-3254,092f, 39,67366f, 4536,965f), Vector(0.0f, -25,07307f, 0.0f), Vector(8,360954f, 5,071371f, 9,701283f));
	*(&iLocal_238 + 112) = Vector(-3257,924f, 42,344f, 4557,019f);
	*(&iLocal_238 + 112 + 12) = Vector(0.0f, 194,7308f, 0.0f);
	*(&iLocal_238 + 136) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_AreaTreasure1", Vector(-3257,924f, 42,344f, 4557,019f), Vector(0.0f, 194,7308f, 0.0f));
	*(&iLocal_238 + 144) = Vector(-3274,24f, 38,15203f, 4542,109f);
	*(&iLocal_238 + 144 + 12) = Vector(0.0f, 90,49685f, 0.0f);
	*(&iLocal_238 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_AreaTreasure2", Vector(-3274,24f, 38,15203f, 4542,109f), Vector(0.0f, 90,49685f, 0.0f));
	*(&iLocal_238 + 176) = Vector(-3294,398f, 39,13904f, 4555,536f);
	*(&iLocal_238 + 176 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_238 + 200) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_AreaTreasure3", Vector(-3294,398f, 39,13904f, 4555,536f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_238 + 208) = Vector(-3241,262f, 39,141f, 4565,932f);
	*(&iLocal_238 + 208 + 12) = Vector(0.0f, -163,7433f, 0.0f);
	*(&iLocal_238 + 232) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_AreaTreasure4", Vector(-3241,262f, 39,141f, 4565,932f), Vector(0.0f, -163,7433f, 0.0f));
	*(&iLocal_238 + 240) = Vector(-3254,024f, 38,33931f, 4536,848f);
	*(&iLocal_238 + 240 + 12) = Vector(0.0f, 133,9522f, 0.0f);
	*(&iLocal_238 + 264) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_InteriorPoint_house1", Vector(-3254,024f, 38,33931f, 4536,848f), Vector(0.0f, 133,9522f, 0.0f));
	*(&iLocal_238 + 272) = Vector(-3240,702f, 38,25601f, 4538,544f);
	*(&iLocal_238 + 272 + 12) = Vector(0.0f, 165,6702f, 0.0f);
	*(&iLocal_238 + 296) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_InteriorPoint_house2", Vector(-3240,702f, 38,25601f, 4538,544f), Vector(0.0f, 165,6702f, 0.0f));
	*(&iLocal_238 + 304) = Vector(-3242,961f, 39,28797f, 4562,563f);
	*(&iLocal_238 + 304 + 12) = Vector(0.0f, 9,727791f, 0.0f);
	*(&iLocal_238 + 328) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_InteriorPoint_house3", Vector(-3242,961f, 39,28797f, 4562,563f), Vector(0.0f, 9,727791f, 0.0f));
	*(&iLocal_238 + 336) = Vector(-3258,785f, 39,37548f, 4563,699f);
	*(&iLocal_238 + 336 + 12) = Vector(0.0f, -6,183845f, 0.0f);
	*(&iLocal_238 + 360) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_InteriorPoint_bar", Vector(-3258,785f, 39,37548f, 4563,699f), Vector(0.0f, -6,183845f, 0.0f));
	*(&iLocal_238 + 368) = Vector(-3280,955f, 39,20288f, 4560,302f);
	*(&iLocal_238 + 368 + 12) = Vector(0.0f, -81,5994f, 0.0f);
	*(&iLocal_238 + 392) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tesf_InteriorPoint_house4", Vector(-3280,955f, 39,20288f, 4560,302f), Vector(0.0f, -81,5994f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos1", Vector(-3176,95f, 39,841f, 4480,792f), Vector(2,682f, 130,244f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos2", Vector(-3276,836f, 40,798f, 4558,844f), Vector(6,243f, -70,529f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos3", Vector(-3207,126f, 39,503f, 4526,501f), Vector(-1,896f, 139,65f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos4", Vector(-3300,319f, 44,023f, 4531,8f), Vector(-13,24f, -116,789f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos5", Vector(-3259,442f, 40,455f, 4559,716f), Vector(3,449f, -52,208f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos6", Vector(-3249,643f, 42,948f, 4546,563f), Vector(-4,679f, 137,066f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos7", Vector(-3262,91f, 45,373f, 4561,198f), Vector(-9,719f, -67,889f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos8", Vector(-3281,967f, 41,09f, 4529,042f), Vector(-3,678f, -134,866f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos9", Vector(-3272,375f, 43,193f, 4561,606f), Vector(-13,737f, -24,746f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "tes_vista_cam_pos10", Vector(-3235,222f, 40,758f, 4556,214f), Vector(-6,727f, 65,79f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xE05C / 57436
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xE0A6 / 57510
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xE0B7 / 57527
{
	return;
}

bool Function_254() //Position: 0xE0BD / 57533
{
	return 1;
}

void Function_255() //Position: 0xE0C4 / 57540
{
	return;
}

bool Function_256() //Position: 0xE0CA / 57546
{
	return Function_257();
}

int Function_257() //Position: 0xE0D3 / 57555
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("TesoroAzul_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("TesoroAzul_layout");
	}
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-3258,2f, 41,98633f, 4562,297f), Vector(0.0f, 0.0f, 0.0f), Vector(9,919705f, 10,38617f, 12,14885f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-3242,425f, 41,00434f, 4538,732f), Vector(0.0f, 0.0f, 0.0f), Vector(10,29013f, 8,815486f, 11,63106f));
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-3281,507f, 42,74657f, 4559,637f), Vector(0.0f, 33,24003f, 0.0f), Vector(6,980552f, 7,836701f, 8,832067f));
	*(&iLocal_178 + 88) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-3245,43f, 41,45444f, 4540,673f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 88);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-3254,818f, 42,38426f, 4558,993f), Vector(0.0f, -60.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 88);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-3279,824f, 42,44788f, 4558,57f), Vector(0.0f, -30.0f, 0.0f));
	DECOR_SET_BOOL(&uVar3, "Core", true);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 88);
	*(&iLocal_178 + 96) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-3279,825f, 42,46805f, 4559,97f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar4, "Core", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 96);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-3279,824f, 42,44788f, 4558,57f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", true);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 96);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-3244,031f, 41,45444f, 4540,673f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 96);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-3245,43f, 41,45444f, 4540,673f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 96);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-3256,218f, 42,38426f, 4558,993f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 96);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-3254,818f, 42,38426f, 4558,993f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 96);
	*(&iLocal_178 + 104) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-3242,644f, 41,45444f, 4536,857f), Vector(0.0f, 18,00279f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 104);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-3254,818f, 42,38426f, 4558,993f), Vector(0.0f, -60.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 104);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04_core", Vector(-3245,43f, 41,45444f, 4540,673f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", true);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 104);
	*(&iLocal_178 + 112) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_player", Vector(-3241,921f, 41,45444f, 4538,257f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 112);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_surv", Vector(-3241,922f, 41,45444f, 4536,857f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 112);
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_defSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-3279,824f, 42,44788f, 4558,57f), Vector(0.0f, -30.0f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 120);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09", Vector(-3245,43f, 41,45444f, 4540,673f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 120);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-3283,861f, 42,4492f, 4557,585f), Vector(0.0f, -346,6378f, 0.0f));
	DECOR_SET_BOOL(&uVar17, "Core", true);
	DECOR_SET_INT(&uVar17, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 120);
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_player", Vector(-3282,461f, 42,4492f, 4557,586f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar18, "Core", true);
	DECOR_SET_INT(&uVar18, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 128);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_surv", Vector(-3283,861f, 42,4492f, 4557,585f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar19, "Core", true);
	DECOR_SET_INT(&uVar19, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup03_defSet", &iLocal_178, 8, 0);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def011", Vector(-3254,818f, 42,38426f, 4558,993f), Vector(0.0f, -60.0f, 0.0f));
	DECOR_SET_INT(&uVar20, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 136);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def012", Vector(-3245,43f, 41,45444f, 4540,673f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_INT(&uVar21, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 136);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def010_core", Vector(-3262,113f, 42,38028f, 4565,443f), Vector(0.0f, -263,8471f, 0.0f));
	DECOR_SET_BOOL(&uVar22, "Core", true);
	DECOR_SET_INT(&uVar22, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 136);
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("ammo_03Set", &iLocal_178, 8, 0);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_10_player", Vector(-3260,713f, 42,38028f, 4565,442f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar23, "Core", true);
	DECOR_SET_INT(&uVar23, "GiveWeapon", 40);
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 144);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_10_surv", Vector(-3262,113f, 42,38028f, 4565,443f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar24, "Core", true);
	...
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar25 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-3257,035f, 39,23201f, 4557,376f), Vector(0.0f, -245,5867f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar25, &iLocal_178 + 152);
	uVar26 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-3258,813f, 39,24109f, 4557,219f), Vector(0.0f, -129,5471f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar26, &iLocal_178 + 152);
	uVar27 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-3240,438f, 38,30056f, 4542,878f), Vector(0.0f, 180.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar27, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar28 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-3256,116f, 38,33931f, 4537,262f), Vector(0.0f, -97,06577f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar28, &iLocal_178 + 160);
	uVar29 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-3294,011f, 39,15282f, 4560,845f), Vector(0.0f, -135.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar29, &iLocal_178 + 160);
	uVar30 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_4", Vector(-3270,877f, 40,07682f, 4541,237f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar30, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = Vector(-3245,478f, 39,28797f, 4563,465f);
	*(&iLocal_178 + 168 + 12) = Vector(0.0f, -90.0f, 0.0f);
	*(&iLocal_178 + 192) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-3245,478f, 39,28797f, 4563,465f), Vector(0.0f, -90.0f, 0.0f));
	*(&iLocal_178 + 200) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand", "rand_idle_stand", Vector(-3257,035f, 39,23343f, 4557,369f), Vector(0.0f, 115,2279f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 200), 0);
	*(&iLocal_178 + 208) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(-3258,893f, 39,24036f, 4557,15f), Vector(0.0f, -129,8838f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 208), 0);
	*(&iLocal_178 + 216) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand1", "rand_idle_stand", Vector(-3240,438f, 38,30402f, 4542,866f), Vector(0.0f, 180.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 216), 0);
	*(&iLocal_178 + 224) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-3246,488f, 39,24966f, 4563,339f), Vector(0.0f, 90.0f, 0.0f));
	*(&iLocal_178 + 232) = CREATE_CAMERA_IN_LAYOUT(&iLocal_178, "bossCam", 0);
	SET_CAMERA_POSITION(StackVal, &iLocal_178 + 232, Vector(-3243,529f, 39,54105f, 4548,9f));
	SET_CAMERA_ORIENTATION(StackVal, &iLocal_178 + 232, Vector(0.0f, -94,01595f, 0.0f), 0);
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xEFFD / 61437
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xF098 / 61592
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xF1A4 / 61860
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xF280 / 62080
{
...
int Function_262(int iParam0) //Position: 0xF2FB / 62203
{
...
bool Function_263(int iParam0) //Position: 0xF310 / 62224
{
...
int Function_264(int iParam0) //Position: 0xF376 / 62326
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xF438 / 62520
{
	int iVar0;
...
void Function_266() //Position: 0xF455 / 62549
{
	SET_DUST_LEVEL(3);
	return;
}

void Function_267(char* cParam0) //Position: 0xF460 / 62560
{
	if (!Function_26(128))
	{
		return;
