...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("SolomonsFolly_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "solv_region");
...
void Function_1(var uParam0, var uParam1) //Position: 0xCA2 / 3234
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCB3 / 3251
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD0B / 3339
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD9B / 3483
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xDB7 / 3511
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDF7 / 3575
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xE14 / 3604
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE25 / 3621
{
	int iVar0;
	int iVar1;
...
var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE79 / 3705
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xEFB / 3835
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xF0A / 3850
{
	if (!Function_4(128))
	{
		return;
