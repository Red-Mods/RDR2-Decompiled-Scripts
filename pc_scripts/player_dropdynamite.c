						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_122))
								{
									...
									{
										bLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_26(var uParam0, int iParam1) //Position: 0x1FBC / 8124
{
	struct<2> Var0;
	struct<2> Var2;
	...
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	Function_27(&uParam0, &Var0);
	GET_OBJECT_ORIENTATION(GET_OBJECT_FROM_ACTOR(&uParam0), &Var2);
	if (!iLocal_0)
	{
		if (IS_OBJECT_VALID(CREATE_GRINGO_IN_LAYOUT(GET_AMBIENT_LAYOUT(), "Bury_Dynamite", "$/content/scripting/gringo/simplegringo/NPC_BuryDynamite", Var0, Var2)))
		{
			iLocal_0 = 1;
		}
	}
...
void Function_27(var uParam0, int iParam1) //Position: 0x204B / 8267
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_28(bool bParam0) //Position: 0x205A / 8282
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_29() //Position: 0x207A / 8314
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x2080 / 8320
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(char* cParam0) //Position: 0x2092 / 8338
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x209F / 8351
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x20BA / 8378
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x20DA / 8410
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x20FA / 8442
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x2131 / 8497
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2151 / 8529
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x216C / 8556
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2182 / 8578
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x24A6 / 9382
{
	int iVar0;
...
bool Function_41(char* cParam0, int iParam1) //Position: 0x24AF / 9391
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x24CE / 9422
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24DD / 9437
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(char* cParam0, int iParam1) //Position: 0x2501 / 9473
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x2527 / 9511
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2545 / 9541
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x2567 / 9575
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(bool bParam0, int iParam1) //Position: 0x2589 / 9609
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x2651 / 9809
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x26CD / 9933
{
...
void Function_51(vector3 vParam0) //Position: 0x26E5 / 9957
{
...
var Function_52(int iParam0) //Position: 0x270A / 9994
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x272B / 10027
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x2742 / 10050
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x274E / 10062
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x2755 / 10069
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x2766 / 10086
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x27AB / 10155
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x27D7 / 10199
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x27E3 / 10211
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x28E5 / 10469
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x2908 / 10504
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x2930 / 10544
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C17 / 11287
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2C74 / 11380
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2CD1 / 11473
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2CDD / 11485
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2CFC / 11516
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2D13 / 11539
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2DA4 / 11684
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DC8 / 11720
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2DE7 / 11751
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2E0B / 11787
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2F33 / 12083
{
...
int Function_75(var uParam0) //Position: 0x2F61 / 12129
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x307A / 12410
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x3087 / 12423
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x3109 / 12553
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x36B4 / 14004
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x36EE / 14062
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x370C / 14092
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x374D / 14157
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x3759 / 14169
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x377B / 14203
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3793 / 14227
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x38A3 / 14499
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x38BB / 14523
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x3BD7 / 15319
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3BE9 / 15337
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3C03 / 15363
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3C1E / 15390
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3C5C / 15452
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3C75 / 15477
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3F6D / 16237
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3F8B / 16267
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x402D / 16429
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x404D / 16461
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x4060 / 16480
{
...
void Function_99(int iParam0) //Position: 0x407C / 16508
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4088 / 16520
{
	bool bVar0;
	var uVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x40F4 / 16628
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x410C / 16652
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x4118 / 16664
{
