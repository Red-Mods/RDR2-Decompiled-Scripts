...
void main() //Position: 0x0 / 0
{
	...
	iLocal_325 = 0;
	bLocal_340 = false;
	Local_341 = Vector(777,949f, 78,365f, 1256,464f);
	iLocal_348 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000004:
						if (Function_118("$/cutscene/RCM_11_CS02/RCM_11_CS02", &iLocal_326, 29382, 29354, 28296, 28220, 27811, 27774, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						Function_117(&Global_99725[6143] + 228, 32);
						Function_108(&uLocal_338, &Global_99725[6143] + 320, "UseCase1", 4294967295, 1, 2);
						Function_107(&Global_99725[6043] + 228, 256);
						if (IS_ACTOR_VALID(&Global_99725[6043] + 312))
						{
							if (Function_106(&Global_99725[6043] + 312, &Global_54076) < 10.0f)
							{
								DESTROY_ACTOR(&Global_99725[6043] + 312);
							}
						}
						if (IS_GRINGO_VALID(&Global_99725[6043] + 320))
						{
							Function_107(&Global_99725[6043] + 228, 32);
							DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&Global_99725[6043] + 320));
						}
						Function_117(&Global_99725[6143] + 228, 256);
						Function_104("Prohibit2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Prohibit2_OBJ", 0, 3, false);
						Function_103(Global_99725[ScriptParam_043].f_224, 0);
						Function_4(61, 1, 1, 0);
						Function_117(&Global_99725[ScriptParam_043] + 228, 128);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2D5 / 725
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x307 / 775
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x324 / 804
{
	RELEASE_LAYOUT_REF(&iLocal_349);
	return;
}

void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x331 / 817
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (!Function_102())
	{
		if (!Function_101(Global_119934, 2097152))
		{
			Function_96(&Global_54076, 2097152, 1, 0);
		}
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_107(&Global_99725[iParam043] + 228, 64);
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x8C9 / 2249
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_6() //Position: 0xA6A / 2666
{
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0xA70 / 2672
{
	if (Global_6624)
	{
		return;
...
void Function_8(bool bParam0) //Position: 0xAAF / 2735
{
...
void Function_9() //Position: 0xB04 / 2820
{
	Function_37();
	Function_36();
	Function_36();
...
void Function_10() //Position: 0xB4F / 2895
{
...
void Function_11() //Position: 0xC55 / 3157
{
	float fVar0;
...
void Function_12() //Position: 0xC88 / 3208
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0xE1B / 3611
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0xFD4 / 4052
{
	Function_15(&Global_42918, 1, 0);
	return;
}

void Function_15(struct<2317> Param0) //Position: 0xFE2 / 4066
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_16() //Position: 0x11FF / 4607
{
...
struct<8> Function_17(int iParam0) //Position: 0x1214 / 4628
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_18(int iParam0, bool bParam1, bool bParam2) //Position: 0x12BB / 4795
{
	int iVar0;
...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1557 / 5463
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_20() //Position: 0x1B95 / 7061
{
	int iVar0;
...
var Function_21(int iParam0) //Position: 0x1B9E / 7070
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_22(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1BAF / 7087
{
	char* cVar0[32];
...
struct<32> Function_23(char* cParam0) //Position: 0x1CA6 / 7334
{
	char* cVar0[32];
...
void Function_24(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1CC1 / 7361
{
	float fVar0;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1D28 / 7464
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_26(int iParam0, bool bParam1) //Position: 0x1D3A / 7482
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_27(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1D4C / 7500
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_28(int iParam0) //Position: 0x1E80 / 7808
{
	return Global_55480[iParam016].f_96;
}

float Function_29(int iParam0) //Position: 0x1E8F / 7823
{
	if (!iParam0 != 4294967295)
	{
...
var Function_30(int iParam0) //Position: 0x1EC8 / 7880
{
	if (iParam0 == 4294967295)
	{
...
void Function_31(int iParam0) //Position: 0x1F05 / 7941
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_32(int iParam0, bool bParam1, bool bParam2) //Position: 0x209F / 8351
{
	int iVar0;
	int iVar1;
...
int Function_33(bool bParam0) //Position: 0x22E3 / 8931
{
...
struct<8> Function_34() //Position: 0x2324 / 8996
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x23AD / 9133
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x2444 / 9284
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_37() //Position: 0x24C3 / 9411
{
...
int Function_38(int iParam0, bool bParam1, int iParam2) //Position: 0x2500 / 9472
{
	int iVar0;
	int iVar1;
...
void Function_39() //Position: 0x270C / 9996
{
	struct<2> Var0;
	var uVar2;
...
bool Function_40(char* cParam0) //Position: 0x27C3 / 10179
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_41(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x27DB / 10203
{
	int iVar0;
...
struct<8> Function_42() //Position: 0x28D3 / 10451
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_43(int iParam0) //Position: 0x28DD / 10461
{
...
int Function_44(bool bParam0, bool bParam1) //Position: 0x28F3 / 10483
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_45(struct<2> Param0, struct<2> Param2) //Position: 0x29BF / 10687
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_46(float fParam0, int iParam1) //Position: 0x29DC / 10716
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_47(int iParam0) //Position: 0x3208 / 12808
{
	var uVar0;
...
bool Function_48(var uParam0, int iParam1) //Position: 0x3243 / 12867
{
	return (uParam0 && iParam1) == 0;
}

void Function_49(var uParam0, int iParam1) //Position: 0x3250 / 12880
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x325F / 12895
{
	uParam0 = &uParam0;
...
void Function_51(bool bParam0) //Position: 0x330E / 13070
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_48(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_117(&Global_99725[iVar143] + 228, 64);
...
void Function_52(struct<229> Param0) //Position: 0x34C8 / 13512
{
	float fVar0;
	int iVar1;
...
void Function_53(struct<217> Param0) //Position: 0x3598 / 13720
{
	float fVar0;
	var uVar1;
...
int Function_54(var uParam0, int iParam1) //Position: 0x3656 / 13910
{
	int iVar0;
	var uVar1;
...
void Function_55(int iParam0, var uParam1, struct<2> Param2) //Position: 0x37C0 / 14272
{
	struct<8> Var0;
...
struct<32> Function_56(char* cParam0) //Position: 0x3868 / 14440
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_57(char* cParam0) //Position: 0x38D4 / 14548
{
	char* cVar0[32];
...
int Function_58(int iParam0) //Position: 0x38F6 / 14582
{
	int iVar0;
	struct<2> Var1;
...
float Function_59(int iParam0, struct<2> Param1) //Position: 0x3A64 / 14948
{
	struct<2> Var0;
...
struct<8> Function_60(int iParam0) //Position: 0x3ADB / 15067
{
	struct<2> Var0;
...
void Function_61(int iParam0) //Position: 0x3B47 / 15175
{
...
bool Function_62(int iParam0) //Position: 0x3BAF / 15279
{
...
void Function_63(struct<153> Param0) //Position: 0x3BC5 / 15301
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_64(int iParam0) //Position: 0x3D34 / 15668
{
...
var Function_65(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3D60 / 15712
{
...
bool Function_67(struct<249> Param0) //Position: 0x3D96 / 15766
{
	...
	{
		Function_117(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_68(struct<265> Param0) //Position: 0x3EC6 / 16070
{
	int iVar0;
...
bool Function_69(int iParam0) //Position: 0x4029 / 16425
{
...
bool Function_70(int iParam0) //Position: 0x404D / 16461
{
...
bool Function_71(int iParam0) //Position: 0x4062 / 16482
{
...
var Function_72(int iParam0) //Position: 0x4079 / 16505
{
...
bool Function_73(int iParam0) //Position: 0x4093 / 16531
{
...
bool Function_74(int iParam0) //Position: 0x40A9 / 16553
{
	return Global_116927[iParam06].f_16;
}

bool Function_75(var uParam0, int iParam1) //Position: 0x40B9 / 16569
{
	int iVar0;
...
bool Function_76(struct<237> Param0) //Position: 0x40D6 / 16598
{
	if (!Param0.f_236)
	{
		if (Function_102())
...
bool Function_77(int iParam0) //Position: 0x41A5 / 16805
{
	...
	if (!Function_48(Global_99725[iParam043].f_228, 32768))
	{
		...
		{
			if (!Function_101(Global_119935, 0x8000000))
			{
				Function_96(&Global_54076, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
bool Function_78(int iParam0) //Position: 0x4200 / 16896
{
	int iVar0;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x421C / 16924
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x4239 / 16953
{
...
bool Function_81(int iParam0) //Position: 0x424E / 16974
{
...
int Function_82(int iParam0) //Position: 0x4263 / 16995
{
...
void Function_83() //Position: 0x4278 / 17016
{
...
int Function_84(int iParam0, int iParam1) //Position: 0x42F8 / 17144
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_85(int iParam0, bool bParam1) //Position: 0x4F5B / 20315
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x4F99 / 20377
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x4FE8 / 20456
{
...
int Function_88(int iParam0) //Position: 0x4FFE / 20478
{
...
void Function_89() //Position: 0x5067 / 20583
{
...
bool Function_90(int iParam0) //Position: 0x508C / 20620
{
	if (!Function_87(iParam0))
	{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x50DD / 20701
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x510A / 20746
{
	if (!Function_87(iParam0))
	{
...
void Function_93(bool bParam0) //Position: 0x515C / 20828
{
	int iVar0;
...
void Function_94() //Position: 0x5196 / 20886
{
	bool bVar0;
...
void Function_95(int iParam0) //Position: 0x51F4 / 20980
{
	PRINTSTRING("Day ");
...
void Function_96(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x523E / 21054
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_98(&uParam0, iParam1, &iParam2) && !&bParam3)
	{
		return;
	}
...
void Function_97(char* cParam0) //Position: 0x52B3 / 21171
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_98(int iParam0, var uParam1, int iParam2) //Position: 0x52ED / 21229
{
	var uVar0;
	char* cVar1[16];
	...
	{
		if (Function_100(DECOR_GET_INT(&iParam0, &cVar1)) > 3)
		{
			return 0;
		}
	}
	...
	if (&iParam2 == 2)
	{
		...
		{
			case 0x00000002:
				if (!Function_101(Global_119935, 1577004))
				{
					return 0;
				}
				break;
...
int Function_99(char* cParam0) //Position: 0x5369 / 21353
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_100(int iParam0) //Position: 0x540A / 21514
{
	int iVar0;
	int iVar1;
...
bool Function_101(int iParam0, int iParam1) //Position: 0x5447 / 21575
{
...
bool Function_102() //Position: 0x545A / 21594
{
...
void Function_103(bool bParam0, bool bParam1) //Position: 0x5475 / 21621
{
	bool bVar0;
...
void Function_104(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x549A / 21658
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_105(int iParam0) //Position: 0x552F / 21807
{
	char* cVar0[16];
...
float Function_106(int iParam0, int iParam1) //Position: 0x556E / 21870
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_107(int iParam0, bool bParam1) //Position: 0x5663 / 22115
{
	iParam0 = (iParam0 - (iParam0 && bParam1));
	return;
}

int Function_108(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x5679 / 22137
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		Function_109(&uParam0, 5, GET_OBJECT_FROM_GRINGO(&uParam1), &uParam4, 1);
	}
	else
	{
		return 0;
...
int Function_109(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x5726 / 22310
{
	char* cVar0[32];
	...
	Function_114(&uParam0, 0);
	Function_113(&uParam0, uParam1);
	Function_112(&uParam0, &uParam2);
	Function_111(&uParam0, uParam3);
	if (Function_110(&uParam0) != 5)
	{
...
int Function_110(int iParam0) //Position: 0x5992 / 22930
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_111(var uParam0, bool bParam1) //Position: 0x59B6 / 22966
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_112(var uParam0, int iParam1) //Position: 0x59DA / 23002
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_113(var uParam0, bool bParam1) //Position: 0x5A00 / 23040
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_114(var uParam0, bool bParam1) //Position: 0x5A27 / 23079
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_115(bool bParam0) //Position: 0x5A4B / 23115
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_116() //Position: 0x5A6A / 23146
{
...
void Function_117(var uParam0, bool bParam1) //Position: 0x5AB9 / 23225
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_118(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5ACA / 23242
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_119(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5B83 / 23427
{
	if (!&bParam15)
	{
...
void Function_120(var uParam0, bool bParam1) //Position: 0x61E5 / 25061
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_121() //Position: 0x62B4 / 25268
{
	int iVar0;
...
void Function_122() //Position: 0x632C / 25388
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_123() //Position: 0x6371 / 25457
{
...
void Function_124(var uParam0, int iParam1) //Position: 0x6383 / 25475
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_125(int iParam0) //Position: 0x6415 / 25621
{
	bool bVar0;
...
float Function_126(vector3 vParam0) //Position: 0x6446 / 25670
{
...
bool Function_127(int iParam0) //Position: 0x6513 / 25875
{
	return Function_48(iParam0, 2);
}

bool Function_128(int iParam0) //Position: 0x6521 / 25889
{
	return Function_48(iParam0, 1);
}

int Function_129(bool bParam0) //Position: 0x652F / 25903
{
	bool bVar0;
	var uVar1;
...
bool Function_130() //Position: 0x65F2 / 26098
{
	bool bVar0;
	var uVar1;
...
void Function_131(int iParam0) //Position: 0x662F / 26159
{
	Function_132(&iParam0, 0.0f);
	return;
}

void Function_132(vector3 vParam0) //Position: 0x663C / 26172
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_117(&vParam0, 1);
	Function_107(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_133(struct<37> Param0) //Position: 0x6661 / 26209
{
	return Param0.f_36;
}

void Function_134(var uParam0, int iParam1) //Position: 0x666C / 26220
{
	Function_135(&uParam0, &iParam1, 0);
	return;
}

void Function_135(var uParam0, bool bParam1, int iParam2) //Position: 0x667C / 26236
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_136(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x67F4 / 26612
{
	int iVar0;
	int iVar1;
...
void Function_137(bool bParam0) //Position: 0x6A1C / 27164
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_138(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6ABA / 27322
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_139() //Position: 0x6AE4 / 27364
{
	var uVar0;
	var uVar1;
...
void Function_140() //Position: 0x6B3F / 27455
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_141() //Position: 0x6C7E / 27774
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(787,566f, 78,306f, 1277,961f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_142() //Position: 0x6CA3 / 27811
{
	Function_144(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_143(&Global_99725[6143] + 320, 1);
	DESTROY_VOLUME(&uLocal_346);
	return 1;
}

void Function_143(var uParam0, bool bParam1) //Position: 0x6CCF / 27855
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6D58 / 27992
{
	var uVar0;
...
void Function_145() //Position: 0x6E27 / 28199
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_146() //Position: 0x6E3C / 28220
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[6143] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[6143] + 320, "UseCase1", 4294967295, 1);
	return 1;
}

int Function_147() //Position: 0x6E88 / 28296
{
	if (!iLocal_348)
	{
		Function_148(StackVal, Local_341, &uLocal_346);
		Function_143(&Global_99725[6143] + 320, 0);
		iLocal_348 = 1;
	}
	return 1;
}

void Function_148(vector3 vParam0) //Position: 0x6EB6 / 28342
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_40(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_106(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_106(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_106(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
void Function_149(float fParam0, float fParam1) //Position: 0x705F / 28767
{
...
void Function_150() //Position: 0x7170 / 29040
{
...
void Function_151() //Position: 0x71A4 / 29092
{
...
int Function_152() //Position: 0x72AA / 29354
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(787,566f, 78,306f, 1277,961f), 0, 0);
	return 1;
}

int Function_153() //Position: 0x72C6 / 29382
{
	uLocal_346 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_349, "tempcutscenevol", 2, *(&Global_99725[6143] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_156(0, 0, 1, 1, 0, 1, 1, &uLocal_346, 1, 1, 1, 1, 0x3f800000, 0);
	Function_154(StackVal, &iLocal_349, *(&Global_99725[6143] + 196), &uLocal_346, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_154(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x733F / 29503
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_155(var uParam0, float fParam1) //Position: 0x75DF / 30175
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_156(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7661 / 30305
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_157(int iParam0) //Position: 0x7913 / 30995
{
	int iVar0;
...
var Function_158() //Position: 0x7947 / 31047
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_159(int iParam0) //Position: 0x79D5 / 31189
{
	struct<2> Var0;
...
int Function_160(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x79E7 / 31207
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_161(struct<257> Param0) //Position: 0x7B72 / 31602
{
...
int Function_162(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7BAE / 31662
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_163() //Position: 0x7E16 / 32278
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_164(char* cParam0) //Position: 0x7E6A / 32362
{
	char* cVar0[64];
...
bool Function_165(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7F93 / 32659
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_60(&uParam0);
...
int Function_166() //Position: 0x8064 / 32868
{
	if (IS_PS3())
	{
		return 1;
...
void Function_167() //Position: 0x8073 / 32883
{
	var uVar0;
...
void Function_168(int iParam0, int iParam1) //Position: 0x80A3 / 32931
{
	switch (&iParam1)
	{
		case 0x00000000:
