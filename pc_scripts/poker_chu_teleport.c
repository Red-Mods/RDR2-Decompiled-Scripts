...
void main() //Position: 0x0 / 0
{
	...
	SET_TIME_OF_DAY(MAKE_TIME_OF_DAY(15, false, 0));
	Var0 = Vector(-2698,61f, 31,151f, 4274,159f);
	bVar2 = 135,96f;
	CAMERA_RESET(0);
	...
	CAMERA_RESET(0);
	Function_4(1, 0, 1);
	while ((!Function_1(Global_46866[0]) || !STREAMING_IS_WORLD_LOADED()) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	if (HUD_IS_FADED())
