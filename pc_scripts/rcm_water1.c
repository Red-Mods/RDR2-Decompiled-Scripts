...
void main() //Position: 0x0 / 0
{
	...
	iLocal_341 = 0;
	fLocal_344 = 120.0f;
	Local_345 = Vector(-1475,717f, 80,085f, 2797,74f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Global_38378 = (GET_CURRENT_GAME_TIME() + fLocal_344);
						Function_160(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 5;
						break;
					
					case 0x00000005:
						if (Function_119("$/cutscene/RCM_03_CS01/RCM_03_CS01", &iLocal_326, 29193, 29186, 27883, 27769, 27360, 27344, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						...
						Function_109(&uLocal_338, &Global_99725[6843] + 320, "UseCase1", 4294967295, 1, 2);
						Function_118(&Global_99725[6843] + 228, 256);
						Function_107("Water1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Water1_OBJ", 0, 3, false);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x21A / 538
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x24C / 588
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x269 / 617
{
	RELEASE_LAYOUT_REF(&iLocal_348);
	return;
}

void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x276 / 630
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x80E / 2062
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_6() //Position: 0x9AF / 2479
{
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0x9B5 / 2485
{
	if (Global_6624)
	{
		return;
...
void Function_9() //Position: 0xA49 / 2633
{
	Function_37();
	Function_36();
	Function_36();
...
void Function_10() //Position: 0xA94 / 2708
{
...
void Function_11() //Position: 0xB9A / 2970
{
	float fVar0;
...
void Function_12() //Position: 0xBCD / 3021
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0xD60 / 3424
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0xF19 / 3865
{
	Function_15(&Global_42918, 1, 0);
	return;
}

void Function_15(struct<2317> Param0) //Position: 0xF27 / 3879
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_16() //Position: 0x1144 / 4420
{
...
struct<8> Function_17(int iParam0) //Position: 0x1159 / 4441
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_18(int iParam0, bool bParam1, bool bParam2) //Position: 0x1200 / 4608
{
	int iVar0;
...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x149C / 5276
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_20() //Position: 0x1ADA / 6874
{
	int iVar0;
...
var Function_21(int iParam0) //Position: 0x1AE3 / 6883
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_22(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1AF4 / 6900
{
	char* cVar0[32];
...
struct<32> Function_23(char* cParam0) //Position: 0x1BEB / 7147
{
	char* cVar0[32];
...
void Function_24(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1C06 / 7174
{
	float fVar0;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1C6D / 7277
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_26(int iParam0, bool bParam1) //Position: 0x1C7F / 7295
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_27(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C91 / 7313
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_28(int iParam0) //Position: 0x1DC5 / 7621
{
	return Global_55480[iParam016].f_96;
}

float Function_29(int iParam0) //Position: 0x1DD4 / 7636
{
	if (!iParam0 != 4294967295)
	{
...
var Function_30(int iParam0) //Position: 0x1E0D / 7693
{
	if (iParam0 == 4294967295)
	{
...
void Function_31(int iParam0) //Position: 0x1E4A / 7754
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_32(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FE4 / 8164
{
	int iVar0;
	int iVar1;
...
int Function_33(bool bParam0) //Position: 0x2228 / 8744
{
...
struct<8> Function_34() //Position: 0x2269 / 8809
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x2389 / 9097
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_37() //Position: 0x2408 / 9224
{
...
int Function_38(int iParam0, bool bParam1, int iParam2) //Position: 0x2445 / 9285
{
	int iVar0;
	int iVar1;
...
void Function_39() //Position: 0x2651 / 9809
{
	struct<2> Var0;
	var uVar2;
...
bool Function_40(char* cParam0) //Position: 0x2708 / 9992
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_41(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2720 / 10016
{
	int iVar0;
...
struct<8> Function_42() //Position: 0x2818 / 10264
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_43(int iParam0) //Position: 0x2822 / 10274
{
...
int Function_44(bool bParam0, bool bParam1) //Position: 0x2838 / 10296
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_45(struct<2> Param0, struct<2> Param2) //Position: 0x2904 / 10500
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_46(float fParam0, int iParam1) //Position: 0x2921 / 10529
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_47(int iParam0) //Position: 0x314D / 12621
{
	var uVar0;
...
bool Function_48(var uParam0, int iParam1) //Position: 0x3188 / 12680
{
	return (uParam0 && iParam1) == 0;
}

void Function_49(var uParam0, int iParam1) //Position: 0x3195 / 12693
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x31A4 / 12708
{
	uParam0 = &uParam0;
...
void Function_51(bool bParam0) //Position: 0x3253 / 12883
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_52(struct<229> Param0) //Position: 0x340D / 13325
{
	float fVar0;
	int iVar1;
...
void Function_53(struct<217> Param0) //Position: 0x34DD / 13533
{
	float fVar0;
	var uVar1;
...
int Function_54(var uParam0, int iParam1) //Position: 0x359B / 13723
{
	int iVar0;
	var uVar1;
...
void Function_55(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3705 / 14085
{
	struct<8> Var0;
...
struct<32> Function_56(char* cParam0) //Position: 0x37AD / 14253
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_57(char* cParam0) //Position: 0x3819 / 14361
{
	char* cVar0[32];
...
int Function_58(int iParam0) //Position: 0x383B / 14395
{
	int iVar0;
	struct<2> Var1;
...
float Function_59(int iParam0, struct<2> Param1) //Position: 0x39A9 / 14761
{
	struct<2> Var0;
...
struct<8> Function_60(int iParam0) //Position: 0x3A20 / 14880
{
	struct<2> Var0;
...
void Function_61(int iParam0) //Position: 0x3A8C / 14988
{
...
bool Function_62(int iParam0) //Position: 0x3AF4 / 15092
{
...
void Function_63(struct<153> Param0) //Position: 0x3B0A / 15114
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_64(int iParam0) //Position: 0x3C79 / 15481
{
...
var Function_65(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3CA5 / 15525
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_66(int iParam0) //Position: 0x3CC6 / 15558
{
...
bool Function_67(struct<249> Param0) //Position: 0x3CDB / 15579
{
...
bool Function_68(struct<265> Param0) //Position: 0x3E0B / 15883
{
	int iVar0;
...
bool Function_69(int iParam0) //Position: 0x3F6C / 16236
{
...
bool Function_70(int iParam0) //Position: 0x3F90 / 16272
{
...
bool Function_71(int iParam0) //Position: 0x3FA5 / 16293
{
...
var Function_72(int iParam0) //Position: 0x3FBC / 16316
{
...
bool Function_73(int iParam0) //Position: 0x3FD6 / 16342
{
...
bool Function_74(int iParam0) //Position: 0x3FEC / 16364
{
	return Global_116927[iParam06].f_16;
}

bool Function_75(var uParam0, int iParam1) //Position: 0x4000 / 16384
{
	int iVar0;
...
bool Function_76(struct<237> Param0) //Position: 0x401D / 16413
{
	if (!Param0.f_236)
	{
		if (Function_103())
...
bool Function_77(int iParam0) //Position: 0x40EC / 16620
{
...
bool Function_78(int iParam0) //Position: 0x4147 / 16711
{
	int iVar0;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x4163 / 16739
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x4180 / 16768
{
...
bool Function_81(int iParam0) //Position: 0x4195 / 16789
{
...
int Function_82(int iParam0) //Position: 0x41AA / 16810
{
...
void Function_83() //Position: 0x41BF / 16831
{
...
int Function_84(int iParam0, int iParam1) //Position: 0x423F / 16959
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_85(int iParam0, bool bParam1) //Position: 0x4EA2 / 20130
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x4EE0 / 20192
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x4F2F / 20271
{
...
int Function_88(int iParam0) //Position: 0x4F45 / 20293
{
...
void Function_89() //Position: 0x4FAE / 20398
{
...
bool Function_90(int iParam0) //Position: 0x4FD3 / 20435
{
	if (!Function_87(iParam0))
	{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x5024 / 20516
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x5051 / 20561
{
	if (!Function_87(iParam0))
	{
...
void Function_93(bool bParam0) //Position: 0x50A3 / 20643
{
	int iVar0;
...
void Function_94() //Position: 0x50DD / 20701
{
	bool bVar0;
...
void Function_95(int iParam0, int iParam1) //Position: 0x513B / 20795
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_96(int iParam0) //Position: 0x5151 / 20817
{
	PRINTSTRING("Day ");
...
void Function_97(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x519B / 20891
{
	bool bVar0;
	char* cVar1[16];
...
void Function_98(char* cParam0) //Position: 0x5210 / 21008
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_99(int iParam0, var uParam1, int iParam2) //Position: 0x524A / 21066
{
	var uVar0;
	char* cVar1[16];
...
int Function_100(char* cParam0) //Position: 0x52C6 / 21190
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_101(int iParam0) //Position: 0x5367 / 21351
{
	int iVar0;
	int iVar1;
...
bool Function_102(int iParam0, int iParam1) //Position: 0x53A4 / 21412
{
...
bool Function_103() //Position: 0x53B7 / 21431
{
...
int Function_104(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x53D2 / 21458
{
	int iVar0;
	int iVar1;
...
void Function_105(int iParam0) //Position: 0x55FA / 22010
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_106(bool bParam0, bool bParam1) //Position: 0x5698 / 22168
{
	bool bVar0;
...
void Function_107(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x56BD / 22205
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_108(int iParam0) //Position: 0x5752 / 22354
{
	char* cVar0[16];
...
int Function_109(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x5791 / 22417
{
...
int Function_110(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x583E / 22590
{
	char* cVar0[32];
...
int Function_111(int iParam0) //Position: 0x5AAA / 23210
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_112(var uParam0, bool bParam1) //Position: 0x5ACE / 23246
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_113(var uParam0, int iParam1) //Position: 0x5AF2 / 23282
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_114(var uParam0, bool bParam1) //Position: 0x5B18 / 23320
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_115(var uParam0, bool bParam1) //Position: 0x5B3F / 23359
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_116(bool bParam0) //Position: 0x5B63 / 23395
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_117() //Position: 0x5B82 / 23426
{
...
void Function_118(var uParam0, bool bParam1) //Position: 0x5BD1 / 23505
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_119(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5BE2 / 23522
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_120(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5C9B / 23707
{
	if (!&bParam15)
	{
...
void Function_121(var uParam0, bool bParam1) //Position: 0x62FD / 25341
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_122() //Position: 0x63CC / 25548
{
	int iVar0;
...
void Function_123() //Position: 0x6444 / 25668
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_124() //Position: 0x6489 / 25737
{
...
void Function_125(var uParam0, int iParam1) //Position: 0x649B / 25755
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_126(int iParam0) //Position: 0x652D / 25901
{
	bool bVar0;
...
float Function_127(vector3 vParam0) //Position: 0x655E / 25950
{
...
bool Function_128(int iParam0) //Position: 0x662B / 26155
{
	return Function_48(iParam0, 2);
}

bool Function_129(int iParam0) //Position: 0x6639 / 26169
{
	return Function_48(iParam0, 1);
}

int Function_130(bool bParam0) //Position: 0x6647 / 26183
{
	bool bVar0;
	var uVar1;
...
bool Function_131() //Position: 0x670A / 26378
{
	bool bVar0;
	var uVar1;
...
void Function_132(int iParam0) //Position: 0x6747 / 26439
{
	Function_133(&iParam0, 0.0f);
	return;
}

void Function_133(vector3 vParam0) //Position: 0x6754 / 26452
{
...
bool Function_134(struct<37> Param0) //Position: 0x6779 / 26489
{
	return Param0.f_36;
}

void Function_135(var uParam0, int iParam1) //Position: 0x6784 / 26500
{
	Function_136(&uParam0, &iParam1, 0);
	return;
}

void Function_136(var uParam0, bool bParam1, bool bParam2) //Position: 0x6794 / 26516
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_137(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x690C / 26892
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_138() //Position: 0x6936 / 26934
{
	var uVar0;
	var uVar1;
...
void Function_139() //Position: 0x6991 / 27025
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_140() //Position: 0x6AD0 / 27344
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_141() //Position: 0x6AE0 / 27360
{
	Function_143(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_142(&Global_99725[6843] + 320, 1);
	DESTROY_VOLUME(&uLocal_342);
	return 1;
}

void Function_142(var uParam0, bool bParam1) //Position: 0x6B0C / 27404
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_143(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6B95 / 27541
{
	var uVar0;
...
void Function_144() //Position: 0x6C64 / 27748
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_145() //Position: 0x6C79 / 27769
{
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[6843] + 320, "UseCase1", 4294967295, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[6843] + 320), "UseCase1", true, 0, 0);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-1481,249f, 80,184f, 2790,808f), 212,707f, 1, 1, true);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 2.0f, 1);
	return 1;
}

int Function_146() //Position: 0x6CEB / 27883
{
	if (!iLocal_341)
	{
		Function_147(StackVal, Local_345, &uLocal_342);
		Function_142(&Global_99725[6843] + 320, 0);
		iLocal_341 = 1;
	}
	return 1;
}

void Function_147(vector3 vParam0) //Position: 0x6D19 / 27929
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_148(int iParam0, int iParam1) //Position: 0x6EC2 / 28354
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_149(float fParam0, float fParam1) //Position: 0x6FB7 / 28599
{
...
void Function_150() //Position: 0x70C8 / 28872
{
...
void Function_151() //Position: 0x70FC / 28924
{
...
int Function_152() //Position: 0x7202 / 29186
{
	return 1;
}

int Function_153() //Position: 0x7209 / 29193
{
	uLocal_342 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_348, "tempcutscenevol", 2, *(&Global_99725[6843] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_156(0, 0, 1, 1, 0, 1, 1, &uLocal_342, 1, 1, 1, 1, 0x3f800000, 0);
	Function_154(StackVal, &iLocal_348, *(&Global_99725[6843] + 196), &uLocal_342, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_154(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7282 / 29314
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_155(var uParam0, float fParam1) //Position: 0x7522 / 29986
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_156(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x75A4 / 30116
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_157(int iParam0) //Position: 0x7856 / 30806
{
	int iVar0;
...
var Function_158() //Position: 0x788A / 30858
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_159(int iParam0) //Position: 0x7918 / 31000
{
	struct<2> Var0;
...
int Function_160(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x792A / 31018
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_161(struct<257> Param0) //Position: 0x7AB5 / 31413
{
...
int Function_162(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7AF1 / 31473
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_163() //Position: 0x7D59 / 32089
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_164(char* cParam0) //Position: 0x7DAD / 32173
{
	char* cVar0[64];
...
bool Function_165(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7ED6 / 32470
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_60(&uParam0);
...
int Function_166() //Position: 0x7F62 / 32610
{
	if (IS_PS3())
	{
		return 1;
...
void Function_167() //Position: 0x7F71 / 32625
{
	var uVar0;
	
	Function_168(4, 1);
	uVar0 = &uVar0;
	iLocal_348 = CREATE_LAYOUT("Water_layout");
	return;
}

void Function_168(int iParam0, int iParam1) //Position: 0x7F98 / 32664
{
	switch (&iParam1)
	{
		case 0x00000000:
