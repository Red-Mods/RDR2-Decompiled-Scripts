...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(1, &uLocal_13, &uLocal_15, &uLocal_3, &uLocal_21, 4294967295);
	return;
}
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_25 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_144(&Param0 + 324, &fLocal_27, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_133(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_27, 20.0f, fLocal_27));
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3460 / 13408
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
{
	Function_97(&uLocal_3, "p_gen_coffinCorpse02x", 0, 0);
	Function_97(&uLocal_3, "$/content/scripting/gringo/simplegringo/mex_pickGarbage", 1, 0);
	if (Function_81(&uLocal_13, &uLocal_3, 14, 1, 1, 1, 0, 0, 0, 0, 0) && Function_79(Global_46796[0]))
	{
		if (!IS_LAYOUTREF_VALID(&uLocal_21))
		{
			uLocal_21 = CREATE_LAYOUT("grave01campfirelayout");
			uLocal_19 = CREATE_WORLD_SECTOR(&uLocal_21, "tumbleweed");
		}
		if (IS_WORLD_SECTOR_LOADED(&uLocal_19))
		{
			uLocal_17 = Function_77(Global_46796[0], "tumbleweed", "grave", 13);
			if (IS_OBJECT_VALID(&uLocal_17))
			{
				if (IS_PROP_STREAMED_IN(&uLocal_17))
				{
					if (Function_75(&uLocal_23, "grave03mobile", &iParam1))
					{
						GRAVE_SET_DUG_UP(&uLocal_17, 1);
						uLocal_15 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_23, Function_133()));
						*(&Global_6667[1428] + 216) = &uLocal_15;
...
void Function_72() //Position: 0x3B6F / 15215
{
	struct<2> Var0;
	var uVar2;
	
	DESTROY_OBJECT(&uLocal_19);
	Var0 = Vector(-3911,7f, 31,59f, 2900,8f);
	uVar2 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_21, "grave03garbage", "mex_pickGarbage", Var0, Vector(0.0f, 58,7f, 16,2f));
	SNAP_OBJECT_TO_GROUND(&uVar2, 2.0f, true, 1092616192);
	SNAP_ACTOR_TO_GRINGO(&uLocal_13, &uVar2, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_13, GET_GRINGO_FROM_OBJECT(&uVar2), "UseCase1", 4294967295, 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_21, "grave03campcoffin", "p_gen_coffinCorpse02x", Vector(-3912,78f, 30,483f, 2899,63f), Vector(0.0f, -53,387f, 0.0f), 1);
	Function_73(&uLocal_13, &uLocal_15, 1, 1);
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3C5F / 15455
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x3E1C / 15900
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x3E64 / 15972
{
...
void Function_76(var uParam0, int iParam1) //Position: 0x3E94 / 16020
{
	int iVar0;
...
var Function_77(int iParam0, var uParam1, char* cParam2) //Position: 0x3EDF / 16095
{
	var uVar0;
	char* cVar1[8];
	char* cVar3[32];
...
bool Function_78(int iParam0) //Position: 0x3FB6 / 16310
{
...
bool Function_79(int iParam0) //Position: 0x3FCC / 16332
{
	if (!Function_78(iParam0))
	{
		return 1;
...
bool Function_80(var uParam0, bool bParam1) //Position: 0x3FE8 / 16360
{
	int iVar0;
...
int Function_81(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4005 / 16389
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_82(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x41E4 / 16868
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_83(var uParam0, bool bParam1) //Position: 0x4724 / 18212
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_84(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4746 / 18246
{
	var uVar0;
...
var Function_85(bool bParam0, int iParam1) //Position: 0x47A7 / 18343
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_86(var uParam0, int iParam1) //Position: 0x4835 / 18485
{
	Function_88(&uParam0);
	Function_87(&uParam0);
...
void Function_87(int iParam0) //Position: 0x4861 / 18529
{
...
void Function_88(int iParam0) //Position: 0x4887 / 18567
{
...
bool Function_89(bool bParam0) //Position: 0x495D / 18781
{
...
var Function_90(int iParam0, int iParam1) //Position: 0x4974 / 18804
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_91(int iParam0, bool bParam1, bool bParam2) //Position: 0x4A1A / 18970
{
	var uVar0;
	var uVar1;
...
void Function_92(int iParam0) //Position: 0x4B29 / 19241
{
	int iVar0;
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4B5C / 19292
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_94() //Position: 0x4BE8 / 19432
{
	var uVar0;
	int iVar1;
...
var Function_95(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4C58 / 19544
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_96(struct<205> Param0) //Position: 0x4CFE / 19710
{
	var uVar0;
	var uVar1;
...
var Function_97(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4E09 / 19977
{
	int iVar0;
	int iVar1;
...
void Function_98(struct<13> Param0) //Position: 0x4E47 / 20039
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_99(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4E5A / 20058
{
	int iVar0;
...
bool Function_100(struct<2>[] Param0) //Position: 0x4F29 / 20265
{
	int iVar0;
	int iVar1;
...
void Function_101() //Position: 0x52EB / 21227
{
	if (!Function_148(128))
	{
		return;
...
bool Function_102() //Position: 0x532B / 21291
{
	int iVar0;
...
void Function_103() //Position: 0x5359 / 21337
{
	if (!Function_148(128))
	{
		return;
...
void Function_104(vector3 vParam0) //Position: 0x539B / 21403
{
	char* cVar0[32];
...
void Function_105(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5433 / 21555
{
	var uVar0;
	var uVar1;
...
void Function_106(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5462 / 21602
{
...
var Function_107(var uParam0, bool bParam1) //Position: 0x54BD / 21693
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_108() //Position: 0x54CD / 21709
{
	return "PackedGrass";
}

var Function_109(bool bParam0, bool bParam1, bool bParam2) //Position: 0x54E1 / 21729
{
	int iVar0;
...
var Function_110() //Position: 0x5506 / 21766
{
	return "PackedMetadata";
}

void Function_111(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x551D / 21789
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_112() //Position: 0x5659 / 22105
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_113() //Position: 0x566B / 22123
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_114() //Position: 0x567D / 22141
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_115(var uParam0, struct<5> Param1) //Position: 0x568F / 22159
{
...
var Function_116(var uParam0, int iParam1, int iParam2) //Position: 0x56B4 / 22196
{
	int iVar0;
...
var Function_117(bool bParam0) //Position: 0x56D3 / 22227
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_118() //Position: 0x56DF / 22239
{
	return Function_119(39);
}

int Function_119(int iParam0) //Position: 0x56EA / 22250
{
	int iVar0;
...
var Function_120() //Position: 0x5718 / 22296
{
	return "PackedWeapon";
}

int Function_121(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x572D / 22317
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_122() //Position: 0x583A / 22586
{
	return "MPItemGiver";
}

struct<32> Function_123(char* cParam0) //Position: 0x584E / 22606
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_124(char* cParam0) //Position: 0x58BA / 22714
{
	char* cVar0[32];
...
var Function_125() //Position: 0x58DC / 22748
{
	return "PBox_";
}

var Function_126() //Position: 0x58EA / 22762
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_127() //Position: 0x5910 / 22800
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_128() //Position: 0x5938 / 22840
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_129(var uParam0, int iParam1) //Position: 0x595E / 22878
{
	int iVar0;
	var uVar1;
...
void Function_130(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5AC8 / 23240
{
	struct<8> Var0;
...
int Function_131(bool bParam0) //Position: 0x5B70 / 23408
{
	int iVar0;
	struct<2> Var1;
...
void Function_132(int iParam0) //Position: 0x5CDE / 23774
{
...
var Function_133() //Position: 0x5D46 / 23878
{
	int iVar0;
...
var Function_134(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5D4F / 23887
{
	return Function_135(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_135(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5D6D / 23917
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_136(int iParam0) //Position: 0x6066 / 24678
{
	int iVar0;
...
void Function_137() //Position: 0x611A / 24858
{
	int iVar0;
...
bool Function_138(bool bParam0) //Position: 0x6155 / 24917
{
	int iVar0;
...
void Function_139(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6182 / 24962
{
	int iVar0;
...
void Function_140() //Position: 0x62DD / 25309
{
	int iVar0;
...
var Function_141(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6329 / 25385
{
	int iVar0;
...
int Function_142() //Position: 0x6405 / 25605
{
	int iVar0;
...
int Function_143() //Position: 0x6561 / 25953
{
	int iVar0;
...
bool Function_144(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6681 / 26241
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_145(struct<2> Param0) //Position: 0x675D / 26461
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_146(struct<2> Param0, struct<5> Param2) //Position: 0x677C / 26492
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_147(int iParam0) //Position: 0x68BF / 26815
{
	var uVar0;
...
bool Function_148(int iParam0) //Position: 0x68E1 / 26849
{
	int iVar0;
...
int Function_149() //Position: 0x68FD / 26877
{
	return 0;
}

void Function_150(struct<321> Param0) //Position: 0x6904 / 26884
{
	var uVar0;
