...
int Function_77(int iParam0) //Position: 0x329A / 12954
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x32B8 / 12984
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x32F9 / 13049
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x3305 / 13061
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(int iParam0, int iParam1) //Position: 0x3327 / 13095
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x3339 / 13113
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x3449 / 13385
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3461 / 13409
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x377D / 14205
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x378F / 14223
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x37A9 / 14249
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x37C4 / 14276
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3802 / 14338
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x381B / 14363
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3B13 / 15123
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3B31 / 15153
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3BD1 / 15313
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3BF1 / 15345
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3C04 / 15364
{
...
void Function_96(int iParam0) //Position: 0x3C20 / 15392
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3C2C / 15404
{
	int iVar0;
	var uVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3C98 / 15512
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3CB0 / 15536
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3CBC / 15548
{
