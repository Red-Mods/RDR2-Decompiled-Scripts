...
void main() //Position: 0x0 / 0
{
	...
	iLocal_116 = 0;
	Function_101(&uScriptParam_0, &iLocal_116);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(vLocal_6[iVar39]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_6[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_87("eGRINGO_EndUse: Stop use by request", &vLocal_6[iVar39] + 24);
							Function_86(&vLocal_6[iVar39] + 24, 1);
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_122, &uLocal_120);
...
void Function_29(var uParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	...
	{
		GET_OBJECT_POSITION(&uVar0, &uVar1);
		if (!IS_DOOR_CLOSED(&(uLocal_0[0])))
		{
			CLOSE_DOOR(&(uLocal_0[0]), 1.0f);
		}
		uLocal_0[0] = FIND_NEAREST_DOOR(&uVar1, 1.0f);
		if (IS_DOOR_VALID(&(uLocal_0[0])))
		{
			if (!IS_DOOR_LOCKED(&(uLocal_0[0])))
			{
				SET_DOOR_LOCK(&(uLocal_0[0]), 1);
			}
		}
	}
	return;
...
bool Function_30(char* cParam0) //Position: 0x2065 / 8293
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2072 / 8306
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x208D / 8333
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20AD / 8365
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x20CD / 8397
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2104 / 8452
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2124 / 8484
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x213F / 8511
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2155 / 8533
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2479 / 9337
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2482 / 9346
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24A1 / 9377
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x24B0 / 9392
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24D4 / 9428
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x24FA / 9466
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2518 / 9496
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x253A / 9530
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x255C / 9564
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2624 / 9764
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26A0 / 9888
{
...
void Function_50(vector3 vParam0) //Position: 0x26B8 / 9912
{
...
var Function_51(int iParam0) //Position: 0x26DD / 9949
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26FE / 9982
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2715 / 10005
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2721 / 10017
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2728 / 10024
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2739 / 10041
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x277E / 10110
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27AA / 10154
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27B6 / 10166
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28B8 / 10424
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x28DB / 10459
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2903 / 10499
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BEA / 11242
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C47 / 11335
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2CA4 / 11428
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2CB0 / 11440
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CCF / 11471
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CE6 / 11494
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D77 / 11639
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D9B / 11675
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2DBA / 11706
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2DDE / 11742
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F06 / 12038
{
...
int Function_74(var uParam0) //Position: 0x2F34 / 12084
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x304D / 12365
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x305A / 12378
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30DC / 12508
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3687 / 13959
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x36C1 / 14017
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x36DF / 14047
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3720 / 14112
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x372C / 14124
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x374E / 14158
{
	var uVar0;
	...
	uLocal_0[0] = FIND_NEAREST_DOOR(&uVar0, 1.0f);
	if (IS_DOOR_VALID(&(uLocal_0[0])))
	{
		Function_84(&uLocal_0, 0);
	}
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var[] uParam0, int iParam1) //Position: 0x378D / 14221
{
	int iVar0;
	...
	while (iVar0 <= uParam0)
	{
		if (IS_DOOR_VALID(&(uParam0[iVar0])))
		{
			...
			{
				Function_85(&(uParam0[iVar0]), &iParam1);
			}
		}
		iVar0++;
	}
...
void Function_85(var uParam0, int iParam1) //Position: 0x37D5 / 14293
{
...
void Function_86(var uParam0, bool bParam1) //Position: 0x382D / 14381
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_87(int iParam0, int iParam1) //Position: 0x393D / 14653
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_88(struct<69> Param0) //Position: 0x3955 / 14677
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_89(int iParam0, int iParam1) //Position: 0x3C71 / 15473
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_90(int iParam0) //Position: 0x3C83 / 15491
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_91(int iParam0) //Position: 0x3C9D / 15517
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, var uParam1) //Position: 0x3CB8 / 15544
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3CF6 / 15606
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_94(struct<65> Param0) //Position: 0x3D0F / 15631
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_95(int iParam0) //Position: 0x4007 / 16391
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x4025 / 16421
{
	struct<5> Var0;
	float fVar5;
...
int Function_97(int iParam0) //Position: 0x40C5 / 16581
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(int iParam0, var uParam1) //Position: 0x40E5 / 16613
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x40F8 / 16632
{
...
void Function_100(int iParam0) //Position: 0x4114 / 16660
{
	iParam0 = &iParam0;
	return;
}

void Function_101(var uParam0, int iParam1) //Position: 0x4120 / 16672
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_102(&(vLocal_6[iLocal_1169]), &uParam0);
		iLocal_116++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x418C / 16780
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_103(int iParam0) //Position: 0x41A4 / 16804
{
	iParam0 = &iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x41B0 / 16816
{
