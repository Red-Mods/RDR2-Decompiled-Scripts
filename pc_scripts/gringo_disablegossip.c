...
void Function_84(var uParam0, bool bParam1) //Position: 0x3704 / 14084
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3814 / 14356
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x382C / 14380
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3B48 / 15176
{
	iParam1 = &iParam1;
	UNK_0x99AFD2D1(&uParam0, 1, 1);
	return;
}

bool Function_88(int iParam0) //Position: 0x3B5C / 15196
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3B76 / 15222
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3B91 / 15249
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3BCF / 15311
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3BE8 / 15336
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3EE0 / 16096
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3EFE / 16126
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3F9E / 16286
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3FBE / 16318
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FD1 / 16337
{
...
void Function_98(int iParam0) //Position: 0x3FED / 16365
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x3FF9 / 16377
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4066 / 16486
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x407E / 16510
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x408A / 16522
{
