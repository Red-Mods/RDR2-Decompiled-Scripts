	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x00000007:
				if (bLocal_177)
				{
					Function_222(&iLocal_13, bScriptParam_0, Function_249());
				}
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBA7 / 2983
{
...
void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF39 / 53049
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
{
	Function_239(&uLocal_490, &cLocal_7, "cartStop01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "cartStop01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "supplyShack01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "supplyShack01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "supplyShack01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "supplyShack01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_490, &cLocal_7, "supplyShack01", 5, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD2D2 / 53970
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD3D5 / 54229
{
	int iVar0;
...
void Function_241() //Position: 0xD406 / 54278
{
	Function_245(&uLocal_9, &uLocal_404, 4, &iLocal_264 + 120, 4294967295, 4);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 8, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 16, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 24, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 32, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 40, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 48, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 56, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 64, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 72, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 80, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 88, 4294967295, 266);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 128, 4294967295, 0);
	Function_245(&uLocal_9, &uLocal_404, 5, &iLocal_264 + 136, 4294967295, 0);
	Function_244(&iLocal_264 + 128, 1);
	Function_243(&iLocal_264 + 136, 12);
	Function_242(&iLocal_264 + 128, 24, 4);
	return;
}

void Function_242(var uParam0, bool bParam1, bool bParam2) //Position: 0xD531 / 54577
{
...
void Function_243(var uParam0, bool bParam1) //Position: 0xD5B3 / 54707
{
	if (DECOR_CHECK_EXIST(&uParam0, "locflag"))
	{
...
void Function_244(var uParam0, bool bParam1) //Position: 0xD61F / 54815
{
	if (DECOR_CHECK_EXIST(&uParam0, "locflag"))
	{
...
void Function_245(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD687 / 54919
{
...
void Function_246(struct<5> Param0) //Position: 0xD774 / 55156
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_247(int iParam0, int iParam1) //Position: 0xD785 / 55173
{
	var uVar0;
	int iVar1;
...
void Function_248(int iParam0, int iParam1, bool bParam2) //Position: 0xD7FB / 55291
{
	var uVar0;
	int iVar1;
...
var Function_249() //Position: 0xD899 / 55449
{
	return &iLocal_178;
}

void Function_250(int iParam0) //Position: 0xD8A2 / 55458
{
	cLocal_7 = Function_251(&iLocal_178, "gaptoothbreach", iParam0);
	return;
}

int Function_251(int iParam0, var uParam1, int iParam2) //Position: 0xD8C4 / 55492
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_252() //Position: 0xD8E7 / 55527
{
	return Function_253();
}

int Function_253() //Position: 0xD8F0 / 55536
{
	var uVar0;
	
	Function_254(3, 3);
	uVar0 = &uVar0;
	iLocal_264 = FIND_NAMED_LAYOUT("GaptoothBreach_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_264))
	{
		iLocal_264 = CREATE_LAYOUT("GaptoothBreach_layout");
	}
	*(&iLocal_264 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_winch01", 2,802597E-45f, Vector(-4467,885f, 30,60711f, 3138,133f), Vector(0.0f, 40,10637f, 0.0f), Vector(23,14547f, 5,693303f, 9,606106f));
	*(&iLocal_264 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_shack05", 2,802597E-45f, Vector(-4431,483f, 24,94902f, 3164,93f), Vector(0.0f, -5,622203f, 0.0f), Vector(2,611438f, 2,354962f, 2,989603f));
	*(&iLocal_264 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_shack01", 2,802597E-45f, Vector(-4478,225f, 10,0649f, 3248,745f), Vector(0.0f, 15,13092f, 0.0f), Vector(3,90555f, 2,684183f, 2,992382f));
	*(&iLocal_264 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_shack03", 2,802597E-45f, Vector(-4424,25f, 9,671838f, 3240,974f), Vector(0.0f, -50,56689f, 0.0f), Vector(4,434833f, 2,772553f, 2,987911f));
	*(&iLocal_264 + 40) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_shack02", 2,802597E-45f, Vector(-4410,126f, 9,610524f, 3268,708f), Vector(0.0f, 0.0f, 0.0f), Vector(3,182478f, 2,576603f, 4,73823f));
	*(&iLocal_264 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_supply01", 2,802597E-45f, Vector(-4454,582f, 10,35419f, 3221,282f), Vector(0.0f, -60,22192f, 0.0f), Vector(11,83462f, 3,058447f, 5,424776f));
	*(&iLocal_264 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_supply02", 2,802597E-45f, Vector(-4455,299f, 13,94045f, 3220,323f), Vector(0.0f, -61,28831f, 0.0f), Vector(12,65227f, 2,493773f, 5,237571f));
	*(&iLocal_264 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_supply03", 2,802597E-45f, Vector(-4457,208f, 17,30235f, 3216,496f), Vector(0.0f, 29,51004f, 0.0f), Vector(5,509431f, 2,572896f, 5,329562f));
	*(&iLocal_264 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_entr01", 2,802597E-45f, Vector(-4427,508f, 10,7146f, 3201,683f), Vector(0.0f, -13,57298f, 0.0f), Vector(10,59845f, 5,217734f, 5,946335f));
	*(&iLocal_264 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_cave02", 4,203895E-45f, Vector(-4404,884f, 4,673136f, 3103,817f), Vector(0.0f, 20.0f, 0.0f), Vector(10,04772f, 3,634864f, 9,184017f));
	*(&iLocal_264 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_cave03", 4,203895E-45f, Vector(-4439,204f, 0,6233581f, 3118,843f), Vector(0,3678176f, -21,70927f, -1,564349f), Vector(19,85855f, 2,652542f, 14,79106f));
	*(&iLocal_264 + 120) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_264, "gapv_region_set");
	*(&iLocal_264 + 96[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_region01", 4,203895E-45f, Vector(-4461,488f, 21,40137f, 3243,386f), Vector(0.0f, 20.0f, 0.0f), Vector(92,69983f, 37,08438f, 89,164f));
	ADD_TO_VOLUME_SET(&iLocal_264 + 120, &iLocal_264 + 96[0]);
	*(&iLocal_264 + 96[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_region02", 4,203895E-45f, Vector(-4468,751f, 32,29619f, 3160,123f), Vector(0.0f, 43,89148f, 0.0f), Vector(89,09129f, 35,56518f, 144,6049f));
	ADD_TO_VOLUME_SET(&iLocal_264 + 120, &iLocal_264 + 96[1]);
	*(&iLocal_264 + 128) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_map01", 4,203895E-45f, Vector(-4433,969f, 2,878583f, 3125,545f), Vector(0.0f, 20.0f, 0.0f), Vector(63,35824f, 14,10728f, 79,84444f));
	*(&iLocal_264 + 136) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_weather01", 4,203895E-45f, Vector(-4441,806f, -2,81256f, 3109,961f), Vector(0.0f, 20.0f, 0.0f), Vector(60.0f, 15.0f, 60.0f));
	*(&iLocal_264 + 144) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_mineCartBuilding", 2,802597E-45f, Vector(-4509,693f, 14,92962f, 3259,542f), Vector(0.0f, 35,6264f, 0.0f), Vector(10,53261f, 10,53261f, 12,75524f));
	*(&iLocal_264 + 152) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_noCritters", 2,802597E-45f, Vector(-4434,201f, -0,8187729f, 3138,237f), Vector(0.0f, 0.0f, 0.0f), Vector(115,506f, 35,23788f, 131,4333f));
	*(&iLocal_264 + 160) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gapv_birdVol", 2,802597E-45f, Vector(-4489,279f, 15,38014f, 3213,495f), Vector(0.0f, 0.0f, 0.0f), Vector(196,8468f, 62,60005f, 268,1234f));
	*(&iLocal_264 + 168) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gap_zombie_01", 4,203895E-45f, Vector(-4463,794f, -0,1033669f, 3265,256f), Vector(0.0f, 20.0f, 0.0f), Vector(75.0f, 15.0f, 75.0f));
	*(&iLocal_264 + 176) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gap_zombie_02", 4,203895E-45f, Vector(-4494,071f, 21,37547f, 3126,231f), Vector(0.0f, 20.0f, 0.0f), Vector(35.0f, 12.0f, 35.0f));
	*(&iLocal_264 + 184) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gap_zombie_03", 4,203895E-45f, Vector(-4438,148f, 5,716315f, 3133,53f), Vector(0.0f, 20.0f, 0.0f), Vector(50.0f, 10.0f, 60.0f));
	*(&iLocal_264 + 192) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gap_zombie_04", 4,203895E-45f, Vector(-4439,246f, 5,716315f, 3120,859f), Vector(0.0f, 20.0f, 0.0f), Vector(15,40012f, 8,155993f, 25,31619f));
	*(&iLocal_264 + 200) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "gap_zombie_05", 4,203895E-45f, Vector(-4475,018f, 5,716315f, 3142,9f), Vector(0.0f, 20.0f, 0.0f), Vector(11,96077f, 6,334492f, 11,89045f));
	*(&iLocal_264 + 208) = Vector(-4468.0f, 28,59105f, 3136f);
	*(&iLocal_264 + 208 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_264 + 232) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_uptop", Vector(-4468.0f, 28,59105f, 3136f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_264 + 240) = Vector(-4454,098f, 12,6053f, 3222,668f);
	*(&iLocal_264 + 240 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_264 + 264) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_buildingflr2", Vector(-4454,098f, 12,6053f, 3222,668f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_264 + 272) = Vector(-4457,464f, 16,05766f, 3216,848f);
	*(&iLocal_264 + 272 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_264 + 296) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_buildingflr3", Vector(-4457,464f, 16,05766f, 3216,848f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_264 + 304) = Vector(-4446,95f, 9,035381f, 3218,423f);
	*(&iLocal_264 + 304 + 12) = Vector(0.0f, -61,02644f, 0.0f);
	*(&iLocal_264 + 328) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure1", Vector(-4446,95f, 9,035381f, 3218,423f), Vector(0.0f, -61,02644f, 0.0f));
	*(&iLocal_264 + 336) = Vector(-4474,644f, 40,80267f, 3143,422f);
	*(&iLocal_264 + 336 + 12) = Vector(0.0f, -99,1375f, 0.0f);
	*(&iLocal_264 + 360) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure2", Vector(-4474,644f, 40,80267f, 3143,422f), Vector(0.0f, -99,1375f, 0.0f));
	*(&iLocal_264 + 368) = Vector(-4510,295f, 12,18096f, 3265,347f);
	*(&iLocal_264 + 368 + 12) = Vector(0.0f, 12,43297f, 0.0f);
	*(&iLocal_264 + 392) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure3", Vector(-4510,295f, 12,18096f, 3265,347f), Vector(0.0f, 12,43297f, 0.0f));
	*(&iLocal_264 + 400) = Vector(-4446,704f, -0,4978765f, 3108,369f);
	*(&iLocal_264 + 400 + 12) = Vector(0.0f, -96,72852f, 0.0f);
	*(&iLocal_264 + 424) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure4", Vector(-4446,704f, -0,4978765f, 3108,369f), Vector(0.0f, -96,72852f, 0.0f));
	*(&iLocal_264 + 432) = Vector(-4475,655f, 1,288707f, 3144,396f);
	*(&iLocal_264 + 432 + 12) = Vector(0.0f, -129,6321f, 0.0f);
	*(&iLocal_264 + 456) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure5", Vector(-4475,655f, 1,288707f, 3144,396f), Vector(0.0f, -129,6321f, 0.0f));
	*(&iLocal_264 + 464) = Vector(-4452,037f, 5,545f, 3102,482f);
	*(&iLocal_264 + 464 + 12) = Vector(0.0f, 187,2736f, 0.0f);
	*(&iLocal_264 + 488) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_AreaTreasure6", Vector(-4452,037f, 5,545f, 3102,482f), Vector(0.0f, 187,2736f, 0.0f));
	*(&iLocal_264 + 496) = Vector(-4451,842f, 9,198417f, 3224,78f);
	*(&iLocal_264 + 496 + 12) = Vector(0.0f, -62,32942f, 0.0f);
	*(&iLocal_264 + 520) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_interiorPoint_01", Vector(-4451,842f, 9,198417f, 3224,78f), Vector(0.0f, -62,32942f, 0.0f));
	*(&iLocal_264 + 528) = Vector(-4508,545f, 12,20014f, 3263,627f);
	*(&iLocal_264 + 528 + 12) = Vector(0.0f, -147,9917f, 0.0f);
	*(&iLocal_264 + 552) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gapf_interiorPoint_02", Vector(-4508,545f, 12,20014f, 3263,627f), Vector(0.0f, -147,9917f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos1", Vector(-4513,377f, 14,626f, 3319,787f), Vector(-0,114f, -29,679f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos2", Vector(-4406,952f, 29,22f, 3309,984f), Vector(-12,375f, 42,799f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos3", Vector(-4405,235f, 19,143f, 3225,527f), Vector(-4,755f, 118,086f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos4", Vector(-4440,23f, 11,167f, 3323,307f), Vector(-0,916f, 26,47f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos5", Vector(-4522,13f, 18,313f, 3235,939f), Vector(-3,896f, -125,305f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos6", Vector(-4508,175f, 12,023f, 3280,951f), Vector(7,792f, -12,089f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos7", Vector(-4485,057f, 39,059f, 3141,618f), Vector(-0,802f, -115,966f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos8", Vector(-4427,75f, 9,929f, 3192,176f), Vector(3,953f, -170,569f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos9", Vector(-4437,174f, 10,309f, 3218,002f), Vector(11,344f, 80,328f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "gap_vista_cam_pos10", Vector(-4469,497f, 9,542f, 3251,881f), Vector(9,854874f, 82,50592f, 0.0f));
	return 1;
}

void Function_254(int iParam0, int iParam1) //Position: 0xE631 / 58929
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_255(var uParam0, int iParam1) //Position: 0xE67B / 59003
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_256() //Position: 0xE68C / 59020
{
	return;
}

bool Function_257() //Position: 0xE692 / 59026
{
	return 1;
}

void Function_258() //Position: 0xE699 / 59033
{
	return;
}

bool Function_259() //Position: 0xE69F / 59039
{
	return Function_260();
}

int Function_260() //Position: 0xE6A8 / 59048
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("GaptoothBreach_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("GaptoothBreach_layout");
	}
	*(&iLocal_178 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "nsurvVol_1", 2,802597E-45f, Vector(-4457,492f, 15,64729f, 3228,322f), Vector(15,50424f, 30,15942f, 0,5496728f), Vector(3,911148f, 4,508488f, 3,672529f));
	*(&iLocal_178 + 120) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-4472,86f, 36,73199f, 3142,717f), Vector(0.0f, 43,92885f, 0.0f), Vector(9,031575f, 17.0f, 8,524941f));
	*(&iLocal_178 + 128) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-4473,961f, 13,217f, 3142,439f), Vector(0.0f, 43,92885f, 0.0f), Vector(9,031575f, 17.0f, 8,524941f));
	*(&iLocal_178 + 136) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-4509,197f, 16,05632f, 3259,202f), Vector(0.0f, 35,05136f, 0.0f), Vector(12,69067f, 12,58789f, 14,10571f));
	*(&iLocal_178 + 144) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_4", 2,802597E-45f, Vector(-4455,801f, 15,51248f, 3220,143f), Vector(0.0f, 29,07527f, 0.0f), Vector(19,49606f, 15.0f, 19,08537f));
	*(&iLocal_178 + 152) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_5", 2,802597E-45f, Vector(-4425,11f, 11,70055f, 3241,669f), Vector(0.0f, 29,07527f, 0.0f), Vector(7,742517f, 10,13066f, 7,579418f));
	*(&iLocal_178 + 160) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_6", 2,802597E-45f, Vector(-4477,944f, 10,96936f, 3248,581f), Vector(0.0f, 16,12264f, 0.0f), Vector(5,784676f, 7,374537f, 4,896632f));
	*(&iLocal_178 + 168) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_7", 2,802597E-45f, Vector(-4411,512f, 10,96936f, 3265,555f), Vector(0.0f, 40,68364f, 0.0f), Vector(6,961011f, 7,374537f, 4,896632f));
	*(&iLocal_178 + 176) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_8", 2,802597E-45f, Vector(-4432,05f, 27,4371f, 3167,07f), Vector(0.0f, 0,05942636f, 0.0f), Vector(7,584743f, 7,374537f, 5,022208f));
	*(&iLocal_178 + 184) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-4472,86f, 36,73199f, 3142,717f), Vector(0.0f, 43,92885f, 0.0f), Vector(15.0f, 28,70319f, 15.0f));
	*(&iLocal_178 + 192) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01", Vector(-4449,159f, 0,428675f, 3116,285f), Vector(0.0f, -70.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 192);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-4477,358f, 8,47983f, 3143,101f), Vector(0.0f, 25.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 192);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-4509,278f, 19,16557f, 3255,832f), Vector(0.0f, -70.0f, 0.0f));
	DECOR_SET_INT(&uVar3, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 192);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-4457,882f, 13,22017f, 3229,555f), Vector(0.0f, 177,7635f, 0.0f));
	DECOR_SET_INT(&uVar4, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 192);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-4475,182f, 40,81606f, 3143,348f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar5, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 192);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05_core", Vector(-4426,006f, 11,80455f, 3242,525f), Vector(0.0f, 120.0f, 0.0f));
	DECOR_SET_BOOL(&uVar6, "Core", 1);
	DECOR_SET_INT(&uVar6, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 192);
	*(&iLocal_178 + 200) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-4476,282f, 8,47983f, 3142,14f), Vector(0.0f, 131,7824f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 200);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-4477,358f, 8,47983f, 3143,101f), Vector(0.0f, 311,7246f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 200);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-4508,43f, 19,16557f, 3257,028f), Vector(0.0f, 34,99584f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 200);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-4509,278f, 19,16557f, 3255,832f), Vector(0.0f, -142,6835f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 200);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_player", Vector(-4456,683f, 13,22017f, 3228,791f), Vector(0.0f, 122,5004f, 0.0f));
	DECOR_SET_INT(&uVar11, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar11, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 200);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_surv", Vector(-4457,882f, 13,22017f, 3229,555f), Vector(0.0f, 302,1082f, 0.0f));
	DECOR_SET_INT(&uVar12, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 200);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_player", Vector(-4473,781f, 40,81606f, 3143,359f), Vector(0.0f, 89,51694f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 200);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_surv", Vector(-4475,182f, 40,81606f, 3143,348f), Vector(0.0f, 269,8758f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 200);
	*(&iLocal_178 + 208) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_difSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-4458,131f, 19,48944f, 3219,542f), Vector(0.0f, 158,3773f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 208);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09", Vector(-4504,571f, 16,12846f, 3262,452f), Vector(0.0f, -116,0217f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 208);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def010", Vector(-4457,882f, 13,22017f, 3229,555f), Vector(0.0f, 177,7635f, 0.0f));
	DECOR_SET_INT(&uVar17, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 208);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def011", Vector(-4449,159f, 0,428675f, 3116,285f), Vector(0.0f, -70.0f, 0.0f));
	DECOR_SET_BOOL(&uVar18, "CrouchShoot", 1);
	DECOR_SET_INT(&uVar18, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 208);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def012", Vector(-4475,182f, 40,81606f, 3143,348f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar19, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 208);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-4426,006f, 11,80455f, 3242,525f), Vector(0.0f, 120.0f, 0.0f));
	DECOR_SET_BOOL(&uVar20, "Core", 1);
	DECOR_SET_INT(&uVar20, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 208);
	*(&iLocal_178 + 216) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_07_player", Vector(-4426,687f, 11,80455f, 3241,346f), Vector(0.0f, 210.0f, 0.0f));
	DECOR_SET_BOOL(&uVar21, "Core", 1);
	DECOR_SET_INT(&uVar21, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 216);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_07_surv", Vector(-4426,006f, 11,80455f, 3242,525f), Vector(0.0f, 30.0f, 0.0f));
	DECOR_SET_BOOL(&uVar22, "Core", 1);
	DECOR_SET_INT(&uVar22, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 216);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_08_player", Vector(-4456,948f, 19,48944f, 3218,859f), Vector(0.0f, 120.0f, 0.0f));
	DECOR_SET_INT(&uVar23, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 216);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_08_surv", Vector(-4458,131f, 19,48944f, 3219,542f), Vector(0.0f, -60.0f, 0.0f));
	DECOR_SET_INT(&uVar24, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar24, &iLocal_178 + 216);
	uVar25 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_09_player", Vector(-4505,391f, 16,12846f, 3261,282f), Vector(0.0f, -145.0f, 0.0f));
	DECOR_SET_INT(&uVar25, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar25, &iLocal_178 + 216);
	uVar26 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_09_surv", Vector(-4504,571f, 16,12846f, 3262,452f), Vector(0.0f, 35.0f, 0.0f));
	DECOR_SET_INT(&uVar26, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar26, &iLocal_178 + 216);
	uVar27 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_11_player", Vector(-4449,159f, 0,429f, 3117,685f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar27, "CrouchShoot", 1);
	DECOR_SET_INT(&uVar27, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar27, &iLocal_178 + 216);
	uVar28 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_11_surv", Vector(-4449,159f, 0,428675f, 3116,285f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar28, "CrouchShoot", 1);
	DECOR_SET_INT(&uVar28, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar28, &iLocal_178 + 216);
	*(&iLocal_178 + 224) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_difSet", &iLocal_178, 8, 0);
	uVar29 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def014", Vector(-4449,159f, 0,428675f, 3116,285f), Vector(0.0f, -70.0f, 0.0f));
	DECOR_SET_INT(&uVar29, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar29, &iLocal_178 + 224);
	uVar30 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def015", Vector(-4513,219f, 19,37191f, 3257,147f), Vector(0.0f, -280,479f, 0.0f));
	DECOR_SET_INT(&uVar30, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar30, &iLocal_178 + 224);
	uVar31 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def016", Vector(-4423,57f, 11,20015f, 3243.0f), Vector(0.0f, 243,9342f, 0.0f));
	DECOR_SET_INT(&uVar31, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar31, &iLocal_178 + 224);
	uVar32 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def017", Vector(-4477,358f, 8,47983f, 3143,101f), Vector(0.0f, 25.0f, 0.0f));
	DECOR_SET_BOOL(&uVar32, "CrouchShoot", 1);
	DECOR_SET_INT(&uVar32, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar32, &iLocal_178 + 224);
	uVar33 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def018", Vector(-4475,182f, 40,81606f, 3143,348f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar33, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar33, &iLocal_178 + 224);
	uVar34 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def013_core", Vector(-4448,151f, 12,11725f, 3220,137f), Vector(0.0f, 338,1729f, 0.0f));
	DECOR_SET_BOOL(&uVar34, "Core", 1);
	DECOR_SET_INT(&uVar34, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar34, &iLocal_178 + 224);
	*(&iLocal_178 + 232) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar35 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_13_player", Vector(-4447,452f, 12,11725f, 3221,342f), Vector(0.0f, 390,5833f, 0.0f));
	DECOR_SET_BOOL(&uVar35, "Core", 1);
	DECOR_SET_INT(&uVar35, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar35, &iLocal_178 + 232);
	uVar36 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_13_surv", Vector(-4448,151f, 12,11725f, 3220,137f), Vector(0.0f, 210.0f, 0.0f));
	DECOR_SET_BOOL(&uVar36, "Core", 1);
	DECOR_SET_INT(&uVar36, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar36, &iLocal_178 + 232);
	uVar37 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_15_player", Vector(-4512,438f, 19,37191f, 3258,262f), Vector(0.0f, 35.0f, 0.0f));
	DECOR_SET_INT(&uVar37, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar37, &iLocal_178 + 232);
	uVar38 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_15_surv", Vector(-4513,219f, 19,37191f, 3257,147f), Vector(0.0f, -145.0f, 0.0f));
	DECOR_SET_INT(&uVar38, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar38, &iLocal_178 + 232);
	uVar39 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_16_player", Vector(-4424,216f, 11,20015f, 3241,803f), Vector(0.0f, -151.0f, 0.0f));
	DECOR_SET_INT(&uVar39, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar39, &iLocal_178 + 232);
	uVar40 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_16_surv", Vector(-4423,57f, 11,20015f, 3243.0f), Vector(0.0f, 28.0f, 0.0f));
	DECOR_SET_INT(&uVar40, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar40, &iLocal_178 + 232);
	*(&iLocal_178 + 240) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar41 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-4477,187f, 35,52991f, 3143,105f), Vector(0.0f, 43,13843f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar41, &iLocal_178 + 240);
	uVar42 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-4473,232f, 40,81606f, 3141,906f), Vector(0.0f, -313,0121f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar42, &iLocal_178 + 240);
	uVar43 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-4506,435f, 15,79817f, 3255,562f), Vector(0.0f, -56,01937f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar43, &iLocal_178 + 240);
	uVar44 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe04", Vector(-4452.0f, 9,035072f, 3236f), Vector(0.0f, 289,9193f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar44, &iLocal_178 + 240);
	uVar45 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe05", Vector(-4450,678f, 8,951299f, 3234,678f), Vector(0.0f, 176,2088f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar45, &iLocal_178 + 240);
	uVar46 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe06", Vector(-4449,574f, 9,035136f, 3227,673f), Vector(0.0f, 211,0916f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar46, &iLocal_178 + 240);
	*(&iLocal_178 + 248) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar47 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-4470,203f, 8,688527f, 3257,988f), Vector(0.0f, 171,9909f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar47, &iLocal_178 + 248);
	uVar48 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-4463,495f, 28,59105f, 3130,472f), Vector(0.0f, 38,58232f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar48, &iLocal_178 + 248);
	uVar49 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_4", Vector(-4510,465f, 12,16741f, 3264,578f), Vector(0.0f, -370,2898f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar49, &iLocal_178 + 248);
	uVar50 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_5", Vector(-4445,712f, 3,544466f, 3164,476f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar50, &iLocal_178 + 248);
	*(&iLocal_178 + 256) = Vector(-4454,145f, 9,204829f, 3220,642f);
	*(&iLocal_178 + 256 + 12) = Vector(0.0f, 206,2646f, 0.0f);
	*(&iLocal_178 + 280) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-4454,145f, 9,204829f, 3220,642f), Vector(0.0f, 206,2646f, 0.0f));
	*(&iLocal_178 + 288) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-4477,18f, 35,54696f, 3143,109f), Vector(0.0f, 43,88315f, 0.0f));
	*(&iLocal_178 + 296) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl", "DLC_survivor_stand_rfl", Vector(-4473,187f, 40,81606f, 3141,95f), Vector(0.0f, 47,03499f, 0.0f));
	*(&iLocal_178 + 304) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl2", "DLC_survivor_roof_rfl", Vector(-4506,452f, 15,80212f, 3255,574f), Vector(0.0f, 304,0049f, 0.0f));
	*(&iLocal_178 + 312) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground1", "Rand_Idle_Sit_Ground", Vector(-4452.0f, 9,035072f, 3236f), Vector(0.0f, 290,4598f, 0.0f));
	*(&iLocal_178 + 320) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_kneel_rfl", "DLC_survivor_kneel_rfl", Vector(-4450,683f, 8,964307f, 3234,719f), Vector(0.0f, 176,8338f, 0.0f));
	*(&iLocal_178 + 328) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl", "DLC_survivor_low_wall_rfl", Vector(-4449,584f, 9,040753f, 3227,662f), Vector(0.0f, 29,811f, 0.0f));
	*(&iLocal_178 + 336) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-4454,417f, 9,203892f, 3215,811f), Vector(0.0f, -62,07943f, 0.0f));
	return 1;
}

void Function_261(bool bParam0, bool bParam1) //Position: 0xFFD9 / 65497
{
	var uVar0;
...
void Function_262(int iParam0, bool bParam1, bool bParam2) //Position: 0x10075 / 65653
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_263(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0x10181 / 65921
{
	int iVar0;
...
bool Function_264(int iParam0) //Position: 0x1025D / 66141
{
	...
	if (Global_6606)
	{
		...
		if ((!Function_35(24) || Function_265(24)) && iParam0 != Global_46866[1])
		{
			return 0;
		}
	}
...
int Function_265(int iParam0) //Position: 0x102D8 / 66264
{
...
bool Function_266(int iParam0) //Position: 0x102ED / 66285
{
...
int Function_267(int iParam0) //Position: 0x10353 / 66387
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_268(int iParam0, int iParam1) //Position: 0x10415 / 66581
{
	int iVar0;
...
void Function_269() //Position: 0x10432 / 66610
{
	return;
}

void Function_270(char* cParam0) //Position: 0x10438 / 66616
{
	if (!Function_26(128))
	{
		return;
