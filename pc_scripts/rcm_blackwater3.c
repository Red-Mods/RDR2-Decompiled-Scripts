...
void main() //Position: 0x0 / 0
{
	...
	iLocal_335 = 0;
	bLocal_348 = false;
	Local_365 = Vector(763,335f, 78,314f, 1334,531f);
	iLocal_384 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_336 = 1000;
			Function_204(&uLocal_351, "$/content/scripting/gringo/SimpleGringo/stool_sit_attach", 1, 0);
			Function_204(&uLocal_351, "$/fragments/p_gen_doorstandard11x", 0, 0);
			Function_203(&uLocal_351, 1257, 3, 0);
			while (!IS_EXITFLAG_SET())
			{
				...
				if (!IS_DOOR_VALID(&uLocal_378))
				{
					if (Function_199(Global_46914[0]))
					{
						uLocal_378 = Function_197("blackwater02", "tailor01Props01x", 1);
						CLOSE_DOOR_FAST(&uLocal_378);
						Function_196(&uLocal_378, 0);
					}
				}
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (Function_191(&uLocal_351))
								{
									uLocal_370 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "BLK_3_Woman", 1257, *(&Global_99725[443] + 184), Vector(0.0f, Global_99725[443].f_208, 0.0f));
									SET_ACTOR_FACTION(&uLocal_370, 20);
									uLocal_382 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "RCM_BLK fallenDoor", "$/fragments/p_gen_doorstandard11x", Vector(762,913f, 78,306f, 1291,57f), Vector(90.0f, 86,667f, 0.0f), 1);
									GIVE_OBJECT_TO_LAYOUT(&uLocal_382, &uLocal_370);
									TASK_PRIORITY_SET(&uLocal_370, 2);
									SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_370, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
									uLocal_376 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, Function_190(), 2,802597E-45f, Vector(772,88f, 78,623f, 1292,734f), Vector(0.0f, 268,51f, 0.0f), Vector(5.0f, 5.0f, 5.0f));
									FIND_COVER_LOCATIONS_IN_VOLUME(&uLocal_372, 1, &uLocal_376, 180.0f, 180.0f, 7);
									TASK_HIDE_AT_COVER(&uLocal_370, &(uLocal_372[0]), -1.0f, 6.0f, 0);
									TASK_PRIORITY_SET(&uLocal_370, true);
									uLocal_380 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, "zombieStayOut", 2,802597E-45f, Vector(762,281f, 78,306f, 1290,754f), Vector(0.0f, 356,882f, 0.0f), Vector(8.0f, 10.0f, 35.0f));
									ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_380);
									ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_380);
									Function_183(&(Global_99725[443]), 4, 0x41f00000, 0x42200000, 0);
									iVar0 = 1;
								}
							}
							else
							{
								uLocal_349 = CREATE_LAYOUT("RCM_Blackwater3_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_348)
							{
								if (StackVal && FABS((StackVal - !Function_171(&Global_54076, 1, 1))) > 2.0f)
								{
									if (Function_167(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
									{
					...
					case 0x00000003:
						if (Function_122("$/cutscene/fenway_3_pt_a_cs/fenway_3_pt_a_cs", &iLocal_336, 33686, 33679, 32383, 32071, 31810, 31794, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_121("Blackwater3_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							Function_112(&Global_99725[443] + 312, &Global_99725[443] + 320, "UseCase1", 4294967295, 1, 2);
							iLocal_368 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
							iLocal_369 = 0;
							while (iLocal_369 <= iLocal_368)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iLocal_369), 4, 0);
								iLocal_369++;
							}
							TASK_PRIORITY_SET(&uLocal_370, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_370, 1, 1, false, 1, 0, 2, 1101004800, 1088421888, 1);
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "blackwater3_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x5AB / 1451
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xA25 / 2597
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xBC6 / 3014
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xBCC / 3020
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xC0B / 3083
{
...
void Function_6() //Position: 0xC60 / 3168
{
	Function_33();
	Function_32();
	Function_32();
...
void Function_7() //Position: 0xCAB / 3243
{
...
void Function_8() //Position: 0xDB1 / 3505
{
	float fVar0;
...
void Function_9() //Position: 0xDE4 / 3556
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0xF77 / 3959
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x1130 / 4400
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x113E / 4414
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x135B / 4955
{
...
struct<8> Function_14(int iParam0) //Position: 0x1370 / 4976
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x1417 / 5143
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x16B3 / 5811
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_17(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_190(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_17(int iParam0) //Position: 0x1CF1 / 7409
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1D02 / 7426
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0) //Position: 0x1DF9 / 7673
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1E14 / 7700
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x1E7B / 7803
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x1E8D / 7821
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1E9F / 7839
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x1FD3 / 8147
{
	return Global_55480[iParam016].f_96;
}

float Function_25(int iParam0) //Position: 0x1FE2 / 8162
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x201B / 8219
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x2058 / 8280
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x21F2 / 8690
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x2436 / 9270
{
...
struct<8> Function_30() //Position: 0x2477 / 9335
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x2500 / 9472
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x2597 / 9623
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x2616 / 9750
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x2653 / 9811
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x285F / 10335
{
	struct<2> Var0;
	var uVar2;
...
bool Function_36(char* cParam0) //Position: 0x2916 / 10518
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_37(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x292E / 10542
{
	int iVar0;
...
struct<8> Function_38() //Position: 0x2A26 / 10790
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_39(int iParam0) //Position: 0x2A30 / 10800
{
...
int Function_40(bool bParam0, bool bParam1) //Position: 0x2A46 / 10822
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_41(struct<2> Param0, struct<2> Param2) //Position: 0x2B12 / 11026
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_42(float fParam0, int iParam1) //Position: 0x2B2F / 11055
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_43(int iParam0) //Position: 0x335B / 13147
{
	var uVar0;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x3396 / 13206
{
	return (uParam0 && iParam1) == 0;
}

void Function_45(var uParam0, int iParam1) //Position: 0x33A3 / 13219
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_46(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x33B2 / 13234
{
	uParam0 = &uParam0;
...
void Function_47(int iParam0) //Position: 0x3461 / 13409
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_48(int iParam0) //Position: 0x3D82 / 15746
{
...
bool Function_49(int iParam0) //Position: 0x3D9C / 15772
{
...
bool Function_50(int iParam0, int iParam1) //Position: 0x3DB3 / 15795
{
	int iVar0;
...
var Function_51() //Position: 0x3DD0 / 15824
{
	return STRING_TO_HASH(Function_52());
}

var Function_52() //Position: 0x3DDC / 15836
{
	return "ZOMBIE_STORY";
}

bool Function_53(int iParam0) //Position: 0x3DF1 / 15857
{
...
int Function_54(int iParam0) //Position: 0x3E57 / 15959
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_55(int iParam0) //Position: 0x3F19 / 16153
{
...
void Function_56(int iParam0) //Position: 0x3F2E / 16174
{
	...
	Function_111(Function_51(), 0);
	return;
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x3F77 / 16247
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x3FB5 / 16309
{
...
bool Function_59(int iParam0) //Position: 0x3FCF / 16335
{
...
void Function_60(int iParam0) //Position: 0x3FE5 / 16357
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_61(struct<229> Param0) //Position: 0x41A1 / 16801
{
	float fVar0;
	int iVar1;
...
void Function_62(struct<217> Param0) //Position: 0x4271 / 17009
{
	float fVar0;
	var uVar1;
...
int Function_63(var uParam0, int iParam1) //Position: 0x432F / 17199
{
	int iVar0;
	var uVar1;
...
void Function_64(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4499 / 17561
{
	struct<8> Var0;
...
struct<32> Function_65(char* cParam0) //Position: 0x4541 / 17729
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_66(char* cParam0) //Position: 0x45AD / 17837
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x45CF / 17871
{
	int iVar0;
	struct<2> Var1;
...
float Function_68(int iParam0, struct<2> Param1) //Position: 0x473D / 18237
{
	struct<2> Var0;
...
struct<8> Function_69(int iParam0) //Position: 0x47B4 / 18356
{
	struct<2> Var0;
...
void Function_70(int iParam0) //Position: 0x4820 / 18464
{
...
bool Function_71(int iParam0) //Position: 0x4888 / 18568
{
...
void Function_72(struct<153> Param0) //Position: 0x489E / 18590
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
void Function_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4DB4 / 19892
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_74(int iParam0) //Position: 0x4E3F / 20031
{
	char* cVar0[16];
...
bool Function_75() //Position: 0x4E7E / 20094
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_76(int iParam0) //Position: 0x4EAB / 20139
{
...
var Function_77(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4ED7 / 20183
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_78(int iParam0) //Position: 0x4EF8 / 20216
{
...
bool Function_79(struct<249> Param0) //Position: 0x4F0D / 20237
{
...
bool Function_80(struct<265> Param0) //Position: 0x503D / 20541
{
	int iVar0;
...
bool Function_81(int iParam0) //Position: 0x519E / 20894
{
	if (!Function_49(iParam0))
	{
		return 0;
...
bool Function_82(int iParam0) //Position: 0x51C2 / 20930
{
...
bool Function_83(int iParam0) //Position: 0x51D7 / 20951
{
	return Global_116927[iParam06].f_16;
}

bool Function_84(struct<237> Param0) //Position: 0x51E7 / 20967
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_85(int iParam0) //Position: 0x52B6 / 21174
{
...
bool Function_86(int iParam0) //Position: 0x5311 / 21265
{
	int iVar0;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x532D / 21293
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x534A / 21322
{
...
int Function_89(int iParam0) //Position: 0x535F / 21343
{
...
void Function_90() //Position: 0x5374 / 21364
{
...
int Function_91(int iParam0, int iParam1) //Position: 0x53F4 / 21492
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_92(int iParam0) //Position: 0x6057 / 24663
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x60A6 / 24742
{
...
int Function_94(int iParam0) //Position: 0x60BC / 24764
{
...
void Function_95() //Position: 0x6125 / 24869
{
...
bool Function_96(int iParam0) //Position: 0x614A / 24906
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x619B / 24987
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x61C8 / 25032
{
	if (!Function_93(iParam0))
	{
...
void Function_99(int iParam0) //Position: 0x621A / 25114
{
	int iVar0;
...
void Function_100() //Position: 0x6254 / 25172
{
	bool bVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x62B2 / 25266
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_102(int iParam0) //Position: 0x62C8 / 25288
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6312 / 25362
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x6387 / 25479
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x63C1 / 25537
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x643D / 25661
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x64DE / 25822
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x651B / 25883
{
...
bool Function_109() //Position: 0x652E / 25902
{
...
void Function_110(int iParam0, int iParam1) //Position: 0x6549 / 25929
{
...
void Function_111(char* cParam0, bool bParam1) //Position: 0x6567 / 25959
{
	bool bVar0;
...
int Function_112(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x658C / 25996
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		Function_113(&uParam0, 5, GET_OBJECT_FROM_GRINGO(&uParam1), &uParam4, 1);
	}
	else
	{
		return 0;
...
int Function_113(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x6639 / 26169
{
	char* cVar0[32];
	...
	Function_118(&uParam0, 0);
	Function_117(&uParam0, uParam1);
	Function_116(&uParam0, &uParam2);
	Function_115(&uParam0, uParam3);
	if (Function_114(&uParam0) != 5)
	{
...
int Function_114(int iParam0) //Position: 0x68A5 / 26789
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_115(var uParam0, bool bParam1) //Position: 0x68C9 / 26825
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_116(var uParam0, int iParam1) //Position: 0x68ED / 26861
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_117(var uParam0, bool bParam1) //Position: 0x6913 / 26899
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_118(var uParam0, bool bParam1) //Position: 0x693A / 26938
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_119(bool bParam0) //Position: 0x695E / 26974
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_120() //Position: 0x697D / 27005
{
...
void Function_121(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x69CC / 27084
{
	struct<4> Var0;
	var uVar4;
...
bool Function_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6A61 / 27233
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_123(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6B1A / 27418
{
	if (!&bParam15)
	{
		Function_139(&iParam1, &uParam10);
	}
	switch (iParam1)
	{
		case 0x000003E8:
			if (uParam3 != 99 && (Function_138(&Param2) || Param2.f_40 < 1))
			{
				iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_135())
					{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_131(&iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_131(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && uParam3 == 99) && !Function_138(&Param2))
			{
...
void Function_124(var uParam0, bool bParam1) //Position: 0x717C / 29052
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_125() //Position: 0x724B / 29259
{
	int iVar0;
...
void Function_126() //Position: 0x72C3 / 29379
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_127() //Position: 0x7308 / 29448
{
...
void Function_128(bool bParam0) //Position: 0x731A / 29466
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_129(var uParam0, int iParam1) //Position: 0x7337 / 29495
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_130(int iParam0) //Position: 0x73C9 / 29641
{
	bool bVar0;
...
float Function_131(vector3 vParam0) //Position: 0x73FA / 29690
{
...
bool Function_132(int iParam0) //Position: 0x74C7 / 29895
{
	return Function_44(iParam0, 2);
}

bool Function_133(int iParam0) //Position: 0x74D5 / 29909
{
	return Function_44(iParam0, 1);
}

int Function_134(bool bParam0) //Position: 0x74E3 / 29923
{
	bool bVar0;
	var uVar1;
...
bool Function_135() //Position: 0x75A6 / 30118
{
	bool bVar0;
	var uVar1;
...
void Function_136(int iParam0) //Position: 0x75E3 / 30179
{
	Function_137(&iParam0, 0.0f);
	return;
}

void Function_137(vector3 vParam0) //Position: 0x75F0 / 30192
{
...
bool Function_138(struct<37> Param0) //Position: 0x7615 / 30229
{
	return Param0.f_36;
}

void Function_139(var uParam0, int iParam1) //Position: 0x7620 / 30240
{
	Function_140(&uParam0, &iParam1, 0);
	return;
}

void Function_140(var uParam0, bool bParam1, int iParam2) //Position: 0x7630 / 30256
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_141(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x77A8 / 30632
{
	int iVar0;
	int iVar1;
...
void Function_142(bool bParam0) //Position: 0x79D0 / 31184
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_143(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7A6E / 31342
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_144() //Position: 0x7A98 / 31384
{
	var uVar0;
	var uVar1;
...
void Function_145() //Position: 0x7AF3 / 31475
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_146() //Position: 0x7C32 / 31794
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_147() //Position: 0x7C42 / 31810
{
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_148(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_385);
	return 1;
}

void Function_148(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7C63 / 31843
{
	var uVar0;
...
void Function_149() //Position: 0x7D32 / 32050
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_150() //Position: 0x7D47 / 32071
{
	Function_151(33, 0, 1);
	ACTOR_SET_NEXT_EQUIP_SLOT(&Global_54076, 0, 0);
	ACTOR_PUT_WEAPON_IN_HAND(&Global_54076, 33, 0);
	RESET_ACTIONTREE_FOR_ACTOR(&Global_54076);
	ACTOR_POP_NEXT_GAIT(&Global_54076, 0, 0);
	if (!Function_108(Global_119934, 8))
	{
		Function_103(&Global_54076, 8, 1, 0);
	}
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(761,964f, 78,306f, 1299,636f), 176,586f, 1, 1, true);
	ACTOR_POP_NEXT_GAIT(&Global_54076, 1, 0);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 2.0f, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_370, Vector(772,88f, 78,623f, 1292,734f), 0.0f, 1, 1, true);
	TASK_HIDE_AT_COVER(&uLocal_370, &(uLocal_372[0]), -1.0f, 6.0f, 0);
	TASK_PRIORITY_SET(&uLocal_370, 2);
	CLEAR_AREA_OF_GRASS(StackVal, Vector(762,913f, 78,306f, 1291,57f), 3.0f);
	SET_DRAW_OBJECT(&uLocal_382, 1);
	return 1;
}

int Function_151(bool bParam0, bool bParam1, int iParam2) //Position: 0x7E13 / 32275
{
	...
	if (!ACTOR_HAS_WEAPON(Function_13(), bParam0))
	{
		GIVE_WEAPON_TO_ACTOR(Function_13(), bParam0, 1.0f, &iParam2, 1);
		return 1;
	}
	if (&bParam1)
	{
		_ADD_AMMO_OF_TYPE(Function_13(), GET_AMMO_ENUM(bParam0), GET_WEAPON_MAX_AMMO(bParam0), 0, &iParam2);
		return 1;
	}
	return 1;
}

bool Function_152(int iParam0) //Position: 0x7E6D / 32365
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int Function_153() //Position: 0x7E7F / 32383
{
	if (!iLocal_384)
	{
		SET_DRAW_OBJECT(&uLocal_382, 0);
		Function_154(StackVal, Local_365, &uLocal_385);
		iLocal_384 = 1;
	}
	return 1;
}

void Function_154(vector3 vParam0) //Position: 0x7EA5 / 32421
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_155(int iParam0, int iParam1) //Position: 0x804F / 32847
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_156(float fParam0, float fParam1) //Position: 0x8144 / 33092
{
...
void Function_157() //Position: 0x8255 / 33365
{
...
void Function_158() //Position: 0x8289 / 33417
{
...
int Function_159() //Position: 0x838F / 33679
{
	return 1;
}

int Function_160() //Position: 0x8396 / 33686
{
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("MISC_BlackwaterDaughter", &uLocal_370);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	uLocal_385 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "tempcutscenevol", 2, *(&Global_99725[443] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 15.0f, 20.0f));
	Function_163(0, 0, 1, 1, 0, 1, 1, &uLocal_385, 1, 1, 1, 1, 0x3f800000, 0);
	Function_161(StackVal, &uLocal_349, *(&Global_99725[443] + 196), &uLocal_385, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_161(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8455 / 33877
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_162(var uParam0, float fParam1) //Position: 0x86F5 / 34549
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_163(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8777 / 34679
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_164(int iParam0) //Position: 0x8A29 / 35369
{
	int iVar0;
...
var Function_165() //Position: 0x8A5D / 35421
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_166(bool bParam0) //Position: 0x8AEB / 35563
{
	struct<2> Var0;
...
bool Function_167(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8AFD / 35581
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_168(vector3 vParam0) //Position: 0x8D32 / 36146
{
	var uVar0;
...
float Function_169(var uParam0, bool bParam1) //Position: 0x8DA8 / 36264
{
	struct<2> Var0;
...
void Function_170(var uParam0, bool bParam1) //Position: 0x8DC9 / 36297
{
	var uVar0;
	var uVar1;
...
bool Function_171(int iParam0, bool bParam1, bool bParam2) //Position: 0x8E33 / 36403
{
...
bool Function_172() //Position: 0x8EF7 / 36599
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_173(int iParam0) //Position: 0x8F0E / 36622
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_174(bool bParam0) //Position: 0x8F1A / 36634
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_175() //Position: 0x8F29 / 36649
{
	if (IS_DOOR_VALID(&uLocal_378))
	{
		Function_181(&uLocal_378, 0);
	}
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
		RELEASE_LAYOUT_REF(&uLocal_349);
	}
	Function_177(&uLocal_351);
	Function_176(0, 0, 0);
	return;
}

int Function_176(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8F5F / 36703
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_177(int iParam0) //Position: 0x8F91 / 36753
{
	int iVar0;
...
void Function_178(struct<2>[] Param0, int iParam1) //Position: 0x8FB9 / 36793
{
...
void Function_179(struct<13> Param0) //Position: 0x9104 / 37124
{
	int iVar0;
...
bool Function_180(struct<13> Param0) //Position: 0x9121 / 37153
{
	int iVar0;
...
void Function_181(var uParam0, int iParam1) //Position: 0x913F / 37183
{
...
void Function_182(var uParam0, int iParam1) //Position: 0x9197 / 37271
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_183(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x91A8 / 37288
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_184(struct<257> Param0) //Position: 0x9333 / 37683
{
...
int Function_185(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x936F / 37743
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_186() //Position: 0x95D7 / 38359
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_187(char* cParam0) //Position: 0x962B / 38443
{
	char* cVar0[64];
...
bool Function_188(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9754 / 38740
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_69(&uParam0);
...
int Function_189() //Position: 0x97E0 / 38880
{
	if (IS_PS3())
	{
		return 1;
...
var Function_190() //Position: 0x97EF / 38895
{
	int iVar0;
...
bool Function_191(struct<2>[] Param0) //Position: 0x97F8 / 38904
{
	int iVar0;
	int iVar1;
...
void Function_192() //Position: 0x9BBA / 39866
{
	if (!Function_86(128))
	{
		return;
...
bool Function_193() //Position: 0x9BFA / 39930
{
	int iVar0;
...
void Function_194(struct<13> Param0) //Position: 0x9C28 / 39976
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_195() //Position: 0x9C3B / 39995
{
	if (!Function_86(128))
	{
		return;
...
void Function_196(var uParam0, int iParam1) //Position: 0x9C7D / 40061
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
int Function_197(var uParam0, var uParam1, int iParam2) //Position: 0x9CD8 / 40152
{
	return Function_198(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_198(int iParam0, char* cParam1, bool bParam3) //Position: 0x9CEC / 40172
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_199(int iParam0) //Position: 0x9D91 / 40337
{
	if (!Function_71(iParam0))
	{
		return 1;
...
void Function_200() //Position: 0x9DAD / 40365
{
	Function_201(4, 1);
	Function_182(&Global_99725[443] + 228, 128);
	ACTOR_DATA_GRAVITY_LIMIT(0);
	Function_175();
	TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
	return;
...
void Function_201(int iParam0, bool bParam1) //Position: 0x9DD3 / 40403
{
	char* cVar0[32];
...
bool Function_202() //Position: 0x9F5C / 40796
{
	if (IS_ACTOR_VALID(&uLocal_370))
	{
		if (GET_LAST_ATTACKER(&uLocal_370) == &Global_54076)
		{
			return 1;
		}
	}
...
var Function_203(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x9F7D / 40829
{
	int iVar0;
...
var Function_204(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA059 / 41049
{
	int iVar0;
	var uVar1;
...
var Function_205(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA097 / 41111
{
	int iVar0;
