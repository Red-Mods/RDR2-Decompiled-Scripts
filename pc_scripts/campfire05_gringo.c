...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 1, 1, "ped_wilderness", 5,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
...
void Function_1(struct<473> Param0) //Position: 0x149 / 329
{
	int iVar0;
...
void Function_2() //Position: 0x2F7 / 759
{
	return;
}

void Function_3() //Position: 0x2FD / 765
{
	Function_4();
	return;
}

void Function_4() //Position: 0x306 / 774
{
...
void Function_5(int iParam0) //Position: 0x319 / 793
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x341 / 833
{
...
void Function_7(struct<13> Param0) //Position: 0x48C / 1164
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x4A9 / 1193
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4C7 / 1223
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_10(struct<62> Param0) //Position: 0x1686 / 5766
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1698 / 5784
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x18D1 / 6353
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18F1 / 6385
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x19DF / 6623
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C4B / 7243
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C6F / 7279
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C93 / 7315
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1CB9 / 7353
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1CE0 / 7392
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1D04 / 7428
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1D23 / 7459
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D72 / 7538
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1DCE / 7630
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DEF / 7663
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E4A / 7754
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E96 / 7830
{
...
void Function_27(struct<425> Param0) //Position: 0x1EAB / 7851
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1FFE / 8190
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x2073 / 8307
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x20DF / 8415
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x20F7 / 8439
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x2155 / 8533
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x21A2 / 8610
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x221B / 8731
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x226A / 8810
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x2433 / 9267
{
...
void Function_37(int iParam0) //Position: 0x2470 / 9328
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2489 / 9353
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x2496 / 9366
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x258B / 9611
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x264A / 9802
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x265D / 9821
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x2724 / 10020
{
...
bool Function_44(int iParam0) //Position: 0x2744 / 10052
{
...
bool Function_45(int iParam0) //Position: 0x2768 / 10088
{
...
bool Function_46(int iParam0) //Position: 0x277D / 10109
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x2794 / 10132
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x27D2 / 10194
{
...
bool Function_49(int iParam0) //Position: 0x27EC / 10220
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x2802 / 10242
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x283C / 10300
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x2921 / 10529
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2AD8 / 10968
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2AFD / 11005
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B4B / 11083
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2CA2 / 11426
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D4D / 11597
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DF3 / 11763
{
	if (Function_59(&iParam1))
	{
		*(&iParam0 + 24) = &iLocal_0;
		*(&iParam0 + 448) = CREATE_OBJECTSET_IN_LAYOUT(Function_98(), &iParam0 + 24, 12, 1);
		ADD_OBJECT_TO_OBJECTSET(&iLocal_0 + 144, &iParam0 + 448);
		*(&iParam0 + 352) = &iLocal_0 + 176;
		GRINGO_ALLOW_ACTIVATION(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 144), false);
		return 1;
	}
	return 0;
}

bool Function_59(var uParam0) //Position: 0x2E4C / 11852
{
	var uVar0;
	...
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "campfire_talk", Vector(1,158346f, 0.0f, -0,9169326f), Vector(0.0f, -415,7296f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 144) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground1", "Rand_Idle_Sit_Ground_Player", Vector(-1,464181f, 0.0f, 1,251049f), Vector(0.0f, -46,55199f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 144), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn", "Rand_Idle_Sit_Ground_nospawn", Vector(0,4153011f, 0.0f, -2,516103f), Vector(0.0f, -192,8973f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn1", "Rand_Idle_Sit_Ground_nospawn", Vector(-1,755083f, 0.0f, -0,9669206f), Vector(0.0f, 244,3821f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "smoking_stand_campfire", "Sit_Ground_Campfire_Tend", Vector(0,1971079f, 0.0f, 1,107491f), Vector(0.0f, 7,880068f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 152) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp2", "horse_stay", Vector(4,312188f, 0.0f, -1,631144f), Vector(0.0f, 113,9858f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 152), 0);
	*(&iLocal_0 + 160) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp3", "horse_stay", Vector(2,218224f, 0.0f, -2,985008f), Vector(0.0f, 216,0832f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 160), 1);
	*(&iLocal_0 + 168) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground2", "Rand_Idle_Sit_Ground", Vector(4,272917f, 0.0f, 1,290696f), Vector(0.0f, 57,19401f, 0.0f));
	...
	*(&iLocal_0 + 184) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Pee_nospawn1", "Pee_nospawn", Vector(-2,286529f, 0.0f, -4,153373f), Vector(0.0f, 17,57659f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 184), 0);
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, int iParam1) //Position: 0x33FE / 13310
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x3449 / 13385
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x3487 / 13447
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x349A / 13466
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3569 / 13673
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x35B3 / 13747
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3975 / 14709
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x39B5 / 14773
{
	int iVar0;
...
void Function_68() //Position: 0x39E3 / 14819
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3A25 / 14885
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3ABD / 15037
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3AEC / 15084
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3B47 / 15175
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3B57 / 15191
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3B6B / 15211
{
	int iVar0;
...
var Function_75() //Position: 0x3B90 / 15248
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3BA7 / 15271
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3CE3 / 15587
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3CF5 / 15605
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3D07 / 15623
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3D19 / 15641
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3D3E / 15678
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3D5D / 15709
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3D69 / 15721
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3D74 / 15732
{
	int iVar0;
...
var Function_85() //Position: 0x3DA2 / 15778
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3DB7 / 15799
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3EC4 / 16068
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3ED8 / 16088
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x3F44 / 16196
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3F66 / 16230
{
	return "PBox_";
}

var Function_91() //Position: 0x3F74 / 16244
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3F9A / 16282
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3FC2 / 16322
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3FE8 / 16360
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x415A / 16730
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x4202 / 16898
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x4370 / 17264
{
...
var Function_98() //Position: 0x43D8 / 17368
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x43E1 / 17377
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x43FF / 17407
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x46F8 / 18168
{
	int iVar0;
...
void Function_102() //Position: 0x47AC / 18348
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x47E7 / 18407
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4814 / 18452
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x496F / 18799
{
...
void Function_106() //Position: 0x4986 / 18822
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x49D2 / 18898
{
	int iVar0;
...
int Function_108() //Position: 0x4AAE / 19118
{
	int iVar0;
...
int Function_109() //Position: 0x4C0A / 19466
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4D2A / 19754
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4E06 / 19974
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4E25 / 20005
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x4F68 / 20328
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x4FDF / 20447
{
	var uVar0;
...
int Function_115() //Position: 0x5001 / 20481
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x5008 / 20488
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x509A / 20634
{
	int iVar0;
