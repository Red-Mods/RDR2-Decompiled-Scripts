...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_100(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_85(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_78(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_2[iVar39]));
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_118, &uLocal_116);
...
void Function_29(var uParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	var uVar0;
	int iVar2;
	...
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	Function_30(GRINGO_GET_MY_OBJECT_REF());
	uVar0 = Function_30(GRINGO_GET_MY_OBJECT_REF());
	iVar2 = FIND_NEAREST_DOOR(&uVar0, 1.0f);
	OPEN_DOOR_DIRECTION(&iVar2, 1);
	SET_DOOR_CURRENT_SPEED(&iVar2, 2.0f, 2.0f);
	return;
}

struct<8> Function_30(int iParam0) //Position: 0x2028 / 8232
{
	struct<2> Var0;
...
bool Function_31(int iParam0) //Position: 0x2051 / 8273
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x205E / 8286
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(int iParam0, int iParam1) //Position: 0x2079 / 8313
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x2099 / 8345
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x20B9 / 8377
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x20F0 / 8432
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2110 / 8464
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x212B / 8491
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2141 / 8513
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x2465 / 9317
{
	int iVar0;
...
bool Function_41(int iParam0, int iParam1) //Position: 0x246E / 9326
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x248D / 9357
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(int iParam0, int iParam1) //Position: 0x249C / 9372
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(int iParam0, int iParam1) //Position: 0x24C0 / 9408
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x24E6 / 9446
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2504 / 9476
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x2526 / 9510
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(int iParam0, int iParam1) //Position: 0x2548 / 9544
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x2610 / 9744
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x268C / 9868
{
...
void Function_51(vector3 vParam0) //Position: 0x26A4 / 9892
{
...
var Function_52(int iParam0) //Position: 0x26C9 / 9929
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x26EA / 9962
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x2701 / 9985
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x270D / 9997
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x2714 / 10004
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x2725 / 10021
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x276A / 10090
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x2796 / 10134
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x27A2 / 10146
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x28A4 / 10404
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x28C7 / 10439
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x28EF / 10479
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BD6 / 11222
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2C33 / 11315
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2C90 / 11408
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2C9C / 11420
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2CBB / 11451
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2CD2 / 11474
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2D63 / 11619
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D87 / 11655
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2DA6 / 11686
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2DCA / 11722
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2EF2 / 12018
{
...
int Function_75(var uParam0) //Position: 0x2F20 / 12064
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x3039 / 12345
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x3046 / 12358
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x30C8 / 12488
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3673 / 13939
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x36AD / 13997
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x36CB / 14027
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x370C / 14092
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x3718 / 14104
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x373A / 14138
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x374C / 14156
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x385C / 14428
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x3874 / 14452
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x3B90 / 15248
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3BA2 / 15266
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3BBC / 15292
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3BD7 / 15319
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3C15 / 15381
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3C2E / 15406
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3F26 / 16166
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3F44 / 16196
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3FE4 / 16356
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x4005 / 16389
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x4018 / 16408
{
...
void Function_99(int iParam0) //Position: 0x4034 / 16436
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4040 / 16448
{
	int iVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x40AC / 16556
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x40C4 / 16580
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x40D0 / 16592
{
