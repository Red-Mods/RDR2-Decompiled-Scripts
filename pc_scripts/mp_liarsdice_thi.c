...
void Function_75() //Position: 0x1A86 / 6790
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_264 = CREATE_LAYOUT("LiarsDice_THI_layout");
	(&iLocal_264 + 208) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "StayOutVol", 2,802597E-45f, Vector(168,1897f, 74,0396f, 2223,022f), Vector(0.0f, 0.0f, 0.0f), Vector(6,013074f, 6,013074f, 6,013074f));
	*(&iLocal_264 + 216) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_264, 8, 0);
	*(&iLocal_264 + 224[03]) = Vector(165,9416f, 73,73709f, 2225,637f);
	*(&iLocal_264 + 224[03] + 12) = Vector(0.0f, 334,2308f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "PlayerPosition", Vector(165,9416f, 73,73709f, 2225,637f), Vector(0.0f, 334,2308f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_264 + 216);
	*(&iLocal_264 + 224[13]) = Vector(166,4469f, 73,74529f, 2222,88f);
	*(&iLocal_264 + 224[13] + 12) = Vector(0.0f, 265,4082f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_0_Position", Vector(166,4469f, 73,74529f, 2222,88f), Vector(0.0f, 265,4082f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_264 + 216);
	*(&iLocal_264 + 224[23]) = Vector(167,3883f, 73,74529f, 2221,372f);
	*(&iLocal_264 + 224[23] + 12) = Vector(0.0f, -142,6472f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_1_Position", Vector(167,3883f, 73,74529f, 2221,372f), Vector(0.0f, -142,6472f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_264 + 216);
	*(&iLocal_264 + 224[33]) = Vector(169,1183f, 73,74081f, 2221,351f);
	*(&iLocal_264 + 224[33] + 12) = Vector(0.0f, -207,7465f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_2_Position", Vector(169,1183f, 73,74081f, 2221,351f), Vector(0.0f, -207,7465f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_264 + 216);
	*(&iLocal_264 + 224[43]) = Vector(170,2189f, 73,74529f, 2223,219f);
	*(&iLocal_264 + 224[43] + 12) = Vector(0.0f, 461,8926f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_3_Position", Vector(170,2189f, 73,74529f, 2223,219f), Vector(0.0f, 461,8926f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_264 + 216);
	*(&iLocal_264 + 224[53]) = Vector(169,3252f, 73,74529f, 2224,675f);
	*(&iLocal_264 + 224[53] + 12) = Vector(0.0f, 389,3722f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_4_Position", Vector(169,3252f, 73,74529f, 2224,675f), Vector(0.0f, 389,3722f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_264 + 216);
	*(&iLocal_264 + 376) = Vector(168,1746f, 74,54424f, 2222,892f);
	*(&iLocal_264 + 376 + 12) = Vector(0.0f, 72,52222f, 0.0f);
	*(&iLocal_264 + 400) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "TableCenter", Vector(168,1746f, 74,54424f, 2222,892f), Vector(0.0f, 72,52222f, 0.0f));
	*(&iLocal_264 + 408) = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", &iLocal_264, 8, 0);
	*(&iLocal_264 + 416[03]) = Vector(166,8756f, 73,74156f, 2229,654f);
	*(&iLocal_264 + 416[03] + 12) = Vector(0.0f, -239,9064f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Waitress_0_Pos", Vector(166,8756f, 73,74156f, 2229,654f), Vector(0.0f, -239,9064f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_264 + 408);
	*(&iLocal_264 + 416[13]) = Vector(166,7213f, 73,74156f, 2231,473f);
	*(&iLocal_264 + 416[13] + 12) = Vector(0.0f, 96,24262f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Waitress_1_Pos", Vector(166,7213f, 73,74156f, 2231,473f), Vector(0.0f, 96,24262f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_264 + 408);
	*(&iLocal_264 + 472) = Vector(167,5964f, 73,74156f, 2222,775f);
	*(&iLocal_264 + 472 + 12) = Vector(0.0f, -122,439f, 0.0f);
	*(&iLocal_264 + 496) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_0", Vector(167,5964f, 73,74156f, 2222,775f), Vector(0.0f, -122,439f, 0.0f));
	*(&iLocal_264 + 504) = Vector(167,958f, 73,74529f, 2222,327f);
	*(&iLocal_264 + 504 + 12) = Vector(0.0f, 175,5729f, 0.0f);
	*(&iLocal_264 + 528) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_1", Vector(167,958f, 73,74529f, 2222,327f), Vector(0.0f, 175,5729f, 0.0f));
	*(&iLocal_264 + 536) = Vector(168,5496f, 73,74591f, 2222,387f);
	*(&iLocal_264 + 536 + 12) = Vector(0.0f, 119,8881f, 0.0f);
	*(&iLocal_264 + 560) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_2", Vector(168,5496f, 73,74591f, 2222,387f), Vector(0.0f, 119,8881f, 0.0f));
	*(&iLocal_264 + 568) = Vector(168,7889f, 73,74529f, 2222,935f);
	*(&iLocal_264 + 568 + 12) = Vector(0.0f, 59,51451f, 0.0f);
	*(&iLocal_264 + 592) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_3", Vector(168,7889f, 73,74529f, 2222,935f), Vector(0.0f, 59,51451f, 0.0f));
	*(&iLocal_264 + 600) = Vector(168,4313f, 73,74976f, 2223,425f);
	*(&iLocal_264 + 600 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_264 + 624) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_4", Vector(168,4313f, 73,74976f, 2223,425f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_264 + 632) = Vector(167,8298f, 73,74976f, 2223,35f);
	*(&iLocal_264 + 632 + 12) = Vector(0.0f, -62,86256f, 0.0f);
	*(&iLocal_264 + 656) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_5", Vector(167,8298f, 73,74976f, 2223,35f), Vector(0.0f, -62,86256f, 0.0f));
	return;
}

void Function_76(int iParam0, int iParam1) //Position: 0x20FC / 8444
{
	switch (&iParam1)
	{
		case 0x00000000:
