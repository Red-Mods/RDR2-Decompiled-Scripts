...
void main() //Position: 0x0 / 0
{
	...
	bLocal_340 = false;
	iLocal_341 = 0;
	Local_344 = Vector(-2096,052f, 16,449f, 2605,648f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000005:
						if (Function_123("$/cutscene/RCM_05_CS01/RCM_05_CS01", &iLocal_326, 30416, 30388, 28271, 28144, 27888, 27851, 1, 1, 2, 2, 0))
						{
							iVar0 = 8;
						}
						break;
					...
					case 0x00000008:
						...
						Function_111("Cannibal1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Cannibal1_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_108(406, 1, 0, 0);
						Function_104(Global_46760[6]);
						Function_58(15, 1, 1, 0);
						Function_4(Global_42265[29].f_64);
						Function_122(&Global_99725[ScriptParam_043] + 228, 256);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x225 / 549
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x257 / 599
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x274 / 628
{
	RELEASE_LAYOUT_REF(&iLocal_347);
	return;
}

void Function_4(int iParam0) //Position: 0x281 / 641
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_5(struct<229> Param0) //Position: 0x43B / 1083
{
	float fVar0;
	int iVar1;
...
void Function_6(struct<217> Param0) //Position: 0x50B / 1291
{
	float fVar0;
	var uVar1;
...
int Function_7(var uParam0, int iParam1) //Position: 0x5C9 / 1481
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0x733 / 1843
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0x7DB / 2011
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0x847 / 2119
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0x869 / 2153
{
	int iVar0;
	struct<2> Var1;
...
float Function_12(int iParam0, struct<2> Param1) //Position: 0x9D7 / 2519
{
	struct<2> Var0;
...
struct<8> Function_13(int iParam0) //Position: 0xA4E / 2638
{
	struct<2> Var0;
...
void Function_14(int iParam0) //Position: 0xABA / 2746
{
...
bool Function_15(int iParam0) //Position: 0xB22 / 2850
{
...
var Function_16() //Position: 0xB38 / 2872
{
	int iVar0;
...
void Function_17(struct<153> Param0) //Position: 0xB41 / 2881
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_18(int iParam0) //Position: 0xCB0 / 3248
{
...
var Function_19(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xCDC / 3292
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_20(int iParam0) //Position: 0xCFD / 3325
{
...
bool Function_21(struct<249> Param0) //Position: 0xD12 / 3346
{
...
bool Function_22(struct<265> Param0) //Position: 0xE42 / 3650
{
	int iVar0;
...
bool Function_23(int iParam0) //Position: 0xFA3 / 4003
{
...
bool Function_24(int iParam0) //Position: 0xFC7 / 4039
{
...
bool Function_25(int iParam0) //Position: 0xFDC / 4060
{
...
var Function_26(int iParam0) //Position: 0xFF3 / 4083
{
...
bool Function_27(int iParam0) //Position: 0x100D / 4109
{
...
bool Function_28(int iParam0) //Position: 0x1023 / 4131
{
	return Global_116927[iParam06].f_16;
}

bool Function_29(var uParam0, int iParam1) //Position: 0x1033 / 4147
{
	int iVar0;
...
bool Function_30(struct<237> Param0) //Position: 0x1050 / 4176
{
	if (!Param0.f_236)
	{
		if (Function_31())
...
bool Function_31() //Position: 0x111F / 4383
{
...
bool Function_32(int iParam0) //Position: 0x113A / 4410
{
...
void Function_33(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1195 / 4501
{
	bool bVar0;
	char* cVar1[16];
...
void Function_34(char* cParam0) //Position: 0x120A / 4618
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_35(int iParam0, var uParam1, int iParam2) //Position: 0x1244 / 4676
{
	var uVar0;
	char* cVar1[16];
...
int Function_36(char* cParam0) //Position: 0x12C0 / 4800
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_37(int iParam0) //Position: 0x1361 / 4961
{
	int iVar0;
	int iVar1;
...
void Function_38(int iParam0, int iParam1) //Position: 0x139E / 5022
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x13B4 / 5044
{
...
bool Function_40(int iParam0) //Position: 0x13C7 / 5063
{
	int iVar0;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x13E3 / 5091
{
	int iVar0;
...
int Function_42(int iParam0) //Position: 0x1400 / 5120
{
...
bool Function_43(int iParam0) //Position: 0x1415 / 5141
{
...
int Function_44(int iParam0) //Position: 0x142A / 5162
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x143F / 5183
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x144C / 5196
{
...
int Function_47(int iParam0, int iParam1) //Position: 0x14CC / 5324
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_48(char* cParam0) //Position: 0x212F / 8495
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_49(int iParam0, bool bParam1) //Position: 0x2147 / 8519
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x2185 / 8581
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x21D4 / 8660
{
...
int Function_52(int iParam0) //Position: 0x21EA / 8682
{
...
void Function_53() //Position: 0x2253 / 8787
{
...
bool Function_54(int iParam0) //Position: 0x2278 / 8824
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x22C9 / 8905
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x22F6 / 8950
{
	if (!Function_51(iParam0))
	{
...
void Function_57(int iParam0) //Position: 0x2348 / 9032
{
	int iVar0;
...
void Function_58(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2382 / 9090
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x291A / 10522
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_60() //Position: 0x2ABB / 10939
{
	return;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2AC1 / 10945
{
	if (Global_6624)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x2B00 / 11008
{
...
void Function_63() //Position: 0x2B55 / 11093
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_64() //Position: 0x2BA0 / 11168
{
...
void Function_65() //Position: 0x2CA6 / 11430
{
	float fVar0;
...
void Function_66() //Position: 0x2CD9 / 11481
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x2E6C / 11884
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3025 / 12325
{
	Function_69(&Global_42918, 1, 0);
	return;
}

void Function_69(struct<2317> Param0) //Position: 0x3033 / 12339
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x3250 / 12880
{
...
struct<8> Function_71(int iParam0) //Position: 0x3265 / 12901
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x330C / 13068
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x35A8 / 13736
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_74(int iParam0) //Position: 0x3BE6 / 15334
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3BF7 / 15351
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x3CEE / 15598
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3D09 / 15625
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x3D70 / 15728
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x3D82 / 15746
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3D94 / 15764
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x3EC8 / 16072
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x3ED7 / 16087
{
	if (!iParam0 != 4294967295)
	{
...
float Function_83(int iParam0) //Position: 0x3F10 / 16144
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x3F4D / 16205
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
void Function_104(int iParam0) //Position: 0x5409 / 21513
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_105(int iParam0, int iParam1) //Position: 0x54FA / 21754
{
	bool bVar0;
...
var Function_106(int iParam0) //Position: 0x5564 / 21860
{
	int iVar0;
...
void Function_107(var uParam0, int iParam1) //Position: 0x55BC / 21948
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_108(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x55CD / 21965
{
	int iVar0;
	int iVar1;
...
void Function_109(int iParam0) //Position: 0x57F5 / 22517
{
	switch (iParam0)
	{
		case 0x00000009:
...
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-2099,061f, 18,898f, 2603,111f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}
...
{
	Function_146(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_342);
	return 1;
}

void Function_146(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6D0C / 27916
{
	var uVar0;
...
void Function_147() //Position: 0x6DDB / 28123
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_148() //Position: 0x6DF0 / 28144
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[1543] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[1543] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2093,284f, 16,449f, 2608,706f), 52,267f, 1, 1, true);
	ACTOR_POP_NEXT_GAIT(&Global_54076, 1, 0);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1073741824, 0);
	return 1;
}

int Function_149() //Position: 0x6E6F / 28271
{
	if (!iLocal_341)
	{
		Function_152(StackVal, Local_344, &uLocal_342);
		Function_150(StackVal, &iLocal_347, (&Global_99725[1543] + 196), &uLocal_342, 0, 0, 0, 0, 1, 1);
		iLocal_341 = 1;
	}
	return 1;
}

void Function_150(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x6EA9 / 28329
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_151(var uParam0, int iParam1) //Position: 0x7149 / 29001
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_152(vector3 vParam0) //Position: 0x71CB / 29131
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_48(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_153(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_153(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_153(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_153(int iParam0, int iParam1) //Position: 0x7374 / 29556
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_154(float fParam0, float fParam1) //Position: 0x7469 / 29801
{
...
void Function_155() //Position: 0x757A / 30074
{
...
void Function_156() //Position: 0x75AE / 30126
{
...
int Function_157() //Position: 0x76B4 / 30388
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-2099,061f, 18,898f, 2603,111f), 0, 0);
	return 1;
}

int Function_158() //Position: 0x76D0 / 30416
{
	uLocal_342 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_347, "tempcutscenevol", 2, *(&Global_99725[1543] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(6.0f, 6.0f, 6.0f));
	Function_159(0, 0, 1, 1, 0, 1, 1, &uLocal_342, 1, 1, 1, 1, 0x3f800000, 0);
	return 1;
}

void Function_159(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7721 / 30497
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_162(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_16(), 2, Function_162(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_160(int iParam0) //Position: 0x79D3 / 31187
{
	int iVar0;
...
var Function_161() //Position: 0x7A07 / 31239
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_162(int iParam0) //Position: 0x7A95 / 31381
{
	struct<2> Var0;
...
int Function_163(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7AA7 / 31399
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_164(struct<257> Param0) //Position: 0x7C32 / 31794
{
...
int Function_165(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7C6E / 31854
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_166() //Position: 0x7ED6 / 32470
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_167(char* cParam0) //Position: 0x7F2A / 32554
{
	char* cVar0[64];
...
bool Function_168(var uParam0, struct<2> Param1, float fParam3) //Position: 0x8055 / 32853
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_13(&uParam0);
...
int Function_169() //Position: 0x80E1 / 32993
{
	if (IS_PS3())
	{
		return 1;
...
void Function_170() //Position: 0x80F0 / 33008
{
	var uVar0;
	
	Function_171(4, 1);
	uVar0 = &uVar0;
	iLocal_347 = CREATE_LAYOUT("CannibalFamily_layout");
	return;
}

void Function_171(int iParam0, int iParam1) //Position: 0x8120 / 33056
{
	switch (&iParam1)
	{
		case 0x00000000:
