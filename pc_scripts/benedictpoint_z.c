...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_456, Function_87(), bScriptParam_0);
				Function_47(&uLocal_494, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_456);
	Function_8(&uLocal_494);
	Function_6();
...
void Function_10(int iParam0, int iParam1, int iParam2) //Position: 0x52A / 1322
{
	int iVar0;
...
void Function_11(int iParam0, int iParam1, bool bParam2) //Position: 0x614 / 1556
{
	int iVar0;
...
void Function_20() //Position: 0x87F / 2175
{
...
void Function_21(int iParam0) //Position: 0x892 / 2194
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x8BA / 2234
{
...
void Function_23(struct<13> Param0) //Position: 0xA05 / 2565
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xA22 / 2594
{
	int iVar0;
...
bool Function_26(int iParam0) //Position: 0xAFA / 2810
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB16 / 2838
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xB89 / 2953
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, int iParam1) //Position: 0xBA6 / 2982
{
	return (uParam0 && iParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xBB3 / 2995
{
...
void Function_31(int iParam0) //Position: 0xF1A / 3866
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0xF81 / 3969
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x12C9 / 4809
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x15A9 / 5545
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1CFF / 7423
{
...
int Function_36(int iParam0) //Position: 0x1D14 / 7444
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D36 / 7478
{
	int iVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1DBF / 7615
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1DDF / 7647
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1E54 / 7764
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1E8E / 7822
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F0A / 7946
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x1FAB / 8107
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x1FE8 / 8168
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x1FFE / 8190
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x2011 / 8209
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x202B / 8235
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x244C / 9292
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x245F / 9311
{
	int iVar0;
...
int Function_50(int iParam0, int iParam1) //Position: 0x247C / 9340
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x248E / 9358
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x2518 / 9496
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x2970 / 10608
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2A61 / 10849
{
...
float Function_55(int iParam0) //Position: 0x2A9E / 10910
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2AD7 / 10967
{
	int iVar0;
...
var Function_57(int iParam0) //Position: 0x2B41 / 11073
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2B99 / 11161
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2DC1 / 11713
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2E5F / 11871
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x349D / 13469
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34A6 / 13478
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x34B7 / 13495
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x35AE / 13742
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x35C9 / 13769
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3630 / 13872
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3642 / 13890
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x3776 / 14198
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x3785 / 14213
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, float fParam1, bool bParam2) //Position: 0x391F / 14623
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3B63 / 15203
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3B70 / 15216
{
...
var Function_73(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x3B9A / 15258
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3E4D / 15949
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3EC0 / 16064
{
...
bool Function_76(bool bParam0) //Position: 0x3EF6 / 16118
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3F6C / 16236
{
...
bool Function_78() //Position: 0x3F7D / 16253
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3F96 / 16278
{
...
bool Function_80(int iParam0) //Position: 0x3FAC / 16300
{
...
bool Function_81(int iParam0) //Position: 0x3FC1 / 16321
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3FDF / 16351
{
	uParam0 = &uParam0;
...
var Function_104(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6923 / 26915
{
	var uVar0;
...
void Function_111(bool bParam0, float fParam1, bool bParam2) //Position: 0x6C51 / 27729
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
int Function_127(int iParam0) //Position: 0x82A3 / 33443
{
	if (iParam0 == 4294967295)
	{
...
int Function_132(int iParam0, float fParam1, int iParam2) //Position: 0x84C0 / 33984
{
	int iVar0;
	int iVar1;
...
var Function_162(var uParam0, int iParam1, int iParam2) //Position: 0xA0C5 / 41157
{
	int iVar0;
...
bool Function_176(var uParam0, int iParam1, bool bParam2) //Position: 0xAEFF / 44799
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_187(var uParam0, var uParam1, int iParam2) //Position: 0xB62F / 46639
{
	int iVar0;
	var uVar1;
...
void Function_196(bool bParam0, float fParam1) //Position: 0xBD38 / 48440
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", fParam1);
	return;
}

void Function_197(var uParam0, int iParam1) //Position: 0xBD5C / 48476
{
...
void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC164 / 49508
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC272 / 49778
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC280 / 49792
{
...
void Function_213() //Position: 0xC29F / 49823
{
...
void Function_214(var uParam0) //Position: 0xC2BB / 49851
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC2C5 / 49861
{
	return;
}

void Function_216(int iParam0) //Position: 0xC2CB / 49867
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC2D5 / 49877
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC2EF / 49903
{
	int iVar0;
...
void Function_219() //Position: 0xC30C / 49932
{
	return;
}

void Function_220() //Position: 0xC312 / 49938
{
	return;
}

void Function_221(int iParam0) //Position: 0xC318 / 49944
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC322 / 49954
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC626 / 50726
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC832 / 51250
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC843 / 51267
{
	int iVar0;
	var uVar1;
	float fVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF2A / 53034
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, float fParam1, float fParam2, float fParam3) //Position: 0xCF39 / 53049
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCF8A / 53130
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xCFD9 / 53209
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD00D / 53261
{
	int iVar0;
...
var Function_231(int iParam0, int iParam1) //Position: 0xD02A / 53290
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD0E0 / 53472
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD14C / 53580
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD16E / 53614
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD174 / 53620
{
...
int Function_236(int iParam0) //Position: 0xD197 / 53655
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD1B3 / 53683
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD1BA / 53690
{
	Function_239(&uLocal_494, &cLocal_7, "house01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_494, &cLocal_7, "trainStation01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_494, &cLocal_7, "trainStation01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_494, &cLocal_7, "trainStation01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_494, &cLocal_7, "trainStation01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD286 / 53894
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD389 / 54153
{
	int iVar0;
...
void Function_241() //Position: 0xD3BA / 54202
{
	Function_242(&uLocal_9, &uLocal_456, 4, &iLocal_248 + 32, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_456, 5, &iLocal_248 + 8, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_456, 5, &iLocal_248 + 640, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_456, 5, &iLocal_248 + 16, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_456, 5, &iLocal_248 + 24, 4294967295, 264);
	Function_242(&uLocal_9, &uLocal_456, 5, &iLocal_248 + 648, 4294967295, 266);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD42C / 54316
{
...
void Function_243(struct<5> Param0) //Position: 0xD519 / 54553
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD52A / 54570
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, int iParam1, bool bParam2) //Position: 0xD5A0 / 54688
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD63E / 54846
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD647 / 54855
{
	cLocal_7 = Function_248(&iLocal_178, "benedictpoint", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD668 / 54888
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD68B / 54923
{
	return Function_250();
}

int Function_250() //Position: 0xD694 / 54932
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_248 = FIND_NAMED_LAYOUT("BenedictPoint_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_248))
	{
		iLocal_248 = CREATE_LAYOUT("BenedictPoint_layout");
	}
	*(&iLocal_248 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_station", 2,802597E-45f, Vector(-3690,035f, 9,508358f, 3472,207f), Vector(0.0f, 358,8154f, 0.0f), Vector(8,2f, 6,283404f, 10,75f));
	*(&iLocal_248 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_house", 2,802597E-45f, Vector(-3668,806f, 9,508358f, 3490,977f), Vector(0.0f, 15.0f, 0.0f), Vector(5,05f, 3,818571f, 9,650508f));
	*(&iLocal_248 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_eating_area", 2,802597E-45f, Vector(-3675,456f, 9,273419f, 3474,542f), Vector(0.0f, 0.0f, 0.0f), Vector(3,183692f, 3,435052f, 7,906288f));
	*(&iLocal_248 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_region", 4,203895E-45f, Vector(-3672,268f, 22,08688f, 3472,788f), Vector(0.0f, -2,475537f, 0.0f), Vector(39,25807f, 17,84807f, 56,83197f));
	*(&iLocal_248 + 136) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_crows_set");
	*(&iLocal_248 + 40[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder11", 4,203895E-45f, Vector(-3659,183f, 25,11299f, 3501,407f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[0]);
	*(&iLocal_248 + 40[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder1", 4,203895E-45f, Vector(-3690,701f, 25,11299f, 3437,034f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[1]);
	*(&iLocal_248 + 40[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder2", 4,203895E-45f, Vector(-3661,622f, 25,11299f, 3455,487f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[2]);
	*(&iLocal_248 + 40[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder3", 4,203895E-45f, Vector(-3690,701f, 25,11299f, 3475,313f), Vector(0.0f, 4,239945f, 0.0f), Vector(13,18543f, 21,64164f, 16,25232f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[3]);
	*(&iLocal_248 + 40[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder4", 4,203895E-45f, Vector(-3683,224f, 25,11299f, 3505,853f), Vector(0.0f, 20.0f, 0.0f), Vector(7,352065f, 21,64164f, 5,33606f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[4]);
	*(&iLocal_248 + 40[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder5", 4,203895E-45f, Vector(-3663,107f, 33,99499f, 3437,863f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[5]);
	*(&iLocal_248 + 40[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder6", 4,203895E-45f, Vector(-3669,573f, 25,11299f, 3490,848f), Vector(0.0f, 20.0f, 0.0f), Vector(7,716234f, 21,64164f, 7,89005f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[6]);
	*(&iLocal_248 + 40[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder7", 4,203895E-45f, Vector(-3677,142f, 25,11299f, 3473,505f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[7]);
	*(&iLocal_248 + 40[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder8", 4,203895E-45f, Vector(-3690,701f, 25,11299f, 3488,257f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[8]);
	*(&iLocal_248 + 40[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "nCylinder9", 4,203895E-45f, Vector(-3680,66f, 25,11299f, 3495,866f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[9]);
	*(&iLocal_248 + 40[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder10", 4,203895E-45f, Vector(-3690,701f, 25,11299f, 3504f), Vector(0.0f, 20.0f, 0.0f), Vector(5,735975f, 21,64164f, 4,612089f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 136, &iLocal_248 + 40[10]);
	*(&iLocal_248 + 216) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_vultures_set");
	*(&iLocal_248 + 144[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder18", 4,203895E-45f, Vector(-3655,472f, 17,41255f, 3498,873f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[0]);
	*(&iLocal_248 + 144[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder17", 4,203895E-45f, Vector(-3690,685f, 17,41255f, 3449,538f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[1]);
	*(&iLocal_248 + 144[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder16", 4,203895E-45f, Vector(-3689,109f, 17,41255f, 3497,248f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[2]);
	*(&iLocal_248 + 144[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder15", 4,203895E-45f, Vector(-3665,429f, 18,88692f, 3438,698f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[3]);
	*(&iLocal_248 + 144[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder14", 4,203895E-45f, Vector(-3672,121f, 16,39698f, 3503,361f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[4]);
	*(&iLocal_248 + 144[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder13", 4,203895E-45f, Vector(-3676,716f, 16,39698f, 3455,342f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[5]);
	*(&iLocal_248 + 144[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder12", 4,203895E-45f, Vector(-3662,563f, 16,39698f, 3481,176f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[6]);
	*(&iLocal_248 + 144[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder19", 4,203895E-45f, Vector(-3655,472f, 16,39698f, 3464f), Vector(0.0f, 20.0f, 0.0f), Vector(6,023086f, 20,08011f, 7,523242f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 216, &iLocal_248 + 144[7]);
	*(&iLocal_248 + 288) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_rabbits_set");
	*(&iLocal_248 + 224[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder26", 4,203895E-45f, Vector(-3660,205f, 8,031368f, 3499,277f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[0]);
	*(&iLocal_248 + 224[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder20", 4,203895E-45f, Vector(-3684.0f, 8,031368f, 3437,59f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[1]);
	*(&iLocal_248 + 224[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder21", 4,203895E-45f, Vector(-3650,905f, 8,031368f, 3459,587f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[2]);
	*(&iLocal_248 + 224[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder22", 4,203895E-45f, Vector(-3674,461f, 8,031368f, 3509,889f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[3]);
	*(&iLocal_248 + 224[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder23", 4,203895E-45f, Vector(-3677,217f, 8,031368f, 3458,184f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[4]);
	*(&iLocal_248 + 224[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder24", 4,203895E-45f, Vector(-3666,25f, 8,031368f, 3476,29f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[5]);
	*(&iLocal_248 + 224[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder25", 4,203895E-45f, Vector(-3690,99f, 8,031368f, 3501,663f), Vector(0.0f, 20.0f, 0.0f), Vector(4,246298f, 3,228842f, 3,633897f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 288, &iLocal_248 + 224[6]);
	*(&iLocal_248 + 344) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_raccoons_set");
	*(&iLocal_248 + 296[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder31", 4,203895E-45f, Vector(-3660,002f, 8,230818f, 3495,822f), Vector(0.0f, 20.0f, 0.0f), Vector(4,167985f, 2,396038f, 4,123489f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 344, &iLocal_248 + 296[0]);
	*(&iLocal_248 + 296[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder27", 4,203895E-45f, Vector(-3685,417f, 8,230818f, 3439,028f), Vector(0.0f, 20.0f, 0.0f), Vector(4,167985f, 2,396038f, 4,123489f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 344, &iLocal_248 + 296[1]);
	*(&iLocal_248 + 296[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder28", 4,203895E-45f, Vector(-3649,13f, 8,230818f, 3457,252f), Vector(0.0f, 20.0f, 0.0f), Vector(4,167985f, 2,396038f, 4,123489f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 344, &iLocal_248 + 296[2]);
	*(&iLocal_248 + 296[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder29", 4,203895E-45f, Vector(-3667,869f, 8,230818f, 3478,334f), Vector(0.0f, 20.0f, 0.0f), Vector(4,167985f, 2,396038f, 4,123489f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 344, &iLocal_248 + 296[3]);
	*(&iLocal_248 + 296[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder30", 4,203895E-45f, Vector(-3679,803f, 8,230818f, 3450,869f), Vector(0.0f, 20.0f, 0.0f), Vector(4,167985f, 2,396038f, 4,123489f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 344, &iLocal_248 + 296[4]);
	*(&iLocal_248 + 432) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_snakes_set");
	*(&iLocal_248 + 352[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder40", 4,203895E-45f, Vector(-3679,316f, 8,761167f, 3442,452f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[0]);
	*(&iLocal_248 + 352[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder32", 4,203895E-45f, Vector(-3658,174f, 8,761167f, 3461,599f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[1]);
	*(&iLocal_248 + 352[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder33", 4,203895E-45f, Vector(-3679,316f, 8,761167f, 3523,094f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[2]);
	*(&iLocal_248 + 352[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder34", 4,203895E-45f, Vector(-3658,501f, 8,761167f, 3488,595f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[3]);
	*(&iLocal_248 + 352[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder35", 4,203895E-45f, Vector(-3696,01f, 8,761167f, 3508,713f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[4]);
	*(&iLocal_248 + 352[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder36", 4,203895E-45f, Vector(-3679,316f, 8,761167f, 3455,715f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[5]);
	*(&iLocal_248 + 352[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder37", 4,203895E-45f, Vector(-3693,983f, 8,761167f, 3453,043f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[6]);
	*(&iLocal_248 + 352[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder38", 4,203895E-45f, Vector(-3687,727f, 8,761167f, 3494,49f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[7]);
	*(&iLocal_248 + 352[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder39", 4,203895E-45f, Vector(-3670,813f, 8,761167f, 3504f), Vector(0.0f, 20.0f, 0.0f), Vector(3,527383f, 3,591761f, 4,034165f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 432, &iLocal_248 + 352[8]);
	*(&iLocal_248 + 496) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_owls_set");
	*(&iLocal_248 + 440[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder46", 4,203895E-45f, Vector(-3664,002f, 20,23113f, 3445,652f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[0]);
	*(&iLocal_248 + 440[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder41", 4,203895E-45f, Vector(-3688,903f, 20,23113f, 3528,066f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[1]);
	*(&iLocal_248 + 440[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder42", 4,203895E-45f, Vector(-3679,567f, 20,23113f, 3434,895f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[2]);
	*(&iLocal_248 + 440[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder43", 4,203895E-45f, Vector(-3647,286f, 20,23113f, 3456,865f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[3]);
	*(&iLocal_248 + 440[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder44", 4,203895E-45f, Vector(-3651,339f, 20,23113f, 3484,503f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[4]);
	*(&iLocal_248 + 440[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder45", 4,203895E-45f, Vector(-3664,002f, 20,23113f, 3499,999f), Vector(0.0f, 20.0f, 0.0f), Vector(5,123412f, 19,08964f, 5,230203f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 496, &iLocal_248 + 440[5]);
	*(&iLocal_248 + 552) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_dogs_set");
	*(&iLocal_248 + 504[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder50", 4,203895E-45f, Vector(-3684,002f, 11,43245f, 3459,023f), Vector(0.0f, 20.0f, 0.0f), Vector(4,410245f, 4,93786f, 4,626956f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 552, &iLocal_248 + 504[0]);
	*(&iLocal_248 + 504[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder49", 4,203895E-45f, Vector(-3679,94f, 11,43245f, 3478,157f), Vector(0.0f, 20.0f, 0.0f), Vector(4,410245f, 4,93786f, 4,626956f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 552, &iLocal_248 + 504[1]);
	*(&iLocal_248 + 504[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder48", 4,203895E-45f, Vector(-3684,002f, 11,43245f, 3493,334f), Vector(0.0f, 20.0f, 0.0f), Vector(4,410245f, 4,93786f, 4,626956f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 552, &iLocal_248 + 504[2]);
	*(&iLocal_248 + 504[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder47", 4,203895E-45f, Vector(-3665,639f, 11,43245f, 3468,916f), Vector(0.0f, 20.0f, 0.0f), Vector(4,410245f, 4,93786f, 4,626956f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 552, &iLocal_248 + 504[3]);
	*(&iLocal_248 + 504[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder51", 4,203895E-45f, Vector(-3665,417f, 11,43245f, 3492,502f), Vector(0.0f, 20.0f, 0.0f), Vector(4,410245f, 4,93786f, 4,626956f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 552, &iLocal_248 + 504[4]);
	*(&iLocal_248 + 608) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_train_set");
	*(&iLocal_248 + 560[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder58", 4,203895E-45f, Vector(-3687,54f, 10,16598f, 3483,035f), Vector(0.0f, 20.0f, 0.0f), Vector(3,060091f, 2,789393f, 4,211166f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 608, &iLocal_248 + 560[0]);
	*(&iLocal_248 + 560[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder53", 4,203895E-45f, Vector(-3691,714f, 10,16598f, 3479,768f), Vector(0.0f, 20.0f, 0.0f), Vector(3,934453f, 2,789393f, 3,105485f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 608, &iLocal_248 + 560[1]);
	*(&iLocal_248 + 560[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder54", 4,203895E-45f, Vector(-3691,296f, 10,16598f, 3465,885f), Vector(0.0f, 3,350196f, 0.0f), Vector(2,404188f, 2,789393f, 1,54993f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 608, &iLocal_248 + 560[2]);
	*(&iLocal_248 + 560[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder56", 4,203895E-45f, Vector(-3690,052f, 10,16598f, 3473,045f), Vector(0.0f, 20.0f, 0.0f), Vector(3,15938f, 2,789393f, 2,616548f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 608, &iLocal_248 + 560[3]);
	*(&iLocal_248 + 560[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Cylinder57", 4,203895E-45f, Vector(-3692,199f, 10,16598f, 3484,899f), Vector(0.0f, 20.0f, 0.0f), Vector(3,7221f, 2,789393f, 2,991706f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 608, &iLocal_248 + 560[4]);
	*(&iLocal_248 + 640) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_248, "benv_TrnPlatform_set");
	*(&iLocal_248 + 616[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Box", 2,802597E-45f, Vector(-3696,749f, 10,32725f, 3475,957f), Vector(0.0f, 0.0f, 0.0f), Vector(3,239367f, 6,043555f, 24,25914f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 640, &iLocal_248 + 616[0]);
	*(&iLocal_248 + 616[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "Box1", 2,802597E-45f, Vector(-3689,937f, 9,882474f, 3482,532f), Vector(0.0f, 0.0f, 0.0f), Vector(11,00425f, 6,273331f, 10,46097f));
	ADD_TO_VOLUME_SET(&iLocal_248 + 640, &iLocal_248 + 616[1]);
	*(&iLocal_248 + 648) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_stables", 2,802597E-45f, Vector(-3683,318f, 9,647223f, 3505,356f), Vector(0,4220771f, 4,370803f, 0,9893484f), Vector(13,49625f, 3,800715f, 5,547434f));
	*(&iLocal_248 + 656) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_dinner", 4,203895E-45f, Vector(-3676,488f, 8,443946f, 3476,815f), Vector(0.0f, 3,87444f, 0.0f), Vector(5,382018f, 3,233917f, 8,059525f));
	*(&iLocal_248 + 664) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_248, "benv_train_tickets", 2,802597E-45f, Vector(-3690,738f, 8,761167f, 3475,852f), Vector(0.0f, 0.0f, 0.0f), Vector(14,454f, 14,454f, 23,98269f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_clear_bounty", Vector(-3691,207f, 9,847f, 3470,861f), Vector(0.0f, 17,52f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_report_crime_road", Vector(-3718,07f, 7,807744f, 3483,963f), Vector(0.0f, 99,826f, 0.0f));
	*(&iLocal_248 + 672) = Vector(-3691,211f, 9,540363f, 3472,469f);
	*(&iLocal_248 + 672 + 12) = Vector(0.0f, 91,049f, 0.0f);
	*(&iLocal_248 + 696) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_interiorPoint_train", Vector(-3691,211f, 9,540363f, 3472,469f), Vector(0.0f, 91,049f, 0.0f));
	*(&iLocal_248 + 704) = Vector(-3668,753f, 8,50267f, 3490,64f);
	*(&iLocal_248 + 704 + 12) = Vector(0.0f, 108,4156f, 0.0f);
	*(&iLocal_248 + 728) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_interiorPoint_house", Vector(-3668,753f, 8,50267f, 3490,64f), Vector(0.0f, 108,4156f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos1", Vector(-3717,172f, 14,174f, 3433,614f), Vector(-10,771f, -137,166f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos2", Vector(-3714,935f, 26,471f, 3525,966f), Vector(-13,12f, -44,003f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos3", Vector(-3636,63f, 30,629f, 3510,744f), Vector(-15,985f, 44,576f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos4", Vector(-3759,687f, 35,412f, 3423,31f), Vector(-12,891f, -128,399f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos5", Vector(-3737,317f, 22,069f, 3571,805f), Vector(-5,443f, -28,476f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos6", Vector(-3677,55f, 10,311f, 3434,616f), Vector(1,89f, 149,943f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos7", Vector(-3674,437f, 13,887f, 3467,653f), Vector(-9,312f, 146,446f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos8", Vector(-3656,893f, 9,64f, 3467,87f), Vector(-5,836f, 128,678f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos9", Vector(-3712,332f, 14,909f, 3467,278f), Vector(-6,052f, -121,816f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "ben_vista_cam_pos10", Vector(-3690,923f, 9,768f, 3508,547f), Vector(4,285f, -21,319f, 0.0f));
	*(&iLocal_248 + 736) = Vector(-3692,117f, 9,540363f, 3472,486f);
	*(&iLocal_248 + 736 + 12) = Vector(0.0f, 91,049f, 0.0f);
	*(&iLocal_248 + 760) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "player_shop_flag", Vector(-3692,117f, 9,540363f, 3472,486f), Vector(0.0f, 91,049f, 0.0f));
	*(&iLocal_248 + 768) = Vector(-3668,471f, 8,50267f, 3491,285f);
	*(&iLocal_248 + 768 + 12) = Vector(0.0f, 94,5275f, 0.0f);
	*(&iLocal_248 + 792) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_interiorSettlement01", Vector(-3668,471f, 8,50267f, 3491,285f), Vector(0.0f, 94,5275f, 0.0f));
	*(&iLocal_248 + 800) = Vector(-3690,588f, 9,540363f, 3473,248f);
	*(&iLocal_248 + 800 + 12) = Vector(0.0f, 81,70078f, 0.0f);
	*(&iLocal_248 + 824) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_248, "benf_interiorSettlement02", Vector(-3690,588f, 9,540363f, 3473,248f), Vector(0.0f, 81,70078f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xF1C0 / 61888
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xF20A / 61962
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xF21B / 61979
{
	return;
}

bool Function_254() //Position: 0xF221 / 61985
{
	return 1;
}

void Function_255() //Position: 0xF228 / 61992
{
	return;
}

bool Function_256() //Position: 0xF22E / 61998
{
	return Function_257();
}

int Function_257() //Position: 0xF237 / 62007
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	Function_251(3, 3);
	uVar0 = &uVar0;
	Function_169(&iLocal_178 + 8, "$/content/scripting/gringo/simplegringo/player_sleep_bed_l", 1, 0);
	Function_169(&iLocal_178 + 8, "$/content/scripting/gringo/simplegringo/dlc_survivor_roof_rfl", 1, 0);
	if (!Function_164(&iLocal_178 + 8))
	{
		return 0;
	}
	iLocal_178 = FIND_NAMED_LAYOUT("BenedictPoint_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("BenedictPoint_layout");
	}
	*(&iLocal_178 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-3683,373f, 13,192f, 3505,481f), Vector(0.0f, 5,124197f, 0.0f), Vector(12,68468f, 5.0f, 5,522659f));
	*(&iLocal_178 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-3676,802f, 11,35464f, 3474,665f), Vector(0.0f, 0,1138366f, 0.0f), Vector(9,105152f, 7,561514f, 9,620157f));
	*(&iLocal_178 + 64) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	*(&iLocal_178 + 72[03]) = Vector(-3683,489f, 11,3901f, 3505,163f);
	*(&iLocal_178 + 72[03] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01", Vector(-3683,489f, 11,3901f, 3505,163f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar1, "Core", 1);
	DECOR_SET_INT(&uVar1, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 64);
	*(&iLocal_178 + 104) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	*(&iLocal_178 + 112[03]) = Vector(-3677,014f, 11,16944f, 3477,565f);
	*(&iLocal_178 + 112[03] + 12) = Vector(0.0f, -186,0478f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-3677,014f, 11,16944f, 3477,565f), Vector(0.0f, -186,0478f, 0.0f));
	DECOR_SET_BOOL(&uVar2, "Core", 1);
	DECOR_SET_INT(&uVar2, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 104);
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	*(&iLocal_178 + 152[03]) = Vector(-3683,476f, 11,3901f, 3503,677f);
	*(&iLocal_178 + 152[03] + 12) = Vector(0.0f, 4,06298f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-3683,476f, 11,3901f, 3503,677f), Vector(0.0f, 4,06298f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 144);
	*(&iLocal_178 + 184) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	*(&iLocal_178 + 192[03]) = Vector(-3692,865f, 9,527859f, 3476,358f);
	*(&iLocal_178 + 192[03] + 12) = Vector(0.0f, -45.0f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-3692,865f, 9,527859f, 3476,358f), Vector(0.0f, -45.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 184);
	*(&iLocal_178 + 224) = Vector(-3669,226f, 8,477426f, 3491,648f);
	*(&iLocal_178 + 224 + 12) = Vector(0.0f, 106,1693f, 0.0f);
	*(&iLocal_178 + 248) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-3669,226f, 8,477426f, 3491,648f), Vector(0.0f, 106,1693f, 0.0f));
	*(&iLocal_178 + 256) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_sleep_bed_L", "player_sleep_bed_L", Vector(-3669,929f, 8,495793f, 3488,021f), Vector(0.0f, 104,8883f, 0.0f));
	*(&iLocal_178 + 264) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-3683,477f, 11,16774f, 3503,68f), Vector(0.0f, 4,290238f, 0.0f));
	PushArrayP();
	*(&iLocal_178 + 272) = CREATE_PATH_IN_LAYOUT_FROM_TABLE(StackVal, &iLocal_178, "benp_patrolpath");
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xF817 / 63511
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xF8B2 / 63666
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xF9BE / 63934
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xFA9A / 64154
{
...
int Function_262(int iParam0) //Position: 0xFB15 / 64277
{
...
bool Function_263(int iParam0) //Position: 0xFB2A / 64298
{
...
int Function_264(int iParam0) //Position: 0xFB90 / 64400
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xFC52 / 64594
{
	int iVar0;
...
void Function_266() //Position: 0xFC6F / 64623
{
	return;
}

void Function_267(char* cParam0) //Position: 0xFC75 / 64629
{
	if (!Function_26(128))
	{
		return;
