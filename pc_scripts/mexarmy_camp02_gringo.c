...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(6, &uLocal_17, &iLocal_19, &uLocal_3, &uLocal_21, 4294967295);
	return;
}
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xED1 / 3793
{
	var uVar0;
	int iVar1;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_29 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_145(&Param0 + 324, &fLocal_31, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_134(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_31, 20.0f, fLocal_31));
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2649 / 9801
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2882 / 10370
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28A2 / 10402
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2990 / 10640
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2BFC / 11260
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C20 / 11296
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C44 / 11332
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C6A / 11370
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C91 / 11409
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CB5 / 11445
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CD4 / 11476
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D23 / 11555
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D7F / 11647
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DA0 / 11680
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2DFB / 11771
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E47 / 11847
{
...
void Function_46(struct<425> Param0) //Position: 0x2E5C / 11868
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FAF / 12207
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3024 / 12324
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x303C / 12348
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x309A / 12442
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30E7 / 12519
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x3160 / 12640
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31AF / 12719
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x326E / 12910
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3281 / 12929
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x3348 / 13128
{
...
bool Function_57(int iParam0) //Position: 0x3368 / 13160
{
...
bool Function_58(int iParam0) //Position: 0x338C / 13196
{
...
bool Function_59(int iParam0) //Position: 0x33A1 / 13217
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33B8 / 13240
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x33F6 / 13302
{
...
bool Function_62(int iParam0) //Position: 0x3410 / 13328
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x3426 / 13350
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3460 / 13408
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3545 / 13637
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_66(var uParam0, bool bParam1) //Position: 0x36FC / 14076
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3721 / 14113
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x376F / 14191
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38C6 / 14534
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3971 / 14705
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A17 / 14871
{
	...
	if (Function_80(&uLocal_17, &uLocal_3, 26, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		cLocal_25 = Function_78(Global_46850[0], "escalera", "villaWall04", 1);
		uLocal_27 = Function_78(Global_46850[0], "escalera", "villaWall04", 2);
		if (IS_DOOR_VALID(&cLocal_25) && IS_DOOR_VALID(&uLocal_27))
		{
			if (Function_76(&uLocal_23, "mexarmy02mobile", &iParam1))
			{
				iLocal_19 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_23, Function_134()));
				*(&Global_6667[2628] + 216) = &iLocal_19;
...
void Function_72() //Position: 0x3B34 / 15156
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	uLocal_21 = CREATE_LAYOUT("mexarmy02campfirelayout");
	Var0 = Vector(-4378,167f, 38,70368f, 4360,536f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_17, Var0, 157,073f, 1, 1, 1);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_17, 1);
	TASK_STAND_STILL(&uLocal_17, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(&uLocal_17);
	uVar2 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(StackVal, Vector(-4378,167f, 38,70368f, 4360,536f), 1.0f, "chair", 1);
	if (IS_PHYSINST_VALID(&uVar2))
	{
		uVar3 = GET_OBJECT_FROM_PHYSINST(&uVar2);
		if (IS_OBJECT_VALID(&uVar3))
		{
			SET_PROP_FIXED(GET_PHYSINST_FROM_OBJECT(&uVar3), 1);
			uVar4 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar3, Function_134(), "stool_sit_attach", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	...
	Function_74(&uLocal_17, &iLocal_19, 1, 1);
	uVar5 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_21, "mexarmy02_standing", 380, Vector(-4375,56f, 38,70368f, 4361,607f), Vector(0.0f, 204,8539f, 0.0f));
	uVar6 = Vector(-4397,508f, 37,866f, 4364,564f);
	GIVE_WEAPON_TO_ACTOR(&uVar5, 13, false, 1, 1);
	bVar8 = TASK_SEQUENCE_OPEN();
	TASK_DRAW_HOLSTER_WEAPON(0, 1);
	TASK_FACE_COORD(0, &uVar6, 1);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM(&uVar5, bVar8);
	TASK_SEQUENCE_RELEASE(bVar8, 1);
	AI_IGNORE_ACTOR(&uVar5);
	Function_74(&uVar5, &iLocal_19, 1, 1);
	uVar5 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_21, "mexarmy02_sitting", 381, Vector(-4378,908f, 38,70368f, 4360,293f), Vector(0.0f, 109,4863f, 0.0f));
	TASK_STAND_STILL(&uVar5, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(&uVar5);
	Function_74(&uVar5, &iLocal_19, 1, 1);
	uVar2 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(StackVal, Vector(-4378,908f, 38,70368f, 4360,293f), 1.0f, "chair", 1);
	if (IS_PHYSINST_VALID(&uVar2))
	{
		uVar9 = GET_OBJECT_FROM_PHYSINST(&uVar2);
		if (IS_OBJECT_VALID(&uVar9))
		{
			SET_PROP_FIXED(GET_PHYSINST_FROM_OBJECT(&uVar9), 1);
			uVar10 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar9, Function_134(), "stool_sit_attach", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
			SNAP_ACTOR_TO_GRINGO(&uVar5, &uVar10, "UseCase1", true, 0, 0);
			TASK_USE_GRINGO(&uVar5, GET_GRINGO_FROM_OBJECT(&uVar10), "UseCase1", 4294967295, 1);
		}
	}
	if (IS_DOOR_LOCKED(&cLocal_25))
	{
		Function_73(&cLocal_25, 1);
	}
	OPEN_DOOR_DIRECTION_FAST(&cLocal_25, 0);
	if (IS_DOOR_LOCKED(&uLocal_27))
	{
		Function_73(&uLocal_27, 1);
	}
	OPEN_DOOR_DIRECTION_FAST(&uLocal_27, 1);
	return;
}

void Function_73(var uParam0, int iParam1) //Position: 0x3DE4 / 15844
{
...
void Function_74(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3E3C / 15932
{
	bool bVar0;
	int iVar1;
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x3FF9 / 16377
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_76(var uParam0, var uParam1, int iParam2) //Position: 0x4043 / 16451
{
...
void Function_77(var uParam0, int iParam1) //Position: 0x4073 / 16499
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iParam1, Function_134(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_78(bool bParam0, char* cParam1, bool bParam3) //Position: 0x40BE / 16574
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_79(bool bParam0) //Position: 0x4163 / 16739
{
...
bool Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4179 / 16761
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4358 / 17240
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x4898 / 18584
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_83(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x48BA / 18618
{
	var uVar0;
...
var Function_84(bool bParam0, int iParam1) //Position: 0x491B / 18715
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x49A9 / 18857
{
	Function_87(&uParam0);
	Function_86(&uParam0);
...
void Function_86(int iParam0) //Position: 0x49D5 / 18901
{
...
void Function_87(int iParam0) //Position: 0x49FB / 18939
{
...
bool Function_88(bool bParam0) //Position: 0x4AD1 / 19153
{
...
var Function_89(int iParam0, int iParam1) //Position: 0x4AE8 / 19176
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x4B8E / 19342
{
	var uVar0;
	var uVar1;
...
void Function_91(var uParam0) //Position: 0x4C9D / 19613
{
	int iVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x4CD0 / 19664
{
	int iVar0;
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4CED / 19693
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_94() //Position: 0x4D79 / 19833
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x4DE9 / 19945
{
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4E05 / 19973
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4EAB / 20139
{
	var uVar0;
	var uVar1;
...
var Function_98(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4FB6 / 20406
{
	int iVar0;
	int iVar1;
...
void Function_99(struct<13> Param0) //Position: 0x4FF4 / 20468
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_100(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5007 / 20487
{
	int iVar0;
...
bool Function_101(struct<2>[] Param0) //Position: 0x50D6 / 20694
{
	int iVar0;
	int iVar1;
...
void Function_102() //Position: 0x5498 / 21656
{
	if (!Function_149(128))
	{
		return;
...
bool Function_103() //Position: 0x54D8 / 21720
{
	int iVar0;
...
void Function_104() //Position: 0x5506 / 21766
{
	if (!Function_149(128))
	{
		return;
...
void Function_105(vector3 vParam0) //Position: 0x5548 / 21832
{
	char* cVar0[32];
...
void Function_106(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x55E0 / 21984
{
	var uVar0;
	var uVar1;
...
void Function_107(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x560F / 22031
{
...
var Function_108(var uParam0, bool bParam1) //Position: 0x566A / 22122
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_109() //Position: 0x567A / 22138
{
	return "PackedGrass";
}

var Function_110(bool bParam0, bool bParam1, bool bParam2) //Position: 0x568E / 22158
{
	int iVar0;
...
var Function_111() //Position: 0x56B3 / 22195
{
	return "PackedMetadata";
}

void Function_112(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x56CA / 22218
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_113() //Position: 0x5806 / 22534
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_114() //Position: 0x5818 / 22552
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_115() //Position: 0x582A / 22570
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_116(var uParam0, struct<5> Param1) //Position: 0x583C / 22588
{
...
var Function_117(var uParam0, int iParam1, int iParam2) //Position: 0x5861 / 22625
{
	int iVar0;
...
var Function_118(bool bParam0) //Position: 0x5880 / 22656
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_119() //Position: 0x588C / 22668
{
	return Function_120(39);
}

int Function_120(int iParam0) //Position: 0x5897 / 22679
{
	int iVar0;
...
var Function_121() //Position: 0x58C5 / 22725
{
	return "PackedWeapon";
}

int Function_122(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x58DA / 22746
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_123() //Position: 0x59E7 / 23015
{
	return "MPItemGiver";
}

struct<32> Function_124(char* cParam0) //Position: 0x59FB / 23035
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_125(char* cParam0) //Position: 0x5A67 / 23143
{
	char* cVar0[32];
...
var Function_126() //Position: 0x5A89 / 23177
{
	return "PBox_";
}

var Function_127() //Position: 0x5A97 / 23191
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_128() //Position: 0x5ABD / 23229
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_129() //Position: 0x5AE5 / 23269
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_130(var uParam0, int iParam1) //Position: 0x5B0B / 23307
{
	int iVar0;
	var uVar1;
...
void Function_131(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5C75 / 23669
{
	struct<8> Var0;
...
int Function_132(bool bParam0) //Position: 0x5D1D / 23837
{
	int iVar0;
	struct<2> Var1;
...
void Function_133(int iParam0) //Position: 0x5E8B / 24203
{
...
var Function_134() //Position: 0x5EF3 / 24307
{
	int iVar0;
...
var Function_135(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5EFC / 24316
{
	return Function_136(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_136(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5F1A / 24346
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_137(int iParam0) //Position: 0x6213 / 25107
{
	int iVar0;
...
void Function_138() //Position: 0x62C7 / 25287
{
	int iVar0;
...
bool Function_139(bool bParam0) //Position: 0x6302 / 25346
{
	int iVar0;
...
void Function_140(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x632F / 25391
{
	bool bVar0;
...
void Function_141() //Position: 0x648A / 25738
{
	int iVar0;
...
var Function_142(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x64D6 / 25814
{
	int iVar0;
...
int Function_143() //Position: 0x65B2 / 26034
{
	int iVar0;
...
int Function_144() //Position: 0x670E / 26382
{
	int iVar0;
...
bool Function_145(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x682E / 26670
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_146(struct<2> Param0) //Position: 0x690A / 26890
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_147(struct<2> Param0, struct<5> Param2) //Position: 0x6929 / 26921
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_148(int iParam0) //Position: 0x6A6C / 27244
{
	var uVar0;
...
bool Function_149(int iParam0) //Position: 0x6A8E / 27278
{
	int iVar0;
...
int Function_150() //Position: 0x6AAA / 27306
{
	return 0;
}

void Function_151(struct<321> Param0) //Position: 0x6AB1 / 27313
{
	var uVar0;
