...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar1 + 360) = 2;
	if (bVar0)
	{
		Function_118(&iVar1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp02x");
	}
	else
	{
...
bool Function_59(var uParam0) //Position: 0x2E73 / 11891
{
	...
	*(&iLocal_0 + 8) = Vector(1,786425f, 0,008248952f, 1,086883f);
	*(&iLocal_0 + 8 + 12) = Vector(0.0f, 111,2571f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 8);
	*(&iLocal_0 + 32) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_horse_stay", Vector(1,786425f, 0,008248952f, 1,086883f), Vector(0.0f, 111,2571f, 0.0f));
	*(&iLocal_0 + 40) = Vector(0,6116906f, 0,002102481f, -1,21826f);
	*(&iLocal_0 + 40 + 12) = Vector(0.0f, 188,8444f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 40);
	*(&iLocal_0 + 64) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_sit", Vector(0,6116906f, 0,002102481f, -1,21826f), Vector(0.0f, 188,8444f, 0.0f));
