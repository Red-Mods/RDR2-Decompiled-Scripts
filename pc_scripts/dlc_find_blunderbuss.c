...
void main() //Position: 0x0 / 0
{
	...
	iLocal_130 = 0;
	Function_101(&uScriptParam_0, &iLocal_130);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(vLocal_20[iVar39]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_20[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_87("eGRINGO_EndUse: Stop use by request", &vLocal_20[iVar39] + 24);
							Function_86(&vLocal_20[iVar39] + 24, 1);
							...
							{
								Function_79(&(vLocal_20[iVar39]), 0);
							}
							else if (vLocal_20[iVar39].f_68 < 8)
							{
								Function_78(&(vLocal_20[iVar39]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_130 - 1))
			{
				if (Function_77(vLocal_20[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_20[iVar09])))
					{
						Function_104("Quitting due to update end");
						Function_79(&(vLocal_20[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_20[iVar09]), 0))
				{
					Function_5(&(vLocal_20[iVar09]));
				}
				iVar0++;
			}
		}
	...
	while (iVar0 < (iLocal_130 - 1))
	{
		if (Function_77(vLocal_20[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_20[iVar09] + 24);
			Function_79(&(vLocal_20[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_20[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_20[iVar09] + 16);
		}
		Function_15(&(vLocal_20[iVar09]), 1);
		iVar0++;
	}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_136, &uLocal_134);
...
bool Function_26(int iParam0, var uParam1) //Position: 0x1FBF / 8127
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_30(int iParam0) //Position: 0x200A / 8202
{
	iParam0 = &iParam0;
	return 1;
}
...
bool Function_32(int iParam0, int iParam1) //Position: 0x2032 / 8242
{
...
bool Function_40(int iParam0, int iParam1) //Position: 0x2427 / 9255
{
...
bool Function_42(int iParam0, int iParam1) //Position: 0x2455 / 9301
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2479 / 9337
{
...
void Function_47(int iParam0, int iParam1) //Position: 0x2501 / 9473
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_62(bool bParam0) //Position: 0x28A8 / 10408
{
	...
	if (!iLocal_14 && bLocal_15)
	{
		...
		iLocal_14 = 1;
		bLocal_16 = Function_63(&Global_46715, 0, &Global_54076, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28DB / 10459
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "Find_Blunderbuss", 2, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2968 / 10600
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x29AD / 10669
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 20,80526f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(16,06369f, 0,555395f, -10,22412f), Vector(1,399617f, 122,9171f, -0,315279f), Vector(0.0f, 0.0f, 0.0f), 0);
...
void Function_66(int iParam0, var uParam1) //Position: 0x2A42 / 10818
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 20,80526f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(16,75583f, 0,556772f, -9,755615f), Vector(0,42291f, 122,2682f, -0,315193f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
...
void Function_67(int iParam0) //Position: 0x2ADC / 10972
{
	iParam0 = &iParam0;
	return;
}

bool Function_68(int iParam0) //Position: 0x2AE8 / 10984
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2B07 / 11015
{
	if (!Function_14(&iParam0))
	{
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2B1E / 11038
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_71(int iParam0) //Position: 0x2BAF / 11183
{
	struct<2> Var0;
...
struct<8> Function_72(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BD3 / 11219
{
	struct<2> Var0;
...
int Function_73(int iParam0) //Position: 0x2BF2 / 11250
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(var uParam0, int iParam1) //Position: 0x2C16 / 11286
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2D3E / 11582
{
...
int Function_76(var uParam0) //Position: 0x2D6C / 11628
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2E85 / 11909
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(struct<69> Param0) //Position: 0x2E92 / 11922
{
	if (Function_77(Param0.f_64, 16))
	{
...
void Function_79(struct<69> Param0) //Position: 0x2F14 / 12052
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x34BF / 13503
{
	int iVar0;
...
int Function_81(int iParam0) //Position: 0x34F9 / 13561
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_82(int iParam0, var uParam1) //Position: 0x3517 / 13591
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_83(int iParam0) //Position: 0x3558 / 13656
{
	iParam0 = &iParam0;
	return;
}

bool Function_84(int iParam0) //Position: 0x3564 / 13668
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_85(var uParam0, int iParam1) //Position: 0x3586 / 13702
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	if (IS_OBJECT_VALID(&bLocal_16))
	{
		DESTROY_OBJECT(&bLocal_16);
	}
	AI_STOP_IGNORING_ACTOR(&uParam0);
	return;
}

void Function_86(var uParam0, bool bParam1) //Position: 0x35AE / 13742
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_87(int iParam0, int iParam1) //Position: 0x36BE / 14014
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_88(struct<69> Param0) //Position: 0x36D6 / 14038
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_89(int iParam0, int iParam1) //Position: 0x39F2 / 14834
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	bLocal_15 = IS_ACTOR_LOCAL_PLAYER(&iParam0);
	if (bLocal_15)
	{
...
bool Function_91(int iParam0) //Position: 0x3A32 / 14898
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, var uParam1) //Position: 0x3A4D / 14925
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3A8B / 14987
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_94(struct<65> Param0) //Position: 0x3AA4 / 15012
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_95(int iParam0) //Position: 0x3D9C / 15772
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3DBA / 15802
{
	struct<5> Var0;
	float fVar5;
...
int Function_97(int iParam0) //Position: 0x3E5A / 15962
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(int iParam0, var uParam1) //Position: 0x3E7A / 15994
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3E8D / 16013
{
...
void Function_100(int iParam0) //Position: 0x3EA9 / 16041
{
	iParam0 = &iParam0;
	return;
}

void Function_101(var uParam0, int iParam1) //Position: 0x3EB5 / 16053
{
	int iVar0;
	var uVar1;
	...
	{
		Function_102(&(vLocal_20[iLocal_1309]), &uParam0);
		iLocal_130++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x3F21 / 16161
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_103(int iParam0) //Position: 0x3F39 / 16185
{
	iParam0 = &iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3F45 / 16197
{
