...
void Function_82(var uParam0, bool bParam1) //Position: 0x3394 / 13204
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(char* cParam0, int iParam1) //Position: 0x34A4 / 13476
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &cParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x34BC / 13500
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x37D8 / 14296
{
	var uVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	if (IS_OBJECT_VALID(&iVar5))
	{
		if (!IS_ATTACHMENT_VALID(&uLocal_2))
		{
			uLocal_2 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iVar5, Function_39(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
		uVar0 = GET_GRINGO_STRING_ATTR("LocatorAttachName", &iParam1, &uVar7);
		iVar6 = GET_TARGET_OBJECT();
		if (IS_OBJECT_VALID(&iVar6))
		{
			iVar8 = CREATE_OBJECT_LOCATOR(&iVar5, &uVar0);
			if (IS_OBJECT_VALID(&iVar8))
			{
				if (OBJECT_LOCATOR_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &iVar8, &iVar5, &uVar0, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
				{
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_POSITION(&iVar8, &Var1);
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_ORIENTATION(&iVar8, &Var3);
...
bool Function_86(int iParam0) //Position: 0x38A4 / 14500
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x38BE / 14526
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x38D9 / 14553
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3917 / 14615
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3930 / 14640
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3C28 / 15400
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3C46 / 15430
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3CE6 / 15590
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3D06 / 15622
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3D19 / 15641
{
...
void Function_96(int iParam0) //Position: 0x3D35 / 15669
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3D41 / 15681
{
	bool bVar0;
	var uVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3DAD / 15789
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(var uParam0) //Position: 0x3DC5 / 15813
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_100(int iParam0) //Position: 0x3E6B / 15979
{
