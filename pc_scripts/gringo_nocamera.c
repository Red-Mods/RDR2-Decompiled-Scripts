...
void Function_82(var uParam0, bool bParam1) //Position: 0x336D / 13165
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x347D / 13437
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3495 / 13461
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x37B1 / 14257
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x37C3 / 14275
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x37DD / 14301
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x37F8 / 14328
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3836 / 14390
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x384F / 14415
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3B47 / 15175
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3B65 / 15205
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C05 / 15365
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3C25 / 15397
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3C38 / 15416
{
...
void Function_96(int iParam0) //Position: 0x3C54 / 15444
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3C60 / 15456
{
	int iVar0;
	var uVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3CCC / 15564
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3CE4 / 15588
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3CF0 / 15600
{
