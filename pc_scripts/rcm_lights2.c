	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000005:
						if (HAS_ITEM(Function_109(64), &Global_54076))
						{
							Function_108("Lights2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							Function_106("RCM_Lights_Deed", 0x41200000, 1, 0, 2, 1, 0);
							iLocal_327 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
							iLocal_328 = 0;
							while (iLocal_328 <= iLocal_327)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iLocal_328), 4, 0);
								iLocal_328++;
							}
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Lights2_OBJ", 0, 3, false);
							Function_105(Global_99725[ScriptParam_043].f_224, 0);
							Function_104(&Global_99725[4943] + 228, 256);
							Function_58(50, 1, 1, 0);
							Function_5(Global_42265[99].f_64);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1A2 / 418
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x1D4 / 468
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x1F1 / 497
{
	RELEASE_LAYOUT_REF(&iLocal_329);
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x1FE / 510
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_5(bool bParam0) //Position: 0x20F / 527
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_6(struct<229> Param0) //Position: 0x3C9 / 969
{
	float fVar0;
	int iVar1;
...
void Function_7(struct<217> Param0) //Position: 0x499 / 1177
{
	float fVar0;
	var uVar1;
...
int Function_8(var uParam0, int iParam1) //Position: 0x557 / 1367
{
	int iVar0;
	var uVar1;
...
void Function_9(int iParam0, var uParam1, struct<2> Param2) //Position: 0x6C1 / 1729
{
	struct<8> Var0;
...
struct<32> Function_10(char* cParam0) //Position: 0x769 / 1897
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_11(char* cParam0) //Position: 0x7D5 / 2005
{
	char* cVar0[32];
...
int Function_12(int iParam0) //Position: 0x7F7 / 2039
{
	int iVar0;
	struct<2> Var1;
...
float Function_13(var uParam0, struct<2> Param1) //Position: 0x965 / 2405
{
	struct<2> Var0;
...
struct<8> Function_14(int iParam0) //Position: 0x9DC / 2524
{
	struct<2> Var0;
...
void Function_15(int iParam0) //Position: 0xA48 / 2632
{
...
bool Function_16(int iParam0) //Position: 0xAB0 / 2736
{
...
var Function_17() //Position: 0xAC6 / 2758
{
	int iVar0;
...
void Function_18(struct<153> Param0) //Position: 0xACF / 2767
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_19(int iParam0) //Position: 0xC3E / 3134
{
...
var Function_20(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xC6A / 3178
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_21(int iParam0) //Position: 0xC8B / 3211
{
...
bool Function_22(struct<249> Param0) //Position: 0xCA0 / 3232
{
...
bool Function_23(struct<265> Param0) //Position: 0xDD0 / 3536
{
	int iVar0;
...
bool Function_24(int iParam0) //Position: 0xF31 / 3889
{
...
bool Function_25(int iParam0) //Position: 0xF55 / 3925
{
...
bool Function_26(int iParam0) //Position: 0xF6A / 3946
{
...
var Function_27(int iParam0) //Position: 0xF81 / 3969
{
...
bool Function_28(int iParam0) //Position: 0xF9B / 3995
{
...
bool Function_29(int iParam0) //Position: 0xFB1 / 4017
{
	return Global_116927[iParam06].f_16;
}

bool Function_30(var uParam0, int iParam1) //Position: 0xFC1 / 4033
{
	int iVar0;
...
bool Function_31(struct<237> Param0) //Position: 0xFDE / 4062
{
	if (!Param0.f_236)
	{
		if (Function_32())
...
bool Function_32() //Position: 0x10AD / 4269
{
...
bool Function_33(int iParam0) //Position: 0x10C8 / 4296
{
...
void Function_34(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1123 / 4387
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0) //Position: 0x1198 / 4504
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(int iParam0, var uParam1, int iParam2) //Position: 0x11D2 / 4562
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x124E / 4686
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x12EF / 4847
{
	int iVar0;
	int iVar1;
...
bool Function_39(var uParam0, int iParam1) //Position: 0x132C / 4908
{
...
bool Function_40(int iParam0) //Position: 0x133F / 4927
{
	int iVar0;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x135B / 4955
{
	int iVar0;
...
int Function_42(int iParam0) //Position: 0x1378 / 4984
{
...
bool Function_43(int iParam0) //Position: 0x138D / 5005
{
...
int Function_44(int iParam0) //Position: 0x13A2 / 5026
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x13B7 / 5047
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x13C4 / 5060
{
...
int Function_47(int iParam0, int iParam1) //Position: 0x1444 / 5188
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_48(char* cParam0) //Position: 0x20A7 / 8359
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_49(int iParam0, bool bParam1) //Position: 0x20BF / 8383
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x20FD / 8445
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x214C / 8524
{
...
int Function_52(int iParam0) //Position: 0x2162 / 8546
{
...
void Function_53() //Position: 0x21CB / 8651
{
...
bool Function_54(int iParam0) //Position: 0x21F0 / 8688
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x2241 / 8769
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x226E / 8814
{
	if (!Function_51(iParam0))
	{
...
void Function_57(bool bParam0) //Position: 0x22C0 / 8896
{
	int iVar0;
...
void Function_58(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x22FA / 8954
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2892 / 10386
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_60() //Position: 0x2A33 / 10803
{
	return;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2A39 / 10809
{
	if (Global_6624)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x2A78 / 10872
{
...
void Function_63() //Position: 0x2ACD / 10957
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_64() //Position: 0x2B18 / 11032
{
...
void Function_65() //Position: 0x2C1E / 11294
{
	float fVar0;
...
void Function_66() //Position: 0x2C51 / 11345
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x2DE4 / 11748
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x2F9D / 12189
{
	Function_69(&Global_42918, 1, 0);
	return;
}

void Function_69(struct<2317> Param0) //Position: 0x2FAB / 12203
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x31C8 / 12744
{
...
struct<8> Function_71(int iParam0) //Position: 0x31DD / 12765
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x3284 / 12932
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3520 / 13600
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_74(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_17(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_74(int iParam0) //Position: 0x3B5E / 15198
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3B6F / 15215
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x3C66 / 15462
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3C81 / 15489
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x3CE8 / 15592
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x3CFA / 15610
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3D0C / 15628
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x3E40 / 15936
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x3E4F / 15951
{
	if (!iParam0 != 4294967295)
	{
...
var Function_83(int iParam0) //Position: 0x3E88 / 16008
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x3EC5 / 16069
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_85(int iParam0, bool bParam1, bool bParam2) //Position: 0x40A9 / 16553
{
	int iVar0;
	int iVar1;
...
int Function_86(bool bParam0) //Position: 0x42ED / 17133
{
...
struct<8> Function_87() //Position: 0x432E / 17198
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x444E / 17486
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_90() //Position: 0x44CD / 17613
{
...
int Function_91(int iParam0, bool bParam1, int iParam2) //Position: 0x450A / 17674
{
	int iVar0;
	int iVar1;
...
void Function_92() //Position: 0x4716 / 18198
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_93(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x47CD / 18381
{
	int iVar0;
...
struct<8> Function_94() //Position: 0x48C5 / 18629
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_95(int iParam0) //Position: 0x48CF / 18639
{
...
int Function_96(bool bParam0, bool bParam1) //Position: 0x48E5 / 18661
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_97(struct<2> Param0, struct<2> Param2) //Position: 0x49B1 / 18865
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_98(float fParam0, int iParam1) //Position: 0x49CE / 18894
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_99(int iParam0) //Position: 0x51FA / 20986
{
	var uVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x5235 / 21045
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_101(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5244 / 21060
{
	uParam0 = &uParam0;
...
void Function_102() //Position: 0x52F3 / 21235
{
	bool bVar0;
...
void Function_103(int iParam0) //Position: 0x5351 / 21329
{
	PRINTSTRING("Day ");
...
void Function_104(int iParam0, int iParam1) //Position: 0x539B / 21403
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_105(bool bParam0, bool bParam1) //Position: 0x53B1 / 21425
{
	bool bVar0;
...
void Function_106(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x53D6 / 21462
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_107(int iParam0) //Position: 0x5461 / 21601
{
	char* cVar0[16];
...
void Function_108(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x54A0 / 21664
{
	struct<4> Var0;
	var uVar4;
...
var Function_109(bool bParam0) //Position: 0x5535 / 21813
{
	bool bVar0;
...
void Function_110() //Position: 0x5629 / 22057
{
	var uVar0;
	
	Function_111(4, 1);
	uVar0 = &uVar0;
	iLocal_329 = CREATE_LAYOUT("Lights_layout");
	return;
}

void Function_111(int iParam0, int iParam1) //Position: 0x5651 / 22097
{
	switch (&iParam1)
	{
		case 0x00000000:
