...
void Function_1(int iParam0, int iParam1) //Position: 0x113 / 275
{
	if (Global_6624)
	{
		return;
...
void Function_3(int iParam0, int iParam1) //Position: 0x1A7 / 423
{
...
var Function_21(int iParam0, bool bParam1) //Position: 0x13F3 / 5107
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_28(bool bParam0) //Position: 0x199C / 6556
{
...
bool Function_35(char* cParam0) //Position: 0x1E7C / 7804
{
...
bool Function_44(bool bParam0, int iParam1) //Position: 0x290D / 10509
{
...
bool Function_47(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x2944 / 10564
{
	iParam0 = &iParam0;
...
{
	uParam0 = Function_95(&uParam0);
	iParam2 = 0;
	if ((Function_91(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
	{
		iLocal_4 = 0;
	}
	if (!Function_90(3, 1))
	{
		Function_57(3, 1, 1, 0, 0);
		iParam2 = 1;
	}
	return;
}

void Function_57(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x2D37 / 11575
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_81(bParam0, bParam1))
	{
		...
		Function_75(bParam0);
		if (StackVal && !Function_44(((((!Function_74() && !Global_6623) && !Global_6635) && !Global_6627) && !&bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, 0, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_44((((Function_74() || Global_6623) || Global_6635) || Global_6627), 1))
		{
		...
		if (!Function_46())
		{
			if (!Function_73(Global_119934, 2))
			{
		...
		{
			case 0x00000004:
				Function_59(3, bParam1);
				break;
			
			case 0x00000005:
				Function_59(3, SHIFT_LEFT(bParam1, 6));
				break;
			
			case 0x00000006:
				Function_59(3, SHIFT_LEFT(bParam1, 12));
				break;
			
			case 0x00000007:
				Function_59(3, SHIFT_LEFT(bParam1, 18));
				break;
			
			case 0x00000008:
				Function_59(3, SHIFT_LEFT(bParam1, 24));
				break;
			
			case 0x00000009:
				Function_59(2, SHIFT_LEFT(bParam1, 18));
				break;
...
void Function_58(int iParam0, int iParam1) //Position: 0x2FD6 / 12246
{
	bool bVar0;
...
void Function_59(int iParam0, bool bParam1) //Position: 0x3040 / 12352
{
...
void Function_60() //Position: 0x30AF / 12463
{
	if (Function_89(Global_42827))
	{
		if (Global_42827.f_16)
		{
			...
			Global_42827.f_4 = Function_67(Global_42827);
			*(&Global_42827 + 8) = Function_61(StackVal, Global_42827);
			Global_42827.f_16 = 0;
		}
...
int Function_61(int iParam0, int iParam1) //Position: 0x312F / 12591
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
	...
	switch (iParam0)
	{
		...
		case 0x00000004:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_63(6, 0) || Function_63(12, 0))
					{
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_62(13) && iVar14)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar14 = 0;
					}
					else if (iVar14 && Function_63(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_62(26) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_62(25) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_62(24) && iVar15)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_62(23) && iVar15)
					{
						cVar4 = &Global_44085[Global_46850[1]9] + 8;
						iVar15 = 0;
					}
					else if (iVar15 && Function_63(26, 0))
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
				...
				case 0x00000008:
					if (Function_62(55) && iVar16)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_62(54) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_62(27) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_62(52) && iVar13)
					{
						cVar4 = &Global_44085[Global_46926[2]9] + 8;
						iVar13 = 0;
					}
					else if (Function_62(51) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
					else if (Function_62(50) && iVar13)
					{
						cVar4 = &Global_44085[Global_46796[4]9] + 8;
						iVar13 = 0;
					}
					else if (Function_62(49) && iVar13)
					{
						cVar4 = &Global_44085[Global_46816[1]9] + 8;
						iVar13 = 0;
					}
					else if (Function_63(17, 0) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_62(19) && iVar17)
					{
						Var0 = Vector(-1708,36f, 46,18f, 2175,89f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_63(6, 0) && Function_62(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_62(17) && iVar17)
					{
						Var0 = Vector(-1687,208f, 53,208f, 2140,491f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_63(9, 0) && Function_62(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_62(15) && iVar17)
					{
						Var0 = Vector(-1709,084f, 55,216f, 2104,631f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if (Function_63(8, 0) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
int Function_62(int iParam0) //Position: 0x3D92 / 15762
{
...
int Function_63(int iParam0, bool bParam1) //Position: 0x3DA7 / 15783
{
	int iVar0;
...
bool Function_64(int iParam0) //Position: 0x3DE5 / 15845
{
...
var Function_65(int iParam0) //Position: 0x3DFC / 15868
{
...
bool Function_66(int iParam0) //Position: 0x3E16 / 15894
{
...
int Function_67(int iParam0) //Position: 0x3E2C / 15916
{
	int iVar0;
	int iVar1;
...
void Function_68(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3E7B / 15995
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_70(&uParam0, uParam1, &uParam2) && !&bParam3)
	{
		return;
	}
...
void Function_69(char* cParam0) //Position: 0x3EF0 / 16112
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_70(int iParam0, var uParam1, int iParam2) //Position: 0x3F2A / 16170
{
	var uVar0;
	char* cVar1[16];
	...
	if (&iParam2 == 2)
	{
		...
		{
			case 0x00000002:
				if (!Function_73(Global_119935, 1577004))
				{
					return 0;
				}
				break;
...
int Function_71(char* cParam0) //Position: 0x3FA6 / 16294
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_72(int iParam0) //Position: 0x409A / 16538
{
	int iVar0;
	int iVar1;
...
bool Function_73(int iParam0, int iParam1) //Position: 0x40D7 / 16599
{
...
bool Function_74() //Position: 0x40EA / 16618
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_75(bool bParam0) //Position: 0x4117 / 16663
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_42265[bParam09].f_64, (TO_FLOAT(Function_78(bParam0)) / TO_FLOAT(Global_42265[bParam09].f_28)), 0, 0);
		Function_77(Global_42265[bParam09].f_64, 0);
...
int Function_76(int iParam0) //Position: 0x42C7 / 17095
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_77(var uParam0, int iParam1) //Position: 0x431E / 17182
{
	bool bVar0;
...
var Function_78(int iParam0) //Position: 0x4343 / 17219
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_79(bool bParam0) //Position: 0x4399 / 17305
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_80() //Position: 0x43A5 / 17317
{
	return;
}

bool Function_81(bool bParam0, int iParam1) //Position: 0x43AB / 17323
{
	int iVar0;
...
void Function_82(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x440A / 17418
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_83(Global_10966) };
		}
...
struct<16> Function_83(int iParam0) //Position: 0x4495 / 17557
{
	char* cVar0[16];
...
void Function_84(int iParam0, int iParam1) //Position: 0x44D4 / 17620
{
	if (!Function_89(iParam0))
	{
...
int Function_85(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x4529 / 17705
{
	int iVar0;
	int iVar1;
...
void Function_86(int iParam0) //Position: 0x4751 / 18257
{
	switch (iParam0)
	{
		case 0x00000009:
...
bool Function_87(int iParam0, int iParam1) //Position: 0x47EF / 18415
{
	int iVar0;
...
bool Function_88(int iParam0) //Position: 0x481C / 18460
{
...
bool Function_89(int iParam0) //Position: 0x4838 / 18488
{
...
bool Function_90(int iParam0, int iParam1) //Position: 0x484E / 18510
{
	int iVar0;
...
int Function_91(int iParam0, bool bParam1, bool bParam2) //Position: 0x48AD / 18605
{
...
bool Function_92() //Position: 0x4971 / 18801
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_93(int iParam0) //Position: 0x4988 / 18824
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_94(int iParam0) //Position: 0x4994 / 18836
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_95(int iParam0) //Position: 0x49A3 / 18851
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x49BE / 18878
{
	var uVar0;
	var uVar1;
