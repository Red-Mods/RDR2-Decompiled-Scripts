...
void main() //Position: 0x0 / 0
{
	...
	Function_10(&bVar0, 66, 4.0f, 0, 0);
	Function_10(&bVar0, 67, 4.0f, 0, 0);
	Function_10(&bVar0, 69, 4.0f, 0, 0);
	Function_10(&bVar0, 65, 4.0f, 0, 0);
	Function_10(&bVar0, 71, 4.0f, 0, 0);
	Function_10(&bVar0, 72, 4.0f, 0, 0);
	Function_10(&bVar0, 298, 4.0f, 0, 0);
	Function_10(&bVar0, 288, 4.0f, 0, 0);
	Function_10(&bVar0, 153, 4.0f, 0, 0);
	Function_10(&bVar0, 154, 4.0f, 0, 0);
	Function_10(&bVar0, 486, 4.0f, 0, 0);
	Function_10(&bVar0, 487, 4.0f, 0, 0);
	Function_10(&bVar0, 489, 4.0f, 0, 0);
	Function_10(&bVar0, 490, 4.0f, 0, 0);
	Function_10(&bVar0, 491, 4.0f, 0, 0);
	Function_10(&bVar0, 493, 4.0f, 0, 0);
	...
	uVar2 = FIND_NAMED_LAYOUT("GaptoothBreach_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "gap_zombie_01");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 10, 30, 0, 0, 1);
		}
		else
		{
	...
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "gap_zombie_02");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 10, 30, 0, 0, 1);
		}
	...
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "gap_zombie_03");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 3, 5, 0, 0, 1);
		}
		else
		{
	...
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "gap_zombie_04");
		if (IS_VOLUME_VALID(&uVar3))
		{
	...
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "gap_zombie_05");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 5, 10, 0, 0, 1);
		}
...
void Function_1(var uParam0, var uParam1) //Position: 0xEEE / 3822
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xEFF / 3839
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xF57 / 3927
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xFE9 / 4073
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0x1005 / 4101
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x1045 / 4165
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x1062 / 4194
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1073 / 4211
{
	int iVar0;
	int iVar1;
	
	iVar0 = Function_10(&bParam0, bParam1, fParam2, bParam3, 0);
	if (iVar0 > 0)
	{
...
void Function_9(int iParam0) //Position: 0x10BA / 4282
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x10C7 / 4295
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0x1149 / 4425
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0x1158 / 4440
{
	if (!Function_4(128))
	{
		return;
