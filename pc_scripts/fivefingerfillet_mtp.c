...
void Function_2(int iParam0) //Position: 0x71 / 113
{
	Function_3(iParam0);
	return;
}
...
int Function_4(int iParam0) //Position: 0xA0 / 160
{
...
bool Function_5(int iParam0) //Position: 0xBB / 187
{
...
void Function_6() //Position: 0xD2 / 210
{
	int iVar0;
	int iVar1;
	char* cVar2[64];
...
void Function_7(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0x319 / 793
{
	uParam3 = iParam0 & 15;
...
bool Function_8(int iParam0) //Position: 0x345 / 837
{
	if (!Function_5(iParam0))
	{
		return 0;
...
bool Function_9(int iParam0) //Position: 0x369 / 873
{
...
bool Function_10(int iParam0) //Position: 0x37E / 894
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_11() //Position: 0x39F / 927
{
	return;
}

void Function_12() //Position: 0x3A5 / 933
{
...
void Function_13(var uParam0) //Position: 0x3F2 / 1010
{
	Global_39922.f_88 = (Global_39922.f_88 || uParam0);
	return;
}

var Function_14() //Position: 0x405 / 1029
{
...
void Function_15(int iParam0) //Position: 0x41A / 1050
{
	var uVar0;
	var uVar2;
	int iVar3;
	...
	while (iVar3 <= 3)
	{
		Function_16(iParam0, iVar3);
		uVar0 = Function_16(iParam0, iVar3);
...
struct<8> Function_16(int iParam0, int iParam1) //Position: 0x662 / 1634
{
...
struct<8> Function_17(int iParam0) //Position: 0x858 / 2136
{
	if (iParam0 == Global_46760[0])
	{
...
struct<8> Function_18(int iParam0) //Position: 0x930 / 2352
{
	if (iParam0 == Global_46760[0])
	{
...
bool Function_19() //Position: 0xA04 / 2564
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_34(Global_46926[1]))
			{
				iLocal_18 = Function_33(Local_6);
				if (iLocal_18 <= 1)
				{
					iLocal_18 = 1;
				}
				if (Function_31() <= iLocal_18)
				{
					Function_27("FiveFingerFillet_NotEnoughMoney", 4.0f, 1, 2, 0, 0, 0, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_26(Global_46926[1], &iLocal_35 + 4, &iLocal_35 + 48, &iLocal_35 + 56))
			{
				Function_25(&(Global_46926[1]));
				Function_24(&iLocal_35 + 4);
				Function_18(Global_46926[1]);
				(&iLocal_35 + 188[02]) = Function_18(Global_46926[1]);
				Function_17(Global_46926[1]);
				*(&iLocal_35 + 188[12]) = Function_17(Global_46926[1]);
				iLocal_35 = Local_6;
				Function_23(Local_6, 0);
		...
		case 0x00000065:
			if (Function_22(Local_6, 0))
			{
				bLocal_2 = true;
			}
			else if (Function_21(Local_6))
			{
				bLocal_3 = true;
			}
			else
...
void Function_20() //Position: 0xB9B / 2971
{
	Function_1();
	return;
}

bool Function_21(int iParam0) //Position: 0xBA4 / 2980
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_22(int iParam0, bool bParam1) //Position: 0xBC5 / 3013
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xBFC / 3068
{
	if (!Function_8(iParam0))
	{
		return;
...
void Function_24(int[] iParam0) //Position: 0xC17 / 3095
{
	int iVar0;
	var uVar1;
...
void Function_25(int iParam0) //Position: 0xC73 / 3187
{
	var uVar0;
	var uVar2;
	int iVar3;
...
bool Function_26(int iParam0, bool[] bParam1, bool bParam2, var uParam3) //Position: 0xEBE / 3774
{
	var uVar0;
	var uVar2;
	int iVar3;
	...
	while (iVar4 <= 3)
	{
		Function_16(iParam0, iVar4);
		uVar0 = Function_16(iParam0, iVar4);
...
void Function_27(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x1204 / 4612
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_28(int iParam0) //Position: 0x1299 / 4761
{
	char* cVar0[16];
...
bool Function_29() //Position: 0x12D8 / 4824
{
...
bool Function_30(var uParam0, bool bParam1) //Position: 0x12F3 / 4851
{
	return (uParam0 && bParam1) == 0;
}

int Function_31() //Position: 0x1300 / 4864
{
	return Function_32(0);
}

int Function_32(int iParam0) //Position: 0x130A / 4874
{
...
var Function_33(int iParam0) //Position: 0x134B / 4939
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_34(int iParam0) //Position: 0x1365 / 4965
{
...
int Function_35(var uParam0, int iParam1) //Position: 0x1381 / 4993
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0x139E / 5022
{
...
void Function_37() //Position: 0x13B4 / 5044
{
	Function_1();
	return;
}

void Function_38() //Position: 0x13BD / 5053
{
	uLocal_4 = CREATE_LAYOUT(Function_47());
	Function_45(0, 1);
	Function_44();
	Function_39(&uLocal_19);
	Function_39(&iLocal_27);
	Function_39(&iLocal_23);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
...
void Function_39(int iParam0) //Position: 0x140A / 5130
{
...
void Function_40(vector3 vParam0) //Position: 0x1421 / 5153
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_42(&vParam0, 1);
	Function_41(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

void Function_41(var uParam0, int iParam1) //Position: 0x1446 / 5190
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x145C / 5212
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_43(var uParam0) //Position: 0x146D / 5229
{
	return Function_30(uParam0, 1);
}

void Function_44() //Position: 0x147B / 5243
{
	return;
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x1481 / 5249
{
	var uVar0;
...
void Function_46(var uParam0) //Position: 0x14E0 / 5344
{
	int iVar0;
...
var Function_47() //Position: 0x14FD / 5373
{
	var uVar0;
