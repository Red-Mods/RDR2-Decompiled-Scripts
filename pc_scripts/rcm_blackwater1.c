...
void main() //Position: 0x0 / 0
{
	...
	iLocal_335 = 0;
	bLocal_348 = false;
	Local_379 = Vector(731,98f, 78,307f, 1251,799f);
	iLocal_386 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			bVar0 = false;
			iLocal_336 = 1000;
			Function_197(&uLocal_351, 1234, 3, 0);
			Function_197(&uLocal_351, 561, 3, 0);
			Function_195(&uLocal_351, "ptl_base", 5, 0);
			Function_195(&uLocal_351, "rfl_base", 5, 0);
			Function_195(&uLocal_351, "cali_dreaming_dead", 5, 0);
			while (!IS_EXITFLAG_SET())
			{
				switch (bVar0)
				{
					case 0x00000000:
						if (DECOR_CHECK_EXIST(&Global_54076, "GP_Dismount"))
						{
							if (IS_SCRIPT_VALID(DECOR_GET_INT(&Global_54076, "GP_Dismount")))
							{
								break;
							}
						}
						else if (!Function_194(Global_119934, 32768))
						{
							break;
						}
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (Function_189(&uLocal_351))
								{
									uLocal_377 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, "ZombieStayOut", 2,802597E-45f, Vector(735,689f, 78,306f, 1298,782f), Vector(0.0f, 0.0f, 0.0f), Vector(25.0f, 15.0f, 30.0f));
									ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_377);
									ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_377);
									Function_182(&(Global_99725[243]), 2, 0x41f00000, 0x42200000, 0);
									bVar0 = true;
								}
							}
							else
							{
								uLocal_349 = CREATE_LAYOUT("RCM_Blackwater_Layout");
							}
						}
						break;
					...
					case 0x00000003:
						if (Function_123("$/cutscene/fenway_1_cs/fenway_1_cs", &iLocal_336, 35340, 35175, 33809, 31323, 31054, 31038, 1, 1, 2, 2, 0))
						{
							bVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						if (!HUD_IS_FADING() && !HUD_IS_FADED())
						{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "blackwater1_OBJ", 0, 3, false);
							Function_121(Global_99725[ScriptParam_043].f_224, 0);
							if (!Function_194(Global_119934, 512))
							{
								Function_116(&Global_54076, 512, 1, 0);
							}
							if (!Function_194(Global_119934, 1024))
							{
								Function_116(&Global_54076, 1024, 1, 0);
							}
							if (DECOR_CHECK_EXIST(&Global_54076, "PlayerHorse_DeathTime"))
							{
								DECOR_REMOVE(&Global_54076, "PlayerHorse_DeathTime");
							}
							Function_114(406, 1, 0, 0);
							Function_14(2, 1, 1, 0);
							Function_11(&uLocal_382);
							SET_ACTOR_CAN_BE_AIMASSISTED(&uLocal_375, 0);
							bVar0 = 13;
						}
						break;
...
void Function_1(var uParam0, int iParam1, bool bParam2) //Position: 0x4EE / 1262
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_2() //Position: 0x6BA / 1722
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

var Function_3() //Position: 0x6C4 / 1732
{
	int iVar0;
...
bool Function_4(var uParam0, int iParam1) //Position: 0x6CD / 1741
{
...
void Function_5(vector3 vParam0) //Position: 0x6E7 / 1767
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
bool Function_6(int iParam0, float fParam1) //Position: 0x6FE / 1790
{
...
float Function_7(vector3 vParam0) //Position: 0x71C / 1820
{
	if (Function_10(&vParam0))
	{
...
bool Function_8(int iParam0) //Position: 0x7E9 / 2025
{
	return Function_9(iParam0, 2);
}

bool Function_9(var uParam0, int iParam1) //Position: 0x7F7 / 2039
{
	return (uParam0 && iParam1) == 0;
}

bool Function_10(int iParam0) //Position: 0x804 / 2052
{
	return Function_9(iParam0, 1);
}

void Function_11(int iParam0) //Position: 0x812 / 2066
{
	if (!Function_10(&iParam0))
	{
...
void Function_12(vector3 vParam0) //Position: 0x829 / 2089
{
...
void Function_13(int iParam0, int iParam1) //Position: 0x84E / 2126
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x864 / 2148
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (!Function_113())
	{
		if (!Function_194(Global_119934, 2097152))
		{
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_13(&Global_99725[iParam043] + 228, 64);
	...
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_99725[iParam043].f_224, 0))
	{
		Function_71(Global_99725[iParam043].f_224);
	}
...
void Function_15(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xCDE / 3294
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_16() //Position: 0xE7F / 3711
{
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0xE85 / 3717
{
	if (Global_6624)
	{
		return;
...
void Function_18(bool bParam0) //Position: 0xEC4 / 3780
{
	...
	*(&Global_53524 + 56) = GET_TIME_OF_DAY();
	...
	if (&bParam0)
	{
		...
		Function_13(&Global_99144, 2);
	}
	Global_140631 = 1;
	return;
}

void Function_19() //Position: 0xF19 / 3865
{
	Function_46();
	Function_45();
	Function_45();
...
void Function_20() //Position: 0xF64 / 3940
{
...
void Function_21() //Position: 0x106A / 4202
{
	float fVar0;
...
void Function_22() //Position: 0x109D / 4253
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_23() //Position: 0x1230 / 4656
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_24() //Position: 0x13E9 / 5097
{
	Function_25(&Global_42918, 1, 0);
	return;
}

void Function_25(struct<2317> Param0) //Position: 0x13F7 / 5111
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_26() //Position: 0x1614 / 5652
{
...
struct<8> Function_27(int iParam0) //Position: 0x1629 / 5673
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x16D0 / 5840
{
	int iVar0;
...
void Function_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x196C / 6508
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_30(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_3(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_30(int iParam0) //Position: 0x1FAA / 8106
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_31(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1FBB / 8123
{
	char* cVar0[32];
...
struct<32> Function_32(char* cParam0) //Position: 0x20B2 / 8370
{
	char* cVar0[32];
...
void Function_33(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x20CD / 8397
{
	float fVar0;
...
var Function_34(int iParam0, int iParam1) //Position: 0x2134 / 8500
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_35(int iParam0, bool bParam1) //Position: 0x2146 / 8518
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_36(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2158 / 8536
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_37(int iParam0) //Position: 0x228C / 8844
{
	return Global_55480[iParam016].f_96;
}

float Function_38(int iParam0) //Position: 0x229B / 8859
{
	if (!iParam0 != 4294967295)
	{
...
var Function_39(int iParam0) //Position: 0x22D4 / 8916
{
	if (iParam0 == 4294967295)
	{
...
void Function_40(int iParam0) //Position: 0x2311 / 8977
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_41(int iParam0, bool bParam1, bool bParam2) //Position: 0x24AB / 9387
{
	int iVar0;
	int iVar1;
...
int Function_42(bool bParam0) //Position: 0x26EF / 9967
{
...
struct<8> Function_43() //Position: 0x2730 / 10032
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_44() //Position: 0x27B9 / 10169
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_45() //Position: 0x2850 / 10320
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_46() //Position: 0x28CF / 10447
{
...
int Function_47(int iParam0, bool bParam1, int iParam2) //Position: 0x290C / 10508
{
	int iVar0;
	int iVar1;
...
void Function_48() //Position: 0x2B18 / 11032
{
	struct<2> Var0;
	var uVar2;
...
bool Function_49(char* cParam0) //Position: 0x2BCF / 11215
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_50(var uParam0, var uParam1, float fParam2, float fParam3) //Position: 0x2BE7 / 11239
{
	int iVar0;
	
	iVar0 = Function_52(&fParam2, &fParam3);
...
bool Function_51(int iParam0) //Position: 0x2CDF / 11487
{
...
int Function_52(bool bParam0, bool bParam1) //Position: 0x2CF5 / 11509
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_53(struct<2> Param0, struct<2> Param2) //Position: 0x2DC1 / 11713
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_54(float fParam0, int iParam1) //Position: 0x2DDE / 11742
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_55(int iParam0) //Position: 0x360A / 13834
{
	var uVar0;
...
void Function_56(var uParam0, int iParam1) //Position: 0x3645 / 13893
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_57(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3654 / 13908
{
	uParam0 = &uParam0;
...
void Function_58(int iParam0) //Position: 0x3703 / 14083
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (!Function_61(&Global_6667[228] + 184, 2) || ((((((Function_66(14) && Function_66(18)) && Function_66(37)) && Function_66(7)) && Function_66(11)) && Function_66(5)) && Function_66(21)))
	{
	...
	if (!Function_61(&Global_6667[328] + 184, 2) || ((Function_66(27) && Function_66(1)) && Function_66(23)))
	{
	...
	if (!Function_66(7))
	{
		...
		if (((Function_66(6) && Function_59(Global_46949) < 0) && Function_59(Global_46951) < 0) && Function_59(Global_46952) < 0)
		{
	...
	{
		Function_122(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_59(int iParam0) //Position: 0x4025 / 16421
{
...
bool Function_60(int iParam0) //Position: 0x403F / 16447
{
...
bool Function_61(int iParam0, int iParam1) //Position: 0x4056 / 16470
{
	int iVar0;
...
var Function_62() //Position: 0x4073 / 16499
{
	return STRING_TO_HASH(Function_63());
}

var Function_63() //Position: 0x407F / 16511
{
	return "ZOMBIE_STORY";
}

bool Function_64(int iParam0) //Position: 0x4094 / 16532
{
	...
	return Global_21684[Function_65(iParam0)7].f_12 < 0;
}

int Function_65(int iParam0) //Position: 0x40FA / 16634
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_66(int iParam0) //Position: 0x41BC / 16828
{
...
void Function_67(int iParam0) //Position: 0x41D1 / 16849
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_62(), &iParam0, 0, 3, false);
	Function_121(Function_62(), 0);
	return;
}

bool Function_68(int iParam0, bool bParam1) //Position: 0x421A / 16922
{
	int iVar0;
...
var Function_69(int iParam0) //Position: 0x4258 / 16984
{
...
bool Function_70(int iParam0) //Position: 0x4272 / 17010
{
...
void Function_71(int iParam0) //Position: 0x4288 / 17032
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72(struct<229> Param0) //Position: 0x4442 / 17474
{
	float fVar0;
	int iVar1;
...
void Function_73(struct<217> Param0) //Position: 0x4512 / 17682
{
	float fVar0;
	var uVar1;
...
int Function_74(var uParam0, int iParam1) //Position: 0x45D0 / 17872
{
	int iVar0;
	var uVar1;
...
void Function_75(int iParam0, var uParam1, struct<2> Param2) //Position: 0x473A / 18234
{
	struct<8> Var0;
...
struct<32> Function_76(char* cParam0) //Position: 0x47E2 / 18402
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_77(char* cParam0) //Position: 0x484E / 18510
{
	char* cVar0[32];
...
int Function_78(int iParam0) //Position: 0x4870 / 18544
{
	int iVar0;
	struct<2> Var1;
		...
		if (IS_VOLUME_VALID(&Global_39621[iVar05] + 16))
		{
			if (DECOR_CHECK_EXIST(&Global_39621[iVar05] + 16, "script"))
			{
				if (!IS_SCRIPT_VALID(DECOR_GET_INT(&Global_39621[iVar05] + 16, "script")))
				{
					...
					{
						if (Function_79(StackVal, &Global_54076, Var1) < 25.0f)
						{
							Function_81(iVar0);
						}
					}
					else if (Function_79(StackVal, &Global_54076, Var1) < 55.0f)
					{
						Function_81(iVar0);
					}
				}
...
float Function_79(int iParam0, struct<2> Param1) //Position: 0x49DE / 18910
{
	struct<2> Var0;
...
struct<8> Function_80(int iParam0) //Position: 0x4A55 / 19029
{
	struct<2> Var0;
...
void Function_81(int iParam0) //Position: 0x4AC1 / 19137
{
...
bool Function_82(int iParam0) //Position: 0x4B29 / 19241
{
...
void Function_83(struct<153> Param0) //Position: 0x4B3F / 19263
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_88(Function_89(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_87(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_9(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_9(Global_116927[iParam16].f_32, 1))
			{
				...
				if (Global_43789 != Global_99725[iParam143].f_216 && !Function_86())
				{
...
void Function_84(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5055 / 20565
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_85(Global_10966) };
		}
...
struct<16> Function_85(int iParam0) //Position: 0x50E0 / 20704
{
	char* cVar0[16];
...
bool Function_86() //Position: 0x511F / 20767
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_87(int iParam0) //Position: 0x514C / 20812
{
...
var Function_88(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5178 / 20856
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_89(int iParam0) //Position: 0x5199 / 20889
{
...
bool Function_90(struct<249> Param0) //Position: 0x51AE / 20910
{
	...
	if (Function_82(Param0.f_216))
	{
		if (Function_98(&(Global_43791[Param0.f_216]), 256))
		{
			return 0;
		}
	}
...
bool Function_91(struct<265> Param0) //Position: 0x52DE / 21214
{
	int iVar0;
	...
	if (!Param0.f_260 != 0)
	{
		...
		{
			iVar0 = Function_69(Param0.f_264);
...
bool Function_92(int iParam0) //Position: 0x543F / 21567
{
	if (!Function_60(iParam0))
	{
		return 0;
...
bool Function_93(int iParam0) //Position: 0x5463 / 21603
{
...
bool Function_94(int iParam0) //Position: 0x5478 / 21624
{
	return Global_116927[iParam06].f_16;
}

bool Function_95(struct<237> Param0) //Position: 0x5488 / 21640
{
	if (!Param0.f_236)
	{
		if (Function_113())
...
bool Function_96(int iParam0) //Position: 0x5557 / 21847
{
	...
	if (!Function_9(Global_99725[iParam043].f_228, 32768))
	{
		...
		{
			if (!Function_194(Global_119935, 0x8000000))
			{
...
bool Function_97(int iParam0) //Position: 0x55B2 / 21938
{
	int iVar0;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x55CE / 21966
{
	int iVar0;
...
int Function_99(int iParam0) //Position: 0x55EB / 21995
{
...
void Function_101() //Position: 0x5615 / 22037
{
	if (Function_104(Global_42827))
	{
		if (Global_42827.f_16)
		{
			...
			Global_42827.f_4 = Function_103(Global_42827);
			(&Global_42827 + 8) = Function_102(StackVal, Global_42827);
			Global_42827.f_16 = 0;
		}
...
int Function_102(int iParam0, int iParam1) //Position: 0x5695 / 22165
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
	...
	switch (iParam0)
	{
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_66(13) && iVar14)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar14 = 0;
					}
					else if (iVar14 && Function_68(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_66(26) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_66(25) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_66(24) && iVar15)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_66(23) && iVar15)
					{
						cVar4 = &Global_44085[Global_46850[1]9] + 8;
						iVar15 = 0;
					}
					else if (iVar15 && Function_68(26, 0))
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
				...
				case 0x00000008:
					if (Function_66(55) && iVar16)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_66(54) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_66(27) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_66(52) && iVar13)
					{
						cVar4 = &Global_44085[Global_46926[2]9] + 8;
						iVar13 = 0;
					}
					else if (Function_66(51) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
					else if (Function_66(50) && iVar13)
					{
						cVar4 = &Global_44085[Global_46796[4]9] + 8;
						iVar13 = 0;
					}
					else if (Function_66(49) && iVar13)
					{
						cVar4 = &Global_44085[Global_46816[1]9] + 8;
						iVar13 = 0;
					}
					else if (Function_68(17, 0) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_66(19) && iVar17)
					{
						Var0 = Vector(-1708,36f, 46,18f, 2175,89f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_68(6, 0) && Function_66(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_66(17) && iVar17)
					{
						Var0 = Vector(-1687,208f, 53,208f, 2140,491f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_68(9, 0) && Function_66(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_66(15) && iVar17)
					{
						Var0 = Vector(-1709,084f, 55,216f, 2104,631f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if (Function_68(8, 0) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
int Function_103(int iParam0) //Position: 0x62F8 / 25336
{
	int iVar0;
	int iVar1;
...
bool Function_104(int iParam0) //Position: 0x6347 / 25415
{
...
int Function_105(int iParam0) //Position: 0x635D / 25437
{
...
void Function_106() //Position: 0x63C6 / 25542
{
...
bool Function_107(int iParam0) //Position: 0x63EB / 25579
{
	if (!Function_104(iParam0))
	{
...
bool Function_108(int iParam0, int iParam1) //Position: 0x643C / 25660
{
	int iVar0;
...
bool Function_109(int iParam0) //Position: 0x6469 / 25705
{
	if (!Function_104(iParam0))
	{
...
void Function_110(int iParam0) //Position: 0x64BB / 25787
{
	int iVar0;
...
void Function_111() //Position: 0x64F5 / 25845
{
	bool bVar0;
...
void Function_112(var uParam0) //Position: 0x6553 / 25939
{
	PRINTSTRING("Day ");
...
bool Function_113() //Position: 0x659D / 26013
{
...
int Function_114(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x65B8 / 26040
{
	int iVar0;
	int iVar1;
...
void Function_115(int iParam0) //Position: 0x67E0 / 26592
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_116(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x687E / 26750
{
	bool bVar0;
	char* cVar1[16];
...
void Function_117(char* cParam0) //Position: 0x68F3 / 26867
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_118(int iParam0, var uParam1, int iParam2) //Position: 0x692D / 26925
{
	var uVar0;
	char* cVar1[16];
	...
	if (&iParam2 == 2)
	{
		...
		{
			case 0x00000002:
				if (!Function_194(Global_119935, 1577004))
				{
					return 0;
				}
				break;
...
int Function_119(char* cParam0) //Position: 0x69A9 / 27049
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_120(int iParam0) //Position: 0x6A4A / 27210
{
	int iVar0;
	int iVar1;
...
void Function_121(char* cParam0, bool bParam1) //Position: 0x6A87 / 27271
{
	bool bVar0;
...
void Function_122(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6AAC / 27308
{
	struct<4> Var0;
	var uVar4;
...
bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6B41 / 27457
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_124(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6BFA / 27642
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_7(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_125(var uParam0, bool bParam1) //Position: 0x725C / 29276
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_126() //Position: 0x732B / 29483
{
	int iVar0;
...
void Function_127() //Position: 0x73A3 / 29603
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x73E8 / 29672
{
...
void Function_129(bool bParam0) //Position: 0x73FA / 29690
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_130(var uParam0, int iParam1) //Position: 0x7417 / 29719
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_131(int iParam0) //Position: 0x74A9 / 29865
{
	bool bVar0;
...
int Function_132(bool bParam0) //Position: 0x74DA / 29914
{
	bool bVar0;
	var uVar1;
...
bool Function_133() //Position: 0x759D / 30109
{
	bool bVar0;
	var uVar1;
...
void Function_134(int iParam0) //Position: 0x75DA / 30170
{
	Function_12(&iParam0, 0.0f);
	return;
}

bool Function_135(struct<37> Param0) //Position: 0x75E7 / 30183
{
	return Param0.f_36;
}

void Function_136(var uParam0, int iParam1) //Position: 0x75F2 / 30194
{
	Function_137(&uParam0, &iParam1, 0);
	return;
}

void Function_137(var uParam0, bool bParam1, bool bParam2) //Position: 0x7602 / 30210
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_138(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x777A / 30586
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_139() //Position: 0x77A4 / 30628
{
	var uVar0;
	var uVar1;
...
void Function_140() //Position: 0x77FF / 30719
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_141() //Position: 0x793E / 31038
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_142() //Position: 0x794E / 31054
{
...
void Function_143(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7977 / 31095
{
	var uVar0;
...
void Function_144() //Position: 0x7A46 / 31302
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_145() //Position: 0x7A5B / 31323
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(743,202f, 78,425f, 1300,785f), 181,303f, 1, 1, true);
	uLocal_375 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "RCM_BLK MacDougal", 561, Vector(741,667f, 78,41f, 1309,608f), Vector(0.0f, 271,085f, 0.0f));
	Function_146(&uLocal_375, 1254, 4294967295, 4294967295, 4294967295, 0, 1, 1);
	SET_ACTION_NODE_FOR_ACTOR(&uLocal_375, "zombie/PlayDead/Variant1/PlayDeadLoop");
	CREATE_DECAL(StackVal, 0f, Vector(741,677f, 78,41f, 1309,608f), 0,75f, 1, 0);
	SET_DRAW_ACTOR(&iLocal_373, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &iLocal_373, Vector(742,896f, 78,41f, 1308,258f), 2,335f, 1, 1, true);
	TASK_MELEE_ATTACK(&iLocal_373, &Global_54076, -1.0f);
	ACTOR_ENABLE_VARIABLE_MESH(&iLocal_373, 23, true);
	ACTOR_ENABLE_VARIABLE_MESH(&iLocal_373, 24, true);
	ACTOR_ENABLE_VARIABLE_MESH(&iLocal_373, 25, true);
	...
	else if (_GET_AMMO_AMOUNT(&Global_54076, 7, 1) < 0.0f)
	{
...
void Function_146(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x7C37 / 31799
{
	var uVar0;
	
	if (Function_152(&uParam0) && !Function_151(&uParam0, 1))
	{
	...
	Function_147(&uParam0, &uParam4, &uParam5);
}

void Function_147(var uParam0, int iParam1, bool bParam2) //Position: 0x7ED4 / 32468
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_148(int iParam0) //Position: 0x7F91 / 32657
{
...
void Function_149(int iParam0) //Position: 0x7FC8 / 32712
{
...
bool Function_151(var uParam0, int iParam1) //Position: 0x83AB / 33707
{
	bool bVar0;
...
int Function_152(int iParam0) //Position: 0x83F0 / 33776
{
	bool bVar0;
...
int Function_153() //Position: 0x8411 / 33809
{
	if (!iLocal_386)
	{
		Function_154(StackVal, Local_379, &uLocal_387);
		iLocal_373 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "RCM_BLK zombieNastas", 1234, Vector(742,896f, 78,41f, 1308,258f), Vector(0.0f, 2,335f, 0.0f));
		SET_DRAW_ACTOR(&iLocal_373, 0);
		TASK_STAND_STILL(&iLocal_373, -1.0f, 0, 0);
		iLocal_386 = 1;
	}
	return 1;
}

void Function_154(vector3 vParam0) //Position: 0x847E / 33918
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_155(int iParam0, int iParam1) //Position: 0x8627 / 34343
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_156(float fParam0, float fParam1) //Position: 0x871C / 34588
{
...
void Function_157() //Position: 0x882D / 34861
{
...
void Function_158() //Position: 0x8861 / 34913
{
...
int Function_159() //Position: 0x8967 / 35175
{
	if (_GET_AMMO_AMOUNT(&Global_54076, 10, 1) < 0.0f)
	{
		if (ACTOR_GET_NEXT_EQUIP_SLOT(&Global_54076) != 6)
	...
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(742,896f, 78,41f, 1308,258f), 0, 0);
	return 1;
}

int Function_160() //Position: 0x8A0C / 35340
{
	uLocal_387 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, "tempcutscenevol", 2,802597E-45f, Vector(735,689f, 78,306f, 1298,782f), Vector(0.0f, 0.0f, 0.0f), Vector(25.0f, 15.0f, 30.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_163(0, 0, 1, 1, 0, 1, 1, &uLocal_387, 1, 1, 1, 1, 0x3f800000, 0);
	Function_161(StackVal, &uLocal_349, Vector(735,689f, 78,306f, 1298,782f), &uLocal_387, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_161(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8AB4 / 35508
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_162(var uParam0, float fParam1) //Position: 0x8D54 / 36180
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_163(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8DD6 / 36310
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_166(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_3(), 2, Function_166(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_164(int iParam0) //Position: 0x9088 / 37000
{
	int iVar0;
...
var Function_165() //Position: 0x90BC / 37052
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_166(bool bParam0) //Position: 0x914A / 37194
{
	struct<2> Var0;
...
bool Function_167(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x915C / 37212
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_168(vector3 vParam0) //Position: 0x9391 / 37777
{
	var uVar0;
...
float Function_169(var uParam0, bool bParam1) //Position: 0x9407 / 37895
{
	struct<2> Var0;
...
void Function_170(var uParam0, bool bParam1) //Position: 0x9428 / 37928
{
	var uVar0;
	var uVar1;
...
bool Function_171(int iParam0, bool bParam1, bool bParam2) //Position: 0x9492 / 38034
{
...
bool Function_172() //Position: 0x9556 / 38230
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_173(int iParam0) //Position: 0x956D / 38253
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_174(bool bParam0) //Position: 0x9579 / 38265
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_175() //Position: 0x9588 / 38280
{
	Function_177(&uLocal_351);
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_377);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_377);
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
...
int Function_176(bool bParam0, bool bParam1, bool bParam2) //Position: 0x95BA / 38330
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_177(int iParam0) //Position: 0x95EC / 38380
{
	int iVar0;
...
void Function_178(struct<2>[] Param0, int iParam1) //Position: 0x9614 / 38420
{
...
void Function_179(struct<13> Param0) //Position: 0x975F / 38751
{
	int iVar0;
...
bool Function_180(struct<13> Param0) //Position: 0x977C / 38780
{
	int iVar0;
...
void Function_181(var uParam0, int iParam1) //Position: 0x979A / 38810
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_182(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x97AB / 38827
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_184(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_184(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_183(struct<257> Param0) //Position: 0x9936 / 39222
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_183(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_184(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x9972 / 39282
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_187(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_188()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_187(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_188()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_187(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_185() //Position: 0x9BDA / 39898
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_186(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_186(char* cParam0) //Position: 0x9C2E / 39982
{
	char* cVar0[64];
...
bool Function_187(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9D57 / 40279
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_80(&uParam0);
		if (VDIST(Function_80(&uParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
int Function_188() //Position: 0x9DE3 / 40419
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_189(struct<2>[] Param0) //Position: 0x9DF2 / 40434
{
	int iVar0;
	int iVar1;
...
void Function_190() //Position: 0xA1B4 / 41396
{
	if (!Function_97(128))
	{
		return;
...
bool Function_191() //Position: 0xA1F4 / 41460
{
	int iVar0;
...
void Function_192(struct<13> Param0) //Position: 0xA222 / 41506
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_193() //Position: 0xA235 / 41525
{
	if (!Function_97(128))
	{
		return;
...
bool Function_194(var uParam0, int iParam1) //Position: 0xA277 / 41591
{
...
var Function_195(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA28A / 41610
{
	int iVar0;
	var uVar1;
...
var Function_196(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA2C8 / 41672
{
	int iVar0;
...
var Function_197(struct<2>[] Param0, int iParam1, int iParam2, bool bParam3) //Position: 0xA397 / 41879
{
	int iVar0;
