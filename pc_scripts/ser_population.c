...
void main() //Position: 0x0 / 0
{
	...
	Function_11(&(Global_46972[0]), 17, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 23, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 28, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 29, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 30, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 32, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 36, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 45, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 96, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 108, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 109, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 110, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 113, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 152, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 168, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 169, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 176, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 177, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 218, 10.0f, 0, 0);
	Function_11(&(Global_46972[0]), 16, 10.0f, 0, 0);
	Function_14(&(Global_46972[1]));
	Global_46972[1] = Function_13("ped_traveller", 3);
	Function_11(&(Global_46972[1]), 89, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 130, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 223, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 225, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 226, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 227, 1.0f, 0, 0);
	Function_11(&(Global_46972[1]), 229, 1.0f, 0, 0);
	...
	Function_8(&(Global_46972[5]), 1058, 2.0f, 14, 1, 0);
	...
	Function_8(&(Global_46972[5]), 1069, 2.0f, 33, 0, 0);
	Function_8(&(Global_46972[5]), 1070, 2.0f, 33, 0, 0);
	Function_8(&(Global_46972[5]), 1071, 2.0f, 33, 0, 0);
	Function_8(&(Global_46972[5]), 1128, 8.0f, 14, 1, 0);
	...
	Function_11(&(Global_46972[2]), 449, 1.0f, 0, 0);
	Function_11(&(Global_46972[2]), 436, 4.0f, 0, 0);
	...
	Function_11(&(Global_46972[3]), 403, 1.0f, 0, 0);
	Function_11(&(Global_46972[3]), 400, 4.0f, 0, 0);
	Function_11(&(Global_46972[3]), 397, 8.0f, 0, 0);
	Function_11(&(Global_46972[3]), 397, 8.0f, 0, 0);
	Function_11(&(Global_46972[3]), 398, 8.0f, 0, 0);
	Function_14(&(Global_46972[4]));
	Global_46972[4] = Function_13("ped_bad_guys_generic", 1);
	Function_11(&(Global_46972[4]), 474, 1.0f, 0, 0);
	Function_11(&(Global_46972[4]), 470, 4.0f, 0, 0);
	Function_11(&(Global_46972[4]), 467, 8.0f, 0, 0);
	Function_11(&(Global_46972[4]), 467, 8.0f, 0, 0);
	Function_11(&(Global_46972[4]), 467, 8.0f, 0, 0);
	...
	uVar0 = FIND_NAMED_LAYOUT("WreckSerendipity_layout");
	if (IS_LAYOUTREF_VALID(&uVar0))
	{
		uVar1 = FIND_VOLUME_IN_LAYOUT(&uVar0, "serv_birdVol");
		if (IS_VOLUME_VALID(&uVar1))
		{
			Function_3(&uVar1, &(Global_46972[7]), 3E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xC01 / 3073
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC12 / 3090
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xC6A / 3178
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xCFA / 3322
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xD16 / 3350
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD56 / 3414
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD73 / 3443
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD84 / 3460
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xE02 / 3586
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE6E / 3694
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xEDA / 3802
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF5C / 3932
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, int iParam1) //Position: 0xFA3 / 4003
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_14(int iParam0) //Position: 0xFB2 / 4018
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

void Function_15(char* cParam0) //Position: 0xFBF / 4031
{
	if (!Function_4(128))
	{
		return;
