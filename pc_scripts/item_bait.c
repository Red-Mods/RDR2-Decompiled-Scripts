...
void main() //Position: 0x0 / 0
{
	...
	iLocal_118 = 0;
	Function_100(&uScriptParam_0, &iLocal_118);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(vLocal_8[iVar39]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_8[iVar39] + 16);
							iVar5 = 1;
						}
						break;
...
void Function_62(bool bParam0) //Position: 0x28AB / 10411
{
	...
	{
		iLocal_1 = 1;
		uLocal_2 = CREATE_LAYOUT("item_bait_Layout");
		bLocal_4 = Function_63(&uLocal_2, 0, &Global_54076, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28ED / 10477
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "nItem_Bait", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x2973 / 10611
{
	var uVar0;
	int iVar1;
...
void Function_65(int iParam0, var uParam1) //Position: 0x29B2 / 10674
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(-0,43858f, 1,618149f, -1,577148f), Vector(-21,36353f, -156,2639f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &uParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(0,348022f, 0,853729f, 0,21167f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A4F / 10831
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A5B / 10843
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A7A / 10874
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A91 / 10897
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2B22 / 11042
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B46 / 11078
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2B65 / 11109
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2B89 / 11145
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CB1 / 11441
{
...
int Function_75(var uParam0) //Position: 0x2CDF / 11487
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2DF8 / 11768
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2E05 / 11781
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2E87 / 11911
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3432 / 13362
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x346C / 13420
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x348A / 13450
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x34CB / 13515
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x34D7 / 13527
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x34F9 / 13561
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	...
	{
		RELEASE_LAYOUT_OBJECTS(&uLocal_2);
		DESTROY_LAYOUT(&uLocal_2);
	}
	return;
}

void Function_85(var uParam0, bool bParam1) //Position: 0x3533 / 13619
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x3643 / 13891
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x365B / 13915
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x3977 / 14711
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
bool Function_89(int iParam0) //Position: 0x3999 / 14745
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x39B3 / 14771
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x39CE / 14798
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3A0C / 14860
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3A25 / 14885
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3D1D / 15645
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3D3B / 15675
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3DDB / 15835
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x3DFB / 15867
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3E0E / 15886
{
...
void Function_99(int iParam0) //Position: 0x3E2A / 15914
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x3E36 / 15926
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_8[iLocal_1189]), &uParam0);
		iLocal_118++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3EA2 / 16034
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x3EBA / 16058
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3EC6 / 16070
{
