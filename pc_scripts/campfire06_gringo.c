...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_116(&iVar3, "$/fragments/p_gen_campFireCombined01x", "$/tune/refGroups/campsiteSets/cam_campfireLarge01x");
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, RAND_INT_RANGE(3, 5), 1, 1, "ped_wilderness", 5,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
...
void Function_1(struct<473> Param0) //Position: 0x14C / 332
{
	int iVar0;
...
void Function_2() //Position: 0x2FA / 762
{
	return;
}

void Function_3() //Position: 0x300 / 768
{
	Function_4();
	return;
}

void Function_4() //Position: 0x309 / 777
{
...
void Function_5(int iParam0) //Position: 0x31C / 796
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x344 / 836
{
...
void Function_7(struct<13> Param0) //Position: 0x48F / 1167
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x4AC / 1196
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4CA / 1226
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_48 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_50, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_50, 20.0f, fLocal_50));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_51, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_10(struct<62> Param0) //Position: 0x1689 / 5769
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x169B / 5787
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x18D4 / 6356
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18F4 / 6388
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x19E2 / 6626
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C4E / 7246
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C72 / 7282
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C96 / 7318
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1CBC / 7356
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1CE3 / 7395
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1D07 / 7431
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1D26 / 7462
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D75 / 7541
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1DD1 / 7633
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DF2 / 7666
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E4D / 7757
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E99 / 7833
{
...
void Function_27(struct<425> Param0) //Position: 0x1EAE / 7854
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2001 / 8193
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x2076 / 8310
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x20E2 / 8418
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x20FA / 8442
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x2158 / 8536
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x21A5 / 8613
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x221E / 8734
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x226D / 8813
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x2436 / 9270
{
...
void Function_37(int iParam0) //Position: 0x2473 / 9331
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x248C / 9356
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x2499 / 9369
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x258E / 9614
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x264D / 9805
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x2660 / 9824
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x2727 / 10023
{
...
bool Function_44(int iParam0) //Position: 0x2747 / 10055
{
...
bool Function_45(int iParam0) //Position: 0x276B / 10091
{
...
bool Function_46(int iParam0) //Position: 0x2780 / 10112
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x2797 / 10135
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x27D5 / 10197
{
...
bool Function_49(int iParam0) //Position: 0x27EF / 10223
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x2805 / 10245
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x283F / 10303
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x2924 / 10532
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2ADB / 10971
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2B00 / 11008
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B4E / 11086
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2CA5 / 11429
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D50 / 11600
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DF6 / 11766
{
	if (Function_59(&iParam1))
	{
		*(&iParam0 + 24) = &iLocal_0;
		*(&iParam0 + 448) = CREATE_OBJECTSET_IN_LAYOUT(Function_98(), &iParam0 + 24, 12, 1);
		ADD_OBJECT_TO_OBJECTSET(&iLocal_0 + 152, &iParam0 + 448);
		*(&iParam0 + 352) = &iLocal_0 + 176;
		GRINGO_ALLOW_ACTIVATION(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 152), false);
		return 1;
	}
	return 0;
}

bool Function_59(var uParam0) //Position: 0x2E4F / 11855
{
	var uVar0;
	...
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/pee_nospawn", 1, 0);
	if (!Function_65(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_98()));
	*(&iLocal_0 + 144) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend", "horse_stay", Vector(4,616f, 0.0f, -1,410647f), Vector(0.0f, 207,0384f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 144), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(1,369664f, 0.0f, 1,193236f), Vector(0.0f, 38,38386f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground1", "Rand_Idle_Sit_Ground_nospawn", Vector(-1,7474f, 0.0f, -1,071243f), Vector(0.0f, -121,0116f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground2", "Rand_Idle_Sit_Ground", Vector(1,300861f, 0.0f, -1,26305f), Vector(0.0f, 149,426f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground3", "Rand_Idle_Sit_Ground", Vector(0,4647369f, 0.0f, -2,425922f), Vector(0.0f, -192,3359f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn1", "Rand_Idle_Sit_Ground_nospawn", Vector(4,23975f, 0.0f, 1,24789f), Vector(0.0f, 56,21284f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Sit_Ground_Play_Cards", "campfire_talk", Vector(2,809753f, 0.0f, 2,199883f), Vector(0.0f, 222,8808f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "sit_ground_smoke", "Rand_Idle_Sit_Ground_nospawn", Vector(-0,7716185f, 0.0f, 2,247407f), Vector(0.0f, -13,86091f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_drunk_rowdydrink1", "Sit_Ground_Campfire_Tend", Vector(-1,314721f, 0.0f, 1,150843f), Vector(0.0f, -47,80643f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 152) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType6", "Rand_Idle_Sit_Ground_Player", Vector(1,838506f, 0.0f, -0,07260761f), Vector(0.0f, 91,68405f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 152), 0);
	*(&iLocal_0 + 160) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(-2,460321f, 0.0f, -2,505692f), Vector(0.0f, -32,71492f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 160), 0);
	*(&iLocal_0 + 168) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp1", "horse_stay", Vector(0.0f, 0.0f, -4,138711f), Vector(0.0f, -116,6164f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 168), 0);
	*(&iLocal_0 + 176) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Player_Sit_Campfire", "Player_Sit_Campfire", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_0 + 184) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Pee_nospawn1", "Pee_nospawn", Vector(4,282685f, 0.0f, -3,409845f), Vector(0.0f, -48,66195f, 0.0f));
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, int iParam1) //Position: 0x3540 / 13632
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x358B / 13707
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x35C9 / 13769
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x35DC / 13788
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x36AB / 13995
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x36F5 / 14069
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3AB7 / 15031
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x3AF7 / 15095
{
	int iVar0;
...
void Function_68() //Position: 0x3B25 / 15141
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3B67 / 15207
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3BFF / 15359
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3C2E / 15406
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3C89 / 15497
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3C99 / 15513
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3CAD / 15533
{
	int iVar0;
...
var Function_75() //Position: 0x3CD2 / 15570
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3CE9 / 15593
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3E25 / 15909
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3E37 / 15927
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3E49 / 15945
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3E5B / 15963
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3E80 / 16000
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3E9F / 16031
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3EAB / 16043
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3EB6 / 16054
{
	int iVar0;
...
var Function_85() //Position: 0x3EE4 / 16100
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3EF9 / 16121
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x4007 / 16391
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x401B / 16411
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x4087 / 16519
{
	char* cVar0[32];
...
var Function_90() //Position: 0x40A9 / 16553
{
	return "PBox_";
}

var Function_91() //Position: 0x40B7 / 16567
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x40DD / 16605
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x4105 / 16645
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x412B / 16683
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4295 / 17045
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x433D / 17213
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x44AB / 17579
{
...
var Function_98() //Position: 0x4513 / 17683
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x451C / 17692
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x453A / 17722
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x4833 / 18483
{
	int iVar0;
...
void Function_102() //Position: 0x48E7 / 18663
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x4922 / 18722
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x494F / 18767
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4AAA / 19114
{
...
void Function_106() //Position: 0x4AC1 / 19137
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4B0D / 19213
{
	int iVar0;
...
int Function_108() //Position: 0x4BE9 / 19433
{
	int iVar0;
...
int Function_109() //Position: 0x4D45 / 19781
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4E65 / 20069
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4F41 / 20289
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4F60 / 20320
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x50A3 / 20643
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x511A / 20762
{
	var uVar0;
...
int Function_115() //Position: 0x513C / 20796
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x5143 / 20803
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x51D5 / 20949
{
	int iVar0;
