...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_102(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_95(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_93(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_88("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_87(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_80(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_79(&(vLocal_2[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			if (!Function_29(&Param0 + 24, &Param0 + 16))
			{
			...
			if (Param0.f_68 == 6)
			{
				...
				if (bVar19)
				{
					if (Function_26(&Param0 + 16) <= 0.0f)
					{
						if (Function_12(&Param0) < Function_26(&Param0 + 16))
						{
...
void Function_22(var uParam0, int iParam1) //Position: 0x1F65 / 8037
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "DigGraveOutcome"))
		{
			if (DECOR_CHECK_STRING(GRINGO_GET_MY_OBJECT_REF(), "DigGraveOutcome", "SAMPLE_VALUE"))
			{
			}
			else if (DECOR_CHECK_STRING(GRINGO_GET_MY_OBJECT_REF(), "DigGraveOutcome", "SAMPLE_VALUE2"))
			{
			}
			DECOR_REMOVE(GRINGO_GET_MY_OBJECT_REF(), "DigGraveOutcome");
		}
		else
		{
			Function_23("GraveEmpty", 0x41200000, 1, 0, 2, 1, 0);
		}
	}
	return;
}

void Function_23(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2029 / 8233
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_24(int iParam0) //Position: 0x20B4 / 8372
{
	char* cVar0[16];
...
bool Function_25() //Position: 0x20F3 / 8435
{
...
float Function_26(int iParam0) //Position: 0x210E / 8462
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_27() //Position: 0x2125 / 8485
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_28(int iParam0) //Position: 0x2132 / 8498
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_29(int iParam0, bool bParam1) //Position: 0x2153 / 8531
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_30(bool bParam0) //Position: 0x2166 / 8550
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_31() //Position: 0x2186 / 8582
{
	return;
}

void Function_32(var uParam0, bool bParam1) //Position: 0x218C / 8588
{
	int iVar0;
...
bool Function_33(char* cParam0) //Position: 0x21B9 / 8633
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_34(int iParam0) //Position: 0x21C6 / 8646
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_35(char* cParam0, int iParam1) //Position: 0x21E1 / 8673
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_36(int iParam0) //Position: 0x2201 / 8705
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_37(int iParam0) //Position: 0x2221 / 8737
{
	int iVar0;
	int iVar1;
...
bool Function_38(int iParam0) //Position: 0x2258 / 8792
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_39(int iParam0) //Position: 0x2278 / 8824
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x2293 / 8851
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_41(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x22A9 / 8873
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_42() //Position: 0x25CD / 9677
{
	int iVar0;
...
bool Function_43(char* cParam0, int iParam1) //Position: 0x25D6 / 9686
{
...
bool Function_45(char* cParam0, int iParam1) //Position: 0x2604 / 9732
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x2628 / 9768
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_47(int iParam0) //Position: 0x264E / 9806
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_48(var uParam0, int iParam1) //Position: 0x266C / 9836
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x268E / 9870
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_50(bool bParam0, int iParam1) //Position: 0x26B0 / 9904
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_51(var uParam0, int iParam1, bool bParam2) //Position: 0x2778 / 10104
{
	int iVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x27F4 / 10228
{
...
void Function_53(vector3 vParam0) //Position: 0x280C / 10252
{
...
var Function_54(int iParam0) //Position: 0x2831 / 10289
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_55(vector3 vParam0) //Position: 0x2852 / 10322
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_56(var uParam0) //Position: 0x2869 / 10345
{
	uParam0 = &uParam0;
	return;
}

int Function_57() //Position: 0x2875 / 10357
{
	return 1;
}

void Function_58(var uParam0, int iParam1) //Position: 0x287C / 10364
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_59(int iParam0, var uParam1, int iParam2) //Position: 0x288D / 10381
{
	float fVar0;
...
int Function_60(int iParam0) //Position: 0x28D2 / 10450
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_61(int iParam0) //Position: 0x28FE / 10494
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_62(int iParam0) //Position: 0x290A / 10506
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_63(int iParam0) //Position: 0x2A0C / 10764
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_64(int iParam0) //Position: 0x2A2F / 10799
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_65(int iParam0) //Position: 0x2A57 / 10839
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	{
		Function_105("Failed to create gringo camera");
	}
	return;
}

struct<8> Function_66(vector3 vParam0) //Position: 0x2D3E / 11582
{
	struct<2> Var0;
...
struct<8> Function_67(vector3 vParam0) //Position: 0x2D9B / 11675
{
	struct<2> Var0;
...
void Function_68(int iParam0) //Position: 0x2DF8 / 11768
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2E04 / 11780
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2E23 / 11811
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2E3A / 11834
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_72(int iParam0) //Position: 0x2ECB / 11979
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2EEF / 12015
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2F0E / 12046
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2F32 / 12082
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x305A / 12378
{
...
int Function_77(var uParam0) //Position: 0x3088 / 12424
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x31A1 / 12705
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x31AE / 12718
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x3230 / 12848
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x37DB / 14299
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x3815 / 14357
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x3833 / 14387
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_84(int iParam0) //Position: 0x3874 / 14452
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x3880 / 14464
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(int iParam0, int iParam1) //Position: 0x38A2 / 14498
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x38B4 / 14516
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_88(int iParam0, int iParam1) //Position: 0x39C4 / 14788
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_89(struct<69> Param0) //Position: 0x39DC / 14812
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_90(int iParam0, int iParam1) //Position: 0x3CF8 / 15608
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_91(int iParam0) //Position: 0x3D0A / 15626
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_92(int iParam0) //Position: 0x3D24 / 15652
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3D3F / 15679
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3D7D / 15741
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_95(struct<65> Param0) //Position: 0x3D96 / 15766
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_96(int iParam0) //Position: 0x4090 / 16528
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x40AE / 16558
{
	struct<5> Var0;
	float fVar5;
...
int Function_98(int iParam0) //Position: 0x414E / 16718
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(int iParam0, var uParam1) //Position: 0x416E / 16750
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_100(int iParam0) //Position: 0x4181 / 16769
{
...
void Function_101(int iParam0) //Position: 0x419D / 16797
{
	iParam0 = &iParam0;
	return;
}

void Function_102(var uParam0, int iParam1) //Position: 0x41A9 / 16809
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_103(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x4215 / 16917
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_104(int iParam0) //Position: 0x422D / 16941
{
	iParam0 = &iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x4239 / 16953
{
