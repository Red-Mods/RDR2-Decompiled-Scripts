...
void main() //Position: 0x0 / 0
{
	...
	iLocal_124 = 0;
	Function_97(&uScriptParam_0, &iLocal_124);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(vLocal_14[iVar39]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_14[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", &vLocal_14[iVar39] + 24);
							Function_82(&vLocal_14[iVar39] + 24, 1);
							...
							{
								Function_75(&(vLocal_14[iVar39]), 0);
							}
							else if (vLocal_14[iVar39].f_68 < 8)
							{
								Function_74(&(vLocal_14[iVar39]));
	...
	while (iVar0 < (iLocal_124 - 1))
	{
		if (Function_73(vLocal_14[iVar09].f_64, 2))
		{
			...
			Function_75(&(vLocal_14[iVar09]), 0);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_130, &uLocal_128);
...
void Function_29(var uParam0, int iParam1) //Position: 0x1FF5 / 8181
{
	...
	uVar27 = GRINGO_GET_MY_OBJECT_REF();
	if (IS_OBJECT_VALID(&uVar27))
	{
		PRINTSTRING(GET_OBJECT_NAME(&uVar27));
		PRINTNL();
		if (!IS_ATTACHMENT_VALID(&uLocal_2))
		{
			uLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, &uVar27, 4294967295);
		}
		bVar17 = DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "trainAttach");
		cVar0 = GET_GRINGO_STRING_ATTR("LocatorPrefix", &iParam1, &uVar18);
		strcpy(&cVar1, &cVar0, 64);
		straddi(&cVar1, bVar17, 64);
		PRINTSTRING(&cVar1);
		PRINTNL();
		iVar28 = GET_TARGET_OBJECT();
		if (IS_OBJECT_VALID(&iVar28))
		{
			PRINTSTRING(GET_OBJECT_NAME(&iVar28));
			PRINTNL();
			PRINTSTRING(GET_OBJECT_MODEL_NAME(&iVar28));
			PRINTNL();
			iVar29 = CREATE_OBJECT_LOCATOR(&iVar28, &cVar1);
			if (IS_OBJECT_VALID(&iVar29))
			{
				if (OBJECT_LOCATOR_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &iVar29, &iVar28, &cVar1, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
				{
					GET_OBJECT_POSITION(&iVar29, &Var19);
					GET_OBJECT_ORIENTATION(&iVar29, &Var21);
					PRINTVECTOR(Var19);
					PRINTNL();
					PRINTVECTOR(Var21);
					PRINTNL();
					GET_OBJECT_RELATIVE_OFFSET(&uVar27, Var19, &Var23);
					GET_OBJECT_RELATIVE_ORIENTATION_IN_OBJECT_SPACE(&uVar27, Var21, &Var25);
					PRINTVECTOR(Var23);
					PRINTNL();
					PRINTVECTOR(Var25);
					PRINTNL();
					SET_ATTACHMENT_LOCAL_OFFSET(&uLocal_2, Var23);
					SET_ATTACHMENT_LOCAL_ROTATION(&uLocal_2, Var25);
				}
				DESTROY_OBJECT(&iVar29);
			}
		}
	}
	return;
...
bool Function_30(char* cParam0) //Position: 0x2141 / 8513
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x214E / 8526
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2169 / 8553
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2189 / 8585
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x21A9 / 8617
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x21E0 / 8672
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2200 / 8704
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x221B / 8731
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2231 / 8753
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2555 / 9557
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x255E / 9566
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x257D / 9597
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x258C / 9612
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x25B0 / 9648
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x25D6 / 9686
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x25F4 / 9716
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2616 / 9750
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(char* cParam0, int iParam1) //Position: 0x2638 / 9784
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2700 / 9984
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x277C / 10108
{
...
void Function_50(vector3 vParam0) //Position: 0x2794 / 10132
{
...
var Function_51(int iParam0) //Position: 0x27B9 / 10169
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x27DA / 10202
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x27F1 / 10225
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x27FD / 10237
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2804 / 10244
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2815 / 10261
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x285A / 10330
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2886 / 10374
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2892 / 10386
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2994 / 10644
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x29B7 / 10679
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(var uParam0) //Position: 0x29DF / 10719
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar1))
		{
			...
			if (IS_OBJECT_VALID(&uVar2))
			{
				...
				PRINTNL();
				GET_OBJECT_POSITION(&uVar2, &Var7);
				GET_OBJECT_RELATIVE_OFFSET(&uVar1, Var7, &vVar9);
				fVar11 = 0.0f;
				bVar12 = 0.0f;
				if (STRINGS_ARE_EQUAL_CLAMPED(GET_OBJECT_NAME(&uVar0), "train_climb_right", 16))
				{
					fVar11 = 2,25f;
					bVar12 = 1,75f;
				}
				else if (STRINGS_ARE_EQUAL_CLAMPED(GET_OBJECT_NAME(&uVar0), "train_climb_left", 16))
				{
					fVar11 = -2,25f;
					bVar12 = -1,75f;
				}
				Var3 = Vector(fVar11, 3,5f, (vVar9.z + 2,5f));
				Var5 = Vector(0.0f, 0.0f, 0.0f);
				uLocal_4 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uVar0, "GringoCamera", 1, 1);
				if (IS_OBJECT_VALID(&uLocal_4))
				{
					uLocal_6 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&uLocal_4, 0);
					if (!IS_OBJECT_VALID(&uLocal_12))
					{
						uLocal_12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &uLocal_6, "LOCATORATTACHGRINGOCAMERATARG", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
					}
					if (IS_OBJECT_VALID(&uLocal_12))
					{
						ATTACH_OBJECTS(StackVal, StackVal, &uLocal_12, &uVar1, Function_39(), Vector(bVar12, 3,5f, vVar9.z), Vector(0.0f, 0.0f, 0.0f), 4294967295);
					}
					INIT_CAMERASHOT_FROM_GAME_CAMERA(&uLocal_6);
					SET_CAMERASHOT_TARGET_OBJECT(&uLocal_6, &uLocal_12, 0);
					SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &uLocal_6, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
					SET_CAMERASHOT_COLLISION_ENABLED(&uLocal_6, 0);
					uLocal_8 = ATTACH_OBJECTS(&uLocal_6, &uVar1, Function_39(), Var3, Var5, 4294967295);
					if (IS_ATTACHMENT_VALID(&uLocal_8))
					{
					}
					iLocal_10 = CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(&uLocal_4, 0, 4294967295);
					FORCE_CAMERASHOT_UPDATE(&uLocal_6);
					PLAY_CUTSCENEOBJECT(&uLocal_4, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
				}
			}
		}
	}
...
void Function_63(int iParam0) //Position: 0x2BF3 / 11251
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x2BFF / 11263
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2C1E / 11294
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x2C35 / 11317
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_67(int iParam0) //Position: 0x2CC6 / 11462
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2CEA / 11498
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x2D09 / 11529
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x2D2D / 11565
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
int Function_72(var uParam0) //Position: 0x2E83 / 11907
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F9C / 12188
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2FA9 / 12201
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x302B / 12331
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x35D6 / 13782
{
	if (IS_OBJECT_VALID(&uLocal_4))
	{
		if (IS_ATTACHMENT_VALID(&uLocal_8))
		{
			REMOVE_OBJECT_ATTACHMENT(&uLocal_8);
		}
		...
		DESTROY_OBJECT(&uLocal_4);
		CAMERA_RESET(0);
		if (IS_OBJECT_VALID(&uLocal_12))
		{
			DESTROY_OBJECT(&uLocal_12);
		}
	}
	return;
}

int Function_77(int iParam0) //Position: 0x362B / 13867
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3649 / 13897
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x368A / 13962
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x3696 / 13974
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(int iParam0, int iParam1) //Position: 0x36B8 / 14008
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_ATTACHMENT_VALID(&uLocal_2))
...
void Function_82(var uParam0, bool bParam1) //Position: 0x372A / 14122
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x383A / 14394
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3852 / 14418
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x3B6E / 15214
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x3B80 / 15232
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x3B9A / 15258
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x3BB5 / 15285
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3BF3 / 15347
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3C0C / 15372
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3F04 / 16132
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3F22 / 16162
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3FC2 / 16322
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3FE2 / 16354
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3FF5 / 16373
{
...
void Function_96(int iParam0) //Position: 0x4013 / 16403
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x401F / 16415
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_98(&(vLocal_14[iLocal_1249]), &uParam0);
		iLocal_124++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x408B / 16523
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(var uParam0) //Position: 0x40A3 / 16547
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_100(int iParam0) //Position: 0x413D / 16701
{
