...
void main() //Position: 0x0 / 0
{
	...
	iLocal_132 = 0;
	Function_110(&uScriptParam_0, &iLocal_132);
...
float Function_10(int iParam0) //Position: 0x973 / 2419
{
	return Function_11(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(float fParam0, int iParam1, int iParam2) //Position: 0x991 / 2449
{
	int iVar0;
...
float Function_23(int iParam0) //Position: 0x1F7C / 8060
{
...
int Function_25(int iParam0) //Position: 0x1FA0 / 8096
{
...
int Function_27(var uParam0, int iParam1, int iParam2) //Position: 0x1FD2 / 8146
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Function_36(&uParam0, 0);
	Function_35(&uParam0, 0);
	...
	uVar2 = GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam1);
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		Function_31(&iParam1, &uParam0, &iParam2);
	}
	if (!IS_OBJECTSET_VALID(&uLocal_2) && !IS_ACTOR_PLAYER(&uParam0))
	{
		return 0;
	}
	if (!iLocal_19)
	{
		if (IS_ACTOR_PLAYER(&uParam0))
		{
			...
			if (VDIST(Var3, Var5) >= 1,5f)
			{
				...
				{
					uLocal_6 = ADD_SCRIPT_USE_CONTEXT(GET_GRINGO_STRING_ATTR("MidUse", &iParam1, &uVar0), 50, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
				}
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_6))
				{
					...
					ADD_OBJECT_TO_OBJECTSET(&uVar8, &uLocal_4);
					uLocal_13 = DECOR_GET_STRING_HASH(GET_INDEXED_OBJECT_IN_OBJECTSET(bLocal_14, &uLocal_2), "UseAnim");
					GRINGO_ANIM_PLAY_NODE_BY_HASH(&uParam0, &uVar2, uLocal_13);
					iLocal_19 = 1;
				}
			}
			...
			else if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_8) || DECOR_GET_BOOL(&uParam0, "PlayerBreakMSGringo"))
			{
		...
		if (Function_29(StackVal, Local_15))
		{
			...
			if (DECOR_CHECK_EXIST(&uVar9, "MSEndBlockCheck"))
			{
				...
				while (bVar10 < (GET_OBJECTSET_SIZE(&uLocal_2) - 1))
				{
					...
					{
						fLocal_18 = GET_OBJECT_HEADING(&uVar9);
						bLocal_14 = bVar10;
						bVar10 = 99999;
					}
					bVar10++;
		...
		if (!DECOR_CHECK_EXIST(&uParam0, "MultistageNoMove"))
		{
			bVar7 = 0,15f;
			if (DECOR_CHECK_EXIST(&uParam0, "MSGringo_setMoveThreshold"))
			{
				bVar7 = DECOR_GET_FLOAT(&uParam0, "MSGringo_setMoveThreshold");
			}
			else if (bLocal_14 != (GET_OBJECTSET_SIZE(&uLocal_2) - 1))
			{
				bVar7 = Function_11(&iParam1, "MidFlagUseLocTol", 0,15f);
			}
			if (bLocal_14 != (GET_OBJECTSET_SIZE(&uLocal_2) - 1))
			{
				fVar13 = Function_11(&iParam1, "MidFlagUseDirTol", 0.0f);
			}
			else
			{
				fVar13 = Function_11(&iParam1, "EndFlagUseDirTol", 0.0f);
			}
			if (GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &Local_15, bVar7, bVar7, iVar1, fLocal_18, fVar13, 1, 1))
			{
				uLocal_13 = DECOR_GET_STRING_HASH(GET_INDEXED_OBJECT_IN_OBJECTSET(bLocal_14, &uLocal_2), "UseAnim");
				GRINGO_ANIM_PLAY_NODE_BY_HASH(&uParam0, &uVar2, uLocal_13);
				iLocal_19 = 1;
				...
				if (bLocal_14 <= iLocal_12 && !IS_ACTOR_PLAYER(&uParam0))
				{
					bLocal_14 = false;
					return 1;
				}
	...
	if (!GRINGO_ANIM_IS_SUBNODE_PLAYING_BY_HASH(&uParam0, &uVar2, uLocal_13))
	{
		if (!iLocal_20)
		{
			iLocal_20 = 1;
			if (GET_GRINGO_INT_ATTR(&iVar14, "StationsUsed", &iParam1))
			{
				iVar14++;
				SET_GRINGO_INT_ATTR(iVar14, "StationsUsed", &iParam1);
			}
		}
		if (IS_ACTOR_PLAYER(&uParam0))
		{
			...
			if (VDIST(Var3, Var5) >= 1,5f)
			{
				...
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_6))
				{
					...
					ADD_OBJECT_TO_OBJECTSET(&uVar15, &uLocal_4);
					uLocal_13 = DECOR_GET_STRING_HASH(GET_INDEXED_OBJECT_IN_OBJECTSET(bLocal_14, &uLocal_2), "UseAnim");
					GRINGO_ANIM_PLAY_NODE_BY_HASH(&uParam0, &uVar2, uLocal_13);
					iLocal_20 = 0;
				}
		...
		if (Function_29(StackVal, Local_15))
		{
			...
			fLocal_18 = GET_OBJECT_HEADING(GET_INDEXED_OBJECT_IN_OBJECTSET(bLocal_14, &uLocal_2));
		}
		if (!DECOR_CHECK_EXIST(&uParam0, "MultistageNoMove"))
		{
			bVar7 = 0.0f;
			...
			if (bLocal_14 != (GET_OBJECTSET_SIZE(&uLocal_2) - 1))
			{
				fVar16 = Function_11(&iParam1, "MidFlagUseDirTol", 0.0f);
			}
			else
			{
				fVar16 = Function_11(&iParam1, "EndFlagUseDirTol", 0.0f);
			}
			if (GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &Local_15, bVar7, 0.0f, iVar1, fLocal_18, fVar16, 1, 0))
			{
				uLocal_13 = DECOR_GET_STRING_HASH(GET_INDEXED_OBJECT_IN_OBJECTSET(bLocal_14, &uLocal_2), "UseAnim");
				GRINGO_ANIM_PLAY_NODE_BY_HASH(&uParam0, &uVar2, uLocal_13);
				bLocal_14++;
		...
		while (bVar3 < (GET_OBJECTSET_SIZE(&uLocal_2) - 2))
		{
			if (!STRING_CONTAINS_STRING(GET_OBJECT_NAME(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar3, &uLocal_2)), "endflag"))
			{
				...
				if (VDIST(Var5, Param0) > bVar2)
				{
					bVar7 = true;
					bVar4 = false;
					while (bVar4 < (GET_OBJECTSET_SIZE(&uLocal_4) - 1))
					{
						if (STRINGS_ARE_EQUAL(GET_OBJECT_NAME(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar3, &uLocal_2)), GET_OBJECT_NAME(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar4, &uLocal_4))))
						{
							bVar2 = 5000.0f;
							bVar7 = false;
						}
...
int Function_31(int iParam0, var uParam1, int iParam2) //Position: 0x27CE / 10190
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	strcpy(&cVar3, GET_GRINGO_STRING_ATTR("ChildFlags", &iParam0, &iVar0), 32);
	if (iVar0 == 0)
	{
		return 0;
	}
	...
	{
		uLocal_4 = CREATE_OBJECTSET_IN_LAYOUT(Function_32(), &uVar2, 4294967295, 0);
	}
	iParam2 = 0;
	return 1;
}
...
void Function_56(char* cParam0, int iParam1) //Position: 0x2F93 / 12179
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_66(int iParam0) //Position: 0x31B5 / 12725
{
...
int Function_70(int iParam0) //Position: 0x3312 / 13074
{
...
int Function_80(int iParam0) //Position: 0x37F1 / 14321
{
...
int Function_88(int iParam0) //Position: 0x40FA / 16634
{
...
void Function_93(var uParam0, int iParam1) //Position: 0x4196 / 16790
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_94(var uParam0, bool bParam1) //Position: 0x42B5 / 17077
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_95(int iParam0, int iParam1) //Position: 0x43C5 / 17349
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_96(struct<69> Param0) //Position: 0x43DD / 17373
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_97(var uParam0, int iParam1) //Position: 0x46F9 / 18169
{
	uParam0 = &uParam0;
...
void Function_98(var uParam0, int iParam1) //Position: 0x470B / 18187
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		DECOR_SET_BOOL(&uLocal_10, "Gringo_PropInUse", 1);
...
bool Function_99(int iParam0) //Position: 0x47C9 / 18377
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_100(int iParam0) //Position: 0x47E3 / 18403
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_101(int iParam0, var uParam1) //Position: 0x47FE / 18430
{
	bool bVar0;
	int iVar1;
...
bool Function_102(var uParam0, int iParam1) //Position: 0x483C / 18492
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_103(struct<65> Param0) //Position: 0x4855 / 18517
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_104(int iParam0) //Position: 0x4B4D / 19277
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_105(var uParam0, int iParam1) //Position: 0x4B6B / 19307
{
	struct<5> Var0;
	float fVar5;
...
int Function_106(int iParam0) //Position: 0x4C0B / 19467
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_107(var uParam0, int iParam1) //Position: 0x4C2B / 19499
{
	return Function_31(&iParam1, &uParam0, &iLocal_21);
}

bool Function_108(int iParam0) //Position: 0x4C3C / 19516
{
...
void Function_109(int iParam0) //Position: 0x4C58 / 19544
{
	iParam0 = &iParam0;
	return;
}

void Function_110(var uParam0, int iParam1) //Position: 0x4C64 / 19556
{
	int iVar0;
	var uVar1;
	...
	{
		Function_111(&(vLocal_22[iLocal_1329]), &uParam0);
		iLocal_132++;
	}
...
void Function_111(int iParam0, int iParam1) //Position: 0x4CD0 / 19664
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_112(int iParam0) //Position: 0x4CE8 / 19688
{
	iParam0 = &iParam0;
	return;
}

void Function_113(int iParam0) //Position: 0x4CF4 / 19700
{
