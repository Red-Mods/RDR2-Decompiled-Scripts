	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_38 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_40, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_40, 20.0f, fLocal_40));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_41, &Param0 + 488, 0, 0, 0x40400000))
						{
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DEB / 11755
{
	if (Function_59(&iParam1))
	{
		...
		*(&iParam0 + 448) = CREATE_OBJECTSET_IN_LAYOUT(Function_98(), &iParam0 + 24, 12, 1);
		ADD_OBJECT_TO_OBJECTSET(&iLocal_0 + 120, &iParam0 + 448);
		*(&iParam0 + 352) = &iLocal_0 + 144;
		GRINGO_ALLOW_ACTIVATION(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 120), false);
		return 1;
	}
	return 0;
}
...
void Function_60(int iParam0, int iParam1) //Position: 0x34F1 / 13553
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x353C / 13628
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x357A / 13690
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x358D / 13709
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x365C / 13916
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x36A6 / 13990
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3A68 / 14952
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x3AA8 / 15016
{
	int iVar0;
...
void Function_68() //Position: 0x3AD6 / 15062
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3B18 / 15128
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3BB0 / 15280
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3BDF / 15327
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3C3A / 15418
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3C4A / 15434
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3C5E / 15454
{
	int iVar0;
...
var Function_75() //Position: 0x3C83 / 15491
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3C9A / 15514
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3DD6 / 15830
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3DE8 / 15848
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3DFA / 15866
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3E0C / 15884
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3E31 / 15921
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3E50 / 15952
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3E5C / 15964
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3E67 / 15975
{
	int iVar0;
...
var Function_85() //Position: 0x3E95 / 16021
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3EAA / 16042
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3FB7 / 16311
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3FCB / 16331
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x4039 / 16441
{
	char* cVar0[32];
...
var Function_90() //Position: 0x405B / 16475
{
	return "PBox_";
}

var Function_91() //Position: 0x4069 / 16489
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x408F / 16527
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x40B7 / 16567
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x40DD / 16605
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4247 / 16967
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x42EF / 17135
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x445D / 17501
{
...
var Function_98() //Position: 0x44C5 / 17605
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x44CE / 17614
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x44EC / 17644
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x47E5 / 18405
{
	int iVar0;
...
void Function_102() //Position: 0x4899 / 18585
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x48D4 / 18644
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4901 / 18689
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4A5C / 19036
{
...
void Function_106() //Position: 0x4A73 / 19059
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4ABF / 19135
{
	int iVar0;
...
int Function_108() //Position: 0x4B9B / 19355
{
	int iVar0;
...
int Function_109() //Position: 0x4CF7 / 19703
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4E17 / 19991
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4EF3 / 20211
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4F12 / 20242
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x5055 / 20565
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x50CC / 20684
{
	var uVar0;
...
int Function_115() //Position: 0x50EE / 20718
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x50F5 / 20725
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x5187 / 20871
{
	int iVar0;
