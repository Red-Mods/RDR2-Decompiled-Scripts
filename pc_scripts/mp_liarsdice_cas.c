...
void Function_75() //Position: 0x1A86 / 6790
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_264 = CREATE_LAYOUT("LiarsDice_CAS_layout");
	(&iLocal_264 + 208) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_264, "StayOutVol", 2,802597E-45f, Vector(-789,2335f, 14,30195f, 3699,008f), Vector(0.0f, 0.0f, 0.0f), Vector(6,320756f, 6,320756f, 6,320756f));
	*(&iLocal_264 + 216) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_264, 8, 0);
	*(&iLocal_264 + 224[03]) = Vector(-791,4677f, 13,12645f, 3697,932f);
	*(&iLocal_264 + 224[03] + 12) = Vector(0.0f, 600,2031f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "PlayerPosition", Vector(-791,4677f, 13,12645f, 3697,932f), Vector(0.0f, 600,2031f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_264 + 216);
	*(&iLocal_264 + 224[13]) = Vector(-786,6812f, 13,17188f, 3698,242f);
	*(&iLocal_264 + 224[13] + 12) = Vector(0.0f, 413,3004f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_0_Position", Vector(-786,6812f, 13,17188f, 3698,242f), Vector(0.0f, 413,3004f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_264 + 216);
	*(&iLocal_264 + 224[23]) = Vector(-788,847f, 13,17189f, 3701,045f);
	*(&iLocal_264 + 224[23] + 12) = Vector(0.0f, -373,3628f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_1_Position", Vector(-788,847f, 13,17189f, 3701,045f), Vector(0.0f, -373,3628f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_264 + 216);
	*(&iLocal_264 + 224[33]) = Vector(-790,9131f, 13,17189f, 3701,045f);
	*(&iLocal_264 + 224[33] + 12) = Vector(0.0f, -353,2975f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_2_Position", Vector(-790,9131f, 13,17189f, 3701,045f), Vector(0.0f, -353,2975f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_264 + 216);
	*(&iLocal_264 + 224[43]) = Vector(-789,6522f, 13,17189f, 3701,045f);
	*(&iLocal_264 + 224[43] + 12) = Vector(0.0f, 316,5571f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "AI_3_Position", Vector(-789,6522f, 13,17189f, 3701,045f), Vector(0.0f, 316,5571f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_264 + 216);
	*(&iLocal_264 + 352) = Vector(-789,002f, 13,965f, 3698,875f);
	*(&iLocal_264 + 352 + 12) = Vector(0.0f, -47,22866f, 0.0f);
	*(&iLocal_264 + 376) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "TableCenter", Vector(-789,002f, 13,965f, 3698,875f), Vector(0.0f, -47,22866f, 0.0f));
	*(&iLocal_264 + 384) = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", &iLocal_264, 8, 0);
	*(&iLocal_264 + 392[03]) = Vector(0,7382904f, 0.0f, 0.0f);
	*(&iLocal_264 + 392[03] + 12) = Vector(0.0f, -239,9064f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Waitress_0_Pos", Vector(0,7382904f, 0.0f, 0.0f), Vector(0.0f, -239,9064f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_264 + 384);
	*(&iLocal_264 + 392[13]) = Vector(-1,150039f, 0.0f, 2,387824f);
	*(&iLocal_264 + 392[13] + 12) = Vector(0.0f, 96,24262f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Waitress_1_Pos", Vector(-1,150039f, 0.0f, 2,387824f), Vector(0.0f, 96,24262f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_264 + 384);
	*(&iLocal_264 + 448) = Vector(-788,6586f, 13,16462f, 3698,422f);
	*(&iLocal_264 + 448 + 12) = Vector(-0,3083775f, 119,2131f, -0,2924392f);
	*(&iLocal_264 + 472) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_0", Vector(-788,6586f, 13,16462f, 3698,422f), Vector(-0,3083775f, 119,2131f, -0,2924392f));
	*(&iLocal_264 + 480) = Vector(-788,4316f, 13,16762f, 3698,957f);
	*(&iLocal_264 + 480 + 12) = Vector(-1,168841f, 58,23166f, -1,80301f);
	*(&iLocal_264 + 504) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_1", Vector(-788,4316f, 13,16762f, 3698,957f), Vector(-1,168841f, 58,23166f, -1,80301f));
	*(&iLocal_264 + 512) = Vector(-788,7964f, 13,165f, 3699,425f);
	*(&iLocal_264 + 512 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_264 + 536) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_2", Vector(-788,7964f, 13,165f, 3699,425f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_264 + 544) = Vector(-789,389f, 13,165f, 3699,35f);
	*(&iLocal_264 + 544 + 12) = Vector(0.0f, -60,34258f, 0.0f);
	*(&iLocal_264 + 568) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_3", Vector(-789,389f, 13,165f, 3699,35f), Vector(0.0f, -60,34258f, 0.0f));
	*(&iLocal_264 + 576) = Vector(-789,6095f, 13,165f, 3698,805f);
	*(&iLocal_264 + 576 + 12) = Vector(0.0f, -118,031f, 0.0f);
	*(&iLocal_264 + 600) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_4", Vector(-789,6095f, 13,165f, 3698,805f), Vector(0.0f, -118,031f, 0.0f));
	*(&iLocal_264 + 608) = Vector(-789,2333f, 13,165f, 3698,335f);
	*(&iLocal_264 + 608 + 12) = Vector(0.0f, -173,8975f, 0.0f);
	*(&iLocal_264 + 632) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_264, "Seat_5", Vector(-789,2333f, 13,165f, 3698,335f), Vector(0.0f, -173,8975f, 0.0f));
	return;
}
