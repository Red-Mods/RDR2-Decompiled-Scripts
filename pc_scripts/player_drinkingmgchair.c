...
void Function_2(bool bParam0, bool bParam1) //Position: 0x442 / 1090
{
	var uVar0;
	...
	{
		uVar0 = GET_OBJECT_NAME(&bParam1);
	}
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), &bParam1, GET_TARGET_OBJECT(), &uVar0, ": ", &bParam0, 0);
	return;
}
...
bool Function_26(bool bParam0, bool bParam1) //Position: 0x1FBC / 8124
{
	bParam1 = &bParam1;
	bParam0 = &bParam0;
	Function_2("OnContinueUse", &bParam0);
	if (&bParam0 == GET_PLAYER_ACTOR(0))
	{
		if (DECOR_CHECK_EXIST(&bParam0, "BreakDrinkingChair"))
		{
			DECOR_REMOVE(&bParam0, "BreakDrinkingChair");
			Function_2("OnContinueUse: FINISHED", &bParam0);
			return 0;
		}
	}
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x204B / 8267
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x206B / 8299
{
	return;
}

void Function_29(bool bParam0, int iParam1) //Position: 0x2071 / 8305
{
	iParam1 = &iParam1;
	bParam0 = &bParam0;
	Function_2("OnStartAnim", &bParam0);
	if (DECOR_CHECK_EXIST(&bParam0, "BreakDrinkingChair"))
	{
		DECOR_REMOVE(&bParam0, "BreakDrinkingChair");
	}
...
bool Function_30(char* cParam0) //Position: 0x20D1 / 8401
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x20DE / 8414
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x20F9 / 8441
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2119 / 8473
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2139 / 8505
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2170 / 8560
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2190 / 8592
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x21AB / 8619
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x21C1 / 8641
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x24E5 / 9445
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x24EE / 9454
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x250D / 9485
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x251C / 9500
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2540 / 9536
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x2566 / 9574
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2584 / 9604
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x25A6 / 9638
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x25C8 / 9672
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2690 / 9872
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x270C / 9996
{
...
void Function_50(vector3 vParam0) //Position: 0x2724 / 10020
{
...
var Function_51(int iParam0) //Position: 0x2749 / 10057
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x276A / 10090
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2781 / 10113
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x278D / 10125
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2794 / 10132
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x27A5 / 10149
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27EA / 10218
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2816 / 10262
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2822 / 10274
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2924 / 10532
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2947 / 10567
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x296F / 10607
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2C56 / 11350
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2CB3 / 11443
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2D10 / 11536
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2D1C / 11548
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2D3B / 11579
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2D52 / 11602
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2DE3 / 11747
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E07 / 11783
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2E26 / 11814
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2E4A / 11850
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F72 / 12146
{
...
int Function_74(var uParam0) //Position: 0x2FA0 / 12192
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x30B9 / 12473
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x30C6 / 12486
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3148 / 12616
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x36F3 / 14067
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x372D / 14125
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x374B / 14155
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x378C / 14220
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3798 / 14232
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(char* cParam0, int iParam1) //Position: 0x37BA / 14266
{
	var uVar0;
	var uVar2;
	...
	iParam1 = &iParam1;
	cParam0 = &cParam0;
	GET_POSITION(&cParam0, &uVar0);
	Function_2("OnFinish", &cParam0);
	uVar2 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/chair_sit_table_attach", &uVar0, 1.0f, 0);
	if (IS_GRINGO_VALID(&uVar2))
	{
		GRINGO_ALLOW_ACTIVATION(&uVar2, true);
	}
	if (DECOR_CHECK_EXIST(&cParam0, "GringoNoQuit"))
	{
		DECOR_REMOVE(&cParam0, "GringoNoQuit");
	}
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x3874 / 14452
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3984 / 14724
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x399C / 14748
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(char* cParam0, int iParam1) //Position: 0x3CB8 / 15544
{
	iParam1 = &iParam1;
	cParam0 = &cParam0;
	Function_2("OnStartUse", &cParam0);
	if (!IS_ACTOR_PLAYER(&cParam0))
	{
	}
	else
	{
		DECOR_SET_INT(&cParam0, "GringoNoQuit", false);
	}
	return;
}

bool Function_88(int iParam0) //Position: 0x3D01 / 15617
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3D1B / 15643
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3D36 / 15670
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3D74 / 15732
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3D8D / 15757
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x4086 / 16518
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x40A4 / 16548
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4144 / 16708
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4164 / 16740
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x4177 / 16759
{
...
void Function_98(int iParam0) //Position: 0x4193 / 16787
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x419F / 16799
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x420B / 16907
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4223 / 16931
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x422F / 16943
{
