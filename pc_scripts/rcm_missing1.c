...
void main() //Position: 0x0 / 0
{
	...
	iLocal_334 = 16;
	iLocal_335 = 0;
	Local_350 = Vector(-2641,181f, 67,263f, 3409,389f);
	Local_378 = Vector(-2652,26f, 68,3f, 3425,26f);
	Local_381 = Vector(-0,4054303f, 586.0f, -3,193105f);
	iLocal_402 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			REQUEST_STRING_TABLE("dlc_zombiepack_pmp");
			Function_194(&uLocal_354, "$/content/DLC/ZombiePack/Gringos/ZombiePack_getmissingposter", 1, 0);
			Function_194(&uLocal_354, "$/fragments/p_pos_missing00x", 0, 0);
			Function_194(&uLocal_354, "stand_poster", 5, 0);
			Function_194(&uLocal_354, "custom/stand_poster", 8, 0);
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					case 0x00000000:
						if (Function_189(&uLocal_354))
						{
							if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288) || Global_116927[196].f_24 != 1)
							{
								if (IS_LAYOUTREF_VALID(&uLocal_376))
								{
									uLocal_372 = CREATE_PROP_IN_LAYOUT(&uLocal_376, "RCM_Missing_P", "$/fragments/p_pos_missing00x", Local_378, Local_381, false);
									uLocal_374 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uLocal_372, "RCM_Missing_G", "$/content/DLC/ZombiePack/Gringos/ZombiePack_getmissingposter", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
									GRINGO_ALLOW_ACTIVATION(GET_GRINGO_FROM_OBJECT(&uLocal_374), true);
									SET_PROP_AI_OBSTACLE_ENABLED(&uLocal_372, 0);
									SET_OBJECT_COLLIDE_WITH_WORLD(&uLocal_372, 0);
									SET_OBJECT_COLLIDE_WITH_MOVABLES(&uLocal_372, 0);
									SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(&uLocal_372), true);
									SET_DRAW_OBJECT(&uLocal_372, 0);
									uLocal_388 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("fortmercer_layout"), "fomv_courtyard_set");
									uLocal_384 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_376, "contextVolume", 3, Local_378, Vector(0.0f, 0.0f, 0.0f), Vector(2,5f, 2.0f, 2,5f));
									uLocal_392 = ADD_SCRIPT_USE_CONTEXT_IN_VOLUME("pm_wp_takePoster", &uLocal_384, 36, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									uLocal_386 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_376, "ZombieStayOut", 2,802597E-45f, Vector(-2653,961f, 68,86f, 3422,246f), Vector(0.0f, 0.0f, 0.0f), Vector(15.0f, 10.0f, 15.0f));
									ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_386);
									ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_386);
									if (Global_116927[196].f_24 == 0)
									{
										iVar0 = 1;
									}
									else
								...
								{
									uLocal_376 = CREATE_LAYOUT("RCM_Missing_Layout");
								}
							}
						}
						break;
					...
					case 0x00000001:
						...
						{
							Function_188(&Global_99725[ScriptParam_043] + 228, 128);
						...
						if (!IS_VOLUME_VALID(&uLocal_390))
						{
							uLocal_390 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_376, "restartSpawnVol", 2,802597E-45f, Vector(-2676,011f, 73,655f, 3418,167f), Vector(0.0f, 225.0f, 0.0f), Vector(20.0f, 6.0f, 10.0f));
						}
						else if (!IS_VOLUME_VALID(&uLocal_388))
						{
							uLocal_388 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("fortmercer_layout"), "fomv_courtyard_set");
						}
						else if (IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_388) && !IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_390))
						{
							iVar0 = 3;
							break;
						}
						Function_167(&(Global_99725[1943]), 19, 100.0f, 150.0f, 0);
						break;
					
					case 0x00000003:
						if (Function_126("$/cutscene/missing_persons_1_cs/missing_persons_1_cs", &iLocal_336, 36362, 36355, 35060, 34937, 34676, 34660, 1, 1, 2, 2, 0))
						{
					...
					case 0x00000005:
						...
						{
							Function_125("missing1_TAKEPOSTER", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "missing1_OBJ", 0, 3, false);
							Function_124(Global_99725[ScriptParam_043].f_224, 0);
							Global_116927[196].f_24 = 1;
							Function_188(&Global_99725[1943] + 228, 2048);
							iVar0 = 8;
						}
						break;
					...
					case 0x00000008:
						...
						{
							case 0x00000000:
								uLocal_398 = CREATE_CAMERA_FOCUS_POINT_OBJECT_WITH_TUNING(&uLocal_376, Function_123(), &uLocal_372, "wantedPoster", 2.0f, 5.0f);
								if (!IS_OBJECT_VALID(&uLocal_398))
								{
									LOG_ERROR("Could not create wanted poster camera focus");
								}
								else
								{
									SET_CAMERA_FOCUS_PROMPT_TEXT(&uLocal_398, "npm_bh_cfp");
									SET_CAMERA_FOCUS_PLAYER_INVULNERABLE(&uLocal_398, 1);
									SET_CAMERA_FOCUS_PLAYER_INPUT_DISABLED(&uLocal_398, 1);
								}
								SET_DRAW_OBJECT(&uLocal_372, 1);
								Function_188(&Global_99725[1943] + 228, 2048);
								Global_39906.f_12 = 1;
								Global_39906.f_20 = 339;
								Global_39906.f_24 = Global_46760[10];
								Global_39906.f_28 = Global_46838[1];
								Global_39906.f_32 = 0;
								Global_39906.f_40 = 0;
								Global_39906.f_16 = Function_122(Global_39906.f_12);
								Function_115(&uLocal_376, &uLocal_372, &uLocal_400, 1);
								iLocal_402 = 1;
								break;
							
							case 0x00000001:
								if (IS_SCRIPT_USE_CONTEXT_VALID(&uLocal_392))
								{
									if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(&uLocal_392))
									{
										if (MAKE_ACTOR_READY_FOR_ACTION(&Global_54076, 1))
										{
											GRINGO_ALLOW_ACTIVATION(GET_GRINGO_FROM_OBJECT(&uLocal_374), true);
											ENABLE_USE_CONTEXTS(0);
											DESTROY_VOLUME(&uLocal_384);
											TASK_CLEAR(&Global_54076);
											TASK_USE_GRINGO(&Global_54076, GET_GRINGO_FROM_OBJECT(&uLocal_374), "nPlayerUse", true, 1);
											SNAP_ACTOR_TO_GRINGO(&Global_54076, &uLocal_374, "nPlayerUse", false, 1, 0);
											if (IS_OBJECT_VALID(&uLocal_398))
											{
											...
											{
												Function_114(&uLocal_372);
											}
											iVar0 = 9;
										}
									}
									else if (IS_OBJECT_VALID(&uLocal_398))
									{
										if (IS_CAMERA_FOCUS_ENABLED(&uLocal_398))
										{
											if (!IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_384))
											{
												SET_CAMERA_FOCUS_ENABLED(&uLocal_398, 0);
											}
											else if (IS_CAMERA_FOCUS_ACTIVE(&uLocal_398))
											{
												MAKE_ACTOR_READY_FOR_ACTION(&Global_54076, 1);
												TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2653,303f, 67,263f, 3424,062f), 228,253f, 1, 1, true);
												ENABLE_USE_CONTEXTS(0);
												RELEASE_SCRIPT_USE_CONTEXT(&uLocal_392);
												iLocal_402 = 3;
											}
										}
										else if (IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_384))
										{
											SET_CAMERA_FOCUS_ENABLED(&uLocal_398, 1);
										}
									}
								}
								if (!IS_BLIP_VALID(&uLocal_396))
								{
									uLocal_396 = ADD_BLIP_FOR_OBJECT(&uLocal_372, 549, 0f, 2, 0);
									SET_BLIP_NAME(&uLocal_396, "MISSING");
								}
								if (!IS_VOLUME_VALID(&uLocal_384))
								{
								}
								break;
							
							case 0x00000003:
								if (!IS_CAMERA_FOCUS_ACTIVE(&uLocal_398))
								{
						...
						if (IS_BLIP_VALID(&Global_99725[1943] + 272))
						{
							REMOVE_BLIP(&Global_99725[1943] + 272);
						}
						if (IS_BLIP_VALID(&Global_99725[1943] + 280))
						{
							REMOVE_BLIP(&Global_99725[1943] + 280);
						}
						break;
					
					case 0x00000009:
						if (!IS_OBJECT_VALID(&uLocal_372) || !IS_OBJECT_VALID(&uLocal_374))
						{
							ENABLE_USE_CONTEXTS(1);
							TASK_CLEAR(&Global_54076);
							SET_PLAYER_CONTROL(0, 1, 0, 0);
							Function_125("missing1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							iLocal_394 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
							iLocal_395 = 0;
							while (iLocal_395 <= iLocal_394)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iLocal_395), 4, 0);
								iLocal_395++;
							}
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "missing1a_OBJ", 0, 3, false);
							Function_124(Global_99725[ScriptParam_043].f_224, 0);
							iVar0 = 13;
						}
						break;
					...
					case 0x0000000D:
						if (!HAS_ITEM(Function_113(72), &Global_54076))
						{
							Function_112(72, 1, 0);
						}
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xAEE / 2798
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xF68 / 3944
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0x1109 / 4361
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x110F / 4367
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0x114E / 4430
{
...
void Function_6() //Position: 0x11A3 / 4515
{
	Function_33();
	Function_32();
	Function_32();
...
void Function_7() //Position: 0x11EE / 4590
{
...
void Function_8() //Position: 0x12F4 / 4852
{
	float fVar0;
...
void Function_9() //Position: 0x1327 / 4903
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x14BA / 5306
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x1673 / 5747
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x1681 / 5761
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x189E / 6302
{
...
struct<8> Function_14(int iParam0) //Position: 0x18B3 / 6323
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x195A / 6490
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1BF6 / 7158
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_17(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_123(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_17(int iParam0) //Position: 0x2234 / 8756
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2245 / 8773
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0) //Position: 0x233C / 9020
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2357 / 9047
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x23BE / 9150
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x23D0 / 9168
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x23E2 / 9186
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x2516 / 9494
{
	return Global_55480[iParam016].f_96;
}

float Function_25(int iParam0) //Position: 0x2525 / 9509
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x255E / 9566
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x259B / 9627
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x2735 / 10037
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x2979 / 10617
{
...
struct<8> Function_30() //Position: 0x29BA / 10682
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x2A43 / 10819
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x2ADA / 10970
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x2B59 / 11097
{
	...
	Function_34(7, (GET_CURRENT_GAME_TIME() - Global_77930), 0);
	Global_77930 = GET_CURRENT_GAME_TIME();
	Function_15(8, (GET_DAY(false) - 2), 0);
	return;
}

int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x2B96 / 11158
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x2DA2 / 11682
{
	struct<2> Var0;
	var uVar2;
	...
	{
		Function_37(&Global_53524 + 12, &Global_53524 + 16, 0, 0);
		Var0 = Function_37(&Global_53524 + 12, &Global_53524 + 16, 0, 0);
	}
	if (Function_36(StackVal, Var0))
	{
		Var0 = Global_54078;
...
bool Function_36(char* cParam0) //Position: 0x2E59 / 11865
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_37(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2E71 / 11889
{
	int iVar0;
	...
	Function_38();
	return StackVal, Function_38();
}

struct<8> Function_38() //Position: 0x2F69 / 12137
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_39(int iParam0) //Position: 0x2F73 / 12147
{
...
int Function_40(bool bParam0, bool bParam1) //Position: 0x2F89 / 12169
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_41(struct<2> Param0, struct<2> Param2) //Position: 0x3055 / 12373
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_42(float fParam0, int iParam1) //Position: 0x3072 / 12402
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_43(int iParam0) //Position: 0x389E / 14494
{
	var uVar0;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x38D9 / 14553
{
	return (uParam0 && iParam1) == 0;
}

void Function_45(var uParam0, int iParam1) //Position: 0x38E6 / 14566
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_46(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x38F5 / 14581
{
	uParam0 = &uParam0;
...
void Function_47(int iParam0) //Position: 0x39A4 / 14756
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_55(4) && !Function_53(0))
	{
		iVar0 = "ZOMBIE_STORY_1a_SHORT";
	}
	if (Function_55(5))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_1_OBJ", 4, 0);
		Function_56("ZOMBIE_STORY_2Nigel_OBJ");
		Function_56("ZOMBIE_STORY_2Seth_OBJ");
		if (!Function_55(8) && !Function_55(6))
		{
	...
	if (Function_55(6))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_2Seth_OBJ", 4, 0);
		if (!Function_55(8))
		{
	...
	if (Function_55(8))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_2Nigel_OBJ", 4, 0);
		if (!Function_55(6))
		{
			iVar0 = "ZOMBIE_STORY_2Seth_SHORT";
		}
	}
	if (!Function_50(&Global_6667[228] + 184, 2) || ((((((Function_55(14) && Function_55(18)) && Function_55(37)) && Function_55(7)) && Function_55(11)) && Function_55(5)) && Function_55(21)))
	{
	...
	if (Function_57(2, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_3_OBJ", 4, 0);
	...
	if (!Function_50(&Global_6667[328] + 184, 2) || ((Function_55(27) && Function_55(1)) && Function_55(23)))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_4_OBJ", 4, 0);
	...
	if (Function_57(3, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_51(), "ZOMBIE_STORY_5_OBJ", 4, 0);
	}
	if (!Function_55(5))
	{
	...
	if (!Function_55(7))
	{
		...
		if (((Function_55(6) && Function_48(Global_46949) < 0) && Function_48(Global_46951) < 0) && Function_48(Global_46952) < 0)
		{
	...
	{
		Function_125(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_48(int iParam0) //Position: 0x42C6 / 17094
{
...
bool Function_49(int iParam0) //Position: 0x42E0 / 17120
{
...
bool Function_50(int iParam0, int iParam1) //Position: 0x42F7 / 17143
{
	int iVar0;
...
bool Function_51() //Position: 0x4314 / 17172
{
	return STRING_TO_HASH(Function_52());
}

var Function_52() //Position: 0x4320 / 17184
{
	return "ZOMBIE_STORY";
}

bool Function_53(int iParam0) //Position: 0x4335 / 17205
{
	...
	return Global_21684[Function_54(iParam0)7].f_12 < 0;
}

int Function_54(int iParam0) //Position: 0x439B / 17307
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_55(int iParam0) //Position: 0x445D / 17501
{
...
void Function_56(int iParam0) //Position: 0x4472 / 17522
{
	if (!IS_JOURNAL_ENTRY_IN_LIST(Function_51(), 0))
	{
		CREATE_JOURNAL_ENTRY(Function_52(), 2, 38, "Mission_Strangers");
		PREPEND_JOURNAL_ENTRY(Function_51(), false);
	}
	APPEND_JOURNAL_ENTRY_DETAIL(Function_51(), &iParam0, 0, 3, false);
	Function_124(Function_51(), 0);
	return;
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x44BB / 17595
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x44F9 / 17657
{
...
bool Function_59(int iParam0) //Position: 0x4513 / 17683
{
...
void Function_60(bool bParam0) //Position: 0x4529 / 17705
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_44(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_188(&Global_99725[iVar143] + 228, 64);
...
void Function_61(struct<229> Param0) //Position: 0x46E3 / 18147
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_123(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_62(&Param0);
...
void Function_62(struct<217> Param0) //Position: 0x47B3 / 18355
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_123(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_123(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_63(&uVar1, 0);
	return;
}

int Function_63(var uParam0, int iParam1) //Position: 0x4871 / 18545
{
	int iVar0;
	var uVar1;
...
void Function_64(int iParam0, var uParam1, struct<2> Param2) //Position: 0x49DB / 18907
{
	struct<8> Var0;
...
struct<32> Function_65(char* cParam0) //Position: 0x4A83 / 19075
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_66(char* cParam0) //Position: 0x4AEF / 19183
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x4B11 / 19217
{
	int iVar0;
	struct<2> Var1;
...
float Function_68(int iParam0, struct<2> Param1) //Position: 0x4C7F / 19583
{
	struct<2> Var0;
...
struct<8> Function_69(int iParam0) //Position: 0x4CF6 / 19702
{
	struct<2> Var0;
...
void Function_70(int iParam0) //Position: 0x4D62 / 19810
{
...
bool Function_71(int iParam0) //Position: 0x4DCA / 19914
{
...
void Function_72(struct<153> Param0) //Position: 0x4DE0 / 19936
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_77(Function_78(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_76(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_44(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_44(Global_116927[iParam16].f_32, 1))
			{
...
void Function_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x52F6 / 21238
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_74(int iParam0) //Position: 0x5381 / 21377
{
	char* cVar0[16];
...
bool Function_75() //Position: 0x53C0 / 21440
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_76(int iParam0) //Position: 0x53ED / 21485
{
...
var Function_77(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5419 / 21529
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_78(int iParam0) //Position: 0x543A / 21562
{
...
bool Function_79(struct<249> Param0) //Position: 0x544F / 21583
{
	...
	{
		Function_188(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
	if ((Function_89(iParam1) || Function_55(iParam1)) || Function_88(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_80(struct<265> Param0) //Position: 0x557F / 21887
{
	int iVar0;
	
	if (!Param0.f_260 != 0)
	{
		if (Function_50(&Param0 + 260, 4))
		{
		...
		if (Function_50(&Param0 + 260, 2) && Global_6606)
		{
		...
		if (Function_50(&Param0 + 260, 8) && Global_6606)
		{
		...
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_50(&Param0 + 260, 1024))
				{
					return 0;
				}
				break;
...
bool Function_81(int iParam0) //Position: 0x56E0 / 22240
{
	if (!Function_49(iParam0))
	{
		return 0;
...
bool Function_82(int iParam0) //Position: 0x5704 / 22276
{
...
bool Function_83(int iParam0) //Position: 0x5719 / 22297
{
	return Global_116927[iParam06].f_16;
}

bool Function_84(struct<237> Param0) //Position: 0x5729 / 22313
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_85(int iParam0) //Position: 0x57F8 / 22520
{
...
bool Function_86(int iParam0) //Position: 0x5853 / 22611
{
	int iVar0;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x586F / 22639
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x588C / 22668
{
...
int Function_89(int iParam0) //Position: 0x58A1 / 22689
{
...
void Function_90() //Position: 0x58B6 / 22710
{
...
int Function_91(int iParam0, int iParam1) //Position: 0x5936 / 22838
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_57(6, 0) && Function_55(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if ((Function_57(9, 0) && Function_55(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
int Function_92(int iParam0) //Position: 0x6599 / 26009
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x65E8 / 26088
{
...
int Function_94(int iParam0) //Position: 0x65FE / 26110
{
...
void Function_95() //Position: 0x6667 / 26215
{
...
bool Function_96(int iParam0) //Position: 0x668C / 26252
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x66DD / 26333
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x670A / 26378
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x675C / 26460
{
	int iVar0;
...
void Function_100() //Position: 0x6796 / 26518
{
	bool bVar0;
	
	bVar0 = Function_29(407);
...
void Function_101(int iParam0, int iParam1) //Position: 0x67F4 / 26612
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_102(int iParam0) //Position: 0x680A / 26634
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6854 / 26708
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x68C9 / 26825
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x6903 / 26883
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x697F / 27007
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x6A20 / 27168
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x6A5D / 27229
{
...
bool Function_109() //Position: 0x6A70 / 27248
{
...
int Function_110(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6A8B / 27275
{
	int iVar0;
	int iVar1;
...
void Function_111(int iParam0) //Position: 0x6CB3 / 27827
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_112(bool bParam0, bool bParam1, int iParam2) //Position: 0x6D51 / 27985
{
	...
	if (&bParam1)
	{
		if (GET_ITEM_COUNT(Function_113(bParam0), Function_13()) == 0)
		{
			ADD_ITEM(Function_113(bParam0), Function_13(), &iParam2);
			return 1;
		}
	}
	ADD_ITEM(Function_113(bParam0), Function_13(), &iParam2);
...
var Function_113(bool bParam0) //Position: 0x6D9F / 28063
{
	int iVar0;
...
void Function_114(int iParam0) //Position: 0x6E93 / 28307
{
	int iVar0;
...
int Function_115(var uParam0, var uParam1, var uParam2, int iParam3) //Position: 0x6EC6 / 28358
{
	var uVar0;
	bool bVar2;
	struct<8> Var3;
	...
	Var3 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_65("posterText") };
	iParam3 = iParam3;
	strcpy(&cVar59, "", 64);
	bVar2 = Function_119(Global_39906.f_20);
	Function_118(bVar2, &uVar43);
	Function_117(Global_39906.f_24, &uVar11);
	Function_116(&uVar27);
...
void Function_116(char* cParam0) //Position: 0x6F8E / 28558
{
...
void Function_117(int iParam0, char* cParam1) //Position: 0x7012 / 28690
{
	strcpy(&cParam1, GET_OBJECT_NAME(&Global_44085[iParam09] + 8), 64);
	return;
}

void Function_118(char* cParam0, char* cParam1) //Position: 0x702A / 28714
{
	switch (cParam0)
	{
		case 0x00000000:
...
var Function_119(int iParam0) //Position: 0x7221 / 29217
{
	int iVar0;
	int iVar1;
	struct<21> Var2;
...
var Function_120(struct<41> Param0) //Position: 0x725F / 29279
{
	int iVar0;
	...
	switch (iParam1)
	{
		case 0x00000000:
			...
			Param0.f_32 = 0;
			Param0.f_40 = 1;
			Param0.f_16 = Function_122(Param0.f_12);
			break;
...
bool Function_121(int iParam0) //Position: 0x771A / 30490
{
...
var Function_122(int iParam0) //Position: 0x7731 / 30513
{
	int iVar0;
...
var Function_123() //Position: 0x7795 / 30613
{
	int iVar0;
...
void Function_124(bool bParam0, bool bParam1) //Position: 0x779E / 30622
{
	bool bVar0;
...
void Function_125(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x77C3 / 30659
{
	struct<4> Var0;
	var uVar4;
...
bool Function_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x7858 / 30808
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_127(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_127(var uParam0, int iParam1, struct<41> Param2) //Position: 0x7911 / 30993
{
	if (!&bParam15)
	{
	...
	{
		case 0x000003E8:
			if (uParam3 != 99 && (Function_142(&Param2) || Param2.f_40 < 1))
			{
				iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_139())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_135(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_133(&Global_99170, &Global_10996);
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && uParam3 == 99) && !Function_142(&Param2))
			{
...
void Function_128(var uParam0, bool bParam1) //Position: 0x7F73 / 32627
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_129() //Position: 0x8043 / 32835
{
	int iVar0;
...
void Function_130() //Position: 0x80BB / 32955
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_131() //Position: 0x8100 / 33024
{
...
void Function_132(bool bParam0) //Position: 0x8112 / 33042
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_133(var uParam0, int iParam1) //Position: 0x812F / 33071
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_123(), &iParam1, 4294967295, 1);
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar2))
		{
			...
			if ((&iVar3 == &Global_54076 && !Function_134(&iVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(&iVar3))
			{
...
bool Function_134(int iParam0) //Position: 0x81C1 / 33217
{
	bool bVar0;
...
float Function_135(vector3 vParam0) //Position: 0x81F2 / 33266
{
...
bool Function_136(int iParam0) //Position: 0x82BF / 33471
{
	return Function_44(iParam0, 2);
}

bool Function_137(int iParam0) //Position: 0x82CD / 33485
{
	return Function_44(iParam0, 1);
}

int Function_138(bool bParam0) //Position: 0x82DB / 33499
{
	bool bVar0;
	var uVar1;
...
bool Function_139() //Position: 0x839E / 33694
{
	bool bVar0;
	var uVar1;
...
void Function_140(int iParam0) //Position: 0x83DB / 33755
{
	Function_141(&iParam0, 0.0f);
	return;
}

void Function_141(vector3 vParam0) //Position: 0x83E8 / 33768
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_188(&vParam0, 1);
	Function_101(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_142(struct<37> Param0) //Position: 0x840D / 33805
{
	return Param0.f_36;
}

void Function_143(var uParam0, int iParam1) //Position: 0x8418 / 33816
{
	Function_144(&uParam0, &iParam1, 0);
	return;
}

void Function_144(var uParam0, bool bParam1, bool bParam2) //Position: 0x8428 / 33832
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_145(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x85A0 / 34208
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_146() //Position: 0x85CA / 34250
{
	var uVar0;
	var uVar1;
...
void Function_147() //Position: 0x8625 / 34341
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_123(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_123(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_148() //Position: 0x8764 / 34660
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_149() //Position: 0x8774 / 34676
{
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_150(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_348);
	return 1;
}

void Function_150(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x8795 / 34709
{
	var uVar0;
	...
	Function_128(&uParam9, &bParam10);
}

void Function_151() //Position: 0x8864 / 34916
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_152() //Position: 0x8879 / 34937
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2654,856f, 67,263f, 3422,84f), 231,53f, 1, 1, true);
	SET_DRAW_OBJECT(&uLocal_372, 1);
	Global_39906.f_12 = 1;
	Global_39906.f_20 = 339;
	Global_39906.f_24 = Global_46760[10];
...
int Function_153() //Position: 0x88F4 / 35060
{
	if (!iLocal_353)
	{
		SET_DRAW_OBJECT(&uLocal_372, 0);
		Function_154(StackVal, Local_350, &uLocal_348);
		iLocal_353 = 1;
	}
	return 1;
}

void Function_154(vector3 vParam0) //Position: 0x891A / 35098
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_36(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_155(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_155(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_155(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_155(int iParam0, int iParam1) //Position: 0x8AC3 / 35523
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_156(float fParam0, float fParam1) //Position: 0x8BB8 / 35768
{
...
void Function_157() //Position: 0x8CC9 / 36041
{
...
void Function_158() //Position: 0x8CFD / 36093
{
...
int Function_159() //Position: 0x8E03 / 36355
{
	return 1;
}

int Function_160() //Position: 0x8E0A / 36362
{
	uLocal_348 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_376, "tempcutscenevol", 2, *(&Global_99725[1943] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(30.0f, 30.0f, 30.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_163(0, 0, 1, 1, 0, 1, 1, &uLocal_348, 1, 1, 1, 1, 0x3f800000, 0);
	Function_161(StackVal, &uLocal_376, *(&Global_99725[1943] + 196), &uLocal_348, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_161(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8EAA / 36522
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_162(var uParam0, float fParam1) //Position: 0x914A / 37194
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_163(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x91CC / 37324
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_166(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_123(), 2, Function_166(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_164(int iParam0) //Position: 0x947E / 38014
{
	int iVar0;
...
var Function_165() //Position: 0x94B2 / 38066
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_166(int iParam0) //Position: 0x9540 / 38208
{
	struct<2> Var0;
...
int Function_167(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x9552 / 38226
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_168(struct<257> Param0) //Position: 0x96DD / 38621
{
...
int Function_169(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x9719 / 38681
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_170() //Position: 0x9981 / 39297
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_171(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_171(char* cParam0) //Position: 0x99D5 / 39381
{
	char* cVar0[64];
...
bool Function_172(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9AFE / 39678
{
...
int Function_173() //Position: 0x9B8A / 39818
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_174(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x9B99 / 39833
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_175(vector3 vParam0) //Position: 0x9DCE / 40398
{
	var uVar0;
	...
	{
		if (!Function_36(StackVal, Param1))
		{
			return 1;
		}
	}
...
float Function_176(var uParam0, bool bParam1) //Position: 0x9E44 / 40516
{
	struct<2> Var0;
...
void Function_177(var uParam0, bool bParam1) //Position: 0x9E65 / 40549
{
	var uVar0;
	var uVar1;
...
bool Function_178(int iParam0, bool bParam1, bool bParam2) //Position: 0x9ECF / 40655
{
...
bool Function_179() //Position: 0x9F93 / 40851
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_180(int iParam0) //Position: 0x9FAA / 40874
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_181(bool bParam0) //Position: 0x9FB6 / 40886
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_182() //Position: 0x9FC5 / 40901
{
	if (IS_LAYOUTREF_VALID(&uLocal_376))
	{
	...
	Function_184(&uLocal_354);
	Function_183(0, 0, 0);
	return;
}

int Function_183(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA00B / 40971
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_184(int iParam0) //Position: 0xA03D / 41021
{
	int iVar0;
...
void Function_185(struct<2>[] Param0, int iParam1) //Position: 0xA065 / 41061
{
...
void Function_186(struct<13> Param0) //Position: 0xA1B0 / 41392
{
	int iVar0;
...
bool Function_187(struct<13> Param0) //Position: 0xA1CD / 41421
{
	int iVar0;
...
void Function_188(var uParam0, int iParam1) //Position: 0xA1EB / 41451
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_189(struct<2>[] Param0) //Position: 0xA1FC / 41468
{
	int iVar0;
	int iVar1;
		...
		if (Function_187(&(Param0[iVar02]), 4))
		{
			if (!Function_187(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_187(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_190() //Position: 0xA5BE / 42430
{
	if (!Function_86(128))
	{
		return;
...
bool Function_191() //Position: 0xA5FE / 42494
{
	int iVar0;
...
void Function_192(struct<13> Param0) //Position: 0xA62C / 42540
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_193() //Position: 0xA63F / 42559
{
	if (!Function_86(128))
	{
		return;
...
var Function_194(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA681 / 42625
{
	int iVar0;
	var uVar1;
...
var Function_195(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA6BF / 42687
{
	int iVar0;
