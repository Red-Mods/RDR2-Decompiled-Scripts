...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_99(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_84(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_77(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_2[iVar39]));
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_118, &uLocal_116);
...
void Function_62(int iParam0) //Position: 0x28A5 / 10405
{
	struct<2> Var0;
	struct<2> Var2;
	var uVar4;
	...
	GET_CAMERA_POSITION(GET_GAME_CAMERA(), &uVar4);
	...
	{
		uVar19 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&uVar18, 0);
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &uVar19, Function_39(), Var13, Vector(0.0f, 0,9f, 0.0f));
		ATTACH_OBJECTS_CONTINUOUS(&uVar20, &fVar6, 4294967295);
		INIT_CAMERASHOT_FROM_GAME_CAMERA(&uVar19);
		SET_CAMERASHOT_TARGET_OBJECT(&uVar19, &uVar20, 0);
		SET_CAMERASHOT_POSITION(&uVar19, Var15);
		SET_CAMERASHOT_COLLISION_ENABLED(&uVar19, 0);
		if (fVar17 < -1.0f)
		{
		...
		SET_CAMERASHOT_FROM_LENS(&uVar19, 6);
		FORCE_CAMERASHOT_UPDATE(&uVar19);
		uVar21 = GRINGO_GET_PARENT_COMPONENT(&iParam0, 3);
		if (IS_GRINGO_COMPONENT_VALID(&uVar21))
		{
			uVar22 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(&uVar21));
			if (IS_ACTOR_VALID(&uVar22))
			{
				GET_OBJECT_RELATIVE_POSITION(StackVal, &uVar22, Vector(3.0f, 2,5f, 1,5f), &Var15);
			}
		}
		SET_CAMERASHOT_POSITION(&uVar19, Var15);
		bVar23 = false;
		uVar24 = GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF());
		while (IS_OBJECT_VALID(&uVar24) && !bVar23)
		{
			if (GET_OBJECT_TYPE(&uVar24) == 13)
			{
				bVar23 = true;
			}
			uVar24 = GET_OBJECT_OWNER(&uVar24);
		}
		if (bVar23)
		{
			GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var25);
			Var27 = Vector(StackVal, StackVal, StackVal) - Vector(Var25, Var15, StackVal);
			ATTACH_CAMERASHOT(StackVal, StackVal, &uVar19, GRINGO_GET_MY_OBJECT_REF(), Var27, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
			Var29 = Vector(StackVal, StackVal, StackVal) - Vector(Var25, Var13, StackVal);
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_39(), Var29, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2B57 / 11095
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BB4 / 11188
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C11 / 11281
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C1D / 11293
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C3C / 11324
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2C53 / 11347
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2CE4 / 11492
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D08 / 11528
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D27 / 11559
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D4B / 11595
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2E73 / 11891
{
...
int Function_74(var uParam0) //Position: 0x2EA1 / 11937
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2FBA / 12218
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x2FC7 / 12231
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3049 / 12361
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x35F4 / 13812
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x362E / 13870
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x364C / 13900
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x368D / 13965
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3699 / 13977
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x36BB / 14011
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x36CD / 14029
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x37DD / 14301
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x37F5 / 14325
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B11 / 15121
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3B23 / 15139
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3B3D / 15165
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3B58 / 15192
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3B96 / 15254
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3BAF / 15279
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3EA7 / 16039
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3EC5 / 16069
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3F65 / 16229
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3F85 / 16261
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3F98 / 16280
{
...
void Function_98(int iParam0) //Position: 0x3FB4 / 16308
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x3FC0 / 16320
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x402D / 16429
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4045 / 16453
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4051 / 16465
{
