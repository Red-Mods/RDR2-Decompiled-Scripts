...
void main() //Position: 0x0 / 0
{
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_35))
	{
		Function_103("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_35);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_26 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x4A0 / 1184
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_35))
								{
									...
									{
										bLocal_35 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_35 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_35))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_35))
		{
			Function_103("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_35);
		}
...
bool Function_26(int iParam0, bool bParam1) //Position: 0x1FC2 / 8130
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_30(char* cParam0) //Position: 0x200D / 8205
{
	cParam0 = &cParam0;
	return 1;
}
...
bool Function_32(char* cParam0, int iParam1) //Position: 0x2035 / 8245
{
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x242A / 9258
{
...
bool Function_42(char* cParam0, int iParam1) //Position: 0x2458 / 9304
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x247C / 9340
{
...
void Function_47(bool bParam0, int iParam1) //Position: 0x2504 / 9476
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_62(bool bParam0) //Position: 0x28AB / 10411
{
	...
	if (bLocal_0)
	{
		...
		{
			iLocal_1 = 1;
			uLocal_2 = CREATE_LAYOUT("PickupMolotov_Layout");
...
var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28F1 / 10481
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "TakeMolotov", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x2979 / 10617
{
	...
	iVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&uParam0, 0, 10.0f, 0);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(&iVar1, 10.0f, 1, 0);
	return;
}
...
void Function_65(int iParam0, var uParam1) //Position: 0x29B8 / 10680
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(1,555111f, 1,56855f, 0,645675f), Vector(-15,2134f, 56,88949f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &uParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(-0,068429f, 1,041409f, -0,413526f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A55 / 10837
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A61 / 10849
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A80 / 10880
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A97 / 10903
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2B28 / 11048
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B4C / 11084
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2B6B / 11115
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2B8F / 11151
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CB7 / 11447
{
...
int Function_75(var uParam0) //Position: 0x2CE5 / 11493
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2DFE / 11774
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2E0B / 11787
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2E8D / 11917
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3438 / 13368
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x3472 / 13426
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x3490 / 13456
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x34D1 / 13521
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x34DD / 13533
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x34FF / 13567
{
	bool bVar0;
	...
	{
		bVar0 = 10.0f;
		bVar0 = (10.0f - _GET_AMMO_AMOUNT(&uParam0, 4, 0));
		if (ACTOR_HAS_WEAPON_IN_HAND(&uParam0, 23) || GET_WEAPON_EQUIPPED(&uParam0, 2) != 23)
		{
			bVar0 = (bVar0 - 1.0f);
		}
		GIVE_WEAPON_TO_ACTOR(&uParam0, 23, 0.0f, 1, 0);
		_ADD_AMMO_OF_TYPE(&uParam0, 4, bVar0, 0, 1);
	}
	iLocal_1 = 0;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x357D / 13693
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x368D / 13965
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x36A5 / 13989
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x39C1 / 14785
{
	iParam1 = &iParam1;
	bLocal_0 = false;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_89(int iParam0) //Position: 0x39DC / 14812
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x39F6 / 14838
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3A11 / 14865
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3A4F / 14927
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3A68 / 14952
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3D60 / 15712
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3D7E / 15742
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3E1E / 15902
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, int iParam1) //Position: 0x3E3E / 15934
{
	bool bVar0;
	bool bVar1;
	...
	{
		if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "AutoGiveAway"))
		{
			if (DECOR_GET_BOOL(GRINGO_GET_MY_OBJECT_REF(), "AutoGiveAway"))
			{
				bVar0 = 10.0f;
				bVar0 = (10.0f - _GET_AMMO_AMOUNT(&iParam0, 4, 0));
				if (ACTOR_HAS_WEAPON_IN_HAND(&iParam0, 23) || GET_WEAPON_EQUIPPED(&iParam0, 2) != 23)
				{
					bVar0 = (bVar0 - 1.0f);
				}
				if (bVar0 < 0.0f)
				{
					GIVE_WEAPON_TO_ACTOR(&iParam0, 23, 0.0f, 1, 0);
					_ADD_AMMO_OF_TYPE(&iParam0, 4, bVar0, 0, 1);
				}
				return 0;
			}
		}
	}
	if (ACTOR_HAS_WEAPON(&iParam0, 23))
	{
		bVar1 = ROUND(_GET_AMMO_AMOUNT(&iParam0, 4, 0));
		if (ACTOR_HAS_WEAPON_IN_HAND(&iParam0, 23) || GET_WEAPON_EQUIPPED(&iParam0, 2) != 23)
		{
			bVar1++;
		}
...
bool Function_98(int iParam0) //Position: 0x3F22 / 16162
{
...
void Function_99(int iParam0) //Position: 0x3F3E / 16190
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x3F4A / 16202
{
	bool bVar0;
	var uVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3FB6 / 16310
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x3FCE / 16334
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3FDA / 16346
{
