...
void Function_75() //Position: 0x1D40 / 7488
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_290 = CREATE_LAYOUT("Poker_THI_layout");
	(&iLocal_290 + 8) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_290, 8, 0);
	*(&iLocal_290 + 16[03]) = Vector(165,1509f, 73,73709f, 2227,604f);
	*(&iLocal_290 + 16[03] + 12) = Vector(0.0f, 208,6129f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "PlayerPosition", Vector(165,1509f, 73,73709f, 2227,604f), Vector(0.0f, 208,6129f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_290 + 8);
	*(&iLocal_290 + 16[13]) = Vector(164,9269f, 73,74156f, 2229,169f);
	*(&iLocal_290 + 16[13] + 12) = Vector(0.0f, 148,5468f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_0_Position", Vector(164,9269f, 73,74156f, 2229,169f), Vector(0.0f, 148,5468f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_290 + 8);
	*(&iLocal_290 + 16[23]) = Vector(166,9712f, 73,74729f, 2230,946f);
	*(&iLocal_290 + 16[23] + 12) = Vector(0.0f, 92,93304f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_1_Position", Vector(166,9712f, 73,74729f, 2230,946f), Vector(0.0f, 92,93304f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_290 + 8);
	*(&iLocal_290 + 16[33]) = Vector(165,1596f, 73,74729f, 2233,888f);
	*(&iLocal_290 + 16[33] + 12) = Vector(0.0f, 26,32837f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_2_Position", Vector(165,1596f, 73,74729f, 2233,888f), Vector(0.0f, 26,32837f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_290 + 8);
	*(&iLocal_290 + 16[43]) = Vector(161,1497f, 73,74976f, 2231,402f);
	*(&iLocal_290 + 16[43] + 12) = Vector(0.0f, 296,1255f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_3_Position", Vector(161,1497f, 73,74976f, 2231,402f), Vector(0.0f, 296,1255f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_290 + 8);
	*(&iLocal_290 + 144) = Vector(163,9887f, 74,554f, 2231,428f);
	*(&iLocal_290 + 144 + 12) = Vector(0.0f, 75,19186f, 0.0f);
	*(&iLocal_290 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "TableCenter", Vector(163,9887f, 74,554f, 2231,428f), Vector(0.0f, 75,19186f, 0.0f));
	*(&iLocal_290 + 176) = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 184[03]) = Vector(166,8756f, 73,74156f, 2229,654f);
	*(&iLocal_290 + 184[03] + 12) = Vector(0.0f, -239,9064f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_0_Pos", Vector(166,8756f, 73,74156f, 2229,654f), Vector(0.0f, -239,9064f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_290 + 176);
	*(&iLocal_290 + 184[13]) = Vector(166,7213f, 73,74156f, 2231,473f);
	*(&iLocal_290 + 184[13] + 12) = Vector(0.0f, 96,24262f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_1_Pos", Vector(166,7213f, 73,74156f, 2231,473f), Vector(0.0f, 96,24262f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_290 + 176);
	*(&iLocal_290 + 240) = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 248[03]) = Vector(151,9999f, 73,28625f, 2224.0f);
	*(&iLocal_290 + 248[03] + 12) = Vector(0.0f, -47,55125f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_0", Vector(151,9999f, 73,28625f, 2224.0f), Vector(0.0f, -47,55125f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_290 + 240);
	*(&iLocal_290 + 248[13]) = Vector(159,9999f, 73,28625f, 2216.0f);
	*(&iLocal_290 + 248[13] + 12) = Vector(0.0f, 135,3923f, 0.0f);
	iVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_1", Vector(159,9999f, 73,28625f, 2216.0f), Vector(0.0f, 135,3923f, 0.0f));
