...
void main() //Position: 0x0 / 0
{
	...
	iLocal_123 = 0;
	Function_100(&uScriptParam_0, &iLocal_123);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(vLocal_13[iVar39]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_13[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", &vLocal_13[iVar39] + 24);
							Function_85(&vLocal_13[iVar39] + 24, 1);
							...
							{
								Function_77(&(vLocal_13[iVar39]), 0);
							}
							else if (vLocal_13[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_13[iVar39]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_123 - 1))
			{
				if (Function_75(vLocal_13[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_13[iVar09])))
					{
						Function_103("Quitting due to update end");
						Function_77(&(vLocal_13[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_13[iVar09]), 0))
				{
					Function_5(&(vLocal_13[iVar09]));
				}
				iVar0++;
			}
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_129, &uLocal_127);
...
bool Function_26(float fParam0, int iParam1) //Position: 0x1FBC / 8124
{
	iParam1 = &iParam1;
	fParam0 = &fParam0;
	PRINTSTRING("TNT Continue use");
	PRINTNL();
	if (!IS_LAYOUTREF_VALID(&uLocal_0))
	{
		uLocal_0 = CREATE_LAYOUT(Function_27());
	}
	if ((GET_CURRENT_GAME_TIME() - fLocal_4) < 1,6f)
	{
		if (!IS_OBJECT_VALID(&uLocal_2))
		{
			Local_5 = Vector(0.0f, -0,05f, -0,6f);
			GET_OBJECT_RELATIVE_POSITION(GET_OBJECT_FROM_ACTOR(&fParam0), Local_5, &Local_8);
			PRINTSTRING("settint TNT on the floor");
			PRINTNL();
		}
	}
	return 1;
...
var Function_27() //Position: 0x2054 / 8276
{
	int iVar0;
...
void Function_29() //Position: 0x207D / 8317
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x2083 / 8323
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(char* cParam0) //Position: 0x2095 / 8341
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x20A2 / 8354
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x20BD / 8381
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x20DD / 8413
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x20FD / 8445
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x2134 / 8500
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2154 / 8532
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x216F / 8559
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2185 / 8581
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x24A9 / 9385
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24C8 / 9416
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x24D7 / 9431
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24FB / 9467
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x2521 / 9505
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x253F / 9535
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2561 / 9569
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2583 / 9603
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x264B / 9803
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26C7 / 9927
{
...
void Function_50(vector3 vParam0) //Position: 0x26DF / 9951
{
...
var Function_51(int iParam0) //Position: 0x2704 / 9988
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x2725 / 10021
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x273C / 10044
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2748 / 10056
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x274F / 10063
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2760 / 10080
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27A5 / 10149
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27D1 / 10193
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27DD / 10205
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28DF / 10463
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2902 / 10498
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x292A / 10538
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &fVar19, Function_27(), Var13, Vector(0.0f, 0.0f, 0.0f));
		...
		if (bVar22)
		{
			...
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_27(), Var28, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2C11 / 11281
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C6E / 11374
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2CCB / 11467
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2CD7 / 11479
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CF6 / 11510
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2D0D / 11533
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D9E / 11678
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DC2 / 11714
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2DE1 / 11745
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2E05 / 11781
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F2D / 12077
{
...
int Function_74(var uParam0) //Position: 0x2F5B / 12123
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3074 / 12404
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3081 / 12417
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3103 / 12547
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x36AE / 13998
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x36E8 / 14056
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3706 / 14086
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3747 / 14151
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3753 / 14163
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3775 / 14197
{
	iParam1 = &iParam1;
	ACTOR_END_FORCE_HOLSTER(&uParam0);
	fLocal_4 = GET_CURRENT_GAME_TIME();
	if (!IS_OBJECT_VALID(&uLocal_2))
	{
		uLocal_2 = CREATE_PROP_IN_LAYOUT(StackVal, &uLocal_0, "dynamite02x0", "$/fragments/p_gen_dynamite02x", Local_8, Vector(290.0f, 51,23545f, 0.0f), 1);
	}
	while ((GET_CURRENT_GAME_TIME() - fLocal_4) > 10.0f)
	{
		if (IS_OBJECT_VALID(&uLocal_2))
		{
		}
	...
	PRINTSTRING("Blow the TNT!");
	PRINTNL();
	DESTROY_OBJECT(&uLocal_2);
	Function_84(&Local_8, "DynamiteExplosion", 0, 1);
	RELEASE_LAYOUT_REF(&uLocal_0);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(float fParam0, float fParam1, float fParam2, var uParam3) //Position: 0x3842 / 14402
{
	var uVar0;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3862 / 14434
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x3972 / 14706
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x398A / 14730
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x3CA6 / 15526
{
	iParam1 = &iParam1;
...
bool Function_89(int iParam0) //Position: 0x3CC0 / 15552
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3CDA / 15578
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3CF5 / 15605
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3D33 / 15667
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3D4C / 15692
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x4048 / 16456
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x4066 / 16486
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x4106 / 16646
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x4126 / 16678
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x4139 / 16697
{
...
void Function_99(int iParam0) //Position: 0x4155 / 16725
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4161 / 16737
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_13[iLocal_1239]), &uParam0);
		iLocal_123++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x41CD / 16845
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x41E5 / 16869
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x41F1 / 16881
{
