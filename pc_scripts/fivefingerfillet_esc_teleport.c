...
void main() //Position: 0x0 / 0
{
	...
	Var0 = Vector(-4273,87f, 18,075f, 4457,291f);
	fVar2 = 20,644f;
	CAMERA_RESET(0);
	TELEPORT_ACTOR_WITH_HEADING(GET_PLAYER_ACTOR(0), Var0, fVar2, 1, 1, 1);
	SET_WEATHER(0, MAKE_TIME_OF_DAY(0, 0, 1));
	...
	CAMERA_RESET(0);
	Function_4(1, 0, 1);
	while ((!Function_1(Global_46850[0]) || !STREAMING_IS_WORLD_LOADED()) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	if (HUD_IS_FADED())
...
bool Function_3(int iParam0) //Position: 0xD6 / 214
{
...
void Function_4(var uParam0, bool bParam1, int iParam2) //Position: 0xEC / 236
{
	int iVar0;
...
void Function_5(int iParam0) //Position: 0x1F8 / 504
{
...
bool Function_6() //Position: 0x277 / 631
{
	int iVar0;
...
void Function_7(var uParam0, int iParam1) //Position: 0x2E0 / 736
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x2FA / 762
{
