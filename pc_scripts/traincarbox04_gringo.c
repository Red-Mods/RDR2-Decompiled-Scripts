...
bool Function_13(var uParam0) //Position: 0x5B3 / 1459
{
	...
	*(&iLocal_0 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarBoxcar4_pop", 2,802597E-45f, Vector(0.0f, 2,107792f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,734728f, 2,497991f, 9,574904f));
	*(&iLocal_0 + 56) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_left", "train_climb_left", Vector(-1,31458f, 0,979899f, -2,488837f), Vector(0.0f, 90,40503f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 56, "trainAttach", 2);
	*(&iLocal_0 + 64) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_left1", "train_climb_left", Vector(-1,261814f, 0,979899f, 2,441001f), Vector(0.0f, 90,40503f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 64, "trainAttach", false);
	*(&iLocal_0 + 72) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_right", "train_climb_right", Vector(1,289806f, 0,979899f, 2,421055f), Vector(0.0f, -90,75429f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 72, "trainAttach", true);
	*(&iLocal_0 + 80) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_right1", "train_climb_right", Vector(1,240252f, 0,979899f, -2,560124f), Vector(0.0f, -89,48206f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 80, "trainAttach", 3);
	Function_14(&iLocal_0, &uParam0);
	return 1;
}

void Function_14(bool bParam0, int iParam1) //Position: 0x83A / 2106
{
	var uVar0;
...
var Function_15() //Position: 0x885 / 2181
{
	int iVar0;
...
bool Function_16(struct<2>[] Param0) //Position: 0x88E / 2190
{
	int iVar0;
	int iVar1;
...
void Function_17() //Position: 0xC50 / 3152
{
	if (!Function_25(128))
	{
		return;
...
bool Function_18() //Position: 0xC90 / 3216
{
	int iVar0;
...
void Function_19(struct<13> Param0) //Position: 0xCBE / 3262
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_20() //Position: 0xCD1 / 3281
{
	if (!Function_25(128))
	{
		return;
...
var Function_21(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xD13 / 3347
{
	int iVar0;
	var uVar1;
...
var Function_22(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xD51 / 3409
{
	int iVar0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xE20 / 3616
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_24(var uParam0, int iParam1) //Position: 0xE6A / 3690
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_25(int iParam0) //Position: 0xE7B / 3707
{
	int iVar0;
