...
void main() //Position: 0x0 / 0
{
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_122))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_122);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_113 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49D / 1181
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_122))
								{
									...
									{
										bLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_122))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_122))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_122);
		}
...
bool Function_26(int iParam0, bool bParam1) //Position: 0x1FBF / 8127
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Soldier", &bParam1) && !iLocal_0)
	{
		iLocal_0 = 1;
	}
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1FEC / 8172
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x200C / 8204
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x2012 / 8210
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2024 / 8228
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2031 / 8241
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x204C / 8268
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x206C / 8300
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x208C / 8332
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20C3 / 8387
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20E3 / 8419
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x20FE / 8446
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2114 / 8468
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2438 / 9272
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2441 / 9281
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2460 / 9312
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x246F / 9327
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2493 / 9363
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x24B9 / 9401
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24D7 / 9431
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24F9 / 9465
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(char* cParam0, int iParam1) //Position: 0x251B / 9499
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25E3 / 9699
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x265F / 9823
{
...
void Function_50(vector3 vParam0) //Position: 0x2677 / 9847
{
...
var Function_51(int iParam0) //Position: 0x269C / 9884
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26BD / 9917
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26D4 / 9940
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26E0 / 9952
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26E7 / 9959
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26F8 / 9976
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x273D / 10045
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2769 / 10089
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2775 / 10101
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2877 / 10359
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x289A / 10394
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x28C2 / 10434
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BA9 / 11177
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C06 / 11270
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C63 / 11363
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C6F / 11375
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C8E / 11406
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CA5 / 11429
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D36 / 11574
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D5A / 11610
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D79 / 11641
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D9D / 11677
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EC5 / 11973
{
...
int Function_74(var uParam0) //Position: 0x2EF3 / 12019
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x300C / 12300
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3019 / 12313
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x309B / 12443
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3646 / 13894
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3680 / 13952
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x369E / 13982
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36DF / 14047
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36EB / 14059
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x370D / 14093
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (iLocal_0 && IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
		{
			uVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
			if (STRING_CONTAINS_STRING(&uVar0, "leanWall"))
			{
				if (GRINGO_COMPONENT_CHECK_NAME("UseCase1", &iParam1))
				{
					bVar1 = RAND_INT_RANGE(true, 3);
					if (RAND_INT_RANGE(false, 10000) <= 5000)
					{
						bVar2 = RAND_INT_RANGE_DIFFERENT(bVar1, 1, 3);
						SET_CRIPPLE_FLAG(&uParam0, bVar1);
						SET_CRIPPLE_FLAG(&uParam0, bVar2);
					}
					else
					{
						bVar2 = 4294967295;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x37A3 / 14243
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x38B3 / 14515
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x38CB / 14539
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3BE7 / 15335
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3BF9 / 15353
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C13 / 15379
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C2E / 15406
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C6C / 15468
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C85 / 15493
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F7D / 16253
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F9B / 16283
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x403D / 16445
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x405D / 16477
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x4070 / 16496
{
...
void Function_98(int iParam0) //Position: 0x408C / 16524
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4098 / 16536
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4104 / 16644
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x411C / 16668
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4128 / 16680
{
