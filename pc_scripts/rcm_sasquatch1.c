				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								Local_357 = Vector(-846,252f, 189,683f, 1590,695f);
								Global_38378 = (GET_CURRENT_GAME_TIME() + fLocal_361);
								uLocal_353 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, "stayOutVol", 2,802597E-45f, Vector(-846,782f, 189,682f, 1590,627f), Vector(0.0f, 237,928f, 0.0f), Vector(50.0f, 50.0f, 50.0f));
								ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_353);
								ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_353);
								iVar0 = 1;
							}
							else
							{
					...
					case 0x00000001:
						...
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_348)
							{
								if (StackVal && FABS((StackVal - !Function_168(&Global_54076, 1, 1))) > 2.0f)
								{
									if (Function_164(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
									{
						...
						Function_157(&(Global_99725[3143]), 31, 0x41f00000, 0x42200000, 0);
						break;
					
					case 0x00000003:
						if (Function_117("$/cutscene/Sasquatch_1_cs/Sasquatch_1_cs", &iLocal_336, 32112, 32049, 30996, 30969, 30474, 30467, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						if (!HUD_IS_FADING() && !HUD_IS_FADED())
						{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "sasquatch1_OBJ", 0, 3, false);
							Function_115(Global_99725[ScriptParam_043].f_224, 0);
							AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
							Function_113(406, 1, 0, 0);
							Function_3(31, 1, 1, 0);
							iVar0 = 13;
						}
						break;
					...
					case 0x0000000D:
						if (IS_ACTOR_VALID(&uLocal_355))
						{
							if (GET_LAST_ATTACKER(&uLocal_355) == &Global_54076)
							{
								TASK_CLEAR(&uLocal_355);
							}
							if (!Function_2(&uLocal_355, 0x3f800000, 0x42960000, 1, 1, 0) && Function_1(&uLocal_355, &Global_54076) < 50.0f)
							{
								DESTROY_ACTOR(&uLocal_355);
							}
						}
						else
						{
...
float Function_1(float fParam0, bool bParam1) //Position: 0x3BD / 957
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_2(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x4B2 / 1202
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &uParam1, &uParam2, &uParam3, &uParam4, &uParam5);
}

void Function_3(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4D2 / 1234
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_4(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x94C / 2380
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_5() //Position: 0xAED / 2797
{
	return;
}

void Function_6(var uParam0, int iParam1) //Position: 0xAF3 / 2803
{
	if (Global_6624)
	{
		return;
...
void Function_7(bool bParam0) //Position: 0xB32 / 2866
{
...
void Function_8() //Position: 0xB87 / 2951
{
	Function_36();
	Function_35();
	Function_35();
...
void Function_9() //Position: 0xBD2 / 3026
{
...
void Function_10() //Position: 0xCD8 / 3288
{
	float fVar0;
...
void Function_11() //Position: 0xD0B / 3339
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0xE9E / 3742
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0x1057 / 4183
{
	Function_14(&Global_42918, 1, 0);
	return;
}

void Function_14(struct<2317> Param0) //Position: 0x1065 / 4197
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_15() //Position: 0x1282 / 4738
{
...
struct<8> Function_16(int iParam0) //Position: 0x1297 / 4759
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_17(int iParam0, bool bParam1, bool bParam2) //Position: 0x133E / 4926
{
	int iVar0;
...
void Function_18(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x15DA / 5594
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_19() //Position: 0x1C18 / 7192
{
	int iVar0;
...
var Function_20(int iParam0) //Position: 0x1C21 / 7201
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_21(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1C32 / 7218
{
	char* cVar0[32];
...
struct<32> Function_22(char* cParam0) //Position: 0x1D29 / 7465
{
	char* cVar0[32];
...
void Function_23(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1D44 / 7492
{
	float fVar0;
...
var Function_24(int iParam0, int iParam1) //Position: 0x1DAB / 7595
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_25(int iParam0, bool bParam1) //Position: 0x1DBD / 7613
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_26(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1DCF / 7631
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_27(int iParam0) //Position: 0x1F03 / 7939
{
	return Global_55480[iParam016].f_96;
}

float Function_28(int iParam0) //Position: 0x1F12 / 7954
{
	if (!iParam0 != 4294967295)
	{
...
var Function_29(int iParam0) //Position: 0x1F4B / 8011
{
	if (iParam0 == 4294967295)
	{
...
void Function_30(int iParam0) //Position: 0x1F88 / 8072
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_31(int iParam0, bool bParam1, bool bParam2) //Position: 0x2122 / 8482
{
	int iVar0;
	int iVar1;
...
int Function_32(bool bParam0) //Position: 0x2366 / 9062
{
...
struct<8> Function_33() //Position: 0x23A7 / 9127
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x2430 / 9264
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x24C7 / 9415
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_36() //Position: 0x2546 / 9542
{
...
int Function_37(int iParam0, bool bParam1, int iParam2) //Position: 0x2583 / 9603
{
	int iVar0;
	int iVar1;
...
void Function_38() //Position: 0x278F / 10127
{
	struct<2> Var0;
	var uVar2;
...
bool Function_39(char* cParam0) //Position: 0x2846 / 10310
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_40(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x285E / 10334
{
	int iVar0;
...
struct<8> Function_41() //Position: 0x2956 / 10582
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_42(int iParam0) //Position: 0x2960 / 10592
{
...
int Function_43(bool bParam0, bool bParam1) //Position: 0x2976 / 10614
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_44(struct<2> Param0, struct<2> Param2) //Position: 0x2A42 / 10818
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_45(float fParam0, int iParam1) //Position: 0x2A5F / 10847
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_46(int iParam0) //Position: 0x328B / 12939
{
	var uVar0;
...
bool Function_47(var uParam0, int iParam1) //Position: 0x32C6 / 12998
{
	return (uParam0 && iParam1) == 0;
}

void Function_48(var uParam0, int iParam1) //Position: 0x32D3 / 13011
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_49(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x32E2 / 13026
{
	uParam0 = &uParam0;
...
void Function_50(int iParam0) //Position: 0x3391 / 13201
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_51(int iParam0) //Position: 0x3CB2 / 15538
{
...
bool Function_52(int iParam0) //Position: 0x3CCC / 15564
{
...
bool Function_53(int iParam0, int iParam1) //Position: 0x3CE3 / 15587
{
	int iVar0;
...
bool Function_54() //Position: 0x3D00 / 15616
{
	return STRING_TO_HASH(Function_55());
}

var Function_55() //Position: 0x3D0C / 15628
{
	return "ZOMBIE_STORY";
}

bool Function_56(int iParam0) //Position: 0x3D21 / 15649
{
...
int Function_57(int iParam0) //Position: 0x3D87 / 15751
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_58(int iParam0) //Position: 0x3E49 / 15945
{
...
void Function_59(int iParam0) //Position: 0x3E5E / 15966
{
	...
	Function_115(Function_54(), 0);
	return;
}

bool Function_60(int iParam0, bool bParam1) //Position: 0x3EA7 / 16039
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x3EE5 / 16101
{
...
bool Function_62(int iParam0) //Position: 0x3EFF / 16127
{
...
void Function_63(bool bParam0) //Position: 0x3F15 / 16149
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				{
					iVar3 = iVar1;
					if (Function_82(&(Global_99725[iVar143]), iVar3))
					{
						Function_174(&Global_99725[iVar143] + 228, 64);
						Function_75(&(Global_99725[iVar143]), iVar3);
...
void Function_64(struct<229> Param0) //Position: 0x40D0 / 16592
{
	float fVar0;
	int iVar1;
...
void Function_65(struct<217> Param0) //Position: 0x41A0 / 16800
{
	float fVar0;
	var uVar1;
...
int Function_66(var uParam0, int iParam1) //Position: 0x425E / 16990
{
	int iVar0;
	var uVar1;
...
void Function_67(int iParam0, var uParam1, struct<2> Param2) //Position: 0x43C8 / 17352
{
	struct<8> Var0;
...
struct<32> Function_68(char* cParam0) //Position: 0x4470 / 17520
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_69(char* cParam0) //Position: 0x44DC / 17628
{
	char* cVar0[32];
...
int Function_70(int iParam0) //Position: 0x44FE / 17662
{
	int iVar0;
	struct<2> Var1;
...
float Function_71(int iParam0, struct<2> Param1) //Position: 0x466C / 18028
{
	struct<2> Var0;
...
struct<8> Function_72(int iParam0) //Position: 0x46E3 / 18147
{
	struct<2> Var0;
...
void Function_73(int iParam0) //Position: 0x474F / 18255
{
...
void Function_75(struct<153> Param0) //Position: 0x47CD / 18381
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_80(Function_81(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_79(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_47(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_47(Global_116927[iParam16].f_32, 1))
			{
				...
				if (Global_43789 != Global_99725[iParam143].f_216 && !Function_78())
				{
					Function_76("TerrCont_RCM", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
			else
			{
...
void Function_76(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4CE3 / 19683
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_77(Global_10966) };
		}
...
struct<16> Function_77(int iParam0) //Position: 0x4D6E / 19822
{
	char* cVar0[16];
...
bool Function_78() //Position: 0x4DAD / 19885
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_79(int iParam0) //Position: 0x4DDA / 19930
{
...
var Function_80(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4E06 / 19974
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_81(int iParam0) //Position: 0x4E27 / 20007
{
...
bool Function_82(struct<249> Param0) //Position: 0x4E3C / 20028
{
	...
	if ((Function_92(iParam1) || Function_58(iParam1)) || Function_91(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
	...
	if (Function_74(Param0.f_216))
	{
		if (Function_90(&(Global_43791[Param0.f_216]), 256))
		{
			return 0;
		}
	}
...
bool Function_83(struct<265> Param0) //Position: 0x4F6C / 20332
{
	int iVar0;
...
bool Function_84(int iParam0) //Position: 0x50CD / 20685
{
	if (!Function_52(iParam0))
	{
		return 0;
...
bool Function_85(int iParam0) //Position: 0x50F1 / 20721
{
...
bool Function_86(int iParam0) //Position: 0x5106 / 20742
{
	return Global_116927[iParam06].f_16;
}

bool Function_87(struct<237> Param0) //Position: 0x5116 / 20758
{
	if (!Param0.f_236)
	{
		if (Function_112())
...
bool Function_88(int iParam0) //Position: 0x51E5 / 20965
{
...
bool Function_89(int iParam0) //Position: 0x5240 / 21056
{
	int iVar0;
...
bool Function_90(var uParam0, int iParam1) //Position: 0x525C / 21084
{
	int iVar0;
...
int Function_91(int iParam0) //Position: 0x5279 / 21113
{
...
int Function_92(int iParam0) //Position: 0x528E / 21134
{
...
void Function_93() //Position: 0x52A3 / 21155
{
...
int Function_94(int iParam0, int iParam1) //Position: 0x5323 / 21283
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_95(int iParam0) //Position: 0x5F86 / 24454
{
	int iVar0;
	int iVar1;
...
bool Function_96(int iParam0) //Position: 0x5FD5 / 24533
{
...
int Function_97(int iParam0) //Position: 0x5FEB / 24555
{
...
void Function_98() //Position: 0x6054 / 24660
{
...
bool Function_99(int iParam0) //Position: 0x6079 / 24697
{
	if (!Function_96(iParam0))
	{
...
bool Function_100(int iParam0, int iParam1) //Position: 0x60CA / 24778
{
	int iVar0;
...
bool Function_101(int iParam0) //Position: 0x60F7 / 24823
{
	if (!Function_96(iParam0))
	{
...
void Function_102(bool bParam0) //Position: 0x6149 / 24905
{
	int iVar0;
...
void Function_103() //Position: 0x6183 / 24963
{
	bool bVar0;
...
void Function_104(int iParam0, int iParam1) //Position: 0x61E1 / 25057
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_105(int iParam0) //Position: 0x61F7 / 25079
{
	PRINTSTRING("Day ");
...
void Function_106(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6241 / 25153
{
	bool bVar0;
	char* cVar1[16];
...
void Function_107(char* cParam0) //Position: 0x62B6 / 25270
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_108(int iParam0, var uParam1, int iParam2) //Position: 0x62F0 / 25328
{
	var uVar0;
	char* cVar1[16];
...
int Function_109(char* cParam0) //Position: 0x636C / 25452
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_110(int iParam0) //Position: 0x640D / 25613
{
	int iVar0;
	int iVar1;
...
bool Function_111(int iParam0, int iParam1) //Position: 0x644A / 25674
{
...
bool Function_112() //Position: 0x645D / 25693
{
...
int Function_113(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6478 / 25720
{
	int iVar0;
	int iVar1;
...
void Function_114(int iParam0) //Position: 0x66A0 / 26272
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_115(bool bParam0, bool bParam1) //Position: 0x673E / 26430
{
	bool bVar0;
...
void Function_116(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6763 / 26467
{
	struct<4> Var0;
	var uVar4;
...
bool Function_117(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x67F8 / 26616
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_118(var uParam0, int iParam1, struct<41> Param2) //Position: 0x68B1 / 26801
{
	if (!&bParam15)
	{
...
void Function_119(var uParam0, bool bParam1) //Position: 0x6F13 / 28435
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_120() //Position: 0x6FE2 / 28642
{
	int iVar0;
...
void Function_121() //Position: 0x705A / 28762
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_122() //Position: 0x709F / 28831
{
...
void Function_123(bool bParam0) //Position: 0x70B1 / 28849
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_124(var uParam0, int iParam1) //Position: 0x70CE / 28878
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_125(int iParam0) //Position: 0x7160 / 29024
{
	bool bVar0;
...
float Function_126(vector3 vParam0) //Position: 0x7191 / 29073
{
...
bool Function_127(int iParam0) //Position: 0x725E / 29278
{
	return Function_47(iParam0, 2);
}

bool Function_128(int iParam0) //Position: 0x726C / 29292
{
	return Function_47(iParam0, 1);
}

int Function_129(bool bParam0) //Position: 0x727A / 29306
{
	bool bVar0;
	var uVar1;
...
bool Function_130() //Position: 0x733D / 29501
{
	bool bVar0;
	var uVar1;
...
void Function_131(int iParam0) //Position: 0x737A / 29562
{
	Function_132(&iParam0, 0.0f);
	return;
}

void Function_132(vector3 vParam0) //Position: 0x7387 / 29575
{
...
bool Function_133(struct<37> Param0) //Position: 0x73AC / 29612
{
	return Param0.f_36;
}

void Function_134(var uParam0, int iParam1) //Position: 0x73B7 / 29623
{
	Function_135(&uParam0, &iParam1, 0);
	return;
}

void Function_135(var uParam0, bool bParam1, bool bParam2) //Position: 0x73C7 / 29639
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_136(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x753F / 30015
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_137() //Position: 0x7569 / 30057
{
	var uVar0;
	var uVar1;
...
void Function_138() //Position: 0x75C4 / 30148
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_139() //Position: 0x7703 / 30467
{
	return 1;
}

int Function_140() //Position: 0x770A / 30474
{
	bool bVar0;
	var uVar1;
	bool bVar3;
	
	uLocal_355 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "ncompanion", 1273, Local_357, Vector(0.0f, 0.0f, 0.0f));
	GIVE_OBJECT_TO_LAYOUT(&uLocal_353, &uLocal_355);
	DELETE_ALL_WEAPONS_FROM_ACTOR(&uLocal_355);
	GIVE_WEAPON_TO_ACTOR(&uLocal_355, 19, false, 1, 1);
	ACTOR_PUT_WEAPON_IN_HAND(&uLocal_355, 19, 1);
	bVar0 = TASK_SEQUENCE_OPEN();
	uVar1 = Vector(-820,745f, 190,985f, 1598,39f);
	bVar3 = RAND_FLOAT_RANGE(1.0f, 3.0f);
	TASK_SHOOT_AT_COORD(false, &uVar1, bVar3);
	uVar1 = Vector(-826,604f, 191,601f, 1590,458f);
	bVar3 = RAND_FLOAT_RANGE(1.0f, 3.0f);
	TASK_SHOOT_AT_COORD(false, &uVar1, bVar3);
	uVar1 = Vector(-827,703f, 191,603f, 1582,133f);
	bVar3 = RAND_FLOAT_RANGE(1.0f, 3.0f);
	TASK_SHOOT_AT_COORD(false, &uVar1, bVar3);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uLocal_355, bVar0, 4294967295);
	TASK_PRIORITY_SET(&uLocal_355, false);
	MEMORY_ALLOW_TAKE_COVER(&uLocal_355, 0);
	DECOR_SET_BOOL(&uLocal_355, "CanBeLasso", false);
	Function_141(2, 0, 1, 1, 0, 1, 1, 1, 1, 1, 1);
	Function_123(1.0f);
	DESTROY_VOLUME(&uLocal_351);
	return 1;
}

void Function_141(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7815 / 30741
{
	var uVar0;
...
void Function_142() //Position: 0x78E4 / 30948
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_143() //Position: 0x78F9 / 30969
{
...
int Function_144() //Position: 0x7914 / 30996
{
	if (!iLocal_360)
	{
		Function_145(StackVal, Vector(-857,41f, 189,73f, 1582,11f), &uLocal_351);
		iLocal_360 = 1;
	}
	return 1;
}

void Function_145(vector3 vParam0) //Position: 0x793D / 31037
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_146(float fParam0, float fParam1) //Position: 0x7AE6 / 31462
{
...
void Function_147() //Position: 0x7BF7 / 31735
{
...
void Function_148() //Position: 0x7C2B / 31787
{
...
int Function_149() //Position: 0x7D31 / 32049
{
	bool bVar0;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (IS_ACTOR_VALID(CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR(bVar0)))
		{
			if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR(bVar0) != &Global_54076)
			{
				DELETE_ALL_WEAPONS_FROM_ACTOR(CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR(bVar0));
			}
		}
		bVar0++;
	}
...
int Function_150() //Position: 0x7D70 / 32112
{
	uLocal_351 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "Sasquatch1_cutscenevol", 2, *(&Global_99725[3143] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(60.0f, 40.0f, 60.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_153(0, 0, 1, 1, 0, 1, 1, &uLocal_351, 1, 1, 1, 1, 0x3f800000, 0);
	Function_151(StackVal, &uLocal_349, *(&Global_99725[3143] + 196), &uLocal_351, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_151(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7E17 / 32279
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_152(var uParam0, float fParam1) //Position: 0x80BA / 32954
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_153(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x813C / 33084
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_156(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_19(), 2, Function_156(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_154(int iParam0) //Position: 0x83EE / 33774
{
	int iVar0;
...
var Function_155() //Position: 0x8422 / 33826
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_156(int iParam0) //Position: 0x84B0 / 33968
{
	struct<2> Var0;
...
int Function_157(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x84C2 / 33986
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_159(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_159(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_158(struct<257> Param0) //Position: 0x864D / 34381
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_158(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_159(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x8689 / 34441
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_162(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_163()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_162(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_163()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_162(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_160() //Position: 0x88F1 / 35057
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_161(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_161(char* cParam0) //Position: 0x8945 / 35141
{
	char* cVar0[64];
...
bool Function_162(var uParam0, struct<2> Param1, float fParam3) //Position: 0x8A6E / 35438
{
...
int Function_163() //Position: 0x8AFA / 35578
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_164(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8B09 / 35593
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_165(vector3 vParam0) //Position: 0x8D3E / 36158
{
	var uVar0;
...
float Function_166(var uParam0, bool bParam1) //Position: 0x8DB4 / 36276
{
	struct<2> Var0;
...
void Function_167(var uParam0, bool bParam1) //Position: 0x8DD5 / 36309
{
	var uVar0;
	var uVar1;
...
bool Function_168(int iParam0, bool bParam1, bool bParam2) //Position: 0x8E3F / 36415
{
...
bool Function_169() //Position: 0x8F03 / 36611
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_170(int iParam0) //Position: 0x8F1A / 36634
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_171(bool bParam0) //Position: 0x8F26 / 36646
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_172() //Position: 0x8F35 / 36661
{
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
...
int Function_173(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8F5B / 36699
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_174(var uParam0, int iParam1) //Position: 0x8F8D / 36749
{
