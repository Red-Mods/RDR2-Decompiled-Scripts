...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_13 = Vector(-788,844f, 93,669f, 2406,71f);
	iLocal_24 = 2;
	iLocal_25 = 4;
	fLocal_26 = 70.0f;
...
{
	RELEASE_LAYOUT_REF(&uLocal_20);
	Function_4(3, &iLocal_9, &uLocal_11, &uLocal_3, &uLocal_18, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x268 / 616
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6DA / 1754
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4) //Position: 0x70E / 1806
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA50 / 2640
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA83 / 2691
{
...
void Function_9(int iParam0) //Position: 0xA9A / 2714
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAC6 / 2758
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAE0 / 2784
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAFD / 2813
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBC3 / 3011
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD8C / 3468
{
...
void Function_15(int iParam0) //Position: 0xDC9 / 3529
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDE2 / 3554
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDEF / 3567
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xEE4 / 3812
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF4A / 3914
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFAC / 4012
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFE1 / 4065
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11FA / 4602
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1271 / 4721
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12DD / 4829
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x1305 / 4869
{
...
void Function_26(struct<13> Param0) //Position: 0x1450 / 5200
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x146D / 5229
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x148B / 5259
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_24 || bParam2) || Global_6611)
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_26, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_26, 20.0f, fLocal_26));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_128(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_132(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000002:
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					...
					Function_86(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_85(StackVal, StackVal, &Param0 + 16, Function_132(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				...
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				...
				while (bVar1 <= iParam3)
				{
					Function_82(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_81(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_81(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
			...
			if ((!bParam2 && !bVar11) && !Param0.f_428)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (SQUAD_GET_SIZE(&Param0 + 392) >= 1)
					{
						...
						{
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &bParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_76(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_27, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_75(&Param0 + 392, 1);
							Function_74(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_27 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_75(&Param0 + 392, 1);
								Function_74(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_73(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_70(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_70(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_69()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_68(&Param0 + 392, Function_69(), 4);
				Function_67(&Param0 + 392, Function_69());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_66(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_65(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_56(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_29(struct<62> Param0) //Position: 0x264A / 9802
{
	...
	if (IS_LAYOUTREF_VALID(&uLocal_18))
	{
		if (!Function_47(&(Global_6667[528])))
		{
			TASK_WANDER(&iLocal_9, 3212836864);
			Function_6(3, 0, 0, 1, 1);
		}
		else if (!Function_46(3))
		{
			fLocal_22 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/chair_sit_attach", &uLocal_13, 3.0f, 0);
			if (IS_GRINGO_VALID(&fLocal_22))
			{
				iLocal_9 = Function_33(3, 0, 1, -789,167f, 93,796f, 2407,194f, 0, 0, 0);
				if (!WOULD_ACTOR_BE_VISIBLE(551, &uLocal_13, 3212836864))
				{
					Function_30(1);
				}
				else
...
void Function_30(bool bParam0) //Position: 0x2716 / 10006
{
	RESET_ANIM_SET_FOR_ACTOR(&iLocal_9, 1);
	if (&bParam0)
	{
		TELEPORT_ACTOR(&iLocal_9, &uLocal_13, 1, 1, 1);
		SNAP_ACTOR_TO_GRINGO(&iLocal_9, GET_OBJECT_FROM_GRINGO(&fLocal_22), "UseCase1", false, 0, 0);
	}
	TASK_USE_GRINGO(&iLocal_9, &fLocal_22, "UseCase1", 4294967295, 1);
	AI_IGNORE_ACTOR(&iLocal_9);
	TASK_PRIORITY_SET(&iLocal_9, false);
	SQUAD_JOIN(&iLocal_9, &uLocal_11);
	Function_31(&iLocal_9, &uLocal_11, 1, 1);
	return;
}

void Function_31(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x2786 / 10118
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_32(&uParam0, &iParam1, 1))
	{
	...
	else if (IS_ACTOR_VEHICLE(&uParam0))
	{
		...
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(&uParam0))
		{
			...
			{
				if (!Function_32(&iVar1, &iParam1, 1))
				{
...
bool Function_32(int iParam0, int iParam1, bool bParam2) //Position: 0x2943 / 10563
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
int Function_33(int iParam0, bool bParam1, int iParam2, float fParam3, float fParam4, float fParam5, bool bParam6, int iParam7, bool bParam8) //Position: 0x298B / 10635
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_45(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		...
		if (&bParam8)
		{
			bVar1 = Function_37(&Global_15402[iParam014] + 16, &iParam7);
		}
...
void Function_34(var uParam0, bool bParam1) //Position: 0x2ECB / 11979
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_35(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x2EED / 12013
{
	var uVar0;
...
bool Function_36(vector3 vParam0) //Position: 0x2F4E / 12110
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_37(bool bParam0, int iParam1) //Position: 0x2F66 / 12134
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_38(var uParam0, int iParam1) //Position: 0x2FF4 / 12276
{
	Function_40(&uParam0);
	Function_39(&uParam0);
...
void Function_39(int iParam0) //Position: 0x3020 / 12320
{
...
void Function_40(int iParam0) //Position: 0x3046 / 12358
{
...
bool Function_41(bool bParam0) //Position: 0x311C / 12572
{
...
var Function_42(int iParam0, int iParam1) //Position: 0x3133 / 12595
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_43(int iParam0, bool bParam1, bool bParam2) //Position: 0x31D9 / 12761
{
	var uVar0;
	var uVar1;
...
void Function_44(var uParam0) //Position: 0x32E8 / 13032
{
	int iVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x331B / 13083
{
	int iVar0;
...
bool Function_46(int iParam0) //Position: 0x3338 / 13112
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool Function_47(struct<205> Param0) //Position: 0x33FC / 13308
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_11(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_48(Function_52(Param0.f_188));
...
var Function_48(int iParam0) //Position: 0x3507 / 13575
{
...
bool Function_49(int iParam0) //Position: 0x3527 / 13607
{
...
bool Function_50(int iParam0) //Position: 0x354B / 13643
{
...
bool Function_51(int iParam0) //Position: 0x3560 / 13664
{
...
var Function_52(int iParam0) //Position: 0x3577 / 13687
{
...
bool Function_53(int iParam0) //Position: 0x3591 / 13713
{
...
void Function_54(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x35A7 / 13735
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_55(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
...
bool Function_55(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x37E0 / 14304
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_56(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3800 / 14336
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(&uVar1))
				{
					Function_57(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_57(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_57(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x38EE / 14574
{
	char* cVar0[32];
	...
	Function_62(&uParam0, 0);
	Function_61(&uParam0, iParam1);
	Function_60(&uParam0, &uParam2);
	Function_59(&uParam0, uParam3);
	if (Function_58(&uParam0) != 5)
	{
...
int Function_58(int iParam0) //Position: 0x3B5A / 15194
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_59(var uParam0, bool bParam1) //Position: 0x3B7E / 15230
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_60(var uParam0, int iParam1) //Position: 0x3BA2 / 15266
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_61(var uParam0, bool bParam1) //Position: 0x3BC8 / 15304
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_62(var uParam0, bool bParam1) //Position: 0x3BEF / 15343
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_63(bool bParam0) //Position: 0x3C13 / 15379
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_64() //Position: 0x3C32 / 15410
{
...
bool Function_65(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x3C81 / 15489
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_55(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_66(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3CDD / 15581
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_67(var uParam0, int iParam1) //Position: 0x3CFE / 15614
{
	bool bVar0;
	var uVar1;
...
void Function_68(var uParam0, var uParam1, bool bParam2) //Position: 0x3D59 / 15705
{
	bool bVar0;
	var uVar1;
...
var Function_69() //Position: 0x3DA5 / 15781
{
...
void Function_70(struct<425> Param0) //Position: 0x3DBA / 15802
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_72(&Param0 + 392))
	{
		return;
	}
	if (!Function_71(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_73(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_73(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_73(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_73(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_71(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3F0D / 16141
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_72(var uParam0) //Position: 0x3F82 / 16258
{
	bool bVar0;
	int iVar1;
...
var Function_73(bool bParam0) //Position: 0x3FE0 / 16352
{
	bool bVar0;
	bool bVar1;
...
void Function_74(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x402E / 16430
{
	bool bVar0;
	var uVar1;
...
void Function_75(var uParam0, bool bParam1) //Position: 0x40A7 / 16551
{
	bool bVar0;
	var uVar1;
...
void Function_76(var uParam0) //Position: 0x40F6 / 16630
{
	struct<21> Var0;
	
	bVar6 = Function_80(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_78(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_77())
...
bool Function_77() //Position: 0x41B5 / 16821
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_78(struct<25> Param0) //Position: 0x41C8 / 16840
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_79(Param0, 0))
	{
		uVar0 = Function_48(StackVal);
...
bool Function_79(int iParam0, bool bParam1) //Position: 0x428F / 17039
{
	int iVar0;
...
int Function_80(int iParam0, struct<6> Param1) //Position: 0x42CD / 17101
{
	int iVar0;
...
void Function_81(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x4307 / 17159
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_82(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x43EC / 17388
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
...
void Function_83(var uParam0, bool bParam1) //Position: 0x45A3 / 17827
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_84(bool bParam0) //Position: 0x45C8 / 17864
{
	var uVar0;
	int iVar1;
...
var Function_85(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x4616 / 17942
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_86(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x476D / 18285
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_87(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_87(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x4818 / 18456
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_88(int iParam0, int iParam1) //Position: 0x48BE / 18622
{
	if (Function_92(&iLocal_9, &uLocal_3, 5, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		fLocal_22 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/chair_sit_attach", &uLocal_13, 3.0f, 0);
		if (IS_GRINGO_VALID(&fLocal_22))
		{
			if (Function_90(&uLocal_20, "ranch07mobile", &iParam1))
			{
				uLocal_11 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_20, Function_132()));
				*(&Global_6667[528] + 216) = &uLocal_11;
				*(&iParam0 + 24) = &uLocal_20;
				Function_89();
				return 1;
			}
		}
...
void Function_89() //Position: 0x496D / 18797
{
	uLocal_18 = CREATE_LAYOUT("ranch07campfirelayout");
	Function_30(1);
	uLocal_16 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_18, Function_132(), 2,802597E-45f, Vector(-788,844f, 93,669f, 2406,71f), Vector(0.0f, 0.0f, 0.0f), Vector(3.0f, 3.0f, 3.0f));
	ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_16);
	ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_16);
	GRINGO_SET_USE_OWNERSHIP(&fLocal_22, "UseCase1", &iLocal_9);
	return;
}

bool Function_90(var uParam0, var uParam1, int iParam2) //Position: 0x49DA / 18906
{
...
void Function_91(var uParam0, bool bParam1) //Position: 0x4A0A / 18954
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_132(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_92(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4A55 / 19029
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_47(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
		...
		if (Function_95(iVar1))
		{
			if (Function_98(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_33(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4C34 / 19508
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_94() //Position: 0x4CC0 / 19648
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x4D30 / 19760
{
	if (!Function_96(iParam0))
	{
		return 1;
	}
	return Function_45(&(Global_43791[iParam0]), 4);
}

bool Function_96(int iParam0) //Position: 0x4D4C / 19788
{
...
var Function_97(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4D62 / 19810
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_98(struct<2>[] Param0) //Position: 0x4E08 / 19976
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x51CA / 20938
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x520A / 21002
{
	int iVar0;
...
void Function_101(struct<13> Param0) //Position: 0x5238 / 21048
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_102() //Position: 0x524B / 21067
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x528D / 21133
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5325 / 21285
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5354 / 21332
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x53AF / 21423
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x53BF / 21439
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x53D3 / 21459
{
	int iVar0;
...
var Function_109() //Position: 0x53F8 / 21496
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x540F / 21519
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x554B / 21835
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x555D / 21853
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x556F / 21871
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x5581 / 21889
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x55A6 / 21926
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x55C5 / 21957
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x55D1 / 21969
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x55DC / 21980
{
	int iVar0;
...
var Function_119() //Position: 0x560A / 22026
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x561F / 22047
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x572C / 22316
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x5740 / 22336
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x57AC / 22444
{
	char* cVar0[32];
...
var Function_124() //Position: 0x57CE / 22478
{
	return "PBox_";
}

var Function_125() //Position: 0x57DC / 22492
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x5802 / 22530
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x582A / 22570
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5850 / 22608
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x59BA / 22970
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5A62 / 23138
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x5BD0 / 23504
{
...
var Function_132() //Position: 0x5C38 / 23608
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5C41 / 23617
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5C5F / 23647
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5F58 / 24408
{
	int iVar0;
...
void Function_136() //Position: 0x600C / 24588
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x6047 / 24647
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6074 / 24692
{
	bool bVar0;
...
void Function_139() //Position: 0x61CF / 25039
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x621B / 25115
{
	int iVar0;
...
int Function_141() //Position: 0x62F7 / 25335
{
	int iVar0;
...
int Function_142() //Position: 0x6453 / 25683
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6573 / 25971
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x664F / 26191
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x666E / 26222
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
	...
	{
		if (!Function_36(StackVal, Param2))
		{
			return 1;
		}
	}
...
bool Function_146(int iParam0) //Position: 0x67B1 / 26545
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x67D3 / 26579
{
	int iVar0;
...
int Function_148() //Position: 0x67EF / 26607
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x67F6 / 26614
{
	var uVar0;
...
var Function_150(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6888 / 26760
{
	int iVar0;
