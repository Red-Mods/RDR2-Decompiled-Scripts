...
{
	iParam1 = &iParam1;
	SET_ACTOR_MAX_SPEED(&uParam0, true);
	if (DECOR_CHECK_EXIST(&uParam0, "MoveObj_AllowRun"))
	{
		if (DECOR_GET_BOOL(&uParam0, "MoveObj_AllowRun"))
		{
			SET_ACTOR_MAX_SPEED(&uParam0, 2);
		}
	}
	if (DECOR_CHECK_EXIST(&uParam0, "MSMove_Run"))
	{
		if (DECOR_GET_BOOL(&uParam0, "MSMove_Run"))
		{
			SET_ACTOR_MAX_SPEED(&uParam0, 2);
		}
	}
...
bool Function_30(char* cParam0) //Position: 0x207A / 8314
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2087 / 8327
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x20A2 / 8354
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20C2 / 8386
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x20E2 / 8418
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2119 / 8473
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2139 / 8505
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2154 / 8532
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x216A / 8554
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x248E / 9358
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2497 / 9367
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24B6 / 9398
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x24C5 / 9413
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24E9 / 9449
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x250F / 9487
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x252D / 9517
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x254F / 9551
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2571 / 9585
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2639 / 9785
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26B5 / 9909
{
...
void Function_50(vector3 vParam0) //Position: 0x26CD / 9933
{
...
var Function_51(int iParam0) //Position: 0x26F2 / 9970
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x2713 / 10003
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x272A / 10026
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2736 / 10038
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x273D / 10045
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x274E / 10062
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2793 / 10131
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27BF / 10175
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27CB / 10187
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28CD / 10445
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x28F0 / 10480
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2918 / 10520
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BFF / 11263
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C5C / 11356
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2CB9 / 11449
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2CC5 / 11461
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CE4 / 11492
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CFB / 11515
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	return 1;
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2D0E / 11534
{
...
int Function_70(var uParam0) //Position: 0x2D3C / 11580
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2E55 / 11861
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(struct<69> Param0) //Position: 0x2E62 / 11874
{
	if (Function_71(Param0.f_64, 16))
	{
...
void Function_73(struct<69> Param0) //Position: 0x2EE4 / 12004
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x348F / 13455
{
	int iVar0;
...
int Function_75(int iParam0) //Position: 0x34C9 / 13513
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_76(int iParam0, var uParam1) //Position: 0x34E7 / 13543
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_77(int iParam0) //Position: 0x3528 / 13608
{
	iParam0 = &iParam0;
	return;
}

bool Function_78(int iParam0) //Position: 0x3534 / 13620
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_79(var uParam0, int iParam1) //Position: 0x3556 / 13654
{
	iParam1 = &iParam1;
	CLEAR_ACTOR_MAX_SPEED(&uParam0);
	ACTIVATE_PHYSINST(GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT()));
	return;
}

void Function_80(var uParam0, bool bParam1) //Position: 0x3571 / 13681
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_81(int iParam0, int iParam1) //Position: 0x3681 / 13953
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_82(struct<69> Param0) //Position: 0x3699 / 13977
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_83(int iParam0, int iParam1) //Position: 0x39B5 / 14773
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_84(int iParam0) //Position: 0x39C7 / 14791
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_85(int iParam0) //Position: 0x39E1 / 14817
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_86(int iParam0, var uParam1) //Position: 0x39FC / 14844
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x3A3A / 14906
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_88(struct<65> Param0) //Position: 0x3A53 / 14931
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_89(int iParam0) //Position: 0x3D4B / 15691
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_90(var uParam0, int iParam1) //Position: 0x3D69 / 15721
{
	struct<5> Var0;
	float fVar5;
...
int Function_91(int iParam0) //Position: 0x3E09 / 15881
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(int iParam0, var uParam1) //Position: 0x3E29 / 15913
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_93(int iParam0) //Position: 0x3E3C / 15932
{
...
void Function_94(int iParam0) //Position: 0x3E58 / 15960
{
	iParam0 = &iParam0;
	return;
}

void Function_95(var uParam0, int iParam1) //Position: 0x3E64 / 15972
{
	bool bVar0;
	var uVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x3ED0 / 16080
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_97(int iParam0) //Position: 0x3EE8 / 16104
{
	iParam0 = &iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x3EF4 / 16116
{
