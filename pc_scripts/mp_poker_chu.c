...
void Function_75() //Position: 0x1D40 / 7488
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_290 = CREATE_LAYOUT("Poker_CHU_layout");
	(&iLocal_290 + 8) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_290, 8, 0);
	*(&iLocal_290 + 16[03]) = Vector(-2698,523f, 31,151f, 4277,089f);
	*(&iLocal_290 + 16[03] + 12) = Vector(0.0f, 143,8871f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "PlayerPosition", Vector(-2698,523f, 31,151f, 4277,089f), Vector(0.0f, 143,8871f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_290 + 8);
	*(&iLocal_290 + 16[13]) = Vector(-2699,419f, 31,151f, 4276,548f);
	*(&iLocal_290 + 16[13] + 12) = Vector(0.0f, 130,9319f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_0_Position", Vector(-2699,419f, 31,151f, 4276,548f), Vector(0.0f, 130,9319f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_290 + 8);
	*(&iLocal_290 + 16[23]) = Vector(-2698,523f, 31,151f, 4278,206f);
	*(&iLocal_290 + 16[23] + 12) = Vector(0.0f, 92,6073f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_1_Position", Vector(-2698,523f, 31,151f, 4278,206f), Vector(0.0f, 92,6073f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_290 + 8);
	*(&iLocal_290 + 16[33]) = Vector(-2698,523f, 31,151f, 4279,507f);
	*(&iLocal_290 + 16[33] + 12) = Vector(0.0f, 65,40177f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_2_Position", Vector(-2698,523f, 31,151f, 4279,507f), Vector(0.0f, 65,40177f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_290 + 8);
	*(&iLocal_290 + 16[43]) = Vector(-2699,375f, 31,151f, 4280,155f);
	*(&iLocal_290 + 16[43] + 12) = Vector(0.0f, 402,257f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_3_Position", Vector(-2699,375f, 31,151f, 4280,155f), Vector(0.0f, 402,257f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_290 + 8);
	*(&iLocal_290 + 144) = Vector(-2701,129f, 31,949f, 4278,085f);
	*(&iLocal_290 + 144 + 12) = Vector(0.0f, 491,4238f, 0.0f);
	*(&iLocal_290 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "TableCenter", Vector(-2701,129f, 31,949f, 4278,085f), Vector(0.0f, 491,4238f, 0.0f));
	...
	*(&iLocal_290 + 248[03]) = Vector(-2699,629f, 31,151f, 4280,907f);
	*(&iLocal_290 + 248[03] + 12) = Vector(0.0f, -91,74943f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_0", Vector(-2699,629f, 31,151f, 4280,907f), Vector(0.0f, -91,74943f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_290 + 240);
	*(&iLocal_290 + 248[13]) = Vector(-2693,679f, 31,151f, 4280,907f);
	*(&iLocal_290 + 248[13] + 12) = Vector(0.0f, -268,4623f, 0.0f);
	iVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_1", Vector(-2693,679f, 31,151f, 4280,907f), Vector(0.0f, -268,4623f, 0.0f));
