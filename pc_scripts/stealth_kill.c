...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_71(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_63(int iParam0) //Position: 0x28B1 / 10417
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x28BD / 10429
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x28DC / 10460
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x28F3 / 10483
{
	struct<2> Var0;
	bool bVar2;
	struct<2> Var3;
	...
	if (IS_ACTOR_PLAYER(&uParam0) && GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Chair", &iParam1))
	{
		uVar5 = GRINGO_GET_PARENT_COMPONENT(&iParam1, 3);
		if (IS_GRINGO_COMPONENT_VALID(&uVar5))
		{
			uVar6 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(&uVar5));
			if (IS_ACTOR_VALID(&uVar6))
			{
				GET_OBJECT_RELATIVE_POSITION(StackVal, GET_OBJECT_FROM_ACTOR(&uVar6), Vector(0.0f, 0.0f, 1,5f), &Var3);
				TELEPORT_ACTOR_WITH_HEADING(&uParam0, Var3, bVar2, 0, 1, true);
			}
		}
		return 1;
	}
	if (IS_ACTOR_PLAYER(&uParam0) && (GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Head", &iParam1) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Feet", &iParam1)))
	{
		TELEPORT_ACTOR_WITH_HEADING(&uParam0, Var0, bVar2, 0, 1, true);
		return 1;
	}
	if ((GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill", &iParam1) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Head", &iParam1)) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Feet", &iParam1))
	{
		return 1;
	}
	if (GRINGO_HANDLES_MOVEMENT(&iParam1))
	{
		return Function_68(&uParam0, &iParam1);
	}
	bVar7 = Function_67(&iParam1);
	fVar8 = Function_57(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &Var0, bVar7, 0,2f, 1, bVar2, fVar8, 0, 0);
	return 1;
}

int Function_67(int iParam0) //Position: 0x2A57 / 10839
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_68(var uParam0, int iParam1) //Position: 0x2A7B / 10875
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2BA3 / 11171
{
...
int Function_70(var uParam0) //Position: 0x2BD1 / 11217
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2CEA / 11498
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(struct<69> Param0) //Position: 0x2CF7 / 11511
{
	if (Function_71(Param0.f_64, 16))
	{
...
void Function_73(struct<69> Param0) //Position: 0x2D79 / 11641
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x3324 / 13092
{
	int iVar0;
...
int Function_75(int iParam0) //Position: 0x335E / 13150
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_76(int iParam0, var uParam1) //Position: 0x337C / 13180
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_77(int iParam0) //Position: 0x33BD / 13245
{
	iParam0 = &iParam0;
	return;
}
...
void Function_79(int iParam0, int iParam1) //Position: 0x33EB / 13291
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_80(var uParam0, bool bParam1) //Position: 0x33FD / 13309
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_81(int iParam0, int iParam1) //Position: 0x350D / 13581
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_82(struct<69> Param0) //Position: 0x3525 / 13605
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_83(int iParam0, int iParam1) //Position: 0x3841 / 14401
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_84(int iParam0) //Position: 0x3853 / 14419
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_85(int iParam0) //Position: 0x386D / 14445
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_86(int iParam0, var uParam1) //Position: 0x3888 / 14472
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x38C6 / 14534
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_88(struct<65> Param0) //Position: 0x38DF / 14559
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_89(int iParam0) //Position: 0x3BD7 / 15319
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_90(var uParam0, int iParam1) //Position: 0x3BF5 / 15349
{
	struct<5> Var0;
	float fVar5;
...
int Function_91(int iParam0) //Position: 0x3C95 / 15509
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3CB5 / 15541
{
	char* cVar0;
	var uVar1;
	var uVar2;
	
	cVar0 = GRINGO_GET_COMPONENT_HASH(&iParam1);
	if (((cVar0 != STRING_TO_HASH("Stealth_Kill") || cVar0 != STRING_TO_HASH("Stealth_Kill_Feet")) || cVar0 != STRING_TO_HASH("Stealth_Kill_Head")) || cVar0 != STRING_TO_HASH("Stealth_Kill_Chair"))
	{
		if (GET_WEAPON_IN_HAND(&iParam0) == 22)
		{
			uVar1 = GRINGO_GET_PARENT_COMPONENT(&iParam1, 3);
			if (IS_GRINGO_COMPONENT_VALID(&uVar1))
			{
				uVar2 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(&uVar1));
				if (IS_ACTOR_VALID(&uVar2))
				{
					if (((GET_ACTOR_ENUM(&uVar2) != 638 || GET_ACTOR_ENUM(&uVar2) != 640) || GET_ACTOR_ENUM(&uVar2) != 698) || GET_ACTOR_ENUM(&uVar2) != 646)
					{
						return 0;
					}
				}
...
bool Function_93(int iParam0) //Position: 0x3D9E / 15774
{
...
void Function_94(int iParam0) //Position: 0x3DBA / 15802
{
	iParam0 = &iParam0;
	return;
}

void Function_95(var uParam0, int iParam1) //Position: 0x3DC6 / 15814
{
	bool bVar0;
	var uVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x3E32 / 15922
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_97(int iParam0) //Position: 0x3E4A / 15946
{
	iParam0 = &iParam0;
	return;
}

void Function_98(bool bParam0) //Position: 0x3E56 / 15958
{
