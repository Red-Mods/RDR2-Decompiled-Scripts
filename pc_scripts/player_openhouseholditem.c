...
void main() //Position: 0x0 / 0
{
	...
	iLocal_119 = 0;
	Function_127(&uScriptParam_0, &iLocal_119);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_119(&(vLocal_9[iVar39]), &bVar4))
						{
							Function_117(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_9[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_112("eGRINGO_EndUse: Stop use by request", &vLocal_9[iVar39] + 24);
							Function_111(&vLocal_9[iVar39] + 24, 1);
							...
							{
								Function_78(&(vLocal_9[iVar39]), 0);
							}
							else if (vLocal_9[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_9[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	{
		Function_112("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_112("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_112("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_125, &uLocal_123);
...
void Function_29(int iParam0, bool bParam1) //Position: 0x1FF5 / 8181
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2007 / 8199
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2014 / 8212
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x202F / 8239
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x204F / 8271
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x206F / 8303
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20A6 / 8358
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20C6 / 8390
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x20E1 / 8417
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x20F7 / 8439
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x241B / 9243
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2424 / 9252
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2443 / 9283
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2452 / 9298
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2476 / 9334
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x249C / 9372
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24BA / 9402
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24DC / 9436
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x24FE / 9470
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25C6 / 9670
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2642 / 9794
{
...
void Function_50(vector3 vParam0) //Position: 0x265A / 9818
{
...
var Function_51(int iParam0) //Position: 0x267F / 9855
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26A0 / 9888
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26B7 / 9911
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26C3 / 9923
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26CA / 9930
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26DB / 9947
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2720 / 10016
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x274C / 10060
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2758 / 10072
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x285A / 10330
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x287D / 10365
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	bParam0 = &bParam0;
	if (iLocal_2 && !iLocal_3)
	{
		iLocal_3 = 1;
		uLocal_0 = CREATE_LAYOUT("openHouseObjLayout");
		Function_63(&uLocal_0, 0, &Global_54076, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28E7 / 10471
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "Armoire", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x296B / 10603
{
	var uVar0;
	int iVar1;
...
void Function_65(int iParam0, var uParam1) //Position: 0x29AA / 10666
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(1,153809f, 1,304125f, 0,460578f), Vector(4,963992f, 66,60995f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &uParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(0,125488f, 1,401447f, 0,015869f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A47 / 10823
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A53 / 10835
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A72 / 10866
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A89 / 10889
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	...
	{
		return Function_73(&uParam0, &iParam1);
	}
	uVar3 = Function_72(&iParam1);
	uVar4 = Function_57(&iParam1);
	Function_70(&iParam1);
	iVar5 = Function_70(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, bVar2, uVar4, 0, 0);
}

struct<8> Function_70(int iParam0) //Position: 0x2B1A / 11034
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_71(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_71(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B3E / 11070
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2B5D / 11101
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2B81 / 11137
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CA9 / 11433
{
...
int Function_75(var uParam0) //Position: 0x2CD7 / 11479
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2DF0 / 11760
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2DFD / 11773
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2E7F / 11903
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x342A / 13354
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x3464 / 13412
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x3482 / 13442
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x34C3 / 13507
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x34CF / 13519
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x34F1 / 13553
{
	int iVar0;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_PLAYER(&uParam0))
		{
			RAND_SET_SEED(GET_TIME_OF_DAY_AS_INT());
			iVar0 = (RAND_INT_RANGE(false, 100000) / 1000);
			if (iVar0 <= 0 && iVar0 >= 40)
			{
				Function_93(Function_110(0, 0, 1, 1, 0), 1, 1);
			}
			else if (iVar0 < 40 && iVar0 >= 80)
			{
			...
			else if (Function_86(11, 0))
			{
				if (RAND_INT_RANGE(false, 1000) <= 500)
				{
					ADD_ITEM(Function_85(0), &uParam0, 1);
				}
				else if (Function_86(4, 0))
				{
					ADD_ITEM(Function_85(3), &uParam0, 1);
				}
				else
				{
					Function_93(Function_110(0, 0, 1, 1, 1), 1, 1);
				}
			}
			else if (Function_86(4, 0))
			{
...
var Function_85(bool bParam0) //Position: 0x35FD / 13821
{
	int iVar0;
...
bool Function_86(int iParam0, bool bParam1) //Position: 0x36F1 / 14065
{
	int iVar0;
...
bool Function_87(int iParam0) //Position: 0x372F / 14127
{
...
var Function_88(int iParam0) //Position: 0x3746 / 14150
{
...
bool Function_89(int iParam0) //Position: 0x3760 / 14176
{
...
bool Function_90(int iParam0) //Position: 0x3776 / 14198
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (!bVar1)
	{
		bVar2 = RAND_INT_RANGE(true, 5);
		if (bVar2 == 1)
		{
			if (Function_92(&iParam0, 39) != 4294967295)
			{
				bVar1 = true;
				iVar3 = 1;
			}
		...
		{
			if (Function_92(&iParam0, 40) != 4294967295)
			{
				bVar1 = true;
				iVar3 = 2;
			}
		...
		{
			if (Function_92(&iParam0, 41) != 4294967295)
			{
				bVar1 = true;
				iVar3 = 3;
			}
		...
		{
			if (Function_92(&iParam0, 42) != 4294967295)
			{
				bVar1 = true;
				iVar3 = 4;
			}
		...
		{
			if (Function_92(&iParam0, 43) != 4294967295)
			{
				bVar1 = true;
				iVar3 = 5;
			}
	...
	while (!bVar1)
	{
		...
		{
			case 0x00000001:
				bVar4 = RAND_INT_RANGE(false, 3);
				break;
			
			case 0x00000002:
				bVar4 = RAND_INT_RANGE(4, 7);
				break;
			
			case 0x00000003:
				bVar4 = RAND_INT_RANGE(8, 11);
				break;
			
			case 0x00000004:
				bVar4 = RAND_INT_RANGE(14, 13);
				break;
			
			case 0x00000005:
				bVar4 = RAND_INT_RANGE(15, 18);
				break;
		}
		if (!IS_WEAPONENUM_LOCKED(bVar4))
		{
			bVar1 = true;
		}
		else
	...
	if ((_GET_MAX_AMMO_AMOUNT(&iParam0, bVar5) - _GET_AMMO_AMOUNT(&iParam0, bVar5, 0)) < 3.0f)
	{
		_ADD_AMMO_OF_TYPE(&iParam0, GET_AMMO_ENUM(bVar4), TO_FLOAT(RAND_INT_RANGE(bVar6, bVar7)), 1, 1);
		return 1;
	}
	return 0;
}

bool Function_91() //Position: 0x38F7 / 14583
{
...
int Function_92(var uParam0, int iParam1) //Position: 0x3922 / 14626
{
	int iVar0;
...
int Function_93(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3934 / 14644
{
	bool bVar0;
	
	bVar0 = Function_109(0);
	if ((Function_109(0) + bParam0) >= 999999)
	{
	...
	UI_SET_MONEY("nMoneyText", "Dmoney_amount", Function_109(0));
	if (&bParam1)
	{
	...
	if (&bParam2)
	{
		if ((Function_109(597) + Function_109(450)) >= 10000)
		{
...
int Function_94(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3A06 / 14854
{
	int iVar0;
	int iVar1;
	...
	Function_108(iParam0, TO_FLOAT(bParam1), 1);
	Function_107(iParam0);
	if (iParam2 && bParam1 == 0)
	{
		Function_96(iParam0, 1, TO_FLOAT(bParam1), 1, 1, 3.0f, 0, &iParam3);
	}
...
void Function_95(bool bParam0) //Position: 0x3C2E / 15406
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_96(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, var uParam5, bool bParam6, var uParam7) //Position: 0x3CCC / 15564
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
	...
	switch (Global_55480[iParam016].f_96)
	{
		...
		case 0x0000000F:
			if (iParam0 == 390)
			{
				...
				stradd(&Global_55480[iParam016] + 32, INT_TO_STRING(FLOOR(Function_106(390))), 32);
			}
			break;
	}
	CLEAR_STAT_MESSAGE();
	if (!Global_77928)
	{
		...
		switch (Global_55480[iParam016].f_96)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_105(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_103(iParam0, bVar19, bVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_100(bVar19, bParam2, &iVar17, &iVar18);
							if (!IS_STRING_VALID(&uParam7))
							{
								uParam7 = "Common_Null";
							}
							Var9 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_98(Global_131807.f_1316, Global_132499.f_1412, 0, 1) };
							SET_STAT_MESSAGE(STRING_TO_HASH(&uParam7), &Global_55480[iParam016] + 32, Function_97(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_39(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_97(int iParam0) //Position: 0x430B / 17163
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_98(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x431C / 17180
{
	char* cVar0[32];
	...
	if (&bParam3)
	{
		...
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_99("icon_prestige_award_", I2STR((iParam1 - 1))) };
	}
	if (iParam1 < 0)
	{
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_99("icon_prestige_", I2STR((iParam0 / 5))) };
	}
...
struct<32> Function_99(char* cParam0) //Position: 0x4413 / 17427
{
	char* cVar0[32];
...
void Function_100(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x442E / 17454
{
	float fVar0;
	
	fVar0 = (Global_131807[Global_131807.f_1316 + 13] - Global_131807[Global_131807.f_13163]);
	uParam2 = Function_102(100, FLOOR((((fParam0 - Global_131807[Global_131807.f_13163]) / fVar0) * 100.0f)));
	uParam3 = Function_101(Function_102(100, FLOOR(((fParam1 / fVar0) * 100.0f))), 1);
}

var Function_101(int iParam0, int iParam1) //Position: 0x4495 / 17557
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_102(int iParam0, bool bParam1) //Position: 0x44A7 / 17575
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_103(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x44B9 / 17593
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (((Function_104(iParam0) != 19 || Function_104(iParam0) != 17) || Function_104(iParam0) != 10) || Function_104(iParam0) != 9)
	{
		if (fParam1 > fVar1)
		{
			fParam1 = fVar1;
...
int Function_104(int iParam0) //Position: 0x45ED / 17901
{
	return Global_55480[iParam016].f_96;
}

float Function_105(int iParam0) //Position: 0x45FC / 17916
{
	if (!iParam0 != 4294967295)
	{
...
var Function_106(int iParam0) //Position: 0x4635 / 17973
{
	if (iParam0 == 4294967295)
	{
...
void Function_107(int iParam0) //Position: 0x4672 / 18034
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_108(int iParam0, float fParam1, bool bParam2) //Position: 0x480C / 18444
{
	int iVar0;
	int iVar1;
...
int Function_109(int iParam0) //Position: 0x4A50 / 19024
{
	if (iParam0 == 4294967295)
	{
...
bool Function_110(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x4A91 / 19089
{
	bool bVar0;
	...
	if (&bParam2)
	{
		bVar0 = (bVar0 * (0,75f + ((TO_FLOAT(Function_109(5)) / 100.0f) * 0,5f)));
	}
	if (&bParam3)
	{
		if (HAS_ITEM(Function_85(17), &Global_54076))
		{
			bVar0 = (bVar0 * 1,2f);
		}
	}
...
void Function_111(var uParam0, bool bParam1) //Position: 0x4B98 / 19352
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_112(int iParam0, int iParam1) //Position: 0x4CA8 / 19624
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_113(struct<69> Param0) //Position: 0x4CC0 / 19648
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_114(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4FDC / 20444
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_115(int iParam0) //Position: 0x4FF4 / 20468
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_116(int iParam0) //Position: 0x500E / 20494
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_117(int iParam0, var uParam1) //Position: 0x5029 / 20521
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_118(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_118(var uParam0, int iParam1) //Position: 0x5067 / 20583
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_119(struct<65> Param0) //Position: 0x5080 / 20608
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_76(Param0.f_64, 2))
		{
			...
			if (Function_76(Param0.f_64, 1))
			{
				Function_112("MIDACTION REQUEST", &uVar1);
			}
			else
			{
...
int Function_120(int iParam0) //Position: 0x5378 / 21368
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_121(var uParam0, int iParam1) //Position: 0x5396 / 21398
{
	struct<5> Var0;
	float fVar5;
...
int Function_122(int iParam0) //Position: 0x5436 / 21558
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_123(var uParam0, int iParam1) //Position: 0x5456 / 21590
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (Function_124(StackVal, Local_4))
	{
		GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Local_4);
		if (VDIST(StackVal, Local_4, Vector(761,974f, 86,91f, 1268,156f)) > 5.0f)
		{
			GRINGO_SET_USABLE_BY_PLAYER(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1", 0);
		}
	}
	return 1;
}

bool Function_124(vector3 vParam0) //Position: 0x54AD / 21677
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_125(int iParam0) //Position: 0x54C5 / 21701
{
...
void Function_126(int iParam0) //Position: 0x54E1 / 21729
{
	iParam0 = &iParam0;
	return;
}

void Function_127(var uParam0, int iParam1) //Position: 0x54ED / 21741
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_128(&(vLocal_9[iLocal_1199]), &uParam0);
		iLocal_119++;
	}
...
void Function_128(int iParam0, int iParam1) //Position: 0x5559 / 21849
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_129(int iParam0) //Position: 0x5571 / 21873
{
	iParam0 = &iParam0;
	return;
}

void Function_130(int iParam0) //Position: 0x557D / 21885
{
