...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x00000002:
				...
				{
					Function_255();
					Function_254(&(Global_43791[bScriptParam_0]), 32);
					iLocal_5 = 3;
					iLocal_6 = 0;
				}
				break;
			...
			case 0x00000003:
				...
				if (Function_251())
				{
					Function_249(bScriptParam_0);
					if (bLocal_177)
					{
						Function_247(&iLocal_13, Function_248(), bScriptParam_0);
						Function_246(&iLocal_13, Function_248());
					}
					Function_254(&(Global_43791[bScriptParam_0]), 16);
					iLocal_5 = 4;
					iLocal_6 = 0;
				}
				break;
			...
			case 0x00000007:
				if (bLocal_177)
				{
					Function_222(&iLocal_13, bScriptParam_0, Function_248());
				}
				Function_221(bScriptParam_0);
				Function_220();
				Function_219();
				Function_254(&(Global_43791[bScriptParam_0]), 8);
			...
			case 0x00000009:
				...
				Function_208(64);
				Function_254(&(Global_43791[bScriptParam_0]), 512);
				iLocal_5 = 10;
				iLocal_6 = 0;
				break;
			
			case 0x0000000A:
				Function_207(Function_248(), bScriptParam_0);
				strcpy(&cVar0, "Finished Initializing ", 64);
				stradd(&cVar0, &Global_44085[bScriptParam_09] + 32, 64);
				Function_206(&cVar0, 5.0f);
				Function_254(&(Global_43791[bScriptParam_0]), 4);
				iLocal_5 = 11;
				iLocal_6 = 0;
				break;
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_494, Function_87(), bScriptParam_0);
				Function_47(&uLocal_550, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_494);
	Function_8(&uLocal_550);
	Function_6();
...
void Function_8(struct<4>[] Param0) //Position: 0x46C / 1132
{
	int iVar0;
...
void Function_9(var uParam0, vector3[] vParam1) //Position: 0x4D1 / 1233
{
	int iVar0;
...
void Function_10(int iParam0, int iParam1, int iParam2) //Position: 0x52E / 1326
{
	int iVar0;
...
void Function_11(int iParam0, int iParam1, bool bParam2) //Position: 0x618 / 1560
{
	int iVar0;
...
void Function_12() //Position: 0x797 / 1943
{
	Global_26174.f_20 = 0.0f;
	return;
}

void Function_13(int iParam0) //Position: 0x7A3 / 1955
{
	PRINTSTRING("Day ");
...
void Function_14(int iParam0) //Position: 0x7ED / 2029
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_15(struct<17> Param0) //Position: 0x833 / 2099
{
	int iVar0;
...
bool Function_16(struct<17> Param0) //Position: 0x850 / 2128
{
	int iVar0;
...
void Function_17() //Position: 0x86E / 2158
{
	return;
}

void Function_18() //Position: 0x874 / 2164
{
...
void Function_19() //Position: 0x8CB / 2251
{
	Function_20();
	return;
}

void Function_20() //Position: 0x8D4 / 2260
{
...
void Function_21(int iParam0) //Position: 0x8E7 / 2279
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x90F / 2319
{
...
void Function_23(struct<13> Param0) //Position: 0xA5A / 2650
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xA77 / 2679
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xA95 / 2709
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_26(int iParam0) //Position: 0xB4F / 2895
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB6B / 2923
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xBDE / 3038
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBFB / 3067
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xC08 / 3080
{
...
void Function_31(int iParam0) //Position: 0xF6F / 3951
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0xFD6 / 4054
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x131E / 4894
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x15FE / 5630
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D54 / 7508
{
...
int Function_36(int iParam0) //Position: 0x1D69 / 7529
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D8B / 7563
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1E14 / 7700
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E34 / 7732
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1EA9 / 7849
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1EE3 / 7907
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F5F / 8031
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x2000 / 8192
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x203D / 8253
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2053 / 8275
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x2066 / 8294
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x2080 / 8320
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x24A1 / 9377
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x24B4 / 9396
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x24D1 / 9425
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x24E3 / 9443
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x256D / 9581
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x29C5 / 10693
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_254(&(Global_43791[iParam0]), 4096);
	if (StackVal != 1)
	{
...
float Function_54(int iParam0) //Position: 0x2AB6 / 10934
{
...
float Function_55(int iParam0) //Position: 0x2AF3 / 10995
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2B2C / 11052
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2B96 / 11158
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2BEE / 11246
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2E16 / 11798
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2EB4 / 11956
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x34F2 / 13554
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34FB / 13563
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x350C / 13580
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x3603 / 13827
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x361E / 13854
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3685 / 13957
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3697 / 13975
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x37CB / 14283
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x37DA / 14298
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, float fParam1, bool bParam2) //Position: 0x3974 / 14708
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3BB8 / 15288
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3BC5 / 15301
{
...
var Function_73(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x3BEF / 15343
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3EA2 / 16034
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3F15 / 16149
{
...
bool Function_76(bool bParam0) //Position: 0x3F4B / 16203
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3FC1 / 16321
{
...
bool Function_78() //Position: 0x3FD2 / 16338
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3FEB / 16363
{
...
bool Function_80(int iParam0) //Position: 0x4002 / 16386
{
...
bool Function_81(int iParam0) //Position: 0x4017 / 16407
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4035 / 16437
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x40E4 / 16612
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x40F7 / 16631
{
	int iVar0;
	int iVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x4171 / 16753
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x419A / 16794
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x41BA / 16826
{
...
void Function_88(struct<82> Param0) //Position: 0x41CF / 16847
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	switch (&Param0 + 376)
	{
		...
		case 0x00000008:
			...
			Function_247(&Param0, &Global_46715, bParam1);
			Function_246(&Param0, &Global_46715);
			*(&Param0 + 376) = 9;
			break;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x5708 / 22280
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x5905 / 22789
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5AEF / 23279
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5F1E / 24350
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x60A4 / 24740
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x60FE / 24830
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x6138 / 24888
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x616C / 24940
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x617B / 24955
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (SQUAD_GET_SIZE(&iParam0) > 4)
	{
		...
		Function_254(&(Global_43791[Global_43789]), 0x20000000);
...
void Function_99(int iParam0) //Position: 0x63D2 / 25554
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x6429 / 25641
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x64A0 / 25760
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x650C / 25868
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x667D / 26237
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6977 / 26999
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x6A05 / 27141
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A6E / 27246
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6AFF / 27391
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6B90 / 27536
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6C26 / 27686
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C61 / 27745
{
	float fVar0;
...
void Function_111(bool bParam0, float fParam1, bool bParam2) //Position: 0x6CA5 / 27813
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6DE9 / 28137
{
...
void Function_113() //Position: 0x6DFB / 28155
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6E10 / 28176
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x7118 / 28952
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x73E6 / 29670
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x74AA / 29866
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x78B7 / 30903
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x7902 / 30978
{
...
void Function_120() //Position: 0x7A08 / 31240
{
	float fVar0;
...
void Function_121() //Position: 0x7A3B / 31291
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7BCE / 31694
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7D87 / 32135
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7D95 / 32149
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x7FB2 / 32690
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x805A / 32858
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x82F6 / 33526
{
...
struct<8> Function_128() //Position: 0x8337 / 33591
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x83C0 / 33728
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x8457 / 33879
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x84D6 / 34006
{
...
int Function_132(int iParam0, float fParam1, int iParam2) //Position: 0x8513 / 34067
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x871F / 34591
{
...
bool Function_134(int iParam0) //Position: 0x8739 / 34617
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x874F / 34639
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x87BB / 34747
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x88BB / 35003
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x8913 / 35091
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8ACD / 35533
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8AEF / 35567
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8B0D / 35597
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8B20 / 35616
{
...
var Function_143(int iParam0) //Position: 0x8D6E / 36206
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8D7A / 36218
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8D8C / 36236
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8DA4 / 36260
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x91BA / 37306
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x92AF / 37551
{
...
bool Function_149() //Position: 0x9373 / 37747
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x938A / 37770
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x9396 / 37782
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x93A5 / 37797
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x9430 / 37936
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x946F / 37999
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x948A / 38026
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x951F / 38175
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x9607 / 38407
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x97C8 / 38856
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9B32 / 39730
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9B56 / 39766
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9E75 / 40565
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, int iParam1, int iParam2) //Position: 0xA118 / 41240
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA171 / 41329
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA1E5 / 41445
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA5A7 / 42407
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA5E7 / 42471
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA615 / 42517
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA628 / 42536
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA66A / 42602
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA6A8 / 42664
{
	int iVar0;
...
bool Function_171() //Position: 0xA777 / 42871
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA870 / 43120
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAAD2 / 43730
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, int iParam1, bool bParam2) //Position: 0xAF52 / 44882
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xAFE4 / 45028
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB2EE / 45806
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB32A / 45866
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB408 / 46088
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB457 / 46167
{
	bool bVar0;
...
void Function_182() //Position: 0xB49C / 46236
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB4EA / 46314
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB4FD / 46333
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB52A / 46378
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB62B / 46635
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB682 / 46722
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB6D4 / 46804
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB713 / 46867
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB7DE / 47070
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB8B8 / 47288
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB917 / 47383
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA5A / 47706
{
...
void Function_194() //Position: 0xBBE0 / 48096
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBC4C / 48204
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, float fParam1) //Position: 0xBD8B / 48523
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", fParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBDAF / 48559
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBDC0 / 48576
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBDFE / 48638
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBE15 / 48661
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE73 / 48755
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xBFD7 / 49111
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xC016 / 49174
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xC02B / 49195
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xC04B / 49227
{
	iParam0 = iParam0;
	return;
}

void Function_206(char* cParam0) //Position: 0xC055 / 49237
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC095 / 49301
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC185 / 49541
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC198 / 49560
{
	Function_210(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC1B6 / 49590
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC2C4 / 49860
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC2D2 / 49874
{
...
void Function_213() //Position: 0xC2F1 / 49905
{
...
void Function_214(var uParam0) //Position: 0xC30D / 49933
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC317 / 49943
{
	return;
}

void Function_216(int iParam0) //Position: 0xC31D / 49949
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC327 / 49959
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC341 / 49985
{
	int iVar0;
...
void Function_219() //Position: 0xC35E / 50014
{
	return;
}

void Function_220() //Position: 0xC364 / 50020
{
	return;
}

void Function_221(int iParam0) //Position: 0xC36A / 50026
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC374 / 50036
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC678 / 50808
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC884 / 51332
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC895 / 51349
{
	int iVar0;
	var uVar1;
	float fVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF7C / 53116
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, float fParam1, float fParam2, float fParam3) //Position: 0xCF8B / 53131
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCFDC / 53212
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD02B / 53291
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD05F / 53343
{
	int iVar0;
...
var Function_231(int iParam0, int iParam1) //Position: 0xD07C / 53372
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD132 / 53554
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD19E / 53662
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD1C0 / 53696
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD1C6 / 53702
{
...
int Function_236(int iParam0) //Position: 0xD1E9 / 53737
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD205 / 53765
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD20C / 53772
{
	Function_239(&uLocal_550, &cLocal_7, "caveInterior01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "caveDoor01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "guardHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "guardhouse01", 2, &Global_44085[bParam09] + 32, 0, &iLocal_244 + 400, 0, 1);
	Function_239(&uLocal_550, &cLocal_7, "guardHouse01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "residence01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "residence01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "slaughterHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "slaughterHouse01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "slaughterHouse01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_550, &cLocal_7, "smokeHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD3CE / 54222
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD4D1 / 54481
{
	int iVar0;
...
void Function_241() //Position: 0xD502 / 54530
{
	Function_244(&uLocal_9, &uLocal_494, 4, &iLocal_244 + 88, 4294967295, 260);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 32, 4294967295, 266);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 496, 4294967295, 266);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 400, 4294967295, 258);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 608, 4294967295, 266);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 640, 4294967295, 266);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 40, 4294967295, 266);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 128, 4294967295, 0);
	Function_244(&uLocal_9, &uLocal_494, 5, &iLocal_244 + 568, 4294967295, 0);
	Function_243(&iLocal_244 + 568, 2);
	Function_242(&iLocal_244 + 128, 10, 3);
	return;
}

void Function_242(var uParam0, bool bParam1, bool bParam2) //Position: 0xD5C0 / 54720
{
...
void Function_243(var uParam0, bool bParam1) //Position: 0xD642 / 54850
{
	if (DECOR_CHECK_EXIST(&uParam0, "locflag"))
	{
...
void Function_244(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD6AA / 54954
{
...
void Function_245(struct<5> Param0) //Position: 0xD797 / 55191
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_246(int iParam0, int iParam1) //Position: 0xD7A8 / 55208
{
	var uVar0;
	int iVar1;
...
void Function_247(int iParam0, int iParam1, bool bParam2) //Position: 0xD81E / 55326
{
	var uVar0;
	int iVar1;
...
var Function_248() //Position: 0xD8BC / 55484
{
	return &iLocal_178;
}

void Function_249(int iParam0) //Position: 0xD8C5 / 55493
{
	cLocal_7 = Function_250(&iLocal_178, "elmatadero", iParam0);
	return;
}

int Function_250(int iParam0, var uParam1, int iParam2) //Position: 0xD8E3 / 55523
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_251() //Position: 0xD906 / 55558
{
	return Function_252();
}

int Function_252() //Position: 0xD90F / 55567
{
	var uVar0;
	
	Function_253(3, 3);
	uVar0 = &uVar0;
	iLocal_244 = FIND_NAMED_LAYOUT("ElMataderoTown_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_244))
	{
		iLocal_244 = CREATE_LAYOUT("ElMataderoTown_layout");
	}
	*(&iLocal_244 + 32) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_slaughter_set");
	*(&iLocal_244 + 8[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_slaughter_01", 2,802597E-45f, Vector(-404,2321f, 26,54425f, 3900,913f), Vector(0.0f, -28,19001f, 0.0f), Vector(16,39726f, 10,85685f, 22,21643f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 32, &iLocal_244 + 8[0]);
	*(&iLocal_244 + 8[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_slaughter_02", 2,802597E-45f, Vector(-408,3539f, 26,80573f, 3891,848f), Vector(0.0f, -28,19001f, 0.0f), Vector(8,016052f, 9,039291f, 9,478353f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 32, &iLocal_244 + 8[1]);
	*(&iLocal_244 + 40) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nemtv_Skin", 2,802597E-45f, Vector(-475,6176f, 21,32426f, 3974,95f), Vector(-34,65542f, 89,7269f, -34,58227f), Vector(6,100757f, 3,94817f, 7,410013f));
	*(&iLocal_244 + 80) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_Chick_Cor_set");
	*(&iLocal_244 + 48[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder10", 4,203895E-45f, Vector(-469,2256f, 20,3386f, 3901,901f), Vector(0.0f, 34,15726f, 0.0f), Vector(10,11353f, 3,210826f, 3,874292f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 80, &iLocal_244 + 48[0]);
	*(&iLocal_244 + 48[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder9", 4,203895E-45f, Vector(-457,6071f, 20,40691f, 3903,084f), Vector(0.0f, 36,29485f, 0.0f), Vector(3,890494f, 3,02977f, 9,348802f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 80, &iLocal_244 + 48[1]);
	*(&iLocal_244 + 48[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder83", 4,203895E-45f, Vector(-452,0193f, 20,40691f, 3929,843f), Vector(0.0f, -14,68059f, 0.0f), Vector(4,972843f, 3,02977f, 9,348802f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 80, &iLocal_244 + 48[2]);
	*(&iLocal_244 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_region", 4,203895E-45f, Vector(-374,8024f, 57,24953f, 3952,834f), Vector(0.0f, -16,00589f, 0.0f), Vector(138,9773f, 61,95609f, 78,34124f));
	*(&iLocal_244 + 128) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_GunProtect_set");
	*(&iLocal_244 + 96[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box16", 2,802597E-45f, Vector(-437,3646f, 26,86532f, 3927,036f), Vector(0.0f, -4,625989f, 0.0f), Vector(9,716339f, 3,053181f, 10,60309f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 128, &iLocal_244 + 96[0]);
	*(&iLocal_244 + 96[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box15", 2,802597E-45f, Vector(-430,3968f, 25,79873f, 3927,659f), Vector(0,09542695f, -2,430723f, -0,3687398f), Vector(1.0f, 3,007777f, 0,7942223f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 128, &iLocal_244 + 96[1]);
	*(&iLocal_244 + 96[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box19", 2,802597E-45f, Vector(-433,43f, 27,6925f, 3932,184f), Vector(0,1358612f, -4,676425f, 0,1440426f), Vector(8,319407f, 3,628421f, 8,8793f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 128, &iLocal_244 + 96[2]);
	*(&iLocal_244 + 136) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_pigPen", 2,802597E-45f, Vector(-405,3079f, 24,64169f, 3904.0f), Vector(-0,8143822f, -28,52375f, 1,026868f), Vector(2,729398f, 3,272871f, 4,075595f));
	*(&iLocal_244 + 200) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_crows_set");
	*(&iLocal_244 + 144[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder18", 4,203895E-45f, Vector(-451,0912f, 21,85264f, 3892,896f), Vector(0.0f, 20.0f, 0.0f), Vector(8,568853f, 27,97861f, 8,699344f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[0]);
	*(&iLocal_244 + 144[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder11", 4,203895E-45f, Vector(-436,9839f, 21,85264f, 3930,141f), Vector(0.0f, 20.0f, 0.0f), Vector(16,09637f, 27,97861f, 17,75993f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[1]);
	*(&iLocal_244 + 144[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder12", 4,203895E-45f, Vector(-406,8368f, 21,85264f, 3921,176f), Vector(0.0f, 20.0f, 0.0f), Vector(8,568853f, 27,97861f, 8,699344f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[2]);
	*(&iLocal_244 + 144[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder13", 4,203895E-45f, Vector(-469,3663f, 20,07843f, 3913,57f), Vector(0.0f, 20.0f, 0.0f), Vector(11,49513f, 27,97861f, 12,88326f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[3]);
	*(&iLocal_244 + 144[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder14", 4,203895E-45f, Vector(-440,6671f, 23,09018f, 3992,056f), Vector(0.0f, 20.0f, 0.0f), Vector(8,568853f, 27,97861f, 8,699344f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[4]);
	*(&iLocal_244 + 144[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder15", 4,203895E-45f, Vector(-474,4264f, 20,72748f, 3944,025f), Vector(0.0f, -0,4196844f, 0.0f), Vector(14,04803f, 27,97861f, 20,26262f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 200, &iLocal_244 + 144[5]);
	*(&iLocal_244 + 304) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_rabbits_set");
	*(&iLocal_244 + 208[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder61", 4,203895E-45f, Vector(-473,301f, 21,61942f, 3880.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[0]);
	*(&iLocal_244 + 208[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder51", 4,203895E-45f, Vector(-431,4697f, 23,19231f, 3887,47f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[1]);
	*(&iLocal_244 + 208[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder52", 4,203895E-45f, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[2]);
	*(&iLocal_244 + 208[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder53", 4,203895E-45f, Vector(-484.0f, 21,08234f, 3932.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[3]);
	*(&iLocal_244 + 208[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder54", 4,203895E-45f, Vector(-440.0f, 23,09018f, 3984.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[4]);
	*(&iLocal_244 + 208[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder55", 4,203895E-45f, Vector(-484f, 20,07843f, 3980.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[5]);
	*(&iLocal_244 + 208[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder56", 4,203895E-45f, Vector(-408.0f, 24,0941f, 3940.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[6]);
	*(&iLocal_244 + 208[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder57", 4,203895E-45f, Vector(-424,6618f, 23,928f, 3956,662f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[7]);
	*(&iLocal_244 + 208[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder58", 4,203895E-45f, Vector(-452f, 20,07843f, 3924,437f), Vector(0.0f, 20.0f, 0.0f), Vector(4,8854f, 3,86688f, 6,399266f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[8]);
	*(&iLocal_244 + 208[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder59", 4,203895E-45f, Vector(-452,5265f, 20,85708f, 4004.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 11,63211f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[9]);
	*(&iLocal_244 + 208[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder60", 4,203895E-45f, Vector(-412f, 23,09019f, 3884.0f), Vector(0.0f, 20.0f, 0.0f), Vector(15,6718f, 3,86688f, 5,509475f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 304, &iLocal_244 + 208[10]);
	*(&iLocal_244 + 392) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_snakes_set");
	*(&iLocal_244 + 312[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder74", 4,203895E-45f, Vector(-456.0f, 21,7392f, 3866,352f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[0]);
	*(&iLocal_244 + 312[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder66", 4,203895E-45f, Vector(-464f, 20,87756f, 3888.0f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[1]);
	*(&iLocal_244 + 312[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder67", 4,203895E-45f, Vector(-476,7524f, 19,07451f, 3922,105f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[2]);
	*(&iLocal_244 + 312[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder68", 4,203895E-45f, Vector(-429,5207f, 22,70851f, 3961,521f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[3]);
	*(&iLocal_244 + 312[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder69", 4,203895E-45f, Vector(-476f, 20,07843f, 3972.0f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[4]);
	*(&iLocal_244 + 312[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder70", 4,203895E-45f, Vector(-420f, 23,09019f, 3916.0f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[5]);
	*(&iLocal_244 + 312[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder71", 4,203895E-45f, Vector(-421,8825f, 24,09412f, 3884.0f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[6]);
	*(&iLocal_244 + 312[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder72", 4,203895E-45f, Vector(-447,4936f, 21,20944f, 3907,494f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[7]);
	*(&iLocal_244 + 312[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder73", 4,203895E-45f, Vector(-448f, 22,08627f, 4000.0f), Vector(0.0f, 20.0f, 0.0f), Vector(9,287487f, 3,153579f, 10,18979f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 392, &iLocal_244 + 312[8]);
	*(&iLocal_244 + 400) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_players_room", 2,802597E-45f, Vector(-433,4084f, 23,15631f, 3932,235f), Vector(0.0f, -5,011694f, 0.0f), Vector(8,66098f, 5,455356f, 9,05703f));
	*(&iLocal_244 + 464) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_vultures_set");
	*(&iLocal_244 + 408[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder79", 4,203895E-45f, Vector(-435,9359f, 31,63634f, 3999,936f), Vector(0.0f, 20.0f, 0.0f), Vector(6,454945f, 18,07725f, 7,881514f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[0]);
	*(&iLocal_244 + 408[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder78", 4,203895E-45f, Vector(-431,0924f, 31,22244f, 3959,093f), Vector(0.0f, 20.0f, 0.0f), Vector(6,454945f, 18,07725f, 7,881514f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[1]);
	*(&iLocal_244 + 408[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder77", 4,203895E-45f, Vector(-474,4808f, 29,55514f, 3975,525f), Vector(0.0f, 20.0f, 0.0f), Vector(6,454945f, 18,07725f, 7,881514f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[2]);
	*(&iLocal_244 + 408[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder76", 4,203895E-45f, Vector(-404.0f, 32,22914f, 3901,885f), Vector(0.0f, 20.0f, 0.0f), Vector(16,11444f, 18,07725f, 18,41733f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[3]);
	*(&iLocal_244 + 408[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder75", 4,203895E-45f, Vector(-398,7549f, 33,80273f, 3930,755f), Vector(0.0f, 20.0f, 0.0f), Vector(6,454945f, 18,07725f, 7,881514f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[4]);
	*(&iLocal_244 + 408[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder80", 4,203895E-45f, Vector(-460.0f, 29,62851f, 3888.0f), Vector(0.0f, 20.0f, 0.0f), Vector(6,454945f, 18,07725f, 7,881514f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 464, &iLocal_244 + 408[5]);
	*(&iLocal_244 + 496) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_Guardhouse1_set");
	*(&iLocal_244 + 472[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box18", 2,802597E-45f, Vector(-438,8914f, 22,35714f, 3925,253f), Vector(0.0f, -5,060482f, 0.0f), Vector(14,23047f, 6,659266f, 13,87694f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 496, &iLocal_244 + 472[0]);
	*(&iLocal_244 + 472[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box17", 2,802597E-45f, Vector(-435,6945f, 22,5055f, 3924,529f), Vector(1,587145f, -5,792999f, -0,9541515f), Vector(4,842037f, 6,44254f, 5,619625f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 496, &iLocal_244 + 472[1]);
	*(&iLocal_244 + 504) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_Cell1", 4,203895E-45f, Vector(-277,024f, 26,40772f, 3978,463f), Vector(0.0f, 279,696f, 0.0f), Vector(1,730609f, 1,613841f, 3,467957f));
	*(&iLocal_244 + 512) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_Cell2", 4,203895E-45f, Vector(-274,8313f, 26,91921f, 3989,358f), Vector(0.0f, 20.0f, 0.0f), Vector(2,671459f, 1,991866f, 2,499593f));
	*(&iLocal_244 + 520) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_cave1", 4,203895E-45f, Vector(-331,6596f, 20,36286f, 3952,476f), Vector(0.0f, 359,322f, 0.0f), Vector(2,49885f, 1,55833f, 2,978285f));
	*(&iLocal_244 + 528) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_cave2", 4,203895E-45f, Vector(-289,6796f, 26,83423f, 3981,802f), Vector(0.0f, 20.0f, 0.0f), Vector(2,039647f, 2,740554f, 1,911343f));
	*(&iLocal_244 + 568) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "EMTV_CAEVS_set");
	*(&iLocal_244 + 536[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder82", 4,203895E-45f, Vector(-305,5692f, 17,0867f, 3974,027f), Vector(0.0f, 12,82287f, 6,776853f), Vector(59,76179f, 16,99776f, 42,97998f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 568, &iLocal_244 + 536[0]);
	*(&iLocal_244 + 536[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nEllipsoid", 0f, Vector(-343,7939f, 20,87648f, 3951,043f), Vector(0.0f, -8,0267f, 0.0f), Vector(10,49871f, 3,881697f, 2,060434f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 568, &iLocal_244 + 536[1]);
	*(&iLocal_244 + 536[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder81", 4,203895E-45f, Vector(-366,9368f, 25,59531f, 3981,699f), Vector(0.0f, 24,62657f, 0.0f), Vector(15,70554f, 10,2729f, 9,442289f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 568, &iLocal_244 + 536[2]);
	*(&iLocal_244 + 576) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_armwrestling", 2,802597E-45f, Vector(-466,3477f, 21,88363f, 3883,296f), Vector(0.0f, 27,18113f, 0.0f), Vector(7,115038f, 5,195804f, 4,810962f));
	*(&iLocal_244 + 608) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_house2_set");
	*(&iLocal_244 + 584[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_house2_01", 2,802597E-45f, Vector(-476,9054f, 21,67009f, 3916,882f), Vector(0.0f, 0,6024326f, 0.0f), Vector(4,406071f, 4,388268f, 3,956662f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 608, &iLocal_244 + 584[0]);
	*(&iLocal_244 + 584[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_house2_02", 2,802597E-45f, Vector(-467,3832f, 21,67009f, 3914,398f), Vector(0.0f, 0,6024326f, 0.0f), Vector(16,28065f, 4,388268f, 10,7535f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 608, &iLocal_244 + 584[1]);
	*(&iLocal_244 + 640) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "emtv_Stable_set");
	*(&iLocal_244 + 616[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_Stable_01", 2,802597E-45f, Vector(-477,7282f, 22,49804f, 3934,111f), Vector(0.0f, 0,7449369f, 0.0f), Vector(4,095503f, 4,844863f, 7,111642f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 640, &iLocal_244 + 616[0]);
	*(&iLocal_244 + 616[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_Stable_02", 2,802597E-45f, Vector(-470,7745f, 22,49804f, 3945,145f), Vector(0.0f, 0,7449369f, 0.0f), Vector(10,40516f, 4,844863f, 30,2014f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 640, &iLocal_244 + 616[1]);
	*(&iLocal_244 + 648) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_zombies_01", 4,203895E-45f, Vector(-453,8232f, 21,95222f, 3925,415f), Vector(0.0f, -5,096532f, 0.0f), Vector(8,846065f, 14,4662f, 25,41703f));
	*(&iLocal_244 + 656) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_zombies_02", 4,203895E-45f, Vector(-412,9255f, 21,95222f, 3930,971f), Vector(0.0f, -5,096532f, 0.0f), Vector(15.0f, 15.0f, 15.0f));
	*(&iLocal_244 + 664) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_zombies_03", 4,203895E-45f, Vector(-494,7199f, 21,95222f, 3919,733f), Vector(0.0f, -5,096532f, 0.0f), Vector(15.0f, 15.0f, 15.0f));
	*(&iLocal_244 + 672) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "emtv_zombies_04", 4,203895E-45f, Vector(-474,1408f, 21,95222f, 3893,373f), Vector(0.0f, -5,096532f, 0.0f), Vector(15.0f, 15.0f, 15.0f));
	*(&iLocal_244 + 680) = Vector(-451,989f, 20,402f, 3912,053f);
	*(&iLocal_244 + 680 + 12) = Vector(0.0f, 20,549f, 0.0f);
	*(&iLocal_244 + 704) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_enDuel1", Vector(-451,989f, 20,402f, 3912,053f), Vector(0.0f, 20,549f, 0.0f));
	*(&iLocal_244 + 712) = Vector(-453,698f, 20,556f, 3904,083f);
	*(&iLocal_244 + 712 + 12) = Vector(0.0f, 184,66f, 0.0f);
	*(&iLocal_244 + 736) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_playerDuel1", Vector(-453,698f, 20,556f, 3904,083f), Vector(0.0f, 184,66f, 0.0f));
	*(&iLocal_244 + 744) = Vector(-448,245f, 22,345f, 3983,167f);
	*(&iLocal_244 + 744 + 12) = Vector(0.0f, 12,937f, 0.0f);
	*(&iLocal_244 + 768) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_playerDuel2", Vector(-448,245f, 22,345f, 3983,167f), Vector(0.0f, 12,937f, 0.0f));
	*(&iLocal_244 + 776) = Vector(-449,969f, 22,101f, 3974,478f);
	*(&iLocal_244 + 776 + 12) = Vector(0.0f, -166,4361f, 0.0f);
	*(&iLocal_244 + 800) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_enDuel2", Vector(-449,969f, 22,101f, 3974,478f), Vector(0.0f, -166,4361f, 0.0f));
	*(&iLocal_244 + 808) = Vector(-427,392f, 22,763f, 4012,884f);
	*(&iLocal_244 + 808 + 12) = Vector(0.0f, 214,095f, 0.0f);
	*(&iLocal_244 + 832) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_report_crime_road", Vector(-427,392f, 22,763f, 4012,884f), Vector(0.0f, 214,095f, 0.0f));
	*(&iLocal_244 + 840) = Vector(-504,921f, 17,075f, 3869,486f);
	*(&iLocal_244 + 840 + 12) = Vector(0.0f, 24,338f, 0.0f);
	*(&iLocal_244 + 864) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_report_crime_road1", Vector(-504,921f, 17,075f, 3869,486f), Vector(0.0f, 24,338f, 0.0f));
	*(&iLocal_244 + 872) = Vector(-469,3604f, 20,0784f, 3916,456f);
	*(&iLocal_244 + 872 + 12) = Vector(0.0f, -64,20235f, 0.0f);
	*(&iLocal_244 + 896) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_interiorPoint_house", Vector(-469,3604f, 20,0784f, 3916,456f), Vector(0.0f, -64,20235f, 0.0f));
	*(&iLocal_244 + 904) = Vector(-474,7617f, 20,42233f, 3975,301f);
	*(&iLocal_244 + 904 + 12) = Vector(0.0f, -88,70686f, 0.0f);
	*(&iLocal_244 + 928) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_interiorPoint_shack", Vector(-474,7617f, 20,42233f, 3975,301f), Vector(0.0f, -88,70686f, 0.0f));
	*(&iLocal_244 + 936) = Vector(-439,629f, 22,02932f, 3927,27f);
	*(&iLocal_244 + 936 + 12) = Vector(0.0f, -246,2092f, 0.0f);
	*(&iLocal_244 + 960) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_interiorPoint_house1", Vector(-439,629f, 22,02932f, 3927,27f), Vector(0.0f, -246,2092f, 0.0f));
	*(&iLocal_244 + 968) = Vector(-406,6394f, 24,19659f, 3906,206f);
	*(&iLocal_244 + 968 + 12) = Vector(0.0f, -204,9065f, 0.0f);
	*(&iLocal_244 + 992) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emtf_interiorPoint_slaughter", Vector(-406,6394f, 24,19659f, 3906,206f), Vector(0.0f, -204,9065f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos1", Vector(-405,49f, 27,182f, 3848,804f), Vector(-0,352f, 171,558f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos2", Vector(-508,22f, 19,695f, 3811,758f), Vector(-5,473f, -150,317f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos3", Vector(-555,501f, 24,191f, 3860,836f), Vector(-4,553f, -118,351f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos4", Vector(-566,173f, 21,715f, 3987,333f), Vector(-2,145f, -60,821f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos5", Vector(-457,239f, 37,692f, 4047,792f), Vector(-9,289f, -8,917f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos6", Vector(-439,931f, 27,769f, 3923,987f), Vector(-5,553f, 127,177f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos7", Vector(-438,851f, 23,666f, 3921,033f), Vector(5,902f, -61,466f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos8", Vector(-424,583f, 24,315f, 3911,717f), Vector(18,482f, -68,864f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos9", Vector(-433,627f, 23,749f, 3920,465f), Vector(1,302f, 82,195f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "emt_vista_cam_pos10", Vector(-469,742f, 22,368f, 3962,443f), Vector(0,951f, -32,672f, 0.0f));
	return 1;
}

void Function_253(int iParam0, int iParam1) //Position: 0xF4C2 / 62658
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_254(var uParam0, int iParam1) //Position: 0xF50C / 62732
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_255() //Position: 0xF51D / 62749
{
	return;
}

bool Function_256() //Position: 0xF523 / 62755
{
	return 1;
}

void Function_257() //Position: 0xF52A / 62762
{
...
bool Function_258() //Position: 0xF5B9 / 62905
{
	return Function_259();
}

int Function_259() //Position: 0xF5C2 / 62914
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("ElMataderoTown_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("ElMataderoTown_layout");
	}
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-435,954f, 25,60531f, 3929,42f), Vector(0.0f, -4,97334f, 0.0f), Vector(14,72568f, 10,28404f, 15,84342f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-469,0569f, 25,01409f, 3914,59f), Vector(0.0f, 0,08487619f, 0.0f), Vector(20,93279f, 12.0f, 13,06657f));
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-468,2597f, 25,98396f, 3945,293f), Vector(0.0f, 89,86266f, 0.0f), Vector(30,63959f, 6,182038f, 6,934392f));
	*(&iLocal_178 + 88) = Vector(-445,8579f, 21,47666f, 3923,305f);
	*(&iLocal_178 + 88 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 112) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-445,8579f, 21,47666f, 3923,305f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-429,6442f, 25,86771f, 3929,041f), Vector(0.0f, -50.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 120);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-464,0201f, 23,9375f, 3914,485f), Vector(0.0f, -116,7959f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 120);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-466,8506f, 23,9375f, 3918,98f), Vector(0.0f, -157,208f, 0.0f));
	DECOR_SET_INT(&uVar3, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 120);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-433,5593f, 25,86804f, 3923,951f), Vector(0.0f, -32,27166f, 0.0f));
	DECOR_SET_INT(&uVar4, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 120);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-441,1365f, 25,86881f, 3922,552f), Vector(0.0f, 36,46137f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", 1);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 120);
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-440,9112f, 25,86881f, 3923,952f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_BOOL(&uVar6, "Core", 1);
	DECOR_SET_INT(&uVar6, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 128);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-440,9118f, 25,86881f, 3922,552f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar7, "Core", 1);
	DECOR_SET_INT(&uVar7, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 128);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-429,8988f, 25,86771f, 3930,377f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 128);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-429,8969f, 25,86771f, 3928,978f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 128);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-465,4203f, 23,9375f, 3914,486f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 128);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-464,0201f, 23,9375f, 3914,485f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 128);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_player", Vector(-466,8515f, 23,9375f, 3917,581f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar12, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 128);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_surv", Vector(-466,8506f, 23,9375f, 3918,98f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 128);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_player", Vector(-433,5598f, 25,86804f, 3925,351f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 128);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_surv", Vector(-433,5593f, 25,86804f, 3923,951f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-466,7911f, 23,73566f, 3955,076f), Vector(0.0f, -88,45356f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 136);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-464,0201f, 23,9375f, 3914,485f), Vector(0.0f, -116,7959f, 0.0f));
	DECOR_SET_INT(&uVar17, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 136);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09", Vector(-466,8506f, 23,9375f, 3918,98f), Vector(0.0f, -157,208f, 0.0f));
	DECOR_SET_INT(&uVar18, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 136);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def010", Vector(-474,5516f, 23,96103f, 3911,944f), Vector(0.0f, 71,95902f, 0.0f));
	DECOR_SET_INT(&uVar19, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 136);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-441,9147f, 25,86356f, 3931,26f), Vector(0.0f, 122,635f, 0.0f));
	DECOR_SET_INT(&uVar20, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar20, "Core", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 136);
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_06_player", Vector(-466,7911f, 23,73566f, 3956,476f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar21, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 144);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_06_surv", Vector(-466,7911f, 23,73566f, 3955,076f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar22, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 144);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_07_player", Vector(-441,6382f, 25,86356f, 3930,081f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar23, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar23, "Core", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 144);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_07_surv", Vector(-441,6404f, 25,86356f, 3931,481f), Vector(0.0f, -0,1483939f, 0.0f));
	DECOR_SET_INT(&uVar24, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar24, "Core", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar24, &iLocal_178 + 144);
	uVar25 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_10_player", Vector(-473,1519f, 23,96103f, 3911,944f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar25, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar25, &iLocal_178 + 144);
	uVar26 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_10_surv", Vector(-474,5516f, 23,96103f, 3911,944f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar26, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar26, &iLocal_178 + 144);
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_difSet", &iLocal_178, 8, 0);
	uVar27 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def011", Vector(-466,8658f, 24,12085f, 3941,239f), Vector(0.0f, -88,45356f, 0.0f));
	DECOR_SET_INT(&uVar27, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar27, &iLocal_178 + 152);
	uVar28 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def013", Vector(-437,3053f, 25,86929f, 3934,295f), Vector(0.0f, -236,3819f, 0.0f));
	DECOR_SET_INT(&uVar28, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar28, &iLocal_178 + 152);
	uVar29 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def014", Vector(-429,6442f, 25,86771f, 3929,041f), Vector(0.0f, -50.0f, 0.0f));
	DECOR_SET_INT(&uVar29, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar29, &iLocal_178 + 152);
	uVar30 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def015", Vector(-464,0287f, 23,96103f, 3909,992f), Vector(0.0f, -48,1745f, 0.0f));
	DECOR_SET_INT(&uVar30, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar30, &iLocal_178 + 152);
	uVar31 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def012_core", Vector(-441,1365f, 25,86881f, 3922,552f), Vector(0.0f, 36,74343f, 0.0f));
	DECOR_SET_INT(&uVar31, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar31, "Core", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar31, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar32 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_11_player", Vector(-466,8658f, 24,12085f, 3939,839f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar32, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar32, &iLocal_178 + 160);
	uVar33 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_11_surv", Vector(-466,8658f, 24,12085f, 3941,239f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar33, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar33, &iLocal_178 + 160);
	uVar34 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_13_player", Vector(-435,9049f, 25,86929f, 3934,295f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar34, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar34, &iLocal_178 + 160);
	uVar35 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_13_surv", Vector(-437,3053f, 25,86929f, 3934,295f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar35, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar35, &iLocal_178 + 160);
	uVar36 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_15_player", Vector(-464,1562f, 23,96103f, 3911,392f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar36, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar36, &iLocal_178 + 160);
	uVar37 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_15_surv", Vector(-464,1553f, 23,96103f, 3909,992f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar37, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar37, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar38 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-443,3217f, 22,54646f, 3926,224f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar38, "Gringo", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar38, &iLocal_178 + 168);
	uVar39 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-437,2962f, 25,86853f, 3924,175f), Vector(0.0f, -122,8673f, 0.0f));
	DECOR_SET_BOOL(&uVar39, "Gringo", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar39, &iLocal_178 + 168);
	uVar40 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-467,5161f, 23,9375f, 3914,166f), Vector(0.0f, -147,939f, 0.0f));
	DECOR_SET_BOOL(&uVar40, "Gringo", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar40, &iLocal_178 + 168);
	uVar41 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe04", Vector(-467,7017f, 23,96086f, 3915,858f), Vector(0.0f, -40,35915f, 0.0f));
	DECOR_SET_BOOL(&uVar41, "Gringo", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar41, &iLocal_178 + 168);
	uVar42 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe05", Vector(-435,3723f, 25,86804f, 3924,313f), Vector(0.0f, 121,9761f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar42, &iLocal_178 + 168);
	*(&iLocal_178 + 176) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar43 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-416,0535f, 24,09412f, 3954,747f), Vector(0.0f, 44,20553f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar43, &iLocal_178 + 176);
	uVar44 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-406,6974f, 24,12449f, 3910,523f), Vector(0.0f, -27,71831f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar44, &iLocal_178 + 176);
	uVar45 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_4", Vector(-470,4484f, 21,09417f, 3939,68f), Vector(0.0f, -0,1219691f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar45, &iLocal_178 + 176);
	*(&iLocal_178 + 184) = Vector(-465,2258f, 20,61027f, 3913,855f);
	*(&iLocal_178 + 184 + 12) = Vector(0.0f, -90.0f, 0.0f);
	*(&iLocal_178 + 208) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-465,2258f, 20,61027f, 3913,855f), Vector(0.0f, -90.0f, 0.0f));
	*(&iLocal_178 + 216) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand1", "rand_idle_stand", Vector(-443,3114f, 22,52275f, 3926,224f), Vector(0.0f, -270.0f, 0.0f));
	*(&iLocal_178 + 224) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand2", "rand_idle_stand", Vector(-437,3216f, 25,86853f, 3924,161f), Vector(0.0f, -122,562f, 0.0f));
	*(&iLocal_178 + 232) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground1", "Rand_Idle_Sit_Ground", Vector(-467,5015f, 23,92692f, 3914,193f), Vector(0.0f, -147,64f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 232), 0);
	*(&iLocal_178 + 240) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground2", "Rand_Idle_Sit_Ground", Vector(-467,7427f, 23,92303f, 3915,904f), Vector(0.0f, -40,30622f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 240), 0);
	*(&iLocal_178 + 248) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand3", "rand_idle_stand", Vector(-435,3714f, 25,86815f, 3924,308f), Vector(0.0f, -237,9964f, 0.0f));
	*(&iLocal_178 + 256) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_L", "ZombiePack_player_sleep_bed_L", Vector(-464,5455f, 20,58626f, 3911,193f), Vector(0.0f, 0.0f, 0.0f));
	return 1;
}

void Function_260(bool bParam0, bool bParam1) //Position: 0x10A3D / 68157
{
	var uVar0;
...
void Function_261(int iParam0, bool bParam1, bool bParam2) //Position: 0x10AD8 / 68312
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_262(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0x10BE4 / 68580
{
	int iVar0;
...
bool Function_263(int iParam0) //Position: 0x10CC0 / 68800
{
...
int Function_264(int iParam0) //Position: 0x10D3B / 68923
{
...
bool Function_265(int iParam0) //Position: 0x10D50 / 68944
{
...
int Function_266(int iParam0) //Position: 0x10DB6 / 69046
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_267(int iParam0, int iParam1) //Position: 0x10E78 / 69240
{
	int iVar0;
...
void Function_268() //Position: 0x10E95 / 69269
{
	ALLOW_TUMBLEWEEDS(0);
	return;
}

void Function_269(char* cParam0) //Position: 0x10E9F / 69279
{
	if (!Function_26(128))
	{
		return;
