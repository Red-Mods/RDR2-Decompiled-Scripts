...
void main() //Position: 0x0 / 0
{
	...
	uVar12 = FIND_NAMED_LAYOUT("GaptoothRidge_layout");
	if (IS_LAYOUTREF_VALID(&uVar12))
	{
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "gapv_flk_CENTER_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar14 = Function_3(&uVar13, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar16 = Function_3(&uVar13, &bVar5, 7E-06f, 0, 0, 1);
			...
			uVar17 = Function_3(&uVar13, &bVar6, 2E-05f, 0, 0, 1);
			...
			uVar18 = Function_3(&uVar13, &bVar7, 3E-05f, 0, 0, 1);
		...
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "gapv_flk_SW_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar20 = Function_3(&uVar13, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(&uVar13, &bVar5, 7E-06f, 0, 0, 1);
			...
			uVar22 = Function_3(&uVar13, &bVar6, 1,5E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(&uVar13, &bVar7, 3E-05f, 0, 0, 1);
			...
			uVar24 = Function_3(&uVar13, &bVar10, 1E-05f, 0, 0, 1);
		...
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "gapv_flk_NORTH_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar25 = Function_3(&uVar13, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(&uVar13, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar27 = Function_3(&uVar13, &bVar5, 1E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(&uVar13, &bVar6, 2,5E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(&uVar13, &bVar7, 3,5E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(&uVar13, &bVar10, 1E-05f, 0, 0, 1);
			...
			Function_3(&uVar13, &(Global_46972[7]), 2E-05f, 0, 0, 1);
			Function_3(&uVar13, &bVar1, 3,5E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0x12AB / 4779
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x12BC / 4796
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1314 / 4884
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0x13A4 / 5028
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0x13C0 / 5056
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x1400 / 5120
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x141D / 5149
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x142E / 5166
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x14AC / 5292
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1518 / 5400
{
	int iVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1584 / 5508
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x15CB / 5579
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x15D8 / 5592
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x165A / 5722
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x1669 / 5737
{
	if (!Function_4(128))
	{
		return;
