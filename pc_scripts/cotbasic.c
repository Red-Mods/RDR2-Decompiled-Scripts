...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_47 + 2140) = Vector(-1802,674f, 22,971f, 2825,056f);
...
void Function_3(int iParam0, var uParam1, int iParam2) //Position: 0x8CE / 2254
{
	int iVar0;
...
void Function_4(int iParam0, int iParam1, bool bParam2) //Position: 0x9B8 / 2488
{
	int iVar0;
...
void Function_45(char* cParam0, int iParam1) //Position: 0x1D50 / 7504
{
	struct<13> Var0;
...
void Function_60(char* cParam0, bool bParam1) //Position: 0x22FB / 8955
{
	if (Function_102(4))
	{
...
void Function_76(struct<53> Param0) //Position: 0x295A / 10586
{
	...
	if (!HUD_IS_FADED())
	{
		...
		*(&Param0 + 28) = Var5;
		...
		{
			fVar11 = Function_77(Param0.f_44);
			SET_OBJECT_POSITION(&Param0, Var1);
			if (!SET_OBJECT_ORIENTATION(StackVal, &Param0, Vector(0.0f, fVar11, 0.0f)))
			{
			}
			if (&iParam14 >= 4294967295)
			{
				SET_OBJECT_POSITION(Vector(StackVal, StackVal, StackVal) + Vector(Var9, Var1, &Param0 + 8));
				if (!SET_OBJECT_ORIENTATION(StackVal, &Param0 + 8, Vector(0.0f, fVar11, 0.0f)))
				{
				}
			}
		}
...
void Function_94(var uParam0, int iParam1) //Position: 0x3378 / 13176
{
	var uVar0;
	var uVar1;
	int iVar2;
