...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_51 = Vector(-3142,973f, 43,359f, 3767,329f);
	iLocal_58 = 2;
	iLocal_59 = 4;
	fLocal_60 = 70.0f;
	...
	*(&iVar0 + 360) = 2;
	...
	{
		Function_36(&iVar0, GRINGO_GET_MY_OBJECT_REF(), 1, 0, 0, 0, "", -1.0f, 1, 0x43160000);
		GRINGO_WAIT(250);
	}
	Function_1(&iVar0);
	return;
...
void Function_3() //Position: 0x24C / 588
{
	...
	bVar0 = false;
	while (bVar0 <= SQUAD_GET_SIZE(&iLocal_49))
	{
		uVar1 = SQUAD_GET_ACTOR_BY_INDEX(&iLocal_49, bVar0);
		if (IS_ACTOR_VALID(&uVar1))
		{
			if (DECOR_CHECK_EXIST(&uVar1, "bACTOR_AVOID_SMALLBRAINS"))
			{
				DECOR_REMOVE(&uVar1, "bACTOR_AVOID_SMALLBRAINS");
			}
		}
		bVar0++;
	}
	SQUAD_MAKE_EMPTY(&iLocal_49);
	Function_24(&Global_11726, &Global_13850, 0, 0);
	Function_24(&Global_11726, &Global_13850, 1, 0);
	Function_24(&Global_11726, &Global_13850, 3, 0);
	Function_24(&Global_11726, &Global_13850, 2, 0);
	Function_24(&Global_11726, &Global_13850, 5, 0);
	Function_24(&Global_11726, &Global_13850, 4, 0);
	RELEASE_LAYOUT_REF(&uLocal_56);
	Function_4(2, &uLocal_45, &iLocal_49, &uLocal_3, &uLocal_54, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x321 / 801
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x793 / 1939
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x7C7 / 1991
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xB09 / 2825
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xB3C / 2876
{
...
void Function_9(int iParam0) //Position: 0xB53 / 2899
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xB7F / 2943
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xB99 / 2969
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xBB6 / 2998
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC7C / 3196
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xE45 / 3653
{
...
void Function_15(int iParam0) //Position: 0xE82 / 3714
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xE9B / 3739
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xEA8 / 3752
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xF9D / 3997
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0x1003 / 4099
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0x1065 / 4197
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0x109A / 4250
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x12B3 / 4787
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x132A / 4906
{
	struct<2> Var0;
...
void Function_24(struct<2>[] Param0, vector3[] vParam1, int iParam2, bool bParam3) //Position: 0x1396 / 5014
{
	int iVar0;
	...
	if (!Function_31(&(Param0[iVar02]), 1))
	{
		return;
	}
	if (!Function_31(&(Param0[iVar02]), 2))
	{
		return;
	}
	if (Function_31(&(Param0[iVar02]), 8))
	{
		STREAMING_EVICT_ACTOR(vParam1[iVar03], 4294967295);
		Function_30(&(Param0[iVar02]), 8);
	}
	Function_30(&(Param0[iVar02]), 1);
	if (!IS_PERS_CHAR_VALID(&vParam1[iVar03] + 16))
	{
		return;
	}
	Function_29(&vParam1[iVar03] + 16);
	if (&bParam3)
	{
		Function_25(&Param0, &vParam1, iParam2, 0);
	}
}

void Function_25(struct<2>[] Param0, vector3[] vParam1, bool bParam2, bool bParam3) //Position: 0x143E / 5182
{
	if (IS_PERS_CHAR_VALID(&vParam1[bParam23] + 16))
	{
		if (!IS_PERS_CHAR_ALIVE(&vParam1[bParam23] + 16))
		{
			...
			{
				Function_28(&(Param0[bParam22]), 4);
				*(&Param0[bParam22] + 8) = GET_TIME_OF_DAY();
				ADD_TIME(&Param0[bParam22] + 8, Function_27(Global_43790), Function_26(Global_43790), false, 0);
			}
			else
			{
		...
		if (!Function_31(&(Param0[bParam22]), 1))
		{
	...
	else if (!Function_31(&(Param0[bParam22]), 1) && !&bParam3)
	{
		Function_28(&(Param0[bParam22]), 4);
		*(&Param0[bParam22] + 8) = GET_TIME_OF_DAY();
		ADD_TIME(&Param0[bParam22] + 8, Function_27(Global_43790), Function_26(Global_43790), false, 0);
...
int Function_26(int iParam0) //Position: 0x15A4 / 5540
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_27(int iParam0) //Position: 0x15CF / 5583
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_28(var uParam0, int iParam1) //Position: 0x1603 / 5635
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_29(int iParam0) //Position: 0x1614 / 5652
{
	var uVar0;
	var uVar1;
...
void Function_30(var uParam0, int iParam1) //Position: 0x16BD / 5821
{
	int iVar0;
...
bool Function_31(var uParam0, int iParam1) //Position: 0x16D7 / 5847
{
	int iVar0;
...
void Function_32(int iParam0) //Position: 0x16F4 / 5876
{
	int iVar0;
	...
	{
		Function_33(&iParam0, iVar0);
		iVar0++;
	}
	return;
}

void Function_33(struct<2>[] Param0, int iParam1) //Position: 0x171C / 5916
{
	if (Function_35(&(Param0[iParam12]), 4))
	{
		if (Function_35(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_34(&(Param0[iParam12]), 1);
			Function_34(&(Param0[iParam12]), 2);
			Function_34(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_34(struct<13> Param0) //Position: 0x1867 / 6247
{
	int iVar0;
...
bool Function_35(struct<13> Param0) //Position: 0x1884 / 6276
{
	int iVar0;
...
var Function_36(struct<477> Param0) //Position: 0x18A2 / 6306
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_58 || bParam2) || Global_6611)
			{
				if (Function_164(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_162(&Param0 + 324, &fLocal_60, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_161();
								(*&Param0 + 48)[1] = Function_160();
								Function_159(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_159(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_152(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_152(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_159(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_159(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_152(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_152(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_152(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_159(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_151(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_60, 20.0f, fLocal_60));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_147(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_151(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_122(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_118(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_151(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_151(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
					...
					Function_77(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_76(StackVal, StackVal, &Param0 + 16, Function_151(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_151()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
					Function_73(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_72(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_72(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_61(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
										fLocal_62 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_62) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_61, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_60(&Param0 + 392, 1);
							Function_59(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_61 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_60(&Param0 + 392, 1);
								Function_59(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_58(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_54(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_54(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_53()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_52(&Param0 + 392, Function_53(), 4);
				Function_51(&Param0 + 392, Function_53());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_50(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_49(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_40(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_37(struct<62> Param0) //Position: 0x2A61 / 10849
{
...
void Function_38(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2A73 / 10867
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_39(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
					if (!Function_39(&bVar2, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&bVar2);
					}
				}
...
bool Function_39(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2CAC / 11436
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_40(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2CCC / 11468
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(&uVar1))
				{
					Function_41(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_41(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_41(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2DBA / 11706
{
	char* cVar0[32];
	...
	Function_44(&uParam0, &uParam2);
	Function_43(&uParam0, uParam3);
	if (Function_42(&uParam0) != 5)
	{
...
int Function_42(int iParam0) //Position: 0x3026 / 12326
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_43(var uParam0, bool bParam1) //Position: 0x304A / 12362
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x306E / 12398
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_45(var uParam0, bool bParam1) //Position: 0x3094 / 12436
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_46(var uParam0, bool bParam1) //Position: 0x30BB / 12475
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_47(bool bParam0) //Position: 0x30DF / 12511
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_48() //Position: 0x30FE / 12542
{
...
bool Function_49(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x314D / 12621
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_39(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_50(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x31A9 / 12713
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_51(var uParam0, int iParam1) //Position: 0x31CA / 12746
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, var uParam1, bool bParam2) //Position: 0x3225 / 12837
{
	bool bVar0;
	var uVar1;
...
var Function_53() //Position: 0x3271 / 12913
{
...
void Function_54(struct<425> Param0) //Position: 0x3286 / 12934
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_57(&Param0 + 392))
	{
		return;
	}
	if (!Function_55(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_58(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_58(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_58(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_58(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_55(var uParam0, struct<2> Param1, float fParam3) //Position: 0x33D9 / 13273
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_56(vector3 vParam0) //Position: 0x344E / 13390
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_57(var uParam0) //Position: 0x3466 / 13414
{
	bool bVar0;
	int iVar1;
...
var Function_58(bool bParam0) //Position: 0x34C4 / 13508
{
	bool bVar0;
	bool bVar1;
...
void Function_59(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3511 / 13585
{
	bool bVar0;
	var uVar1;
...
void Function_60(var uParam0, bool bParam1) //Position: 0x358A / 13706
{
	bool bVar0;
	var uVar1;
...
void Function_61(var uParam0) //Position: 0x35D9 / 13785
{
	struct<21> Var0;
	
	bVar6 = Function_71(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_63(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_62())
...
bool Function_62() //Position: 0x3698 / 13976
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_63(struct<25> Param0) //Position: 0x36AB / 13995
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_68(Param0, 0))
	{
		uVar0 = Function_64(StackVal);
...
var Function_64(int iParam0) //Position: 0x3772 / 14194
{
...
bool Function_65(int iParam0) //Position: 0x3792 / 14226
{
	if (!Function_67(iParam0))
	{
		return 0;
	}
	if (!Function_66(StackVal))
	{
		return 0;
	}
	return 1;
...
bool Function_66(int iParam0) //Position: 0x37B6 / 14262
{
...
bool Function_67(int iParam0) //Position: 0x37CB / 14283
{
...
bool Function_68(int iParam0, bool bParam1) //Position: 0x37E2 / 14306
{
	int iVar0;
...
var Function_69(int iParam0) //Position: 0x3820 / 14368
{
...
bool Function_70(int iParam0) //Position: 0x383A / 14394
{
...
int Function_71(int iParam0, struct<6> Param1) //Position: 0x3850 / 14416
{
	int iVar0;
...
void Function_72(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x388A / 14474
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > bParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_151(), bParam2[iVar0], Var1, Var3);
...
void Function_73(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x396F / 14703
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_151(), bParam3, Var2, Var4);
...
void Function_74(var uParam0, bool bParam1) //Position: 0x3B26 / 15142
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_75(bool bParam0) //Position: 0x3B4B / 15179
{
	var uVar0;
	int iVar1;
...
var Function_76(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3B99 / 15257
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_77(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3CF0 / 15600
{
	var uVar0[5];
	int iVar6;
...
int Function_78(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3D9B / 15771
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_79(int iParam0, int iParam1) //Position: 0x3E41 / 15937
{
	Function_159(&uLocal_3, 1202, 3, 0);
	Function_115(&uLocal_3, "p_gen_tableSnakeOilSign01x", 0, 0);
	Function_115(&uLocal_3, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_115(&uLocal_3, "$/content/scripting/gringo/simplegringo/lean_fence_l", 1, 0);
	Function_115(&uLocal_3, "$/content/scripting/gringo/simplegringo/rand_idle_stand_nospawn", 1, 0);
	Function_115(&uLocal_3, "$/content/scripting/gringo/simplegringo/stand_dnd_rowdydrink", 1, 0);
	Function_115(&uLocal_3, "$/fragments/p_gen_bottleSnakeOil01x", 0, 0);
	Function_115(&uLocal_3, "$/fragments/p_gen_bottleSnakeOil02x", 0, 0);
	Function_115(&uLocal_3, "$/fragments/p_gen_tableSnakeOil01x", 0, 0);
	Function_115(&uLocal_3, "$/fragments/p_gen_tableSnakeOilSign01x", 0, 0);
	if (Function_96(&uLocal_45, &uLocal_3, 16, 0, 1, 1, 0, 1, 0, 0, 0) && !WOULD_ACTOR_BE_VISIBLE(1202, &uLocal_51, 3212836864))
	{
		if (Function_94(&uLocal_56, "merchant03mobile", &iParam1))
		{
			iLocal_49 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_56, Function_151()));
			*(&Global_6667[1628] + 216) = &iLocal_49;
			*(&iParam0 + 24) = &uLocal_56;
			Function_80();
			return 1;
		}
	}
...
void Function_80() //Position: 0x40C9 / 16585
{
	uLocal_54 = CREATE_LAYOUT("merchant04campfiregringo");
	Function_89();
	Function_88();
	if (!Function_87(1202, &iLocal_47, &uLocal_54, 0))
	{
		iLocal_47 = Function_83(StackVal, StackVal, &uLocal_54, "mercant_coach", 1202, 976, Vector(-3142,973f, 43,359f, 3767,329f), Vector(0.0f, 152,259f, 0.0f), 1, 976, 976, 976, 4);
	}
	Function_81(&iLocal_47, &iLocal_49, 1, 1);
	return;
}

void Function_81(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x4152 / 16722
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_82(&uParam0, &iParam1, 1))
	{
	...
	else if (IS_ACTOR_VEHICLE(&uParam0))
	{
		...
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(&uParam0))
		{
			...
			if (IS_ACTOR_VALID(&iVar1))
			{
				if (!Function_82(&iVar1, &iParam1, 1))
				{
...
bool Function_82(int iParam0, int iParam1, bool bParam2) //Position: 0x430F / 17167
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
int Function_83(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x4357 / 17239
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(&uVar0))
	{
		...
		while (iVar9 < (iVar10 - 1))
		{
			...
			uVar15 = "";
			if (Function_86(&(Global_46972[6]), 4, 23, 0) && uParam8)
			{
				bVar16 = Function_85(StackVal, &(Global_46972[6]), Param4, 4, 23, 0);
				if (Function_84(bVar16, &iVar1))
				{
					bVar16 = 976;
				}
				iVar1[iVar9] = bVar16;
...
bool Function_84(int iParam0, bool[] bParam1) //Position: 0x45AA / 17834
{
	int iVar0;
...
var Function_85(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x45DE / 17886
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_86(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x45FA / 17914
{
...
bool Function_87(int iParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4626 / 17958
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88() //Position: 0x4752 / 18258
{
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "tableSnakeOil01x0", "p_gen_tableSnakeOil01x", Vector(-3125,33f, 44,22f, 3762,92f), Vector(0.0f, 88,38f, 0.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil01x0", "p_gen_bottleSnakeOil01x", Vector(-3125,36f, 45,02f, 3762,64f), Vector(180.0f, 25,37f, -180.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil01x1", "p_gen_bottleSnakeOil01x", Vector(-3125,46f, 45.0f, 3762,27f), Vector(180.0f, 82,08f, -180.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil01x2", "p_gen_bottleSnakeOil01x", Vector(-3125,75f, 45,02f, 3762,25f), Vector(180.0f, 39,44f, -180.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil01x3", "p_gen_bottleSnakeOil01x", Vector(-3125,8f, 45,02f, 3762,59f), Vector(0.0f, 32,87f, 0.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil01x4", "p_gen_bottleSnakeOil01x", Vector(-3126,13f, 45,02f, 3762,76f), Vector(0.0f, -34.0f, 0.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil02x1", "p_gen_bottleSnakeOil02x", Vector(-3126,11f, 45,02f, 3762,3f), Vector(0.0f, -3,4f, 0.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "bottleSnakeOil02x2", "p_gen_bottleSnakeOil02x", Vector(-3125,51f, 45,02f, 3762,85f), Vector(180.0f, 82,08f, 180.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "tableSnakeOilSign01x0", "p_gen_tableSnakeOilSign01x", Vector(-3126,623f, 44,02248f, 3763,398f), Vector(0.0f, 85,15919f, 0.0f), 1);
	return;
}

void Function_89() //Position: 0x4A43 / 19011
{
	int iVar0;
	var uVar1;
	
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 0, Vector(-3102,8f, 45,09734f, 3760,586f), Vector(0.0f, 104,4485f, 0.0f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "smoking_stand", "smoking_stand", Vector(-3117,469f, 44,15486f, 3768f), Vector(0.0f, -301,3417f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 1, Vector(-3118,406f, 44,17278f, 3760f), Vector(0.0f, 117,926f, 0.0f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "lean_fence_L", "lean_fence_L", Vector(-3102,916f, 45,08257f, 3760,465f), Vector(0.0f, 41,69626f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 3, Vector(-3116,601f, 44,1653f, 3768f), Vector(0,6915786f, 73,61624f, 1,73868f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "rand_idle_stand_nospawn03", "rand_idle_stand_nospawn", Vector(-3117,44f, 44,1552f, 3768f), Vector(0.0f, 58,66973f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 2, Vector(-3120.0f, 44,12778f, 3767,686f), Vector(0.0f, 64,95924f, 0.0f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "smoking_stand1", "smoking_stand", Vector(-3121,522f, 44,15486f, 3760,104f), Vector(0.0f, -184,1617f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 5, Vector(-3118,774f, 44,17255f, 3769,988f), Vector(0.0f, 59,74842f, 0.0f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "Sit_Ground_Only", "stand_dnd_rowdydrink", Vector(-3120.0f, 44,14787f, 3766,663f), Vector(0.0f, 75,05489f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	DECOR_SET_BOOL(&iVar0, "bACTOR_AVOID_SMALLBRAINS", 1);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
	iVar0 = Function_90(StackVal, StackVal, &Global_11726, &Global_13850, 4, Vector(-3121,328f, 44,1042f, 3759,588f), Vector(0.0f, 158,3807f, 0.0f), 1);
	uVar1 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_54, "Sit_Ground_Only1", "stand_dnd_rowdydrink", Vector(-3119,402f, 44,14787f, 3760,324f), Vector(0.0f, 126,6882f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar1), 0);
	DECOR_SET_BOOL(&iVar0, "bACTOR_AVOID_SMALLBRAINS", 1);
	TASK_USE_GRINGO(&iVar0, GET_GRINGO_FROM_OBJECT(&uVar1), "UseCase1", 4294967295, 1);
	Function_81(&iVar0, &iLocal_49, 1, 1);
...
int Function_90(int iParam0, float fParam1, float fParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x4E3D / 20029
{
	var uVar0;
	var uVar1;
	
	uVar0 = fParam2;
	uVar1 = Function_91(&iParam0, &fParam1, uVar0, &iParam7, 0, 1);
	if (!IS_ACTOR_VALID(&uVar1))
	{
...
var Function_91(struct<2>[] Param0, vector3[] vParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x4F2D / 20269
{
	int iVar0;
	var uVar1;
	struct<2> Var2;
	...
	else if (IS_EARLIER_THAN(&Param0[iVar02] + 8, 0) || uParam3)
	{
		...
		(&vParam1[iVar03] + 16) = Function_93(StackVal, &Global_10996, Function_151(), vParam1[iVar03], &vParam1[iVar03] + 8, Var2, 0x42700000);
		if (IS_PERS_CHAR_VALID(&vParam1[iVar03] + 16))
		{
			if (!Function_31(&(Param0[iVar02]), 8))
			{
	...
	Function_92(&vParam1[iVar03] + 16, 1);
	if (&bParam5)
	{
...
int Function_92(int iParam0, bool bParam1) //Position: 0x50F4 / 20724
{
	var uVar0;
	var uVar1;
...
var Function_93(var uParam0, var uParam1, var uParam2, var uParam3, struct<2> Param4, float fParam6) //Position: 0x51A6 / 20902
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	{
		ATTACH_OBJECTS(StackVal, StackVal, &uVar3, GET_OBJECT_FROM_PERS_CHAR(&uVar2), Function_151(), Vector(0.0f, 1,5f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	}
	else
	{
...
bool Function_94(var uParam0, var uParam1, int iParam2) //Position: 0x52CD / 21197
{
	...
	Function_95(&uParam0, &iParam2);
	return 1;
	return 0;
}

void Function_95(var uParam0, bool bParam1) //Position: 0x52FD / 21245
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_151(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
int Function_96(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x5348 / 21320
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_114(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_113(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_111(uVar0))
		{
	...
	if (StackVal || !Function_109((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_113(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_111(iVar1))
		{
			if (Function_118(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_97(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_97(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x5527 / 21799
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_108(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		if (&bParam6)
		{
			bVar1 = Function_105(&Global_15402[iParam014] + 16, &uParam7);
		}
		if (&bParam8)
		{
			bVar1 = Function_100(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_98(var uParam0, bool bParam1) //Position: 0x5A67 / 23143
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_99(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x5A89 / 23177
{
	var uVar0;
...
var Function_100(bool bParam0, int iParam1) //Position: 0x5AEA / 23274
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_101(var uParam0, int iParam1) //Position: 0x5B78 / 23416
{
	Function_103(&uParam0);
	Function_102(&uParam0);
	REMOVE_OBJECT_FROM_OBJECTSET(GET_OBJECT_FROM_ACTOR(&uParam0), &Global_26172);
	GIVE_OBJECT_TO_LAYOUT(GET_OBJECT_FROM_ACTOR(&uParam0), &iParam1);
	return;
}

void Function_102(int iParam0) //Position: 0x5BA4 / 23460
{
...
void Function_103(int iParam0) //Position: 0x5BCA / 23498
{
...
bool Function_104(bool bParam0) //Position: 0x5CA0 / 23712
{
...
var Function_105(int iParam0, int iParam1) //Position: 0x5CB7 / 23735
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_106(int iParam0, bool bParam1, bool bParam2) //Position: 0x5D5D / 23901
{
	var uVar0;
	var uVar1;
...
void Function_107(var uParam0) //Position: 0x5E6C / 24172
{
	int iVar0;
...
bool Function_108(var uParam0, int iParam1) //Position: 0x5E9F / 24223
{
	int iVar0;
...
bool Function_109(int iParam0, struct<2> Param1, float fParam3) //Position: 0x5EBC / 24252
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_110() //Position: 0x5F48 / 24392
{
	var uVar0;
	int iVar1;
...
bool Function_111(int iParam0) //Position: 0x5FB8 / 24504
{
	if (!Function_112(iParam0))
	{
		return 1;
	}
	return Function_108(&(Global_43791[iParam0]), 4);
}

bool Function_112(int iParam0) //Position: 0x5FD4 / 24532
{
...
var Function_113(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x5FEA / 24554
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_114(struct<205> Param0) //Position: 0x6090 / 24720
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_11(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_64(Function_69(Param0.f_188));
...
var Function_115(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x619B / 24987
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_117(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_116(struct<13> Param0) //Position: 0x61D9 / 25049
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_117(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x61EC / 25068
{
	int iVar0;
	...
	{
		if (!Function_35(&(Param0[iVar02]), 4))
		{
...
bool Function_118(struct<2>[] Param0) //Position: 0x62BB / 25275
{
	int iVar0;
	int iVar1;
	...
	Function_121();
	iVar1 = 0;
	if (!Function_35(&(Param0[iVar02]), 16))
	{
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_35(&(Param0[iVar02]), 4))
		{
			if (!Function_35(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_35(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_35(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_35(&(Param0[iVar02]), 4))
		{
			if (!Function_35(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_119() //Position: 0x667D / 26237
{
	if (!Function_166(128))
	{
		return;
...
bool Function_120() //Position: 0x66BD / 26301
{
	int iVar0;
...
void Function_121() //Position: 0x66EB / 26347
{
	if (!Function_166(128))
	{
		return;
...
void Function_122(vector3 vParam0) //Position: 0x672D / 26413
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_123(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_123(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_123(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x67C5 / 26565
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_124(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_124(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x67F4 / 26612
{
	Function_139(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_129(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_128(), Function_127(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_126(), Function_125(&uParam11, &uParam12));
}

var Function_125(var uParam0, bool bParam1) //Position: 0x684F / 26703
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_126() //Position: 0x685F / 26719
{
	return "PackedGrass";
}

var Function_127(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6873 / 26739
{
	int iVar0;
...
var Function_128() //Position: 0x6898 / 26776
{
	return "PackedMetadata";
}

void Function_129(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x68AF / 26799
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_138(), &uVar4))
				{
					Function_133(uVar4, &bVar5);
...
struct<8> Function_130() //Position: 0x69EB / 27115
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_131() //Position: 0x69FD / 27133
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_132() //Position: 0x6A0F / 27151
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_133(var uParam0, struct<5> Param1) //Position: 0x6A21 / 27169
{
	Param1 = Function_134(uParam0, Function_136(), 0);
	Param1.f_4 = Function_134(uParam0, Function_136() + 8, Function_136());
	return;
}

var Function_134(var uParam0, int iParam1, int iParam2) //Position: 0x6A46 / 27206
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_135((iParam1 - 1)), true) - 1);
	return SHIFT_RIGHT((iVar0 && uParam0), iParam2);
}

var Function_135(bool bParam0) //Position: 0x6A65 / 27237
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_136() //Position: 0x6A71 / 27249
{
	return Function_137(39);
}

int Function_137(int iParam0) //Position: 0x6A7C / 27260
{
	int iVar0;
...
var Function_138() //Position: 0x6AAA / 27306
{
	return "PackedWeapon";
}

int Function_139(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x6ABF / 27327
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_143(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_141(Function_143()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_140(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_140() //Position: 0x6BCC / 27596
{
	return "MPItemGiver";
}

struct<32> Function_141(char* cParam0) //Position: 0x6BE0 / 27616
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_142(char* cParam0) //Position: 0x6C4C / 27724
{
	char* cVar0[32];
...
var Function_143() //Position: 0x6C6E / 27758
{
	return "PBox_";
}

var Function_144() //Position: 0x6C7C / 27772
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_145() //Position: 0x6CA2 / 27810
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_146() //Position: 0x6CCA / 27850
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_147(var uParam0, int iParam1) //Position: 0x6CF0 / 27888
{
	int iVar0;
	var uVar1;
	...
	Function_149(DECOR_GET_INT(&uParam0, "script"));
	iVar0 = 0;
	while (iVar0 <= 25)
	{
...
void Function_148(int iParam0, var uParam1, struct<2> Param2) //Position: 0x6E5A / 28250
{
	struct<8> Var0;
...
int Function_149(bool bParam0) //Position: 0x6F02 / 28418
{
	int iVar0;
	struct<2> Var1;
...
void Function_150(int iParam0) //Position: 0x7070 / 28784
{
...
var Function_151() //Position: 0x70D8 / 28888
{
	int iVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x70E1 / 28897
{
	return Function_153(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_153(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x70FF / 28927
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_104(bVar1))
	{
		...
		{
			Function_157(&uParam0, bParam1, iParam2, iParam3, bParam4);
	...
	if (bParam1 || (!iParam3 != 4294967295 && !iParam3 != GET_ACTORENUM_SPECIES(bVar1)))
	{
		...
		{
			while (Function_156(bVar0) && iVar2 > 20)
			{
...
void Function_154(int iParam0) //Position: 0x73F8 / 29688
{
	int iVar0;
...
void Function_155() //Position: 0x74AC / 29868
{
	int iVar0;
...
bool Function_156(bool bParam0) //Position: 0x74E7 / 29927
{
	int iVar0;
...
void Function_157(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x7514 / 29972
{
	bool bVar0;
...
void Function_158() //Position: 0x766F / 30319
{
	int iVar0;
...
var Function_159(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x76BB / 30395
{
	int iVar0;
...
int Function_160() //Position: 0x7797 / 30615
{
	int iVar0;
...
int Function_161() //Position: 0x78F3 / 30963
{
	int iVar0;
...
bool Function_162(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x7A13 / 31251
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_163(struct<2> Param0) //Position: 0x7AEF / 31471
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_164(struct<2> Param0, struct<5> Param2) //Position: 0x7B0E / 31502
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_165(int iParam0) //Position: 0x7C51 / 31825
{
	var uVar0;
...
bool Function_166(int iParam0) //Position: 0x7C73 / 31859
{
	int iVar0;
...
int Function_167() //Position: 0x7C8F / 31887
{
	return 0;
}

void Function_168(struct<321> Param0) //Position: 0x7C96 / 31894
{
	var uVar0;
	
	Param0.f_8 = 0;
	Param0.f_320 = 0;
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_141("campfire"), 4);
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_117(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_117(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
