...
void main() //Position: 0x0 / 0
{
	...
	iLocal_118 = 0;
	Function_103(&uScriptParam_0, &iLocal_118);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(vLocal_8[iVar39]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_8[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", &vLocal_8[iVar39] + 24);
							Function_88(&vLocal_8[iVar39] + 24, 1);
							...
							{
								Function_81(&(vLocal_8[iVar39]), 0);
							}
							else if (vLocal_8[iVar39].f_68 < 8)
							{
								Function_80(&(vLocal_8[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xAE0 / 2784
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_79(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_62(int iParam0) //Position: 0x28AB / 10411
{
	...
	iParam0 = &iParam0;
	if ((iLocal_6 && !iLocal_7) && Global_46838[1] != Global_43789)
	{
		iLocal_7 = 1;
		...
		uLocal_4 = Function_63(&uLocal_2, 0, 1, 0, 0);
		HUD_ENABLE(0);
		uVar8 = FIND_VOLUME_IN_LAYOUT(&Global_46715, "v_frontRestrict");
		if (IS_VOLUME_VALID(&uVar8))
		{
			uVar9 = CREATE_OBJECTSET_IN_LAYOUT(Function_39(), &uLocal_2, 4294967295, 0);
			iVar10 = LOCATE_ACTORS_IN_VOLUME(&uVar8, &uVar9, 0, 1);
			if (iVar10 >= 0)
			{
				iVar11 = 0;
				while (iVar11 < (iVar10 - 1))
				{
					iVar12 = GET_INDEXED_OBJECT_IN_OBJECTSET(iVar11, &uVar9);
					if (!&iVar12 != GET_OBJECT_FROM_ACTOR(&Global_54076) && !DECOR_CHECK_EXIST(&iVar12, "IsHelper"))
					{
						SET_OBJECT_POSITION_ON_GROUND(StackVal, &iVar12, Vector(-2661,72f, 67,26f, 3402,27f));
					}
					iVar11++;
				}
			}
			...
			{
				if (IS_ACTOR_IN_VOLUME(&Global_21369 + 72, &uVar8))
				{
...
var Function_63(var uParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2A07 / 10759
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "ClimbHelp_FortMercer", 2, 1);
	}
	Function_64(&uVar0);
...
void Function_64(int iParam0) //Position: 0x2A95 / 10901
{
	var uVar0;
...
void Function_65(int iParam0) //Position: 0x2AE6 / 10982
{
	...
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2657,796f, 70,23667f, 3403,237f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,0432f, -2,926601f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2B5B / 11099
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2656,693f, 68,58958f, 3404,863f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,034746f, 2,892083f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

struct<32> Function_67(char* cParam0) //Position: 0x2BD0 / 11216
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0) //Position: 0x2C3C / 11324
{
	char* cVar0[32];
...
void Function_69(int iParam0) //Position: 0x2C5E / 11358
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2C6A / 11370
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2C89 / 11401
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2CA0 / 11424
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_73(int iParam0) //Position: 0x2D31 / 11569
{
	struct<2> Var0;
...
struct<8> Function_74(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D55 / 11605
{
	struct<2> Var0;
...
int Function_75(int iParam0) //Position: 0x2D74 / 11636
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(var uParam0, int iParam1) //Position: 0x2D98 / 11672
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2EC0 / 11968
{
...
int Function_78(var uParam0) //Position: 0x2EEE / 12014
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x3007 / 12295
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(struct<69> Param0) //Position: 0x3014 / 12308
{
	if (Function_79(Param0.f_64, 16))
	{
...
void Function_81(struct<69> Param0) //Position: 0x3096 / 12438
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x3641 / 13889
{
	iLocal_7 = 0;
...
int Function_83(int iParam0) //Position: 0x3659 / 13913
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_84(int iParam0, var uParam1) //Position: 0x3677 / 13943
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_85(int iParam0) //Position: 0x36B8 / 14008
{
	iParam0 = &iParam0;
	return;
}

bool Function_86(int iParam0) //Position: 0x36C4 / 14020
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_87(int iParam0, int iParam1) //Position: 0x36E6 / 14054
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x3738 / 14136
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_89(int iParam0, int iParam1) //Position: 0x3848 / 14408
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_90(struct<69> Param0) //Position: 0x3860 / 14432
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x3B7C / 15228
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_92(int iParam0) //Position: 0x3B94 / 15252
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_93(int iParam0) //Position: 0x3BAE / 15278
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, var uParam1) //Position: 0x3BC9 / 15305
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3C07 / 15367
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_96(struct<65> Param0) //Position: 0x3C20 / 15392
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_97(int iParam0) //Position: 0x3F18 / 16152
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3F36 / 16182
{
	struct<5> Var0;
	float fVar5;
...
int Function_99(int iParam0) //Position: 0x3FD6 / 16342
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(int iParam0, var uParam1) //Position: 0x3FF6 / 16374
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x400B / 16395
{
...
void Function_102(int iParam0) //Position: 0x4027 / 16423
{
	iParam0 = &iParam0;
	return;
}

void Function_103(var uParam0, int iParam1) //Position: 0x4033 / 16435
{
	int iVar0;
	var uVar1;
	...
	{
		Function_104(&(vLocal_8[iLocal_1189]), &uParam0);
		iLocal_118++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x409F / 16543
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_105(int iParam0) //Position: 0x40B7 / 16567
{
	iParam0 = &iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x40C3 / 16579
{
