...
void main() //Position: 0x0 / 0
{
	...
	iLocal_2 = 1;
	fLocal_3 = 2.0f;
	Local_18 = Vector(-2083,37f, 17,089f, 2599,237f);
	Local_21 = Vector(-2088,832f, 17,014f, 2602,875f);
	iLocal_29 = 2;
	iLocal_30 = 4;
	fLocal_31 = 70.0f;
...
void Function_1(struct<473> Param0) //Position: 0xAB / 171
{
	bool bVar0;
...
void Function_2() //Position: 0x259 / 601
{
	Function_3();
	return;
}
...
void Function_3() //Position: 0x262 / 610
{
	...
	Function_4(4, &uLocal_10, &iLocal_12, &uLocal_4, &uLocal_14, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x27E / 638
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6F0 / 1776
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x724 / 1828
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA66 / 2662
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA99 / 2713
{
...
void Function_9(int iParam0) //Position: 0xAB0 / 2736
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xADC / 2780
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAF6 / 2806
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB13 / 2835
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBD9 / 3033
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xDA2 / 3490
{
...
void Function_15(int iParam0) //Position: 0xDDF / 3551
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDF8 / 3576
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE05 / 3589
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xEFA / 3834
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF60 / 3936
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFC2 / 4034
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFF7 / 4087
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x1210 / 4624
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1287 / 4743
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12F3 / 4851
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x131B / 4891
{
...
void Function_26(struct<13> Param0) //Position: 0x1466 / 5222
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x1483 / 5251
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x14A1 / 5281
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_29 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_31, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_31, 20.0f, fLocal_31));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_73(StackVal, StackVal, &Param0 + 16, Function_132(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
...
void Function_29(struct<62> Param0) //Position: 0x2660 / 9824
{
	var uVar0;
	...
	if ((GET_CURRENT_GAME_TIME() - fLocal_28) < 1.0f && Function_33(Global_46760[0]))
	{
...
void Function_30(var uParam0, int iParam1) //Position: 0x26E1 / 9953
{
...
int Function_31(int iParam0, char* cParam1, bool bParam3) //Position: 0x273C / 10044
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_32(int iParam0) //Position: 0x27E1 / 10209
{
...
bool Function_33(int iParam0) //Position: 0x27F7 / 10231
{
	if (!Function_32(iParam0))
	{
		return 1;
...
bool Function_34(var uParam0, int iParam1) //Position: 0x2813 / 10259
{
	int iVar0;
...
void Function_35(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2830 / 10288
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_36(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2A69 / 10857
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_37(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2A89 / 10889
{
	bool bVar0;
	var uVar1;
...
int Function_38(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2B77 / 11127
{
	char* cVar0[32];
...
int Function_39(int iParam0) //Position: 0x2DE3 / 11747
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_40(var uParam0, bool bParam1) //Position: 0x2E07 / 11783
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_41(var uParam0, int iParam1) //Position: 0x2E2B / 11819
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E51 / 11857
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_43(var uParam0, bool bParam1) //Position: 0x2E78 / 11896
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_44(bool bParam0) //Position: 0x2E9C / 11932
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_45() //Position: 0x2EBB / 11963
{
...
bool Function_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2F0A / 12042
{
	bool bVar0;
	var uVar1;
...
bool Function_47(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F66 / 12134
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_48(var uParam0, int iParam1) //Position: 0x2F87 / 12167
{
	bool bVar0;
	var uVar1;
...
void Function_49(var uParam0, var uParam1, bool bParam2) //Position: 0x2FE2 / 12258
{
	bool bVar0;
	var uVar1;
...
var Function_50() //Position: 0x302E / 12334
{
...
void Function_51(struct<425> Param0) //Position: 0x3043 / 12355
{
	bool bVar0;
	bool bVar1;
...
bool Function_52(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3196 / 12694
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_53(vector3 vParam0) //Position: 0x320B / 12811
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_54(var uParam0) //Position: 0x3223 / 12835
{
	bool bVar0;
	int iVar1;
...
var Function_55(bool bParam0) //Position: 0x3281 / 12929
{
	bool bVar0;
	bool bVar1;
...
void Function_56(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x32CE / 13006
{
	bool bVar0;
	var uVar1;
...
void Function_57(var uParam0, bool bParam1) //Position: 0x3347 / 13127
{
	bool bVar0;
	var uVar1;
...
void Function_58(var uParam0) //Position: 0x3396 / 13206
{
	struct<21> Var0;
...
bool Function_59() //Position: 0x3455 / 13397
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_60(struct<25> Param0) //Position: 0x3468 / 13416
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_61(int iParam0) //Position: 0x352F / 13615
{
...
bool Function_62(int iParam0) //Position: 0x354F / 13647
{
...
bool Function_63(int iParam0) //Position: 0x3573 / 13683
{
...
bool Function_64(int iParam0) //Position: 0x3588 / 13704
{
...
bool Function_65(int iParam0, bool bParam1) //Position: 0x359F / 13727
{
	int iVar0;
...
var Function_66(int iParam0) //Position: 0x35DD / 13789
{
...
bool Function_67(int iParam0) //Position: 0x35F7 / 13815
{
...
int Function_68(int iParam0, struct<6> Param1) //Position: 0x360D / 13837
{
	int iVar0;
...
void Function_69(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3647 / 13895
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_70(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x372C / 14124
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_71(var uParam0, bool bParam1) //Position: 0x38E3 / 14563
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_72(bool bParam0) //Position: 0x3908 / 14600
{
	var uVar0;
	int iVar1;
...
var Function_73(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3956 / 14678
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_74(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3AAD / 15021
{
	var uVar0[5];
	int iVar6;
...
int Function_75(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3B58 / 15192
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_76(int iParam0, int iParam1) //Position: 0x3BFE / 15358
{
	Function_140(&uLocal_4, 606, 3, 0);
	if (Function_82(&uLocal_10, &uLocal_4, 9, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		uLocal_24 = LOCATE_GRINGO_OF_TYPE("sleep", &Local_18, 1.0f, 1);
		uLocal_26 = LOCATE_GRINGO_OF_TYPE("wrk", &Local_21, 1.0f, 1);
		if (IS_GRINGO_VALID(&uLocal_24) && IS_GRINGO_VALID(&uLocal_26))
		{
			if (Function_80(&uLocal_16, "marshal02mobile", &iParam1))
			{
				iLocal_12 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_16, Function_132()));
				*(&Global_6667[928] + 216) = &iLocal_12;
...
void Function_77() //Position: 0x3CA5 / 15525
{
	var uVar0;
	var uVar1;
	char[] cVar2[4];
	...
	uLocal_14 = CREATE_LAYOUT("marshal02campfirelayout");
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_14, "marshal02restrict", 2,802597E-45f, Vector(-2084,343f, 17,37085f, 2602,81f), Vector(0.0f, 24,46099f, 0.0f), Vector(9,259373f, 5,303829f, 9,113053f));
	...
	uVar1 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Local_21, 5.0f, "chair01", 1);
	RESET_PROP(&uVar1);
	cVar2 = Function_31(Global_46760[0], "narmadillo", "sheriffsOffice01", 1);
	CLOSE_DOOR_FAST(&cVar2);
	cVar2 = Function_31(Global_46760[0], "narmadillo", "sheriffsOffice01", 2);
	CLOSE_DOOR_FAST(&cVar2);
	uVar3 = Vector(-2087,707f, 17,305f, 2601,11f);
	TELEPORT_ACTOR(&uLocal_10, &uVar3, 1, 1, 1);
	TASK_USE_GRINGO(&uLocal_10, &uLocal_26, "UseCase1", 4294967295, 1);
	AI_IGNORE_ACTOR(&uLocal_10);
	Function_78(&uLocal_10, &iLocal_12, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_10, &uVar0, 1, true);
	uVar5 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_14, "Marshal02prisoner", 606, Local_18, Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&uVar5, GET_OBJECT_FROM_GRINGO(&uLocal_24), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uVar5, &uLocal_24, "UseCase1", 4294967295, 1);
	Function_78(&uVar5, &iLocal_12, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uVar5, &uVar0, 1, true);
	return;
}

void Function_78(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3E70 / 15984
{
	bool bVar0;
	int iVar1;
...
bool Function_79(int iParam0, int iParam1, bool bParam2) //Position: 0x402E / 16430
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x4076 / 16502
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x40A6 / 16550
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x40F1 / 16625
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x42D0 / 17104
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x4810 / 18448
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_85(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4832 / 18482
{
	var uVar0;
...
var Function_86(bool bParam0, int iParam1) //Position: 0x4893 / 18579
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x4921 / 18721
{
	Function_89(&uParam0);
	Function_88(&uParam0);
...
void Function_88(int iParam0) //Position: 0x494D / 18765
{
...
void Function_89(int iParam0) //Position: 0x4973 / 18803
{
...
bool Function_90(bool bParam0) //Position: 0x4A49 / 19017
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x4A60 / 19040
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4B06 / 19206
{
	var uVar0;
	var uVar1;
...
void Function_93(int iParam0) //Position: 0x4C15 / 19477
{
	int iVar0;
...
bool Function_94(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4C48 / 19528
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_95() //Position: 0x4CD4 / 19668
{
	var uVar0;
	int iVar1;
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4D44 / 19780
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4DEA / 19946
{
	var uVar0;
	var uVar1;
...
bool Function_98(struct<2>[] Param0) //Position: 0x4EF5 / 20213
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x52B7 / 21175
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x52F7 / 21239
{
	int iVar0;
...
void Function_101(struct<13> Param0) //Position: 0x5325 / 21285
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_102() //Position: 0x5338 / 21304
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x537A / 21370
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5412 / 21522
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5441 / 21569
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x549C / 21660
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x54AC / 21676
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x54C0 / 21696
{
	int iVar0;
...
var Function_109() //Position: 0x54E5 / 21733
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x54FC / 21756
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x5638 / 22072
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x564A / 22090
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x565C / 22108
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x566E / 22126
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x5693 / 22163
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x56B2 / 22194
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x56BE / 22206
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x56C9 / 22217
{
	int iVar0;
...
var Function_119() //Position: 0x56F7 / 22263
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x570C / 22284
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x5819 / 22553
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x582D / 22573
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x5899 / 22681
{
	char* cVar0[32];
...
var Function_124() //Position: 0x58BB / 22715
{
	return "PBox_";
}

var Function_125() //Position: 0x58C9 / 22729
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x58EF / 22767
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x5917 / 22807
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x593D / 22845
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5AA7 / 23207
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5B4F / 23375
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x5CBD / 23741
{
...
var Function_132() //Position: 0x5D25 / 23845
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5D2E / 23854
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5D4C / 23884
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x6045 / 24645
{
	int iVar0;
...
void Function_136() //Position: 0x60F9 / 24825
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x6134 / 24884
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6161 / 24929
{
	int iVar0;
...
void Function_139() //Position: 0x62BC / 25276
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6308 / 25352
{
	int iVar0;
...
int Function_141() //Position: 0x63E4 / 25572
{
	int iVar0;
...
int Function_142() //Position: 0x6540 / 25920
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6660 / 26208
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x673C / 26428
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x675B / 26459
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x689E / 26782
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x68C0 / 26816
{
	int iVar0;
...
int Function_148() //Position: 0x68DC / 26844
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x68E3 / 26851
{
	var uVar0;
...
var Function_150(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6975 / 26997
{
	int iVar0;
