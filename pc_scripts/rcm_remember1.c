...
void main() //Position: 0x0 / 0
{
	...
	bLocal_340 = false;
	iLocal_341 = 0;
	Local_342 = Vector(733,982f, 78,519f, 1212,414f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000004:
						if (Function_123("$/cutscene/RCM_32_CS01/RCM_32_CS01", &iLocal_326, 29489, 29461, 28174, 28067, 27811, 27774, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						Function_111("Remember1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Remember1_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_106(Global_46760[5]);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x208 / 520
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x23A / 570
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x257 / 599
{
	RELEASE_LAYOUT_REF(&iLocal_347);
	return;
}

void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x264 / 612
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x7FC / 2044
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_6() //Position: 0x99D / 2461
{
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0x9A3 / 2467
{
	if (Global_6624)
	{
		return;
...
void Function_8(bool bParam0) //Position: 0x9E2 / 2530
{
...
void Function_9() //Position: 0xA37 / 2615
{
	Function_37();
	Function_36();
	Function_36();
...
void Function_10() //Position: 0xA82 / 2690
{
...
void Function_11() //Position: 0xB88 / 2952
{
	float fVar0;
...
void Function_12() //Position: 0xBBB / 3003
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0xD4E / 3406
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0xF07 / 3847
{
	Function_15(&Global_42918, 1, 0);
	return;
}

void Function_15(struct<2317> Param0) //Position: 0xF15 / 3861
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_16() //Position: 0x1132 / 4402
{
...
struct<8> Function_17(int iParam0) //Position: 0x1147 / 4423
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_18(int iParam0, bool bParam1, bool bParam2) //Position: 0x11EE / 4590
{
	int iVar0;
...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x148A / 5258
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_20() //Position: 0x1AC8 / 6856
{
	int iVar0;
...
var Function_21(int iParam0) //Position: 0x1AD1 / 6865
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_22(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1AE2 / 6882
{
	char* cVar0[32];
...
struct<32> Function_23(char* cParam0) //Position: 0x1BD9 / 7129
{
	char* cVar0[32];
...
void Function_24(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1BF4 / 7156
{
	float fVar0;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1C5B / 7259
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_26(int iParam0, bool bParam1) //Position: 0x1C6D / 7277
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_27(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C7F / 7295
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_28(int iParam0) //Position: 0x1DB3 / 7603
{
	return Global_55480[iParam016].f_96;
}

float Function_29(int iParam0) //Position: 0x1DC2 / 7618
{
	if (!iParam0 != 4294967295)
	{
...
float Function_30(int iParam0) //Position: 0x1DFB / 7675
{
	if (iParam0 == 4294967295)
	{
...
void Function_31(int iParam0) //Position: 0x1E38 / 7736
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_32(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FD2 / 8146
{
	int iVar0;
	int iVar1;
...
int Function_33(bool bParam0) //Position: 0x2216 / 8726
{
...
struct<8> Function_34() //Position: 0x2257 / 8791
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x22E0 / 8928
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x2377 / 9079
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_37() //Position: 0x23F6 / 9206
{
...
int Function_38(int iParam0, bool bParam1, int iParam2) //Position: 0x2433 / 9267
{
	int iVar0;
	int iVar1;
...
void Function_39() //Position: 0x263F / 9791
{
	struct<2> Var0;
	var uVar2;
...
bool Function_40(char* cParam0) //Position: 0x26F6 / 9974
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_41(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x270E / 9998
{
	int iVar0;
...
struct<8> Function_42() //Position: 0x2806 / 10246
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_43(int iParam0) //Position: 0x2810 / 10256
{
...
int Function_44(bool bParam0, bool bParam1) //Position: 0x2826 / 10278
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_45(struct<2> Param0, struct<2> Param2) //Position: 0x28F2 / 10482
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_46(float fParam0, int iParam1) //Position: 0x290F / 10511
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_47(int iParam0) //Position: 0x313B / 12603
{
	var uVar0;
...
bool Function_48(var uParam0, int iParam1) //Position: 0x3176 / 12662
{
	return (uParam0 && iParam1) == 0;
}

void Function_49(var uParam0, int iParam1) //Position: 0x3183 / 12675
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3192 / 12690
{
	uParam0 = &uParam0;
...
void Function_51(bool bParam0) //Position: 0x3241 / 12865
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_52(struct<229> Param0) //Position: 0x33FB / 13307
{
	float fVar0;
	int iVar1;
...
void Function_53(struct<217> Param0) //Position: 0x34CB / 13515
{
	float fVar0;
	var uVar1;
...
int Function_54(var uParam0, int iParam1) //Position: 0x3589 / 13705
{
	int iVar0;
	var uVar1;
...
void Function_55(int iParam0, var uParam1, struct<2> Param2) //Position: 0x36F3 / 14067
{
	struct<8> Var0;
...
struct<32> Function_56(char* cParam0) //Position: 0x379B / 14235
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_57(char* cParam0) //Position: 0x3807 / 14343
{
	char* cVar0[32];
...
int Function_58(int iParam0) //Position: 0x3829 / 14377
{
	int iVar0;
	struct<2> Var1;
...
float Function_59(int iParam0, struct<2> Param1) //Position: 0x3997 / 14743
{
	struct<2> Var0;
...
struct<8> Function_60(int iParam0) //Position: 0x3A0E / 14862
{
	struct<2> Var0;
...
void Function_61(int iParam0) //Position: 0x3A7A / 14970
{
...
bool Function_62(int iParam0) //Position: 0x3AE2 / 15074
{
...
void Function_63(struct<153> Param0) //Position: 0x3AF8 / 15096
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_64(int iParam0) //Position: 0x3C67 / 15463
{
...
var Function_65(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3C93 / 15507
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_66(int iParam0) //Position: 0x3CB4 / 15540
{
...
bool Function_67(struct<249> Param0) //Position: 0x3CC9 / 15561
{
...
bool Function_68(struct<265> Param0) //Position: 0x3DF9 / 15865
{
	int iVar0;
...
bool Function_69(int iParam0) //Position: 0x3F5A / 16218
{
...
bool Function_70(int iParam0) //Position: 0x3F7E / 16254
{
...
bool Function_71(int iParam0) //Position: 0x3F93 / 16275
{
...
var Function_72(int iParam0) //Position: 0x3FAA / 16298
{
...
bool Function_73(int iParam0) //Position: 0x3FC4 / 16324
{
...
bool Function_74(int iParam0) //Position: 0x3FDA / 16346
{
	return Global_116927[iParam06].f_16;
}

bool Function_75(var uParam0, int iParam1) //Position: 0x3FEA / 16362
{
	int iVar0;
...
bool Function_76(struct<237> Param0) //Position: 0x4007 / 16391
{
	if (!Param0.f_236)
	{
		if (Function_103())
...
bool Function_77(int iParam0) //Position: 0x40D6 / 16598
{
...
bool Function_78(int iParam0) //Position: 0x4131 / 16689
{
	int iVar0;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x414D / 16717
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x416A / 16746
{
...
bool Function_81(int iParam0) //Position: 0x417F / 16767
{
...
int Function_82(int iParam0) //Position: 0x4194 / 16788
{
...
void Function_83() //Position: 0x41A9 / 16809
{
...
int Function_84(int iParam0, int iParam1) //Position: 0x4229 / 16937
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_85(int iParam0, bool bParam1) //Position: 0x4E8C / 20108
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x4ECA / 20170
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x4F19 / 20249
{
...
int Function_88(int iParam0) //Position: 0x4F2F / 20271
{
...
void Function_89() //Position: 0x4F98 / 20376
{
...
bool Function_90(int iParam0) //Position: 0x4FBD / 20413
{
	if (!Function_87(iParam0))
	{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x500E / 20494
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x503B / 20539
{
	if (!Function_87(iParam0))
	{
...
void Function_93(bool bParam0) //Position: 0x508D / 20621
{
	int iVar0;
...
void Function_94() //Position: 0x50C7 / 20679
{
	bool bVar0;
...
void Function_95(int iParam0, int iParam1) //Position: 0x5125 / 20773
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_96(int iParam0) //Position: 0x513B / 20795
{
	PRINTSTRING("Day ");
...
void Function_97(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5185 / 20869
{
	bool bVar0;
	char* cVar1[16];
...
void Function_98(char* cParam0) //Position: 0x51FA / 20986
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_99(int iParam0, var uParam1, int iParam2) //Position: 0x5234 / 21044
{
	var uVar0;
	char* cVar1[16];
...
int Function_100(char* cParam0) //Position: 0x52B0 / 21168
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_101(int iParam0) //Position: 0x5351 / 21329
{
	int iVar0;
	int iVar1;
...
bool Function_102(int iParam0, int iParam1) //Position: 0x538E / 21390
{
...
bool Function_103() //Position: 0x53A1 / 21409
{
...
int Function_104(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x53BC / 21436
{
	int iVar0;
	int iVar1;
...
void Function_105(int iParam0) //Position: 0x55E4 / 21988
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_106(int iParam0) //Position: 0x5682 / 22146
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_107(int iParam0, int iParam1) //Position: 0x5773 / 22387
{
	bool bVar0;
...
var Function_108(int iParam0) //Position: 0x57DD / 22493
{
	int iVar0;
...
void Function_109(var uParam0, int iParam1) //Position: 0x5835 / 22581
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_110(bool bParam0, bool bParam1) //Position: 0x5846 / 22598
{
	bool bVar0;
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x586B / 22635
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_112(int iParam0) //Position: 0x5900 / 22784
{
	char* cVar0[16];
...
int Function_113(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x593F / 22847
{
...
int Function_114(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x59EC / 23020
{
	char* cVar0[32];
...
int Function_115(int iParam0) //Position: 0x5C58 / 23640
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_116(var uParam0, bool bParam1) //Position: 0x5C7C / 23676
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5CA0 / 23712
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_118(var uParam0, bool bParam1) //Position: 0x5CC6 / 23750
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_119(var uParam0, bool bParam1) //Position: 0x5CED / 23789
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_120(bool bParam0) //Position: 0x5D11 / 23825
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_121() //Position: 0x5D30 / 23856
{
...
void Function_122(var uParam0, bool bParam1) //Position: 0x5D7F / 23935
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5D90 / 23952
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_124(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5E49 / 24137
{
	if (!&bParam15)
	{
...
void Function_125(var uParam0, bool bParam1) //Position: 0x64AB / 25771
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_126() //Position: 0x657A / 25978
{
	int iVar0;
...
void Function_127() //Position: 0x65F2 / 26098
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x6637 / 26167
{
...
void Function_129(var uParam0, int iParam1) //Position: 0x6649 / 26185
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_130(int iParam0) //Position: 0x66DB / 26331
{
	bool bVar0;
...
float Function_131(vector3 vParam0) //Position: 0x670C / 26380
{
...
bool Function_132(int iParam0) //Position: 0x67D9 / 26585
{
	return Function_48(iParam0, 2);
}

bool Function_133(int iParam0) //Position: 0x67E7 / 26599
{
	return Function_48(iParam0, 1);
}

int Function_134(bool bParam0) //Position: 0x67F5 / 26613
{
	bool bVar0;
	var uVar1;
...
bool Function_135() //Position: 0x68B8 / 26808
{
	bool bVar0;
	var uVar1;
...
void Function_136(int iParam0) //Position: 0x68F5 / 26869
{
	Function_137(&iParam0, 0.0f);
	return;
}

void Function_137(vector3 vParam0) //Position: 0x6902 / 26882
{
...
bool Function_138(struct<37> Param0) //Position: 0x6927 / 26919
{
	return Param0.f_36;
}

void Function_139(var uParam0, int iParam1) //Position: 0x6932 / 26930
{
	Function_140(&uParam0, &iParam1, 0);
	return;
}

void Function_140(var uParam0, bool bParam1, bool bParam2) //Position: 0x6942 / 26946
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_141(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6ABA / 27322
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_142() //Position: 0x6AE4 / 27364
{
	var uVar0;
	var uVar1;
...
void Function_143() //Position: 0x6B3F / 27455
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_144() //Position: 0x6C7E / 27774
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(667,061f, 79,04f, 1290,773f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_145() //Position: 0x6CA3 / 27811
{
...
void Function_146(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6CBF / 27839
{
	var uVar0;
...
void Function_147() //Position: 0x6D8E / 28046
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_148() //Position: 0x6DA3 / 28067
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[6443] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[6443] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(666,691f, 78,767f, 1285,013f), 179,518f, 1, 1, true);
	return 1;
}

int Function_149() //Position: 0x6E0E / 28174
{
	if (!iLocal_341)
	{
		Function_150(StackVal, Local_342, &uLocal_345);
		iLocal_341 = 1;
	}
	return 1;
}

void Function_150(vector3 vParam0) //Position: 0x6E2C / 28204
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_151(int iParam0, int iParam1) //Position: 0x6FD5 / 28629
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_152(float fParam0, float fParam1) //Position: 0x70CA / 28874
{
...
void Function_153() //Position: 0x71DB / 29147
{
...
void Function_154() //Position: 0x720F / 29199
{
...
int Function_156() //Position: 0x7331 / 29489
{
	uLocal_345 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_347, "tempcutscenevol", 2, *(&Global_99725[6443] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_159(0, 0, 1, 1, 0, 1, 1, &uLocal_345, 1, 1, 1, 1, 0x3f800000, 0);
	Function_157(StackVal, &iLocal_347, *(&Global_99725[6443] + 196), &uLocal_345, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_157(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x73AA / 29610
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_158(var uParam0, float fParam1) //Position: 0x764A / 30282
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_159(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x76CC / 30412
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_160(int iParam0) //Position: 0x797E / 31102
{
	int iVar0;
...
var Function_161() //Position: 0x79B2 / 31154
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_162(int iParam0) //Position: 0x7A40 / 31296
{
	struct<2> Var0;
...
int Function_163(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7A52 / 31314
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_164(struct<257> Param0) //Position: 0x7BDD / 31709
{
...
int Function_165(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7C19 / 31769
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_166() //Position: 0x7E81 / 32385
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_167(char* cParam0) //Position: 0x7ED5 / 32469
{
	char* cVar0[64];
...
bool Function_168(var uParam0, struct<2> Param1, float fParam3) //Position: 0x8000 / 32768
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_60(&uParam0);
...
int Function_169() //Position: 0x808C / 32908
{
	if (IS_PS3())
	{
		return 1;
...
void Function_170() //Position: 0x809B / 32923
{
	var uVar0;
	
	Function_171(4, 1);
	uVar0 = &uVar0;
	iLocal_347 = CREATE_LAYOUT("Remember_layout");
	return;
}

void Function_171(int iParam0, int iParam1) //Position: 0x80C5 / 32965
{
	switch (&iParam1)
	{
		case 0x00000000:
