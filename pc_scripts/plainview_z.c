	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x00000002:
				...
				{
					Function_252();
					Function_251(&(Global_43791[bScriptParam_0]), 32);
					iLocal_5 = 3;
					bLocal_6 = false;
				}
				break;
			...
			case 0x00000003:
				...
				if (Function_248())
				{
					Function_246(bScriptParam_0);
					if (bLocal_177)
					{
						Function_244(&iLocal_13, Function_245(), bScriptParam_0);
						Function_243(&iLocal_13, Function_245());
					}
					Function_251(&(Global_43791[bScriptParam_0]), 16);
					iLocal_5 = 4;
					bLocal_6 = false;
				}
				break;
			...
			case 0x00000007:
				if (bLocal_177)
				{
					Function_223(&iLocal_13, bScriptParam_0, Function_245());
				}
				Function_222(bScriptParam_0);
				Function_221();
				Function_220();
				Function_251(&(Global_43791[bScriptParam_0]), 8);
			...
			case 0x00000009:
				...
				Function_208(64);
				Function_251(&(Global_43791[bScriptParam_0]), 512);
				iLocal_5 = 10;
				bLocal_6 = false;
				break;
			
			case 0x0000000A:
				Function_207(Function_245(), bScriptParam_0);
				strcpy(&cVar0, "Finished Initializing ", 64);
				stradd(&cVar0, &Global_44085[bScriptParam_09] + 32, 64);
				Function_206(&cVar0, 5.0f);
				Function_251(&(Global_43791[bScriptParam_0]), 4);
				iLocal_5 = 11;
				bLocal_6 = false;
				break;
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_392, Function_87(), bScriptParam_0);
				Function_47(&uLocal_412, 0);
				break;
...
void Function_10(bool bParam0, int iParam1, int iParam2) //Position: 0x52E / 1326
{
	bool bVar0;
...
void Function_11(bool bParam0, bool bParam1, bool bParam2) //Position: 0x618 / 1560
{
	int iVar0;
...
void Function_19() //Position: 0x8F5 / 2293
{
	Function_20();
	return;
}

void Function_20() //Position: 0x8FE / 2302
{
...
void Function_21(int iParam0) //Position: 0x911 / 2321
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x939 / 2361
{
...
void Function_23(struct<13> Param0) //Position: 0xA84 / 2692
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xAA1 / 2721
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xABF / 2751
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_27(bool bParam0) //Position: 0xB95 / 2965
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xC08 / 3080
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xC25 / 3109
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xC32 / 3122
{
...
void Function_31(int iParam0) //Position: 0xF99 / 3993
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0x1000 / 4096
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x1348 / 4936
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x1628 / 5672
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D7E / 7550
{
...
int Function_36(int iParam0) //Position: 0x1D93 / 7571
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1DB5 / 7605
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1E3E / 7742
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E5E / 7774
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1ED3 / 7891
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1F0D / 7949
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F89 / 8073
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x202A / 8234
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x2067 / 8295
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x207D / 8317
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x2090 / 8336
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x20AA / 8362
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x24CB / 9419
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x24DE / 9438
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x24FB / 9467
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x250D / 9485
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x2597 / 9623
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x29EF / 10735
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_251(&(Global_43791[iParam0]), 4096);
	if (StackVal != 1)
	{
...
float Function_54(int iParam0) //Position: 0x2AE0 / 10976
{
...
float Function_55(int iParam0) //Position: 0x2B1D / 11037
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2B56 / 11094
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2BC0 / 11200
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2C18 / 11288
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2E40 / 11840
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2EDE / 11998
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x351C / 13596
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3525 / 13605
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3536 / 13622
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x362D / 13869
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3648 / 13896
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x36AF / 13999
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x36C1 / 14017
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x37F5 / 14325
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x3804 / 14340
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x399E / 14750
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3BE2 / 15330
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3BEF / 15343
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3C19 / 15385
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3ECC / 16076
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3F3F / 16191
{
...
bool Function_76(bool bParam0) //Position: 0x3F75 / 16245
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3FEB / 16363
{
...
void Function_88(struct<82> Param0) //Position: 0x41FC / 16892
{
	...
	switch (&Param0 + 376)
	{
		...
		case 0x00000008:
			...
			Function_244(&Param0, &Global_46715, bParam1);
			Function_243(&Param0, &Global_46715);
			*(&Param0 + 376) = 9;
			break;
...
int Function_98(int iParam0) //Position: 0x61A8 / 25000
{
	...
	if (SQUAD_GET_SIZE(&iParam0) > 4)
	{
		...
		Function_251(&(Global_43791[Global_43789]), 0x20000000);
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6CD2 / 27858
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x8540 / 34112
{
	int iVar0;
	int iVar1;
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA145 / 41285
{
	int iVar0;
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAF7F / 44927
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBDB8 / 48568
{
...
void Function_206(char* cParam0) //Position: 0xC083 / 49283
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC0C3 / 49347
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC1B3 / 49587
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC1C6 / 49606
{
	Function_210(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC1E4 / 49636
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC2F2 / 49906
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC300 / 49920
{
...
void Function_213() //Position: 0xC31F / 49951
{
...
void Function_214(var uParam0) //Position: 0xC33B / 49979
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC345 / 49989
{
	return;
}

void Function_216(int iParam0) //Position: 0xC34B / 49995
{
	if (((!Function_35(0) || !Function_35(1)) && Function_27(iParam0)) && !Function_217())
	{
...
bool Function_217() //Position: 0xC386 / 50054
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_218(var uParam0, int iParam1) //Position: 0xC3B3 / 50099
{
	int iVar0;
...
bool Function_219(int iParam0, int iParam1) //Position: 0xC3CD / 50125
{
	int iVar0;
...
void Function_220() //Position: 0xC3EA / 50154
{
	return;
}

void Function_221() //Position: 0xC3F0 / 50160
{
	return;
}

void Function_222(int iParam0) //Position: 0xC3F6 / 50166
{
	iParam0 = iParam0;
	return;
}

void Function_223(int iParam0, bool bParam1, int iParam2) //Position: 0xC400 / 50176
{
...
void Function_224(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC704 / 50948
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_225(var uParam0, int iParam1) //Position: 0xC910 / 51472
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_226(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC921 / 51489
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_227(var uParam0, int iParam1) //Position: 0xD008 / 53256
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_228(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xD017 / 53271
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD068 / 53352
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_230(var uParam0, bool bParam1) //Position: 0xD0B7 / 53431
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_231(var uParam0, int iParam1) //Position: 0xD0EB / 53483
{
	int iVar0;
...
var Function_232(bool bParam0, int iParam1) //Position: 0xD108 / 53512
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_233(char* cParam0) //Position: 0xD1BE / 53694
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_234(char* cParam0) //Position: 0xD22A / 53802
{
	char* cVar0[32];
...
void Function_235() //Position: 0xD24C / 53836
{
	return;
}

bool Function_236(int iParam0) //Position: 0xD252 / 53842
{
...
int Function_237(int iParam0) //Position: 0xD275 / 53877
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_238() //Position: 0xD291 / 53905
{
	return 1;
}

void Function_239(var uParam0) //Position: 0xD298 / 53912
{
	uParam0 = uParam0;
	return;
}

void Function_240() //Position: 0xD2A2 / 53922
{
	Function_241(&uLocal_9, &uLocal_392, 4, &iLocal_246 + 200, 4294967295, 4);
	Function_241(&uLocal_9, &uLocal_392, 5, &iLocal_246 + 208, 4294967295, 0x1000000);
	Function_241(&uLocal_9, &uLocal_392, 5, &iLocal_246 + 216, 4294967295, 258);
	return;
}

void Function_241(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD2DE / 53982
{
...
void Function_242(struct<5> Param0) //Position: 0xD3CB / 54219
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_243(int iParam0, int iParam1) //Position: 0xD3DC / 54236
{
	var uVar0;
	int iVar1;
...
void Function_244(int iParam0, bool bParam1, bool bParam2) //Position: 0xD452 / 54354
{
	var uVar0;
	int iVar1;
...
var Function_245() //Position: 0xD4F0 / 54512
{
	return &iLocal_178;
}

void Function_246(int iParam0) //Position: 0xD4F9 / 54521
{
	iLocal_7 = Function_247(&iLocal_178, "nplainview", iParam0);
	return;
}

int Function_247(int iParam0, var uParam1, int iParam2) //Position: 0xD516 / 54550
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_248() //Position: 0xD539 / 54585
{
	return Function_249();
}

int Function_249() //Position: 0xD542 / 54594
{
	var uVar0;
	
	Function_250(3, 3);
	uVar0 = &uVar0;
	iLocal_246 = FIND_NAMED_LAYOUT("Plainview_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_246))
	{
		iLocal_246 = CREATE_LAYOUT("Plainview_layout");
	}
	*(&iLocal_246 + 80) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_Crows_set");
	*(&iLocal_246 + 8[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder8", 4,203895E-45f, Vector(-3154,781f, 62,23264f, 3730,757f), Vector(0.0f, 116,651f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[0]);
	*(&iLocal_246 + 8[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder1", 4,203895E-45f, Vector(-3092.0f, 64,63806f, 3700f), Vector(0.0f, 20.0f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[1]);
	*(&iLocal_246 + 8[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder2", 4,203895E-45f, Vector(-3180.0f, 60,12295f, 3668f), Vector(0.0f, 20.0f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[2]);
	*(&iLocal_246 + 8[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder3", 4,203895E-45f, Vector(-3176.0f, 60,77409f, 3768f), Vector(0.0f, 20.0f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[3]);
	*(&iLocal_246 + 8[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder4", 4,203895E-45f, Vector(-3130,213f, 62,65864f, 3645,388f), Vector(0.0f, 211,15f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[4]);
	*(&iLocal_246 + 8[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder5", 4,203895E-45f, Vector(-3224,706f, 58,10864f, 3720,895f), Vector(0.0f, 230,296f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[5]);
	*(&iLocal_246 + 8[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder6", 4,203895E-45f, Vector(-3240,502f, 57,16964f, 3766,691f), Vector(0.0f, 20.0f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[6]);
	*(&iLocal_246 + 8[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder7", 4,203895E-45f, Vector(-3089,14f, 63,19264f, 3758,427f), Vector(0.0f, 41,524f, 0.0f), Vector(9,921549f, 43,9325f, 10,05155f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 80, &iLocal_246 + 8[7]);
	*(&iLocal_246 + 136) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_vultures_set");
	*(&iLocal_246 + 88[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder13", 4,203895E-45f, Vector(-3120.0f, 45,17645f, 3660f), Vector(0.0f, 20.0f, 0.0f), Vector(14,39547f, 68,32167f, 11,99445f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 136, &iLocal_246 + 88[0]);
	*(&iLocal_246 + 88[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nCylinder9", 4,203895E-45f, Vector(-3236,989f, 39,9087f, 3720f), Vector(0.0f, 20.0f, 0.0f), Vector(14,39547f, 68,32167f, 11,99445f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 136, &iLocal_246 + 88[1]);
	*(&iLocal_246 + 88[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder10", 4,203895E-45f, Vector(-3144.0f, 43,19034f, 3772f), Vector(0.0f, 20.0f, 0.0f), Vector(14,39547f, 68,32167f, 11,99445f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 136, &iLocal_246 + 88[2]);
	*(&iLocal_246 + 88[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder11", 4,203895E-45f, Vector(-3064.0f, 46,18039f, 3736.0f), Vector(0.0f, 20.0f, 0.0f), Vector(14,39547f, 68,32167f, 11,99445f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 136, &iLocal_246 + 88[3]);
	*(&iLocal_246 + 88[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder12", 4,203895E-45f, Vector(-3213,699f, 33,6055f, 3761,732f), Vector(0.0f, 20.0f, 0.0f), Vector(14,39547f, 68,32167f, 11,99445f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 136, &iLocal_246 + 88[4]);
	*(&iLocal_246 + 192) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_snakes_set");
	*(&iLocal_246 + 144[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder18", 4,203895E-45f, Vector(-3137,157f, 41,20716f, 3665,066f), Vector(0.0f, 20.0f, 0.0f), Vector(12,87659f, 27,24862f, 11,50123f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 192, &iLocal_246 + 144[0]);
	*(&iLocal_246 + 144[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder14", 4,203895E-45f, Vector(-3221,674f, 43,15674f, 3777,584f), Vector(0.0f, 20.0f, 0.0f), Vector(12,87659f, 27,24862f, 11,50123f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 192, &iLocal_246 + 144[1]);
	*(&iLocal_246 + 144[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder15", 4,203895E-45f, Vector(-3206,235f, 43,15674f, 3652,926f), Vector(0.0f, 20.0f, 0.0f), Vector(12,87659f, 27,24862f, 11,50123f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 192, &iLocal_246 + 144[2]);
	*(&iLocal_246 + 144[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder16", 4,203895E-45f, Vector(-3242,674f, 43,15674f, 3707,5f), Vector(0.0f, 20.0f, 0.0f), Vector(12,87659f, 27,24862f, 11,50123f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 192, &iLocal_246 + 144[3]);
	*(&iLocal_246 + 144[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder17", 4,203895E-45f, Vector(-3152.0f, 43,15674f, 3766,534f), Vector(0.0f, 20.0f, 0.0f), Vector(12,87659f, 27,24862f, 11,50123f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 192, &iLocal_246 + 144[4]);
	*(&iLocal_246 + 200) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_region", 4,203895E-45f, Vector(-3144,042f, 53,08625f, 3731,443f), Vector(0.0f, 90,54484f, 0.0f), Vector(62,3877f, 48,45017f, 63,32744f));
	*(&iLocal_246 + 208) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "nplnv_herd", 2,802597E-45f, Vector(-3099,294f, 51,43663f, 3735,135f), Vector(0.0f, 0.0f, 0.0f), Vector(42,58439f, 24,99685f, 34,86998f));
	*(&iLocal_246 + 216) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_Office", 2,802597E-45f, Vector(-3241,429f, 41,00087f, 3763,81f), Vector(0.0f, 0.0f, 0.0f), Vector(7,472592f, 3,316618f, 4,910101f));
	*(&iLocal_246 + 224) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_people", 2,802597E-45f, Vector(-3238,64f, 40,62006f, 3763,842f), Vector(0.0f, 0.0f, 0.0f), Vector(7,135357f, 6,270594f, 5,934124f));
	*(&iLocal_246 + 296) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_rabbits_set");
	*(&iLocal_246 + 232[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder25", 4,203895E-45f, Vector(-3224,424f, 39,48167f, 3684f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[0]);
	*(&iLocal_246 + 232[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder19", 4,203895E-45f, Vector(-3136.0f, 43,16861f, 3655,566f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[1]);
	*(&iLocal_246 + 232[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder20", 4,203895E-45f, Vector(-3116.0f, 44,17237f, 3715,336f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[2]);
	*(&iLocal_246 + 232[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder21", 4,203895E-45f, Vector(-3099,992f, 44,17328f, 3772f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[3]);
	*(&iLocal_246 + 232[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder22", 4,203895E-45f, Vector(-3154,316f, 42,25236f, 3788f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[4]);
	*(&iLocal_246 + 232[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder23", 4,203895E-45f, Vector(-3192.0f, 40,55696f, 3772f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[5]);
	*(&iLocal_246 + 232[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "Cylinder24", 4,203895E-45f, Vector(-3224,424f, 39,48167f, 3684f), Vector(0.0f, 20.0f, 0.0f), Vector(6,007527f, 8,561134f, 6,063537f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 296, &iLocal_246 + 232[6]);
	*(&iLocal_246 + 304) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_armwrestling", 2,802597E-45f, Vector(-3143,779f, 44,30478f, 3720,552f), Vector(0.0f, 0.0f, 0.0f), Vector(9,637772f, 9,083694f, 9,869506f));
	*(&iLocal_246 + 312) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_cards", 2,802597E-45f, Vector(-3218,809f, 41,73452f, 3748,741f), Vector(0.0f, -31,74342f, 0.0f), Vector(7,622405f, 7,622405f, 7,622405f));
	*(&iLocal_246 + 360) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_fires_set");
	*(&iLocal_246 + 320[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_camp_01", 4,203895E-45f, Vector(-3196,637f, 40,88158f, 3745,956f), Vector(0.0f, 82,77209f, 0.0f), Vector(5,489922f, 5,489922f, 9,348227f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 360, &iLocal_246 + 320[0]);
	*(&iLocal_246 + 320[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_camp_02", 4,203895E-45f, Vector(-3190,443f, 40,88158f, 3749,877f), Vector(0.0f, 30,98936f, 0.0f), Vector(5,381675f, 5,381675f, 9,163904f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 360, &iLocal_246 + 320[1]);
	*(&iLocal_246 + 320[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_camp_03", 4,203895E-45f, Vector(-3194,222f, 40,88158f, 3772,641f), Vector(0.0f, 30,98936f, 0.0f), Vector(8,604525f, 4,506968f, 7,674454f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 360, &iLocal_246 + 320[2]);
	*(&iLocal_246 + 320[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_camp_04", 4,203895E-45f, Vector(-3181,984f, 40,88158f, 3720,101f), Vector(0.0f, 46,805f, 0.0f), Vector(6,547194f, 4,506968f, 14,19947f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 360, &iLocal_246 + 320[3]);
	*(&iLocal_246 + 408) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_246, "plnv_workers_set");
	*(&iLocal_246 + 368[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_workers01", 4,203895E-45f, Vector(-3127,701f, 46,36782f, 3641,51f), Vector(0.0f, -9,594697f, 0.0f), Vector(14,40249f, 15,81141f, 15,07511f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 408, &iLocal_246 + 368[0]);
	*(&iLocal_246 + 368[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_workers02", 4,203895E-45f, Vector(-3090,964f, 49,13192f, 3755,671f), Vector(0.0f, 52,7761f, 0.0f), Vector(17,20536f, 19,68517f, 17,51938f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 408, &iLocal_246 + 368[1]);
	*(&iLocal_246 + 368[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_workers03", 4,203895E-45f, Vector(-3153,939f, 46,53284f, 3733,473f), Vector(0.0f, 52,7761f, 0.0f), Vector(14,13749f, 21,26913f, 14,38251f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 408, &iLocal_246 + 368[2]);
	*(&iLocal_246 + 368[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_workers04", 4,203895E-45f, Vector(-3222,176f, 48,12009f, 3719,34f), Vector(0.0f, -46,68447f, 0.0f), Vector(11,99182f, 17,37822f, 15,61937f));
	ADD_TO_VOLUME_SET(&iLocal_246 + 408, &iLocal_246 + 368[3]);
	*(&iLocal_246 + 416) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_246, "plnv_players_room", 2,802597E-45f, Vector(-3198,89f, 41,73452f, 3752,622f), Vector(0.0f, -6,677323f, 0.0f), Vector(5,512986f, 5,512986f, 5,512986f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "plnf_report_crime_road", Vector(-3283,096f, 34,949f, 3815,075f), Vector(0.0f, 131,508f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "plnf_report_crime_road1", Vector(-3208,801f, 39,439f, 3661,792f), Vector(0.0f, 66,075f, 0.0f));
	*(&iLocal_246 + 424) = Vector(-3240,401f, 39,70732f, 3763,838f);
	*(&iLocal_246 + 424 + 12) = Vector(0.0f, -87,86558f, 0.0f);
	*(&iLocal_246 + 448) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "plnf_interiorPoint_01", Vector(-3240,401f, 39,70732f, 3763,838f), Vector(0.0f, -87,86558f, 0.0f));
	*(&iLocal_246 + 456) = Vector(-3123,854f, 47,702f, 3785,719f);
	*(&iLocal_246 + 456 + 12) = Vector(-2,573f, 24,035f, 0.0f);
	*(&iLocal_246 + 480) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos1", Vector(-3123,854f, 47,702f, 3785,719f), Vector(-2,573f, 24,035f, 0.0f));
	*(&iLocal_246 + 488) = Vector(-3121,945f, 48,736f, 3685,073f);
	*(&iLocal_246 + 488 + 12) = Vector(-2,381f, 121,394f, 0.0f);
	*(&iLocal_246 + 512) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos2", Vector(-3121,945f, 48,736f, 3685,073f), Vector(-2,381f, 121,394f, 0.0f));
	*(&iLocal_246 + 520) = Vector(-3223,12f, 60,904f, 3719,14f);
	*(&iLocal_246 + 520 + 12) = Vector(-14,127f, -81,633f, 0.0f);
	*(&iLocal_246 + 544) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos3", Vector(-3223,12f, 60,904f, 3719,14f), Vector(-14,127f, -81,633f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos4", Vector(-3269,953f, 47,761f, 3728,823f), Vector(-0,767f, -83,208f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos5", Vector(-3216,574f, 46,457f, 3703,953f), Vector(-2,011f, -101,443f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos6", Vector(-3069,177f, 45,937f, 3782,552f), Vector(13,119f, 65,152f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos7", Vector(-3158,676f, 47,483f, 3794,831f), Vector(2,197f, -15,757f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos8", Vector(-3106,123f, 47,702f, 3779,877f), Vector(9,557f, -16,294f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos9", Vector(-3230,89f, 42,915f, 3724,238f), Vector(1,898f, -88,815f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "pln_vista_cam_pos10", Vector(-3090,24f, 48,82f, 3762,232f), Vector(-0,059f, 61,565f, 0.0f));
	*(&iLocal_246 + 552) = Vector(-3240,766f, 39,70732f, 3764,216f);
	*(&iLocal_246 + 552 + 12) = Vector(0.0f, -80,08377f, 0.0f);
	*(&iLocal_246 + 576) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_246, "plnf_interiorSettlement01", Vector(-3240,766f, 39,70732f, 3764,216f), Vector(0.0f, -80,08377f, 0.0f));
	return 1;
}

void Function_250(int iParam0, int iParam1) //Position: 0xE706 / 59142
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_251(var uParam0, int iParam1) //Position: 0xE750 / 59216
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_252() //Position: 0xE761 / 59233
{
	return;
}

bool Function_253() //Position: 0xE767 / 59239
{
	return 1;
}

void Function_254() //Position: 0xE76E / 59246
{
...
bool Function_255() //Position: 0xE835 / 59445
{
	return Function_256();
}

int Function_256() //Position: 0xE83E / 59454
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("Plainview_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("Plainview_layout");
	}
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-3153,742f, 53,422f, 3733,308f), Vector(0.0f, 0,5057631f, 0.0f), Vector(7,097221f, 24,87401f, 11,87461f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-3090,664f, 55,31773f, 3757,533f), Vector(0.0f, 0,5057631f, 0.0f), Vector(8,243246f, 24,87401f, 16,81211f));
	*(&iLocal_178 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-3223,411f, 50,2218f, 3719,801f), Vector(0.0f, -35,08574f, 0.0f), Vector(7,097221f, 24,87401f, 11,87461f));
	*(&iLocal_178 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-3155,743f, 46,61566f, 3733,325f), Vector(0.0f, 0,5057631f, 0.0f), Vector(10,83476f, 9,04815f, 13,55095f));
	*(&iLocal_178 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_2", 2,802597E-45f, Vector(-3095,102f, 46,61566f, 3754,769f), Vector(0.0f, 0,5057631f, 0.0f), Vector(14,05344f, 9,04815f, 14,75557f));
	*(&iLocal_178 + 120) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_3", 2,802597E-45f, Vector(-3225,392f, 41,24699f, 3718,563f), Vector(0.0f, -35,24025f, 0.0f), Vector(12,02529f, 6,665389f, 12,38117f));
	*(&iLocal_178 + 128) = Vector(-3194,146f, 41,28f, 3756,203f);
	*(&iLocal_178 + 128 + 12) = Vector(0.0f, 267,076f, 0.0f);
	*(&iLocal_178 + 152) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-3194,146f, 41,28f, 3756,203f), Vector(0.0f, 267,076f, 0.0f));
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-3092,265f, 61,04901f, 3755,374f), Vector(0.0f, 77,36301f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 160);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-3219,804f, 54,8824f, 3718,472f), Vector(0.0f, 275.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 160);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-3156,017f, 57,95736f, 3729,769f), Vector(0.0f, 61,64761f, 0.0f));
	DECOR_SET_BOOL(&uVar3, "Core", true);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-3155,831f, 57,95736f, 3731,157f), Vector(0.0f, 360,8339f, 0.0f));
	DECOR_SET_BOOL(&uVar4, "Core", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 168);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-3155,857f, 57,95736f, 3729,757f), Vector(0.0f, 181,1992f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", true);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 168);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-3092,265f, 61,04901f, 3755,374f), Vector(0.0f, -89,93298f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 168);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-3090,865f, 61,04901f, 3755,373f), Vector(0.0f, 90,45357f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 168);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-3220,246f, 54,8824f, 3718,048f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 168);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-3220,245f, 54,8824f, 3719,448f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 168);
	*(&iLocal_178 + 176) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-3155,713f, 57,95736f, 3733,747f), Vector(0.0f, 111,4807f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 176);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-3219,804f, 54,8824f, 3718,472f), Vector(0.0f, 275.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 176);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04_core", Vector(-3156,017f, 57,95736f, 3729,769f), Vector(0.0f, 61,64761f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", true);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 176);
	*(&iLocal_178 + 184) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_player", Vector(-3154,313f, 57,95736f, 3733,747f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 184);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_surv", Vector(-3155,713f, 57,95736f, 3733,747f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 184);
	*(&iLocal_178 + 192) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-3236,277f, 39,71345f, 3762,394f), Vector(0.0f, 210,5916f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 192);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-3236,553f, 39,71345f, 3764,841f), Vector(0.0f, -90.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 192);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-3092,557f, 61,04901f, 3751,304f), Vector(0.0f, -269,4809f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 192);
	*(&iLocal_178 + 200) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-3238,708f, 39,71345f, 3762,008f), Vector(0.0f, -226,2283f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 200);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-3197,056f, 41,16077f, 3737,394f), Vector(0.0f, -121,8663f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 200);
	*(&iLocal_178 + 208) = Vector(-3195,612f, 41,29269f, 3752,929f);
	*(&iLocal_178 + 208 + 12) = Vector(0.0f, -97,31544f, 0.0f);
	*(&iLocal_178 + 232) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-3195,612f, 41,29269f, 3752,929f), Vector(0.0f, -97,31544f, 0.0f));
	*(&iLocal_178 + 240) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl", "DLC_survivor_low_wall_rfl", Vector(-3236,496f, 39,71345f, 3764,843f), Vector(0.0f, 90,10542f, 0.0f));
	*(&iLocal_178 + 248) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand1", "rand_idle_stand", Vector(-3236,3f, 39,71345f, 3762,359f), Vector(0.0f, 211,3991f, 0.0f));
	*(&iLocal_178 + 256) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-3092,589f, 61,05261f, 3751,304f), Vector(0.0f, 450,4194f, 0.0f));
	*(&iLocal_178 + 264) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZP_player_sleep_on_ground", "ZombiePack_player_sleep_ground", Vector(-3197,932f, 41,27335f, 3753,694f), Vector(0.0f, -99,17616f, 0.0f));
	return 1;
}

void Function_257(bool bParam0, bool bParam1) //Position: 0xF439 / 62521
{
	var uVar0;
...
void Function_258(int iParam0, bool bParam1, bool bParam2) //Position: 0xF4D4 / 62676
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_259(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xF5E0 / 62944
{
	int iVar0;
...
bool Function_260(int iParam0) //Position: 0xF6BC / 63164
{
...
int Function_261(int iParam0) //Position: 0xF737 / 63287
{
...
bool Function_262(int iParam0) //Position: 0xF74C / 63308
{
...
int Function_263(int iParam0) //Position: 0xF7B2 / 63410
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_264(int iParam0, int iParam1) //Position: 0xF874 / 63604
{
	int iVar0;
...
void Function_265() //Position: 0xF891 / 63633
{
	ALLOW_TUMBLEWEEDS(1);
	return;
}

void Function_266(char* cParam0) //Position: 0xF89B / 63643
{
	if (!Function_26(128))
	{
		return;
