...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_47 + 2140) = Vector(564,206f, 92,859f, 1166,414f);
...
void Function_1() //Position: 0x23A / 570
{
	struct<45> Var0;
...
void Function_2(int iParam0, int iParam1) //Position: 0x8C1 / 2241
{
	INIT_NATIVE_WEAPONENUM_AMMO(iParam0, &iParam1);
	return;
}

void Function_3(int iParam0, var uParam1, int iParam2) //Position: 0x8CF / 2255
{
	int iVar0;
	...
	if (!StackVal != Global_26182)
	{
		...
		Function_4(Global_26182, &iVar0, 1);
	}
	return;
}

void Function_4(int iParam0, int iParam1, bool bParam2) //Position: 0x9B9 / 2489
{
	int iVar0;
...
void Function_5() //Position: 0xB38 / 2872
{
	Global_26174.f_20 = 0.0f;
	return;
}

void Function_6(int iParam0) //Position: 0xB44 / 2884
{
	PRINTSTRING("Day ");
...
void Function_7(int iParam0) //Position: 0xB8E / 2958
{
	switch (iParam0)
	{
		case 0x00000000:
...
var Function_8() //Position: 0xBD4 / 3028
{
...
void Function_9() //Position: 0xBE9 / 3049
{
...
void Function_10() //Position: 0xC1A / 3098
{
	Function_11();
	return;
}

void Function_11() //Position: 0xC23 / 3107
{
...
void Function_12(int iParam0, bool bParam1, int iParam2) //Position: 0xD2C / 3372
{
	iParam2 = &iParam2;
	if (bParam1)
	{
...
void Function_13(var uParam0, int iParam1) //Position: 0xD58 / 3416
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_14(var uParam0, int iParam1) //Position: 0xD6E / 3438
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_15() //Position: 0xD7F / 3455
{
	int iVar0;
...
int Function_16(int iParam0) //Position: 0xD9B / 3483
{
	var uVar0;
...
var Function_17() //Position: 0xDEE / 3566
{
...
void Function_18(int iParam0) //Position: 0xE20 / 3616
{
	int iVar0;
...
void Function_19(struct<2>[] Param0, int iParam1) //Position: 0xE48 / 3656
{
...
void Function_20(struct<13> Param0) //Position: 0xF93 / 3987
{
	int iVar0;
...
bool Function_21(struct<13> Param0) //Position: 0xFB0 / 4016
{
	int iVar0;
...
void Function_22(int iParam0, int iParam1, int iParam2) //Position: 0xFCE / 4046
{
...
void Function_23(var uParam0, var uParam1, int iParam2) //Position: 0x1167 / 4455
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_24(bool bParam0, int iParam1, int iParam2) //Position: 0x12E2 / 4834
{
	var uVar0;
...
int Function_25(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x12F4 / 4852
{
	char* cVar0[32];
...
bool Function_26(bool bParam0, int iParam1, bool bParam2) //Position: 0x135C / 4956
{
	char* cVar0[64];
	int iVar16;
...
var Function_27(int iParam0) //Position: 0x13DF / 5087
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_28(bool bParam0) //Position: 0x16F8 / 5880
{
	char* cVar0[64];
...
void Function_29(bool bParam0) //Position: 0x1799 / 6041
{
...
void Function_30() //Position: 0x17B4 / 6068
{
	Function_12(32768, 1, 0);
	return;
}

int Function_31() //Position: 0x17C3 / 6083
{
	int iVar0;
	int iVar1;
...
void Function_32(var uParam0, int iParam1) //Position: 0x17E6 / 6118
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_33(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x1B2B / 6955
{
	float fVar0;
...
var Function_34(var uParam0, int iParam1, int iParam2) //Position: 0x1B86 / 7046
{
	int iVar0;
...
var Function_35(bool bParam0) //Position: 0x1BA5 / 7077
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_36(int iParam0) //Position: 0x1BB1 / 7089
{
...
int Function_37(var uParam0, int iParam1, int iParam2) //Position: 0x1BD2 / 7122
{
	var uVar0;
	int iVar1;
...
int Function_38(int iParam0, var uParam1, int iParam2) //Position: 0x1C2D / 7213
{
	var uVar0;
	int iVar1;
	var uVar2;
...
int Function_39(int iParam0, bool bParam1) //Position: 0x1C76 / 7286
{
	int iVar0;
...
void Function_40(int iParam0, var uParam1, int iParam2) //Position: 0x1C9D / 7325
{
	float fVar0;
...
var Function_41(int iParam0) //Position: 0x1CD1 / 7377
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
int Function_42(float fParam0) //Position: 0x1CF2 / 7410
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_43() //Position: 0x1D2F / 7471
{
	if (!Function_44())
	{
		return 4294967295;
...
bool Function_44() //Position: 0x1D44 / 7492
{
	return UNK_0xA80C6DE6(&Global_123099);
}

void Function_45(char* cParam0, int iParam1) //Position: 0x1D51 / 7505
{
	struct<13> Var0;
	...
	if (Var0 >= 0)
	{
		...
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(cParam0, UI_GET_STRING("GENERIC_DBUFFER32_0"));
	}
	else
	{
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(cParam0, UI_GET_STRING("GENERIC_DBUFFER10_2"));
	}
	return;
}

struct<8> Function_46(int iParam0) //Position: 0x1F7E / 8062
{
	struct<2> Var0;
	int iVar2;
...
var Function_47(vector3 vParam0) //Position: 0x1FED / 8173
{
...
void Function_48() //Position: 0x20C3 / 8387
{
	if (!Function_49())
	{
	}
...
bool Function_49() //Position: 0x20D0 / 8400
{
	return NET_IS_IN_SESSION();
}

bool Function_50(int iParam0) //Position: 0x20D9 / 8409
{
	return Function_108(iParam0, 2);
}

bool Function_51(int iParam0) //Position: 0x20E7 / 8423
{
	return Function_108(iParam0, 1);
}

void Function_52(int iParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x20F5 / 8437
{
	if (&iParam2 != 0)
	{
...
var Function_53(int iParam0) //Position: 0x214A / 8522
{
	iParam0 = (iParam0 - 1);
	return iParam0 + 1;
}

int Function_54(int iParam0) //Position: 0x2160 / 8544
{
	return Function_55(0, iParam0);
}

int Function_55(int iParam0, bool bParam1) //Position: 0x216C / 8556
{
	char* cVar0[64];
...
int Function_56(int iParam0) //Position: 0x21D3 / 8659
{
	return (*&Global_122919 + 200)[iParam0];
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x21E3 / 8675
{
	char* cVar0[64];
...
int Function_58(int iParam0) //Position: 0x2252 / 8786
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_59(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x226C / 8812
{
	int iVar0;
	int iVar1;
...
void Function_60(char* cParam0, bool bParam1) //Position: 0x22FC / 8956
{
	if (Function_102(4))
	{
...
void Function_61(bool bParam0, int iParam1, var uParam2) //Position: 0x232F / 9007
{
	if (bParam0)
	{
		if (Function_103())
...
int Function_62() //Position: 0x2351 / 9041
{
	if (!Function_65(1))
	{
		return 0;
...
void Function_63() //Position: 0x23E0 / 9184
{
...
var Function_64() //Position: 0x241D / 9245
{
	int iVar0;
...
bool Function_65(bool bParam0) //Position: 0x2426 / 9254
{
	char* cVar0[64];
...
void Function_66(bool bParam0) //Position: 0x24A8 / 9384
{
...
struct<64> Function_67(int iParam0) //Position: 0x2533 / 9523
{
...
int Function_69(int iParam0, int iParam1) //Position: 0x258E / 9614
{
...
void Function_70() //Position: 0x25C7 / 9671
{
...
bool Function_71(int iParam0) //Position: 0x2601 / 9729
{
	return Function_108(StackVal, iParam0);
}

void Function_72() //Position: 0x2615 / 9749
{
	if (IS_LAYOUTREF_VALID(&Local_47 + 2016))
	{
		DESTROY_LAYOUT(&Local_47 + 2016);
...
void Function_73(int iParam0) //Position: 0x263B / 9787
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_90(StackVal, 13051, *(&Local_47 + 2140), 1, &iParam0);
	bVar1 = true;
	if (IS_LOCAL_PLAYER_VALID(0))
	{
	...
	while (iVar0 <= Local_47.f_2008)
	{
		...
		Function_76(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_47[iVar050]), Vector(fVar8, fVar7, Var3) + Vector(Vector(0.0f, 2,725f, 0.0f), *(&Local_47[iVar050] + 360), &Local_47[iVar050] + 352), 1, 11293, 0, iVar5, iVar0, "", iVar6);
		if (Function_75(&Local_47[iVar050] + 384))
		{
			Function_76(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_47[iVar050] + 56, Vector(fVar8, fVar7, Var3) + Vector(Vector(0.0f, 2,25f, 0.0f), *(&Local_47[iVar050] + 360), &Local_47[iVar050] + 352), Local_47[iVar050].f_372, 10490, 0, iVar5, iVar0, "", iVar6);
		}
		else
		{
			Function_80(&Local_47[iVar050] + 56);
...
var Function_74(int iParam0, int iParam1) //Position: 0x28FA / 10490
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_47[iParam150] + 112)[iParam0 + 1]);
}

bool Function_75(float fParam0) //Position: 0x2911 / 10513
{
	bool bVar0;
	float fVar1;
...
void Function_76(struct<53> Param0) //Position: 0x295B / 10587
{
	float fVar0;
	struct<2> Var1;
	float fVar3;
	...
	if (!HUD_IS_FADED())
	{
		...
		*(&Param0 + 28) = Var5;
		...
		{
			uVar11 = Function_77(Param0.f_44);
			SET_OBJECT_POSITION(&Param0, Var1);
			if (!SET_OBJECT_ORIENTATION(StackVal, &Param0, Vector(0.0f, uVar11, 0.0f)))
			{
			}
			if (&iParam14 >= 4294967295)
			{
				SET_OBJECT_POSITION(Vector(StackVal, StackVal, StackVal) + Vector(Var9, Var1, &Param0 + 8));
				if (!SET_OBJECT_ORIENTATION(StackVal, &Param0 + 8, Vector(0.0f, uVar11, 0.0f)))
				{
				}
			}
		}
...
var Function_77(float fParam0) //Position: 0x2C0F / 11279
{
	return (fParam0 * 57,29578f);
}

int Function_78(var uParam0, int iParam1) //Position: 0x2C1D / 11293
{
	uParam0 = uParam0;
	return Function_81(Local_47[iParam150].f_344, 1);
}

void Function_79(int iParam0, int iParam1) //Position: 0x2C34 / 11316
{
...
void Function_80(int iParam0) //Position: 0x2C5D / 11357
{
...
int Function_81(int iParam0, bool bParam1) //Position: 0x2C89 / 11401
{
	if (&bParam1)
	{
		switch (iParam0)
...
var Function_82(int iParam0) //Position: 0x2FFD / 12285
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_83(int iParam0) //Position: 0x3094 / 12436
{
	Function_84(&Global_131807 + 1308, iParam0);
	return;
}

void Function_84(var uParam0, int iParam1) //Position: 0x30A6 / 12454
{
	Function_14(&uParam0, iParam1);
	return;
}

void Function_85(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x30B4 / 12468
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_86(int iParam0) //Position: 0x313F / 12607
{
	char* cVar0[16];
...
bool Function_87() //Position: 0x317E / 12670
{
...
bool Function_88(int iParam0) //Position: 0x3199 / 12697
{
	return Function_89(Global_131807.f_1308, iParam0);
}

int Function_89(var uParam0, int iParam1) //Position: 0x31AB / 12715
{
	return (uParam0 && iParam1) == 0;
}

void Function_90(var uParam0, struct<2> Param1, var uParam3, var uParam4) //Position: 0x31B8 / 12728
{
	...
	Function_91(StackVal, StackVal, StackVal, Vector(&Local_15, StackVal, StackVal) + Vector(Vector(0.0f, 2,45f, 0.0f), Param1, &Local_15 + 120), 1, 12950, 1, 125, 0, 0, 0);
...
void Function_91(var uParam0, var uParam1, struct<2> Param2, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) //Position: 0x3244 / 12868
{
	struct<2> Var0;
	var uVar2;
...
var Function_92(int iParam0, var uParam1) //Position: 0x3296 / 12950
{
	char* cVar0[64];
...
var Function_93() //Position: 0x32FB / 13051
{
	int iVar0;
...
void Function_94(var uParam0, int iParam1) //Position: 0x3379 / 13177
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	{
		SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(&iVar2), iParam1);
...
var Function_95(var uParam0, var uParam1) //Position: 0x33D3 / 13267
{
	uParam1 = uParam1;
	uParam0 = uParam0;
...
bool Function_96(bool bParam0, bool bParam1) //Position: 0x33F2 / 13298
{
	int iVar0;
...
int Function_97() //Position: 0x3413 / 13331
{
	if (Function_100(16))
	{
	}
...
void Function_98(int iParam0) //Position: 0x3431 / 13361
{
...
void Function_99(var uParam0, int iParam1) //Position: 0x346B / 13419
{
	Function_13(&uParam0, iParam1);
	return;
}

bool Function_100(int iParam0) //Position: 0x3479 / 13433
{
	return Function_89(Global_124154, iParam0);
}

bool Function_101(int iParam0) //Position: 0x3488 / 13448
{
	return Function_108((&Global_131396 + 256)->f_108, iParam0);
}

bool Function_102(int iParam0) //Position: 0x349C / 13468
{
	return Function_108(Global_120031.f_260, iParam0);
}

bool Function_103() //Position: 0x34AE / 13486
{
	return Function_102(32768);
}

void Function_104(int iParam0, float fParam1, int iParam2) //Position: 0x34BB / 13499
{
	Function_105(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_105(int iParam0, int iParam1) //Position: 0x34D1 / 13521
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_106(int iParam0, int iParam1, bool bParam2) //Position: 0x34F3 / 13555
{
	Function_107(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

void Function_107(int iParam0, int iParam1) //Position: 0x3508 / 13576
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
bool Function_108(var uParam0, int iParam1) //Position: 0x352A / 13610
{
	return (uParam0 && iParam1) == 0;
}

void Function_109(int iParam0) //Position: 0x3537 / 13623
{
	Function_110(8, iParam0);
	return;
}

void Function_110(int iParam0, bool bParam1) //Position: 0x3544 / 13636
{
	if (bParam1)
	{
...
void Function_111(var uParam0, var uParam1, float fParam2) //Position: 0x356E / 13678
{
	struct<2> Var0[5];
...
void Function_112(struct<2>[] Param0) //Position: 0x3634 / 13876
{
	bool bVar1;
	bool bVar2;
...
void Function_113(struct<345> Param0) //Position: 0x38A5 / 14501
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
var Function_114(bool bParam0, float fParam1, int iParam2) //Position: 0x3A48 / 14920
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_115(float fParam0) //Position: 0x3B3A / 15162
{
	return (fParam0 * 0,01745329f);
}

var Function_116(var uParam0, struct<2> Param1, bool bParam3) //Position: 0x3B48 / 15176
{
	var uVar0;
	struct<2> Var2;
	struct<2> Var4;
...
var Function_117() //Position: 0x3BB9 / 15289
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_118(float fParam0, struct<2> Param1, var[] uParam3, float fParam4) //Position: 0x3BE0 / 15328
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_119(bool bParam0, float fParam1, int iParam2, int iParam3) //Position: 0x3CDF / 15583
{
...
bool Function_120(int iParam0) //Position: 0x3E7E / 15998
{
...
bool Function_121(bool bParam0, int iParam1) //Position: 0x3E90 / 16016
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<116> Function_122(int iParam0, int iParam1) //Position: 0x3EEF / 16111
{
	struct<29> Var0;
...
int Function_156(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x4D1E / 19742
{
	bool bVar0;
	char* cVar1;
