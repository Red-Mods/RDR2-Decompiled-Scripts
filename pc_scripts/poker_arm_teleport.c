...
void main() //Position: 0x0 / 0
{
	...
	SET_TIME_OF_DAY(MAKE_TIME_OF_DAY(21, false, 0));
	Var0 = Vector(-2160,051f, 16,874f, 2597,944f);
	bVar2 = 313,028f;
	CAMERA_RESET(0);
	...
	CAMERA_RESET(0);
	Function_4(1, 0, 1);
	while ((!Function_1(Global_46760[0]) || !STREAMING_IS_WORLD_LOADED()) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	if (HUD_IS_FADED())
