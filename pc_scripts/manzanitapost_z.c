...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_410, Function_87(), bScriptParam_0);
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_410);
...
void Function_19() //Position: 0x91E / 2334
{
	Function_20();
	return;
}

void Function_20() //Position: 0x927 / 2343
{
...
void Function_21(int iParam0) //Position: 0x93A / 2362
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x962 / 2402
{
...
void Function_23(struct<13> Param0) //Position: 0xAAD / 2733
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xACA / 2762
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xAE8 / 2792
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_26(int iParam0) //Position: 0xBA2 / 2978
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xBBE / 3006
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xC31 / 3121
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xC4E / 3150
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xC5B / 3163
{
...
void Function_31(int iParam0) //Position: 0xFC2 / 4034
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0x1029 / 4137
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x1371 / 4977
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x1651 / 5713
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1DA7 / 7591
{
...
int Function_36(int iParam0) //Position: 0x1DBC / 7612
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1DDE / 7646
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1E67 / 7783
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E87 / 7815
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1EFC / 7932
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1F36 / 7990
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1FB2 / 8114
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x2053 / 8275
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x2090 / 8336
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x20A6 / 8358
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x20B9 / 8377
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x20D3 / 8403
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x24F4 / 9460
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x2507 / 9479
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x2524 / 9508
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x2536 / 9526
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x25C0 / 9664
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x2A18 / 10776
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2B09 / 11017
{
...
float Function_55(int iParam0) //Position: 0x2B46 / 11078
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2B7F / 11135
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2BE9 / 11241
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2C41 / 11329
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2E69 / 11881
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2F07 / 12039
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x3545 / 13637
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x354E / 13646
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x355F / 13663
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x3656 / 13910
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3671 / 13937
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x36D8 / 14040
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x36EA / 14058
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x381E / 14366
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x382D / 14381
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x39C7 / 14791
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3C0B / 15371
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3C18 / 15384
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3C42 / 15426
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3EF5 / 16117
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3F68 / 16232
{
...
bool Function_76(bool bParam0) //Position: 0x3F9E / 16286
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x4015 / 16405
{
...
bool Function_78() //Position: 0x4026 / 16422
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x403F / 16447
{
...
bool Function_80(int iParam0) //Position: 0x4055 / 16469
{
...
bool Function_81(int iParam0) //Position: 0x406A / 16490
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4088 / 16520
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x4137 / 16695
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x414A / 16714
{
	int iVar0;
	bool bVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x41C4 / 16836
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x41ED / 16877
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x420D / 16909
{
...
void Function_88(struct<82> Param0) //Position: 0x4222 / 16930
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x575B / 22363
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x5958 / 22872
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5B42 / 23362
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5F71 / 24433
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x60F7 / 24823
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x6151 / 24913
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x618B / 24971
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x61BF / 25023
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x61CE / 25038
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_99(int iParam0) //Position: 0x6425 / 25637
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x647C / 25724
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x64F3 / 25843
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x655F / 25951
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x66D0 / 26320
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x69CA / 27082
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x6A58 / 27224
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6AC1 / 27329
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6B52 / 27474
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6BE3 / 27619
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6C79 / 27769
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6CB4 / 27828
{
	bool bVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6CF8 / 27896
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6E3C / 28220
{
...
void Function_113() //Position: 0x6E4E / 28238
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6E63 / 28259
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x716B / 29035
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x7439 / 29753
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x74FD / 29949
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x790A / 30986
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x7955 / 31061
{
...
void Function_120() //Position: 0x7A5B / 31323
{
	float fVar0;
...
void Function_121() //Position: 0x7A8E / 31374
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7C21 / 31777
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7DDA / 32218
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7DE8 / 32232
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x8006 / 32774
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x80AD / 32941
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x8349 / 33609
{
...
struct<8> Function_128() //Position: 0x838A / 33674
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x8413 / 33811
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x84AA / 33962
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x8529 / 34089
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x8566 / 34150
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x8772 / 34674
{
...
bool Function_134(int iParam0) //Position: 0x878C / 34700
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x87A2 / 34722
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x880E / 34830
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x890E / 35086
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x8966 / 35174
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8B20 / 35616
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8B42 / 35650
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8B60 / 35680
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8B73 / 35699
{
...
var Function_143(int iParam0) //Position: 0x8DC1 / 36289
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8DCD / 36301
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8DDF / 36319
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8DF7 / 36343
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x920D / 37389
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x9302 / 37634
{
...
bool Function_149() //Position: 0x93C6 / 37830
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x93DD / 37853
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x93E9 / 37865
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x93F8 / 37880
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x9483 / 38019
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x94C2 / 38082
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x94DD / 38109
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x9572 / 38258
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x965A / 38490
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x981B / 38939
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9B85 / 39813
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9BA9 / 39849
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9EC8 / 40648
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA16B / 41323
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA1C4 / 41412
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA238 / 41528
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA5FA / 42490
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA63A / 42554
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA668 / 42600
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA67B / 42619
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA6BD / 42685
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA6FB / 42747
{
	int iVar0;
...
bool Function_171() //Position: 0xA7CA / 42954
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA8C3 / 43203
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAB25 / 43813
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, int iParam1, bool bParam2) //Position: 0xAFA5 / 44965
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xB037 / 45111
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB341 / 45889
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB37D / 45949
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB45B / 46171
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB4AA / 46250
{
	bool bVar0;
...
void Function_182() //Position: 0xB4EF / 46319
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB53D / 46397
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB550 / 46416
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB57D / 46461
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB67E / 46718
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB6D5 / 46805
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB727 / 46887
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB766 / 46950
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB831 / 47153
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB90B / 47371
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB96A / 47466
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBAAD / 47789
{
...
void Function_194() //Position: 0xBC33 / 48179
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBC9F / 48287
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBDDE / 48606
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBE02 / 48642
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBE13 / 48659
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBE51 / 48721
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBE68 / 48744
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBEC6 / 48838
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xC02D / 49197
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xC06B / 49259
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xC080 / 49280
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xC0A0 / 49312
{
	iParam0 = iParam0;
	return;
}

void Function_206(char* cParam0) //Position: 0xC0AA / 49322
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC0EA / 49386
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC1DA / 49626
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC1ED / 49645
{
	Function_210(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC20B / 49675
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC319 / 49945
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC327 / 49959
{
...
void Function_213() //Position: 0xC346 / 49990
{
...
void Function_214(var uParam0) //Position: 0xC362 / 50018
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC36C / 50028
{
	return;
}

void Function_216(int iParam0) //Position: 0xC372 / 50034
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC37C / 50044
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC396 / 50070
{
	int iVar0;
...
void Function_219() //Position: 0xC3B3 / 50099
{
	return;
}

void Function_220() //Position: 0xC3B9 / 50105
{
	return;
}

void Function_221(int iParam0) //Position: 0xC3BF / 50111
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC3C9 / 50121
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC6CD / 50893
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC8D9 / 51417
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC8EA / 51434
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCFD1 / 53201
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCFE0 / 53216
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xD031 / 53297
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD080 / 53376
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD0B4 / 53428
{
	int iVar0;
...
var Function_231(int iParam0, int iParam1) //Position: 0xD0D1 / 53457
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD187 / 53639
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD1F3 / 53747
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD215 / 53781
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD21B / 53787
{
...
int Function_236(int iParam0) //Position: 0xD23E / 53822
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD25A / 53850
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD261 / 53857
{
	Function_239(&uLocal_442, &cLocal_7, "cabin01", 99, &Global_44085[bParam09] + 32, 0, &iLocal_242 + 432, 0, 1);
	Function_239(&uLocal_442, &cLocal_7, "tradepost01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "tradepost01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "tradepost01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "tradepost01", 4, &Global_44085[bParam09] + 32, 1, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "tradepost01", 5, &Global_44085[bParam09] + 32, 0, &iLocal_242 + 80, 1, 0);
	Function_239(&uLocal_442, &cLocal_7, "trainDepot01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD378 / 54136
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD47B / 54395
{
	int iVar0;
...
void Function_241() //Position: 0xD4AC / 54444
{
	Function_242(&uLocal_9, &uLocal_410, 4, &iLocal_242 + 8, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_410, 5, &iLocal_242 + 80, 4294967295, 2314);
	Function_242(&uLocal_9, &uLocal_410, 5, &iLocal_242 + 104, 4294967295, 16650);
	Function_242(&uLocal_9, &uLocal_410, 5, &iLocal_242 + 336, 4294967295, 16650);
	Function_242(&uLocal_9, &uLocal_410, 5, &iLocal_242 + 432, 4294967295, 258);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD50C / 54540
{
...
void Function_243(struct<5> Param0) //Position: 0xD5F9 / 54777
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD60A / 54794
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, int iParam1, bool bParam2) //Position: 0xD680 / 54912
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD71E / 55070
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD727 / 55079
{
	cLocal_7 = Function_248(&iLocal_178, "nmanzanita", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD744 / 55108
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD767 / 55143
{
	return Function_250();
}

int Function_250() //Position: 0xD770 / 55152
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_242 = FIND_NAMED_LAYOUT("ManzanitaPost_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_242))
	{
		iLocal_242 = CREATE_LAYOUT("ManzanitaPost_layout");
	}
	*(&iLocal_242 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_region", 4,203895E-45f, Vector(-446,1047f, 166,8103f, 1613,427f), Vector(0.0f, 34,62986f, 0.0f), Vector(56,60696f, 20,28249f, 83,10894f));
	*(&iLocal_242 + 80) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_store_set");
	*(&iLocal_242 + 16[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store03", 2,802597E-45f, Vector(-453,4148f, 155,0032f, 1620,927f), Vector(0.0f, 18,27136f, 0.0f), Vector(7,289934f, 3,890072f, 17,96808f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[0]);
	*(&iLocal_242 + 16[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store01", 2,802597E-45f, Vector(-459,9624f, 154,911f, 1616,25f), Vector(0.0f, 18,34838f, 0.0f), Vector(4,421497f, 3,494474f, 5,325041f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[1]);
	*(&iLocal_242 + 16[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store02", 2,802597E-45f, Vector(-449,089f, 155,1434f, 1619,235f), Vector(0.0f, 18,35766f, 0.0f), Vector(3,26932f, 4,017075f, 17,89183f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[2]);
	*(&iLocal_242 + 16[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store04", 2,802597E-45f, Vector(-449,7834f, 155,2446f, 1612,098f), Vector(0.0f, 18,34838f, 0.0f), Vector(0,8837107f, 1,610648f, 1,115541f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[3]);
	*(&iLocal_242 + 16[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store05", 2,802597E-45f, Vector(-448,934f, 155,2446f, 1614,658f), Vector(0.0f, 18,34838f, 0.0f), Vector(0,8837107f, 1,610648f, 1,115541f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[4]);
	*(&iLocal_242 + 16[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store06", 2,802597E-45f, Vector(-445,6509f, 155,2446f, 1624,557f), Vector(0.0f, 18,34838f, 0.0f), Vector(0,8837107f, 1,610648f, 1,115541f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[5]);
	*(&iLocal_242 + 16[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_store07", 2,802597E-45f, Vector(-446,0783f, 154,9507f, 1630,749f), Vector(0.0f, 18,34838f, 0.0f), Vector(0,2717866f, 1,610648f, 1,995313f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 80, &iLocal_242 + 16[6]);
	*(&iLocal_242 + 104) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_trainStation_set");
	*(&iLocal_242 + 88[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Box4", 2,802597E-45f, Vector(-412,1928f, 153,5993f, 1604,312f), Vector(0.0f, 16,98188f, 0.0f), Vector(3,399913f, 2,795681f, 5,496667f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 104, &iLocal_242 + 88[0]);
	*(&iLocal_242 + 128) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_tents_set");
	*(&iLocal_242 + 112[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "nCylinder5", 4,203895E-45f, Vector(-463,9041f, 154,5908f, 1575,254f), Vector(0.0f, -9,161345f, 0.0f), Vector(19,90582f, 6,999259f, 30,42453f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 128, &iLocal_242 + 112[0]);
	*(&iLocal_242 + 168) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_trainWalkway_set");
	*(&iLocal_242 + 136[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Box27", 2,802597E-45f, Vector(-415,3496f, 153,487f, 1604,169f), Vector(0.0f, 17,58583f, 0.0f), Vector(2,243587f, 2,619346f, 8,862592f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 168, &iLocal_242 + 136[0]);
	*(&iLocal_242 + 136[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Box14", 2,802597E-45f, Vector(-408,9507f, 153,0197f, 1602,299f), Vector(0.0f, -71,86266f, 0.0f), Vector(8,396963f, 2,344469f, 3,288374f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 168, &iLocal_242 + 136[1]);
	*(&iLocal_242 + 136[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Box15", 2,802597E-45f, Vector(-410,2993f, 153,4289f, 1607,948f), Vector(0.0f, -70,86935f, 0.0f), Vector(1,893754f, 2,470759f, 8,776808f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 168, &iLocal_242 + 136[2]);
	*(&iLocal_242 + 216) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_birds_set");
	*(&iLocal_242 + 176[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder50", 4,203895E-45f, Vector(-413,9072f, 153,5974f, 1603,649f), Vector(0.0f, 20.0f, 0.0f), Vector(12,09756f, 20,17988f, 12,09756f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 216, &iLocal_242 + 176[0]);
	*(&iLocal_242 + 176[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "nCylinder1", 4,203895E-45f, Vector(-452,8146f, 156,1155f, 1624,195f), Vector(0.0f, 20.0f, 0.0f), Vector(12,09756f, 20,17988f, 18,81477f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 216, &iLocal_242 + 176[1]);
	*(&iLocal_242 + 176[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "nCylinder2", 4,203895E-45f, Vector(-444,1078f, 153,5015f, 1673,068f), Vector(0.0f, 20.0f, 0.0f), Vector(12,09756f, 20,17988f, 12,09756f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 216, &iLocal_242 + 176[2]);
	*(&iLocal_242 + 176[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "nCylinder3", 4,203895E-45f, Vector(-492,7358f, 157,5287f, 1564,088f), Vector(0.0f, 20.0f, 0.0f), Vector(18,64388f, 20,17988f, 19,19005f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 216, &iLocal_242 + 176[3]);
	*(&iLocal_242 + 280) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_raccoon_set");
	*(&iLocal_242 + 224[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder58", 4,203895E-45f, Vector(-474,5305f, 154,0435f, 1636,803f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[0]);
	*(&iLocal_242 + 224[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder53", 4,203895E-45f, Vector(-485,9409f, 152,3524f, 1569,181f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[1]);
	*(&iLocal_242 + 224[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder54", 4,203895E-45f, Vector(-402,0251f, 151,9082f, 1622,764f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[2]);
	*(&iLocal_242 + 224[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder55", 4,203895E-45f, Vector(-453,4293f, 156,322f, 1675,813f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[3]);
	*(&iLocal_242 + 224[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder56", 4,203895E-45f, Vector(-491,8233f, 160,4498f, 1612,328f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[4]);
	*(&iLocal_242 + 224[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder57", 4,203895E-45f, Vector(-474,5305f, 154,0435f, 1636,803f), Vector(0.0f, 20.0f, 0.0f), Vector(4,855732f, 4,4292f, 6,442109f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 280, &iLocal_242 + 224[5]);
	*(&iLocal_242 + 336) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_TrnPlatform_set");
	*(&iLocal_242 + 288[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_TrnPlatform01", 2,802597E-45f, Vector(-413,1695f, 153,7277f, 1598,692f), Vector(0.0f, -72,26491f, 0.0f), Vector(5,465863f, 4,133375f, 11,42017f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 336, &iLocal_242 + 288[0]);
	*(&iLocal_242 + 288[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_TrnPlatform02", 2,802597E-45f, Vector(-412,1872f, 153,6225f, 1593,995f), Vector(0.0f, 18,3607f, 0.0f), Vector(5,837962f, 4,156413f, 4,773031f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 336, &iLocal_242 + 288[1]);
	*(&iLocal_242 + 288[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_TrnPlatform03", 2,802597E-45f, Vector(-410,1619f, 153,7277f, 1608,096f), Vector(0.0f, -72,26491f, 0.0f), Vector(2,378887f, 4,133375f, 11,42017f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 336, &iLocal_242 + 288[2]);
	*(&iLocal_242 + 288[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_TrnPlatform04", 2,802597E-45f, Vector(-408,374f, 153,7277f, 1602,771f), Vector(0.0f, -72,26491f, 0.0f), Vector(9,64335f, 4,133375f, 4,336667f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 336, &iLocal_242 + 288[3]);
	*(&iLocal_242 + 288[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_TrnPlatform05", 2,802597E-45f, Vector(-416,0699f, 153,7277f, 1604,832f), Vector(0.0f, -72,26491f, 0.0f), Vector(9,64335f, 4,133375f, 4,336667f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 336, &iLocal_242 + 288[4]);
	*(&iLocal_242 + 360) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_customers_set");
	*(&iLocal_242 + 344[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_customers01", 2,802597E-45f, Vector(-436,6406f, 154,911f, 1618,357f), Vector(0.0f, 18,34838f, 0.0f), Vector(19,61568f, 12,64799f, 13,83968f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 360, &iLocal_242 + 344[0]);
	*(&iLocal_242 + 416) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_Songbirds_set");
	*(&iLocal_242 + 368[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder105", 4,203895E-45f, Vector(-401,213f, 155,4097f, 1646,434f), Vector(0.0f, 270,613f, 0.0f), Vector(2,485654f, 4,727016f, 2,202775f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 416, &iLocal_242 + 368[0]);
	*(&iLocal_242 + 368[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder101", 4,203895E-45f, Vector(-408,3219f, 156,9579f, 1649,914f), Vector(0.0f, 122,003f, 0.0f), Vector(2,198967f, 5,421324f, 2,345026f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 416, &iLocal_242 + 368[1]);
	*(&iLocal_242 + 368[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder102", 4,203895E-45f, Vector(-456,459f, 158,5899f, 1643,045f), Vector(0.0f, 20.0f, 0.0f), Vector(3,176107f, 7,441402f, 3,210801f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 416, &iLocal_242 + 368[2]);
	*(&iLocal_242 + 368[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder103", 4,203895E-45f, Vector(-475,198f, 155,9205f, 1566,421f), Vector(0.0f, 53,93914f, 0.0f), Vector(4,298011f, 9,141942f, 6,170969f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 416, &iLocal_242 + 368[3]);
	*(&iLocal_242 + 368[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "Cylinder104", 4,203895E-45f, Vector(-440,795f, 154,1687f, 1583,035f), Vector(0.0f, 212,157f, 0.0f), Vector(3,047699f, 7,583018f, 2,975777f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 416, &iLocal_242 + 368[4]);
	*(&iLocal_242 + 424) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "nmtpv_hawk", 4,203895E-45f, Vector(-425,6133f, 154,7939f, 1550,393f), Vector(0.0f, 109,36f, 0.0f), Vector(3,356604f, 7,971628f, 3,077288f));
	*(&iLocal_242 + 432) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_players_house", 2,802597E-45f, Vector(-443,6414f, 153,499f, 1670,266f), Vector(0.0f, -36,5882f, 0.0f), Vector(7,443309f, 7,843923f, 8,202867f));
	*(&iLocal_242 + 464) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_242, "mtpv_train_tickets_set");
	*(&iLocal_242 + 440[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_train_tickets_01", 2,802597E-45f, Vector(-411,8714f, 153,7277f, 1602,584f), Vector(0.0f, -72,26491f, 0.0f), Vector(13,11986f, 4,133375f, 9,90799f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 464, &iLocal_242 + 440[0]);
	*(&iLocal_242 + 440[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_train_tickets_02", 2,802597E-45f, Vector(-412,2029f, 153,6225f, 1594,064f), Vector(0.0f, 18,3607f, 0.0f), Vector(5,837962f, 4,156413f, 3,940191f));
	ADD_TO_VOLUME_SET(&iLocal_242 + 464, &iLocal_242 + 440[1]);
	*(&iLocal_242 + 472) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_242, "mtpv_fff", 4,203895E-45f, Vector(-464,1764f, 152,3517f, 1596,943f), Vector(0.0f, 108,6721f, 0.0f), Vector(3,572981f, 4,85507f, 3,993516f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_report_crime_road", Vector(-440,88f, 148,47f, 1550,962f), Vector(0.0f, 18,344f, 0.0f));
	*(&iLocal_242 + 480) = Vector(-415,8964f, 152,043f, 1603,051f);
	*(&iLocal_242 + 480 + 12) = Vector(0.0f, 283,8603f, 0.0f);
	*(&iLocal_242 + 504) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_f_merc_giver", Vector(-415,8964f, 152,043f, 1603,051f), Vector(0.0f, 283,8603f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_clear_bounty", Vector(-410,142f, 152,246f, 1603,021f), Vector(0.0f, 110,2083f, 0.0f));
	*(&iLocal_242 + 512) = Vector(-412,3942f, 152,2606f, 1604,294f);
	*(&iLocal_242 + 512 + 12) = Vector(0.0f, 18,68623f, 0.0f);
	*(&iLocal_242 + 536) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_interiorPoint_train", Vector(-412,3942f, 152,2606f, 1604,294f), Vector(0.0f, 18,68623f, 0.0f));
	*(&iLocal_242 + 544) = Vector(-443,7186f, 153,5825f, 1670,733f);
	*(&iLocal_242 + 544 + 12) = Vector(0.0f, -40,65596f, 0.0f);
	*(&iLocal_242 + 568) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_interiorPoint_house", Vector(-443,7186f, 153,5825f, 1670,733f), Vector(0.0f, -40,65596f, 0.0f));
	*(&iLocal_242 + 576) = Vector(-450,457f, 153,6398f, 1622,386f);
	*(&iLocal_242 + 576 + 12) = Vector(0.0f, -73,56581f, 0.0f);
	*(&iLocal_242 + 600) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_interiorPoint_store", Vector(-450,457f, 153,6398f, 1622,386f), Vector(0.0f, -73,56581f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos1", Vector(-438,92f, 152,501f, 1578,528f), Vector(-3,163f, -125,189f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos2", Vector(-406,784f, 152,805f, 1584,935f), Vector(0,803f, 161,82f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos3", Vector(-412,308f, 150,886f, 1500,399f), Vector(6,689f, 152,501f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos4", Vector(-442,073f, 165,451f, 1710,445f), Vector(-10,302f, 26,831f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos5", Vector(-414,191f, 159,153f, 1670,796f), Vector(-12,885f, 15,472f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos6", Vector(-429,409f, 154,315f, 1625,182f), Vector(-3,736f, 57,946f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos7", Vector(-416,24f, 154,064f, 1610,48f), Vector(-7,286f, -5,064f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos8", Vector(-441,808f, 156,897f, 1684,545f), Vector(-4,498f, -13,347f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos9", Vector(-459,1f, 151,26f, 1541,848f), Vector(3,86f, 169,793f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtp_vista_cam_pos10", Vector(-409,687f, 155,93f, 1592,663f), Vector(-12,558f, 144,192f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "player_shop_flag", Vector(-409,2896f, 152,246f, 1602,707f), Vector(0.0f, -71,32724f, 0.0f));
	*(&iLocal_242 + 608) = Vector(-444,1791f, 153,5885f, 1669,92f);
	*(&iLocal_242 + 608 + 12) = Vector(0.0f, -47,09195f, 0.0f);
	*(&iLocal_242 + 632) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_interiorSettlement01", Vector(-444,1791f, 153,5885f, 1669,92f), Vector(0.0f, -47,09195f, 0.0f));
	*(&iLocal_242 + 640) = Vector(-451,759f, 153,6398f, 1620,574f);
	*(&iLocal_242 + 640 + 12) = Vector(0.0f, -88,73708f, 0.0f);
	*(&iLocal_242 + 664) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_242, "mtpf_interiorSettlement02", Vector(-451,759f, 153,6398f, 1620,574f), Vector(0.0f, -88,73708f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xEB23 / 60195
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xEB6D / 60269
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xEB7E / 60286
{
	return;
}

bool Function_254() //Position: 0xEB84 / 60292
{
	return 1;
}

void Function_255() //Position: 0xEB8B / 60299
{
...
bool Function_256() //Position: 0xEC5E / 60510
{
	return Function_257();
}

int Function_257() //Position: 0xEC67 / 60519
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("ManzanitaPost_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("ManzanitaPost_layout");
	}
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "mtpv_wolf_trigger", 4,203895E-45f, Vector(-648,4926f, 87,459f, 1488,032f), Vector(0.0f, -31,57944f, 0.0f), Vector(11,27725f, 3.0f, 20,08958f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-408,1405f, 155,5181f, 1611,479f), Vector(0.0f, 18,48834f, 0.0f), Vector(6,354789f, 10,37365f, 5,269826f));
	*(&iLocal_178 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-449,9822f, 154,6963f, 1621,395f), Vector(0.0f, 18,48834f, 0.0f), Vector(15,33546f, 10,09173f, 24,84793f));
	*(&iLocal_178 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-456,5679f, 155,1972f, 1623,817f), Vector(0.0f, 17,08066f, 0.0f), Vector(17,41877f, 8,398009f, 24,8438f));
	*(&iLocal_178 + 112) = Vector(-444,8913f, 153,2378f, 1663,379f);
	*(&iLocal_178 + 112 + 12) = Vector(0.0f, -79,87083f, 0.0f);
	*(&iLocal_178 + 136) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-444,8913f, 153,2378f, 1663,379f), Vector(0.0f, -79,87083f, 0.0f));
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_difSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-405,9222f, 154,5893f, 1612,074f), Vector(0.0f, -107,162f, 0.0f));
	DECOR_SET_INT(&uVar1, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar1, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 144);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-452,2768f, 153,6423f, 1619,997f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "Accuracy", 100);
	DECOR_SET_INT(&uVar2, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 144);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-410,1466f, 154,6336f, 1610,861f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_INT(&uVar3, "nShoot_Vol", true);
	DECOR_SET_BOOL(&uVar3, "Core", 1);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 144);
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-410,5224f, 154,53f, 1611,857f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar4, "nShoot_Vol", true);
	DECOR_SET_BOOL(&uVar4, "Core", 1);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 152);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-410,5238f, 154,53f, 1610,457f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar5, "nShoot_Vol", true);
	DECOR_SET_BOOL(&uVar5, "Core", 1);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 152);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-405,5964f, 154,587f, 1612,685f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar6, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 152);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-405,5968f, 154,5872f, 1611,285f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar7, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar7, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 152);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-452,2765f, 153,6423f, 1618,597f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "Accuracy", 100);
	DECOR_SET_INT(&uVar8, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 152);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-452,2768f, 153,6423f, 1619,997f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "Accuracy", 100);
	DECOR_SET_INT(&uVar9, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-410,1466f, 154,6336f, 1610,861f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_INT(&uVar10, "nShoot_Vol", true);
	DECOR_SET_INT(&uVar10, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 160);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-452,2768f, 153,6423f, 1619,997f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "Accuracy", 100);
	DECOR_SET_INT(&uVar11, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 160);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05_core", Vector(-453,8691f, 153,6423f, 1624,621f), Vector(0.0f, 289,484f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", 1);
	DECOR_SET_INT(&uVar12, "Accuracy", 100);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_player", Vector(-453,9034f, 153,6423f, 1623,162f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "Accuracy", 100);
	DECOR_SET_INT(&uVar13, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 168);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_surv", Vector(-453,9052f, 153,6423f, 1624,562f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "Accuracy", 100);
	DECOR_SET_INT(&uVar14, "GiveWeapon", 43);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 168);
	*(&iLocal_178 + 176) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-410,1776f, 154,4999f, 1612,176f), Vector(0.0f, 116,4694f, 0.0f));
	DECOR_SET_BOOL(&uVar15, "Core", 1);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 176);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-405,8035f, 154,591f, 1612,157f), Vector(0.0f, 255,133f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 176);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-452,944f, 153,6745f, 1619,235f), Vector(0.0f, -70.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 176);
	*(&iLocal_178 + 184) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-437,3776f, 152,3484f, 1644,596f), Vector(0.0f, -269,7534f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 184);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-470,288f, 149,4585f, 1555,66f), Vector(0.0f, -133,7102f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 184);
	*(&iLocal_178 + 192) = Vector(-448,9981f, 153,3878f, 1631,183f);
	*(&iLocal_178 + 192 + 12) = Vector(0.0f, 20,74287f, 0.0f);
	*(&iLocal_178 + 216) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-448,9981f, 153,3878f, 1631,183f), Vector(0.0f, 20,74287f, 0.0f));
	*(&iLocal_178 + 224) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-410,0219f, 154,5299f, 1612,192f), Vector(0.0f, -256,5173f, 0.0f));
	*(&iLocal_178 + 232) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_kneel_rfl", "DLC_survivor_kneel_rfl", Vector(-405,7955f, 154,6413f, 1612,183f), Vector(0.0f, -115,8652f, 0.0f));
	*(&iLocal_178 + 240) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl", "DLC_survivor_low_wall_rfl", Vector(-452,8916f, 153,6416f, 1619,215f), Vector(0.0f, 109.0f, 0.0f));
	*(&iLocal_178 + 248) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-451,7794f, 153,3961f, 1631,966f), Vector(0.0f, 19,70151f, 0.0f));
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xF911 / 63761
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xF9AC / 63916
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xFAB8 / 64184
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xFB94 / 64404
{
...
int Function_262(int iParam0) //Position: 0xFC0F / 64527
{
...
bool Function_263(int iParam0) //Position: 0xFC24 / 64548
{
...
int Function_264(int iParam0) //Position: 0xFC8A / 64650
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xFD4C / 64844
{
	int iVar0;
...
void Function_266() //Position: 0xFD69 / 64873
{
	return;
}

void Function_267(char* cParam0) //Position: 0xFD6F / 64879
{
	if (!Function_26(128))
	{
		return;
