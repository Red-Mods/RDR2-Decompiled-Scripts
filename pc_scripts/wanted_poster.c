...
void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0xC10 / 3088
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
int Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1758 / 5976
{
	int iVar0;
	int iVar1;
...
void Function_32() //Position: 0x1B7C / 7036
{
	...
	Global_77930 = GET_CURRENT_GAME_TIME();
	Function_13(8, (GET_DAY(false) - 2), 0);
	return;
}

int Function_33(int iParam0, bool bParam1, int iParam2) //Position: 0x1BB9 / 7097
{
	int iVar0;
	int iVar1;
...
int Function_48(int iParam0) //Position: 0x29F3 / 10739
{
	...
	switch (iLocal_2)
	{
		...
		case 0x00000001:
			if (Function_78(&iParam0, &uVar0))
			{
				Function_70(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 2;
			}
			iVar1 = 0;
			break;
...
bool Function_50(int iParam0, int iParam1, int iParam2) //Position: 0x2AD7 / 10967
{
	var uVar0;
		...
		if (IS_GRINGO_COMPONENT_VALID(&uVar0) && iLocal_4)
		{
			if (DECOR_CHECK_EXIST(&iParam1, "NewspaperStart"))
			{
				if (!iLocal_22)
				{
					...
					ENABLE_USE_CONTEXTS(1);
					Function_51();
					SHOW_NEWSPAPER(202, &cLocal_5, 1, 0);
					iLocal_22 = 1;
				}
			}
...
void Function_51() //Position: 0x2C1A / 11290
{
	var uVar0;
	var uVar16;
	var uVar32;
	...
	Function_64(Global_39906.f_12, &uVar0);
	uVar64 = Function_63(Global_39906.f_20);
	Function_62(uVar64, &uVar16);
	Function_61(Global_39906.f_24, &uVar32);
	Function_56(&uVar48);
	SET_NEWSPAPER_INFO(0, &uVar16);
	SET_NEWSPAPER_INFO(1, &uVar0);
	SET_NEWSPAPER_INFO(2, &uVar32);
	SET_NEWSPAPER_INFO(3, &uVar48);
	if (!Function_52(Function_53(Global_39906.f_20)))
	{
		strcpy(&cLocal_5, "p_pos_wanted", 32);
		if (Global_39906.f_40 <= 10)
		{
			stradd(&cLocal_5, "0", 32);
		}
		stradd(&cLocal_5, INT_TO_STRING(Global_39906.f_40), 32);
	}
	else
	{
		strcpy(&cLocal_5, "p_pos_wanted61", 32);
	}
	return;
}

bool Function_52(bool bParam0) //Position: 0x2CBA / 11450
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_53(int iParam0) //Position: 0x2D0C / 11532
{
	int iVar0;
	int iVar1;
	struct<21> Var2;
...
var Function_54(struct<41> Param0) //Position: 0x2D4A / 11594
{
	int iVar0;
...
bool Function_55(int iParam0) //Position: 0x359E / 13726
{
...
void Function_56(int iParam0) //Position: 0x35B5 / 13749
{
	memcpy(&iParam0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_57(&Global_39906), 16);
	return;
}

struct<32> Function_57(int iParam0) //Position: 0x35C8 / 13768
{
	char* cVar0[32];
	bool bVar8;
	bool bVar9;
	
	bVar8 = Function_58(&iParam0, 0);
	bVar9 = Function_58(&iParam0, 1);
...
var Function_58(struct<13> Param0) //Position: 0x365A / 13914
{
	bool bVar0;
	char* cVar1[32];
...
bool Function_59() //Position: 0x3786 / 14214
{
...
int Function_60() //Position: 0x37B1 / 14257
{
	return Global_21369.f_244;
}

void Function_61(int iParam0, char* cParam1) //Position: 0x37BC / 14268
{
	strcpy(&cParam1, GET_OBJECT_NAME(&Global_44085[iParam09] + 8), 64);
	return;
}

void Function_62(char* cParam0, char* cParam1) //Position: 0x37D4 / 14292
{
	switch (cParam0)
	{
		case 0x00000004:
...
var Function_63(bool bParam0) //Position: 0x38C3 / 14531
{
	int iVar0;
	int iVar1;
...
void Function_64(char* cParam0, char* cParam1) //Position: 0x3972 / 14706
{
	switch (cParam0)
	{
		case 0x00000001:
...
void Function_65(int iParam0, var uParam1, var uParam2) //Position: 0x3A51 / 14929
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0) && uParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(&uVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(&uParam1, &uVar1, Function_67(&uVar1, "AttachBone", &iVar2), Function_67(&uVar1, "AttachLocator", &iVar2), 1))
				{
					Function_66(&uVar1, &uParam1);
					uParam2 = 1;
				}
			}
		}
...
void Function_66(bool bParam0, int iParam1) //Position: 0x3AEE / 15086
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_67(char* cParam0, var uParam1, int iParam2) //Position: 0x3BB6 / 15286
{
	int iVar0;
	int iVar1;
...
var Function_68(int iParam0) //Position: 0x3C06 / 15366
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_69(int iParam0) //Position: 0x3C1D / 15389
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_70(var uParam0, var uParam1, int iParam2) //Position: 0x3C34 / 15412
{
	uParam0 = Function_77(&uParam0);
	iParam2 = 0;
	...
	if (!Global_6623)
	{
		if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(&Global_54076)))
		{
			...
			{
				if (((Function_73(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
				{
					iLocal_4 = 0;
				}
				iParam2 = 1;
			...
			{
				Function_71("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
				iParam2 = 0;
			}
		}
		else
		{
			Function_71("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
	}
	else
...
void Function_71(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3D52 / 15698
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_72(int iParam0) //Position: 0x3DDD / 15837
{
	char* cVar0[16];
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x3E1C / 15900
{
...
bool Function_74() //Position: 0x3EE0 / 16096
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_75(int iParam0) //Position: 0x3EF7 / 16119
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_76(int iParam0) //Position: 0x3F03 / 16131
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_77(int iParam0) //Position: 0x3F12 / 16146
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_78(int iParam0, int iParam1) //Position: 0x3F2D / 16173
{
	var uVar0;
	var uVar1;
	
	iParam0 = &iParam0;
	uVar0 = Function_68(&iParam0);
	uVar1 = Function_69(&iParam0);
	if (IS_GRINGO_COMPONENT_VALID(&uVar1))
	{
		if (!iLocal_21)
		{
