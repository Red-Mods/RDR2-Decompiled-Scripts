...
void main() //Position: 0x0 / 0
{
	...
	Function_11(&bVar0, 66, 4.0f, 0, 0);
	Function_11(&bVar0, 67, 4.0f, 0, 0);
	Function_11(&bVar0, 69, 4.0f, 0, 0);
	Function_11(&bVar0, 65, 4.0f, 0, 0);
	Function_11(&bVar0, 71, 4.0f, 0, 0);
	Function_11(&bVar0, 72, 4.0f, 0, 0);
	...
	uVar2 = FIND_NAMED_LAYOUT("FortMercer_layout");
	uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "fomv_zombies_01");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		Function_4(&uVar3, &bVar0, 10, 15, 0, 0, 1);
	}
	else
	{
	...
	{
		Function_4(&uVar3, &(Global_46972[4]), 2, 5, 0, 0, 1);
	}
	else
	{
		LOG_ERROR("FortMercer: Cannot find FortMercer_layout to create population volumes");
	}
	uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "fomv_zombies_03");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		Function_4(&uVar3, &bVar0, 10, 15, 0, 0, 1);
	}
	...
	uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "fomv_zombies_04");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
	...
	uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "fomv_zombies_05");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		Function_4(&uVar3, &bVar0, 5, 10, 0, 0, 1);
	}
	...
	uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "fomv_region");
	if (IS_VOLUME_VALID(&uVar3))
	{
...
void Function_1(var uParam0, var uParam1) //Position: 0xF93 / 3987
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xFA4 / 4004
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xFFC / 4092
{
	var uVar0;
...
var Function_4(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x108C / 4236
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0x111E / 4382
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0x113A / 4410
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x117A / 4474
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x1197 / 4503
{
...
var Function_9(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x11A8 / 4520
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x11EF / 4591
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x11FC / 4604
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, int iParam1) //Position: 0x127E / 4734
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_13(char* cParam0) //Position: 0x128D / 4749
{
	if (!Function_5(128))
	{
		return;
