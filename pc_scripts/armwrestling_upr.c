	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_36(Global_46926[2]))
			{
				...
				{
					Function_30("ArmWrestling_NotEnoughMoney", 4.0f, 1, 2, 0, 0, 0, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_24(Global_46926[2], &iLocal_35 + 4, &iLocal_35 + 40, &iLocal_35 + 48))
			{
				Function_23(&iLocal_35 + 4);
				Function_22(Global_46926[2]);
				(&iLocal_35 + 64[02]) = Function_22(Global_46926[2]);
				Function_21(Global_46926[2]);
				*(&iLocal_35 + 64[12]) = Function_21(Global_46926[2]);
				Function_20(Global_46926[2]);
				*(&iLocal_35 + 52) = Function_20(Global_46926[2]);
				iLocal_35 = Local_7;
...
bool Function_17(int iParam0) //Position: 0x5AD / 1453
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_18(int iParam0, bool bParam1) //Position: 0x5CE / 1486
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_19(int iParam0, int iParam1) //Position: 0x605 / 1541
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_20(int iParam0) //Position: 0x620 / 1568
{
...
struct<8> Function_21(int iParam0) //Position: 0x6D0 / 1744
{
	if (iParam0 == Global_46866[2])
	{
...
struct<8> Function_22(int iParam0) //Position: 0x784 / 1924
{
	if (iParam0 == Global_46866[2])
	{
...
void Function_23(int[] iParam0) //Position: 0x834 / 2100
{
	int iVar0;
	var uVar1;
...
bool Function_24(var uParam0, var[] uParam1, var uParam2, var uParam3) //Position: 0x890 / 2192
{
	var uVar0;
	var uVar2;
	int iVar3;
...
bool Function_25(int iParam0, bool bParam1, bool bParam2) //Position: 0xB72 / 2930
{
...
bool Function_26() //Position: 0xC36 / 3126
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_27(int iParam0) //Position: 0xC4D / 3149
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_28(int iParam0) //Position: 0xC59 / 3161
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

struct<8> Function_29(int iParam0, bool bParam1) //Position: 0xC68 / 3176
{
	if (iParam0 == Global_46866[2])
	{
		if (bParam1 == 0)
...
void Function_30(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0xD98 / 3480
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_31(int iParam0) //Position: 0xE2D / 3629
{
	char* cVar0[16];
...
bool Function_32() //Position: 0xE6C / 3692
{
...
bool Function_33(var uParam0, int iParam1) //Position: 0xE87 / 3719
{
	return (uParam0 && iParam1) == 0;
}

float Function_34(int iParam0) //Position: 0xE94 / 3732
{
...
var Function_35(int iParam0) //Position: 0xECD / 3789
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_36(int iParam0) //Position: 0xEE7 / 3815
{
...
int Function_37(var uParam0, int iParam1) //Position: 0xF03 / 3843
{
	int iVar0;
...
bool Function_38(int iParam0) //Position: 0xF20 / 3872
{
...
void Function_39() //Position: 0xF36 / 3894
{
	Function_1();
	return;
}

void Function_40() //Position: 0xF3F / 3903
{
...
void Function_41(int iParam0) //Position: 0xF8C / 3980
{
...
void Function_42(vector3 vParam0) //Position: 0xFA3 / 4003
{
...
void Function_43(var uParam0, int iParam1) //Position: 0xFC8 / 4040
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0xFDE / 4062
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_45(var uParam0) //Position: 0xFEF / 4079
{
	return Function_33(uParam0, 1);
}

void Function_46() //Position: 0xFFD / 4093
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x1003 / 4099
{
	var uVar0;
...
void Function_48(var uParam0) //Position: 0x1062 / 4194
{
	int iVar0;
...
var Function_49() //Position: 0x107F / 4223
{
	var uVar0;
