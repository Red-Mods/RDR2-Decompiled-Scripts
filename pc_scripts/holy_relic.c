...
var Function_53(char* cParam0, var uParam1, int iParam2) //Position: 0x2C71 / 11377
{
	int iVar0;
	int iVar1;
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uParam0 = Function_66(&uParam0);
	iParam2 = 0;
	iLocal_4 = 0;
	if (!IS_ACTOR_VALID(&uParam1) || !IS_ACTOR_ALIVE(&Global_54076))
	{
		return;
	}
	Global_46955 = Function_61(0, Global_46850[2], 3);
	bVar0 = false;
	if (Global_21684[Global_469557].f_16 == 0)
	{
		bVar0 = true;
	}
	else if (IS_EARLIER_THAN(Global_21684[Global_469557].f_16, 0))
	{
		bVar0 = true;
	}
	if (bVar0)
	{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(&Global_54076, 16) - _GET_AMMO_AMOUNT(&Global_54076, 16, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(&Global_54076, 16));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(&Global_54076, 5) - _GET_AMMO_AMOUNT(&Global_54076, 5, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(&Global_54076, 5));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(&Global_54076, 4) - _GET_AMMO_AMOUNT(&Global_54076, 4, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(&Global_54076, 4));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		if (!IS_WEAPONENUM_LOCKED(31))
		{
			...
			{
				fVar1 = (_GET_MAX_AMMO_AMOUNT(&Global_54076, 13) - _GET_AMMO_AMOUNT(&Global_54076, 13, 1));
				fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(&Global_54076, 13));
				if (fVar2 < fVar7)
				{
					if (fVar7 < fVar8)
					{
		...
		if (bVar3 != 4294967295)
		{
			_ADD_AMMO_OF_TYPE(&Global_54076, bVar3, bVar5, 1, 1);
		}
		if (bVar4 != 4294967295)
		{
			_ADD_AMMO_OF_TYPE(&Global_54076, bVar4, (fVar6 / 2.0f), 1, 1);
		}
		iVar9 = 0;
		iVar10 = 0;
		bVar11 = 4294967295;
		iVar9 = (GET_MAX_ITEM_COUNT(Function_60(3)) - GET_ITEM_COUNT(Function_60(3), &Global_54076));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = 3;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_60(1)) - GET_ITEM_COUNT(Function_60(1), &Global_54076));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = true;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_60(0)) - GET_ITEM_COUNT(Function_60(0), &Global_54076));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = false;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_60(2)) - GET_ITEM_COUNT(Function_60(2), &Global_54076));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = 2;
		...
		{
			ADD_ITEM(Function_60(bVar11), &Global_54076, 1);
		}
		uVar12 = GET_TIME_OF_DAY();
		ADD_TIME(&uVar12, 1, 0, false, 0);
		Global_21684[Global_469557].f_16 = &uVar12;
		Function_59(&uVar12);
		PRINTNL();
		iParam2 = 1;
	}
	...
	{
		Function_57("tut_holy_relic_wait", 0x41200000, 1, 0, 2, 1, 0);
	}
	return;
}

void Function_57(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3043 / 12355
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x30CE / 12494
{
	char* cVar0[16];
...
void Function_59(int iParam0) //Position: 0x310D / 12557
{
	PRINTSTRING("Day ");
...
var Function_60(bool bParam0) //Position: 0x3157 / 12631
{
	int iVar0;
...
int Function_61(bool bParam0, bool bParam1, bool bParam2) //Position: 0x324B / 12875
{
	int iVar0;
	int iVar1;
...
int Function_62(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x32A9 / 12969
{
	var uVar0;
...
var Function_63(int iParam0) //Position: 0x340D / 13325
{
	int iVar0;
...
bool Function_64(int iParam0) //Position: 0x344B / 13387
{
...
var Function_65(int iParam0, int iParam1, int iParam2) //Position: 0x3460 / 13408
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

var Function_66(int iParam0) //Position: 0x3480 / 13440
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_67(int iParam0, int iParam1) //Position: 0x349B / 13467
{
	var uVar0;
	var uVar1;
