		...
		if (IS_GRINGO_COMPONENT_VALID(&uVar0) && iLocal_4)
		{
			if (DECOR_CHECK_EXIST(&iParam1, "NewspaperStart"))
			{
				if (!iLocal_5)
				{
					...
					ENABLE_USE_CONTEXTS(1);
					SHOW_NEWSPAPER(201, &uLocal_6, 1, 1);
					iLocal_5 = 1;
				}
			}
...
void Function_51(int iParam0, var uParam1, var uParam2) //Position: 0x2C12 / 11282
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_52(bool bParam0, int iParam1) //Position: 0x2CAF / 11439
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_53(char* cParam0, var uParam1, int iParam2) //Position: 0x2D77 / 11639
{
	int iVar0;
	int iVar1;
...
var Function_54(int iParam0) //Position: 0x2DC7 / 11719
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_55(int iParam0) //Position: 0x2DDE / 11742
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2DF5 / 11765
{
	uParam0 = Function_65(&uParam0);
	iParam2 = 0;
	uLocal_6 = Function_63();
	...
	if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(&Global_54076)))
	{
		...
		{
			if (STRING_CONTAINS_STRING(&uLocal_6, "Unknown"))
			{
				iParam2 = 0;
			}
			else
...
void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F25 / 12069
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x2FB0 / 12208
{
	char* cVar0[16];
...
int Function_59(int iParam0, bool bParam1, bool bParam2) //Position: 0x2FEF / 12271
{
...
bool Function_60() //Position: 0x30B3 / 12467
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_61(int iParam0) //Position: 0x30CA / 12490
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_62(bool bParam0) //Position: 0x30D6 / 12502
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

var Function_63() //Position: 0x30E5 / 12517
{
	int iVar0;
	int iVar1;
	...
	if (Function_46())
	{
		...
		{
			iVar1 = "Scratching_post";
		}
		else if (iVar0 == 3)
		{
			iVar1 = "SepulcroTresmap";
		}
		else if (iVar0 == 4)
		{
			iVar1 = "DiazButtesmap";
...
var Function_64(int iParam0) //Position: 0x328C / 12940
{
...
var Function_65(int iParam0) //Position: 0x32B4 / 12980
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_66(int iParam0, int iParam1) //Position: 0x32CF / 13007
{
	var uVar0;
	var uVar1;
