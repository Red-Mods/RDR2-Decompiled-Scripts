...
void main() //Position: 0x0 / 0
{
	...
	iLocal_355 = 0;
	iLocal_343 = 1000;
	Function_192(&uLocal_337, "p_gen_bottle01x", 0, 0);
	Function_191(&iLocal_366);
	Function_190(&uLocal_370, (3.0f - 1.0f));
	while (!IS_EXITFLAG_SET())
	{
		if (Function_187(&uLocal_370) < 3.0f)
		{
			CLEAR_AREA_OF_GRASS(StackVal, Vector(-803,374f, 13,09f, 3724,813f), 3,5f);
			Function_185(&uLocal_370);
		}
		switch (iLocal_355)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					...
					{
						if (Function_180(&uLocal_337))
						{
							uLocal_364 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_356, "Ricketts1_StayOut", 2,802597E-45f, Vector(-800,828f, 17,941f, 3710,073f), Vector(0.0f, 45,285f, 0.0f), Vector(16,099f, 11,758f, 19,494f));
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_364);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_364);
							uLocal_360 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_356, "StallerProp", "p_gen_bottle01x", Vector(-791,77f, 10,224f, 3693,673f), Vector(0.0f, 0.0f, 0.0f), true);
							iLocal_355 = 1;
							Function_185(&iLocal_366);
						}
						else if (Function_187(&iLocal_366) < 5.0f)
						{
							Function_185(&iLocal_366);
						}
						Function_174(&(Global_99725[2243]), 22, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						uLocal_356 = CREATE_LAYOUT("RCM_Ricketts1_Layout");
					}
				}
				break;
			...
			case 0x00000003:
				if (Function_115("$/cutscene/LANDON_RICKETTS_1_CS_SEQ/LANDON_RICKETTS_1_CS_SEQ", &iLocal_343, 33324, 33317, 30441, 30379, 30108, 30092, 1, 1, 2, 2, 0))
				{
					iLocal_355 = 5;
					Function_185(&iLocal_366);
				}
			...
			case 0x00000005:
				...
				{
					GIVE_OBJECT_TO_LAYOUT(&uLocal_360, &Global_46715);
					*(&Global_99725[2343] + 328) = &uLocal_360;
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Ricketts1_OBJ", 0, 3, false);
			...
			case 0x00000006:
				if (Function_187(&iLocal_366) < 4.0f)
				{
...
void Function_1(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x475 / 1141
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_2(int iParam0) //Position: 0x500 / 1280
{
	char* cVar0[16];
...
bool Function_3() //Position: 0x53F / 1343
{
...
bool Function_4(var uParam0, int iParam1) //Position: 0x55A / 1370
{
	return (uParam0 && iParam1) == 0;
}

void Function_5(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x567 / 1383
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_6(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x9E1 / 2529
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_7() //Position: 0xB82 / 2946
{
	return;
}

void Function_8(var uParam0, int iParam1) //Position: 0xB88 / 2952
{
	if (Global_6624)
	{
		return;
...
void Function_9(bool bParam0) //Position: 0xBC7 / 3015
{
...
void Function_10() //Position: 0xC1C / 3100
{
	Function_38();
	Function_37();
	Function_37();
...
void Function_11() //Position: 0xC67 / 3175
{
...
void Function_12() //Position: 0xD6D / 3437
{
	float fVar0;
...
void Function_13() //Position: 0xDA0 / 3488
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0xF33 / 3891
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_15() //Position: 0x10EC / 4332
{
	Function_16(&Global_42918, 1, 0);
	return;
}

void Function_16(struct<2317> Param0) //Position: 0x10FA / 4346
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_17() //Position: 0x1317 / 4887
{
...
struct<8> Function_18(int iParam0) //Position: 0x132C / 4908
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_19(int iParam0, bool bParam1, bool bParam2) //Position: 0x13D3 / 5075
{
	int iVar0;
...
void Function_20(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x166F / 5743
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_21() //Position: 0x1CAD / 7341
{
	int iVar0;
...
var Function_22(int iParam0) //Position: 0x1CB6 / 7350
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_23(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1CC7 / 7367
{
	char* cVar0[32];
...
struct<32> Function_24(char* cParam0) //Position: 0x1DBE / 7614
{
	char* cVar0[32];
...
void Function_25(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1DD9 / 7641
{
	float fVar0;
...
var Function_26(int iParam0, int iParam1) //Position: 0x1E40 / 7744
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_27(int iParam0, bool bParam1) //Position: 0x1E52 / 7762
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_28(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1E64 / 7780
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_29(int iParam0) //Position: 0x1F98 / 8088
{
	return Global_55480[iParam016].f_96;
}

float Function_30(int iParam0) //Position: 0x1FA7 / 8103
{
	if (!iParam0 != 4294967295)
	{
...
var Function_31(int iParam0) //Position: 0x1FE0 / 8160
{
	if (iParam0 == 4294967295)
	{
...
void Function_32(int iParam0) //Position: 0x201D / 8221
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_33(int iParam0, bool bParam1, bool bParam2) //Position: 0x21B7 / 8631
{
	int iVar0;
	int iVar1;
...
int Function_34(bool bParam0) //Position: 0x23FB / 9211
{
...
struct<8> Function_35() //Position: 0x243C / 9276
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x24C5 / 9413
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_37() //Position: 0x255C / 9564
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_38() //Position: 0x25DB / 9691
{
...
int Function_39(int iParam0, bool bParam1, int iParam2) //Position: 0x2618 / 9752
{
	int iVar0;
	int iVar1;
...
void Function_40() //Position: 0x2824 / 10276
{
	struct<2> Var0;
	var uVar2;
...
bool Function_41(char* cParam0) //Position: 0x28DB / 10459
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_42(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x28F3 / 10483
{
	int iVar0;
...
struct<8> Function_43() //Position: 0x29EB / 10731
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_44(int iParam0) //Position: 0x29F5 / 10741
{
...
int Function_45(bool bParam0, bool bParam1) //Position: 0x2A0B / 10763
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_46(struct<2> Param0, struct<2> Param2) //Position: 0x2AD7 / 10967
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_47(float fParam0, int iParam1) //Position: 0x2AF4 / 10996
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_48(int iParam0) //Position: 0x3320 / 13088
{
	var uVar0;
...
void Function_49(var uParam0, int iParam1) //Position: 0x335B / 13147
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x336A / 13162
{
	uParam0 = &uParam0;
...
void Function_51(int iParam0) //Position: 0x3419 / 13337
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_52(int iParam0) //Position: 0x3D3A / 15674
{
...
bool Function_53(int iParam0) //Position: 0x3D54 / 15700
{
...
bool Function_54(int iParam0, int iParam1) //Position: 0x3D6B / 15723
{
	int iVar0;
...
bool Function_55() //Position: 0x3D88 / 15752
{
	return STRING_TO_HASH(Function_56());
}

var Function_56() //Position: 0x3D94 / 15764
{
	return "ZOMBIE_STORY";
}

bool Function_57(int iParam0) //Position: 0x3DA9 / 15785
{
...
int Function_58(int iParam0) //Position: 0x3E0F / 15887
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_59(int iParam0) //Position: 0x3ED1 / 16081
{
...
void Function_60(int iParam0) //Position: 0x3EE6 / 16102
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x3F2F / 16175
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3F6D / 16237
{
...
bool Function_63(int iParam0) //Position: 0x3F87 / 16263
{
...
void Function_64(bool bParam0) //Position: 0x3F9D / 16285
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_65(struct<229> Param0) //Position: 0x4159 / 16729
{
	float fVar0;
	int iVar1;
...
void Function_66(struct<217> Param0) //Position: 0x4229 / 16937
{
	float fVar0;
	var uVar1;
...
int Function_67(var uParam0, int iParam1) //Position: 0x42E7 / 17127
{
	int iVar0;
	var uVar1;
...
void Function_68(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4451 / 17489
{
	struct<8> Var0;
...
struct<32> Function_69(char* cParam0) //Position: 0x44F9 / 17657
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_70(char* cParam0) //Position: 0x4565 / 17765
{
	char* cVar0[32];
...
int Function_71(int iParam0) //Position: 0x4587 / 17799
{
	int iVar0;
	struct<2> Var1;
...
float Function_72(int iParam0, struct<2> Param1) //Position: 0x46F5 / 18165
{
	struct<2> Var0;
...
struct<8> Function_73(int iParam0) //Position: 0x476C / 18284
{
	struct<2> Var0;
...
void Function_74(int iParam0) //Position: 0x47D8 / 18392
{
...
bool Function_75(int iParam0) //Position: 0x4840 / 18496
{
...
void Function_76(struct<153> Param0) //Position: 0x4856 / 18518
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_79(Function_80(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_78(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_4(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_4(Global_116927[iParam16].f_32, 1))
			{
				...
				if (Global_43789 != Global_99725[iParam143].f_216 && !Function_77())
				{
...
bool Function_77() //Position: 0x4D6C / 19820
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_78(int iParam0) //Position: 0x4D99 / 19865
{
...
var Function_79(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4DC5 / 19909
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_80(int iParam0) //Position: 0x4DE6 / 19942
{
...
bool Function_81(struct<249> Param0) //Position: 0x4DFB / 19963
{
...
bool Function_82(struct<265> Param0) //Position: 0x4F2B / 20267
{
	int iVar0;
...
bool Function_83(int iParam0) //Position: 0x508C / 20620
{
	if (!Function_53(iParam0))
	{
		return 0;
...
bool Function_84(int iParam0) //Position: 0x50B0 / 20656
{
...
bool Function_85(int iParam0) //Position: 0x50C5 / 20677
{
	return Global_116927[iParam06].f_16;
}

bool Function_86(struct<237> Param0) //Position: 0x50D5 / 20693
{
	if (!Param0.f_236)
	{
		if (Function_3())
...
bool Function_87(int iParam0) //Position: 0x51A4 / 20900
{
...
bool Function_88(int iParam0) //Position: 0x51FF / 20991
{
	int iVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x521B / 21019
{
	int iVar0;
...
int Function_90(int iParam0) //Position: 0x5238 / 21048
{
...
int Function_91(int iParam0) //Position: 0x524D / 21069
{
...
void Function_92() //Position: 0x5262 / 21090
{
	if (Function_95(Global_42827))
	{
		if (Global_42827.f_16)
		{
			...
			Global_42827.f_4 = Function_94(Global_42827);
...
int Function_93(int iParam0, int iParam1) //Position: 0x52E2 / 21218
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_94(int iParam0) //Position: 0x5F45 / 24389
{
	int iVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x5F94 / 24468
{
...
int Function_96(int iParam0) //Position: 0x5FAA / 24490
{
...
void Function_97() //Position: 0x6013 / 24595
{
...
bool Function_98(int iParam0) //Position: 0x6038 / 24632
{
	if (!Function_95(iParam0))
	{
...
bool Function_99(int iParam0, int iParam1) //Position: 0x6089 / 24713
{
	int iVar0;
...
bool Function_100(int iParam0) //Position: 0x60B6 / 24758
{
	if (!Function_95(iParam0))
	{
...
void Function_101(bool bParam0) //Position: 0x6108 / 24840
{
	int iVar0;
...
void Function_102() //Position: 0x6142 / 24898
{
	bool bVar0;
...
void Function_103(int iParam0, int iParam1) //Position: 0x61A0 / 24992
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_104(int iParam0) //Position: 0x61B6 / 25014
{
	PRINTSTRING("Day ");
...
void Function_105(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6200 / 25088
{
	bool bVar0;
	char* cVar1[16];
...
void Function_106(char* cParam0) //Position: 0x6275 / 25205
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_107(int iParam0, var uParam1, int iParam2) //Position: 0x62AF / 25263
{
	var uVar0;
	char* cVar1[16];
...
int Function_108(char* cParam0) //Position: 0x632B / 25387
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_109(int iParam0) //Position: 0x63CC / 25548
{
	int iVar0;
	int iVar1;
...
bool Function_110(var uParam0, int iParam1) //Position: 0x6409 / 25609
{
...
int Function_111(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x641C / 25628
{
	int iVar0;
	int iVar1;
...
void Function_112(int iParam0) //Position: 0x6644 / 26180
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_113(bool bParam0, bool bParam1) //Position: 0x66E2 / 26338
{
	bool bVar0;
...
void Function_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6707 / 26375
{
	struct<4> Var0;
	var uVar4;
...
bool Function_115(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x679C / 26524
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_116(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6855 / 26709
{
	if (!&bParam15)
	{
...
void Function_117(var uParam0, bool bParam1) //Position: 0x6EB7 / 28343
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_118() //Position: 0x6F86 / 28550
{
	int iVar0;
...
void Function_119() //Position: 0x6FFE / 28670
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_120() //Position: 0x7043 / 28739
{
...
void Function_121(bool bParam0) //Position: 0x7055 / 28757
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_122(var uParam0, int iParam1) //Position: 0x7072 / 28786
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_123(int iParam0) //Position: 0x7104 / 28932
{
	bool bVar0;
...
int Function_124(bool bParam0) //Position: 0x7135 / 28981
{
	bool bVar0;
	var uVar1;
...
bool Function_125() //Position: 0x71F8 / 29176
{
	bool bVar0;
	var uVar1;
...
bool Function_126(struct<37> Param0) //Position: 0x7235 / 29237
{
	return Param0.f_36;
}

void Function_127(var uParam0, int iParam1) //Position: 0x7240 / 29248
{
	Function_128(&uParam0, &iParam1, 0);
	return;
}

void Function_128(var uParam0, bool bParam1, bool bParam2) //Position: 0x7250 / 29264
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x73C8 / 29640
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x73F2 / 29682
{
	var uVar0;
	var uVar1;
...
void Function_131() //Position: 0x744D / 29773
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_132() //Position: 0x758C / 30092
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x759C / 30108
{
...
void Function_134(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x75C7 / 30151
{
	var uVar0;
...
void Function_135() //Position: 0x7696 / 30358
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x76AB / 30379
{
	...
	if (IS_ACTOR_ALIVE(&uLocal_358))
	{
		KILL_ACTOR(&uLocal_358);
	}
	return 1;
}

int Function_137() //Position: 0x76E9 / 30441
{
	var uVar0;
	bool bVar1;
	...
	{
		Function_148();
		Function_143(StackVal, Vector(-779,135f, 13,075f, 3722,793f), &uLocal_362);
		iLocal_375 = 1;
	}
	if (!bLocal_376)
	{
		...
		{
			bVar1 = false;
			while (bVar1 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
			{
				uVar0 = CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR(bVar1);
				if (GET_ACTOR_ENUM(&uVar0) == 1211)
				{
					uLocal_358 = &uVar0;
					bVar1 = 999999;
				}
...
void Function_138(var uParam0, bool bParam1) //Position: 0x7778 / 30584
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		{
			if (((Function_142() || Function_141(&uParam0)) || Function_140(&uParam0)) || Function_139(&uParam0, 1))
			{
			...
			{
				uVar2 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uParam0, Function_21(), 2, Var0, Vector(0.0f, 0.0f, 0.0f), Vector(0,5f, 0,5f, 0,5f));
			...
			Function_43();
			iVar4 = CREATE_RMPTFX_EMITTER_ON_BONE(Function_21(), "blood_zombie_shotgun_exit", "head", &uParam0, Function_43(), &uParam0);
			if (IS_OBJECT_VALID(&iVar4))
			{
				Function_43();
				UNK_0x6745191B(&iVar4, Function_43());
			}
		}
	}
	return;
...
int Function_139(var uParam0, int iParam1) //Position: 0x796A / 31082
{
	bool bVar0;
...
int Function_140(int iParam0) //Position: 0x79AF / 31151
{
	bool bVar0;
...
int Function_141(int iParam0) //Position: 0x79D0 / 31184
{
	bool bVar0;
...
var Function_142() //Position: 0x79F1 / 31217
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

void Function_143(vector3 vParam0) //Position: 0x7A04 / 31236
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_144(int iParam0, int iParam1) //Position: 0x7BAD / 31661
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_145(float fParam0, float fParam1) //Position: 0x7CA2 / 31906
{
...
void Function_146() //Position: 0x7DB3 / 32179
{
...
void Function_147() //Position: 0x7DE7 / 32231
{
...
void Function_148() //Position: 0x7EED / 32493
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_150(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0), Var1, Var3, Var5, Var7);
		}
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_149(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_149(char* cParam0) //Position: 0x7F83 / 32643
{
	char* cVar0[64];
...
void Function_150(char* cParam0) //Position: 0x80B9 / 32953
{
	char* cVar0[64];
...
int Function_151() //Position: 0x8225 / 33317
{
	return 1;
}

int Function_152() //Position: 0x822C / 33324
{
	...
	uLocal_362 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_356, "Ricketts1_CSVol", 2,802597E-45f, Vector(-798,251f, 17,941f, 3714,445f), Vector(0.0f, 45,285f, 0.0f), Vector(18,363f, 11,758f, 27,582f));
	Function_155(0, 0, 1, 1, 0, 1, 1, &uLocal_362, 1, 1, 1, 1, 0x3f800000, 0);
	Function_153(StackVal, &uLocal_356, *(&Global_99725[2243] + 196), &uLocal_362, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_153(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x82D8 / 33496
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_154(var uParam0, float fParam1) //Position: 0x8578 / 34168
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_155(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x85FA / 34298
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_158(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_21(), 2, Function_158(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_156(int iParam0) //Position: 0x88AC / 34988
{
	int iVar0;
...
var Function_157() //Position: 0x88E0 / 35040
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_158(bool bParam0) //Position: 0x896E / 35182
{
	struct<2> Var0;
...
bool Function_159(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8980 / 35200
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_160(vector3 vParam0) //Position: 0x8BB5 / 35765
{
	var uVar0;
...
float Function_161(var uParam0, bool bParam1) //Position: 0x8C2B / 35883
{
	struct<2> Var0;
...
void Function_162(var uParam0, bool bParam1) //Position: 0x8C4C / 35916
{
	var uVar0;
	var uVar1;
...
bool Function_163(int iParam0, bool bParam1, bool bParam2) //Position: 0x8CB6 / 36022
{
...
bool Function_164() //Position: 0x8D7A / 36218
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_165(int iParam0) //Position: 0x8D91 / 36241
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_166(bool bParam0) //Position: 0x8D9D / 36253
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_167() //Position: 0x8DAC / 36268
{
	if (IS_LAYOUTREF_VALID(&uLocal_356))
	{
		DESTROY_OBJECT(&uLocal_356);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_169(&uLocal_337);
	if (bLocal_374)
	{
	}
	Function_168(0, 0, 0);
...
int Function_168(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8DDB / 36315
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_169(int iParam0) //Position: 0x8E0D / 36365
{
	int iVar0;
...
void Function_170(struct<2>[] Param0, int iParam1) //Position: 0x8E35 / 36405
{
	if (Function_172(&(Param0[iParam12]), 4))
	{
		if (Function_172(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_171(&(Param0[iParam12]), 1);
			Function_171(&(Param0[iParam12]), 2);
			Function_171(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_171(struct<13> Param0) //Position: 0x8F80 / 36736
{
	int iVar0;
...
bool Function_172(struct<13> Param0) //Position: 0x8F9D / 36765
{
	int iVar0;
...
void Function_173(var uParam0, bool bParam1) //Position: 0x8FBB / 36795
{
	uParam0 = (uParam0 || bParam1);
	return;
}

int Function_174(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) //Position: 0x8FCC / 36812
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_175(struct<257> Param0) //Position: 0x916F / 37231
{
...
int Function_176(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, int iParam12) //Position: 0x91AB / 37291
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_177() //Position: 0x9413 / 37907
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
bool Function_178(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9467 / 37991
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_73(&uParam0);
...
int Function_179() //Position: 0x94F3 / 38131
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_180(struct<2>[] Param0) //Position: 0x9502 / 38146
{
	int iVar0;
	int iVar1;
	...
	Function_184();
	iVar1 = 0;
	if (!Function_172(&(Param0[iVar02]), 16))
	{
	...
	{
		if (Function_172(&(Param0[iVar02]), 4))
		{
			if (!Function_172(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_172(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_172(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_181() //Position: 0x98C4 / 39108
{
	if (!Function_88(128))
	{
		return;
...
bool Function_182() //Position: 0x9904 / 39172
{
	int iVar0;
...
void Function_183(struct<13> Param0) //Position: 0x9932 / 39218
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_184() //Position: 0x9945 / 39237
{
	if (!Function_88(128))
	{
		return;
...
void Function_185(int iParam0) //Position: 0x9987 / 39303
{
	Function_186(&iParam0, 0.0f);
	return;
}

void Function_186(vector3 vParam0) //Position: 0x9994 / 39316
{
...
float Function_187(vector3 vParam0) //Position: 0x99B9 / 39353
{
...
bool Function_188(int iParam0) //Position: 0x9A86 / 39558
{
	return Function_4(iParam0, 2);
}

bool Function_189(int iParam0) //Position: 0x9A94 / 39572
{
	return Function_4(iParam0, 1);
}

void Function_190(int iParam0, float fParam1) //Position: 0x9AA2 / 39586
{
...
void Function_191(int iParam0) //Position: 0x9ABA / 39610
{
	if (!Function_189(&iParam0))
	{
		Function_186(&iParam0, 0.0f);
...
var Function_192(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x9AD1 / 39633
{
	int iVar0;
	var uVar1;
...
var Function_193(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x9B0F / 39695
{
	int iVar0;
