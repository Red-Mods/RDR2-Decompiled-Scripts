...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			bVar0 = Function_52(&Param0 + 24, &Param0 + 16, bVar29);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_42(&Param0, &uVar7, &iLocal_118, &uLocal_116);
		...
		case 0x00000006:
			...
			bVar0 = Function_52(&Param0 + 24, &Param0 + 16, Function_75(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_22(int iParam0, char* cParam1) //Position: 0x1F65 / 8037
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	{
		if ((!IS_ACTOR_PLAYER(&iParam0) && !IS_PERS_CHAR_VALID(GET_PERS_CHAR_FROM_ACTOR(&iParam0))) && !Function_26(&iParam0))
		{
			uVar1 = Function_9(&cParam1, "GiveSmallBrainScript", &bVar0);
			if (bVar0)
			{
				bVar2 = true;
				if (STRING_CONTAINS_STRING(&uVar1, "Drun"))
				{
				}
				if (bVar2)
				{
					DISABLE_GRINGO_STREAMING_CHECKS();
					uVar3 = Function_25(&cParam1, "ChanceToGiveSmallBrain", 100);
					Function_23(&iParam0, &uVar1, uVar3);
...
int Function_23(var uParam0, bool bParam1, int iParam2) //Position: 0x2005 / 8197
{
	bool bVar0;
	...
	return Function_24(&uParam0, &bParam1);
}

int Function_24(int iParam0, char* cParam1) //Position: 0x202C / 8236
{
	var uVar0;
	char* cVar1[64];
	int iVar17;
	...
	uVar0 = FIND_OBJECT_IN_OBJECT(GET_OBJECT_FROM_ACTOR(&iParam0), "Small_Brain");
	if (IS_OBJECT_VALID(&uVar0))
	{
		return 0;
	}
	uVar0 = FIND_OBJECT_IN_OBJECT(GET_OBJECT_FROM_ACTOR(&iParam0), "Persistent_Char_Brain");
	if (IS_OBJECT_VALID(&uVar0))
	{
		return 0;
	}
	...
	iVar17 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, GET_OBJECT_FROM_ACTOR(&iParam0), "Small_Brain", &cVar1, Vector(0.0f, 1,5f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	if (IS_OBJECT_VALID(&iVar17))
	{
...
var Function_25(var uParam0, var uParam1, int iParam2) //Position: 0x213E / 8510
{
	int iVar0;
...
bool Function_26(int iParam0) //Position: 0x2156 / 8534
{
...
float Function_27(int iParam0) //Position: 0x21A9 / 8617
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_28() //Position: 0x21C0 / 8640
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_29(int iParam0) //Position: 0x21CD / 8653
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_30(int iParam0, bool bParam1) //Position: 0x21EE / 8686
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_31(bool bParam0) //Position: 0x2201 / 8705
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_32() //Position: 0x2221 / 8737
{
	return;
}

void Function_33(int iParam0, bool bParam1) //Position: 0x2227 / 8743
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_34(char* cParam0) //Position: 0x2239 / 8761
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_35(int iParam0) //Position: 0x2246 / 8774
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_36(char* cParam0, int iParam1) //Position: 0x2261 / 8801
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_37(int iParam0) //Position: 0x2281 / 8833
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_38(int iParam0) //Position: 0x22A1 / 8865
{
	int iVar0;
	int iVar1;
...
bool Function_39(int iParam0) //Position: 0x22D8 / 8920
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_40(int iParam0) //Position: 0x22F8 / 8952
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x2313 / 8979
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2329 / 9001
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_43() //Position: 0x264D / 9805
{
	int iVar0;
...
bool Function_44(char* cParam0, int iParam1) //Position: 0x2656 / 9814
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_45() //Position: 0x2675 / 9845
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x2684 / 9860
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_47(char* cParam0, int iParam1) //Position: 0x26A8 / 9896
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_48(int iParam0) //Position: 0x26CE / 9934
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x26EC / 9964
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_50(var uParam0, int iParam1) //Position: 0x270E / 9998
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_51(bool bParam0, int iParam1) //Position: 0x2730 / 10032
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_52(var uParam0, int iParam1, bool bParam2) //Position: 0x27F8 / 10232
{
	int iVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x2874 / 10356
{
...
void Function_54(vector3 vParam0) //Position: 0x288C / 10380
{
...
var Function_55(int iParam0) //Position: 0x28B1 / 10417
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_56(vector3 vParam0) //Position: 0x28D2 / 10450
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x28E9 / 10473
{
	uParam0 = &uParam0;
	return;
}

int Function_58() //Position: 0x28F5 / 10485
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x28FC / 10492
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_60(int iParam0, var uParam1, int iParam2) //Position: 0x290D / 10509
{
	bool bVar0;
...
int Function_61(int iParam0) //Position: 0x2952 / 10578
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(int iParam0) //Position: 0x297E / 10622
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_63(int iParam0) //Position: 0x298A / 10634
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_64(int iParam0) //Position: 0x2A8C / 10892
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_65(int iParam0) //Position: 0x2AAF / 10927
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(int iParam0) //Position: 0x2AD7 / 10967
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	while (bVar7 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(&uVar8))
		{
			...
			{
				Function_68(StackVal, StackVal, Var2, Var11);
				Var2 = Function_68(StackVal, StackVal, Var2, Var11);
				Function_67(StackVal, StackVal, Var0, Var11);
				Var0 = Function_67(StackVal, StackVal, Var0, Var11);
			}
		}
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &fVar19, Function_43(), Var13, Vector(0.0f, 0.0f, 0.0f));
		...
		if (bVar22)
		{
			...
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_43(), Var28, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
...
struct<8> Function_67(vector3 vParam0) //Position: 0x2DBE / 11710
{
	struct<2> Var0;
...
struct<8> Function_68(vector3 vParam0) //Position: 0x2E1B / 11803
{
	struct<2> Var0;
...
void Function_69(int iParam0) //Position: 0x2E78 / 11896
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2E84 / 11908
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2EA3 / 11939
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(float fParam0, int iParam1) //Position: 0x2EBA / 11962
{
	struct<2> Var0;
	float fVar2;
	struct<2> Var3;
	...
	Var3.f_4 = fVar2;
	SET_OBJECT_POSITION_ON_GROUND(&fParam0, Var0);
	SET_OBJECT_ORIENTATION(&fParam0, Var3);
	return 1;
}

bool Function_73(var uParam0, int iParam1) //Position: 0x2EF5 / 12021
{
...
int Function_74(var uParam0) //Position: 0x2F23 / 12067
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x303C / 12348
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3049 / 12361
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30CB / 12491
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3676 / 13942
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x36B0 / 14000
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x36CE / 14030
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x370F / 14095
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x371B / 14107
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x373D / 14141
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x374F / 14159
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x385F / 14431
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3877 / 14455
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B93 / 15251
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3BA5 / 15269
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3BBF / 15295
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3BDA / 15322
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C18 / 15384
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C31 / 15409
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F29 / 16169
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F47 / 16199
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3FE7 / 16359
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4018 / 16408
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x402B / 16427
{
...
void Function_98(int iParam0) //Position: 0x4047 / 16455
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4053 / 16467
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x40BF / 16575
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x40D7 / 16599
{
	iParam0 = &iParam0;
	return;
}

void Function_102(bool bParam0) //Position: 0x40E3 / 16611
{
