...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("Nosalida_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "nosv_dogs_set");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 10, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("nos_pop: Cannot find nosv_dogs to create dogs");
		}
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "nosv_goats_set");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 10, 0, 0, 1);
		}
...
void Function_1(var uParam0, var uParam1) //Position: 0xC65 / 3173
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC76 / 3190
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCCE / 3278
{
	var uVar0;
...
void Function_5(char* cParam0) //Position: 0xD7A / 3450
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDBA / 3514
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDD7 / 3543
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDE8 / 3560
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE2F / 3631
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE3C / 3644
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xEBE / 3774
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xECD / 3789
{
	if (!Function_4(128))
	{
		return;
