...
void main() //Position: 0x0 / 0
{
	...
	iLocal_358 = 0;
	iLocal_346 = 1000;
	Function_186(&uLocal_336, "p_gen_pitchfork01x", 0, 0);
	Function_186(&uLocal_336, "p_gen_shovel02x", 0, 0);
	Function_185(&iLocal_383);
	Function_185(&bLocal_387);
	Function_185(&iLocal_391);
		...
		switch (iLocal_358)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					...
					{
						uLocal_381 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "Bonnie1_StayOut", 2,802597E-45f, Vector(-788,633f, 95,525f, 2411,045f), Vector(0.0f, -35,023f, 0.0f), Vector(14,953f, 7,088f, 14,799f));
						...
						uLocal_361 = CREATE_OBJECTSET_IN_LAYOUT("Bonnie1_HorseSet", &uLocal_359, 15, 1);
						Function_171(&(Global_99725[1243]), 12, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
						iLocal_358 = 1;
						Function_169(&iLocal_383);
					}
					else
					{
						uLocal_359 = CREATE_LAYOUT("RCM_Bonnie_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				{
					Function_168(&Global_99725[ScriptParam_043] + 228, 128);
				...
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (StackVal && FABS((StackVal - !Function_158(&Global_54076, 1, 1))) > 2.0f)
					{
						if (Function_154(&Global_99725[ScriptParam_043] + 288, 0, 1, 1, 1, 0))
						{
						...
						else if (Function_151(&iLocal_383) < 5.0f)
						{
							Function_169(&iLocal_383);
						}
					}
			...
			case 0x00000003:
				if (Function_116("$/cutscene/bonnie_rcm_1_pt_a_cs/bonnie_rcm_1_pt_a_cs", &iLocal_346, 31648, 31641, 30336, 30322, 30056, 30040, 1, 1, 2, 2, 0))
				{
					Function_168(&Global_99725[1243] + 228, 512);
					if (IS_ACTOR_VALID(&Global_99725[1243] + 312))
					{
						DESTROY_ACTOR(&Global_99725[1243] + 312);
					}
					Function_115(1.0f);
					iLocal_358 = 5;
					Function_169(&iLocal_383);
			...
			case 0x00000005:
				...
				{
					Function_168(&Global_99725[1243] + 228, 256);
					Function_114("Bonnie1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "bonnie1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x442 / 1090
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x8BC / 2236
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xA5D / 2653
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xA63 / 2659
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xAA2 / 2722
{
...
void Function_6() //Position: 0xAF7 / 2807
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_7() //Position: 0xB42 / 2882
{
...
void Function_8() //Position: 0xC48 / 3144
{
	float fVar0;
...
void Function_9() //Position: 0xC7B / 3195
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0xE0E / 3598
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0xFC7 / 4039
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0xFD5 / 4053
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x11F2 / 4594
{
...
struct<8> Function_14(int iParam0) //Position: 0x1207 / 4615
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x12AE / 4782
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x154A / 5450
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_17() //Position: 0x1B88 / 7048
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x1B91 / 7057
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1BA2 / 7074
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x1C99 / 7321
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1CB4 / 7348
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x1D1B / 7451
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x1D2D / 7469
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1D3F / 7487
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x1E73 / 7795
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x1E82 / 7810
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x1EBB / 7867
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x1EF8 / 7928
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x2092 / 8338
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x22D6 / 8918
{
...
struct<8> Function_31() //Position: 0x2317 / 8983
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x23A0 / 9120
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x2437 / 9271
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x24B6 / 9398
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x24F3 / 9459
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x26FF / 9983
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x27B6 / 10166
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x27CE / 10190
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x28C6 / 10438
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_40(int iParam0) //Position: 0x28D0 / 10448
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x28E6 / 10470
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x29B2 / 10674
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x29CF / 10703
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x31FB / 12795
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x3236 / 12854
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x3243 / 12867
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3252 / 12882
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x3301 / 13057
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
...
var Function_52() //Position: 0x3C70 / 15472
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x3C7C / 15484
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x3C91 / 15505
{
...
int Function_55(int iParam0) //Position: 0x3CF7 / 15607
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_56(int iParam0) //Position: 0x3DB9 / 15801
{
...
void Function_57(int iParam0) //Position: 0x3DCE / 15822
{
...
bool Function_58(int iParam0, bool bParam1) //Position: 0x3E17 / 15895
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x3E55 / 15957
{
...
bool Function_60(int iParam0) //Position: 0x3E6F / 15983
{
...
void Function_61(int iParam0) //Position: 0x3E85 / 16005
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_45(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_168(&Global_99725[iVar143] + 228, 64);
...
void Function_62(struct<229> Param0) //Position: 0x4040 / 16448
{
	float fVar0;
	int iVar1;
...
void Function_63(struct<217> Param0) //Position: 0x4110 / 16656
{
	float fVar0;
	var uVar1;
...
int Function_64(var uParam0, int iParam1) //Position: 0x41CE / 16846
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4338 / 17208
{
	struct<8> Var0;
...
struct<32> Function_66(char* cParam0) //Position: 0x43E0 / 17376
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x444C / 17484
{
	char* cVar0[32];
...
int Function_68(int iParam0) //Position: 0x446E / 17518
{
	int iVar0;
	struct<2> Var1;
...
float Function_69(int iParam0, struct<2> Param1) //Position: 0x45DC / 17884
{
	struct<2> Var0;
...
struct<8> Function_70(int iParam0) //Position: 0x4653 / 18003
{
	struct<2> Var0;
...
void Function_71(int iParam0) //Position: 0x46BF / 18111
{
...
bool Function_72(int iParam0) //Position: 0x4727 / 18215
{
...
void Function_73(struct<153> Param0) //Position: 0x473D / 18237
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
void Function_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4C53 / 19539
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x4CDE / 19678
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x4D1D / 19741
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(int iParam0) //Position: 0x4D4A / 19786
{
...
var Function_78(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4D76 / 19830
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_79(int iParam0) //Position: 0x4D97 / 19863
{
...
bool Function_80(struct<249> Param0) //Position: 0x4DAC / 19884
{
	...
	{
		Function_168(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_81(struct<265> Param0) //Position: 0x4EDC / 20188
{
	int iVar0;
...
bool Function_82(int iParam0) //Position: 0x503D / 20541
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_83(int iParam0) //Position: 0x5061 / 20577
{
...
bool Function_84(int iParam0) //Position: 0x5076 / 20598
{
	return Global_116927[iParam06].f_16;
}

bool Function_85(struct<237> Param0) //Position: 0x5086 / 20614
{
	if (!Param0.f_236)
	{
		if (Function_110())
...
bool Function_86(int iParam0) //Position: 0x5155 / 20821
{
...
bool Function_87(int iParam0) //Position: 0x51B0 / 20912
{
	int iVar0;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x51CC / 20940
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x51E9 / 20969
{
...
int Function_90(int iParam0) //Position: 0x51FE / 20990
{
...
void Function_91() //Position: 0x5213 / 21011
{
...
int Function_92(int iParam0, int iParam1) //Position: 0x5293 / 21139
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_93(int iParam0) //Position: 0x5EF6 / 24310
{
	int iVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x5F45 / 24389
{
...
int Function_95(int iParam0) //Position: 0x5F5B / 24411
{
...
void Function_96() //Position: 0x5FC4 / 24516
{
...
bool Function_97(int iParam0) //Position: 0x5FE9 / 24553
{
	if (!Function_94(iParam0))
	{
...
bool Function_98(int iParam0, int iParam1) //Position: 0x603A / 24634
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x6067 / 24679
{
	if (!Function_94(iParam0))
	{
...
void Function_100(int iParam0) //Position: 0x60B9 / 24761
{
	int iVar0;
...
void Function_101() //Position: 0x60F3 / 24819
{
	bool bVar0;
...
void Function_102(int iParam0, int iParam1) //Position: 0x6151 / 24913
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_103(int iParam0) //Position: 0x6167 / 24935
{
	PRINTSTRING("Day ");
...
void Function_104(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x61B1 / 25009
{
	bool bVar0;
	char* cVar1[16];
...
void Function_105(char* cParam0) //Position: 0x6226 / 25126
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_106(int iParam0, var uParam1, int iParam2) //Position: 0x6260 / 25184
{
	var uVar0;
	char* cVar1[16];
...
int Function_107(char* cParam0) //Position: 0x62DC / 25308
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_108(int iParam0) //Position: 0x637D / 25469
{
	int iVar0;
	int iVar1;
...
bool Function_109(int iParam0, int iParam1) //Position: 0x63BA / 25530
{
...
bool Function_110() //Position: 0x63CD / 25549
{
...
int Function_111(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x63E8 / 25576
{
	int iVar0;
	int iVar1;
...
void Function_112(int iParam0) //Position: 0x6610 / 26128
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_113(char* cParam0, bool bParam1) //Position: 0x66AE / 26286
{
	bool bVar0;
...
void Function_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x66D3 / 26323
{
	struct<4> Var0;
	var uVar4;
...
void Function_115(bool bParam0) //Position: 0x6768 / 26472
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6785 / 26501
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_117(var uParam0, int iParam1, struct<41> Param2) //Position: 0x683E / 26686
{
	if (!&bParam15)
	{
...
void Function_118(var uParam0, bool bParam1) //Position: 0x6EA0 / 28320
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_119() //Position: 0x6F6F / 28527
{
	int iVar0;
...
void Function_120() //Position: 0x6FE7 / 28647
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_121() //Position: 0x702C / 28716
{
...
void Function_122(var uParam0, int iParam1) //Position: 0x703E / 28734
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_123(int iParam0) //Position: 0x70D0 / 28880
{
	bool bVar0;
...
int Function_124(bool bParam0) //Position: 0x7101 / 28929
{
	bool bVar0;
	var uVar1;
...
bool Function_125() //Position: 0x71C4 / 29124
{
	bool bVar0;
	var uVar1;
...
bool Function_126(struct<37> Param0) //Position: 0x7201 / 29185
{
	return Param0.f_36;
}

void Function_127(var uParam0, int iParam1) //Position: 0x720C / 29196
{
	Function_128(&uParam0, &iParam1, 0);
	return;
}

void Function_128(var uParam0, bool bParam1, bool bParam2) //Position: 0x721C / 29212
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7394 / 29588
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x73BE / 29630
{
	var uVar0;
	var uVar1;
...
void Function_131() //Position: 0x7419 / 29721
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_132() //Position: 0x7558 / 30040
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x7568 / 30056
{
...
void Function_134(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x758E / 30094
{
	var uVar0;
...
void Function_135() //Position: 0x765D / 30301
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x7672 / 30322
{
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_137() //Position: 0x7680 / 30336
{
	struct<2> Var0;
	
	Var0 = Vector(-781,843f, 92,467f, 2427,425f);
	if (!iLocal_459)
	{
		Function_138(StackVal, Var0, &uLocal_379);
		iLocal_459 = 1;
	}
	return 1;
}

void Function_138(vector3 vParam0) //Position: 0x76B0 / 30384
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_139(int iParam0, int iParam1) //Position: 0x7859 / 30809
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_140(float fParam0, float fParam1) //Position: 0x794E / 31054
{
...
void Function_141() //Position: 0x7A5F / 31327
{
...
void Function_142() //Position: 0x7A93 / 31379
{
...
int Function_143() //Position: 0x7B99 / 31641
{
	return 1;
}

int Function_144() //Position: 0x7BA0 / 31648
{
	uLocal_379 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "Bonnie1CSVol", 2,802597E-45f, Vector(-790,0453f, 93,30781f, 2410,738f), Vector(0.0f, -125,742f, 0.0f), Vector(21,22061f, 15,24588f, 22,38816f));
	Function_147(0, 0, 1, 1, 0, 1, 1, &uLocal_379, 1, 1, 1, 1, 0x3f800000, 0);
	Function_145(StackVal, &uLocal_359, *(&Global_99725[1243] + 196), &uLocal_379, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	return 1;
}

void Function_145(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7C45 / 31813
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_146(var uParam0, float fParam1) //Position: 0x7EE5 / 32485
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_147(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7F67 / 32615
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_150(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_17(), 2, Function_150(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_148(int iParam0) //Position: 0x821B / 33307
{
	int iVar0;
...
var Function_149() //Position: 0x824F / 33359
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_150(int iParam0) //Position: 0x82DD / 33501
{
	struct<2> Var0;
...
float Function_151(vector3 vParam0) //Position: 0x82EF / 33519
{
...
bool Function_152(int iParam0) //Position: 0x83BC / 33724
{
	return Function_45(iParam0, 2);
}

bool Function_153(bool bParam0) //Position: 0x83CA / 33738
{
	return Function_45(bParam0, 1);
}

bool Function_154(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x83D8 / 33752
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_157(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_156(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_155(vector3 vParam0) //Position: 0x860D / 34317
{
	var uVar0;
...
float Function_156(var uParam0, bool bParam1) //Position: 0x8683 / 34435
{
	struct<2> Var0;
...
void Function_157(var uParam0, bool bParam1) //Position: 0x86A4 / 34468
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_156(&uParam0, 0) < 2.0f)
	{
...
bool Function_158(int iParam0, bool bParam1, bool bParam2) //Position: 0x870E / 34574
{
...
bool Function_159() //Position: 0x87D2 / 34770
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_160(int iParam0) //Position: 0x87E9 / 34793
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_161(bool bParam0) //Position: 0x87F5 / 34805
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_162() //Position: 0x8804 / 34820
{
	Function_164(&uLocal_336);
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	if (IS_LAYOUTREF_VALID(&uLocal_359))
	{
...
int Function_163(bool bParam0, bool bParam1, bool bParam2) //Position: 0x882D / 34861
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_164(int iParam0) //Position: 0x885F / 34911
{
	int iVar0;
...
void Function_165(struct<2>[] Param0, int iParam1) //Position: 0x8887 / 34951
{
	if (Function_167(&(Param0[iParam12]), 4))
	{
		if (Function_167(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_166(&(Param0[iParam12]), 1);
			Function_166(&(Param0[iParam12]), 2);
			Function_166(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_166(struct<13> Param0) //Position: 0x89D2 / 35282
{
	int iVar0;
...
bool Function_167(struct<13> Param0) //Position: 0x89EF / 35311
{
	int iVar0;
...
void Function_168(var uParam0, int iParam1) //Position: 0x8A0D / 35341
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_169(int iParam0) //Position: 0x8A1E / 35358
{
	Function_170(&iParam0, 0.0f);
	return;
}

void Function_170(vector3 vParam0) //Position: 0x8A2B / 35371
{
...
int Function_171(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) //Position: 0x8A50 / 35408
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == iParam1)
				{
					...
					uVar2 = Function_173(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == iParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_173(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
...
int Function_172(struct<257> Param0) //Position: 0x8BF3 / 35827
{
...
int Function_173(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, int iParam12) //Position: 0x8C2F / 35887
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_174() //Position: 0x8E97 / 36503
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_175(char* cParam0) //Position: 0x8EEB / 36587
{
	char* cVar0[64];
...
bool Function_176(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9014 / 36884
{
...
int Function_177() //Position: 0x90A0 / 37024
{
	if (IS_PS3())
	{
		return 1;
...
void Function_178() //Position: 0x90AF / 37039
{
	var uVar0;
	int iVar1;
	bool bVar2;
	
	if (!Function_153(&bLocal_387) || !IS_OBJECTSET_VALID(&uLocal_361))
	{
		return;
	}
	if (Function_151(&bLocal_387) > 2.0f)
	{
		return;
	}
	Function_179(&uLocal_361);
	if (IS_VOLUME_VALID(&uLocal_381))
	{
		iVar1 = LOCATE_ACTORS_IN_VOLUME(&uLocal_381, &uLocal_361, 0, 1);
	}
	bVar2 = false;
	while (bVar2 <= iVar1)
	{
		uVar0 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar2, &uLocal_361));
		if (IS_ACTOR_VALID(&uVar0))
		{
			if (IS_ACTOR_HORSE(&uVar0))
			{
				SET_ACTOR_STAY_OUTSIDE_OF_VOLUME(&uVar0, &uLocal_381, 2, 1);
			}
		}
		bVar2++;
	}
...
void Function_179(var uParam0) //Position: 0x9135 / 37173
{
	var uVar0;
...
void Function_180() //Position: 0x9175 / 37237
{
	var uVar0;
	int iVar2;
	
	uVar0 = Vector(-785,761f, 93,743f, 2407,57f);
	if (!Function_184(Global_46816[0]))
	{
		return;
	}
	iVar2 = 0;
	while (iVar2 <= 6)
	{
		if (!IS_DOOR_VALID(&(uLocal_363[iVar2])))
		{
			uLocal_363[iVar2] = Function_182("hennigansRanch", &(Local_395[iVar24]), iLocal_445[iVar2]);
		}
		if (IS_DOOR_VALID(&(uLocal_363[iVar2])))
		{
			if (!IS_DOOR_CLOSED(&(uLocal_363[iVar2])))
			{
				if (!IS_DOOR_CLOSING(&(uLocal_363[iVar2])))
				{
					CLOSE_DOOR_FAST(&(uLocal_363[iVar2]));
				}
			}
			if (!IS_DOOR_LOCKED(&(uLocal_363[iVar2])))
			{
				Function_181(&(uLocal_363[iVar2]), 1);
			}
		}
		iVar2++;
	}
	if (!IS_DOOR_VALID(&iLocal_377))
	{
		iLocal_377 = FIND_NEAREST_DOOR(&uVar0, 2.0f);
	}
	if (IS_DOOR_VALID(&iLocal_377))
	{
		SET_DOOR_LOCK_VISIBLE(&iLocal_377, 0);
	}
	return;
}

void Function_181(var uParam0, int iParam1) //Position: 0x9260 / 37472
{
...
int Function_182(var uParam0, var uParam1, int iParam2) //Position: 0x92BB / 37563
{
	return Function_183(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_183(int iParam0, char* cParam1, bool bParam3) //Position: 0x92CF / 37583
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_184(int iParam0) //Position: 0x9374 / 37748
{
	if (!Function_72(iParam0))
	{
		return 1;
...
void Function_185(int iParam0) //Position: 0x9390 / 37776
{
...
var Function_186(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x93A7 / 37799
{
	int iVar0;
	var uVar1;
...
void Function_187(struct<13> Param0) //Position: 0x93E5 / 37861
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_188(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x93F8 / 37880
{
	int iVar0;
	...
	{
		if (!Function_167(&(Param0[iVar02]), 4))
		{
...
void Function_189() //Position: 0x94C7 / 38087
{
	strcpy(&(Local_395[04]), "barn01", 16);
	strcpy(&(Local_395[14]), "barn01", 16);
	strcpy(&(Local_395[24]), "barn01", 16);
	strcpy(&(Local_395[34]), "barn01", 16);
	strcpy(&(Local_395[44]), "barn01props", 16);
	strcpy(&(Local_395[54]), "barn01props", 16);
	iLocal_445[0] = 1;
	iLocal_445[1] = 2;
	iLocal_445[2] = 3;
	iLocal_445[3] = 4;
