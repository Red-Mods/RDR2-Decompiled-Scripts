...
bool Function_15() //Position: 0x411 / 1041
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_24(Global_46838[0], &iLocal_35 + 4, &iLocal_35 + 40, &iLocal_35 + 48))
			{
				Function_23(&iLocal_35 + 4);
				Function_22(Global_46838[0]);
				(&iLocal_35 + 64[02]) = Function_22(Global_46838[0]);
				Function_21(Global_46838[0]);
				*(&iLocal_35 + 64[12]) = Function_21(Global_46838[0]);
				Function_20(Global_46838[0]);
				*(&iLocal_35 + 52) = Function_20(Global_46838[0]);
				iLocal_35 = Local_7;
