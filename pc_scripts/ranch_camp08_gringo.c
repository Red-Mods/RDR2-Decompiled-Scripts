...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(3, &uLocal_25, &iLocal_31, &uLocal_3, &uLocal_33, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x307 / 775
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x779 / 1913
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x7AD / 1965
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xAEF / 2799
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xB22 / 2850
{
...
void Function_9(int iParam0) //Position: 0xB39 / 2873
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xB65 / 2917
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xB7F / 2943
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB9C / 2972
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC62 / 3170
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xE2B / 3627
{
...
void Function_15(int iParam0) //Position: 0xE68 / 3688
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xE81 / 3713
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE8E / 3726
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xF83 / 3971
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xFE9 / 4073
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0x104B / 4171
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0x1080 / 4224
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x1299 / 4761
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1310 / 4880
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x137C / 4988
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x13A4 / 5028
{
...
void Function_26(struct<13> Param0) //Position: 0x14EF / 5359
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x150C / 5388
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x152A / 5418
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_44 || bParam2) || Global_6611)
			{
				if (Function_155(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_153(&Param0 + 324, &fLocal_46, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_152();
								(*&Param0 + 48)[1] = Function_151();
								Function_150(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_150(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_143(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_143(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_150(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_150(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_143(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_143(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_143(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_150(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_142(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_46, 20.0f, fLocal_46));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_138(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_142(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_113(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_109(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_142(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_142(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_75(StackVal, StackVal, &Param0 + 16, Function_142(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_142()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_48 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_48) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_47, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x26E9 / 9961
{
	if (IS_ACTOR_VALID(&uLocal_27) && IS_ACTOR_VALID(&uLocal_29))
	{
		if (GET_TASK_SEQUENCE_CURRENT_TASK_INDEX(&uLocal_27, 4294967295) >= 0)
		{
			if (!GET_TASK_STATUS(&uLocal_29, 6) != 1)
			{
				TASK_STAND_STILL(&uLocal_29, -1.0f, 0, 0);
			}
			if (GET_TASK_SEQUENCE_CURRENT_TASK_INDEX(&uLocal_27, 4294967295) != 2 && !iLocal_43)
			{
				SAY_SINGLE_LINE_CONTEXT(&uLocal_29, 111, &Global_54076, 1, 0, 0, 4294967295, 4294967295, 0, 1);
				iLocal_43 = 1;
			}
			Function_33(&uLocal_37);
		}
		else if (Function_30(&uLocal_37) < 5.0f)
		{
			TASK_USE_GRINGO(&uLocal_29, GET_GRINGO_FROM_OBJECT(&uLocal_41), "ButtSlap", true, 1);
			iLocal_43 = 0;
		}
	}
...
float Function_30(vector3 vParam0) //Position: 0x2780 / 10112
{
...
bool Function_31(int iParam0) //Position: 0x284D / 10317
{
	return Function_16(iParam0, 2);
}

bool Function_32(int iParam0) //Position: 0x285B / 10331
{
	return Function_16(iParam0, 1);
}

void Function_33(int iParam0) //Position: 0x2869 / 10345
{
	Function_34(&iParam0, 0.0f);
	return;
}

void Function_34(vector3 vParam0) //Position: 0x2876 / 10358
{
...
void Function_35(var uParam0, int iParam1) //Position: 0x289B / 10395
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x28B1 / 10417
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x28C2 / 10434
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2AFB / 11003
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_39(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2B1B / 11035
{
	bool bVar0;
	var uVar1;
...
int Function_40(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2C09 / 11273
{
	char* cVar0[32];
...
int Function_41(int iParam0) //Position: 0x2E75 / 11893
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E99 / 11929
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x2EBD / 11965
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_44(var uParam0, bool bParam1) //Position: 0x2EE3 / 12003
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_45(var uParam0, bool bParam1) //Position: 0x2F0A / 12042
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_46(bool bParam0) //Position: 0x2F2E / 12078
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_47() //Position: 0x2F4D / 12109
{
...
bool Function_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2F9C / 12188
{
	bool bVar0;
	var uVar1;
...
bool Function_49(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2FF8 / 12280
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_50(var uParam0, int iParam1) //Position: 0x3019 / 12313
{
	bool bVar0;
	var uVar1;
...
void Function_51(var uParam0, var uParam1, bool bParam2) //Position: 0x3074 / 12404
{
	bool bVar0;
	var uVar1;
...
var Function_52() //Position: 0x30C0 / 12480
{
...
void Function_53(struct<425> Param0) //Position: 0x30D5 / 12501
{
	bool bVar0;
	bool bVar1;
...
bool Function_54(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3228 / 12840
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_55(vector3 vParam0) //Position: 0x329D / 12957
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_56(var uParam0) //Position: 0x32B5 / 12981
{
	bool bVar0;
	int iVar1;
...
var Function_57(bool bParam0) //Position: 0x3313 / 13075
{
	bool bVar0;
	bool bVar1;
...
void Function_58(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3360 / 13152
{
	bool bVar0;
	var uVar1;
...
void Function_59(var uParam0, bool bParam1) //Position: 0x33D9 / 13273
{
	bool bVar0;
	var uVar1;
...
void Function_60(var uParam0) //Position: 0x3428 / 13352
{
	struct<21> Var0;
...
bool Function_61() //Position: 0x34E7 / 13543
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_62(struct<25> Param0) //Position: 0x34FA / 13562
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_63(int iParam0) //Position: 0x35C1 / 13761
{
...
bool Function_64(int iParam0) //Position: 0x35E1 / 13793
{
...
bool Function_65(int iParam0) //Position: 0x3605 / 13829
{
...
bool Function_66(int iParam0) //Position: 0x361A / 13850
{
...
bool Function_67(int iParam0, bool bParam1) //Position: 0x3631 / 13873
{
	int iVar0;
...
var Function_68(int iParam0) //Position: 0x366F / 13935
{
...
bool Function_69(int iParam0) //Position: 0x3689 / 13961
{
...
int Function_70(int iParam0, struct<6> Param1) //Position: 0x369F / 13983
{
	int iVar0;
...
void Function_71(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x36D9 / 14041
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > bParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_142(), bParam2[iVar0], Var1, Var3);
...
void Function_72(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x37BE / 14270
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_142(), bParam3, Var2, Var4);
...
void Function_73(var uParam0, bool bParam1) //Position: 0x3975 / 14709
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_74(bool bParam0) //Position: 0x399A / 14746
{
	var uVar0;
	int iVar1;
...
var Function_75(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x39E8 / 14824
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_76(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3B3F / 15167
{
	var uVar0[5];
	int iVar6;
...
int Function_77(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3BEA / 15338
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_78(int iParam0, int iParam1) //Position: 0x3C90 / 15504
{
	var uVar0;
	...
	if (Function_88(&uLocal_25, &uLocal_3, 7, 1, 1, 0, 0, 1, 0, 0, 0))
	{
		uVar0 = Function_86(Global_46816[0], "hennigansRanch", "barn01", 1);
		if (IS_DOOR_VALID(&uVar0))
		{
			if (Function_84(&uLocal_35, "ranch08mobile", &iParam1))
			{
				Function_83(&uVar0, 1);
				OPEN_DOOR_DIRECTION(&uVar0, 1);
				iLocal_31 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_35, Function_142()));
				*(&Global_6667[728] + 216) = &iLocal_31;
				*(&iParam0 + 24) = &uLocal_35;
				Function_79();
				return 1;
			}
		}
...
void Function_79() //Position: 0x3D9A / 15770
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	
	uLocal_33 = CREATE_LAYOUT("ranch08campfire");
	uLocal_27 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "ranch08horse01", 976, Vector(-847,958f, 90,353f, 2450,01f), Vector(0.0f, 206,381f, 0.0f));
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uLocal_27, 1);
	Var0 = Vector(-847,958f, 90,353f, 2450,01f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_27, Var0, 206,381f, 1, 1, 1);
	uLocal_41 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_33, "slapgringo", "slap_horse", Var0, Vector(0.0f, 206,381f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&uLocal_27, &uLocal_41, "UseCase1", false, 0, 0);
	bVar2 = TASK_SEQUENCE_OPEN();
	TASK_USE_GRINGO(false, GET_GRINGO_FROM_OBJECT(&uLocal_41), "UseCase1", true, 1);
	TASK_STAND_STILL(false, 10.0f, 0, 0);
	TASK_ACTION_PERFORM(false, "horse_Main/Melee/MeleeAI/Kick");
	TASK_STAND_STILL(false, 10.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uLocal_27, bVar2, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar2, 1);
	Function_81(&uLocal_27, &iLocal_31, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "ranch08horse02", 977, Vector(-852,43f, 91,59f, 2448,84f), Vector(-1,99f, -81,2f, 0.0f));
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uVar3, 1);
	Var0 = Vector(-852,43f, 91,59f, 2448,84f);
	TELEPORT_ACTOR_WITH_HEADING(&uVar3, Var0, -81,2f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(&uVar3, 5.0f, true, 1092616192);
	TASK_STAND_STILL(&uVar3, -1.0f, 0, 0);
	ACCESSORIZE_HORSE(&uVar3, 3);
	Function_81(&uVar3, &iLocal_31, 1, 1);
	uLocal_29 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "ranch08foreman", 550, Vector(-850,571f, 90,724f, 2450,425f), Vector(-172,44f, -80.0f, 171,64f));
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uLocal_29, 1);
	Var0 = Vector(-849,852f, 90,463f, 2450,021f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_29, Var0, -81,2f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(&uLocal_29, 5.0f, true, 1092616192);
	TASK_STAND_STILL(&uLocal_29, -1.0f, 0, 0);
	Function_81(&uLocal_29, &iLocal_31, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "ranch08laborer", 161, Vector(-846,449f, 90,505f, 2453,387f), Vector(0.0f, 21,07f, 0.0f));
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uVar3, 1);
	Var0 = Vector(-846,211f, 90,353f, 2452,652f);
	TELEPORT_ACTOR_WITH_HEADING(&uVar3, Var0, 21,07f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(&uVar3, 5.0f, true, 1092616192);
	TASK_USE_GRINGO(&uLocal_29, GET_GRINGO_FROM_OBJECT(&uLocal_41), "ButtSlap", true, 1);
	Function_81(&uVar3, &iLocal_31, 1, 1);
	if (!DOES_AMBIENT_MOVE_RESTRICTION_VOLUME_EXIST(FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Ranch08")))
	...
	Function_80(&uLocal_37);
	iLocal_43 = 0;
	return;
}

void Function_80(int iParam0) //Position: 0x4138 / 16696
{
...
void Function_81(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x414F / 16719
{
	bool bVar0;
	int iVar1;
...
bool Function_82(int iParam0, int iParam1, bool bParam2) //Position: 0x430C / 17164
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_83(var uParam0, int iParam1) //Position: 0x4354 / 17236
{
...
bool Function_84(var uParam0, var uParam1, int iParam2) //Position: 0x43AC / 17324
{
...
void Function_85(var uParam0, int iParam1) //Position: 0x43DC / 17372
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iParam1, Function_142(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
var Function_86(bool bParam0, char* cParam1, bool bParam3) //Position: 0x4427 / 17447
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_87(bool bParam0) //Position: 0x44CC / 17612
{
...
bool Function_88(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x44E2 / 17634
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_105(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_104(StackVal, (&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	if (StackVal || !Function_101((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_104(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_103(iVar1))
		{
			if (Function_109(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_89(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_89(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x46C1 / 18113
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_100(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		if (&bParam6)
		{
			bVar1 = Function_97(&Global_15402[iParam014] + 16, &uParam7);
		}
		if (&bParam8)
		{
			bVar1 = Function_92(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_90(var uParam0, bool bParam1) //Position: 0x4C01 / 19457
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_91(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4C23 / 19491
{
	var uVar0;
...
var Function_92(bool bParam0, int iParam1) //Position: 0x4C84 / 19588
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_93(var uParam0, int iParam1) //Position: 0x4D12 / 19730
{
	Function_95(&uParam0);
	Function_94(&uParam0);
...
void Function_94(int iParam0) //Position: 0x4D3E / 19774
{
...
void Function_95(int iParam0) //Position: 0x4D64 / 19812
{
...
bool Function_96(bool bParam0) //Position: 0x4E3A / 20026
{
...
var Function_97(int iParam0, int iParam1) //Position: 0x4E51 / 20049
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_98(int iParam0, bool bParam1, bool bParam2) //Position: 0x4EF7 / 20215
{
	var uVar0;
	var uVar1;
...
void Function_99(var uParam0) //Position: 0x5006 / 20486
{
	int iVar0;
...
bool Function_100(var uParam0, int iParam1) //Position: 0x5039 / 20537
{
	int iVar0;
...
bool Function_101(int iParam0, struct<2> Param1, float fParam3) //Position: 0x5056 / 20566
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_102() //Position: 0x50E2 / 20706
{
	var uVar0;
	int iVar1;
...
bool Function_103(int iParam0) //Position: 0x5152 / 20818
{
...
var Function_104(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x516E / 20846
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_105(struct<205> Param0) //Position: 0x5214 / 21012
{
	var uVar0;
	var uVar1;
...
var Function_106(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x531F / 21279
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_108(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_107(struct<13> Param0) //Position: 0x535D / 21341
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_108(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5370 / 21360
{
	int iVar0;
...
bool Function_109(struct<2>[] Param0) //Position: 0x543F / 21567
{
	int iVar0;
	int iVar1;
...
void Function_110() //Position: 0x5801 / 22529
{
	if (!Function_157(128))
	{
		return;
...
bool Function_111() //Position: 0x5841 / 22593
{
	int iVar0;
...
void Function_112() //Position: 0x586F / 22639
{
	if (!Function_157(128))
	{
		return;
...
void Function_113(vector3 vParam0) //Position: 0x58B1 / 22705
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_114(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_114(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_114(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5949 / 22857
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_115(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_115(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5978 / 22904
{
	Function_130(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_120(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_119(), Function_118(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_117(), Function_116(&uParam11, &uParam12));
}

var Function_116(var uParam0, bool bParam1) //Position: 0x59D3 / 22995
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_117() //Position: 0x59E3 / 23011
{
	return "PackedGrass";
}

var Function_118(bool bParam0, bool bParam1, bool bParam2) //Position: 0x59F7 / 23031
{
	int iVar0;
...
var Function_119() //Position: 0x5A1C / 23068
{
	return "PackedMetadata";
}

void Function_120(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5A33 / 23091
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_129(), &uVar4))
				{
					Function_124(uVar4, &bVar5);
...
struct<8> Function_121() //Position: 0x5B6F / 23407
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_122() //Position: 0x5B81 / 23425
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_123() //Position: 0x5B93 / 23443
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_124(var uParam0, struct<5> Param1) //Position: 0x5BA5 / 23461
{
	Param1 = Function_125(uParam0, Function_127(), 0);
	Param1.f_4 = Function_125(uParam0, Function_127() + 8, Function_127());
	return;
}

var Function_125(var uParam0, int iParam1, int iParam2) //Position: 0x5BCA / 23498
{
	int iVar0;
...
var Function_126(bool bParam0) //Position: 0x5BE9 / 23529
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_127() //Position: 0x5BF5 / 23541
{
	return Function_128(39);
}

int Function_128(int iParam0) //Position: 0x5C00 / 23552
{
	int iVar0;
...
var Function_129() //Position: 0x5C2E / 23598
{
	return "PackedWeapon";
}

int Function_130(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5C43 / 23619
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_134(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_132(Function_134()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_131(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_131() //Position: 0x5D50 / 23888
{
	return "MPItemGiver";
}

struct<32> Function_132(char* cParam0) //Position: 0x5D64 / 23908
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_133(char* cParam0) //Position: 0x5DD0 / 24016
{
	char* cVar0[32];
...
var Function_134() //Position: 0x5DF2 / 24050
{
	return "PBox_";
}

var Function_135() //Position: 0x5E00 / 24064
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_136() //Position: 0x5E26 / 24102
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_137() //Position: 0x5E4E / 24142
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_138(var uParam0, int iParam1) //Position: 0x5E74 / 24180
{
	int iVar0;
	var uVar1;
...
void Function_139(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5FDE / 24542
{
	struct<8> Var0;
...
int Function_140(bool bParam0) //Position: 0x6086 / 24710
{
	int iVar0;
	struct<2> Var1;
...
void Function_141(int iParam0) //Position: 0x61F4 / 25076
{
...
var Function_142() //Position: 0x625C / 25180
{
	int iVar0;
...
var Function_143(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x6265 / 25189
{
	return Function_144(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_144(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6283 / 25219
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_96(bVar1))
	{
		...
		{
			Function_148(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_145(int iParam0) //Position: 0x657C / 25980
{
	int iVar0;
...
void Function_146() //Position: 0x6630 / 26160
{
	int iVar0;
...
bool Function_147(bool bParam0) //Position: 0x666B / 26219
{
	int iVar0;
...
void Function_148(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6698 / 26264
{
	bool bVar0;
...
void Function_149() //Position: 0x67F3 / 26611
{
	int iVar0;
...
var Function_150(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x683F / 26687
{
	int iVar0;
...
int Function_151() //Position: 0x691B / 26907
{
	int iVar0;
...
int Function_152() //Position: 0x6A77 / 27255
{
	int iVar0;
...
bool Function_153(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6B97 / 27543
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_154(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_154(struct<2> Param0) //Position: 0x6C73 / 27763
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_155(struct<2> Param0, struct<5> Param2) //Position: 0x6C92 / 27794
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_156(int iParam0) //Position: 0x6DD5 / 28117
{
	var uVar0;
...
bool Function_157(int iParam0) //Position: 0x6DF7 / 28151
{
	int iVar0;
...
int Function_158() //Position: 0x6E13 / 28179
{
	return 0;
}

void Function_159(struct<321> Param0) //Position: 0x6E1A / 28186
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_108(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_108(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
