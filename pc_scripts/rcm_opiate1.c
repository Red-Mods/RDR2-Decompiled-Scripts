...
void main() //Position: 0x0 / 0
{
	...
	iLocal_325 = 0;
	bLocal_340 = false;
	Local_347 = Vector(-411,486f, 23,906f, 3915,613f);
	iLocal_358 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			iLocal_326 = 1000;
			bLocal_340 = true;
			Function_170(&uLocal_350, "$/fragments/p_gen_crate03ax", 0, 0);
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288) && Function_164(&uLocal_350))
						{
							if (IS_LAYOUTREF_VALID(&uLocal_341))
							{
								if (!IS_OBJECT_VALID(&uLocal_343))
								{
									uLocal_343 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_341, Function_163(), "$/fragments/p_gen_crate03ax", Vector(-406,119f, 24,008f, 3910,635f), Vector(0.0f, 19,119f, 0.0f), false);
									*(&Global_99725[5443] + 328) = &uLocal_343;
								}
								if (IS_ACTOR_VALID(&uLocal_338) && IS_OBJECT_VALID(&uLocal_343))
								{
									SET_ACTOR_ALLOW_BUMP_REACTIONS(&uLocal_338, 0);
									Function_156(&(Global_99725[5443]), 54, 0x41f00000, 0x42200000, 0);
									iVar0 = 1;
								}
							}
							...
							{
								Function_154();
								uLocal_341 = &iLocal_356;
							}
							else
							{
								uLocal_341 = FIND_NAMED_LAYOUT("Opiate_layout");
							}
						}
						break;
					...
					case 0x00000001:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304) && !Function_150(&Global_54076, 0, 1))
								{
									iVar0 = 2;
								}
								else if (((!IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304) && HAS_STRING_TABLE_LOADED("RandomCharMissions")) && IS_LAYOUTREF_VALID(&uLocal_341)) && !Function_150(&Global_54076, 0, 1))
								{
							...
							else if (Function_150(&Global_54076, 0, 1) && IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304))
							{
					...
					case 0x00000002:
						if ((!Global_6647 && !Global_6646) && !Global_6648)
						{
							if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
							{
								if (GATEWAY_UPDATE(&Global_99725[ScriptParam_043] + 288))
								{
									...
									{
										if ((StackVal && FABS((StackVal - !Function_150(&Global_54076, 0, 1))) > 2.0f) && IS_SCRIPT_USE_CONTEXT_PRESSED(&Global_99725[ScriptParam_043] + 304))
										{
											RELEASE_SCRIPT_USE_CONTEXT(&Global_99725[ScriptParam_043] + 304);
											iVar0 = 3;
											break;
								...
								if (Function_150(&Global_54076, 0, 1) || !GATEWAY_UPDATE(&Global_99725[ScriptParam_043] + 288))
								{
						...
						{
							Function_149(&Global_99725[ScriptParam_043] + 228, 128);
					...
					case 0x00000003:
						if (Function_108("$/cutscene/RCM_14_CS01/RCM_14_CS01", &iLocal_326, 29006, 28999, 27696, 27573, 27160, 27144, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_106("Opiate1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "opiate1_OBJ", 0, 3, false);
							Function_105(Global_99725[ScriptParam_043].f_224, 0);
							Function_149(&Global_99725[ScriptParam_043] + 228, 128);
							Function_149(&Global_99725[ScriptParam_043] + 228, 256);
							Function_103(406, 1, 0, 0);
							Function_57(54, 1, 1, 0);
							Function_4(Global_42265[89].f_64);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							iVar0 = 13;
						}
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5AF / 1455
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x5E1 / 1505
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x5FE / 1534
{
	RELEASE_LAYOUT_REF(&iLocal_356);
	return;
}

void Function_4(bool bParam0) //Position: 0x60B / 1547
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_44(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_149(&Global_99725[iVar143] + 228, 64);
...
void Function_5(struct<229> Param0) //Position: 0x7C5 / 1989
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_163(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_6(&Param0);
...
void Function_6(struct<217> Param0) //Position: 0x895 / 2197
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_163(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_163(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_7(&uVar1, 0);
	return;
}

int Function_7(var uParam0, int iParam1) //Position: 0x953 / 2387
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0xABD / 2749
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0xB65 / 2917
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0xBD1 / 3025
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0xBF3 / 3059
{
	int iVar0;
	struct<2> Var1;
...
float Function_12(int iParam0, struct<2> Param1) //Position: 0xD61 / 3425
{
	struct<2> Var0;
...
struct<8> Function_13(int iParam0) //Position: 0xDD8 / 3544
{
	struct<2> Var0;
...
void Function_14(int iParam0) //Position: 0xE44 / 3652
{
...
bool Function_15(int iParam0) //Position: 0xEAC / 3756
{
...
void Function_16(struct<153> Param0) //Position: 0xEC2 / 3778
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if (((StackVal && Function_18(Function_19(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_17(iParam1)) || Global_116927[iParam16].f_20 != 1)
	{
...
int Function_17(int iParam0) //Position: 0x1031 / 4145
{
...
var Function_18(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x105D / 4189
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_19(int iParam0) //Position: 0x107E / 4222
{
...
bool Function_20(struct<249> Param0) //Position: 0x1093 / 4243
{
	...
	{
		Function_149(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_21(struct<265> Param0) //Position: 0x11C3 / 4547
{
	int iVar0;
...
bool Function_23(int iParam0) //Position: 0x1348 / 4936
{
...
bool Function_24(int iParam0) //Position: 0x135D / 4957
{
...
var Function_25(int iParam0) //Position: 0x1374 / 4980
{
...
bool Function_26(int iParam0) //Position: 0x138E / 5006
{
...
bool Function_27(int iParam0) //Position: 0x13A4 / 5028
{
	return Global_116927[iParam06].f_16;
}

bool Function_28(var uParam0, int iParam1) //Position: 0x13B4 / 5044
{
	int iVar0;
...
bool Function_29(struct<237> Param0) //Position: 0x13D1 / 5073
{
	if (!Param0.f_236)
	{
		if (Function_30())
...
bool Function_30() //Position: 0x14A0 / 5280
{
...
bool Function_31(int iParam0) //Position: 0x14BB / 5307
{
	...
	if (!Function_44(Global_99725[iParam043].f_228, 32768))
	{
		if ((Global_6646 || Global_6648) || Global_6647)
		{
			...
			{
				Function_32(&Global_54076, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
void Function_32(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1516 / 5398
{
	bool bVar0;
	char* cVar1[16];
...
void Function_33(char* cParam0) //Position: 0x158B / 5515
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_34(int iParam0, var uParam1, int iParam2) //Position: 0x15C5 / 5573
{
	var uVar0;
	char* cVar1[16];
	...
	{
		if (Function_36(DECOR_GET_INT(&iParam0, &cVar1)) > 3)
		{
			return 0;
		}
	}
...
int Function_35(char* cParam0) //Position: 0x1641 / 5697
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_36(int iParam0) //Position: 0x16E2 / 5858
{
	int iVar0;
	int iVar1;
...
void Function_37(int iParam0, int iParam1) //Position: 0x171F / 5919
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x1735 / 5941
{
...
bool Function_39(int iParam0) //Position: 0x1748 / 5960
{
	int iVar0;
...
bool Function_40(var uParam0, int iParam1) //Position: 0x1764 / 5988
{
	int iVar0;
...
int Function_41(int iParam0) //Position: 0x1781 / 6017
{
...
bool Function_42(int iParam0) //Position: 0x1796 / 6038
{
...
int Function_43(int iParam0) //Position: 0x17AB / 6059
{
...
bool Function_44(var uParam0, bool bParam1) //Position: 0x17C0 / 6080
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x17CD / 6093
{
...
int Function_46(int iParam0, int iParam1) //Position: 0x184D / 6221
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_47(char* cParam0) //Position: 0x24B0 / 9392
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_48(int iParam0, bool bParam1) //Position: 0x24C8 / 9416
{
	int iVar0;
...
int Function_49(int iParam0) //Position: 0x2506 / 9478
{
	int iVar0;
	int iVar1;
...
bool Function_50(int iParam0) //Position: 0x2555 / 9557
{
...
int Function_51(int iParam0) //Position: 0x256B / 9579
{
...
void Function_52() //Position: 0x25D4 / 9684
{
...
bool Function_53(int iParam0) //Position: 0x25F9 / 9721
{
	if (!Function_50(iParam0))
	{
...
bool Function_54(int iParam0, int iParam1) //Position: 0x264A / 9802
{
	int iVar0;
...
bool Function_55(int iParam0) //Position: 0x2677 / 9847
{
	if (!Function_50(iParam0))
	{
...
void Function_56(bool bParam0) //Position: 0x26C9 / 9929
{
	int iVar0;
...
void Function_57(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2703 / 9987
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (!Function_30())
	{
		...
		{
			Function_32(&Global_54076, 2097152, 1, 0);
		}
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_37(&Global_99725[iParam043] + 228, 64);
...
void Function_58(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2C9B / 11419
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_59() //Position: 0x2E3C / 11836
{
	return;
}

void Function_60(var uParam0, int iParam1) //Position: 0x2E42 / 11842
{
	if (Global_6624)
	{
		return;
...
void Function_61(bool bParam0) //Position: 0x2E81 / 11905
{
...
void Function_62() //Position: 0x2ED6 / 11990
{
	Function_89();
	Function_88();
	Function_88();
...
void Function_63() //Position: 0x2F21 / 12065
{
...
void Function_64() //Position: 0x3027 / 12327
{
	float fVar0;
...
void Function_65() //Position: 0x305A / 12378
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_66() //Position: 0x31ED / 12781
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x33A6 / 13222
{
	Function_68(&Global_42918, 1, 0);
	return;
}

void Function_68(struct<2317> Param0) //Position: 0x33B4 / 13236
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_69() //Position: 0x35D1 / 13777
{
...
struct<8> Function_70(int iParam0) //Position: 0x35E6 / 13798
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_71(int iParam0, bool bParam1, bool bParam2) //Position: 0x368D / 13965
{
	int iVar0;
...
void Function_72(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3929 / 14633
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_73(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_163(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_73(int iParam0) //Position: 0x3F67 / 16231
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_74(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3F78 / 16248
{
	char* cVar0[32];
...
struct<32> Function_75(char* cParam0) //Position: 0x4070 / 16496
{
	char* cVar0[32];
...
void Function_76(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x408B / 16523
{
	float fVar0;
...
var Function_77(int iParam0, int iParam1) //Position: 0x40F2 / 16626
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_78(int iParam0, bool bParam1) //Position: 0x4104 / 16644
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_79(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4116 / 16662
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_80(int iParam0) //Position: 0x424A / 16970
{
	return Global_55480[iParam016].f_96;
}

float Function_81(int iParam0) //Position: 0x4259 / 16985
{
	if (!iParam0 != 4294967295)
	{
...
var Function_82(int iParam0) //Position: 0x4292 / 17042
{
	if (iParam0 == 4294967295)
	{
...
void Function_83(int iParam0) //Position: 0x42CF / 17103
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_84(int iParam0, bool bParam1, bool bParam2) //Position: 0x4469 / 17513
{
	int iVar0;
	int iVar1;
...
int Function_85(bool bParam0) //Position: 0x46AD / 18093
{
...
struct<8> Function_86() //Position: 0x46EE / 18158
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_87() //Position: 0x4777 / 18295
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_88() //Position: 0x480E / 18446
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_89() //Position: 0x488D / 18573
{
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x48CA / 18634
{
	int iVar0;
	int iVar1;
...
void Function_91() //Position: 0x4AD6 / 19158
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_92(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4B8D / 19341
{
	int iVar0;
...
struct<8> Function_93() //Position: 0x4C85 / 19589
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_94(int iParam0) //Position: 0x4C8F / 19599
{
...
int Function_95(bool bParam0, bool bParam1) //Position: 0x4CA5 / 19621
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_96(struct<2> Param0, struct<2> Param2) //Position: 0x4D71 / 19825
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_97(float fParam0, int iParam1) //Position: 0x4D8E / 19854
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_98(int iParam0) //Position: 0x55BA / 21946
{
	var uVar0;
...
void Function_99(var uParam0, int iParam1) //Position: 0x55F5 / 22005
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_100(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5604 / 22020
{
	uParam0 = &uParam0;
...
void Function_101() //Position: 0x56B3 / 22195
{
	bool bVar0;
...
void Function_102(int iParam0) //Position: 0x5711 / 22289
{
	PRINTSTRING("Day ");
...
int Function_103(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x575B / 22363
{
	int iVar0;
	int iVar1;
	...
	Function_104(iParam0);
	return 1;
}

void Function_104(int iParam0) //Position: 0x5983 / 22915
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_105(bool bParam0, bool bParam1) //Position: 0x5A21 / 23073
{
	bool bVar0;
...
void Function_106(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x5A46 / 23110
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_107(int iParam0) //Position: 0x5ADB / 23259
{
	char* cVar0[16];
...
bool Function_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5B1A / 23322
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_109(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5BD3 / 23507
{
	if (!&bParam15)
	{
...
void Function_110(var uParam0, bool bParam1) //Position: 0x6235 / 25141
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_111() //Position: 0x6304 / 25348
{
	int iVar0;
...
void Function_112() //Position: 0x637C / 25468
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_113() //Position: 0x63C1 / 25537
{
...
void Function_114(var uParam0, int iParam1) //Position: 0x63D3 / 25555
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_163(), &iParam1, 4294967295, 1);
...
bool Function_115(int iParam0) //Position: 0x6465 / 25701
{
	bool bVar0;
...
float Function_116(vector3 vParam0) //Position: 0x6496 / 25750
{
...
bool Function_117(int iParam0) //Position: 0x6563 / 25955
{
	return Function_44(iParam0, 2);
}

bool Function_118(int iParam0) //Position: 0x6571 / 25969
{
	return Function_44(iParam0, 1);
}

int Function_119(bool bParam0) //Position: 0x657F / 25983
{
	bool bVar0;
	var uVar1;
...
bool Function_120() //Position: 0x6642 / 26178
{
	bool bVar0;
	var uVar1;
...
void Function_121(int iParam0) //Position: 0x667F / 26239
{
	Function_122(&iParam0, 0.0f);
	return;
}

void Function_122(vector3 vParam0) //Position: 0x668C / 26252
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_149(&vParam0, 1);
	Function_37(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_123(struct<37> Param0) //Position: 0x66B1 / 26289
{
	return Param0.f_36;
}

void Function_124(var uParam0, int iParam1) //Position: 0x66BC / 26300
{
	Function_125(&uParam0, &iParam1, 0);
	return;
}

void Function_125(var uParam0, bool bParam1, bool bParam2) //Position: 0x66CC / 26316
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_126(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6844 / 26692
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_127() //Position: 0x686E / 26734
{
	var uVar0;
	var uVar1;
...
void Function_128() //Position: 0x68C9 / 26825
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_163(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_163(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_129() //Position: 0x6A08 / 27144
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_130() //Position: 0x6A18 / 27160
{
	Function_132(2, 0, 1, 1, 0, 1, 1, 1, 1, 1, 1);
	Function_131(&Global_99725[5443] + 320, 1);
	ENABLE_USE_CONTEXTS(1);
	DESTROY_VOLUME(&uLocal_345);
	return 1;
}

void Function_131(var uParam0, bool bParam1) //Position: 0x6A48 / 27208
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_132(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6AD1 / 27345
{
	var uVar0;
...
void Function_133() //Position: 0x6BA0 / 27552
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_134() //Position: 0x6BB5 / 27573
{
	GATEWAY_DISABLE(&Global_99725[5443] + 288, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[5443] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[5443] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-408,38f, 24,129f, 3907,475f), 156,858f, 1, 1, true);
	return 1;
}

int Function_135() //Position: 0x6C30 / 27696
{
	if (!iLocal_358)
	{
		Function_136(StackVal, Local_347, &uLocal_345);
		Function_131(&Global_99725[5443] + 320, 0);
		iLocal_358 = 1;
	}
	return 1;
}

void Function_136(vector3 vParam0) //Position: 0x6C5E / 27742
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_47(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_137(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_137(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_137(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_137(int iParam0, int iParam1) //Position: 0x6E07 / 28167
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_138(float fParam0, float fParam1) //Position: 0x6EFC / 28412
{
...
void Function_139() //Position: 0x700D / 28685
{
...
void Function_140() //Position: 0x7041 / 28737
{
...
int Function_141() //Position: 0x7147 / 28999
{
	return 1;
}

int Function_142() //Position: 0x714E / 29006
{
	uLocal_345 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_356, "Opiate1_Cutscene", 2, *(&Global_99725[5443] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
	Function_145(0, 0, 1, 1, 1, 1, 1, &uLocal_345, 1, 1, 1, 1, 0x3f800000, 0);
	Function_143(StackVal, &iLocal_356, *(&Global_99725[5443] + 196), &uLocal_345, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_143(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x71C8 / 29128
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_144(var uParam0, float fParam1) //Position: 0x7468 / 29800
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_145(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x74EA / 29930
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_148(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_163(), 2, Function_148(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_147()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_146(int iParam0) //Position: 0x779C / 30620
{
	int iVar0;
...
var Function_147() //Position: 0x77D0 / 30672
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_148(int iParam0) //Position: 0x785E / 30814
{
	struct<2> Var0;
...
void Function_149(var uParam0, int iParam1) //Position: 0x7870 / 30832
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_150(int iParam0, bool bParam1, bool bParam2) //Position: 0x7881 / 30849
{
...
bool Function_151() //Position: 0x7945 / 31045
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_152(int iParam0) //Position: 0x795C / 31068
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_153(bool bParam0) //Position: 0x7968 / 31080
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_154() //Position: 0x7977 / 31095
{
	var uVar0;
	
	Function_155(4, 1);
	uVar0 = &uVar0;
	iLocal_356 = CREATE_LAYOUT("Opiate_layout");
	return;
}

void Function_155(int iParam0, int iParam1) //Position: 0x799F / 31135
{
	switch (&iParam1)
	{
		case 0x00000000:
...
int Function_156(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x79E9 / 31209
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_158(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_157(&iParam0));
							}
						}
						...
						uVar6 = Function_158(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_157(struct<257> Param0) //Position: 0x7B74 / 31604
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_157(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_158(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7BB0 / 31664
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_161(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_162()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_161(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_162()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_161(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_159() //Position: 0x7E18 / 32280
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_160(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_160(char* cParam0) //Position: 0x7E6C / 32364
{
	char* cVar0[64];
...
bool Function_161(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7F95 / 32661
{
...
int Function_162() //Position: 0x8064 / 32868
{
	if (IS_PS3())
	{
		return 1;
...
var Function_163() //Position: 0x8073 / 32883
{
	int iVar0;
...
int Function_164(struct<2>[] Param0) //Position: 0x807C / 32892
{
	int iVar0;
	int iVar1;
	...
	Function_169();
	iVar1 = 0;
	if (!Function_168(&(Param0[iVar02]), 16))
	{
	...
	{
		if (Function_168(&(Param0[iVar02]), 4))
		{
			if (!Function_168(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_168(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_168(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_168(&(Param0[iVar02]), 4))
		{
			if (!Function_168(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_165() //Position: 0x843E / 33854
{
	if (!Function_39(128))
	{
		return;
...
bool Function_166() //Position: 0x847E / 33918
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0x84AC / 33964
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

bool Function_168(struct<13> Param0) //Position: 0x84BF / 33983
{
	int iVar0;
...
void Function_169() //Position: 0x84DD / 34013
{
	if (!Function_39(128))
	{
		return;
...
var Function_170(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x851F / 34079
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_171(&Param0, &uVar1, iParam2);
	if (&bParam3)
	{
		Function_167(&(Param0[iVar02]), 8);
	}
...
var Function_171(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x855D / 34141
{
	int iVar0;
