	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_37(Global_46796[1]))
			{
				...
				{
					Function_30("HorseShoes_NotEnoughMoney", 4.0f, 0, 2, 1, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_23(Global_46796[1], &Local_35 + 4, &Local_35 + 104, &Local_35 + 112, &Local_35 + 92, &Local_35 + 96))
			{
				Function_22(&Local_35 + 4);
				Function_21(Global_46796[1], 0);
				(&Local_35 + 28[02]) = Function_21(Global_46796[1], 0);
				Function_21(Global_46796[1], 1);
				*(&Local_35 + 28[12]) = Function_21(Global_46796[1], 1);
				Local_35 = Local_7;
				Local_35.f_84 = 1;
				if (Function_20())
				{
				...
				*(&Local_35 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_5, "StayOutVol", 2,802597E-45f, Vector(-3662,599f, 43,03283f, 2134,773f), Vector(0.0f, -46,61358f, 0.0f), Vector(8,22709f, 3,373459f, 21,7038f));
...
void Function_16() //Position: 0x5F1 / 1521
{
	Function_1();
	return;
}

bool Function_17(int iParam0) //Position: 0x5FA / 1530
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_18(int iParam0, bool bParam1) //Position: 0x61B / 1563
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_19(int iParam0, var uParam1) //Position: 0x652 / 1618
{
	if (!Function_8(iParam0))
	{
		return;
...
bool Function_20() //Position: 0x66D / 1645
{
...
struct<8> Function_21(int iParam0, int iParam1) //Position: 0x698 / 1688
{
...
void Function_22(bool[] bParam0) //Position: 0x7CD / 1997
{
	int iVar0;
	var uVar1;
...
bool Function_23(int iParam0, var[] uParam1, var uParam3, var uParam4, var uParam5) //Position: 0x829 / 2089
{
	var uVar0;
	int iVar2;
	
	Function_29(iParam0, 0);
	uVar0 = Function_29(iParam0, 0);
	uParam2 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_horseshoe", &uVar0, 1.0f, 0);
	Function_29(iParam0, 1);
	uVar0 = Function_29(iParam0, 1);
	uParam3 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_horseshoe", &uVar0, 1.0f, 0);
	Function_29(iParam0, 0);
	Function_29(iParam0, 1);
	if (StackVal > Function_28(StackVal, Function_28(StackVal, StackVal, Global_54078, Function_29(iParam0, 0)), Global_54078, Function_29(iParam0, 1)))
	{
		iVar2 = 0;
		uParam4 = 1;
		uParam5 = 0;
	...
	{
		if (Function_24(&Global_54076, 1, 1))
		{
			return 0;
		}
		return 1;
...
bool Function_24(int iParam0, bool bParam1, bool bParam2) //Position: 0x987 / 2439
{
...
bool Function_25() //Position: 0xA4B / 2635
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_26(int iParam0) //Position: 0xA62 / 2658
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_27(int iParam0) //Position: 0xA6E / 2670
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

float Function_28(struct<2> Param0, struct<2> Param2) //Position: 0xA7D / 2685
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_29(int iParam0, bool bParam1) //Position: 0xA9A / 2714
{
	if (iParam0 == Global_46816[0])
	{
		if (&bParam1 == 0)
...
void Function_30(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0xBBB / 3003
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_31(int iParam0) //Position: 0xC40 / 3136
{
	char* cVar0[16];
...
bool Function_32() //Position: 0xC7F / 3199
{
...
bool Function_33(var uParam0, bool bParam1) //Position: 0xC9A / 3226
{
	return (uParam0 && bParam1) == 0;
}

int Function_34() //Position: 0xCA7 / 3239
{
	return Function_35(0);
}

int Function_35(int iParam0) //Position: 0xCB1 / 3249
{
...
var Function_36(int iParam0) //Position: 0xCF2 / 3314
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_37(int iParam0) //Position: 0xD0C / 3340
{
...
int Function_38(var uParam0, int iParam1) //Position: 0xD28 / 3368
{
	int iVar0;
...
bool Function_39(int iParam0) //Position: 0xD45 / 3397
{
...
void Function_40() //Position: 0xD5B / 3419
{
	Function_1();
	return;
}

void Function_41() //Position: 0xD64 / 3428
{
...
void Function_42(int iParam0) //Position: 0xDB1 / 3505
{
...
void Function_43(vector3 vParam0) //Position: 0xDC8 / 3528
{
...
void Function_44(var uParam0, int iParam1) //Position: 0xDED / 3565
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, int iParam1) //Position: 0xE03 / 3587
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_46(var uParam0) //Position: 0xE14 / 3604
{
	return Function_33(uParam0, 1);
}

void Function_47() //Position: 0xE22 / 3618
{
	return;
}

void Function_48(bool bParam0, bool bParam1) //Position: 0xE28 / 3624
{
	var uVar0;
...
void Function_49(var uParam0) //Position: 0xE87 / 3719
{
	int iVar0;
...
var Function_50() //Position: 0xEA4 / 3748
{
	var uVar0;
