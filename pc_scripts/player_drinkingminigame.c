...
void main() //Position: 0x0 / 0
{
	...
	iLocal_30 = 0;
	Function_109(&uScriptParam_0, &iLocal_30);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_31);
		}
		iVar2 = 0;
		bLocal_38 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_102(&(vLocal_10[iVar39]), &bVar4))
						{
							Function_100(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_10[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_94("eGRINGO_EndUse: Stop use by request", &vLocal_10[iVar39] + 24);
							Function_93(&vLocal_10[iVar39] + 24, 1);
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_39))
								{
									...
									{
										bLocal_39 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_39 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000001:
			...
			{
				Function_59(&Param0 + 16, &Var3, &uVar5);
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(&Param0 + 24, Var3, uVar5, 1, 1, Function_57());
				}
				if (!Function_78(Param0.f_64, 1024))
				{
					Function_58(&Param0 + 64, 1024);
		...
		case 0x00000004:
			Function_56(&Param0 + 16);
			bLocal_38 = true;
			Function_55(&Param0);
			Function_52(&Param0, Function_54(&Param0 + 16));
			if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
			{
			...
			bVar0 = Function_51(&Param0 + 24, &Param0 + 16, bVar29);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_41(&Param0, &uVar7, &iLocal_36, &uLocal_34);
					if (GET_OBJECT_TYPE(&uVar7) != 15)
					{
						...
						if (IS_PHYSINST_VALID(&uVar20))
						{
							...
							{
								Function_58(&Param0 + 64, 256);
								SET_PROP_FIXED(&uVar20, 1);
							}
							else
							{
								Function_40(&Param0 + 64, 256);
							}
						}
					}
				}
				...
				if (IS_GRINGO_COMPONENT_VALID(&bVar0))
				{
					...
					bVar9 = false;
					uVar6 = Function_35(&Param0 + 16, &bVar9);
					if (bVar9)
					{
						iVar2 = GRINGO_GET_PARENT_COMPONENT(&Param0 + 16, 3);
						if (IS_GRINGO_COMPONENT_VALID(&iVar2))
				...
				if (Function_34(&Param0 + 16))
				{
					...
					{
						Function_58(&Param0 + 64, 8);
					}
					else
					{
						Function_40(&Param0 + 64, 8);
					}
		...
		case 0x00000006:
			...
			bVar0 = Function_51(&Param0 + 24, &Param0 + 16, Function_78(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
bool Function_26(int iParam0, bool bParam1) //Position: 0x1FBC / 8124
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	if (Function_14(&iLocal_6))
	{
		if (Function_12(&iLocal_6) < 3,1f)
		{
			HUD_FADE_OUT(1.0f, 1f, 1);
			Function_55(&iLocal_6);
		}
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x1FF4 / 8180
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x2014 / 8212
{
	return;
}

void Function_29(var uParam0, bool bParam1) //Position: 0x201A / 8218
{
	bParam1 = &bParam1;
	uParam0 = &uParam0;
	Function_30("Drinking_firstRound_AutoBet", 4.0f, 0, 2, 1, 0);
	return;
}

void Function_30(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x2052 / 8274
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_31(int iParam0) //Position: 0x20D7 / 8407
{
	char* cVar0[16];
...
bool Function_32() //Position: 0x2116 / 8470
{
...
bool Function_33(char* cParam0) //Position: 0x2131 / 8497
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_34(int iParam0) //Position: 0x213E / 8510
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_35(char* cParam0, int iParam1) //Position: 0x2159 / 8537
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_36(int iParam0) //Position: 0x2179 / 8569
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_37(int iParam0) //Position: 0x2199 / 8601
{
	int iVar0;
	int iVar1;
...
bool Function_38(int iParam0) //Position: 0x21D0 / 8656
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_39(int iParam0) //Position: 0x21F0 / 8688
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x220B / 8715
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_41(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2221 / 8737
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	PRINTNL();
	uVar2 = Function_49(&iParam0 + 16, &bVar0);
	uVar3 = Function_48(&iParam0 + 16, &bVar1);
	uVar4 = Function_47(&iParam0 + 16);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(&uVar4)))
	{
		uVar6 = Function_46(&iParam0 + 16, &bVar5);
		if (bVar5)
		{
			uVar8 = Function_45(&iParam0 + 16, &bVar7);
			if (!bVar7)
			{
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, &uVar3, Function_43(&iParam0 + 16, &iVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, Function_42(), Function_43(&iParam0 + 16, &iVar10), 0, bVar9);
	}
...
var Function_42() //Position: 0x2545 / 9541
{
	int iVar0;
...
bool Function_43(char* cParam0, int iParam1) //Position: 0x254E / 9550
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_44() //Position: 0x256D / 9581
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_45(char* cParam0, int iParam1) //Position: 0x257C / 9596
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x25A0 / 9632
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_47(int iParam0) //Position: 0x25C6 / 9670
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_48(var uParam0, int iParam1) //Position: 0x25E4 / 9700
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x2606 / 9734
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_50(bool bParam0, int iParam1) //Position: 0x2628 / 9768
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_51(var uParam0, int iParam1, bool bParam2) //Position: 0x26F0 / 9968
{
	int iVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x276C / 10092
{
	if (!Function_14(&iParam0))
	{
		Function_53(&iParam0, fParam1);
	}
	return;
}

void Function_53(vector3 vParam0) //Position: 0x2784 / 10116
{
...
var Function_54(int iParam0) //Position: 0x27A9 / 10153
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_55(vector3 vParam0) //Position: 0x27CA / 10186
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_56(var uParam0) //Position: 0x27E1 / 10209
{
	uParam0 = &uParam0;
	return;
}

int Function_57() //Position: 0x27ED / 10221
{
	return 1;
}

void Function_58(var uParam0, int iParam1) //Position: 0x27F4 / 10228
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_59(int iParam0, var uParam1, int iParam2) //Position: 0x2805 / 10245
{
	float fVar0;
	
	Function_62(&iParam0);
	uParam1 = Function_62(&iParam0);
	iParam2 = Function_61(&iParam0);
	fVar0 = Function_60(&iParam0);
	if (fVar0 < 180.0f)
	{
		fVar0 = 180.0f;
	}
...
int Function_60(int iParam0) //Position: 0x284A / 10314
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_61(int iParam0) //Position: 0x2876 / 10358
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_62(int iParam0) //Position: 0x2882 / 10370
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_63(int iParam0) //Position: 0x2984 / 10628
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_64(int iParam0) //Position: 0x29A7 / 10663
{
...
void Function_65(int iParam0) //Position: 0x29CF / 10703
{
	...
	while (bVar7 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(&uVar8))
		{
			...
			{
				Function_67(StackVal, StackVal, Var2, Var11);
				Var2 = Function_67(StackVal, StackVal, Var2, Var11);
				Function_66(StackVal, StackVal, Var0, Var11);
				Var0 = Function_66(StackVal, StackVal, Var0, Var11);
			}
		}
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &fVar19, Function_42(), Var13, Vector(0.0f, 0.0f, 0.0f));
		...
		if (bVar22)
		{
			...
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_42(), Var28, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
		PLAY_CUTSCENEOBJECT(&uVar18, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
	}
	else
	{
		Function_112("Failed to create gringo camera");
	}
	return;
}

struct<8> Function_66(vector3 vParam0) //Position: 0x2CB6 / 11446
{
	struct<2> Var0;
...
struct<8> Function_67(vector3 vParam0) //Position: 0x2D13 / 11539
{
	struct<2> Var0;
...
void Function_68(int iParam0) //Position: 0x2D70 / 11632
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2D7C / 11644
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2D9B / 11675
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2DB2 / 11698
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	...
	Function_62(&iParam1);
	Var0 = Function_62(&iParam1);
	bVar2 = Function_61(&iParam1);
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return 0;
	}
...
struct<8> Function_72(int iParam0) //Position: 0x2E43 / 11843
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E67 / 11879
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2E86 / 11910
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2EAA / 11946
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
int Function_77(var uParam0) //Position: 0x3000 / 12288
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x3119 / 12569
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x3126 / 12582
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x31A8 / 12712
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_36)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_34));
		iLocal_36 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_39(&Param0 + 16))
...
void Function_81() //Position: 0x3753 / 14163
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x378D / 14221
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x37AB / 14251
{
	var uVar0;
	var uVar1;
	int iVar2;
	
	Function_49(&iParam0 + 16, &uVar0);
	Function_48(&iParam0 + 16, &uVar1);
	iVar2 = Function_47(&iParam0 + 16);
...
void Function_84(int iParam0) //Position: 0x37EC / 14316
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x37F8 / 14328
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, bool bParam1) //Position: 0x381A / 14362
{
	bool bVar0;
	int iVar1;
	...
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		bVar0 = DECOR_GET_INT(&Global_46715, "regid");
		*(&iVar1 + 28) = 1;
		Function_92();
		Function_92();
		Function_87(StackVal, StackVal, 4096, 5, GET_ASSET_ID("$/content/Mini_Games/Drinking/Drinking", 4), Function_92(), Function_92(), 0, 0, 0, bVar0, 25, 0, 50, &iVar1, &uLocal_2, 0, 0x40a00000, 4294967295, 0, 0);
		DESTROY_CAMERA(&uLocal_4);
		DECOR_REMOVE(&uParam0, "DuelingNoStart");
	}
	return;
}

int Function_87(int iParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) //Position: 0x38BA / 14522
{
	int iVar0;
	...
	while (iVar0 <= Global_38380)
	{
		...
		{
			if (Function_91(&(Global_38380[iVar036]), 4))
			{
				if (!IS_SCRIPT_VALID(&Global_38380[iVar036] + 48))
				{
					...
					*(&Global_38380[iVar036] + 64) = &uParam9;
					...
					Function_90(&uParam14, &Global_38380[iVar036] + 112);
					Global_38380[iVar036].f_112 = uParam1;
					Function_89(&(Global_38380[iVar036]), 1);
					Function_88(&(Global_38380[iVar036]), 4);
					return 1;
				}
			}
		}
...
void Function_88(vector3 vParam0) //Position: 0x3A08 / 14856
{
	int iVar0;
...
void Function_89(vector3 vParam0) //Position: 0x3A25 / 14885
{
	vParam0.f_8 = (vParam0.z || iParam1);
	return;
}

void Function_90(struct<157> Param0) //Position: 0x3A38 / 14904
{
	Param1 = Param0;
...
bool Function_91(vector3 vParam0) //Position: 0x3BE8 / 15336
{
	int iVar0;
...
struct<8> Function_92() //Position: 0x3C06 / 15366
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

void Function_93(var uParam0, bool bParam1) //Position: 0x3C10 / 15376
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_94(int iParam0, int iParam1) //Position: 0x3D20 / 15648
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_95(struct<69> Param0) //Position: 0x3D38 / 15672
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	if (GRINGO_GET_USE_REQUIRES_OBSTACLE(&uVar0))
	{
		...
		ATTACH_OBJECTS(StackVal, StackVal, &Param0 + 56, &Param0 + 24, Function_42(), Vector(0.0f, 1.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	}
	Function_55(&Param0);
	Function_2("Going to eGringoPositioning", &Param0 + 24);
	Param0.f_68 = 2;
	Function_58(&Param0 + 64, 2);
	Function_40(&Param0 + 64, 8);
	Function_40(&Param0 + 64, 16);
	Function_40(&Param0 + 64, 64);
	...
	if (!Function_99(&Param0 + 16))
	{
		if (HAS_INVENTORY_COMPONENT(&Param0 + 24))
		{
			...
			{
				Function_58(&Param0 + 64, 32);
			}
			else
			{
				Function_40(&Param0 + 64, 32);
			}
		}
		else
		{
		...
		if (Function_78(Param0.f_64, 32))
		{
			Function_58(&Param0 + 64, 128);
		}
		else
		{
			Function_40(&Param0 + 64, 128);
		}
	}
	else
	{
...
void Function_96(var uParam0, int iParam1) //Position: 0x406B / 16491
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		DECOR_SET_BOOL(&uParam0, "DuelingNoStart", true);
		uLocal_4 = CREATE_CAMERA_IN_LAYOUT(GET_AMBIENT_LAYOUT(), "drinkCutCam", 0);
		INIT_CAMERA_FROM_GAME_CAMERA(&uLocal_4);
		SET_CAMERA_POSITION(StackVal, &uLocal_4, Vector(-2166,765f, 18,464f, 2598,753f));
		SET_CAMERA_DIRECTION(StackVal, &uLocal_4, Vector(0,817f, -0,032f, 0,575f), 1);
		SET_CURRENT_CAMERA_ON_CHANNEL(&uLocal_4, 0, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
		DECOR_SET_INT(&uParam0, "GringoNoQuit", false);
		GET_POSITION(&uParam0, &Var0);
		uVar2 = CREATE_OBJECT_ITERATOR(GET_AMBIENT_LAYOUT());
		ITERATE_IN_LAYOUT(&uVar2, &Global_46715);
		ITERATE_IN_SPHERE(&uVar2, Var0, 20.0f);
		ITERATE_ON_OBJECT_TYPE(&uVar2, 8);
		uVar3 = START_OBJECT_ITERATOR(&uVar2);
		while (IS_OBJECT_VALID(&uVar3) && !bVar4)
		{
			uVar5 = GET_OBJECT_NAME(&uVar3);
			if (STRING_CONTAINS_STRING(&uVar5, "ndrinksrch"))
			{
				GET_OBJECT_POSITION(&uVar3, &Var0);
				bVar4 = true;
			}
		...
		if (!bVar4)
		{
			LOG_ERROR("Never found the flag");
			LOG_WARNING("!!! IMPORTANT: This area is not using the new method of drinking by placing the gringo at the bar.  Please ask Ryan Paradis about how to set this up. !!!");
			GET_POSITION(&uParam0, &Var0);
		}
		uVar6 = GET_NEW_PHYSINST_IN_SPHERE(Var0, 1,25f, "chair");
		if (!IS_PHYSINST_VALID(&uVar6))
		{
			uVar6 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Var0, 1,5f, "chair", 1);
		}
		uVar7 = GET_OBJECT_FROM_PHYSINST(&uVar6);
		uVar8 = FIND_OBJECT_IN_OBJECT(&uVar7, "sit");
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar8)))
		{
			if (GRINGO_IS_ACTIVE(&uVar8))
			{
				GRINGO_DEACTIVATE_AND_RESET_ACTORS(GET_GRINGO_FROM_OBJECT(&uVar8));
			}
		}
		RESET_PROPS_IN_VOLUME(FIND_VOLUME_IN_LAYOUT(&Global_46715, "armv_drinkambexc"), 3);
		uLocal_2 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar7, Function_42(), "$/content/scripting/gringo/SimpleGringo/chair_drinking_mg", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)));
		if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0)), "GringoIgnoreStoryMission"))
		{
			DECOR_REMOVE(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0)), "GringoIgnoreStoryMission");
		}
		Function_97(&iLocal_6);
	}
	return;
}

void Function_97(int iParam0) //Position: 0x4389 / 17289
{
	Function_53(&iParam0, 0.0f);
	return;
}

bool Function_98(int iParam0) //Position: 0x4396 / 17302
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_99(int iParam0) //Position: 0x43B0 / 17328
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_100(int iParam0, var uParam1) //Position: 0x43CB / 17355
{
	bool bVar0;
	int iVar1;
...
bool Function_101(var uParam0, int iParam1) //Position: 0x4409 / 17417
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_102(struct<65> Param0) //Position: 0x4422 / 17442
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_78(Param0.f_64, 2))
		{
			...
			{
				Function_58(&Param0 + 64, 1);
			}
			else
			{
				Function_40(&Param0 + 64, 1);
			}
			if (Function_78(Param0.f_64, 1))
			{
			...
			else
			{
				...
				if (!bVar30 != 0.0f)
				{
					if (bVar30 < 0.0f)
					{
						fVar31 = (UNK_0x9C40E671(&Var10) - Function_61(&Param0 + 16));
					}
					else
					{
						fVar31 = ((180.0f + UNK_0x9C40E671(&Var10)) - Function_61(&Param0 + 16));
					}
					if (fVar31 < 180.0f)
					{
...
int Function_103(int iParam0) //Position: 0x471A / 18202
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_104(var uParam0, int iParam1) //Position: 0x4738 / 18232
{
	struct<5> Var0;
	float fVar5;
...
int Function_105(int iParam0) //Position: 0x47D8 / 18392
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_106(int iParam0, int iParam1) //Position: 0x47F8 / 18424
{
	var uVar0;
	
	iParam1 = &iParam1;
	GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &uVar0);
...
bool Function_107(int iParam0) //Position: 0x4861 / 18529
{
...
void Function_108(int iParam0) //Position: 0x487D / 18557
{
	iParam0 = &iParam0;
	return;
}

void Function_109(var uParam0, int iParam1) //Position: 0x4889 / 18569
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_110(&(vLocal_10[iLocal_309]), &uParam0);
		iLocal_30++;
	}
...
void Function_110(int iParam0, int iParam1) //Position: 0x48F5 / 18677
{
	*(&iParam0 + 16) = &iParam1;
	Function_40(&iParam0 + 64, 1);
	return;
}

void Function_111(int iParam0) //Position: 0x490D / 18701
{
	iParam0 = &iParam0;
	return;
}

void Function_112(int iParam0) //Position: 0x4919 / 18713
{
