...
void Function_81(int iParam0, int iParam1) //Position: 0x335B / 13147
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x3388 / 13192
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x3498 / 13464
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x34B0 / 13488
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x37CC / 14284
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	HUD_ENABLE(0);
...
bool Function_86(int iParam0) //Position: 0x37ED / 14317
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x3807 / 14343
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x3822 / 14370
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3860 / 14432
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3879 / 14457
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3B71 / 15217
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3B8F / 15247
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C2F / 15407
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3C4F / 15439
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3C62 / 15458
{
...
void Function_96(int iParam0) //Position: 0x3C7E / 15486
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3C8A / 15498
{
	bool bVar0;
	var uVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3CF6 / 15606
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3D0E / 15630
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3D1A / 15642
{
