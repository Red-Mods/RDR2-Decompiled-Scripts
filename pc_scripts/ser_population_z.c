...
void main() //Position: 0x0 / 0
{
	...
	uVar3 = FIND_NAMED_LAYOUT("WreckSerendipity_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "serv_birdVol");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_4(&uVar4, &uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("SER_Pop: Cannot find serv_birdVol to create bird volumes");
...
void Function_1(var uParam0, var uParam1) //Position: 0xC36 / 3126
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC47 / 3143
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xC9F / 3231
{
	var uVar0;
...
var Function_4(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0xD2F / 3375
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0xDC1 / 3521
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0xDDD / 3549
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xE1D / 3613
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xE3A / 3642
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xE4B / 3659
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xEC9 / 3785
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0xF35 / 3893
{
	bool bVar0;
...
var Function_12(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xFA1 / 4001
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0xFE8 / 4072
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_14(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xFF5 / 4085
{
	int iVar0;
	int iVar1;
...
var Function_15(var uParam0, int iParam1) //Position: 0x1077 / 4215
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_16(char* cParam0) //Position: 0x1086 / 4230
{
	if (!Function_5(128))
	{
		return;
