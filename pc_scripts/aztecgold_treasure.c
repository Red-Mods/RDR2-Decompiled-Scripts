...
void main() //Position: 0x0 / 0
{
	...
	iLocal_120 = 0;
	Function_112(&uScriptParam_0, &iLocal_120);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_105(&(vLocal_10[iVar39]), &bVar4))
						{
							Function_103(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_10[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_98("eGRINGO_EndUse: Stop use by request", &vLocal_10[iVar39] + 24);
							Function_97(&vLocal_10[iVar39] + 24, 1);
							...
							{
								Function_90(&(vLocal_10[iVar39]), 0);
							}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_129))
	{
		Function_115("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_129);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_120 - 1))
	{
		if (Function_88(vLocal_10[iVar09].f_64, 2))
		{
			...
			Function_90(&(vLocal_10[iVar09]), 0);
		}
...
void Function_5(struct<69> Param0) //Position: 0x4A0 / 1184
{
	...
	if (!Function_88(Param0.f_64, 2))
	{
		Function_97(&Param0 + 24, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_129))
								{
									...
									{
										iLocal_129 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_129 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_129))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_129))
		{
			Function_115("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_129);
		}
...
bool Function_16(struct<69> Param0) //Position: 0xAE0 / 2784
{
	...
	bVar11 = Function_87(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_98("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_98("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_98("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_86(&Param0 + 16, &fVar22))
				{
			...
			{
				if (Function_81(&Param0 + 24, &Param0 + 16))
				{
			...
			if (!Function_79(&Param0 + 16) && Param0.f_68 != 1)
			{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_88(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_88(Param0.f_64, 1))
			{
				Function_56(&Param0 + 16, &Var3, &uVar5);
				if (!Function_88(Param0.f_64, 16))
				{
				...
				if (!Function_88(Param0.f_64, 1024))
				{
			...
			else if (Function_81(&Param0 + 24, &Param0 + 16))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 1);
			...
			if (Param0.f_68 != 3 && !Function_88(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_88(Param0.f_64, 1);
			}
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_126, &uLocal_124);
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_88(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_62(int iParam0) //Position: 0x28AB / 10411
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
	...
	{
		iLocal_1 = 1;
		uLocal_6 = CREATE_LAYOUT("AG_TreasureGringo_Layout");
		bVar0 = true;
		uVar1 = &Global_44085[Global_46850[3]9] + 8;
		if (IS_VOLUME_VALID(&uVar1))
		{
			if (IS_ACTOR_IN_VOLUME(&Global_54076, &uVar1))
			{
				bVar0 = false;
				uLocal_2 = Function_73(&uLocal_6, 0, 1, 0, 0);
			}
		}
		if (bVar0)
		{
			uVar1 = &Global_44085[Global_46866[9]9] + 8;
			if (IS_VOLUME_VALID(&uVar1))
			{
				if (IS_ACTOR_IN_VOLUME(&Global_54076, &uVar1))
				{
					bVar0 = false;
					uLocal_2 = Function_68(&uLocal_6, 0, 1, 0, 0);
				}
			}
		}
		if (bVar0)
		{
			uVar1 = &Global_44085[Global_44085[Global_46894[5]9]9] + 8;
			if (IS_VOLUME_VALID(&uVar1))
			{
				if (IS_ACTOR_IN_VOLUME(&Global_54076, &uVar1))
				{
					bVar0 = false;
					uLocal_2 = Function_63(&uLocal_6, 0, 1, 0, 0);
				}
			}
		}
		if (!IS_OBJECTSET_VALID(&uLocal_4))
		{
			GET_ACTOR_AXIS(&Global_54076, &Var2, 2);
			GET_POSITION(&Global_54076, &Var4);
			uLocal_4 = CREATE_OBJECTSET_IN_LAYOUT(Function_39(), &uLocal_6, 4294967295, 0);
			uVar6 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_6, Function_39(), 4,203895E-45f, Var4, Vector(0.0f, 0.0f, 0.0f), Vector(4.0f, 6.0f, 4.0f));
			Var4 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(Var2, Var4, StackVal) * Vector(4.0f, 4.0f, 4.0f), StackVal, StackVal);
			iVar7 = LOCATE_ACTORS_IN_VOLUME(&uVar6, &uLocal_4, 0, 1);
			if (iVar7 >= 0)
			{
				iVar8 = 0;
				iVar8 = 0;
				while (iVar8 < (iVar7 - 1))
				{
					iVar9 = GET_INDEXED_OBJECT_IN_OBJECTSET(iVar8, &uLocal_4);
					if (!&iVar9 != GET_OBJECT_FROM_ACTOR(&Global_54076))
					{
						SET_OBJECT_POSITION_ON_GROUND(&iVar9, Var4);
						Var4 = (Var4 + 0,5f);
					}
					iVar8++;
				}
			}
			DESTROY_OBJECTSET(&uLocal_4);
			DESTROY_VOLUME(&uVar6);
		}
	}
	return;
}

int Function_63(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2A56 / 10838
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "AztecGold_Treasure3", 3, 1);
	}
	Function_64(&uVar0);
...
void Function_64(int iParam0) //Position: 0x2AE3 / 10979
{
	var uVar0;
...
void Function_65(int iParam0) //Position: 0x2B4E / 11086
{
	...
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-545,3259f, 17,40562f, 3989,449f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,014153f, 2,645533f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2BC3 / 11203
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-545,6757f, 16,55864f, 3988,855f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,249252f, 2,840503f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_67(int iParam0) //Position: 0x2C38 / 11320
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-547,4234f, 17,80982f, 3991,774f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,216602f, -0,653991f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

var Function_68(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2CAD / 11437
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "AztecGold_Treasure2", 3, 1);
	}
	Function_69(&uVar0);
	if (uParam4 && CHECK_CUTSCENE_COLLISIONS(&uVar0))
	{
...
void Function_69(int iParam0) //Position: 0x2D3A / 11578
{
	var uVar0;
...
void Function_70(int iParam0) //Position: 0x2DA5 / 11685
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-1199,886f, 20,46942f, 4964,45f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,127372f, -0,869504f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_71(int iParam0) //Position: 0x2E1A / 11802
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-1198,401f, 19,57088f, 4965,13f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,088678f, 0,620804f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_72(int iParam0) //Position: 0x2E8F / 11919
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-1199,479f, 19,73318f, 4966,04f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,02078f, -0,20798f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

var Function_73(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2F04 / 12036
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "AztecGold_Treasure1", 3, 1);
	}
	Function_74(&uVar0);
	if (uParam4 && CHECK_CUTSCENE_COLLISIONS(&uVar0))
	{
...
void Function_74(int iParam0) //Position: 0x2F91 / 12177
{
	var uVar0;
...
void Function_75(int iParam0) //Position: 0x2FFC / 12284
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-3626,443f, 29,52776f, 4746,663f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,004438f, 2,664227f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_76(int iParam0) //Position: 0x3071 / 12401
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-3627,891f, 28,78153f, 4746,347f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,018663f, -1,966126f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_77(int iParam0) //Position: 0x30E6 / 12518
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-3629,594f, 30,00947f, 4745,89f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,458419f, 2,331954f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_78(int iParam0) //Position: 0x315B / 12635
{
	iParam0 = &iParam0;
	return;
}

bool Function_79(int iParam0) //Position: 0x3167 / 12647
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_80(int iParam0) //Position: 0x3186 / 12678
{
	if (!Function_14(&iParam0))
	{
...
bool Function_81(var uParam0, int iParam1) //Position: 0x319D / 12701
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
	...
	{
		return Function_85(&uParam0, &iParam1);
	}
	uVar3 = Function_84(&iParam1);
	uVar4 = Function_57(&iParam1);
	Function_82(&iParam1);
	iVar5 = Function_82(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, fVar2, uVar4, 0, 0);
}

struct<8> Function_82(int iParam0) //Position: 0x322E / 12846
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_83(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_83(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_83(var uParam0, var uParam1, struct<2> Param2) //Position: 0x3252 / 12882
{
	struct<2> Var0;
...
int Function_84(int iParam0) //Position: 0x3271 / 12913
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_85(var uParam0, int iParam1) //Position: 0x3295 / 12949
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_86(var uParam0, int iParam1) //Position: 0x33BD / 13245
{
...
int Function_87(var uParam0) //Position: 0x33EB / 13291
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3504 / 13572
{
	return (uParam0 && iParam1) == 0;
}

void Function_89(struct<69> Param0) //Position: 0x3511 / 13585
{
	if (Function_88(Param0.f_64, 16))
	{
...
void Function_90(struct<69> Param0) //Position: 0x3593 / 13715
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_88(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_96(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_88(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_88(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_95(&Param0 + 16) && Function_88(Param0.f_64, 512))
			{
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_92(&Param0 + 16), &Param0 + 16);
	}
...
void Function_91() //Position: 0x3B3E / 15166
{
	int iVar0;
...
int Function_92(int iParam0) //Position: 0x3B78 / 15224
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3B96 / 15254
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_94(int iParam0) //Position: 0x3BD7 / 15319
{
	iParam0 = &iParam0;
	return;
}

bool Function_95(int iParam0) //Position: 0x3BE3 / 15331
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_96(int iParam0, int iParam1) //Position: 0x3C05 / 15365
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_LAYOUTREF_VALID(&uLocal_6))
	{
		DESTROY_OBJECT(&uLocal_2);
		DESTROY_LAYOUT(&uLocal_6);
	}
	iLocal_0 = 0;
	iLocal_1 = 0;
	return;
...
void Function_97(var uParam0, bool bParam1) //Position: 0x3C32 / 15410
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_98(int iParam0, int iParam1) //Position: 0x3D42 / 15682
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_99(struct<69> Param0) //Position: 0x3D5A / 15706
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_100(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4078 / 16504
{
	iParam1 = &iParam1;
	iLocal_0 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_101(int iParam0) //Position: 0x4093 / 16531
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_102(int iParam0) //Position: 0x40AD / 16557
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_103(int iParam0, var uParam1) //Position: 0x40C8 / 16584
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_104(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_104(var uParam0, int iParam1) //Position: 0x4106 / 16646
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_105(struct<65> Param0) //Position: 0x411F / 16671
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_88(Param0.f_64, 2))
		{
			...
			if (Function_88(Param0.f_64, 1))
			{
				Function_98("MIDACTION REQUEST", &uVar1);
			}
			else
			{
...
int Function_106(int iParam0) //Position: 0x4417 / 17431
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_107(var uParam0, int iParam1) //Position: 0x4435 / 17461
{
	struct<5> Var0;
	float fVar5;
...
int Function_108(int iParam0) //Position: 0x44D5 / 17621
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_109(int iParam0, var uParam1) //Position: 0x44F5 / 17653
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_110(int iParam0) //Position: 0x4508 / 17672
{
...
void Function_111(int iParam0) //Position: 0x4524 / 17700
{
	iParam0 = &iParam0;
	return;
}

void Function_112(var uParam0, int iParam1) //Position: 0x4530 / 17712
{
	int iVar0;
	var uVar1;
	...
	{
		Function_113(&(vLocal_10[iLocal_1209]), &uParam0);
		iLocal_120++;
	}
...
void Function_113(int iParam0, int iParam1) //Position: 0x459C / 17820
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_114(int iParam0) //Position: 0x45B4 / 17844
{
	iParam0 = &iParam0;
	return;
}

void Function_115(int iParam0) //Position: 0x45C0 / 17856
{
