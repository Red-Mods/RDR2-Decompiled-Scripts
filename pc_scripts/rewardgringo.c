...
void Function_22(var uParam0, int iParam1) //Position: 0x1F65 / 8037
{
	...
	bVar0 = false;
	uVar1 = Function_26(&iParam1, &bVar0);
	if (bVar0)
	{
		if (STRING_CONTAINS_STRING(&uVar1, "Item"))
		{
			ADD_ITEM(Function_25(&iParam1), &uParam0, 1);
		}
		else
		{
			GRINGO_REWARD_ACTOR(&uVar1, Function_23(&iParam1), &uParam0);
		}
	}
	return;
}

int Function_23(int iParam0) //Position: 0x1FAF / 8111
{
	return Function_24(&iParam0, "CompletionRewardAmount", 0);
}

int Function_24(var uParam0, var uParam1, int iParam2) //Position: 0x1FD5 / 8149
{
	int iVar0;
...
var Function_25(char* cParam0) //Position: 0x1FED / 8173
{
	bool bVar0;
	int iVar1;
	
	bVar0 = false;
	iVar1 = Function_9(&cParam0, "ItemReward", &bVar0);
	if (bVar0)
	{
		return &iVar1;
	}
...
bool Function_26(char* cParam0, int iParam1) //Position: 0x2039 / 8249
{
	return Function_9(&cParam0, "CompletionReward", &iParam1);
}

float Function_27(int iParam0) //Position: 0x205B / 8283
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_28() //Position: 0x2072 / 8306
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_29(int iParam0) //Position: 0x207F / 8319
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_30(int iParam0, bool bParam1) //Position: 0x20A0 / 8352
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_31(bool bParam0) //Position: 0x20B3 / 8371
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_32() //Position: 0x20D3 / 8403
{
	return;
}

void Function_33(int iParam0, bool bParam1) //Position: 0x20D9 / 8409
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_34(char* cParam0) //Position: 0x20EB / 8427
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_35(int iParam0) //Position: 0x20F8 / 8440
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_36(char* cParam0, int iParam1) //Position: 0x2113 / 8467
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_37(int iParam0) //Position: 0x2133 / 8499
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_38(int iParam0) //Position: 0x2153 / 8531
{
	int iVar0;
	int iVar1;
...
bool Function_39(int iParam0) //Position: 0x218A / 8586
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_40(int iParam0) //Position: 0x21AA / 8618
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x21C5 / 8645
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x21DB / 8667
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_43() //Position: 0x24FF / 9471
{
	int iVar0;
...
bool Function_44(char* cParam0, int iParam1) //Position: 0x2508 / 9480
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_45() //Position: 0x2527 / 9511
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x2536 / 9526
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_47(char* cParam0, int iParam1) //Position: 0x255A / 9562
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_48(int iParam0) //Position: 0x2580 / 9600
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x259E / 9630
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_50(var uParam0, int iParam1) //Position: 0x25C0 / 9664
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_51(bool bParam0, int iParam1) //Position: 0x25E2 / 9698
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_52(var uParam0, int iParam1, bool bParam2) //Position: 0x26AA / 9898
{
	int iVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x2726 / 10022
{
...
void Function_54(vector3 vParam0) //Position: 0x273E / 10046
{
...
var Function_55(int iParam0) //Position: 0x2763 / 10083
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_56(vector3 vParam0) //Position: 0x2784 / 10116
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x279B / 10139
{
	uParam0 = &uParam0;
	return;
}

int Function_58() //Position: 0x27A7 / 10151
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x27AE / 10158
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_60(int iParam0, var uParam1, int iParam2) //Position: 0x27BF / 10175
{
	bool bVar0;
...
int Function_61(int iParam0) //Position: 0x2804 / 10244
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(int iParam0) //Position: 0x2830 / 10288
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_63(int iParam0) //Position: 0x283C / 10300
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_64(int iParam0) //Position: 0x293E / 10558
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_65(int iParam0) //Position: 0x2961 / 10593
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(int iParam0) //Position: 0x2989 / 10633
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_67(vector3 vParam0) //Position: 0x2C70 / 11376
{
	struct<2> Var0;
...
struct<8> Function_68(vector3 vParam0) //Position: 0x2CCD / 11469
{
	struct<2> Var0;
...
void Function_69(int iParam0) //Position: 0x2D2A / 11562
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2D36 / 11574
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2D55 / 11605
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2D6C / 11628
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_73(int iParam0) //Position: 0x2DFD / 11773
{
	struct<2> Var0;
...
struct<8> Function_74(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E21 / 11809
{
	struct<2> Var0;
...
int Function_75(int iParam0) //Position: 0x2E40 / 11840
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(var uParam0, int iParam1) //Position: 0x2E64 / 11876
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2F8C / 12172
{
...
int Function_78(var uParam0) //Position: 0x2FBA / 12218
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x30D3 / 12499
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(struct<69> Param0) //Position: 0x30E0 / 12512
{
	if (Function_79(Param0.f_64, 16))
	{
...
void Function_81(struct<69> Param0) //Position: 0x3162 / 12642
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x370D / 14093
{
	int iVar0;
...
int Function_83(int iParam0) //Position: 0x3747 / 14151
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_84(int iParam0, var uParam1) //Position: 0x3765 / 14181
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_85(int iParam0) //Position: 0x37A6 / 14246
{
	iParam0 = &iParam0;
	return;
}

bool Function_86(int iParam0) //Position: 0x37B2 / 14258
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_87(int iParam0, int iParam1) //Position: 0x37D4 / 14292
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x37E6 / 14310
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_89(int iParam0, int iParam1) //Position: 0x38F6 / 14582
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_90(struct<69> Param0) //Position: 0x390E / 14606
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_91(int iParam0, int iParam1) //Position: 0x3C2A / 15402
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_92(int iParam0) //Position: 0x3C3C / 15420
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_93(int iParam0) //Position: 0x3C56 / 15446
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, var uParam1) //Position: 0x3C71 / 15473
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3CA6 / 15526
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_96(struct<65> Param0) //Position: 0x3CBF / 15551
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_97(int iParam0) //Position: 0x3FB7 / 16311
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3FD5 / 16341
{
	struct<5> Var0;
	float fVar5;
...
int Function_99(int iParam0) //Position: 0x4088 / 16520
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(int iParam0, var uParam1) //Position: 0x40A8 / 16552
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x40BB / 16571
{
...
void Function_102(int iParam0) //Position: 0x40D7 / 16599
{
	iParam0 = &iParam0;
	return;
}

void Function_103(var uParam0, int iParam1) //Position: 0x40E3 / 16611
{
	bool bVar0;
	var uVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x414F / 16719
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_105(int iParam0) //Position: 0x4167 / 16743
{
	iParam0 = &iParam0;
	return;
}

void Function_106(bool bParam0) //Position: 0x4173 / 16755
{
