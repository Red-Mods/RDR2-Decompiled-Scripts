...
void main() //Position: 0x0 / 0
{
	...
	bVar12 = Function_14("armadillo_prestream", 0);
	...
	Function_13(&bVar12, 66, 4.0f, 0, 0);
	Function_13(&bVar12, 67, 4.0f, 0, 0);
	Function_13(&bVar12, 69, 4.0f, 0, 0);
	Function_13(&bVar12, 65, 4.0f, 0, 0);
	Function_13(&bVar12, 71, 4.0f, 0, 0);
	Function_13(&bVar12, 72, 4.0f, 0, 0);
	Function_13(&bVar12, 486, 4.0f, 0, 0);
	Function_13(&bVar12, 487, 4.0f, 0, 0);
	Function_13(&bVar12, 489, 4.0f, 0, 0);
	Function_13(&bVar12, 490, 4.0f, 0, 0);
	Function_13(&bVar12, 491, 4.0f, 0, 0);
	Function_13(&bVar12, 493, 4.0f, 0, 0);
	...
	uVar15 = FIND_NAMED_LAYOUT("CootsChapel_layout");
	if (IS_LAYOUTREF_VALID(&uVar15))
	{
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "coov_region");
		if (IS_VOLUME_VALID(&uVar16))
		{
			Function_3(&uVar16, &uVar11, 0.0f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xF17 / 3863
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xF28 / 3880
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xF80 / 3968
{
	var uVar0;
...
void Function_5(char* cParam0) //Position: 0x102C / 4140
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x106C / 4204
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x1089 / 4233
{
...
var Function_8(var uParam0, int iParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x109A / 4250
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1118 / 4376
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1184 / 4484
{
	int iVar0;
...
var Function_11(bool bParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x11F0 / 4592
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1237 / 4663
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1244 / 4676
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x12C6 / 4806
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x12D5 / 4821
{
	if (!Function_4(128))
	{
		return;
