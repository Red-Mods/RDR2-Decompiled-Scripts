...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46894[2], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_25(Global_46894[2], 0);
				(&Local_35 + 232) = Function_25(Global_46894[2], 0);
				Function_24(&Local_35 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_35 + 68)[iVar0] = iLocal_4 * 10;
					Function_23(Global_46894[2], iVar0, 0);
					*(&Local_35 + 128[iVar02]) = Function_23(Global_46894[2], iVar0, 0);
					iVar0++;
				}
				if (Function_35())
				{
				...
				Function_22(Global_46894[2]);
				*(&Local_35 + 268) = Function_22(Global_46894[2]);
				Function_21(Global_46894[2]);
				*(&Local_35 + 280) = Function_21(Global_46894[2]);
...
void Function_17() //Position: 0x5D7 / 1495
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5E0 / 1504
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x601 / 1537
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x638 / 1592
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_21(int iParam0) //Position: 0x653 / 1619
{
...
struct<8> Function_22(int iParam0) //Position: 0x755 / 1877
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_23(int iParam0, int iParam1, bool bParam2) //Position: 0x857 / 2135
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_24(int[] iParam0) //Position: 0xE03 / 3587
{
	int iVar0;
	var uVar1;
...
struct<8> Function_25(int iParam0, bool bParam1) //Position: 0xE5F / 3679
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_26(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF7B / 3963
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1189 / 4489
{
...
bool Function_28() //Position: 0x124D / 4685
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_29(int iParam0) //Position: 0x1264 / 4708
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_30(int iParam0) //Position: 0x1270 / 4720
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_31(var uParam0, int iParam1) //Position: 0x127F / 4735
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_32(var uParam0, bool bParam1) //Position: 0x128E / 4750
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_33() //Position: 0x12D0 / 4816
{
	return Function_34(0);
}

int Function_34(bool bParam0) //Position: 0x12DA / 4826
{
...
bool Function_35() //Position: 0x131B / 4891
{
...
var Function_36(int iParam0) //Position: 0x1346 / 4934
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_37(int iParam0) //Position: 0x1360 / 4960
{
...
int Function_38(var uParam0, int iParam1) //Position: 0x137C / 4988
{
	int iVar0;
...
bool Function_39(int iParam0) //Position: 0x1399 / 5017
{
...
void Function_40() //Position: 0x13AF / 5039
{
	Function_1();
	return;
}

void Function_41() //Position: 0x13B8 / 5048
{
...
void Function_42(int iParam0) //Position: 0x1408 / 5128
{
...
void Function_43(vector3 vParam0) //Position: 0x141F / 5151
{
...
void Function_44(var uParam0, int iParam1) //Position: 0x1444 / 5188
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, int iParam1) //Position: 0x145A / 5210
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_46(int iParam0) //Position: 0x146B / 5227
{
	return Function_47(iParam0, 1);
}

int Function_47(var uParam0, bool bParam1) //Position: 0x1479 / 5241
{
	return (uParam0 && bParam1) == 0;
}

void Function_48() //Position: 0x1486 / 5254
{
	return;
}

void Function_49() //Position: 0x148C / 5260
{
	return;
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x1492 / 5266
{
	var uVar0;
...
void Function_51(var uParam0) //Position: 0x14F1 / 5361
{
	int iVar0;
...
var Function_52() //Position: 0x150E / 5390
{
	var uVar0;
