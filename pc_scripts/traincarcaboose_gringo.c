...
bool Function_13(var uParam0) //Position: 0x56E / 1390
{
	...
	Function_23(3, 2);
	uVar0 = &uVar0;
	Function_21(&iLocal_0 + 8, "p_gen_lantern05x", 0, 0);
	Function_21(&iLocal_0 + 8, "p_gen_hayHook01x", 0, 0);
	if (!Function_16(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_15()));
	*(&iLocal_0 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarCaboose_pop", 2,802597E-45f, Vector(0.0f, 2,097436f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,594977f, 2,342571f, 5,429244f));
	*(&iLocal_0 + 56) = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "lantern05x0", "p_gen_lantern05x", Vector(0,1680129f, 2,841865f, -1,61908f), Vector(0.0f, 0.0f, 0.0f), true);
	*(&iLocal_0 + 64) = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "lantern05x1", "p_gen_lantern05x", Vector(0,09789637f, 2,833699f, 1,55144f), Vector(0.0f, 0.0f, 0.0f), true);
	*(&iLocal_0 + 72) = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "hayHook01x0", "p_gen_hayHook01x", Vector(-0,008369255f, 3,514904f, 1,6299f), Vector(-180.0f, 0.0f, 0.0f), false);
	*(&iLocal_0 + 80) = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "hayHook01x1", "p_gen_hayHook01x", Vector(0,06632159f, 3,534861f, -1,530476f), Vector(-180.0f, 0.0f, 0.0f), true);
	Function_14(&iLocal_0, &uParam0);
	return 1;
}

void Function_14(bool bParam0, int iParam1) //Position: 0x726 / 1830
{
	var uVar0;
...
var Function_15() //Position: 0x771 / 1905
{
	int iVar0;
...
bool Function_16(struct<2>[] Param0) //Position: 0x77A / 1914
{
	int iVar0;
	int iVar1;
...
void Function_17() //Position: 0xB3C / 2876
{
	if (!Function_25(128))
	{
		return;
...
bool Function_18() //Position: 0xB7C / 2940
{
	int iVar0;
...
void Function_19(struct<13> Param0) //Position: 0xBAA / 2986
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_20() //Position: 0xBBD / 3005
{
	if (!Function_25(128))
	{
		return;
...
var Function_21(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xBFF / 3071
{
	int iVar0;
	var uVar1;
...
var Function_22(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xC3D / 3133
{
	int iVar0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xD0C / 3340
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_24(var uParam0, int iParam1) //Position: 0xD56 / 3414
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_25(int iParam0) //Position: 0xD67 / 3431
{
	int iVar0;
