...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	bVar1 = Function_66(&uParam0, "nBoostTime", 0.0f);
	if (!DECOR_CHECK_EXIST(&uVar0, "horse_pills_effect"))
	{
		if ((IS_ACTOR_VALID(&uVar0) && IS_ACTOR_ALIVE(&uVar0)) && IS_ACTOR_MOUNTED(&uVar0))
		{
			DECOR_SET_FLOAT(&Global_54076, "horse_pills", bVar1);
			if ((Function_62(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
			{
				iLocal_4 = 0;
			}
			Function_60(482, 1, 0, 0);
			if (Function_59())
			{
				if (HAS_ITEM(SS_GET_STRING(1, 8), &Global_54076))
				{
					bVar2 = GET_ITEM_COUNT(SS_GET_STRING(1, 8), &Global_54076);
				}
				PLAYSTAT_INT("HC_HORSE_PILLS", bVar2);
			}
			iParam2 = 1;
		}
		else
		{
			Function_57("pills_no_horse", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
	}
	else
	{
		Function_57("already_horse_pills", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 0;
	}
	return;
}

void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2E23 / 11811
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x2EAE / 11950
{
	char* cVar0[16];
...
bool Function_59() //Position: 0x2EED / 12013
{
...
int Function_60(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2F18 / 12056
{
	int iVar0;
	int iVar1;
...
void Function_61(int iParam0) //Position: 0x3140 / 12608
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_62(int iParam0, bool bParam1, bool bParam2) //Position: 0x31DE / 12766
{
...
bool Function_63() //Position: 0x32A2 / 12962
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_64(int iParam0) //Position: 0x32B9 / 12985
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_65(int iParam0) //Position: 0x32C5 / 12997
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_66(var uParam0, var uParam1, int iParam2) //Position: 0x32D4 / 13012
{
	int iVar0;
...
var Function_67(int iParam0) //Position: 0x32EC / 13036
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_68(int iParam0, int iParam1) //Position: 0x3307 / 13063
{
	var uVar0;
	var uVar1;
