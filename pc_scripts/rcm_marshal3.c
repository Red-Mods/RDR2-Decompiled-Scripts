...
void main() //Position: 0x0 / 0
{
	...
	iLocal_358 = 0;
	iLocal_346 = 1000;
	Function_201(&Global_99725[1743] + 228, 1024);
	Function_200(&Global_99725[1743] + 228, 2048);
	Global_99725[1743].f_236 = 1;
	Function_199(&uLocal_336, 1237, 2, 1);
	Function_197(&uLocal_336, "$/content/DLC/ZombiePack/Gringos/DLC_eating_dynamic", 1, 0);
	Function_196(&iLocal_385);
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_358)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (IS_LAYOUTREF_VALID(&uLocal_359))
					{
						...
						if (IS_ACTOR_VALID(&uLocal_361) && Function_185(&uLocal_336))
						{
							uLocal_381 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "Marshal3_StayOut", 2,802597E-45f, Vector(-2162,658f, 19,579f, 2529,682f), Vector(0.0f, 1,118f, 0.0f), Vector(36,527f, 8,597f, 32,858f));
							CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_381, 15);
							...
							uLocal_383 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "Marshal3_Gateway", 2,802597E-45f, Vector(-2168,751f, 19,41f, 2533,672f), Vector(0.0f, 0.0f, 0.0f), Vector(21,115f, 8,273f, 13,947f));
							iLocal_363 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "RCM_Marshal3_Eli", 1237, Vector(-2173,109f, 16,164f, 2534,515f), Vector(0.0f, -51,56f, 0.0f));
							uLocal_377 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "Marshal3_ChowGringo", "DLC_eating_dynamic", Vector(-2173,524f, 16,185f, 2534,993f), Vector(0.0f, 199,263f, 0.0f)));
							SET_ACTOR_FACTION(&uLocal_361, 20);
							SET_ACTOR_FACTION(&iLocal_363, 20);
							DELETE_ALL_WEAPONS_FROM_ACTOR(&uLocal_361);
							DELETE_ALL_WEAPONS_FROM_ACTOR(&iLocal_363);
							SET_OBJECT_COLLIDE_WITH_OBJECT(&uLocal_361, &iLocal_363, 0);
							SET_OBJECT_COLLIDE_WITH_OBJECT(&iLocal_363, &uLocal_361, 0);
							TASK_USE_GRINGO(&iLocal_363, &uLocal_377, "UseCase1", 4294967295, 1);
							SNAP_ACTOR_TO_GRINGO(&iLocal_363, GET_OBJECT_FROM_GRINGO(&uLocal_377), "UseCase1", true, 0, 0);
							TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_361, Vector(-2173,287f, 16,176f, 2535,027f), -38,986f, 1, 1, true);
							SET_ACTION_NODE_FOR_ACTOR(&uLocal_361, "zombie/PlayDead/Variant1/PlayDeadLoop");
							Function_184(&uLocal_361, 4294967295, 0);
							iLocal_358 = 1;
							Function_183(&iLocal_385);
						}
						else if (Function_181(&iLocal_385) < 5.0f)
						{
							Function_183(&iLocal_385);
						}
						Function_174(&(Global_99725[1743]), 17, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						uLocal_359 = CREATE_LAYOUT("RCM_Marshal3_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (((AI_IS_AGGROING(&uLocal_361, &Global_54076) || AI_IS_HOSTILE_OR_ENEMY(&uLocal_361, &Global_54076)) || GET_LAST_ATTACKER(&uLocal_361) != &Global_54076) || GET_ACTOR_HEALTH(&uLocal_361) > GET_ACTOR_MAX_HEALTH(&uLocal_361))
				{
					bLocal_405 = true;
				}
				if (!bLocal_405)
				{
					if (((AI_IS_AGGROING(&uLocal_361, &Global_54076) || AI_IS_HOSTILE_OR_ENEMY(&uLocal_361, &Global_54076)) || GET_LAST_ATTACKER(&uLocal_361) != &Global_54076) || GET_ACTOR_HEALTH(&iLocal_363) > GET_ACTOR_MAX_HEALTH(&iLocal_363))
					{
						bLocal_405 = true;
					}
				}
				if (bLocal_405)
				{
					...
					if (IS_ACTOR_ALIVE(&uLocal_361))
					{
						Function_167(&uLocal_361, 4294967295, 1);
						SET_ACTOR_FACTION(&uLocal_361, 32);
						SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(&uLocal_361, 322, 0, 2, 0), "Marshal3_JonahBlip");
						TASK_MELEE_ATTACK(&uLocal_361, &Global_54076, -1.0f);
						SET_OBJECT_COLLIDE_WITH_OBJECT(&uLocal_361, &iLocal_363, 1);
					}
					if (IS_ACTOR_ALIVE(&iLocal_363))
					{
						SET_ACTOR_FACTION(&iLocal_363, 32);
						SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(&iLocal_363, 322, 0, 2, 0), "Marshal3_EliBlip");
						TASK_MELEE_ATTACK(&iLocal_363, &Global_54076, -1.0f);
						SET_OBJECT_COLLIDE_WITH_OBJECT(&iLocal_363, &uLocal_361, 1);
					}
					Function_201(&Global_99725[1743] + 228, 512);
					Function_201(&Global_99725[1743] + 228, 2048);
					if (IS_BLIP_VALID(&Global_99725[1743] + 272))
					{
						REMOVE_BLIP(&Global_99725[1743] + 272);
					}
					if (IS_BLIP_VALID(&Global_99725[1743] + 280))
					{
						REMOVE_BLIP(&Global_99725[1743] + 280);
					}
					iLocal_358 = 5;
					Function_183(&iLocal_385);
				}
				else if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					...
					{
						if (IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_383))
						{
							Function_159(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0);
							GATEWAY_DISABLE(&Global_99725[ScriptParam_043] + 288, 1);
							Function_201(&Global_99725[1743] + 228, 2048);
							if (IS_BLIP_VALID(&Global_99725[1743] + 272))
							{
			...
			case 0x00000003:
				if (Function_122("$/cutscene/marshal_rcm_3_cs/marshal_rcm_3_cs", &iLocal_346, 33447, 33440, 32384, 32063, 31797, 31781, 1, 1, 2, 2, 0))
				{
					iLocal_358 = 5;
					Function_183(&iLocal_385);
				}
			...
			case 0x00000005:
				...
				{
					if (IS_ACTOR_ALIVE(&uLocal_361) || IS_ACTOR_ALIVE(&iLocal_363))
					{
						AUDIO_MUSIC_FORCE_TRACK("TC_FTR_SONG_01", "LOW_FIGHT_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
						Function_121("Marshal3a_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					}
					iLocal_403 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
					iVar1 = 0;
					while (iVar1 <= iLocal_403)
					{
						SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iVar1), 4, 0);
						iVar1++;
					}
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Marshal3a_OBJ", 0, 3, false);
					Function_120(Global_99725[ScriptParam_043].f_224, 0);
					iLocal_358 = 6;
					Function_117(&iLocal_389, (15.0f - 4.0f));
				}
				break;
			
			case 0x00000006:
				if ((IS_ACTOR_ALIVE(&uLocal_361) || IS_ACTOR_ALIVE(&iLocal_363)) || IS_PLAYER_DEADEYE(0))
				{
					if (Function_181(&iLocal_389) < 15.0f)
					{
						fVar0 = 0.0f;
						if (IS_ACTOR_ALIVE(&uLocal_361))
						{
							fVar0 = Function_116(&Global_54076, &uLocal_361);
						}
						if (IS_ACTOR_ALIVE(&iLocal_363))
						{
							fVar0 = Function_115(fVar0, Function_116(&Global_54076, &iLocal_363));
						}
						if (fVar0 >= 15.0f)
						{
							Function_111();
						}
						Function_183(&iLocal_389);
					}
					if (Function_181(&iLocal_385) < 5.0f)
					{
						Function_183(&iLocal_385);
					}
				}
				...
				{
					Function_110();
					Function_121("Marshal3b_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					iLocal_403 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
					iVar1 = 0;
					while (iVar1 <= iLocal_403)
					{
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Marshal3b_OBJ", 0, 3, false);
					Function_120(Global_99725[ScriptParam_043].f_224, 0);
					Function_1(17, 1, 1, 0);
					Function_201(&Global_99725[ScriptParam_043] + 228, 128);
					ACTOR_DATA_GRAVITY_LIMIT(0);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x929 / 2345
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_200(&Global_99725[iParam043] + 228, 64);
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xDA3 / 3491
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xF44 / 3908
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xF4A / 3914
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xF89 / 3977
{
	...
	*(&Global_53524 + 56) = GET_TIME_OF_DAY();
	...
	if (&bParam0)
	{
		Function_200(&Global_99144, 1);
		Function_200(&Global_99144, 2);
	}
	Global_140631 = 1;
	return;
}

void Function_6() //Position: 0xFDE / 4062
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_7() //Position: 0x1029 / 4137
{
...
void Function_8() //Position: 0x112F / 4399
{
	float fVar0;
...
void Function_9() //Position: 0x1162 / 4450
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x12F5 / 4853
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x14AE / 5294
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x14BC / 5308
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x16D9 / 5849
{
...
struct<8> Function_14(int iParam0) //Position: 0x16EE / 5870
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x1795 / 6037
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1A31 / 6705
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_17() //Position: 0x206F / 8303
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x2078 / 8312
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2089 / 8329
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x2180 / 8576
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x219B / 8603
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x2202 / 8706
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x2214 / 8724
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2226 / 8742
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x235A / 9050
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x2369 / 9065
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x23A2 / 9122
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x23DF / 9183
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x2579 / 9593
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x27BD / 10173
{
...
struct<8> Function_31() //Position: 0x27FE / 10238
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x2887 / 10375
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x291E / 10526
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x299D / 10653
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x29DA / 10714
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2BE6 / 11238
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x2C9D / 11421
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2CB5 / 11445
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x2DAD / 11693
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_40(int iParam0) //Position: 0x2DB7 / 11703
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x2DCD / 11725
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x2E99 / 11929
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x2EB6 / 11958
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x36E2 / 14050
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x371D / 14109
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x372A / 14122
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3739 / 14137
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x37E8 / 14312
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (!Function_51(&Global_6667[228] + 184, 2) || ((((((Function_56(14) && Function_56(18)) && Function_56(37)) && Function_56(7)) && Function_56(11)) && Function_56(5)) && Function_56(21)))
	{
	...
	if (!Function_51(&Global_6667[328] + 184, 2) || ((Function_56(27) && Function_56(1)) && Function_56(23)))
	{
	...
	if (!Function_56(7))
	{
		...
		if (((Function_56(6) && Function_49(Global_46949) < 0) && Function_49(Global_46951) < 0) && Function_49(Global_46952) < 0)
		{
...
int Function_49(int iParam0) //Position: 0x411B / 16667
{
...
bool Function_50(int iParam0) //Position: 0x4135 / 16693
{
...
bool Function_51(int iParam0, int iParam1) //Position: 0x414C / 16716
{
	int iVar0;
...
bool Function_52() //Position: 0x4169 / 16745
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x4175 / 16757
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x418A / 16778
{
...
int Function_55(int iParam0) //Position: 0x41F0 / 16880
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_56(int iParam0) //Position: 0x42B2 / 17074
{
...
void Function_57(int iParam0) //Position: 0x42C7 / 17095
{
	...
	Function_120(Function_52(), 0);
	return;
}

bool Function_58(int iParam0, bool bParam1) //Position: 0x4310 / 17168
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x434E / 17230
{
...
bool Function_60(int iParam0) //Position: 0x4368 / 17256
{
...
void Function_61(bool bParam0) //Position: 0x437E / 17278
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_62(struct<229> Param0) //Position: 0x4538 / 17720
{
	float fVar0;
	int iVar1;
...
void Function_63(struct<217> Param0) //Position: 0x4608 / 17928
{
	float fVar0;
	var uVar1;
...
int Function_64(var uParam0, int iParam1) //Position: 0x46C6 / 18118
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4830 / 18480
{
	struct<8> Var0;
...
struct<32> Function_66(char* cParam0) //Position: 0x48D8 / 18648
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x4944 / 18756
{
	char* cVar0[32];
...
int Function_68(int iParam0) //Position: 0x4966 / 18790
{
	int iVar0;
	struct<2> Var1;
...
float Function_69(int iParam0, struct<2> Param1) //Position: 0x4AD4 / 19156
{
	struct<2> Var0;
...
struct<8> Function_70(int iParam0) //Position: 0x4B4B / 19275
{
	struct<2> Var0;
...
void Function_71(int iParam0) //Position: 0x4BB7 / 19383
{
...
bool Function_72(int iParam0) //Position: 0x4C1F / 19487
{
...
void Function_73(struct<153> Param0) //Position: 0x4C35 / 19509
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_78(Function_79(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_77(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_45(Global_99725[iParam143].f_228, 64))
	{
...
void Function_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x514B / 20811
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x51D6 / 20950
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x5215 / 21013
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(int iParam0) //Position: 0x5242 / 21058
{
...
var Function_78(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x526E / 21102
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_79(int iParam0) //Position: 0x528F / 21135
{
...
bool Function_80(struct<249> Param0) //Position: 0x52A4 / 21156
{
...
bool Function_81(struct<265> Param0) //Position: 0x53D4 / 21460
{
	int iVar0;
...
bool Function_82(int iParam0) //Position: 0x5535 / 21813
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_83(int iParam0) //Position: 0x5559 / 21849
{
...
bool Function_84(int iParam0) //Position: 0x556E / 21870
{
	return Global_116927[iParam06].f_16;
}

bool Function_85(struct<237> Param0) //Position: 0x557E / 21886
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_86(int iParam0) //Position: 0x564D / 22093
{
...
bool Function_87(int iParam0) //Position: 0x56A8 / 22184
{
	int iVar0;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x56C4 / 22212
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x56E1 / 22241
{
...
int Function_90(int iParam0) //Position: 0x56F6 / 22262
{
...
void Function_91() //Position: 0x570B / 22283
{
...
int Function_92(int iParam0, int iParam1) //Position: 0x578B / 22411
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
	...
	switch (iParam0)
	{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_56(26) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_56(25) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_56(24) && iVar15)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_56(23) && iVar15)
					{
				...
				case 0x00000008:
					if (Function_56(55) && iVar16)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_56(54) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_56(27) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_56(52) && iVar13)
					{
						cVar4 = &Global_44085[Global_46926[2]9] + 8;
						iVar13 = 0;
					}
					else if (Function_56(51) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
					else if (Function_56(50) && iVar13)
					{
						cVar4 = &Global_44085[Global_46796[4]9] + 8;
						iVar13 = 0;
					}
					else if (Function_56(49) && iVar13)
					{
						cVar4 = &Global_44085[Global_46816[1]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_56(19) && iVar17)
					{
						Var0 = Vector(-1708,36f, 46,18f, 2175,89f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_58(6, 0) && Function_56(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_56(17) && iVar17)
					{
						Var0 = Vector(-1687,208f, 53,208f, 2140,491f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_58(9, 0) && Function_56(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_56(15) && iVar17)
					{
...
int Function_93(int iParam0) //Position: 0x63EE / 25582
{
	int iVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x643D / 25661
{
...
int Function_95(int iParam0) //Position: 0x6453 / 25683
{
...
void Function_96() //Position: 0x64BC / 25788
{
...
bool Function_97(int iParam0) //Position: 0x64E1 / 25825
{
	if (!Function_94(iParam0))
	{
...
bool Function_98(int iParam0, int iParam1) //Position: 0x6532 / 25906
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x655F / 25951
{
	if (!Function_94(iParam0))
	{
...
void Function_100(bool bParam0) //Position: 0x65B1 / 26033
{
	int iVar0;
...
void Function_101() //Position: 0x65EB / 26091
{
	bool bVar0;
...
void Function_102(int iParam0) //Position: 0x6649 / 26185
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6693 / 26259
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x6708 / 26376
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x6742 / 26434
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x67BE / 26558
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x685F / 26719
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x689C / 26780
{
...
bool Function_109() //Position: 0x68AF / 26799
{
...
void Function_110() //Position: 0x68CA / 26826
{
	HUD_CLEAR_OBJECTIVE();
...
void Function_111() //Position: 0x68D6 / 26838
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(false, "RCMMarsh_JonEli", "RCMMarsh_JonEli", true, 2, 1, 0, 1);
		Function_112(3);
...
void Function_112(int iParam0) //Position: 0x691D / 26909
{
	Function_113(0, &Global_54076, iParam0, 0);
	return;
}

void Function_113(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x692E / 26926
{
	bool bVar0;
	
	uParam3 = &uParam3;
	if (Function_45(uParam2, Function_114(uParam0)))
	{
		bVar0 = uParam0;
...
int Function_114(bool bParam0) //Position: 0x6956 / 26966
{
	return SHIFT_LEFT(true, bParam0);
}

float Function_115(int iParam0, int iParam1) //Position: 0x6962 / 26978
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
float Function_116(int iParam0, int iParam1) //Position: 0x6975 / 26997
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_117(int iParam0, float fParam1) //Position: 0x6A6A / 27242
{
	if (!Function_119(&iParam0))
	{
		Function_118(&iParam0, fParam1);
	}
	return;
}

void Function_118(vector3 vParam0) //Position: 0x6A82 / 27266
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_201(&vParam0, 1);
	Function_200(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_119(int iParam0) //Position: 0x6AA7 / 27303
{
	return Function_45(iParam0, 1);
}

void Function_120(bool bParam0, bool bParam1) //Position: 0x6AB5 / 27317
{
	bool bVar0;
...
void Function_121(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6ADA / 27354
{
	struct<4> Var0;
	var uVar4;
...
bool Function_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6B6F / 27503
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_123(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_123(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6C28 / 27688
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		case 0x000003E8:
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_132())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_181(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_129(&Global_99170, &Global_10996);
...
void Function_124(var uParam0, bool bParam1) //Position: 0x728A / 29322
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_125() //Position: 0x7359 / 29529
{
	int iVar0;
...
void Function_126() //Position: 0x73D1 / 29649
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_127() //Position: 0x7416 / 29718
{
...
void Function_128(bool bParam0) //Position: 0x7428 / 29736
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_129(var uParam0, int iParam1) //Position: 0x7445 / 29765
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar2))
		{
			...
			if ((&iVar3 == &Global_54076 && !Function_130(&iVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(&iVar3))
			{
...
bool Function_130(int iParam0) //Position: 0x74D7 / 29911
{
	bool bVar0;
...
int Function_131(bool bParam0) //Position: 0x7508 / 29960
{
	bool bVar0;
	var uVar1;
...
bool Function_132() //Position: 0x75CB / 30155
{
	bool bVar0;
	var uVar1;
...
bool Function_133(struct<37> Param0) //Position: 0x7608 / 30216
{
	return Param0.f_36;
}

void Function_134(var uParam0, int iParam1) //Position: 0x7613 / 30227
{
	Function_135(&uParam0, &iParam1, 0);
	return;
}

void Function_135(var uParam0, bool bParam1, int iParam2) //Position: 0x7623 / 30243
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_136(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x779B / 30619
{
	int iVar0;
	int iVar1;
...
void Function_137(bool bParam0) //Position: 0x79C3 / 31171
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_138(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7A61 / 31329
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_139() //Position: 0x7A8B / 31371
{
	var uVar0;
	var uVar1;
...
void Function_140() //Position: 0x7AE6 / 31462
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_141() //Position: 0x7C25 / 31781
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_142() //Position: 0x7C35 / 31797
{
	Function_143(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
...
void Function_143(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7C5B / 31835
{
	var uVar0;
	...
	Function_124(&uParam9, &bParam10);
}

void Function_144() //Position: 0x7D2A / 32042
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_145() //Position: 0x7D3F / 32063
{
	SET_OBJECT_COLLIDE_WITH_OBJECT(&uLocal_361, &iLocal_363, 1);
	SET_OBJECT_COLLIDE_WITH_OBJECT(&iLocal_363, &uLocal_361, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2159,252f, 16,191f, 2535,111f), 88,961f, 1, 1, true);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_361, Vector(-2166,273f, 16,151f, 2534,507f), 262,295f, 1, 1, true);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &iLocal_363, Vector(-2166,39f, 16,188f, 2535,517f), -83,691f, 1, 1, true);
	ACTOR_END_FORCE_HOLSTER(&Global_54076);
	ACTOR_DRAW_LAST_WEAPON(&Global_54076, 0);
	RESET_ACTIONTREE_FOR_ACTOR(&Global_54076);
	ACTOR_POP_NEXT_GAIT(&Global_54076, 0, 1.0f);
	ACTOR_POP_NEXT_GAIT(&uLocal_361, 3, 1.0f);
	ACTOR_POP_NEXT_GAIT(&iLocal_363, 3, 1.0f);
	AI_ACTOR_FORCE_SPEED(&uLocal_361, 4);
	AI_ACTOR_FORCE_SPEED(&iLocal_363, 4);
	SET_ACTOR_FACTION(&uLocal_361, 32);
	SET_ACTOR_FACTION(&iLocal_363, 32);
	SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(&uLocal_361, 322, 0, 2, 0), "Marshal3_JonahBlip");
	SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(&iLocal_363, 322, 0, 2, 0), "Marshal3_EliBlip");
...
int Function_146() //Position: 0x7E80 / 32384
{
	if (!iLocal_406)
	{
		Function_147(StackVal, Vector(-2162,434f, 16,196f, 2553,133f), &uLocal_379);
		iLocal_406 = 1;
	}
	return 1;
}

void Function_147(vector3 vParam0) //Position: 0x7EA9 / 32425
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_37(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_116(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_116(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_116(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
void Function_148(float fParam0, float fParam1) //Position: 0x8055 / 32853
{
...
void Function_149() //Position: 0x8166 / 33126
{
...
void Function_150() //Position: 0x819A / 33178
{
...
int Function_151() //Position: 0x82A0 / 33440
{
	return 1;
}

int Function_152() //Position: 0x82A7 / 33447
{
	uLocal_379 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_359, "Marshal3_CSVol", 2,802597E-45f, Vector(-2162,658f, 19,579f, 2529,682f), Vector(0.0f, 1,118f, 0.0f), Vector(36,527f, 8,597f, 32,858f));
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Deputy01", &uLocal_361);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Deputy02", &iLocal_363);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_155(0, 0, 1, 1, 0, 1, 1, &uLocal_379, 1, 1, 1, 1, 0x3f800000, 0);
	Function_153(StackVal, &uLocal_359, *(&Global_99725[1743] + 196), &uLocal_379, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_153(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8380 / 33664
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_154(var uParam0, float fParam1) //Position: 0x8620 / 34336
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_155(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x86A2 / 34466
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_158(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_17(), 2, Function_158(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
				DELETE_PROJECTILES_IN_VOLUME(&uVar0);
			}
		}
		Function_136(19, 1, 0, 0);
	}
...
void Function_156(int iParam0) //Position: 0x8954 / 35156
{
	int iVar0;
...
var Function_157() //Position: 0x8988 / 35208
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_158(bool bParam0) //Position: 0x8A16 / 35350
{
	struct<2> Var0;
...
int Function_159(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8A28 / 35368
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_160(vector3 vParam0) //Position: 0x8C5D / 35933
{
	var uVar0;
...
float Function_161(var uParam0, bool bParam1) //Position: 0x8CD3 / 36051
{
	struct<2> Var0;
...
void Function_162(var uParam0, bool bParam1) //Position: 0x8CF4 / 36084
{
	var uVar0;
	var uVar1;
...
bool Function_163(int iParam0, bool bParam1, bool bParam2) //Position: 0x8D5E / 36190
{
...
bool Function_164() //Position: 0x8E22 / 36386
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_165(int iParam0) //Position: 0x8E39 / 36409
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_166(int iParam0) //Position: 0x8E45 / 36421
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_167(var uParam0, int iParam1, bool bParam2) //Position: 0x8E54 / 36436
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
void Function_168() //Position: 0x9020 / 36896
{
	if (IS_ACTOR_VALID(&iLocal_363))
	{
		RELEASE_ACTOR(&iLocal_363);
	}
	if (IS_LAYOUTREF_VALID(&uLocal_359))
	{
	...
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_170(&uLocal_336);
	if (bLocal_404)
	{
	}
	Function_200(&Global_99725[1743] + 228, 512);
	Function_200(&Global_99725[1743] + 228, 2048);
	Function_169(0, 0, 1);
	return;
}

int Function_169(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9080 / 36992
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_170(int iParam0) //Position: 0x90B2 / 37042
{
	int iVar0;
...
void Function_171(struct<2>[] Param0, int iParam1) //Position: 0x90DA / 37082
{
	if (Function_173(&(Param0[iParam12]), 4))
	{
		if (Function_173(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_172(&(Param0[iParam12]), 1);
			Function_172(&(Param0[iParam12]), 2);
			Function_172(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_172(struct<13> Param0) //Position: 0x9225 / 37413
{
	int iVar0;
...
bool Function_173(struct<13> Param0) //Position: 0x9242 / 37442
{
	int iVar0;
...
int Function_174(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) //Position: 0x9260 / 37472
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == iParam1)
				{
					...
					uVar2 = Function_176(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == iParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_176(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
...
int Function_175(struct<257> Param0) //Position: 0x9403 / 37891
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_175(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_176(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, int iParam12) //Position: 0x943F / 37951
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_179(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_180()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_179(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_180()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_179(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_177() //Position: 0x96A7 / 38567
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_178(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_178(char* cParam0) //Position: 0x96FB / 38651
{
	char* cVar0[64];
...
bool Function_179(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9824 / 38948
{
...
int Function_180() //Position: 0x98B0 / 39088
{
	if (IS_PS3())
	{
		return 1;
...
float Function_181(vector3 vParam0) //Position: 0x98BF / 39103
{
	if (Function_119(&vParam0))
	{
...
bool Function_182(int iParam0) //Position: 0x998C / 39308
{
	return Function_45(iParam0, 2);
}

void Function_183(int iParam0) //Position: 0x999A / 39322
{
	Function_118(&iParam0, 0.0f);
	return;
}

void Function_184(var uParam0, int iParam1, bool bParam2) //Position: 0x99A7 / 39335
{
	switch (&iParam1)
	{
		case 0x00000000:
	...
	if (&iParam1 != 4294967295)
	{
		if (&bParam2)
		{
			Function_167(&uParam0, &iParam1, 0);
		}
		else
		{
...
int Function_185(struct<2>[] Param0) //Position: 0x9A64 / 39524
{
	int iVar0;
	int iVar1;
	...
	Function_189();
	iVar1 = 0;
	if (!Function_173(&(Param0[iVar02]), 16))
	{
	...
	{
		if (Function_173(&(Param0[iVar02]), 4))
		{
			if (!Function_173(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_173(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_173(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_173(&(Param0[iVar02]), 4))
		{
			if (!Function_173(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_186() //Position: 0x9E26 / 40486
{
	if (!Function_87(128))
	{
		return;
...
bool Function_187() //Position: 0x9E66 / 40550
{
	int iVar0;
...
void Function_188(struct<13> Param0) //Position: 0x9E94 / 40596
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_189() //Position: 0x9EA7 / 40615
{
	if (!Function_87(128))
	{
		return;
...
void Function_190() //Position: 0x9EE9 / 40681
{
	int iVar0;
	
	if (!Function_195(Global_46760[0]))
	{
		return;
	}
	if (!IS_DOOR_VALID(&uLocal_375))
	{
		uLocal_375 = Function_193("narmadillo", "sheriff", 1);
	}
	if (IS_DOOR_VALID(&uLocal_375))
	{
		SET_DOOR_LOCK_VISIBLE(&uLocal_375, 0);
		if (!IS_DOOR_CLOSED(&uLocal_375))
		{
			if (!IS_DOOR_CLOSING(&uLocal_375))
			{
				CLOSE_DOOR_FAST(&uLocal_375);
			}
		}
		if (!IS_DOOR_LOCKED(&uLocal_375))
		{
			Function_192(&uLocal_375, 1);
		}
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		if (!IS_DOOR_VALID(&(uLocal_365[iVar0])))
		{
			uLocal_365[iVar0] = Function_193("narmadillo", "corralPens01x", iLocal_393[iVar0]);
		}
		if (IS_DOOR_VALID(&(uLocal_365[iVar0])))
		{
			if (IS_DOOR_LOCKED(&(uLocal_365[iVar0])))
			{
				Function_191(&(uLocal_365[iVar0]), 1);
			}
		}
		iVar0++;
	}
...
void Function_191(var uParam0, int iParam1) //Position: 0x9FDF / 40927
{
...
void Function_192(var uParam0, int iParam1) //Position: 0xA037 / 41015
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
int Function_193(var uParam0, var uParam1, int iParam2) //Position: 0xA092 / 41106
{
	return Function_194(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_194(int iParam0, char* cParam1, bool bParam3) //Position: 0xA0A6 / 41126
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_195(int iParam0) //Position: 0xA14B / 41291
{
	if (!Function_72(iParam0))
	{
		return 1;
...
void Function_196(int iParam0) //Position: 0xA167 / 41319
{
	if (!Function_119(&iParam0))
	{
		Function_118(&iParam0, 0.0f);
...
var Function_197(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA17E / 41342
{
	int iVar0;
	var uVar1;
...
var Function_198(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA1BC / 41404
{
	int iVar0;
...
var Function_199(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xA28B / 41611
{
	int iVar0;
...
void Function_200(int iParam0, int iParam1) //Position: 0xA367 / 41831
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_201(var uParam0, int iParam1) //Position: 0xA37D / 41853
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_202() //Position: 0xA38E / 41870
{
	iLocal_393[0] = 2;
	iLocal_393[1] = 3;
	iLocal_393[2] = 4;
