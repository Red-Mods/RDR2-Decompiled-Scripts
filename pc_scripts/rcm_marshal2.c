...
void main() //Position: 0x0 / 0
{
	...
	iLocal_370 = 0;
	iLocal_358 = 1000;
	Function_200(&uLocal_336, "tend_counter_and_patron", 1, 0);
	Function_200(&uLocal_336, "dlc_eating_dynamic", 1, 0);
	Function_199(&uLocal_336, 1210, 3, 0);
	Function_199(&uLocal_336, 1204, 3, 0);
	Function_199(&uLocal_336, 1212, 3, 0);
	Function_198(&iLocal_415);
	while (!IS_EXITFLAG_SET())
	{
		...
		if (IS_ACTOR_VALID(&uLocal_375))
		{
			...
			{
				SET_ACTOR_FACTION(&uLocal_375, 4);
				TASK_PRIORITY_SET(&uLocal_375, false);
				TASK_FLEE_ACTOR(&uLocal_375, &Global_54076, 200.0f, -1.0f, 0, 0, 0);
				if (!Function_191(16))
				{
					Function_190(16, 1);
				}
				if (IS_VOLUME_VALID(&uLocal_399))
				{
					DESTROY_VOLUME(&uLocal_399);
				}
				Function_189(&Global_99725[ScriptParam_043] + 228, 128);
		...
		switch (iLocal_370)
		{
			case 0x00000000:
				...
				{
					if (IS_LAYOUTREF_VALID(&uLocal_371))
					{
						uLocal_375 = &Global_99725[ScriptParam_043] + 312;
						if (IS_ACTOR_VALID(&uLocal_375) && Function_178(&uLocal_336))
						{
							uLocal_399 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_371, "Marshal2_StayOut", 2,802597E-45f, Vector(-2087,249f, 20,071f, 2602,065f), Vector(0.0f, 24,353f, 0.0f), Vector(19,13f, 8,597f, 15,587f));
							CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_399, 15);
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_399);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_399);
							uLocal_385 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_ShopGringo", "tend_counter_and_patron", Vector(-2150,842f, 17,666f, 2623,209f), Vector(0.0f, -89,972f, 0.0f)));
							SET_ACTOR_FACTION(&uLocal_375, 20);
							TASK_PRIORITY_SET(&uLocal_375, true);
							SNAP_ACTOR_TO_GRINGO(&uLocal_375, GET_OBJECT_FROM_GRINGO(&uLocal_385), "UseCase1", true, 0, 0);
							TASK_USE_GRINGO(&uLocal_375, &uLocal_385, "UseCase1", 4294967295, 1);
							DECOR_SET_INT(&uLocal_375, "iSpecificItem", true);
							iLocal_370 = 1;
							Function_176(&iLocal_415);
						}
						else if (Function_173(&iLocal_415) < 5.0f)
						{
							Function_176(&iLocal_415);
						}
						Function_166(&(Global_99725[1643]), 16, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						uLocal_371 = CREATE_LAYOUT("RCM_Marshal2_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (StackVal && FABS((StackVal - !Function_162(&Global_54076, 1, 1))) > 2.0f)
					{
						if (Function_158(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
						{
			...
			case 0x00000003:
				if (Function_113("$/cutscene/MARSHAL_RCM_2_CS_SEQ/MARSHAL_RCM_2_CS_SEQ", &iLocal_358, 35564, 35557, 33548, 31236, 30970, 30954, 1, 1, 2, 2, 0))
				{
					iLocal_422 = 0;
					iLocal_370 = 5;
					Function_176(&iLocal_415);
			...
			case 0x00000005:
				if (!HUD_IS_FADING() && !HUD_IS_FADED())
				{
					...
					Function_112("Marshal2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					iLocal_419 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
					iVar0 = 0;
					while (iVar0 <= iLocal_419)
					{
						SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iVar0), 4, 0);
						iVar0++;
					}
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Marshal2_OBJ", 0, 3, false);
			...
			case 0x0000000D:
				...
				{
					case 0x00000000:
						if (Function_173(&iLocal_415) < 0,3f)
						{
							Function_1(&(uLocal_377[0]), 4294967295, 0);
							TASK_CLEAR(&(uLocal_377[0]));
							iLocal_420 = 1;
						}
						break;
					
					case 0x00000001:
						if (Function_173(&iLocal_415) < 1.0f)
						{
							Function_1(&(uLocal_377[1]), 4294967295, 0);
							TASK_CLEAR(&(uLocal_377[1]));
							iLocal_420 = 2;
						}
						break;
					
					case 0x00000002:
						if (Function_173(&iLocal_415) < 1,9f)
						{
							Function_1(&(uLocal_377[2]), 4294967295, 0);
							TASK_CLEAR(&(uLocal_377[2]));
							iLocal_420 = 3;
						}
						break;
					
					case 0x00000003:
						if (Function_173(&iLocal_415) < 4.0f)
						{
...
void Function_1(var uParam0, int iParam1, bool bParam2) //Position: 0x61C / 1564
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_2() //Position: 0x7E8 / 2024
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

var Function_3() //Position: 0x7F2 / 2034
{
	int iVar0;
...
void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x7FB / 2043
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_99725[iParam043].f_224, 0))
	{
		Function_61(Global_99725[iParam043].f_224);
	}
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xC75 / 3189
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_6() //Position: 0xE16 / 3606
{
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0xE1C / 3612
{
	if (Global_6624)
	{
		return;
...
void Function_8(bool bParam0) //Position: 0xE5B / 3675
{
...
void Function_9() //Position: 0xEB0 / 3760
{
	Function_36();
	Function_35();
	Function_35();
...
void Function_10() //Position: 0xEFB / 3835
{
...
void Function_11() //Position: 0x1001 / 4097
{
	float fVar0;
...
void Function_12() //Position: 0x1034 / 4148
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0x11C7 / 4551
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0x1380 / 4992
{
	Function_15(&Global_42918, 1, 0);
	return;
}

void Function_15(struct<2317> Param0) //Position: 0x138E / 5006
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_16() //Position: 0x15AB / 5547
{
...
struct<8> Function_17(int iParam0) //Position: 0x15C0 / 5568
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_18(int iParam0, bool bParam1, bool bParam2) //Position: 0x1667 / 5735
{
	int iVar0;
...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1903 / 6403
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_20(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_3(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_20(int iParam0) //Position: 0x1F41 / 8001
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_21(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1F52 / 8018
{
	char* cVar0[32];
...
struct<32> Function_22(char* cParam0) //Position: 0x2049 / 8265
{
	char* cVar0[32];
...
void Function_23(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2064 / 8292
{
	float fVar0;
...
var Function_24(int iParam0, int iParam1) //Position: 0x20CB / 8395
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_25(int iParam0, bool bParam1) //Position: 0x20DD / 8413
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_26(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x20EF / 8431
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_27(int iParam0) //Position: 0x2223 / 8739
{
	return Global_55480[iParam016].f_96;
}

float Function_28(int iParam0) //Position: 0x2232 / 8754
{
	if (!iParam0 != 4294967295)
	{
...
var Function_29(int iParam0) //Position: 0x226B / 8811
{
	if (iParam0 == 4294967295)
	{
...
void Function_30(int iParam0) //Position: 0x22A8 / 8872
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_31(int iParam0, bool bParam1, bool bParam2) //Position: 0x2442 / 9282
{
	int iVar0;
	int iVar1;
...
int Function_32(bool bParam0) //Position: 0x2686 / 9862
{
...
struct<8> Function_33() //Position: 0x26C7 / 9927
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x2750 / 10064
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x27E7 / 10215
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_36() //Position: 0x2866 / 10342
{
...
int Function_37(int iParam0, bool bParam1, int iParam2) //Position: 0x28A3 / 10403
{
	int iVar0;
	int iVar1;
...
void Function_38() //Position: 0x2AAF / 10927
{
	struct<2> Var0;
	var uVar2;
	...
	if (Function_110())
	{
		Function_44(&Global_53524 + 12, &Global_53524 + 16);
		Var0 = Function_44(&Global_53524 + 12, &Global_53524 + 16);
	}
	else
	{
...
bool Function_39(char* cParam0) //Position: 0x2B66 / 11110
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_40(var uParam0, var uParam1, float fParam2, float fParam3) //Position: 0x2B7E / 11134
{
	int iVar0;
	
	iVar0 = Function_42(&fParam2, &fParam3);
	if (Function_41(iVar0))
	{
		if (iVar0 == 15)
		{
			Global_53524.f_24 = Global_43788;
			Function_189(&Global_99144, 1);
			Function_102(&Global_99144, 2);
...
bool Function_41(int iParam0) //Position: 0x2C76 / 11382
{
...
int Function_42(bool bParam0, bool bParam1) //Position: 0x2C8C / 11404
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar3 <= Global_26200)
	{
		if (((Global_26200[iVar314].f_40 != 3 || Global_26200[iVar314].f_40 != 4) || (iVar3 != 15 && !&bParam0)) && (Global_26200[iVar314].f_52 != Global_43787 || bParam1))
		{
			...
			{
				fVar2 = Function_43(StackVal, StackVal, Global_54078, Global_26200[iVar314]);
				if (fVar2 > fVar1)
				{
					fVar1 = fVar2;
					iVar0 = iVar3;
	...
	if (Global_26651)
	{
		fVar2 = Function_43(StackVal, StackVal, Global_54078, Vector(-2833,843f, 50,332f, 2418,003f));
		if (fVar2 > fVar1)
		{
			return 4294967295;
		}
	}
	if (!Function_41(iVar0) && !&bParam1)
	{
		iVar0 = Function_42(&bParam0, 1);
	}
	return iVar0;
}

float Function_43(struct<2> Param0, struct<2> Param2) //Position: 0x2D58 / 11608
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_44(float fParam0, int iParam1) //Position: 0x2D75 / 11637
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_45(int iParam0) //Position: 0x35A1 / 13729
{
	var uVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x35DC / 13788
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(var uParam0, int iParam1) //Position: 0x35E9 / 13801
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x35F8 / 13816
{
	uParam0 = &uParam0;
...
void Function_49(int iParam0) //Position: 0x36A7 / 13991
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_191(4) && !Function_55(0))
	{
	...
	if (Function_191(5))
	{
		...
		if (!Function_191(8) && !Function_191(6))
		{
	...
	if (!Function_52(&Global_6667[228] + 184, 2) || ((((((Function_191(14) && Function_191(18)) && Function_191(37)) && Function_191(7)) && Function_191(11)) && Function_191(5)) && Function_191(21)))
	{
	...
	if (!Function_52(&Global_6667[328] + 184, 2) || ((Function_191(27) && Function_191(1)) && Function_191(23)))
	{
	...
	if (!Function_191(7))
	{
		...
		if (((Function_191(6) && Function_50(Global_46949) < 0) && Function_50(Global_46951) < 0) && Function_50(Global_46952) < 0)
		{
	...
	{
		Function_112(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_50(int iParam0) //Position: 0x3FC8 / 16328
{
...
bool Function_51(int iParam0) //Position: 0x3FE2 / 16354
{
...
bool Function_52(int iParam0, int iParam1) //Position: 0x3FF9 / 16377
{
	int iVar0;
...
bool Function_53() //Position: 0x4018 / 16408
{
	return STRING_TO_HASH(Function_54());
}

var Function_54() //Position: 0x4024 / 16420
{
	return "ZOMBIE_STORY";
}
...
bool Function_55(int iParam0) //Position: 0x4039 / 16441
{
	...
	return Global_21684[Function_56(iParam0)7].f_12 < 0;
}

int Function_56(int iParam0) //Position: 0x409F / 16543
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_57(int iParam0) //Position: 0x4161 / 16737
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_53(), &iParam0, 0, 3, false);
	Function_111(Function_53(), 0);
	return;
}

bool Function_58(int iParam0, bool bParam1) //Position: 0x41AA / 16810
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x41E8 / 16872
{
...
bool Function_60(int iParam0) //Position: 0x4202 / 16898
{
...
void Function_61(bool bParam0) //Position: 0x4218 / 16920
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_62(struct<229> Param0) //Position: 0x43D2 / 17362
{
	float fVar0;
	int iVar1;
...
void Function_63(struct<217> Param0) //Position: 0x44A2 / 17570
{
	float fVar0;
	var uVar1;
...
int Function_64(var uParam0, int iParam1) //Position: 0x4560 / 17760
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, struct<2> Param2) //Position: 0x46CA / 18122
{
	struct<8> Var0;
...
struct<32> Function_66(char* cParam0) //Position: 0x4772 / 18290
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x47DE / 18398
{
	char* cVar0[32];
...
int Function_68(int iParam0) //Position: 0x4800 / 18432
{
	int iVar0;
	struct<2> Var1;
...
float Function_69(int iParam0, struct<2> Param1) //Position: 0x496E / 18798
{
	struct<2> Var0;
...
struct<8> Function_70(int iParam0) //Position: 0x49E5 / 18917
{
	struct<2> Var0;
...
void Function_71(int iParam0) //Position: 0x4A51 / 19025
{
...
bool Function_72(int iParam0) //Position: 0x4AB9 / 19129
{
...
void Function_73(struct<153> Param0) //Position: 0x4ACF / 19151
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_78(Function_79(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_77(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_46(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_46(Global_116927[iParam16].f_32, 1))
			{
...
void Function_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4FE5 / 20453
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x5070 / 20592
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x50AF / 20655
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(int iParam0) //Position: 0x50DC / 20700
{
...
var Function_78(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5108 / 20744
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_79(int iParam0) //Position: 0x5129 / 20777
{
...
bool Function_80(struct<249> Param0) //Position: 0x513E / 20798
{
	...
	{
		Function_189(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
	if ((Function_90(iParam1) || Function_191(iParam1)) || Function_89(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_81(struct<265> Param0) //Position: 0x526E / 21102
{
	int iVar0;
	
	if (!Param0.f_260 != 0)
	{
		if (Function_52(&Param0 + 260, 4))
		{
		...
		if (Function_52(&Param0 + 260, 1))
		{
			if (!Function_191(Param0.f_256))
			{
				return 0;
			}
		}
		if (Function_52(&Param0 + 260, 2) && Global_6606)
		{
			iVar0 = Function_59(Param0.f_264);
		...
		if (Function_52(&Param0 + 260, 8) && Global_6606)
		{
		...
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_52(&Param0 + 260, 1024))
				{
					return 0;
				}
				break;
...
bool Function_82(int iParam0) //Position: 0x53CF / 21455
{
	if (!Function_51(iParam0))
	{
		return 0;
...
bool Function_83(int iParam0) //Position: 0x53F3 / 21491
{
...
bool Function_84(int iParam0) //Position: 0x5408 / 21512
{
	return Global_116927[iParam06].f_16;
}

bool Function_85(struct<237> Param0) //Position: 0x5418 / 21528
{
	if (!Param0.f_236)
	{
		if (Function_110())
...
bool Function_86(int iParam0) //Position: 0x54E7 / 21735
{
...
bool Function_87(int iParam0) //Position: 0x5542 / 21826
{
	int iVar0;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x555E / 21854
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x557B / 21883
{
...
int Function_90(int iParam0) //Position: 0x5590 / 21904
{
...
void Function_91() //Position: 0x55A5 / 21925
{
...
int Function_92(int iParam0, int iParam1) //Position: 0x5625 / 22053
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
	...
	switch (iParam0)
	{
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_191(13) && iVar14)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar14 = 0;
					}
					else if (iVar14 && Function_58(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_191(26) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_191(25) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_191(24) && iVar15)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_191(23) && iVar15)
					{
						cVar4 = &Global_44085[Global_46850[1]9] + 8;
						iVar15 = 0;
					}
					else if (iVar15 && Function_58(26, 0))
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
				...
				case 0x00000008:
					if (Function_191(55) && iVar16)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_191(54) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_191(27) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_191(52) && iVar13)
					{
						cVar4 = &Global_44085[Global_46926[2]9] + 8;
						iVar13 = 0;
					}
					else if (Function_191(51) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
					else if (Function_191(50) && iVar13)
					{
						cVar4 = &Global_44085[Global_46796[4]9] + 8;
						iVar13 = 0;
					}
					else if (Function_191(49) && iVar13)
					{
						cVar4 = &Global_44085[Global_46816[1]9] + 8;
						iVar13 = 0;
					}
					else if (Function_58(17, 0) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_191(19) && iVar17)
					{
						Var0 = Vector(-1708,36f, 46,18f, 2175,89f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_58(6, 0) && Function_191(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_191(17) && iVar17)
					{
						Var0 = Vector(-1687,208f, 53,208f, 2140,491f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_58(9, 0) && Function_191(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_191(15) && iVar17)
					{
						Var0 = Vector(-1709,084f, 55,216f, 2104,631f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if (Function_58(8, 0) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
int Function_93(int iParam0) //Position: 0x6288 / 25224
{
	int iVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x62D7 / 25303
{
...
int Function_95(int iParam0) //Position: 0x62ED / 25325
{
...
void Function_96() //Position: 0x6356 / 25430
{
...
bool Function_97(int iParam0) //Position: 0x637B / 25467
{
	if (!Function_94(iParam0))
	{
...
bool Function_98(int iParam0, int iParam1) //Position: 0x63CC / 25548
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x63F9 / 25593
{
	if (!Function_94(iParam0))
	{
...
void Function_100(bool bParam0) //Position: 0x644B / 25675
{
	int iVar0;
...
void Function_101() //Position: 0x6485 / 25733
{
	bool bVar0;
...
void Function_102(int iParam0, int iParam1) //Position: 0x64E3 / 25827
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_103(int iParam0) //Position: 0x64F9 / 25849
{
	PRINTSTRING("Day ");
...
void Function_104(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6543 / 25923
{
	bool bVar0;
	char* cVar1[16];
...
void Function_105(char* cParam0) //Position: 0x65B8 / 26040
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_106(int iParam0, var uParam1, int iParam2) //Position: 0x65F2 / 26098
{
	var uVar0;
	char* cVar1[16];
...
int Function_107(char* cParam0) //Position: 0x666E / 26222
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_108(int iParam0) //Position: 0x670F / 26383
{
	int iVar0;
	int iVar1;
...
bool Function_109(int iParam0, int iParam1) //Position: 0x674C / 26444
{
...
bool Function_110() //Position: 0x675F / 26463
{
...
void Function_111(bool bParam0, bool bParam1) //Position: 0x677A / 26490
{
	bool bVar0;
...
void Function_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x679F / 26527
{
	struct<4> Var0;
	var uVar4;
...
bool Function_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6834 / 26676
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_114(var uParam0, int iParam1, struct<41> Param2) //Position: 0x68ED / 26861
{
	if (!&bParam15)
	{
		Function_125(&iParam1, &uParam10);
	}
	switch (iParam1)
	{
		case 0x000003E8:
			if (uParam3 != 99 && (Function_124(&Param2) || Param2.f_40 < 1))
			{
				iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_123())
					{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_173(&iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_173(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && uParam3 == 99) && !Function_124(&Param2))
			{
...
void Function_115(var uParam0, bool bParam1) //Position: 0x6F4F / 28495
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_116() //Position: 0x701E / 28702
{
	int iVar0;
...
void Function_117() //Position: 0x7096 / 28822
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_118() //Position: 0x70DB / 28891
{
...
void Function_119(bool bParam0) //Position: 0x70ED / 28909
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_120(var uParam0, int iParam1) //Position: 0x710A / 28938
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_121(int iParam0) //Position: 0x719C / 29084
{
	bool bVar0;
...
int Function_122(bool bParam0) //Position: 0x71CD / 29133
{
	bool bVar0;
	var uVar1;
...
bool Function_123() //Position: 0x7290 / 29328
{
	bool bVar0;
	var uVar1;
...
bool Function_124(struct<37> Param0) //Position: 0x72CD / 29389
{
	return Param0.f_36;
}

void Function_125(var uParam0, int iParam1) //Position: 0x72D8 / 29400
{
	Function_126(&uParam0, &iParam1, 0);
	return;
}

void Function_126(var uParam0, bool bParam1, int iParam2) //Position: 0x72E8 / 29416
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_127(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x7460 / 29792
{
	int iVar0;
	int iVar1;
...
void Function_128(bool bParam0) //Position: 0x7688 / 30344
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7726 / 30502
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x7750 / 30544
{
	var uVar0;
	var uVar1;
...
void Function_131() //Position: 0x77AB / 30635
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_132() //Position: 0x78EA / 30954
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x78FA / 30970
{
	Function_134(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	if (IS_VOLUME_VALID(&uLocal_397))
	{
		DESTROY_VOLUME(&uLocal_397);
	}
	return 1;
}

void Function_134(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7920 / 31008
{
	var uVar0;
...
void Function_135() //Position: 0x79EF / 31215
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x7A04 / 31236
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2142,677f, 16,774f, 2623,614f), -155,974f, 1, 1, true);
	TASK_CLEAR(&uLocal_375);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_375, Vector(-2141,006f, 16,659f, 2630,398f), 171,734f, 1, 1, true);
	Function_137(&uLocal_375, 1254, 4294967295, 4294967295, 4294967295, 1, 1, 1);
	SET_ACTOR_FACTION(&uLocal_375, 32);
	MEMORY_CONSIDER_AS_ENEMY(&uLocal_375, &Global_54076);
	SET_ACTION_NODE_FOR_ACTOR(&uLocal_375, "zombie/PlayDead/Variant1/PlayDeadLoop");
	CREATE_DECAL(StackVal, 0f, Vector(-2141,006f, 16,659f, 2630,398f), 0,75f, 1, 0);
	SET_DRAW_ACTOR(&(uLocal_377[0]), 1);
	SET_DRAW_ACTOR(&(uLocal_377[1]), 1);
	SET_DRAW_ACTOR(&(uLocal_377[2]), 1);
	DECOR_REMOVE(&(uLocal_377[0]), "IsCutscene");
	DECOR_REMOVE(&(uLocal_377[1]), "IsCutscene");
	DECOR_REMOVE(&(uLocal_377[2]), "IsCutscene");
	Global_99725[1643].f_236 = 1;
	return 1;
}

void Function_137(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x7B33 / 31539
{
	var uVar0;
	
	if (Function_143(&uParam0) && !Function_142(&uParam0, 1))
	{
	...
	Function_138(&uParam0, &uParam4, &uParam5);
}

void Function_138(var uParam0, int iParam1, bool bParam2) //Position: 0x7DD0 / 32208
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_139(int iParam0) //Position: 0x7E8D / 32397
{
...
void Function_140(int iParam0) //Position: 0x7EC4 / 32452
{
...
bool Function_142(var uParam0, int iParam1) //Position: 0x82A6 / 33446
{
	bool bVar0;
...
int Function_143(int iParam0) //Position: 0x82EB / 33515
{
	bool bVar0;
...
int Function_144() //Position: 0x830C / 33548
{
	var uVar0;
	
	if (!iLocal_422)
	{
		uVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_ChowGringo01", "DLC_eating_dynamic", Vector(-2141,397f, 16,449f, 2631,667f), Vector(0.0f, -16,967f, 0.0f)));
		uLocal_377[0] = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_Zombie1", 1210, Vector(-2141,397f, 16,449f, 2631,667f), Vector(0.0f, -16,967f, 0.0f));
		SET_DRAW_ACTOR(&(uLocal_377[0]), 0);
		SET_OBJECT_COLLIDE_WITH_OBJECT(&(uLocal_377[0]), &uLocal_375, 0);
		TASK_USE_GRINGO(&(uLocal_377[0]), &uVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(&(uLocal_377[0]), GET_OBJECT_FROM_GRINGO(&uVar0), "UseCase1", true, 0, 0);
		SET_ACTOR_FACTION(&(uLocal_377[0]), 32);
		uVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_ChowGringo02", "DLC_eating_dynamic", Vector(-2140,475f, 16,659f, 2631,447f), Vector(0.0f, 26,095f, 0.0f)));
		uLocal_377[1] = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_Zombie2", 1204, Vector(-2140,475f, 16,659f, 2631,447f), Vector(0.0f, 26,095f, 0.0f));
		SET_DRAW_ACTOR(&(uLocal_377[1]), 0);
		SET_OBJECT_COLLIDE_WITH_OBJECT(&(uLocal_377[1]), &uLocal_375, 0);
		TASK_USE_GRINGO(&(uLocal_377[1]), &uVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(&(uLocal_377[1]), GET_OBJECT_FROM_GRINGO(&uVar0), "UseCase1", true, 0, 0);
		SET_ACTOR_FACTION(&(uLocal_377[1]), 32);
		uVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_ChowGringo03", "DLC_eating_dynamic", Vector(-2139,871f, 16,659f, 2630,563f), Vector(0.0f, 80,959f, 0.0f)));
		uLocal_377[2] = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_371, "Marshal2_Zombie3", 1212, Vector(-2139,871f, 16,659f, 2630,563f), Vector(0.0f, 80,959f, 0.0f));
		SET_DRAW_ACTOR(&(uLocal_377[2]), 0);
		SET_OBJECT_COLLIDE_WITH_OBJECT(&(uLocal_377[2]), &uLocal_375, 0);
		TASK_USE_GRINGO(&(uLocal_377[2]), &uVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(&(uLocal_377[2]), GET_OBJECT_FROM_GRINGO(&uVar0), "UseCase1", true, 0, 0);
		SET_ACTOR_FACTION(&(uLocal_377[2]), 32);
		Function_145(StackVal, Vector(-2152,67f, 15,992f, 2613,229f), &uLocal_397);
		iLocal_422 = 1;
	}
	return 1;
}

void Function_145(vector3 vParam0) //Position: 0x85FC / 34300
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_39(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_146(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_146(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_146(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_146(int iParam0, int iParam1) //Position: 0x87A5 / 34725
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_147(float fParam0, float fParam1) //Position: 0x889A / 34970
{
...
void Function_148() //Position: 0x89AB / 35243
{
...
void Function_149() //Position: 0x89DF / 35295
{
...
int Function_150() //Position: 0x8AE5 / 35557
{
	return 1;
}

int Function_151() //Position: 0x8AEC / 35564
{
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("MISC_HerbertMoon", &uLocal_375);
	uLocal_397 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_371, "Marshal2_CSVol", 2,802597E-45f, Vector(-2147,343f, 16,774f, 2623,743f), Vector(0.0f, 1,118f, 0.0f), Vector(19,13f, 8,597f, 16,361f));
	Function_154(0, 0, 1, 1, 0, 1, 1, &uLocal_397, 1, 1, 1, 1, 0x3f800000, 0);
	Function_152(StackVal, &uLocal_371, *(&Global_99725[1643] + 196), &uLocal_397, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	DECOR_SET_BOOL(&(uLocal_377[0]), "IsCutscene", true);
	DECOR_SET_BOOL(&(uLocal_377[1]), "IsCutscene", true);
	DECOR_SET_BOOL(&(uLocal_377[2]), "IsCutscene", true);
	return 1;
}

void Function_152(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8BF8 / 35832
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_153(var uParam0, float fParam1) //Position: 0x8E98 / 36504
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_154(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8F1A / 36634
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_157(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_3(), 2, Function_157(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
				DELETE_PROJECTILES_IN_VOLUME(&uVar0);
			}
		}
		Function_127(19, 1, 0, 0);
	}
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_156()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
		DESTROY_CAMERA(GET_CAMERA_FROM_OBJECT(Function_156()));
...
void Function_155(int iParam0) //Position: 0x91CC / 37324
{
	int iVar0;
...
var Function_156() //Position: 0x9200 / 37376
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_157(bool bParam0) //Position: 0x928E / 37518
{
	struct<2> Var0;
...
bool Function_158(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x92A0 / 37536
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_161(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_160(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_159(vector3 vParam0) //Position: 0x94D5 / 38101
{
	var uVar0;
...
float Function_160(var uParam0, bool bParam1) //Position: 0x954B / 38219
{
	struct<2> Var0;
...
void Function_161(var uParam0, bool bParam1) //Position: 0x956C / 38252
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_160(&uParam0, 0) < 2.0f)
	{
...
bool Function_162(int iParam0, bool bParam1, bool bParam2) //Position: 0x95D6 / 38358
{
...
bool Function_163() //Position: 0x969A / 38554
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_164(int iParam0) //Position: 0x96B1 / 38577
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_165(bool bParam0) //Position: 0x96BD / 38589
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

int Function_166(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) //Position: 0x96CC / 38604
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == iParam1)
				{
					...
					uVar2 = Function_168(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == iParam1 && bVar0 > Global_99717.f_24))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_167(&iParam0));
							}
						}
						...
						uVar6 = Function_168(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
...
int Function_167(struct<257> Param0) //Position: 0x986F / 39023
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_167(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_168(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, int iParam12) //Position: 0x98AB / 39083
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_169() //Position: 0x9B13 / 39699
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_170(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_170(char* cParam0) //Position: 0x9B67 / 39783
{
	char* cVar0[64];
...
bool Function_171(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9C90 / 40080
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_70(&uParam0);
		if (VDIST(Function_70(&uParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
int Function_172() //Position: 0x9D1C / 40220
{
	if (IS_PS3())
	{
		return 1;
...
float Function_173(vector3 vParam0) //Position: 0x9D2B / 40235
{
	if (Function_175(&vParam0))
	{
		if (Function_174(&vParam0))
		{
			return vParam0.z;
		}
...
bool Function_174(int iParam0) //Position: 0x9DF8 / 40440
{
	return Function_46(iParam0, 2);
}

bool Function_175(int iParam0) //Position: 0x9E06 / 40454
{
	return Function_46(iParam0, 1);
}

void Function_176(int iParam0) //Position: 0x9E14 / 40468
{
	Function_177(&iParam0, 0.0f);
	return;
}

void Function_177(vector3 vParam0) //Position: 0x9E21 / 40481
{
...
int Function_178(struct<2>[] Param0) //Position: 0x9E46 / 40518
{
	int iVar0;
	int iVar1;
		...
		if (Function_182(&(Param0[iVar02]), 4))
		{
			if (!Function_182(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_182(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_179() //Position: 0xA208 / 41480
{
	if (!Function_87(128))
	{
		return;
...
bool Function_180() //Position: 0xA248 / 41544
{
	int iVar0;
...
void Function_181(struct<13> Param0) //Position: 0xA276 / 41590
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

bool Function_182(struct<13> Param0) //Position: 0xA289 / 41609
{
	int iVar0;
...
void Function_183() //Position: 0xA2A7 / 41639
{
	if (!Function_87(128))
	{
		return;
...
void Function_184() //Position: 0xA2E9 / 41705
{
	if (IS_LAYOUTREF_VALID(&uLocal_371))
	{
		RELEASE_LAYOUT_REF(&uLocal_371);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_186(&uLocal_336);
	if (bLocal_421)
	{
	}
	Function_185(0, 0, 1);
...
int Function_185(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA318 / 41752
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_186(int iParam0) //Position: 0xA34A / 41802
{
	int iVar0;
	...
	{
		Function_187(&iParam0, iVar0);
		iVar0++;
	}
	return;
}

void Function_187(struct<2>[] Param0, int iParam1) //Position: 0xA372 / 41842
{
	if (Function_182(&(Param0[iParam12]), 4))
	{
		if (Function_182(&(Param0[iParam12]), 1))
		{
			...
			Function_188(&(Param0[iParam12]), 1);
			Function_188(&(Param0[iParam12]), 2);
			Function_188(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_188(struct<13> Param0) //Position: 0xA4BD / 42173
{
	int iVar0;
...
void Function_189(var uParam0, int iParam1) //Position: 0xA4DA / 42202
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_190(int iParam0, bool bParam1) //Position: 0xA4EB / 42219
{
	char* cVar0[32];
...
bool Function_191(int iParam0) //Position: 0xA674 / 42612
{
...
void Function_192() //Position: 0xA689 / 42633
{
	var uVar0;
	var uVar1;
	int iVar2;
	
	if (!Function_197(Global_46760[0]))
	{
		return;
	}
	if (!IS_ACTOR_VALID(&uLocal_375))
	...
	if (!iLocal_423)
	{
		uVar0 = FIND_NAMED_LAYOUT("Armadillo_layout");
		if (IS_LAYOUTREF_VALID(&uVar0))
		{
			uLocal_373 = CREATE_WORLD_SECTOR(&uVar0, "dlc06x");
			iLocal_423 = 1;
		}
		return;
	}
	if (!IS_DOOR_VALID(&uLocal_395))
	{
		uLocal_395 = Function_195("narmadillo", "sheriff", 1);
	}
	if (IS_DOOR_VALID(&uLocal_395))
	{
		SET_DOOR_LOCK_VISIBLE(&uLocal_395, 0);
		if (!IS_DOOR_CLOSED(&uLocal_395))
		{
			if (!IS_DOOR_CLOSING(&uLocal_395))
			{
				CLOSE_DOOR_FAST(&uLocal_395);
			}
		}
		if (!IS_DOOR_LOCKED(&uLocal_395))
		{
			Function_194(&uLocal_395, 1);
		}
	}
	if (!IS_WORLD_SECTOR_LOADED(&uLocal_373))
	{
		return;
	}
	iVar2 = 0;
	while (iVar2 <= 3)
	{
		if (!IS_DOOR_VALID(&(uLocal_387[iVar2])))
		{
			uVar1 = GET_WORLD_SECTOR_CHILD_OBJECT(&uLocal_373, "dlc_arm_generalStoreProps01x", &(Local_401[iVar22]));
			if (IS_OBJECT_VALID(&uVar1))
			{
				uLocal_387[iVar2] = GET_DOOR_FROM_OBJECT(&uVar1);
			}
		}
		if (IS_DOOR_VALID(&(uLocal_387[iVar2])))
		{
			if (iVar2 != 0 || iVar2 != 1)
			{
				if (IS_DOOR_LOCKED(&(uLocal_387[iVar2])))
				{
					Function_193(&(uLocal_387[iVar2]), 1);
				}
				if (!IS_DOOR_OPEN_IN_DIRECTION(&(uLocal_387[iVar2]), iVar2 != 0))
				{
					if (IS_DOOR_OPEN_IN_DIRECTION(&(uLocal_387[iVar2]), iVar2 != 1))
					{
						CLOSE_DOOR_FAST(&(uLocal_387[iVar2]));
					}
					OPEN_DOOR_DIRECTION_FAST(&(uLocal_387[iVar2]), iVar2 != 0);
				}
			}
			else
			{
				if (!IS_DOOR_CLOSED(&(uLocal_387[iVar2])))
				{
					if (!IS_DOOR_CLOSING(&(uLocal_387[iVar2])))
					{
						CLOSE_DOOR_FAST(&(uLocal_387[iVar2]));
					}
				}
				if (!IS_DOOR_LOCKED(&(uLocal_387[iVar2])))
				{
					Function_194(&(uLocal_387[iVar2]), 1);
				}
			}
		}
		iVar2++;
...
void Function_193(var uParam0, int iParam1) //Position: 0xA883 / 43139
{
...
void Function_194(var uParam0, int iParam1) //Position: 0xA8DB / 43227
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
int Function_195(var uParam0, var uParam1, int iParam2) //Position: 0xA936 / 43318
{
	return Function_196(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_196(int iParam0, char* cParam1, bool bParam3) //Position: 0xA94A / 43338
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_197(int iParam0) //Position: 0xA9EF / 43503
{
	if (!Function_72(iParam0))
	{
		return 1;
...
void Function_198(int iParam0) //Position: 0xAA0B / 43531
{
...
var Function_199(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xAA22 / 43554
{
	int iVar0;
...
var Function_200(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xAAFE / 43774
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_201(&Param0, &uVar1, iParam2);
	if (&bParam3)
	{
		Function_181(&(Param0[iVar02]), 8);
	}
...
var Function_201(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xAB3C / 43836
{
	int iVar0;
...
void Function_202() //Position: 0xAC0B / 44043
{
	strcpy(&(Local_401[02]), "door01", 8);
	strcpy(&(Local_401[12]), "door02", 8);
	strcpy(&(Local_401[22]), "door03", 8);
	return;
}
