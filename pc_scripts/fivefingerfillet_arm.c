...
bool Function_21() //Position: 0xA46 / 2630
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_28(Global_46760[0], &iLocal_35 + 4, &iLocal_35 + 48, &iLocal_35 + 56))
			{
				Function_27(&(Global_46760[0]));
				Function_26(&iLocal_35 + 4);
				Function_20(Global_46760[0]);
				(&iLocal_35 + 188[02]) = Function_20(Global_46760[0]);
				Function_19(Global_46760[0]);
				*(&iLocal_35 + 188[12]) = Function_19(Global_46760[0]);
				iLocal_35 = Local_6;
