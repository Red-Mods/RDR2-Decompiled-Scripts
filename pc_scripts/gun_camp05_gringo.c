...
void Function_3() //Position: 0x239 / 569
{
	...
	uVar0 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun05");
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uVar0);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uVar0);
	if (IS_ACTOR_VALID(&iLocal_47))
	{
		if (DECOR_CHECK_EXIST(&iLocal_47, "bACTOR_AVOID_SMALLBRAINS"))
		{
			DECOR_REMOVE(&iLocal_47, "bACTOR_AVOID_SMALLBRAINS");
		}
	}
	Function_24();
	Function_4(5, &iLocal_47, &iLocal_49, &uLocal_5, &uLocal_51, 31);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x2D7 / 727
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x749 / 1865
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x77D / 1917
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xABF / 2751
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xAF2 / 2802
{
...
void Function_9(int iParam0) //Position: 0xB09 / 2825
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xB35 / 2869
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xB4F / 2895
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB6C / 2924
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC32 / 3122
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xDFB / 3579
{
...
void Function_15(int iParam0) //Position: 0xE38 / 3640
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xE51 / 3665
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE5E / 3678
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xF53 / 3923
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xFB9 / 4025
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0x101B / 4123
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0x1050 / 4176
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x1269 / 4713
{
	struct<2> Var0;
...
struct<8> Function_23(var uParam0) //Position: 0x12E0 / 4832
{
	struct<2> Var0;
...
void Function_24() //Position: 0x134C / 4940
{
	RELEASE_LAYOUT_REF(&uLocal_0);
	return;
}

void Function_25(int iParam0) //Position: 0x1358 / 4952
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x1380 / 4992
{
...
void Function_27(struct<13> Param0) //Position: 0x14CB / 5323
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x14E8 / 5352
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x1506 / 5382
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_53 || bParam2) || Global_6611)
			{
				if (Function_148(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_146(&Param0 + 324, &fLocal_55, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_145();
								(*&Param0 + 48)[1] = Function_144();
								Function_143(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_143(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_136(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_136(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_143(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_143(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_136(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_136(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_136(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_143(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_135(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_55, 20.0f, fLocal_55));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_131(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_135(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_106(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_102(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_135(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_135(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
					...
					Function_70(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_69(StackVal, StackVal, &Param0 + 16, Function_135(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_135()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
					Function_66(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_65(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_65(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_54(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_57) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_56, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_53(&Param0 + 392, 1);
							Function_52(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_56 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_53(&Param0 + 392, 1);
								Function_52(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_51(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_47(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_47(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_46()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_45(&Param0 + 392, Function_46(), 4);
				Function_44(&Param0 + 392, Function_46());
			}
...
void Function_30(struct<62> Param0) //Position: 0x26C5 / 9925
{
...
void Function_31(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26D7 / 9943
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_32(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
...
bool Function_32(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2910 / 10512
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_33(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2930 / 10544
{
	bool bVar0;
	var uVar1;
...
int Function_34(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2A1E / 10782
{
	char* cVar0[32];
...
int Function_35(int iParam0) //Position: 0x2C8A / 11402
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_36(var uParam0, bool bParam1) //Position: 0x2CAE / 11438
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2CD2 / 11474
{
...
void Function_39(var uParam0, bool bParam1) //Position: 0x2D1F / 11551
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_40(bool bParam0) //Position: 0x2D43 / 11587
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_41() //Position: 0x2D62 / 11618
{
...
bool Function_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2DB1 / 11697
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_32(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_43(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E0D / 11789
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2E2E / 11822
{
	bool bVar0;
	var uVar1;
...
void Function_45(var uParam0, var uParam1, bool bParam2) //Position: 0x2E89 / 11913
{
	bool bVar0;
	var uVar1;
...
var Function_46() //Position: 0x2ED5 / 11989
{
...
void Function_47(struct<425> Param0) //Position: 0x2EEA / 12010
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_50(&Param0 + 392))
	{
		return;
	}
	if (!Function_48(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_51(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_51(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_51(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_51(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_48(var uParam0, struct<2> Param1, float fParam3) //Position: 0x303D / 12349
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
bool Function_49(vector3 vParam0) //Position: 0x30B2 / 12466
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_50(var uParam0) //Position: 0x30CA / 12490
{
	bool bVar0;
	int iVar1;
...
var Function_51(bool bParam0) //Position: 0x3128 / 12584
{
	bool bVar0;
	bool bVar1;
...
void Function_52(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3175 / 12661
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x31EE / 12782
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0) //Position: 0x323D / 12861
{
	struct<21> Var0;
	
	bVar6 = Function_64(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_56(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_55())
...
bool Function_55() //Position: 0x32FC / 13052
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_56(struct<25> Param0) //Position: 0x330F / 13071
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_61(Param0, 0))
	{
		uVar0 = Function_57(StackVal);
...
var Function_57(int iParam0) //Position: 0x33D6 / 13270
{
...
bool Function_58(int iParam0) //Position: 0x33F6 / 13302
{
...
bool Function_59(int iParam0) //Position: 0x341A / 13338
{
...
bool Function_60(int iParam0) //Position: 0x342F / 13359
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x3446 / 13382
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3484 / 13444
{
...
bool Function_63(int iParam0) //Position: 0x349E / 13470
{
...
int Function_64(int iParam0, struct<6> Param1) //Position: 0x34B4 / 13492
{
	int iVar0;
...
void Function_65(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x34EE / 13550
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_135(), bParam2[iVar0], Var1, Var3);
...
void Function_66(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x35D3 / 13779
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_135(), bParam3, Var2, Var4);
...
void Function_67(var uParam0, bool bParam1) //Position: 0x378A / 14218
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_68(bool bParam0) //Position: 0x37AF / 14255
{
	var uVar0;
	int iVar1;
...
var Function_69(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x37FD / 14333
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_70(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3954 / 14676
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_71(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_71(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x39FF / 14847
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3AA5 / 15013
{
	Function_143(&uLocal_5, 662, 3, 0);
	Function_143(&uLocal_5, 248, 3, 0);
	Function_143(&uLocal_5, 246, 3, 0);
	Function_143(&uLocal_5, 746, 3, 0);
	Function_143(&uLocal_5, 748, 3, 0);
	Function_143(&uLocal_5, 750, 3, 0);
	Function_143(&uLocal_5, 664, 3, 0);
	Function_143(&uLocal_5, 408, 3, 0);
	Function_99(&uLocal_5, "$/content/scripting/gringo/simplegringo/mex_drunk_sittable", 1, 0);
	Function_99(&uLocal_5, "p_gen_chair08x", 0, 0);
	if (Function_80(&iLocal_47, &uLocal_5, 31, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_77(&iParam1))
		{
			iLocal_49 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_0, Function_135()));
			*(&Global_6667[3128] + 216) = &iLocal_49;
			*(&iParam0 + 24) = &uLocal_0;
			Function_73();
			return 1;
		}
...
void Function_73() //Position: 0x3BA7 / 15271
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	uLocal_51 = CREATE_LAYOUT("gun05campfirelayout");
	uVar0 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun05");
	...
	CLEAR_AMBIENT_OBJECTS_VOLUME(&uVar0, 24);
	RESET_PROPS_IN_VOLUME(&uVar0, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "PokerPlayer", 408, Vector(-2701,148f, 31,71349f, 4276,872f), Vector(0.0f, 174,6393f, 0.0f));
	Function_76(&iVar1);
	Function_74(&iVar1, &iLocal_49, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "Sanches", 664, Vector(-2702,863f, 31,14054f, 4277,042f), Vector(0.0f, 235,3982f, 0.0f));
	Function_76(&iVar1);
	Function_74(&iVar1, &iLocal_49, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "Muller", 662, Vector(-2699,544f, 31,391f, 4277,169f), Vector(0.0f, 57,70023f, 0.0f));
	Function_76(&iVar1);
	Function_74(&iVar1, &iLocal_49, 1, 1);
	uVar2 = Vector(-2702.0f, 31,8f, 4278,8f);
	TELEPORT_ACTOR(&iLocal_47, &uVar2, 1, 1, 1);
	Function_76(&iLocal_47);
	Function_74(&iLocal_47, &iLocal_49, 1, 1);
	uVar4 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "nchair08x0", "p_gen_chair08x", Vector(-2700,989f, 31,15568f, 4275,231f), Vector(0.0f, 165,386f, 0.0f), 1);
	SET_PROP_FIXED(GET_PHYSINST_FROM_OBJECT(&uVar4), 0);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "Patron01", 746, Vector(-2702,436f, 31,16296f, 4274,005f), Vector(0.0f, 215,0818f, 0.0f));
	uVar5 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar4, Function_135(), "mex_drunk_sittable", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&iVar1, &uVar5, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&iVar1, GET_GRINGO_FROM_OBJECT(&uVar5), "UseCase1", 4294967295, 1);
	Function_74(&iVar1, &iLocal_49, 1, 1);
	uVar4 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "nchair08x1", "p_gen_chair08x", Vector(-2701,719f, 31,17118f, 4275,033f), Vector(0.0f, 92,5588f, 0.0f), 1);
	SET_PROP_FIXED(GET_PHYSINST_FROM_OBJECT(&uVar4), 0);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "Patron03", 750, Vector(-2701,883f, 31,12158f, 4275,653f), Vector(0.0f, -36,15588f, 0.0f));
	uVar5 = CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar4, "mexdrunkgun05", "mex_drunk_sittable", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&iVar1, &uVar5, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&iVar1, GET_GRINGO_FROM_OBJECT(&uVar5), "UseCase1", 4294967295, 1);
	Function_74(&iVar1, &iLocal_49, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "Patron02", 748, Vector(-2697,669f, 31,19069f, 4279,791f), Vector(0.0f, -47,32679f, 0.0f));
	uVar6 = Vector(-2697,079f, 31,253f, 4278,567f);
	uVar8 = LOCATE_GRINGO_OF_TYPE("mex_Drunk_sittable", &uVar6, 2.0f, 1);
	if (IS_GRINGO_VALID(&uVar8))
	{
		SNAP_ACTOR_TO_GRINGO(&iVar1, GET_OBJECT_FROM_GRINGO(&uVar8), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&iVar1, &uVar8, "UseCase1", 4294967295, 1);
	}
	else
	{
		TASK_WANDER_IN_VOLUME(&iVar1, &uVar0, -1f);
	}
	Function_74(&iVar1, &iLocal_49, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "HookerPatron02", 248, Vector(-2698,238f, 31,14262f, 4278,27f), Vector(0.0f, -90,96336f, 0.0f));
	uVar6 = Vector(-2697,223f, 31,205f, 4279,66f);
	uVar8 = LOCATE_GRINGO_OF_TYPE("mex_table_service", &uVar6, 2.0f, 1);
	if (IS_GRINGO_VALID(&uVar8))
	{
		SNAP_ACTOR_TO_GRINGO(&iVar1, GET_OBJECT_FROM_GRINGO(&uVar8), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&iVar1, &uVar8, "UseCase1", 4294967295, 1);
	...
	Function_74(&iVar1, &iLocal_49, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_51, "HookerPatron01", 246, Vector(-2699,97f, 31,325f, 4276,018f), Vector(0.0f, -90,96336f, 0.0f));
	uVar6 = Vector(-2699,97f, 31,325f, 4276,018f);
	uVar8 = LOCATE_GRINGO_OF_TYPE("lean_table", &uVar6, 2.0f, 1);
	if (IS_GRINGO_VALID(&uVar8))
	{
		SNAP_ACTOR_TO_GRINGO(&iVar1, GET_OBJECT_FROM_GRINGO(&uVar8), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&iVar1, &uVar8, "UseCase1", 4294967295, 1);
...
void Function_74(int iParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x40E9 / 16617
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_75(&iParam0, &iParam1, 1))
	{
		SQUAD_JOIN(&iParam0, &iParam1);
	}
	DECOR_SET_BOOL(&iParam0, "MissionCampfireActor", 1);
	if (IS_ACTOR_HUMAN(&iParam0) || IS_ACTOR_HORSE(&iParam0))
	{
		...
		UNK_0x99AFD2D1(&iParam0, 0, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 12, 1);
		AI_SET_ENABLE_HORSE_CHARGE_REACTIONS(&iParam0, &iParam3);
		SET_ACTOR_ALLOW_PLAYER_GREET_RESPONSES(&iParam0, 0);
		SET_ACTOR_CAN_PLAY_BORED_IDLES(&iParam0, &iParam3);
		SET_ACTOR_CAN_PLAY_GESTURES(&iParam0, &iParam3);
		Function_5(&iParam0, 0);
		AI_SET_ENABLE_HORSE_CHARGE_REACTIONS(&iParam0, 0);
	}
	else if (IS_ACTOR_VEHICLE(&iParam0))
	{
		ENABLE_VEHICLE_SEAT(&iParam0, 0, 0);
		ENABLE_VEHICLE_SEAT(&iParam0, 1, 0);
		TASK_STAND_STILL(&iParam0, -1.0f, 0, 0);
		MEMORY_CLEAR_ALL(&iParam0);
		AI_GLOBAL_CLEAR_DANGER(&iParam0);
		bVar0 = false;
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(&iParam0))
		{
			...
			if (IS_ACTOR_VALID(&iVar1))
			{
				if (!Function_75(&iVar1, &iParam1, 1))
				{
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x42A6 / 17062
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_76(int iParam0) //Position: 0x42EE / 17134
{
	var uVar0;
	var uVar2;
	...
	{
		Function_23(&iParam0);
		uVar0 = Function_23(&iParam0);
		uVar2 = LOCATE_GRINGO_OF_NAME("fake_poker", &uVar0, 2.0f, 1);
		if (IS_GRINGO_VALID(&uVar2))
		{
			GRINGO_SET_ALL_USES_OWNERSHIP(&uVar2, &iParam0);
			SNAP_ACTOR_TO_GRINGO(&iParam0, GET_OBJECT_FROM_GRINGO(&uVar2), "UseCase1", true, 0, 0);
			TASK_USE_GRINGO(&iParam0, &uVar2, "UseCase1", 4294967295, 1);
			DECOR_SET_BOOL(&iParam0, "inpoker", 1);
		}
	}
	return;
}

bool Function_77(var uParam0) //Position: 0x4378 / 17272
{
	var uVar0;
	
	Function_79(3, 2);
	uVar0 = &uVar0;
	uLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("Gun_camp05_mobile"));
	Function_78(&uLocal_0, &uParam0);
	return 1;
}

void Function_78(int iParam0, var uParam1) //Position: 0x43B0 / 17328
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &uParam1, Function_135(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
void Function_79(int iParam0, bool bParam1) //Position: 0x43FB / 17403
{
	switch (&bParam1)
	{
		case 0x00000000:
...
bool Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4445 / 17477
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_98(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_97(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	{
		iVar1 = Function_97(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_95(iVar1))
		{
			if (Function_102(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_81(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4624 / 17956
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_92(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		...
		if (&bParam8)
		{
			bVar1 = Function_84(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_82(var uParam0, bool bParam1) //Position: 0x4B64 / 19300
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_83(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4B86 / 19334
{
	var uVar0;
...
var Function_84(bool bParam0, int iParam1) //Position: 0x4BE7 / 19431
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x4C75 / 19573
{
	Function_87(&uParam0);
	Function_86(&uParam0);
...
void Function_86(int iParam0) //Position: 0x4CA1 / 19617
{
...
void Function_87(int iParam0) //Position: 0x4CC7 / 19655
{
...
bool Function_88(bool bParam0) //Position: 0x4D9D / 19869
{
...
var Function_89(int iParam0, int iParam1) //Position: 0x4DB4 / 19892
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x4E5A / 20058
{
	var uVar0;
	var uVar1;
...
void Function_91(var uParam0) //Position: 0x4F69 / 20329
{
	int iVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x4F9C / 20380
{
	int iVar0;
...
bool Function_93(var uParam0, struct<2> Param1, float fParam3) //Position: 0x4FB9 / 20409
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_23(&uParam0);
...
void Function_94() //Position: 0x5045 / 20549
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x50B5 / 20661
{
...
bool Function_96(int iParam0) //Position: 0x50D1 / 20689
{
...
var Function_97(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x50E7 / 20711
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_98(struct<205> Param0) //Position: 0x518D / 20877
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_11(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_57(Function_62(Param0.f_188));
...
var Function_99(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5298 / 21144
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_101(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_100(struct<13> Param0) //Position: 0x52D6 / 21206
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_101(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x52E9 / 21225
{
	int iVar0;
...
bool Function_102(struct<2>[] Param0) //Position: 0x53B8 / 21432
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x577A / 22394
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x57BA / 22458
{
	int iVar0;
...
void Function_105() //Position: 0x57E8 / 22504
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(vector3 vParam0) //Position: 0x582A / 22570
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_107(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_107(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_107(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x58C2 / 22722
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_108(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_108(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x58F1 / 22769
{
	Function_123(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_113(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_112(), Function_111(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_110(), Function_109(&uParam11, &uParam12));
}

var Function_109(var uParam0, bool bParam1) //Position: 0x594C / 22860
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x595C / 22876
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5970 / 22896
{
	int iVar0;
...
var Function_112() //Position: 0x5995 / 22933
{
	return "PackedMetadata";
}

void Function_113(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x59AC / 22956
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_122(), &uVar4))
				{
					Function_117(uVar4, &bVar5);
...
struct<8> Function_114() //Position: 0x5AE8 / 23272
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_115() //Position: 0x5AFA / 23290
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_116() //Position: 0x5B0C / 23308
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_117(var uParam0, struct<5> Param1) //Position: 0x5B1E / 23326
{
	Param1 = Function_118(uParam0, Function_120(), 0);
	Param1.f_4 = Function_118(uParam0, Function_120() + 8, Function_120());
	return;
}

var Function_118(var uParam0, int iParam1, int iParam2) //Position: 0x5B43 / 23363
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x5B62 / 23394
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_120() //Position: 0x5B6E / 23406
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x5B79 / 23417
{
	int iVar0;
...
var Function_122() //Position: 0x5BA7 / 23463
{
	return "PackedWeapon";
}

int Function_123(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5BBC / 23484
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_127(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_125(Function_127()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_124(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_124() //Position: 0x5CC9 / 23753
{
	return "MPItemGiver";
}

struct<32> Function_125(char* cParam0) //Position: 0x5CDD / 23773
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0) //Position: 0x5D49 / 23881
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5D6B / 23915
{
	return "PBox_";
}

var Function_128() //Position: 0x5D79 / 23929
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5D9F / 23967
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x5DC7 / 24007
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x5DED / 24045
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5F57 / 24407
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5FFF / 24575
{
	int iVar0;
	struct<2> Var1;
...
void Function_134(int iParam0) //Position: 0x616D / 24941
{
...
var Function_135() //Position: 0x61D5 / 25045
{
	int iVar0;
...
var Function_136(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x61DE / 25054
{
	return Function_137(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x61FC / 25084
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_88(bVar1))
	{
		...
		{
			Function_141(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_138(int iParam0) //Position: 0x64F5 / 25845
{
	int iVar0;
...
void Function_139() //Position: 0x65A9 / 26025
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x65E4 / 26084
{
	int iVar0;
...
void Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6611 / 26129
{
	int iVar0;
...
void Function_142() //Position: 0x676C / 26476
{
	int iVar0;
...
var Function_143(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x67B8 / 26552
{
	int iVar0;
...
int Function_144() //Position: 0x6894 / 26772
{
	int iVar0;
...
int Function_145() //Position: 0x69F0 / 27120
{
	int iVar0;
...
bool Function_146(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6B10 / 27408
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_147(struct<2> Param0) //Position: 0x6BEC / 27628
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_148(struct<2> Param0, struct<5> Param2) //Position: 0x6C0B / 27659
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_149(int iParam0) //Position: 0x6D4E / 27982
{
	var uVar0;
...
bool Function_150(int iParam0) //Position: 0x6D70 / 28016
{
	int iVar0;
...
int Function_151() //Position: 0x6D8C / 28044
{
	return 0;
}

void Function_152(struct<321> Param0) //Position: 0x6D93 / 28051
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_101(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_101(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
