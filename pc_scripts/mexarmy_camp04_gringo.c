...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar0 + 360) = 2;
	...
	{
		Function_30(&iVar0, GRINGO_GET_MY_OBJECT_REF(), 1, 0, 0, 0, "", -1.0f, 1, 0x43160000);
		GRINGO_WAIT(250);
	}
	Function_1(&iVar0);
	return;
...
void Function_3() //Position: 0x239 / 569
{
	...
	if (IS_DOOR_LOCKED(&cLocal_3))
	{
		Function_25(&cLocal_3, 1);
	}
	if (IS_DOOR_LOCKED(&uLocal_5))
	{
		Function_25(&uLocal_5, 1);
	}
	RELEASE_LAYOUT_REF(&uLocal_11);
	Function_4(6, &uLocal_7, &uVar0, &iLocal_9, 4294967295);
	return;
}

void Function_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x273 / 627
{
	int iVar0;
...
void Function_5(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x298 / 664
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_6(var uParam0, bool bParam1) //Position: 0x70A / 1802
{
...
int Function_7(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x73E / 1854
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_8(var uParam0) //Position: 0xA80 / 2688
{
	int iVar0;
...
void Function_9(int iParam0) //Position: 0xAB3 / 2739
{
...
void Function_10(int iParam0) //Position: 0xACA / 2762
{
...
void Function_11(var uParam0, int iParam1) //Position: 0xAF6 / 2806
{
	int iVar0;
...
bool Function_12(int iParam0, int iParam1) //Position: 0xB10 / 2832
{
	int iVar0;
...
void Function_13(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB2D / 2861
{
	var uVar0;
	bool bVar1;
...
bool Function_14(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBF3 / 3059
{
	float fVar0;
...
void Function_15(int iParam0) //Position: 0xDBC / 3516
{
...
void Function_16(int iParam0) //Position: 0xDF9 / 3577
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_17(var uParam0, int iParam1) //Position: 0xE12 / 3602
{
	return (uParam0 && iParam1) == 0;
}

var Function_18(var uParam0, int iParam1) //Position: 0xE1F / 3615
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_19(bool bParam0, var uParam1) //Position: 0xF14 / 3860
{
	var uVar0;
	int iVar1;
...
bool Function_20(var uParam0, int iParam1) //Position: 0xF7A / 3962
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_21(int iParam0) //Position: 0xFDC / 4060
{
	bool bVar0;
...
int Function_22(struct<209> Param0) //Position: 0x1011 / 4113
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_23(var uParam0, struct<2> Param1) //Position: 0x122A / 4650
{
	struct<2> Var0;
...
struct<8> Function_24(int iParam0) //Position: 0x12A1 / 4769
{
	struct<2> Var0;
...
void Function_25(var uParam0, int iParam1) //Position: 0x130D / 4877
{
...
void Function_26(int iParam0) //Position: 0x1365 / 4965
{
	int iVar0;
...
void Function_27(struct<2>[] Param0, int iParam1) //Position: 0x138D / 5005
{
...
void Function_28(struct<13> Param0) //Position: 0x14D8 / 5336
{
	int iVar0;
...
bool Function_29(struct<13> Param0) //Position: 0x14F5 / 5365
{
	int iVar0;
...
var Function_30(struct<477> Param0) //Position: 0x1513 / 5395
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_13 || bParam2) || Global_6611)
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_15, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_15, 20.0f, fLocal_15));
		...
		case 0x00000002:
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_23(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					...
					Function_71(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_70(StackVal, StackVal, &Param0 + 16, Function_132(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				...
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				...
				while (bVar1 <= iParam3)
				{
					Function_67(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_66(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_66(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_55(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_17) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_14(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_16, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_54(&Param0 + 392, 1);
							Function_53(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_16 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_54(&Param0 + 392, 1);
								Function_53(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_52(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_48(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_48(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_47()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_46(&Param0 + 392, Function_47(), 4);
				Function_45(&Param0 + 392, Function_47());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_44(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_43(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_34(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_31(struct<62> Param0) //Position: 0x26D2 / 9938
{
...
void Function_32(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26E4 / 9956
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_33(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
					if (!Function_33(&bVar2, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&bVar2);
					}
				}
...
bool Function_33(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x291D / 10525
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_34(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x293D / 10557
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(&uVar1))
				{
					Function_35(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_35(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_35(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2A2B / 10795
{
	char* cVar0[32];
	...
	Function_40(&uParam0, 0);
	Function_39(&uParam0, iParam1);
	Function_38(&uParam0, &uParam2);
	Function_37(&uParam0, uParam3);
	if (Function_36(&uParam0) != 5)
	{
...
int Function_36(int iParam0) //Position: 0x2C97 / 11415
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2CBB / 11451
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_38(var uParam0, int iParam1) //Position: 0x2CDF / 11487
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2D05 / 11525
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_40(var uParam0, bool bParam1) //Position: 0x2D2C / 11564
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_41(bool bParam0) //Position: 0x2D50 / 11600
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_42() //Position: 0x2D6F / 11631
{
...
bool Function_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2DBE / 11710
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_33(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_44(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E1A / 11802
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_45(var uParam0, int iParam1) //Position: 0x2E3B / 11835
{
	bool bVar0;
	var uVar1;
...
void Function_46(var uParam0, var uParam1, bool bParam2) //Position: 0x2E96 / 11926
{
	bool bVar0;
	var uVar1;
...
var Function_47() //Position: 0x2EE2 / 12002
{
...
void Function_48(struct<425> Param0) //Position: 0x2EF7 / 12023
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_51(&Param0 + 392))
	{
		return;
	}
	if (!Function_49(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_52(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_52(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_52(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_52(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_49(var uParam0, struct<2> Param1, float fParam3) //Position: 0x304A / 12362
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_50(vector3 vParam0) //Position: 0x30BF / 12479
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_51(var uParam0) //Position: 0x30D7 / 12503
{
	bool bVar0;
	int iVar1;
...
var Function_52(bool bParam0) //Position: 0x3135 / 12597
{
	bool bVar0;
	bool bVar1;
...
void Function_53(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3182 / 12674
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0, bool bParam1) //Position: 0x31FB / 12795
{
	bool bVar0;
	var uVar1;
...
void Function_55(var uParam0) //Position: 0x324A / 12874
{
	struct<21> Var0;
	
	bVar6 = Function_65(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_57(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_56())
...
bool Function_56() //Position: 0x3309 / 13065
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_57(struct<25> Param0) //Position: 0x331C / 13084
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_62(Param0, 0))
	{
		uVar0 = Function_58(StackVal);
...
var Function_58(int iParam0) //Position: 0x33E3 / 13283
{
...
bool Function_59(int iParam0) //Position: 0x3403 / 13315
{
...
bool Function_60(int iParam0) //Position: 0x3427 / 13351
{
...
bool Function_61(int iParam0) //Position: 0x343C / 13372
{
...
bool Function_62(int iParam0, bool bParam1) //Position: 0x3453 / 13395
{
	int iVar0;
...
var Function_63(int iParam0) //Position: 0x3491 / 13457
{
...
bool Function_64(int iParam0) //Position: 0x34AB / 13483
{
...
int Function_65(int iParam0, struct<6> Param1) //Position: 0x34C1 / 13505
{
	int iVar0;
...
void Function_66(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x34FB / 13563
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_67(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x35E0 / 13792
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_68(var uParam0, bool bParam1) //Position: 0x3797 / 14231
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_69(bool bParam0) //Position: 0x37BC / 14268
{
	var uVar0;
	int iVar1;
...
var Function_70(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x380A / 14346
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_71(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3961 / 14689
{
	var uVar0[5];
	int iVar6;
...
int Function_72(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3A0C / 14860
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_73(int iParam0, int iParam1) //Position: 0x3AB2 / 15026
{
	if (Function_79(&uLocal_7, 29, 1))
	{
		cLocal_3 = Function_77(Global_46850[0], "escalera", "villaWall04", 1);
		uLocal_5 = Function_77(Global_46850[0], "escalera", "villaWall04", 2);
		if (IS_DOOR_VALID(&cLocal_3) && IS_DOOR_VALID(&uLocal_5))
		{
			if (Function_75(&uLocal_11, "mexarmy04mobile", &iParam1))
			{
				*(&iParam0 + 24) = &uLocal_11;
				if (!IS_DOOR_LOCKED(&cLocal_3))
				{
					Function_74(&cLocal_3, 1);
				}
				if (IS_DOOR_OPENED(&cLocal_3))
				{
					CLOSE_DOOR_FAST(&cLocal_3);
				}
				if (!IS_DOOR_LOCKED(&uLocal_5))
				{
					Function_74(&uLocal_5, 1);
				}
				if (IS_DOOR_OPENED(&uLocal_5))
				{
					CLOSE_DOOR_FAST(&uLocal_5);
				}
				iLocal_9 = CREATE_LAYOUT(Function_132());
				return 1;
			}
		}
	}
...
void Function_74(var uParam0, int iParam1) //Position: 0x3B97 / 15255
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
bool Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x3BF2 / 15346
{
...
void Function_76(var uParam0, int iParam1) //Position: 0x3C22 / 15394
{
	int iVar0;
...
int Function_77(int iParam0, char* cParam1, bool bParam3) //Position: 0x3C6D / 15469
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_78(int iParam0) //Position: 0x3D12 / 15634
{
...
bool Function_79(var uParam0, var uParam1, bool bParam2) //Position: 0x3D28 / 15656
{
	var uVar0;
	
	uVar0 = 1;
	return Function_80(&uParam0, &uVar0, uParam1, &bParam2, 1, 1, 0, 0, 0, 0, 0);
}

int Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3D47 / 15687
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3F26 / 16166
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x4467 / 17511
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_83(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4489 / 17545
{
	var uVar0;
...
var Function_84(bool bParam0, int iParam1) //Position: 0x44EA / 17642
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x4578 / 17784
{
	Function_87(&uParam0);
	Function_86(&uParam0);
...
void Function_86(int iParam0) //Position: 0x45A4 / 17828
{
...
void Function_87(int iParam0) //Position: 0x45CA / 17866
{
...
bool Function_88(bool bParam0) //Position: 0x46A0 / 18080
{
...
var Function_89(int iParam0, int iParam1) //Position: 0x46B7 / 18103
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x475D / 18269
{
	var uVar0;
	var uVar1;
...
void Function_91(var uParam0) //Position: 0x486C / 18540
{
	int iVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x489F / 18591
{
	int iVar0;
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x48BC / 18620
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_24(&iParam0);
...
void Function_94() //Position: 0x4948 / 18760
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x49B8 / 18872
{
	if (!Function_78(iParam0))
	{
		return 1;
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x49D4 / 18900
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4A7A / 19066
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_12(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_58(Function_63(Param0.f_188));
...
bool Function_98(struct<2>[] Param0) //Position: 0x4B85 / 19333
{
	int iVar0;
	int iVar1;
		...
		if (Function_29(&(Param0[iVar02]), 4))
		{
			if (!Function_29(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_29(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_99() //Position: 0x4F47 / 20295
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x4F87 / 20359
{
	int iVar0;
...
void Function_101(struct<13> Param0) //Position: 0x4FB5 / 20405
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_102() //Position: 0x4FC8 / 20424
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x500A / 20490
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x50A2 / 20642
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x50D1 / 20689
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x512C / 20780
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x513C / 20796
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5150 / 20816
{
	int iVar0;
...
var Function_109() //Position: 0x5175 / 20853
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x518C / 20876
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x52C8 / 21192
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x52DA / 21210
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x52EC / 21228
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x52FE / 21246
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x5323 / 21283
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x5342 / 21314
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x534E / 21326
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x5359 / 21337
{
	int iVar0;
...
var Function_119() //Position: 0x5387 / 21383
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x539C / 21404
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x54A9 / 21673
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x54BD / 21693
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x5529 / 21801
{
	char* cVar0[32];
...
var Function_124() //Position: 0x554B / 21835
{
	return "PBox_";
}

var Function_125() //Position: 0x5559 / 21849
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x557F / 21887
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x55A7 / 21927
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x55CD / 21965
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5737 / 22327
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x57DF / 22495
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x594D / 22861
{
...
var Function_132() //Position: 0x59B5 / 22965
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x59BE / 22974
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x59DC / 23004
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5CD5 / 23765
{
	int iVar0;
...
void Function_136() //Position: 0x5D89 / 23945
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5DC4 / 24004
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x5DF1 / 24049
{
	bool bVar0;
...
void Function_139() //Position: 0x5F4C / 24396
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x5F98 / 24472
{
	int iVar0;
...
int Function_141() //Position: 0x6074 / 24692
{
	int iVar0;
...
int Function_142() //Position: 0x61D0 / 25040
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x62F0 / 25328
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x63CC / 25548
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x63EB / 25579
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x652E / 25902
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x6550 / 25936
{
	int iVar0;
...
int Function_148() //Position: 0x656C / 25964
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x6573 / 25971
{
	var uVar0;
...
var Function_150(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6605 / 26117
{
	int iVar0;
