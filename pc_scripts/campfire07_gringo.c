...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_116(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireLarge01x");
...
void Function_1(struct<473> Param0) //Position: 0x141 / 321
{
	int iVar0;
...
void Function_2() //Position: 0x2EF / 751
{
	return;
}
...
void Function_4() //Position: 0x2FE / 766
{
...
void Function_5(int iParam0) //Position: 0x311 / 785
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x339 / 825
{
...
void Function_7(struct<13> Param0) //Position: 0x484 / 1156
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x4A1 / 1185
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4BF / 1215
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_44 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_46, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_46, 20.0f, fLocal_46));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_47, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_10(struct<62> Param0) //Position: 0x167E / 5758
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1690 / 5776
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x18C9 / 6345
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18E9 / 6377
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x19D7 / 6615
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C43 / 7235
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C67 / 7271
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C8B / 7307
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1CB1 / 7345
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1CD8 / 7384
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1CFC / 7420
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1D1B / 7451
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D6A / 7530
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1DC6 / 7622
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DE7 / 7655
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E42 / 7746
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E8E / 7822
{
...
void Function_27(struct<425> Param0) //Position: 0x1EA3 / 7843
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1FF6 / 8182
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x206B / 8299
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x20D7 / 8407
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x20EF / 8431
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x214D / 8525
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x219A / 8602
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x2213 / 8723
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x2262 / 8802
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x242B / 9259
{
...
void Function_37(int iParam0) //Position: 0x2468 / 9320
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2481 / 9345
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x248E / 9358
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x2583 / 9603
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x2642 / 9794
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x2655 / 9813
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x271C / 10012
{
...
bool Function_44(int iParam0) //Position: 0x273C / 10044
{
...
bool Function_45(int iParam0) //Position: 0x2760 / 10080
{
...
bool Function_46(int iParam0) //Position: 0x2775 / 10101
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x278C / 10124
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x27CA / 10186
{
...
bool Function_49(int iParam0) //Position: 0x27E4 / 10212
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x27FA / 10234
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x2834 / 10292
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x2919 / 10521
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2AD0 / 10960
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2AF5 / 10997
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B43 / 11075
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2C9A / 11418
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D45 / 11589
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DEB / 11755
{
...
bool Function_59(var uParam0) //Position: 0x2E44 / 11844
{
	var uVar0;
	...
	*(&iLocal_0 + 128) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend1", "horse_stay", Vector(-1,722836f, 0.0f, -4,751904f), Vector(0.0f, -159,4017f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 128), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn", "campfire_talk", Vector(-1,495469f, 0,05462896f, -1,056958f), Vector(0.0f, 420,3378f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "smoking_stand_nospawn", "Rand_Idle_Sit_Ground_nospawn", Vector(0,5048123f, 0.0f, -2,34332f), Vector(0.0f, -194,3122f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_announce", "campfire_talk", Vector(3,621576f, 0.0f, 0,4118278f), Vector(0.0f, 231,2719f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_drunk_rowdydrink1", "Sit_Ground_Campfire_Tend", Vector(-1,21514f, 0.0f, 1,114008f), Vector(0.0f, -47,84432f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "sit_camp_coffee_drink", "Rand_Idle_Sit_Ground_nospawn", Vector(-2,561264f, 0.0f, 1,222186f), Vector(0.0f, -67,59335f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Sit_Ground_Campfire_Tend", "Rand_Idle_Sit_Ground_nospawn", Vector(1,407981f, 0.0f, 0,8042166f), Vector(0.0f, 56,86643f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 136) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType6", "Rand_Idle_Sit_Ground_Player", Vector(1,429398f, 0.0f, -1,235141f), Vector(0.0f, 129,2687f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 136), 0);
	*(&iLocal_0 + 144) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(3,212193f, 0.0f, 3,500115f), Vector(0.0f, 65,86808f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 144), 0);
	*(&iLocal_0 + 152) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp1", "horse_stay", Vector(0.0f, 0.0f, 3,57749f), Vector(0.0f, -50,32582f, 0.0f));
	...
	*(&iLocal_0 + 168) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Pee_nospawn1", "Pee_nospawn", Vector(-5,764121f, 0.0f, -0,9983891f), Vector(0.0f, 55,99445f, 0.0f));
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, int iParam1) //Position: 0x343D / 13373
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x3488 / 13448
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x34C6 / 13510
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x34D9 / 13529
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x35A8 / 13736
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x35F2 / 13810
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x39B4 / 14772
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x39F4 / 14836
{
	int iVar0;
...
void Function_68() //Position: 0x3A22 / 14882
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3A64 / 14948
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3AFC / 15100
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3B2B / 15147
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3B86 / 15238
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3B96 / 15254
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3BAA / 15274
{
	int iVar0;
...
var Function_75() //Position: 0x3BCF / 15311
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3BE6 / 15334
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3D22 / 15650
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3D34 / 15668
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3D46 / 15686
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3D58 / 15704
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3D7D / 15741
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3D9C / 15772
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3DA8 / 15784
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3DB3 / 15795
{
	int iVar0;
...
var Function_85() //Position: 0x3DE1 / 15841
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3DF6 / 15862
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3F03 / 16131
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3F17 / 16151
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x3F83 / 16259
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3FA5 / 16293
{
	return "PBox_";
}

var Function_91() //Position: 0x3FB3 / 16307
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3FD9 / 16345
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x4023 / 16419
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x4049 / 16457
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x41B3 / 16819
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x425B / 16987
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x43C9 / 17353
{
...
var Function_98() //Position: 0x4431 / 17457
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x443A / 17466
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x4458 / 17496
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x4751 / 18257
{
	int iVar0;
...
void Function_102() //Position: 0x4805 / 18437
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x4840 / 18496
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x486D / 18541
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x49C8 / 18888
{
...
void Function_106() //Position: 0x49DF / 18911
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4A2B / 18987
{
	int iVar0;
...
int Function_108() //Position: 0x4B07 / 19207
{
	int iVar0;
...
int Function_109() //Position: 0x4C63 / 19555
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4D83 / 19843
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4E5F / 20063
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4E7E / 20094
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x4FC1 / 20417
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x5038 / 20536
{
	var uVar0;
...
int Function_115() //Position: 0x505A / 20570
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x5061 / 20577
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x50F3 / 20723
{
	int iVar0;
