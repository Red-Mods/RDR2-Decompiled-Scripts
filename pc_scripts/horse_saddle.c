...
bool Function_26(int iParam0, bool bParam1) //Position: 0x1FBC / 8124
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	if (IS_ACTOR_HORSE(&iParam0))
	{
		if (!Function_27(&iParam0, 0x3f800000, 0x42960000, 1, 1, 0))
		{
			if (!DOES_HORSE_HAVE_ACCESSORY(&iParam0, 3) && !DOES_HORSE_HAVE_ACCESSORY(&iParam0, 4))
			{
				if (&iParam0 == &Global_21369 + 72)
				{
					ACCESSORIZE_HORSE(&iParam0, 4);
				}
				else
				{
...
bool Function_27(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x2022 / 8226
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &uParam1, &uParam2, &uParam3, &uParam4, &uParam5);
}

bool Function_28(bool bParam0) //Position: 0x2042 / 8258
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_29() //Position: 0x2062 / 8290
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x2068 / 8296
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(char* cParam0) //Position: 0x207A / 8314
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x2087 / 8327
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x20A2 / 8354
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x20C2 / 8386
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x20E2 / 8418
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x2119 / 8473
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2139 / 8505
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x2154 / 8532
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x216A / 8554
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x248E / 9358
{
	int iVar0;
...
bool Function_41(char* cParam0, int iParam1) //Position: 0x2497 / 9367
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x24B6 / 9398
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24C5 / 9413
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(char* cParam0, int iParam1) //Position: 0x24E9 / 9449
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x250F / 9487
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x252D / 9517
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x254F / 9551
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(char* cParam0, int iParam1) //Position: 0x2571 / 9585
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x2639 / 9785
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x26B5 / 9909
{
...
void Function_51(vector3 vParam0) //Position: 0x26CD / 9933
{
...
var Function_52(int iParam0) //Position: 0x26F2 / 9970
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x2713 / 10003
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x272A / 10026
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x2736 / 10038
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x273D / 10045
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x274E / 10062
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x2793 / 10131
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x27BF / 10175
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x27CB / 10187
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x28CD / 10445
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x28F0 / 10480
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x2918 / 10520
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BFF / 11263
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2C5C / 11356
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2CB9 / 11449
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2CC5 / 11461
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2CE4 / 11492
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2CFB / 11515
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2D8C / 11660
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DB0 / 11696
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2DCF / 11727
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2DF3 / 11763
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2F1B / 12059
{
...
int Function_75(var uParam0) //Position: 0x2F49 / 12105
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x3062 / 12386
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x306F / 12399
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x30F1 / 12529
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x369C / 13980
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x36D6 / 14038
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x36F4 / 14068
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x3735 / 14133
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x3741 / 14145
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x3763 / 14179
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3775 / 14197
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x3885 / 14469
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x389D / 14493
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x3BB9 / 15289
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3BCB / 15307
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3BE5 / 15333
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3C00 / 15360
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3C3E / 15422
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3C57 / 15447
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3F4F / 16207
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3F6D / 16237
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x400E / 16398
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x402E / 16430
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x4041 / 16449
{
...
void Function_99(int iParam0) //Position: 0x405D / 16477
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4069 / 16489
{
	bool bVar0;
	var uVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x40D5 / 16597
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x40ED / 16621
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x40F9 / 16633
{
