...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_95(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_113);
		}
		iVar2 = 0;
		bLocal_120 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			{
				if (&vLocal_2[iVar09] + 16 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_112;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_88(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_86(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (&vLocal_2[iVar39] + 24 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_81("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_80(&vLocal_2[iVar39] + 24, 1);
							if (IS_ACTOR_VALID(&vLocal_2[iVar39] + 24))
							{
								if (IS_ACTOR_LOCAL_PLAYER(&vLocal_2[iVar39] + 24) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(&vLocal_2[iVar39] + 16))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(&vLocal_2[iVar39] + 24, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_73(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_72(&(vLocal_2[iVar39]));
								vLocal_2[iVar39].f_68 = 8;
							}
							bVar5 = true;
						}
						else
		...
		else
		{
			...
			while (iVar0 < (iLocal_112 - 1))
			{
				if (Function_71(vLocal_2[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_2[iVar09])))
					{
						Function_98("Quitting due to update end");
						Function_73(&(vLocal_2[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_2[iVar09]), 0))
				{
					Function_5(&(vLocal_2[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_121))
	{
		Function_98("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_121);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_112 - 1))
	{
		if (Function_71(vLocal_2[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_2[iVar09] + 24);
			Function_73(&(vLocal_2[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_2[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_2[iVar09] + 16);
		}
		Function_15(&(vLocal_2[iVar09]), 1);
		iVar0++;
	}
...
void Function_5(struct<69> Param0) //Position: 0x498 / 1176
{
	...
	if (!Function_71(Param0.f_64, 2))
	{
		Function_80(&Param0 + 24, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_121))
								{
									...
									{
										bLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_121))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_121))
		{
			Function_98("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_121);
		}
...
float Function_10(char* cParam0) //Position: 0x96C / 2412
{
	return Function_11(&cParam0, "MinimumUseTime", 0.0f);
}

var Function_11(float fParam0, char* cParam1, int iParam2) //Position: 0x98A / 2442
{
	int iVar0;
	
	iVar0 = iParam2;
	GET_GRINGO_FLOAT_ATTR(&iVar0, &cParam1, &fParam0);
	return iVar0;
}
...
bool Function_16(struct<69> Param0) //Position: 0xAD8 / 2776
{
	...
	bVar11 = Function_70(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_81("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_81("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_81("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_69(&Param0 + 16, &fVar22))
				{
			...
			{
				if (Function_68(&Param0 + 24, &Param0 + 16))
				{
			...
			if (!Function_66(&Param0 + 16) && Param0.f_68 != 1)
			{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_71(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_71(Param0.f_64, 1))
			{
				Function_59(&Param0 + 16, &Var3, &uVar5);
				if (!Function_71(Param0.f_64, 16))
				{
				...
				if (!Function_71(Param0.f_64, 1024))
				{
			...
			else if (Function_68(&Param0 + 24, &Param0 + 16))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 1);
			...
			if (Param0.f_68 != 3 && !Function_71(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_71(Param0.f_64, 1);
			}
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_41(&Param0, &uVar7, &iLocal_118, &uLocal_116);
		...
		case 0x00000006:
			...
			bVar0 = Function_51(&Param0 + 24, &Param0 + 16, Function_71(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
float Function_23(char* cParam0) //Position: 0x1F75 / 8053
{
	return Function_11(&cParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1F8C / 8076
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

var Function_25(char* cParam0) //Position: 0x1F99 / 8089
{
	return Function_11(&cParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, bool bParam1) //Position: 0x1FBA / 8122
{
	var uVar0;
	bool bVar2;
	bool bVar3;
	...
	Function_28(&bParam1);
	uVar0 = Function_28(&bParam1);
	bVar2 = Function_27(&bParam1);
	GRINGO_ACTOR_MOVE_TO_AND_FACE(&iParam0, &uVar0, 0,05f, 0,05f, 1, bVar2, 0,05f, 0, 0);
	fVar4 = Function_9(&bParam1, "PushAnimToSyncWithVelocity", &bVar3);
	if (bVar3)
	{
		fVar5 = Function_11(&bParam1, "AnimTimeToSyncWithVelocity", 0,5f);
		fVar6 = GET_ACTOR_ANIM_CURRENT_TIME(GET_PLAYER_ACTOR(0), &fVar4);
		if (fVar6 <= fVar5)
		{
			fVar7 = GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT());
			GET_ACTOR_AXIS(GET_PLAYER_ACTOR(0), &uVar8, 2);
			bVar10 = Function_11(&bParam1, "AppliedVelocityOnZ", -1.0f);
			VSCALE(&uVar8, bVar10);
			SET_PROP_VELOCITY_ON_AXIS(&fVar7, &uVar8, 2);
		}
	}
	bParam1 = &bParam1;
	iParam0 = &iParam0;
...
float Function_27(int iParam0) //Position: 0x20A9 / 8361
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_28(int iParam0) //Position: 0x20B5 / 8373
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_29(int iParam0) //Position: 0x21B7 / 8631
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

bool Function_30(bool bParam0) //Position: 0x21DA / 8666
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_31() //Position: 0x21FA / 8698
{
	return;
}

void Function_32(int iParam0, bool bParam1) //Position: 0x2200 / 8704
{
	var uVar0;
	var uVar1;
	
	uVar0 = GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT());
	uVar1 = Vector(0.0f, 0.0f, 0.0f);
	SET_PROP_VELOCITY_ON_AXIS(&uVar0, &uVar1, 2);
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
}

bool Function_33(char* cParam0) //Position: 0x222C / 8748
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_34(int iParam0) //Position: 0x2239 / 8761
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_35(char* cParam0, int iParam1) //Position: 0x2254 / 8788
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_36(int iParam0) //Position: 0x2274 / 8820
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_37(int iParam0) //Position: 0x2294 / 8852
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (vLocal_2 - 1))
	{
		if (&vLocal_2[iVar09] + 16 == &iParam0)
		{
			return &vLocal_2[iVar09] + 24;
		}
		iVar0++;
	}
	return &iVar1;
...
bool Function_38(int iParam0) //Position: 0x22CB / 8907
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_39(int iParam0) //Position: 0x22EB / 8939
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x2306 / 8966
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_41(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x231C / 8988
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_42() //Position: 0x2640 / 9792
{
	int iVar0;
...
bool Function_43(char* cParam0, int iParam1) //Position: 0x2649 / 9801
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_44() //Position: 0x2668 / 9832
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_45(char* cParam0, int iParam1) //Position: 0x2677 / 9847
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x269B / 9883
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_47(int iParam0) //Position: 0x26C1 / 9921
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_48(var uParam0, int iParam1) //Position: 0x26DF / 9951
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x2701 / 9985
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_50(bool bParam0, int iParam1) //Position: 0x2723 / 10019
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_51(var uParam0, int iParam1, bool bParam2) //Position: 0x27EB / 10219
{
	int iVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x2867 / 10343
{
...
void Function_53(vector3 vParam0) //Position: 0x287F / 10367
{
...
var Function_54(int iParam0) //Position: 0x28A4 / 10404
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_55(vector3 vParam0) //Position: 0x28C5 / 10437
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_56(var uParam0) //Position: 0x28DC / 10460
{
	uParam0 = &uParam0;
	return;
}

int Function_57() //Position: 0x28E8 / 10472
{
	return 1;
}

void Function_58(var uParam0, int iParam1) //Position: 0x28EF / 10479
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_59(int iParam0, var uParam1, int iParam2) //Position: 0x2900 / 10496
{
	bool bVar0;
	
	Function_28(&iParam0);
	uParam1 = Function_28(&iParam0);
	iParam2 = Function_27(&iParam0);
	bVar0 = Function_60(&iParam0);
	if (bVar0 < 180.0f)
	{
		bVar0 = 180.0f;
	}
...
var Function_60(int iParam0) //Position: 0x2945 / 10565
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

var Function_61(int iParam0) //Position: 0x2971 / 10609
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2999 / 10649
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	while (bVar7 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(&uVar8))
		{
			...
			{
				Function_64(StackVal, StackVal, Var2, Var11);
				Var2 = Function_64(StackVal, StackVal, Var2, Var11);
				Function_63(StackVal, StackVal, Var0, Var11);
				Var0 = Function_63(StackVal, StackVal, Var0, Var11);
			}
		}
	...
	{
		Function_98("Failed to create gringo camera");
	}
	return;
}

struct<8> Function_63(vector3 vParam0) //Position: 0x2C80 / 11392
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2CDD / 11485
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2D3A / 11578
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2D46 / 11590
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2D65 / 11621
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(int iParam0, int iParam1) //Position: 0x2D7C / 11644
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2D8F / 11663
{
...
int Function_70(var uParam0) //Position: 0x2DBD / 11709
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2ED6 / 11990
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(struct<69> Param0) //Position: 0x2EE3 / 12003
{
	if (Function_71(Param0.f_64, 16))
	{
...
void Function_73(struct<69> Param0) //Position: 0x2F65 / 12133
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_71(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_79(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_71(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_71(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_78(&Param0 + 16) && Function_71(Param0.f_64, 512))
			{
	...
	if (&Param0 + 16 == &iLocal_118)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_116));
		iLocal_118 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_39(&Param0 + 16))
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_75(&Param0 + 16), &Param0 + 16);
	}
...
void Function_74() //Position: 0x3510 / 13584
{
	int iVar0;
...
var Function_75(int iParam0) //Position: 0x354A / 13642
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_76(int iParam0, var uParam1) //Position: 0x3568 / 13672
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_77(int iParam0) //Position: 0x35A9 / 13737
{
	iParam0 = &iParam0;
	return;
}

bool Function_78(int iParam0) //Position: 0x35B5 / 13749
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_79(int iParam0, int iParam1) //Position: 0x35D7 / 13783
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_80(var uParam0, bool bParam1) //Position: 0x35E9 / 13801
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_81(float fParam0, int iParam1) //Position: 0x36F9 / 14073
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &fParam0, 0, 0, 0);
	return;
}

void Function_82(struct<69> Param0) //Position: 0x3711 / 14097
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_83(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_83(int iParam0, int iParam1) //Position: 0x3A2D / 14893
{
	var uVar0;
	var uVar1;
	var uVar3;
	...
	SET_PROP_VELOCITY_ON_AXIS(&uVar0, &uVar1, 2);
	Function_28(&iParam1);
	uVar3 = Function_28(&iParam1);
	bVar5 = Function_27(&iParam1);
	GRINGO_ACTOR_MOVE_TO_AND_FACE(&iParam0, &uVar3, 0,05f, 0,05f, 1, bVar5, 0,05f, 0, 0);
	CAMERA_RESET(0);
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_84(int iParam0) //Position: 0x3A8B / 14987
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_85(int iParam0) //Position: 0x3AA5 / 15013
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_86(int iParam0, var uParam1) //Position: 0x3AC0 / 15040
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_87(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_87(var uParam0, int iParam1) //Position: 0x3AFE / 15102
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_88(struct<65> Param0) //Position: 0x3B17 / 15127
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_71(Param0.f_64, 2))
		{
			...
			if (Function_71(Param0.f_64, 1))
			{
				Function_81("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				Function_28(&Param0 + 16);
				Var8 = Function_28(&Param0 + 16);
				Var10 = Vector(StackVal, StackVal, StackVal) - Vector(Var2, Var8, StackVal);
				fVar12 = Function_91(&Param0 + 16);
				bVar13 = VMAG(Var10);
				...
				if (!Function_90(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar30 = Function_89(&Param0 + 16);
				if (!bVar30 != 0.0f)
				{
					if (bVar30 < 0.0f)
					{
						fVar31 = (UNK_0x9C40E671(&Var10) - Function_27(&Param0 + 16));
					}
					else
					{
						fVar31 = ((180.0f + UNK_0x9C40E671(&Var10)) - Function_27(&Param0 + 16));
					}
					if (fVar31 < 180.0f)
					{
...
var Function_89(int iParam0) //Position: 0x3E0F / 15887
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_90(var uParam0, int iParam1) //Position: 0x3E2D / 15917
{
	struct<5> Var0;
	float fVar5;
...
var Function_91(int iParam0) //Position: 0x3ECD / 16077
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3EED / 16109
{
	float fVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	if (GET_GRINGO_FLOAT_ATTR(&fVar0, "FaceCentreHeadingTol", &iParam1))
	{
		if (GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var1))
		{
			GET_OBJECT_POSITION(&uParam0, &Var3);
			uVar5 = Vector(StackVal, StackVal, StackVal) - Vector(Var3, Var1, StackVal);
			bVar7 = (UNK_0x9C40E671(&uVar5) - GET_OBJECT_HEADING(&uParam0));
			bVar7 = FABS(bVar7);
			if (bVar7 <= 180.0f)
			{
				bVar7 = (bVar7 - 360.0f);
			}
			if (bVar7 < fVar0 || bVar7 > -fVar0)
			{
				return 0;
			}
		}
...
bool Function_93(int iParam0) //Position: 0x3F71 / 16241
{
...
void Function_94(int iParam0) //Position: 0x3F8D / 16269
{
	iParam0 = &iParam0;
	return;
}

void Function_95(var uParam0, int iParam1) //Position: 0x3F99 / 16281
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_96(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_96(int iParam0, int iParam1) //Position: 0x4006 / 16390
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_97(int iParam0) //Position: 0x401E / 16414
{
	iParam0 = &iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x402A / 16426
{
