						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_123))
								{
									...
									{
										bLocal_123 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_123 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
void Function_29(bool bParam0, int iParam1) //Position: 0x1FF5 / 8181
{
	bParam0 = &bParam0;
	iParam1 = &iParam1;
	return;
...
void Function_83(int iParam0, int iParam1) //Position: 0x36F0 / 14064
{
	...
	{
		SUSPEND_MOVER(&iParam0);
		REMOVE_OBJECT_ATTACHMENT(&uLocal_2);
	}
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x3717 / 14103
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3827 / 14375
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x383F / 14399
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3B5B / 15195
{
	int iVar0;
	int iVar1;
	struct<2> Var2;
	...
	if (IS_OBJECT_VALID(&iVar0))
	{
		if (!IS_ATTACHMENT_VALID(&uLocal_2))
		{
			uLocal_2 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iVar0, Function_39(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
			ENABLE_MOVER(&uParam0);
		}
		iVar1 = GET_TARGET_OBJECT();
		if (IS_OBJECT_VALID(&iVar1))
		{
			iVar6 = CREATE_OBJECT_LOCATOR(&iVar0, Function_39());
			if (IS_OBJECT_VALID(&iVar6))
			{
				if (OBJECT_LOCATOR_ATTACH_TO_OBJECT(StackVal, StackVal, &iVar6, &iVar0, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
				{
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_POSITION(&iVar6, &Var2);
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_ORIENTATION(&iVar6, &Var4);
					SET_ATTACHMENT_LOCAL_OFFSET(&uLocal_2, Var2);
					SET_ATTACHMENT_LOCAL_ROTATION(&uLocal_2, Var4);
				}
...
bool Function_88(int iParam0) //Position: 0x3C11 / 15377
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C2B / 15403
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C46 / 15430
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C84 / 15492
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C9D / 15517
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F95 / 16277
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FB3 / 16307
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4054 / 16468
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4074 / 16500
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x4087 / 16519
{
...
void Function_98(int iParam0) //Position: 0x40A3 / 16547
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x40AF / 16559
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x411B / 16667
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(var uParam0) //Position: 0x4133 / 16691
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x41A9 / 16809
{
