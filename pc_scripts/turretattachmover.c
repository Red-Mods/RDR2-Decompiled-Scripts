...
void main() //Position: 0x0 / 0
{
	...
	iLocal_132 = 0;
	Function_104(&uScriptParam_0, &iLocal_132);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_97(&(vLocal_22[iVar39]), &bVar4))
						{
							Function_95(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_22[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_90("eGRINGO_EndUse: Stop use by request", &vLocal_22[iVar39] + 24);
							Function_89(&vLocal_22[iVar39] + 24, 1);
							...
							{
								Function_80(&(vLocal_22[iVar39]), 0);
							}
							else if (vLocal_22[iVar39].f_68 < 8)
							{
								Function_79(&(vLocal_22[iVar39]));
	...
	while (iVar0 < (iLocal_132 - 1))
	{
		if (Function_78(vLocal_22[iVar09].f_64, 2))
		{
			...
			Function_80(&(vLocal_22[iVar09]), 0);
		}
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_141))
								{
									...
									{
										bLocal_141 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_141 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_16(struct<69> Param0) //Position: 0xADC / 2780
{
	...
	{
		Function_90("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_90("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_90("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			bLocal_140 = true;
			Function_58(&Param0);
			Function_55(&Param0, Function_57(&Param0 + 16));
			if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
			{
			...
			bVar0 = Function_54(&Param0 + 24, &Param0 + 16, bVar29);
			...
			else if (bVar11)
			{
				if (GRINGO_PLAY_ANIM_ON_ACTOR(&Param0 + 24, &bVar0, bVar29))
				{
					...
					bVar12 = false;
					cVar14 = GRINGO_GET_ATTRIBUTE(&Param0 + 16, bVar12);
					while (bVar12 <= GRINGO_GET_ATTRIBUTE_COUNT(&Param0 + 16))
					{
						cVar14 = GRINGO_GET_ATTRIBUTE(&Param0 + 16, bVar12);
						if (GRINGO_IS_ATTRIBUTE_VALID(&cVar14))
						{
							if (GRINGO_GET_ATTR_TYPE_BY_HANDLE(&cVar14) == 2)
							{
								if (iVar21 == GRINGO_GET_ATTRIBUTE_HASH(&cVar14))
								{
									uVar15 = GRINGO_GET_STRING_ATTR_BY_HANDLE(&cVar14, &uVar13);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_44(&Param0, &uVar7, &iLocal_138, &uLocal_136);
					if (GET_OBJECT_TYPE(&uVar7) != 15)
					{
						cVar20 = GET_PHYSINST_FROM_OBJECT(&uVar7);
						if (IS_PHYSINST_VALID(&cVar20))
						{
							if (!IS_PROP_FIXED(&cVar20))
							{
								Function_61(&Param0 + 64, 256);
								SET_PROP_FIXED(&cVar20, 1);
							}
							else
							{
								Function_43(&Param0 + 64, 256);
							}
						}
					}
				}
				...
				if (IS_GRINGO_COMPONENT_VALID(&bVar0))
				{
					...
					bVar9 = false;
					uVar6 = Function_38(&Param0 + 16, &bVar9);
					if (bVar9)
					{
						iVar2 = GRINGO_GET_PARENT_COMPONENT(&Param0 + 16, 3);
						if (IS_GRINGO_COMPONENT_VALID(&iVar2))
		...
		case 0x00000006:
			...
			bVar0 = Function_54(&Param0 + 24, &Param0 + 16, Function_78(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
bool Function_26(var uParam0, int iParam1) //Position: 0x1FBE / 8126
{
	...
	else if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_PLAYER(&uParam0))
		{
			if (IS_ACTION_NODE_PLAYING_PARTIAL(&uParam0, "fire"))
			{
				Global_6663 = 1;
			}
			else
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		GET_ACTOR_AXIS(&uParam0, &Var0, 1);
		GET_POSITION(&uParam0, &Var2);
		Var4 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(Var0, Var2, StackVal) * Vector(2.0f, 2.0f, 2.0f), StackVal, StackVal);
...
bool Function_27(int iParam0) //Position: 0x2050 / 8272
{
	int iVar0;
...
bool Function_28(int iParam0) //Position: 0x2086 / 8326
{
...
bool Function_29(int iParam0) //Position: 0x20AA / 8362
{
...
bool Function_30(int iParam0) //Position: 0x20BF / 8383
{
...
var Function_31(int iParam0) //Position: 0x20D6 / 8406
{
	if (!Function_32(iParam0))
	{
		return 4294967295;
...
bool Function_32(int iParam0) //Position: 0x20F0 / 8432
{
...
bool Function_33(bool bParam0) //Position: 0x2106 / 8454
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_34() //Position: 0x2126 / 8486
{
	return;
}

void Function_35(var uParam0, int iParam1) //Position: 0x212C / 8492
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	uVar2 = GET_GRINGO_STRING_ATTR("LocatorAttachName", &iParam1, &uVar3);
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		{
			iVar8 = CREATE_OBJECT_LOCATOR(&iVar1, &uVar2);
			if (IS_OBJECT_VALID(&iVar8))
			{
				if (OBJECT_LOCATOR_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &iVar8, &iVar1, &uVar2, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
				{
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_POSITION(&iVar8, &Var4);
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_ORIENTATION(&iVar8, &Var6);
					SET_ATTACHMENT_LOCAL_OFFSET(&uLocal_15, Var4);
					SET_ATTACHMENT_LOCAL_ROTATION(&uLocal_15, Var6);
				}
...
bool Function_36(char* cParam0) //Position: 0x21DF / 8671
{
	cParam0 = &cParam0;
	return 0;
}

bool Function_37(int iParam0) //Position: 0x21EC / 8684
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_38(char* cParam0, int iParam1) //Position: 0x2207 / 8711
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_39(int iParam0) //Position: 0x2227 / 8743
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_40(int iParam0) //Position: 0x2247 / 8775
{
	int iVar0;
	int iVar1;
...
bool Function_41(int iParam0) //Position: 0x227E / 8830
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_42(int iParam0) //Position: 0x229E / 8862
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_43(var uParam0, int iParam1) //Position: 0x22B9 / 8889
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_44(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x22CF / 8911
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	PRINTNL();
	uVar2 = Function_52(&iParam0 + 16, &bVar0);
	uVar3 = Function_51(&iParam0 + 16, &bVar1);
	uVar4 = Function_50(&iParam0 + 16);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(&uVar4)))
	{
		uVar6 = Function_49(&iParam0 + 16, &bVar5);
		if (bVar5)
		{
			uVar8 = Function_48(&iParam0 + 16, &bVar7);
			if (!bVar7)
			{
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, &uVar3, Function_46(&iParam0 + 16, &iVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, Function_45(), Function_46(&iParam0 + 16, &iVar10), 0, bVar9);
	}
...
var Function_45() //Position: 0x25F3 / 9715
{
	int iVar0;
...
bool Function_46(char* cParam0, int iParam1) //Position: 0x25FC / 9724
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_47() //Position: 0x261B / 9755
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_48(char* cParam0, int iParam1) //Position: 0x262A / 9770
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_49(char* cParam0, int iParam1) //Position: 0x264E / 9806
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_50(int iParam0) //Position: 0x2674 / 9844
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_51(var uParam0, int iParam1) //Position: 0x2692 / 9874
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_52(var uParam0, int iParam1) //Position: 0x26B4 / 9908
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_53(bool bParam0, int iParam1) //Position: 0x26D6 / 9942
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_54(var uParam0, int iParam1, bool bParam2) //Position: 0x279E / 10142
{
	int iVar0;
...
void Function_55(int iParam0, float fParam1) //Position: 0x281A / 10266
{
...
void Function_56(vector3 vParam0) //Position: 0x2832 / 10290
{
...
var Function_57(int iParam0) //Position: 0x2857 / 10327
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_58(vector3 vParam0) //Position: 0x2878 / 10360
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_59(var uParam0) //Position: 0x288F / 10383
{
	uParam0 = &uParam0;
	return;
}

int Function_60() //Position: 0x289B / 10395
{
	return 1;
}

void Function_61(var uParam0, int iParam1) //Position: 0x28A2 / 10402
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_62(int iParam0, var uParam1, int iParam2) //Position: 0x28B3 / 10419
{
	bool bVar0;
...
int Function_63(int iParam0) //Position: 0x28F8 / 10488
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_64(int iParam0) //Position: 0x2924 / 10532
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_65(int iParam0) //Position: 0x2930 / 10544
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_66(int iParam0) //Position: 0x2A32 / 10802
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_67(int iParam0) //Position: 0x2A55 / 10837
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_68(int iParam0) //Position: 0x2A7D / 10877
{
	var uVar0;
	var uVar1;
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar1))
		{
			if (DECOR_CHECK_EXIST(&uVar1, "bUseGatlingWagonCam") && iLocal_19)
			{
...
void Function_69(int iParam0) //Position: 0x2B06 / 11014
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2B12 / 11026
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2B31 / 11057
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2B48 / 11080
{
	var uVar0;
	bool bVar2;
	var uVar3;
	...
	Function_65(&iParam1);
	uVar0 = Function_65(&iParam1);
	bVar2 = Function_64(&iParam1);
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return 0;
	}
	...
	uVar4 = Function_63(&iParam1);
	Function_73(&iParam1);
	iVar5 = Function_73(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &uVar0, &iVar5, uVar3, 0,2f, 1, bVar2, uVar4, 0, 0);
}

struct<8> Function_73(int iParam0) //Position: 0x2BA7 / 11175
{
	struct<2> Var0;
...
struct<8> Function_74(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BCB / 11211
{
	struct<2> Var0;
...
int Function_75(int iParam0) //Position: 0x2BEA / 11242
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

bool Function_76(var uParam0, int iParam1) //Position: 0x2C0E / 11278
{
...
int Function_77(var uParam0) //Position: 0x2C3C / 11324
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2D55 / 11605
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x2D62 / 11618
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x2DE4 / 11748
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x338F / 13199
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x33C9 / 13257
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x33E7 / 13287
{
	var uVar0;
	var uVar1;
	int iVar2;
	
	Function_52(&iParam0 + 16, &uVar0);
	Function_51(&iParam0 + 16, &uVar1);
	iVar2 = Function_50(&iParam0 + 16);
...
void Function_84(int iParam0) //Position: 0x3428 / 13352
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x3434 / 13364
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(bool bParam0, var uParam1) //Position: 0x3456 / 13398
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	{
		if (IS_VOLUME_VALID(FIND_VOLUME_IN_LAYOUT(&Global_46715, "fodv_region")))
		{
			Function_88(GRINGO_GET_MY_OBJECT_REF());
			Var0 = Function_88(GRINGO_GET_MY_OBJECT_REF());
			uVar2 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Var0, 5.0f, "cannon", 1);
			if (IS_PHYSINST_VALID(&uVar2))
			{
				if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_PHYSINST(&uVar2), "fRestrictRotation"))
				{
					DECOR_REMOVE(GET_OBJECT_FROM_PHYSINST(&uVar2), "fRestrictRotation");
				}
			}
		}
	}
	if (IS_ATTACHMENT_VALID(&uLocal_15))
	{
		PRINTSTRING("TURRETATTACHMOVER - OnFinish - Detaching the object attachment.");
		PRINTNL();
		REMOVE_OBJECT_ATTACHMENT(&uLocal_15);
	}
	if (!IS_ACTOR_DEAD(&bParam0))
	{
		Function_87(&bParam0);
	}
	iVar3 = GRINGO_GET_MY_OBJECT_REF();
	if (IS_OBJECT_VALID(&iVar3))
	{
		uVar4 = GET_TARGET_OBJECT();
		if (IS_OBJECT_VALID(&uVar4))
		{
			if (DECOR_CHECK_EXIST(&uVar4, "bUseGatlingWagonCam") && iLocal_19)
			{
	...
	if (IS_LAYOUTREF_VALID(&uLocal_17))
	{
		DESTROY_LAYOUT_OBJECTS(&uLocal_17);
		DESTROY_LAYOUT(&uLocal_17);
	}
	return;
}

void Function_87(int iParam0) //Position: 0x35DE / 13790
{
	DECOR_REMOVE(&iParam0, "nKillBonus");
	DECOR_REMOVE(&iParam0, "KillBonusClass");
	return;
}

struct<8> Function_88(bool bParam0) //Position: 0x360F / 13839
{
	struct<2> Var0;
...
void Function_89(var uParam0, bool bParam1) //Position: 0x3638 / 13880
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_90(int iParam0, int iParam1) //Position: 0x3748 / 14152
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_91(struct<69> Param0) //Position: 0x3760 / 14176
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_92(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_92(var uParam0, var uParam1) //Position: 0x3A7C / 14972
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		if (IS_LAYOUTREF_VALID(&Global_46715))
		{
			if (IS_VOLUME_VALID(FIND_VOLUME_IN_LAYOUT(&Global_46715, "fodv_region")))
			{
				...
				if (IS_PHYSINST_VALID(&uVar2))
				{
					DECOR_SET_FLOAT(GET_OBJECT_FROM_PHYSINST(&uVar2), "fRestrictRotation", 135.0f);
				}
				uVar3 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Var0, 5.0f, "gat", 1);
				if (IS_PHYSINST_VALID(&uVar3))
				{
					DECOR_SET_FLOAT(GET_OBJECT_FROM_PHYSINST(&uVar3), "fRestrictRotation", 100.0f);
				}
			}
		}
	}
	if (!IS_ATTACHMENT_VALID(&uLocal_15))
	{
		uLocal_15 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, GET_TARGET_OBJECT(), 4294967295);
	}
	uVar4 = GET_GRINGO_STRING_ATTR("LocatorAttachName", &uParam1, &uVar6);
	iVar5 = GRINGO_GET_MY_OBJECT_REF();
...
bool Function_93(int iParam0) //Position: 0x3BA7 / 15271
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_94(int iParam0) //Position: 0x3BC1 / 15297
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_95(int iParam0, var uParam1) //Position: 0x3BDC / 15324
{
	bool bVar0;
	int iVar1;
...
bool Function_96(var uParam0, int iParam1) //Position: 0x3C1A / 15386
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_97(struct<65> Param0) //Position: 0x3C33 / 15411
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_78(Param0.f_64, 2))
		{
			...
			{
				Function_43(&Param0 + 64, 1);
			}
			if (Function_78(Param0.f_64, 1))
			{
				Function_90("MIDACTION REQUEST", &uVar1);
			}
			else
			{
...
int Function_98(int iParam0) //Position: 0x3F2B / 16171
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_99(var uParam0, int iParam1) //Position: 0x3F49 / 16201
{
	struct<5> Var0;
	float fVar5;
...
int Function_100(int iParam0) //Position: 0x3FE9 / 16361
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_101(bool bParam0, int iParam1) //Position: 0x4018 / 16408
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		if (IS_ATTACHMENT_VALID(&uVar1))
		{
			...
			{
				if (GET_ACTOR_STUCK_STATE(GET_ACTOR_FROM_OBJECT(&uVar2)) != 0)
				{
					PRINTSTRING("TURRET ATTACH MOVER - OnVerifyUse: kStuckState = ");
					PRINTINT(GET_ACTOR_STUCK_STATE(GET_ACTOR_FROM_OBJECT(&uVar2)));
					PRINTNL();
					return 0;
				}
			}
...
bool Function_102(int iParam0) //Position: 0x40D2 / 16594
{
...
void Function_103(int iParam0) //Position: 0x40EE / 16622
{
	iParam0 = &iParam0;
	return;
}

void Function_104(var uParam0, int iParam1) //Position: 0x40FA / 16634
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_105(&(vLocal_22[iLocal_1329]), &uParam0);
		iLocal_132++;
	}
...
void Function_105(int iParam0, int iParam1) //Position: 0x4166 / 16742
{
	*(&iParam0 + 16) = &iParam1;
	Function_43(&iParam0 + 64, 1);
	return;
}

void Function_106(var uParam0) //Position: 0x417E / 16766
{
	int iVar0;
	
	uParam0 = &uParam0;
	iVar0 = GRINGO_GET_MY_OBJECT_REF();
	return;
}

void Function_107(bool bParam0) //Position: 0x4190 / 16784
{
