...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(6, &uLocal_9, &uLocal_11, &uLocal_3, &uLocal_13, 4294967295);
	return;
}
...
{
	Function_96(&uLocal_3, "$/content/scripting/gringo/simplegringo/smoking_stand_nospawn", 1, 0);
	if (Function_77(&uLocal_9, &uLocal_3, 36, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_75(&uLocal_15, "mexarmy05mobile", &iParam1))
		{
			uLocal_11 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_15, Function_132()));
			*(&Global_6667[3628] + 216) = &uLocal_11;
...
void Function_72() //Position: 0x3AC7 / 15047
{
	struct<2> Var0;
	var uVar2;
	
	uLocal_13 = CREATE_LAYOUT("mexarmy05campfirelayout");
	Var0 = Vector(-4362,943f, 39,488f, 4350,005f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_9, Var0, 157,073f, 1, 1, 1);
	uVar2 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_13, "mexarmy05smoking", "smoking_stand_nospawn", Vector(-4362,63f, 39,624f, 4349,441f), Vector(0.0f, 140.0f, 0.0f));
...
void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3BB2 / 15282
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x3D6F / 15727
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x3DB7 / 15799
{
...
void Function_76(var uParam0, bool bParam1) //Position: 0x3DE7 / 15847
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3E32 / 15922
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_78(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4012 / 16402
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_79(var uParam0, bool bParam1) //Position: 0x4552 / 17746
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_80(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4574 / 17780
{
	var uVar0;
...
var Function_81(bool bParam0, int iParam1) //Position: 0x45D5 / 17877
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_82(var uParam0, int iParam1) //Position: 0x4663 / 18019
{
	Function_84(&uParam0);
	Function_83(&uParam0);
...
void Function_83(int iParam0) //Position: 0x468F / 18063
{
...
void Function_84(int iParam0) //Position: 0x46B5 / 18101
{
...
bool Function_85(bool bParam0) //Position: 0x478B / 18315
{
...
var Function_86(int iParam0, int iParam1) //Position: 0x47A2 / 18338
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_87(int iParam0, bool bParam1, bool bParam2) //Position: 0x4848 / 18504
{
	var uVar0;
	var uVar1;
...
void Function_88(var uParam0) //Position: 0x4957 / 18775
{
	int iVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x498A / 18826
{
	int iVar0;
...
bool Function_90(int iParam0, struct<2> Param1, float fParam3) //Position: 0x49A7 / 18855
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_91() //Position: 0x4A33 / 18995
{
	var uVar0;
	int iVar1;
...
bool Function_92(int iParam0) //Position: 0x4AA3 / 19107
{
...
bool Function_93(int iParam0) //Position: 0x4ABF / 19135
{
...
var Function_94(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4AD5 / 19157
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_95(struct<205> Param0) //Position: 0x4B7B / 19323
{
	var uVar0;
	var uVar1;
...
var Function_96(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4C86 / 19590
{
	int iVar0;
	int iVar1;
...
void Function_97(struct<13> Param0) //Position: 0x4CC4 / 19652
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_98(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4CD7 / 19671
{
	int iVar0;
...
bool Function_99(struct<2>[] Param0) //Position: 0x4DA6 / 19878
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x5168 / 20840
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x51A8 / 20904
{
	int iVar0;
...
void Function_102() //Position: 0x51D6 / 20950
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x5218 / 21016
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x52B0 / 21168
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x52DF / 21215
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x533A / 21306
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x534A / 21322
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x535E / 21342
{
	int iVar0;
...
var Function_109() //Position: 0x5383 / 21379
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x539A / 21402
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x54D6 / 21718
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x54E8 / 21736
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x54FA / 21754
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x550C / 21772
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x5531 / 21809
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x5550 / 21840
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x555C / 21852
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x5567 / 21863
{
	int iVar0;
...
var Function_119() //Position: 0x5595 / 21909
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x55AA / 21930
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x56B7 / 22199
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x56CB / 22219
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x5737 / 22327
{
	char* cVar0[32];
...
var Function_124() //Position: 0x5759 / 22361
{
	return "PBox_";
}

var Function_125() //Position: 0x5767 / 22375
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x578D / 22413
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x57B5 / 22453
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x57DB / 22491
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5945 / 22853
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x59ED / 23021
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x5B5B / 23387
{
...
var Function_132() //Position: 0x5BC3 / 23491
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5BCC / 23500
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5BEA / 23530
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5EE3 / 24291
{
	int iVar0;
...
void Function_136() //Position: 0x5F97 / 24471
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5FD2 / 24530
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x5FFF / 24575
{
	bool bVar0;
...
void Function_139() //Position: 0x615A / 24922
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x61A6 / 24998
{
	int iVar0;
...
int Function_141() //Position: 0x6282 / 25218
{
	int iVar0;
...
int Function_142() //Position: 0x63DE / 25566
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x64FE / 25854
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x65DA / 26074
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x65F9 / 26105
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x673C / 26428
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x675E / 26462
{
	int iVar0;
...
int Function_148() //Position: 0x677A / 26490
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x6781 / 26497
{
	var uVar0;
