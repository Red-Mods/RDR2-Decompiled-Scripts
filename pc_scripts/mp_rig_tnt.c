...
void main() //Position: 0x0 / 0
{
	...
	iLocal_117 = 0;
	Function_105(&uScriptParam_0, &iLocal_117);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_98(&(vLocal_7[iVar39]), &bVar4))
						{
							Function_96(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_7[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_91("eGRINGO_EndUse: Stop use by request", &vLocal_7[iVar39] + 24);
							Function_90(&vLocal_7[iVar39] + 24, 1);
							...
							{
								Function_83(&(vLocal_7[iVar39]), 0);
							}
							else if (vLocal_7[iVar39].f_68 < 8)
							{
								Function_82(&(vLocal_7[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADD / 2781
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_81(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
bool Function_27(bool bParam0) //Position: 0x1FD2 / 8146
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x1FF2 / 8178
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x1FF8 / 8184
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x200A / 8202
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2017 / 8215
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2032 / 8242
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2052 / 8274
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2072 / 8306
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20A9 / 8361
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20C9 / 8393
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x20E4 / 8420
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x20FA / 8442
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x241E / 9246
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2427 / 9255
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2446 / 9286
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2455 / 9301
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2479 / 9337
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x249F / 9375
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24BD / 9405
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24DF / 9439
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2501 / 9473
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25C9 / 9673
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2645 / 9797
{
...
void Function_50(vector3 vParam0) //Position: 0x265D / 9821
{
...
var Function_51(int iParam0) //Position: 0x2682 / 9858
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26A3 / 9891
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26BA / 9914
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26C6 / 9926
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26CD / 9933
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26DE / 9950
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2723 / 10019
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x274F / 10063
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x275B / 10075
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x285D / 10333
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2880 / 10368
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x28A8 / 10408
{
	struct<8> Var0;
	struct<25> Var8;
	...
	if (!iLocal_0)
	{
		...
		{
			bLocal_3 = Function_66(&uLocal_1, 0, &Var8, 1, 0, 1);
		}
		else
		{
			bLocal_3 = Function_63(&uLocal_1, 0, &Var8, 1, 0, 1);
		}
	}
	return;
}

var Function_63(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2931 / 10545
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "MP_Rig_TNT_CASE1", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x29BE / 10686
{
	var uVar0;
...
void Function_65(float fParam0, struct<25> Param1) //Position: 0x29EE / 10734
{
	struct<2> Var0;
	...
	Var0 = Vector(1,321045f, 1,491829f, 0,49707f);
	...
	Var0 = Vector(0,714006f, 0,355672f, 0,603069f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
...
var Function_66(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x2AB3 / 10931
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "MP_Rig_TNT", 1, 1);
	}
...
void Function_67(Vector3 vParam0, var uParam1) //Position: 0x2B3A / 11066
{
	var uVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&vParam0, 0, 1000.0f, 0);
	return;
}

void Function_68(float fParam0, struct<25> Param1) //Position: 0x2B6A / 11114
{
	struct<2> Var0;
...
struct<32> Function_69(char* cParam0) //Position: 0x2C2F / 11311
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_70(char* cParam0) //Position: 0x2C9B / 11419
{
	char* cVar0[32];
...
void Function_71(int iParam0) //Position: 0x2CBD / 11453
{
	iParam0 = &iParam0;
	return;
}

bool Function_72(int iParam0) //Position: 0x2CC9 / 11465
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_73(int iParam0) //Position: 0x2CE8 / 11496
{
	if (!Function_14(&iParam0))
	{
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CFF / 11519
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	...
	{
		return Function_78(&uParam0, &iParam1);
	}
	uVar3 = Function_77(&iParam1);
	uVar4 = Function_57(&iParam1);
	Function_75(&iParam1);
	iVar5 = Function_75(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, bVar2, uVar4, 0, 0);
}

struct<8> Function_75(int iParam0) //Position: 0x2D90 / 11664
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_76(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_76(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_76(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DB4 / 11700
{
	struct<2> Var0;
...
int Function_77(int iParam0) //Position: 0x2DD3 / 11731
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_78(var uParam0, int iParam1) //Position: 0x2DF7 / 11767
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2F1F / 12063
{
...
int Function_80(var uParam0) //Position: 0x2F4D / 12109
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_81(var uParam0, int iParam1) //Position: 0x3066 / 12390
{
	return (uParam0 && iParam1) == 0;
}

void Function_82(struct<69> Param0) //Position: 0x3073 / 12403
{
	if (Function_81(Param0.f_64, 16))
	{
...
void Function_83(struct<69> Param0) //Position: 0x30F5 / 12533
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_84() //Position: 0x36A0 / 13984
{
	int iVar0;
...
int Function_85(int iParam0) //Position: 0x36DA / 14042
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_86(int iParam0, var uParam1) //Position: 0x36F8 / 14072
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_87(int iParam0) //Position: 0x3739 / 14137
{
	iParam0 = &iParam0;
	return;
}

bool Function_88(int iParam0) //Position: 0x3745 / 14149
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_89(int iParam0, int iParam1) //Position: 0x3767 / 14183
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_LAYOUTREF_VALID(&uLocal_1))
	{
		DESTROY_LAYOUT(&uLocal_1);
	}
	iLocal_0 = 0;
	return;
}

void Function_90(var uParam0, bool bParam1) //Position: 0x378B / 14219
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_91(int iParam0, int iParam1) //Position: 0x389B / 14491
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_92(struct<69> Param0) //Position: 0x38B3 / 14515
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_93(int iParam0, int iParam1) //Position: 0x3BCF / 15311
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_94(int iParam0) //Position: 0x3BE1 / 15329
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_95(int iParam0) //Position: 0x3BFB / 15355
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_96(int iParam0, var uParam1) //Position: 0x3C16 / 15382
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_97(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_97(var uParam0, int iParam1) //Position: 0x3C54 / 15444
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_98(struct<65> Param0) //Position: 0x3C6D / 15469
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_99(int iParam0) //Position: 0x3F65 / 16229
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x3F83 / 16259
{
	struct<5> Var0;
	float fVar5;
...
int Function_101(int iParam0) //Position: 0x4025 / 16421
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_102(int iParam0, var uParam1) //Position: 0x4045 / 16453
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_103(int iParam0) //Position: 0x4058 / 16472
{
...
void Function_104(int iParam0) //Position: 0x4074 / 16500
{
	iParam0 = &iParam0;
	return;
}

void Function_105(var uParam0, int iParam1) //Position: 0x4080 / 16512
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_106(&(vLocal_7[iLocal_1179]), &uParam0);
		iLocal_117++;
	}
...
void Function_106(int iParam0, int iParam1) //Position: 0x40EC / 16620
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_107(int iParam0) //Position: 0x4104 / 16644
{
	iParam0 = &iParam0;
	return;
}

void Function_108(int iParam0) //Position: 0x4110 / 16656
{
