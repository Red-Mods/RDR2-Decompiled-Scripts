...
void Function_29(var uParam0, bool bParam1) //Position: 0x1FF5 / 8181
{
	...
	{
		iLocal_0 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, GRINGO_GET_MY_OBJECT_REF(), 4294967295);
	}
	return;
}
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BA0 / 11168
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BFD / 11261
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C5A / 11354
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C66 / 11366
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C85 / 11397
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2C9C / 11420
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D2D / 11565
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D51 / 11601
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D70 / 11632
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D94 / 11668
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EBC / 11964
{
...
int Function_74(var uParam0) //Position: 0x2EEA / 12010
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3003 / 12291
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3010 / 12304
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3092 / 12434
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x363D / 13885
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3677 / 13943
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3695 / 13973
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36D6 / 14038
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36E2 / 14050
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3704 / 14084
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	if (IS_ATTACHMENT_VALID(&iLocal_0))
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3725 / 14117
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3835 / 14389
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x384D / 14413
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B69 / 15209
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3B7B / 15227
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3B95 / 15253
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3BB0 / 15280
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3BEE / 15342
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C07 / 15367
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3EFF / 16127
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F1D / 16157
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3FBD / 16317
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3FDD / 16349
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FF0 / 16368
{
...
void Function_98(int iParam0) //Position: 0x400D / 16397
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4019 / 16409
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4085 / 16517
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x409D / 16541
{
	iParam0 = &iParam0;
	return;
}

void Function_102(bool bParam0) //Position: 0x40A9 / 16553
{
