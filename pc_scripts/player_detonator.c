...
void main() //Position: 0x0 / 0
{
	...
	iLocal_117 = 0;
	Function_99(&uScriptParam_0, &iLocal_117);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_7[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_7[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_7[iVar39] + 24);
							Function_84(&vLocal_7[iVar39] + 24, 1);
							...
							{
								Function_77(&(vLocal_7[iVar39]), 0);
							}
							else if (vLocal_7[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_7[iVar39]));
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_126))
								{
									...
									{
										bLocal_126 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_126 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_26(int iParam0, int iParam1) //Position: 0x1FBA / 8122
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		if (!DECOR_CHECK_EXIST(&iParam0, "NumTNT"))
		{
			if (IS_ACTION_NODE_PLAYING(&iParam0, "dynamite/Detonator/idle_high"))
			{
				if (!IS_SCRIPT_USE_CONTEXT_VALID(&uLocal_2))
				{
					uLocal_4 = ADD_SCRIPT_USE_CONTEXT("Quit_Detonator", 50, "@DETONATOR.LEAVE", false, 0, 0, 0, 4294967295, 0);
					uLocal_2 = ADD_SCRIPT_USE_CONTEXT("Push_Detonator", 50, "@DETONATOR.DETONATE", false, 0, 0, 0, 4294967295, 0);
				}
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_2))
				{
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_2);
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_4);
					if (IS_ACTION_NODE_PLAYING(&iParam0, "dynamite/Detonator/idle_high"))
					{
						SET_ACTION_NODE_FOR_ACTOR(&iParam0, "dynamite/Detonator/Down");
					}
					DECOR_SET_INT(&iParam0, "UsedDetonator", true);
				}
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_4))
				{
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_2);
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_4);
					return 0;
		...
		if (bLocal_6 <= DECOR_GET_INT(&iParam0, "NumTNT"))
		{
			if (IS_ACTION_NODE_PLAYING_PARTIAL(&iParam0, "dynamite/Detonator/idle_high") && DECOR_CHECK_EXIST(&iParam0, "wagoncutfinished"))
			{
				if (!UI_ISACTIVE("Rebel04_Detonator"))
				{
					UI_ENTER("Rebel04_Detonator");
					SET_AUTO_CONVERSATION_LOOK(&Global_54076, 0);
				}
				else if (UNK_0x973F30EE("@DETONATOR.DETONATE", 1, 0))
				{
					SET_ACTION_NODE_FOR_ACTOR(&iParam0, "dynamite/Detonator/Down");
					DECOR_SET_INT(&iParam0, "UsedDetonator", true);
					UI_EXIT("Rebel04_Detonator");
				}
				else if (UNK_0x973F30EE("@DETONATOR.LEAVE", 1, 0))
				{
...
bool Function_27(bool bParam0) //Position: 0x225D / 8797
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x227D / 8829
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x2283 / 8835
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2295 / 8853
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x22A2 / 8866
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x22BD / 8893
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x22DD / 8925
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x22FD / 8957
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2334 / 9012
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2354 / 9044
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x236F / 9071
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2385 / 9093
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x26A9 / 9897
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x26B2 / 9906
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x26D1 / 9937
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x26E0 / 9952
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2704 / 9988
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x272A / 10026
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2748 / 10056
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x276A / 10090
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x278C / 10124
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2854 / 10324
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x28D0 / 10448
{
...
void Function_50(vector3 vParam0) //Position: 0x28E8 / 10472
{
...
var Function_51(int iParam0) //Position: 0x290D / 10509
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x292E / 10542
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2945 / 10565
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2951 / 10577
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2958 / 10584
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2969 / 10601
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x29AE / 10670
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x29DA / 10714
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x29E6 / 10726
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2AE8 / 10984
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2B0B / 11019
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2B33 / 11059
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	if (!DECOR_CHECK_EXIST(GET_PLAYER_ACTOR(0), "NumTNT") && 1)
	{
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2E30 / 11824
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2E8D / 11917
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2EEA / 12010
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2EF6 / 12022
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2F15 / 12053
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2F2C / 12076
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2FBD / 12221
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2FE1 / 12257
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x3000 / 12288
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x3024 / 12324
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x314C / 12620
{
...
int Function_74(var uParam0) //Position: 0x317A / 12666
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3293 / 12947
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x32A0 / 12960
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3322 / 13090
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x38CD / 14541
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3907 / 14599
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3925 / 14629
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3966 / 14694
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3972 / 14706
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3994 / 14740
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	SET_AUTO_CONVERSATION_LOOK(&Global_54076, 1);
	...
	if (DECOR_CHECK_EXIST(&uParam0, "removepushdetonator"))
	{
		DECOR_REMOVE(&uParam0, "removepushdetonator");
	}
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x3A50 / 14928
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3B60 / 15200
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3B78 / 15224
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3E94 / 16020
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3EA6 / 16038
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3EC0 / 16064
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3EDB / 16091
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3F19 / 16153
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3F32 / 16178
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x422B / 16939
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x4249 / 16969
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x42E9 / 17129
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4309 / 17161
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x431C / 17180
{
...
void Function_98(int iParam0) //Position: 0x4338 / 17208
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4344 / 17220
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_7[iLocal_1179]), &uParam0);
		iLocal_117++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x43B0 / 17328
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x43C8 / 17352
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x43D4 / 17364
{
