...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_103(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_88(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_81(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_80(&(vLocal_2[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_52(&Param0 + 24, &Param0 + 16, Function_79(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_22(int iParam0, int iParam1) //Position: 0x1F65 / 8037
{
	...
	if (IS_ACTOR_VALID(&iParam0))
	{
		...
		{
			uVar1 = Function_9(&iParam1, "GiveSmallBrainScript", &bVar0);
			if (bVar0)
			{
				bVar2 = true;
				...
				if (bVar2)
				{
					...
					uVar3 = Function_25(&iParam1, "ChanceToGiveSmallBrain", 100);
...
bool Function_36(int iParam0, int iParam1) //Position: 0x2261 / 8801
{
...
bool Function_44(int iParam0, int iParam1) //Position: 0x2656 / 9814
{
...
bool Function_46(int iParam0, int iParam1) //Position: 0x2684 / 9860
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_47(int iParam0, int iParam1) //Position: 0x26A8 / 9896
{
...
void Function_51(int iParam0, int iParam1) //Position: 0x2730 / 10032
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_66(int iParam0) //Position: 0x2AD7 / 10967
{
	...
	{
		Function_106("Failed to create gringo camera");
	}
	return;
}
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2EBA / 11962
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_73(int iParam0) //Position: 0x2F4B / 12107
{
	struct<2> Var0;
...
struct<8> Function_74(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2F6F / 12143
{
	struct<2> Var0;
...
int Function_75(int iParam0) //Position: 0x2F8E / 12174
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(var uParam0, int iParam1) //Position: 0x2FB2 / 12210
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x30DA / 12506
{
...
int Function_78(var uParam0) //Position: 0x3108 / 12552
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x3221 / 12833
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(struct<69> Param0) //Position: 0x322E / 12846
{
	if (Function_79(Param0.f_64, 16))
	{
...
void Function_81(struct<69> Param0) //Position: 0x32B0 / 12976
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_79(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		...
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_79(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
...
void Function_82() //Position: 0x385B / 14427
{
	int iVar0;
...
int Function_83(int iParam0) //Position: 0x3895 / 14485
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_84(int iParam0, var uParam1) //Position: 0x38B3 / 14515
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_85(int iParam0) //Position: 0x38F4 / 14580
{
	iParam0 = &iParam0;
	return;
}

bool Function_86(int iParam0) //Position: 0x3900 / 14592
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_87(int iParam0, int iParam1) //Position: 0x3922 / 14626
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x3934 / 14644
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_89(int iParam0, int iParam1) //Position: 0x3A44 / 14916
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_90(struct<69> Param0) //Position: 0x3A5C / 14940
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_91(int iParam0, int iParam1) //Position: 0x3D78 / 15736
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_92(int iParam0) //Position: 0x3D8A / 15754
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_93(int iParam0) //Position: 0x3DA4 / 15780
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, var uParam1) //Position: 0x3DBF / 15807
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3DFD / 15869
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_96(struct<65> Param0) //Position: 0x3E16 / 15894
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_97(int iParam0) //Position: 0x410F / 16655
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x412D / 16685
{
	struct<5> Var0;
	float fVar5;
...
int Function_99(int iParam0) //Position: 0x41CD / 16845
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(int iParam0, var uParam1) //Position: 0x41ED / 16877
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x4200 / 16896
{
...
void Function_102(int iParam0) //Position: 0x421C / 16924
{
	iParam0 = &iParam0;
	return;
}

void Function_103(var uParam0, int iParam1) //Position: 0x4228 / 16936
{
	int iVar0;
	var uVar1;
	...
	{
		Function_104(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x4294 / 17044
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_105(int iParam0) //Position: 0x42AC / 17068
{
	iParam0 = &iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x42B8 / 17080
{
