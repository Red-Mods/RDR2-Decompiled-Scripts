...
bool Function_15() //Position: 0x411 / 1041
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_24(Global_46850[0], &Local_195 + 4, GET_PLAYER_ACTOR(0)))
			{
				Function_23(Global_46850[0]);
				(&Local_195 + 60) = Function_23(Global_46850[0]);
				Local_195.f_72 = Function_22(Global_46850[0]);
				Function_21(&Local_195 + 4);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					Function_20(Global_46850[0], iVar0);
					*(&Local_195 + 84[iVar02]) = Function_20(Global_46850[0], iVar0);
					iVar0++;
				}
