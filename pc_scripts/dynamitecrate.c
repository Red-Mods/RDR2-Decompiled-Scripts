...
void main() //Position: 0x0 / 0
{
	...
	iLocal_26 = 0;
	Function_100(&uScriptParam_0, &iLocal_26);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_27);
		}
		iVar2 = 0;
		bLocal_34 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(vLocal_6[iVar39]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_6[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", &vLocal_6[iVar39] + 24);
							Function_85(&vLocal_6[iVar39] + 24, 1);
							...
							{
								Function_78(&(vLocal_6[iVar39]), 0);
							}
							else if (vLocal_6[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_6[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_35))
	{
		Function_103("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_35);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_26 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_35))
								{
									...
									{
										iLocal_35 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_35 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_35))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_35))
		{
			Function_103("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_35);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_32, &uLocal_30);
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_76(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	{
		iLocal_1 = 1;
		uLocal_2 = CREATE_LAYOUT("TakeTNT_Layout");
		Function_63(&uLocal_2, 0, &Global_54076, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28E3 / 10467
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "DynamiteCrate", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x296D / 10605
{
	var uVar0;
	int iVar1;
...
void Function_65(int iParam0, var uParam1) //Position: 0x29AC / 10668
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(1,425441f, 1,084938f, -2,043603f), Vector(-5,617736f, 137,7865f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &uParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(-0,290142f, 0,833778f, -0,152415f), Vector(0.0f, 0.0f, 0.0f), 1);
...
struct<8> Function_70(int iParam0) //Position: 0x2B1C / 11036
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B40 / 11072
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2B5F / 11103
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2B83 / 11139
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CAB / 11435
{
...
int Function_75(var uParam0) //Position: 0x2CD9 / 11481
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2DF2 / 11762
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2DFF / 11775
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2E81 / 11905
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_32)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_30));
		iLocal_32 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_79() //Position: 0x342C / 13356
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x3466 / 13414
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x3484 / 13444
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x34C5 / 13509
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x34D1 / 13521
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x34F3 / 13555
{
	float fVar0;
	
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0) || !IS_ACTOR_PLAYER(&uParam0))
	{
		fVar0 = 8.0f;
		fVar0 = (8.0f - _GET_AMMO_AMOUNT(&uParam0, 5, 0));
		if (ACTOR_HAS_WEAPON_IN_HAND(&uParam0, 24) || GET_WEAPON_EQUIPPED(&uParam0, 2) != 24)
		{
			fVar0 = (fVar0 - 1.0f);
		}
		_ADD_AMMO_OF_TYPE(&uParam0, 5, fVar0, 0, 1);
	}
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3569 / 13673
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x3679 / 13945
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x3691 / 13969
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x39AD / 14765
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_89(int iParam0) //Position: 0x39C5 / 14789
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x39DF / 14815
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x39FA / 14842
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3A38 / 14904
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3A51 / 14929
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3D49 / 15689
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3D67 / 15719
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3E07 / 15879
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3E27 / 15911
{
	int iVar0;
	...
	{
		iVar0 = ROUND(_GET_AMMO_AMOUNT(&uParam0, 5, 0));
		if (ACTOR_HAS_WEAPON_IN_HAND(&uParam0, 24) || GET_WEAPON_EQUIPPED(&uParam0, 2) != 24)
		{
			iVar0++;
		}
...
bool Function_98(int iParam0) //Position: 0x3E7B / 15995
{
...
void Function_99(int iParam0) //Position: 0x3E97 / 16023
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x3EA3 / 16035
{
	int iVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_6[iLocal_269]), &uParam0);
		iLocal_26++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3F0F / 16143
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x3F27 / 16167
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3F33 / 16179
{
