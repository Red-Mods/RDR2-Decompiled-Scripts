...
void main() //Position: 0x0 / 0
{
	...
	iLocal_118 = 0;
	Function_102(&uScriptParam_0, &iLocal_118);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_95(&(vLocal_8[iVar39]), &bVar4))
						{
							Function_93(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_8[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_88("eGRINGO_EndUse: Stop use by request", &vLocal_8[iVar39] + 24);
							Function_87(&vLocal_8[iVar39] + 24, 1);
							...
							{
								Function_80(&(vLocal_8[iVar39]), 0);
							}
							else if (vLocal_8[iVar39].f_68 < 8)
							{
								Function_79(&(vLocal_8[iVar39]));
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	if (iLocal_4 && !iLocal_5)
	{
		...
		bLocal_2 = Function_63(&uLocal_0, 0, &Global_54076, 1, 0, 0);
	}
	return;
}
...
var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28F0 / 10480
{
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "HandOverLetter", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x297B / 10619
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x29AB / 10667
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(-1,276597f, 2,046043f, -0,388184f), Vector(-22,68632f, -74,54433f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &iParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(0,349853f, 1,340582f, -0,837646f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

struct<32> Function_66(char* cParam0) //Position: 0x2A48 / 10824
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x2AB4 / 10932
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x2AD6 / 10966
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2AE2 / 10978
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2B01 / 11009
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B18 / 11032
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_72(int iParam0) //Position: 0x2BA9 / 11177
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BCD / 11213
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2BEC / 11244
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2C10 / 11280
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2D38 / 11576
{
...
int Function_77(var uParam0) //Position: 0x2D66 / 11622
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2E7F / 11903
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x2E8C / 11916
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x2F0E / 12046
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x34B9 / 13497
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x34F3 / 13555
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x3511 / 13585
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_84(int iParam0) //Position: 0x3552 / 13650
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x355E / 13662
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(int iParam0, int iParam1) //Position: 0x3580 / 13696
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	iLocal_5 = 0;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x35BC / 13756
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_88(int iParam0, int iParam1) //Position: 0x36CC / 14028
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_89(struct<69> Param0) //Position: 0x36E4 / 14052
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, int iParam1) //Position: 0x3A00 / 14848
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_91(int iParam0) //Position: 0x3A18 / 14872
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_92(int iParam0) //Position: 0x3A32 / 14898
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3A4D / 14925
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3A8B / 14987
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_95(struct<65> Param0) //Position: 0x3AA4 / 15012
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_96(int iParam0) //Position: 0x3D9C / 15772
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3DBA / 15802
{
	struct<5> Var0;
	float fVar5;
...
int Function_98(int iParam0) //Position: 0x3E5A / 15962
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(int iParam0, var uParam1) //Position: 0x3E7A / 15994
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_100(int iParam0) //Position: 0x3E8D / 16013
{
...
void Function_101(int iParam0) //Position: 0x3EA9 / 16041
{
	iParam0 = &iParam0;
	return;
}

void Function_102(var uParam0, int iParam1) //Position: 0x3EB5 / 16053
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_103(&(vLocal_8[iLocal_1189]), &uParam0);
		iLocal_118++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x3F21 / 16161
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_104(int iParam0) //Position: 0x3F39 / 16185
{
	iParam0 = &iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x3F45 / 16197
{
