...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_19 = Vector(-4330,585f, 23,214f, 2742,339f);
	uLocal_22 = Vector(-4326,726f, 23,306f, 2738,884f);
	iLocal_33 = 2;
	iLocal_34 = 4;
	fLocal_35 = 70.0f;
...
void Function_3() //Position: 0x25F / 607
{
	...
	Function_4(2, &uLocal_13, &iLocal_17, &uLocal_3, &uLocal_25, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x27B / 635
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6ED / 1773
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x721 / 1825
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA63 / 2659
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA96 / 2710
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAD9 / 2777
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAF3 / 2803
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB10 / 2832
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBD6 / 3030
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD9F / 3487
{
...
void Function_15(int iParam0) //Position: 0xDDC / 3548
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDF5 / 3573
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE02 / 3586
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xEF7 / 3831
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF5D / 3933
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFBF / 4031
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFF4 / 4084
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x120D / 4621
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1284 / 4740
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12F0 / 4848
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x1318 / 4888
{
...
void Function_26(struct<13> Param0) //Position: 0x1463 / 5219
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x1480 / 5248
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x149E / 5278
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_33 || bParam2) || Global_6611)
			{
				if (Function_150(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_149(&Param0 + 324, &fLocal_35, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_138(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_35, 20.0f, fLocal_35));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_71(StackVal, StackVal, &Param0 + 16, Function_138(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_57(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_36, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_56(&Param0 + 392, 1);
							Function_55(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_36 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_56(&Param0 + 392, 1);
								Function_55(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_54(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_50(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_50(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_49()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_48(&Param0 + 392, Function_49(), 4);
				Function_47(&Param0 + 392, Function_49());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_46(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_45(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_36(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_29(struct<62> Param0) //Position: 0x265D / 9821
{
	...
	if (IS_ACTOR_VALID(&uLocal_13))
	{
		if (Function_31(&Global_54076, &uLocal_13, 20.0f))
		{
			if (GET_TASK_STATUS(&uLocal_13, 66) != 1)
			{
				CLEAR_ACTOR_STAY_WITHIN_VOLUME(&uLocal_13);
				if (!IS_VOLUME_VALID(&uLocal_31))
				{
					uLocal_31 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_25, Function_138(), 2,802597E-45f, Vector(-4328,211f, 23,386f, 2741,336f), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
				}
				TASK_WANDER_IN_VOLUME(&uLocal_13, &uLocal_31, -1f);
				SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_13, &uLocal_31, 1, true);
			}
		}
		else if (!GET_TASK_STATUS(&uLocal_13, 57) == 1)
		{
			CLEAR_ACTOR_STAY_WITHIN_VOLUME(&uLocal_13);
			TASK_WANDER_IN_VOLUME(&uLocal_13, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), -1f);
			SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_13, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), 1, true);
		}
		if ((Function_31(&uLocal_13, &Global_54076, 15.0f) && (GET_CURRENT_GAME_TIME() - fLocal_29) < 60.0f) && MEMORY_GET_IS_VISIBLE(&uLocal_13, &Global_54076))
		{
			if (Function_30() && !bLocal_30)
			{
				SAY_SINGLE_LINE_CONTEXT(&uLocal_13, 43, &Global_54076, 1, 0, 0, 4294967295, 4294967295, 0, 1);
			}
			else
			{
				SAY_SINGLE_LINE_STRING_SCRIPTED_INTERRUPT(&uLocal_13, "POST_FIGHT_GRATITUDE", "POST_FIGHT_GRATITUDE", 0, 1, 1, 3, 1, 0, 0, 1000, 0, 0);
			}
...
bool Function_30() //Position: 0x27F2 / 10226
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

bool Function_31(var uParam0, var uParam1, float fParam2) //Position: 0x2805 / 10245
{
	float fVar0;
...
var Function_32(var uParam0, int iParam1) //Position: 0x2824 / 10276
{
	var uVar0;
	int iVar2;
	int iVar4;
...
float Function_33(struct<2> Param0) //Position: 0x2845 / 10309
{
	struct<2> Var0;
	bool bVar2;
...
void Function_34(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2864 / 10340
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2A9D / 10909
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_36(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2ABD / 10941
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(&uVar1))
				{
					Function_37(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_37(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_37(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2BAB / 11179
{
	char* cVar0[32];
	...
	Function_42(&uParam0, 0);
	Function_41(&uParam0, iParam1);
	Function_40(&uParam0, &uParam2);
	Function_39(&uParam0, uParam3);
	if (Function_38(&uParam0) != 5)
	{
...
int Function_38(int iParam0) //Position: 0x2E17 / 11799
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2E3B / 11835
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_40(var uParam0, int iParam1) //Position: 0x2E5F / 11871
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_41(var uParam0, bool bParam1) //Position: 0x2E85 / 11909
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2EAC / 11948
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_43(bool bParam0) //Position: 0x2ED0 / 11984
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_44() //Position: 0x2EEF / 12015
{
...
bool Function_45(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2F3E / 12094
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_35(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_46(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F9A / 12186
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_47(var uParam0, int iParam1) //Position: 0x2FBB / 12219
{
	bool bVar0;
	var uVar1;
...
void Function_48(var uParam0, var uParam1, bool bParam2) //Position: 0x3016 / 12310
{
	bool bVar0;
	var uVar1;
...
var Function_49() //Position: 0x3062 / 12386
{
...
void Function_50(struct<425> Param0) //Position: 0x3077 / 12407
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_53(&Param0 + 392))
	{
		return;
	}
	if (!Function_51(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_54(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_54(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_54(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_54(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_51(var uParam0, struct<2> Param1, float fParam3) //Position: 0x31CA / 12746
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_52(vector3 vParam0) //Position: 0x323F / 12863
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_53(var uParam0) //Position: 0x3257 / 12887
{
	bool bVar0;
	int iVar1;
...
var Function_54(bool bParam0) //Position: 0x32B5 / 12981
{
	bool bVar0;
	bool bVar1;
...
void Function_55(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3302 / 13058
{
	bool bVar0;
	var uVar1;
...
void Function_56(var uParam0, bool bParam1) //Position: 0x337B / 13179
{
	bool bVar0;
	var uVar1;
...
void Function_57(int iParam0) //Position: 0x33CA / 13258
{
	struct<21> Var0;
	
	bVar6 = Function_66(GET_ACTOR_ENUM(&iParam0), &Var0);
	if (bVar6)
	{
...
var Function_58(struct<25> Param0) //Position: 0x3489 / 13449
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_59(int iParam0) //Position: 0x3550 / 13648
{
...
bool Function_60(int iParam0) //Position: 0x3570 / 13680
{
...
bool Function_61(int iParam0) //Position: 0x3594 / 13716
{
...
bool Function_62(int iParam0) //Position: 0x35A9 / 13737
{
...
bool Function_63(int iParam0, bool bParam1) //Position: 0x35C0 / 13760
{
	int iVar0;
...
var Function_64(int iParam0) //Position: 0x35FE / 13822
{
...
bool Function_65(int iParam0) //Position: 0x3618 / 13848
{
...
int Function_66(int iParam0, struct<6> Param1) //Position: 0x362E / 13870
{
	int iVar0;
...
void Function_67(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3668 / 13928
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_68(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x374D / 14157
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_69(var uParam0, bool bParam1) //Position: 0x3904 / 14596
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_70(bool bParam0) //Position: 0x3929 / 14633
{
	var uVar0;
	int iVar1;
...
var Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3977 / 14711
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_72(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3ACE / 15054
{
	var uVar0[5];
	int iVar6;
...
int Function_73(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3B79 / 15225
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_74(int iParam0, int iParam1) //Position: 0x3C1F / 15391
{
	Function_146(&uLocal_3, 1202, 3, 0);
	Function_146(&uLocal_3, 1057, 3, 0);
	if (!IS_LAYOUTREF_VALID(&uLocal_25))
	{
		uLocal_25 = CREATE_LAYOUT("merchant04campfiregringo");
	}
	if (Function_85(&uLocal_13, &uLocal_3, 17, 0, 1, 1, 1, 0, 1, &uLocal_25, 0) && !WOULD_ACTOR_BE_VISIBLE(1202, &uLocal_22, 3212836864))
	{
		if (Function_83(&uLocal_27, "merchant04mobile", &iParam1))
		{
			iLocal_17 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_27, Function_138()));
			*(&Global_6667[1728] + 216) = &iLocal_17;
...
void Function_75() //Position: 0x3CD4 / 15572
{
	if (!Function_82(1202, &uLocal_15, &uLocal_25, DECOR_CHECK_EXIST(&uLocal_13, "bJustFinished03")))
	{
		uLocal_15 = Function_78(StackVal, StackVal, &uLocal_25, "mercant_coach", 1202, 976, Vector(-4326,726f, 23,306f, 2738,884f), Vector(0.0f, 333,806f, 0.0f), 1, 976, 976, 976, 4);
		fLocal_29 = (GET_CURRENT_GAME_TIME() - 60.0f);
		TELEPORT_ACTOR(&uLocal_13, &uLocal_19, 1, 1, 1);
		LOG_ERROR("creating new wagon!");
	}
	else
	{
		bLocal_30 = true;
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&uLocal_13, 43, 0);
		fLocal_29 = (GET_CURRENT_GAME_TIME() - 50.0f);
		LOG_ERROR("found old wagon!");
	}
	Function_76(&uLocal_15, &iLocal_17, 1, 1);
	MEMORY_PREFER_RIDING(&uLocal_13, false);
	MEMORY_PREFER_WALKING(&uLocal_13, 1);
	TASK_WANDER_IN_VOLUME(&uLocal_13, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), -1f);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_13, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), 1, true);
	AI_IGNORE_ACTOR(&uLocal_13);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_13, 1);
	Function_76(&uLocal_13, &iLocal_17, 1, 1);
	return;
}

void Function_76(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3E2D / 15917
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_77(&uParam0, &iParam1, 1))
	{
	...
	else if (IS_ACTOR_VEHICLE(&uParam0))
	{
		...
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(&uParam0))
		{
			...
			if (IS_ACTOR_VALID(&iVar1))
			{
				if (!Function_77(&iVar1, &iParam1, 1))
				{
...
bool Function_77(int iParam0, int iParam1, bool bParam2) //Position: 0x3FEA / 16362
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
var Function_78(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x4033 / 16435
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(&uVar0))
	{
		...
		while (iVar9 < (iVar10 - 1))
		{
			...
			uVar15 = "";
			if (Function_81(&(Global_46972[6]), 4, 23, 0) && uParam8)
			{
				bVar16 = Function_80(StackVal, &(Global_46972[6]), Param4, 4, 23, 0);
				if (Function_79(bVar16, &iVar1))
				{
					bVar16 = 976;
				}
				iVar1[iVar9] = bVar16;
...
bool Function_79(int iParam0, bool[] bParam1) //Position: 0x4286 / 17030
{
	int iVar0;
...
var Function_80(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x42BA / 17082
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_81(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x42D6 / 17110
{
...
bool Function_82(int iParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4302 / 17154
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_83(var uParam0, var uParam1, int iParam2) //Position: 0x442E / 17454
{
...
void Function_84(var uParam0, bool bParam1) //Position: 0x445E / 17502
{
	int iVar0;
...
int Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x44A9 / 17577
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_103(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_102(StackVal, (&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	{
		iVar1 = Function_102(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4688 / 18056
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x4BC8 / 19400
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_88(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4BEA / 19434
{
	var uVar0;
...
var Function_89(bool bParam0, int iParam1) //Position: 0x4C4B / 19531
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, int iParam1) //Position: 0x4CD9 / 19673
{
	Function_92(&uParam0);
	Function_91(&uParam0);
...
void Function_91(int iParam0) //Position: 0x4D05 / 19717
{
...
void Function_92(int iParam0) //Position: 0x4D2B / 19755
{
...
bool Function_93(bool bParam0) //Position: 0x4E01 / 19969
{
...
var Function_94(int iParam0, int iParam1) //Position: 0x4E18 / 19992
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x4EBE / 20158
{
	var uVar0;
	var uVar1;
...
void Function_96(var uParam0) //Position: 0x4FCD / 20429
{
	int iVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x5000 / 20480
{
	int iVar0;
...
bool Function_98(int iParam0, struct<2> Param1, float fParam3) //Position: 0x501D / 20509
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_99() //Position: 0x50A9 / 20649
{
	var uVar0;
	int iVar1;
...
bool Function_100(int iParam0) //Position: 0x5119 / 20761
{
...
bool Function_101(int iParam0) //Position: 0x5135 / 20789
{
...
var Function_102(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x514B / 20811
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_103(struct<205> Param0) //Position: 0x51F1 / 20977
{
	var uVar0;
	var uVar1;
...
bool Function_104(struct<2>[] Param0) //Position: 0x52FC / 21244
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x56BE / 22206
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x56FE / 22270
{
	int iVar0;
...
void Function_107(struct<13> Param0) //Position: 0x572C / 22316
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_108() //Position: 0x573F / 22335
{
	if (!Function_152(128))
	{
		return;
...
void Function_109(vector3 vParam0) //Position: 0x5781 / 22401
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5819 / 22553
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5848 / 22600
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x58A3 / 22691
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x58B3 / 22707
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x58C7 / 22727
{
	int iVar0;
...
var Function_115() //Position: 0x58EC / 22764
{
	return "PackedMetadata";
}

void Function_116(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5903 / 22787
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_117() //Position: 0x5A3F / 23103
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_118() //Position: 0x5A51 / 23121
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_119() //Position: 0x5A63 / 23139
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_120(var uParam0, struct<5> Param1) //Position: 0x5A75 / 23157
{
...
var Function_121(var uParam0, int iParam1, int iParam2) //Position: 0x5A9A / 23194
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x5AB9 / 23225
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_123() //Position: 0x5AC5 / 23237
{
	return Function_124(39);
}

int Function_124(int iParam0) //Position: 0x5AD0 / 23248
{
	int iVar0;
...
var Function_125() //Position: 0x5AFE / 23294
{
	return "PackedWeapon";
}

int Function_126(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5B13 / 23315
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_127() //Position: 0x5C20 / 23584
{
	return "MPItemGiver";
}

struct<32> Function_128(char* cParam0) //Position: 0x5C34 / 23604
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0) //Position: 0x5CA0 / 23712
{
	char* cVar0[32];
...
var Function_130() //Position: 0x5CC2 / 23746
{
	return "PBox_";
}

var Function_131() //Position: 0x5CD0 / 23760
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x5CF6 / 23798
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5D1E / 23838
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x5D44 / 23876
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5EAE / 24238
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5F56 / 24406
{
	int iVar0;
	struct<2> Var1;
...
void Function_137(int iParam0) //Position: 0x60C4 / 24772
{
...
var Function_138() //Position: 0x612C / 24876
{
	int iVar0;
...
var Function_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x6135 / 24885
{
	return Function_140(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_140(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6153 / 24915
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x644C / 25676
{
	int iVar0;
...
void Function_142() //Position: 0x6500 / 25856
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x653B / 25915
{
	int iVar0;
...
void Function_144(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6568 / 25960
{
	bool bVar0;
...
void Function_145() //Position: 0x66C3 / 26307
{
	int iVar0;
...
var Function_146(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x670F / 26383
{
	int iVar0;
...
int Function_147() //Position: 0x67EB / 26603
{
	int iVar0;
...
int Function_148() //Position: 0x6947 / 26951
{
	int iVar0;
...
bool Function_149(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6A67 / 27239
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
bool Function_150(struct<2> Param0, struct<5> Param2) //Position: 0x6B43 / 27459
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_151(int iParam0) //Position: 0x6C86 / 27782
{
	var uVar0;
...
bool Function_152(int iParam0) //Position: 0x6CA8 / 27816
{
	int iVar0;
...
int Function_153() //Position: 0x6CC4 / 27844
{
	return 0;
}

void Function_154(struct<321> Param0) //Position: 0x6CCB / 27851
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_155(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_155(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

var Function_155(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6D5D / 27997
{
	int iVar0;
