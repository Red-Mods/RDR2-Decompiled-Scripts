...
void main() //Position: 0x0 / 0
{
	...
	bLocal_348 = false;
	iLocal_349 = 0;
	Local_350 = Vector(727,384f, 78,353f, 1333,93f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			iLocal_326 = 1000;
			bLocal_348 = true;
			Function_192(&uLocal_340, "RandomCharMissions", 10, 0);
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000000:
						if (!Function_189(&(Global_99725[ScriptParam_043]), 62, 0, 1))
						{
							Function_188(&Global_99725[ScriptParam_043] + 228, 64);
							Function_186(&(Global_99725[ScriptParam_043]), 62, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_181(&uLocal_340) && IS_ACTOR_VALID(&uLocal_338))
						{
							if (IS_LAYOUTREF_VALID(&uLocal_346))
							{
								if (IS_ACTOR_VALID(&Global_99725[6143] + 312))
								{
									if (Function_180(&Global_99725[6143] + 312, &Global_54076) < 10.0f)
									{
										DESTROY_ACTOR(&Global_99725[6143] + 312);
									}
								}
								if (IS_GRINGO_VALID(&Global_99725[6143] + 320))
								{
									Function_188(&Global_99725[6143] + 228, 32);
									DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&Global_99725[6143] + 320));
								}
								Global_99725[ScriptParam_043].f_236 = 1;
								Function_179(&Global_99725[ScriptParam_043] + 228, 32768);
								Function_178(&uLocal_338, 4294967276);
								SET_ACTOR_INVULNERABILITY(&uLocal_338, false);
								Function_171(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
								iVar0 = 1;
							}
							else if (!IS_LAYOUTREF_VALID(FIND_NAMED_LAYOUT("Prohibitionist_layout")))
							{
								Function_169();
								uLocal_346 = &iLocal_357;
							}
							else
							{
								uLocal_346 = FIND_NAMED_LAYOUT("Prohibitionist_layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						else if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304) && Global_116927[ScriptParam_06] != 5)
							{
								...
								{
									if ((StackVal && FABS((StackVal - !Function_165(&Global_54076, 0, 1))) > 2.0f) && IS_SCRIPT_USE_CONTEXT_PRESSED(&Global_99725[ScriptParam_043] + 304))
									{
							...
							else if (((!IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304) && HAS_STRING_TABLE_LOADED("RandomCharMissions")) && IS_LAYOUTREF_VALID(&uLocal_346)) && !Function_165(&Global_54076, 0, 1))
							{
							...
							else if (Function_165(&Global_54076, 0, 1) && IS_SCRIPT_USE_CONTEXT_VALID(&Global_99725[ScriptParam_043] + 304))
							{
								RELEASE_SCRIPT_USE_CONTEXT(&Global_99725[ScriptParam_043] + 304);
							}
							if (IS_ACTOR_VALID(&uLocal_338) && (((IS_ACTOR_HOGTIED(&uLocal_338) || AI_IS_AGGROING(&uLocal_338, &Global_54076)) || AI_IS_HOSTILE_OR_ENEMY(&uLocal_338, &Global_54076)) || Function_164(&Global_54076, &uLocal_338, 1, 1, 0, 3212836864)))
							{
								...
								{
									Function_163(&Global_99725[ScriptParam_043] + 288);
								}
								if (IS_BLIP_VALID(&Global_99725[ScriptParam_043] + 272))
								{
									REMOVE_BLIP(&Global_99725[ScriptParam_043] + 272);
								}
								Function_179(&Global_99725[ScriptParam_043] + 228, 2048);
								Function_179(&Global_99725[ScriptParam_043] + 228, 512);
								iVar0 = 6;
							}
						}
						Function_171(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
					...
					case 0x00000004:
						if (Function_124("$/cutscene/RCM_11_CS03/RCM_11_CS03", &iLocal_326, 31434, 31406, 30364, 30357, 30101, 30064, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						Function_115(&uLocal_338, 2, &Global_54076, 2);
						Function_113("Prohibit3_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						iLocal_353 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
						bLocal_354 = false;
						while (bLocal_354 <= iLocal_353)
						{
							SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, bLocal_354), 4, 0);
							bLocal_354++;
						}
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Prohibit3_OBJ", 0, 3, false);
						Function_112(Global_99725[ScriptParam_043].f_224, 0);
						Function_188(&Global_99725[6143] + 228, 256);
						Global_116927[636].f_24 = 1;
						*(&Global_99725[6343] + 136) = GET_ASSET_ID("$/cutscene/RCM_11_CS04_b/RCM_11_CS04_b", 9);
						Function_107(Function_110(1, 1, 1, 0, 0), 1, 1);
						Function_8(62, 1, 1, 0);
						ACTOR_DATA_GRAVITY_LIMIT(0);
						Function_179(&Global_99725[ScriptParam_043] + 228, 128);
						TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
						iVar0 = 13;
						break;
					
					case 0x00000006:
						if (!IS_ACTOR_ALIVE(&uLocal_338))
						{
							Function_113("Prohibit3a_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							iLocal_353 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
							bLocal_354 = false;
							while (bLocal_354 <= iLocal_353)
							{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Prohibit3a_OBJ", 0, 3, false);
							Function_112(Global_99725[ScriptParam_043].f_224, 0);
							CUTSCENE_MANAGER_UNLOAD_CUTSCENE();
							Global_116927[636].f_24 = 2;
							*(&Global_99725[6343] + 136) = GET_ASSET_ID("$/cutscene/RCM_11_CS04_a/RCM_11_CS04_a", 9);
							Function_188(&Global_99725[6143] + 228, 256);
							Function_8(62, 1, 1, 0);
							(&Global_99725[6143] + 312) = "";
							iVar0 = 13;
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_179(&Global_99725[ScriptParam_043] + 228, 128);
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
	...
	Function_188(&Global_99725[ScriptParam_043] + 228, 2048);
	Function_188(&Global_99725[ScriptParam_043] + 228, 512);
	Function_188(&Global_99725[ScriptParam_043] + 228, 32768);
	if (IS_LAYOUTREF_VALID(&uLocal_346))
	{
		RELEASE_LAYOUT_OBJECTS(&uLocal_346);
		RELEASE_LAYOUT_REF(&uLocal_346);
	}
	if (bLocal_348)
	{
		Function_7();
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x828 / 2088
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x85A / 2138
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3(int iParam0) //Position: 0x877 / 2167
{
	int iVar0;
...
void Function_4(struct<2>[] Param0, int iParam1) //Position: 0x89F / 2207
{
...
void Function_5(struct<13> Param0) //Position: 0x9EA / 2538
{
	int iVar0;
...
bool Function_6(struct<13> Param0) //Position: 0xA07 / 2567
{
	int iVar0;
...
void Function_7() //Position: 0xA25 / 2597
{
	RELEASE_LAYOUT_REF(&iLocal_357);
	return;
}

void Function_8(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xA32 / 2610
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_188(&Global_99725[iParam043] + 228, 64);
...
void Function_9(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xFCA / 4042
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_10() //Position: 0x116B / 4459
{
	return;
}

void Function_11(var uParam0, int iParam1) //Position: 0x1171 / 4465
{
	if (Global_6624)
	{
		return;
...
void Function_12(bool bParam0) //Position: 0x11B0 / 4528
{
...
void Function_13() //Position: 0x1205 / 4613
{
	Function_41();
	Function_40();
	Function_40();
...
void Function_14() //Position: 0x1250 / 4688
{
...
void Function_15() //Position: 0x1356 / 4950
{
	float fVar0;
...
void Function_16() //Position: 0x1389 / 5001
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_17() //Position: 0x151C / 5404
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_18() //Position: 0x16D5 / 5845
{
	Function_19(&Global_42918, 1, 0);
	return;
}

void Function_19(struct<2317> Param0) //Position: 0x16E3 / 5859
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_20() //Position: 0x1900 / 6400
{
...
struct<8> Function_21(int iParam0) //Position: 0x1915 / 6421
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_22(int iParam0, bool bParam1, bool bParam2) //Position: 0x19BC / 6588
{
	int iVar0;
...
void Function_23(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x1C58 / 7256
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_24() //Position: 0x2296 / 8854
{
	int iVar0;
...
var Function_25(int iParam0) //Position: 0x229F / 8863
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_26(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x22B0 / 8880
{
	char* cVar0[32];
...
struct<32> Function_27(char* cParam0) //Position: 0x23A7 / 9127
{
	char* cVar0[32];
...
void Function_28(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x23C2 / 9154
{
	float fVar0;
...
var Function_29(int iParam0, int iParam1) //Position: 0x2429 / 9257
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_30(int iParam0, bool bParam1) //Position: 0x243B / 9275
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_31(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x244D / 9293
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_32(int iParam0) //Position: 0x2581 / 9601
{
	return Global_55480[iParam016].f_96;
}

float Function_33(int iParam0) //Position: 0x2590 / 9616
{
	if (!iParam0 != 4294967295)
	{
...
var Function_34(int iParam0) //Position: 0x25C9 / 9673
{
	if (iParam0 == 4294967295)
	{
...
void Function_35(int iParam0) //Position: 0x2606 / 9734
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_36(int iParam0, bool bParam1, bool bParam2) //Position: 0x27A0 / 10144
{
	int iVar0;
	int iVar1;
...
int Function_37(bool bParam0) //Position: 0x29E4 / 10724
{
...
struct<8> Function_38() //Position: 0x2A25 / 10789
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_39() //Position: 0x2AAE / 10926
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_40() //Position: 0x2B45 / 11077
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_41() //Position: 0x2BC4 / 11204
{
...
int Function_42(int iParam0, bool bParam1, int iParam2) //Position: 0x2C01 / 11265
{
	int iVar0;
	int iVar1;
...
void Function_43() //Position: 0x2E0D / 11789
{
	struct<2> Var0;
	var uVar2;
...
bool Function_44(char* cParam0) //Position: 0x2EC4 / 11972
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_45(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2EDC / 11996
{
	int iVar0;
...
struct<8> Function_46() //Position: 0x2FD4 / 12244
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_47(int iParam0) //Position: 0x2FDE / 12254
{
...
int Function_48(bool bParam0, bool bParam1) //Position: 0x2FF4 / 12276
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_49(struct<2> Param0, struct<2> Param2) //Position: 0x30C0 / 12480
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_50(float fParam0, int iParam1) //Position: 0x30DD / 12509
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_51(int iParam0) //Position: 0x3909 / 14601
{
	var uVar0;
...
bool Function_52(var uParam0, int iParam1) //Position: 0x3944 / 14660
{
	return (uParam0 && iParam1) == 0;
}

void Function_53(var uParam0, int iParam1) //Position: 0x3951 / 14673
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_54(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3960 / 14688
{
	uParam0 = &uParam0;
...
void Function_55(bool bParam0) //Position: 0x3A0F / 14863
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_52(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_179(&Global_99725[iVar143] + 228, 64);
...
void Function_56(struct<229> Param0) //Position: 0x3BC9 / 15305
{
	float fVar0;
	int iVar1;
...
void Function_57(struct<217> Param0) //Position: 0x3C99 / 15513
{
	float fVar0;
	var uVar1;
...
int Function_58(var uParam0, int iParam1) //Position: 0x3D57 / 15703
{
	int iVar0;
	var uVar1;
...
void Function_59(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3EC1 / 16065
{
	struct<8> Var0;
...
struct<32> Function_60(char* cParam0) //Position: 0x3F69 / 16233
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_61(char* cParam0) //Position: 0x3FD5 / 16341
{
	char* cVar0[32];
...
int Function_62(int iParam0) //Position: 0x3FF7 / 16375
{
	int iVar0;
	struct<2> Var1;
...
float Function_63(int iParam0, struct<2> Param1) //Position: 0x4166 / 16742
{
	struct<2> Var0;
...
struct<8> Function_64(int iParam0) //Position: 0x41DD / 16861
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x4249 / 16969
{
...
bool Function_66(int iParam0) //Position: 0x42B1 / 17073
{
...
void Function_67(struct<153> Param0) //Position: 0x42C7 / 17095
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_68(int iParam0) //Position: 0x4436 / 17462
{
...
var Function_69(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4462 / 17506
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_70(int iParam0) //Position: 0x4483 / 17539
{
...
bool Function_71(struct<249> Param0) //Position: 0x4498 / 17560
{
	...
	{
		Function_179(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_72(struct<265> Param0) //Position: 0x45C8 / 17864
{
	int iVar0;
...
bool Function_73(int iParam0) //Position: 0x4729 / 18217
{
...
bool Function_74(int iParam0) //Position: 0x474D / 18253
{
...
bool Function_75(int iParam0) //Position: 0x4762 / 18274
{
...
var Function_76(int iParam0) //Position: 0x4779 / 18297
{
...
bool Function_77(int iParam0) //Position: 0x4793 / 18323
{
...
bool Function_78(int iParam0) //Position: 0x47A9 / 18345
{
	return Global_116927[iParam06].f_16;
}

bool Function_79(var uParam0, int iParam1) //Position: 0x47B9 / 18361
{
	int iVar0;
...
bool Function_80(struct<237> Param0) //Position: 0x47D6 / 18390
{
	if (!Param0.f_236)
	{
		if (Function_106())
...
bool Function_81(int iParam0) //Position: 0x48A5 / 18597
{
...
bool Function_82(int iParam0) //Position: 0x4900 / 18688
{
	int iVar0;
...
bool Function_83(var uParam0, int iParam1) //Position: 0x491C / 18716
{
	int iVar0;
...
int Function_84(int iParam0) //Position: 0x4939 / 18745
{
...
bool Function_85(int iParam0) //Position: 0x494E / 18766
{
...
int Function_86(int iParam0) //Position: 0x4963 / 18787
{
...
void Function_87() //Position: 0x4978 / 18808
{
...
int Function_88(int iParam0, int iParam1) //Position: 0x49F8 / 18936
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_89(int iParam0, bool bParam1) //Position: 0x565B / 22107
{
	int iVar0;
...
int Function_90(int iParam0) //Position: 0x5699 / 22169
{
	int iVar0;
	int iVar1;
...
bool Function_91(int iParam0) //Position: 0x56E8 / 22248
{
...
int Function_92(int iParam0) //Position: 0x56FE / 22270
{
...
void Function_93() //Position: 0x5767 / 22375
{
...
bool Function_94(int iParam0) //Position: 0x578C / 22412
{
	if (!Function_91(iParam0))
	{
...
bool Function_95(int iParam0, int iParam1) //Position: 0x57DD / 22493
{
	int iVar0;
...
bool Function_96(int iParam0) //Position: 0x580A / 22538
{
	if (!Function_91(iParam0))
	{
...
void Function_97(bool bParam0) //Position: 0x585C / 22620
{
	int iVar0;
...
void Function_98() //Position: 0x5896 / 22678
{
	bool bVar0;
...
void Function_99(int iParam0) //Position: 0x58F4 / 22772
{
	PRINTSTRING("Day ");
...
void Function_100(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x593E / 22846
{
	bool bVar0;
	char* cVar1[16];
...
void Function_101(char* cParam0) //Position: 0x59B3 / 22963
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_102(int iParam0, var uParam1, int iParam2) //Position: 0x59ED / 23021
{
	var uVar0;
	char* cVar1[16];
...
int Function_103(char* cParam0) //Position: 0x5A69 / 23145
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_104(int iParam0) //Position: 0x5B0A / 23306
{
	int iVar0;
	int iVar1;
...
bool Function_105(int iParam0, int iParam1) //Position: 0x5B47 / 23367
{
...
bool Function_106() //Position: 0x5B5A / 23386
{
...
int Function_107(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5B75 / 23413
{
	bool bVar0;
	
	bVar0 = Function_37(0);
	if ((Function_37(0) + bParam0) >= 999999)
	{
	...
	UI_SET_MONEY("nMoneyText", "Dmoney_amount", Function_37(0));
	if (&bParam1)
	{
	...
	if (&bParam2)
	{
		if ((Function_37(597) + Function_37(450)) >= 10000)
		{
...
int Function_108(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5C47 / 23623
{
	int iVar0;
	int iVar1;
...
void Function_109(int iParam0) //Position: 0x5E6F / 24175
{
	switch (iParam0)
	{
		case 0x00000009:
...
var Function_110(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5F0D / 24333
{
	bool bVar0;
	...
	if (&bParam2)
	{
		bVar0 = (bVar0 * (0,75f + ((TO_FLOAT(Function_37(5)) / 100.0f) * 0,5f)));
	}
	if (&bParam3)
	{
		if (HAS_ITEM(Function_111(17), &Global_54076))
		{
			bVar0 = (bVar0 * 1,2f);
		}
	}
...
var Function_111(bool bParam0) //Position: 0x6014 / 24596
{
	int iVar0;
...
void Function_112(bool bParam0, bool bParam1) //Position: 0x6108 / 24840
{
	bool bVar0;
...
void Function_113(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x612D / 24877
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_114(int iParam0) //Position: 0x61C2 / 25026
{
	char* cVar0[16];
...
int Function_115(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x6201 / 25089
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				{
					Function_116(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_116(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_116(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x62EF / 25327
{
	char* cVar0[32];
...
int Function_117(int iParam0) //Position: 0x655B / 25947
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_118(var uParam0, bool bParam1) //Position: 0x657F / 25983
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_119(var uParam0, int iParam1) //Position: 0x65A3 / 26019
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_120(var uParam0, bool bParam1) //Position: 0x65C9 / 26057
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_121(var uParam0, bool bParam1) //Position: 0x65F0 / 26096
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_122(bool bParam0) //Position: 0x6614 / 26132
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_123() //Position: 0x6633 / 26163
{
...
bool Function_124(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6682 / 26242
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_125(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_125(var uParam0, int iParam1, struct<41> Param2) //Position: 0x673B / 26427
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		case 0x000003E8:
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_136())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_132(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_130(&Global_99170, &Global_10996);
...
void Function_126(var uParam0, bool bParam1) //Position: 0x6D9D / 28061
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_127() //Position: 0x6E6C / 28268
{
	int iVar0;
...
void Function_128() //Position: 0x6EE4 / 28388
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_129() //Position: 0x6F29 / 28457
{
...
void Function_130(var uParam0, int iParam1) //Position: 0x6F3B / 28475
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar2))
		{
			...
			if ((&iVar3 == &Global_54076 && !Function_131(&iVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(&iVar3))
			{
...
bool Function_131(int iParam0) //Position: 0x6FCD / 28621
{
	bool bVar0;
...
float Function_132(vector3 vParam0) //Position: 0x6FFE / 28670
{
...
bool Function_133(int iParam0) //Position: 0x70CB / 28875
{
	return Function_52(iParam0, 2);
}

bool Function_134(int iParam0) //Position: 0x70D9 / 28889
{
	return Function_52(iParam0, 1);
}

int Function_135(bool bParam0) //Position: 0x70E7 / 28903
{
	bool bVar0;
	var uVar1;
...
bool Function_136() //Position: 0x71AA / 29098
{
	bool bVar0;
	var uVar1;
...
void Function_137(int iParam0) //Position: 0x71E7 / 29159
{
	Function_138(&iParam0, 0.0f);
	return;
}

void Function_138(vector3 vParam0) //Position: 0x71F4 / 29172
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_179(&vParam0, 1);
	Function_188(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_139(struct<37> Param0) //Position: 0x7219 / 29209
{
	return Param0.f_36;
}

void Function_140(var uParam0, int iParam1) //Position: 0x7224 / 29220
{
	Function_141(&uParam0, &iParam1, 0);
	return;
}

void Function_141(var uParam0, bool bParam1, bool bParam2) //Position: 0x7234 / 29236
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_142(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x73AC / 29612
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_143() //Position: 0x73D6 / 29654
{
	var uVar0;
	var uVar1;
...
void Function_144() //Position: 0x7431 / 29745
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_145() //Position: 0x7570 / 30064
{
...
int Function_146() //Position: 0x7595 / 30101
{
	Function_147(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_355);
	return 1;
}

void Function_147(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x75B1 / 30129
{
	var uVar0;
	...
	Function_126(&uParam9, &bParam10);
}

void Function_148() //Position: 0x7680 / 30336
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_149() //Position: 0x7695 / 30357
{
	return 1;
}

int Function_150() //Position: 0x769C / 30364
{
	if (!iLocal_349)
	{
		Function_151(StackVal, Local_350, &uLocal_355);
		iLocal_349 = 1;
	}
	return 1;
}

void Function_151(vector3 vParam0) //Position: 0x76BA / 30394
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_152(float fParam0, float fParam1) //Position: 0x7863 / 30819
{
...
void Function_153() //Position: 0x7974 / 31092
{
...
void Function_154() //Position: 0x79A8 / 31144
{
...
int Function_155() //Position: 0x7AAE / 31406
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(737,029f, 78,306f, 1329,105f), 0, 0);
	return 1;
}

int Function_156() //Position: 0x7ACA / 31434
{
	uLocal_355 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_346, "tempcutscenevol", 2, *(&Global_99725[6243] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_159(0, 0, 1, 1, 0, 1, 1, &uLocal_355, 1, 1, 1, 1, 0x3f800000, 0);
	Function_157(StackVal, &uLocal_346, *(&Global_99725[6243] + 196), &uLocal_355, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_157(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7B43 / 31555
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_158(var uParam0, float fParam1) //Position: 0x7DE3 / 32227
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_159(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7E65 / 32357
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_162(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_24(), 2, Function_162(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_161()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_160(int iParam0) //Position: 0x8126 / 33062
{
	int iVar0;
...
var Function_161() //Position: 0x815A / 33114
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_162(int iParam0) //Position: 0x81E8 / 33256
{
	struct<2> Var0;
...
void Function_163(bool bParam0) //Position: 0x81FA / 33274
{
	var uVar0;
...
int Function_164(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8290 / 33424
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		return 0;
...
bool Function_165(int iParam0, bool bParam1, bool bParam2) //Position: 0x8396 / 33686
{
...
bool Function_166() //Position: 0x845A / 33882
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_167(int iParam0) //Position: 0x8471 / 33905
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_168(bool bParam0) //Position: 0x847D / 33917
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

void Function_169() //Position: 0x848C / 33932
{
	var uVar0;
	
	Function_170(4, 1);
	uVar0 = &uVar0;
	iLocal_357 = CREATE_LAYOUT("Prohibitionist_layout");
	return;
}

void Function_170(int iParam0, int iParam1) //Position: 0x84BC / 33980
{
	switch (&iParam1)
	{
		case 0x00000000:
...
int Function_171(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x8506 / 34054
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_173(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_172(&iParam0));
							}
						}
						...
						uVar6 = Function_173(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_172(struct<257> Param0) //Position: 0x8691 / 34449
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_172(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_173(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x86CD / 34509
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_176(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_177()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_176(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_177()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_176(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_174() //Position: 0x8935 / 35125
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_175(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_175(char* cParam0) //Position: 0x8989 / 35209
{
	char* cVar0[64];
...
bool Function_176(var uParam0, struct<2> Param1, float fParam3) //Position: 0x8AB2 / 35506
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_64(&uParam0);
...
int Function_177() //Position: 0x8B3E / 35646
{
	if (IS_PS3())
	{
		return 1;
...
void Function_178(var uParam0, bool bParam1) //Position: 0x8B4D / 35661
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_179(var uParam0, int iParam1) //Position: 0x8B6F / 35695
{
	uParam0 = (uParam0 || iParam1);
	return;
}

float Function_180(int iParam0, int iParam1) //Position: 0x8B80 / 35712
{
	struct<2> Var0;
	struct<2> Var2;
...
int Function_181(struct<2>[] Param0) //Position: 0x8C75 / 35957
{
	int iVar0;
	int iVar1;
...
void Function_182() //Position: 0x9037 / 36919
{
	if (!Function_82(128))
	{
		return;
...
bool Function_183() //Position: 0x9077 / 36983
{
	int iVar0;
...
void Function_184(struct<13> Param0) //Position: 0x90A5 / 37029
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_185() //Position: 0x90B8 / 37048
{
	if (!Function_82(128))
	{
		return;
...
void Function_186(struct<229> Param0) //Position: 0x90FA / 37114
{
	if (IS_BLIP_VALID(&Param0 + 272))
	{
		if (((!&bParam2 || Function_85(iParam1)) || Function_84(iParam1)) || iParam1 != &Param0 + 36)
		{
	...
	else if (&bParam2)
	{
		...
		if (!(Function_85(iParam1) || Function_84(iParam1)))
		{
...
void Function_187(struct<229> Param0) //Position: 0x92FD / 37629
{
	if (Function_52(Param0.f_228, 1))
	{
		STREAMING_EVICT_ACTOR(Param0.f_220, 4294967295);
		Function_188(&Param0 + 228, 1);
	}
	if (Function_52(Param0.f_228, 8))
	{
		REMOVE_STRING_TABLE("RandomCharMissions");
		Function_188(&Param0 + 228, 8);
	}
	if (Function_52(Param0.f_228, 2))
	{
		STREAMING_EVICT_GRINGO(&Param0 + 120);
		Function_188(&Param0 + 228, 2);
	}
	if (Function_52(Param0.f_228, 4))
	{
		STREAMING_EVICT_PROP(&Param0 + 128);
		Function_188(&Param0 + 228, 4);
	}
	return;
}

void Function_188(int iParam0, int iParam1) //Position: 0x938C / 37772
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_189(struct<265> Param0) //Position: 0x93A2 / 37794
{
	if (!Param0.f_260 != 0)
	{
		if (Function_79(&Param0 + 260, 4))
		...
		if (Function_79(&Param0 + 260, 8) && Global_6606)
		{
			if (!Function_191(Param0.f_252, 0))
			{
				return 0;
			}
		}
		...
		return Function_190(&Param0);
	}
	return 1;
}

int Function_190(struct<261> Param0) //Position: 0x946E / 37998
{
	if (!Param0.f_260 != 0)
	{
		switch (Global_99472)
...
bool Function_191(int iParam0, bool bParam1) //Position: 0x9529 / 38185
{
...
var Function_192(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x9560 / 38240
{
	int iVar0;
	var uVar1;
...
var Function_193(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x959E / 38302
{
	int iVar0;
