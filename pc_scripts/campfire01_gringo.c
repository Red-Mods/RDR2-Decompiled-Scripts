...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_116(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireSmall01x");
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 1, 1, "ped_wilderness", 2,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
...
void Function_1(struct<473> Param0) //Position: 0x157 / 343
{
	int iVar0;
...
void Function_2() //Position: 0x305 / 773
{
	return;
}

void Function_3() //Position: 0x30B / 779
{
	Function_4();
	return;
}

void Function_4() //Position: 0x314 / 788
{
...
void Function_5(int iParam0) //Position: 0x327 / 807
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x34F / 847
{
...
void Function_7(struct<13> Param0) //Position: 0x49A / 1178
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x4B7 / 1207
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4D5 / 1237
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_10(struct<62> Param0) //Position: 0x1694 / 5780
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x16A6 / 5798
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x18DF / 6367
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18FF / 6399
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x19ED / 6637
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C59 / 7257
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C7D / 7293
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1CA1 / 7329
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1CC7 / 7367
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1CEE / 7406
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1D12 / 7442
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1D31 / 7473
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D80 / 7552
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1DDC / 7644
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DFD / 7677
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E58 / 7768
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1EA4 / 7844
{
...
void Function_27(struct<425> Param0) //Position: 0x1EB9 / 7865
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x200C / 8204
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x2081 / 8321
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x20ED / 8429
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x2105 / 8453
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x2163 / 8547
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x21B0 / 8624
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x2229 / 8745
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x2278 / 8824
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x2441 / 9281
{
...
void Function_37(int iParam0) //Position: 0x247E / 9342
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2497 / 9367
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x24A4 / 9380
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x2599 / 9625
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x2658 / 9816
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x266B / 9835
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x2732 / 10034
{
...
bool Function_44(int iParam0) //Position: 0x2752 / 10066
{
...
bool Function_45(int iParam0) //Position: 0x2776 / 10102
{
...
bool Function_46(int iParam0) //Position: 0x278B / 10123
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x27A2 / 10146
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x27E0 / 10208
{
...
bool Function_49(int iParam0) //Position: 0x27FA / 10234
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x2810 / 10256
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x284A / 10314
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x292F / 10543
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2AE6 / 10982
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2B0B / 11019
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B59 / 11097
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2CB0 / 11440
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D5B / 11611
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2E01 / 11777
{
...
bool Function_59(var uParam0) //Position: 0x2E5A / 11866
{
	var uVar0;
...
void Function_60(int iParam0, int iParam1) //Position: 0x358D / 13709
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x35D8 / 13784
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x3616 / 13846
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x3629 / 13865
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x36F8 / 14072
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x3742 / 14146
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3B04 / 15108
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x3B44 / 15172
{
	int iVar0;
...
void Function_68() //Position: 0x3B72 / 15218
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3BB4 / 15284
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3C4C / 15436
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3C7B / 15483
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3CD6 / 15574
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3CE6 / 15590
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3CFA / 15610
{
	int iVar0;
...
var Function_75() //Position: 0x3D1F / 15647
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3D36 / 15670
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3E72 / 15986
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3E84 / 16004
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3E96 / 16022
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3EA8 / 16040
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3ECD / 16077
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3EEC / 16108
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3EF8 / 16120
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3F03 / 16131
{
	int iVar0;
...
var Function_85() //Position: 0x3F31 / 16177
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3F46 / 16198
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x4059 / 16473
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x406D / 16493
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x40D9 / 16601
{
	char* cVar0[32];
...
var Function_90() //Position: 0x40FB / 16635
{
	return "PBox_";
}

var Function_91() //Position: 0x4109 / 16649
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x412F / 16687
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x4157 / 16727
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x417D / 16765
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x42E7 / 17127
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x438F / 17295
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x44FD / 17661
{
...
var Function_98() //Position: 0x4565 / 17765
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x456E / 17774
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x458C / 17804
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x4885 / 18565
{
	int iVar0;
...
void Function_102() //Position: 0x4939 / 18745
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x49A1 / 18849
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4AFC / 19196
{
...
void Function_106() //Position: 0x4B13 / 19219
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4B5F / 19295
{
	int iVar0;
...
int Function_108() //Position: 0x4C3B / 19515
{
	int iVar0;
...
int Function_109() //Position: 0x4D97 / 19863
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4EB7 / 20151
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4F93 / 20371
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4FB2 / 20402
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x50F5 / 20725
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x516C / 20844
{
	var uVar0;
...
int Function_115() //Position: 0x518E / 20878
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x5195 / 20885
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x5227 / 21031
{
	int iVar0;
