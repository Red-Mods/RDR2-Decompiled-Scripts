...
float Function_25(int iParam0) //Position: 0x1581 / 5505
{
	if (iParam0 == 4294967295)
	{
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uParam0 = Function_74(&uParam0);
	if ((Function_70(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
	{
		iLocal_4 = 0;
	}
	cVar0 = GET_GRINGO_STRING_ATTR("nRegionMap", &uParam0, &uVar1);
	if (Function_69(&cVar0, "CHOLLA_SPRINGS_REGION"))
	{
		Function_63(Global_46736[0]);
		Function_59(&Global_46760);
		Function_57("discover_cholla", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "GAPTOOTH_RIDGE_REGION"))
	{
		Function_63(Global_46736[1]);
		Function_59(&Global_46796);
		Function_57("discover_gaptooth", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "HENNIGANS_STEAD_REGION"))
	{
		Function_63(Global_46736[2]);
		Function_59(&Global_46816);
		Function_57("discover_hennigans", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "RIO_BRAVO_REGION"))
	{
		Function_63(Global_46736[3]);
		Function_59(&Global_46838);
		Function_57("discover_riobravo", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "PUNTA_ORGULLO_REGION"))
	{
		Function_63(Global_46746[0]);
		Function_59(&Global_46850);
		Function_57("discover_orgullo", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "PERDIDO_REGION"))
	{
		Function_63(Global_46746[2]);
		Function_59(&Global_46866);
		Function_57("discover_perdido", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "DIEZ_CORONAS_REGION"))
	{
		Function_63(Global_46746[1]);
		Function_59(&Global_46894);
		Function_57("discover_diezcoronas", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "GREAT_PLAINS_REGION"))
	{
		Function_63(Global_46754[0]);
		Function_59(&Global_46914);
		Function_57("discover_greatplains", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else if (Function_69(&cVar0, "TALL_TREES_REGION"))
	{
		Function_63(Global_46754[1]);
		Function_59(&Global_46926);
		Function_57("discover_talltrees", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 1;
	}
	else
	{
	...
	DECOR_SET_BOOL(&Global_54076, "ItemSave", 1);
	return;
}

void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3093 / 12435
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x311E / 12574
{
	char* cVar0[16];
...
int Function_59(int[] iParam0) //Position: 0x315D / 12637
{
	int iVar0;
	...
	while (iVar0 <= iParam0)
	{
		if (!Function_60(iParam0[iVar0]))
		{
			Function_63(iParam0[iVar0]);
		}
		iVar0++;
	}
	return 1;
...
bool Function_60(int iParam0) //Position: 0x3191 / 12689
{
	if (!Function_62(iParam0))
	{
		return 0;
	}
	return Function_61(&(Global_43791[iParam0]), 4096);
}

bool Function_61(var uParam0, int iParam1) //Position: 0x31AF / 12719
{
	int iVar0;
...
void Function_63(int iParam0) //Position: 0x31E2 / 12770
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	if (Function_61(&(Global_43791[iParam0]), 4096))
	{
		return;
	}
	Function_68(&(Global_43791[iParam0]), 4096);
	if (StackVal != 1)
	{
		Function_66(473, 1, 0, 0);
		iVar0 = Function_65(iParam0);
		if (iVar0 == Global_46722[0])
		{
			Function_66(474, 1, 0, 0);
		}
		else if (iVar0 == Global_46722[1])
		{
			Function_66(475, 1, 0, 0);
		}
		else if (iVar0 == Global_46722[2])
		{
			Function_66(476, 1, 0, 0);
		}
	}
...
void Function_64(int iParam0, int iParam1) //Position: 0x32D3 / 13011
{
	bool bVar0;
...
var Function_65(int iParam0) //Position: 0x333D / 13117
{
	int iVar0;
...
int Function_66(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3395 / 13205
{
	int iVar0;
	int iVar1;
...
void Function_67(int iParam0) //Position: 0x35BD / 13757
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_68(var uParam0, int iParam1) //Position: 0x365B / 13915
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_69(char* cParam0) //Position: 0x366C / 13932
{
	char* cVar0[64];
	char* cVar16[64];
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3699 / 13977
{
...
bool Function_71() //Position: 0x375D / 14173
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_72(int iParam0) //Position: 0x3774 / 14196
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_73(int iParam0) //Position: 0x3780 / 14208
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_74(int iParam0) //Position: 0x378F / 14223
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_75(int iParam0, int iParam1) //Position: 0x37AA / 14250
{
	var uVar0;
	var uVar1;
