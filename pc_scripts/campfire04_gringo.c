...
void Function_1(struct<473> Param0) //Position: 0x142 / 322
{
	int iVar0;
...
void Function_2() //Position: 0x2F0 / 752
{
	return;
}

void Function_3() //Position: 0x2F6 / 758
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2FF / 767
{
...
void Function_5(int iParam0) //Position: 0x312 / 786
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x33A / 826
{
...
void Function_7(struct<13> Param0) //Position: 0x485 / 1157
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x4A2 / 1186
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4C0 / 1216
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_10(struct<62> Param0) //Position: 0x167F / 5759
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1691 / 5777
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x18CA / 6346
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18EA / 6378
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x19D8 / 6616
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C44 / 7236
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C68 / 7272
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C8C / 7308
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1CB2 / 7346
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1CD9 / 7385
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1CFD / 7421
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1D1C / 7452
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D6B / 7531
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1DC7 / 7623
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DE8 / 7656
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E43 / 7747
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E8F / 7823
{
...
void Function_27(struct<425> Param0) //Position: 0x1EA4 / 7844
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1FF7 / 8183
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x206C / 8300
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x20D8 / 8408
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x20F0 / 8432
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x214E / 8526
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x219B / 8603
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x2214 / 8724
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x2263 / 8803
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x242C / 9260
{
...
void Function_37(int iParam0) //Position: 0x2469 / 9321
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2482 / 9346
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x248F / 9359
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x2584 / 9604
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x2643 / 9795
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x2656 / 9814
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x271D / 10013
{
...
bool Function_44(int iParam0) //Position: 0x273D / 10045
{
...
bool Function_45(int iParam0) //Position: 0x2761 / 10081
{
...
bool Function_46(int iParam0) //Position: 0x2776 / 10102
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x278D / 10125
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x27CB / 10187
{
...
bool Function_49(int iParam0) //Position: 0x27E5 / 10213
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x27FB / 10235
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x2835 / 10293
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x291A / 10522
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2AD1 / 10961
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2AF6 / 10998
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B44 / 11076
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2C9B / 11419
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D46 / 11590
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DEC / 11756
{
...
bool Function_59(var uParam0) //Position: 0x2E45 / 11845
{
	var uVar0;
	...
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/stand_peeing_b_any", 1, 0);
	...
	*(&iLocal_0 + 128) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend", "horse_stay", Vector(-0,2137153f, 0.0f, -3,582657f), Vector(0.0f, 85,81294f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 128), 0);
	*(&iLocal_0 + 136) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "horse_stay", Vector(-3,226877f, 0,08612903f, -2,296662f), Vector(0.0f, -399,5245f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 136), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn", "Rand_Idle_Sit_Ground_nospawn", Vector(-2,082995f, 0,03732488f, 1,440351f), Vector(0.0f, -54,37279f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand_nospawn1", "Rand_Idle_Sit_Ground_nospawn", Vector(1,420548f, 0.0f, 0,7975557f), Vector(0.0f, 61,7462f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "smoking_stand_nospawn", "Sit_Ground_Campfire_Tend", Vector(0,9072577f, 0.0f, -0,7298713f), Vector(0.0f, 130,7249f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_drunk_rowdydrink", "Rand_Idle_Sit_Ground_nospawn", Vector(-1,730599f, 0.0f, -0,6577868f), Vector(0.0f, -114,4034f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_guntricks_e_any", "campfire_talk", Vector(-0,1049702f, 0.0f, 1,434903f), Vector(0.0f, 172,5073f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_peeing_b_any", "stand_peeing_b_any", Vector(0,1740932f, 0.0f, 3,848174f), Vector(0.0f, -164,8789f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 144) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType6", "Rand_Idle_Sit_Ground_Player", Vector(-0,5289611f, 0.0f, -1,464898f), Vector(0.0f, 197,1313f, 0.0f));
...
void Function_60(int iParam0, int iParam1) //Position: 0x33D1 / 13265
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x341C / 13340
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x345A / 13402
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x346D / 13421
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x353C / 13628
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x3586 / 13702
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3948 / 14664
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x3988 / 14728
{
	int iVar0;
...
void Function_68() //Position: 0x39B6 / 14774
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x39F8 / 14840
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3A90 / 14992
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3ABF / 15039
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3B1A / 15130
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3B2A / 15146
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3B3E / 15166
{
	int iVar0;
...
var Function_75() //Position: 0x3B63 / 15203
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3B7A / 15226
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3CB6 / 15542
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3CC8 / 15560
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3CDA / 15578
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3CEC / 15596
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3D11 / 15633
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3D30 / 15664
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3D3C / 15676
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3D47 / 15687
{
	int iVar0;
...
var Function_85() //Position: 0x3D75 / 15733
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3D8A / 15754
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3E97 / 16023
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3EAB / 16043
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x3F17 / 16151
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3F39 / 16185
{
	return "PBox_";
}

var Function_91() //Position: 0x3F47 / 16199
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3F6D / 16237
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3F95 / 16277
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3FBB / 16315
{
	int iVar0;
	var uVar1;
