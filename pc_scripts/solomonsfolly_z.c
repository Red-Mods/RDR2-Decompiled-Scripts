...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_308, Function_87(), bScriptParam_0);
				Function_47(&uLocal_334, 0);
				break;
	...
	if (bLocal_177)
	{
		Function_26(&iLocal_13, bScriptParam_0);
	}
	Function_21(bScriptParam_0);
	Function_19();
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_308);
	Function_8(&uLocal_334);
	Function_6();
...
void Function_21(bool bParam0) //Position: 0x88B / 2187
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	if (Function_218(&(Global_43791[bParam0]), 0x20000000))
	{
		...
		{
			ENABLE_AMBIENT_SPAWNING(Function_22(1));
		}
	}
	return;
}

bool Function_22(int iParam0) //Position: 0x945 / 2373
{
	int iVar0;
...
bool Function_23(bool bParam0) //Position: 0x961 / 2401
{
	var uVar0;
	...
	return (((Function_25(uVar0, 0x1000000) || Function_25(uVar0, 0x2000000)) || Function_25(uVar0, 0x4000000)) || Function_24(bParam0));
}

bool Function_24(int iParam0) //Position: 0x9D4 / 2516
{
	var uVar0;
	bool bVar1;
...
bool Function_25(var uParam0, bool bParam1) //Position: 0x9F1 / 2545
{
	return (uParam0 && bParam1) == 0;
}

void Function_26(int iParam0, int iParam1) //Position: 0x9FE / 2558
{
	HUD_CLEAR_HELP_QUEUE();
	if (!Function_5(iParam1) || Function_25(&iParam0 + 608, 16))
	{
		return;
	}
	if (iParam1 == Global_46760[0])
	{
		Function_29(&iParam0, &Global_11014, iParam1);
	}
	else if (iParam1 == Global_46760[1])
	{
		Function_29(&iParam0, &Global_11146, iParam1);
	}
	else if (iParam1 == Global_46760[2])
	{
		Function_29(&iParam0, &Global_11120, iParam1);
	}
	else if (iParam1 == Global_46796[1])
	{
		Function_29(&iParam0, &Global_11222, iParam1);
	}
	else if (iParam1 == Global_46796[3])
	{
		Function_29(&iParam0, &Global_11284, iParam1);
	}
	else if (iParam1 == Global_46796[4])
	{
		Function_29(&iParam0, &Global_11492, iParam1);
	}
	else if (iParam1 == Global_46816[0])
	{
		Function_29(&iParam0, &Global_11544, iParam1);
	}
	else if (iParam1 == Global_46816[1])
	{
		Function_29(&iParam0, &Global_11646, iParam1);
	}
	else if (iParam1 == Global_46816[2])
	{
		Function_29(&iParam0, &Global_11704, iParam1);
	}
	else if (iParam1 == Global_46838[1])
	{
		Function_29(&iParam0, &Global_11752, iParam1);
	}
	else if (iParam1 == Global_46838[0])
	{
		Function_29(&iParam0, &Global_11726, iParam1);
	}
	else if (iParam1 == Global_46850[0])
	{
		Function_29(&iParam0, &Global_11836, iParam1);
	}
	else if (iParam1 == Global_46850[1])
	{
		Function_29(&iParam0, &Global_11946, iParam1);
	}
	else if (iParam1 == Global_46850[2])
	{
		Function_29(&iParam0, &Global_11988, iParam1);
	}
	else if (iParam1 == Global_46866[0])
	{
		Function_29(&iParam0, &Global_12048, iParam1);
	}
	else if (iParam1 == Global_46866[1])
	{
		Function_29(&iParam0, &Global_12150, iParam1);
	}
	else if (iParam1 == Global_46866[2])
	{
		Function_29(&iParam0, &Global_11398, iParam1);
	}
	else if (iParam1 == Global_46894[2])
	{
		Function_29(&iParam0, &Global_12284, iParam1);
	}
	else if (iParam1 == Global_46894[1])
	{
		Function_29(&iParam0, &Global_12342, iParam1);
	}
	else if (iParam1 == Global_46894[0])
	{
		Function_29(&iParam0, &Global_12422, iParam1);
	}
	else if (iParam1 == Global_46894[3])
	{
		Function_29(&iParam0, &Global_12392, iParam1);
	}
	else if (iParam1 == Global_46926[0])
	{
		Function_29(&iParam0, &Global_12760, iParam1);
	}
	else if (iParam1 == Global_46926[1])
	{
		Function_29(&iParam0, &Global_12714, iParam1);
	}
	else if (iParam1 == Global_46926[2])
	{
		Function_29(&iParam0, &Global_12644, iParam1);
	}
	else if (iParam1 == Global_46914[0])
	{
		Function_29(&iParam0, &Global_12488, iParam1);
	}
	else if (iParam1 == Global_46914[1])
	{
		Function_29(&iParam0, &Global_12482, iParam1);
	}
...
void Function_27(int iParam0) //Position: 0xD65 / 3429
{
	var uVar0;
	
	if (Global_6623 || Function_22(0x8000000))
	{
		return;
	}
	uVar0 = Function_28(iParam0);
...
int Function_28(int iParam0) //Position: 0xDCC / 3532
{
	int iVar0;
...
void Function_29(vector3 vParam0) //Position: 0x1114 / 4372
{
	int iVar0;
	var uVar1;
	...
	else if (Function_25(&vParam0 + 608, 32))
	{
	...
	Function_33(&vParam0 + 384);
	AUDIO_SET_CURRENT_AREA_IS_UNDER_ZOMBIE_ATTACK(true);
	Function_30(iParam2, Function_23(iParam2));
	ENABLE_AMBIENT_SPAWNING(Function_22(1));
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x13F4 / 5108
{
	if (!Function_5(iParam0))
	{
		return;
	}
	if (bParam1 && Function_32("noZombieFireArt"))
	{
		return;
	}
...
bool Function_31(int iParam0) //Position: 0x1B4A / 6986
{
...
int Function_32(int iParam0) //Position: 0x1B5F / 7007
{
	var uVar0;
...
void Function_33(int iParam0) //Position: 0x1B81 / 7041
{
	int iVar0;
	...
	{
		Function_34(&iParam0, iVar0);
		iVar0++;
	}
	return;
}

void Function_34(struct<2>[] Param0, int iParam1) //Position: 0x1BA9 / 7081
{
	if (Function_36(&(Param0[iParam12]), 4))
	{
		if (Function_36(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_35(&(Param0[iParam12]), 1);
			Function_35(&(Param0[iParam12]), 2);
			Function_35(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_35(struct<13> Param0) //Position: 0x1CF4 / 7412
{
	int iVar0;
...
bool Function_36(struct<13> Param0) //Position: 0x1D11 / 7441
{
	int iVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D2F / 7471
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1DB8 / 7608
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1DD8 / 7640
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1E4D / 7757
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1E87 / 7815
{
	var uVar0;
	char* cVar1[16];
...
bool Function_45(var uParam0, int iParam1) //Position: 0x1FF7 / 8183
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x200A / 8202
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x2024 / 8228
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x2445 / 9285
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x2458 / 9304
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x2475 / 9333
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x2487 / 9351
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	uVar2 = Global_6629;
	Global_6629 = 0;
	if (!Function_22(32) || !IS_ACTOR_VALID(&uParam2))
	{
		return;
	}
	iVar0 = 0;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x2511 / 9489
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x2969 / 10601
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2A5A / 10842
{
...
float Function_55(int iParam0) //Position: 0x2A97 / 10903
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2AD0 / 10960
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2B3A / 11066
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2B92 / 11154
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2DBA / 11706
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2E58 / 11864
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x3496 / 13462
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x349F / 13471
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x34B0 / 13488
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x35A7 / 13735
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x35C2 / 13762
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3629 / 13865
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x363B / 13883
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x376F / 14191
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x377E / 14206
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3918 / 14616
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3B5C / 15196
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3B69 / 15209
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3B93 / 15251
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3E46 / 15942
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3EB9 / 16057
{
...
bool Function_76(bool bParam0) //Position: 0x3EEF / 16111
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3F65 / 16229
{
...
bool Function_78() //Position: 0x3F76 / 16246
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3F8F / 16271
{
...
bool Function_80(int iParam0) //Position: 0x3FA5 / 16293
{
...
bool Function_81(int iParam0) //Position: 0x3FBA / 16314
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3FD8 / 16344
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x4089 / 16521
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x409C / 16540
{
	int iVar0;
	bool bVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x4116 / 16662
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x413F / 16703
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x415F / 16735
{
...
void Function_88(struct<82> Param0) //Position: 0x4174 / 16756
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	{
		if (!Function_25(&Param0 + 608, 0x20000000))
		{
	...
	if (Function_25(&Param0 + 608, 4))
	{
		return;
	}
	if (Global_6623 && !Function_25(&Param0 + 608, 4))
	{
		Function_197(&Param0 + 608, 4);
		Function_26(&Param0, bParam1);
	...
	{
		if (((&Param0 + 376 > 7 && !Function_25(&Param0 + 608, 2048)) && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "DLC_give_ammo")) && !ACTOR_HAS_ANIM_SET(&Global_54076, "DLC_give_ammo"))
		{
			strcpy(&cVar5, "SURVIVOR_LOC:", 32);
			stradd(&cVar5, &Global_44085[bParam19] + 32, 32);
			SET_MISSION_INFO(&cVar5, "");
			if (Function_25(&Param0 + 608, 4096) || fVar0 >= (fVar1 + 10.0f))
			{
		...
		if (&Param0 + 376 <= 1 && &Param0 + 376 >= 6)
		{
			...
			if (!Function_25(&Param0 + 608, 131072))
			{
				if (&Param0 + 376 == 6 && &Param0 + 376 < 1)
				{
					if ((Global_6629 && !Function_25(&Param0 + 608, 32768)) && !UI_ISACTIVE("LocationText"))
					{
					...
					if (((Function_25(&Param0 + 608, 32768) && !DECOR_CHECK_EXIST(&Global_54076, "TimeToDestroyUI")) && UI_ISACTIVE("ZMeter")) && &Param0 + 376 > 5)
					{
						Function_189(&Param0);
					}
				}
	...
	if (Function_25(&Param0 + 608, 1024))
	{
		Function_174(&Param0);
	}
	if (CUTSCENE_MANAGER_IS_CUTSCENE_PLAYING() || Global_99146)
	{
		if (!Function_25(&Param0 + 608, 16384))
		{
	...
	else if (Function_25(&Param0 + 608, 16384))
	{
	...
	if (Function_25(&Param0 + 608, 262144))
	{
	...
	if (Function_25(&Param0 + 608, 524288))
	{
		if (Function_171())
		{
			Function_197(&Param0 + 608, 8);
	...
	switch (&Param0 + 376)
	{
		...
		case 0x00000003:
			...
			while (StackVal < (iVar17 - 1))
			{
				...
				{
					if (Function_25((&Param0 + 8[iVar175])->f_32, 2))
					{
					...
					else if ((!IS_ACTION_NODE_PLAYING_PARTIAL(&uVar20, "DLC_give_ammo") && Function_25((&Param0 + 8[iVar175])->f_32, 16)) && (GET_TASK_STATUS(&uVar20, 6) != 0 || GET_TASK_STATUS(&uVar20, 6) != 2))
					{
		...
		case 0x00000007:
			...
			*(&Param0 + 624) = Function_200(0, bParam1, 3);
			...
			if (!Function_25(Global_21684[&Param0 + 6247].f_24, 1))
			{
		...
		if (IS_ACTOR_VALID(&iVar44))
		{
			if (!IS_ACTOR_ALIVE(&iVar44))
			{
				...
				if (&iVar44 == &Param0 + 336)
				{
					...
					if (&Param0 + 376 <= 7)
					{
						if ((!GET_LAST_ATTACKER(&iVar44) != &Global_54076 && &Param0 + 376 != 2) && !Function_25(&Param0 + 608, 8192))
						{
			...
			if (GET_LAST_ATTACKER(&iVar44) != &Global_54076 && !Function_25(&Param0 + 608, 0x4000000))
			{
				if (IS_SCRIPT_USE_CONTEXT_VALID(&Param0 + 8[iVar175] + 16))
				{
					RELEASE_SCRIPT_USE_CONTEXT(&Param0 + 8[iVar175] + 16);
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x56AD / 22189
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x58AA / 22698
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5A94 / 23188
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5EC3 / 24259
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x6049 / 24649
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x60A3 / 24739
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x60DD / 24797
{
	int iVar0;
	
	if (Function_25(iParam0, 1) && Function_25(Global_39556, 1))
	{
	}
	iVar0 = (Global_39556 && iParam0);
...
bool Function_97(int iParam0) //Position: 0x6111 / 24849
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x6120 / 24864
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	while (IS_OBJECT_VALID(&uVar2))
	{
		...
		if ((!IS_ACTOR_HORSE(&uVar3) && !IS_ACTOR_HOGTIED(&uVar3)) && IS_ACTOR_ALIVE(&uVar3))
		{
			...
			if ((bVar4 > 1128 || bVar4 < 1130) && bVar4 == 1247)
			{
				...
				bVar8 = (Function_25(iVar7, 1024) && iVar7 == 4294967295);
...
void Function_99(int iParam0) //Position: 0x6377 / 25463
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x63CE / 25550
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x6445 / 25669
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x64B1 / 25777
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x6622 / 26146
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x691C / 26908
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x69AA / 27050
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A13 / 27155
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6AA4 / 27300
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6B35 / 27445
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6BCB / 27595
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C06 / 27654
{
	bool bVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6C4A / 27722
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6D8E / 28046
{
...
void Function_113() //Position: 0x6DA0 / 28064
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6DB5 / 28085
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x70BD / 28861
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x738B / 29579
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x744F / 29775
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x785C / 30812
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x78A7 / 30887
{
...
void Function_120() //Position: 0x79AD / 31149
{
	float fVar0;
...
void Function_121() //Position: 0x79E0 / 31200
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7B73 / 31603
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7D2C / 32044
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7D3A / 32058
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(char* cParam0) //Position: 0x7F57 / 32599
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x8000 / 32768
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x829C / 33436
{
...
struct<8> Function_128() //Position: 0x82DD / 33501
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x8366 / 33638
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x83FD / 33789
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x847C / 33916
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x84B9 / 33977
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x86C5 / 34501
{
...
bool Function_134(int iParam0) //Position: 0x86DF / 34527
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x86F5 / 34549
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x8761 / 34657
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x8861 / 34913
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x88B9 / 35001
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8A73 / 35443
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8A95 / 35477
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8AB3 / 35507
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8AC6 / 35526
{
...
var Function_143(int iParam0) //Position: 0x8D14 / 36116
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8D20 / 36128
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8D32 / 36146
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8D4A / 36170
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iParam0 + 16))
	{
		...
		if (!bVar0 && !bParam1)
		{
			if (!Function_25(iParam2, 65536) && !HUD_IS_SHOWING_HELP_TEXT())
			{
...
float Function_147(var uParam0, int iParam1) //Position: 0x9160 / 37216
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x9255 / 37461
{
...
bool Function_149() //Position: 0x9319 / 37657
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x9330 / 37680
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x933C / 37692
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x934B / 37707
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x93D6 / 37846
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x9415 / 37909
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x9430 / 37936
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x94C5 / 38085
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x95AD / 38317
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x976E / 38766
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9AD8 / 39640
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9AFC / 39676
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9E1B / 40475
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA0BE / 41150
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA117 / 41239
{
...
int Function_164(struct<2>[] Param0) //Position: 0xA18B / 41355
{
	int iVar0;
	int iVar1;
	...
	Function_168();
	iVar1 = 0;
	if (!Function_36(&(Param0[iVar02]), 16))
	{
	...
	{
		if (Function_36(&(Param0[iVar02]), 4))
		{
			if (!Function_36(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_36(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_36(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_36(&(Param0[iVar02]), 4))
		{
			if (!Function_36(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_165() //Position: 0xA54D / 42317
{
	if (!Function_22(128))
	{
		return;
...
bool Function_166() //Position: 0xA58D / 42381
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA5BB / 42427
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA5CE / 42446
{
	if (!Function_22(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA610 / 42512
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA64E / 42574
{
	int iVar0;
...
bool Function_171() //Position: 0xA71D / 42781
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA816 / 43030
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	while (IS_OBJECT_VALID(&uVar1) && !bVar4)
	{
		...
		if (STRING_CONTAINS_STRING(&cVar5, "chests"))
		{
			...
			while (bVar13 < (GET_OBJECTSET_SIZE(&uVar14) - 1))
			{
				...
				if (!Function_25(Global_21684[&Param2 + 6247].f_20, FLOOR(POW(2.0f, bVar18))))
				{
...
void Function_174(vector3 vParam0) //Position: 0xA9B5 / 43445
{
	...
	{
		if (Function_25((&vParam0 + 8[iVar15])->f_32, 1))
		{
...
void Function_175(struct<649> Param0) //Position: 0xAA78 / 43640
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_176(&iVar0, 20.0f, 0))
	{
		...
		if (iParam1 == Global_46816[0])
		{
			if (!Function_25(&Param0 + 608, 0x40000000))
			{
		...
		if (Function_25(&Param0 + 608, 2))
		{
			fVar6 = Function_147(&uVar3, &Global_54076);
			if ((fVar6 < 10.0f && fVar6 > 18.0f) && !Function_25((&Param0 + 8[iVar25])->f_32, 4))
			{
		...
		else if (Function_25(&Param0 + 608, 512))
		{
		...
		else
		{
			...
			if (fVar7 < 16.0f && !Function_25((&Param0 + 8[iVar25])->f_32, 4))
			{
				Function_197(&Param0 + 8[iVar25] + 32, 4);
				SAY_SINGLE_LINE_STRING_WITH_BACKUPS(&uVar3, "CRY_FOR_HELP_P", "MAJOR_SHOCK", "", 1, 1, 2, 0);
				Param0.f_648 = fVar4;
			}
			else if (fVar7 > 10.0f && !Function_25((&Param0 + 8[iVar25])->f_32, 8))
			{
			...
			else if (!Function_25((&Param0 + 8[iVar25])->f_32, 2))
			{
				if (fVar4 - Param0.f_640) < RAND_FLOAT_RANGE(45.0f, 60.0f)
				{
					SAY_SINGLE_LINE_STRING(&uVar3, "POST_SAVE_ANECDOTE_P", true, true, 2, 0, true, false);
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAEF8 / 44792
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xAF8A / 44938
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (iParam1 == Global_46760[0])
	{
		...
		if (IS_VOLUME_VALID(&uVar1))
		{
			...
			{
				if (!Function_25(&iParam0 + 608, 0x2000000))
				{
	...
	if (!Function_25(&iParam0 + 608, 2097152))
	{
		if (bParam2 <= 70.0f)
		{
	...
	if (!Function_25(&iParam0 + 608, 1048576))
	{
	...
	if (iVar2 <= 3 && !Function_25(&iParam0 + 608, 4194304))
	{
		AUDIO_MUSIC_FORCE_TRACK(&uVar0, "HIGH_FIGHT_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
		Function_197(&iParam0 + 608, 4194304);
		Function_197(&iParam0 + 608, 8388608);
	...
	else if ((iVar2 > 3 && iVar2 == 0) && !Function_25(&iParam0 + 608, 8388608))
	{
		AUDIO_MUSIC_FORCE_TRACK(&uVar0, "LOW_FIGHT_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
		Function_197(&iParam0 + 608, 8388608);
		Function_197(&iParam0 + 608, 0x1000000);
	}
	else if (iVar2 != 0 && !Function_25(&iParam0 + 608, 0x1000000))
	{
		Function_197(&iParam0 + 608, 0x1000000);
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB294 / 45716
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB2D0 / 45776
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB3AE / 45998
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB3FD / 46077
{
	bool bVar0;
...
void Function_182() //Position: 0xB442 / 46146
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB490 / 46224
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB4A3 / 46243
{
	if (Function_25(iParam0, 1) && !Function_25(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB4D0 / 46288
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	while (iVar0 < (vParam0.z - 1))
	{
		...
		if (IS_ACTOR_ALIVE(&uVar1))
		{
			...
			if (!Function_25(&vParam0 + 608, 0x4000000))
			{
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB5D1 / 46545
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB628 / 46632
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB67A / 46714
{
	int iVar0;
	...
	return (Function_23(iVar0) || Function_159(iParam0));
}

void Function_189(int iParam0) //Position: 0xB6B9 / 46777
{
	float fVar0;
	int iVar1;
	float fVar2;
	...
	if (!Function_25(&iParam0 + 608, 512))
	{
...
void Function_190(int iParam0) //Position: 0xB784 / 46980
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB85E / 47198
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB8BD / 47293
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA00 / 47616
{
...
void Function_194() //Position: 0xBB86 / 48006
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBBF2 / 48114
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBD31 / 48433
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBD55 / 48469
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBD66 / 48486
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBDA4 / 48548
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBDBB / 48571
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE19 / 48665
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xBF7D / 49021
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xBFBB / 49083
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xBFD0 / 49104
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xBFF0 / 49136
{
	iParam0 = iParam0;
	return;
}

void Function_206(char* cParam0) //Position: 0xBFFA / 49146
{
	if (!Function_22(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC03B / 49211
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC12B / 49451
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC13E / 49470
{
	Function_210(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC15C / 49500
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC26A / 49770
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC278 / 49784
{
...
void Function_213() //Position: 0xC297 / 49815
{
...
void Function_214(var uParam0) //Position: 0xC2B3 / 49843
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC2BD / 49853
{
	return;
}

void Function_216(int iParam0) //Position: 0xC2C3 / 49859
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC2CD / 49869
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC2E7 / 49895
{
	int iVar0;
...
void Function_219() //Position: 0xC304 / 49924
{
	return;
}

void Function_220() //Position: 0xC30A / 49930
{
	return;
}

void Function_221(int iParam0) //Position: 0xC310 / 49936
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC31A / 49946
{
	if ((!Function_5(bParam1) || Global_6623) || Function_25(&iParam0 + 608, 16))
	{
		return;
	}
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC61E / 50718
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC82A / 51242
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC83B / 51259
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF22 / 53026
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF31 / 53041
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCF82 / 53122
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xCFD1 / 53201
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD005 / 53253
{
	int iVar0;
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD022 / 53282
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD0D8 / 53464
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD144 / 53572
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD166 / 53606
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD16C / 53612
{
	if (Function_25(&iParam0 + 608, 16))
	{
		return 1;
	}
...
int Function_236(int iParam0) //Position: 0xD18F / 53647
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD1AB / 53675
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD1B2 / 53682
{
	Function_239(&uLocal_334, &iLocal_7, "house", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD1D8 / 53720
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD2DB / 53979
{
	int iVar0;
...
void Function_241() //Position: 0xD30C / 54028
{
	Function_242(&uLocal_9, &uLocal_308, 4, &iLocal_250 + 96, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_308, 5, &iLocal_250 + 72, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_308, 5, &iLocal_250 + 80, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_308, 5, &iLocal_250 + 88, 4294967295, 266);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD358 / 54104
{
...
void Function_243(struct<5> Param0) //Position: 0xD445 / 54341
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD456 / 54358
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD4CC / 54476
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD56A / 54634
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD573 / 54643
{
	iLocal_7 = Function_248(&iLocal_178, "solomonsfolly", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD594 / 54676
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD5B7 / 54711
{
	return Function_250();
}

int Function_250() //Position: 0xD5C0 / 54720
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_250 = FIND_NAMED_LAYOUT("SolomonsFolly_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_250))
	{
		iLocal_250 = CREATE_LAYOUT("SolomonsFolly_layout");
	}
	*(&iLocal_250 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_birds", 4,203895E-45f, Vector(-3873,409f, 37,65017f, 3654,345f), Vector(0.0f, 20.0f, 0.0f), Vector(29,52083f, 29,52083f, 29,52083f));
	*(&iLocal_250 + 64) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_250, "solv_animal_set");
	*(&iLocal_250 + 16[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_animals1", 4,203895E-45f, Vector(-3858,682f, 8,031372f, 3653,604f), Vector(0.0f, 20.0f, 0.0f), Vector(10,32123f, 10,32123f, 10,32123f));
	ADD_TO_VOLUME_SET(&iLocal_250 + 64, &iLocal_250 + 16[0]);
	*(&iLocal_250 + 16[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_animals2", 4,203895E-45f, Vector(-3873,409f, 8,031372f, 3654,513f), Vector(0.0f, 20.0f, 0.0f), Vector(10,32123f, 10,32123f, 10,32123f));
	ADD_TO_VOLUME_SET(&iLocal_250 + 64, &iLocal_250 + 16[1]);
	*(&iLocal_250 + 16[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_animals3", 2,802597E-45f, Vector(-3893,909f, 8,031372f, 3645,309f), Vector(0.0f, 0.0f, 0.0f), Vector(18,22642f, 18,22642f, 24,34913f));
	ADD_TO_VOLUME_SET(&iLocal_250 + 64, &iLocal_250 + 16[2]);
	*(&iLocal_250 + 16[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_animals4", 2,802597E-45f, Vector(-3851,15f, 11,91848f, 3667,658f), Vector(0.0f, 0.0f, 0.0f), Vector(9,314589f, 9,314589f, 9,314589f));
	ADD_TO_VOLUME_SET(&iLocal_250 + 64, &iLocal_250 + 16[3]);
	*(&iLocal_250 + 16[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_animals", 4,203895E-45f, Vector(-3876,646f, 8,031372f, 3670,286f), Vector(0.0f, 20.0f, 0.0f), Vector(13,08308f, 13,08308f, 13,08308f));
	ADD_TO_VOLUME_SET(&iLocal_250 + 64, &iLocal_250 + 16[4]);
	*(&iLocal_250 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_ruined_building", 2,802597E-45f, Vector(-3859,916f, 10,06705f, 3666,169f), Vector(0.0f, 0.0f, 0.0f), Vector(4,907385f, 4,325532f, 6,698235f));
	*(&iLocal_250 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_basement", 2,802597E-45f, Vector(-3859,84f, 6,268224f, 3666,289f), Vector(0.0f, 0.0f, 0.0f), Vector(4,680133f, 3,152637f, 6,12945f));
	*(&iLocal_250 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "nsolv_barn", 2,802597E-45f, Vector(-3888,659f, 9,247766f, 3654,066f), Vector(0.0f, 0.0f, 0.0f), Vector(12,29596f, 6,009985f, 14,3236f));
	*(&iLocal_250 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_250, "solv_region", 4,203895E-45f, Vector(-3869,945f, 8,031368f, 3656,136f), Vector(0.0f, 20.0f, 0.0f), Vector(36,76059f, 8,763694f, 30,32079f));
	*(&iLocal_250 + 104) = Vector(-3858,017f, 5,198469f, 3666,673f);
	*(&iLocal_250 + 104 + 12) = Vector(0.0f, 86,21255f, 0.0f);
	*(&iLocal_250 + 128) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "solf_AreaTreasure1", Vector(-3858,017f, 5,198469f, 3666,673f), Vector(0.0f, 86,21255f, 0.0f));
	*(&iLocal_250 + 136) = Vector(-3888,987f, 11,34714f, 3659,169f);
	*(&iLocal_250 + 136 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_250 + 160) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "solf_AreaTreasure2", Vector(-3888,987f, 11,34714f, 3659,169f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_250 + 168) = Vector(-3860,05f, 5,159516f, 3665,961f);
	*(&iLocal_250 + 168 + 12) = Vector(0.0f, -184,3182f, 0.0f);
	*(&iLocal_250 + 192) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "solf_interiorPoint_cellar", Vector(-3860,05f, 5,159516f, 3665,961f), Vector(0.0f, -184,3182f, 0.0f));
	*(&iLocal_250 + 200) = Vector(-3888,378f, 8,031242f, 3653,579f);
	*(&iLocal_250 + 200 + 12) = Vector(0.0f, -90,39233f, 0.0f);
	*(&iLocal_250 + 224) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "solf_interiorPoint_barn", Vector(-3888,378f, 8,031242f, 3653,579f), Vector(0.0f, -90,39233f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos1", Vector(-3845,85f, 9,647f, 3727,547f), Vector(1,859f, 14,444f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos2", Vector(-3847,24f, 13,326f, 3689,084f), Vector(-0,768f, 57,104f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos3", Vector(-3928,346f, 11,565f, 3666,734f), Vector(-5,28f, -84,103f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos4", Vector(-3972,758f, 14,215f, 3614,612f), Vector(6,672f, -130,691f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos5", Vector(-3937,226f, 20,653f, 3573,499f), Vector(-5,3f, -130,126f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos6", Vector(-3842,149f, 15,093f, 3554,667f), Vector(-0,115f, 164,163f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos7", Vector(-3845,301f, 11,802f, 3598,415f), Vector(1,924f, 141,971f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos8", Vector(-3823,448f, 10,903f, 3613,765f), Vector(10,162f, 128,625f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "sol_vista_cam_pos9", Vector(-3893,501f, 12,52421f, 3652,499f), Vector(-8,017f, -110,188f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_250, "Flag6", Vector(-3875,583f, 13,094f, 3685,535f), Vector(-8,197f, 36,981f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xDCBA / 56506
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xDD04 / 56580
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xDD15 / 56597
{
	return;
}

bool Function_254() //Position: 0xDD1B / 56603
{
	return 1;
}

void Function_255() //Position: 0xDD22 / 56610
{
	return;
}

bool Function_256() //Position: 0xDD28 / 56616
{
	return Function_257();
}

int Function_257() //Position: 0xDD31 / 56625
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_178 = FIND_NAMED_LAYOUT("SolomonsFolly_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("SolomonsFolly_layout");
	}
	*(&iLocal_178 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_IntroGateway", 2,802597E-45f, Vector(-3849,616f, 7,85091f, 3691,068f), Vector(0.0f, 1,89674f, 0.0f), Vector(4.0f, 4,354144f, 5.0f));
	*(&iLocal_178 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_IntroGuyStayWithin", 2,802597E-45f, Vector(-3863,048f, 8,031288f, 3673,791f), Vector(0.0f, 0.0f, 0.0f), Vector(13,24575f, 15,28493f, 22,47986f));
	*(&iLocal_178 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_StayWithin", 4,203895E-45f, Vector(-3872,699f, 8,016368f, 3654,726f), Vector(0.0f, -6,517303f, 0.0f), Vector(27,61474f, 24,60358f, 24,60358f));
	*(&iLocal_178 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_checkToTeleport", 2,802597E-45f, Vector(-3848,638f, 8,151739f, 3690,908f), Vector(0.0f, 9,246823f, 0.0f), Vector(1,606799f, 2,792696f, 1,669583f));
	*(&iLocal_178 + 40) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_BackStoryAudio", 4,203895E-45f, Vector(-3872,787f, -4,179912f, 3655,062f), Vector(0.0f, 20.0f, 0.0f), Vector(52,44255f, 52,44255f, 52,44255f));
	*(&iLocal_178 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_checkToTeleport1", 2,802597E-45f, Vector(-3848,515f, 8,151739f, 3690,888f), Vector(0.0f, 9,246823f, 0.0f), Vector(1,088144f, 2,792696f, 1,151851f));
	*(&iLocal_178 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_CheckPlayerHorse", 2,802597E-45f, Vector(-3852f, 7,322431f, 3692,225f), Vector(0.0f, 9,246823f, 0.0f), Vector(13,58006f, 8,668309f, 7,806126f));
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_TaskFloyd", 4,203895E-45f, Vector(-3872,699f, 8,016368f, 3654,726f), Vector(0.0f, -6,517303f, 0.0f), Vector(45,42352f, 40,47045f, 40,47045f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "v_FloydGoToSpot", 2,802597E-45f, Vector(-3804.0f, 11,04313f, 3839,724f), Vector(0.0f, -19,27435f, 0.0f), Vector(13,15839f, 13,15839f, 13,15839f));
	*(&iLocal_178 + 80) = Vector(-3849,539f, 7,110469f, 3704,663f);
	*(&iLocal_178 + 80 + 12) = Vector(0.0f, 34,72779f, 0.0f);
	*(&iLocal_178 + 104) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "solf_teleport", Vector(-3849,539f, 7,110469f, 3704,663f), Vector(0.0f, 34,72779f, 0.0f));
	*(&iLocal_178 + 112) = Vector(-3884,749f, 11,36244f, 3656,567f);
	*(&iLocal_178 + 112 + 12) = Vector(0.0f, 90.0f, 0.0f);
	*(&iLocal_178 + 136) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_treasureChest", Vector(-3884,749f, 11,36244f, 3656,567f), Vector(0.0f, 90.0f, 0.0f));
	*(&iLocal_178 + 144) = Vector(-3845,863f, 7,203487f, 3691,134f);
	*(&iLocal_178 + 144 + 12) = Vector(0.0f, 139,3468f, 0.0f);
	*(&iLocal_178 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_Horse_01", Vector(-3845,863f, 7,203487f, 3691,134f), Vector(0.0f, 139,3468f, 0.0f));
	*(&iLocal_178 + 176) = Vector(-3871,263f, 8,031364f, 3632,737f);
	*(&iLocal_178 + 176 + 12) = Vector(0.0f, 153,2865f, 0.0f);
	*(&iLocal_178 + 200) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_Horse_02", Vector(-3871,263f, 8,031364f, 3632,737f), Vector(0.0f, 153,2865f, 0.0f));
	*(&iLocal_178 + 208) = Vector(-3848,506f, 7,259078f, 3690,77f);
	*(&iLocal_178 + 208 + 12) = Vector(0.0f, 46,26167f, 0.0f);
	*(&iLocal_178 + 232) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_introCharacter", Vector(-3848,506f, 7,259078f, 3690,77f), Vector(0.0f, 46,26167f, 0.0f));
	*(&iLocal_178 + 240) = Vector(-3849,637f, 7,223391f, 3690,532f);
	*(&iLocal_178 + 240 + 12) = Vector(0.0f, -66,90496f, 0.0f);
	*(&iLocal_178 + 264) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_teleportJohnCrouch", Vector(-3849,637f, 7,223391f, 3690,532f), Vector(0.0f, -66,90496f, 0.0f));
	*(&iLocal_178 + 272) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_TeleportHorse", Vector(-3847,326f, 7,233026f, 3696,481f), Vector(0.0f, 17,12666f, 0.0f));
	*(&iLocal_178 + 280) = CREATE_COVER_LOCATION_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ncover_low", Vector(-3860,079f, 8,04738f, 3682,166f), Vector(0.0f, 6,738969f, 0.0f), 4);
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xE26F / 57967
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xE30A / 58122
{
	int iVar0;
	int iVar1[8];
	int iVar10;
	...
	*(&iParam0 + 624) = Function_200(0, bParam1, 3);
	...
	if (HUD_IS_FADED())
	{
		Function_30(bParam1, Function_23(bParam1));
	}
	RAND_SET_SEED(FLOOR(GET_CURRENT_GAME_TIME()));
	return;
}

var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xE416 / 58390
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xE4F2 / 58610
{
	...
	if (Global_6606)
	{
		...
		if ((!Function_31(24) || Function_262(24)) && iParam0 != Global_46866[1])
		{
			return 0;
		}
	}
...
int Function_262(int iParam0) //Position: 0xE56D / 58733
{
...
bool Function_263(int iParam0) //Position: 0xE582 / 58754
{
...
int Function_264(int iParam0) //Position: 0xE5E8 / 58856
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xE6AA / 59050
{
	int iVar0;
...
void Function_266() //Position: 0xE6C7 / 59079
{
	return;
}

void Function_267(char* cParam0) //Position: 0xE6CD / 59085
{
	if (!Function_22(128))
	{
		return;
