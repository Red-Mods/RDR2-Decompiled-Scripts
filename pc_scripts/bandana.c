...
int Function_48(int iParam0) //Position: 0x29F3 / 10739
{
	...
	switch (iLocal_2)
	{
		...
		case 0x00000001:
			...
			{
				Function_58(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			uVar2 = Function_57(&iParam0);
			if (IS_GRINGO_COMPONENT_VALID(&uVar2) && iLocal_4)
			{
				Function_53(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 3;
			}
			else
			{
...
void Function_49(int iParam0, var uParam1, int iParam2) //Position: 0x2AAA / 10922
{
	...
	if (DECOR_CHECK_EXIST(&uParam1, "ITEM_ATTACHING"))
	{
		DECOR_REMOVE(&uParam1, "ITEM_ATTACHING");
	}
	return;
}

bool Function_50(int iParam0, int iParam1, int iParam2) //Position: 0x2B0C / 11020
{
	var uVar0;
	
	uVar0 = Function_57(&iParam0);
	if (!((Global_6621 || HUD_IS_FADING()) || HUD_IS_FADED()))
	{
		if ((IS_GRINGO_COMPONENT_VALID(&uVar0) && iParam2) && iLocal_4)
		{
			if (DECOR_CHECK_EXIST(&iParam1, "ITEM_DESTROY"))
			{
				Function_52(0, 0);
				DECOR_REMOVE(&iParam1, "ITEM_DESTROY");
			}
			if (DECOR_CHECK_EXIST(&iParam1, "ITEM_CREATE"))
			{
				Function_52(0, 1);
				DECOR_REMOVE(&iParam1, "ITEM_CREATE");
			}
...
bool Function_51(int iParam0) //Position: 0x2BCD / 11213
{
	return (*&Global_21369 + 168)[iParam0];
}

void Function_52(int iParam0, bool bParam1) //Position: 0x2BDC / 11228
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_53(int iParam0, var uParam1, var uParam2) //Position: 0x2D62 / 11618
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0) && uParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(&uVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(&uParam1, &uVar1, Function_55(&uVar1, "AttachBone", &iVar2), Function_55(&uVar1, "AttachLocator", &iVar2), 1))
				{
					Function_54(&uVar1, &uParam1);
					uParam2 = 1;
				}
			}
		}
...
void Function_54(var uParam0, int iParam1) //Position: 0x2DFF / 11775
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_55(var uParam0, var uParam1, int iParam2) //Position: 0x2EC7 / 11975
{
	int iVar0;
	int iVar1;
...
var Function_56(int iParam0) //Position: 0x2F17 / 12055
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

var Function_57(int iParam0) //Position: 0x2F2E / 12078
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_58(var uParam0, var uParam1, int iParam2) //Position: 0x2F45 / 12101
{
	...
	else
	{
		...
		if (!Function_51(0))
		{
			DECOR_SET_BOOL(&uParam1, "ITEM_ATTACHING", 1);
		}
		iLocal_4 = 1;
		iParam2 = 1;
	}
...
int Function_59(int iParam0, bool bParam1, bool bParam2) //Position: 0x2FFC / 12284
{
...
bool Function_60() //Position: 0x30C0 / 12480
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_61(int iParam0) //Position: 0x30D7 / 12503
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_62(int iParam0) //Position: 0x30E3 / 12515
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_63(int iParam0) //Position: 0x30F2 / 12530
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_64(int iParam0, int iParam1) //Position: 0x310D / 12557
{
	var uVar0;
	var uVar1;
