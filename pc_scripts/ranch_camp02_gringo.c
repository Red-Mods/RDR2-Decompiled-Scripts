...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	Local_13 = Vector(-799,3787f, 92,33308f, 2425,723f);
	iLocal_20 = 2;
	iLocal_21 = 4;
	fLocal_22 = 70.0f;
...
{
	RELEASE_LAYOUT_REF(&uLocal_18);
	Function_4(3, &uLocal_9, &uLocal_11, &uLocal_3, &uLocal_16, 4294967295);
	return;
}
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_20 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_146(&Param0 + 324, &fLocal_22, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_135(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_22, 20.0f, fLocal_22));
...
{
	Function_143(&uLocal_3, 1196, 3, 0);
	if (Function_82(&uLocal_9, &uLocal_3, 4, 1, 1, 1, 0, 1, 0, 0, 0) && !WOULD_ACTOR_BE_VISIBLE(1196, &Local_13, 3212836864))
	{
		if (Function_80(&uLocal_18, "ranch02mobile", &iParam1))
		{
			uLocal_11 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_18, Function_135()));
			*(&Global_6667[428] + 216) = &uLocal_11;
			*(&iParam0 + 24) = &uLocal_18;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3AA2 / 15010
{
	var uVar0;
	
	uLocal_16 = CREATE_LAYOUT("ranch02campfirelayout");
	if (!Function_79("Wag", &uVar0, &uLocal_16, 0))
	{
		uVar0 = Function_75(StackVal, StackVal, &uLocal_16, "Wag", 1196, 976, Local_13, Vector(0.0f, 50,06666f, 0.0f), 1, 976, 976, 976, 4);
	}
	Function_73(&uVar0, &uLocal_11, 1, 1);
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3B0F / 15119
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x3CCC / 15564
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
var Function_75(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x3D14 / 15636
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(&uVar0))
	{
		...
		while (iVar9 < (iVar10 - 1))
		{
			...
			uVar15 = "";
			if (Function_78(&(Global_46972[6]), 4, 23, 0) && uParam8)
			{
				bVar16 = Function_77(StackVal, &(Global_46972[6]), Param4, 4, 23, 0);
				if (Function_76(bVar16, &iVar1))
				{
					bVar16 = 976;
				}
				iVar1[iVar9] = bVar16;
...
bool Function_76(int iParam0, bool[] bParam1) //Position: 0x3F67 / 16231
{
	int iVar0;
...
var Function_77(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x3F9B / 16283
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_78(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3FB7 / 16311
{
...
bool Function_79(var uParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x3FE3 / 16355
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x4116 / 16662
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x4146 / 16710
{
	int iVar0;
...
int Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4191 / 16785
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4370 / 17264
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x48B0 / 18608
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_85(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x48D2 / 18642
{
	var uVar0;
...
var Function_86(bool bParam0, int iParam1) //Position: 0x4933 / 18739
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x49C1 / 18881
{
	Function_89(&uParam0);
	Function_88(&uParam0);
...
void Function_88(int iParam0) //Position: 0x49ED / 18925
{
...
void Function_89(int iParam0) //Position: 0x4A13 / 18963
{
...
bool Function_90(bool bParam0) //Position: 0x4AE9 / 19177
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x4B00 / 19200
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4BA6 / 19366
{
	var uVar0;
	var uVar1;
...
void Function_93(var uParam0) //Position: 0x4CB5 / 19637
{
	int iVar0;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x4CE8 / 19688
{
	int iVar0;
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4D05 / 19717
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_96() //Position: 0x4D91 / 19857
{
	var uVar0;
	int iVar1;
...
bool Function_97(int iParam0) //Position: 0x4E01 / 19969
{
...
bool Function_98(int iParam0) //Position: 0x4E1D / 19997
{
...
var Function_99(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4E33 / 20019
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(struct<205> Param0) //Position: 0x4ED9 / 20185
{
	var uVar0;
	var uVar1;
...
bool Function_101(struct<2>[] Param0) //Position: 0x4FE4 / 20452
{
	int iVar0;
	int iVar1;
...
void Function_102() //Position: 0x53A6 / 21414
{
	if (!Function_150(128))
	{
		return;
...
bool Function_103() //Position: 0x53E6 / 21478
{
	int iVar0;
...
void Function_104(struct<13> Param0) //Position: 0x5414 / 21524
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_105() //Position: 0x5427 / 21543
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(vector3 vParam0) //Position: 0x5469 / 21609
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5501 / 21761
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5530 / 21808
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x558B / 21899
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x559B / 21915
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x55AF / 21935
{
	int iVar0;
...
var Function_112() //Position: 0x55D4 / 21972
{
	return "PackedMetadata";
}

void Function_113(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x55EB / 21995
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_114() //Position: 0x5727 / 22311
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_115() //Position: 0x5739 / 22329
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_116() //Position: 0x574B / 22347
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_117(var uParam0, struct<5> Param1) //Position: 0x575D / 22365
{
...
var Function_118(var uParam0, int iParam1, int iParam2) //Position: 0x5782 / 22402
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x57A1 / 22433
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_120() //Position: 0x57AD / 22445
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x57B8 / 22456
{
	int iVar0;
...
var Function_122() //Position: 0x57E6 / 22502
{
	return "PackedWeapon";
}

int Function_123(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x57FB / 22523
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_124() //Position: 0x5908 / 22792
{
	return "MPItemGiver";
}

struct<32> Function_125(char* cParam0) //Position: 0x591C / 22812
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0) //Position: 0x5988 / 22920
{
	char* cVar0[32];
...
var Function_127() //Position: 0x59AA / 22954
{
	return "PBox_";
}

var Function_128() //Position: 0x59B8 / 22968
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x59DE / 23006
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x5A06 / 23046
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x5A2C / 23084
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5B96 / 23446
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5C3E / 23614
{
	int iVar0;
	struct<2> Var1;
...
void Function_134(int iParam0) //Position: 0x5DAC / 23980
{
...
var Function_135() //Position: 0x5E14 / 24084
{
	int iVar0;
...
var Function_136(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5E1D / 24093
{
	return Function_137(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5E3B / 24123
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_139() //Position: 0x61E8 / 25064
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x6223 / 25123
{
	int iVar0;
...
void Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6250 / 25168
{
	bool bVar0;
...
void Function_142() //Position: 0x63AB / 25515
{
	int iVar0;
...
var Function_143(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x63F7 / 25591
{
	int iVar0;
...
int Function_144() //Position: 0x64D3 / 25811
{
	int iVar0;
...
int Function_145() //Position: 0x662F / 26159
{
	int iVar0;
...
bool Function_146(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x674F / 26447
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_147(struct<2> Param0) //Position: 0x682B / 26667
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_148(struct<2> Param0, struct<5> Param2) //Position: 0x684A / 26698
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_149(int iParam0) //Position: 0x698D / 27021
{
	var uVar0;
...
bool Function_150(int iParam0) //Position: 0x69AF / 27055
{
	int iVar0;
...
int Function_151() //Position: 0x69CB / 27083
{
	return 0;
}

void Function_152(struct<321> Param0) //Position: 0x69D2 / 27090
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_153(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_153(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

var Function_153(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6A64 / 27236
{
	int iVar0;
