...
void Function_11(struct<7> Param0) //Position: 0x54E / 1358
{
	...
	if (Function_25(32768))
	{
		...
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104)))
		{
			GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104), 1);
			GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 120), 1);
		}
	}
	else
	{
...
bool Function_13(var uParam0) //Position: 0x603 / 1539
{
	...
	Function_21(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_21(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	...
	*(&iLocal_0 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarBoxcar3_pop", 2,802597E-45f, Vector(0.0f, 2,090946f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,69351f, 2,303248f, 9,541062f));
	*(&iLocal_0 + 104) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_NearWall", "Rand_Idle_NearWall", Vector(0,6496333f, 0,9798797f, 1,296378f), Vector(0.0f, 90,09578f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104), 1);
	*(&iLocal_0 + 112) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "look_out_window_L", "look_out_window_L", Vector(-0,3149849f, 0,981665f, -4,292036f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_0 + 120) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand", "Rand_Idle_Sit_Ground", Vector(-0,7036909f, 0,9794222f, 1,269479f), Vector(0.0f, -90,22742f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 120), 1);
	*(&iLocal_0 + 128) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(0,6841315f, 0,9825688f, -3,616831f), Vector(0.0f, 89,78111f, 0.0f));
	*(&iLocal_0 + 136) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "look_out_window_R", "look_out_window_R", Vector(-0,3511463f, 0,9852048f, 4,196025f), Vector(0.0f, 180,9666f, 0.0f));
	*(&iLocal_0 + 144) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_left", "train_climb_left", Vector(-1,285842f, 0,9795684f, -2,492694f), Vector(0.0f, 89,41081f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 144, "trainAttach", false);
	*(&iLocal_0 + 152) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_left1", "train_climb_left", Vector(-1,203854f, 0,9826367f, 2,461015f), Vector(0.0f, 89,27229f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 152, "trainAttach", true);
	Function_14(&iLocal_0, &uParam0);
	return 1;
}

void Function_14(bool bParam0, int iParam1) //Position: 0xA2F / 2607
{
	var uVar0;
...
var Function_15() //Position: 0xA7A / 2682
{
	int iVar0;
...
bool Function_16(struct<2>[] Param0) //Position: 0xA83 / 2691
{
	int iVar0;
	int iVar1;
...
void Function_17() //Position: 0xE45 / 3653
{
	if (!Function_25(128))
	{
		return;
...
bool Function_18() //Position: 0xE85 / 3717
{
	int iVar0;
...
void Function_19(struct<13> Param0) //Position: 0xEB3 / 3763
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_20() //Position: 0xEC6 / 3782
{
	if (!Function_25(128))
	{
		return;
...
var Function_21(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xF08 / 3848
{
	int iVar0;
	var uVar1;
...
var Function_22(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xF46 / 3910
{
	int iVar0;
...
void Function_23(int iParam0, int iParam1) //Position: 0x1015 / 4117
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_24(var uParam0, int iParam1) //Position: 0x105F / 4191
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_25(int iParam0) //Position: 0x1070 / 4208
{
	int iVar0;
