...
void main() //Position: 0x0 / 0
{
	...
	iLocal_115 = 0;
	Function_100(&uScriptParam_0, &iLocal_115);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_116);
		}
		iVar2 = 0;
		bLocal_123 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_5[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_5[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_5[iVar39] + 24);
							Function_84(&vLocal_5[iVar39] + 24, 1);
							...
							{
								Function_77(&(vLocal_5[iVar39]), 0);
							}
							else if (vLocal_5[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_5[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_124))
	{
		Function_103("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_124);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_115 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x498 / 1176
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_124))
								{
									...
									{
										bLocal_124 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_124 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_124))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_124))
		{
			Function_103("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_124);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_121, &uLocal_119);
...
bool Function_26(float fParam0, var uParam1) //Position: 0x1FBA / 8122
{
	uParam1 = &uParam1;
	fParam0 = &fParam0;
	if (!IS_ACTOR_PLAYER(&fParam0))
	{
		if (!DECOR_CHECK_EXIST(&fParam0, "MoveObj_AllowRun"))
		{
			if (GRINGO_ACTOR_MOVE_TO_AND_FACE(&fParam0, &Local_0, 0,1f, 0,1f, 1, 0.0f, 180.0f, 1, 0))
			{
				Local_0 = Vector(0.0f, 0.0f, 0.0f);
				return 0;
			}
		}
		SET_ACTOR_MIN_SPEED(&fParam0, 2);
		SET_ACTOR_MAX_SPEED(&fParam0, 2);
		if (GRINGO_ACTOR_MOVE_TO_AND_FACE(&fParam0, &Local_0, 0,1f, 0,1f, 2, 0.0f, 180.0f, 1, 0))
		{
			Local_0 = Vector(0.0f, 0.0f, 0.0f);
			return 0;
		}
	...
	if (!DECOR_CHECK_EXIST(&fParam0, "MoveObj_AllowRun"))
	{
		SET_ACTOR_MAX_SPEED(&fParam0, true);
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x207A / 8314
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x209A / 8346
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x20A0 / 8352
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x20B2 / 8370
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x20BF / 8383
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x20DA / 8410
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20FA / 8442
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x211A / 8474
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2151 / 8529
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2171 / 8561
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x218C / 8588
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x21A2 / 8610
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x24C6 / 9414
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x24CF / 9423
{
...
bool Function_42(char* cParam0, int iParam1) //Position: 0x24FD / 9469
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2521 / 9505
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x2547 / 9543
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2565 / 9573
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2587 / 9607
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x25A9 / 9641
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2671 / 9841
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26ED / 9965
{
...
void Function_50(vector3 vParam0) //Position: 0x2705 / 9989
{
...
var Function_51(int iParam0) //Position: 0x272A / 10026
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x274B / 10059
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2762 / 10082
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x276E / 10094
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2775 / 10101
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2786 / 10118
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27CB / 10187
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27F7 / 10231
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2803 / 10243
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2905 / 10501
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2928 / 10536
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2950 / 10576
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2C37 / 11319
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C94 / 11412
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2CF1 / 11505
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2CFD / 11517
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2D1C / 11548
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2D33 / 11571
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2DC4 / 11716
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DE8 / 11752
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2E07 / 11783
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2E2B / 11819
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F53 / 12115
{
...
int Function_74(var uParam0) //Position: 0x2F81 / 12161
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x309A / 12442
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x30A7 / 12455
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3129 / 12585
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_121)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_119));
		iLocal_121 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_78() //Position: 0x36D4 / 14036
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x370E / 14094
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x372C / 14124
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x376D / 14189
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3779 / 14201
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x379B / 14235
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x37C5 / 14277
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x38D5 / 14549
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x38ED / 14573
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3C09 / 15369
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3C1B / 15387
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C35 / 15413
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C50 / 15440
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C8E / 15502
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3CA7 / 15527
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F9F / 16287
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FBD / 16317
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x405F / 16479
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x407F / 16511
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (!IS_ACTOR_PLAYER(&iParam0))
	{
		if (!DECOR_CHECK_EXIST(&iParam0, "MoveObj_Dest"))
		{
			if (Global_6623)
			{
				uVar0 = GET_LAYOUT_FROM_OBJECT(GET_OBJECT_OWNER(GET_TARGET_OBJECT()));
			}
			else
			{
				uVar0 = &Global_46715;
			...
			{
				uVar4 = GET_OBJECT_NAME(&uVar2);
				if (STRING_CONTAINS_STRING(&uVar4, "moveobj"))
				{
					GET_OBJECT_POSITION(&uVar2, &Local_0);
					bVar3 = true;
				}
				uVar2 = OBJECT_ITERATOR_NEXT(&uVar1);
			}
			DESTROY_ITERATOR(&uVar1);
			GET_POSITION(&iParam0, &Var5);
			if (VDIST(Local_0, Var5) > 2.0f)
			{
				Local_0 = Vector(0.0f, 0.0f, 0.0f);
				return 0;
			}
			if (Function_97(StackVal, Local_0))
			{
				return 0;
			}
		}
		uVar7 = DECOR_GET_OBJECT(&iParam0, "MoveObj_Dest");
		GET_OBJECT_POSITION(&uVar7, &Local_0);
		if (Function_97(StackVal, Local_0))
		{
			return 0;
		}
...
bool Function_97(vector3 vParam0) //Position: 0x41A1 / 16801
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_98(int iParam0) //Position: 0x41B9 / 16825
{
...
void Function_99(int iParam0) //Position: 0x41D5 / 16853
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x41E1 / 16865
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_5[iLocal_1159]), &uParam0);
		iLocal_115++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x424D / 16973
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x4265 / 16997
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x4271 / 17009
{
