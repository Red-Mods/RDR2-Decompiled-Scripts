...
void main() //Position: 0x0 / 0
{
	...
	iLocal_3 = 33;
	iLocal_4 = 1;
	Local_17 = Vector(-0,857f, 129,9f, 1444,653f);
	iLocal_23 = 2;
	iLocal_24 = 4;
	fLocal_25 = 70.0f;
...
void Function_3() //Position: 0x24C / 588
{
	Function_22(56);
	Function_21();
	Function_4(13, &uLocal_11, &uLocal_13, &uLocal_5, &uLocal_15, 56);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x26C / 620
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6DE / 1758
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x712 / 1810
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA54 / 2644
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA87 / 2695
{
...
void Function_9(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xA9E / 2718
{
	var uVar0;
	bool bVar1;
...
bool Function_10(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xB64 / 2916
{
	float fVar0;
...
void Function_11(int iParam0) //Position: 0xD2D / 3373
{
...
void Function_12(int iParam0) //Position: 0xD6A / 3434
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_13(var uParam0, int iParam1) //Position: 0xD83 / 3459
{
	return (uParam0 && iParam1) == 0;
}

var Function_14(var uParam0, int iParam1) //Position: 0xD90 / 3472
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_15(int iParam0, var uParam1) //Position: 0xE85 / 3717
{
	var uVar0;
	int iVar1;
...
bool Function_16(var uParam0, int iParam1) //Position: 0xEEB / 3819
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_17(int iParam0) //Position: 0xF4D / 3917
{
	bool bVar0;
...
int Function_18(struct<209> Param0) //Position: 0xF82 / 3970
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_19(var uParam0, struct<2> Param1) //Position: 0x119B / 4507
{
	struct<2> Var0;
...
struct<8> Function_20(var uParam0) //Position: 0x1212 / 4626
{
	struct<2> Var0;
...
void Function_21() //Position: 0x127E / 4734
{
	RELEASE_LAYOUT_REF(&uLocal_0);
	return;
}

void Function_22(int iParam0) //Position: 0x128A / 4746
{
...
void Function_23(var uParam0, int iParam1) //Position: 0x12B6 / 4790
{
	int iVar0;
...
bool Function_24(var uParam0, int iParam1) //Position: 0x12D0 / 4816
{
	int iVar0;
...
void Function_25(int iParam0) //Position: 0x12ED / 4845
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x1315 / 4885
{
...
void Function_27(struct<13> Param0) //Position: 0x1460 / 5216
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x147D / 5245
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x149B / 5275
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_23 || bParam2) || Global_6611)
			{
				if (Function_149(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_147(&Param0 + 324, &fLocal_25, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_136(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_25, 20.0f, fLocal_25));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_132(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_136(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000002:
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_19(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					...
					Function_73(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_72(StackVal, StackVal, &Param0 + 16, Function_136(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				...
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				...
				while (bVar1 <= iParam3)
				{
					Function_69(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_68(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_68(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_27 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_27) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_10(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_26, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x265A / 9818
{
	...
	if (IS_ACTOR_VALID(&uLocal_11) && IS_LAYOUTREF_VALID(&uLocal_15))
	{
		if (Function_33(StackVal, &uLocal_11, Local_17, 5.0f))
		{
			if (!GET_TASK_STATUS(&uLocal_11, 19) != 1)
			{
				TASK_USE_GRINGO(&uLocal_11, GET_GRINGO_FROM_OBJECT(&uLocal_20), "UseCase2", 4294967295, 1);
			}
			if (!IS_ACTOR_IN_VOLUME(&Global_54076, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Home02Ranch03")))
			{
				Function_31(56);
			}
		}
		else if ((GET_CURRENT_GAME_TIME() - fLocal_22) < 300.0f)
		{
			Function_31(56);
		}
	}
...
void Function_31(int iParam0) //Position: 0x2706 / 9990
{
	if (!Function_24(&Global_6667[iParam028] + 184, 8388608))
	{
		Function_32(&Global_6667[iParam028] + 184, 8388608);
	}
	return;
}

void Function_32(var uParam0, int iParam1) //Position: 0x2733 / 10035
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_33(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2744 / 10052
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_20(&uParam0);
		if (VDIST(Function_20(&uParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
void Function_34(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x27D0 / 10192
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2A09 / 10761
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_36(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2A29 / 10793
{
	bool bVar0;
	var uVar1;
...
int Function_37(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2B17 / 11031
{
	char* cVar0[32];
...
int Function_38(int iParam0) //Position: 0x2D83 / 11651
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2DA7 / 11687
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_40(var uParam0, int iParam1) //Position: 0x2DCB / 11723
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_41(var uParam0, bool bParam1) //Position: 0x2DF1 / 11761
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E18 / 11800
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_43(bool bParam0) //Position: 0x2E3C / 11836
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_44() //Position: 0x2E5B / 11867
{
...
bool Function_45(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2EAA / 11946
{
	bool bVar0;
	var uVar1;
...
bool Function_46(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F06 / 12038
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_47(var uParam0, int iParam1) //Position: 0x2F27 / 12071
{
	bool bVar0;
	var uVar1;
...
void Function_48(var uParam0, var uParam1, bool bParam2) //Position: 0x2F82 / 12162
{
	bool bVar0;
	var uVar1;
...
var Function_49() //Position: 0x2FCE / 12238
{
...
void Function_50(struct<425> Param0) //Position: 0x2FE3 / 12259
{
	bool bVar0;
	bool bVar1;
...
bool Function_51(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3136 / 12598
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
bool Function_52(vector3 vParam0) //Position: 0x31AB / 12715
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_53(var uParam0) //Position: 0x31C3 / 12739
{
	bool bVar0;
	int iVar1;
...
var Function_54(bool bParam0) //Position: 0x3221 / 12833
{
	bool bVar0;
	bool bVar1;
...
void Function_55(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x326E / 12910
{
	bool bVar0;
	var uVar1;
...
void Function_56(var uParam0, bool bParam1) //Position: 0x32E7 / 13031
{
	bool bVar0;
	var uVar1;
...
void Function_57(var uParam0) //Position: 0x3336 / 13110
{
	struct<21> Var0;
	
	bVar6 = Function_67(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_59(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_58())
...
bool Function_58() //Position: 0x33F5 / 13301
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_59(struct<25> Param0) //Position: 0x3408 / 13320
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_64(Param0, 0))
	{
		uVar0 = Function_60(StackVal);
...
var Function_60(int iParam0) //Position: 0x34CF / 13519
{
...
bool Function_61(int iParam0) //Position: 0x34EF / 13551
{
...
bool Function_62(int iParam0) //Position: 0x3513 / 13587
{
...
bool Function_63(int iParam0) //Position: 0x3528 / 13608
{
...
bool Function_64(int iParam0, bool bParam1) //Position: 0x353F / 13631
{
	int iVar0;
...
var Function_65(int iParam0) //Position: 0x357D / 13693
{
...
bool Function_66(int iParam0) //Position: 0x3597 / 13719
{
...
int Function_67(int iParam0, struct<6> Param1) //Position: 0x35AD / 13741
{
	int iVar0;
...
void Function_68(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x35E7 / 13799
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_69(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x36CC / 14028
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_70(var uParam0, bool bParam1) //Position: 0x3883 / 14467
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_71(bool bParam0) //Position: 0x38A8 / 14504
{
	var uVar0;
	int iVar1;
...
var Function_72(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x38F6 / 14582
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_73(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3A4D / 14925
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_74(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_74(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3AF8 / 15096
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_75(int iParam0, int iParam1) //Position: 0x3B9E / 15262
{
	Function_100(&uLocal_5, "$/content/scripting/gringo/simplegringo/spyGlass", 1, 0);
	if (Function_82(&uLocal_11, &uLocal_5, 56, 1, 1, 0, 1, 0, 0, 0, 0))
	{
		if (Function_79(&iParam1))
		{
			uLocal_13 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_0, Function_136()));
			*(&Global_6667[5628] + 216) = &uLocal_13;
			*(&iParam0 + 24) = &uLocal_0;
			Function_76();
			return 1;
		}
...
void Function_76() //Position: 0x3C2A / 15402
{
	var uVar0;
	
	uLocal_15 = CREATE_LAYOUT("home02ranch03campfirelayout");
	UNK_0x44986367(&uVar0, 293,849f);
	uLocal_20 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_15, "home02ranch03look", "spyGlass", Local_17, Vector(0.0f, 293.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uLocal_20, 2.0f, false, 1092616192);
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uLocal_20), 0);
	MEMORY_PREFER_RIDING(&uLocal_11, false);
	MEMORY_PREFER_WALKING(&uLocal_11, 1);
	if (GET_TASK_STATUS(&uLocal_11, 0) != 1)
	{
		if (!Function_33(StackVal, &Global_54076, Local_17, 100.0f))
		{
			SNAP_ACTOR_TO_GRINGO(&uLocal_11, &uLocal_20, "UseCase1", true, 0, 0);
			TASK_USE_GRINGO(&uLocal_11, GET_GRINGO_FROM_OBJECT(&uLocal_20), "UseCase2", 4294967295, 1);
			Function_31(56);
		}
		else
		{
			TASK_GO_NEAR_COORD(&uLocal_11, &Local_17, 2.0f, 1);
		}
	}
	Function_77(&uLocal_11, &uLocal_13, 1, 1);
	Function_31(56);
	return;
}

void Function_77(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3D2A / 15658
{
	bool bVar0;
	int iVar1;
...
bool Function_78(int iParam0, int iParam1, bool bParam2) //Position: 0x3EE7 / 16103
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_79(var uParam0) //Position: 0x3F2F / 16175
{
	var uVar0;
	
	Function_81(3, 2);
	uVar0 = &uVar0;
	uLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("home02ranch_camp03_mobile"));
	Function_80(&uLocal_0, &uParam0);
	return 1;
}

void Function_80(int iParam0, var uParam1) //Position: 0x3F6F / 16239
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &uParam1, Function_136(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
void Function_81(int iParam0, bool bParam1) //Position: 0x3FBA / 16314
{
	switch (&bParam1)
	{
		case 0x00000000:
...
bool Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4004 / 16388
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (StackVal || !Function_33((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		...
		if (Function_96(iVar1))
		{
			if (Function_103(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_83(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x41E3 / 16867
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_94(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		if (&bParam6)
		{
			bVar1 = Function_91(&Global_15402[iParam014] + 16, &uParam7);
		}
		if (&bParam8)
		{
			bVar1 = Function_86(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_84(var uParam0, bool bParam1) //Position: 0x4723 / 18211
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_85(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4745 / 18245
{
	var uVar0;
...
var Function_86(bool bParam0, int iParam1) //Position: 0x47A6 / 18342
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x4834 / 18484
{
	Function_89(&uParam0);
	Function_88(&uParam0);
...
void Function_88(int iParam0) //Position: 0x4860 / 18528
{
...
void Function_89(int iParam0) //Position: 0x4886 / 18566
{
...
bool Function_90(bool bParam0) //Position: 0x495C / 18780
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x4973 / 18803
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4A19 / 18969
{
	var uVar0;
	var uVar1;
...
void Function_93(var uParam0) //Position: 0x4B28 / 19240
{
	int iVar0;
...
bool Function_94(int iParam0, int iParam1) //Position: 0x4B5B / 19291
{
	int iVar0;
...
void Function_95() //Position: 0x4B78 / 19320
{
	var uVar0;
	int iVar1;
...
bool Function_96(int iParam0) //Position: 0x4BE8 / 19432
{
	if (!Function_97(iParam0))
	{
		return 1;
	}
	return Function_94(&(Global_43791[iParam0]), 4);
}

bool Function_97(int iParam0) //Position: 0x4C04 / 19460
{
...
var Function_98(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4C1A / 19482
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_99(struct<205> Param0) //Position: 0x4CC0 / 19648
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_24(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_60(Function_65(Param0.f_188));
...
var Function_100(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4DCB / 19915
{
	int iVar0;
	int iVar1;
...
void Function_101(struct<13> Param0) //Position: 0x4E09 / 19977
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_102(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4E1C / 19996
{
	int iVar0;
...
bool Function_103(struct<2>[] Param0) //Position: 0x4EEB / 20203
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x52AD / 21165
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x52ED / 21229
{
	int iVar0;
...
void Function_106() //Position: 0x531B / 21275
{
	if (!Function_151(128))
	{
		return;
...
void Function_107(vector3 vParam0) //Position: 0x535D / 21341
{
	char* cVar0[32];
...
void Function_108(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x53F5 / 21493
{
	var uVar0;
	var uVar1;
...
void Function_109(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5424 / 21540
{
...
var Function_110(var uParam0, bool bParam1) //Position: 0x547F / 21631
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_111() //Position: 0x548F / 21647
{
	return "PackedGrass";
}

var Function_112(bool bParam0, bool bParam1, bool bParam2) //Position: 0x54A3 / 21667
{
	int iVar0;
...
var Function_113() //Position: 0x54C8 / 21704
{
	return "PackedMetadata";
}

void Function_114(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x54DF / 21727
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_115() //Position: 0x561B / 22043
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_116() //Position: 0x562D / 22061
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_117() //Position: 0x563F / 22079
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_118(var uParam0, struct<5> Param1) //Position: 0x5651 / 22097
{
...
var Function_119(var uParam0, int iParam1, int iParam2) //Position: 0x5676 / 22134
{
	int iVar0;
...
var Function_120(bool bParam0) //Position: 0x5695 / 22165
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_121() //Position: 0x56A1 / 22177
{
	return Function_122(39);
}

int Function_122(int iParam0) //Position: 0x56AC / 22188
{
	int iVar0;
...
var Function_123() //Position: 0x56DA / 22234
{
	return "PackedWeapon";
}

int Function_124(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x56EF / 22255
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_125() //Position: 0x57FC / 22524
{
	return "MPItemGiver";
}

struct<32> Function_126(char* cParam0) //Position: 0x5810 / 22544
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_127(char* cParam0) //Position: 0x587C / 22652
{
	char* cVar0[32];
...
var Function_128() //Position: 0x589E / 22686
{
	return "PBox_";
}

var Function_129() //Position: 0x58AC / 22700
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_130() //Position: 0x58D2 / 22738
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_131() //Position: 0x58FA / 22778
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_132(var uParam0, int iParam1) //Position: 0x5920 / 22816
{
	int iVar0;
	var uVar1;
...
void Function_133(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5A8A / 23178
{
	struct<8> Var0;
...
int Function_134(bool bParam0) //Position: 0x5B32 / 23346
{
	int iVar0;
	struct<2> Var1;
...
void Function_135(int iParam0) //Position: 0x5CA0 / 23712
{
...
var Function_136() //Position: 0x5D08 / 23816
{
	int iVar0;
...
var Function_137(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5D11 / 23825
{
	return Function_138(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5D2F / 23855
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_139(int iParam0) //Position: 0x6028 / 24616
{
	int iVar0;
...
void Function_140() //Position: 0x60DC / 24796
{
	int iVar0;
...
bool Function_141(bool bParam0) //Position: 0x6117 / 24855
{
	int iVar0;
...
void Function_142(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6144 / 24900
{
	int iVar0;
...
void Function_143() //Position: 0x629F / 25247
{
	int iVar0;
...
var Function_144(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x62EB / 25323
{
	int iVar0;
...
int Function_145() //Position: 0x63C7 / 25543
{
	int iVar0;
...
int Function_146() //Position: 0x6523 / 25891
{
	int iVar0;
...
bool Function_147(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6643 / 26179
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_148(struct<2> Param0) //Position: 0x671F / 26399
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_149(struct<2> Param0, struct<5> Param2) //Position: 0x673E / 26430
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_150(int iParam0) //Position: 0x6881 / 26753
{
	var uVar0;
...
bool Function_151(int iParam0) //Position: 0x68A3 / 26787
{
	int iVar0;
...
int Function_152() //Position: 0x68BF / 26815
{
	return 0;
}

void Function_153(struct<321> Param0) //Position: 0x68C6 / 26822
{
	var uVar0;
