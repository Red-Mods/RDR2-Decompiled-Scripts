...
void Function_1(int iParam0, struct<11> Param1) //Position: 0xFE / 254
{
	struct<2> Var0;
	struct<2> Var2;
	var uVar4;
...
var Function_2(int iParam0) //Position: 0x19E / 414
{
	int iVar0;
	var uVar1;
	var uVar2;
...
int Function_3(struct<37> Param0) //Position: 0x31B / 795
{
	var uVar0;
	var uVar1;
	var uVar2;
...
struct<8> Function_4(int iParam0, int iParam1) //Position: 0x417 / 1047
{
	struct<2> Var0;
	var uVar11;
	struct<2> Var12;
...
bool Function_5(struct<2> Param0, struct<2> Param2) //Position: 0x6E3 / 1763
{
	struct<2> Var0;
...
int Function_6(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) //Position: 0x70F / 1807
{
	int iVar0;
...
int Function_10(int iParam0, struct<69> Param1) //Position: 0x841 / 2113
{
	int iVar0;
	struct<2> Var1;
	var uVar3;
...
bool Function_11(float fParam0, int iParam1) //Position: 0x1957 / 6487
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_12(int iParam0) //Position: 0x1983 / 6531
{
	var uVar0;
	int iVar1;
...
void Function_13(int iParam0, int iParam1, int iParam2) //Position: 0x19CD / 6605
{
	struct<5> Var0;
...
int Function_14(int iParam0, int iParam1) //Position: 0x19F6 / 6646
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
int Function_15(int iParam0, int iParam1) //Position: 0x1A09 / 6665
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_16(int iParam0, int iParam1, var uParam2) //Position: 0x1A1C / 6684
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_17(int iParam0) //Position: 0x1BF1 / 7153
{
	int iVar0;
	int iVar1;
...
float Function_18(vector3 vParam0) //Position: 0x1C20 / 7200
{
...
bool Function_19(int iParam0) //Position: 0x1CED / 7405
{
	return Function_20(iParam0, 2);
}

int Function_20(var uParam0, int iParam1) //Position: 0x1CFB / 7419
{
	return (uParam0 && iParam1) == 0;
}

bool Function_21(int iParam0) //Position: 0x1D08 / 7432
{
	return Function_20(iParam0, 1);
}

bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1D16 / 7446
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_23(int iParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x1DA8 / 7592
{
	int iVar0;
...
void Function_24(int iParam0) //Position: 0x1FF9 / 8185
{
...
void Function_25(int iParam0) //Position: 0x201F / 8223
{
...
void Function_26(int iParam0, int iParam1) //Position: 0x20A2 / 8354
{
	if (Function_9(&iParam0))
	{
		LOG_ERROR(&iParam1);
...
bool Function_27(int iParam0) //Position: 0x20B7 / 8375
{
	var uVar0;
	var uVar1;
...
void Function_28(int iParam0, var uParam1, int iParam2) //Position: 0x2101 / 8449
{
	if (Function_9(&iParam0))
	{
...
bool Function_29(struct<11> Param0) //Position: 0x215E / 8542
{
...
void Function_30(struct<2> Param0, var uParam2, var uParam3) //Position: 0x217A / 8570
{
	struct<2> Var0;
	var uVar2;
	float fVar4;
...
bool Function_31(vector3 vParam0) //Position: 0x22C0 / 8896
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

void Function_32(struct<2> Param0, var uParam2, var uParam3) //Position: 0x22D8 / 8920
{
	struct<2> Var0;
	var uVar2;
	float fVar4;
...
void Function_33(struct<2> Param0, var uParam2, float fParam3) //Position: 0x23E6 / 9190
{
	var uVar0;
	var uVar2;
...
void Function_34(vector3 vParam0) //Position: 0x2418 / 9240
{
	if (fParam2 >= 0.0f)
	{
		fParam2 = 1.0f;
...
void Function_35(int iParam0) //Position: 0x248A / 9354
{
...
void Function_36(vector3 vParam0) //Position: 0x24A1 / 9377
{
...
void Function_37(var uParam0, int iParam1) //Position: 0x24C6 / 9414
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, int iParam1) //Position: 0x24DC / 9436
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_39(vector3 vParam0) //Position: 0x24ED / 9453
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
var Function_40(int iParam0, int iParam1, var uParam2, var uParam3, struct<2> Param4, float fParam6, bool bParam7, bool bParam8) //Position: 0x2504 / 9476
{
	var uVar0;
	float fVar1;
	var uVar2;
...
var Function_41(float fParam0, bool bParam1, bool bParam2) //Position: 0x2CBF / 11455
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
var Function_42() //Position: 0x2DB9 / 11705
{
	int iVar0;
...
var Function_43(int iParam0, var uParam1, int iParam2) //Position: 0x2DC2 / 11714
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_44(int iParam0) //Position: 0x2FA3 / 12195
{
	int iVar0;
	var uVar11;
...
var Function_45() //Position: 0x2FF7 / 12279
{
	return StackVal;
}

void Function_46(int iParam0) //Position: 0x3002 / 12290
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (!IS_VOLUME_VALID(&(uLocal_6[1])))
	{
		uVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Banker_Vols", 0, &iParam0);
		uVar2 = GRINGO_GET_FIRST_NAMED_CHILD("Volumes", 0, &uVar1);
		uVar3 = GRINGO_GET_ATTRIBUTE(&uVar2, 0);
		uVar5 = GRINGO_GET_STRING_ATTR_BY_HANDLE(&uVar3, &uVar4);
		uLocal_6[1] = FIND_VOLUME_IN_LAYOUT(&Global_46715, &uVar5);
		return;
	}
	if (IS_ACTOR_IN_VOLUME(&Global_54076, &(uLocal_6[1])) && &iLocal_2 == &Global_54076)
	{
		iLocal_2 = &Global_54076;
		fLocal_0 = GET_CURRENT_GAME_TIME();
		SAY_SINGLE_LINE_CONTEXT(&uVar0, 341, &Global_54076, 0, 0, 0, 4294967295, 4294967295, 0, 1);
		return;
	}
	if (!IS_VOLUME_VALID(&(uLocal_6[0])))
	{
		uVar6 = GRINGO_GET_FIRST_NAMED_CHILD("Banker_Vols", 0, &iParam0);
		uVar7 = GRINGO_GET_FIRST_NAMED_CHILD("Volumes", 0, &uVar6);
		uVar8 = GRINGO_GET_ATTRIBUTE(&uVar7, 1);
		uVar10 = GRINGO_GET_STRING_ATTR_BY_HANDLE(&uVar8, &uVar9);
		uLocal_6[0] = FIND_VOLUME_IN_LAYOUT(&Global_46715, &uVar10);
		return;
	}
	uVar11 = CREATE_OBJECTSET_IN_LAYOUT(Function_42(), &Global_46715, 15, 0);
	LOCATE_ACTORS_IN_VOLUME(&(uLocal_6[0]), &uVar11, 0, 1);
	if (GET_OBJECTSET_SIZE(&uVar11) != 0)
	{
		iVar12 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(0, &uVar11));
		if (&iVar12 != &iLocal_4)
		{
			iLocal_4 = &iVar12;
			fLocal_0 = GET_CURRENT_GAME_TIME();
			GET_POSITION(&uVar0, &Var13);
			GET_ACTOR_AXIS(&Global_54076, &uVar17, 0);
			GET_POSITION(&Global_54076, &Var15);
			uVar19 = Vector(StackVal, StackVal, StackVal) - Vector(Var15, Var13, StackVal);
			VNORMALIZE(&uVar19);
			if (VDOT(&uVar19, &uVar17) <= 0.0f)
			{
				SAY_SINGLE_LINE_CONTEXT(&uVar0, 339, &iLocal_4, 0, 0, 0, 4294967295, 4294967295, 0, 1);
				return;
			}
			SAY_SINGLE_LINE_CONTEXT(&uVar0, 340, &iLocal_4, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			return;
		}
		fLocal_0 = GET_CURRENT_GAME_TIME();
		GET_POSITION(&uVar0, &Var21);
		GET_ACTOR_AXIS(&Global_54076, &uVar25, 0);
		GET_POSITION(&Global_54076, &Var23);
		uVar27 = Vector(StackVal, StackVal, StackVal) - Vector(Var23, Var21, StackVal);
		VNORMALIZE(&uVar27);
		fVar29 = VDOT(&uVar27, &uVar25);
		if (fVar29 <= 0.0f && !iLocal_1)
		{
			SAY_SINGLE_LINE_CONTEXT(&uVar0, 339, &iLocal_4, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			iLocal_1 = 1;
			return;
		}
		if (iLocal_1 && fVar29 > 0.0f)
		{
			SAY_SINGLE_LINE_CONTEXT(&uVar0, 340, &iLocal_4, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			iLocal_1 = 0;
			return;
	...
	DESTROY_OBJECTSET(&uVar11);
	if ((GET_CURRENT_GAME_TIME() - fLocal_0) <= 15.0f)
	{
		fLocal_0 = GET_CURRENT_GAME_TIME();
		SAY_SINGLE_LINE_CONTEXT(&uVar0, 338, 0, 0, 0, 0, 4294967295, 4294967295, 0, 1);
		return;
	}
	return;
}

bool Function_47(int iParam0) //Position: 0x3275 / 12917
{
	var uVar0;
	var uVar1;
...
var Function_48() //Position: 0x32BE / 12990
{
	return GET_PERS_CHAR_FROM_OBJECT(GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF()));
}

bool Function_49(int iParam0) //Position: 0x32CD / 13005
{
	var uVar0;
	int iVar1;
	bool bVar2;
