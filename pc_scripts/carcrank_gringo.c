...
void main() //Position: 0x0 / 0
{
	...
	iLocal_54 = 0;
	Function_107(&uScriptParam_0, &iLocal_54);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_55);
		}
		iVar2 = 0;
		bLocal_62 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_100(&(vLocal_16[iVar39]), &bVar4))
						{
							Function_98(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_16[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_91("eGRINGO_EndUse: Stop use by request", &vLocal_16[iVar39] + 24);
							Function_90(&vLocal_16[iVar39] + 24, 1);
							...
							{
								Function_82(&(vLocal_16[iVar39]), 0);
							}
							else if (vLocal_16[iVar39].f_68 < 8)
							{
								Function_81(&(vLocal_16[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&fLocal_63))
	{
		Function_110("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&fLocal_63);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_54 - 1))
	{
		if (Function_80(vLocal_16[iVar09].f_64, 2))
		{
			...
			Function_82(&(vLocal_16[iVar09]), 0);
		}
...
void Function_5(struct<69> Param0) //Position: 0x499 / 1177
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&fLocal_63))
								{
									...
									{
										fLocal_63 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										fLocal_63 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&fLocal_63))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&fLocal_63))
		{
			Function_110("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&fLocal_63);
		}
...
bool Function_16(struct<69> Param0) //Position: 0xAD9 / 2777
{
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_78(&Param0 + 16, &fVar22))
				{
			...
			{
				if (Function_73(&Param0 + 24, &Param0 + 16))
				{
			...
			if (!Function_71(&Param0 + 16) && Param0.f_68 != 1)
			{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_80(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_80(Param0.f_64, 1))
			{
				Function_63(&Param0 + 16, &Var3, &uVar5);
				if (!Function_80(Param0.f_64, 16))
				{
				...
				if (!Function_80(Param0.f_64, 1024))
				{
			...
			else if (Function_73(&Param0 + 24, &Param0 + 16))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 1);
			...
			if (Param0.f_68 != 3 && !Function_80(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_80(Param0.f_64, 1);
			}
			fVar0 = Function_55(&Param0 + 24, &Param0 + 16, bVar29);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_45(&Param0, &uVar7, &iLocal_60, &uLocal_58);
		...
		case 0x00000006:
			...
			fVar0 = Function_55(&Param0 + 24, &Param0 + 16, Function_80(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&fVar0))
			{
...
bool Function_26(int iParam0, int iParam1) //Position: 0x1FBB / 8123
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		...
		{
			case 0x00000000:
				Function_91("Mini-Game Started", &iParam0);
				fLocal_9 = 0.0f;
				fLocal_10 = 0.0f;
				iLocal_15 = 0;
				START_MINIGAME(4);
				...
				EVENT_TRAP_CLEAR_TRAP_FLAG(&uLocal_3);
				EVENT_TRAP_CLEAR_TRAP_FLAG(&fLocal_5);
				uLocal_11 = GET_OBJECT_ANIMATOR_ON_OBJECT(GET_TARGET_OBJECT());
				if (IS_OBJECT_ANIMATOR_VALID(&uLocal_11))
				{
					LINK_OBJECT_ANIMATOR_TO_ACTOR(&uLocal_11, &iParam0, false);
				}
				else
				{
				...
				uLocal_13 = ADD_SCRIPT_USE_CONTEXT("carcrank_stop", 100, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
				Function_32(StackVal, StackVal, GET_TARGET_OBJECT(), Vector(0.0f, 0,5f, -3.0f), Vector(0.0f, 0,5f, -2,5f), -1.0f, 0, 0);
				iLocal_2 = 1;
				return 1;
				break;
			
			case 0x00000001:
				if (IS_SCRIPT_USE_CONTEXT_PRESSED(&uLocal_13))
				{
					Function_91("Mini-Game Stopped", &iParam0);
					iLocal_7 = 10;
					iLocal_8 = 0;
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_13);
					END_CURRENT_MINIGAME();
					iLocal_2 = 2;
					return 1;
				}
				if (EVENT_TRAP_SUCCESSFUL_TRAP(&uLocal_3))
				{
					Function_91("Mini-Game Succeeded", &iParam0);
					iLocal_8 = 1;
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_13);
				...
				if (EVENT_TRAP_SUCCESSFUL_TRAP(&fLocal_5))
				{
					Function_91("Mini-Game Failed", &iParam0);
					iLocal_7++;
					iLocal_8 = 0;
					RELEASE_SCRIPT_USE_CONTEXT(&uLocal_13);
				...
				fVar1 = GET_ANALOGUE_ACTION("@GENERIC.MOVE_Y", 1);
				if (FABS(fVar1) != 0.0f)
				{
					fVar1 = 1.0f;
				}
				fVar2 = (ATAN2_DEGREE(fVar0, -fVar1) + 180.0f);
				fVar3 = (fVar2 - fLocal_9);
				fVar4 = FABS(fVar3);
				if (fVar4 < 180.0f)
				{
					if (fVar3 < 0.0f)
				...
				{
					fLocal_9 = (fLocal_9 + fVar3);
				}
				if (fLocal_9 <= 360.0f)
				{
					fLocal_9 = (fLocal_9 - 360.0f);
				}
				else if (fLocal_9 > 0.0f)
				{
					fLocal_9 = 0.0f;
				}
				fLocal_10 = (fLocal_9 / 360.0f);
				SET_PANIM_PHASE(&iParam0, fLocal_10);
				SET_OBJECT_ANIMATOR_RATE(&uLocal_11, 0.0f);
				SET_OBJECT_ANIMATOR_PHASE(&uLocal_11, fLocal_10);
				break;
			
			case 0x00000002:
				if (fLocal_10 != 0.0f || fLocal_10 != 1.0f)
				{
					Function_91("Mini-Game Finished", &iParam0);
					if (iLocal_8 || iLocal_7 <= 10)
					{
						iLocal_15 = 0;
						iLocal_2 = 3;
						return 1;
				...
				if (fLocal_10 < 0,5f)
				{
					if (fLocal_10 >= 0,95f)
					{
						fLocal_10 = (fLocal_10 + 0,05f);
					}
					else if (fLocal_10 > 1.0f)
					{
						fLocal_10 = 1.0f;
					}
				}
				else if (fLocal_10 <= 0,05f)
				{
					fLocal_10 = (fLocal_10 - 0,05f);
				}
				else if (fLocal_10 < 0.0f)
				{
					fLocal_10 = 0.0f;
				}
				SET_PANIM_PHASE(&iParam0, fLocal_10);
			...
			case 0x00000003:
				Function_91("Mini-Game Done", &iParam0);
				iLocal_15 = 0;
				DESTROY_OBJECT(&uLocal_3);
				DESTROY_OBJECT(&fLocal_5);
				DESTROY_OBJECT_ANIMATOR(&uLocal_11);
				Function_32(StackVal, StackVal, GET_TARGET_OBJECT(), Vector(0.0f, 1.0f, -4.0f), Vector(0.0f, 1.0f, -2,5f), -1.0f, 0, 0);
				iLocal_2 = 3;
				return 0;
				break;
			}
...
void Function_27() //Position: 0x2487 / 9351
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
bool Function_28() //Position: 0x249C / 9372
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_29(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x24C9 / 9417
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_30(int iParam0) //Position: 0x2554 / 9556
{
	char* cVar0[16];
...
bool Function_31() //Position: 0x2593 / 9619
{
	if (Function_80(Global_131807.f_1304, 1024))
	{
...
void Function_32(float fParam0, struct<2> Param1, struct<2> Param3, float fParam5, int iParam6, int iParam7) //Position: 0x25AE / 9646
{
	Function_33(GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&Global_99148, 0));
...
void Function_33(int iParam0) //Position: 0x26E2 / 9954
{
...
bool Function_34(bool bParam0) //Position: 0x26F5 / 9973
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_35() //Position: 0x2715 / 10005
{
	return;
}

void Function_36(int iParam0, bool bParam1) //Position: 0x271B / 10011
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_37(int iParam0) //Position: 0x272D / 10029
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_38(int iParam0) //Position: 0x273A / 10042
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_39(int iParam0, int iParam1) //Position: 0x2755 / 10069
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_40(int iParam0) //Position: 0x2775 / 10101
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_41(int iParam0) //Position: 0x2795 / 10133
{
	int iVar0;
	int iVar1;
...
bool Function_42(int iParam0) //Position: 0x27CC / 10188
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_43(int iParam0) //Position: 0x27EC / 10220
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2807 / 10247
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_45(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x281D / 10269
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_46() //Position: 0x2B41 / 11073
{
	int iVar0;
...
bool Function_47(int iParam0, int iParam1) //Position: 0x2B4A / 11082
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_48() //Position: 0x2B69 / 11113
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_49(int iParam0, int iParam1) //Position: 0x2B78 / 11128
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_50(int iParam0, int iParam1) //Position: 0x2B9C / 11164
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_51(int iParam0) //Position: 0x2BC2 / 11202
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_52(var uParam0, int iParam1) //Position: 0x2BE0 / 11232
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_53(var uParam0, int iParam1) //Position: 0x2C02 / 11266
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_54(int iParam0, int iParam1) //Position: 0x2C24 / 11300
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_55(var uParam0, int iParam1, bool bParam2) //Position: 0x2CEC / 11500
{
	int iVar0;
...
void Function_56(int iParam0, float fParam1) //Position: 0x2D68 / 11624
{
...
void Function_57(vector3 vParam0) //Position: 0x2D80 / 11648
{
...
var Function_58(int iParam0) //Position: 0x2DA5 / 11685
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_59(vector3 vParam0) //Position: 0x2DC6 / 11718
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_60(var uParam0) //Position: 0x2DDD / 11741
{
	uParam0 = &uParam0;
	return;
}

int Function_61() //Position: 0x2DE9 / 11753
{
	return 1;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2DF0 / 11760
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_63(int iParam0, var uParam1, int iParam2) //Position: 0x2E01 / 11777
{
	float fVar0;
...
int Function_64(int iParam0) //Position: 0x2E46 / 11846
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_65(int iParam0) //Position: 0x2E72 / 11890
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_66(int iParam0) //Position: 0x2E7E / 11902
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_67(int iParam0) //Position: 0x2F80 / 12160
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_68(int iParam0) //Position: 0x2FA3 / 12195
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_69(int iParam0) //Position: 0x2FCB / 12235
{
	iParam0 = &iParam0;
	return;
}

void Function_70(int iParam0) //Position: 0x2FD7 / 12247
{
	iParam0 = &iParam0;
	return;
}

bool Function_71(int iParam0) //Position: 0x2FE3 / 12259
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_72(int iParam0) //Position: 0x3002 / 12290
{
	if (!Function_14(&iParam0))
	{
...
bool Function_73(var uParam0, int iParam1) //Position: 0x3019 / 12313
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
	...
	{
		return Function_77(&uParam0, &iParam1);
	}
	uVar3 = Function_76(&iParam1);
	uVar4 = Function_64(&iParam1);
	Function_74(&iParam1);
	iVar5 = Function_74(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, fVar2, uVar4, 0, 0);
}

struct<8> Function_74(int iParam0) //Position: 0x30AA / 12458
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_75(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_75(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_75(var uParam0, var uParam1, struct<2> Param2) //Position: 0x30CE / 12494
{
	struct<2> Var0;
...
int Function_76(int iParam0) //Position: 0x30ED / 12525
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_77(var uParam0, int iParam1) //Position: 0x3111 / 12561
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar0 = Function_76(&iParam1);
	uVar1 = Function_64(&iParam1);
...
bool Function_78(var uParam0, int iParam1) //Position: 0x3239 / 12857
{
...
int Function_79(var uParam0) //Position: 0x3267 / 12903
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_80(var uParam0, int iParam1) //Position: 0x3380 / 13184
{
	return (uParam0 && iParam1) == 0;
}

void Function_81(struct<69> Param0) //Position: 0x338D / 13197
{
	if (Function_80(Param0.f_64, 16))
	{
...
void Function_82(struct<69> Param0) //Position: 0x340F / 13327
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_80(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_88(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_80(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_80(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_87(&Param0 + 16) && Function_80(Param0.f_64, 512))
			{
	...
	if (&Param0 + 16 == &iLocal_60)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_58));
		iLocal_60 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_43(&Param0 + 16))
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_84(&Param0 + 16), &Param0 + 16);
	}
...
void Function_83() //Position: 0x39BA / 14778
{
	return;
}

int Function_84(int iParam0) //Position: 0x39C0 / 14784
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_85(int iParam0, var uParam1) //Position: 0x39DE / 14814
{
	var uVar0;
	var uVar1;
	int iVar2;
	
	Function_53(&iParam0 + 16, &uVar0);
	Function_52(&iParam0 + 16, &uVar1);
	iVar2 = Function_51(&iParam0 + 16);
...
void Function_86(int iParam0) //Position: 0x3A1F / 14879
{
	iParam0 = &iParam0;
	return;
}

bool Function_87(int iParam0) //Position: 0x3A2B / 14891
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_88(int iParam0, float fParam1) //Position: 0x3A4D / 14925
{
	fParam1 = &fParam1;
	iParam0 = &iParam0;
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		Function_91("Mini-Game Cleanup", &iParam0);
		iLocal_15 = 2000;
		...
		if (IS_OBJECT_VALID(&uLocal_3))
		{
			DESTROY_OBJECT(&uLocal_3);
		}
		if (IS_OBJECT_VALID(&fLocal_5))
		{
			DESTROY_OBJECT(&fLocal_5);
		}
		if (IS_OBJECT_ANIMATOR_VALID(&uLocal_11))
		...
		if (IS_SCRIPT_USE_CONTEXT_VALID(&uLocal_13))
		{
			RELEASE_SCRIPT_USE_CONTEXT(&uLocal_13);
		}
		if (iLocal_8)
		{
			DECOR_SET_BOOL(GET_TARGET_OBJECT(), "carCranked", 1);
		}
	}
...
void Function_89() //Position: 0x3B16 / 15126
{
...
void Function_90(var uParam0, bool bParam1) //Position: 0x3C48 / 15432
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_91(int iParam0, int iParam1) //Position: 0x3D58 / 15704
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_92(struct<69> Param0) //Position: 0x3D70 / 15728
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_93(int iParam0, float fParam1) //Position: 0x408C / 16524
{
	fParam1 = &fParam1;
	iParam0 = &iParam0;
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		Function_91("Mini-Game Init", &iParam0);
		iLocal_7 = 0;
		iLocal_8 = 0;
		iLocal_15 = 0;
		...
		Function_32(StackVal, StackVal, GET_TARGET_OBJECT(), Vector(0.0f, 1.0f, -4.0f), Vector(0.0f, 1.0f, -2,5f), -1.0f, 0, 0);
		uLocal_3 = CREATE_EVENT_TRAP("CrankMiniGameSucceeded", 55, GRINGO_GET_MY_OBJECT_REF());
		fLocal_5 = CREATE_EVENT_TRAP("CrankMiniGameFailed", 56, GRINGO_GET_MY_OBJECT_REF());
		iLocal_2 = 0;
		return;
	}
	return;
...
void Function_94(var uParam0, var uParam1, bool bParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, var uParam13) //Position: 0x4161 / 16737
{
	Function_95(0, 1);
	Global_99148 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, Function_46(), 2, 1);
...
void Function_95(bool bParam0, bool bParam1) //Position: 0x426A / 17002
{
	if (&bParam0)
	{
		if (VMAG(*(&Global_99148 + 48)) < 0.0f)
...
bool Function_96(int iParam0) //Position: 0x42C0 / 17088
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_97(int iParam0) //Position: 0x42DA / 17114
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_98(int iParam0, var uParam1) //Position: 0x42F5 / 17141
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_99(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_99(var uParam0, int iParam1) //Position: 0x4333 / 17203
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_100(struct<65> Param0) //Position: 0x434C / 17228
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_101(int iParam0) //Position: 0x4644 / 17988
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_102(var uParam0, int iParam1) //Position: 0x4662 / 18018
{
	struct<5> Var0;
	float fVar5;
...
int Function_103(int iParam0) //Position: 0x4702 / 18178
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_104(int iParam0, var uParam1) //Position: 0x4722 / 18210
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_105(int iParam0) //Position: 0x4735 / 18229
{
...
void Function_106(int iParam0) //Position: 0x4751 / 18257
{
	iParam0 = &iParam0;
	return;
}

void Function_107(var uParam0, int iParam1) //Position: 0x475D / 18269
{
	int iVar0;
	var uVar1;
	...
	{
		Function_108(&(vLocal_16[iLocal_549]), &uParam0);
		iLocal_54++;
	}
...
void Function_108(int iParam0, int iParam1) //Position: 0x47C9 / 18377
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_109(int iParam0) //Position: 0x47E1 / 18401
{
	iParam0 = &iParam0;
	return;
}

void Function_110(int iParam0) //Position: 0x47ED / 18413
{
