...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	if (DECOR_CHECK_EXIST(&uParam1, "phosphorous"))
	{
		Function_69("item_phos_still_on", 0x41200000, 1, 0, 2, 1, 0);
		return;
	}
	bVar1 = 491;
	if (!HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		if (Function_28(498) >= Function_28(bVar1))
		{
			bVar1 = 498;
		}
		if (Function_28(496) >= Function_28(bVar1))
		{
			bVar1 = 496;
		}
		if (Function_28(bVar1) == 0)
		{
			Function_69("item_phos_more_sage", 0x41200000, 1, 0, 2, 1, 0);
			bVar2 = true;
		}
		if (Function_28(497) == 0)
		{
			Function_69("item_phos_more_snow", 0x41200000, 1, 0, 2, 1, 0);
			bVar2 = true;
		}
		if (bVar2)
		{
	...
	DECOR_SET_FLOAT(&uParam1, "phosphorous", bVar0);
	if (!HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		Function_59(bVar1, 1);
		Function_59(497, 1);
	}
	Function_57(667, 1, 0, 0);
	iParam2 = 1;
	return;
}

int Function_57(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2E66 / 11878
{
	int iVar0;
	int iVar1;
...
void Function_58(int iParam0) //Position: 0x308E / 12430
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_59(int iParam0, bool bParam1) //Position: 0x312C / 12588
{
	bool bVar0;
	int iVar1;
...
int Function_60() //Position: 0x32D7 / 13015
{
	int iVar0;
...
void Function_61() //Position: 0x3378 / 13176
{
	int iVar0;
	int iVar1;
...
void Function_62(int iParam0) //Position: 0x3436 / 13366
{
...
var Function_63(int iParam0, int iParam1) //Position: 0x349C / 13468
{
	int iVar0;
...
int Function_64(int iParam0, bool bParam1, int iParam2) //Position: 0x34E1 / 13537
{
	int iVar0;
	int iVar1;
...
int Function_65(int iParam0, bool bParam1, bool bParam2) //Position: 0x36DE / 14046
{
...
bool Function_66() //Position: 0x37A2 / 14242
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_67(int iParam0) //Position: 0x37B9 / 14265
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_68(int iParam0) //Position: 0x37C5 / 14277
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_69(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x37D4 / 14292
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_70(int iParam0) //Position: 0x385F / 14431
{
	char* cVar0[16];
...
var Function_71(int iParam0) //Position: 0x389E / 14494
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_72(int iParam0, int iParam1) //Position: 0x38B9 / 14521
{
	var uVar0;
	var uVar1;
