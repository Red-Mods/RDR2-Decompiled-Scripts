...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_8(0, &iLocal_17, &iLocal_21, &uLocal_3, &uLocal_25, 4294967295);
	if (Function_7(2))
	{
...
int Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4) //Position: 0x265 / 613
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_ACTOR_VALID(&Global_15402[iParam014] + 8))
	{
		...
		Function_6(&Global_15402[iParam014] + 8);
		...
		Function_5(&Global_15402[iParam014] + 8);
...
void Function_5(var uParam0) //Position: 0x5A7 / 1447
{
	int iVar0;
...
void Function_6(int iParam0) //Position: 0x5DA / 1498
{
...
bool Function_7(bool bParam0) //Position: 0x5F1 / 1521
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_PERS_CHAR_VALID(&(Global_15402[bParam014])))
	{
		uVar1 = FIND_OBJECT_IN_OBJECT(GET_OBJECT_FROM_PERS_CHAR(&(Global_15402[bParam014])), "Persistent_Char_Brain");
		return GRINGO_QUERY_BOOL(GET_GRINGO_FROM_OBJECT(&uVar1), "ScriptStructure", "stolen_flag", &uVar2);
	}
	return IS_ACTOR_VALID(&Global_15402[bParam014] + 8);
}

void Function_8(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x6B5 / 1717
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	Function_4(bParam0, DECOR_CHECK_EXIST(&iParam1, "hidden"), (Global_6621 || bVar9), 1, 1);
...
void Function_9(var uParam0, bool bParam1) //Position: 0xB27 / 2855
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_10(int iParam0) //Position: 0xB5B / 2907
{
...
void Function_11(var uParam0, int iParam1) //Position: 0xB87 / 2951
{
	int iVar0;
...
bool Function_12(int iParam0, int iParam1) //Position: 0xBA1 / 2977
{
	int iVar0;
...
void Function_13(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xBBE / 3006
{
	var uVar0;
	bool bVar1;
...
bool Function_14(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC84 / 3204
{
	float fVar0;
...
void Function_15(int iParam0) //Position: 0xE4D / 3661
{
...
void Function_16(int iParam0) //Position: 0xE8A / 3722
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_17(var uParam0, int iParam1) //Position: 0xEA3 / 3747
{
	return (uParam0 && iParam1) == 0;
}

var Function_18(var uParam0, int iParam1) //Position: 0xEB0 / 3760
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_19(int iParam0, var uParam1) //Position: 0xFA5 / 4005
{
	var uVar0;
	int iVar1;
...
bool Function_20(var uParam0, int iParam1) //Position: 0x100B / 4107
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_21(int iParam0) //Position: 0x106D / 4205
{
	bool bVar0;
...
int Function_22(struct<209> Param0) //Position: 0x10A2 / 4258
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_23(var uParam0, struct<2> Param1) //Position: 0x12BB / 4795
{
	struct<2> Var0;
...
struct<8> Function_24(int iParam0) //Position: 0x1332 / 4914
{
	struct<2> Var0;
...
void Function_25(int iParam0) //Position: 0x139E / 5022
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x13C6 / 5062
{
...
void Function_27(struct<13> Param0) //Position: 0x1511 / 5393
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x152E / 5422
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x154C / 5452
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_29 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_148(&Param0 + 324, &fLocal_31, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_137(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_31, 20.0f, fLocal_31));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_69(StackVal, StackVal, &Param0 + 16, Function_137(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_14(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_32, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x270B / 9995
{
...
void Function_31(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x271D / 10013
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_32(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2956 / 10582
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_33(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2976 / 10614
{
	bool bVar0;
	var uVar1;
...
int Function_34(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2A64 / 10852
{
	char* cVar0[32];
...
int Function_35(int iParam0) //Position: 0x2CD0 / 11472
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_36(var uParam0, bool bParam1) //Position: 0x2CF4 / 11508
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2D18 / 11544
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2D3E / 11582
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2D65 / 11621
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_40(bool bParam0) //Position: 0x2D89 / 11657
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_41() //Position: 0x2DA8 / 11688
{
...
bool Function_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2DF7 / 11767
{
	bool bVar0;
	var uVar1;
...
bool Function_43(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E53 / 11859
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2E74 / 11892
{
	bool bVar0;
	var uVar1;
...
void Function_45(var uParam0, var uParam1, bool bParam2) //Position: 0x2ECF / 11983
{
	bool bVar0;
	var uVar1;
...
var Function_46() //Position: 0x2F1B / 12059
{
...
void Function_47(struct<425> Param0) //Position: 0x2F30 / 12080
{
	bool bVar0;
	bool bVar1;
...
bool Function_48(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3083 / 12419
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_49(vector3 vParam0) //Position: 0x30F8 / 12536
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_50(var uParam0) //Position: 0x3110 / 12560
{
	bool bVar0;
	int iVar1;
...
var Function_51(bool bParam0) //Position: 0x316E / 12654
{
	bool bVar0;
	bool bVar1;
...
void Function_52(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x31BB / 12731
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x3234 / 12852
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0) //Position: 0x3283 / 12931
{
	struct<21> Var0;
...
bool Function_55() //Position: 0x3342 / 13122
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_56(struct<25> Param0) //Position: 0x3355 / 13141
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_57(int iParam0) //Position: 0x341C / 13340
{
...
bool Function_58(int iParam0) //Position: 0x343C / 13372
{
...
bool Function_59(int iParam0) //Position: 0x3460 / 13408
{
...
bool Function_60(int iParam0) //Position: 0x3475 / 13429
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x348C / 13452
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34CA / 13514
{
...
bool Function_63(int iParam0) //Position: 0x34E4 / 13540
{
...
int Function_64(int iParam0, struct<6> Param1) //Position: 0x34FA / 13562
{
	int iVar0;
...
void Function_65(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3534 / 13620
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_66(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3619 / 13849
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_67(var uParam0, bool bParam1) //Position: 0x37D0 / 14288
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_68(bool bParam0) //Position: 0x37F5 / 14325
{
	var uVar0;
	int iVar1;
...
var Function_69(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3843 / 14403
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_70(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x399A / 14746
{
	var uVar0[5];
	int iVar6;
...
int Function_71(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3A45 / 14917
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3AEB / 15083
{
	Function_101(&uLocal_3, "talking_stand", 5, 0);
	Function_101(&uLocal_3, "custom/talking_stand", 8, 0);
	Function_145(&uLocal_3, 1190, 3, 0);
	if (Function_94(&iLocal_17, &uLocal_3, 25, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (!IS_ACTOR_VALID(&uLocal_19))
		{
			uLocal_19 = Function_82(2, 0, 1, -482,77f, 19,7f, 3048,1f, 0, 0, 0);
			TASK_STAND_STILL(&uLocal_19, -1.0f, 0, 0);
		}
		else if (Function_80(&uLocal_27, "fort02mobile", &iParam1))
		{
			iLocal_21 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_27, Function_137()));
			*(&Global_6667[2528] + 216) = &iLocal_21;
...
void Function_73() //Position: 0x3BBE / 15294
{
	var uVar0;
	bool bVar2;
	var uVar3;
	
	uLocal_25 = CREATE_LAYOUT("fort02campfirelayout");
	uLocal_23 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_25, "Fort02restrict", 0f, Vector(-2688,006f, 33,222f, 4289,545f), Vector(0.0f, 0.0f, 0.0f), Vector(25.0f, 25.0f, 25.0f));
	ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_23);
	ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_23);
	CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_23, 15);
	CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_23, 24);
	RESET_PROPS_IN_VOLUME(&uLocal_23, 1);
	uVar0 = Vector(-483,39f, 19,7f, 3046,77f);
	TELEPORT_ACTOR(&iLocal_17, &uVar0, 1, 1, 1);
	uVar0 = Vector(-482,77f, 19,7f, 3048,1f);
	TELEPORT_ACTOR(&uLocal_19, &uVar0, 1, 1, 1);
	Function_76(&iLocal_17, &uLocal_19);
	Function_76(&uLocal_19, &iLocal_17);
	RESET_ANIM_SET_FOR_ACTOR(&iLocal_17, 1);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_19, 1);
	SET_ANIM_SET_FOR_ACTOR(&iLocal_17, "talking_stand", 0);
	SET_ANIM_SET_FOR_ACTOR(&uLocal_19, "talking_stand", 0);
	bVar2 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &uLocal_19, 0, 3212836864);
	TASK_ACTION_PERFORM(0, "talking_stand/Talk_A");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(0, "talking_stand/Listen_B");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&iLocal_17, bVar2, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar2, 1);
	bVar2 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &iLocal_17, 0, 3212836864);
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(0, "talking_stand/Listen_B");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(0, "talking_stand/Talk_A");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uLocal_19, bVar2, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar2, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_25, "fort02_raft", 1190, Vector(-487,5f, 17,9f, 3044,88f), Vector(179,92f, -20,54f, -179,75f));
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_ACTOR(&uVar3), 1);
	TASK_STAND_STILL(&uVar3, -1.0f, 1, 0);
	TASK_PRIORITY_SET(&uVar3, true);
	Function_74(&iLocal_17, &iLocal_21, 1, 1);
	Function_74(&uLocal_19, &iLocal_21, 1, 1);
	Function_74(&uVar3, &iLocal_21, 1, 1);
	return;
}

void Function_74(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3E15 / 15893
{
	bool bVar0;
	int iVar1;
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x3FD2 / 16338
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_76(var uParam0, int iParam1) //Position: 0x401C / 16412
{
	struct<2> Var0;
	
	GET_OBJECT_POSITION(GET_OBJECT_FROM_ACTOR(&iParam1), &Var0);
	Function_77(StackVal, &uParam0, Var0);
	return;
}

void Function_77(var uParam0, struct<2> Param1) //Position: 0x4038 / 16440
{
	if (!IS_ACTOR_VALID(GET_MOUNT(&uParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_78(&uParam0, &uParam0, Param1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_78(GET_MOUNT(&uParam0), &uParam0, Param1), 1);
	}
	return;
}

var Function_78(var uParam0, struct<2> Param1) //Position: 0x4073 / 16499
{
	struct<2> Var0;
	
	Function_79(&uParam0);
	Var0 = Vector(StackVal, StackVal, StackVal) - Vector(Function_79(&uParam0), Param1, StackVal);
	VNORMALIZE(&Var0);
...
struct<8> Function_79(int iParam0) //Position: 0x40F4 / 16628
{
	struct<2> Var0;
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x4106 / 16646
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x4136 / 16694
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_137(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
var Function_82(int iParam0, bool bParam1, int iParam2, float fParam3, float fParam4, float fParam5, bool bParam6, int iParam7, bool bParam8) //Position: 0x4181 / 16769
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	else
	{
		if (&bParam6)
		{
			bVar1 = Function_90(&Global_15402[iParam014] + 16, &iParam7);
		}
		if (&bParam8)
		{
			bVar1 = Function_85(&Global_15402[iParam014] + 16, &iParam7);
		}
...
void Function_83(var uParam0, bool bParam1) //Position: 0x46C1 / 18113
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_84(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x46E3 / 18147
{
	var uVar0;
...
var Function_85(bool bParam0, int iParam1) //Position: 0x4744 / 18244
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_86(var uParam0, int iParam1) //Position: 0x47D2 / 18386
{
	Function_88(&uParam0);
	Function_87(&uParam0);
...
void Function_87(int iParam0) //Position: 0x47FE / 18430
{
...
void Function_88(int iParam0) //Position: 0x4824 / 18468
{
...
bool Function_89(bool bParam0) //Position: 0x48FA / 18682
{
...
var Function_90(int iParam0, int iParam1) //Position: 0x4911 / 18705
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_91(int iParam0, bool bParam1, bool bParam2) //Position: 0x49B7 / 18871
{
	var uVar0;
	var uVar1;
...
void Function_92(var uParam0) //Position: 0x4AC6 / 19142
{
	int iVar0;
...
bool Function_93(var uParam0, bool bParam1) //Position: 0x4AF9 / 19193
{
	int iVar0;
...
bool Function_94(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4B16 / 19222
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_100(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_99(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	if (StackVal || !Function_95((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_99(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4CF5 / 19701
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_24(&iParam0);
...
void Function_96() //Position: 0x4D81 / 19841
{
	var uVar0;
	int iVar1;
...
bool Function_97(int iParam0) //Position: 0x4DF1 / 19953
{
...
bool Function_98(int iParam0) //Position: 0x4E0D / 19981
{
...
var Function_99(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4E23 / 20003
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(struct<205> Param0) //Position: 0x4EC9 / 20169
{
	var uVar0;
	var uVar1;
...
var Function_101(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4FD4 / 20436
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_103(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
		Function_102(&(Param0[iVar02]), 8);
	}
	return iVar0;
}

void Function_102(struct<13> Param0) //Position: 0x5012 / 20498
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_103(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5025 / 20517
{
	int iVar0;
...
bool Function_104(struct<2>[] Param0) //Position: 0x50F4 / 20724
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x54B6 / 21686
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x54F6 / 21750
{
	int iVar0;
...
void Function_107() //Position: 0x5524 / 21796
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(vector3 vParam0) //Position: 0x5566 / 21862
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x55FE / 22014
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x562D / 22061
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x5688 / 22152
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x5698 / 22168
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x56AC / 22188
{
	int iVar0;
...
var Function_114() //Position: 0x56D1 / 22225
{
	return "PackedMetadata";
}

void Function_115(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x56E8 / 22248
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&iParam1, Function_124(), &uVar4))
				{
					Function_119(uVar4, &iVar5);
...
struct<8> Function_116() //Position: 0x5824 / 22564
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_117() //Position: 0x5836 / 22582
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_118() //Position: 0x5848 / 22600
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_119(var uParam0, struct<5> Param1) //Position: 0x585A / 22618
{
...
var Function_120(var uParam0, int iParam1, int iParam2) //Position: 0x587F / 22655
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x589E / 22686
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_122() //Position: 0x58AA / 22698
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x58B5 / 22709
{
	int iVar0;
...
var Function_124() //Position: 0x58E3 / 22755
{
	return "PackedWeapon";
}

int Function_125(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x58F8 / 22776
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_126() //Position: 0x5A05 / 23045
{
	return "MPItemGiver";
}

struct<32> Function_127(char* cParam0) //Position: 0x5A19 / 23065
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0) //Position: 0x5A85 / 23173
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5AA7 / 23207
{
	return "PBox_";
}

var Function_130() //Position: 0x5AB5 / 23221
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5ADB / 23259
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x5B03 / 23299
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5B29 / 23337
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5C93 / 23699
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x5D3B / 23867
{
	int iVar0;
	struct<2> Var1;
...
void Function_136(int iParam0) //Position: 0x5EA9 / 24233
{
...
var Function_137() //Position: 0x5F11 / 24337
{
	int iVar0;
...
var Function_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5F1A / 24346
{
	return Function_139(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_139(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5F38 / 24376
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x6231 / 25137
{
	int iVar0;
...
void Function_141() //Position: 0x62E5 / 25317
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x6320 / 25376
{
	int iVar0;
...
void Function_143(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x634D / 25421
{
	int iVar0;
...
void Function_144() //Position: 0x64A8 / 25768
{
	int iVar0;
...
var Function_145(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x64F4 / 25844
{
	int iVar0;
...
int Function_146() //Position: 0x65D0 / 26064
{
	int iVar0;
...
int Function_147() //Position: 0x672C / 26412
{
	int iVar0;
...
bool Function_148(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x684C / 26700
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_149(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_149(struct<2> Param0) //Position: 0x6928 / 26920
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_150(struct<2> Param0, struct<5> Param2) //Position: 0x6947 / 26951
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_151(int iParam0) //Position: 0x6A8A / 27274
{
	var uVar0;
...
bool Function_152(int iParam0) //Position: 0x6AAC / 27308
{
	int iVar0;
...
int Function_153() //Position: 0x6AC8 / 27336
{
	return 0;
}

void Function_154(struct<321> Param0) //Position: 0x6ACF / 27343
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_103(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_103(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
