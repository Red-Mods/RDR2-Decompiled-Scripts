...
void Function_22(var uParam0, var uParam1) //Position: 0x1F65 / 8037
{
	int iVar0;
...
float Function_23(int iParam0) //Position: 0x1F8F / 8079
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1FA6 / 8102
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1FB3 / 8115
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, var uParam1) //Position: 0x1FD4 / 8148
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1FE7 / 8167
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x2007 / 8199
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x200D / 8205
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x201F / 8223
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x202C / 8236
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(int iParam0, int iParam1) //Position: 0x2047 / 8263
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2067 / 8295
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2087 / 8327
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20BE / 8382
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20DE / 8414
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x20F9 / 8441
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x210F / 8463
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2433 / 9267
{
	int iVar0;
...
bool Function_40(int iParam0, int iParam1) //Position: 0x243C / 9276
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x245B / 9307
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(int iParam0, int iParam1) //Position: 0x246A / 9322
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x248E / 9358
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x24B4 / 9396
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24D2 / 9426
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24F4 / 9460
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x2516 / 9494
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25DE / 9694
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x265A / 9818
{
...
void Function_50(vector3 vParam0) //Position: 0x2672 / 9842
{
...
var Function_51(int iParam0) //Position: 0x2697 / 9879
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26B8 / 9912
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26CF / 9935
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26DB / 9947
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26E2 / 9954
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26F3 / 9971
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2738 / 10040
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2764 / 10084
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2770 / 10096
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2872 / 10354
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2895 / 10389
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x28BD / 10429
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BA4 / 11172
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C01 / 11265
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C5E / 11358
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C6A / 11370
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C89 / 11401
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CA0 / 11424
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D31 / 11569
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D55 / 11605
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D74 / 11636
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D98 / 11672
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EC0 / 11968
{
...
int Function_74(var uParam0) //Position: 0x2EEE / 12014
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3007 / 12295
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3014 / 12308
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3096 / 12438
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3642 / 13890
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x367C / 13948
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x369A / 13978
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36DB / 14043
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36E7 / 14055
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

int Function_83(int iParam0, int iParam1) //Position: 0x3709 / 14089
{
	bool bVar0;
	...
	GIVE_WEAPON_TO_ACTOR(GET_PLAYER_ACTOR(0), 24, 0f, 1, 1);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	if (&iParam0 == GET_PLAYER_ACTOR(0))
	{
		if (!DECOR_CHECK_EXIST(&iParam0, "mexArmy02_bombsDisarmed"))
		{
			DECOR_SET_INT(&iParam0, "mexArmy02_bombsDisarmed", true);
		}
		else
		{
			bVar0 = DECOR_GET_INT(&iParam0, "mexArmy02_bombsDisarmed");
			bVar0++;
			DECOR_SET_INT(&iParam0, "mexArmy02_bombsDisarmed", bVar0);
		}
	}
	return 1;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x37D3 / 14291
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x38E3 / 14563
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x38FB / 14587
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3C17 / 15383
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3C29 / 15401
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C43 / 15427
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C5E / 15454
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C9C / 15516
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3CB5 / 15541
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3FAD / 16301
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FCB / 16331
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x406D / 16493
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x408D / 16525
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x40A0 / 16544
{
...
void Function_98(int iParam0) //Position: 0x40BC / 16572
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x40C8 / 16584
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4134 / 16692
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x414C / 16716
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4158 / 16728
{
