...
void Function_83(int iParam0, var uParam1) //Position: 0x36F0 / 14064
{
	var uVar0;
	
	iParam0 = &iParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", &uParam1))
	{
		uVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
		if (STRING_CONTAINS_STRING(&uVar0, "high_power"))
		{
...
void Function_84(var uParam0, bool bParam1) //Position: 0x375A / 14170
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x386A / 14442
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3882 / 14466
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B9E / 15262
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", &iParam1))
	{
		HUD_ENABLE(0);
	}
	return;
...
bool Function_88(int iParam0) //Position: 0x3BC6 / 15302
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3BE0 / 15328
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3BFB / 15355
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C39 / 15417
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C52 / 15442
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F4A / 16202
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F68 / 16232
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4009 / 16393
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4029 / 16425
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x403C / 16444
{
...
void Function_98(int iParam0) //Position: 0x4058 / 16472
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4064 / 16484
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x40D0 / 16592
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x40E8 / 16616
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x40F4 / 16628
{
