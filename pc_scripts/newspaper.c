...
void Function_1(var uParam0, int iParam1) //Position: 0x11E / 286
{
	if (Global_6624)
	{
		return;
...
void Function_2(bool bParam0) //Position: 0x15D / 349
{
...
void Function_3(var uParam0, int iParam1) //Position: 0x1B2 / 434
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_4() //Position: 0x1C8 / 456
{
	Function_32();
	Function_31();
	Function_31();
...
void Function_5() //Position: 0x213 / 531
{
...
void Function_6() //Position: 0x319 / 793
{
	float fVar0;
...
void Function_7() //Position: 0x34C / 844
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_8() //Position: 0x4DF / 1247
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x698 / 1688
{
	Function_10(&Global_42918, 1, 0);
	return;
}

void Function_10(struct<2317> Param0) //Position: 0x6A6 / 1702
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_11() //Position: 0x8C3 / 2243
{
...
struct<8> Function_12(int iParam0) //Position: 0x8D8 / 2264
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_13(int iParam0, bool bParam1, bool bParam2) //Position: 0x97F / 2431
{
	int iVar0;
...
void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0xC1B / 3099
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_15() //Position: 0x1259 / 4697
{
	int iVar0;
...
var Function_16(int iParam0) //Position: 0x1262 / 4706
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_17(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1273 / 4723
{
	char* cVar0[32];
...
struct<32> Function_18(char* cParam0) //Position: 0x136A / 4970
{
	char* cVar0[32];
...
void Function_19(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1385 / 4997
{
	float fVar0;
...
var Function_20(int iParam0, int iParam1) //Position: 0x13EC / 5100
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_21(int iParam0, bool bParam1) //Position: 0x13FE / 5118
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_22(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1410 / 5136
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_23(int iParam0) //Position: 0x1544 / 5444
{
	return Global_55480[iParam016].f_96;
}

float Function_24(int iParam0) //Position: 0x1553 / 5459
{
	if (!iParam0 != 4294967295)
	{
...
var Function_25(int iParam0) //Position: 0x158C / 5516
{
	if (iParam0 == 4294967295)
	{
...
void Function_26(int iParam0) //Position: 0x15C9 / 5577
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1763 / 5987
{
	int iVar0;
	int iVar1;
...
int Function_28(bool bParam0) //Position: 0x19A7 / 6567
{
...
struct<8> Function_29() //Position: 0x19E8 / 6632
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_30() //Position: 0x1A71 / 6769
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x1B08 / 6920
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_32() //Position: 0x1B87 / 7047
{
...
int Function_33(int iParam0, bool bParam1, int iParam2) //Position: 0x1BC4 / 7108
{
	int iVar0;
	int iVar1;
...
void Function_34() //Position: 0x1DD0 / 7632
{
	struct<2> Var0;
	var uVar2;
...
bool Function_35(vector3 vParam0) //Position: 0x1E87 / 7815
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

struct<8> Function_36(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x1E9F / 7839
{
	int iVar0;
...
struct<8> Function_37() //Position: 0x1F97 / 8087
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1FA1 / 8097
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_39(int iParam0) //Position: 0x1FB2 / 8114
{
...
int Function_40(bool bParam0, bool bParam1) //Position: 0x1FC8 / 8136
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_41(struct<2> Param0, struct<2> Param2) //Position: 0x2094 / 8340
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_42(float fParam0, int iParam1) //Position: 0x20B1 / 8369
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x2918 / 10520
{
	return (uParam0 && iParam1) == 0;
}

void Function_45(var uParam0, var uParam1) //Position: 0x2925 / 10533
{
	GET_POSITION(&uParam0, &uParam1);
	return;
}

bool Function_46() //Position: 0x2934 / 10548
{
...
bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x294F / 10575
{
	uParam0 = &uParam0;
...
int Function_48(int iParam0) //Position: 0x29FE / 10750
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_49(int iParam0, var uParam1, int iParam2) //Position: 0x2AB5 / 10933
{
	int iVar0;
...
bool Function_50(int iParam0, int iParam1, int iParam2) //Position: 0x2AE2 / 10978
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (iParam2)
	{
		...
		{
			if (DECOR_CHECK_EXIST(&iParam1, "NewspaperStart"))
			{
				if (!iLocal_8)
				{
					ENABLE_USE_CONTEXTS(1);
					if (bLocal_5 == 200)
					{
						DECOR_REMOVE(&iParam1, "NewspaperStart");
						SHOW_NEWSPAPER(200, &uLocal_6, 1, 1);
					}
					else if (bLocal_5 == 202)
					{
						SHOW_NEWSPAPER(202, &uLocal_6, 1, 1);
					}
					else if (bLocal_5 == 201)
					{
						SHOW_NEWSPAPER(201, "BlackmailPhotos", 1, 1);
						iLocal_9 = 1;
					}
					else
					{
						CLEAR_NEWSPAPER();
						bLocal_5 = Function_28(472);
						bLocal_5 = (bLocal_5 || SHIFT_LEFT(true, false));
						bVar1 = false;
						while (bVar1 < 9)
						{
							bVar2 = SHIFT_LEFT(true, bVar1);
							if ((bVar2 && bLocal_5) == bVar2)
							{
								SHOW_NEWSPAPER(bVar1, "NULL", 0, 1);
							}
							bVar1++;
						}
					}
			...
			if (DECOR_CHECK_EXIST(&iParam1, "NewspaperClosed"))
			{
				DECOR_REMOVE(&iParam1, "NewspaperClosed");
				ENABLE_USE_CONTEXTS(0);
				if (iLocal_9)
				{
					SET_ACTION_NODE_FOR_ACTOR(&iParam1, "dirty_photos/pst");
				}
				else if (bLocal_5 == 200)
				{
					SET_ACTION_NODE_FOR_ACTOR(&iParam1, "treasure_map/human/map_pst");
				}
				else
				{
					SET_ACTION_NODE_FOR_ACTOR(&iParam1, "wanted_poster/human/poster_pst");
				}
			}
			if (!GRINGO_IS_ACTOR_PLAYING_ANIM(&iParam1, &uVar0))
			{
				return 0;
			}
		}
		if (!iLocal_4)
		{
			...
			if (!iLocal_8)
			{
				...
				else
				{
					...
					while (bVar3 < 9)
					{
						bVar4 = SHIFT_LEFT(true, bVar3);
						if ((bVar4 && bLocal_5) == bVar4)
						{
							SHOW_NEWSPAPER(bVar3, "NULL", 0, 1);
						}
						bVar3++;
					}
				}
...
void Function_51(int iParam0, var uParam1, var uParam2) //Position: 0x2DC1 / 11713
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_52(bool bParam0, int iParam1) //Position: 0x2E5E / 11870
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		iVar1 = GRINGO_GET_PHYSINST(&bParam0);
...
var Function_53(char* cParam0, var uParam1, int iParam2) //Position: 0x2F26 / 12070
{
	int iVar0;
	int iVar1;
	
	iVar1 = GET_GRINGO_STRING_ATTR(&uParam1, &cParam0, &iVar0);
	iParam2 = iVar0 < 0;
	if (iParam2)
	{
...
var Function_54(int iParam0) //Position: 0x2F76 / 12150
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_55(int iParam0) //Position: 0x2F8D / 12173
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2FA4 / 12196
{
	uParam0 = Function_63(&uParam0);
	iParam2 = 0;
	if (DECOR_CHECK_EXIST(&uParam1, "NewspaperStart"))
	{
		DECOR_REMOVE(&uParam1, "NewspaperStart");
	}
	if (DECOR_CHECK_EXIST(&uParam1, "NewspaperClosed"))
	{
		DECOR_REMOVE(&uParam1, "NewspaperClosed");
	}
	if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(&Global_54076)))
	{
		if (!IS_PLAYER_IN_COMBAT_WITHIN(0, 15.0f))
		{
			if (GET_GRINGO_INT_ATTR(&bLocal_5, "ngraphicID", &uParam0))
			{
				if (((Function_59(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
				{
					iLocal_4 = 0;
				}
				iParam2 = 1;
		...
		{
			Function_57("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
	}
	else
	{
		Function_57("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 0;
	}
	iLocal_8 = 0;
	return;
...
void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x30D5 / 12501
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x3160 / 12640
{
	char* cVar0[16];
...
int Function_59(int iParam0, bool bParam1, bool bParam2) //Position: 0x319F / 12703
{
...
bool Function_60() //Position: 0x3263 / 12899
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_61(int iParam0) //Position: 0x327A / 12922
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_62(int iParam0) //Position: 0x3286 / 12934
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_63(int iParam0) //Position: 0x3295 / 12949
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_64(int iParam0, int iParam1) //Position: 0x32B0 / 12976
{
	var uVar0;
	var uVar1;
