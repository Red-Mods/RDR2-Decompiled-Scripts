...
void Function_1(struct<473> Param0) //Position: 0x85 / 133
{
	bool bVar0;
...
void Function_2() //Position: 0x233 / 563
{
	Function_3();
	return;
}

void Function_3() //Position: 0x23C / 572
{
	RELEASE_LAYOUT_REF(&uLocal_52);
	Function_4(5, &uLocal_46, &iLocal_48, &uLocal_4, &uLocal_50, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x258 / 600
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6CA / 1738
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x6FE / 1790
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA40 / 2624
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA73 / 2675
{
...
void Function_9(int iParam0) //Position: 0xA8A / 2698
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAB6 / 2742
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAD0 / 2768
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAED / 2797
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBB3 / 2995
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD7C / 3452
{
...
void Function_15(int iParam0) //Position: 0xDB9 / 3513
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDD2 / 3538
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDDF / 3551
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xED4 / 3796
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF3A / 3898
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xF9C / 3996
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFD1 / 4049
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11EA / 4586
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1261 / 4705
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12CD / 4813
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x12F5 / 4853
{
...
void Function_26(struct<13> Param0) //Position: 0x1440 / 5184
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x145D / 5213
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x147B / 5243
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_54 || bParam2) || Global_6611)
			{
				if (Function_148(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_146(&Param0 + 324, &fLocal_56, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_135(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_56, 20.0f, fLocal_56));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_135(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_58 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_58) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_57, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x263A / 9786
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x264C / 9804
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2885 / 10373
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28A5 / 10405
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2993 / 10643
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2BFF / 11263
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C23 / 11299
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C47 / 11335
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C6D / 11373
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C94 / 11412
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CB8 / 11448
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CD7 / 11479
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D26 / 11558
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D82 / 11650
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DA3 / 11683
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2DFE / 11774
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E4A / 11850
{
...
void Function_46(struct<425> Param0) //Position: 0x2E5F / 11871
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FB2 / 12210
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3027 / 12327
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x303F / 12351
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x309D / 12445
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30EA / 12522
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x3163 / 12643
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31B2 / 12722
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x3271 / 12913
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3284 / 12932
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x334B / 13131
{
...
bool Function_57(int iParam0) //Position: 0x336B / 13163
{
...
bool Function_58(int iParam0) //Position: 0x338F / 13199
{
...
bool Function_59(int iParam0) //Position: 0x33A4 / 13220
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33BB / 13243
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x33F9 / 13305
{
...
bool Function_62(int iParam0) //Position: 0x3413 / 13331
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x3429 / 13353
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3463 / 13411
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3548 / 13640
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_66(var uParam0, bool bParam1) //Position: 0x36FF / 14079
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3724 / 14116
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3772 / 14194
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38C9 / 14537
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3974 / 14708
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A1A / 14874
{
	Function_99(&uLocal_4, "$/fragments/p_gen_barrel01x", 0, 0);
	Function_99(&uLocal_4, "$/fragments/p_gen_package06x", 0, 0);
	Function_99(&uLocal_4, "$/content/scripting/gringo/SimpleGringo/chair_sit_attach", 1, 0);
	Function_143(&uLocal_4, 656, 3, 0);
	Function_143(&uLocal_4, 497, 3, 0);
	Function_143(&uLocal_4, 406, 3, 0);
	Function_143(&uLocal_4, 781, 3, 0);
	Function_143(&uLocal_4, 1016, 3, 0);
	if (Function_80(&uLocal_46, &uLocal_4, 30, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_78(&uLocal_52, "gun01mobile", &iParam1))
		{
			iLocal_48 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_52, Function_135()));
			*(&Global_6667[3028] + 216) = &iLocal_48;
			*(&iParam0 + 24) = &uLocal_52;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3B3F / 15167
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uLocal_50 = CREATE_LAYOUT("gun01campfirelayout");
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01campfirebarrel01", "p_gen_barrel01x", Vector(-2706,754f, 32,64522f, 4254,835f), Vector(0.0f, 32,5f, 0.0f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01campfirebarrel02", "p_gen_barrel01x", Vector(-2706,448f, 32,85683f, 4254,646f), Vector(-51,61531f, -7,236988f, -95,69872f), 1);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01campfirepackage", "p_gen_package06x", Vector(-2712,214f, 32,38f, 4239,834f), Vector(90.0f, 29,47589f, 0.0f), 1);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01campcompsit", "chair_sit_attach", Vector(-2712,022f, 32,28f, 4240,288f), Vector(0.0f, 30.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uVar0, 2.0f, false, 1092616192);
	SNAP_ACTOR_TO_GRINGO(&uLocal_46, &uVar0, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_46, GET_GRINGO_FROM_OBJECT(&uVar0), "UseCase1", 4294967295, 1);
	Function_76(&uLocal_46, &iLocal_48, 1, 1);
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01simon", 656, Vector(-2707,584f, 33,65f, 4254,608f), Vector(1,33f, 28,8f, -3,56f));
	Function_73(StackVal, &uVar1, Vector(-2706,66f, 33,43f, 4253,183f));
	AI_IGNORE_ACTOR(&uVar1);
	ACTOR_START_FORCE_HOLSTER(&uVar1, 0, 0);
	uVar2 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "ngun01band", 497, Vector(-2706,721f, 32,699f, 4253,926f), Vector(165.0f, 28,8f, -3,56f));
	Function_73(StackVal, &uVar1, Vector(-2707,584f, 33,65f, 4254,608f));
	AI_IGNORE_ACTOR(&uVar2);
	ACTOR_START_FORCE_HOLSTER(&uVar2, 0, 0);
	TASK_FACE_ACTOR(&uVar2, &uVar1, 1, 3212836864);
	TASK_FACE_ACTOR(&uVar1, &uVar2, 1, 3212836864);
	Function_76(&uVar1, &iLocal_48, 1, 1);
	Function_76(&uVar2, &iLocal_48, 1, 1);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01campgensit", "chair_sit_attach", Vector(-2706,369f, 32,56f, 4253,969f), Vector(0.0f, -123.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uVar0, 2.0f, false, 1092616192);
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "ngun01crim", 406, Vector(-2706,66f, 33,43f, 4253,183f), Vector(165.0f, 28,8f, -3,56f));
	...
	ACTOR_START_FORCE_HOLSTER(&uVar1, 0, 0);
	Function_76(&uVar1, &iLocal_48, 1, 1);
	uVar3 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_50, "gun01campfirevol", 2,802597E-45f, Vector(-2724,564f, 33,084f, 4250,329f), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	uVar4 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01chicken", 1016, Vector(-2724,564f, 33,084f, 4250,329f), Vector(0.0f, 0.0f, 0.0f));
	SET_ACTOR_STAY_WITHIN_VOLUME(&uVar4, &uVar3, 1, true);
	AI_IGNORE_ACTOR(&uVar4);
	Function_76(&uVar1, &iLocal_48, 1, 1);
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_50, "gun01farmer", 781, Vector(-2724,564f, 33,084f, 4250,329f), Vector(0.0f, 0.0f, 0.0f));
	SET_ACTOR_STAY_WITHIN_VOLUME(&uVar1, &uVar3, 1, true);
	TASK_GO_NEAR_ACTOR(&uVar1, &uVar4, 1.0f, 1);
	AI_IGNORE_ACTOR(&uVar1);
	Function_76(&uVar1, &iLocal_48, 1, 1);
	TASK_FLEE_ACTOR(&uVar4, &uVar1, 5.0f, -1.0f, 0, 0, 0);
	iVar5 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_50, Function_135(), Vector(-2755,591f, 31,989f, 4268,534f), Vector(0.0f, 0.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f), 2, &Global_54076, 1, 4294967295, 0, 1, 1);
	iVar5 = &iVar5;
	iVar5 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_50, Function_135(), Vector(-2646,725f, 31,143f, 4235,529f), Vector(0.0f, 0.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f), 2, &Global_54076, 1, 4294967295, 0, 1, 1);
	iVar5 = &iVar5;
	iVar5 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_50, Function_135(), Vector(-2710,222f, 32,112f, 4212,118f), Vector(0.0f, 0.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f), 2, &Global_54076, 1, 4294967295, 0, 1, 1);
	iVar5 = &iVar5;
	return;
}

void Function_73(float fParam0, struct<2> Param1) //Position: 0x402F / 16431
{
	if (!IS_ACTOR_VALID(GET_MOUNT(&fParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_74(&fParam0, &fParam0, Param1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_74(GET_MOUNT(&fParam0), &fParam0, Param1), 1);
	}
	return;
}

var Function_74(var uParam0, struct<2> Param1) //Position: 0x406A / 16490
{
	struct<2> Var0;
	
	Function_75(&uParam0);
	Var0 = Vector(StackVal, StackVal, StackVal) - Vector(Function_75(&uParam0), Param1, StackVal);
	VNORMALIZE(&Var0);
...
struct<8> Function_75(int iParam0) //Position: 0x40EB / 16619
{
	struct<2> Var0;
...
void Function_76(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x40FD / 16637
{
	bool bVar0;
	int iVar1;
...
bool Function_77(int iParam0, int iParam1, bool bParam2) //Position: 0x42BA / 17082
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_78(var uParam0, var uParam1, int iParam2) //Position: 0x4302 / 17154
{
...
void Function_79(var uParam0, bool bParam1) //Position: 0x4332 / 17202
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_135(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x437D / 17277
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x455C / 17756
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x4A9C / 19100
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_83(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4ABE / 19134
{
	var uVar0;
...
var Function_84(bool bParam0, int iParam1) //Position: 0x4B1F / 19231
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x4BAD / 19373
{
	Function_87(&uParam0);
	Function_86(&uParam0);
...
void Function_86(int iParam0) //Position: 0x4BD9 / 19417
{
...
void Function_87(int iParam0) //Position: 0x4BFF / 19455
{
...
bool Function_88(bool bParam0) //Position: 0x4CD5 / 19669
{
...
var Function_89(int iParam0, int iParam1) //Position: 0x4CEC / 19692
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D92 / 19858
{
	var uVar0;
	var uVar1;
...
void Function_91(var uParam0) //Position: 0x4EA1 / 20129
{
	int iVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x4ED4 / 20180
{
	int iVar0;
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4EF1 / 20209
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_94() //Position: 0x4F7D / 20349
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x4FED / 20461
{
...
bool Function_96(int iParam0) //Position: 0x5009 / 20489
{
...
var Function_97(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x501F / 20511
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_98(struct<205> Param0) //Position: 0x50C5 / 20677
{
	var uVar0;
	var uVar1;
...
var Function_99(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x51D0 / 20944
{
	int iVar0;
	int iVar1;
...
void Function_100(struct<13> Param0) //Position: 0x520E / 21006
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_101(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5221 / 21025
{
	int iVar0;
...
bool Function_102(struct<2>[] Param0) //Position: 0x52F0 / 21232
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x56B2 / 22194
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x56F2 / 22258
{
	int iVar0;
...
void Function_105() //Position: 0x5720 / 22304
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(vector3 vParam0) //Position: 0x5762 / 22370
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x57FA / 22522
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5829 / 22569
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x5884 / 22660
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x5894 / 22676
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x58A8 / 22696
{
	int iVar0;
...
var Function_112() //Position: 0x58CD / 22733
{
	return "PackedMetadata";
}

void Function_113(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x58E4 / 22756
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_114() //Position: 0x5A20 / 23072
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_115() //Position: 0x5A32 / 23090
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_116() //Position: 0x5A44 / 23108
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_117(var uParam0, struct<5> Param1) //Position: 0x5A56 / 23126
{
...
var Function_118(var uParam0, int iParam1, int iParam2) //Position: 0x5A7B / 23163
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x5A9A / 23194
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_120() //Position: 0x5AA6 / 23206
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x5AB1 / 23217
{
	int iVar0;
...
var Function_122() //Position: 0x5ADF / 23263
{
	return "PackedWeapon";
}

int Function_123(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5AF4 / 23284
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_124() //Position: 0x5C01 / 23553
{
	return "MPItemGiver";
}

struct<32> Function_125(char* cParam0) //Position: 0x5C15 / 23573
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0) //Position: 0x5C81 / 23681
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5CA3 / 23715
{
	return "PBox_";
}

var Function_128() //Position: 0x5CB1 / 23729
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5CD7 / 23767
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x5CFF / 23807
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x5D25 / 23845
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5E8F / 24207
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5F37 / 24375
{
	int iVar0;
	struct<2> Var1;
...
void Function_134(int iParam0) //Position: 0x60A5 / 24741
{
...
var Function_135() //Position: 0x610D / 24845
{
	int iVar0;
...
var Function_136(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x6116 / 24854
{
	return Function_137(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6134 / 24884
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_138(int iParam0) //Position: 0x642D / 25645
{
	int iVar0;
...
void Function_139() //Position: 0x64E1 / 25825
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x651C / 25884
{
	int iVar0;
...
void Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6549 / 25929
{
	int iVar0;
...
void Function_142() //Position: 0x66A4 / 26276
{
	int iVar0;
...
var Function_143(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x66F0 / 26352
{
	int iVar0;
...
int Function_144() //Position: 0x67CC / 26572
{
	int iVar0;
...
int Function_145() //Position: 0x6928 / 26920
{
	int iVar0;
...
bool Function_146(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6A48 / 27208
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_147(struct<2> Param0) //Position: 0x6B24 / 27428
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_148(struct<2> Param0, struct<5> Param2) //Position: 0x6B43 / 27459
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_149(int iParam0) //Position: 0x6C86 / 27782
{
	var uVar0;
...
bool Function_150(int iParam0) //Position: 0x6CA8 / 27816
{
	int iVar0;
...
int Function_151() //Position: 0x6CC4 / 27844
{
	return 0;
}

void Function_152(struct<321> Param0) //Position: 0x6CCB / 27851
{
	var uVar0;
