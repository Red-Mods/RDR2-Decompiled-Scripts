...
bool Function_96(var uParam0, int iParam1) //Position: 0x3FBA / 16314
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (!GET_WEAPON_IN_HAND(&uParam0) != 4294967295)
	{
		return 0;
	}
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FDB / 16347
{
...
void Function_98(int iParam0) //Position: 0x3FF7 / 16375
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4004 / 16388
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4070 / 16496
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4088 / 16520
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4094 / 16532
{
