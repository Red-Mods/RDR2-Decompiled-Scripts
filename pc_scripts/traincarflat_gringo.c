...
bool Function_9(var uParam0) //Position: 0x3B9 / 953
{
	...
	*(&iLocal_0 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarFlat_pop", 2,802597E-45f, Vector(0.0f, 2,665724f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,94944f, 3,273606f, 15,44871f));
	Function_10(&iLocal_0, &uParam0);
	return 1;
}

void Function_10(bool bParam0, int iParam1) //Position: 0x41B / 1051
{
	var uVar0;
...
var Function_11() //Position: 0x466 / 1126
{
	int iVar0;
...
void Function_12(int iParam0, int iParam1) //Position: 0x46F / 1135
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_13(var uParam0, int iParam1) //Position: 0x4B9 / 1209
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_14(int iParam0) //Position: 0x4CA / 1226
{
	int iVar0;
