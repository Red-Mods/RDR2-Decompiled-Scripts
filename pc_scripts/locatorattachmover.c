...
void main() //Position: 0x0 / 0
{
	...
	iLocal_122 = 0;
	Function_97(&uScriptParam_0, &iLocal_122);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(vLocal_12[iVar39]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_12[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", &vLocal_12[iVar39] + 24);
							Function_82(&vLocal_12[iVar39] + 24, 1);
							...
							{
								Function_75(&(vLocal_12[iVar39]), 0);
							}
							else if (vLocal_12[iVar39].f_68 < 8)
							{
								Function_74(&(vLocal_12[iVar39]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_122 - 1))
			{
				if (Function_73(vLocal_12[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_12[iVar09])))
					{
						Function_100("Quitting due to update end");
						Function_75(&(vLocal_12[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_12[iVar09]), 0))
				{
					Function_5(&(vLocal_12[iVar09]));
				}
				iVar0++;
			}
		}
	...
	while (iVar0 < (iLocal_122 - 1))
	{
		if (Function_73(vLocal_12[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_12[iVar09] + 24);
			Function_75(&(vLocal_12[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_12[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_12[iVar09] + 16);
		}
		Function_15(&(vLocal_12[iVar09]), 1);
		iVar0++;
	}
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_131))
								{
									...
									{
										bLocal_131 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_131 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_128, &uLocal_126);
...
void Function_29(var uParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	...
	uVar5 = GRINGO_GET_MY_OBJECT_REF();
	if (IS_OBJECT_VALID(&uVar5))
	{
		PRINTSTRING(GET_OBJECT_NAME(&uVar5));
		PRINTNL();
		if (!IS_ATTACHMENT_VALID(&uLocal_2))
		{
			uLocal_2 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &uVar5, Function_30(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
		uVar0 = GET_GRINGO_STRING_ATTR("LocatorAttachName", &uParam1, &uVar7);
		PRINTSTRING(&uVar0);
		PRINTNL();
		uVar6 = GET_TARGET_OBJECT();
		if (IS_OBJECT_VALID(&uVar6))
		{
			PRINTSTRING(GET_OBJECT_NAME(&uVar6));
			PRINTNL();
			PRINTSTRING(GET_OBJECT_MODEL_NAME(&uVar6));
			PRINTNL();
			bVar8 = CREATE_OBJECT_LOCATOR(&uVar6, &uVar0);
			if (IS_OBJECT_VALID(&bVar8))
			{
				if (OBJECT_LOCATOR_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &bVar8, &uVar6, &uVar0, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
				{
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_POSITION(&bVar8, &Var1);
					OBJECT_LOCATOR_GET_LOCATOR_LOCAL_ORIENTATION(&bVar8, &Var3);
					PRINTVECTOR(Var1);
					PRINTNL();
					PRINTVECTOR(Var3);
					PRINTNL();
					SET_ATTACHMENT_LOCAL_OFFSET(&uLocal_2, Var1);
					SET_ATTACHMENT_LOCAL_ROTATION(&uLocal_2, Var3);
					PRINTVECTOR(Var1);
					PRINTNL();
					PRINTVECTOR(Var3);
					PRINTNL();
...
var Function_30() //Position: 0x2116 / 8470
{
	int iVar0;
...
bool Function_31(char* cParam0) //Position: 0x211F / 8479
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x212C / 8492
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x2147 / 8519
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x2167 / 8551
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x2187 / 8583
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x21BE / 8638
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x21DE / 8670
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x21F9 / 8697
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x220F / 8719
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, Function_30(), Function_40(&iParam0 + 16, &iVar10), 0, bVar9);
	}
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2533 / 9523
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2552 / 9554
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2561 / 9569
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2585 / 9605
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x25AB / 9643
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x25C9 / 9673
{
...
void Function_47(char* cParam0, int iParam1) //Position: 0x260D / 9741
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x26D5 / 9941
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2751 / 10065
{
...
void Function_50(vector3 vParam0) //Position: 0x2769 / 10089
{
...
var Function_51(int iParam0) //Position: 0x278E / 10126
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x27AF / 10159
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x27C6 / 10182
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x27D2 / 10194
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x27D9 / 10201
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x27EA / 10218
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x282F / 10287
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x285B / 10331
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2867 / 10343
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2969 / 10601
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x298C / 10636
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(var uParam0) //Position: 0x29B4 / 10676
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar1))
		{
			PRINTSTRING(GET_OBJECT_NAME(&uVar1));
			PRINTNL();
			PRINTSTRING(GET_OBJECT_MODEL_NAME(&uVar1));
			PRINTNL();
			uVar2 = GRINGO_GET_COMPONENT_USER(&uParam0);
			if (IS_OBJECT_VALID(&uVar2))
			{
				...
				PRINTNL();
				GET_GRINGO_VECTOR_ATTR(&Var4, "GringoCameraOffset", &uParam0);
				GET_GRINGO_VECTOR_ATTR(&Var6, "GringoCameraOrient", &uParam0);
				GET_GRINGO_VECTOR_ATTR(&uVar8, "GringoCameraTarget", &uParam0);
				uLocal_6 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uVar0, "GringoCamera", 1, 1);
				if (IS_OBJECT_VALID(&uLocal_6))
				{
					uLocal_8 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&uLocal_6, 0);
					uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &uLocal_8, Function_30(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
					ATTACH_OBJECTS(StackVal, StackVal, &uVar3, &uVar1, Function_30(), Vector(0.0f, 1,7f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
					INIT_CAMERASHOT_FROM_GAME_CAMERA(&uLocal_8);
					SET_CAMERASHOT_TARGET_OBJECT(&uLocal_8, &uVar3, 0);
					SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &uLocal_8, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
					SET_CAMERASHOT_COLLISION_ENABLED(&uLocal_8, 0);
					uLocal_4 = ATTACH_OBJECTS(&uLocal_8, &uVar1, Function_30(), Var4, Var6, 4294967295);
					if (IS_ATTACHMENT_VALID(&uLocal_4))
					{
					}
					iLocal_10 = CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(&uLocal_6, 0, 4294967295);
					FORCE_CAMERASHOT_UPDATE(&uLocal_8);
					PLAY_CUTSCENEOBJECT(&uLocal_6, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
				}
			}
		}
	}
...
void Function_63(int iParam0) //Position: 0x2B4E / 11086
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x2B5A / 11098
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2B79 / 11129
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x2B90 / 11152
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_67(int iParam0) //Position: 0x2C21 / 11297
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2C45 / 11333
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x2C64 / 11364
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x2C88 / 11400
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2DB0 / 11696
{
...
int Function_72(var uParam0) //Position: 0x2DDE / 11742
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EF7 / 12023
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2F04 / 12036
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2F86 / 12166
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x3531 / 13617
{
	if (IS_OBJECT_VALID(&uLocal_6))
	{
		if (IS_ATTACHMENT_VALID(&uLocal_4))
		{
			REMOVE_OBJECT_ATTACHMENT(&uLocal_4);
		}
		if (IS_OBJECT_VALID(&uLocal_8))
		{
			DESTROY_OBJECT(&uLocal_8);
		}
		if (IS_OBJECT_VALID(&iLocal_10))
		{
			DESTROY_OBJECT(&iLocal_10);
		}
...
int Function_77(int iParam0) //Position: 0x3577 / 13687
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3595 / 13717
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x35D6 / 13782
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x35E2 / 13794
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(int iParam0, int iParam1) //Position: 0x3604 / 13828
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (IS_ATTACHMENT_VALID(&uLocal_2))
	{
		PRINTSTRING("LOCATORATTACHENGINEER - OnFinish - Detaching the object attachment.");
		PRINTNL();
...
void Function_82(var uParam0, bool bParam1) //Position: 0x3671 / 13937
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x3781 / 14209
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3799 / 14233
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	if (GRINGO_GET_USE_REQUIRES_OBSTACLE(&uVar0))
	{
		...
		ATTACH_OBJECTS(StackVal, StackVal, &Param0 + 56, &Param0 + 24, Function_30(), Vector(0.0f, 1.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	}
	Function_52(&Param0);
...
void Function_85(int iParam0, int iParam1) //Position: 0x3AB5 / 15029
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x3AC7 / 15047
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x3AE1 / 15073
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x3AFC / 15100
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3B3A / 15162
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3B53 / 15187
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3E4B / 15947
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3E69 / 15977
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3F09 / 16137
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3F29 / 16169
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3F3C / 16188
{
...
void Function_96(int iParam0) //Position: 0x3F58 / 16216
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3F64 / 16228
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_98(&(vLocal_12[iLocal_1229]), &uParam0);
		iLocal_122++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3FD0 / 16336
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(var uParam0) //Position: 0x3FE8 / 16360
{
	var uVar0;
	var uVar1;
	int iVar2;
			...
			if (IS_OBJECT_ATTACHED(&uVar1))
			{
				...
				if (IS_ATTACHMENT_VALID(&uVar3))
				{
					...
					if (IS_OBJECT_VALID(&iVar2))
					{
						...
						PRINTNL();
						PRINTSTRING(GET_OBJECT_MODEL_NAME(&iVar2));
						PRINTNL();
...
void Function_100(int iParam0) //Position: 0x408F / 16527
{
