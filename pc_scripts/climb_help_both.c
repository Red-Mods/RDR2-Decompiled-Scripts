...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_94(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		Function_93(&uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_87(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_85(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_80("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_79(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_72(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_71(&(vLocal_2[iVar39]));
						...
						{
							Function_97("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_112 - 1))
			{
				if (Function_70(vLocal_2[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_2[iVar09])))
					{
						Function_97("Quitting due to update end");
						Function_72(&(vLocal_2[iVar09]), 1);
					}
				}
	...
	{
		Function_97("Removing quit context at script termination");
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	if (!Function_70(Param0.f_64, 2))
	{
		Function_79(&Param0 + 24, 0);
	}
					...
					if (IS_ACTOR_LOCAL_PLAYER(&Param0 + 24))
					{
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
								{
									Function_97("ManagePlayerQuit: Create quit context");
								...
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_121))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
									{
										Function_97("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
								{
									if (Function_6(&Param0 + 24))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
										{
											Function_97("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
										}
									}
								}
						...
						else if (Global_6663)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
							{
								Function_97("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
							}
						}
					}
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	bVar11 = Function_69(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_80("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_80("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_80("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_68(&Param0 + 16, &fVar22))
				{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_70(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_70(Param0.f_64, 1))
			{
				Function_56(&Param0 + 16, &Var3, &uVar5);
				if (!Function_70(Param0.f_64, 16))
				{
				...
				if (!Function_70(Param0.f_64, 1024))
				{
			...
			if (Param0.f_68 != 3 && !Function_70(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_70(Param0.f_64, 1);
			}
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_70(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x28F3 / 10483
{
	...
	uVar3 = Function_67(&iParam1);
	uVar4 = Function_57(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &uVar0, uVar3, 0,2f, 1, fVar2, uVar4, 0, 0);
}

int Function_67(int iParam0) //Position: 0x293C / 10556
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

bool Function_68(var uParam0, int iParam1) //Position: 0x2960 / 10592
{
...
int Function_69(var uParam0) //Position: 0x298E / 10638
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2AA7 / 10919
{
	return (uParam0 && iParam1) == 0;
}

void Function_71(struct<69> Param0) //Position: 0x2AB4 / 10932
{
	if (Function_70(Param0.f_64, 16))
	{
...
void Function_72(struct<69> Param0) //Position: 0x2B36 / 11062
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_70(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_78(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_70(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_70(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_77(&Param0 + 16) && Function_70(Param0.f_64, 512))
			{
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_74(&Param0 + 16), &Param0 + 16);
	}
...
void Function_73() //Position: 0x30E1 / 12513
{
	int iVar0;
...
int Function_74(int iParam0) //Position: 0x311B / 12571
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_75(int iParam0, var uParam1) //Position: 0x3139 / 12601
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_76(int iParam0) //Position: 0x317A / 12666
{
	iParam0 = &iParam0;
	return;
}

bool Function_77(int iParam0) //Position: 0x3186 / 12678
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_78(int iParam0, int iParam1) //Position: 0x31A8 / 12712
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_79(var uParam0, bool bParam1) //Position: 0x31BA / 12730
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
		{
			Function_97("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
		{
			if (&bParam1)
			{
				Function_97("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
			{
				if (&bParam1)
				{
					Function_97("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
			}
		}
	...
	if (&bParam1)
	{
		Function_97("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_80(int iParam0, int iParam1) //Position: 0x32CA / 13002
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_81(struct<69> Param0) //Position: 0x32E2 / 13026
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_82(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_82(int iParam0, int iParam1) //Position: 0x35FE / 13822
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_83(int iParam0) //Position: 0x3610 / 13840
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_84(int iParam0) //Position: 0x362A / 13866
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_85(int iParam0, var uParam1) //Position: 0x3645 / 13893
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_86(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_86(var uParam0, int iParam1) //Position: 0x3683 / 13955
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_87(struct<65> Param0) //Position: 0x369C / 13980
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_91(&uVar1, &Param0 + 16))
		{
		...
		if (!Function_70(Param0.f_64, 2))
		{
			...
			if (Function_70(Param0.f_64, 1))
			{
				Function_80("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				...
				if (!Function_89(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				fVar30 = Function_88(&Param0 + 16);
				if (!fVar30 != 0.0f)
				{
					if (fVar30 < 0.0f)
					{
...
int Function_88(int iParam0) //Position: 0x3994 / 14740
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_89(var uParam0, int iParam1) //Position: 0x39B2 / 14770
{
	struct<5> Var0;
	float fVar5;
...
int Function_90(int iParam0) //Position: 0x3A52 / 14930
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_91(int iParam0, var uParam1) //Position: 0x3A72 / 14962
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_92(int iParam0) //Position: 0x3A85 / 14981
{
...
void Function_93(int iParam0) //Position: 0x3AA1 / 15009
{
	iParam0 = &iParam0;
	return;
}

void Function_94(var uParam0, int iParam1) //Position: 0x3AAD / 15021
{
	int iVar0;
	var uVar1;
	...
	{
		Function_95(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_95(int iParam0, int iParam1) //Position: 0x3B19 / 15129
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_96(int iParam0) //Position: 0x3B31 / 15153
{
	iParam0 = &iParam0;
	return;
}

void Function_97(int iParam0) //Position: 0x3B3D / 15165
{
