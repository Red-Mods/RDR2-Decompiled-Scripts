...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_296, Function_87(), bScriptParam_0);
				Function_47(&uLocal_316, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_296);
	Function_8(&uLocal_316);
	Function_6();
...
bool Function_29(int iParam0, bool bParam1) //Position: 0xBAC / 2988
{
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAF05 / 44805
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_206(char* cParam0) //Position: 0xC00A / 49162
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC04A / 49226
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC13A / 49466
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC14D / 49485
{
	Function_210(0, 0.0f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC167 / 49511
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC275 / 49781
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC283 / 49795
{
...
void Function_213() //Position: 0xC2A2 / 49826
{
...
void Function_214(var uParam0) //Position: 0xC2BE / 49854
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC2C8 / 49864
{
	return;
}

void Function_216(int iParam0) //Position: 0xC2CE / 49870
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC2D8 / 49880
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC2F2 / 49906
{
	int iVar0;
...
void Function_219() //Position: 0xC30F / 49935
{
	return;
}

void Function_220() //Position: 0xC315 / 49941
{
	return;
}

void Function_221(int iParam0) //Position: 0xC31B / 49947
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC325 / 49957
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC629 / 50729
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC835 / 51253
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC846 / 51270
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF2D / 53037
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF3C / 53052
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCF8D / 53133
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xCFDC / 53212
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD010 / 53264
{
	int iVar0;
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD02D / 53293
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD0E3 / 53475
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD14F / 53583
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD171 / 53617
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD177 / 53623
{
...
int Function_236(int iParam0) //Position: 0xD19A / 53658
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD1B6 / 53686
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD1BD / 53693
{
	Function_239(&uLocal_316, &cLocal_7, "waterWheel01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_316, &cLocal_7, "waterWheel01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD211 / 53777
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD314 / 54036
{
	int iVar0;
...
void Function_241() //Position: 0xD345 / 54085
{
	Function_242(&uLocal_9, &uLocal_296, 4, &iLocal_230 + 40, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_296, 5, &iLocal_230 + 8, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_296, 5, &iLocal_230 + 16, 4294967295, 266);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD37F / 54143
{
...
void Function_243(struct<5> Param0) //Position: 0xD46C / 54380
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD47D / 54397
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD4F3 / 54515
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD591 / 54673
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD59A / 54682
{
	cLocal_7 = Function_248(&iLocal_178, "ntwinrocks", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD5B7 / 54711
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD5DA / 54746
{
	return Function_250();
}

int Function_250() //Position: 0xD5E3 / 54755
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_230 = FIND_NAMED_LAYOUT("TwinRocks_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_230))
	{
		iLocal_230 = CREATE_LAYOUT("TwinRocks_layout");
	}
	*(&iLocal_230 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "ntwrv_main", 2,802597E-45f, Vector(-2419,218f, 28,40931f, 2127,467f), Vector(0.0f, 48,61477f, 0.0f), Vector(7,345848f, 4,531405f, 5,979833f));
	*(&iLocal_230 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "ntwrv_bunk", 2,802597E-45f, Vector(-2414,411f, 27,62044f, 2140,523f), Vector(0.0f, 9,201379f, 0.0f), Vector(5,340143f, 4,164891f, 6,735958f));
	*(&iLocal_230 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_hut", 2,802597E-45f, Vector(-2422,211f, 24,95054f, 2151,077f), Vector(0.0f, 16,27139f, 0.0f), Vector(5,51716f, 5,51716f, 5,51716f));
	*(&iLocal_230 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_courtyard", 4,203895E-45f, Vector(-2434,562f, 26,14284f, 2138,854f), Vector(0.0f, 20.0f, 0.0f), Vector(6,965883f, 5,306581f, 6,583744f));
	*(&iLocal_230 + 40) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_region", 4,203895E-45f, Vector(-2432f, 31,48506f, 2145,475f), Vector(0.0f, 20.0f, 0.0f), Vector(74,6052f, 17,20428f, 74,89449f));
	*(&iLocal_230 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_cellDoor01", 2,802597E-45f, Vector(-2424,24f, 27,86292f, 2123,214f), Vector(0.0f, 49,14137f, 0.0f), Vector(1,399422f, 2,532508f, 0,1635376f));
	*(&iLocal_230 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_cell01", 2,802597E-45f, Vector(-2424,811f, 28,00207f, 2121,575f), Vector(0.0f, -130,8067f, 0.0f), Vector(4,71092f, 2,630623f, 2,806002f));
	*(&iLocal_230 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_230, "twrv_zombies_01", 4,203895E-45f, Vector(-2430,965f, 19,05272f, 2143,275f), Vector(0.0f, 20.0f, 0.0f), Vector(42,37038f, 9,770792f, 42,53467f));
	*(&iLocal_230 + 72) = Vector(-2300f, 27,60785f, 2240f);
	*(&iLocal_230 + 72 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_230 + 96) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_reinforceSpawn1", Vector(-2300f, 27,60785f, 2240f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_230 + 104) = Vector(-2423,571f, 26,68939f, 2123,423f);
	*(&iLocal_230 + 104 + 12) = Vector(0.0f, 48,45982f, 0.0f);
	*(&iLocal_230 + 128) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_lootRoomFlag", Vector(-2423,571f, 26,68939f, 2123,423f), Vector(0.0f, 48,45982f, 0.0f));
	*(&iLocal_230 + 136) = Vector(-2300f, 27,60783f, 2172f);
	*(&iLocal_230 + 136 + 12) = Vector(0.0f, 83,85815f, 0.0f);
	*(&iLocal_230 + 160) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_reinforceSpawn2", Vector(-2300f, 27,60783f, 2172f), Vector(0.0f, 83,85815f, 0.0f));
	*(&iLocal_230 + 168) = Vector(-2423,3f, 30,40257f, 2124,234f);
	*(&iLocal_230 + 168 + 12) = Vector(0.0f, 56,96858f, 0.0f);
	*(&iLocal_230 + 192) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_AreaTreasure1", Vector(-2423,3f, 30,40257f, 2124,234f), Vector(0.0f, 56,96858f, 0.0f));
	*(&iLocal_230 + 200) = Vector(-2411,583f, 25,62742f, 2136,698f);
	*(&iLocal_230 + 200 + 12) = Vector(0.0f, -80,28419f, 0.0f);
	*(&iLocal_230 + 224) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_AreaTreasure2", Vector(-2411,583f, 25,62742f, 2136,698f), Vector(0.0f, -80,28419f, 0.0f));
	*(&iLocal_230 + 232) = Vector(-2450,403f, 33,47676f, 2126,371f);
	*(&iLocal_230 + 232 + 12) = Vector(0.0f, 195,8737f, 0.0f);
	*(&iLocal_230 + 256) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twrf_AreaTreasure3", Vector(-2450,403f, 33,47676f, 2126,371f), Vector(0.0f, 195,8737f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos1", Vector(-2355,767f, 43,67f, 2145,133f), Vector(-9,953f, 93,043f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos2", Vector(-2393,283f, 40,185f, 2062,816f), Vector(-10,204f, 155,927f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos3", Vector(-2518,689f, 32,912f, 2061,615f), Vector(-2,798f, -124,849f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos4", Vector(-2494,521f, 25,574f, 2161,221f), Vector(2,528f, -71,907f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos5", Vector(-2442,571f, 25,63f, 2230,282f), Vector(2,528f, -6,103f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos6", Vector(-2448,418f, 24,328f, 2180,775f), Vector(2,372f, -28,54f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos7", Vector(-2456,419f, 25,066f, 2147,736f), Vector(5,621f, -70,497f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos8", Vector(-2392,986f, 30,864f, 2145,408f), Vector(-6,954f, 73,795f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos9", Vector(-2447,499f, 35,018f, 2127,488f), Vector(-11,383f, -98,999f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_230, "twr_vista_cam_pos10", Vector(-2422,66f, 25,948f, 2154,043f), Vector(8,411f, 6,988f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xDC9A / 56474
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xDCE4 / 56548
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xDCF5 / 56565
{
	return;
}

bool Function_254() //Position: 0xDCFB / 56571
{
	return 1;
}

void Function_255() //Position: 0xDD02 / 56578
{
	SET_FACTIONS_STATUS_TWO_WAY(2, 25, 3);
	return;
}

bool Function_256() //Position: 0xDD0F / 56591
{
	return Function_257();
}

int Function_257() //Position: 0xDD18 / 56600
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("TwinRocks_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("TwinRocks_layout");
	}
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-2415,303f, 28,79648f, 2137,928f), Vector(0.0f, 9,079557f, 0.0f), Vector(7,073998f, 10,66432f, 7,684002f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-2421,908f, 29,94221f, 2124,989f), Vector(0.0f, 49,11822f, 0.0f), Vector(7,7623f, 10.0f, 14,63856f));
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-2422,485f, 29,20027f, 2125,656f), Vector(0.0f, 49,11822f, 0.0f), Vector(10,22877f, 8,992779f, 16,03852f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_2", 2,802597E-45f, Vector(-2415,303f, 28,79648f, 2137,928f), Vector(0.0f, 9,079557f, 0.0f), Vector(12,39289f, 10,66432f, 7,684002f));
	*(&iLocal_178 + 96) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-2416,785f, 29,30136f, 2138,906f), Vector(0.0f, 94,14911f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 96);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-2413,361f, 29,31359f, 2140,138f), Vector(0.0f, 230.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 96);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-2421,384f, 30,83087f, 2127,109f), Vector(0.0f, 145.0f, 0.0f));
	DECOR_SET_INT(&uVar3, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar3, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 96);
	*(&iLocal_178 + 104) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-2420,394f, 30,83087f, 2126,119f), Vector(0.0f, -221.0f, 0.0f));
	DECOR_SET_INT(&uVar4, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar4, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 104);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-2421,384f, 30,83087f, 2127,109f), Vector(0.0f, -45.0f, 0.0f));
	DECOR_SET_INT(&uVar5, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar5, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 104);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-2415,386f, 29,30136f, 2138,69f), Vector(0.0f, -262,2712f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 104);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-2416,785f, 29,30136f, 2138,906f), Vector(0.0f, -80,98174f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 104);
	*(&iLocal_178 + 112) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-2413,361f, 29,31359f, 2140,138f), Vector(0.0f, 230.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 112);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-2421,384f, 30,83087f, 2127,109f), Vector(0.0f, 145.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 112);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05_core", Vector(-2417,588f, 29,30136f, 2135,821f), Vector(0.0f, 94,14911f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar10, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 112);
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_04_player", Vector(-2413,551f, 29,31359f, 2138,739f), Vector(0.0f, -172,2649f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 120);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_04_surv", Vector(-2413,361f, 29,31359f, 2140,138f), Vector(0.0f, 8.0f, 0.0f));
	DECOR_SET_INT(&uVar12, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 120);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_player", Vector(-2417,005f, 29,30136f, 2137,051f), Vector(0.0f, 9,631139f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar13, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 120);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_surv", Vector(-2417,246f, 29,30136f, 2135,655f), Vector(0.0f, -170.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 39);
	DECOR_SET_BOOL(&uVar14, "Core", true);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 120);
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-2436f, 24,60082f, 2137,544f), Vector(0.0f, -126,8194f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 128);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-2434,577f, 24,61513f, 2141,527f), Vector(0.0f, -12,01207f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 128);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-2432,002f, 24,6132f, 2138,2f), Vector(0.0f, 123,0811f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-2421,764f, 26,36346f, 2122,552f), Vector(0.0f, -218,9582f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 136);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-2416.0f, 25,09812f, 2154,72f), Vector(0.0f, -320,6008f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 136);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_4", Vector(-2422,3f, 26,10194f, 2108f), Vector(0.0f, -45,99229f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 136);
	*(&iLocal_178 + 144) = Vector(-2424,093f, 26,36347f, 2122,362f);
	*(&iLocal_178 + 144 + 12) = Vector(0.0f, -130,8715f, 0.0f);
	*(&iLocal_178 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-2424,093f, 26,36347f, 2122,362f), Vector(0.0f, -130,8715f, 0.0f));
	*(&iLocal_178 + 176) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand1", "rand_idle_stand", Vector(-2434,545f, 24,63879f, 2141,455f), Vector(0.0f, 7,450444f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 176), 0);
	*(&iLocal_178 + 184) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand2", "rand_idle_stand", Vector(-2436f, 24,60082f, 2137,545f), Vector(0.0f, 227,2839f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 184), 0);
	*(&iLocal_178 + 192) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(-2431,989f, 24,61278f, 2138,194f), Vector(0.0f, 122,5305f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_178 + 192), 0);
	*(&iLocal_178 + 200) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-2425,258f, 26,38067f, 2120,7f), Vector(0.0f, -41,05323f, 0.0f));
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xE849 / 59465
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xE8E4 / 59620
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xE9F0 / 59888
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xEACC / 60108
{
...
int Function_262(int iParam0) //Position: 0xEB47 / 60231
{
...
bool Function_263(int iParam0) //Position: 0xEB5C / 60252
{
...
int Function_264(int iParam0) //Position: 0xEBC2 / 60354
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xEC84 / 60548
{
	int iVar0;
...
void Function_266() //Position: 0xECA1 / 60577
{
	return;
}

void Function_267(char* cParam0) //Position: 0xECA7 / 60583
{
	if (!Function_26(128))
	{
		return;
