						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_51))
								{
									...
									{
										bLocal_51 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_51 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_8(char* cParam0, int iParam1) //Position: 0x90B / 2315
{
	return Function_9(&cParam0, "UseQuit", &iParam1);
}

bool Function_9(char* cParam0, char* cParam1, int iParam2) //Position: 0x924 / 2340
{
	int iVar0;
	int iVar1;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_48, &uLocal_46);
...
bool Function_26(var uParam0, bool bParam1) //Position: 0x1FC2 / 8130
{
	var uVar0;
	...
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
		if (!DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "ForceMusicGringoUse"))
		{
			if (AUDIO_IS_SCRIPTED_MUSIC_PLAYING())
			{
				uVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
				if (STRING_CONTAINS_STRING(&uVar0, "nsit_piano"))
				{
					if (!iLocal_1)
					{
						iLocal_1 = 1;
						SET_ACTION_NODE_FOR_ACTOR(&uParam0, "piano_sit/leave/stand");
					}
				}
				else
				{
...
bool Function_27(bool bParam0) //Position: 0x204F / 8271
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x206F / 8303
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x2075 / 8309
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2087 / 8327
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2094 / 8340
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x20AF / 8367
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20CF / 8399
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x20EF / 8431
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2126 / 8486
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2146 / 8518
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2161 / 8545
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2177 / 8567
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x249B / 9371
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x24A4 / 9380
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24C3 / 9411
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x24D2 / 9426
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24F6 / 9462
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x251C / 9500
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x253A / 9530
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x255C / 9564
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x257E / 9598
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2646 / 9798
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26C2 / 9922
{
...
void Function_50(vector3 vParam0) //Position: 0x26DA / 9946
{
...
var Function_51(int iParam0) //Position: 0x26FF / 9983
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x2720 / 10016
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2737 / 10039
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2743 / 10051
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x274A / 10058
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x275B / 10075
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27A0 / 10144
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27CC / 10188
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27D8 / 10200
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28DA / 10458
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x28FD / 10493
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2925 / 10533
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2C0C / 11276
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C69 / 11369
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2CC6 / 11462
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2CD2 / 11474
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CF1 / 11505
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2D08 / 11528
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D99 / 11673
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2DBD / 11709
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2DDC / 11740
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2E00 / 11776
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F28 / 12072
{
...
int Function_74(var uParam0) //Position: 0x2F56 / 12118
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x306F / 12399
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x307C / 12412
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30FE / 12542
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x36A9 / 13993
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x36E3 / 14051
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3701 / 14081
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3742 / 14146
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x374E / 14158
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x3770 / 14192
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (bLocal_0)
	...
	SET_ACTOR_CAN_PLAY_GESTURES(&iParam0, true);
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x3795 / 14229
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x38A5 / 14501
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x38BD / 14525
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3BD9 / 15321
{
	var uVar0;
	...
	iParam0 = &iParam0;
	uVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
	if (STRING_CONTAINS_STRING(&uVar0, "nharmonica"))
	{
...
bool Function_88(int iParam0) //Position: 0x3C1A / 15386
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C34 / 15412
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C4F / 15439
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C8D / 15501
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3CA6 / 15526
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F9E / 16286
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FBC / 16316
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x405D / 16477
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x407D / 16509
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
...
bool Function_97(int iParam0) //Position: 0x40C1 / 16577
{
...
void Function_98(int iParam0) //Position: 0x40DD / 16605
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x40E9 / 16617
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4155 / 16725
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x416D / 16749
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4179 / 16761
{
