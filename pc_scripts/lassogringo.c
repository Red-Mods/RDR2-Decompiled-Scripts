...
void main() //Position: 0x0 / 0
{
	...
	Function_118("STARTS");
	Function_117(&uScriptParam_0);
	iLocal_126 = 0;
	Function_115(&uScriptParam_0, &iLocal_126);
	while (IS_GRINGO_ACTIVE())
	{
		Function_114(&uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_127);
		}
		iVar2 = 0;
		bLocal_134 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			{
				if (&vLocal_16[iVar09] + 16 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_126;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_108(&(vLocal_16[iVar39]), &bVar4))
						{
							Function_106(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_16[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (&vLocal_16[iVar39] + 24 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_101("eGRINGO_EndUse: Stop use by request", &vLocal_16[iVar39] + 24);
							Function_100(&vLocal_16[iVar39] + 24, 1);
							if (IS_ACTOR_VALID(&vLocal_16[iVar39] + 24))
							{
								if (IS_ACTOR_LOCAL_PLAYER(&vLocal_16[iVar39] + 24) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(&vLocal_16[iVar39] + 16))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(&vLocal_16[iVar39] + 24, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_78(&(vLocal_16[iVar39]), 0);
							}
							else if (vLocal_16[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_16[iVar39]));
								vLocal_16[iVar39].f_68 = 8;
							}
							bVar5 = true;
						}
						else
						{
							Function_118("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_126 - 1))
			{
				if (Function_76(vLocal_16[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_16[iVar09])))
					{
						Function_118("Quitting due to update end");
						Function_78(&(vLocal_16[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_16[iVar09]), 0))
				{
					Function_5(&(vLocal_16[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
	{
		Function_118("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_126 - 1))
	{
		if (Function_76(vLocal_16[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_16[iVar09] + 24);
			Function_78(&(vLocal_16[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_16[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_16[iVar09] + 16);
		}
		Function_15(&(vLocal_16[iVar09]), 1);
		iVar0++;
	}
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	if (!Function_76(Param0.f_64, 2))
	{
		Function_100(&Param0 + 24, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
					...
					if (IS_ACTOR_LOCAL_PLAYER(&Param0 + 24))
					{
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
								{
									Function_118("ManagePlayerQuit: Create quit context");
									if (Function_7(&Param0 + 16, "UseQuitBOverride", 0))
									{
										bLocal_135 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_135 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_135))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
									{
										Function_118("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
								{
									if (Function_6(&Param0 + 24))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
										{
											Function_118("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
										}
									}
								}
						...
						else if (Global_6663)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
							{
								Function_118("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
							}
						}
					}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
		{
			Function_118("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
		}
...
int Function_11(float fParam0, var uParam1, int iParam2) //Position: 0x98C / 2444
{
	int iVar0;
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	bVar11 = Function_75(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_101("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_101("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_101("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_74(&Param0 + 16, &fVar22))
				{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_76(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
				Function_68(&Param0 + 16);
			}
			fVar18 = Function_67(&Param0 + 16);
			if (Function_12(&Param0) < fVar18)
			{
				Function_2("INTRO TIMED OUT - ABORTING", &Param0 + 24);
				return 0;
			}
			if (Function_76(Param0.f_64, 1))
			{
				Function_62(&Param0 + 16, &Var3, &uVar5);
				if (!Function_76(Param0.f_64, 16))
				{
					if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
					{
						Function_2("SUSPEND MOVER", &Param0 + 24);
						SUSPEND_MOVER(&Param0 + 24);
						Function_61(&Param0 + 64, 16);
					}
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(&Param0 + 24, Var3, uVar5, 1, 1, Function_60());
				}
				if (!Function_76(Param0.f_64, 1024))
				{
					Function_61(&Param0 + 64, 1024);
			...
			if (Param0.f_68 != 3 && !Function_76(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_76(Param0.f_64, 1);
			}
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_132, &uLocal_130);
				...
				if (Function_31(&Param0 + 16))
				{
					...
					{
						Function_61(&Param0 + 64, 8);
					}
					else
					{
						Function_37(&Param0 + 64, 8);
					}
					if (Function_76(Param0.f_64, 8))
					{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_76(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
					...
					if (IS_GRINGO_COMPONENT_VALID(&uVar37))
					{
						...
						else
						{
							...
							if (iVar39 >= 0)
							{
								...
								{
									DECOR_SET_FLOAT(GRINGO_GET_MY_OBJECT_REF(), "Gringo_SpeechTime", GET_CURRENT_GAME_TIME());
									bVar47 = RAND_INT_RANGE(0, (iVar39 - 1));
...
void Function_29(var uParam0, int iParam1) //Position: 0x1FF5 / 8181
{
	var uVar0;
	int iVar1[8];
	int iVar10;
	...
	{
		iVar1[0] = GET_WEAPON_IN_HAND(&uVar0);
		iVar1[1] = GET_WEAPON_EQUIPPED(&uVar0, 0);
		iVar1[2] = GET_WEAPON_EQUIPPED(&uVar0, 1);
		iVar1[3] = GET_WEAPON_EQUIPPED(&uVar0, 2);
		iVar1[4] = GET_WEAPON_EQUIPPED(&uVar0, 3);
		iVar1[5] = GET_WEAPON_EQUIPPED(&uVar0, 4);
		iVar1[6] = GET_WEAPON_EQUIPPED(&uVar0, 5);
		iVar1[7] = GET_WEAPON_EQUIPPED(&uVar0, 6);
		iVar10 = 0;
		while (iVar10 < 7)
		{
			if (iVar1[iVar10] != 4294967295)
			{
				DELETE_WEAPON_FROM_ACTOR(&uVar0, iVar1[iVar10]);
				if (!DECOR_CHECK_EXIST(&uVar0, "Hogtie_DontGiveWeapons"))
				{
					...
					if (GET_AMMO_ENUM(iVar1[iVar10]) != 4294967295)
					{
						...
						if (!ACTOR_HAS_WEAPON(&uParam0, iVar1[iVar10]))
						{
							GIVE_WEAPON_TO_ACTOR(&uParam0, iVar1[iVar10], 0.0f, 1, 0);
							if ((_GET_MAX_AMMO_AMOUNT(&uParam0, bVar11) - _GET_AMMO_AMOUNT(&uParam0, bVar11, 0)) < 5.0f)
							{
								_ADD_AMMO_OF_TYPE(&uParam0, bVar11, GET_WEAPON_MAX_AMMO(iVar1[iVar10]), 1, 1);
							}
						}
						else if ((_GET_MAX_AMMO_AMOUNT(&uParam0, bVar11) - _GET_AMMO_AMOUNT(&uParam0, bVar11, 0)) < 5.0f)
						{
							_ADD_AMMO_OF_TYPE(&uParam0, bVar11, GET_WEAPON_MAX_AMMO(iVar1[iVar10]), 1, 1);
						}
					}
		...
		AI_SET_DISARMED(&uVar0, 1);
	}
	LASSO_EVENT(&uParam0, 0);
	if (DECOR_CHECK_EXIST(&uVar0, "lasso"))
	{
		DECOR_REMOVE(&uVar0, "lasso");
	}
	if (!DECOR_CHECK_EXIST(&uVar0, "hogtie"))
	{
		DECOR_SET_BOOL(&uVar0, "hogtie", 1);
	}
	DECOR_SET_BOOL(&uVar0, "NoBleedOut", 1);
	LASSO_EVENT(&uParam0, 1);
	if (!DECOR_CHECK_EXIST(&uVar0, "Hogtie_NoCripple") && !IS_ACTOR_CRIPPLED(&uVar0, 5))
	{
		SET_CRIPPLE_FLAG(&uVar0, RAND_INT_RANGE(1, 2));
	}
	AUDIO_PLAY_PLAYER_HOGTIE_LINE(&uVar0);
	if (!DECOR_CHECK_EXIST(&uVar0, "CanBeLasso"))
	{
		DECOR_SET_BOOL(&uVar0, "CanBeLasso", 0);
	}
	return;
}

bool Function_30(char* cParam0) //Position: 0x2249 / 8777
{
	cParam0 = &cParam0;
	return 0;
}

bool Function_31(int iParam0) //Position: 0x2256 / 8790
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2271 / 8817
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2291 / 8849
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x22B1 / 8881
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (vLocal_16 - 1))
	{
		if (&vLocal_16[iVar09] + 16 == &iParam0)
		{
			return &vLocal_16[iVar09] + 24;
		}
		iVar0++;
	}
	return &iVar1;
...
bool Function_35(int iParam0) //Position: 0x22E8 / 8936
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2308 / 8968
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2323 / 8995
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2339 / 9017
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x265D / 9821
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2666 / 9830
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2685 / 9861
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2694 / 9876
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x26B8 / 9912
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x26DE / 9950
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x26FC / 9980
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x271E / 10014
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(char* cParam0, int iParam1) //Position: 0x2740 / 10048
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2808 / 10248
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2884 / 10372
{
...
void Function_50(vector3 vParam0) //Position: 0x289C / 10396
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_61(&vParam0, 1);
	Function_37(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

var Function_51(int iParam0) //Position: 0x28C1 / 10433
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x28E2 / 10466
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(bool bParam0) //Position: 0x28F9 / 10489
{
	bParam0 = &bParam0;
	if (iLocal_4 && !iLocal_5)
	{
		iLocal_5 = 1;
		uLocal_0 = CREATE_LAYOUT("hogtieGringo_Layout");
		Function_59(&Global_54076);
		*(&Local_6 + 12) = Function_59(&Global_54076);
		Function_58(&Global_54076);
		Local_6 = Function_58(&Global_54076);
		Local_6.f_24 = 0;
		Local_6 = { StackVal, StackVal, StackVal, Local_6 };
		uLocal_2 = Function_54(&uLocal_0, 0, &Local_6, &Global_54076, GET_TARGET_ACTOR(), 1, 0, 1);
		UI_PUSH("nCutscenes");
		UNK_0x8CF09BD7(1);
	}
	return;
...
int Function_54(float fParam0, bool bParam1, var uParam2, Vector3 vParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x2979 / 10617
{
	var uVar0;
	
	if (&bParam5)
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&fParam0, Function_39(), 2, 1);
	}
	else
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&fParam0, "HogTie", 2, 1);
	}
	Function_55(&uVar0, &uParam2, &vParam3, &uParam4);
...
void Function_55(int iParam0, var uParam1, bool bParam2, var uParam3) //Position: 0x2A02 / 10754
{
	var uVar0;
	var uVar1;
	
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&iParam0, 0);
	Function_57(&uVar0, &uParam1, &bParam2, &uParam3);
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&iParam0, 1);
	Function_56(&uVar0, &uParam1, &bParam2, &uParam3);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(&iParam0, 0);
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&iParam0, 0, 1.0f, 0);
	SET_TRANSITION_COLLISION_PARAMS(&uVar1, 1, 0);
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_EASE_IN_OUT(&iParam0, 0, 1, 2,5f, 1, 1);
	SET_TRANSITION_COLLISION_PARAMS(&uVar1, 1, 0);
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&iParam0, 1, 1.0f, 2);
	SET_TRANSITION_COLLISION_PARAMS(&uVar1, 1, 0);
}

void Function_56(float fParam0, struct<25> Param1) //Position: 0x2A89 / 10889
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	SET_CAMERASHOT_PERSPECTIVE(&fParam0, 1);
	SET_CAMERASHOT_FOV(&fParam0, 52,68325f);
	...
	Var0 = Vector(0,807802f, 0,543602f, 0,300283f);
	...
	Var0 = Vector(0,970749f, -0,235249f, 0,048004f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
...
void Function_57(var uParam0, struct<25> Param1) //Position: 0x2B87 / 11143
{
	struct<2> Var0;
	...
	Var0 = Vector(0,833933f, 0,532759f, 0,510557f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
	Var0 = Vector(StackVal, StackVal, StackVal) + Vector(*(&Param1 + 12), Var0, StackVal);
	Var0 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(0.0f, 0.0f, 0.0f), Var0, StackVal);
	SET_CAMERASHOT_POSITION(&uParam0, Var0);
	Var0 = Vector(0,69485f, -0,155595f, 0,70212f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
	SET_CAMERASHOT_DIRECTION(&uParam0, Var0, 0);
	ADD_CAMERASHOT_COLLISION_EXCLUSION(&uParam0, &uParam2, 119);
	ADD_CAMERASHOT_COLLISION_EXCLUSION(&uParam0, &uParam3, 52);
	ADD_CAMERASHOT_COLLISION_BOUNDFLAG(&uParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&uParam0, &uParam2, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &uParam0, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 1,5f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&uParam0);
	ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &uParam2, Function_39(), Vector(0,69485f, 0,655595f, 0,70212f), Vector(0.0f, 45.0f, 0.0f), 4294967295);
}

struct<8> Function_58(int iParam0) //Position: 0x2CAC / 11436
{
	struct<2> Var0;
...
struct<8> Function_59(var uParam0) //Position: 0x2CD5 / 11477
{
	struct<2> Var0;
...
int Function_60() //Position: 0x2CFE / 11518
{
	return 1;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2D05 / 11525
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_62(int iParam0, var uParam1, int iParam2) //Position: 0x2D16 / 11542
{
	float fVar0;
	
	Function_65(&iParam0);
	uParam1 = Function_65(&iParam0);
	iParam2 = Function_64(&iParam0);
	fVar0 = Function_63(&iParam0);
	if (fVar0 < 180.0f)
	{
		fVar0 = 180.0f;
	}
...
int Function_63(int iParam0) //Position: 0x2D5B / 11611
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_64(int iParam0) //Position: 0x2D87 / 11655
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_65(int iParam0) //Position: 0x2D93 / 11667
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_66(int iParam0) //Position: 0x2E95 / 11925
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_67(int iParam0) //Position: 0x2EB8 / 11960
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_68(int iParam0) //Position: 0x2EE0 / 12000
{
	iParam0 = &iParam0;
	return;
}

void Function_69(int iParam0) //Position: 0x2EEC / 12012
{
	iParam0 = &iParam0;
	return;
}

bool Function_70(int iParam0) //Position: 0x2EF8 / 12024
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2F17 / 12055
{
	if (!Function_14(&iParam0))
	{
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2F2E / 12078
{
	var uVar0;
...
bool Function_73() //Position: 0x2F72 / 12146
{
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2F8D / 12173
{
...
int Function_75(var uParam0) //Position: 0x2FBB / 12219
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x30D4 / 12500
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x30E1 / 12513
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x3163 / 12643
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_76(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_84(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_76(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_76(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_83(&Param0 + 16) && Function_76(Param0.f_64, 512))
			{
	...
	if (&Param0 + 16 == &iLocal_132)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_130));
		iLocal_132 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_80(&Param0 + 16), &Param0 + 16);
	}
...
void Function_79() //Position: 0x370E / 14094
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x3748 / 14152
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x3766 / 14182
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x37A7 / 14247
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x37B3 / 14259
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x37D5 / 14293
{
	var uVar0;
	...
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		HUD_ENABLE(1);
		if (DECOR_CHECK_EXIST(&uVar0, "Mission_RemoveWhenHogtied"))
		{
			DECOR_REMOVE(&uVar0, "Mission_RemoveWhenHogtied");
		}
	}
	...
	if (IS_ACTOR_PLAYER(&uVar0))
	{
		AI_CLEAR_DONT_HARM_ACTOR(&uVar0);
	}
	if (DECOR_CHECK_EXIST(&uVar0, "hogtie"))
	{
		DECOR_REMOVE(&uVar0, "hogtie");
	}
	MEMORY_CONSIDER_AS_ENEMY(&uVar0, &uParam0);
	if (IS_OBJECT_VALID(&uLocal_2))
	{
		DESTROY_OBJECT(&uLocal_2);
	}
	UI_POP("nCutscenes");
	UNK_0x8CF09BD7(0);
...
int Function_85(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3902 / 14594
{
	int iVar0;
	int iVar1;
	...
	Function_99(iParam0, TO_FLOAT(bParam1), 1);
	Function_98(iParam0);
	if (uParam2 && bParam1 == 0)
	{
		Function_87(iParam0, 1, TO_FLOAT(bParam1), 1, 1, 3.0f, 0, &uParam3);
	}
...
void Function_86(bool bParam0) //Position: 0x3B2A / 15146
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_87(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, var uParam5, bool bParam6, var uParam7) //Position: 0x3BC8 / 15304
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
	...
	switch (Global_55480[iParam016].f_96)
	{
		...
		case 0x0000000F:
			if (iParam0 == 390)
			{
				...
				stradd(&Global_55480[iParam016] + 32, INT_TO_STRING(FLOOR(Function_97(390))), 32);
			}
			break;
	}
	CLEAR_STAT_MESSAGE();
	if (!Global_77928)
	{
		...
		switch (Global_55480[iParam016].f_96)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_96(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_94(iParam0, bVar19, bVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_91(bVar19, bParam2, &iVar17, &iVar18);
							if (!IS_STRING_VALID(&uParam7))
							{
								uParam7 = "Common_Null";
							}
							Var9 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_89(Global_131807.f_1316, Global_132499.f_1412, 0, 1) };
							SET_STAT_MESSAGE(STRING_TO_HASH(&uParam7), &Global_55480[iParam016] + 32, Function_88(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_39(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_88(int iParam0) //Position: 0x420E / 16910
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_89(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x421F / 16927
{
	char* cVar0[32];
	...
	if (&bParam3)
	{
		...
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_90("icon_prestige_award_", I2STR((iParam1 - 1))) };
	}
	if (iParam1 < 0)
	{
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_90("icon_prestige_", I2STR((iParam0 / 5))) };
	}
...
struct<32> Function_90(char* cParam0) //Position: 0x4316 / 17174
{
	char* cVar0[32];
...
void Function_91(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x4331 / 17201
{
	float fVar0;
	
	fVar0 = (Global_131807[Global_131807.f_1316 + 13] - Global_131807[Global_131807.f_13163]);
	uParam2 = Function_93(100, FLOOR((((fParam0 - Global_131807[Global_131807.f_13163]) / fVar0) * 100.0f)));
	uParam3 = Function_92(Function_93(100, FLOOR(((fParam1 / fVar0) * 100.0f))), 1);
}

var Function_92(int iParam0, int iParam1) //Position: 0x4398 / 17304
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_93(int iParam0, bool bParam1) //Position: 0x43AA / 17322
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_94(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x43BC / 17340
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (((Function_95(iParam0) != 19 || Function_95(iParam0) != 17) || Function_95(iParam0) != 10) || Function_95(iParam0) != 9)
	{
		if (fParam1 > fVar1)
		{
			fParam1 = fVar1;
...
int Function_95(int iParam0) //Position: 0x44F0 / 17648
{
	return Global_55480[iParam016].f_96;
}

float Function_96(int iParam0) //Position: 0x44FF / 17663
{
	if (!iParam0 != 4294967295)
	{
...
var Function_97(int iParam0) //Position: 0x4538 / 17720
{
	if (iParam0 == 4294967295)
	{
...
void Function_98(int iParam0) //Position: 0x4575 / 17781
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_99(int iParam0, float fParam1, bool bParam2) //Position: 0x470F / 18191
{
	int iVar0;
	int iVar1;
...
void Function_100(var uParam0, bool bParam1) //Position: 0x4953 / 18771
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
		{
			Function_118("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
		{
			if (&bParam1)
			{
				Function_118("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_135))
			{
				if (&bParam1)
				{
					Function_118("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(&bLocal_135);
			}
		}
	...
	if (&bParam1)
	{
		Function_118("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_101(int iParam0, int iParam1) //Position: 0x4A63 / 19043
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_102(struct<69> Param0) //Position: 0x4A7B / 19067
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	if (Function_83(&Param0 + 16))
	{
		if (GET_ACTOR_ALLOW_BUMP_REACTIONS(&Param0 + 24))
		{
			Function_61(&Param0 + 64, 512);
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_103(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_103(var uParam0, int iParam1) //Position: 0x4D97 / 19863
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_104(int iParam0) //Position: 0x4DD5 / 19925
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_105(int iParam0) //Position: 0x4DEF / 19951
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_106(int iParam0, var uParam1) //Position: 0x4E0A / 19978
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_107(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_107(var uParam0, int iParam1) //Position: 0x4E48 / 20040
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_108(struct<65> Param0) //Position: 0x4E61 / 20065
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_112(&uVar1, &Param0 + 16))
		{
		...
		if (!Function_76(Param0.f_64, 2))
		{
			...
			if (Function_76(Param0.f_64, 1))
			{
				Function_101("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				Function_65(&Param0 + 16);
				Var8 = Function_65(&Param0 + 16);
				Var10 = Vector(StackVal, StackVal, StackVal) - Vector(Var2, Var8, StackVal);
				fVar12 = Function_111(&Param0 + 16);
				bVar13 = VMAG(Var10);
				...
				bVar30 = Function_109(&Param0 + 16);
				if (!bVar30 != 0.0f)
				{
					if (bVar30 < 0.0f)
					{
						fVar31 = (UNK_0x9C40E671(&Var10) - Function_64(&Param0 + 16));
					}
					else
					{
						fVar31 = ((180.0f + UNK_0x9C40E671(&Var10)) - Function_64(&Param0 + 16));
					}
					if (fVar31 < 180.0f)
					{
...
int Function_109(int iParam0) //Position: 0x5159 / 20825
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_110(var uParam0, int iParam1) //Position: 0x5177 / 20855
{
	struct<5> Var0;
	float fVar5;
...
int Function_111(int iParam0) //Position: 0x5217 / 21015
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_112(int iParam0, int iParam1) //Position: 0x5237 / 21047
{
	int iVar0;
	...
	if (GET_LASSO_TARGET(&iParam0) != &iVar0)
	{
		return 0;
	}
	...
	if (!CAN_ACTOR_HOGTIE_TARGET(&iParam0, &iVar0))
	{
		return 0;
	}
	iParam1 = &iParam1;
...
bool Function_113(int iParam0) //Position: 0x5290 / 21136
{
...
void Function_115(var uParam0, int iParam1) //Position: 0x52B8 / 21176
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_116(&(vLocal_16[iLocal_1269]), &uParam0);
		iLocal_126++;
	}
...
void Function_116(int iParam0, int iParam1) //Position: 0x5324 / 21284
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_117(int iParam0) //Position: 0x533C / 21308
{
	iParam0 = &iParam0;
	return;
}

void Function_118(int iParam0) //Position: 0x5348 / 21320
{
