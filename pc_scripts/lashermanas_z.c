...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x00000005:
				...
				Function_242();
				Function_239(bScriptParam_0);
				iLocal_5 = 6;
				bLocal_6 = false;
				break;
			
			case 0x00000006:
				if ((Function_238() && Function_237(Global_44085[bScriptParam_09])) && Function_236(&iLocal_13))
				{
					Function_235();
					iLocal_5 = 7;
					bLocal_6 = false;
			...
			case 0x00000007:
				if (bLocal_177)
				{
					Function_223(&iLocal_13, bScriptParam_0, Function_247());
				}
				Function_222(bScriptParam_0);
				Function_221();
				Function_220();
				Function_253(&(Global_43791[bScriptParam_0]), 8);
				if (Function_219(&(Global_43791[bScriptParam_0]), 131072))
				{
					Function_218(&(Global_43791[bScriptParam_0]), 131072);
					iLocal_5 = 11;
				}
				else
				{
			...
			case 0x00000008:
				...
				Function_216();
				Function_215(bScriptParam_0);
				iLocal_5 = 9;
				bLocal_6 = false;
				break;
			
			case 0x00000009:
				Function_210(bScriptParam_0);
				Function_209(64);
			...
			case 0x0000000A:
				Function_208(Function_247(), bScriptParam_0);
				strcpy(&cVar0, "Finished Initializing ", 64);
				stradd(&cVar0, &Global_44085[bScriptParam_09] + 32, 64);
				Function_207(&cVar0, 5.0f);
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_516, Function_87(), bScriptParam_0);
				Function_47(&uLocal_572, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_516);
	Function_8(&uLocal_572);
	Function_6();
	Function_2(bScriptParam_0);
	SET_AMBIENT_TUNING_MAX_VISIBLE_RANGE(70.0f);
	Function_209(64);
	Function_218(&(Global_43791[bScriptParam_0]), 32);
	Function_218(&(Global_43791[bScriptParam_0]), 64);
	Function_218(&(Global_43791[bScriptParam_0]), 8);
	Function_218(&(Global_43791[bScriptParam_0]), 512);
	Function_218(&(Global_43791[bScriptParam_0]), 16);
	Function_218(&(Global_43791[bScriptParam_0]), 4);
	Function_1();
...
void Function_19() //Position: 0x87C / 2172
{
	Function_20();
	return;
}

void Function_20() //Position: 0x885 / 2181
{
...
void Function_21(int iParam0) //Position: 0x898 / 2200
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x8C0 / 2240
{
...
void Function_23(struct<13> Param0) //Position: 0xA0B / 2571
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xA28 / 2600
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xA46 / 2630
{
	var uVar0;
	int iVar1;
	var uVar2;
	
	if (Function_219(&(Global_43791[bParam0]), 0x20000000))
	{
		Function_218(&(Global_43791[bParam0]), 0x20000000);
...
bool Function_26(int iParam0) //Position: 0xB00 / 2816
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB1C / 2844
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xB8F / 2959
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBAC / 2988
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xBB9 / 3001
{
...
void Function_31(int iParam0) //Position: 0xF20 / 3872
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0xF87 / 3975
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x12CF / 4815
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x15AF / 5551
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D05 / 7429
{
...
int Function_36(int iParam0) //Position: 0x1D1A / 7450
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D3C / 7484
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1DC5 / 7621
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1DE5 / 7653
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1E5A / 7770
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1E94 / 7828
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F10 / 7952
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x1FB1 / 8113
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x1FEE / 8174
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2004 / 8196
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x2017 / 8215
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x2031 / 8241
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x2452 / 9298
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x2465 / 9317
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x2482 / 9346
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x2494 / 9364
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x251E / 9502
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_218(&(Global_43791[iParam2]), 4194304);
	...
	switch (vParam0)
	{
		...
		case 0x00000004:
			...
			if (IS_ACTOR_IN_VOLUME(&uParam1, &vParam0 + 8))
			{
				if (!Function_219(&(Global_43791[iParam2]), 262144))
				{
...
void Function_53(int iParam0) //Position: 0x2976 / 10614
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	if (Function_219(&(Global_43791[iParam0]), 4096))
	{
		return;
	}
...
float Function_54(int iParam0) //Position: 0x2A67 / 10855
{
...
float Function_55(int iParam0) //Position: 0x2AA4 / 10916
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2ADD / 10973
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2B47 / 11079
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2B9F / 11167
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2DC7 / 11719
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2E65 / 11877
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x34A3 / 13475
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34AC / 13484
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x34BD / 13501
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x35B4 / 13748
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x35CF / 13775
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3636 / 13878
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3648 / 13896
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x377C / 14204
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x378B / 14219
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3925 / 14629
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3B69 / 15209
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3B76 / 15222
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3BA0 / 15264
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3E53 / 15955
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3EC6 / 16070
{
...
bool Function_76(bool bParam0) //Position: 0x3EFC / 16124
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3F72 / 16242
{
...
bool Function_78() //Position: 0x3F83 / 16259
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3F9C / 16284
{
...
bool Function_80(int iParam0) //Position: 0x3FB2 / 16306
{
...
bool Function_81(int iParam0) //Position: 0x3FC7 / 16327
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3FE5 / 16357
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x4096 / 16534
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x40A9 / 16553
{
	int iVar0;
	bool bVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x4123 / 16675
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x414C / 16716
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x416C / 16748
{
...
void Function_88(struct<82> Param0) //Position: 0x4181 / 16769
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	switch (&Param0 + 376)
	{
		...
		case 0x00000009:
			if (Function_236(&Param0))
			{
				...
				{
					Function_223(&Param0, bParam1, &Global_46715);
					*(&Param0 + 376) = 1;
				}
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x56BA / 22202
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x58B7 / 22711
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5AA1 / 23201
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5ED0 / 24272
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x6056 / 24662
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x60B0 / 24752
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x60EA / 24810
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x611E / 24862
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x612D / 24877
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_99(int iParam0) //Position: 0x6384 / 25476
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x63DB / 25563
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x6452 / 25682
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x64BE / 25790
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x662F / 26159
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6929 / 26921
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x69B7 / 27063
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A20 / 27168
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6AB1 / 27313
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6B42 / 27458
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6BD8 / 27608
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C13 / 27667
{
	bool bVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6C57 / 27735
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6D9B / 28059
{
...
void Function_113() //Position: 0x6DAD / 28077
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6DC2 / 28098
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x70CA / 28874
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x7398 / 29592
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x745C / 29788
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x7869 / 30825
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x78B4 / 30900
{
...
void Function_120() //Position: 0x79BA / 31162
{
	float fVar0;
...
void Function_121() //Position: 0x79ED / 31213
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7B80 / 31616
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7D39 / 32057
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7D47 / 32071
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x7F64 / 32612
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x800D / 32781
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x82A9 / 33449
{
...
struct<8> Function_128() //Position: 0x82EA / 33514
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x8373 / 33651
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x840A / 33802
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x8489 / 33929
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x84C6 / 33990
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x86D2 / 34514
{
...
bool Function_134(int iParam0) //Position: 0x86EC / 34540
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x8702 / 34562
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x876E / 34670
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
	...
	while (iVar5 < 145)
	{
		if (StackVal && (StackVal || IS_VOLUME_VALID(&Global_44085[iVar59] + 8) != 3 != 4))
		{
			...
			if (!Function_219(&(Global_43791[iVar5]), 4096) && !IS_ACTOR_IN_VOLUME(&Global_54076, &Global_44085[iVar59] + 8))
			{
				iVar4 = 0;
			}
			if (iVar4 == 1)
...
int Function_137(bool bParam0) //Position: 0x886E / 34926
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x88C6 / 35014
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8A80 / 35456
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8AA2 / 35490
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8AC0 / 35520
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8AD3 / 35539
{
	if (!IS_ACTOR_VALID(&Global_54076))
	{
		return 0;
	}
	if (Function_219(&(Global_43791[Global_46914[0]]), 4))
	{
	...
	if (Function_219(&(Global_43791[Global_46760[4]]), 4))
	{
	...
	if (Function_219(&(Global_43791[Global_46760[12]]), 4))
	{
	...
	if (Function_219(&(Global_43791[Global_46796[0]]), 4))
	{
	...
	if (Function_219(&(Global_43791[Global_46866[4]]), 4))
	{
...
var Function_143(int iParam0) //Position: 0x8D21 / 36129
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8D2D / 36141
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8D3F / 36159
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8D57 / 36183
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x916D / 37229
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x9262 / 37474
{
...
bool Function_149() //Position: 0x9326 / 37670
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x933D / 37693
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x9349 / 37705
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x9358 / 37720
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x93E3 / 37859
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x9422 / 37922
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x943D / 37949
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x94D2 / 38098
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x95BA / 38330
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x977B / 38779
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9AE5 / 39653
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9B09 / 39689
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9E28 / 40488
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA0CB / 41163
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA124 / 41252
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA198 / 41368
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA55A / 42330
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA59A / 42394
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA5C8 / 42440
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA5DB / 42459
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA61D / 42525
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA65B / 42587
{
	int iVar0;
...
bool Function_171() //Position: 0xA72A / 42794
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA823 / 43043
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAA85 / 43653
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, int iParam1, bool bParam2) //Position: 0xAF05 / 44805
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xAF97 / 44951
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB2A1 / 45729
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB2DD / 45789
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB3BB / 46011
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB40A / 46090
{
	bool bVar0;
...
void Function_182() //Position: 0xB44F / 46159
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB49D / 46237
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB4B0 / 46256
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB4DD / 46301
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB5DE / 46558
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB635 / 46645
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB687 / 46727
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB6C6 / 46790
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB791 / 46993
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB86B / 47211
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB8CA / 47306
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA0D / 47629
{
...
void Function_194() //Position: 0xBB93 / 48019
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBBFF / 48127
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBD3E / 48446
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBD62 / 48482
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBD73 / 48499
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBDB1 / 48561
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBDC8 / 48584
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE26 / 48678
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xBF8A / 49034
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xBFC8 / 49096
{
...
var Function_204(int iParam0, int iParam1, bool bParam2) //Position: 0xBFDD / 49117
{
	return (((bParam2 && 15) || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xC000 / 49152
{
	iParam0 = iParam0;
	if (!iLocal_798)
	{
		if (((Function_35(24) && !Function_35(25)) && Function_27(iParam0)) && !Function_206())
		{
...
bool Function_206() //Position: 0xC04B / 49227
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_207(char* cParam0) //Position: 0xC078 / 49272
{
	if (!Function_26(128))
	{
		return;
...
void Function_208(int iParam0, bool bParam1) //Position: 0xC0B8 / 49336
{
	char[] cVar0[4];
...
void Function_209(int iParam0) //Position: 0xC1A8 / 49576
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_210(bool bParam0) //Position: 0xC1BB / 49595
{
	Function_211(0, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_211(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC1D9 / 49625
{
	var uVar0;
	...
	*(&Global_43580 + 32) = &uParam4;
	...
	if (&bParam5)
	{
		Function_212(1048576);
	}
}

void Function_212(int iParam0) //Position: 0xC2E7 / 49895
{
	Function_213(&Global_43580, iParam0);
	return;
}

void Function_213(var uParam0, var uParam1) //Position: 0xC2F5 / 49909
{
...
void Function_214() //Position: 0xC314 / 49940
{
...
void Function_215(var uParam0) //Position: 0xC330 / 49968
{
	uParam0 = uParam0;
	return;
}

void Function_216() //Position: 0xC33A / 49978
{
	return;
}

void Function_217(int iParam0) //Position: 0xC340 / 49984
{
	if ((((Function_35(25) && !Function_35(26)) || (Function_35(26) && !Function_35(27))) && Function_27(iParam0)) && !Function_206())
	{
		Function_152("TerrCont_RCM", 0x41200000, 1, 0, 2, 1, 0);
	}
	return;
...
void Function_218(var uParam0, int iParam1) //Position: 0xC389 / 50057
{
	int iVar0;
...
bool Function_219(int iParam0, int iParam1) //Position: 0xC3A3 / 50083
{
	int iVar0;
...
void Function_220() //Position: 0xC3C0 / 50112
{
	return;
}

void Function_221() //Position: 0xC3C6 / 50118
{
	return;
}

void Function_222(int iParam0) //Position: 0xC3CC / 50124
{
	iParam0 = iParam0;
	return;
}

void Function_223(int iParam0, bool bParam1, int iParam2) //Position: 0xC3D6 / 50134
{
	...
	{
		Function_224(&iParam0, bParam1, &Global_11014, &iParam2);
	}
	else if (bParam1 == Global_46760[1])
	{
		Function_224(&iParam0, bParam1, &Global_11146, &iParam2);
	}
	else if (bParam1 == Global_46760[2])
	{
		Function_224(&iParam0, bParam1, &Global_11120, &iParam2);
	}
	else if (bParam1 == Global_46796[1])
	{
		Function_224(&iParam0, bParam1, &Global_11222, &iParam2);
	}
	else if (bParam1 == Global_46796[3])
	{
		Function_224(&iParam0, bParam1, &Global_11284, &iParam2);
	}
	else if (bParam1 == Global_46796[4])
	{
		Function_224(&iParam0, bParam1, &Global_11492, &iParam2);
	}
	else if (bParam1 == Global_46816[0])
	{
		Function_224(&iParam0, bParam1, &Global_11544, &iParam2);
	}
	else if (bParam1 == Global_46816[1])
	{
		Function_224(&iParam0, bParam1, &Global_11646, &iParam2);
	}
	else if (bParam1 == Global_46816[2])
	{
		Function_224(&iParam0, bParam1, &Global_11704, &iParam2);
	}
	else if (bParam1 == Global_46838[1])
	{
		Function_224(&iParam0, bParam1, &Global_11752, &iParam2);
	}
	else if (bParam1 == Global_46838[0])
	{
		Function_224(&iParam0, bParam1, &Global_11726, &iParam2);
	}
	else if (bParam1 == Global_46850[0])
	{
		Function_224(&iParam0, bParam1, &Global_11836, &iParam2);
	}
	else if (bParam1 == Global_46850[1])
	{
		Function_224(&iParam0, bParam1, &Global_11946, &iParam2);
	}
	else if (bParam1 == Global_46850[2])
	{
		Function_224(&iParam0, bParam1, &Global_11988, &iParam2);
	}
	else if (bParam1 == Global_46866[0])
	{
		Function_224(&iParam0, bParam1, &Global_12048, &iParam2);
	}
	else if (bParam1 == Global_46866[1])
	{
		Function_224(&iParam0, bParam1, &Global_12150, &iParam2);
	}
	else if (bParam1 == Global_46866[2])
	{
		Function_224(&iParam0, bParam1, &Global_11398, &iParam2);
	}
	else if (bParam1 == Global_46894[2])
	{
		Function_224(&iParam0, bParam1, &Global_12284, &iParam2);
	}
	else if (bParam1 == Global_46894[1])
	{
		Function_224(&iParam0, bParam1, &Global_12342, &iParam2);
	}
	else if (bParam1 == Global_46894[0])
	{
		Function_224(&iParam0, bParam1, &Global_12422, &iParam2);
	}
	else if (bParam1 == Global_46894[3])
	{
		Function_224(&iParam0, bParam1, &Global_12392, &iParam2);
	}
	else if (bParam1 == Global_46926[0])
	{
		Function_224(&iParam0, bParam1, &Global_12760, &iParam2);
	}
	else if (bParam1 == Global_46926[1])
	{
		Function_224(&iParam0, bParam1, &Global_12714, &iParam2);
	}
	else if (bParam1 == Global_46926[2])
	{
		Function_224(&iParam0, bParam1, &Global_12644, &iParam2);
	}
	else if (bParam1 == Global_46914[0])
	{
		Function_224(&iParam0, bParam1, &Global_12488, &iParam2);
	}
	else if (bParam1 == Global_46914[1])
	{
		Function_224(&iParam0, bParam1, &Global_12482, &iParam2);
	}
	Function_197(&iParam0 + 608, 64);
	return;
}

void Function_224(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC6DA / 50906
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
	...
	if (!SQUAD_IS_VALID(&iParam0))
	{
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_233("localSurvSquad") };
		iParam0 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uParam3, &Var0));
	}
	uVar8 = Function_232(&uParam3, iParam1);
	...
	while (bVar22 < (iVar18 - 1))
	{
		if (bVar22 <= Param2)
		{
			if (!Function_231(&(Param2[bVar222]), 4))
			{
				*(&iParam0 + 8[bVar225] + 8) = GET_INDEXED_OBJECT_IN_OBJECTSET(bVar22, &uVar8);
				...
				if (bVar23)
				{
					...
					Var28 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_233("nSurvivor_") };
					*(&iParam0 + 8[bVar225]) = CREATE_ACTOR_IN_LAYOUT(&uParam3, &Var28, iVar9[bVar22], Var24, Var26);
					Function_226(bVar22, &iParam0, &uParam3, bVar21, iParam1);
...
void Function_225(var uParam0, int iParam1) //Position: 0xC8E6 / 51430
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_226(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC8F7 / 51447
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (DECOR_CHECK_EXIST(&uVar1, "Accuracy"))
	{
		...
		Function_228(&iVar0, TO_FLOAT(bVar11), 1.0f, 1.0f);
	}
	else
	{
		Function_228(&iVar0, 75.0f, 1.0f, 1.0f);
	}
	...
	else if (DECOR_CHECK_EXIST(&uVar1, "Gringo") || !bParam3)
	{
		...
		if (IS_GRINGO_VALID(&uVar22))
		{
			...
			{
				if (!IS_OBJECT_VALID(Function_227(&uVar22, "UseCase1")))
				{
	...
	Function_228(&iVar0, 20.0f, 1.0f, 1.0f);
...
var Function_227(var uParam0, int iParam1) //Position: 0xCFDE / 53214
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_228(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCFED / 53229
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD03E / 53310
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_230(var uParam0, bool bParam1) //Position: 0xD08D / 53389
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_231(var uParam0, int iParam1) //Position: 0xD0C1 / 53441
{
	int iVar0;
...
var Function_232(int iParam0, int iParam1) //Position: 0xD0DE / 53470
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_233(char* cParam0) //Position: 0xD194 / 53652
{
	char* cVar0[32];
	char* cVar8[16];
	...
	else
	{
		...
		{
			memcpy(&cVar8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_234("0", &cVar8, ""), 4);
		}
...
struct<32> Function_234(char* cParam0) //Position: 0xD200 / 53760
{
	char* cVar0[32];
...
void Function_235() //Position: 0xD222 / 53794
{
	return;
}

bool Function_236(int iParam0) //Position: 0xD228 / 53800
{
...
int Function_237(int iParam0) //Position: 0xD24B / 53835
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_238() //Position: 0xD267 / 53863
{
	return 1;
}

void Function_239(bool bParam0) //Position: 0xD26E / 53870
{
	Function_240(&uLocal_572, &cLocal_7, "church01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "church01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "church01", 5, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 5, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 9, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 10, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 11, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "prayerRoom01", 12, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "residence01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "residence01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "residence01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "residence01", 9, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 7, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 8, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "storageRoom01", 9, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 1, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 2, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 3, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 4, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 5, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	Function_240(&uLocal_572, &cLocal_7, "walls01", 6, &Global_44085[bParam09] + 32, !Function_35(24), 0, 0, 0);
	return;
}

var Function_240(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD6BA / 54970
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_241(struct<4>[] Param0) //Position: 0xD7BD / 55229
{
	int iVar0;
...
void Function_242() //Position: 0xD7EE / 55278
{
	Function_243(&uLocal_9, &uLocal_516, 4, &iLocal_278 + 160, 4294967295, 4);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 24, 4294967295, 65802);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 520, 4294967295, 4194570);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 72, 4294967295, 2097418);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 96, 4294967295, 65802);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 624, 4294967295, 65794);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 704, 4294967295, 266);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 296, 4294967295, 16648);
	Function_243(&uLocal_9, &uLocal_516, 5, &iLocal_278 + 584, 4294967295, 0x1000000);
	return;
}

void Function_243(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD8A9 / 55465
{
...
void Function_244(struct<5> Param0) //Position: 0xD996 / 55702
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_245(int iParam0, int iParam1) //Position: 0xD9A7 / 55719
{
	var uVar0;
	int iVar1;
...
void Function_246(int iParam0, int iParam1, bool bParam2) //Position: 0xDA1D / 55837
{
	var uVar0;
	int iVar1;
...
var Function_247() //Position: 0xDABB / 55995
{
	return &iLocal_178;
}

void Function_248(int iParam0) //Position: 0xDAC4 / 56004
{
	cLocal_7 = Function_249(&iLocal_178, "lashermanas", iParam0);
	return;
}

int Function_249(int iParam0, var uParam1, int iParam2) //Position: 0xDAE3 / 56035
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_250() //Position: 0xDB06 / 56070
{
	return Function_251();
}

int Function_251() //Position: 0xDB0F / 56079
{
	var uVar0;
	
	Function_252(3, 3);
	uVar0 = &uVar0;
	iLocal_278 = FIND_NAMED_LAYOUT("LasHermanas_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_278))
	{
		iLocal_278 = CREATE_LAYOUT("LasHermanas_layout");
	}
	*(&iLocal_278 + 24) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_dorm_set");
	*(&iLocal_278 + 8[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_dorm_01", 2,802597E-45f, Vector(-1680,477f, 12,88474f, 4212,336f), Vector(0.0f, 0.0f, 0.0f), Vector(14,11601f, 10,94981f, 32,42182f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 24, &iLocal_278 + 8[0]);
	*(&iLocal_278 + 64) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_church_bottom_set");
	*(&iLocal_278 + 32[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church_01", 2,802597E-45f, Vector(-1699,849f, 8,953889f, 4194,267f), Vector(0.0f, 0.0f, 0.0f), Vector(10,03829f, 6,800636f, 22,85925f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 64, &iLocal_278 + 32[0]);
	*(&iLocal_278 + 32[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church_02", 2,802597E-45f, Vector(-1701,763f, 8,839959f, 4189,003f), Vector(0.0f, 0.0f, 0.0f), Vector(10,30391f, 6,980586f, 14,0285f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 64, &iLocal_278 + 32[1]);
	*(&iLocal_278 + 32[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church_03", 2,802597E-45f, Vector(-1693,566f, 8,915912f, 4194,521f), Vector(0.0f, 0.0f, 0.0f), Vector(10,03829f, 6,800636f, 3,936624f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 64, &iLocal_278 + 32[2]);
	*(&iLocal_278 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_storage", 2,802597E-45f, Vector(-1727,559f, 11,40409f, 4186,101f), Vector(0.0f, 0.0f, 0.0f), Vector(16,94143f, 9,961804f, 7,295546f));
	*(&iLocal_278 + 96) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_office_set");
	*(&iLocal_278 + 80[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_office_01", 2,802597E-45f, Vector(-1724,063f, 12,22613f, 4215,942f), Vector(0.0f, 0.0f, 0.0f), Vector(25,09364f, 10,29202f, 15,37596f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 96, &iLocal_278 + 80[0]);
	*(&iLocal_278 + 152) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_wall_top_set");
	*(&iLocal_278 + 104[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Box58", 2,802597E-45f, Vector(-1679,588f, 13,63631f, 4240,783f), Vector(0.0f, 0.0f, 0.0f), Vector(5,028011f, 5,058086f, 26,02822f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 152, &iLocal_278 + 104[0]);
	*(&iLocal_278 + 104[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Box56", 2,802597E-45f, Vector(-1691,434f, 13,23021f, 4249,844f), Vector(0.0f, 0.0f, 0.0f), Vector(23,54208f, 4,018136f, 7,780226f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 152, &iLocal_278 + 104[1]);
	*(&iLocal_278 + 104[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Box59", 2,802597E-45f, Vector(-1719,598f, 13,77301f, 4238,642f), Vector(0.0f, 0.0f, 0.0f), Vector(6,269324f, 5,987976f, 30,70751f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 152, &iLocal_278 + 104[2]);
	*(&iLocal_278 + 104[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Box60", 2,802597E-45f, Vector(-1710,774f, 13,11671f, 4252,273f), Vector(0.0f, 0.0f, 0.0f), Vector(11,85519f, 4,15668f, 2,80413f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 152, &iLocal_278 + 104[3]);
	*(&iLocal_278 + 104[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Box61", 2,802597E-45f, Vector(-1740,266f, 13,23021f, 4198,792f), Vector(0.0f, 0.0f, 0.0f), Vector(9,643528f, 4,018136f, 27,7147f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 152, &iLocal_278 + 104[4]);
	*(&iLocal_278 + 160) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_region", 2,802597E-45f, Vector(-1703,746f, 31,57897f, 4232,615f), Vector(0.0f, 0.0f, 0.0f), Vector(107,4996f, 53,61927f, 128,9135f));
	*(&iLocal_278 + 288) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_birds_set");
	*(&iLocal_278 + 168[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder16", 4,203895E-45f, Vector(-1716.0f, 22,86559f, 4176.0f), Vector(0.0f, 20.0f, 0.0f), Vector(7,251727f, 15,35544f, 6,742037f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[0]);
	*(&iLocal_278 + 168[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "nCylinder5", 4,203895E-45f, Vector(-1696.0f, 17,51975f, 4239,035f), Vector(0.0f, 20.0f, 0.0f), Vector(4,258359f, 9,853659f, 4,707277f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[1]);
	*(&iLocal_278 + 168[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "nCylinder6", 4,203895E-45f, Vector(-1699,984f, 18,80392f, 4260,431f), Vector(0.0f, 5,547814f, 0.0f), Vector(5,089667f, 6,305782f, 3,394659f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[2]);
	*(&iLocal_278 + 168[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "nCylinder8", 4,203895E-45f, Vector(-1721,753f, 14,54672f, 4198,247f), Vector(0.0f, 20.0f, 0.0f), Vector(2,995238f, 6,622173f, 2,592857f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[3]);
	*(&iLocal_278 + 168[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "nCylinder9", 4,203895E-45f, Vector(-1690,292f, 16,41214f, 4220.0f), Vector(0.0f, 20.0f, 0.0f), Vector(5,340826f, 8,687995f, 6,06607f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[4]);
	*(&iLocal_278 + 168[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder10", 4,203895E-45f, Vector(-1708,653f, 27,73623f, 4229,026f), Vector(0.0f, 20.0f, 0.0f), Vector(5,105824f, 21,43283f, 5,934885f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[5]);
	*(&iLocal_278 + 168[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder11", 4,203895E-45f, Vector(-1682,211f, 18,39396f, 4259,572f), Vector(0.0f, 20.0f, 0.0f), Vector(2,995238f, 10,64231f, 2,592857f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[6]);
	*(&iLocal_278 + 168[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder12", 4,203895E-45f, Vector(-1670,941f, 15,07071f, 4235,801f), Vector(0.0f, 20.0f, 0.0f), Vector(2,995238f, 6,791216f, 2,592857f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[7]);
	*(&iLocal_278 + 168[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder13", 4,203895E-45f, Vector(-1680,295f, 26,46428f, 4189,357f), Vector(0.0f, 20.0f, 0.0f), Vector(8,094522f, 17,79937f, 4,113313f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[8]);
	*(&iLocal_278 + 168[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder14", 4,203895E-45f, Vector(-1714,098f, 21,36292f, 4258,068f), Vector(0.0f, 20.0f, 0.0f), Vector(2,995238f, 12,9917f, 5,21893f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[9]);
	*(&iLocal_278 + 168[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder15", 4,203895E-45f, Vector(-1746,252f, 21,53139f, 4176.0f), Vector(0.0f, 20.0f, 0.0f), Vector(4,985382f, 14,86888f, 5,76815f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[10]);
	*(&iLocal_278 + 168[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder17", 4,203895E-45f, Vector(-1663,856f, 16,00959f, 4286,607f), Vector(0.0f, 45,4551f, 0.0f), Vector(12,03572f, 12,06892f, 8,572443f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[11]);
	*(&iLocal_278 + 168[12]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder18", 4,203895E-45f, Vector(-1705,944f, 19,61593f, 4220,521f), Vector(0.0f, 0,7690971f, 0.0f), Vector(44,97596f, 16,6264f, 47,32175f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[12]);
	*(&iLocal_278 + 168[13]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "Cylinder24", 4,203895E-45f, Vector(-1743,951f, 15,40103f, 4199,313f), Vector(0.0f, 2,212199f, 0.0f), Vector(3,641118f, 8,21683f, 8,265753f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 288, &iLocal_278 + 168[13]);
	*(&iLocal_278 + 296) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_trainStn", 2,802597E-45f, Vector(-1663,711f, 8,663337f, 4287,102f), Vector(0.0f, -44,9127f, 0.0f), Vector(12,97896f, 12,32496f, 17,10686f));
	*(&iLocal_278 + 352) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_vulture_set");
	*(&iLocal_278 + 304[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_vulture01", 4,203895E-45f, Vector(-1681,732f, 18,21694f, 4180,131f), Vector(0.0f, 20.0f, 0.0f), Vector(5,274219f, 9,508277f, 3,683119f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 352, &iLocal_278 + 304[0]);
	*(&iLocal_278 + 304[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_vulture02", 4,203895E-45f, Vector(-1672,406f, 19,49429f, 4233,301f), Vector(0.0f, 20.0f, 0.0f), Vector(5,274219f, 11,59507f, 3,683119f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 352, &iLocal_278 + 304[1]);
	*(&iLocal_278 + 304[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_vulture03", 4,203895E-45f, Vector(-1749,259f, 20,08563f, 4197,967f), Vector(0.0f, 20.0f, 0.0f), Vector(5,274219f, 15,62297f, 3,683119f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 352, &iLocal_278 + 304[2]);
	*(&iLocal_278 + 304[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_vulture04", 4,203895E-45f, Vector(-1731,571f, 20,53805f, 4178,198f), Vector(0.0f, 20.0f, 0.0f), Vector(5,274219f, 13,54044f, 3,683119f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 352, &iLocal_278 + 304[3]);
	*(&iLocal_278 + 304[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_vulture05", 4,203895E-45f, Vector(-1725,832f, 20,72448f, 4255,945f), Vector(0.0f, 20.0f, 0.0f), Vector(5,274219f, 12,59817f, 3,683119f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 352, &iLocal_278 + 304[4]);
	*(&iLocal_278 + 432) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_rabbits_set");
	*(&iLocal_278 + 360[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_08", 4,203895E-45f, Vector(-1718,231f, 8,031359f, 4174,87f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[0]);
	*(&iLocal_278 + 360[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_01", 4,203895E-45f, Vector(-1727,993f, 8,031359f, 4245,781f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[1]);
	*(&iLocal_278 + 360[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_02", 4,203895E-45f, Vector(-1685,591f, 8,031359f, 4260.0f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[2]);
	*(&iLocal_278 + 360[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_03", 4,203895E-45f, Vector(-1694,572f, 8,031359f, 4177,146f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[3]);
	*(&iLocal_278 + 360[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_04", 4,203895E-45f, Vector(-1677,323f, 8,031359f, 4187,76f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[4]);
	*(&iLocal_278 + 360[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_05", 4,203895E-45f, Vector(-1749,005f, 8,031359f, 4210,055f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[5]);
	*(&iLocal_278 + 360[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_06", 4,203895E-45f, Vector(-1666,386f, 8,031359f, 4240,722f), Vector(0.0f, 20.0f, 0.0f), Vector(3,807782f, 1.0f, 3,202161f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[6]);
	*(&iLocal_278 + 360[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_rabbits_07", 4,203895E-45f, Vector(-1715,02f, 8,031359f, 4260.0f), Vector(0.0f, 20.0f, 0.0f), Vector(4,744264f, 1.0f, 4,338517f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 432, &iLocal_278 + 360[7]);
	*(&iLocal_278 + 456) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_courtyard_set");
	*(&iLocal_278 + 440[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_crtyard01", 2,802597E-45f, Vector(-1695,541f, 8,531469f, 4229,946f), Vector(0.0f, 0.0f, 0.0f), Vector(31,94847f, 26,11821f, 47,16391f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 456, &iLocal_278 + 440[0]);
	*(&iLocal_278 + 480) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_courtyard_west_set");
	*(&iLocal_278 + 464[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_crtyard02", 2,802597E-45f, Vector(-1726,614f, 8,531469f, 4198,509f), Vector(0.0f, 0.0f, 0.0f), Vector(29,19217f, 16,77434f, 19,56031f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 480, &iLocal_278 + 464[0]);
	*(&iLocal_278 + 520) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_church_set");
	*(&iLocal_278 + 488[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church01", 2,802597E-45f, Vector(-1699,547f, 8,031361f, 4207,622f), Vector(0.0f, 0.0f, 0.0f), Vector(18,16732f, 30,22345f, 6,723855f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 520, &iLocal_278 + 488[0]);
	*(&iLocal_278 + 488[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church02", 2,802597E-45f, Vector(-1701,647f, 8,031361f, 4200,307f), Vector(0.0f, 0.0f, 0.0f), Vector(22,40417f, 36,92038f, 9,264437f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 520, &iLocal_278 + 488[1]);
	*(&iLocal_278 + 488[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_church03", 2,802597E-45f, Vector(-1699,797f, 8,031361f, 4188,984f), Vector(0.0f, 0.0f, 0.0f), Vector(23,99464f, 34,35847f, 16,35218f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 520, &iLocal_278 + 488[2]);
	*(&iLocal_278 + 568) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_night_set");
	*(&iLocal_278 + 528[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_pplNight_04", 2,802597E-45f, Vector(-1709,409f, 12,07436f, 4189,641f), Vector(0.0f, 0.0f, 0.0f), Vector(5,949434f, 3,670935f, 13,21718f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 568, &iLocal_278 + 528[0]);
	*(&iLocal_278 + 528[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_pplNight_07", 2,802597E-45f, Vector(-1714,335f, 7,539286f, 4215,988f), Vector(0.0f, 0.0f, 0.0f), Vector(6,297369f, 4,048958f, 16,07903f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 568, &iLocal_278 + 528[1]);
	*(&iLocal_278 + 528[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_pplNight_08", 2,802597E-45f, Vector(-1699,736f, 8,753281f, 4208,526f), Vector(0.0f, 0.0f, 0.0f), Vector(34,29349f, 5,45341f, 4,479712f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 568, &iLocal_278 + 528[2]);
	*(&iLocal_278 + 528[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_pplNight_09", 2,802597E-45f, Vector(-1685,461f, 9,140862f, 4212,987f), Vector(0.0f, 0.0f, 0.0f), Vector(5,95134f, 3,670935f, 33,07381f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 568, &iLocal_278 + 528[3]);
	*(&iLocal_278 + 576) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_customers", 2,802597E-45f, Vector(-1716,91f, 12,54541f, 4220,833f), Vector(0.0f, 0.0f, 0.0f), Vector(7,943641f, 2,561483f, 3,338091f));
	*(&iLocal_278 + 584) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_corral", 4,203895E-45f, Vector(-1694,778f, 11,67337f, 4281,024f), Vector(0.0f, 20.0f, 0.0f), Vector(15.0f, 3.0f, 15.0f));
	*(&iLocal_278 + 592) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_HorseShoePit", 2,802597E-45f, Vector(-1715,773f, 8,6719f, 4259,296f), Vector(0.0f, 89,6482f, 0.0f), Vector(6,359126f, 7,856765f, 16,50986f));
	*(&iLocal_278 + 624) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_players_room_set");
	*(&iLocal_278 + 600[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_players_room_01", 2,802597E-45f, Vector(-1716,871f, 12,81204f, 4212,376f), Vector(0.0f, 0.0f, 0.0f), Vector(9,124324f, 3,007901f, 7,505444f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 624, &iLocal_278 + 600[0]);
	*(&iLocal_278 + 600[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_players_room_02", 2,802597E-45f, Vector(-1722,329f, 12,81204f, 4211,309f), Vector(0.0f, 0.0f, 0.0f), Vector(9,124324f, 3,007901f, 5,586895f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 624, &iLocal_278 + 600[1]);
	*(&iLocal_278 + 704) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_wall_set");
	*(&iLocal_278 + 632[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_01", 2,802597E-45f, Vector(-1720,718f, 12,07436f, 4238,375f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 32,07529f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[0]);
	*(&iLocal_278 + 632[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_02", 2,802597E-45f, Vector(-1678,464f, 12,07436f, 4238,83f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 32,07529f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[1]);
	*(&iLocal_278 + 632[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_03", 2,802597E-45f, Vector(-1700,272f, 12,07436f, 4251,892f), Vector(0.0f, 0.0f, 0.0f), Vector(45,26178f, 18,70035f, 5,400733f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[2]);
	*(&iLocal_278 + 632[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_04", 2,802597E-45f, Vector(-1700,159f, 12,07436f, 4255,413f), Vector(0.0f, 0.0f, 0.0f), Vector(10,87699f, 19,13146f, 12,483f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[3]);
	*(&iLocal_278 + 632[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_05", 2,802597E-45f, Vector(-1742,98f, 12,07436f, 4198,962f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 27,49704f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[4]);
	*(&iLocal_278 + 632[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_06", 2,802597E-45f, Vector(-1738,777f, 12,07436f, 4187,036f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 3,720941f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[5]);
	*(&iLocal_278 + 632[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_07", 2,802597E-45f, Vector(-1738,777f, 12,07436f, 4210,985f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 3,720941f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[6]);
	*(&iLocal_278 + 632[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "lshv_wall_08", 2,802597E-45f, Vector(-1709,266f, 12,07436f, 4189,81f), Vector(0.0f, 0.0f, 0.0f), Vector(4,666071f, 18,70035f, 13,33412f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 704, &iLocal_278 + 632[7]);
	*(&iLocal_278 + 752) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_278, "lshv_freshZombies_set");
	*(&iLocal_278 + 712[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "freshZombies4", 2,802597E-45f, Vector(-1764,807f, 12,28626f, 4070,833f), Vector(0.0f, 0.0f, 0.0f), Vector(278,5885f, 47,35487f, 129,0522f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 752, &iLocal_278 + 712[0]);
	*(&iLocal_278 + 712[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "freshZombies3", 2,802597E-45f, Vector(-1813,8f, 12,28626f, 4233,23f), Vector(0.0f, 0.0f, 0.0f), Vector(114,0945f, 47,35487f, 166,9074f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 752, &iLocal_278 + 712[1]);
	*(&iLocal_278 + 712[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "freshZombies2", 2,802597E-45f, Vector(-1577,959f, 12,28626f, 4231,854f), Vector(0.0f, 0.0f, 0.0f), Vector(129,2697f, 47,35487f, 371,6447f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 752, &iLocal_278 + 712[2]);
	*(&iLocal_278 + 712[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_278, "freshZombies1", 2,802597E-45f, Vector(-1774,083f, 12,28626f, 4391,74f), Vector(0.0f, 0.0f, 0.0f), Vector(244,4215f, 47,35487f, 154,694f));
	ADD_TO_VOLUME_SET(&iLocal_278 + 752, &iLocal_278 + 712[3]);
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_report_crime_road", Vector(-1677,152f, 8,03f, 4274,093f), Vector(0.0f, 128,301f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_clear_bounty", Vector(-1665,316f, 8,663f, 4288,242f), Vector(0.0f, 158,115f, 0.0f));
	*(&iLocal_278 + 760) = Vector(-1719,589f, 8,205862f, 4223,875f);
	*(&iLocal_278 + 760 + 12) = Vector(0.0f, -79,87354f, 0.0f);
	*(&iLocal_278 + 784) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorPoint_house1", Vector(-1719,589f, 8,205862f, 4223,875f), Vector(0.0f, -79,87354f, 0.0f));
	*(&iLocal_278 + 792) = Vector(-1678,9f, 8,333403f, 4225,87f);
	*(&iLocal_278 + 792 + 12) = Vector(0.0f, -277,14f, 0.0f);
	*(&iLocal_278 + 816) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorPoint_house", Vector(-1678,9f, 8,333403f, 4225,87f), Vector(0.0f, -277,14f, 0.0f));
	*(&iLocal_278 + 824) = Vector(-1699,81f, 8,455795f, 4202,104f);
	*(&iLocal_278 + 824 + 12) = Vector(0.0f, -178,5118f, 0.0f);
	*(&iLocal_278 + 848) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorPoint_church", Vector(-1699,81f, 8,455795f, 4202,104f), Vector(0.0f, -178,5118f, 0.0f));
	*(&iLocal_278 + 856) = Vector(-1728,916f, 7,958327f, 4186,138f);
	*(&iLocal_278 + 856 + 12) = Vector(0.0f, -178,5118f, 0.0f);
	*(&iLocal_278 + 880) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorPoint_warehouse", Vector(-1728,916f, 7,958327f, 4186,138f), Vector(0.0f, -178,5118f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos1", Vector(-1767,143f, 12,503f, 4156,063f), Vector(3,298f, -133,852f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos2", Vector(-1712,397f, 10,961f, 4289,741f), Vector(3,764f, -21,345f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos3", Vector(-1657,222f, 12,624f, 4311,153f), Vector(-5,875f, 21,961f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos4", Vector(-1591,833f, 17,012f, 4126,583f), Vector(-3,069f, 129,428f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos5", Vector(-1731,104f, 9,945f, 4135,587f), Vector(3,873f, -152,596f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos6", Vector(-1706,594f, 12,703f, 4250,618f), Vector(-5,622f, -20,141f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos7", Vector(-1755,687f, 15,962f, 4209,258f), Vector(-5,152f, -69,251f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos8", Vector(-1717,49f, 16,316f, 4229,982f), Vector(-7,17f, -43,388f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos9", Vector(-1677,802f, 19,561f, 4232,425f), Vector(-12,064f, 61,386f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lsh_vista_cam_pos10", Vector(-1709,614f, 15,468f, 4208,013f), Vector(-13,606f, 65,017f, 0.0f));
	*(&iLocal_278 + 888) = Vector(-1699,81f, 8,455795f, 4194,62f);
	*(&iLocal_278 + 888 + 12) = Vector(0.0f, 180,9226f, 0.0f);
	*(&iLocal_278 + 912) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorSettlement01", Vector(-1699,81f, 8,455795f, 4194,62f), Vector(0.0f, 180,9226f, 0.0f));
	*(&iLocal_278 + 920) = Vector(-1700.0f, 8,031364f, 4255,358f);
	*(&iLocal_278 + 920 + 12) = Vector(0.0f, -179,7341f, 0.0f);
	*(&iLocal_278 + 944) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_278, "lshf_interiorSettlement02", Vector(-1700.0f, 8,031364f, 4255,358f), Vector(0.0f, -179,7341f, 0.0f));
	return 1;
}

void Function_252(int iParam0, int iParam1) //Position: 0xF906 / 63750
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_253(var uParam0, int iParam1) //Position: 0xF950 / 63824
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_254() //Position: 0xF961 / 63841
{
	return;
}

bool Function_255() //Position: 0xF967 / 63847
{
	return 1;
}

void Function_256() //Position: 0xF96E / 63854
{
...
bool Function_257() //Position: 0xF981 / 63873
{
	return Function_258();
}

int Function_258() //Position: 0xF98A / 63882
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	Function_252(3, 3);
	uVar0 = &uVar0;
	Function_169(&iLocal_178 + 8, "$/content/scripting/gringo/simplegringo/dlc_survivor_low_wall_rfl", 1, 0);
	...
	iLocal_178 = FIND_NAMED_LAYOUT("LasHermanas_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("LasHermanas_layout");
	}
	*(&iLocal_178 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-1700,07f, 16,59118f, 4255,364f), Vector(0.0f, 0.0f, 0.0f), Vector(10,32708f, 7.0f, 12,23933f));
	*(&iLocal_178 + 120) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-1680,341f, 17,18155f, 4212,375f), Vector(0.0f, 0.0f, 0.0f), Vector(14,1947f, 7.0f, 33,97351f));
	*(&iLocal_178 + 128) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-1700,372f, 15,34718f, 4196,362f), Vector(0.0f, 0.0f, 0.0f), Vector(24,9791f, 21,91695f, 31,3446f));
	*(&iLocal_178 + 136) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_4", 2,802597E-45f, Vector(-1718,266f, 13,74883f, 4239,057f), Vector(0.0f, 0.0f, 0.0f), Vector(10,40198f, 7.0f, 30,79616f));
	*(&iLocal_178 + 144) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_5", 2,802597E-45f, Vector(-1728,703f, 10,86086f, 4199,52f), Vector(0.0f, 0.0f, 0.0f), Vector(6,176655f, 10.0f, 23,00268f));
	*(&iLocal_178 + 152) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_6", 2,802597E-45f, Vector(-1678,586f, 11,98757f, 4212,375f), Vector(0.0f, 0.0f, 0.0f), Vector(10,08233f, 10,40724f, 33,97351f));
	*(&iLocal_178 + 160) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-1716,722f, 13,74883f, 4239,057f), Vector(0.0f, 0.0f, 0.0f), Vector(13,99376f, 7.0f, 30,79616f));
	*(&iLocal_178 + 168) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_2", 2,802597E-45f, Vector(-1708,017f, 11,21691f, 4193,159f), Vector(0.0f, 0.0f, 0.0f), Vector(9,98219f, 7.0f, 23,66742f));
	*(&iLocal_178 + 176) = Vector(-1693,753f, 8,006304f, 4258,227f);
	*(&iLocal_178 + 176 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 200) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-1693,753f, 8,006304f, 4258,227f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 208) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02_nun", Vector(-1701,464f, 13,82635f, 4258,909f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 208);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03_nun", Vector(-1716,994f, 11,56003f, 4237,85f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 208);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04_nun", Vector(-1717,597f, 10,98935f, 4246,985f), Vector(0.0f, -45.0f, 0.0f));
	DECOR_SET_INT(&uVar3, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 208);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-1703,183f, 15,85931f, 4210,269f), Vector(0.0f, 191,6165f, 0.0f));
	DECOR_SET_INT(&uVar4, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 208);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-1691,324f, 12,12563f, 4202,921f), Vector(0.0f, 230,8869f, 0.0f));
	DECOR_SET_INT(&uVar5, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 208);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07", Vector(-1685,301f, 15,03937f, 4219,593f), Vector(0.0f, 110.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 208);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-1711,518f, 20,31091f, 4203,473f), Vector(0.0f, 143,8666f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 208);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-1698,405f, 13,79077f, 4250,978f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar8, "Core", 1);
	DECOR_SET_INT(&uVar8, "GiveWeapon", 42);
	DECOR_SET_INT(&uVar8, "Accuracy", 100);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 208);
	*(&iLocal_178 + 216) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-1699,805f, 13,79077f, 4251,551f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar9, "Core", 1);
	DECOR_SET_INT(&uVar9, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 216);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-1698,405f, 13,79077f, 4251,56f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar10, "Core", 1);
	DECOR_SET_INT(&uVar10, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 216);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-1700,063f, 13,826f, 4258,909f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 216);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-1701,464f, 13,82635f, 4258,909f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar12, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 216);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-1696,247f, 15,81119f, 4208,747f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 216);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-1696,246f, 15,81119f, 4210,147f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 216);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_player", Vector(-1703,183f, 15,85931f, 4208,87f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 216);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_04_surv", Vector(-1703,183f, 15,85931f, 4210,269f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 216);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_player", Vector(-1691,327f, 12,12563f, 4201,521f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar17, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 216);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_surv", Vector(-1691,324f, 12,12563f, 4202,921f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar18, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 216);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_player", Vector(-1718,394f, 11,56003f, 4237,85f), Vector(0.0f, -450.0f, 0.0f));
	DECOR_SET_INT(&uVar19, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 216);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_surv", Vector(-1716,994f, 11,56003f, 4237,85f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar20, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 216);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_07_player", Vector(-1685,301f, 15,03937f, 4218,225f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar21, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 216);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_07_surv", Vector(-1685,301f, 15,03937f, 4219,593f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar22, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 216);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_08_player", Vector(-1710,162f, 20,31091f, 4203,473f), Vector(0.0f, 450.0f, 0.0f));
	DECOR_SET_INT(&uVar23, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 216);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_08_surv", Vector(-1711,518f, 20,31091f, 4203,473f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar24, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar24, &iLocal_178 + 216);
	*(&iLocal_178 + 224) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar25 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def013_nun", Vector(-1716,994f, 11,56003f, 4237,85f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar25, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar25, &iLocal_178 + 224);
	uVar26 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def014_nun", Vector(-1701,464f, 13,82635f, 4258,909f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar26, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar26, &iLocal_178 + 224);
	uVar27 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09_nun", Vector(-1698,405f, 13,79077f, 4250,978f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar27, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar27, &iLocal_178 + 224);
	uVar28 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def010", Vector(-1730,877f, 11,50155f, 4200,032f), Vector(0.0f, 111,8821f, 0.0f));
	DECOR_SET_INT(&uVar28, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar28, &iLocal_178 + 224);
	uVar29 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def011", Vector(-1696,246f, 15,81119f, 4210,147f), Vector(0.0f, 191,6165f, 0.0f));
	DECOR_SET_INT(&uVar29, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar29, &iLocal_178 + 224);
	uVar30 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def012", Vector(-1703,183f, 15,85931f, 4210,269f), Vector(0.0f, 191,6165f, 0.0f));
	DECOR_SET_INT(&uVar30, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar30, &iLocal_178 + 224);
	uVar31 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def016", Vector(-1690,466f, 14,75733f, 4195,439f), Vector(0.0f, 190.0f, 0.0f));
	DECOR_SET_INT(&uVar31, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar31, &iLocal_178 + 224);
	uVar32 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def015_core", Vector(-1703,823f, 13,90195f, 4254,884f), Vector(0.0f, 75.0f, 0.0f));
	DECOR_SET_BOOL(&uVar32, "Core", 1);
	DECOR_SET_INT(&uVar32, "GiveWeapon", 42);
	DECOR_SET_INT(&uVar32, "Accuracy", 100);
	ADD_OBJECT_TO_OBJECTSET(&uVar32, &iLocal_178 + 224);
	*(&iLocal_178 + 232) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar33 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_09_player", Vector(-1726,542f, 11,38962f, 4196,873f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar33, "Core", 1);
	DECOR_SET_INT(&uVar33, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar33, &iLocal_178 + 232);
	uVar34 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_09_surv", Vector(-1726,542f, 11,38962f, 4195,473f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar34, "Core", 1);
	DECOR_SET_INT(&uVar34, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar34, &iLocal_178 + 232);
	uVar35 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_10_player", Vector(-1730,877f, 11,50155f, 4201,432f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar35, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar35, &iLocal_178 + 232);
	uVar36 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_10_surv", Vector(-1730,877f, 11,50155f, 4200,032f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar36, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar36, &iLocal_178 + 232);
	uVar37 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_15_player", Vector(-1703,823f, 13,90195f, 4256,284f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar37, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar37, &iLocal_178 + 232);
	uVar38 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_15_surv", Vector(-1703,823f, 13,90195f, 4254,884f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar38, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar38, &iLocal_178 + 232);
	uVar39 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_16_player", Vector(-1691,866f, 14,74844f, 4195,441f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar39, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar39, &iLocal_178 + 232);
	uVar40 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_16_surv", Vector(-1690,466f, 14,75733f, 4195,439f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar40, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar40, &iLocal_178 + 232);
	*(&iLocal_178 + 240) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_defSet", &iLocal_178, 8, 0);
	uVar41 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def020_nun", Vector(-1701,464f, 13,82635f, 4258,909f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar41, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar41, &iLocal_178 + 240);
	uVar42 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def022_nun", Vector(-1698,405f, 13,79077f, 4250,978f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar42, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar42, &iLocal_178 + 240);
	uVar43 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def018_nun", Vector(-1716,994f, 11,56003f, 4237,85f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_INT(&uVar43, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar43, &iLocal_178 + 240);
	uVar44 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def019", Vector(-1696,246f, 15,81119f, 4210,147f), Vector(0.0f, 191,6165f, 0.0f));
	DECOR_SET_INT(&uVar44, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar44, &iLocal_178 + 240);
	uVar45 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def021", Vector(-1690,466f, 14,75733f, 4195,439f), Vector(0.0f, 190.0f, 0.0f));
	DECOR_SET_INT(&uVar45, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar45, &iLocal_178 + 240);
	uVar46 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def023", Vector(-1711,482f, 20,32163f, 4200,189f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar46, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar46, &iLocal_178 + 240);
	uVar47 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def024", Vector(-1705,764f, 12,71009f, 4190,621f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_INT(&uVar47, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar47, &iLocal_178 + 240);
	uVar48 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def017_core", Vector(-1717,597f, 10,98935f, 4246,985f), Vector(0.0f, -45.0f, 0.0f));
	DECOR_SET_BOOL(&uVar48, "Core", 1);
	DECOR_SET_INT(&uVar48, "GiveWeapon", 42);
	DECOR_SET_INT(&uVar48, "Accuracy", 100);
	ADD_OBJECT_TO_OBJECTSET(&uVar48, &iLocal_178 + 240);
	*(&iLocal_178 + 248) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar49 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_17_player", Vector(-1718,704f, 10,98935f, 4247,387f), Vector(0.0f, -90.0f, 0.0f));
	DECOR_SET_BOOL(&uVar49, "Core", 1);
	DECOR_SET_INT(&uVar49, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar49, &iLocal_178 + 248);
	uVar50 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_17_surv", Vector(-1717,304f, 10,98935f, 4247,386f), Vector(0.0f, -270.0f, 0.0f));
	DECOR_SET_BOOL(&uVar50, "Core", 1);
	DECOR_SET_INT(&uVar50, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar50, &iLocal_178 + 248);
	uVar51 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_23_player", Vector(-1711,482f, 20,32163f, 4198,789f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar51, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar51, &iLocal_178 + 248);
	uVar52 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_23_surv", Vector(-1711,482f, 20,32163f, 4200,189f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar52, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar52, &iLocal_178 + 248);
	uVar53 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_24_player", Vector(-1705,764f, 12,71009f, 4189,221f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar53, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar53, &iLocal_178 + 248);
	uVar54 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_24_surv", Vector(-1705,764f, 12,71009f, 4190,621f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar54, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar54, &iLocal_178 + 248);
	*(&iLocal_178 + 256) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup03_difXXXSet", &iLocal_178, 8, 0);
	uVar55 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def028_nun", Vector(-1698,405f, 13,79077f, 4250,978f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar55, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar55, &iLocal_178 + 256);
	uVar56 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def032_nun", Vector(-1703,823f, 13,90195f, 4254,884f), Vector(0.0f, 75.0f, 0.0f));
	DECOR_SET_INT(&uVar56, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar56, &iLocal_178 + 256);
	uVar57 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def026_nun", Vector(-1730,808f, 11,50155f, 4193,619f), Vector(0.0f, 111,8821f, 0.0f));
	DECOR_SET_INT(&uVar57, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar57, &iLocal_178 + 256);
	uVar58 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def027", Vector(-1696,246f, 15,81119f, 4210,147f), Vector(0.0f, 191,6165f, 0.0f));
	DECOR_SET_INT(&uVar58, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar58, &iLocal_178 + 256);
	uVar59 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def029", Vector(-1690,466f, 14,75733f, 4195,439f), Vector(0.0f, 190.0f, 0.0f));
	DECOR_SET_INT(&uVar59, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar59, &iLocal_178 + 256);
	uVar60 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def030", Vector(-1685,301f, 15,07247f, 4214,214f), Vector(0.0f, -260,9173f, 0.0f));
	DECOR_SET_INT(&uVar60, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar60, &iLocal_178 + 256);
	uVar61 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def031", Vector(-1703,219f, 17,79244f, 4186,565f), Vector(0.0f, 76,18607f, 0.0f));
	DECOR_SET_INT(&uVar61, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar61, &iLocal_178 + 256);
	uVar62 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def025_core", Vector(-1719,047f, 11,02783f, 4230,962f), Vector(0.0f, -85,76277f, 0.0f));
	DECOR_SET_BOOL(&uVar62, "Core", 1);
	DECOR_SET_INT(&uVar62, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar62, &iLocal_178 + 256);
	*(&iLocal_178 + 264) = CREATE_OBJECTSET_IN_LAYOUT("ammo_03Set", &iLocal_178, 8, 0);
	uVar63 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_25_player", Vector(-1719,047f, 11,02783f, 4232,362f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar63, "Core", 1);
	DECOR_SET_INT(&uVar63, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar63, &iLocal_178 + 264);
	uVar64 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_25_surv", Vector(-1719,047f, 11,02783f, 4230,962f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar64, "Core", 1);
	DECOR_SET_INT(&uVar64, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar64, &iLocal_178 + 264);
	uVar65 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_26_player", Vector(-1730,808f, 11,50155f, 4195,019f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar65, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar65, &iLocal_178 + 264);
	uVar66 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_26_surv", Vector(-1730,808f, 11,50155f, 4193,619f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar66, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar66, &iLocal_178 + 264);
	uVar67 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_30_player", Vector(-1685,301f, 15,07247f, 4212,814f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_INT(&uVar67, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar67, &iLocal_178 + 264);
	uVar68 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_30_surv", Vector(-1685,301f, 15,07247f, 4214,214f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar68, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar68, &iLocal_178 + 264);
	uVar69 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_31_player", Vector(-1703,219f, 17,79244f, 4187,965f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_INT(&uVar69, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar69, &iLocal_178 + 264);
	uVar70 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_31_surv", Vector(-1703,219f, 17,79244f, 4186,565f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar70, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar70, &iLocal_178 + 264);
	*(&iLocal_178 + 272) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar71 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-1721,523f, 11,51309f, 4237,925f), Vector(0.0f, 270.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar71, &iLocal_178 + 272);
	uVar72 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-1721,162f, 11,51309f, 4239,399f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar72, &iLocal_178 + 272);
	uVar73 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-1694,384f, 11,25023f, 4250,617f), Vector(0.0f, -90.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar73, &iLocal_178 + 272);
	uVar74 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe04", Vector(-1697,505f, 8,099007f, 4236,836f), Vector(0.0f, 30,98839f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar74, &iLocal_178 + 272);
	uVar75 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe05", Vector(-1698,371f, 8,099007f, 4234,702f), Vector(0.0f, 185,0735f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar75, &iLocal_178 + 272);
	uVar76 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe06", Vector(-1703,081f, 15,83401f, 4209,834f), Vector(0.0f, 182,9972f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar76, &iLocal_178 + 272);
	uVar77 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe07", Vector(-1691,553f, 8,106472f, 4211,153f), Vector(0.0f, 180.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar77, &iLocal_178 + 272);
	uVar78 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe08", Vector(-1693,085f, 8,055316f, 4212,467f), Vector(0.0f, -55,49017f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar78, &iLocal_178 + 272);
	*(&iLocal_178 + 280) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar79 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-1702,252f, 8,687581f, 4183,458f), Vector(0.0f, -90.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar79, &iLocal_178 + 280);
	uVar80 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-1713,201f, 11,28086f, 4222,186f), Vector(0.0f, 45.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar80, &iLocal_178 + 280);
	uVar81 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_4", Vector(-1739,018f, 7,300357f, 4189,153f), Vector(0.0f, 180.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar81, &iLocal_178 + 280);
	uVar82 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_5", Vector(-1710,666f, 8,031472f, 4252,989f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar82, &iLocal_178 + 280);
	uVar83 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_6", Vector(-1691,54f, 8,106472f, 4199,567f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar83, &iLocal_178 + 280);
	*(&iLocal_178 + 288) = Vector(-1717,263f, 11,29226f, 4210,837f);
	*(&iLocal_178 + 288 + 12) = Vector(0.0f, 90.0f, 0.0f);
	*(&iLocal_178 + 312) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-1717,263f, 11,29226f, 4210,837f), Vector(0.0f, 90.0f, 0.0f));
	*(&iLocal_178 + 320) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl", "DLC_survivor_low_wall_rfl", Vector(-1694,335f, 11,27388f, 4250,617f), Vector(0.0f, 90.0f, 0.0f));
	*(&iLocal_178 + 328) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl", "DLC_survivor_stand_rfl", Vector(-1697,502f, 8,106741f, 4236,836f), Vector(0.0f, 31,18229f, 0.0f));
	*(&iLocal_178 + 336) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand2", "rand_idle_stand", Vector(-1698,381f, 8,108055f, 4234,698f), Vector(0.0f, -173,6874f, 0.0f));
	*(&iLocal_178 + 344) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl1", "DLC_survivor_roof_rfl", Vector(-1703,029f, 15,91278f, 4209,79f), Vector(0.0f, -179,1651f, 0.0f));
	*(&iLocal_178 + 352) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl1", "DLC_survivor_low_wall_rfl", Vector(-1691,553f, 8,106472f, 4211,203f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 360) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl2", "DLC_survivor_low_wall_rfl", Vector(-1721,547f, 11,5195f, 4237,926f), Vector(0.0f, 90.0f, 0.0f));
	*(&iLocal_178 + 368) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_kneel_rfl2", "DLC_survivor_kneel_rfl", Vector(-1721,165f, 11,51649f, 4239,527f), Vector(0.0f, -360,3278f, 0.0f));
	*(&iLocal_178 + 376) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl1", "DLC_survivor_stand_rfl", Vector(-1693,09f, 8,090067f, 4212,462f), Vector(0.0f, -41,72302f, 0.0f));
	*(&iLocal_178 + 384) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_L", "ZombiePack_player_sleep_bed_L", Vector(-1717,093f, 11,28451f, 4214,554f), Vector(0.0f, -90.0f, 0.0f));
	PushArrayP();
	*(&iLocal_178 + 392) = CREATE_PATH_IN_LAYOUT_FROM_TABLE(StackVal, &iLocal_178, "lshp_patrolpath");
	return 1;
}

void Function_259(bool bParam0, bool bParam1) //Position: 0x11F73 / 73587
{
	var uVar0;
...
void Function_260(int iParam0, bool bParam1, bool bParam2) //Position: 0x1200E / 73742
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_261(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0x1211A / 74010
{
	int iVar0;
...
bool Function_262(int iParam0) //Position: 0x121F6 / 74230
{
...
int Function_263(int iParam0) //Position: 0x12271 / 74353
{
...
bool Function_264(int iParam0) //Position: 0x12286 / 74374
{
...
int Function_265(int iParam0) //Position: 0x122EC / 74476
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_266(int iParam0, int iParam1) //Position: 0x123AE / 74670
{
	int iVar0;
...
void Function_267() //Position: 0x123CB / 74699
{
	return;
}

void Function_268(char* cParam0) //Position: 0x123D1 / 74705
{
	if (!Function_26(128))
	{
		return;
