...
void main() //Position: 0x0 / 0
{
	...
	uVar6 = FIND_NAMED_LAYOUT("OddFellowsRest_layout");
	if (IS_LAYOUTREF_VALID(&uVar6))
	{
		uVar7 = FIND_VOLUME_IN_LAYOUT(&uVar6, "oddv_region");
		if (IS_VOLUME_VALID(&uVar7))
		{
			Function_4(&uVar7, &uVar1, 2, 5, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xD10 / 3344
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xD21 / 3361
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD79 / 3449
{
	var uVar0;
...
var Function_4(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0xE09 / 3593
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0xE9B / 3739
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0xEB7 / 3767
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xEF7 / 3831
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xF14 / 3860
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xF25 / 3877
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xFA3 / 4003
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x100F / 4111
{
	bool bVar0;
...
var Function_12(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x107B / 4219
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0x10C2 / 4290
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_14(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x10CF / 4303
{
	int iVar0;
	int iVar1;
...
var Function_15(var uParam0, int iParam1) //Position: 0x1151 / 4433
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_16(char* cParam0) //Position: 0x1160 / 4448
{
	if (!Function_5(128))
	{
		return;
