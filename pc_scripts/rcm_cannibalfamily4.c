...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			Function_131(&uLocal_326, "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", 1, 0);
			Function_131(&uLocal_326, "RandomCharMissions", 10, 0);
			Function_131(&uLocal_326, "$/fragments/p_gen_hat02x", 0, 0);
			Function_131(&uLocal_326, "$/fragments/p_gen_bodyPartArm01x", 0, 0);
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					case 0x00000000:
						if (!Function_128(&(Global_99725[ScriptParam_043]), 18, 0, 1))
						{
							Function_127(&Global_99725[ScriptParam_043] + 228, 64);
							Function_125(&(Global_99725[ScriptParam_043]), 18, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_120(&uLocal_326) && IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (IS_LAYOUTREF_VALID(&uLocal_344))
							{
								uLocal_346 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_344, "SearchClues1", "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", *(&Global_99725[ScriptParam_043] + 184), Vector(0.0f, 0.0f, 0.0f));
								CREATE_DECAL(StackVal, 2,802597E-45f, Vector(-1687,427f, 53,208f, 2140,068f), 1.0f, 1, 1);
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_344, "RCM_Cannibal2_Hat")))
								{
									CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_344, "RCM_Cannibal2_Hat", "$/fragments/p_gen_hat02x", Vector(-1686,165f, 53,208f, 2140,195f), Vector(0.0f, 50.0f, 0.0f), 1);
								}
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_344, "RCM_Cannibal4_Arm")))
								{
									CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_344, "RCM_Cannibal4_Arm", "$/fragments/p_gen_bodyPartArm01x", Vector(-1688,349f, 53,208f, 2139,711f), Vector(0.0f, 113.0f, 0.0f), 1);
								}
							...
							{
								Function_118();
								uLocal_344 = &iLocal_351;
							}
							else
							{
								uLocal_344 = FIND_NAMED_LAYOUT("CannibalFamily_layout");
							}
						}
						break;
					
					case 0x00000005:
						if (GET_CURRENT_GRINGO(&Global_54076) == GET_GRINGO_FROM_OBJECT(&uLocal_346))
						{
							uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_344, Function_117(), 2, *(&Global_99725[1843] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
							Function_112(StackVal, Vector(-1675,043f, 55,781f, 2134,299f), &uVar1);
					...
					case 0x00000006:
						if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(&Global_54076)))
						{
							...
							Function_109("RCM_Cannibal_Not_Complete", 0x41200000, 1, 0, 2, 1, 0);
							iLocal_349 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
							iLocal_350 = 0;
							while (iLocal_350 <= iLocal_349)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iLocal_350), 4, 0);
								iLocal_350++;
							}
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Cannibal4_OBJ", 0, 4, false);
							Function_108(Global_99725[ScriptParam_043].f_224, 0);
							Function_62(18, 1, 1, 1);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x552 / 1362
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x584 / 1412
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x5A1 / 1441
{
	RELEASE_LAYOUT_REF(&iLocal_351);
	return;
}

void Function_4(int iParam0) //Position: 0x5AE / 1454
{
	int iVar0;
...
void Function_5(struct<2>[] Param0, int iParam1) //Position: 0x5D6 / 1494
{
...
void Function_6(struct<13> Param0) //Position: 0x721 / 1825
{
	int iVar0;
...
bool Function_7(struct<13> Param0) //Position: 0x73E / 1854
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x75C / 1884
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_9() //Position: 0x76D / 1901
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x79E / 1950
{
	int iVar0;
...
void Function_11() //Position: 0x7D8 / 2008
{
...
void Function_12(int iParam0) //Position: 0x7FD / 2045
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_51(Global_99725[iVar143].f_228, 2048))
				{
					...
					if (Function_28(&(Global_99725[iVar143]), iVar3))
					{
						...
						Function_24(&(Global_99725[iVar143]), iVar3);
...
void Function_13(struct<229> Param0) //Position: 0x9B7 / 2487
{
	float fVar0;
	int iVar1;
...
void Function_14(struct<217> Param0) //Position: 0xA87 / 2695
{
	float fVar0;
	var uVar1;
...
int Function_15(var uParam0, int iParam1) //Position: 0xB45 / 2885
{
	int iVar0;
	var uVar1;
...
void Function_16(int iParam0, var uParam1, struct<2> Param2) //Position: 0xCAF / 3247
{
	struct<8> Var0;
...
struct<32> Function_17(char* cParam0) //Position: 0xD57 / 3415
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_18(char* cParam0) //Position: 0xDC3 / 3523
{
	char* cVar0[32];
...
int Function_19(int iParam0) //Position: 0xDE5 / 3557
{
	int iVar0;
	struct<2> Var1;
...
float Function_20(var uParam0, struct<2> Param1) //Position: 0xF53 / 3923
{
	struct<2> Var0;
...
struct<8> Function_21(int iParam0) //Position: 0xFCA / 4042
{
	struct<2> Var0;
...
void Function_22(int iParam0) //Position: 0x1036 / 4150
{
...
bool Function_23(int iParam0) //Position: 0x109E / 4254
{
...
void Function_24(struct<153> Param0) //Position: 0x10B4 / 4276
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if (((StackVal && Function_26(Function_27(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_25(iParam1)) || Global_116927[iParam16].f_20 != 1)
	{
...
var Function_26(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x124F / 4687
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_27(int iParam0) //Position: 0x1270 / 4720
{
...
bool Function_28(struct<249> Param0) //Position: 0x1285 / 4741
{
...
bool Function_29(struct<265> Param0) //Position: 0x13B5 / 5045
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x1516 / 5398
{
...
bool Function_31(int iParam0) //Position: 0x153A / 5434
{
...
bool Function_32(int iParam0) //Position: 0x154F / 5455
{
...
var Function_33(int iParam0) //Position: 0x1566 / 5478
{
...
bool Function_34(int iParam0) //Position: 0x1580 / 5504
{
...
bool Function_35(int iParam0) //Position: 0x1596 / 5526
{
	return Global_116927[iParam06].f_16;
}

bool Function_36(var uParam0, int iParam1) //Position: 0x15A6 / 5542
{
	int iVar0;
...
bool Function_37(struct<237> Param0) //Position: 0x15C3 / 5571
{
	if (!Param0.f_236)
	{
		if (Function_38())
...
bool Function_38() //Position: 0x1692 / 5778
{
...
bool Function_39(int iParam0) //Position: 0x16AD / 5805
{
...
void Function_40(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1708 / 5896
{
	bool bVar0;
	char* cVar1[16];
...
void Function_41(char* cParam0) //Position: 0x177D / 6013
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_42(int iParam0, var uParam1, int iParam2) //Position: 0x17B7 / 6071
{
	var uVar0;
	char* cVar1[16];
...
int Function_43(char* cParam0) //Position: 0x1833 / 6195
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_44(int iParam0) //Position: 0x18D4 / 6356
{
	int iVar0;
	int iVar1;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x1911 / 6417
{
...
bool Function_46(int iParam0) //Position: 0x1924 / 6436
{
	int iVar0;
...
bool Function_47(var uParam0, int iParam1) //Position: 0x1940 / 6464
{
	int iVar0;
...
int Function_48(int iParam0) //Position: 0x195D / 6493
{
...
bool Function_49(int iParam0) //Position: 0x1972 / 6514
{
...
int Function_50(int iParam0) //Position: 0x1987 / 6535
{
...
bool Function_51(var uParam0, bool bParam1) //Position: 0x199C / 6556
{
	return (uParam0 && bParam1) == 0;
}

void Function_52() //Position: 0x19A9 / 6569
{
...
int Function_53(int iParam0, int iParam1) //Position: 0x1A29 / 6697
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_54(char* cParam0) //Position: 0x268C / 9868
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

bool Function_55(int iParam0, bool bParam1) //Position: 0x26A4 / 9892
{
	int iVar0;
...
int Function_56(int iParam0) //Position: 0x26E2 / 9954
{
	int iVar0;
	int iVar1;
...
bool Function_57(int iParam0) //Position: 0x2731 / 10033
{
...
int Function_58(int iParam0) //Position: 0x2747 / 10055
{
...
bool Function_59(int iParam0) //Position: 0x27B0 / 10160
{
	if (!Function_57(iParam0))
	{
...
bool Function_60(int iParam0, int iParam1) //Position: 0x2801 / 10241
{
	int iVar0;
...
bool Function_61(int iParam0) //Position: 0x282E / 10286
{
	if (!Function_57(iParam0))
	{
...
void Function_62(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2880 / 10368
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	Function_127(&Global_99725[iParam043] + 228, 64);
...
void Function_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E18 / 11800
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_64() //Position: 0x2FB9 / 12217
{
	return;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2FBF / 12223
{
	if (Global_6624)
	{
		return;
...
void Function_66(bool bParam0) //Position: 0x2FFE / 12286
{
...
void Function_67() //Position: 0x3053 / 12371
{
	Function_94();
	Function_93();
	Function_93();
...
void Function_68() //Position: 0x309E / 12446
{
...
void Function_69() //Position: 0x31A4 / 12708
{
	float fVar0;
...
void Function_70() //Position: 0x31D7 / 12759
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x336A / 13162
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x3523 / 13603
{
	Function_73(&Global_42918, 1, 0);
	return;
}

void Function_73(struct<2317> Param0) //Position: 0x3531 / 13617
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_74() //Position: 0x374E / 14158
{
...
struct<8> Function_75(int iParam0) //Position: 0x3763 / 14179
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_76(int iParam0, bool bParam1, bool bParam2) //Position: 0x380A / 14346
{
	int iVar0;
...
void Function_77(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3AA6 / 15014
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_78(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_117(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_78(int iParam0) //Position: 0x40E5 / 16613
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_79(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x40F6 / 16630
{
	char* cVar0[32];
...
struct<32> Function_80(char* cParam0) //Position: 0x41ED / 16877
{
	char* cVar0[32];
...
void Function_81(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x4208 / 16904
{
	float fVar0;
...
var Function_82(int iParam0, int iParam1) //Position: 0x426F / 17007
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_83(int iParam0, bool bParam1) //Position: 0x4281 / 17025
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_84(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4293 / 17043
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_85(int iParam0) //Position: 0x43C7 / 17351
{
	return Global_55480[iParam016].f_96;
}

float Function_86(int iParam0) //Position: 0x43D6 / 17366
{
	if (!iParam0 != 4294967295)
	{
...
var Function_87(int iParam0) //Position: 0x440F / 17423
{
	if (iParam0 == 4294967295)
	{
...
void Function_88(int iParam0) //Position: 0x444C / 17484
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x45E6 / 17894
{
	int iVar0;
	int iVar1;
...
int Function_90(bool bParam0) //Position: 0x482A / 18474
{
...
struct<8> Function_91() //Position: 0x486B / 18539
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_92() //Position: 0x48F4 / 18676
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x498B / 18827
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_94() //Position: 0x4A0A / 18954
{
...
int Function_95(int iParam0, bool bParam1, int iParam2) //Position: 0x4A47 / 19015
{
	int iVar0;
	int iVar1;
...
void Function_96() //Position: 0x4C53 / 19539
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_97(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4D0A / 19722
{
	int iVar0;
...
struct<8> Function_98() //Position: 0x4E02 / 19970
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_99(int iParam0) //Position: 0x4E0C / 19980
{
...
int Function_100(bool bParam0, bool bParam1) //Position: 0x4E22 / 20002
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_101(struct<2> Param0, struct<2> Param2) //Position: 0x4EEE / 20206
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_102(float fParam0, int iParam1) //Position: 0x4F0B / 20235
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_103(int iParam0) //Position: 0x5737 / 22327
{
	var uVar0;
...
void Function_104(var uParam0, int iParam1) //Position: 0x5772 / 22386
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_105(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5781 / 22401
{
	uParam0 = &uParam0;
...
void Function_106() //Position: 0x5830 / 22576
{
	bool bVar0;
...
void Function_107(int iParam0) //Position: 0x588E / 22670
{
	PRINTSTRING("Day ");
...
void Function_108(char* cParam0, bool bParam1) //Position: 0x58D8 / 22744
{
	bool bVar0;
...
void Function_109(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x58FD / 22781
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_110(int iParam0) //Position: 0x5988 / 22920
{
	char* cVar0[16];
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x59C7 / 22983
{
	struct<4> Var0;
	var uVar4;
...
void Function_112(vector3 vParam0) //Position: 0x5A5C / 23132
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_54(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_113(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_113(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_113(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_113(int iParam0, int iParam1) //Position: 0x5C05 / 23557
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_114(float fParam0, float fParam1) //Position: 0x5CFA / 23802
{
...
void Function_115() //Position: 0x5E0B / 24075
{
...
void Function_116() //Position: 0x5E3F / 24127
{
...
var Function_117() //Position: 0x5F45 / 24389
{
	var uVar0;
...
void Function_118() //Position: 0x5F4E / 24398
{
	var uVar0;
	
	Function_119(4, 1);
	uVar0 = &uVar0;
	iLocal_351 = CREATE_LAYOUT("CannibalFamily_layout");
	return;
}

void Function_119(int iParam0, int iParam1) //Position: 0x5F7E / 24446
{
	switch (&iParam1)
	{
		case 0x00000000:
...
int Function_120(struct<2>[] Param0) //Position: 0x5FC8 / 24520
{
	int iVar0;
	int iVar1;
...
void Function_121() //Position: 0x638A / 25482
{
	if (!Function_46(128))
	{
		return;
...
bool Function_122() //Position: 0x63CA / 25546
{
	int iVar0;
...
void Function_123(struct<13> Param0) //Position: 0x63F8 / 25592
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_124() //Position: 0x640B / 25611
{
	if (!Function_46(128))
	{
		return;
...
void Function_125(struct<229> Param0) //Position: 0x644D / 25677
{
	if (IS_BLIP_VALID(&Param0 + 272))
	{
		if (((!&bParam2 || Function_49(iParam1)) || Function_48(iParam1)) || iParam1 != &Param0 + 36)
		{
	...
	{
		if (Function_51(Global_99725[iParam143].f_228, 64) && iParam1 == &Param0 + 36)
		{
	...
	{
		if (!Function_51(Param0.f_228, 32))
		{
...
void Function_126(struct<229> Param0) //Position: 0x6650 / 26192
{
	if (Function_51(Param0.f_228, 1))
	{
		STREAMING_EVICT_ACTOR(Param0.f_220, 4294967295);
		Function_127(&Param0 + 228, 1);
	}
	if (Function_51(Param0.f_228, 8))
	{
		REMOVE_STRING_TABLE("RandomCharMissions");
		Function_127(&Param0 + 228, 8);
	}
	if (Function_51(Param0.f_228, 2))
	{
		STREAMING_EVICT_GRINGO(&Param0 + 120);
		Function_127(&Param0 + 228, 2);
	}
	if (Function_51(Param0.f_228, 4))
	{
		STREAMING_EVICT_PROP(&Param0 + 128);
		Function_127(&Param0 + 228, 4);
	}
	return;
}

void Function_127(int iParam0, int iParam1) //Position: 0x66DF / 26335
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_128(struct<265> Param0) //Position: 0x66F5 / 26357
{
	if (!Param0.f_260 != 0)
	{
		if (Function_36(&Param0 + 260, 4))
		...
		if (Function_36(&Param0 + 260, 8) && Global_6606)
		{
			if (!Function_130(Param0.f_252, 0))
			{
				return 0;
			}
		}
		...
		return Function_129(&Param0);
	}
	return 1;
}

int Function_129(struct<261> Param0) //Position: 0x67C1 / 26561
{
	if (!Param0.f_260 != 0)
	{
		switch (Global_99472)
...
bool Function_130(int iParam0, bool bParam1) //Position: 0x687C / 26748
{
...
var Function_131(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x68B3 / 26803
{
	int iVar0;
	var uVar1;
...
var Function_132(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x68F1 / 26865
{
	int iVar0;
