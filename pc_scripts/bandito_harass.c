...
void main() //Position: 0x0 / 0
{
	...
	iLocal_113 = 0;
	Function_99(&uScriptParam_0, &iLocal_113);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_114);
		}
		iVar2 = 0;
		bLocal_121 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			{
				if (&vLocal_3[iVar09] + 16 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_113;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_3[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_3[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						if (&vLocal_3[iVar39] + 24 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_3[iVar39] + 24);
							Function_84(&vLocal_3[iVar39] + 24, 1);
							if (IS_ACTOR_VALID(&vLocal_3[iVar39] + 24))
							{
								if (IS_ACTOR_LOCAL_PLAYER(&vLocal_3[iVar39] + 24) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(&vLocal_3[iVar39] + 16))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(&vLocal_3[iVar39] + 24, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_77(&(vLocal_3[iVar39]), 0);
							}
							else if (vLocal_3[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_3[iVar39]));
								vLocal_3[iVar39].f_68 = 8;
							}
							iVar5 = 1;
						}
						else
		...
		else
		{
			...
			while (iVar0 < (iLocal_113 - 1))
			{
				if (Function_75(vLocal_3[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_3[iVar09])))
					{
						Function_102("Quitting due to update end");
						Function_77(&(vLocal_3[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_3[iVar09]), 0))
				{
					Function_5(&(vLocal_3[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_122))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_122);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_113 - 1))
	{
		if (Function_75(vLocal_3[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_3[iVar09] + 24);
			Function_77(&(vLocal_3[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_3[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_3[iVar09] + 16);
		}
		Function_15(&(vLocal_3[iVar09]), 1);
		iVar0++;
	}
...
void Function_2(int iParam0, char* cParam1) //Position: 0x445 / 1093
{
	var uVar0;
...
void Function_5(struct<69> Param0) //Position: 0x49D / 1181
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_122))
								{
									...
									{
										iLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_122 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_122))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_122))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_122);
		}
...
bool Function_7(bool bParam0, int iParam1, int iParam2) //Position: 0x8EA / 2282
{
	int iVar0;
	bool bVar1;
	
	bVar1 = GET_GRINGO_BOOL_ATTR(&iParam1, &bParam0, &iVar0);
	if (iVar0 >= 0)
	{
		return bVar1;
	}
...
bool Function_8(int iParam0, int iParam1) //Position: 0x908 / 2312
{
	return Function_9(&iParam0, "UseQuit", &iParam1);
}

bool Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x921 / 2337
{
	int iVar0;
	int iVar1;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_119, &uLocal_117);
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_75(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1E29 / 7721
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	return;
...
bool Function_19() //Position: 0x1E3B / 7739
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E6E / 7790
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1EEC / 7916
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x1F68 / 8040
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1F7A / 8058
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1F91 / 8081
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1F9E / 8094
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1FBF / 8127
{
	bool bVar0;
	var uVar1;
	...
	if (iLocal_2 == 5)
	{
		if (!Function_7(&iParam1, "HasSwappedNode", 0))
		{
			uVar1 = Function_9(&iParam1, "NodeToSwap", &bVar0);
			if (bVar0)
			{
				if (SET_ACTION_NODE_FOR_ACTOR(&uParam0, &uVar1))
				{
					SET_GRINGO_BOOL_ATTR(1, "HasSwappedNode", &iParam1);
					return 1;
				}
				LOG_ERROR("SET_ACTION_NODE_FOR_ACTOR FAILED!!!");
				return 0;
			}
			LOG_ERROR("NODE SWAP NOT FOUND!!!");
			PRINTSTRING(&uVar1);
			PRINTNL();
		}
	}
	else if (Function_7(&iParam1, "HasSwappedNode", 0))
	{
		SET_GRINGO_BOOL_ATTR(0, "HasSwappedNode", &iParam1);
		return 0;
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x20BB / 8379
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x20DB / 8411
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x20E1 / 8417
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x20F3 / 8435
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2100 / 8448
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(int iParam0, int iParam1) //Position: 0x211B / 8475
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x213B / 8507
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x215B / 8539
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (vLocal_3 - 1))
	{
		if (&vLocal_3[iVar09] + 16 == &iParam0)
		{
			return &vLocal_3[iVar09] + 24;
		}
		iVar0++;
	}
	return &iVar1;
...
bool Function_35(int iParam0) //Position: 0x2192 / 8594
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x21B2 / 8626
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x21CD / 8653
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x21E3 / 8675
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2507 / 9479
{
	int iVar0;
...
bool Function_40(int iParam0, int iParam1) //Position: 0x2510 / 9488
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x252F / 9519
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(int iParam0, int iParam1) //Position: 0x253E / 9534
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2562 / 9570
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x2588 / 9608
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x25A6 / 9638
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x25C8 / 9672
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x25EA / 9706
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x26B2 / 9906
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x272E / 10030
{
...
void Function_50(vector3 vParam0) //Position: 0x2746 / 10054
{
...
var Function_51(int iParam0) //Position: 0x276B / 10091
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x278C / 10124
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x27A3 / 10147
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x27AF / 10159
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x27B6 / 10166
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x27C7 / 10183
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x280C / 10252
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2838 / 10296
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2844 / 10308
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2946 / 10566
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2969 / 10601
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2991 / 10641
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		PLAY_CUTSCENEOBJECT(&uVar18, 0, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
	}
	else
	{
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2C78 / 11384
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2CD5 / 11477
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2D32 / 11570
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2D3E / 11582
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2D5D / 11613
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2D74 / 11636
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2E05 / 11781
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E29 / 11817
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2E48 / 11848
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2E6C / 11884
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2F94 / 12180
{
...
int Function_74(var uParam0) //Position: 0x2FC2 / 12226
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x30DB / 12507
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x30E8 / 12520
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x316A / 12650
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_119)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_117));
		iLocal_119 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_78() //Position: 0x3715 / 14101
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x374F / 14159
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x376D / 14189
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x37AE / 14254
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x37BA / 14266
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x37DC / 14300
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	iLocal_2 = (iLocal_2 - 1);
...
void Function_84(var uParam0, bool bParam1) //Position: 0x37F4 / 14324
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3904 / 14596
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x391C / 14620
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3C38 / 15416
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	iLocal_2++;
...
bool Function_88(int iParam0) //Position: 0x3C50 / 15440
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C6A / 15466
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C85 / 15493
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3CC3 / 15555
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3CDC / 15580
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3FD4 / 16340
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FF2 / 16370
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4093 / 16531
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x40B3 / 16563
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x40C6 / 16582
{
...
void Function_98(int iParam0) //Position: 0x40E2 / 16610
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x40EE / 16622
{
	int iVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_3[iLocal_1139]), &uParam0);
		iLocal_113++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x415A / 16730
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4172 / 16754
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x417E / 16766
{
