...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_23 = Vector(-70,441f, 116,972f, 1415,828f);
	Local_26 = Vector(-73,11f, 117,869f, 1367,464f);
	fLocal_29 = -1.0f;
	iLocal_30 = 0;
	iLocal_31 = 2;
	iLocal_32 = 4;
	...
	*(&iVar0 + 360) = 2;
	...
	{
		Function_31(&iVar0, GRINGO_GET_MY_OBJECT_REF(), 1, 0, 0, 0, "", -1.0f, 1, 0x43160000);
		GRINGO_WAIT(250);
	}
	Function_1(&iVar0);
	return;
...
void Function_1(struct<473> Param0) //Position: 0xAE / 174
{
	bool bVar0;
...
void Function_2() //Position: 0x25C / 604
{
	Function_3();
	return;
}

void Function_3() //Position: 0x265 / 613
{
	Function_24(57);
	RELEASE_LAYOUT_REF(&uLocal_17);
	SQUAD_LEAVE(&uLocal_9);
	CLEAR_ACTOR_STAY_WITHIN_VOLUME(&uLocal_9);
	MEMORY_ALLOW_SHOOTING(&uLocal_9, false);
	MEMORY_PREFER_MELEE(&uLocal_9, 0);
	SET_ACTOR_FACTION(&uLocal_9, 20);
	MEMORY_CONSIDER_AS(&uLocal_9, &Global_54076, false);
	Function_21(13, 0, 1, 1, 1);
	Function_7(12, &uLocal_9, &uLocal_13, &uLocal_3, &uLocal_15, 57);
	if (IS_ACTOR_VALID(&Global_15402[1214] + 8))
	{
		if (GET_ACTOR_ENUM(&Global_15402[1214] + 8) == 640)
		{
			Function_6(12);
			Function_4(StackVal, 12, "Son", 640, "Companion_Son_Bed", Vector(-105,85f, 119,64f, 1368,919f), 1);
		}
	}
	return;
}

var Function_4(int iParam0, char* cParam1) //Position: 0x31B / 795
{
	var uVar0;
	int iVar1;
	struct<2> Var2;
	...
	(&Global_15402[iParam014] + 16) = uParam2;
	...
	*(&Global_15402[iParam014] + 24) = &Global_10992;
	if (&bParam6)
	{
		...
		if (!(STRING_CONTAINS_STRING(&uParam3, "\\") || STRING_CONTAINS_STRING(&uParam3, "/")))
		{
			FILE_START_PATH("$/content/scripting/gringo/gringobrains/cb");
			FILE_ADD_TO_PATH(&uParam3);
			FILE_END_PATH();
			uParam3 = FILE_GET_CURRENT_PATH();
		}
		uVar4 = CREATE_GRINGO_ON_OBJECT(GET_OBJECT_FROM_PERS_CHAR(&uVar0), "Persistent_Char_Brain", &uParam3, Var2, Var2);
		if (IS_OBJECT_VALID(&uVar4))
		{
			GRINGO_QUERY_BOOL(GET_GRINGO_FROM_OBJECT(&uVar4), "CompanionSettings", "EnableCompanionBehavior", &iVar5);
			if (iVar5 >= 0)
			{
				ATTACH_OBJECTS(StackVal, StackVal, &uVar4, GET_OBJECT_FROM_PERS_CHAR(&uVar0), Function_5(), Vector(0.0f, 1,5f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
			}
			else
			{
...
var Function_5() //Position: 0x7D0 / 2000
{
	int iVar0;
...
void Function_6(bool bParam0) //Position: 0x7D9 / 2009
{
	int iVar0;
	...
	if (Global_15402[bParam014].f_32)
	{
		STREAMING_EVICT_ACTOR(&Global_15402[bParam014] + 16, 4294967295);
	}
	if (IS_ACTOR_VALID(&Global_15402[bParam014] + 8))
	{
		DESTROY_ACTOR(&Global_15402[bParam014] + 8);
	}
	if (IS_PERS_CHAR_VALID(&(Global_15402[bParam014])))
	{
		DESTROY_PERS_CHAR(&(Global_15402[bParam014]));
	}
	return;
}

void Function_7(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x877 / 2167
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	Function_21(bParam0, DECOR_CHECK_EXIST(&iParam1, "hidden"), (Global_6621 || bVar9), 1, 1);
...
void Function_8(var uParam0, bool bParam1) //Position: 0xCE9 / 3305
{
...
void Function_9(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xD1D / 3357
{
	var uVar0;
	bool bVar1;
...
bool Function_10(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xDE3 / 3555
{
	float fVar0;
...
void Function_11(int iParam0) //Position: 0xFAC / 4012
{
...
void Function_12(int iParam0) //Position: 0xFE9 / 4073
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_13(var uParam0, int iParam1) //Position: 0x1002 / 4098
{
	return (uParam0 && iParam1) == 0;
}

var Function_14(var uParam0, int iParam1) //Position: 0x100F / 4111
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_15(int iParam0, var uParam1) //Position: 0x1104 / 4356
{
	var uVar0;
	int iVar1;
...
bool Function_16(var uParam0, int iParam1) //Position: 0x116A / 4458
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_17(int iParam0) //Position: 0x11CC / 4556
{
	bool bVar0;
...
int Function_18(struct<209> Param0) //Position: 0x1201 / 4609
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_19(var uParam0, struct<2> Param1) //Position: 0x141A / 5146
{
	struct<2> Var0;
...
struct<8> Function_20(int iParam0) //Position: 0x1491 / 5265
{
	struct<2> Var0;
...
int Function_21(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4) //Position: 0x14FD / 5373
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_ACTOR_VALID(&Global_15402[iParam014] + 8))
	{
		...
		Function_23(&Global_15402[iParam014] + 8);
		...
		Function_22(&Global_15402[iParam014] + 8);
...
void Function_22(var uParam0) //Position: 0x183F / 6207
{
	int iVar0;
...
void Function_23(int iParam0) //Position: 0x1872 / 6258
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		return;
...
void Function_24(int iParam0) //Position: 0x1889 / 6281
{
	if (Function_26(&Global_6667[iParam028] + 184, 8388608))
	{
		Function_25(&Global_6667[iParam028] + 184, 8388608);
	}
	return;
}

void Function_25(var uParam0, int iParam1) //Position: 0x18B5 / 6325
{
	int iVar0;
...
bool Function_26(var uParam0, int iParam1) //Position: 0x18CF / 6351
{
	int iVar0;
...
void Function_27(int iParam0) //Position: 0x18EC / 6380
{
	int iVar0;
	...
	{
		Function_28(&iParam0, iVar0);
		iVar0++;
	}
	return;
}

void Function_28(struct<2>[] Param0, int iParam1) //Position: 0x1914 / 6420
{
	if (Function_30(&(Param0[iParam12]), 4))
	{
		if (Function_30(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_29(&(Param0[iParam12]), 1);
			Function_29(&(Param0[iParam12]), 2);
			Function_29(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_29(struct<13> Param0) //Position: 0x1A5F / 6751
{
	int iVar0;
...
bool Function_30(struct<13> Param0) //Position: 0x1A7C / 6780
{
	int iVar0;
...
var Function_31(struct<477> Param0) //Position: 0x1A9A / 6810
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_31 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_147(&Param0 + 324, &fLocal_33, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_5(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_33, 20.0f, fLocal_33));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_133(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_5(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_19(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_5(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_5(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_71(StackVal, StackVal, &Param0 + 16, Function_5(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_5()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_10(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_34, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_32(struct<62> Param0) //Position: 0x2C59 / 11353
{
...
void Function_33(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2C6B / 11371
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_34(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2EA4 / 11940
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_35(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2EC4 / 11972
{
	bool bVar0;
	var uVar1;
...
int Function_36(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2FB2 / 12210
{
	char* cVar0[32];
...
int Function_37(int iParam0) //Position: 0x321E / 12830
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_38(var uParam0, bool bParam1) //Position: 0x3242 / 12866
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_39(var uParam0, int iParam1) //Position: 0x3266 / 12902
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_40(var uParam0, bool bParam1) //Position: 0x328C / 12940
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_41(var uParam0, bool bParam1) //Position: 0x32B3 / 12979
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_42(bool bParam0) //Position: 0x32D7 / 13015
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_43() //Position: 0x32F6 / 13046
{
...
bool Function_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x3345 / 13125
{
	bool bVar0;
	var uVar1;
...
bool Function_45(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x33A1 / 13217
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_46(var uParam0, int iParam1) //Position: 0x33C2 / 13250
{
	bool bVar0;
	var uVar1;
...
void Function_47(var uParam0, var uParam1, bool bParam2) //Position: 0x341D / 13341
{
	bool bVar0;
	var uVar1;
...
var Function_48() //Position: 0x3469 / 13417
{
...
void Function_49(struct<425> Param0) //Position: 0x347E / 13438
{
	bool bVar0;
	bool bVar1;
...
bool Function_50(var uParam0, struct<2> Param1, float fParam3) //Position: 0x35D1 / 13777
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			{
				Function_20(&iVar1);
				if (VDIST(Function_20(&iVar1), Param1) >= fParam3)
				{
					iVar2 = 1;
				}
			}
...
bool Function_51(vector3 vParam0) //Position: 0x3646 / 13894
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_52(var uParam0) //Position: 0x365E / 13918
{
	bool bVar0;
	int iVar1;
...
var Function_53(bool bParam0) //Position: 0x36BC / 14012
{
	bool bVar0;
	bool bVar1;
...
void Function_54(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3709 / 14089
{
	bool bVar0;
	var uVar1;
...
void Function_55(var uParam0, bool bParam1) //Position: 0x3782 / 14210
{
	bool bVar0;
	var uVar1;
...
void Function_56(var uParam0) //Position: 0x37D1 / 14289
{
	struct<21> Var0;
...
bool Function_57() //Position: 0x3890 / 14480
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_58(struct<25> Param0) //Position: 0x38A3 / 14499
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_59(int iParam0) //Position: 0x396A / 14698
{
...
bool Function_60(int iParam0) //Position: 0x398A / 14730
{
...
bool Function_61(int iParam0) //Position: 0x39AE / 14766
{
...
bool Function_62(int iParam0) //Position: 0x39C3 / 14787
{
...
bool Function_63(int iParam0, bool bParam1) //Position: 0x39DA / 14810
{
	int iVar0;
...
var Function_64(int iParam0) //Position: 0x3A18 / 14872
{
...
bool Function_65(int iParam0) //Position: 0x3A32 / 14898
{
...
int Function_66(int iParam0, struct<6> Param1) //Position: 0x3A48 / 14920
{
	int iVar0;
...
void Function_67(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3A82 / 14978
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_5(), bParam2[iVar0], Var1, Var3);
...
void Function_68(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3B67 / 15207
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_5(), bParam3, Var2, Var4);
...
void Function_69(var uParam0, bool bParam1) //Position: 0x3D1E / 15646
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_70(bool bParam0) //Position: 0x3D43 / 15683
{
	var uVar0;
	int iVar1;
...
var Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3D91 / 15761
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_72(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3EE8 / 16104
{
	var uVar0[5];
	int iVar6;
...
int Function_73(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3F93 / 16275
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_74(int iParam0, int iParam1) //Position: 0x403A / 16442
{
	iParam1 = &iParam1;
	if ((IS_PERS_CHAR_VALID(&(Global_15402[1214])) && (&Global_15402[1214] + 16 != 638 || &Global_15402[1214] + 16 != 640)) || (iLocal_30 && (GET_CURRENT_GAME_TIME() - fLocal_29) < 15.0f))
	{
		Function_101(&uLocal_3, "$/content/scripting/gringo/simplegringo/repair_kneel_nospawn", 1, 0);
		if (Function_94(&uLocal_9, &uLocal_3, 57, 1, 1, 0, 1, 0, 0, 0, 0))
		{
			if (!IS_ACTOR_VALID(&uLocal_11))
			{
				uLocal_11 = Function_82(13, 0, 1, 0, 0, 0, 0, 0, 0);
			}
			else
			{
				uLocal_19 = LOCATE_GRINGO_OF_TYPE("hammer", &uLocal_23, 2.0f, 1);
				if (IS_GRINGO_VALID(&uLocal_19))
				{
					if (Function_80(&uLocal_17, "home03mobile", &iParam1))
					{
						uLocal_13 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_17, Function_5()));
						*(&Global_6667[5728] + 216) = &uLocal_13;
						*(&iParam0 + 24) = &uLocal_17;
						Function_75();
						return 1;
					}
				}
...
void Function_75() //Position: 0x4182 / 16770
{
	uLocal_15 = CREATE_LAYOUT("home02son01campfirelayout");
	uLocal_21 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_15, "home03hammer", "repair_kneel_nospawn", Local_26, Vector(0.0f, 242,821f, 0.0f));
	TELEPORT_ACTOR(&uLocal_9, &uLocal_23, 1, 1, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_9, GET_OBJECT_FROM_GRINGO(&uLocal_19), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_9, &uLocal_19, "UseCase1", 4294967295, 1);
	Function_78(57);
	TELEPORT_ACTOR(&uLocal_11, &Local_26, 1, 1, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_11, &uLocal_21, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_11, GET_GRINGO_FROM_OBJECT(&uLocal_21), "UseCase1", 4294967295, 1);
	Function_76(&uLocal_9, &uLocal_13, 1, 1);
	Function_78(57);
	return;
}

void Function_76(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x4271 / 17009
{
	bool bVar0;
	int iVar1;
...
bool Function_77(int iParam0, int iParam1, bool bParam2) //Position: 0x442E / 17454
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_78(int iParam0) //Position: 0x4476 / 17526
{
	if (!Function_26(&Global_6667[iParam028] + 184, 8388608))
	{
		Function_79(&Global_6667[iParam028] + 184, 8388608);
	}
	return;
}

void Function_79(var uParam0, int iParam1) //Position: 0x44A3 / 17571
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x44B4 / 17588
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x44E4 / 17636
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_5(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
var Function_82(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8) //Position: 0x452F / 17711
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_83(var uParam0, bool bParam1) //Position: 0x4A6F / 19055
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_84(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4A91 / 19089
{
	var uVar0;
...
var Function_85(bool bParam0, int iParam1) //Position: 0x4AF2 / 19186
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_86(var uParam0, int iParam1) //Position: 0x4B80 / 19328
{
	Function_88(&uParam0);
	Function_87(&uParam0);
...
void Function_87(int iParam0) //Position: 0x4BAC / 19372
{
...
void Function_88(int iParam0) //Position: 0x4BD2 / 19410
{
...
bool Function_89(bool bParam0) //Position: 0x4CA8 / 19624
{
...
var Function_90(int iParam0, int iParam1) //Position: 0x4CBF / 19647
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_91(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D65 / 19813
{
	var uVar0;
	var uVar1;
...
void Function_92(var uParam0) //Position: 0x4E74 / 20084
{
	int iVar0;
...
bool Function_93(var uParam0, bool bParam1) //Position: 0x4EA7 / 20135
{
	int iVar0;
...
bool Function_94(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4EC4 / 20164
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x50A3 / 20643
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_20(&iParam0);
		if (VDIST(Function_20(&iParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
void Function_96() //Position: 0x512F / 20783
{
	var uVar0;
	int iVar1;
...
bool Function_97(int iParam0) //Position: 0x519F / 20895
{
...
bool Function_98(int iParam0) //Position: 0x51BB / 20923
{
...
var Function_99(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x51D1 / 20945
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(struct<205> Param0) //Position: 0x5277 / 21111
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_26(&Param0 + 184, 1024))
				{
					return 0;
				}
				break;
		}
		if (Function_26(&Param0 + 184, 4096))
		{
			if (Function_26(&Param0 + 184, 1))
			{
...
var Function_101(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5382 / 21378
{
	int iVar0;
	int iVar1;
...
void Function_102(struct<13> Param0) //Position: 0x53C0 / 21440
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_103(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x53D3 / 21459
{
	int iVar0;
	...
	{
		if (!Function_30(&(Param0[iVar02]), 4))
		{
...
bool Function_104(struct<2>[] Param0) //Position: 0x54A2 / 21666
{
	int iVar0;
	int iVar1;
	...
	Function_107();
	iVar1 = 0;
	if (!Function_30(&(Param0[iVar02]), 16))
	{
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_30(&(Param0[iVar02]), 4))
		{
			if (!Function_30(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_30(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), 1, (Function_30(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_30(&(Param0[iVar02]), 4))
		{
			if (!Function_30(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_105() //Position: 0x5864 / 22628
{
	if (!Function_151(128))
	{
		return;
...
bool Function_106() //Position: 0x58A4 / 22692
{
	int iVar0;
...
void Function_107() //Position: 0x58D2 / 22738
{
	if (!Function_151(128))
	{
		return;
...
void Function_108(vector3 vParam0) //Position: 0x5914 / 22804
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x59AC / 22956
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x59DB / 23003
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x5A36 / 23094
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x5A46 / 23110
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5A5A / 23130
{
	int iVar0;
...
var Function_114() //Position: 0x5A7F / 23167
{
	return "PackedMetadata";
}

void Function_115(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5A96 / 23190
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_116() //Position: 0x5BD2 / 23506
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_117() //Position: 0x5BE4 / 23524
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_118() //Position: 0x5BF6 / 23542
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_119(var uParam0, struct<5> Param1) //Position: 0x5C08 / 23560
{
...
var Function_120(var uParam0, int iParam1, int iParam2) //Position: 0x5C2D / 23597
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x5C4C / 23628
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_122() //Position: 0x5C58 / 23640
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x5C63 / 23651
{
	int iVar0;
...
var Function_124() //Position: 0x5C91 / 23697
{
	return "PackedWeapon";
}

int Function_125(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5CA6 / 23718
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_126() //Position: 0x5DB3 / 23987
{
	return "MPItemGiver";
}

struct<32> Function_127(char* cParam0) //Position: 0x5DC7 / 24007
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0) //Position: 0x5E33 / 24115
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5E55 / 24149
{
	return "PBox_";
}

var Function_130() //Position: 0x5E63 / 24163
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5E89 / 24201
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x5EB1 / 24241
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5ED7 / 24279
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, struct<2> Param2) //Position: 0x6041 / 24641
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x60E9 / 24809
{
	int iVar0;
	struct<2> Var1;
...
void Function_136(int iParam0) //Position: 0x6257 / 25175
{
...
var Function_137(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x62BF / 25279
{
	return Function_138(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x62DD / 25309
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_139(int iParam0) //Position: 0x65D6 / 26070
{
	int iVar0;
...
void Function_140() //Position: 0x668A / 26250
{
	int iVar0;
...
bool Function_141(bool bParam0) //Position: 0x66C5 / 26309
{
	int iVar0;
...
void Function_142(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x66F2 / 26354
{
	int iVar0;
...
void Function_143() //Position: 0x684D / 26701
{
	int iVar0;
...
var Function_144(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6899 / 26777
{
	int iVar0;
...
int Function_145() //Position: 0x6975 / 26997
{
	int iVar0;
...
int Function_146() //Position: 0x6AD1 / 27345
{
	int iVar0;
...
bool Function_147(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6BF1 / 27633
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_148(struct<2> Param0) //Position: 0x6CCD / 27853
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_149(struct<2> Param0, struct<5> Param2) //Position: 0x6CEC / 27884
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_150(int iParam0) //Position: 0x6E2F / 28207
{
	var uVar0;
...
bool Function_151(int iParam0) //Position: 0x6E51 / 28241
{
	int iVar0;
...
int Function_152() //Position: 0x6E6D / 28269
{
	return 0;
}

void Function_153(struct<321> Param0) //Position: 0x6E74 / 28276
{
	var uVar0;
