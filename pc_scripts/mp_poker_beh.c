...
void Function_75() //Position: 0x1D40 / 7488
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_290 = CREATE_LAYOUT("Poker_BEH_layout");
	(&iLocal_290 + 8) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_290, 8, 0);
	*(&iLocal_290 + 16[03]) = Vector(-139,135f, 119,2267f, 1345,722f);
	*(&iLocal_290 + 16[03] + 12) = Vector(0.0f, 1,746283f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "PlayerPosition", Vector(-139,135f, 119,2267f, 1345,722f), Vector(0.0f, 1,746283f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_290 + 8);
	*(&iLocal_290 + 16[13]) = Vector(-140,5376f, 119,2267f, 1344,727f);
	*(&iLocal_290 + 16[13] + 12) = Vector(0.0f, -50,74146f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_0_Position", Vector(-140,5376f, 119,2267f, 1344,727f), Vector(0.0f, -50,74146f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_290 + 8);
	*(&iLocal_290 + 16[23]) = Vector(-140,7188f, 119,2267f, 1342,68f);
	*(&iLocal_290 + 16[23] + 12) = Vector(0.0f, 245,7885f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_1_Position", Vector(-140,7188f, 119,2267f, 1342,68f), Vector(0.0f, 245,7885f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_290 + 8);
	*(&iLocal_290 + 16[33]) = Vector(-139,117f, 119,2222f, 1341,368f);
	*(&iLocal_290 + 16[33] + 12) = Vector(0.0f, 180,7421f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_2_Position", Vector(-139,117f, 119,2222f, 1341,368f), Vector(0.0f, 180,7421f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_290 + 8);
	*(&iLocal_290 + 16[43]) = Vector(-137,1698f, 119,2222f, 1342,421f);
	*(&iLocal_290 + 16[43] + 12) = Vector(0.0f, 120,8644f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_3_Position", Vector(-137,1698f, 119,2222f, 1342,421f), Vector(0.0f, 120,8644f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_290 + 8);
	*(&iLocal_290 + 144) = Vector(-138,8952f, 120,019f, 1343,499f);
	*(&iLocal_290 + 144 + 12) = Vector(0.0f, 189,761f, 0.0f);
	*(&iLocal_290 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "TableCenter", Vector(-138,8952f, 120,019f, 1343,499f), Vector(0.0f, 189,761f, 0.0f));
	*(&iLocal_290 + 176) = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 184[03]) = Vector(-137,0149f, 119,2222f, 1344,059f);
	*(&iLocal_290 + 184[03] + 12) = Vector(0.0f, -285,6316f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_0_Pos", Vector(-137,0149f, 119,2222f, 1344,059f), Vector(0.0f, -285,6316f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_290 + 176);
	*(&iLocal_290 + 184[13]) = Vector(-137,3732f, 119,2222f, 1344,825f);
	*(&iLocal_290 + 184[13] + 12) = Vector(0.0f, 53,60045f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_1_Pos", Vector(-137,3732f, 119,2222f, 1344,825f), Vector(0.0f, 53,60045f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_290 + 176);
	*(&iLocal_290 + 240) = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 248[03]) = Vector(-136.0f, 118,8691f, 1368f);
	*(&iLocal_290 + 248[03] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_0", Vector(-136.0f, 118,8691f, 1368f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_290 + 240);
	*(&iLocal_290 + 248[13]) = Vector(-136.0f, 118,8691f, 1356f);
	*(&iLocal_290 + 248[13] + 12) = Vector(0.0f, 177,0741f, 0.0f);
	iVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_1", Vector(-136.0f, 118,8691f, 1356f), Vector(0.0f, 177,0741f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&iVar9, &iLocal_290 + 240);
	return;
}

void Function_76(int iParam0, int iParam1) //Position: 0x21E5 / 8677
{
	switch (&iParam1)
	{
		case 0x00000000:
