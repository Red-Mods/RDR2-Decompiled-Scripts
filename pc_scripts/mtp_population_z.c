...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("ManzanitaPost_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "mtpv_TrnPlatform_set");
		...
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "mtpv_customers_set");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 1, 5, 0, 0, 1);
		}
		...
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "mtpv_store_set");
		if (IS_VOLUME_VALID(&uVar3))
		{
		...
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "mtpv_region");
		if (IS_VOLUME_VALID(&uVar3))
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xCBD / 3261
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCCE / 3278
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xD26 / 3366
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xDB8 / 3512
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xDD4 / 3540
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xE14 / 3604
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xE31 / 3633
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE42 / 3650
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE89 / 3721
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE96 / 3734
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xF18 / 3864
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xF27 / 3879
{
	if (!Function_4(128))
	{
		return;
