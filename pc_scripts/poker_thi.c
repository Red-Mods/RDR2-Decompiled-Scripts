...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46816[1], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_25(Global_46816[1], 0);
				(&Local_35 + 232) = Function_25(Global_46816[1], 0);
				Function_24(&Local_35 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_35 + 68)[iVar0] = iLocal_4 * 10;
					Function_23(Global_46816[1], iVar0, 0);
					*(&Local_35 + 128[iVar02]) = Function_23(Global_46816[1], iVar0, 0);
					iVar0++;
				}
				if (Function_35())
				{
				...
				Function_22(Global_46816[1]);
				*(&Local_35 + 268) = Function_22(Global_46816[1]);
				Function_21(Global_46816[1]);
				*(&Local_35 + 280) = Function_21(Global_46816[1]);
...
void Function_17() //Position: 0x5CA / 1482
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5D3 / 1491
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x5F4 / 1524
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x62B / 1579
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_21(int iParam0) //Position: 0x646 / 1606
{
...
struct<8> Function_22(int iParam0) //Position: 0x748 / 1864
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_23(int iParam0, int iParam1, bool bParam2) //Position: 0x84A / 2122
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_24(int[] iParam0) //Position: 0xDF6 / 3574
{
	int iVar0;
	var uVar1;
...
struct<8> Function_25(int iParam0, bool bParam1) //Position: 0xE52 / 3666
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_26(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF6E / 3950
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x117C / 4476
{
...
bool Function_28() //Position: 0x1240 / 4672
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_29(int iParam0) //Position: 0x1257 / 4695
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_30(int iParam0) //Position: 0x1263 / 4707
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_31(var uParam0, int iParam1) //Position: 0x1272 / 4722
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_32(var uParam0, bool bParam1) //Position: 0x1281 / 4737
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_33() //Position: 0x12C3 / 4803
{
	return Function_34(0);
}

int Function_34(bool bParam0) //Position: 0x12CD / 4813
{
...
bool Function_35() //Position: 0x130E / 4878
{
...
var Function_36(int iParam0) //Position: 0x1339 / 4921
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_37() //Position: 0x1353 / 4947
{
	Function_1();
	return;
}

void Function_38() //Position: 0x135C / 4956
{
...
void Function_39(int iParam0) //Position: 0x13AC / 5036
{
...
void Function_40(vector3 vParam0) //Position: 0x13C3 / 5059
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x13E8 / 5096
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x13FE / 5118
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0x140F / 5135
{
	return Function_44(iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0x141D / 5149
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x142A / 5162
{
	return;
}

void Function_46() //Position: 0x1430 / 5168
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x1436 / 5174
{
	var uVar0;
...
void Function_48(var uParam0) //Position: 0x1495 / 5269
{
	int iVar0;
...
var Function_49() //Position: 0x14B2 / 5298
{
	var uVar0;
