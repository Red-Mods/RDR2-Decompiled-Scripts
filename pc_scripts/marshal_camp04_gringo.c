...
{
	RELEASE_LAYOUT_REF(&uLocal_27);
	Function_4(4, &iLocal_21, &iLocal_23, &uLocal_3, &uLocal_25, 4294967295);
	return;
}
...
var Function_28(struct<477> Param0) //Position: 0x1478 / 5240
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_30 || bParam2) || Global_6611)
			{
				if (Function_151(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_149(&Param0 + 324, &fLocal_32, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_138(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_32, 20.0f, fLocal_32));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_33, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x2637 / 9783
{
	...
	if ((GET_CURRENT_GAME_TIME() - fLocal_29) < 1.0f && Function_33(Global_46760[0]))
	{
		...
		fLocal_29 = GET_CURRENT_GAME_TIME();
	}
	return;
}
...
bool Function_76(int iParam0, int iParam1) //Position: 0x3BD5 / 15317
{
	...
	Function_146(&uLocal_3, 592, 3, 0);
	Function_102(&uLocal_3, "talking_stand", 5, 0);
	Function_102(&uLocal_3, "custom/talking_stand", 8, 0);
	if (Function_86(&iLocal_21, &uLocal_3, 21, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_84(&uLocal_27, "marshal04mobile", &iParam1))
		{
			iLocal_23 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_27, Function_138()));
			*(&Global_6667[2128] + 216) = &iLocal_23;
			*(&iParam0 + 24) = &uLocal_27;
			Function_77();
			fLocal_29 = GET_CURRENT_GAME_TIME();
			return 1;
		}
...
void Function_77() //Position: 0x3C90 / 15504
{
	var uVar0;
	struct<2> Var1;
	bool bVar3;
	...
	uLocal_25 = CREATE_LAYOUT("marshal04campfirelayout");
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_25, "marshal04restrict", 2,802597E-45f, Vector(-2084,343f, 17,37085f, 2602,81f), Vector(0.0f, 24,46099f, 0.0f), Vector(9,259373f, 5,303829f, 9,113053f));
	...
	TELEPORT_ACTOR_WITH_HEADING(&iLocal_21, Var1, 15.0f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(&iLocal_21, 1.0f, false, 1092616192);
	Function_81(StackVal, &iLocal_21, Vector(-2084,735f, 17,709f, 2601,664f));
	TASK_STAND_STILL(&iLocal_21, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(&iLocal_21, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&iLocal_21, "talking_stand");
	bVar3 = TASK_SEQUENCE_OPEN();
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(false, "talking_stand/Listen_B");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&iLocal_21, bVar3, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar3, 1);
	Function_79(&iLocal_21, &iLocal_23, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iLocal_21, &uVar0, 1, true);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_25, "Marshal01deputy01", 588, Vector(-2086,813f, 17,204f, 2600,029f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uVar4, 1.0f, false, 1092616192);
	Function_78(&uVar4, &iLocal_21);
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "talking_stand");
	bVar3 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &iLocal_21, 0, 3212836864);
	TASK_ACTION_PERFORM(false, "talking_stand/Talk_A");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uVar4, bVar3, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar3, 1);
	Function_79(&uVar4, &iLocal_23, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uVar4, &uVar0, 1, true);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_25, "Marshal01deputy03", 592, Vector(-2086,204f, 17,227f, 2601,798f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uVar4, 1.0f, false, 1092616192);
	Function_78(&uVar4, &iLocal_21);
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "talking_stand");
...
void Function_78(var uParam0, int iParam1) //Position: 0x3F91 / 16273
{
	struct<2> Var0;
...
void Function_79(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3FAD / 16301
{
	bool bVar0;
	int iVar1;
...
bool Function_80(int iParam0, int iParam1, bool bParam2) //Position: 0x416B / 16747
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_81(var uParam0, struct<2> Param1) //Position: 0x41B3 / 16819
{
	if (!IS_ACTOR_VALID(GET_MOUNT(&uParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_82(&uParam0, &uParam0, Param1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_82(GET_MOUNT(&uParam0), &uParam0, Param1), 1);
	}
	return;
}

var Function_82(var uParam0, struct<2> Param1) //Position: 0x41EE / 16878
{
	struct<2> Var0;
...
struct<8> Function_83(int iParam0) //Position: 0x426F / 17007
{
	struct<2> Var0;
...
bool Function_84(var uParam0, var uParam1, int iParam2) //Position: 0x4281 / 17025
{
...
void Function_85(var uParam0, bool bParam1) //Position: 0x42B1 / 17073
{
	int iVar0;
...
bool Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x42FC / 17148
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x44DB / 17627
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x4A1B / 18971
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_89(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4A3D / 19005
{
	var uVar0;
...
var Function_90(bool bParam0, int iParam1) //Position: 0x4A9E / 19102
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x4B2C / 19244
{
	Function_93(&uParam0);
	Function_92(&uParam0);
...
void Function_92(int iParam0) //Position: 0x4B58 / 19288
{
...
void Function_93(int iParam0) //Position: 0x4B7E / 19326
{
...
bool Function_94(bool bParam0) //Position: 0x4C54 / 19540
{
...
var Function_95(int iParam0, int iParam1) //Position: 0x4C6B / 19563
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D11 / 19729
{
	var uVar0;
	var uVar1;
...
void Function_97(int iParam0) //Position: 0x4E20 / 20000
{
	int iVar0;
...
bool Function_98(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4E53 / 20051
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_99() //Position: 0x4EDF / 20191
{
	var uVar0;
	int iVar1;
...
var Function_100(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4F4F / 20303
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_101(struct<205> Param0) //Position: 0x4FF5 / 20469
{
	var uVar0;
	var uVar1;
...
var Function_102(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5100 / 20736
{
	int iVar0;
	int iVar1;
...
void Function_103(struct<13> Param0) //Position: 0x513E / 20798
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_104(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5151 / 20817
{
	int iVar0;
...
bool Function_105(struct<2>[] Param0) //Position: 0x5220 / 21024
{
	int iVar0;
	int iVar1;
...
void Function_106() //Position: 0x55E2 / 21986
{
	if (!Function_153(128))
	{
		return;
...
bool Function_107() //Position: 0x5622 / 22050
{
	int iVar0;
...
void Function_108() //Position: 0x5650 / 22096
{
	if (!Function_153(128))
	{
		return;
...
void Function_109(vector3 vParam0) //Position: 0x5692 / 22162
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x572A / 22314
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5759 / 22361
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x57B4 / 22452
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x57C4 / 22468
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x57D8 / 22488
{
	int iVar0;
...
var Function_115() //Position: 0x57FD / 22525
{
	return "PackedMetadata";
}

void Function_116(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5814 / 22548
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_117() //Position: 0x5950 / 22864
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_118() //Position: 0x5962 / 22882
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_119() //Position: 0x5974 / 22900
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_120(var uParam0, struct<5> Param1) //Position: 0x5986 / 22918
{
...
var Function_121(var uParam0, int iParam1, int iParam2) //Position: 0x59AB / 22955
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x59CA / 22986
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_123() //Position: 0x59D6 / 22998
{
	return Function_124(39);
}

int Function_124(int iParam0) //Position: 0x59E1 / 23009
{
	int iVar0;
...
var Function_125() //Position: 0x5A0F / 23055
{
	return "PackedWeapon";
}

int Function_126(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5A24 / 23076
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_127() //Position: 0x5B31 / 23345
{
	return "MPItemGiver";
}

struct<32> Function_128(char* cParam0) //Position: 0x5B45 / 23365
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0) //Position: 0x5BB1 / 23473
{
	char* cVar0[32];
...
var Function_130() //Position: 0x5BD3 / 23507
{
	return "PBox_";
}

var Function_131() //Position: 0x5BE1 / 23521
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x5C07 / 23559
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5C2F / 23599
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x5C55 / 23637
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5DBF / 23999
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5E67 / 24167
{
	int iVar0;
	struct<2> Var1;
...
void Function_137(int iParam0) //Position: 0x5FD5 / 24533
{
...
var Function_138() //Position: 0x603D / 24637
{
	int iVar0;
...
var Function_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x6046 / 24646
{
	return Function_140(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_140(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6064 / 24676
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x635D / 25437
{
	int iVar0;
...
void Function_142() //Position: 0x6411 / 25617
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x644C / 25676
{
	int iVar0;
...
void Function_144(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6479 / 25721
{
	int iVar0;
...
void Function_145() //Position: 0x65D4 / 26068
{
	int iVar0;
...
var Function_146(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6620 / 26144
{
	int iVar0;
...
int Function_147() //Position: 0x66FC / 26364
{
	int iVar0;
...
int Function_148() //Position: 0x6858 / 26712
{
	int iVar0;
...
bool Function_149(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6978 / 27000
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_150(struct<2> Param0) //Position: 0x6A54 / 27220
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_151(struct<2> Param0, struct<5> Param2) //Position: 0x6A73 / 27251
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_152(int iParam0) //Position: 0x6BB6 / 27574
{
	var uVar0;
...
bool Function_153(int iParam0) //Position: 0x6BD8 / 27608
{
	int iVar0;
...
int Function_154() //Position: 0x6BF4 / 27636
{
	return 0;
}

void Function_155(struct<321> Param0) //Position: 0x6BFB / 27643
{
	var uVar0;
