...
void main() //Position: 0x0 / 0
{
	...
	iLocal_122 = 0;
	Function_114(&uScriptParam_0, &iLocal_122);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_123);
		}
		iVar2 = 0;
		bLocal_130 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			iVar3 = 4294967295;
			iVar0 = 0;
			while (iVar0 < (iLocal_122 - 1))
			{
				if (&vLocal_12[iVar09] + 16 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_122;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_107(&(vLocal_12[iVar39]), &bVar4))
						{
							Function_105(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_12[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (&vLocal_12[iVar39] + 24 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_100("eGRINGO_EndUse: Stop use by request", &vLocal_12[iVar39] + 24);
							Function_99(&vLocal_12[iVar39] + 24, 1);
							if (IS_ACTOR_VALID(&vLocal_12[iVar39] + 24))
							{
								if (IS_ACTOR_LOCAL_PLAYER(&vLocal_12[iVar39] + 24) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(&vLocal_12[iVar39] + 16))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(&vLocal_12[iVar39] + 24, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_92(&(vLocal_12[iVar39]), 0);
							}
							else if (vLocal_12[iVar39].f_68 < 8)
							{
								Function_91(&(vLocal_12[iVar39]));
								vLocal_12[iVar39].f_68 = 8;
							}
							bVar5 = true;
						}
						else
		...
		else
		{
			...
			while (iVar0 < (iLocal_122 - 1))
			{
				if (Function_90(vLocal_12[iVar09].f_64, 2))
				{
					if (!Function_31(&(vLocal_12[iVar09])))
					{
						Function_117("Quitting due to update end");
						Function_92(&(vLocal_12[iVar09]), 1);
					}
				}
				if (Function_30(&(vLocal_12[iVar09]), 0))
				{
					Function_20(&(vLocal_12[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_131))
	{
		Function_117("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_131);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_122 - 1))
	{
		if (Function_90(vLocal_12[iVar09].f_64, 2))
		{
			Function_6("Gringo termination calls StopUse", &vLocal_12[iVar09] + 24);
			Function_92(&(vLocal_12[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_12[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_12[iVar09] + 16);
		}
		Function_30(&(vLocal_12[iVar09]), 1);
		iVar0++;
	}
...
void Function_1(int iParam0) //Position: 0x443 / 1091
{
	iParam0 = &iParam0;
	Function_2(&uLocal_4);
	return;
...
void Function_2(int iParam0) //Position: 0x454 / 1108
{
	int iVar0;
...
void Function_3(struct<2>[] Param0, int iParam1) //Position: 0x47C / 1148
{
...
void Function_4(struct<13> Param0) //Position: 0x5C7 / 1479
{
	int iVar0;
...
bool Function_5(struct<13> Param0) //Position: 0x5E4 / 1508
{
	int iVar0;
...
void Function_6(bool bParam0, char* cParam1) //Position: 0x602 / 1538
{
	var uVar0;
...
var Function_7() //Position: 0x644 / 1604
{
	return iLocal_3;
}

int Function_8(int iParam0) //Position: 0x64C / 1612
{
	struct<2> Var0;
	var uVar2;
	struct<2> Var3;
	...
	if (Function_16(48, 0))
	{
		if (IS_ACTOR_VALID(&uLocal_0))
		{
			iLocal_3 = 4000;
			return 1;
		}
		GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var0);
		uVar2 = LOCATE_ACTOR_OF_TYPE(Var0, 10.0f, 4294967295, 1194);
		...
		uVar2 = GET_VEHICLE(&Global_54076);
		if (IS_ACTOR_VALID(&uVar2))
		{
			uLocal_0 = &uVar2;
			iLocal_3 = 4000;
		...
		if (!iLocal_2)
		{
			Function_15(&uLocal_4, 1194, 3, 0);
			iLocal_2 = 1;
			iLocal_3 = 10;
		}
		if (Function_9(&uLocal_4))
		{
			if (IS_LAYOUTREF_VALID(&Global_46715))
			{
				if (!WOULD_ACTOR_BE_VISIBLE(1194, &Var0, 3212836864) || HUD_IS_FADED())
				{
					GET_OBJECT_ORIENTATION(GRINGO_GET_MY_OBJECT_REF(), &Var3);
					uLocal_0 = CREATE_ACTOR_IN_LAYOUT(&Global_46715, "PlayerCarGringo_Car", 1194, Var0, Var3);
					iLocal_3 = 4000;
				}
				else
				{
...
bool Function_9(struct<2>[] Param0) //Position: 0x756 / 1878
{
	int iVar0;
	int iVar1;
...
void Function_10() //Position: 0xB18 / 2840
{
	if (!Function_11(128))
	{
		return;
...
bool Function_11(int iParam0) //Position: 0xB58 / 2904
{
	int iVar0;
...
bool Function_12() //Position: 0xB74 / 2932
{
	int iVar0;
...
void Function_13(struct<13> Param0) //Position: 0xBA2 / 2978
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_14() //Position: 0xBB5 / 2997
{
	if (!Function_11(128))
	{
		return;
...
var Function_15(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xBF7 / 3063
{
	int iVar0;
...
bool Function_16(var uParam0, bool bParam1) //Position: 0xCD3 / 3283
{
	int iVar0;
...
bool Function_17(int iParam0) //Position: 0xD11 / 3345
{
...
var Function_18(int iParam0) //Position: 0xD28 / 3368
{
...
bool Function_19(int iParam0) //Position: 0xD42 / 3394
{
...
void Function_20(struct<69> Param0) //Position: 0xD58 / 3416
{
	bool bVar0;
	int iVar1;
	int iVar2;
	
	if (!Function_90(Param0.f_64, 2))
	{
		Function_99(&Param0 + 24, 0);
	}
	else if (UNK_0x0A0E660E() || Function_29(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_131))
								{
									...
									{
										bLocal_131 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_131 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_131))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_131))
		{
			Function_117("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_131);
		}
...
bool Function_21(int iParam0) //Position: 0x108C / 4236
{
	bool bVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_22(bool bParam0, var uParam1, int iParam2) //Position: 0x11A5 / 4517
{
	int iVar0;
	bool bVar1;
...
bool Function_23(char* cParam0, int iParam1) //Position: 0x11C3 / 4547
{
	return Function_24(&cParam0, "UseQuit", &iParam1);
}

bool Function_24(char* cParam0, char* cParam1, int iParam2) //Position: 0x11DC / 4572
{
	int iVar0;
	int iVar1;
...
float Function_25(int iParam0) //Position: 0x122C / 4652
{
	return Function_26(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_26(float fParam0, var uParam1, int iParam2) //Position: 0x124A / 4682
{
	int iVar0;
...
float Function_27(vector3 vParam0) //Position: 0x1262 / 4706
{
...
bool Function_28(int iParam0) //Position: 0x132F / 4911
{
	return Function_90(iParam0, 2);
}

bool Function_29(int iParam0) //Position: 0x133D / 4925
{
	return Function_90(iParam0, 1);
}

bool Function_30(int iParam0, int iParam1) //Position: 0x134B / 4939
{
	bool bVar0;
...
bool Function_31(struct<69> Param0) //Position: 0x1398 / 5016
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	bVar11 = Function_89(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_100("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_22(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_100("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_100("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_88(&Param0 + 16, &fVar22))
				{
			...
			{
				if (Function_83(&Param0 + 24, &Param0 + 16))
				{
			...
			if (!Function_81(&Param0 + 16) && Param0.f_68 != 1)
			{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_90(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
				Function_77(&Param0 + 16);
			}
			fVar18 = Function_76(&Param0 + 16);
			if (Function_27(&Param0) < fVar18)
			{
				Function_6("INTRO TIMED OUT - ABORTING", &Param0 + 24);
				return 0;
			}
			if (Function_90(Param0.f_64, 1))
			{
				Function_71(&Param0 + 16, &Var3, &uVar5);
				if (!Function_90(Param0.f_64, 16))
				{
					if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
					{
						Function_6("SUSPEND MOVER", &Param0 + 24);
						SUSPEND_MOVER(&Param0 + 24);
						Function_70(&Param0 + 64, 16);
					}
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(&Param0 + 24, Var3, uVar5, 1, 1, Function_69());
				}
				if (!Function_90(Param0.f_64, 1024))
				{
					Function_70(&Param0 + 64, 1024);
					SET_ACTOR_CAN_PLAY_GESTURES(&Param0 + 24, Function_22(&Param0 + 16, "AllowGestures", 1));
				}
				Param0.f_68 = 3;
			}
			else if (Function_83(&Param0 + 24, &Param0 + 16))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 1);
			...
			if (Param0.f_68 != 3 && !Function_90(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_6("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			bLocal_130 = true;
			Function_67(&Param0);
			Function_64(&Param0, Function_66(&Param0 + 16));
			if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
			{
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_90(Param0.f_64, 1);
			}
			bVar0 = Function_63(&Param0 + 24, &Param0 + 16, bVar29);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_53(&Param0, &uVar7, &iLocal_128, &uLocal_126);
				...
				if (Function_46(&Param0 + 16))
				{
					...
					{
						Function_70(&Param0 + 64, 8);
					}
					else
					{
						Function_52(&Param0 + 64, 8);
					}
					if (Function_90(Param0.f_64, 8))
					{
		...
		case 0x00000006:
			...
			bVar0 = Function_63(&Param0 + 24, &Param0 + 16, Function_90(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_32(var uParam0, int iParam1) //Position: 0x26CD / 9933
{
...
void Function_33(var uParam0, var uParam1) //Position: 0x26E4 / 9956
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	return;
...
bool Function_34() //Position: 0x26F6 / 9974
{
	bool bVar0;
...
void Function_35(var uParam0, int iParam1) //Position: 0x2729 / 10025
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_36(var uParam0, int iParam1) //Position: 0x27A7 / 10151
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_37(int iParam0, int iParam1) //Position: 0x2823 / 10275
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_38(int iParam0) //Position: 0x2835 / 10293
{
	return Function_26(&iParam0, "UseTime", 5.0f);
}

bool Function_39() //Position: 0x284C / 10316
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_40(int iParam0) //Position: 0x2859 / 10329
{
	return Function_26(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_41(int iParam0, bool bParam1) //Position: 0x287A / 10362
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_42(bool bParam0) //Position: 0x288D / 10381
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_43() //Position: 0x28AD / 10413
{
	return;
}

void Function_44(int iParam0, bool bParam1) //Position: 0x28B3 / 10419
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_45(char* cParam0) //Position: 0x28C5 / 10437
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_46(int iParam0) //Position: 0x28D2 / 10450
{
	return Function_22(&iParam0, "OneShotKill", 0);
}

bool Function_47(char* cParam0, int iParam1) //Position: 0x28ED / 10477
{
	return Function_24(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_48(int iParam0) //Position: 0x290D / 10509
{
	return Function_22(&iParam0, "LinkToParentAnim", 0);
}

var Function_49(int iParam0) //Position: 0x292D / 10541
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (vLocal_12 - 1))
	{
		if (&vLocal_12[iVar09] + 16 == &iParam0)
		{
			return &vLocal_12[iVar09] + 24;
		}
		iVar0++;
	}
	return &iVar1;
...
bool Function_50(int iParam0) //Position: 0x2964 / 10596
{
	return Function_22(&iParam0, "LinkParentToAnim", 0);
}

bool Function_51(int iParam0) //Position: 0x2984 / 10628
{
	return Function_22(&iParam0, "SingularUse", 0);
}

void Function_52(var uParam0, int iParam1) //Position: 0x299F / 10655
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_53(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x29B5 / 10677
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	PRINTNL();
	uVar2 = Function_61(&iParam0 + 16, &bVar0);
	uVar3 = Function_60(&iParam0 + 16, &bVar1);
	uVar4 = Function_59(&iParam0 + 16);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(&uVar4)))
	{
		uVar6 = Function_58(&iParam0 + 16, &bVar5);
		if (bVar5)
		{
			uVar8 = Function_57(&iParam0 + 16, &bVar7);
			if (!bVar7)
			{
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, &uVar3, Function_55(&iParam0 + 16, &iVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, Function_54(), Function_55(&iParam0 + 16, &iVar10), 0, bVar9);
	}
...
var Function_54() //Position: 0x2CD9 / 11481
{
	int iVar0;
...
bool Function_55(char* cParam0, int iParam1) //Position: 0x2CE2 / 11490
{
	return Function_24(&cParam0, "TargetLocator", &iParam1);
}

void Function_56() //Position: 0x2D01 / 11521
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_57(char* cParam0, int iParam1) //Position: 0x2D10 / 11536
{
	return Function_24(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_58(char* cParam0, int iParam1) //Position: 0x2D34 / 11572
{
	return Function_24(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_59(int iParam0) //Position: 0x2D5A / 11610
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_60(var uParam0, int iParam1) //Position: 0x2D78 / 11640
{
	return Function_24(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_61(var uParam0, int iParam1) //Position: 0x2D9A / 11674
{
	return Function_24(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_62(bool bParam0, int iParam1) //Position: 0x2DBC / 11708
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_63(var uParam0, int iParam1, bool bParam2) //Position: 0x2E84 / 11908
{
	int iVar0;
...
void Function_64(int iParam0, float fParam1) //Position: 0x2F00 / 12032
{
...
void Function_65(vector3 vParam0) //Position: 0x2F18 / 12056
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_70(&vParam0, 1);
	Function_52(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

var Function_66(int iParam0) //Position: 0x2F3D / 12093
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_26(&iParam0, "RandUseTime", 0.0f));
}

void Function_67(vector3 vParam0) //Position: 0x2F5E / 12126
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_68(var uParam0) //Position: 0x2F75 / 12149
{
	uParam0 = &uParam0;
	return;
}

int Function_69() //Position: 0x2F81 / 12161
{
	return 1;
}

void Function_70(var uParam0, int iParam1) //Position: 0x2F88 / 12168
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_71(int iParam0, var uParam1, int iParam2) //Position: 0x2F99 / 12185
{
	float fVar0;
	
	Function_74(&iParam0);
	uParam1 = Function_74(&iParam0);
	iParam2 = Function_73(&iParam0);
	fVar0 = Function_72(&iParam0);
	if (fVar0 < 180.0f)
	{
		fVar0 = 180.0f;
	}
...
int Function_72(int iParam0) //Position: 0x2FDE / 12254
{
	return Function_26(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_73(int iParam0) //Position: 0x300A / 12298
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_74(int iParam0) //Position: 0x3016 / 12310
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_75(int iParam0) //Position: 0x3118 / 12568
{
	return Function_22(&iParam0, "UsePosActorRelative", 0);
}

int Function_76(int iParam0) //Position: 0x313B / 12603
{
	return Function_26(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_77(int iParam0) //Position: 0x3163 / 12643
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	while (bVar7 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(&uVar8))
		{
			...
			{
				Function_79(StackVal, StackVal, Var2, Var11);
				Var2 = Function_79(StackVal, StackVal, Var2, Var11);
				Function_78(StackVal, StackVal, Var0, Var11);
				Var0 = Function_78(StackVal, StackVal, Var0, Var11);
			}
		}
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &fVar19, Function_54(), Var13, Vector(0.0f, 0.0f, 0.0f));
		...
		if (bVar22)
		{
			...
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_54(), Var28, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
...
struct<8> Function_78(vector3 vParam0) //Position: 0x344A / 13386
{
	struct<2> Var0;
...
struct<8> Function_79(vector3 vParam0) //Position: 0x34A7 / 13479
{
	struct<2> Var0;
...
void Function_80(int iParam0) //Position: 0x3504 / 13572
{
	iParam0 = &iParam0;
	return;
}

bool Function_81(int iParam0) //Position: 0x3510 / 13584
{
	return Function_22(&iParam0, "MaintainPosture", 0);
}

void Function_82(int iParam0) //Position: 0x352F / 13615
{
	if (!Function_29(&iParam0))
	{
...
bool Function_83(var uParam0, int iParam1) //Position: 0x3546 / 13638
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	...
	Function_74(&iParam1);
	Var0 = Function_74(&iParam1);
	bVar2 = Function_73(&iParam1);
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return 0;
	}
	...
	{
		return Function_87(&uParam0, &iParam1);
	}
	uVar3 = Function_86(&iParam1);
	uVar4 = Function_72(&iParam1);
	Function_84(&iParam1);
	iVar5 = Function_84(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, bVar2, uVar4, 0, 0);
}

struct<8> Function_84(int iParam0) //Position: 0x35D7 / 13783
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_85(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_85(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_85(var uParam0, var uParam1, struct<2> Param2) //Position: 0x35FB / 13819
{
	struct<2> Var0;
...
int Function_86(int iParam0) //Position: 0x361A / 13850
{
	return Function_26(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_87(var uParam0, int iParam1) //Position: 0x363E / 13886
{
	bool bVar0;
	float fVar1;
	var uVar2;
	...
	bVar0 = Function_86(&iParam1);
	fVar1 = Function_72(&iParam1);
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3766 / 14182
{
...
int Function_89(var uParam0) //Position: 0x3794 / 14228
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_90(var uParam0, int iParam1) //Position: 0x38AD / 14509
{
	return (uParam0 && iParam1) == 0;
}

void Function_91(struct<69> Param0) //Position: 0x38BA / 14522
{
	if (Function_90(Param0.f_64, 16))
	{
...
void Function_92(struct<69> Param0) //Position: 0x393C / 14652
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_90(Param0.f_64, 32)) && Function_22(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_98(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_90(Param0.f_64, 64));
		Function_32(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_22(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_90(Param0.f_64, 128) && Function_22(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_97(&Param0 + 16) && Function_90(Param0.f_64, 512))
			{
	...
	if (&Param0 + 16 == &iLocal_128)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_126));
		iLocal_128 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_51(&Param0 + 16))
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_94(&Param0 + 16), &Param0 + 16);
	}
...
void Function_93() //Position: 0x3EE7 / 16103
{
	int iVar0;
...
int Function_94(int iParam0) //Position: 0x3F21 / 16161
{
	return Function_26(&iParam0, "ReuseDelay", 15.0f);
}

void Function_95(int iParam0, var uParam1) //Position: 0x3F3F / 16191
{
	var uVar0;
	var uVar1;
	int iVar2;
	
	Function_61(&iParam0 + 16, &uVar0);
	Function_60(&iParam0 + 16, &uVar1);
	iVar2 = Function_59(&iParam0 + 16);
...
void Function_96(int iParam0) //Position: 0x3F80 / 16256
{
	iParam0 = &iParam0;
	return;
}

bool Function_97(int iParam0) //Position: 0x3F8C / 16268
{
	return Function_22(&iParam0, "BlockBumpReactions", 0);
}

void Function_98(int iParam0, int iParam1) //Position: 0x3FAE / 16302
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_99(var uParam0, bool bParam1) //Position: 0x3FC0 / 16320
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_100(int iParam0, int iParam1) //Position: 0x40D1 / 16593
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_101(struct<69> Param0) //Position: 0x40E9 / 16617
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	if (GRINGO_GET_USE_REQUIRES_OBSTACLE(&uVar0))
	{
		...
		ATTACH_OBJECTS(StackVal, StackVal, &Param0 + 56, &Param0 + 24, Function_54(), Vector(0.0f, 1.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	}
	Function_67(&Param0);
	Function_6("Going to eGringoPositioning", &Param0 + 24);
	Param0.f_68 = 2;
	Function_70(&Param0 + 64, 2);
	Function_52(&Param0 + 64, 8);
	Function_52(&Param0 + 64, 16);
	...
	if (Function_97(&Param0 + 16))
	{
		if (GET_ACTOR_ALLOW_BUMP_REACTIONS(&Param0 + 24))
		{
			Function_70(&Param0 + 64, 512);
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_102(&Param0 + 24, &uVar0);
	Function_6("START: ", &Param0 + 24);
	return;
}

void Function_102(int iParam0, int iParam1) //Position: 0x4405 / 17413
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_103(int iParam0) //Position: 0x4417 / 17431
{
	return Function_22(&iParam0, "DrawWeapon", 0);
}

bool Function_104(int iParam0) //Position: 0x4431 / 17457
{
	return Function_22(&iParam0, "AllowWeapon", 0);
}

void Function_105(int iParam0, var uParam1) //Position: 0x444C / 17484
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_106(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_106(var uParam0, int iParam1) //Position: 0x448A / 17546
{
	return Function_24(&uParam0, "UseName", &iParam1);
}

bool Function_107(struct<65> Param0) //Position: 0x44A3 / 17571
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_111(&uVar1, &Param0 + 16))
		{
		...
		if (!Function_90(Param0.f_64, 2))
		{
			...
			if (Function_90(Param0.f_64, 1))
			{
				Function_100("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				Function_74(&Param0 + 16);
				Var8 = Function_74(&Param0 + 16);
				Var10 = Vector(StackVal, StackVal, StackVal) - Vector(Var2, Var8, StackVal);
				fVar12 = Function_110(&Param0 + 16);
				bVar13 = VMAG(Var10);
				...
				if (!Function_109(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar30 = Function_108(&Param0 + 16);
				if (!bVar30 != 0.0f)
				{
					if (bVar30 < 0.0f)
					{
						fVar31 = (UNK_0x9C40E671(&Var10) - Function_73(&Param0 + 16));
					}
					else
					{
						fVar31 = ((180.0f + UNK_0x9C40E671(&Var10)) - Function_73(&Param0 + 16));
					}
					if (fVar31 < 180.0f)
					{
...
int Function_108(int iParam0) //Position: 0x479B / 18331
{
	return Function_26(&iParam0, "ActivationCone", 0.0f);
}

bool Function_109(var uParam0, int iParam1) //Position: 0x47B9 / 18361
{
	struct<5> Var0;
	float fVar5;
...
int Function_110(int iParam0) //Position: 0x4859 / 18521
{
	return Function_26(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_111(int iParam0, var uParam1) //Position: 0x4879 / 18553
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 0;
...
bool Function_112(int iParam0) //Position: 0x488C / 18572
{
...
void Function_113(int iParam0) //Position: 0x48A8 / 18600
{
	iParam0 = &iParam0;
	return;
}

void Function_114(var uParam0, int iParam1) //Position: 0x48B4 / 18612
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_115(&(vLocal_12[iLocal_1229]), &uParam0);
		iLocal_122++;
	}
...
void Function_115(int iParam0, int iParam1) //Position: 0x4920 / 18720
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_116(int iParam0) //Position: 0x4938 / 18744
{
	iParam0 = &iParam0;
	return;
}

void Function_117(int iParam0) //Position: 0x4944 / 18756
{
