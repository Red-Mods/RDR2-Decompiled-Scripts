...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 0, 0, "ped_bad_guys_generic", 5,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_31 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_111(&Param0 + 324, &fLocal_33, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_99(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_33, 20.0f, fLocal_33));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_36(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_34, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_10(int iParam0) //Position: 0x1684 / 5764
{
	if (!iLocal_30)
	{
...
void Function_11(var uParam0, int iParam1, bool bParam2) //Position: 0x16AF / 5807
{
	int iVar0;
	var uVar1;
...
void Function_12(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x172C / 5932
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_13(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1965 / 6501
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_14(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1985 / 6533
{
	int iVar0;
	var uVar1;
...
int Function_15(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x1A73 / 6771
{
	char* cVar0[32];
...
int Function_16(int iParam0) //Position: 0x1CDF / 7391
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_17(var uParam0, bool bParam1) //Position: 0x1D03 / 7427
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_18(var uParam0, int iParam1) //Position: 0x1D27 / 7463
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1D4D / 7501
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_20(var uParam0, bool bParam1) //Position: 0x1D74 / 7540
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_21(bool bParam0) //Position: 0x1D98 / 7576
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_22() //Position: 0x1DB7 / 7607
{
...
bool Function_23(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1E06 / 7686
{
	int iVar0;
	var uVar1;
...
bool Function_24(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1E62 / 7778
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_25(var uParam0, int iParam1) //Position: 0x1E83 / 7811
{
	int iVar0;
	var uVar1;
...
void Function_26(var uParam0, var uParam1, bool bParam2) //Position: 0x1EDE / 7902
{
	int iVar0;
	var uVar1;
...
var Function_27() //Position: 0x1F2A / 7978
{
...
void Function_28(struct<425> Param0) //Position: 0x1F3F / 7999
{
	int iVar0;
	int iVar1;
...
bool Function_29(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2092 / 8338
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_30(int iParam0) //Position: 0x2107 / 8455
{
	struct<2> Var0;
...
bool Function_31(vector3 vParam0) //Position: 0x2173 / 8563
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_32(var uParam0) //Position: 0x218B / 8587
{
	int iVar0;
	int iVar1;
...
var Function_33(bool bParam0) //Position: 0x21E9 / 8681
{
	bool bVar0;
	int iVar1;
...
void Function_34(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2236 / 8758
{
	int iVar0;
	var uVar1;
...
void Function_35(var uParam0, bool bParam1) //Position: 0x22AF / 8879
{
	int iVar0;
	var uVar1;
...
bool Function_36(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x22FE / 8958
{
	float fVar0;
...
void Function_37(int iParam0) //Position: 0x24C7 / 9415
{
...
void Function_38(int iParam0) //Position: 0x2504 / 9476
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x251D / 9501
{
	return (uParam0 && iParam1) == 0;
}

var Function_40(var uParam0, int iParam1) //Position: 0x252A / 9514
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_41(var uParam0) //Position: 0x261F / 9759
{
	struct<21> Var0;
...
bool Function_42() //Position: 0x26DE / 9950
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_43(struct<25> Param0) //Position: 0x26F1 / 9969
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_44(int iParam0) //Position: 0x27B8 / 10168
{
...
bool Function_45(int iParam0) //Position: 0x27D8 / 10200
{
...
bool Function_46(int iParam0) //Position: 0x27FC / 10236
{
...
bool Function_47(int iParam0) //Position: 0x2811 / 10257
{
...
bool Function_48(var uParam0, bool bParam1) //Position: 0x2828 / 10280
{
	int iVar0;
...
var Function_49(int iParam0) //Position: 0x2866 / 10342
{
...
bool Function_50(int iParam0) //Position: 0x2880 / 10368
{
...
int Function_51(int iParam0, struct<6> Param1) //Position: 0x2896 / 10390
{
	int iVar0;
...
void Function_52(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x28D0 / 10448
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_53(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x29B5 / 10677
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_54(var uParam0, bool bParam1) //Position: 0x2B6C / 11116
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_55(bool bParam0) //Position: 0x2B91 / 11153
{
	var uVar0;
	int iVar1;
...
var Function_56(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2BDF / 11231
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_57(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2D36 / 11574
{
	var uVar0[5];
	int iVar6;
...
int Function_58(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2DE1 / 11745
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_59(int iParam0, int iParam1) //Position: 0x2E87 / 11911
{
...
bool Function_60(var uParam0) //Position: 0x2EA2 / 11938
{
	var uVar0;
	...
	*(&iLocal_0 + 96) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(2,279573f, 0.0f, -1,022649f), Vector(0.0f, -136,8491f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 96), 0);
	*(&iLocal_0 + 104) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp1", "horse_stay", Vector(3,197684f, 0.0f, 1,874126f), Vector(0.0f, 185,144f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104), 0);
	*(&iLocal_0 + 112) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp2", "horse_stay", Vector(-0,402169f, 0.0f, 5,538029f), Vector(0.0f, 0.0f, 0.0f));
...
void Function_61(int iParam0, int iParam1) //Position: 0x3304 / 13060
{
	int iVar0;
...
var Function_62(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x334F / 13135
{
	int iVar0;
	int iVar1;
...
void Function_63(struct<13> Param0) //Position: 0x338D / 13197
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_64(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x33A0 / 13216
{
	int iVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x346F / 13423
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_66(struct<2>[] Param0) //Position: 0x34B9 / 13497
{
	int iVar0;
	int iVar1;
...
void Function_67() //Position: 0x387B / 14459
{
	if (!Function_118(128))
	{
		return;
...
bool Function_68() //Position: 0x38BB / 14523
{
	int iVar0;
...
void Function_69() //Position: 0x38E9 / 14569
{
	if (!Function_118(128))
	{
		return;
...
void Function_70(vector3 vParam0) //Position: 0x392B / 14635
{
	char* cVar0[32];
...
void Function_71(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x39C3 / 14787
{
	var uVar0;
	var uVar1;
...
void Function_72(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x39F2 / 14834
{
...
var Function_73(var uParam0, bool bParam1) //Position: 0x3A4D / 14925
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_74() //Position: 0x3A5D / 14941
{
	return "PackedGrass";
}

var Function_75(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3A71 / 14961
{
	int iVar0;
...
var Function_76() //Position: 0x3A96 / 14998
{
	return "PackedMetadata";
}

void Function_77(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3AAD / 15021
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_78() //Position: 0x3BE9 / 15337
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_79() //Position: 0x3BFB / 15355
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_80() //Position: 0x3C0D / 15373
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_81(var uParam0, struct<5> Param1) //Position: 0x3C1F / 15391
{
...
var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x3C44 / 15428
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x3C63 / 15459
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x3C6F / 15471
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x3C7A / 15482
{
	int iVar0;
...
var Function_86() //Position: 0x3CA8 / 15528
{
	return "PackedWeapon";
}

int Function_87(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3CBD / 15549
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_88() //Position: 0x3DCA / 15818
{
	return "MPItemGiver";
}

struct<32> Function_89(char* cParam0) //Position: 0x3DDE / 15838
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0) //Position: 0x3E4A / 15946
{
	char* cVar0[32];
...
var Function_91() //Position: 0x3E6C / 15980
{
	return "PBox_";
}

var Function_92() //Position: 0x3E7A / 15994
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x3EA0 / 16032
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x3EC8 / 16072
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3EEE / 16110
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, struct<2> Param2) //Position: 0x405A / 16474
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x4102 / 16642
{
	int iVar0;
	struct<2> Var1;
...
void Function_98(int iParam0) //Position: 0x4270 / 17008
{
...
var Function_99() //Position: 0x42D8 / 17112
{
	int iVar0;
...
var Function_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x42E1 / 17121
{
	return Function_101(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_101(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x42FF / 17151
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x45F8 / 17912
{
	int iVar0;
...
void Function_103() //Position: 0x46AC / 18092
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x46E7 / 18151
{
	int iVar0;
...
void Function_105(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4714 / 18196
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x486F / 18543
{
...
void Function_107() //Position: 0x4886 / 18566
{
	int iVar0;
...
var Function_108(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x48D2 / 18642
{
	int iVar0;
...
int Function_109() //Position: 0x49AE / 18862
{
	int iVar0;
...
int Function_110() //Position: 0x4B0A / 19210
{
	int iVar0;
...
bool Function_111(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4C2A / 19498
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_112(struct<2> Param0) //Position: 0x4D06 / 19718
{
	struct<2> Var0;
	int iVar2;
...
bool Function_113(struct<2> Param0, struct<5> Param2) //Position: 0x4D25 / 19749
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_114(var uParam0, struct<2> Param1) //Position: 0x4E68 / 20072
{
	struct<2> Var0;
...
bool Function_115(int iParam0) //Position: 0x4EDF / 20191
{
	var uVar0;
...
int Function_116() //Position: 0x4F01 / 20225
{
	return 0;
}

void Function_117(struct<321> Param0) //Position: 0x4F08 / 20232
{
	var uVar0;
...
bool Function_118(int iParam0) //Position: 0x4F9A / 20378
{
	int iVar0;
