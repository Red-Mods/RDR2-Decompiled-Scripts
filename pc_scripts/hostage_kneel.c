...
void main() //Position: 0x0 / 0
{
	...
	iLocal_82 = 0;
	Function_106(&uScriptParam_0, &iLocal_82);
			...
			if (iVar3 >= 4294967295)
			{
				...
				switch (GRINGO_GET_MESSAGE_TYPE())
				{
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", &vLocal_8[iVar39] + 24);
							Function_85(&vLocal_8[iVar39] + 24, 1);
							...
							{
								Function_78(&(vLocal_8[iVar39]), 0);
							}
							else if (vLocal_8[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_8[iVar39]));
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_88, &uLocal_86);
...
void Function_47(char* cParam0, int iParam1) //Position: 0x2504 / 9476
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_62(bool bParam0) //Position: 0x28AB / 10411
{
	...
	if (bLocal_0)
	{
		...
		{
			iLocal_1 = 1;
			uLocal_2 = CREATE_LAYOUT("Hostage_Kneel_Layout");
...
var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x2909 / 10505
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "HostageKneel_CutFree", 1, 1);
	}
...
void Function_64(Vector3 vParam0, var uParam1) //Position: 0x299A / 10650
{
	var uVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&vParam0, 0, 10.0f, 0);
	return;
}

void Function_65(float fParam0, struct<25> Param1) //Position: 0x29CA / 10698
{
	struct<2> Var0;
	...
	Var0 = Vector(1,085264f, 0,389518f, -1,189705f);
	...
	Var0 = Vector(0,717189f, -0,277447f, -0,639267f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
...
bool Function_67(int iParam0) //Position: 0x2A8F / 10895
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2AAE / 10926
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2AC5 / 10949
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2B56 / 11094
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B7A / 11130
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2B99 / 11161
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2BBD / 11197
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2CE5 / 11493
{
...
int Function_75(var uParam0) //Position: 0x2D13 / 11539
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2E2C / 11820
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2E39 / 11833
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2EBB / 11963
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3466 / 13414
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x34A0 / 13472
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x34BE / 13502
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x34FF / 13567
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x350B / 13579
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x352D / 13613
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Cut_Free", &iParam1) || GRINGO_COMPONENT_CHECK_NAME("nCut_Free1", &iParam1))
	{
		...
		if (bLocal_5)
		{
			ACTOR_SET_NEXT_WEAPON(&Global_54076, bLocal_4);
		}
	}
	return;
}

void Function_85(var uParam0, bool bParam1) //Position: 0x3592 / 13714
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x36A2 / 13986
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x36BA / 14010
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x39D6 / 14806
{
	iParam1 = &iParam1;
	bLocal_0 = false;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		if (Function_89(41))
		{
			...
			{
				if (GET_WEAPON_IN_HAND(&Global_54076) != 22)
				{
					bLocal_4 = GET_WEAPON_IN_HAND(&Global_54076);
					bLocal_5 = true;
...
bool Function_89(int iParam0) //Position: 0x3A25 / 14885
{
	int iVar0;
...
bool Function_90(int iParam0) //Position: 0x3A5B / 14939
{
...
bool Function_91(int iParam0) //Position: 0x3A7F / 14975
{
...
bool Function_92(int iParam0) //Position: 0x3A94 / 14996
{
...
var Function_93(int iParam0) //Position: 0x3AAB / 15019
{
	if (!Function_94(iParam0))
	{
		return 4294967295;
...
bool Function_94(int iParam0) //Position: 0x3AC5 / 15045
{
...
bool Function_95(int iParam0) //Position: 0x3ADB / 15067
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_96(int iParam0) //Position: 0x3AF5 / 15093
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_97(int iParam0, var uParam1) //Position: 0x3B10 / 15120
{
	bool bVar0;
	int iVar1;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x3B4E / 15182
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_99(struct<65> Param0) //Position: 0x3B67 / 15207
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_100(int iParam0) //Position: 0x3E5F / 15967
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_101(var uParam0, int iParam1) //Position: 0x3E7D / 15997
{
	struct<5> Var0;
	float fVar5;
...
int Function_102(int iParam0) //Position: 0x3F1D / 16157
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_103(int iParam0, var uParam1) //Position: 0x3F3D / 16189
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_104(int iParam0) //Position: 0x3F50 / 16208
{
...
void Function_105(int iParam0) //Position: 0x3F6C / 16236
{
	iParam0 = &iParam0;
	return;
}

void Function_106(var uParam0, int iParam1) //Position: 0x3F78 / 16248
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_107(&(vLocal_8[iLocal_829]), &uParam0);
		iLocal_82++;
	}
...
void Function_107(int iParam0, var uParam1) //Position: 0x3FE4 / 16356
{
	*(&iParam0 + 16) = &uParam1;
...
void Function_108(int iParam0) //Position: 0x4000 / 16384
{
	iParam0 = &iParam0;
	return;
}

void Function_109(int iParam0) //Position: 0x400C / 16396
{
