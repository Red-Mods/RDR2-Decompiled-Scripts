...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_23 = Vector(-2687,108f, 31,35223f, 4289,625f);
	uLocal_26 = Vector(-2688,031f, 31,35223f, 4290,049f);
	Local_29 = Vector(-2687,451f, 31,35223f, 4290,104f);
	iLocal_48 = 2;
	iLocal_49 = 4;
	fLocal_50 = 70.0f;
...
void Function_1(struct<473> Param0) //Position: 0xBB / 187
{
	bool bVar0;
...
void Function_2() //Position: 0x269 / 617
{
	Function_3();
	return;
}

void Function_3() //Position: 0x272 / 626
{
	if (IS_VOLUME_VALID(&uLocal_21))
	{
		if (DOES_AMBIENT_MOVE_RESTRICTION_VOLUME_EXIST(&uLocal_21))
		{
			REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_21);
		}
		if (DOES_AMBIENT_SPAWN_RESTRICTION_VOLUME_EXIST(&uLocal_21))
		{
			REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_21);
		}
	}
	if (IS_ACTOR_VALID(&uLocal_17))
	{
		if (DECOR_CHECK_EXIST(&uLocal_17, "bACTOR_AVOID_SMALLBRAINS"))
		{
			DECOR_REMOVE(&uLocal_17, "bACTOR_AVOID_SMALLBRAINS");
		}
	}
	RELEASE_LAYOUT_REF(&uLocal_44);
	Function_4(5, &uLocal_17, &iLocal_19, &uLocal_3, &uLocal_42, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x304 / 772
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x776 / 1910
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x7AA / 1962
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xAEC / 2796
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xB1F / 2847
{
...
void Function_9(int iParam0) //Position: 0xB36 / 2870
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xB62 / 2914
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xB7C / 2940
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB99 / 2969
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC5F / 3167
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xE28 / 3624
{
...
void Function_15(int iParam0) //Position: 0xE65 / 3685
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xE7E / 3710
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE8B / 3723
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xF80 / 3968
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xFE6 / 4070
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0x1048 / 4168
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0x107D / 4221
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x1296 / 4758
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x130D / 4877
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x1379 / 4985
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x13A1 / 5025
{
...
void Function_26(struct<13> Param0) //Position: 0x14EC / 5356
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x1509 / 5385
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x1527 / 5415
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_48 || bParam2) || Global_6611)
			{
				if (Function_147(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_145(&Param0 + 324, &fLocal_50, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_144();
								(*&Param0 + 48)[1] = Function_143();
								Function_142(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_142(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_135(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_135(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_142(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_142(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_135(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_135(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_135(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_142(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_134(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_50, 20.0f, fLocal_50));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_130(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_134(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_105(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_101(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_134(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_134(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_134(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_134()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_52 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_52) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_51, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x26E6 / 9958
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26F8 / 9976
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2931 / 10545
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2951 / 10577
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2A3F / 10815
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2CAB / 11435
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2CCF / 11471
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2CF3 / 11507
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2D19 / 11545
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2D40 / 11584
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2D64 / 11620
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2D83 / 11651
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2DD2 / 11730
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E2E / 11822
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2E4F / 11855
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2EAA / 11946
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2EF6 / 12022
{
...
void Function_46(struct<425> Param0) //Position: 0x2F0B / 12043
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x305E / 12382
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x30D3 / 12499
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x30EB / 12523
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x3149 / 12617
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3196 / 12694
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x320F / 12815
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x325E / 12894
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x331D / 13085
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3330 / 13104
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x33F7 / 13303
{
...
bool Function_57(int iParam0) //Position: 0x3417 / 13335
{
...
bool Function_58(int iParam0) //Position: 0x343B / 13371
{
...
bool Function_59(int iParam0) //Position: 0x3450 / 13392
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x3467 / 13415
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x34A5 / 13477
{
...
bool Function_62(int iParam0) //Position: 0x34BF / 13503
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x34D5 / 13525
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x350F / 13583
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_134(), bParam2[iVar0], Var1, Var3);
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x35F4 / 13812
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_134(), bParam3, Var2, Var4);
...
void Function_66(var uParam0, bool bParam1) //Position: 0x37AB / 14251
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x37D0 / 14288
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x381E / 14366
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3975 / 14709
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3A20 / 14880
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3AC6 / 15046
{
	...
	if (Function_79(&uLocal_17, &uLocal_3, 33, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (!IS_LAYOUTREF_VALID(&uLocal_42))
		{
			uLocal_42 = CREATE_LAYOUT("gun03campfirelayout");
		}
		if (!IS_VOLUME_VALID(&uLocal_21))
		{
			uLocal_21 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02");
			ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_21);
			ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_21);
			CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_21, 15);
			CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_21, 24);
			DEACTIVATE_ACTORS_FOR_PERS_CHARS_IN_VOLUME(&uLocal_21);
			RESET_PROPS_IN_VOLUME(&uLocal_21, 1);
		}
		uLocal_46 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Local_29, 0,25f, "chair05", 1);
		iLocal_32 = LOCATE_GRINGO_OF_TYPE("mex_drunk_sittable", &uLocal_23, 0,25f, 1);
		iLocal_36 = LOCATE_GRINGO_OF_TYPE("mex_drunk_sittable", &uLocal_26, 0,25f, 1);
		if (IS_PHYSINST_VALID(&uLocal_46))
		{
			if (IS_GRINGO_VALID(&iLocal_32))
			{
				if (!GET_CURRENT_GRINGO(&uLocal_17) != &iLocal_32 && !GET_TASK_STATUS(&uLocal_17, 19) != 1)
				{
					DECOR_SET_BOOL(&uLocal_17, "bACTOR_AVOID_SMALLBRAINS", 1);
					SNAP_ACTOR_TO_GRINGO(&uLocal_17, GET_OBJECT_FROM_GRINGO(&iLocal_32), "UseCase1", false, 0, 0);
					TASK_USE_GRINGO(&uLocal_17, &iLocal_32, "UseCase1", 4294967295, 1);
				}
				if (IS_GRINGO_VALID(&iLocal_36))
				{
					if (Function_77(&uLocal_44, "gun03mobile", &iParam1))
					{
						iLocal_19 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_44, Function_134()));
						*(&Global_6667[3328] + 216) = &iLocal_19;
						*(&iParam0 + 24) = &uLocal_44;
						Function_72();
						return 1;
					}
				}
...
void Function_72() //Position: 0x3CEA / 15594
{
	TASK_USE_GRINGO(&uLocal_17, &iLocal_32, "UseCase1", 4294967295, 1);
	iLocal_34 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, GET_OBJECT_FROM_PHYSINST(&uLocal_46), "gun03drunk", "mex_drunk_sittable", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)));
	uLocal_40 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "gun03emiliofriend", 651, Vector(-2689,277f, 32,753f, 4285,304f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uLocal_40, "bACTOR_AVOID_SMALLBRAINS", 1);
	if (&iLocal_36 == &iLocal_34 && &iLocal_36 == &iLocal_32)
	{
		SNAP_ACTOR_TO_GRINGO(&uLocal_40, GET_OBJECT_FROM_GRINGO(&iLocal_36), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&uLocal_40, &iLocal_36, "UseCase1", 4294967295, 1);
	}
	else
	{
		TASK_WANDER_IN_VOLUME(&uLocal_40, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02"), -1f);
		SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_40, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02"), 1, true);
	}
	uLocal_38 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "gun03emilio", 650, Vector(-2689,277f, 32,753f, 4285,304f), Vector(0.0f, 0.0f, 0.0f));
	Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_34));
	Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_32));
	Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_34));
	Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_36));
	if (StackVal && !Function_75(StackVal, !Function_75(StackVal, StackVal, Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_34)), Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_32))), Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_34)), Function_76(GET_OBJECT_FROM_GRINGO(&iLocal_36))))
	{
		SNAP_ACTOR_TO_GRINGO(&uLocal_38, GET_OBJECT_FROM_GRINGO(&iLocal_34), "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&uLocal_38, &iLocal_34, "UseCase1", 4294967295, 1);
	}
	else
	{
		TASK_WANDER_IN_VOLUME(&uLocal_38, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02"), -1f);
		SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_38, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02"), 1, true);
	}
	DECOR_SET_BOOL(&uLocal_38, "bACTOR_AVOID_SMALLBRAINS", 1);
	Function_73(&uLocal_17, &iLocal_19, 1, 1);
	Function_73(&uLocal_38, &iLocal_19, 1, 1);
	Function_73(&uLocal_40, &iLocal_19, 1, 1);
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3F6D / 16237
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x412C / 16684
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_75(struct<2> Param0, struct<2> Param2) //Position: 0x4174 / 16756
{
	struct<2> Var0;
...
struct<8> Function_76(bool bParam0) //Position: 0x41A0 / 16800
{
	struct<2> Var0;
...
bool Function_77(var uParam0, var uParam1, int iParam2) //Position: 0x41C9 / 16841
{
...
void Function_78(var uParam0, bool bParam1) //Position: 0x41F9 / 16889
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_134(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_79(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4244 / 16964
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_97(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_96(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	if (StackVal || !Function_92((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_96(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_94(iVar1))
		{
			if (Function_101(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_80(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_80(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4423 / 17443
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_91(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		if (&bParam6)
		{
			bVar1 = Function_88(&Global_15402[iParam014] + 16, &uParam7);
		}
		if (&bParam8)
		{
			bVar1 = Function_83(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_81(var uParam0, bool bParam1) //Position: 0x4963 / 18787
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_82(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4985 / 18821
{
	var uVar0;
...
var Function_83(bool bParam0, int iParam1) //Position: 0x49E6 / 18918
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_84(var uParam0, int iParam1) //Position: 0x4A74 / 19060
{
	Function_86(&uParam0);
	Function_85(&uParam0);
...
void Function_85(int iParam0) //Position: 0x4AA0 / 19104
{
...
void Function_86(int iParam0) //Position: 0x4AC6 / 19142
{
...
bool Function_87(bool bParam0) //Position: 0x4B9C / 19356
{
...
var Function_88(int iParam0, int iParam1) //Position: 0x4BB3 / 19379
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x4C59 / 19545
{
	var uVar0;
	var uVar1;
...
void Function_90(var uParam0) //Position: 0x4D68 / 19816
{
	int iVar0;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x4D9B / 19867
{
	int iVar0;
...
bool Function_92(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4DB8 / 19896
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_93() //Position: 0x4E44 / 20036
{
	var uVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x4EB4 / 20148
{
...
bool Function_95(int iParam0) //Position: 0x4ED0 / 20176
{
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4EE6 / 20198
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4F8C / 20364
{
	var uVar0;
	var uVar1;
...
var Function_98(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5097 / 20631
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_100(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_99(struct<13> Param0) //Position: 0x50D5 / 20693
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_100(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x50E8 / 20712
{
	int iVar0;
...
bool Function_101(struct<2>[] Param0) //Position: 0x51B7 / 20919
{
	int iVar0;
	int iVar1;
...
void Function_102() //Position: 0x5579 / 21881
{
	if (!Function_149(128))
	{
		return;
...
bool Function_103() //Position: 0x55B9 / 21945
{
	int iVar0;
...
void Function_104() //Position: 0x55E7 / 21991
{
	if (!Function_149(128))
	{
		return;
...
void Function_105(vector3 vParam0) //Position: 0x5629 / 22057
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_106(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_106(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_106(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x56C1 / 22209
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_107(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_107(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x56F0 / 22256
{
	Function_122(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_112(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_111(), Function_110(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_109(), Function_108(&uParam11, &uParam12));
}

var Function_108(var uParam0, bool bParam1) //Position: 0x574B / 22347
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_109() //Position: 0x575B / 22363
{
	return "PackedGrass";
}

var Function_110(bool bParam0, bool bParam1, bool bParam2) //Position: 0x576F / 22383
{
	int iVar0;
...
var Function_111() //Position: 0x5794 / 22420
{
	return "PackedMetadata";
}

void Function_112(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x57AB / 22443
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_121(), &uVar4))
				{
					Function_116(uVar4, &bVar5);
...
struct<8> Function_113() //Position: 0x58E7 / 22759
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_114() //Position: 0x58F9 / 22777
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_115() //Position: 0x590B / 22795
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_116(var uParam0, struct<5> Param1) //Position: 0x591D / 22813
{
	Param1 = Function_117(uParam0, Function_119(), 0);
	Param1.f_4 = Function_117(uParam0, Function_119() + 8, Function_119());
	return;
}

var Function_117(var uParam0, int iParam1, int iParam2) //Position: 0x5942 / 22850
{
	int iVar0;
...
var Function_118(bool bParam0) //Position: 0x5961 / 22881
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_119() //Position: 0x596D / 22893
{
	return Function_120(39);
}

int Function_120(int iParam0) //Position: 0x5978 / 22904
{
	int iVar0;
...
var Function_121() //Position: 0x59A6 / 22950
{
	return "PackedWeapon";
}

int Function_122(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x59BB / 22971
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_126(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(Function_126()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_123(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_123() //Position: 0x5AC8 / 23240
{
	return "MPItemGiver";
}

struct<32> Function_124(char* cParam0) //Position: 0x5ADC / 23260
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_125(char* cParam0) //Position: 0x5B48 / 23368
{
	char* cVar0[32];
...
var Function_126() //Position: 0x5B6A / 23402
{
	return "PBox_";
}

var Function_127() //Position: 0x5B78 / 23416
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_128() //Position: 0x5B9E / 23454
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_129() //Position: 0x5BC6 / 23494
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_130(var uParam0, int iParam1) //Position: 0x5BEC / 23532
{
	int iVar0;
	var uVar1;
...
void Function_131(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5D56 / 23894
{
	struct<8> Var0;
...
int Function_132(bool bParam0) //Position: 0x5DFE / 24062
{
	int iVar0;
	struct<2> Var1;
...
void Function_133(int iParam0) //Position: 0x5F6C / 24428
{
...
var Function_134() //Position: 0x5FD4 / 24532
{
	int iVar0;
...
var Function_135(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5FDD / 24541
{
	return Function_136(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_136(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5FFB / 24571
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_87(bVar1))
	{
		...
		{
			Function_140(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_137(int iParam0) //Position: 0x62F4 / 25332
{
	int iVar0;
...
void Function_138() //Position: 0x63A8 / 25512
{
	int iVar0;
...
bool Function_139(bool bParam0) //Position: 0x63E3 / 25571
{
	int iVar0;
...
void Function_140(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6410 / 25616
{
	int iVar0;
...
var Function_142(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x65B7 / 26039
{
	int iVar0;
...
int Function_143() //Position: 0x6693 / 26259
{
	int iVar0;
...
int Function_144() //Position: 0x67EF / 26607
{
	int iVar0;
...
bool Function_145(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x690F / 26895
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_146(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_146(struct<2> Param0) //Position: 0x69EB / 27115
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_147(struct<2> Param0, struct<5> Param2) //Position: 0x6A0A / 27146
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_148(int iParam0) //Position: 0x6B4D / 27469
{
	var uVar0;
...
bool Function_149(int iParam0) //Position: 0x6B6F / 27503
{
	int iVar0;
...
int Function_150() //Position: 0x6B8B / 27531
{
	return 0;
}

void Function_151(struct<321> Param0) //Position: 0x6B92 / 27538
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_100(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_100(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
