...
void main() //Position: 0x0 / 0
{
	...
	Function_8(&(Global_46972[5]), 1128, 8.0f, 30, 1, 0);
	...
	Function_8(&(Global_46972[5]), 1082, 5.0f, 33, 0, 0);
	Function_8(&(Global_46972[5]), 1084, 5.0f, 33, 0, 0);
	...
	Function_11(&(Global_46972[8]), 1012, 10.0f, 0, 0);
	Function_11(&(Global_46972[8]), 1009, 10.0f, 0, 0);
	Function_11(&(Global_46972[8]), 1010, 10.0f, 0, 0);
	Function_11(&(Global_46972[8]), 1011, 10.0f, 0, 0);
	Function_14(&(Global_46972[7]));
	Global_46972[7] = Function_13("animal_bird", 1);
	Function_8(&(Global_46972[7]), 1131, 2.0f, 15, 0, 0);
	Function_8(&(Global_46972[7]), 1135, 1.0f, 15, 0, 0);
	Function_8(&(Global_46972[7]), 1136, 1.0f, 15, 0, 0);
	Function_8(&(Global_46972[7]), 1136, 1.0f, 15, 0, 0);
	...
	Function_11(&(Global_46972[3]), 477, 1.0f, 1, 0);
	Function_11(&(Global_46972[3]), 478, 1.0f, 1, 0);
	Function_11(&(Global_46972[3]), 479, 1.0f, 1, 0);
	...
	Function_11(&(Global_46972[9]), 1183, 8.0f, 0, 0);
	...
	uVar1 = FIND_NAMED_LAYOUT("PikesBasin_layout");
	if (IS_LAYOUTREF_VALID(&uVar1))
	{
		uVar2 = FIND_VOLUME_IN_LAYOUT(&uVar1, "pikv_mainCamp");
		if (IS_VOLUME_VALID(&uVar2))
		{
			Function_3(&uVar2, &(Global_46972[8]), 0.0f, 0, 0, 1);
		}
		uVar2 = FIND_VOLUME_IN_LAYOUT(&uVar1, "pikv_birdVol");
		if (IS_VOLUME_VALID(&uVar2))
		{
			Function_3(&uVar2, &(Global_46972[7]), 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("PIK_Pop: Cannot find pikv_birdVol to create bird volumes");
		}
		uVar2 = FIND_VOLUME_IN_LAYOUT(&uVar1, "pik_null");
		if (IS_VOLUME_VALID(&uVar2))
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xC9C / 3228
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCAD / 3245
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD05 / 3333
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD95 / 3477
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xDB1 / 3505
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDF1 / 3569
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xE0E / 3598
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xE1F / 3615
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xE9D / 3741
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xF09 / 3849
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF75 / 3957
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xFF7 / 4087
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, int iParam1) //Position: 0x103E / 4158
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_14(int iParam0) //Position: 0x104D / 4173
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

void Function_15(char* cParam0) //Position: 0x105A / 4186
{
	if (!Function_4(128))
	{
		return;
