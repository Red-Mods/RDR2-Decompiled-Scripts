...
void Function_51(int iParam0, var uParam1, var uParam2) //Position: 0x2B14 / 11028
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_52(var uParam0, int iParam1) //Position: 0x2BB1 / 11185
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_53(char* cParam0, var uParam1, int iParam2) //Position: 0x2C79 / 11385
{
	int iVar0;
	int iVar1;
...
var Function_54(int iParam0) //Position: 0x2CC9 / 11465
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_55(int iParam0) //Position: 0x2CE0 / 11488
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CF7 / 11511
{
	float fVar0;
	float fVar1;
	var uVar2;
	...
	fVar0 = GET_ACTOR_HEALTH(&uParam1);
	fVar1 = GET_ACTOR_MAX_HEALTH(&uParam1);
	iVar3 = 0;
	iParam2 = 0;
	bVar4 = false;
	if (IS_ACTOR_VALID(&uParam1) && fVar0 > fVar1)
	{
		uVar2 = GET_GRINGO_STRING_ATTR("myItemString", &uParam0, &iVar3);
		if (GET_GRINGO_FLOAT_ATTR(&fVar5, "HitPointsCuredPercent", &uParam0))
		{
			fVar6 = ((fVar1 * fVar5) / 100.0f);
			fVar0 = (fVar0 + fVar6);
			if (fVar0 < fVar1)
			{
				fVar0 = fVar1;
			}
			SET_ACTOR_HEALTH(&uParam1, fVar0);
			if (((Function_62(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
			{
				iLocal_4 = 0;
			}
			if (STRING_CONTAINS_STRING(&uVar2, "nMeds_Lvl1"))
			{
				Function_60(480, 1, 0, 0);
				if (Function_59())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 3), &Global_54076))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 3), &Global_54076);
					}
					PLAYSTAT_INT("HC_MEDS", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(&uVar2, "Edible_Meat"))
			{
				Function_60(485, 1, 0, 0);
				if (Function_59())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 4), &Global_54076))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 4), &Global_54076);
					}
					PLAYSTAT_INT("HC_VITTLES", bVar4);
				}
			}
			iParam2 = 1;
		}
		...
		{
			LOG_ERROR("ITEM_MEDS SCRIPT: Cannot find attrib HitPointsCuredPercent");
		}
	}
	else
	{
		Function_57("user_full_health", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 0;
	}
	return;
}

void Function_57(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2ED4 / 11988
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x2F5F / 12127
{
	char* cVar0[16];
...
bool Function_59() //Position: 0x2F9E / 12190
{
...
int Function_60(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2FC9 / 12233
{
	int iVar0;
	int iVar1;
...
void Function_61(int iParam0) //Position: 0x31F1 / 12785
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_62(int iParam0, bool bParam1, bool bParam2) //Position: 0x328F / 12943
{
...
bool Function_63() //Position: 0x3353 / 13139
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_64(int iParam0) //Position: 0x336A / 13162
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_65(int iParam0) //Position: 0x3376 / 13174
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_66(int iParam0) //Position: 0x3385 / 13189
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_67(int iParam0, int iParam1) //Position: 0x33A0 / 13216
{
	var uVar0;
	var uVar1;
