...
void main() //Position: 0x0 / 0
{
	...
	iLocal_3 = 33;
	iLocal_4 = 1;
	Local_17 = Vector(-68,16f, 127,217f, 1371,621f);
	iLocal_20 = 2;
	iLocal_21 = 4;
	fLocal_22 = 70.0f;
...
{
	Function_24();
	Function_4(12, &uLocal_11, &uLocal_13, &uLocal_5, &uLocal_15, 53);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x267 / 615
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6D9 / 1753
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x70D / 1805
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA4F / 2639
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA82 / 2690
{
...
void Function_9(int iParam0) //Position: 0xA99 / 2713
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAC5 / 2757
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xADF / 2783
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAFC / 2812
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBC2 / 3010
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD8B / 3467
{
...
void Function_15(int iParam0) //Position: 0xDC8 / 3528
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDE1 / 3553
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDEE / 3566
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xEE3 / 3811
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF49 / 3913
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFAB / 4011
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFE0 / 4064
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11F9 / 4601
{
	struct<2> Var0;
...
struct<8> Function_23(var uParam0) //Position: 0x1270 / 4720
{
	struct<2> Var0;
...
void Function_24() //Position: 0x12DC / 4828
{
	RELEASE_LAYOUT_REF(&uLocal_0);
	return;
}

void Function_25(int iParam0) //Position: 0x12E8 / 4840
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x1310 / 4880
{
...
void Function_27(struct<13> Param0) //Position: 0x145B / 5211
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x1478 / 5240
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x1496 / 5270
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_20 || bParam2) || Global_6611)
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_22, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_22, 20.0f, fLocal_22));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_23, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x2655 / 9813
{
...
void Function_31(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2667 / 9831
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_32(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x28A0 / 10400
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_33(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28C0 / 10432
{
	bool bVar0;
	var uVar1;
...
int Function_34(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x29AE / 10670
{
	char* cVar0[32];
...
int Function_35(int iParam0) //Position: 0x2C1A / 11290
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_36(var uParam0, bool bParam1) //Position: 0x2C3E / 11326
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2C62 / 11362
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C88 / 11400
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2CAF / 11439
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_40(bool bParam0) //Position: 0x2CD3 / 11475
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_41() //Position: 0x2CF2 / 11506
{
...
bool Function_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D41 / 11585
{
	bool bVar0;
	var uVar1;
...
bool Function_43(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D9D / 11677
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2DBE / 11710
{
	bool bVar0;
	var uVar1;
...
void Function_45(var uParam0, var uParam1, bool bParam2) //Position: 0x2E19 / 11801
{
	bool bVar0;
	var uVar1;
...
var Function_46() //Position: 0x2E65 / 11877
{
...
void Function_47(struct<425> Param0) //Position: 0x2E7A / 11898
{
	bool bVar0;
	bool bVar1;
...
bool Function_48(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FCD / 12237
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
bool Function_49(vector3 vParam0) //Position: 0x3042 / 12354
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_50(var uParam0) //Position: 0x305A / 12378
{
	bool bVar0;
	int iVar1;
...
var Function_51(bool bParam0) //Position: 0x30B8 / 12472
{
	bool bVar0;
	bool bVar1;
...
void Function_52(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x3105 / 12549
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x317E / 12670
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0) //Position: 0x31CD / 12749
{
	struct<21> Var0;
...
bool Function_55() //Position: 0x328C / 12940
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_56(struct<25> Param0) //Position: 0x329F / 12959
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_57(int iParam0) //Position: 0x3366 / 13158
{
...
bool Function_58(int iParam0) //Position: 0x3386 / 13190
{
...
bool Function_59(int iParam0) //Position: 0x33AA / 13226
{
...
bool Function_60(int iParam0) //Position: 0x33BF / 13247
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x33D6 / 13270
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3414 / 13332
{
...
bool Function_63(int iParam0) //Position: 0x342E / 13358
{
...
int Function_64(int iParam0, struct<6> Param1) //Position: 0x3444 / 13380
{
	int iVar0;
...
void Function_65(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x347E / 13438
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_66(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3563 / 13667
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_67(var uParam0, bool bParam1) //Position: 0x371A / 14106
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_68(bool bParam0) //Position: 0x373F / 14143
{
	var uVar0;
	int iVar1;
...
var Function_69(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x378D / 14221
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_70(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38E4 / 14564
{
	var uVar0[5];
	int iVar6;
...
int Function_71(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x398F / 14735
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3A35 / 14901
{
	iParam1 = &iParam1;
	if (Function_79(&uLocal_11, &uLocal_5, 53, 0, 0, 0, 0, 0, 0, 0, 0))
	{
		if (Function_76(&iParam1))
		{
			uLocal_13 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_0, Function_132()));
...
void Function_73() //Position: 0x3A8C / 14988
{
	uLocal_15 = CREATE_LAYOUT("home02son03campfirelayout");
	DELETE_ALL_WEAPONS_FROM_ACTOR(&uLocal_11);
	AI_IGNORE_ACTOR(&uLocal_11);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_11, Local_17, 15.0f, 1, 1, 1);
	TASK_STAND_STILL(false, -1.0f, 0, 0);
	Function_74(&uLocal_11, &uLocal_13, 1, 1);
	SET_DRAW_ACTOR(&uLocal_11, 0);
	return;
}

void Function_74(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3AEB / 15083
{
	bool bVar0;
	int iVar1;
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x3CA8 / 15528
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_76(var uParam0) //Position: 0x3CF0 / 15600
{
	var uVar0;
	
	Function_78(3, 2);
	uVar0 = &uVar0;
	uLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("home02son_camp03_mobile"));
	Function_77(&uLocal_0, &uParam0);
	return 1;
}

void Function_77(int iParam0, var uParam1) //Position: 0x3D2E / 15662
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &uParam1, Function_132(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
void Function_78(int iParam0, bool bParam1) //Position: 0x3D79 / 15737
{
	switch (&bParam1)
	{
		case 0x00000000:
...
bool Function_79(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3DC3 / 15811
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_80(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3FA2 / 16290
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_81(var uParam0, bool bParam1) //Position: 0x44E3 / 17635
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_82(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4505 / 17669
{
	var uVar0;
...
var Function_83(bool bParam0, int iParam1) //Position: 0x4566 / 17766
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_84(var uParam0, int iParam1) //Position: 0x45F4 / 17908
{
	Function_86(&uParam0);
	Function_85(&uParam0);
...
void Function_85(int iParam0) //Position: 0x4620 / 17952
{
...
void Function_86(int iParam0) //Position: 0x4646 / 17990
{
...
bool Function_87(bool bParam0) //Position: 0x471C / 18204
{
...
var Function_88(int iParam0, int iParam1) //Position: 0x4733 / 18227
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x47D9 / 18393
{
	var uVar0;
	var uVar1;
...
void Function_90(var uParam0) //Position: 0x48E8 / 18664
{
	int iVar0;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x491B / 18715
{
	int iVar0;
...
bool Function_92(var uParam0, struct<2> Param1, float fParam3) //Position: 0x4938 / 18744
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_23(&uParam0);
...
void Function_93() //Position: 0x49C4 / 18884
{
	var uVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x4A34 / 18996
{
...
bool Function_95(int iParam0) //Position: 0x4A50 / 19024
{
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4A66 / 19046
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4B0C / 19212
{
	var uVar0;
	var uVar1;
...
bool Function_98(struct<2>[] Param0) //Position: 0x4C17 / 19479
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x4FD9 / 20441
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x5019 / 20505
{
	int iVar0;
...
void Function_101(struct<13> Param0) //Position: 0x5047 / 20551
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_102() //Position: 0x505A / 20570
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x509C / 20636
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5134 / 20788
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5163 / 20835
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x51BE / 20926
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x51CE / 20942
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x51E2 / 20962
{
	int iVar0;
...
var Function_109() //Position: 0x5207 / 20999
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x521E / 21022
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x535A / 21338
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x536C / 21356
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x537E / 21374
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x5390 / 21392
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x53B5 / 21429
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x53D4 / 21460
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x53E0 / 21472
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x53EB / 21483
{
	int iVar0;
...
var Function_119() //Position: 0x5419 / 21529
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x542E / 21550
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x553B / 21819
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x554F / 21839
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x55BB / 21947
{
	char* cVar0[32];
...
var Function_124() //Position: 0x55DD / 21981
{
	return "PBox_";
}

var Function_125() //Position: 0x55EB / 21995
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x5611 / 22033
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x5639 / 22073
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x565F / 22111
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x57C9 / 22473
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5871 / 22641
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x59DF / 23007
{
...
var Function_132() //Position: 0x5A47 / 23111
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5A50 / 23120
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5A6E / 23150
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5D67 / 23911
{
	int iVar0;
...
void Function_136() //Position: 0x5E1B / 24091
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5E56 / 24150
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x5E83 / 24195
{
	int iVar0;
...
void Function_139() //Position: 0x5FDE / 24542
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x602A / 24618
{
	int iVar0;
...
int Function_141() //Position: 0x6106 / 24838
{
	int iVar0;
...
int Function_142() //Position: 0x6262 / 25186
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6382 / 25474
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x645E / 25694
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x647D / 25725
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x65C0 / 26048
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x65E2 / 26082
{
	int iVar0;
...
int Function_148() //Position: 0x65FE / 26110
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x6605 / 26117
{
	var uVar0;
...
var Function_150(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6697 / 26263
{
	int iVar0;
