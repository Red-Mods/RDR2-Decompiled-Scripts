...
void main() //Position: 0x0 / 0
{
	...
	iLocal_120 = 0;
	Function_101(&uScriptParam_0, &iLocal_120);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(vLocal_10[iVar39]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_10[iVar39] + 16);
							bVar5 = true;
						}
						break;
...
void Function_2(bool bParam0, char* cParam1) //Position: 0x499 / 1177
{
	var uVar0;
...
int Function_3() //Position: 0x4DB / 1243
{
	return 2000;
}

int Function_4(int iParam0) //Position: 0x4E4 / 1252
{
	iParam0 = &iParam0;
	return 0;
}

void Function_5(struct<69> Param0) //Position: 0x4F1 / 1265
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_6(int iParam0) //Position: 0x825 / 2085
{
	bool bVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_7(bool bParam0, var uParam1, int iParam2) //Position: 0x93E / 2366
{
	int iVar0;
	bool bVar1;
...
bool Function_8(char* cParam0, int iParam1) //Position: 0x95C / 2396
{
	return Function_9(&cParam0, "UseQuit", &iParam1);
}

bool Function_9(char* cParam0, char* cParam1, int iParam2) //Position: 0x975 / 2421
{
	int iVar0;
	int iVar1;
...
float Function_10(int iParam0) //Position: 0x9C5 / 2501
{
	return Function_11(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(bool bParam0, var uParam1, int iParam2) //Position: 0x9E3 / 2531
{
	int iVar0;
...
float Function_12(vector3 vParam0) //Position: 0x9FB / 2555
{
...
bool Function_13(int iParam0) //Position: 0xAC8 / 2760
{
	return Function_77(iParam0, 2);
}

bool Function_14(int iParam0) //Position: 0xAD6 / 2774
{
	return Function_77(iParam0, 1);
}

bool Function_15(int iParam0, int iParam1) //Position: 0xAE4 / 2788
{
	bool bVar0;
...
bool Function_16(struct<69> Param0) //Position: 0xB31 / 2865
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_77(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_17(var uParam0, int iParam1) //Position: 0x1E66 / 7782
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1E7D / 7805
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	return;
...
bool Function_19() //Position: 0x1E8F / 7823
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1EC2 / 7874
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1F40 / 8000
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x1FBC / 8124
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1FCE / 8142
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1FE5 / 8165
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1FF2 / 8178
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(bool bParam0, int iParam1) //Position: 0x2013 / 8211
{
	iParam1 = &iParam1;
		...
		if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(&bParam0), "DECOR_TICKET"))
		{
			if (IS_ACTOR_PLAYING_NODE_IN_TREE(&bParam0, "train_sit/Player/ride"))
			{
				if (!DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(&bParam0), "nTRAIN_NAP"))
				{
					...
					{
						uLocal_4 = ADD_SCRIPT_USE_CONTEXT("train_take_nap", true, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
					}
					else if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(&uLocal_4))
					{
...
bool Function_27(bool bParam0) //Position: 0x2107 / 8455
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x2127 / 8487
{
	return;
}

void Function_29(var uParam0, bool bParam1) //Position: 0x212D / 8493
{
	bParam1 = &bParam1;
	if (!IS_ATTACHMENT_VALID(&iLocal_2))
	{
...
bool Function_30(char* cParam0) //Position: 0x2153 / 8531
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2160 / 8544
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x217B / 8571
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x219B / 8603
{
...
bool Function_35(int iParam0) //Position: 0x21F2 / 8690
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2212 / 8722
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x222D / 8749
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2243 / 8771
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2567 / 9575
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2570 / 9584
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x258F / 9615
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x259E / 9630
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x25C2 / 9666
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x25E8 / 9704
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2606 / 9734
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2628 / 9768
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x264A / 9802
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2712 / 10002
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x278E / 10126
{
...
void Function_50(vector3 vParam0) //Position: 0x27A6 / 10150
{
...
var Function_51(int iParam0) //Position: 0x27CB / 10187
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x27EC / 10220
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2803 / 10243
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x280F / 10255
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2816 / 10262
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2827 / 10279
{
	bool bVar0;
...
int Function_57(int iParam0) //Position: 0x286C / 10348
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2898 / 10392
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x28A4 / 10404
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x29A6 / 10662
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x29C9 / 10697
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x29F1 / 10737
{
	var uVar4;
	
	bParam0 = &bParam0;
	if (iLocal_9 && !iLocal_8)
	{
		iLocal_8 = 1;
		Function_66(&Global_54076);
		uVar4 = LOCATE_ACTOR_OF_TYPE(Function_66(&Global_54076), 30.0f, 4294967295, 1165);
		uLocal_6 = CREATE_LAYOUT("TrainSit_Layout");
		Function_63(&uLocal_6, 0, &uVar4, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2A45 / 10821
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "SitTrain_Right", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x2AD0 / 10960
{
	var uVar0;
	int iVar1;
	...
	iVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&uParam0, 0, 4.0f, 0);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(&iVar1, 5.0f, 1, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(&uParam0, 0, 1);
	return;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2B11 / 11025
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &uParam0, &iParam1, Vector(0.0f, 3,014539f, -7,118135f), Vector(-19,51769f, -178,952f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
...
struct<8> Function_66(int iParam0) //Position: 0x2BA8 / 11176
{
	struct<2> Var0;
...
void Function_67(int iParam0) //Position: 0x2BD1 / 11217
{
	iParam0 = &iParam0;
	return;
}

bool Function_68(int iParam0) //Position: 0x2BDD / 11229
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2BFC / 11260
{
	if (!Function_14(&iParam0))
	{
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2C13 / 11283
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_71(int iParam0) //Position: 0x2CA4 / 11428
{
	struct<2> Var0;
...
struct<8> Function_72(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2CC8 / 11464
{
	struct<2> Var0;
...
int Function_73(int iParam0) //Position: 0x2CE7 / 11495
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(var uParam0, int iParam1) //Position: 0x2D0B / 11531
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2E33 / 11827
{
...
int Function_76(var uParam0) //Position: 0x2E61 / 11873
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2F7A / 12154
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(struct<69> Param0) //Position: 0x2F87 / 12167
{
	if (Function_77(Param0.f_64, 16))
	{
...
void Function_79(struct<69> Param0) //Position: 0x3009 / 12297
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x35B4 / 13748
{
	int iVar0;
...
int Function_81(int iParam0) //Position: 0x35EE / 13806
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_82(int iParam0, var uParam1) //Position: 0x360C / 13836
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_83(int iParam0) //Position: 0x364D / 13901
{
	iParam0 = &iParam0;
	return;
}

bool Function_84(int iParam0) //Position: 0x3659 / 13913
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_85(var uParam0, int iParam1) //Position: 0x367B / 13947
{
	iParam1 = &iParam1;
	...
	{
		DESTROY_LAYOUT_OBJECTS(&uLocal_6);
		DESTROY_LAYOUT(&uLocal_6);
	}
	return;
}

void Function_86(var uParam0, bool bParam1) //Position: 0x36B3 / 14003
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_87(int iParam0, int iParam1) //Position: 0x37C3 / 14275
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_88(struct<69> Param0) //Position: 0x37DB / 14299
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x3AF7 / 15095
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_90(int iParam0) //Position: 0x3B0F / 15119
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_91(int iParam0) //Position: 0x3B29 / 15145
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, var uParam1) //Position: 0x3B44 / 15172
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3B82 / 15234
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_94(struct<65> Param0) //Position: 0x3B9B / 15259
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_95(int iParam0) //Position: 0x3E93 / 16019
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3EB1 / 16049
{
	struct<5> Var0;
	float fVar5;
...
int Function_97(int iParam0) //Position: 0x3F51 / 16209
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(int iParam0, var uParam1) //Position: 0x3F71 / 16241
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3F84 / 16260
{
...
void Function_100(int iParam0) //Position: 0x3FA0 / 16288
{
	iParam0 = &iParam0;
	return;
}

void Function_101(var uParam0, int iParam1) //Position: 0x3FAC / 16300
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_102(&(vLocal_10[iLocal_1209]), &uParam0);
		iLocal_120++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x401A / 16410
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_103(var uParam0) //Position: 0x4032 / 16434
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_104(bool bParam0) //Position: 0x40A8 / 16552
{
