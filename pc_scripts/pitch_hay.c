...
void Function_65(int iParam0) //Position: 0x2C46 / 11334
{
	...
	while (bVar0 >= 4294967295)
	{
		...
		UNK_0x6BA667B5(&uVar1);
		bVar0 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, &iParam0, bVar0 + 1);
	}
	return;
}

bool Function_66(int iParam0) //Position: 0x2C97 / 11415
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CB6 / 11446
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CCD / 11469
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D5E / 11614
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D82 / 11650
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2DA1 / 11681
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2DC5 / 11717
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EED / 12013
{
...
int Function_74(var uParam0) //Position: 0x2F1B / 12059
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3034 / 12340
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3041 / 12353
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30C3 / 12483
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x366E / 13934
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x36A8 / 13992
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x36C6 / 14022
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3707 / 14087
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3713 / 14099
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x3735 / 14133
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3747 / 14151
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3857 / 14423
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x386F / 14447
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B8B / 15243
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3B9D / 15261
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3BB7 / 15287
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3BD2 / 15314
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C10 / 15376
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C29 / 15401
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F21 / 16161
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F3F / 16191
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(var uParam0) //Position: 0x3FDF / 16351
{
	return Function_11(&uParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4000 / 16384
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x4013 / 16403
{
...
void Function_98(int iParam0) //Position: 0x402F / 16431
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x403B / 16443
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x40A7 / 16551
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x40BF / 16575
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x40CB / 16587
{
