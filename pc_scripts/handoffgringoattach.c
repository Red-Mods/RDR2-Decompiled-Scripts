...
void main() //Position: 0x0 / 0
{
	...
	iLocal_115 = 0;
	Function_97(&uScriptParam_0, &iLocal_115);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(vLocal_5[iVar39]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_5[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", &vLocal_5[iVar39] + 24);
							Function_82(&vLocal_5[iVar39] + 24, 1);
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	{
		iLocal_4 = 1;
		bLocal_2 = Function_63(GRINGO_GET_MY_OBJECT_REF(), 0, &Global_54076, 1, 0, 0);
		CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&bLocal_2, 0, 9.0f, 4294967295);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28D9 / 10457
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "handoff_cutscene", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2959 / 10585
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x2988 / 10632
{
	...
	SET_CAMERASHOT_FAR_CLIP_PLANE(&iParam0, 2800.0f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(0,776195f, 1,958444f, 1,22306f), Vector(-16,60814f, 25,83153f, 0,000145f), Vector(0.0f, 0.0f, 0.0f), 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &iParam1, 0);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(-0,033495f, 1,404306f, -0,449202f), Vector(0.0f, 0.0f, 0.0f), 0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A2E / 10798
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A3A / 10810
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A59 / 10841
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A70 / 10864
{
	struct<2> Var0;
	bool bVar2;
	bool bVar3;
	...
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		TELEPORT_ACTOR_WITH_HEADING(&uParam0, Var0, bVar2, 1, 1, 1);
		return 1;
	}
	bVar3 = Function_70(&iParam1);
	fVar4 = Function_57(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &Var0, bVar3, 0,2f, 1, bVar2, fVar4, 0, 0);
}

int Function_70(int iParam0) //Position: 0x2AC7 / 10951
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

bool Function_71(var uParam0, int iParam1) //Position: 0x2AEB / 10987
{
...
int Function_72(var uParam0) //Position: 0x2B19 / 11033
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2C32 / 11314
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2C3F / 11327
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2CC1 / 11457
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x326C / 12908
{
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
...
int Function_77(int iParam0) //Position: 0x3285 / 12933
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x32A3 / 12963
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x32E4 / 13028
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x32F0 / 13040
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(int iParam0, int iParam1) //Position: 0x3312 / 13074
{
	DECOR_SET_BOOL(&iParam0, "bIsFinished", 1);
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
}

void Function_82(var uParam0, bool bParam1) //Position: 0x333A / 13114
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x344A / 13386
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3462 / 13410
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x377E / 14206
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x3790 / 14224
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x37AA / 14250
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x37C5 / 14277
{
	bool bVar0;
	var uVar1;
	...
	if (DECOR_CHECK_EXIST(&iParam0, "handoffAmmo"))
	{
		if (DECOR_GET_BOOL(&iParam0, "handoffAmmo"))
		{
...
int Function_89(var uParam0, int iParam1) //Position: 0x3837 / 14391
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3850 / 14416
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3B48 / 15176
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3B66 / 15206
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C06 / 15366
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3C26 / 15398
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3C39 / 15417
{
...
void Function_96(int iParam0) //Position: 0x3C55 / 15445
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3C61 / 15457
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_98(&(vLocal_5[iLocal_1159]), &uParam0);
		iLocal_115++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3CCD / 15565
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3CE5 / 15589
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3CF1 / 15601
{
