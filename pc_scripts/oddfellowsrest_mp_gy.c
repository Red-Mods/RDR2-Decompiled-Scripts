...
void Function_151(char* cParam0, bool bParam1) //Position: 0x49D6 / 18902
{
	bool bVar0;
...
int Function_195() //Position: 0x54CB / 21707
{
	...
	if (iLocal_566 != 99)
	{
		...
		Function_205(&uLocal_337, &bLocal_106, 2, &uLocal_339);
		Function_196(StackVal, (bLocal_281 <= 12 || Local_988.f_52), &iLocal_292, &bLocal_106, *(&bLocal_106 + 24), 2);
	}
	return bVar0;
}
...
bool Function_216(struct<2> Param0, int iParam2, bool bParam3, float fParam4) //Position: 0x5D5F / 23903
{
	...
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &bParam3, Function_56(), 4,203895E-45f, Param0, Vector(0.0f, 0.0f, 0.0f), Vector(&fParam4, 20.0f, &fParam4));
	...
	if (Function_342(&Param0) && !IS_SCRIPT_VALID(&Global_123163 + 40))
	{
		if (Param0 < 1 && Param0 > 8)
		{
			...
			else if (!(Function_47(Param0.f_80, 2) || Function_47(Param0.f_80, 128)))
			{
				...
				{
					(&Param0 + 152) = ADD_SCRIPT_USE_CONTEXT("net_respawn_button", false, "@UI.ACCEPT", 0, 0, 0, 0, 4294967295, 0);
				}
...
void Function_377(int iParam0, bool bParam1) //Position: 0xBAC5 / 47813
{
	*(&iParam0 + 72) = &bParam1;
	return;
}

void Function_378(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0xBAD4 / 47828
{
	int iVar0;
...
int Function_379() //Position: 0xBB58 / 47960
{
	var uVar0;
	...
	switch (Local_576)
	{
			...
			if (Function_431(&iLocal_1078))
			{
				...
				else
				{
					*(&Local_576 + 24) = Function_420(&bLocal_106, 0, &bLocal_106, 1, 0, 0);
					...
					{
						LOG_ERROR("OddFellowsRest_GY_cutsceneFinal - Failed to create mp_gy_OddFellowsRest_outro_cutscene");
					}
				}
				Local_576 = 1001;
			}
		...
		case 0x000003EC:
			if (Function_382(&iLocal_1078, 52468) && GET_CUTSCENEOBJECT_SEQUENCE(&Local_576 + 24) != 2)
			{
				Function_430(&Local_576 + 4);
				Function_381();
				Local_576 = 1104;
...
void Function_380() //Position: 0xBD84 / 48516
{
	Function_50(2, 0, 1, 0, 1, 0, 0, 1, 1, 1, 1);
	return;
}

void Function_381() //Position: 0xBD98 / 48536
{
	UI_SET_STYLE("MPSplashTitle", 4);
	return;
}

int Function_382(struct<25> Param0) //Position: 0xBDB2 / 48562
{
	float fVar0;
	bool bVar1;
	bool bVar2;
...
void Function_383(bool bParam0) //Position: 0xC3D2 / 50130
{
	if (bParam0)
	{
...
void Function_384(bool bParam0) //Position: 0xC463 / 50275
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void Function_385(struct<25> Param0) //Position: 0xC593 / 50579
{
	bool bVar0;
	var uVar1;
...
int Function_386() //Position: 0xC62C / 50732
{
	return Function_111();
}

void Function_387(int iParam0) //Position: 0xC635 / 50741
{
...
var Function_388(int iParam0) //Position: 0xC690 / 50832
{
	switch (iParam0)
	{
		case 0x00000000:
...
bool Function_389(bool bParam0) //Position: 0xC834 / 51252
{
	return Function_116(bParam0);
}

bool Function_390(struct<17> Param0) //Position: 0xC83F / 51263
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_391(bool bParam0, bool bParam1) //Position: 0xC8BE / 51390
{
	if (bParam1)
	{
...
void Function_392(bool bParam0) //Position: 0xC991 / 51601
{
	UI_SET_TEXT("MPSplashItem.s0", "Generic_Dbuffer128_0");
	UI_INCLUDE("MPSplashItem.s0");
...
bool Function_393(struct<25> Param0) //Position: 0xCA17 / 51735
{
	int iVar0;
	float fVar1;
	struct<13> Var2;
...
int Function_394(int iParam0) //Position: 0xCB8D / 52109
{
	int iVar0;
	int iVar1;
...
int Function_395(float fParam0) //Position: 0xCBB8 / 52152
{
	int iVar0;
	int iVar1;
...
void Function_396(int iParam0, int iParam1) //Position: 0xCBDB / 52187
{
	if (iParam0 == 2)
	{
		iParam1 = 1000;
...
int Function_397(float fParam0) //Position: 0xCC0D / 52237
{
	float fVar0;
	float fVar1;
	float fVar2;
...
struct<8> Function_398(var uParam0) //Position: 0xCC5F / 52319
{
	struct<2> Var0;
	bool bVar2;
...
void Function_399() //Position: 0xCCCE / 52430
{
	if (!UI_ISACTIVE("MPSplash"))
	{
		UI_SHOW("MPSplash");
...
int Function_400(int iParam0) //Position: 0xCCF4 / 52468
{
	switch (iLocal_1086)
	{
		case 0x0000000F:
...
void Function_401(int iParam0, int iParam1) //Position: 0xCD94 / 52628
{
	iParam1 = &iParam1;
...
void Function_402(var uParam0) //Position: 0xCDA6 / 52646
{
	bool bVar0;
	int iVar1;
...
void Function_403() //Position: 0xCE0B / 52747
{
...
bool Function_404(bool bParam0, bool bParam1, float fParam2) //Position: 0xCE3A / 52794
{
	struct<17> Var0;
...
bool Function_405(int iParam0) //Position: 0xD08F / 53391
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_406(bool bParam0) //Position: 0xD0D2 / 53458
{
	int iVar0;
...
int Function_407(int iParam0) //Position: 0xD0F9 / 53497
{
	return iParam0;
}

void Function_408(int iParam0, int iParam1) //Position: 0xD103 / 53507
{
	iParam0 = &Global_120101[iParam188] + 184;
	return;
}

void Function_409(int iParam0) //Position: 0xD118 / 53528
{
	Function_26(&iParam0, 4294967286);
	return;
}

bool Function_410(bool bParam0) //Position: 0xD127 / 53543
{
	return Function_104(bParam0);
}

void Function_411(var uParam0, bool bParam1) //Position: 0xD132 / 53554
{
	if (bParam1)
	{
...
bool Function_412(bool bParam0) //Position: 0xD14E / 53582
{
	return Function_47(bParam0, 2);
}

bool Function_413() //Position: 0xD15C / 53596
{
...
bool Function_414(int iParam0, var uParam1, int iParam2) //Position: 0xD17A / 53626
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_415(int iParam0, bool bParam1) //Position: 0xD1CC / 53708
{
	if (bParam1)
	{
...
bool Function_416(int iParam0) //Position: 0xD1E8 / 53736
{
	return Function_47(iParam0, 1);
}

void Function_417(var uParam0) //Position: 0xD1F6 / 53750
{
	bool bVar0;
	var uVar1;
	struct<13> Var2;
...
void Function_418() //Position: 0xD2F3 / 54003
{
...
void Function_419(var uParam0, bool bParam1, bool bParam2) //Position: 0xD372 / 54130
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
var Function_420(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0xD422 / 54306
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "mp_gy_odd_fellows_rest_outro", 2, 1);
	}
...
void Function_421(var uParam0, int iParam1) //Position: 0xD4BB / 54459
{
	var uVar0;
...
void Function_422(int iParam0) //Position: 0xD527 / 54567
{
	...
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2920,654f, 26,4594f, 2654,271f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,059004f, -3,050952f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_423(var uParam0) //Position: 0xD59C / 54684
{
	SET_CAMERASHOT_PERSPECTIVE(&uParam0, 1);
	SET_CAMERASHOT_FOV(&uParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&uParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&uParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&uParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &uParam0, Vector(-2925,873f, 18,77402f, 2667,732f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &uParam0, Vector(0,498907f, 3,101163f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&uParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&uParam0);
	return;
}

void Function_424() //Position: 0xD611 / 54801
{
	Function_3(1024, 1, 0);
	Function_3(1, 0, 0);
	return;
...
void Function_425() //Position: 0xD625 / 54821
{
	Function_426(1, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1, 1, 0x3f800000, 0);
	return;
}

void Function_426(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, int iParam13) //Position: 0xD640 / 54848
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_427(int iParam0) //Position: 0xD92D / 55597
{
	int iVar0;
...
bool Function_428(int iParam0) //Position: 0xD961 / 55649
{
	int iVar0;
...
var Function_429() //Position: 0xD97D / 55677
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_430(int iParam0) //Position: 0xDA0B / 55819
{
	Function_359(&iParam0, 0.0f);
	return;
}

bool Function_431(struct<21> Param0) //Position: 0xDA18 / 55832
{
	switch (Param0)
	{
		case 0x00000000:
...
void Function_432() //Position: 0xDB05 / 56069
{
	return;
}

void Function_433(int iParam0) //Position: 0xDB0B / 56075
{
	char* cVar0[32];
...
void Function_434() //Position: 0xDC9E / 56478
{
	return;
}

void Function_435() //Position: 0xDCA4 / 56484
{
	iLocal_1043 = 1;
	Function_97(iLocal_1043, 0);
	return;
...
void Function_436() //Position: 0xDCB5 / 56501
{
	return;
}

bool Function_437() //Position: 0xDCBB / 56507
{
	return Function_438(iLocal_567);
}

int Function_438(int iParam0) //Position: 0xDCC7 / 56519
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_439() //Position: 0xDD0F / 56591
{
	...
	{
		case 0x00000000:
			NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_CUTSCENE", 0, 0, 0, 0);
			Function_418();
			Function_642();
		...
		case 0x00000003:
			if (!IS_OBJECT_VALID(&uLocal_278))
			{
				...
				Function_433(4);
				NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_POST_CUTSCENE", 0, 0, 0, 0);
			}
			break;
		...
		case 0x00000004:
			if (STREAMING_IS_WORLD_LOADED())
			{
				if (Function_404(6, 1, 0x3f800000))
				{
					...
					NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_FIRST_GOAL", 0, 0, 0, 0);
		...
		case 0x00000006:
			...
			Function_557(&uLocal_306, &bLocal_106, 477, 485, Local_988.f_52);
			...
			NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_SECOND_GOAL", 0, 0, 0, 0);
			Function_433(7);
			break;
		...
		case 0x00000007:
			if (Function_549(&iLocal_618))
			{
				...
				NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_THIRD_GOAL", 0, 0, 0, 0);
				Function_433(8);
			}
			break;
		...
		case 0x00000008:
			if (Function_549(&iLocal_618))
			{
				...
				NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_FOURTH_GOAL", 0, 0, 0, 0);
				Function_433(9);
			}
			break;
		...
		case 0x00000009:
			...
			if (Function_502(1) && !iLocal_1043)
			{
				if (Function_404(8, 1, 0x3f800000))
				{
					...
					NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_FIFTH_GOAL", 0, 0, 0, 0);
					Function_433(10);
				}
			}
			else
		...
		case 0x0000000A:
			if (!Function_496() && Function_203(&iLocal_618))
			{
				...
				Function_197(&iLocal_618, 0,5f);
				NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_SIXTH_GOAL", 0, 0, 0, 0);
				Function_433(11);
			}
			break;
		...
		case 0x0000000B:
			if (Function_549(&iLocal_618))
			{
				...
				Function_494(2);
				Function_197(&iLocal_618, 0,5f);
				NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_SEVENTH_GOAL", 0, 0, 0, 0);
				Function_433(12);
			}
			break;
		...
		case 0x0000000C:
			...
			if ((Function_502(4) || Local_988.f_52) && !iLocal_1043)
			{
				if (Function_404(13, 1, 0x3f800000))
				{
					...
					Function_617(bLocal_281);
					Function_483();
					NET_LOG(bLocal_1042, "OddGY Stage01: %s", "Transitioning to GID_EIGHTH_GOAL", 0, 0, 0, 0);
					Function_433(13);
				}
			}
			else
...
void Function_440(struct<2> Param0) //Position: 0xEAD8 / 60120
{
	bool bVar0;
...
void Function_441(struct<2> Param0, bool bParam2) //Position: 0xEB97 / 60311
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_442(bool bParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) //Position: 0xEC49 / 60489
{
	bool bVar0;
	float fVar1;
...
void Function_443(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, int iParam5) //Position: 0xEF12 / 61202
{
	struct<4> Var0;
...
void Function_444() //Position: 0xEF85 / 61317
{
	if (!Function_69())
	{
...
void Function_445(var uParam0, int iParam1) //Position: 0xEFAE / 61358
{
	if (Global_6624)
	{
		return;
...
void Function_446(bool bParam0) //Position: 0xEFF0 / 61424
{
...
void Function_447() //Position: 0xF045 / 61509
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_448(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0xF0FC / 61692
{
	int iVar0;
...
bool Function_449(int iParam0) //Position: 0xF1F4 / 61940
{
...
int Function_450(bool bParam0, bool bParam1) //Position: 0xF20A / 61962
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_451(struct<2> Param0, struct<2> Param2) //Position: 0xF2D6 / 62166
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_452(float fParam0, int iParam1) //Position: 0xF2F3 / 62195
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_453(int iParam0) //Position: 0xFB1F / 64287
{
	var uVar0;
...
void Function_454(var uParam0, int iParam1) //Position: 0xFB5A / 64346
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_455(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0xFB69 / 64361
{
	uParam0 = &uParam0;
...
void Function_456(int iParam0, bool bParam1) //Position: 0xFC18 / 64536
{
	Function_4(&Global_79340[iParam018] + 40, bParam1);
	return;
}

void Function_457(var uParam0, bool bParam1, int iParam2) //Position: 0xFC2D / 64557
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<16> Function_458(int iParam0) //Position: 0xFCA7 / 64679
{
	char* cVar0[16];
...
struct<16> Function_459(int iParam0) //Position: 0xFCC8 / 64712
{
	char* cVar0[16];
...
struct<16> Function_460(int iParam0) //Position: 0xFCE9 / 64745
{
	char* cVar0[16];
...
var Function_461() //Position: 0xFD0A / 64778
{
	return "CQueue_Count";
}

void Function_462(int iParam0, int iParam1) //Position: 0xFD1F / 64799
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
...
struct<16> Function_463(int iParam0) //Position: 0xFDA3 / 64931
{
	char* cVar0[16];
...
struct<24> Function_464(int iParam0) //Position: 0xFDC3 / 64963
{
	char* cVar0[24];
...
bool Function_465(int iParam0) //Position: 0xFDF5 / 65013
{
	switch (iParam0)
	{
		case 0x0000003A:
...
void Function_466(int iParam0) //Position: 0xFF73 / 65395
{
	Function_467(iParam0, 1);
	return;
}

void Function_467(int iParam0, bool bParam1) //Position: 0xFF7F / 65407
{
	int iVar0;
...
void Function_468(bool bParam0, bool bParam1) //Position: 0xFFD6 / 65494
{
	bool bVar0;
	char* cVar1[16];
...
bool Function_469() //Position: 0x10132 / 65842
{
	int iVar0;
...
void Function_470(bool bParam0, float fParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6) //Position: 0x10183 / 65923
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[24];
...
void Function_471(bool bParam0) //Position: 0x10284 / 66180
{
	Function_481(bParam0);
	return;
}

void Function_472(bool bParam0, var uParam1, int iParam2, int iParam3, float fParam4, float fParam5, int iParam6, var uParam7, bool bParam8) //Position: 0x1028F / 66191
{
	struct<4> Var0;
...
void Function_473(int iParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x1032B / 66347
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
...
void Function_474(int iParam0, bool bParam1) //Position: 0x103EE / 66542
{
	Function_5(&Global_79340[iParam018] + 40, bParam1);
	return;
}

struct<24> Function_475(int iParam0) //Position: 0x10403 / 66563
{
	char* cVar0[24];
...
struct<24> Function_476(int iParam0) //Position: 0x10432 / 66610
{
	char* cVar0[24];
...
var Function_477(bool bParam0) //Position: 0x10463 / 66659
{
	if (&bParam0)
	{
...
void Function_478(bool bParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x1049C / 66716
{
	int iVar0;
...
void Function_479(bool bParam0) //Position: 0x104F4 / 66804
{
...
float Function_480(bool bParam0) //Position: 0x10524 / 66852
{
	return Global_79340[bParam018].f_12;
}

void Function_481(bool bParam0) //Position: 0x10534 / 66868
{
	Function_482(bParam0, 0, Global_79340[bParam018].f_36);
	return;
}

int Function_482(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1054B / 66891
{
	char* cVar0[16];
	bool bVar4;
...
void Function_483() //Position: 0x105C3 / 67011
{
	int iVar0;
...
void Function_484() //Position: 0x1061A / 67098
{
	bLocal_281++;
	if (bLocal_281 > 14)
	{
...
int Function_485(struct<2> Param0, int iParam2) //Position: 0x1063F / 67135
{
	int iVar0;
	int iVar1;
...
int Function_486(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x10742 / 67394
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	iVar0 = 0;
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iParam2, Function_56(), 4,203895E-45f, Param0, Vector(0.0f, 0.0f, 0.0f), Vector(&bParam3, 20.0f, &bParam3));
...
int Function_487(bool bParam0, int iParam1) //Position: 0x1081E / 67614
{
	if (bParam0)
	{
		return 0;
...
int Function_488(int iParam0) //Position: 0x10837 / 67639
{
	int iVar0;
...
int Function_489(var uParam0, int iParam1) //Position: 0x10897 / 67735
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool Function_490(int iParam0) //Position: 0x109A8 / 68008
{
	bool bVar0;
...
var Function_491() //Position: 0x109C9 / 68041
{
	int iVar0;
...
void Function_492(var uParam0, var uParam1) //Position: 0x10A3A / 68154
{
	if (IS_OBJECT_VALID(&uParam0))
	{
		DESTROY_OBJECT(&uParam0);
...
void Function_493() //Position: 0x10A62 / 68194
{
	Function_164(&iLocal_360);
	Function_164(&iLocal_386);
	Function_164(&iLocal_412);
...
void Function_494(int iParam0) //Position: 0x10A92 / 68242
{
...
void Function_495(int iParam0) //Position: 0x10AC4 / 68292
{
	switch (iParam0)
	{
		case 0x00000000:
...
bool Function_496() //Position: 0x10B9A / 68506
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_497(struct<5> Param0) //Position: 0x10BE6 / 68582
{
	Param0.f_4 = (StackVal + fParam1);
	return;
}

float Function_498(float fParam0) //Position: 0x10BF9 / 68601
{
	if (fParam0 < 15.0f)
	{
		return 0.0f;
...
float Function_499(int iParam0) //Position: 0x10C14 / 68628
{
	if (Function_123(&iParam0))
	{
...
int Function_500() //Position: 0x10C2B / 68651
{
	return Function_501(&iLocal_252, (Function_370() - Function_675()));
}

int Function_501(struct<5> Param0) //Position: 0x10C3D / 68669
{
	return StackVal <= iParam1;
}

bool Function_502(bool bParam0) //Position: 0x10C4B / 68683
{
...
void Function_503() //Position: 0x10C80 / 68736
{
...
void Function_504(var uParam0, var uParam1, bool bParam2) //Position: 0x10CA9 / 68777
{
	if (bParam2)
	{
		return;
...
void Function_505(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x10CF5 / 68853
{
	var uVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_506(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x10E2E / 69166
{
	bool bVar0;
...
void Function_507(var uParam0, int iParam1, var uParam2) //Position: 0x10E9A / 69274
{
	bool bVar0;
...
var Function_508() //Position: 0x10EBE / 69310
{
	return "PackedWeapon";
}

var Function_509(struct<5> Param0) //Position: 0x10ED3 / 69331
{
	return ((StackVal || SHIFT_LEFT(Param0, Function_260())) || SHIFT_LEFT(bParam1, Function_260() + 8));
}

void Function_510(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x10EF1 / 69361
{
...
var Function_511(var uParam0, bool bParam1) //Position: 0x10F4C / 69452
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_512(bool bParam0, bool bParam1, bool bParam2) //Position: 0x10F5C / 69468
{
	int iVar0;
...
var Function_513() //Position: 0x10F81 / 69505
{
	return "PackedMetadata";
}

void Function_514(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x10F98 / 69528
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_515() //Position: 0x110D4 / 69844
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_516() //Position: 0x110E6 / 69862
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_517() //Position: 0x110F8 / 69880
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

int Function_518(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x1110A / 69898
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
struct<32> Function_519(char* cParam0) //Position: 0x11217 / 70167
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_520(char* cParam0) //Position: 0x11283 / 70275
{
	char* cVar0[32];
...
var Function_521() //Position: 0x112A5 / 70309
{
	return "PBox_";
}

var Function_522() //Position: 0x112B3 / 70323
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_523() //Position: 0x112D9 / 70361
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_524() //Position: 0x11301 / 70401
{
	return "p_gen_crateMultiplayerAmmo01x";
}

void Function_525(int iParam0, int iParam1, var uParam2, struct<2> Param3, struct<2> Param5, bool bParam7, int iParam8, int iParam9, float fParam10, float fParam11) //Position: 0x11327 / 70439
{
	int iVar0;
...
void Function_526(struct<2> Param0, struct<2> Param2, bool bParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x11411 / 70673
{
	var uVar0;
...
void Function_527(var uParam0, struct<85> Param1) //Position: 0x11450 / 70736
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int Function_528(struct<33> Param0) //Position: 0x11726 / 71462
{
	int iVar0;
	var uVar1;
	var uVar2;
...
var Function_529(struct<2> Param0, var uParam2, bool bParam3, var uParam4, bool bParam5, var uParam6) //Position: 0x11868 / 71784
{
	struct<2> Var0;
	struct<2> Var2;
	var uVar4;
...
var Function_530(struct<2> Param0, var uParam2, bool bParam3, var uParam4, bool bParam5, var uParam6) //Position: 0x11908 / 71944
{
	var uVar0;
	struct<2> Var2;
	var uVar4;
...
var Function_531(bool bParam0, bool bParam1) //Position: 0x119BC / 72124
{
	bool bVar0;
	bool bVar1;
...
int Function_532(struct<2> Param0, bool bParam2) //Position: 0x119E3 / 72163
{
	bool bVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_533(struct<85> Param0) //Position: 0x11A83 / 72323
{
	if (Param0.f_84)
	{
		return 0;
...
void Function_534(struct<2> Param0, struct<2> Param2, bool bParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x11AA6 / 72358
{
	var uVar0;
...
void Function_535(struct<2> Param0, struct<2> Param2, bool bParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x11AE6 / 72422
{
	var uVar0;
...
void Function_536(struct<2> Param0, struct<2> Param2, bool bParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x11B23 / 72483
{
	var uVar0;
...
void Function_537(struct<2> Param0, struct<2> Param2, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) //Position: 0x11B63 / 72547
{
...
void Function_538(int iParam0, bool bParam1) //Position: 0x11BA0 / 72608
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_539(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7, bool bParam8) //Position: 0x11BD6 / 72662
{
	if (bParam8)
	{
		return;
...
void Function_540(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, int iParam6) //Position: 0x11C15 / 72725
{
	struct<2> Var0;
	struct<5> Var2;
	struct<2> Var7;
...
void Function_541(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, bool bParam7, var uParam8) //Position: 0x11D18 / 72984
{
	var uVar0;
	var uVar1;
...
void Function_542(var uParam0, int iParam1) //Position: 0x11DF3 / 73203
{
	struct<5> Var0;
...
bool Function_543(int iParam0, int iParam1) //Position: 0x11E0E / 73230
{
	var uVar0;
...
void Function_544(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x11F38 / 73528
{
	int iVar0;
...
void Function_545(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x11FF7 / 73719
{
	int iVar0;
	bool bVar1;
...
void Function_546(int iParam0) //Position: 0x12071 / 73841
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_547(int iParam0, var uParam1, bool bParam2) //Position: 0x120A2 / 73890
{
	if (bParam2)
	{
	}
...
void Function_548(var uParam0, var uParam1, var uParam2, var uParam3, struct<2> Param4, struct<2> Param6, var uParam8, var uParam9, var uParam10, var uParam11, bool bParam12) //Position: 0x120ED / 73965
{
	struct<2> Var0;
	char* cVar2[16];
	bool bVar6;
...
bool Function_549(int iParam0) //Position: 0x121FC / 74236
{
	if (Function_203(&iParam0))
	{
...
void Function_550(vector3 vParam0) //Position: 0x12214 / 74260
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_551(var uParam0, float fParam1, int iParam2) //Position: 0x1222B / 74283
{
	bool bVar0;
...
void Function_552(var uParam0, int iParam1) //Position: 0x123B0 / 74672
{
	bool bVar0;
...
void Function_553(bool bParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x12540 / 75072
{
	int iVar0;
...
void Function_554(var uParam0, var uParam1, int iParam2) //Position: 0x125C9 / 75209
{
	if (IS_OBJECTSET_VALID(&uParam0))
	{
...
void Function_555(var uParam0, bool bParam1, var uParam2) //Position: 0x125F7 / 75255
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_556() //Position: 0x12640 / 75328
{
	iLocal_280 = 0;
	return;
}

void Function_557(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1264A / 75338
{
...
void Function_558(var uParam0, bool bParam1) //Position: 0x126D0 / 75472
{
...
void Function_559(struct<85> Param0) //Position: 0x12707 / 75527
{
	cParam5 = &cParam5;
	Param0.f_24 = iParam6;
	Param0.f_28 = iParam7;
...
void Function_560(var uParam0, char* cParam1) //Position: 0x12768 / 75624
{
...
void Function_561(var uParam0, char* cParam1) //Position: 0x1279F / 75679
{
...
void Function_562(var uParam0, char* cParam1) //Position: 0x127D6 / 75734
{
...
void Function_563(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1280D / 75789
{
...
void Function_564(var uParam0, char* cParam1) //Position: 0x1284A / 75850
{
	if (Local_523 == 4294967295)
	{
		return;
	...
	Function_565(&iLocal_464, 75946);
	return;
}

void Function_565(int iParam0, int iParam1) //Position: 0x1289B / 75931
{
	*(&iParam0 + 32) = &iParam1;
	return;
}

void Function_566(int iParam0, int iParam1) //Position: 0x128AA / 75946
{
	iParam1 = iParam1;
...
void Function_567(int iParam0, int iParam1, int iParam2) //Position: 0x128D1 / 75985
{
	bool bVar0;
...
int Function_568(int iParam0, int iParam1) //Position: 0x128FC / 76028
{
	int iVar0;
...
void Function_569(int iParam0, int iParam1, int iParam2) //Position: 0x129D9 / 76249
{
	if (IS_ACTOR_VALID(&iParam0))
	{
...
bool Function_570(int iParam0) //Position: 0x12CA3 / 76963
{
	bool bVar0;
...
bool Function_571(int iParam0) //Position: 0x12CC4 / 76996
{
	bool bVar0;
...
void Function_572(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0x12CE5 / 77029
{
	if (IS_ACTOR_VALID(&uParam0))
	{
...
void Function_573(int iParam0) //Position: 0x12D36 / 77110
{
	var uVar0;
	var uVar1;
...
bool Function_574(int iParam0) //Position: 0x12FEA / 77802
{
	bool bVar0;
...
bool Function_575(int iParam0) //Position: 0x1300B / 77835
{
...
int Function_576(int iParam0) //Position: 0x13062 / 77922
{
	bool bVar0;
...
void Function_577(int iParam0) //Position: 0x130A1 / 77985
{
	if (!IS_OBJECT_VALID(&iParam0))
	{
		return;
...
void Function_578(int iParam0) //Position: 0x130D8 / 78040
{
...
void Function_579(var uParam0, bool bParam1) //Position: 0x13496 / 78998
{
	int iVar0;
...
void Function_580(struct<85> Param0) //Position: 0x134B9 / 79033
{
	char* cVar0[32];
	char* cVar8[32];
	char* cVar16[32];
...
void Function_581(int iParam0, float fParam1) //Position: 0x135D2 / 79314
{
	if (!Function_123(&iParam0))
	{
...
void Function_582(int iParam0, int iParam1) //Position: 0x135EA / 79338
{
	bool bVar0;
	var uVar1;
...
void Function_583(int iParam0) //Position: 0x1365D / 79453
{
	Function_565(&iParam0, 79469);
	return;
}

void Function_584(int iParam0, var uParam1) //Position: 0x1366D / 79469
{
	iParam0 = &iParam0;
	uParam1 = uParam1;
	return;
...
void Function_585(var uParam0, char* cParam1) //Position: 0x1367D / 79485
{
	if (Local_515 == 4294967295)
	{
		return;
	...
	Function_565(&iLocal_438, 79566);
	return;
}

void Function_586(int iParam0, int iParam1) //Position: 0x136CE / 79566
{
	iParam1 = iParam1;
...
void Function_587(int iParam0, int iParam1, bool bParam2) //Position: 0x136FD / 79613
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_588(var uParam0, int iParam1, bool bParam2) //Position: 0x137BA / 79802
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
void Function_589(var uParam0, char* cParam1) //Position: 0x13986 / 80262
{
	if (Local_507 == 4294967295)
	{
		return;
	...
	Function_565(&iLocal_412, 80343);
	return;
}

void Function_590(int iParam0, int iParam1) //Position: 0x139D7 / 80343
{
	iParam1 = iParam1;
...
void Function_591(var uParam0, char* cParam1) //Position: 0x13A06 / 80390
{
	if (Local_499 == 4294967295)
	{
		return;
	...
	Function_565(&iLocal_386, 80471);
	return;
}

void Function_592(int iParam0, int iParam1) //Position: 0x13A57 / 80471
{
	iParam1 = iParam1;
...
void Function_593(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x13A86 / 80518
{
	if (Local_491 == 4294967295)
	{
		return;
	...
	Function_565(&iLocal_360, 80601);
}

void Function_594(int iParam0, int iParam1) //Position: 0x13AD9 / 80601
{
	iParam1 = iParam1;
...
void Function_595(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x13B0F / 80655
{
	var uVar0;
...
void Function_596(bool bParam0) //Position: 0x13DAC / 81324
{
	if (bLocal_281 > 15)
	{
		iLocal_282 = 15;
...
void Function_597(bool[] bParam0) //Position: 0x13ED1 / 81617
{
...
var Function_598(vector3 vParam0, var uParam9, var uParam10, var uParam11, vector3 vParam12) //Position: 0x13F7A / 81786
{
	bool bVar0;
...
int Function_599(int iParam0, int iParam1) //Position: 0x13FC9 / 81865
{
	int iVar0;
...
void Function_600(struct<21> Param0) //Position: 0x13FE2 / 81890
{
	Param0 = iParam1;
	Param0.f_4 = iParam2;
	Param0.f_8 = iParam3;
...
void Function_601(int[] iParam0) //Position: 0x14014 / 81940
{
...
void Function_602(int[] iParam0) //Position: 0x140BD / 82109
{
...
void Function_603(int[] iParam0) //Position: 0x14166 / 82278
{
	Function_600(&Local_491, 5, 21, 7, 2, 0,3f, iLocal_565);
...
void Function_604(int[] iParam0) //Position: 0x1420F / 82447
{
...
void Function_605(int[] iParam0) //Position: 0x142B4 / 82612
{
	Function_600(&Local_491, 5, 24, 8, 2, 1.0f, iLocal_565);
...
void Function_606(int[] iParam0) //Position: 0x14359 / 82777
{
	Function_600(&Local_491, 5, 24, 8, 2, 1.0f, iLocal_565);
...
void Function_607(int[] iParam0) //Position: 0x143FE / 82942
{
...
void Function_608(int[] iParam0) //Position: 0x144A3 / 83107
{
	Function_600(&Local_491, 4, 24, 8, 2, 1.0f, iLocal_565);
...
void Function_609(int[] iParam0) //Position: 0x14546 / 83270
{
...
void Function_610(int[] iParam0) //Position: 0x145E9 / 83433
{
	Function_600(&Local_491, 3, 24, 8, 2, 1.0f, iLocal_565);
...
void Function_611(int[] iParam0) //Position: 0x1468C / 83596
{
...
void Function_612(int[] iParam0) //Position: 0x1472F / 83759
{
	Function_600(&Local_491, 2, 24, 8, 2, 1.0f, iLocal_565);
	Function_600(&Local_499, 2, 12, 4, 1, 0,8f, iLocal_565);
...
void Function_613(int[] iParam0) //Position: 0x147D1 / 83921
{
...
void Function_614(int[] iParam0) //Position: 0x1486F / 84079
{
...
void Function_615(int[] iParam0) //Position: 0x14908 / 84232
{
...
void Function_616(int[] iParam0) //Position: 0x149A0 / 84384
{
...
void Function_617(bool bParam0) //Position: 0x14A3C / 84540
{
	switch (bParam0)
	{
		case 0x00000000:
...
void Function_618(struct<89> Param0) //Position: 0x14B3D / 84797
{
	Param0.f_88 = 1;
	return;
}

void Function_619() //Position: 0x14B49 / 84809
{
	Function_615(&bLocal_531);
	Function_614(&bLocal_531);
	Function_613(&bLocal_531);
...
void Function_620(var uParam0, int iParam1) //Position: 0x14BAF / 84911
{
...
void Function_621(int iParam0, int iParam1, int iParam2) //Position: 0x14C0F / 85007
{
	if (iParam1 <= 0)
	{
	}
...
void Function_622(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x14C33 / 85043
{
	Function_623(&iParam0 + 520, iParam1, iParam2, iParam3, &iParam4);
}

void Function_623(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x14C4D / 85069
{
	Function_624(&iParam0 + 232, iParam1, bParam2, iParam3, &bParam4);
}

void Function_624(int[] iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x14C66 / 85094
{
...
void Function_625(struct<5> Param0) //Position: 0x14C8B / 85131
{
	Param0 = bParam1;
	if (&bParam3)
	{
...
bool Function_626(int iParam0) //Position: 0x14CB9 / 85177
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_627(int iParam0) //Position: 0x14CC9 / 85193
{
	if (!iParam0)
	{
		UI_ENTER("NetTimer");
...
void Function_628(vector3 vParam0) //Position: 0x14CED / 85229
{
	if (Function_123(&vParam0))
	{
		if (Function_121(&vParam0))
...
void Function_629() //Position: 0x14DC3 / 85443
{
	int iVar0;
...
void Function_630() //Position: 0x14E23 / 85539
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
void Function_631() //Position: 0x14F6D / 85869
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
void Function_632() //Position: 0x150B3 / 86195
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
void Function_633() //Position: 0x151B8 / 86456
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
void Function_634() //Position: 0x15306 / 86790
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
void Function_635() //Position: 0x15450 / 87120
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
...
var Function_636(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x15555 / 87381
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "mp_gy_odd_fellows_rest_intro", 2, 1);
	}
	Function_637(&uVar0);
...
void Function_637(var uParam0) //Position: 0x155EB / 87531
{
	var uVar0;
	int iVar1;
...
void Function_638(int iParam0) //Position: 0x1565E / 87646
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2906,763f, 27,2643f, 2723,93f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,252497f, 0,099053f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_639(int iParam0) //Position: 0x156D3 / 87763
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2898,763f, 22,13225f, 2712,098f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,003357f, 0,52567f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_640(int iParam0) //Position: 0x15748 / 87880
{
	UI_EXIT("NetTimer");
	Function_641(0.0f);
	iParam0 = 0;
...
void Function_641(bool bParam0) //Position: 0x15765 / 87909
{
...
void Function_642() //Position: 0x1578B / 87947
{
	iLocal_226[0] = 7;
	iLocal_226[1] = 9;
	iLocal_226[2] = 16;
...
void Function_643(bool bParam0) //Position: 0x157E6 / 88038
{
...
void Function_644() //Position: 0x157FE / 88062
{
	var uVar0;
...
void Function_645(int iParam0, var uParam1, int iParam2, int iParam3) //Position: 0x1580F / 88079
{
	bool bVar0;
	bool bVar1;
...
void Function_646(int iParam0, var uParam1, int iParam2) //Position: 0x158CF / 88271
{
	int iVar0;
	struct<2> Var1;
...
void Function_647(int iParam0, float fParam1) //Position: 0x159BC / 88508
{
	if (!Function_123(&iParam0))
	{
		Function_198(&iParam0, fParam1);
...
void Function_648(int iParam0) //Position: 0x159D4 / 88532
{
	struct<2> Var0;
...
void Function_649(var uParam0, var uParam1) //Position: 0x15A2E / 88622
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_650() //Position: 0x15B4F / 88911
{
	if (UI_ISACTIVE("nPauseMenu"))
	{
		Function_18();
...
void Function_651() //Position: 0x15B6D / 88941
{
	HUD_CLEAR_BIG_TEXT_QUEUE();
	HUD_CLEAR_HELP_QUEUE();
	HUD_CLEAR_OBJECTIVE_QUEUE();
...
void Function_652(var uParam0, bool bParam1) //Position: 0x15B7F / 88959
{
	bool bVar0;
...
void Function_653() //Position: 0x15C26 / 89126
{
...
void Function_654(bool bParam0) //Position: 0x15C5B / 89179
{
...
bool Function_655() //Position: 0x15CC3 / 89283
{
	return Function_46(16384);
}

void Function_656(int iParam0, bool bParam1) //Position: 0x15CCF / 89295
{
...
void Function_657() //Position: 0x15D2A / 89386
{
...
void Function_658(int iParam0) //Position: 0x15D40 / 89408
{
	struct<5> Var0;
...
int Function_659() //Position: 0x15D5D / 89437
{
	bool bVar0;
...
int Function_660(bool bParam0) //Position: 0x15D8A / 89482
{
...
bool Function_661(bool bParam0) //Position: 0x15DAF / 89519
{
	if (!IS_SLOT_VALID(bParam0))
	{
		return 0;
...
void Function_662(struct<2> Param0) //Position: 0x15DC5 / 89541
{
	bool bVar0;
...
void Function_663() //Position: 0x15E84 / 89732
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_664(var uParam0, int iParam1) //Position: 0x15FA6 / 90022
{
...
void Function_665(bool bParam0) //Position: 0x16021 / 90145
{
...
void Function_666(var uParam0, float fParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x16077 / 90231
{
	struct<4> Var0;
	var uVar4;
...
void Function_667(var uParam0, var uParam1, bool bParam2) //Position: 0x1610C / 90380
{
	int iVar0;
...
var Function_668() //Position: 0x161A5 / 90533
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_669(bool bParam0) //Position: 0x161E9 / 90601
{
	if (Function_661(bParam0))
	{
...
void Function_670() //Position: 0x1620F / 90639
{
	if (iLocal_566 == 101)
	{
		Function_671(6);
...
void Function_671(bool bParam0) //Position: 0x162C2 / 90818
{
	switch (bParam0)
	{
		case 0x00000000:
...
void Function_672(struct<4> Param0) //Position: 0x163E4 / 91108
{
	bool bVar0;
	int iVar1;
...
void Function_673(struct<5> Param0, var uParam5) //Position: 0x164A5 / 91301
{
	char* cVar0[32];
	bool bVar8;
...
int Function_674(bool bParam0, bool bParam1) //Position: 0x16514 / 91412
{
	if (bParam0 >= bParam1)
	{
		return 100;
...
int Function_675() //Position: 0x16540 / 91456
{
	return Function_371((bLocal_281 - 1));
}

void Function_676() //Position: 0x1654E / 91470
{
	int iVar0;
	
	Function_678(&uLocal_1046, &bLocal_106, 92094, 1);
	iVar0 = FIND_NAMED_LAYOUT("nsd_layout");
	if (IS_LAYOUTREF_VALID(&iVar0))
	{
		Function_678(&uLocal_1046, &iVar0, 92094, 1);
	}
...
void Function_677() //Position: 0x1664B / 91723
{
	return;
}

int Function_678(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x16651 / 91729
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
int Function_679(int iParam0) //Position: 0x16757 / 91991
{
	int iVar0;
...
void Function_680(var uParam0) //Position: 0x167BE / 92094
{
	Function_681(&uParam0);
	return;
}

void Function_681(int iParam0) //Position: 0x167C9 / 92105
{
	int iVar0;
	int iVar1;
...
void Function_682() //Position: 0x16899 / 92313
{
	switch (iLocal_567)
	{
		case 0x00000006:
			...
			Function_784(&bLocal_624, 110402);
		...
		case 0x00000008:
			Function_718(&iLocal_252, 97715, UI_GET_STRING("TDM_team_fmt_cpp"));
			CAMERA_RESET(0);
			...
			Function_256(Function_48());
			iLocal_357 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "ExclusionVolume", 4,203895E-45f, Function_256(Function_48()), Vector(0.0f, 0.0f, 0.0f), Vector(3.0f, 3.0f, 3.0f));
...
void Function_683(int iParam0, bool bParam1) //Position: 0x16BA6 / 93094
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_684(var uParam0, var uParam1) //Position: 0x16BC8 / 93128
{
...
void Function_685() //Position: 0x16C0D / 93197
{
...
void Function_686() //Position: 0x16C51 / 93265
{
	NET_SCRIPTMSG_REGISTER_HANDLER(57, 93281);
	return;
}

void Function_687(int iParam0) //Position: 0x16C61 / 93281
{
	int iVar0;
	var uVar2;
...
void Function_688() //Position: 0x16D78 / 93560
{
	NET_SCRIPTMSG_REGISTER_HANDLER(61, 93576);
	return;
}

void Function_689(int iParam0) //Position: 0x16D88 / 93576
{
	var uVar0;
...
void Function_690() //Position: 0x16D98 / 93592
{
	NET_SCRIPTMSG_REGISTER_HANDLER(62, 93608);
	return;
}

void Function_691(int iParam0) //Position: 0x16DA8 / 93608
{
	struct<5> Var0;
...
void Function_692(var uParam0, bool bParam1) //Position: 0x17120 / 94496
{
...
void Function_693(int iParam0, var uParam1, var uParam2) //Position: 0x171B0 / 94640
{
	iParam0 = CREATE_EVENT_TRAP("MIRTrap", 5, &uParam1);
	EVENT_TRAP_ON_VOLUME(&iParam0, &uParam2);
	EVENT_TRAP_STORE_EVENTS(&iParam0, 1);
	NET_SCRIPTMSG_REGISTER_HANDLER(58, 95091);
	NET_SCRIPTMSG_REGISTER_HANDLER(59, 94705);
	return;
}

void Function_694(int iParam0) //Position: 0x171F1 / 94705
{
	struct<5> Var0;
	var uVar5;
...
void Function_695(int iParam0) //Position: 0x17373 / 95091
{
	struct<5> Var0;
...
int Function_696(var uParam0, struct<2> Param1, float fParam3) //Position: 0x174F7 / 95479
{
	if (IS_ACTOR_VALID(&uParam0))
	{
...
struct<8> Function_697(int iParam0) //Position: 0x17583 / 95619
{
	struct<2> Var0;
...
void Function_698(var uParam0, int iParam1, int iParam2, var uParam3) //Position: 0x175EF / 95727
{
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(60, 95858);
}

void Function_699(int iParam0) //Position: 0x17672 / 95858
{
	var uVar0;
...
void Function_700(int iParam0, var uParam1, var uParam2) //Position: 0x17681 / 95873
{
	iParam0 = CREATE_EVENT_TRAP("HeadshotTrap", 10, &uParam1);
	EVENT_TRAP_ON_VOLUME(&iParam0, &uParam2);
	EVENT_TRAP_STORE_EVENTS(&iParam0, 1);
	NET_SCRIPTMSG_REGISTER_HANDLER(63, 95934);
	return;
}

void Function_701(int iParam0) //Position: 0x176BE / 95934
{
	var uVar0;
...
void Function_702(int iParam0, var uParam1, var uParam2) //Position: 0x176CD / 95949
{
	iParam0 = CREATE_EVENT_TRAP("ZombieBaitTrap", 17, &uParam1);
	EVENT_TRAP_ON_VOLUME(&iParam0, &uParam2);
	EVENT_TRAP_STORE_EVENTS(&iParam0, 1);
	NET_SCRIPTMSG_REGISTER_HANDLER(64, 96012);
	return;
}

void Function_703(int iParam0) //Position: 0x1770C / 96012
{
	struct<2> Var0;
	int iVar2;
	struct<2> Var3;
...
void Function_704(int iParam0, var uParam1, var uParam2, int iParam3) //Position: 0x1786D / 96365
{
	bool bVar0;
	float fVar1;
	bool bVar2;
...
void Function_705() //Position: 0x1799C / 96668
{
	NET_SCRIPTMSG_REGISTER_HANDLER(32, 97665);
	NET_SCRIPTMSG_REGISTER_HANDLER(33, 97645);
	NET_SCRIPTMSG_REGISTER_HANDLER(35, 97542);
	NET_SCRIPTMSG_REGISTER_HANDLER(15, 97521);
	NET_SCRIPTMSG_REGISTER_HANDLER(39, 97288);
	NET_SCRIPTMSG_REGISTER_HANDLER(40, 96734);
	return;
}

void Function_706(int iParam0) //Position: 0x179DE / 96734
{
	struct<5> Var0;
...
void Function_707(bool bParam0, var uParam1, bool bParam2) //Position: 0x17AA5 / 96933
{
	bool bVar0;
...
void Function_708(bool bParam0, int iParam1) //Position: 0x17B19 / 97049
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_709(bool bParam0, var[] uParam1, bool bParam2) //Position: 0x17B6F / 97135
{
	bool bVar0;
	bool bVar1;
...
void Function_710(int iParam0) //Position: 0x17C08 / 97288
{
	var uVar0;
...
void Function_711(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x17C8D / 97421
{
	bool bVar0;
...
void Function_712(int iParam0) //Position: 0x17CF1 / 97521
{
	var uVar0;
...
void Function_713(int iParam0) //Position: 0x17D06 / 97542
{
	int iVar0;
...
void Function_714() //Position: 0x17D61 / 97633
{
	return;
}

void Function_715() //Position: 0x17D67 / 97639
{
	return;
}

void Function_716(int iParam0) //Position: 0x17D6D / 97645
{
	int iVar0;
...
void Function_717(int iParam0) //Position: 0x17D81 / 97665
{
	int iVar0;
...
void Function_718(struct<97> Param0) //Position: 0x17D95 / 97685
{
	Param0.f_96 = 0;
	*(&Param0 + 64) = &iParam1;
	*(&Param0 + 80) = &iParam2;
...
var Function_719(struct<5> Param0) //Position: 0x17DB3 / 97715
{
	int iVar0;
...
int Function_720(var uParam0, int iParam1, int iParam2) //Position: 0x17DE9 / 97769
{
	if (uParam0 != iParam1)
	{
		uParam0 = iParam1;
...
var Function_721(int iParam0) //Position: 0x17E06 / 97798
{
	int iVar0;
...
bool Function_722() //Position: 0x17E23 / 97827
{
	if (!IS_EXITFLAG_SET())
	{
		if (!STREAMING_IS_WORLD_LOADED())
...
bool Function_723(struct<2>[] Param0) //Position: 0x17E53 / 97875
{
	int iVar0;
	int iVar1;
...
void Function_724() //Position: 0x18216 / 98838
{
	if (!Function_428(128))
	{
		return;
...
bool Function_725() //Position: 0x18256 / 98902
{
	int iVar0;
...
void Function_726(struct<13> Param0) //Position: 0x18284 / 98948
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_727() //Position: 0x18297 / 98967
{
	if (!Function_428(128))
	{
		return;
...
void Function_728(int iParam0) //Position: 0x182D9 / 99033
{
	int iVar0;
	var uVar1;
	struct<29> Var2;
...
void Function_729() //Position: 0x1841C / 99356
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int Function_730() //Position: 0x1844B / 99403
{
	var uVar0;
...
void Function_731(int iParam0, int iParam1) //Position: 0x18468 / 99432
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
bool Function_732(int iParam0) //Position: 0x1848A / 99466
{
	var uVar0;
...
void Function_733(bool bParam0) //Position: 0x184AC / 99500
{
	struct<17> Var0;
	...
	Function_20(&Var0);
	Function_21();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 99583);
	return;
}

void Function_734(int iParam0) //Position: 0x184FF / 99583
{
	struct<5> Var0;
	bool bVar5;
...
void Function_735(int iParam0, struct<29> Param1) //Position: 0x18602 / 99842
{
...
struct<116> Function_736(int iParam0, int iParam1) //Position: 0x18618 / 99864
{
	struct<29> Var0;
...
void Function_737(int iParam0, int iParam1) //Position: 0x1880E / 100366
{
	int iVar0;
	int iVar1[17];
	int iVar19;
...
bool Function_738(int iParam0, var uParam1, int iParam2) //Position: 0x18956 / 100694
{
	if (Function_47(Global_124175.f_72, 4194304))
	{
		switch (iParam0)
...
void Function_739(struct<225> Param0) //Position: 0x18A46 / 100934
{
	int iVar0;
...
void Function_740(struct<229> Param0) //Position: 0x18A76 / 100982
{
	Param0.f_228 = iParam1;
	return;
}

void Function_741(int iParam0) //Position: 0x18A83 / 100995
{
	Function_625(&iParam0, 4294967295, 0, 1);
	return;
}

void Function_742(int iParam0, bool bParam1) //Position: 0x18A92 / 101010
{
	if (bParam1)
	{
...
void Function_743(int iParam0, int iParam1) //Position: 0x18AB4 / 101044
{
	*(&iParam0 + 272) = &iParam1;
	return;
}

void Function_744() //Position: 0x18AC4 / 101060
{
	int iVar0;
...
void Function_745(struct<89> Param0) //Position: 0x18BAB / 101291
{
	Param0.f_88 = iParam1;
	return;
}

void Function_746(struct<245> Param0) //Position: 0x18BB8 / 101304
{
	if (bParam1)
	{
		Param0 = 9;
...
void Function_747(int iParam0, bool bParam1) //Position: 0x18CA1 / 101537
{
	if (bParam1)
	{
...
void Function_748(int iParam0) //Position: 0x18CC3 / 101571
{
	Function_749(&iParam0, 101603);
	return;
}

void Function_749(int iParam0, int iParam1) //Position: 0x18CD3 / 101587
{
	*(&iParam0 + 304) = &iParam1;
	return;
}

int Function_750() //Position: 0x18CE3 / 101603
{
	return 0;
}

void Function_751(var uParam0) //Position: 0x18CEA / 101610
{
	Function_352(&uParam0, 101626);
	return;
}

int Function_752() //Position: 0x18CFA / 101626
{
	return 1;
}

void Function_753(int iParam0) //Position: 0x18D01 / 101633
{
	Function_754(&iParam0, 101665);
	return;
}

void Function_754(int iParam0, int iParam1) //Position: 0x18D11 / 101649
{
	*(&iParam0 + 264) = &iParam1;
	return;
}

void Function_755() //Position: 0x18D21 / 101665
{
	return;
}

void Function_756(int iParam0) //Position: 0x18D27 / 101671
{
	Function_743(&iParam0, 101665);
	return;
}

void Function_757(int iParam0) //Position: 0x18D37 / 101687
{
	Function_758(&iParam0, 101665);
	return;
}

void Function_758(int iParam0, int iParam1) //Position: 0x18D47 / 101703
{
	*(&iParam0 + 280) = &iParam1;
	return;
}

void Function_759(int iParam0) //Position: 0x18D57 / 101719
{
	Function_760(&iParam0, 101751);
	return;
}

void Function_760(int iParam0, int iParam1) //Position: 0x18D67 / 101735
{
	*(&iParam0 + 288) = &iParam1;
	return;
}

int Function_761() //Position: 0x18D77 / 101751
{
	return 0;
}

void Function_762(int iParam0) //Position: 0x18D7E / 101758
{
	Function_784(&iParam0, 101774);
	return;
}

void Function_763(int iParam0) //Position: 0x18D8E / 101774
{
	iParam0 = &iParam0;
	return;
}

void Function_764(int iParam0) //Position: 0x18D9A / 101786
{
	Function_198(&iParam0, 0.0f);
	return;
}

void Function_765(int iParam0) //Position: 0x18DA7 / 101799
{
...
void Function_766(bool bParam0, bool bParam1) //Position: 0x18E6E / 101998
{
	var uVar0;
...
void Function_767() //Position: 0x18EBC / 102076
{
...
void Function_768() //Position: 0x18EDB / 102107
{
	Function_769(&Global_122919 + 376);
	return;
}

void Function_769(int[] iParam0) //Position: 0x18EEB / 102123
{
	int iVar0;
...
void Function_770(int iParam0) //Position: 0x18F0E / 102158
{
	int iVar0;
...
void Function_771(int iParam0) //Position: 0x18F33 / 102195
{
	int iVar0;
...
void Function_772() //Position: 0x18F59 / 102233
{
	iLocal_1062 = 0;
	*(&iLocal_1062 + 24) = "";
...
void Function_773(vector3 vParam0) //Position: 0x18F74 / 102260
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_774() //Position: 0x18F8B / 102283
{
	if (&Global_47308 == "")
	{
...
void Function_775() //Position: 0x18FA1 / 102305
{
	struct<405> Var0;
...
void Function_776() //Position: 0x19905 / 104709
{
	struct<297> Var0;
...
void Function_777(var uParam0, var uParam1, var uParam2) //Position: 0x19AF1 / 105201
{
	INIT_NATIVE_WEAPONENUM_MELEE(uParam0, &uParam1, &uParam2);
	return;
}

void Function_778() //Position: 0x19B02 / 105218
{
	struct<45> Var0;
...
void Function_779(int iParam0, var uParam1) //Position: 0x19D30 / 105776
{
	INIT_NATIVE_WEAPONENUM_AMMO(iParam0, &uParam1);
	return;
}

void Function_780() //Position: 0x19D3E / 105790
{
	struct<421> Var0;
...
void Function_781(var uParam0, var uParam1, var uParam2) //Position: 0x1A0E5 / 106725
{
	INIT_NATIVE_WEAPONENUM_SHOTGUN(uParam0, &uParam1, &uParam2);
	return;
}

void Function_782() //Position: 0x1A0F6 / 106742
{
	struct<473> Var0;
...
void Function_783(var uParam0, int iParam1, int iParam2) //Position: 0x1AF21 / 110369
{
	INIT_NATIVE_WEAPONENUM_THROWN_EXPLODING(uParam0, &iParam1, &iParam2);
	return;
}

void Function_784(int iParam0, int iParam1) //Position: 0x1AF32 / 110386
{
	*(&iParam0 + 256) = &iParam1;
	return;
}

void Function_785(var uParam0) //Position: 0x1AF42 / 110402
{
	if (IS_ACTOR_VALID(&uParam0))
	{
...
void Function_786(struct<17> Param0) //Position: 0x1AF62 / 110434
{
	Param0.f_16 = 2;
	iParam1 = iParam1;
	return;
...
void Function_787(int iParam0, int iParam1) //Position: 0x1AF72 / 110450
{
...
void Function_788() //Position: 0x1AF8D / 110477
{
	Function_791(&uLocal_770, 7, 3, 1);
	Function_791(&uLocal_770, 9, 3, 1);
	Function_791(&uLocal_770, 16, 3, 1);
	Function_791(&uLocal_770, 65, 3, 1);
	Function_791(&uLocal_770, 84, 3, 1);
	Function_791(&uLocal_770, 133, 3, 1);
	Function_791(&uLocal_770, 148, 3, 1);
	Function_791(&uLocal_770, 209, 3, 1);
	Function_791(&uLocal_770, 210, 3, 1);
...
var Function_789(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x1B1B8 / 111032
{
	int iVar0;
	var uVar1;
...
var Function_790(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x1B1F6 / 111094
{
	int iVar0;
...
var Function_791(struct<2>[] Param0, int iParam1, int iParam2, bool bParam3) //Position: 0x1B2C5 / 111301
{
	int iVar0;
...
void Function_792() //Position: 0x1B3A1 / 111521
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	Function_793(4, 1);
	uVar0 = &uVar0;
	bLocal_106 = CREATE_LAYOUT("OddFellowsRestMP_GY_layout");
	*(&bLocal_106 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &bLocal_106, "SpawnVol01", 4,203895E-45f, Vector(-2910,528f, 19,075f, 2694,192f), Vector(0.0f, 20.0f, 0.0f), Vector(3.0f, 3.0f, 3.0f));
	*(&bLocal_106 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &bLocal_106, "TrapVolume", 4,203895E-45f, Vector(-2910,528f, 19,075f, 2694,192f), Vector(0.0f, 20.0f, 0.0f), Vector(200.0f, 20.0f, 200.0f));
	*(&bLocal_106 + 24) = Vector(-2910,528f, 19,075f, 2694,192f);
	*(&bLocal_106 + 24 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&bLocal_106 + 48) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "LocationCenter", Vector(-2910,528f, 19,075f, 2694,192f), Vector(0.0f, 0.0f, 0.0f));
	*(&bLocal_106 + 56) = CREATE_OBJECTSET_IN_LAYOUT("WeaponPrizesSet", &bLocal_106, 8, 0);
	*(&bLocal_106 + 64[03]) = Vector(-2883,627f, 19,577f, 2684,731f);
	*(&bLocal_106 + 64[03] + 12) = Vector(0.0f, -67,00241f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "weapon_0", Vector(-2883,627f, 19,577f, 2684,731f), Vector(0.0f, -67,00241f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &bLocal_106 + 56);
	*(&bLocal_106 + 64[13]) = Vector(-2894,578f, 18,936f, 2700,34f);
	*(&bLocal_106 + 64[13] + 12) = Vector(0.0f, -108,6545f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "weapon_1", Vector(-2894,578f, 18,936f, 2700,34f), Vector(0.0f, -108,6545f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &bLocal_106 + 56);
	*(&bLocal_106 + 64[23]) = Vector(-2920,047f, 19,075f, 2702,072f);
	*(&bLocal_106 + 64[23] + 12) = Vector(0.0f, 100,0596f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "weapon_2", Vector(-2920,047f, 19,075f, 2702,072f), Vector(0.0f, 100,0596f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &bLocal_106 + 56);
	*(&bLocal_106 + 64[33]) = Vector(-2927,156f, 18,536f, 2678,514f);
	*(&bLocal_106 + 64[33] + 12) = Vector(0.0f, 42,49035f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "weapon_3", Vector(-2927,156f, 18,536f, 2678,514f), Vector(0.0f, 42,49035f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &bLocal_106 + 56);
	*(&bLocal_106 + 64[43]) = Vector(-2903,496f, 18,121f, 2717,708f);
	*(&bLocal_106 + 64[43] + 12) = Vector(0.0f, -186,5333f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "weapon_4", Vector(-2903,496f, 18,121f, 2717,708f), Vector(0.0f, -186,5333f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &bLocal_106 + 56);
	*(&bLocal_106 + 192) = CREATE_OBJECTSET_IN_LAYOUT("CoffinSpawnsSet", &bLocal_106, 8, 0);
	*(&bLocal_106 + 200[03]) = Vector(-2882,342f, 17,532f, 2723,401f);
	*(&bLocal_106 + 200[03] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_1", Vector(-2882,342f, 17,532f, 2723,401f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &bLocal_106 + 192);
	*(&bLocal_106 + 200[13]) = Vector(-2907,979f, 17,415f, 2737,209f);
	*(&bLocal_106 + 200[13] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_2", Vector(-2907,979f, 17,415f, 2737,209f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &bLocal_106 + 192);
	*(&bLocal_106 + 200[23]) = Vector(-2938,442f, 18,558f, 2721,072f);
	*(&bLocal_106 + 200[23] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_3", Vector(-2938,442f, 18,558f, 2721,072f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &bLocal_106 + 192);
	*(&bLocal_106 + 200[33]) = Vector(-2930,711f, 18,898f, 2676,373f);
	*(&bLocal_106 + 200[33] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_4", Vector(-2930,711f, 18,898f, 2676,373f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &bLocal_106 + 192);
	*(&bLocal_106 + 200[43]) = Vector(-2915,768f, 19,075f, 2660,329f);
	*(&bLocal_106 + 200[43] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_5", Vector(-2915,768f, 19,075f, 2660,329f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &bLocal_106 + 192);
	*(&bLocal_106 + 200[53]) = Vector(-2864,389f, 22,152f, 2659,655f);
	*(&bLocal_106 + 200[53] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_6", Vector(-2864,389f, 22,152f, 2659,655f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &bLocal_106 + 192);
	*(&bLocal_106 + 200[63]) = Vector(-2881,038f, 19,576f, 2680,482f);
	*(&bLocal_106 + 200[63] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_7", Vector(-2881,038f, 19,576f, 2680,482f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &bLocal_106 + 192);
	*(&bLocal_106 + 200[73]) = Vector(-2871,003f, 18,583f, 2707,354f);
	*(&bLocal_106 + 200[73] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_8", Vector(-2871,003f, 18,583f, 2707,354f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &bLocal_106 + 192);
	*(&bLocal_106 + 200[83]) = Vector(-2900,044f, 19,327f, 2678,735f);
	*(&bLocal_106 + 200[83] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_9", Vector(-2900,044f, 19,327f, 2678,735f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &bLocal_106 + 192);
	*(&bLocal_106 + 200[93]) = Vector(-2913,138f, 19,075f, 2707,206f);
	*(&bLocal_106 + 200[93] + 12) = Vector(0.0f, 0.0f, 0.0f);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "spawn_10", Vector(-2913,138f, 19,075f, 2707,206f), Vector(0.0f, 0.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &bLocal_106 + 192);
	*(&bLocal_106 + 448) = Vector(-2864f, 20,58038f, 2692.0f);
	*(&bLocal_106 + 448 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&bLocal_106 + 472) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &bLocal_106, "HidingSpot", Vector(-2864f, 20,58038f, 2692.0f), Vector(0.0f, 0.0f, 0.0f));
	return;
}

void Function_793(int iParam0, int iParam1) //Position: 0x1BA93 / 113299
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_794(bool bParam0) //Position: 0x1BADD / 113373
{
	return (iLocal_566 != 99 || Function_364(&bParam0));
}

void Function_795() //Position: 0x1BAF0 / 113392
{
	var uVar0[4];
	int iVar5;
	...
	{
		uVar0[0] = "Pause timer";
		uVar0[1] = "Don't Pause Timer";
		uVar0[2] = "Finish";
		uVar0[3] = "Quit Mission";
		iVar5 = Function_799(&Local_568, &uVar0, "RDR CO-OP MISSION MENU", GET_DEBUG_PADINDEX(), 0);
		if (Function_798(&iVar5, &iLocal_566, &iLocal_567, &Local_576))
		{
			Function_71();
			Function_18();
		}
...
void Function_796() //Position: 0x1BBDE / 113630
{
	int iVar0;
...
void Function_797(int iParam0) //Position: 0x1BBF2 / 113650
{
	var uVar0;
...
bool Function_798(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1BC07 / 113671
{
...
var Function_799(struct<17> Param0) //Position: 0x1BCB6 / 113846
{
	struct<65> Var0;
	...
	Param0.f_12 = &uParam3;
	Param0.f_16 = &uParam4;
	Function_812(&Var12, &Var0);
	uVar15 = Function_811(uParam1, &Var12);
	Function_810(&uParam2, 1.0f, 1.0f, 1.0f, 1.0f);
	Function_809(&Param0, uVar15);
	Function_807(StackVal, &Param0, Var12.f_12);
	Function_805(StackVal, &Param0, Var12.f_12);
	iVar16 = Function_804(uParam1, &Param0, &Var12);
	while (!Var12.f_16 && iVar16 > uParam1)
	{
		strcpy(&Var0, &(uParam1[iVar16]), 32);
		if (Function_801(&Var12, &Var0, &Param0, "@DEBUG.LEFT_STICK", "@UI.ACCEPT"))
		{
	...
	Function_800(StackVal, Var0.f_64, Var12.f_12);
	SET_SCRIPT_AVOIDS_STRINGTABLE(0);
	return 4294967295;
}

void Function_800(int iParam0, int iParam1, int iParam2) //Position: 0x1BDAA / 114090
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
bool Function_801(struct<17> Param0) //Position: 0x1BE0A / 114186
{
	char* cVar0[64];
	...
	if (IS_STRING_VALID(&Param1))
	{
		if (STRING_LENGTH(&Param1) >= 3)
		{
			if (StackVal && Param0 != vParam2.y != vParam2.z)
			{
				...
				Function_803(Param1.f_64, Param1.f_68, Param1.f_72, &cVar0, Param1.f_76, Param1.f_80, Param1.f_84, 1.0f, Param1.f_88, 1);
				Param1.f_64++;
			...
			Function_803(Param1.f_64, Param1.f_68, Param1.f_72, &Param1, Param1.f_76, Param1.f_80, Param1.f_84, 1.0f, Param1.f_88, 1);
			Param1.f_64++;
			Param0++;
			...
			{
				Param0.f_16 = 1;
				Function_800(StackVal, Param1.f_64, Param0.f_12);
				return 0;
			}
		}
		Function_802(Param1.f_64);
	}
	else
	{
		Function_802(Param1.f_64);
...
void Function_802(bool bParam0) //Position: 0x1BF9D / 114589
{
	var uVar0;
	char* cVar1[16];
...
void Function_803(bool bParam0, var uParam1, var uParam2, char* cParam3) //Position: 0x1BFDB / 114651
{
	struct<13> Var0;
...
var Function_804(int iParam0, struct<21> Param1) //Position: 0x1C093 / 114835
{
	int iVar0;
...
void Function_805(vector3 vParam0) //Position: 0x1C0BA / 114874
{
	switch (Function_806())
	{
		case 0x000000C8:
...
int Function_806() //Position: 0x1C166 / 115046
{
...
void Function_807(vector3 vParam0) //Position: 0x1C1A2 / 115106
{
	switch (Function_808(&vParam0))
	{
		case 0x00000001:
			vParam0.f_4 = (vParam0.y - 1);
			if (vParam0.y <= 0)
...
int Function_808(int iParam0) //Position: 0x1C24B / 115275
{
...
var Function_809(struct<21> Param0) //Position: 0x1C36B / 115563
{
	int iVar0;
...
void Function_810(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x1C525 / 116005
{
	struct<13> Var0;
...
var Function_811(int iParam0, struct<13> Param1) //Position: 0x1C5C1 / 116161
{
	int iVar0;
	int iVar1;
...
void Function_812(struct<17> Param0) //Position: 0x1C5DD / 116189
{
	Param1.f_68 = 100.0f;
	Param1.f_72 = 110.0f;
	Param1.f_76 = 1.0f;
...
void Function_813() //Position: 0x1C637 / 116279
{
...
bool Function_814() //Position: 0x1C6F9 / 116473
{
	return Function_47(Global_124890, 64);
}

int Function_815() //Position: 0x1C708 / 116488
{
	int iVar0;
	...
	{
		Function_823();
		Function_819(&bLocal_106, &bLocal_624, &iLocal_1043, Local_988.f_52);
	}
	if (Function_794(&bLocal_624))
	{
		Function_375();
	...
	if (iLocal_566 != 99)
	{
		...
		iVar0 = Function_818(&bLocal_624, iLocal_1043, Local_988.f_52);
		Function_232(&uLocal_327, &bLocal_106);
		Function_228(&uLocal_329, &bLocal_106);
		Function_220(&uLocal_331, &uLocal_333, &bLocal_106, &uLocal_335);
		Function_214(StackVal, *(&bLocal_106 + 24));
		Function_817(&uLocal_337, &bLocal_106, 2, &uLocal_339, Local_988.f_52);
		Function_196(StackVal, (bLocal_281 <= 12 || Local_988.f_52), &iLocal_292, &bLocal_106, *(&bLocal_106 + 24), 2);
	}
...
bool Function_816(bool bParam0) //Position: 0x1C803 / 116739
{
	return Function_47((&Global_131396 + 256)->f_108, bParam0);
}

void Function_817(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x1C817 / 116759
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_818(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1C92D / 117037
{
	int iVar0;
...
void Function_819(var uParam0, struct<72> Param1) //Position: 0x1CA10 / 117264
{
	bool bVar0;
	var uVar1;
	int iVar2;
	...
	if (&bParam3)
	{
		...
		else if (Function_333(GET_LOCAL_SLOT(), 16384, 0) && !UI_ISACTIVE("MP_OverrunQuit"))
		{
			...
			{
				Function_820(&uParam0);
			}
		}
	}
}

void Function_820(var uParam0) //Position: 0x1CB62 / 117602
{
	var uVar0;
	bool bVar1;
...
void Function_821() //Position: 0x1CBED / 117741
{
	bool bVar0;
...
void Function_822(int iParam0, bool bParam1) //Position: 0x1CC7B / 117883
{
	if (bParam1)
	{
...
void Function_823() //Position: 0x1CCA5 / 117925
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
