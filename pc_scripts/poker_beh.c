...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46914[1], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_25(Global_46914[1], 0);
				(&Local_35 + 232) = Function_25(Global_46914[1], 0);
				Function_24(&Local_35 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_35 + 68)[iVar0] = iLocal_4 * 10;
					Function_23(Global_46914[1], iVar0, 0);
					*(&Local_35 + 128[iVar02]) = Function_23(Global_46914[1], iVar0, 0);
					iVar0++;
				}
				Local_35.f_252 = 2;
				Local_35.f_244 = 0;
				Local_35.f_8 = Local_7;
				Function_22(Global_46914[1]);
				*(&Local_35 + 268) = Function_22(Global_46914[1]);
				Function_21(Global_46914[1]);
				*(&Local_35 + 280) = Function_21(Global_46914[1]);
...
void Function_17() //Position: 0x5B4 / 1460
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5BD / 1469
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x5DE / 1502
{
	if (!Function_8(iParam0))
	{
		return 0;
...
struct<8> Function_21(int iParam0) //Position: 0x630 / 1584
{
...
struct<8> Function_22(int iParam0) //Position: 0x732 / 1842
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_23(int iParam0, int iParam1, bool bParam2) //Position: 0x834 / 2100
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_24(int[] iParam0) //Position: 0xDE0 / 3552
{
	int iVar0;
	var uVar1;
...
struct<8> Function_25(int iParam0, bool bParam1) //Position: 0xE3C / 3644
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_26(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF58 / 3928
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1166 / 4454
{
...
bool Function_28() //Position: 0x122A / 4650
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_29(int iParam0) //Position: 0x1241 / 4673
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_30(int iParam0) //Position: 0x124D / 4685
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_31(var uParam0, int iParam1) //Position: 0x125C / 4700
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_32(var uParam0, bool bParam1) //Position: 0x126B / 4715
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_33() //Position: 0x12AD / 4781
{
	return Function_34(0);
}

int Function_34(int iParam0) //Position: 0x12B7 / 4791
{
...
var Function_35(int iParam0) //Position: 0x12F8 / 4856
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_36(int iParam0) //Position: 0x1312 / 4882
{
...
int Function_37(var uParam0, int iParam1) //Position: 0x132E / 4910
{
	int iVar0;
...
bool Function_38(int iParam0) //Position: 0x134B / 4939
{
...
void Function_39() //Position: 0x1361 / 4961
{
	Function_1();
	return;
}

void Function_40() //Position: 0x136A / 4970
{
	uLocal_5 = CREATE_LAYOUT(Function_51());
	Function_49(0, 1);
	Function_48();
	Function_47();
...
void Function_41(int iParam0) //Position: 0x13BA / 5050
{
...
void Function_42(vector3 vParam0) //Position: 0x13D1 / 5073
{
...
void Function_43(var uParam0, int iParam1) //Position: 0x13F6 / 5110
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x140C / 5132
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_45(int iParam0) //Position: 0x141D / 5149
{
	return Function_46(iParam0, 1);
}

int Function_46(var uParam0, bool bParam1) //Position: 0x142B / 5163
{
	return (uParam0 && bParam1) == 0;
}

void Function_47() //Position: 0x1438 / 5176
{
	return;
}

void Function_48() //Position: 0x143E / 5182
{
	return;
}

void Function_49(bool bParam0, bool bParam1) //Position: 0x1444 / 5188
{
	var uVar0;
...
void Function_50(var uParam0) //Position: 0x14A3 / 5283
{
	int iVar0;
...
var Function_51() //Position: 0x14C0 / 5312
{
	var uVar0;
