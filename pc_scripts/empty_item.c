...
void Function_56(int iParam0, int iParam1, int iParam2) //Position: 0x2CEF / 11503
{
	iParam0 = &iParam0;
	iParam1 = &iParam1;
	iParam2 = iParam2;
...
bool Function_57(int iParam0, int iParam1) //Position: 0x2D09 / 11529
{
	var uVar0;
	var uVar1;
