...
void main() //Position: 0x0 / 0
{
	...
	uVar3 = FIND_NAMED_LAYOUT("Plainview_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "plnv_people");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 5, 10, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("pln_pop: Cannot find plnv_people to create population volumes");
		}
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "plnv_workers_set");
		if (IS_VOLUME_VALID(&uVar4))
		{
		...
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "plnv_region");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar1, 3, 6, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 10, 30, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("lsh_pop: Cannot find plnv_region to create population volumes");
...
void Function_1(var uParam0, var uParam1) //Position: 0xE12 / 3602
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xE23 / 3619
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xE7B / 3707
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xF0D / 3853
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xF29 / 3881
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xF69 / 3945
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xF86 / 3974
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xF97 / 3991
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1015 / 4117
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1081 / 4225
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x10ED / 4333
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1134 / 4404
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1141 / 4417
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x11C3 / 4547
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x11D2 / 4562
{
	if (!Function_4(128))
	{
		return;
