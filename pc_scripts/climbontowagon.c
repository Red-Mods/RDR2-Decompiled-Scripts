...
void main() //Position: 0x0 / 0
{
	...
	iLocal_116 = 0;
	Function_102(&uScriptParam_0, &iLocal_116);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_95(&(vLocal_6[iVar39]), &bVar4))
						{
							Function_93(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_6[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_88("eGRINGO_EndUse: Stop use by request", &vLocal_6[iVar39] + 24);
							Function_87(&vLocal_6[iVar39] + 24, 1);
							...
							{
								Function_80(&(vLocal_6[iVar39]), 0);
							}
							else if (vLocal_6[iVar39].f_68 < 8)
							{
								Function_79(&(vLocal_6[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_125))
	{
		Function_105("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_125);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_116 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_125))
								{
									...
									{
										iLocal_125 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_125 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_125))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_125))
		{
			Function_105("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_125);
		}
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_78(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	{
		uLocal_0 = CREATE_LAYOUT("ClimbOntoWagon_Layout");
		Function_67(GET_TARGET_OBJECT());
		*(&Var0 + 12) = Function_67(GET_TARGET_OBJECT());
		Function_66(GET_TARGET_OBJECT());
		Var0 = Function_66(GET_TARGET_OBJECT());
		Var0.f_24 = 0;
		bLocal_2 = Function_63(&uLocal_0, 0, &Var0, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x2901 / 10497
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "ClimbOntoWagon", 1, 1);
	}
...
void Function_64(Vector3 vParam0, var uParam1) //Position: 0x298C / 10636
{
	var uVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&vParam0, 0, 2.0f, 0);
	return;
}

void Function_65(float fParam0, struct<25> Param1) //Position: 0x29B8 / 10680
{
	struct<2> Var0;
	...
	Var0 = Vector(-1,154559f, 3,143767f, 0,875406f);
	...
	Var0 = Vector(-0,756029f, 0,499827f, -0,422603f);
	UNK_0xF76F2BB3(&Var0, &Param1, Param1.f_24, 4);
...
struct<8> Function_66(int iParam0) //Position: 0x2A7D / 10877
{
	struct<2> Var0;
...
struct<8> Function_67(int iParam0) //Position: 0x2AA6 / 10918
{
	struct<2> Var0;
...
void Function_68(int iParam0) //Position: 0x2ACF / 10959
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2ADB / 10971
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2AFA / 11002
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B11 / 11025
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_72(int iParam0) //Position: 0x2BA2 / 11170
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BC6 / 11206
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2BE5 / 11237
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2C09 / 11273
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2D31 / 11569
{
...
int Function_77(var uParam0) //Position: 0x2D5F / 11615
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2E78 / 11896
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x2E85 / 11909
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x2F07 / 12039
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x34B2 / 13490
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x34EC / 13548
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x350A / 13578
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_84(int iParam0) //Position: 0x354B / 13643
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x3557 / 13655
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, int iParam1) //Position: 0x3579 / 13689
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (IS_LAYOUTREF_VALID(&uLocal_0))
...
void Function_87(var uParam0, bool bParam1) //Position: 0x35BB / 13755
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_88(int iParam0, int iParam1) //Position: 0x36CB / 14027
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_89(struct<69> Param0) //Position: 0x36E3 / 14051
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_90(int iParam0, int iParam1) //Position: 0x39FF / 14847
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
bool Function_91(int iParam0) //Position: 0x3A2C / 14892
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_92(int iParam0) //Position: 0x3A46 / 14918
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3A61 / 14945
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3A9F / 15007
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_95(struct<65> Param0) //Position: 0x3AB8 / 15032
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_96(int iParam0) //Position: 0x3DB0 / 15792
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3DCE / 15822
{
	struct<5> Var0;
	float fVar5;
...
int Function_98(int iParam0) //Position: 0x3E6E / 15982
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(int iParam0, int iParam1) //Position: 0x3E8E / 16014
{
	struct<2> Var0;
	struct<5> Var2;
	...
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	GET_ACTOR_VELOCITY(GET_ACTOR_FROM_OBJECT(GET_TARGET_OBJECT()), &Var0);
	if (VMAG(Var0) < 0,5f)
	{
		return 0;
	}
	Function_67(GRINGO_GET_MY_OBJECT_REF());
	Var2 = Function_67(GRINGO_GET_MY_OBJECT_REF());
	Function_67(&iParam0);
	Var4 = Function_67(&iParam0);
...
bool Function_100(int iParam0) //Position: 0x3EE5 / 16101
{
...
void Function_101(int iParam0) //Position: 0x3F01 / 16129
{
	iParam0 = &iParam0;
	return;
}

void Function_102(var uParam0, int iParam1) //Position: 0x3F0D / 16141
{
	int iVar0;
	var uVar1;
	...
	{
		Function_103(&(vLocal_6[iLocal_1169]), &uParam0);
		iLocal_116++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x3F79 / 16249
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_104(int iParam0) //Position: 0x3F91 / 16273
{
	iParam0 = &iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x3F9D / 16285
{
