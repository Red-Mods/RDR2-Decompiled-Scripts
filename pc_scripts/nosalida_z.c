...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_378, Function_87(), bScriptParam_0);
				Function_47(&uLocal_404, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_378);
	Function_8(&uLocal_404);
	Function_6();
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBA6 / 2982
{
...
int Function_50(int iParam0, bool bParam1) //Position: 0x247C / 9340
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2E5F / 11871
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x391F / 14623
{
	int iVar0;
	int iVar1;
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3B9A / 15258
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD02A / 53290
{
	var uVar0;
	int iVar1;
	int iVar2;
...
{
	Function_239(&uLocal_404, &cLocal_7, "centerHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "centerHouse01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "mainStructure01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "mainStructure01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "mainStructure01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "mainStructure01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "waterFrontHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_404, &cLocal_7, "waterFrontHouse01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD310 / 54032
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD413 / 54291
{
	int iVar0;
...
void Function_241() //Position: 0xD444 / 54340
{
	Function_242(&uLocal_9, &uLocal_378, 4, &iLocal_226 + 8, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_378, 5, &iLocal_226 + 16, 4294967295, 65794);
	Function_242(&uLocal_9, &uLocal_378, 5, &iLocal_226 + 24, 4294967295, 65794);
	Function_242(&uLocal_9, &uLocal_378, 5, &iLocal_226 + 32, 4294967295, 65794);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD493 / 54419
{
...
void Function_243(struct<5> Param0) //Position: 0xD580 / 54656
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD591 / 54673
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD607 / 54791
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD6A5 / 54949
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD6AE / 54958
{
	cLocal_7 = Function_248(&iLocal_178, "nosalida", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD6CA / 54986
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD6ED / 55021
{
	return Function_250();
}

int Function_250() //Position: 0xD6F6 / 55030
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_226 = FIND_NAMED_LAYOUT("Nosalida_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_226))
	{
		iLocal_226 = CREATE_LAYOUT("Nosalida_layout");
	}
	*(&iLocal_226 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_region", 4,203895E-45f, Vector(-4735,336f, 2,00787f, 3989,682f), Vector(0.0f, 20.0f, 0.0f), Vector(61,49357f, 11,71307f, 75,2207f));
	*(&iLocal_226 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_house01", 2,802597E-45f, Vector(-4710,054f, 4,059649f, 3964,694f), Vector(0.0f, -4,679701f, 0.0f), Vector(7,749181f, 4,736944f, 9,648175f));
	*(&iLocal_226 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_house02", 2,802597E-45f, Vector(-4731,854f, 3,75279f, 3959,197f), Vector(0.0f, -10,19262f, 0.0f), Vector(11,53499f, 3,732412f, 13,04875f));
	*(&iLocal_226 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_house03", 2,802597E-45f, Vector(-4757,934f, 4,248062f, 4026,789f), Vector(-0,5938766f, 14,65898f, 0,4160779f), Vector(29,11474f, 6,599332f, 15,91506f));
	*(&iLocal_226 + 64) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_226, "nosv_dogs_set");
	*(&iLocal_226 + 40[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_dogs01", 4,203895E-45f, Vector(-4737,044f, 2,007869f, 4036,396f), Vector(0.0f, 30,49317f, 0.0f), Vector(27,90201f, 3,969246f, 11,90349f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 64, &iLocal_226 + 40[0]);
	*(&iLocal_226 + 40[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_dogs02", 4,203895E-45f, Vector(-4709,754f, 2,007869f, 3965,22f), Vector(0.0f, -85,48962f, 0.0f), Vector(26,41172f, 3,822314f, 19,55445f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 64, &iLocal_226 + 40[1]);
	*(&iLocal_226 + 96) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_226, "nosv_docks_set");
	*(&iLocal_226 + 72[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_docks02", 2,802597E-45f, Vector(-4733,883f, 1,820969f, 3938,285f), Vector(1,847206f, 54,63364f, 0,3211141f), Vector(21,59676f, 1,712891f, 3,04375f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 96, &iLocal_226 + 72[0]);
	*(&iLocal_226 + 72[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_docks01", 2,802597E-45f, Vector(-4741,52f, 1,327494f, 3955,527f), Vector(0.0f, -9,450789f, 0.0f), Vector(2,70771f, 1,523745f, 16,61516f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 96, &iLocal_226 + 72[1]);
	*(&iLocal_226 + 168) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_226, "nosv_chickens_set");
	*(&iLocal_226 + 104[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens01", 4,203895E-45f, Vector(-4698,853f, 3,330612f, 3952,004f), Vector(0.0f, 20.0f, 0.0f), Vector(5,537433f, 5,537433f, 5,537433f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[0]);
	*(&iLocal_226 + 104[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens02", 4,203895E-45f, Vector(-4712,516f, 3,957368f, 3951,656f), Vector(0.0f, 20.0f, 0.0f), Vector(8,079192f, 2,992907f, 5,031132f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[1]);
	*(&iLocal_226 + 104[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens03", 4,203895E-45f, Vector(-4686,73f, 4,542793f, 3968,686f), Vector(0.0f, -8,74915f, 0.0f), Vector(8,001294f, 3,152647f, 4,709808f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[2]);
	*(&iLocal_226 + 104[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens04", 4,203895E-45f, Vector(-4703,657f, 4,122806f, 3976,856f), Vector(0.0f, -18,00772f, 0.0f), Vector(6,084473f, 4,477352f, 8,020122f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[3]);
	*(&iLocal_226 + 104[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens05", 4,203895E-45f, Vector(-4717,485f, 3,769896f, 3977,028f), Vector(0.0f, 20.0f, 0.0f), Vector(6,086939f, 4,173774f, 8,597703f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[4]);
	*(&iLocal_226 + 104[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens06", 4,203895E-45f, Vector(-4752.0f, 4,87489f, 4038,013f), Vector(0.0f, 5,352821f, 0.0f), Vector(19,12297f, 4,34854f, 7,981565f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[5]);
	*(&iLocal_226 + 104[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_chickens07", 4,203895E-45f, Vector(-4717,006f, 3,864486f, 4023,634f), Vector(0.0f, 20.0f, 0.0f), Vector(9,988485f, 4,623668f, 5,266285f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 168, &iLocal_226 + 104[6]);
	*(&iLocal_226 + 208) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_226, "nosv_goats_set");
	*(&iLocal_226 + 176[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_goats01", 4,203895E-45f, Vector(-4698,604f, 3,036527f, 3966,532f), Vector(0.0f, 0,4843248f, 0.0f), Vector(6,555081f, 3,16973f, 10,55234f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 208, &iLocal_226 + 176[0]);
	*(&iLocal_226 + 176[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_goats02", 4,203895E-45f, Vector(-4718,224f, 3,957368f, 3954,931f), Vector(0.0f, 58,54212f, 0.0f), Vector(11,62974f, 1,964657f, 6,306052f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 208, &iLocal_226 + 176[1]);
	*(&iLocal_226 + 176[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nosv_goats03", 4,203895E-45f, Vector(-4753,052f, 101,2714f, 4035,282f), Vector(0.0f, 20.0f, 0.0f), Vector(14,22141f, 4,525812f, 5,875824f));
	ADD_TO_VOLUME_SET(&iLocal_226 + 208, &iLocal_226 + 176[2]);
	*(&iLocal_226 + 216) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_226, "nv_BirdPop", 2,802597E-45f, Vector(-4716.0f, 3,036528f, 3968,239f), Vector(0.0f, 0.0f, 0.0f), Vector(118,4502f, 36,13533f, 149,2472f));
	*(&iLocal_226 + 224) = Vector(-4735,691f, 3,142759f, 3959,758f);
	*(&iLocal_226 + 224 + 12) = Vector(0.0f, -105,5876f, 0.0f);
	*(&iLocal_226 + 248) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_AreaTreasure1", Vector(-4735,691f, 3,142759f, 3959,758f), Vector(0.0f, -105,5876f, 0.0f));
	*(&iLocal_226 + 256) = Vector(-4728,77f, 3,018617f, 4004,514f);
	*(&iLocal_226 + 256 + 12) = Vector(0.0f, -276,6156f, 0.0f);
	*(&iLocal_226 + 280) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_AreaTreasure2", Vector(-4728,77f, 3,018617f, 4004,514f), Vector(0.0f, -276,6156f, 0.0f));
	*(&iLocal_226 + 288) = Vector(-4766,274f, 2,138235f, 4023,075f);
	*(&iLocal_226 + 288 + 12) = Vector(0.0f, -69,91085f, 0.0f);
	*(&iLocal_226 + 312) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_AreaTreasure3", Vector(-4766,274f, 2,138235f, 4023,075f), Vector(0.0f, -69,91085f, 0.0f));
	*(&iLocal_226 + 320) = Vector(-4754,748f, 3,157908f, 4025,919f);
	*(&iLocal_226 + 320 + 12) = Vector(0.0f, -164,6989f, 0.0f);
	*(&iLocal_226 + 344) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_interiorPoint_house1", Vector(-4754,748f, 3,157908f, 4025,919f), Vector(0.0f, -164,6989f, 0.0f));
	*(&iLocal_226 + 352) = Vector(-4709,098f, 3,159959f, 3964,871f);
	*(&iLocal_226 + 352 + 12) = Vector(0.0f, -275,3008f, 0.0f);
	*(&iLocal_226 + 376) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_interiorPoint_house", Vector(-4709,098f, 3,159959f, 3964,871f), Vector(0.0f, -275,3008f, 0.0f));
	*(&iLocal_226 + 384) = Vector(-4734,144f, 3,157851f, 3959,429f);
	*(&iLocal_226 + 384 + 12) = Vector(0.0f, -98,3689f, 0.0f);
	*(&iLocal_226 + 408) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_interiorPoint_house2", Vector(-4734,144f, 3,157851f, 3959,429f), Vector(0.0f, -98,3689f, 0.0f));
	*(&iLocal_226 + 416) = Vector(-4732,877f, 3,157851f, 3955,011f);
	*(&iLocal_226 + 416 + 12) = Vector(0.0f, -98,3689f, 0.0f);
	*(&iLocal_226 + 440) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_interiorPoint_house3", Vector(-4732,877f, 3,157851f, 3955,011f), Vector(0.0f, -98,3689f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos1", Vector(-4770,091f, 4,061f, 3927,483f), Vector(-1,333f, -133,603f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos2", Vector(-4668,753f, 7,878f, 3928,565f), Vector(-9,534f, 115,531f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos3", Vector(-4685,64f, 9,17f, 4014,176f), Vector(-10,84f, 29,185f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos4", Vector(-4769,903f, 8,668f, 4057,877f), Vector(-6,76f, -23,323f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos5", Vector(-4776,173f, 6,841f, 4038,427f), Vector(-9,487f, -28,015f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos6", Vector(-4730,625f, 6,807f, 3988,08f), Vector(-12,19f, 37,337f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos7", Vector(-4785,929f, 5,109f, 3973,673f), Vector(-2,123f, -58,106f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos8", Vector(-4715,063f, 5,982f, 3968,258f), Vector(-4,68f, 65,168f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos9", Vector(-4732,547f, 7,267f, 3939,39f), Vector(-16,839f, 132,82f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nos_vista_cam_pos10", Vector(-4697,269f, 7,092f, 3944,439f), Vector(-7,934f, 122,43f, 0.0f));
	*(&iLocal_226 + 448) = Vector(-4757,202f, 2,532873f, 3943,118f);
	*(&iLocal_226 + 448 + 12) = Vector(0.0f, 79,7265f, 0.0f);
	*(&iLocal_226 + 472) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_respawn_water_01", Vector(-4757,202f, 2,532873f, 3943,118f), Vector(0.0f, 79,7265f, 0.0f));
	*(&iLocal_226 + 480) = Vector(-4756,526f, 2,573081f, 3960,351f);
	*(&iLocal_226 + 480 + 12) = Vector(0.0f, 79,7265f, 0.0f);
	*(&iLocal_226 + 504) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_respawn_water_02", Vector(-4756,526f, 2,573081f, 3960,351f), Vector(0.0f, 79,7265f, 0.0f));
	*(&iLocal_226 + 512) = Vector(-4741,297f, 2,492837f, 3953,254f);
	*(&iLocal_226 + 512 + 12) = Vector(0.0f, 79,7265f, 0.0f);
	*(&iLocal_226 + 536) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_respawn_water_03", Vector(-4741,297f, 2,492837f, 3953,254f), Vector(0.0f, 79,7265f, 0.0f));
	*(&iLocal_226 + 544) = Vector(-4743,793f, 2,277456f, 3971,102f);
	*(&iLocal_226 + 544 + 12) = Vector(0,5604507f, 79,65567f, 0,3089817f);
	*(&iLocal_226 + 568) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_respawn_water_04", Vector(-4743,793f, 2,277456f, 3971,102f), Vector(0,5604507f, 79,65567f, 0,3089817f));
	*(&iLocal_226 + 576) = Vector(-4736.0f, 0,91145f, 3940.0f);
	*(&iLocal_226 + 576 + 12) = Vector(0.0f, 43,57052f, 0.0f);
	*(&iLocal_226 + 600) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_226, "nosf_respawn_water_05", Vector(-4736.0f, 0,91145f, 3940.0f), Vector(0.0f, 43,57052f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xE4AE / 58542
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xE4F8 / 58616
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xE509 / 58633
{
	return;
}

bool Function_254() //Position: 0xE50F / 58639
{
	return 1;
}

void Function_255() //Position: 0xE516 / 58646
{
	return;
}

bool Function_256() //Position: 0xE51C / 58652
{
	return Function_257();
}

int Function_257() //Position: 0xE525 / 58661
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("Nosalida_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("Nosalida_layout");
	}
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-4697,583f, 5,875669f, 3950,434f), Vector(0.0f, -20,2393f, 0.0f), Vector(5,845229f, 7.0f, 7,003549f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-4750,941f, 5,632304f, 3944,326f), Vector(0.0f, -10,77369f, 0.0f), Vector(17,55923f, 7.0f, 4,822172f));
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-4754,094f, 2,134434f, 3960,894f), Vector(0.0f, -10,77369f, 0.0f), Vector(17,55923f, 13,53322f, 13,88602f));
	*(&iLocal_178 + 88) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_difSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-4756,153f, 2,658015f, 3943,287f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "Accuracy", 100);
	DECOR_SET_INT(&uVar1, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 88);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-4696,612f, 5,610038f, 3953,057f), Vector(0.0f, 163,2663f, 0.0f));
	DECOR_SET_INT(&uVar2, "Accuracy", 100);
	DECOR_SET_BOOL(&uVar2, "Core", true);
	DECOR_SET_INT(&uVar2, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 88);
	*(&iLocal_178 + 96) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-4698,304f, 5,610038f, 3952,564f), Vector(0.0f, -112,0727f, 0.0f));
	DECOR_SET_INT(&uVar3, "Accuracy", 100);
	DECOR_SET_INT(&uVar3, "nShoot_Vol", true);
	DECOR_SET_BOOL(&uVar3, "Core", true);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 96);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-4696,902f, 5,610038f, 3953,023f), Vector(0.0f, 71,30717f, 0.0f));
	DECOR_SET_INT(&uVar4, "Accuracy", 100);
	DECOR_SET_INT(&uVar4, "nShoot_Vol", true);
	DECOR_SET_BOOL(&uVar4, "Core", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 96);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-4754,666f, 2,658f, 3943,288f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar5, "Accuracy", 100);
	DECOR_SET_INT(&uVar5, "nShoot_Vol", 2);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 96);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-4756,153f, 2,658015f, 3943,287f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "Accuracy", 100);
	DECOR_SET_INT(&uVar6, "nShoot_Vol", 2);
	DECOR_SET_INT(&uVar6, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 96);
	*(&iLocal_178 + 104) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-4756,153f, 2,658015f, 3943,287f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar7, "Accuracy", 100);
	DECOR_SET_INT(&uVar7, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 104);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03_core", Vector(-4755,325f, 2,566453f, 3955,682f), Vector(0.0f, 264,4939f, 0.0f));
	DECOR_SET_INT(&uVar8, "Accuracy", 100);
	DECOR_SET_BOOL(&uVar8, "Core", true);
	DECOR_SET_INT(&uVar8, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 104);
	*(&iLocal_178 + 112) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_03_player", Vector(-4753,925f, 2,566453f, 3955,68f), Vector(0.0f, 90.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "Accuracy", 100);
	DECOR_SET_BOOL(&uVar9, "Core", true);
	DECOR_SET_INT(&uVar9, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 112);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_03_surv", Vector(-4755,325f, 2,566453f, 3955,682f), Vector(0.0f, 270.0f, 0.0f));
	DECOR_SET_INT(&uVar10, "Accuracy", 100);
	DECOR_SET_BOOL(&uVar10, "Core", true);
	DECOR_SET_INT(&uVar10, "GiveWeapon", 41);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 112);
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-4721,829f, 3,036527f, 3944.0f), Vector(0.0f, 123,6047f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 120);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-4724.0f, 3,036527f, 3948.0f), Vector(0.0f, 19,69166f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 120);
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-4731,362f, 3,157715f, 3953,696f), Vector(0.0f, 170.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 128);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-4756,779f, 3,15749f, 4025,27f), Vector(0.0f, 195,6549f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = Vector(-4708,083f, 3,172676f, 3968,105f);
	*(&iLocal_178 + 136 + 12) = Vector(0.0f, -90.0f, 0.0f);
	*(&iLocal_178 + 160) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-4708,083f, 3,172676f, 3968,105f), Vector(0.0f, -90.0f, 0.0f));
	*(&iLocal_178 + 168) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl", "DLC_survivor_stand_rfl", Vector(-4721,829f, 3,057811f, 3944.0f), Vector(0.0f, 123,9217f, 0.0f));
	*(&iLocal_178 + 176) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_kneel_rfl", "DLC_survivor_kneel_rfl", Vector(-4724.0f, 3,041664f, 3948.0f), Vector(0.0f, 379,9909f, 0.0f));
	*(&iLocal_178 + 184) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-4709,337f, 3,179787f, 3967,79f), Vector(0.0f, -275,5622f, 0.0f));
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xEF07 / 61191
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xEFA2 / 61346
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xF0AE / 61614
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xF18A / 61834
{
...
int Function_262(int iParam0) //Position: 0xF205 / 61957
{
...
bool Function_263(int iParam0) //Position: 0xF21A / 61978
{
...
int Function_264(int iParam0) //Position: 0xF280 / 62080
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xF342 / 62274
{
	int iVar0;
...
void Function_266() //Position: 0xF35F / 62303
{
	return;
}

void Function_267(char* cParam0) //Position: 0xF365 / 62309
{
	if (!Function_26(128))
	{
		return;
