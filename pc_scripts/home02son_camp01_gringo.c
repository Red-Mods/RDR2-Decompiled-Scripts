...
void main() //Position: 0x0 / 0
{
	...
	iLocal_3 = 33;
	iLocal_4 = 1;
	Local_19 = Vector(-57,72f, 116,695f, 1391,078f);
	iLocal_24 = 2;
	iLocal_25 = 4;
	fLocal_26 = 70.0f;
...
void Function_3() //Position: 0x24C / 588
{
	Function_22(52);
	Function_21();
	Function_4(12, &fLocal_11, &uLocal_13, &uLocal_5, &uLocal_15, 52);
	return;
}
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_24 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_150(&Param0 + 324, &fLocal_26, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_139(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_26, 20.0f, fLocal_26));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_10(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_27, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x265A / 9818
{
	...
	{
		if (Function_36(StackVal, &fLocal_11, Local_19, 5.0f) && !GET_TASK_STATUS(&fLocal_11, 19) != 1)
		{
			TASK_USE_GRINGO(&fLocal_11, GET_GRINGO_FROM_OBJECT(&uLocal_17), "UseCase1", 4294967295, 1);
			if (!IS_ACTOR_IN_VOLUME(&Global_54076, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Home02Son01")))
			{
				Function_34(52);
			}
		}
		else if ((GET_CURRENT_GAME_TIME() - fLocal_23) < 300.0f)
		{
			Function_34(52);
		}
		if ((Function_31(&fLocal_11, &Global_54076, 15.0f) && (GET_CURRENT_GAME_TIME() - fLocal_22) < 60.0f) && MEMORY_GET_IS_VISIBLE(&fLocal_11, &Global_54076))
		{
...
int Function_31(var uParam0, var uParam1, float fParam2) //Position: 0x2744 / 10052
{
	float fVar0;
...
var Function_32(var uParam0, int iParam1) //Position: 0x2763 / 10083
{
	var uVar0;
	int iVar2;
	int iVar4;
...
float Function_33(struct<2> Param0) //Position: 0x2784 / 10116
{
	struct<2> Var0;
	bool bVar2;
...
void Function_34(int iParam0) //Position: 0x27A3 / 10147
{
	if (!Function_24(&Global_6667[iParam028] + 184, 8388608))
	{
...
void Function_35(var uParam0, int iParam1) //Position: 0x27D0 / 10192
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_36(float fParam0, struct<2> Param1, float fParam3) //Position: 0x27E1 / 10209
{
...
void Function_37(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x286D / 10349
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2AA6 / 10918
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_39(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2AC6 / 10950
{
	bool bVar0;
	var uVar1;
...
int Function_40(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2BB4 / 11188
{
	char* cVar0[32];
...
int Function_41(int iParam0) //Position: 0x2E20 / 11808
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E44 / 11844
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x2E68 / 11880
{
...
void Function_45(var uParam0, bool bParam1) //Position: 0x2EB5 / 11957
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_46(bool bParam0) //Position: 0x2ED9 / 11993
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_47() //Position: 0x2EF8 / 12024
{
...
bool Function_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2F47 / 12103
{
	bool bVar0;
	var uVar1;
...
bool Function_49(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2FA3 / 12195
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_50(var uParam0, int iParam1) //Position: 0x2FC4 / 12228
{
	bool bVar0;
	var uVar1;
...
void Function_51(var uParam0, var uParam1, bool bParam2) //Position: 0x301F / 12319
{
	bool bVar0;
	var uVar1;
...
var Function_52() //Position: 0x306B / 12395
{
...
void Function_53(struct<425> Param0) //Position: 0x3080 / 12416
{
	bool bVar0;
	bool bVar1;
...
bool Function_54(var uParam0, struct<2> Param1, float fParam3) //Position: 0x31D3 / 12755
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
bool Function_55(vector3 vParam0) //Position: 0x3248 / 12872
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_56(var uParam0) //Position: 0x3260 / 12896
{
	bool bVar0;
	int iVar1;
...
var Function_57(bool bParam0) //Position: 0x32BE / 12990
{
	bool bVar0;
	bool bVar1;
...
void Function_58(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x330B / 13067
{
	bool bVar0;
	var uVar1;
...
void Function_59(var uParam0, bool bParam1) //Position: 0x3384 / 13188
{
	bool bVar0;
	var uVar1;
...
void Function_60(var uParam0) //Position: 0x33D3 / 13267
{
	struct<21> Var0;
...
bool Function_61() //Position: 0x3492 / 13458
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_62(struct<25> Param0) //Position: 0x34A5 / 13477
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_63(int iParam0) //Position: 0x356C / 13676
{
...
bool Function_64(int iParam0) //Position: 0x358C / 13708
{
...
bool Function_65(int iParam0) //Position: 0x35B0 / 13744
{
...
bool Function_66(int iParam0) //Position: 0x35C5 / 13765
{
...
bool Function_67(int iParam0, bool bParam1) //Position: 0x35DC / 13788
{
	int iVar0;
...
var Function_68(int iParam0) //Position: 0x361A / 13850
{
...
bool Function_69(int iParam0) //Position: 0x3634 / 13876
{
...
int Function_70(int iParam0, struct<6> Param1) //Position: 0x364A / 13898
{
	int iVar0;
...
void Function_71(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3684 / 13956
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_72(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3769 / 14185
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_73(var uParam0, bool bParam1) //Position: 0x3920 / 14624
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_74(bool bParam0) //Position: 0x3945 / 14661
{
	var uVar0;
	int iVar1;
...
var Function_75(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3993 / 14739
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_76(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3AEA / 15082
{
	var uVar0[5];
	int iVar6;
...
int Function_77(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3B95 / 15253
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_78(int iParam0, int iParam1) //Position: 0x3C3B / 15419
{
	iParam1 = &iParam1;
	Function_103(&uLocal_5, "$/content/scripting/gringo/simplegringo/jake_read", 1, 0);
	if (Function_85(&fLocal_11, &uLocal_5, 52, 1, 1, 0, 1, 0, 0, 0, 0))
	{
		if (Function_82(&iParam1))
		{
			uLocal_13 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_0, Function_139()));
			*(&Global_6667[5228] + 216) = &uLocal_13;
			*(&iParam0 + 24) = &uLocal_0;
			Function_79();
			return 1;
		}
...
void Function_79() //Position: 0x3CCE / 15566
{
	var uVar0;
	
	uLocal_15 = CREATE_LAYOUT("home02son01campfirelayout");
	uLocal_17 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_15, "home02son01eat", "njake_read", Vector(-57,594f, 116,589f, 1390,992f), Vector(0.0f, 15.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uLocal_17, 2.0f, false, 1092616192);
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uLocal_17), 0);
	if (!Function_36(StackVal, &Global_54076, Local_19, 100.0f))
	{
		SNAP_ACTOR_TO_GRINGO(&fLocal_11, &uLocal_17, "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(&fLocal_11, GET_GRINGO_FROM_OBJECT(&uLocal_17), "UseCase1", 4294967295, 1);
		Function_34(52);
	}
	else
	{
		...
		TASK_GO_NEAR_COORD(&fLocal_11, &Local_19, 2.0f, 1);
	}
	Function_80(&fLocal_11, &uLocal_13, 1, 1);
	fLocal_22 = (GET_CURRENT_GAME_TIME() - 50.0f);
	fLocal_23 = GET_CURRENT_GAME_TIME();
	return;
}

void Function_80(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3DF6 / 15862
{
	bool bVar0;
	int iVar1;
...
bool Function_81(int iParam0, int iParam1, bool bParam2) //Position: 0x3FB3 / 16307
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_82(var uParam0) //Position: 0x4000 / 16384
{
	var uVar0;
	
	Function_84(3, 2);
	uVar0 = &uVar0;
	uLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("home02son_camp01_mobile"));
	Function_83(&uLocal_0, &uParam0);
	return 1;
}

void Function_83(int iParam0, var uParam1) //Position: 0x403E / 16446
{
	int iVar0;
...
void Function_84(int iParam0, bool bParam1) //Position: 0x4089 / 16521
{
	switch (&bParam1)
	{
		case 0x00000000:
...
bool Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x40D3 / 16595
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x42B2 / 17074
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x47F2 / 18418
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_88(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4814 / 18452
{
	var uVar0;
...
var Function_89(bool bParam0, int iParam1) //Position: 0x4875 / 18549
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, int iParam1) //Position: 0x4903 / 18691
{
	Function_92(&uParam0);
	Function_91(&uParam0);
...
void Function_91(int iParam0) //Position: 0x492F / 18735
{
...
void Function_92(int iParam0) //Position: 0x4955 / 18773
{
...
bool Function_93(bool bParam0) //Position: 0x4A2B / 18987
{
...
var Function_94(int iParam0, int iParam1) //Position: 0x4A42 / 19010
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x4AE8 / 19176
{
	var uVar0;
	var uVar1;
...
void Function_96(var uParam0) //Position: 0x4BF7 / 19447
{
	int iVar0;
...
bool Function_97(int iParam0, int iParam1) //Position: 0x4C2A / 19498
{
	int iVar0;
...
void Function_98() //Position: 0x4C47 / 19527
{
	var uVar0;
	int iVar1;
...
bool Function_99(int iParam0) //Position: 0x4CB7 / 19639
{
...
bool Function_100(int iParam0) //Position: 0x4CD3 / 19667
{
...
var Function_101(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4CE9 / 19689
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_102(struct<205> Param0) //Position: 0x4D8F / 19855
{
	var uVar0;
	var uVar1;
...
var Function_103(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4E9A / 20122
{
	int iVar0;
	int iVar1;
...
void Function_104(struct<13> Param0) //Position: 0x4ED8 / 20184
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_105(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4EEB / 20203
{
	int iVar0;
...
bool Function_106(struct<2>[] Param0) //Position: 0x4FBA / 20410
{
	int iVar0;
	int iVar1;
...
void Function_107() //Position: 0x537C / 21372
{
	if (!Function_153(128))
	{
		return;
...
bool Function_108() //Position: 0x53BC / 21436
{
	int iVar0;
...
void Function_109() //Position: 0x53EA / 21482
{
	if (!Function_153(128))
	{
		return;
...
void Function_110(vector3 vParam0) //Position: 0x542C / 21548
{
	char* cVar0[32];
...
void Function_111(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x54C4 / 21700
{
	var uVar0;
	var uVar1;
...
void Function_112(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x54F3 / 21747
{
...
var Function_113(var uParam0, bool bParam1) //Position: 0x554E / 21838
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_114() //Position: 0x555E / 21854
{
	return "PackedGrass";
}

var Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5572 / 21874
{
	int iVar0;
...
var Function_116() //Position: 0x5597 / 21911
{
	return "PackedMetadata";
}

void Function_117(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x55AE / 21934
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_118() //Position: 0x56EA / 22250
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_119() //Position: 0x56FC / 22268
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_120() //Position: 0x570E / 22286
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_121(var uParam0, struct<5> Param1) //Position: 0x5720 / 22304
{
...
var Function_122(var uParam0, int iParam1, int iParam2) //Position: 0x5745 / 22341
{
	int iVar0;
...
var Function_123(bool bParam0) //Position: 0x5764 / 22372
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_124() //Position: 0x5770 / 22384
{
	return Function_125(39);
}

int Function_125(int iParam0) //Position: 0x577B / 22395
{
	int iVar0;
...
var Function_126() //Position: 0x57A9 / 22441
{
	return "PackedWeapon";
}

int Function_127(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x57BE / 22462
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_128() //Position: 0x58CB / 22731
{
	return "MPItemGiver";
}

struct<32> Function_129(char* cParam0) //Position: 0x58DF / 22751
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_130(char* cParam0) //Position: 0x594B / 22859
{
	char* cVar0[32];
...
var Function_131() //Position: 0x596D / 22893
{
	return "PBox_";
}

var Function_132() //Position: 0x597B / 22907
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_133() //Position: 0x59A1 / 22945
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_134() //Position: 0x59C9 / 22985
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_135(var uParam0, int iParam1) //Position: 0x59EF / 23023
{
	int iVar0;
	var uVar1;
...
void Function_136(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5B59 / 23385
{
	struct<8> Var0;
...
int Function_137(bool bParam0) //Position: 0x5C01 / 23553
{
	int iVar0;
	struct<2> Var1;
...
void Function_138(int iParam0) //Position: 0x5D6F / 23919
{
...
var Function_139() //Position: 0x5DD7 / 24023
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5DE0 / 24032
{
	return Function_141(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5DFE / 24062
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_142(int iParam0) //Position: 0x60F7 / 24823
{
	int iVar0;
...
void Function_143() //Position: 0x61AB / 25003
{
	int iVar0;
...
bool Function_144(bool bParam0) //Position: 0x61E6 / 25062
{
	int iVar0;
...
void Function_145(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6213 / 25107
{
	int iVar0;
...
void Function_146() //Position: 0x636E / 25454
{
	int iVar0;
...
var Function_147(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x63BA / 25530
{
	int iVar0;
...
int Function_148() //Position: 0x6496 / 25750
{
	int iVar0;
...
int Function_149() //Position: 0x65F2 / 26098
{
	int iVar0;
...
bool Function_150(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6712 / 26386
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
bool Function_151(struct<2> Param0, struct<5> Param2) //Position: 0x67EE / 26606
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_152(int iParam0) //Position: 0x6931 / 26929
{
	var uVar0;
...
bool Function_153(int iParam0) //Position: 0x6953 / 26963
{
	int iVar0;
...
int Function_154() //Position: 0x696F / 26991
{
	return 0;
}

void Function_155(struct<321> Param0) //Position: 0x6976 / 26998
{
	var uVar0;
