...
void main() //Position: 0x0 / 0
{
	...
	iLocal_113 = 0;
	Function_100(&uScriptParam_0, &iLocal_113);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(vLocal_3[iVar39]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_3[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", &vLocal_3[iVar39] + 24);
							Function_85(&vLocal_3[iVar39] + 24, 1);
							...
							{
								Function_78(&(vLocal_3[iVar39]), 0);
							}
							else if (vLocal_3[iVar39].f_68 < 8)
							{
								Function_77(&(vLocal_3[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADD / 2781
{
	...
	{
		Function_86("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_86("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_86("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			iVar0 = Function_49(&Param0 + 24, &Param0 + 16, bVar29);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_119, &uLocal_117);
		...
		case 0x00000006:
			...
			iVar0 = Function_49(&Param0 + 24, &Param0 + 16, Function_76(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
bool Function_26(var uParam0, bool bParam1) //Position: 0x1FBF / 8127
{
	bParam1 = &bParam1;
	if (!iLocal_0)
	{
		if (!Function_27(&uParam0, 0x3f800000, 0x42960000, 1, 1, 0) && IS_ACTION_NODE_PLAYING_PARTIAL(&uParam0, "mid"))
		{
			ADD_BLOOD_TO_ACTOR(StackVal, &uParam0, Vector(RAND_FLOAT_RANGE(-0,1f, 0,1f), RAND_FLOAT_RANGE(1,1f, 1,4f), -0,1f), 0, 0, 0);
			ADD_BLOOD_TO_ACTOR(StackVal, &uParam0, Vector(RAND_FLOAT_RANGE(-0,1f, 0,1f), RAND_FLOAT_RANGE(1,1f, 1,4f), -0,1f), 0, 0, 0);
			ADD_BLOOD_TO_ACTOR(StackVal, &uParam0, Vector(RAND_FLOAT_RANGE(-0,1f, 0,1f), RAND_FLOAT_RANGE(1,1f, 1,4f), -0,1f), 0, 0, 0);
			ADD_BLOOD_TO_ACTOR(StackVal, &uParam0, Vector(RAND_FLOAT_RANGE(-0,1f, 0,1f), RAND_FLOAT_RANGE(1,1f, 1,4f), -0,1f), 0, 0, 0);
			ADD_BLOOD_TO_ACTOR(StackVal, &uParam0, Vector(RAND_FLOAT_RANGE(-0,1f, 0,1f), RAND_FLOAT_RANGE(1,1f, 1,4f), -0,1f), 0, 0, 0);
...
bool Function_27(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x20EF / 8431
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &uParam1, &uParam2, &uParam3, &uParam4, &uParam5);
}

bool Function_28(bool bParam0) //Position: 0x210F / 8463
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_29() //Position: 0x212F / 8495
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x2135 / 8501
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x2147 / 8519
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x2154 / 8532
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(int iParam0, int iParam1) //Position: 0x216F / 8559
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x218F / 8591
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x21AF / 8623
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x21E6 / 8678
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2206 / 8710
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x2221 / 8737
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2237 / 8759
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x255B / 9563
{
	int iVar0;
...
bool Function_41(int iParam0, int iParam1) //Position: 0x2564 / 9572
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x2583 / 9603
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2592 / 9618
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(int iParam0, int iParam1) //Position: 0x25B6 / 9654
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x25DC / 9692
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x25FA / 9722
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x261C / 9756
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(int iParam0, int iParam1) //Position: 0x263E / 9790
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x2706 / 9990
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2782 / 10114
{
...
void Function_51(vector3 vParam0) //Position: 0x279A / 10138
{
...
var Function_52(int iParam0) //Position: 0x27BF / 10175
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x27E0 / 10208
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x27F7 / 10231
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x2803 / 10243
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x280A / 10250
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x281B / 10267
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x2860 / 10336
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x288C / 10380
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x2898 / 10392
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x299A / 10650
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x29BD / 10685
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x29E5 / 10725
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
	...
	while (iVar7 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(&uVar8))
		{
			...
			{
				Function_65(StackVal, StackVal, Var2, Var11);
				Var2 = Function_65(StackVal, StackVal, Var2, Var11);
				Function_64(StackVal, StackVal, Var0, Var11);
				Var0 = Function_64(StackVal, StackVal, Var0, Var11);
			}
		}
	...
	if (IS_OBJECT_VALID(&uVar18))
	{
		...
		uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, &fVar19, Function_40(), Var13, Vector(0.0f, 0.0f, 0.0f));
		...
		if (bVar22)
		{
			...
			ATTACH_OBJECTS(StackVal, &uVar20, GRINGO_GET_MY_OBJECT_REF(), Function_40(), Var28, Vector(0.0f, 0.0f, 0.0f), 4294967295);
		}
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2CCC / 11468
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2D29 / 11561
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2D86 / 11654
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2D92 / 11666
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2DB1 / 11697
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2DC8 / 11720
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2E59 / 11865
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E7D / 11901
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2E9C / 11932
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2EC0 / 11968
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar0 = Function_72(&iParam1);
	uVar1 = Function_58(&iParam1);
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2FE8 / 12264
{
...
int Function_75(var uParam0) //Position: 0x3016 / 12310
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x312F / 12591
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x313C / 12604
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x31BE / 12734
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3769 / 14185
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x37A3 / 14243
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x37C1 / 14273
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x3802 / 14338
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x380E / 14350
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x3830 / 14384
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	iLocal_0 = 0;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3845 / 14405
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x3955 / 14677
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x396D / 14701
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_88(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_88(int iParam0, int iParam1) //Position: 0x3C89 / 15497
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3C9B / 15515
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3CB5 / 15541
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3CD0 / 15568
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_92(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3D0E / 15630
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3D27 / 15655
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_76(Param0.f_64, 2))
		{
			...
			if (Function_76(Param0.f_64, 1))
			{
				Function_86("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				...
				if (!Function_95(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				fVar30 = Function_94(&Param0 + 16);
				if (!fVar30 != 0.0f)
				{
					if (fVar30 < 0.0f)
					{
...
int Function_94(int iParam0) //Position: 0x4020 / 16416
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x403E / 16446
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x40DE / 16606
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x40FE / 16638
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x4111 / 16657
{
...
void Function_99(int iParam0) //Position: 0x412D / 16685
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x4139 / 16697
{
	int iVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_3[iLocal_1139]), &uParam0);
		iLocal_113++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x41A5 / 16805
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x41BD / 16829
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x41C9 / 16841
{
