...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_21682, "Sep", 4);
	Function_16("Loading Sepulcro population file", 3);
	Global_47148++;
	...
	Var4 = Vector(-2148,719f, 16,323f, 2602,377f);
	AMBIENT_SPAWN_PRESTREAM_SET(&uVar3, Var4, 450.0f, 15);
	...
	uVar6 = FIND_NAMED_LAYOUT("Sepulcro_layout");
	if (IS_LAYOUTREF_VALID(&uVar6))
	{
		uVar7 = FIND_VOLUME_IN_LAYOUT(&uVar6, "sepv_region");
		if (IS_VOLUME_VALID(&uVar7))
		{
			Function_4(&uVar7, &uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("sep_pop: Cannot find sepv_region to create population volumes");
		}
		uVar7 = FIND_VOLUME_IN_LAYOUT(&uVar6, "sepv_region");
		if (IS_VOLUME_VALID(&uVar7))
		{
			Function_3(&uVar7, &uVar2, 0.0f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("sep_pop: Cannot find sepv_region to create population volumes");
	...
	{
		LOG_ERROR("sep_pop: Cannot find one of the volumes to create population volumes");
	}
	END_POPULATION_DEFINITION();
	Global_47148 = (Global_47148 - 1);
	...
	Function_6("Finished loading Sepulcro population file", 5.0f);
	Function_1(&(Global_43791[iLocal_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xCFA / 3322
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xD0B / 3339
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD63 / 3427
{
	var uVar0;
...
var Function_4(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0xDF3 / 3571
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0xE85 / 3717
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0xEA1 / 3745
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xEE1 / 3809
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xEFE / 3838
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xF0F / 3855
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xF8D / 3981
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0xFF9 / 4089
{
	bool bVar0;
...
var Function_12(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1065 / 4197
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0x10AC / 4268
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_14(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x10B9 / 4281
{
	int iVar0;
	int iVar1;
...
var Function_15(var uParam0, int iParam1) //Position: 0x113B / 4411
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_16(char* cParam0) //Position: 0x114A / 4426
{
	if (!Function_5(128))
	{
		return;
