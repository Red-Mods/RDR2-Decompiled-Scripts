	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Function_158(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 5;
						break;
					
					case 0x00000005:
						if (Function_123("$/cutscene/RCM_16_CS02/RCM_16_CS02", &iLocal_326, 28274, 28246, 28239, 28132, 27876, 27839, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						...
						Function_111("KillerPimp2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "KillerPimp2_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_109(&Global_99725[4543] + 228, 256);
						Function_26(47, 1, 1, 0);
						Function_4(Global_46866[4]);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x244 / 580
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x276 / 630
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x293 / 659
{
	RELEASE_LAYOUT_REF(&iLocal_345);
	return;
}

void Function_4(int iParam0) //Position: 0x2A0 / 672
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_5(int iParam0) //Position: 0x391 / 913
{
...
float Function_6(int iParam0) //Position: 0x3CE / 974
{
	if (!iParam0 != 4294967295)
	{
...
void Function_7(int iParam0, int iParam1) //Position: 0x407 / 1031
{
	bool bVar0;
...
var Function_8(int iParam0) //Position: 0x471 / 1137
{
	int iVar0;
...
bool Function_9(int iParam0) //Position: 0x4C9 / 1225
{
...
int Function_10(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x4DF / 1247
{
	int iVar0;
	int iVar1;
...
void Function_11(bool bParam0) //Position: 0x707 / 1799
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_12(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x7A5 / 1957
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_13() //Position: 0xDE3 / 3555
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0xDEC / 3564
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_15(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xDFD / 3581
{
	char* cVar0[32];
...
struct<32> Function_16(char* cParam0) //Position: 0xEF4 / 3828
{
	char* cVar0[32];
...
void Function_17(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0xF0F / 3855
{
	float fVar0;
...
var Function_18(int iParam0, int iParam1) //Position: 0xF76 / 3958
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_19(int iParam0, bool bParam1) //Position: 0xF88 / 3976
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_20(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0xF9A / 3994
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_21(int iParam0) //Position: 0x10CE / 4302
{
	return Global_55480[iParam016].f_96;
}

void Function_22(int iParam0) //Position: 0x10DD / 4317
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_23(int iParam0, bool bParam1, bool bParam2) //Position: 0x1277 / 4727
{
	int iVar0;
	int iVar1;
...
void Function_24(var uParam0, int iParam1) //Position: 0x14BB / 5307
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_25(var uParam0, int iParam1) //Position: 0x14CC / 5324
{
	int iVar0;
...
void Function_26(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x14E9 / 5353
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_27(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1A81 / 6785
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_28() //Position: 0x1C22 / 7202
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1C28 / 7208
{
	if (Global_6624)
	{
		return;
...
void Function_30(bool bParam0) //Position: 0x1C67 / 7271
{
...
void Function_31() //Position: 0x1CBC / 7356
{
	Function_45();
	Function_44();
	Function_44();
...
void Function_32() //Position: 0x1D07 / 7431
{
...
void Function_33() //Position: 0x1E0D / 7693
{
	float fVar0;
...
void Function_34() //Position: 0x1E40 / 7744
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_35() //Position: 0x1FD3 / 8147
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_36() //Position: 0x218C / 8588
{
	Function_37(&Global_42918, 1, 0);
	return;
}

void Function_37(struct<2317> Param0) //Position: 0x219A / 8602
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_38() //Position: 0x23B7 / 9143
{
...
struct<8> Function_39(int iParam0) //Position: 0x23CC / 9164
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_40(int iParam0, bool bParam1, bool bParam2) //Position: 0x2473 / 9331
{
	int iVar0;
...
int Function_41(bool bParam0) //Position: 0x270F / 9999
{
...
struct<8> Function_42() //Position: 0x2750 / 10064
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_43() //Position: 0x27D9 / 10201
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_44() //Position: 0x2870 / 10352
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_45() //Position: 0x28EF / 10479
{
...
int Function_46(int iParam0, bool bParam1, int iParam2) //Position: 0x292C / 10540
{
	int iVar0;
	int iVar1;
...
void Function_47() //Position: 0x2B38 / 11064
{
	struct<2> Var0;
	var uVar2;
...
bool Function_48(char* cParam0) //Position: 0x2BEF / 11247
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_49(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2C07 / 11271
{
	int iVar0;
...
struct<8> Function_50() //Position: 0x2CFF / 11519
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_51(int iParam0) //Position: 0x2D09 / 11529
{
...
int Function_52(bool bParam0, bool bParam1) //Position: 0x2D1F / 11551
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_53(struct<2> Param0, struct<2> Param2) //Position: 0x2DEB / 11755
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_54(float fParam0, int iParam1) //Position: 0x2E08 / 11784
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_55(int iParam0) //Position: 0x3634 / 13876
{
	var uVar0;
...
bool Function_56(var uParam0, int iParam1) //Position: 0x366F / 13935
{
	return (uParam0 && iParam1) == 0;
}

void Function_57(var uParam0, int iParam1) //Position: 0x367C / 13948
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_58(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x368B / 13963
{
	uParam0 = &uParam0;
...
void Function_59(bool bParam0) //Position: 0x373A / 14138
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_60(struct<229> Param0) //Position: 0x38F4 / 14580
{
	float fVar0;
	int iVar1;
...
void Function_61(struct<217> Param0) //Position: 0x39C4 / 14788
{
	float fVar0;
	var uVar1;
...
int Function_62(var uParam0, int iParam1) //Position: 0x3A82 / 14978
{
	int iVar0;
	var uVar1;
...
void Function_63(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3BEC / 15340
{
	struct<8> Var0;
...
struct<32> Function_64(char* cParam0) //Position: 0x3C94 / 15508
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_65(char* cParam0) //Position: 0x3D00 / 15616
{
	char* cVar0[32];
...
int Function_66(int iParam0) //Position: 0x3D22 / 15650
{
	int iVar0;
	struct<2> Var1;
...
float Function_67(int iParam0, struct<2> Param1) //Position: 0x3E90 / 16016
{
	struct<2> Var0;
...
struct<8> Function_68(int iParam0) //Position: 0x3F07 / 16135
{
	struct<2> Var0;
...
void Function_69(int iParam0) //Position: 0x3F73 / 16243
{
...
void Function_70(struct<153> Param0) //Position: 0x3FDB / 16347
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_71(int iParam0) //Position: 0x414F / 16719
{
...
var Function_72(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x417B / 16763
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_73(int iParam0) //Position: 0x419C / 16796
{
...
bool Function_74(struct<249> Param0) //Position: 0x41B1 / 16817
{
...
bool Function_75(struct<265> Param0) //Position: 0x42E1 / 17121
{
	int iVar0;
...
bool Function_76(int iParam0) //Position: 0x4442 / 17474
{
...
bool Function_77(int iParam0) //Position: 0x4466 / 17510
{
...
bool Function_78(int iParam0) //Position: 0x447B / 17531
{
...
var Function_79(int iParam0) //Position: 0x4492 / 17554
{
...
bool Function_80(int iParam0) //Position: 0x44AC / 17580
{
...
bool Function_81(int iParam0) //Position: 0x44C2 / 17602
{
	return Global_116927[iParam06].f_16;
}

bool Function_82(var uParam0, int iParam1) //Position: 0x44D2 / 17618
{
	int iVar0;
...
bool Function_83(struct<237> Param0) //Position: 0x44EF / 17647
{
	if (!Param0.f_236)
	{
		if (Function_108())
...
bool Function_84(int iParam0) //Position: 0x45BE / 17854
{
...
bool Function_85(int iParam0) //Position: 0x4619 / 17945
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x4635 / 17973
{
...
bool Function_87(int iParam0) //Position: 0x464A / 17994
{
...
int Function_88(int iParam0) //Position: 0x465F / 18015
{
...
void Function_89() //Position: 0x4674 / 18036
{
...
int Function_90(int iParam0, int iParam1) //Position: 0x46F4 / 18164
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_91(int iParam0, bool bParam1) //Position: 0x5357 / 21335
{
	int iVar0;
...
int Function_92(int iParam0) //Position: 0x5395 / 21397
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x53E4 / 21476
{
...
int Function_94(int iParam0) //Position: 0x53FA / 21498
{
...
void Function_95() //Position: 0x5463 / 21603
{
...
bool Function_96(int iParam0) //Position: 0x5488 / 21640
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x54D9 / 21721
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x5506 / 21766
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x5558 / 21848
{
	int iVar0;
...
void Function_100() //Position: 0x5592 / 21906
{
	bool bVar0;
...
void Function_101(int iParam0) //Position: 0x55F0 / 22000
{
	PRINTSTRING("Day ");
...
void Function_102(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x563A / 22074
{
	bool bVar0;
	char* cVar1[16];
...
void Function_103(char* cParam0) //Position: 0x56AF / 22191
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_104(int iParam0, var uParam1, int iParam2) //Position: 0x56E9 / 22249
{
	var uVar0;
	char* cVar1[16];
...
int Function_105(char* cParam0) //Position: 0x5765 / 22373
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_106(int iParam0) //Position: 0x5806 / 22534
{
	int iVar0;
	int iVar1;
...
bool Function_107(int iParam0, int iParam1) //Position: 0x5843 / 22595
{
...
bool Function_108() //Position: 0x5856 / 22614
{
...
void Function_109(int iParam0, int iParam1) //Position: 0x5871 / 22641
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_110(bool bParam0, bool bParam1) //Position: 0x5887 / 22663
{
	bool bVar0;
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x58AC / 22700
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_112(int iParam0) //Position: 0x5941 / 22849
{
	char* cVar0[16];
...
int Function_113(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x5980 / 22912
{
...
int Function_114(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x5A2D / 23085
{
	char* cVar0[32];
...
int Function_115(int iParam0) //Position: 0x5C99 / 23705
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_116(var uParam0, bool bParam1) //Position: 0x5CBD / 23741
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5CE1 / 23777
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_118(var uParam0, bool bParam1) //Position: 0x5D07 / 23815
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_119(var uParam0, bool bParam1) //Position: 0x5D2E / 23854
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_120(bool bParam0) //Position: 0x5D52 / 23890
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_121() //Position: 0x5D71 / 23921
{
...
void Function_122(var uParam0, bool bParam1) //Position: 0x5DC0 / 24000
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5DD1 / 24017
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_124(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5E8A / 24202
{
	if (!&bParam15)
	{
...
void Function_125(var uParam0, bool bParam1) //Position: 0x64EC / 25836
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_126() //Position: 0x65BB / 26043
{
	int iVar0;
...
void Function_127() //Position: 0x6633 / 26163
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x6678 / 26232
{
...
void Function_129(var uParam0, int iParam1) //Position: 0x668A / 26250
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_130(int iParam0) //Position: 0x671C / 26396
{
	bool bVar0;
...
float Function_131(vector3 vParam0) //Position: 0x674D / 26445
{
...
bool Function_132(int iParam0) //Position: 0x681A / 26650
{
	return Function_56(iParam0, 2);
}

bool Function_133(int iParam0) //Position: 0x6828 / 26664
{
	return Function_56(iParam0, 1);
}

int Function_134(bool bParam0) //Position: 0x6836 / 26678
{
	bool bVar0;
	var uVar1;
...
bool Function_135() //Position: 0x68F9 / 26873
{
	bool bVar0;
	var uVar1;
...
void Function_136(int iParam0) //Position: 0x6936 / 26934
{
	Function_137(&iParam0, 0.0f);
	return;
}

void Function_137(vector3 vParam0) //Position: 0x6943 / 26947
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_122(&vParam0, 1);
	Function_109(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_138(struct<37> Param0) //Position: 0x6968 / 26984
{
	return Param0.f_36;
}

void Function_139(var uParam0, int iParam1) //Position: 0x6973 / 26995
{
	Function_140(&uParam0, &iParam1, 0);
	return;
}

void Function_140(var uParam0, bool bParam1, bool bParam2) //Position: 0x6983 / 27011
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_141(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6AFB / 27387
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_142() //Position: 0x6B25 / 27429
{
	var uVar0;
	var uVar1;
...
void Function_143() //Position: 0x6B80 / 27520
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_144() //Position: 0x6CBF / 27839
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-1699,778f, 9,934f, 4195,386f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_145() //Position: 0x6CE4 / 27876
{
...
void Function_146(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6D00 / 27904
{
	var uVar0;
...
void Function_147() //Position: 0x6DCF / 28111
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_148() //Position: 0x6DE4 / 28132
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[4743] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[4743] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-1699,55f, 8,03f, 4186,75f), 172,62f, 1, 1, true);
	return 1;
}

int Function_149() //Position: 0x6E4F / 28239
{
	return 1;
}

int Function_150() //Position: 0x6E56 / 28246
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-1699,778f, 9,934f, 4195,386f), 0, 0);
	return 1;
}

int Function_151() //Position: 0x6E72 / 28274
{
	uLocal_343 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_345, "tempcutscenevol", 2, (&Global_99725[4743] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_154(0, 0, 1, 1, 0, 1, 1, &uLocal_343, 1, 1, 1, 1, 0x3f800000, 0);
	Function_152(StackVal, &iLocal_345, *(&Global_99725[4743] + 196), &uLocal_343, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_152(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x6EEB / 28395
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_153(var uParam0, float fParam1) //Position: 0x718B / 29067
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_154(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x720D / 29197
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_157(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_13(), 2, Function_157(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_155(int iParam0) //Position: 0x74BF / 29887
{
	int iVar0;
...
var Function_156() //Position: 0x74F3 / 29939
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_157(int iParam0) //Position: 0x7581 / 30081
{
	struct<2> Var0;
...
int Function_158(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7593 / 30099
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_159(struct<257> Param0) //Position: 0x771E / 30494
{
...
int Function_160(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x775A / 30554
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_161() //Position: 0x79C2 / 31170
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_162(char* cParam0) //Position: 0x7A16 / 31254
{
	char* cVar0[64];
...
bool Function_163(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7B3F / 31551
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_68(&uParam0);
...
int Function_164() //Position: 0x7BCB / 31691
{
	if (IS_PS3())
	{
		return 1;
...
void Function_165() //Position: 0x7BDA / 31706
{
	var uVar0;
	
	Function_166(4, 1);
	uVar0 = &uVar0;
	iLocal_345 = CREATE_LAYOUT("KillerPimp_layout");
	return;
}

void Function_166(int iParam0, int iParam1) //Position: 0x7C06 / 31750
{
	switch (&iParam1)
	{
		case 0x00000000:
