...
void main() //Position: 0x0 / 0
{
	...
	iLocal_116 = 0;
	Function_99(&uScriptParam_0, &iLocal_116);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_117);
		}
		iVar2 = 0;
		bLocal_124 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			iVar3 = 4294967295;
			iVar0 = 0;
			while (iVar0 < (iLocal_116 - 1))
			{
				if (&vLocal_6[iVar09] + 16 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_116;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_6[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_6[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (&vLocal_6[iVar39] + 24 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_6[iVar39] + 24);
							Function_84(&vLocal_6[iVar39] + 24, 1);
							if (IS_ACTOR_VALID(&vLocal_6[iVar39] + 24))
							{
								if (IS_ACTOR_LOCAL_PLAYER(&vLocal_6[iVar39] + 24) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(&vLocal_6[iVar39] + 16))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(&vLocal_6[iVar39] + 24, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_77(&(vLocal_6[iVar39]), 0);
							}
							else if (vLocal_6[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_6[iVar39]));
								vLocal_6[iVar39].f_68 = 8;
							}
							bVar5 = true;
						}
						else
		...
		else
		{
			...
			while (iVar0 < (iLocal_116 - 1))
			{
				if (Function_75(vLocal_6[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_6[iVar09])))
					{
						Function_102("Quitting due to update end");
						Function_77(&(vLocal_6[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_6[iVar09]), 0))
				{
					Function_5(&(vLocal_6[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_125))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_125);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_116 - 1))
	{
		if (Function_75(vLocal_6[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_6[iVar09] + 24);
			Function_77(&(vLocal_6[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_6[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_6[iVar09] + 16);
		}
		Function_15(&(vLocal_6[iVar09]), 1);
		iVar0++;
	}
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_125))
								{
									...
									{
										bLocal_125 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_125 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_125))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_125))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_125);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_40(&Param0, &uVar7, &iLocal_122, &uLocal_120);
		...
		case 0x00000006:
			...
			bVar0 = Function_50(&Param0 + 24, &Param0 + 16, Function_75(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_29(bool bParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	{
		if ((GRINGO_COMPONENT_CHECK_NAME("Push_Lft", &uParam1) || GRINGO_COMPONENT_CHECK_NAME("Push_For", &uParam1)) || GRINGO_COMPONENT_CHECK_NAME("Push_Rgt", &uParam1))
		{
			uLocal_2 = CREATE_LAYOUT("LeanRail_Layout");
			uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uLocal_2, "LEANRAIL", 1, 1);
			uVar1 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&uVar0, 0);
			uVar2 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&uVar0, 0, 3.0f, 0);
			ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(&uVar2, 3.0f, 1, 0);
			SET_CAMERASHOT_ASPECT_RATIO(&uVar1, 0.0f);
			SET_CAMERASHOT_PERSPECTIVE(&uVar1, 1);
			SET_CAMERASHOT_FOV(&uVar1, 42,97919f);
			SET_CAMERASHOT_COLLISION_PARAMETERS(&uVar1, 0,3f, 1);
			SET_CAMERASHOT_COLLISION_ENABLED(&uVar1, 0);
			Function_31(GRINGO_GET_MY_OBJECT_REF());
			Var3 = Function_31(GRINGO_GET_MY_OBJECT_REF());
			GET_OBJECT_AXIS(GRINGO_GET_MY_OBJECT_REF(), &Var5, 2);
			GET_OBJECT_AXIS(GRINGO_GET_MY_OBJECT_REF(), &Var7, 0);
			Var3 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(Var5, Var3, StackVal) * Vector(-3,2f, -3,2f, -3,2f), StackVal, StackVal);
			Var3 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(Var7, Var3, StackVal) * Vector(0,75f, 0,75f, 0,75f), StackVal, StackVal);
			Var3.f_4 = (StackVal + 1,3f);
			SET_CAMERASHOT_POSITION(&uVar1, Var3);
			Function_31(GRINGO_GET_MY_OBJECT_REF());
			Var3 = Function_31(GRINGO_GET_MY_OBJECT_REF());
			Var3.f_4 = (StackVal + 0,9f);
			SET_CAMERASHOT_TARGET_POSITION(&uVar1, Var3, 0);
			RESET_CAMERASHOT_TARGETDOF(&uVar1);
			PLAY_CUTSCENEOBJECT(&uVar0, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
			AI_GLOBAL_REPORT_DANGER(&bParam0);
			iVar9 = GET_ACTOR_FROM_OBJECT(Function_30(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1"));
			if (!IS_ACTOR_VALID(&iVar9))
			{
				iVar9 = GET_ACTOR_FROM_OBJECT(Function_30(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase2"));
			}
			if (IS_ACTOR_VALID(&iVar9))
			{
				MEMORY_CONSIDER_AS_ENEMY(GET_ACTOR_FROM_OBJECT(&iVar9), &bParam0);
			}
		}
	}
	return;
...
var Function_30(var uParam0, bool bParam1) //Position: 0x21A6 / 8614
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &bParam1);
}

struct<8> Function_31(bool bParam0) //Position: 0x21B5 / 8629
{
	struct<2> Var0;
...
bool Function_32(char* cParam0) //Position: 0x21DE / 8670
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_33(int iParam0) //Position: 0x21EB / 8683
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_34(char* cParam0, int iParam1) //Position: 0x2206 / 8710
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_35(int iParam0) //Position: 0x2226 / 8742
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_36(int iParam0) //Position: 0x2246 / 8774
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (vLocal_6 - 1))
	{
		if (&vLocal_6[iVar09] + 16 == &iParam0)
		{
			return &vLocal_6[iVar09] + 24;
		}
		iVar0++;
	}
	return &iVar1;
...
bool Function_37(int iParam0) //Position: 0x227D / 8829
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_38(int iParam0) //Position: 0x229D / 8861
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_39(var uParam0, int iParam1) //Position: 0x22B8 / 8888
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_40(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x22CE / 8910
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_41() //Position: 0x25F2 / 9714
{
	int iVar0;
...
bool Function_42(char* cParam0, int iParam1) //Position: 0x25FB / 9723
{
...
bool Function_44(char* cParam0, int iParam1) //Position: 0x2629 / 9769
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_45(char* cParam0, int iParam1) //Position: 0x264D / 9805
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_46(int iParam0) //Position: 0x2673 / 9843
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x2691 / 9873
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_48(var uParam0, int iParam1) //Position: 0x26B3 / 9907
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_49(char* cParam0, int iParam1) //Position: 0x26D5 / 9941
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_50(var uParam0, int iParam1, bool bParam2) //Position: 0x279D / 10141
{
	int iVar0;
...
void Function_51(int iParam0, float fParam1) //Position: 0x2819 / 10265
{
...
void Function_52(vector3 vParam0) //Position: 0x2831 / 10289
{
...
var Function_53(int iParam0) //Position: 0x2856 / 10326
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_54(vector3 vParam0) //Position: 0x2877 / 10359
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x288E / 10382
{
	uParam0 = &uParam0;
	return;
}

int Function_56() //Position: 0x289A / 10394
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x28A1 / 10401
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_58(int iParam0, var uParam1, int iParam2) //Position: 0x28B2 / 10418
{
	float fVar0;
...
int Function_59(int iParam0) //Position: 0x28F7 / 10487
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(int iParam0) //Position: 0x2923 / 10531
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_61(int iParam0) //Position: 0x292F / 10543
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_62(int iParam0) //Position: 0x2A31 / 10801
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_63(int iParam0) //Position: 0x2A54 / 10836
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(int iParam0) //Position: 0x2A7C / 10876
{
	iParam0 = &iParam0;
	return;
}

void Function_65(int iParam0) //Position: 0x2A88 / 10888
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2A94 / 10900
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2AB3 / 10931
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2ACA / 10954
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2B5B / 11099
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B7F / 11135
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2B9E / 11166
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2BC2 / 11202
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2CEA / 11498
{
...
int Function_74(var uParam0) //Position: 0x2D18 / 11544
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2E31 / 11825
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x2E3E / 11838
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x2EC0 / 11968
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_122)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_120));
		iLocal_122 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_38(&Param0 + 16))
...
void Function_78() //Position: 0x346B / 13419
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x34A5 / 13477
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x34C3 / 13507
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3504 / 13572
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x3510 / 13584
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, var uParam1) //Position: 0x3532 / 13618
{
	var uVar0;
	int iVar1;
	...
	if ((GRINGO_COMPONENT_CHECK_NAME("Push_Lft", &uParam1) || GRINGO_COMPONENT_CHECK_NAME("Push_For", &uParam1)) || GRINGO_COMPONENT_CHECK_NAME("Push_Rgt", &uParam1))
	{
		GRINGO_SET_REUSE_DELAY(20.0f, &uParam1);
		uVar0 = GRINGO_GET_PARENT_COMPONENT(&uParam1, 3);
		if (IS_GRINGO_COMPONENT_VALID(&uVar0))
		{
			iVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_Lft", 3, &uVar0);
			if (IS_GRINGO_COMPONENT_VALID(&iVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, &iVar1);
			}
			iVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_For", 3, &uVar0);
			if (IS_GRINGO_COMPONENT_VALID(&iVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, &iVar1);
			}
			iVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_Rgt", 3, &uVar0);
			if (IS_GRINGO_COMPONENT_VALID(&iVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, &iVar1);
			}
		}
		if (IS_LAYOUTREF_VALID(&uLocal_2))
		{
			DESTROY_LAYOUT_OBJECTS(&uLocal_2);
			DESTROY_LAYOUT(&uLocal_2);
		}
	}
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x3624 / 13860
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3734 / 14132
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x374C / 14156
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3A68 / 14952
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3A7A / 14970
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3A94 / 14996
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3AAF / 15023
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3AED / 15085
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3B06 / 15110
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3DFE / 15870
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3E1C / 15900
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3EBC / 16060
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3EDC / 16092
{
	var uVar0;
	var uVar1;
	
	uParam0 = &uParam0;
	if (!IS_GRINGO_VALID(&uLocal_4))
	{
		uLocal_4 = GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	}
	if (!(GRINGO_COMPONENT_CHECK_NAME("UseCase1", &iParam1) || GRINGO_COMPONENT_CHECK_NAME("UseCase2", &iParam1)))
	{
		uVar0 = GRINGO_GET_PARENT_COMPONENT(&iParam1, 3);
		uVar1 = GRINGO_GET_COMPONENT_USER(&uVar0);
		if (IS_OBJECT_VALID(&uVar1))
		{
			if (!IS_ACTOR_MALE(GET_ACTOR_FROM_OBJECT(&uVar1)))
			{
				return 0;
			}
			if (DECOR_CHECK_EXIST(&uVar1, "CannotPush"))
			{
				return 0;
			}
		}
...
bool Function_97(int iParam0) //Position: 0x3F66 / 16230
{
...
void Function_98(int iParam0) //Position: 0x3F82 / 16258
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x3F8E / 16270
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_6[iLocal_1169]), &uParam0);
		iLocal_116++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x3FFA / 16378
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4013 / 16403
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x401F / 16415
{
