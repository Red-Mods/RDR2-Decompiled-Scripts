...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_404, Function_87(), bScriptParam_0);
				Function_47(&uLocal_442, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_404);
	Function_8(&uLocal_442);
	Function_6();
...
void Function_19() //Position: 0x8CA / 2250
{
	Function_20();
	return;
}

void Function_20() //Position: 0x8D3 / 2259
{
...
void Function_21(int iParam0) //Position: 0x8E6 / 2278
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x90E / 2318
{
...
void Function_23(struct<13> Param0) //Position: 0xA59 / 2649
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xA76 / 2678
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xA94 / 2708
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_26(int iParam0) //Position: 0xB4E / 2894
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB6A / 2922
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xBDD / 3037
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBFA / 3066
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xC07 / 3079
{
...
void Function_31(int iParam0) //Position: 0xF6E / 3950
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0xFD5 / 4053
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x131D / 4893
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x15FD / 5629
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D53 / 7507
{
...
int Function_36(int iParam0) //Position: 0x1D68 / 7528
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1D8A / 7562
{
	bool bVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1E13 / 7699
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E33 / 7731
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1EA8 / 7848
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1EE2 / 7906
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F5E / 8030
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x1FFF / 8191
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x203C / 8252
{
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x207F / 8319
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x24A0 / 9376
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x24B3 / 9395
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x24D0 / 9424
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x24E2 / 9442
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x256C / 9580
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x29C4 / 10692
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2AB5 / 10933
{
...
float Function_55(int iParam0) //Position: 0x2AF2 / 10994
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2B2B / 11051
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2B95 / 11157
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2BED / 11245
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2E15 / 11797
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2EB3 / 11955
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x34F1 / 13553
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x34FA / 13562
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x350B / 13579
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x3602 / 13826
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x361D / 13853
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x3684 / 13956
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3696 / 13974
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x37CA / 14282
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x37D9 / 14297
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3973 / 14707
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3BB7 / 15287
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3BC4 / 15300
{
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3BEE / 15342
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3EA1 / 16033
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3F14 / 16148
{
...
bool Function_76(bool bParam0) //Position: 0x3F4A / 16202
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3FC0 / 16320
{
...
bool Function_78() //Position: 0x3FD1 / 16337
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x3FEA / 16362
{
...
bool Function_80(int iParam0) //Position: 0x4000 / 16384
{
...
bool Function_81(int iParam0) //Position: 0x4015 / 16405
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4033 / 16435
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x40E2 / 16610
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x40F5 / 16629
{
	int iVar0;
	bool bVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x416F / 16751
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x4198 / 16792
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x41B8 / 16824
{
...
void Function_88(struct<82> Param0) //Position: 0x41CD / 16845
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x5706 / 22278
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x5903 / 22787
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5AED / 23277
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5F1C / 24348
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x60A2 / 24738
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x60FC / 24828
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x6136 / 24886
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x616A / 24938
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x6179 / 24953
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_99(int iParam0) //Position: 0x63D0 / 25552
{
	bool bVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x6427 / 25639
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x649E / 25758
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x650A / 25866
{
	bool bVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x667B / 26235
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6975 / 26997
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x6A03 / 27139
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A6C / 27244
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6AFD / 27389
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6B8E / 27534
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6C24 / 27684
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C5F / 27743
{
	bool bVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6CA3 / 27811
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6DE7 / 28135
{
...
void Function_113() //Position: 0x6DF9 / 28153
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6E0E / 28174
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x7116 / 28950
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x73E4 / 29668
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x74A8 / 29864
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x78B5 / 30901
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x7900 / 30976
{
...
void Function_120() //Position: 0x7A06 / 31238
{
	float fVar0;
...
void Function_121() //Position: 0x7A39 / 31289
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7BCC / 31692
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7D85 / 32133
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7D93 / 32147
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x7FB0 / 32688
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x8058 / 32856
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x82F4 / 33524
{
...
struct<8> Function_128() //Position: 0x8335 / 33589
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x83BE / 33726
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x8455 / 33877
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x84D4 / 34004
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x8511 / 34065
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x871D / 34589
{
...
bool Function_134(int iParam0) //Position: 0x8737 / 34615
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x874D / 34637
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x87B9 / 34745
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x88B9 / 35001
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x8911 / 35089
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8ACB / 35531
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8AED / 35565
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8B0B / 35595
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8B1E / 35614
{
...
var Function_143(int iParam0) //Position: 0x8D6C / 36204
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8D78 / 36216
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8D8A / 36234
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8DA2 / 36258
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x91B8 / 37304
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x92AD / 37549
{
...
bool Function_149() //Position: 0x9371 / 37745
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x9388 / 37768
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x9394 / 37780
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x93A3 / 37795
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x942E / 37934
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x946D / 37997
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x9488 / 38024
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x951D / 38173
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x9605 / 38405
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x97C6 / 38854
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9B30 / 39728
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9B54 / 39764
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9E73 / 40563
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA116 / 41238
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA16F / 41327
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA1E3 / 41443
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA5A5 / 42405
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA5E5 / 42469
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA613 / 42515
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA626 / 42534
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA668 / 42600
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA6A6 / 42662
{
	int iVar0;
...
bool Function_171() //Position: 0xA775 / 42869
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA86E / 43118
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAAD0 / 43728
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAF50 / 44880
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xAFE2 / 45026
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB2EC / 45804
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB328 / 45864
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB406 / 46086
{
	bool bVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB455 / 46165
{
	bool bVar0;
...
void Function_182() //Position: 0xB49A / 46234
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB4E8 / 46312
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB4FB / 46331
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB528 / 46376
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB629 / 46633
{
	bool bVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB680 / 46720
{
	bool bVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB6D2 / 46802
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB711 / 46865
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB7DC / 47068
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB8B6 / 47286
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB915 / 47381
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA58 / 47704
{
...
void Function_194() //Position: 0xBBDE / 48094
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBC4A / 48202
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBD89 / 48521
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBDAD / 48557
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBDBE / 48574
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBDFC / 48636
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBE13 / 48659
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE71 / 48753
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xBFD5 / 49109
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xC014 / 49172
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xC029 / 49193
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xC049 / 49225
{
	iParam0 = iParam0;
	return;
}

void Function_206(char* cParam0) //Position: 0xC053 / 49235
{
	if (!Function_26(128))
	{
		return;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC093 / 49299
{
	char[] cVar0[4];
...
void Function_208(int iParam0) //Position: 0xC183 / 49539
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_209(bool bParam0) //Position: 0xC196 / 49558
{
	Function_210(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_210(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC1B4 / 49588
{
	var uVar0;
...
void Function_211(int iParam0) //Position: 0xC2C2 / 49858
{
	Function_212(&Global_43580, iParam0);
	return;
}

void Function_212(var uParam0, var uParam1) //Position: 0xC2D0 / 49872
{
...
void Function_213() //Position: 0xC2EF / 49903
{
...
void Function_214(var uParam0) //Position: 0xC30B / 49931
{
	uParam0 = uParam0;
	return;
}

void Function_215() //Position: 0xC315 / 49941
{
	return;
}

void Function_216(int iParam0) //Position: 0xC31B / 49947
{
	iParam0 = iParam0;
	return;
}

void Function_217(var uParam0, int iParam1) //Position: 0xC325 / 49957
{
	int iVar0;
...
bool Function_218(int iParam0, int iParam1) //Position: 0xC33F / 49983
{
	int iVar0;
...
void Function_219() //Position: 0xC35C / 50012
{
	return;
}

void Function_220() //Position: 0xC362 / 50018
{
	return;
}

void Function_221(int iParam0) //Position: 0xC368 / 50024
{
	iParam0 = iParam0;
	return;
}

void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC372 / 50034
{
...
void Function_223(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC676 / 50806
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
...
void Function_224(var uParam0, int iParam1) //Position: 0xC882 / 51330
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_225(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC893 / 51347
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
var Function_226(var uParam0, int iParam1) //Position: 0xCF7A / 53114
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF89 / 53129
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_228(var uParam0, bool bParam1) //Position: 0xCFDA / 53210
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD029 / 53289
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD05D / 53341
{
	int iVar0;
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD07A / 53370
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD130 / 53552
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD19C / 53660
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD1BE / 53694
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD1C4 / 53700
{
...
int Function_236(int iParam0) //Position: 0xD1E7 / 53735
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD203 / 53763
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD20A / 53770
{
	Function_239(&uLocal_442, &cLocal_7, "nfactory01", 1, &Global_44085[bParam09] + 32, 0, &iLocal_244 + 96, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "nfactory01", 2, &Global_44085[bParam09] + 32, 0, &iLocal_244 + 96, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "nfactory01", 3, &Global_44085[bParam09] + 32, 0, &iLocal_244 + 96, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "repairStructure01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "repairStructure01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_442, &cLocal_7, "repairStructure01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD30C / 54028
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD40F / 54287
{
	int iVar0;
...
void Function_241() //Position: 0xD440 / 54336
{
	Function_242(&uLocal_9, &uLocal_404, 4, &iLocal_244 + 8, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_404, 5, &iLocal_244 + 96, 4294967295, 258);
	Function_242(&uLocal_9, &uLocal_404, 5, &iLocal_244 + 104, 4294967295, 258);
	Function_242(&uLocal_9, &uLocal_404, 5, &iLocal_244 + 416, 4294967295, 16650);
	Function_242(&uLocal_9, &uLocal_404, 5, &iLocal_244 + 440, 4294967295, 16650);
	Function_242(&uLocal_9, &uLocal_404, 5, &iLocal_244 + 424, 4294967295, 0x1000000);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD4B5 / 54453
{
...
void Function_243(struct<5> Param0) //Position: 0xD5A2 / 54690
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD5B3 / 54707
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD629 / 54825
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD6C7 / 54983
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD6D0 / 54992
{
	cLocal_7 = Function_248(&iLocal_178, "unionpacific", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD6F0 / 55024
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD713 / 55059
{
	return Function_250();
}

int Function_250() //Position: 0xD71C / 55068
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_244 = FIND_NAMED_LAYOUT("PacificUnionRailroadCamp_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_244))
	{
		iLocal_244 = CREATE_LAYOUT("PacificUnionRailroadCamp_layout");
	}
	*(&iLocal_244 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_region", 4,203895E-45f, Vector(-276,533f, 88,48374f, 2108.0f), Vector(0.0f, 1,442405f, 0.0f), Vector(71,23859f, 26,43192f, 65,84873f));
	*(&iLocal_244 + 96) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "uprv_rail_garage_set");
	*(&iLocal_244 + 16[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box", 2,802597E-45f, Vector(-303,9727f, 87,1772f, 2101,977f), Vector(0.0f, 0.0f, 0.0f), Vector(7,93783f, 4,655536f, 23,87166f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[0]);
	*(&iLocal_244 + 16[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box1", 2,802597E-45f, Vector(-291,0089f, 86,47955f, 2102,997f), Vector(0.0f, 0.0f, 0.0f), Vector(4,555228f, 4,416288f, 8,760977f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[1]);
	*(&iLocal_244 + 16[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box2", 2,802597E-45f, Vector(-303,9828f, 89,93198f, 2092,967f), Vector(-21,24749f, 0.0f, 0.0f), Vector(7,899105f, 1.0f, 6,182f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[2]);
	*(&iLocal_244 + 16[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box3", 2,802597E-45f, Vector(-292,2061f, 89,25299f, 2103f), Vector(0.0f, 0.0f, -32,5902f), Vector(5,489248f, 2,347258f, 8,788452f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[3]);
	*(&iLocal_244 + 16[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box4", 2,802597E-45f, Vector(-296,5568f, 92,15102f, 2107,407f), Vector(0,3374383f, 1,850172f, -38,11795f), Vector(5,732241f, 2,603295f, 25,49879f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[4]);
	*(&iLocal_244 + 16[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box5", 2,802597E-45f, Vector(-301,6805f, 91,26135f, 2103,662f), Vector(0,3272007f, -0,1652647f, 20,74546f), Vector(8,950992f, 4,725996f, 17,90949f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[5]);
	*(&iLocal_244 + 16[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box6", 2,802597E-45f, Vector(-300,2626f, 91,97006f, 2116,378f), Vector(0,9871613f, 1,95931f, 33,94175f), Vector(6,173971f, 2,698692f, 7,52782f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[6]);
	*(&iLocal_244 + 16[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box7", 2,802597E-45f, Vector(-298,3304f, 87,02213f, 2107,366f), Vector(0.0f, 0.0f, 0.0f), Vector(10,02958f, 5,703563f, 25,2258f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[7]);
	*(&iLocal_244 + 16[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Box8", 2,802597E-45f, Vector(-307,8334f, 86,72701f, 2114,877f), Vector(0.0f, 0.0f, 0.0f), Vector(9,20863f, 6,721798f, 5,885845f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 96, &iLocal_244 + 16[8]);
	*(&iLocal_244 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_wharehouse", 2,802597E-45f, Vector(-268,3538f, 84,58439f, 2095,652f), Vector(0.0f, 0.0f, 0.0f), Vector(19,65977f, 9,98608f, 7,276427f));
	*(&iLocal_244 + 224) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "uprv_birds_set");
	*(&iLocal_244 + 112[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder", 4,203895E-45f, Vector(-288,4171f, 86,70437f, 2076,95f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[0]);
	*(&iLocal_244 + 112[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder1", 4,203895E-45f, Vector(-267,3666f, 86,70437f, 2098,132f), Vector(0.0f, 20.0f, 0.0f), Vector(16,11971f, 15,45276f, 12,38887f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[1]);
	*(&iLocal_244 + 112[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder2", 4,203895E-45f, Vector(-288,4171f, 86,70437f, 2129,781f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[2]);
	*(&iLocal_244 + 112[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder3", 4,203895E-45f, Vector(-306,1589f, 86,70437f, 2084,923f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[3]);
	*(&iLocal_244 + 112[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder4", 4,203895E-45f, Vector(-305,3243f, 86,70437f, 2127,916f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[4]);
	*(&iLocal_244 + 112[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder5", 4,203895E-45f, Vector(-278,6503f, 86,70437f, 2126,258f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[5]);
	*(&iLocal_244 + 112[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder6", 4,203895E-45f, Vector(-244,5781f, 86,70437f, 2133,737f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[6]);
	*(&iLocal_244 + 112[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder7", 4,203895E-45f, Vector(-287,521f, 86,70437f, 2090,79f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[7]);
	*(&iLocal_244 + 112[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder8", 4,203895E-45f, Vector(-288,4171f, 86,70437f, 2076,95f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[8]);
	*(&iLocal_244 + 112[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nCylinder9", 4,203895E-45f, Vector(-241,9218f, 89,34151f, 2108,085f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[9]);
	*(&iLocal_244 + 112[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder10", 4,203895E-45f, Vector(-281,8465f, 89,34151f, 2108,085f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[10]);
	*(&iLocal_244 + 112[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder11", 4,203895E-45f, Vector(-269,7834f, 89,34151f, 2108,085f), Vector(0.0f, 20.0f, 0.0f), Vector(6,125018f, 8,664046f, 3,739491f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[11]);
	*(&iLocal_244 + 112[12]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder12", 4,203895E-45f, Vector(-260,243f, 85,67178f, 2126,663f), Vector(0.0f, 20.0f, 0.0f), Vector(14,08476f, 9,999254f, 10,8478f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 224, &iLocal_244 + 112[12]);
	*(&iLocal_244 + 296) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "uprv_snakes_set");
	*(&iLocal_244 + 232[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder22", 4,203895E-45f, Vector(-305,046f, 85,3311f, 2154,449f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[0]);
	*(&iLocal_244 + 232[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder13", 4,203895E-45f, Vector(-255,9118f, 85,3311f, 2075,077f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[1]);
	*(&iLocal_244 + 232[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder14", 4,203895E-45f, Vector(-239,0561f, 85,3311f, 2133,486f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[2]);
	*(&iLocal_244 + 232[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder16", 4,203895E-45f, Vector(-280,9818f, 87,07264f, 2150,994f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[3]);
	*(&iLocal_244 + 232[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder17", 4,203895E-45f, Vector(-233,5434f, 85,3311f, 2094,527f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[4]);
	*(&iLocal_244 + 232[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder18", 4,203895E-45f, Vector(-300,1494f, 85,3311f, 2078,184f), Vector(0.0f, 20.0f, 0.0f), Vector(4,896402f, 1.0f, 7,201437f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[5]);
	*(&iLocal_244 + 232[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder20", 4,203895E-45f, Vector(-302,0449f, 87,30672f, 2106,049f), Vector(0.0f, 2,192104f, 0.0f), Vector(17,99822f, 12,46395f, 21,27627f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 296, &iLocal_244 + 232[6]);
	*(&iLocal_244 + 408) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "uprv_dogs_set");
	*(&iLocal_244 + 304[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder34", 4,203895E-45f, Vector(-269,6276f, 85,38675f, 2098,054f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[0]);
	*(&iLocal_244 + 304[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder23", 4,203895E-45f, Vector(-259,2169f, 85,38675f, 2126,819f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[1]);
	*(&iLocal_244 + 304[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder24", 4,203895E-45f, Vector(-306,0565f, 85,38675f, 2126,819f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[2]);
	*(&iLocal_244 + 304[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder25", 4,203895E-45f, Vector(-261,9017f, 85,38675f, 2135,965f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[3]);
	*(&iLocal_244 + 304[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder26", 4,203895E-45f, Vector(-244,2293f, 85,38675f, 2110,657f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[4]);
	*(&iLocal_244 + 304[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder27", 4,203895E-45f, Vector(-279,1176f, 85,38675f, 2089,075f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[5]);
	*(&iLocal_244 + 304[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder28", 4,203895E-45f, Vector(-248,1928f, 85,38675f, 2088,807f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[6]);
	*(&iLocal_244 + 304[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder29", 4,203895E-45f, Vector(-309,2191f, 85,38675f, 2086,472f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[7]);
	*(&iLocal_244 + 304[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder30", 4,203895E-45f, Vector(-263,2665f, 85,38675f, 2116,714f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[8]);
	*(&iLocal_244 + 304[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder31", 4,203895E-45f, Vector(-279,1176f, 85,38675f, 2140,391f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[9]);
	*(&iLocal_244 + 304[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder32", 4,203895E-45f, Vector(-295,9451f, 85,38675f, 2074,522f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[10]);
	*(&iLocal_244 + 304[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "Cylinder33", 4,203895E-45f, Vector(-279,1176f, 85,38675f, 2126,819f), Vector(0.0f, 20.0f, 0.0f), Vector(3,466603f, 3,880696f, 3,861811f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 408, &iLocal_244 + 304[11]);
	*(&iLocal_244 + 416) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_TrnPlatform", 2,802597E-45f, Vector(-263,3087f, 86,66891f, 2119,665f), Vector(0.0f, 0.0f, 0.0f), Vector(14,43368f, 6,369541f, 5,344096f));
	*(&iLocal_244 + 424) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "nuprv_Herd", 2,802597E-45f, Vector(-275,6026f, 84,3294f, 2072.0f), Vector(0.0f, -1,53006f, 0.0f), Vector(16,23215f, 8,401258f, 7,705633f));
	*(&iLocal_244 + 432) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_train_station", 2,802597E-45f, Vector(-172,3959f, 86,23949f, 2071,448f), Vector(0.0f, 0.0f, 0.0f), Vector(5,504734f, 6,265932f, 6,265932f));
	*(&iLocal_244 + 440) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_train_station_platform", 2,802597E-45f, Vector(-171,6638f, 86,23949f, 2068,398f), Vector(0.0f, 0.0f, 0.0f), Vector(11,20949f, 11,46947f, 17,42475f));
	*(&iLocal_244 + 448) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_armwrestling", 2,802597E-45f, Vector(-263,0347f, 84,35147f, 2118,849f), Vector(0.0f, 0.0f, 0.0f), Vector(5,340823f, 7,420619f, 4,080139f));
	*(&iLocal_244 + 480) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_244, "uprv_genworker_set");
	*(&iLocal_244 + 456[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_genworker01", 2,802597E-45f, Vector(-269,2947f, 84,35153f, 2110,276f), Vector(0.0f, 0.0f, 0.0f), Vector(34,40644f, 13,37772f, 12,14555f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 480, &iLocal_244 + 456[0]);
	*(&iLocal_244 + 456[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprv_genworker02", 2,802597E-45f, Vector(-278,725f, 84,35153f, 2094,979f), Vector(0.0f, 0,4032314f, 0.0f), Vector(19,24889f, 13,37772f, 17,74932f));
	ADD_TO_VOLUME_SET(&iLocal_244 + 480, &iLocal_244 + 456[1]);
	*(&iLocal_244 + 488) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprf_zombies_01", 2,802597E-45f, Vector(-278,743f, 83,73338f, 2108,704f), Vector(0.0f, 0.0f, 0.0f), Vector(94,94068f, 11,94434f, 61,30685f));
	*(&iLocal_244 + 496) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprf_zombies_02", 2,802597E-45f, Vector(-301,5572f, 81,90335f, 2106,305f), Vector(0.0f, 0.0f, 0.0f), Vector(16,50631f, 11,94434f, 22,83902f));
	*(&iLocal_244 + 504) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_244, "uprf_zombies_03", 2,802597E-45f, Vector(-280,1126f, 80,42537f, 2131,898f), Vector(0.0f, 90.0f, 0.0f), Vector(24,78508f, 13,22727f, 19,09408f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_report_crime_road", Vector(-312,9127f, 84,32952f, 2069,938f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_clear_bounty", Vector(-169,628f, 84,182f, 2071,095f), Vector(0.0f, 101,237f, 0.0f));
	*(&iLocal_244 + 512) = Vector(-299,3507f, 84,33038f, 2105,254f);
	*(&iLocal_244 + 512 + 12) = Vector(0.0f, -186,7571f, 0.0f);
	*(&iLocal_244 + 536) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_interiorPoint_factory", Vector(-299,3507f, 84,33038f, 2105,254f), Vector(0.0f, -186,7571f, 0.0f));
	*(&iLocal_244 + 544) = Vector(-265,2167f, 84,59452f, 2095,46f);
	*(&iLocal_244 + 544 + 12) = Vector(0.0f, -178,3439f, 0.0f);
	*(&iLocal_244 + 568) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_interiorPoint_factory1", Vector(-265,2167f, 84,59452f, 2095,46f), Vector(0.0f, -178,3439f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos1", Vector(-213,533f, 85,848f, 2118,844f), Vector(-1,352f, 80,408f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos2", Vector(-223,046f, 86,233f, 2065,41f), Vector(-0,522f, 138,056f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos3", Vector(-344,209f, 87,703f, 2076,437f), Vector(-0,868f, -122,689f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos4", Vector(-310,2876f, 84,30087f, 2156,126f), Vector(6,823851f, -39,3588f, -1,115042f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos5", Vector(-234,891f, 85,606f, 2152,366f), Vector(5,468f, 42,857f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos6", Vector(-247,254f, 86,914f, 2111,899f), Vector(0,056f, 109,959f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos7", Vector(-276,294f, 88,03f, 2102,535f), Vector(0,246f, 141,537f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos8", Vector(-295,29f, 87,218f, 2118,052f), Vector(-2,832f, 27,458f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos9", Vector(-297,1f, 87,015f, 2117,951f), Vector(-1,573f, -51,539f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "upr_vista_cam_pos10", Vector(-281,771f, 88,097f, 2121,184f), Vector(-6,186f, -58,68f, 0.0f));
	*(&iLocal_244 + 576) = Vector(-300,4244f, 84,33038f, 2110,669f);
	*(&iLocal_244 + 576 + 12) = Vector(0.0f, 108,2563f, 0.0f);
	*(&iLocal_244 + 600) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_interiorSettlement01", Vector(-300,4244f, 84,33038f, 2110,669f), Vector(0.0f, 108,2563f, 0.0f));
	*(&iLocal_244 + 608) = Vector(-263,7625f, 84,59452f, 2095,46f);
	*(&iLocal_244 + 608 + 12) = Vector(0.0f, 162,509f, 0.0f);
	*(&iLocal_244 + 632) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_244, "uprf_interiorSettlement02", Vector(-263,7625f, 84,59452f, 2095,46f), Vector(0.0f, 162,509f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xED1B / 60699
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xED65 / 60773
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xED76 / 60790
{
	return;
}

bool Function_254() //Position: 0xED7C / 60796
{
	return 1;
}

void Function_255() //Position: 0xED83 / 60803
{
...
bool Function_256() //Position: 0xEDEC / 60908
{
	return Function_257();
}

int Function_257() //Position: 0xEDF5 / 60917
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("PacificUnionRailroadCamp_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("PacificUnionRailroadCamp_layout");
	}
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-280,2569f, 89,59232f, 2124,018f), Vector(0.0f, -35,12527f, 0.0f), Vector(5,607125f, 5.0f, 6,496716f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-291,1284f, 89,65588f, 2103,068f), Vector(0.0f, 0.0f, 0.0f), Vector(5,607125f, 5.0f, 10,17819f));
	*(&iLocal_178 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-260,4551f, 87,56374f, 2128,368f), Vector(0.0f, 0.0f, 0.0f), Vector(20,12525f, 13,39205f, 13,90067f));
	*(&iLocal_178 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_4", 2,802597E-45f, Vector(-256,213f, 86,45366f, 2095,656f), Vector(0.0f, 0.0f, 0.0f), Vector(6,376537f, 10.0f, 7,492531f));
	*(&iLocal_178 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_5", 2,802597E-45f, Vector(-262,0844f, 84,98093f, 2110,135f), Vector(0.0f, 0.0f, 0.0f), Vector(4,679916f, 10.0f, 4,757069f));
	*(&iLocal_178 + 120) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_6", 2,802597E-45f, Vector(-268,9918f, 84,23763f, 2109,383f), Vector(0.0f, 0.0f, 0.0f), Vector(4,679916f, 10.0f, 2,643277f));
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-292,8015f, 87,57394f, 2103,907f), Vector(0.0f, 114,6045f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 128);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-264,2712f, 89,21505f, 2123,425f), Vector(0.0f, -12,04787f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 128);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-278,616f, 87,54498f, 2122,99f), Vector(0.0f, -54,97743f, 0.0f));
	DECOR_SET_BOOL(&uVar3, "Core", true);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-279,9684f, 87,54498f, 2121,829f), Vector(0.0f, -125,4354f, 0.0f));
	DECOR_SET_BOOL(&uVar4, "Core", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 136);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-278,6554f, 87,54498f, 2122,746f), Vector(0.0f, 55,68426f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", true);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 136);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-292,6688f, 87,57394f, 2105,308f), Vector(0.0f, 5,330732f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 136);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-292,8015f, 87,57394f, 2103,907f), Vector(0.0f, 185,4322f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 136);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-264,3274f, 89,19033f, 2124,802f), Vector(0.0f, -0,3880508f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 136);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-264,2712f, 89,21505f, 2123,425f), Vector(0.0f, 178,1479f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 136);
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-267,5878f, 89,12824f, 2124,313f), Vector(0.0f, 50.0f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 144);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-282,6772f, 87,5775f, 2124,748f), Vector(0.0f, 94,8221f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 144);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04_core", Vector(-264,2712f, 89,21505f, 2123,425f), Vector(0.0f, -11,4417f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", true);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 144);
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_player", Vector(-267,6339f, 89,12824f, 2125,712f), Vector(0.0f, 357,7919f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 152);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_05_surv", Vector(-267,5878f, 89,12824f, 2124,313f), Vector(0.0f, 178,2213f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 152);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_player", Vector(-281,8271f, 87,60403f, 2126,125f), Vector(0.0f, 42,07525f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 152);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_06_surv", Vector(-282,9262f, 87,60403f, 2124,946f), Vector(0.0f, 223,5215f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_defSet", &iLocal_178, 8, 0);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-267,5878f, 89,12824f, 2124,313f), Vector(0.0f, 50.0f, 0.0f));
	DECOR_SET_INT(&uVar17, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 160);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09", Vector(-278,6184f, 87,54475f, 2122,993f), Vector(0.0f, -54,87802f, 0.0f));
	DECOR_SET_INT(&uVar18, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 160);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-255,6455f, 87,28313f, 2096,616f), Vector(0.0f, -126,0832f, 0.0f));
	DECOR_SET_BOOL(&uVar19, "Core", true);
	DECOR_SET_INT(&uVar19, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_player", Vector(-255,6446f, 87,28313f, 2095,216f), Vector(0.0f, 180,1841f, 0.0f));
	DECOR_SET_BOOL(&uVar20, "Core", true);
	DECOR_SET_INT(&uVar20, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 168);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_surv", Vector(-255,6455f, 87,28313f, 2096,616f), Vector(0.0f, -0,07498666f, 0.0f));
	DECOR_SET_BOOL(&uVar21, "Core", true);
	DECOR_SET_INT(&uVar21, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 168);
	*(&iLocal_178 + 176) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-279,0436f, 87,44022f, 2122,785f), Vector(0.0f, -28,7239f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 176);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-259,1684f, 85,13748f, 2121,074f), Vector(0.0f, 47,78498f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 176);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-261,392f, 85,11736f, 2122,839f), Vector(0.0f, 5,511367f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar24, &iLocal_178 + 176);
	*(&iLocal_178 + 184) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar25 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-296,3387f, 84,35152f, 2124,233f), Vector(0.0f, -134,5996f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar25, &iLocal_178 + 184);
	uVar26 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-277,3621f, 84,58439f, 2094,807f), Vector(0.0f, -90.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar26, &iLocal_178 + 184);
	*(&iLocal_178 + 192) = Vector(-298,7082f, 84,35147f, 2134,708f);
	*(&iLocal_178 + 192 + 12) = Vector(0.0f, 59,32771f, 0.0f);
	*(&iLocal_178 + 216) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-298,7082f, 84,35147f, 2134,708f), Vector(0.0f, 59,32771f, 0.0f));
	*(&iLocal_178 + 224) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-279,0454f, 87,53468f, 2122,777f), Vector(0.0f, -29,03983f, 0.0f));
	*(&iLocal_178 + 232) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl", "DLC_survivor_stand_rfl", Vector(-259,1227f, 85,13748f, 2121,12f), Vector(0.0f, 47,70347f, 0.0f));
	*(&iLocal_178 + 240) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_low_wall_rfl", "DLC_survivor_low_wall_rfl", Vector(-261,3938f, 85,12666f, 2122,624f), Vector(0.0f, 180,5309f, 0.0f));
	*(&iLocal_178 + 248) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_L", "ZombiePack_player_sleep_bed_L", Vector(-298,4734f, 84,34794f, 2136,253f), Vector(0.0f, -119,9046f, 0.0f));
	PushArrayP();
	*(&iLocal_178 + 256) = CREATE_PATH_IN_LAYOUT_FROM_TABLE(StackVal, &iLocal_178, "uprp_patrolpath");
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xFD57 / 64855
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xFDF2 / 65010
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xFEFE / 65278
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xFFDA / 65498
{
...
int Function_262(int iParam0) //Position: 0x10056 / 65622
{
...
bool Function_263(int iParam0) //Position: 0x1006B / 65643
{
...
int Function_264(int iParam0) //Position: 0x100D1 / 65745
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0x10193 / 65939
{
	int iVar0;
...
void Function_266() //Position: 0x101B0 / 65968
{
	return;
}

void Function_267(char* cParam0) //Position: 0x101B6 / 65974
{
	if (!Function_26(128))
	{
		return;
