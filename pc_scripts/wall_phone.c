...
void Function_84(var uParam0, bool bParam1) //Position: 0x3702 / 14082
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3812 / 14354
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x382A / 14378
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B46 / 15174
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3B58 / 15192
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3B72 / 15218
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3B8D / 15245
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3BCB / 15307
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3BE4 / 15332
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3EDC / 16092
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3EFA / 16122
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3F9A / 16282
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3FBA / 16314
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FCD / 16333
{
...
void Function_98(int iParam0) //Position: 0x3FE9 / 16361
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x3FF5 / 16373
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4063 / 16483
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x407B / 16507
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	{
		uVar0 = GRINGO_GET_USE_COMPONENT_EXT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1");
		bVar1 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, &uVar0, 0);
		uVar2 = GRINGO_GET_INDEXED_CHILD_COMPONENT(bVar1, &uVar0);
		uVar3 = GRINGO_GET_PROP_FROM_COMPONENT_EXT(&uVar2, GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()));
		if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
		{
			uVar4 = GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT());
			if (IS_PHYSINST_VALID(&uVar4) && IS_PHYSINST_VALID(&uVar3))
			{
				if (IS_PHYSINST_IN_LEVEL(&uVar4) && IS_PHYSINST_IN_LEVEL(&uVar3))
				{
					iVar5 = CREATE_LEASH_OBJECT(GRINGO_GET_MY_OBJECT_REF(), Function_39(), 0,75f, 10, 0, 0,0025f, 10.0f, 10000.0f, 200.0f, 0.0f, 100.0f, 1.0f, 0, 0, 1);
					LEASH_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &iVar5, &uVar3, "grab", Vector(0.0f, -0,06f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0, 0);
					LEASH_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &iVar5, GET_TARGET_OBJECT(), "base", Vector(0.0f, 0,025f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 1, 0);
					LEASH_SET_LEASH_LENGTH(&iVar5, 0,75f);
					LEASH_CONSTRAIN(&iVar5);
					LEASH_SET_CONSTRAINT_LENGTH(&iVar5, 0,75f);
...
void Function_102(bool bParam0) //Position: 0x41C2 / 16834
{
