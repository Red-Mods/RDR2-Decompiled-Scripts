...
void main() //Position: 0x0 / 0
{
	...
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_77);
		}
		iVar2 = 0;
		bLocal_84 = false;
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_85))
								{
									...
									{
										bLocal_85 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_85 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_82, &uLocal_80);
...
void Function_75(struct<69> Param0) //Position: 0x2D0B / 11531
{
	...
	if (&Param0 + 16 == &iLocal_82)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_80));
		iLocal_82 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3C98 / 15512
{
	...
	if (0 == DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "UseStage"))
	{
		return 0;
	}
	if (!IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_95(int iParam0) //Position: 0x3CDA / 15578
{
...
void Function_96(int iParam0) //Position: 0x3CF6 / 15606
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3D02 / 15618
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_98(&(vLocal_2[iLocal_769]), &uParam0);
		iLocal_76++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3D6E / 15726
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3D86 / 15750
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3D92 / 15762
{
