...
void Function_83(var uParam0, int iParam1) //Position: 0x36F0 / 14064
{
	struct<2> Var0;
	struct<2> Var2;
	var uVar4;
	...
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	uVar4 = GRINGO_GET_FIRST_CHILD(1, &iParam1);
	if (IS_GRINGO_COMPONENT_VALID(&uVar4))
	{
		GET_OBJECT_ORIENTATION(GRINGO_GET_PHYSINST(&uVar4), &Var0);
		GET_OBJECT_POSITION(GRINGO_GET_PHYSINST(&uVar4), &Var2);
		if (IS_LAYOUTREF_VALID(&Global_46715))
		{
			CREATE_PROP_IN_LAYOUT(&Global_46715, "local", "p_gen_map02x", Var2, Var0, 1);
		}
		else
		{
			CREATE_PROP_IN_LAYOUT(GET_AMBIENT_LAYOUT(), "ambient", "p_gen_map02x", Var2, Var0, 1);
		}
		DESTROY_OBJECT(GRINGO_GET_PHYSINST(&uVar4));
	}
	DECOR_SET_INT(&uParam0, "Player_hasPlacedMap", true);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x37B8 / 14264
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x38C8 / 14536
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x38E0 / 14560
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3BFC / 15356
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3C0E / 15374
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C28 / 15400
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C43 / 15427
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C81 / 15489
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C9A / 15514
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F92 / 16274
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FB0 / 16304
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4051 / 16465
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4071 / 16497
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x4084 / 16516
{
...
void Function_98(int iParam0) //Position: 0x40A0 / 16544
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x40AC / 16556
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4118 / 16664
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x4130 / 16688
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x413C / 16700
{
