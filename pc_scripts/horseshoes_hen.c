...
bool Function_15() //Position: 0x411 / 1041
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_23(Global_46816[0], &Local_35 + 4, &Local_35 + 104, &Local_35 + 112, &Local_35 + 92, &Local_35 + 96))
			{
				Function_22(&Local_35 + 4);
				Function_21(Global_46816[0], 0);
				(&Local_35 + 28[02]) = Function_21(Global_46816[0], 0);
				Function_21(Global_46816[0], 1);
				*(&Local_35 + 28[12]) = Function_21(Global_46816[0], 1);
				Local_35 = Local_7;
				Local_35.f_84 = 1;
				if (Function_20())
				{
				...
				*(&Local_35 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_5, "StayOutVol", 2,802597E-45f, Vector(-820,343f, 93,33113f, 2349,59f), Vector(0.0f, -91,07706f, 0.0f), Vector(8,22709f, 3,373459f, 21,7038f));
