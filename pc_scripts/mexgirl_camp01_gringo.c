...
{
	Function_24();
	Function_4(8, &uLocal_31, &iLocal_33, &uLocal_13, &iLocal_0, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x253 / 595
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6C5 / 1733
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x6F9 / 1785
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA3B / 2619
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA6E / 2670
{
...
void Function_9(int iParam0) //Position: 0xA85 / 2693
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAB1 / 2737
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xACB / 2763
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAE8 / 2792
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBAE / 2990
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD77 / 3447
{
...
void Function_15(int iParam0) //Position: 0xDB4 / 3508
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDCD / 3533
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDDA / 3546
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xECF / 3791
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF35 / 3893
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xF97 / 3991
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFCC / 4044
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11E5 / 4581
{
	struct<2> Var0;
...
struct<8> Function_23(var uParam0) //Position: 0x125C / 4700
{
	struct<2> Var0;
...
void Function_24() //Position: 0x12C8 / 4808
{
	RELEASE_LAYOUT_REF(&iLocal_0);
	return;
}

void Function_25(int iParam0) //Position: 0x12D4 / 4820
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x12FC / 4860
{
...
void Function_27(struct<13> Param0) //Position: 0x1447 / 5191
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x1464 / 5220
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x1482 / 5250
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_35 || bParam2) || Global_6611)
			{
				if (Function_154(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_152(&Param0 + 324, &fLocal_37, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_141(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_37, 20.0f, fLocal_37));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_69(StackVal, StackVal, &Param0 + 16, Function_141(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_38, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x2641 / 9793
{
...
void Function_31(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2653 / 9811
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_32(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x288C / 10380
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_33(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28AC / 10412
{
	bool bVar0;
	var uVar1;
...
int Function_34(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x299A / 10650
{
	char* cVar0[32];
...
int Function_35(int iParam0) //Position: 0x2C06 / 11270
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_36(var uParam0, bool bParam1) //Position: 0x2C2A / 11306
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2C4E / 11342
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C74 / 11380
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2C9B / 11419
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_40(bool bParam0) //Position: 0x2CBF / 11455
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_41() //Position: 0x2CDE / 11486
{
...
bool Function_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D2D / 11565
{
	bool bVar0;
	var uVar1;
...
bool Function_43(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D89 / 11657
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2DAA / 11690
{
	bool bVar0;
	var uVar1;
...
void Function_45(var uParam0, var uParam1, bool bParam2) //Position: 0x2E05 / 11781
{
	bool bVar0;
	var uVar1;
...
var Function_46() //Position: 0x2E51 / 11857
{
...
void Function_47(struct<425> Param0) //Position: 0x2E66 / 11878
{
	bool bVar0;
	bool bVar1;
...
bool Function_48(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FB9 / 12217
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
bool Function_49(vector3 vParam0) //Position: 0x302E / 12334
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_50(var uParam0) //Position: 0x3046 / 12358
{
	bool bVar0;
	int iVar1;
...
var Function_51(bool bParam0) //Position: 0x30A4 / 12452
{
	bool bVar0;
	bool bVar1;
...
void Function_52(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30F1 / 12529
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x316A / 12650
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0) //Position: 0x31B9 / 12729
{
	struct<21> Var0;
...
bool Function_55() //Position: 0x3278 / 12920
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_56(struct<25> Param0) //Position: 0x328B / 12939
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_57(int iParam0) //Position: 0x3352 / 13138
{
...
bool Function_58(int iParam0) //Position: 0x3372 / 13170
{
...
bool Function_59(int iParam0) //Position: 0x3396 / 13206
{
...
bool Function_60(int iParam0) //Position: 0x33AB / 13227
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x33C2 / 13250
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3400 / 13312
{
...
bool Function_63(int iParam0) //Position: 0x341A / 13338
{
...
int Function_64(int iParam0, struct<6> Param1) //Position: 0x3430 / 13360
{
	int iVar0;
...
void Function_65(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x346A / 13418
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_66(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x354F / 13647
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_67(var uParam0, bool bParam1) //Position: 0x3706 / 14086
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_68(bool bParam0) //Position: 0x372B / 14123
{
	var uVar0;
	int iVar1;
...
var Function_69(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3779 / 14201
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_70(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38D0 / 14544
{
	var uVar0[5];
	int iVar6;
...
int Function_71(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x397B / 14715
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3A21 / 14881
{
	Function_105(&uLocal_13, "$/content/scripting/gringo/simplegringo/mexGirl01_idles", 1, 0);
	Function_149(&uLocal_13, 1199, 3, 0);
	Function_149(&uLocal_13, 622, 3, 0);
	Function_149(&uLocal_13, 619, 3, 0);
	if (Function_86(&uLocal_31, &uLocal_13, 34, 1, 1, 0, 0, 0, 0, 0, 0))
	{
		if (Function_83(&iParam1))
		{
			iLocal_33 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&iLocal_0, Function_141()));
			*(&Global_6667[3428] + 216) = &iLocal_33;
			*(&iParam0 + 24) = &iLocal_0;
			Function_73();
			return 1;
		}
...
void Function_73() //Position: 0x3AD8 / 15064
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	Var0 = Vector(-2151,502f, 19,459f, 4970,023f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_31, Var0, 157,073f, 1, 1, 1);
	TASK_STAND_STILL(&uLocal_31, -1.0f, 0, 0);
	Function_81(&uLocal_31, &iLocal_33, 1, 1);
	uVar2 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "mexgirl01campmother", 622, Vector(-2147,2f, 18,176f, 4964,265f), Vector(-0,012f, 0,116f, 0,993f));
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "mexgirl01campsister", 619, Vector(-2146,6f, 18,176f, 4964,265f), Vector(-0,012f, 0,116f, 0,993f));
	SET_OBJECT_COLLIDE_WITH_OBJECT(&uVar2, &uVar3, 0);
	Function_80(&iLocal_0 + 16[0]);
	Function_79(&iLocal_0 + 16[0]);
	uVar4 = CREATE_GRINGO_IN_LAYOUT(&iLocal_0, "nmothersit", "mexGirl01_idles", Function_80(&iLocal_0 + 16[0]), Function_79(&iLocal_0 + 16[0]));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar4), 0);
	SNAP_ACTOR_TO_GRINGO(&uVar2, &uVar4, "mom", true, 0, 0);
	TASK_USE_GRINGO(&uVar2, GET_GRINGO_FROM_OBJECT(&uVar4), "mom", 4294967295, 1);
	Function_81(&uVar2, &iLocal_33, 1, 1);
	Function_80(&iLocal_0 + 16[1]);
	Function_79(&iLocal_0 + 16[1]);
	uVar4 = CREATE_GRINGO_IN_LAYOUT(&iLocal_0, "nsistersit", "mexGirl01_idles", Function_80(&iLocal_0 + 16[1]), Function_79(&iLocal_0 + 16[1]));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar4), 0);
	SNAP_ACTOR_TO_GRINGO(&uVar3, &uVar4, "sister", true, 0, 0);
	TASK_USE_GRINGO(&uVar3, GET_GRINGO_FROM_OBJECT(&uVar4), "sister", 4294967295, 1);
	Function_81(&uVar3, &iLocal_33, 1, 1);
	if (!Function_78("MexGirl01Wagon", &iVar5, &iLocal_0, 0))
	{
		iVar5 = Function_74(StackVal, StackVal, &iLocal_0, "MexGirl01Wagon", 1199, 976, Vector(-2142,45f, 18,21f, 4962,98f), Vector(0.0f, 13,68f, 0.0f), 1, 976, 976, 976, 4);
	}
	Function_81(&iVar5, &iLocal_33, 1, 1);
	return;
}

int Function_74(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x3D07 / 15623
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
...
bool Function_75(int iParam0, bool[] bParam1) //Position: 0x3F5A / 16218
{
	int iVar0;
...
var Function_76(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x3F8E / 16270
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_77(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3FAA / 16298
{
...
bool Function_78(var uParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x3FD6 / 16342
{
	var uVar0;
	var uVar1;
	var uVar2;
...
struct<8> Function_79(int iParam0) //Position: 0x4107 / 16647
{
	struct<2> Var0;
...
struct<8> Function_80(int iParam0) //Position: 0x4130 / 16688
{
	struct<2> Var0;
...
void Function_81(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x4159 / 16729
{
	bool bVar0;
	int iVar1;
...
bool Function_82(int iParam0, int iParam1, bool bParam2) //Position: 0x4316 / 17174
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_83(var uParam0) //Position: 0x435E / 17246
{
	var uVar0;
	
	Function_85(3, 2);
	uVar0 = &uVar0;
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("mexgirl_camp01_layout"));
	(&iLocal_0 + 8) = CREATE_OBJECTSET_IN_LAYOUT("GringoFlagsSet", &iLocal_0, 8, 0);
	*(&iLocal_0 + 16[0]) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "MomFlag", Vector(-0,9973148f, -0,1128953f, 3,50209f), Vector(0.0f, -180.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&iLocal_0 + 16[0], &iLocal_0 + 8);
	*(&iLocal_0 + 16[1]) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "SisterFlag", Vector(-0,3182978f, -0,1283147f, 3,498401f), Vector(0.0f, -180.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&iLocal_0 + 16[1], &iLocal_0 + 8);
	Function_84(&iLocal_0, &uParam0);
	return 1;
}

void Function_84(int iParam0, var uParam1) //Position: 0x443E / 17470
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &uParam1, Function_141(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
void Function_85(int iParam0, bool bParam1) //Position: 0x4489 / 17545
{
	switch (&bParam1)
	{
		case 0x00000000:
...
bool Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x44D3 / 17619
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x46B2 / 18098
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x4BF2 / 19442
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_89(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4C14 / 19476
{
	var uVar0;
...
var Function_90(bool bParam0, int iParam1) //Position: 0x4C75 / 19573
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x4D03 / 19715
{
	Function_93(&uParam0);
	Function_92(&uParam0);
...
void Function_92(int iParam0) //Position: 0x4D2F / 19759
{
...
void Function_93(int iParam0) //Position: 0x4D55 / 19797
{
...
bool Function_94(bool bParam0) //Position: 0x4E2B / 20011
{
...
var Function_95(int iParam0, int iParam1) //Position: 0x4E42 / 20034
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x4EE8 / 20200
{
	var uVar0;
	var uVar1;
...
void Function_97(var uParam0) //Position: 0x4FF7 / 20471
{
	int iVar0;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x502A / 20522
{
	int iVar0;
...
bool Function_99(var uParam0, struct<2> Param1, float fParam3) //Position: 0x5047 / 20551
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_23(&uParam0);
...
void Function_100() //Position: 0x50D3 / 20691
{
	var uVar0;
	int iVar1;
...
bool Function_101(int iParam0) //Position: 0x5143 / 20803
{
...
bool Function_102(int iParam0) //Position: 0x515F / 20831
{
...
var Function_103(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x5175 / 20853
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_104(struct<205> Param0) //Position: 0x521B / 21019
{
	var uVar0;
	var uVar1;
...
var Function_105(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5326 / 21286
{
	int iVar0;
	int iVar1;
...
void Function_106(struct<13> Param0) //Position: 0x5364 / 21348
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_107(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5377 / 21367
{
	int iVar0;
...
bool Function_108(struct<2>[] Param0) //Position: 0x5446 / 21574
{
	int iVar0;
	int iVar1;
		...
		if (Function_28(&(Param0[iVar02]), 4))
		{
			if (!Function_28(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_28(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_109() //Position: 0x5808 / 22536
{
	if (!Function_156(128))
	{
		return;
...
bool Function_110() //Position: 0x5848 / 22600
{
	int iVar0;
...
void Function_111() //Position: 0x5876 / 22646
{
	if (!Function_156(128))
	{
		return;
...
void Function_112(vector3 vParam0) //Position: 0x58B8 / 22712
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5950 / 22864
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x597F / 22911
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x59DA / 23002
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x59EA / 23018
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x59FE / 23038
{
	int iVar0;
...
var Function_118() //Position: 0x5A23 / 23075
{
	return "PackedMetadata";
}

void Function_119(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5A3A / 23098
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_120() //Position: 0x5B76 / 23414
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_121() //Position: 0x5B88 / 23432
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_122() //Position: 0x5B9A / 23450
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_123(var uParam0, struct<5> Param1) //Position: 0x5BAC / 23468
{
...
var Function_124(var uParam0, int iParam1, int iParam2) //Position: 0x5BD1 / 23505
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x5BF0 / 23536
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_126() //Position: 0x5BFC / 23548
{
	return Function_127(39);
}

int Function_127(int iParam0) //Position: 0x5C07 / 23559
{
	int iVar0;
...
var Function_128() //Position: 0x5C35 / 23605
{
	return "PackedWeapon";
}

int Function_129(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5C4A / 23626
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_130() //Position: 0x5D57 / 23895
{
	return "MPItemGiver";
}

struct<32> Function_131(char* cParam0) //Position: 0x5D6B / 23915
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0) //Position: 0x5DD7 / 24023
{
	char* cVar0[32];
...
var Function_133() //Position: 0x5DF9 / 24057
{
	return "PBox_";
}

var Function_134() //Position: 0x5E07 / 24071
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x5E2D / 24109
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5E55 / 24149
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(var uParam0, int iParam1) //Position: 0x5E7B / 24187
{
	int iVar0;
	var uVar1;
...
void Function_138(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5FE5 / 24549
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x608D / 24717
{
	int iVar0;
	struct<2> Var1;
...
void Function_140(int iParam0) //Position: 0x61FB / 25083
{
...
var Function_141() //Position: 0x6263 / 25187
{
	int iVar0;
...
var Function_142(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x626C / 25196
{
	return Function_143(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_143(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x628A / 25226
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x6583 / 25987
{
	int iVar0;
...
void Function_145() //Position: 0x6637 / 26167
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x6672 / 26226
{
	int iVar0;
...
void Function_147(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x669F / 26271
{
	bool bVar0;
...
void Function_148() //Position: 0x67FA / 26618
{
	int iVar0;
...
var Function_149(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6846 / 26694
{
	int iVar0;
...
int Function_150() //Position: 0x6922 / 26914
{
	int iVar0;
...
int Function_151() //Position: 0x6A7E / 27262
{
	int iVar0;
...
bool Function_152(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6B9E / 27550
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_153(struct<2> Param0) //Position: 0x6C7A / 27770
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_154(struct<2> Param0, struct<5> Param2) //Position: 0x6C99 / 27801
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_155(int iParam0) //Position: 0x6DDC / 28124
{
	var uVar0;
...
bool Function_156(int iParam0) //Position: 0x6DFE / 28158
{
	int iVar0;
...
int Function_157() //Position: 0x6E1A / 28186
{
	return 0;
}

void Function_158(struct<321> Param0) //Position: 0x6E21 / 28193
{
	var uVar0;
