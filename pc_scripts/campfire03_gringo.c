...
void Function_60(int iParam0, int iParam1) //Position: 0x3417 / 13335
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x3462 / 13410
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x34A0 / 13472
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x34B3 / 13491
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3582 / 13698
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x35CC / 13772
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x398E / 14734
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x39CE / 14798
{
	int iVar0;
...
void Function_68() //Position: 0x39FC / 14844
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3A3E / 14910
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3AD6 / 15062
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3B05 / 15109
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3B60 / 15200
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3B70 / 15216
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3B84 / 15236
{
	int iVar0;
...
var Function_75() //Position: 0x3BA9 / 15273
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3BC0 / 15296
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3CFC / 15612
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3D0E / 15630
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3D20 / 15648
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3D32 / 15666
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3D57 / 15703
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3D76 / 15734
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3D82 / 15746
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3D8D / 15757
{
	int iVar0;
...
var Function_85() //Position: 0x3DBB / 15803
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3DD0 / 15824
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3EDD / 16093
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3EF1 / 16113
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x3F5D / 16221
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3F7F / 16255
{
	return "PBox_";
}

var Function_91() //Position: 0x3F8D / 16269
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3FB3 / 16307
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3FDB / 16347
{
