...
void main() //Position: 0x0 / 0
{
	...
	iLocal_118 = 0;
	Function_106(&uScriptParam_0, &iLocal_118);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_99(&(vLocal_8[iVar39]), &bVar4))
						{
							Function_97(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_8[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_92("eGRINGO_EndUse: Stop use by request", &vLocal_8[iVar39] + 24);
							Function_91(&vLocal_8[iVar39] + 24, 1);
							...
							{
								Function_84(&(vLocal_8[iVar39]), 0);
							}
							else if (vLocal_8[iVar39].f_68 < 8)
							{
								Function_83(&(vLocal_8[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_127))
	{
		Function_109("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_127);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_118 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x498 / 1176
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_127))
								{
									...
									{
										bLocal_127 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_127 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_127))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_127))
		{
			Function_109("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_127);
		}
...
bool Function_16(struct<69> Param0) //Position: 0xAD8 / 2776
{
	...
	{
		Function_92("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_92("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_92("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_42(&Param0, &uVar7, &iLocal_124, &uLocal_122);
		...
		case 0x00000006:
			...
			bVar0 = Function_52(&Param0 + 24, &Param0 + 16, Function_82(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
float Function_23(int iParam0) //Position: 0x1F75 / 8053
{
...
int Function_25(int iParam0) //Position: 0x1F99 / 8089
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1FBA / 8122
{
	var uVar0[2];
	...
	if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "nOpen_Door"))
	{
		...
		OPEN_DOOR_DIRECTION(&(uVar0[0]), 1);
		OPEN_DOOR_DIRECTION(&(uVar0[1]), 0);
...
void Function_27(var uParam0, int iParam1) //Position: 0x2097 / 8343
{
...
int Function_28(var uParam0, var uParam1, int iParam2) //Position: 0x20EF / 8431
{
	return Function_29(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_29(int iParam0, char* cParam1, bool bParam3) //Position: 0x2103 / 8451
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_30(int iParam0) //Position: 0x21A8 / 8616
{
...
bool Function_31(bool bParam0) //Position: 0x21BE / 8638
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_32() //Position: 0x21DE / 8670
{
	return;
}

void Function_33(int iParam0, bool bParam1) //Position: 0x21E4 / 8676
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_34(char* cParam0) //Position: 0x21F6 / 8694
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_35(int iParam0) //Position: 0x2203 / 8707
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_36(char* cParam0, int iParam1) //Position: 0x221E / 8734
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_37(int iParam0) //Position: 0x223E / 8766
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_38(int iParam0) //Position: 0x225E / 8798
{
	int iVar0;
	int iVar1;
...
bool Function_39(int iParam0) //Position: 0x2295 / 8853
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_40(int iParam0) //Position: 0x22B5 / 8885
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x22D0 / 8912
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x22E6 / 8934
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_43() //Position: 0x260A / 9738
{
	int iVar0;
...
bool Function_44(char* cParam0, int iParam1) //Position: 0x2613 / 9747
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_45() //Position: 0x2632 / 9778
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x2641 / 9793
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_47(char* cParam0, int iParam1) //Position: 0x2665 / 9829
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_48(int iParam0) //Position: 0x268B / 9867
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_49(var uParam0, int iParam1) //Position: 0x26A9 / 9897
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_50(var uParam0, int iParam1) //Position: 0x26CB / 9931
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_51(bool bParam0, int iParam1) //Position: 0x26ED / 9965
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_52(var uParam0, int iParam1, bool bParam2) //Position: 0x27B5 / 10165
{
	int iVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x2831 / 10289
{
...
void Function_54(vector3 vParam0) //Position: 0x2849 / 10313
{
...
var Function_55(int iParam0) //Position: 0x286E / 10350
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_56(vector3 vParam0) //Position: 0x288F / 10383
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x28A6 / 10406
{
	uParam0 = &uParam0;
	return;
}

int Function_58() //Position: 0x28B2 / 10418
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x28B9 / 10425
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_60(int iParam0, var uParam1, int iParam2) //Position: 0x28CA / 10442
{
	float fVar0;
...
int Function_61(int iParam0) //Position: 0x290F / 10511
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(int iParam0) //Position: 0x293B / 10555
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_63(int iParam0) //Position: 0x2947 / 10567
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_64(int iParam0) //Position: 0x2A49 / 10825
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_65(int iParam0) //Position: 0x2A6C / 10860
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(int iParam0) //Position: 0x2A94 / 10900
{
	struct<8> Var0;
	...
	if (iLocal_1 && !iLocal_0)
	{
		...
		uLocal_2 = CREATE_LAYOUT(&Var0);
		iLocal_4 = Function_67(&uLocal_2, 0, 1, 0, 0);
	}
	return;
}

int Function_67(var uParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2ADA / 10970
{
	var uVar0;
	
	if (&bParam2)
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, Function_43(), 1, 1);
	}
	else
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "BigDoorOpen", 1, 1);
	}
	Function_68(&uVar0);
...
void Function_68(int iParam0) //Position: 0x2B5F / 11103
{
	var uVar0;
...
void Function_69(int iParam0) //Position: 0x2B8C / 11148
{
	...
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-2649,763f, 68,01277f, 3419,051f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(0,26214f, -0,465322f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

struct<32> Function_70(char* cParam0) //Position: 0x2C01 / 11265
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_71(char* cParam0) //Position: 0x2C6D / 11373
{
	char* cVar0[32];
...
void Function_72(int iParam0) //Position: 0x2C8F / 11407
{
	iParam0 = &iParam0;
	return;
}

bool Function_73(int iParam0) //Position: 0x2C9B / 11419
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_74(int iParam0) //Position: 0x2CBA / 11450
{
	if (!Function_14(&iParam0))
	{
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CD1 / 11473
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
	...
	{
		return Function_79(&uParam0, &iParam1);
	}
	uVar3 = Function_78(&iParam1);
	uVar4 = Function_61(&iParam1);
	Function_76(&iParam1);
	iVar5 = Function_76(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(&uParam0, &Var0, &iVar5, uVar3, 0,2f, 1, bVar2, uVar4, 0, 0);
}

struct<8> Function_76(int iParam0) //Position: 0x2D62 / 11618
{
	struct<2> Var0;
	
	Var0 = Vector(0.0f, 0.0f, 0.0f);
	Function_77(StackVal, &iParam0, "UserOffset", Var0);
	return StackVal, Function_77(StackVal, &iParam0, "UserOffset", Var0);
}

struct<8> Function_77(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D86 / 11654
{
	struct<2> Var0;
...
int Function_78(int iParam0) //Position: 0x2DA5 / 11685
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_79(var uParam0, int iParam1) //Position: 0x2DC9 / 11721
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_80(var uParam0, int iParam1) //Position: 0x2EF1 / 12017
{
...
int Function_81(var uParam0) //Position: 0x2F1F / 12063
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_82(var uParam0, int iParam1) //Position: 0x3038 / 12344
{
	return (uParam0 && iParam1) == 0;
}

void Function_83(struct<69> Param0) //Position: 0x3045 / 12357
{
	if (Function_82(Param0.f_64, 16))
	{
...
void Function_84(struct<69> Param0) //Position: 0x30C7 / 12487
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_85() //Position: 0x3672 / 13938
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x36AC / 13996
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_87(int iParam0, var uParam1) //Position: 0x36CA / 14026
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_88(int iParam0) //Position: 0x370B / 14091
{
	iParam0 = &iParam0;
	return;
}

bool Function_89(int iParam0) //Position: 0x3717 / 14103
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3739 / 14137
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	HUD_ENABLE(1);
	if (IS_OBJECT_VALID(&iLocal_4))
	{
		DESTROY_OBJECT(&iLocal_4);
	}
...
void Function_91(var uParam0, bool bParam1) //Position: 0x3779 / 14201
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_92(int iParam0, int iParam1) //Position: 0x3889 / 14473
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_93(struct<69> Param0) //Position: 0x38A1 / 14497
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_94(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_94(var uParam0, int iParam1) //Position: 0x3BBD / 15293
{
	iParam1 = &iParam1;
	iLocal_1 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_95(int iParam0) //Position: 0x3BDC / 15324
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_96(int iParam0) //Position: 0x3BF6 / 15350
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_97(int iParam0, var uParam1) //Position: 0x3C11 / 15377
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_98(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_98(var uParam0, int iParam1) //Position: 0x3C4F / 15439
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_99(struct<65> Param0) //Position: 0x3C68 / 15464
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_82(Param0.f_64, 2))
		{
			...
			if (Function_82(Param0.f_64, 1))
			{
				Function_92("MIDACTION REQUEST", &uVar1);
			}
			else
			{
...
int Function_100(int iParam0) //Position: 0x3F60 / 16224
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_101(var uParam0, int iParam1) //Position: 0x3F7E / 16254
{
	struct<5> Var0;
	float fVar5;
...
int Function_102(int iParam0) //Position: 0x4020 / 16416
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_103(int iParam0, int iParam1) //Position: 0x4040 / 16448
{
	var uVar0;
	...
	{
		uVar0 = FIND_VOLUME_IN_LAYOUT(&Global_46715, "v_HelperInFort");
...
bool Function_104(int iParam0) //Position: 0x408D / 16525
{
...
void Function_105(int iParam0) //Position: 0x40A9 / 16553
{
	iParam0 = &iParam0;
	return;
}

void Function_106(var uParam0, int iParam1) //Position: 0x40B5 / 16565
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_107(&(vLocal_8[iLocal_1189]), &uParam0);
		iLocal_118++;
	}
...
void Function_107(int iParam0, int iParam1) //Position: 0x4121 / 16673
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_108(int iParam0) //Position: 0x4139 / 16697
{
	iParam0 = &iParam0;
	return;
}

void Function_109(int iParam0) //Position: 0x4145 / 16709
{
