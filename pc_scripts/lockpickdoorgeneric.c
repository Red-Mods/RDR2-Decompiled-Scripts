...
void main() //Position: 0x0 / 0
{
	...
	iLocal_40 = 0;
	Function_99(&uScriptParam_0, &iLocal_40);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_41);
		}
		iVar2 = 0;
		bLocal_48 = false;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_49))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_49);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_40 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_49))
								{
									...
									{
										bLocal_49 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_49 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_49))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_49))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_49);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_46, &uLocal_44);
...
void Function_77(struct<69> Param0) //Position: 0x307E / 12414
{
	...
	if (&Param0 + 16 == &iLocal_46)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_44));
		iLocal_46 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_99(var uParam0, int iParam1) //Position: 0x3FF5 / 16373
{
	...
	{
		Function_100(&(vLocal_2[iLocal_409]), &uParam0);
		iLocal_40++;
	}
