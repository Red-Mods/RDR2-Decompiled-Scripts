...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x00000007:
				if (bLocal_177)
				{
					Function_223(&iLocal_13, bScriptParam_0, Function_246());
				}
			...
			case 0x0000000A:
				Function_208(Function_246(), bScriptParam_0);
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_598, Function_87(), bScriptParam_0);
				Function_47(&uLocal_660, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_598);
	Function_8(&uLocal_660);
	Function_6();
...
void Function_2(int iParam0) //Position: 0x3D7 / 983
{
	int iVar0;
...
void Function_3(int iParam0) //Position: 0x40D / 1037
{
...
bool Function_4(int iParam0) //Position: 0x42F / 1071
{
...
bool Function_5(int iParam0) //Position: 0x445 / 1093
{
...
void Function_6() //Position: 0x45B / 1115
{
	Function_7();
	return;
}

void Function_7() //Position: 0x464 / 1124
{
	RELEASE_LAYOUT_REF(&iLocal_238);
	return;
}

void Function_8(struct<4>[] Param0) //Position: 0x470 / 1136
{
	int iVar0;
...
void Function_9(var uParam0, vector3[] vParam1) //Position: 0x4D5 / 1237
{
	int iVar0;
...
void Function_10(int iParam0, int iParam1, int iParam2) //Position: 0x532 / 1330
{
	int iVar0;
...
void Function_11(int iParam0, int iParam1, bool bParam2) //Position: 0x61C / 1564
{
	int iVar0;
...
void Function_12() //Position: 0x79B / 1947
{
	Global_26174.f_20 = 0.0f;
	return;
}

void Function_13(int iParam0) //Position: 0x7A7 / 1959
{
	PRINTSTRING("Day ");
...
void Function_14(int iParam0) //Position: 0x7F1 / 2033
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_15(struct<17> Param0) //Position: 0x837 / 2103
{
	int iVar0;
...
bool Function_16(struct<17> Param0) //Position: 0x854 / 2132
{
	int iVar0;
...
void Function_17() //Position: 0x872 / 2162
{
	return;
}
...
void Function_19() //Position: 0x8F9 / 2297
{
	Function_20();
	return;
}

void Function_20() //Position: 0x902 / 2306
{
...
void Function_21(int iParam0) //Position: 0x915 / 2325
{
	int iVar0;
...
void Function_22(struct<2>[] Param0, int iParam1) //Position: 0x93D / 2365
{
...
void Function_23(struct<13> Param0) //Position: 0xA88 / 2696
{
	int iVar0;
...
bool Function_24(struct<13> Param0) //Position: 0xAA5 / 2725
{
	int iVar0;
...
void Function_25(bool bParam0) //Position: 0xAC3 / 2755
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_26(int iParam0) //Position: 0xB7D / 2941
{
	int iVar0;
...
bool Function_27(bool bParam0) //Position: 0xB99 / 2969
{
	var uVar0;
...
bool Function_28(int iParam0) //Position: 0xC0C / 3084
{
	var uVar0;
	bool bVar1;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xC29 / 3113
{
	return (uParam0 && bParam1) == 0;
}

void Function_30(int iParam0, int iParam1) //Position: 0xC36 / 3126
{
...
void Function_31(int iParam0) //Position: 0xF9D / 3997
{
	var uVar0;
...
int Function_32(int iParam0) //Position: 0x1004 / 4100
{
	int iVar0;
...
void Function_33(vector3 vParam0) //Position: 0x134C / 4940
{
	int iVar0;
	var uVar1;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x162C / 5676
{
	if (!Function_5(iParam0))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x1D82 / 7554
{
...
int Function_36(int iParam0) //Position: 0x1D97 / 7575
{
	var uVar0;
...
void Function_37(var uParam0, bool bParam1, bool bParam2) //Position: 0x1DB9 / 7609
{
	int iVar0;
	var uVar1;
...
bool Function_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1E42 / 7746
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E62 / 7778
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0) //Position: 0x1ED7 / 7895
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(int iParam0, var uParam1, int iParam2) //Position: 0x1F11 / 7953
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F8D / 8077
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x202E / 8238
{
	int iVar0;
	int iVar1;
...
void Function_44(int iParam0, int iParam1) //Position: 0x206B / 8299
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2081 / 8321
{
...
void Function_46(var uParam0, int iParam1) //Position: 0x2094 / 8340
{
	int iVar0;
...
void Function_47(struct<4>[] Param0, bool bParam1) //Position: 0x20AE / 8366
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_48(struct<13> Param0) //Position: 0x24CF / 9423
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_49(struct<13> Param0) //Position: 0x24E2 / 9442
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x24FF / 9471
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_51(vector3 vParam0) //Position: 0x2511 / 9489
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_52(vector3 vParam0, var uParam3, bool bParam4) //Position: 0x259B / 9627
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_53(int iParam0) //Position: 0x29F3 / 10739
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_54(int iParam0) //Position: 0x2AE4 / 10980
{
...
float Function_55(int iParam0) //Position: 0x2B21 / 11041
{
	if (!iParam0 != 4294967295)
	{
...
void Function_56(int iParam0, int iParam1) //Position: 0x2B5A / 11098
{
	bool bVar0;
...
var Function_57(int iParam0) //Position: 0x2BC4 / 11204
{
	int iVar0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2C1C / 11292
{
	int iVar0;
	int iVar1;
...
void Function_59(bool bParam0) //Position: 0x2E44 / 11844
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_60(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2EE2 / 12002
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_61() //Position: 0x3520 / 13600
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x3529 / 13609
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_63(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x353A / 13626
{
	char* cVar0[32];
...
struct<32> Function_64(char* cParam0) //Position: 0x3631 / 13873
{
	char* cVar0[32];
...
void Function_65(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x364C / 13900
{
	float fVar0;
...
var Function_66(int iParam0, int iParam1) //Position: 0x36B3 / 14003
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_67(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x36C5 / 14021
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_68(int iParam0) //Position: 0x37F9 / 14329
{
	return Global_55480[iParam016].f_96;
}

void Function_69(int iParam0) //Position: 0x3808 / 14344
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_70(int iParam0, float fParam1, bool bParam2) //Position: 0x39A2 / 14754
{
	int iVar0;
	int iVar1;
...
void Function_71(var uParam0, int iParam1) //Position: 0x3BE6 / 15334
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_72(int iParam0, var uParam1, int iParam2) //Position: 0x3BF3 / 15347
{
...
var Function_73(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x3C1D / 15389
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
void Function_74() //Position: 0x3ED0 / 16080
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(var uParam0, int iParam1) //Position: 0x3F43 / 16195
{
...
bool Function_76(bool bParam0) //Position: 0x3F79 / 16249
{
	if (Function_81(256))
	{
		return 0;
...
int Function_77(int iParam0) //Position: 0x3FEF / 16367
{
...
bool Function_78() //Position: 0x4000 / 16384
{
	if (Global_46720 == 2)
	{
		if (StackVal == 1)
...
bool Function_79(int iParam0) //Position: 0x4019 / 16409
{
...
bool Function_80(int iParam0) //Position: 0x402F / 16431
{
...
bool Function_81(int iParam0) //Position: 0x4044 / 16452
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4062 / 16482
{
	uParam0 = &uParam0;
...
void Function_83(struct<17> Param0) //Position: 0x4111 / 16657
{
	Param0.f_16 = (Param0.f_16 || iParam1);
	return;
}

void Function_84(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x4124 / 16676
{
	int iVar0;
	int iVar1;
...
void Function_85(int iParam0, int iParam1) //Position: 0x419E / 16798
{
	var uVar0;
...
bool Function_86(int iParam0) //Position: 0x41C7 / 16839
{
	if (iParam0 == 0)
	{
		return 0;
...
var Function_87() //Position: 0x41E7 / 16871
{
...
void Function_88(struct<82> Param0) //Position: 0x41FC / 16892
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x5735 / 22325
{
	int iVar0;
	int iVar1;
...
var Function_91(int iParam0) //Position: 0x5932 / 22834
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
int Function_92(int[] iParam0) //Position: 0x5B1C / 23324
{
	iParam1 = iParam1;
	if (iParam1 == Global_46760[0])
	{
...
var Function_93(int iParam0) //Position: 0x5F4B / 24395
{
	if (iParam0 == 1)
	{
...
void Function_94(vector3 vParam0) //Position: 0x60D1 / 24785
{
	int iVar0;
...
void Function_95(int iParam0) //Position: 0x612B / 24875
{
	var uVar0;
...
void Function_96(int iParam0) //Position: 0x6165 / 24933
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x6199 / 24985
{
	return Function_98(&iParam0 + 600);
}

int Function_98(int iParam0) //Position: 0x61A8 / 25000
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_99(int iParam0) //Position: 0x63FF / 25599
{
	int iVar0;
	var uVar1;
...
float Function_100(var uParam0, struct<2> Param1) //Position: 0x6456 / 25686
{
	struct<2> Var0;
...
struct<8> Function_101(int iParam0) //Position: 0x64CD / 25805
{
	struct<2> Var0;
...
bool Function_102(int iParam0) //Position: 0x6539 / 25913
{
	int iVar0;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x66AA / 26282
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x69A4 / 27044
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x6A32 / 27186
{
	var uVar0;
...
void Function_106(int iParam0, int iParam1) //Position: 0x6A9B / 27291
{
...
void Function_107(int iParam0, var uParam1) //Position: 0x6B2C / 27436
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
void Function_108(int iParam0, int iParam1) //Position: 0x6BBD / 27581
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 35,86088f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
...
bool Function_109(var uParam0, struct<2> Param1) //Position: 0x6C53 / 27731
{
	struct<2> Var0;
	var uVar2;
	var uVar4;
...
void Function_110(int iParam0, float fParam1) //Position: 0x6C8E / 27790
{
	float fVar0;
...
void Function_111(bool bParam0, float fParam1, bool bParam2) //Position: 0x6CD2 / 27858
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_112() //Position: 0x6E16 / 28182
{
...
void Function_113() //Position: 0x6E28 / 28200
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6E3D / 28221
{
	var uVar0[3];
	int iVar4;
...
void Function_115(vector3 vParam0) //Position: 0x7145 / 28997
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var Function_116(int iParam0) //Position: 0x7413 / 29715
{
	bool bVar0;
...
var Function_117(struct<2> Param0, bool bParam2, var uParam3, bool bParam4) //Position: 0x74D7 / 29911
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
void Function_118() //Position: 0x78E4 / 30948
{
	Function_131();
	Function_130();
	Function_130();
...
void Function_119() //Position: 0x792F / 31023
{
...
void Function_120() //Position: 0x7A35 / 31285
{
	float fVar0;
...
void Function_121() //Position: 0x7A68 / 31336
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_122() //Position: 0x7BFB / 31739
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_123() //Position: 0x7DB4 / 32180
{
	Function_124(&Global_42918, 1, 0);
	return;
}

void Function_124(struct<2317> Param0) //Position: 0x7DC2 / 32194
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_125(int iParam0) //Position: 0x7FDF / 32735
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x8087 / 32903
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x8323 / 33571
{
...
struct<8> Function_128() //Position: 0x8364 / 33636
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_129() //Position: 0x83ED / 33773
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_130() //Position: 0x8484 / 33924
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_131() //Position: 0x8503 / 34051
{
...
int Function_132(int iParam0, float fParam1, int iParam2) //Position: 0x8540 / 34112
{
	int iVar0;
	int iVar1;
...
int Function_133(int iParam0) //Position: 0x874C / 34636
{
...
bool Function_134(int iParam0) //Position: 0x8766 / 34662
{
...
var Function_135(struct<2> Param0, bool bParam2) //Position: 0x877C / 34684
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_136(struct<2> Param0, float fParam2, int iParam3) //Position: 0x87E8 / 34792
{
	int iVar0;
	struct<2> Var1;
	bool bVar3;
...
int Function_137(bool bParam0) //Position: 0x88E8 / 35048
{
	bool bVar0;
...
bool Function_138(struct<2> Param0, int iParam2, struct<2> Param3, bool bParam5) //Position: 0x8940 / 35136
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
struct<8> Function_139(vector3 vParam0) //Position: 0x8AFA / 35578
{
	struct<2> Var0;
...
vector3 Function_140(vector3 vParam0) //Position: 0x8B1C / 35612
{
	vector3 vVar0;
...
var Function_141(int iParam0, int iParam1) //Position: 0x8B3A / 35642
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_142(float fParam0, var uParam1, int iParam2) //Position: 0x8B4D / 35661
{
...
var Function_143(int iParam0) //Position: 0x8D9B / 36251
{
	return GET_HEADING(&iParam0);
}

struct<8> Function_144(int iParam0) //Position: 0x8DA7 / 36263
{
	struct<2> Var0;
...
bool Function_145(vector3 vParam0) //Position: 0x8DB9 / 36281
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_146(int iParam0, bool bParam1, int iParam2) //Position: 0x8DD1 / 36305
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
float Function_147(var uParam0, int iParam1) //Position: 0x91E7 / 37351
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_148(int iParam0, bool bParam1, bool bParam2) //Position: 0x92DC / 37596
{
...
bool Function_149() //Position: 0x93A0 / 37792
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_150(int iParam0) //Position: 0x93B7 / 37815
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_151(int iParam0) //Position: 0x93C3 / 37827
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_152(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x93D2 / 37842
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_153(int iParam0) //Position: 0x945D / 37981
{
	char* cVar0[16];
...
bool Function_154() //Position: 0x949C / 38044
{
...
void Function_155(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x94B7 / 38071
{
	struct<4> Var0;
	var uVar4;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x954C / 38220
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x9634 / 38452
{
	var uVar0;
	var uVar1;
	var uVar5;
...
void Function_158(int iParam0) //Position: 0x97F5 / 38901
{
	int iVar0;
	int iVar1;
...
bool Function_159(int iParam0) //Position: 0x9B5F / 39775
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x9B83 / 39811
{
	while (&iParam4 > 60)
	{
		iParam4 = (&iParam4 - 60);
...
void Function_161(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0x9EA2 / 40610
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_162(var uParam0, int iParam1, int iParam2) //Position: 0xA145 / 41285
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0xA19E / 41374
{
...
bool Function_164(struct<2>[] Param0) //Position: 0xA212 / 41490
{
	int iVar0;
	int iVar1;
...
void Function_165() //Position: 0xA5D4 / 42452
{
	if (!Function_26(128))
	{
		return;
...
bool Function_166() //Position: 0xA614 / 42516
{
	int iVar0;
...
void Function_167(struct<13> Param0) //Position: 0xA642 / 42562
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_168() //Position: 0xA655 / 42581
{
	if (!Function_26(128))
	{
		return;
...
var Function_169(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA697 / 42647
{
	int iVar0;
	var uVar1;
...
var Function_170(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA6D5 / 42709
{
	int iVar0;
...
bool Function_171() //Position: 0xA7A4 / 42916
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_172(var uParam0, var uParam1, struct<82> Param2) //Position: 0xA89D / 43165
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_175(struct<649> Param0) //Position: 0xAAFF / 43775
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_176(var uParam0, int iParam1, bool bParam2) //Position: 0xAF7F / 44927
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_177(int iParam0, int iParam1, bool bParam2) //Position: 0xB011 / 45073
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_178(struct<2> Param0, float fParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB31B / 45851
{
	var uVar0;
	var uVar1;
...
int Function_179(var uParam0, var uParam1, bool bParam2) //Position: 0xB357 / 45911
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_180(int iParam0) //Position: 0xB435 / 46133
{
	int iVar0;
...
bool Function_181(int iParam0, int iParam1) //Position: 0xB484 / 46212
{
	int iVar0;
...
void Function_182() //Position: 0xB4C9 / 46281
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_183(int iParam0, int iParam1) //Position: 0xB517 / 46359
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_184(int iParam0) //Position: 0xB52A / 46378
{
	if (Function_29(iParam0, 1) && !Function_29(Global_39556, 1))
	{
	}
...
void Function_185(vector3 vParam0) //Position: 0xB557 / 46423
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_186(int iParam0, int iParam1, int iParam2) //Position: 0xB658 / 46680
{
	int iVar0;
	var uVar1;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB6AF / 46767
{
	int iVar0;
	var uVar1;
...
bool Function_188(int iParam0) //Position: 0xB701 / 46849
{
	int iVar0;
...
void Function_189(int iParam0) //Position: 0xB740 / 46912
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void Function_190(int iParam0) //Position: 0xB80B / 47115
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_191(bool bParam0) //Position: 0xB8E5 / 47333
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var Function_192(int iParam0) //Position: 0xB944 / 47428
{
	if (iParam0 == 1)
	{
		return 70.0f;
...
int Function_193(bool bParam0) //Position: 0xBA87 / 47751
{
...
void Function_194() //Position: 0xBC0D / 48141
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_195(bool bParam0, int iParam1) //Position: 0xBC79 / 48249
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void Function_196(bool bParam0, float fParam1) //Position: 0xBDB8 / 48568
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", fParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBDDC / 48604
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_198(int iParam0, bool bParam1) //Position: 0xBDED / 48621
{
	int iVar0;
...
bool Function_199(int iParam0) //Position: 0xBE2B / 48683
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBE42 / 48706
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBEA0 / 48800
{
	var uVar0;
...
var Function_202(int iParam0) //Position: 0xC006 / 49158
{
	int iVar0;
...
bool Function_203(int iParam0) //Position: 0xC044 / 49220
{
...
var Function_204(int iParam0, int iParam1, int iParam2) //Position: 0xC059 / 49241
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_205(int iParam0) //Position: 0xC079 / 49273
{
	var uVar0;
	...
	if (Function_35(23))
	{
		uVar0 = LOCATE_NAMED_ACTOR(StackVal, Vector(-803,351f, 13,256f, 3724,381f), 6.0f, "ricketts23", 0);
		if (IS_ACTOR_ALIVE(&uVar0))
		{
			if ((((AI_IS_AGGROING(&uVar0, &Global_54076) || AI_IS_HOSTILE_OR_ENEMY(&uVar0, &Global_54076)) || GET_LAST_ATTACKER(&uVar0) != &Global_54076) || AI_HAS_PLAYER_PROJECTILE_IMPACTED_WITHIN(&uVar0, 1.0f)) || AI_HAS_PLAYER_PROJECTILE_NEAR_MISSED_WITHIN(&uVar0, 1.0f, 1.0f))
			{
				SET_ACTOR_FACTION(&uVar0, 3);
				MEMORY_CONSIDER_AS_ENEMY(&uVar0, &Global_54076);
				TASK_CLEAR(&uVar0);
				Function_206(&uVar0, 100.0f, 0,5f, 0,8f);
			}
		}
	}
	if (!iLocal_782)
	{
		iLocal_782 = 1;
		Function_258(iParam0, 0);
		Function_157(iParam0);
		Function_197(&iLocal_13 + 608, 2);
		Function_195(1, 4294967295);
		AUDIO_SET_CURRENT_AREA_IS_UNDER_ZOMBIE_ATTACK(false);
	}
	return;
...
void Function_206(var uParam0, float fParam1, float fParam2, float fParam3) //Position: 0xC143 / 49475
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
void Function_207(char* cParam0) //Position: 0xC194 / 49556
{
	if (!Function_26(128))
	{
		return;
...
void Function_208(int iParam0, bool bParam1) //Position: 0xC1D4 / 49620
{
	char[] cVar0[4];
...
void Function_209(int iParam0) //Position: 0xC2C4 / 49860
{
	Global_39922.f_88 = (Global_39922.f_88 || iParam0);
	return;
}

void Function_210(bool bParam0) //Position: 0xC2D7 / 49879
{
	Function_211(1, 0,25f, 4, &iLocal_178, &Global_44085[bParam09] + 8, 1);
	return;
}

void Function_211(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, bool bParam5) //Position: 0xC2F5 / 49909
{
	var uVar0;
...
void Function_212(int iParam0) //Position: 0xC403 / 50179
{
	Function_213(&Global_43580, iParam0);
	return;
}

void Function_213(var uParam0, var uParam1) //Position: 0xC411 / 50193
{
...
void Function_214() //Position: 0xC430 / 50224
{
...
void Function_215(var uParam0) //Position: 0xC44C / 50252
{
	uParam0 = uParam0;
	return;
}

void Function_216() //Position: 0xC456 / 50262
{
	return;
}

void Function_217(int iParam0) //Position: 0xC45C / 50268
{
	iParam0 = iParam0;
	return;
}

void Function_218(var uParam0, int iParam1) //Position: 0xC466 / 50278
{
	int iVar0;
...
bool Function_219(int iParam0, int iParam1) //Position: 0xC480 / 50304
{
	int iVar0;
...
void Function_220() //Position: 0xC49D / 50333
{
	return;
}

void Function_221() //Position: 0xC4A3 / 50339
{
	return;
}

void Function_222(int iParam0) //Position: 0xC4A9 / 50345
{
	iParam0 = iParam0;
	return;
}

void Function_223(int iParam0, bool bParam1, int iParam2) //Position: 0xC4B3 / 50355
{
...
void Function_224(int iParam0, int iParam1, struct<2>[] Param2, var uParam3) //Position: 0xC7B7 / 51127
{
	struct<8> Var0;
	var uVar8;
	int iVar9[8];
				...
				*(&iParam0 + 8[iVar225] + 8) = GET_INDEXED_OBJECT_IN_OBJECTSET(iVar22, &uVar8);
				...
				if (bVar23)
				{
					...
					*(&iParam0 + 8[iVar225]) = CREATE_ACTOR_IN_LAYOUT(&uParam3, &Var28, iVar9[iVar22], Var24, Var26);
					Function_226(iVar22, &iParam0, &uParam3, bVar21, iParam1);
...
void Function_225(var uParam0, int iParam1) //Position: 0xC9C3 / 51651
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_226(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0xC9D4 / 51668
{
	int iVar0;
	var uVar1;
	float fVar2;
	...
	if (DECOR_CHECK_EXIST(&uVar1, "Accuracy"))
	{
		...
		Function_206(&iVar0, TO_FLOAT(bVar11), 1.0f, 1.0f);
	}
	else
	{
		Function_206(&iVar0, 75.0f, 1.0f, 1.0f);
	}
	...
	Function_206(&iVar0, 20.0f, 1.0f, 1.0f);
...
var Function_227(var uParam0, int iParam1) //Position: 0xD0BB / 53435
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(&uParam0, &iParam1);
}

void Function_228(var uParam0, bool bParam1) //Position: 0xD0CA / 53450
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_229(var uParam0, bool bParam1) //Position: 0xD119 / 53529
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
bool Function_230(var uParam0, int iParam1) //Position: 0xD14D / 53581
{
	int iVar0;
...
var Function_231(int iParam0, int iParam1) //Position: 0xD16A / 53610
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<32> Function_232(char* cParam0) //Position: 0xD220 / 53792
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_233(char* cParam0) //Position: 0xD28C / 53900
{
	char* cVar0[32];
...
void Function_234() //Position: 0xD2AE / 53934
{
	return;
}

bool Function_235(int iParam0) //Position: 0xD2B4 / 53940
{
...
int Function_236(int iParam0) //Position: 0xD2D7 / 53975
{
	if (!Function_5(iParam0))
	{
		return 1;
...
int Function_237() //Position: 0xD2F3 / 54003
{
	return 1;
}

void Function_238(bool bParam0) //Position: 0xD2FA / 54010
{
	Function_239(&uLocal_660, &cLocal_7, "ncantina01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "ncantina01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "ncantina01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "trainstation01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 5, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 6, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 9, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 10, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 11, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 7, &Global_44085[bParam09] + 32, 0, &iLocal_238 + 272, 0, 1);
	Function_239(&uLocal_660, &cLocal_7, "whorehouse01", 8, &Global_44085[bParam09] + 32, 0, &iLocal_238 + 272, 0, 1);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD550 / 54608
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD653 / 54867
{
	int iVar0;
...
void Function_241() //Position: 0xD684 / 54916
{
	Function_242(&uLocal_9, &uLocal_598, 4, &iLocal_238 + 112, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 8, 4294967295, 16642);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 896, 4294967295, 16642);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 952, 4294967295, 1282);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 40, 4294967295, 770);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 80, 4294967295, 258);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 944, 4294967295, 258);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 120, 4294967295, 65792);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 272, 4294967295, 65792);
	Function_242(&uLocal_9, &uLocal_598, 5, &iLocal_238 + 344, 4294967295, 1282);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD743 / 55107
{
...
void Function_243(struct<5> Param0) //Position: 0xD830 / 55344
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD841 / 55361
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, int iParam1, bool bParam2) //Position: 0xD8B7 / 55479
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD955 / 55637
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD95E / 55646
{
	cLocal_7 = Function_248(&iLocal_178, "casamadrugada", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD97F / 55679
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD9A2 / 55714
{
	return Function_250();
}

int Function_250() //Position: 0xD9AB / 55723
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_238 = FIND_NAMED_LAYOUT("CasaMadrugada_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_238))
	{
		iLocal_238 = CREATE_LAYOUT("CasaMadrugada_layout");
	}
	*(&iLocal_238 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_trainStn", 2,802597E-45f, Vector(-806,3028f, 16,27773f, 3777,344f), Vector(-0,5743347f, -44,77498f, 0,541441f), Vector(7,291147f, 5,922976f, 15,61f));
	*(&iLocal_238 + 40) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_bar_set");
	*(&iLocal_238 + 16[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_bar_01", 2,802597E-45f, Vector(-794,7755f, 15,01289f, 3696,803f), Vector(0.0f, -44,38549f, 0.0f), Vector(16,07115f, 3,758225f, 10,05159f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 40, &iLocal_238 + 16[0]);
	*(&iLocal_238 + 16[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_bar_02", 2,802597E-45f, Vector(-789,6567f, 13,15435f, 3703,599f), Vector(0.0f, -43,09472f, 0.0f), Vector(3,249471f, 7,623641f, 7,487772f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 40, &iLocal_238 + 16[1]);
	*(&iLocal_238 + 80) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_alley_set");
	*(&iLocal_238 + 48[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_alley_01", 2,802597E-45f, Vector(-796,4014f, 13,70259f, 3681,536f), Vector(0,6455604f, -44,57007f, -1,497947f), Vector(8,451973f, 6,889233f, 4,493765f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 80, &iLocal_238 + 48[0]);
	*(&iLocal_238 + 48[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_alley_02", 2,802597E-45f, Vector(-801,9087f, 13,05098f, 3686,507f), Vector(0.0f, -45,2793f, 0.0f), Vector(7,737553f, 9,463933f, 14,94528f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 80, &iLocal_238 + 48[1]);
	*(&iLocal_238 + 48[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_alley_03", 2,802597E-45f, Vector(-820,2098f, 12,16464f, 3695,942f), Vector(0.0f, -44,78384f, 0.0f), Vector(5,064258f, 10,26207f, 33,69819f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 80, &iLocal_238 + 48[2]);
	*(&iLocal_238 + 104) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_balcony_set");
	*(&iLocal_238 + 88[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_balcony_03", 2,802597E-45f, Vector(-808,3246f, 18,67298f, 3708,198f), Vector(0.0f, 46,09587f, 0.0f), Vector(25,51252f, 5,493402f, 3,00904f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 104, &iLocal_238 + 88[0]);
	*(&iLocal_238 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_region", 2,802597E-45f, Vector(-804,7143f, 16,50582f, 3732,976f), Vector(0.0f, 44,79254f, 0.0f), Vector(117,0739f, 25,23466f, 108,1188f));
	*(&iLocal_238 + 120) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_BunkHouse", 2,802597E-45f, Vector(-788,619f, 13,18159f, 3690,619f), Vector(0.0f, 45,84349f, 0.0f), Vector(6,227079f, 6,568761f, 15,13013f));
	*(&iLocal_238 + 264) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_crows_set");
	*(&iLocal_238 + 128[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder13", 4,203895E-45f, Vector(-764,0739f, 13,05098f, 3744.0f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[0]);
	*(&iLocal_238 + 128[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder1", 4,203895E-45f, Vector(-796.0f, 13,05098f, 3674,372f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[1]);
	*(&iLocal_238 + 128[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder2", 4,203895E-45f, Vector(-805,8668f, 13,05098f, 3777,47f), Vector(0.0f, 45,26674f, 0.0f), Vector(23,49845f, 7,5894f, 13,56014f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[2]);
	*(&iLocal_238 + 128[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder3", 4,203895E-45f, Vector(-777,3153f, 13,05098f, 3708,433f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[3]);
	*(&iLocal_238 + 128[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder4", 4,203895E-45f, Vector(-833,4831f, 13,05098f, 3742,111f), Vector(0.0f, -45,5061f, 0.0f), Vector(16,77011f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[4]);
	*(&iLocal_238 + 128[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder5", 4,203895E-45f, Vector(-826,9752f, 13,05098f, 3727,765f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[5]);
	*(&iLocal_238 + 128[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder6", 4,203895E-45f, Vector(-805,5087f, 13,05098f, 3702,613f), Vector(0.0f, 33,29927f, 0.0f), Vector(28,18205f, 7,5894f, 19,86875f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[6]);
	*(&iLocal_238 + 128[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder7", 4,203895E-45f, Vector(-819,5359f, 13,05098f, 3767,139f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[7]);
	*(&iLocal_238 + 128[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder8", 4,203895E-45f, Vector(-796.0f, 13,05098f, 3744.0f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[8]);
	*(&iLocal_238 + 128[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "nCylinder9", 4,203895E-45f, Vector(-760,6938f, 13,05098f, 3731,306f), Vector(0.0f, 20.0f, 0.0f), Vector(6,10493f, 7,5894f, 3,934427f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[9]);
	*(&iLocal_238 + 128[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder10", 4,203895E-45f, Vector(-819,3535f, 18,43041f, 3710,828f), Vector(0.0f, 38,58831f, 0.0f), Vector(2,086118f, 1,787392f, 4,852084f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[10]);
	*(&iLocal_238 + 128[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder11", 4,203895E-45f, Vector(-830,0306f, 13,03314f, 3704,874f), Vector(0.0f, 39,89325f, 0.0f), Vector(3,894529f, 1.0f, 2,128424f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[11]);
	*(&iLocal_238 + 128[12]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder12", 4,203895E-45f, Vector(-819,5968f, 13,03314f, 3694,634f), Vector(0.0f, 43,64146f, 0.0f), Vector(8,288342f, 1.0f, 1,357594f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[12]);
	*(&iLocal_238 + 128[13]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder16", 4,203895E-45f, Vector(-790,4797f, 19,48275f, 3692,78f), Vector(0.0f, 20.0f, 0.0f), Vector(4,029238f, 1,592475f, 5,292638f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[13]);
	*(&iLocal_238 + 128[14]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder14", 4,203895E-45f, Vector(-841,3357f, 18,50264f, 3727,26f), Vector(0.0f, 20.0f, 0.0f), Vector(3,048616f, 1.0f, 3,845933f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[14]);
	*(&iLocal_238 + 128[15]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder15", 4,203895E-45f, Vector(-834,6487f, 19,41341f, 3716,635f), Vector(2,006079f, 16,84535f, -2,695644f), Vector(2,563606f, 1,560858f, 2,006725f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 264, &iLocal_238 + 128[15]);
	*(&iLocal_238 + 272) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_players_room", 2,802597E-45f, Vector(-811,742f, 18,18306f, 3705,84f), Vector(0.0f, 44,24602f, 0.0f), Vector(8,813954f, 3,418221f, 5,097694f));
	*(&iLocal_238 + 344) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_brothel_set");
	*(&iLocal_238 + 280[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_01", 2,802597E-45f, Vector(-811,5852f, 14,51999f, 3700,57f), Vector(0.0f, -45,3715f, 0.0f), Vector(9,289575f, 3,330397f, 6,019562f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[0]);
	*(&iLocal_238 + 280[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_03", 2,802597E-45f, Vector(-807,2336f, 13,85711f, 3696,247f), Vector(0.0f, -46,03899f, 0.0f), Vector(9,207765f, 4,680773f, 6,26373f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[1]);
	*(&iLocal_238 + 280[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_04", 2,802597E-45f, Vector(-816,0667f, 14,67081f, 3704,945f), Vector(0.0f, -44,96406f, 0.0f), Vector(9,022927f, 3,044132f, 6,009335f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[2]);
	*(&iLocal_238 + 280[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_05", 2,802597E-45f, Vector(-817,4669f, 18,13931f, 3699,951f), Vector(0.0f, 43,24169f, 0.0f), Vector(8,738506f, 3,412303f, 4,675186f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[3]);
	*(&iLocal_238 + 280[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_06", 2,802597E-45f, Vector(-811,2756f, 18,17668f, 3693,858f), Vector(0.0f, 46,06035f, 0.0f), Vector(8,470537f, 3,390614f, 4,714306f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[4]);
	*(&iLocal_238 + 280[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_07", 2,802597E-45f, Vector(-805,4082f, 18,16347f, 3699,799f), Vector(0.0f, -44,45793f, 0.0f), Vector(4,815435f, 3,36401f, 8,271959f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[5]);
	*(&iLocal_238 + 280[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_brothel_02", 2,802597E-45f, Vector(-811,5617f, 18,16293f, 3699,9f), Vector(0.0f, 45,38604f, 0.0f), Vector(17,37091f, 3,021058f, 2,812284f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 344, &iLocal_238 + 280[6]);
	*(&iLocal_238 + 392) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_walkway_set");
	*(&iLocal_238 + 352[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_walkway2", 2,802597E-45f, Vector(-796,7672f, 14,37165f, 3706,787f), Vector(0.0f, 44,05541f, 0.0f), Vector(5,227089f, 3,784717f, 17,67647f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 392, &iLocal_238 + 352[0]);
	*(&iLocal_238 + 352[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_walkway3", 2,802597E-45f, Vector(-811,2538f, 12,91709f, 3709,225f), Vector(0.0f, 44,96168f, 0.0f), Vector(27,33997f, 6,435522f, 3,48009f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 392, &iLocal_238 + 352[1]);
	*(&iLocal_238 + 352[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_walkway4", 2,802597E-45f, Vector(-824,2254f, 15,8424f, 3714,592f), Vector(0.0f, 44,96168f, 0.0f), Vector(7,533593f, 11,4075f, 16,18906f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 392, &iLocal_238 + 352[2]);
	*(&iLocal_238 + 352[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_walkway5", 2,802597E-45f, Vector(-787,3676f, 14,37165f, 3706,853f), Vector(0.0f, 44,05541f, 0.0f), Vector(13,06286f, 3,784717f, 4,337309f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 392, &iLocal_238 + 352[3]);
	*(&iLocal_238 + 416) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_regs_set");
	*(&iLocal_238 + 400[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_regs_01", 2,802597E-45f, Vector(-794,6103f, 14,12606f, 3697,246f), Vector(0.0f, -44,75211f, 0.0f), Vector(15,08281f, 7,08342f, 4,550721f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 416, &iLocal_238 + 400[0]);
	*(&iLocal_238 + 496) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_WhrRegs_set");
	*(&iLocal_238 + 424[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder34", 4,203895E-45f, Vector(-811,6566f, 17,86487f, 3693,92f), Vector(0.0f, 42,77212f, 0.0f), Vector(5,090549f, 1,468264f, 2,420432f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[0]);
	*(&iLocal_238 + 424[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder27", 4,203895E-45f, Vector(-807,5456f, 14,16206f, 3695,944f), Vector(0.0f, 43,41973f, 0.0f), Vector(3,069165f, 1,745446f, 4,115707f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[1]);
	*(&iLocal_238 + 424[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder28", 4,203895E-45f, Vector(-811,5952f, 14,15583f, 3700,567f), Vector(0.0f, 20.0f, 0.0f), Vector(3,001235f, 1,442589f, 3,561808f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[2]);
	*(&iLocal_238 + 424[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder29", 4,203895E-45f, Vector(-816,0573f, 14,14706f, 3705,06f), Vector(0.0f, 20.0f, 0.0f), Vector(2,716609f, 1,580899f, 3,864628f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[3]);
	*(&iLocal_238 + 424[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder30", 4,203895E-45f, Vector(-820,3043f, 14,14306f, 3709,699f), Vector(0.0f, 20.0f, 0.0f), Vector(2,866683f, 1,45179f, 3,824502f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[4]);
	*(&iLocal_238 + 424[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder31", 4,203895E-45f, Vector(-811,2254f, 18,14856f, 3705,455f), Vector(0.0f, 50,20604f, 0.0f), Vector(6,881428f, 1,5476f, 2,959556f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[5]);
	*(&iLocal_238 + 424[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder32", 4,203895E-45f, Vector(-805,3223f, 18,20893f, 3699,656f), Vector(0.0f, 44,01006f, 0.0f), Vector(3,846889f, 1,687158f, 2,437262f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[6]);
	*(&iLocal_238 + 424[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder33", 4,203895E-45f, Vector(-817,7166f, 18,29096f, 3699,879f), Vector(0.0f, 40,30882f, 0.0f), Vector(4,098403f, 1,562841f, 2,57164f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 496, &iLocal_238 + 424[7]);
	*(&iLocal_238 + 592) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_rabbits_set");
	*(&iLocal_238 + 504[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder51", 4,203895E-45f, Vector(-766,1308f, 13,05098f, 3739,121f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[0]);
	*(&iLocal_238 + 504[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder42", 4,203895E-45f, Vector(-829,3022f, 13,05098f, 3765,605f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[1]);
	*(&iLocal_238 + 504[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder43", 4,203895E-45f, Vector(-774,9594f, 13,05098f, 3696,278f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[2]);
	*(&iLocal_238 + 504[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder44", 4,203895E-45f, Vector(-797,9305f, 13,05098f, 3735,462f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[3]);
	*(&iLocal_238 + 504[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder45", 4,203895E-45f, Vector(-844,5376f, 13,05098f, 3712,051f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[4]);
	*(&iLocal_238 + 504[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder46", 4,203895E-45f, Vector(-773,1508f, 13,05098f, 3718,52f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[5]);
	*(&iLocal_238 + 504[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder47", 4,203895E-45f, Vector(-834,3109f, 13,05098f, 3786,002f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[6]);
	*(&iLocal_238 + 504[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder48", 4,203895E-45f, Vector(-783,9529f, 13,05098f, 3757,397f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[7]);
	*(&iLocal_238 + 504[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder49", 4,203895E-45f, Vector(-831,933f, 13,05098f, 3735,462f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[8]);
	*(&iLocal_238 + 504[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder50", 4,203895E-45f, Vector(-844,5376f, 13,05098f, 3735,462f), Vector(0.0f, 20.0f, 0.0f), Vector(3,661924f, 2,925787f, 2,883651f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 592, &iLocal_238 + 504[9]);
	*(&iLocal_238 + 648) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_dogs_set");
	*(&iLocal_238 + 600[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder68", 4,203895E-45f, Vector(-792,836f, 13,16464f, 3711,019f), Vector(0.0f, 20.0f, 0.0f), Vector(4,163461f, 10,99225f, 3,658534f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 648, &iLocal_238 + 600[0]);
	*(&iLocal_238 + 600[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder64", 4,203895E-45f, Vector(-836,1879f, 13,16464f, 3731,692f), Vector(0.0f, 20.0f, 0.0f), Vector(4,163461f, 10,99225f, 3,658534f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 648, &iLocal_238 + 600[1]);
	*(&iLocal_238 + 600[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder65", 4,203895E-45f, Vector(-795,469f, 13,16464f, 3762,82f), Vector(0.0f, 20.0f, 0.0f), Vector(4,163461f, 10,99225f, 3,658534f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 648, &iLocal_238 + 600[2]);
	*(&iLocal_238 + 600[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder66", 4,203895E-45f, Vector(-825,9218f, 13,16464f, 3721,139f), Vector(0.0f, 20.0f, 0.0f), Vector(4,163461f, 10,99225f, 3,658534f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 648, &iLocal_238 + 600[3]);
	*(&iLocal_238 + 600[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder67", 4,203895E-45f, Vector(-807,9018f, 13,16464f, 3731,106f), Vector(0.0f, 20.0f, 0.0f), Vector(4,163461f, 2,748588f, 3,658534f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 648, &iLocal_238 + 600[4]);
	*(&iLocal_238 + 744) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_snakes_set");
	*(&iLocal_238 + 656[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder78", 4,203895E-45f, Vector(-768,6904f, 13,05098f, 3760.0f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[0]);
	*(&iLocal_238 + 656[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder69", 4,203895E-45f, Vector(-774,1686f, 13,05098f, 3725,26f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[1]);
	*(&iLocal_238 + 656[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder70", 4,203895E-45f, Vector(-836,5049f, 13,05098f, 3751,001f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[2]);
	*(&iLocal_238 + 656[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder71", 4,203895E-45f, Vector(-835,0659f, 13,05098f, 3699,702f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[3]);
	*(&iLocal_238 + 656[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder72", 4,203895E-45f, Vector(-824,9296f, 13,05098f, 3731,961f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[4]);
	*(&iLocal_238 + 656[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder73", 4,203895E-45f, Vector(-821,1913f, 13,05098f, 3798,301f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[5]);
	*(&iLocal_238 + 656[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder74", 4,203895E-45f, Vector(-783,5839f, 13,05098f, 3760.0f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[6]);
	*(&iLocal_238 + 656[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder75", 4,203895E-45f, Vector(-827,6003f, 13,05098f, 3786,766f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[7]);
	*(&iLocal_238 + 656[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder76", 4,203895E-45f, Vector(-745,0389f, 13,05098f, 3724,009f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 3,202805f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[8]);
	*(&iLocal_238 + 656[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder77", 4,203895E-45f, Vector(-820.0f, 13,05098f, 3760.0f), Vector(0.0f, 20.0f, 0.0f), Vector(3,310231f, 4,443566f, 3,457055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 744, &iLocal_238 + 656[9]);
	*(&iLocal_238 + 856) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_vultures_set");
	*(&iLocal_238 + 752[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder63", 4,203895E-45f, Vector(-759,6187f, 14,22204f, 3748,58f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[0]);
	*(&iLocal_238 + 752[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder52", 4,203895E-45f, Vector(-824.0f, 14,22204f, 3789,929f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[1]);
	*(&iLocal_238 + 752[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder53", 4,203895E-45f, Vector(-824.0f, 14,22204f, 3692,034f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[2]);
	*(&iLocal_238 + 752[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder54", 4,203895E-45f, Vector(-840,0287f, 14,22204f, 3751,655f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[3]);
	*(&iLocal_238 + 752[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder55", 4,203895E-45f, Vector(-791,483f, 14,22204f, 3761,306f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[4]);
	*(&iLocal_238 + 752[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder56", 4,203895E-45f, Vector(-767,9371f, 14,22204f, 3706,355f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[5]);
	*(&iLocal_238 + 752[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder57", 4,203895E-45f, Vector(-776,0715f, 14,22204f, 3728,357f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[6]);
	*(&iLocal_238 + 752[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder58", 4,203895E-45f, Vector(-855,1661f, 14,22204f, 3725,353f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[7]);
	*(&iLocal_238 + 752[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder59", 4,203895E-45f, Vector(-741,2905f, 14,22204f, 3728,619f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[8]);
	*(&iLocal_238 + 752[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder60", 4,203895E-45f, Vector(-798,5344f, 14,22204f, 3750,051f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[9]);
	*(&iLocal_238 + 752[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder61", 4,203895E-45f, Vector(-824.0f, 14,22204f, 3764.0f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[10]);
	*(&iLocal_238 + 752[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "Cylinder62", 4,203895E-45f, Vector(-845,1601f, 14,22204f, 3696,963f), Vector(0.0f, 20.0f, 0.0f), Vector(5,376306f, 15,18995f, 5,853055f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 856, &iLocal_238 + 752[11]);
	*(&iLocal_238 + 864) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_liarsdice", 2,802597E-45f, Vector(-789,4973f, 13,4669f, 3698,786f), Vector(0.0f, -43,11062f, 0.0f), Vector(5,090456f, 5,090456f, 5,090456f));
	*(&iLocal_238 + 872) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_poker", 2,802597E-45f, Vector(-795,1835f, 13,4669f, 3699,552f), Vector(0.0f, -43,11062f, 0.0f), Vector(6,340227f, 5,090456f, 5,090456f));
	*(&iLocal_238 + 896) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_train_platform_set");
	*(&iLocal_238 + 880[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_train_platform_01", 2,802597E-45f, Vector(-807,3448f, 13,81927f, 3779,459f), Vector(0.0f, -45,37596f, 0.0f), Vector(20,26508f, 14,77738f, 31,95724f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 896, &iLocal_238 + 880[0]);
	*(&iLocal_238 + 944) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_CourtYrd_set");
	*(&iLocal_238 + 904[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_CourtYrd_02", 2,802597E-45f, Vector(-780,2878f, 13,05098f, 3709,311f), Vector(0.0f, 46,09587f, 0.0f), Vector(23,69177f, 12,77384f, 8,261987f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 944, &iLocal_238 + 904[0]);
	*(&iLocal_238 + 904[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_CourtYrd_03", 2,802597E-45f, Vector(-781,5798f, 13,01439f, 3699,925f), Vector(0.0f, -44,35699f, 0.0f), Vector(8,206616f, 8,351545f, 9,999015f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 944, &iLocal_238 + 904[1]);
	*(&iLocal_238 + 904[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_CourtYrd_04", 2,802597E-45f, Vector(-828,0232f, 13,2275f, 3728,073f), Vector(0.0f, -45,66846f, 0.0f), Vector(17,11484f, 15,15773f, 16,34783f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 944, &iLocal_238 + 904[2]);
	*(&iLocal_238 + 904[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_CourtYrd_05", 2,802597E-45f, Vector(-809,9717f, 13,2275f, 3727,646f), Vector(0.0f, -45,66846f, 0.0f), Vector(20,97757f, 18,57875f, 42,01398f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 944, &iLocal_238 + 904[3]);
	*(&iLocal_238 + 952) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_patioupper", 2,802597E-45f, Vector(-820,549f, 18,43921f, 3710,325f), Vector(-0,2801316f, 44,35781f, -0,879748f), Vector(8,267499f, 3,73759f, 16,12029f));
	*(&iLocal_238 + 960) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_patiolower", 2,802597E-45f, Vector(-832,2273f, 14,75896f, 3714,829f), Vector(-0,2801316f, 44,35781f, -0,879748f), Vector(11,67304f, 5,277174f, 7,373465f));
	*(&iLocal_238 + 984) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_238, "casv_trainyard_set");
	*(&iLocal_238 + 968[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_238, "casv_trainyard_01", 2,802597E-45f, Vector(-783,8069f, 13,05098f, 3747,955f), Vector(0.0f, 46,09587f, 0.0f), Vector(41,4718f, 22,36026f, 39,71608f));
	ADD_TO_VOLUME_SET(&iLocal_238 + 984, &iLocal_238 + 968[0]);
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_report_crime_road", Vector(-843,8538f, 12,80097f, 3799,341f), Vector(0.0f, 153,566f, 0.0f));
	*(&iLocal_238 + 992) = Vector(-798,875f, 13,052f, 3718,32f);
	*(&iLocal_238 + 992 + 12) = Vector(0.0f, 129,5424f, 0.0f);
	*(&iLocal_238 + 1016) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_enDuel1", Vector(-798,875f, 13,052f, 3718,32f), Vector(0.0f, 129,5424f, 0.0f));
	*(&iLocal_238 + 1024) = Vector(-805,637f, 13,052f, 3724,192f);
	*(&iLocal_238 + 1024 + 12) = Vector(0.0f, 310,034f, 0.0f);
	*(&iLocal_238 + 1048) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_playerDuel1", Vector(-805,637f, 13,052f, 3724,192f), Vector(0.0f, 310,034f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_clear_bounty", Vector(-806,509f, 13,604f, 3778,119f), Vector(0.0f, 53,728f, 0.0f));
	*(&iLocal_238 + 1056) = Vector(-810,2482f, 13,46156f, 3781,604f);
	*(&iLocal_238 + 1056 + 12) = Vector(0.0f, 45,03443f, 0.0f);
	*(&iLocal_238 + 1080) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_train", Vector(-810,2482f, 13,46156f, 3781,604f), Vector(0.0f, 45,03443f, 0.0f));
	*(&iLocal_238 + 1088) = Vector(-791,525f, 13,09719f, 3700,97f);
	*(&iLocal_238 + 1088 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1112) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_saloon", Vector(-791,525f, 13,09719f, 3700,97f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1120) = Vector(-786,8501f, 13,16464f, 3691,692f);
	*(&iLocal_238 + 1120 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1144) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_house", Vector(-786,8501f, 13,16464f, 3691,692f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1152) = Vector(-820,6178f, 13,11084f, 3710,959f);
	*(&iLocal_238 + 1152 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1176) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room", Vector(-820,6178f, 13,11084f, 3710,959f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1184) = Vector(-815,7907f, 13,11084f, 3705,553f);
	*(&iLocal_238 + 1184 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1208) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room1", Vector(-815,7907f, 13,11084f, 3705,553f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1216) = Vector(-811,6736f, 13,11084f, 3700,942f);
	*(&iLocal_238 + 1216 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1240) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room2", Vector(-811,6736f, 13,11084f, 3700,942f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1248) = Vector(-806,9931f, 13,11084f, 3695,701f);
	*(&iLocal_238 + 1248 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1272) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room3", Vector(-806,9931f, 13,11084f, 3695,701f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1280) = Vector(-811,8158f, 16,67075f, 3693,402f);
	*(&iLocal_238 + 1280 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1304) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room4", Vector(-811,8158f, 16,67075f, 3693,402f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1312) = Vector(-818,0532f, 16,67075f, 3700,387f);
	*(&iLocal_238 + 1312 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1336) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room5", Vector(-818,0532f, 16,67075f, 3700,387f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1344) = Vector(-813,9606f, 17,10117f, 3706,818f);
	*(&iLocal_238 + 1344 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1368) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room6", Vector(-813,9606f, 17,10117f, 3706,818f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1376) = Vector(-810,0627f, 17,10117f, 3702,453f);
	*(&iLocal_238 + 1376 + 12) = Vector(0.0f, 228,2381f, 0.0f);
	*(&iLocal_238 + 1400) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room7", Vector(-810,0627f, 17,10117f, 3702,453f), Vector(0.0f, 228,2381f, 0.0f));
	*(&iLocal_238 + 1408) = Vector(-804,9431f, 17,10117f, 3697,665f);
	*(&iLocal_238 + 1408 + 12) = Vector(0.0f, 403,9355f, 0.0f);
	*(&iLocal_238 + 1432) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "casf_interiorPoint_room8", Vector(-804,9431f, 17,10117f, 3697,665f), Vector(0.0f, 403,9355f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos1", Vector(-732,781f, 15,471f, 3738,639f), Vector(-1,4f, 93,691f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos2", Vector(-798,373f, 22,81f, 3944,837f), Vector(-2,745f, -20,61f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos3", Vector(-641,201f, 38,305f, 3803,866f), Vector(-13,205f, 68,847f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos4", Vector(-820,656f, 23,022f, 3816,73f), Vector(-6,96f, -22,109f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos5", Vector(-852,164f, 25,875f, 3696,872f), Vector(-7,658f, -128,018f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos6", Vector(-837,26f, 19,185f, 3783,303f), Vector(-8,226f, -70,808f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos7", Vector(-821,606f, 14,435f, 3755,39f), Vector(2,893f, -18,159f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos8", Vector(-843,792f, 20,28f, 3729,123f), Vector(-9,04f, -74,629f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos9", Vector(-813,713f, 16,584f, 3736,573f), Vector(-7,097f, -17,422f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_238, "cas_vista_cam_pos10", Vector(-762,416f, 19,465f, 3710,691f), Vector(-3,76f, 122,27f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0x10358 / 66392
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0x103A2 / 66466
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0x103B3 / 66483
{
	return;
}

bool Function_254() //Position: 0x103B9 / 66489
{
	return 1;
}

void Function_255() //Position: 0x103C0 / 66496
{
...
bool Function_256() //Position: 0x10456 / 66646
{
	return Function_257();
}

int Function_257() //Position: 0x1045F / 66655
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("CasaMadrugada_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("CasaMadrugada_layout");
	}
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-790,2934f, 19,55101f, 3696,901f), Vector(0.0f, 44,67266f, 0.0f), Vector(18,81964f, 7.0f, 25,68936f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-782,1068f, 16,38974f, 3763,964f), Vector(0.0f, 45,41782f, 0.0f), Vector(4,089084f, 7.0f, 3,100368f));
	*(&iLocal_178 + 80) = Vector(-805,9355f, 13,1009f, 3708,502f);
	*(&iLocal_178 + 80 + 12) = Vector(0.0f, -135,8845f, 0.0f);
	*(&iLocal_178 + 104) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-805,9355f, 13,1009f, 3708,502f), Vector(0.0f, -135,8845f, 0.0f));
	*(&iLocal_178 + 112) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-782,3847f, 16,04831f, 3764,405f), Vector(0.0f, 70.0f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 112);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03", Vector(-797,9075f, 15,56747f, 3729,229f), Vector(0.0f, 32,04296f, 0.0f));
	DECOR_SET_INT(&uVar2, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 112);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-793,1645f, 17,61095f, 3704,51f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_BOOL(&uVar3, "Core", 1);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 112);
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-792,186f, 17,61095f, 3705,489f), Vector(0.0f, 405.0f, 0.0f));
	DECOR_SET_BOOL(&uVar4, "Core", 1);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 120);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-793,1645f, 17,61095f, 3704,51f), Vector(0.0f, 225.0f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", 1);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 120);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-783,1251f, 16,06645f, 3763,557f), Vector(0.0f, -135.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 120);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-782,0715f, 16,06645f, 3764,61f), Vector(0.0f, 45.0f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 120);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_player", Vector(-797,9223f, 15,567f, 3730,629f), Vector(0.0f, 360.0f, 0.0f));
	DECOR_SET_INT(&uVar8, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 120);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_03_surv", Vector(-797,9075f, 15,56747f, 3729,229f), Vector(0.0f, 180.0f, 0.0f));
	DECOR_SET_INT(&uVar9, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 120);
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05", Vector(-795,0137f, 17,90234f, 3702,256f), Vector(0.0f, 134,514f, 0.0f));
	DECOR_SET_INT(&uVar10, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 128);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-797,9075f, 15,56747f, 3729,229f), Vector(0.0f, 32,04296f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 128);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04_core", Vector(-793,1645f, 17,61095f, 3704,51f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", 1);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 128);
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_player", Vector(-794,7728f, 17,90234f, 3702,49f), Vector(0.0f, 405.0f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 136);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_05_surv", Vector(-795,805f, 17,90234f, 3701,458f), Vector(0.0f, 225.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 136);
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_defSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-795,0137f, 17,90234f, 3702,256f), Vector(0.0f, 134,514f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 144);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def09", Vector(-782,3847f, 16,04831f, 3764,405f), Vector(0.0f, 70.0f, 0.0f));
	DECOR_SET_INT(&uVar16, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 144);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-784,5569f, 17,00459f, 3694,355f), Vector(0.0f, 220,5936f, 0.0f));
	DECOR_SET_BOOL(&uVar17, "Core", 1);
	DECOR_SET_INT(&uVar17, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 144);
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_player", Vector(-785,5258f, 17,00459f, 3695,324f), Vector(0.0f, -45.0f, 0.0f));
	DECOR_SET_BOOL(&uVar18, "Core", 1);
	DECOR_SET_INT(&uVar18, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 152);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_07_surv", Vector(-784,5569f, 17,00459f, 3694,355f), Vector(0.0f, 135.0f, 0.0f));
	DECOR_SET_BOOL(&uVar19, "Core", 1);
	DECOR_SET_INT(&uVar19, "GiveWeapon", 39);
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-806,3001f, 13,11084f, 3706,333f), Vector(0.0f, 97,49034f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 160);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-784,9116f, 13,09357f, 3764,408f), Vector(0.0f, 34,49513f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 160);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe03", Vector(-808,3615f, 13,11084f, 3705,188f), Vector(0.0f, 226,0872f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar23 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-812,363f, 13,11084f, 3705,837f), Vector(0.0f, 90.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar23, &iLocal_178 + 168);
	uVar24 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-812,7915f, 13,59102f, 3781,379f), Vector(0.0f, -45.0f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar24, &iLocal_178 + 168);
	*(&iLocal_178 + 176) = Vector(-819,4399f, 13,11084f, 3712,137f);
	*(&iLocal_178 + 176 + 12) = Vector(0.0f, -134,983f, 0.0f);
	*(&iLocal_178 + 200) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-819,4399f, 13,11084f, 3712,137f), Vector(0.0f, -134,983f, 0.0f));
	*(&iLocal_178 + 208) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand1", "rand_idle_stand", Vector(-806,2977f, 13,11749f, 3706,33f), Vector(0.0f, -262,4864f, 0.0f));
	*(&iLocal_178 + 216) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand2", "rand_idle_stand", Vector(-784,9116f, 13,09896f, 3764,408f), Vector(0.0f, -685,1762f, 0.0f));
	*(&iLocal_178 + 224) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(-808,3799f, 13,11084f, 3705,174f), Vector(0.0f, -495,322f, 0.0f));
	*(&iLocal_178 + 232) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_R", "ZombiePack_player_sleep_bed_R", Vector(-822,9794f, 13,10997f, 3708,667f), Vector(0.0f, -45,61752f, 0.0f));
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0x110F7 / 69879
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0x11192 / 70034
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0x1129E / 70302
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0x1137A / 70522
{
...
int Function_262(int iParam0) //Position: 0x113F5 / 70645
{
...
bool Function_263(int iParam0) //Position: 0x1140A / 70666
{
...
int Function_264(int iParam0) //Position: 0x11470 / 70768
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0x11532 / 70962
{
	int iVar0;
...
void Function_266() //Position: 0x1154F / 70991
{
	ALLOW_TUMBLEWEEDS(0);
	return;
}

void Function_267(char* cParam0) //Position: 0x11559 / 71001
{
	if (!Function_26(128))
	{
		return;
