...
void main() //Position: 0x0 / 0
{
	...
	uVar3 = FIND_NAMED_LAYOUT("TesoroAzul_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "tesv_region");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xBEE / 3054
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xBFF / 3071
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xC57 / 3159
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xCE9 / 3305
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xD05 / 3333
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD45 / 3397
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD62 / 3426
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD73 / 3443
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xDF1 / 3569
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE5D / 3677
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xEC9 / 3785
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0xF10 / 3856
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF1D / 3869
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0xF9F / 3999
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0xFAE / 4014
{
	if (!Function_4(128))
	{
		return;
