...
void main() //Position: 0x0 / 0
{
	...
	iLocal_129 = 0;
	Function_108(&uScriptParam_0, &iLocal_129);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_130);
		}
		iVar2 = 0;
		bLocal_137 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_101(&(vLocal_19[iVar39]), &bVar4))
						{
							Function_99(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_19[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_94("eGRINGO_EndUse: Stop use by request", &vLocal_19[iVar39] + 24);
							Function_93(&vLocal_19[iVar39] + 24, 1);
							...
							{
								Function_86(&(vLocal_19[iVar39]), 0);
							}
							else if (vLocal_19[iVar39].f_68 < 8)
							{
								Function_85(&(vLocal_19[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_138))
	{
		Function_111("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_138);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_129 - 1))
	{
		if (Function_84(vLocal_19[iVar09].f_64, 2))
		{
			...
			Function_86(&(vLocal_19[iVar09]), 0);
		}
...
void Function_2(int iParam0, char* cParam1) //Position: 0x44E / 1102
{
	var uVar0;
...
int Function_4(int iParam0) //Position: 0x498 / 1176
{
	iParam0 = &iParam0;
	return 0;
}

void Function_5(struct<69> Param0) //Position: 0x4A5 / 1189
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_138))
								{
									...
									{
										iLocal_138 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_138 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_138))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_138))
		{
			Function_111("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_138);
		}
...
bool Function_6(int iParam0) //Position: 0x7D9 / 2009
{
	float fVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_7(bool bParam0, var uParam1, int iParam2) //Position: 0x8F2 / 2290
{
	int iVar0;
	bool bVar1;
...
bool Function_8(int iParam0, int iParam1) //Position: 0x910 / 2320
{
	return Function_9(&iParam0, "UseQuit", &iParam1);
}

bool Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x929 / 2345
{
	int iVar0;
	int iVar1;
...
float Function_10(int iParam0) //Position: 0x979 / 2425
{
	return Function_11(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(float fParam0, var uParam1, int iParam2) //Position: 0x997 / 2455
{
	int iVar0;
...
float Function_12(vector3 vParam0) //Position: 0x9AF / 2479
{
...
bool Function_13(int iParam0) //Position: 0xA7C / 2684
{
	return Function_84(iParam0, 2);
}

bool Function_14(int iParam0) //Position: 0xA8A / 2698
{
	return Function_84(iParam0, 1);
}

bool Function_15(int iParam0, int iParam1) //Position: 0xA98 / 2712
{
	bool bVar0;
...
bool Function_16(struct<69> Param0) //Position: 0xAE5 / 2789
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_135, &uLocal_133);
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_84(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_17(var uParam0, int iParam1) //Position: 0x1E1A / 7706
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1E31 / 7729
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	if (iLocal_7 && IS_OBJECT_VALID(&bLocal_15))
	{
		if (Function_12(&iLocal_9) <= 2,5f)
		{
			DESTROY_OBJECT(&bLocal_15);
			CAMERA_RESET(0);
		}
	}
	return;
...
bool Function_19() //Position: 0x1E67 / 7783
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E9A / 7834
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1F18 / 7960
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x1F94 / 8084
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1FA6 / 8102
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1FBD / 8125
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1FCA / 8138
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, int iParam1) //Position: 0x1FEB / 8171
{
	var uVar0;
	struct<2> Var2;
	...
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (!iLocal_4 && Function_12(&iLocal_0) < 0,65f)
	{
		uVar0 = GET_TARGET_OBJECT();
		if (GET_OBJECT_TYPE(&uVar0) == 17)
		{
			GET_OBJECT_POSITION(&uVar0, &Var2);
			UNK_0x6745191B(StackVal, CREATE_RMPTFX_EMITTER_IN_LAYOUT(&uVar0, Function_27(), "fire_zombie_02_dataSphere", Var2), Vector(0.0f, 0.0f, 0.0f));
		}
		iLocal_4 = 1;
	}
	return 1;
...
var Function_27() //Position: 0x205E / 8286
{
	int iVar0;
...
bool Function_28(bool bParam0) //Position: 0x2067 / 8295
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_29() //Position: 0x2087 / 8327
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x208D / 8333
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x209F / 8351
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x20AC / 8364
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(int iParam0, int iParam1) //Position: 0x20C7 / 8391
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x20E7 / 8423
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x2107 / 8455
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x213E / 8510
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x215E / 8542
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x2179 / 8569
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x218F / 8591
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &iParam1, Function_27(), Function_40(&iParam0 + 16, &iVar10), 0, bVar9);
	}
...
bool Function_40(int iParam0, int iParam1) //Position: 0x24B3 / 9395
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24D2 / 9426
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(int iParam0, int iParam1) //Position: 0x24E1 / 9441
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2505 / 9477
{
...
bool Function_45(var uParam0, int iParam1) //Position: 0x2549 / 9545
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x256B / 9579
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x258D / 9613
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2655 / 9813
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26D1 / 9937
{
...
void Function_50(vector3 vParam0) //Position: 0x26E9 / 9961
{
...
var Function_51(int iParam0) //Position: 0x270E / 9998
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x272F / 10031
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2746 / 10054
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2752 / 10066
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2759 / 10073
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x276A / 10090
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27AF / 10159
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27DB / 10203
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27E7 / 10215
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28E9 / 10473
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x290C / 10508
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2934 / 10548
{
	struct<8> Var0;
	
	bParam0 = &bParam0;
	if (iLocal_7 && !iLocal_8)
	{
		iLocal_8 = 1;
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_72("LootCorpse_Layout") };
		uLocal_13 = CREATE_LAYOUT(&Var0);
		Function_71(&iLocal_9);
		if (RAND_INT_RANGE(0, 100000) <= 50000)
		{
			bLocal_15 = Function_67(&uLocal_13, 0, &Global_54076, 1, 0, 0);
		}
		else
		{
			bLocal_15 = Function_63(&uLocal_13, 0, &Global_54076, 1, 0, 0);
		}
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x29A9 / 10665
{
	var uVar0;
	
	if (&bParam3)
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, Function_27(), 2, 1);
	}
	else
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "nATestShot", 2, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2A2F / 10799
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x2A74 / 10868
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 40,00002f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(0,990934f, 0,741472f, -2,885897f), Vector(3,690737f, 155,787f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
...
void Function_66(var uParam0, bool bParam1) //Position: 0x2B05 / 11013
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &uParam0, &bParam1, Vector(1,196374f, 0,737337f, -2,840414f), Vector(3,872986f, 150,7197f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
...
var Function_67(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2B9B / 11163
{
	var uVar0;
...
void Function_68(var uParam0, int iParam1) //Position: 0x2C21 / 11297
{
	var uVar0;
	...
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(&uParam0, 1);
	Function_69(&uVar0, &iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(&uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_LERP(&uParam0, 0, 1, 2,5f, 0, 0);
	return;
}

void Function_69(int iParam0, int iParam1) //Position: 0x2C66 / 11366
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	...
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(0.0f, 0,75f, -2,5f), Vector(4.0f, 190.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &iParam1, 1);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
...
void Function_70(int iParam0, var uParam1) //Position: 0x2CEF / 11503
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 40.0f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 0);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(-0,25f, 0,75f, -2,5f), Vector(4.0f, 200.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGET(&iParam0, 0);
...
void Function_71(int iParam0) //Position: 0x2D85 / 11653
{
	Function_50(&iParam0, 0.0f);
	return;
}

struct<32> Function_72(char* cParam0) //Position: 0x2D92 / 11666
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_73(char* cParam0) //Position: 0x2DFE / 11774
{
	char* cVar0[32];
...
void Function_74(int iParam0) //Position: 0x2E20 / 11808
{
	iParam0 = &iParam0;
	return;
}

bool Function_75(int iParam0) //Position: 0x2E2C / 11820
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_76(int iParam0) //Position: 0x2E4B / 11851
{
	if (!Function_14(&iParam0))
	{
		Function_50(&iParam0, 0.0f);
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2E62 / 11874
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_78(int iParam0) //Position: 0x2EF3 / 12019
{
	struct<2> Var0;
...
struct<8> Function_79(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2F17 / 12055
{
	struct<2> Var0;
...
int Function_80(int iParam0) //Position: 0x2F36 / 12086
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_81(var uParam0, int iParam1) //Position: 0x2F5A / 12122
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_82(var uParam0, int iParam1) //Position: 0x3082 / 12418
{
...
int Function_83(var uParam0) //Position: 0x30B0 / 12464
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_84(var uParam0, int iParam1) //Position: 0x31C9 / 12745
{
	return (uParam0 && iParam1) == 0;
}

void Function_85(struct<69> Param0) //Position: 0x31D6 / 12758
{
	if (Function_84(Param0.f_64, 16))
	{
...
void Function_86(struct<69> Param0) //Position: 0x3258 / 12888
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_135)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_133));
		iLocal_135 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_37(&Param0 + 16))
...
void Function_87() //Position: 0x3803 / 14339
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x383D / 14397
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_89(int iParam0, var uParam1) //Position: 0x385B / 14427
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_90(int iParam0) //Position: 0x389C / 14492
{
	iParam0 = &iParam0;
	return;
}

bool Function_91(int iParam0) //Position: 0x38A8 / 14504
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_92(var uParam0, var uParam1) //Position: 0x38CA / 14538
{
	int iVar0;
	...
	iVar0 = GET_BLIP_ON_OBJECT(GET_TARGET_OBJECT());
	if (IS_BLIP_VALID(&iVar0))
	{
		REMOVE_BLIP(&iVar0);
	}
	if (IS_OBJECT_VALID(&bLocal_15))
	{
		DESTROY_OBJECT(&bLocal_15);
	}
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	if (bLocal_6 != 4294967295)
	{
		ACTOR_PUT_WEAPON_IN_HAND(&Global_54076, bLocal_6, 1);
	}
	return;
}

void Function_93(var uParam0, bool bParam1) //Position: 0x392E / 14638
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_94(int iParam0, int iParam1) //Position: 0x3A3E / 14910
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_95(struct<69> Param0) //Position: 0x3A56 / 14934
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	if (GRINGO_GET_USE_REQUIRES_OBSTACLE(&uVar0))
	{
		...
		ATTACH_OBJECTS(StackVal, StackVal, &Param0 + 56, &Param0 + 24, Function_27(), Vector(0.0f, 1.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	}
	Function_52(&Param0);
...
void Function_96(var uParam0, int iParam1) //Position: 0x3D72 / 15730
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		{
			bLocal_6 = GET_WEAPON_IN_HAND(&Global_54076);
...
bool Function_97(int iParam0) //Position: 0x3DC2 / 15810
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_98(int iParam0) //Position: 0x3DDC / 15836
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_99(int iParam0, var uParam1) //Position: 0x3DF7 / 15863
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_100(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_100(var uParam0, int iParam1) //Position: 0x3E35 / 15925
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_101(struct<65> Param0) //Position: 0x3E4E / 15950
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_84(Param0.f_64, 2))
		{
			...
			else
			{
				...
				if (!Function_103(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				fVar30 = Function_102(&Param0 + 16);
				if (!fVar30 != 0.0f)
				{
					if (fVar30 < 0.0f)
					{
...
int Function_102(int iParam0) //Position: 0x4148 / 16712
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_103(var uParam0, int iParam1) //Position: 0x4166 / 16742
{
	struct<5> Var0;
	float fVar5;
...
int Function_104(int iParam0) //Position: 0x4206 / 16902
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_105(int iParam0, var uParam1) //Position: 0x4226 / 16934
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_106(int iParam0) //Position: 0x4239 / 16953
{
...
void Function_107(int iParam0) //Position: 0x4255 / 16981
{
	iParam0 = &iParam0;
	return;
}

void Function_108(var uParam0, int iParam1) //Position: 0x4261 / 16993
{
	int iVar0;
	var uVar1;
	...
	{
		Function_109(&(vLocal_19[iLocal_1299]), &uParam0);
		iLocal_129++;
	}
...
void Function_109(int iParam0, int iParam1) //Position: 0x42CD / 17101
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_110(int iParam0) //Position: 0x42E5 / 17125
{
	iParam0 = &iParam0;
	return;
}

void Function_111(int iParam0) //Position: 0x42F1 / 17137
{
