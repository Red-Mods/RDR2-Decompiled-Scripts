						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_121))
								{
									...
									{
										bLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
void Function_47(char* cParam0, int iParam1) //Position: 0x24FE / 9470
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_96(var uParam0, int iParam1) //Position: 0x3FBA / 16314
{
	bool bVar0;
	var uVar1;
	...
	uParam0 = &uParam0;
	bVar0 = false;
	uVar1 = Function_9(&iParam1, "CheckForWeapon", &bVar0);
	if (!bVar0)
	{
		return 0;
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyRifle"))
	{
		return ACTOR_HAS_WEAPON(&uParam0, 42);
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyRepeater"))
	{
		return ACTOR_HAS_WEAPON(&uParam0, 41);
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyRevolver"))
	{
		return ACTOR_HAS_WEAPON(&uParam0, 40);
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "nAnyPistol"))
	{
		return ACTOR_HAS_WEAPON(&uParam0, 39);
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyShotgun"))
	{
		return ACTOR_HAS_WEAPON(&uParam0, 43);
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyRifleOrRepeater"))
	{
		return (ACTOR_HAS_WEAPON(&uParam0, 41) || ACTOR_HAS_WEAPON(&uParam0, 42));
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyPistolOrRevolver"))
	{
		return (ACTOR_HAS_WEAPON(&uParam0, 39) || ACTOR_HAS_WEAPON(&uParam0, 40));
	}
	if (STRINGS_ARE_EQUAL(&uVar1, "AnyRifleOrRepeaterOrShotgun"))
	{
		return ((ACTOR_HAS_WEAPON(&uParam0, 41) || ACTOR_HAS_WEAPON(&uParam0, 42)) || ACTOR_HAS_WEAPON(&uParam0, 43));
	}
	return 0;
}

bool Function_97(int iParam0) //Position: 0x4151 / 16721
{
...
void Function_98(int iParam0) //Position: 0x416D / 16749
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4179 / 16761
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x41E5 / 16869
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x41FD / 16893
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4209 / 16905
{
