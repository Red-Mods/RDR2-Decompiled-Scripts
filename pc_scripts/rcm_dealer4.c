	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Function_146(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 5;
						break;
					
					case 0x00000005:
						if (Function_108("$/cutscene/RCM_02_CS05/RCM_02_CS05", &iLocal_326, 26819, 26812, 26774, 26736, 26327, 26311, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						Function_107(&Global_99725[ScriptParam_043] + 228, 32);
						Function_107(&Global_99725[2743] + 228, 16384);
						Function_105("Dealer4_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Dealer4_OBJ", 0, 3, false);
						...
						*(&Global_99725[2743] + 312) = &uLocal_338;
						(&Global_99725[2643] + 312) = "";
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x246 / 582
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x278 / 632
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x295 / 661
{
	RELEASE_LAYOUT_REF(&iLocal_345);
	return;
}

void Function_4(int iParam0) //Position: 0x2A2 / 674
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_5(struct<229> Param0) //Position: 0x45C / 1116
{
	float fVar0;
	int iVar1;
...
void Function_6(struct<217> Param0) //Position: 0x52C / 1324
{
	float fVar0;
	var uVar1;
...
int Function_7(var uParam0, int iParam1) //Position: 0x5EA / 1514
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0x754 / 1876
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0x7FC / 2044
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0x868 / 2152
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0x88A / 2186
{
	int iVar0;
	struct<2> Var1;
...
float Function_12(int iParam0, struct<2> Param1) //Position: 0x9F8 / 2552
{
	struct<2> Var0;
...
struct<8> Function_13(int iParam0) //Position: 0xA6F / 2671
{
	struct<2> Var0;
...
void Function_14(int iParam0) //Position: 0xADB / 2779
{
...
bool Function_15(int iParam0) //Position: 0xB43 / 2883
{
...
var Function_16() //Position: 0xB59 / 2905
{
	int iVar0;
...
void Function_17(struct<153> Param0) //Position: 0xB62 / 2914
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_18(int iParam0) //Position: 0xCD1 / 3281
{
...
var Function_19(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xCFD / 3325
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_20(int iParam0) //Position: 0xD1E / 3358
{
...
bool Function_21(struct<249> Param0) //Position: 0xD33 / 3379
{
...
bool Function_22(struct<265> Param0) //Position: 0xE63 / 3683
{
	int iVar0;
...
bool Function_23(int iParam0) //Position: 0xFC4 / 4036
{
...
bool Function_24(int iParam0) //Position: 0xFE8 / 4072
{
...
bool Function_25(int iParam0) //Position: 0xFFD / 4093
{
...
var Function_26(int iParam0) //Position: 0x1014 / 4116
{
...
bool Function_27(int iParam0) //Position: 0x102E / 4142
{
...
bool Function_28(int iParam0) //Position: 0x1044 / 4164
{
	return Global_116927[iParam06].f_16;
}

bool Function_29(var uParam0, int iParam1) //Position: 0x1054 / 4180
{
	int iVar0;
...
bool Function_30(struct<237> Param0) //Position: 0x1071 / 4209
{
	if (!Param0.f_236)
	{
		if (Function_31())
...
bool Function_31() //Position: 0x1140 / 4416
{
...
bool Function_32(int iParam0) //Position: 0x115B / 4443
{
...
void Function_33(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x11B6 / 4534
{
	bool bVar0;
	char* cVar1[16];
...
void Function_34(char* cParam0) //Position: 0x122B / 4651
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_35(int iParam0, var uParam1, int iParam2) //Position: 0x1265 / 4709
{
	var uVar0;
	char* cVar1[16];
...
int Function_36(char* cParam0) //Position: 0x12E1 / 4833
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_37(int iParam0) //Position: 0x1382 / 4994
{
	int iVar0;
	int iVar1;
...
void Function_38(int iParam0, int iParam1) //Position: 0x13BF / 5055
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x13D5 / 5077
{
...
bool Function_40(int iParam0) //Position: 0x13E8 / 5096
{
	int iVar0;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x1404 / 5124
{
	int iVar0;
...
int Function_42(int iParam0) //Position: 0x1421 / 5153
{
...
bool Function_43(int iParam0) //Position: 0x1436 / 5174
{
...
int Function_44(int iParam0) //Position: 0x144B / 5195
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x1460 / 5216
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x146D / 5229
{
...
int Function_47(int iParam0, int iParam1) //Position: 0x14ED / 5357
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_48(char* cParam0) //Position: 0x2150 / 8528
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_49(int iParam0, bool bParam1) //Position: 0x2168 / 8552
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x21A6 / 8614
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x21F5 / 8693
{
...
int Function_52(int iParam0) //Position: 0x220B / 8715
{
...
void Function_53() //Position: 0x2274 / 8820
{
...
bool Function_54(int iParam0) //Position: 0x2299 / 8857
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x22EA / 8938
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x2317 / 8983
{
	if (!Function_51(iParam0))
	{
...
void Function_57(int iParam0) //Position: 0x2369 / 9065
{
	int iVar0;
...
void Function_58(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x23A3 / 9123
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x293B / 10555
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_60() //Position: 0x2ADC / 10972
{
	return;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2AE2 / 10978
{
	if (Global_6624)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x2B21 / 11041
{
...
void Function_63() //Position: 0x2B76 / 11126
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_64() //Position: 0x2BC1 / 11201
{
...
void Function_65() //Position: 0x2CC7 / 11463
{
	float fVar0;
...
void Function_66() //Position: 0x2CFA / 11514
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x2E8D / 11917
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3046 / 12358
{
	Function_69(&Global_42918, 1, 0);
	return;
}

void Function_69(struct<2317> Param0) //Position: 0x3054 / 12372
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x3271 / 12913
{
...
struct<8> Function_71(int iParam0) //Position: 0x3286 / 12934
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x332D / 13101
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x35C9 / 13769
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_74(int iParam0) //Position: 0x3C07 / 15367
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3C18 / 15384
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x3D0F / 15631
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3D2A / 15658
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x3D91 / 15761
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x3DA3 / 15779
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3DB5 / 15797
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x3EE9 / 16105
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x3EF8 / 16120
{
	if (!iParam0 != 4294967295)
	{
...
var Function_83(int iParam0) //Position: 0x3F31 / 16177
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x3F6E / 16238
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
void Function_107(var uParam0, bool bParam1) //Position: 0x5502 / 21762
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5513 / 21779
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_109(var uParam0, int iParam1, struct<41> Param2) //Position: 0x55CC / 21964
{
	if (!&bParam15)
	{
...
void Function_110(var uParam0, bool bParam1) //Position: 0x5C2E / 23598
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_111() //Position: 0x5CFD / 23805
{
	int iVar0;
...
void Function_112() //Position: 0x5D75 / 23925
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_113() //Position: 0x5DBA / 23994
{
...
void Function_114(var uParam0, int iParam1) //Position: 0x5DCC / 24012
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_115(int iParam0) //Position: 0x5E5E / 24158
{
	bool bVar0;
...
float Function_116(vector3 vParam0) //Position: 0x5E8F / 24207
{
...
bool Function_117(int iParam0) //Position: 0x5F5C / 24412
{
	return Function_45(iParam0, 2);
}

bool Function_118(int iParam0) //Position: 0x5F6A / 24426
{
	return Function_45(iParam0, 1);
}

int Function_119(bool bParam0) //Position: 0x5F78 / 24440
{
	bool bVar0;
	var uVar1;
...
bool Function_120() //Position: 0x603B / 24635
{
	bool bVar0;
	var uVar1;
...
void Function_121(int iParam0) //Position: 0x6078 / 24696
{
	Function_122(&iParam0, 0.0f);
	return;
}

void Function_122(vector3 vParam0) //Position: 0x6085 / 24709
{
...
bool Function_123(struct<37> Param0) //Position: 0x60AA / 24746
{
	return Param0.f_36;
}

void Function_124(var uParam0, int iParam1) //Position: 0x60B5 / 24757
{
	Function_125(&uParam0, &iParam1, 0);
	return;
}

void Function_125(var uParam0, bool bParam1, int iParam2) //Position: 0x60C5 / 24773
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_126(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x623D / 25149
{
	int iVar0;
	int iVar1;
...
void Function_127(bool bParam0) //Position: 0x6465 / 25701
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6503 / 25859
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x652D / 25901
{
	var uVar0;
	var uVar1;
...
void Function_130() //Position: 0x6588 / 25992
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_131() //Position: 0x66C7 / 26311
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x66D7 / 26327
{
	Function_134(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_133(&Global_99725[2643] + 320, 1);
	DESTROY_VOLUME(&uLocal_343);
	return 1;
}

void Function_133(var uParam0, bool bParam1) //Position: 0x6703 / 26371
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_134(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x678C / 26508
{
	var uVar0;
...
void Function_135() //Position: 0x685B / 26715
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x6870 / 26736
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2660,34f, 31,39f, 4255,76f), 268,559f, 1, 1, true);
	return 1;
}

int Function_137() //Position: 0x6896 / 26774
{
	SET_RCM_ACTOR_CALL_OVER_SUPPRESS(2.0f);
	if (!iLocal_347)
	{
		Function_133(&Global_99725[2643] + 320, 0);
		iLocal_347 = 1;
	}
	return 1;
}

int Function_138() //Position: 0x68BC / 26812
{
	return 1;
}

int Function_139() //Position: 0x68C3 / 26819
{
	uLocal_343 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_345, "tempcutscenevol", 2, (&Global_99725[2643] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_142(0, 1, 0, 1, 0, 1, 1, &uLocal_343, 1, 1, 1, 1, 0x3f800000, 0);
	Function_140(StackVal, &iLocal_345, *(&Global_99725[2643] + 196), &uLocal_343, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_140(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x693C / 26940
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_141(var uParam0, float fParam1) //Position: 0x6BDC / 27612
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_142(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x6C5E / 27742
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_145(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_16(), 2, Function_145(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_144()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_143(int iParam0) //Position: 0x6F10 / 28432
{
	int iVar0;
...
var Function_144() //Position: 0x6F44 / 28484
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_145(int iParam0) //Position: 0x6FD2 / 28626
{
	struct<2> Var0;
...
int Function_146(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x6FE4 / 28644
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_147(struct<257> Param0) //Position: 0x716F / 29039
{
...
int Function_148(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x71AB / 29099
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_151(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_152()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_151(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_152()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
...
void Function_149() //Position: 0x7413 / 29715
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_150(char* cParam0) //Position: 0x7467 / 29799
{
	char* cVar0[64];
...
bool Function_151(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7590 / 30096
{
...
int Function_152() //Position: 0x761C / 30236
{
	if (IS_PS3())
	{
		return 1;
...
void Function_153() //Position: 0x762B / 30251
{
	var uVar0;
	
	Function_154(4, 1);
	uVar0 = &uVar0;
	iLocal_345 = CREATE_LAYOUT("Dealer_layout");
	return;
}

void Function_154(int iParam0, int iParam1) //Position: 0x7653 / 30291
{
	switch (&iParam1)
	{
		case 0x00000000:
