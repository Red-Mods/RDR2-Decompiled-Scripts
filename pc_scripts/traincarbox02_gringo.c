...
bool Function_13(var uParam0) //Position: 0x5B3 / 1459
{
	...
	*(&iLocal_0 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarBoxcar2_pop", 2,802597E-45f, Vector(0.0f, 2,119719f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,572681f, 2,283565f, 9,472619f));
	*(&iLocal_0 + 56) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_left", "train_climb_left", Vector(-1,287784f, 1,014794f, -0,02201801f), Vector(0.0f, 90,2034f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 56, "trainAttach", false);
	*(&iLocal_0 + 64) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "train_climb_right", "train_climb_right", Vector(1,286159f, 1,014794f, -0,08863876f), Vector(0.0f, 270,7476f, 0.0f));
	DECOR_SET_INT(&iLocal_0 + 64, "trainAttach", true);
	Function_14(&iLocal_0, &uParam0);
	return 1;
}

void Function_14(bool bParam0, int iParam1) //Position: 0x774 / 1908
{
	var uVar0;
...
var Function_15() //Position: 0x7BF / 1983
{
	int iVar0;
...
bool Function_16(struct<2>[] Param0) //Position: 0x7C8 / 1992
{
	int iVar0;
	int iVar1;
...
void Function_17() //Position: 0xB8A / 2954
{
	if (!Function_25(128))
	{
		return;
...
bool Function_18() //Position: 0xBCA / 3018
{
	int iVar0;
...
void Function_19(struct<13> Param0) //Position: 0xBF8 / 3064
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_20() //Position: 0xC0B / 3083
{
	if (!Function_25(128))
	{
		return;
...
var Function_21(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xC4D / 3149
{
	int iVar0;
	var uVar1;
...
var Function_22(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xC8B / 3211
{
	int iVar0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xD5A / 3418
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_24(var uParam0, int iParam1) //Position: 0xDA4 / 3492
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_25(int iParam0) //Position: 0xDB5 / 3509
{
	int iVar0;
