...
void Function_51(int iParam0, var uParam1, var uParam2) //Position: 0x2B0C / 11020
{
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0) && uParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(&cVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(&uParam1, &cVar1, Function_53(&cVar1, "AttachBone", &iVar2), Function_53(&cVar1, "AttachLocator", &iVar2), 1))
				{
					Function_52(&cVar1, &uParam1);
					uParam2 = 1;
				}
			}
		}
...
var Function_53(char* cParam0, char* cParam1, int iParam2) //Position: 0x2C71 / 11377
{
	int iVar0;
	int iVar1;
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uVar0 = Function_53(&uParam0, "OutfitEnum", &iVar1);
	if ((Function_90(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
	{
		iLocal_4 = 0;
	}
	iVar2 = 0;
	while (iVar2 <= Global_42265)
	{
		if (iVar2 != 4294967295)
		{
			if (STRINGS_ARE_EQUAL(&Global_42265[iVar29] + 32, &uVar0))
			{
				if (Function_89(iVar2) != 32)
				{
					DECOR_SET_BOOL(&uParam1, "ItemSave", true);
				}
				Function_57(Global_42265[iVar29], 32, 0, 0, 0);
				iParam2 = 1;
			}
		}
		iVar2++;
...
void Function_57(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x2D97 / 11671
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_86(bParam0, 2))
	{
		...
		Function_83(bParam0, 2);
		if (!&bParam2)
		{
			cVar8 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, cVar0 };
			stradd(&cVar8, "_tip", 32);
			Function_81(&cVar8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = &bParam2;
	if (!Function_80(bParam0, bParam1))
	{
		Global_42265[bParam09].f_4 = (StackVal || bParam1);
		Function_83(bParam0, 1048576);
		if (&bParam4)
		{
		...
		Function_74(bParam0);
		if (StackVal && !Function_44(((((!Function_73() && !Global_6623) && !Global_6635) && !Global_6627) && !&bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, 0, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_44((((Function_73() || Global_6623) || Global_6635) || Global_6627), 1))
		{
		...
		if (!Function_46())
		{
			if (!Function_72(Global_119934, 2))
			{
				Function_67(&Global_54076, 2, 1, 0);
			}
		}
...
void Function_58(int iParam0, int iParam1) //Position: 0x3036 / 12342
{
	bool bVar0;
...
void Function_59(int iParam0, bool bParam1) //Position: 0x30A0 / 12448
{
...
void Function_60() //Position: 0x310F / 12559
{
...
int Function_61(int iParam0, int iParam1) //Position: 0x318F / 12687
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_62(int iParam0) //Position: 0x3DF2 / 15858
{
...
int Function_63(int iParam0, bool bParam1) //Position: 0x3E07 / 15879
{
	int iVar0;
...
bool Function_64(int iParam0) //Position: 0x3E45 / 15941
{
...
var Function_65(int iParam0) //Position: 0x3E5C / 15964
{
...
bool Function_66(int iParam0) //Position: 0x3E76 / 15990
{
...
void Function_67(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3E8C / 16012
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_69(&uParam0, uParam1, &uParam2) && !&bParam3)
	{
		return;
	}
...
void Function_68(char* cParam0) //Position: 0x3F01 / 16129
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_69(int iParam0, var uParam1, int iParam2) //Position: 0x3F3B / 16187
{
	var uVar0;
	char* cVar1[16];
	...
	{
		if (Function_71(DECOR_GET_INT(&iParam0, &cVar1)) > 3)
		{
			return 0;
		}
	}
...
int Function_70(char* cParam0) //Position: 0x3FB7 / 16311
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_71(int iParam0) //Position: 0x409A / 16538
{
	int iVar0;
	int iVar1;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x40D7 / 16599
{
...
bool Function_73() //Position: 0x40EA / 16618
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_74(bool bParam0) //Position: 0x4117 / 16663
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (!IS_JOURNAL_ENTRY_IN_LIST(Global_42265[bParam09].f_64, 0) && !IS_JOURNAL_ENTRY_IN_LIST(Global_42265[bParam09].f_64, 1))
	{
		...
		while (bVar24 <= Global_42265[bParam09].f_28)
		{
			...
			if (Function_80(bParam0, Function_78(bVar24)))
			{
	...
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_42265[bParam09].f_64, (TO_FLOAT(Function_77(bParam0)) / TO_FLOAT(Global_42265[bParam09].f_28)), false, 0);
		Function_76(Global_42265[bParam09].f_64, 0);
		straddi(&cVar8, Function_75(bParam0), 32);
		SET_JOURNAL_ENTRY_CURRENT_OBJECTIVE(Global_42265[bParam09].f_64, &cVar8, 3);
	}
	return;
}

int Function_75(int iParam0) //Position: 0x42C7 / 17095
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_76(char* cParam0, bool bParam1) //Position: 0x431E / 17182
{
	bool bVar0;
...
var Function_77(int iParam0) //Position: 0x4343 / 17219
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_78(bool bParam0) //Position: 0x4399 / 17305
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_79() //Position: 0x43A5 / 17317
{
	return;
}

bool Function_80(bool bParam0, int iParam1) //Position: 0x43AB / 17323
{
	int iVar0;
...
void Function_81(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x440A / 17418
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_82(int iParam0) //Position: 0x4495 / 17557
{
	char* cVar0[16];
...
void Function_83(int iParam0, int iParam1) //Position: 0x44D4 / 17620
{
	if (!Function_88(iParam0))
	{
...
int Function_84(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x4529 / 17705
{
	int iVar0;
	int iVar1;
...
void Function_85(int iParam0) //Position: 0x4751 / 18257
{
	switch (iParam0)
	{
		case 0x00000009:
...
bool Function_86(int iParam0, int iParam1) //Position: 0x47EF / 18415
{
	int iVar0;
...
bool Function_87(int iParam0) //Position: 0x481C / 18460
{
...
bool Function_88(int iParam0) //Position: 0x4838 / 18488
{
...
int Function_89(int iParam0) //Position: 0x484E / 18510
{
	int iVar0;
	int iVar1;
...
int Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x489D / 18589
{
...
bool Function_91() //Position: 0x4961 / 18785
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_92(int iParam0) //Position: 0x4978 / 18808
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_93(int iParam0) //Position: 0x4984 / 18820
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_94(int iParam0) //Position: 0x4993 / 18835
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_95(int iParam0, int iParam1) //Position: 0x49AE / 18862
{
	var uVar0;
	var uVar1;
