...
void main() //Position: 0x0 / 0
{
	...
	Function_16(&(Global_46972[0]), 397, 8.0f, 0, 0);
	Function_16(&(Global_46972[0]), 398, 8.0f, 0, 0);
	Function_16(&(Global_46972[0]), 400, 2.0f, 0, 0);
	Function_16(&(Global_46972[0]), 401, 2.0f, 0, 0);
	Function_16(&(Global_46972[0]), 403, 1.0f, 0, 0);
	Function_16(&(Global_46972[0]), 404, 1.0f, 0, 0);
	Function_18(&(Global_46972[1]));
	Global_46972[1] = Function_17("ped_traveller", 3);
	Function_16(&(Global_46972[1]), 397, 8.0f, 0, 0);
	Function_16(&(Global_46972[1]), 398, 8.0f, 0, 0);
	Function_16(&(Global_46972[1]), 400, 2.0f, 0, 0);
	Function_16(&(Global_46972[1]), 401, 2.0f, 0, 0);
	Function_16(&(Global_46972[1]), 403, 1.0f, 0, 0);
	Function_16(&(Global_46972[1]), 404, 1.0f, 0, 0);
	...
	Function_16(&(Global_46972[3]), 397, 10.0f, 0, 0);
	Function_16(&(Global_46972[3]), 398, 10.0f, 0, 0);
	Function_16(&(Global_46972[3]), 400, 2.0f, 0, 0);
	Function_16(&(Global_46972[3]), 401, 2.0f, 0, 0);
	Function_16(&(Global_46972[3]), 403, 1.0f, 0, 0);
	Function_16(&(Global_46972[3]), 404, 1.0f, 0, 0);
	Function_18(&(Global_46972[4]));
	Global_46972[4] = Function_17("ped_bad_guys_generic", 1);
	Function_16(&(Global_46972[4]), 397, 10.0f, 0, 0);
	Function_16(&(Global_46972[4]), 398, 10.0f, 0, 0);
	Function_16(&(Global_46972[4]), 400, 2.0f, 0, 0);
	Function_16(&(Global_46972[4]), 401, 2.0f, 0, 0);
	...
	Function_16(&(Global_46972[5]), 1049, 8.0f, 0, 0);
	Function_16(&(Global_46972[5]), 1128, 3.0f, 0, 0);
	...
	Function_11(&(Global_46972[5]), 9E-05f);
	...
	if (!Global_6623)
	{
		...
		{
			uVar4 = GET_VOLUME_FROM_OBJECT(Function_4(GET_PLAYER_ACTOR(0), 4));
			if (IS_VOLUME_VALID(&uVar4))
			{
				Function_3(&uVar4, &(uVar0[0]), RAND_INT_RANGE(3, 5), 0, 0, 1);
				Function_3(&uVar4, &(uVar0[1]), RAND_INT_RANGE(3, 5), 0, 0, 1);
				Function_3(&uVar4, &(uVar0[2]), RAND_INT_RANGE(2, 4), 0, 0, 1);
			}
			else
			{
...
void Function_1(var uParam0, var uParam1) //Position: 0x7D2 / 2002
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x7E3 / 2019
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x83B / 2107
{
	var uVar0;
...
var Function_4(int iParam0, int iParam1) //Position: 0x8CB / 2251
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
int Function_5(int iParam0) //Position: 0xAB3 / 2739
{
...
var Function_6() //Position: 0xAE9 / 2793
{
	int iVar0;
...
bool Function_7(float fParam0, int iParam1) //Position: 0xAF2 / 2802
{
...
bool Function_8(int iParam0) //Position: 0xB23 / 2851
{
	int iVar0;
...
void Function_9(char* cParam0) //Position: 0xB3F / 2879
{
	if (!Function_8(128))
	{
		return;
...
bool Function_10(var uParam0, int iParam1) //Position: 0xB7F / 2943
{
	int iVar0;
...
void Function_11(var uParam0, bool bParam1) //Position: 0xB9C / 2972
{
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xBAD / 2989
{
	int iVar0;
	int iVar1;
...
var Function_13(int iParam0) //Position: 0xC2B / 3115
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0xC97 / 3223
{
	int iVar0;
...
var Function_15(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xD03 / 3331
{
	int iVar0;
	int iVar1;
...
var Function_16(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xD4A / 3402
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, int iParam1) //Position: 0xDCC / 3532
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_18(int iParam0) //Position: 0xDDB / 3547
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

void Function_19(char* cParam0) //Position: 0xDE8 / 3560
{
	if (!Function_8(128))
	{
		return;
