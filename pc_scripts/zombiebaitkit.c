...
void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, int iParam7) //Position: 0xC10 / 3088
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	{
		if (Function_28(499) == 0)
		{
			Function_69("item_zbait_more_fever", 0x41200000, 1, 0, 2, 1, 0);
			bVar0 = true;
		}
		if (Function_28(493) == 0)
		{
			Function_69("item_zbait_more_poppy", 0x41200000, 1, 0, 2, 1, 0);
			bVar0 = true;
		}
	}
	if (bVar0)
	...
	bVar1 = CEIL((_GET_AMMO_AMOUNT(&Global_54076, 3, 0) + ACTOR_GET_WEAPON_AMMO(&Global_54076, 36)));
	if (IntToFloat(bVar1) <= _GET_MAX_AMMO_AMOUNT(&Global_54076, 3))
	{
		Function_69("item_zbait_full", 0x41200000, 1, 0, 2, 1, 0);
		return;
	}
	if (((Function_65(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
	{
		iLocal_4 = 0;
	}
	iLocal_4 = 0;
	...
	_ADD_AMMO_OF_TYPE(&Global_54076, 3, 1.0f, 0, 1);
	Function_57(668, 1, 0, 0);
	iParam2 = 1;
	return;
}

int Function_57(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2E2C / 11820
{
	int iVar0;
	int iVar1;
...
void Function_58(int iParam0) //Position: 0x3054 / 12372
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_59(int iParam0, bool bParam1) //Position: 0x30F2 / 12530
{
	bool bVar0;
	int iVar1;
...
int Function_60() //Position: 0x329D / 12957
{
	int iVar0;
...
void Function_61() //Position: 0x333E / 13118
{
	int iVar0;
	int iVar1;
...
void Function_62(int iParam0) //Position: 0x33FC / 13308
{
...
var Function_63(int iParam0, int iParam1) //Position: 0x3462 / 13410
{
	int iVar0;
...
int Function_64(int iParam0, bool bParam1, int iParam2) //Position: 0x34A7 / 13479
{
	int iVar0;
	int iVar1;
...
int Function_65(int iParam0, bool bParam1, bool bParam2) //Position: 0x36A4 / 13988
{
...
bool Function_66() //Position: 0x3768 / 14184
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_67(int iParam0) //Position: 0x377F / 14207
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_68(int iParam0) //Position: 0x378B / 14219
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_69(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x379A / 14234
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_70(Global_10966) };
		}
...
struct<16> Function_70(int iParam0) //Position: 0x3825 / 14373
{
	char* cVar0[16];
...
var Function_71(int iParam0) //Position: 0x3864 / 14436
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_72(int iParam0, int iParam1) //Position: 0x387F / 14463
{
	var uVar0;
	var uVar1;
