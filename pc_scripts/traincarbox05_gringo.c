...
void Function_5(int iParam0) //Position: 0x110 / 272
{
	bool bVar0;
	var uVar1;
...
var Function_6(int iParam0, var uParam1, bool bParam2, var uParam3, float fParam4) //Position: 0x15E / 350
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_7(struct<7> Param0) //Position: 0x399 / 921
{
...
bool Function_8(int iParam0, int iParam1) //Position: 0x3E3 / 995
{
...
bool Function_9(var uParam0) //Position: 0x3FE / 1022
{
	var uVar0;
	...
	*(&iLocal_0 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarBoxcar5_pop", 2,802597E-45f, Vector(0.0f, 2,01777f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,672175f, 2,360678f, 9,584975f));
	Function_10(&iLocal_0, &uParam0);
	return 1;
}

void Function_10(bool bParam0, int iParam1) //Position: 0x463 / 1123
{
	var uVar0;
...
var Function_11() //Position: 0x4AE / 1198
{
	int iVar0;
...
void Function_12(int iParam0, int iParam1) //Position: 0x4B7 / 1207
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_13(var uParam0, int iParam1) //Position: 0x501 / 1281
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_14(int iParam0) //Position: 0x512 / 1298
{
	int iVar0;
