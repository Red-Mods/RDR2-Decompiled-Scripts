...
void main() //Position: 0x0 / 0
{
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_112 - 1))
	{
...
void Function_2(int iParam0, char* cParam1) //Position: 0x442 / 1090
{
	var uVar0;
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
								{
									...
									{
										iLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_121 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_121))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_121))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_121);
		}
...
bool Function_7(bool bParam0, var uParam1, int iParam2) //Position: 0x8E7 / 2279
{
	...
	iVar1 = GET_GRINGO_BOOL_ATTR(&uParam1, &bParam0, &iVar0);
	if (iVar0 >= 0)
	{
		return iVar1;
	}
...
bool Function_8(int iParam0, int iParam1) //Position: 0x905 / 2309
{
	return Function_9(&iParam0, "UseQuit", &iParam1);
}

bool Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x91E / 2334
{
	int iVar0;
	int iVar1;
...
bool Function_26(int iParam0, var uParam1) //Position: 0x1FBC / 8124
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_30(int iParam0) //Position: 0x2007 / 8199
{
	iParam0 = &iParam0;
	return 1;
}
...
bool Function_32(int iParam0, int iParam1) //Position: 0x202F / 8239
{
...
void Function_38(int iParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x20F7 / 8439
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(&uVar4)))
	{
		...
		if (bVar5)
		{
			...
			*(&iParam0 + 48) = ATTACH_OBJECTS_PHYSICAL(&uParam1, &iParam0 + 24, &uVar6, &uVar8, 0,02f);
		}
		return;
	}
	iVar9 = 1;
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &uParam1, &uVar3, Function_40(&iParam0 + 16, &iVar10), 0, iVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(&iParam0 + 24, &uParam1, Function_39(), Function_40(&iParam0 + 16, &iVar10), 0, iVar9);
	}
	if (IS_GRINGO_COMPONENT_VALID(&uVar4))
	{
		...
		bParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(&uParam1, &uVar11, &iVar12, &uVar13);
		if (IS_OBJECT_ANIMATOR_VALID(&bParam3))
		{
			if (Function_7(&uVar4, "LinkToUser", 0))
			{
				...
				LINK_OBJECT_ANIMATOR_TO_ACTOR(&bParam3, &iParam0 + 24, iVar9);
			}
		}
		else
		{
...
bool Function_40(int iParam0, int iParam1) //Position: 0x2424 / 9252
{
...
bool Function_42(int iParam0, int iParam1) //Position: 0x2452 / 9298
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2476 / 9334
{
...
void Function_47(int iParam0, int iParam1) //Position: 0x24FE / 9470
{
	var uVar0;
	var uVar1;
	var uVar2;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2B8C / 11148
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BE9 / 11241
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C46 / 11334
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C52 / 11346
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C71 / 11377
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2C88 / 11400
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D19 / 11545
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D3D / 11581
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D5C / 11612
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D80 / 11648
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EA8 / 11944
{
...
int Function_74(var uParam0) //Position: 0x2ED6 / 11990
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2FEF / 12271
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x2FFC / 12284
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x307E / 12414
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3629 / 13865
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3663 / 13923
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3681 / 13953
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36C2 / 14018
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36CE / 14030
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x36F0 / 14064
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3708 / 14088
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3818 / 14360
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3830 / 14384
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B4C / 15180
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3B78 / 15224
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3B93 / 15251
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3BD1 / 15313
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3BEA / 15338
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3EE2 / 16098
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F00 / 16128
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3FA0 / 16288
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3FC0 / 16320
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FD3 / 16339
{
...
void Function_98(var uParam0) //Position: 0x3FEF / 16367
{
	uParam0 = &uParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4000 / 16384
{
	int iVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x406C / 16492
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(var uParam0) //Position: 0x4084 / 16516
{
	var uVar0;
	int iVar2;
	...
	iVar2 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/Player_Lockpick_Footlocker", &uVar0, 0,5f, 0);
	if (IS_GRINGO_VALID(&iVar2))
	{
		DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&iVar2));
	}
	return;
}

void Function_102(int iParam0) //Position: 0x40FE / 16638
{
