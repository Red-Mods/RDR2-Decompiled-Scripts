		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000004:
						if (Function_123("$/cutscene/RCM_17_CS01/RCM_17_CS01", &iLocal_326, 28286, 28258, 28251, 28144, 27888, 27851, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						Function_111("Lights1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Lights1_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_122(&Global_99725[4943] + 228, 256);
						Function_108(406, 1, 0, 0);
						Function_104(Global_46816[1]);
						Function_104(Global_46796[4]);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x211 / 529
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x243 / 579
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x260 / 608
{
	RELEASE_LAYOUT_REF(&iLocal_343);
	return;
}

void Function_4(bool bParam0) //Position: 0x26D / 621
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_5(struct<229> Param0) //Position: 0x427 / 1063
{
	float fVar0;
	int iVar1;
...
void Function_6(struct<217> Param0) //Position: 0x4F7 / 1271
{
	float fVar0;
	var uVar1;
...
int Function_7(var uParam0, int iParam1) //Position: 0x5B5 / 1461
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0x71F / 1823
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0x7C7 / 1991
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0x833 / 2099
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0x855 / 2133
{
	int iVar0;
	struct<2> Var1;
...
float Function_12(int iParam0, struct<2> Param1) //Position: 0x9C3 / 2499
{
	struct<2> Var0;
...
struct<8> Function_13(int iParam0) //Position: 0xA3A / 2618
{
	struct<2> Var0;
...
void Function_14(int iParam0) //Position: 0xAA6 / 2726
{
...
bool Function_15(int iParam0) //Position: 0xB0E / 2830
{
...
var Function_16() //Position: 0xB24 / 2852
{
	int iVar0;
...
void Function_17(struct<153> Param0) //Position: 0xB2D / 2861
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_18(int iParam0) //Position: 0xC9C / 3228
{
...
var Function_19(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xCC8 / 3272
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_20(int iParam0) //Position: 0xCE9 / 3305
{
...
bool Function_21(struct<249> Param0) //Position: 0xCFE / 3326
{
...
bool Function_22(struct<265> Param0) //Position: 0xE2E / 3630
{
	int iVar0;
...
bool Function_23(int iParam0) //Position: 0xF8F / 3983
{
...
bool Function_24(int iParam0) //Position: 0xFB3 / 4019
{
...
bool Function_25(int iParam0) //Position: 0xFC8 / 4040
{
...
var Function_26(int iParam0) //Position: 0xFDF / 4063
{
...
bool Function_27(int iParam0) //Position: 0xFF9 / 4089
{
...
bool Function_28(int iParam0) //Position: 0x100F / 4111
{
	return Global_116927[iParam06].f_16;
}

bool Function_29(var uParam0, int iParam1) //Position: 0x101F / 4127
{
	int iVar0;
...
bool Function_30(struct<237> Param0) //Position: 0x103C / 4156
{
	if (!Param0.f_236)
	{
		if (Function_31())
...
bool Function_31() //Position: 0x110B / 4363
{
...
bool Function_32(int iParam0) //Position: 0x1126 / 4390
{
...
void Function_33(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1181 / 4481
{
	bool bVar0;
	char* cVar1[16];
...
void Function_34(char* cParam0) //Position: 0x11F6 / 4598
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_35(int iParam0, var uParam1, int iParam2) //Position: 0x1230 / 4656
{
	var uVar0;
	char* cVar1[16];
...
int Function_36(char* cParam0) //Position: 0x12AC / 4780
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_37(int iParam0) //Position: 0x134D / 4941
{
	int iVar0;
	int iVar1;
...
void Function_38(int iParam0, int iParam1) //Position: 0x138A / 5002
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x13A0 / 5024
{
...
bool Function_40(int iParam0) //Position: 0x13B3 / 5043
{
	int iVar0;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x13CF / 5071
{
	int iVar0;
...
int Function_42(int iParam0) //Position: 0x13EC / 5100
{
...
bool Function_43(int iParam0) //Position: 0x1401 / 5121
{
...
int Function_44(int iParam0) //Position: 0x1416 / 5142
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x142B / 5163
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x1438 / 5176
{
...
int Function_47(int iParam0, int iParam1) //Position: 0x14B8 / 5304
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_48(char* cParam0) //Position: 0x211B / 8475
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_49(int iParam0, bool bParam1) //Position: 0x2133 / 8499
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x2171 / 8561
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x21C0 / 8640
{
...
int Function_52(int iParam0) //Position: 0x21D6 / 8662
{
...
void Function_53() //Position: 0x223F / 8767
{
...
bool Function_54(int iParam0) //Position: 0x2264 / 8804
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x22B5 / 8885
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x22E2 / 8930
{
	if (!Function_51(iParam0))
	{
...
void Function_57(bool bParam0) //Position: 0x2334 / 9012
{
	int iVar0;
...
void Function_58(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x236E / 9070
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2906 / 10502
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_60() //Position: 0x2AA7 / 10919
{
	return;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2AAD / 10925
{
	if (Global_6624)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x2AEC / 10988
{
...
void Function_63() //Position: 0x2B41 / 11073
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_64() //Position: 0x2B8C / 11148
{
...
void Function_65() //Position: 0x2C92 / 11410
{
	float fVar0;
...
void Function_66() //Position: 0x2CC5 / 11461
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x2E58 / 11864
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3011 / 12305
{
	Function_69(&Global_42918, 1, 0);
	return;
}

void Function_69(struct<2317> Param0) //Position: 0x301F / 12319
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x323C / 12860
{
...
struct<8> Function_71(int iParam0) //Position: 0x3251 / 12881
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x32F8 / 13048
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3594 / 13716
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_74(int iParam0) //Position: 0x3BD2 / 15314
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3BE3 / 15331
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x3CDA / 15578
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3CF5 / 15605
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x3D5C / 15708
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x3D6E / 15726
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3D80 / 15744
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x3EB4 / 16052
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x3EC3 / 16067
{
	if (!iParam0 != 4294967295)
	{
...
float Function_83(int iParam0) //Position: 0x3EFC / 16124
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x3F39 / 16185
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x5893 / 22675
{
	bool bVar0;
...
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-2063,831f, 21,305f, 2653,99f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}
...
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[4943] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[4943] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-2064,643f, 19,52f, 2653,19f), 226,424f, 1, 1, true);
	return 1;
}

int Function_149() //Position: 0x6E5B / 28251
{
	return 1;
}

int Function_150() //Position: 0x6E62 / 28258
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-2063,831f, 21,305f, 2653,99f), 0, 0);
	return 1;
}

int Function_151() //Position: 0x6E7E / 28286
{
	uLocal_341 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_343, "tempcutscenevol", 2, (&Global_99725[4943] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_154(0, 0, 1, 1, 0, 1, 1, &uLocal_341, 1, 1, 1, 1, 0x3f800000, 0);
	Function_152(StackVal, &iLocal_343, *(&Global_99725[4943] + 196), &uLocal_341, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_152(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x6EF7 / 28407
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_153(var uParam0, float fParam1) //Position: 0x7197 / 29079
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_154(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7219 / 29209
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_157(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_16(), 2, Function_157(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_155(int iParam0) //Position: 0x74CB / 29899
{
	int iVar0;
...
var Function_156() //Position: 0x74FF / 29951
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_157(int iParam0) //Position: 0x758D / 30093
{
	struct<2> Var0;
...
int Function_158(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x759F / 30111
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_159(struct<257> Param0) //Position: 0x772A / 30506
{
...
int Function_160(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7766 / 30566
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_161() //Position: 0x79CE / 31182
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_162(char* cParam0) //Position: 0x7A22 / 31266
{
	char* cVar0[64];
...
bool Function_163(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7B4B / 31563
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_13(&uParam0);
...
int Function_164() //Position: 0x7BD7 / 31703
{
	if (IS_PS3())
	{
		return 1;
...
void Function_165() //Position: 0x7BE6 / 31718
{
	var uVar0;
	
	Function_166(4, 1);
	uVar0 = &uVar0;
	iLocal_343 = CREATE_LAYOUT("Lights_layout");
	return;
}

void Function_166(int iParam0, int iParam1) //Position: 0x7C0E / 31758
{
	switch (&iParam1)
	{
		case 0x00000000:
