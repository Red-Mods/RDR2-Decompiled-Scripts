...
{
	RELEASE_LAYOUT_REF(&uLocal_15);
	Function_4(0, &uLocal_9, &uLocal_11, &uLocal_3, &uLocal_13, 4294967295);
	return;
}
...
var Function_28(struct<477> Param0) //Position: 0x1478 / 5240
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_17 || bParam2) || Global_6611)
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_19, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_19, 20.0f, fLocal_19));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_132(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_20, &Param0 + 488, 0, 0, 0x40400000))
						{
...
{
	Function_96(&uLocal_3, "$/content/scripting/gringo/simplegringo/gun01_drunk", 1, 0);
	if (Function_77(&uLocal_9, &uLocal_3, 19, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_75(&uLocal_15, "outlaw02mobile", &iParam1))
		{
			uLocal_11 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_15, Function_132()));
			*(&Global_6667[1928] + 216) = &uLocal_11;
			*(&iParam0 + 24) = &uLocal_15;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3ABC / 15036
{
	struct<2> Var0;
	var uVar2;
	
	uLocal_13 = CREATE_LAYOUT("outlaw02campfirelayout");
	Var0 = Vector(-3668,79f, 8,32f, 3496,28f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_9, Var0, 157,073f, 1, 1, 1);
	uVar2 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_13, "outlaw02drinking", "gun01_drunk", Vector(-3669,22f, 8,367f, 3497,462f), Vector(0,065f, -0,107f, 0,992f));
	SNAP_OBJECT_TO_GROUND(&uVar2, 2.0f, false, 1092616192);
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar2), 0);
	SNAP_ACTOR_TO_GRINGO(&uLocal_9, &uVar2, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_9, GET_GRINGO_FROM_OBJECT(&uVar2), "UseCase1", 4294967295, 1);
	Function_73(&uLocal_9, &uLocal_11, 1, 1);
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3BA4 / 15268
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x3D61 / 15713
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x3DA9 / 15785
{
...
void Function_76(var uParam0, bool bParam1) //Position: 0x3DD9 / 15833
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3E24 / 15908
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_95(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_94(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_92(uVar0))
		{
	...
	if (StackVal || !Function_90((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_94(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
		if (Function_92(iVar1))
		{
			if (Function_99(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_78(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_78(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4004 / 16388
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_89(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
	...
	else
	{
		...
		if (&bParam8)
		{
			bVar1 = Function_81(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_79(var uParam0, bool bParam1) //Position: 0x4544 / 17732
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_80(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4566 / 17766
{
	var uVar0;
...
var Function_81(bool bParam0, int iParam1) //Position: 0x45C7 / 17863
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_82(var uParam0, int iParam1) //Position: 0x4655 / 18005
{
	Function_84(&uParam0);
	Function_83(&uParam0);
...
void Function_83(int iParam0) //Position: 0x4681 / 18049
{
...
void Function_84(int iParam0) //Position: 0x46A7 / 18087
{
...
bool Function_85(bool bParam0) //Position: 0x477D / 18301
{
...
var Function_86(int iParam0, int iParam1) //Position: 0x4794 / 18324
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_87(int iParam0, bool bParam1, bool bParam2) //Position: 0x483A / 18490
{
	var uVar0;
	var uVar1;
...
void Function_88(var uParam0) //Position: 0x4949 / 18761
{
	int iVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x497C / 18812
{
	int iVar0;
...
bool Function_90(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4999 / 18841
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_91() //Position: 0x4A25 / 18981
{
	var uVar0;
	int iVar1;
...
bool Function_92(int iParam0) //Position: 0x4A95 / 19093
{
	if (!Function_93(iParam0))
	{
		return 1;
	}
	return Function_89(&(Global_43791[iParam0]), 4);
}

bool Function_93(int iParam0) //Position: 0x4AB1 / 19121
{
...
var Function_94(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4AC7 / 19143
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_95(struct<205> Param0) //Position: 0x4B6D / 19309
{
	var uVar0;
	var uVar1;
...
var Function_96(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4C78 / 19576
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_98(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_97(struct<13> Param0) //Position: 0x4CB6 / 19638
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_98(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4CC9 / 19657
{
	int iVar0;
...
bool Function_99(struct<2>[] Param0) //Position: 0x4D98 / 19864
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x515A / 20826
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x519A / 20890
{
	int iVar0;
...
void Function_102() //Position: 0x51C8 / 20936
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x520A / 21002
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x52A2 / 21154
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x52D1 / 21201
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x532C / 21292
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x533C / 21308
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5350 / 21328
{
	int iVar0;
...
var Function_109() //Position: 0x5375 / 21365
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x538C / 21388
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_111() //Position: 0x54C8 / 21704
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x54DA / 21722
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x54EC / 21740
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x54FE / 21758
{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x5523 / 21795
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x5542 / 21826
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x554E / 21838
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x5559 / 21849
{
	int iVar0;
...
var Function_119() //Position: 0x5587 / 21895
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x559C / 21916
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_121() //Position: 0x56A9 / 22185
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x56BD / 22205
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x5729 / 22313
{
	char* cVar0[32];
...
var Function_124() //Position: 0x574B / 22347
{
	return "PBox_";
}

var Function_125() //Position: 0x5759 / 22361
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x577F / 22399
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x57A7 / 22439
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x57CD / 22477
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5937 / 22839
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x59DF / 23007
{
	int iVar0;
	struct<2> Var1;
...
void Function_131(int iParam0) //Position: 0x5B4D / 23373
{
...
var Function_132() //Position: 0x5BB5 / 23477
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5BBE / 23486
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5BDC / 23516
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5ED5 / 24277
{
	int iVar0;
...
void Function_136() //Position: 0x5F89 / 24457
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5FC4 / 24516
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x5FF1 / 24561
{
	bool bVar0;
...
void Function_139() //Position: 0x614C / 24908
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6198 / 24984
{
	int iVar0;
...
int Function_141() //Position: 0x6274 / 25204
{
	int iVar0;
...
int Function_142() //Position: 0x63D0 / 25552
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x64F0 / 25840
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x65CC / 26060
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x65EB / 26091
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x672E / 26414
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x6750 / 26448
{
	int iVar0;
...
int Function_148() //Position: 0x676C / 26476
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x6773 / 26483
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_98(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_98(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
