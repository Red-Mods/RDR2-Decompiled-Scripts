...
void main() //Position: 0x0 / 0
{
	...
	iLocal_335 = 0;
	bLocal_348 = false;
	Local_393 = Vector(-3211,382f, 40,157f, 3695,802f);
	iLocal_398 = 0;
	iLocal_411 = 0;
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_336 = 1000;
			Function_204(&uLocal_351, "$/fragments/p_gen_projector01x", 0, 0);
			Function_204(&uLocal_351, "$/fragments/p_gen_chair04x", 0, 0);
			Function_203(&uLocal_351, 1284, 3, 0);
			Function_203(&uLocal_351, 1205, 3, 0);
			Function_203(&uLocal_351, 1224, 3, 0);
			Function_204(&uLocal_351, "$/content/DLC/ZombiePack/Gringos/DLC_McKenna1", 1, 0);
			while (!IS_EXITFLAG_SET())
			{
				if (Function_202())
				{
					if (IS_ACTOR_VALID(&uLocal_379))
					{
						TASK_FLEE_ACTOR(&uLocal_379, &Global_54076, -1.0f, -1.0f, 0, 0, 0);
						SET_ACTOR_FACTION(&uLocal_379, 3);
					}
					if (IS_ACTOR_VALID(&uLocal_377))
					{
						TASK_MELEE_ATTACK(&uLocal_377, &Global_54076, -1.0f);
					}
					Function_200();
				}
				if (iVar0 <= 3)
				{
					Function_187(&uLocal_379, 40327, &uLocal_403, &iLocal_407, 5);
				}
				else if (iVar0 == 3)
				{
					Function_186(&uLocal_403);
					Function_186(&iLocal_407);
				}
				else if (iVar0 >= 3)
				{
					Function_187(&uLocal_379, 40327, &uLocal_403, &iLocal_407, 5);
				...
				if (!iLocal_399)
				{
					uLocal_401 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(*(&Global_99725[043] + 184), 10.0f, "p_gen_campfire", 1);
					if (IS_PHYSINST_VALID(&uLocal_401))
					{
						iLocal_399 = 1;
						HIDE_PHYSINST(&uLocal_401);
						SET_PHYSINST_FROZEN(&uLocal_401, true);
						uLocal_391 = GET_OBJECT_FROM_PHYSINST(&uLocal_401);
						if (IS_OBJECT_VALID(&uLocal_391))
						{
							SET_OBJECT_COLLIDE_WITH_MOVABLES(&uLocal_391, 0);
						}
					}
				}
				if (!iLocal_400)
				{
					uLocal_396 = LOCATE_GRINGO_OF_TYPE("fema_stir_cauldron", &Global_99725[043] + 184, 10.0f, 1);
					if (IS_GRINGO_VALID(&uLocal_396))
					{
						iLocal_400 = 1;
						DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&uLocal_396));
					}
				}
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (Function_181(&uLocal_351))
								{
									uLocal_383 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_349, "stayPutVol", 2,802597E-45f, Vector(-3188,779f, 40,92f, 3714,029f), Vector(0.0f, 232,941f, 0.0f), Vector(8.0f, 8.0f, 8.0f));
									...
									uLocal_379 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "Mackenna", 1284, Vector(-3192,431f, 40,632f, 3711,572f), Vector(0.0f, 232,941f, 0.0f));
									ADD_ACTOR_STAY_WITHIN_VOLUME(&uLocal_379, &uLocal_383);
									uLocal_377 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "MackennaZombie", 1205, Vector(-3187,7f, 41,25f, 3723,76f), Vector(0.0f, 55,848f, 0.0f));
									if (!IS_ACTOR_HOGTIED(&uLocal_377))
									{
										HOGTIE_ACTOR(&uLocal_377);
										AI_IGNORE_ACTOR(&uLocal_377);
										DECOR_SET_BOOL(&uLocal_377, "NoTalk_CutFree", true);
										DECOR_SET_BOOL(&uLocal_377, "CutFree_IgnoreObstruction", true);
										SET_MOVER_FROZEN(&uLocal_377, true);
										DECOR_SET_BOOL(&uLocal_377, "ActionArea_DisableHogtie", true);
										SET_ACTOR_ALLOW_WEAPON_REACTIONS(&uLocal_377, false);
										SET_ACTOR_OBEY_AMBIENT_MOVE_RESTRICTIONS(&uLocal_377, 0);
									}
									TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_377, Vector(-3188,157f, 41,35f, 3724,301f), 236,495f, 1, 1, true);
									uLocal_387 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "RCM_Mackenna Camera", "$/fragments/p_gen_projector01x", Vector(-3183,368f, 41,5f, 3729,427f), Vector(0.0f, 54,55f, 0.0f), true);
									uLocal_389 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "RCM_Mackenna Chair", "$/fragments/p_gen_chair04x", Vector(-3183,169f, 41,44f, 3724,295f), Vector(0.0f, -51,844f, 0.0f), true);
									DELETE_ALL_WEAPONS_FROM_ACTOR(&uLocal_379);
									SET_ACTOR_FACTION(&uLocal_379, 20);
									uLocal_381 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "zombieStayOut", 2, *(&Global_99725[ScriptParam_043] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(50.0f, 10.0f, 50.0f));
									...
									uLocal_385 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "mackennaGringo", "$/content/DLC/ZombiePack/Gringos/DLC_McKenna1", Vector(-3188,779f, 40,92f, 3714,029f), Vector(0.0f, 215,753f, 0.0f));
									TASK_USE_GRINGO(&uLocal_379, GET_GRINGO_FROM_OBJECT(&uLocal_385), "UseCase1", 4294967295, 1);
									SNAP_ACTOR_TO_GRINGO(&uLocal_379, &uLocal_385, "UseCase1", true, 0, 0);
									SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_379, 1, 0, true, 1, 0, 2, 1101004800, 1088421888, 1);
									TASK_PRIORITY_SET(&uLocal_379, 2);
									AI_IGNORE_ACTOR(&uLocal_379);
									AI_IGNORE_ACTOR(&uLocal_377);
									SET_ACTOR_VISION_MAX_RANGE(&uLocal_379, 10.0f, 1);
									SET_ACTOR_HEARING_MAX_RANGE(&uLocal_379, 10.0f);
									iVar0 = 1;
								}
							}
							else
					...
					case 0x00000001:
						...
						{
							Function_180(&Global_99725[ScriptParam_043] + 228, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_174();
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							break;
						}
						bLocal_348 = Function_173(&uLocal_379, 0x3f800000, 0x42960000, 1, 1, 0);
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_348)
							{
								if (StackVal && FABS((StackVal - !Function_169(&Global_54076, 1, 1))) > 2.0f)
								{
									if (Function_165(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
									{
						...
						Function_158(&(Global_99725[043]), 0, 0x41f00000, 0x42200000, 0);
						if (Function_157())
						{
							TASK_MELEE_ATTACK(&uLocal_377, &Global_54076, -1.0f);
							if (IS_ACTOR_VALID(&uLocal_379))
					...
					case 0x00000003:
						if (Function_115("$/cutscene/mckenna_1_pt_a_cs/mckenna_1_pt_a_cs", &iLocal_336, 33592, 33585, 32240, 31796, 31540, 31524, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						if (!HUD_IS_FADING() && !HUD_IS_FADED())
						{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "mackenna1_OBJ", 0, 3, false);
							Function_113(Global_99725[ScriptParam_043].f_224, 0);
							AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_379, 1, 1, false, 1, 0, 2, 1101004800, 1088421888, 1);
							TASK_PRIORITY_SET(&uLocal_379, 2);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8F3 / 2291
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xD6D / 3437
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xF0E / 3854
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xF14 / 3860
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xF53 / 3923
{
...
void Function_6() //Position: 0xFA8 / 4008
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_7() //Position: 0xFF3 / 4083
{
...
void Function_8() //Position: 0x10F9 / 4345
{
	float fVar0;
...
void Function_9() //Position: 0x112C / 4396
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x12BF / 4799
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x1478 / 5240
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x1486 / 5254
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x16A3 / 5795
{
...
struct<8> Function_14(int iParam0) //Position: 0x16B8 / 5816
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x175F / 5983
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x19FB / 6651
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_17() //Position: 0x2039 / 8249
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x2042 / 8258
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2053 / 8275
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x214A / 8522
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2165 / 8549
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x21CC / 8652
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x21DE / 8670
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x21F0 / 8688
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x2324 / 8996
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x2333 / 9011
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x236C / 9068
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x23A9 / 9129
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x2543 / 9539
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x2787 / 10119
{
...
struct<8> Function_31() //Position: 0x27C8 / 10184
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x2851 / 10321
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x28E8 / 10472
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x2967 / 10599
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x29A4 / 10660
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2BB0 / 11184
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x2C67 / 11367
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2C7F / 11391
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x2D77 / 11639
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_40(int iParam0) //Position: 0x2D81 / 11649
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x2D97 / 11671
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x2E63 / 11875
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x2E80 / 11904
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x36AC / 13996
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x36E7 / 14055
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x36F4 / 14068
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3703 / 14083
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x37B2 / 14258
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_49(int iParam0) //Position: 0x40D4 / 16596
{
...
bool Function_50(int iParam0) //Position: 0x40EE / 16622
{
...
bool Function_51(int iParam0, int iParam1) //Position: 0x4105 / 16645
{
	int iVar0;
...
bool Function_52() //Position: 0x4122 / 16674
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x412E / 16686
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x4143 / 16707
{
...
int Function_55(int iParam0) //Position: 0x41A9 / 16809
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_56(int iParam0) //Position: 0x426B / 17003
{
...
void Function_57(int iParam0) //Position: 0x4280 / 17024
{
	...
	Function_113(Function_52(), 0);
	return;
}

bool Function_58(int iParam0, bool bParam1) //Position: 0x42C9 / 17097
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x4307 / 17159
{
...
bool Function_60(int iParam0) //Position: 0x4321 / 17185
{
...
void Function_61(bool bParam0) //Position: 0x4337 / 17207
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_45(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_180(&Global_99725[iVar143] + 228, 64);
...
void Function_62(struct<229> Param0) //Position: 0x44F1 / 17649
{
	float fVar0;
	int iVar1;
...
void Function_63(struct<217> Param0) //Position: 0x45C1 / 17857
{
	float fVar0;
	var uVar1;
...
int Function_64(var uParam0, int iParam1) //Position: 0x467F / 18047
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, struct<2> Param2) //Position: 0x47E9 / 18409
{
	struct<8> Var0;
...
struct<32> Function_66(char* cParam0) //Position: 0x4891 / 18577
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x48FD / 18685
{
	char* cVar0[32];
...
int Function_68(int iParam0) //Position: 0x491F / 18719
{
	int iVar0;
	struct<2> Var1;
...
float Function_69(int iParam0, struct<2> Param1) //Position: 0x4A8D / 19085
{
	struct<2> Var0;
...
struct<8> Function_70(int iParam0) //Position: 0x4B04 / 19204
{
	struct<2> Var0;
...
void Function_71(int iParam0) //Position: 0x4B70 / 19312
{
...
bool Function_72(int iParam0) //Position: 0x4BD8 / 19416
{
...
void Function_73(struct<153> Param0) //Position: 0x4BEE / 19438
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
void Function_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5104 / 20740
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x518F / 20879
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x51CE / 20942
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(int iParam0) //Position: 0x51FB / 20987
{
...
var Function_78(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5227 / 21031
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_79(int iParam0) //Position: 0x5248 / 21064
{
...
bool Function_80(struct<249> Param0) //Position: 0x525D / 21085
{
	...
	{
		Function_180(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_81(struct<265> Param0) //Position: 0x538D / 21389
{
	int iVar0;
...
bool Function_82(int iParam0) //Position: 0x54EE / 21742
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_83(int iParam0) //Position: 0x5512 / 21778
{
...
bool Function_84(int iParam0) //Position: 0x5527 / 21799
{
	return Global_116927[iParam06].f_16;
}

bool Function_85(struct<237> Param0) //Position: 0x5537 / 21815
{
	if (!Param0.f_236)
	{
		if (Function_110())
...
bool Function_86(int iParam0) //Position: 0x5606 / 22022
{
...
bool Function_87(int iParam0) //Position: 0x5661 / 22113
{
	int iVar0;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x567D / 22141
{
	int iVar0;
...
int Function_89(int iParam0) //Position: 0x569A / 22170
{
...
int Function_90(int iParam0) //Position: 0x56AF / 22191
{
...
void Function_91() //Position: 0x56C4 / 22212
{
...
int Function_92(int iParam0, int iParam1) //Position: 0x5744 / 22340
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_93(int iParam0) //Position: 0x63A7 / 25511
{
	int iVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x63F6 / 25590
{
...
int Function_95(int iParam0) //Position: 0x640C / 25612
{
...
void Function_96() //Position: 0x6475 / 25717
{
...
bool Function_97(int iParam0) //Position: 0x649A / 25754
{
	if (!Function_94(iParam0))
	{
...
bool Function_98(int iParam0, int iParam1) //Position: 0x64EB / 25835
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x6518 / 25880
{
	if (!Function_94(iParam0))
	{
...
void Function_100(bool bParam0) //Position: 0x656A / 25962
{
	int iVar0;
...
void Function_101() //Position: 0x65A4 / 26020
{
	bool bVar0;
...
void Function_102(var uParam0, int iParam1) //Position: 0x6602 / 26114
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_103(int iParam0) //Position: 0x6618 / 26136
{
	PRINTSTRING("Day ");
...
void Function_104(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6662 / 26210
{
	bool bVar0;
	char* cVar1[16];
...
void Function_105(char* cParam0) //Position: 0x66D7 / 26327
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_106(int iParam0, var uParam1, int iParam2) //Position: 0x6711 / 26385
{
	var uVar0;
	char* cVar1[16];
...
int Function_107(char* cParam0) //Position: 0x678D / 26509
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_108(int iParam0) //Position: 0x682E / 26670
{
	int iVar0;
	int iVar1;
...
bool Function_109(int iParam0, int iParam1) //Position: 0x686B / 26731
{
...
bool Function_110() //Position: 0x687E / 26750
{
...
int Function_111(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6899 / 26777
{
	int iVar0;
	int iVar1;
...
void Function_112(int iParam0) //Position: 0x6AC1 / 27329
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_113(bool bParam0, bool bParam1) //Position: 0x6B5F / 27487
{
	bool bVar0;
...
void Function_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6B84 / 27524
{
	struct<4> Var0;
	var uVar4;
...
bool Function_115(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6C19 / 27673
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_116(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6CD2 / 27858
{
	if (!&bParam15)
	{
...
void Function_117(var uParam0, bool bParam1) //Position: 0x7334 / 29492
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_118() //Position: 0x7403 / 29699
{
	int iVar0;
...
void Function_119() //Position: 0x747B / 29819
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_120() //Position: 0x74C0 / 29888
{
...
void Function_121(bool bParam0) //Position: 0x74D2 / 29906
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_122(var uParam0, int iParam1) //Position: 0x74EF / 29935
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_123(int iParam0) //Position: 0x7581 / 30081
{
	bool bVar0;
...
float Function_124(vector3 vParam0) //Position: 0x75B2 / 30130
{
...
bool Function_125(int iParam0) //Position: 0x767F / 30335
{
	return Function_45(iParam0, 2);
}

bool Function_126(int iParam0) //Position: 0x768D / 30349
{
	return Function_45(iParam0, 1);
}

int Function_127(bool bParam0) //Position: 0x769B / 30363
{
	bool bVar0;
	var uVar1;
...
bool Function_128() //Position: 0x775E / 30558
{
	bool bVar0;
	var uVar1;
...
void Function_129(int iParam0) //Position: 0x779B / 30619
{
	Function_130(&iParam0, 0.0f);
	return;
}

void Function_130(vector3 vParam0) //Position: 0x77A8 / 30632
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_180(&vParam0, 1);
	Function_102(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_131(struct<37> Param0) //Position: 0x77CD / 30669
{
	return Param0.f_36;
}

void Function_132(var uParam0, int iParam1) //Position: 0x77D8 / 30680
{
	Function_133(&uParam0, &iParam1, 0);
	return;
}

void Function_133(var uParam0, bool bParam1, bool bParam2) //Position: 0x77E8 / 30696
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_134(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7960 / 31072
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_135() //Position: 0x798A / 31114
{
	var uVar0;
	var uVar1;
...
void Function_136() //Position: 0x79E5 / 31205
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_137() //Position: 0x7B24 / 31524
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_138() //Position: 0x7B34 / 31540
{
	Function_139(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_412);
	return 1;
}

void Function_139(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7B50 / 31568
{
	var uVar0;
...
void Function_140() //Position: 0x7C1F / 31775
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_141() //Position: 0x7C34 / 31796
{
	...
	TASK_USE_GRINGO(&uLocal_379, GET_GRINGO_FROM_OBJECT(&uLocal_385), "UseCase1", 4294967295, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_379, &uLocal_385, "UseCase1", true, 0, 0);
	TASK_PRIORITY_SET(&uLocal_379, true);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_379, &Global_46715);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_385, &Global_46715);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_381, &Global_46715);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_377, &Global_46715);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_387, &Global_46715);
	GIVE_OBJECT_TO_LAYOUT(&uLocal_389, &Global_46715);
	CAMERA_RESET(0);
	return 1;
}

int Function_142() //Position: 0x7DF0 / 32240
{
	if (!iLocal_411)
	{
		Function_143(StackVal, Local_393, &uLocal_412);
...
void Function_143(vector3 vParam0) //Position: 0x7E15 / 32277
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_144(int iParam0, int iParam1) //Position: 0x7FBE / 32702
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_145(float fParam0, float fParam1) //Position: 0x80E6 / 32998
{
...
void Function_146() //Position: 0x81F7 / 33271
{
...
void Function_147() //Position: 0x822B / 33323
{
...
int Function_148() //Position: 0x8331 / 33585
{
	return 1;
}

int Function_149() //Position: 0x8338 / 33592
{
	var uVar0;
	
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_02", &uLocal_377);
	uLocal_412 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "tempcutscenevol", 2, *(&Global_99725[043] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(30.0f, 30.0f, 30.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	uVar0 = GET_ATTACHED_HOGTIE_VICTIM(GET_MOST_RECENT_MOUNT(&Global_54076));
	if (IS_ACTOR_VALID(&uVar0))
	{
		if (Function_156(GET_OBJECT_FROM_ACTOR(&uVar0)) != &Global_46715)
		{
			GIVE_OBJECT_TO_LAYOUT(GET_OBJECT_FROM_ACTOR(&uVar0), &Global_46715);
		}
	}
	uVar0 = GET_ATTACHED_HOGTIE_VICTIM(&Global_21369 + 72);
	if (IS_ACTOR_VALID(&uVar0))
	{
		if (Function_156(GET_OBJECT_FROM_ACTOR(&uVar0)) != &Global_46715)
		{
	...
	Function_152(0, 0, 1, 1, 0, 1, 1, &uLocal_412, 1, 1, 1, 1, 0x3f800000, 0);
	Function_150(StackVal, &uLocal_349, *(&Global_99725[143] + 196), &uLocal_412, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_150(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8455 / 33877
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_151(var uParam0, float fParam1) //Position: 0x86F5 / 34549
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_152(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8777 / 34679
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_155(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_17(), 2, Function_155(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_154()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_153(int iParam0) //Position: 0x8A29 / 35369
{
	int iVar0;
...
var Function_154() //Position: 0x8A5D / 35421
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_155(int iParam0) //Position: 0x8AEB / 35563
{
	struct<2> Var0;
...
int Function_156(bool bParam0) //Position: 0x8AFD / 35581
{
	var uVar0;
...
bool Function_157() //Position: 0x8B64 / 35684
{
	if (IS_ACTOR_VALID(&uLocal_377))
	{
		if (!IS_ACTOR_HOGTIED(&uLocal_377))
...
int Function_158(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x8B82 / 35714
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_159(struct<257> Param0) //Position: 0x8D0D / 36109
{
...
int Function_160(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x8D49 / 36169
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_161() //Position: 0x8FB1 / 36785
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_162(char* cParam0) //Position: 0x9005 / 36869
{
	char* cVar0[64];
...
bool Function_163(var uParam0, struct<2> Param1, float fParam3) //Position: 0x912E / 37166
{
...
int Function_164() //Position: 0x91BA / 37306
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_165(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x91C9 / 37321
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_168(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_167(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_166(vector3 vParam0) //Position: 0x93FE / 37886
{
	var uVar0;
...
float Function_167(var uParam0, bool bParam1) //Position: 0x9474 / 38004
{
	struct<2> Var0;
...
void Function_168(var uParam0, bool bParam1) //Position: 0x9495 / 38037
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_167(&uParam0, 0) < 2.0f)
	{
...
bool Function_169(int iParam0, bool bParam1, bool bParam2) //Position: 0x94FF / 38143
{
...
bool Function_170() //Position: 0x95C3 / 38339
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_171(int iParam0) //Position: 0x95DA / 38362
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_172(bool bParam0) //Position: 0x95E6 / 38374
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

int Function_173(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x95F5 / 38389
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_174() //Position: 0x9615 / 38421
{
	Function_176(&uLocal_351);
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
	...
	if (IS_ACTOR_VALID(&uLocal_379))
	{
		REMOVE_ACTOR_STAY_WITHIN_VOLUME(&uLocal_379, &uLocal_383);
	}
	Function_175(0, 0, 1);
	return;
}

int Function_175(bool bParam0, bool bParam1, bool bParam2) //Position: 0x964E / 38478
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_176(int iParam0) //Position: 0x9680 / 38528
{
	int iVar0;
...
void Function_177(struct<2>[] Param0, int iParam1) //Position: 0x96A8 / 38568
{
...
void Function_178(struct<13> Param0) //Position: 0x97F3 / 38899
{
	int iVar0;
...
bool Function_179(struct<13> Param0) //Position: 0x9810 / 38928
{
	int iVar0;
...
void Function_180(var uParam0, int iParam1) //Position: 0x982E / 38958
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_181(struct<2>[] Param0) //Position: 0x983F / 38975
{
	int iVar0;
	int iVar1;
...
bool Function_183() //Position: 0x9C41 / 40001
{
	int iVar0;
...
void Function_184(struct<13> Param0) //Position: 0x9C6F / 40047
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_185() //Position: 0x9C82 / 40066
{
	if (!Function_87(128))
	{
		return;
...
void Function_186(vector3 vParam0) //Position: 0x9CC4 / 40132
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_187(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4) //Position: 0x9CDB / 40155
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (((!IS_SCRIPTED_SPEECH_PLAYING(&uParam0) && (MEMORY_GET_IS_VISIBLE(&uParam0, &Global_54076) || Function_173(&uParam0, 0x3f800000, 0x42960000, 1, 1, 0))) && Function_144(&Global_54076, &uParam0) > 35.0f) && !Global_99146)
		{
...
void Function_188(int iParam0) //Position: 0x9D70 / 40304
{
...
void Function_189() //Position: 0x9D87 / 40327
{
	switch (iLocal_398)
	{
		case 0x00000000:
...
void Function_190() //Position: 0x9E1D / 40477
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AG", "RCMMac_talkPacePre1_v1_AG", false, 1, 1, 0, 1);
		Function_191(3);
...
void Function_191(int iParam0) //Position: 0x9E78 / 40568
{
	Function_192(0, &Global_54076, iParam0, 0);
	Function_192(1, &uLocal_379, iParam0, 0);
	return;
}

void Function_192(int iParam0, var uParam1, var uParam2, int iParam3) //Position: 0x9E94 / 40596
{
	bool bVar0;
	
	iParam3 = &iParam3;
	if (Function_45(uParam2, Function_193(iParam0)))
	{
		bVar0 = iParam0;
...
int Function_193(bool bParam0) //Position: 0x9EBC / 40636
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_194() //Position: 0x9EC8 / 40648
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AF", "RCMMac_talkPacePre1_v1_AF", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_195() //Position: 0x9F23 / 40739
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AE", "RCMMac_talkPacePre1_v1_AE", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_196() //Position: 0x9F7E / 40830
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AD", "RCMMac_talkPacePre1_v1_AD", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_197() //Position: 0x9FD9 / 40921
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AC", "RCMMac_talkPacePre1_v1_AC", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_198() //Position: 0xA034 / 41012
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AB", "RCMMac_talkPacePre1_v1_AB", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_199() //Position: 0xA08F / 41103
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMMac_talkPacePre1_v1_AA", "RCMMac_talkPacePre1_v1_AA", false, 1, 1, 0, 1);
		Function_191(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_200() //Position: 0xA0EA / 41194
{
	Function_201(0, 1);
	Function_180(&Global_99725[043] + 228, 128);
	ACTOR_DATA_GRAVITY_LIMIT(0);
	Function_174();
	TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
	return;
...
void Function_201(int iParam0, bool bParam1) //Position: 0xA110 / 41232
{
	char* cVar0[32];
...
bool Function_202() //Position: 0xA299 / 41625
{
	if (IS_ACTOR_VALID(&uLocal_379))
	{
		if (GET_LAST_ATTACKER(&uLocal_379) == &Global_54076)
		{
			return 1;
		}
	}
	if (IS_ACTOR_VALID(&uLocal_377))
	{
		if (GET_LAST_ATTACKER(&uLocal_377) == &Global_54076)
		{
			return 1;
		}
	}
...
var Function_203(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xA2D4 / 41684
{
	int iVar0;
...
var Function_204(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA3B0 / 41904
{
	int iVar0;
	var uVar1;
...
var Function_205(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA3EE / 41966
{
	int iVar0;
