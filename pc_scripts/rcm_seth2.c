...
void main() //Position: 0x0 / 0
{
	...
	iLocal_335 = 0;
	bLocal_348 = false;
	Local_351 = Vector(103,443f, 71,175f, 2677,125f);
	iLocal_436 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_336 = 1000;
			Function_199(&uLocal_354, 1233, 3, 0);
			Function_199(&uLocal_354, 545, 3, 0);
			Function_199(&uLocal_354, 1212, 3, 0);
			Function_199(&uLocal_354, 1214, 3, 0);
			Function_199(&uLocal_354, 1213, 3, 0);
			Function_197(&uLocal_354, "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2a", 1, 0);
			Function_197(&uLocal_354, "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2b", 1, 0);
			Function_197(&uLocal_354, "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2c", 1, 0);
			Local_406 = Vector(116,67f, 72,25f, 2671,29f);
			Local_409 = Vector(115,67f, 72,28f, 2674,3f);
			Local_412 = Vector(118,46f, 72,28f, 2672,95f);
			Local_415 = Vector(116,94f, 72,28f, 2673,17f);
			Local_418 = Vector(117,66f, 72,28f, 2671,63f);
			bLocal_421 = 328,31f;
			bLocal_422 = 282,7f;
			bLocal_423 = 422,84f;
			bLocal_424 = 440,84f;
			...
			while (!IS_EXITFLAG_SET())
			{
				if (Function_196())
				{
					SET_ACTOR_FACTION(&uLocal_388, 0);
					SET_ACTOR_FACTION(&uLocal_392, 0);
					SET_ACTOR_FACTION(&uLocal_394, 0);
					SET_ACTOR_FACTION(&uLocal_396, 0);
					SET_ACTOR_FACTION(&uLocal_390, 0);
					TASK_PRIORITY_SET(&uLocal_388, false);
					TASK_PRIORITY_SET(&uLocal_392, false);
					TASK_PRIORITY_SET(&uLocal_394, false);
					TASK_PRIORITY_SET(&uLocal_396, false);
					TASK_PRIORITY_SET(&uLocal_390, false);
					TASK_FLEE_ACTOR(&uLocal_388, &Global_54076, -1.0f, -1.0f, 0, 0, 0);
					TASK_MELEE_ATTACK(&uLocal_392, &Global_54076, -1.0f);
					TASK_MELEE_ATTACK(&uLocal_394, &Global_54076, -1.0f);
					TASK_MELEE_ATTACK(&uLocal_396, &Global_54076, -1.0f);
					TASK_MELEE_ATTACK(&uLocal_390, &Global_54076, -1.0f);
					if (!Function_195(7))
					{
						Function_194(7, 1);
					}
				...
				if (iVar0 <= 3)
				{
					Function_185(&uLocal_388, 41148, &uLocal_426, &iLocal_430, 8);
				}
				else if (iVar0 == 3)
				{
					Function_184(&uLocal_426);
					Function_184(&iLocal_430);
				}
				else if (iVar0 >= 3)
				{
					Function_185(&uLocal_388, 40781, &uLocal_426, &iLocal_430, 8);
				}
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (Function_174(&uLocal_354))
								{
									uLocal_388 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "Seth", 545, Local_406, Vector(0.0f, bLocal_421, 0.0f));
									uLocal_390 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "ZombieMoses", 1233, Local_409, Vector(0.0f, bLocal_422, 0.0f));
									uLocal_392 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "Fiddler", 1212, Local_412, Vector(0.0f, bLocal_423, 0.0f));
									uLocal_394 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "Bruiser", 1214, Local_415, Vector(0.0f, bLocal_424, 0.0f));
									uLocal_396 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "nSeth_Lady", 1213, Local_418, Vector(0.0f, bLocal_425, 0.0f));
									uLocal_398 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "nSethDance", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2a", Local_406, Vector(0.0f, bLocal_421, 0.0f));
									uLocal_402 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "FiddlerGringo", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2c", Local_412, Vector(0.0f, bLocal_423, 0.0f));
									uLocal_404 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "BruiserDance", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2b", Local_415, Vector(0.0f, bLocal_424, 0.0f));
									uLocal_400 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "MosesDance", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2b", Local_409, Vector(0.0f, bLocal_422, 0.0f));
									SNAP_ACTOR_TO_GRINGO(&uLocal_388, &uLocal_398, "Human", true, 0, 0);
									SNAP_ACTOR_TO_GRINGO(&uLocal_396, &uLocal_398, "UseCase1", true, 0, 0);
									SNAP_ACTOR_TO_GRINGO(&uLocal_392, &uLocal_402, "UseCase1", true, 0, 0);
									SNAP_ACTOR_TO_GRINGO(&uLocal_394, &uLocal_404, "UseCase1", true, 0, 0);
									SNAP_ACTOR_TO_GRINGO(&uLocal_390, &uLocal_400, "UseCase1", true, 0, 0);
									TASK_USE_GRINGO(&uLocal_388, GET_GRINGO_FROM_OBJECT(&uLocal_398), "Human", 4294967295, 1);
									TASK_USE_GRINGO(&uLocal_396, GET_GRINGO_FROM_OBJECT(&uLocal_398), "UseCase1", 4294967295, 1);
									TASK_USE_GRINGO(&uLocal_392, GET_GRINGO_FROM_OBJECT(&uLocal_402), "UseCase1", 4294967295, 1);
									TASK_USE_GRINGO(&uLocal_394, GET_GRINGO_FROM_OBJECT(&uLocal_404), "UseCase1", 4294967295, 1);
									TASK_USE_GRINGO(&uLocal_390, GET_GRINGO_FROM_OBJECT(&uLocal_400), "UseCase1", 4294967295, 1);
									TASK_PRIORITY_SET(&uLocal_388, true);
									TASK_PRIORITY_SET(&uLocal_392, true);
									TASK_PRIORITY_SET(&uLocal_394, true);
									TASK_PRIORITY_SET(&uLocal_396, true);
									TASK_PRIORITY_SET(&uLocal_390, true);
									SET_ACTOR_FACTION(&uLocal_388, 20);
									SET_ACTOR_FACTION(&uLocal_392, 20);
									SET_ACTOR_FACTION(&uLocal_394, 20);
									SET_ACTOR_FACTION(&uLocal_396, 20);
									SET_ACTOR_FACTION(&uLocal_390, 20);
									uLocal_434 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "zombieStayOut", 2, *(&Global_99725[643] + 184), Vector(0.0f, Global_99725[643].f_208, 0.0f), Vector(30.0f, 20.0f, 30.0f));
									ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_434);
									ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_434);
									GIVE_OBJECT_TO_ACTOR(&uLocal_434, &uLocal_388);
									TASK_PRIORITY_SET(&uLocal_388, 2);
									SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_388, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
									Function_168(&(Global_99725[743]), 7, 0x41f00000, 0x42200000, 0);
									iVar0 = 1;
								}
							}
							else
					...
					case 0x00000001:
						...
						bLocal_348 = ((((Function_167(&uLocal_388, 0x3f800000, 0x42960000, 1, 1, 0) || Function_167(&uLocal_390, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_167(&uLocal_392, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_167(&uLocal_394, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_167(&uLocal_396, 0x3f800000, 0x42960000, 1, 1, 0));
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_348)
							{
					...
					case 0x00000003:
						if (Function_115("$/cutscene/the_dead_rise_again_2_pt_a_cs/the_dead_rise_again_2_pt_a_cs", &iLocal_336, 35194, 35187, 33058, 32312, 32056, 32040, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_193(&Global_99725[743] + 228, 256);
							Global_6655 = 1;
							Global_6659 = 7;
							AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
							TASK_PRIORITY_SET(&uLocal_388, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_388, 1, 1, true, 1, 0, 2, 1101004800, 1088421888, 1);
							...
							{
								Function_58("ZOMBIE_STORY_3_SHORT", 7,5f, 0, 2, 0, 0, 0, 0);
							}
							Function_3();
							iVar0 = 13;
						}
					...
					case 0x0000000D:
						if (Function_1(StackVal, &Global_54076, *(&Global_99725[743] + 184)) < 100.0f)
						{
							Function_193(&Global_99725[ScriptParam_043] + 228, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_188();
...
float Function_1(var uParam0, struct<2> Param1) //Position: 0xA98 / 2712
{
	struct<2> Var0;
...
struct<8> Function_2(var uParam0) //Position: 0xB0F / 2831
{
	struct<2> Var0;
...
void Function_3() //Position: 0xB7B / 2939
{
	bool bVar0;
	bool bVar1;
...
void Function_4(bool bParam0) //Position: 0xBAC / 2988
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_5(struct<229> Param0) //Position: 0xD66 / 3430
{
	float fVar0;
	int iVar1;
...
void Function_6(struct<217> Param0) //Position: 0xE36 / 3638
{
	float fVar0;
	var uVar1;
...
int Function_7(var uParam0, int iParam1) //Position: 0xEF4 / 3828
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0x105E / 4190
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0x1106 / 4358
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0x1172 / 4466
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0x1194 / 4500
{
	int iVar0;
	struct<2> Var1;
...
void Function_12(int iParam0) //Position: 0x1302 / 4866
{
...
bool Function_13(int iParam0) //Position: 0x136A / 4970
{
...
var Function_14() //Position: 0x1380 / 4992
{
	int iVar0;
...
void Function_15(struct<153> Param0) //Position: 0x1389 / 5001
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_21(Function_22(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_20(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_45(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_45(Global_116927[iParam16].f_32, 1))
			{
				...
				if (Global_43789 != Global_99725[iParam143].f_216 && !Function_19())
				{
...
void Function_16(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x189F / 6303
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_17(int iParam0) //Position: 0x192A / 6442
{
	char* cVar0[16];
...
bool Function_18() //Position: 0x1969 / 6505
{
...
bool Function_19() //Position: 0x1984 / 6532
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(int iParam0) //Position: 0x19B1 / 6577
{
...
var Function_21(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x19DD / 6621
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_22(int iParam0) //Position: 0x19FE / 6654
{
...
bool Function_23(struct<249> Param0) //Position: 0x1A13 / 6675
{
...
bool Function_24(struct<265> Param0) //Position: 0x1B43 / 6979
{
	int iVar0;
...
bool Function_25(int iParam0) //Position: 0x1CA4 / 7332
{
...
bool Function_26(int iParam0) //Position: 0x1CC8 / 7368
{
...
bool Function_27(int iParam0) //Position: 0x1CDD / 7389
{
...
var Function_28(int iParam0) //Position: 0x1CF4 / 7412
{
...
bool Function_29(int iParam0) //Position: 0x1D0E / 7438
{
...
bool Function_30(int iParam0) //Position: 0x1D24 / 7460
{
	return Global_116927[iParam06].f_16;
}

bool Function_31(var uParam0, int iParam1) //Position: 0x1D34 / 7476
{
	int iVar0;
...
bool Function_32(struct<237> Param0) //Position: 0x1D51 / 7505
{
	if (!Param0.f_236)
	{
		if (Function_18())
...
bool Function_33(int iParam0) //Position: 0x1E20 / 7712
{
...
void Function_34(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E7B / 7803
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0) //Position: 0x1EF0 / 7920
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(int iParam0, var uParam1, int iParam2) //Position: 0x1F2A / 7978
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x1FA6 / 8102
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x2047 / 8263
{
	int iVar0;
	int iVar1;
...
void Function_39(var uParam0, int iParam1) //Position: 0x2084 / 8324
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

bool Function_40(var uParam0, int iParam1) //Position: 0x209A / 8346
{
...
bool Function_41(int iParam0) //Position: 0x20AD / 8365
{
	int iVar0;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x20C9 / 8393
{
	int iVar0;
...
int Function_43(int iParam0) //Position: 0x20E6 / 8422
{
...
int Function_44(int iParam0) //Position: 0x20FB / 8443
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x2110 / 8464
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x211D / 8477
{
	if (Function_51(Global_42827))
	{
		if (Global_42827.f_16)
		{
			...
			Global_42827.f_4 = Function_50(Global_42827);
			(&Global_42827 + 8) = Function_47(StackVal, Global_42827);
			Global_42827.f_16 = 0;
		}
...
int Function_47(int iParam0, int iParam1) //Position: 0x219D / 8605
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					...
					else if (iVar14 && Function_49(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					...
					else if (iVar15 && Function_49(26, 0))
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					...
					else if (Function_49(17, 0) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_49(6, 0) && Function_195(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if ((Function_49(9, 0) && Function_195(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if (Function_49(8, 0) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
bool Function_48(char* cParam0) //Position: 0x2E00 / 11776
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

bool Function_49(int iParam0, bool bParam1) //Position: 0x2E18 / 11800
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x2E56 / 11862
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x2EA5 / 11941
{
...
int Function_52(int iParam0) //Position: 0x2EBB / 11963
{
...
void Function_53() //Position: 0x2F24 / 12068
{
...
bool Function_54(int iParam0) //Position: 0x2F49 / 12105
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x2F9A / 12186
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x2FC7 / 12231
{
	if (!Function_51(iParam0))
	{
...
void Function_57(bool bParam0) //Position: 0x3019 / 12313
{
	int iVar0;
...
void Function_58(var uParam0, float fParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x3053 / 12371
{
	struct<4> Var0;
	var uVar4;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x30E8 / 12520
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3562 / 13666
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_61() //Position: 0x3703 / 14083
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x3709 / 14089
{
	if (Global_6624)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x3748 / 14152
{
...
void Function_64() //Position: 0x379D / 14237
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x37E8 / 14312
{
...
void Function_66() //Position: 0x38EE / 14574
{
	float fVar0;
...
void Function_67() //Position: 0x3921 / 14625
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3AB4 / 15028
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x3C6D / 15469
{
	Function_70(&Global_42918, 1, 0);
	return;
}

void Function_70(struct<2317> Param0) //Position: 0x3C7B / 15483
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x3E98 / 16024
{
...
struct<8> Function_72(int iParam0) //Position: 0x3EAD / 16045
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x3F54 / 16212
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x4234 / 16948
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_75(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_14(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_75(int iParam0) //Position: 0x4872 / 18546
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x4883 / 18563
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0) //Position: 0x497A / 18810
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x4995 / 18837
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x49FC / 18940
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x4A0E / 18958
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4A20 / 18976
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x4B54 / 19284
{
	return Global_55480[iParam016].f_96;
}

float Function_83(int iParam0) //Position: 0x4B63 / 19299
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x4B9C / 19356
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x4BD9 / 19417
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D73 / 19827
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x4FB7 / 20407
{
...
struct<8> Function_88() //Position: 0x4FF8 / 20472
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x5081 / 20609
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x5118 / 20760
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x5197 / 20887
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x51D4 / 20948
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x53E0 / 21472
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_94(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x5497 / 21655
{
	int iVar0;
...
struct<8> Function_95() //Position: 0x558F / 21903
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_96(int iParam0) //Position: 0x5599 / 21913
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x55AF / 21935
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_98(struct<2> Param0, struct<2> Param2) //Position: 0x567B / 22139
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_99(float fParam0, int iParam1) //Position: 0x5698 / 22168
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_100(int iParam0) //Position: 0x5EC4 / 24260
{
	var uVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x5EFF / 24319
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5F0E / 24334
{
	uParam0 = &uParam0;
...
void Function_103(int iParam0) //Position: 0x5FBD / 24509
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_195(4) && !Function_107(0))
	{
	...
	if (!Function_31(&Global_6667[228] + 184, 2) || ((((((Function_195(14) && Function_195(18)) && Function_195(37)) && Function_195(7)) && Function_195(11)) && Function_195(5)) && Function_195(21)))
	{
	...
	if (!Function_31(&Global_6667[328] + 184, 2) || ((Function_195(27) && Function_195(1)) && Function_195(23)))
	{
	...
	if (!Function_195(5))
	{
		...
		if (Function_195(4))
		{
			...
			stradd(&cVar2, I2STR(Function_104(Global_46948)), 64);
			APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[443].f_224, "blackwater3_OBJ", 0, 3, !bVar1);
			if (Function_104(Global_46948) >= 0)
			{
	...
	if (!Function_195(7))
	{
		...
		if (((Function_195(6) && Function_104(Global_46949) < 0) && Function_104(Global_46951) < 0) && Function_104(Global_46952) < 0)
		{
	...
	{
		Function_58(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_104(int iParam0) //Position: 0x68DE / 26846
{
	if (!Function_27(iParam0))
	{
		return 4294967295;
...
var Function_105() //Position: 0x68F8 / 26872
{
	return STRING_TO_HASH(Function_106());
}

var Function_106() //Position: 0x6904 / 26884
{
	return "ZOMBIE_STORY";
}

bool Function_107(int iParam0) //Position: 0x6919 / 26905
{
	...
	return Global_21684[Function_108(iParam0)7].f_12 < 0;
}

int Function_108(int iParam0) //Position: 0x697F / 27007
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_109(int iParam0) //Position: 0x6A41 / 27201
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_105(), &iParam0, 0, 3, false);
	Function_110(Function_105(), 0);
	return;
}

void Function_110(bool bParam0, bool bParam1) //Position: 0x6A8A / 27274
{
	bool bVar0;
...
void Function_111() //Position: 0x6AAF / 27311
{
	bool bVar0;
...
void Function_112(int iParam0) //Position: 0x6B0D / 27405
{
	PRINTSTRING("Day ");
...
int Function_113(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6B57 / 27479
{
	int iVar0;
	int iVar1;
...
void Function_114(bool bParam0) //Position: 0x6D7F / 28031
{
	switch (bParam0)
	{
		case 0x00000009:
...
bool Function_115(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6E1D / 28189
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_116(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6ED6 / 28374
{
	if (!&bParam15)
	{
...
void Function_117(var uParam0, bool bParam1) //Position: 0x7538 / 30008
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_118() //Position: 0x7607 / 30215
{
	int iVar0;
...
void Function_119() //Position: 0x767F / 30335
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_120() //Position: 0x76C4 / 30404
{
...
void Function_121(bool bParam0) //Position: 0x76D6 / 30422
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_122(var uParam0, int iParam1) //Position: 0x76F3 / 30451
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_123(int iParam0) //Position: 0x7785 / 30597
{
	bool bVar0;
...
float Function_124(vector3 vParam0) //Position: 0x77B6 / 30646
{
...
bool Function_125(int iParam0) //Position: 0x7883 / 30851
{
	return Function_45(iParam0, 2);
}

bool Function_126(int iParam0) //Position: 0x7891 / 30865
{
	return Function_45(iParam0, 1);
}

int Function_127(bool bParam0) //Position: 0x789F / 30879
{
	bool bVar0;
	var uVar1;
...
bool Function_128() //Position: 0x7962 / 31074
{
	bool bVar0;
	var uVar1;
...
void Function_129(int iParam0) //Position: 0x799F / 31135
{
	Function_130(&iParam0, 0.0f);
	return;
}

void Function_130(vector3 vParam0) //Position: 0x79AC / 31148
{
...
bool Function_131(struct<37> Param0) //Position: 0x79D1 / 31185
{
	return Param0.f_36;
}

void Function_132(var uParam0, int iParam1) //Position: 0x79DC / 31196
{
	Function_133(&uParam0, &iParam1, 0);
	return;
}

void Function_133(var uParam0, bool bParam1, bool bParam2) //Position: 0x79EC / 31212
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_134(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7B64 / 31588
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_135() //Position: 0x7B8E / 31630
{
	var uVar0;
	var uVar1;
...
void Function_136() //Position: 0x7BE9 / 31721
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_137() //Position: 0x7D28 / 32040
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_138() //Position: 0x7D38 / 32056
{
	Function_139(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_437);
	return 1;
}

void Function_139(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7D54 / 32084
{
	var uVar0;
...
void Function_140() //Position: 0x7E23 / 32291
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_141() //Position: 0x7E38 / 32312
{
	uLocal_398 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "nSethDance", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2a", Local_406, Vector(0.0f, bLocal_421, 0.0f));
	uLocal_402 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "FiddlerGringo", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2c", Local_412, Vector(0.0f, bLocal_423, 0.0f));
	uLocal_404 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_349, "BruiserDance", "$/content/scripting/gringo/simpleGringo/DLC_dead_rise_again2b", Local_415, Vector(0.0f, bLocal_424, 0.0f));
	...
	TASK_PRIORITY_SET(&uLocal_396, true);
	TASK_PRIORITY_SET(&uLocal_390, true);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(107,827f, 71,206f, 2677,504f), 87,996f, 1, 1, true);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_142() //Position: 0x8122 / 33058
{
	if (!iLocal_436)
	{
		Function_146(StackVal, Local_351, &uLocal_437);
		Function_143();
		DESTROY_OBJECT(&uLocal_398);
		DESTROY_OBJECT(&uLocal_402);
		DESTROY_OBJECT(&uLocal_404);
...
void Function_143() //Position: 0x815F / 33119
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_144(char* cParam0) //Position: 0x81F5 / 33269
{
	char* cVar0[64];
...
void Function_145(char* cParam0) //Position: 0x831E / 33566
{
	char* cVar0[64];
...
void Function_146(vector3 vParam0) //Position: 0x848A / 33930
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_48(StackVal, vParam0))
	{
...
float Function_147(int iParam0, int iParam1) //Position: 0x8633 / 34355
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_148(float fParam0, float fParam1) //Position: 0x8728 / 34600
{
...
void Function_149() //Position: 0x8839 / 34873
{
...
void Function_150() //Position: 0x886D / 34925
{
...
int Function_151() //Position: 0x8973 / 35187
{
	return 1;
}

int Function_152() //Position: 0x897A / 35194
{
	uLocal_437 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "tempcutscenevol", 2, *(&Global_99725[743] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("COMPANION_GraveRobber", &uLocal_388);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Moses", &uLocal_390);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_09", &uLocal_392);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Bruiser_01", &uLocal_394);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_10", &uLocal_396);
	Function_155(0, 0, 1, 1, 0, 1, 1, &uLocal_437, 1, 1, 1, 1, 0x3f800000, 0);
	Function_153(StackVal, &uLocal_349, *(&Global_99725[743] + 196), &uLocal_437, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_153(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8A98 / 35480
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_154(var uParam0, float fParam1) //Position: 0x8D38 / 36152
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_155(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8DBA / 36282
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_158(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_14(), 2, Function_158(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_156(int iParam0) //Position: 0x906C / 36972
{
	int iVar0;
...
var Function_157() //Position: 0x90A0 / 37024
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_158(bool bParam0) //Position: 0x912E / 37166
{
	struct<2> Var0;
...
bool Function_159(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x9140 / 37184
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_160(vector3 vParam0) //Position: 0x9375 / 37749
{
	var uVar0;
...
float Function_161(var uParam0, bool bParam1) //Position: 0x93EB / 37867
{
	struct<2> Var0;
...
void Function_162(var uParam0, bool bParam1) //Position: 0x940C / 37900
{
	var uVar0;
	var uVar1;
...
bool Function_163(int iParam0, bool bParam1, bool bParam2) //Position: 0x9476 / 38006
{
...
bool Function_164() //Position: 0x953A / 38202
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_165(int iParam0) //Position: 0x9551 / 38225
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_166(bool bParam0) //Position: 0x955D / 38237
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

var Function_167(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x956C / 38252
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_168(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x958C / 38284
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_170(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_170(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_169(struct<257> Param0) //Position: 0x9717 / 38679
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_169(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_170(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x9753 / 38739
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_172(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_173()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_172(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_173()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_172(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_171() //Position: 0x99BB / 39355
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
bool Function_172(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9A0F / 39439
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_2(&uParam0);
...
int Function_173() //Position: 0x9A9B / 39579
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_174(struct<2>[] Param0) //Position: 0x9AAA / 39594
{
	int iVar0;
	int iVar1;
	...
	Function_179();
	iVar1 = 0;
	if (!Function_178(&(Param0[iVar02]), 16))
	{
		if (IS_MISSION_SCRIPT())
		{
			iVar1 = 1;
			Function_177(&(Param0[iVar02]), 8);
		}
		...
		Function_177(&(Param0[iVar02]), 16);
	}
	iVar0 = 0;
	while (iVar0 < (Param0 - 1))
	{
		if (Function_178(&(Param0[iVar02]), 4))
		{
			if (!Function_178(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_178(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_178(&(Param0[02]), 8) || iVar1));
						break;
	...
	while (iVar0 < (Param0 - 1))
	{
		if (Function_178(&(Param0[iVar02]), 4))
		{
			if (!Function_178(&(Param0[iVar02]), 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_175() //Position: 0x9E6C / 40556
{
	if (!Function_41(128))
	{
		return;
...
bool Function_176() //Position: 0x9EAC / 40620
{
	int iVar0;
...
void Function_177(struct<13> Param0) //Position: 0x9EDA / 40666
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

bool Function_178(struct<13> Param0) //Position: 0x9EED / 40685
{
	int iVar0;
...
void Function_179() //Position: 0x9F0B / 40715
{
	if (!Function_41(128))
	{
		return;
...
void Function_180() //Position: 0x9F4D / 40781
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMSeth_DancePostCut", "RCMSeth_DancePostCut", 2, 2, 1, 0, 1);
		Function_181(7);
...
void Function_181(int iParam0) //Position: 0x9F9E / 40862
{
	Function_182(0, &Global_54076, iParam0, 0);
	Function_182(1, &uLocal_388, iParam0, 0);
	Function_182(2, &uLocal_390, iParam0, 0);
	return;
}

void Function_182(int iParam0, var uParam1, var uParam2, int iParam3) //Position: 0x9FC5 / 40901
{
	bool bVar0;
...
bool Function_183(bool bParam0) //Position: 0x9FED / 40941
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_184(vector3 vParam0) //Position: 0x9FF9 / 40953
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_185(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4) //Position: 0xA010 / 40976
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (((!IS_SCRIPTED_SPEECH_PLAYING(&uParam0) && (MEMORY_GET_IS_VISIBLE(&uParam0, &Global_54076) || Function_167(&uParam0, 0x3f800000, 0x42960000, 1, 1, 0))) && Function_147(&Global_54076, &uParam0) > 35.0f) && !Global_99146)
		{
...
void Function_186(int iParam0) //Position: 0xA0A5 / 41125
{
...
void Function_187() //Position: 0xA0BC / 41148
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCMSeth_DancePreCut", "RCMSeth_DancePreCut", 2, 2, 1, 0, 1);
		Function_181(7);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_188() //Position: 0xA10B / 41227
{
	Function_190(&uLocal_354);
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
...
int Function_189(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA12F / 41263
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_190(int iParam0) //Position: 0xA161 / 41313
{
	int iVar0;
...
void Function_191(struct<2>[] Param0, int iParam1) //Position: 0xA189 / 41353
{
	if (Function_178(&(Param0[iParam12]), 4))
	{
		if (Function_178(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
...
void Function_192(struct<13> Param0) //Position: 0xA2D4 / 41684
{
	int iVar0;
...
void Function_193(var uParam0, int iParam1) //Position: 0xA2F1 / 41713
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_194(int iParam0, bool bParam1) //Position: 0xA302 / 41730
{
	char* cVar0[32];
	...
	*(&Global_116927[iParam06] + 8) = GET_TIME_OF_DAY();
	...
	if (!Function_40(Global_119934, 8192))
	{
		Function_34(&Global_54076, 8192, 1, 0);
	}
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_99725[iParam043].f_224, 0))
	{
...
bool Function_195(int iParam0) //Position: 0xA48B / 42123
{
...
bool Function_196() //Position: 0xA4A0 / 42144
{
	if (IS_ACTOR_VALID(&uLocal_388))
	{
		if (GET_LAST_ATTACKER(&uLocal_388) == &Global_54076)
		{
			return 1;
		}
	}
	if (IS_ACTOR_VALID(&uLocal_390))
	{
		if (GET_LAST_ATTACKER(&uLocal_390) == &Global_54076)
		{
			return 1;
		}
	}
	if (IS_ACTOR_VALID(&uLocal_392))
	{
		if (GET_LAST_ATTACKER(&uLocal_392) == &Global_54076)
		{
			return 1;
		}
	}
	if (IS_ACTOR_VALID(&uLocal_394))
	{
		if (GET_LAST_ATTACKER(&uLocal_394) == &Global_54076)
		{
			return 1;
		}
	}
	if (IS_ACTOR_VALID(&uLocal_396))
	{
		if (GET_LAST_ATTACKER(&uLocal_396) == &Global_54076)
		{
			return 1;
		}
	}
...
var Function_197(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA529 / 42281
{
	int iVar0;
	var uVar1;
...
var Function_198(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA567 / 42343
{
	int iVar0;
...
var Function_199(struct<2>[] Param0, int iParam1, int iParam2, bool bParam3) //Position: 0xA636 / 42550
{
	int iVar0;
