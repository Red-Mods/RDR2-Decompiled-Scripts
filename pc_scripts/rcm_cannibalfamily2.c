...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			...
			Function_131(&uLocal_326, "$/fragments/p_gen_femur02x", 0, 0);
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000000:
						if (!Function_128(&(Global_99725[ScriptParam_043]), 16, 0, 1))
						{
							Function_127(&Global_99725[ScriptParam_043] + 228, 64);
							Function_125(&(Global_99725[ScriptParam_043]), 16, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_120(&uLocal_326) && IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								uLocal_342 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_340, "SearchClues1", "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", *(&Global_99725[ScriptParam_043] + 184), Vector(0.0f, 0.0f, 0.0f));
								CREATE_DECAL(StackVal, 2,802597E-45f, Vector(-1709,4f, 55,217f, 2104,56f), 1.0f, 1, 1);
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_340, "RCM_Cannibal2_Bone")))
								{
									CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_340, "RCM_Cannibal2_Bone", "$/fragments/p_gen_femur02x", Vector(-1708,451f, 55,217f, 2104,037f), Vector(0.0f, 50.0f, 0.0f), 1);
								}
							...
							{
								Function_118();
								uLocal_340 = &iLocal_347;
							}
							else
							{
								uLocal_340 = FIND_NAMED_LAYOUT("CannibalFamily_layout");
							}
						}
						break;
					
					case 0x00000005:
						if (GET_CURRENT_GRINGO(&Global_54076) == GET_GRINGO_FROM_OBJECT(&uLocal_342))
						{
							uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_340, Function_117(), 2, *(&Global_99725[1643] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
							Function_112(StackVal, Vector(-1700,569f, 56,271f, 2106,419f), &uVar1);
					...
					case 0x00000006:
						if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(&Global_54076)))
						{
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Cannibal2_OBJ", 0, 4, false);
							Function_108(Global_99725[ScriptParam_043].f_224, 0);
							Function_62(16, 1, 1, 1);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4B6 / 1206
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x4E8 / 1256
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x505 / 1285
{
	RELEASE_LAYOUT_REF(&iLocal_347);
	return;
}

void Function_4(int iParam0) //Position: 0x512 / 1298
{
	int iVar0;
...
void Function_5(struct<2>[] Param0, int iParam1) //Position: 0x53A / 1338
{
...
void Function_6(struct<13> Param0) //Position: 0x685 / 1669
{
	int iVar0;
...
bool Function_7(struct<13> Param0) //Position: 0x6A2 / 1698
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x6C0 / 1728
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_9() //Position: 0x6D1 / 1745
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x702 / 1794
{
	int iVar0;
...
void Function_11() //Position: 0x73C / 1852
{
...
void Function_12(int iParam0) //Position: 0x761 / 1889
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13(struct<229> Param0) //Position: 0x91B / 2331
{
	float fVar0;
	int iVar1;
...
void Function_14(struct<217> Param0) //Position: 0x9EB / 2539
{
	float fVar0;
	var uVar1;
...
int Function_15(var uParam0, int iParam1) //Position: 0xAA9 / 2729
{
	int iVar0;
	var uVar1;
...
void Function_16(int iParam0, var uParam1, struct<2> Param2) //Position: 0xC13 / 3091
{
	struct<8> Var0;
...
struct<32> Function_17(char* cParam0) //Position: 0xCBB / 3259
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_18(char* cParam0) //Position: 0xD27 / 3367
{
	char* cVar0[32];
...
int Function_19(int iParam0) //Position: 0xD49 / 3401
{
	int iVar0;
	struct<2> Var1;
...
float Function_20(var uParam0, struct<2> Param1) //Position: 0xEB7 / 3767
{
	struct<2> Var0;
...
struct<8> Function_21(int iParam0) //Position: 0xF2E / 3886
{
	struct<2> Var0;
...
void Function_22(int iParam0) //Position: 0xF9A / 3994
{
...
bool Function_23(int iParam0) //Position: 0x1002 / 4098
{
...
void Function_24(struct<153> Param0) //Position: 0x1018 / 4120
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_25(int iParam0) //Position: 0x1187 / 4487
{
...
var Function_26(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x11B3 / 4531
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_27(int iParam0) //Position: 0x11D4 / 4564
{
...
bool Function_28(struct<249> Param0) //Position: 0x11E9 / 4585
{
...
bool Function_29(struct<265> Param0) //Position: 0x1319 / 4889
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x147A / 5242
{
...
bool Function_31(int iParam0) //Position: 0x149E / 5278
{
...
bool Function_32(int iParam0) //Position: 0x14B3 / 5299
{
...
var Function_33(int iParam0) //Position: 0x14CA / 5322
{
...
bool Function_34(int iParam0) //Position: 0x14E4 / 5348
{
...
bool Function_35(int iParam0) //Position: 0x14FA / 5370
{
	return Global_116927[iParam06].f_16;
}

bool Function_36(var uParam0, int iParam1) //Position: 0x150A / 5386
{
	int iVar0;
...
bool Function_37(struct<237> Param0) //Position: 0x1527 / 5415
{
	if (!Param0.f_236)
	{
		if (Function_38())
...
bool Function_38() //Position: 0x15F6 / 5622
{
...
bool Function_39(int iParam0) //Position: 0x1611 / 5649
{
...
void Function_40(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x166C / 5740
{
	bool bVar0;
	char* cVar1[16];
...
void Function_41(char* cParam0) //Position: 0x16E1 / 5857
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_42(int iParam0, var uParam1, int iParam2) //Position: 0x171B / 5915
{
	var uVar0;
	char* cVar1[16];
...
int Function_43(char* cParam0) //Position: 0x1797 / 6039
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_44(int iParam0) //Position: 0x1838 / 6200
{
	int iVar0;
	int iVar1;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x1875 / 6261
{
...
bool Function_46(int iParam0) //Position: 0x1888 / 6280
{
	int iVar0;
...
bool Function_47(var uParam0, int iParam1) //Position: 0x18A4 / 6308
{
	int iVar0;
...
int Function_48(int iParam0) //Position: 0x18C1 / 6337
{
...
bool Function_49(int iParam0) //Position: 0x18D6 / 6358
{
...
int Function_50(int iParam0) //Position: 0x18EB / 6379
{
...
bool Function_51(var uParam0, bool bParam1) //Position: 0x1900 / 6400
{
	return (uParam0 && bParam1) == 0;
}

void Function_52() //Position: 0x190D / 6413
{
...
int Function_53(int iParam0, int iParam1) //Position: 0x198D / 6541
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_54(char* cParam0) //Position: 0x25F0 / 9712
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

bool Function_55(int iParam0, bool bParam1) //Position: 0x2608 / 9736
{
	int iVar0;
...
int Function_56(int iParam0) //Position: 0x2646 / 9798
{
	int iVar0;
	int iVar1;
...
bool Function_57(int iParam0) //Position: 0x2695 / 9877
{
...
int Function_58(int iParam0) //Position: 0x26AB / 9899
{
...
bool Function_59(int iParam0) //Position: 0x2714 / 10004
{
	if (!Function_57(iParam0))
	{
...
bool Function_60(int iParam0, int iParam1) //Position: 0x2765 / 10085
{
	int iVar0;
...
bool Function_61(int iParam0) //Position: 0x2792 / 10130
{
	if (!Function_57(iParam0))
	{
...
void Function_62(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x27E4 / 10212
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D7C / 11644
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_64() //Position: 0x2F1D / 12061
{
	return;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2F23 / 12067
{
	if (Global_6624)
	{
		return;
...
void Function_66(bool bParam0) //Position: 0x2F62 / 12130
{
...
void Function_67() //Position: 0x2FB7 / 12215
{
	Function_94();
	Function_93();
	Function_93();
...
void Function_68() //Position: 0x3002 / 12290
{
...
void Function_69() //Position: 0x3108 / 12552
{
	float fVar0;
...
void Function_70() //Position: 0x313B / 12603
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x32CE / 13006
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x3487 / 13447
{
	Function_73(&Global_42918, 1, 0);
	return;
}

void Function_73(struct<2317> Param0) //Position: 0x3495 / 13461
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_74() //Position: 0x36B2 / 14002
{
...
struct<8> Function_75(int iParam0) //Position: 0x36C7 / 14023
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_76(int iParam0, bool bParam1, bool bParam2) //Position: 0x376E / 14190
{
	int iVar0;
...
void Function_77(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3A0A / 14858
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_78(int iParam0) //Position: 0x4049 / 16457
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_79(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x405A / 16474
{
	char* cVar0[32];
...
struct<32> Function_80(char* cParam0) //Position: 0x4151 / 16721
{
	char* cVar0[32];
...
void Function_81(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x416C / 16748
{
	float fVar0;
...
var Function_82(int iParam0, int iParam1) //Position: 0x41D3 / 16851
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_83(int iParam0, bool bParam1) //Position: 0x41E5 / 16869
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_84(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x41F7 / 16887
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_85(int iParam0) //Position: 0x432B / 17195
{
	return Global_55480[iParam016].f_96;
}

float Function_86(int iParam0) //Position: 0x433A / 17210
{
	if (!iParam0 != 4294967295)
	{
...
var Function_87(int iParam0) //Position: 0x4373 / 17267
{
	if (iParam0 == 4294967295)
	{
...
void Function_88(int iParam0) //Position: 0x43B0 / 17328
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x454A / 17738
{
	int iVar0;
	int iVar1;
...
int Function_90(bool bParam0) //Position: 0x478E / 18318
{
...
struct<8> Function_91() //Position: 0x47CF / 18383
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_92() //Position: 0x4858 / 18520
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x48EF / 18671
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_94() //Position: 0x496E / 18798
{
...
int Function_95(int iParam0, bool bParam1, int iParam2) //Position: 0x49AB / 18859
{
	int iVar0;
	int iVar1;
...
void Function_96() //Position: 0x4BB7 / 19383
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_97(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4C6E / 19566
{
	int iVar0;
...
struct<8> Function_98() //Position: 0x4D66 / 19814
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_99(int iParam0) //Position: 0x4D70 / 19824
{
...
int Function_100(bool bParam0, bool bParam1) //Position: 0x4D86 / 19846
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_101(struct<2> Param0, struct<2> Param2) //Position: 0x4E52 / 20050
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_102(float fParam0, int iParam1) //Position: 0x4E6F / 20079
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_103(int iParam0) //Position: 0x569B / 22171
{
	var uVar0;
...
void Function_104(var uParam0, int iParam1) //Position: 0x56D6 / 22230
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_105(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x56E5 / 22245
{
	uParam0 = &uParam0;
...
void Function_106() //Position: 0x5794 / 22420
{
	bool bVar0;
...
void Function_107(int iParam0) //Position: 0x57F2 / 22514
{
	PRINTSTRING("Day ");
...
void Function_108(char* cParam0, bool bParam1) //Position: 0x583C / 22588
{
	bool bVar0;
...
void Function_109(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5861 / 22625
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_110(int iParam0) //Position: 0x58EC / 22764
{
	char* cVar0[16];
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x592B / 22827
{
	struct<4> Var0;
	var uVar4;
...
void Function_112(vector3 vParam0) //Position: 0x59C0 / 22976
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_113(int iParam0, int iParam1) //Position: 0x5B69 / 23401
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_114(float fParam0, float fParam1) //Position: 0x5C5E / 23646
{
...
void Function_115() //Position: 0x5D6F / 23919
{
...
void Function_116() //Position: 0x5DA3 / 23971
{
...
var Function_117() //Position: 0x5EA9 / 24233
{
	var uVar0;
...
void Function_118() //Position: 0x5EB2 / 24242
{
	var uVar0;
...
void Function_119(int iParam0, int iParam1) //Position: 0x5EE2 / 24290
{
	switch (&iParam1)
	{
		case 0x00000000:
...
int Function_120(struct<2>[] Param0) //Position: 0x5F2C / 24364
{
	int iVar0;
	int iVar1;
...
void Function_121() //Position: 0x62EE / 25326
{
	if (!Function_46(128))
	{
		return;
...
bool Function_122() //Position: 0x632E / 25390
{
	int iVar0;
...
void Function_123(struct<13> Param0) //Position: 0x635C / 25436
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_124() //Position: 0x636F / 25455
{
	if (!Function_46(128))
	{
		return;
...
void Function_125(struct<229> Param0) //Position: 0x63B1 / 25521
{
...
void Function_126(struct<229> Param0) //Position: 0x65B4 / 26036
{
...
void Function_127(int iParam0, int iParam1) //Position: 0x6643 / 26179
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_128(struct<265> Param0) //Position: 0x6659 / 26201
{
	if (!Param0.f_260 != 0)
	{
		if (Function_36(&Param0 + 260, 4))
...
int Function_129(struct<261> Param0) //Position: 0x6725 / 26405
{
	if (!Param0.f_260 != 0)
	{
		switch (Global_99472)
...
bool Function_130(int iParam0, bool bParam1) //Position: 0x67E0 / 26592
{
...
var Function_131(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x6817 / 26647
{
	int iVar0;
	var uVar1;
...
var Function_132(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6855 / 26709
{
	int iVar0;
