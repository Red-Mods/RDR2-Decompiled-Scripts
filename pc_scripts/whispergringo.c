...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&bLocal_2, 0, 10.0f, 4294967295);
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28D0 / 10448
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "whisper", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2947 / 10567
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x296A / 10602
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &iParam1, Vector(1,012977f, 1,792521f, -0,474222f), Vector(-13,58976f, 89,76136f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	SET_CAMERASHOT_TARGET_OBJECT(&iParam0, &iParam1, 0);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(-0,351507f, 1,462641f, -0,48016f), Vector(0.0f, 0.0f, 0.0f), 0);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A13 / 10771
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A1F / 10783
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A3E / 10814
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A55 / 10837
{
	struct<2> Var0;
	bool bVar2;
	bool bVar3;
	...
	if (IS_ACTOR_PLAYER(&uParam0))
	{
		TELEPORT_ACTOR_WITH_HEADING(&uParam0, Var0, bVar2, 1, 1, true);
		return 1;
	}
...
int Function_70(int iParam0) //Position: 0x2AAC / 10924
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

bool Function_71(var uParam0, int iParam1) //Position: 0x2AD0 / 10960
{
...
int Function_72(var uParam0) //Position: 0x2AFE / 11006
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2C17 / 11287
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2C24 / 11300
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2CA6 / 11430
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x3251 / 12881
{
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
...
int Function_77(int iParam0) //Position: 0x326A / 12906
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3288 / 12936
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x32C9 / 13001
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x32D5 / 13013
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(int iParam0, int iParam1) //Position: 0x32F7 / 13047
{
	DECOR_SET_BOOL(&iParam0, "bIsFinished", true);
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
}

void Function_82(var uParam0, bool bParam1) //Position: 0x331F / 13087
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x342F / 13359
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3447 / 13383
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x3763 / 14179
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x3775 / 14197
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x378F / 14223
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x37AA / 14250
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	iParam0 = &iParam0;
	uVar2 = Function_89(&iParam1, &bVar1);
	if (!bVar1)
	{
		if (IS_ACTOR_LOCAL_PLAYER(GRINGO_GET_REQUESTING_ACTOR()))
		{
			uVar2 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
		}
	}
	uVar2 = &uVar2;
	bVar0 = DECOR_GET_INT(&iParam0, "context");
	if (bVar0 != 0)
	{
		if (bVar0 == 1)
		{
			GRINGO_SET_REQUEST_STRING("Warn_Military");
		}
		if (bVar0 == 2)
		{
			GRINGO_SET_REQUEST_STRING("Recruit_Civilian");
		}
	}
	else
	{
		GRINGO_SET_REQUEST_STRING("Whisper");
	}
	return;
}

int Function_89(var uParam0, int iParam1) //Position: 0x383C / 14396
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x3855 / 14421
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3B4D / 15181
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3B6B / 15211
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C0B / 15371
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(int iParam0, var uParam1) //Position: 0x3C2B / 15403
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3C3E / 15422
{
...
void Function_96(int iParam0) //Position: 0x3C5A / 15450
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3C66 / 15462
{
	bool bVar0;
	var uVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3CD2 / 15570
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3CEA / 15594
{
	iParam0 = &iParam0;
	return;
}

void Function_100(bool bParam0) //Position: 0x3CF6 / 15606
{
