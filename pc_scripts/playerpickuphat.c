...
void main() //Position: 0x0 / 0
{
	...
	iLocal_114 = 0;
	Function_96(&uScriptParam_0, &iLocal_114);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_89(&(vLocal_4[iVar39]), &bVar4))
						{
							Function_87(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_4[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_82("eGRINGO_EndUse: Stop use by request", &vLocal_4[iVar39] + 24);
							Function_81(&vLocal_4[iVar39] + 24, 1);
							...
							{
								Function_74(&(vLocal_4[iVar39]), 0);
							}
							else if (vLocal_4[iVar39].f_68 < 8)
							{
								Function_73(&(vLocal_4[iVar39]));
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	if (!Function_72(Param0.f_64, 2))
	{
		Function_81(&Param0 + 24, 0);
	}
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	bVar11 = Function_71(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_82("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_82("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_82("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_70(&Param0 + 16, &fVar22))
				{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_72(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_72(Param0.f_64, 1))
			{
				Function_56(&Param0 + 16, &Var3, &uVar5);
				if (!Function_72(Param0.f_64, 16))
				{
				...
				if (!Function_72(Param0.f_64, 1024))
				{
			...
			if (Param0.f_68 != 3 && !Function_72(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_72(Param0.f_64, 1);
			}
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_72(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_62(bool bParam0) //Position: 0x28A5 / 10405
{
	...
	uVar0 = GRINGO_GET_COMPONENT_USER(&bParam0);
	bLocal_0 = Function_63(GRINGO_GET_MY_OBJECT_REF(), 0, &uVar0, 1, 0, 0);
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28C4 / 10436
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "nhatpickup", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x294A / 10570
{
	var uVar0;
	int iVar1;
...
void Function_65(int iParam0, var uParam1) //Position: 0x2993 / 10643
{
	SET_CAMERASHOT_PERSPECTIVE(&iParam0, 1);
	SET_CAMERASHOT_FOV(&iParam0, 43,74291f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(&iParam0, 0,15f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(&iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(&iParam0, 1);
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(-1,200705f, 0,12542f, -2,229393f), Vector(16,4817f, -142,7418f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
	...
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(StackVal, StackVal, &iParam0, Vector(0.0f, 0,795814f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2A34 / 10804
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2A40 / 10816
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2A5F / 10847
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A76 / 10870
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	return 1;
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2A89 / 10889
{
...
int Function_71(var uParam0) //Position: 0x2AB7 / 10935
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2BD0 / 11216
{
	return (uParam0 && iParam1) == 0;
}

void Function_73(struct<69> Param0) //Position: 0x2BDD / 11229
{
	if (Function_72(Param0.f_64, 16))
	{
...
void Function_74(struct<69> Param0) //Position: 0x2C5F / 11359
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_72(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_80(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_72(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_72(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_79(&Param0 + 16) && Function_72(Param0.f_64, 512))
			{
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_76(&Param0 + 16), &Param0 + 16);
	}
...
void Function_75() //Position: 0x320A / 12810
{
	if (IS_OBJECT_VALID(&bLocal_0))
	{
		DESTROY_OBJECT(&bLocal_0);
	}
	return;
}

int Function_76(int iParam0) //Position: 0x321F / 12831
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_77(int iParam0, var uParam1) //Position: 0x323D / 12861
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_78(int iParam0) //Position: 0x327E / 12926
{
	iParam0 = &iParam0;
	return;
}

bool Function_79(int iParam0) //Position: 0x328A / 12938
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_80(var uParam0, int iParam1) //Position: 0x32AC / 12972
{
	iParam1 = &iParam1;
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		{
			EQUIP_ACCESSORY(&uParam0, 0, 1);
		}
	}
	return;
}

void Function_81(var uParam0, bool bParam1) //Position: 0x32D2 / 13010
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_82(int iParam0, int iParam1) //Position: 0x33E2 / 13282
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_83(struct<69> Param0) //Position: 0x33FA / 13306
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_84(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_84(int iParam0, int iParam1) //Position: 0x3716 / 14102
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_85(int iParam0) //Position: 0x3728 / 14120
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_86(int iParam0) //Position: 0x3742 / 14146
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_87(int iParam0, var uParam1) //Position: 0x375D / 14173
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_88(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_88(var uParam0, int iParam1) //Position: 0x379B / 14235
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_89(struct<65> Param0) //Position: 0x37B4 / 14260
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_93(&uVar1, &Param0 + 16))
		{
		...
		if (!Function_72(Param0.f_64, 2))
		{
			...
			if (Function_72(Param0.f_64, 1))
			{
				Function_82("MIDACTION REQUEST", &uVar1);
			}
			else
			{
...
int Function_90(int iParam0) //Position: 0x3AAC / 15020
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_91(var uParam0, int iParam1) //Position: 0x3ACA / 15050
{
	struct<5> Var0;
	float fVar5;
...
int Function_92(int iParam0) //Position: 0x3B6A / 15210
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_93(int iParam0, var uParam1) //Position: 0x3B8A / 15242
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_94(int iParam0) //Position: 0x3B9D / 15261
{
...
void Function_95(int iParam0) //Position: 0x3BB9 / 15289
{
	iParam0 = &iParam0;
	return;
}

void Function_96(var uParam0, int iParam1) //Position: 0x3BC5 / 15301
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_97(&(vLocal_4[iLocal_1149]), &uParam0);
		iLocal_114++;
	}
...
void Function_97(int iParam0, int iParam1) //Position: 0x3C31 / 15409
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_98(int iParam0) //Position: 0x3C49 / 15433
{
	iParam0 = &iParam0;
	return;
}

void Function_99(int iParam0) //Position: 0x3C55 / 15445
{
