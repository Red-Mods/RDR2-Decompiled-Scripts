...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(4, &iLocal_25, &iLocal_27, &uLocal_3, &uLocal_29, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x255 / 597
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6C7 / 1735
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x6FB / 1787
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA3D / 2621
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA70 / 2672
{
...
void Function_9(int iParam0) //Position: 0xA87 / 2695
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAB3 / 2739
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xACD / 2765
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAEA / 2794
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBB0 / 2992
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD79 / 3449
{
...
void Function_15(int iParam0) //Position: 0xDB6 / 3510
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDCF / 3535
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDDC / 3548
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(int iParam0, var uParam1) //Position: 0xED1 / 3793
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF37 / 3895
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xF99 / 3993
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFCE / 4046
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11E7 / 4583
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x125E / 4702
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12CA / 4810
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x12F2 / 4850
{
...
void Function_26(struct<13> Param0) //Position: 0x143D / 5181
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x145A / 5210
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x1478 / 5240
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_34 || bParam2) || Global_6611)
			{
				if (Function_151(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_149(&Param0 + 324, &fLocal_36, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_148();
								(*&Param0 + 48)[1] = Function_147();
								Function_146(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_146(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_139(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_139(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_146(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_146(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_139(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_139(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_139(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_146(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_138(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_36, 20.0f, fLocal_36));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_134(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_138(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_109(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_105(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_138(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_138(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
					...
					Function_74(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_73(StackVal, StackVal, &Param0 + 16, Function_138(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_138()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
					Function_70(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_69(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_69(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_58(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_38) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_37, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_57(&Param0 + 392, 1);
							Function_56(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_37 == 8)
							{
					...
					while (bVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[bVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[bVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[bVar1]) != &Global_54076)
							{
								...
								Function_57(&Param0 + 392, 1);
								Function_56(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_55(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_51(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_51(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_50()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_49(&Param0 + 392, Function_50(), 4);
				Function_48(&Param0 + 392, Function_50());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_47(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_46(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_37(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_29(struct<62> Param0) //Position: 0x2637 / 9783
{
	var uVar0;
	...
	if ((GET_CURRENT_GAME_TIME() - fLocal_33) < 1.0f && Function_33(Global_46760[0]))
	{
		uVar0 = Function_31(Global_46760[0], "narmadillo", "sheriffsOffice01", 1);
...
void Function_30(var uParam0, int iParam1) //Position: 0x26B8 / 9912
{
...
var Function_31(int iParam0, char* cParam1, bool bParam3) //Position: 0x2713 / 10003
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_32(int iParam0) //Position: 0x27B8 / 10168
{
...
bool Function_33(int iParam0) //Position: 0x27CE / 10190
{
	if (!Function_32(iParam0))
	{
		return 1;
...
bool Function_34(var uParam0, int iParam1) //Position: 0x27EA / 10218
{
	int iVar0;
...
void Function_35(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2807 / 10247
{
	bool bVar0;
	var uVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_36(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
...
bool Function_36(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2A40 / 10816
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_37(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2A60 / 10848
{
	bool bVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(&uParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(&uVar1))
				{
					Function_38(&uVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_38(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_38(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2B4E / 11086
{
	char* cVar0[32];
	...
	Function_41(&uParam0, &uParam2);
	Function_40(&uParam0, uParam3);
	if (Function_39(&uParam0) != 5)
	{
...
int Function_39(int iParam0) //Position: 0x2DBA / 11706
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_40(var uParam0, bool bParam1) //Position: 0x2DDE / 11742
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_41(var uParam0, int iParam1) //Position: 0x2E02 / 11778
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E28 / 11816
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_43(var uParam0, bool bParam1) //Position: 0x2E4F / 11855
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_44(bool bParam0) //Position: 0x2E73 / 11891
{
...
bool Function_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2EE1 / 12001
{
	bool bVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_36(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_47(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F3D / 12093
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_48(var uParam0, int iParam1) //Position: 0x2F5E / 12126
{
	bool bVar0;
	var uVar1;
...
void Function_49(var uParam0, var uParam1, bool bParam2) //Position: 0x2FB9 / 12217
{
	bool bVar0;
	var uVar1;
...
var Function_50() //Position: 0x3005 / 12293
{
...
void Function_51(struct<425> Param0) //Position: 0x301A / 12314
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_54(&Param0 + 392))
	{
		return;
	}
	if (!Function_52(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_55(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_55(&Param0 + 392), &Global_54076, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_55(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_55(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_52(var uParam0, struct<2> Param1, float fParam3) //Position: 0x316D / 12653
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_53(vector3 vParam0) //Position: 0x31E2 / 12770
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_54(var uParam0) //Position: 0x31FA / 12794
{
	bool bVar0;
	int iVar1;
...
var Function_55(bool bParam0) //Position: 0x3258 / 12888
{
	bool bVar0;
	bool bVar1;
...
void Function_56(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x32A5 / 12965
{
	bool bVar0;
	var uVar1;
...
void Function_57(var uParam0, bool bParam1) //Position: 0x331E / 13086
{
	bool bVar0;
	var uVar1;
...
void Function_58(var uParam0) //Position: 0x336D / 13165
{
	struct<21> Var0;
	
	bVar6 = Function_68(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_60(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_59())
...
bool Function_59() //Position: 0x342C / 13356
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_60(struct<25> Param0) //Position: 0x343F / 13375
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_65(Param0, 0))
	{
		uVar0 = Function_61(StackVal);
...
var Function_61(int iParam0) //Position: 0x3506 / 13574
{
...
bool Function_62(int iParam0) //Position: 0x3526 / 13606
{
...
bool Function_63(int iParam0) //Position: 0x354A / 13642
{
...
bool Function_64(int iParam0) //Position: 0x355F / 13663
{
...
bool Function_65(int iParam0, bool bParam1) //Position: 0x3576 / 13686
{
	int iVar0;
...
var Function_66(int iParam0) //Position: 0x35B4 / 13748
{
...
bool Function_67(int iParam0) //Position: 0x35CE / 13774
{
...
int Function_68(int iParam0, struct<6> Param1) //Position: 0x35E4 / 13796
{
	int iVar0;
...
void Function_69(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x361E / 13854
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_138(), bParam2[iVar0], Var1, Var3);
...
void Function_70(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3703 / 14083
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_138(), bParam3, Var2, Var4);
...
void Function_71(var uParam0, bool bParam1) //Position: 0x38BA / 14522
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_72(bool bParam0) //Position: 0x38DF / 14559
{
	var uVar0;
	int iVar1;
...
var Function_73(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x392D / 14637
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_74(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3A84 / 14980
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_75(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_75(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3B2F / 15151
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_76(int iParam0, int iParam1) //Position: 0x3BD5 / 15317
{
	Function_146(&uLocal_3, 588, 3, 0);
	Function_146(&uLocal_3, 608, 3, 0);
	Function_146(&uLocal_3, 645, 3, 0);
	Function_102(&uLocal_3, "talking_stand", 5, 0);
	Function_102(&uLocal_3, "custom/talking_stand", 8, 0);
	if (Function_86(&iLocal_25, &uLocal_3, 23, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_84(&uLocal_31, "marshal03mobile", &iParam1))
		{
			iLocal_27 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_31, Function_138()));
			*(&Global_6667[2328] + 216) = &iLocal_27;
			*(&iParam0 + 24) = &uLocal_31;
			Function_77();
			fLocal_33 = GET_CURRENT_GAME_TIME();
			return 1;
		}
...
void Function_77() //Position: 0x3C9B / 15515
{
	var uVar0;
	struct<2> Var1;
	int iVar3;
	...
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_29, "marshal03restrict", 2,802597E-45f, Vector(-2084,343f, 17,37085f, 2602,81f), Vector(0.0f, 24,46099f, 0.0f), Vector(9,259373f, 5,303829f, 9,113053f));
	...
	uLocal_29 = CREATE_LAYOUT("marshal03campfirelayout");
	Var1 = Vector(-2088,17f, 17,459f, 2601,121f);
	TELEPORT_ACTOR_WITH_HEADING(&iLocal_25, Var1, 15.0f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(&iLocal_25, 1.0f, false, 1092616192);
	Function_81(StackVal, &iLocal_25, Vector(-2084,735f, 17,709f, 2601,664f));
	TASK_STAND_STILL(&iLocal_25, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(&iLocal_25, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&iLocal_25, "talking_stand");
	Function_79(&iLocal_25, &iLocal_27, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iLocal_25, &uVar0, 1, true);
	iVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_29, "Marshal01drew", 608, Vector(-2086,813f, 17,204f, 2600,029f), Vector(0.0f, 0.0f, 0.0f));
	Function_79(&iVar3, &iLocal_27, 1, 1);
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &iVar3, 0, 3212836864);
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(false, "talking_stand/Listen_B");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&iLocal_25, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	SNAP_OBJECT_TO_GROUND(&iVar3, 1.0f, false, 1092616192);
	Function_78(&iVar3, &iLocal_25);
	SET_ANIM_SET_FOR_ACTOR(&iVar3, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&iVar3, "talking_stand");
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &iLocal_25, 0, 3212836864);
	TASK_ACTION_PERFORM(false, "talking_stand/Talk_A");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&iVar3, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iVar3, &uVar0, 1, true);
	iVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_29, "Marshal03dep", 588, Vector(-2086,176f, 17,098f, 2599,993f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&iVar3, 1.0f, false, 1092616192);
	Function_81(StackVal, &iVar3, Vector(-2084,312f, 17,182f, 2604,943f));
	TASK_STAND_STILL(&iVar3, -1.0f, 0, 0);
	Function_79(&iVar3, &iLocal_27, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iVar3, &uVar0, 1, true);
	iVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_29, "Marshal03deek", 645, Vector(-2082,788f, 17,096f, 2600,006f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&iVar3, 1.0f, false, 1092616192);
	Function_78(&iVar3, &iLocal_25);
	TASK_STAND_STILL(&iVar3, -1.0f, 0, 0);
	Function_79(&iVar3, &iLocal_27, 1, 1);
...
void Function_78(var uParam0, int iParam1) //Position: 0x3FA6 / 16294
{
	struct<2> Var0;
	
	GET_OBJECT_POSITION(GET_OBJECT_FROM_ACTOR(&iParam1), &Var0);
	Function_81(StackVal, &uParam0, Var0);
	return;
}

void Function_79(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3FC2 / 16322
{
	bool bVar0;
	int iVar1;
...
bool Function_80(int iParam0, int iParam1, bool bParam2) //Position: 0x4180 / 16768
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_81(float fParam0, struct<2> Param1) //Position: 0x41C8 / 16840
{
	if (!IS_ACTOR_VALID(GET_MOUNT(&fParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_82(&fParam0, &fParam0, Param1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_82(GET_MOUNT(&fParam0), &fParam0, Param1), 1);
	}
	return;
}

var Function_82(var uParam0, struct<2> Param1) //Position: 0x4203 / 16899
{
	struct<2> Var0;
	
	Function_83(&uParam0);
	Var0 = Vector(StackVal, StackVal, StackVal) - Vector(Function_83(&uParam0), Param1, StackVal);
	VNORMALIZE(&Var0);
...
struct<8> Function_83(int iParam0) //Position: 0x4284 / 17028
{
	struct<2> Var0;
...
bool Function_84(var uParam0, var uParam1, int iParam2) //Position: 0x4296 / 17046
{
...
void Function_85(var uParam0, bool bParam1) //Position: 0x42C6 / 17094
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_138(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4311 / 17169
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_101(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_100(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	if (StackVal || !Function_98((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_100(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x44F0 / 17648
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x4A30 / 18992
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_89(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4A52 / 19026
{
	var uVar0;
...
var Function_90(bool bParam0, int iParam1) //Position: 0x4AB3 / 19123
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x4B41 / 19265
{
	Function_93(&uParam0);
	Function_92(&uParam0);
...
void Function_92(int iParam0) //Position: 0x4B6D / 19309
{
...
void Function_93(int iParam0) //Position: 0x4B93 / 19347
{
...
bool Function_94(bool bParam0) //Position: 0x4C69 / 19561
{
...
var Function_95(int iParam0, int iParam1) //Position: 0x4C80 / 19584
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D26 / 19750
{
	var uVar0;
	var uVar1;
...
void Function_97(int iParam0) //Position: 0x4E35 / 20021
{
	int iVar0;
...
bool Function_98(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4E68 / 20072
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_99() //Position: 0x4EF4 / 20212
{
	var uVar0;
	int iVar1;
...
var Function_100(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4F64 / 20324
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_101(struct<205> Param0) //Position: 0x500A / 20490
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		...
		if (Function_11(&Param0 + 184, 4096))
		{
			...
			{
				uVar0 = Function_61(Function_66(Param0.f_188));
...
var Function_102(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5115 / 20757
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_104(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_103(struct<13> Param0) //Position: 0x5153 / 20819
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_104(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5166 / 20838
{
	int iVar0;
...
bool Function_105(struct<2>[] Param0) //Position: 0x5235 / 21045
{
	int iVar0;
	int iVar1;
...
void Function_106() //Position: 0x55F7 / 22007
{
	if (!Function_153(128))
	{
		return;
...
bool Function_107() //Position: 0x5637 / 22071
{
	int iVar0;
...
void Function_108() //Position: 0x5665 / 22117
{
	if (!Function_153(128))
	{
		return;
...
void Function_109(vector3 vParam0) //Position: 0x56A7 / 22183
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_110(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_110(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_110(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x573F / 22335
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_111(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_111(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x576E / 22382
{
	Function_126(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_116(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_115(), Function_114(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_113(), Function_112(&uParam11, &uParam12));
}

var Function_112(var uParam0, bool bParam1) //Position: 0x57C9 / 22473
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x57D9 / 22489
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x57ED / 22509
{
	int iVar0;
...
var Function_115() //Position: 0x5812 / 22546
{
	return "PackedMetadata";
}

void Function_116(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5829 / 22569
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_125(), &uVar4))
				{
					Function_120(uVar4, &bVar5);
...
struct<8> Function_117() //Position: 0x5965 / 22885
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_118() //Position: 0x5977 / 22903
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_119() //Position: 0x5989 / 22921
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_120(var uParam0, struct<5> Param1) //Position: 0x599B / 22939
{
	Param1 = Function_121(uParam0, Function_123(), 0);
	Param1.f_4 = Function_121(uParam0, Function_123() + 8, Function_123());
	return;
}

var Function_121(var uParam0, int iParam1, int iParam2) //Position: 0x59C0 / 22976
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x59DF / 23007
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_123() //Position: 0x59EB / 23019
{
	return Function_124(39);
}

int Function_124(int iParam0) //Position: 0x59F6 / 23030
{
	int iVar0;
...
var Function_125() //Position: 0x5A24 / 23076
{
	return "PackedWeapon";
}

int Function_126(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5A39 / 23097
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_130(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_128(Function_130()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_127(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_127() //Position: 0x5B46 / 23366
{
	return "MPItemGiver";
}

struct<32> Function_128(char* cParam0) //Position: 0x5B5A / 23386
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0) //Position: 0x5BC6 / 23494
{
	char* cVar0[32];
...
var Function_130() //Position: 0x5BE8 / 23528
{
	return "PBox_";
}

var Function_131() //Position: 0x5BF6 / 23542
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x5C1C / 23580
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5C44 / 23620
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x5C6A / 23658
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5DD4 / 24020
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5E7C / 24188
{
	int iVar0;
	struct<2> Var1;
...
void Function_137(int iParam0) //Position: 0x5FEA / 24554
{
...
var Function_138() //Position: 0x6052 / 24658
{
	int iVar0;
...
var Function_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x605B / 24667
{
	return Function_140(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_140(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6079 / 24697
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_94(bVar1))
	{
		...
		{
			Function_144(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_141(int iParam0) //Position: 0x6372 / 25458
{
	int iVar0;
...
void Function_142() //Position: 0x6426 / 25638
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x6461 / 25697
{
	int iVar0;
...
void Function_144(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x648E / 25742
{
	int iVar0;
...
void Function_145() //Position: 0x65E9 / 26089
{
	int iVar0;
...
var Function_146(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6635 / 26165
{
	int iVar0;
...
int Function_147() //Position: 0x6711 / 26385
{
	int iVar0;
...
int Function_148() //Position: 0x686D / 26733
{
	int iVar0;
...
bool Function_149(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x698D / 27021
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_150(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_150(struct<2> Param0) //Position: 0x6A69 / 27241
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_151(struct<2> Param0, struct<5> Param2) //Position: 0x6A88 / 27272
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
	...
	{
		if (!Function_53(StackVal, Param2))
		{
			return 1;
		}
	}
...
bool Function_152(int iParam0) //Position: 0x6BCB / 27595
{
	var uVar0;
...
bool Function_153(int iParam0) //Position: 0x6BED / 27629
{
	int iVar0;
...
int Function_154() //Position: 0x6C09 / 27657
{
	return 0;
}

void Function_155(struct<321> Param0) //Position: 0x6C10 / 27664
{
	var uVar0;
	
	Param0.f_8 = 0;
	Param0.f_320 = 0;
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_128("campfire"), 4);
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_104(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_104(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
