...
void main() //Position: 0x0 / 0
{
	...
	Function_132("STARTS");
	Function_131(&uScriptParam_0);
	iLocal_35 = 0;
	Function_129(&uScriptParam_0, &iLocal_35);
	while (IS_GRINGO_ACTIVE())
	{
		Function_128(&uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_36);
		}
		iVar2 = 0;
		bLocal_43 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_122(&(vLocal_15[iVar39]), &bVar4))
						{
							Function_120(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_15[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_79("eGRINGO_EndUse: Stop use by request", &vLocal_15[iVar39] + 24);
							Function_78(&vLocal_15[iVar39] + 24, 1);
							...
							{
								Function_71(&(vLocal_15[iVar39]), 0);
							}
							else if (vLocal_15[iVar39].f_68 < 8)
							{
								Function_70(&(vLocal_15[iVar39]));
						...
						{
							Function_132("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_35 - 1))
			{
				if (Function_69(vLocal_15[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_15[iVar09])))
					{
						Function_132("Quitting due to update end");
						Function_71(&(vLocal_15[iVar09]), 1);
					}
				}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
	{
		Function_132("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_35 - 1))
	{
		if (Function_69(vLocal_15[iVar09].f_64, 2))
		{
			...
			Function_71(&(vLocal_15[iVar09]), 0);
		}
...
int Function_4(int iParam0) //Position: 0x48E / 1166
{
	iParam0 = &iParam0;
	return 0;
}

void Function_5(struct<69> Param0) //Position: 0x49B / 1179
{
	bool bVar0;
	int iVar1;
	int iVar2;
	
	if (!Function_69(Param0.f_64, 2))
	{
		Function_78(&Param0 + 24, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
					...
					if (IS_ACTOR_LOCAL_PLAYER(&Param0 + 24))
					{
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
								{
									Function_132("ManagePlayerQuit: Create quit context");
									if (Function_7(&Param0 + 16, "UseQuitBOverride", 0))
									{
										bLocal_44 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_44 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_44))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
									{
										Function_132("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(&Param0 + 24, "LobbyGringo"))
								{
									if (Function_6(&Param0 + 24))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
										{
											Function_132("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
										}
									}
								}
						...
						else if (Global_6663)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
							{
								Function_132("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
							}
						}
					}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
		{
			Function_132("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
		}
...
bool Function_6(int iParam0) //Position: 0x7CF / 1999
{
	bool bVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_7(bool bParam0, var uParam1, int iParam2) //Position: 0x8E8 / 2280
{
	int iVar0;
	bool bVar1;
...
bool Function_8(char* cParam0, int iParam1) //Position: 0x906 / 2310
{
	return Function_9(&cParam0, "UseQuit", &iParam1);
}

bool Function_9(char* cParam0, char* cParam1, int iParam2) //Position: 0x91F / 2335
{
	int iVar0;
	int iVar1;
...
float Function_10(int iParam0) //Position: 0x96F / 2415
{
	return Function_11(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(float fParam0, var uParam1, int iParam2) //Position: 0x98D / 2445
{
	int iVar0;
...
float Function_12(vector3 vParam0) //Position: 0x9A5 / 2469
{
...
bool Function_13(int iParam0) //Position: 0xA72 / 2674
{
...
bool Function_15(int iParam0, int iParam1) //Position: 0xA8E / 2702
{
	bool bVar0;
...
bool Function_16(struct<69> Param0) //Position: 0xADB / 2779
{
	bool bVar0;
	char[] cVar1[4];
	int iVar2;
	...
	bVar11 = Function_68(&Param0 + 16);
	if (!(IS_ACTOR_VALID(&Param0 + 24) && IS_ACTOR_ALIVE(&Param0 + 24)))
	{
		Function_79("UpdateUse with invalid actor", &Param0 + 24);
		return 0;
	}
	if (!Function_7(&Param0 + 16, "DenyDamageTermination", 0))
	{
		...
		{
			Function_79("Damage quit", &Param0 + 24);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(&Param0 + 24))
	{
		Function_79("Incapacitation quit", &Param0 + 24);
		return 0;
	}
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_67(&Param0 + 16, &fVar22))
				{
		...
		case 0x00000001:
			...
			if (((!Global_99146 && IS_ACTOR_LOCAL_PLAYER(&Param0 + 24)) && !Function_69(Param0.f_64, 1)) && !DECOR_CHECK_EXIST(&Param0 + 24, "NoGringoCamera"))
			{
			...
			if (Function_69(Param0.f_64, 1))
			{
				Function_56(&Param0 + 16, &Var3, &uVar5);
				if (!Function_69(Param0.f_64, 16))
				{
				...
				if (!Function_69(Param0.f_64, 1024))
				{
			...
			if (Param0.f_68 != 3 && !Function_69(Param0.f_64, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(&Param0 + 16))
				{
					Function_2("SUSPEND MOVER", &Param0 + 24);
		...
		case 0x00000004:
			...
			if (iVar28 == 0)
			{
				bVar29 = Function_69(Param0.f_64, 1);
			}
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_41, &uLocal_39);
		...
		case 0x00000006:
			...
			bVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_69(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_17(var uParam0, int iParam1) //Position: 0x1E10 / 7696
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1E27 / 7719
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	return;
...
bool Function_19() //Position: 0x1E39 / 7737
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E6C / 7788
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1EEA / 7914
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x1F66 / 8038
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1F78 / 8056
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1F8F / 8079
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1F9C / 8092
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, bool bParam1) //Position: 0x1FBD / 8125
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1FD0 / 8144
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x1FF0 / 8176
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x1FF6 / 8182
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2008 / 8200
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2015 / 8213
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2030 / 8240
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2050 / 8272
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2070 / 8304
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20A7 / 8359
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20C7 / 8391
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x20E2 / 8418
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x20F8 / 8440
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x241C / 9244
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2425 / 9253
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2444 / 9284
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2453 / 9299
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2477 / 9335
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x249D / 9373
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24BB / 9403
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24DD / 9437
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(char* cParam0, int iParam1) //Position: 0x24FF / 9471
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25C7 / 9671
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2643 / 9795
{
...
void Function_50(vector3 vParam0) //Position: 0x265B / 9819
{
...
var Function_51(int iParam0) //Position: 0x2680 / 9856
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26A1 / 9889
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26B8 / 9912
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26C4 / 9924
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26CB / 9931
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26DC / 9948
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2721 / 10017
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x274D / 10061
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2759 / 10073
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x285B / 10331
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x287E / 10366
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x28A6 / 10406
{
	iParam0 = &iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x28B2 / 10418
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x28BE / 10430
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x28DD / 10461
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x28F4 / 10484
{
	uParam0 = &uParam0;
	iParam1 = &iParam1;
	return 1;
...
bool Function_67(var uParam0, int iParam1) //Position: 0x2907 / 10503
{
...
int Function_68(var uParam0) //Position: 0x2935 / 10549
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2A4E / 10830
{
	return (uParam0 && iParam1) == 0;
}

void Function_70(struct<69> Param0) //Position: 0x2A5B / 10843
{
	if (Function_69(Param0.f_64, 16))
	{
...
void Function_71(struct<69> Param0) //Position: 0x2ADD / 10973
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(&Param0 + 24) && Function_69(Param0.f_64, 32)) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
	{
	...
	Function_77(&Param0 + 24, &Param0 + 16);
	if (IS_ACTOR_VALID(&Param0 + 24))
	{
		GRINGO_REPORT_USE_FINISHED(&Param0 + 24, Function_69(Param0.f_64, 64));
		Function_17(&Param0 + 24, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
		if (!Function_7(&Param0 + 16, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_69(Param0.f_64, 128) && Function_7(&Param0 + 16, "RedrawWeapon", 1))
			{
			...
			if (Function_76(&Param0 + 16) && Function_69(Param0.f_64, 512))
			{
	...
	if (&Param0 + 16 == &iLocal_41)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_39));
		iLocal_41 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
	...
	if (IS_ACTOR_VALID(&Param0 + 24) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_73(&Param0 + 16), &Param0 + 16);
	}
...
void Function_72() //Position: 0x3088 / 12424
{
	int iVar0;
...
int Function_73(int iParam0) //Position: 0x30C2 / 12482
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_74(int iParam0, var uParam1) //Position: 0x30E0 / 12512
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_75(int iParam0) //Position: 0x3121 / 12577
{
	iParam0 = &iParam0;
	return;
}

bool Function_76(int iParam0) //Position: 0x312D / 12589
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_77(int iParam0, int iParam1) //Position: 0x314F / 12623
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_78(var uParam0, bool bParam1) //Position: 0x3161 / 12641
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
		{
			Function_132("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
		{
			if (&bParam1)
			{
				Function_132("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_44))
			{
				if (&bParam1)
				{
					Function_132("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(&bLocal_44);
			}
		}
	...
	if (&bParam1)
	{
		Function_132("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_79(int iParam0, int iParam1) //Position: 0x3271 / 12913
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_80(struct<69> Param0) //Position: 0x3289 / 12937
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	*(&Param0 + 16) = &uVar0;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 0);
	Function_81(&Param0 + 24, &uVar0);
	Function_2("START: ", &Param0 + 24);
	return;
}

void Function_81(float fParam0, int iParam1) //Position: 0x35A5 / 13733
{
	Function_82(&fParam0, &iParam1);
	return;
}

int Function_82(float fParam0, int iParam1) //Position: 0x35B3 / 13747
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	{
		SET_GRINGO_OBJECT_REF_ATTR(GET_OBJECT_FROM_ACTOR(&fParam0), "LastUserObject", &iParam1);
	...
	switch (Function_117())
	{
		case 0x00000002:
			...
			bVar3 = Function_110(&fParam0, 1, 1, iVar2);
		...
		case 0x00000001:
			bVar3 = Function_98(&fParam0, &uVar0);
			break;
		
		case 0x00000003:
			bVar3 = Function_97(&fParam0);
			break;
		
		case 0x00000004:
			bVar3 = Function_96(&fParam0);
			break;
	}
	if (bVar3)
	{
		if (!Function_115(262144))
		{
			Function_94(Function_117());
		}
...
void Function_83(int iParam0, bool bParam1, float fParam2) //Position: 0x3753 / 14163
{
	var uVar0;
	float fVar1;
	...
	if (!IS_OBJECT_IN_OBJECTSET(&iParam0, Function_92()))
	{
		if (Function_85(&iParam0) != 5)
		{
			ADD_OBJECT_TO_OBJECTSET(&iParam0, Function_92());
		}
		uVar0 = GET_OBJECT_OWNER(&iParam0);
		DESTROY_OBJECT_GLOW(&uVar0);
		PLAY_SIMPLE_PROP_ANIMATION(&uVar0, "crateMultiplayer_open", 0, 0, 2.0f, 0);
		if (&bParam1)
		{
			fParam2 = (&fParam2 - (0.0f - GET_CURRENT_GAME_TIME()));
		}
		else
		{
			RELEASE_SOUND_ID(PLAY_SOUND_FROM_OBJECT(&uVar0, "LOCKER_OPEN_QUICK_MASTER"));
			fParam2 = GET_CURRENT_GAME_TIME();
		}
		DECOR_SET_FLOAT(&iParam0, Function_84(), &fParam2);
		fVar1 = GET_BLIP_ON_OBJECT(&uVar0);
		if (IS_BLIP_VALID(&fVar1))
		{
			REMOVE_BLIP(&fVar1);
		}
		fVar1 = GET_BLIP_ON_OBJECT(&iParam0);
		if (IS_BLIP_VALID(&fVar1))
		{
			REMOVE_BLIP(&fVar1);
		}
...
var Function_84() //Position: 0x3839 / 14393
{
	return "nResetTime";
}

int Function_85(int iParam0) //Position: 0x384B / 14411
{
	return Function_86(DECOR_GET_INT(&iParam0, Function_91()));
}

int Function_86(int iParam0) //Position: 0x385D / 14429
{
	return Function_87(iParam0, Function_89() + 2, 2);
}

int Function_87(int iParam0, int iParam1, int iParam2) //Position: 0x386E / 14446
{
	int iVar0;
...
var Function_88(bool bParam0) //Position: 0x388D / 14477
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_89() //Position: 0x3899 / 14489
{
	return Function_90(6);
}

int Function_90(int iParam0) //Position: 0x38A3 / 14499
{
	int iVar0;
...
var Function_91() //Position: 0x38D1 / 14545
{
	return "PackedMetadata";
}

var Function_92() //Position: 0x38E8 / 14568
{
	if (!IS_OBJECTSET_VALID(&Global_131394))
	{
		Global_131394 = CREATE_OBJECTSET_IN_LAYOUT("gMP_OpenedPickupSet", Function_93(), 12, 1);
	}
	return &Global_131394;
}

var Function_93() //Position: 0x3923 / 14627
{
...
void Function_94(var uParam0) //Position: 0x3955 / 14677
{
	struct<5> Var0;
	int iVar17;
	...
	iVar17 = Function_95(GRINGO_GET_MY_OBJECT_REF());
	if (IS_LAYOUTREF_VALID(&iVar17))
	{
		strcpy(&Var0 + 72, GET_LAYOUT_NAME(&iVar17), 32);
	}
	else
	{
		strcpy(&Var0 + 72, Function_39(), 32);
	}
	NET_SCRIPTMSG_SEND(2, 18, &Var0, 34, 1);
	NET_SCRIPTMSG_SEND(3, 18, &Var0, 34, 1);
	return;
}

int Function_95(int iParam0) //Position: 0x39B7 / 14775
{
	int iVar0;
...
int Function_96(int iParam0) //Position: 0x3A1E / 14878
{
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		SET_PLAYER_DEADEYE_POINTS(0, 100.0f, 0);
		CLEAR_STAT_MESSAGE();
		SET_STAT_MESSAGE(STRING_TO_HASH("pickup_deadeye_header"), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, false, 0, 0);
	}
	return 1;
}

int Function_97(int iParam0) //Position: 0x3A6C / 14956
{
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		SET_ACTOR_HEALTH(&iParam0, GET_ACTOR_MAX_HEALTH(&iParam0));
		CLEAR_STAT_MESSAGE();
		SET_STAT_MESSAGE(STRING_TO_HASH("pickup_health_header"), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, false, 0, 0);
	}
	return 1;
}

int Function_98(var uParam0, int iParam1) //Position: 0x3ABD / 15037
{
	int iVar0;
	int iVar1;
	struct<5> Var2;
	...
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		if (DECOR_GET_INT_VERBOSE(&iParam1, Function_102(), &iVar1))
		{
			...
			bVar3 = !ACTOR_HAS_WEAPON(&uParam0, Var2);
			if (bVar3)
			{
			}
			bVar4 = GET_AMMO_ENUM(Var2);
			if (Function_99(bVar4, 1))
			{
				bVar5 = TO_FLOAT(StackVal);
				if (bVar5 < 0.0f)
				{
					if (!bVar3)
					{
						CLEAR_STAT_MESSAGE();
						SET_STAT_MESSAGE(STRING_TO_HASH(GET_WEAPON_DISPLAY_NAME(Var2)), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, false, 0, 0);
					}
					_ADD_AMMO_OF_TYPE(&uParam0, bVar4, bVar5, 1, 0);
				}
			}
			if (bVar3)
			{
...
bool Function_99(bool bParam0, int iParam1) //Position: 0x3B68 / 15208
{
	return !(bParam0 != 4294967295 || (iParam1 && bParam0 != 0));
}

void Function_100(int iParam0, struct<5> Param1) //Position: 0x3B7C / 15228
{
	Param1 = Function_87(iParam0, Function_101(), 0);
	Param1.f_4 = Function_87(iParam0, Function_101() + 8, Function_101());
	return;
}

int Function_101() //Position: 0x3BA1 / 15265
{
	return Function_90(39);
}

var Function_102() //Position: 0x3BAC / 15276
{
	return "PackedWeapon";
}

int Function_103() //Position: 0x3BC1 / 15297
{
	return Global_124175.f_32;
}

void Function_104(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3BCD / 15309
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_105(int iParam0) //Position: 0x3C58 / 15448
{
	char* cVar0[16];
...
bool Function_106() //Position: 0x3C97 / 15511
{
...
var Function_107() //Position: 0x3CB2 / 15538
{
...
int Function_108(int iParam0) //Position: 0x3CC7 / 15559
{
	return Function_109(Global_131807.f_1304, iParam0);
}

int Function_109(var uParam0, int iParam1) //Position: 0x3CD9 / 15577
{
	return (uParam0 && iParam1) == 0;
}

int Function_110(var uParam0, var uParam1, bool bParam2, int iParam3) //Position: 0x3CE6 / 15590
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		while (iVar1 <= 17)
		{
			...
			{
				bVar3 = iVar1;
				_ADD_AMMO_OF_TYPE(&uParam0, bVar3, TO_FLOAT(Function_113(&Global_131396 + 520, bVar3)), 1, 0);
				iVar0 = 1;
			}
			iVar1++;
		}
			...
			case 0x00000002:
				...
				while (bVar2 <= 40)
				{
					if (Global_132883[bVar2])
					{
						...
						if (Function_99(bVar3, 1))
						{
							bVar24 = (Function_113(&Global_131396 + 520, bVar3) - CEIL(_GET_AMMO_AMOUNT(&uParam0, bVar3, 1)));
							if (bVar24 >= 0)
							{
								_ADD_AMMO_OF_TYPE(&uParam0, bVar3, TO_FLOAT(bVar24), 1, 0);
							}
...
bool Function_111(bool bParam0) //Position: 0x3FDA / 16346
{
...
bool Function_112(int iParam0) //Position: 0x4000 / 16384
{
...
int Function_113(int iParam0, bool bParam1) //Position: 0x4012 / 16402
{
...
bool Function_114() //Position: 0x402D / 16429
{
	return 0;
}

bool Function_115(int iParam0) //Position: 0x4034 / 16436
{
	return Function_116(&Global_124175, iParam0);
}

int Function_116(struct<73> Param0) //Position: 0x4043 / 16451
{
	return Function_69(Param0.f_72, uParam1);
}

int Function_117() //Position: 0x4053 / 16467
{
	return Function_85(GRINGO_GET_MY_OBJECT_REF());
}

bool Function_118(int iParam0) //Position: 0x405F / 16479
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_119(int iParam0) //Position: 0x4079 / 16505
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_120(int iParam0, var uParam1) //Position: 0x4094 / 16532
{
	bool bVar0;
	int iVar1;
	
	iParam0 = &iParam0;
	iVar1 = Function_121(&uParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_121(var uParam0, int iParam1) //Position: 0x40D2 / 16594
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_122(struct<65> Param0) //Position: 0x40EB / 16619
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0))
	{
		...
		if (!Function_126(&uVar1, &Param0 + 16))
		{
		...
		if (!Function_69(Param0.f_64, 2))
		{
			...
			if (Function_69(Param0.f_64, 1))
			{
				Function_79("MIDACTION REQUEST", &uVar1);
			}
			else
			{
				...
				if (!Function_124(&uVar1, &Param0 + 16))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar30 = Function_123(&Param0 + 16);
				if (!bVar30 != 0.0f)
				{
					if (bVar30 < 0.0f)
					{
...
int Function_123(int iParam0) //Position: 0x43E3 / 17379
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_124(var uParam0, int iParam1) //Position: 0x4401 / 17409
{
	struct<5> Var0;
	float fVar5;
...
int Function_125(int iParam0) //Position: 0x44A1 / 17569
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_126(bool bParam0, int iParam1) //Position: 0x44C1 / 17601
{
	iParam1 = &iParam1;
	bParam0 = &bParam0;
	...
	{
		if (Function_115(262144) || DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "DLC_AA_award"))
		{
...
bool Function_127(int iParam0) //Position: 0x4514 / 17684
{
...
void Function_128(int iParam0) //Position: 0x4530 / 17712
{
	iParam0 = &iParam0;
	return;
}

void Function_129(var uParam0, int iParam1) //Position: 0x453C / 17724
{
	int iVar0;
	var uVar1;
	...
	{
		Function_130(&(vLocal_15[iLocal_359]), &uParam0);
		iLocal_35++;
	}
...
void Function_130(int iParam0, int iParam1) //Position: 0x45A8 / 17832
{
	(&iParam0 + 16) = &iParam1;
...
void Function_131(int iParam0) //Position: 0x45C0 / 17856
{
	iParam0 = &iParam0;
	return;
}

void Function_132(int iParam0) //Position: 0x45CC / 17868
{
