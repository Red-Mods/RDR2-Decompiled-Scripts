...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46866[0], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_25(Global_46866[0], 0);
				(&Local_35 + 232) = Function_25(Global_46866[0], 0);
				Function_24(&Local_35 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_35 + 68)[iVar0] = iLocal_4 * 10;
					Function_23(Global_46866[0], iVar0, 0);
					*(&Local_35 + 128[iVar02]) = Function_23(Global_46866[0], iVar0, 0);
					iVar0++;
				}
				if (Function_35())
				{
				...
				*(&Local_35 + 268) = Function_22(Global_46866[0]);
				Function_21(Global_46866[0]);
				*(&Local_35 + 280) = Function_21(Global_46866[0]);
