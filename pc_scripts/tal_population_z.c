...
void main() //Position: 0x0 / 0
{
	...
	uVar12 = FIND_NAMED_LAYOUT("TallTrees_layout");
	if (IS_LAYOUTREF_VALID(&uVar12))
	{
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "talv_flk_CENTER_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar14 = Function_3(&uVar13, &bVar0, 4E-05f, 0, 0, 1);
			...
			uVar15 = Function_3(&uVar13, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar16 = Function_3(&uVar13, &bVar5, 1E-05f, 0, 0, 1);
			...
			uVar17 = Function_3(&uVar13, &bVar6, 1E-05f, 0, 0, 1);
			...
			uVar18 = Function_3(&uVar13, &bVar7, 1E-05f, 0, 0, 1);
			...
			uVar19 = Function_3(&uVar13, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar20 = Function_3(&uVar13, &bVar3, 1E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(&uVar13, &bVar4, 1E-05f, 0, 0, 1);
			...
			Function_3(&uVar13, &(Global_46972[7]), 2E-05f, 0, 0, 1);
			Function_3(&uVar13, &bVar1, 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hgn_pop: Cannot find talv_flk_ALL_set to create population volumes");
		}
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "talv_flk_NORTH_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar22 = Function_3(&uVar13, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(&uVar13, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar24 = Function_3(&uVar13, &bVar5, 1E-05f, 0, 0, 1);
			...
			uVar25 = Function_3(&uVar13, &bVar6, 1E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(&uVar13, &bVar7, 1E-05f, 0, 0, 1);
			...
			uVar27 = Function_3(&uVar13, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(&uVar13, &bVar3, 1E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(&uVar13, &bVar4, 1E-05f, 0, 0, 1);
		...
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "talv_flk_SOUTH_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			uVar30 = Function_3(&uVar13, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(&uVar13, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar32 = Function_3(&uVar13, &bVar5, 1E-05f, 0, 0, 1);
			...
			uVar33 = Function_3(&uVar13, &bVar6, 1E-05f, 0, 0, 1);
			...
			uVar34 = Function_3(&uVar13, &bVar7, 1E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(&uVar13, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(&uVar13, &bVar3, 1E-05f, 0, 0, 1);
			...
			uVar37 = Function_3(&uVar13, &bVar4, 1E-05f, 0, 0, 1);
...
void Function_1(var uParam0, var uParam1) //Position: 0x1245 / 4677
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1256 / 4694
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x12AE / 4782
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0x133E / 4926
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0x135A / 4954
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x139A / 5018
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x13B7 / 5047
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x13C8 / 5064
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1446 / 5190
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x14B2 / 5298
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x151E / 5406
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1565 / 5477
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1572 / 5490
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x15F4 / 5620
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x1603 / 5635
{
	if (!Function_4(128))
	{
		return;
