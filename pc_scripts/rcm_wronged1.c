...
void main() //Position: 0x0 / 0
{
	...
	iLocal_325 = 0;
	bLocal_340 = false;
	Local_341 = Vector(569,491f, 93,611f, 1181,602f);
	iLocal_348 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000006:
						if (Function_110("$/cutscene/RCM_20_CS01/RCM_20_CS01", &iLocal_326, 27994, 27966, 26679, 26565, 26309, 26272, 1, 1, 2, 2, 0))
						{
							iVar0 = 8;
						}
						break;
					...
					case 0x00000008:
						Function_109(&Global_99725[ScriptParam_043] + 228, 32);
						GIVE_OBJECT_TO_LAYOUT(&uLocal_338, &Global_46715);
						GIVE_OBJECT_TO_LAYOUT(GET_OBJECT_FROM_GRINGO(&Global_99725[7243] + 320), &uLocal_338);
						Function_109(&Global_99725[7243] + 228, 256);
						Function_107("Wronged1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Wronged1_OBJ", 0, 3, false);
						Function_106(Global_99725[ScriptParam_043].f_224, 0);
						Function_104(406, 1, 0, 0);
						Function_4(72, 1, 1, 0);
						ACTOR_DATA_GRAVITY_LIMIT(0);
						Function_109(&Global_99725[ScriptParam_043] + 228, 128);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22B / 555
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x25D / 605
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x27A / 634
{
	RELEASE_LAYOUT_REF(&iLocal_344);
	return;
}

void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x287 / 647
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x81F / 2079
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_6() //Position: 0x9C0 / 2496
{
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0x9C6 / 2502
{
	if (Global_6624)
	{
		return;
...
void Function_8(bool bParam0) //Position: 0xA05 / 2565
{
...
void Function_9() //Position: 0xA5A / 2650
{
	Function_37();
	Function_36();
	Function_36();
...
void Function_10() //Position: 0xAA5 / 2725
{
...
void Function_11() //Position: 0xBAB / 2987
{
	float fVar0;
...
void Function_12() //Position: 0xBDE / 3038
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0xD71 / 3441
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0xF2A / 3882
{
	Function_15(&Global_42918, 1, 0);
	return;
}

void Function_15(struct<2317> Param0) //Position: 0xF38 / 3896
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_16() //Position: 0x1155 / 4437
{
...
struct<8> Function_17(int iParam0) //Position: 0x116A / 4458
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_18(int iParam0, bool bParam1, bool bParam2) //Position: 0x1211 / 4625
{
	int iVar0;
...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x14AD / 5293
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_20() //Position: 0x1AEB / 6891
{
	int iVar0;
...
var Function_21(int iParam0) //Position: 0x1AF4 / 6900
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_22(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1B05 / 6917
{
	char* cVar0[32];
...
struct<32> Function_23(char* cParam0) //Position: 0x1BFC / 7164
{
	char* cVar0[32];
...
void Function_24(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1C17 / 7191
{
	float fVar0;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1C7E / 7294
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_26(int iParam0, bool bParam1) //Position: 0x1C90 / 7312
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_27(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1CA2 / 7330
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_28(int iParam0) //Position: 0x1DD6 / 7638
{
	return Global_55480[iParam016].f_96;
}

float Function_29(int iParam0) //Position: 0x1DE5 / 7653
{
	if (!iParam0 != 4294967295)
	{
...
var Function_30(int iParam0) //Position: 0x1E1E / 7710
{
	if (iParam0 == 4294967295)
	{
...
void Function_31(int iParam0) //Position: 0x1E5B / 7771
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_32(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FF5 / 8181
{
	int iVar0;
	int iVar1;
...
int Function_33(bool bParam0) //Position: 0x2239 / 8761
{
...
struct<8> Function_34() //Position: 0x227A / 8826
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x2303 / 8963
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x239A / 9114
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_37() //Position: 0x2419 / 9241
{
...
int Function_38(int iParam0, bool bParam1, int iParam2) //Position: 0x2456 / 9302
{
	int iVar0;
	int iVar1;
...
void Function_39() //Position: 0x2662 / 9826
{
	struct<2> Var0;
	var uVar2;
...
bool Function_40(char* cParam0) //Position: 0x2719 / 10009
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_41(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2731 / 10033
{
	int iVar0;
...
struct<8> Function_42() //Position: 0x2829 / 10281
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_43(int iParam0) //Position: 0x2833 / 10291
{
...
int Function_44(bool bParam0, bool bParam1) //Position: 0x2849 / 10313
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_45(struct<2> Param0, struct<2> Param2) //Position: 0x2915 / 10517
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_46(float fParam0, int iParam1) //Position: 0x2932 / 10546
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_47(int iParam0) //Position: 0x315E / 12638
{
	var uVar0;
...
bool Function_48(var uParam0, int iParam1) //Position: 0x3199 / 12697
{
	return (uParam0 && iParam1) == 0;
}

void Function_49(var uParam0, int iParam1) //Position: 0x31A6 / 12710
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x31B5 / 12725
{
	uParam0 = &uParam0;
...
void Function_51(bool bParam0) //Position: 0x3264 / 12900
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_52(struct<229> Param0) //Position: 0x341E / 13342
{
	float fVar0;
	int iVar1;
...
void Function_53(struct<217> Param0) //Position: 0x34EE / 13550
{
	float fVar0;
	var uVar1;
...
int Function_54(var uParam0, int iParam1) //Position: 0x35AC / 13740
{
	int iVar0;
	var uVar1;
...
void Function_55(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3716 / 14102
{
	struct<8> Var0;
...
struct<32> Function_56(char* cParam0) //Position: 0x37BE / 14270
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_57(char* cParam0) //Position: 0x382A / 14378
{
	char* cVar0[32];
...
int Function_58(int iParam0) //Position: 0x384C / 14412
{
	int iVar0;
	struct<2> Var1;
...
float Function_59(int iParam0, struct<2> Param1) //Position: 0x39BA / 14778
{
	struct<2> Var0;
...
struct<8> Function_60(int iParam0) //Position: 0x3A31 / 14897
{
	struct<2> Var0;
...
void Function_61(int iParam0) //Position: 0x3A9D / 15005
{
...
bool Function_62(int iParam0) //Position: 0x3B05 / 15109
{
...
void Function_63(struct<153> Param0) //Position: 0x3B1B / 15131
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_64(int iParam0) //Position: 0x3C8A / 15498
{
...
var Function_65(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3CB6 / 15542
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_66(int iParam0) //Position: 0x3CD7 / 15575
{
...
bool Function_67(struct<249> Param0) //Position: 0x3CEC / 15596
{
...
bool Function_68(struct<265> Param0) //Position: 0x3E1C / 15900
{
	int iVar0;
...
bool Function_69(int iParam0) //Position: 0x3F7D / 16253
{
...
bool Function_70(int iParam0) //Position: 0x3FA1 / 16289
{
...
var Function_72(int iParam0) //Position: 0x3FCD / 16333
{
...
bool Function_73(int iParam0) //Position: 0x3FE7 / 16359
{
...
bool Function_75(var uParam0, int iParam1) //Position: 0x4010 / 16400
{
	int iVar0;
...
bool Function_76(struct<237> Param0) //Position: 0x402D / 16429
{
	if (!Param0.f_236)
	{
		if (Function_103())
...
bool Function_78(int iParam0) //Position: 0x4157 / 16727
{
	int iVar0;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x4173 / 16755
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x4190 / 16784
{
...
bool Function_81(int iParam0) //Position: 0x41A5 / 16805
{
...
int Function_82(int iParam0) //Position: 0x41BA / 16826
{
...
void Function_83() //Position: 0x41CF / 16847
{
...
int Function_84(int iParam0, int iParam1) //Position: 0x424F / 16975
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_85(int iParam0, bool bParam1) //Position: 0x4EB2 / 20146
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x4EF0 / 20208
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0) //Position: 0x4F3F / 20287
{
...
int Function_88(int iParam0) //Position: 0x4F55 / 20309
{
...
void Function_89() //Position: 0x4FBE / 20414
{
...
bool Function_90(int iParam0) //Position: 0x4FE3 / 20451
{
	if (!Function_87(iParam0))
	{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x5034 / 20532
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x5061 / 20577
{
	if (!Function_87(iParam0))
	{
...
void Function_93(bool bParam0) //Position: 0x50B3 / 20659
{
	int iVar0;
...
void Function_94() //Position: 0x50ED / 20717
{
	bool bVar0;
...
void Function_95(int iParam0, int iParam1) //Position: 0x514B / 20811
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_96(int iParam0) //Position: 0x5161 / 20833
{
	PRINTSTRING("Day ");
...
void Function_97(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x51AB / 20907
{
	bool bVar0;
	char* cVar1[16];
...
void Function_98(char* cParam0) //Position: 0x5220 / 21024
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_99(int iParam0, var uParam1, int iParam2) //Position: 0x525A / 21082
{
	var uVar0;
	char* cVar1[16];
...
int Function_100(char* cParam0) //Position: 0x52D6 / 21206
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_101(int iParam0) //Position: 0x5377 / 21367
{
	int iVar0;
	int iVar1;
...
bool Function_102(int iParam0, int iParam1) //Position: 0x53B4 / 21428
{
...
bool Function_103() //Position: 0x53C7 / 21447
{
...
int Function_104(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x53E2 / 21474
{
	int iVar0;
	int iVar1;
...
void Function_105(int iParam0) //Position: 0x560A / 22026
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_106(bool bParam0, bool bParam1) //Position: 0x56A8 / 22184
{
	bool bVar0;
...
void Function_107(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x56CD / 22221
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_108(int iParam0) //Position: 0x5762 / 22370
{
	char* cVar0[16];
...
void Function_109(var uParam0, bool bParam1) //Position: 0x57A1 / 22433
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_110(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x57B2 / 22450
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_111(var uParam0, int iParam1, struct<41> Param2) //Position: 0x586B / 22635
{
	if (!&bParam15)
	{
...
void Function_112(var uParam0, bool bParam1) //Position: 0x5ECD / 24269
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_113() //Position: 0x5F9C / 24476
{
	int iVar0;
...
void Function_114() //Position: 0x6014 / 24596
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_115() //Position: 0x6059 / 24665
{
...
void Function_116(var uParam0, int iParam1) //Position: 0x606B / 24683
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_117(int iParam0) //Position: 0x60FD / 24829
{
	bool bVar0;
...
float Function_118(vector3 vParam0) //Position: 0x612E / 24878
{
...
bool Function_119(int iParam0) //Position: 0x61FB / 25083
{
	return Function_48(iParam0, 2);
}

bool Function_120(int iParam0) //Position: 0x6209 / 25097
{
	return Function_48(iParam0, 1);
}

int Function_121(bool bParam0) //Position: 0x6217 / 25111
{
	bool bVar0;
	var uVar1;
...
bool Function_122() //Position: 0x62DA / 25306
{
	bool bVar0;
	var uVar1;
...
void Function_123(int iParam0) //Position: 0x6317 / 25367
{
	Function_124(&iParam0, 0.0f);
	return;
}

void Function_124(vector3 vParam0) //Position: 0x6324 / 25380
{
...
bool Function_125(struct<37> Param0) //Position: 0x6349 / 25417
{
	return Param0.f_36;
}

void Function_126(var uParam0, int iParam1) //Position: 0x6354 / 25428
{
	Function_127(&uParam0, &iParam1, 0);
	return;
}

void Function_127(var uParam0, bool bParam1, bool bParam2) //Position: 0x6364 / 25444
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x64DC / 25820
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x6506 / 25862
{
	var uVar0;
	var uVar1;
...
void Function_130() //Position: 0x6561 / 25953
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_131() //Position: 0x66A0 / 26272
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(559,294f, 96,352f, 1185,255f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x66C5 / 26309
{
...
void Function_133(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x66E1 / 26337
{
	var uVar0;
...
void Function_134() //Position: 0x67B0 / 26544
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x67C5 / 26565
{
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[7243] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[7243] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(559,478f, 94,577f, 1189,348f), 356,329f, 1, 1, true);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_136() //Position: 0x6837 / 26679
{
	if (!iLocal_348)
	{
		Function_137(StackVal, Local_341, &uLocal_346);
		iLocal_348 = 1;
	}
	return 1;
}

void Function_137(vector3 vParam0) //Position: 0x6855 / 26709
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_138(int iParam0, int iParam1) //Position: 0x69FE / 27134
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_139(float fParam0, float fParam1) //Position: 0x6AF3 / 27379
{
...
void Function_140() //Position: 0x6C04 / 27652
{
...
void Function_141() //Position: 0x6C38 / 27704
{
...
int Function_142() //Position: 0x6D3E / 27966
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(559,294f, 96,352f, 1185,255f), 0, 0);
	return 1;
}

int Function_143() //Position: 0x6D5A / 27994
{
	uLocal_346 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_344, "tempcutscenevol", 2, *(&Global_99725[7243] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(5.0f, 8.0f, 5.0f));
	Function_146(0, 0, 1, 1, 0, 1, 1, &uLocal_346, 1, 1, 1, 1, 0x3f800000, 0);
	Function_144(StackVal, &iLocal_344, *(&Global_99725[7243] + 196), &uLocal_346, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_144(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x6DCB / 28107
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_145(var uParam0, float fParam1) //Position: 0x706B / 28779
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_146(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x70ED / 28909
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_149(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_20(), 2, Function_149(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_147(int iParam0) //Position: 0x739F / 29599
{
	int iVar0;
...
var Function_148() //Position: 0x73D3 / 29651
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_149(int iParam0) //Position: 0x7461 / 29793
{
	struct<2> Var0;
...
int Function_150(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7473 / 29811
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_151(struct<257> Param0) //Position: 0x75FE / 30206
{
...
int Function_152(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x763A / 30266
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_153() //Position: 0x78A2 / 30882
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_154(char* cParam0) //Position: 0x78F6 / 30966
{
	char* cVar0[64];
...
bool Function_155(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7A1F / 31263
{
...
int Function_156() //Position: 0x7AAB / 31403
{
	if (IS_PS3())
	{
		return 1;
...
void Function_157() //Position: 0x7ABA / 31418
{
	var uVar0;
...
void Function_158(int iParam0, int iParam1) //Position: 0x7AE3 / 31459
{
	switch (&iParam1)
	{
		case 0x00000000:
