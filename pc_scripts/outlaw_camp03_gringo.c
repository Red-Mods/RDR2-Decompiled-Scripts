...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(0, &iLocal_25, &iLocal_27, &uLocal_3, &uLocal_29, 4294967295);
	return;
}
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_33 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_148(&Param0 + 324, &fLocal_35, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_137(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_35, 20.0f, fLocal_35));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_137(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
...
{
	Function_145(&uLocal_3, 243, 3, 0);
	Function_145(&uLocal_3, 244, 3, 0);
	Function_101(&uLocal_3, "stand_wringhands", 5, 0);
	Function_101(&uLocal_3, "custom/stand_wringhands", 8, 0);
	Function_101(&uLocal_3, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	if (Function_82(&iLocal_25, &uLocal_3, 20, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_80(&uLocal_31, "outlaw03mobile", &iParam1))
		{
			iLocal_27 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_31, Function_137()));
			*(&Global_6667[2028] + 216) = &iLocal_27;
...
void Function_72() //Position: 0x3B13 / 15123
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
	...
	uLocal_29 = CREATE_LAYOUT("outlaw03campfirelayout");
	Var0 = Vector(175,211f, 74,677f, 2223,336f);
	TELEPORT_ACTOR(&iLocal_25, &Var0, 1, 1, 1);
	Function_77(StackVal, &iLocal_25, Vector(177,913f, 74,65f, 2223,634f));
	TASK_STAND_STILL(&iLocal_25, -1.0f, 0, 0);
	Function_76(&iLocal_25);
	uVar2 = CREATE_GRINGO_IN_LAYOUT(&uLocal_29, "outlaw03_rowdydrink", "stand_drunk_rowdydrink", Var0, Function_76(&iLocal_25));
	SNAP_OBJECT_TO_GROUND(&uVar2, 2.0f, false, 1092616192);
	SNAP_ACTOR_TO_GRINGO(&iLocal_25, &uVar2, "UseCAse1", true, 0, 0);
	TASK_USE_GRINGO(&iLocal_25, GET_GRINGO_FROM_OBJECT(&uVar2), "UseCase1", 4294967295, 1);
	Function_74(&iLocal_25, &iLocal_27, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_29, "outlaw03nun02", 243, Vector(177,913f, 74,65f, 2223,634f), Vector(0.0f, 0.0f, 0.0f));
	Function_73(&uVar3, &iLocal_25);
	TASK_STAND_STILL(&uVar3, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(&uVar3, "stand_wringhands", 0);
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_STAND_STILL(false, 1.0f, 0, 0);
	TASK_ACTION_PERFORM(false, "stand_wringhands");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uVar3, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	Function_74(&uVar3, &iLocal_27, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_29, "outlaw03nun03", 244, Vector(177,69f, 74,6434f, 2224,117f), Vector(0.0f, 0.0f, 0.0f));
	Function_73(&uVar3, &iLocal_25);
	TASK_STAND_STILL(&uVar3, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(&uVar3, "stand_wringhands", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar3, "stand_wringhands");
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_ACTION_PERFORM(false, "stand_wringhands");
	TASK_STAND_STILL(false, 1.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
...
void Function_73(var uParam0, int iParam1) //Position: 0x3D50 / 15696
{
	struct<2> Var0;
...
void Function_74(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3D6C / 15724
{
	bool bVar0;
	int iVar1;
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x3F29 / 16169
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
struct<8> Function_76(int iParam0) //Position: 0x3F71 / 16241
{
	struct<2> Var0;
...
void Function_77(var uParam0, struct<2> Param1) //Position: 0x3F9A / 16282
{
...
var Function_78(var uParam0, struct<2> Param1) //Position: 0x3FD5 / 16341
{
	struct<2> Var0;
...
struct<8> Function_79(int iParam0) //Position: 0x4069 / 16489
{
	struct<2> Var0;
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x407B / 16507
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x40AB / 16555
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x40F6 / 16630
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x42D5 / 17109
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x4815 / 18453
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_85(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4837 / 18487
{
	var uVar0;
...
var Function_86(bool bParam0, int iParam1) //Position: 0x4898 / 18584
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x4926 / 18726
{
	Function_89(&uParam0);
	Function_88(&uParam0);
...
void Function_88(int iParam0) //Position: 0x4952 / 18770
{
...
void Function_89(int iParam0) //Position: 0x4978 / 18808
{
...
bool Function_90(bool bParam0) //Position: 0x4A4E / 19022
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x4A65 / 19045
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4B0B / 19211
{
	var uVar0;
	var uVar1;
...
void Function_93(var uParam0) //Position: 0x4C1A / 19482
{
	int iVar0;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x4C4D / 19533
{
	int iVar0;
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4C6A / 19562
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_96() //Position: 0x4CF6 / 19702
{
	var uVar0;
	int iVar1;
...
bool Function_97(int iParam0) //Position: 0x4D66 / 19814
{
...
bool Function_98(int iParam0) //Position: 0x4D82 / 19842
{
...
var Function_99(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4D98 / 19864
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(struct<205> Param0) //Position: 0x4E3E / 20030
{
	var uVar0;
	var uVar1;
...
var Function_101(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4F49 / 20297
{
	int iVar0;
	int iVar1;
...
void Function_102(struct<13> Param0) //Position: 0x4F87 / 20359
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_103(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4F9A / 20378
{
	int iVar0;
...
bool Function_104(struct<2>[] Param0) //Position: 0x5069 / 20585
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x542B / 21547
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x546B / 21611
{
	int iVar0;
...
void Function_107() //Position: 0x5499 / 21657
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(vector3 vParam0) //Position: 0x54DB / 21723
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5573 / 21875
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x55A2 / 21922
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x55FD / 22013
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x560D / 22029
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5621 / 22049
{
	int iVar0;
...
var Function_114() //Position: 0x5646 / 22086
{
	return "PackedMetadata";
}

void Function_115(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x565D / 22109
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_116() //Position: 0x5799 / 22425
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_117() //Position: 0x57AB / 22443
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_118() //Position: 0x57BD / 22461
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_119(var uParam0, struct<5> Param1) //Position: 0x57CF / 22479
{
...
var Function_120(var uParam0, int iParam1, int iParam2) //Position: 0x57F4 / 22516
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x5813 / 22547
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_122() //Position: 0x581F / 22559
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x582A / 22570
{
	int iVar0;
...
var Function_124() //Position: 0x5858 / 22616
{
	return "PackedWeapon";
}

int Function_125(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x586D / 22637
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_126() //Position: 0x597A / 22906
{
	return "MPItemGiver";
}

struct<32> Function_127(char* cParam0) //Position: 0x598E / 22926
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0) //Position: 0x59FA / 23034
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5A1C / 23068
{
	return "PBox_";
}

var Function_130() //Position: 0x5A2A / 23082
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5A50 / 23120
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x5A78 / 23160
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5A9E / 23198
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5C08 / 23560
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x5CB0 / 23728
{
	int iVar0;
	struct<2> Var1;
...
void Function_136(int iParam0) //Position: 0x5E1E / 24094
{
...
var Function_137() //Position: 0x5E86 / 24198
{
	int iVar0;
...
var Function_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5E8F / 24207
{
	return Function_139(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_139(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5EAD / 24237
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x61A6 / 24998
{
	int iVar0;
...
void Function_141() //Position: 0x625A / 25178
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x6295 / 25237
{
	int iVar0;
...
void Function_143(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x62C2 / 25282
{
	bool bVar0;
...
void Function_144() //Position: 0x641D / 25629
{
	int iVar0;
...
var Function_145(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6469 / 25705
{
	int iVar0;
...
int Function_146() //Position: 0x6545 / 25925
{
	int iVar0;
...
int Function_147() //Position: 0x66A1 / 26273
{
	int iVar0;
...
bool Function_148(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x67C1 / 26561
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_149(struct<2> Param0) //Position: 0x689D / 26781
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_150(struct<2> Param0, struct<5> Param2) //Position: 0x68BC / 26812
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_151(int iParam0) //Position: 0x69FF / 27135
{
	var uVar0;
...
bool Function_152(int iParam0) //Position: 0x6A21 / 27169
{
	int iVar0;
...
int Function_153() //Position: 0x6A3D / 27197
{
	return 0;
}

void Function_154(struct<321> Param0) //Position: 0x6A44 / 27204
{
	var uVar0;
