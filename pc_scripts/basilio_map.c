		...
		if (IS_GRINGO_COMPONENT_VALID(&uVar0) && iLocal_4)
		{
			if (DECOR_CHECK_EXIST(&iParam1, "NewspaperStart"))
			{
				if (!iLocal_7)
				{
					...
					ENABLE_USE_CONTEXTS(1);
					SHOW_NEWSPAPER(201, &uLocal_5, 1, 1);
					iLocal_7 = 1;
				}
			}
...
void Function_52(var uParam0, int iParam1) //Position: 0x2CAF / 11439
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_53(var uParam0, var uParam1, int iParam2) //Position: 0x2D77 / 11639
{
	int iVar0;
	int iVar1;
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2DF5 / 11765
{
	...
	if (((Function_60(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
	{
		iLocal_4 = 0;
	}
	if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(&Global_54076)))
	{
		if (!IS_PLAYER_IN_COMBAT_WITHIN(0, 15.0f))
		{
			...
			else if (Function_59(6))
			{
				uLocal_5 = "Aztec_02";
				iParam2 = 1;
			}
			else if (Function_59(5))
			{
				uLocal_5 = "Aztec_03";
				iParam2 = 1;
			}
			else if (Function_59(4))
			{
				uLocal_5 = "Aztec_01";
				iParam2 = 1;
			}
...
void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F78 / 12152
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x3003 / 12291
{
	char* cVar0[16];
...
bool Function_59(int iParam0) //Position: 0x3042 / 12354
{
...
int Function_60(int iParam0, bool bParam1, bool bParam2) //Position: 0x3057 / 12375
{
...
bool Function_61() //Position: 0x311B / 12571
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_62(int iParam0) //Position: 0x3132 / 12594
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_63(int iParam0) //Position: 0x313E / 12606
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_64(int iParam0) //Position: 0x314D / 12621
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_65(int iParam0, int iParam1) //Position: 0x3168 / 12648
{
	var uVar0;
	var uVar1;
