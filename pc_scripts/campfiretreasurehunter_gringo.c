...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar1 + 360) = 2;
	if (bVar0)
	{
		Function_116(&iVar1, "", "$/tune/refGroups/battleSets/treasureHunter01");
	}
...
void Function_1(struct<473> Param0) //Position: 0xCA / 202
{
	int iVar0;
...
void Function_2() //Position: 0x278 / 632
{
	return;
}
...
void Function_4() //Position: 0x287 / 647
{
...
void Function_5(int iParam0) //Position: 0x29A / 666
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x2C2 / 706
{
...
void Function_7(struct<13> Param0) //Position: 0x40D / 1037
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x42A / 1066
{
	int iVar0;
...
var Function_9(struct<477> Param0) //Position: 0x448 / 1096
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_16 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_18, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_18, 20.0f, fLocal_18));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_19, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_10(struct<62> Param0) //Position: 0x1607 / 5639
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1619 / 5657
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1852 / 6226
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1872 / 6258
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x1960 / 6496
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1BCC / 7116
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1BF0 / 7152
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C14 / 7188
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1C3A / 7226
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1C61 / 7265
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1C85 / 7301
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1CA4 / 7332
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1CF3 / 7411
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1D4F / 7503
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1D70 / 7536
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1DCB / 7627
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E17 / 7703
{
...
void Function_27(struct<425> Param0) //Position: 0x1E2C / 7724
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1F7F / 8063
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x1FF4 / 8180
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x2060 / 8288
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x2078 / 8312
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x20D6 / 8406
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2123 / 8483
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x219C / 8604
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x21EB / 8683
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x23B4 / 9140
{
...
void Function_37(int iParam0) //Position: 0x23F1 / 9201
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x240A / 9226
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x2417 / 9239
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x250C / 9484
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x25CB / 9675
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x25DE / 9694
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x26A5 / 9893
{
...
bool Function_44(int iParam0) //Position: 0x26C5 / 9925
{
...
bool Function_45(int iParam0) //Position: 0x26E9 / 9961
{
...
bool Function_46(int iParam0) //Position: 0x26FE / 9982
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x2715 / 10005
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x2753 / 10067
{
...
bool Function_49(int iParam0) //Position: 0x276D / 10093
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x2783 / 10115
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x27BD / 10173
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x28A2 / 10402
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2A59 / 10841
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2A7E / 10878
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2ACC / 10956
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2C23 / 11299
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2CCE / 11470
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2D74 / 11636
{
...
bool Function_59(var uParam0) //Position: 0x2DA5 / 11685
{
	var uVar0;
	
	Function_64(3, 2);
	uVar0 = &uVar0;
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/rand_idle_stand", 1, 0);
	...
	*(&iLocal_0 + 48) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "rand_idle_stand", "rand_idle_stand", Vector(1,443349f, 0.0f, -4,459836f), Vector(0.0f, -11,59386f, 0.0f));
	*(&iLocal_0 + 56) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(0,5908761f, 0.0f, -3,23271f), Vector(0.0f, 27,12187f, 0.0f));
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, int iParam1) //Position: 0x2EF6 / 12022
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x2F41 / 12097
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x2F7F / 12159
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x2F92 / 12178
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3061 / 12385
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x30AB / 12459
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x346D / 13421
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x34AD / 13485
{
	int iVar0;
...
void Function_68() //Position: 0x34DB / 13531
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x351D / 13597
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x35B5 / 13749
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x35E4 / 13796
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x363F / 13887
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x364F / 13903
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3663 / 13923
{
	int iVar0;
...
var Function_75() //Position: 0x3688 / 13960
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x369F / 13983
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x37DB / 14299
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x37ED / 14317
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x37FF / 14335
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3811 / 14353
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3836 / 14390
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3855 / 14421
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3861 / 14433
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x386C / 14444
{
	int iVar0;
...
var Function_85() //Position: 0x389A / 14490
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x38AF / 14511
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x39BC / 14780
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x39D0 / 14800
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x3A3C / 14908
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3A5E / 14942
{
	return "PBox_";
}

var Function_91() //Position: 0x3A6C / 14956
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3A92 / 14994
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3ABA / 15034
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3AE0 / 15072
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3C4A / 15434
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3CF2 / 15602
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x3E60 / 15968
{
...
var Function_98() //Position: 0x3EC8 / 16072
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3ED1 / 16081
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x3EEF / 16111
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x41E9 / 16873
{
	int iVar0;
...
void Function_102() //Position: 0x429D / 17053
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x42D8 / 17112
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4305 / 17157
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4460 / 17504
{
...
void Function_106() //Position: 0x4477 / 17527
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x44C3 / 17603
{
	int iVar0;
...
int Function_108() //Position: 0x459F / 17823
{
	int iVar0;
...
int Function_109() //Position: 0x46FB / 18171
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x481B / 18459
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x48F7 / 18679
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4916 / 18710
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x4A59 / 19033
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x4AD0 / 19152
{
	var uVar0;
...
int Function_115() //Position: 0x4AF2 / 19186
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x4AF9 / 19193
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x4B8B / 19339
{
	int iVar0;
