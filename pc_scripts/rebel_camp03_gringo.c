...
{
	if (IS_SOUND_ID_VALID(&uLocal_59))
	{
		STOP_SOUND(&uLocal_59);
	}
	RELEASE_LAYOUT_REF(&uLocal_57);
	Function_4(7, &iLocal_49, &uLocal_53, &uLocal_3, &uLocal_55, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x264 / 612
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6D6 / 1750
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x70A / 1802
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA4C / 2636
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA7F / 2687
{
...
void Function_9(int iParam0) //Position: 0xA96 / 2710
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAC2 / 2754
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xADC / 2780
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAF9 / 2809
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBBF / 3007
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD88 / 3464
{
...
void Function_15(int iParam0) //Position: 0xDC5 / 3525
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDDE / 3550
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDEB / 3563
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xEE0 / 3808
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF46 / 3910
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFA8 / 4008
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFDD / 4061
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11F6 / 4598
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x126D / 4717
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12D9 / 4825
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x1301 / 4865
{
...
void Function_26(struct<13> Param0) //Position: 0x144C / 5196
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x1469 / 5225
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x1487 / 5255
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_61 || bParam2) || Global_6611)
			{
				if (Function_149(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_147(&Param0 + 324, &fLocal_63, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_146();
								(*&Param0 + 48)[1] = Function_145();
								Function_144(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_144(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_137(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_137(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_144(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_144(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_137(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_137(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_137(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_144(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_136(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_63, 20.0f, fLocal_63));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_132(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_136(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_136(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_136(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_136(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_136()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_65 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_65) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_64, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x2646 / 9798
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2658 / 9816
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2891 / 10385
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28B1 / 10417
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x299F / 10655
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2C0B / 11275
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C2F / 11311
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C53 / 11347
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C79 / 11385
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2CA0 / 11424
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CC4 / 11460
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CE3 / 11491
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D32 / 11570
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D8E / 11662
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DAF / 11695
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2E0A / 11786
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E56 / 11862
{
...
void Function_46(struct<425> Param0) //Position: 0x2E6B / 11883
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FBE / 12222
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3033 / 12339
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x304B / 12363
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x30A9 / 12457
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30F6 / 12534
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x316F / 12655
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31BE / 12734
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x327D / 12925
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3290 / 12944
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x3357 / 13143
{
...
bool Function_57(int iParam0) //Position: 0x3377 / 13175
{
...
bool Function_58(int iParam0) //Position: 0x339B / 13211
{
...
bool Function_59(int iParam0) //Position: 0x33B0 / 13232
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33C7 / 13255
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x3405 / 13317
{
...
bool Function_62(int iParam0) //Position: 0x341F / 13343
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x3435 / 13365
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x346F / 13423
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > bParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_136(), bParam2[iVar0], Var1, Var3);
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3554 / 13652
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_136(), bParam3, Var2, Var4);
...
void Function_66(var uParam0, bool bParam1) //Position: 0x370B / 14091
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3730 / 14128
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x377E / 14206
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38D5 / 14549
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3980 / 14720
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A26 / 14886
{
	Function_144(&uLocal_3, 522, 3, 0);
	Function_144(&uLocal_3, 523, 3, 0);
	Function_144(&uLocal_3, 521, 3, 0);
	Function_144(&uLocal_3, 529, 3, 0);
	Function_144(&uLocal_3, 517, 3, 0);
	Function_144(&uLocal_3, 518, 3, 0);
	Function_144(&uLocal_3, 752, 3, 0);
	Function_144(&uLocal_3, 754, 3, 0);
	Function_100(&uLocal_3, "talking_stand", 5, 0);
	Function_100(&uLocal_3, "custom/talking_stand", 8, 0);
	Function_100(&uLocal_3, "$/content/scripting/gringo/SimpleGringo/chair_sit_attach", 1, 0);
	if (Function_81(&iLocal_49, &uLocal_3, 37, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_79(&uLocal_57, "rebel03mobile", &iParam1))
		{
			uLocal_53 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_57, Function_136()));
			*(&Global_6667[3728] + 216) = &uLocal_53;
			*(&iParam0 + 24) = &uLocal_57;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3B59 / 15193
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uLocal_55 = CREATE_LAYOUT("rebel03campfirelayout");
	SQUAD_JOIN(CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "firstshoteasy03", 518, Vector(-1480.0f, 16,54457f, 3942,181f), Vector(0.0f, -76,53144f, 0.0f)), &uLocal_53);
	SQUAD_JOIN(CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "firstshotmed02", 522, Vector(-1480,891f, 16,54457f, 3941,262f), Vector(0.0f, -86,91844f, 0.0f)), &uLocal_53);
	SQUAD_JOIN(CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshothard01", 529, Vector(-1460,563f, 16,54457f, 3950,775f), Vector(-1,17371f, 41,55438f, -3,895562f)), &uLocal_53);
	SQUAD_JOIN(CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshotsoldier05", 752, Vector(-1462,415f, 16,59668f, 3955,745f), Vector(0.0f, -247,8012f, 0.0f)), &uLocal_53);
	uLocal_51 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshotsoldeir06", 754, Vector(-1464,207f, 16,648f, 3953,991f), Vector(0.0f, -403,3448f, 0.0f));
	SQUAD_JOIN(&uLocal_51, &uLocal_53);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "rebel03sitgringo01", "chair_sit_attach", Vector(-1461,943f, 16,6077f, 3953,896f), Vector(0.0f, 296,1798f, 0.0f));
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshotmed01", 521, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&uVar1, &uVar0, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uVar1, GET_GRINGO_FROM_OBJECT(&uVar0), "UseCase1", 4294967295, 1);
	SQUAD_JOIN(&uVar1, &uLocal_53);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "rebel03sitgringo02", "chair_sit_attach", Vector(-1461,07f, 16,68762f, 3956,153f), Vector(0.0f, 202,6879f, 0.0f));
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshotmed02", 522, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&uVar1, &uVar0, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uVar1, GET_GRINGO_FROM_OBJECT(&uVar0), "UseCase1", 4294967295, 1);
	SQUAD_JOIN(&uVar1, &uLocal_53);
	uVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_55, "secondshoteasy03", 518, Vector(-1462,584f, 16,57063f, 3957,635f), Vector(0.0f, 292,9579f, 0.0f));
	SQUAD_JOIN(&uVar1, &uLocal_53);
	SQUAD_GOAL_ADD_GENERAL_TASK(&uLocal_53, false, 2, 4294967295);
	TASK_STAND_STILL(false, -1.0f, 0, 0);
	uVar2 = Vector(-1463,7f, 16,54457f, 3956,287f);
	TELEPORT_ACTOR(&iLocal_49, &uVar2, 1, 1, 1);
	TASK_STAND_STILL(&iLocal_49, -1.0f, 0, 0);
	Function_75(&iLocal_49, &uLocal_51);
	Function_75(&uLocal_51, &iLocal_49);
	RESET_ANIM_SET_FOR_ACTOR(&iLocal_49, 1);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_51, 1);
	SET_ANIM_SET_FOR_ACTOR(&iLocal_49, "talking_stand", 0);
	SET_ANIM_SET_FOR_ACTOR(&uLocal_51, "talking_stand", 0);
	Function_73(&iLocal_49, &uLocal_53, 1, 1);
	...
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&iLocal_49, bVar4, 4294967295);
	...
	TASK_ACTION_PERFORM(false, "talking_stand/Talk_A");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(&uLocal_51, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	uLocal_59 = GET_SOUND_ID();
	PLAY_WALLA_SOUND_FROM_POSITION_PERSISTENT(&uLocal_59, "CROWD_MEXICAN_OUTDOOR_LITE_MASTER", *(&Global_6667[3728] + 88));
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3FC9 / 16329
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x4189 / 16777
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_75(var uParam0, int iParam1) //Position: 0x41D1 / 16849
{
	struct<2> Var0;
	
	GET_OBJECT_POSITION(GET_OBJECT_FROM_ACTOR(&iParam1), &Var0);
	Function_76(StackVal, &uParam0, Var0);
	return;
}

void Function_76(var uParam0, struct<2> Param1) //Position: 0x41ED / 16877
{
	if (!IS_ACTOR_VALID(GET_MOUNT(&uParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_77(&uParam0, &uParam0, Param1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_77(GET_MOUNT(&uParam0), &uParam0, Param1), 1);
	}
	return;
}

var Function_77(var uParam0, struct<2> Param1) //Position: 0x4228 / 16936
{
	struct<2> Var0;
	
	Function_78(&uParam0);
	Var0 = Vector(StackVal, StackVal, StackVal) - Vector(Function_78(&uParam0), Param1, StackVal);
	VNORMALIZE(&Var0);
...
struct<8> Function_78(int iParam0) //Position: 0x42A9 / 17065
{
	struct<2> Var0;
...
bool Function_79(var uParam0, var uParam1, int iParam2) //Position: 0x42BB / 17083
{
	...
	Function_80(&uParam0, &iParam2);
	return 1;
	return 0;
}

void Function_80(var uParam0, bool bParam1) //Position: 0x42EB / 17131
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_136(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_81(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4336 / 17206
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_99(&(Global_6667[iParam228])) && uParam4)
	{
		return 0;
	}
	if (&bParam7)
	{
		uVar0 = Function_98(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
	...
	if (StackVal || !Function_94((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam228].f_5614] + 16, &Global_6667[iParam228] + 88, 3212836864) || !&bParam5), &Global_54076, *(&Global_6667[iParam228] + 88), 50.0f))
	{
		iVar1 = Function_98(StackVal, *(&Global_6667[iParam228] + 88), 0, 1, 1);
...
var Function_82(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4515 / 17685
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	{
		if (!Function_93(&(Global_43791[Global_46722[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(&(Global_15402[iParam014])))
...
void Function_83(var uParam0, bool bParam1) //Position: 0x4A55 / 19029
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_84(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4A77 / 19063
{
	var uVar0;
...
var Function_85(bool bParam0, int iParam1) //Position: 0x4AD8 / 19160
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_86(var uParam0, int iParam1) //Position: 0x4B66 / 19302
{
	Function_88(&uParam0);
	Function_87(&uParam0);
...
void Function_87(int iParam0) //Position: 0x4B92 / 19346
{
...
void Function_88(int iParam0) //Position: 0x4BB8 / 19384
{
...
bool Function_89(bool bParam0) //Position: 0x4C8E / 19598
{
...
var Function_90(int iParam0, int iParam1) //Position: 0x4CA5 / 19621
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_91(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D4B / 19787
{
	var uVar0;
	var uVar1;
...
void Function_92(var uParam0) //Position: 0x4E5A / 20058
{
	int iVar0;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x4E8D / 20109
{
	int iVar0;
...
bool Function_94(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4EAA / 20138
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_95() //Position: 0x4F36 / 20278
{
	var uVar0;
	int iVar1;
...
bool Function_96(int iParam0) //Position: 0x4FA6 / 20390
{
	if (!Function_97(iParam0))
	{
		return 1;
	}
	return Function_93(&(Global_43791[iParam0]), 4);
}

bool Function_97(int iParam0) //Position: 0x4FC2 / 20418
{
...
var Function_98(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4FD8 / 20440
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_99(struct<205> Param0) //Position: 0x507E / 20606
{
	var uVar0;
	var uVar1;
...
var Function_100(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5189 / 20873
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_102(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_101(struct<13> Param0) //Position: 0x51C7 / 20935
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_102(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x51DA / 20954
{
	int iVar0;
...
bool Function_103(struct<2>[] Param0) //Position: 0x52A9 / 21161
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x566B / 22123
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x56AB / 22187
{
	int iVar0;
...
void Function_106() //Position: 0x56D9 / 22233
{
	if (!Function_151(128))
	{
		return;
...
void Function_107(vector3 vParam0) //Position: 0x571B / 22299
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_108(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_108(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_108(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x57B3 / 22451
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_109(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_109(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x57E2 / 22498
{
	Function_124(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_114(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_113(), Function_112(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_111(), Function_110(&uParam11, &uParam12));
}

var Function_110(var uParam0, bool bParam1) //Position: 0x583D / 22589
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_111() //Position: 0x584D / 22605
{
	return "PackedGrass";
}

var Function_112(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5861 / 22625
{
	int iVar0;
...
var Function_113() //Position: 0x5886 / 22662
{
	return "PackedMetadata";
}

void Function_114(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x589D / 22685
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_123(), &uVar4))
				{
					Function_118(uVar4, &bVar5);
...
struct<8> Function_115() //Position: 0x59D9 / 23001
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_116() //Position: 0x59EB / 23019
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_117() //Position: 0x59FD / 23037
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_118(var uParam0, struct<5> Param1) //Position: 0x5A0F / 23055
{
	Param1 = Function_119(uParam0, Function_121(), 0);
	Param1.f_4 = Function_119(uParam0, Function_121() + 8, Function_121());
	return;
}

var Function_119(var uParam0, int iParam1, int iParam2) //Position: 0x5A34 / 23092
{
	int iVar0;
...
var Function_120(bool bParam0) //Position: 0x5A53 / 23123
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_121() //Position: 0x5A5F / 23135
{
	return Function_122(39);
}

int Function_122(int iParam0) //Position: 0x5A6A / 23146
{
	int iVar0;
...
var Function_123() //Position: 0x5A98 / 23192
{
	return "PackedWeapon";
}

int Function_124(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5AAD / 23213
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_128(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_126(Function_128()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_125(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_125() //Position: 0x5BBA / 23482
{
	return "MPItemGiver";
}

struct<32> Function_126(char* cParam0) //Position: 0x5BCE / 23502
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_127(char* cParam0) //Position: 0x5C3A / 23610
{
	char* cVar0[32];
...
var Function_128() //Position: 0x5C5C / 23644
{
	return "PBox_";
}

var Function_129() //Position: 0x5C6A / 23658
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_130() //Position: 0x5C90 / 23696
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_131() //Position: 0x5CB8 / 23736
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_132(var uParam0, int iParam1) //Position: 0x5CDE / 23774
{
	int iVar0;
	var uVar1;
...
void Function_133(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5E48 / 24136
{
	struct<8> Var0;
...
int Function_134(bool bParam0) //Position: 0x5EF0 / 24304
{
	int iVar0;
	struct<2> Var1;
...
void Function_135(int iParam0) //Position: 0x605E / 24670
{
...
var Function_136() //Position: 0x60C6 / 24774
{
	int iVar0;
...
var Function_137(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x60CF / 24783
{
	return Function_138(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x60ED / 24813
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_89(bVar1))
	{
		...
		{
			Function_142(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_139(int iParam0) //Position: 0x63E6 / 25574
{
	int iVar0;
...
void Function_140() //Position: 0x649A / 25754
{
	int iVar0;
...
bool Function_141(bool bParam0) //Position: 0x64D5 / 25813
{
	int iVar0;
...
void Function_142(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6502 / 25858
{
	bool bVar0;
...
void Function_143() //Position: 0x665D / 26205
{
	int iVar0;
...
var Function_144(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x66A9 / 26281
{
	int iVar0;
...
int Function_145() //Position: 0x6785 / 26501
{
	int iVar0;
...
int Function_146() //Position: 0x68E1 / 26849
{
	int iVar0;
...
bool Function_147(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6A01 / 27137
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_148(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_148(struct<2> Param0) //Position: 0x6ADD / 27357
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_149(struct<2> Param0, struct<5> Param2) //Position: 0x6AFC / 27388
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_150(int iParam0) //Position: 0x6C3F / 27711
{
	var uVar0;
...
bool Function_151(int iParam0) //Position: 0x6C61 / 27745
{
	int iVar0;
...
int Function_152() //Position: 0x6C7D / 27773
{
	return 0;
}

void Function_153(struct<321> Param0) //Position: 0x6C84 / 27780
{
	var uVar0;
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_102(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_102(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
