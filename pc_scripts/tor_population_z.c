...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("Torquemada_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "torv_region_set");
...
void Function_1(var uParam0, var uParam1) //Position: 0xC72 / 3186
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC83 / 3203
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0xCDB / 3291
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD6D / 3437
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xD89 / 3465
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDC9 / 3529
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDE6 / 3558
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDF7 / 3575
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE3E / 3646
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE4B / 3659
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xECD / 3789
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xEDC / 3804
{
	if (!Function_4(128))
	{
		return;
