...
void main() //Position: 0x0 / 0
{
	...
	iLocal_114 = 0;
	Function_99(&uScriptParam_0, &iLocal_114);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(vLocal_4[iVar39]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_4[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", &vLocal_4[iVar39] + 24);
							Function_84(&vLocal_4[iVar39] + 24, 1);
							...
							{
								Function_77(&(vLocal_4[iVar39]), 0);
							}
							else if (vLocal_4[iVar39].f_68 < 8)
							{
								Function_76(&(vLocal_4[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_123))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_123);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_114 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_123))
								{
									...
									{
										iLocal_123 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_123 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_123))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_123))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_123);
		}
...
void Function_83(var uParam0, var uParam1) //Position: 0x36F0 / 14064
{
	int iVar0;
	...
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
		iVar0 = DECOR_GET_OBJECT(GRINGO_GET_MY_OBJECT_REF(), "GringoTarg");
		DECOR_REMOVE(&iVar0, &iLocal_0);
	}
	return;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x372B / 14123
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x383B / 14395
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3853 / 14419
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, var uParam1) //Position: 0x3B6F / 15215
{
	var uVar0;
	...
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
		uVar0 = DECOR_GET_OBJECT(GRINGO_GET_MY_OBJECT_REF(), "GringoTarg");
		if (!DECOR_CHECK_EXIST(&uVar0, "Animal_CurrentlyEating1"))
		{
			DECOR_SET_OBJECT(&uVar0, "Animal_CurrentlyEating1", &uParam0);
			iLocal_0 = "Animal_CurrentlyEating1";
		}
		else if (!DECOR_CHECK_EXIST(&uVar0, "Animal_CurrentlyEating2"))
		{
			DECOR_SET_OBJECT(&uVar0, "Animal_CurrentlyEating2", &uParam0);
			iLocal_0 = "Animal_CurrentlyEating2";
		}
		else if (!DECOR_CHECK_EXIST(&uVar0, "Animal_CurrentlyEating3"))
		{
			DECOR_SET_OBJECT(&uVar0, "Animal_CurrentlyEating3", &uParam0);
			iLocal_0 = "Animal_CurrentlyEating3";
		}
		else if (!DECOR_CHECK_EXIST(&uVar0, "Animal_CurrentlyEating4"))
		{
			DECOR_SET_OBJECT(&uVar0, "Animal_CurrentlyEating4", &uParam0);
			iLocal_0 = "Animal_CurrentlyEating4";
		}
	}
	return;
}

bool Function_88(int iParam0) //Position: 0x3D37 / 15671
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3D51 / 15697
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3D6C / 15724
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3DAA / 15786
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3DC3 / 15811
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x40BD / 16573
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x40DB / 16603
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x417B / 16763
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x419B / 16795
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x41AE / 16814
{
...
void Function_98(int iParam0) //Position: 0x41CA / 16842
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x41D6 / 16854
{
	int iVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_4[iLocal_1149]), &uParam0);
		iLocal_114++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x4242 / 16962
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x425A / 16986
{
	iParam0 = &iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x4266 / 16998
{
