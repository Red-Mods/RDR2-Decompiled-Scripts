...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uParam1 = &uParam1;
	if (!Function_44(Global_99130.f_40, 1))
	{
		Function_38(&Global_99130 + 40, 1);
	}
	if (!Function_58(Global_119934, 4096))
	{
		Function_57(&Global_119934, 4096);
	}
	if (!Function_58(Global_119934, 8192))
	{
		Function_57(&Global_119934, 8192);
	}
	iLocal_4 = 0;
	iParam2 = 1;
	return;
...
void Function_57(var uParam0, int iParam1) //Position: 0x2D54 / 11604
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_58(var uParam0, int iParam1) //Position: 0x2D65 / 11621
{
...
bool Function_60(int iParam0, int iParam1) //Position: 0x2D93 / 11667
{
	var uVar0;
	var uVar1;
