				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								Function_148(&(Global_99725[2843]), 28, 0x41f00000, 0x42200000, 0);
								iVar0 = 1;
							}
							else
							{
					...
					case 0x00000001:
						...
						{
							Function_147(&Global_99725[ScriptParam_043] + 228, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_145();
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							break;
						}
						bLocal_348 = Function_144(StackVal, *(&Global_99725[ScriptParam_043] + 196), 0x3f800000, 0x42960000, 1, 1, 0);
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (bLocal_348)
							{
								if (StackVal && FABS((StackVal - !Function_140(&Global_54076, 1, 1))) > 2.0f)
								{
									if (Function_136(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0))
									{
					...
					case 0x00000003:
						if (Function_104("$/cutscene/false_ending_intro_cs/false_ending_intro_cs", "$/cutscene/false_ending_cs/false_ending_cs", &iLocal_336, &uLocal_353, uLocal_365, 26606, 26599, 26592, 26599, 26585, 26599, 26527, 26267, 26260, 0, 2, 1, 1, 2))
						{
							Function_103(1.0f);
							iVar0 = 5;
						}
					...
					case 0x00000005:
						...
						{
							Function_147(&Global_99725[2843] + 228, 256);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "False1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x369 / 873
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x901 / 2305
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xAA2 / 2722
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xAA8 / 2728
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xAE7 / 2791
{
...
void Function_6() //Position: 0xB3C / 2876
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_7() //Position: 0xB87 / 2951
{
...
void Function_8() //Position: 0xC8D / 3213
{
	float fVar0;
...
void Function_9() //Position: 0xCC0 / 3264
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0xE53 / 3667
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x100C / 4108
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x101A / 4122
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x1237 / 4663
{
...
struct<8> Function_14(int iParam0) //Position: 0x124C / 4684
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x12F3 / 4851
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x158F / 5519
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_17() //Position: 0x1BCD / 7117
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x1BD6 / 7126
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1BE7 / 7143
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x1CDE / 7390
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1CF9 / 7417
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x1D60 / 7520
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x1D72 / 7538
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1D84 / 7556
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x1EB8 / 7864
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x1EC7 / 7879
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x1F00 / 7936
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x1F3D / 7997
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x20D7 / 8407
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x231B / 8987
{
...
struct<8> Function_31() //Position: 0x235C / 9052
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x23E5 / 9189
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x247C / 9340
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x24FB / 9467
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x2538 / 9528
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2744 / 10052
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x27FB / 10235
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2813 / 10259
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x290B / 10507
{
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x29F7 / 10743
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x2A14 / 10772
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x3240 / 12864
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x327B / 12923
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x3288 / 12936
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3297 / 12951
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x3346 / 13126
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_45(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_147(&Global_99725[iVar143] + 228, 64);
...
void Function_49(struct<229> Param0) //Position: 0x3500 / 13568
{
	float fVar0;
	int iVar1;
...
void Function_50(struct<217> Param0) //Position: 0x35D0 / 13776
{
	float fVar0;
	var uVar1;
...
int Function_51(var uParam0, int iParam1) //Position: 0x368E / 13966
{
	int iVar0;
	var uVar1;
...
void Function_52(int iParam0, var uParam1, struct<2> Param2) //Position: 0x37F8 / 14328
{
	struct<8> Var0;
...
struct<32> Function_53(char* cParam0) //Position: 0x38A0 / 14496
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_54(char* cParam0) //Position: 0x390C / 14604
{
	char* cVar0[32];
...
int Function_55(int iParam0) //Position: 0x392E / 14638
{
	int iVar0;
	struct<2> Var1;
...
float Function_56(int iParam0, struct<2> Param1) //Position: 0x3A9C / 15004
{
	struct<2> Var0;
...
struct<8> Function_57(int iParam0) //Position: 0x3B13 / 15123
{
	struct<2> Var0;
...
void Function_58(int iParam0) //Position: 0x3B7F / 15231
{
...
bool Function_59(int iParam0) //Position: 0x3BE7 / 15335
{
...
void Function_60(struct<153> Param0) //Position: 0x3BFD / 15357
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if (((StackVal && Function_144(Function_62(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_61(iParam1)) || Global_116927[iParam16].f_20 != 1)
	{
...
int Function_61(int iParam0) //Position: 0x3D6C / 15724
{
...
bool Function_62(int iParam0) //Position: 0x3D98 / 15768
{
...
bool Function_63(struct<249> Param0) //Position: 0x3DAD / 15789
{
	...
	{
		Function_147(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
...
bool Function_64(struct<265> Param0) //Position: 0x3EDD / 16093
{
	int iVar0;
...
bool Function_65(int iParam0) //Position: 0x403F / 16447
{
...
bool Function_66(int iParam0) //Position: 0x4063 / 16483
{
...
bool Function_67(int iParam0) //Position: 0x4078 / 16504
{
...
var Function_68(int iParam0) //Position: 0x408F / 16527
{
...
bool Function_69(int iParam0) //Position: 0x40A9 / 16553
{
...
bool Function_70(int iParam0) //Position: 0x40BF / 16575
{
	return Global_116927[iParam06].f_16;
}

bool Function_71(var uParam0, int iParam1) //Position: 0x40CF / 16591
{
	int iVar0;
...
bool Function_72(struct<237> Param0) //Position: 0x40EC / 16620
{
	if (!Param0.f_236)
	{
		if (Function_99())
...
bool Function_73(int iParam0) //Position: 0x41BB / 16827
{
...
bool Function_74(int iParam0) //Position: 0x4216 / 16918
{
	int iVar0;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x4232 / 16946
{
	int iVar0;
...
int Function_76(int iParam0) //Position: 0x424F / 16975
{
...
bool Function_77(int iParam0) //Position: 0x4264 / 16996
{
...
int Function_78(int iParam0) //Position: 0x4279 / 17017
{
...
void Function_79() //Position: 0x428E / 17038
{
...
int Function_80(int iParam0, int iParam1) //Position: 0x430E / 17166
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_81(int iParam0, bool bParam1) //Position: 0x4F71 / 20337
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x4FAF / 20399
{
	int iVar0;
	int iVar1;
...
bool Function_83(int iParam0) //Position: 0x4FFE / 20478
{
...
int Function_84(int iParam0) //Position: 0x5014 / 20500
{
...
void Function_85() //Position: 0x507D / 20605
{
...
bool Function_86(int iParam0) //Position: 0x50A2 / 20642
{
	if (!Function_83(iParam0))
	{
...
bool Function_87(int iParam0, int iParam1) //Position: 0x50F3 / 20723
{
	int iVar0;
...
bool Function_88(int iParam0) //Position: 0x5120 / 20768
{
	if (!Function_83(iParam0))
	{
...
void Function_89(int iParam0) //Position: 0x5172 / 20850
{
	int iVar0;
...
void Function_90() //Position: 0x51AC / 20908
{
	bool bVar0;
...
void Function_91(int iParam0, int iParam1) //Position: 0x520A / 21002
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_92(int iParam0) //Position: 0x5220 / 21024
{
	PRINTSTRING("Day ");
...
void Function_93(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x526A / 21098
{
	bool bVar0;
	char* cVar1[16];
...
void Function_94(char* cParam0) //Position: 0x52DF / 21215
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_95(int iParam0, var uParam1, int iParam2) //Position: 0x5319 / 21273
{
	var uVar0;
	char* cVar1[16];
...
int Function_96(char* cParam0) //Position: 0x5395 / 21397
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_97(int iParam0) //Position: 0x5436 / 21558
{
	int iVar0;
	int iVar1;
...
bool Function_98(int iParam0, int iParam1) //Position: 0x5473 / 21619
{
...
bool Function_99() //Position: 0x5486 / 21638
{
...
void Function_100(char* cParam0, bool bParam1) //Position: 0x54A1 / 21665
{
	bool bVar0;
...
void Function_101(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x54C6 / 21702
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_102(int iParam0) //Position: 0x555B / 21851
{
	char* cVar0[16];
...
void Function_103(bool bParam0) //Position: 0x559A / 21914
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_104(var uParam0, var uParam1, int iParam2, struct<41> Param3) //Position: 0x55B7 / 21943
{
	struct<2> Var0;
	struct<2> Var2;
	
	Function_116(&iParam2, &uParam14);
	switch (iParam2)
	{
		case 0x000003E8:
			if (iParam4 != 99 && (Function_115(&Param3) || Param3.f_40 < 1))
			{
				iParam2 = 1106;
				return 0;
			}
			...
			if (CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				Function_113(&iParam2 + 4);
				iParam2 = 1002;
			}
			else if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
			{
				if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_112())
				{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_109(&iParam2 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_109(&iParam2 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && iParam4 == 99) && !Function_115(&Param3))
			{
...
void Function_105(var uParam0, bool bParam1) //Position: 0x5F1B / 24347
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_106() //Position: 0x5FEA / 24554
{
	int iVar0;
...
void Function_107() //Position: 0x6062 / 24674
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_108() //Position: 0x60A7 / 24743
{
...
float Function_109(vector3 vParam0) //Position: 0x60B9 / 24761
{
...
bool Function_110(int iParam0) //Position: 0x6186 / 24966
{
	return Function_45(iParam0, 2);
}

bool Function_111(var uParam0) //Position: 0x6194 / 24980
{
	return Function_45(uParam0, 1);
}

bool Function_112() //Position: 0x61A2 / 24994
{
	bool bVar0;
	var uVar1;
...
void Function_113(int iParam0) //Position: 0x61DF / 25055
{
	Function_114(&iParam0, 0.0f);
	return;
}

void Function_114(vector3 vParam0) //Position: 0x61EC / 25068
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_147(&vParam0, 1);
	Function_91(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

bool Function_115(struct<37> Param0) //Position: 0x6211 / 25105
{
	return Param0.f_36;
}

void Function_116(var uParam0, int iParam1) //Position: 0x621C / 25116
{
	Function_117(&uParam0, &iParam1, 0);
	return;
}

void Function_117(var uParam0, bool bParam1, int iParam2) //Position: 0x622C / 25132
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_118(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x63A4 / 25508
{
	int iVar0;
	int iVar1;
...
void Function_119(bool bParam0) //Position: 0x65CC / 26060
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_120(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x666A / 26218
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_121() //Position: 0x6694 / 26260
{
	return 1;
}

int Function_122() //Position: 0x669B / 26267
{
	Function_123(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_351);
	Function_103(1.0f);
	return 1;
}

void Function_123(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x66BB / 26299
{
	var uVar0;
...
void Function_124() //Position: 0x678A / 26506
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_125() //Position: 0x679F / 26527
{
...
int Function_126() //Position: 0x67D9 / 26585
{
	return 1;
}

int Function_127() //Position: 0x67E0 / 26592
{
	return 1;
}

int Function_128() //Position: 0x67E7 / 26599
{
	return 1;
}

int Function_129() //Position: 0x67EE / 26606
{
	uLocal_351 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "tempcutscenevol", 2, (&Global_99725[2843] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(5.0f, 5.0f, 5.0f));
	Function_132(0, 0, 1, 1, 0, 1, 1, &uLocal_351, 1, 1, 1, 1, 0x3f800000, 0);
	Function_130(StackVal, &uLocal_349, *(&Global_99725[2843] + 196), &uLocal_351, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_130(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x685B / 26715
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_131(var uParam0, float fParam1) //Position: 0x6AFB / 27387
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_132(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x6B7D / 27517
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_135(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_17(), 2, Function_135(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_134()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_133(int iParam0) //Position: 0x6E2F / 28207
{
	int iVar0;
...
var Function_134() //Position: 0x6E63 / 28259
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_135(bool bParam0) //Position: 0x6EF1 / 28401
{
	struct<2> Var0;
...
bool Function_136(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x6F03 / 28419
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_139(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_138(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_137(vector3 vParam0) //Position: 0x7138 / 28984
{
	var uVar0;
...
float Function_138(var uParam0, bool bParam1) //Position: 0x71AE / 29102
{
	struct<2> Var0;
...
void Function_139(var uParam0, bool bParam1) //Position: 0x71CF / 29135
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_138(&uParam0, 0) < 2.0f)
	{
...
bool Function_140(int iParam0, bool bParam1, bool bParam2) //Position: 0x7239 / 29241
{
...
bool Function_141() //Position: 0x72FD / 29437
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_142(int iParam0) //Position: 0x7314 / 29460
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_143(int iParam0) //Position: 0x7320 / 29472
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

int Function_144(struct<2> Param0, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x732F / 29487
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &iParam2, &iParam3, &iParam4, &iParam5, &iParam6);
}

void Function_145() //Position: 0x7350 / 29520
{
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
...
int Function_146(bool bParam0, bool bParam1, bool bParam2) //Position: 0x736E / 29550
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_147(var uParam0, int iParam1) //Position: 0x73A0 / 29600
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_148(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x73B1 / 29617
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_150(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_149(&iParam0));
							}
						}
						...
						uVar6 = Function_150(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_149(struct<257> Param0) //Position: 0x753C / 30012
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_149(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_150(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7578 / 30072
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_153(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_154()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_153(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_154()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_153(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_151() //Position: 0x77E0 / 30688
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_152(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_152(char* cParam0) //Position: 0x7834 / 30772
{
	char* cVar0[64];
...
bool Function_153(var uParam0, struct<2> Param1, float fParam3) //Position: 0x795D / 31069
{
...
int Function_154() //Position: 0x79E9 / 31209
{
	if (IS_PS3())
	{
		return 1;
