...
void main() //Position: 0x0 / 0
{
	...
	iLocal_116 = 0;
	Function_100(&uScriptParam_0, &iLocal_116);
...
{
	iParam0 = &iParam0;
	if (!iLocal_3 && iLocal_2)
	{
		iLocal_3 = 1;
		if (Global_6623 && DECOR_CHECK_EXIST(&Global_54076, "Grave03_DoorLocked"))
		{
			DECOR_REMOVE(&Global_54076, "Grave03_DoorLocked");
		}
		else if (Global_6623 && DECOR_CHECK_EXIST(&Global_54076, "Ranch04_DoorLocked"))
		{
			DECOR_REMOVE(&Global_54076, "Ranch04_DoorLocked");
		}
		else
		{
			uLocal_0 = CREATE_LAYOUT("Door_Locked_Layout");
			Function_63(&uLocal_0, 0, 1, 0, 0);
		}
	}
	return;
}

var Function_63(var uParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x296F / 10607
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "DoorLocked", 1, 1);
	}
	Function_64(&uVar0);
...
void Function_64(var uParam0) //Position: 0x29F3 / 10739
{
	var uVar0;
	int iVar1;
...
void Function_65(int iParam0) //Position: 0x2A2F / 10799
{
	...
	SET_CAMERASHOT_POSITION(StackVal, &iParam0, Vector(-4085,193f, 38,73898f, 2949,181f));
	SET_CAMERASHOT_ORIENTATION(StackVal, &iParam0, Vector(-0,075568f, -0,215053f, 0.0f), 1);
	RESET_CAMERASHOT_TARGET(&iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(&iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x2AA4 / 10916
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2AB0 / 10928
{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2AE6 / 10982
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2B77 / 11127
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2B9B / 11163
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2BBA / 11194
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2BDE / 11230
{
	float fVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2D06 / 11526
{
...
int Function_75(var uParam0) //Position: 0x2D34 / 11572
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2E4D / 11853
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x2E5A / 11866
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x2EDC / 11996
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3487 / 13447
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x34C1 / 13505
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x34DF / 13535
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x3520 / 13600
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x352C / 13612
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x354E / 13646
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x357F / 13695
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x368F / 13967
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x36A7 / 13991
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x39C3 / 14787
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
bool Function_89(int iParam0) //Position: 0x39E5 / 14821
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x39FF / 14847
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3A1A / 14874
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3A58 / 14936
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3A71 / 14961
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3D69 / 15721
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3D87 / 15751
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x3E27 / 15911
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(int iParam0, var uParam1) //Position: 0x3E47 / 15943
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3E5A / 15962
{
...
void Function_99(int iParam0) //Position: 0x3E76 / 15990
{
	iParam0 = &iParam0;
	return;
}

void Function_100(var uParam0, int iParam1) //Position: 0x3E82 / 16002
{
	int iVar0;
	var uVar1;
	...
	{
		Function_101(&(vLocal_6[iLocal_1169]), &uParam0);
		iLocal_116++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3EEE / 16110
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_102(int iParam0) //Position: 0x3F06 / 16134
{
	iParam0 = &iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3F12 / 16146
{
