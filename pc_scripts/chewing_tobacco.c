...
void Function_56(var uParam0, var uParam1, var uParam2) //Position: 0x2CEF / 11503
{
	bool bVar0;
	...
	if (IS_ACTOR_VALID(&uParam1) && IS_ACTOR_ALIVE(&Global_54076))
	{
		...
		Function_58(479, 1, 0, 0);
		if (Function_57())
		{
			if (HAS_ITEM(SS_GET_STRING(1, 2), &Global_54076))
			{
				bVar0 = GET_ITEM_COUNT(SS_GET_STRING(1, 2), &Global_54076);
			}
			PLAYSTAT_INT("HC_TOBACCO", bVar0);
		}
		uParam2 = 1;
	}
	return;
...
bool Function_57() //Position: 0x2D9E / 11678
{
...
int Function_58(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2DC9 / 11721
{
	int iVar0;
	int iVar1;
...
void Function_59(int iParam0) //Position: 0x2FF1 / 12273
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_60(int iParam0, bool bParam1, bool bParam2) //Position: 0x308F / 12431
{
...
bool Function_61() //Position: 0x3153 / 12627
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_62(int iParam0) //Position: 0x316A / 12650
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_63(int iParam0) //Position: 0x3176 / 12662
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_64(int iParam0) //Position: 0x3185 / 12677
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_65(int iParam0, int iParam1) //Position: 0x31A0 / 12704
{
	var uVar0;
	var uVar1;
