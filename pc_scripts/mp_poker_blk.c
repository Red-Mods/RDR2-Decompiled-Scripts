...
void Function_75() //Position: 0x1D40 / 7488
{
	...
	Function_76(4, 1);
	uVar0 = &uVar0;
	iLocal_290 = CREATE_LAYOUT("Poker_BLK_layout");
	(&iLocal_290 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_290, "PlayableSpace", 2,802597E-45f, Vector(854,8467f, 78,99314f, 1281,728f), Vector(0.0f, -33,07299f, 0.0f), Vector(4,807904f, 3,53227f, 6,156056f));
	*(&iLocal_290 + 16) = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", &iLocal_290, 8, 0);
	*(&iLocal_290 + 24[03]) = Vector(856,8768f, 77,52f, 1283,041f);
	*(&iLocal_290 + 24[03] + 12) = Vector(0.0f, 60,64319f, 0.0f);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "PlayerPosition", Vector(856,8768f, 77,52f, 1283,041f), Vector(0.0f, 60,64319f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_290 + 16);
	*(&iLocal_290 + 24[13]) = Vector(854,4354f, 77,52193f, 1284,053f);
	*(&iLocal_290 + 24[13] + 12) = Vector(0.0f, -4,489308f, 0.0f);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_0_Position", Vector(854,4354f, 77,52193f, 1284,053f), Vector(0.0f, -4,489308f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_290 + 16);
	*(&iLocal_290 + 24[23]) = Vector(857,2482f, 77,52f, 1281,733f);
	*(&iLocal_290 + 24[23] + 12) = Vector(0.0f, 444,1363f, 0.0f);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_1_Position", Vector(857,2482f, 77,52f, 1281,733f), Vector(0.0f, 444,1363f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_290 + 16);
	*(&iLocal_290 + 24[33]) = Vector(856,4229f, 77,52234f, 1280,632f);
	*(&iLocal_290 + 24[33] + 12) = Vector(0.0f, 110,3671f, 0.0f);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_2_Position", Vector(856,4229f, 77,52234f, 1280,632f), Vector(0.0f, 110,3671f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_290 + 16);
	*(&iLocal_290 + 24[43]) = Vector(853,1198f, 77,52234f, 1280,618f);
	*(&iLocal_290 + 24[43] + 12) = Vector(0.0f, 224,0751f, 0.0f);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "AI_3_Position", Vector(853,1198f, 77,52234f, 1280,618f), Vector(0.0f, 224,0751f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_290 + 16);
	*(&iLocal_290 + 152) = Vector(855,1326f, 78,3239f, 1281,816f);
	*(&iLocal_290 + 152 + 12) = Vector(0.0f, 192,4619f, 0.0f);
	*(&iLocal_290 + 176) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "TableCenter", Vector(855,1326f, 78,3239f, 1281,816f), Vector(0.0f, 192,4619f, 0.0f));
	*(&iLocal_290 + 184) = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 192[03]) = Vector(856,4048f, 77,51955f, 1286,333f);
	*(&iLocal_290 + 192[03] + 12) = Vector(0.0f, -159,0592f, 0.0f);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_0_Pos", Vector(856,4048f, 77,51955f, 1286,333f), Vector(0.0f, -159,0592f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_290 + 184);
	*(&iLocal_290 + 192[13]) = Vector(855,2977f, 77,51955f, 1286,333f);
	*(&iLocal_290 + 192[13] + 12) = Vector(0.0f, -124,4389f, 0.0f);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Waitress_1_Pos", Vector(855,2977f, 77,51955f, 1286,333f), Vector(0.0f, -124,4389f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_290 + 184);
	*(&iLocal_290 + 248) = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", &iLocal_290, 8, 0);
	*(&iLocal_290 + 256[03]) = Vector(857,9119f, 77,51955f, 1286,135f);
	*(&iLocal_290 + 256[03] + 12) = Vector(0.0f, 5,508229f, 0.0f);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_0", Vector(857,9119f, 77,51955f, 1286,135f), Vector(0.0f, 5,508229f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_290 + 248);
	*(&iLocal_290 + 256[13]) = Vector(857,5084f, 77,51955f, 1279,553f);
	*(&iLocal_290 + 256[13] + 12) = Vector(0.0f, 181,6365f, 0.0f);
	iVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_290, "Dueler_1", Vector(857,5084f, 77,51955f, 1279,553f), Vector(0.0f, 181,6365f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&iVar9, &iLocal_290 + 248);
	return;
}

void Function_76(int iParam0, int iParam1) //Position: 0x2237 / 8759
{
	switch (&iParam1)
	{
		case 0x00000000:
