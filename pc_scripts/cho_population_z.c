...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_21682, "Cho", 4);
	Function_16("Loading Cholla Springs population file", 3);
	Global_47148++;
	...
	bVar12 = Function_15("armadillo_prestream", 0);
	Function_14(&bVar12, 202, 4.0f, 0, 0);
	Function_14(&bVar12, 87, 4.0f, 0, 0);
	Function_14(&bVar12, 235, 4.0f, 0, 0);
	Function_14(&bVar12, 217, 4.0f, 0, 0);
	Function_14(&bVar12, 140, 4.0f, 0, 0);
	Function_14(&bVar12, 137, 4.0f, 0, 0);
	Function_14(&bVar12, 46, 4.0f, 0, 0);
	Function_14(&bVar12, 50, 4.0f, 0, 0);
	...
	Function_14(&bVar12, 49, 4.0f, 0, 0);
	Function_14(&bVar12, 56, 4.0f, 0, 0);
	Function_14(&bVar12, 74, 4.0f, 0, 0);
	...
	Function_14(&bVar12, 1204, 5.0f, 0, 0);
	Function_14(&bVar12, 1205, 5.0f, 0, 0);
	Function_14(&bVar12, 1206, 5.0f, 0, 0);
	Function_14(&bVar12, 1207, 5.0f, 0, 0);
	Function_14(&bVar12, 1208, 5.0f, 0, 0);
	Function_14(&bVar12, 1209, 5.0f, 0, 0);
	Function_14(&bVar12, 1210, 5.0f, 0, 0);
	Function_14(&bVar12, 1211, 5.0f, 0, 0);
	Function_14(&bVar12, 1212, 5.0f, 0, 0);
	Function_14(&bVar12, 1213, 5.0f, 0, 0);
	Function_14(&bVar12, 1214, 5.0f, 0, 0);
	Function_14(&bVar12, 1215, 5.0f, 0, 0);
	Function_14(&bVar12, 1216, 5.0f, 0, 0);
	Function_14(&bVar12, 1217, 5.0f, 0, 0);
	Function_14(&bVar12, 1218, 5.0f, 0, 0);
	Function_14(&bVar12, 1219, 5.0f, 0, 0);
	Function_14(&bVar12, 1220, 5.0f, 0, 0);
	Var13 = Vector(-2148,719f, 16,323f, 2602,377f);
	...
	uVar15 = FIND_NAMED_LAYOUT("ChollaSprings_layout");
	if (IS_LAYOUTREF_VALID(&uVar15))
	{
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_narrowZombie_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar17 = Function_4(&uVar16, &bVar0, 100, 0, 0, 1);
			SET_ZONE_POPULATION_SPAWN_MULTI_PER_POINT(&uVar17, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_RepulsionExclusion_set to create population volumes");
		}
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_flk_CENTER_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar18 = Function_3(&uVar16, &bVar0, 4E-05f, 0, 0, 1);
			...
			uVar19 = Function_3(&uVar16, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar20 = Function_3(&uVar16, &bVar5, 5E-06f, 0, 0, 1);
			...
			uVar21 = Function_3(&uVar16, &bVar6, 1,5E-05f, 0, 0, 1);
			...
			uVar22 = Function_3(&uVar16, &bVar7, 2E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(&uVar16, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar24 = Function_3(&uVar16, &bVar9, 5E-06f, 0, 0, 1);
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_flk_SE_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar25 = Function_3(&uVar16, &bVar0, 4E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(&uVar16, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar27 = Function_3(&uVar16, &bVar5, 5E-06f, 0, 0, 1);
			...
			uVar28 = Function_3(&uVar16, &bVar6, 1,5E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(&uVar16, &bVar7, 2E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(&uVar16, &bVar9, 5E-06f, 0, 0, 1);
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_flk_NW_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar32 = Function_3(&uVar16, &bVar0, 4E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(&uVar32, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(&uVar32, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(&uVar32, 20);
			uVar33 = Function_3(&uVar16, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar34 = Function_3(&uVar16, &bVar5, 1E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(&uVar16, &bVar6, 1,5E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(&uVar16, &bVar7, 2E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(&uVar36, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(&uVar36, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(&uVar36, 6);
			uVar37 = Function_3(&uVar16, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar38 = Function_3(&uVar16, &bVar9, 1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(&uVar38, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(&uVar38, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(&uVar38, 1);
			Function_3(&uVar16, &(Global_46972[7]), 2E-05f, 0, 0, 1);
			Function_3(&uVar16, &bVar1, 3E-05f, 0, 0, 1);
		}
		else
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_Venters");
		if (IS_VOLUME_VALID(&uVar16))
		{
			Function_3(&uVar16, &bVar0, 5E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_Venters to create population volumes");
		}
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_critchly");
		if (IS_VOLUME_VALID(&uVar16))
		{
			Function_3(&uVar16, &bVar0, 5E-05f, 0, 0, 1);
		}
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "chov_rileysCharge");
		if (IS_VOLUME_VALID(&uVar16))
		{
			Function_4(&uVar16, &bVar0, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_rileysCharge to create population volumes");
		}
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "nchov_null");
		if (IS_VOLUME_VALID(&uVar16))
		{
			Function_3(&uVar16, &bVar11, 0.0f, 0, 0, 1);
		}
		else
		{
	...
	Function_6("Finished loading Cholla Springs population file", 5.0f);
	Function_1(&(Global_43791[iLocal_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0x177A / 6010
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x178B / 6027
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x17E3 / 6115
{
	var uVar0;
...
var Function_4(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1873 / 6259
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0x1903 / 6403
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0x191F / 6431
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x195F / 6495
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x197C / 6524
{
...
var Function_9(var uParam0, int iParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x198D / 6541
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0x1A0B / 6667
{
	int iVar0;
...
var Function_11(int iParam0) //Position: 0x1A77 / 6775
{
	int iVar0;
...
var Function_12(bool bParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1AE3 / 6883
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0x1B2A / 6954
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_14(bool bParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1B37 / 6967
{
	int iVar0;
	int iVar1;
...
var Function_15(var uParam0, int iParam1) //Position: 0x1BB9 / 7097
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_16(char* cParam0) //Position: 0x1BC8 / 7112
{
	if (!Function_5(128))
	{
		return;
