...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar1 + 360) = 2;
	if (bVar0)
	{
		Function_118(&iVar1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp03x");
	}
	else
	{
...
bool Function_59(var uParam0) //Position: 0x2E73 / 11891
{
	...
	*(&iLocal_0 + 8) = Vector(1,2023f, 0,008248952f, 1,803332f);
	*(&iLocal_0 + 8 + 12) = Vector(0.0f, 91,99133f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 8);
	*(&iLocal_0 + 32) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_horse_stay", Vector(1,2023f, 0,008248952f, 1,803332f), Vector(0.0f, 91,99133f, 0.0f));
	*(&iLocal_0 + 40) = Vector(0,8178751f, 0,002102481f, -1,287217f);
	*(&iLocal_0 + 40 + 12) = Vector(0.0f, 179,551f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 40);
	*(&iLocal_0 + 64) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_sit", Vector(0,8178751f, 0,002102481f, -1,287217f), Vector(0.0f, 179,551f, 0.0f));
