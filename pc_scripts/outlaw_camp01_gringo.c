...
void Function_3() //Position: 0x239 / 569
{
	...
	Function_4(0, &iLocal_29, &iLocal_31, &uLocal_3, &uLocal_33, 4294967295);
	return;
}
...
var Function_28(struct<477> Param0) //Position: 0x1478 / 5240
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			{
				if (Function_152(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_150(&Param0 + 324, &fLocal_39, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_139(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_39, 20.0f, fLocal_39));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_139(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_40, &Param0 + 488, 0, 0, 0x40400000))
						{
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A17 / 14871
{
	...
	Function_147(&uLocal_3, 586, 3, 0);
	Function_147(&uLocal_3, 584, 3, 0);
	Function_103(&uLocal_3, "talking_stand", 5, 0);
	Function_103(&uLocal_3, "custom/talking_stand", 8, 0);
	Function_103(&uLocal_3, "stand_wringhands", 5, 0);
	Function_103(&uLocal_3, "custom/stand_wringhands", 8, 0);
	if (Function_85(&iLocal_29, &uLocal_3, 18, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		uVar0[0] = Function_83(Global_46760[0], "narmadillo", "stable01", 1);
		uVar0[1] = Function_83(Global_46760[0], "narmadillo", "stable01", 2);
		uVar0[2] = Function_83(Global_46760[0], "narmadillo", "stable01", 3);
		uVar0[3] = Function_83(Global_46760[0], "narmadillo", "stable01", 4);
		if (((IS_DOOR_VALID(&(uVar0[0])) && IS_DOOR_VALID(&(uVar0[1]))) && IS_DOOR_VALID(&(uVar0[2]))) && IS_DOOR_VALID(&(uVar0[3])))
		{
			if (Function_81(&uLocal_35, "outlaw01mobile", &iParam1))
			{
				...
				OPEN_DOOR_DIRECTION(&(uVar0[2]), 1);
				Function_79(&(uVar0[3]), 1);
				OPEN_DOOR_DIRECTION(&(uVar0[3]), 1);
				iLocal_31 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_35, Function_139()));
				*(&Global_6667[1828] + 216) = &iLocal_31;
...
void Function_72() //Position: 0x3C1D / 15389
{
	var uVar0;
	var uVar1;
	var uVar3;
	...
	uLocal_33 = CREATE_LAYOUT("outlaw01campfirelayout");
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_33, "outlaw01restrictvol", 2,802597E-45f, Vector(-2167,61f, 17,43f, 2574,133f), Vector(0.0f, 0.0f, 0.0f), Vector(5.0f, 5.0f, 5.0f));
	...
	uVar1 = Vector(-2167,374f, 17,076f, 2574,237f);
	TELEPORT_ACTOR(&iLocal_29, &uVar1, 1, 1, 1);
	Function_76(StackVal, &iLocal_29, Vector(-2172,475f, 17,678f, 2573,642f));
	SET_ANIM_SET_FOR_ACTOR(&iLocal_29, "stand_wringhands", 0);
	SET_ACTION_NODE_FOR_ACTOR(&iLocal_29, "stand_wringhands");
	Function_74(&iLocal_29, &iLocal_31, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "outlaw01french", 584, Vector(-2168,497f, 16,775f, 2573,524f), Vector(0.0f, -48.0f, 155.0f));
	Function_73(&uVar3, &iLocal_29);
	SNAP_OBJECT_TO_GROUND(&uVar3, 2.0f, false, 1092616192);
	SET_ANIM_SET_FOR_ACTOR(&uVar3, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar3, "talking_stand");
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(0, &iLocal_29, 0, 3212836864);
	...
	Function_74(&uVar3, &iLocal_31, 1, 1);
	uVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_33, "outlaw01welsh", 586, Vector(-2168,341f, 16,793f, 2574,861f), Vector(0.0f, -61.0f, 155.0f));
	SNAP_OBJECT_TO_GROUND(&uVar3, 2.0f, false, 1092616192);
	Function_73(&uVar3, &iLocal_29);
	SET_ANIM_SET_FOR_ACTOR(&uVar3, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar3, "talking_stand");
...
void Function_73(var uParam0, int iParam1) //Position: 0x3EAD / 16045
{
	struct<2> Var0;
...
void Function_74(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3EC9 / 16073
{
	bool bVar0;
	int iVar1;
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x4088 / 16520
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_76(var uParam0, struct<2> Param1) //Position: 0x40D0 / 16592
{
...
var Function_77(var uParam0, struct<2> Param1) //Position: 0x410B / 16651
{
	struct<2> Var0;
...
struct<8> Function_78(int iParam0) //Position: 0x418C / 16780
{
	struct<2> Var0;
...
void Function_79(var uParam0, int iParam1) //Position: 0x419E / 16798
{
...
void Function_80(var uParam0, int iParam1) //Position: 0x41F6 / 16886
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
bool Function_81(var uParam0, var uParam1, int iParam2) //Position: 0x4251 / 16977
{
...
void Function_82(var uParam0, int iParam1) //Position: 0x4281 / 17025
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iParam1, Function_139(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_83(bool bParam0, char* cParam1, bool bParam3) //Position: 0x42CC / 17100
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_84(bool bParam0) //Position: 0x4371 / 17265
{
...
bool Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4387 / 17287
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4566 / 17766
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x4AA6 / 19110
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_88(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4AC8 / 19144
{
	var uVar0;
...
var Function_89(bool bParam0, int iParam1) //Position: 0x4B29 / 19241
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, int iParam1) //Position: 0x4BB7 / 19383
{
	Function_92(&uParam0);
	Function_91(&uParam0);
...
void Function_91(int iParam0) //Position: 0x4BE3 / 19427
{
...
void Function_92(int iParam0) //Position: 0x4C09 / 19465
{
...
bool Function_93(bool bParam0) //Position: 0x4CDF / 19679
{
...
var Function_94(int iParam0, int iParam1) //Position: 0x4CF6 / 19702
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x4D9C / 19868
{
	var uVar0;
	var uVar1;
...
void Function_96(var uParam0) //Position: 0x4EAB / 20139
{
	int iVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x4EDE / 20190
{
	int iVar0;
...
bool Function_98(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4EFB / 20219
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_99() //Position: 0x4F87 / 20359
{
	var uVar0;
	int iVar1;
...
bool Function_100(int iParam0) //Position: 0x4FF7 / 20471
{
...
var Function_101(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x5013 / 20499
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_102(struct<205> Param0) //Position: 0x50B9 / 20665
{
	var uVar0;
	var uVar1;
...
var Function_103(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x51C4 / 20932
{
	int iVar0;
	int iVar1;
...
void Function_104(struct<13> Param0) //Position: 0x5202 / 20994
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_105(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x5215 / 21013
{
	int iVar0;
...
bool Function_106(struct<2>[] Param0) //Position: 0x52E4 / 21220
{
	int iVar0;
	int iVar1;
...
void Function_107() //Position: 0x56A6 / 22182
{
	if (!Function_154(128))
	{
		return;
...
bool Function_108() //Position: 0x56E6 / 22246
{
	int iVar0;
...
void Function_109() //Position: 0x5714 / 22292
{
	if (!Function_154(128))
	{
		return;
...
void Function_110(vector3 vParam0) //Position: 0x5756 / 22358
{
	char* cVar0[32];
...
void Function_111(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x57EE / 22510
{
	var uVar0;
	var uVar1;
...
void Function_112(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x581D / 22557
{
...
var Function_113(var uParam0, bool bParam1) //Position: 0x5878 / 22648
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_114() //Position: 0x5888 / 22664
{
	return "PackedGrass";
}

var Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x589C / 22684
{
	int iVar0;
...
var Function_116() //Position: 0x58C1 / 22721
{
	return "PackedMetadata";
}

void Function_117(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x58D8 / 22744
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_118() //Position: 0x5A14 / 23060
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_119() //Position: 0x5A26 / 23078
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_120() //Position: 0x5A38 / 23096
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_121(var uParam0, struct<5> Param1) //Position: 0x5A4A / 23114
{
...
var Function_122(var uParam0, int iParam1, int iParam2) //Position: 0x5A6F / 23151
{
	int iVar0;
...
var Function_123(bool bParam0) //Position: 0x5A8E / 23182
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_124() //Position: 0x5A9A / 23194
{
	return Function_125(39);
}

int Function_125(int iParam0) //Position: 0x5AA5 / 23205
{
	int iVar0;
...
var Function_126() //Position: 0x5AD3 / 23251
{
	return "PackedWeapon";
}

int Function_127(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5AE8 / 23272
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_128() //Position: 0x5BF5 / 23541
{
	return "MPItemGiver";
}

struct<32> Function_129(char* cParam0) //Position: 0x5C09 / 23561
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_130(char* cParam0) //Position: 0x5C75 / 23669
{
	char* cVar0[32];
...
var Function_131() //Position: 0x5C97 / 23703
{
	return "PBox_";
}

var Function_132() //Position: 0x5CA5 / 23717
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_133() //Position: 0x5CCB / 23755
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_134() //Position: 0x5CF3 / 23795
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_135(var uParam0, int iParam1) //Position: 0x5D19 / 23833
{
	int iVar0;
	var uVar1;
...
void Function_136(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5E83 / 24195
{
	struct<8> Var0;
...
int Function_137(bool bParam0) //Position: 0x5F2B / 24363
{
	int iVar0;
	struct<2> Var1;
...
void Function_138(int iParam0) //Position: 0x6099 / 24729
{
...
var Function_139() //Position: 0x6101 / 24833
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x610A / 24842
{
	return Function_141(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x6128 / 24872
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_142(int iParam0) //Position: 0x6421 / 25633
{
	int iVar0;
...
void Function_143() //Position: 0x64D5 / 25813
{
	int iVar0;
...
bool Function_144(bool bParam0) //Position: 0x6510 / 25872
{
	int iVar0;
...
void Function_145(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x653D / 25917
{
	bool bVar0;
...
void Function_146() //Position: 0x6698 / 26264
{
	int iVar0;
...
var Function_147(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x66E4 / 26340
{
	int iVar0;
...
int Function_148() //Position: 0x67C0 / 26560
{
	int iVar0;
...
int Function_149() //Position: 0x691C / 26908
{
	int iVar0;
...
bool Function_150(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6A3C / 27196
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_151(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_151(struct<2> Param0) //Position: 0x6B18 / 27416
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_152(struct<2> Param0, struct<5> Param2) //Position: 0x6B37 / 27447
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_153(int iParam0) //Position: 0x6C7A / 27770
{
	var uVar0;
...
bool Function_154(int iParam0) //Position: 0x6C9C / 27804
{
	int iVar0;
...
int Function_155() //Position: 0x6CB8 / 27832
{
	return 0;
}

void Function_156(struct<321> Param0) //Position: 0x6CBF / 27839
{
	var uVar0;
