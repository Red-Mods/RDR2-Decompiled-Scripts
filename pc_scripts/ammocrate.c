...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_97(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_82(&vLocal_2[iVar39] + 24, 1);
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			iVar0 = Function_48(&Param0 + 24, &Param0 + 16, Function_73(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&iVar0))
			{
...
void Function_18(char* cParam0) //Position: 0x1E26 / 7718
{
	int iVar0;
	char* cVar1[16];
	int iVar5;
	...
	while (iVar0 < (17 - 1))
	{
		...
		if (iVar5 != 0)
		{
			...
			PRINTINT(iVar5);
			PRINTSTRING(", to ");
			PRINTSTRING(GET_OBJECT_NAME(&cParam0));
			PRINTNL();
			_ADD_AMMO_OF_TYPE(&cParam0, iVar0, TO_FLOAT(iVar5), 1, 1);
		}
		iVar0++;
	}
	return;
...
bool Function_19() //Position: 0x1ED8 / 7896
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1F0B / 7947
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1F89 / 8073
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x2005 / 8197
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x2017 / 8215
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x202E / 8238
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x203B / 8251
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, var uParam1) //Position: 0x205C / 8284
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x206F / 8303
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x208F / 8335
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x2095 / 8341
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x20A7 / 8359
{
	iParam0 = &iParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x20B4 / 8372
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(int iParam0, int iParam1) //Position: 0x20CF / 8399
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20EF / 8431
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x210F / 8463
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x2146 / 8518
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x2166 / 8550
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2181 / 8577
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x2197 / 8599
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x24BB / 9403
{
	int iVar0;
...
bool Function_40(int iParam0, int iParam1) //Position: 0x24C4 / 9412
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24E3 / 9443
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(int iParam0, int iParam1) //Position: 0x24F2 / 9458
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2516 / 9494
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x253C / 9532
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x255A / 9562
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x257C / 9596
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x259E / 9630
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x2666 / 9830
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26E2 / 9954
{
...
void Function_50(vector3 vParam0) //Position: 0x26FA / 9978
{
...
var Function_51(int iParam0) //Position: 0x271F / 10015
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x2740 / 10048
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2757 / 10071
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x2763 / 10083
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x276A / 10090
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x277B / 10107
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x27C0 / 10176
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27EC / 10220
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27F8 / 10232
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28FA / 10490
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x291D / 10525
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2945 / 10565
{
	iParam0 = &iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x2951 / 10577
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x295D / 10589
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x297C / 10620
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x2993 / 10643
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_67(int iParam0) //Position: 0x2A24 / 10788
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2A48 / 10824
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x2A67 / 10855
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x2A8B / 10891
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2BB3 / 11187
{
...
int Function_72(var uParam0) //Position: 0x2BE1 / 11233
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2CFA / 11514
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2D07 / 11527
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2D89 / 11657
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x3334 / 13108
{
	return;
}

int Function_77(int iParam0) //Position: 0x333A / 13114
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3358 / 13144
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x3399 / 13209
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x33A5 / 13221
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x33C7 / 13255
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "UseOnce"))
	{
		DECOR_SET_INT(GRINGO_GET_MY_OBJECT_REF(), "UseOnce", 1);
	}
	return;
}

void Function_82(var uParam0, bool bParam1) //Position: 0x33FE / 13310
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x350E / 13582
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x3526 / 13606
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(int iParam0, int iParam1) //Position: 0x3842 / 14402
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_86(int iParam0) //Position: 0x3854 / 14420
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x386E / 14446
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x3889 / 14473
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x38C7 / 14535
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x38E0 / 14560
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3BD8 / 15320
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3BF6 / 15350
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C96 / 15510
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, char* cParam1) //Position: 0x3CB6 / 15542
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
...
bool Function_95(int iParam0) //Position: 0x3D34 / 15668
{
...
void Function_96(int iParam0) //Position: 0x3D50 / 15696
{
	iParam0 = &iParam0;
	return;
}

void Function_97(var uParam0, int iParam1) //Position: 0x3D5C / 15708
{
	int iVar0;
	var uVar1;
	...
	{
		Function_98(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3DC8 / 15816
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_99(int iParam0) //Position: 0x3DE0 / 15840
{
	iParam0 = &iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3DEC / 15852
{
