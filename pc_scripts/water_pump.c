...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_101(&uScriptParam_0, &iLocal_112);
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_49(&Param0 + 24, &Param0 + 16, Function_76(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_29(bool bParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	...
	if (!Function_30(&uParam1, fVar0))
	{
		LOG_ERROR("SET_WATERPUMP_TIMESTAMP: Failed to set time step!");
	}
	Var1 = (Var1 + -1,1f);
	bVar3 = FIND_OBJECT_IN_OBJECT(GRINGO_GET_MY_OBJECT_REF(), "water_source");
	if (IS_OBJECT_VALID(&bVar3))
	{
	}
	else
	{
		bVar3 = GET_OBJECT_FROM_VOLUME(CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GRINGO_GET_MY_OBJECT_REF(), "water_source", 2, Var1, Vector(0.0f, 0.0f, 0.0f), Vector(1,8f, 0,6f, 0,4f)));
		TRANSFORM_OBJECT_RELATIVE(&bVar3, GRINGO_GET_TARGET(GRINGO_GET_MY_GRINGO_ID()));
	}
	return;
}

bool Function_30(var uParam0, bool bParam1) //Position: 0x20BE / 8382
{
	return SET_GRINGO_FLOAT_ATTR(cParam1, "WaterSourceCreationTimestamp", &uParam0);
}

bool Function_31(char* cParam0) //Position: 0x20EB / 8427
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x20F8 / 8440
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x2113 / 8467
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x2133 / 8499
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x2153 / 8531
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x218A / 8586
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x21AA / 8618
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x21C5 / 8645
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x21DB / 8667
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x24FF / 9471
{
	int iVar0;
...
bool Function_41(char* cParam0, int iParam1) //Position: 0x2508 / 9480
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x2527 / 9511
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2536 / 9526
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(char* cParam0, int iParam1) //Position: 0x255A / 9562
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x2580 / 9600
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x259E / 9630
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x25C0 / 9664
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(bool bParam0, int iParam1) //Position: 0x25E2 / 9698
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x26AA / 9898
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2726 / 10022
{
...
void Function_51(vector3 vParam0) //Position: 0x273E / 10046
{
...
var Function_52(int iParam0) //Position: 0x2763 / 10083
{
...
void Function_54(var uParam0) //Position: 0x279B / 10139
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x27A7 / 10151
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x27AE / 10158
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x27BF / 10175
{
	bool bVar0;
...
int Function_58(int iParam0) //Position: 0x2804 / 10244
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x2830 / 10288
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x283C / 10300
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x293E / 10558
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x2961 / 10593
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x2989 / 10633
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C70 / 11376
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2CCD / 11469
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2D2A / 11562
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2D36 / 11574
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2D55 / 11605
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2D6C / 11628
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_70(int iParam0) //Position: 0x2DFD / 11773
{
	struct<2> Var0;
...
struct<8> Function_71(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2E21 / 11809
{
	struct<2> Var0;
...
int Function_72(int iParam0) //Position: 0x2E40 / 11840
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(var uParam0, int iParam1) //Position: 0x2E64 / 11876
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_74(var uParam0, int iParam1) //Position: 0x2F8C / 12172
{
...
int Function_75(var uParam0) //Position: 0x2FBA / 12218
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x30D3 / 12499
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(struct<69> Param0) //Position: 0x30E0 / 12512
{
	if (Function_76(Param0.f_64, 16))
	{
...
void Function_78(struct<69> Param0) //Position: 0x3162 / 12642
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x370D / 14093
{
	int iVar0;
...
int Function_80(int iParam0) //Position: 0x3747 / 14151
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_81(int iParam0, var uParam1) //Position: 0x3765 / 14181
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_82(int iParam0) //Position: 0x37A6 / 14246
{
	iParam0 = &iParam0;
	return;
}

bool Function_83(int iParam0) //Position: 0x37B2 / 14258
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_84(int iParam0, int iParam1) //Position: 0x37D4 / 14292
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x37E6 / 14310
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_86(int iParam0, int iParam1) //Position: 0x38F6 / 14582
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_87(struct<69> Param0) //Position: 0x390E / 14606
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_88(int iParam0, int iParam1) //Position: 0x3C2A / 15402
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_89(int iParam0) //Position: 0x3C3C / 15420
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_90(int iParam0) //Position: 0x3C56 / 15446
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, var uParam1) //Position: 0x3C71 / 15473
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3CAF / 15535
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_93(struct<65> Param0) //Position: 0x3CC8 / 15560
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_94(int iParam0) //Position: 0x3FC0 / 16320
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_95(var uParam0, int iParam1) //Position: 0x3FDE / 16350
{
	struct<5> Var0;
	float fVar5;
...
int Function_96(int iParam0) //Position: 0x4088 / 16520
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x40A8 / 16552
{
	var uVar0;
	float fVar1;
	...
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	uVar0 = FIND_OBJECT_IN_OBJECT(GRINGO_GET_MY_OBJECT_REF(), "water_source");
	if (IS_OBJECT_VALID(&uVar0))
	{
		fVar1 = Function_98(&iParam1);
		if (fVar1 < 0.0f)
		{
...
int Function_98(int iParam0) //Position: 0x4109 / 16649
{
	return Function_11(&iParam0, "WaterSourceCreationTimestamp", -1.0f);
}

bool Function_99(int iParam0) //Position: 0x4135 / 16693
{
...
void Function_100(int iParam0) //Position: 0x4151 / 16721
{
	iParam0 = &iParam0;
	return;
}

void Function_101(var uParam0, int iParam1) //Position: 0x415D / 16733
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_102(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x41C9 / 16841
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_103(int iParam0) //Position: 0x41E1 / 16865
{
	iParam0 = &iParam0;
	return;
}

void Function_104(bool bParam0) //Position: 0x41ED / 16877
{
