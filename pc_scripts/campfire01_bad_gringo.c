...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_117(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireSmall01x");
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 0, 0, "ped_bad_guys_generic", 2,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_29 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_111(&Param0 + 324, &fLocal_31, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_99(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_31, 20.0f, fLocal_31));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_36(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_32, &Param0 + 488, 0, 0, 0x40400000))
						{
...
bool Function_60(var uParam0) //Position: 0x2EA2 / 11938
{
	...
	Function_65(3, 2);
	uVar0 = &uVar0;
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/campfire_talk", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground_nospawn", 1, 0);
	...
	*(&iLocal_0 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "defend_region", 2,802597E-45f, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(15.0f, 5.0f, 15.0f));
	...
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType", "campfire_talk", Vector(-0,8807065f, 0.0f, -0,3756721f), Vector(0.0f, 78,46466f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType1", "Rand_Idle_Sit_Ground", Vector(1,166761f, 0.0f, 1,4932f), Vector(0.0f, 37,09051f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType3", "Sit_Ground_Campfire_Tend", Vector(1,326281f, 0.0f, 0,1284029f), Vector(0.0f, 84,62513f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType4", "Rand_Idle_Sit_Ground_nospawn", Vector(0.0f, 0.0f, 1,235861f), Vector(0.0f, 0.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 104) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(-0,7814661f, 0.0f, -3,469023f), Vector(0.0f, -92,0647f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "camp_veh_gen", "horse_stay", Vector(-3,617362f, 0.0f, 0,2916448f), Vector(0.0f, 0.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 1);
	Function_61(&iLocal_0, &uParam0);
	return 1;
}

void Function_61(int iParam0, int iParam1) //Position: 0x3323 / 13091
{
	int iVar0;
...
var Function_62(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x336E / 13166
{
	int iVar0;
	int iVar1;
...
void Function_63(struct<13> Param0) //Position: 0x33AC / 13228
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_64(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x33BF / 13247
{
	int iVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x348E / 13454
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_66(struct<2>[] Param0) //Position: 0x34D8 / 13528
{
	int iVar0;
	int iVar1;
...
void Function_67() //Position: 0x389A / 14490
{
	if (!Function_118(128))
	{
		return;
...
bool Function_68() //Position: 0x38DA / 14554
{
	int iVar0;
...
void Function_69() //Position: 0x3908 / 14600
{
	if (!Function_118(128))
	{
		return;
...
void Function_70(vector3 vParam0) //Position: 0x394A / 14666
{
	char* cVar0[32];
...
void Function_71(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x39E2 / 14818
{
	var uVar0;
	var uVar1;
...
void Function_72(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3A11 / 14865
{
...
var Function_73(var uParam0, bool bParam1) //Position: 0x3A6C / 14956
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_74() //Position: 0x3A7C / 14972
{
	return "PackedGrass";
}

var Function_75(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3A90 / 14992
{
	int iVar0;
...
var Function_76() //Position: 0x3AB5 / 15029
{
	return "PackedMetadata";
}

void Function_77(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3ACC / 15052
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_78() //Position: 0x3C08 / 15368
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_79() //Position: 0x3C1A / 15386
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_80() //Position: 0x3C2C / 15404
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_81(var uParam0, struct<5> Param1) //Position: 0x3C3E / 15422
{
...
var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x3C63 / 15459
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x3C82 / 15490
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x3C8E / 15502
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x3C99 / 15513
{
	int iVar0;
...
var Function_86() //Position: 0x3CC7 / 15559
{
	return "PackedWeapon";
}

int Function_87(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3CDC / 15580
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_88() //Position: 0x3DE9 / 15849
{
	return "MPItemGiver";
}

struct<32> Function_89(char* cParam0) //Position: 0x3DFD / 15869
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0) //Position: 0x3E69 / 15977
{
	char* cVar0[32];
...
var Function_91() //Position: 0x3E8B / 16011
{
	return "PBox_";
}

var Function_92() //Position: 0x3E99 / 16025
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x3EBF / 16063
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x3EE7 / 16103
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3F0D / 16141
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4078 / 16504
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x4120 / 16672
{
	int iVar0;
	struct<2> Var1;
...
void Function_98(int iParam0) //Position: 0x428E / 17038
{
...
var Function_99() //Position: 0x42F6 / 17142
{
	int iVar0;
...
var Function_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x42FF / 17151
{
	return Function_101(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_101(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x431D / 17181
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x4616 / 17942
{
	int iVar0;
...
void Function_103() //Position: 0x46CA / 18122
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x4705 / 18181
{
	int iVar0;
...
void Function_105(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4732 / 18226
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x488D / 18573
{
...
void Function_107() //Position: 0x48A4 / 18596
{
	int iVar0;
...
var Function_108(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x48F0 / 18672
{
	int iVar0;
...
int Function_109() //Position: 0x49CC / 18892
{
	int iVar0;
...
int Function_110() //Position: 0x4B28 / 19240
{
	int iVar0;
...
bool Function_111(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4C48 / 19528
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_112(struct<2> Param0) //Position: 0x4D24 / 19748
{
	struct<2> Var0;
	int iVar2;
...
bool Function_113(struct<2> Param0, struct<5> Param2) //Position: 0x4D43 / 19779
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_114(var uParam0, struct<2> Param1) //Position: 0x4E86 / 20102
{
	struct<2> Var0;
...
bool Function_115(int iParam0) //Position: 0x4EFD / 20221
{
	var uVar0;
...
int Function_116() //Position: 0x4F1F / 20255
{
	return 0;
}

void Function_117(struct<321> Param0) //Position: 0x4F26 / 20262
{
	var uVar0;
...
bool Function_118(int iParam0) //Position: 0x4FB8 / 20408
{
	int iVar0;
