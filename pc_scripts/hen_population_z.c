...
void main() //Position: 0x0 / 0
{
	...
	Function_15(&bVar0, 22, 4.0f, 0, 0);
	Function_15(&bVar0, 311, 4.0f, 0, 0);
	...
	Function_15(&bVar0, 298, 4.0f, 0, 0);
	Function_15(&bVar0, 288, 4.0f, 0, 0);
	...
	uVar4 = FIND_NAMED_LAYOUT("HennigansRanch_layout");
	if (IS_LAYOUTREF_VALID(&uVar4))
	{
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "Henv_Townpop_Set");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_5(&uVar5, &bVar0, 5, 10, 0, 0, 1);
		}
		else
		{
		...
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "henv_region");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_5(&uVar5, &uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hen_pop: Cannot find henv_townpop01 to create population volumes");
		}
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "Henv_nightPop");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_5(&uVar5, &bVar0, 10, 20, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hen_pop: Cannot find henv_townpop01 to create population volumes");
		}
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "henv_lawGuys");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_5(&uVar5, &bVar0, 1, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hen_pop: Cannot find henv_lawGuys to create population volumes");
		}
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "henv_women");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_4(&uVar5, &bVar0, 4, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hen_pop: Cannot find henv_women to create population volumes");
		}
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "henv_trainstation_set");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_5(&uVar5, &bVar0, 5, 10, 0, 0, 1);
		}
		...
		uVar5 = FIND_VOLUME_IN_LAYOUT(&uVar4, "henv_null_set");
		if (IS_VOLUME_VALID(&uVar5))
		{
			Function_3(&uVar5, &uVar3, 0.0f, 0, 0, 1);
		}
...
void Function_1(var uParam0, var uParam1) //Position: 0x1042 / 4162
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1053 / 4179
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x10AB / 4267
{
	var uVar0;
...
var Function_4(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x113B / 4411
{
	var uVar0;
...
var Function_5(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x11CB / 4555
{
	var uVar0;
...
bool Function_6(int iParam0) //Position: 0x125D / 4701
{
	int iVar0;
...
void Function_7(char* cParam0) //Position: 0x1279 / 4729
{
	if (!Function_6(128))
	{
		return;
...
bool Function_8(var uParam0, int iParam1) //Position: 0x12B9 / 4793
{
	int iVar0;
...
void Function_9(var uParam0, bool bParam1) //Position: 0x12D6 / 4822
{
...
var Function_10(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x12E7 / 4839
{
	int iVar0;
	int iVar1;
...
var Function_11(int iParam0) //Position: 0x1365 / 4965
{
	int iVar0;
...
var Function_12(int iParam0) //Position: 0x13D1 / 5073
{
	int iVar0;
...
var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x143D / 5181
{
	int iVar0;
	int iVar1;
...
void Function_14(int iParam0) //Position: 0x1484 / 5252
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_15(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1491 / 5265
{
	int iVar0;
	int iVar1;
...
var Function_16(var uParam0, int iParam1) //Position: 0x1513 / 5395
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_17(char* cParam0) //Position: 0x1522 / 5410
{
	if (!Function_6(128))
	{
		return;
