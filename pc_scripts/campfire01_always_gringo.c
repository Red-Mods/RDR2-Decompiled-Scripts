...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar0 + 272) = 5;
	*(&iVar0 + 360) = 2;
	Function_117(&iVar0, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireSmall01x");
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		Function_9(&iVar0, GRINGO_GET_MY_OBJECT_REF(), 0, RAND_INT_RANGE(2, 3), 1, 1, "ped_wilderness", 2,5f, 1, 0x43160000);
		GRINGO_WAIT(250);
	}
	Function_1(&iVar0);
...
void Function_1(struct<473> Param0) //Position: 0xE9 / 233
{
	int iVar0;
...
void Function_2() //Position: 0x297 / 663
{
	return;
}

void Function_3() //Position: 0x29D / 669
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2A6 / 678
{
...
void Function_5(int iParam0) //Position: 0x2B9 / 697
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x2E1 / 737
{
...
void Function_7(struct<13> Param0) //Position: 0x42C / 1068
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x449 / 1097
{
	int iVar0;
...
var Function_9(struct<477> Param0) //Position: 0x467 / 1127
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_40 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_42, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_42, 20.0f, fLocal_42));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_43, &Param0 + 488, 0, 0, 0x40400000))
						{
			...
			if (SQUAD_IS_VALID(&Param0 + 392))
			{
				...
				while (iVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1)))
					{
						if (!Param0.f_440)
						{
							MEMORY_PREFER_RIDING(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), 0);
...
void Function_10(struct<62> Param0) //Position: 0x1626 / 5670
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1638 / 5688
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x1871 / 6257
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1891 / 6289
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x197F / 6527
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1BEB / 7147
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C0F / 7183
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C33 / 7219
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1C59 / 7257
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1C80 / 7296
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1CA4 / 7332
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1CC3 / 7363
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D12 / 7442
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1D6E / 7534
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1D8F / 7567
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1DEA / 7658
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E36 / 7734
{
...
void Function_27(struct<425> Param0) //Position: 0x1E4B / 7755
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1F9E / 8094
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x2013 / 8211
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x207F / 8319
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x2097 / 8343
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x20F5 / 8437
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2142 / 8514
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x21BB / 8635
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x220A / 8714
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x23D3 / 9171
{
...
void Function_37(int iParam0) //Position: 0x2410 / 9232
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2429 / 9257
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x2436 / 9270
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x252B / 9515
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x25EA / 9706
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x25FD / 9725
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x26C4 / 9924
{
...
bool Function_44(int iParam0) //Position: 0x26E4 / 9956
{
...
bool Function_45(int iParam0) //Position: 0x2708 / 9992
{
...
bool Function_46(int iParam0) //Position: 0x271D / 10013
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x2734 / 10036
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x2772 / 10098
{
...
bool Function_49(int iParam0) //Position: 0x278C / 10124
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x27A2 / 10146
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x27DC / 10204
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x28C1 / 10433
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2A78 / 10872
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2A9D / 10909
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2AEB / 10987
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2C42 / 11330
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2CED / 11501
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2D93 / 11667
{
...
bool Function_59(var uParam0) //Position: 0x2DEC / 11756
{
	var uVar0;
...
void Function_60(int iParam0, int iParam1) //Position: 0x351F / 13599
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x356A / 13674
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x35A8 / 13736
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x35BB / 13755
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x368A / 13962
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x36D4 / 14036
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3A96 / 14998
{
	if (!Function_115(128))
	{
		return;
...
bool Function_67() //Position: 0x3AD6 / 15062
{
	int iVar0;
...
void Function_68() //Position: 0x3B04 / 15108
{
	if (!Function_115(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3B46 / 15174
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3BDE / 15326
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3C0D / 15373
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3C68 / 15464
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3C78 / 15480
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3C8C / 15500
{
	int iVar0;
...
var Function_75() //Position: 0x3CB1 / 15537
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3CC8 / 15560
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3E04 / 15876
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3E16 / 15894
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3E28 / 15912
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3E3A / 15930
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3E5F / 15967
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3E7E / 15998
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3E8A / 16010
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3E95 / 16021
{
	int iVar0;
...
var Function_85() //Position: 0x3EC3 / 16067
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3ED8 / 16088
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x3FE5 / 16357
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x3FF9 / 16377
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x4067 / 16487
{
	char* cVar0[32];
...
var Function_90() //Position: 0x4089 / 16521
{
	return "PBox_";
}

var Function_91() //Position: 0x4097 / 16535
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x40BD / 16573
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x40E5 / 16613
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x410B / 16651
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4275 / 17013
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x431D / 17181
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x448B / 17547
{
...
var Function_98() //Position: 0x44F3 / 17651
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x44FC / 17660
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x451A / 17690
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x4813 / 18451
{
	int iVar0;
...
void Function_102() //Position: 0x48C7 / 18631
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x4902 / 18690
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x492F / 18735
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4A8A / 19082
{
...
void Function_106() //Position: 0x4AA1 / 19105
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4AED / 19181
{
	int iVar0;
...
int Function_108() //Position: 0x4BC9 / 19401
{
	int iVar0;
...
int Function_109() //Position: 0x4D25 / 19749
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4E45 / 20037
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4F21 / 20257
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4F40 / 20288
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x5083 / 20611
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x50FA / 20730
{
	var uVar0;
...
bool Function_115(int iParam0) //Position: 0x511C / 20764
{
	int iVar0;
...
int Function_116() //Position: 0x5138 / 20792
{
	return 0;
}

void Function_117(struct<321> Param0) //Position: 0x513F / 20799
{
	var uVar0;
