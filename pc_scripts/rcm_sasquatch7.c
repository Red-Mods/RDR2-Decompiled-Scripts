...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_336 = 1000;
			Function_203(&uLocal_355, "$/content/scripting/gringo/simpleGringo/Sit_Ground_Only", 1, 0);
			Function_203(&uLocal_355, "$/content/DLC/ZombiePack/Gringos/DLC_Sasquatch2", 1, 0);
			Function_202(&uLocal_355, 1263, 3, 0);
			while (!IS_EXITFLAG_SET())
			{
				if (iVar0 <= 3)
				{
					Function_197(&fLocal_369, 41024, &uLocal_376, &iLocal_380, 8);
				}
				else if (iVar0 == 3)
				{
					Function_196(&uLocal_376);
					Function_196(&iLocal_380);
				}
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							...
							{
								if (IS_ACTOR_VALID(&fLocal_369))
								{
									if (Function_191(&uLocal_355))
									{
										if (!IS_OBJECT_VALID(&uLocal_353))
										{
											uLocal_353 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_349, Function_190(), "DLC_Sasquatch2", Vector(-586,993f, 128,503f, 561,232f), Vector(0.0f, 134,97f, 0.0f));
										}
										else
										{
											uLocal_374 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "stayoutvol", 2, *(&Global_99725[ScriptParam_043] + 196), Vector(0.0f, 0.0f, 0.0f), Vector(40.0f, 40.0f, 40.0f));
											ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_374);
											ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_374);
											SNAP_ACTOR_TO_GRINGO(&fLocal_369, &uLocal_353, "UseCase1", true, 0, 0);
											TASK_USE_GRINGO(&fLocal_369, GET_GRINGO_FROM_OBJECT(&uLocal_353), "UseCase1", 4294967295, 1);
											DELETE_ALL_WEAPONS_FROM_ACTOR(&fLocal_369);
											uLocal_371 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "dummySasquatch", 1263, Vector(-375,228f, 186,303f, 555,938f), Vector(0.0f, 0.0f, 0.0f));
											SET_ACTOR_INVULNERABILITY(&uLocal_371, true);
											TASK_STAND_STILL(&uLocal_371, -1.0f, 0, 0);
											TASK_PRIORITY_SET(&uLocal_371, true);
											SET_ACTOR_ALLOW_WEAPON_REACTIONS(&fLocal_369, false);
											SET_ALLOW_EXECUTE(&fLocal_369, 0);
											SET_CRIPPLE_ENABLE(&fLocal_369, 0);
											CLEAR_AREA_OF_GRASS(StackVal, Vector(-586,993f, 128,503f, 561,232f), 1,3f);
											Function_183(&(Global_99725[3743]), 37, 0x41f00000, 0x42200000, 0);
											iVar0 = 1;
										}
									}
								}
								...
								{
									fLocal_369 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_349, "nsasquatch", 1263, *(&Global_99725[ScriptParam_043] + 196), Vector(0.0f, 0.0f, 0.0f));
									SET_ACTOR_FACTION(&fLocal_369, 0);
									SET_ACTOR_HEALTH(&fLocal_369, GET_ACTOR_MAX_HEALTH(&fLocal_369));
									SET_ACTOR_OVERHEALTH_MODE(&fLocal_369, true);
								}
							}
							else
							{
								uLocal_349 = CREATE_LAYOUT("RCM_Sasquatch_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						if (GET_LAST_ATTACKER(&fLocal_369) == Function_175())
						{
							iVar1 = 1;
						}
						iLocal_348 = 1;
						if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288) || iVar1)
						{
							if (iLocal_348 || iVar1)
							{
								if ((StackVal && FABS((StackVal - !Function_171(&Global_54076, 1, 1))) > 2.0f) || iVar1)
								{
									if (Function_167(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0) || iVar1)
									{
					...
					case 0x00000003:
						if (Function_126("$/cutscene/Sasquatch_2_cs/Sasquatch_2_cs", &iLocal_336, 34282, 34275, 33024, 32937, 32665, 32658, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						if (!HUD_IS_FADING() && !HUD_IS_FADED())
						{
							...
							Function_59(37, 1, 1, 0);
							AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
							TASK_PRIORITY_SET(&fLocal_369, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&fLocal_369, 1, 1, true, 1, 0, 2, 1101004800, 1088421888, 1);
							SET_ACTOR_INVULNERABILITY(&fLocal_369, false);
							Function_3();
							iVar0 = 13;
						}
						break;
					...
					case 0x0000000D:
						if (IS_ACTOR_VALID(&fLocal_369))
						{
							if (!Function_2(&fLocal_369, 0x3f800000, 0x42960000, 1, 1, 0) && Function_1(&fLocal_369, &Global_54076) < 50.0f)
							{
								DESTROY_ACTOR(&fLocal_369);
							}
						}
						else
						{
...
float Function_1(float fParam0, bool bParam1) //Position: 0x587 / 1415
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_2(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x67C / 1660
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

void Function_3() //Position: 0x69C / 1692
{
	bool bVar0;
	bool bVar1;
...
void Function_4(bool bParam0) //Position: 0x6CD / 1741
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				{
					iVar3 = iVar1;
					if (Function_24(&(Global_99725[iVar143]), iVar3))
					{
						Function_182(&Global_99725[iVar143] + 228, 64);
						Function_16(&(Global_99725[iVar143]), iVar3);
...
void Function_5(struct<229> Param0) //Position: 0x887 / 2183
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_190(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_6(&Param0);
...
void Function_6(struct<217> Param0) //Position: 0x957 / 2391
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_190(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_190(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_7(&uVar1, 0);
	return;
}

int Function_7(var uParam0, int iParam1) //Position: 0xA15 / 2581
{
	int iVar0;
	var uVar1;
...
void Function_8(int iParam0, var uParam1, struct<2> Param2) //Position: 0xB7F / 2943
{
	struct<8> Var0;
...
struct<32> Function_9(char* cParam0) //Position: 0xC27 / 3111
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_10(char* cParam0) //Position: 0xC93 / 3219
{
	char* cVar0[32];
...
int Function_11(int iParam0) //Position: 0xCB5 / 3253
{
	int iVar0;
	struct<2> Var1;
...
float Function_12(int iParam0, struct<2> Param1) //Position: 0xE23 / 3619
{
	struct<2> Var0;
...
struct<8> Function_13(int iParam0) //Position: 0xE9A / 3738
{
	struct<2> Var0;
...
void Function_14(int iParam0) //Position: 0xF06 / 3846
{
...
bool Function_15(int iParam0) //Position: 0xF6E / 3950
{
...
void Function_16(struct<153> Param0) //Position: 0xF84 / 3972
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_22(Function_23(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_21(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_47(Global_99725[iParam143].f_228, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(&Param0 + 328))
		{
			...
			*(&Param0 + 280) = ADD_BLIP_FOR_COORD(&Param0 + 196, Param0.f_152, 0.0f, 2, 0);
			...
			if (Function_47(Global_116927[iParam16].f_32, 1))
			{
				...
				if (Global_43789 != Global_99725[iParam143].f_216 && !Function_20())
				{
...
void Function_17(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x149A / 5274
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_18(int iParam0) //Position: 0x1525 / 5413
{
	char* cVar0[16];
...
bool Function_19() //Position: 0x1564 / 5476
{
...
bool Function_20() //Position: 0x157F / 5503
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_21(int iParam0) //Position: 0x15AC / 5548
{
...
var Function_22(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x15D8 / 5592
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_23(int iParam0) //Position: 0x15F9 / 5625
{
...
bool Function_24(struct<249> Param0) //Position: 0x160E / 5646
{
...
bool Function_25(struct<265> Param0) //Position: 0x173E / 5950
{
	int iVar0;
	
	if (!Param0.f_260 != 0)
	{
		if (Function_32(&Param0 + 260, 4))
		{
		...
		if (Function_32(&Param0 + 260, 2) && Global_6606)
		{
			iVar0 = Function_29(Param0.f_264);
		...
		if (Function_32(&Param0 + 260, 8) && Global_6606)
		{
		...
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_32(&Param0 + 260, 1024))
				{
					return 0;
				}
				break;
...
bool Function_26(int iParam0) //Position: 0x189F / 6303
{
...
bool Function_27(int iParam0) //Position: 0x18C3 / 6339
{
...
bool Function_28(int iParam0) //Position: 0x18D8 / 6360
{
...
var Function_29(int iParam0) //Position: 0x18EF / 6383
{
...
bool Function_30(int iParam0) //Position: 0x1909 / 6409
{
...
bool Function_31(int iParam0) //Position: 0x191F / 6431
{
	return Global_116927[iParam06].f_16;
}

bool Function_32(var uParam0, int iParam1) //Position: 0x192F / 6447
{
	int iVar0;
...
bool Function_33(struct<237> Param0) //Position: 0x194C / 6476
{
	if (!Param0.f_236)
	{
		if (Function_19())
...
bool Function_34(int iParam0) //Position: 0x1A1B / 6683
{
...
void Function_35(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1A76 / 6774
{
	bool bVar0;
	char* cVar1[16];
...
void Function_36(char* cParam0) //Position: 0x1AEB / 6891
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x1B25 / 6949
{
	var uVar0;
	char* cVar1[16];
...
int Function_38(char* cParam0) //Position: 0x1BA1 / 7073
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_39(int iParam0) //Position: 0x1C42 / 7234
{
	int iVar0;
	int iVar1;
...
void Function_40(int iParam0, int iParam1) //Position: 0x1C7F / 7295
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

bool Function_41(var uParam0, int iParam1) //Position: 0x1C95 / 7317
{
...
bool Function_42(int iParam0) //Position: 0x1CA8 / 7336
{
	int iVar0;
...
bool Function_43(var uParam0, int iParam1) //Position: 0x1CC4 / 7364
{
	int iVar0;
...
int Function_44(int iParam0) //Position: 0x1CE1 / 7393
{
...
bool Function_45(int iParam0) //Position: 0x1CF6 / 7414
{
...
int Function_46(int iParam0) //Position: 0x1D0B / 7435
{
...
bool Function_47(bool bParam0, bool bParam1) //Position: 0x1D20 / 7456
{
	return (bParam0 && bParam1) == 0;
}

void Function_48() //Position: 0x1D2D / 7469
{
...
int Function_49(int iParam0, int iParam1) //Position: 0x1DAD / 7597
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					...
					else if (iVar14 && Function_125(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					...
					else if (iVar15 && Function_125(26, 0))
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					...
					else if (Function_125(17, 0) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_125(6, 0) && Function_45(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if ((Function_125(9, 0) && Function_45(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					...
					else if (Function_125(8, 0) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
...
bool Function_50(char* cParam0) //Position: 0x2A10 / 10768
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_51(int iParam0) //Position: 0x2A28 / 10792
{
	int iVar0;
	int iVar1;
...
bool Function_52(int iParam0) //Position: 0x2A77 / 10871
{
...
int Function_53(int iParam0) //Position: 0x2A8D / 10893
{
...
void Function_54() //Position: 0x2AF6 / 10998
{
...
bool Function_55(int iParam0) //Position: 0x2B1B / 11035
{
	if (!Function_52(iParam0))
	{
...
bool Function_56(int iParam0, int iParam1) //Position: 0x2B6C / 11116
{
	int iVar0;
...
bool Function_57(int iParam0) //Position: 0x2B99 / 11161
{
	if (!Function_52(iParam0))
	{
...
void Function_58(bool bParam0) //Position: 0x2BEB / 11243
{
	int iVar0;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2C25 / 11301
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x309F / 12447
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_61() //Position: 0x3240 / 12864
{
	return;
}

void Function_62(bool bParam0, int iParam1) //Position: 0x3246 / 12870
{
	if (Global_6624)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x3285 / 12933
{
...
void Function_64() //Position: 0x32DA / 13018
{
	Function_90();
	Function_89();
	Function_89();
...
void Function_65() //Position: 0x3325 / 13093
{
...
void Function_66() //Position: 0x342B / 13355
{
	float fVar0;
...
void Function_67() //Position: 0x345E / 13406
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x35F1 / 13809
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x37AA / 14250
{
	Function_70(&Global_42918, 1, 0);
	return;
}

void Function_70(struct<2317> Param0) //Position: 0x37B8 / 14264
{
	var uVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_71(int iParam0) //Position: 0x39D5 / 14805
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x3A7C / 14972
{
	int iVar0;
...
void Function_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3D18 / 15640
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_74(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_190(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_74(int iParam0) //Position: 0x4358 / 17240
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_75(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x4369 / 17257
{
	char* cVar0[32];
...
struct<32> Function_76(char* cParam0) //Position: 0x4460 / 17504
{
	char* cVar0[32];
...
void Function_77(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x447B / 17531
{
	float fVar0;
...
var Function_78(int iParam0, int iParam1) //Position: 0x44E2 / 17634
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_79(int iParam0, bool bParam1) //Position: 0x44F4 / 17652
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_80(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4506 / 17670
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_81(int iParam0) //Position: 0x463A / 17978
{
	return Global_55480[iParam016].f_96;
}

float Function_82(int iParam0) //Position: 0x4649 / 17993
{
	if (!iParam0 != 4294967295)
	{
...
var Function_83(int iParam0) //Position: 0x4682 / 18050
{
	if (iParam0 == 4294967295)
	{
...
void Function_84(int iParam0) //Position: 0x46BF / 18111
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_85(int iParam0, bool bParam1, bool bParam2) //Position: 0x4859 / 18521
{
	int iVar0;
	int iVar1;
...
int Function_86(bool bParam0) //Position: 0x4A9D / 19101
{
...
struct<8> Function_87() //Position: 0x4ADE / 19166
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_88() //Position: 0x4B67 / 19303
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x4BFE / 19454
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_90() //Position: 0x4C7D / 19581
{
...
int Function_91(int iParam0, bool bParam1, int iParam2) //Position: 0x4CBA / 19642
{
	int iVar0;
	int iVar1;
...
void Function_92() //Position: 0x4EC6 / 20166
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_93(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4F7D / 20349
{
	int iVar0;
...
struct<8> Function_94() //Position: 0x5075 / 20597
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_95(int iParam0) //Position: 0x507F / 20607
{
...
int Function_96(bool bParam0, bool bParam1) //Position: 0x5095 / 20629
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_97(struct<2> Param0, struct<2> Param2) //Position: 0x5161 / 20833
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_98(float fParam0, int iParam1) //Position: 0x517E / 20862
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_99(int iParam0) //Position: 0x59AA / 22954
{
	var uVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x59E5 / 23013
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_101(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x59F4 / 23028
{
	iParam0 = &iParam0;
...
void Function_102(int iParam0) //Position: 0x5AA3 / 23203
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_45(4) && !Function_106(0))
	{
	...
	if (!Function_32(&Global_6667[228] + 184, 2) || ((((((Function_45(14) && Function_45(18)) && Function_45(37)) && Function_45(7)) && Function_45(11)) && Function_45(5)) && Function_45(21)))
	{
	...
	if (!Function_32(&Global_6667[328] + 184, 2) || ((Function_45(27) && Function_45(1)) && Function_45(23)))
	{
	...
	if (!Function_45(7))
	{
		...
		if (((Function_45(6) && Function_103(Global_46949) < 0) && Function_103(Global_46951) < 0) && Function_103(Global_46952) < 0)
		{
...
int Function_103(int iParam0) //Position: 0x63C4 / 25540
{
	if (!Function_28(iParam0))
	{
		return 4294967295;
...
bool Function_104() //Position: 0x63DE / 25566
{
	return STRING_TO_HASH(Function_105());
}

var Function_105() //Position: 0x63EA / 25578
{
	return "ZOMBIE_STORY";
}

bool Function_106(int iParam0) //Position: 0x63FF / 25599
{
...
int Function_107(int iParam0) //Position: 0x6465 / 25701
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_108(int iParam0) //Position: 0x6527 / 25895
{
...
void Function_109(bool bParam0, bool bParam1) //Position: 0x6570 / 25968
{
	bool bVar0;
...
void Function_110() //Position: 0x6595 / 26005
{
	bool bVar0;
...
void Function_111(int iParam0) //Position: 0x65F3 / 26099
{
	PRINTSTRING("Day ");
...
int Function_112(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x663D / 26173
{
	int iVar0;
	int iVar1;
...
void Function_113(bool bParam0) //Position: 0x6865 / 26725
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6903 / 26883
{
	struct<4> Var0;
	var uVar4;
...
void Function_115(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x6998 / 27032
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_122(bParam0, bParam1))
	{
		...
		if (StackVal && !Function_47(((((!Function_20() && !Global_6623) && !Global_6635) && !Global_6627) && !&bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, 0, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_47((((Function_20() || Global_6623) || Global_6635) || Global_6627), 1))
		{
		...
		if (!Function_19())
		{
			if (!Function_41(Global_119934, 2))
			{
...
void Function_116(int iParam0, int iParam1) //Position: 0x6C37 / 27703
{
	bool bVar0;
...
void Function_117(int iParam0, bool bParam1) //Position: 0x6CA1 / 27809
{
...
void Function_118(bool bParam0) //Position: 0x6D10 / 27920
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
...
int Function_119(int iParam0) //Position: 0x6EC0 / 28352
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_120(int iParam0) //Position: 0x6F17 / 28439
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_121(bool bParam0) //Position: 0x6F6D / 28525
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122(bool bParam0, int iParam1) //Position: 0x6F79 / 28537
{
	int iVar0;
...
void Function_123(int iParam0, int iParam1) //Position: 0x6FD8 / 28632
{
	if (!Function_52(iParam0))
	{
...
bool Function_124(int iParam0) //Position: 0x702D / 28717
{
...
bool Function_125(int iParam0, bool bParam1) //Position: 0x7049 / 28745
{
	int iVar0;
...
bool Function_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x7087 / 28807
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_127(var uParam0, int iParam1, struct<41> Param2) //Position: 0x7140 / 28992
{
	if (!&bParam15)
	{
...
void Function_128(var uParam0, bool bParam1) //Position: 0x77A2 / 30626
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_129() //Position: 0x7871 / 30833
{
	int iVar0;
...
void Function_130() //Position: 0x78E9 / 30953
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_131() //Position: 0x792E / 31022
{
...
void Function_132(bool bParam0) //Position: 0x7940 / 31040
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_133(var uParam0, int iParam1) //Position: 0x795D / 31069
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_190(), &iParam1, 4294967295, 1);
...
bool Function_134(int iParam0) //Position: 0x79EF / 31215
{
	bool bVar0;
...
float Function_135(vector3 vParam0) //Position: 0x7A20 / 31264
{
...
bool Function_136(int iParam0) //Position: 0x7AED / 31469
{
	return Function_47(iParam0, 2);
}

bool Function_137(int iParam0) //Position: 0x7AFB / 31483
{
	return Function_47(iParam0, 1);
}

int Function_138(bool bParam0) //Position: 0x7B09 / 31497
{
	bool bVar0;
	var uVar1;
...
bool Function_139() //Position: 0x7BCC / 31692
{
	bool bVar0;
	var uVar1;
...
void Function_140(int iParam0) //Position: 0x7C09 / 31753
{
	Function_141(&iParam0, 0.0f);
	return;
}

void Function_141(vector3 vParam0) //Position: 0x7C16 / 31766
{
...
bool Function_142(struct<37> Param0) //Position: 0x7C3B / 31803
{
	return Param0.f_36;
}

void Function_143(var uParam0, int iParam1) //Position: 0x7C46 / 31814
{
	Function_144(&uParam0, &iParam1, 0);
	return;
}

void Function_144(var uParam0, bool bParam1, bool bParam2) //Position: 0x7C56 / 31830
{
...
void Function_145(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7DCE / 32206
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_146() //Position: 0x7DF8 / 32248
{
	var uVar0;
	var uVar1;
...
void Function_147() //Position: 0x7E53 / 32339
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_190(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_190(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_148() //Position: 0x7F92 / 32658
{
	return 1;
}

int Function_149() //Position: 0x7F99 / 32665
{
	Function_150(2, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	ACTOR_PUT_WEAPON_IN_HAND(&Global_54076, 4, 0);
	Function_132(1.0f);
	DESTROY_VOLUME(&uLocal_351);
	return 1;
}

void Function_150(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7FC3 / 32707
{
	var uVar0;
...
void Function_151() //Position: 0x8094 / 32916
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_152() //Position: 0x80A9 / 32937
{
	if (IS_ACTOR_VALID(&uLocal_371))
	{
		SET_ACTOR_INVULNERABILITY(&uLocal_371, false);
		DESTROY_ACTOR(&uLocal_371);
	}
	GIVE_OBJECT_TO_LAYOUT(&uLocal_353, &fLocal_369);
	SET_DRAW_ACTOR(&fLocal_369, 1);
	CAMERA_RESET(0);
...
int Function_153() //Position: 0x8100 / 33024
{
	if (!iLocal_373)
	{
		if (IS_ACTOR_VALID(&fLocal_369))
		{
			if (!IS_ACTOR_ALIVE(&fLocal_369) || GET_ACTOR_INCAPACITATED(&fLocal_369))
			{
				DESTROY_ACTOR(&fLocal_369);
			}
		}
		if (!IS_ACTOR_VALID(&fLocal_369))
		{
			fLocal_369 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "nsasquatch", 1263, Vector(-375,228f, 186,303f, 555,938f), Vector(0.0f, 0.0f, 0.0f));
			SET_ACTOR_FACTION(&fLocal_369, 0);
			SET_ACTOR_HEALTH(&fLocal_369, GET_ACTOR_MAX_HEALTH(&fLocal_369));
			SET_ACTOR_OVERHEALTH_MODE(&fLocal_369, true);
		}
		MEMORY_CLEAR_ALL(&fLocal_369);
		CLEAR_LAST_HIT(&fLocal_369);
		TASK_USE_GRINGO(&fLocal_369, GET_GRINGO_FROM_OBJECT(&uLocal_353), "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(&fLocal_369, &uLocal_353, "UseCase1", true, 0, 0);
		SET_DRAW_ACTOR(&fLocal_369, 0);
		Function_154(StackVal, Vector(-590,3f, 129,51f, 576,89f), &uLocal_351);
		iLocal_373 = 1;
	}
	return 1;
}

void Function_154(vector3 vParam0) //Position: 0x81EF / 33263
{
	float fVar0;
	int iVar1;
	float fVar2;
	...
	if (!Function_50(StackVal, vParam0))
	{
		fVar0 = GET_MOST_RECENT_MOUNT(&Global_54076);
		iVar1 = &Global_21369 + 72;
		fVar2 = GET_ACTOR_MOST_RECENT_VEHICLE(&Global_54076);
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_1(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&fVar0))
		{
			if (&fVar0 != &iVar1)
			{
				if (IS_VOLUME_VALID(&iParam2))
				{
					if (IS_ACTOR_IN_VOLUME(&fVar0, &iParam2))
					{
						TELEPORT_ACTOR(&fVar0, &vVar3, 1, 1, 1);
						vVar3 = (vParam0.x + 2,5f);
						vVar3.f_8 = (vParam0.z + 2,5f);
					}
				}
				else if (Function_1(&fVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&fVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
				...
				TASK_CLEAR(&fVar0);
				TASK_STAND_STILL(&fVar0, -1.0f, 0, 0);
				TASK_PRIORITY_SET(&fVar0, true);
			}
		}
		if (IS_ACTOR_VALID(&fVar2))
		{
			if (IS_VOLUME_VALID(&iParam2))
			{
				if (IS_ACTOR_IN_VOLUME(&fVar2, &iParam2))
				{
					TELEPORT_ACTOR(&fVar2, &vVar3, 1, 1, 1);
				}
			}
			else if (Function_1(&fVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&fVar2, &vVar3, 1, 1, 1);
			}
		}
...
void Function_155(float fParam0, float fParam1) //Position: 0x8398 / 33688
{
...
void Function_156() //Position: 0x84A9 / 33961
{
...
void Function_157() //Position: 0x84DD / 34013
{
...
int Function_158() //Position: 0x85E3 / 34275
{
	return 1;
}

int Function_159() //Position: 0x85EA / 34282
{
	ACTOR_SET_NEXT_EQUIP_SLOT(&Global_54076, 1, 0);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("RCM_Sasquatch", &uLocal_371);
	uLocal_351 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_349, "Sasquatch1_cutscenevol", 2, *(&Global_99725[3743] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(40.0f, 40.0f, 40.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_163(0, 0, 1, 1, 0, 1, 1, &uLocal_351, 1, 1, 1, 1, 0x3f800000, 0);
	Function_161(StackVal, &uLocal_349, *(&Global_99725[3743] + 196), &uLocal_351, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	Function_160(&fLocal_369, 1, 1);
	return 1;
}

void Function_160(var uParam0, bool bParam1, bool bParam2) //Position: 0x86BB / 34491
{
...
void Function_161(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x876B / 34667
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_162(var uParam0, float fParam1) //Position: 0x8A0B / 35339
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_163(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8A8D / 35469
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_166(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_190(), 2, Function_166(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_164(bool bParam0) //Position: 0x8D3F / 36159
{
	bool bVar0;
	
	if (Function_47(bParam0, 1) && Function_47(Global_39556, 1))
	{
	}
...
var Function_165() //Position: 0x8D73 / 36211
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_166(bool bParam0) //Position: 0x8E01 / 36353
{
	struct<2> Var0;
...
int Function_167(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8E13 / 36371
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_170(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_169(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_168(vector3 vParam0) //Position: 0x9048 / 36936
{
	var uVar0;
...
float Function_169(var uParam0, bool bParam1) //Position: 0x90BE / 37054
{
	struct<2> Var0;
...
void Function_170(var uParam0, bool bParam1) //Position: 0x90DF / 37087
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_169(&uParam0, 0) < 2.0f)
	{
...
bool Function_171(int iParam0, bool bParam1, bool bParam2) //Position: 0x9149 / 37193
{
...
bool Function_172() //Position: 0x920D / 37389
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_173(int iParam0) //Position: 0x9224 / 37412
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_174(bool bParam0) //Position: 0x9230 / 37424
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

int Function_175() //Position: 0x923F / 37439
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return "";
...
void Function_176() //Position: 0x9254 / 37460
{
	SET_ACTOR_OVERHEALTH_MODE(&fLocal_369, false);
	SET_ACTOR_INVULNERABILITY(&fLocal_369, false);
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_374);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_374);
	if (IS_LAYOUTREF_VALID(&uLocal_349))
	{
	...
	Function_178(&uLocal_355);
	Function_177(0, 0, 0);
	return;
}

int Function_177(bool bParam0, bool bParam1, bool bParam2) //Position: 0x92B7 / 37559
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_178(int iParam0) //Position: 0x92E9 / 37609
{
	int iVar0;
...
void Function_179(struct<2>[] Param0, int iParam1) //Position: 0x9311 / 37649
{
...
void Function_180(struct<13> Param0) //Position: 0x945C / 37980
{
	int iVar0;
...
bool Function_181(struct<13> Param0) //Position: 0x9479 / 38009
{
	int iVar0;
...
void Function_182(var uParam0, int iParam1) //Position: 0x9497 / 38039
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_183(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x94A8 / 38056
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_185(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_185(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_184(struct<257> Param0) //Position: 0x9633 / 38451
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_184(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_185(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x966F / 38511
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_188(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_189()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_188(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_189()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_188(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_186() //Position: 0x98D7 / 39127
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_187(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_187(char* cParam0) //Position: 0x992B / 39211
{
	char* cVar0[64];
...
bool Function_188(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9A54 / 39508
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_13(&uParam0);
...
int Function_189() //Position: 0x9AE0 / 39648
{
	if (IS_PS3())
	{
		return 1;
...
var Function_190() //Position: 0x9AEF / 39663
{
	int iVar0;
...
bool Function_191(struct<2>[] Param0) //Position: 0x9AF8 / 39672
{
	int iVar0;
	int iVar1;
...
void Function_192() //Position: 0x9EBA / 40634
{
	if (!Function_42(128))
	{
		return;
...
bool Function_193() //Position: 0x9EFA / 40698
{
	int iVar0;
...
void Function_194(struct<13> Param0) //Position: 0x9F28 / 40744
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_195() //Position: 0x9F3B / 40763
{
	if (!Function_42(128))
	{
		return;
...
void Function_196(vector3 vParam0) //Position: 0x9F7D / 40829
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_197(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) //Position: 0x9F94 / 40852
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (((!IS_SCRIPTED_SPEECH_PLAYING(&uParam0) && (MEMORY_GET_IS_VISIBLE(&uParam0, &Global_54076) || Function_2(&uParam0, 0x3f800000, 0x42960000, 1, 1, 0))) && Function_1(&Global_54076, &uParam0) > 35.0f) && !Global_99146)
		{
...
void Function_198(int iParam0) //Position: 0xA029 / 41001
{
...
void Function_199() //Position: 0xA040 / 41024
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "RCM_CALL_OVER_FIRST_TIME", "RCM_CALL_OVER_FIRST_TIME", true, 1, 1, 0, 1);
		Function_200(3);
...
void Function_200(bool bParam0) //Position: 0xA099 / 41113
{
	Function_201(0, &Global_54076, bParam0, 0);
	Function_201(1, &fLocal_369, bParam0, 0);
	return;
}

void Function_201(bool bParam0, float fParam1, bool bParam2, int iParam3) //Position: 0xA0B5 / 41141
{
	bool bVar0;
	...
	{
		bVar0 = bParam0;
		ADD_NEW_CONVERSATION_SPEAKER(bVar0, &fParam1, 0);
	}
}

var Function_202(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xA0DD / 41181
{
	int iVar0;
...
var Function_203(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA1B9 / 41401
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_204(&Param0, &uVar1, iParam2);
	if (&bParam3)
	{
		Function_194(&(Param0[iVar02]), 8);
	}
...
var Function_204(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA1F7 / 41463
{
	int iVar0;
