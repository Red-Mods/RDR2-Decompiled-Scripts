...
void main() //Position: 0x0 / 0
{
	...
	iLocal_2 = 1;
	fLocal_3 = 2.0f;
	uLocal_30 = Vector(-2080,533f, 17,121f, 2604,184f);
	iLocal_36 = 2;
	iLocal_37 = 4;
	fLocal_38 = 70.0f;
...
void Function_3() //Position: 0x24F / 591
{
	...
	Function_4(4, &uLocal_22, &iLocal_24, &uLocal_4, &uLocal_26, 4294967295);
	return;
}
...
bool Function_18(int iParam0, var uParam1) //Position: 0xEE7 / 3815
{
	var uVar0;
	int iVar1;
...
var Function_28(struct<477> Param0) //Position: 0x148E / 5262
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_36 || bParam2) || Global_6611)
			{
				if (Function_148(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_146(&Param0 + 324, &fLocal_38, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_135(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_38, 20.0f, fLocal_38));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_73(StackVal, StackVal, &Param0 + 16, Function_135(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000B:
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_40) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_39, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x264D / 9805
{
	...
	if ((GET_CURRENT_GAME_TIME() - fLocal_35) < 1.0f && Function_33(Global_46760[0]))
	{
...
void Function_30(var uParam0, int iParam1) //Position: 0x26CE / 9934
{
...
var Function_31(int iParam0, char* cParam1, bool bParam3) //Position: 0x2729 / 10025
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_32(int iParam0) //Position: 0x27CE / 10190
{
...
bool Function_33(int iParam0) //Position: 0x27E4 / 10212
{
	if (!Function_32(iParam0))
	{
		return 1;
...
bool Function_34(var uParam0, int iParam1) //Position: 0x2800 / 10240
{
	int iVar0;
...
void Function_35(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x281D / 10269
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_36(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2A56 / 10838
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_37(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2A76 / 10870
{
	bool bVar0;
	var uVar1;
...
int Function_38(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2B64 / 11108
{
	char* cVar0[32];
...
int Function_39(int iParam0) //Position: 0x2DD0 / 11728
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_40(var uParam0, bool bParam1) //Position: 0x2DF4 / 11764
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_41(var uParam0, int iParam1) //Position: 0x2E18 / 11800
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_42(var uParam0, bool bParam1) //Position: 0x2E3E / 11838
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_43(var uParam0, bool bParam1) //Position: 0x2E65 / 11877
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_44(bool bParam0) //Position: 0x2E89 / 11913
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_45() //Position: 0x2EA8 / 11944
{
...
bool Function_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2EF7 / 12023
{
	bool bVar0;
	var uVar1;
...
bool Function_47(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F53 / 12115
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_48(var uParam0, int iParam1) //Position: 0x2F74 / 12148
{
	bool bVar0;
	var uVar1;
...
void Function_49(var uParam0, var uParam1, bool bParam2) //Position: 0x2FCF / 12239
{
	bool bVar0;
	var uVar1;
...
var Function_50() //Position: 0x301B / 12315
{
...
void Function_51(struct<425> Param0) //Position: 0x3030 / 12336
{
	bool bVar0;
	bool bVar1;
...
bool Function_52(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3183 / 12675
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_53(vector3 vParam0) //Position: 0x31F8 / 12792
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_54(var uParam0) //Position: 0x3210 / 12816
{
	bool bVar0;
	int iVar1;
...
var Function_55(bool bParam0) //Position: 0x326E / 12910
{
	bool bVar0;
	bool bVar1;
...
void Function_56(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x32BB / 12987
{
	bool bVar0;
	var uVar1;
...
void Function_57(var uParam0, bool bParam1) //Position: 0x3334 / 13108
{
	bool bVar0;
	var uVar1;
...
void Function_58(var uParam0) //Position: 0x3383 / 13187
{
	struct<21> Var0;
...
bool Function_59() //Position: 0x3442 / 13378
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_60(struct<25> Param0) //Position: 0x3455 / 13397
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_61(int iParam0) //Position: 0x351C / 13596
{
...
bool Function_62(int iParam0) //Position: 0x353C / 13628
{
...
bool Function_63(int iParam0) //Position: 0x3560 / 13664
{
...
bool Function_64(int iParam0) //Position: 0x3575 / 13685
{
...
bool Function_65(int iParam0, bool bParam1) //Position: 0x358C / 13708
{
	int iVar0;
...
var Function_66(int iParam0) //Position: 0x35CA / 13770
{
...
bool Function_67(int iParam0) //Position: 0x35E4 / 13796
{
...
int Function_68(int iParam0, struct<6> Param1) //Position: 0x35FA / 13818
{
	int iVar0;
...
void Function_69(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x3634 / 13876
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_70(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3719 / 14105
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_71(var uParam0, bool bParam1) //Position: 0x38D0 / 14544
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_72(bool bParam0) //Position: 0x38F5 / 14581
{
	var uVar0;
	int iVar1;
...
var Function_73(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3943 / 14659
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_74(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x3A9A / 15002
{
	var uVar0[5];
	int iVar6;
...
int Function_75(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3B45 / 15173
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_76(int iParam0, int iParam1) //Position: 0x3BEB / 15339
{
	var uVar0;
	
	Function_143(&uLocal_4, 588, 3, 0);
	Function_143(&uLocal_4, 606, 3, 0);
	Function_99(&uLocal_4, "$/content/scripting/gringo/SimpleGringo/chair_sit_attach", 1, 0);
	Function_99(&uLocal_4, "p_gen_stool02x", 0, 0);
	if (Function_83(&uLocal_22, &uLocal_4, 8, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_81(&uLocal_28, "marshal01mobile", &iParam1))
		{
			uVar0 = Function_31(Global_46760[0], "narmadillo", "sheriffsOffice01", 2);
			uLocal_33 = LOCATE_GRINGO_OF_TYPE("sleep", &uLocal_30, 1.0f, 1);
			if (IS_DOOR_VALID(&uVar0) && IS_GRINGO_VALID(&uLocal_33))
			{
				Function_80(&uVar0, 1);
				OPEN_DOOR_DIRECTION_FAST(&uVar0, 0);
				iLocal_24 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_28, Function_135()));
				*(&Global_6667[828] + 216) = &iLocal_24;
				*(&iParam0 + 24) = &uLocal_28;
				Function_77();
				fLocal_35 = GET_CURRENT_GAME_TIME();
				return 1;
			}
...
void Function_77() //Position: 0x3D23 / 15651
{
	var uVar0;
	struct<2> Var1;
	int iVar3;
	...
	uLocal_26 = CREATE_LAYOUT("marshal01campfirelayout");
	uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_26, "marshal01restrict", 2,802597E-45f, Vector(-2084,343f, 17,37085f, 2602,81f), Vector(0.0f, 24,46099f, 0.0f), Vector(9,259373f, 5,303829f, 9,113053f));
	...
	Var1 = Vector(-2080,617f, 17,144f, 2602,648f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_22, Var1, 15.0f, 1, 1, 1);
	TASK_STAND_STILL(&uLocal_22, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(&uLocal_22);
	Function_78(&uLocal_22, &iLocal_24, 0, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_22, &uVar0, 1, true);
	iVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_26, "Marshal01deputy", 588, Var1, Vector(0.0f, 0.0f, 0.0f));
	SNAP_ACTOR_TO_GRINGO(&iVar3, GET_OBJECT_FROM_GRINGO(&uLocal_33), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&iVar3, &uLocal_33, "UseCase1", 4294967295, 1);
	Function_78(&iVar3, &iLocal_24, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iVar3, &uVar0, 1, true);
	iVar3 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_26, "Marshal01prisoner", 606, Var1, Vector(0.0f, 0.0f, 0.0f));
	uVar4 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_26, "marshal01sit", "chair_sit_attach", Vector(-2082,322f, 17,034f, 2599,749f), Vector(0.0f, 284,948f, 0.0f));
	SNAP_OBJECT_TO_GROUND(&uVar4, 1.0f, false, 1092616192);
	SNAP_ACTOR_TO_GRINGO(&iVar3, &uVar4, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&iVar3, GET_GRINGO_FROM_OBJECT(&uVar4), "UseCase1", 4294967295, 1);
	Function_78(&iVar3, &iLocal_24, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(&iVar3, &uVar0, 1, true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_26, "marshal01stool", "p_gen_stool02x", Vector(-2081,962f, 16,85f, 2599,682f), Vector(0.0f, -63.0f, 0.0f), 1);
	return;
}

void Function_78(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3F60 / 16224
{
	bool bVar0;
	int iVar1;
...
bool Function_79(int iParam0, int iParam1, bool bParam2) //Position: 0x411E / 16670
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
void Function_80(var uParam0, int iParam1) //Position: 0x4166 / 16742
{
	if (!IS_DOOR_VALID(&uParam0))
	{
		return;
...
bool Function_81(var uParam0, var uParam1, int iParam2) //Position: 0x41BE / 16830
{
...
void Function_82(var uParam0, bool bParam1) //Position: 0x41EE / 16878
{
	int iVar0;
...
bool Function_83(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4239 / 16953
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
		...
		if (Function_33(iVar1))
		{
			if (Function_102(&iParam1))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					uParam0 = Function_84(Global_6667[iParam228].f_56, 0, 1, vVar2.x, vVar2.y, vVar2.z, &uParam8, &uParam9, &uParam10);
				}
			}
		}
	}
...
var Function_84(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4418 / 17432
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	else
	{
		...
		if (&bParam8)
		{
			bVar1 = Function_87(&Global_15402[iParam014] + 16, &uParam7);
		}
...
void Function_85(var uParam0, bool bParam1) //Position: 0x4958 / 18776
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_86(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x497A / 18810
{
	var uVar0;
...
var Function_87(bool bParam0, int iParam1) //Position: 0x49DB / 18907
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x4A69 / 19049
{
	Function_90(&uParam0);
	Function_89(&uParam0);
...
void Function_89(int iParam0) //Position: 0x4A95 / 19093
{
...
void Function_90(int iParam0) //Position: 0x4ABB / 19131
{
...
bool Function_91(bool bParam0) //Position: 0x4B91 / 19345
{
...
var Function_92(int iParam0, int iParam1) //Position: 0x4BA8 / 19368
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_93(int iParam0, bool bParam1, bool bParam2) //Position: 0x4C4E / 19534
{
	var uVar0;
	var uVar1;
...
void Function_94(int iParam0) //Position: 0x4D5D / 19805
{
	int iVar0;
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4D90 / 19856
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_96() //Position: 0x4E1C / 19996
{
	var uVar0;
	int iVar1;
...
var Function_97(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4E8C / 20108
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_98(struct<205> Param0) //Position: 0x4F32 / 20274
{
	var uVar0;
	var uVar1;
...
var Function_99(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x503D / 20541
{
	int iVar0;
	int iVar1;
...
void Function_100(struct<13> Param0) //Position: 0x507B / 20603
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_101(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x508E / 20622
{
	int iVar0;
...
bool Function_102(struct<2>[] Param0) //Position: 0x515D / 20829
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x551F / 21791
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x555F / 21855
{
	int iVar0;
...
void Function_105() //Position: 0x558D / 21901
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(vector3 vParam0) //Position: 0x55CF / 21967
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5667 / 22119
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5696 / 22166
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x56F1 / 22257
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x5701 / 22273
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5715 / 22293
{
	int iVar0;
...
var Function_112() //Position: 0x573A / 22330
{
	return "PackedMetadata";
}

void Function_113(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5751 / 22353
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_114() //Position: 0x588D / 22669
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_115() //Position: 0x589F / 22687
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_116() //Position: 0x58B1 / 22705
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_117(var uParam0, struct<5> Param1) //Position: 0x58C3 / 22723
{
...
var Function_118(var uParam0, int iParam1, int iParam2) //Position: 0x58E8 / 22760
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x5907 / 22791
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_120() //Position: 0x5913 / 22803
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x591E / 22814
{
	int iVar0;
...
var Function_122() //Position: 0x594C / 22860
{
	return "PackedWeapon";
}

int Function_123(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5961 / 22881
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_124() //Position: 0x5A6E / 23150
{
	return "MPItemGiver";
}

struct<32> Function_125(char* cParam0) //Position: 0x5A82 / 23170
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0) //Position: 0x5AEE / 23278
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5B10 / 23312
{
	return "PBox_";
}

var Function_128() //Position: 0x5B1E / 23326
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5B44 / 23364
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x5B6C / 23404
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x5B92 / 23442
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5CFC / 23804
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5DA4 / 23972
{
	int iVar0;
	struct<2> Var1;
...
void Function_134(int iParam0) //Position: 0x5F12 / 24338
{
...
var Function_135() //Position: 0x5F7A / 24442
{
	int iVar0;
...
var Function_136(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5F83 / 24451
{
	return Function_137(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5FA1 / 24481
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_138(int iParam0) //Position: 0x629A / 25242
{
	int iVar0;
...
void Function_139() //Position: 0x634E / 25422
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x6389 / 25481
{
	int iVar0;
...
void Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x63B6 / 25526
{
	int iVar0;
...
void Function_142() //Position: 0x6511 / 25873
{
	int iVar0;
...
var Function_143(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x655D / 25949
{
	int iVar0;
...
int Function_144() //Position: 0x6639 / 26169
{
	int iVar0;
...
int Function_145() //Position: 0x6795 / 26517
{
	int iVar0;
...
bool Function_146(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x68B5 / 26805
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_147(struct<2> Param0) //Position: 0x6991 / 27025
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_148(struct<2> Param0, struct<5> Param2) //Position: 0x69B0 / 27056
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_149(int iParam0) //Position: 0x6AF3 / 27379
{
	var uVar0;
...
bool Function_150(int iParam0) //Position: 0x6B15 / 27413
{
	int iVar0;
...
int Function_151() //Position: 0x6B31 / 27441
{
	return 0;
}

void Function_152(struct<321> Param0) //Position: 0x6B38 / 27448
{
	var uVar0;
