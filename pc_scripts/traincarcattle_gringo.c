...
bool Function_13(var uParam0) //Position: 0x56E / 1390
{
	...
	Function_23(3, 2);
	uVar0 = &uVar0;
	Function_21(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/cow_knl", 1, 0);
	Function_21(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/milk_cow", 1, 0);
	if (!Function_16(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_15()));
	*(&iLocal_0 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "TrainCarCattle_pop", 2,802597E-45f, Vector(0.0f, 2,199779f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(2,575523f, 2,490779f, 9,470821f));
	*(&iLocal_0 + 56) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "cow_knl", "cow_knl", Vector(-0,02731095f, 1,027933f, -3,265341f), Vector(0.0f, -43,35219f, 0.0f));
	*(&iLocal_0 + 64) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "cow_knl1", "cow_knl", Vector(0,5198239f, 1,027933f, 3,495657f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_0 + 72) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "cow_knl2", "cow_knl", Vector(-0,1917491f, 1,027933f, -1,371411f), Vector(0.0f, 6,866085f, 0.0f));
	*(&iLocal_0 + 80) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "milk_cow", "milk_cow", Vector(-0,4964082f, 1,027933f, 2,901009f), Vector(0.0f, -21,15021f, 0.0f));
	*(&iLocal_0 + 88) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "nmilk_cow1", "milk_cow", Vector(0.0f, 1,027933f, 1,420474f), Vector(0.0f, 85,09035f, 0.0f));
	*(&iLocal_0 + 96) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "nmilk_cow2", "milk_cow", Vector(0.0f, 1,027933f, 0.0f), Vector(0.0f, -32,61503f, 0.0f));
	Function_14(&iLocal_0, &uParam0);
	return 1;
}

void Function_14(bool bParam0, int iParam1) //Position: 0x79C / 1948
{
	var uVar0;
...
var Function_15() //Position: 0x7E7 / 2023
{
	int iVar0;
...
bool Function_16(struct<2>[] Param0) //Position: 0x7F0 / 2032
{
	int iVar0;
	int iVar1;
...
void Function_17() //Position: 0xBB2 / 2994
{
	if (!Function_25(128))
	{
		return;
...
void Function_19(struct<13> Param0) //Position: 0xC20 / 3104
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_20() //Position: 0xC33 / 3123
{
	if (!Function_25(128))
	{
		return;
...
var Function_21(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xC75 / 3189
{
	int iVar0;
	var uVar1;
...
var Function_22(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xCB3 / 3251
{
	int iVar0;
...
void Function_24(var uParam0, int iParam1) //Position: 0xDCC / 3532
{
	iParam1 = &iParam1;
	uParam0 = 0;
	return;
...
bool Function_25(int iParam0) //Position: 0xDDD / 3549
{
	int iVar0;
