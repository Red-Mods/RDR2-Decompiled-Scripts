...
void main() //Position: 0x0 / 0
{
	...
	iLocal_2 = 1;
	fLocal_3 = 2.0f;
	Local_40 = Vector(-3841,149f, 7,596f, 3664,383f);
	iLocal_45 = 2;
	iLocal_46 = 4;
	fLocal_47 = 70.0f;
...
{
	if (IS_VOLUME_VALID(&uLocal_43))
	{
		REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_43);
		REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_43);
		REMOVE_AI_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME_SET(&uLocal_43, 0);
		REMOVE_AI_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME_SET(&uLocal_43, 1);
		REMOVE_AI_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME_SET(&uLocal_43, 2);
		DESTROY_VOLUME(&uLocal_43);
	}
	if (IS_OBJECT_VALID(&uLocal_34))
	{
		DESTROY_OBJECT(&uLocal_34);
	}
	if (IS_OBJECT_VALID(&uLocal_32))
	{
		DESTROY_OBJECT(&uLocal_32);
	}
	RELEASE_LAYOUT_REF(&uLocal_38);
	Function_4(2, &uLocal_28, &iLocal_26, &uLocal_4, &uLocal_36, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x2B9 / 697
{
	bool bVar0;
	bool bVar1;
	int iVar2;
		...
		while (bVar0 <= SQUAD_GET_SIZE(&iParam2))
		{
			...
			if (IS_ACTOR_VALID(&iVar5))
			{
				...
				if (IS_GRINGO_VALID(&uVar6) && Global_6621)
				{
					...
					{
						DECOR_SET_BOOL(GET_OBJECT_FROM_GRINGO(&uVar6), "missioncampfireobj", true);
...
void Function_5(var uParam0, bool bParam1) //Position: 0x72B / 1835
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x75F / 1887
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xAA1 / 2721
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xAD4 / 2772
{
...
void Function_9(int iParam0) //Position: 0xAEB / 2795
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xB17 / 2839
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xB31 / 2865
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB4E / 2894
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC14 / 3092
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xDDD / 3549
{
...
void Function_15(int iParam0) //Position: 0xE1A / 3610
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xE33 / 3635
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xE40 / 3648
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xF35 / 3893
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF9B / 3995
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFFD / 4093
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0x1032 / 4146
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x124B / 4683
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x12C2 / 4802
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x132E / 4910
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x1356 / 4950
{
...
void Function_26(struct<13> Param0) //Position: 0x14A1 / 5281
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x14BE / 5310
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x14DC / 5340
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_47, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_142();
								(*&Param0 + 48)[1] = Function_141();
								Function_140(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_140(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_132(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_132(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_140(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_140(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_132(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_132(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_132(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_140(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_131(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_47, 20.0f, fLocal_47));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_127(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_131(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_102(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_98(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (!bParam2)
			{
				...
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				...
				while (IS_OBJECT_VALID(&uVar4))
				{
					...
					{
						DECOR_SET_BOOL(&uVar4, "ForceAllowSun", true);
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_131(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_131(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_131(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
				NET_OBJECT_REPLICATION_MODE_END(2);
				DECOR_SET_BOOL(&uParam1, "PropsCreated", true);
			}
			else if (!bParam2)
			{
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_131()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										DECOR_SET_BOOL(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false), "nconvAdded", true);
										DECOR_SET_BOOL(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, true), "nconvAdded", true);
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
					{
						...
						{
							SET_ACTOR_ALLOW_WEAPON_REACTIONS(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), true);
...
void Function_29(struct<62> Param0) //Position: 0x269B / 9883
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26AD / 9901
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x28E6 / 10470
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2906 / 10502
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x29F4 / 10740
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2C60 / 11360
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C84 / 11396
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2CA8 / 11432
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2CCE / 11470
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2CF5 / 11509
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2D19 / 11545
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2D38 / 11576
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D87 / 11655
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2DE3 / 11747
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2E04 / 11780
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2E5F / 11871
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2EAB / 11947
{
...
void Function_46(struct<425> Param0) //Position: 0x2EC0 / 11968
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3013 / 12307
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3088 / 12424
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x30A0 / 12448
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x30FE / 12542
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x314B / 12619
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x31C4 / 12740
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x3213 / 12819
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x32D2 / 13010
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x32E5 / 13029
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x33AC / 13228
{
...
bool Function_57(int iParam0) //Position: 0x33CC / 13260
{
...
bool Function_58(int iParam0) //Position: 0x33F0 / 13296
{
...
bool Function_59(int iParam0) //Position: 0x3405 / 13317
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x341C / 13340
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x345A / 13402
{
...
bool Function_62(int iParam0) //Position: 0x3474 / 13428
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x348A / 13450
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x34C4 / 13508
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > bParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_131(), bParam2[iVar0], Var1, Var3);
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x35A9 / 13737
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_131(), bParam3, Var2, Var4);
	SET_ACTOR_STAY_WITHIN_VOLUME(&uVar6, &uParam5, 2, 2);
	SET_ACTOR_ALLOW_WEAPON_REACTIONS(&uVar6, true);
	...
	if (bVar0)
	{
		...
		TASK_USE_GRINGO(&uVar6, GET_GRINGO_FROM_OBJECT(&uParam4), "UseCase1", bVar1, 1);
...
void Function_66(var uParam0, bool bParam1) //Position: 0x3760 / 14176
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3785 / 14213
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x37D3 / 14291
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x392A / 14634
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x39D5 / 14805
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A7B / 14971
{
	Function_140(&uLocal_4, 1202, 3, 0);
	Function_140(&uLocal_4, 546, 3, 0);
	Function_95(&uLocal_4, "$/content/scripting/gringo/simplegringo/stool_sit_attach_indef", 1, 0);
	Function_95(&uLocal_4, "p_gen_bag01x", 0, 0);
	Function_95(&uLocal_4, "p_gen_stool02x", 0, 0);
	if (!IS_LAYOUTREF_VALID(&uLocal_36))
	{
		uLocal_36 = CREATE_LAYOUT("zombie02campfirelayout");
	}
	if (Function_83(&uLocal_28, 546, &uLocal_4, 2, &uLocal_36, "zombie02merchant", 1, 1, 1, 0, 0) && !WOULD_ACTOR_BE_VISIBLE(1202, &Local_40, 3212836864))
	{
		if (Function_81(&uLocal_38, "merchant05mobile", &iParam1))
		{
			iLocal_26 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_38, Function_131()));
			*(&Global_6667[228] + 216) = &iLocal_26;
			*(&iParam0 + 24) = &uLocal_38;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3BB9 / 15289
{
	var uVar0;
	var uVar2;
	struct<2> Var3;
	...
	uLocal_32 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, Function_131(), "p_gen_stool02x", Vector(-3860,191f, 8,012622f, 3668,214f), Vector(0.0f, -90.0f, 0.0f), true);
	uLocal_34 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, Function_131(), "p_gen_bag01x", Vector(-3859,842f, 8,0319f, 2669,186f), Vector(0.0f, -86,1598f, 0.0f), true);
	uLocal_30 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_36, Function_131(), "stool_sit_attach_indef", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	ATTACH_OBJECTS(StackVal, StackVal, &uLocal_30, &uLocal_32, Function_131(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
	uVar0 = Vector(-3856,289f, 8,315f, 3668,06f);
	TELEPORT_ACTOR(&uLocal_28, &uVar0, 1, 1, 1);
	TASK_STAND_STILL(&uLocal_28, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(&uLocal_28);
	SQUAD_JOIN(&uLocal_28, &iLocal_26);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_28, 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_28, &uLocal_30, "UseCase1", true, 0, 0);
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uLocal_28, 1);
	TASK_USE_GRINGO(&uLocal_28, GET_GRINGO_FROM_OBJECT(&uLocal_30), "UseCase1", 4294967295, 1);
	TASK_PRIORITY_SET(&uLocal_28, true);
	Function_79(&uLocal_28, &iLocal_26, 1, 1);
	uLocal_43 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_36, "zombie02_vol", 2,802597E-45f, Vector(-3859,997f, 7,974345f, 3665,969f), Vector(0.0f, 0.0f, 0.0f), Vector(65.0f, 35.0f, 65.0f));
	ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_43);
	ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_43);
	if (!Function_78(1202, &uVar2, &uLocal_36, 0))
	{
		uVar2 = Function_74(StackVal, StackVal, &uLocal_36, "merchant_coach", 1202, 976, Local_40, Vector(0.0f, 216,15f, 0.0f), 1, 976, 976, 976, 4);
	}
	STOP_VEHICLE(&uVar2);
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_ACTOR(&uVar2), true);
	Function_79(&uVar2, &iLocal_26, 1, 1);
	Var3 = Vector(-3862,622f, 8,109f, 3664,495f);
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "tempPhysVol", 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_73(&uLocal_36, "blanket", &uVar5);
	if (IS_VOLUME_VALID(&uVar5))
	{
		DESTROY_VOLUME(&uVar5);
	}
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x1", "p_gen_crateMedicine01x", Vector(-3269,51f, 15,795f, 2727,51f), Vector(180.0f, -88,9998f, -180.0f), true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x2", "p_gen_crateMedicine01x", Vector(-3269,49f, 15,795f, 2726,75f), Vector(0.0f, -89,1063f, 0.0f), true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x3", "p_gen_crateMedicine01x", Vector(-3269,47f, 16,0886f, 2726,76f), Vector(158,641f, -88,1115f, -159,525f), true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x6", "p_gen_crateMedicine01x", Vector(-3257,99f, 16,3181f, 2727,15f), Vector(-180.0f, -89,9407f, 180.0f), true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x8", "p_gen_crateMedicine01x", Vector(-3257,7f, 16,3266f, 2727,14f), Vector(179,177f, -86,1352f, -180.0f), true);
	CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_36, "p_gen_crateMedicine01x9", "p_gen_crateMedicine01x", Vector(-3257,72f, 16,614f, 2727,15f), Vector(-180.0f, -88,9998f, 180.0f), true);
	return;
}

void Function_73(var uParam0, char* cParam1, bool bParam2) //Position: 0x4021 / 16417
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	iVar1 = CREATE_OBJECTSET_IN_LAYOUT(Function_131(), &uParam0, 4294967295, 1);
	LOCATE_PHYSINSTS_OF_PARTIAL_TYPE(&iVar1, &bParam2, &cParam1, 1);
...
var Function_74(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x408B / 16523
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(&uVar0))
	{
		...
		while (bVar9 < (iVar10 - 1))
		{
			...
			uVar15 = "";
			if (Function_77(&(Global_46972[6]), 4, 23, 0) && uParam8)
			{
				bVar16 = Function_76(StackVal, &(Global_46972[6]), Param4, 4, 23, 0);
...
bool Function_75(int iParam0, bool[] bParam1) //Position: 0x42DE / 17118
{
	int iVar0;
...
var Function_76(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x4312 / 17170
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_77(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x432E / 17198
{
...
bool Function_78(int iParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x435A / 17242
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_79(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x4486 / 17542
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_80(&uParam0, &iParam1, 1))
	{
		SQUAD_JOIN(&uParam0, &iParam1);
	}
	DECOR_SET_BOOL(&uParam0, "MissionCampfireActor", true);
	...
	{
		ENABLE_VEHICLE_SEAT(&uParam0, false, 0);
		ENABLE_VEHICLE_SEAT(&uParam0, true, 0);
		...
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(&uParam0))
		{
			...
			if (IS_ACTOR_VALID(&iVar1))
			{
				if (!Function_80(&iVar1, &iParam1, 1))
				{
				...
				DECOR_SET_BOOL(&iVar1, "MissionCampfireActor", true);
			}
			bVar0++;
		}
	}
...
bool Function_80(int iParam0, int iParam1, bool bParam2) //Position: 0x4643 / 17987
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_81(var uParam0, var uParam1, int iParam2) //Position: 0x468B / 18059
{
	...
	Function_82(&uParam0, &iParam2);
	return 1;
	return 0;
}

void Function_82(var uParam0, bool bParam1) //Position: 0x46BB / 18107
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_131(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
int Function_83(var uParam0, bool bParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9, bool bParam10) //Position: 0x4706 / 18182
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	if (HUD_IS_FADED() && uParam6)
	{
		return 0;
	}
	if (!Function_94(&(Global_6667[iParam328])) && uParam7)
	{
		return 0;
	}
	if (&bParam10)
	{
		uVar0 = Function_93(StackVal, (&Global_6667[iParam328] + 88), 0, 1, 1);
		if (Function_90(uVar0))
		{
			if (Function_98(&iParam2))
			{
				return 1;
			}
			return 0;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		if (!&bParam9)
		{
			SET_DRAW_ACTOR(&uParam0, &bParam9);
	...
	if (StackVal || !Function_88((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam328].f_5614] + 16, &Global_6667[iParam328] + 88, 3212836864) || !&bParam8), &Global_54076, *(&Global_6667[iParam328] + 88), 50.0f))
	{
		iVar1 = Function_93(StackVal, *(&Global_6667[iParam328] + 88), 0, 1, 1);
		if (Function_90(iVar1))
		{
			if (Function_98(&iParam2))
			{
				if (!IS_ACTOR_VALID(&uParam0))
				{
					...
					{
						case 0x00000004:
							uVar2 = Vector(-784,289f, 93,83f, 2401,439f);
							break;
						
						default:
							uVar2 = *(&Global_6667[iParam328] + 88);
							break;
					}
					uParam0 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uParam4, &uParam5, bParam1, *(&Global_6667[iParam328] + 88), Vector(0.0f, 0.0f, 0.0f));
					Function_84(&uParam0);
				}
			}
		}
...
void Function_84(int iParam0) //Position: 0x48E5 / 18661
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		TASK_CLEAR(&iParam0);
		...
		Function_87(&iParam0, 0, 0, 0, 0);
		SET_ACTOR_FACTION(&iParam0, 20);
		MEMORY_CONSIDER_AS(&iParam0, &Global_54076, false);
		SET_ACTOR_ALLOW_DISARM(&iParam0, false);
		AI_ACTOR_SET_MATCH_WALK_SPEED_ENABLED(&iParam0, 1);
		TOGGLE_ACTOR_ACTION_SIGNAL_ON(&iParam0, 8, "FASTWALK");
		if (IS_ACTOR_HOGTIED(&iParam0))
		{
			FREE_FROM_HOGTIE(&iParam0);
		}
		UNK_0x99AFD2D1(&iParam0, 1, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 12, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 13, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 14, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 64, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 65, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 66, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 67, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 68, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 46, 0);
		LIMIT_BLOOD_ON_ACTOR(&iParam0, 3);
		SET_ACTOR_IS_COMPANION(&iParam0, 1);
		SET_ACTOR_ALLOW_WEAPON_REACTIONS(&iParam0, false);
		SET_ACTOR_IS_AMBIENT(&iParam0, 0);
		AI_SET_ENABLE_HORSE_CHARGE_REACTIONS(&iParam0, 0);
		SET_ACTOR_ALLOW_PLAYER_GREET_RESPONSES(&iParam0, 0);
		SET_ACTOR_CAN_PLAY_BORED_IDLES(&iParam0, 0);
		Function_86(&iParam0, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 111, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 112, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 30, 0);
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(&iParam0, 31, 0);
		SET_ACTOR_MOVE_CONFLICT_HIGH_PRIORITY(&iParam0, 1);
		SET_ACTOR_MOVE_CONFLICT_ALLOWED_TO_RUN_OVER_SMALL_ANIMALS(&iParam0, 1);
		AI_SET_NAV_FAILSAFE_MOVEMENT_ENABLED(&iParam0, 1);
		if (DECOR_CHECK_EXIST(&iParam0, "hidden"))
		{
			DECOR_REMOVE(&iParam0, "hidden");
		}
		SET_DRAW_ACTOR(&iParam0, 1);
		SET_ACTOR_WEAPON_REACTION_ACTOR_TYPE(&iParam0, 4);
		...
		SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&iParam0, 1);
	}
	return;
}

void Function_85(var uParam0, bool bParam1) //Position: 0x4A89 / 19081
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_86(var uParam0, bool bParam1) //Position: 0x4AD8 / 19160
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_87(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4AFA / 19194
{
	var uVar0;
...
bool Function_88(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4B5B / 19291
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_89() //Position: 0x4BE7 / 19431
{
	var uVar0;
	int iVar1;
...
bool Function_90(int iParam0) //Position: 0x4C57 / 19543
{
	if (!Function_92(iParam0))
	{
		return 1;
	}
	return Function_91(&(Global_43791[iParam0]), 4);
}

int Function_91(var uParam0, int iParam1) //Position: 0x4C73 / 19571
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x4C90 / 19600
{
...
var Function_93(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4CA6 / 19622
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_94(struct<205> Param0) //Position: 0x4D4C / 19788
{
	var uVar0;
	var uVar1;
...
var Function_95(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4E57 / 20055
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_97(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
		Function_96(&(Param0[iVar02]), 8);
	}
	return iVar0;
}

void Function_96(struct<13> Param0) //Position: 0x4E95 / 20117
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_97(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4EA8 / 20136
{
	int iVar0;
...
bool Function_98(struct<2>[] Param0) //Position: 0x4F77 / 20343
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x5339 / 21305
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x5379 / 21369
{
	int iVar0;
...
void Function_101() //Position: 0x53A7 / 21415
{
	if (!Function_147(128))
	{
		return;
...
void Function_102(vector3 vParam0) //Position: 0x53E9 / 21481
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_103(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_103(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_103(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5481 / 21633
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_104(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_104(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x54B0 / 21680
{
	Function_119(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_109(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_108(), Function_107(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_106(), Function_105(&uParam11, &uParam12));
}

var Function_105(var uParam0, bool bParam1) //Position: 0x550B / 21771
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_106() //Position: 0x551B / 21787
{
	return "PackedGrass";
}

var Function_107(bool bParam0, bool bParam1, bool bParam2) //Position: 0x552F / 21807
{
	int iVar0;
...
var Function_108() //Position: 0x5554 / 21844
{
	return "PackedMetadata";
}

void Function_109(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x556B / 21867
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_118(), &uVar4))
				{
					Function_113(uVar4, &bVar5);
...
struct<8> Function_110() //Position: 0x56A7 / 22183
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_111() //Position: 0x56B9 / 22201
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_112() //Position: 0x56CB / 22219
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_113(var uParam0, struct<5> Param1) //Position: 0x56DD / 22237
{
	Param1 = Function_114(uParam0, Function_116(), 0);
	Param1.f_4 = Function_114(uParam0, Function_116() + 8, Function_116());
	return;
}

var Function_114(var uParam0, int iParam1, int iParam2) //Position: 0x5702 / 22274
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_115((iParam1 - 1)), true) - 1);
	return SHIFT_RIGHT((iVar0 && uParam0), iParam2);
}

var Function_115(bool bParam0) //Position: 0x5721 / 22305
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_116() //Position: 0x572D / 22317
{
	return Function_117(39);
}

int Function_117(int iParam0) //Position: 0x5738 / 22328
{
	int iVar0;
...
var Function_118() //Position: 0x5766 / 22374
{
	return "PackedWeapon";
}

int Function_119(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x577B / 22395
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_123(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_121(Function_123()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_120(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_120() //Position: 0x5888 / 22664
{
	return "MPItemGiver";
}

struct<32> Function_121(char* cParam0) //Position: 0x589C / 22684
{
	char* cVar0[32];
	char* cVar8[16];
	...
	else
	{
		...
		{
			memcpy(&cVar8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_122("0", &cVar8, ""), 4);
		}
...
struct<32> Function_122(char* cParam0) //Position: 0x5908 / 22792
{
	char* cVar0[32];
...
var Function_123() //Position: 0x592A / 22826
{
	return "PBox_";
}

var Function_124() //Position: 0x5938 / 22840
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_125() //Position: 0x595E / 22878
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_126() //Position: 0x5986 / 22918
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_127(var uParam0, int iParam1) //Position: 0x59AC / 22956
{
	int iVar0;
	var uVar1;
	...
	while (iVar0 <= 25)
	{
		...
		{
			Function_128(iVar0, &uParam0, &uVar1, &iParam1);
			return 1;
		}
		iVar0++;
	}
...
void Function_128(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5B16 / 23318
{
	struct<8> Var0;
	
	*(&Global_39621[iParam05] + 16) = &uParam1;
	Global_39621[iParam05].f_32 = GET_CURRENT_GAME_TIME();
	Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_121("stayout") };
...
int Function_129(bool bParam0) //Position: 0x5BBE / 23486
{
	int iVar0;
	struct<2> Var1;
...
void Function_130(int iParam0) //Position: 0x5D2C / 23852
{
...
var Function_131() //Position: 0x5D94 / 23956
{
	int iVar0;
...
var Function_132(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5D9D / 23965
{
	return Function_133(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_133(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5DBB / 23995
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_138(bVar1))
	{
		...
		{
			Function_137(&uParam0, bParam1, iParam2, iParam3, bParam4);
	...
	if (bParam1 || (!iParam3 != 4294967295 && !iParam3 != GET_ACTORENUM_SPECIES(bVar1)))
	{
		...
		{
			while (Function_136(bVar0) && iVar2 > 20)
			{
...
void Function_134(int iParam0) //Position: 0x60B4 / 24756
{
	int iVar0;
...
void Function_135() //Position: 0x6168 / 24936
{
	int iVar0;
...
bool Function_136(bool bParam0) //Position: 0x61A3 / 24995
{
	int iVar0;
...
void Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x61D0 / 25040
{
	bool bVar0;
...
bool Function_138(bool bParam0) //Position: 0x632B / 25387
{
...
void Function_139() //Position: 0x6342 / 25410
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x638E / 25486
{
	int iVar0;
...
int Function_141() //Position: 0x646A / 25706
{
	int iVar0;
...
int Function_142() //Position: 0x65C6 / 26054
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x66E6 / 26342
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x67C2 / 26562
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x67E1 / 26593
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x6924 / 26916
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x6946 / 26950
{
	int iVar0;
...
int Function_148() //Position: 0x6962 / 26978
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x6969 / 26985
{
	var uVar0;
	
	Param0.f_8 = 0;
	Param0.f_320 = 0;
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_121("campfire"), 4);
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_97(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_97(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
