	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_34(Global_46894[3]))
			{
				...
				{
					Function_27("FiveFingerFillet_NotEnoughMoney", 4.0f, 0, 2, 1, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_26(Global_46894[3], &iLocal_35 + 4, &iLocal_35 + 48, &iLocal_35 + 56))
			{
				Function_25(&(Global_46894[3]));
				Function_24(&iLocal_35 + 4);
				Function_18(Global_46894[3]);
				(&iLocal_35 + 188[02]) = Function_18(Global_46894[3]);
				Function_17(Global_46894[3]);
				*(&iLocal_35 + 188[12]) = Function_17(Global_46894[3]);
				iLocal_35 = Local_6;
...
void Function_20() //Position: 0xB99 / 2969
{
	Function_1();
	return;
}

bool Function_21(int iParam0) //Position: 0xBA2 / 2978
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_22(int iParam0, bool bParam1) //Position: 0xBC3 / 3011
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xBFA / 3066
{
	if (!Function_8(iParam0))
	{
		return;
...
void Function_24(int[] iParam0) //Position: 0xC15 / 3093
{
	int iVar0;
	var uVar1;
...
void Function_25(int iParam0) //Position: 0xC71 / 3185
{
	var uVar0;
	var uVar2;
	int iVar3;
...
bool Function_26(int iParam0, bool[] bParam1, bool bParam2, var uParam3) //Position: 0xEBC / 3772
{
	var uVar0;
	var uVar2;
	int iVar3;
...
void Function_27(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x1202 / 4610
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_28(int iParam0) //Position: 0x1287 / 4743
{
	char* cVar0[16];
...
bool Function_29() //Position: 0x12C6 / 4806
{
...
bool Function_30(var uParam0, bool bParam1) //Position: 0x12E1 / 4833
{
	return (uParam0 && bParam1) == 0;
}

int Function_31() //Position: 0x12EE / 4846
{
	return Function_32(0);
}

int Function_32(int iParam0) //Position: 0x12F8 / 4856
{
...
var Function_33(int iParam0) //Position: 0x1339 / 4921
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_34(int iParam0) //Position: 0x1353 / 4947
{
...
int Function_35(var uParam0, int iParam1) //Position: 0x136F / 4975
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0x138C / 5004
{
...
void Function_37() //Position: 0x13A2 / 5026
{
	Function_1();
	return;
}

void Function_38() //Position: 0x13AB / 5035
{
...
void Function_39(int iParam0) //Position: 0x13F8 / 5112
{
...
void Function_40(vector3 vParam0) //Position: 0x140F / 5135
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x1434 / 5172
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x144A / 5194
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_43(var uParam0) //Position: 0x145B / 5211
{
	return Function_30(uParam0, 1);
}

void Function_44() //Position: 0x1469 / 5225
{
	return;
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x146F / 5231
{
	var uVar0;
...
void Function_46(var uParam0) //Position: 0x14CE / 5326
{
	int iVar0;
...
var Function_47() //Position: 0x14EB / 5355
{
	var uVar0;
