...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	uLocal_11 = Vector(-2687,092f, 31,424f, 4289,672f);
	iLocal_18 = 2;
	iLocal_19 = 4;
	fLocal_20 = 70.0f;
...
void Function_3() //Position: 0x24C / 588
{
	...
	{
		if (DECOR_CHECK_EXIST(&uLocal_3, "bACTOR_AVOID_SMALLBRAINS"))
		{
			DECOR_REMOVE(&uLocal_3, "bACTOR_AVOID_SMALLBRAINS");
		}
	}
	RELEASE_LAYOUT_REF(&uLocal_16);
	Function_4(5, &uLocal_3, &uLocal_5, &uLocal_14, 4294967295);
	return;
}

void Function_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2B5 / 693
{
	int iVar0;
...
void Function_5(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x2DA / 730
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (SQUAD_IS_VALID(&iParam2))
	{
		if (&iParam5 > 0)
		{
			Function_22(&(Global_6667[&iParam528]));
		}
		bVar0 = false;
		...
		if (Function_20(&iParam2, &Global_54076))
		{
			bVar1 = true;
		}
		bVar0 = false;
		while (bVar0 <= SQUAD_GET_SIZE(&iParam2))
		{
			...
			if (IS_ACTOR_VALID(&iVar5))
			{
				...
				{
					if (Function_19(GET_OBJECT_FROM_GRINGO(&uVar6), &uParam4))
					{
	...
	switch (&iParam5)
	{
		...
		case 0x00000033:
		case 0x00000039:
			if (GET_LAST_ATTACKER(&iParam1) != &Global_54076 || ((((Global_6667[&iParam528].f_208 && !Function_14(&iParam1, &uVar8, &uVar7, 0, 0, 0x40400000)) && !HUD_IS_FADED()) && !HUD_IS_FADING()) && !Global_6638))
			{
				UI_SET_TEXT("Death_Explanation", "kill_family_help");
				KILL_ACTOR(&Global_54076);
			}
			else if (Global_6667[&iParam528].f_208 && Function_14(&iParam1, &uVar8, &uVar7, 0, 0, 0x40400000))
			{
				if (bParam0 == 11)
				{
					Function_13(StackVal, &iParam1, Vector(-105,606f, 119,513f, 1362,295f), 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 12)
				{
					Function_13(StackVal, &iParam1, Vector(-104,413f, 119,521f, 1367,917f), 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 13)
				{
					Function_13(StackVal, &iParam1, Vector(-102,615f, 119,513f, 1364,342f), 10.0f, 1, 120.0f, 0x40c00000);
				}
...
void Function_6(var uParam0, bool bParam1) //Position: 0x74C / 1868
{
...
int Function_7(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x780 / 1920
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_8(var uParam0) //Position: 0xAC2 / 2754
{
	int iVar0;
...
void Function_9(int iParam0) //Position: 0xAF5 / 2805
{
...
void Function_10(int iParam0) //Position: 0xB0C / 2828
{
	if (Function_12(&Global_6667[iParam028] + 184, 8388608))
	{
		Function_11(&Global_6667[iParam028] + 184, 8388608);
	}
	return;
}

void Function_11(var uParam0, int iParam1) //Position: 0xB38 / 2872
{
	int iVar0;
...
bool Function_12(int iParam0, int iParam1) //Position: 0xB52 / 2898
{
	int iVar0;
...
void Function_13(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xB6F / 2927
{
	var uVar0;
	bool bVar1;
...
bool Function_14(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xC35 / 3125
{
	float fVar0;
...
void Function_15(int iParam0) //Position: 0xDFE / 3582
{
...
void Function_16(int iParam0) //Position: 0xE3B / 3643
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_17(var uParam0, int iParam1) //Position: 0xE54 / 3668
{
	return (uParam0 && iParam1) == 0;
}

var Function_18(var uParam0, int iParam1) //Position: 0xE61 / 3681
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_19(int iParam0, var uParam1) //Position: 0xF56 / 3926
{
	var uVar0;
	int iVar1;
...
bool Function_20(var uParam0, int iParam1) //Position: 0xFBC / 4028
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_21(int iParam0) //Position: 0x101E / 4126
{
	bool bVar0;
...
int Function_22(struct<209> Param0) //Position: 0x1053 / 4179
{
	int iVar0;
	var uVar1;
	var uVar2;
			...
			while (bVar3 <= SQUAD_GET_SIZE(&Param0 + 216))
			{
				...
				if (IS_ACTOR_VALID(&iVar4))
				{
					if (!IS_ACTOR_VEHICLE(&iVar4))
					{
						...
						if (Function_14(&iVar4, &uVar2, &uVar1, 0, 0, 0x40400000) && ((Param0.f_56 != 11 || Param0.f_56 != 12) || Param0.f_56 != 13))
						{
							Function_21(&Param0 + 216);
							SQUAD_GOALS_CLEAR(&Param0 + 216);
							Param0.f_208 = 1;
	...
	else if (Function_23(StackVal, &Global_54076, *(&Param0 + 88)) < 100.0f)
	{
		Param0.f_208 = 0;
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&Param0 + 64)))
		{
...
float Function_23(var uParam0, struct<2> Param1) //Position: 0x126C / 4716
{
	struct<2> Var0;
...
struct<8> Function_24(int iParam0) //Position: 0x12E3 / 4835
{
	struct<2> Var0;
...
void Function_25(int iParam0) //Position: 0x134F / 4943
{
	int iVar0;
...
void Function_26(struct<2>[] Param0, int iParam1) //Position: 0x1377 / 4983
{
...
void Function_27(struct<13> Param0) //Position: 0x14C2 / 5314
{
	int iVar0;
...
bool Function_28(struct<13> Param0) //Position: 0x14DF / 5343
{
	int iVar0;
...
var Function_29(struct<477> Param0) //Position: 0x14FD / 5373
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if (Global_6611)
			{
				if (Function_23(StackVal, &Global_54076, Var7) < 10.0f)
				{
					break;
				}
			}
			if ((Global_39620 + 1 > iLocal_18 || bParam2) || Global_6611)
			{
				if (Function_145(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_143(&Param0 + 324, &fLocal_20, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_133(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_133(&(Global_46972[6]), 0, 4, 23, 1);
							...
							{
								(*&Param0 + 96)[0] = Function_133(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_133(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_133(&uVar3, 1, 0, 4294967295, 1);
								}
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_20, 20.0f, fLocal_20));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_128(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_132(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000002:
			...
			{
				if (((Function_23(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						if (IS_OBJECT_VALID(&Param0 + 352))
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_132(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_132(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_69(StackVal, StackVal, &Param0 + 16, Function_132(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_132()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_22 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_22) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_14(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_21, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_30(struct<62> Param0) //Position: 0x26BC / 9916
{
...
void Function_31(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26CE / 9934
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_32(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2907 / 10503
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_33(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2927 / 10535
{
	bool bVar0;
	var uVar1;
...
int Function_34(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2A15 / 10773
{
	char* cVar0[32];
...
int Function_35(int iParam0) //Position: 0x2C81 / 11393
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_36(var uParam0, bool bParam1) //Position: 0x2CA5 / 11429
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2CC9 / 11465
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2CEF / 11503
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_39(var uParam0, bool bParam1) //Position: 0x2D16 / 11542
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_40(bool bParam0) //Position: 0x2D3A / 11578
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_41() //Position: 0x2D59 / 11609
{
...
bool Function_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2DA8 / 11688
{
	bool bVar0;
	var uVar1;
...
bool Function_43(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E04 / 11780
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_44(var uParam0, int iParam1) //Position: 0x2E25 / 11813
{
	bool bVar0;
	var uVar1;
...
void Function_45(var uParam0, var uParam1, bool bParam2) //Position: 0x2E80 / 11904
{
	bool bVar0;
	var uVar1;
...
var Function_46() //Position: 0x2ECC / 11980
{
...
void Function_47(struct<425> Param0) //Position: 0x2EE1 / 12001
{
	bool bVar0;
	bool bVar1;
...
bool Function_48(var uParam0, struct<2> Param1, float fParam3) //Position: 0x3034 / 12340
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			{
				Function_24(&iVar1);
				if (VDIST(Function_24(&iVar1), Param1) >= fParam3)
				{
					iVar2 = 1;
				}
			}
...
bool Function_49(vector3 vParam0) //Position: 0x30A9 / 12457
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_50(var uParam0) //Position: 0x30C1 / 12481
{
	bool bVar0;
	int iVar1;
...
var Function_51(bool bParam0) //Position: 0x311F / 12575
{
	bool bVar0;
	bool bVar1;
...
void Function_52(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x316C / 12652
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x31E5 / 12773
{
	bool bVar0;
	var uVar1;
...
void Function_54(var uParam0) //Position: 0x3234 / 12852
{
	struct<21> Var0;
...
bool Function_55() //Position: 0x32F3 / 13043
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_56(struct<25> Param0) //Position: 0x3306 / 13062
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_57(int iParam0) //Position: 0x33CD / 13261
{
...
bool Function_58(int iParam0) //Position: 0x33ED / 13293
{
...
bool Function_59(int iParam0) //Position: 0x3411 / 13329
{
...
bool Function_60(int iParam0) //Position: 0x3426 / 13350
{
...
bool Function_61(int iParam0, bool bParam1) //Position: 0x343D / 13373
{
	int iVar0;
...
var Function_62(int iParam0) //Position: 0x347B / 13435
{
...
bool Function_63(int iParam0) //Position: 0x3495 / 13461
{
...
int Function_64(int iParam0, struct<6> Param1) //Position: 0x34AB / 13483
{
	int iVar0;
...
void Function_65(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x34E5 / 13541
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_132(), bParam2[iVar0], Var1, Var3);
...
void Function_66(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x35CA / 13770
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_132(), bParam3, Var2, Var4);
...
void Function_67(var uParam0, bool bParam1) //Position: 0x3781 / 14209
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_68(bool bParam0) //Position: 0x37A6 / 14246
{
	var uVar0;
	int iVar1;
...
var Function_69(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x37F4 / 14324
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_70(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x394B / 14667
{
	var uVar0[5];
	int iVar6;
...
int Function_71(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x39F6 / 14838
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3A9C / 15004
{
	if (Function_78(&uLocal_3, 32, 0))
	{
		uLocal_9 = LOCATE_GRINGO_OF_TYPE("mex_drunk_sittable", &uLocal_11, 1.0f, 1);
		if (IS_GRINGO_VALID(&uLocal_9))
		{
			if (Function_76(&uLocal_16, "gun02mobile", &iParam1))
			{
				uLocal_5 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_16, Function_132()));
				*(&Global_6667[3228] + 216) = &uLocal_5;
				*(&iParam0 + 24) = &uLocal_16;
				Function_73();
				return 1;
			}
		}
...
void Function_73() //Position: 0x3B19 / 15129
{
	uLocal_14 = CREATE_LAYOUT("gun02campfirelayout");
	uLocal_7 = FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Gun02");
	ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_7);
	ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_7);
	CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_7, 15);
	CLEAR_AMBIENT_OBJECTS_VOLUME(&uLocal_7, 24);
	RESET_PROPS_IN_VOLUME(&uLocal_7, 1);
	DECOR_SET_BOOL(&uLocal_3, "bACTOR_AVOID_SMALLBRAINS", 1);
	SNAP_ACTOR_TO_GRINGO(&uLocal_3, GET_OBJECT_FROM_GRINGO(&uLocal_9), "UseCase1", false, 0, 0);
	TASK_USE_GRINGO(&uLocal_3, &uLocal_9, "UseCase1", 4294967295, 1);
	Function_74(&uLocal_3, &uLocal_5, 1, 1);
	return;
}

void Function_74(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3BE5 / 15333
{
	bool bVar0;
	int iVar1;
	...
	if (!Function_75(&uParam0, &iParam1, 1))
	{
...
bool Function_75(int iParam0, int iParam1, bool bParam2) //Position: 0x3DA2 / 15778
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_76(var uParam0, var uParam1, int iParam2) //Position: 0x3DEA / 15850
{
	...
	Function_77(&uParam0, &iParam2);
	return 1;
	return 0;
}

void Function_77(var uParam0, int iParam1) //Position: 0x3E1A / 15898
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &iParam1, Function_132(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_78(var uParam0, var uParam1, bool bParam2) //Position: 0x3E65 / 15973
{
	var uVar0;
	
	uVar0 = 1;
	return Function_79(&uParam0, &uVar0, uParam1, &bParam2, 1, 1, 0, 0, 0, 0, 0);
}

int Function_79(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3E84 / 16004
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_80(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4064 / 16484
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_81(var uParam0, bool bParam1) //Position: 0x45A4 / 17828
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_82(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x45C6 / 17862
{
	var uVar0;
...
var Function_83(bool bParam0, int iParam1) //Position: 0x4627 / 17959
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_84(var uParam0, int iParam1) //Position: 0x46B5 / 18101
{
	Function_86(&uParam0);
	Function_85(&uParam0);
...
void Function_85(int iParam0) //Position: 0x46E1 / 18145
{
...
void Function_86(int iParam0) //Position: 0x4707 / 18183
{
...
bool Function_87(bool bParam0) //Position: 0x47DD / 18397
{
...
var Function_88(int iParam0, int iParam1) //Position: 0x47F4 / 18420
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x489A / 18586
{
	var uVar0;
	var uVar1;
...
void Function_90(var uParam0) //Position: 0x49A9 / 18857
{
	int iVar0;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x49DC / 18908
{
	int iVar0;
...
bool Function_92(int iParam0, struct<2> Param1, float fParam3) //Position: 0x49F9 / 18937
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_24(&iParam0);
		if (VDIST(Function_24(&iParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
void Function_93() //Position: 0x4A85 / 19077
{
	var uVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x4AF5 / 19189
{
...
bool Function_95(int iParam0) //Position: 0x4B11 / 19217
{
...
var Function_96(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4B27 / 19239
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(struct<205> Param0) //Position: 0x4BCD / 19405
{
	var uVar0;
	var uVar1;
	...
	if (!Param0.f_184 != 0)
	{
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_12(&Param0 + 184, 1024))
				{
					return 0;
				}
				break;
		}
		if (Function_12(&Param0 + 184, 4096))
		{
			if (Function_12(&Param0 + 184, 1))
			{
...
bool Function_98(struct<2>[] Param0) //Position: 0x4CD8 / 19672
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x509A / 20634
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x50DA / 20698
{
	int iVar0;
...
void Function_101(struct<13> Param0) //Position: 0x5108 / 20744
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_102() //Position: 0x511B / 20763
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(vector3 vParam0) //Position: 0x515D / 20829
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_104(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_104(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_104(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x51F5 / 20981
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_105(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_105(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5224 / 21028
{
	Function_120(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_110(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_109(), Function_108(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_107(), Function_106(&uParam11, &uParam12));
}

var Function_106(var uParam0, bool bParam1) //Position: 0x527F / 21119
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x528F / 21135
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x52A3 / 21155
{
	int iVar0;
...
var Function_109() //Position: 0x52C8 / 21192
{
	return "PackedMetadata";
}

void Function_110(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x52DF / 21215
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_119(), &uVar4))
				{
					Function_114(uVar4, &bVar5);
...
struct<8> Function_111() //Position: 0x541B / 21531
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_112() //Position: 0x542D / 21549
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_113() //Position: 0x543F / 21567
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_114(var uParam0, struct<5> Param1) //Position: 0x5451 / 21585
{
	Param1 = Function_115(uParam0, Function_117(), 0);
	Param1.f_4 = Function_115(uParam0, Function_117() + 8, Function_117());
	return;
}

var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x5476 / 21622
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x5495 / 21653
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_117() //Position: 0x54A1 / 21665
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x54AC / 21676
{
	int iVar0;
...
var Function_119() //Position: 0x54DA / 21722
{
	return "PackedWeapon";
}

int Function_120(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x54EF / 21743
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_124(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_122(Function_124()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_121(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_121() //Position: 0x55FC / 22012
{
	return "MPItemGiver";
}

struct<32> Function_122(char* cParam0) //Position: 0x5610 / 22032
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0) //Position: 0x567C / 22140
{
	char* cVar0[32];
...
var Function_124() //Position: 0x569E / 22174
{
	return "PBox_";
}

var Function_125() //Position: 0x56AC / 22188
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x56D2 / 22226
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x56FA / 22266
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5720 / 22304
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, struct<2> Param2) //Position: 0x588A / 22666
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5932 / 22834
{
	int iVar0;
	struct<2> Var1;
		...
		if (IS_VOLUME_VALID(&Global_39621[iVar05] + 16))
		{
			if (DECOR_CHECK_EXIST(&Global_39621[iVar05] + 16, "script"))
			{
				if (!IS_SCRIPT_VALID(DECOR_GET_INT(&Global_39621[iVar05] + 16, "script")))
				{
					...
					{
						if (Function_23(StackVal, &Global_54076, Var1) < 25.0f)
						{
							Function_131(iVar0);
						}
					}
					else if (Function_23(StackVal, &Global_54076, Var1) < 55.0f)
					{
						Function_131(iVar0);
					}
				}
...
void Function_131(int iParam0) //Position: 0x5AA0 / 23200
{
...
var Function_132() //Position: 0x5B08 / 23304
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5B11 / 23313
{
	return Function_134(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_134(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5B2F / 23343
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_87(bVar1))
	{
		...
		{
			Function_138(&uParam0, bParam1, iParam2, iParam3, bParam4);
...
void Function_135(int iParam0) //Position: 0x5E28 / 24104
{
	int iVar0;
...
void Function_136() //Position: 0x5EDC / 24284
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5F17 / 24343
{
	int iVar0;
...
void Function_138(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x5F44 / 24388
{
	int iVar0;
...
void Function_139() //Position: 0x609F / 24735
{
	int iVar0;
...
var Function_140(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x60EB / 24811
{
	int iVar0;
...
int Function_141() //Position: 0x61C7 / 25031
{
	int iVar0;
...
int Function_142() //Position: 0x6323 / 25379
{
	int iVar0;
...
bool Function_143(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6443 / 25667
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_144(struct<2> Param0) //Position: 0x651F / 25887
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_145(struct<2> Param0, struct<5> Param2) //Position: 0x653E / 25918
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_146(int iParam0) //Position: 0x6681 / 26241
{
	var uVar0;
...
bool Function_147(int iParam0) //Position: 0x66A3 / 26275
{
	int iVar0;
...
int Function_148() //Position: 0x66BF / 26303
{
	return 0;
}

void Function_149(struct<321> Param0) //Position: 0x66C6 / 26310
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_150(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_150(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

var Function_150(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x6758 / 26456
{
	int iVar0;
