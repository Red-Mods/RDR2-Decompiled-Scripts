...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("BenedictPoint_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "benv_region");
...
void Function_1(var uParam0, var uParam1) //Position: 0xC22 / 3106
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC33 / 3123
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xC8B / 3211
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD1B / 3355
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xD37 / 3383
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD77 / 3447
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD94 / 3476
{
...
var Function_8(bool bParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDA5 / 3493
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xDEC / 3564
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xDF9 / 3577
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xE7B / 3707
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xE8A / 3722
{
	if (!Function_4(128))
	{
		return;
