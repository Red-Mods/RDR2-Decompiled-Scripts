...
void Function_14(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, int iParam7) //Position: 0xC10 / 3088
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
bool Function_28(bool bParam0) //Position: 0x199C / 6556
{
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	while (iVar1 <= 5)
	{
		iVar0 = (iVar0 + Function_28((604 + iVar1)));
		iVar1++;
	}
	if (iVar0 > 20 && !HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		Function_69("item_buss_more_parts", 0x41200000, 1, 0, 2, 1, 0);
		return;
	}
	bVar2 = CEIL((_GET_AMMO_AMOUNT(&Global_54076, 15, 0) + ACTOR_GET_WEAPON_AMMO(&Global_54076, 34)));
	if (IntToFloat(bVar2) <= _GET_MAX_AMMO_AMOUNT(&Global_54076, 15))
	{
		Function_69("item_buss_full", 0x41200000, 1, 0, 2, 1, 0);
		return;
	}
	...
	iLocal_4 = 0;
	bVar3 = FLOOR((IntToFloat(iVar0) / 10.0f));
	if (HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		bVar3 = 20;
	}
	if (IntToFloat(bVar3) < (_GET_MAX_AMMO_AMOUNT(&Global_54076, 15) - IntToFloat(bVar2)))
	{
		bVar3 = FLOOR((_GET_MAX_AMMO_AMOUNT(&Global_54076, 15) - IntToFloat(bVar2)));
	}
	iVar0 = (10 * bVar3);
	if (!HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		...
		while (iVar1 <= 5)
		{
			if (iVar0 >= 0)
			{
				if (Function_28((604 + iVar1)) > iVar0)
				{
					Function_59((604 + iVar1), iVar0);
					iVar0 = 0;
				}
				else
				{
					iVar0 = (iVar0 - Function_28((604 + iVar1)));
					Function_59((604 + iVar1), Function_28((604 + iVar1)));
				}
			}
			iVar1++;
		}
	}
	_ADD_AMMO_OF_TYPE(&Global_54076, 15, TO_FLOAT(bVar3), 0, 1);
	Function_57(670, bVar3, 0, 0);
	iParam2 = 1;
	return;
}

int Function_57(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2EA5 / 11941
{
	int iVar0;
	int iVar1;
...
void Function_58(int iParam0) //Position: 0x30CD / 12493
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_59(int iParam0, bool bParam1) //Position: 0x316B / 12651
{
	bool bVar0;
	int iVar1;
...
int Function_60() //Position: 0x3316 / 13078
{
	int iVar0;
...
void Function_61() //Position: 0x33B7 / 13239
{
	int iVar0;
	int iVar1;
...
void Function_62(int iParam0) //Position: 0x3475 / 13429
{
...
var Function_63(int iParam0, int iParam1) //Position: 0x34DB / 13531
{
	int iVar0;
...
int Function_64(int iParam0, bool bParam1, int iParam2) //Position: 0x3520 / 13600
{
	int iVar0;
	int iVar1;
...
int Function_65(int iParam0, bool bParam1, bool bParam2) //Position: 0x371D / 14109
{
...
bool Function_66() //Position: 0x37E1 / 14305
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_67(int iParam0) //Position: 0x37F8 / 14328
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_68(int iParam0) //Position: 0x3804 / 14340
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_69(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3813 / 14355
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_70(int iParam0) //Position: 0x389E / 14494
{
	char* cVar0[16];
...
var Function_71(int iParam0) //Position: 0x38DD / 14557
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_72(int iParam0, int iParam1) //Position: 0x38F8 / 14584
{
	var uVar0;
	var uVar1;
