...
void main() //Position: 0x0 / 0
{
	...
	iLocal_121 = 0;
	Function_102(&uScriptParam_0, &iLocal_121);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_95(&(vLocal_11[iVar39]), &bVar4))
						{
							Function_93(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_11[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_88("eGRINGO_EndUse: Stop use by request", &vLocal_11[iVar39] + 24);
							Function_87(&vLocal_11[iVar39] + 24, 1);
							...
							{
								Function_80(&(vLocal_11[iVar39]), 0);
							}
							else if (vLocal_11[iVar39].f_68 < 8)
							{
								Function_79(&(vLocal_11[iVar39]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_121 - 1))
			{
				if (Function_78(vLocal_11[iVar09].f_64, 2))
				{
					if (!Function_16(&(vLocal_11[iVar09])))
					{
						Function_105("Quitting due to update end");
						Function_80(&(vLocal_11[iVar09]), 1);
					}
				}
				if (Function_15(&(vLocal_11[iVar09]), 0))
				{
					Function_5(&(vLocal_11[iVar09]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_130))
	{
		Function_105("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&iLocal_130);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_121 - 1))
	{
		if (Function_78(vLocal_11[iVar09].f_64, 2))
		{
			Function_2("Gringo termination calls StopUse", &vLocal_11[iVar09] + 24);
			Function_80(&(vLocal_11[iVar09]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(&vLocal_11[iVar09] + 16))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", &vLocal_11[iVar09] + 16);
		}
		Function_15(&(vLocal_11[iVar09]), 1);
		iVar0++;
	}
...
void Function_2(int iParam0, char* cParam1) //Position: 0x44B / 1099
{
	var uVar0;
...
void Function_5(struct<69> Param0) //Position: 0x4A3 / 1187
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_130))
								{
									...
									{
										iLocal_130 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_130 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&iLocal_130))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&iLocal_130))
		{
			Function_105("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&iLocal_130);
		}
...
bool Function_8(int iParam0, int iParam1) //Position: 0x90E / 2318
{
	return Function_9(&iParam0, "UseQuit", &iParam1);
}

bool Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x927 / 2343
{
	int iVar0;
	int iVar1;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_127, &uLocal_125);
...
bool Function_26(int iParam0, var uParam1) //Position: 0x1FC5 / 8133
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_30(int iParam0) //Position: 0x2010 / 8208
{
	iParam0 = &iParam0;
	return 1;
}
...
bool Function_32(int iParam0, int iParam1) //Position: 0x2038 / 8248
{
...
bool Function_40(int iParam0, int iParam1) //Position: 0x242D / 9261
{
...
bool Function_42(int iParam0, int iParam1) //Position: 0x245B / 9307
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(int iParam0, int iParam1) //Position: 0x247F / 9343
{
...
void Function_47(int iParam0, int iParam1) //Position: 0x2507 / 9479
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_53(var uParam0) //Position: 0x26C0 / 9920
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26CC / 9932
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26D3 / 9939
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26E4 / 9956
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2729 / 10025
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2755 / 10069
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x2761 / 10081
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x2863 / 10339
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2886 / 10374
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x28AE / 10414
{
	struct<8> Var0;
	struct<2> Var8;
	struct<2> Var10;
	...
	if (!iLocal_1 && iLocal_0)
	{
		...
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_66("CanFamClueLayout_") };
		uLocal_3 = CREATE_LAYOUT(&Var0);
		uLocal_5 = Function_63(&uLocal_3, 0, &Global_54076, 1, 0, 0);
		uLocal_7 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_3, Function_39(), 4,203895E-45f, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(3.0f, 7.0f, 3.0f));
		ATTACH_OBJECTS(StackVal, StackVal, &uLocal_7, GRINGO_GET_MY_OBJECT_REF(), "", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
		if (IS_ACTOR_VALID(&Global_21369 + 72))
		{
			if (IS_ACTOR_IN_VOLUME(&Global_21369 + 72, &uLocal_7))
			{
				GET_ACTOR_AXIS(&Global_54076, &Var8, 2);
				GET_POSITION(&Global_54076, &Var10);
				Var10 = Vector(StackVal, StackVal, StackVal) + Vector(Vector(Var8, Var10, StackVal) * Vector(4,5f, 4,5f, 4,5f), StackVal, StackVal);
				if (!SET_OBJECT_POSITION_ON_GROUND(&Global_21369 + 72, Var10))
				{
					ADD_ACTOR_STAY_OUTSIDE_OF_VOLUME(&Global_21369 + 72, &uLocal_7);
					iLocal_2 = 1;
				}
			}
		}
...
var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2994 / 10644
{
	var uVar0;
	...
	{
		uVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(&uParam0, "CannibalFamClue", 1, 1);
	}
...
void Function_64(var uParam0, var uParam1) //Position: 0x2A20 / 10784
{
	var uVar0;
	int iVar1;
	...
	iVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(&uParam0, 0, 9,666f, 0);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(&iVar1, 9,666f, 1, 0);
	return;
}

void Function_65(int iParam0, var uParam1) //Position: 0x2A5F / 10847
{
	...
	ATTACH_CAMERASHOT(StackVal, StackVal, StackVal, &iParam0, &uParam1, Vector(3,86792f, 1,557201f, -2,192871f), Vector(-9,674168f, 113,0835f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 0);
...
struct<32> Function_66(char* cParam0) //Position: 0x2AF0 / 10992
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x2B5C / 11100
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x2B7E / 11134
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2B8A / 11146
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2BA9 / 11177
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2BC0 / 11200
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
...
struct<8> Function_72(int iParam0) //Position: 0x2C51 / 11345
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2C75 / 11381
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2C94 / 11412
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2CB8 / 11448
{
	var uVar0;
	var uVar1;
	var uVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2DE0 / 11744
{
...
int Function_77(var uParam0) //Position: 0x2E0E / 11790
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2F27 / 12071
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x2F34 / 12084
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x2FB6 / 12214
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x3561 / 13665
{
	int iVar0;
...
int Function_82(int iParam0) //Position: 0x359B / 13723
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0, var uParam1) //Position: 0x35B9 / 13753
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_84(int iParam0) //Position: 0x35FA / 13818
{
	iParam0 = &iParam0;
	return;
}

bool Function_85(int iParam0) //Position: 0x3606 / 13830
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_86(int iParam0, int iParam1) //Position: 0x3628 / 13864
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	if (iLocal_2)
	{
		REMOVE_ACTOR_STAY_OUTSIDE_OF_VOLUME(&Global_21369 + 72, &uLocal_7);
	}
	if (IS_OBJECT_VALID(&uLocal_5))
	{
		DESTROY_OBJECT(&uLocal_5);
	}
	if (IS_OBJECT_VALID(&uLocal_7))
	{
		DESTROY_OBJECT(&uLocal_7);
	}
	if (IS_LAYOUTREF_VALID(&uLocal_3))
	{
		DESTROY_LAYOUT(&uLocal_3);
	}
...
void Function_87(var uParam0, bool bParam1) //Position: 0x3686 / 13958
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_88(int iParam0, int iParam1) //Position: 0x3796 / 14230
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_89(struct<69> Param0) //Position: 0x37AE / 14254
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, int iParam1) //Position: 0x3ACA / 15050
{
	iParam1 = &iParam1;
	iLocal_0 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
...
bool Function_91(int iParam0) //Position: 0x3AE5 / 15077
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_92(int iParam0) //Position: 0x3AFF / 15103
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3B1A / 15130
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3B58 / 15192
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_95(struct<65> Param0) //Position: 0x3B71 / 15217
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_96(int iParam0) //Position: 0x3E69 / 15977
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3E87 / 16007
{
	struct<5> Var0;
	float fVar5;
...
int Function_98(int iParam0) //Position: 0x3F27 / 16167
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(int iParam0, var uParam1) //Position: 0x3F47 / 16199
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_100(int iParam0) //Position: 0x3F5A / 16218
{
...
void Function_101(int iParam0) //Position: 0x3F76 / 16246
{
	iParam0 = &iParam0;
	return;
}

void Function_102(var uParam0, int iParam1) //Position: 0x3F82 / 16258
{
	int iVar0;
	var uVar1;
	...
	{
		Function_103(&(vLocal_11[iLocal_1219]), &uParam0);
		iLocal_121++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x3FEE / 16366
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_104(int iParam0) //Position: 0x4007 / 16391
{
	iParam0 = &iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x4013 / 16403
{
