...
void main() //Position: 0x0 / 0
{
	...
	iLocal_46 = 0;
	Function_102(&uScriptParam_0, &iLocal_46);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_47);
		}
		iVar2 = 0;
		bLocal_54 = false;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_55))
	{
		Function_105("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_55);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_46 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x4A0 / 1184
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_55))
								{
									...
									{
										bLocal_55 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_55 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_55))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_55))
		{
			Function_105("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_55);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_52, &uLocal_50);
...
void Function_62(bool bParam0) //Position: 0x28AB / 10411
{
	...
	if (iLocal_6 && !iLocal_7)
	{
		...
		bLocal_4 = Function_63(&iLocal_2, 0, &Global_54076, 1, 0, 0);
	}
	return;
}

var Function_63(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x28FE / 10494
{
	var uVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2996 / 10646
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x29C6 / 10694
{
...
struct<32> Function_66(char* cParam0) //Position: 0x2A63 / 10851
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0) //Position: 0x2ACF / 10959
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x2AF1 / 10993
{
	iParam0 = &iParam0;
	return;
}

bool Function_69(int iParam0) //Position: 0x2AFD / 11005
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2B1C / 11036
{
	if (!Function_14(&iParam0))
	{
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B33 / 11059
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_72(int iParam0) //Position: 0x2BC4 / 11204
{
	struct<2> Var0;
...
struct<8> Function_73(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2BE8 / 11240
{
	struct<2> Var0;
...
int Function_74(int iParam0) //Position: 0x2C07 / 11271
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(var uParam0, int iParam1) //Position: 0x2C2B / 11307
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2D53 / 11603
{
...
int Function_77(var uParam0) //Position: 0x2D81 / 11649
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2E9A / 11930
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(struct<69> Param0) //Position: 0x2EA7 / 11943
{
	if (Function_78(Param0.f_64, 16))
	{
...
void Function_80(struct<69> Param0) //Position: 0x2F29 / 12073
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_52)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_50));
		iLocal_52 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_81() //Position: 0x34D4 / 13524
{
	iLocal_7 = 0;
...
void Function_86(int iParam0, int iParam1) //Position: 0x3579 / 13689
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	...
	if (IS_LAYOUTREF_VALID(&iLocal_2))
	{
		DESTROY_LAYOUT_OBJECTS(&iLocal_2);
		DESTROY_LAYOUT(&iLocal_2);
	}
	return;
}

void Function_87(var uParam0, bool bParam1) //Position: 0x35A7 / 13735
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_88(int iParam0, int iParam1) //Position: 0x36B7 / 14007
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_89(struct<69> Param0) //Position: 0x36CF / 14031
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_90(var uParam0, var uParam1) //Position: 0x39EB / 14827
{
	struct<8> Var0;
	struct<2> Var8;
	int iVar10;
	...
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
		...
		GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var8);
		iVar10 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_2, Function_39(), 3, Var8, Vector(0.0f, 0.0f, 0.0f), Vector(3.0f, 7.0f, 3.0f));
		ADD_CORPSE_REMOVAL_VOLUME_OBJ(&iVar10);
		DESTROY_VOLUME(&iVar10);
		Global_6663 = 0;
...
bool Function_91(int iParam0) //Position: 0x3A66 / 14950
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_92(int iParam0) //Position: 0x3A80 / 14976
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, var uParam1) //Position: 0x3A9B / 15003
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3AD9 / 15065
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_95(struct<65> Param0) //Position: 0x3AF2 / 15090
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_96(int iParam0) //Position: 0x3DEA / 15850
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3E08 / 15880
{
	struct<5> Var0;
	float fVar5;
...
int Function_98(int iParam0) //Position: 0x3EA8 / 16040
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(int iParam0, int iParam1) //Position: 0x3EC8 / 16072
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&iParam0))
	{
		if ((GET_CURRENT_GAME_TIME() - GET_LAST_ATTACK_TIME(&iParam0)) > 8.0f)
		{
			return 0;
		}
...
bool Function_100(int iParam0) //Position: 0x3F0B / 16139
{
...
void Function_101(int iParam0) //Position: 0x3F27 / 16167
{
	iParam0 = &iParam0;
	return;
}

void Function_102(var uParam0, int iParam1) //Position: 0x3F33 / 16179
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_103(&(vLocal_8[iLocal_469]), &uParam0);
		iLocal_46++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x3F9F / 16287
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_104(int iParam0) //Position: 0x3FB7 / 16311
{
	iParam0 = &iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x3FC3 / 16323
{
