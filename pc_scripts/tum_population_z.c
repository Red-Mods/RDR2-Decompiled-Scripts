...
void main() //Position: 0x0 / 0
{
	...
	uVar12 = FIND_NAMED_LAYOUT("Tumbleweed_layout");
	if (IS_LAYOUTREF_VALID(&uVar12))
	{
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "TumPopArea_1_set");
		if (IS_VOLUME_VALID(&uVar13))
		{
			Function_4(&uVar13, &uVar1, 3, 6, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("tum_pop: Cannot find TumPopArea_1 to create wilderness volumes");
		}
		uVar13 = FIND_VOLUME_IN_LAYOUT(&uVar12, "tumv_zombies");
		if (IS_VOLUME_VALID(&uVar13))
		{
			Function_4(&uVar13, &bVar0, 10, 40, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("tum_pop: Cannot find TumPopArea_1 to create wilderness volumes");
...
void Function_1(var uParam0, var uParam1) //Position: 0xE05 / 3589
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xE16 / 3606
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xE6E / 3694
{
	var uVar0;
...
var Function_4(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xEFE / 3838
{
	var uVar0;
...
bool Function_5(int iParam0) //Position: 0xF90 / 3984
{
	int iVar0;
...
void Function_6(char* cParam0) //Position: 0xFAC / 4012
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xFEC / 4076
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x1009 / 4105
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x101A / 4122
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0x1098 / 4248
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1104 / 4356
{
	bool bVar0;
...
var Function_12(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1170 / 4464
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0x11B7 / 4535
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_14(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x11C4 / 4548
{
	int iVar0;
	int iVar1;
...
var Function_15(var uParam0, int iParam1) //Position: 0x1246 / 4678
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_16(char* cParam0) //Position: 0x1255 / 4693
{
	if (!Function_5(128))
	{
		return;
