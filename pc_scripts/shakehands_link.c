...
int Function_11(bool bParam0, var uParam1, int iParam2) //Position: 0x992 / 2450
{
	int iVar0;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BBC / 11196
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C19 / 11289
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C76 / 11382
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C82 / 11394
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2CA1 / 11425
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CB8 / 11448
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D49 / 11593
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D6D / 11629
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D8C / 11660
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2DB0 / 11696
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2ED8 / 11992
{
...
int Function_74(var uParam0) //Position: 0x2F06 / 12038
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x301F / 12319
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x302C / 12332
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30AE / 12462
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3659 / 13913
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3693 / 13971
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x36B1 / 14001
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36F2 / 14066
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36FE / 14078
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3720 / 14112
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	if (bLocal_2)
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3772 / 14194
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3882 / 14466
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x389A / 14490
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3BB6 / 15286
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
...
bool Function_88(int iParam0) //Position: 0x3BD4 / 15316
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3BEE / 15342
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C09 / 15369
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3C47 / 15431
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C60 / 15456
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F58 / 16216
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F76 / 16246
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4018 / 16408
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x4038 / 16440
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x404B / 16459
{
...
void Function_98(int iParam0) //Position: 0x4067 / 16487
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x4073 / 16499
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x40DF / 16607
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x40F7 / 16631
{
	iParam0 = &iParam0;
	return;
}

void Function_102(bool bParam0) //Position: 0x4103 / 16643
{
