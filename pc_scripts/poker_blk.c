...
void Function_12() //Position: 0x3A2 / 930
{
	RELEASE_LAYOUT_REF(&iLocal_4);
	return;
}

void Function_13() //Position: 0x3AE / 942
{
	return;
}

void Function_14() //Position: 0x3B4 / 948
{
...
void Function_15(var uParam0) //Position: 0x401 / 1025
{
	Global_39922.f_88 = (Global_39922.f_88 || uParam0);
	return;
}

var Function_16() //Position: 0x414 / 1044
{
...
bool Function_17() //Position: 0x429 / 1065
{
	int iVar0;
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			iLocal_82 = Function_37(Local_85);
			if (Function_36())
			{
				if (iLocal_82 < 50)
				{
			...
			else if (iLocal_82 < 100)
			{
				iLocal_82 = 100;
			}
			if (Function_34() <= iLocal_82)
			{
				bLocal_3 = true;
			}
			else
		...
		case 0x00000001:
			if (Function_27(Global_46914[0], &Local_113 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_46914[0], 0);
				(&Local_113 + 232) = Function_26(Global_46914[0], 0);
				Function_25(&Local_113 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_113 + 68)[iVar0] = iLocal_82 * 10;
					Function_24(Global_46914[0], iVar0, 0);
					*(&Local_113 + 128[iVar02]) = Function_24(Global_46914[0], iVar0, 0);
					iVar0++;
				}
				if (Function_36())
				{
				...
				Function_23(Global_46914[0]);
				*(&Local_113 + 268) = Function_23(Global_46914[0]);
				Function_22(Global_46914[0]);
				*(&Local_113 + 280) = Function_22(Global_46914[0]);
		...
		case 0x00000065:
			if (Function_20(Local_85, 0))
			{
				bLocal_2 = true;
			}
			else if (Function_19(Local_85))
			{
				bLocal_3 = true;
			}
			else
...
bool Function_19(int iParam0) //Position: 0x5E4 / 1508
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x605 / 1541
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x63C / 1596
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_22(int iParam0) //Position: 0x657 / 1623
{
...
struct<8> Function_23(int iParam0) //Position: 0x759 / 1881
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x85B / 2139
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_25(int[] iParam0) //Position: 0xE07 / 3591
{
	int iVar0;
	var uVar1;
...
struct<8> Function_26(int iParam0, bool bParam1) //Position: 0xE63 / 3683
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_27(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF7F / 3967
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
	...
	while (iVar4 <= 6)
	{
		Function_24(iParam0, iVar4, &bParam4);
		iVar16 = Function_33(StackVal, Function_24(iParam0, iVar4, &bParam4));
...
bool Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x118D / 4493
{
...
bool Function_29() //Position: 0x1251 / 4689
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_30(int iParam0) //Position: 0x1268 / 4712
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_31(int iParam0) //Position: 0x1274 / 4724
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_32(var uParam0, int iParam1) //Position: 0x1283 / 4739
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_33(var uParam0, bool bParam1) //Position: 0x1292 / 4754
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x12D4 / 4820
{
	return Function_35(0);
}

int Function_35(bool bParam0) //Position: 0x12DE / 4830
{
...
bool Function_36() //Position: 0x131F / 4895
{
...
var Function_37(int iParam0) //Position: 0x134A / 4938
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_38() //Position: 0x1364 / 4964
{
	Function_1();
	return;
}

void Function_39() //Position: 0x136D / 4973
{
	uLocal_83 = CREATE_LAYOUT(Function_52());
	Function_50(0, 1);
	Function_47();
	Function_46();
	Function_40(&uLocal_97);
	Function_40(&iLocal_105);
	Function_40(&iLocal_101);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
...
void Function_40(int iParam0) //Position: 0x13BD / 5053
{
...
void Function_41(vector3 vParam0) //Position: 0x13D4 / 5076
{
...
void Function_42(var uParam0, int iParam1) //Position: 0x13F9 / 5113
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x140F / 5135
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_44(int iParam0) //Position: 0x1420 / 5152
{
	return Function_45(iParam0, 1);
}

int Function_45(var uParam0, bool bParam1) //Position: 0x142E / 5166
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x143B / 5179
{
	return;
}

void Function_47() //Position: 0x1441 / 5185
{
	Function_48();
	return;
}

void Function_48() //Position: 0x144A / 5194
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_49(int iParam0, int iParam1) //Position: 0x1910 / 6416
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_50(bool bParam0, bool bParam1) //Position: 0x195A / 6490
{
	var uVar0;
...
void Function_51(var uParam0) //Position: 0x19B9 / 6585
{
	int iVar0;
...
var Function_52() //Position: 0x19D6 / 6614
{
	var uVar0;
