...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar1 + 360) = 2;
	if (bVar0)
	{
		Function_118(&iVar1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp01x");
	}
	else
	{
		GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var63);
		strcpy(&cVar65, "p", 24);
		stradd(&cVar65, GET_OBJECT_NAME(GRINGO_GET_MY_OBJECT_REF()), 24);
		CREATE_POINT_IN_LAYOUT(StackVal, GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF()), &cVar65, Var63, Vector(0.0f, 0.0f, 0.0f));
	...
	while (IS_GRINGO_ACTIVE())
	{
		if (bVar0)
		{
			Function_9(&iVar1, GRINGO_GET_MY_OBJECT_REF(), 1, 0, 1, 1, "ped_wilderness", 2.0f, 0, 0x43160000);
		}
		GRINGO_WAIT(250);
	}
	if (DECOR_CHECK_EXIST(&Global_54076, "DestroyMyCamp"))
	{
		Function_5(&iVar1 + 120);
		Function_3();
		DESTROY_LAYOUT(&iVar1 + 24);
		DESTROY_LAYOUT(&iVar1 + 16);
		Function_1(&iVar1);
...
void Function_1(struct<473> Param0) //Position: 0x14D / 333
{
	bool bVar0;
...
void Function_2() //Position: 0x2FB / 763
{
	return;
}

void Function_3() //Position: 0x301 / 769
{
	Function_4();
	return;
}
...
var Function_9(struct<477> Param0) //Position: 0x4C4 / 1220
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_18 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_111(&Param0 + 324, &fLocal_20, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_100(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_100(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_108(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_99(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_20, 20.0f, fLocal_20));
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_55(StackVal, StackVal, &Param0 + 16, Function_99(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				...
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				...
				while (bVar1 <= iParam3)
				{
					Function_52(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[bVar1], &Param0 + 272[bVar1], &Param0 + 480, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_40(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, false));
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_21, &Param0 + 488, 0, 0, 0x40400000))
						{
				...
				while (bVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), 4, 0, 2);
						}
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x2839 / 10297
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DF0 / 11760
{
	...
	{
		GRINGO_UPDATE_BOOL(GET_GRINGO_FROM_OBJECT(&iParam1), "PlayerCampInfo", "CampIsReady", 1);
		*(&iParam0 + 24) = &iLocal_0;
		DECOR_SET_OBJECT(GET_OBJECT_FROM_GRINGO(GRINGO_GET_MY_GRINGO_ID()), "gringoLayout", &iParam0 + 24);
		*(&iParam0 + 448) = CREATE_OBJECTSET_IN_LAYOUT(Function_99(), &iParam0 + 24, 12, 1);
		(&iParam0 + 352) = "";
		return 1;
	}
	return 0;
...
bool Function_59(var uParam0) //Position: 0x2E73 / 11891
{
	var uVar0;
	...
	*(&iLocal_0 + 8) = Vector(1,844061f, 0,008248952f, 1,429237f);
	*(&iLocal_0 + 8 + 12) = Vector(0.0f, 109,9417f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 8);
	*(&iLocal_0 + 32) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_horse_stay", Vector(1,844061f, 0,008248952f, 1,429237f), Vector(0.0f, 109,9417f, 0.0f));
	*(&iLocal_0 + 40) = Vector(0,6116906f, 0,002102481f, -1,21826f);
	*(&iLocal_0 + 40 + 12) = Vector(0.0f, 187,4159f, 0.0f);
	Function_61(&uParam0, &iLocal_0 + 40);
	*(&iLocal_0 + 64) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "player_camp_sit", Vector(0,6116906f, 0,002102481f, -1,21826f), Vector(0.0f, 187,4159f, 0.0f));
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, var uParam1) //Position: 0x2F67 / 12135
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &uParam1, Function_99(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
void Function_61(var uParam0, int iParam1) //Position: 0x2FB2 / 12210
{
	Function_62(&uParam0, 1, &iParam1, &iParam1 + 12);
	return;
}

void Function_62(var uParam0, bool bParam1, struct<2> Param2) //Position: 0x2FC7 / 12231
{
	struct<2> Var0;
...
bool Function_63(vector3 vParam0) //Position: 0x30F4 / 12532
{
	var uVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x316A / 12650
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x31B4 / 12724
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3576 / 13686
{
	if (!Function_116(128))
	{
		return;
...
bool Function_67() //Position: 0x35B6 / 13750
{
	int iVar0;
...
void Function_68(struct<13> Param0) //Position: 0x35E4 / 13796
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_69() //Position: 0x35F7 / 13815
{
	if (!Function_116(128))
	{
		return;
...
void Function_70(vector3 vParam0) //Position: 0x3639 / 13881
{
	char* cVar0[32];
...
void Function_71(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x36D1 / 14033
{
	var uVar0;
	var uVar1;
...
void Function_72(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3700 / 14080
{
...
var Function_73(var uParam0, bool bParam1) //Position: 0x375B / 14171
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_74() //Position: 0x376B / 14187
{
	return "PackedGrass";
}

var Function_75(bool bParam0, bool bParam1, bool bParam2) //Position: 0x377F / 14207
{
	int iVar0;
...
var Function_76() //Position: 0x37A4 / 14244
{
	return "PackedMetadata";
}

void Function_77(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x37BB / 14267
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_86(), &uVar4))
				{
					Function_81(uVar4, &bVar5);
...
struct<8> Function_78() //Position: 0x38F7 / 14583
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_79() //Position: 0x3909 / 14601
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_80() //Position: 0x391B / 14619
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_81(var uParam0, struct<5> Param1) //Position: 0x392D / 14637
{
...
var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x3952 / 14674
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x3971 / 14705
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x397D / 14717
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x3988 / 14728
{
	int iVar0;
...
var Function_86() //Position: 0x39B6 / 14774
{
	return "PackedWeapon";
}

int Function_87(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x39CB / 14795
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_88() //Position: 0x3AD8 / 15064
{
	return "MPItemGiver";
}

struct<32> Function_89(char* cParam0) //Position: 0x3AEC / 15084
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0) //Position: 0x3B58 / 15192
{
	char* cVar0[32];
...
var Function_91() //Position: 0x3B7A / 15226
{
	return "PBox_";
}

var Function_92() //Position: 0x3B88 / 15240
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x3BAE / 15278
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x3BD6 / 15318
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3BFC / 15356
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3D66 / 15718
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x3E0E / 15886
{
	int iVar0;
	struct<2> Var1;
...
void Function_98(int iParam0) //Position: 0x3F7C / 16252
{
...
var Function_99() //Position: 0x3FE4 / 16356
{
	int iVar0;
...
var Function_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3FED / 16365
{
	return Function_101(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_101(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x400C / 16396
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x4305 / 17157
{
	int iVar0;
...
void Function_103() //Position: 0x43B9 / 17337
{
	int iVar0;
...
bool Function_104(bool bParam0) //Position: 0x43F4 / 17396
{
	int iVar0;
...
void Function_105(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4421 / 17441
{
	bool bVar0;
...
bool Function_106(bool bParam0) //Position: 0x457C / 17788
{
...
void Function_107() //Position: 0x4593 / 17811
{
	int iVar0;
...
var Function_108(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x45DF / 17887
{
	int iVar0;
...
int Function_109() //Position: 0x46BB / 18107
{
	int iVar0;
...
int Function_110() //Position: 0x4817 / 18455
{
	int iVar0;
...
bool Function_111(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4937 / 18743
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_112(struct<2> Param0) //Position: 0x4A13 / 18963
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_113(struct<2> Param0, struct<5> Param2) //Position: 0x4A32 / 18994
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_114(var uParam0, struct<2> Param1) //Position: 0x4B75 / 19317
{
	struct<2> Var0;
...
bool Function_115(int iParam0) //Position: 0x4BEC / 19436
{
	var uVar0;
...
bool Function_116(int iParam0) //Position: 0x4C0E / 19470
{
	int iVar0;
...
int Function_117() //Position: 0x4C2A / 19498
{
	return 0;
}

void Function_118(struct<321> Param0) //Position: 0x4C31 / 19505
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_119(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_119(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

var Function_119(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x4CC3 / 19651
{
	int iVar0;
