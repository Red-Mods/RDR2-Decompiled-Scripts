...
void Function_22(var uParam0, var uParam1) //Position: 0x1F65 / 8037
{
	...
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	iVar0 = GET_CURRENT_GRINGO(GET_PLAYER_ACTOR(0));
	if (IS_GRINGO_VALID(&iVar0))
	{
		if (GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()) == &iVar0)
		{
		}
	}
...
float Function_23(int iParam0) //Position: 0x1F9C / 8092
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1FB3 / 8115
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1FC0 / 8128
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(int iParam0, bool bParam1) //Position: 0x1FE1 / 8161
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return 1;
...
void Function_29(int iParam0, bool bParam1) //Position: 0x201A / 8218
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x202C / 8236
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2039 / 8249
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2054 / 8276
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2074 / 8308
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2094 / 8340
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20CB / 8395
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20EB / 8427
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2106 / 8454
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x211C / 8476
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x2440 / 9280
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2449 / 9289
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x2468 / 9320
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x2477 / 9335
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x249B / 9371
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x24C1 / 9409
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24DF / 9439
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2501 / 9473
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2523 / 9507
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25EB / 9707
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2667 / 9831
{
...
void Function_50(vector3 vParam0) //Position: 0x267F / 9855
{
...
var Function_51(int iParam0) //Position: 0x26A4 / 9892
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26C5 / 9925
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26DC / 9948
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26E8 / 9960
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26EF / 9967
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2700 / 9984
{
	bool bVar0;
...
int Function_57(int iParam0) //Position: 0x2745 / 10053
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2771 / 10097
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x277D / 10109
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x287F / 10367
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x28A2 / 10402
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x28CA / 10442
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2BB1 / 11185
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2C0E / 11278
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C6B / 11371
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C77 / 11383
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C96 / 11414
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2CAD / 11437
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D3E / 11582
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D62 / 11618
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D81 / 11649
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2DA5 / 11685
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2ECD / 11981
{
...
int Function_74(var uParam0) //Position: 0x2EFB / 12027
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3014 / 12308
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3021 / 12321
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x30A3 / 12451
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x364E / 13902
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3688 / 13960
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x36A6 / 13990
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36E7 / 14055
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36F3 / 14067
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x3715 / 14101
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3727 / 14119
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x3837 / 14391
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x384F / 14415
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3B6B / 15211
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3B7D / 15229
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3B97 / 15255
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3BB2 / 15282
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3BF0 / 15344
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3C09 / 15369
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3F01 / 16129
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3F1F / 16159
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x3FBF / 16319
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, var uParam1) //Position: 0x3FDF / 16351
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3FF2 / 16370
{
...
void Function_98(int iParam0) //Position: 0x400F / 16399
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x401B / 16411
{
	bool bVar0;
	var uVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x4087 / 16519
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(int iParam0) //Position: 0x409F / 16543
{
	iParam0 = &iParam0;
	return;
}

void Function_102(bool bParam0) //Position: 0x40AB / 16555
{
