...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_532, Function_87(), bScriptParam_0);
				Function_47(&uLocal_588, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_532);
	Function_8(&uLocal_588);
	Function_6();
...
void Function_25(bool bParam0) //Position: 0xA98 / 2712
{
	var uVar0;
	int iVar1;
	var uVar2;
...
bool Function_27(bool bParam0) //Position: 0xB6E / 2926
{
	var uVar0;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0xBFE / 3070
{
...
int Function_50(int iParam0, bool bParam1) //Position: 0x24D4 / 9428
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_58(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2BF1 / 11249
{
	int iVar0;
	int iVar1;
...
void Function_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x2EB7 / 11959
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
int Function_70(int iParam0, bool bParam1, bool bParam2) //Position: 0x3977 / 14711
{
	int iVar0;
	int iVar1;
...
var Function_73(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x3BF2 / 15346
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
int Function_90(int iParam0, bool bParam1, int iParam2) //Position: 0x570A / 22282
{
	int iVar0;
	int iVar1;
...
var Function_104(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6979 / 27001
{
	var uVar0;
...
void Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6CA7 / 27815
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
void Function_114(int iParam0, bool bParam1) //Position: 0x6E12 / 28178
{
	var uVar0[3];
	int iVar4;
...
int Function_126(int iParam0, bool bParam1, bool bParam2) //Position: 0x805D / 32861
{
	int iVar0;
...
int Function_127(bool bParam0) //Position: 0x82F9 / 33529
{
...
int Function_132(int iParam0, bool bParam1, int iParam2) //Position: 0x8516 / 34070
{
	int iVar0;
	int iVar1;
...
void Function_156(int iParam0, bool bParam1) //Position: 0x9522 / 38178
{
	var uVar0;
...
void Function_157(bool bParam0) //Position: 0x960A / 38410
{
	var uVar0;
	var uVar1;
	var uVar5;
...
var Function_162(var uParam0, bool bParam1, int iParam2) //Position: 0xA11B / 41243
{
	int iVar0;
...
bool Function_176(var uParam0, bool bParam1, bool bParam2) //Position: 0xAF55 / 44885
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_187(var uParam0, var uParam1, bool bParam2) //Position: 0xB685 / 46725
{
	bool bVar0;
	var uVar1;
...
var Function_191(bool bParam0) //Position: 0xB8BB / 47291
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
int Function_193(bool bParam0) //Position: 0xBA5D / 47709
{
...
void Function_196(bool bParam0, bool bParam1) //Position: 0xBD8E / 48526
{
	DECOR_SET_FLOAT(&Global_44085[bParam09] + 8, "ZombieScore", bParam1);
	return;
}

void Function_197(var uParam0, bool bParam1) //Position: 0xBDB2 / 48562
{
...
int Function_200(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBE18 / 48664
{
	int iVar0;
	int iVar1;
...
int Function_201(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xBE76 / 48758
{
	var uVar0;
...
void Function_207(int iParam0, bool bParam1) //Position: 0xC099 / 49305
{
	char[] cVar0[4];
...
void Function_222(int iParam0, bool bParam1, int iParam2) //Position: 0xC378 / 50040
{
...
void Function_227(var uParam0, bool bParam1, float fParam2, float fParam3) //Position: 0xCF8F / 53135
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
var Function_231(bool bParam0, int iParam1) //Position: 0xD080 / 53376
{
	var uVar0;
	int iVar1;
	int iVar2;
...
{
	Function_239(&uLocal_588, &cLocal_7, "bunkHouse01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "bunkHouse01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "bunkHouse01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "bunkHouse01", 5, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 1, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 2, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 3, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 4, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 5, &Global_44085[bParam09] + 32, 0, &iLocal_298 + 528, 0, 1);
	Function_239(&uLocal_588, &cLocal_7, "saloon01", 6, &Global_44085[bParam09] + 32, 0, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD386 / 54150
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD489 / 54409
{
	int iVar0;
...
void Function_241() //Position: 0xD4BA / 54458
{
	Function_242(&uLocal_9, &uLocal_532, 4, &iLocal_298 + 32, 4294967295, 4);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 560, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 528, 4294967295, 258);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 464, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 16, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 24, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 8, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 472, 4294967295, 266);
	Function_242(&uLocal_9, &uLocal_532, 5, &iLocal_298 + 568, 4294967295, 0x1000000);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, int iParam4, int iParam5) //Position: 0xD570 / 54640
{
...
void Function_243(struct<5> Param0) //Position: 0xD65D / 54877
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD66E / 54894
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, bool bParam1, bool bParam2) //Position: 0xD6E4 / 55012
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD782 / 55170
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD78B / 55179
{
	cLocal_7 = Function_248(&iLocal_178, "rathskellerfork", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD7AE / 55214
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD7D1 / 55249
{
	return Function_250();
}

int Function_250() //Position: 0xD7DA / 55258
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_298 = FIND_NAMED_LAYOUT("RathskellerFork_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_298))
	{
		iLocal_298 = CREATE_LAYOUT("RathskellerFork_layout");
	}
	*(&iLocal_298 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_garden", 2,802597E-45f, Vector(-3693,255f, 42,3148f, 2125,701f), Vector(0.0f, 44,51831f, 0.0f), Vector(9,925219f, 9,925219f, 9,925219f));
	*(&iLocal_298 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_sty", 2,802597E-45f, Vector(-3621,196f, 43,9767f, 2119,432f), Vector(0.0f, -44,95447f, 0.0f), Vector(8,86199f, 8,86199f, 14,07406f));
	*(&iLocal_298 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_stable", 2,802597E-45f, Vector(-3662,146f, 42,16473f, 2154,364f), Vector(0.0f, 44,8574f, 0.0f), Vector(18,53334f, 15,97864f, 20,40537f));
	*(&iLocal_298 + 32) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_region", 2,802597E-45f, Vector(-3657,196f, 42,16477f, 2124.0f), Vector(0.0f, 44,51225f, 0.0f), Vector(100,1779f, 100,1779f, 100,1779f));
	*(&iLocal_298 + 160) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_crows_set");
	*(&iLocal_298 + 40[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder12", 4,203895E-45f, Vector(-3667,996f, 50,28079f, 2128,001f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[0]);
	*(&iLocal_298 + 40[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder1", 4,203895E-45f, Vector(-3663,123f, 50,28079f, 2153,339f), Vector(0.0f, 20.0f, 0.0f), Vector(12,97006f, 18,59737f, 11,29908f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[1]);
	*(&iLocal_298 + 40[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder2", 4,203895E-45f, Vector(-3692,968f, 50,28079f, 2128,001f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[2]);
	*(&iLocal_298 + 40[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder3", 4,203895E-45f, Vector(-3619,695f, 50,28079f, 2118,437f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[3]);
	*(&iLocal_298 + 40[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder4", 4,203895E-45f, Vector(-3658,227f, 50,28079f, 2139,811f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[4]);
	*(&iLocal_298 + 40[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder5", 4,203895E-45f, Vector(-3641,509f, 50,28079f, 2142,275f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[5]);
	*(&iLocal_298 + 40[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder6", 4,203895E-45f, Vector(-3694,344f, 50,28079f, 2141,383f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[6]);
	*(&iLocal_298 + 40[7]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder7", 4,203895E-45f, Vector(-3648,459f, 50,28079f, 2096,775f), Vector(0.0f, 45,10091f, 0.0f), Vector(12,58875f, 18,59737f, 18,2455f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[7]);
	*(&iLocal_298 + 40[8]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder8", 4,203895E-45f, Vector(-3630,325f, 50,28079f, 2113,575f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[8]);
	*(&iLocal_298 + 40[9]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nCylinder9", 4,203895E-45f, Vector(-3647,141f, 50,28079f, 2121,827f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[9]);
	*(&iLocal_298 + 40[10]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder10", 4,203895E-45f, Vector(-3681,653f, 50,28079f, 2144,476f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[10]);
	*(&iLocal_298 + 40[11]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder11", 4,203895E-45f, Vector(-3667,996f, 50,28079f, 2128,001f), Vector(0.0f, 20.0f, 0.0f), Vector(5,208708f, 18,59737f, 5,328751f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[11]);
	*(&iLocal_298 + 40[12]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder13", 4,203895E-45f, Vector(-3677,346f, 67,70795f, 2111,989f), Vector(0.0f, 43,88285f, 0.0f), Vector(22,30366f, 44,16914f, 10,43942f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[12]);
	*(&iLocal_298 + 40[13]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder14", 4,203895E-45f, Vector(-3618,137f, 55,39209f, 2104.0f), Vector(0.0f, 42,34747f, 0.0f), Vector(5,228905f, 32,45801f, 13,83174f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 160, &iLocal_298 + 40[13]);
	*(&iLocal_298 + 232) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_vultures_set");
	*(&iLocal_298 + 168[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder21", 4,203895E-45f, Vector(-3645,254f, 62,21743f, 2068,658f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[0]);
	*(&iLocal_298 + 168[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder15", 4,203895E-45f, Vector(-3704,5f, 62,21743f, 2125,481f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[1]);
	*(&iLocal_298 + 168[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder16", 4,203895E-45f, Vector(-3684,737f, 62,21743f, 2151,741f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[2]);
	*(&iLocal_298 + 168[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder17", 4,203895E-45f, Vector(-3651,746f, 62,21743f, 2164,688f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[3]);
	*(&iLocal_298 + 168[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder18", 4,203895E-45f, Vector(-3687,232f, 62,21743f, 2095,677f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[4]);
	*(&iLocal_298 + 168[5]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder19", 4,203895E-45f, Vector(-3659,434f, 62,21743f, 2139,26f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[5]);
	*(&iLocal_298 + 168[6]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder20", 4,203895E-45f, Vector(-3626,506f, 62,21743f, 2125,481f), Vector(0.0f, 20.0f, 0.0f), Vector(10,21942f, 35,64838f, 10,42494f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 232, &iLocal_298 + 168[6]);
	*(&iLocal_298 + 272) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_dogs_set");
	*(&iLocal_298 + 240[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder25", 4,203895E-45f, Vector(-3668,338f, 42,57071f, 2127,185f), Vector(0.0f, 41,02739f, 0.0f), Vector(26,52049f, 10,58024f, 12,71264f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 272, &iLocal_298 + 240[0]);
	*(&iLocal_298 + 240[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder49", 4,203895E-45f, Vector(-3647,38f, 42,57071f, 2126,344f), Vector(0.0f, -44,90509f, 0.0f), Vector(18,74602f, 7,478643f, 8,985932f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 272, &iLocal_298 + 240[1]);
	*(&iLocal_298 + 240[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder50", 4,203895E-45f, Vector(-3633,482f, 42,57071f, 2116,284f), Vector(0.0f, 42,50925f, 0.0f), Vector(14,85578f, 5,926651f, 7,121143f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 272, &iLocal_298 + 240[2]);
	*(&iLocal_298 + 304) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_rabbits_set");
	*(&iLocal_298 + 280[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder33", 4,203895E-45f, Vector(-3620,92f, 42,28122f, 2126,759f), Vector(0.0f, 20.0f, 0.0f), Vector(16,35258f, 16,35258f, 16,35258f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 304, &iLocal_298 + 280[0]);
	*(&iLocal_298 + 280[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder29", 4,203895E-45f, Vector(-3693,331f, 42,28122f, 2133,986f), Vector(0.0f, 20.0f, 0.0f), Vector(9,970144f, 9,970144f, 14,92122f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 304, &iLocal_298 + 280[1]);
	*(&iLocal_298 + 344) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_owls_set");
	*(&iLocal_298 + 312[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder30", 4,203895E-45f, Vector(-3670,436f, 42,18943f, 2155,838f), Vector(0.0f, 20.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 344, &iLocal_298 + 312[0]);
	*(&iLocal_298 + 312[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder31", 4,203895E-45f, Vector(-3615,168f, 42,18943f, 2121,688f), Vector(0.0f, 20.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 344, &iLocal_298 + 312[1]);
	*(&iLocal_298 + 312[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder32", 4,203895E-45f, Vector(-3705,158f, 42,18943f, 2124f), Vector(0.0f, 20.0f, 0.0f), Vector(1.0f, 1.0f, 1.0f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 344, &iLocal_298 + 312[2]);
	*(&iLocal_298 + 400) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_snakes_set");
	*(&iLocal_298 + 352[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder38", 4,203895E-45f, Vector(-3700,949f, 42,34898f, 2122,962f), Vector(0.0f, 20.0f, 0.0f), Vector(3,610236f, 3,421223f, 2,652358f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 400, &iLocal_298 + 352[0]);
	*(&iLocal_298 + 352[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder34", 4,203895E-45f, Vector(-3613,97f, 42,34898f, 2128,212f), Vector(0.0f, 20.0f, 0.0f), Vector(3,610236f, 3,421223f, 2,652358f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 400, &iLocal_298 + 352[1]);
	*(&iLocal_298 + 352[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder35", 4,203895E-45f, Vector(-3666,562f, 42,34898f, 2163,008f), Vector(0.0f, 20.0f, 0.0f), Vector(3,610236f, 3,421223f, 2,652358f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 400, &iLocal_298 + 352[2]);
	*(&iLocal_298 + 352[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder36", 4,203895E-45f, Vector(-3643,612f, 42,34898f, 2083,865f), Vector(0.0f, 20.0f, 0.0f), Vector(3,610236f, 3,421223f, 2,652358f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 400, &iLocal_298 + 352[3]);
	*(&iLocal_298 + 352[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder37", 4,203895E-45f, Vector(-3640,333f, 42,34898f, 2153,589f), Vector(0.0f, 20.0f, 0.0f), Vector(3,610236f, 3,421223f, 2,652358f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 400, &iLocal_298 + 352[4]);
	*(&iLocal_298 + 456) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_raccoons_set");
	*(&iLocal_298 + 408[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder43", 4,203895E-45f, Vector(-3695,979f, 42,23679f, 2136,317f), Vector(0.0f, 20.0f, 0.0f), Vector(4,824193f, 10,8969f, 5,528018f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 456, &iLocal_298 + 408[0]);
	*(&iLocal_298 + 408[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder39", 4,203895E-45f, Vector(-3683,682f, 42,23679f, 2096,461f), Vector(0.0f, 20.0f, 0.0f), Vector(4,824193f, 10,8969f, 5,528018f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 456, &iLocal_298 + 408[1]);
	*(&iLocal_298 + 408[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder40", 4,203895E-45f, Vector(-3638,214f, 42,23679f, 2149,041f), Vector(0.0f, 20.0f, 0.0f), Vector(4,824193f, 10,8969f, 5,528018f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 456, &iLocal_298 + 408[2]);
	*(&iLocal_298 + 408[3]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder41", 4,203895E-45f, Vector(-3611,295f, 42,23679f, 2121,366f), Vector(0.0f, 20.0f, 0.0f), Vector(4,824193f, 10,8969f, 5,528018f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 456, &iLocal_298 + 408[3]);
	*(&iLocal_298 + 408[4]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "Cylinder42", 4,203895E-45f, Vector(-3648,867f, 42,23679f, 2074,036f), Vector(0.0f, 20.0f, 0.0f), Vector(4,824193f, 10,8969f, 5,528018f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 456, &iLocal_298 + 408[4]);
	*(&iLocal_298 + 464) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nratv_bunk", 2,802597E-45f, Vector(-3682,061f, 42,5698f, 2111,87f), Vector(0.0f, 45,59922f, 0.0f), Vector(25,31392f, 9,060952f, 8,177214f));
	*(&iLocal_298 + 472) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "nratv_Dine", 2,802597E-45f, Vector(-3668,304f, 43,94373f, 2102,041f), Vector(0.0f, -46,31173f, 0.0f), Vector(11,99691f, 6,113931f, 7,192955f));
	*(&iLocal_298 + 504) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_Whores_set");
	*(&iLocal_298 + 480[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_Whores01", 2,802597E-45f, Vector(-3646,066f, 42,56909f, 2101,388f), Vector(0.0f, -44,76482f, 0.0f), Vector(25,06916f, 14,2938f, 19,08414f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 504, &iLocal_298 + 480[0]);
	*(&iLocal_298 + 480[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_Whores02", 2,802597E-45f, Vector(-3655,999f, 42,56909f, 2088,728f), Vector(0.0f, -44,76482f, 0.0f), Vector(6,673093f, 14,2938f, 3,680476f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 504, &iLocal_298 + 480[1]);
	*(&iLocal_298 + 512) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_HorseShoePit", 2,802597E-45f, Vector(-3662,472f, 43,93107f, 2134,971f), Vector(0.0f, 135,107f, 0.0f), Vector(6,81608f, 6,964901f, 16,74516f));
	*(&iLocal_298 + 520) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_BlackJack", 2,802597E-45f, Vector(-3640,298f, 43,93376f, 2104,451f), Vector(0.0f, 133,1409f, 0.0f), Vector(4,37964f, 2,965514f, 3,916286f));
	*(&iLocal_298 + 528) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_players_room", 2,802597E-45f, Vector(-3652,793f, 44,6935f, 2085,093f), Vector(0.0f, 45,59922f, 0.0f), Vector(4,759793f, 5,430603f, 6,321949f));
	*(&iLocal_298 + 560) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_main_set");
	*(&iLocal_298 + 536[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_main01", 2,802597E-45f, Vector(-3645,046f, 42,56982f, 2099,732f), Vector(0.0f, -45,05889f, 0.0f), Vector(25,56203f, 13,85471f, 14,44504f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 560, &iLocal_298 + 536[0]);
	*(&iLocal_298 + 536[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_main02", 2,802597E-45f, Vector(-3657,712f, 42,56982f, 2090,174f), Vector(0.0f, -45,05889f, 0.0f), Vector(7,878011f, 13,85471f, 9,139983f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 560, &iLocal_298 + 536[1]);
	*(&iLocal_298 + 568) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_corall", 2,802597E-45f, Vector(-3651,32f, 42,16473f, 2143,592f), Vector(0.0f, 44,8574f, 0.0f), Vector(12,70692f, 15,97864f, 20,40537f));
	*(&iLocal_298 + 576) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_horses", 2,802597E-45f, Vector(-3657,382f, 42,16473f, 2149,623f), Vector(0.0f, 44,8574f, 0.0f), Vector(28,14958f, 15,02053f, 19,18183f));
	*(&iLocal_298 + 608) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_chickens_set");
	*(&iLocal_298 + 584[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_chickens_01", 4,203895E-45f, Vector(-3649,241f, 42,57071f, 2123,689f), Vector(0.0f, -122,7184f, 0.0f), Vector(7,975013f, 7,642354f, 15,51084f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 608, &iLocal_298 + 584[0]);
	*(&iLocal_298 + 584[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_chickens_02", 4,203895E-45f, Vector(-3664,541f, 42,57071f, 2123,689f), Vector(0.0f, -48,57617f, 0.0f), Vector(7,975013f, 7,642354f, 15,51084f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 608, &iLocal_298 + 584[1]);
	*(&iLocal_298 + 616) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_saloon", 2,802597E-45f, Vector(-3646,287f, 44,28983f, 2100,976f), Vector(0.0f, 135,6248f, 0.0f), Vector(24,87583f, 4,187143f, 18,12609f));
	*(&iLocal_298 + 640) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_298, "ratv_pigs_set");
	*(&iLocal_298 + 624[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_298, "ratv_pigs_01", 2,802597E-45f, Vector(-3620,959f, 42,7423f, 2119,239f), Vector(0.0f, 44,8574f, 0.0f), Vector(10,96561f, 6,400937f, 7,425486f));
	ADD_TO_VOLUME_SET(&iLocal_298 + 640, &iLocal_298 + 624[0]);
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_report_crime_road", Vector(-3709,576f, 38,298f, 2180,219f), Vector(0.0f, 134,997f, 0.0f));
	*(&iLocal_298 + 648) = Vector(-3679,57f, 42,76945f, 2116,521f);
	*(&iLocal_298 + 648 + 12) = Vector(0.0f, 46,5f, 0.0f);
	*(&iLocal_298 + 672) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_merc_giver", Vector(-3679,57f, 42,76945f, 2116,521f), Vector(0.0f, 46,5f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_report_crime_road1", Vector(-3600,961f, 33,418f, 2198,256f), Vector(0.0f, 261,738f, 0.0f));
	*(&iLocal_298 + 680) = Vector(-3660,212f, 42,212f, 2118,864f);
	*(&iLocal_298 + 680 + 12) = Vector(0.0f, 234,371f, 0.0f);
	*(&iLocal_298 + 704) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_playerDuel1", Vector(-3660,212f, 42,212f, 2118,864f), Vector(0.0f, 234,371f, 0.0f));
	*(&iLocal_298 + 712) = Vector(-3653,307f, 42,189f, 2124,016f);
	*(&iLocal_298 + 712 + 12) = Vector(0.0f, 54,53135f, 0.0f);
	*(&iLocal_298 + 736) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_enDuel1", Vector(-3653,307f, 42,189f, 2124,016f), Vector(0.0f, 54,53135f, 0.0f));
	*(&iLocal_298 + 744) = Vector(-3688,435f, 42,97049f, 2118,117f);
	*(&iLocal_298 + 744 + 12) = Vector(0.0f, -135,7672f, 0.0f);
	*(&iLocal_298 + 768) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorPoint_room", Vector(-3688,435f, 42,97049f, 2118,117f), Vector(0.0f, -135,7672f, 0.0f));
	*(&iLocal_298 + 776) = Vector(-3681,78f, 42,8261f, 2111,366f);
	*(&iLocal_298 + 776 + 12) = Vector(0.0f, -128,9299f, 0.0f);
	*(&iLocal_298 + 800) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorPoint_room1", Vector(-3681,78f, 42,8261f, 2111,366f), Vector(0.0f, -128,9299f, 0.0f));
	*(&iLocal_298 + 808) = Vector(-3676,121f, 42,84285f, 2105,66f);
	*(&iLocal_298 + 808 + 12) = Vector(0.0f, -133,9488f, 0.0f);
	*(&iLocal_298 + 832) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorPoint_room2", Vector(-3676,121f, 42,84285f, 2105,66f), Vector(0.0f, -133,9488f, 0.0f));
	*(&iLocal_298 + 840) = Vector(-3665,583f, 42,97049f, 2104,722f);
	*(&iLocal_298 + 840 + 12) = Vector(0.0f, 133,635f, 0.0f);
	*(&iLocal_298 + 864) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorPoint_kitchen", Vector(-3665,583f, 42,97049f, 2104,722f), Vector(0.0f, 133,635f, 0.0f));
	*(&iLocal_298 + 872) = Vector(-3640,909f, 42,81192f, 2108,583f);
	*(&iLocal_298 + 872 + 12) = Vector(0.0f, 133,3033f, 0.0f);
	*(&iLocal_298 + 896) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorPoint_saloon", Vector(-3640,909f, 42,81192f, 2108,583f), Vector(0.0f, 133,3033f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos1", Vector(-3537,666f, 51,095f, 2197,576f), Vector(-8,571f, 74,576f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos2", Vector(-3740,636f, 66,742f, 2234,344f), Vector(-3,548f, -35,045f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos3", Vector(-3790,722f, 35,46f, 2374,584f), Vector(-3,846f, -38,871f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos4", Vector(-3517,717f, 27,906f, 2478,56f), Vector(-0,879f, 29,392f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos5", Vector(-3637,22f, 53,512f, 2077,482f), Vector(-19,611f, -165,941f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos6", Vector(-3661,797f, 50,852f, 2099,953f), Vector(-21,407f, -175,593f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos7", Vector(-3696,647f, 42,663f, 2145,779f), Vector(8,18f, -94,142f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos8", Vector(-3625,752f, 43,288f, 2128,093f), Vector(-4,06f, 86,964f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos9", Vector(-3658,883f, 43,521f, 2119,656f), Vector(-5,587f, -41,994f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "rat_vista_cam_pos10", Vector(-3680,953f, 43,298f, 2146,535f), Vector(6,062f, -88,992f, 0.0f));
	*(&iLocal_298 + 904) = Vector(-3642,582f, 42,81192f, 2103,989f);
	*(&iLocal_298 + 904 + 12) = Vector(0.0f, 171,5513f, 0.0f);
	*(&iLocal_298 + 928) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_298, "ratf_interiorSettlement01", Vector(-3642,582f, 42,81192f, 2103,989f), Vector(0.0f, 171,5513f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xF322 / 62242
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xF36C / 62316
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xF37D / 62333
{
	return;
}

bool Function_254() //Position: 0xF383 / 62339
{
	return 1;
}

void Function_255() //Position: 0xF38A / 62346
{
...
bool Function_256() //Position: 0xF3F6 / 62454
{
	return Function_257();
}

int Function_257() //Position: 0xF3FF / 62463
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	Function_251(3, 3);
	uVar0 = &uVar0;
	Function_169(&iLocal_178 + 8, "p_gen_gatlingGun01x", 0, 0);
	...
	iLocal_178 = FIND_NAMED_LAYOUT("RathskellerFork_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("RathskellerFork_layout");
	}
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-3677,78f, 46,79279f, 2109,943f), Vector(0.0f, 44,87215f, 0.0f), Vector(35,03042f, 9,20523f, 15,60501f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-3648,302f, 46,82883f, 2098,528f), Vector(0.0f, 135.0f, 0.0f), Vector(33,26289f, 11,66569f, 19,86834f));
	*(&iLocal_178 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-3648,108f, 46,82883f, 2099,245f), Vector(0.0f, 135.0f, 0.0f), Vector(42,24061f, 11,66569f, 30,87942f));
	*(&iLocal_178 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_2", 2,802597E-45f, Vector(-3678,2f, 46,79279f, 2113,032f), Vector(0.0f, 44,87215f, 0.0f), Vector(31,31033f, 9,20523f, 19,18906f));
	*(&iLocal_178 + 112) = Vector(-3682,141f, 42,5698f, 2113,858f);
	*(&iLocal_178 + 112 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 136) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_bunk", Vector(-3682,141f, 42,5698f, 2113,858f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 144) = Vector(-3641,758f, 42,56982f, 2102,225f);
	*(&iLocal_178 + 144 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 168) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_main", Vector(-3641,758f, 42,56982f, 2102,225f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 176) = Vector(-3656f, 42,56982f, 2088.0f);
	*(&iLocal_178 + 176 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 200) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_judge", Vector(-3656f, 42,56982f, 2088.0f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 208) = Vector(-3658,599f, 42,16472f, 2149,401f);
	*(&iLocal_178 + 208 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 232) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_stable", Vector(-3658,599f, 42,16472f, 2149,401f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 240) = Vector(-3670,337f, 42,5698f, 2101,66f);
	*(&iLocal_178 + 240 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 264) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_bunk1", Vector(-3670,337f, 42,5698f, 2101,66f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 272) = Vector(-3659,985f, 42,56141f, 2095,988f);
	*(&iLocal_178 + 272 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 296) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rat_flag_yard", Vector(-3659,985f, 42,56141f, 2095,988f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 304) = Vector(-3653,14f, 42,5694f, 2108,013f);
	*(&iLocal_178 + 304 + 12) = Vector(0.0f, 0.0f, 0.0f);
	*(&iLocal_178 + 328) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "f_playerHorse", Vector(-3653,14f, 42,5694f, 2108,013f), Vector(0.0f, 0.0f, 0.0f));
	*(&iLocal_178 + 336) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-3646,508f, 46,41805f, 2106,547f), Vector(0.0f, -220,5872f, 0.0f));
	DECOR_SET_INT(&uVar1, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar1, &iLocal_178 + 336);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01_core", Vector(-3674,232f, 47,1266f, 2108,865f), Vector(0.0f, -122.0f, 0.0f));
	DECOR_SET_BOOL(&uVar2, "Core", true);
	DECOR_SET_INT(&uVar2, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 336);
	*(&iLocal_178 + 344) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-3674,225f, 47,1266f, 2107,466f), Vector(0.0f, -180,266f, 0.0f));
	DECOR_SET_BOOL(&uVar3, "Core", true);
	DECOR_SET_INT(&uVar3, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar3, &iLocal_178 + 344);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-3674,232f, 47,1266f, 2108,865f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar4, "Core", true);
	DECOR_SET_INT(&uVar4, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar4, &iLocal_178 + 344);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_player", Vector(-3646,506f, 46,41805f, 2105,146f), Vector(0.0f, -180,1375f, 0.0f));
	DECOR_SET_INT(&uVar5, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 344);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_02_surv", Vector(-3646,508f, 46,41805f, 2106,547f), Vector(0.0f, -360.0f, 0.0f));
	DECOR_SET_INT(&uVar6, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 344);
	*(&iLocal_178 + 352) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def04", Vector(-3674,232f, 47,1266f, 2108,865f), Vector(0.0f, -122.0f, 0.0f));
	DECOR_SET_INT(&uVar7, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 352);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def03_core", Vector(-3665,126f, 47,13488f, 2106,248f), Vector(0.0f, -156.0f, 0.0f));
	DECOR_SET_BOOL(&uVar8, "Core", true);
	DECOR_SET_INT(&uVar8, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 352);
	*(&iLocal_178 + 360) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_01_player", Vector(-3665,126f, 47,1338f, 2104,847f), Vector(0.0f, -180.0f, 0.0f));
	DECOR_SET_BOOL(&uVar9, "Core", true);
	DECOR_SET_INT(&uVar9, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 360);
	uVar10 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_01_surv", Vector(-3665,126f, 47,13488f, 2106,248f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar10, "Core", true);
	DECOR_SET_INT(&uVar10, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar10, &iLocal_178 + 360);
	*(&iLocal_178 + 368) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup02_defSet", &iLocal_178, 8, 0);
	uVar11 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def06", Vector(-3684,908f, 47,19706f, 2119,312f), Vector(0.0f, -135.0f, 0.0f));
	DECOR_SET_INT(&uVar11, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar11, &iLocal_178 + 368);
	uVar12 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def05_core", Vector(-3665,126f, 47,13488f, 2106,248f), Vector(0.0f, -156.0f, 0.0f));
	DECOR_SET_BOOL(&uVar12, "Core", true);
	DECOR_SET_INT(&uVar12, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar12, &iLocal_178 + 368);
	*(&iLocal_178 + 376) = CREATE_OBJECTSET_IN_LAYOUT("ammo_02Set", &iLocal_178, 8, 0);
	uVar13 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_02_player", Vector(-3684,796f, 47,19706f, 2117,916f), Vector(0.0f, -184,5907f, 0.0f));
	DECOR_SET_INT(&uVar13, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar13, &iLocal_178 + 376);
	uVar14 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_02_02_surv", Vector(-3684,908f, 47,19706f, 2119,312f), Vector(0.0f, -364.0f, 0.0f));
	DECOR_SET_INT(&uVar14, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar14, &iLocal_178 + 376);
	*(&iLocal_178 + 384) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup03_defSet", &iLocal_178, 8, 0);
	uVar15 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def08", Vector(-3684,908f, 47,19706f, 2119,312f), Vector(0.0f, -135.0f, 0.0f));
	DECOR_SET_INT(&uVar15, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar15, &iLocal_178 + 384);
	uVar16 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def07_core", Vector(-3641,451f, 46,41805f, 2111,697f), Vector(0.0f, -222,3637f, 0.0f));
	DECOR_SET_BOOL(&uVar16, "Core", true);
	DECOR_SET_INT(&uVar16, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar16, &iLocal_178 + 384);
	*(&iLocal_178 + 392) = CREATE_OBJECTSET_IN_LAYOUT("ammo_03Set", &iLocal_178, 8, 0);
	uVar17 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_01_player", Vector(-3641,467f, 46,41805f, 2110,297f), Vector(0.0f, -179,3257f, 0.0f));
	DECOR_SET_BOOL(&uVar17, "Core", true);
	DECOR_SET_INT(&uVar17, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar17, &iLocal_178 + 392);
	uVar18 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_03_01_surv", Vector(-3641,451f, 46,41805f, 2111,697f), Vector(0.0f, 0.0f, 0.0f));
	DECOR_SET_BOOL(&uVar18, "Core", true);
	DECOR_SET_INT(&uVar18, "GiveWeapon", 42);
	ADD_OBJECT_TO_OBJECTSET(&uVar18, &iLocal_178 + 392);
	*(&iLocal_178 + 400) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar19 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-3676f, 42,49113f, 2124,015f), Vector(0.0f, -88,86583f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar19, &iLocal_178 + 400);
	uVar20 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-3671,627f, 42,528f, 2121,647f), Vector(0.0f, 112,1144f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar20, &iLocal_178 + 400);
	*(&iLocal_178 + 408) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar21 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-3653,417f, 47,17472f, 2082,929f), Vector(0.0f, 178,9326f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar21, &iLocal_178 + 408);
	uVar22 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_3", Vector(-3664,75f, 42,16473f, 2163,212f), Vector(0.0f, -46,15682f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar22, &iLocal_178 + 408);
	*(&iLocal_178 + 416) = Vector(-3658,131f, 42,81397f, 2092,973f);
	*(&iLocal_178 + 416 + 12) = Vector(0.0f, -135,0896f, 0.0f);
	*(&iLocal_178 + 440) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-3658,131f, 42,81397f, 2092,973f), Vector(0.0f, -135,0896f, 0.0f));
	*(&iLocal_178 + 448) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_stand_rfl", "DLC_survivor_stand_rfl", Vector(-3676f, 42,49846f, 2124,015f), Vector(0.0f, -89,83514f, 0.0f));
	*(&iLocal_178 + 456) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "rand_idle_stand", "rand_idle_stand", Vector(-3671,635f, 42,54024f, 2121,651f), Vector(0.0f, -247,4331f, 0.0f));
	*(&iLocal_178 + 464) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_L", "ZombiePack_player_sleep_bed_L", Vector(-3659,839f, 42,81774f, 2090,631f), Vector(0.0f, 46,62177f, 0.0f));
	*(&iLocal_178 + 472) = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "gatlingGun01x0", "p_gen_gatlingGun01x", Vector(-3643,518f, 46,41805f, 2109,422f), Vector(0.0f, 136,2623f, 0.0f), 1);
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0x10337 / 66359
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0x103D2 / 66514
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0x104DE / 66782
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0x105BA / 67002
{
...
int Function_262(int iParam0) //Position: 0x10635 / 67125
{
...
bool Function_263(int iParam0) //Position: 0x1064A / 67146
{
...
int Function_264(int iParam0) //Position: 0x106B0 / 67248
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0x10772 / 67442
{
	int iVar0;
...
void Function_266() //Position: 0x1078F / 67471
{
	return;
}

void Function_267(char* cParam0) //Position: 0x10795 / 67477
{
	if (!Function_26(128))
	{
		return;
