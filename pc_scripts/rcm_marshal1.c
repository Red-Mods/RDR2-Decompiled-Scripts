...
void main() //Position: 0x0 / 0
{
	...
	iLocal_382 = 0;
	iLocal_370 = 1000;
	Function_194(&uLocal_336, 1218, 2, 1);
	Function_194(&uLocal_336, 666, 2, 1);
	Function_192(&uLocal_336, "rand_idle_stand", 1, 0);
	Function_192(&uLocal_336, "sit_chr_dsk_wrk", 1, 0);
	Function_192(&uLocal_336, "DLC_RCM_mother_superior", 1, 0);
	Function_192(&uLocal_336, "dead_ground_male", 5, 0);
	Function_192(&uLocal_336, "ptl_base", 5, 0);
	Function_192(&uLocal_336, "shotgun_sawed01x", 0, 0);
	Function_191(&iLocal_403);
	while (!IS_EXITFLAG_SET())
	{
		Function_186();
		if (IS_ACTOR_VALID(&uLocal_385))
		{
			if ((GET_LAST_ATTACKER(&uLocal_385) != &Global_54076 || GET_LAST_ATTACKER(&uLocal_387) != &Global_54076) || GET_LAST_ATTACKER(&uLocal_389) != &Global_54076)
			{
				TASK_CLEAR(&uLocal_385);
				TASK_CLEAR(&uLocal_387);
				TASK_CLEAR(&uLocal_389);
				SET_ACTOR_FACTION(&uLocal_385, 4);
				SET_ACTOR_FACTION(&uLocal_387, 4);
				SET_ACTOR_FACTION(&uLocal_389, 32);
				if (!Function_185(15))
				{
					Function_184(15, 1);
				}
		...
		switch (iLocal_382)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					...
					{
						uLocal_385 = &Global_99725[ScriptParam_043] + 312;
						if (IS_ACTOR_VALID(&uLocal_385) && Function_172(&uLocal_336))
						{
							uLocal_399 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_383, "Marshal1_StayOut", 2,802597E-45f, Vector(-2086,485f, 20,071f, 2603,702f), Vector(0.0f, 24,353f, 0.0f), Vector(13,94f, 8,597f, 8,977f));
							...
							uLocal_387 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_383, "RCM_Marshal1_Prisoner", 666, Vector(-2082,766f, 16,984f, 2603,48f), Vector(0.0f, 192,276f, 0.0f));
							uLocal_389 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_383, "RCM_Marshal1_Zombie", 1218, Vector(-2082,359f, 16,995f, 2604,209f), Vector(0.0f, 22,831f, 0.0f));
							uLocal_391 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_383, "RCM_Marshal1_StandIdleGringo", "rand_idle_stand", Vector(-2085,311f, 16,965f, 2605,992f), Vector(0.0f, -51,56f, 0.0f)));
							uLocal_393 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_383, "RCM_Marshal1_StruggleGringo", "DLC_RCM_mother_superior", Vector(-2082,27f, 16,968f, 2603,618f), Vector(0.0f, 202,533f, 0.0f)));
							uLocal_401 = CREATE_VOLUME_SET_IN_LAYOUT(&uLocal_383, "RCM_Marshal1_GatewaySet");
							ADD_TO_VOLUME_SET(StackVal, CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_401, &uLocal_383, "Marshal1_Gateway01", 4,203895E-45f, Vector(-2089,727f, 17,042f, 2605,469f), Vector(0.0f, 24,006f, 0.0f), Vector(2,921f, 1,63f, 2,921f)));
							ADD_TO_VOLUME_SET(StackVal, CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_401, &uLocal_383, "Marshal1_Gateway02", 2,802597E-45f, Vector(-2084,523f, 17,576f, 2602,944f), Vector(0.0f, 24,353f, 0.0f), Vector(8,337f, 3,409f, 7,715f)));
							SET_ACTOR_FACTION(&uLocal_385, 20);
							SET_ACTOR_FACTION(&uLocal_387, 20);
							SET_ACTOR_FACTION(&uLocal_389, 20);
							TASK_PRIORITY_SET(&uLocal_385, true);
							TASK_PRIORITY_SET(&uLocal_387, true);
							TASK_PRIORITY_SET(&uLocal_389, true);
							TASK_USE_GRINGO(&uLocal_385, &uLocal_391, "UseCase1", 4294967295, 1);
							TASK_USE_GRINGO(&uLocal_387, &uLocal_393, "Mom", 4294967295, 1);
							TASK_USE_GRINGO(&uLocal_389, &uLocal_393, "UseCase1", 4294967295, 1);
							SNAP_ACTOR_TO_GRINGO(&uLocal_385, GET_OBJECT_FROM_GRINGO(&uLocal_391), "UseCase1", true, 0, 0);
							SNAP_ACTOR_TO_GRINGO(&uLocal_387, GET_OBJECT_FROM_GRINGO(&uLocal_393), "Mom", true, 0, 0);
							SNAP_ACTOR_TO_GRINGO(&uLocal_389, GET_OBJECT_FROM_GRINGO(&uLocal_393), "UseCase1", true, 0, 0);
							iLocal_382 = 1;
							Function_170(&iLocal_403);
						}
						else if (Function_167(&iLocal_403) < 5.0f)
						{
							Function_170(&iLocal_403);
						}
						Function_160(&(Global_99725[1543]), 15, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						uLocal_383 = CREATE_LAYOUT("RCM_Marshal1_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (!iLocal_409)
				{
					if (IS_ACTOR_ALIVE(&uLocal_387))
					{
						if (IS_ACTOR_ALIVE(&uLocal_389))
						{
							if (ACTORS_IN_RANGE(&Global_54076, &uLocal_387, 15.0f))
							{
								if (IS_GRINGO_VALID(GET_CURRENT_GRINGO(&uLocal_387)))
								{
									if (IS_GRINGO_VALID(GET_CURRENT_GRINGO(&uLocal_389)))
									{
										SET_ACTOR_UPDATE_PRIORITY(&uLocal_387, false);
										SET_ACTOR_UPDATE_PRIORITY(&uLocal_389, false);
										SET_ACTOR_ANIM_CURRENT_TIME(&uLocal_387, 0.0f);
										SET_ACTOR_ANIM_CURRENT_TIME(&uLocal_389, 0.0f);
										iLocal_409 = 1;
									}
								}
							}
				...
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (StackVal && FABS((StackVal - (!Function_156(&Global_54076, 1, 1) && !IS_ACTOR_RAGDOLL(&Global_54076)))) > 2.0f)
					{
						if (IS_ACTOR_IN_VOLUME(&Global_54076, &uLocal_401))
						{
							Function_152(&Global_99725[ScriptParam_043] + 288, 0, 1, 0, 1, 0);
			...
			case 0x00000003:
				if (Function_114("$/cutscene/MARSHAL_RCM_1_CS_SEQ/MARSHAL_RCM_1_CS_SEQ", &iLocal_370, 33507, 33362, 32042, 31335, 31056, 31045, 1, 1, 2, 2, 0))
				{
					iLocal_382 = 5;
					Function_170(&iLocal_403);
				}
			...
			case 0x00000005:
				...
				{
					Function_183(&Global_99725[1543] + 228, 256);
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Marshal1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x844 / 2116
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xCBE / 3262
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xE5F / 3679
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xE65 / 3685
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xEA4 / 3748
{
...
void Function_6() //Position: 0xEF9 / 3833
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_8() //Position: 0x104A / 4170
{
	float fVar0;
...
void Function_9() //Position: 0x107D / 4221
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x1210 / 4624
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x13C9 / 5065
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x13D7 / 5079
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x15F4 / 5620
{
...
struct<8> Function_14(int iParam0) //Position: 0x1609 / 5641
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x16B0 / 5808
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x194C / 6476
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_17() //Position: 0x1F8A / 8074
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x1F93 / 8083
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1FA4 / 8100
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0) //Position: 0x209B / 8347
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x20B6 / 8374
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x211D / 8477
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x212F / 8495
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2141 / 8513
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x2275 / 8821
{
	return Global_55480[iParam016].f_96;
}

float Function_26(int iParam0) //Position: 0x2284 / 8836
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x22BD / 8893
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x22FA / 8954
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x2494 / 9364
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x26D8 / 9944
{
...
struct<8> Function_31() //Position: 0x2719 / 10009
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x27A2 / 10146
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x2839 / 10297
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x28B8 / 10424
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x28F5 / 10485
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2B01 / 11009
{
	struct<2> Var0;
	var uVar2;
...
bool Function_37(char* cParam0) //Position: 0x2BB8 / 11192
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_38(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2BD0 / 11216
{
	int iVar0;
...
struct<8> Function_39() //Position: 0x2CC8 / 11464
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_40(int iParam0) //Position: 0x2CD2 / 11474
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x2CE8 / 11496
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_42(struct<2> Param0, struct<2> Param2) //Position: 0x2DB4 / 11700
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_43(float fParam0, int iParam1) //Position: 0x2DD1 / 11729
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_44(int iParam0) //Position: 0x35FD / 13821
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x3638 / 13880
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(var uParam0, int iParam1) //Position: 0x3645 / 13893
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3654 / 13908
{
	uParam0 = &uParam0;
...
void Function_48(int iParam0) //Position: 0x3703 / 14083
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_185(4) && !Function_54(0))
	{
	...
	if (!Function_51(&Global_6667[228] + 184, 2) || ((((((Function_185(14) && Function_185(18)) && Function_185(37)) && Function_185(7)) && Function_185(11)) && Function_185(5)) && Function_185(21)))
	{
	...
	if (!Function_51(&Global_6667[328] + 184, 2) || ((Function_185(27) && Function_185(1)) && Function_185(23)))
	{
	...
	if (!Function_185(7))
	{
		...
		if (((Function_185(6) && Function_49(Global_46949) < 0) && Function_49(Global_46951) < 0) && Function_49(Global_46952) < 0)
		{
...
int Function_49(int iParam0) //Position: 0x4025 / 16421
{
...
bool Function_50(int iParam0) //Position: 0x403F / 16447
{
...
bool Function_51(int iParam0, int iParam1) //Position: 0x4056 / 16470
{
	int iVar0;
...
bool Function_52() //Position: 0x4073 / 16499
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x407F / 16511
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x4094 / 16532
{
...
int Function_55(int iParam0) //Position: 0x40FA / 16634
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_56(int iParam0) //Position: 0x41BC / 16828
{
...
bool Function_57(int iParam0, bool bParam1) //Position: 0x4205 / 16901
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x4243 / 16963
{
...
bool Function_59(int iParam0) //Position: 0x425D / 16989
{
...
void Function_60(bool bParam0) //Position: 0x4273 / 17011
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_61(struct<229> Param0) //Position: 0x442D / 17453
{
	float fVar0;
	int iVar1;
...
void Function_62(struct<217> Param0) //Position: 0x44FD / 17661
{
	float fVar0;
	var uVar1;
...
int Function_63(var uParam0, int iParam1) //Position: 0x45BB / 17851
{
	int iVar0;
	var uVar1;
...
void Function_64(int iParam0, var uParam1, struct<2> Param2) //Position: 0x4725 / 18213
{
	struct<8> Var0;
...
struct<32> Function_65(char* cParam0) //Position: 0x47CD / 18381
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_66(char* cParam0) //Position: 0x4839 / 18489
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x485B / 18523
{
	int iVar0;
	struct<2> Var1;
...
float Function_68(int iParam0, struct<2> Param1) //Position: 0x49C9 / 18889
{
	struct<2> Var0;
...
struct<8> Function_69(int iParam0) //Position: 0x4A40 / 19008
{
	struct<2> Var0;
...
void Function_70(int iParam0) //Position: 0x4AAC / 19116
{
...
bool Function_71(int iParam0) //Position: 0x4B14 / 19220
{
...
void Function_72(struct<153> Param0) //Position: 0x4B2A / 19242
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
void Function_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5040 / 20544
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_74(int iParam0) //Position: 0x50CB / 20683
{
	char* cVar0[16];
...
bool Function_75() //Position: 0x510A / 20746
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_76(int iParam0) //Position: 0x5137 / 20791
{
...
var Function_77(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5163 / 20835
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_78(int iParam0) //Position: 0x5184 / 20868
{
...
bool Function_79(struct<249> Param0) //Position: 0x5199 / 20889
{
	...
	if ((Function_89(iParam1) || Function_185(iParam1)) || Function_88(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_80(struct<265> Param0) //Position: 0x52C9 / 21193
{
	int iVar0;
...
bool Function_81(int iParam0) //Position: 0x542A / 21546
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_82(int iParam0) //Position: 0x544E / 21582
{
...
bool Function_83(int iParam0) //Position: 0x5463 / 21603
{
	return Global_116927[iParam06].f_16;
}

bool Function_84(struct<237> Param0) //Position: 0x5473 / 21619
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_85(int iParam0) //Position: 0x5542 / 21826
{
...
bool Function_86(int iParam0) //Position: 0x559D / 21917
{
	int iVar0;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x55B9 / 21945
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x55D6 / 21974
{
...
int Function_89(int iParam0) //Position: 0x55EB / 21995
{
...
void Function_90() //Position: 0x5600 / 22016
{
...
int Function_91(int iParam0, int iParam1) //Position: 0x5680 / 22144
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
	...
	switch (iParam0)
	{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_185(26) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_185(25) && iVar15)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_185(24) && iVar15)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar15 = 0;
					}
					else if (Function_185(23) && iVar15)
					{
				...
				case 0x00000008:
					if (Function_185(55) && iVar16)
					{
						cVar4 = &Global_44085[Global_46866[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_185(54) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
					else if (Function_185(27) && iVar16)
					{
						cVar4 = &Global_44085[Global_46894[0]9] + 8;
						iVar16 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_185(52) && iVar13)
					{
						cVar4 = &Global_44085[Global_46926[2]9] + 8;
						iVar13 = 0;
					}
					else if (Function_185(51) && iVar13)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar13 = 0;
					}
					else if (Function_185(50) && iVar13)
					{
						cVar4 = &Global_44085[Global_46796[4]9] + 8;
						iVar13 = 0;
					}
					else if (Function_185(49) && iVar13)
					{
						cVar4 = &Global_44085[Global_46816[1]9] + 8;
						iVar13 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_185(19) && iVar17)
					{
						Var0 = Vector(-1708,36f, 46,18f, 2175,89f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_57(6, 0) && Function_185(18)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_185(17) && iVar17)
					{
						Var0 = Vector(-1687,208f, 53,208f, 2140,491f);
						vVar2 = Vector(125.0f, 125.0f, 125.0f);
						iVar17 = 0;
					}
					else if ((Function_57(9, 0) && Function_185(16)) && iVar17)
					{
						cVar4 = &Global_44085[Global_46760[0]9] + 8;
						iVar17 = 0;
					}
					else if (Function_185(15) && iVar17)
					{
...
int Function_92(int iParam0) //Position: 0x62E3 / 25315
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x6332 / 25394
{
...
int Function_94(int iParam0) //Position: 0x6348 / 25416
{
...
void Function_95() //Position: 0x63B1 / 25521
{
...
bool Function_96(int iParam0) //Position: 0x63D6 / 25558
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x6427 / 25639
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x6454 / 25684
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x64A6 / 25766
{
	int iVar0;
...
void Function_100() //Position: 0x64E0 / 25824
{
	bool bVar0;
...
void Function_101(int iParam0, int iParam1) //Position: 0x653E / 25918
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_102(int iParam0) //Position: 0x6554 / 25940
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x659E / 26014
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x6613 / 26131
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x664D / 26189
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x66C9 / 26313
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x676A / 26474
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x67A7 / 26535
{
...
bool Function_109() //Position: 0x67BA / 26554
{
...
int Function_110(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x67D5 / 26581
{
	int iVar0;
	int iVar1;
...
void Function_111(int iParam0) //Position: 0x69FD / 27133
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_112(bool bParam0, bool bParam1) //Position: 0x6A9B / 27291
{
	bool bVar0;
...
void Function_113(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6AC0 / 27328
{
	struct<4> Var0;
	var uVar4;
...
bool Function_114(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6B55 / 27477
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_115(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6C0E / 27662
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_167(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_116(var uParam0, bool bParam1) //Position: 0x7270 / 29296
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_117() //Position: 0x733F / 29503
{
	int iVar0;
...
void Function_118() //Position: 0x73B7 / 29623
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_119() //Position: 0x73FC / 29692
{
...
void Function_120(bool bParam0) //Position: 0x740E / 29710
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_121(var uParam0, int iParam1) //Position: 0x742B / 29739
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_122(int iParam0) //Position: 0x74BD / 29885
{
	bool bVar0;
...
int Function_123(bool bParam0) //Position: 0x74EE / 29934
{
	bool bVar0;
	var uVar1;
...
bool Function_124() //Position: 0x75B1 / 30129
{
	bool bVar0;
	var uVar1;
...
bool Function_125(struct<37> Param0) //Position: 0x75EE / 30190
{
	return Param0.f_36;
}

void Function_126(var uParam0, int iParam1) //Position: 0x75F9 / 30201
{
	Function_127(&uParam0, &iParam1, 0);
	return;
}

void Function_127(var uParam0, bool bParam1, bool bParam2) //Position: 0x7609 / 30217
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7781 / 30593
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x77AB / 30635
{
	var uVar0;
	var uVar1;
...
void Function_130() //Position: 0x7806 / 30726
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_131() //Position: 0x7945 / 31045
{
	Function_120(1.0f);
	return 1;
}

int Function_132() //Position: 0x7950 / 31056
{
...
void Function_133(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7983 / 31107
{
	var uVar0;
...
void Function_134() //Position: 0x7A52 / 31314
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x7A67 / 31335
{
	struct<2> Var0;
	var uVar2;
	
	Var0 = Vector(-2088,85f, 16,9525f, 2602,82f);
	uVar2 = LOCATE_PHYSINST_OF_TYPE(Var0, 2.0f, "p_gen_chair01x", 1);
	if (!IS_PHYSINST_VALID(&uVar2))
	{
		uVar2 = GET_PHYSINST_FROM_OBJECT(CREATE_PROP_IN_LAYOUT(StackVal, &uLocal_383, "Marshal1_Chair", "p_gen_chair01x", Var0, Vector(0.0f, 34,5365f, 0.0f), false));
	}
	if (IS_PHYSINST_VALID(&uVar2))
	{
		uLocal_391 = LOCATE_GRINGO_OF_TYPE("sit_chr_dsk_wrk", &Var0, 4.0f, 0);
		if (IS_GRINGO_VALID(&uLocal_391))
		{
			DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(&uLocal_391));
		}
		SET_OBJECT_POSITION(&uVar2, Var0);
		uLocal_391 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_ON_OBJECT(StackVal, StackVal, &uVar2, "RCM_Marshal1_DeskGringo", "sit_chr_dsk_wrk", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)));
	}
	CREATE_CORPSE_IN_LAYOUT(StackVal, StackVal, &Global_46715, "Marshal1_DeadPrisoner", 9,332648E-43f, Vector(-2080,655f, 16,995f, 2603,241f), Vector(0.0f, 102,904f, 0.0f), "dead_ground_male", "inj_deadpose_2");
	CREATE_CORPSE_IN_LAYOUT(StackVal, StackVal, &Global_46715, "Marshal1_DeadZombie", 1,706782E-42f, Vector(-2081,045f, 16,982f, 2602,356f), Vector(0.0f, 126,341f, 0.0f), "dead_ground_male", "inj_deadpose_1");
	DESTROY_ACTOR(&uLocal_387);
	DESTROY_ACTOR(&uLocal_389);
	if (IS_GRINGO_VALID(&uLocal_391))
	{
		SNAP_ACTOR_TO_GRINGO(&uLocal_385, GET_OBJECT_FROM_GRINGO(&uLocal_391), "UseCase1", true, 0, 1);
		TASK_USE_GRINGO(&uLocal_385, &uLocal_391, "UseCase1", 4294967295, 1);
	}
	else
	{
		TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_385, Vector(-2088,415f, 16,982f, 2601,308f), -173,903f, 1, 1, true);
		TASK_STAND_STILL(&uLocal_385, -1.0f, 1, 0);
	}
...
int Function_136() //Position: 0x7D2A / 32042
{
	if (!iLocal_408)
	{
		if (IS_GRINGO_VALID(&uLocal_391))
		...
		Function_137(StackVal, Vector(-2089,776f, 16,309f, 2593,775f), &uLocal_397);
		iLocal_408 = 1;
	}
	return 1;
}

void Function_137(vector3 vParam0) //Position: 0x7D67 / 32103
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_138(int iParam0, int iParam1) //Position: 0x7F10 / 32528
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_139(float fParam0, float fParam1) //Position: 0x8007 / 32775
{
...
void Function_140() //Position: 0x8118 / 33048
{
...
void Function_141() //Position: 0x814C / 33100
{
...
int Function_142() //Position: 0x8252 / 33362
{
	Function_143(15, 0, 0);
...
int Function_143(bool bParam0, bool bParam1, int iParam2) //Position: 0x8277 / 33399
{
...
bool Function_144(int iParam0) //Position: 0x82D1 / 33489
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int Function_145() //Position: 0x82E3 / 33507
{
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("COMPANION_Marshal", &uLocal_385);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("MISC_TownDrunk", &uLocal_387);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Bruiser_05", &uLocal_389);
	...
	uLocal_397 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &uLocal_383, "Marshal1_CSVol", 2,802597E-45f, Vector(-2085,967f, 19,627f, 2603,78f), Vector(0.0f, 24,353f, 0.0f), Vector(13,105f, 8,597f, 9,176f));
	Function_148(0, 0, 1, 1, 0, 1, 1, &uLocal_397, 1, 1, 1, 1, 0x3f800000, 0);
	Function_146(StackVal, &uLocal_383, *(&Global_99725[1543] + 196), &uLocal_397, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_146(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x83DC / 33756
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_147(var uParam0, float fParam1) //Position: 0x867C / 34428
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_148(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x86FE / 34558
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_151(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_17(), 2, Function_151(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_150()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_149(int iParam0) //Position: 0x89B0 / 35248
{
	int iVar0;
...
var Function_150() //Position: 0x89E4 / 35300
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_151(bool bParam0) //Position: 0x8A72 / 35442
{
	struct<2> Var0;
...
int Function_152(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8A84 / 35460
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(&uParam0))
	{
		...
		if (IS_OBJECT_VALID(&uVar0))
		{
			...
			if (&bParam3)
			{
				Function_155(&uVar1, &fParam5);
			}
			else if (IS_ACTOR_RIDING(&uVar1))
			{
				if (Function_154(&uVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(&uVar1)))
				{
...
int Function_153(vector3 vParam0) //Position: 0x8CB9 / 36025
{
	var uVar0;
...
float Function_154(var uParam0, bool bParam1) //Position: 0x8D2F / 36143
{
	struct<2> Var0;
...
void Function_155(var uParam0, bool bParam1) //Position: 0x8D50 / 36176
{
	var uVar0;
	var uVar1;
	...
	else if (!&bParam1 || Function_154(&uParam0, 0) < 2.0f)
	{
...
bool Function_156(int iParam0, bool bParam1, bool bParam2) //Position: 0x8DBA / 36282
{
...
bool Function_157() //Position: 0x8E7E / 36478
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_158(int iParam0) //Position: 0x8E95 / 36501
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_159(bool bParam0) //Position: 0x8EA1 / 36513
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&bParam0));
}

int Function_160(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) //Position: 0x8EB0 / 36528
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == iParam1)
				{
					...
					uVar2 = Function_162(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == iParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_162(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, &iParam4, &iParam5, &iParam6, &iParam7, 0, 1);
...
int Function_161(struct<257> Param0) //Position: 0x9053 / 36947
{
...
int Function_162(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, int iParam12) //Position: 0x908F / 37007
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_163() //Position: 0x92F7 / 37623
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_164(char* cParam0) //Position: 0x934B / 37707
{
	char* cVar0[64];
...
bool Function_165(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9474 / 38004
{
...
int Function_166() //Position: 0x9500 / 38144
{
	if (IS_PS3())
	{
		return 1;
...
float Function_167(vector3 vParam0) //Position: 0x950F / 38159
{
	if (Function_169(&vParam0))
	{
...
bool Function_168(int iParam0) //Position: 0x95DC / 38364
{
	return Function_45(iParam0, 2);
}

bool Function_169(int iParam0) //Position: 0x95EA / 38378
{
	return Function_45(iParam0, 1);
}

void Function_170(int iParam0) //Position: 0x95F8 / 38392
{
	Function_171(&iParam0, 0.0f);
	return;
}

void Function_171(vector3 vParam0) //Position: 0x9605 / 38405
{
...
int Function_172(struct<2>[] Param0) //Position: 0x962A / 38442
{
	int iVar0;
	int iVar1;
...
void Function_173() //Position: 0x99EC / 39404
{
	if (!Function_86(128))
	{
		return;
...
bool Function_174() //Position: 0x9A2C / 39468
{
	int iVar0;
...
void Function_175(struct<13> Param0) //Position: 0x9A5A / 39514
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

bool Function_176(struct<13> Param0) //Position: 0x9A6D / 39533
{
	int iVar0;
...
void Function_177() //Position: 0x9A8B / 39563
{
	if (!Function_86(128))
	{
		return;
...
void Function_178() //Position: 0x9ACD / 39629
{
	if (IS_LAYOUTREF_VALID(&Global_46715))
	{
		GIVE_OBJECT_TO_LAYOUT(&uLocal_399, &Global_46715);
		GIVE_OBJECT_TO_LAYOUT(GET_OBJECT_FROM_GRINGO(&uLocal_391), &Global_46715);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	if (IS_LAYOUTREF_VALID(&uLocal_383))
	{
		RELEASE_OBJECT_REF(&uLocal_383);
	}
	Function_180(&uLocal_336);
	if (bLocal_407)
	{
	}
	Function_179(0, 0, 1);
...
int Function_179(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9B21 / 39713
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_180(int iParam0) //Position: 0x9B53 / 39763
{
	int iVar0;
...
void Function_181(struct<2>[] Param0, int iParam1) //Position: 0x9B7B / 39803
{
...
void Function_182(struct<13> Param0) //Position: 0x9CC6 / 40134
{
	int iVar0;
...
void Function_183(var uParam0, int iParam1) //Position: 0x9CE3 / 40163
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_184(int iParam0, bool bParam1) //Position: 0x9CF4 / 40180
{
	char* cVar0[32];
...
bool Function_185(int iParam0) //Position: 0x9E7D / 40573
{
...
void Function_186() //Position: 0x9E92 / 40594
{
	if (!Function_190(Global_46760[0]))
	{
		return;
	}
	if (!IS_DOOR_VALID(&uLocal_395))
	{
		uLocal_395 = Function_188("narmadillo", "sheriff", 1);
	}
	if (IS_DOOR_VALID(&uLocal_395))
	{
		...
		{
			Function_187(&uLocal_395, 1);
		}
	}
	return;
}

void Function_187(var uParam0, int iParam1) //Position: 0x9F11 / 40721
{
...
int Function_188(var uParam0, var uParam1, int iParam2) //Position: 0x9F6C / 40812
{
	return Function_189(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_189(int iParam0, char* cParam1, bool bParam3) //Position: 0x9F80 / 40832
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_190(int iParam0) //Position: 0xA025 / 40997
{
	if (!Function_71(iParam0))
	{
		return 1;
...
void Function_191(int iParam0) //Position: 0xA041 / 41025
{
...
var Function_192(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0xA058 / 41048
{
	int iVar0;
	var uVar1;
...
var Function_193(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0xA096 / 41110
{
	int iVar0;
...
var Function_194(struct<2>[] Param0, int iParam1, int iParam2, bool bParam3) //Position: 0xA165 / 41317
{
	int iVar0;
