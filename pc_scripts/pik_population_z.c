...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = FIND_NAMED_LAYOUT("PikesBasin_layout");
	if (IS_LAYOUTREF_VALID(&uVar2))
	{
		uVar3 = FIND_VOLUME_IN_LAYOUT(&uVar2, "pikv_zombies");
		if (IS_VOLUME_VALID(&uVar3))
		{
			Function_3(&uVar3, &bVar0, 15, 30, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xC42 / 3138
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC53 / 3155
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0xCAB / 3243
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD3D / 3389
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xD59 / 3417
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD99 / 3481
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDB6 / 3510
{
...
var Function_8(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDC7 / 3527
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE0E / 3598
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE1B / 3611
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xE9D / 3741
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xEAC / 3756
{
	if (!Function_4(128))
	{
		return;
