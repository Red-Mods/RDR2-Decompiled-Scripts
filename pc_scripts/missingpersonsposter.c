...
int Function_48(int iParam0) //Position: 0x29F3 / 10739
{
	...
	switch (iLocal_2)
	{
		...
		case 0x00000001:
			...
			{
				Function_64(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			uVar2 = Function_63(&iParam0);
			if (IS_GRINGO_COMPONENT_VALID(&uVar2) && iLocal_4)
			{
				Function_59(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 3;
			}
			else
			{
...
void Function_49(int iParam0, var uParam1, int iParam2) //Position: 0x2AAA / 10922
{
	...
	if (iLocal_23)
	{
		REMOVE_STRING_TABLE("dlc_zombiepack_pmp");
		iLocal_23 = 0;
	}
	return;
}

bool Function_50(int iParam0, int iParam1, int iParam2) //Position: 0x2AF7 / 10999
{
	var uVar0;
...
void Function_51() //Position: 0x2C3A / 11322
{
	char* cVar0[64];
	var uVar16;
	var uVar32;
	...
	strcpy(&cVar0, "", 64);
	uVar64 = Function_55(Global_39906.f_20);
	Function_54(uVar64, &uVar16);
	Function_53(Global_39906.f_24, &uVar32);
	Function_52(&uVar48);
	SET_NEWSPAPER_INFO(0, &uVar16);
	SET_NEWSPAPER_INFO(1, &uVar32);
	SET_NEWSPAPER_INFO(2, &uVar48);
	SET_NEWSPAPER_INFO(3, &cVar0);
	strcpy(&cLocal_5, "p_pos_missing", 32);
...
void Function_52(char* cParam0) //Position: 0x2CB1 / 11441
{
...
void Function_53(int iParam0, char* cParam1) //Position: 0x2D35 / 11573
{
	strcpy(&cParam1, GET_OBJECT_NAME(&Global_44085[iParam09] + 8), 64);
	return;
}

void Function_54(char* cParam0, char* cParam1) //Position: 0x2D4D / 11597
{
	switch (cParam0)
	{
		case 0x00000000:
...
var Function_55(int iParam0) //Position: 0x2F44 / 12100
{
	int iVar0;
	int iVar1;
	struct<21> Var2;
...
var Function_56(struct<41> Param0) //Position: 0x2F82 / 12162
{
	int iVar0;
	...
	switch (iParam1)
	{
		case 0x00000000:
			...
			Param0.f_32 = 0;
			Param0.f_40 = 1;
			Param0.f_16 = Function_57(Param0.f_12);
			break;
...
var Function_57(int iParam0) //Position: 0x343D / 13373
{
	int iVar0;
...
bool Function_58(int iParam0) //Position: 0x34A1 / 13473
{
...
void Function_59(int iParam0, var uParam1, var uParam2) //Position: 0x34B8 / 13496
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(&uVar0) && uParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(&uVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(&uParam1, &uVar1, Function_61(&uVar1, "AttachBone", &iVar2), Function_61(&uVar1, "AttachLocator", &iVar2), 1))
				{
					Function_60(&uVar1, &uParam1);
					uParam2 = 1;
				}
			}
		}
...
void Function_60(bool bParam0, int iParam1) //Position: 0x3555 / 13653
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_61(char* cParam0, var uParam1, int iParam2) //Position: 0x361D / 13853
{
	int iVar0;
	int iVar1;
...
var Function_62(int iParam0) //Position: 0x366D / 13933
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_63(int iParam0) //Position: 0x3684 / 13956
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_64(var uParam0, var uParam1, int iParam2) //Position: 0x369B / 13979
{
	uParam0 = Function_71(&uParam0);
	iParam2 = 0;
	...
	if (!Global_6623)
	{
		if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(&Global_54076)))
		{
			...
			{
				if (((Function_67(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(&uParam1))
				{
					iLocal_4 = 0;
				}
				iParam2 = 1;
			...
			{
				Function_65("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
				iParam2 = 0;
			}
		}
		else
		{
			Function_65("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
	}
	else
...
void Function_65(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x37B9 / 14265
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_66(Global_10966) };
		}
...
struct<16> Function_66(int iParam0) //Position: 0x3844 / 14404
{
	char* cVar0[16];
...
int Function_67(int iParam0, bool bParam1, bool bParam2) //Position: 0x3883 / 14467
{
...
bool Function_68() //Position: 0x3947 / 14663
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_69(int iParam0) //Position: 0x395E / 14686
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_70(int iParam0) //Position: 0x396A / 14698
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_71(int iParam0) //Position: 0x3979 / 14713
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_72(int iParam0, int iParam1) //Position: 0x3994 / 14740
{
	var uVar0;
	var uVar1;
	
	iParam0 = &iParam0;
	uVar0 = Function_62(&iParam0);
	uVar1 = Function_63(&iParam0);
	if (!iLocal_23)
	{
