...
void Function_29(bool bParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	uParam1 = &uParam1;
	bParam0 = &bParam0;
	iLocal_2 = GRINGO_GET_MY_OBJECT_REF();
	return;
}
...
struct<8> Function_63(vector3 vParam0) //Position: 0x2B92 / 11154
{
	struct<2> Var0;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BEF / 11247
{
	struct<2> Var0;
...
void Function_65(int iParam0) //Position: 0x2C4C / 11340
{
	iParam0 = &iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x2C58 / 11352
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2C77 / 11383
{
	if (!Function_14(&iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2C8E / 11406
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_69(int iParam0) //Position: 0x2D1F / 11551
{
	struct<2> Var0;
...
struct<8> Function_70(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2D43 / 11587
{
	struct<2> Var0;
...
int Function_71(int iParam0) //Position: 0x2D62 / 11618
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(var uParam0, int iParam1) //Position: 0x2D86 / 11654
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2EAE / 11950
{
...
int Function_74(var uParam0) //Position: 0x2EDC / 11996
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2FF5 / 12277
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(struct<69> Param0) //Position: 0x3002 / 12290
{
	if (Function_75(Param0.f_64, 16))
	{
...
void Function_77(struct<69> Param0) //Position: 0x3084 / 12420
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x362F / 13871
{
	int iVar0;
...
int Function_79(int iParam0) //Position: 0x3669 / 13929
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_80(int iParam0, var uParam1) //Position: 0x3687 / 13959
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x36C8 / 14024
{
	iParam0 = &iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x36D4 / 14036
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_83(int iParam0, int iParam1) //Position: 0x36F6 / 14070
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
