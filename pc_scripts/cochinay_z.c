...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_5)
		{
			...
			case 0x0000000B:
				...
				Function_51(&uLocal_9, &uLocal_270, Function_87(), bScriptParam_0);
				Function_47(&uLocal_278, 0);
				break;
	...
	Function_18();
	Function_17();
	Function_9(&uLocal_9, &uLocal_270);
	Function_8(&uLocal_278);
	Function_6();
...
void Function_227(var uParam0, float fParam1, float fParam2, float fParam3) //Position: 0xCF35 / 53045
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_ALIVE(&uParam0))
...
var Function_231(int iParam0, int iParam1) //Position: 0xD026 / 53286
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_238(bool bParam0) //Position: 0xD1B6 / 53686
{
	Function_239(&uLocal_278, &cLocal_7, "fence01", 1, &Global_44085[bParam09] + 32, 1, 0, 0, 0);
	Function_239(&uLocal_278, &cLocal_7, "fence01", 2, &Global_44085[bParam09] + 32, 1, 0, 0, 0);
	return;
}

var Function_239(struct<4>[] Param0, var uParam1, char* cParam2) //Position: 0xD200 / 53760
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_240(struct<4>[] Param0) //Position: 0xD303 / 54019
{
	int iVar0;
...
void Function_241() //Position: 0xD334 / 54068
{
	Function_242(&uLocal_9, &uLocal_270, 4, &iLocal_234 + 8, 4294967295, 4);
	return;
}

void Function_242(var uParam0, vector3[] vParam1, int iParam2, var uParam3, var uParam4, var uParam5) //Position: 0xD34A / 54090
{
...
void Function_243(struct<5> Param0) //Position: 0xD437 / 54327
{
	Param0 = 0;
	Param0.f_4 = 0;
	return;
...
void Function_244(int iParam0, int iParam1) //Position: 0xD448 / 54344
{
	var uVar0;
	int iVar1;
...
void Function_245(int iParam0, int iParam1, bool bParam2) //Position: 0xD4BE / 54462
{
	var uVar0;
	int iVar1;
...
var Function_246() //Position: 0xD55C / 54620
{
	return &iLocal_178;
}

void Function_247(int iParam0) //Position: 0xD565 / 54629
{
	cLocal_7 = Function_248(&iLocal_178, "cochinay", iParam0);
	return;
}

int Function_248(int iParam0, var uParam1, int iParam2) //Position: 0xD581 / 54657
{
	*(&Global_44085[iParam29] + 56) = CREATE_WORLD_SECTOR(&iParam0, &uParam1);
	return &Global_44085[iParam29] + 56;
}

bool Function_249() //Position: 0xD5A4 / 54692
{
	return Function_250();
}

int Function_250() //Position: 0xD5AD / 54701
{
	var uVar0;
	
	Function_251(3, 3);
	uVar0 = &uVar0;
	iLocal_234 = FIND_NAMED_LAYOUT("Cochinay_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_234))
	{
		iLocal_234 = CREATE_LAYOUT("Cochinay_layout");
	}
	*(&iLocal_234 + 8) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_region", 4,203895E-45f, Vector(-844,8088f, 204,6687f, 915,5305f), Vector(0.0f, 69,61356f, 0.0f), Vector(177,1435f, 100,6493f, 86,88271f));
	*(&iLocal_234 + 16) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "ncocv_pigs", 4,203895E-45f, Vector(-856,1192f, 195,3441f, 953,2307f), Vector(0.0f, -18,49722f, 0.0f), Vector(7,572897f, 6,637381f, 5,58058f));
	*(&iLocal_234 + 24) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_goats", 4,203895E-45f, Vector(-866,7574f, 195,3441f, 952,7543f), Vector(0.0f, 30,72902f, 0.0f), Vector(7,324498f, 6,419668f, 5,397531f));
	*(&iLocal_234 + 64) = CREATE_VOLUME_SET_IN_LAYOUT(&iLocal_234, "cocv_chickens_set");
	*(&iLocal_234 + 32[0]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_chickens_01", 4,203895E-45f, Vector(-858,9502f, 195,3441f, 939,8424f), Vector(0.0f, -1,076836f, 0.0f), Vector(13,39865f, 8,325352f, 3,86132f));
	ADD_TO_VOLUME_SET(&iLocal_234 + 64, &iLocal_234 + 32[0]);
	*(&iLocal_234 + 32[1]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_chickens_02", 4,203895E-45f, Vector(-845,2125f, 195,3441f, 932,5607f), Vector(0.0f, -114,8304f, 0.0f), Vector(11,45287f, 8,325352f, 3,86132f));
	ADD_TO_VOLUME_SET(&iLocal_234 + 64, &iLocal_234 + 32[1]);
	*(&iLocal_234 + 32[2]) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_chickens_03", 4,203895E-45f, Vector(-877,036f, 195,3441f, 944,4405f), Vector(0.0f, 38,85898f, 0.0f), Vector(10,30462f, 8,325352f, 3,86132f));
	ADD_TO_VOLUME_SET(&iLocal_234 + 64, &iLocal_234 + 32[2]);
	*(&iLocal_234 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_234, "cocv_zombies", 4,203895E-45f, Vector(-844,8088f, 204,6687f, 915,5305f), Vector(0.0f, 69,61356f, 0.0f), Vector(177,1435f, 100,6493f, 86,88271f));
	*(&iLocal_234 + 80) = Vector(-727,4501f, 175,5662f, 781,0355f);
	*(&iLocal_234 + 80 + 12) = Vector(-175,9475f, 64,90475f, -175,9777f);
	*(&iLocal_234 + 104) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "cocf_teleport", Vector(-727,4501f, 175,5662f, 781,0355f), Vector(-175,9475f, 64,90475f, -175,9777f));
	*(&iLocal_234 + 112) = Vector(-928,6725f, 214,6138f, 1035,982f);
	*(&iLocal_234 + 112 + 12) = Vector(-1,891193f, 16,71275f, -3,017009f);
	*(&iLocal_234 + 136) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "cocf_interiorPoint_cave", Vector(-928,6725f, 214,6138f, 1035,982f), Vector(-1,891193f, 16,71275f, -3,017009f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos1", Vector(-873,459f, 235,634f, 1037,045f), Vector(-21,948f, 31,113f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos2", Vector(-871,26f, 212,527f, 959,089f), Vector(-3,835f, 144,163f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos3", Vector(-834,77f, 202,538f, 883,54f), Vector(1,959f, 142,939f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos4", Vector(-821,095f, 209,861f, 906,072f), Vector(-11,384f, 127,053f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos5", Vector(-806,649f, 198,265f, 1152,725f), Vector(-8,082f, 14,177f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos6", Vector(-808,195f, 199,877f, 1103,01f), Vector(6,988f, 165,48f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos7", Vector(-895,05f, 206,076f, 994,752f), Vector(23,789f, 150,098f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos8", Vector(-873,679f, 203,308f, 1016,877f), Vector(23,284f, 107,765f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos9", Vector(-897,76f, 204,936f, 970,465f), Vector(8,164f, -147,053f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_234, "coc_vista_cam_pos10", Vector(-834,219f, 200,771f, 881,65f), Vector(-10,025f, 145,011f, 0.0f));
	return 1;
}

void Function_251(int iParam0, int iParam1) //Position: 0xDB35 / 56117
{
	switch (&iParam1)
	{
		case 0x00000000:
...
void Function_252(var uParam0, int iParam1) //Position: 0xDB7F / 56191
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_253() //Position: 0xDB90 / 56208
{
	return;
}

bool Function_254() //Position: 0xDB96 / 56214
{
	return 1;
}

void Function_255() //Position: 0xDB9D / 56221
{
	return;
}

bool Function_256() //Position: 0xDBA3 / 56227
{
	return Function_257();
}

int Function_257() //Position: 0xDBAC / 56236
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	iLocal_178 = FIND_NAMED_LAYOUT("Cochinay_layout");
	if (!IS_LAYOUTREF_VALID(&iLocal_178))
	{
		iLocal_178 = CREATE_LAYOUT("Cochinay_layout");
	}
	*(&iLocal_178 + 48) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_1", 2,802597E-45f, Vector(-899,5078f, 208,0988f, 972,1177f), Vector(0.0f, 0.0f, 0.0f), Vector(11,82669f, 18,28525f, 26,8707f));
	*(&iLocal_178 + 56) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_2", 2,802597E-45f, Vector(-905,1303f, 208,0988f, 1012,955f), Vector(0.0f, 0.0f, 0.0f), Vector(18,70917f, 32,92183f, 31,33055f));
	*(&iLocal_178 + 64) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_3", 2,802597E-45f, Vector(-888,4346f, 208,9505f, 1023,277f), Vector(0.0f, 0.0f, 0.0f), Vector(18,70917f, 22,73152f, 11,74532f));
	*(&iLocal_178 + 72) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_4", 2,802597E-45f, Vector(-909,7368f, 208,0988f, 975,1846f), Vector(0.0f, 0.0f, 0.0f), Vector(16,72632f, 50,05937f, 44,49941f));
	*(&iLocal_178 + 80) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_5", 2,802597E-45f, Vector(-870,9651f, 208,0988f, 981,0289f), Vector(0.0f, 0.0f, 0.0f), Vector(16,72632f, 50,05937f, 44,49941f));
	*(&iLocal_178 + 88) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_6", 2,802597E-45f, Vector(-820,4177f, 208,0988f, 925,5197f), Vector(0.0f, 0.0f, 0.0f), Vector(30,70705f, 63,96128f, 101,714f));
	*(&iLocal_178 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "SpawnRestrict_7", 2,802597E-45f, Vector(-906,8681f, 208,0988f, 925,5197f), Vector(0.0f, 0.0f, 0.0f), Vector(30,70705f, 63,96128f, 77,58231f));
	*(&iLocal_178 + 104) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_1", 2,802597E-45f, Vector(-828,3879f, 196,8746f, 919,6917f), Vector(0.0f, 0.0f, 0.0f), Vector(14,20436f, 34,43805f, 14,29684f));
	*(&iLocal_178 + 112) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_178, "MoveRestrict_2", 2,802597E-45f, Vector(-897,864f, 196,8746f, 981,3749f), Vector(0.0f, 0.0f, 0.0f), Vector(14,20436f, 34,43805f, 12,4726f));
	*(&iLocal_178 + 120) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_defSet", &iLocal_178, 8, 0);
	uVar1 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def01", Vector(-895,3734f, 208,055f, 981,4798f), Vector(0.0f, -449,4003f, 0.0f));
	...
	*(&iLocal_178 + 128) = CREATE_OBJECTSET_IN_LAYOUT("ammo_00Set", &iLocal_178, 8, 0);
	uVar2 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_player", Vector(-896,7726f, 208,055f, 981,5056f), Vector(0.0f, -809,7499f, 0.0f));
	DECOR_SET_BOOL(&uVar2, "Core", 1);
	DECOR_SET_INT(&uVar2, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar2, &iLocal_178 + 128);
	uVar3 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_00_01_surv", Vector(-895,3734f, 208,055f, 981,4798f), Vector(0.0f, -628,6481f, 0.0f));
	...
	*(&iLocal_178 + 136) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup01_defSet", &iLocal_178, 8, 0);
	uVar4 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_def02", Vector(-830,4132f, 205,6318f, 918,4484f), Vector(0.0f, 100,4565f, 0.0f));
	...
	*(&iLocal_178 + 144) = CREATE_OBJECTSET_IN_LAYOUT("ammo_01Set", &iLocal_178, 8, 0);
	uVar5 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_02_player", Vector(-829,0129f, 205,6318f, 918,4255f), Vector(0.0f, -268,9615f, 0.0f));
	DECOR_SET_BOOL(&uVar5, "Core", 1);
	DECOR_SET_INT(&uVar5, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar5, &iLocal_178 + 144);
	uVar6 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ammo_01_02_surv", Vector(-830,4132f, 205,6318f, 918,4484f), Vector(0.0f, -89,07681f, 0.0f));
	DECOR_SET_BOOL(&uVar6, "Core", 1);
	DECOR_SET_INT(&uVar6, "GiveWeapon", 44);
	ADD_OBJECT_TO_OBJECTSET(&uVar6, &iLocal_178 + 144);
	*(&iLocal_178 + 152) = CREATE_OBJECTSET_IN_LAYOUT("survivorGroup_safeSet", &iLocal_178, 8, 0);
	uVar7 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe01", Vector(-895,827f, 208,0187f, 981,5157f), Vector(0.0f, -94,50138f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar7, &iLocal_178 + 152);
	uVar8 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "sGroup_safe02", Vector(-829,9268f, 205,6318f, 918,7424f), Vector(0.0f, 90,04488f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar8, &iLocal_178 + 152);
	*(&iLocal_178 + 160) = CREATE_OBJECTSET_IN_LAYOUT("nchestsSet", &iLocal_178, 8, 0);
	uVar9 = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "chest_2", Vector(-880,6841f, 202,7453f, 997,6718f), Vector(0.0f, 94,3454f, 0.0f));
	ADD_OBJECT_TO_OBJECTSET(&uVar9, &iLocal_178 + 160);
	*(&iLocal_178 + 168) = Vector(-884,3423f, 202,5276f, 1006,602f);
	*(&iLocal_178 + 168 + 12) = Vector(0.0f, 94,65078f, 0.0f);
	*(&iLocal_178 + 192) = CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "player_save_01", Vector(-884,3423f, 202,5276f, 1006,602f), Vector(0.0f, 94,65078f, 0.0f));
	*(&iLocal_178 + 200) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl", "DLC_survivor_roof_rfl", Vector(-895,796f, 208,0541f, 981,3898f), Vector(0.0f, -88,04469f, 0.0f));
	*(&iLocal_178 + 208) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "DLC_survivor_roof_rfl1", "DLC_survivor_roof_rfl", Vector(-829,9308f, 205,6318f, 918,7449f), Vector(0.0f, 90,69358f, 0.0f));
	*(&iLocal_178 + 216) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_178, "ZombiePack_player_sleep_bed_L", "ZombiePack_player_sleep_bed_L", Vector(-881,448f, 202,6197f, 1007,337f), Vector(0.0f, -90,17611f, 0.0f));
	return 1;
}

void Function_258(bool bParam0, bool bParam1) //Position: 0xE41C / 58396
{
	var uVar0;
...
void Function_259(int iParam0, bool bParam1, bool bParam2) //Position: 0xE4B7 / 58551
{
	int iVar0;
	int iVar1[8];
	int iVar10;
...
var Function_260(struct<2>[] Param0, int iParam1, var uParam2, bool bParam3) //Position: 0xE5C3 / 58819
{
	int iVar0;
...
bool Function_261(int iParam0) //Position: 0xE69F / 59039
{
...
int Function_262(int iParam0) //Position: 0xE71A / 59162
{
...
bool Function_263(int iParam0) //Position: 0xE72F / 59183
{
...
int Function_264(int iParam0) //Position: 0xE795 / 59285
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_265(int iParam0, int iParam1) //Position: 0xE857 / 59479
{
	int iVar0;
...
void Function_266() //Position: 0xE874 / 59508
{
	return;
}

void Function_267(char* cParam0) //Position: 0xE87A / 59514
{
	if (!Function_26(128))
	{
		return;
