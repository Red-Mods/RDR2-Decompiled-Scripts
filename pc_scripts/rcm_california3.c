...
void main() //Position: 0x0 / 0
{
	...
	bLocal_340 = false;
	iLocal_341 = 0;
	Local_344 = Vector(-3764,832f, 25,428f, 2716,325f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Function_153(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 5;
						break;
					
					case 0x00000005:
						if (Function_110("$/cutscene/RCM_08_CS03/RCM_08_CS03", &iLocal_326, 28313, 28285, 26982, 26913, 26504, 26467, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						...
						Function_107("RCM_Journal_Edit", &Global_99725[ScriptParam_043] + 4, 0x40f00000);
						iLocal_347 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
						iLocal_348 = 0;
						while (iLocal_348 <= iLocal_347)
						{
							SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, iLocal_348), 4, 0);
							iLocal_348++;
						}
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "California3_OBJ", 0, 4, false);
						Function_106(Global_99725[ScriptParam_043].f_224, 0);
						Function_105(&Global_99725[1143] + 228, 256);
						Function_59(12, 1, 1, 1);
						Function_8(Global_42265[69].f_64);
						Function_5();
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x259 / 601
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x28B / 651
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x2A8 / 680
{
	RELEASE_LAYOUT_REF(&iLocal_349);
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x2B5 / 693
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_5() //Position: 0x2C6 / 710
{
	int iVar0;
	int iVar1;
...
void Function_6(int iParam0) //Position: 0x2F7 / 759
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0x356 / 854
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_6(GET_TARGETED_JOURNAL_ENTRY());
	...
	switch (iVar0)
	{
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				{
					iVar3 = iVar1;
					if (Function_25(&(Global_99725[iVar143]), iVar3))
					{
						Function_4(&Global_99725[iVar143] + 228, 64);
						Function_21(&(Global_99725[iVar143]), iVar3);
...
void Function_9(struct<229> Param0) //Position: 0x510 / 1296
{
	float fVar0;
	int iVar1;
...
void Function_10(struct<217> Param0) //Position: 0x5E0 / 1504
{
	float fVar0;
	var uVar1;
...
int Function_11(var uParam0, int iParam1) //Position: 0x69E / 1694
{
	int iVar0;
	var uVar1;
...
void Function_12(int iParam0, var uParam1, struct<2> Param2) //Position: 0x808 / 2056
{
	struct<8> Var0;
...
struct<32> Function_13(char* cParam0) //Position: 0x8B0 / 2224
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_14(char* cParam0) //Position: 0x91C / 2332
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x93E / 2366
{
	int iVar0;
	struct<2> Var1;
...
float Function_16(int iParam0, struct<2> Param1) //Position: 0xAAC / 2732
{
	struct<2> Var0;
...
struct<8> Function_17(int iParam0) //Position: 0xB23 / 2851
{
	struct<2> Var0;
...
void Function_18(int iParam0) //Position: 0xB8F / 2959
{
...
bool Function_19(int iParam0) //Position: 0xBF7 / 3063
{
...
var Function_20() //Position: 0xC0D / 3085
{
	int iVar0;
...
void Function_21(struct<153> Param0) //Position: 0xC16 / 3094
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if (((StackVal && Function_23(Function_24(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_22(iParam1)) || Global_116927[iParam16].f_20 != 1)
	{
...
int Function_22(int iParam0) //Position: 0xD85 / 3461
{
...
var Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xDB1 / 3505
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_24(int iParam0) //Position: 0xDD2 / 3538
{
...
bool Function_25(struct<249> Param0) //Position: 0xDE7 / 3559
{
...
bool Function_26(struct<265> Param0) //Position: 0xF17 / 3863
{
	int iVar0;
	
	if (!Param0.f_260 != 0)
	{
		if (Function_33(&Param0 + 260, 4))
		{
		...
		if (Function_33(&Param0 + 260, 2) && Global_6606)
		{
			iVar0 = Function_30(Param0.f_264);
		...
		if (Function_33(&Param0 + 260, 8) && Global_6606)
		{
			if (Function_27(Param0.f_252))
			{
				if (StackVal != 3)
				{
					return 0;
		...
		switch (Global_99472)
		{
			...
			case 0x00000020:
				if (!Function_33(&Param0 + 260, 1024))
				{
					return 0;
				}
				break;
...
bool Function_27(int iParam0) //Position: 0x1078 / 4216
{
	if (!Function_29(iParam0))
	{
		return 0;
	}
	if (!Function_28(StackVal))
	{
		return 0;
	}
	return 1;
...
bool Function_28(int iParam0) //Position: 0x109C / 4252
{
...
bool Function_29(int iParam0) //Position: 0x10B1 / 4273
{
...
var Function_30(int iParam0) //Position: 0x10C8 / 4296
{
...
bool Function_31(int iParam0) //Position: 0x10E2 / 4322
{
...
bool Function_32(int iParam0) //Position: 0x10F8 / 4344
{
	return Global_116927[iParam06].f_16;
}

bool Function_33(var uParam0, int iParam1) //Position: 0x1108 / 4360
{
	int iVar0;
...
bool Function_34(struct<237> Param0) //Position: 0x1125 / 4389
{
	if (!Param0.f_236)
	{
		if (Function_35())
...
bool Function_35() //Position: 0x11F4 / 4596
{
...
bool Function_36(int iParam0) //Position: 0x120F / 4623
{
	...
	if (!Function_48(Global_99725[iParam043].f_228, 32768))
	{
		if ((Global_6646 || Global_6648) || Global_6647)
		{
			...
			{
				Function_37(&Global_54076, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
void Function_37(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x126A / 4714
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_39(&uParam0, iParam1, &iParam2) && !&bParam3)
	{
		return;
	}
...
void Function_38(char* cParam0) //Position: 0x12DF / 4831
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_39(int iParam0, var uParam1, int iParam2) //Position: 0x1319 / 4889
{
	var uVar0;
	char* cVar1[16];
...
int Function_40(char* cParam0) //Position: 0x1395 / 5013
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_41(int iParam0) //Position: 0x1436 / 5174
{
	int iVar0;
	int iVar1;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x1473 / 5235
{
...
bool Function_43(int iParam0) //Position: 0x1486 / 5254
{
	int iVar0;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x14A2 / 5282
{
	int iVar0;
...
int Function_45(int iParam0) //Position: 0x14BF / 5311
{
...
bool Function_46(int iParam0) //Position: 0x14D4 / 5332
{
...
int Function_47(int iParam0) //Position: 0x14E9 / 5353
{
...
bool Function_48(var uParam0, bool bParam1) //Position: 0x14FE / 5374
{
	return (uParam0 && bParam1) == 0;
}

void Function_49() //Position: 0x150B / 5387
{
...
int Function_50(int iParam0, int iParam1) //Position: 0x158B / 5515
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_51(char* cParam0) //Position: 0x21EE / 8686
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

int Function_52(int iParam0, bool bParam1) //Position: 0x2206 / 8710
{
	int iVar0;
...
int Function_53(int iParam0) //Position: 0x2244 / 8772
{
	int iVar0;
	int iVar1;
...
bool Function_54(int iParam0) //Position: 0x2293 / 8851
{
...
int Function_55(int iParam0) //Position: 0x22A9 / 8873
{
...
bool Function_56(int iParam0) //Position: 0x2312 / 8978
{
	if (!Function_54(iParam0))
	{
...
bool Function_57(int iParam0, int iParam1) //Position: 0x2363 / 9059
{
	int iVar0;
...
bool Function_58(int iParam0) //Position: 0x2390 / 9104
{
	if (!Function_54(iParam0))
	{
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x23E2 / 9186
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (!Function_35())
	{
		...
		{
			Function_37(&Global_54076, 2097152, 1, 0);
		}
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x297A / 10618
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_61() //Position: 0x2B1B / 11035
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2B21 / 11041
{
	if (Global_6624)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2B60 / 11104
{
...
void Function_64() //Position: 0x2BB5 / 11189
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2C00 / 11264
{
...
void Function_66() //Position: 0x2D06 / 11526
{
	float fVar0;
...
void Function_67() //Position: 0x2D39 / 11577
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x2ECC / 11980
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x3085 / 12421
{
	Function_70(&Global_42918, 1, 0);
	return;
}

void Function_70(struct<2317> Param0) //Position: 0x3093 / 12435
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x32B0 / 12976
{
...
struct<8> Function_72(int iParam0) //Position: 0x32C5 / 12997
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x336C / 13164
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3608 / 13832
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_75(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_20(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_75(int iParam0) //Position: 0x3C46 / 15430
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3C57 / 15447
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0) //Position: 0x3D4E / 15694
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3D69 / 15721
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x3DD0 / 15824
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x3DE2 / 15842
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3DF4 / 15860
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x3F28 / 16168
{
	return Global_55480[iParam016].f_96;
}

float Function_83(int iParam0) //Position: 0x3F37 / 16183
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x3F70 / 16240
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x3FAD / 16301
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
void Function_105(int iParam0, int iParam1) //Position: 0x5465 / 21605
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_106(char* cParam0, bool bParam1) //Position: 0x547B / 21627
{
	bool bVar0;
...
void Function_107(var uParam0, var uParam1, int iParam2) //Position: 0x54A0 / 21664
{
...
void Function_108(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x54E5 / 21733
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_109(int iParam0) //Position: 0x5570 / 21872
{
	char* cVar0[16];
...
bool Function_110(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x55AF / 21935
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_111(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5668 / 22120
{
	if (!&bParam15)
	{
...
void Function_112(var uParam0, bool bParam1) //Position: 0x5CCA / 23754
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_113() //Position: 0x5D99 / 23961
{
	int iVar0;
...
void Function_114() //Position: 0x5E11 / 24081
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_115() //Position: 0x5E56 / 24150
{
...
void Function_116(var uParam0, int iParam1) //Position: 0x5E68 / 24168
{
	var uVar0;
	bool bVar1;
	var uVar2;
...
bool Function_117(int iParam0) //Position: 0x5EFA / 24314
{
	bool bVar0;
...
float Function_118(vector3 vParam0) //Position: 0x5F2B / 24363
{
...
bool Function_119(int iParam0) //Position: 0x5FF8 / 24568
{
	return Function_48(iParam0, 2);
}

bool Function_120(int iParam0) //Position: 0x6006 / 24582
{
	return Function_48(iParam0, 1);
}

int Function_121(bool bParam0) //Position: 0x6014 / 24596
{
	bool bVar0;
	var uVar1;
...
bool Function_122() //Position: 0x60D7 / 24791
{
	bool bVar0;
	var uVar1;
...
void Function_123(int iParam0) //Position: 0x6114 / 24852
{
	Function_124(&iParam0, 0.0f);
	return;
}

void Function_124(vector3 vParam0) //Position: 0x6121 / 24865
{
...
bool Function_125(struct<37> Param0) //Position: 0x6146 / 24902
{
	return Param0.f_36;
}

void Function_126(var uParam0, int iParam1) //Position: 0x6151 / 24913
{
	Function_127(&uParam0, &iParam1, 0);
	return;
}

void Function_127(var uParam0, bool bParam1, int iParam2) //Position: 0x6161 / 24929
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_128(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x62D9 / 25305
{
	int iVar0;
	int iVar1;
...
void Function_129(bool bParam0) //Position: 0x6501 / 25857
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_130(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x659F / 26015
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_131() //Position: 0x65C9 / 26057
{
	var uVar0;
	var uVar1;
...
void Function_132() //Position: 0x6624 / 26148
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_133() //Position: 0x6763 / 26467
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-3761,149f, 30,131f, 2721,602f), 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_134() //Position: 0x6788 / 26504
{
	Function_136(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_135(&Global_99725[1243] + 320, 1);
	DESTROY_VOLUME(&uLocal_342);
	return 1;
}

void Function_135(var uParam0, bool bParam1) //Position: 0x67B4 / 26548
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_136(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x683D / 26685
{
	var uVar0;
...
void Function_137() //Position: 0x690C / 26892
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_138() //Position: 0x6921 / 26913
{
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-3753,35f, 26,75f, 2730,74f), 66,33f, 1, 1, true);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &uLocal_338, Vector(-3756,15f, 26,75f, 2738,11f), 397,85f, 1, 1, true);
	return 1;
}

int Function_139() //Position: 0x6966 / 26982
{
	if (!iLocal_341)
	{
		Function_140(StackVal, Local_344, &uLocal_342);
		Function_135(&Global_99725[1243] + 320, 0);
		iLocal_341 = 1;
	}
	return 1;
}

void Function_140(vector3 vParam0) //Position: 0x6994 / 27028
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_141(int iParam0, int iParam1) //Position: 0x6B3D / 27453
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_142(float fParam0, float fParam1) //Position: 0x6C32 / 27698
{
...
void Function_143() //Position: 0x6D43 / 27971
{
...
void Function_144() //Position: 0x6D77 / 28023
{
...
int Function_145() //Position: 0x6E7D / 28285
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(StackVal, Vector(-3761,149f, 30,131f, 2721,602f), 0, 0);
	return 1;
}

int Function_146() //Position: 0x6E99 / 28313
{
	uLocal_342 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_349, "tempcutscenevol", 2, *(&Global_99725[1243] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_149(0, 0, 1, 1, 0, 1, 1, &uLocal_342, 1, 1, 1, 1, 0x3f800000, 0);
	Function_147(StackVal, &iLocal_349, *(&Global_99725[1243] + 196), &uLocal_342, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_147(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x6F12 / 28434
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_148(var uParam0, float fParam1) //Position: 0x71B2 / 29106
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_149(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x7234 / 29236
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_152(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_20(), 2, Function_152(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
	...
	if (uParam10 && !Function_35())
	{
		CLEAR_CHARACTER_BLOOD();
	}
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_151()) || DECOR_CHECK_EXIST(&Global_54076, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_150(int iParam0) //Position: 0x74E6 / 29926
{
	int iVar0;
...
var Function_151() //Position: 0x751A / 29978
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_152(int iParam0) //Position: 0x75A8 / 30120
{
	struct<2> Var0;
...
int Function_153(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x75BA / 30138
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_6623 || Global_6625) || Global_6635) || Global_53524.f_28))
		{
			if (UNK_0x214AFB8C(&iParam0 + 136))
			{
				...
				if (&Global_99717 + 16 == fParam1)
				{
					...
					uVar2 = Function_155(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &uVar1, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > &fParam2)
				{
					if (&Global_99717 + 16 != 4294967295 || (&Global_99717 + 16 == fParam1 && bVar0 > Global_99717.f_24))
					{
						...
						uVar6 = Function_155(StackVal, GET_ASSET_NAME(&iParam0 + 136, 9), &iVar3, *(&iParam0 + 184), 0, &fParam2, &fParam3, 2, 1, 2, 2, 0, 1);
...
int Function_154(struct<257> Param0) //Position: 0x7745 / 30533
{
	if (Param0.f_256 != 4294967295)
	{
		...
		return Function_154(&(Global_99725[Param0.f_25643]));
	}
	return 0;
}

int Function_155(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7781 / 30593
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
	
	if (Function_158(StackVal, &Global_54076, Param2, (&fParam5 + ((IntToFloat(Function_159()) * (&fParam6 - &fParam5)) * 0,5f))) || bParam11)
	{
	...
	else if ((!Function_158(StackVal, &Global_54076, Param2, (&fParam6 + ((IntToFloat(Function_159()) * (&fParam6 - &fParam5)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !&bParam11)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		iParam1 = 0;
	}
	else if (!Function_158(StackVal, &Global_54076, Param2, &fParam5))
	{
	}
	return 0;
}

void Function_156() //Position: 0x79E9 / 31209
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_157(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_157(char* cParam0) //Position: 0x7A3D / 31293
{
	char* cVar0[64];
...
bool Function_158(var uParam0, struct<2> Param1, float fParam3) //Position: 0x7B66 / 31590
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_17(&uParam0);
		if (VDIST(Function_17(&uParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
int Function_159() //Position: 0x7BF2 / 31730
{
	if (IS_PS3())
	{
		return 1;
...
void Function_160() //Position: 0x7C01 / 31745
{
	var uVar0;
	
	Function_161(4, 1);
	uVar0 = &uVar0;
	iLocal_349 = CREATE_LAYOUT("California_layout");
	return;
}

void Function_161(int iParam0, int iParam1) //Position: 0x7C2D / 31789
{
	switch (&iParam1)
	{
		case 0x00000000:
