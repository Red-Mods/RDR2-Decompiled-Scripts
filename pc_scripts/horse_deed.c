...
void Function_1(var uParam0, int iParam1) //Position: 0x116 / 278
{
	if (Global_6624)
	{
		return;
...
void Function_2(bool bParam0) //Position: 0x155 / 341
{
...
void Function_3(var uParam0, int iParam1) //Position: 0x1AA / 426
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_4() //Position: 0x1C0 / 448
{
	Function_32();
	Function_31();
	Function_31();
...
void Function_5() //Position: 0x20B / 523
{
...
void Function_6() //Position: 0x311 / 785
{
	float fVar0;
...
void Function_7() //Position: 0x344 / 836
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_8() //Position: 0x4D7 / 1239
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x690 / 1680
{
	Function_10(&Global_42918, 1, 0);
	return;
}

void Function_10(struct<2317> Param0) //Position: 0x69E / 1694
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_11() //Position: 0x8BB / 2235
{
...
struct<8> Function_12(int iParam0) //Position: 0x8D0 / 2256
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_13(int iParam0, bool bParam1, bool bParam2) //Position: 0x977 / 2423
{
	int iVar0;
...
void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0xC13 / 3091
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_15() //Position: 0x1251 / 4689
{
	int iVar0;
...
var Function_16(int iParam0) //Position: 0x125A / 4698
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_17(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x126B / 4715
{
	char* cVar0[32];
...
struct<32> Function_18(char* cParam0) //Position: 0x1362 / 4962
{
	char* cVar0[32];
...
void Function_19(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x137D / 4989
{
	float fVar0;
...
var Function_20(int iParam0, int iParam1) //Position: 0x13E4 / 5092
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_21(int iParam0, bool bParam1) //Position: 0x13F6 / 5110
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_22(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1408 / 5128
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_23(int iParam0) //Position: 0x153C / 5436
{
	return Global_55480[iParam016].f_96;
}

float Function_24(int iParam0) //Position: 0x154B / 5451
{
	if (!iParam0 != 4294967295)
	{
...
var Function_25(int iParam0) //Position: 0x1584 / 5508
{
	if (iParam0 == 4294967295)
	{
...
void Function_26(int iParam0) //Position: 0x15C1 / 5569
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x175B / 5979
{
	int iVar0;
	int iVar1;
...
int Function_28(bool bParam0) //Position: 0x199F / 6559
{
...
struct<8> Function_29() //Position: 0x19E0 / 6624
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_30() //Position: 0x1A69 / 6761
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x1B00 / 6912
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_32() //Position: 0x1B7F / 7039
{
...
int Function_33(int iParam0, bool bParam1, int iParam2) //Position: 0x1BBC / 7100
{
	int iVar0;
	int iVar1;
	...
	{
		Function_14(iParam0, 1, bParam1, 0, 1, 0x40400000, 0, 0);
	}
	if (Global_55480[iParam016].f_96 == 2)
	{
		iVar1 = 0;
...
void Function_34() //Position: 0x1DC8 / 7624
{
	struct<2> Var0;
	var uVar2;
...
bool Function_35(vector3 vParam0) //Position: 0x1E7F / 7807
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

struct<8> Function_36(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x1E97 / 7831
{
	int iVar0;
...
struct<8> Function_37() //Position: 0x1F8F / 8079
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1F99 / 8089
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_39(int iParam0) //Position: 0x1FAA / 8106
{
...
int Function_40(bool bParam0, bool bParam1) //Position: 0x1FC0 / 8128
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_41(struct<2> Param0, struct<2> Param2) //Position: 0x208C / 8332
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_42(float fParam0, int iParam1) //Position: 0x20A9 / 8361
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_43(int iParam0) //Position: 0x28D5 / 10453
{
	var uVar0;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x2910 / 10512
{
	return (uParam0 && iParam1) == 0;
}

void Function_45(var uParam0, var uParam1) //Position: 0x291D / 10525
{
	GET_POSITION(&uParam0, &uParam1);
	return;
}

bool Function_46() //Position: 0x292C / 10540
{
...
bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2947 / 10567
{
	uParam0 = &uParam0;
...
int Function_48(int iParam0) //Position: 0x29F6 / 10742
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (iLocal_2)
	{
		...
		case 0x00000001:
			if (Function_72(&iParam0, &uVar0))
			{
				Function_65(&iParam0, &uVar0, &iLocal_3);
				iLocal_2 = 2;
			}
			iVar1 = 0;
			break;
...
void Function_49(int iParam0, var uParam1, int iParam2) //Position: 0x2AAD / 10925
{
	int iVar0;
...
bool Function_50(int iParam0, int iParam1, int iParam2) //Position: 0x2ADD / 10973
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	if (iParam2)
	{
		switch (iLocal_5)
		{
			case 0x00000000:
				...
				uVar1 = Function_59(Function_60(&iParam0), "nActorEnum", &iVar0);
				uVar2 = GET_ACTOR_ENUM_FROM_STRING(&uVar1);
				Function_58(uVar2, 1, 1);
				Function_55(0, 0x40400000);
			...
			case 0x00000001:
				if (Function_54())
				{
					Function_53(4294967295);
					iLocal_5 = 2;
				}
				break;
			
			case 0x00000002:
				Function_51("own_new_horse", 0x41200000, 1, 0, 2, 1, 0);
				DECOR_SET_BOOL(&iParam1, "ItemSave", 1);
				iParam2 = 1;
				return 0;
				break;
		}
...
void Function_51(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2BED / 11245
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_52(Global_10966) };
		}
...
struct<16> Function_52(int iParam0) //Position: 0x2C78 / 11384
{
	char* cVar0[16];
...
void Function_53(var uParam0) //Position: 0x2CB7 / 11447
{
	DECOR_SET_INT(&Global_54076, "Player_SimWhistle", &uParam0);
	DECOR_SET_INT(&Global_54076, "WhistleTimeWaited", 100);
	return;
}

bool Function_54() //Position: 0x2CFA / 11514
{
	bool bVar0;
...
void Function_55(float fParam0, float fParam1) //Position: 0x2D1A / 11546
{
...
void Function_56() //Position: 0x2E2B / 11819
{
...
void Function_57() //Position: 0x2E5F / 11871
{
...
void Function_58(var uParam0, bool bParam1, bool bParam2) //Position: 0x2F65 / 12133
{
...
var Function_59(char* cParam0, char* cParam1, int iParam2) //Position: 0x2F94 / 12180
{
	int iVar0;
	int iVar1;
...
var Function_60(int iParam0) //Position: 0x2FE4 / 12260
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

void Function_61(int iParam0, var uParam1, var uParam2) //Position: 0x2FFF / 12287
{
	var uVar0;
	char[] cVar1[4];
	int iVar2;
	
	uVar0 = Function_64(&iParam0);
	cVar1 = Function_63(&iParam0);
	iVar2 = 0;
	if (IS_GRINGO_COMPONENT_VALID(&uVar0) && uParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(&cVar1))
		{
			if (GRINGO_PLAY_ANIM_ON_ACTOR(&uParam1, &uVar0, false))
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(&uParam1, &cVar1, Function_59(&cVar1, "AttachBone", &iVar2), Function_59(&cVar1, "AttachLocator", &iVar2), 1))
				{
					Function_62(&cVar1, &uParam1);
					uParam2 = 1;
				}
			}
		}
...
void Function_62(var uParam0, var uParam1) //Position: 0x309C / 12444
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	{
		uVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(&uVar0, &uParam1);
		...
		if (IS_PHYSINST_VALID(&iVar1))
		{
			...
			{
				LINK_OBJECT_ANIMATOR_TO_ACTOR(&iVar6, &uParam1, GRINGO_GET_PROP_ATTACH_SLOT(&uParam0));
			}
		}
	}
	return;
...
var Function_63(int iParam0) //Position: 0x3164 / 12644
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, &iParam0);
}

int Function_64(int iParam0) //Position: 0x317B / 12667
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, &iParam0);
}

void Function_65(var uParam0, var uParam1, int iParam2) //Position: 0x3192 / 12690
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (IS_ACTOR_VALID(&Global_21369 + 72))
	{
		uVar1 = Function_59(&uParam0, "nActorEnum", &iVar0);
		bVar2 = GET_ACTOR_ENUM_FROM_STRING(&uVar1);
		bVar3 = GET_ACTOR_ENUM(&Global_21369 + 72);
		iVar4 = 0;
		Function_71(&Global_54076);
		Var5 = Function_71(&Global_54076);
		if (GET_ACTORENUM_SPECIES(bVar2) == 23)
		{
			uVar7 = LOCATE_ACTOR_OF_TYPE(Var5, 140.0f, 23, bVar2);
		}
		else
		{
			uVar7 = LOCATE_ACTOR_OF_TYPE(Var5, 140.0f, 24, bVar2);
		}
		Function_55(0, 0x40400000);
		if (IS_ACTOR_VALID(&Global_21369 + 72))
		{
			TASK_PRIORITY_SET(&Global_21369 + 72, true);
			TASK_FLEE_ACTOR(&Global_21369 + 72, &Global_54076, 250.0f, -1.0f, 0, 0, 0);
		}
		if (IS_ACTOR_VALID(&uVar7))
		{
			if (DECOR_CHECK_EXIST(&uVar7, "WasPlayerMount"))
			{
				iVar4 = 1;
				Function_38(&Global_21369 + 72 + 32, 2);
				Function_70(&uVar7, 1);
			}
		}
		if (bVar3 != bVar2 || iVar4)
		{
			Function_51("already_have_horse", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
		else
		{
	...
	if ((Function_66(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
	{
		iLocal_4 = 0;
	}
	return;
...
int Function_66(int iParam0, bool bParam1, bool bParam2) //Position: 0x32E7 / 13031
{
...
bool Function_67() //Position: 0x33AB / 13227
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_68(int iParam0) //Position: 0x33C2 / 13250
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_69(int iParam0) //Position: 0x33CE / 13262
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_70(var uParam0, int iParam1) //Position: 0x33DD / 13277
{
...
struct<8> Function_71(int iParam0) //Position: 0x3424 / 13348
{
	struct<2> Var0;
...
bool Function_72(int iParam0, int iParam1) //Position: 0x3436 / 13366
{
	var uVar0;
	var uVar1;
	
	iParam0 = &iParam0;
	uVar0 = Function_63(&iParam0);
	uVar1 = Function_64(&iParam0);
