...
void main() //Position: 0x0 / 0
{
	...
	Var13 = Vector(-2690,274f, 31,548f, 4256,147f);
	...
	uVar15 = FIND_NAMED_LAYOUT("Perdido_layout");
	if (IS_LAYOUTREF_VALID(&uVar15))
	{
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "prdv_flk_CENTER_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar17 = Function_3(&uVar16, &bVar0, 4E-05f, 0, 0, 1);
			...
			uVar19 = Function_3(&uVar16, &bVar5, 7E-06f, 0, 0, 1);
			...
			uVar20 = Function_3(&uVar16, &bVar6, 2,5E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(&uVar16, &bVar7, 3E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(&uVar16, &bVar9, 1E-05f, 0, 0, 1);
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "prdv_flk_SOUTH_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar24 = Function_3(&uVar16, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar25 = Function_3(&uVar16, &bVar2, 1E-05f, 0, 1, 1);
			...
			uVar26 = Function_3(&uVar16, &bVar5, 7E-06f, 0, 0, 1);
			...
			uVar27 = Function_3(&uVar16, &bVar6, 2,5E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(&uVar16, &bVar7, 3E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(&uVar16, &bVar10, 1E-05f, 0, 0, 1);
		...
		uVar16 = FIND_VOLUME_IN_LAYOUT(&uVar15, "prdv_flk_NORTH_set");
		if (IS_VOLUME_VALID(&uVar16))
		{
			uVar30 = Function_3(&uVar16, &bVar0, 3E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(&uVar16, &bVar2, 2E-05f, 0, 1, 1);
			...
			uVar32 = Function_3(&uVar16, &bVar5, 5E-06f, 0, 0, 1);
			...
			uVar33 = Function_3(&uVar16, &bVar6, 1E-05f, 0, 0, 1);
			...
			uVar34 = Function_3(&uVar16, &bVar7, 2E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(&uVar16, &bVar10, 1E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(&uVar16, &bVar9, 1E-05f, 0, 0, 1);
			...
			Function_3(&uVar16, &(Global_46972[7]), 2E-05f, 0, 0, 1);
			Function_3(&uVar16, &bVar1, 4E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0x1536 / 5430
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1547 / 5447
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x159F / 5535
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0x162F / 5679
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0x164B / 5707
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x168B / 5771
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x16A8 / 5800
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x16B9 / 5817
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1737 / 5943
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x17A3 / 6051
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x180F / 6159
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1856 / 6230
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1863 / 6243
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x18E5 / 6373
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x18F4 / 6388
{
	if (!Function_4(128))
	{
		return;
