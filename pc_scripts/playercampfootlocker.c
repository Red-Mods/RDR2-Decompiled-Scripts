...
void main() //Position: 0x0 / 0
{
	...
	iLocal_42 = 0;
	Function_99(&uScriptParam_0, &iLocal_42);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_43);
		}
		iVar2 = 0;
		bLocal_50 = false;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_51))
	{
		Function_102("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_51);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_42 - 1))
	{
...
int Function_4(int iParam0) //Position: 0x491 / 1169
{
	iParam0 = &iParam0;
	return 0;
}

void Function_5(struct<69> Param0) //Position: 0x49E / 1182
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_51))
								{
									...
									{
										bLocal_51 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_51 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_51))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_51))
		{
			Function_102("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_51);
		}
...
bool Function_6(int iParam0) //Position: 0x7D2 / 2002
{
	bool bVar0;
	struct<2> Var1;
	bool bVar3;
...
bool Function_7(bool bParam0, var uParam1, int iParam2) //Position: 0x8EB / 2283
{
	int iVar0;
	bool bVar1;
...
bool Function_8(char* cParam0, int iParam1) //Position: 0x909 / 2313
{
	return Function_9(&cParam0, "UseQuit", &iParam1);
}

bool Function_9(char* cParam0, char* cParam1, int iParam2) //Position: 0x922 / 2338
{
	int iVar0;
	int iVar1;
...
float Function_10(int iParam0) //Position: 0x972 / 2418
{
	return Function_11(&iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(float fParam0, var uParam1, int iParam2) //Position: 0x990 / 2448
{
	int iVar0;
...
float Function_12(vector3 vParam0) //Position: 0x9A8 / 2472
{
...
bool Function_13(int iParam0) //Position: 0xA75 / 2677
{
	return Function_73(iParam0, 2);
}

bool Function_14(int iParam0) //Position: 0xA83 / 2691
{
	return Function_73(iParam0, 1);
}

bool Function_15(int iParam0, int iParam1) //Position: 0xA91 / 2705
{
	bool bVar0;
...
bool Function_16(struct<69> Param0) //Position: 0xADE / 2782
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_48, &uLocal_46);
		...
		case 0x00000006:
			...
			bVar0 = Function_49(&Param0 + 24, &Param0 + 16, Function_73(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_17(var uParam0, int iParam1) //Position: 0x1E13 / 7699
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1E2A / 7722
{
	uParam1 = &uParam1;
	uParam0 = &uParam0;
	return;
...
bool Function_19() //Position: 0x1E3C / 7740
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E6F / 7791
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, int iParam1) //Position: 0x1EED / 7917
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(int iParam0, int iParam1) //Position: 0x1F69 / 8041
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1F7B / 8059
{
	return Function_11(&iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1F92 / 8082
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1F9F / 8095
{
	return Function_11(&iParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1FC0 / 8128
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
...
int Function_27(int iParam0) //Position: 0x1FF7 / 8183
{
...
bool Function_28(bool bParam0) //Position: 0x201F / 8223
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_29() //Position: 0x203F / 8255
{
	return;
}

void Function_30(int iParam0, bool bParam1) //Position: 0x2045 / 8261
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_31(char* cParam0) //Position: 0x2057 / 8279
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_32(int iParam0) //Position: 0x2064 / 8292
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(char* cParam0, int iParam1) //Position: 0x207F / 8319
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x209F / 8351
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x20BF / 8383
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x20F6 / 8438
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x2116 / 8470
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x2131 / 8497
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2147 / 8519
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x246B / 9323
{
	int iVar0;
...
bool Function_41(char* cParam0, int iParam1) //Position: 0x2474 / 9332
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x2493 / 9363
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x24A2 / 9378
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(char* cParam0, int iParam1) //Position: 0x24C6 / 9414
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x24EC / 9452
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x250A / 9482
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x252C / 9516
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(bool bParam0, int iParam1) //Position: 0x254E / 9550
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x2616 / 9750
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2692 / 9874
{
...
void Function_51(vector3 vParam0) //Position: 0x26AA / 9898
{
...
var Function_52(int iParam0) //Position: 0x26CF / 9935
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x26F0 / 9968
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x2707 / 9991
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x2713 / 10003
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x271A / 10010
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x272B / 10027
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x2770 / 10096
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x279C / 10140
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x27A8 / 10152
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x28AA / 10410
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x28CD / 10445
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x28F5 / 10485
{
	struct<2> Var0;
	struct<2> Var2;
	struct<2> Var4;
...
struct<8> Function_64(vector3 vParam0) //Position: 0x2BDC / 11228
{
	struct<2> Var0;
...
struct<8> Function_65(vector3 vParam0) //Position: 0x2C39 / 11321
{
	struct<2> Var0;
...
void Function_66(int iParam0) //Position: 0x2C96 / 11414
{
	iParam0 = &iParam0;
	return;
}

bool Function_67(int iParam0) //Position: 0x2CA2 / 11426
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2CC1 / 11457
{
	if (!Function_14(&iParam0))
	{
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2CD8 / 11480
{
	var uVar0;
	bool bVar2;
	bool bVar3;
	...
	Function_60(&iParam1);
	uVar0 = Function_60(&iParam1);
	bVar2 = Function_70(&iParam1);
	bVar3 = Function_59(&iParam1);
	fVar4 = Function_58(&iParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(&uParam0, &uVar0, bVar2, 0,2f, 1, bVar3, fVar4, 0, 0);
}

int Function_70(int iParam0) //Position: 0x2D15 / 11541
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

bool Function_71(var uParam0, int iParam1) //Position: 0x2D39 / 11577
{
...
int Function_72(var uParam0) //Position: 0x2D67 / 11623
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2E80 / 11904
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2E8D / 11917
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2F0F / 12047
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_48)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_46));
		iLocal_48 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_37(&Param0 + 16))
...
void Function_76() //Position: 0x34BA / 13498
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x34F4 / 13556
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3512 / 13586
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x3553 / 13651
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x355F / 13663
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3581 / 13697
{
	bool bVar0;
	var uVar1;
	...
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	bVar0 = DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "CAMPLVL");
	if (IS_ACTOR_VALID(&uParam0))
	{
	...
	if (iLocal_2)
	{
		...
		{
			case 0x00000000:
				Function_83(&uParam0, 4, 0);
				Function_83(&uParam0, 8, 0);
				break;
			
			case 0x00000001:
				Function_83(&uParam0, 4, 0);
				Function_83(&uParam0, 8, 0);
				Function_83(&uParam0, GET_WEAPON_EQUIPPED(&uParam0, 5), 0);
				Function_83(&uParam0, GET_WEAPON_EQUIPPED(&uParam0, true), 0);
				if (!HAS_ITEM("ELIXIR", &uParam0))
				{
					ADD_ITEM("ELIXIR", &uParam0, 1);
				}
				break;
			...
			case 0x00000002:
				Function_83(&uParam0, 4, 0);
				Function_83(&uParam0, 8, 0);
				Function_83(&uParam0, GET_WEAPON_EQUIPPED(&uParam0, 5), 1);
				Function_83(&uParam0, GET_WEAPON_EQUIPPED(&uParam0, true), 1);
				Function_82(&uParam0);
				if (!HAS_ITEM("ABSINTHE", &uParam0))
				{
					ADD_ITEM("ABSINTHE", &uParam0, 1);
				}
				break;
		}
		if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(&uParam0), "CAMPLVL"))
		{
			DECOR_REMOVE(GET_OBJECT_FROM_ACTOR(&uParam0), "CAMPLVL");
		}
...
int Function_82(int iParam0) //Position: 0x372B / 14123
{
	int iVar0;
	
	iVar0 = (RAND_INT_RANGE(true, 4499) / 1500);
	if (iVar0 == 0)
	{
		ADD_ITEM("FEED_BAG", &iParam0, 1);
	}
	else if (iVar0 == 1)
	{
		ADD_ITEM("H_PILLS", &iParam0, 1);
	}
	else
	{
		ADD_ITEM("H_MEDS", &iParam0, 1);
	}
	return 1;
}

int Function_83(var uParam0, bool bParam1, bool bParam2) //Position: 0x3787 / 14215
{
	float fVar0;
	bool bVar1;
	bool bVar2;
	...
	if (iLocal_3)
	{
		fVar0 = GET_WEAPON_MAX_AMMO(bParam1);
	}
	else
	{
		fVar0 = 0.0f;
	}
	bVar1 = GET_AMMO_ENUM(bParam1);
	bVar2 = 0.0f;
	fVar3 = (_GET_AMMO_AMOUNT(&uParam0, bVar1, 0) + ACTOR_GET_WEAPON_AMMO(&uParam0, bParam1));
	if (fVar3 > GET_WEAPON_MAX_AMMO(bParam1))
	{
		bVar2 = ((GET_WEAPON_MAX_AMMO(bParam1) - fVar3) + fVar0);
		if (&bParam2)
		{
			bVar2 = (bVar2 + (GET_WEAPON_MAX_AMMO(bParam1) + fVar0));
		}
	}
	if (bVar2 < 0.0f)
	{
		_ADD_AMMO_OF_TYPE(&uParam0, bVar1, bVar2, 1, 1);
	}
	return 1;
}

void Function_84(var uParam0, bool bParam1) //Position: 0x37FC / 14332
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_85(int iParam0, int iParam1) //Position: 0x390C / 14604
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_86(struct<69> Param0) //Position: 0x3924 / 14628
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_87(int iParam0, int iParam1) //Position: 0x3C40 / 15424
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3C52 / 15442
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x3C6C / 15468
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, var uParam1) //Position: 0x3C87 / 15495
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3CC5 / 15557
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_92(struct<65> Param0) //Position: 0x3CDE / 15582
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_93(int iParam0) //Position: 0x3FD6 / 16342
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3FF4 / 16372
{
	struct<5> Var0;
	float fVar5;
...
int Function_95(int iParam0) //Position: 0x4095 / 16533
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x40B5 / 16565
{
	iParam1 = &iParam1;
	uParam0 = &uParam0;
...
bool Function_97(int iParam0) //Position: 0x40E2 / 16610
{
...
void Function_98(int iParam0) //Position: 0x40FE / 16638
{
	iParam0 = &iParam0;
	return;
}

void Function_99(var uParam0, int iParam1) //Position: 0x410A / 16650
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_100(&(vLocal_4[iLocal_429]), &uParam0);
		iLocal_42++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x4176 / 16758
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_101(var uParam0) //Position: 0x418E / 16782
{
	var uVar0;
	int iVar2;
	...
	iVar2 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/stand_open_chest", &uVar0, 1.0f, 0);
