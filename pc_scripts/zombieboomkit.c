...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	{
		if (_GET_AMMO_AMOUNT(&Global_54076, 5, 1) != 0.0f)
		{
			Function_63("not enough dynamite", 0x41200000, 1, 0, 2, 1, 0);
			bVar0 = true;
		}
		if (_GET_AMMO_AMOUNT(&Global_54076, 3, 1) != 0.0f)
		{
			Function_63("not enough bait", 0x41200000, 1, 0, 2, 1, 0);
			bVar0 = true;
		}
	}
	if (bVar0)
	...
	bVar1 = CEIL((_GET_AMMO_AMOUNT(&Global_54076, 2, 0) + ACTOR_GET_WEAPON_AMMO(&Global_54076, 37)));
	if (IntToFloat(bVar1) <= _GET_MAX_AMMO_AMOUNT(&Global_54076, 2))
	{
		Function_63("item_zboom_full", 0x41200000, 1, 0, 2, 1, 0);
		return;
	}
	...
	if (!HAS_ACHIEVEMENT_BEEN_PASSED(47))
	{
		_ADD_AMMO_OF_TYPE(&Global_54076, 3, -1.0f, 0, 0);
		_ADD_AMMO_OF_TYPE(&Global_54076, 5, -1.0f, 0, 0);
	}
	_ADD_AMMO_OF_TYPE(&Global_54076, 2, 1.0f, 0, 1);
	Function_57(669, 1, 0, 0);
	iParam2 = 1;
	return;
}

int Function_57(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2E32 / 11826
{
	int iVar0;
	int iVar1;
...
void Function_58(int iParam0) //Position: 0x305A / 12378
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_59(int iParam0, bool bParam1, bool bParam2) //Position: 0x30F8 / 12536
{
...
bool Function_60() //Position: 0x31BC / 12732
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_61(int iParam0) //Position: 0x31D3 / 12755
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_62(int iParam0) //Position: 0x31DF / 12767
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_63(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x31EE / 12782
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_64(Global_10966) };
		}
...
struct<16> Function_64(int iParam0) //Position: 0x3279 / 12921
{
	char* cVar0[16];
...
var Function_65(int iParam0) //Position: 0x32B8 / 12984
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_66(int iParam0, int iParam1) //Position: 0x32D3 / 13011
{
	var uVar0;
	var uVar1;
