...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46914[0], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 1))
			{
				Function_25(Global_46914[0], 1);
				(&Local_35 + 232) = Function_25(Global_46914[0], 1);
				Function_24(&Local_35 + 12);
				iVar1 = 0;
				while (iVar1 <= 6)
				{
					(*&Local_35 + 68)[iVar1] = iLocal_4 * 10;
					Function_23(Global_46914[0], iVar1, 1);
					*(&Local_35 + 128[iVar12]) = Function_23(Global_46914[0], iVar1, 1);
					iVar1++;
				}
				if (Function_35())
				{
				...
				*(&Local_35 + 268) = Function_22(Global_46914[0]);
				Function_21(Global_46914[0]);
				*(&Local_35 + 280) = Function_21(Global_46914[0]);
				Function_20(Local_7, 0);
				uVar0 = NET_MAILBOX_GET_CHALLENGE_BY_ID("sc_challenge_aa_08");
				SC_CHALLENGE_LAUNCH(&uVar0);
				DECOR_SET_INT(&Global_54076, "scInPokerBlk", true);
		...
		case 0x00000002:
			if (!Function_10(Local_7))
			{
				...
				{
					DECOR_REMOVE(&Global_54076, "scInPokerBlk");
				}
...
void Function_17() //Position: 0x672 / 1650
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x67B / 1659
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x69C / 1692
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x6D3 / 1747
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_21(int iParam0) //Position: 0x6EE / 1774
{
...
struct<8> Function_22(int iParam0) //Position: 0x7F0 / 2032
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_23(int iParam0, int iParam1, bool bParam2) //Position: 0x8F2 / 2290
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_24(int[] iParam0) //Position: 0xE9E / 3742
{
	int iVar0;
	var uVar1;
...
struct<8> Function_25(int iParam0, bool bParam1) //Position: 0xEFA / 3834
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_26(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0x1016 / 4118
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1224 / 4644
{
...
bool Function_28() //Position: 0x12E8 / 4840
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_29(int iParam0) //Position: 0x12FF / 4863
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_30(int iParam0) //Position: 0x130B / 4875
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_31(var uParam0, int iParam1) //Position: 0x131A / 4890
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_32(var uParam0, bool bParam1) //Position: 0x1329 / 4905
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_33() //Position: 0x136B / 4971
{
	return Function_34(0);
}

int Function_34(bool bParam0) //Position: 0x1375 / 4981
{
...
bool Function_35() //Position: 0x13B6 / 5046
{
...
var Function_36(int iParam0) //Position: 0x13E1 / 5089
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_37() //Position: 0x13FB / 5115
{
	Function_1();
	return;
}

void Function_38() //Position: 0x1404 / 5124
{
...
void Function_39(int iParam0) //Position: 0x1454 / 5204
{
...
void Function_40(vector3 vParam0) //Position: 0x146B / 5227
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x1490 / 5264
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x14A6 / 5286
{
...
int Function_44(var uParam0, bool bParam1) //Position: 0x14C5 / 5317
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x14D2 / 5330
{
	return;
}

void Function_46() //Position: 0x14D8 / 5336
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x14DE / 5342
{
	var uVar0;
...
void Function_48(var uParam0) //Position: 0x153D / 5437
{
	int iVar0;
...
var Function_49() //Position: 0x155A / 5466
{
	var uVar0;
