...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_126(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireMedium01x");
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 0, 0, "ped_law", 2,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
...
void Function_1(struct<473> Param0) //Position: 0x13B / 315
{
	int iVar0;
...
void Function_2() //Position: 0x2E9 / 745
{
	return;
}

void Function_3() //Position: 0x2EF / 751
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2F8 / 760
{
...
void Function_5(int iParam0) //Position: 0x30B / 779
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x333 / 819
{
...
void Function_7(struct<13> Param0) //Position: 0x47E / 1150
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x49B / 1179
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4B9 / 1209
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if (Global_6611)
			{
				if (Function_123(StackVal, &Global_54076, Var7) < 10.0f)
				{
					break;
				}
			}
			...
			{
				if (Function_122(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_120(&Param0 + 324, &fLocal_40, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_119();
								(*&Param0 + 48)[1] = Function_118();
								Function_117(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_117(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								iVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_109(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_109(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_117(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_117(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_109(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (iVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[iVar1] = Function_109(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[iVar1] = Function_109(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_117(&Param0 + 120, (*&Param0 + 48)[iVar1], 2, 0);
								iVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_108(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_40, 20.0f, fLocal_40));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_104(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_108(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_79(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_75(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
		...
		case 0x00000002:
			...
			{
				if (((Function_123(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						if (IS_OBJECT_VALID(&Param0 + 352))
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_108(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_108(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
					...
					Function_66(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_65(StackVal, StackVal, &Param0 + 16, Function_108(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_108()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				iVar1 = 0;
				while (iVar1 <= iParam3)
				{
					Function_62(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[iVar1], &Param0 + 272[iVar1], &Param0 + 480, iVar1);
					iVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_61(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_61(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_50(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, 0));
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_45(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_41, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_44(&Param0 + 392, 1);
							Function_43(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_41 == 8)
							{
					...
					while (iVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[iVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[iVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[iVar1]) != &Global_54076)
							{
								...
								Function_44(&Param0 + 392, 1);
								Function_43(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_42(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_38(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_38(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_37()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_36(&Param0 + 392, Function_37(), 4);
				Function_35(&Param0 + 392, Function_37());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_34(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_33(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (iVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_24(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), 4, 0, 2);
						}
...
void Function_10(struct<62> Param0) //Position: 0x1678 / 5752
{
	var uVar0;
	...
	if (SQUAD_IS_VALID(&Param0 + 392))
	{
		if (!bLocal_35 && DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "victim"))
		{
			uLocal_32 = GET_ACTOR_FROM_OBJECT(DECOR_GET_OBJECT(GRINGO_GET_MY_OBJECT_REF(), "victim"));
			if (IS_ACTOR_VALID(&uLocal_32))
			{
				if (IS_ACTOR_ALIVE(&uLocal_32))
				{
					if (Function_19(&uLocal_32, GRINGO_GET_MY_OBJECT_REF(), 50.0f))
					{
						bLocal_35 = true;
						SQUAD_GOAL_ADD_SHARE_PERCEPTION(&Param0 + 392, 1);
					}
				}
			}
		}
		...
		{
			if (!iLocal_36 && Function_18(&Param0 + 392, &uLocal_32, 1))
			{
				iLocal_36 = 1;
				Function_16(&Param0 + 392, 30.0f, 0x40400000, 0x40000000);
				Function_44(&Param0 + 392, 1);
				Function_36(&Param0 + 392, &uLocal_32, 4);
				Function_15(&Param0 + 392, 322, 4294967295, 0, 3212836864, 0x3f800000, 2048, 0);
			}
			else if (!Function_13(&Param0 + 392, &uLocal_32, 150.0f, 1))
			{
				iLocal_36 = 0;
				Function_36(&Param0 + 392, &uLocal_32, 2);
				Function_12(&Param0 + 392);
				Function_11(&Param0 + 392);
				SQUAD_GOALS_CLEAR(&Param0 + 392);
			}
			else if (!iLocal_37 && !Function_13(&Param0 + 392, &uLocal_32, 40.0f, 1))
			{
				iLocal_37 = 1;
				uVar0 = Vector(0.0f, 0.0f, 2,5f);
				Function_11(&Param0 + 392);
				SQUAD_GOALS_CLEAR(&Param0 + 392);
				SQUAD_GOAL_ADD_GENERAL_TASK(&Param0 + 392, 1, 0, 4294967295);
				TASK_FOLLOW_AND_ATTACK_OBJECT(0, &uLocal_32, &uVar0, 0, 0, 0, 0, 0, 1);
			}
			else if (iLocal_37 && Function_13(&Param0 + 392, &uLocal_32, 40.0f, 1))
			{
				iLocal_37 = 0;
			...
			else if (!iLocal_34 && Function_13(&Param0 + 392, &uLocal_32, 20.0f, 1))
			{
				iLocal_34 = 1;
				DECOR_SET_BOOL(GRINGO_GET_MY_OBJECT_REF(), "nvictimmsg", 1);
				Function_11(&Param0 + 392);
				SQUAD_GOALS_CLEAR(&Param0 + 392);
			}
		}
...
void Function_11(int iParam0) //Position: 0x1884 / 6276
{
	int iVar0;
...
void Function_12(int iParam0) //Position: 0x18B9 / 6329
{
	int iVar0;
	var uVar1;
...
bool Function_13(var uParam0, var uParam1, bool bParam2, int iParam3) //Position: 0x190D / 6413
{
	int iVar0;
	var uVar1;
	...
	while (iVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			if (IS_ACTOR_ALIVE(&uVar1))
			{
				...
				{
					if (!Function_14(&uVar1, 1) || iParam3)
					{
						return 1;
					}
				}
...
bool Function_14(int iParam0, bool bParam1) //Position: 0x19B2 / 6578
{
	var uVar0;
	int iVar1;
...
void Function_15(var uParam0, int iParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7) //Position: 0x1A04 / 6660
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void Function_16(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1B14 / 6932
{
	int iVar0;
	var uVar1;
	...
	while (iVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			Function_17(&uVar1, uParam1, &uParam2, &uParam3);
		}
		iVar0++;
	}
}

void Function_17(var uParam0, float fParam1, float fParam2, float fParam3) //Position: 0x1B62 / 7010
{
...
int Function_18(int iParam0, int iParam1, bool bParam2) //Position: 0x1BB3 / 7091
{
	var uVar0;
	int iVar1;
	...
	if (SQUAD_IS_VALID(&iParam0))
	{
		...
		{
			iVar1 = 0;
			while (iVar1 <= SQUAD_GET_SIZE(&iParam0))
			{
				uVar0 = SQUAD_GET_ACTOR_BY_INDEX(&iParam0, iVar1);
...
bool Function_19(int iParam0, var uParam1, float fParam2) //Position: 0x1C26 / 7206
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		if (IS_OBJECT_VALID(&uParam1))
		{
			Function_21(&iParam0);
			Function_20(&uParam1);
			if (VDIST(Function_21(&iParam0), Function_20(&uParam1)) >= fParam2)
			{
				return 1;
			}
		}
...
struct<8> Function_20(int iParam0) //Position: 0x1D44 / 7492
{
	struct<2> Var0;
...
struct<8> Function_21(int iParam0) //Position: 0x1DB2 / 7602
{
	struct<2> Var0;
...
void Function_22(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1E1E / 7710
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	while (iVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_23(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
...
bool Function_23(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2057 / 8279
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_24(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2077 / 8311
{
	int iVar0;
	var uVar1;
...
int Function_25(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2165 / 8549
{
	char* cVar0[32];
...
int Function_26(int iParam0) //Position: 0x23D1 / 9169
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_27(var uParam0, bool bParam1) //Position: 0x23F5 / 9205
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_28(var uParam0, int iParam1) //Position: 0x2419 / 9241
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_29(var uParam0, bool bParam1) //Position: 0x243F / 9279
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_30(var uParam0, bool bParam1) //Position: 0x2466 / 9318
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_31(bool bParam0) //Position: 0x248A / 9354
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_32() //Position: 0x24A9 / 9385
{
...
bool Function_33(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x24F8 / 9464
{
	int iVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (iVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_23(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_34(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2554 / 9556
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_35(var uParam0, int iParam1) //Position: 0x2575 / 9589
{
	int iVar0;
	var uVar1;
...
void Function_36(var uParam0, var uParam1, bool bParam2) //Position: 0x25D0 / 9680
{
	int iVar0;
	var uVar1;
...
var Function_37() //Position: 0x261C / 9756
{
...
void Function_38(struct<425> Param0) //Position: 0x2631 / 9777
{
	int iVar0;
	int iVar1;
	...
	if (!Function_41(&Param0 + 392))
	{
		return;
	}
	if (!Function_39(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_42(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_42(&Param0 + 392), &Global_54076, 5.0f);
		iVar1 = 0;
		while (iVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_42(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_42(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_39(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2784 / 10116
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_40(StackVal, Param1))
	{
		return 0;
	}
	iVar2 = 0;
...
bool Function_40(vector3 vParam0) //Position: 0x27F9 / 10233
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_41(var uParam0) //Position: 0x2811 / 10257
{
	int iVar0;
	int iVar1;
...
var Function_42(bool bParam0) //Position: 0x286F / 10351
{
	bool bVar0;
	int iVar1;
...
void Function_43(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x28BC / 10428
{
	int iVar0;
	var uVar1;
...
void Function_44(var uParam0, bool bParam1) //Position: 0x2935 / 10549
{
	int iVar0;
	var uVar1;
...
bool Function_45(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x2984 / 10628
{
	float fVar0;
	...
	if (IS_ACTOR_VALID(&iParam0) && !&bParam4)
	{
		fVar0 = Function_49(&iParam0, &Global_54076);
...
void Function_46(int iParam0) //Position: 0x2B4D / 11085
{
...
void Function_47(int iParam0) //Position: 0x2B8A / 11146
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_48(var uParam0, int iParam1) //Position: 0x2BA3 / 11171
{
	return (uParam0 && iParam1) == 0;
}

var Function_49(var uParam0, int iParam1) //Position: 0x2BB0 / 11184
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_50(var uParam0) //Position: 0x2CA5 / 11429
{
	struct<21> Var0;
	
	bVar6 = Function_60(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_52(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_51())
...
bool Function_51() //Position: 0x2D64 / 11620
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_52(struct<25> Param0) //Position: 0x2D77 / 11639
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_53(int iParam0) //Position: 0x2E3E / 11838
{
...
bool Function_54(int iParam0) //Position: 0x2E5E / 11870
{
...
bool Function_55(int iParam0) //Position: 0x2E82 / 11906
{
...
bool Function_56(int iParam0) //Position: 0x2E97 / 11927
{
...
bool Function_57(var uParam0, bool bParam1) //Position: 0x2EAE / 11950
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x2EEC / 12012
{
...
bool Function_59(int iParam0) //Position: 0x2F06 / 12038
{
...
int Function_60(int iParam0, struct<6> Param1) //Position: 0x2F1C / 12060
{
	int iVar0;
...
void Function_61(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x2F56 / 12118
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_108(), bParam2[iVar0], Var1, Var3);
...
void Function_62(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x303B / 12347
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_108(), bParam3, Var2, Var4);
...
void Function_63(var uParam0, bool bParam1) //Position: 0x31F2 / 12786
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_64(bool bParam0) //Position: 0x3217 / 12823
{
	var uVar0;
	int iVar1;
...
var Function_65(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3265 / 12901
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_66(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x33BC / 13244
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_67(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_67(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3467 / 13415
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_68(int iParam0, int iParam1) //Position: 0x350D / 13581
{
...
bool Function_69(var uParam0) //Position: 0x3528 / 13608
{
	var uVar0;
	
	Function_74(3, 2);
	uVar0 = &uVar0;
	Function_71(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_71(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/campfire_talk", 1, 0);
	Function_71(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_71(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground_nospawn", 1, 0);
	Function_71(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	if (!Function_75(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_108()));
	*(&iLocal_0 + 96) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, StackVal, &iLocal_0, "defend_region", 2,802597E-45f, Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), Vector(15.0f, 5.0f, 15.0f));
	...
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType", "Rand_Idle_Sit_Ground", Vector(-1,006979f, 0.0f, 1,860258f), Vector(0.0f, -24,90162f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType1", "Rand_Idle_Sit_Ground", Vector(1,336552f, 0.0f, 0,8644874f), Vector(0.0f, 56,98051f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType2", "Rand_Idle_Sit_Ground", Vector(-0,03567915f, 0.0f, -1,427451f), Vector(0.0f, -175,2135f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType3", "campfire_talk", Vector(-1,097859f, 0,09311698f, -1,010704f), Vector(0.0f, 41,60906f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType4", "Sit_Ground_Campfire_Tend", Vector(0,259433f, 0.0f, 0,9700034f), Vector(0.0f, 16,58006f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "aiGringoLocType5", "Rand_Idle_Sit_Ground_nospawn", Vector(0,8610202f, 0.0f, -0,8455662f), Vector(0.0f, -224,148f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 104) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(-2,683875f, 0.0f, -2,346591f), Vector(0.0f, -42,43259f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 104), 0);
	*(&iLocal_0 + 112) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "camp_veh_gen", "horse_stay", Vector(0,03595503f, 0.0f, -3,419633f), Vector(0.0f, -97,05606f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 112), 0);
	*(&iLocal_0 + 120) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp1", "horse_stay", Vector(2,465868f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 120), 0);
	Function_70(&iLocal_0, &uParam0);
	return 1;
}

void Function_70(int iParam0, int iParam1) //Position: 0x3A57 / 14935
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &iParam1, Function_108(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
var Function_71(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x3AA2 / 15010
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_73(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
		Function_72(&(Param0[iVar02]), 8);
	}
	return iVar0;
}

void Function_72(struct<13> Param0) //Position: 0x3AE0 / 15072
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_73(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x3AF3 / 15091
{
	int iVar0;
...
void Function_74(int iParam0, int iParam1) //Position: 0x3BC2 / 15298
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_75(struct<2>[] Param0) //Position: 0x3C0C / 15372
{
	int iVar0;
	int iVar1;
...
void Function_76() //Position: 0x3FCE / 16334
{
	if (!Function_127(128))
	{
		return;
...
bool Function_77() //Position: 0x400F / 16399
{
	int iVar0;
...
void Function_78() //Position: 0x403D / 16445
{
	if (!Function_127(128))
	{
		return;
...
void Function_79(vector3 vParam0) //Position: 0x407F / 16511
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_80(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_80(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_80(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x4117 / 16663
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_81(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_81(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x4146 / 16710
{
	Function_96(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_86(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_85(), Function_84(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_83(), Function_82(&uParam11, &uParam12));
}

var Function_82(var uParam0, bool bParam1) //Position: 0x41A1 / 16801
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_83() //Position: 0x41B1 / 16817
{
	return "PackedGrass";
}

var Function_84(bool bParam0, bool bParam1, bool bParam2) //Position: 0x41C5 / 16837
{
	int iVar0;
...
var Function_85() //Position: 0x41EA / 16874
{
	return "PackedMetadata";
}

void Function_86(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4201 / 16897
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&iParam1, Function_95(), &uVar4))
				{
					Function_90(uVar4, &iVar5);
...
struct<8> Function_87() //Position: 0x433D / 17213
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_88() //Position: 0x434F / 17231
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_89() //Position: 0x4361 / 17249
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_90(var uParam0, struct<5> Param1) //Position: 0x4373 / 17267
{
	Param1 = Function_91(uParam0, Function_93(), 0);
	Param1.f_4 = Function_91(uParam0, Function_93() + 8, Function_93());
	return;
}

var Function_91(var uParam0, int iParam1, int iParam2) //Position: 0x4398 / 17304
{
	int iVar0;
...
var Function_92(bool bParam0) //Position: 0x43B7 / 17335
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_93() //Position: 0x43C3 / 17347
{
	return Function_94(39);
}

int Function_94(int iParam0) //Position: 0x43CE / 17358
{
	int iVar0;
...
var Function_95() //Position: 0x43FC / 17404
{
	return "PackedWeapon";
}

int Function_96(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x4411 / 17425
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_100(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_98(Function_100()), 16);
	}
	NET_OBJECT_REPLICATION_MODE_START(17, 0);
	uParam0 = CREATE_PROP_IN_LAYOUT(&uParam3, &cVar3, &uVar0, Param4, Param6, 0);
	SNAP_OBJECT_TO_GROUND(&uParam0, 1.0f, 0, 1092616192);
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_97(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_97() //Position: 0x451E / 17694
{
	return "MPItemGiver";
}

struct<32> Function_98(char* cParam0) //Position: 0x4532 / 17714
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_99(char* cParam0) //Position: 0x459E / 17822
{
	char* cVar0[32];
...
var Function_100() //Position: 0x45C0 / 17856
{
	return "PBox_";
}

var Function_101() //Position: 0x45CE / 17870
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_102() //Position: 0x45F4 / 17908
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_103() //Position: 0x461C / 17948
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_104(var uParam0, int iParam1) //Position: 0x4642 / 17986
{
	int iVar0;
	var uVar1;
...
void Function_105(int iParam0, var uParam1, struct<2> Param2) //Position: 0x47AC / 18348
{
	struct<8> Var0;
...
int Function_106(bool bParam0) //Position: 0x4854 / 18516
{
	int iVar0;
	struct<2> Var1;
...
void Function_107(int iParam0) //Position: 0x49C2 / 18882
{
...
var Function_108() //Position: 0x4A2A / 18986
{
	int iVar0;
...
var Function_109(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x4A33 / 18995
{
	return Function_110(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_110(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x4A51 / 19025
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_115(iVar1))
	{
		if (!Global_47146 && !Global_47147)
		{
			Function_114(&uParam0, bParam1, iParam2, iParam3, bParam4);
	...
	if (bParam1 || (!iParam3 != 4294967295 && !iParam3 != GET_ACTORENUM_SPECIES(iVar1)))
	{
		...
		{
			while (Function_113(iVar0) && iVar2 > 20)
			{
...
void Function_111(int iParam0) //Position: 0x4D4A / 19786
{
	int iVar0;
...
void Function_112() //Position: 0x4DFE / 19966
{
	int iVar0;
...
bool Function_113(int iParam0) //Position: 0x4E39 / 20025
{
	int iVar0;
...
void Function_114(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x4E66 / 20070
{
	int iVar0;
...
bool Function_115(int iParam0) //Position: 0x4FC1 / 20417
{
...
void Function_116() //Position: 0x4FD8 / 20440
{
	int iVar0;
...
var Function_117(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x5024 / 20516
{
	int iVar0;
...
int Function_118() //Position: 0x5100 / 20736
{
	int iVar0;
...
int Function_119() //Position: 0x525C / 21084
{
	int iVar0;
...
bool Function_120(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x537C / 21372
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_121(struct<2> Param0) //Position: 0x5458 / 21592
{
	struct<2> Var0;
	int iVar2;
...
bool Function_122(struct<2> Param0, struct<5> Param2) //Position: 0x5477 / 21623
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
	...
	{
		if (!Function_40(StackVal, Param2))
		{
			return 1;
		}
	}
...
float Function_123(var uParam0, struct<2> Param1) //Position: 0x55BA / 21946
{
	struct<2> Var0;
...
bool Function_124(int iParam0) //Position: 0x5631 / 22065
{
	var uVar0;
...
int Function_125() //Position: 0x5653 / 22099
{
	return 0;
}

void Function_126(struct<321> Param0) //Position: 0x565A / 22106
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_73(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_73(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

bool Function_127(int iParam0) //Position: 0x56EC / 22252
{
	int iVar0;
