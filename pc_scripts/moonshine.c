...
void Function_52(bool bParam0, int iParam1) //Position: 0x2BA9 / 11177
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	iVar3 = 0;
	bVar4 = false;
	if (!DECOR_CHECK_EXIST(&uParam1, "nmoonshine"))
	{
		if (IS_ACTOR_VALID(&uParam1) && IS_ACTOR_ALIVE(&uParam1))
		{
			GET_GRINGO_FLOAT_ATTR(&bVar0, "effectTime", &uParam0);
			GET_GRINGO_FLOAT_ATTR(&fVar1, "DeadEyeRestorePercent", &uParam0);
			uVar2 = GET_GRINGO_STRING_ATTR("myItemString", &uParam0, &iVar3);
			if (STRING_CONTAINS_STRING(&uVar2, "nMOONSHINE"))
			{
				DECOR_SET_FLOAT(&uParam1, "nmoonshine", bVar0);
			}
			...
			if (Global_39290[15])
			{
				SET_PLAYER_DEADEYE_POINTS(0, 150.0f, 1);
			}
			else
			{
			...
			if (STRING_CONTAINS_STRING(&uVar2, "nMOONSHINE"))
			{
				Function_60(478, 1, 0, 0);
				if (Function_59())
				{
					if (HAS_ITEM(SS_GET_STRING(1, true), &Global_54076))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, true), &Global_54076);
					}
					PLAYSTAT_INT("HC_MOONSHINE", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(&uVar2, "nSNAKE_OIL"))
			{
				Function_60(477, 1, 0, 0);
				if (Function_59())
				{
					if (HAS_ITEM(SS_GET_STRING(1, false), &Global_54076))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, false), &Global_54076);
					}
					PLAYSTAT_INT("HC_SNAKE_OIL", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(&uVar2, "TONIC"))
			{
				Function_60(486, 1, 0, 0);
				if (Function_59())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 5), &Global_54076))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 5), &Global_54076);
					}
					PLAYSTAT_INT("HC_TONIC", bVar4);
				}
			}
			iParam2 = 1;
		}
	...
	{
		Function_57("already_moonshine", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 0;
	}
	return;
}

void Function_57(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2F24 / 12068
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x2FAF / 12207
{
	char* cVar0[16];
...
bool Function_59() //Position: 0x2FEE / 12270
{
...
int Function_60(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3019 / 12313
{
	int iVar0;
	int iVar1;
...
void Function_61(int iParam0) //Position: 0x3241 / 12865
{
	switch (iParam0)
	{
		case 0x00000009:
...
int Function_62(int iParam0, bool bParam1, bool bParam2) //Position: 0x32DF / 13023
{
...
bool Function_63() //Position: 0x33A3 / 13219
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_64(int iParam0) //Position: 0x33BA / 13242
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_65(int iParam0) //Position: 0x33C6 / 13254
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_66(int iParam0) //Position: 0x33D5 / 13269
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_67(int iParam0, int iParam1) //Position: 0x33F0 / 13296
{
	var uVar0;
	var uVar1;
