...
void Function_3() //Position: 0x23C / 572
{
	...
	Function_4(8, &uLocal_38, &iLocal_40, &uLocal_4, &uLocal_42, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x259 / 601
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6CB / 1739
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x6FF / 1791
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA41 / 2625
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA74 / 2676
{
...
void Function_9(int iParam0) //Position: 0xA8B / 2699
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xAB7 / 2743
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAD1 / 2769
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAEE / 2798
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBB4 / 2996
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD7D / 3453
{
...
void Function_15(int iParam0) //Position: 0xDBA / 3514
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDD3 / 3539
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDE0 / 3552
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xED5 / 3797
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF3B / 3899
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xF9D / 3997
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFD2 / 4050
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11EB / 4587
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1262 / 4706
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12CE / 4814
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x12F6 / 4854
{
...
void Function_26(struct<13> Param0) //Position: 0x1441 / 5185
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x145E / 5214
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x147C / 5244
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_49 || bParam2) || Global_6611)
			{
				if (Function_154(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_152(&Param0 + 324, &fLocal_51, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_141(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_51, 20.0f, fLocal_51));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_137(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_141(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										fLocal_53 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_53) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_52, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x263B / 9787
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x264D / 9805
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2886 / 10374
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28A6 / 10406
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2994 / 10644
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2C00 / 11264
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C24 / 11300
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C48 / 11336
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C6E / 11374
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C95 / 11413
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CB9 / 11449
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CD8 / 11480
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D27 / 11559
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D83 / 11651
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DA4 / 11684
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2DFF / 11775
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E4B / 11851
{
...
void Function_46(struct<425> Param0) //Position: 0x2E60 / 11872
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FB3 / 12211
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3028 / 12328
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x3040 / 12352
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x309E / 12446
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30EB / 12523
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x3164 / 12644
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31B3 / 12723
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x3272 / 12914
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3285 / 12933
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x334C / 13132
{
...
bool Function_57(int iParam0) //Position: 0x336C / 13164
{
...
bool Function_58(int iParam0) //Position: 0x3390 / 13200
{
...
bool Function_59(int iParam0) //Position: 0x33A5 / 13221
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33BC / 13244
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x33FA / 13306
{
...
bool Function_62(int iParam0) //Position: 0x3414 / 13332
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x342A / 13354
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3464 / 13412
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3549 / 13641
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
...
void Function_66(var uParam0, bool bParam1) //Position: 0x3700 / 14080
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3725 / 14117
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3773 / 14195
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38CA / 14538
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3975 / 14709
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A1B / 14875
{
	...
	if (Function_86(&uLocal_38, &uLocal_4, 38, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (!IS_LAYOUTREF_VALID(&uLocal_42))
		{
			uLocal_42 = CREATE_LAYOUT("rebel04campfirelayout");
			iLocal_46 = 0;
		}
		if (!IS_LAYOUTREF_VALID(&uLocal_44))
		{
			Function_84(&uLocal_44, "rebel04mobile", &iParam1);
		}
		if (Function_78("$/cutscene/REBEL_04/REBEL_04", &iLocal_46, &uLocal_42, &uLocal_47, &uLocal_4, "p_gen", 0))
		{
			iLocal_40 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_44, Function_141()));
			*(&Global_6667[3828] + 216) = &iLocal_40;
...
void Function_72() //Position: 0x3B4E / 15182
{
	var uVar0;
	int iVar1;
	
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "rebel04campluisait", "chair_sit_attach", Vector(-2291,7f, 21,65f, 4961.0f), Vector(0.0f, 140.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	SNAP_ACTOR_TO_GRINGO(&uLocal_38, &uVar0, "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_38, GET_GRINGO_FROM_OBJECT(&uVar0), "UseCase1", 4294967295, 1);
	Function_76(&uLocal_38, &iLocal_40, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "rebel04campeasy01", 533, Vector(-2233,187f, 19,41f, 4904,43f), Vector(0.0f, 0.0f, 0.0f));
	Function_73(StackVal, &iVar1, Vector(-2226,482f, 19,568f, 4908,459f));
	TASK_CROUCH(&iVar1, -1.0f);
	Function_76(&iVar1, &iLocal_40, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "rebel04campmed02", 537, Vector(-2226,482f, 19,568f, 4908,459f), Vector(0.0f, 0.0f, 0.0f));
	Function_73(StackVal, &iVar1, Vector(-2233,187f, 19,41f, 4904,43f));
	TASK_CROUCH(&iVar1, -1.0f);
	Function_76(&iVar1, &iLocal_40, 1, 1);
	iVar1 = CREATE_ACTOR_IN_LAYOUT(StackVal, StackVal, &uLocal_42, "rebel04campmed03", 538, Vector(-2291,56f, 22,36f, 4961,74f), Vector(0.0f, 0.0f, 0.0f));
	Function_73(StackVal, &iVar1, Vector(-2292,27f, 22,31f, 4961.0f));
	TASK_CROUCH(&iVar1, -1.0f);
	Function_76(&iVar1, &iLocal_40, 1, 1);
	return;
}

void Function_73(float fParam0, struct<2> Param1) //Position: 0x3CF2 / 15602
{
...
var Function_74(var uParam0, struct<2> Param1) //Position: 0x3D2D / 15661
{
	struct<2> Var0;
...
struct<8> Function_75(int iParam0) //Position: 0x3DAE / 15790
{
	struct<2> Var0;
...
void Function_76(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3DC0 / 15808
{
	bool bVar0;
	int iVar1;
...
bool Function_77(int iParam0, int iParam1, bool bParam2) //Position: 0x3F7D / 16253
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_78(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6) //Position: 0x3FC5 / 16325
{
	char* cVar0[64];
	...
	switch (uParam1)
	{
		case 0x00000000:
			...
			{
				CUTSCENE_MANAGER_LOAD_CUTFILE(&uParam0, 0, 0, 0, 0, 0);
				uParam1 = 1;
			}
			break;
...
void Function_79() //Position: 0x4154 / 16724
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
		{
			...
			Function_80(StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (Var1 + 180.0f), (Var5 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_80(char* cParam0) //Position: 0x41A8 / 16808
{
	char* cVar0[64];
...
bool Function_81(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x42D1 / 17105
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	{
		uParam1 = CREATE_OBJECTSET_IN_LAYOUT(Function_141(), &uParam0, 4294967295, 1);
		bVar0 = false;
		while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
		{
			if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
			{
				...
				if (!STRING_CONTAINS_STRING(&cVar21, "x_") && STRING_CONTAINS_STRING(&cVar21, &bParam3))
				{
					Function_105(&iParam2, CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0), 0, 0);
	...
	if (Function_108(&iParam2))
	{
		...
		while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
		{
			if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &Var1, &Var3))
			{
				cVar22 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
				strcpy(&cVar5, &cVar22, 64);
				if (STRING_CONTAINS_STRING(&cVar22, &bParam3))
				{
					uVar23 = "";
					if (!STRING_CONTAINS_STRING(&cVar22, "x_"))
					{
						uVar23 = CREATE_PROP_IN_LAYOUT(&uParam0, &cVar22, &cVar22, Var1, Var3, true);
					}
					else
					{
						iVar24 = Function_82(&cVar22);
						uVar23 = CREATE_PROP_IN_LAYOUT(&uParam0, &cVar5, &iVar24, Var1, Var3, true);
					}
					if (IS_OBJECT_VALID(&uVar23))
					{
						ADD_OBJECT_TO_OBJECTSET(&uVar23, &uParam1);
					}
				}
			}
			bVar0++;
...
var Function_82(int iParam0) //Position: 0x4412 / 17426
{
	bool bVar0;
	var uVar1;
	var uVar3;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_PROPS())
	{
		...
		if (CUTSCENE_MANAGER_GET_CUTSCENE_PROP_BY_INDEX_START_ORIENT(bVar0, &uVar1, &uVar3))
		{
			uVar5 = CUTSCENE_MANAGER_GET_CUTSCENE_PROP_NAME(bVar0);
			if (STRING_CONTAINS_STRING(&iParam0, &uVar5) && !STRING_CONTAINS_STRING(&uVar5, "x_"))
			{
				return &uVar5;
			}
		}
...
int Function_83() //Position: 0x446E / 17518
{
	bool bVar0;
	var uVar1;
	var uVar3;
...
int Function_84(var uParam0, var uParam1, int iParam2) //Position: 0x449D / 17565
{
...
void Function_85(var uParam0, bool bParam1) //Position: 0x44CD / 17613
{
	int iVar0;
...
bool Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4518 / 17688
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x46F7 / 18167
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_88(var uParam0, bool bParam1) //Position: 0x4C37 / 19511
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_89(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4C59 / 19545
{
	var uVar0;
...
var Function_90(bool bParam0, int iParam1) //Position: 0x4CBA / 19642
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x4D48 / 19784
{
	Function_93(&uParam0);
	Function_92(&uParam0);
...
void Function_92(int iParam0) //Position: 0x4D74 / 19828
{
...
void Function_93(int iParam0) //Position: 0x4D9A / 19866
{
...
bool Function_94(bool bParam0) //Position: 0x4E70 / 20080
{
...
var Function_95(int iParam0, int iParam1) //Position: 0x4E87 / 20103
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x4F2D / 20269
{
	var uVar0;
	var uVar1;
...
void Function_97(var uParam0) //Position: 0x503C / 20540
{
	int iVar0;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x506F / 20591
{
	int iVar0;
...
bool Function_99(int iParam0, struct<2> Param1, float fParam3) //Position: 0x508C / 20620
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_100() //Position: 0x5118 / 20760
{
	var uVar0;
	int iVar1;
...
bool Function_101(int iParam0) //Position: 0x5188 / 20872
{
...
bool Function_102(int iParam0) //Position: 0x51A4 / 20900
{
...
var Function_103(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x51BA / 20922
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_104(struct<205> Param0) //Position: 0x5260 / 21088
{
	var uVar0;
	var uVar1;
...
var Function_105(struct<2>[] Param0, int iParam1, int iParam2, bool bParam3) //Position: 0x536B / 21355
{
	int iVar0;
	int iVar1;
	...
	iVar1 = GET_ASSET_ID(&iParam1, iParam2);
...
void Function_106(struct<13> Param0) //Position: 0x53A9 / 21417
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_107(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x53BC / 21436
{
	int iVar0;
...
bool Function_108(struct<2>[] Param0) //Position: 0x548B / 21643
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x584D / 22605
{
	if (!Function_156(128))
	{
		return;
...
bool Function_110() //Position: 0x588D / 22669
{
	int iVar0;
...
void Function_111() //Position: 0x58BB / 22715
{
	if (!Function_156(128))
	{
		return;
...
void Function_112(vector3 vParam0) //Position: 0x58FD / 22781
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x5995 / 22933
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x59C4 / 22980
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x5A1F / 23071
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x5A2F / 23087
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5A43 / 23107
{
	int iVar0;
...
var Function_118() //Position: 0x5A68 / 23144
{
	return "PackedMetadata";
}

void Function_119(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5A7F / 23167
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_120() //Position: 0x5BBB / 23483
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_121() //Position: 0x5BCD / 23501
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_122() //Position: 0x5BDF / 23519
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_123(var uParam0, struct<5> Param1) //Position: 0x5BF1 / 23537
{
...
var Function_124(var uParam0, int iParam1, int iParam2) //Position: 0x5C16 / 23574
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x5C35 / 23605
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_126() //Position: 0x5C41 / 23617
{
	return Function_127(39);
}

int Function_127(int iParam0) //Position: 0x5C4C / 23628
{
	int iVar0;
...
var Function_128() //Position: 0x5C7A / 23674
{
	return "PackedWeapon";
}

int Function_129(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x5C8F / 23695
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_130() //Position: 0x5D9C / 23964
{
	return "MPItemGiver";
}

struct<32> Function_131(char* cParam0) //Position: 0x5DB0 / 23984
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0) //Position: 0x5E1C / 24092
{
	char* cVar0[32];
...
var Function_133() //Position: 0x5E3E / 24126
{
	return "PBox_";
}

var Function_134() //Position: 0x5E4C / 24140
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x5E72 / 24178
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5E9A / 24218
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(var uParam0, int iParam1) //Position: 0x5EC0 / 24256
{
	int iVar0;
	var uVar1;
...
void Function_138(int iParam0, var uParam1, struct<2> Param2) //Position: 0x602A / 24618
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x60D2 / 24786
{
	int iVar0;
	struct<2> Var1;
...
void Function_140(int iParam0) //Position: 0x6240 / 25152
{
...
var Function_141() //Position: 0x62A8 / 25256
{
	int iVar0;
...
var Function_142(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x62B1 / 25265
{
	return Function_143(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_143(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x62CF / 25295
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x65C8 / 26056
{
	int iVar0;
...
void Function_145() //Position: 0x667C / 26236
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x66B7 / 26295
{
	int iVar0;
...
void Function_147(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x66E4 / 26340
{
	bool bVar0;
...
void Function_148() //Position: 0x683F / 26687
{
	int iVar0;
...
var Function_149(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x688B / 26763
{
	int iVar0;
...
int Function_150() //Position: 0x6967 / 26983
{
	int iVar0;
...
int Function_151() //Position: 0x6AC3 / 27331
{
	int iVar0;
...
bool Function_152(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6BE3 / 27619
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_153(struct<2> Param0) //Position: 0x6CBF / 27839
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_154(struct<2> Param0, struct<5> Param2) //Position: 0x6CDE / 27870
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_155(int iParam0) //Position: 0x6E21 / 28193
{
	var uVar0;
...
bool Function_156(int iParam0) //Position: 0x6E43 / 28227
{
	int iVar0;
...
int Function_157() //Position: 0x6E5F / 28255
{
	return 0;
}

void Function_158(struct<321> Param0) //Position: 0x6E66 / 28262
{
	var uVar0;
