...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar1 + 360) = 2;
	if (bVar0)
	{
		Function_116(&iVar1, "$/fragments/p_gen_campFireCombined01x", "$/tune/refGroups/campsiteSets/cam_campRebel01x");
	}
...
void Function_1(struct<473> Param0) //Position: 0x103 / 259
{
	int iVar0;
...
void Function_2() //Position: 0x2B1 / 689
{
	return;
}

void Function_3() //Position: 0x2B7 / 695
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2C0 / 704
{
...
void Function_5(int iParam0) //Position: 0x2D3 / 723
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x2FB / 763
{
...
void Function_7(struct<13> Param0) //Position: 0x446 / 1094
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x463 / 1123
{
	int iVar0;
...
var Function_9(struct<477> Param0) //Position: 0x481 / 1153
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_32 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_110(&Param0 + 324, &fLocal_34, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_98(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_34, 20.0f, fLocal_34));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_35(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_35, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_10(struct<62> Param0) //Position: 0x1640 / 5696
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1652 / 5714
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
bool Function_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x188B / 6283
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_13(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x18AB / 6315
{
	int iVar0;
	var uVar1;
...
int Function_14(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x1999 / 6553
{
	char* cVar0[32];
...
int Function_15(int iParam0) //Position: 0x1C05 / 7173
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_16(var uParam0, bool bParam1) //Position: 0x1C29 / 7209
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(var uParam0, int iParam1) //Position: 0x1C4D / 7245
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_18(var uParam0, bool bParam1) //Position: 0x1C73 / 7283
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1C9A / 7322
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1CBE / 7358
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1CDD / 7389
{
...
bool Function_22(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1D2C / 7468
{
	int iVar0;
	var uVar1;
...
bool Function_23(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1D88 / 7560
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_24(var uParam0, int iParam1) //Position: 0x1DA9 / 7593
{
	int iVar0;
	var uVar1;
...
void Function_25(var uParam0, var uParam1, bool bParam2) //Position: 0x1E04 / 7684
{
	int iVar0;
	var uVar1;
...
var Function_26() //Position: 0x1E50 / 7760
{
...
void Function_27(struct<425> Param0) //Position: 0x1E65 / 7781
{
	int iVar0;
	int iVar1;
...
bool Function_28(var uParam0, struct<2> Param1, float fParam3) //Position: 0x1FB8 / 8120
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_29(int iParam0) //Position: 0x202D / 8237
{
	struct<2> Var0;
...
bool Function_30(vector3 vParam0) //Position: 0x2099 / 8345
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(var uParam0) //Position: 0x20B1 / 8369
{
	int iVar0;
	int iVar1;
...
var Function_32(bool bParam0) //Position: 0x210F / 8463
{
	bool bVar0;
	int iVar1;
...
void Function_33(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x215C / 8540
{
	int iVar0;
	var uVar1;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x21D5 / 8661
{
	int iVar0;
	var uVar1;
...
bool Function_35(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x2224 / 8740
{
	float fVar0;
...
void Function_36(int iParam0) //Position: 0x23ED / 9197
{
...
void Function_37(int iParam0) //Position: 0x242A / 9258
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2443 / 9283
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(var uParam0, int iParam1) //Position: 0x2450 / 9296
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_40(var uParam0) //Position: 0x2545 / 9541
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x2604 / 9732
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(struct<25> Param0) //Position: 0x2617 / 9751
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_43(int iParam0) //Position: 0x26DE / 9950
{
...
bool Function_44(int iParam0) //Position: 0x26FE / 9982
{
...
bool Function_45(int iParam0) //Position: 0x2722 / 10018
{
...
bool Function_46(int iParam0) //Position: 0x2737 / 10039
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x274E / 10062
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x278C / 10124
{
...
bool Function_49(int iParam0) //Position: 0x27A6 / 10150
{
...
int Function_50(int iParam0, struct<6> Param1) //Position: 0x27BC / 10172
{
	int iVar0;
...
void Function_51(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x27F6 / 10230
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_52(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x28DB / 10459
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_53(var uParam0, bool bParam1) //Position: 0x2A92 / 10898
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x2AB7 / 10935
{
	var uVar0;
	int iVar1;
...
var Function_55(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2B05 / 11013
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2C5C / 11356
{
	var uVar0[5];
	int iVar6;
...
int Function_57(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2D07 / 11527
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2DAD / 11693
{
	if (Function_59(&iParam1))
	{
		*(&iParam0 + 24) = &iLocal_0;
		DECOR_SET_OBJECT(GET_OBJECT_FROM_GRINGO(GRINGO_GET_MY_GRINGO_ID()), "gringoLayout", &iParam0 + 24);
...
bool Function_59(var uParam0) //Position: 0x2E06 / 11782
{
	var uVar0;
	...
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/digging", 1, 0);
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/horse_tend", 1, 0);
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/lean_table", 1, 0);
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/Pee", 1, 0);
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/Rand_Idle_Sit_Ground", 1, 0);
	Function_61(&iLocal_0 + 8, "$/content/scripting/gringo/SimpleGringo/stand_lookdistance_w_any", 1, 0);
	if (!Function_65(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_98()));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "shooter1", Vector(1,501631f, 0.0f, 5,109672f), Vector(0.0f, 178,8169f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "shooter2", Vector(0,1107956f, 0.0f, 5,080949f), Vector(0.0f, 180,1217f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "shooter3", Vector(-1,051004f, 0.0f, 5,056956f), Vector(0.0f, 180,8044f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target16", Vector(2,496888f, 1,056212f, 14,24056f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target15", Vector(2,030904f, 1,061306f, 14,5414f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target14", Vector(1,865656f, 1,080628f, 14,23427f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target13", Vector(1,687267f, 1,136276f, 14,24967f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target12", Vector(1,30177f, 0,9304508f, 14,51594f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target11", Vector(1,19593f, 0,8951195f, 14,22565f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target10", Vector(0,9536536f, 0,8545251f, 15,00356f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target9", Vector(0,5709574f, 0,8607488f, 14,32035f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target8", Vector(0,3649621f, 0,8303215f, 14,2357f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target7", Vector(-0,2429519f, 0,9919534f, 14,2269f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target6", Vector(-0,4631887f, 1,057899f, 14,1779f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target5", Vector(-0,7470617f, 1,030867f, 14,54287f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target4", Vector(-1,434959f, 1,106331f, 14,12983f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target3", Vector(-1,287048f, 0,9807302f, 14,4564f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target2", Vector(-2,099566f, 0,9078563f, 14,18787f), Vector(0.0f, 0.0f, 0.0f));
	CREATE_POINT_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "target1", Vector(2,234324f, 1,121726f, 14,5636f), Vector(0.0f, 0.0f, 0.0f));
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "campfire_talk", "campfire_talk", Vector(5,44575f, 0.0f, 0,5628713f), Vector(0.0f, 55,83191f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "digging", "digging", Vector(9,57904f, 0.0f, 10,33677f), Vector(0.0f, -105,8149f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend", "horse_tend", Vector(-7,454279f, 0.0f, -5,715081f), Vector(0.0f, -121,2826f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend1", "horse_tend", Vector(8,228367f, 0.0f, -7,615363f), Vector(0.0f, 132,7843f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "lean_table", "lean_table", Vector(7,370644f, 0.0f, -1,7649f), Vector(0.0f, 28,40776f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "lean_table1", "lean_table", Vector(-5,142337f, 0.0f, 8,105992f), Vector(0.0f, 48,25124f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Pee", "Pee", Vector(-10,70836f, 0.0f, 5,277891f), Vector(0.0f, 86,95214f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground", "Rand_Idle_Sit_Ground", Vector(6,561553f, 0.0f, 2,366916f), Vector(0.0f, 39,84533f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Rand_Idle_Sit_Ground1", "Rand_Idle_Sit_Ground", Vector(4,992314f, 0.0f, 2,509163f), Vector(0.0f, -10,87477f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "stand_lookdistance_w_any", "stand_lookdistance_w_any", Vector(3,302554f, 0.0f, 4,104522f), Vector(0.0f, 165,1223f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	Function_60(&iLocal_0, &uParam0);
	return 1;
}

void Function_60(int iParam0, int iParam1) //Position: 0x359A / 13722
{
	int iVar0;
...
var Function_61(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x35E5 / 13797
{
	int iVar0;
	int iVar1;
...
void Function_62(struct<13> Param0) //Position: 0x3623 / 13859
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_63(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x3636 / 13878
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3705 / 14085
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_65(struct<2>[] Param0) //Position: 0x374F / 14159
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3B11 / 15121
{
	if (!Function_117(128))
	{
		return;
...
bool Function_67() //Position: 0x3B51 / 15185
{
	int iVar0;
...
void Function_68() //Position: 0x3B7F / 15231
{
	if (!Function_117(128))
	{
		return;
...
void Function_69(vector3 vParam0) //Position: 0x3BC1 / 15297
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3C59 / 15449
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3C88 / 15496
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3CE3 / 15587
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3CF3 / 15603
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3D07 / 15623
{
	int iVar0;
...
var Function_75() //Position: 0x3D2C / 15660
{
	return "PackedMetadata";
}

void Function_76(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3D43 / 15683
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3E7F / 15999
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_78() //Position: 0x3E91 / 16017
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_79() //Position: 0x3EA3 / 16035
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_80(var uParam0, struct<5> Param1) //Position: 0x3EB5 / 16053
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3EDA / 16090
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3EF9 / 16121
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3F05 / 16133
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3F10 / 16144
{
	int iVar0;
...
var Function_85() //Position: 0x3F3E / 16190
{
	return "PackedWeapon";
}

int Function_86(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3F53 / 16211
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_87() //Position: 0x4061 / 16481
{
	return "MPItemGiver";
}

struct<32> Function_88(char* cParam0) //Position: 0x4075 / 16501
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0) //Position: 0x40E1 / 16609
{
	char* cVar0[32];
...
var Function_90() //Position: 0x4103 / 16643
{
	return "PBox_";
}

var Function_91() //Position: 0x4111 / 16657
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x4137 / 16695
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x415F / 16735
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x4185 / 16773
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, struct<2> Param2) //Position: 0x42EF / 17135
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x4397 / 17303
{
	int iVar0;
	struct<2> Var1;
...
void Function_97(int iParam0) //Position: 0x4505 / 17669
{
...
var Function_98() //Position: 0x456D / 17773
{
	int iVar0;
...
var Function_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x4576 / 17782
{
	return Function_100(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_100(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x4594 / 17812
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x488D / 18573
{
	int iVar0;
...
void Function_102() //Position: 0x4941 / 18753
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x497C / 18812
{
	int iVar0;
...
void Function_104(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x49A9 / 18857
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4B04 / 19204
{
...
void Function_106() //Position: 0x4B1B / 19227
{
	int iVar0;
...
var Function_107(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4B67 / 19303
{
	int iVar0;
...
int Function_108() //Position: 0x4C43 / 19523
{
	int iVar0;
...
int Function_109() //Position: 0x4D9F / 19871
{
	int iVar0;
...
bool Function_110(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4EBF / 20159
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_111(struct<2> Param0) //Position: 0x4F9B / 20379
{
	struct<2> Var0;
	int iVar2;
...
bool Function_112(struct<2> Param0, struct<5> Param2) //Position: 0x4FBA / 20410
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
float Function_113(var uParam0, struct<2> Param1) //Position: 0x50FD / 20733
{
	struct<2> Var0;
...
bool Function_114(int iParam0) //Position: 0x5174 / 20852
{
	var uVar0;
...
int Function_115() //Position: 0x5196 / 20886
{
	return 0;
}

void Function_116(struct<321> Param0) //Position: 0x519D / 20893
{
	var uVar0;
...
bool Function_117(int iParam0) //Position: 0x522F / 21039
{
	int iVar0;
