...
{
	ENABLE_MOVER(&uLocal_17);
	RELEASE_LAYOUT_REF(&uLocal_23);
	Function_4(8, &uLocal_17, &iLocal_19, &uLocal_3, &uLocal_21, 4294967295);
	return;
}

void Function_4(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) //Position: 0x25C / 604
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_5(var uParam0, bool bParam1) //Position: 0x6CE / 1742
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x702 / 1794
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_7(var uParam0) //Position: 0xA44 / 2628
{
	int iVar0;
...
void Function_8(int iParam0) //Position: 0xA77 / 2679
{
...
void Function_9(int iParam0) //Position: 0xA8E / 2702
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xABA / 2746
{
	int iVar0;
...
bool Function_11(int iParam0, int iParam1) //Position: 0xAD4 / 2772
{
	int iVar0;
...
void Function_12(float fParam0, float fParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6) //Position: 0xAF1 / 2801
{
	var uVar0;
	bool bVar1;
...
bool Function_13(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xBB7 / 2999
{
	float fVar0;
...
void Function_14(int iParam0) //Position: 0xD80 / 3456
{
...
void Function_15(int iParam0) //Position: 0xDBD / 3517
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xDD6 / 3542
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(var uParam0, int iParam1) //Position: 0xDE3 / 3555
{
	struct<2> Var0;
	struct<2> Var2;
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xED8 / 3800
{
	var uVar0;
	int iVar1;
...
bool Function_19(var uParam0, int iParam1) //Position: 0xF3E / 3902
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void Function_20(int iParam0) //Position: 0xFA0 / 4000
{
	bool bVar0;
...
int Function_21(struct<209> Param0) //Position: 0xFD5 / 4053
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(var uParam0, struct<2> Param1) //Position: 0x11EE / 4590
{
	struct<2> Var0;
...
struct<8> Function_23(int iParam0) //Position: 0x1265 / 4709
{
	struct<2> Var0;
...
void Function_24(int iParam0) //Position: 0x12D1 / 4817
{
	int iVar0;
...
void Function_25(struct<2>[] Param0, int iParam1) //Position: 0x12F9 / 4857
{
...
void Function_26(struct<13> Param0) //Position: 0x1444 / 5188
{
	int iVar0;
...
bool Function_27(struct<13> Param0) //Position: 0x1461 / 5217
{
	int iVar0;
...
var Function_28(struct<477> Param0) //Position: 0x147F / 5247
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_25 || bParam2) || Global_6611)
			{
				if (Function_150(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_148(&Param0 + 324, &fLocal_27, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_137(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_27, 20.0f, fLocal_27));
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_28, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_29(struct<62> Param0) //Position: 0x263E / 9790
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2650 / 9808
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2889 / 10377
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28A9 / 10409
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2997 / 10647
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2C03 / 11267
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C27 / 11303
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C4B / 11339
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C71 / 11377
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2C98 / 11416
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CBC / 11452
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CDB / 11483
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D2A / 11562
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D86 / 11654
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DA7 / 11687
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2E02 / 11778
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E4E / 11854
{
...
void Function_46(struct<425> Param0) //Position: 0x2E63 / 11875
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FB6 / 12214
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x302B / 12331
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x3043 / 12355
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x30A1 / 12449
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30EE / 12526
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x3167 / 12647
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31B6 / 12726
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x3275 / 12917
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3288 / 12936
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x334F / 13135
{
...
bool Function_57(int iParam0) //Position: 0x336F / 13167
{
...
bool Function_58(int iParam0) //Position: 0x3393 / 13203
{
...
bool Function_59(int iParam0) //Position: 0x33A8 / 13224
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33BF / 13247
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x33FD / 13309
{
...
bool Function_62(int iParam0) //Position: 0x3417 / 13335
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x342D / 13357
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3467 / 13415
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x354C / 13644
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void Function_66(var uParam0, bool bParam1) //Position: 0x3703 / 14083
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3728 / 14120
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3776 / 14198
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38CD / 14541
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3978 / 14712
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A1E / 14878
{
	Function_101(&uLocal_3, "sobbing", 5, 0);
	Function_101(&uLocal_3, "custom/sobbing", 8, 0);
	Function_145(&uLocal_3, 1199, 3, 0);
	if (Function_82(&uLocal_17, &uLocal_3, 35, 1, 1, 0, 0, 0, 0, 0, 0))
	{
		if (Function_80(&uLocal_23, "mexgirl03mobile", &iParam1))
		{
			iLocal_19 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_23, Function_137()));
			*(&Global_6667[3528] + 216) = &iLocal_19;
...
void Function_72() //Position: 0x3ABD / 15037
{
	struct<2> Var0;
	int iVar2;
	
	uLocal_21 = CREATE_LAYOUT("mexgirlcamp01campfirelayout");
	Var0 = Vector(-2146,16f, 18,261f, 4964,794f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_17, Var0, 0.0f, 1, 1, 1);
	SUSPEND_MOVER(&uLocal_17);
	TASK_STAND_STILL(&uLocal_17, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(&uLocal_17, "sobbing", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uLocal_17, "sobbing/sobbing");
	Function_78(&uLocal_17, &iLocal_19, 1, 0);
	if (!Function_77("MexGirl03Wagon", &iVar2, &uLocal_21, 0))
	{
		iVar2 = Function_73(StackVal, StackVal, &uLocal_21, "MexGirl03Wagon", 1199, 977, Vector(-2169,263f, 17,372f, 4944,214f), Vector(0.0f, -3.0f, 0.0f), 1, 976, 976, 976, 4);
	}
	Function_78(&iVar2, &iLocal_19, 1, 1);
	return;
}

int Function_73(var uParam0, var uParam1, bool bParam2, int iParam3, struct<2> Param4, struct<2> Param6, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x3BB7 / 15287
{
	var uVar0;
	int iVar1[6];
	bool bVar8;
...
bool Function_74(int iParam0, bool[] bParam1) //Position: 0x3E0A / 15882
{
	int iVar0;
...
var Function_75(var uParam0, struct<2> Param1, var uParam3, var uParam4, var uParam5) //Position: 0x3E3E / 15934
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(&uParam0, &uParam3, &uParam4, &uParam5, 1,401298E-45f, Param1);
}

int Function_76(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3E5A / 15962
{
...
bool Function_77(var uParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x3E86 / 16006
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_78(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3FB6 / 16310
{
	bool bVar0;
	int iVar1;
...
bool Function_79(int iParam0, int iParam1, bool bParam2) //Position: 0x4174 / 16756
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x41BC / 16828
{
...
void Function_81(var uParam0, bool bParam1) //Position: 0x41EC / 16876
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4237 / 16951
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4416 / 17430
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_84(var uParam0, bool bParam1) //Position: 0x4956 / 18774
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_85(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4978 / 18808
{
	var uVar0;
...
var Function_86(bool bParam0, int iParam1) //Position: 0x49D9 / 18905
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x4A67 / 19047
{
	Function_89(&uParam0);
	Function_88(&uParam0);
...
void Function_88(int iParam0) //Position: 0x4A93 / 19091
{
...
void Function_89(int iParam0) //Position: 0x4AB9 / 19129
{
...
bool Function_90(bool bParam0) //Position: 0x4B8F / 19343
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x4BA6 / 19366
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4C4C / 19532
{
	var uVar0;
	var uVar1;
...
void Function_93(var uParam0) //Position: 0x4D5B / 19803
{
	int iVar0;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x4D8E / 19854
{
	int iVar0;
...
bool Function_95(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4DAB / 19883
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_96() //Position: 0x4E37 / 20023
{
	var uVar0;
	int iVar1;
...
bool Function_98(int iParam0) //Position: 0x4EC3 / 20163
{
...
var Function_99(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4ED9 / 20185
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(struct<205> Param0) //Position: 0x4F7F / 20351
{
	var uVar0;
	var uVar1;
...
var Function_101(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x508A / 20618
{
	int iVar0;
	int iVar1;
...
void Function_102(struct<13> Param0) //Position: 0x50C8 / 20680
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_103(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x50DB / 20699
{
	int iVar0;
...
bool Function_104(struct<2>[] Param0) //Position: 0x51AA / 20906
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x556C / 21868
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x55AC / 21932
{
	int iVar0;
...
void Function_107() //Position: 0x55DA / 21978
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(vector3 vParam0) //Position: 0x561C / 22044
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x56B4 / 22196
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x56E3 / 22243
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x573E / 22334
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x574E / 22350
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5762 / 22370
{
	int iVar0;
...
var Function_114() //Position: 0x5787 / 22407
{
	return "PackedMetadata";
}

void Function_115(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x579E / 22430
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_116() //Position: 0x58DA / 22746
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_117() //Position: 0x58EC / 22764
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_118() //Position: 0x58FE / 22782
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_119(var uParam0, struct<5> Param1) //Position: 0x5910 / 22800
{
...
var Function_120(var uParam0, int iParam1, int iParam2) //Position: 0x5935 / 22837
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x5954 / 22868
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_122() //Position: 0x5960 / 22880
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x596B / 22891
{
	int iVar0;
...
var Function_124() //Position: 0x5999 / 22937
{
	return "PackedWeapon";
}

int Function_125(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x59AE / 22958
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_126() //Position: 0x5ABB / 23227
{
	return "MPItemGiver";
}

struct<32> Function_127(char* cParam0) //Position: 0x5ACF / 23247
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0) //Position: 0x5B3B / 23355
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5B5D / 23389
{
	return "PBox_";
}

var Function_130() //Position: 0x5B6B / 23403
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5B91 / 23441
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x5BB9 / 23481
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5BDF / 23519
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5D49 / 23881
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x5DF1 / 24049
{
	int iVar0;
	struct<2> Var1;
...
void Function_136(int iParam0) //Position: 0x5F5F / 24415
{
...
var Function_137() //Position: 0x5FC7 / 24519
{
	int iVar0;
...
var Function_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5FD0 / 24528
{
	return Function_139(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_139(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5FEE / 24558
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x62E7 / 25319
{
	int iVar0;
...
void Function_141() //Position: 0x639B / 25499
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x63D6 / 25558
{
	int iVar0;
...
void Function_143(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x6403 / 25603
{
	bool bVar0;
...
void Function_144() //Position: 0x655E / 25950
{
	int iVar0;
...
var Function_145(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x65AA / 26026
{
	int iVar0;
...
int Function_146() //Position: 0x6686 / 26246
{
	int iVar0;
...
int Function_147() //Position: 0x67E2 / 26594
{
	int iVar0;
...
bool Function_148(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x6902 / 26882
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_149(struct<2> Param0) //Position: 0x69DE / 27102
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_150(struct<2> Param0, struct<5> Param2) //Position: 0x69FD / 27133
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_151(int iParam0) //Position: 0x6B40 / 27456
{
	var uVar0;
...
bool Function_152(int iParam0) //Position: 0x6B62 / 27490
{
	int iVar0;
...
int Function_153() //Position: 0x6B7E / 27518
{
	return 0;
}

void Function_154(struct<321> Param0) //Position: 0x6B85 / 27525
{
	var uVar0;
