...
void main() //Position: 0x0 / 0
{
	...
	bLocal_340 = false;
	iLocal_341 = 0;
	Local_342 = Vector(-1863,867f, 23,779f, 3289,06f);
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Function_164(&(Global_99725[ScriptParam_043]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 4;
						break;
					
					case 0x00000004:
						if (Function_123("$/cutscene/RCM_32_CS02/RCM_32_CS02", &iLocal_326, 29748, 29690, 28387, 28272, 27863, 27847, 1, 1, 2, 2, 0))
						{
					...
					case 0x00000005:
						Function_122(&Global_99725[ScriptParam_043] + 228, 32);
						Function_113(&uLocal_338, &Global_99725[ScriptParam_043] + 320, "UseCase1", 4294967295, 1, 2);
						Function_111("Remember2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
						iLocal_345 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
						bLocal_346 = false;
						while (bLocal_346 <= iLocal_345)
						{
							SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_99725[ScriptParam_043].f_224, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_99725[ScriptParam_043].f_224, bLocal_346), 4, 0);
							bLocal_346++;
						}
						APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "Remember2_OBJ", 0, 3, false);
						Function_110(Global_99725[ScriptParam_043].f_224, 0);
						Function_26(65, 1, 1, 0);
						Function_4(Global_46866[5]);
						ACTOR_DATA_GRAVITY_LIMIT(0);
						Function_122(&Global_99725[ScriptParam_043] + 228, 128);
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x250 / 592
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x282 / 642
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x29F / 671
{
	RELEASE_LAYOUT_REF(&iLocal_355);
	return;
}

void Function_4(int iParam0) //Position: 0x2AC / 684
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	if (Function_25(&(Global_43791[iParam0]), 4096))
	{
		return;
	}
	Function_24(&(Global_43791[iParam0]), 4096);
	if (StackVal != 1)
	{
		Function_10(473, 1, 0, 0);
		iVar0 = Function_8(iParam0);
		if (iVar0 == Global_46722[0])
		{
			Function_10(474, 1, 0, 0);
		}
		else if (iVar0 == Global_46722[1])
		{
			Function_10(475, 1, 0, 0);
		}
		else if (iVar0 == Global_46722[2])
		{
			Function_10(476, 1, 0, 0);
		}
	}
	...
	if (iVar2 < 10)
	{
		Function_7(iVar2, iVar1);
	}
	else if (iParam0 == Global_46926[9])
	{
		Function_7(7, 30);
	}
	if (Function_6(473) <= Function_5(473))
	{
...
float Function_5(int iParam0) //Position: 0x39D / 925
{
...
float Function_6(int iParam0) //Position: 0x3DA / 986
{
	if (!iParam0 != 4294967295)
	{
...
void Function_7(int iParam0, int iParam1) //Position: 0x413 / 1043
{
	bool bVar0;
...
var Function_8(int iParam0) //Position: 0x47D / 1149
{
	int iVar0;
...
bool Function_9(int iParam0) //Position: 0x4D5 / 1237
{
...
int Function_10(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x4EB / 1259
{
	int iVar0;
	int iVar1;
...
void Function_11(bool bParam0) //Position: 0x713 / 1811
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_12(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x7B1 / 1969
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
	...
	switch (Global_55480[iParam016].f_96)
	{
		...
		case 0x0000000F:
			if (iParam0 == 390)
			{
				...
				stradd(&Global_55480[iParam016] + 32, INT_TO_STRING(FLOOR(Function_5(390))), 32);
			}
			break;
	}
	CLEAR_STAT_MESSAGE();
	if (!Global_77928)
	{
		...
		switch (Global_55480[iParam016].f_96)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_6(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_14(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_13(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_13() //Position: 0xDEF / 3567
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0xDF8 / 3576
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_15(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xE09 / 3593
{
	char* cVar0[32];
...
struct<32> Function_16(char* cParam0) //Position: 0xF00 / 3840
{
	char* cVar0[32];
...
void Function_17(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0xF1B / 3867
{
	float fVar0;
...
var Function_18(int iParam0, int iParam1) //Position: 0xF82 / 3970
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_19(int iParam0, bool bParam1) //Position: 0xF94 / 3988
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_20(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0xFA6 / 4006
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_21(int iParam0) //Position: 0x10DA / 4314
{
	return Global_55480[iParam016].f_96;
}

void Function_22(int iParam0) //Position: 0x10E9 / 4329
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_23(int iParam0, bool bParam1, bool bParam2) //Position: 0x1283 / 4739
{
	int iVar0;
	int iVar1;
...
void Function_24(var uParam0, int iParam1) //Position: 0x14C7 / 5319
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_25(var uParam0, int iParam1) //Position: 0x14D8 / 5336
{
	int iVar0;
...
void Function_26(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x14F5 / 5365
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_27(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1A8D / 6797
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_28() //Position: 0x1C2E / 7214
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1C34 / 7220
{
	if (Global_6624)
	{
		return;
...
void Function_30(bool bParam0) //Position: 0x1C73 / 7283
{
...
void Function_31() //Position: 0x1CC8 / 7368
{
	Function_45();
	Function_44();
	Function_44();
...
void Function_32() //Position: 0x1D13 / 7443
{
...
void Function_33() //Position: 0x1E19 / 7705
{
	float fVar0;
...
void Function_34() //Position: 0x1E4C / 7756
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_35() //Position: 0x1FDF / 8159
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_36() //Position: 0x2198 / 8600
{
	Function_37(&Global_42918, 1, 0);
	return;
}

void Function_37(struct<2317> Param0) //Position: 0x21A6 / 8614
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_38() //Position: 0x23C3 / 9155
{
...
struct<8> Function_39(int iParam0) //Position: 0x23D8 / 9176
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_40(int iParam0, bool bParam1, bool bParam2) //Position: 0x247F / 9343
{
	int iVar0;
...
int Function_41(bool bParam0) //Position: 0x271B / 10011
{
...
struct<8> Function_42() //Position: 0x275C / 10076
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_43() //Position: 0x27E5 / 10213
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_44() //Position: 0x287C / 10364
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_45() //Position: 0x28FB / 10491
{
...
int Function_46(int iParam0, bool bParam1, int iParam2) //Position: 0x2938 / 10552
{
	int iVar0;
	int iVar1;
...
void Function_47() //Position: 0x2B44 / 11076
{
	struct<2> Var0;
	var uVar2;
...
bool Function_48(char* cParam0) //Position: 0x2BFB / 11259
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_49(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2C13 / 11283
{
	int iVar0;
...
struct<8> Function_50() //Position: 0x2D0B / 11531
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_51(int iParam0) //Position: 0x2D15 / 11541
{
...
int Function_52(bool bParam0, bool bParam1) //Position: 0x2D2B / 11563
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_53(struct<2> Param0, struct<2> Param2) //Position: 0x2DF7 / 11767
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_54(float fParam0, int iParam1) //Position: 0x2E14 / 11796
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_55(int iParam0) //Position: 0x3640 / 13888
{
	var uVar0;
...
bool Function_56(var uParam0, int iParam1) //Position: 0x367B / 13947
{
	return (uParam0 && iParam1) == 0;
}

void Function_57(var uParam0, int iParam1) //Position: 0x3688 / 13960
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_58(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3697 / 13975
{
	uParam0 = &uParam0;
...
void Function_59(bool bParam0) //Position: 0x3746 / 14150
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_56(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_122(&Global_99725[iVar143] + 228, 64);
...
void Function_60(struct<229> Param0) //Position: 0x3900 / 14592
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_13(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_61(&Param0);
...
void Function_61(struct<217> Param0) //Position: 0x39D0 / 14800
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_13(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_13(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_62(&uVar1, 0);
	return;
}

int Function_62(var uParam0, int iParam1) //Position: 0x3A8E / 14990
{
	int iVar0;
	var uVar1;
...
void Function_63(int iParam0, var uParam1, struct<2> Param2) //Position: 0x3BF8 / 15352
{
	struct<8> Var0;
...
struct<32> Function_64(char* cParam0) //Position: 0x3CA0 / 15520
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_65(char* cParam0) //Position: 0x3D0C / 15628
{
	char* cVar0[32];
...
int Function_66(int iParam0) //Position: 0x3D2E / 15662
{
	int iVar0;
	struct<2> Var1;
...
float Function_67(int iParam0, struct<2> Param1) //Position: 0x3E9C / 16028
{
	struct<2> Var0;
...
struct<8> Function_68(int iParam0) //Position: 0x3F13 / 16147
{
	struct<2> Var0;
...
void Function_69(int iParam0) //Position: 0x3F7F / 16255
{
...
void Function_70(struct<153> Param0) //Position: 0x3FE7 / 16359
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_71(int iParam0) //Position: 0x4157 / 16727
{
...
var Function_72(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4183 / 16771
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

bool Function_73(int iParam0) //Position: 0x41A4 / 16804
{
...
bool Function_74(struct<249> Param0) //Position: 0x41B9 / 16825
{
	...
	{
		Function_122(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
	...
	if (Function_9(Param0.f_216))
	{
		if (Function_25(&(Global_43791[Param0.f_216]), 256))
		{
			return 0;
		}
	}
...
bool Function_75(struct<265> Param0) //Position: 0x42E9 / 17129
{
	int iVar0;
...
bool Function_76(int iParam0) //Position: 0x444A / 17482
{
...
bool Function_77(int iParam0) //Position: 0x446E / 17518
{
...
bool Function_78(int iParam0) //Position: 0x4483 / 17539
{
...
var Function_79(int iParam0) //Position: 0x449A / 17562
{
...
bool Function_80(int iParam0) //Position: 0x44B4 / 17588
{
...
bool Function_81(int iParam0) //Position: 0x44CA / 17610
{
	return Global_116927[iParam06].f_16;
}

bool Function_82(var uParam0, int iParam1) //Position: 0x44DA / 17626
{
	int iVar0;
...
bool Function_83(struct<237> Param0) //Position: 0x44F7 / 17655
{
	if (!Param0.f_236)
	{
		if (Function_109())
...
bool Function_84(int iParam0) //Position: 0x45C6 / 17862
{
...
bool Function_85(int iParam0) //Position: 0x4621 / 17953
{
	int iVar0;
...
int Function_86(int iParam0) //Position: 0x463D / 17981
{
...
bool Function_87(int iParam0) //Position: 0x4652 / 18002
{
...
int Function_88(int iParam0) //Position: 0x4667 / 18023
{
...
void Function_89() //Position: 0x467C / 18044
{
...
int Function_90(int iParam0, int iParam1) //Position: 0x46FC / 18172
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_91(int iParam0, bool bParam1) //Position: 0x535F / 21343
{
	int iVar0;
...
int Function_92(int iParam0) //Position: 0x539D / 21405
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x53EC / 21484
{
...
int Function_94(int iParam0) //Position: 0x5402 / 21506
{
...
void Function_95() //Position: 0x546B / 21611
{
...
bool Function_96(int iParam0) //Position: 0x5490 / 21648
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x54E1 / 21729
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x550E / 21774
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x5560 / 21856
{
	int iVar0;
...
void Function_100() //Position: 0x559A / 21914
{
	bool bVar0;
...
void Function_101(int iParam0, int iParam1) //Position: 0x55F8 / 22008
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_102(int iParam0) //Position: 0x560E / 22030
{
	PRINTSTRING("Day ");
...
void Function_103(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5658 / 22104
{
	bool bVar0;
	char* cVar1[16];
...
void Function_104(char* cParam0) //Position: 0x56CD / 22221
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(int iParam0, var uParam1, int iParam2) //Position: 0x5707 / 22279
{
	var uVar0;
	char* cVar1[16];
...
int Function_106(char* cParam0) //Position: 0x5783 / 22403
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x5824 / 22564
{
	int iVar0;
	int iVar1;
...
bool Function_108(int iParam0, int iParam1) //Position: 0x5861 / 22625
{
...
bool Function_109() //Position: 0x5874 / 22644
{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x588F / 22671
{
	bool bVar0;
...
void Function_111(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x58B4 / 22708
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_112(int iParam0) //Position: 0x5949 / 22857
{
	char* cVar0[16];
...
int Function_113(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) //Position: 0x5988 / 22920
{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		Function_114(&uParam0, 5, GET_OBJECT_FROM_GRINGO(&uParam1), &uParam4, 1);
	}
	else
	{
		return 0;
...
int Function_114(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x5A35 / 23093
{
	char* cVar0[32];
	...
	Function_119(&uParam0, 0);
	Function_118(&uParam0, uParam1);
	Function_117(&uParam0, &uParam2);
	Function_116(&uParam0, uParam3);
	if (Function_115(&uParam0) != 5)
	{
...
int Function_115(int iParam0) //Position: 0x5CA1 / 23713
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_116(var uParam0, bool bParam1) //Position: 0x5CC5 / 23749
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5CE9 / 23785
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_118(var uParam0, bool bParam1) //Position: 0x5D0F / 23823
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_119(var uParam0, bool bParam1) //Position: 0x5D36 / 23862
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_120(bool bParam0) //Position: 0x5D5A / 23898
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_121() //Position: 0x5D79 / 23929
{
...
void Function_122(var uParam0, bool bParam1) //Position: 0x5DC8 / 24008
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5DD9 / 24025
{
	var uVar0;
	var uVar6;
	bool bVar7;
	...
	bVar7 = Function_124(&uParam0, &uParam1, &uVar0, &uVar6, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6, &uParam7, 0, &uParam8, &uParam9, &uParam10, &uParam11, &uParam12, 1);
	if (bVar7)
	{
...
int Function_124(var uParam0, int iParam1, struct<41> Param2) //Position: 0x5E92 / 24210
{
	if (!&bParam15)
	{
...
void Function_125(var uParam0, bool bParam1) //Position: 0x64F4 / 25844
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_126() //Position: 0x65C3 / 26051
{
	int iVar0;
...
void Function_127() //Position: 0x663B / 26171
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x6680 / 26240
{
...
void Function_129(var uParam0, int iParam1) //Position: 0x6692 / 26258
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_13(), &iParam1, 4294967295, 1);
...
bool Function_130(int iParam0) //Position: 0x6724 / 26404
{
	bool bVar0;
...
float Function_131(vector3 vParam0) //Position: 0x6755 / 26453
{
...
bool Function_132(int iParam0) //Position: 0x6822 / 26658
{
	return Function_56(iParam0, 2);
}

bool Function_133(int iParam0) //Position: 0x6830 / 26672
{
	return Function_56(iParam0, 1);
}

int Function_134(bool bParam0) //Position: 0x683E / 26686
{
	bool bVar0;
	var uVar1;
...
bool Function_135() //Position: 0x6901 / 26881
{
	bool bVar0;
	var uVar1;
...
void Function_136(int iParam0) //Position: 0x693E / 26942
{
	Function_137(&iParam0, 0.0f);
	return;
}

void Function_137(vector3 vParam0) //Position: 0x694B / 26955
{
...
bool Function_138(struct<37> Param0) //Position: 0x6970 / 26992
{
	return Param0.f_36;
}

void Function_139(var uParam0, int iParam1) //Position: 0x697B / 27003
{
	Function_140(&uParam0, &iParam1, 0);
	return;
}

void Function_140(var uParam0, bool bParam1, bool bParam2) //Position: 0x698B / 27019
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_141(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6B03 / 27395
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_142() //Position: 0x6B2D / 27437
{
	var uVar0;
	var uVar1;
...
void Function_143() //Position: 0x6B88 / 27528
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_13(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_13(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_144() //Position: 0x6CC7 / 27847
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_145() //Position: 0x6CD7 / 27863
{
	Function_147(1, 0, 1, 1, 0, 1, 0, 1, 1, 1, 1);
	Function_146(&Global_99725[6543] + 320, 1);
	DESTROY_VOLUME(&uLocal_347);
	return 1;
}

void Function_146(var uParam0, bool bParam1) //Position: 0x6D03 / 27907
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_147(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x6D8C / 28044
{
	var uVar0;
	...
	Function_125(&uParam9, &bParam10);
}

void Function_148() //Position: 0x6E5B / 28251
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_149() //Position: 0x6E70 / 28272
{
	SET_DRAW_ACTOR(&uLocal_338, 0);
	SNAP_ACTOR_TO_GRINGO(&uLocal_338, GET_OBJECT_FROM_GRINGO(&Global_99725[6543] + 320), "UseCase1", true, 0, 0);
	TASK_USE_GRINGO(&uLocal_338, &Global_99725[6543] + 320, "UseCase1", 4294967295, 1);
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-1862,24f, 24,92f, 3298.0f), 40.0f, 1, 1, true);
	return 1;
}

int Function_150() //Position: 0x6EE3 / 28387
{
	if (!iLocal_341)
	{
		Function_151(StackVal, Local_342, &uLocal_347);
		Function_146(&Global_99725[6543] + 320, 0);
		iLocal_341 = 1;
	}
	return 1;
}

void Function_151(vector3 vParam0) //Position: 0x6F11 / 28433
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_48(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_152(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_152(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_152(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_152(int iParam0, int iParam1) //Position: 0x70BA / 28858
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_153(float fParam0, float fParam1) //Position: 0x71AF / 29103
{
...
void Function_154() //Position: 0x72C0 / 29376
{
...
void Function_155() //Position: 0x72F4 / 29428
{
...
int Function_156() //Position: 0x73FA / 29690
{
	GET_GAME_CAMERA_RESET_POSITION(StackVal, &Local_349, &Local_352, Vector(-1862,24f, 24,92f, 3298.0f), 40.0f, "roam");
	CUTSCENE_MANAGER_SET_FINAL_STREAMING_LOAD_SCENE_EXT(Local_349, Local_352);
	return 1;
}

int Function_157() //Position: 0x7434 / 29748
{
	uLocal_347 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_355, "tempcutscenevol", 2, *(&Global_99725[6543] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(10.0f, 10.0f, 10.0f));
	Function_160(0, 0, 1, 1, 0, 1, 1, &uLocal_347, 1, 1, 1, 1, 0x3f800000, 0);
	Function_158(StackVal, &iLocal_355, *(&Global_99725[6543] + 196), &uLocal_347, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_158(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x74AD / 29869
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_159(var uParam0, float fParam1) //Position: 0x774D / 30541
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_160(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x77CF / 30671
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_163(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_13(), 2, Function_163(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_161(int iParam0) //Position: 0x7A81 / 31361
{
	int iVar0;
...
var Function_162() //Position: 0x7AB5 / 31413
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_163(int iParam0) //Position: 0x7B43 / 31555
{
	struct<2> Var0;
...
int Function_164(int iParam0, float fParam1, float fParam2, float fParam3, var uParam4) //Position: 0x7B55 / 31573
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_165(struct<257> Param0) //Position: 0x7CE0 / 31968
{
...
int Function_166(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x7D1C / 32028
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_167() //Position: 0x7F84 / 32644
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_168(char* cParam0) //Position: 0x7FD8 / 32728
{
	char* cVar0[64];
...
bool Function_169(var uParam0, struct<2> Param1, float fParam3) //Position: 0x810B / 33035
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		Function_68(&uParam0);
		if (VDIST(Function_68(&uParam0), Param1) >= fParam3)
		{
			return 1;
		}
	}
...
int Function_170() //Position: 0x8197 / 33175
{
	if (IS_PS3())
	{
		return 1;
...
void Function_171() //Position: 0x81A6 / 33190
{
	var uVar0;
	
	Function_172(4, 1);
	uVar0 = &uVar0;
	iLocal_355 = CREATE_LAYOUT("Remember_layout");
	return;
}

void Function_172(int iParam0, int iParam1) //Position: 0x81D0 / 33232
{
	switch (&iParam1)
	{
		case 0x00000000:
