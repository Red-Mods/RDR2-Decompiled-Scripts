...
void main() //Position: 0x0 / 0
{
	...
	iLocal_358 = 0;
	iLocal_346 = 1000;
	Function_185(&iLocal_369);
	Function_183(&uLocal_336, "$/content/DLC/ZombiePack/Gringos/DLC_mother_superior_waiting", 1, 0);
	Function_182(&uLocal_336, 613, 3, 0);
		...
		switch (iLocal_358)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					...
					{
						if (Function_177(&uLocal_336))
						{
							uLocal_361 = CREATE_ACTOR_IN_LAYOUT(StackVal, &uLocal_359, Function_176(), 613, *(&Global_99725[ScriptParam_043] + 196), Vector(0.0f, 0.0f, 0.0f));
							uLocal_377 = CREATE_GRINGO_IN_LAYOUT(StackVal, &uLocal_359, Function_176(), "DLC_mother_superior_waiting", *(&Global_99725[ScriptParam_043] + 196), Vector(0.0f, Global_99725[ScriptParam_043].f_208, 0.0f));
							SNAP_ACTOR_TO_GRINGO(&uLocal_361, &uLocal_377, "UseCase1", true, 0, 0);
							TASK_USE_GRINGO(&uLocal_361, GET_GRINGO_FROM_OBJECT(&uLocal_377), "UseCase1", 4294967295, 1);
							uLocal_367 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "Mother3_StayOut", 2, *(&Global_99725[ScriptParam_043] + 196), Vector(0.0f, 0,404f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_367);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(&uLocal_367);
							SET_ACTOR_STAY_WITHIN_VOLUME(&uLocal_361, &uLocal_367, 1, true);
							AI_IGNORE_ACTOR(&uLocal_361);
							TASK_PRIORITY_SET(&uLocal_361, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_361, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
							AUDIO_ADD_ALTERNATE_CONTEXT(&uLocal_361, "RCM_CALL_OVER", "RCM_STILL_HERE_POST2");
							iLocal_358 = 1;
							Function_174(&iLocal_369);
						}
						else if (Function_171(&iLocal_369) < 5.0f)
						{
							Function_174(&iLocal_369);
						}
						Function_164(&(Global_99725[2643]), 26, 0x41f00000, 0x42200000, 0);
					}
					else
					{
						uLocal_359 = CREATE_LAYOUT("RCM_Mother3_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				{
					Function_163(&Global_99725[ScriptParam_043] + 228, 128);
				...
				if (IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
				{
					if (Function_156(StackVal, *(&Global_99725[ScriptParam_043] + 196), 0x3f800000, 0x42960000, 1, 1, 0))
					{
						if (FABS((StackVal - StackVal)) > 2.0f)
						{
							if (GATEWAY_UPDATE(&Global_99725[ScriptParam_043] + 288))
							{
								uLocal_363 = Function_154();
								if (IS_ACTOR_VALID(&uLocal_363))
								{
			...
			case 0x00000003:
				if (Function_112("$/cutscene/mother_superior_has_a_gun_3_pt_a_cs/mother_superior_has_a_gun_3_pt_a_cs", &iLocal_346, 32385, 32378, 31080, 30721, 30305, 30289, 1, 1, 2, 2, 0))
				{
					iLocal_358 = 5;
					Function_174(&iLocal_369);
				}
			...
			case 0x00000005:
				if (!HUD_IS_FADING() && !HUD_IS_FADED())
				{
					...
					Function_110(35, 0, 1);
					_ADD_AMMO_OF_TYPE(&Global_54076, 16, 5.0f, 0, 1);
					if (!Function_109(Global_119934, 16))
					{
						Function_104(&Global_54076, 16, 1, 0);
					}
					TASK_PRIORITY_SET(&uLocal_361, 2);
					SET_RCM_ACTOR_CALL_OVER_ENABLE(&uLocal_361, 1, 1, false, 1, 0, 2, 1101004800, 1088421888, 1);
					iLocal_373 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_99725[ScriptParam_043].f_224);
					bVar0 = false;
					while (bVar0 <= iLocal_373)
					{
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_99725[ScriptParam_043].f_224, "mother3_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x582 / 1410
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x9FC / 2556
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_3() //Position: 0xB9D / 2973
{
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0xBA3 / 2979
{
	if (Global_6624)
	{
		return;
...
void Function_5(bool bParam0) //Position: 0xBE2 / 3042
{
...
void Function_6() //Position: 0xC37 / 3127
{
	Function_33();
	Function_32();
	Function_32();
...
void Function_7() //Position: 0xC82 / 3202
{
...
void Function_8() //Position: 0xD88 / 3464
{
	float fVar0;
...
void Function_9() //Position: 0xDBB / 3515
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0xF4E / 3918
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0x1107 / 4359
{
	Function_12(&Global_42918, 1, 0);
	return;
}

void Function_12(struct<2317> Param0) //Position: 0x1115 / 4373
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_13() //Position: 0x1332 / 4914
{
...
struct<8> Function_14(int iParam0) //Position: 0x1347 / 4935
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_15(int iParam0, bool bParam1, bool bParam2) //Position: 0x13EE / 5102
{
	int iVar0;
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x168A / 5770
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&iParam7), &Global_55480[iParam016] + 32, Function_17(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_176(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_17(int iParam0) //Position: 0x1CC8 / 7368
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1CD9 / 7385
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0) //Position: 0x1DD0 / 7632
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1DEB / 7659
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x1E52 / 7762
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x1E64 / 7780
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1E76 / 7798
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x1FAA / 8106
{
	return Global_55480[iParam016].f_96;
}

float Function_25(int iParam0) //Position: 0x1FB9 / 8121
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x1FF2 / 8178
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x202F / 8239
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x21C9 / 8649
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x240D / 9229
{
...
struct<8> Function_30() //Position: 0x244E / 9294
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x24D7 / 9431
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x256E / 9582
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x25ED / 9709
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x262A / 9770
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x2836 / 10294
{
	struct<2> Var0;
	var uVar2;
...
bool Function_36(char* cParam0) //Position: 0x28ED / 10477
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

struct<8> Function_37(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2905 / 10501
{
	int iVar0;
...
struct<8> Function_38() //Position: 0x29FD / 10749
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_39(int iParam0) //Position: 0x2A07 / 10759
{
...
int Function_40(bool bParam0, bool bParam1) //Position: 0x2A1D / 10781
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_41(struct<2> Param0, struct<2> Param2) //Position: 0x2AE9 / 10985
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_42(float fParam0, int iParam1) //Position: 0x2B06 / 11014
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_43(int iParam0) //Position: 0x3332 / 13106
{
	var uVar0;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x336D / 13165
{
	return (uParam0 && iParam1) == 0;
}

void Function_45(var uParam0, int iParam1) //Position: 0x337A / 13178
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_46(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3389 / 13193
{
	uParam0 = &uParam0;
...
void Function_47(int iParam0) //Position: 0x3438 / 13368
{
	int iVar0;
	bool bVar1;
	char* cVar2[64];
	...
	{
		Function_153(&iVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_48(int iParam0) //Position: 0x3D59 / 15705
{
...
bool Function_49(int iParam0) //Position: 0x3D73 / 15731
{
...
bool Function_50(int iParam0, int iParam1) //Position: 0x3D8A / 15754
{
	int iVar0;
...
bool Function_51() //Position: 0x3DA7 / 15783
{
	return STRING_TO_HASH(Function_52());
}

var Function_52() //Position: 0x3DB3 / 15795
{
	return "ZOMBIE_STORY";
}

bool Function_53(int iParam0) //Position: 0x3DC8 / 15816
{
...
int Function_54(int iParam0) //Position: 0x3E2E / 15918
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_55(int iParam0) //Position: 0x3EF0 / 16112
{
...
void Function_56(int iParam0) //Position: 0x3F05 / 16133
{
	...
	Function_103(Function_51(), 0);
	return;
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x3F4E / 16206
{
	int iVar0;
...
var Function_58(int iParam0) //Position: 0x3F8C / 16268
{
...
bool Function_59(int iParam0) //Position: 0x3FA6 / 16294
{
...
void Function_60(bool bParam0) //Position: 0x3FBC / 16316
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (&Global_99725[iVar143] + 36 == iVar2)
			{
				...
				if (!Function_44(Global_99725[iVar143].f_228, 2048))
				{
					...
					{
						Function_163(&Global_99725[iVar143] + 228, 64);
...
void Function_61(struct<229> Param0) //Position: 0x4183 / 16771
{
	float fVar0;
	int iVar1;
	...
	fVar0 = Param0.f_180;
	*(&Param0 + 288) = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_176(), *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0), 0, &Global_54076, iParam1, Param0.f_176, 0, 1, 1);
	Function_62(&Param0);
...
void Function_62(struct<217> Param0) //Position: 0x4253 / 16979
{
	float fVar0;
	var uVar1;
	...
	*(&Param0 + 336) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_176(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(2.0f, 2.0f, 2.0f));
	...
	uVar1 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 336, Function_176(), 2, *(&Param0 + 196), Vector(0.0f, 0.0f, 0.0f), Vector(fVar0, fVar0, fVar0));
	DECOR_SET_INT(&uVar1, "category", 512);
	Function_63(&uVar1, 0);
	return;
}

int Function_63(var uParam0, int iParam1) //Position: 0x4311 / 17169
{
	int iVar0;
	var uVar1;
...
void Function_64(int iParam0, var uParam1, struct<2> Param2) //Position: 0x447B / 17531
{
	struct<8> Var0;
...
struct<32> Function_65(char* cParam0) //Position: 0x4523 / 17699
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_66(char* cParam0) //Position: 0x458F / 17807
{
	char* cVar0[32];
...
int Function_67(int iParam0) //Position: 0x45B1 / 17841
{
	int iVar0;
	struct<2> Var1;
...
float Function_68(int iParam0, struct<2> Param1) //Position: 0x471F / 18207
{
	struct<2> Var0;
...
struct<8> Function_69(int iParam0) //Position: 0x4796 / 18326
{
	struct<2> Var0;
...
void Function_70(int iParam0) //Position: 0x4802 / 18434
{
...
bool Function_71(int iParam0) //Position: 0x486A / 18538
{
...
void Function_72(struct<153> Param0) //Position: 0x4880 / 18560
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
	...
	fVar2 = 1.0f;
	fVar3 = 50.0f;
	if ((((StackVal && Function_156(Function_77(iParam1), Var0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_76(iParam1)) || Global_116927[iParam16].f_20 != 1) || Function_44(Global_99725[iParam143].f_228, 64))
	{
...
void Function_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4D96 / 19862
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_74(int iParam0) //Position: 0x4E21 / 20001
{
	char* cVar0[16];
...
bool Function_75() //Position: 0x4E60 / 20064
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_76(int iParam0) //Position: 0x4E8D / 20109
{
...
bool Function_77(int iParam0) //Position: 0x4EB9 / 20153
{
...
bool Function_78(struct<249> Param0) //Position: 0x4ECE / 20174
{
	...
	{
		Function_163(&Global_99725[iParam143] + 228, 64);
		return 1;
	}
	if ((Function_88(iParam1) || Function_55(iParam1)) || Function_87(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_79(struct<265> Param0) //Position: 0x4FFE / 20478
{
	int iVar0;
...
bool Function_80(int iParam0) //Position: 0x515F / 20831
{
	if (!Function_49(iParam0))
	{
		return 0;
...
bool Function_81(int iParam0) //Position: 0x5183 / 20867
{
...
bool Function_82(int iParam0) //Position: 0x5198 / 20888
{
	return Global_116927[iParam06].f_16;
}

bool Function_83(struct<237> Param0) //Position: 0x51A8 / 20904
{
	if (!Param0.f_236)
	{
		if (Function_102())
...
bool Function_84(int iParam0) //Position: 0x5277 / 21111
{
...
bool Function_85(int iParam0) //Position: 0x52D2 / 21202
{
	int iVar0;
...
bool Function_86(var uParam0, int iParam1) //Position: 0x52EE / 21230
{
	int iVar0;
...
int Function_87(int iParam0) //Position: 0x530B / 21259
{
...
int Function_88(int iParam0) //Position: 0x5320 / 21280
{
...
void Function_89() //Position: 0x5335 / 21301
{
...
int Function_90(int iParam0, int iParam1) //Position: 0x53B5 / 21429
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
int Function_91(int iParam0) //Position: 0x6018 / 24600
{
	int iVar0;
	int iVar1;
...
bool Function_92(int iParam0) //Position: 0x6067 / 24679
{
...
int Function_93(int iParam0) //Position: 0x607D / 24701
{
...
void Function_94() //Position: 0x60E6 / 24806
{
...
bool Function_95(int iParam0) //Position: 0x610B / 24843
{
	if (!Function_92(iParam0))
	{
...
bool Function_96(int iParam0, int iParam1) //Position: 0x615C / 24924
{
	int iVar0;
...
bool Function_97(int iParam0) //Position: 0x6189 / 24969
{
	if (!Function_92(iParam0))
	{
...
void Function_98(bool bParam0) //Position: 0x61DB / 25051
{
	int iVar0;
...
void Function_99() //Position: 0x6215 / 25109
{
	bool bVar0;
...
void Function_100(int iParam0, int iParam1) //Position: 0x6273 / 25203
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

void Function_101(var uParam0) //Position: 0x6289 / 25225
{
	PRINTSTRING("Day ");
...
bool Function_102() //Position: 0x62D3 / 25299
{
...
void Function_103(bool bParam0, bool bParam1) //Position: 0x62EE / 25326
{
	bool bVar0;
...
void Function_104(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6313 / 25363
{
	bool bVar0;
	char* cVar1[16];
...
void Function_105(char* cParam0) //Position: 0x6388 / 25480
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_106(int iParam0, var uParam1, int iParam2) //Position: 0x63C2 / 25538
{
	var uVar0;
	char* cVar1[16];
...
int Function_107(char* cParam0) //Position: 0x643E / 25662
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_108(int iParam0) //Position: 0x64DF / 25823
{
	int iVar0;
	int iVar1;
...
bool Function_109(var uParam0, int iParam1) //Position: 0x651C / 25884
{
...
int Function_110(bool bParam0, bool bParam1, int iParam2) //Position: 0x652F / 25903
{
...
bool Function_111(bool bParam0) //Position: 0x6589 / 25993
{
	if (bParam0 == 4294967295)
	{
		return 0;
...
bool Function_112(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x659B / 26011
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_113(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6654 / 26196
{
	if (!&bParam15)
	{
	...
	switch (iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_171(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_114(var uParam0, bool bParam1) //Position: 0x6CB6 / 27830
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_115() //Position: 0x6D85 / 28037
{
	int iVar0;
...
void Function_116() //Position: 0x6DFD / 28157
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_117() //Position: 0x6E42 / 28226
{
...
void Function_118(bool bParam0) //Position: 0x6E54 / 28244
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_119(var uParam0, int iParam1) //Position: 0x6E71 / 28273
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	uVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_176(), &iParam1, 4294967295, 1);
...
bool Function_120(int iParam0) //Position: 0x6F03 / 28419
{
	bool bVar0;
...
int Function_121(bool bParam0) //Position: 0x6F34 / 28468
{
	bool bVar0;
	var uVar1;
...
bool Function_122() //Position: 0x6FF7 / 28663
{
	bool bVar0;
	var uVar1;
...
bool Function_123(struct<37> Param0) //Position: 0x7034 / 28724
{
	return Param0.f_36;
}

void Function_124(var uParam0, int iParam1) //Position: 0x703F / 28735
{
	Function_125(&uParam0, &iParam1, 0);
	return;
}

void Function_125(var uParam0, bool bParam1, int iParam2) //Position: 0x704F / 28751
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_126(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x71C7 / 29127
{
	int iVar0;
	int iVar1;
...
void Function_127(bool bParam0) //Position: 0x73EF / 29679
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x748D / 29837
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x74B7 / 29879
{
	var uVar0;
	var uVar1;
...
void Function_130() //Position: 0x7512 / 29970
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	uVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_176(), &Global_99717, 15, 0);
	Var3 = Global_54078;
	uVar5 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_99717, Function_176(), 2, Var3, Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
...
int Function_131() //Position: 0x7651 / 30289
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x7661 / 30305
{
	...
	if (IS_VOLUME_VALID(&uLocal_365))
	{
		DESTROY_VOLUME(&uLocal_365);
	}
	return 1;
}

void Function_133(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x771D / 30493
{
	var uVar0;
...
void Function_134() //Position: 0x77EC / 30700
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x7801 / 30721
{
	var uVar0[2];
	int iVar3;
	
	TELEPORT_ACTOR_WITH_HEADING(StackVal, &Global_54076, Vector(-1699,905f, 8,031f, 4262,575f), 196,745f, 1, 1, true);
	if (Function_138(Global_46866[1]))
	{
		iVar3 = 0;
		while (iVar3 <= 2)
		{
...
int Function_136(var uParam0, var uParam1, int iParam2) //Position: 0x7893 / 30867
{
	return Function_137(Global_43789, &uParam0, &uParam1, iParam2);
}

int Function_137(int iParam0, char* cParam1, bool bParam3) //Position: 0x78A7 / 30887
{
	char* cVar0[8];
	char* cVar2[32];
	var uVar10;
...
bool Function_138(bool bParam0) //Position: 0x794C / 31052
{
	if (!Function_71(bParam0))
	{
		return 1;
	}
	return Function_86(&(Global_43791[bParam0]), 4);
}

int Function_139() //Position: 0x7968 / 31080
{
	if (!iLocal_374)
	{
		Function_140(StackVal, Vector(-1732,179f, 8,031f, 4232,975f), &uLocal_365);
		iLocal_374 = 1;
	}
	return 1;
}

void Function_140(vector3 vParam0) //Position: 0x7991 / 31121
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_141(int iParam0, int iParam1) //Position: 0x7B3A / 31546
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_142(float fParam0, float fParam1) //Position: 0x7C2F / 31791
{
...
void Function_143() //Position: 0x7D40 / 32064
{
...
void Function_144() //Position: 0x7D74 / 32116
{
...
int Function_145() //Position: 0x7E7A / 32378
{
	return 1;
}

int Function_146() //Position: 0x7E81 / 32385
{
	...
	GIVE_OBJECT_TO_LAYOUT(&uLocal_363, &uLocal_359);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_08", &uLocal_363);
	uLocal_365 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &uLocal_359, "Mother3_CSVol", 2, *(&Global_99725[2643] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_149(0, 0, 1, 1, 0, 1, 1, &uLocal_365, 1, 1, 1, 1, 0x3f800000, 0);
	Function_147(StackVal, &uLocal_359, *(&Global_99725[2643] + 196), &uLocal_365, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_147(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x7FAE / 32686
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_148(var uParam0, float fParam1) //Position: 0x8268 / 33384
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_149(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x82EA / 33514
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_152(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_176(), 2, Function_152(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_150(int iParam0) //Position: 0x859C / 34204
{
	int iVar0;
...
var Function_151() //Position: 0x85D0 / 34256
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_152(bool bParam0) //Position: 0x865E / 34398
{
	struct<2> Var0;
...
void Function_153(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x8670 / 34416
{
	struct<4> Var0;
	var uVar4;
...
var Function_154() //Position: 0x8705 / 34565
{
	var uVar0;
	var uVar1;
	...
	{
		uVar1 = GET_MOUNT(&Global_54076);
		uVar0 = GET_ATTACHED_HOGTIE_VICTIM(&uVar1);
	}
	if (IS_ACTOR_VALID(&uVar0))
	{
		...
		if (iLocal_375 && !HUD_IS_SHOWING_OBJECTIVE())
		{
			if (!iLocal_376)
			{
				iLocal_376 = 1;
				Function_73("Mother2_WrongZ", 7.0f, 1, 0, 2, 1, 0);
			}
		}
	}
	else if (Function_171(&iLocal_369) < 5.0f)
...
bool Function_155(int iParam0) //Position: 0x879F / 34719
{
	bool bVar0;
...
bool Function_156(struct<2> Param0, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x87DE / 34782
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &iParam2, &iParam3, &iParam4, &iParam5, &iParam6);
}

void Function_157() //Position: 0x87FF / 34815
{
	AI_STOP_IGNORING_ACTOR(&uLocal_361);
	ENABLE_CHILD_SECTOR("lsh_garden01x");
	ENABLE_CHILD_SECTOR("lsh_arches01x");
	ENABLE_CHILD_SECTOR("lsh_shacks01x");
	ENABLE_CHILD_SECTOR("lsh_storageRoom01x");
	...
	Function_159(&uLocal_336);
	Function_158(0, 0, 0);
	return;
}

int Function_158(bool bParam0, bool bParam1, bool bParam2) //Position: 0x88BC / 35004
{
	if (&bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_159(int iParam0) //Position: 0x88EE / 35054
{
	int iVar0;
...
void Function_160(struct<2>[] Param0, int iParam1) //Position: 0x8916 / 35094
{
	if (Function_162(&(Param0[iParam12]), 4))
	{
		if (Function_162(&(Param0[iParam12]), 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_161(&(Param0[iParam12]), 1);
			Function_161(&(Param0[iParam12]), 2);
			Function_161(&(Param0[iParam12]), 4);
		}
	}
	return;
}

void Function_161(struct<13> Param0) //Position: 0x8A61 / 35425
{
	int iVar0;
...
bool Function_162(struct<13> Param0) //Position: 0x8A7E / 35454
{
	int iVar0;
...
void Function_163(var uParam0, int iParam1) //Position: 0x8A9C / 35484
{
	uParam0 = (uParam0 || iParam1);
	return;
}

int Function_164(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x8AAD / 35501
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_165(struct<257> Param0) //Position: 0x8C38 / 35896
{
...
int Function_166(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x8C74 / 35956
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_167() //Position: 0x8EDC / 36572
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_168(char* cParam0) //Position: 0x8F30 / 36656
{
	char* cVar0[64];
...
bool Function_169(var uParam0, struct<2> Param1, float fParam3) //Position: 0x9059 / 36953
{
...
int Function_170() //Position: 0x90E5 / 37093
{
	if (IS_PS3())
	{
		return 1;
...
float Function_171(vector3 vParam0) //Position: 0x90F4 / 37108
{
...
bool Function_172(int iParam0) //Position: 0x91C1 / 37313
{
	return Function_44(iParam0, 2);
}

bool Function_173(int iParam0) //Position: 0x91CF / 37327
{
	return Function_44(iParam0, 1);
}

void Function_174(int iParam0) //Position: 0x91DD / 37341
{
	Function_175(&iParam0, 0.0f);
	return;
}

void Function_175(vector3 vParam0) //Position: 0x91EA / 37354
{
	vParam0.f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_163(&vParam0, 1);
	Function_100(&vParam0, 2);
	vParam0.f_8 = 0.0f;
	return;
}

var Function_176() //Position: 0x920F / 37391
{
	int iVar0;
...
bool Function_177(struct<2>[] Param0) //Position: 0x9218 / 37400
{
	int iVar0;
	int iVar1;
	...
	Function_181();
	iVar1 = 0;
	if (!Function_162(&(Param0[iVar02]), 16))
	{
		...
		Function_180(&(Param0[iVar02]), 16);
	}
	iVar0 = 0;
	while (iVar0 < (Param0 - 1))
	{
		if (Function_162(&(Param0[iVar02]), 4))
		{
			if (!Function_162(&(Param0[iVar02]), 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP(&(Param0[iVar02]), (Function_162(&(Param0[02]), 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR(&(Param0[iVar02]), true, (Function_162(&(Param0[02]), 8) || iVar1));
						break;
...
void Function_178() //Position: 0x95DA / 38362
{
	if (!Function_85(128))
	{
		return;
...
bool Function_179() //Position: 0x961A / 38426
{
	int iVar0;
...
void Function_180(struct<13> Param0) //Position: 0x9648 / 38472
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_181() //Position: 0x965B / 38491
{
	if (!Function_85(128))
	{
		return;
...
var Function_182(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x969D / 38557
{
	int iVar0;
...
var Function_183(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x9779 / 38777
{
	int iVar0;
	var uVar1;
...
var Function_184(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x97B7 / 38839
{
	int iVar0;
...
void Function_185(var uParam0) //Position: 0x9886 / 39046
{
