...
struct<8> Function_12(int iParam0) //Position: 0x8CD / 2253
{
	...
	Function_13(182, iVar5, 0);
	strcpy(&cVar0, "fwep_", 8);
	straddi(&cVar0, iVar5, 8);
	return StackVal, cVar0;
}

int Function_13(int iParam0, int iParam1, bool bParam2) //Position: 0x974 / 2420
{
	int iVar0;
	...
	{
		Function_27(iParam0, TO_FLOAT(iParam1), 0);
	}
	Global_54086[iParam0] = TO_FLOAT(iParam1);
	Function_26(iParam0);
	if (&bParam2)
	{
		Function_14(iParam0, 1, TO_FLOAT(iParam1), 1, 0, 0x40400000, 0, 0);
	}
	return 1;
}
...
void Function_56(var uParam0, var uParam1, int iParam2) //Position: 0x2CEF / 11503
{
	...
	uVar0 = GET_MOUNT(&uParam1);
	fVar1 = Function_63(&uParam0, "HorseStaminaBoost", 0.0f);
	if ((IS_ACTOR_VALID(&uVar0) && IS_ACTOR_ALIVE(&uVar0)) && IS_ACTOR_MOUNTED(&uVar0))
	{
		fVar2 = HORSE_GET_CURR_FRESHNESS(&uVar0);
		if (fVar2 > fVar1)
		{
			HORSE_SET_CURR_FRESHNESS(&uVar0, fVar1);
			fVar3 = GET_ACTOR_MAX_FRESHNESS(&uVar0);
			if (fVar3 > 100.0f)
			{
				fVar3 = (fVar3 + 5.0f);
				if (fVar3 < 100.0f)
				...
				SET_ACTOR_MAX_FRESHNESS(&uVar0, fVar3);
			}
			if ((Function_59(&uParam1, 0, 0) || IS_WEAPON_DRAWN(&uParam1)) || GET_WEAPON_IN_HAND(&uParam1) == 4294967295)
			{
				iLocal_4 = 0;
			}
			iParam2 = 1;
		...
		{
			Function_57("horse_full_stamina", 0x41200000, 1, 0, 2, 1, 0);
			iParam2 = 0;
		}
	}
	else
	{
		Function_57("apple_feed_horse", 0x41200000, 1, 0, 2, 1, 0);
		iParam2 = 0;
	}
	return;
}

void Function_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2DFD / 11773
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_58(int iParam0) //Position: 0x2E88 / 11912
{
	char* cVar0[16];
...
int Function_59(int iParam0, bool bParam1, bool bParam2) //Position: 0x2EC7 / 11975
{
...
bool Function_60() //Position: 0x2F8B / 12171
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_61(int iParam0) //Position: 0x2FA2 / 12194
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_62(int iParam0) //Position: 0x2FAE / 12206
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

var Function_63(var uParam0, var uParam1, int iParam2) //Position: 0x2FBD / 12221
{
	int iVar0;
...
var Function_64(int iParam0) //Position: 0x2FD5 / 12245
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, &iParam0);
}

bool Function_65(int iParam0, int iParam1) //Position: 0x2FF0 / 12272
{
	var uVar0;
	var uVar1;
