...
{
	RELEASE_LAYOUT_REF(&uLocal_24);
	Function_4(2, &uLocal_20, &uLocal_18, &uLocal_4, &uLocal_22, 4294967295);
	return;
}
...
bool Function_18(bool bParam0, var uParam1) //Position: 0xED4 / 3796
{
	var uVar0;
	int iVar1;
...
var Function_28(struct<477> Param0) //Position: 0x147B / 5243
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_26 || bParam2) || Global_6611)
			{
				if (Function_139(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_137(&Param0 + 324, &fLocal_28, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_136();
								(*&Param0 + 48)[1] = Function_135();
								Function_134(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_134(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								bVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_126(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_126(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_134(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_134(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_126(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (bVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[bVar1] = Function_126(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[bVar1] = Function_126(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_134(&Param0 + 120, (*&Param0 + 48)[bVar1], 2, 0);
								bVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_125(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_28, 20.0f, fLocal_28));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_121(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_125(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_96(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_92(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
			...
			if (STREAMING_ARE_BOUNDS_LOADED(*(&Param0 + 324), 10.0f))
			{
				if (((Function_22(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_125(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_125(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_68(StackVal, StackVal, &Param0 + 16, Function_125(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_125()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				bVar1 = false;
				while (bVar1 <= iParam3)
				{
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, bVar1), &iLocal_29, &Param0 + 488, 0, 0, 0x40400000))
						{
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3463 / 13411
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > bParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_125(), bParam2[iVar0], Var1, Var3);
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3548 / 13640
{
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_125(), bParam3, Var2, Var4);
...
{
	Function_134(&uLocal_4, 239, 3, 0);
	Function_89(&uLocal_4, "sobbing", 5, 0);
	Function_89(&uLocal_4, "custom/sobbing", 8, 0);
	if (!IS_LAYOUTREF_VALID(&uLocal_22))
	{
		uLocal_22 = CREATE_LAYOUT("zombie03campfirelayout");
	}
	if (Function_77(&uLocal_20, 239, &uLocal_4, 3, &uLocal_22, "zombie03oldlay", 1, 1, 1, 0, 0))
	{
		if (Function_75(&uLocal_24, "zombie03mobile", &iParam1))
		{
			uLocal_18 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_24, Function_125()));
			*(&Global_6667[328] + 216) = &uLocal_18;
			*(&iParam0 + 24) = &uLocal_24;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3AEB / 15083
{
	struct<2> Var0;
	
	Var0 = Vector(-4364,457f, 39,875f, 4347,325f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_20, Var0, 247.0f, 1, 1, true);
	TASK_STAND_STILL(&uLocal_20, -1.0f, 0, 0);
	AI_IGNORE_ACTOR(&uLocal_20);
	SQUAD_JOIN(&uLocal_20, &uLocal_18);
	RESET_ANIM_SET_FOR_ACTOR(&uLocal_20, 1);
	SUSPEND_MOVER(&uLocal_20);
	SET_ANIM_SET_FOR_ACTOR(&uLocal_20, "sobbing", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uLocal_20, "sobbing/sobbing");
	Function_73(&uLocal_20, &uLocal_18, 1, 0);
	SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(&uLocal_20, 1);
	TASK_PRIORITY_SET(&uLocal_20, true);
	return;
}

void Function_73(var uParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x3B7F / 15231
{
	bool bVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1, bool bParam2) //Position: 0x3D3C / 15676
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x3D84 / 15748
{
...
void Function_76(var uParam0, bool bParam1) //Position: 0x3DB4 / 15796
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&uParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &uParam0, &bParam1, Function_125(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
bool Function_77(var uParam0, bool bParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9, bool bParam10) //Position: 0x3DFF / 15871
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	if (!Function_88(&(Global_6667[iParam328])) && uParam7)
	{
		return 0;
	}
	if (&bParam10)
	{
		uVar0 = Function_87(StackVal, *(&Global_6667[iParam328] + 88), 0, 1, 1);
		if (Function_84(uVar0))
		{
			if (Function_92(&iParam2))
			{
				return 1;
			}
			return 0;
	...
	if (StackVal || !Function_82((!WOULD_ACTOR_BE_VISIBLE(&Global_15402[Global_6667[iParam328].f_5614] + 16, &Global_6667[iParam328] + 88, 3212836864) || !&bParam8), &Global_54076, *(&Global_6667[iParam328] + 88), 50.0f))
	{
		iVar1 = Function_87(StackVal, *(&Global_6667[iParam328] + 88), 0, 1, 1);
		if (Function_84(iVar1))
		{
			if (Function_92(&iParam2))
			{
				if (!IS_ACTOR_VALID(&uParam0))
...
void Function_78(int iParam0) //Position: 0x3FDE / 16350
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		TASK_CLEAR(&iParam0);
...
void Function_79(var uParam0, bool bParam1) //Position: 0x4185 / 16773
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_80(var uParam0, bool bParam1) //Position: 0x41D4 / 16852
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_81(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x41F6 / 16886
{
	var uVar0;
...
bool Function_82(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4257 / 16983
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_83() //Position: 0x42E3 / 17123
{
	var uVar0;
	int iVar1;
...
bool Function_84(int iParam0) //Position: 0x4353 / 17235
{
	if (!Function_86(iParam0))
	{
		return 1;
	}
	return Function_85(&(Global_43791[iParam0]), 4);
}

int Function_85(var uParam0, int iParam1) //Position: 0x436F / 17263
{
	int iVar0;
...
bool Function_86(int iParam0) //Position: 0x438C / 17292
{
...
var Function_87(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x43A2 / 17314
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_88(struct<205> Param0) //Position: 0x4448 / 17480
{
	var uVar0;
	var uVar1;
...
var Function_89(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x4553 / 17747
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_91(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_90(struct<13> Param0) //Position: 0x4591 / 17809
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_91(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x45A4 / 17828
{
	int iVar0;
...
bool Function_92(struct<2>[] Param0) //Position: 0x4673 / 18035
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x4A35 / 18997
{
	if (!Function_141(128))
	{
		return;
...
bool Function_94() //Position: 0x4A75 / 19061
{
	int iVar0;
...
void Function_95() //Position: 0x4AA3 / 19107
{
	if (!Function_141(128))
	{
		return;
...
void Function_96(vector3 vParam0) //Position: 0x4AE5 / 19173
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_97(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_97(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_97(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x4B7D / 19325
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_98(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_98(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x4BAC / 19372
{
	Function_113(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_103(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_102(), Function_101(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_100(), Function_99(&uParam11, &uParam12));
}

var Function_99(var uParam0, bool bParam1) //Position: 0x4C07 / 19463
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_100() //Position: 0x4C17 / 19479
{
	return "PackedGrass";
}

var Function_101(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4C2B / 19499
{
	int iVar0;
...
var Function_102() //Position: 0x4C50 / 19536
{
	return "PackedMetadata";
}

void Function_103(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4C67 / 19559
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&bParam1, Function_112(), &uVar4))
				{
					Function_107(uVar4, &bVar5);
...
struct<8> Function_104() //Position: 0x4DA3 / 19875
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_105() //Position: 0x4DB5 / 19893
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_106() //Position: 0x4DC7 / 19911
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_107(var uParam0, struct<5> Param1) //Position: 0x4DD9 / 19929
{
	Param1 = Function_108(uParam0, Function_110(), 0);
	Param1.f_4 = Function_108(uParam0, Function_110() + 8, Function_110());
	return;
}

var Function_108(var uParam0, int iParam1, int iParam2) //Position: 0x4DFE / 19966
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_109((iParam1 - 1)), true) - 1);
	return SHIFT_RIGHT((iVar0 && uParam0), iParam2);
}

var Function_109(bool bParam0) //Position: 0x4E1D / 19997
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_110() //Position: 0x4E29 / 20009
{
	return Function_111(39);
}

int Function_111(int iParam0) //Position: 0x4E34 / 20020
{
	int iVar0;
...
var Function_112() //Position: 0x4E62 / 20066
{
	return "PackedWeapon";
}

int Function_113(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x4E77 / 20087
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_117(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_115(Function_117()), 16);
	}
	...
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_114(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_114() //Position: 0x4F84 / 20356
{
	return "MPItemGiver";
}

struct<32> Function_115(char* cParam0) //Position: 0x4F98 / 20376
{
	char* cVar0[32];
	char* cVar8[16];
	...
	else
	{
		...
		{
			memcpy(&cVar8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_116("0", &cVar8, ""), 4);
		}
...
struct<32> Function_116(char* cParam0) //Position: 0x5004 / 20484
{
	char* cVar0[32];
...
var Function_117() //Position: 0x5026 / 20518
{
	return "PBox_";
}

var Function_118() //Position: 0x5034 / 20532
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_119() //Position: 0x505A / 20570
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_120() //Position: 0x5082 / 20610
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_121(var uParam0, int iParam1) //Position: 0x50A8 / 20648
{
	int iVar0;
	var uVar1;
	...
	Function_123(DECOR_GET_INT(&uParam0, "script"));
	iVar0 = 0;
	while (iVar0 <= 25)
	{
...
void Function_122(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5212 / 21010
{
	struct<8> Var0;
	
	*(&Global_39621[iParam05] + 16) = &uParam1;
	Global_39621[iParam05].f_32 = GET_CURRENT_GAME_TIME();
	Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_115("stayout") };
...
int Function_123(bool bParam0) //Position: 0x52BA / 21178
{
	int iVar0;
	struct<2> Var1;
...
void Function_124(int iParam0) //Position: 0x5428 / 21544
{
...
var Function_125() //Position: 0x5490 / 21648
{
	int iVar0;
...
var Function_126(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5499 / 21657
{
	return Function_127(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_127(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x54B7 / 21687
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_132(bVar1))
	{
		...
		{
			Function_131(&uParam0, bParam1, iParam2, iParam3, bParam4);
	...
	if (bParam1 || (!iParam3 != 4294967295 && !iParam3 != GET_ACTORENUM_SPECIES(bVar1)))
	{
		...
		{
			while (Function_130(bVar0) && iVar2 > 20)
			{
...
void Function_128(int iParam0) //Position: 0x57B0 / 22448
{
	int iVar0;
...
void Function_129() //Position: 0x5864 / 22628
{
	int iVar0;
...
bool Function_130(bool bParam0) //Position: 0x589F / 22687
{
	int iVar0;
...
void Function_131(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x58CC / 22732
{
	bool bVar0;
...
bool Function_132(bool bParam0) //Position: 0x5A27 / 23079
{
...
void Function_133() //Position: 0x5A3E / 23102
{
	int iVar0;
...
var Function_134(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x5A8A / 23178
{
	int iVar0;
...
int Function_135() //Position: 0x5B66 / 23398
{
	int iVar0;
...
int Function_136() //Position: 0x5CC2 / 23746
{
	int iVar0;
...
bool Function_137(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x5DE2 / 24034
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_138(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_138(struct<2> Param0) //Position: 0x5EBE / 24254
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_139(struct<2> Param0, struct<5> Param2) //Position: 0x5EDD / 24285
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_140(int iParam0) //Position: 0x6020 / 24608
{
	var uVar0;
...
bool Function_141(int iParam0) //Position: 0x6042 / 24642
{
	int iVar0;
...
int Function_142() //Position: 0x605E / 24670
{
	return 0;
}

void Function_143(struct<321> Param0) //Position: 0x6065 / 24677
{
	var uVar0;
	
	Param0.f_8 = 0;
	Param0.f_320 = 0;
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_115("campfire"), 4);
	...
	if (IS_STRING_VALID(&bParam1))
	{
		if (STRING_LENGTH(&bParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&bParam1, 0);
			Function_91(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&uParam2))
	{
		if (STRING_LENGTH(&uParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&uParam2, 7);
			Function_91(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}
