...
void main() //Position: 0x0 / 0
{
	...
	iLocal_114 = 0;
	Function_95(&uScriptParam_0, &iLocal_114);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_88(&(vLocal_4[iVar39]), &bVar4))
						{
							Function_86(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_4[iVar39] + 16);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_81("eGRINGO_EndUse: Stop use by request", &vLocal_4[iVar39] + 24);
							Function_80(&vLocal_4[iVar39] + 24, 1);
							...
							{
								Function_73(&(vLocal_4[iVar39]), 0);
							}
							else if (vLocal_4[iVar39].f_68 < 8)
							{
								Function_72(&(vLocal_4[iVar39]));
...
bool Function_16(struct<69> Param0) //Position: 0xADA / 2778
{
	...
	switch (Param0.f_68)
	{
		case 0x00000002:
			...
			{
				if (Function_67(&Param0 + 24, &Param0 + 16))
				{
			...
			if (!Function_65(&Param0 + 16) && Param0.f_68 != 1)
			{
		...
		case 0x00000001:
			...
			else if (Function_67(&Param0 + 24, &Param0 + 16))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(&Param0 + 24, 1);
		...
		case 0x00000004:
			...
			else if (bVar11)
			{
				if (GRINGO_PLAY_ANIM_ON_ACTOR(&Param0 + 24, &bVar0, bVar29))
				{
					...
					iVar12 = 0;
					bVar14 = GRINGO_GET_ATTRIBUTE(&Param0 + 16, iVar12);
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_39(&Param0, &uVar7, &iLocal_120, &uLocal_118);
		...
		case 0x00000006:
			...
			bVar0 = Function_49(&Param0 + 24, &Param0 + 16, Function_71(Param0.f_64, 1));
			if (IS_GRINGO_COMPONENT_VALID(&bVar0))
			{
...
void Function_29(int iParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	var uVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	{
		bLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&iParam0, GET_TARGET_OBJECT(), 4294967295);
	}
	uVar0 = CREATE_OBJECT_LOCATOR(GET_TARGET_OBJECT(), "bobLoc");
	if (OBJECT_LOCATOR_ATTACH_TO_FRAGMENT_LOCATOR(StackVal, StackVal, &uVar0, GET_TARGET_OBJECT(), "truckgatling01x_attach", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f)))
	{
		OBJECT_LOCATOR_GET_LOCATOR_LOCAL_POSITION(&uVar0, &Var1);
		OBJECT_LOCATOR_GET_LOCATOR_LOCAL_ORIENTATION(&uVar0, &Var3);
		SET_ATTACHMENT_LOCAL_OFFSET(&bLocal_2, Var1);
		SET_ATTACHMENT_LOCAL_ROTATION(&bLocal_2, Var3);
	}
	else
	{
		SET_ATTACHMENT_LOCAL_OFFSET(StackVal, &bLocal_2, Vector(0.0f, 0.0f, 0,95f));
		SET_ATTACHMENT_LOCAL_ROTATION(StackVal, &bLocal_2, Vector(0.0f, 0.0f, 0.0f));
	}
	...
	if (IS_OBJECT_VALID(&uVar5))
	{
		...
		if (DECOR_CHECK_EXIST(&uVar6, "bUseGatlingWagonCam") && &iParam0 != Function_30())
		{
...
int Function_30() //Position: 0x2111 / 8465
{
...
bool Function_31(int iParam0) //Position: 0x2126 / 8486
{
	iParam0 = &iParam0;
	return 0;
}

bool Function_32(int iParam0) //Position: 0x2133 / 8499
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_33(int iParam0, int iParam1) //Position: 0x214E / 8526
{
	return Function_9(&iParam0, "ParentAnimNode", &iParam1);
}

bool Function_34(int iParam0) //Position: 0x216E / 8558
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_35(int iParam0) //Position: 0x218E / 8590
{
	int iVar0;
	int iVar1;
...
bool Function_36(int iParam0) //Position: 0x21C5 / 8645
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_37(int iParam0) //Position: 0x21E5 / 8677
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x2200 / 8704
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2216 / 8726
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_40() //Position: 0x253A / 9530
{
	int iVar0;
...
bool Function_41(int iParam0, int iParam1) //Position: 0x2543 / 9539
{
	return Function_9(&iParam0, "TargetLocator", &iParam1);
}

void Function_42() //Position: 0x2562 / 9570
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(int iParam0, int iParam1) //Position: 0x2571 / 9585
{
	return Function_9(&iParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_44(int iParam0, int iParam1) //Position: 0x2595 / 9621
{
	return Function_9(&iParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_45(int iParam0) //Position: 0x25BB / 9659
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x25D9 / 9689
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_47(var uParam0, int iParam1) //Position: 0x25FB / 9723
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_48(int iParam0, int iParam1) //Position: 0x261D / 9757
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_49(var uParam0, int iParam1, bool bParam2) //Position: 0x26E5 / 9957
{
	int iVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2761 / 10081
{
...
void Function_51(vector3 vParam0) //Position: 0x2779 / 10105
{
...
var Function_52(int iParam0) //Position: 0x279E / 10142
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_53(vector3 vParam0) //Position: 0x27BF / 10175
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x27D6 / 10198
{
	uParam0 = &uParam0;
	return;
}

int Function_55() //Position: 0x27E2 / 10210
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x27E9 / 10217
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_57(int iParam0, var uParam1, int iParam2) //Position: 0x27FA / 10234
{
	float fVar0;
...
int Function_58(int iParam0) //Position: 0x283F / 10303
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(int iParam0) //Position: 0x286B / 10347
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_60(int iParam0) //Position: 0x2877 / 10359
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_61(int iParam0) //Position: 0x2979 / 10617
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_62(int iParam0) //Position: 0x299C / 10652
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(int iParam0) //Position: 0x29C4 / 10692
{
	iParam0 = &iParam0;
	return;
}

void Function_64(int iParam0) //Position: 0x29D0 / 10704
{
	iParam0 = &iParam0;
	return;
}

bool Function_65(int iParam0) //Position: 0x29DC / 10716
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_66(int iParam0) //Position: 0x29FB / 10747
{
	if (!Function_14(&iParam0))
	{
...
bool Function_67(var uParam0, int iParam1) //Position: 0x2A12 / 10770
{
	struct<2> Var0;
	float fVar2;
	var uVar3;
	...
	TELEPORT_ACTOR_WITH_HEADING(&uParam0, Var0, fVar2, 1, 1, 1);
	if (IS_ATTACHMENT_VALID(&bLocal_2))
	{
	...
	if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
	{
		...
		bLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, GET_TARGET_OBJECT(), 4294967295);
	}
	else
	{
		uVar3 = GRINGO_GET_MY_OBJECT_REF();
		uVar3 = Function_68(&uVar3);
		if (IS_OBJECT_VALID(&uVar3))
		{
			if (IS_OBJECT_ATTACHED(&uVar3))
			{
				...
				if (IS_ATTACHMENT_VALID(&uVar4))
				{
					...
					if (IS_OBJECT_VALID(&uVar5))
					{
						bLocal_2 = ATTACH_OBJECTS_CONTINUOUS(&uParam0, &uVar5, 4294967295);
					}
				}
			}
		}
...
var Function_68(var uParam0) //Position: 0x2B71 / 11121
{
	int iVar0;
	...
	while (IS_OBJECT_VALID(&iVar0))
	{
		if (IS_OBJECT_ATTACHED(&iVar0))
		{
			...
			PRINTSTRING(GET_OBJECT_NAME(&iVar0));
			PRINTNL();
...
bool Function_69(var uParam0, int iParam1) //Position: 0x2BF8 / 11256
{
...
int Function_70(var uParam0) //Position: 0x2C26 / 11302
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2D3F / 11583
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(struct<69> Param0) //Position: 0x2D4C / 11596
{
	if (Function_71(Param0.f_64, 16))
	{
...
void Function_73(struct<69> Param0) //Position: 0x2DCE / 11726
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x3379 / 13177
{
	int iVar0;
...
int Function_75(int iParam0) //Position: 0x33B3 / 13235
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_76(int iParam0, var uParam1) //Position: 0x33D1 / 13265
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_77(int iParam0) //Position: 0x3412 / 13330
{
	iParam0 = &iParam0;
	return;
}

bool Function_78(int iParam0) //Position: 0x341E / 13342
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_79(var uParam0, int iParam1) //Position: 0x3440 / 13376
{
	var uVar0;
	var uVar1;
	...
	if (IS_OBJECT_VALID(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar1))
		{
			if (DECOR_CHECK_EXIST(&uVar1, "bUseGatlingWagonCam") && &uParam0 != Function_30())
			{
...
void Function_80(var uParam0, bool bParam1) //Position: 0x34F3 / 13555
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_81(int iParam0, int iParam1) //Position: 0x3603 / 13827
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_82(struct<69> Param0) //Position: 0x361B / 13851
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_83(int iParam0, int iParam1) //Position: 0x3937 / 14647
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_84(int iParam0) //Position: 0x3949 / 14665
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_85(int iParam0) //Position: 0x3963 / 14691
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_86(int iParam0, var uParam1) //Position: 0x397E / 14718
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x39BC / 14780
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_88(struct<65> Param0) //Position: 0x39D5 / 14805
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_89(int iParam0) //Position: 0x3CCD / 15565
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_90(var uParam0, int iParam1) //Position: 0x3CEB / 15595
{
	struct<5> Var0;
	float fVar5;
...
int Function_91(int iParam0) //Position: 0x3D8B / 15755
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(var uParam0, float fParam1) //Position: 0x3DAB / 15787
{
	struct<5> Var0;
...
bool Function_93(int iParam0) //Position: 0x3DD7 / 15831
{
...
void Function_94(int iParam0) //Position: 0x3DF3 / 15859
{
	iParam0 = &iParam0;
	return;
}

void Function_95(var uParam0, int iParam1) //Position: 0x3DFF / 15871
{
	int iVar0;
	var uVar1;
	...
	{
		Function_96(&(vLocal_4[iLocal_1149]), &uParam0);
		iLocal_114++;
	}
...
void Function_96(int iParam0, int iParam1) //Position: 0x3E6B / 15979
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_97(int iParam0) //Position: 0x3E83 / 16003
{
	iParam0 = &iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x3E8F / 16015
{
