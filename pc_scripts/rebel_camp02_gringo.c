...
{
	if (IS_SOUND_ID_VALID(&iLocal_42))
	{
		STOP_SOUND(&iLocal_42);
	}
	RELEASE_LAYOUT_REF(&uLocal_40);
	Function_4(8, &uLocal_34, &iLocal_36, &uLocal_4, &uLocal_38, 4294967295);
	return;
}
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x70E / 1806
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_39620 + 1 > iLocal_44 || bParam2) || Global_6611)
			{
				...
				{
					if (((!bParam2 && !Function_146(&Param0 + 324, &fLocal_46, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_135(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_46, 20.0f, fLocal_46));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_131(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_135(), 3, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x265C / 9820
{
	bool bVar0;
	var uVar1;
	bool bVar2;
...
bool Function_31(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2895 / 10389
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_32(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28B5 / 10421
{
	bool bVar0;
	var uVar1;
...
int Function_33(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x29A3 / 10659
{
	char* cVar0[32];
...
int Function_34(int iParam0) //Position: 0x2C0F / 11279
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_35(var uParam0, bool bParam1) //Position: 0x2C33 / 11315
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x2C57 / 11351
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_37(var uParam0, bool bParam1) //Position: 0x2C7D / 11389
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(var uParam0, bool bParam1) //Position: 0x2CA4 / 11428
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2CC8 / 11464
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2CE7 / 11495
{
...
bool Function_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2D36 / 11574
{
	bool bVar0;
	var uVar1;
...
bool Function_42(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2D92 / 11666
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_43(var uParam0, int iParam1) //Position: 0x2DB3 / 11699
{
	bool bVar0;
	var uVar1;
...
void Function_44(var uParam0, var uParam1, bool bParam2) //Position: 0x2E0E / 11790
{
	bool bVar0;
	var uVar1;
...
var Function_45() //Position: 0x2E5A / 11866
{
...
void Function_46(struct<425> Param0) //Position: 0x2E6F / 11887
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2FC2 / 12226
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x3037 / 12343
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(var uParam0) //Position: 0x304F / 12367
{
	bool bVar0;
	int iVar1;
...
var Function_50(bool bParam0) //Position: 0x30AD / 12461
{
	bool bVar0;
	bool bVar1;
...
void Function_51(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x30FA / 12538
{
	bool bVar0;
	var uVar1;
...
void Function_52(var uParam0, bool bParam1) //Position: 0x3173 / 12659
{
	bool bVar0;
	var uVar1;
...
void Function_53(var uParam0) //Position: 0x31C2 / 12738
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x3281 / 12929
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(struct<25> Param0) //Position: 0x3294 / 12948
{
	var uVar0;
	int iVar1;
	var uVar2;
...
var Function_56(int iParam0) //Position: 0x335B / 13147
{
...
bool Function_57(int iParam0) //Position: 0x337B / 13179
{
...
bool Function_58(int iParam0) //Position: 0x339F / 13215
{
...
bool Function_59(int iParam0) //Position: 0x33B4 / 13236
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x33CB / 13259
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x3409 / 13321
{
...
bool Function_62(int iParam0) //Position: 0x3423 / 13347
{
...
int Function_63(int iParam0, struct<6> Param1) //Position: 0x3439 / 13369
{
	int iVar0;
...
void Function_64(var uParam0, char* cParam1, bool[] bParam2, bool bParam3, var[] uParam4) //Position: 0x3473 / 13427
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
...
void Function_65(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x3558 / 13656
{
	bool bVar0;
	bool bVar1;
	struct<2> Var2;
...
void Function_66(var uParam0, bool bParam1) //Position: 0x370F / 14095
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3734 / 14132
{
	var uVar0;
	int iVar1;
...
var Function_68(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x3782 / 14210
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x38D9 / 14553
{
	var uVar0[5];
	int iVar6;
...
int Function_70(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x3984 / 14724
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3A2A / 14890
{
	Function_143(&uLocal_4, 533, 3, 0);
	Function_143(&uLocal_4, 534, 3, 0);
	Function_143(&uLocal_4, 535, 3, 0);
	Function_143(&uLocal_4, 537, 3, 0);
	Function_143(&uLocal_4, 538, 3, 0);
	Function_99(&uLocal_4, "gather", 5, 0);
	Function_99(&uLocal_4, "custom/gather", 8, 0);
	if (Function_80(&uLocal_34, &uLocal_4, 39, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_78(&uLocal_40, "rebel02mobile", &iParam1))
		{
			iLocal_36 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&uLocal_40, Function_135()));
			*(&Global_6667[3928] + 216) = &iLocal_36;
			*(&iParam0 + 24) = &uLocal_40;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x3AF1 / 15089
{
	struct<2> Var0;
	struct<2> Var2;
	var uVar4;
	
	uLocal_38 = CREATE_LAYOUT("rebel04campfirelayout");
	Var0 = Vector(-2291,682f, 21,839f, 4962,178f);
	Var2 = Vector(0.0f, 324,348f, 0.0f);
	TELEPORT_ACTOR_WITH_HEADING(&uLocal_34, Var0, 313,76f, 1, 1, true);
	SET_ANIM_SET_FOR_ACTOR(&uLocal_34, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uLocal_34, "Gather/Speaker/talking");
	Function_76(&uLocal_34, &iLocal_36, 1, 1);
	Var0 = Vector(-2291,651f, 21,839f, 4957,303f);
	Var2 = Vector(0.0f, 201,101f, 0.0f);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(&uLocal_38, "rebel04campeasy01", 533, Var0, Var2);
	TELEPORT_ACTOR(&uVar4, &Var0, 1, 1, 1);
	Function_73(StackVal, &uVar4, Vector(-2291,682f, 21,839f, 4962,178f));
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "Gather/Listener/Idle");
	Function_76(&uVar4, &iLocal_36, 1, 1);
	Var0 = Vector(-2290,927f, 21,839f, 4955,965f);
	Var2 = Vector(0.0f, 183,007f, 0.0f);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(&uLocal_38, "rebel04campeasy02", 534, Var0, Var2);
	TELEPORT_ACTOR(&uVar4, &Var0, 1, 1, 1);
	Function_73(StackVal, &uVar4, Vector(-2291,682f, 21,839f, 4962,178f));
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "Gather/Listener/Idle");
	Function_76(&uVar4, &iLocal_36, 1, 1);
	Var0 = Vector(-2289,116f, 21,839f, 4956,751f);
	Var2 = Vector(0.0f, 158,056f, 0.0f);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(&uLocal_38, "rebel04campeasy03", 535, Var0, Var2);
	TELEPORT_ACTOR(&uVar4, &Var0, 1, 1, 1);
	Function_73(StackVal, &uVar4, Vector(-2291,682f, 21,839f, 4962,178f));
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "Gather/Listener/Idle");
	Function_76(&uVar4, &iLocal_36, 1, 1);
	Var0 = Vector(-2286,725f, 21,839f, 4959,168f);
	Var2 = Vector(0.0f, 118,725f, 0.0f);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(&uLocal_38, "rebel04campmed02", 537, Var0, Var2);
	TELEPORT_ACTOR(&uVar4, &Var0, 1, 1, 1);
	Function_73(StackVal, &uVar4, Vector(-2291,682f, 21,839f, 4962,178f));
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "Gather/Listener/Idle");
	Function_76(&uVar4, &iLocal_36, 1, 1);
	Var0 = Vector(-2286,783f, 21,839f, 4957,792f);
	Var2 = Vector(0.0f, 126,266f, 0.0f);
	uVar4 = CREATE_ACTOR_IN_LAYOUT(&uLocal_38, "rebel04campmed03", 538, Var0, Var2);
	TELEPORT_ACTOR(&uVar4, &Var0, 1, 1, 1);
	Function_73(StackVal, &uVar4, Vector(-2291,682f, 21,839f, 4962,178f));
	SET_ANIM_SET_FOR_ACTOR(&uVar4, "gather", 0);
	SET_ACTION_NODE_FOR_ACTOR(&uVar4, "Gather/Listener/Idle");
	...
	PLAY_WALLA_SOUND_FROM_POSITION_PERSISTENT(StackVal, &iLocal_42, "VOCAL_MEX_CROWD_MASTER", Vector(-2289,171f, 22,609f, 4959,531f));
	return;
}

void Function_73(float fParam0, struct<2> Param1) //Position: 0x3ED3 / 16083
{
...
var Function_74(var uParam0, struct<2> Param1) //Position: 0x3F0E / 16142
{
	struct<2> Var0;
...
struct<8> Function_75(int iParam0) //Position: 0x3F8F / 16271
{
	struct<2> Var0;
...
void Function_76(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x3FA1 / 16289
{
	bool bVar0;
	int iVar1;
...
bool Function_77(int iParam0, int iParam1, bool bParam2) //Position: 0x4160 / 16736
{
	if (!IS_ACTOR_VALID(&iParam0))
	{
		if (&bParam2)
...
bool Function_78(var uParam0, var uParam1, int iParam2) //Position: 0x41A8 / 16808
{
...
void Function_79(var uParam0, bool bParam1) //Position: 0x41D8 / 16856
{
	int iVar0;
...
bool Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4223 / 16931
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x4402 / 17410
{
	int iVar0;
	bool bVar1;
	var uVar2;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x4942 / 18754
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_83(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x4964 / 18788
{
	var uVar0;
...
var Function_84(bool bParam0, int iParam1) //Position: 0x49C5 / 18885
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x4A53 / 19027
{
	Function_87(&uParam0);
	Function_86(&uParam0);
...
void Function_86(int iParam0) //Position: 0x4A7F / 19071
{
...
void Function_87(int iParam0) //Position: 0x4AA5 / 19109
{
...
bool Function_88(bool bParam0) //Position: 0x4B7B / 19323
{
...
var Function_89(int iParam0, int iParam1) //Position: 0x4B92 / 19346
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x4C38 / 19512
{
	var uVar0;
	var uVar1;
...
void Function_91(var uParam0) //Position: 0x4D47 / 19783
{
	int iVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x4D7A / 19834
{
	int iVar0;
...
bool Function_93(int iParam0, struct<2> Param1, float fParam3) //Position: 0x4D97 / 19863
{
	if (IS_ACTOR_VALID(&iParam0))
	{
		Function_23(&iParam0);
...
void Function_94() //Position: 0x4E23 / 20003
{
	var uVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x4E93 / 20115
{
...
bool Function_96(int iParam0) //Position: 0x4EAF / 20143
{
...
var Function_97(struct<2> Param0, int iParam2, int iParam3, bool bParam4) //Position: 0x4EC5 / 20165
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_98(struct<205> Param0) //Position: 0x4F6B / 20331
{
	var uVar0;
	var uVar1;
...
var Function_99(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x5076 / 20598
{
	int iVar0;
	int iVar1;
...
void Function_100(struct<13> Param0) //Position: 0x50B4 / 20660
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_101(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x50C7 / 20679
{
	int iVar0;
...
bool Function_102(struct<2>[] Param0) //Position: 0x5196 / 20886
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x5558 / 21848
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x5598 / 21912
{
	int iVar0;
...
void Function_105() //Position: 0x55C6 / 21958
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(vector3 vParam0) //Position: 0x5608 / 22024
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x56A0 / 22176
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x56CF / 22223
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x572A / 22314
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x573A / 22330
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x574E / 22350
{
	int iVar0;
...
var Function_112() //Position: 0x5773 / 22387
{
	return "PackedMetadata";
}

void Function_113(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x578A / 22410
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
...
struct<8> Function_114() //Position: 0x58C6 / 22726
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_115() //Position: 0x58D8 / 22744
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_116() //Position: 0x58EA / 22762
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_117(var uParam0, struct<5> Param1) //Position: 0x58FC / 22780
{
...
var Function_118(var uParam0, int iParam1, int iParam2) //Position: 0x5921 / 22817
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x5940 / 22848
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_120() //Position: 0x594C / 22860
{
	return Function_121(39);
}

int Function_121(int iParam0) //Position: 0x5957 / 22871
{
	int iVar0;
...
var Function_122() //Position: 0x5985 / 22917
{
	return "PackedWeapon";
}

int Function_123(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x599A / 22938
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
...
var Function_124() //Position: 0x5AA7 / 23207
{
	return "MPItemGiver";
}

struct<32> Function_125(char* cParam0) //Position: 0x5ABB / 23227
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0) //Position: 0x5B27 / 23335
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5B49 / 23369
{
	return "PBox_";
}

var Function_128() //Position: 0x5B57 / 23383
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5B7D / 23421
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x5BA5 / 23461
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x5BCB / 23499
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, struct<2> Param2) //Position: 0x5D35 / 23861
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x5DDD / 24029
{
	int iVar0;
	struct<2> Var1;
...
void Function_134(int iParam0) //Position: 0x5F4B / 24395
{
...
var Function_135() //Position: 0x5FB3 / 24499
{
	int iVar0;
...
var Function_136(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5FBC / 24508
{
	return Function_137(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_137(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x5FDA / 24538
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_138(int iParam0) //Position: 0x62D3 / 25299
{
	int iVar0;
...
void Function_139() //Position: 0x6387 / 25479
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x63C2 / 25538
{
	int iVar0;
...
void Function_141(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x63EF / 25583
{
	bool bVar0;
...
void Function_142() //Position: 0x654A / 25930
{
	int iVar0;
...
var Function_143(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6596 / 26006
{
	int iVar0;
...
int Function_144() //Position: 0x6672 / 26226
{
	int iVar0;
...
int Function_145() //Position: 0x67CE / 26574
{
	int iVar0;
...
bool Function_146(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x68EE / 26862
{
	var uVar0;
	int iVar2;
	bool bVar3;
...
float Function_147(struct<2> Param0) //Position: 0x69CA / 27082
{
	struct<2> Var0;
	bool bVar2;
...
bool Function_148(struct<2> Param0, struct<5> Param2) //Position: 0x69E9 / 27113
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
...
bool Function_149(int iParam0) //Position: 0x6B2C / 27436
{
	var uVar0;
...
bool Function_150(int iParam0) //Position: 0x6B4E / 27470
{
	int iVar0;
...
int Function_151() //Position: 0x6B6A / 27498
{
	return 0;
}

void Function_152(struct<321> Param0) //Position: 0x6B71 / 27505
{
	var uVar0;
