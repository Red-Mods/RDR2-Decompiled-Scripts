...
void main() //Position: 0x0 / 0
{
	...
	iLocal_348 = 0;
	bLocal_363 = false;
	Local_364 = Vector(-366,826f, 16,863f, 3938,828f);
	iLocal_369 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_326 = 1000;
			Function_196(&uLocal_349, "$/fragments/p_gen_rockRCM23_cs01x", 0, 0);
			Function_196(&uLocal_349, "$/fragments/p_gen_rockRCM23_cs02x", 0, 0);
			Function_196(&uLocal_349, "$/fragments/p_gen_rockRCM23_cs03x", 0, 0);
			bLocal_363 = true;
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000000:
						if (Function_191(&uLocal_349) && IS_OBJECT_VALID(&Global_99725[ScriptParam_043] + 288))
						{
							if (IS_LAYOUTREF_VALID(&uLocal_346))
							{
								if (!iLocal_348)
								{
									if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_346, "aztec_rock1")))
									{
										uLocal_340 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_346, "aztec_rock1", "$/fragments/p_gen_rockRCM23_cs01x", Vector(-301,372f, 23,915f, 3983,026f), Vector(0,454f, 14,883f, 2,862f), 1);
									}
									if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_346, "aztec_rock2")))
									{
										uLocal_342 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_346, "aztec_rock2", "$/fragments/p_gen_rockRCM23_cs02x", Vector(-301,077f, 23,938f, 3982,655f), Vector(-5,266f, -83,883f, 5,326f), 1);
									}
									if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(&uLocal_346, "aztec_rock3")))
									{
										uLocal_344 = CREATE_PROP_IN_LAYOUT(StackVal, StackVal, &uLocal_346, "aztec_rock3", "$/fragments/p_gen_rockRCM23_cs03x", Vector(-301,307f, 23,927f, 3983,631f), Vector(76,154f, 77,739f, 74,385f), 1);
									}
									if ((IS_OBJECT_VALID(&uLocal_340) && IS_OBJECT_VALID(&uLocal_342)) && IS_OBJECT_VALID(&uLocal_344))
									{
										iLocal_348 = 1;
									}
								}
								if (IS_ACTOR_VALID(&uLocal_338) && iLocal_348)
								{
									Function_184(&(Global_99725[943]), 9, 0x41f00000, 0x42200000, 0);
									iVar0 = 1;
								}
							}
							...
							{
								Function_182();
								uLocal_346 = &iLocal_367;
							}
							else
							{
								uLocal_346 = FIND_NAMED_LAYOUT("AztecGold_layout");
							}
						}
						break;
					
					case 0x00000001:
						if (!Function_179(&(Global_99725[ScriptParam_043]), 9, 0, 1) || Function_178(9))
						{
							Function_177(&Global_99725[943] + 228, 64);
							Function_175(&(Global_99725[943]), 9, 0, 1, 1);
							iVar0 = 13;
						}
						else if (IS_OBJECT_VALID(&Global_99725[943] + 288))
						{
							if (Function_171(&Global_99725[943] + 288, 0, 1, 0, 0, 0))
							{
								Function_170(&(Global_99725[943]));
								iVar0 = 3;
							}
						}
						Function_184(&(Global_99725[943]), 9, 0x41f00000, 0x42200000, 0);
					...
					case 0x00000003:
						if (Function_130("$/cutscene/RCM_23_CS04/RCM_23_CS04", &iLocal_326, 32915, 32908, 31616, 31585, 31329, 31313, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						SAY_SINGLE_LINE_STRING(&Global_54076, "PLAYER_BLACKJACK_LEAVES_GAME_HAVING_LOST_MONEY", false, false, 0, 6, true, false);
						Function_129(&(Global_43791[Global_46866[9]]), 8192);
						Global_6655 = 1;
						Global_6659 = 7;
						Function_127("AztecGold_END", 7,5f, 0, 2, 0, 0, 0, 0);
						Function_111(50, 1, 0);
						Function_109(407, 1, 0, 0);
						Function_63(9, 1, 1, 0);
						Function_9();
						DESTROY_ACTOR(&uLocal_338);
						Function_8(&(Global_99725[943]));
...
int Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x533 / 1331
{
	if (&bParam2)
	{
...
void Function_2(bool bParam0) //Position: 0x565 / 1381
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x582 / 1410
{
	RELEASE_LAYOUT_REF(&iLocal_367);
	return;
}

void Function_4(int iParam0) //Position: 0x58F / 1423
{
	int iVar0;
...
void Function_5(struct<2>[] Param0, int iParam1) //Position: 0x5B7 / 1463
{
...
void Function_6(struct<13> Param0) //Position: 0x702 / 1794
{
	int iVar0;
...
bool Function_7(struct<13> Param0) //Position: 0x71F / 1823
{
	int iVar0;
...
void Function_8(struct<221> Param0) //Position: 0x73D / 1853
{
...
void Function_9() //Position: 0x786 / 1926
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x7B7 / 1975
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11(struct<229> Param0) //Position: 0x971 / 2417
{
	float fVar0;
	int iVar1;
...
void Function_12(struct<217> Param0) //Position: 0xA41 / 2625
{
	float fVar0;
	var uVar1;
...
int Function_13(var uParam0, int iParam1) //Position: 0xAFF / 2815
{
	int iVar0;
	var uVar1;
...
void Function_14(int iParam0, var uParam1, struct<2> Param2) //Position: 0xC69 / 3177
{
	struct<8> Var0;
...
struct<32> Function_15(char* cParam0) //Position: 0xD11 / 3345
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_16(char* cParam0) //Position: 0xD7D / 3453
{
	char* cVar0[32];
...
int Function_17(int iParam0) //Position: 0xD9F / 3487
{
	int iVar0;
	struct<2> Var1;
...
float Function_18(int iParam0, struct<2> Param1) //Position: 0xF0D / 3853
{
	struct<2> Var0;
...
struct<8> Function_19(int iParam0) //Position: 0xF84 / 3972
{
	struct<2> Var0;
...
void Function_20(int iParam0) //Position: 0xFF0 / 4080
{
...
bool Function_21(int iParam0) //Position: 0x1058 / 4184
{
...
var Function_22() //Position: 0x106E / 4206
{
	int iVar0;
...
void Function_23(struct<153> Param0) //Position: 0x1077 / 4215
{
	struct<2> Var0;
	float fVar2;
	float fVar3;
...
int Function_24(int iParam0) //Position: 0x11E6 / 4582
{
...
var Function_25(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1212 / 4626
{
...
void Function_27(var uParam0, int iParam1) //Position: 0x1248 / 4680
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_28(struct<249> Param0) //Position: 0x1259 / 4697
{
	...
	if ((Function_49(iParam1) || Function_48(iParam1)) || Function_178(iParam1))
	{
		return 0;
	}
	if (Param0.f_248)
...
bool Function_29(struct<265> Param0) //Position: 0x1389 / 5001
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x14EA / 5354
{
...
bool Function_31(int iParam0) //Position: 0x150E / 5390
{
...
bool Function_32(int iParam0) //Position: 0x1523 / 5411
{
...
var Function_33(int iParam0) //Position: 0x153A / 5434
{
...
bool Function_34(int iParam0) //Position: 0x1554 / 5460
{
...
bool Function_35(int iParam0) //Position: 0x156A / 5482
{
	return Global_116927[iParam06].f_16;
}

bool Function_36(var uParam0, int iParam1) //Position: 0x157A / 5498
{
	int iVar0;
...
bool Function_37(struct<237> Param0) //Position: 0x1597 / 5527
{
	if (!Param0.f_236)
	{
		if (Function_38())
...
bool Function_38() //Position: 0x1666 / 5734
{
...
bool Function_39(int iParam0) //Position: 0x1681 / 5761
{
...
void Function_40(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x16DC / 5852
{
	bool bVar0;
	char* cVar1[16];
...
void Function_41(char* cParam0) //Position: 0x1751 / 5969
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_42(int iParam0, var uParam1, int iParam2) //Position: 0x178B / 6027
{
	var uVar0;
	char* cVar1[16];
...
int Function_43(char* cParam0) //Position: 0x1807 / 6151
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_44(int iParam0) //Position: 0x18A8 / 6312
{
	int iVar0;
	int iVar1;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x18E5 / 6373
{
...
bool Function_46(int iParam0) //Position: 0x18F8 / 6392
{
	int iVar0;
...
bool Function_47(var uParam0, int iParam1) //Position: 0x1914 / 6420
{
	int iVar0;
...
bool Function_48(int iParam0) //Position: 0x1931 / 6449
{
...
int Function_49(int iParam0) //Position: 0x1946 / 6470
{
...
bool Function_50(var uParam0, bool bParam1) //Position: 0x195B / 6491
{
	return (uParam0 && bParam1) == 0;
}

void Function_51() //Position: 0x1968 / 6504
{
...
int Function_52(int iParam0, int iParam1) //Position: 0x19E8 / 6632
{
	struct<2> Var0;
	struct<9> Var2;
	int iVar13;
...
bool Function_53(char* cParam0) //Position: 0x264B / 9803
{
	return (StackVal && (StackVal && cParam0 != 0.0f != 0.0f) != 0.0f);
}

bool Function_54(int iParam0, bool bParam1) //Position: 0x2663 / 9827
{
	int iVar0;
...
int Function_55(int iParam0) //Position: 0x26A1 / 9889
{
	int iVar0;
	int iVar1;
...
bool Function_56(int iParam0) //Position: 0x26F0 / 9968
{
...
int Function_57(int iParam0) //Position: 0x2706 / 9990
{
...
void Function_58() //Position: 0x276F / 10095
{
...
bool Function_59(int iParam0) //Position: 0x2794 / 10132
{
	if (!Function_56(iParam0))
	{
...
bool Function_60(int iParam0, int iParam1) //Position: 0x27E5 / 10213
{
	int iVar0;
...
bool Function_61(int iParam0) //Position: 0x2812 / 10258
{
	if (!Function_56(iParam0))
	{
...
void Function_62(int iParam0) //Position: 0x2864 / 10340
{
	int iVar0;
...
void Function_63(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x289E / 10398
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
void Function_64(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2E36 / 11830
{
	uParam3 = 2;
	uParam4 = 20.0f;
	uParam5 = 7.0f;
...
void Function_65() //Position: 0x2FD7 / 12247
{
	return;
}

void Function_66(var uParam0, int iParam1) //Position: 0x2FDD / 12253
{
	if (Global_6624)
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x301C / 12316
{
...
void Function_68() //Position: 0x3071 / 12401
{
	Function_95();
	Function_94();
	Function_94();
...
void Function_70() //Position: 0x31C2 / 12738
{
	float fVar0;
...
void Function_71() //Position: 0x31F5 / 12789
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x3388 / 13192
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_73() //Position: 0x3541 / 13633
{
	Function_74(&Global_42918, 1, 0);
	return;
}

void Function_74(struct<2317> Param0) //Position: 0x354F / 13647
{
	var uVar0;
	int iVar1;
	int iVar2;
...
var Function_75() //Position: 0x376C / 14188
{
...
struct<8> Function_76(int iParam0) //Position: 0x3781 / 14209
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_77(int iParam0, bool bParam1, bool bParam2) //Position: 0x3828 / 14376
{
	int iVar0;
...
void Function_78(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7) //Position: 0x3AC4 / 15044
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
...
var Function_79(int iParam0) //Position: 0x4103 / 16643
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_80(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x4114 / 16660
{
	char* cVar0[32];
...
struct<32> Function_81(char* cParam0) //Position: 0x420B / 16907
{
	char* cVar0[32];
...
void Function_82(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x4226 / 16934
{
	float fVar0;
...
var Function_83(int iParam0, int iParam1) //Position: 0x428D / 17037
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_84(int iParam0, bool bParam1) //Position: 0x429F / 17055
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_85(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x42B1 / 17073
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_86(int iParam0) //Position: 0x43E5 / 17381
{
	return Global_55480[iParam016].f_96;
}

float Function_87(int iParam0) //Position: 0x43F4 / 17396
{
	if (!iParam0 != 4294967295)
	{
...
var Function_88(int iParam0) //Position: 0x442D / 17453
{
	if (iParam0 == 4294967295)
	{
...
void Function_89(int iParam0) //Position: 0x446A / 17514
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x4604 / 17924
{
	int iVar0;
	int iVar1;
...
int Function_91(bool bParam0) //Position: 0x4848 / 18504
{
...
struct<8> Function_92() //Position: 0x4889 / 18569
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x4912 / 18706
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_94() //Position: 0x49A9 / 18857
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_95() //Position: 0x4A28 / 18984
{
...
int Function_96(int iParam0, bool bParam1, int iParam2) //Position: 0x4A65 / 19045
{
	int iVar0;
	int iVar1;
...
void Function_97() //Position: 0x4C71 / 19569
{
	struct<2> Var0;
	var uVar2;
...
struct<8> Function_98(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x4D28 / 19752
{
	int iVar0;
...
struct<8> Function_99() //Position: 0x4E20 / 20000
{
	return StackVal, Vector(0.0f, 0.0f, 0.0f);
}

bool Function_100(int iParam0) //Position: 0x4E2A / 20010
{
...
int Function_101(bool bParam0, bool bParam1) //Position: 0x4E40 / 20032
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float Function_102(struct<2> Param0, struct<2> Param2) //Position: 0x4F0C / 20236
{
	Param0.f_4 = 0.0f;
	Param2.f_4 = 0.0f;
...
struct<8> Function_103(float fParam0, int iParam1) //Position: 0x4F29 / 20265
{
	bool bVar0;
	struct<2> Var1;
	struct<2> Var3;
...
bool Function_104(int iParam0) //Position: 0x5755 / 22357
{
	var uVar0;
...
void Function_105(var uParam0, int iParam1) //Position: 0x5790 / 22416
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

bool Function_106(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x579F / 22431
{
	uParam0 = &uParam0;
...
void Function_107() //Position: 0x584E / 22606
{
	bool bVar0;
...
void Function_108(int iParam0) //Position: 0x58AC / 22700
{
	PRINTSTRING("Day ");
...
int Function_109(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x58F6 / 22774
{
	int iVar0;
	int iVar1;
...
void Function_110(int iParam0) //Position: 0x5B1E / 23326
{
	switch (iParam0)
	{
		case 0x00000009:
...
void Function_111(int iParam0, bool bParam1, bool bParam2) //Position: 0x5BBC / 23484
{
	int iVar0;
	bool bVar1;
	...
	switch (Global_21369.f_248)
	{
		case 0x00000000:
			if (iVar0 > 1000)
			{
				...
				Function_113(4, Function_119(Global_21369.f_248), 1);
...
void Function_112(int iParam0, int iParam1) //Position: 0x5D90 / 23952
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_113(int iParam0, char* cParam1) //Position: 0x5FFA / 24570
{
	bool bVar0;
	int iVar1;
...
int Function_114() //Position: 0x618A / 24970
{
	int iVar0;
...
void Function_115() //Position: 0x622B / 25131
{
	int iVar0;
	int iVar1;
...
void Function_116(int iParam0) //Position: 0x62E9 / 25321
{
...
int Function_117(int iParam0, char* cParam1) //Position: 0x634F / 25423
{
	int iVar0;
	var uVar1;
	...
	if (&bParam2)
	{
		...
		Function_118(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, iParam0, *(&Global_55480[iParam016] + 32), 3.0f, &uParam3);
	}
	return 1;
}

void Function_118(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, bool bParam10) //Position: 0x66A6 / 26278
{
	CLEAR_STAT_MESSAGE();
	if (!Global_77928)
	{
...
var Function_119(int iParam0) //Position: 0x672E / 26414
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_120(int iParam0, bool bParam1) //Position: 0x67BD / 26557
{
	bool bVar0;
	int iVar1;
...
var Function_121(int iParam0, int iParam1) //Position: 0x6969 / 26985
{
	int iVar0;
...
void Function_122() //Position: 0x69AE / 27054
{
	Function_124(3, 0.0f);
...
int Function_123(int iParam0, int iParam1) //Position: 0x69C4 / 27076
{
	if (iParam0 == 4294967295)
	{
...
int Function_124(int iParam0, int iParam1) //Position: 0x6A04 / 27140
{
	if (iParam0 == 4294967295)
	{
...
bool Function_125() //Position: 0x6A44 / 27204
{
...
var Function_126(bool bParam0) //Position: 0x6A6F / 27247
{
	return (*&Global_21369 + 168)[bParam0];
}

void Function_127(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, var uParam5, var uParam6, var uParam7) //Position: 0x6A7E / 27262
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_6623 != 1 && Global_10966 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_128(Global_10966) };
		}
...
struct<16> Function_128(int iParam0) //Position: 0x6B13 / 27411
{
	char* cVar0[16];
...
void Function_129(var uParam0, bool bParam1) //Position: 0x6B52 / 27474
{
	uParam0 = (uParam0 || bParam1);
	return;
}

bool Function_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6B63 / 27491
{
	var uVar0;
	var uVar6;
	bool bVar7;
...
int Function_131(var uParam0, int iParam1, struct<41> Param2) //Position: 0x6C1C / 27676
{
	if (!&bParam15)
	{
		Function_146(&iParam1, &uParam10);
	}
	switch (iParam1)
	{
		case 0x000003E8:
			if (uParam3 != 99 && (Function_145(&Param2) || Param2.f_40 < 1))
			{
				iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), &uParam0) || !Function_142())
					{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_138(&iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_138(&iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(&Global_54076, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_136(&Global_99170, &Global_10996);
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && uParam3 == 99) && !Function_145(&Param2))
			{
...
void Function_132(var uParam0, bool bParam1) //Position: 0x727E / 29310
{
	uParam0 = &uParam0;
	HUD_ENABLE(&uParam0);
	if (&bParam1)
...
void Function_133() //Position: 0x734D / 29517
{
	int iVar0;
...
void Function_134() //Position: 0x73C5 / 29637
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_135() //Position: 0x740A / 29706
{
...
void Function_136(var uParam0, int iParam1) //Position: 0x741C / 29724
{
	var uVar0;
	bool bVar1;
	var uVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(&uVar0))
	{
		...
		if (IS_OBJECT_VALID(&uVar2))
		{
			...
			if ((&iVar3 == &Global_54076 && !Function_137(&iVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(&iVar3))
			{
...
bool Function_137(int iParam0) //Position: 0x74AE / 29870
{
	bool bVar0;
...
float Function_138(vector3 vParam0) //Position: 0x74DF / 29919
{
	if (Function_140(&vParam0))
	{
		if (Function_139(&vParam0))
		{
			return vParam0.z;
		}
...
bool Function_139(int iParam0) //Position: 0x75AC / 30124
{
	return Function_50(iParam0, 2);
}

bool Function_140(int iParam0) //Position: 0x75BA / 30138
{
	return Function_50(iParam0, 1);
}

int Function_141(bool bParam0) //Position: 0x75C8 / 30152
{
	bool bVar0;
	var uVar1;
...
bool Function_142() //Position: 0x768B / 30347
{
	bool bVar0;
	var uVar1;
...
void Function_143(int iParam0) //Position: 0x76C8 / 30408
{
	Function_144(&iParam0, 0.0f);
	return;
}

void Function_144(vector3 vParam0) //Position: 0x76D5 / 30421
{
...
bool Function_145(struct<37> Param0) //Position: 0x76FA / 30458
{
	return Param0.f_36;
}

void Function_146(var uParam0, int iParam1) //Position: 0x7705 / 30469
{
	Function_147(&uParam0, &iParam1, 0);
	return;
}

void Function_147(var uParam0, bool bParam1, bool bParam2) //Position: 0x7715 / 30485
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_148(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x788D / 30861
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_149() //Position: 0x78B7 / 30903
{
	var uVar0;
	var uVar1;
...
void Function_150() //Position: 0x7912 / 30994
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int Function_151() //Position: 0x7A51 / 31313
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_152() //Position: 0x7A61 / 31329
{
	Function_153(2, 0, 1, 1, 1, 1, 0, 1, 1, 1, 1);
	DESTROY_VOLUME(&uLocal_370);
	return 1;
}

void Function_153(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9, bool bParam10) //Position: 0x7A7D / 31357
{
	var uVar0;
...
void Function_154() //Position: 0x7B4C / 31564
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_155() //Position: 0x7B61 / 31585
{
	SET_DRAW_OBJECT(&uLocal_340, 1);
	SET_DRAW_OBJECT(&uLocal_342, 1);
	SET_DRAW_OBJECT(&uLocal_344, 1);
	return 1;
}

int Function_156() //Position: 0x7B80 / 31616
{
	if (!iLocal_369)
	{
		Function_157(StackVal, Local_364, &uLocal_370);
		iLocal_369 = 1;
	}
	return 1;
}

void Function_157(vector3 vParam0) //Position: 0x7B9E / 31646
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Function_53(StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			else if (Function_158(&iVar1, &Global_54076) > 4.0f)
			{
				TELEPORT_ACTOR(&iVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(&iVar0))
		{
			if (&iVar0 != &iVar1)
			{
				...
				else if (Function_158(&iVar0, &Global_54076) > 4.0f)
				{
					TELEPORT_ACTOR(&iVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(&iVar2))
		{
			...
			else if (Function_158(&iVar2, &Global_54076) > 8.0f)
			{
				TELEPORT_ACTOR(&iVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_158(int iParam0, int iParam1) //Position: 0x7D47 / 32071
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_159(float fParam0, float fParam1) //Position: 0x7E3C / 32316
{
...
void Function_160() //Position: 0x7F4D / 32589
{
...
void Function_161() //Position: 0x7F81 / 32641
{
...
int Function_162() //Position: 0x808C / 32908
{
	return 1;
}

int Function_163() //Position: 0x8093 / 32915
{
	uLocal_370 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &iLocal_367, "tempcutscenevol", 2, *(&Global_99725[943] + 184), Vector(0.0f, 0.0f, 0.0f), Vector(20.0f, 20.0f, 20.0f));
	Function_166(0, 0, 1, 1, 1, 1, 1, &uLocal_370, 1, 1, 1, 1, 0x3f800000, 0);
	Function_164(StackVal, &iLocal_367, *(&Global_99725[943] + 196), &uLocal_370, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	SET_DRAW_OBJECT(&uLocal_340, 0);
	SET_DRAW_OBJECT(&uLocal_342, 0);
	SET_DRAW_OBJECT(&uLocal_344, 0);
	return 1;
}

void Function_164(var uParam0, struct<2> Param1, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, bool bParam8, bool bParam9) //Position: 0x8124 / 33060
{
	bool bVar0;
	var uVar1;
	struct<2> Var2;
...
void Function_165(var uParam0, float fParam1) //Position: 0x83C4 / 33732
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_166(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, var uParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11, var uParam12, var uParam13) //Position: 0x8446 / 33862
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (&bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_169(&uVar1);
				uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_22(), 2, Function_169(&uVar1), Vector(0.0f, 0.0f, 0.0f), Vector(100.0f, 100.0f, 100.0f));
...
void Function_167(int iParam0) //Position: 0x86F8 / 34552
{
	int iVar0;
...
var Function_168() //Position: 0x872C / 34604
{
	var uVar0;
	var uVar1;
	int iVar2;
...
struct<8> Function_169(int iParam0) //Position: 0x87BA / 34746
{
	struct<2> Var0;
...
void Function_170(bool bParam0) //Position: 0x87CC / 34764
{
	int iVar0;
...
bool Function_171(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x8820 / 34848
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
int Function_172(vector3 vParam0) //Position: 0x8A55 / 35413
{
	var uVar0;
...
float Function_173(var uParam0, bool bParam1) //Position: 0x8ACB / 35531
{
	struct<2> Var0;
...
void Function_174(var uParam0, bool bParam1) //Position: 0x8AEC / 35564
{
	var uVar0;
	var uVar1;
...
void Function_175(struct<229> Param0) //Position: 0x8B56 / 35670
{
	if (IS_BLIP_VALID(&Param0 + 272))
	{
		if (((!&bParam2 || Function_48(iParam1)) || Function_178(iParam1)) || iParam1 != &Param0 + 36)
		{
	...
	else if (&bParam2)
	{
		...
		if (!(Function_48(iParam1) || Function_178(iParam1)))
		{
...
void Function_176(struct<229> Param0) //Position: 0x8D59 / 36185
{
...
void Function_177(int iParam0, int iParam1) //Position: 0x8DE8 / 36328
{
	iParam0 = (iParam0 - (iParam0 && iParam1));
	return;
}

int Function_178(int iParam0) //Position: 0x8DFE / 36350
{
...
bool Function_179(struct<265> Param0) //Position: 0x8E13 / 36371
{
	if (!Param0.f_260 != 0)
	{
		if (Function_36(&Param0 + 260, 4))
		...
		if (Function_36(&Param0 + 260, 8) && Global_6606)
		{
			if (!Function_181(Param0.f_252, 0))
			{
				return 0;
			}
		}
		...
		return Function_180(&Param0);
	}
	return 1;
}

int Function_180(struct<261> Param0) //Position: 0x8EDF / 36575
{
	if (!Param0.f_260 != 0)
	{
		switch (Global_99472)
...
bool Function_181(int iParam0, bool bParam1) //Position: 0x8F9A / 36762
{
...
void Function_182() //Position: 0x8FD1 / 36817
{
	var uVar0;
	
	Function_183(4, 1);
	uVar0 = &uVar0;
	iLocal_367 = CREATE_LAYOUT("AztecGold_layout");
	return;
}

void Function_183(int iParam0, int iParam1) //Position: 0x8FFC / 36860
{
	switch (&iParam1)
	{
		case 0x00000000:
...
int Function_184(int iParam0, float fParam1, float fParam2, float fParam3, int iParam4) //Position: 0x9046 / 36934
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
int Function_185(struct<257> Param0) //Position: 0x91D1 / 37329
{
...
int Function_186(var uParam0, int iParam1, struct<2> Param2, bool bParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x920D / 37389
{
	char* cVar0[64];
	struct<2> Var16;
	struct<2> Var18;
...
void Function_187() //Position: 0x9475 / 38005
{
	bool bVar0;
	struct<2> Var1;
	struct<5> Var3;
...
void Function_188(char* cParam0) //Position: 0x94C9 / 38089
{
	char* cVar0[64];
...
bool Function_189(var uParam0, struct<2> Param1, float fParam3) //Position: 0x95F2 / 38386
{
...
int Function_190() //Position: 0x967E / 38526
{
	if (IS_PS3())
	{
		return 1;
...
int Function_191(struct<2>[] Param0) //Position: 0x968D / 38541
{
	int iVar0;
	int iVar1;
...
void Function_192() //Position: 0x9A4F / 39503
{
	if (!Function_46(128))
	{
		return;
...
bool Function_193() //Position: 0x9A8F / 39567
{
	int iVar0;
...
void Function_194(struct<13> Param0) //Position: 0x9ABD / 39613
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

void Function_195() //Position: 0x9AD0 / 39632
{
	if (!Function_46(128))
	{
		return;
...
var Function_196(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x9B12 / 39698
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_197(&Param0, &uVar1, iParam2);
	if (&bParam3)
	{
		Function_194(&(Param0[iVar02]), 8);
	}
...
var Function_197(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x9B50 / 39760
{
	int iVar0;
