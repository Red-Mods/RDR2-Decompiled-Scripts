...
void main() //Position: 0x0 / 0
{
	...
	iLocal_112 = 0;
	Function_114(&uScriptParam_0, &iLocal_112);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_107(&(vLocal_2[iVar39]), &bVar4))
						{
							Function_105(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_2[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_100("eGRINGO_EndUse: Stop use by request", &vLocal_2[iVar39] + 24);
							Function_99(&vLocal_2[iVar39] + 24, 1);
							...
							{
								Function_75(&(vLocal_2[iVar39]), 0);
							}
							else if (vLocal_2[iVar39].f_68 < 8)
							{
								Function_74(&(vLocal_2[iVar39]));
...
void Function_29(var uParam0, var uParam1) //Position: 0x1FF5 / 8181
{
	...
	bVar0 = GRINGO_GET_INDEX_OF_NEXT_CHILD(1, &uParam1, false);
	uParam0 = &uParam0;
	while (bVar0 >= 4294967295)
	{
		uVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(bVar0, &uParam1);
		PRINTINT(bVar0);
		PRINTNL();
		if (IS_GRINGO_COMPONENT_VALID(&uVar1))
		{
			iVar2 = GRINGO_GET_PROP_FROM_COMPONENT(&uVar1);
			if (IS_PHYSINST_VALID(&iVar2))
			{
				uVar3 = GET_OBJECT_FROM_PHYSINST(&iVar2);
				if (IS_OBJECT_VALID(&uVar3))
				{
					PRINTSTRING(GET_OBJECT_NAME(&uVar3));
					PRINTNL();
					GET_OBJECT_POSITION(&uVar3, &Var4);
					PRINTVECTOR(Var4);
					PRINTNL();
					GIVE_OBJECT_TO_ACTOR(&uVar3, &uParam0);
				}
			}
		}
		bVar0 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, &uParam1, bVar0 + 1);
	}
	return;
}

bool Function_30(char* cParam0) //Position: 0x20A0 / 8352
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x20AD / 8365
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x20C8 / 8392
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x20E8 / 8424
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2108 / 8456
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x213F / 8511
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x215F / 8543
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x217A / 8570
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2190 / 8592
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x24B4 / 9396
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x24BD / 9405
{
	return Function_9(&cParam0, "TargetLocator", &iParam1);
}

void Function_41() //Position: 0x24DC / 9436
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(char* cParam0, int iParam1) //Position: 0x24EB / 9451
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x250F / 9487
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x2535 / 9525
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x2553 / 9555
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x2575 / 9589
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2597 / 9623
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x265F / 9823
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x26DB / 9947
{
...
void Function_50(vector3 vParam0) //Position: 0x26F3 / 9971
{
...
var Function_51(int iParam0) //Position: 0x2718 / 10008
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x2739 / 10041
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2750 / 10064
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x275C / 10076
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2763 / 10083
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2774 / 10100
{
	bool bVar0;
...
int Function_57(int iParam0) //Position: 0x27B9 / 10169
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x27E5 / 10213
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x27F1 / 10225
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x28F3 / 10483
{
	return Function_7(&iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2916 / 10518
{
	return Function_11(&iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x293E / 10558
{
	iParam0 = &iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x294A / 10570
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x2956 / 10582
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2975 / 10613
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x298C / 10636
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_67(int iParam0) //Position: 0x2A1D / 10781
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x2A41 / 10817
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x2A60 / 10848
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x2A84 / 10884
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2BAC / 11180
{
...
int Function_72(var uParam0) //Position: 0x2BDA / 11226
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2CF3 / 11507
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2D00 / 11520
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2D82 / 11650
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x332D / 13101
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x3367 / 13159
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x3385 / 13189
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x33C6 / 13254
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x33D2 / 13266
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x33F4 / 13300
{
	bool bVar0;
	var uVar1;
	int iVar2;
	...
	bVar0 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, &iParam1, 0);
	iParam1 = &iParam1;
	uParam0 = &uParam0;
	Function_82(20, 1, 1);
	while (bVar0 >= 4294967295)
	{
		uVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(bVar0, &iParam1);
		PRINTINT(bVar0);
		PRINTNL();
		if (IS_GRINGO_COMPONENT_VALID(&uVar1))
		{
		...
		bVar0 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, &iParam1, bVar0 + 1);
	}
	return;
}

int Function_82(bool bParam0, bool bParam1, bool bParam2) //Position: 0x34B0 / 13488
{
	bool bVar0;
...
int Function_83(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3582 / 13698
{
	int iVar0;
	int iVar1;
...
void Function_84(bool bParam0) //Position: 0x37AA / 14250
{
	switch (bParam0)
	{
		case 0x00000009:
...
void Function_85(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, var uParam5, bool bParam6, var uParam7) //Position: 0x3848 / 14408
{
	char* cVar0[32];
	bool bVar8;
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_131807.f_1316 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(&uParam7), &Global_55480[iParam016] + 32, Function_86(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_131807.f_1316 + 1, Function_39(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_86(int iParam0) //Position: 0x3E86 / 16006
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_87(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3E97 / 16023
{
	char* cVar0[32];
...
struct<32> Function_88(char* cParam0) //Position: 0x3F8E / 16270
{
	char* cVar0[32];
...
void Function_89(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3FA9 / 16297
{
	float fVar0;
...
var Function_90(int iParam0, int iParam1) //Position: 0x4011 / 16401
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_91(int iParam0, bool bParam1) //Position: 0x4023 / 16419
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_92(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x4035 / 16437
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_93(int iParam0) //Position: 0x4169 / 16745
{
	return Global_55480[iParam016].f_96;
}

float Function_94(int iParam0) //Position: 0x4178 / 16760
{
	if (!iParam0 != 4294967295)
	{
...
var Function_95(int iParam0) //Position: 0x41B1 / 16817
{
	if (iParam0 == 4294967295)
	{
...
void Function_96(int iParam0) //Position: 0x41EE / 16878
{
	if (Global_55480[iParam016].f_112 == 0.0f)
	{
...
int Function_97(int iParam0, float fParam1, bool bParam2) //Position: 0x4388 / 17288
{
	int iVar0;
	int iVar1;
...
int Function_98(int iParam0) //Position: 0x45CC / 17868
{
	if (iParam0 == 4294967295)
	{
...
void Function_99(var uParam0, bool bParam1) //Position: 0x460D / 17933
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_100(int iParam0, int iParam1) //Position: 0x471D / 18205
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_101(struct<69> Param0) //Position: 0x4735 / 18229
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_102(int iParam0, int iParam1) //Position: 0x4A51 / 19025
{
	iParam1 = &iParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_103(int iParam0) //Position: 0x4A63 / 19043
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_104(int iParam0) //Position: 0x4A7D / 19069
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_105(int iParam0, var uParam1) //Position: 0x4A98 / 19096
{
	bool bVar0;
	int iVar1;
...
bool Function_106(var uParam0, int iParam1) //Position: 0x4AD6 / 19158
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_107(struct<65> Param0) //Position: 0x4AEF / 19183
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_108(int iParam0) //Position: 0x4DE7 / 19943
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_109(var uParam0, int iParam1) //Position: 0x4E05 / 19973
{
	struct<5> Var0;
	float fVar5;
...
int Function_110(int iParam0) //Position: 0x4EA5 / 20133
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_111(int iParam0, var uParam1) //Position: 0x4EC5 / 20165
{
	uParam1 = &uParam1;
	iParam0 = &iParam0;
	return 1;
...
bool Function_112(int iParam0) //Position: 0x4ED8 / 20184
{
...
void Function_113(int iParam0) //Position: 0x4EF4 / 20212
{
	iParam0 = &iParam0;
	return;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4F00 / 20224
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_115(&(vLocal_2[iLocal_1129]), &uParam0);
		iLocal_112++;
	}
...
void Function_115(int iParam0, int iParam1) //Position: 0x4F6C / 20332
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_116(int iParam0) //Position: 0x4F84 / 20356
{
	iParam0 = &iParam0;
	return;
}

void Function_117(bool bParam0) //Position: 0x4F90 / 20368
{
