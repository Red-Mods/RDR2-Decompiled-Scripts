...
void main() //Position: 0x0 / 0
{
	...
	Global_46972[8] = Function_13("farmyard_animals", 1);
	Function_8(&(Global_46972[8]), 1128, 10.0f, 30, 0, 0);
	...
	Function_11(&(Global_46972[3]), 398, 1.0f, 0, 0);
	Function_11(&(Global_46972[3]), 397, 4.0f, 0, 0);
	...
	uVar0 = FIND_NAMED_LAYOUT("Tumbleweed_layout");
	if (IS_LAYOUTREF_VALID(&uVar0))
	{
		uVar1 = FIND_VOLUME_IN_LAYOUT(&uVar0, "TumPopArea_1_set");
		if (IS_VOLUME_VALID(&uVar1))
		{
			Function_3(&uVar1, &(Global_46972[5]), 5E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xBC3 / 3011
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xBD4 / 3028
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC2C / 3116
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xCBC / 3260
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xCD8 / 3288
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD18 / 3352
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD35 / 3381
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD46 / 3398
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xDC4 / 3524
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE30 / 3632
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE9C / 3740
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF1E / 3870
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, int iParam1) //Position: 0xF65 / 3941
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_14(int iParam0) //Position: 0xF74 / 3956
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

void Function_15(char* cParam0) //Position: 0xF81 / 3969
{
	if (!Function_4(128))
	{
		return;
