...
bool Function_16() //Position: 0x41A / 1050
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_26(Global_46816[0], &Local_35 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_25(Global_46816[0], 0);
				(&Local_35 + 232) = Function_25(Global_46816[0], 0);
				Function_24(&Local_35 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_35 + 68)[iVar0] = iLocal_4 * 10;
					Function_23(Global_46816[0], iVar0, 0);
					*(&Local_35 + 128[iVar02]) = Function_23(Global_46816[0], iVar0, 0);
					iVar0++;
				}
				Local_35.f_252 = 2;
				Local_35.f_244 = 0;
				Local_35.f_8 = Local_7;
				Function_22(Global_46816[0]);
				*(&Local_35 + 268) = Function_22(Global_46816[0]);
				Function_21(Global_46816[0]);
				*(&Local_35 + 280) = Function_21(Global_46816[0]);
...
void Function_17() //Position: 0x5BA / 1466
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5C3 / 1475
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x5E4 / 1508
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x61B / 1563
{
	if (!Function_8(iParam0))
	{
		return;
...
struct<8> Function_21(int iParam0) //Position: 0x636 / 1590
{
...
struct<8> Function_22(int iParam0) //Position: 0x738 / 1848
{
	if (iParam0 == Global_46816[0])
	{
...
struct<8> Function_23(int iParam0, int iParam1, bool bParam2) //Position: 0x83A / 2106
{
	if (iParam0 == Global_46816[0])
	{
		switch (iParam1)
...
void Function_24(int[] iParam0) //Position: 0xDE6 / 3558
{
	int iVar0;
	var uVar1;
...
struct<8> Function_25(int iParam0, bool bParam1) //Position: 0xE42 / 3650
{
	if (iParam0 == Global_46816[0])
	{
...
bool Function_26(int iParam0, var[] uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF5E / 3934
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x116C / 4460
{
...
bool Function_28() //Position: 0x1230 / 4656
{
	return ((Global_54082 != 0 || Global_54082 != 2) || Global_54082 != 3);
}

bool Function_29(int iParam0) //Position: 0x1247 / 4679
{
	return IS_ACTOR_IN_HOGTIE(&iParam0);
}

bool Function_30(int iParam0) //Position: 0x1253 / 4691
{
	return IS_ACTOR_VALID(GET_LASSO_USER(&iParam0));
}

void Function_31(var uParam0, int iParam1) //Position: 0x1262 / 4706
{
	GET_POSITION(&uParam0, &iParam1);
	return;
}

var Function_32(var uParam0, bool bParam1) //Position: 0x1271 / 4721
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_33() //Position: 0x12B3 / 4787
{
	return Function_34(0);
}

int Function_34(bool bParam0) //Position: 0x12BD / 4797
{
...
bool Function_35() //Position: 0x12FE / 4862
{
...
var Function_36(int iParam0) //Position: 0x1329 / 4905
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_37() //Position: 0x1343 / 4931
{
	Function_1();
	return;
}

void Function_38() //Position: 0x134C / 4940
{
...
void Function_40(vector3 vParam0) //Position: 0x13B3 / 5043
{
...
void Function_41(var uParam0, int iParam1) //Position: 0x13D8 / 5080
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x13EE / 5102
{
	uParam0 = (uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0x13FF / 5119
{
	return Function_44(iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0x140D / 5133
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0x141A / 5146
{
	return;
}

void Function_46() //Position: 0x1420 / 5152
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x1426 / 5158
{
	var uVar0;
...
void Function_48(var uParam0) //Position: 0x1485 / 5253
{
	int iVar0;
...
var Function_49() //Position: 0x14A2 / 5282
{
	var uVar0;
