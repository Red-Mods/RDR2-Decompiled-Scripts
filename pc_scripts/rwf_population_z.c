...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_21682, "Rwf", 4);
	Function_15("Loading Ridgewood Farm population file", 3);
	Global_47148++;
	...
	uVar3 = FIND_NAMED_LAYOUT("RidgewoodFarm_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "rwfv_zombies_01");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar1, 1, 4, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("RWF_POP: Cannot find rwfv_zombies_01 to create population volumes");
		}
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "rwfv_zombies_01");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 10, 20, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("RWF_POP: Cannot find rwfv_zombies_01 to create population volumes");
		}
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "rwfv_zombies_02");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar1, 1, 3, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("RWF_POP: Cannot find rwfv_zombies_02 to create population volumes");
		}
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "rwfv_zombies_02");
		if (IS_VOLUME_VALID(&uVar4))
		{
			Function_3(&uVar4, &bVar0, 5, 7, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("RWF_POP: Cannot find rwfv_zombies_02 to create population volumes");
	...
	Function_5("Finished loading Ridgewood Farm population file", 5.0f);
	Function_1(&(Global_43791[iLocal_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xE40 / 3648
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xE51 / 3665
{
	int iVar0;
...
var Function_3(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xEA9 / 3753
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xF3B / 3899
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xF57 / 3927
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xF97 / 3991
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xFB4 / 4020
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xFC5 / 4037
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1043 / 4163
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x10AF / 4271
{
	bool bVar0;
...
var Function_11(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x111B / 4379
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1162 / 4450
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_13(bool bParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x116F / 4463
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, int iParam1) //Position: 0x11F1 / 4593
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_15(char* cParam0) //Position: 0x1200 / 4608
{
	if (!Function_4(128))
	{
		return;
