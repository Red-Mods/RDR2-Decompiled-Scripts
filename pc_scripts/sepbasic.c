...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_47 + 2140) = Vector(-1372,93f, 13,051f, 4281,811f);
...
void Function_3(bool bParam0, var uParam1, int iParam2) //Position: 0x8CF / 2255
{
	bool bVar0;
...
void Function_4(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9B9 / 2489
{
	int iVar0;
...
void Function_45(bool bParam0, int iParam1) //Position: 0x1D51 / 7505
{
	struct<13> Var0;
...
void Function_60(bool bParam0, bool bParam1) //Position: 0x22FC / 8956
{
	if (Function_102(4))
	{
...
void Function_94(var uParam0, bool bParam1) //Position: 0x3379 / 13177
{
	var uVar0;
	var uVar1;
	int iVar2;
...
var Function_116(var uParam0, struct<2> Param1, bool bParam3) //Position: 0x3B48 / 15176
{
	...
	return CREATE_PROP_IN_LAYOUT(StackVal, StackVal, StackVal, Vector("", &uParam0, StackVal) + Vector(Var4, Param1, Function_117()), Vector(0.0f, (bParam2 + 180.0f), 0.0f), true);
}
