...
void main() //Position: 0x0 / 0
{
	...
	bVar1 = Function_11("zombie_dogs", 0);
	Function_10(&bVar1, 1240, 10.0f, 0, 0);
	...
	uVar3 = FIND_NAMED_LAYOUT("CasaMadrugada_layout");
	if (IS_LAYOUTREF_VALID(&uVar3))
	{
		uVar4 = FIND_VOLUME_IN_LAYOUT(&uVar3, "casv_region");
...
void Function_1(var uParam0, var uParam1) //Position: 0xC9A / 3226
{
	uParam0 = (uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCAB / 3243
{
	int iVar0;
...
var Function_3(var uParam0, var uParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD03 / 3331
{
	var uVar0;
...
bool Function_4(int iParam0) //Position: 0xD93 / 3475
{
	int iVar0;
...
void Function_5(char* cParam0) //Position: 0xDAF / 3503
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDEF / 3567
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xE0C / 3596
{
...
var Function_8(bool bParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE1D / 3613
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE64 / 3684
{
	DESTROY_POPULATION_SET(&iParam0);
	return;
}

var Function_10(bool bParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE71 / 3697
{
	int iVar0;
	int iVar1;
...
var Function_11(var uParam0, int iParam1) //Position: 0xEF3 / 3827
{
	return CREATE_NAMED_POPULATION_SET(&uParam0, &iParam1);
}

void Function_12(char* cParam0) //Position: 0xF02 / 3842
{
	if (!Function_4(128))
	{
		return;
