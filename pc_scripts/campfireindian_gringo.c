...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 360) = 2;
	if (bVar2)
	{
		Function_117(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireLarge01x");
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			iVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, iVar1, 0, 0, "ped_wilderness", 5.0f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(iVar0);
...
void Function_1(struct<473> Param0) //Position: 0x13D / 317
{
	int iVar0;
...
void Function_2() //Position: 0x2EB / 747
{
	return;
}

void Function_3() //Position: 0x2F1 / 753
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2FA / 762
{
...
void Function_5(int iParam0) //Position: 0x30D / 781
{
	int iVar0;
...
void Function_6(struct<2>[] Param0, int iParam1) //Position: 0x335 / 821
{
...
void Function_7(struct<13> Param0) //Position: 0x480 / 1152
{
	int iVar0;
...
bool Function_8(struct<13> Param0) //Position: 0x49D / 1181
{
	int iVar0;
...
int Function_9(struct<477> Param0) //Position: 0x4BB / 1211
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if (Global_6611)
			{
				if (Function_114(StackVal, &Global_54076, Var7) < 10.0f)
				{
					break;
				}
			}
			if ((Global_39620 + 1 > iLocal_37 || bParam2) || Global_6611)
			{
				if (Function_113(&Var7, 50.0f, &Param0 + 324, 4294967295))
				{
					if (((!bParam2 && !Function_111(&Param0 + 324, &fLocal_39, 256, 0)) && !Global_6611) && 1)
					{
						iVar12 = 1000;
					}
					else
					{
						...
						if ((IS_POPSET_VALID(&uVar3) && IS_POPSET_VALID(&(Global_46972[6]))) && !bParam2)
						{
							...
							{
								(*&Param0 + 48)[0] = Function_110();
								(*&Param0 + 48)[1] = Function_109();
								Function_108(&Param0 + 120, (*&Param0 + 48)[0], 2, 0);
								Function_108(&Param0 + 120, (*&Param0 + 48)[1], 2, 0);
								iVar1 = 2;
							}
							if (iParam3 >= 1)
							{
								(*&Param0 + 96)[0] = Function_100(&(Global_46972[6]), 0, 4, 23, 1);
								(*&Param0 + 96)[1] = Function_100(&(Global_46972[6]), 0, 4, 23, 1);
								...
								Function_108(&Param0 + 120, (*&Param0 + 96)[0], 2, 0);
								Function_108(&Param0 + 120, (*&Param0 + 96)[1], 2, 0);
							}
							else
							{
								(*&Param0 + 96)[0] = Function_100(&(Global_46972[6]), 0, 0, 23, 1);
								if ((*&Param0 + 96)[0] == 4294967295)
								{
									(*&Param0 + 96)[0] = 977;
								}
							...
							while (iVar1 <= iParam3)
							{
								...
								{
									(*&Param0 + 48)[iVar1] = Function_100(&uVar3, 1, 1, 4294967295, 1);
								}
								else
								{
									(*&Param0 + 48)[iVar1] = Function_100(&uVar3, 1, 0, 4294967295, 1);
								}
								...
								Function_108(&Param0 + 120, (*&Param0 + 48)[iVar1], 2, 0);
								iVar1++;
							}
						}
						else if (!bParam2 && 1)
						...
						if (!bParam2 || 0)
						{
							uVar0 = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Global_39615, Function_99(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector(fLocal_39, 20.0f, fLocal_39));
							DECOR_SET_INT(&uVar0, "script", GET_THIS_SCRIPT_ID());
							DECOR_SET_INT(&uVar0, "category", 256);
							Global_39620++;
							Function_95(&uVar0, 0);
							*(&Param0 + 480) = CREATE_VOLUME_IN_LAYOUT(StackVal, StackVal, &Param0 + 16, Function_99(), 4,203895E-45f, *(&Param0 + 324), Vector(0.0f, 0.0f, 0.0f), Vector((&fParam7 + 1,5f), 9.0f, (&fParam7 + 1,5f)));
						}
						Param0.f_8 = 1;
					}
				}
		...
		case 0x00000006:
			Function_70(&Param0, &iVar12);
			break;
		
		case 0x00000001:
			if (Function_66(&Param0 + 120))
			{
				Param0.f_8 = 4;
			}
			iVar12 = 0;
		...
		case 0x00000002:
			...
			{
				if (((Function_114(StackVal, &Global_54076, *(&Param0 + 324)) < 120.0f || bParam2) || Global_6611) || 0)
				{
					if (UNK_0x214AFB8C(&Param0 + 32))
					{
						if (IS_OBJECT_VALID(&Param0 + 352))
						...
						uVar6 = CREATE_PROP_IN_LAYOUT_BY_ID(&Param0 + 16, Function_99(), &Param0 + 32, *(&Param0 + 324), *(&Param0 + 336), 0);
						Param0 = CREATE_RMPTFX_EMITTER_ON_OBJECT(StackVal, Function_99(), "amb_campfire_light", &uVar6, Vector(0.0f, 0.0f, 0.0f), 1, &uVar6);
					...
					Function_57(StackVal, &Param0 + 464, &Param0 + 472, &Param0 + 468, &fParam7, *(&Param0 + 324));
					Param0.f_8 = 5;
					iVar12 = 0;
					Param0.f_432 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(&Param0 + 40))
			{
				...
				Function_56(StackVal, StackVal, &Param0 + 16, Function_99(), GET_ASSET_NAME(&Param0 + 40, 7), *(&Param0 + 324), *(&Param0 + 336), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && 1)
			{
				*(&Param0 + 392) = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(&Param0 + 24, Function_99()));
				*(&Param0 + 456) = CREATE_OBJECT_ITERATOR(&Param0 + 24);
				iVar1 = 0;
				while (iVar1 <= iParam3)
				{
					Function_53(&Param0 + 16, &Param0 + 456, &Param0 + 392, (*&Param0 + 48)[iVar1], &Param0 + 272[iVar1], &Param0 + 480, iVar1);
					iVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_52(&Param0 + 24, &Param0 + 16, &Param0 + 96, 2, &Param0 + 360);
				}
				else
				{
					Function_52(&Param0 + 24, &Param0 + 16, &Param0 + 96, 1, &Param0 + 360);
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(&uParam6, "bad") && !STRING_CONTAINS_STRING(&uParam6, "law")) && &iParam8 != 1)
							{
								if (VDIST(*(&Param0 + 324), Global_54078) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player"))
									{
										...
										Function_41(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, 0));
										fLocal_41 = GET_CURRENT_GAME_TIME();
										Param0.f_428 = 1;
									}
								}
							}
			...
			if ((Param0.f_428 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(&Global_54076, "rand_idle_sit_ground_player")) && !Param0.f_436)
			{
				if (SQUAD_IS_VALID(&Param0 + 392) && SQUAD_GET_SIZE(&Param0 + 392) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_41) < 10.0f)
						{
			...
			if (!bParam2 && !bVar11)
			{
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					...
					{
						if (Function_36(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), &iLocal_40, &Param0 + 488, 0, 0, 0x40400000))
						{
							...
							Param0.f_440 = 1;
							Function_35(&Param0 + 392, 1);
							Function_34(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
							if (iLocal_40 == 8)
							{
					...
					while (iVar1 <= Param0.f_360)
					{
						if (IS_ACTOR_VALID(&Param0 + 360[iVar1]))
						{
							if (GET_LAST_ATTACKER(&Param0 + 360[iVar1]) != &Global_54076 || GET_RIDER(&Param0 + 360[iVar1]) != &Global_54076)
							{
								...
								Function_35(&Param0 + 392, 1);
								Function_34(&Param0 + 392, &Global_54076, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_33(&Param0 + 392), &Global_54076);
								Param0.f_8 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar11)
			{
				Function_28(&Param0, bParam2, 0);
			}
			else if (Param0.f_416)
			{
				Function_28(&Param0, bParam2, 1);
			}
			if (!Param0.f_428)
			{
			}
			if (GET_VEHICLE(Function_27()) != &Param0 + 384 && IS_ACTOR_VALID(&Param0 + 384))
			{
				Function_26(&Param0 + 392, Function_27(), 4);
				Function_25(&Param0 + 392, Function_27());
			}
			...
			if (!bParam2 && !bVar11)
			{
				if (Function_24(StackVal, Var7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_38379 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(&Param0 + 392))
				{
					if (Function_23(&Param0 + 392, 1.0f, 80.0f, 1, 1))
					{
						Global_38379 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (iVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1)))
					{
						if (!Param0.f_440)
						{
							...
							Function_14(SQUAD_GET_ACTOR_BY_INDEX(&Param0 + 392, iVar1), 4, 0, 2);
						}
...
void Function_10(int iParam0) //Position: 0x167A / 5754
{
	if (!iLocal_36)
	{
		if (SQUAD_IS_VALID(&iParam0 + 392))
		{
			Function_11(&iParam0 + 392, GET_PLAYER_ACTOR(0), 4);
			iLocal_36 = 1;
		}
	}
	return;
...
void Function_11(var uParam0, int iParam1, bool bParam2) //Position: 0x16A5 / 5797
{
	int iVar0;
	var uVar1;
...
void Function_12(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1722 / 5922
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	while (iVar0 <= SQUAD_GET_SIZE(&uParam0))
	{
		...
		if (IS_ACTOR_VALID(&uVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(&uVar1))
			{
				...
				{
					if (!Function_13(&uVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&uVar1);
					}
					if (!Function_13(&bVar2, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(&bVar2);
					}
				}
...
bool Function_13(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x195B / 6491
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), &uParam0, &iParam1, &iParam2, &iParam3, &iParam4, &iParam5);
}

int Function_14(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x197B / 6523
{
	int iVar0;
	var uVar1;
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		...
		Function_15(&uParam0, &iParam1, &uParam2, &uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_15(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x1A69 / 6761
{
	char* cVar0[32];
...
int Function_16(int iParam0) //Position: 0x1CD5 / 7381
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(&iParam0), "actorRoam_behavior");
}

void Function_17(var uParam0, bool bParam1) //Position: 0x1CF9 / 7417
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_18(var uParam0, int iParam1) //Position: 0x1D1D / 7453
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_target", &iParam1);
	return;
}

void Function_19(var uParam0, bool bParam1) //Position: 0x1D43 / 7491
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_20(var uParam0, bool bParam1) //Position: 0x1D6A / 7530
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(&uParam0), "actorRoam_state", bParam1);
	return;
}

int Function_21(bool bParam0) //Position: 0x1D8E / 7566
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(&bParam0), "actorRoam_ref");
}

void Function_22() //Position: 0x1DAD / 7597
{
...
bool Function_23(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1DFC / 7676
{
	int iVar0;
	var uVar1;
	...
	if (SQUAD_IS_VALID(&uParam0))
	{
		...
		while (iVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(&uVar1))
			{
				if (Function_13(&uVar1, &uParam1, &uParam2, &uParam3, &uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_24(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x1E58 / 7768
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), Param0, &uParam2, &uParam3, &uParam4, &uParam5, &uParam6);
}

void Function_25(var uParam0, int iParam1) //Position: 0x1E79 / 7801
{
	int iVar0;
	var uVar1;
...
void Function_26(var uParam0, var uParam1, bool bParam2) //Position: 0x1ED4 / 7892
{
	int iVar0;
	var uVar1;
...
var Function_27() //Position: 0x1F20 / 7968
{
...
void Function_28(struct<425> Param0) //Position: 0x1F35 / 7989
{
	int iVar0;
	int iVar1;
	...
	if (!Function_32(&Param0 + 392))
	{
		return;
	}
	if (!Function_29(StackVal, &Param0 + 392, (&Param0 + 324), 10.0f))
	{
		return;
	}
	if (VDIST(*(&Param0 + 324), Global_54078) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_33(&Param0 + 392), &Global_54076, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_33(&Param0 + 392), &Global_54076, 5.0f);
		iVar1 = 0;
		while (iVar1 <= SQUAD_GET_SIZE(&Param0 + 392))
		{
		...
		if (&bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_33(&Param0 + 392), 96, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_33(&Param0 + 392), 120, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		Param0.f_424 = 1;
	}
	return;
...
bool Function_29(var uParam0, struct<2> Param1, float fParam3) //Position: 0x2088 / 8328
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < (SQUAD_GET_SIZE(&uParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(&iVar1))
		{
			...
			{
				Function_30(&iVar1);
				if (VDIST(Function_30(&iVar1), Param1) >= fParam3)
				{
					iVar2 = 1;
				}
			}
...
struct<8> Function_30(int iParam0) //Position: 0x20FD / 8445
{
	struct<2> Var0;
...
bool Function_31(vector3 vParam0) //Position: 0x2169 / 8553
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_32(var uParam0) //Position: 0x2181 / 8577
{
	int iVar0;
	int iVar1;
...
var Function_33(bool bParam0) //Position: 0x21DF / 8671
{
	bool bVar0;
	int iVar1;
...
void Function_34(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x222C / 8748
{
	int iVar0;
	var uVar1;
...
void Function_35(var uParam0, bool bParam1) //Position: 0x22A5 / 8869
{
	int iVar0;
	var uVar1;
...
bool Function_36(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x22F4 / 8948
{
	float fVar0;
	...
	if (IS_ACTOR_VALID(&iParam0) && !&bParam4)
	{
		fVar0 = Function_40(&iParam0, &Global_54076);
		if (!Function_39(&uParam3, 8))
		{
...
void Function_37(int iParam0) //Position: 0x24BD / 9405
{
...
void Function_38(int iParam0) //Position: 0x24FA / 9466
{
	SAY_SINGLE_LINE_CONTEXT(&iParam0, 60, &Global_54076, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x2513 / 9491
{
	return (uParam0 && iParam1) == 0;
}

var Function_40(var uParam0, int iParam1) //Position: 0x2520 / 9504
{
	struct<2> Var0;
	struct<2> Var2;
...
void Function_41(var uParam0) //Position: 0x2615 / 9749
{
	struct<21> Var0;
	
	bVar6 = Function_51(GET_ACTOR_ENUM(&uParam0), &Var0);
	if (bVar6)
	{
		iVar7 = Function_43(&Var0);
		iVar8 = 0;
		if (iVar7 == 2)
		{
			if (Function_42())
...
bool Function_42() //Position: 0x26D4 / 9940
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_43(struct<25> Param0) //Position: 0x26E7 / 9959
{
	var uVar0;
	int iVar1;
	var uVar2;
	...
	Param0.f_20 = 0;
	(&Param0 + 24)->f_20 = 0;
	if (Function_48(Param0, 0))
	{
		uVar0 = Function_44(StackVal);
...
var Function_44(int iParam0) //Position: 0x27AE / 10158
{
...
bool Function_45(int iParam0) //Position: 0x27CE / 10190
{
	if (!Function_47(iParam0))
	{
		return 0;
	}
	if (!Function_46(StackVal))
	{
		return 0;
	}
	return 1;
...
bool Function_46(int iParam0) //Position: 0x27F2 / 10226
{
...
bool Function_47(int iParam0) //Position: 0x2807 / 10247
{
...
bool Function_48(var uParam0, bool bParam1) //Position: 0x281E / 10270
{
	int iVar0;
	
	iVar0 = Function_49(uParam0);
...
var Function_49(int iParam0) //Position: 0x285C / 10332
{
...
bool Function_50(int iParam0) //Position: 0x2876 / 10358
{
...
int Function_51(int iParam0, struct<6> Param1) //Position: 0x288C / 10380
{
	int iVar0;
...
void Function_52(var uParam0, char* cParam1, bool[] bParam2, int iParam3, var[] uParam4) //Position: 0x28C6 / 10438
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var3;
	...
	while (IS_OBJECT_VALID(&uVar5) && iVar0 > iParam3)
	{
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(&uVar5)))
		{
			if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(&uVar5), "horse_stay"))
			{
				...
				uVar7 = CREATE_ACTOR_IN_LAYOUT(&cParam1, Function_99(), bParam2[iVar0], Var1, Var3);
...
void Function_53(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4, var uParam5, int iParam6) //Position: 0x29AB / 10667
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	uVar6 = CREATE_ACTOR_IN_LAYOUT(&uParam0, Function_99(), bParam3, Var2, Var4);
...
void Function_54(var uParam0, bool bParam1) //Position: 0x2B62 / 11106
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return;
...
void Function_55(bool bParam0) //Position: 0x2B87 / 11143
{
	var uVar0;
	int iVar1;
...
var Function_56(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, int iParam7) //Position: 0x2BD5 / 11221
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_57(var uParam0, var uParam1, var uParam2, float fParam3, struct<2> Param4) //Position: 0x2D2C / 11564
{
	var uVar0[5];
	int iVar6;
	...
	{
		if (Function_58(StackVal, &Global_46715, "player_herb", &uVar0, 20.0f, 5, Param4) >= 0)
		{
			iVar6 = 0;
			while (iVar6 <= 5)
			{
...
int Function_58(char* cParam0, var uParam1, char*[] cParam2, float fParam3, int iParam4, struct<2> Param5) //Position: 0x2DD7 / 11735
{
	int iVar0;
	struct<2> Var1;
	int iVar3;
...
bool Function_59(int iParam0, int iParam1) //Position: 0x2E7D / 11901
{
...
bool Function_60(var uParam0) //Position: 0x2E98 / 11928
{
	var uVar0;
	
	Function_65(3, 2);
	uVar0 = &uVar0;
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/indian_sit_ground", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/indian_sit_ground_smoke", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/pee_nospawn", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_62(&iLocal_0 + 8, "$/content/scripting/gringo/simplegringo/player_sit_campfire", 1, 0);
	if (!Function_66(&iLocal_0 + 8))
	{
		return 0;
	}
	iLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT(Function_99()));
	*(&iLocal_0 + 112) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp", "horse_stay", Vector(2,279573f, 0.0f, -1,022649f), Vector(0.0f, -136,8491f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 112), 0);
	*(&iLocal_0 + 120) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp1", "horse_stay", Vector(3,197684f, 0.0f, 1,874126f), Vector(0.0f, 185,144f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 120), 0);
	*(&iLocal_0 + 128) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "horse_tend_camp2", "horse_stay", Vector(-0,402169f, 0.0f, 5,538029f), Vector(0.0f, 0.0f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&iLocal_0 + 128), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Indian_Sit_Ground", "Indian_Sit_Ground", Vector(-0,3341665f, 0.0f, 1,800426f), Vector(0.0f, -3,624405f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Indian_Sit_Ground1", "Indian_Sit_Ground", Vector(0,8303077f, -0,02670348f, 1,2933f), Vector(0.0f, 42,92405f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Indian_Sit_Ground2", "Indian_Sit_Ground", Vector(1,06292f, 0.0f, 0,1023914f), Vector(0.0f, 90,99183f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Indian_Sit_Ground_Smoke1", "Indian_Sit_Ground_Smoke", Vector(-0,9969944f, 0.0f, -0,7362126f), Vector(0.0f, -139,5349f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Pee_nospawn", "Pee_nospawn", Vector(-5,114749f, 0.0f, 0.0f), Vector(0.0f, 67,76147f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	uVar0 = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Sit_Ground_Campfire_Tend", "Sit_Ground_Campfire_Tend", Vector(0,358073f, 0.0f, -1,030563f), Vector(0.0f, 153,471f, 0.0f));
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(&uVar0), 0);
	*(&iLocal_0 + 136) = CREATE_GRINGO_IN_LAYOUT(StackVal, StackVal, &iLocal_0, "Player_Sit_Campfire", "Player_Sit_Campfire", Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f));
	Function_61(&iLocal_0, &uParam0);
	return 1;
}

void Function_61(int iParam0, int iParam1) //Position: 0x3381 / 13185
{
	int iVar0;
	...
	if (IS_LAYOUTREF_VALID(&iParam0))
	{
		...
		{
			iVar0 = ATTACH_OBJECTS(StackVal, StackVal, &iParam0, &iParam1, Function_99(), Vector(0.0f, 0.0f, 0.0f), Vector(0.0f, 0.0f, 0.0f), 4294967295);
...
var Function_62(struct<2>[] Param0, var uParam1, int iParam2, bool bParam3) //Position: 0x33CC / 13260
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_64(&Param0, &iVar1, iParam2);
	if (&bParam3)
	{
...
void Function_63(struct<13> Param0) //Position: 0x340A / 13322
{
	Param0.f_12 = (Param0.f_12 || iParam1);
	return;
}

var Function_64(struct<2>[] Param0, int iParam1, int iParam2) //Position: 0x341D / 13341
{
	int iVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x34EC / 13548
{
	switch (&iParam1)
	{
		case 0x00000000:
...
bool Function_66(struct<2>[] Param0) //Position: 0x3536 / 13622
{
	int iVar0;
	int iVar1;
...
void Function_67() //Position: 0x38F8 / 14584
{
	if (!Function_118(128))
	{
		return;
...
bool Function_68() //Position: 0x3938 / 14648
{
	int iVar0;
...
void Function_69() //Position: 0x3966 / 14694
{
	if (!Function_118(128))
	{
		return;
...
void Function_70(vector3 vParam0) //Position: 0x39A8 / 14760
{
	char* cVar0[32];
	...
	if (Global_131396.f_1200)
	{
		...
		Function_71(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) + Vector(Vector(1,5f, 0.0f, 2,5f), *(&vParam0 + 324), 2), *(&vParam0 + 336), &cVar0);
		strcpy(&cVar0, "d", 32);
		stradd(&cVar0, GET_OBJECT_NAME(&vParam0 + 16), 32);
		Function_71(StackVal, StackVal, StackVal, StackVal, Vector(&vParam0 + 16, StackVal, StackVal) - Vector(Vector(2,5f, 0.0f, 1,5f), *(&vParam0 + 324), 4), *(&vParam0 + 336), &cVar0);
	}
	vParam0.f_8 = 1;
	iParam1 = 250;
	return;
...
void Function_71(var uParam0, var uParam1, struct<2> Param2, struct<2> Param4, char* cParam6) //Position: 0x3A40 / 14912
{
	var uVar0;
	var uVar1;
	...
	uVar0 = &uVar0;
	uVar1 = &uVar1;
	Function_72(StackVal, StackVal, &uVar0, &uVar1, &uParam0, Param2, Param4, uParam1, 1, 1, &cParam6, 0, 0);
}

void Function_72(var uParam0, var uParam1, var uParam2, struct<2> Param3, struct<2> Param5, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x3A6F / 14959
{
	Function_87(StackVal, StackVal, &uParam0, &uParam1, uParam7, &uParam2, Param3, Param5, &uParam10);
	Function_77(&uParam0, &uParam1, uParam7, uParam8, uParam9);
	DECOR_SET_INT(&uParam1, Function_76(), Function_75(uParam8, uParam9, uParam7));
	DECOR_SET_INT(&uParam1, Function_74(), Function_73(&uParam11, &uParam12));
}

var Function_73(var uParam0, bool bParam1) //Position: 0x3ACA / 15050
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_74() //Position: 0x3ADA / 15066
{
	return "PackedGrass";
}

var Function_75(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3AEE / 15086
{
	int iVar0;
...
var Function_76() //Position: 0x3B13 / 15123
{
	return "PackedMetadata";
}

void Function_77(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3B2A / 15146
{
	struct<2> Var0;
	var uVar2;
	int iVar3;
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				...
				if (DECOR_GET_INT_VERBOSE(&iParam1, Function_86(), &uVar4))
				{
					Function_81(uVar4, &iVar5);
...
struct<8> Function_78() //Position: 0x3C66 / 15462
{
	return StackVal, Vector(0.0f, 0,101f, -0,195f);
}

struct<8> Function_79() //Position: 0x3C78 / 15480
{
	return StackVal, Vector(0.0f, 0,127f, -0,177f);
}

struct<8> Function_80() //Position: 0x3C8A / 15498
{
	return StackVal, Vector(0.0f, 0,158f, -0,163f);
}

void Function_81(var uParam0, struct<5> Param1) //Position: 0x3C9C / 15516
{
	Param1 = Function_82(uParam0, Function_84(), 0);
	Param1.f_4 = Function_82(uParam0, Function_84() + 8, Function_84());
	return;
}

var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x3CC1 / 15553
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x3CE0 / 15584
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x3CEC / 15596
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x3CF7 / 15607
{
	int iVar0;
...
var Function_86() //Position: 0x3D25 / 15653
{
	return "PackedWeapon";
}

int Function_87(var uParam0, char* cParam1, int iParam2, var uParam3, struct<2> Param4, struct<2> Param6, char* cParam8) //Position: 0x3D3A / 15674
{
	var uVar0;
	struct<2> Var1;
	char* cVar3[64];
	...
	{
		strcpy(&cVar3, Function_91(), 64);
		stradd(&cVar3, &cParam8, 64);
	}
	else
	{
		memcpy(&cVar3, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_89(Function_91()), 16);
	}
	NET_OBJECT_REPLICATION_MODE_START(17, 0);
	uParam0 = CREATE_PROP_IN_LAYOUT(&uParam3, &cVar3, &uVar0, Param4, Param6, 0);
	SNAP_OBJECT_TO_GROUND(&uParam0, 1.0f, 0, 1092616192);
	cParam1 = CREATE_GRINGO_ON_OBJECT(StackVal, &uParam0, Function_88(), "$/content/scripting/gringo/SimpleGringo/Giveaway_Footlocker", Var1, Vector(0.0f, 0.0f, 0.0f));
	NET_OBJECT_REPLICATION_MODE_END(17);
	ENABLE_GRINGO_STREAMING_CHECKS();
	return 1;
}

var Function_88() //Position: 0x3E47 / 15943
{
	return "MPItemGiver";
}

struct<32> Function_89(char* cParam0) //Position: 0x3E5B / 15963
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0) //Position: 0x3EC7 / 16071
{
	char* cVar0[32];
...
var Function_91() //Position: 0x3EE9 / 16105
{
	return "PBox_";
}

var Function_92() //Position: 0x3EF7 / 16119
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x3F1D / 16157
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x3F45 / 16197
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3F6B / 16235
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, struct<2> Param2) //Position: 0x40EE / 16622
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x4196 / 16790
{
	int iVar0;
	struct<2> Var1;
		...
		if (IS_VOLUME_VALID(&Global_39621[iVar05] + 16))
		{
			if (DECOR_CHECK_EXIST(&Global_39621[iVar05] + 16, "script"))
			{
				if (!IS_SCRIPT_VALID(DECOR_GET_INT(&Global_39621[iVar05] + 16, "script")))
				{
					...
					{
						if (Function_114(StackVal, &Global_54076, Var1) < 25.0f)
						{
							Function_98(iVar0);
						}
					}
					else if (Function_114(StackVal, &Global_54076, Var1) < 55.0f)
					{
						Function_98(iVar0);
					}
				}
...
void Function_98(int iParam0) //Position: 0x4304 / 17156
{
...
var Function_99() //Position: 0x436C / 17260
{
	int iVar0;
...
var Function_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x4375 / 17269
{
	return Function_101(StackVal, &uParam0, iParam1, &iParam2, &iParam3, &iParam4, 0, Vector(0.0f, 0.0f, 0.0f));
}

var Function_101(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, float fParam5, struct<2> Param6) //Position: 0x4393 / 17299
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x468C / 18060
{
	int iVar0;
...
void Function_103() //Position: 0x4740 / 18240
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x477B / 18299
{
	int iVar0;
...
void Function_105(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x47A8 / 18344
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x4903 / 18691
{
...
void Function_107() //Position: 0x491A / 18714
{
	int iVar0;
...
var Function_108(struct<2>[] Param0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x4966 / 18790
{
	int iVar0;
...
int Function_109() //Position: 0x4A42 / 19010
{
	int iVar0;
...
int Function_110() //Position: 0x4B9E / 19358
{
	int iVar0;
...
bool Function_111(struct<2> Param0, int iParam2, bool bParam3) //Position: 0x4CBE / 19646
{
	var uVar0;
	int iVar2;
	bool bVar3;
	...
	while (iVar2 <= 25)
	{
		if (IS_VOLUME_VALID(&Global_39621[iVar25] + 16))
		{
			...
			else if (Function_112(&Param0, &uVar0) > fVar4)
			{
				return 0;
			}
		}
...
float Function_112(struct<2> Param0) //Position: 0x4D9A / 19866
{
	struct<2> Var0;
	int iVar2;
...
bool Function_113(struct<2> Param0, struct<5> Param2) //Position: 0x4DB9 / 19897
{
	var uVar0;
	int iVar2;
	struct<2> Var3;
	...
	{
		if (!Function_31(StackVal, Param2))
		{
			return 1;
		}
	}
...
float Function_114(var uParam0, struct<2> Param1) //Position: 0x4EFC / 20220
{
	struct<2> Var0;
...
bool Function_115(int iParam0) //Position: 0x4F73 / 20339
{
	var uVar0;
...
int Function_116() //Position: 0x4F95 / 20373
{
	return 0;
}

void Function_117(struct<321> Param0) //Position: 0x4F9C / 20380
{
	var uVar0;
	...
	if (IS_STRING_VALID(&uParam1))
	{
		if (STRING_LENGTH(&uParam1) >= 0)
		{
			*(&Param0 + 32) = GET_ASSET_ID(&uParam1, 0);
			Function_64(&Param0 + 120, &Param0 + 32, 0);
		}
	}
	if (IS_STRING_VALID(&iParam2))
	{
		if (STRING_LENGTH(&iParam2) >= 0)
		{
			*(&Param0 + 40) = GET_ASSET_ID(&iParam2, 7);
			Function_64(&Param0 + 120, &Param0 + 40, 7);
		}
	}
	return;
}

bool Function_118(int iParam0) //Position: 0x502E / 20526
{
	int iVar0;
