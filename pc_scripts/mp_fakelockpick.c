...
void main() //Position: 0x0 / 0
{
	...
	iLocal_23 = 0;
	Function_105(&uScriptParam_0, &iLocal_23);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(&uVar1, &uLocal_24);
		}
		iVar2 = 0;
		bLocal_31 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(vLocal_3[iVar39]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), &vLocal_3[iVar39] + 16);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", &vLocal_3[iVar39] + 24);
							Function_82(&vLocal_3[iVar39] + 24, 1);
							...
							{
								Function_75(&(vLocal_3[iVar39]), 0);
							}
							else if (vLocal_3[iVar39].f_68 < 8)
							{
								Function_74(&(vLocal_3[iVar39]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_32))
	{
		Function_108("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(&bLocal_32);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_23 - 1))
	{
...
void Function_5(struct<69> Param0) //Position: 0x49A / 1178
{
	...
	else if (UNK_0x0A0E660E() || Function_14(&Param0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_6663)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_32))
								{
									...
									{
										bLocal_32 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@UI.CANCEL", 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_32 = ADD_SCRIPT_USE_CONTEXT(&iVar1, 500, "@GENERIC.USE", 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(&bLocal_32))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(&bLocal_32))
		{
			Function_108("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(&bLocal_32);
		}
	...
	switch (Param0.f_68)
	{
		...
		case 0x00000004:
			...
			if (Param0.f_68 == 5)
			{
				...
				{
					Function_38(&Param0, &uVar7, &iLocal_29, &uLocal_27);
...
bool Function_26(var uParam0, bool bParam1) //Position: 0x1FBC / 8124
{
	bParam1 = &bParam1;
	uParam0 = &uParam0;
...
bool Function_27(bool bParam0) //Position: 0x1FF1 / 8177
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, &bParam0));
}

void Function_28() //Position: 0x2011 / 8209
{
	return;
}

void Function_29(int iParam0, bool bParam1) //Position: 0x2017 / 8215
{
	bParam1 = &bParam1;
	iParam0 = &iParam0;
	return;
...
bool Function_30(char* cParam0) //Position: 0x2029 / 8233
{
	cParam0 = &cParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x2036 / 8246
{
	return Function_7(&iParam0, "OneShotKill", 0);
}

bool Function_32(char* cParam0, int iParam1) //Position: 0x2051 / 8273
{
	return Function_9(&cParam0, "ParentAnimNode", &iParam1);
}

bool Function_33(int iParam0) //Position: 0x2071 / 8305
{
	return Function_7(&iParam0, "LinkToParentAnim", 0);
}

var Function_34(int iParam0) //Position: 0x2091 / 8337
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x20C8 / 8392
{
	return Function_7(&iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x20E8 / 8424
{
	return Function_7(&iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2103 / 8451
{
	uParam0 = (uParam0 - (uParam0 && iParam1));
	return;
}

void Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2119 / 8473
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x243D / 9277
{
	int iVar0;
...
bool Function_40(char* cParam0, int iParam1) //Position: 0x2446 / 9286
{
...
bool Function_42(char* cParam0, int iParam1) //Position: 0x2474 / 9332
{
	return Function_9(&cParam0, "UserPhysAttachBone", &iParam1);
}

bool Function_43(char* cParam0, int iParam1) //Position: 0x2498 / 9368
{
	return Function_9(&cParam0, "TargetPhysAttachBone", &iParam1);
}

int Function_44(int iParam0) //Position: 0x24BE / 9406
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, &iParam0);
}

bool Function_45(var uParam0, int iParam1) //Position: 0x24DC / 9436
{
	return Function_9(&uParam0, "TargetAttachBone", &iParam1);
}

bool Function_46(var uParam0, int iParam1) //Position: 0x24FE / 9470
{
	return Function_9(&uParam0, "TargetAttachSlot", &iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2520 / 9504
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var Function_48(var uParam0, int iParam1, bool bParam2) //Position: 0x25E8 / 9704
{
	int iVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2664 / 9828
{
...
void Function_50(vector3 vParam0) //Position: 0x267C / 9852
{
...
var Function_51(int iParam0) //Position: 0x26A1 / 9889
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(&iParam0, "RandUseTime", 0.0f));
}

void Function_52(vector3 vParam0) //Position: 0x26C2 / 9922
{
	vParam0.f_4 = 0.0f;
	vParam0.f_8 = 0.0f;
	vParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x26D9 / 9945
{
	uParam0 = &uParam0;
	return;
}

int Function_54() //Position: 0x26E5 / 9957
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x26EC / 9964
{
	uParam0 = (uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x26FD / 9981
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x2742 / 10050
{
	return Function_11(&iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x276E / 10094
{
	return GRINGO_GET_USE_COMPONENT_HEADING(&iParam0);
}

struct<8> Function_59(int iParam0) //Position: 0x277A / 10106
{
	struct<2> Var0;
	var uVar2;
	var uVar3;
...
bool Function_60(int iParam0) //Position: 0x287C / 10364
{
...
void Function_62(int iParam0) //Position: 0x28C7 / 10439
{
	iParam0 = &iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x28D3 / 10451
{
	iParam0 = &iParam0;
	return;
}

bool Function_64(int iParam0) //Position: 0x28DF / 10463
{
	return Function_7(&iParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x28FE / 10494
{
	if (!Function_14(&iParam0))
	{
...
bool Function_66(var uParam0, int iParam1) //Position: 0x2915 / 10517
{
	struct<2> Var0;
	bool bVar2;
	var uVar3;
...
struct<8> Function_67(int iParam0) //Position: 0x29A6 / 10662
{
	struct<2> Var0;
...
struct<8> Function_68(var uParam0, var uParam1, struct<2> Param2) //Position: 0x29CA / 10698
{
	struct<2> Var0;
...
int Function_69(int iParam0) //Position: 0x29E9 / 10729
{
	return Function_11(&iParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(var uParam0, int iParam1) //Position: 0x2A0D / 10765
{
	bool bVar0;
	float fVar1;
	var uVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2B35 / 11061
{
...
int Function_72(var uParam0) //Position: 0x2B63 / 11107
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2C7C / 11388
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(struct<69> Param0) //Position: 0x2C89 / 11401
{
	if (Function_73(Param0.f_64, 16))
	{
...
void Function_75(struct<69> Param0) //Position: 0x2D0B / 11531
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (&Param0 + 16 == &iLocal_29)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(&uLocal_27));
		iLocal_29 = &uVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(&Param0 + 16, 0);
	if (Function_36(&Param0 + 16))
...
void Function_76() //Position: 0x32B6 / 12982
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x32F0 / 13040
{
	return Function_11(&iParam0, "ReuseDelay", 15.0f);
}

void Function_78(int iParam0, var uParam1) //Position: 0x330E / 13070
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_79(int iParam0) //Position: 0x334F / 13135
{
	iParam0 = &iParam0;
	return;
}

bool Function_80(int iParam0) //Position: 0x335B / 13147
{
	return Function_7(&iParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x337D / 13181
{
	if (DECOR_CHECK_EXIST(&uParam0, "iLockerOpen"))
	{
	...
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
		{
			SET_FORCED_LOOK_ENABLE(&uParam0, 1);
		}
	}
	iParam1 = &iParam1;
	return;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x33CE / 13262
{
	if (IS_ACTOR_VALID(&uParam0))
	{
		if (&bParam1)
...
void Function_83(int iParam0, int iParam1) //Position: 0x34DE / 13534
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), &iParam1, &iParam0, 0, 0, 0);
	return;
}

void Function_84(struct<69> Param0) //Position: 0x34F6 / 13558
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x3812 / 14354
{
	iParam1 = &iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(&uParam0))
	{
...
bool Function_86(int iParam0) //Position: 0x3836 / 14390
{
	return Function_7(&iParam0, "DrawWeapon", 0);
}

bool Function_87(int iParam0) //Position: 0x3850 / 14416
{
	return Function_7(&iParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, var uParam1) //Position: 0x386B / 14443
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x38A9 / 14505
{
	return Function_9(&uParam0, "UseName", &iParam1);
}

bool Function_90(struct<65> Param0) //Position: 0x38C2 / 14530
{
	var uVar0;
	var uVar1;
	struct<2> Var2;
...
int Function_91(int iParam0) //Position: 0x3BBA / 15290
{
	return Function_11(&iParam0, "ActivationCone", 0.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3BD8 / 15320
{
	struct<5> Var0;
	float fVar5;
...
int Function_93(int iParam0) //Position: 0x3C78 / 15480
{
	return Function_11(&iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3C98 / 15512
{
	if (!IS_ACTOR_VALID(&uParam0))
	{
		return 0;
	...
	if (Function_102(3) != DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "UseStage"))
	{
		return 0;
	}
	if (Function_96() != 1 != Function_95(8))
	{
		return 0;
	}
	iParam1 = &iParam1;
...
int Function_95(var uParam0) //Position: 0x3CE9 / 15593
{
	return Function_73((&Global_131396 + 256)->f_108, uParam0);
}

int Function_96() //Position: 0x3CFD / 15613
{
	return 4294967295;
	return Function_97(GET_LOCAL_SLOT(), 1, 0);
}

int Function_97(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3D0D / 15629
{
	if (&bParam1)
	{
...
bool Function_98(bool bParam0, int iParam1, bool bParam2) //Position: 0x3D53 / 15699
{
	char* cVar0[64];
	int iVar16;
	...
	if (!Function_101(bParam0))
	{
		...
		stradd(&cVar0, Function_99(iParam1), 64);
...
var Function_99(int iParam0) //Position: 0x3DD6 / 15830
{
	switch (iParam0)
	{
		case 0x00000002:
...
var Function_100(int iParam0, bool bParam1) //Position: 0x40F1 / 16625
{
	int iVar0;
...
bool Function_101(bool bParam0) //Position: 0x4112 / 16658
{
	char* cVar0[64];
...
var Function_102(int iParam0) //Position: 0x41B3 / 16819
{
...
bool Function_103(int iParam0) //Position: 0x41D4 / 16852
{
...
void Function_104(int iParam0) //Position: 0x41F0 / 16880
{
	iParam0 = &iParam0;
	return;
}

void Function_105(var uParam0, int iParam1) //Position: 0x41FC / 16892
{
	bool bVar0;
	var uVar1;
	...
	{
		Function_106(&(vLocal_3[iLocal_239]), &uParam0);
		iLocal_23++;
	}
...
void Function_106(int iParam0, int iParam1) //Position: 0x4268 / 17000
{
	*(&iParam0 + 16) = &iParam1;
...
void Function_107(int iParam0) //Position: 0x4280 / 17024
{
	iParam0 = &iParam0;
	return;
}

void Function_108(int iParam0) //Position: 0x428C / 17036
{
