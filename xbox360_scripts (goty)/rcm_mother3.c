...
void main() //Position: 0x0 / 0
{
	...
	iLocal_262 = 0;
	iLocal_255 = 1000;
	Function_185(&iLocal_268);
	Function_183(&uLocal_248, "$/content/DLC/ZombiePack/Gringos/DLC_mother_superior_waiting", 1, 0);
	Function_182(&uLocal_248, 613, 3, 0);
		...
		switch (iLocal_262)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					...
					{
						if (Function_177(&uLocal_248))
						{
							bLocal_264 = CREATE_ACTOR_IN_LAYOUT(bLocal_263, Function_176(), 613, *(&Global_63541[ScriptParam_055] + 112), 0.0f, 0.0f, 0.0f);
							bLocal_275 = CREATE_GRINGO_IN_LAYOUT(bLocal_263, Function_176(), "DLC_mother_superior_waiting", *(&Global_63541[ScriptParam_055] + 112), 0.0f, Global_63541[ScriptParam_055].f_124, 0.0f);
							SNAP_ACTOR_TO_GRINGO(bLocal_264, bLocal_275, "UseCase1", 1, 0, 0);
							TASK_USE_GRINGO(bLocal_264, GET_GRINGO_FROM_OBJECT(bLocal_275), "UseCase1", 4294967295, 1);
							bLocal_267 = CREATE_VOLUME_IN_LAYOUT(bLocal_263, "Mother3_StayOut", 2, *(&Global_63541[ScriptParam_055] + 112), 0.0f, 0.404f, 0.0f, 20.0f, 20.0f, 20.0f);
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_267);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_267);
							SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_264, bLocal_267, 1, 1);
							AI_IGNORE_ACTOR(bLocal_264);
							TASK_PRIORITY_SET(bLocal_264, 2);
							SET_RCM_ACTOR_CALL_OVER_ENABLE(bLocal_264, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
							AUDIO_ADD_ALTERNATE_CONTEXT(bLocal_264, "RCM_CALL_OVER", "RCM_STILL_HERE_POST2");
							iLocal_262 = 1;
							Function_174(&iLocal_268);
						}
						else if (Function_171(&iLocal_268) < 5.0f)
						{
							Function_174(&iLocal_268);
						}
						Function_164(&(Global_63541[2655]), 26, 0x41f00000, 0x42200000, 0);
					}
					else
					{
						bLocal_263 = CREATE_LAYOUT("RCM_Mother3_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				{
					Function_163(&Global_63541[ScriptParam_055] + 144, 128);
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					if (Function_156(StackVal, StackVal, *(&Global_63541[ScriptParam_055] + 112), 0x3f800000, 0x42960000, 1, 1, 0))
					{
						if (FABS((StackVal - StackVal)) > 2.0f)
						{
							if (GATEWAY_UPDATE(Global_63541[ScriptParam_055].f_192))
							{
								bLocal_265 = Function_154();
								...
								{
									Function_153("Mother2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
									iLocal_273 = 1;
								}
							}
							else if (Function_171(&iLocal_268) < 5.0f)
			...
			case 0x00000003:
				if (Function_113("$/cutscene/mother_superior_has_a_gun_3_pt_a_cs/mother_superior_has_a_gun_3_pt_a_cs", &iLocal_255, 31027, 31020, 29793, 29450, 29004, 28988, 1, 1, 2, 2, 0))
				{
					iLocal_262 = 5;
					Function_174(&iLocal_268);
				}
			...
			case 0x00000005:
				if (!HUD_IS_FADING() && !HUD_IS_FADED())
				{
					...
					Function_153("Mother3_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					Function_111(35, 0, 1);
					_ADD_AMMO_OF_TYPE(Global_34573, 16, 5.0f, 0, 1);
					if (!Function_110(Global_76846, 16))
					{
						Function_105(Global_34573, 16, 1, 0);
					}
					TASK_PRIORITY_SET(bLocal_264, 2);
					SET_RCM_ACTOR_CALL_OVER_ENABLE(bLocal_264, 1, 1, false, 1, 0, 2, 1101004800, 1088421888, 1);
					iLocal_271 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_63541[ScriptParam_055].f_140);
					bVar0 = false;
					while (bVar0 <= iLocal_271)
					{
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "mother3_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x541 / 1345
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_101(&Global_63541[iParam055] + 144, 64);
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x970 / 2416
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_3() //Position: 0xAE3 / 2787
{
	return;
}

void Function_4(var uParam0, var uParam1) //Position: 0xAE9 / 2793
{
	if (Global_3381)
	{
		return;
...
bool Function_5() //Position: 0xB2B / 2859
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_6(bool bParam0) //Position: 0xB34 / 2868
{
	...
	if (bParam0)
	{
		Function_101(&Global_63095, 1);
		Function_101(&Global_63095, 2);
	}
	Global_88793 = 1;
	return;
}

void Function_7() //Position: 0xB85 / 2949
{
	Function_34();
	Function_33();
	Function_33();
...
void Function_8() //Position: 0xBD7 / 3031
{
...
void Function_9() //Position: 0xCDD / 3293
{
	float fVar0;
...
void Function_10() //Position: 0xD10 / 3344
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0xE9E / 3742
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0x1052 / 4178
{
	Function_13(&Global_28260, 1, 0);
	return;
}

void Function_13(int iParam0, bool bParam1, var uParam2) //Position: 0x1060 / 4192
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_14() //Position: 0x1251 / 4689
{
...
struct<8> Function_15(int iParam0) //Position: 0x1266 / 4710
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x130C / 4876
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x15A7 / 5543
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_18(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_176(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_18(int iParam0) //Position: 0x1BD4 / 7124
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_19(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1BE5 / 7141
{
	char* cVar0[32];
...
struct<32> Function_20(char* cParam0, bool bParam1) //Position: 0x1CDA / 7386
{
	char* cVar0[32];
...
void Function_21(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1CF3 / 7411
{
	float fVar0;
...
var Function_22(int iParam0, int iParam1) //Position: 0x1D58 / 7512
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_23(int iParam0, bool bParam1) //Position: 0x1D6A / 7530
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_24(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1D7C / 7548
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_25(int iParam0) //Position: 0x1EAC / 7852
{
	return Global_35278[iParam020].f_48;
}

float Function_26(int iParam0) //Position: 0x1EBB / 7867
{
	if (!iParam0 != 4294967295)
	{
...
var Function_27(int iParam0) //Position: 0x1EF4 / 7924
{
	if (iParam0 == 4294967295)
	{
...
void Function_28(int iParam0) //Position: 0x1F31 / 7985
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x20CB / 8395
{
	int iVar0;
	int iVar1;
...
int Function_30(bool bParam0) //Position: 0x230F / 8975
{
...
struct<8> Function_31() //Position: 0x2350 / 9040
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x23D9 / 9177
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x2470 / 9328
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_34() //Position: 0x24EF / 9455
{
...
int Function_35(int iParam0, bool bParam1, int iParam2) //Position: 0x2528 / 9512
{
	int iVar0;
	int iVar1;
...
void Function_36() //Position: 0x2732 / 10034
{
	vector3 vVar0;
	var uVar3;
...
bool Function_37(vector3 vParam0) //Position: 0x27ED / 10221
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_38(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2805 / 10245
{
	int iVar0;
...
vector3 Function_39() //Position: 0x28EC / 10476
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_40(int iParam0) //Position: 0x28F5 / 10485
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x290B / 10507
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x29D2 / 10706
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_43(var uParam0, int iParam1) //Position: 0x29EF / 10735
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_44(int iParam0) //Position: 0x3214 / 12820
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x324F / 12879
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(bool bParam0, bool bParam1) //Position: 0x325C / 12892
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3269 / 12905
{
	uParam0 = uParam0;
...
void Function_48(int iParam0) //Position: 0x330D / 13069
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	{
		Function_153(bVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_49(int iParam0) //Position: 0x3C02 / 15362
{
...
bool Function_50(int iParam0) //Position: 0x3C1C / 15388
{
...
bool Function_51(int iParam0, int iParam1) //Position: 0x3C33 / 15411
{
	int iVar0;
...
bool Function_52() //Position: 0x3C4F / 15439
{
	return STRING_TO_HASH(Function_53());
}

var Function_53() //Position: 0x3C5B / 15451
{
	return "ZOMBIE_STORY";
}

bool Function_54(int iParam0) //Position: 0x3C70 / 15472
{
...
int Function_55(int iParam0) //Position: 0x3CD6 / 15574
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_56(int iParam0) //Position: 0x3D98 / 15768
{
...
void Function_57(char* cParam0) //Position: 0x3DAD / 15789
{
	...
	Function_104(Function_52(), 0);
	return;
}

bool Function_58(int iParam0, bool bParam1) //Position: 0x3DF5 / 15861
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x3E32 / 15922
{
...
bool Function_60(int iParam0) //Position: 0x3E4C / 15948
{
...
void Function_61(bool bParam0) //Position: 0x3E62 / 15970
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				{
					iVar3 = iVar1;
					if (Function_79(&(Global_63541[iVar155]), iVar3))
					{
						Function_163(&Global_63541[iVar155] + 144, 64);
...
void Function_62(int iParam0, int iParam1) //Position: 0x4004 / 16388
{
	float fVar0;
	bool bVar1;
	...
	fVar0 = iParam0->f_96;
	iParam0->f_192 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(Global_63535, Function_176(), *(iParam0 + 112), 0.0f, 0.0f, 0.0f, fVar0, fVar0, fVar0, 0, Global_34573, iParam1, iParam0->f_92, 0, 1, 1);
	Function_63(iParam0);
...
void Function_63(int iParam0) //Position: 0x40BE / 16574
{
	float fVar0;
	bool bVar1;
	...
	iParam0->f_216 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_176(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, 2.0f, 2.0f, 2.0f);
	...
	bVar1 = CREATE_VOLUME_IN_LAYOUT(iParam0->f_216, Function_176(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, fVar0, fVar0, fVar0);
	DECOR_SET_INT(bVar1, "category", 512);
	Function_64(&bVar1, 0);
	return;
}

int Function_64(var uParam0, int iParam1) //Position: 0x4160 / 16736
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x42C1 / 17089
{
	struct<8> Var0;
...
struct<32> Function_66(bool bParam0) //Position: 0x435C / 17244
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0, char* cParam1, char* cParam2) //Position: 0x43C6 / 17350
{
	char* cVar0[32];
...
int Function_68(bool bParam0) //Position: 0x43E5 / 17381
{
	int iVar0;
	vector3 vVar1;
...
float Function_69(bool bParam0, vector3 vParam1) //Position: 0x4546 / 17734
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0) //Position: 0x45C0 / 17856
{
	vector3 vVar0;
...
void Function_71(int iParam0) //Position: 0x462A / 17962
{
...
bool Function_72(int iParam0) //Position: 0x468B / 18059
{
...
void Function_73(int iParam0, int iParam1) //Position: 0x46A1 / 18081
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_156(StackVal, Function_78(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_77(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_45(Global_63541[iParam155].f_144, 64))
	{
...
void Function_74(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4B33 / 19251
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x4BAE / 19374
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x4BED / 19437
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(int iParam0) //Position: 0x4C1A / 19482
{
...
bool Function_78(int iParam0) //Position: 0x4C46 / 19526
{
...
bool Function_79(int iParam0, int iParam1) //Position: 0x4C5B / 19547
{
	...
	{
		Function_163(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
	if ((Function_89(iParam1) || Function_56(iParam1)) || Function_88(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
	...
	if (Function_72(iParam0->f_132))
	{
		if (Function_87(&(Global_29008[iParam0->f_132]), 256))
		{
			return 0;
		}
	}
	...
	if (!Function_80(iParam0, iParam1))
	{
		return 0;
	}
	Function_163(&Global_63541[iParam155] + 144, 64);
...
bool Function_80(int iParam0, int iParam1) //Position: 0x4D70 / 19824
{
	int iVar0;
...
bool Function_81(int iParam0) //Position: 0x4EB4 / 20148
{
	if (!Function_50(iParam0))
	{
		return 0;
...
bool Function_82(int iParam0) //Position: 0x4ED8 / 20184
{
...
bool Function_83(int iParam0) //Position: 0x4EED / 20205
{
	return StackVal;
}

bool Function_84(int iParam0) //Position: 0x4EFD / 20221
{
	if (!iParam0->f_152)
	{
		if (Function_103())
...
bool Function_85(int iParam0) //Position: 0x4FA1 / 20385
{
	if (!Function_86(1048576) || Global_3381)
	{
		return 1;
	}
...
bool Function_86(int iParam0) //Position: 0x4FFA / 20474
{
	int iVar0;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x5016 / 20502
{
	int iVar0;
...
int Function_88(int iParam0) //Position: 0x5032 / 20530
{
...
int Function_89(int iParam0) //Position: 0x5047 / 20551
{
...
void Function_90() //Position: 0x505C / 20572
{
...
var Function_91(int iParam0, int iParam1) //Position: 0x50D7 / 20695
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_92(int iParam0) //Position: 0x5CC8 / 23752
{
	int iVar0;
	int iVar1;
...
bool Function_93(int iParam0) //Position: 0x5D17 / 23831
{
...
int Function_94(int iParam0) //Position: 0x5D2D / 23853
{
...
void Function_95() //Position: 0x5D96 / 23958
{
...
bool Function_96(int iParam0) //Position: 0x5DB9 / 23993
{
	if (!Function_93(iParam0))
	{
...
bool Function_97(int iParam0, int iParam1) //Position: 0x5E0A / 24074
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x5E37 / 24119
{
	if (!Function_93(iParam0))
	{
...
void Function_99(bool bParam0) //Position: 0x5E89 / 24201
{
	int iVar0;
...
void Function_100() //Position: 0x5EC3 / 24259
{
	bool bVar0;
...
void Function_101(int iParam0, int iParam1) //Position: 0x5F21 / 24353
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_102(bool bParam0) //Position: 0x5F34 / 24372
{
	PRINTSTRING("Day ");
...
bool Function_103() //Position: 0x5F7A / 24442
{
...
void Function_104(bool bParam0, bool bParam1) //Position: 0x5F95 / 24469
{
	bool bVar0;
...
void Function_105(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5FBA / 24506
{
	bool bVar0;
	char* cVar1[16];
...
void Function_106(char* cParam0, int iParam1) //Position: 0x6026 / 24614
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_107(bool bParam0, var uParam1, int iParam2) //Position: 0x605D / 24669
{
	var uVar0;
	char* cVar1[16];
...
int Function_108(char* cParam0) //Position: 0x60D5 / 24789
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_109(int iParam0) //Position: 0x6176 / 24950
{
	int iVar0;
	int iVar1;
...
bool Function_110(var uParam0, int iParam1) //Position: 0x61B3 / 25011
{
...
int Function_111(bool bParam0, bool bParam1, int iParam2) //Position: 0x61C6 / 25030
{
...
bool Function_112(bool bParam0) //Position: 0x621D / 25117
{
	if (bParam0 == 4294967295)
	{
		return 0;
...
bool Function_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x622F / 25135
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_114(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x62D8 / 25304
{
	if (!bParam15)
	{
	...
	switch (*iParam1)
	{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_171(iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_171(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_115(bool bParam0) //Position: 0x68EC / 26860
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_116() //Position: 0x699B / 27035
{
	bool bVar0;
...
void Function_117() //Position: 0x6A0D / 27149
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_118() //Position: 0x6A52 / 27218
{
...
void Function_119(bool bParam0) //Position: 0x6A64 / 27236
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_120(bool bParam0, bool bParam1) //Position: 0x6A81 / 27265
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_176(), bParam1, 4294967295, 1);
...
bool Function_121(bool bParam0) //Position: 0x6B01 / 27393
{
	int iVar0;
...
int Function_122(bool bParam0) //Position: 0x6B30 / 27440
{
	int iVar0;
	bool bVar1;
...
bool Function_123() //Position: 0x6BE8 / 27624
{
	int iVar0;
	bool bVar1;
...
bool Function_124(int iParam0) //Position: 0x6C22 / 27682
{
	return iParam0->f_20;
}

void Function_125(var uParam0, int iParam1) //Position: 0x6C2C / 27692
{
	Function_126(uParam0, iParam1, 0);
	return;
}

void Function_126(var uParam0, bool bParam1, bool bParam2) //Position: 0x6C3A / 27706
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_127(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6D86 / 28038
{
	int iVar0;
	int iVar1;
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6FA6 / 28582
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x6FCF / 28623
{
	bool bVar0;
	bool bVar1;
...
void Function_130() //Position: 0x701A / 28698
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_176(), Global_63535, 15, 0);
	vVar3 = { StackVal, StackVal, Global_34574 };
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_176(), 2, vVar3, 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
...
int Function_131() //Position: 0x713C / 28988
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x714C / 29004
{
	...
	if (IS_VOLUME_VALID(bLocal_266))
	{
		DESTROY_VOLUME(bLocal_266);
	}
	return 1;
}

void Function_133(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x7205 / 29189
{
	bool bVar0;
...
void Function_134() //Position: 0x72F5 / 29429
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x730A / 29450
{
	var uVar0[2];
	int iVar3;
	
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -1699.905f, 8.031f, 4262.575f, 196.745f, 1, true, 1);
	if (Function_138(Global_30693[1]))
	{
		iVar3 = 0;
		while (iVar3 <= 2)
		{
			if (!IS_DOOR_VALID(uVar0[iVar3]))
			{
				uVar0[iVar3] = Function_136("lashermanas", "walls01Props01x", iVar3 + 1);
				CLOSE_DOOR_FAST(uVar0[iVar3]);
			}
			iVar3++;
		}
	}
...
int Function_136(var uParam0, var uParam1, int iParam2) //Position: 0x7397 / 29591
{
	return Function_137(Global_29006, uParam0, uParam1, iParam2);
}

int Function_137(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x73A9 / 29609
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_138(bool bParam0) //Position: 0x7445 / 29765
{
	if (!Function_72(bParam0))
	{
		return 1;
	}
	return Function_87(&(Global_29008[bParam0]), 4);
}

int Function_139() //Position: 0x7461 / 29793
{
	if (!iLocal_272)
	{
		Function_140(-1732.179f, 8.031f, 4232.975f, bLocal_266);
		iLocal_272 = 1;
	}
	return 1;
}

void Function_140(vector3 vParam0) //Position: 0x7488 / 29832
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_141(bool bParam0, bool bParam1) //Position: 0x760E / 30222
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_142(bool bParam0, float fParam1) //Position: 0x76FF / 30463
{
...
void Function_143() //Position: 0x77FD / 30717
{
...
void Function_144() //Position: 0x782F / 30767
{
...
int Function_145() //Position: 0x792C / 31020
{
	return 1;
}

int Function_146() //Position: 0x7933 / 31027
{
	...
	GIVE_OBJECT_TO_LAYOUT(bLocal_265, bLocal_263);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_08", bLocal_265);
	bLocal_266 = CREATE_VOLUME_IN_LAYOUT(bLocal_263, "Mother3_CSVol", 2, *(&Global_63541[2655] + 100), 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_149(0, 0, 1, 1, 0, 1, 1, bLocal_266, 1, 1, 1, 1);
	Function_147(StackVal, StackVal, bLocal_263, *(&Global_63541[2655] + 112), &bLocal_266, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_147(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x7A4F / 31311
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_148(bool bParam0, bool bParam1) //Position: 0x7CBD / 31933
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_149(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x7D32 / 32050
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_152(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_176(), 2, Function_152(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_150(int iParam0) //Position: 0x7FE0 / 32736
{
	int iVar0;
...
var Function_151() //Position: 0x8016 / 32790
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_152(bool bParam0) //Position: 0x8095 / 32917
{
	vector3 vVar0;
...
void Function_153(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x80A6 / 32934
{
	struct<4> Var0;
	int iVar4;
...
var Function_154() //Position: 0x812B / 33067
{
	bool bVar0;
	bool bVar1;
	...
	{
		bVar1 = GET_MOUNT(Global_34573);
		bVar0 = GET_ATTACHED_HOGTIE_VICTIM(bVar1);
	}
	if (IS_ACTOR_VALID(bVar0))
	{
		...
		if (iLocal_273 && !HUD_IS_SHOWING_OBJECTIVE())
		{
			if (!iLocal_274)
			{
				iLocal_274 = 1;
				Function_74("Mother2_WrongZ", 7.0f, 1, 0, 2, 1, 0);
			}
		}
	}
	else if (Function_171(&iLocal_268) < 5.0f)
...
bool Function_155(bool bParam0) //Position: 0x81BA / 33210
{
	bool bVar0;
...
bool Function_156(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x81F6 / 33270
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_157() //Position: 0x8212 / 33298
{
	AI_STOP_IGNORING_ACTOR(bLocal_264);
	ENABLE_CHILD_SECTOR("lsh_garden01x");
	ENABLE_CHILD_SECTOR("lsh_arches01x");
	ENABLE_CHILD_SECTOR("lsh_shacks01x");
	ENABLE_CHILD_SECTOR("lsh_storageRoom01x");
	...
	if (IS_LAYOUTREF_VALID(bLocal_263))
	{
		DESTROY_OBJECT(bLocal_263);
	}
	Function_159(&uLocal_248);
	Function_158(0, 0, 0);
	return;
}

int Function_158(bool bParam0, bool bParam1, bool bParam2) //Position: 0x82CB / 33483
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_159(int iParam0) //Position: 0x82FA / 33530
{
	int iVar0;
...
void Function_160(var uParam0, int iParam1) //Position: 0x8320 / 33568
{
	if (Function_162(uParam0[iParam13], 4))
	{
		if (Function_162(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_161(uParam0[iParam13], 1);
			Function_161(uParam0[iParam13], 2);
			Function_161(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_161(var uParam0, int iParam1) //Position: 0x844E / 33870
{
	int iVar0;
...
bool Function_162(var uParam0, int iParam1) //Position: 0x8468 / 33896
{
	int iVar0;
...
void Function_163(var uParam0, int iParam1) //Position: 0x8485 / 33925
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_164(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x8494 / 33940
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_166(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_166(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_165(float fParam0) //Position: 0x85F5 / 34293
{
...
int Function_166(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x862A / 34346
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_167() //Position: 0x8870 / 34928
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
...
void Function_168(char* cParam0, vector3 vParam1) //Position: 0x88C4 / 35012
{
	char* cVar0[64];
...
bool Function_169(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x89EC / 35308
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_70(bParam0);
...
int Function_170() //Position: 0x8A76 / 35446
{
	if (IS_PS3())
	{
		return 1;
...
float Function_171(int iParam0) //Position: 0x8A85 / 35461
{
...
bool Function_172(int iParam0) //Position: 0x8B4D / 35661
{
	return Function_45(*iParam0, 2);
}

bool Function_173(int iParam0) //Position: 0x8B5A / 35674
{
	return Function_45(*iParam0, 1);
}

void Function_174(int iParam0) //Position: 0x8B67 / 35687
{
	Function_175(iParam0, 0.0f);
	return;
}

void Function_175(var uParam0, float fParam1) //Position: 0x8B73 / 35699
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_163(uParam0, 1);
	Function_101(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

var Function_176() //Position: 0x8B94 / 35732
{
	int iVar0;
...
bool Function_177(int iParam0) //Position: 0x8B9C / 35740
{
	int iVar0;
	int iVar1;
	...
	Function_181();
	iVar1 = 0;
	if (!Function_162(iParam0[iVar03], 16))
	{
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_162(iParam0[iVar03], 4))
		{
			if (!Function_162(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP((*iParam0)[iVar03], (Function_162(iParam0[03], 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_162(iParam0[03], 8) || iVar1));
						break;
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_162(iParam0[iVar03], 4))
		{
			if (!Function_162(iParam0[iVar03], 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_178() //Position: 0x8F17 / 36631
{
	if (!Function_86(128))
	{
		return;
...
bool Function_179() //Position: 0x8F57 / 36695
{
	int iVar0;
...
void Function_180(var uParam0, int iParam1) //Position: 0x8F82 / 36738
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_181() //Position: 0x8F93 / 36755
{
	if (!Function_86(128))
	{
		return;
...
var Function_182(var uParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x8FD5 / 36821
{
	int iVar0;
	...
	{
		if (!Function_162(uParam0[iVar03], 4))
		{
...
var Function_183(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x90A5 / 37029
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_184(uParam0, iVar1, iParam2);
	if (bParam3)
	{
		Function_180(uParam0[iVar03], 8);
	}
...
var Function_184(var uParam0, int iParam1, int iParam2) //Position: 0x90DD / 37085
{
	int iVar0;
...
void Function_185(var uParam0) //Position: 0x91A1 / 37281
{
	if (!Function_173(uParam0))
	{
		Function_175(uParam0, 0.0f);
	}
	return;
}
