...
void Function_75() //Position: 0x1C21 / 7201
{
	...
	Function_76(4, 1);
	uVar0 = uVar0;
	Local_177 = CREATE_LAYOUT("Poker_CHU_layout");
	Local_177.f_4 = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", Local_177, 8, 0);
	*(&Local_177 + 8[06]) = { -2698.523f, 31.151f, 4277.089f };
	*(&Local_177 + 8[06] + 12) = { 0.0f, 143.8871f, 0.0f };
	bVar1 = CREATE_POINT_IN_LAYOUT(Local_177, "PlayerPosition", -2698.523f, 31.151f, 4277.089f, 0.0f, 143.8871f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar1);
	*(&Local_177 + 8[16]) = { -2699.419f, 31.151f, 4276.548f };
	*(&Local_177 + 8[16] + 12) = { 0.0f, 130.9319f, 0.0f };
	bVar2 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_0_Position", -2699.419f, 31.151f, 4276.548f, 0.0f, 130.9319f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar2);
	*(&Local_177 + 8[26]) = { -2698.523f, 31.151f, 4278.206f };
	*(&Local_177 + 8[26] + 12) = { 0.0f, 92.6073f, 0.0f };
	bVar3 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_1_Position", -2698.523f, 31.151f, 4278.206f, 0.0f, 92.6073f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar3);
	*(&Local_177 + 8[36]) = { -2698.523f, 31.151f, 4279.507f };
	*(&Local_177 + 8[36] + 12) = { 0.0f, 65.40177f, 0.0f };
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_2_Position", -2698.523f, 31.151f, 4279.507f, 0.0f, 65.40177f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar4);
	*(&Local_177 + 8[46]) = { -2699.375f, 31.151f, 4280.155f };
	*(&Local_177 + 8[46] + 12) = { 0.0f, 402.257f, 0.0f };
	bVar5 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_3_Position", -2699.375f, 31.151f, 4280.155f, 0.0f, 402.257f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar5);
	*(&Local_177 + 132) = { -2701.129f, 31.949f, 4278.085f };
	*(&Local_177 + 132 + 12) = { 0.0f, 491.4238f, 0.0f };
	Local_177.f_156 = CREATE_POINT_IN_LAYOUT(Local_177, "TableCenter", -2701.129f, 31.949f, 4278.085f, 0.0f, 491.4238f, 0.0f);
	...
	*(&Local_177 + 220[06]) = { -2699.629f, 31.151f, 4280.907f };
	*(&Local_177 + 220[06] + 12) = { 0.0f, -91.74943f, 0.0f };
	bVar8 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_0", -2699.629f, 31.151f, 4280.907f, 0.0f, -91.74943f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar8, Local_177.f_216);
	*(&Local_177 + 220[16]) = { -2693.679f, 31.151f, 4280.907f };
	*(&Local_177 + 220[16] + 12) = { 0.0f, -268.4623f, 0.0f };
	bVar9 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_1", -2693.679f, 31.151f, 4280.907f, 0.0f, -268.4623f, 0.0f);
