...
void main() //Position: 0x0 / 0
{
					...
					if (IS_ACTOR_VALID(bVar33))
					{
						...
						if (FIRE_IS_ACTOR_ON_FIRE(bVar33))
						{
							if (GET_LAST_ATTACKER(bVar33) == Global_34573)
							{
								...
								{
									iVar37 = Function_59(Function_60());
									if ((iVar37 != 12 || iVar37 != 11) || iVar37 != 13)
									{
						...
						if (((!HUD_IS_FADED() && !HUD_IS_FADING()) && !Global_3395) && !Global_3380)
						{
							iVar37 = Function_59(Function_60());
							if ((iVar37 != 12 || iVar37 != 11) || iVar37 != 13)
							{
								if (!IS_OBJECT_VALID(bVar36))
								{
									bVar36 = CREATE_EVENT_TRAP(Function_51(), 91, bVar33);
									EVENT_TRAP_ON_TARGET(bVar36, bVar33);
								}
								if ((EVENT_TRAP_SUCCESSFUL_TRAP(bVar36) && ((GET_WEAPON_IN_HAND(Global_34573) != 31 || GET_WEAPON_IN_HAND(Global_34573) != 23) || GET_WEAPON_IN_HAND(Global_34573) != 24)) || GET_LAST_ATTACKER(bVar33) != Global_34573)
								{
									UI_SET_TEXT("Death_Explanation", "kill_family_help");
									KILL_ACTOR(Global_34573);
								}
	...
	if (IS_OBJECT_VALID(bVar36))
	{
		DESTROY_OBJECT(bVar36);
	}
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3C7 / 967
{
	bool bVar0;
	bool bVar1;
...
void Function_2(int iParam0) //Position: 0x480 / 1152
{
...
void Function_3(int iParam0) //Position: 0x4A8 / 1192
{
...
void Function_4(int iParam0) //Position: 0x4C1 / 1217
{
...
void Function_5(var uParam0, float fParam1) //Position: 0x4D6 / 1238
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x4F7 / 1271
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0x50A / 1290
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_8(int iParam0) //Position: 0x519 / 1305
{
	return Function_9(*iParam0, 1);
}

int Function_9(var uParam0, int iParam1) //Position: 0x526 / 1318
{
	return (uParam0 && iParam1) == 0;
}

void Function_10(int iParam0) //Position: 0x533 / 1331
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_11(int iParam0, bool bParam1) //Position: 0x547 / 1351
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
var Function_12(bool bParam0) //Position: 0x5E4 / 1508
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
int Function_13(int iParam0) //Position: 0x750 / 1872
{
	int iVar0;
	int iVar1;
	int iVar2;
...
vector3 Function_14(int iParam0, bool bParam1) //Position: 0x827 / 2087
{
	vector3 vVar0;
	int iVar20;
	vector3 vVar21;
...
bool Function_15(vector3 vParam0, vector3 vParam3) //Position: 0xAED / 2797
{
	vector3 vVar0;
...
bool Function_16(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) //Position: 0xB1A / 2842
{
	int iVar0;
...
var Function_17() //Position: 0xBE7 / 3047
{
	return GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF());
}

bool Function_18(bool bParam0) //Position: 0xBF3 / 3059
{
	bool bVar0;
	var uVar1;
...
bool Function_19(int iParam0, bool bParam1, int iParam2) //Position: 0xC36 / 3126
{
...
void Function_20(int iParam0, bool bParam1, bool bParam2) //Position: 0xCD9 / 3289
{
	if (Function_18(iParam0))
	{
...
int Function_21(bool bParam0) //Position: 0xD33 / 3379
{
	struct<16> Var0;
	bool bVar16;
...
struct<64> Function_22() //Position: 0xD5A / 3418
{
	char* cVar0[64];
...
var Function_23() //Position: 0xD7D / 3453
{
	int iVar0;
...
bool Function_24(int iParam0, bool bParam1, bool bParam2) //Position: 0xD94 / 3476
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
	...
	switch (*iParam0)
	{
		case 0x00000000:
			...
			*(bParam1 + 40) = { StackVal, StackVal, Function_14(bParam1, bParam1->f_16) };
			...
			bParam1->f_56 = Function_49(bParam1);
			bParam1->f_12 = 0;
			bParam1->f_60 = Function_48(bParam1, bParam1 + 12, 0);
...
bool Function_25(float fParam0, bool bParam1) //Position: 0x1D16 / 7446
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_26(bool bParam0) //Position: 0x1D41 / 7489
{
	bool bVar0;
	int iVar1;
...
void Function_27(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1D87 / 7559
{
	struct<5> Var0;
...
int Function_28(int iParam0, int iParam1) //Position: 0x1DAE / 7598
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
int Function_29(int iParam0, int iParam1) //Position: 0x1DC1 / 7617
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_30(bool bParam0, int iParam1, int iParam2) //Position: 0x1DD4 / 7636
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_31(bool bParam0) //Position: 0x1F93 / 8083
{
	int iVar0;
	int iVar1;
...
float Function_32(int iParam0) //Position: 0x1FC1 / 8129
{
	if (Function_8(iParam0))
	{
...
bool Function_34(bool bParam0, bool bParam1, bool bParam2, var uParam3) //Position: 0x2096 / 8342
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_35(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x211B / 8475
{
	bool bVar0;
...
void Function_36(bool bParam0) //Position: 0x2355 / 9045
{
...
void Function_37(bool bParam0) //Position: 0x2377 / 9079
{
...
void Function_38(int iParam0, bool bParam1) //Position: 0x23F3 / 9203
{
	if (Function_18(iParam0))
	{
		LOG_ERROR(bParam1);
...
bool Function_39(int iParam0) //Position: 0x2406 / 9222
{
	bool bVar0;
	var uVar1;
...
bool Function_40(bool bParam0) //Position: 0x244B / 9291
{
...
void Function_41(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x2465 / 9317
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
bool Function_42(vector3 vParam0) //Position: 0x25A9 / 9641
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

void Function_43(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x25C1 / 9665
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
void Function_44(vector3 vParam0, var uParam3, float fParam4) //Position: 0x26CB / 9931
{
	var uVar0;
	var uVar3;
...
void Function_45(vector3 vParam0) //Position: 0x26FD / 9981
{
	if (fParam3 >= 0.0f)
	{
		fParam3 = 1.0f;
...
var Function_46(int iParam0, bool bParam1, bool bParam2, bool bParam3, vector3 vParam4, bool bParam7, bool bParam8, bool bParam9) //Position: 0x2769 / 10089
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bParam8 || bParam9)
	{
		bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_51(), bParam1, 4294967295, 0);
...
bool Function_47(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2EE6 / 12006
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_48(int iParam0, var uParam1, int iParam2) //Position: 0x2FCB / 12235
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_49(var uParam0) //Position: 0x3192 / 12690
{
	struct<73> Var0;
...
var Function_50() //Position: 0x31E1 / 12769
{
	return StackVal;
}

var Function_51() //Position: 0x31EC / 12780
{
	int iVar0;
...
int Function_52(var uParam0, var uParam1, float fParam2) //Position: 0x31F4 / 12788
{
	float fVar0;
...
var Function_53(bool bParam0, bool bParam1) //Position: 0x3211 / 12817
{
	var uVar0;
	var uVar3;
	int iVar6;
...
var Function_54(var uParam0, int iParam1) //Position: 0x3230 / 12848
{
	vector3 vVar0;
	bool bVar3;
...
void Function_55(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4) //Position: 0x324E / 12878
{
	bool bVar0;
...
bool Function_58(bool bParam0) //Position: 0x32D5 / 13013
{
	bool bVar0;
	var uVar1;
...
int Function_59(int iParam0) //Position: 0x3319 / 13081
{
	int iVar0;
...
int Function_60() //Position: 0x3342 / 13122
{
