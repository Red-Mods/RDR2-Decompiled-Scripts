...
void Function_3() //Position: 0x1F9 / 505
{
	...
	if (IS_DOOR_LOCKED(bLocal_3))
	{
		Function_25(bLocal_3, 1);
	}
	if (IS_DOOR_LOCKED(bLocal_4))
	{
		Function_25(bLocal_4, 1);
	}
	RELEASE_LAYOUT_REF(bLocal_7);
	Function_4(6, uLocal_5, uVar0, cLocal_6, 4294967295);
	return;
}

void Function_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x22B / 555
{
	int iVar0;
...
void Function_5(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x24C / 588
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_6(bool bParam0, bool bParam1) //Position: 0x669 / 1641
{
...
int Function_7(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x698 / 1688
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_8(bool bParam0) //Position: 0x9B6 / 2486
{
	bool bVar0;
...
void Function_9(bool bParam0) //Position: 0x9E2 / 2530
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_10(int iParam0) //Position: 0x9F7 / 2551
{
...
void Function_11(var uParam0, int iParam1) //Position: 0xA23 / 2595
{
	int iVar0;
...
bool Function_12(var uParam0, bool bParam1) //Position: 0xA3A / 2618
{
	int iVar0;
...
void Function_13(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0xA56 / 2646
{
	int iVar0;
	bool bVar1;
...
bool Function_14(bool bParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xB10 / 2832
{
	float fVar0;
...
void Function_15(bool bParam0) //Position: 0xCA7 / 3239
{
...
void Function_16(bool bParam0) //Position: 0xCDB / 3291
{
	SAY_SINGLE_LINE_CONTEXT(bParam0, 60, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_17(var uParam0, int iParam1) //Position: 0xCF2 / 3314
{
	return (uParam0 && iParam1) == 0;
}

var Function_18(bool bParam0, bool bParam1) //Position: 0xCFF / 3327
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_19(bool bParam0, bool bParam1) //Position: 0xDF0 / 3568
{
	bool bVar0;
	bool bVar1;
...
bool Function_20(bool bParam0, bool bParam1) //Position: 0xE47 / 3655
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_21(bool bParam0) //Position: 0xEA0 / 3744
{
	bool bVar0;
...
int Function_22(int iParam0) //Position: 0xED2 / 3794
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_23(bool bParam0, vector3 vParam1) //Position: 0x10A8 / 4264
{
	vector3 vVar0;
...
vector3 Function_24(bool bParam0) //Position: 0x1122 / 4386
{
	vector3 vVar0;
...
void Function_25(bool bParam0, bool bParam1) //Position: 0x118C / 4492
{
...
void Function_26(int iParam0) //Position: 0x11DD / 4573
{
	int iVar0;
...
void Function_27(var uParam0, int iParam1) //Position: 0x1203 / 4611
{
	if (Function_29(uParam0[iParam13], 4))
	{
		if (Function_29(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_28(uParam0[iParam13], 1);
			Function_28(uParam0[iParam13], 2);
			Function_28(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_28(var uParam0, int iParam1) //Position: 0x1331 / 4913
{
	int iVar0;
...
bool Function_29(var uParam0, bool bParam1) //Position: 0x134B / 4939
{
	int iVar0;
...
var Function_30(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x1368 / 4968
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_8 || bParam2) || Global_3370)
			{
				if (Function_145(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					if (((!bParam2 && !Function_143(iParam0 + 200, &fLocal_10, 256, 0)) && !Global_3370) && !Function_150())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_132(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_10, 20.0f, fLocal_10);
		...
		case 0x00000004:
			if (Function_73(iParam0, bParam1))
			{
		...
		case 0x00000002:
			...
			{
				if (((Function_23(StackVal, StackVal, Global_34573, *(iParam0 + 200)) < 120.0f || bParam2) || Global_3370) || Function_150())
				{
					if (UNK_0x214AFB8C(iParam0->f_16))
					{
						if (IS_OBJECT_VALID(iParam0->f_224))
					...
					Function_71(StackVal, StackVal, iParam0 + 292, iParam0 + 300, iParam0 + 296, fParam7, *(iParam0 + 200));
					iParam0->f_4 = 5;
					iVar14 = 0;
					iParam0->f_272 = 1;
				}
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_70(StackVal, StackVal, StackVal, StackVal, StackVal, Function_132(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
		...
		case 0x0000000A:
			if (!bParam2 && !Function_150())
			{
				...
				while (bVar1 <= iParam3)
				{
					Function_67(StackVal, iParam0->f_288, iParam0->f_244, (*iParam0 + 24)[bVar1], (*iParam0 + 172)[bVar1], iParam0->f_308, bVar1);
					bVar1++;
				}
				if (iParam3 >= 1)
				{
					Function_66(StackVal, iParam0->f_12, iParam0 + 48, 2, iParam0 + 228);
				}
				else
				{
					Function_66(StackVal, iParam0->f_12, iParam0 + 48, 1, iParam0 + 228);
				}
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
		...
		case 0x0000000B:
							...
							if ((!STRING_CONTAINS_STRING(bParam6, "bad") && !STRING_CONTAINS_STRING(bParam6, "law")) && iParam8 != 1)
							{
								if (VDIST(*(iParam0 + 200), Global_34574) > 10.0f)
								{
									if (IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player"))
									{
										...
										Function_55(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, false));
			...
			if ((iParam0->f_268 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player")) && !iParam0->f_276)
			{
				if (SQUAD_IS_VALID(iParam0->f_244) && SQUAD_GET_SIZE(iParam0->f_244) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_12) < 10.0f)
						{
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_14(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_11, iParam0 + 312, 0, 0, 0x40400000))
						{
							...
							iParam0->f_280 = 1;
							Function_54(iParam0->f_244, 1);
							Function_53(iParam0->f_244, Global_34573, -1.0f, -1.0f, 0, 2);
							if (iLocal_11 == 8)
							{
					...
					while (bVar1 <= iParam0->f_228)
					{
						if (IS_ACTOR_VALID((*iParam0 + 228)[bVar1]))
						{
							if (GET_LAST_ATTACKER((*iParam0 + 228)[bVar1]) != Global_34573 || GET_RIDER((*iParam0 + 228)[bVar1]) != Global_34573)
							{
								...
								Function_54(iParam0->f_244, 1);
								Function_53(iParam0->f_244, Global_34573, -1.0f, -1.0f, 0, 2);
								TASK_KILL_CHAR(Function_52(iParam0->f_244), Global_34573);
								iParam0->f_4 = 12;
								break;
							}
						}
			...
			if (bParam4 && !bVar13)
			{
				Function_48(iParam0, bParam2, 0);
			}
			else if (iParam0->f_256)
			{
				Function_48(iParam0, bParam2, 1);
			}
			if (!iParam0->f_268)
			{
			}
			if (GET_VEHICLE(Function_47()) != iParam0->f_240 && IS_ACTOR_VALID(iParam0->f_240))
			{
				Function_46(iParam0->f_244, Function_47(), 4);
				Function_45(iParam0->f_244, Function_47());
			}
			...
			if (!bParam2 && !bVar13)
			{
				if (Function_44(StackVal, StackVal, vVar7, 1.0f, 80.0f, 1, 1, 0))
				{
					Global_25266 = GET_CURRENT_GAME_TIME();
				}
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					if (Function_43(iParam0->f_244, 1.0f, 80.0f, 1, 1))
					{
						Global_25266 = GET_CURRENT_GAME_TIME();
					}
				}
				...
				while (bVar1 <= SQUAD_GET_SIZE(iParam0->f_244))
				{
					if (IS_ACTOR_VALID(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1)))
					{
						if (!iParam0->f_280)
						{
							...
							Function_34(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), 4, 0, 2);
						}
...
void Function_31(int iParam0) //Position: 0x2366 / 9062
{
...
void Function_32(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2376 / 9078
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar0 <= SQUAD_GET_SIZE(*uParam0))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			if (IS_ACTOR_RIDING_VEHICLE(bVar1))
			{
				...
				{
					if (!Function_33(bVar1, 0x3f800000, 0x42960000, 1, 1, 0))
					{
						DESTROY_ACTOR(bVar1);
					}
...
bool Function_33(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x2574 / 9588
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_34(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x258E / 9614
{
	bool bVar0;
	bool bVar1;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(bParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(bVar1))
				{
					Function_35(bVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_35(bParam0, iParam1, uParam2, uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_35(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x266E / 9838
{
	char* cVar0[32];
	...
	Function_40(bParam0, 0);
	Function_39(bParam0, iParam1);
	Function_38(bParam0, uParam2);
	Function_37(bParam0, uParam3);
	if (Function_36(bParam0) != 5)
	{
...
int Function_36(bool bParam0) //Position: 0x28BC / 10428
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_37(bool bParam0, bool bParam1) //Position: 0x28DF / 10463
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_38(bool bParam0, bool bParam1) //Position: 0x2902 / 10498
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_39(bool bParam0, bool bParam1) //Position: 0x2926 / 10534
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_40(bool bParam0, bool bParam1) //Position: 0x294C / 10572
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_41(bool bParam0) //Position: 0x296F / 10607
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_42() //Position: 0x298D / 10637
{
...
bool Function_43(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x29D7 / 10711
{
	bool bVar0;
	bool bVar1;
	...
	if (SQUAD_IS_VALID(bParam0))
	{
		...
		while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
		{
			...
			if (IS_ACTOR_VALID(bVar1))
			{
				if (Function_33(bVar1, uParam1, uParam2, uParam3, uParam4, 0))
				{
					return 1;
				}
			}
...
bool Function_44(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2A29 / 10793
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x2A45 / 10821
{
	bool bVar0;
	bool bVar1;
...
void Function_46(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2A97 / 10903
{
	bool bVar0;
	bool bVar1;
...
var Function_47() //Position: 0x2ADC / 10972
{
...
void Function_48(int iParam0, bool bParam1, bool bParam2) //Position: 0x2AF1 / 10993
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_51(iParam0->f_244))
	{
		return;
	}
	if (!Function_49(StackVal, StackVal, iParam0->f_244, *(iParam0 + 200), 10.0f))
	{
		return;
	}
	if (VDIST(*(iParam0 + 200), Global_34574) > 15.0f)
	{
		AI_GOAL_LOOK_AT_ACTOR(Function_52(iParam0->f_244), Global_34573, 0, 1065353216, 3212836864, 3212836864, 0);
		FORCE_LOOK_AT_ACTOR(Function_52(iParam0->f_244), Global_34573, 5.0f);
		bVar1 = false;
		while (bVar1 <= SQUAD_GET_SIZE(iParam0->f_244))
		{
		...
		if (bParam2)
		{
			SAY_SINGLE_LINE_CONTEXT(Function_52(iParam0->f_244), 96, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		else
		{
			SAY_SINGLE_LINE_CONTEXT(Function_52(iParam0->f_244), 120, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
		}
		iParam0->f_264 = 1;
	}
	return;
...
bool Function_49(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2C14 / 11284
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (Function_50(StackVal, StackVal, vParam1))
	{
		return 0;
	}
	iVar2 = 0;
...
bool Function_50(vector3 vParam0) //Position: 0x2C82 / 11394
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_51(bool bParam0) //Position: 0x2C9A / 11418
{
	bool bVar0;
	bool bVar1;
...
var Function_52(bool bParam0) //Position: 0x2CF1 / 11505
{
	bool bVar0;
	bool bVar1;
...
void Function_53(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2D37 / 11575
{
	bool bVar0;
	bool bVar1;
...
void Function_54(bool bParam0, bool bParam1) //Position: 0x2DA5 / 11685
{
	bool bVar0;
	bool bVar1;
...
void Function_55(bool bParam0) //Position: 0x2DED / 11757
{
	struct<21> Var0;
	
	bVar12 = Function_65(GET_ACTOR_ENUM(bParam0), &Var0);
	if (bVar12)
	{
		iVar13 = Function_57(&Var0);
		iVar14 = 0;
		if (iVar13 == 2)
		{
			if (Function_56())
...
bool Function_56() //Position: 0x2EAB / 11947
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_57(int iParam0) //Position: 0x2EBE / 11966
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	iParam0->f_20 = 0;
	(iParam0 + 24)->f_20 = 0;
	if (Function_62(*iParam0, 0))
	{
		bVar0 = Function_58(StackVal);
...
bool Function_58(int iParam0) //Position: 0x2F6F / 12143
{
...
bool Function_59(int iParam0) //Position: 0x2F8E / 12174
{
...
bool Function_60(int iParam0) //Position: 0x2FB2 / 12210
{
...
bool Function_61(int iParam0) //Position: 0x2FC7 / 12231
{
...
bool Function_62(int iParam0, bool bParam1) //Position: 0x2FDE / 12254
{
	int iVar0;
...
var Function_63(int iParam0) //Position: 0x301B / 12315
{
...
bool Function_64(int iParam0) //Position: 0x3035 / 12341
{
...
int Function_65(int iParam0, int iParam1) //Position: 0x304B / 12363
{
	int iVar0;
...
void Function_66(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x3084 / 12420
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_67(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x3151 / 12625
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_68(bool bParam0, bool bParam1) //Position: 0x32E8 / 13032
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_69(bool bParam0) //Position: 0x330A / 13066
{
	bool bVar0;
	bool bVar1;
...
var Function_70(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x334E / 13134
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_71(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x3497 / 13463
{
	var uVar0[5];
	int iVar6;
...
int Function_72(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x3538 / 13624
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x35CC / 13772
{
	if (Function_79(&uLocal_5, 29, 1))
	{
		bLocal_3 = Function_77(Global_30685[0], "escalera", "villaWall04", 1);
		bLocal_4 = Function_77(Global_30685[0], "escalera", "villaWall04", 2);
		if (IS_DOOR_VALID(bLocal_3) && IS_DOOR_VALID(bLocal_4))
		{
			if (Function_75(&bLocal_7, "mexarmy04mobile", iParam1))
			{
				uParam0->f_12 = bLocal_7;
				if (!IS_DOOR_LOCKED(bLocal_3))
				{
					Function_74(bLocal_3, 1);
				}
				if (IS_DOOR_OPENED(bLocal_3))
				{
					CLOSE_DOOR_FAST(bLocal_3);
				}
				if (!IS_DOOR_LOCKED(bLocal_4))
				{
					Function_74(bLocal_4, 1);
				}
				if (IS_DOOR_OPENED(bLocal_4))
				{
					CLOSE_DOOR_FAST(bLocal_4);
				}
				cLocal_6 = CREATE_LAYOUT(Function_132());
				return 1;
			}
		}
	}
...
void Function_74(bool bParam0, bool bParam1) //Position: 0x36A0 / 13984
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_75(var uParam0, char* cParam1, int iParam2) //Position: 0x36F4 / 14068
{
...
void Function_76(bool bParam0, bool bParam1) //Position: 0x371F / 14111
{
	int iVar0;
...
var Function_77(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x3761 / 14177
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_78(int iParam0) //Position: 0x37FD / 14333
{
...
bool Function_79(var uParam0, var uParam1, bool bParam2) //Position: 0x3813 / 14355
{
	var uVar0;
...
int Function_80(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3830 / 14384
{
	var uVar0;
	bool bVar1;
	struct<9> Var2;
...
var Function_81(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x39F9 / 14841
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x3EE3 / 16099
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_83(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3F03 / 16131
{
	bool bVar0;
...
int Function_84(bool bParam0, bool bParam1) //Position: 0x3F57 / 16215
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3FD7 / 16343
{
	Function_87(bParam0);
	Function_86(bParam0);
...
void Function_86(bool bParam0) //Position: 0x4000 / 16384
{
...
void Function_87(bool bParam0) //Position: 0x4024 / 16420
{
...
bool Function_88(bool bParam0) //Position: 0x40F3 / 16627
{
...
int Function_89(int iParam0, bool bParam1) //Position: 0x410A / 16650
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x419D / 16797
{
	bool bVar0;
	bool bVar1;
...
void Function_91(bool bParam0) //Position: 0x4294 / 17044
{
	bool bVar0;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x42C0 / 17088
{
	int iVar0;
...
bool Function_93(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x42DC / 17116
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_24(bParam0);
...
void Function_94() //Position: 0x4366 / 17254
{
	bool bVar0;
	bool bVar1;
...
bool Function_95(bool bParam0) //Position: 0x43CB / 17355
{
...
var Function_96(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x43E7 / 17383
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(int iParam0) //Position: 0x4487 / 17543
{
	bool bVar0;
	int iVar1;
	...
	if (!iParam0->f_128 != 0)
	{
		...
		if (Function_12(iParam0 + 128, 4096))
		{
			...
			{
				bVar0 = Function_58(Function_63(iParam0->f_132));
...
bool Function_98(int iParam0) //Position: 0x4581 / 17793
{
	int iVar0;
	int iVar1;
	...
	Function_102();
	iVar1 = 0;
	if (!Function_29(iParam0[iVar03], 16))
	{
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_29(iParam0[iVar03], 4))
		{
			if (!Function_29(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP((*iParam0)[iVar03], (Function_29(iParam0[03], 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_29(iParam0[03], 8) || iVar1));
						break;
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_29(iParam0[iVar03], 4))
		{
			if (!Function_29(iParam0[iVar03], 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_99() //Position: 0x48FC / 18684
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x493C / 18748
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x4967 / 18791
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x4978 / 18808
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x49BA / 18874
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4A3E / 19006
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4A67 / 19047
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4AB8 / 19128
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4AC8 / 19144
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4ADC / 19164
{
	int iVar0;
...
var Function_109() //Position: 0x4B01 / 19201
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4B18 / 19224
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4C43 / 19523
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_112() //Position: 0x4C54 / 19540
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_113() //Position: 0x4C65 / 19557
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4C76 / 19574
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4C99 / 19609
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4CB8 / 19640
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4CC4 / 19652
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4CCF / 19663
{
	bool bVar0;
...
var Function_119() //Position: 0x4CFD / 19709
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4D12 / 19730
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4E16 / 19990
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4E2A / 20010
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4E94 / 20116
{
	char* cVar0[32];
...
var Function_124() //Position: 0x4EB3 / 20147
{
	return "PBox_";
}

var Function_125() //Position: 0x4EC1 / 20161
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x4EE7 / 20199
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x4F0F / 20239
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x4F35 / 20277
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5096 / 20630
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5131 / 20785
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x5292 / 21138
{
...
var Function_132() //Position: 0x52F3 / 21235
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x52FB / 21243
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x5314 / 21268
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5607 / 22023
{
	int iVar0;
...
void Function_136() //Position: 0x56BB / 22203
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x56F5 / 22261
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5722 / 22306
{
	bool bVar0;
...
void Function_139() //Position: 0x5873 / 22643
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x58BE / 22718
{
	int iVar0;
	...
	{
		if (!Function_29(uParam0[iVar03], 4))
		{
...
int Function_141() //Position: 0x598E / 22926
{
	int iVar0;
...
int Function_142() //Position: 0x5AEA / 23274
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5C0A / 23562
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5CDA / 23770
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5CF8 / 23800
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
	...
	{
		if (!Function_50(StackVal, StackVal, *iParam2))
		{
			return 1;
		}
	}
...
bool Function_146(bool bParam0) //Position: 0x5E2A / 24106
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x5E49 / 24137
{
	int iVar0;
...
int Function_148() //Position: 0x5E65 / 24165
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x5E7E / 24190
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x5E8A / 24202
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x5E93 / 24211
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x5F10 / 24336
{
	int iVar0;
