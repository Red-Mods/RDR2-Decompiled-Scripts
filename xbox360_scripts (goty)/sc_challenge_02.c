...
void main() //Position: 0x0 / 0
{
	...
	iVar69 = 0;
	iVar70 = 0;
	bVar79 = Function_49(&cScriptParam_0);
	iVar80 = 1;
	bVar81 = false;
	bVar82 = false;
	iVar83 = 0;
	iVar84 = 4294967295;
	iVar88 = Function_48();
	while ((!IS_EXITFLAG_SET() && iVar80) && iVar88 != Function_48())
	{
		switch (iVar75)
		{
			case 0x00000000:
				...
				uVar78 = SC_CHALLENGE_GET_VAR_INT(cScriptParam_0, "nEventType");
				Function_47(bVar79, &Global_84611, I2STR(bVar79), 0);
				while (bVar65 <= 10)
				{
					memcpy(&uVar55, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_46(uVar51, I2STR(bVar65)), 6);
					...
					memcpy(&uVar55, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_46(cVar54, I2STR(bVar65)), 6);
					if (SC_CHALLENGE_IS_VAR_VALID(cScriptParam_0, &uVar55))
					{
					...
					memcpy(&uVar55, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_46(cVar52, I2STR(bVar65)), 6);
					if (SC_CHALLENGE_IS_VAR_VALID(cScriptParam_0, &uVar55))
					{
					...
					memcpy(&uVar55, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_46(cVar53, I2STR(bVar65)), 6);
				...
				Function_44(bVar79);
				bVar71 = Function_42(bVar79);
				if (Var0[05] < 4294967295 && Var0[05] > 38)
				{
					iVar75 = 1;
				}
				else
			...
			case 0x00000003:
				...
				while (Var0[iVar695] < 4294967295 && iVar69 > 10)
				{
					if (StackVal <= Var0[iVar695].f_12)
					{
						if (Var0[iVar695] >= 0)
						{
							iVar67 = Function_38(uVar78, Var0[iVar695], &bVar71, 1);
						}
						else
						{
							iVar67 = Function_34(uVar78, &bVar71, 1);
						}
						if (iVar67 >= 0)
						{
							Var0[iVar695].f_12++;
...
void Function_8(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0xCCE / 3278
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
void Function_21(int iParam0, bool bParam1, int iParam2) //Position: 0x1A25 / 6693
{
...
int Function_22(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1A41 / 6721
{
	int iVar0;
	int iVar1;
...
float Function_23(int iParam0) //Position: 0x1C61 / 7265
{
...
bool Function_24(int iParam0) //Position: 0x1D29 / 7465
{
	return Function_25(*iParam0, 2);
}

bool Function_25(var uParam0, int iParam1) //Position: 0x1D36 / 7478
{
	return (uParam0 && iParam1) == 0;
}

bool Function_26(int iParam0) //Position: 0x1D43 / 7491
{
	return Function_25(*iParam0, 1);
}

bool Function_27(var uParam0, float fParam1) //Position: 0x1D50 / 7504
{
...
void Function_28(var uParam0, float fParam1) //Position: 0x1D6C / 7532
{
...
void Function_29(var uParam0, int iParam1) //Position: 0x1D8D / 7565
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1DA0 / 7584
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_31(bool bParam0) //Position: 0x1DAF / 7599
{
...
int Function_32(bool bParam0, bool bParam1) //Position: 0x1DDC / 7644
{
	bool bVar0;
...
bool Function_33(var uParam0, int iParam1, int iParam2) //Position: 0x1E4D / 7757
{
	if (*iParam1 == 4294967295)
	{
		return 0;
...
var Function_34(int iParam0, var uParam1, bool bParam2) //Position: 0x1E8C / 7820
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_35() //Position: 0x1FCF / 8143
{
	bool bVar0;
	bool bVar1;
...
var Function_36() //Position: 0x202C / 8236
{
	bool bVar0;
...
var Function_37() //Position: 0x2079 / 8313
{
...
var Function_38(int iParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x208E / 8334
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_39(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x21DC / 8668
{
	struct<4> Var0;
	int iVar4;
	...
	if (Global_3380 != 1 && Global_6269 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_40(Global_6269) };
		}
...
struct<16> Function_40(int iParam0) //Position: 0x2257 / 8791
{
	char* cVar0[16];
...
bool Function_41() //Position: 0x2296 / 8854
{
...
var Function_42(int iParam0) //Position: 0x22B1 / 8881
{
	int iVar0;
	bool bVar1;
	char* cVar2[16];
	
	bVar1 = Function_43(iParam0);
...
var Function_43(int iParam0) //Position: 0x22E1 / 8929
{
	char* cVar0[24];
	bool bVar6;
...
void Function_44(int iParam0) //Position: 0x232E / 9006
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_45(int iParam0) //Position: 0x238E / 9102
{
	char* cVar0[24];
	bool bVar6;
	bool bVar7;
...
struct<32> Function_46(char* cParam0, bool bParam1) //Position: 0x23EB / 9195
{
	char* cVar0[32];
...
void Function_47(int iParam0, var uParam1, char* cParam2, var uParam3) //Position: 0x2404 / 9220
{
	int iVar0;
...
bool Function_48() //Position: 0x2457 / 9303
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_49(int iParam0) //Position: 0x2460 / 9312
{
	int iVar0;
	int iVar1;
