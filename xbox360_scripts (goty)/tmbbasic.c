...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_39 + 1896) = { -3949.347f, 28.884f, 2951.231f };
		...
		AUDIO_MUSIC_FORCE_TRACK("TC_FTR_SONG_02", "nIDLE_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
...
void Function_3(bool bParam0, bool bParam1, int iParam2) //Position: 0x898 / 2200
{
	bool bVar0;
...
void Function_32(var uParam0, bool bParam1) //Position: 0x175D / 5981
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_34(var uParam0, int iParam1, bool bParam2) //Position: 0x1ADA / 6874
{
	int iVar0;
...
var Function_35(bool bParam0) //Position: 0x1AF9 / 6905
{
...
void Function_45(bool bParam0, int iParam1) //Position: 0x1C8F / 7311
{
	struct<13> Var0;
...
void Function_52(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x202E / 8238
{
	if (iParam2 != 0)
	{
...
void Function_60(bool bParam0, bool bParam1) //Position: 0x2229 / 8745
{
	if (Function_102(4))
	{
...
void Function_61(bool bParam0, int iParam1, bool bParam2) //Position: 0x225C / 8796
{
	if (bParam0)
	{
		if (Function_103())
		...
		else
		{
			...
			if (bVar1)
			{
				...
				if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(Local_39[iVar090].f_356))
				{
					...
					PRINT_SMALL_FORMAT(2.5f, "COOP_Selected", Function_81(Local_39[iVar090].f_324, 0), false, 0, false, 2, 0, 0);
...
void Function_85(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F73 / 12147
{
	struct<4> Var0;
	int iVar4;
...
void Function_91(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x30EA / 12522
{
	vector3 vVar0;
	int iVar3;
...
void Function_106(int iParam0, int iParam1, bool bParam2) //Position: 0x3379 / 13177
{
...
void Function_113(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x36F1 / 14065
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_114(bool bParam0, var uParam1, int iParam2) //Position: 0x386E / 14446
{
	switch (bParam0)
	{
		case 0x00000004:
...
var Function_116(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3968 / 14696
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_125() //Position: 0x402E / 16430
{
	return Function_126(39);
}

int Function_126(bool bParam0) //Position: 0x4039 / 16441
{
	int iVar0;
...
int Function_156(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A73 / 19059
{
	bool bVar0;
	bool bVar1;
