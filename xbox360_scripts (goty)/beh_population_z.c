...
void main() //Position: 0x0 / 0
{
	...
	bVar3 = FIND_NAMED_LAYOUT("BeechersHope_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "behv_birds_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar1, 1, 2, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("beh_pop: Cannot find behv_birds_set to create population volumes");
		}
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "behv_region");
		if (IS_VOLUME_VALID(bVar4))
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xBA5 / 2981
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xBB4 / 2996
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC09 / 3081
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xC89 / 3209
{
	bool bVar0;
...
bool Function_5(int iParam0) //Position: 0xD0B / 3339
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0xD27 / 3367
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xD65 / 3429
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xD81 / 3457
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD91 / 3473
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xE09 / 3593
{
	int iVar0;
...
var Function_11(int iParam0) //Position: 0xE75 / 3701
{
	int iVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xEE1 / 3809
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0xF26 / 3878
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_14(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF32 / 3890
{
	int iVar0;
	int iVar1;
...
var Function_15(int iParam0, int iParam1) //Position: 0xFAE / 4014
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_16(bool bParam0, var uParam1) //Position: 0xFBB / 4027
{
	if (!Function_5(128))
	{
		return;
