...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Rio", 4);
	Function_15("Loading Rio Bravo population file", 3);
	Global_30839++;
	...
	bVar12 = FIND_NAMED_LAYOUT("RioBravo_layout");
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "riov_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar14 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			...
			uVar16 = Function_3(bVar13, uVar5, 2E-05f, 0, 0, 1);
			...
			uVar17 = Function_3(bVar13, uVar6, 2E-05f, 0, 0, 1);
			...
			uVar18 = Function_3(bVar13, uVar7, 3E-05f, 0, 0, 1);
			...
			Function_3(bVar13, uVar1, 4E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find riov_flk_CENTER_set to create population volumes");
		}
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "riov_flk_SOUTH_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar20 = Function_3(bVar13, uVar0, 4E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar20, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar20, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar20, 10);
			uVar21 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar22 = Function_3(bVar13, uVar5, 2E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(bVar13, uVar6, 2E-05f, 0, 0, 1);
			...
			uVar24 = Function_3(bVar13, uVar7, 2E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar24, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar24, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar24, 6);
			uVar25 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
		...
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "riov_flk_NORTH_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar26 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar26, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar26, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar26, 20);
			uVar27 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar28 = Function_3(bVar13, uVar5, 2E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(bVar13, uVar6, 1E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(bVar13, uVar7, 1E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
...
void Function_1(var uParam0, var uParam1) //Position: 0x1215 / 4629
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1224 / 4644
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1279 / 4729
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0x12F9 / 4857
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0x1315 / 4885
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x1353 / 4947
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x136F / 4975
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x137F / 4991
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x13F7 / 5111
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1463 / 5219
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x14CF / 5327
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1514 / 5396
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1520 / 5408
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x159C / 5532
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x15A9 / 5545
{
	if (!Function_4(128))
	{
		return;
