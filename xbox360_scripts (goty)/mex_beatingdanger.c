...
bool Function_26(var uParam0, bool bParam1) //Position: 0x1D10 / 7440
{
	bParam1 = bParam1;
	uParam0 = uParam0;
...
bool Function_27(bool bParam0) //Position: 0x1D38 / 7480
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D57 / 7511
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D5D / 7517
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D6B / 7531
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D76 / 7542
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D90 / 7568
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DAE / 7598
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DCD / 7629
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E00 / 7680
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E1F / 7711
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E39 / 7737
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E4C / 7756
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2134 / 8500
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x213C / 8508
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2159 / 8537
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2168 / 8552
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x218A / 8586
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21AE / 8622
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21CB / 8651
{
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x220B / 8715
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22B9 / 8889
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2329 / 9001
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x233F / 9023
{
...
var Function_51(bool bParam0) //Position: 0x2360 / 9056
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2380 / 9088
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2394 / 9108
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x239E / 9118
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23A5 / 9125
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23B4 / 9140
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x23F3 / 9203
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x241E / 9246
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2429 / 9257
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x251F / 9503
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2541 / 9537
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2568 / 9576
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2827 / 10279
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2884 / 10372
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28E1 / 10465
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28EB / 10475
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2909 / 10505
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x291E / 10526
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29A5 / 10661
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29C8 / 10696
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29E6 / 10726
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A09 / 10761
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B24 / 11044
{
...
int Function_74(bool bParam0) //Position: 0x2B4F / 11087
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C54 / 11348
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C61 / 11361
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CD4 / 11476
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31D2 / 12754
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3209 / 12809
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3226 / 12838
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x325E / 12894
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3268 / 12904
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, bool bParam1) //Position: 0x3289 / 12937
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3313 / 13075
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x341B / 13339
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3431 / 13361
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36E7 / 14055
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x36F5 / 14069
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x370E / 14094
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x3728 / 14120
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3760 / 14176
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3777 / 14199
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A40 / 14912
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A5D / 14941
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3AF9 / 15097
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B18 / 15128
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B27 / 15143
{
...
void Function_98(int iParam0) //Position: 0x3B43 / 15171
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B4D / 15181
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BAF / 15279
{
...
void Function_102(int iParam0) //Position: 0x3BCD / 15309
{
