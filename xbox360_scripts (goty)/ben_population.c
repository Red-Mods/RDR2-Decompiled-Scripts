...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar10))
	{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar2, 2E-06f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar7, 0.00025f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar5, 5E-06f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar8, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar3, 2E-05f, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_3(bVar11, uVar1, 2, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_5(bVar11, uVar9, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1284 / 4740
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1306 / 4870
{
	bool bVar0;
...
var Function_5(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1386 / 4998
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1504 / 5380
{
	int iVar0;
...
var Function_12(int iParam0) //Position: 0x1570 / 5488
{
	int iVar0;
...
var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x15DC / 5596
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1658 / 5720
{
	int iVar0;
	int iVar1;
...
var Function_15(int iParam0, int iParam1) //Position: 0x169D / 5789
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_16(int iParam0) //Position: 0x16AA / 5802
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_17(bool bParam0, var uParam1) //Position: 0x16B6 / 5814
{
	if (!Function_6(128))
	{
		return;
