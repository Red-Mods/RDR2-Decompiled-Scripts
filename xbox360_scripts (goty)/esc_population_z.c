...
void main() //Position: 0x0 / 0
{
	...
	Function_11(&uVar0, 1206, 5.0f, 0, 0);
	Function_11(&uVar0, 1207, 5.0f, 0, 0);
	Function_11(&uVar0, 1208, 5.0f, 0, 0);
	Function_11(&uVar0, 1209, 5.0f, 0, 0);
	Function_11(&uVar0, 1210, 5.0f, 0, 0);
	Function_11(&uVar0, 1211, 5.0f, 0, 0);
	Function_11(&uVar0, 1212, 5.0f, 0, 0);
	Function_11(&uVar0, 1213, 5.0f, 0, 0);
	Function_11(&uVar0, 1214, 5.0f, 0, 0);
	Function_11(&uVar0, 1215, 5.0f, 0, 0);
	Function_11(&uVar0, 1216, 5.0f, 0, 0);
	Function_11(&uVar0, 1217, 5.0f, 0, 0);
	Function_11(&uVar0, 1218, 5.0f, 0, 0);
	Function_11(&uVar0, 1219, 5.0f, 0, 0);
	Function_11(&uVar0, 1220, 5.0f, 0, 0);
	Function_11(&uVar0, 1222, 5.0f, 0, 0);
	Function_11(&uVar0, 1223, 5.0f, 0, 0);
	Function_11(&uVar0, 1224, 5.0f, 0, 0);
	Function_11(&uVar0, 1225, 5.0f, 0, 0);
	Function_11(&uVar0, 1226, 5.0f, 0, 0);
	Function_11(&uVar0, 1227, 5.0f, 0, 0);
	...
	uVar1 = Function_12("zombie_dogs", 0);
	Function_11(&uVar1, 1240, 10.0f, 0, 0);
	...
	bVar3 = FIND_NAMED_LAYOUT("Escalera_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_whorehouse");
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_cantina_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar0, 5, 10, 0, 0, 1);
		}
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_cantina_exterior_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar0, 5, 10, 0, 0, 1);
		}
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_streets_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar0, 30, 50, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar1, 1, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("esc_pop: Cannot find escv_streets_set to create population volumes");
		}
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_slums_set");
		if (IS_VOLUME_VALID(bVar4))
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_market_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar0, 10, 30, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("esc_pop: Cannot find escv_market_set to create population volumes");
		}
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "escv_church");
		if (IS_VOLUME_VALID(bVar4))
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xFD4 / 4052
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xFE3 / 4067
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1038 / 4152
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x10B8 / 4280
{
	bool bVar0;
...
bool Function_5(int iParam0) //Position: 0x113A / 4410
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0x1156 / 4438
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x1194 / 4500
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x11B0 / 4528
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x11C0 / 4544
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x1205 / 4613
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1211 / 4625
{
	int iVar0;
	int iVar1;
...
var Function_12(bool bParam0, int iParam1) //Position: 0x128D / 4749
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_13(bool bParam0, var uParam1) //Position: 0x129A / 4762
{
	if (!Function_5(128))
	{
		return;
