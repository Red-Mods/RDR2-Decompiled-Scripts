...
void Function_5(int iParam0, int iParam1, int iParam2) //Position: 0x351 / 849
{
	bool bVar0;
...
void Function_6(int iParam0, bool bParam1, bool bParam2) //Position: 0x437 / 1079
{
	int iVar0;
...
void Function_7() //Position: 0x5B0 / 1456
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_8(bool bParam0) //Position: 0x5BC / 1468
{
	PRINTSTRING("Day ");
...
void Function_9(int iParam0) //Position: 0x602 / 1538
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_10(var uParam0, int iParam1) //Position: 0x648 / 1608
{
	int iVar0;
...
bool Function_11(var uParam0, int iParam1) //Position: 0x662 / 1634
{
	int iVar0;
...
void Function_12(int iParam0) //Position: 0x67F / 1663
{
...
void Function_13(bool bParam0) //Position: 0x6AB / 1707
{
	bool bVar0;
...
void Function_14(var uParam0, bool bParam1) //Position: 0x6F0 / 1776
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_15(var uParam0, int iParam1) //Position: 0xABC / 2748
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_16(var uParam0, int iParam1) //Position: 0xACD / 2765
{
	int iVar0;
...
int Function_17(int iParam0, bool bParam1) //Position: 0xAE7 / 2791
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
bool Function_18() //Position: 0xAF9 / 2809
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_19(var uParam0, var uParam1, bool bParam2, var uParam3) //Position: 0xB02 / 2818
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_20(var uParam0, bool bParam1, int iParam2, var uParam3, bool bParam4) //Position: 0xB83 / 2947
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_21(int iParam0) //Position: 0xF9C / 3996
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_22(int iParam0) //Position: 0x109B / 4251
{
...
float Function_23(int iParam0) //Position: 0x10D8 / 4312
{
	if (!iParam0 != 4294967295)
	{
...
void Function_24(int iParam0, bool bParam1) //Position: 0x1111 / 4369
{
	bool bVar0;
...
var Function_25(int iParam0) //Position: 0x1178 / 4472
{
	int iVar0;
...
int Function_26(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x11D0 / 4560
{
	int iVar0;
	int iVar1;
...
void Function_27(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x13F0 / 5104
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_28() //Position: 0x1A1D / 6685
{
	int iVar0;
...
var Function_29(int iParam0) //Position: 0x1A25 / 6693
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_30(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1A36 / 6710
{
	char* cVar0[32];
...
struct<32> Function_31(char* cParam0, bool bParam1) //Position: 0x1B2B / 6955
{
	char* cVar0[32];
...
void Function_32(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1B44 / 6980
{
	float fVar0;
...
var Function_33(int iParam0, int iParam1) //Position: 0x1BA9 / 7081
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_34(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1BBB / 7099
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_35(int iParam0) //Position: 0x1CEB / 7403
{
	return Global_35278[iParam020].f_48;
}

void Function_36(int iParam0) //Position: 0x1CFA / 7418
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_37(int iParam0, float fParam1, bool bParam2) //Position: 0x1E94 / 7828
{
	int iVar0;
	int iVar1;
...
void Function_38(var uParam0, int iParam1) //Position: 0x20D8 / 8408
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_39(struct<5> Param0) //Position: 0x20E5 / 8421
{
...
bool Function_40(var uParam0, int iParam1) //Position: 0x210B / 8459
{
	int iVar0;
...
var Function_41(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x2127 / 8487
{
	vector3 vVar0;
	var uVar3;
	bool bVar4;
	...
	if ((IS_CRIME_VALID(uVar3) && IS_OBJECT_VALID(bVar4)) && GET_OBJECT_TYPE(bVar4) != 2)
	{
		...
		iVar5 = CREATE_OBJECTSET_IN_LAYOUT(Function_28(), Global_26314, 3, 0);
...
void Function_42() //Position: 0x23B7 / 9143
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_43(bool bParam0, bool bParam1) //Position: 0x241A / 9242
{
...
bool Function_44(bool bParam0) //Position: 0x2449 / 9289
{
	if (Function_49(256))
	{
		return 0;
...
int Function_45(int iParam0) //Position: 0x24BF / 9407
{
...
bool Function_46() //Position: 0x24D0 / 9424
{
	if (Global_30619 == 2)
	{
		if (StackVal == 1)
...
bool Function_47(int iParam0) //Position: 0x24E9 / 9449
{
...
bool Function_48(int iParam0) //Position: 0x24FF / 9471
{
...
bool Function_49(int iParam0) //Position: 0x2514 / 9492
{
	int iVar0;
...
bool Function_50(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2532 / 9522
{
	uParam0 = uParam0;
...
bool Function_51(int iParam0) //Position: 0x25D6 / 9686
{
...
void Function_52(var uParam0, int iParam1) //Position: 0x25EC / 9708
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_53(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x25FD / 9725
{
	int iVar0;
	bool bVar1;
...
void Function_54(int iParam0, int iParam1) //Position: 0x266F / 9839
{
	int iVar0;
...
bool Function_55(int iParam0) //Position: 0x2694 / 9876
{
	if (*iParam0 == 0)
	{
		return 0;
...
bool Function_56(int iParam0) //Position: 0x26B1 / 9905
{
	int iVar0;
...
void Function_57(bool bParam0, float fParam1) //Position: 0x26CD / 9933
{
	if (!Function_56(128))
	{
		return;
...
void Function_58(var uParam0, bool bParam1) //Position: 0x270B / 9995
{
	*uParam0 = (*uParam0 || bParam1);
	return;
}

var Function_59(var uParam0, int iParam1, bool bParam2, int iParam3, char* cParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x271A / 10010
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_60(bool bParam0) //Position: 0x27F9 / 10233
{
	int iVar0;
...
void Function_61(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x2827 / 10279
{
...
void Function_62(int iParam0) //Position: 0x2902 / 10498
{
	*iParam0 = 0;
	iParam0->f_4 = 0;
	return;
...
var Function_63(bool bParam0, char* cParam1, int iParam2) //Position: 0x2911 / 10513
{
	Global_29155[iParam210].f_32 = CREATE_WORLD_SECTOR(bParam0, cParam1);
	return Global_29155[iParam210].f_32;
}

bool Function_64() //Position: 0x2930 / 10544
{
	var uVar0;
...
void Function_65(int iParam0, int iParam1) //Position: 0x3CA1 / 15521
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_66() //Position: 0x3CEA / 15594
{
...
void Function_67(bool bParam0, var uParam1) //Position: 0x3CFF / 15615
{
	if (!Function_56(128))
	{
		return;
