...
void Function_74() //Position: 0x1C1B / 7195
{
	...
	bVar0 = Function_75("hennigansRanch", "ncottage03", 1);
...
int Function_75(var uParam0, var uParam1, int iParam2) //Position: 0x1C51 / 7249
{
	return Function_76(Global_29006, uParam0, uParam1, iParam2);
}

int Function_76(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x1C63 / 7267
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
void Function_77() //Position: 0x1CFF / 7423
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_78(4, 1);
	uVar0 = uVar0;
	Local_177 = CREATE_LAYOUT("Poker_HEN_layout");
	Local_177.f_4 = CREATE_VOLUME_IN_LAYOUT(Local_177, "PlayableSpace", 2, -801.9144f, 94.54633f, 2376.035f, 0.0f, -33.07299f, 0.0f, 7.645823f, 5.617232f, 9.789737f);
	Local_177.f_8 = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", Local_177, 8, 0);
	*(&Local_177 + 12[06]) = { -801.308f, 92.77644f, 2378.256f };
	*(&Local_177 + 12[06] + 12) = { 0.0f, 60.64319f, 0.0f };
	bVar1 = CREATE_POINT_IN_LAYOUT(Local_177, "PlayerPosition", -801.308f, 92.77644f, 2378.256f, 0.0f, 60.64319f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar1);
	*(&Local_177 + 12[16]) = { -801.9977f, 92.76498f, 2379.166f };
	*(&Local_177 + 12[16] + 12) = { 0.0f, -4.489308f, 0.0f };
	bVar2 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_0_Position", -801.9977f, 92.76498f, 2379.166f, 0.0f, -4.489308f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar2);
	*(&Local_177 + 12[26]) = { -804.7414f, 92.76498f, 2376.985f };
	*(&Local_177 + 12[26] + 12) = { 0.0f, 259.7184f, 0.0f };
	bVar3 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_1_Position", -804.7414f, 92.76498f, 2376.985f, 0.0f, 259.7184f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar3);
	*(&Local_177 + 12[36]) = { -804.2881f, 92.765f, 2376.293f };
	*(&Local_177 + 12[36] + 12) = { 0.0f, 180.7421f, 0.0f };
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_2_Position", -804.2881f, 92.765f, 2376.293f, 0.0f, 180.7421f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar4);
	*(&Local_177 + 12[46]) = { -803.2666f, 92.765f, 2376.059f };
	*(&Local_177 + 12[46] + 12) = { 0.0f, 305.1362f, 0.0f };
	bVar5 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_3_Position", -803.2666f, 92.765f, 2376.059f, 0.0f, 305.1362f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar5);
	*(&Local_177 + 136) = { -800.8856f, 93.554f, 2375.189f };
	*(&Local_177 + 136 + 12) = { 0.0f, 271.4398f, 0.0f };
	Local_177.f_160 = CREATE_POINT_IN_LAYOUT(Local_177, "TableCenter", -800.8856f, 93.554f, 2375.189f, 0.0f, 271.4398f, 0.0f);
	Local_177.f_164 = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", Local_177, 8, 0);
	*(&Local_177 + 168[06]) = { -802.4116f, 93.75813f, 2375.009f };
	*(&Local_177 + 168[06] + 12) = { 0.0f, -159.0592f, 0.0f };
	bVar6 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_0_Pos", -802.4116f, 93.75813f, 2375.009f, 0.0f, -159.0592f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar6, Local_177.f_164);
	*(&Local_177 + 168[16]) = { -801.8246f, 92.76498f, 2372.763f };
	*(&Local_177 + 168[16] + 12) = { 0.0f, -124.4389f, 0.0f };
	bVar7 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_1_Pos", -801.8246f, 92.76498f, 2372.763f, 0.0f, -124.4389f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar7, Local_177.f_164);
	Local_177.f_220 = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", Local_177, 8, 0);
	*(&Local_177 + 224[06]) = { -824.276f, 92.4381f, 2374.495f };
	*(&Local_177 + 224[06] + 12) = { 0.0f, 286.3178f, 0.0f };
	bVar8 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_0", -824.276f, 92.4381f, 2374.495f, 0.0f, 286.3178f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar8, Local_177.f_220);
	*(&Local_177 + 224[16]) = { -807.9985f, 92.26298f, 2367.876f };
	*(&Local_177 + 224[16] + 12) = { 0.0f, -239.942f, 0.0f };
	bVar9 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_1", -807.9985f, 92.26298f, 2367.876f, 0.0f, -239.942f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar9, Local_177.f_220);
	return;
}

void Function_78(int iParam0, int iParam1) //Position: 0x2179 / 8569
{
	switch (iParam1)
	{
		case 0x00000000:
