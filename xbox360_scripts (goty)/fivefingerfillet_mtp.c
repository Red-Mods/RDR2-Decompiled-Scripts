	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_35(Global_30723[1]))
			{
				...
				{
					Function_28("FiveFingerFillet_NotEnoughMoney", 4.0f, 1, 2, 0, 0, 0, 0);
					bLocal_3 = true;
				}
				else
				{
...
void Function_21() //Position: 0xB7A / 2938
{
	Function_1();
	return;
}

bool Function_22(int iParam0) //Position: 0xB83 / 2947
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_23(int iParam0, bool bParam1) //Position: 0xBA4 / 2980
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_24(int iParam0, int iParam1) //Position: 0xBDA / 3034
{
	if (!Function_8(iParam0))
	{
		return;
...
void Function_25(int iParam0) //Position: 0xBF5 / 3061
{
	int iVar0;
	bool bVar1;
...
void Function_26(int iParam0) //Position: 0xC4A / 3146
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
bool Function_27(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0xE88 / 3720
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void Function_28(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x11B4 / 4532
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_29(int iParam0) //Position: 0x1239 / 4665
{
	char* cVar0[16];
...
bool Function_30() //Position: 0x1278 / 4728
{
...
bool Function_31(var uParam0, bool bParam1) //Position: 0x1293 / 4755
{
	return (uParam0 && bParam1) == 0;
}

int Function_32() //Position: 0x12A0 / 4768
{
	return Function_33(0);
}

int Function_33(int iParam0) //Position: 0x12AA / 4778
{
...
var Function_34(int iParam0) //Position: 0x12EB / 4843
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_35(int iParam0) //Position: 0x1305 / 4869
{
...
int Function_36(var uParam0, int iParam1) //Position: 0x1321 / 4897
{
	int iVar0;
...
bool Function_37(int iParam0) //Position: 0x133D / 4925
{
...
void Function_38() //Position: 0x1353 / 4947
{
	Function_1();
	return;
}

void Function_39() //Position: 0x135C / 4956
{
...
void Function_40(int iParam0) //Position: 0x13A8 / 5032
{
...
void Function_41(var uParam0, float fParam1) //Position: 0x13BD / 5053
{
...
void Function_42(var uParam0, int iParam1) //Position: 0x13DE / 5086
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x13F1 / 5105
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_44(var uParam0) //Position: 0x1400 / 5120
{
	return Function_31(*uParam0, 1);
}

void Function_45() //Position: 0x140D / 5133
{
	return;
}

void Function_46(bool bParam0, bool bParam1) //Position: 0x1413 / 5139
{
	bool bVar0;
...
void Function_47(var uParam0) //Position: 0x146A / 5226
{
	int iVar0;
...
var Function_48() //Position: 0x1487 / 5255
{
	var uVar0;
