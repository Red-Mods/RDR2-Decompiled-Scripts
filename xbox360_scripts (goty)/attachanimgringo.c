...
void main() //Position: 0x0 / 0
{
	...
	iLocal_75 = 0;
	Function_96(uScriptParam_0, &iLocal_75);
	while (IS_GRINGO_ACTIVE())
	{
		Function_95(uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_89(&(Local_2[iVar312]), &bVar4))
						{
							Function_87(GRINGO_GET_REQUESTING_ACTOR(), Local_2[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_82("eGRINGO_EndUse: Stop use by request", Local_2[iVar312].f_16);
							Function_81(Local_2[iVar312].f_16, 1);
							...
							{
								Function_74(&(Local_2[iVar312]), 0);
							}
							else if (Local_2[iVar312].f_44 < 8)
							{
								Function_73(&(Local_2[iVar312]));
						...
						{
							Function_99("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_75 - 1))
			{
				if (Function_72(Local_2[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_2[iVar012])))
					{
						Function_99("Quitting due to update end");
						Function_74(&(Local_2[iVar012]), 1);
					}
				}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
	{
		Function_99("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_75 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	if (!Function_72(iParam0->f_40, 2))
	{
		Function_81(iParam0->f_16, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
								{
									Function_99("ManagePlayerQuit: Create quit context");
									if (Function_7(iParam0->f_12, "UseQuitBOverride", 0))
									{
										iLocal_82 = ADD_SCRIPT_USE_CONTEXT(uVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_82 = ADD_SCRIPT_USE_CONTEXT(uVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(iLocal_82))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
									{
										Function_99("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
										{
											Function_99("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
							{
								Function_99("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
							}
						}
					}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
		{
			Function_99("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
		}
...
{
	return Function_72(*iParam0, 2);
}

bool Function_14(int iParam0) //Position: 0x9DC / 2524
{
	return Function_72(*iParam0, 1);
}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	bVar12 = Function_71(iParam0->f_12);
	if (!(IS_ACTOR_VALID(iParam0->f_16) && IS_ACTOR_ALIVE(iParam0->f_16)))
	{
		Function_82("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_82("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_82("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		case 0x00000002:
			...
			{
				if (Function_70(iParam0->f_12, &fVar24))
				{
		...
		case 0x00000001:
			...
			if (((!Global_63096 && IS_ACTOR_LOCAL_PLAYER(iParam0->f_16)) && !Function_72(iParam0->f_40, 1)) && !DECOR_CHECK_EXIST(iParam0->f_16, "NoGringoCamera"))
			{
			...
			if (Function_72(iParam0->f_40, 1))
			{
				Function_56(iParam0->f_12, &vVar3, &uVar6);
				if (!Function_72(iParam0->f_40, 16))
				{
				...
				if (!Function_72(iParam0->f_40, 1024))
				{
			...
			if (iParam0->f_44 != 3 && !Function_72(iParam0->f_40, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(iParam0->f_12))
				{
					Function_2("SUSPEND MOVER", iParam0->f_16);
		...
		case 0x00000003:
			if (Function_72(iParam0->f_40, 32))
			{
				bLocal_81 = true;
		...
		case 0x00000004:
			...
			if (iVar32 == 0)
			{
				bVar33 = Function_72(iParam0->f_40, 1);
			}
				...
				if (GRINGO_PLAY_ANIM_ON_ACTOR(iParam0->f_16, bVar0, bVar33))
				{
					...
					while (iVar11 >= 4294967295)
					{
						...
						if (GRINGO_ATTACH_PROP_TO_ANIM(iParam0->f_16, bVar1, Function_9(bVar1, "AttachBone", &bVar10), Function_9(bVar1, "AttachLocator", &bVar10), 1))
						{
							...
							if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
							{
								iVar34 = GRINGO_GET_PROP_FROM_COMPONENT(bVar1);
								...
								if (iVar23 == GRINGO_GET_ATTRIBUTE_HASH(uVar15))
								{
									...
									while (iVar11 >= 4294967295)
									{
										...
										if (GRINGO_ATTACH_PROP_TO_ANIM(iParam0->f_16, bVar1, Function_9(bVar1, "AttachBone", &bVar10), Function_9(bVar1, "AttachLocator", &bVar10), 1))
										{
											if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
											{
												iVar35 = GRINGO_GET_PROP_FROM_COMPONENT(bVar1);
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_80, &uLocal_79);
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_72(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_29(bool bParam0, int iParam1) //Position: 0x1D41 / 7489
{
	...
	{
		uVar1 = _GET_OBJECT_ATTACHMENT(bVar0);
		if (IS_ATTACHMENT_VALID(uVar1))
		{
			bVar2 = GET_OBJECT_ATTACHED_TO(uVar1);
			if (IS_OBJECT_VALID(bVar2))
			{
				uLocal_1 = ATTACH_OBJECTS_CONTINUOUS(bParam0, bVar2, 4294967295);
			}
		}
	}
	return;
...
bool Function_30(int iParam0) //Position: 0x1D80 / 7552
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D8B / 7563
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DA5 / 7589
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DC3 / 7619
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DE2 / 7650
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E15 / 7701
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E34 / 7732
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E4E / 7758
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E61 / 7777
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar4))
	{
		...
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bParam1, uVar11, uVar12, uVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
...
var Function_39() //Position: 0x2149 / 8521
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2151 / 8529
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x216E / 8558
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x217D / 8573
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x219F / 8607
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21C3 / 8643
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21E0 / 8672
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2200 / 8704
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x2220 / 8736
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (IS_PHYSINST_VALID(bVar1))
		{
			...
			uVar6 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bVar1, uVar2, uVar3, uVar4);
			if (IS_OBJECT_ANIMATOR_VALID(uVar6))
			{
				LINK_OBJECT_ANIMATOR_TO_ACTOR(uVar6, iParam1, GRINGO_GET_PROP_ATTACH_SLOT(bParam0));
			}
		}
	}
	return;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22CE / 8910
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x233E / 9022
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2354 / 9044
{
...
var Function_51(bool bParam0) //Position: 0x2375 / 9077
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2395 / 9109
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23A9 / 9129
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23B3 / 9139
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23BA / 9146
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23C9 / 9161
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x2408 / 9224
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2433 / 9267
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x243E / 9278
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2534 / 9524
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2556 / 9558
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x257D / 9597
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	while (iVar10 >= 4294967295)
	{
		...
		{
			iVar12 = GRINGO_GET_PROP_FROM_COMPONENT(bVar11);
			bVar13 = GET_OBJECT_FROM_PHYSINST(iVar12);
	...
	{
		Function_99("Failed to create gringo camera");
	}
	return;
}

vector3 Function_63(vector3 vParam0) //Position: 0x283C / 10300
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2899 / 10393
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28F6 / 10486
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2900 / 10496
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x291E / 10526
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2933 / 10547
{
	vector3 vVar0;
	float fVar3;
	bool bVar4;
	...
	TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar0, fVar3, 1, 1, 1);
	if (IS_ATTACHMENT_VALID(uLocal_1))
	{
		REMOVE_OBJECT_ATTACHMENT(uLocal_1);
	}
	if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
	{
		...
		uLocal_1 = ATTACH_OBJECTS_CONTINUOUS(bParam0, GET_TARGET_OBJECT(), 4294967295);
	}
	else
	{
		bVar4 = GRINGO_GET_MY_OBJECT_REF();
		bVar4 = Function_69(bVar4);
		if (IS_OBJECT_VALID(bVar4))
		{
			if (IS_OBJECT_ATTACHED(bVar4))
			{
				GET_OBJECT_OWNER(bVar4);
				uVar5 = _GET_OBJECT_ATTACHMENT(bVar4);
				if (IS_ATTACHMENT_VALID(uVar5))
				{
					bVar6 = GET_OBJECT_ATTACHED_TO(uVar5);
					if (IS_OBJECT_VALID(bVar6))
					{
						uLocal_1 = ATTACH_OBJECTS_CONTINUOUS(bParam0, bVar6, 4294967295);
					}
				}
			}
		}
...
var Function_69(bool bParam0) //Position: 0x2A7A / 10874
{
	bool bVar0;
...
bool Function_70(bool bParam0, int iParam1) //Position: 0x2AF7 / 10999
{
...
int Function_71(bool bParam0) //Position: 0x2B22 / 11042
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_72(var uParam0, int iParam1) //Position: 0x2C27 / 11303
{
	return (uParam0 && iParam1) == 0;
}

void Function_73(int iParam0) //Position: 0x2C34 / 11316
{
	if (Function_72(iParam0->f_40, 16))
	{
...
void Function_74(int iParam0, bool bParam1) //Position: 0x2CA7 / 11431
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(iParam0->f_16) && Function_72(iParam0->f_40, 32)) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
	{
	...
	Function_80(iParam0->f_16, iParam0->f_12);
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		GRINGO_REPORT_USE_FINISHED(iParam0->f_16, Function_72(iParam0->f_40, 64));
		Function_17(iParam0->f_16, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_72(iParam0->f_40, 128) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
			{
			...
			if (Function_79(iParam0->f_12) && Function_72(iParam0->f_40, 512))
			{
	...
	if (IS_ACTOR_VALID(iParam0->f_16) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_76(iParam0->f_12), iParam0->f_12);
	}
...
void Function_75() //Position: 0x31A5 / 12709
{
	bool bVar0;
...
bool Function_76(bool bParam0) //Position: 0x31DC / 12764
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_77(var uParam0, int iParam1) //Position: 0x31F9 / 12793
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_78(int iParam0) //Position: 0x3231 / 12849
{
	iParam0 = iParam0;
	return;
}

bool Function_79(bool bParam0) //Position: 0x323B / 12859
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_80(var uParam0, int iParam1) //Position: 0x325C / 12892
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_ATTACHMENT_VALID(uLocal_1))
	{
		PRINTSTRING("---------------------------Detatching---------------------------");
		PRINTNL();
		REMOVE_OBJECT_ATTACHMENT(uLocal_1);
	}
	return;
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x32C0 / 12992
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_99("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_99("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
			{
				if (bParam1)
				{
					Function_99("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(iLocal_82);
			}
		}
	...
	if (bParam1)
	{
		Function_99("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_82(char* cParam0, bool bParam1) //Position: 0x33C8 / 13256
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_83(int iParam0) //Position: 0x33DE / 13278
{
	int iVar0;
	int iVar1;
	char* cVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_84(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_84(var uParam0, int iParam1) //Position: 0x3694 / 13972
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_85(bool bParam0) //Position: 0x36A2 / 13986
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_86(bool bParam0) //Position: 0x36BB / 14011
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_87(int iParam0, int iParam1) //Position: 0x36D5 / 14037
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_88(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_88(var uParam0, int iParam1) //Position: 0x370D / 14093
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_89(int iParam0, int iParam1) //Position: 0x3724 / 14116
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_93(bVar1, iParam0->f_12))
		{
		...
		if (!Function_72(iParam0->f_40, 2))
		{
			...
			if (Function_72(iParam0->f_40, 1))
			{
				Function_82("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_92(iParam0->f_12);
				fVar16 = VMAG(vVar12);
				...
				if (!Function_91(bVar1, iParam0->f_12))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar33 = Function_90(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
...
bool Function_90(bool bParam0) //Position: 0x39ED / 14829
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_91(bool bParam0, bool bParam1) //Position: 0x3A0A / 14858
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_92(int iParam0) //Position: 0x3AA6 / 15014
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_93(var uParam0, int iParam1) //Position: 0x3AC5 / 15045
{
	struct<5> Var0;
...
bool Function_94(int iParam0) //Position: 0x3AED / 15085
{
...
void Function_95(int iParam0) //Position: 0x3B09 / 15113
{
	iParam0 = iParam0;
	return;
}

void Function_96(bool bParam0, int iParam1) //Position: 0x3B13 / 15123
{
	int iVar0;
	int iVar1;
	...
	{
		Function_97(&(Local_2[iLocal_7512]), bParam0);
		iLocal_75++;
	}
...
void Function_97(int iParam0, int iParam1) //Position: 0x3B75 / 15221
{
...
void Function_98(int iParam0) //Position: 0x3B89 / 15241
{
	iParam0 = iParam0;
	return;
}

void Function_99(int iParam0) //Position: 0x3B93 / 15251
{
