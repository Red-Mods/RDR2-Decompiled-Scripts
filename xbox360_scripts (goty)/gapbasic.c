...
void main() //Position: 0x0 / 0
{
	...
	if (Function_133())
	{
		Local_39.f_1892 = 150.0f;
		vVar0[03] = { -4434.99f, 7.23023f, 3357.75f };
		vVar0[13] = { -4439.32f, 7.13829f, 3360.25f };
		vVar0[23] = { -4443.65f, 7.20987f, 3357.75f };
		vVar0[33] = { -4443.65f, 7.35811f, 3352.75f };
		vVar0[43] = { -4439.82f, 7.2561f, 3356.12f };
		Function_100(&vVar0, 0);
		Function_98(1);
		if (Function_97(Global_79962, 128))
		{
			Function_96(2, 7200, 1200);
			Function_96(1, 6000, 900);
			Function_96(0, 5200, 600);
			Function_94(2, 9.0f, 500);
			Function_94(1, 12.0f, 250);
			Function_94(0, 30.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(88);
		}
		else
		{
			Function_96(2, 3000, 1030);
			Function_96(1, 2400, 730);
			Function_96(0, 1900, 430);
			Function_94(2, 7.0f, 500);
			Function_94(1, 9.0f, 250);
			Function_94(0, 15.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(34);
		}
...
void Function_1() //Position: 0x17D / 381
{
...
void Function_3() //Position: 0x1B5 / 437
{
...
void Function_4(int iParam0, bool bParam1, int iParam2) //Position: 0x2BE / 702
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_5(var uParam0, int iParam1) //Position: 0x2E6 / 742
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_6(var uParam0, int iParam1) //Position: 0x2F9 / 761
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_7(int iParam0) //Position: 0x308 / 776
{
	return Function_97(Global_76905.f_132, iParam0);
}

void Function_8() //Position: 0x319 / 793
{
	bool bVar0;
...
var Function_9(bool bParam0) //Position: 0x332 / 818
{
	bool bVar0;
...
var Function_10() //Position: 0x37F / 895
{
...
void Function_11(int iParam0) //Position: 0x3AE / 942
{
	int iVar0;
...
void Function_12(var uParam0, int iParam1) //Position: 0x3D4 / 980
{
...
void Function_13(var uParam0, int iParam1) //Position: 0x502 / 1282
{
	int iVar0;
...
bool Function_14(var uParam0, int iParam1) //Position: 0x51C / 1308
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1, int iParam2) //Position: 0x539 / 1337
{
...
void Function_16(var uParam0, var uParam1, int iParam2) //Position: 0x6D2 / 1746
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_17(bool bParam0, int iParam1, int iParam2) //Position: 0x84A / 2122
{
	var uVar0;
...
int Function_18(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x85B / 2139
{
	char* cVar0[32];
...
bool Function_19(bool bParam0, int iParam1, bool bParam2) //Position: 0x8C0 / 2240
{
	char* cVar0[64];
	int iVar16;
...
var Function_20(int iParam0) //Position: 0x941 / 2369
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_21(bool bParam0) //Position: 0xC5A / 3162
{
	char* cVar0[64];
...
void Function_22(bool bParam0) //Position: 0xCFB / 3323
{
...
bool Function_23() //Position: 0xD15 / 3349
{
	return Function_7(32768);
}

void Function_24() //Position: 0xD22 / 3362
{
	Function_4(32768, 1, 0);
	return;
}

int Function_25() //Position: 0xD31 / 3377
{
	int iVar0;
	int iVar1;
...
void Function_26(int iParam0, int iParam1) //Position: 0xD5B / 3419
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_27(char* cParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xEE4 / 3812
{
...
int Function_28(int iParam0) //Position: 0xF07 / 3847
{
	*iParam0 = (*iParam0 - 1);
	return *iParam0 + 1;
}

void Function_29(var uParam0, bool bParam1) //Position: 0xF1A / 3866
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_30(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x11F2 / 4594
{
	bool bVar0;
...
var Function_31(var uParam0, int iParam1, bool bParam2) //Position: 0x1243 / 4675
{
	int iVar0;
...
var Function_32(bool bParam0) //Position: 0x1262 / 4706
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_33(int iParam0) //Position: 0x126E / 4718
{
...
int Function_34(int iParam0, var uParam1, int iParam2) //Position: 0x128E / 4750
{
	bool bVar0;
	int iVar1;
...
int Function_35(int iParam0, int iParam1, int iParam2) //Position: 0x12E1 / 4833
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x1322 / 4898
{
	int iVar0;
...
void Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x1348 / 4936
{
	float fVar0;
...
var Function_38(int iParam0) //Position: 0x1379 / 4985
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
var Function_39(float fParam0) //Position: 0x1399 / 5017
{
	int iVar0;
	float fVar1;
	var uVar2;
...
int Function_40() //Position: 0x13C6 / 5062
{
	if (!Function_41())
	{
		return 4294967295;
...
bool Function_41() //Position: 0x13DB / 5083
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_42(bool bParam0, int iParam1) //Position: 0x13E8 / 5096
{
	struct<13> Var0;
...
struct<16> Function_43(var uParam0) //Position: 0x1615 / 5653
{
	struct<4> Var0;
	bool bVar4;
...
var Function_44(int iParam0) //Position: 0x1686 / 5766
{
...
void Function_45() //Position: 0x1757 / 5975
{
	if (!Function_46())
	{
	}
...
bool Function_46() //Position: 0x1764 / 5988
{
	return NET_IS_IN_SESSION();
}

bool Function_47(int iParam0) //Position: 0x176D / 5997
{
	return Function_97(*iParam0, 2);
}

bool Function_48(int iParam0) //Position: 0x177A / 6010
{
	return Function_97(*iParam0, 1);
}

void Function_49(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x1787 / 6023
{
	if (iParam2 != 0)
	{
...
int Function_50(int iParam0) //Position: 0x17D6 / 6102
{
	return Function_51(0, iParam0);
}

int Function_51(int iParam0, bool bParam1) //Position: 0x17E2 / 6114
{
	char* cVar0[64];
...
int Function_52(int iParam0) //Position: 0x1849 / 6217
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_53(int iParam0, bool bParam1) //Position: 0x1859 / 6233
{
	char* cVar0[64];
...
int Function_54(int iParam0) //Position: 0x18C7 / 6343
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_55(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x18E0 / 6368
{
	bool bVar0;
	bool bVar1;
...
void Function_56(bool bParam0, bool bParam1) //Position: 0x1980 / 6528
{
	if (Function_7(4))
	{
...
int Function_57(bool bParam0) //Position: 0x19B3 / 6579
{
	return Function_53(12, bParam0);
}

void Function_58(bool bParam0, int iParam1, char* cParam2) //Position: 0x19C0 / 6592
{
	if (bParam0)
	{
		if (Function_23())
...
int Function_59() //Position: 0x19E1 / 6625
{
	if (!Function_61(1))
	{
		return 0;
...
void Function_60() //Position: 0x1A7F / 6783
{
	if (Function_7(4096))
	{
...
bool Function_61(bool bParam0) //Position: 0x1ABC / 6844
{
	char* cVar0[64];
...
void Function_62(bool bParam0) //Position: 0x1B3D / 6973
{
...
struct<64> Function_63(int iParam0) //Position: 0x1BC6 / 7110
{
...
int Function_65(bool bParam0, bool bParam1) //Position: 0x1C1F / 7199
{
...
void Function_66() //Position: 0x1C53 / 7251
{
...
bool Function_67(int iParam0) //Position: 0x1C8D / 7309
{
	return Function_97(StackVal, iParam0);
}

bool Function_68(bool bParam0) //Position: 0x1CA0 / 7328
{
	return Function_69(Global_79336, bParam0);
}

bool Function_69(var uParam0, bool bParam1) //Position: 0x1CAF / 7343
{
	return (uParam0 && bParam1) == 0;
}

void Function_70() //Position: 0x1CBC / 7356
{
	if (IS_LAYOUTREF_VALID(Local_39.f_1808))
	{
		DESTROY_LAYOUT(Local_39.f_1808);
...
void Function_71(int iParam0) //Position: 0x1CE0 / 7392
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_87(StackVal, StackVal, 10516, *(&Local_39 + 1896), 1, iParam0);
	bVar1 = true;
	...
	while (iVar0 <= Local_39.f_1804)
	{
		...
		else
		{
			...
			if (bVar1)
			{
				if (!IS_SCRIPT_USE_CONTEXT_VALID(Local_39[iVar090].f_356))
				{
					UI_SET_STRING_FORMAT(Function_80(iVar0), UI_GET_STRING("COOP_Select"), UI_GET_STRING(Function_79(Local_39[iVar090].f_324, 0)), false, false);
					Local_39[iVar090].f_356 = ADD_SCRIPT_USE_CONTEXT_IN_VOLUME(Function_80(iVar0), Local_39[iVar090].f_352, 0, 4, 0, false, 0, 0, 4294967295, 0);
				}
				if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(Local_39[iVar090].f_356))
				{
					Function_78(&(Local_39[iVar290]));
					Function_78(&Local_39[iVar290] + 48);
					Function_77(8, Local_39[iVar090].f_324 + 1);
					iVar2 = iVar0;
					HUD_CLEAR_SMALL_TEXT_QUEUE();
					PRINT_SMALL_FORMAT(2.5f, "COOP_Selected", Function_79(Local_39[iVar090].f_324, 0), 0, 0, 0, 2, 0, 0);
					RELEASE_SOUND_ID(PLAY_SOUND_FROM_OBJECT(Local_39[iVar090].f_328, "HUD_STINGER_TEXT_SELECTION_MASTER"));
					Function_78(&(Local_39[iVar090]));
					Function_78(&Local_39[iVar090] + 48);
					iVar6 = 15790320;
					iVar7 = 0;
				}
			}
		...
		Function_74(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_39[iVar090]), vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.725f, 0.0f), 1, 8811, 0, iVar6, iVar0, "", iVar7);
		if (Function_73(Local_39[iVar090].f_352))
		{
			Function_74(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_39[iVar090] + 48, vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.25f, 0.0f), Local_39[iVar090].f_344, 8066, 0, iVar6, iVar0, "", iVar7);
		}
		else
		{
			Function_78(&Local_39[iVar090] + 48);
...
var Function_72(int iParam0, int iParam1) //Position: 0x1F82 / 8066
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_39[iParam190] + 96)[iParam0 + 12]);
}

bool Function_73(bool bParam0) //Position: 0x1F99 / 8089
{
	bool bVar0;
	bool bVar1;
...
void Function_74(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1FDE / 8158
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_75(float fParam0) //Position: 0x225D / 8797
{
	return (fParam0 * 57.29578f);
}

int Function_76(var uParam0, int iParam1) //Position: 0x226B / 8811
{
	uParam0 = uParam0;
	return Function_79(Local_39[iParam190].f_324, 1);
}

void Function_77(int iParam0, int iParam1) //Position: 0x2282 / 8834
{
...
void Function_78(int iParam0) //Position: 0x22AB / 8875
{
	if (IS_OBJECT_VALID(*iParam0))
	{
...
int Function_79(int iParam0, bool bParam1) //Position: 0x22D1 / 8913
{
	if (bParam1)
	{
		switch (iParam0)
...
var Function_80(int iParam0) //Position: 0x2644 / 9796
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_81(int iParam0) //Position: 0x26DB / 9947
{
	Function_82(&Global_83864 + 1256, iParam0);
	return;
}

void Function_82(var uParam0, int iParam1) //Position: 0x26ED / 9965
{
	Function_6(uParam0, iParam1);
	return;
}

void Function_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x26FA / 9978
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_84(int iParam0) //Position: 0x2775 / 10101
{
	char* cVar0[16];
...
bool Function_85() //Position: 0x27B4 / 10164
{
	if (Function_97(Global_83864.f_1252, 1024))
	{
...
bool Function_86(bool bParam0) //Position: 0x27CF / 10191
{
	return Function_69(Global_83864.f_1256, bParam0);
}

void Function_87(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x27E1 / 10209
{
	...
	Function_88(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 10415, 1, 125, 0, 0, 0);
...
void Function_88(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x2864 / 10340
{
	vector3 vVar0;
	int iVar3;
...
var Function_89(int iParam0, var uParam1) //Position: 0x28AF / 10415
{
	char* cVar0[64];
...
var Function_90() //Position: 0x2914 / 10516
{
	int iVar0;
...
void Function_91(bool bParam0, int iParam1) //Position: 0x298D / 10637
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_92(var uParam0, var uParam1) //Position: 0x29D9 / 10713
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return "GAP_summary";
...
bool Function_93(int iParam0, bool bParam1) //Position: 0x29F5 / 10741
{
	int iVar0;
...
void Function_94(int iParam0, float fParam1, int iParam2) //Position: 0x2A15 / 10773
{
	Function_95(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_95(int iParam0, int iParam1) //Position: 0x2A2B / 10795
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_96(int iParam0, int iParam1, bool bParam2) //Position: 0x2A4C / 10828
{
	Function_141(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

bool Function_97(var uParam0, int iParam1) //Position: 0x2A61 / 10849
{
	return (uParam0 && iParam1) == 0;
}

void Function_98(int iParam0) //Position: 0x2A6E / 10862
{
	Function_99(8, iParam0);
	return;
}

void Function_99(int iParam0, bool bParam1) //Position: 0x2A7B / 10875
{
	if (bParam1)
	{
...
void Function_100(var uParam0, bool bParam1) //Position: 0x2AA3 / 10915
{
	bool bVar1;
	bool bVar2;
	...
	while (!Function_127(&Local_39 + 1828) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	Function_126();
	bVar1 = Function_97(Global_79962, 128);
	...
	{
		Local_39.f_1804 = 5;
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[090]), *uParam0[03], 4, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[03]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[190]), *uParam0[13], 5, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[13]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[290]), *uParam0[23], 6, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[23]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[390]), *uParam0[33], 7, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[33]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[490]), *uParam0[43], 8, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[43]), bParam1);
	}
	else
	{
		Local_39.f_1804 = 4;
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[090]), *uParam0[03], 0, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[03]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[190]), *uParam0[13], 1, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[13]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[290]), *uParam0[23], 2, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[23]), bParam1);
		Function_101(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_124(&(Local_39[390]), *uParam0[33], 3, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[33]), bParam1);
	}
	NET_OBJECT_REPLICATION_MODE_END(17);
	return;
}

void Function_101(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x2CEC / 11500
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	*(iParam0 + 96) = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_110(bParam4, iParam0 + 344) };
	iParam0->f_324 = bParam4;
	if (bParam4 != 8)
	{
		iParam0->f_328 = Function_106(bParam5, &vParam1, fParam6, iParam0 + 96, bParam7);
	}
	else
	{
		iParam0->f_328 = Function_104(bParam5, &vParam1, (fParam6 + 180.0f), bParam7);
		...
		CREATE_MP_TEXT(iParam0->f_328, "", "Custom_deco", vVar6, Function_103(vVar9.x), Function_103(vVar9.y), Function_103(vVar9.z), iVar12);
	}
	*(iParam0 + 332) = { StackVal, StackVal, vParam1 };
	...
	bVar19 = Function_102(bParam4, &vVar13, &vVar16);
...
var Function_102(bool bParam0, var uParam1, int iParam2) //Position: 0x2E69 / 11881
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_103(float fParam0) //Position: 0x2F55 / 12117
{
	return (fParam0 * 0.01745329f);
}

var Function_104(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2F63 / 12131
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	return CREATE_PROP_IN_LAYOUT(StackVal, StackVal, StackVal, Vector("", uParam0, StackVal) + Vector(vVar6, *iParam1, Function_105()), 0.0f, (bParam2 + 180.0f), 0.0f, 1);
}

bool Function_105() //Position: 0x2FCF / 12239
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_106(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2FF6 / 12278
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	bVar0 = Function_104(uParam0, uParam1, uParam2, uParam4);
	iVar1 = 0;
	while (iVar1 <= 27)
	{
		if (Function_109((*uParam3)[iVar12], &iVar2))
		{
			iVar10[iVar2]++;
			if (iVar10[iVar2] == 2)
			{
	...
	while (iVar1 <= 27)
	{
		if (Function_109((*uParam3)[iVar12], &iVar2))
		{
			if (Function_107((*uParam3)[iVar12], &vVar3, &vVar6, (iVar10[iVar2] - 1)))
			{
...
bool Function_107(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x30E4 / 12516
{
...
bool Function_108(int iParam0) //Position: 0x3275 / 12917
{
...
bool Function_109(bool bParam0, int iParam1) //Position: 0x3287 / 12935
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<228> Function_110(int iParam0, int iParam1) //Position: 0x32E3 / 13027
{
	struct<57> Var0;
	
	Var0 = 27;
	Function_121(&Var0);
	Function_118(&Var0, 0, 22, 1, 1);
	switch (iParam0)
	{
		case 0x00000000:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 9, 10, 1);
				Function_118(&Var0, 2, 0, 6, 1);
				*iParam1 = 2;
			}
			break;
		...
		case 0x00000004:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 11, 6, 1);
				Function_118(&Var0, 2, 0, 8, 1);
				*iParam1 = 2;
			}
			break;
		...
		case 0x00000001:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 17, 10, 1);
				Function_118(&Var0, 2, 5, 6, 1);
				Function_118(&Var0, 3, 24, 5, 1);
				*iParam1 = 3;
			}
			break;
		...
		case 0x00000005:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 18, 10, 1);
				Function_118(&Var0, 2, 5, 8, 1);
				Function_118(&Var0, 3, 24, 5, 1);
				*iParam1 = 3;
			}
			break;
		...
		case 0x00000002:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 19, 20, 0);
				Function_118(&Var0, 2, 4, 8, 1);
				Function_118(&Var0, 3, 25, 6, 1);
				*iParam1 = 3;
			}
			break;
		...
		case 0x00000006:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 20, 20, 0);
				Function_118(&Var0, 2, 4, 10, 1);
				Function_118(&Var0, 3, 25, 6, 1);
				*iParam1 = 3;
			}
			break;
		...
		case 0x00000003:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 6, 10, 1);
				Function_118(&Var0, 2, 8, 8, 1);
				Function_118(&Var0, 3, 23, 5, 1);
				*iParam1 = 3;
			}
			break;
		...
		case 0x00000007:
			if (!Function_117(iParam0, &Var0, iParam1))
			{
				Function_118(&Var0, 1, 2, 10, 1);
				Function_118(&Var0, 2, 8, 9, 1);
				Function_118(&Var0, 3, 23, 5, 1);
				*iParam1 = 3;
			}
			break;
...
void Function_111(int iParam0, int iParam1) //Position: 0x34C8 / 13512
{
	int iVar0;
	int iVar1[17];
	int iVar19;
	...
	*iParam1 = 1;
	Function_118(iParam0, *iParam1, 4, 4, 1);
	iVar1[7] = 1;
	iVar0 = 1;
	while (iVar0 < Global_83864.f_1264)
	{
		if (StackVal != 4294967295)
		{
			...
			iVar19 = 0;
			if (Function_116(iVar20, 1))
			{
				if (!iVar1[iVar20])
				{
					iVar19 = Function_115(&Global_83591 + 276, iVar20) * 2;
					iVar1[iVar20] = 1;
				}
			}
			*iParam1++;
			Function_118(StackVal, iParam0, *iParam1, iVar19, 1);
		}
		iVar0++;
	}
	if (DECOR_GET_INT_VERBOSE(Function_10(), "DLCFM_Weapon", &iVar21))
	{
		...
		while (iVar23 <= iVar21)
		{
			...
			if (DECOR_GET_INT_VERBOSE(Function_10(), &cVar24, &uVar22))
			{
				...
				*iParam1++;
				Function_118(iParam0, *iParam1, Var32, iVar19, 0);
			}
			iVar23++;
		}
	}
...
void Function_112(var uParam0, var uParam1) //Position: 0x3605 / 13829
{
	*uParam1 = Function_31(uParam0, Function_113(), 0);
	uParam1->f_4 = Function_31(uParam0, Function_113() + 8, Function_113());
	return;
}

bool Function_113() //Position: 0x3628 / 13864
{
	return Function_114(39);
}

int Function_114(bool bParam0) //Position: 0x3633 / 13875
{
	int iVar0;
...
int Function_115(int iParam0, int iParam1) //Position: 0x3661 / 13921
{
	if (Function_116(iParam1, 1))
	{
...
bool Function_116(int iParam0, int iParam1) //Position: 0x367B / 13947
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

bool Function_117(int iParam0, var uParam1, int iParam2) //Position: 0x368E / 13966
{
	if (Function_97(Global_79349.f_44, 4194304))
	{
		switch (iParam0)
		{
			case 0x00000000:
			case 0x00000004:
				Function_118(uParam1, 1, 10, 5, 1);
				Function_118(uParam1, 2, 7, 4, 1);
				Function_118(uParam1, 3, 18, 2, 1);
				*iParam2 = 3;
				break;
			
			case 0x00000001:
			case 0x00000005:
				Function_118(uParam1, 1, 17, 6, 1);
				Function_118(uParam1, 2, 6, 4, 1);
				Function_118(uParam1, 3, 24, 6, 1);
				*iParam2 = 3;
				break;
			
			case 0x00000002:
			case 0x00000006:
				Function_118(uParam1, 1, 13, 8, 1);
				Function_118(uParam1, 2, 16, 9, 1);
				Function_118(uParam1, 3, 2, 3, 1);
				*iParam2 = 3;
				break;
			
			case 0x00000003:
			case 0x00000007:
				Function_118(uParam1, 1, 3, 6, 1);
				Function_118(uParam1, 2, 15, 12, 1);
				Function_118(uParam1, 3, 24, 3, 1);
				*iParam2 = 3;
				break;
		}
		return 1;
...
void Function_118(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x376E / 14190
{
	if (!Function_120(iParam1))
	{
		return;
	}
	Function_119(iParam0[iParam12], bParam2, iParam3, bParam4);
}

void Function_119(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3791 / 14225
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_120(int iParam0) //Position: 0x37BB / 14267
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_121(int iParam0) //Position: 0x37CB / 14283
{
	int iVar0;
...
void Function_122(var uParam0, int iParam1) //Position: 0x37F8 / 14328
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_123(bool bParam0) //Position: 0x3804 / 14340
{
	Function_119(bParam0, 4294967295, 0, 1);
	return;
}

float Function_124(vector3 vParam0, vector3 vParam3) //Position: 0x3812 / 14354
{
	var uVar0;
	
	Function_125(StackVal, StackVal, StackVal, StackVal, vParam0, vParam3, &uVar0);
	return UNK_0x9C40E671(&uVar0);
}

void Function_125(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x382C / 14380
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_126() //Position: 0x384F / 14415
{
...
bool Function_127(int iParam0) //Position: 0x385F / 14431
{
	int iVar0;
	int iVar1;
		...
		if (Function_14(iParam0[iVar03], 4))
		{
			if (!Function_14(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], 1, (Function_14(iParam0[03], 8) || iVar1));
						break;
...
void Function_128() //Position: 0x3BDA / 15322
{
	if (!Function_129(128))
	{
		return;
...
bool Function_129(int iParam0) //Position: 0x3C1A / 15386
{
	int iVar0;
...
bool Function_130() //Position: 0x3C36 / 15414
{
	int iVar0;
...
void Function_131(var uParam0, int iParam1) //Position: 0x3C61 / 15457
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_132() //Position: 0x3C72 / 15474
{
	if (!Function_129(128))
	{
		return;
...
bool Function_133() //Position: 0x3CB4 / 15540
{
	var uVar0;
	bool bVar3;
	int iVar4;
	...
	if (Function_97(Global_79349.f_44, 4194304))
	{
		Function_136(&Local_39 + 1812, "dlc_zombiepack_mp_gy", 10, 0);
	}
	else
	{
		Function_136(&Local_39 + 1812, "dlc_mpcooppack_mp_coop", 10, 0);
	}
	Function_136(&Local_39 + 1828, Function_105(), 0, 0);
	iVar4 = 0;
	while (iVar4 <= 5)
	{
		bVar3 = Function_102(iVar4, &uVar0, &uVar0);
		if (STRING_LENGTH(bVar3) >= 0)
		{
			Function_136(&Local_39 + 1828, bVar3, 0, 0);
		}
		iVar4++;
	}
	Function_127(&Local_39 + 1828);
	while (!Function_127(&Local_39 + 1812) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	Function_135("nCOOP_help", 4294967295);
	Function_134();
	if (!Function_97(Global_84364, 2147483648))
	{
...
void Function_134() //Position: 0x3DE5 / 15845
{
...
void Function_135(char* cParam0, int iParam1) //Position: 0x3E00 / 15872
{
	char* cVar0[32];
	char* cVar8[32];
...
var Function_136(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3E97 / 16023
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_137(iParam0, uVar1, iParam2);
	if (bParam3)
	{
		Function_131(iParam0[iVar03], 8);
	}
...
var Function_137(var uParam0, int iParam1, int iParam2) //Position: 0x3ECF / 16079
{
	int iVar0;
...
void Function_138(var uParam0, var uParam1) //Position: 0x3F93 / 16275
{
	Function_15(uParam0, uParam1, 16292);
	return;
}

int Function_139() //Position: 0x3FA4 / 16292
{
	return 1;
}

bool Function_140() //Position: 0x3FAB / 16299
{
	return Function_67(2);
}

void Function_141(int iParam0, int iParam1) //Position: 0x3FB5 / 16309
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
