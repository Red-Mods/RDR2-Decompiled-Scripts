...
void Function_2() //Position: 0x51 / 81
{
	Function_14();
...
void Function_3() //Position: 0x62 / 98
{
	Function_4();
	return;
}

void Function_4() //Position: 0x6B / 107
{
...
void Function_5(int iParam0, bool bParam1, int iParam2) //Position: 0x174 / 372
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_6(var uParam0, int iParam1) //Position: 0x19C / 412
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_7(var uParam0, int iParam1) //Position: 0x1AF / 431
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_8(int iParam0) //Position: 0x1BE / 446
{
	return Function_9(Global_76905.f_132, iParam0);
}

int Function_9(var uParam0, int iParam1) //Position: 0x1CF / 463
{
	return (uParam0 && iParam1) == 0;
}

void Function_10(int iParam0) //Position: 0x1DC / 476
{
	int iVar0;
...
void Function_11(var uParam0, int iParam1) //Position: 0x202 / 514
{
...
void Function_12(var uParam0, int iParam1) //Position: 0x330 / 816
{
	int iVar0;
...
bool Function_13(int iParam0, int iParam1) //Position: 0x34A / 842
{
	int iVar0;
...
void Function_14() //Position: 0x367 / 871
{
	if (iLocal_46)
	{
...
void Function_15() //Position: 0x3A6 / 934
{
	Function_89();
	if (Function_88(1, 1))
	{
		Function_72(StackVal, StackVal, 7058, vLocal_48, 1, 6945);
	}
	else
	{
		if (!iLocal_47)
		...
		Function_18(4346, 3139);
		Function_16();
	}
	return;
}

void Function_16() //Position: 0x3F1 / 1009
{
...
void Function_17(int iParam0) //Position: 0x40D / 1037
{
...
void Function_18(int iParam0, int iParam1) //Position: 0x433 / 1075
{
	Function_19(iParam0, iParam1, 3132);
	return;
}

void Function_19(var uParam0, var uParam1, int iParam2) //Position: 0x444 / 1092
{
...
void Function_20(var uParam0, var uParam1, int iParam2) //Position: 0x5DD / 1501
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_21(bool bParam0, int iParam1, int iParam2) //Position: 0x755 / 1877
{
	var uVar0;
...
int Function_22(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x766 / 1894
{
	char* cVar0[32];
...
bool Function_23(bool bParam0, int iParam1, bool bParam2) //Position: 0x7CB / 1995
{
	char* cVar0[64];
	int iVar16;
...
var Function_24(int iParam0) //Position: 0x84C / 2124
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_25(bool bParam0) //Position: 0xB65 / 2917
{
	char* cVar0[64];
...
void Function_26(bool bParam0) //Position: 0xC06 / 3078
{
...
bool Function_27() //Position: 0xC20 / 3104
{
	return Function_8(32768);
}

void Function_28() //Position: 0xC2D / 3117
{
	Function_5(32768, 1, 0);
	return;
}

int Function_29() //Position: 0xC3C / 3132
{
	return 1;
}

int Function_30(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0xC43 / 3139
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_31() //Position: 0xD46 / 3398
{
	return (Function_8(4096) || Function_8(4));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0xD57 / 3415
{
	if (Function_8(4))
	{
...
bool Function_33(bool bParam0) //Position: 0xD8A / 3466
{
	if (Function_35(bParam0, 1, 0) != 4294967295 && Function_34() != 4294967295)
	{
		return 0;
	}
	return Function_35(bParam0, 1, 0) != Function_34();
}

int Function_34() //Position: 0xDB2 / 3506
{
	if (!NET_IS_IN_SESSION())
	{
		return 4294967295;
	}
	return Function_35(GET_LOCAL_SLOT(), 1, 0);
}

int Function_35(bool bParam0, bool bParam1, bool bParam2) //Position: 0xDC9 / 3529
{
	if (bParam1)
	{
...
bool Function_36(bool bParam0, int iParam1, bool bParam2) //Position: 0xE0D / 3597
{
	char* cVar0[64];
	int iVar16;
	...
	{
		strcpy(&cVar0, "Tried to get bit ", 64);
		stradd(&cVar0, Function_37(iParam1), 64);
		stradd(&cVar0, " bit from bad slot ", 64);
		stradd(&cVar0, I2STR(bParam0), 64);
	}
...
var Function_37(int iParam0) //Position: 0xE8E / 3726
{
	switch (iParam0)
	{
		case 0x00000001:
...
var Function_38(int iParam0, bool bParam1) //Position: 0xF80 / 3968
{
	int iVar0;
...
int Function_39(int iParam0, bool bParam1) //Position: 0xFA0 / 4000
{
	char* cVar0[64];
...
int Function_40(int iParam0) //Position: 0x100E / 4110
{
	if (iParam0 > 40)
	{
		return 0;
...
var Function_41(int iParam0, int iParam1, int iParam2) //Position: 0x1027 / 4135
{
	return (((iParam0 * 100000) + iParam1 * 100) - iParam2);
}

int Function_42(int iParam0) //Position: 0x103C / 4156
{
	return Function_43(0, iParam0);
}

int Function_43(int iParam0, bool bParam1) //Position: 0x1048 / 4168
{
	char* cVar0[64];
...
var Function_44(int iParam0) //Position: 0x10AF / 4271
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_45(bool bParam0) //Position: 0x10BF / 4287
{
	return Function_39(12, bParam0);
}

int Function_46(int iParam0) //Position: 0x10CC / 4300
{
	return Function_39(11, iParam0);
}

void Function_47(bool bParam0, int iParam1, char* cParam2) //Position: 0x10D9 / 4313
{
	if (bParam0)
	{
		if (Function_27())
...
int Function_48() //Position: 0x10FA / 4346
{
	if (!Function_62(1))
	{
		return 0;
...
void Function_49() //Position: 0x1196 / 4502
{
	if (Function_58())
	{
...
void Function_50(bool bParam0, bool bParam1) //Position: 0x11C1 / 4545
{
	bool bVar0;
	bool bVar1;
	
	if (bParam0 == Function_34())
	{
		bVar0 = 2;
	}
	else
...
void Function_51(int iParam0, int iParam1, bool bParam2) //Position: 0x1260 / 4704
{
	bool bVar0;
	struct<4> Var1;
...
struct<16> Function_52(var uParam0, var uParam1) //Position: 0x1353 / 4947
{
	return StackVal, StackVal, StackVal, Function_53(Function_54(uParam0), uParam1);
}

struct<16> Function_53(bool bParam0, bool bParam1) //Position: 0x1365 / 4965
{
	char* cVar0[16];
...
int Function_54(int iParam0) //Position: 0x139A / 5018
{
	if (!Function_55())
	{
		return 0;
...
bool Function_55() //Position: 0x13B3 / 5043
{
	return UNK_0xA80C6DE6(&Global_78578);
}

int Function_56(int iParam0) //Position: 0x13C0 / 5056
{
...
bool Function_57() //Position: 0x13DC / 5084
{
	return Function_34() == 4294967295;
}

bool Function_58() //Position: 0x13E7 / 5095
{
	return Function_59(2);
}

int Function_59(int iParam0) //Position: 0x13F1 / 5105
{
	return Function_60(&Global_79349, iParam0);
}

int Function_60(var uParam0, int iParam1) //Position: 0x1400 / 5120
{
	return Function_9(uParam0->f_44, iParam1);
}

void Function_61() //Position: 0x140F / 5135
{
	if (Function_8(4096))
	{
...
bool Function_62(bool bParam0) //Position: 0x144C / 5196
{
	char* cVar0[64];
...
void Function_63(bool bParam0) //Position: 0x14CD / 5325
{
...
struct<64> Function_64(int iParam0) //Position: 0x1556 / 5462
{
...
int Function_66(bool bParam0, bool bParam1) //Position: 0x15AF / 5551
{
...
void Function_67(vector3 vParam0, float fParam3) //Position: 0x15E3 / 5603
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_68(bool bParam0) //Position: 0x1696 / 5782
{
	bool bVar0;
...
int Function_69(bool bParam0) //Position: 0x16D1 / 5841
{
	bool bVar0;
...
void Function_70(bool bParam0) //Position: 0x171F / 5919
{
	SET_BLIP_COLOR(bParam0, 1.0f, 1.0f, 1.0f, 0.4f);
	return;
}

var Function_71() //Position: 0x1732 / 5938
{
...
void Function_72(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x1761 / 5985
{
	if (!IS_OBJECT_VALID(Local_12.f_104))
	{
	...
	Function_73(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 6844, 1, 125, 0, 0, 0);
...
void Function_73(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x17E4 / 6116
{
	vector3 vVar0;
	int iVar3;
...
void Function_74(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, var uParam11, var uParam12, int iParam13, var uParam14, var uParam15, int iParam16) //Position: 0x182F / 6191
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_75(float fParam0) //Position: 0x1AAE / 6830
{
	return (fParam0 * 57.29578f);
}

var Function_76(int iParam0, var uParam1) //Position: 0x1ABC / 6844
{
	char* cVar0[64];
...
var Function_77(int iParam0, var uParam1) //Position: 0x1B21 / 6945
{
	uParam1 = uParam1;
...
var Function_78() //Position: 0x1B92 / 7058
{
	int iVar0;
...
var Function_79(bool bParam0, int iParam1) //Position: 0x1BBF / 7103
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool Function_80(bool bParam0, var uParam1, var uParam2, bool bParam3, int iParam4) //Position: 0x1CCE / 7374
{
	float fVar0;
...
bool Function_81(int iParam0) //Position: 0x1DF5 / 7669
{
...
bool Function_82(bool bParam0, int iParam1) //Position: 0x1E07 / 7687
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
var Function_83() //Position: 0x1E63 / 7779
{
	int iVar0;
...
var Function_84(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1E6B / 7787
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_85(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x1F59 / 8025
{
	if (!Function_81(bParam0))
	{
		return 0;
...
var Function_86(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x20EA / 8426
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_87() //Position: 0x2156 / 8534
{
	return "$/fragments/p_gen_dressForm01x";
}

bool Function_88(bool bParam0, bool bParam1) //Position: 0x217D / 8573
{
	int iVar0;
...
void Function_89() //Position: 0x219D / 8605
{
	if (HUD_IS_FADED())
	{
		if (!iLocal_46)
...
void Function_90(char* cParam0, int iParam1) //Position: 0x2232 / 8754
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_91(bool bParam0) //Position: 0x22C9 / 8905
{
	Function_92(16, bParam0);
	return;
}

void Function_92(int iParam0, bool bParam1) //Position: 0x22D6 / 8918
{
	if (bParam1)
	{
...
void Function_93(var uParam0) //Position: 0x22FE / 8958
{
	Function_92(8, uParam0);
	return;
}

bool Function_94() //Position: 0x230B / 8971
{
	NET_OBJECT_REPLICATION_MODE_START(17, 0);
	Function_117();
	NET_OBJECT_REPLICATION_MODE_END(17);
	if (!Function_112(Local_51))
	{
		return 0;
	}
	Function_105(&Global_83591 + 276, 0);
	Function_103(&Global_83591, 1, 22, 1, 1);
	Function_103(&Global_83591, 2, 1, 8, 1);
	Function_103(&Global_83591, 3, 16, 15, 1);
	Function_103(&Global_83591, 4, 25, 20, 1);
	Function_98(&Global_83591, 1, 20, 3, 1);
	Function_98(&Global_83591, 2, 6, 3, 1);
	Function_98(&Global_83591, 3, 17, 4, 1);
	Function_98(&Global_83591, 4, 10, 2, 1);
	Function_97(&Global_83591);
	Function_96(&Global_83591 + 276, 4);
	Function_95(0, 8);
	Function_95(1, 1);
	return 1;
}

void Function_95(int iParam0, int iParam1) //Position: 0x23B2 / 9138
{
	iParam0 = iParam0;
	iParam1 = iParam1;
	return;
...
void Function_96(int iParam0, int iParam1) //Position: 0x23C0 / 9152
{
	(iParam0 + 228)->f_220 = 0;
...
void Function_97(int iParam0) //Position: 0x23D8 / 9176
{
	iParam0->f_844 = 0;
	return;
}

void Function_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x23E4 / 9188
{
	Function_99(iParam0 + 276, iParam1, iParam2, iParam3, iParam4);
}

void Function_99(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x23FC / 9212
{
	Function_100(iParam0 + 228, iParam1, bParam2, iParam3, bParam4);
}

void Function_100(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x2413 / 9235
{
	if (!Function_102(iParam1))
	{
		return;
	}
	Function_101(uParam0[iParam12], bParam2, iParam3, bParam4);
}

void Function_101(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x2436 / 9270
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_102(int iParam0) //Position: 0x2460 / 9312
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x2470 / 9328
{
	Function_104(iParam0 + 276, iParam1, iParam2, iParam3, iParam4);
}

void Function_104(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2488 / 9352
{
	Function_100(uParam0, uParam1, uParam2, uParam3, uParam4);
}

void Function_105(int iParam0, bool bParam1) //Position: 0x249D / 9373
{
	Function_109(iParam0);
	Function_109(iParam0 + 228);
	if (bParam1)
	{
...
void Function_106(int iParam0) //Position: 0x24B9 / 9401
{
	int iVar0;
	...
	while (iVar0 <= 17)
	{
		Function_107(iParam0, iVar0);
		iVar0++;
	}
	return;
}

void Function_107(var uParam0, int iParam1) //Position: 0x24D9 / 9433
{
	Function_108(uParam0, iParam1, 0);
	return;
}

void Function_108(int iParam0, int iParam1, int iParam2) //Position: 0x24E7 / 9447
{
	(*iParam0 + 456)[iParam1] = iParam2;
	return;
}

void Function_109(int iParam0) //Position: 0x24F8 / 9464
{
	int iVar0;
	...
	while (iVar0 <= 27)
	{
		Function_111(iParam0[iVar02]);
		iVar0++;
	}
	iParam0->f_220 = 0;
	Function_110(iParam0, 0.0f);
	return;
}

void Function_110(var uParam0, int iParam1) //Position: 0x2525 / 9509
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_111(int iParam0) //Position: 0x2531 / 9521
{
	Function_101(iParam0, 4294967295, 0, 1);
	return;
}

bool Function_112(int iParam0) //Position: 0x253F / 9535
{
	Function_116(iParam0);
	if (Function_115())
	{
		Function_96(&Global_83591 + 276, 2);
	}
	Function_113();
	vLocal_48 = { StackVal, StackVal, Function_113() };
	return 1;
}

vector3 Function_113() //Position: 0x2563 / 9571
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
...
var Function_114() //Position: 0x25AB / 9643
{
	return Global_83591.f_140;
}

bool Function_115() //Position: 0x25B7 / 9655
{
	return Function_9(Global_79962, 1024);
}

void Function_116(var uParam0) //Position: 0x25C7 / 9671
{
	Global_83591.f_140 = uParam0;
	return;
}

void Function_117() //Position: 0x25D5 / 9685
{
	var uVar0;
...
void Function_118(int iParam0, int iParam1) //Position: 0x2C32 / 11314
{
	switch (iParam1)
	{
		case 0x00000000:
...
void Function_119() //Position: 0x2C7B / 11387
{
	while (!IS_EXITFLAG_SET())
	{
		Function_18(4346, 3139);
...
bool Function_120() //Position: 0x2C98 / 11416
{
	return Function_121(2);
}

bool Function_121(int iParam0) //Position: 0x2CA2 / 11426
{
	return Function_9(StackVal, iParam0);
}

void Function_122() //Position: 0x2CB5 / 11445
{
	if (Function_120())
	{
		return;
	...
	Function_132();
	Function_130(&bLocal_39, "MP_CTF", 10, 0);
	Function_130(&bLocal_39, "$/fragments/p_gen_skullPost02x", 0, 0);
	while (!Function_124(&bLocal_39))
	{
		WAIT(0);
	}
	fLocal_11 = 5.0f;
...
void Function_123() //Position: 0x2D19 / 11545
{
...
bool Function_124(int iParam0) //Position: 0x2D34 / 11572
{
	int iVar0;
	int iVar1;
...
void Function_125() //Position: 0x30AF / 12463
{
	if (!Function_126(128))
	{
		return;
...
bool Function_126(int iParam0) //Position: 0x30EF / 12527
{
	int iVar0;
...
bool Function_127() //Position: 0x310B / 12555
{
	int iVar0;
...
void Function_128(var uParam0, int iParam1) //Position: 0x3136 / 12598
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_129() //Position: 0x3147 / 12615
{
	if (!Function_126(128))
	{
		return;
...
var Function_130(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3189 / 12681
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_131(uParam0, uVar1, iParam2);
	if (bParam3)
	{
...
var Function_131(var uParam0, int iParam1, int iParam2) //Position: 0x31C1 / 12737
{
	int iVar0;
...
void Function_132() //Position: 0x3285 / 12933
{
