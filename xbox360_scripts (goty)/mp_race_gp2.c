...
void main() //Position: 0x0 / 0
{
	...
	fLocal_68 = 1.0f;
	Function_261();
	Function_260("RAC_PRD");
	Function_260("RAC_ARM");
	Function_260("RAC_DZC");
	Function_260("RAC_GAP");
	Function_258();
	Local_267.f_716 = 1;
	while (Function_29(&bVar0))
	{
		WAIT(bVar0);
	}
	Function_1();
...
void Function_1() //Position: 0x66 / 102
{
...
void Function_2(int iParam0) //Position: 0x9B / 155
{
	int iVar0;
...
void Function_3(var uParam0, int iParam1) //Position: 0xC1 / 193
{
...
void Function_4(var uParam0, int iParam1) //Position: 0x1EF / 495
{
	int iVar0;
...
bool Function_5(int iParam0, int iParam1) //Position: 0x209 / 521
{
	int iVar0;
...
void Function_6() //Position: 0x226 / 550
{
	if (Local_267.f_732)
	{
...
void Function_7(int iParam0) //Position: 0x26D / 621
{
...
void Function_8(int iParam0) //Position: 0x33E / 830
{
	Function_9(&Global_83864 + 1252, iParam0);
	return;
}

void Function_9(var uParam0, int iParam1) //Position: 0x350 / 848
{
	Function_10(uParam0, iParam1);
	return;
}

void Function_10(var uParam0, int iParam1) //Position: 0x35D / 861
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_11(int iParam0) //Position: 0x370 / 880
{
	Function_28(4);
	Function_26(8197);
	Function_22();
...
int Function_12(int iParam0, bool bParam1) //Position: 0x3C5 / 965
{
...
void Function_13() //Position: 0x43B / 1083
{
	Function_14(4294967295, 0);
	return;
}

void Function_14(int iParam0, bool bParam1) //Position: 0x446 / 1094
{
...
void Function_15(int iParam0, bool bParam1, int iParam2) //Position: 0x473 / 1139
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_16(var uParam0, int iParam1) //Position: 0x49B / 1179
{
...
void Function_18(char* cParam0) //Position: 0x4B6 / 1206
{
...
bool Function_19(bool bParam0, bool bParam1) //Position: 0x4DA / 1242
{
...
var Function_20() //Position: 0x50E / 1294
{
	bool bVar0;
...
void Function_21() //Position: 0x516 / 1302
{
...
void Function_22() //Position: 0x52A / 1322
{
	if (Function_24(4))
	{
		Function_23();
...
void Function_23() //Position: 0x540 / 1344
{
	Function_15(32768, 1, 0);
	return;
}

bool Function_24(int iParam0) //Position: 0x54F / 1359
{
	return Function_25(Global_76905.f_132, iParam0);
}

bool Function_25(var uParam0, int iParam1) //Position: 0x560 / 1376
{
	return (uParam0 && iParam1) == 0;
}

void Function_26(int iParam0) //Position: 0x56D / 1389
{
	Function_27(&Global_83864 + 1252, iParam0);
	return;
}

void Function_27(var uParam0, int iParam1) //Position: 0x57F / 1407
{
	Function_16(uParam0, iParam1);
	return;
}

void Function_28(int iParam0) //Position: 0x58C / 1420
{
...
bool Function_29(int iParam0) //Position: 0x5C5 / 1477
{
	int iVar0;
	bool bVar1;
	...
	*iParam0 = 250;
	...
	switch (Local_267)
	{
		case 0x00000000:
			...
			{
				NET_LOG(true, "PROCESS_GRAND_PRIX", "LOCAL PLAYER %s is Streaming Aux Requests...", GET_SLOT_NAME(GET_LOCAL_SLOT()), false, false, false);
			}
			if (!Local_267.f_736)
			{
		...
		case 0x00000004:
			if (Function_242(1, 1))
			{
				Function_231(StackVal, StackVal, 38207, *(&Global_79349 + 28), Function_246(3) + 1, 38022);
				*iParam0 = 0;
			}
			if (Function_246(4) == 0)
			{
...
bool Function_30() //Position: 0xA71 / 2673
{
...
bool Function_31(int iParam0) //Position: 0xA87 / 2695
{
	int iVar0;
	...
	switch (iParam0->f_60)
	{
		...
		case 0x00000004:
			if (STREAMING_IS_WORLD_LOADED())
			{
				...
				else
				{
					...
					if (iParam0->f_24 != 4294967295)
					{
						UI_SET_STRING_FORMAT("Generic_Dbuffer128_0", UI_GET_STRING("mp_mvp"), UI_GET_STRING(Function_141(iParam0->f_28)), false, false);
			...
			{
				NET_LOG(true, "Victory screen", "LOCAL PLAYER %s is streaming the victory screen", GET_SLOT_NAME(GET_LOCAL_SLOT()), false, false, false);
			}
			break;
		...
		case 0x00000003:
			if (STREAMING_IS_WORLD_LOADED())
			{
				...
				{
					NET_LOG(true, "Victory screen", "LOCAL PLAYER %s is waiting for other players", GET_SLOT_NAME(GET_LOCAL_SLOT()), false, false, false);
				}
			}
			else
			{
				NET_LOG(true, "Victory screen", "LOCAL PLAYER %s is waiting for horse and player to stream in", GET_SLOT_NAME(GET_LOCAL_SLOT()), false, false, false);
			}
			break;
...
void Function_32(int iParam0) //Position: 0x1625 / 5669
{
	char* cVar0[32];
...
void Function_33(int iParam0) //Position: 0x16B3 / 5811
{
	char* cVar0[32];
...
bool Function_34(int iParam0) //Position: 0x174F / 5967
{
	return Function_25((&Global_83591 + 140)->f_56, iParam0);
}

void Function_35(var uParam0, var uParam1, bool bParam2) //Position: 0x1762 / 5986
{
	bool bVar0;
	float fVar1;
...
void Function_36(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x18EB / 6379
{
	struct<4> Var0;
...
void Function_37() //Position: 0x1957 / 6487
{
	if (!Function_84())
	{
...
void Function_38(bool bParam0) //Position: 0x1980 / 6528
{
...
void Function_39() //Position: 0x1A09 / 6665
{
	Function_66();
	Function_65();
	Function_65();
...
void Function_40() //Position: 0x1A5B / 6747
{
...
void Function_41() //Position: 0x1B61 / 7009
{
	float fVar0;
...
void Function_42() //Position: 0x1B94 / 7060
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_43() //Position: 0x1D22 / 7458
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_44() //Position: 0x1ED6 / 7894
{
	Function_45(&Global_28260, 1, 0);
	return;
}

void Function_45(int iParam0, bool bParam1, var uParam2) //Position: 0x1EE4 / 7908
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_46() //Position: 0x20D5 / 8405
{
...
struct<8> Function_47(int iParam0) //Position: 0x20EA / 8426
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_48(int iParam0, bool bParam1, bool bParam2) //Position: 0x2190 / 8592
{
	int iVar0;
...
void Function_49(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x242B / 9259
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_50(int iParam0) //Position: 0x2A58 / 10840
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_51(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2A69 / 10857
{
	char* cVar0[32];
...
struct<32> Function_52(char* cParam0, bool bParam1) //Position: 0x2B5E / 11102
{
	char* cVar0[32];
...
void Function_53(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2B77 / 11127
{
	float fVar0;
...
var Function_54(int iParam0, int iParam1) //Position: 0x2BDC / 11228
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_55(int iParam0, bool bParam1) //Position: 0x2BEE / 11246
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_56(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2C00 / 11264
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_57(int iParam0) //Position: 0x2D30 / 11568
{
	return Global_35278[iParam020].f_48;
}

float Function_58(int iParam0) //Position: 0x2D3F / 11583
{
	if (!iParam0 != 4294967295)
	{
...
var Function_59(int iParam0) //Position: 0x2D78 / 11640
{
	if (iParam0 == 4294967295)
	{
...
void Function_60(int iParam0) //Position: 0x2DB5 / 11701
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_61(int iParam0, bool bParam1, bool bParam2) //Position: 0x2F4F / 12111
{
	int iVar0;
	int iVar1;
...
int Function_62(bool bParam0) //Position: 0x3193 / 12691
{
...
struct<8> Function_63() //Position: 0x31D4 / 12756
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_64() //Position: 0x325D / 12893
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_65() //Position: 0x32F4 / 13044
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_66() //Position: 0x3373 / 13171
{
...
int Function_67(int iParam0, bool bParam1, int iParam2) //Position: 0x33AC / 13228
{
	int iVar0;
	int iVar1;
...
void Function_68(int iParam0) //Position: 0x35B6 / 13750
{
	Function_9(&Global_79338, iParam0);
	return;
}

void Function_69(int iParam0) //Position: 0x35C5 / 13765
{
	Function_27(&Global_79338, iParam0);
	return;
}

void Function_70(var uParam0, int iParam1) //Position: 0x35D4 / 13780
{
	if (Global_3381)
	{
		return;
...
void Function_71(bool bParam0) //Position: 0x3616 / 13846
{
...
void Function_72() //Position: 0x3667 / 13927
{
	vector3 vVar0;
	var uVar3;
...
bool Function_73(vector3 vParam0) //Position: 0x3722 / 14114
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_74(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x373A / 14138
{
	int iVar0;
...
vector3 Function_75() //Position: 0x3821 / 14369
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_76(int iParam0) //Position: 0x382A / 14378
{
...
int Function_77(bool bParam0, bool bParam1) //Position: 0x3840 / 14400
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_78(vector3 vParam0, vector3 vParam3) //Position: 0x3907 / 14599
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_79(var uParam0, int iParam1) //Position: 0x3924 / 14628
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_80(int iParam0) //Position: 0x414A / 16714
{
	var uVar0;
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x4185 / 16773
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_82() //Position: 0x4192 / 16786
{
...
bool Function_83(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x41AD / 16813
{
	uParam0 = uParam0;
...
bool Function_84() //Position: 0x4251 / 16977
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_85(int iParam0, int iParam1) //Position: 0x425A / 16986
{
	Function_10(&Global_50170[iParam022] + 32, iParam1);
	return;
}

void Function_86(bool bParam0, bool bParam1, bool bParam2) //Position: 0x426E / 17006
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<16> Function_87(int iParam0) //Position: 0x42E0 / 17120
{
	char* cVar0[16];
...
struct<16> Function_88(int iParam0) //Position: 0x4301 / 17153
{
	char* cVar0[16];
...
struct<16> Function_89(int iParam0) //Position: 0x4322 / 17186
{
	char* cVar0[16];
...
var Function_90() //Position: 0x4343 / 17219
{
	return "CQueue_Count";
}

var Function_91() //Position: 0x4358 / 17240
{
...
struct<16> Function_92(int iParam0) //Position: 0x4387 / 17287
{
	char* cVar0[16];
...
void Function_93(int iParam0, int iParam1) //Position: 0x43BB / 17339
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	if (!bVar0)
	{
		...
		SET_JOURNAL_ENTRY_PROGRESS(Function_96(iParam0), 1.0f, false, 0);
	}
	return;
}

struct<16> Function_94(int iParam0) //Position: 0x443D / 17469
{
	char* cVar0[16];
...
struct<24> Function_95(int iParam0) //Position: 0x445D / 17501
{
	char* cVar0[24];
...
var Function_96(int iParam0) //Position: 0x448E / 17550
{
	return Global_50170[iParam022].f_24;
}

bool Function_97(int iParam0) //Position: 0x449D / 17565
{
	switch (iParam0)
	{
		case 0x0000003A:
...
void Function_98(int iParam0) //Position: 0x461B / 17947
{
	Function_99(iParam0, 1);
	return;
}

void Function_99(int iParam0, bool bParam1) //Position: 0x4627 / 17959
{
	int iVar0;
...
int Function_100(bool bParam0) //Position: 0x467D / 18045
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_101(bool bParam0, bool bParam1) //Position: 0x4689 / 18057
{
	bool bVar0;
	bool bVar1;
	char* cVar2[16];
...
var Function_102() //Position: 0x47D5 / 18389
{
	bool bVar0;
...
void Function_103(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4822 / 18466
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_96(iParam0), fParam1, true, 0);
	if (bParam2)
	{
...
void Function_104(char* cParam0, bool bParam1) //Position: 0x48D9 / 18649
{
	bool bVar0;
...
bool Function_105(int iParam0, int iParam1) //Position: 0x48FE / 18686
{
	return Function_25(Global_50170[iParam022].f_32, iParam1);
}

void Function_106(bool bParam0) //Position: 0x4912 / 18706
{
	Function_114(bParam0);
	return;
}

void Function_107(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x491D / 18717
{
	struct<4> Var0;
	...
	*uParam1 = iParam2;
	if (bParam8)
	{
		SET_JOURNAL_ENTRY_PROGRESS(Function_96(iParam0), 0.0f, false, 0);
	}
	else
	{
		SET_JOURNAL_ENTRY_PROGRESS(Function_96(iParam0), (TO_FLOAT(Global_50170[iParam022].f_28) / TO_FLOAT(bParam6)), false, 0);
	}
...
void Function_108(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x49AD / 18861
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
...
void Function_109(int iParam0, int iParam1) //Position: 0x4A6A / 19050
{
	Function_16(&Global_50170[iParam022] + 32, iParam1);
	return;
}

struct<24> Function_110(int iParam0) //Position: 0x4A7E / 19070
{
	char* cVar0[24];
...
struct<24> Function_111(int iParam0) //Position: 0x4AAC / 19116
{
	char* cVar0[24];
...
bool Function_112(bool bParam0) //Position: 0x4ADC / 19164
{
	if (bParam0)
	{
...
var Function_113(int iParam0) //Position: 0x4B12 / 19218
{
	return Global_50170[iParam022].f_12;
}

void Function_114(int iParam0) //Position: 0x4B21 / 19233
{
	Function_115(iParam0, 0, Global_50170[iParam022].f_28);
	return;
}

int Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4B37 / 19255
{
	char* cVar0[16];
	bool bVar4;
...
int Function_116(bool bParam0, int iParam1, bool bParam2) //Position: 0x4BAC / 19372
{
	if (!Function_122())
	{
		Global_83822 = 1;
	...
	{
		Function_119(8, bParam0);
	}
	Function_117(487, (bParam0 * Global_3362), iParam1);
	return 1;
}

void Function_117(var uParam0, bool bParam1, int iParam2) //Position: 0x4BDC / 19420
{
...
int Function_118(int iParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4BF8 / 19448
{
	int iVar0;
	int iVar1;
...
void Function_119(var uParam0, float fParam1) //Position: 0x4E18 / 19992
{
	Function_120(uParam0, (Function_121(uParam0) + fParam1));
	return;
}

void Function_120(int iParam0, int iParam1) //Position: 0x4E2B / 20011
{
...
float Function_121(int iParam0) //Position: 0x4E54 / 20052
{
	return (*&Global_78480 + 176)[iParam0];
}

bool Function_122() //Position: 0x4E64 / 20068
{
	if (Function_84())
	{
...
int Function_123() //Position: 0x4E7D / 20093
{
	return Global_79349.f_16;
}

void Function_124(bool bParam0) //Position: 0x4E89 / 20105
{
	bool bVar0;
...
int Function_125() //Position: 0x4EB3 / 20147
{
	int iVar0;
...
int Function_126(bool bParam0, bool bParam1, float fParam2) //Position: 0x4EF8 / 20216
{
	float fVar0;
	bool bVar1;
...
bool Function_127(bool bParam0) //Position: 0x4F95 / 20373
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_128(int iParam0) //Position: 0x4FE5 / 20453
{
	return Function_129(iParam0, 4, 1);
}

int Function_129(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4FF2 / 20466
{
	char* cVar0[64];
	bool bVar16;
...
var Function_130(int iParam0) //Position: 0x5073 / 20595
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_131(bool bParam0) //Position: 0x538C / 21388
{
	char* cVar0[64];
...
void Function_132(char* cParam0, int iParam1) //Position: 0x542D / 21549
{
	struct<4> Var0;
...
struct<16> Function_133(var uParam0, var uParam1) //Position: 0x5444 / 21572
{
	return StackVal, StackVal, StackVal, Function_134(Function_135(uParam0), uParam1);
}

struct<16> Function_134(bool bParam0, bool bParam1) //Position: 0x5456 / 21590
{
	char* cVar0[16];
...
int Function_135(int iParam0) //Position: 0x548B / 21643
{
	if (!Function_136())
	{
		return 0;
...
bool Function_136() //Position: 0x54A4 / 21668
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_137(int iParam0) //Position: 0x54B1 / 21681
{
	struct<16> Var0;
...
struct<64> Function_138(bool bParam0) //Position: 0x5509 / 21769
{
	char* cVar0[64];
	char* cVar16[64];
	char* cVar32[64];
...
struct<64> Function_139() //Position: 0x55AF / 21935
{
...
bool Function_140() //Position: 0x55C0 / 21952
{
	return HAS_STRING_TABLE_LOADED("jp");
}

var Function_141(int iParam0) //Position: 0x55CE / 21966
{
	switch (iParam0)
	{
		case 0x00000000:
...
var Function_142(bool bParam0) //Position: 0x5772 / 22386
{
	bool bVar0;
...
var Function_143(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x57A7 / 22439
{
	bool bVar0;
...
void Function_144(var uParam0, int iParam1) //Position: 0x5824 / 22564
{
	bool bVar0;
...
void Function_145(var uParam0, bool bParam1) //Position: 0x584A / 22602
{
	...
	ATTACH_CAMERASHOT(*uParam0, bParam1, -1.972281f, 1.428903f, -2.302404f, 8.079432f, -115.2385f, -11.85037f, 0.0f, 0.0f, 0.0f, 0);
...
void Function_146() //Position: 0x58E5 / 22757
{
...
void Function_147(var uParam0, int iParam1, int iParam2) //Position: 0x58F7 / 22775
{
...
void Function_148(int iParam0) //Position: 0x5908 / 22792
{
	Function_149(4, iParam0);
	return;
}

void Function_149(int iParam0, bool bParam1) //Position: 0x5914 / 22804
{
	if (bParam1)
	{
...
void Function_150(int iParam0, bool bParam1) //Position: 0x594F / 22863
{
	if (bParam1)
	{
...
void Function_151(int iParam0, bool bParam1) //Position: 0x5977 / 22903
{
	if (bParam1)
	{
...
void Function_152() //Position: 0x599F / 22943
{
...
void Function_153(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x5A2E / 23086
{
	bool bVar0;
	float fVar1;
...
bool Function_154(bool bParam0) //Position: 0x5AF5 / 23285
{
	if (bParam0)
	{
...
int Function_155(bool bParam0, bool bParam1) //Position: 0x5B25 / 23333
{
	char* cVar0[16];
	bool bVar4;
...
void Function_156(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, vector3 vParam5, var uParam8, var uParam9, int iParam10) //Position: 0x5BB1 / 23473
{
...
void Function_157() //Position: 0x5C8F / 23695
{
...
var Function_158(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5CA3 / 23715
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_160(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
void Function_159(var uParam0, int iParam1) //Position: 0x5CDB / 23771
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_160(var uParam0, int iParam1, int iParam2) //Position: 0x5CEC / 23788
{
	int iVar0;
...
var Function_161(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5DB0 / 23984
{
	int iVar0;
...
int Function_162(int iParam0, bool bParam1) //Position: 0x5E80 / 24192
{
	char* cVar0[64];
...
int Function_163(int iParam0) //Position: 0x5EE7 / 24295
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_164(bool bParam0) //Position: 0x5EF7 / 24311
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
float Function_165(int iParam0, bool bParam1) //Position: 0x5F74 / 24436
{
	char* cVar0[64];
...
bool Function_166(bool bParam0) //Position: 0x5FDD / 24541
{
...
var Function_167() //Position: 0x5FF3 / 24563
{
	bool bVar0;
...
int Function_168() //Position: 0x6021 / 24609
{
	int iVar0;
...
bool Function_169(bool bParam0) //Position: 0x606E / 24686
{
	bool bVar0;
...
int Function_170(bool bParam0, int iParam1) //Position: 0x6112 / 24850
{
	float fVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_171(bool bParam0, float fParam1, var uParam2, var uParam3) //Position: 0x634E / 25422
{
	float fVar0;
...
void Function_172(int iParam0, float fParam1, float fParam2) //Position: 0x638B / 25483
{
	struct<9> Var0;
	float fVar9;
	float fVar10;
	...
	switch (iParam0->f_92)
	{
		...
		default:
			...
			else
			{
				...
				iVar5 = (fVar4 / 3.0f);
				fVar7 = Function_173(FABS(bVar6), iVar5);
				if (bVar6 > 0.0f)
				{
					fVar7 = (fVar7 * -1.0f);
				}
...
var Function_173(int iParam0, int iParam1) //Position: 0x6570 / 25968
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
float Function_174(bool bParam0, bool bParam1) //Position: 0x6583 / 25987
{
	vector3 vVar0;
...
var Function_175(bool bParam0) //Position: 0x65A2 / 26018
{
	bool bVar0;
...
void Function_176(int iParam0, float fParam1, float fParam2) //Position: 0x65E0 / 26080
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	switch (iParam0->f_92)
	{
		...
		default:
			...
			else
			{
				...
				fVar12 = Function_173(FABS(bVar11), fVar10);
				if (bVar11 > 0.0f)
				{
					fVar12 = (fVar12 * -1.0f);
				}
...
float Function_177(int iParam0, int iParam1) //Position: 0x675B / 26459
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
void Function_178(bool bParam0) //Position: 0x676E / 26478
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_179(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x6909 / 26889
{
	vector3 vVar0;
	bool bVar3;
...
int Function_180(float fParam0, bool bParam1, vector3 vParam2, var uParam5, var uParam6) //Position: 0x6961 / 26977
{
	struct<5> Var0;
	float fVar6;
	bool bVar7;
...
vector3 Function_181(vector3 vParam0, int iParam3) //Position: 0x6D48 / 27976
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
...
var Function_182(vector3 vParam0, bool bParam3) //Position: 0x6DB0 / 28080
{
	vector3 vVar0;
	var uVar3;
...
void Function_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x6DE0 / 28128
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_184(var uParam0, bool bParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x6E03 / 28163
{
	vector3 vVar0;
	bool bVar3;
...
int Function_185(float fParam0, bool bParam1, vector3 vParam2, var uParam5, var uParam6) //Position: 0x6E60 / 28256
{
	struct<5> Var0;
	vector3 vVar6;
	float fVar9;
...
void Function_186(var uParam0, bool bParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x7443 / 29763
{
	vector3 vVar0;
	bool bVar3;
...
void Function_187(var uParam0, bool bParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x74A0 / 29856
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
int Function_188(int iParam0, bool bParam1, bool bParam2, vector3 vParam3, var uParam6, var uParam7) //Position: 0x7520 / 29984
{
	struct<5> Var0;
	vector3 vVar6;
	vector3 vVar9;
...
void Function_189(bool bParam0, bool bParam1, float fParam2) //Position: 0x78A4 / 30884
{
	bool bVar0;
...
void Function_190(bool bParam0, bool bParam1) //Position: 0x7918 / 31000
{
	bool bVar0;
...
void Function_191(bool bParam0, bool bParam1, bool bParam2, float fParam3) //Position: 0x794A / 31050
{
	vector3 vVar0;
...
bool Function_192(int iParam0) //Position: 0x7A3C / 31292
{
	bool bVar0;
	vector3 vVar1;
	var uVar4;
...
void Function_193(bool bParam0, int iParam1, bool bParam2) //Position: 0x7D7E / 32126
{
	int iVar0;
...
var Function_194(bool bParam0, int iParam1) //Position: 0x7E03 / 32259
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_195(int iParam0, bool bParam1, bool bParam2) //Position: 0x8006 / 32774
{
	vector3 vVar0;
...
void Function_196(bool bParam0) //Position: 0x8093 / 32915
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
...
void Function_197(bool bParam0, bool bParam1) //Position: 0x824D / 33357
{
	if (IS_OBJECT_VALID(bParam1))
	{
		bParam0->f_92 = 0;
...
float Function_198(int iParam0) //Position: 0x82A5 / 33445
{
	return -Function_199(iParam0);
}

float Function_199(int iParam0) //Position: 0x82B1 / 33457
{
...
void Function_200() //Position: 0x8382 / 33666
{
	if (!Function_201())
	{
	}
...
bool Function_201() //Position: 0x838F / 33679
{
	return NET_IS_IN_SESSION();
}

bool Function_202(bool bParam0) //Position: 0x8398 / 33688
{
	return Function_25(*bParam0, 2);
}

void Function_203() //Position: 0x83A5 / 33701
{
...
bool Function_204(int iParam0) //Position: 0x8420 / 33824
{
	if (Function_205(iParam0))
	{
...
bool Function_205(int iParam0) //Position: 0x843B / 33851
{
	return Function_25(*iParam0, 1);
}

void Function_206(int iParam0, float fParam1) //Position: 0x8448 / 33864
{
	Function_207(iParam0, -fParam1);
	return;
}

void Function_207(var uParam0, float fParam1) //Position: 0x8456 / 33878
{
	Function_200();
...
void Function_208(var uParam0, var uParam1) //Position: 0x846A / 33898
{
	uParam0->f_4 = uParam1;
...
void Function_209() //Position: 0x8487 / 33927
{
	bool bVar0;
...
void Function_210(int iParam0) //Position: 0x85F6 / 34294
{
...
void Function_211(int iParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x864F / 34383
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
...
int Function_212(int iParam0) //Position: 0x8899 / 34969
{
	int iVar0;
...
bool Function_213(bool bParam0, int iParam1, bool bParam2) //Position: 0x88DC / 35036
{
	char* cVar0[64];
...
var Function_214(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x8941 / 35137
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_215() //Position: 0x89DC / 35292
{
	if (!Function_24(4))
	{
		Function_23();
...
void Function_216() //Position: 0x89F3 / 35315
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_217(var uParam0, var uParam1, var uParam2, int iParam3) //Position: 0x8B95 / 35733
{
	bool bVar0;
	float fVar1;
...
bool Function_218(bool bParam0) //Position: 0x8D29 / 36137
{
	if (bParam0)
	{
...
void Function_219(int iParam0) //Position: 0x8D63 / 36195
{
	int iVar0;
...
int Function_220() //Position: 0x8DCB / 36299
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_221(int iParam0, int iParam1) //Position: 0x8E06 / 36358
{
...
int Function_222(bool bParam0) //Position: 0x8E2F / 36399
{
	return Function_162(0, bParam0);
}

int Function_223(int iParam0, bool bParam1) //Position: 0x8E3B / 36411
{
	int iVar0;
...
bool Function_224() //Position: 0x8E8F / 36495
{
	if (Function_246(4) <= Function_246(3))
	{
		return 0;
...
void Function_225(int iParam0, int iParam1) //Position: 0x8EA3 / 36515
{
...
bool Function_226() //Position: 0x8EC4 / 36548
{
	return GET_NUM_PLAYERS() >= 1;
}

void Function_227(int iParam0) //Position: 0x8ECF / 36559
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_228(int iParam0) //Position: 0x8EE3 / 36579
{
	struct<21> Var0;
...
void Function_229() //Position: 0x8F1E / 36638
{
	char* cVar0[32];
...
int Function_230(bool bParam0) //Position: 0x9003 / 36867
{
	struct<4> Var0;
...
void Function_231(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x9047 / 36935
{
	...
	Function_232(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_69.f_104, &Local_69) + Vector(0.0f, 2.45f, 0.0f), 1, 37832, 1, 125, 0, 0, 0);
...
void Function_232(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x90CA / 37066
{
	vector3 vVar0;
	int iVar3;
...
void Function_233(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, var uParam11, var uParam12, int iParam13, var uParam14, var uParam15, int iParam16) //Position: 0x9115 / 37141
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (!HUD_IS_FADED())
	{
		...
		*(iParam0 + 20) = { StackVal, StackVal, vVar6 };
		...
		{
			fVar14 = Function_234(iParam0->f_36);
...
var Function_234(float fParam0) //Position: 0x9394 / 37780
{
	return (fParam0 * 57.29578f);
}

void Function_235(int iParam0) //Position: 0x93A2 / 37794
{
	if (IS_OBJECT_VALID(*iParam0))
	{
		DESTROY_OBJECT(*iParam0);
...
var Function_236(int iParam0, var uParam1) //Position: 0x93C8 / 37832
{
	char* cVar0[64];
...
struct<64> Function_237(var uParam0) //Position: 0x942D / 37933
{
...
var Function_239(bool bParam0, var uParam1) //Position: 0x9486 / 38022
{
	int iVar0;
	...
	if (Local_69.f_100 != bParam0)
	{
		...
		if (bParam0 == 0)
		{
			UI_SET_STRING_FORMAT("Generic_Dbuffer128_1", UI_GET_STRING("RACE_summary"), I2STR(Function_246(3)), false, false);
		}
		else
		{
			Function_213(&Local_267 + 12 + 12[(bParam0 - 1)2], &iVar0, 1);
			UI_SET_STRING_FORMAT("Generic_Dbuffer128_1", UI_GET_STRING("GP_summary"), I2STR(bParam0), UI_GET_STRING(&iVar0 + 48), false);
		}
	}
	return "Generic_Dbuffer128_1";
}

var Function_240() //Position: 0x953F / 38207
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
...
void Function_241(bool bParam0, int iParam1) //Position: 0x95A3 / 38307
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_242(bool bParam0, bool bParam1) //Position: 0x95EF / 38383
{
	int iVar0;
...
void Function_243() //Position: 0x960F / 38415
{
	if (IS_OBJECT_VALID(Local_69.f_104))
	{
...
bool Function_244() //Position: 0x962B / 38443
{
	return Function_255(8);
}

bool Function_245(int iParam0) //Position: 0x9636 / 38454
{
	struct<25> Var0;
...
bool Function_246(int iParam0) //Position: 0x9671 / 38513
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return 4294967295;
...
void Function_247(int iParam0) //Position: 0x9691 / 38545
{
	Function_150(8, iParam0);
	return;
}

void Function_248(bool bParam0) //Position: 0x969E / 38558
{
	NET_LOG(true, "GP State", "Moving to: %s (%s)", Function_249(bParam0), I2STR(bParam0), false, false);
	Local_267 = bParam0;
	return;
}

var Function_249(int iParam0) //Position: 0x96D9 / 38617
{
	switch (iParam0)
	{
		case 0x00000000:
...
bool Function_250(int iParam0) //Position: 0x98C2 / 39106
{
	int iVar0;
	int iVar1;
...
void Function_251() //Position: 0x9C3D / 39997
{
	if (!Function_252(128))
	{
		return;
...
bool Function_252(int iParam0) //Position: 0x9C7D / 40061
{
	int iVar0;
...
bool Function_253() //Position: 0x9C99 / 40089
{
	int iVar0;
...
void Function_254() //Position: 0x9CC4 / 40132
{
	if (!Function_252(128))
	{
		return;
...
bool Function_255(int iParam0) //Position: 0x9D06 / 40198
{
	return Function_25(StackVal, iParam0);
}

void Function_256() //Position: 0x9D19 / 40217
{
	if (HUD_IS_FADED())
	{
...
void Function_257(char* cParam0, int iParam1) //Position: 0x9D6E / 40302
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_258() //Position: 0x9E05 / 40453
{
	bool bVar0;
	bool bVar1;
	...
	bVar0 = RAND_INT_RANGE(true, (Function_246(3) - 2));
	bVar1 = RAND_INT_RANGE(false, 10);
	Function_259(&Local_267 + 12 + 12, &bVar0, &bVar1);
	return;
}

int Function_259(var uParam0, var uParam1, int iParam2) //Position: 0x9E3D / 40509
{
	struct<2> Var0;
...
void Function_260(bool bParam0) //Position: 0x9EB8 / 40632
{
	var uVar0;
	...
	if (NET_IS_SESSION_HOST())
	{
		strcpy(&Local_267 + 12 + 12[Function_246(3)2], bParam0, 8);
	}
	Function_225(3, Function_246(3) + 1);
	return;
}

void Function_261() //Position: 0x9EF5 / 40693
{
	Function_225(4, 0);
	Function_225(3, 0);
	Function_151(2, 1);
...
void Function_262() //Position: 0x9F7A / 40826
{
...
void Function_263(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0xA153 / 41299
{
	Function_264(iParam0 + 276, iParam1, iParam2, iParam3, iParam4);
}

void Function_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0xA16B / 41323
{
	Function_265(uParam0, uParam1, uParam2, uParam3, uParam4);
}

void Function_265(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0xA180 / 41344
{
...
void Function_266(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xA1A3 / 41379
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_267(int iParam0) //Position: 0xA1CD / 41421
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_268(int iParam0) //Position: 0xA1DD / 41437
{
	int iVar0;
...
void Function_269(var uParam0, int iParam1) //Position: 0xA20A / 41482
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_270(var uParam0) //Position: 0xA216 / 41494
{
	Function_266(uParam0, 4294967295, 0, 1);
	return;
}

void Function_271() //Position: 0xA224 / 41508
{
