...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = Function_44();
	Function_43(4096);
	PRINT_BIG("Use the widget bank scripts/loadtest to control this script", 5f, 0, 2, 0);
	...
	iVar2++;
	Function_42(bLocal_20);
	Function_42(bLocal_21);
	iVar24 = 0;
	...
	while (iVar28 <= Global_29008)
	{
		...
		{
			Function_41(iVar28);
			vVar39 = { StackVal, StackVal, Function_41(iVar28) };
			if (Function_40(&vVar39, &vVar25) < 100.0f)
			{
	...
	if (Function_39("soakrandomdest"))
	{
		iVar42 = Function_38("soakrandomdest");
	...
	while (iVar47 <= iVar1)
	{
		iVar49 = GET_ASSET_ID(uLocal_436[iVar47], 0);
		STREAMING_REQUEST_PROP(iVar49, false);
		while (!STREAMING_IS_PROP_LOADED(iVar49))
		{
			WAIT(false);
		}
		iVar47++;
	...
	Function_37(&Local_196, 976, 369, 325);
	Function_37(&Local_234, 976, 397, 322);
	fLocal_4 = 40.0f;
	fLocal_3 = 20.0f;
	iLocal_5 = 0;
	fLocal_6 = 37.0f;
	iLocal_7 = 20;
	bLocal_8 = true;
	if (Function_39("soakexplosion"))
	{
		iLocal_9 = Function_38("soakexplosion");
		if (iLocal_9 == 0)
		{
			bLocal_8 = false;
		}
	...
	if (Function_39("soaksquadsize"))
	{
		iLocal_272 = Function_38("soaksquadsize");
		iLocal_273 = iLocal_272;
	}
	if (Function_39("soakwalkabouttimeout"))
	{
		bLocal_170 = TO_FLOAT(Function_38("soakwalkabouttimeout"));
	}
	if (Function_39("soakflee"))
	{
		bLocal_16 = true;
		iLocal_187 = 0;
		iLocal_188 = 0;
	...
	iVar61 = 0;
	iVar51 = iLocal_7;
	Local_274 = CREATE_LAYOUT(Function_36());
	fVar62 = GET_CURRENT_GAME_TIME();
	while (!IS_EXITFLAG_SET())
	{
		Function_34(&Local_274);
		if (iLocal_13)
		{
		...
		if (iLocal_14 != bLocal_15)
		{
			...
			{
				fVar62 = GET_CURRENT_GAME_TIME();
				bLocal_19 = CREATE_LAYOUT(Function_36());
				Function_33();
				vLocal_175 = { StackVal, StackVal, Function_33() };
				Function_27();
				AI_GLOBAL_SET_PERMANENT_DANGER(Function_44(), 1);
			}
			else
			{
				...
				TASK_CLEAR(Function_44());
				AI_GLOBAL_SET_PERMANENT_DANGER(Function_44(), 0);
			}
		}
		if (bLocal_186)
		{
		...
		if (iLocal_272 >= 0)
		{
			...
			{
				Function_18(Local_196.f_20, Function_44(), -1.0f, -1.0f, 0, 1);
			}
			else
			{
		...
		if (iLocal_273 >= 0)
		{
			...
			{
				Function_18(Local_234.f_20, Function_44(), -1.0f, -1.0f, 1, 1);
			}
			else
			{
		...
		if (bLocal_15)
		{
			...
			Function_33();
			vVar67 = { StackVal, StackVal, Function_33() };
			vVar70 = { 0.0f, 0.0f, 0.0f };
			GET_POSITION(Function_44(), &vVar70);
			...
			if ((bLocal_170 > fLocal_169 && fLocal_171 < bLocal_170) || IS_BUTTON_RELEASED(Function_15(), 4, 1, false))
			{
				...
				PRINTVECTOR(vVar67);
				PRINTNL();
				TELEPORT_ACTOR(Function_44(), &vVar67, 1, 1, 1);
				WAIT(50);
				...
				WAIT(20);
				SNAP_OBJECT_TO_GROUND(Function_44(), 1000.0f, false, 1092616192);
...
void Function_2(var uParam0, char* cParam1, bool bParam2, int iParam3) //Position: 0xA10 / 2576
{
	vector3 vVar0;
...
void Function_3(bool bParam0, float fParam1, int iParam2) //Position: 0xA2C / 2604
{
	...
	fVar0 = (TO_FLOAT(bParam0) * fParam1);
	fVar1 = 0.0f;
	fVar2 = 0.0f;
	bVar3 = RAND_FLOAT_RANGE(fLocal_3, fLocal_4);
	*iParam2 = { ((fLocal_3 * SIN_DEGREE(fVar0)) + fVar1), 0.0f, (fVar2 + (bVar3 * COS_DEGREE(fVar0))) };
	return;
}
...
void Function_9() //Position: 0xB85 / 2949
{
	...
	{
		Function_14(Function_44());
		vVar3 = { StackVal, StackVal, Function_14(Function_44()) };
		vVar3.x = (vVar3.x + 2.0f);
		bLocal_18 = CREATE_ACTOR_IN_LAYOUT(bLocal_19, Function_36(), bLocal_20, vVar3, vVar0);
		SET_ACTOR_INVULNERABILITY(bLocal_18, 1);
	}
	if (!IS_ACTOR_VALID(bLocal_174))
	{
		Function_14(Function_44());
		vVar6 = { StackVal, StackVal, Function_14(Function_44()) };
		vVar6.x = (vVar6.x + 3.0f);
		bLocal_174 = CREATE_ACTOR_IN_LAYOUT(bLocal_19, Function_36(), bLocal_21, vVar6, vVar0);
		SET_ACTOR_INVULNERABILITY(bLocal_174, 1);
		SET_ACTOR_UPDATE_PRIORITY(bLocal_174, false);
		_SET_ACTOR_INFINITE_AMMO_FLAG(bLocal_174, 6, true);
		TASK_FOLLOW_OBJECT_AT_DISTANCE(Function_44(), bLocal_174, 8.0f, 3);
		SET_ACTOR_UPDATE_PRIORITY(Function_44(), false);
		if (IS_BLIP_VALID(bLocal_443))
		{
			REMOVE_BLIP(bLocal_443);
		}
	...
	{
		Function_14(Function_44());
		vVar9 = { StackVal, StackVal, Function_14(Function_44()) };
		vVar9.x = (vVar9.x - 2.0f);
		bLocal_178 = CREATE_ACTOR_IN_LAYOUT(bLocal_19, Function_36(), bLocal_20, vVar9, vVar0);
	}
	if (!IS_ACTOR_MOUNTED(bLocal_178))
	{
		ACTOR_MOUNT_ACTOR(Function_44(), bLocal_178);
	}
...
void Function_17(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF9A / 3994
{
	bool bVar0;
	bool bVar1;
	...
	while (bVar0 <= SQUAD_GET_SIZE(bParam0))
	{
		...
		{
			TASK_FOLLOW_OBJECT_AT_DISTANCE(bVar1, bParam1, fParam2, iParam3);
...
void Function_18(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0xFF3 / 4083
{
	bool bVar0;
	bool bVar1;
...
void Function_19(bool bParam0, bool bParam1, int iParam2) //Position: 0x1061 / 4193
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		TASK_PRIORITY_SET(bVar2, iParam2);
		bVar0++;
	}
	return;
}
...
void Function_21(int iParam0, int iParam1) //Position: 0x10EE / 4334
{
	...
	{
		*iParam0 = CREATE_LAYOUT(Function_36());
	}
	if (!SQUAD_IS_VALID(iParam0->f_20))
	{
		iParam0->f_20 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(*iParam0, Function_36()));
	}
	iLocal_183++;
		...
		if (StackVal <= iVar10)
		{
			...
			if (bLocal_192)
			{
				if (!bVar12)
				{
					...
					(*iParam0 + 24)[iVar10] = CREATE_ACTOR_IN_LAYOUT(*iParam0, Function_36(), iParam0->f_12, vVar3, vVar0);
					MEMORY_REPORT_POSITION_AUTO((*iParam0 + 24)[iVar10], Function_44(), 1);
				}
			}
			else if (bVar12)
			{
			...
			if ((bVar17 || !bLocal_192) && !bVar11)
			{
				...
				FIND_GROUND_INTERSECTION(&vVar14, 100.0f, &vVar3, &uVar6);
				(*iParam0 + 88)[iVar10] = CREATE_ACTOR_IN_LAYOUT(*iParam0, Function_36(), iParam0->f_16, vVar3, vVar0);
				MEMORY_REPORT_POSITION_AUTO((*iParam0 + 88)[iVar10], Function_44(), 1);
...
void Function_28() //Position: 0x15D0 / 5584
{
	...
	HUD_CLEAR_OBJECTIVE();
	Function_29(UI_GET_STRING(GET_OBJECT_NAME(StackVal)), 0x40f00000, 1, 2, 0, 0, 0, 0);
	return;
}

void Function_29(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x15FD / 5629
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_30(int iParam0) //Position: 0x1682 / 5762
{
	char* cVar0[16];
...
bool Function_31() //Position: 0x16C1 / 5825
{
...
bool Function_32(var uParam0, bool bParam1) //Position: 0x16DC / 5852
{
	return (uParam0 && bParam1) == 0;
}

vector3 Function_33() //Position: 0x16E9 / 5865
{
	Function_41(iLocal_22[bLocal_179]);
	return StackVal, StackVal, Function_41(iLocal_22[bLocal_179]);
}

void Function_34(int iParam0) //Position: 0x16F8 / 5880
{
	if (bLocal_11)
	{
		...
		if (iParam0->f_16 == 0)
		{
			Function_35(StackVal, iParam0, iLocal_5, fLocal_6, uLocal_436[iParam0->f_32]);
			iLocal_5++;
...
void Function_35(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4) //Position: 0x179E / 6046
{
	char* cVar0[16];
	bool bVar4;
	vector3 vVar5;
...
void Function_37(var uParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x183D / 6205
{
...
int Function_38(bool bParam0) //Position: 0x1861 / 6241
{
	bool bVar0;
...
bool Function_39(bool bParam0) //Position: 0x1884 / 6276
{
	bool bVar0;
...
float Function_40(var uParam0, int iParam1) //Position: 0x18A3 / 6307
{
	vector3 vVar0;
	bool bVar3;
...
vector3 Function_41(int iParam0) //Position: 0x18C1 / 6337
{
	bool bVar0;
	vector3 vVar1;
...
void Function_42(bool bParam0) //Position: 0x18DD / 6365
{
	if (bParam0 != 4294967295)
	{
...
void Function_43(var uParam0) //Position: 0x1901 / 6401
{
	int iVar0;
	
	if (Function_32(uParam0, 1) && Function_32(Global_26119, 1))
	{
	}
...
bool Function_44() //Position: 0x1935 / 6453
{
