...
void Function_1() //Position: 0x76 / 118
{
	...
	{
		if (SQUAD_IS_VALID(bLocal_147))
		{
			SQUAD_GOALS_CLEAR(bLocal_147);
			Function_92(bLocal_147);
			Function_91(bLocal_147);
		}
		if (IS_ACTORSET_VALID(iLocal_19))
		{
			Function_87(iLocal_19, Global_78576, -1.0f, -1.0f, 1, 1);
		}
	}
	else if (NET_SCRIPT_GET_NUM_PARTICIPANTS() == 0)
	{
		if (SQUAD_IS_VALID(bLocal_147))
		{
			SQUAD_GOALS_CLEAR(bLocal_147);
	...
	if (IS_BLIP_VALID(bLocal_151))
	{
		REMOVE_BLIP(bLocal_151);
	}
	Function_86();
...
void Function_3(int iParam0) //Position: 0x1EA / 490
{
...
void Function_4() //Position: 0x1FC / 508
{
	Function_6();
	Function_5();
	return;
...
void Function_6() //Position: 0x228 / 552
{
...
void Function_7(int iParam0) //Position: 0x25D / 605
{
	Function_42(131072);
	HUD_ENABLE(1);
...
int Function_8(float fParam0, var uParam1, bool bParam2) //Position: 0x318 / 792
{
	if (!Function_28())
	{
		Global_83822 = 1;
...
void Function_9(int iParam0, bool bParam1, int iParam2) //Position: 0x348 / 840
{
...
int Function_10(int iParam0, bool bParam1, int iParam2, var uParam3) //Position: 0x364 / 868
{
	int iVar0;
	int iVar1;
...
void Function_11(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x584 / 1412
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_12() //Position: 0xBB1 / 2993
{
	int iVar0;
...
var Function_13(int iParam0) //Position: 0xBB9 / 3001
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_14(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xBCA / 3018
{
	char* cVar0[32];
...
struct<32> Function_15(char* cParam0, bool bParam1) //Position: 0xCBF / 3263
{
	char* cVar0[32];
...
void Function_16(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0xCD8 / 3288
{
	float fVar0;
...
int Function_17(int iParam0, int iParam1) //Position: 0xD3D / 3389
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
int Function_18(int iParam0, bool bParam1) //Position: 0xD4F / 3407
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_19(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0xD61 / 3425
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_20(int iParam0) //Position: 0xE91 / 3729
{
	return Global_35278[iParam020].f_48;
}

float Function_21(int iParam0) //Position: 0xEA0 / 3744
{
	if (!iParam0 != 4294967295)
	{
...
var Function_22(int iParam0) //Position: 0xED9 / 3801
{
	if (iParam0 == 4294967295)
	{
...
void Function_23(int iParam0) //Position: 0xF16 / 3862
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_24(int iParam0, bool bParam1, bool bParam2) //Position: 0x10B0 / 4272
{
	int iVar0;
	int iVar1;
...
void Function_25(int iParam0, float fParam1) //Position: 0x12F4 / 4852
{
	Function_26(iParam0, (Function_27(iParam0) + fParam1));
	return;
}

void Function_26(int iParam0, int iParam1) //Position: 0x1307 / 4871
{
...
float Function_27(int iParam0) //Position: 0x1330 / 4912
{
	return (*&Global_78480 + 176)[iParam0];
}

bool Function_28() //Position: 0x1340 / 4928
{
	if (Function_30())
	{
...
int Function_29() //Position: 0x1359 / 4953
{
	return Global_79349.f_16;
}

bool Function_30() //Position: 0x1365 / 4965
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_31() //Position: 0x136E / 4974
{
	if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_90))
	{
...
void Function_32() //Position: 0x13C8 / 5064
{
...
void Function_33(int iParam0, bool bParam1, int iParam2) //Position: 0x13DC / 5084
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_34(var uParam0, int iParam1) //Position: 0x1404 / 5124
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_35(int iParam0, int iParam1) //Position: 0x1417 / 5143
{
	*iParam0 = (*iParam0 || iParam1);
	return;
}

void Function_36() //Position: 0x1426 / 5158
{
	if (Function_38())
	{
		Function_37();
...
void Function_37() //Position: 0x143D / 5181
{
	Function_33(32768, 1, 0);
	return;
}

bool Function_38() //Position: 0x144C / 5196
{
	return (Function_39(4096) || Function_39(4));
}

bool Function_39(bool bParam0) //Position: 0x145D / 5213
{
	return Function_40(Global_76905.f_132, bParam0);
}

bool Function_40(var uParam0, bool bParam1) //Position: 0x146E / 5230
{
	return (uParam0 && bParam1) == 0;
}

var Function_41() //Position: 0x147B / 5243
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return "";
...
void Function_42(int iParam0) //Position: 0x1490 / 5264
{
...
void Function_43(var uParam0, int iParam1) //Position: 0x14E9 / 5353
{
	Function_35(uParam0, iParam1);
	return;
}

void Function_44(bool bParam0, int iParam1) //Position: 0x14F6 / 5366
{
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), iParam1, 0, 0, 0, 0, 0);
	return;
}

struct<32> Function_45(int iParam0) //Position: 0x150B / 5387
{
	char* cVar0[32];
...
bool Function_46(int iParam0) //Position: 0x15C8 / 5576
{
...
void Function_47(int iParam0) //Position: 0x15DE / 5598
{
	Function_48(&Global_79338, iParam0);
	return;
}

void Function_48(var uParam0, int iParam1) //Position: 0x15ED / 5613
{
	Function_34(uParam0, iParam1);
	return;
}

void Function_49(int iParam0) //Position: 0x15FA / 5626
{
	Function_48(&Global_83864 + 1252, iParam0);
	return;
}

void Function_50(int iParam0) //Position: 0x160C / 5644
{
	Function_48(&Global_78617 + 52, iParam0);
	return;
}

void Function_51(int iParam0) //Position: 0x161D / 5661
{
...
void Function_52() //Position: 0x1656 / 5718
{
...
void Function_53() //Position: 0x166D / 5741
{
	struct<17> Var0;
...
void Function_54(int iParam0) //Position: 0x168F / 5775
{
	Local_84 = { StackVal, StackVal, StackVal, StackVal, *iParam0 };
	return;
}

void Function_55() //Position: 0x169D / 5789
{
	Function_56();
	return;
}

void Function_56() //Position: 0x16A6 / 5798
{
	Function_57(4294967286);
	return;
}

void Function_57(bool bParam0) //Position: 0x16B2 / 5810
{
	var uVar0;
	struct<9> Var1;
...
void Function_58(var uParam0, int iParam1) //Position: 0x16EF / 5871
{
	Local_51[iParam12] = *uParam0;
	return;
}

void Function_59(int iParam0) //Position: 0x16FE / 5886
{
	Local_49 = *iParam0;
	return;
}

void Function_60(var uParam0, int iParam1) //Position: 0x1709 / 5897
{
	*uParam0 = iParam1;
	return;
}

void Function_61(int iParam0) //Position: 0x1714 / 5908
{
	*iParam0 = { StackVal, StackVal, StackVal, StackVal, Local_84 };
	return;
}

void Function_62(int iParam0) //Position: 0x1722 / 5922
{
	*iParam0 = Local_49;
	return;
}

float Function_63(int iParam0) //Position: 0x172D / 5933
{
...
void Function_64() //Position: 0x17FE / 6142
{
	if (!Function_65())
	{
	}
...
bool Function_65() //Position: 0x180B / 6155
{
	return NET_IS_IN_SESSION();
}

bool Function_66(int iParam0) //Position: 0x1814 / 6164
{
	return Function_40(*iParam0, 2);
}

bool Function_67(int iParam0) //Position: 0x1821 / 6177
{
	return Function_40(*iParam0, 1);
}

void Function_68(int iParam0) //Position: 0x182E / 6190
{
...
void Function_69(int iParam0) //Position: 0x185C / 6236
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_70(var uParam0, int iParam1) //Position: 0x186F / 6255
{
	int iVar0;
...
void Function_71(int iParam0) //Position: 0x1886 / 6278
{
	if (IS_ACTORSET_VALID(iLocal_19))
	{
		Function_81(iLocal_19);
	}
	Function_79(iParam0);
	if (!Function_77(4))
	{
...
void Function_72(bool bParam0) //Position: 0x18AA / 6314
{
	bool bVar0;
...
void Function_73(bool bParam0, bool bParam1) //Position: 0x18EE / 6382
{
	bool bVar0;
...
int Function_74(bool bParam0, bool bParam1) //Position: 0x196B / 6507
{
	int iVar0;
	int iVar1;
...
void Function_75(int iParam0) //Position: 0x198F / 6543
{
	Function_48(&Global_79337, iParam0);
	return;
}

void Function_76(int iParam0) //Position: 0x199E / 6558
{
	Function_43(&Global_79337, iParam0);
	return;
}

bool Function_77(int iParam0) //Position: 0x19AD / 6573
{
	return Function_78(Global_79337, iParam0);
}

int Function_78(var uParam0, int iParam1) //Position: 0x19BC / 6588
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(bool bParam0) //Position: 0x19C9 / 6601
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_80(bool bParam0) //Position: 0x1A68 / 6760
{
	bool bVar0;
...
void Function_81(int iParam0) //Position: 0x1A99 / 6809
{
	int iVar0;
...
void Function_82(int iParam0) //Position: 0x1AE4 / 6884
{
	int iVar0;
...
void Function_83(var uParam0, int iParam1) //Position: 0x1B0A / 6922
{
...
void Function_84(var uParam0, int iParam1) //Position: 0x1C38 / 7224
{
	int iVar0;
...
bool Function_85(int iParam0, int iParam1) //Position: 0x1C52 / 7250
{
	int iVar0;
...
void Function_86() //Position: 0x1C6F / 7279
{
	HUD_CLEAR_OBJECTIVE();
...
void Function_87(int iParam0, var uParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x1C7B / 7291
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (iVar0 < (GET_ACTORSET_SIZE(iParam0) - 1))
	{
		bVar1 = GET_ACTOR_FROM_ACTORSET(iParam0, iVar0);
...
var Function_88(var uParam0, int iParam1) //Position: 0x1CCB / 7371
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	{
		if (IS_ACTOR_ALIVE(GET_ACTOR_FROM_ACTORSET(iParam1, iVar0)))
		{
			fVar3 = Function_89(uParam0, GET_ACTOR_FROM_ACTORSET(iParam1, iVar0));
			if (fVar3 > fVar2)
			{
				fVar2 = fVar3;
				iVar1 = iVar0;
	...
	if (iVar1 >= 4294967295)
	{
		return GET_ACTOR_FROM_ACTORSET(iParam1, iVar1);
	}
	return "";
}

float Function_89(bool bParam0, bool bParam1) //Position: 0x1D51 / 7505
{
	var uVar0;
	var uVar3;
	int iVar6;
...
var Function_90(var uParam0, int iParam1) //Position: 0x1D70 / 7536
{
	vector3 vVar0;
	int iVar3;
...
void Function_91(bool bParam0) //Position: 0x1D8E / 7566
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_92(bool bParam0) //Position: 0x1DD5 / 7637
{
	bool bVar0;
...
int Function_93() //Position: 0x1E0A / 7690
{
	bool bVar0;
	
	if (!Function_304(&vLocal_103, &bLocal_130, 41542, 1, 1))
	{
		return 0;
	}
	if (vLocal_103.y < 0 && vLocal_103.y > 11)
	{
		...
		{
			bVar0 = IS_ACTOR_IN_VOLUME(Function_41(), bLocal_150);
		}
		if (iLocal_167)
		{
			if (bVar0)
			{
				iLocal_167 = 0;
				Function_303(&uLocal_152, (5.0f - 1.0f));
			}
		}
		else
		{
			SET_BLIP_VISIBLE(bLocal_151, !bVar0);
			if (bVar0 && !bLocal_168)
			{
				Function_86();
			}
			if (iLocal_166)
			{
				if (!bVar0)
				{
					if (!Function_302())
					{
						if (IS_ACTOR_ALIVE(Function_41()))
						{
							Function_300("bobcat_MP_return", 0x40f00000, 1, 2, 0, 0, 0, 0);
							Function_299(&uLocal_152);
							iLocal_166 = 0;
						}
					}
				}
			}
			else if (Function_297(&uLocal_152) < 5.0f)
			{
				iLocal_166 = 1;
			}
		}
...
void Function_94() //Position: 0x1F29 / 7977
{
	int iVar0;
	...
	{
		case 0x00000000:
			iVar0 = (Function_230(319) - iLocal_164);
...
var Function_95(int iParam0) //Position: 0x1F7F / 8063
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
...
void Function_96(var uParam0, bool bParam1, int iParam2) //Position: 0x24B9 / 9401
{
	int iVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x25C4 / 9668
{
	int iVar0;
...
void Function_98(int iParam0) //Position: 0x25E0 / 9696
{
...
bool Function_99() //Position: 0x265F / 9823
{
	int iVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x26C8 / 9928
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_101(int iParam0, bool bParam1) //Position: 0x26D7 / 9943
{
	if (bParam1)
	{
...
bool Function_102(int iParam0) //Position: 0x2712 / 10002
{
	return Function_78(Global_78617.f_52, iParam0);
}

bool Function_103(vector3 vParam0) //Position: 0x2723 / 10019
{
	var uVar0[8];
	int iVar9;
	int iVar10;
...
var Function_104(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x2797 / 10135
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_105(int iParam0) //Position: 0x2832 / 10290
{
...
vector3 Function_106(bool bParam0) //Position: 0x2890 / 10384
{
	vector3 vVar0;
...
void Function_107(int iParam0) //Position: 0x28A1 / 10401
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

bool Function_108(bool bParam0, bool bParam1, float fParam2) //Position: 0x28B2 / 10418
{
	struct<17> Var0;
...
bool Function_109(int iParam0) //Position: 0x2B05 / 11013
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_110(bool bParam0) //Position: 0x2B48 / 11080
{
	int iVar0;
...
int Function_111(int iParam0) //Position: 0x2B6F / 11119
{
	return *iParam0;
}

void Function_112(var uParam0, int iParam1) //Position: 0x2B78 / 11128
{
	*uParam0 = Local_51[iParam12];
	return;
}

void Function_113(int iParam0) //Position: 0x2B87 / 11143
{
	Function_60(iParam0, 4294967286);
	return;
}

bool Function_114(bool bParam0) //Position: 0x2B95 / 11157
{
	return _IS_CLIENT_DATA_VALID_FOR_SLOT(&Local_51, bParam0);
}

void Function_115(var uParam0, bool bParam1) //Position: 0x2BA2 / 11170
{
	if (bParam1)
	{
...
bool Function_116(bool bParam0) //Position: 0x2BBC / 11196
{
	return Function_40(*bParam0, 2);
}

bool Function_117() //Position: 0x2BC9 / 11209
{
...
bool Function_118(int iParam0, var uParam1, int iParam2) //Position: 0x2BE7 / 11239
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_119(int iParam0, bool bParam1) //Position: 0x2C38 / 11320
{
	if (bParam1)
	{
...
bool Function_120(int iParam0) //Position: 0x2C52 / 11346
{
	return Function_40(*iParam0, 1);
}

void Function_121(int iParam0) //Position: 0x2C5F / 11359
{
	bool bVar0;
	int iVar1;
	struct<13> Var2;
...
bool Function_122(int iParam0) //Position: 0x2D5C / 11612
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_123(int iParam0) //Position: 0x2F98 / 12184
{
	return StackVal;
}

bool Function_124(bool bParam0) //Position: 0x2FA6 / 12198
{
	if (!IS_SLOT_VALID(bParam0))
	{
		return 0;
...
void Function_125() //Position: 0x2FBC / 12220
{
	Function_126(8);
...
void Function_126(int iParam0) //Position: 0x2FCE / 12238
{
	Function_43(&Global_79338, iParam0);
	return;
}

bool Function_127() //Position: 0x2FDD / 12253
{
	return Function_39(32768);
}

void Function_128(bool bParam0) //Position: 0x2FEA / 12266
{
...
bool Function_129(int iParam0, int iParam1, bool bParam2) //Position: 0x3015 / 12309
{
	int iVar0;
	bool bVar1;
...
void Function_130() //Position: 0x30C2 / 12482
{
...
void Function_131() //Position: 0x30FD / 12541
{
	Function_33(1025, 1, 0);
	return;
}

void Function_132() //Position: 0x310B / 12555
{
	if (!Function_38())
	{
		Function_37();
...
void Function_133(var uParam0, var uParam1) //Position: 0x3123 / 12579
{
	struct<8> Var0;
	struct<5> Var8;
...
var Function_134() //Position: 0x3148 / 12616
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_135(bool bParam0) //Position: 0x3187 / 12679
{
	return Function_136(0, bParam0);
}

int Function_136(int iParam0, bool bParam1) //Position: 0x3193 / 12691
{
	char* cVar0[64];
...
bool Function_137(bool bParam0) //Position: 0x31FA / 12794
{
	char* cVar0[64];
...
int Function_138(int iParam0) //Position: 0x329B / 12955
{
	return (*&Global_78480 + 132)[iParam0];
}

void Function_139(int iParam0) //Position: 0x32AB / 12971
{
	char* cVar0[32];
	int iVar8;
	bool bVar9;
...
void Function_140(bool bParam0, int iParam1) //Position: 0x36CF / 14031
{
	struct<13> Var0;
...
struct<16> Function_141(var uParam0) //Position: 0x38FC / 14588
{
	struct<4> Var0;
	bool bVar4;
...
int Function_142() //Position: 0x396D / 14701
{
	return Function_226(12);
}

void Function_143(bool bParam0) //Position: 0x3978 / 14712
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
void Function_144(bool bParam0, bool bParam1) //Position: 0x3992 / 14738
{
	bool bVar0;
	bool bVar1;
...
float Function_145(bool bParam0, bool bParam1) //Position: 0x39EF / 14831
{
	vector3 vVar0;
...
var Function_146(int iParam0) //Position: 0x3A0E / 14862
{
...
void Function_147(bool bParam0) //Position: 0x3A6C / 14956
{
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), 0, 0, 0, 0, 0, 0);
	return;
}

bool Function_148() //Position: 0x3A80 / 14976
{
	if (IS_PS3())
	{
		return 1;
...
void Function_149(int iParam0) //Position: 0x3A8F / 14991
{
...
void Function_150(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3B85 / 15237
{
...
void Function_151(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3C49 / 15433
{
...
void Function_152(int iParam0) //Position: 0x3C8A / 15498
{
	struct<5> Var0;
...
void Function_153(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x3CFF / 15615
{
	var uVar0[67];
	int iVar68;
...
void Function_154(bool bParam0) //Position: 0x3E1B / 15899
{
...
void Function_155() //Position: 0x3EA4 / 16036
{
	Function_167();
	Function_166();
	Function_166();
...
void Function_156() //Position: 0x3EF6 / 16118
{
...
void Function_157() //Position: 0x4000 / 16384
{
	float fVar0;
...
void Function_158() //Position: 0x4033 / 16435
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_159() //Position: 0x41C1 / 16833
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_160() //Position: 0x4375 / 17269
{
	Function_161(&Global_28260, 1, 0);
	return;
}

void Function_161(int iParam0, bool bParam1, int iParam2) //Position: 0x4383 / 17283
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_162(int iParam0) //Position: 0x4574 / 17780
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_163(int iParam0, bool bParam1, bool bParam2) //Position: 0x461A / 17946
{
	int iVar0;
...
struct<8> Function_164() //Position: 0x48B5 / 18613
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_165() //Position: 0x493E / 18750
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_166() //Position: 0x49D5 / 18901
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_167() //Position: 0x4A54 / 19028
{
...
int Function_168(int iParam0, bool bParam1, int iParam2) //Position: 0x4A8D / 19085
{
	int iVar0;
	int iVar1;
...
void Function_169(int iParam0) //Position: 0x4C97 / 19607
{
	bool bVar0[67];
	bool bVar68[67];
...
bool Function_170() //Position: 0x4D3E / 19774
{
	return NET_GET_FREE_ROAM_MODE() != 1;
}

void Function_171(var uParam0, var uParam1, bool bParam2) //Position: 0x4D49 / 19785
{
	int iVar0;
...
void Function_172() //Position: 0x4D8E / 19854
{
	int iVar0;
...
void Function_173() //Position: 0x4DB8 / 19896
{
...
void Function_174(bool bParam0) //Position: 0x4E18 / 19992
{
...
void Function_175(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4E32 / 20018
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_179(iParam0), fParam1, 1, 0);
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_179(iParam0), &cVar0, 2, 2, 1);
	}
...
void Function_176(var uParam0, int iParam1) //Position: 0x4EE9 / 20201
{
	bool bVar0;
...
bool Function_177(int iParam0, bool bParam1) //Position: 0x4F0E / 20238
{
	return Function_40(Global_50170[iParam022].f_32, bParam1);
}

struct<16> Function_178(int iParam0) //Position: 0x4F22 / 20258
{
	char* cVar0[16];
...
var Function_179(int iParam0) //Position: 0x4F56 / 20310
{
	return Global_50170[iParam022].f_24;
}

void Function_180(var uParam0, var uParam1, int iParam2) //Position: 0x4F65 / 20325
{
	bool bVar0;
	float fVar1;
...
void Function_181(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x510E / 20750
{
	Function_210(iParam0, 1);
	Global_50170[iParam022].f_8 = 10;
	SET_JOURNAL_ENTRY_PROGRESS(Function_179(iParam0), 1.0f, 0, 0);
...
void Function_182() //Position: 0x5174 / 20852
{
	if (!Function_30())
	{
...
void Function_183(var uParam0, int iParam1) //Position: 0x519D / 20893
{
	if (Global_3381)
	{
		return;
...
void Function_184(bool bParam0) //Position: 0x51DF / 20959
{
...
void Function_185() //Position: 0x5230 / 21040
{
	vector3 vVar0;
	var uVar3;
...
bool Function_186(vector3 vParam0) //Position: 0x52EB / 21227
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_187(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x5303 / 21251
{
	int iVar0;
...
vector3 Function_188() //Position: 0x53EA / 21482
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_189(int iParam0) //Position: 0x53F3 / 21491
{
...
int Function_190(bool bParam0, bool bParam1) //Position: 0x5409 / 21513
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_191(vector3 vParam0, vector3 vParam3) //Position: 0x54D0 / 21712
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_192(var uParam0, int iParam1) //Position: 0x54ED / 21741
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_193(int iParam0) //Position: 0x5D12 / 23826
{
	var uVar0;
...
void Function_194(bool bParam0, int iParam1) //Position: 0x5D4D / 23885
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_195() //Position: 0x5D5A / 23898
{
...
bool Function_196(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5D75 / 23925
{
	uParam0 = uParam0;
...
void Function_197(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5E19 / 24089
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<16> Function_198(int iParam0) //Position: 0x5E8B / 24203
{
	char* cVar0[16];
...
struct<16> Function_199(int iParam0) //Position: 0x5EAC / 24236
{
	char* cVar0[16];
...
struct<16> Function_200(int iParam0) //Position: 0x5ECD / 24269
{
	char* cVar0[16];
...
var Function_201() //Position: 0x5EEE / 24302
{
	return "CQueue_Count";
}

var Function_202() //Position: 0x5F03 / 24323
{
...
void Function_203(int iParam0) //Position: 0x5F32 / 24370
{
	Function_204(iParam0, 1);
	return;
}

void Function_204(int iParam0, bool bParam1) //Position: 0x5F3E / 24382
{
	int iVar0;
...
int Function_205(bool bParam0) //Position: 0x5F94 / 24468
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_206(int iParam0, int iParam1) //Position: 0x5FA0 / 24480
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	if (!bVar0)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_179(iParam0), &Var7, 0, 2, 0);
		PREPEND_JOURNAL_ENTRY(Function_179(iParam0), 1);
		SET_JOURNAL_ENTRY_PROGRESS(Function_179(iParam0), 1.0f, 0, 0);
	}
	return;
}

struct<16> Function_207(int iParam0) //Position: 0x6022 / 24610
{
	char* cVar0[16];
...
struct<24> Function_208(int iParam0) //Position: 0x6042 / 24642
{
	char* cVar0[24];
...
bool Function_209(int iParam0) //Position: 0x6073 / 24691
{
	switch (iParam0)
	{
		case 0x0000003A:
...
void Function_210(bool bParam0, bool bParam1) //Position: 0x61F1 / 25073
{
	bool bVar0;
	bool bVar1;
	char* cVar2[16];
...
var Function_211() //Position: 0x633D / 25405
{
	bool bVar0;
...
void Function_212(var uParam0, bool bParam1, bool bParam2) //Position: 0x638A / 25482
{
...
void Function_213(int iParam0, var uParam1, int iParam2, var uParam3, int iParam4, float fParam5, bool bParam6, int iParam7, bool bParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x63A2 / 25506
{
	struct<4> Var0;
...
void Function_214(int iParam0, int iParam1) //Position: 0x6418 / 25624
{
	Function_34(&Global_50170[iParam022] + 32, iParam1);
	return;
}

void Function_215(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x642C / 25644
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	if ((bParam3 && Function_177(iParam0, 4)) || !bParam3)
	{
		if (!bVar0)
		{
			PREPEND_JOURNAL_ENTRY(Function_179(iParam0), 0);
			Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_208(iParam0) };
			Var7 = { StackVal, StackVal, StackVal, Function_178(iParam0) };
			UI_SET_STRING(&Var1, UI_GET_STRING(&Var7));
...
void Function_216(int iParam0, int iParam1) //Position: 0x64E9 / 25833
{
	Function_35(&Global_50170[iParam022] + 32, iParam1);
	return;
}

struct<24> Function_217(int iParam0) //Position: 0x64FD / 25853
{
	char* cVar0[24];
...
struct<24> Function_218(int iParam0) //Position: 0x652B / 25899
{
	char* cVar0[24];
...
bool Function_219() //Position: 0x655B / 25947
{
	return "MP_Unstoppable_Icon_128";
}

float Function_220(int iParam0) //Position: 0x657B / 25979
{
	return Global_50170[iParam022].f_12;
}

void Function_221(int iParam0, int iParam1) //Position: 0x658A / 25994
{
	if (iParam0 > 40)
	{
		return;
...
void Function_222(int iParam0, int iParam1) //Position: 0x65AF / 26031
{
...
void Function_223(int iParam0) //Position: 0x65D8 / 26072
{
	struct<13> Var0;
...
void Function_224(var uParam0, int iParam1, int iParam2) //Position: 0x6667 / 26215
{
	if (*uParam0 > iParam2)
	{
		*uParam0 = iParam2;
...
struct<20> Function_225(int iParam0) //Position: 0x668C / 26252
{
	struct<5> Var0;
...
int Function_226(int iParam0) //Position: 0x6948 / 26952
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_227() //Position: 0x6961 / 26977
{
	return Function_138(0);
}

void Function_228(int iParam0) //Position: 0x696B / 26987
{
	if (Function_67(iParam0))
	{
		if (!Function_66(iParam0))
...
void Function_229(int iParam0, int iParam1) //Position: 0x6A33 / 27187
{
	if (iParam0 > 40)
	{
		return;
...
int Function_230(bool bParam0) //Position: 0x6A4D / 27213
{
...
void Function_231() //Position: 0x6A8E / 27278
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			vLocal_103.f_8 = 6;
			Function_233(&iLocal_158);
			break;
		
		case 0x00000006:
			if (Function_232(bLocal_147) < 0)
			{
				if (Function_108(11, 1, 0x3f800000))
				{
					vLocal_103.f_8 = 106;
				}
				if (Function_297(&bLocal_155) < 4.0f)
				{
					Function_299(&bLocal_155);
				}
			}
			else
			{
				...
				if (!iLocal_169)
				{
					Function_300("bobcat_MP_killRemainder", 7.5f, 1, 2, 1, 0, 0, 0);
					iLocal_169 = 1;
				}
			}
			break;
...
int Function_232(bool bParam0) //Position: 0x6B45 / 27461
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_233(int iParam0) //Position: 0x6B95 / 27541
{
...
void Function_234(int iParam0, float fParam1) //Position: 0x6BAA / 27562
{
...
bool Function_235(int iParam0) //Position: 0x6BCB / 27595
{
	return Function_40(*iParam0, 1);
}

void Function_236(var uParam0, bool bParam1) //Position: 0x6BD8 / 27608
{
	struct<9> Var0;
...
void Function_237() //Position: 0x6C0F / 27663
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				...
				Function_238(bLocal_147, iLocal_19, 0, 0);
				Function_238(bLocal_148, iLocal_19, 0, 0);
			}
			vLocal_103.f_8 = 6;
			Function_233(&iLocal_158);
			break;
		...
		case 0x00000006:
			...
			else
			{
				...
				if (!iLocal_171)
				{
					if (IS_ACTOR_ALIVE(bLocal_149))
					{
						Function_300("bobcat_MP_obj02", 7.5f, 1, 2, 1, 0, 0, 0);
						iLocal_171 = 1;
					}
				}
			}
...
void Function_238(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x6CED / 27885
{
	bool bVar0;
	bool bVar1;
...
void Function_239() //Position: 0x6D6F / 28015
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	vVar1 = { -1293.33f, 79.12852f, 3626.381f };
	fVar4 = 20.0f;
	fVar5 = 70.0f;
	switch (iVar0)
	{
		case 0x00000003:
			Function_240(StackVal, StackVal, vVar1, 1113, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1112, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1115, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1113, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1112, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1115, 65813, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1113, 65813, fVar4, fVar5);
...
var Function_240(vector3 vParam0, int iParam3, int iParam4, float fParam5, float fParam6) //Position: 0x6F87 / 28551
{
	var uVar0;
	bool bVar4;
	...
	if (IS_ACTOR_VALID(bVar4))
	{
		...
		if (iParam4 == 65813)
		{
			SQUAD_JOIN(bVar4, bLocal_147);
		}
		else if (iParam4 == 76186)
		{
			SQUAD_JOIN(bVar4, bLocal_148);
		}
		SET_ACTOR_VOLUME_PARAMETERS(bVar4, 4, 1);
		ADD_ACTOR_STAY_WITHIN_VOLUME(StackVal, bVar4);
		NET_ACTOR_SET_SCRIPT_INT(bVar4, iParam4);
		Function_241(bVar4, 10, "COMMON_NULL");
	}
	return bVar4;
}

int Function_241(bool bParam0, bool bParam1, bool bParam2) //Position: 0x7011 / 28689
{
...
void Function_242(bool bParam0) //Position: 0x7057 / 28759
{
	if (IS_ACTOR_VALID(bParam0))
	{
		SET_ACTOR_MAX_HEALTH(bParam0, 65.0f);
		SET_ACTOR_HEALTH(bParam0, 65.0f);
		TASK_CLEAR(bParam0);
	}
	return;
}

var Function_243(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x707E / 28798
{
	var uVar0;
	vector3 vVar3;
	var uVar6;
...
void Function_244(char* cParam0, bool bParam1) //Position: 0x711D / 28957
{
...
var Function_245() //Position: 0x7157 / 29015
{
	return cLocal_99;
}

var Function_246() //Position: 0x715F / 29023
{
	int iVar0;
	int iVar1;
...
void Function_247() //Position: 0x718E / 29070
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	
	vVar0 = { -1306.161f, 77.732f, 3622.356f };
	fVar3 = 30.0f;
	fVar4 = 65.0f;
	bLocal_149 = Function_240(StackVal, StackVal, vVar0, 1114, 76186, fVar3, fVar4);
	if (IS_ACTOR_VALID(bLocal_149))
	{
		SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bLocal_149, 392, 0, 2, 0), "bobcat_MP_BossName");
		SET_ACTOR_MAX_HEALTH(bLocal_149, (GET_ACTOR_MAX_HEALTH(bLocal_149) * 2.5f));
	}
	return;
}

void Function_248() //Position: 0x7204 / 29188
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			if (!iLocal_170)
			{
				Function_300("bobcat_MP_obj01", 7.5f, 1, 2, 1, 0, 0, 0);
				iLocal_170 = 1;
			}
			vLocal_103.f_8 = 6;
			break;
...
void Function_249() //Position: 0x72C9 / 29385
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_250() //Position: 0x738E / 29582
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			Function_251(&bLocal_147, iLocal_165);
			Function_300("bobcat_MP_obj01", 7.5f, 1, 2, 1, 0, 0, 0);
			iLocal_170 = 1;
			vLocal_103.f_8 = 6;
			break;
...
void Function_251(var uParam0, int iParam1) //Position: 0x7454 / 29780
{
	bool bVar0;
	bool bVar1;
...
void Function_252() //Position: 0x74F0 / 29936
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_253(var uParam0) //Position: 0x758F / 30095
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_256(int iParam0) //Position: 0x770F / 30479
{
...
void Function_257(int iParam0, bool bParam1) //Position: 0x77A4 / 30628
{
...
void Function_258(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x77EC / 30700
{
	bool bVar0;
...
void Function_259(int iParam0) //Position: 0x78FF / 30975
{
	Function_260(&Global_28842, iParam0);
	return;
}

void Function_260(var uParam0, var uParam1) //Position: 0x790D / 30989
{
...
void Function_261() //Position: 0x7928 / 31016
{
...
void Function_262(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x7944 / 31044
{
...
void Function_263() //Position: 0x7A28 / 31272
{
	int iVar0;
...
int Function_264(int iParam0) //Position: 0x7A76 / 31350
{
...
bool Function_265(int iParam0) //Position: 0x7A8E / 31374
{
...
void Function_266(bool bParam0, bool bParam1) //Position: 0x7AA3 / 31395
{
	char[] cVar0[4];
...
void Function_267(var uParam0, var uParam1) //Position: 0x7B9D / 31645
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &uParam1);
	return;
}

void Function_268() //Position: 0x7BAA / 31658
{
	bLocal_147 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_130, "AnimalSquad"));
	bLocal_148 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_130, "nBossSquad"));
	SQUAD_GOAL_ADD_GENERAL_TASK(bLocal_147, 0, 1, 4294967295);
	TASK_ANIMAL_PATROL(StackVal, 0);
	SQUAD_GOAL_ADD_GENERAL_TASK(bLocal_148, 0, 1, 4294967295);
	TASK_ANIMAL_PATROL(StackVal, 0);
	SQUAD_GOAL_ADD_SHARE_PERCEPTION(bLocal_147, 0);
	return;
}

void Function_269() //Position: 0x7C19 / 31769
{
	var uVar0;
	bool bVar1;
	
	uVar0 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_130, "SpawnVol_0_set");
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_0", 2, -1318.269f, 79.6798f, 3648f, 0.0f, 172.493f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_1", 2, -1276.0f, 74.33723f, 3644.814f, 0.0f, 224.067f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_2", 2, -1296.0f, 77.30194f, 3648f, 0.0f, 210.562f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_3", 2, -1273.782f, 75.66293f, 3617.782f, 0.0f, 246.472f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_4", 2, -1262.839f, 73.28625f, 3626.839f, 0.0f, 246.0f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_5", 2, -1262.307f, 75.29407f, 3606.306f, 0.0f, 261.018f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_6", 2, -1278.867f, 76.29799f, 3594.867f, 0.0f, 278.748f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_7", 2, -1290.234f, 78.44055f, 3585.765f, 0.0f, 313.148f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_8", 2, -1334.115f, 77.41796f, 3633.884f, 0.0f, 144.47f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_9", 2, -1317.054f, 81.78415f, 3575.421f, 0.0f, 370.845f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_10", 2, -1281.585f, 75.16035f, 3629.431f, 0.0f, 231.655f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_11", 2, -1268.0f, 75.56527f, 3589.08f, 0.0f, 283.157f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bLocal_150 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "mpaa_warning_vol", 3, -1291.597f, 77.302f, 3623.148f, 0.0f, 48.11329f, 0.0f, 82.41593f, 50.0f, 68.01967f);
	bLocal_151 = Function_270(bLocal_150, 330, 0.0f);
	SET_BLIP_VISIBLE(bLocal_151, false);
	return;
}

var Function_270(bool bParam0, int iParam1, float fParam2) //Position: 0x7F7E / 32638
{
	bool bVar0;
...
void Function_271(var uParam0, bool bParam1) //Position: 0x7FCB / 32715
{
...
void Function_272(var uParam0) //Position: 0x803E / 32830
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_273() //Position: 0x804C / 32844
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_274(int iParam0) //Position: 0x8065 / 32869
{
	int iVar0;
	int iVar1;
...
void Function_275() //Position: 0x83E0 / 33760
{
	if (!Function_276(128))
	{
		return;
...
bool Function_276(int iParam0) //Position: 0x8420 / 33824
{
	int iVar0;
...
bool Function_277() //Position: 0x843C / 33852
{
	int iVar0;
...
void Function_278(var uParam0, int iParam1) //Position: 0x8467 / 33895
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_279() //Position: 0x8478 / 33912
{
	if (!Function_276(128))
	{
		return;
...
void Function_280() //Position: 0x84BA / 33978
{
	Function_282(&uLocal_131, "mp_action_areas", 10, 0);
	Function_281(&uLocal_131, 1112, 10, 0);
	Function_281(&uLocal_131, 1113, 10, 0);
	Function_281(&uLocal_131, 1114, 10, 0);
	Function_281(&uLocal_131, 1115, 10, 0);
	return;
}

var Function_281(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x850B / 34059
{
	int iVar0;
...
var Function_282(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x85DB / 34267
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_283(uParam0, uVar1, iParam2);
	if (bParam3)
	{
		Function_278(uParam0[iVar03], 8);
	}
...
var Function_283(var uParam0, int iParam1, int iParam2) //Position: 0x8613 / 34323
{
	int iVar0;
...
bool Function_284(int iParam0) //Position: 0x86D7 / 34519
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
void Function_285(var uParam0, float fParam1) //Position: 0x8783 / 34691
{
	Function_286(uParam0, -fParam1);
	return;
}

void Function_286(var uParam0, float fParam1) //Position: 0x8791 / 34705
{
	Function_64();
...
void Function_287(var uParam0, int iParam1) //Position: 0x87A5 / 34725
{
	uParam0->f_4 = iParam1;
...
bool Function_288(int iParam0) //Position: 0x87C2 / 34754
{
...
void Function_289(int iParam0) //Position: 0x87D8 / 34776
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_290(int iParam0) //Position: 0x87EC / 34796
{
	if (Function_67(iParam0))
	{
...
float Function_291(float fParam0) //Position: 0x8807 / 34823
{
	return -Function_63(fParam0);
}

bool Function_292() //Position: 0x8813 / 34835
{
	return iLocal_20;
}

void Function_293(int iParam0, var uParam1) //Position: 0x881B / 34843
{
	if (!Function_67(iParam0))
	{
...
void Function_294() //Position: 0x8831 / 34865
{
	struct<13> Var0;
...
void Function_295(bool bParam0) //Position: 0x885D / 34909
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 34991);
	return;
}

void Function_296(var uParam0) //Position: 0x88AF / 34991
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
float Function_297(bool bParam0) //Position: 0x89B2 / 35250
{
...
bool Function_298(int iParam0) //Position: 0x8A7A / 35450
{
	return Function_40(*iParam0, 2);
}

void Function_299(bool bParam0) //Position: 0x8A87 / 35463
{
	Function_234(bParam0, 0.0f);
	return;
}

void Function_300(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x8A93 / 35475
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_301(int iParam0) //Position: 0x8B18 / 35608
{
	char* cVar0[16];
...
bool Function_302() //Position: 0x8B57 / 35671
{
	return (HUD_IS_SHOWING_OBJECTIVE() || HUD_IS_SHOWING_SMALL_TEXT());
}

void Function_303(var uParam0, int iParam1) //Position: 0x8B64 / 35684
{
...
bool Function_304(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x8B7A / 35706
{
	if (!Function_346())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_317(39604, 38952);
			break;
		
		case 0x00000002:
			Function_317(36329, 35905);
			break;
...
int Function_305(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x8C41 / 35905
{
	bool bVar0;
	bool bVar1;
...
bool Function_306(bool bParam0, bool bParam1, int iParam2) //Position: 0x8CE4 / 36068
{
	var uVar0;
...
int Function_307(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x8CF5 / 36085
{
	char* cVar0[32];
...
int Function_308(int iParam0, bool bParam1) //Position: 0x8D5A / 36186
{
	char* cVar0[64];
...
void Function_309(bool bParam0, int iParam1, char* cParam2) //Position: 0x8DC8 / 36296
{
	if (bParam0)
	{
		if (Function_127())
...
int Function_310() //Position: 0x8DE9 / 36329
{
	if (!Function_311(1))
	{
		return 0;
...
bool Function_311(bool bParam0) //Position: 0x8EA5 / 36517
{
	char* cVar0[64];
...
void Function_312(bool bParam0) //Position: 0x8F26 / 36646
{
...
var Function_313(int iParam0, bool bParam1) //Position: 0x8FAF / 36783
{
	int iVar0;
...
struct<64> Function_314(var uParam0) //Position: 0x8FCF / 36815
{
...
struct<64> Function_315(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x8FE3 / 36835
{
	char* cVar0[64];
...
int Function_316(bool bParam0, bool bParam1) //Position: 0x9028 / 36904
{
...
void Function_317(int iParam0, int iParam1) //Position: 0x905C / 36956
{
	Function_318(iParam0, iParam1, 38945);
	return;
}

void Function_318(var uParam0, var uParam1, int iParam2) //Position: 0x906D / 36973
{
...
void Function_319() //Position: 0x9206 / 37382
{
	if (Function_39(4194304))
	{
...
void Function_320(var uParam0, var uParam1, int iParam2) //Position: 0x930F / 37647
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_321(bool bParam0, int iParam1, bool bParam2) //Position: 0x9487 / 38023
{
	char* cVar0[64];
	int iVar16;
...
var Function_322(int iParam0) //Position: 0x9508 / 38152
{
	switch (iParam0)
	{
		case 0x00000002:
...
int Function_323() //Position: 0x9821 / 38945
{
	return 1;
}

int Function_324(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x9828 / 38952
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_309(bParam1, iParam2, cParam3);
...
var Function_325(int iParam0) //Position: 0x99E9 / 39401
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_326(int iParam0) //Position: 0x99FC / 39420
{
...
float Function_327(int iParam0, bool bParam1) //Position: 0x9A1C / 39452
{
	char* cVar0[64];
...
int Function_328(bool bParam0) //Position: 0x9A85 / 39557
{
	if (!Function_137(bParam0))
	{
		return 4294967295;
...
var Function_329() //Position: 0x9AAA / 39594
{
	return Global_78480;
}

int Function_330() //Position: 0x9AB4 / 39604
{
	bool bVar0;
	int iVar1;
...
void Function_331() //Position: 0x9BD7 / 39895
{
	if (Function_39(4096))
	{
...
void Function_332(int iParam0) //Position: 0x9C14 / 39956
{
	int iVar0;
	int iVar1;
...
void Function_333(int iParam0) //Position: 0x9C8D / 40077
{
	struct<13> Var0;
...
void Function_334(int iParam0) //Position: 0x9CB8 / 40120
{
	int iVar0;
...
void Function_335(var uParam0, bool bParam1) //Position: 0x9CFF / 40191
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_336(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x9E4A / 40522
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_337(bool bParam0) //Position: 0x9F2C / 40748
{
	bool bVar0;
...
void Function_338() //Position: 0x9F86 / 40838
{
	Function_339(4);
	return;
}

void Function_339(int iParam0) //Position: 0x9F90 / 40848
{
	var uVar0;
	var uVar1;
...
void Function_340(var uParam0) //Position: 0x9FC2 / 40898
{
	var uVar0;
...
void Function_341() //Position: 0x9FD1 / 40913
{
	bool bVar0;
	...
	if (!iLocal_22)
	{
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (IS_ACTORSET_VALID(iLocal_19))
			{
				if (Function_343(bVar0, iLocal_19, 1, 0, 0, -1.0f))
				{
					Function_342();
					iLocal_22 = 1;
				}
...
void Function_342() //Position: 0xA006 / 40966
{
	int iVar0;
...
bool Function_343(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0xA01F / 40991
{
	bool bVar0;
	...
	if (Function_345(iParam1, 0, 0, 0, 0, 0) < 0)
	{
		return 0;
	}
...
bool Function_344(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0xA088 / 41096
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_345(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xA175 / 41333
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool Function_346() //Position: 0xA223 / 41507
{
	int iVar0;
...
void Function_347(bool bParam0) //Position: 0xA246 / 41542
{
	bool bVar0;
	
	bVar0 = NET_ACTOR_GET_SCRIPT_INT(bParam0);
	if (bVar0 != 65813 || bVar0 != 76186)
	{
		TASK_CLEAR(bParam0);
		...
		if (bVar0 == 76186)
		{
			SQUAD_JOIN(bParam0, bLocal_148);
			Function_241(bParam0, 100, "COMMON_NULL");
			if (!IS_BLIP_VALID(GET_BLIP_ON_ACTOR(bParam0)))
			{
				SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bParam0, 392, 0.0f, 2, 0), "bobcat_MP_bossName");
			}
			if (bLocal_149 == "")
			{
				bLocal_149 = bParam0;
		...
		{
			SQUAD_JOIN(bParam0, bLocal_147);
			Function_241(bParam0, 10, "COMMON_NULL");
		}
		if (!Function_235(&iLocal_161))
		{
			Function_233(&iLocal_161);
		}
	}
	return;
}

bool Function_348(var uParam0, int iParam1) //Position: 0xA335 / 41781
{
	if (!Function_28())
	{
		return 0;
...
bool Function_349(int iParam0) //Position: 0xA355 / 41813
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 42130);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 42091);
	return 1;
}

void Function_350(var uParam0) //Position: 0xA46B / 42091
{
	int iVar0;
...
void Function_351(var uParam0) //Position: 0xA492 / 42130
{
	struct<13> Var0;
...
void Function_352(var uParam0) //Position: 0xA509 / 42249
{
	struct<13> Var0;
...
void Function_353(var uParam0, int iParam1) //Position: 0xA556 / 42326
{
	bool bVar0;
	int iVar1;
...
void Function_354(int iParam0) //Position: 0xA5AB / 42411
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_355(int iParam0) //Position: 0xA5BD / 42429
{
...
void Function_356() //Position: 0xA681 / 42625
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_357(bool bParam0, bool bParam1) //Position: 0xA69A / 42650
{
	var uVar0;
...
void Function_358() //Position: 0xA6E6 / 42726
{
...
void Function_359() //Position: 0xA705 / 42757
{
	Function_360(&Global_78480 + 220);
	return;
}

void Function_360(int iParam0) //Position: 0xA714 / 42772
{
	int iVar0;
...
void Function_361(int iParam0) //Position: 0xA735 / 42805
{
	int iVar0;
...
void Function_362(int iParam0) //Position: 0xA759 / 42841
{
	int iVar0;
...
void Function_363(var uParam0, int iParam1) //Position: 0xA77D / 42877
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_364(var uParam0) //Position: 0xA789 / 42889
{
	uParam0 = uParam0;
	return;
}

void Function_365(int iParam0) //Position: 0xA793 / 42899
{
	if (!Function_67(iParam0))
	{
...
bool Function_366(var uParam0, bool bParam1) //Position: 0xA7A8 / 42920
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_367(char* cParam0) //Position: 0xA85B / 43099
{
	bool bVar0;
