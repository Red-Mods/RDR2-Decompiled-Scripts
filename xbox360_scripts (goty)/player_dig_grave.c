	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_65(iParam0, bVar8, &iLocal_84, &cLocal_83);
...
void Function_18(bool bParam0, int iParam1) //Position: 0x1B9A / 7066
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	if (STRING_CONTAINS_STRING(bVar9, "Coot"))
	{
		...
		else if (DECOR_CHECK_EXIST(bVar10, "Grave_Weapon"))
		{
			...
			GIVE_WEAPON_TO_ACTOR(bParam0, DECOR_GET_INT(bVar10, "Grave_Weapon"), 0, 1, 1);
		}
...
void Function_19(int iParam0) //Position: 0x1DEB / 7659
{
	int iVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E11 / 7697
{
...
void Function_21(var uParam0, int iParam1) //Position: 0x1F3F / 7999
{
	int iVar0;
...
bool Function_22(var uParam0, int iParam1) //Position: 0x1F59 / 8025
{
	int iVar0;
...
int Function_23(bool bParam0, bool bParam1, int iParam2) //Position: 0x1F76 / 8054
{
...
var Function_24() //Position: 0x1FC1 / 8129
{
...
var Function_25(bool bParam0) //Position: 0x1FD6 / 8150
{
	bool bVar0;
...
int Function_26(bool bParam0, bool bParam1) //Position: 0x20C7 / 8391
{
	bool bVar0;
...
int Function_27(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2192 / 8594
{
	int iVar0;
	int iVar1;
...
void Function_28(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x23B2 / 9138
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_29(int iParam0) //Position: 0x29DF / 10719
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_30(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x29F0 / 10736
{
	char* cVar0[32];
...
struct<32> Function_31(char* cParam0, bool bParam1) //Position: 0x2AE5 / 10981
{
	char* cVar0[32];
...
void Function_32(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2AFE / 11006
{
	float fVar0;
...
var Function_33(int iParam0, int iParam1) //Position: 0x2B63 / 11107
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_34(int iParam0, bool bParam1) //Position: 0x2B75 / 11125
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_35(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2B87 / 11143
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_36(int iParam0) //Position: 0x2CB7 / 11447
{
	return Global_35278[iParam020].f_48;
}

float Function_37(int iParam0) //Position: 0x2CC6 / 11462
{
	if (!iParam0 != 4294967295)
	{
...
var Function_38(int iParam0) //Position: 0x2CFF / 11519
{
	if (iParam0 == 4294967295)
	{
...
void Function_39(int iParam0) //Position: 0x2D3C / 11580
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_40(int iParam0, float fParam1, bool bParam2) //Position: 0x2ED6 / 11990
{
	int iVar0;
	int iVar1;
...
int Function_41(int iParam0) //Position: 0x311A / 12570
{
	if (iParam0 == 4294967295)
	{
...
var Function_42(int iParam0) //Position: 0x315B / 12635
{
...
bool Function_43(int iParam0) //Position: 0x3609 / 13833
{
...
var Function_44() //Position: 0x361F / 13855
{
	int iVar0;
...
vector3 Function_45(bool bParam0) //Position: 0x3627 / 13863
{
	vector3 vVar0;
...
bool Function_46() //Position: 0x364E / 13902
{
	bool bVar0;
...
void Function_47(var uParam0, bool bParam1) //Position: 0x367F / 13951
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_48(var uParam0, bool bParam1) //Position: 0x36F3 / 14067
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_49(var uParam0, int iParam1) //Position: 0x3765 / 14181
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_50(bool bParam0) //Position: 0x3773 / 14195
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_51() //Position: 0x3789 / 14217
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_52(bool bParam0) //Position: 0x3796 / 14230
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_53(var uParam0, int iParam1) //Position: 0x37B6 / 14262
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_54(bool bParam0) //Position: 0x37C5 / 14277
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_55() //Position: 0x37E4 / 14308
{
	return;
}

void Function_56(bool bParam0, int iParam1) //Position: 0x37EA / 14314
{
	bool bVar0;
...
bool Function_57(int iParam0) //Position: 0x3819 / 14361
{
	iParam0 = iParam0;
	return 1;
}

bool Function_58(bool bParam0) //Position: 0x3824 / 14372
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_59(bool bParam0, int iParam1) //Position: 0x383E / 14398
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_60(bool bParam0) //Position: 0x385C / 14428
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_61(bool bParam0) //Position: 0x387B / 14459
{
	int iVar0;
	int iVar1;
...
bool Function_62(bool bParam0) //Position: 0x38AE / 14510
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_63(bool bParam0) //Position: 0x38CD / 14541
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_64(var uParam0, int iParam1) //Position: 0x38E7 / 14567
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_65(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x38FA / 14586
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_72(uParam0->f_12, &bVar0);
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x3BE2 / 15330
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_67() //Position: 0x3BFF / 15359
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_68(bool bParam0, int iParam1) //Position: 0x3C0E / 15374
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_69(bool bParam0, int iParam1) //Position: 0x3C30 / 15408
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_70(bool bParam0) //Position: 0x3C54 / 15444
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_71(bool bParam0, int iParam1) //Position: 0x3C71 / 15473
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_72(bool bParam0, int iParam1) //Position: 0x3C91 / 15505
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_73(bool bParam0, bool bParam1) //Position: 0x3CB1 / 15537
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3D5F / 15711
{
	bool bVar0;
...
void Function_75(int iParam0, float fParam1) //Position: 0x3DCF / 15823
{
	if (!Function_14(iParam0))
	{
...
void Function_76(int iParam0, float fParam1) //Position: 0x3DE5 / 15845
{
...
var Function_77(bool bParam0) //Position: 0x3E06 / 15878
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_78(int iParam0) //Position: 0x3E26 / 15910
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_79(var uParam0) //Position: 0x3E3A / 15930
{
	uParam0 = uParam0;
	return;
}

int Function_80() //Position: 0x3E44 / 15940
{
	return 1;
}

void Function_81(var uParam0, int iParam1) //Position: 0x3E4B / 15947
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_82(bool bParam0, var uParam1, int iParam2) //Position: 0x3E5A / 15962
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x3E99 / 16025
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_84(bool bParam0) //Position: 0x3EC4 / 16068
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_85(bool bParam0) //Position: 0x3ECF / 16079
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_86(bool bParam0) //Position: 0x3FC5 / 16325
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_87(bool bParam0) //Position: 0x3FE7 / 16359
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_88(int iParam0) //Position: 0x4020 / 16416
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(int iParam0) //Position: 0x417E / 16766
{
	iParam0 = iParam0;
	return;
}

bool Function_90(bool bParam0) //Position: 0x4188 / 16776
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_91(int iParam0) //Position: 0x41A6 / 16806
{
	if (!Function_14(iParam0))
	{
...
bool Function_92(bool bParam0, bool bParam1) //Position: 0x41BB / 16827
{
	vector3 vVar0;
	float fVar3;
	vector3 vVar4;
...
bool Function_93(bool bParam0, int iParam1) //Position: 0x41EE / 16878
{
...
int Function_94(bool bParam0) //Position: 0x4219 / 16921
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x431E / 17182
{
	return (uParam0 && iParam1) == 0;
}

void Function_96(int iParam0) //Position: 0x432B / 17195
{
	if (Function_95(iParam0->f_40, 16))
	{
...
void Function_97(int iParam0, bool bParam1) //Position: 0x439E / 17310
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_98() //Position: 0x489C / 18588
{
	return;
}

bool Function_99(bool bParam0) //Position: 0x48A2 / 18594
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_100(var uParam0, int iParam1) //Position: 0x48BF / 18623
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_101(int iParam0) //Position: 0x48F7 / 18679
{
	iParam0 = iParam0;
	return;
}

bool Function_102(bool bParam0) //Position: 0x4901 / 18689
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_103(var uParam0, int iParam1) //Position: 0x4922 / 18722
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_104(bool bParam0, bool bParam1) //Position: 0x4930 / 18736
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_105(bool bParam0, bool bParam1) //Position: 0x4A38 / 19000
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_106(int iParam0) //Position: 0x4A4E / 19022
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_107(var uParam0, int iParam1) //Position: 0x4D04 / 19716
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
int Function_108(int iParam0) //Position: 0x4D56 / 19798
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x50D1 / 20689
{
	if (!Function_110(128))
	{
		return;
...
bool Function_110(int iParam0) //Position: 0x5111 / 20753
{
	int iVar0;
...
bool Function_111() //Position: 0x512D / 20781
{
	int iVar0;
...
void Function_112(var uParam0, int iParam1) //Position: 0x5158 / 20824
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_113() //Position: 0x5169 / 20841
{
	if (!Function_110(128))
	{
		return;
...
var Function_114(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x51AB / 20907
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_115(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x51E3 / 20963
{
	int iVar0;
...
bool Function_117(bool bParam0) //Position: 0x52C0 / 21184
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_118(bool bParam0, int iParam1) //Position: 0x52DA / 21210
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_119(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_119(var uParam0, int iParam1) //Position: 0x5312 / 21266
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_120(int iParam0, int iParam1) //Position: 0x5329 / 21289
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_121(bool bParam0) //Position: 0x55F2 / 22002
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_122(bool bParam0, bool bParam1) //Position: 0x560F / 22031
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_123(int iParam0) //Position: 0x56AB / 22187
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_124(bool bParam0, int iParam1) //Position: 0x56CA / 22218
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (!IS_ACTOR_PLAYER(bParam0))
...
bool Function_125(int iParam0) //Position: 0x5709 / 22281
{
...
void Function_126(int iParam0) //Position: 0x5725 / 22309
{
	iParam0 = iParam0;
	return;
}

void Function_127(bool bParam0, int iParam1) //Position: 0x572F / 22319
{
	int iVar0;
	int iVar1;
...
void Function_128(int iParam0, int iParam1) //Position: 0x5791 / 22417
{
...
void Function_129(int iParam0) //Position: 0x57A5 / 22437
{
	iParam0 = iParam0;
	return;
}

void Function_130(int iParam0) //Position: 0x57AF / 22447
{
