...
void main() //Position: 0x0 / 0
{
	...
	iLocal_74 = 0;
	Function_94(uScriptParam_0, &iLocal_74);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_87(&(Local_1[iVar312]), &bVar4))
						{
							Function_85(GRINGO_GET_REQUESTING_ACTOR(), Local_1[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_80("eGRINGO_EndUse: Stop use by request", Local_1[iVar312].f_16);
							Function_79(Local_1[iVar312].f_16, 1);
							...
							{
								Function_72(&(Local_1[iVar312]), 0);
							}
							else if (Local_1[iVar312].f_44 < 8)
							{
								Function_71(&(Local_1[iVar312]));
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	if (!Function_70(iParam0->f_40, 2))
	{
		Function_79(iParam0->f_16, 0);
	}
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_81))
								{
									...
									{
										bLocal_81 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_81 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	bVar12 = Function_69(iParam0->f_12);
	if (!(IS_ACTOR_VALID(iParam0->f_16) && IS_ACTOR_ALIVE(iParam0->f_16)))
	{
		Function_80("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_80("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_80("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		case 0x00000002:
			...
			{
				if (Function_68(iParam0->f_12, &fVar24))
				{
		...
		case 0x00000001:
			...
			if (((!Global_63096 && IS_ACTOR_LOCAL_PLAYER(iParam0->f_16)) && !Function_70(iParam0->f_40, 1)) && !DECOR_CHECK_EXIST(iParam0->f_16, "NoGringoCamera"))
			{
			...
			if (Function_70(iParam0->f_40, 1))
			{
				Function_56(iParam0->f_12, &vVar3, &uVar6);
				if (!Function_70(iParam0->f_40, 16))
				{
				...
				if (!Function_70(iParam0->f_40, 1024))
				{
			...
			if (iParam0->f_44 != 3 && !Function_70(iParam0->f_40, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(iParam0->f_12))
				{
					Function_2("SUSPEND MOVER", iParam0->f_16);
		...
		case 0x00000003:
			if (Function_70(iParam0->f_40, 32))
			{
				bLocal_80 = true;
		...
		case 0x00000004:
			...
			if (iVar32 == 0)
			{
				bVar33 = Function_70(iParam0->f_40, 1);
			}
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_79, &cLocal_78);
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_70(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x2593 / 9619
{
	...
	uVar4 = Function_67(bParam1);
	uVar5 = Function_57(bParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vVar0, uVar4, 0.2f, 1, bVar3, uVar5, 0, 0);
}

bool Function_67(bool bParam0) //Position: 0x25D7 / 9687
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

bool Function_68(bool bParam0, int iParam1) //Position: 0x25FA / 9722
{
...
int Function_69(bool bParam0) //Position: 0x2625 / 9765
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_70(var uParam0, int iParam1) //Position: 0x272A / 10026
{
	return (uParam0 && iParam1) == 0;
}

void Function_71(int iParam0) //Position: 0x2737 / 10039
{
	if (Function_70(iParam0->f_40, 16))
	{
...
void Function_72(int iParam0, bool bParam1) //Position: 0x27AA / 10154
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(iParam0->f_16) && Function_70(iParam0->f_40, 32)) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
	{
	...
	Function_78(iParam0->f_16, iParam0->f_12);
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		GRINGO_REPORT_USE_FINISHED(iParam0->f_16, Function_70(iParam0->f_40, 64));
		Function_17(iParam0->f_16, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_70(iParam0->f_40, 128) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
			{
			...
			if (Function_77(iParam0->f_12) && Function_70(iParam0->f_40, 512))
			{
	...
	if (IS_ACTOR_VALID(iParam0->f_16) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_74(iParam0->f_12), iParam0->f_12);
	}
...
void Function_73() //Position: 0x2CA8 / 11432
{
	bool bVar0;
...
bool Function_74(bool bParam0) //Position: 0x2CDF / 11487
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_75(var uParam0, int iParam1) //Position: 0x2CFC / 11516
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_76(int iParam0) //Position: 0x2D34 / 11572
{
	iParam0 = iParam0;
	return;
}

bool Function_77(bool bParam0) //Position: 0x2D3E / 11582
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2D5F / 11615
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_79(bool bParam0, bool bParam1) //Position: 0x2D6D / 11629
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x2E75 / 11893
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_81(int iParam0) //Position: 0x2E8B / 11915
{
	int iVar0;
	bool bVar1;
	char* cVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_82(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_82(var uParam0, int iParam1) //Position: 0x3141 / 12609
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_83(bool bParam0) //Position: 0x314F / 12623
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_84(bool bParam0) //Position: 0x3168 / 12648
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_85(int iParam0, int iParam1) //Position: 0x3182 / 12674
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_86(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_86(var uParam0, int iParam1) //Position: 0x31BA / 12730
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_87(int iParam0, int iParam1) //Position: 0x31D1 / 12753
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_70(iParam0->f_40, 2))
		{
			...
			if (Function_70(iParam0->f_40, 1))
			{
				Function_80("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_90(iParam0->f_12);
				bVar16 = VMAG(vVar12);
				...
				if (!Function_89(bVar1, iParam0->f_12))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar33 = Function_88(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
...
bool Function_88(bool bParam0) //Position: 0x349A / 13466
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_89(bool bParam0, bool bParam1) //Position: 0x34B7 / 13495
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_90(int iParam0) //Position: 0x3553 / 13651
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_91(var uParam0, int iParam1) //Position: 0x3572 / 13682
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_92(int iParam0) //Position: 0x3581 / 13697
{
...
void Function_93(int iParam0) //Position: 0x359D / 13725
{
	iParam0 = iParam0;
	return;
}

void Function_94(bool bParam0, int iParam1) //Position: 0x35A7 / 13735
{
	int iVar0;
	int iVar1;
	...
	{
		Function_95(&(Local_1[iLocal_7412]), bParam0);
		iLocal_74++;
	}
...
void Function_95(int iParam0, int iParam1) //Position: 0x3609 / 13833
{
...
void Function_96(int iParam0) //Position: 0x361D / 13853
{
	iParam0 = iParam0;
	return;
}

void Function_97(int iParam0) //Position: 0x3627 / 13863
{
