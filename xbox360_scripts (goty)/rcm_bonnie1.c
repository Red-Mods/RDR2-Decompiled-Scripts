...
#region Local Var
	...
	var uLocal_282 = 0;
	var uLocal_283 = 0;
	struct<4> Local_284[6];
	int iLocal_309[6] = { 0, 0, 0, 0, 0, 0 };
	int iLocal_316 = 0;
...
void main() //Position: 0x0 / 0
{
	...
	iLocal_262 = 0;
	iLocal_255 = 1000;
	Function_186(&bLocal_248, "p_gen_pitchfork01x", 0, 0);
	Function_186(&bLocal_248, "p_gen_shovel02x", 0, 0);
	Function_185(&bLocal_275);
	Function_185(&bLocal_278);
	Function_185(&iLocal_281);
		...
		switch (iLocal_262)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					...
					{
						bLocal_274 = CREATE_VOLUME_IN_LAYOUT(bLocal_263, "Bonnie1_StayOut", 2, -788.633f, 95.525f, 2411.045f, 0.0f, -35.023f, 0.0f, 14.953f, 7.088f, 14.799f);
						...
						bLocal_264 = CREATE_OBJECTSET_IN_LAYOUT("Bonnie1_HorseSet", bLocal_263, 15, 1);
						Function_171(&(Global_63541[1255]), 12, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
						iLocal_262 = 1;
						Function_169(&bLocal_275);
					}
					else
					{
						bLocal_263 = CREATE_LAYOUT("RCM_Bonnie_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					if (StackVal && FABS((StackVal - !Function_158(Global_34573, 1, 1))) > 2.0f)
					{
						if (Function_154(Global_63541[ScriptParam_055].f_192, 0, 1, 1, 1, 0))
						{
						...
						else if (Function_151(&bLocal_275) < 5.0f)
						{
							Function_169(&bLocal_275);
						}
					}
			...
			case 0x00000003:
				if (Function_116("$/cutscene/bonnie_rcm_1_pt_a_cs/bonnie_rcm_1_pt_a_cs", &iLocal_255, 30316, 30309, 29074, 29060, 28764, 28748, 1, 1, 2, 2, 0))
				{
					Function_168(&Global_63541[1255] + 144, 512);
					if (IS_ACTOR_VALID(Global_63541[1255].f_204))
					{
						DESTROY_ACTOR(Global_63541[1255].f_204);
					}
					Function_115(1.0f);
					iLocal_262 = 5;
					Function_169(&bLocal_275);
			...
			case 0x00000005:
				...
				{
					Function_168(&Global_63541[1255] + 144, 256);
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "bonnie1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x40F / 1039
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x83E / 2110
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_3() //Position: 0x9B1 / 2481
{
	return;
}

void Function_4(var uParam0, var uParam1) //Position: 0x9B7 / 2487
{
	if (Global_3381)
	{
		return;
...
bool Function_5() //Position: 0x9F9 / 2553
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_6(bool bParam0) //Position: 0xA02 / 2562
{
...
void Function_7() //Position: 0xA53 / 2643
{
	Function_35();
	Function_34();
	Function_34();
...
void Function_8() //Position: 0xAA5 / 2725
{
...
void Function_9() //Position: 0xBAB / 2987
{
	float fVar0;
...
void Function_10() //Position: 0xBDE / 3038
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0xD6C / 3436
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0xF20 / 3872
{
	Function_13(&Global_28260, 1, 0);
	return;
}

void Function_13(int iParam0, bool bParam1, var uParam2) //Position: 0xF2E / 3886
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_14() //Position: 0x111F / 4383
{
...
struct<8> Function_15(int iParam0) //Position: 0x1134 / 4404
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x11DA / 4570
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x1475 / 5237
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18() //Position: 0x1AA2 / 6818
{
	int iVar0;
...
var Function_19(int iParam0) //Position: 0x1AAA / 6826
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_20(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1ABB / 6843
{
	char* cVar0[32];
...
struct<32> Function_21(char* cParam0, bool bParam1) //Position: 0x1BB0 / 7088
{
	char* cVar0[32];
...
void Function_22(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1BC9 / 7113
{
	float fVar0;
...
var Function_23(int iParam0, int iParam1) //Position: 0x1C2E / 7214
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_24(int iParam0, bool bParam1) //Position: 0x1C40 / 7232
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_25(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C52 / 7250
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_26(int iParam0) //Position: 0x1D82 / 7554
{
	return Global_35278[iParam020].f_48;
}

float Function_27(int iParam0) //Position: 0x1D91 / 7569
{
	if (!iParam0 != 4294967295)
	{
...
var Function_28(int iParam0) //Position: 0x1DCA / 7626
{
	if (iParam0 == 4294967295)
	{
...
void Function_29(int iParam0) //Position: 0x1E07 / 7687
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_30(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FA1 / 8097
{
	int iVar0;
	int iVar1;
...
int Function_31(bool bParam0) //Position: 0x21E5 / 8677
{
...
struct<8> Function_32() //Position: 0x2226 / 8742
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x22AF / 8879
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x2346 / 9030
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_35() //Position: 0x23C5 / 9157
{
...
int Function_36(int iParam0, bool bParam1, int iParam2) //Position: 0x23FE / 9214
{
	int iVar0;
	int iVar1;
...
void Function_37() //Position: 0x2608 / 9736
{
	vector3 vVar0;
	var uVar3;
...
bool Function_38(vector3 vParam0) //Position: 0x26C3 / 9923
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_39(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x26DB / 9947
{
	int iVar0;
...
vector3 Function_40() //Position: 0x27C2 / 10178
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_41(int iParam0) //Position: 0x27CB / 10187
{
...
int Function_42(bool bParam0, bool bParam1) //Position: 0x27E1 / 10209
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_43(vector3 vParam0, vector3 vParam3) //Position: 0x28A8 / 10408
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_44(var uParam0, int iParam1) //Position: 0x28C5 / 10437
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_45(int iParam0) //Position: 0x30EA / 12522
{
	var uVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x3125 / 12581
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x3132 / 12594
{
...
void Function_49(int iParam0) //Position: 0x31E3 / 12771
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_50(int iParam0) //Position: 0x3AD8 / 15064
{
...
bool Function_51(int iParam0) //Position: 0x3AF2 / 15090
{
...
bool Function_52(int iParam0, int iParam1) //Position: 0x3B09 / 15113
{
	int iVar0;
...
var Function_53() //Position: 0x3B25 / 15141
{
	return STRING_TO_HASH(Function_54());
}

var Function_54() //Position: 0x3B31 / 15153
{
	return "ZOMBIE_STORY";
}

bool Function_55(int iParam0) //Position: 0x3B46 / 15174
{
...
int Function_56(int iParam0) //Position: 0x3BAC / 15276
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_57(int iParam0) //Position: 0x3C6E / 15470
{
...
void Function_58(char* cParam0) //Position: 0x3C83 / 15491
{
...
bool Function_59(int iParam0, bool bParam1) //Position: 0x3CCB / 15563
{
	int iVar0;
...
var Function_60(int iParam0) //Position: 0x3D08 / 15624
{
...
bool Function_61(int iParam0) //Position: 0x3D22 / 15650
{
...
void Function_62(int iParam0) //Position: 0x3D38 / 15672
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_63(int iParam0, int iParam1) //Position: 0x3EDA / 16090
{
	float fVar0;
	bool bVar1;
...
void Function_64(int iParam0) //Position: 0x3F94 / 16276
{
	float fVar0;
	bool bVar1;
...
int Function_65(var uParam0, int iParam1) //Position: 0x4038 / 16440
{
	int iVar0;
	var uVar1;
...
void Function_66(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x4199 / 16793
{
	struct<8> Var0;
...
struct<32> Function_67(bool bParam0) //Position: 0x4234 / 16948
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x429E / 17054
{
	char* cVar0[32];
...
int Function_69(bool bParam0) //Position: 0x42BD / 17085
{
	int iVar0;
	vector3 vVar1;
...
float Function_70(bool bParam0, vector3 vParam1) //Position: 0x441E / 17438
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0) //Position: 0x4498 / 17560
{
	vector3 vVar0;
...
void Function_72(int iParam0) //Position: 0x4502 / 17666
{
...
bool Function_73(int iParam0) //Position: 0x4563 / 17763
{
...
void Function_74(int iParam0, int iParam1) //Position: 0x4579 / 17785
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void Function_75(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4A0B / 18955
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_76(int iParam0) //Position: 0x4A86 / 19078
{
	char* cVar0[16];
...
bool Function_77() //Position: 0x4AC5 / 19141
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_78(bool bParam0) //Position: 0x4AF2 / 19186
{
...
var Function_79(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4B1E / 19230
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_80(int iParam0) //Position: 0x4B3A / 19258
{
...
bool Function_81(int iParam0, int iParam1) //Position: 0x4B4F / 19279
{
...
bool Function_82(int iParam0, int iParam1) //Position: 0x4C64 / 19556
{
	int iVar0;
...
bool Function_83(int iParam0) //Position: 0x4DA8 / 19880
{
	if (!Function_51(iParam0))
	{
		return 0;
...
bool Function_84(int iParam0) //Position: 0x4DCC / 19916
{
...
bool Function_85(int iParam0) //Position: 0x4DE1 / 19937
{
	return StackVal;
}

bool Function_86(int iParam0) //Position: 0x4DF1 / 19953
{
	if (!iParam0->f_152)
	{
		if (Function_111())
...
bool Function_87(int iParam0) //Position: 0x4E95 / 20117
{
...
bool Function_88(int iParam0) //Position: 0x4EEE / 20206
{
	int iVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x4F0A / 20234
{
	int iVar0;
...
int Function_90(int iParam0) //Position: 0x4F26 / 20262
{
...
int Function_91(int iParam0) //Position: 0x4F3B / 20283
{
...
void Function_92() //Position: 0x4F50 / 20304
{
...
var Function_93(int iParam0, int iParam1) //Position: 0x4FCB / 20427
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_94(int iParam0) //Position: 0x5BBC / 23484
{
	int iVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x5C0B / 23563
{
...
int Function_96(int iParam0) //Position: 0x5C21 / 23585
{
...
void Function_97() //Position: 0x5C8A / 23690
{
...
bool Function_98(int iParam0) //Position: 0x5CAD / 23725
{
	if (!Function_95(iParam0))
	{
...
bool Function_99(int iParam0, int iParam1) //Position: 0x5CFE / 23806
{
	int iVar0;
...
bool Function_100(int iParam0) //Position: 0x5D2B / 23851
{
	if (!Function_95(iParam0))
	{
...
void Function_101(int iParam0) //Position: 0x5D7D / 23933
{
	int iVar0;
...
void Function_102() //Position: 0x5DB7 / 23991
{
	bool bVar0;
...
void Function_103(int iParam0, int iParam1) //Position: 0x5E15 / 24085
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_104(bool bParam0) //Position: 0x5E28 / 24104
{
	PRINTSTRING("Day ");
...
void Function_105(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5E6E / 24174
{
	bool bVar0;
	char* cVar1[16];
...
void Function_106(char* cParam0, int iParam1) //Position: 0x5EDA / 24282
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_107(bool bParam0, var uParam1, int iParam2) //Position: 0x5F11 / 24337
{
	var uVar0;
	char* cVar1[16];
...
int Function_108(char* cParam0) //Position: 0x5F89 / 24457
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_109(int iParam0) //Position: 0x602A / 24618
{
	int iVar0;
	int iVar1;
...
bool Function_110(int iParam0, int iParam1) //Position: 0x6067 / 24679
{
...
bool Function_111() //Position: 0x607A / 24698
{
...
int Function_112(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6095 / 24725
{
	int iVar0;
	int iVar1;
...
void Function_113(char* cParam0, bool bParam1) //Position: 0x62B5 / 25269
{
	bool bVar0;
...
void Function_114(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x62DA / 25306
{
	struct<4> Var0;
	int iVar4;
...
void Function_115(bool bParam0) //Position: 0x635F / 25439
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x637C / 25468
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_117(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, bool bParam15, bool bParam16) //Position: 0x6425 / 25637
{
	if (!bParam15)
	{
	...
	switch (*iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_151(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_118(bool bParam0) //Position: 0x6A39 / 27193
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_119() //Position: 0x6AE8 / 27368
{
	bool bVar0;
...
void Function_120() //Position: 0x6B5A / 27482
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_121() //Position: 0x6B9F / 27551
{
...
void Function_122(bool bParam0, bool bParam1) //Position: 0x6BB1 / 27569
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_123(bool bParam0) //Position: 0x6C31 / 27697
{
	int iVar0;
...
int Function_124(bool bParam0) //Position: 0x6C60 / 27744
{
	int iVar0;
	bool bVar1;
...
bool Function_125() //Position: 0x6D18 / 27928
{
	int iVar0;
	bool bVar1;
...
bool Function_126(int iParam0) //Position: 0x6D52 / 27986
{
	return iParam0->f_20;
}

void Function_127(var uParam0, int iParam1) //Position: 0x6D5C / 27996
{
	Function_128(uParam0, iParam1, 0);
	return;
}

void Function_128(var uParam0, bool bParam1, bool bParam2) //Position: 0x6D6A / 28010
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6EB6 / 28342
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x6EDF / 28383
{
	bool bVar0;
	bool bVar1;
...
void Function_131() //Position: 0x6F2A / 28458
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_132() //Position: 0x704C / 28748
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x705C / 28764
{
...
void Function_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x707F / 28799
{
	bool bVar0;
...
void Function_135() //Position: 0x716F / 29039
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x7184 / 29060
{
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.0f, 1);
	return 1;
}

int Function_137() //Position: 0x7192 / 29074
{
	vector3 vVar0;
	
	vVar0 = { -781.843f, 92.467f, 2427.425f };
	if (!iLocal_316)
	{
		Function_138(StackVal, StackVal, vVar0, bLocal_273);
		iLocal_316 = 1;
	}
	return 1;
}

void Function_138(vector3 vParam0) //Position: 0x71C1 / 29121
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_139(bool bParam0, bool bParam1) //Position: 0x7347 / 29511
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_140(bool bParam0, float fParam1) //Position: 0x7438 / 29752
{
...
void Function_141() //Position: 0x7536 / 30006
{
...
void Function_142() //Position: 0x7568 / 30056
{
...
int Function_143() //Position: 0x7665 / 30309
{
	return 1;
}

int Function_144() //Position: 0x766C / 30316
{
	bLocal_273 = CREATE_VOLUME_IN_LAYOUT(bLocal_263, "Bonnie1CSVol", 2, -790.0453f, 93.30781f, 2410.738f, 0.0f, -125.742f, 0.0f, 21.22061f, 15.24588f, 22.38816f);
	Function_147(0, 0, 1, 1, 0, 1, 1, bLocal_273, 1, 1, 1, 1);
	Function_145(StackVal, StackVal, bLocal_263, *(&Global_63541[1255] + 112), &bLocal_273, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	return 1;
}

void Function_145(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x7703 / 30467
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_146(bool bParam0, bool bParam1) //Position: 0x7971 / 31089
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_147(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x79E6 / 31206
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_150(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_18(), 2, Function_150(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_148(int iParam0) //Position: 0x7C94 / 31892
{
	int iVar0;
...
var Function_149() //Position: 0x7CC8 / 31944
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_150(bool bParam0) //Position: 0x7D47 / 32071
{
	vector3 vVar0;
...
float Function_151(bool bParam0) //Position: 0x7D58 / 32088
{
...
bool Function_152(int iParam0) //Position: 0x7E20 / 32288
{
	return Function_46(*iParam0, 2);
}

bool Function_153(bool bParam0) //Position: 0x7E2D / 32301
{
	return Function_46(*bParam0, 1);
}

bool Function_154(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x7E3A / 32314
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			{
				if (Function_156(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_156(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_155(&iVar6, &vVar3);
				}
				else
				{
...
int Function_155(int iParam0, int iParam1) //Position: 0x804D / 32845
{
	var uVar0;
...
float Function_156(bool bParam0, bool bParam1) //Position: 0x80B8 / 32952
{
	vector3 vVar0;
...
void Function_157(bool bParam0, bool bParam1) //Position: 0x80D7 / 32983
{
	bool bVar0;
	bool bVar1;
	...
	else if (!bParam1 || Function_156(bParam0, 0) < 2.0f)
	{
...
bool Function_158(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8134 / 33076
{
...
bool Function_159() //Position: 0x81EA / 33258
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_160(bool bParam0) //Position: 0x8201 / 33281
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_161(bool bParam0) //Position: 0x820C / 33292
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_162() //Position: 0x821A / 33306
{
	Function_164(&bLocal_248);
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	if (IS_LAYOUTREF_VALID(bLocal_263))
	{
...
int Function_163(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8240 / 33344
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_164(int iParam0) //Position: 0x826F / 33391
{
	int iVar0;
...
void Function_165(var uParam0, int iParam1) //Position: 0x8295 / 33429
{
	if (Function_167(uParam0[iParam13], 4))
	{
		if (Function_167(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_166(uParam0[iParam13], 1);
			Function_166(uParam0[iParam13], 2);
			Function_166(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_166(var uParam0, int iParam1) //Position: 0x83C3 / 33731
{
	int iVar0;
...
bool Function_167(var uParam0, int iParam1) //Position: 0x83DD / 33757
{
	int iVar0;
...
void Function_168(var uParam0, int iParam1) //Position: 0x83FA / 33786
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_169(bool bParam0) //Position: 0x8409 / 33801
{
	Function_170(bParam0, 0.0f);
	return;
}

void Function_170(var uParam0, bool bParam1) //Position: 0x8415 / 33813
{
...
int Function_171(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) //Position: 0x8436 / 33846
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_173(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_173(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
...
float Function_172(float fParam0) //Position: 0x85A6 / 34214
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_172(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_173(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x85DB / 34267
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_176(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_177()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
	...
	else if ((!Function_176(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_177()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_176(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_174() //Position: 0x8821 / 34849
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_175(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_175(char* cParam0, vector3 vParam1) //Position: 0x8875 / 34933
{
	char* cVar0[64];
...
bool Function_176(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x899D / 35229
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_71(bParam0);
...
int Function_177() //Position: 0x8A27 / 35367
{
	if (IS_PS3())
	{
		return 1;
...
void Function_178() //Position: 0x8A36 / 35382
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	
	if (!Function_153(&bLocal_278) || !IS_OBJECTSET_VALID(bLocal_264))
	{
		return;
	}
	if (Function_151(&bLocal_278) > 2.0f)
	{
		return;
	}
	Function_179(bLocal_264);
	if (IS_VOLUME_VALID(bLocal_274))
	{
		iVar1 = LOCATE_ACTORS_IN_VOLUME(bLocal_274, bLocal_264, 0, 1);
	}
	bVar2 = false;
	while (bVar2 <= iVar1)
	{
		bVar0 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar2, bLocal_264));
		if (IS_ACTOR_VALID(bVar0))
		{
			if (IS_ACTOR_HORSE(bVar0))
			{
				SET_ACTOR_STAY_OUTSIDE_OF_VOLUME(bVar0, bLocal_274, 2, 1);
			}
		}
		bVar2++;
	}
...
void Function_179(bool bParam0) //Position: 0x8AB1 / 35505
{
	bool bVar0;
...
void Function_180() //Position: 0x8AE9 / 35561
{
	vector3 vVar0;
	int iVar3;
	...
	while (iVar3 <= 6)
	{
		if (!IS_DOOR_VALID(uLocal_265[iVar3]))
		{
			uLocal_265[iVar3] = Function_182("hennigansRanch", &(Local_284[iVar34]), iLocal_309[iVar3]);
		}
		if (IS_DOOR_VALID(uLocal_265[iVar3]))
		{
			if (!IS_DOOR_CLOSED(uLocal_265[iVar3]))
			{
				if (!IS_DOOR_CLOSING(uLocal_265[iVar3]))
				{
					CLOSE_DOOR_FAST(uLocal_265[iVar3]);
				}
			}
			if (!IS_DOOR_LOCKED(uLocal_265[iVar3]))
			{
				Function_181(uLocal_265[iVar3], 1);
			}
		}
		iVar3++;
	}
	if (!IS_DOOR_VALID(bLocal_272))
	{
		bLocal_272 = FIND_NEAREST_DOOR(&vVar0, 2.0f);
	}
	if (IS_DOOR_VALID(bLocal_272))
	{
		SET_DOOR_LOCK_VISIBLE(bLocal_272, 0);
	}
	return;
}

void Function_181(bool bParam0, bool bParam1) //Position: 0x8BC8 / 35784
{
...
int Function_182(var uParam0, var uParam1, int iParam2) //Position: 0x8C1C / 35868
{
	return Function_183(Global_29006, uParam0, uParam1, iParam2);
}

int Function_183(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x8C2E / 35886
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_184(int iParam0) //Position: 0x8CCA / 36042
{
	if (!Function_73(iParam0))
	{
		return 1;
...
void Function_185(int iParam0) //Position: 0x8CE6 / 36070
{
...
var Function_186(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x8CFB / 36091
{
	int iVar0;
	int iVar1;
...
void Function_187(var uParam0, int iParam1) //Position: 0x8D33 / 36147
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_188(var uParam0, int iParam1, int iParam2) //Position: 0x8D44 / 36164
{
	int iVar0;
	...
	{
		if (!Function_167(uParam0[iVar03], 4))
		{
...
void Function_189() //Position: 0x8E08 / 36360
{
	strcpy(&(Local_284[04]), "barn01", 16);
	strcpy(&(Local_284[14]), "barn01", 16);
	strcpy(&(Local_284[24]), "barn01", 16);
	strcpy(&(Local_284[34]), "barn01", 16);
	strcpy(&(Local_284[44]), "barn01props", 16);
	strcpy(&(Local_284[54]), "barn01props", 16);
	iLocal_309[0] = 1;
	iLocal_309[1] = 2;
	iLocal_309[2] = 3;
	iLocal_309[3] = 4;
