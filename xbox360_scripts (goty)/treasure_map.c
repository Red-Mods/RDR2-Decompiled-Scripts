...
int Function_49(bool bParam0) //Position: 0x2978 / 10616
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_67(bParam0, bVar0))
			{
				Function_57(bParam0, bVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000003:
			if (!Function_51(bParam0, bVar0, &iLocal_2))
			{
				iLocal_1 = 4;
			}
			iVar1 = 0;
		...
		case 0x00000004:
			Function_50(bParam0, bVar0, &iLocal_2);
			iLocal_3 = 1;
			iLocal_1 = 0;
			break;
	}
...
bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A48 / 10824
{
	bool bVar0;
...
void Function_52(bool bParam0, var uParam1, int iParam2) //Position: 0x2B74 / 11124
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_53(bool bParam0, bool bParam1) //Position: 0x2BFE / 11262
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_54(bool bParam0, bool bParam1, int iParam2) //Position: 0x2CAC / 11436
{
	int iVar0;
	bool bVar1;
...
var Function_55(bool bParam0) //Position: 0x2CF1 / 11505
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_56(bool bParam0) //Position: 0x2D07 / 11527
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2D1D / 11549
{
	uParam0 = Function_66(uParam0);
	*iParam2 = 0;
	bLocal_5 = Function_64();
	if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
	{
		DECOR_REMOVE(bParam1, "NewspaperStart");
	}
...
void Function_58(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2E3B / 11835
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2EB6 / 11958
{
	char* cVar0[16];
...
int Function_60(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2EF5 / 12021
{
...
bool Function_61() //Position: 0x2FAB / 12203
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_62(bool bParam0) //Position: 0x2FC2 / 12226
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_63(bool bParam0) //Position: 0x2FCD / 12237
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_64() //Position: 0x2FDB / 12251
{
	int iVar0;
	int iVar1;
...
var Function_65(int iParam0) //Position: 0x3171 / 12657
{
...
var Function_66(bool bParam0) //Position: 0x3199 / 12697
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_67(int iParam0, bool bParam1) //Position: 0x31B3 / 12723
{
	bool bVar0;
	bool bVar1;
