...
{
	RELEASE_LAYOUT_REF(bLocal_19);
	Function_4(4, bLocal_16, bLocal_17, &bLocal_3, bLocal_18, 4294967295);
	return;
}
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_21 || bParam2) || Global_3370)
			{
				...
				{
					if (((!bParam2 && !Function_149(iParam0 + 200, &fLocal_23, 256, 0)) && !Global_3370) && !Function_156())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_138(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_23, 20.0f, fLocal_23);
		...
		case 0x0000000B:
			...
			if ((iParam0->f_268 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player")) && !iParam0->f_276)
			{
				if (SQUAD_IS_VALID(iParam0->f_244) && SQUAD_GET_SIZE(iParam0->f_244) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_25) < 10.0f)
						{
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_24, iParam0 + 312, 0, 0, 0x40400000))
						{
...
bool Function_76(int iParam0, int iParam1) //Position: 0x36E7 / 14055
{
	...
	Function_146(&bLocal_3, 592, 3, 0);
	Function_102(&bLocal_3, "talking_stand", 5, 0);
	Function_102(&bLocal_3, "custom/talking_stand", 8, 0);
	if (Function_86(&bLocal_16, &bLocal_3, 21, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_84(&bLocal_19, "marshal04mobile", iParam1))
		{
			bLocal_17 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_19, Function_138()));
			Global_3422[2140].f_156 = bLocal_17;
			iParam0->f_12 = bLocal_19;
			Function_77();
			fLocal_20 = GET_CURRENT_GAME_TIME();
			return 1;
		}
...
void Function_77() //Position: 0x379A / 14234
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	bLocal_18 = CREATE_LAYOUT("marshal04campfirelayout");
	bVar0 = CREATE_VOLUME_IN_LAYOUT(bLocal_18, "marshal04restrict", 2, -2084.343f, 17.37085f, 2602.81f, 0.0f, 24.46099f, 0.0f, 9.259373f, 5.303829f, 9.113053f);
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_16, vVar1, 15.0f, 1, 1, 1);
	SNAP_OBJECT_TO_GROUND(bLocal_16, 1.0f, false, 1092616192);
	Function_81(bLocal_16, -2084.735f, 17.709f, 2601.664f);
	TASK_STAND_STILL(bLocal_16, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(bLocal_16, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(bLocal_16, "talking_stand");
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_ACTION_PERFORM(false, "talking_stand/Listen_B");
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(bLocal_16, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	Function_79(bLocal_16, &bLocal_17, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_16, bVar0, 1, 1);
	bVar5 = CREATE_ACTOR_IN_LAYOUT(bLocal_18, "Marshal01deputy01", 588, -2086.813f, 17.204f, 2600.029f, 0.0f, 0.0f, 0.0f);
	SNAP_OBJECT_TO_GROUND(bVar5, 1.0f, false, 1092616192);
	Function_78(bVar5, bLocal_16);
	SET_ANIM_SET_FOR_ACTOR(bVar5, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(bVar5, "talking_stand");
	bVar4 = TASK_SEQUENCE_OPEN();
	TASK_FACE_ACTOR(false, bLocal_16, 0, 3212836864);
	TASK_ACTION_PERFORM(false, "talking_stand/Talk_A");
	TASK_STAND_STILL(false, 5.0f, 0, 0);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM_REPEATEDLY(bVar5, bVar4, 4294967295);
	TASK_SEQUENCE_RELEASE(bVar4, 1);
	Function_79(bVar5, &bLocal_17, 1, 1);
	SET_ACTOR_STAY_WITHIN_VOLUME(bVar5, bVar0, 1, 1);
	bVar5 = CREATE_ACTOR_IN_LAYOUT(bLocal_18, "Marshal01deputy03", 592, -2086.204f, 17.227f, 2601.798f, 0.0f, 0.0f, 0.0f);
	SNAP_OBJECT_TO_GROUND(bVar5, 1.0f, false, 1092616192);
	Function_78(bVar5, bLocal_16);
	SET_ANIM_SET_FOR_ACTOR(bVar5, "talking_stand", 0);
	SET_ACTION_NODE_FOR_ACTOR(bVar5, "talking_stand");
...
void Function_78(bool bParam0, bool bParam1) //Position: 0x3A6A / 14954
{
	vector3 vVar0;
...
void Function_79(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x3A84 / 14980
{
	bool bVar0;
	bool bVar1;
...
bool Function_80(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3C0E / 15374
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
void Function_81(bool bParam0, vector3 vParam1) //Position: 0x3C4E / 15438
{
...
var Function_82(bool bParam0, vector3 vParam1) //Position: 0x3C86 / 15494
{
	vector3 vVar0;
...
vector3 Function_83(bool bParam0) //Position: 0x3D09 / 15625
{
	vector3 vVar0;
...
bool Function_84(var uParam0, char* cParam1, int iParam2) //Position: 0x3D1A / 15642
{
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3D45 / 15685
{
	int iVar0;
...
bool Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3D87 / 15751
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3F50 / 16208
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x443C / 17468
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_89(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x445C / 17500
{
	bool bVar0;
...
int Function_90(bool bParam0, bool bParam1) //Position: 0x44B0 / 17584
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x4530 / 17712
{
	Function_93(bParam0);
	Function_92(bParam0);
...
void Function_92(bool bParam0) //Position: 0x4556 / 17750
{
...
void Function_93(bool bParam0) //Position: 0x457A / 17786
{
...
bool Function_94(bool bParam0) //Position: 0x4649 / 17993
{
...
int Function_95(int iParam0, bool bParam1) //Position: 0x4660 / 18016
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x46F3 / 18163
{
	bool bVar0;
	bool bVar1;
...
void Function_97(bool bParam0) //Position: 0x47EA / 18410
{
	bool bVar0;
...
bool Function_98(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x4816 / 18454
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_99() //Position: 0x48A0 / 18592
{
	bool bVar0;
	bool bVar1;
...
var Function_100(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x4905 / 18693
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_101(int iParam0) //Position: 0x49A5 / 18853
{
	bool bVar0;
	int iVar1;
...
var Function_102(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A9F / 19103
{
	int iVar0;
	int iVar1;
...
void Function_103(var uParam0, int iParam1) //Position: 0x4AD7 / 19159
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_104(var uParam0, int iParam1, int iParam2) //Position: 0x4AE8 / 19176
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x4BAC / 19372
{
	int iVar0;
	int iVar1;
...
void Function_106() //Position: 0x4F27 / 20263
{
	if (!Function_153(128))
	{
		return;
...
bool Function_107() //Position: 0x4F67 / 20327
{
	int iVar0;
...
void Function_108() //Position: 0x4F92 / 20370
{
	if (!Function_153(128))
	{
		return;
...
void Function_109(int iParam0, bool bParam1) //Position: 0x4FD4 / 20436
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5058 / 20568
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x5081 / 20609
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x50D2 / 20690
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x50E2 / 20706
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x50F6 / 20726
{
	int iVar0;
...
var Function_115() //Position: 0x511B / 20763
{
	return "PackedMetadata";
}

void Function_116(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5132 / 20786
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_117() //Position: 0x525D / 21085
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_118() //Position: 0x526E / 21102
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_119() //Position: 0x527F / 21119
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_120(var uParam0, int iParam1) //Position: 0x5290 / 21136
{
...
var Function_121(var uParam0, int iParam1, bool bParam2) //Position: 0x52B3 / 21171
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x52D2 / 21202
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_123() //Position: 0x52DE / 21214
{
	return Function_124(39);
}

int Function_124(bool bParam0) //Position: 0x52E9 / 21225
{
	bool bVar0;
...
var Function_125() //Position: 0x5317 / 21271
{
	return "PackedWeapon";
}

int Function_126(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x532C / 21292
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_127() //Position: 0x5430 / 21552
{
	return "MPItemGiver";
}

struct<32> Function_128(bool bParam0) //Position: 0x5444 / 21572
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0, char* cParam1, char* cParam2) //Position: 0x54AE / 21678
{
	char* cVar0[32];
...
var Function_130() //Position: 0x54CD / 21709
{
	return "PBox_";
}

var Function_131() //Position: 0x54DB / 21723
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x5501 / 21761
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x5529 / 21801
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x554F / 21839
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x56B0 / 22192
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x574B / 22347
{
	int iVar0;
	vector3 vVar1;
...
void Function_137(int iParam0) //Position: 0x58AC / 22700
{
...
var Function_138() //Position: 0x590D / 22797
{
	int iVar0;
...
var Function_139(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5915 / 22805
{
	return Function_140(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x592E / 22830
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x5C21 / 23585
{
	int iVar0;
...
void Function_142() //Position: 0x5CD5 / 23765
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x5D0F / 23823
{
	int iVar0;
...
void Function_144(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5D3C / 23868
{
	bool bVar0;
...
void Function_145() //Position: 0x5E8D / 24205
{
	int iVar0;
...
var Function_146(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5ED8 / 24280
{
	int iVar0;
...
int Function_147() //Position: 0x5FA8 / 24488
{
	int iVar0;
...
int Function_148() //Position: 0x6104 / 24836
{
	int iVar0;
...
bool Function_149(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x6224 / 25124
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_150(var uParam0, int iParam1) //Position: 0x62F4 / 25332
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_151(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6312 / 25362
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_152(bool bParam0) //Position: 0x6444 / 25668
{
	bool bVar0;
...
bool Function_153(int iParam0) //Position: 0x6463 / 25699
{
	int iVar0;
...
int Function_154() //Position: 0x647F / 25727
{
	if (Function_156())
	{
...
int Function_155() //Position: 0x6498 / 25752
{
	return Global_79349.f_16;
}

bool Function_156() //Position: 0x64A4 / 25764
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_157(int iParam0, bool bParam1, bool bParam2) //Position: 0x64AD / 25773
{
	var uVar0;
