...
bool Function_17() //Position: 0x420 / 1056
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30668[1], &Local_24 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_30668[1], 0);
				*(&Local_24 + 148) = { StackVal, StackVal, Function_26(Global_30668[1], 0) };
				Function_25(&Local_24 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_24 + 40)[iVar0] = iLocal_4 * 10;
					Function_24(Global_30668[1], iVar0, 0);
					*(&Local_24 + 72[iVar03]) = { StackVal, StackVal, Function_24(Global_30668[1], iVar0, 0) };
					iVar0++;
				}
				if (Function_36())
				{
				...
				*(&Local_24 + 184) = { StackVal, StackVal, Function_23(Global_30668[1]) };
				Function_22(Global_30668[1]);
				*(&Local_24 + 196) = { StackVal, StackVal, Function_22(Global_30668[1]) };
...
void Function_18() //Position: 0x5D2 / 1490
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5DB / 1499
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x5FC / 1532
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x632 / 1586
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x64D / 1613
{
...
vector3 Function_23(int iParam0) //Position: 0x747 / 1863
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x841 / 2113
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xDBB / 3515
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xE10 / 3600
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF22 / 3874
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1111 / 4369
{
...
bool Function_29() //Position: 0x11C7 / 4551
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11DE / 4574
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11E9 / 4585
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x11F7 / 4599
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x1204 / 4612
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1246 / 4678
{
	return Function_35(0);
}

int Function_35(bool bParam0) //Position: 0x1250 / 4688
{
...
bool Function_36() //Position: 0x1291 / 4753
{
...
var Function_37(int iParam0) //Position: 0x12BC / 4796
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_38() //Position: 0x12D6 / 4822
{
	Function_1();
	return;
}

void Function_39() //Position: 0x12DF / 4831
{
...
void Function_40(int iParam0) //Position: 0x132E / 4910
{
...
void Function_41(var uParam0, float fParam1) //Position: 0x1343 / 4931
{
...
void Function_42(var uParam0, int iParam1) //Position: 0x1364 / 4964
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x1377 / 4983
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_44(int iParam0) //Position: 0x1386 / 4998
{
	return Function_45(*iParam0, 1);
}

int Function_45(var uParam0, bool bParam1) //Position: 0x1393 / 5011
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x13A0 / 5024
{
	return;
}

void Function_47() //Position: 0x13A6 / 5030
{
	return;
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x13AC / 5036
{
	bool bVar0;
...
void Function_49(var uParam0) //Position: 0x1403 / 5123
{
	int iVar0;
...
var Function_50() //Position: 0x1420 / 5152
{
	var uVar0;
