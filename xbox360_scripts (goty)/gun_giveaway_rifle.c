...
void main() //Position: 0x0 / 0
{
	...
	iLocal_77 = 0;
	Function_103(uScriptParam_0, &iLocal_77);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(Local_4[iVar312]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), Local_4[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", Local_4[iVar312].f_16);
							Function_88(Local_4[iVar312].f_16, 1);
							...
							{
								Function_81(&(Local_4[iVar312]), 0);
							}
							else if (Local_4[iVar312].f_44 < 8)
							{
								Function_80(&(Local_4[iVar312]));
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_84))
								{
									...
									{
										bLocal_84 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_84 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_82, &cLocal_81);
...
void Function_62(bool bParam0) //Position: 0x254C / 9548
{
	...
	{
		iLocal_1 = 1;
		cLocal_2 = CREATE_LAYOUT("gunGiveRifle_Layout");
		uVar7 = Function_68(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1");
		Function_67(uVar7);
		*(&Var0 + 12) = { StackVal, StackVal, Function_67(uVar7) };
		Function_66(uVar7);
		Var0 = { StackVal, StackVal, Function_66(uVar7) };
		Var0.f_24 = 0;
...
var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25B8 / 9656
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "GunGiveRifle", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2632 / 9778
{
	bool bVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 100.0f, 0);
	return;
}

void Function_65(var uParam0, bool bParam1) //Position: 0x265D / 9821
{
	vector3 vVar0;
	
	vVar0 = { 0.0f, 0.0f, 0.0f };
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 43.29395f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*uParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*uParam0, 0);
	vVar0 = { 1.295631f, 1.604782f, 0.447745f };
	...
	vVar0 = { 0.716617f, 0.105341f, 0.689466f };
	UNK_0xF76F2BB3(&vVar0, bParam1, bParam1->f_24, 4);
...
vector3 Function_66(bool bParam0) //Position: 0x2715 / 10005
{
	vector3 vVar0;
...
vector3 Function_67(bool bParam0) //Position: 0x273C / 10044
{
	vector3 vVar0;
...
var Function_68(bool bParam0, bool bParam1) //Position: 0x2763 / 10083
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_69(int iParam0) //Position: 0x2770 / 10096
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x277A / 10106
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2798 / 10136
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x27AD / 10157
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2834 / 10292
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2857 / 10327
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x2875 / 10357
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x2898 / 10392
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x29B3 / 10675
{
...
int Function_78(bool bParam0) //Position: 0x29DE / 10718
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2AE3 / 10979
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2AF0 / 10992
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2B63 / 11107
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_81));
		iLocal_82 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_82() //Position: 0x3061 / 12385
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x3098 / 12440
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x30B5 / 12469
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x30ED / 12525
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x30F7 / 12535
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(bool bParam0, bool bParam1) //Position: 0x3118 / 12568
{
	bool bVar0;
	
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
	{
		bVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
		if (STRING_CONTAINS_STRING(bVar0, "winchester"))
		{
			SET_WEAPONENUM_LOCKED(9, 0);
			GIVE_WEAPON_TO_ACTOR(bParam0, 9, 0, 1, 1);
			ACTOR_PUT_WEAPON_IN_HAND(bParam0, 9, 0);
		}
		else if (STRING_CONTAINS_STRING(bVar0, "rollingblock"))
		{
			SET_WEAPONENUM_LOCKED(19, 0);
			GIVE_WEAPON_TO_ACTOR(bParam0, 19, 0, 1, 1);
			ACTOR_PUT_WEAPON_IN_HAND(bParam0, 19, 0);
		}
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x31B1 / 12721
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x32B9 / 12985
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x32CF / 13007
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x3585 / 13701
{
	bParam1 = bParam1;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
	{
...
bool Function_92(bool bParam0) //Position: 0x35AF / 13743
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x35C8 / 13768
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x35E2 / 13794
{
	bool bVar0;
	char* cVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x361A / 13850
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x3631 / 13873
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x38FA / 14586
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x3917 / 14615
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x39B3 / 14771
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x39D2 / 14802
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x39E1 / 14817
{
...
void Function_102(int iParam0) //Position: 0x39FD / 14845
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x3A07 / 14855
{
	int iVar0;
	int iVar1;
	...
	{
		Function_104(&(Local_4[iLocal_7712]), bParam0);
		iLocal_77++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x3A69 / 14953
{
...
void Function_105(int iParam0) //Position: 0x3A7D / 14973
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3A87 / 14983
{
