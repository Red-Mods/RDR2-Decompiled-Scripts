...
void main() //Position: 0x0 / 0
{
	...
	iLocal_78 = 0;
	Function_106(uScriptParam_0, &iLocal_78);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_99(&(Local_5[iVar312]), &bVar4))
						{
							Function_97(GRINGO_GET_REQUESTING_ACTOR(), Local_5[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_92("eGRINGO_EndUse: Stop use by request", Local_5[iVar312].f_16);
							Function_91(Local_5[iVar312].f_16, 1);
							...
							{
								Function_84(&(Local_5[iVar312]), 0);
							}
							else if (Local_5[iVar312].f_44 < 8)
							{
								Function_83(&(Local_5[iVar312]));
						...
						{
							Function_109("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_78 - 1))
			{
				if (Function_82(Local_5[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_5[iVar012])))
					{
						Function_109("Quitting due to update end");
						Function_84(&(Local_5[iVar012]), 1);
					}
				}
	...
	{
		Function_109("Removing quit context at script termination");
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
								{
									Function_109("ManagePlayerQuit: Create quit context");
								...
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_85))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
									{
										Function_109("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(bLocal_85);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
										{
											Function_109("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(bLocal_85);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
							{
								Function_109("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(bLocal_85);
							}
						}
					}
...
bool Function_16(int iParam0) //Position: 0xA2F / 2607
{
	...
	{
		Function_92("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_92("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_92("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000001:
			...
			if (Function_82(iParam0->f_40, 1))
			{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, 1, Function_58());
				}
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_42(iParam0, bVar8, &iLocal_83, &cLocal_82);
		...
		case 0x00000006:
			...
			bVar0 = Function_52(iParam0->f_16, iParam0->f_12, Function_82(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_17(bool bParam0, int iParam1) //Position: 0x1B80 / 7040
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1B95 / 7061
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1BA3 / 7075
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BD4 / 7124
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C48 / 7240
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CBA / 7354
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CC8 / 7368
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CDE / 7390
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CEB / 7403
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D0B / 7435
{
	var uVar0[2];
	
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "nOpen_Door"))
	{
		DECOR_REMOVE(GRINGO_GET_MY_OBJECT_REF(), "nOpen_Door");
		uVar0[0] = Function_28("fortMercer", "guardTowerProps01", 7);
		uVar0[1] = Function_28("fortMercer", "guardTowerProps01", 8);
		Function_27(uVar0[0], 0);
		Function_27(uVar0[1], 0);
		OPEN_DOOR_DIRECTION(uVar0[0], true);
		OPEN_DOOR_DIRECTION(uVar0[1], false);
		SET_DOOR_CURRENT_SPEED(uVar0[0], 1.8f, 0.0f);
		SET_DOOR_CURRENT_SPEED(uVar0[1], 1.8f, 0.0f);
	}
	return 1;
}

void Function_27(bool bParam0, bool bParam1) //Position: 0x1DDC / 7644
{
...
int Function_28(var uParam0, var uParam1, int iParam2) //Position: 0x1E2D / 7725
{
	return Function_29(Global_29006, uParam0, uParam1, iParam2);
}

int Function_29(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x1E3F / 7743
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_30(int iParam0) //Position: 0x1EDB / 7899
{
...
bool Function_31(bool bParam0) //Position: 0x1EF1 / 7921
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_32() //Position: 0x1F10 / 7952
{
	return;
}

void Function_33(var uParam0, int iParam1) //Position: 0x1F16 / 7958
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34(int iParam0) //Position: 0x1F24 / 7972
{
	iParam0 = iParam0;
	return 1;
}

bool Function_35(bool bParam0) //Position: 0x1F2F / 7983
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_36(bool bParam0, int iParam1) //Position: 0x1F49 / 8009
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_37(bool bParam0) //Position: 0x1F67 / 8039
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1F86 / 8070
{
	int iVar0;
	int iVar1;
...
bool Function_39(bool bParam0) //Position: 0x1FB9 / 8121
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_40(bool bParam0) //Position: 0x1FD8 / 8152
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x1FF2 / 8178
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2005 / 8197
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_50(uParam0->f_12, &bVar0);
...
var Function_43() //Position: 0x22ED / 8941
{
	int iVar0;
...
bool Function_44(bool bParam0, bool bParam1) //Position: 0x22F5 / 8949
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_45() //Position: 0x2312 / 8978
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2321 / 8993
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2343 / 9027
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_48(bool bParam0) //Position: 0x2367 / 9063
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x2384 / 9092
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x23A4 / 9124
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_51(bool bParam0, bool bParam1) //Position: 0x23C4 / 9156
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_52(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2472 / 9330
{
	bool bVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x24E2 / 9442
{
	if (!Function_14(iParam0))
	{
...
void Function_54(int iParam0, float fParam1) //Position: 0x24F8 / 9464
{
...
var Function_55(bool bParam0) //Position: 0x2519 / 9497
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_56(int iParam0) //Position: 0x2539 / 9529
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x254D / 9549
{
	uParam0 = uParam0;
	return;
}

int Function_58() //Position: 0x2557 / 9559
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x255E / 9566
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_60(bool bParam0, var uParam1, int iParam2) //Position: 0x256D / 9581
{
	bool bVar0;
...
bool Function_61(bool bParam0) //Position: 0x25AC / 9644
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(bool bParam0) //Position: 0x25D7 / 9687
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_63(bool bParam0) //Position: 0x25E2 / 9698
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_64(bool bParam0) //Position: 0x26D8 / 9944
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_65(bool bParam0) //Position: 0x26FA / 9978
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(int iParam0) //Position: 0x2721 / 10017
{
	struct<8> Var0;
	
	iParam0 = iParam0;
	if (iLocal_1 && !iLocal_0)
	{
		iLocal_0 = 1;
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_70("bigDoor_layout") };
		cLocal_2 = CREATE_LAYOUT(&Var0);
		bLocal_3 = Function_67(cLocal_2, 0, 1, 0, 0);
	}
	return;
}

bool Function_67(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2762 / 10082
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "BigDoorOpen", 1, 1);
	}
	Function_68(&bVar0);
...
void Function_68(int iParam0) //Position: 0x27D9 / 10201
{
	bool bVar0;
...
void Function_69(int iParam0) //Position: 0x2802 / 10242
{
	...
	SET_CAMERASHOT_POSITION(*iParam0, -2649.763f, 68.01277f, 3419.051f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.26214f, -0.465322f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

struct<32> Function_70(bool bParam0) //Position: 0x286C / 10348
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_71(char* cParam0, char* cParam1, char* cParam2) //Position: 0x28D6 / 10454
{
	char* cVar0[32];
...
void Function_72(int iParam0) //Position: 0x28F5 / 10485
{
	iParam0 = iParam0;
	return;
}

bool Function_73(bool bParam0) //Position: 0x28FF / 10495
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_74(int iParam0) //Position: 0x291D / 10525
{
	if (!Function_14(iParam0))
	{
...
bool Function_75(bool bParam0, bool bParam1) //Position: 0x2932 / 10546
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
	...
	{
		return Function_79(bParam0, bParam1);
	}
	uVar4 = Function_78(bParam1);
	uVar5 = Function_61(bParam1);
	Function_76(bParam1);
	vVar6 = { StackVal, StackVal, Function_76(bParam1) };
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(bParam0, &vVar0, &vVar6, uVar4, 0.2f, 1, bVar3, uVar5, 0, 0);
}

vector3 Function_76(int iParam0) //Position: 0x29B9 / 10681
{
	vector3 vVar0;
	
	vVar0 = { 0.0f, 0.0f, 0.0f };
	Function_77(StackVal, StackVal, iParam0, "UserOffset", vVar0);
	return StackVal, StackVal, Function_77(StackVal, StackVal, iParam0, "UserOffset", vVar0);
}

vector3 Function_77(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29DC / 10716
{
	vector3 vVar0;
...
bool Function_78(bool bParam0) //Position: 0x29FA / 10746
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_79(bool bParam0, bool bParam1) //Position: 0x2A1D / 10781
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
	...
	bVar0 = Function_78(bParam1);
	fVar1 = Function_61(bParam1);
...
bool Function_80(bool bParam0, int iParam1) //Position: 0x2B38 / 11064
{
...
int Function_81(bool bParam0) //Position: 0x2B63 / 11107
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_82(var uParam0, int iParam1) //Position: 0x2C68 / 11368
{
	return (uParam0 && iParam1) == 0;
}

void Function_83(int iParam0) //Position: 0x2C75 / 11381
{
	if (Function_82(iParam0->f_40, 16))
	{
...
void Function_84(int iParam0, bool bParam1) //Position: 0x2CE8 / 11496
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_85() //Position: 0x31E6 / 12774
{
	bool bVar0;
...
void Function_87(var uParam0, int iParam1) //Position: 0x323A / 12858
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_88(int iParam0) //Position: 0x3272 / 12914
{
	iParam0 = iParam0;
	return;
}

bool Function_89(bool bParam0) //Position: 0x327C / 12924
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_90(var uParam0, int iParam1) //Position: 0x329D / 12957
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	HUD_ENABLE(true);
	...
	if (IS_LAYOUTREF_VALID(cLocal_2))
	{
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x32D4 / 13012
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_109("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_109("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
			{
				if (bParam1)
				{
					Function_109("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(bLocal_85);
			}
		}
	...
	if (bParam1)
	{
		Function_109("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_92(bool bParam0, bool bParam1) //Position: 0x33DC / 13276
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_93(int iParam0) //Position: 0x33F2 / 13298
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_94(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_94(bool bParam0, int iParam1) //Position: 0x36A8 / 13992
{
	iParam1 = iParam1;
	iLocal_1 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_95(bool bParam0) //Position: 0x36C4 / 14020
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_96(bool bParam0) //Position: 0x36DD / 14045
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_97(bool bParam0, int iParam1) //Position: 0x36F7 / 14071
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_98(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_98(var uParam0, int iParam1) //Position: 0x372F / 14127
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_99(int iParam0, int iParam1) //Position: 0x3746 / 14150
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_82(iParam0->f_40, 2))
		{
			...
			if (Function_82(iParam0->f_40, 1))
			{
				Function_92("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_102(iParam0->f_12);
				bVar16 = VMAG(vVar12);
				...
				if (!Function_101(bVar1, iParam0->f_12))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar33 = Function_100(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
...
bool Function_100(bool bParam0) //Position: 0x3A0F / 14863
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_101(bool bParam0, bool bParam1) //Position: 0x3A2C / 14892
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_102(int iParam0) //Position: 0x3AC8 / 15048
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_103(bool bParam0, int iParam1) //Position: 0x3AE7 / 15079
{
	bool bVar0;
	...
	{
		bVar0 = FIND_VOLUME_IN_LAYOUT(Global_30616, "v_HelperInFort");
...
bool Function_104(int iParam0) //Position: 0x3B2D / 15149
{
...
void Function_105(int iParam0) //Position: 0x3B49 / 15177
{
	iParam0 = iParam0;
	return;
}

void Function_106(bool bParam0, int iParam1) //Position: 0x3B53 / 15187
{
	int iVar0;
	int iVar1;
	...
	{
		Function_107(&(Local_5[iLocal_7812]), bParam0);
		iLocal_78++;
	}
...
void Function_107(int iParam0, int iParam1) //Position: 0x3BB5 / 15285
{
...
void Function_108(int iParam0) //Position: 0x3BC9 / 15305
{
	iParam0 = iParam0;
	return;
}

void Function_109(int iParam0) //Position: 0x3BD3 / 15315
{
