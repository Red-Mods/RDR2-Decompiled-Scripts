...
void main() //Position: 0x0 / 0
{
	...
	iLocal_83 = 0;
	Function_100(uScriptParam_0, &iLocal_83);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_84);
		}
		iVar2 = 0;
		bLocal_89 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			{
				if (Local_10[iVar012].f_12 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_83;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(Local_10[iVar312]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), Local_10[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (Local_10[iVar312].f_16 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_86("eGRINGO_EndUse: Stop use by request", Local_10[iVar312].f_16);
							Function_85(Local_10[iVar312].f_16, 1);
							if (IS_ACTOR_VALID(Local_10[iVar312].f_16))
							{
								if (IS_ACTOR_LOCAL_PLAYER(Local_10[iVar312].f_16) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(Local_10[iVar312].f_12))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(Local_10[iVar312].f_16, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_77(&(Local_10[iVar312]), 0);
							}
							else if (Local_10[iVar312].f_44 < 8)
							{
								Function_76(&(Local_10[iVar312]));
								Local_10[iVar312].f_44 = 8;
							}
							bVar5 = true;
						}
						else
		...
		else
		{
			...
			while (iVar0 < (iLocal_83 - 1))
			{
				if (Function_75(Local_10[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_10[iVar012])))
					{
						Function_103("Quitting due to update end");
						Function_77(&(Local_10[iVar012]), 1);
					}
				}
				if (Function_15(&(Local_10[iVar012]), 0))
				{
					Function_5(&(Local_10[iVar012]));
				}
				iVar0++;
			}
		}
	...
	while (iVar0 < (iLocal_83 - 1))
	{
		if (Function_75(Local_10[iVar012].f_40, 2))
		{
			Function_2("Gringo termination calls StopUse", Local_10[iVar012].f_16);
			Function_77(&(Local_10[iVar012]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(Local_10[iVar012].f_12))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", Local_10[iVar012].f_12);
		}
		Function_15(&(Local_10[iVar012]), 1);
		iVar0++;
	}
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_90))
								{
									...
									{
										bLocal_90 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_90 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_90))
		{
			Function_103("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_90);
		}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_88, &cLocal_87);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0D / 7437
{
	...
	{
		bLocal_0 = CREATE_LAYOUT(Function_27());
	}
	if ((GET_CURRENT_GAME_TIME() - fLocal_2) < 1.6f)
	{
		if (!IS_OBJECT_VALID(bLocal_1))
		{
			vLocal_3 = { 0.0f, -0.05f, -0.6f };
			GET_OBJECT_RELATIVE_POSITION(GET_OBJECT_FROM_ACTOR(bParam0), vLocal_3, &vLocal_6);
...
var Function_27() //Position: 0x1D9D / 7581
{
	int iVar0;
...
bool Function_28(bool bParam0) //Position: 0x1DA5 / 7589
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1DC4 / 7620
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1DCA / 7626
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x1DD8 / 7640
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1DE3 / 7651
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DFD / 7677
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x1E1B / 7707
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x1E3A / 7738
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (Local_10 - 1))
	{
		if (Local_10[iVar012].f_12 == bParam0)
		{
			return Local_10[iVar012].f_16;
		}
		iVar0++;
	}
	return iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1E6D / 7789
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1E8C / 7820
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1EA6 / 7846
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EB9 / 7865
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_27(), Function_40(uParam0->f_12, &bVar10), false, bVar9);
	}
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x21A1 / 8609
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21BE / 8638
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21CD / 8653
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21EF / 8687
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2213 / 8723
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2230 / 8752
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2250 / 8784
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2270 / 8816
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x231E / 8990
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x238E / 9102
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23A4 / 9124
{
...
var Function_51(bool bParam0) //Position: 0x23C5 / 9157
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23E5 / 9189
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23F9 / 9209
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2403 / 9219
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x240A / 9226
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2419 / 9241
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x2458 / 9304
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2483 / 9347
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x248E / 9358
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2584 / 9604
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x25A6 / 9638
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25CD / 9677
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (IS_OBJECT_VALID(bVar24))
	{
		...
		bVar26 = CREATE_POINT_IN_LAYOUT(bVar25, Function_27(), vVar17, 0.0f, 0.0f, 0.0f);
		...
		if (bVar28)
		{
			...
			ATTACH_OBJECTS(bVar26, GRINGO_GET_MY_OBJECT_REF(), Function_27(), vVar36, 0.0f, 0.0f, 0.0f, 4294967295);
		}
...
vector3 Function_63(vector3 vParam0) //Position: 0x288C / 10380
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28E9 / 10473
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2946 / 10566
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2950 / 10576
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x296E / 10606
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2983 / 10627
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A0A / 10762
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A2D / 10797
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A4B / 10827
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A6E / 10862
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B89 / 11145
{
...
int Function_74(bool bParam0) //Position: 0x2BB4 / 11188
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CB9 / 11449
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CC6 / 11462
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D39 / 11577
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_88)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_87));
		iLocal_88 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_37(iParam0->f_12))
...
void Function_78() //Position: 0x3237 / 12855
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x326E / 12910
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x328B / 12939
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32C3 / 12995
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32CD / 13005
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x32EE / 13038
{
	iParam1 = iParam1;
	...
	if (!IS_OBJECT_VALID(bLocal_1))
	{
		bLocal_1 = CREATE_PROP_IN_LAYOUT(bLocal_0, "dynamite02x0", "$/fragments/p_gen_dynamite02x", vLocal_6, 290.0f, 51.23545f, 0.0f, 1);
	}
	while ((GET_CURRENT_GAME_TIME() - fLocal_2) > 10.0f)
	{
		if (IS_OBJECT_VALID(bLocal_1))
		{
		}
	...
	Function_84(&vLocal_6, "DynamiteExplosion", 0, 1);
	RELEASE_LAYOUT_REF(bLocal_0);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var uParam0, char* cParam1, bool bParam2, int iParam3) //Position: 0x33B1 / 13233
{
	vector3 vVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33CD / 13261
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x34D5 / 13525
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x34EB / 13547
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_88(iParam0->f_16, bVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_88(bool bParam0, int iParam1) //Position: 0x37A1 / 14241
{
	iParam1 = iParam1;
...
bool Function_89(bool bParam0) //Position: 0x37B8 / 14264
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x37D1 / 14289
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x37EB / 14315
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_92(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3823 / 14371
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x383A / 14394
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3B03 / 15107
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3B20 / 15136
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3BBC / 15292
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3BDB / 15323
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3BEA / 15338
{
...
void Function_99(int iParam0) //Position: 0x3C06 / 15366
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C10 / 15376
{
	int iVar0;
	int iVar1;
	...
	{
		Function_101(&(Local_10[iLocal_8312]), bParam0);
		iLocal_83++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3C72 / 15474
{
...
void Function_102(int iParam0) //Position: 0x3C86 / 15494
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3C90 / 15504
{
