...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		...
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 2E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar1, 0.00015f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD3C / 3388
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xEBA / 3770
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xF26 / 3878
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF92 / 3986
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x100E / 4110
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0x1053 / 4179
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0x1060 / 4192
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0x106C / 4204
{
	if (!Function_4(128))
	{
		return;
