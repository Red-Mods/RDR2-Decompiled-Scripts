...
void main() //Position: 0x0 / 0
{
	...
	vVar0 = { 720.806f, 78.477f, 1331.567f };
	bVar3 = 17.542f;
	CAMERA_RESET(0);
	...
	CAMERA_RESET(0);
	Function_4(1, 0, 1);
	while ((!Function_1(Global_30717[0]) || !STREAMING_IS_WORLD_LOADED()) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	if (HUD_IS_FADED())
...
bool Function_3(int iParam0) //Position: 0xC8 / 200
{
...
void Function_4(var uParam0, bool bParam1, int iParam2) //Position: 0xDE / 222
{
	int iVar0;
...
bool Function_5() //Position: 0x1E9 / 489
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_6(int iParam0) //Position: 0x1F2 / 498
{
...
bool Function_7() //Position: 0x271 / 625
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x2DA / 730
{
	int iVar0;
...
void Function_9(var uParam0, int iParam1) //Position: 0x2F1 / 753
{
