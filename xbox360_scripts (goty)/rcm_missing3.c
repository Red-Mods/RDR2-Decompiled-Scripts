...
void main() //Position: 0x0 / 0
{
	...
	iLocal_246 = 16;
	iLocal_247 = 0;
	vLocal_256 = { -2641.181f, 67.263f, 3409.389f };
	bLocal_263 = false;
	switch (StackVal)
	{
		case 0x00000001:
			...
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					case 0x00000000:
						...
						{
							if (IS_LAYOUTREF_VALID(bLocal_264))
							{
								Function_187(&(Global_63541[2155]), 21, 0x41f00000, 0x42200000, 0);
								bLocal_265 = CREATE_VOLUME_IN_LAYOUT(bLocal_264, "zombieStayOut", 2, *(&Global_63541[2155] + 100), 0.0f, Global_63541[2155].f_124, 0.0f, 10.0f, 10.0f, 10.0f);
							...
							{
								bLocal_264 = CREATE_LAYOUT("RCM_Missing_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						{
							Function_186(&Global_63541[ScriptParam_055] + 144, 128);
						...
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (bLocal_263)
							{
								if (StackVal && FABS((StackVal - !Function_177(Global_34573, 1, 1))) > 2.0f)
								{
									if (Function_176(&uLocal_260, 1.0f))
									{
										if (Function_175() || DECOR_CHECK_EXIST(Global_34573, "debugRCMMissing2"))
										{
											if (!DECOR_CHECK_EXIST(Global_34573, "Missing3_ShutUp"))
											{
												if (GATEWAY_UPDATE(Global_63541[ScriptParam_055].f_192))
												{
													DECOR_SET_BOOL(Global_34573, "Missing3_ShutUp", true);
												}
											}
											if (Function_171(Global_63541[ScriptParam_055].f_192, 0, 1, 1, 1, 0))
											{
					...
					case 0x00000003:
						if (Function_130("$/cutscene/MISSING_PERSONS_3_CS_SEQ/MISSING_PERSONS_3_CS_SEQ", &iLocal_248, 32642, 32635, 31419, 31372, 31086, 31070, 1, 1, 2, 2, 0))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_186(&Global_63541[2155] + 144, 256);
							Global_3412 = 1;
							Global_3416 = 7;
							Function_128(1, 0, 1);
							ACTOR_ADD_WEAPON_AMMO(Global_34573, true, 7.0f);
							_ADD_AMMO_OF_TYPE(Global_34573, 6, 7.0f, 0, 1);
							Function_126(72, 1);
							if (!Function_125(4, 0))
							{
							...
							Function_113(657, 1, 0, 0);
							Function_59(21, 1, 1, 0);
							Function_1();
							Function_186(&Global_63541[ScriptParam_055] + 144, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_181();
...
void Function_1() //Position: 0x39F / 927
{
	bool bVar0;
	bool bVar1;
...
void Function_2(bool bParam0) //Position: 0x3D0 / 976
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_46(Global_63541[iVar155].f_144, 2048))
				{
					...
					{
						Function_186(&Global_63541[iVar155] + 144, 64);
...
void Function_3(int iParam0, int iParam1) //Position: 0x572 / 1394
{
	float fVar0;
	bool bVar1;
...
void Function_4(int iParam0) //Position: 0x62C / 1580
{
	float fVar0;
	bool bVar1;
...
int Function_5(var uParam0, int iParam1) //Position: 0x6CE / 1742
{
	int iVar0;
	var uVar1;
...
void Function_6(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x82F / 2095
{
	struct<8> Var0;
...
struct<32> Function_7(bool bParam0) //Position: 0x8CA / 2250
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_8(char* cParam0, char* cParam1, char* cParam2) //Position: 0x934 / 2356
{
	char* cVar0[32];
...
int Function_9(bool bParam0) //Position: 0x953 / 2387
{
	int iVar0;
	vector3 vVar1;
...
float Function_10(bool bParam0, vector3 vParam1) //Position: 0xAB4 / 2740
{
	vector3 vVar0;
...
vector3 Function_11(bool bParam0) //Position: 0xB2E / 2862
{
	vector3 vVar0;
...
void Function_12(int iParam0) //Position: 0xB98 / 2968
{
...
bool Function_13(int iParam0) //Position: 0xBF9 / 3065
{
...
var Function_14() //Position: 0xC0F / 3087
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1) //Position: 0xC17 / 3095
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_21(StackVal, Function_22(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_20(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_46(Global_63541[iParam155].f_144, 64))
	{
...
void Function_16(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x10A9 / 4265
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_17(int iParam0) //Position: 0x1124 / 4388
{
	char* cVar0[16];
...
bool Function_18() //Position: 0x1163 / 4451
{
...
bool Function_19() //Position: 0x117E / 4478
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(bool bParam0) //Position: 0x11AB / 4523
{
...
var Function_21(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x11D7 / 4567
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_22(int iParam0) //Position: 0x11F3 / 4595
{
...
bool Function_23(int iParam0, int iParam1) //Position: 0x1208 / 4616
{
	...
	{
		Function_186(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
...
bool Function_24(int iParam0, int iParam1) //Position: 0x131D / 4893
{
	int iVar0;
...
bool Function_25(int iParam0) //Position: 0x1461 / 5217
{
...
bool Function_26(int iParam0) //Position: 0x1485 / 5253
{
...
bool Function_27(int iParam0) //Position: 0x149A / 5274
{
...
var Function_28(int iParam0) //Position: 0x14B1 / 5297
{
...
bool Function_29(int iParam0) //Position: 0x14CB / 5323
{
...
bool Function_30(int iParam0) //Position: 0x14E1 / 5345
{
	return StackVal;
}

bool Function_31(var uParam0, int iParam1) //Position: 0x14F1 / 5361
{
	int iVar0;
...
bool Function_32(int iParam0) //Position: 0x150D / 5389
{
	if (!iParam0->f_152)
	{
		if (Function_18())
...
bool Function_33(int iParam0) //Position: 0x15B1 / 5553
{
...
void Function_34(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x160A / 5642
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0, int iParam1) //Position: 0x1676 / 5750
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(bool bParam0, var uParam1, int iParam2) //Position: 0x16AD / 5805
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x1725 / 5925
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x17C6 / 6086
{
	int iVar0;
	int iVar1;
...
void Function_39(int iParam0, int iParam1) //Position: 0x1803 / 6147
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_40(var uParam0, int iParam1) //Position: 0x1816 / 6166
{
...
bool Function_41(int iParam0) //Position: 0x1829 / 6185
{
	int iVar0;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x1845 / 6213
{
	int iVar0;
...
int Function_43(int iParam0) //Position: 0x1861 / 6241
{
...
bool Function_44(int iParam0) //Position: 0x1876 / 6262
{
...
int Function_45(int iParam0) //Position: 0x188B / 6283
{
...
bool Function_46(bool bParam0, bool bParam1) //Position: 0x18A0 / 6304
{
...
void Function_47() //Position: 0x18AD / 6317
{
	if (Function_51(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_8 = Function_48(StackVal, Global_28180);
			Global_28180.f_12 = 0;
		}
...
var Function_48(int iParam0, int iParam1) //Position: 0x1928 / 6440
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
	...
	switch (iParam0)
	{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_44(26) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_44(25) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_44(24) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_44(23) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
				...
				case 0x00000008:
					if (Function_44(55) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_44(54) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_44(27) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_44(52) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_44(51) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_44(50) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_44(49) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_44(19) && iVar19)
					{
						vVar0 = { -1708.36f, 46.18f, 2175.89f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_125(6, 0) && Function_44(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_44(17) && iVar19)
					{
						vVar0 = { -1687.208f, 53.208f, 2140.491f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_125(9, 0) && Function_44(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_44(15) && iVar19)
					{
...
bool Function_49(vector3 vParam0) //Position: 0x2519 / 9497
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_50(int iParam0) //Position: 0x2531 / 9521
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x2580 / 9600
{
...
int Function_52(int iParam0) //Position: 0x2596 / 9622
{
...
void Function_53() //Position: 0x25FF / 9727
{
...
bool Function_54(int iParam0) //Position: 0x2622 / 9762
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x2673 / 9843
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x26A0 / 9888
{
	if (!Function_51(iParam0))
	{
...
bool Function_57() //Position: 0x26F2 / 9970
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_58(bool bParam0) //Position: 0x26FB / 9979
{
	int iVar0;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2735 / 10037
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2B64 / 11108
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_61() //Position: 0x2CD7 / 11479
{
	return;
}

void Function_62(bool bParam0, int iParam1) //Position: 0x2CDD / 11485
{
	if (Global_3381)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2D1F / 11551
{
...
void Function_64() //Position: 0x2D70 / 11632
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2DC2 / 11714
{
...
void Function_66() //Position: 0x2EC8 / 11976
{
	float fVar0;
...
void Function_67() //Position: 0x2EFB / 12027
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3089 / 12425
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x323D / 12861
{
	Function_70(&Global_28260, 1, 0);
	return;
}

void Function_70(int iParam0, bool bParam1, var uParam2) //Position: 0x324B / 12875
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x343C / 13372
{
...
struct<8> Function_72(int iParam0) //Position: 0x3451 / 13393
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x34F7 / 13559
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x3792 / 14226
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_75(int iParam0) //Position: 0x3DBF / 15807
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3DD0 / 15824
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0, bool bParam1) //Position: 0x3EC5 / 16069
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3EDE / 16094
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x3F43 / 16195
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x3F55 / 16213
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3F67 / 16231
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x4099 / 16537
{
	return Global_35278[iParam020].f_48;
}

float Function_83(int iParam0) //Position: 0x40A8 / 16552
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x40E1 / 16609
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x411E / 16670
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x42B8 / 17080
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x44FC / 17660
{
...
struct<8> Function_88() //Position: 0x453D / 17725
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x45C6 / 17862
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x465D / 18013
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x46DC / 18140
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x4715 / 18197
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x491F / 18719
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_94(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x49DA / 18906
{
	int iVar0;
...
vector3 Function_95() //Position: 0x4AC1 / 19137
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_96(int iParam0) //Position: 0x4ACA / 19146
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x4AE0 / 19168
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_98(vector3 vParam0, vector3 vParam3) //Position: 0x4BA7 / 19367
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_99(var uParam0, int iParam1) //Position: 0x4BC4 / 19396
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_100(int iParam0) //Position: 0x53E9 / 21481
{
	var uVar0;
...
void Function_101(bool bParam0, bool bParam1) //Position: 0x5424 / 21540
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_102(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x5431 / 21553
{
	iParam0 = iParam0;
...
void Function_103(int iParam0) //Position: 0x54D5 / 21717
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_44(4) && !Function_107(0))
	{
	...
	if (!Function_31(&Global_3422[240] + 128, 2) || ((((((Function_44(14) && Function_44(18)) && Function_44(37)) && Function_44(7)) && Function_44(11)) && Function_44(5)) && Function_44(21)))
	{
	...
	if (!Function_31(&Global_3422[340] + 128, 2) || ((Function_44(27) && Function_44(1)) && Function_44(23)))
	{
	...
	if (!Function_44(7))
	{
		...
		if (((Function_44(6) && Function_104(Global_30735) < 0) && Function_104(Global_30737) < 0) && Function_104(Global_30738) < 0)
		{
...
int Function_104(int iParam0) //Position: 0x5DCA / 24010
{
	if (!Function_27(iParam0))
	{
		return 4294967295;
...
bool Function_105() //Position: 0x5DE4 / 24036
{
	return STRING_TO_HASH(Function_106());
}

var Function_106() //Position: 0x5DF0 / 24048
{
	return "ZOMBIE_STORY";
}

bool Function_107(int iParam0) //Position: 0x5E05 / 24069
{
...
int Function_108(int iParam0) //Position: 0x5E6B / 24171
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_109(char* cParam0) //Position: 0x5F2D / 24365
{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x5F75 / 24437
{
	bool bVar0;
...
void Function_111() //Position: 0x5F9A / 24474
{
	bool bVar0;
...
void Function_112(bool bParam0) //Position: 0x5FF8 / 24568
{
	PRINTSTRING("Day ");
...
int Function_113(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x603E / 24638
{
	int iVar0;
	int iVar1;
...
void Function_114(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x625E / 25182
{
	struct<4> Var0;
	int iVar4;
...
void Function_115(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x62E3 / 25315
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_122(bParam0, bParam1))
	{
		...
		if (StackVal && !Function_46(((((!Function_19() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, false, false, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_46((((Function_19() || Global_3380) || Global_3392) || Global_3384), 1))
		{
...
void Function_116(int iParam0, bool bParam1) //Position: 0x6579 / 25977
{
	bool bVar0;
...
void Function_117(int iParam0, bool bParam1) //Position: 0x65E0 / 26080
{
...
void Function_118(bool bParam0) //Position: 0x664B / 26187
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
...
int Function_119(int iParam0) //Position: 0x67FB / 26619
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_120(int iParam0) //Position: 0x6852 / 26706
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_121(bool bParam0) //Position: 0x68A8 / 26792
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122(bool bParam0, int iParam1) //Position: 0x68B4 / 26804
{
	int iVar0;
...
void Function_123(int iParam0, int iParam1) //Position: 0x6913 / 26899
{
	if (!Function_51(iParam0))
	{
...
bool Function_124(int iParam0) //Position: 0x6968 / 26984
{
...
bool Function_125(int iParam0, bool bParam1) //Position: 0x6984 / 27012
{
	int iVar0;
...
int Function_126(bool bParam0, bool bParam1) //Position: 0x69C1 / 27073
{
	...
	if (bParam1)
	{
		if (GET_ITEM_COUNT(Function_127(bParam0), Function_71()) >= 0)
		{
			DELETE_ITEM(Function_127(bParam0), Function_71(), 0);
			return 1;
		}
	}
	DELETE_ITEM(Function_127(bParam0), Function_71(), 1);
	return 1;
}

var Function_127(bool bParam0) //Position: 0x6A08 / 27144
{
	bool bVar0;
...
int Function_128(bool bParam0, bool bParam1, int iParam2) //Position: 0x6AF9 / 27385
{
...
bool Function_129(bool bParam0) //Position: 0x6B50 / 27472
{
	if (bParam0 == 4294967295)
	{
		return 0;
...
bool Function_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6B62 / 27490
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_131(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x6C0B / 27659
{
	if (!bParam15)
	{
	...
	{
		case 0x000003E8:
			if (*uParam3 != 99 && (Function_146(iParam2) || iParam2->f_24 < 1))
			{
				*iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), bParam0) || !Function_143())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_139(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_137(Global_63117, Global_6289);
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && *uParam3 == 99) && !Function_146(iParam2))
			{
...
void Function_132(bool bParam0) //Position: 0x721F / 29215
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_133() //Position: 0x72CE / 29390
{
	bool bVar0;
...
void Function_134() //Position: 0x7340 / 29504
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_135() //Position: 0x7385 / 29573
{
...
void Function_136(bool bParam0) //Position: 0x7397 / 29591
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_137(bool bParam0, bool bParam1) //Position: 0x73B4 / 29620
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(bVar0))
	{
		...
		if (IS_OBJECT_VALID(bVar2))
		{
			...
			if ((bVar3 == Global_34573 && !Function_138(bVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(bVar3))
			{
...
bool Function_138(bool bParam0) //Position: 0x7434 / 29748
{
	int iVar0;
...
float Function_139(int iParam0) //Position: 0x7463 / 29795
{
...
bool Function_140(int iParam0) //Position: 0x752B / 29995
{
	return Function_46(*iParam0, 2);
}

bool Function_141(int iParam0) //Position: 0x7538 / 30008
{
	return Function_46(*iParam0, 1);
}

int Function_142(bool bParam0) //Position: 0x7545 / 30021
{
	int iVar0;
	bool bVar1;
...
bool Function_143() //Position: 0x75FD / 30205
{
	int iVar0;
	bool bVar1;
...
void Function_144(int iParam0) //Position: 0x7637 / 30263
{
	Function_145(iParam0, 0.0f);
	return;
}

void Function_145(var uParam0, float fParam1) //Position: 0x7643 / 30275
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_186(uParam0, 1);
	Function_39(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

bool Function_146(int iParam0) //Position: 0x7664 / 30308
{
	return iParam0->f_20;
}

void Function_147(var uParam0, int iParam1) //Position: 0x766E / 30318
{
	Function_148(uParam0, iParam1, 0);
	return;
}

void Function_148(var uParam0, bool bParam1, bool bParam2) //Position: 0x767C / 30332
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_149(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x77C8 / 30664
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_150() //Position: 0x77F1 / 30705
{
	bool bVar0;
	bool bVar1;
...
void Function_151() //Position: 0x783C / 30780
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_152() //Position: 0x795E / 31070
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_153() //Position: 0x796E / 31086
{
	Function_154(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_255);
	return 1;
}

void Function_154(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x7987 / 31111
{
	bool bVar0;
...
void Function_155() //Position: 0x7A77 / 31351
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_156() //Position: 0x7A8C / 31372
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -2661.784f, 67.263f, 3426.978f, 293.165f, 1, true, 1);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1073741824, 0);
	return 1;
}

int Function_157() //Position: 0x7ABB / 31419
{
	if (!iLocal_259)
	{
		Function_158(StackVal, StackVal, vLocal_256, bLocal_255);
		iLocal_259 = 1;
	}
	return 1;
}

void Function_158(vector3 vParam0) //Position: 0x7AD7 / 31447
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!Function_49(StackVal, StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			else if (Function_159(bVar1, Global_34573) > 4.0f)
			{
				TELEPORT_ACTOR(bVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1.5f);
				vVar3.f_8 = (vParam0.z + 1.5f);
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (bVar0 != bVar1)
			{
				...
				else if (Function_159(bVar0, Global_34573) > 4.0f)
				{
					TELEPORT_ACTOR(bVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2.5f);
					vVar3.f_8 = (vParam0.z + 2.5f);
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			...
			else if (Function_159(bVar2, Global_34573) > 8.0f)
			{
				TELEPORT_ACTOR(bVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_159(bool bParam0, bool bParam1) //Position: 0x7C5D / 31837
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_160(bool bParam0, float fParam1) //Position: 0x7D4E / 32078
{
...
void Function_161() //Position: 0x7E4C / 32332
{
...
void Function_162() //Position: 0x7E7E / 32382
{
...
int Function_163() //Position: 0x7F7B / 32635
{
	return 1;
}

int Function_164() //Position: 0x7F82 / 32642
{
	bLocal_255 = CREATE_VOLUME_IN_LAYOUT(bLocal_264, "tempcutscenevol", 2, -2661.417f, 67.263f, 3429.102f, 0.0f, 0.0f, 0.0f, 20.0f, 15.0f, 20.0f);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_167(0, 0, 1, 1, 0, 1, 1, bLocal_255, 1, 1, 1, 1);
	Function_165(StackVal, StackVal, bLocal_264, *(&Global_63541[2155] + 112), &bLocal_255, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_165(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x8017 / 32791
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_VOLUME_VALID(*uParam4))
	{
		...
		if (!Global_3380)
		{
			...
			if (IS_ACTOR_VALID(bVar1))
			{
				Function_166(bVar1, bParam0);
			}
		}
		if (!Function_49(StackVal, StackVal, vVar2))
		{
			if (!IS_ACTOR_VALID(bVar0))
			{
...
void Function_166(bool bParam0, bool bParam1) //Position: 0x8285 / 33413
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_167(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x82FA / 33530
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_170(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_14(), 2, Function_170(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_168(bool bParam0) //Position: 0x85A8 / 34216
{
	bool bVar0;
...
var Function_169() //Position: 0x85DC / 34268
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_170(bool bParam0) //Position: 0x865B / 34395
{
	vector3 vVar0;
...
bool Function_171(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x866C / 34412
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_174(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_173(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_173(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_172(&iVar6, &vVar3);
				}
				else
				{
...
int Function_172(int iParam0, int iParam1) //Position: 0x887E / 34942
{
	var uVar0;
...
float Function_173(bool bParam0, bool bParam1) //Position: 0x88E9 / 35049
{
	vector3 vVar0;
...
void Function_174(bool bParam0, bool bParam1) //Position: 0x8908 / 35080
{
	bool bVar0;
	bool bVar1;
	...
	else if (!bParam1 || Function_173(bParam0, 0) < 2.0f)
	{
...
int Function_175() //Position: 0x8965 / 35173
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	
	bVar0 = CREATE_VOLUME_IN_LAYOUT(bLocal_264, "nsearchVol", 2, *(&Global_63541[2155] + 100), 0.0f, 0.0f, 0.0f, 50.0f, 20.0f, 50.0f);
	bVar1 = FIND_NAMED_LAYOUT("RCM_Missing2_Layout");
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		bVar2 = FIND_ACTOR_IN_LAYOUT(bVar1, "nmillicent");
	}
	if (IS_ACTOR_VALID(bVar2))
	{
		if (IS_ACTOR_IN_VOLUME(bVar2, bVar0))
		{
...
bool Function_176(int iParam0, float fParam1) //Position: 0x89FA / 35322
{
	if (Function_141(iParam0))
	{
...
bool Function_177(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8A16 / 35350
{
...
bool Function_178() //Position: 0x8ACC / 35532
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_179(bool bParam0) //Position: 0x8AE3 / 35555
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_180(bool bParam0) //Position: 0x8AEE / 35566
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_181() //Position: 0x8AFC / 35580
{
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_183(0);
	if (IS_LAYOUTREF_VALID(bLocal_264))
...
int Function_182(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8B8B / 35723
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_183(int iParam0) //Position: 0x8BBA / 35770
{
	Function_185(0);
	Function_184();
	...
	if (iParam0 == 1)
	{
		Function_39(&Global_26303 + 8, 4096);
	}
	return;
}

void Function_184() //Position: 0x8BFC / 35836
{
	Function_39(&Global_26303 + 8, 2);
	Function_39(&Global_26303 + 8, 4);
	Function_39(&Global_26303 + 8, 8);
	Function_39(&Global_26303 + 8, 16);
	Function_39(&Global_26303 + 8, 32);
	Function_39(&Global_26303 + 8, 64);
	Function_39(&Global_26303 + 8, 128);
	Function_39(&Global_26303 + 8, 256);
	Function_39(&Global_26303 + 8, 512);
	Function_39(&Global_26303 + 8, 1024);
	Function_39(&Global_26303 + 8, 2048);
	Function_39(&Global_26303 + 8, 131072);
	Function_39(&Global_26303 + 8, 262144);
	Function_39(&Global_26303 + 8, 524288);
	return;
}

void Function_185(int iParam0) //Position: 0x8C96 / 35990
{
	if (iParam0 == 1)
	{
		Function_186(&Global_26303 + 8, 1);
	}
	else
	{
		Function_39(&Global_26303 + 8, 1);
	}
	return;
}

void Function_186(var uParam0, int iParam1) //Position: 0x8CB7 / 36023
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_187(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x8CC6 / 36038
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_189(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_189(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_188(float fParam0) //Position: 0x8E27 / 36391
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_188(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_189(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x8E5C / 36444
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_192(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_193()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
		...
		if ((iParam13 && Global_3380) && CUTSCENE_MANAGER_IS_CUTFILE_LOADED())
		{
			...
			{
				if (!Function_49(StackVal, StackVal, vVar16))
				{
					if (HUD_IS_FADED())
					{
	...
	else if ((!Function_192(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_193()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_192(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_190() //Position: 0x90A2 / 37026
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_191(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_191(char* cParam0, vector3 vParam1) //Position: 0x90F6 / 37110
{
	char* cVar0[64];
...
bool Function_192(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x921E / 37406
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_11(bParam0);
...
int Function_193() //Position: 0x92A8 / 37544
{
	if (IS_PS3())
	{
		return 1;
...
void Function_194(var uParam0) //Position: 0x92B7 / 37559
{
