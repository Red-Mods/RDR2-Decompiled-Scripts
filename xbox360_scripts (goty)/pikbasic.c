...
void main() //Position: 0x0 / 0
{
	...
	if (Function_132())
	{
		Local_39.f_1892 = 35.0f;
		vVar0[03] = { -1212.94f, 74.254f, 2374.71f };
		vVar0[13] = { -1213.15f, 74.357f, 2369.593f };
		vVar0[23] = { -1209.799f, 75.294f, 2365.959f };
		vVar0[33] = { -1205.28f, 75.295f, 2368.28f };
		vVar0[43] = { -1208.984f, 74.82f, 2370.928f };
		Function_99(&vVar0, 0);
		Function_97(1);
		if (Function_96(Global_79962, 128))
		{
			Function_95(2, 5000, 1200);
			Function_95(1, 4200, 900);
			Function_95(0, 3500, 600);
			Function_93(2, 9.0f, 500);
			Function_93(1, 12.0f, 250);
			Function_93(0, 30.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(90);
		}
		else
		{
			Function_95(2, 3700, 970);
			Function_95(1, 3000, 670);
			Function_95(0, 2500, 370);
			Function_93(2, 6.0f, 500);
			Function_93(1, 8.0f, 250);
			Function_93(0, 12.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(36);
		}
...
void Function_1() //Position: 0x173 / 371
{
...
void Function_2() //Position: 0x1A2 / 418
{
	Function_3();
	return;
}

void Function_3() //Position: 0x1AB / 427
{
...
void Function_4(int iParam0, bool bParam1, int iParam2) //Position: 0x2B4 / 692
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_5(var uParam0, int iParam1) //Position: 0x2DC / 732
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_6(var uParam0, int iParam1) //Position: 0x2EF / 751
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_7(int iParam0) //Position: 0x2FE / 766
{
	return Function_96(Global_76905.f_132, iParam0);
}

void Function_8() //Position: 0x30F / 783
{
	bool bVar0;
...
var Function_9(bool bParam0) //Position: 0x328 / 808
{
	bool bVar0;
...
var Function_10() //Position: 0x375 / 885
{
...
void Function_11(int iParam0) //Position: 0x3A4 / 932
{
	int iVar0;
...
void Function_13(var uParam0, int iParam1) //Position: 0x4F8 / 1272
{
	int iVar0;
...
bool Function_14(var uParam0, int iParam1) //Position: 0x512 / 1298
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1, int iParam2) //Position: 0x52F / 1327
{
...
void Function_16(var uParam0, var uParam1, int iParam2) //Position: 0x6C8 / 1736
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_17(bool bParam0, int iParam1, int iParam2) //Position: 0x840 / 2112
{
	var uVar0;
...
int Function_18(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x851 / 2129
{
	char* cVar0[32];
...
bool Function_19(bool bParam0, int iParam1, bool bParam2) //Position: 0x8B6 / 2230
{
	char* cVar0[64];
	int iVar16;
...
var Function_20(int iParam0) //Position: 0x937 / 2359
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_21(bool bParam0) //Position: 0xC50 / 3152
{
	char* cVar0[64];
...
void Function_22(bool bParam0) //Position: 0xCF1 / 3313
{
...
bool Function_23() //Position: 0xD0B / 3339
{
	return Function_7(32768);
}

void Function_24() //Position: 0xD18 / 3352
{
	Function_4(32768, 1, 0);
	return;
}

int Function_25() //Position: 0xD27 / 3367
{
	int iVar0;
	int iVar1;
...
void Function_26(int iParam0, int iParam1) //Position: 0xD51 / 3409
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_27(bool bParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xEDA / 3802
{
...
int Function_28(int iParam0) //Position: 0xEFD / 3837
{
	*iParam0 = (*iParam0 - 1);
	return *iParam0 + 1;
}

void Function_29(var uParam0, bool bParam1) //Position: 0xF10 / 3856
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_30(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x11E8 / 4584
{
	bool bVar0;
...
var Function_31(var uParam0, int iParam1, bool bParam2) //Position: 0x1239 / 4665
{
	int iVar0;
...
var Function_32(bool bParam0) //Position: 0x1258 / 4696
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_33(int iParam0) //Position: 0x1264 / 4708
{
...
int Function_34(int iParam0, var uParam1, int iParam2) //Position: 0x1284 / 4740
{
	bool bVar0;
	int iVar1;
...
int Function_35(int iParam0, int iParam1, int iParam2) //Position: 0x12D7 / 4823
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x1318 / 4888
{
	int iVar0;
...
void Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x133E / 4926
{
	float fVar0;
...
var Function_38(int iParam0) //Position: 0x136F / 4975
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
var Function_39(float fParam0) //Position: 0x138F / 5007
{
	int iVar0;
	float fVar1;
	var uVar2;
...
int Function_40() //Position: 0x13BC / 5052
{
	if (!Function_41())
	{
		return 4294967295;
...
bool Function_41() //Position: 0x13D1 / 5073
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_42(bool bParam0, int iParam1) //Position: 0x13DE / 5086
{
	struct<13> Var0;
...
struct<16> Function_43(var uParam0) //Position: 0x160B / 5643
{
	struct<4> Var0;
	bool bVar4;
...
var Function_44(int iParam0) //Position: 0x167C / 5756
{
...
void Function_45() //Position: 0x174D / 5965
{
	if (!Function_46())
	{
	}
...
bool Function_46() //Position: 0x175A / 5978
{
	return NET_IS_IN_SESSION();
}

bool Function_47(int iParam0) //Position: 0x1763 / 5987
{
	return Function_96(*iParam0, 2);
}

bool Function_48(int iParam0) //Position: 0x1770 / 6000
{
	return Function_96(*iParam0, 1);
}

void Function_49(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x177D / 6013
{
	if (iParam2 != 0)
	{
...
int Function_50(int iParam0) //Position: 0x17CC / 6092
{
	return Function_51(0, iParam0);
}

int Function_51(int iParam0, bool bParam1) //Position: 0x17D8 / 6104
{
	char* cVar0[64];
...
int Function_52(int iParam0) //Position: 0x183F / 6207
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_53(int iParam0, bool bParam1) //Position: 0x184F / 6223
{
	char* cVar0[64];
...
int Function_54(int iParam0) //Position: 0x18BD / 6333
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_55(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x18D6 / 6358
{
	bool bVar0;
	bool bVar1;
...
void Function_56(bool bParam0, bool bParam1) //Position: 0x1976 / 6518
{
	if (Function_7(4))
	{
...
int Function_57(bool bParam0) //Position: 0x19A9 / 6569
{
	return Function_53(12, bParam0);
}

void Function_58(bool bParam0, int iParam1, bool bParam2) //Position: 0x19B6 / 6582
{
	if (bParam0)
	{
		if (Function_23())
...
int Function_59() //Position: 0x19D7 / 6615
{
	if (!Function_61(1))
	{
		return 0;
...
void Function_60() //Position: 0x1A75 / 6773
{
	if (Function_7(4096))
	{
...
bool Function_61(bool bParam0) //Position: 0x1AB2 / 6834
{
	char* cVar0[64];
...
void Function_62(bool bParam0) //Position: 0x1B33 / 6963
{
...
struct<64> Function_63(int iParam0) //Position: 0x1BBC / 7100
{
...
int Function_65(bool bParam0, bool bParam1) //Position: 0x1C15 / 7189
{
...
void Function_66() //Position: 0x1C49 / 7241
{
...
bool Function_67(int iParam0) //Position: 0x1C83 / 7299
{
	return Function_96(StackVal, iParam0);
}

void Function_68() //Position: 0x1C96 / 7318
{
	if (IS_LAYOUTREF_VALID(Local_39.f_1808))
	{
		DESTROY_LAYOUT(Local_39.f_1808);
...
void Function_69(int iParam0) //Position: 0x1CBA / 7354
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_86(StackVal, StackVal, 10491, *(&Local_39 + 1896), 1, iParam0);
	bVar1 = true;
	...
	while (iVar0 <= Local_39.f_1804)
	{
		...
		Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_39[iVar090]), vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.725f, 0.0f), 1, 8773, 0, iVar6, iVar0, "", iVar7);
		if (Function_71(Local_39[iVar090].f_352))
		{
			Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_39[iVar090] + 48, vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.25f, 0.0f), Local_39[iVar090].f_344, 8028, 0, iVar6, iVar0, "", iVar7);
		}
		else
		{
			Function_76(&Local_39[iVar090] + 48);
...
var Function_70(int iParam0, int iParam1) //Position: 0x1F5C / 8028
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_39[iParam190] + 96)[iParam0 + 12]);
}

bool Function_71(bool bParam0) //Position: 0x1F73 / 8051
{
	bool bVar0;
	bool bVar1;
...
void Function_72(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1FB8 / 8120
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_73(float fParam0) //Position: 0x2237 / 8759
{
	return (fParam0 * 57.29578f);
}

int Function_74(var uParam0, int iParam1) //Position: 0x2245 / 8773
{
	uParam0 = uParam0;
	return Function_77(Local_39[iParam190].f_324, 1);
}

void Function_75(int iParam0, int iParam1) //Position: 0x225C / 8796
{
...
void Function_76(int iParam0) //Position: 0x2285 / 8837
{
	if (IS_OBJECT_VALID(*iParam0))
	{
...
int Function_77(int iParam0, bool bParam1) //Position: 0x22AB / 8875
{
	if (bParam1)
	{
		switch (iParam0)
...
var Function_78(int iParam0) //Position: 0x261E / 9758
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_79(int iParam0) //Position: 0x26B5 / 9909
{
	Function_80(&Global_83864 + 1256, iParam0);
	return;
}

void Function_80(var uParam0, int iParam1) //Position: 0x26C7 / 9927
{
	Function_6(uParam0, iParam1);
	return;
}

void Function_81(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x26D4 / 9940
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_82(int iParam0) //Position: 0x274F / 10063
{
	char* cVar0[16];
...
bool Function_83() //Position: 0x278E / 10126
{
...
bool Function_84(int iParam0) //Position: 0x27A9 / 10153
{
	return Function_85(Global_83864.f_1256, iParam0);
}

int Function_85(var uParam0, bool bParam1) //Position: 0x27BB / 10171
{
	return (uParam0 && bParam1) == 0;
}

void Function_86(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x27C8 / 10184
{
	...
	Function_87(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 10390, 1, 125, 0, 0, 0);
...
void Function_87(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x284B / 10315
{
	vector3 vVar0;
	int iVar3;
...
var Function_88(int iParam0, var uParam1) //Position: 0x2896 / 10390
{
	char* cVar0[64];
...
var Function_89() //Position: 0x28FB / 10491
{
	int iVar0;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x2974 / 10612
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_91(var uParam0, var uParam1) //Position: 0x29C0 / 10688
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return "PIK_summary";
...
bool Function_92(int iParam0, bool bParam1) //Position: 0x29DC / 10716
{
	int iVar0;
...
void Function_93(int iParam0, float fParam1, int iParam2) //Position: 0x29FC / 10748
{
	Function_94(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_94(int iParam0, int iParam1) //Position: 0x2A12 / 10770
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_95(int iParam0, int iParam1, bool bParam2) //Position: 0x2A33 / 10803
{
	Function_140(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

bool Function_96(var uParam0, int iParam1) //Position: 0x2A48 / 10824
{
	return (uParam0 && iParam1) == 0;
}

void Function_97(int iParam0) //Position: 0x2A55 / 10837
{
	Function_98(8, iParam0);
	return;
}

void Function_98(int iParam0, bool bParam1) //Position: 0x2A62 / 10850
{
	if (bParam1)
	{
...
void Function_99(var uParam0, bool bParam1) //Position: 0x2A8A / 10890
{
	bool bVar1;
	bool bVar2;
...
void Function_100(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x2CD3 / 11475
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_101(bool bParam0, var uParam1, int iParam2) //Position: 0x2E50 / 11856
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_102(float fParam0) //Position: 0x2F3C / 12092
{
	return (fParam0 * 0.01745329f);
}

var Function_103(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2F4A / 12106
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_104() //Position: 0x2FB6 / 12214
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2FDD / 12253
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_106(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x30CB / 12491
{
...
bool Function_107(int iParam0) //Position: 0x325C / 12892
{
...
bool Function_108(bool bParam0, int iParam1) //Position: 0x326E / 12910
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<228> Function_109(int iParam0, int iParam1) //Position: 0x32CA / 13002
{
	struct<57> Var0;
...
void Function_110(int iParam0, int iParam1) //Position: 0x34AF / 13487
{
	int iVar0;
	int iVar1[17];
	int iVar19;
...
void Function_111(var uParam0, var uParam1) //Position: 0x35EC / 13804
{
...
bool Function_112() //Position: 0x360F / 13839
{
	return Function_113(39);
}

int Function_113(bool bParam0) //Position: 0x361A / 13850
{
	int iVar0;
...
int Function_114(int iParam0, int iParam1) //Position: 0x3648 / 13896
{
...
bool Function_115(int iParam0, int iParam1) //Position: 0x3662 / 13922
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

bool Function_116(int iParam0, var uParam1, int iParam2) //Position: 0x3675 / 13941
{
...
void Function_117(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x3755 / 14165
{
...
void Function_118(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3778 / 14200
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_119(int iParam0) //Position: 0x37A2 / 14242
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_120(int iParam0) //Position: 0x37B2 / 14258
{
	int iVar0;
...
void Function_121(var uParam0, int iParam1) //Position: 0x37DF / 14303
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_122(bool bParam0) //Position: 0x37EB / 14315
{
	Function_118(bParam0, 4294967295, 0, 1);
	return;
}

float Function_123(vector3 vParam0, vector3 vParam3) //Position: 0x37F9 / 14329
{
	var uVar0;
...
void Function_124(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3813 / 14355
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_125() //Position: 0x3836 / 14390
{
...
bool Function_126(int iParam0) //Position: 0x3846 / 14406
{
	int iVar0;
	int iVar1;
...
void Function_127() //Position: 0x3BC1 / 15297
{
	if (!Function_128(128))
	{
		return;
...
bool Function_128(int iParam0) //Position: 0x3C01 / 15361
{
	int iVar0;
...
bool Function_129() //Position: 0x3C1D / 15389
{
	int iVar0;
...
void Function_130(var uParam0, int iParam1) //Position: 0x3C48 / 15432
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_131() //Position: 0x3C59 / 15449
{
	if (!Function_128(128))
	{
		return;
...
bool Function_132() //Position: 0x3C9B / 15515
{
	var uVar0;
	bool bVar3;
	int iVar4;
...
void Function_133() //Position: 0x3DCC / 15820
{
...
void Function_134(char* cParam0, int iParam1) //Position: 0x3DE7 / 15847
{
	char* cVar0[32];
	char* cVar8[32];
...
var Function_135(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3E7E / 15998
{
	int iVar0;
	int iVar1;
...
var Function_136(var uParam0, int iParam1, int iParam2) //Position: 0x3EB6 / 16054
{
	int iVar0;
...
void Function_137(var uParam0, var uParam1) //Position: 0x3F7A / 16250
{
	Function_15(uParam0, uParam1, 16267);
	return;
}

int Function_138() //Position: 0x3F8B / 16267
{
	return 1;
}

bool Function_139() //Position: 0x3F92 / 16274
{
	return Function_67(2);
}

void Function_140(int iParam0, int iParam1) //Position: 0x3F9C / 16284
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
