...
bool Function_18() //Position: 0x42E / 1070
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			iLocal_73 = Function_38(Local_75);
			if (Function_37())
			{
				if (iLocal_73 < 50)
				{
...
void Function_19() //Position: 0x5E2 / 1506
{
	Function_1();
	return;
}

bool Function_20(int iParam0) //Position: 0x5EB / 1515
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_21(int iParam0, bool bParam1) //Position: 0x60C / 1548
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_22(int iParam0, int iParam1) //Position: 0x642 / 1602
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_23(int iParam0) //Position: 0x65D / 1629
{
...
vector3 Function_24(int iParam0) //Position: 0x757 / 1879
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_25(int iParam0, int iParam1, bool bParam2) //Position: 0x851 / 2129
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_26(int iParam0) //Position: 0xDCB / 3531
{
	int iVar0;
	bool bVar1;
...
vector3 Function_27(int iParam0, bool bParam1) //Position: 0xE20 / 3616
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_28(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF32 / 3890
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_29(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1121 / 4385
{
...
bool Function_30() //Position: 0x11D7 / 4567
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_31(bool bParam0) //Position: 0x11EE / 4590
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_32(bool bParam0) //Position: 0x11F9 / 4601
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_33(bool bParam0, bool bParam1) //Position: 0x1207 / 4615
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_34(var uParam0, var uParam1, bool bParam2) //Position: 0x1214 / 4628
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_35() //Position: 0x1256 / 4694
{
	return Function_36(0);
}

int Function_36(bool bParam0) //Position: 0x1260 / 4704
{
...
bool Function_37() //Position: 0x12A1 / 4769
{
...
var Function_38(int iParam0) //Position: 0x12CC / 4812
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_39() //Position: 0x12E6 / 4838
{
	Function_1();
	return;
}

void Function_40() //Position: 0x12EF / 4847
{
	bLocal_74 = CREATE_LAYOUT(Function_53());
	Function_51(0, 1);
	Function_48();
	Function_47();
	Function_41(&uLocal_82);
	Function_41(&iLocal_88);
	Function_41(&iLocal_85);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
...
void Function_41(int iParam0) //Position: 0x133E / 4926
{
...
void Function_42(var uParam0, float fParam1) //Position: 0x1353 / 4947
{
...
void Function_43(var uParam0, int iParam1) //Position: 0x1374 / 4980
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x1387 / 4999
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_45(int iParam0) //Position: 0x1396 / 5014
{
	return Function_46(*iParam0, 1);
}

int Function_46(var uParam0, bool bParam1) //Position: 0x13A3 / 5027
{
	return (uParam0 && bParam1) == 0;
}

void Function_47() //Position: 0x13B0 / 5040
{
	return;
}

void Function_48() //Position: 0x13B6 / 5046
{
	Function_49();
	return;
}

void Function_49() //Position: 0x13BF / 5055
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
void Function_50(int iParam0, int iParam1) //Position: 0x1839 / 6201
{
	switch (iParam1)
	{
		case 0x00000000:
...
void Function_51(bool bParam0, bool bParam1) //Position: 0x1882 / 6274
{
	bool bVar0;
...
void Function_52(var uParam0) //Position: 0x18D9 / 6361
{
	int iVar0;
...
var Function_53() //Position: 0x18F6 / 6390
{
	var uVar0;
