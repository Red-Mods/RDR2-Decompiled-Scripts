...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Mtp", 4);
	Function_12("Loading Manzanita Post population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("ManzanitaPost_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "mtpv_TrnPlatform_set");
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "mtpv_customers_set");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 1, 5, 0, 0, 1);
		}
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "mtpv_store_set");
		if (IS_VOLUME_VALID(bVar3))
		{
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "mtpv_region");
		if (IS_VOLUME_VALID(bVar3))
		{
	...
	Function_5("Finished loading Manzanita Post population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC96 / 3222
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCA5 / 3237
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xCFA / 3322
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD7C / 3452
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD98 / 3480
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDD6 / 3542
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDF2 / 3570
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE02 / 3586
{
	int iVar0;
	int iVar1;
...
var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE53 / 3667
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0xECF / 3791
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xEDC / 3804
{
	if (!Function_4(128))
	{
		return;
