...
void main() //Position: 0x0 / 0
{
	...
	SET_DUST_LEVEL(2);
	ALLOW_TUMBLEWEEDS(1);
	Function_100("Initializing PuntaOrgullo", 3);
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_405)
		{
			...
			case 0x00000003:
				...
				Function_79(&Global_6810, &Global_7947, iScriptParam_0);
				iLocal_405 = 5;
				bLocal_457 = false;
				break;
			
			case 0x00000005:
				if (Function_78(&Global_6810, &Global_7947, iScriptParam_0))
				{
					iLocal_405 = 4;
					bLocal_457 = false;
				}
			...
			case 0x00000006:
				Function_75(0, &uLocal_364, Local_0, -3679.491f, 42.8246f, 2107.083f, -3680.329f, 42.74f, 2115.949f, -3661.467f, 42.165f, 2152.03f, -3661.467f, 42.165f, 2152.03f, -3640.249f, 42.74f, 2104.202f, -3677.26f, 42.74f, 2107.369f);
				Function_75(1, &uLocal_364, Local_0, -3679.491f, 42.8246f, 2107.083f, -3680.329f, 42.74f, 2115.949f, -3661.467f, 42.165f, 2152.03f, -3661.467f, 42.165f, 2152.03f, -3640.249f, 42.74f, 2104.202f, -3677.26f, 42.74f, 2107.369f);
				Function_69(&Global_6810, &Global_7947, &uLocal_364, Global_6289, iScriptParam_0);
				Function_64(4, Local_13.f_1400, Local_13.f_612, 0, 0, 0, Local_0.f_32);
				...
				{
					Function_63(&(Global_29008[iScriptParam_0]), 131072);
					iLocal_405 = 10;
				}
				else
				{
			...
			case 0x00000008:
				Function_48(1, Global_30685[0], -4355.349f, 30.16f, 4384.089f);
				if (!Function_47(&Global_30685))
				{
					Function_43(StackVal, 3, 1.0f, 0, Local_0, !Function_47(&Global_30685));
					Function_42(64);
					Function_38(1, 10, 6, 0, 3);
				}
			...
			case 0x00000009:
				if (!Function_47(&Global_30685))
				{
					Function_36(Local_0, iScriptParam_0);
				}
				Global_29004 = 1;
				Function_84(&(Global_29008[iScriptParam_0]), 4);
				Function_35("Finished Initializing PuntaOrgullo", 5.0f);
				iLocal_405 = 10;
				bLocal_457 = false;
				iLocal_459 = 0;
				break;
				...
				if (!iLocal_459)
				{
					if (IS_LAYOUTREF_VALID(Global_30616))
					{
						...
						if (IS_OBJECT_VALID(bVar1))
						{
							...
							iLocal_459 = Function_32(StackVal, StackVal, vVar2, 0, 0);
							Function_31(StackVal, StackVal, vVar2, 1, &bLocal_462);
						}
					}
				}
	...
	Function_63(&(Global_29008[iScriptParam_0]), 32);
	Function_63(&(Global_29008[iScriptParam_0]), 64);
	Function_63(&(Global_29008[iScriptParam_0]), 8);
	Function_63(&(Global_29008[iScriptParam_0]), 512);
	Function_63(&(Global_29008[iScriptParam_0]), 4);
	if (IS_SCRIPT_VALID(bLocal_460))
	{
		TERMINATE_SCRIPT(bLocal_460);
	}
	Function_35("Unloaded PuntaOrgullo", 5.0f);
...
void Function_11(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x7C8 / 1992
{
	...
	if (Function_77(&(Global_29008[iParam2]), 0x40000000))
	{
		...
		Function_63(&(Global_29008[iParam2]), 0x40000000);
	}
	iVar16 = 0;
	iVar16 = 0;
...
void Function_12(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x9C8 / 2504
{
...
int Function_13(int iParam0) //Position: 0xB17 / 2839
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_14(int iParam0) //Position: 0xB42 / 2882
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_15(var uParam0, int iParam1) //Position: 0xB76 / 2934
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_16(int iParam0) //Position: 0xB85 / 2949
{
	int iVar0;
...
void Function_17(var uParam0, int iParam1) //Position: 0xBA1 / 2977
{
	int iVar0;
...
bool Function_18(int iParam0, int iParam1) //Position: 0xBB8 / 3000
{
	int iVar0;
...
bool Function_19() //Position: 0xBD4 / 3028
{
...
bool Function_20(var uParam0, int iParam1) //Position: 0xBEF / 3055
{
	return (uParam0 && iParam1) == 0;
}

var Function_21(int iParam0) //Position: 0xBFC / 3068
{
	if (!Function_4(iParam0))
	{
		return "";
...
bool Function_22() //Position: 0x10AA / 4266
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_23(int iParam0) //Position: 0x10B3 / 4275
{
	if (!Function_4(iParam0))
	{
		return;
...
bool Function_24(int iParam0) //Position: 0x111E / 4382
{
...
bool Function_25(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x11A1 / 4513
{
	uParam0 = uParam0;
...
bool Function_26(int iParam0) //Position: 0x1245 / 4677
{
...
int Function_27(int iParam0) //Position: 0x1260 / 4704
{
	if (iParam0 == 1)
	{
		if (Global_3386 == 1)
...
bool Function_28(bool bParam0) //Position: 0x1314 / 4884
{
...
bool Function_29() //Position: 0x1332 / 4914
{
	return Function_20(StackVal, 1);
}

var Function_30() //Position: 0x1341 / 4929
{
	return StackVal;
}

void Function_31(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x134C / 4940
{
	bool bVar0;
...
bool Function_32(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x13FE / 5118
{
	var uVar0[2];
	int iVar3;
	bool bVar4;
	...
	Function_34(StackVal, StackVal, vParam0, &(uVar0[0]), &(uVar0[1]));
	iVar3 = 0;
	if (bParam3)
	{
	...
	else
	{
		if (IS_GRINGO_VALID(uVar0[0]))
		{
			bVar4 = GET_ACTOR_FROM_OBJECT(Function_33(uVar0[0], "UseCase1"));
		...
		if (IS_GRINGO_VALID(uVar0[1]))
		{
			bVar5 = GET_ACTOR_FROM_OBJECT(Function_33(uVar0[1], "UseCase1"));
...
var Function_33(bool bParam0, bool bParam1) //Position: 0x155F / 5471
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_34(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x156C / 5484
{
	bool bVar0;
...
void Function_35(bool bParam0, float fParam1) //Position: 0x16AF / 5807
{
	if (!Function_16(128))
	{
		return;
...
void Function_36(bool bParam0, bool bParam1) //Position: 0x16ED / 5869
{
	char[] cVar0[4];
	...
	{
		strcpy(&cVar0, "", 4);
		Function_37(Global_29155[bParam110].f_20, cVar0);
	}
...
void Function_37(var uParam0, int iParam1) //Position: 0x17E7 / 6119
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_38(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x17F4 / 6132
{
...
void Function_39() //Position: 0x18D8 / 6360
{
	int iVar0;
...
int Function_40(int iParam0) //Position: 0x1926 / 6438
{
...
bool Function_41(int iParam0) //Position: 0x193E / 6462
{
...
void Function_42(bool bParam0) //Position: 0x1953 / 6483
{
	Global_26316.f_56 = (Global_26316.f_56 || bParam0);
	return;
}

void Function_43(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x1966 / 6502
{
	bool bVar0;
...
void Function_44(int iParam0) //Position: 0x1A79 / 6777
{
	Function_45(&Global_28842, iParam0);
	return;
}

void Function_45(var uParam0, var uParam1) //Position: 0x1A87 / 6791
{
...
void Function_46() //Position: 0x1AA2 / 6818
{
...
bool Function_47(int iParam0) //Position: 0x1ABE / 6846
{
	int iVar0;
...
void Function_48(int iParam0, var uParam1, vector3 vParam2) //Position: 0x1B0B / 6923
{
	if (!Function_41(iParam0))
	{
...
void Function_49(int iParam0) //Position: 0x1B6D / 7021
{
	switch (Global_30619)
	{
		case 0x00000000:
	...
	Function_53(7, 2, 0, 0, 50, 2, 0, 0, 4, iParam0, "$/content/Ambient/Roaming/event_donkey_lead", 31, 2, 185.0f, 8, 55, 0);
	Function_52(&Global_17483[775] + 120, 1, 3.0f, 112, 4294967295);
	Function_51(&Global_17483[775] + 120, -5.0f, 2);
	Function_50(&Global_17483[775] + 120);
	return;
}

void Function_50(int iParam0) //Position: 0x1C39 / 7225
{
	iParam0->f_16 = 1;
	return;
}

void Function_51(int iParam0, float fParam1, int iParam2) //Position: 0x1C44 / 7236
{
...
void Function_52(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1C5A / 7258
{
...
void Function_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1C80 / 7296
{
	if (!Function_3(iParam0))
	{
		return;
	}
	Function_54(iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam10, iParam11, iParam12, fParam13, iParam14, iParam15, iParam16);
	Global_17483[iParam075].f_92 = iParam9;
}

void Function_54(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, var uParam7, var uParam8, bool bParam9, var uParam10, var uParam11, var uParam12, var uParam13, bool bParam14, var uParam15) //Position: 0x1CC2 / 7362
{
	var uVar0;
	int iVar1;
	bool bVar2;
	...
	if (!UNK_0x214AFB8C(Global_16876[iParam06].f_20))
	{
		...
		Function_55(iParam0, Global_17483[iParam075].f_96);
	...
	bParam14 = Function_56(bParam14 * 60);
...
int Function_55(int iParam0, int iParam1) //Position: 0x206A / 8298
{
	if (iParam0 >= 4294967295 || iParam0 <= 100)
	{
		return 0;
...
bool Function_56(int iParam0) //Position: 0x208B / 8331
{
	return CEIL(((IntToFloat(iParam0) * Global_63398) / 60.0f));
}

void Function_57(int iParam0) //Position: 0x20A1 / 8353
{
	Function_53(28, 2, 25, 4294967146, 100, 1, 8, 0, 4, iParam0, "$/content/Ambient/Roaming/event_roadside_aftermath", 63, 2, 180.0f, 8, 55, 0);
	Function_52(&Global_17483[2875] + 120, 1, 9.0f, 64, 752);
	Function_61(&Global_17483[2875] + 120, 20.0f);
	Function_60(&Global_17483[2875] + 120, 5.0f);
	Function_59(&Global_17483[2875] + 120, 12.0f, 5.0f);
	Function_58(&Global_17483[2875] + 120, 0.4f, 8.0f);
	Function_51(&Global_17483[2875] + 120, -4.0f, 2);
	Function_50(&Global_17483[2875] + 120);
	return;
}

void Function_58(int iParam0, float fParam1, int iParam2) //Position: 0x2177 / 8567
{
...
void Function_59(int iParam0, float fParam1, int iParam2) //Position: 0x218D / 8589
{
...
void Function_60(int iParam0, int iParam1) //Position: 0x21A3 / 8611
{
	(iParam0 + 60)->f_32 = iParam1;
	return;
}

void Function_61(int iParam0, int iParam1) //Position: 0x21B1 / 8625
{
	(iParam0 + 60)->f_20 = iParam1;
	return;
}

void Function_62(int iParam0) //Position: 0x21BF / 8639
{
	Function_53(30, 2, 50, 4294967196, 100, 1, 8, 0, 4, iParam0, "$/content/Ambient/Roaming/event_roadside_execution", 63, 2, 180.0f, 8, 55, 0);
	Function_52(&Global_17483[3075] + 120, 2, 5.0f, 96, 752);
	Function_61(&Global_17483[3075] + 120, 32.0f);
	Function_60(&Global_17483[3075] + 120, 5.0f);
	Function_59(&Global_17483[3075] + 120, 19.9f, 8.0f);
	Function_58(&Global_17483[3075] + 120, 0.4f, 4.0f);
	Function_51(&Global_17483[3075] + 120, 0.0f, 4);
	Function_50(&Global_17483[3075] + 120);
	return;
}

void Function_63(var uParam0, int iParam1) //Position: 0x228D / 8845
{
	int iVar0;
...
void Function_64(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6) //Position: 0x22A4 / 8868
{
	var uVar0;
	bool bVar3[2];
	bool bVar6;
	...
	if (IS_DOOR_VALID(bParam4))
	{
		...
		{
			Function_66(bParam4, 0);
		}
		else
		{
			Function_65(bParam4, 1);
		}
	}
	if (IS_DOOR_VALID(bParam5))
	{
		if (Global_16537[iParam021].f_40 == 3)
		{
			Function_66(bParam5, 0);
		}
		else
		{
			Function_65(bParam5, 1);
		}
	}
	...
	if (IS_OBJECT_VALID(bParam6))
	{
		...
		{
			bVar6 = GET_ACTOR_FROM_OBJECT(Function_33(bVar3[0], "UseCase1"));
		...
		{
			bVar7 = GET_ACTOR_FROM_OBJECT(Function_33(bVar3[1], "UseCase1"));
...
void Function_65(bool bParam0, bool bParam1) //Position: 0x2637 / 9783
{
...
void Function_66(bool bParam0, bool bParam1) //Position: 0x268B / 9867
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_67(int iParam0) //Position: 0x26DC / 9948
{
...
int Function_68(bool bParam0, bool bParam1) //Position: 0x26F2 / 9970
{
	if (!IS_OBJECT_VALID(bParam1))
	{
...
void Function_69(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x284C / 10316
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 >= 0)
	{
		Function_63(&(Global_29008[iParam4]), 2048);
	}
...
bool Function_70(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x28FE / 10494
{
	int iVar0;
	char* cVar1[16];
...
int Function_71(bool bParam0, int iParam1) //Position: 0x2A69 / 10857
{
	vector3 vVar0;
	bool bVar20;
...
bool Function_72(vector3 vParam0) //Position: 0x2BA5 / 11173
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_73(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x2BBD / 11197
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_74() //Position: 0x2CD6 / 11478
{
	float fVar0;
...
void Function_75(int iParam0, var uParam1, bool bParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9, vector3 vParam12, vector3 vParam15, vector3 vParam18) //Position: 0x2CDE / 11486
{
	bool bVar0;
...
bool Function_76(vector3 vParam0, vector3 vParam3) //Position: 0x2F85 / 12165
{
	vector3 vVar0;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2FB2 / 12210
{
	int iVar0;
...
bool Function_78(var uParam0, var uParam1, int iParam2) //Position: 0x2FCE / 12238
{
	int iVar0;
	char* cVar1[64];
...
void Function_79(var uParam0, var uParam1, int iParam2) //Position: 0x30AF / 12463
{
	int iVar0;
	char* cVar1[64];
...
int Function_80(bool bParam0) //Position: 0x3197 / 12695
{
	bool bVar0;
	vector3 vVar1;
	var uVar4;
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x32E0 / 13024
{
	int iVar0;
...
int Function_82() //Position: 0x3300 / 13056
{
	if (Function_22())
	{
...
int Function_83() //Position: 0x3319 / 13081
{
	return Global_79349.f_16;
}

void Function_84(var uParam0, int iParam1) //Position: 0x3325 / 13093
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_85() //Position: 0x3334 / 13108
{
	bool bVar0;
	
	Function_93(3, 3);
	bVar0 = bVar0;
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/locked_footlocker", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire01", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire05", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire03", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire01_bad", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire03_bad", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire04", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire02", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire03_law", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/player_herb_pricklypear", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_drink", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_guntricks_e_any", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_throwbottle", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_smoke", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_only", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/horse_tend", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sleeping_scripted", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/riverwash", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_docks", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_play_harmonica", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_announce", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_spit", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sleeping", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/pee_nospawn", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_yawning_n_any", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/player_herb_woollybluecurls", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/treasure_hunting_5", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire01_law", 1, 0);
	Function_91(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/player_sleep_bed_r", 1, 0);
	if (!Function_86(&Local_13 + 4))
	{
		return 0;
	}
...
bool Function_86(int iParam0) //Position: 0x92E4 / 37604
{
	int iVar0;
	int iVar1;
...
void Function_87() //Position: 0x965F / 38495
{
	if (!Function_16(128))
	{
		return;
...
bool Function_88() //Position: 0x969F / 38559
{
	int iVar0;
...
void Function_89(var uParam0, int iParam1) //Position: 0x96CA / 38602
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_90() //Position: 0x96DB / 38619
{
	if (!Function_16(128))
	{
		return;
...
var Function_91(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x971D / 38685
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_92(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_92(var uParam0, int iParam1, int iParam2) //Position: 0x9755 / 38741
{
	int iVar0;
...
void Function_93(int iParam0, int iParam1) //Position: 0x9819 / 38937
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_94(var uParam0, bool bParam1) //Position: 0x9862 / 39010
{
	int iVar0;
	
	iVar0 = Function_96(uParam0);
...
bool Function_95(int iParam0) //Position: 0x989F / 39071
{
...
var Function_96(int iParam0) //Position: 0x98B6 / 39094
{
...
bool Function_97(int iParam0) //Position: 0x98D0 / 39120
{
...
bool Function_98() //Position: 0x98E6 / 39142
{
	var uVar0;
	...
	Local_0.f_36 = Function_99(Local_0, "cover2x1x0", "p_uti_cover2x1x", -3825.586f, 2.900937f, 4226.143f, 0.0f, 82.24956f, 0.0f, 1);
	Local_0.f_40 = Function_99(Local_0, "cover2x1x1", "p_uti_cover2x1x", -3849.503f, 3.143f, 4213.479f, 0.0f, 77.38024f, 0.0f, 1);
	Local_0.f_44 = Function_99(Local_0, "cover1x1x0", "p_uti_cover1x1x", -3850.03f, 3.715f, 4225.948f, 0.0f, 16.0873f, 0.0f, 1);
	Local_0.f_48 = Function_99(Local_0, "cover1x1x1", "p_uti_cover1x1x", -3850.701f, 3.365f, 4220.66f, 0.0f, 29.73987f, 0.0f, 1);
	return 1;
}

var Function_99(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x9AA1 / 39585
{
	uParam0 = uParam0;
	uParam1 = uParam1;
	uParam2 = uParam2;
...
void Function_100(bool bParam0, int iParam1) //Position: 0x9ACB / 39627
{
	if (!Function_16(128))
	{
		return;
...
void Function_101(int iParam0) //Position: 0x9B06 / 39686
{
	if (!Function_4(iParam0))
	{
		return;
