...
int Function_93() //Position: 0x1DD4 / 7636
{
	...
	if (!Function_304(&vLocal_103, &bLocal_130, 41406, 1, 1))
	{
		return 0;
	}
			...
			if (iLocal_166)
			{
				if (!bVar0)
				{
					if (!Function_302())
					{
						if (IS_ACTOR_ALIVE(Function_41()))
						{
							Function_300("rio_MP_return", 0x40f00000, 1, 2, 0, 0, 0, 0);
...
void Function_94() //Position: 0x1EF0 / 7920
{
	int iVar0;
	...
	{
		case 0x00000000:
			iVar0 = (Function_230(347) - iLocal_164);
...
var Function_95(int iParam0) //Position: 0x1F46 / 8006
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
...
void Function_96(var uParam0, bool bParam1, int iParam2) //Position: 0x2480 / 9344
{
	int iVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x258B / 9611
{
	int iVar0;
...
void Function_98(int iParam0) //Position: 0x25A7 / 9639
{
...
bool Function_99() //Position: 0x2626 / 9766
{
	int iVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x268F / 9871
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_101(int iParam0, bool bParam1) //Position: 0x269E / 9886
{
	if (bParam1)
	{
...
bool Function_102(int iParam0) //Position: 0x26D9 / 9945
{
	return Function_78(Global_78617.f_52, iParam0);
}

bool Function_103(vector3 vParam0) //Position: 0x26EA / 9962
{
	var uVar0[8];
	int iVar9;
	int iVar10;
...
var Function_104(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x275E / 10078
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_105(int iParam0) //Position: 0x27F9 / 10233
{
...
vector3 Function_106(bool bParam0) //Position: 0x2857 / 10327
{
	vector3 vVar0;
...
void Function_107(int iParam0) //Position: 0x2868 / 10344
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

bool Function_108(bool bParam0, bool bParam1, float fParam2) //Position: 0x2879 / 10361
{
	struct<17> Var0;
...
bool Function_109(int iParam0) //Position: 0x2ACC / 10956
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_110(bool bParam0) //Position: 0x2B0F / 11023
{
	int iVar0;
...
int Function_111(int iParam0) //Position: 0x2B36 / 11062
{
	return *iParam0;
}

void Function_112(var uParam0, int iParam1) //Position: 0x2B3F / 11071
{
	*uParam0 = Local_51[iParam12];
	return;
}

void Function_113(int iParam0) //Position: 0x2B4E / 11086
{
	Function_60(iParam0, 4294967286);
	return;
}

bool Function_114(bool bParam0) //Position: 0x2B5C / 11100
{
	return _IS_CLIENT_DATA_VALID_FOR_SLOT(&Local_51, bParam0);
}

void Function_115(var uParam0, bool bParam1) //Position: 0x2B69 / 11113
{
	if (bParam1)
	{
...
bool Function_116(bool bParam0) //Position: 0x2B83 / 11139
{
	return Function_40(*bParam0, 2);
}

bool Function_117() //Position: 0x2B90 / 11152
{
...
bool Function_118(int iParam0, var uParam1, int iParam2) //Position: 0x2BAE / 11182
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_119(int iParam0, bool bParam1) //Position: 0x2BFF / 11263
{
	if (bParam1)
	{
...
bool Function_120(int iParam0) //Position: 0x2C19 / 11289
{
	return Function_40(*iParam0, 1);
}

void Function_121(int iParam0) //Position: 0x2C26 / 11302
{
	bool bVar0;
	int iVar1;
	struct<13> Var2;
...
bool Function_122(int iParam0) //Position: 0x2D23 / 11555
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_123(int iParam0) //Position: 0x2F5F / 12127
{
	return StackVal;
}

bool Function_124(bool bParam0) //Position: 0x2F6D / 12141
{
	if (!IS_SLOT_VALID(bParam0))
	{
		return 0;
...
void Function_125() //Position: 0x2F83 / 12163
{
	Function_126(8);
...
void Function_126(int iParam0) //Position: 0x2F95 / 12181
{
	Function_43(&Global_79338, iParam0);
	return;
}

bool Function_127() //Position: 0x2FA4 / 12196
{
	return Function_39(32768);
}

void Function_128(bool bParam0) //Position: 0x2FB1 / 12209
{
...
bool Function_129(int iParam0, int iParam1, bool bParam2) //Position: 0x2FDC / 12252
{
	int iVar0;
	bool bVar1;
...
void Function_130() //Position: 0x3089 / 12425
{
...
void Function_131() //Position: 0x30C4 / 12484
{
	Function_33(1025, 1, 0);
	return;
}

void Function_132() //Position: 0x30D2 / 12498
{
	if (!Function_38())
	{
		Function_37();
...
void Function_133(var uParam0, var uParam1) //Position: 0x30EA / 12522
{
	struct<8> Var0;
	struct<5> Var8;
...
var Function_134() //Position: 0x310F / 12559
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_135(bool bParam0) //Position: 0x314E / 12622
{
	return Function_136(0, bParam0);
}

int Function_136(int iParam0, bool bParam1) //Position: 0x315A / 12634
{
	char* cVar0[64];
...
bool Function_137(bool bParam0) //Position: 0x31C1 / 12737
{
	char* cVar0[64];
...
int Function_138(int iParam0) //Position: 0x3262 / 12898
{
	return (*&Global_78480 + 132)[iParam0];
}

void Function_139(int iParam0) //Position: 0x3272 / 12914
{
	char* cVar0[32];
	int iVar8;
	bool bVar9;
...
void Function_140(bool bParam0, int iParam1) //Position: 0x3696 / 13974
{
	struct<13> Var0;
...
struct<16> Function_141(var uParam0) //Position: 0x38C3 / 14531
{
	struct<4> Var0;
	bool bVar4;
...
int Function_142() //Position: 0x3934 / 14644
{
	return Function_226(12);
}

void Function_143(bool bParam0) //Position: 0x393F / 14655
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
void Function_144(bool bParam0, bool bParam1) //Position: 0x3959 / 14681
{
	bool bVar0;
	bool bVar1;
...
float Function_145(bool bParam0, bool bParam1) //Position: 0x39B6 / 14774
{
	vector3 vVar0;
...
var Function_146(int iParam0) //Position: 0x39D5 / 14805
{
...
void Function_147(bool bParam0) //Position: 0x3A33 / 14899
{
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), false, false, 0, 0, 0, 0);
	return;
}

bool Function_148() //Position: 0x3A47 / 14919
{
	if (IS_PS3())
	{
		return 1;
...
void Function_149(int iParam0) //Position: 0x3A56 / 14934
{
...
void Function_150(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3B4C / 15180
{
...
void Function_151(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3C10 / 15376
{
...
void Function_152(int iParam0) //Position: 0x3C51 / 15441
{
	struct<5> Var0;
...
void Function_153(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x3CC6 / 15558
{
	var uVar0[67];
	int iVar68;
...
void Function_154(bool bParam0) //Position: 0x3DE2 / 15842
{
...
void Function_155() //Position: 0x3E6B / 15979
{
	Function_167();
	Function_166();
	Function_166();
...
void Function_156() //Position: 0x3EBD / 16061
{
...
void Function_157() //Position: 0x3FC3 / 16323
{
	float fVar0;
...
void Function_158() //Position: 0x3FF6 / 16374
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_159() //Position: 0x4185 / 16773
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_160() //Position: 0x4339 / 17209
{
	Function_161(&Global_28260, 1, 0);
	return;
}

void Function_161(int iParam0, bool bParam1, int iParam2) //Position: 0x4347 / 17223
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_162(int iParam0) //Position: 0x4538 / 17720
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_163(int iParam0, bool bParam1, bool bParam2) //Position: 0x45DE / 17886
{
	int iVar0;
...
struct<8> Function_164() //Position: 0x4879 / 18553
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_165() //Position: 0x4902 / 18690
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_166() //Position: 0x4999 / 18841
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_167() //Position: 0x4A18 / 18968
{
...
int Function_168(int iParam0, bool bParam1, int iParam2) //Position: 0x4A51 / 19025
{
	int iVar0;
	int iVar1;
...
void Function_169(int iParam0) //Position: 0x4C5B / 19547
{
	bool bVar0[67];
	bool bVar68[67];
...
bool Function_170() //Position: 0x4D02 / 19714
{
	return NET_GET_FREE_ROAM_MODE() != 1;
}

void Function_171(var uParam0, var uParam1, bool bParam2) //Position: 0x4D0D / 19725
{
	int iVar0;
...
void Function_172() //Position: 0x4D52 / 19794
{
	int iVar0;
...
void Function_173() //Position: 0x4D7C / 19836
{
...
void Function_174(bool bParam0) //Position: 0x4DDC / 19932
{
...
void Function_175(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4DF6 / 19958
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
...
void Function_176(bool bParam0, bool bParam1) //Position: 0x4EAD / 20141
{
	bool bVar0;
...
bool Function_177(int iParam0, bool bParam1) //Position: 0x4ED2 / 20178
{
	return Function_40(Global_50170[iParam022].f_32, bParam1);
}

struct<16> Function_178(int iParam0) //Position: 0x4EE6 / 20198
{
	char* cVar0[16];
...
var Function_179(int iParam0) //Position: 0x4F1A / 20250
{
	return Global_50170[iParam022].f_24;
}

void Function_180(var uParam0, var uParam1, int iParam2) //Position: 0x4F29 / 20265
{
	bool bVar0;
	float fVar1;
...
void Function_181(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x50D2 / 20690
{
...
void Function_182() //Position: 0x5138 / 20792
{
	if (!Function_30())
	{
...
void Function_183(var uParam0, int iParam1) //Position: 0x5161 / 20833
{
	if (Global_3381)
	{
		return;
...
void Function_184(bool bParam0) //Position: 0x51A3 / 20899
{
...
void Function_185() //Position: 0x51F4 / 20980
{
	vector3 vVar0;
	var uVar3;
...
bool Function_186(vector3 vParam0) //Position: 0x52AF / 21167
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_187(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x52C7 / 21191
{
	int iVar0;
...
vector3 Function_188() //Position: 0x53AE / 21422
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_189(int iParam0) //Position: 0x53B7 / 21431
{
...
int Function_190(bool bParam0, bool bParam1) //Position: 0x53CD / 21453
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_191(vector3 vParam0, vector3 vParam3) //Position: 0x5494 / 21652
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_192(var uParam0, int iParam1) //Position: 0x54B1 / 21681
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_193(int iParam0) //Position: 0x5CD6 / 23766
{
	var uVar0;
...
void Function_194(bool bParam0, bool bParam1) //Position: 0x5D11 / 23825
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_195() //Position: 0x5D1E / 23838
{
...
bool Function_196(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5D39 / 23865
{
	uParam0 = uParam0;
...
void Function_197(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5DDD / 24029
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<16> Function_198(int iParam0) //Position: 0x5E4F / 24143
{
	char* cVar0[16];
...
struct<16> Function_199(int iParam0) //Position: 0x5E70 / 24176
{
	char* cVar0[16];
...
struct<16> Function_200(int iParam0) //Position: 0x5E91 / 24209
{
	char* cVar0[16];
...
var Function_201() //Position: 0x5EB2 / 24242
{
	return "CQueue_Count";
}

var Function_202() //Position: 0x5EC7 / 24263
{
...
void Function_203(int iParam0) //Position: 0x5EF6 / 24310
{
	Function_204(iParam0, 1);
	return;
}

void Function_204(int iParam0, bool bParam1) //Position: 0x5F02 / 24322
{
	int iVar0;
...
int Function_205(bool bParam0) //Position: 0x5F58 / 24408
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_206(int iParam0, int iParam1) //Position: 0x5F64 / 24420
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
...
struct<16> Function_207(int iParam0) //Position: 0x5FE6 / 24550
{
	char* cVar0[16];
...
struct<24> Function_208(int iParam0) //Position: 0x6006 / 24582
{
	char* cVar0[24];
...
bool Function_209(int iParam0) //Position: 0x6037 / 24631
{
	switch (iParam0)
	{
		case 0x0000003A:
...
void Function_210(bool bParam0, bool bParam1) //Position: 0x61B5 / 25013
{
	bool bVar0;
	bool bVar1;
	char* cVar2[16];
...
var Function_211() //Position: 0x6301 / 25345
{
	bool bVar0;
...
void Function_212(var uParam0, bool bParam1, bool bParam2) //Position: 0x634E / 25422
{
...
void Function_213(int iParam0, var uParam1, int iParam2, var uParam3, int iParam4, float fParam5, bool bParam6, int iParam7, bool bParam8, int iParam9, int iParam10, bool bParam11, int iParam12) //Position: 0x6366 / 25446
{
	struct<4> Var0;
...
void Function_214(int iParam0, int iParam1) //Position: 0x63DC / 25564
{
	Function_34(&Global_50170[iParam022] + 32, iParam1);
	return;
}

void Function_215(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x63F0 / 25584
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
...
void Function_216(int iParam0, int iParam1) //Position: 0x64AD / 25773
{
	Function_35(&Global_50170[iParam022] + 32, iParam1);
	return;
}

struct<24> Function_217(int iParam0) //Position: 0x64C1 / 25793
{
	char* cVar0[24];
...
struct<24> Function_218(int iParam0) //Position: 0x64EF / 25839
{
	char* cVar0[24];
...
bool Function_219() //Position: 0x651F / 25887
{
	return "MP_Unstoppable_Icon_128";
}

float Function_220(int iParam0) //Position: 0x653F / 25919
{
	return Global_50170[iParam022].f_12;
}

void Function_221(int iParam0, int iParam1) //Position: 0x654E / 25934
{
	if (iParam0 > 40)
	{
		return;
...
void Function_222(int iParam0, int iParam1) //Position: 0x6573 / 25971
{
...
void Function_223(int iParam0) //Position: 0x659C / 26012
{
	struct<13> Var0;
...
void Function_224(var uParam0, int iParam1, int iParam2) //Position: 0x662B / 26155
{
	if (*uParam0 > iParam2)
	{
		*uParam0 = iParam2;
...
struct<20> Function_225(int iParam0) //Position: 0x6650 / 26192
{
	struct<5> Var0;
...
int Function_226(int iParam0) //Position: 0x690C / 26892
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_227() //Position: 0x6925 / 26917
{
	return Function_138(0);
}

void Function_228(int iParam0) //Position: 0x692F / 26927
{
	if (Function_67(iParam0))
	{
		if (!Function_66(iParam0))
...
void Function_229(int iParam0, int iParam1) //Position: 0x69F7 / 27127
{
	if (iParam0 > 40)
	{
		return;
...
int Function_230(bool bParam0) //Position: 0x6A11 / 27153
{
...
void Function_231() //Position: 0x6A52 / 27218
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
		...
		case 0x00000006:
			...
			else
			{
				...
				if (!iLocal_169)
				{
					Function_300("rio_MP_killRemainder", 7.5f, 1, 2, 1, 0, 0, 0);
					iLocal_169 = 1;
				}
			}
			break;
...
int Function_232(bool bParam0) //Position: 0x6B06 / 27398
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_233(int iParam0) //Position: 0x6B56 / 27478
{
...
void Function_234(int iParam0, float fParam1) //Position: 0x6B6B / 27499
{
...
bool Function_235(int iParam0) //Position: 0x6B8C / 27532
{
	return Function_40(*iParam0, 1);
}

void Function_236(var uParam0, bool bParam1) //Position: 0x6B99 / 27545
{
	struct<9> Var0;
...
void Function_237() //Position: 0x6BD0 / 27600
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				...
				Function_238(bLocal_147, bLocal_19, 0, 0);
				Function_238(bLocal_148, bLocal_19, 0, 0);
			}
			vLocal_103.f_8 = 6;
			Function_233(&iLocal_158);
			break;
		...
		case 0x00000006:
			...
			else
			{
				...
				if (!iLocal_171)
				{
					...
					{
						Function_300("rio_MP_obj02", 7.5f, 1, 2, 1, 0, 0, 0);
						iLocal_171 = 1;
					}
				}
			}
...
void Function_238(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x6CAB / 27819
{
	bool bVar0;
	bool bVar1;
...
void Function_239() //Position: 0x6D2D / 27949
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	vVar1 = { -1921.99f, 37.06729f, 3459.4f };
	fVar4 = 20.0f;
	fVar5 = 74.0f;
	switch (iVar0)
	{
		case 0x00000003:
			Function_240(StackVal, StackVal, vVar1, 1061, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1063, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1062, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1061, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1063, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1062, 55076, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1061, 55076, fVar4, fVar5);
...
var Function_240(vector3 vParam0, int iParam3, bool bParam4, float fParam5, float fParam6) //Position: 0x6F0C / 28428
{
	var uVar0;
	bool bVar4;
...
int Function_241(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6F97 / 28567
{
...
void Function_242(bool bParam0) //Position: 0x6FDD / 28637
{
...
var Function_243(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x7004 / 28676
{
	var uVar0;
	vector3 vVar3;
	var uVar6;
...
void Function_244(char* cParam0, bool bParam1) //Position: 0x70A3 / 28835
{
...
var Function_245() //Position: 0x70DD / 28893
{
	return cLocal_99;
}

var Function_246() //Position: 0x70E5 / 28901
{
	int iVar0;
	int iVar1;
...
void Function_247() //Position: 0x7114 / 28948
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	
	vVar0 = { -1921.99f, 37.06729f, 3459.4f };
	fVar3 = 20.0f;
	fVar4 = 74.0f;
	bLocal_149 = Function_240(StackVal, StackVal, vVar0, 1060, 32815, fVar3, fVar4);
	if (IS_ACTOR_VALID(bLocal_149))
	{
		SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bLocal_149, 392, 0, 2, 0), "rio_MP_BossName");
		SET_ACTOR_MAX_HEALTH(bLocal_149, (GET_ACTOR_MAX_HEALTH(bLocal_149) * 2.5f));
	}
	return;
}

void Function_248() //Position: 0x7187 / 29063
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			if (!iLocal_170)
			{
				Function_300("rio_MP_obj01", 7.5f, 1, 2, 1, 0, 0, 0);
				iLocal_170 = 1;
			}
			vLocal_103.f_8 = 6;
			break;
...
void Function_249() //Position: 0x7249 / 29257
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_250() //Position: 0x730B / 29451
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_251(var uParam0, int iParam1) //Position: 0x73CE / 29646
{
	bool bVar0;
	bool bVar1;
...
void Function_252() //Position: 0x746A / 29802
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_253(var uParam0) //Position: 0x7506 / 29958
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_256(int iParam0) //Position: 0x7686 / 30342
{
...
void Function_257(int iParam0, bool bParam1) //Position: 0x771B / 30491
{
...
void Function_258(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x7763 / 30563
{
	bool bVar0;
...
void Function_259(int iParam0) //Position: 0x7876 / 30838
{
	Function_260(&Global_28842, iParam0);
	return;
}

void Function_260(var uParam0, var uParam1) //Position: 0x7884 / 30852
{
...
void Function_261() //Position: 0x789F / 30879
{
...
void Function_262(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x78BB / 30907
{
...
void Function_263() //Position: 0x799F / 31135
{
	int iVar0;
...
int Function_264(int iParam0) //Position: 0x79ED / 31213
{
...
bool Function_265(int iParam0) //Position: 0x7A05 / 31237
{
...
void Function_266(bool bParam0, bool bParam1) //Position: 0x7A1A / 31258
{
	char[] cVar0[4];
...
void Function_267(var uParam0, var uParam1) //Position: 0x7B14 / 31508
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &uParam1);
	return;
}

void Function_268() //Position: 0x7B21 / 31521
{
...
void Function_269() //Position: 0x7B92 / 31634
{
	bool bVar0;
	bool bVar1;
	
	bVar0 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_130, "SpawnVol_0_set");
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_0", 2, -1933.636f, 30.69586f, 3474.364f, 0.0f, 170.222f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_1", 2, -1956.972f, 28.95003f, 3465.152f, 0.0f, 110.015f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_2", 2, -1921.104f, 33.42532f, 3457.104f, 0.0f, -80.472f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_3", 2, -1972.98f, 22.07712f, 3445.854f, 0.0f, 85.599f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_4", 2, -1929.7f, 32.66842f, 3446.3f, 0.0f, 318.888f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_5", 2, -1912.888f, 35.56906f, 3442.48f, 0.0f, 300.339f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_6", 2, -1955.241f, 40.89969f, 3422.575f, 0.0f, 365.928f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_7", 2, -1980.0f, 19.88835f, 3463.863f, 0.0f, 165.44f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_8", 2, -1908.338f, 36.82536f, 3452.0f, 0.0f, -69.097f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_9", 2, -1935.187f, 39.30875f, 3413.166f, 0.0f, 30.374f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_10", 2, -1968.008f, 40.41465f, 3426.256f, 0.0f, 34.607f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_11", 2, -1941.02f, 42.02314f, 3422.685f, 0.0f, 354.606f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(bVar0, bVar1);
	bLocal_150 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "mpaa_warning_vol", 3, -1921.624f, 30.981f, 3460.829f, 0.0f, 20.0f, 0.0f, 66.923f, 50.0f, 66.75157f);
	bLocal_151 = Function_270(bLocal_150, 330, 0.0f);
	SET_BLIP_VISIBLE(bLocal_151, false);
	return;
}

bool Function_270(bool bParam0, bool bParam1, float fParam2) //Position: 0x7EF7 / 32503
{
	bool bVar0;
...
void Function_271(var uParam0, bool bParam1) //Position: 0x7F44 / 32580
{
...
void Function_272(var uParam0) //Position: 0x7FB5 / 32693
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_273() //Position: 0x7FC3 / 32707
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_274(int iParam0) //Position: 0x7FDC / 32732
{
	int iVar0;
	int iVar1;
...
void Function_275() //Position: 0x8358 / 33624
{
	if (!Function_276(128))
	{
		return;
...
bool Function_276(int iParam0) //Position: 0x8398 / 33688
{
	int iVar0;
...
bool Function_277() //Position: 0x83B4 / 33716
{
	int iVar0;
...
void Function_278(var uParam0, int iParam1) //Position: 0x83DF / 33759
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_279() //Position: 0x83F0 / 33776
{
	if (!Function_276(128))
	{
		return;
...
void Function_280() //Position: 0x8432 / 33842
{
	Function_282(&uLocal_131, "mp_action_areas", 10, 0);
	Function_281(&uLocal_131, 1060, 10, 0);
	Function_281(&uLocal_131, 1061, 10, 0);
	Function_281(&uLocal_131, 1062, 10, 0);
	Function_281(&uLocal_131, 1063, 10, 0);
	return;
}

var Function_281(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x8483 / 33923
{
	int iVar0;
...
var Function_282(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x8553 / 34131
{
	int iVar0;
	int iVar1;
...
var Function_283(var uParam0, int iParam1, int iParam2) //Position: 0x858B / 34187
{
	int iVar0;
...
bool Function_284(int iParam0) //Position: 0x864F / 34383
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
void Function_285(var uParam0, float fParam1) //Position: 0x86FB / 34555
{
	Function_286(uParam0, -fParam1);
	return;
}

void Function_286(var uParam0, float fParam1) //Position: 0x8709 / 34569
{
	Function_64();
...
void Function_287(var uParam0, int iParam1) //Position: 0x871D / 34589
{
	uParam0->f_4 = iParam1;
...
bool Function_288(int iParam0) //Position: 0x873A / 34618
{
...
void Function_289(int iParam0) //Position: 0x8750 / 34640
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_290(int iParam0) //Position: 0x8764 / 34660
{
	if (Function_67(iParam0))
	{
...
float Function_291(float fParam0) //Position: 0x877F / 34687
{
	return -Function_63(fParam0);
}

bool Function_292() //Position: 0x878B / 34699
{
	return iLocal_20;
}

void Function_293(int iParam0, var uParam1) //Position: 0x8793 / 34707
{
	if (!Function_67(iParam0))
	{
...
void Function_294() //Position: 0x87A9 / 34729
{
	struct<13> Var0;
...
void Function_295(bool bParam0) //Position: 0x87D5 / 34773
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 34855);
	return;
}

void Function_296(bool bParam0) //Position: 0x8827 / 34855
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
float Function_297(bool bParam0) //Position: 0x892A / 35114
{
...
bool Function_298(int iParam0) //Position: 0x89F2 / 35314
{
	return Function_40(*iParam0, 2);
}

void Function_299(bool bParam0) //Position: 0x89FF / 35327
{
	Function_234(bParam0, 0.0f);
	return;
}

void Function_300(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x8A0B / 35339
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_301(int iParam0) //Position: 0x8A90 / 35472
{
	char* cVar0[16];
...
bool Function_302() //Position: 0x8ACF / 35535
{
	return (HUD_IS_SHOWING_OBJECTIVE() || HUD_IS_SHOWING_SMALL_TEXT());
}

void Function_303(var uParam0, int iParam1) //Position: 0x8ADC / 35548
{
...
bool Function_304(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x8AF2 / 35570
{
	if (!Function_346())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_317(39468, 38816);
			break;
		
		case 0x00000002:
			Function_317(36193, 35769);
			break;
...
int Function_305(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x8BB9 / 35769
{
	bool bVar0;
	bool bVar1;
...
bool Function_306(bool bParam0, bool bParam1, int iParam2) //Position: 0x8C5C / 35932
{
	var uVar0;
...
int Function_307(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x8C6D / 35949
{
	char* cVar0[32];
...
int Function_308(int iParam0, bool bParam1) //Position: 0x8CD2 / 36050
{
	char* cVar0[64];
...
void Function_309(bool bParam0, int iParam1, bool bParam2) //Position: 0x8D40 / 36160
{
	if (bParam0)
	{
		if (Function_127())
...
int Function_310() //Position: 0x8D61 / 36193
{
	if (!Function_311(1))
	{
		return 0;
...
bool Function_311(bool bParam0) //Position: 0x8E1D / 36381
{
	char* cVar0[64];
...
void Function_312(bool bParam0) //Position: 0x8E9E / 36510
{
...
var Function_313(int iParam0, bool bParam1) //Position: 0x8F27 / 36647
{
	int iVar0;
...
struct<64> Function_314(var uParam0) //Position: 0x8F47 / 36679
{
...
struct<64> Function_315(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x8F5B / 36699
{
	char* cVar0[64];
...
int Function_316(bool bParam0, bool bParam1) //Position: 0x8FA0 / 36768
{
...
void Function_317(int iParam0, int iParam1) //Position: 0x8FD4 / 36820
{
	Function_318(iParam0, iParam1, 38809);
	return;
}

void Function_318(var uParam0, var uParam1, int iParam2) //Position: 0x8FE5 / 36837
{
...
void Function_319() //Position: 0x917E / 37246
{
	if (Function_39(4194304))
	{
...
void Function_320(var uParam0, var uParam1, int iParam2) //Position: 0x9287 / 37511
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_321(bool bParam0, int iParam1, bool bParam2) //Position: 0x93FF / 37887
{
	char* cVar0[64];
	int iVar16;
...
var Function_322(int iParam0) //Position: 0x9480 / 38016
{
	switch (iParam0)
	{
		case 0x00000002:
...
int Function_323() //Position: 0x9799 / 38809
{
	return 1;
}

int Function_324(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x97A0 / 38816
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
var Function_325(int iParam0) //Position: 0x9961 / 39265
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_326(int iParam0) //Position: 0x9974 / 39284
{
...
float Function_327(int iParam0, bool bParam1) //Position: 0x9994 / 39316
{
	char* cVar0[64];
...
int Function_328(bool bParam0) //Position: 0x99FD / 39421
{
	if (!Function_137(bParam0))
	{
		return 4294967295;
...
var Function_329() //Position: 0x9A22 / 39458
{
	return Global_78480;
}

int Function_330() //Position: 0x9A2C / 39468
{
	bool bVar0;
	int iVar1;
...
void Function_331() //Position: 0x9B4F / 39759
{
	if (Function_39(4096))
	{
...
void Function_332(int iParam0) //Position: 0x9B8C / 39820
{
	int iVar0;
	int iVar1;
...
void Function_333(int iParam0) //Position: 0x9C05 / 39941
{
	struct<13> Var0;
...
void Function_334(int iParam0) //Position: 0x9C30 / 39984
{
	bool bVar0;
...
void Function_335(var uParam0, bool bParam1) //Position: 0x9C77 / 40055
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_336(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x9DC2 / 40386
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_337(bool bParam0) //Position: 0x9EA4 / 40612
{
	bool bVar0;
...
void Function_338() //Position: 0x9EFE / 40702
{
	Function_339(4);
	return;
}

void Function_339(int iParam0) //Position: 0x9F08 / 40712
{
	var uVar0;
	var uVar1;
...
void Function_340(bool bParam0) //Position: 0x9F3A / 40762
{
	var uVar0;
...
void Function_341() //Position: 0x9F49 / 40777
{
	bool bVar0;
...
void Function_342() //Position: 0x9F7E / 40830
{
	int iVar0;
...
bool Function_343(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x9F97 / 40855
{
	bool bVar0;
...
bool Function_344(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0xA000 / 40960
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_345(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xA0ED / 41197
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_346() //Position: 0xA19B / 41371
{
	int iVar0;
...
void Function_347(bool bParam0) //Position: 0xA1BE / 41406
{
	bool bVar0;
	
	bVar0 = NET_ACTOR_GET_SCRIPT_INT(bParam0);
	if (bVar0 != 55076 || bVar0 != 32815)
	{
		TASK_CLEAR(bParam0);
		...
		if (bVar0 == 32815)
		{
			...
			{
				SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bParam0, 392, 0.0f, 2, 0), "rio_MP_bossName");
			}
			if (bLocal_149 == "")
			{
				bLocal_149 = bParam0;
...
bool Function_348(var uParam0, int iParam1) //Position: 0xA2AB / 41643
{
	if (!Function_28())
	{
		return 0;
...
bool Function_349(int iParam0) //Position: 0xA2CB / 41675
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 41992);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 41953);
	return 1;
}

void Function_350(bool bParam0) //Position: 0xA3E1 / 41953
{
	int iVar0;
...
void Function_351(bool bParam0) //Position: 0xA408 / 41992
{
	struct<13> Var0;
...
void Function_352(bool bParam0) //Position: 0xA47F / 42111
{
	struct<13> Var0;
...
void Function_353(var uParam0, int iParam1) //Position: 0xA4CC / 42188
{
	bool bVar0;
	bool bVar1;
...
void Function_354(int iParam0) //Position: 0xA521 / 42273
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_355(int iParam0) //Position: 0xA533 / 42291
{
...
void Function_356() //Position: 0xA5F7 / 42487
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_357(bool bParam0, bool bParam1) //Position: 0xA610 / 42512
{
	var uVar0;
...
void Function_358() //Position: 0xA65C / 42588
{
...
void Function_359() //Position: 0xA67B / 42619
{
	Function_360(&Global_78480 + 220);
	return;
}

void Function_360(int iParam0) //Position: 0xA68A / 42634
{
	int iVar0;
...
void Function_361(int iParam0) //Position: 0xA6AB / 42667
{
	int iVar0;
...
void Function_362(int iParam0) //Position: 0xA6CF / 42703
{
	int iVar0;
...
void Function_363(var uParam0, int iParam1) //Position: 0xA6F3 / 42739
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_364(var uParam0) //Position: 0xA6FF / 42751
{
	uParam0 = uParam0;
	return;
}

void Function_365(int iParam0) //Position: 0xA709 / 42761
{
	if (!Function_67(iParam0))
	{
...
bool Function_366(var uParam0, bool bParam1) //Position: 0xA71E / 42782
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_367(bool bParam0) //Position: 0xA7D1 / 42961
{
	bool bVar0;
