...
void main() //Position: 0x0 / 0
{
	...
	fVar93[9] = 249.871f;
	iVar104[0] = GET_ASSET_ID("repair_kneel", 1);
	iVar104[1] = GET_ASSET_ID("stand_sellpaper", 1);
	iVar104[2] = GET_ASSET_ID("rand_idle_stand", 1);
	iVar104[3] = GET_ASSET_ID("stand_announce", 1);
	iVar104[4] = GET_ASSET_ID("stand_hammer_wall", 1);
	iVar104[5] = GET_ASSET_ID("look_distance_binocs", 1);
	iVar104[6] = GET_ASSET_ID("whittle_wood", 1);
	iVar104[7] = GET_ASSET_ID("factory_foreman", 1);
	iVar104[8] = GET_ASSET_ID("window_shopping", 1);
	iVar115 = 0;
	iVar115 = 0;
	while (iVar115 <= 10)
	{
		Function_16(&uVar1, iVar104[iVar115], 1);
		iVar115++;
	}
	SET_SCRIPT_AVOIDS_STRINGTABLE(1);
	ADD_PERSISTENT_SCRIPT(GET_THIS_SCRIPT_ID());
	bVar116 = CREATE_LAYOUT(Function_15());
	iVar115 = 0;
	while (iVar115 <= 10)
	{
		Function_14(&uVar1, (3 + iVar115), 3, 0);
		iVar115++;
	}
	while (!Function_7(&uVar1))
	{
		WAIT(false);
	}
	...
	while (iVar115 <= 50)
	{
		...
		bVar117 = CREATE_GRINGO_IN_LAYOUT_BY_ID(bVar116, Function_15(), iVar104[((iVar115 + iVar129) % 10)], vVar120, vVar123);
		bVar119 = (3 + (iVar115 % 10));
		bVar118 = CREATE_ACTOR_IN_LAYOUT(bVar116, Function_15(), bVar119, vVar120, vVar123);
		TASK_USE_GRINGO(bVar118, GET_GRINGO_FROM_OBJECT(bVar117), "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(bVar118, bVar117, "UseCase1", 1, 0, 0);
		if ((iVar115 % 10) == 9)
		{
			iVar129++;
		}
	...
	if (!bVar4)
	{
		...
		while (iVar2 <= 79)
		{
			if (Function_3(iVar2))
			{
				...
				{
					ADD_ITEM(Function_2(iVar2), bVar3, 0);
				}
			}
			iVar2++;
		}
...
var Function_2(bool bParam0) //Position: 0x55D / 1373
{
	bool bVar0;
...
bool Function_3(bool bParam0) //Position: 0x64E / 1614
{
	bool bVar0;
...
void Function_4(bool bParam0, bool bParam1) //Position: 0x661 / 1633
{
	SET_WEAPONENUM_LOCKED(bParam1, 0);
	GIVE_WEAPON_TO_ACTOR(bParam0, bParam1, 1.0f, 0, 1);
	return;
}

var Function_5() //Position: 0x677 / 1655
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_6() //Position: 0x680 / 1664
{
...
bool Function_7(int iParam0) //Position: 0x695 / 1685
{
	int iVar0;
	int iVar1;
...
void Function_8() //Position: 0xA10 / 2576
{
	if (!Function_9(128))
	{
		return;
...
bool Function_9(int iParam0) //Position: 0xA50 / 2640
{
	int iVar0;
...
bool Function_10() //Position: 0xA6C / 2668
{
	int iVar0;
...
void Function_11(var uParam0, int iParam1) //Position: 0xA97 / 2711
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_12(int iParam0, int iParam1) //Position: 0xAA8 / 2728
{
	int iVar0;
...
void Function_13() //Position: 0xAC5 / 2757
{
	if (!Function_9(128))
	{
		return;
...
var Function_14(var uParam0, int iParam1, var uParam2, bool bParam3) //Position: 0xB07 / 2823
{
	int iVar0;
	...
	while (iVar0 < (*uParam0 - 1))
	{
		if (!Function_12(uParam0[iVar03], 4))
		{
			...
			Function_11(uParam0[iVar03], 4);
			if (bParam3)
			{
				Function_11(uParam0[iVar03], 8);
			}
			return iVar0;
		}
...
var Function_15() //Position: 0xBD7 / 3031
{
	int iVar0;
...
var Function_16(var uParam0, int iParam1, int iParam2) //Position: 0xBDF / 3039
{
	int iVar0;
