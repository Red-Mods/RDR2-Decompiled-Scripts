	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_22 || bParam2) || Global_3370)
			{
				...
				{
					if (((!bParam2 && !Function_152(iParam0 + 200, &fLocal_24, 256, 0)) && !Global_3370) && !Function_159())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_141(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_24, 20.0f, fLocal_24);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_25, iParam0 + 312, 0, 0, 0x40400000))
						{
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x29B3 / 10675
{
...
void Function_51(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2CC1 / 11457
{
	bool bVar0;
	bool bVar1;
...
{
	Function_149(&bLocal_4, 1202, 3, 0);
	Function_105(&bLocal_4, "$/content/scripting/gringo/simplegringo/lean_rail_nospawn", 1, 0);
	Function_105(&bLocal_4, "p_gen_crateMedicine01x", 0, 0);
	if (Function_86(&bLocal_15, &bLocal_4, 15, 1, 1, 1, 0, 0, 0, 0, 0) && !WOULD_ACTOR_BE_VISIBLE(1202, &vLocal_19, 3212836864))
	{
		if (Function_84(&bLocal_18, "merchant05mobile", iParam1))
		{
			bLocal_14 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_18, Function_141()));
...
bool Function_83() //Position: 0x418F / 16783
{
...
bool Function_84(var uParam0, char* cParam1, int iParam2) //Position: 0x41AA / 16810
{
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x41D5 / 16853
{
	int iVar0;
...
int Function_86(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4217 / 16919
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_87(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x43E0 / 17376
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x48CA / 18634
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_89(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x48EA / 18666
{
	bool bVar0;
...
int Function_90(bool bParam0, bool bParam1) //Position: 0x493E / 18750
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x49BE / 18878
{
	Function_93(bParam0);
	Function_92(bParam0);
...
void Function_92(bool bParam0) //Position: 0x49E4 / 18916
{
...
void Function_93(bool bParam0) //Position: 0x4A08 / 18952
{
...
bool Function_94(bool bParam0) //Position: 0x4AD7 / 19159
{
...
int Function_95(int iParam0, bool bParam1) //Position: 0x4AEE / 19182
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_96(int iParam0, bool bParam1, bool bParam2) //Position: 0x4B81 / 19329
{
	bool bVar0;
	bool bVar1;
...
void Function_97(bool bParam0) //Position: 0x4C78 / 19576
{
	bool bVar0;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x4CA4 / 19620
{
	int iVar0;
...
bool Function_99(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x4CC0 / 19648
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_100() //Position: 0x4D4A / 19786
{
	bool bVar0;
	bool bVar1;
...
bool Function_101(int iParam0) //Position: 0x4DAF / 19887
{
...
bool Function_102(bool bParam0) //Position: 0x4DCB / 19915
{
...
var Function_103(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x4DE1 / 19937
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_104(int iParam0) //Position: 0x4E81 / 20097
{
	bool bVar0;
	int iVar1;
...
var Function_105(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4F7B / 20347
{
	int iVar0;
	int iVar1;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4FB3 / 20403
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_107(var uParam0, int iParam1, int iParam2) //Position: 0x4FC4 / 20420
{
	int iVar0;
...
bool Function_108(int iParam0) //Position: 0x5088 / 20616
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x5403 / 21507
{
	if (!Function_156(128))
	{
		return;
...
bool Function_110() //Position: 0x5443 / 21571
{
	int iVar0;
...
void Function_111() //Position: 0x546E / 21614
{
	if (!Function_156(128))
	{
		return;
...
void Function_112(int iParam0, bool bParam1) //Position: 0x54B0 / 21680
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5534 / 21812
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x555D / 21853
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x55AE / 21934
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x55BE / 21950
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x55D2 / 21970
{
	int iVar0;
...
var Function_118() //Position: 0x55F7 / 22007
{
	return "PackedMetadata";
}

void Function_119(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x560E / 22030
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_120() //Position: 0x5739 / 22329
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_121() //Position: 0x574A / 22346
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_122() //Position: 0x575B / 22363
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_123(var uParam0, int iParam1) //Position: 0x576C / 22380
{
...
var Function_124(var uParam0, int iParam1, bool bParam2) //Position: 0x578F / 22415
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x57AE / 22446
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_126() //Position: 0x57BA / 22458
{
	return Function_127(39);
}

int Function_127(bool bParam0) //Position: 0x57C5 / 22469
{
	bool bVar0;
...
var Function_128() //Position: 0x57F3 / 22515
{
	return "PackedWeapon";
}

int Function_129(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5808 / 22536
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_130() //Position: 0x590C / 22796
{
	return "MPItemGiver";
}

struct<32> Function_131(bool bParam0) //Position: 0x5920 / 22816
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0, char* cParam1, char* cParam2) //Position: 0x598A / 22922
{
	char* cVar0[32];
...
var Function_133() //Position: 0x59A9 / 22953
{
	return "PBox_";
}

var Function_134() //Position: 0x59B7 / 22967
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x59DD / 23005
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5A05 / 23045
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(var uParam0, int iParam1) //Position: 0x5A2B / 23083
{
	int iVar0;
	var uVar1;
...
void Function_138(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5B8C / 23436
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x5C27 / 23591
{
	int iVar0;
	vector3 vVar1;
...
void Function_140(int iParam0) //Position: 0x5D88 / 23944
{
...
var Function_141() //Position: 0x5DE9 / 24041
{
	int iVar0;
...
var Function_142(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5DF1 / 24049
{
	return Function_143(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x5E0A / 24074
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x60FD / 24829
{
	int iVar0;
...
void Function_145() //Position: 0x61B1 / 25009
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x61EB / 25067
{
	int iVar0;
...
void Function_147(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x6218 / 25112
{
	bool bVar0;
...
void Function_148() //Position: 0x6369 / 25449
{
	int iVar0;
...
var Function_149(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x63B4 / 25524
{
	int iVar0;
...
int Function_150() //Position: 0x6484 / 25732
{
	int iVar0;
...
int Function_151() //Position: 0x65E0 / 26080
{
	int iVar0;
...
bool Function_152(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x6700 / 26368
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_153(var uParam0, int iParam1) //Position: 0x67D0 / 26576
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_154(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x67EE / 26606
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_155(bool bParam0) //Position: 0x6920 / 26912
{
	bool bVar0;
...
bool Function_156(int iParam0) //Position: 0x693F / 26943
{
	int iVar0;
...
int Function_157() //Position: 0x695B / 26971
{
	if (Function_159())
	{
...
int Function_158() //Position: 0x6974 / 26996
{
	return Global_79349.f_16;
}

bool Function_159() //Position: 0x6980 / 27008
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_160(int iParam0, bool bParam1, bool bParam2) //Position: 0x6989 / 27017
{
	var uVar0;
