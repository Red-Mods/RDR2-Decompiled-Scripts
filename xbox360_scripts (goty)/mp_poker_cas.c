...
void Function_75() //Position: 0x1C21 / 7201
{
	...
	Function_76(4, 1);
	uVar0 = uVar0;
	Local_177 = CREATE_LAYOUT("Poker_CAS_layout");
	Local_177.f_4 = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", Local_177, 8, 0);
	*(&Local_177 + 8[06]) = { -794.7776f, 13.20574f, 3697.313f };
	*(&Local_177 + 8[06] + 12) = { 0.0f, 143.8871f, 0.0f };
	bVar1 = CREATE_POINT_IN_LAYOUT(Local_177, "PlayerPosition", -794.7776f, 13.20574f, 3697.313f, 0.0f, 143.8871f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar1);
	*(&Local_177 + 8[16]) = { -797.7305f, 13.00466f, 3697.815f };
	*(&Local_177 + 8[16] + 12) = { 0.0f, -4.489308f, 0.0f };
	bVar2 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_0_Position", -797.7305f, 13.00466f, 3697.815f, 0.0f, -4.489308f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar2);
	*(&Local_177 + 8[26]) = { -796.1972f, 13.20574f, 3702.099f };
	*(&Local_177 + 8[26] + 12) = { 0.0f, 0.2177533f, 0.0f };
	bVar3 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_1_Position", -796.1972f, 13.20574f, 3702.099f, 0.0f, 0.2177533f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar3);
	*(&Local_177 + 8[36]) = { -792.8218f, 13.20574f, 3699.719f };
	*(&Local_177 + 8[36] + 12) = { 0.0f, 65.40177f, 0.0f };
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_2_Position", -792.8218f, 13.20574f, 3699.719f, 0.0f, 65.40177f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar4);
	*(&Local_177 + 8[46]) = { -794.0304f, 12.6806f, 3701.532f };
	*(&Local_177 + 8[46] + 12) = { 0.0f, 402.257f, 0.0f };
	bVar5 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_3_Position", -794.0304f, 12.6806f, 3701.532f, 0.0f, 402.257f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar5);
	*(&Local_177 + 132) = { -795.0887f, 13.958f, 3699.661f };
	*(&Local_177 + 132 + 12) = { 0.0f, 399.6771f, 0.0f };
	Local_177.f_156 = CREATE_POINT_IN_LAYOUT(Local_177, "TableCenter", -795.0887f, 13.958f, 3699.661f, 0.0f, 399.6771f, 0.0f);
	Local_177.f_160 = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", Local_177, 8, 0);
	*(&Local_177 + 164[06]) = { -792.3431f, 13.25721f, 3704.926f };
	*(&Local_177 + 164[06] + 12) = { 0.0f, 65.09982f, 0.0f };
	bVar6 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_0_Pos", -792.3431f, 13.25721f, 3704.926f, 0.0f, 65.09982f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar6, Local_177.f_160);
	*(&Local_177 + 164[16]) = { -791.2239f, 13.25721f, 3704.926f };
	*(&Local_177 + 164[16] + 12) = { 0.0f, 36.11068f, 0.0f };
	bVar7 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_1_Pos", -791.2239f, 13.25721f, 3704.926f, 0.0f, 36.11068f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar7, Local_177.f_160);
	Local_177.f_216 = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", Local_177, 8, 0);
	*(&Local_177 + 220[06]) = { -792.0f, 13.05098f, 3716f };
	*(&Local_177 + 220[06] + 12) = { 0.0f, 42.077f, 0.0f };
	bVar8 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_0", -792.0f, 13.05098f, 3716f, 0.0f, 42.077f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar8, Local_177.f_216);
	*(&Local_177 + 220[16]) = { -800.0038f, 13.05098f, 3707.996f };
	*(&Local_177 + 220[16] + 12) = { 0.0f, -138.9687f, 0.0f };
	bVar9 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_1", -800.0038f, 13.05098f, 3707.996f, 0.0f, -138.9687f, 0.0f);
