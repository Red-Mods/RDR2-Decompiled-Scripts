...
void main() //Position: 0x0 / 0
{
	...
	iLocal_75 = 0;
	Function_100(uScriptParam_0, &iLocal_75);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_93(&(Local_2[iVar312]), &bVar4))
						{
							Function_91(GRINGO_GET_REQUESTING_ACTOR(), Local_2[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", Local_2[iVar312].f_16);
							Function_85(Local_2[iVar312].f_16, 1);
							...
							{
								Function_78(&(Local_2[iVar312]), 0);
							}
							else if (Local_2[iVar312].f_44 < 8)
							{
								Function_77(&(Local_2[iVar312]));
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_80, &cLocal_79);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0D / 7437
{
	...
	iParam1 = iParam1;
	bParam0 = bParam0;
	Function_27(bParam0, &vVar0);
	GET_OBJECT_ORIENTATION(GET_OBJECT_FROM_ACTOR(bParam0), &vVar3);
	if (!iLocal_0)
	{
		if (IS_OBJECT_VALID(CREATE_GRINGO_IN_LAYOUT(GET_AMBIENT_LAYOUT(), "Bury_Dynamite", "$/content/scripting/gringo/simplegringo/NPC_BuryDynamite", vVar0, vVar3)))
		{
			iLocal_0 = 1;
		}
	}
...
void Function_27(bool bParam0, bool bParam1) //Position: 0x1D96 / 7574
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_28(bool bParam0) //Position: 0x1DA3 / 7587
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1DC2 / 7618
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x1DC8 / 7624
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x1DD6 / 7638
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1DE1 / 7649
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DFB / 7675
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x1E19 / 7705
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x1E38 / 7736
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1E6B / 7787
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1E8A / 7818
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1EA4 / 7844
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EB7 / 7863
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_40() //Position: 0x219F / 8607
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x21A7 / 8615
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x21C4 / 8644
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21D3 / 8659
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x21F5 / 8693
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x2219 / 8729
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2236 / 8758
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2256 / 8790
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x2276 / 8822
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2324 / 8996
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2394 / 9108
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x23AA / 9130
{
...
var Function_52(bool bParam0) //Position: 0x23CB / 9163
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x23EB / 9195
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x23FF / 9215
{
	uParam0 = uParam0;
	return;
}

int Function_55() //Position: 0x2409 / 9225
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x2410 / 9232
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x241F / 9247
{
	bool bVar0;
...
bool Function_58(bool bParam0) //Position: 0x245E / 9310
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(bool bParam0) //Position: 0x2489 / 9353
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_60(bool bParam0) //Position: 0x2494 / 9364
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_61(bool bParam0) //Position: 0x258A / 9610
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_62(bool bParam0) //Position: 0x25AC / 9644
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(bool bParam0) //Position: 0x25D3 / 9683
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2892 / 10386
{
	vector3 vVar0;
...
vector3 Function_65(vector3 vParam0) //Position: 0x28EF / 10479
{
	vector3 vVar0;
...
void Function_66(int iParam0) //Position: 0x294C / 10572
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x2956 / 10582
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2974 / 10612
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2989 / 10633
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x2A10 / 10768
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A33 / 10803
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2A51 / 10833
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x2A74 / 10868
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2B8F / 11151
{
...
int Function_75(bool bParam0) //Position: 0x2BBA / 11194
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2CBF / 11455
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2CCC / 11468
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2D3F / 11583
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x323D / 12861
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x3274 / 12916
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3291 / 12945
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x32C9 / 13001
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x32D3 / 13011
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32F4 / 13044
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3308 / 13064
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3410 / 13328
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x3426 / 13350
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x36DC / 14044
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_89(bool bParam0) //Position: 0x36EA / 14058
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x3703 / 14083
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x371D / 14109
{
	bool bVar0;
	char* cVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3755 / 14165
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x376C / 14188
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3A35 / 14901
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3A52 / 14930
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3AEE / 15086
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3B0D / 15117
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3B1C / 15132
{
...
void Function_99(int iParam0) //Position: 0x3B38 / 15160
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3B42 / 15170
{
	int iVar0;
	int iVar1;
	...
	{
		Function_101(&(Local_2[iLocal_7512]), bParam0);
		iLocal_75++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3BA4 / 15268
{
...
void Function_102(int iParam0) //Position: 0x3BB8 / 15288
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3BC2 / 15298
{
