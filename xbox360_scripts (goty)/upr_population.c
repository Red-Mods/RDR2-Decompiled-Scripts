...
void main() //Position: 0x0 / 0
{
	...
	iVar0 = Function_18("ped_genworkers", 0);
	Function_13(&iVar0, 155, 1.0f, 14, 0, 0);
	Function_13(&iVar0, 158, 1.0f, 14, 0, 0);
	Function_13(&iVar0, 36, 1.0f, 14, 0, 0);
	Function_13(&iVar0, 35, 1.0f, 14, 0, 0);
	Function_13(&iVar0, 152, 1.0f, 14, 0, 0);
	Function_13(&iVar0, 154, 1.0f, 14, 0, 0);
	...
	iVar4 = Function_18("Owls", 0);
	Function_13(&iVar4, 1137, 8.0f, 33, 0, 0);
	iVar5 = Function_18("snakes", 0);
	Function_13(&iVar5, 1058, 8.0f, 14, 0, 0);
	...
	iVar10 = Function_18("Dogs", 0);
	Function_16(&iVar10, 1032, 8.0f, 0, 0);
	Function_16(&iVar10, 1030, 8.0f, 0, 0);
	Function_16(&iVar10, 1031, 8.0f, 0, 0);
	...
	iVar11 = CREATE_POPULATION_SET(1);
	PRINTNL();
	...
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_7(bVar13, iVar4, 1E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("upr_pop: Cannot find uprv_birds_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_7(bVar13, iVar5, 5E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_6(bVar13, iVar10, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_3(bVar13, iVar0, 2, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_7(bVar13, iVar11, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x12D8 / 4824
{
	bool bVar0;
...
var Function_6(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1428 / 5160
{
	bool bVar0;
...
var Function_7(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x14A8 / 5288
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x162F / 5679
{
	bool bVar0;
...
var Function_15(int iParam0) //Position: 0x169B / 5787
{
	bool bVar0;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1707 / 5895
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1783 / 6019
{
	int iVar0;
	int iVar1;
...
var Function_18(bool bParam0, int iParam1) //Position: 0x17C8 / 6088
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_19(int iParam0) //Position: 0x17D5 / 6101
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_20(bool bParam0, var uParam1) //Position: 0x17E1 / 6113
{
	if (!Function_8(128))
	{
		return;
