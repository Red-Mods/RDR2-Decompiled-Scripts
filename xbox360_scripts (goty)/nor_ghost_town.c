...
var Function_3(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x9BE / 2494
{
	bool bVar0;
...
var Function_13(int iParam0) //Position: 0xD55 / 3413
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0xDC1 / 3521
{
	int iVar0;
...
var Function_15(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE2D / 3629
{
	int iVar0;
	int iVar1;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE72 / 3698
{
	int iVar0;
	int iVar1;
...
var Function_17(bool bParam0, int iParam1) //Position: 0xEEE / 3822
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_18(int iParam0) //Position: 0xEFB / 3835
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_19(bool bParam0, var uParam1) //Position: 0xF07 / 3847
{
	if (!Function_8(128))
	{
		return;
