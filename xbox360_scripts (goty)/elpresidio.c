...
void main() //Position: 0x0 / 0
{
	...
	fLocal_3 = 2.0f;
	iLocal_164 = 0;
	Function_81("Initializing ElPresidio", 3);
	ALLOW_TUMBLEWEEDS(0);
	if (Function_77(40, 0) && !Function_77(41, 0))
	{
		iVar0 = 0;
		while (iVar0 <= Global_6962)
		{
			Function_76(&(Global_6962[iVar02]), &(Global_8172[iVar03]), 3);
			iVar0++;
		}
		Function_75(&(Global_29008[Global_30707[1]]), 2048);
	}
		...
		switch (iLocal_164)
		{
			...
			case 0x00000001:
				if (Function_74())
				{
					...
					if (Function_77(41, 0))
					{
						Function_73(&Global_6962, &Global_8172, 0, 530, "elp/elp_Gen");
						Function_73(&Global_6962, &Global_8172, 3, 521, "elp/Guard_Brain_elp");
						Function_73(&Global_6962, &Global_8172, 1, 529, "elp/elp_Major");
						Function_73(&Global_6962, &Global_8172, 2, 516, "elp/elp_Cmder");
						Function_72(&(Global_6962[102]), 2);
						Function_73(&Global_6962, &Global_8172, 11, 260, "elp/elp_Blacksmt");
						Function_73(&Global_6962, &Global_8172, 4, 522, "elp/Guard_Brain_elp1");
						Function_73(&Global_6962, &Global_8172, 5, 523, "elp/Guard_Brain_elp2");
						Function_73(&Global_6962, &Global_8172, 6, 531, "elp/Guard_Brain_elp3");
						Function_73(&Global_6962, &Global_8172, 7, 517, "elp/Guard_Brain_elp4");
						Function_73(&Global_6962, &Global_8172, 8, 518, "elp/Guard_Brain_elp5");
						Function_73(&Global_6962, &Global_8172, 9, 521, "elp/Guard_Brain_elp6");
					}
					iLocal_164 = 2;
				}
				iLocal_165 = 0;
			...
			case 0x00000002:
				if (Function_63())
				{
					...
					Local_166[04] = { StackVal, StackVal, StackVal, Function_62(FIND_OBJECT_IN_LAYOUT(Local_55, "stand_yelling"), FIND_OBJECT_IN_LAYOUT(Local_55, "rand_idle_stand5"), 1, 0, 0, 0, 0, 1) };
					Local_166[14] = { StackVal, StackVal, StackVal, Function_62(FIND_OBJECT_IN_LAYOUT(Local_55, "stand_yelling"), FIND_OBJECT_IN_LAYOUT(Local_55, "smoking_stand5"), 1, 0, 0, 0, 0, 1) };
					Local_166[24] = { StackVal, StackVal, StackVal, Function_62(FIND_OBJECT_IN_LAYOUT(Local_55, "stand_yelling"), FIND_OBJECT_IN_LAYOUT(Local_55, "smoking_stand4"), 1, 0, 0, 0, 0, 1) };
					Local_166[34] = { StackVal, StackVal, StackVal, Function_62(FIND_OBJECT_IN_LAYOUT(Local_55, "stand_yelling"), FIND_OBJECT_IN_LAYOUT(Local_55, "rand_idle_stand6"), 1, 0, 0, 0, 0, 1) };
					Local_166[44] = { StackVal, StackVal, StackVal, Function_62(FIND_OBJECT_IN_LAYOUT(Local_55, "stand_yelling"), FIND_OBJECT_IN_LAYOUT(Local_55, "rand_idle_stand7"), 1, 0, 0, 0, 0, 1) };
					iLocal_164 = 3;
				}
				iLocal_165 = 0;
				break;
			...
			case 0x00000003:
				...
				Function_61(&Global_6962, &Global_8172, iScriptParam_0);
				iLocal_164 = 5;
				iLocal_165 = 0;
				break;
			
			case 0x00000005:
				if (Function_60(&Global_6962, &Global_8172, iScriptParam_0))
				{
					iLocal_164 = 4;
					iLocal_165 = 0;
				}
			...
			case 0x00000006:
				Function_57(0, &uLocal_188, -708.815f, 67.513f, 3279.682f);
				Function_56(0, &uLocal_188, -717.114f, 67.513f, 3292.289f);
				Function_55(0, &uLocal_188, -708.815f, 67.513f, 3279.682f);
				Function_54(0, &uLocal_188, -707.428f, 63.247f, 3291.421f);
				Function_53(0, &uLocal_188, -708.815f, 67.513f, 3279.682f);
				Function_51(0, &uLocal_188, -722.821f, 67.444f, 3296.769f);
				Function_50(0, &uLocal_188, Local_55);
				Function_57(1, &uLocal_188, -713.523f, 67.513f, 3285.215f);
				Function_56(1, &uLocal_188, -723.239f, 82.564f, 3311.303f);
				Function_55(1, &uLocal_188, -713.523f, 67.513f, 3285.215f);
				Function_54(1, &uLocal_188, -723.239f, 82.564f, 3311.303f);
				Function_53(1, &uLocal_188, -713.523f, 67.513f, 3285.215f);
				Function_51(1, &uLocal_188, -725.956f, 67.513f, 3295.09f);
				Function_50(1, &uLocal_188, Local_55);
				Function_57(2, &uLocal_188, -724.647f, 67.444f, 3295.881f);
				Function_56(2, &uLocal_188, -667.545f, 65.615f, 3309.488f);
				Function_55(2, &uLocal_188, -708.495f, 67.514f, 3282.732f);
				Function_54(2, &uLocal_188, -722.121f, 75.168f, 3313.103f);
				Function_53(2, &uLocal_188, -680.707f, 63.247f, 3314.156f);
				Function_51(2, &uLocal_188, -699.914f, 66.449f, 3312.629f);
				Function_50(2, &uLocal_188, Local_55);
				Function_57(3, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_56(3, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_55(3, &uLocal_188, -723.107f, 67.518f, 3294.821f);
				Function_54(3, &uLocal_188, -694.297f, 63.247f, 3302.513f);
				Function_53(3, &uLocal_188, -699.914f, 66.449f, 3312.629f);
				Function_51(3, &uLocal_188, -687.773f, 69.633f, 3320.589f);
				Function_50(3, &uLocal_188, Local_55);
				Function_57(4, &uLocal_188, -699.914f, 66.449f, 3312.629f);
				Function_56(4, &uLocal_188, -687.773f, 69.633f, 3320.589f);
				Function_55(4, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_54(4, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_53(4, &uLocal_188, -717.974f, 63.332f, 3297.667f);
				Function_51(4, &uLocal_188, -723.107f, 67.518f, 3294.821f);
				Function_50(4, &uLocal_188, Local_55);
				Function_57(5, &uLocal_188, -723.107f, 67.518f, 3294.821f);
				Function_56(5, &uLocal_188, -717.974f, 63.332f, 3297.667f);
				Function_55(5, &uLocal_188, -699.914f, 66.449f, 3312.629f);
				Function_54(5, &uLocal_188, -687.773f, 69.633f, 3320.589f);
				Function_53(5, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_51(5, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_50(5, &uLocal_188, Local_55);
				Function_57(6, &uLocal_188, -717.974f, 63.332f, 3297.667f);
				Function_56(6, &uLocal_188, -723.107f, 67.518f, 3294.821f);
				Function_55(6, &uLocal_188, -717.974f, 63.332f, 3297.667f);
				Function_54(6, &uLocal_188, -706.122f, 63.471f, 3292.733f);
				Function_53(6, &uLocal_188, -687.773f, 69.633f, 3320.589f);
				Function_51(6, &uLocal_188, -665.638f, 73.428f, 3308.527f);
				Function_50(6, &uLocal_188, Local_55);
				Function_57(7, &uLocal_188, -720.367f, 67.518f, 3296.77f);
				Function_56(7, &uLocal_188, -719.387f, 75.168f, 3311.7f);
				Function_55(7, &uLocal_188, -717.593f, 82.548f, 3311.168f);
				Function_54(7, &uLocal_188, -717.518f, 74.085f, 3324.969f);
				Function_53(7, &uLocal_188, -736.38f, 77.258f, 3300.231f);
				Function_51(7, &uLocal_188, -726.041f, 72.947f, 3294.014f);
				Function_50(7, &uLocal_188, Local_55);
				Function_57(8, &uLocal_188, -736.38f, 77.258f, 3300.231f);
				Function_56(8, &uLocal_188, -726.041f, 72.947f, 3294.014f);
				Function_55(8, &uLocal_188, -720.367f, 67.518f, 3296.77f);
				Function_54(8, &uLocal_188, -719.387f, 75.168f, 3311.7f);
				Function_53(8, &uLocal_188, -717.593f, 82.548f, 3311.168f);
				Function_51(8, &uLocal_188, -717.518f, 74.085f, 3324.969f);
				Function_50(8, &uLocal_188, Local_55);
				Function_57(9, &uLocal_188, -717.593f, 82.548f, 3311.168f);
				Function_56(9, &uLocal_188, -717.518f, 74.085f, 3324.969f);
				Function_55(9, &uLocal_188, -736.38f, 77.258f, 3300.231f);
				Function_54(9, &uLocal_188, -726.041f, 72.947f, 3294.014f);
				Function_53(9, &uLocal_188, -720.367f, 67.518f, 3296.77f);
				Function_51(9, &uLocal_188, -719.387f, 75.168f, 3311.7f);
				Function_50(9, &uLocal_188, Local_55);
				Function_57(10, &uLocal_188, -722.69f, 63.35f, 3294.993f);
				...
				Function_51(10, &uLocal_188, -722.69f, 63.35f, 3294.993f);
				Function_50(10, &uLocal_188, Local_55);
				Function_57(11, &uLocal_188, -712.303f, 67.513f, 3280.132f);
				Function_56(11, &uLocal_188, -671.651f, 63.247f, 3317.933f);
				Function_55(11, &uLocal_188, -711.992f, 63.222f, 3285.779f);
				Function_54(11, &uLocal_188, -671.651f, 63.247f, 3317.933f);
				Function_53(11, &uLocal_188, -712.303f, 67.513f, 3280.132f);
				Function_51(11, &uLocal_188, -723.443f, 67.444f, 3294.47f);
				Function_50(11, &uLocal_188, Local_55);
				Function_45(&Global_6962, &Global_8172, &uLocal_188, Global_6289, iScriptParam_0);
				if (Function_59(&(Global_29008[iScriptParam_0]), 256) || !Function_44(2))
				{
					iLocal_429 = 1;
				}
				Function_43(StackVal, GET_OBJECT_FROM_PERS_CHAR(&Local_55 + 432));
				Function_75(&(Global_29008[iScriptParam_0]), 8);
				if (Function_59(&(Global_29008[iScriptParam_0]), 131072))
				{
					Function_42(&(Global_29008[iScriptParam_0]), 131072);
					iLocal_164 = 10;
				}
				else
				{
			...
			case 0x00000008:
				Function_38(StackVal, 0, 0.5f, 4, Local_4, 1);
				Function_37(64);
				if (Function_36(iScriptParam_0, &Global_6962, iLocal_429))
				{
				...
				{
					Function_32(1, 10, 6, 0, 3);
					Function_29(Local_4);
					Function_28(StackVal, 0);
					Function_28(StackVal, 0);
					Function_28(StackVal, 0);
					Function_28(StackVal, 0);
					Function_28(StackVal, 0);
			...
			case 0x00000009:
				...
				Function_25("Finished Initializing ElPresidio", 5.0f);
				iLocal_164 = 10;
				iLocal_165 = 0;
				break;
			
			case 0x0000000A:
				Function_21(&Local_166);
				if (Function_59(&(Global_29008[iScriptParam_0]), 131072))
				{
					iLocal_164 = 6;
				}
	...
	Function_42(&(Global_29008[iScriptParam_0]), 32);
	Function_42(&(Global_29008[iScriptParam_0]), 64);
	Function_42(&(Global_29008[iScriptParam_0]), 8);
	Function_42(&(Global_29008[iScriptParam_0]), 512);
	Function_42(&(Global_29008[iScriptParam_0]), 4);
	if (IS_SCRIPT_VALID(bLocal_187))
	{
		TERMINATE_SCRIPT(bLocal_187);
	}
	ALLOW_TUMBLEWEEDS(1);
	Function_25("Unloaded ElPresidio", 5.0f);
...
void Function_11(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xF8E / 3982
{
	...
	if (Function_59(&(Global_29008[iParam2]), 0x40000000))
	{
		...
		Function_42(&(Global_29008[iParam2]), 0x40000000);
	}
	iVar16 = 0;
	iVar16 = 0;
	...
	bVar17 = true;
	if (!Function_44(2) || Function_59(&(Global_29008[iParam2]), 256))
	{
		bVar17 = false;
	}
	iVar16 = 0;
...
void Function_12(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x118E / 4494
{
...
int Function_13(int iParam0) //Position: 0x12DD / 4829
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_14(int iParam0) //Position: 0x1308 / 4872
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_15(var uParam0, int iParam1) //Position: 0x133C / 4924
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_16(int iParam0, int iParam1) //Position: 0x134B / 4939
{
	int iVar0;
...
bool Function_17() //Position: 0x1367 / 4967
{
...
bool Function_18(bool bParam0, int iParam1) //Position: 0x1382 / 4994
{
	return (bParam0 && iParam1) == 0;
}

var Function_19(int iParam0) //Position: 0x138F / 5007
{
	if (!Function_4(iParam0))
	{
		return "";
...
bool Function_20() //Position: 0x183D / 6205
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_21(int iParam0) //Position: 0x1846 / 6214
{
	bool bVar0;
	int iVar1;
	...
	while (bVar0 < (*iParam0 - 1))
	{
		if (StackVal && IS_GRINGO_VALID(IS_GRINGO_VALID((*iParam0)[bVar04])))
		{
			if (IS_OBJECT_VALID(GRINGO_QUERY_NAMED_COMPONENT_USER((*iParam0)[bVar04], "UseCase1")))
			{
				...
				if (StackVal && IS_OBJECT_VALID(GRINGO_QUERY_NAMED_COMPONENT_USER(Function_18(StackVal, 4), "UseCase1")))
				{
			...
			{
				if (Function_18(StackVal, 16))
				{
					Function_22(iParam0[bVar04] + 8, 64);
				}
				else if (Function_18(StackVal, 32))
				{
			...
			else
			{
				if (iParam0[bVar04]->f_12 >= 4294967295)
				{
					...
					else if (StackVal && Function_18(Function_18(StackVal, 64), 16))
					{
				...
				if (iParam0[bVar04]->f_12 >= 4294967295)
				{
					...
					else if (Function_18(StackVal, 64))
					{
						if (Function_18(StackVal, 32))
						{
					...
					else if (Function_18(StackVal, 8))
					{
...
void Function_22(var uParam0, bool bParam1) //Position: 0x1FD6 / 8150
{
	*uParam0 = (*uParam0 - (*uParam0 && bParam1));
	return;
}

void Function_23(vector3 vParam0) //Position: 0x1FE9 / 8169
{
	if (Function_18(vParam0.z, 128))
	{
		PRINTSTRING(bParam4);
...
void Function_24(var uParam0, int iParam1) //Position: 0x2010 / 8208
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_25(bool bParam0, float fParam1) //Position: 0x201F / 8223
{
	if (!Function_44(128))
	{
		return;
...
void Function_26(bool bParam0, bool bParam1) //Position: 0x205D / 8285
{
	char[] cVar0[4];
...
void Function_27(var uParam0, int iParam1) //Position: 0x2157 / 8535
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

int Function_28(bool bParam0, bool bParam1) //Position: 0x2164 / 8548
{
	bool bVar0;
	bool bVar1;
...
void Function_29(bool bParam0) //Position: 0x21DD / 8669
{
	vector3 vVar0;
...
void Function_30(var uParam0) //Position: 0x22C8 / 8904
{
	int iVar0;
...
var Function_31() //Position: 0x22E5 / 8933
{
	int iVar0;
...
void Function_32(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x22ED / 8941
{
...
void Function_33() //Position: 0x23D1 / 9169
{
	int iVar0;
...
int Function_34(int iParam0) //Position: 0x241F / 9247
{
...
bool Function_35(int iParam0) //Position: 0x2437 / 9271
{
...
bool Function_36(int iParam0, int iParam1, bool bParam2) //Position: 0x244C / 9292
{
	char* cVar0[64];
	struct<5> Var16;
	...
	*iParam1[02] = { StackVal, *iParam1[02] };
	...
	if (!Function_59(&(Global_29008[iParam0]), 2048))
	{
		return 0;
	}
	if (iParam0 != Global_30717[1] && Function_77(49, 0))
	{
		return 0;
	}
	if (bParam2)
...
void Function_37(bool bParam0) //Position: 0x250C / 9484
{
	Global_26316.f_56 = (Global_26316.f_56 || bParam0);
	return;
}

void Function_38(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x251F / 9503
{
	bool bVar0;
...
void Function_39(int iParam0) //Position: 0x2632 / 9778
{
	Function_40(&Global_28842, iParam0);
	return;
}

void Function_40(var uParam0, var uParam1) //Position: 0x2640 / 9792
{
...
void Function_41() //Position: 0x265B / 9819
{
...
void Function_42(var uParam0, int iParam1) //Position: 0x2677 / 9847
{
	int iVar0;
...
void Function_43(var uParam0, bool bParam1) //Position: 0x268E / 9870
{
	bool bVar0;
...
bool Function_44(int iParam0) //Position: 0x26D6 / 9942
{
	int iVar0;
...
void Function_45(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x26F2 / 9970
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 <= *uParam0)
	{
		...
		{
			if (Function_46(uParam0[iVar02], uParam1[iVar03], iVar0, uParam2, uParam3, iParam4))
			{
				iVar1++;
			}
			else
	...
	if (iVar1 >= 0)
	{
		Function_42(&(Global_29008[iParam4]), 2048);
	}
...
bool Function_46(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x27A4 / 10148
{
	int iVar0;
	char* cVar1[16];
	...
	Function_47(StackVal, uParam3[iVar020]);
	return 1;
}

int Function_47(bool bParam0, int iParam1) //Position: 0x290F / 10511
{
	vector3 vVar0;
	bool bVar20;
...
bool Function_48(vector3 vParam0) //Position: 0x2A4B / 10827
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_49(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x2A63 / 10851
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_50(int iParam0, var uParam1, bool bParam2) //Position: 0x2B7C / 11132
{
	bool bVar0;
...
void Function_51(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2BD7 / 11223
{
	bool bVar0;
...
bool Function_52(vector3 vParam0, vector3 vParam3) //Position: 0x2C3D / 11325
{
	vector3 vVar0;
...
void Function_53(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2C6A / 11370
{
	bool bVar0;
...
void Function_54(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2CD2 / 11474
{
	bool bVar0;
...
void Function_55(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2D3C / 11580
{
	bool bVar0;
...
void Function_56(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2DA1 / 11681
{
	bool bVar0;
...
void Function_57(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2E09 / 11785
{
	bool bVar0;
...
int Function_58(int iParam0) //Position: 0x2E6C / 11884
{
	if (!Function_4(iParam0))
	{
		return 1;
...
bool Function_59(var uParam0, int iParam1) //Position: 0x2E88 / 11912
{
	int iVar0;
...
bool Function_60(var uParam0, var uParam1, int iParam2) //Position: 0x2EA4 / 11940
{
	int iVar0;
	char* cVar1[64];
...
void Function_61(var uParam0, var uParam1, bool bParam2) //Position: 0x2F85 / 12165
{
	int iVar0;
	char* cVar1[64];
...
struct<16> Function_62(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x306D / 12397
{
	struct<4> Var0;
...
bool Function_63() //Position: 0x3136 / 12598
{
	bool bVar0;
	
	Function_71(3, 3);
	bVar0 = bVar0;
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/mex_towerguard", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/sleeping_wall_scripted", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/mex_gateguards", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/mex_talking_soldiers_link", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_guntricks_e_any", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/lean_rail", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_check_clipboard", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/repair_kneel", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_l", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_l_talking", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_horseshoe", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/horse_tend", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/sleeping_scripted", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_worried_n_any", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/sit_cleanrifle", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/stand_yelling_mid", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_r", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_l", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/lean_table", 1, 0);
	Function_69(&Local_55 + 4, "$/content/scripting/gringo/simplegringo/sit_barrel", 1, 0);
	if (!Function_64(&Local_55 + 4))
	{
		return 0;
	}
	...
	Local_55.f_432 = CREATE_OBJECTSET_IN_LAYOUT(Function_31(), Local_55, 12, 0);
...
bool Function_64(int iParam0) //Position: 0x5253 / 21075
{
	int iVar0;
	int iVar1;
...
void Function_65() //Position: 0x55CE / 21966
{
	if (!Function_44(128))
	{
		return;
...
bool Function_66() //Position: 0x560E / 22030
{
	int iVar0;
...
void Function_67(var uParam0, int iParam1) //Position: 0x5639 / 22073
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_68() //Position: 0x564A / 22090
{
	if (!Function_44(128))
	{
		return;
...
var Function_69(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x568C / 22156
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_70(uParam0, uVar1, iParam2);
	if (bParam3)
	{
...
var Function_70(var uParam0, int iParam1, int iParam2) //Position: 0x56C4 / 22212
{
	int iVar0;
...
void Function_71(int iParam0, int iParam1) //Position: 0x5788 / 22408
{
	switch (iParam1)
	{
		case 0x00000000:
...
void Function_72(int iParam0, int iParam1) //Position: 0x57D1 / 22481
{
	int iVar0;
...
void Function_73(var uParam0, var uParam1, var uParam2, int iParam3, bool bParam4) //Position: 0x57E8 / 22504
{
	int iVar0;
	char* cVar1[64];
	...
	Function_72(uParam0[iVar02], 1);
	Function_15(uParam0[iVar02], 2);
	Function_72(uParam0[iVar02], 8);
	Function_72(uParam0[iVar02], 16);
}

bool Function_74() //Position: 0x5882 / 22658
{
	var uVar0;
...
void Function_75(var uParam0, int iParam1) //Position: 0x5CDD / 23773
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_76(var uParam0, var uParam1, int iParam2) //Position: 0x5CEC / 23788
{
	var uVar0;
	...
	if (iParam2 == 0)
	{
		ADD_TIME(&uVar0, Function_14(Global_29007), 0, false, 0);
	}
	else
	{
...
bool Function_77(int iParam0, bool bParam1) //Position: 0x5D3F / 23871
{
	int iVar0;
...
bool Function_78(int iParam0) //Position: 0x5D7C / 23932
{
...
var Function_79(int iParam0) //Position: 0x5D93 / 23955
{
...
bool Function_80(int iParam0) //Position: 0x5DAD / 23981
{
...
void Function_81(bool bParam0, var uParam1) //Position: 0x5DC3 / 24003
{
	if (!Function_44(128))
	{
		return;
