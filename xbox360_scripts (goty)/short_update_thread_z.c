...
int Function_13(int iParam0, int iParam1, bool bParam2) //Position: 0x998 / 2456
{
	int iVar0;
	bool bVar1;
...
void Function_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x164C / 5708
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_43(char* cParam0, bool bParam1) //Position: 0x1D7F / 7551
{
	char* cVar0[32];
...
void Function_94(bool bParam0, bool bParam1) //Position: 0x4874 / 18548
{
...
void Function_103(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4BD0 / 19408
{
	struct<4> Var0;
	int iVar4;
...
void Function_106(bool bParam0) //Position: 0x4CB7 / 19639
{
	...
	if (Global_27774[bParam013].f_48 == 4294967295 && Global_27774[bParam013].f_48 == 0)
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_109(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), false, 0);
...
void Function_108(bool bParam0, bool bParam1) //Position: 0x4EBE / 20158
{
	bool bVar0;
...
void Function_119(bool bParam0) //Position: 0x5254 / 21076
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_123(bParam0), 1.0f, false, 0);
	return;
}
...
bool Function_123(bool bParam0) //Position: 0x5402 / 21506
{
	if (Function_69() || Global_34165.f_44)
	{
...
void Function_126(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x54C0 / 21696
{
	...
	*bParam1 = iParam2;
	...
	{
		Function_133(bParam0, 1);
		SET_JOURNAL_ENTRY_PROGRESS(Function_123(bParam0), 0.0f, false, 0);
	}
	else
	{
		SET_JOURNAL_ENTRY_PROGRESS(Function_123(bParam0), (TO_FLOAT(Global_49310[bParam022].f_28) / TO_FLOAT(bParam3)), false, 0);
	}
...
void Function_132(bool bParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x5656 / 22102
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_123(bParam0), fParam1, true, 0);
	if (bParam2)
	{
			...
			if (GET_WEAPON_IN_HAND(Global_34573) == 37)
			{
				if (FIND_GROUND_INTERSECTION(&vVar1, 2.0f, &vVar5, &vVar8))
				{
					...
					if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(FIND_NAMED_LAYOUT("PlayerLayout"), &cVar11)))
					{
						...
						iVar28 = GET_PHYSINST_FROM_OBJECT(bVar27);
						SET_PROP_TARGETABLE(iVar28, 1, 0);
						SET_PROP_TARGETABLE_ACQUISITION_RADIUS(iVar28, 10.0f);
						SET_PROP_TARGETABLE_SCORE_BIAS(iVar28, -100000.0f);
						SET_PROP_TARGETABLE_AS_ENEMY(iVar28, 1);
						SET_PROP_TARGETABLE_TARGET_BOX_SIZE(iVar28, 0.1f, 0.1f);
					}
				}
			}
...
void Function_142(bool bParam0, var uParam1, var uParam2, var uParam3, bool bParam4) //Position: 0x5D29 / 23849
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
		...
		if (IS_OBJECT_VALID(bVar1))
		{
			...
			if (IS_ACTOR_VALID(bVar2))
			{
				if (!IS_ACTOR_HOGTIED(bVar2))
				{
					...
					TASK_GO_NEAR_COORD(false, &uParam1, bParam4, iVar5);
					TASK_WANDER(false, 10.0f);
					TASK_SEQUENCE_CLOSE();
					if (bVar2 != Global_34573)
					{
						TASK_SEQUENCE_PERFORM(bVar2, bVar3);
					}
...
bool Function_145(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x5F46 / 24390
{
									...
									switch (GET_EVENT_TYPE(bParam0))
									{
											...
											if (!IS_OBJECT_VALID(FIND_OBJECT_IN_OBJECT(bVar1, "Hogtie_Pickup")))
											{
												...
												if (IS_VOLUME_VALID(bVar6) && !Global_3385)
												{
													...
													if (iVar7 != 0)
													{
														...
														{
															Function_217(iVar7, 0, 0, RAND_INT_RANGE(true, 5), 20);
														}
														else
														{
										...
										case 0x00000002:
											...
											else
											{
												...
												{
													bVar13 = Function_220(Global_29006);
													if (bVar13 != 0)
													{
														if (Global_12976.f_36 != bVar1)
														{
															if (!Function_218(Global_29006))
															{
																Function_217(bVar13, 0, 0, RAND_INT_RANGE(true, 5), 20);
															}
															else
															{
...
bool Function_164(bool bParam0) //Position: 0x7A74 / 31348
{
...
void Function_177(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x806E / 32878
{
	...
	if (bVar12)
	{
		if (bVar11)
		{
			...
			if ((Function_178() && DECOR_CHECK_EXIST(bParam0, "Zombie")) || (bVar0 <= 1222 && bVar0 >= 1227))
			{
...
void Function_183(var uParam0, char* cParam1) //Position: 0x8744 / 34628
{
	...
	Function_184(&bVar0, cParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_DECORATOR(*uParam0, 0, cParam1, "endLinkedAnimation", 0, 1, 180f);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESETTILT(bVar1, 100.0f, 1);
	return;
}
...
void Function_198(var uParam0, char* cParam1) //Position: 0x8E02 / 36354
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_199(&bVar0, cParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_DECORATOR(*uParam0, 0, cParam1, "endLinkedAnimation", 0, 1, 180.0f);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESETTILT(bVar1, 100.0f, 1);
	return;
}
...
void Function_217(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x959A / 38298
{
	while (bParam4 > 60)
	{
		bParam4 = (bParam4 - 60);
		...
		case 0x00000002:
			...
			if (IS_ACTOR_ANIMAL(GET_ACTOR_FROM_OBJECT(bVar1)))
			{
				...
				if (StackVal && Function_9(!Function_9(StackVal, 4), 2))
				{
					...
					if (bVar2 == 24)
					{
						bVar5 = GET_ACTOR_ENUM(GET_ACTOR_FROM_OBJECT(bVar1));
			...
			if ((bVar4 == 1263 && bVar4 == 1264) && bVar4 == 1265)
			{
				...
				else if (((((((!DECOR_CHECK_EXIST(bVar1, "Zombie") && !(bVar4 <= 1204 && bVar4 >= 1254)) && bVar4 == 541) && bVar4 == 542) && bVar4 == 543) && bVar4 == 544) && bVar4 == 1252) && bVar4 == 1253)
				{
					Function_39(27, 1, 0, 0);
					if (IS_ACTOR_ON_TRAIN(GET_ACTOR_FROM_OBJECT(bVar0), 0))
					{
...
void Function_248(int iParam0, bool bParam1, int iParam2) //Position: 0xC4F2 / 50418
{
	if (StackVal == 1)
	{
		if (iParam0 == 10)
	...
	if (iParam0 == 2)
	{
		...
		if (StackVal != 1)
		{
			if (StackVal || (((((((((StackVal != 0 && Global_50170[23022].f_28 < 0) && Global_50170[23022].f_28 == 24) && Global_50170[23022].f_28 == 23) && Global_50170[23022].f_28 == 35) && Global_50170[23022].f_28 == 25) && Global_50170[23022].f_28 == 29) && Global_50170[23022].f_28 == 36) && Global_50170[23022].f_28 == 37) && Global_50170[23022].f_28 == 32) == 0)
			{
				if (StackVal == 4)
				{
					if (!Function_249(GET_LAST_HIT_FLAGS(bParam1), 262144) && !IS_PLAYER_DEADEYE(false))
					{
						Function_61(0, &Global_49310[022] + 8, &Global_49310[022] + 12, 0);
					}
				}
		...
		case 0x00000001:
			switch (iParam1)
			{
				...
				case 0x0000000A:
					...
					GIVE_WEAPON_TO_ACTOR(Global_34573, 7, 0, 1, 1);
					GIVE_WEAPON_TO_ACTOR(Global_34573, 11, 0, 1, 1);
					break;
			}
			break;
		...
		case 0x00000000:
			switch (iParam1)
			{
				...
				case 0x0000000A:
					...
					GIVE_WEAPON_TO_ACTOR(Global_34573, 20, 0, 1, 1);
					GIVE_WEAPON_TO_ACTOR(Global_34573, 3, 0, 1, 1);
					break;
			}
			break;
...
int Function_284(int iParam0, int iParam1) //Position: 0xDDC2 / 56770
{
	var uVar0;
...
int Function_287(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0xDED4 / 57044
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
vector3 Function_298(bool bParam0) //Position: 0xEB34 / 60212
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_299(vector3 vParam0) //Position: 0xEB8B / 60299
{
	bool bVar0;
...
bool Function_304(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0xEFC1 / 61377
{
...
bool Function_325(bool bParam0) //Position: 0x10509 / 66825
{
...
void Function_339(int iParam0) //Position: 0x10D21 / 68897
{
	...
	ADD_TIME(&Global_12976 + 4, 0, false, (iParam0 + Function_340(105)), 0);
	return;
}
...
void Function_341(bool bParam0) //Position: 0x10D58 / 68952
{
...
void Function_342(int iParam0) //Position: 0x10DF4 / 69108
{
	...
	ADD_TIME(&Global_12976 + 12, 0, false, (iParam0 + Function_340(90)), 0);
	return;
}
...
void Function_348(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1152C / 70956
{
	*uParam3 = (bParam0 && 15);
...
void Function_360(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x11C2D / 72749
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
void Function_406(bool bParam0, bool bParam1, int iParam2) //Position: 0x147D3 / 83923
{
	bool bVar0;
...
bool Function_413(bool bParam0, bool bParam1, int iParam2, var uParam3, bool bParam4, bool bParam5, var uParam6) //Position: 0x14B4F / 84815
{
	...
	if (IS_ACTOR_IN_VOLUME(bParam1, bParam0))
	{
		...
		{
			SET_PLAYER_CONTROL(false, 0, iParam2, iParam2);
		}
		if (IS_PLAYER_DEADEYE(false) && uParam3)
		{
			CANCEL_DEADEYE();
			CANCEL_TIME_WARP(1);
		}
		...
		if (bParam5 && IS_ACTOR_RIDING(bParam1))
		{
			...
			TASK_DISMOUNT(false, 1);
			TASK_GO_TO_COORD(false, &vVar1, 1);
			TASK_SEQUENCE_CLOSE();
		...
		switch (GET_EVENT_RESPONSE_ID(iVar2))
		{
			...
			case 0x00000038:
				...
				if (IS_OBJECT_VALID(bVar12))
				{
					...
					{
						bVar53 = GET_ACTOR_ENUM(bVar52);
						if (bVar53 <= 976 && bVar53 >= 1007)
						{
							if (DECOR_CHECK_EXIST(Global_34573, "HorseStolen"))
							{
				...
				if (IS_OBJECT_VALID(bVar13) && IS_OBJECT_VALID(bVar12))
				{
					...
					if (GET_OBJECT_TYPE(bVar12) == 15)
					{
						...
						if (IS_ACTOR_VEHICLE(bVar10))
						{
							...
							while (bVar1 <= GET_NUM_AVAILABLE_SEATS(bVar10))
							{
								bVar24 = GET_ACTOR_IN_VEHICLE_SEAT(bVar10, bVar1);
				...
				if (IS_OBJECT_VALID(bVar13) && IS_OBJECT_VALID(bVar12))
				{
					if (GET_OBJECT_TYPE(bVar13) == 15)
					{
						if (IS_ACTOR_VALID(GET_ACTOR_FROM_OBJECT(bVar13)))
						{
							...
							{
								bVar14 = GET_OBJECT_FROM_ACTOR(GET_MOUNT(GET_ACTOR_FROM_OBJECT(bVar13)));
								bVar19 = GET_ACTOR_ENUM(GET_ACTOR_FROM_OBJECT(bVar12));
								bVar18 = bVar19;
								switch (bVar18)
								{
									case 0x000004AD:
...
void Function_423(var uParam0, char* cParam1, var uParam2, var uParam3) //Position: 0x17BAF / 97199
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_426(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_425(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_424(&bVar0, uParam2);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_428(var uParam0, char* cParam1, var uParam2, var uParam3) //Position: 0x17E25 / 97829
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_431(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_430(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_429(&bVar0, uParam2);
...
void Function_433(var uParam0, var uParam1, int iParam2) //Position: 0x180DC / 98524
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_435(&bVar0, uParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_434(&bVar0, iParam2);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_437(var uParam0, int iParam1) //Position: 0x182A3 / 98979
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_439(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_438(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 2.0f, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 1, 2.0f, 1);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(bVar1, 2.0f, 0, 0f);
	return;
}
...
void Function_441(var uParam0, int iParam1) //Position: 0x18436 / 99382
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_443(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_442(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_445(var uParam0, int iParam1) //Position: 0x18613 / 99859
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_447(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_446(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 0.25f, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_EASE_IN_OUT(*uParam0, 0, 1, 0.9f, 1, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 1, 1.0f, 2);
...
void Function_450(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1882E / 100398
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_451(&bVar0, uParam1, uParam2, uParam3);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_453(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x189C8 / 100808
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_454(&bVar0, uParam1, uParam2, uParam3);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_519(var uParam0, var uParam1, char* cParam2) //Position: 0x1A778 / 108408
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_521(&bVar0, uParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_520(&bVar0, uParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_524(var uParam0, char* cParam1) //Position: 0x1A9C2 / 108994
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_527(&bVar0, cParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_526(&bVar0, cParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_525(&bVar0, cParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_535(bool bParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x1AF0C / 110348
{
	int iVar0;
