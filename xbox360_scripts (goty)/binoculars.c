...
void Function_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBE0 / 3040
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_22(int iParam0, int iParam1) //Position: 0x13AB / 5035
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
int Function_29(int iParam0) //Position: 0x1950 / 6480
{
	if (iParam0 == 4294967295)
	{
...
bool Function_45(var uParam0, int iParam1) //Position: 0x289F / 10399
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(bool bParam0, int iParam1) //Position: 0x28AC / 10412
{
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28D4 / 10452
{
	uParam0 = uParam0;
...
int Function_49(bool bParam0) //Position: 0x2978 / 10616
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_72(bParam0, uVar0))
			{
				Function_63(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_62(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_58(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
		...
		case 0x00000003:
			if (!Function_52(bParam0, uVar0, &iLocal_2))
			{
				iLocal_1 = 4;
			}
			iVar1 = 0;
...
void Function_50(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A21 / 10785
{
	...
	*iParam2 = 0;
	...
	bLocal_12 = (GET_CURRENT_GAME_TIME() - bLocal_12);
	Function_51(471, CEIL(bLocal_12), 0, 0);
	if ((((UI_ISACTIVE("BinocularsUI") || UI_ISACTIVE("Movies")) || IS_GAME_RESETTING()) || IS_OBJECT_VALID(bLocal_5)) || IS_OBJECT_VALID(bLocal_4))
	{
		UI_POP("BinocularsUI");
	}
	UNK_0xE6C1DBD9(0);
	...
	{
		DESTROY_CAMERA(bLocal_4);
	}
	if (IS_OBJECT_VALID(bLocal_5))
	{
		DESTROY_OBJECT(bLocal_5);
	}
	ALLOW_GAME_CAMERA_AUTO_TILTING(iLocal_6, 2);
	ALLOW_GAME_CAMERA_AUTO_CENTERING(iLocal_7, 2);
	ALLOW_GAME_CAMERA_AUTO_TILTING(iLocal_8, 0);
	ALLOW_GAME_CAMERA_AUTO_CENTERING(iLocal_9, 0);
	ALLOW_GAME_CAMERA_AUTO_TILTING(iLocal_10, 1);
	ALLOW_GAME_CAMERA_AUTO_CENTERING(iLocal_11, 1);
	Global_63096 = 0;
...
int Function_51(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2AFA / 11002
{
	int iVar0;
	int iVar1;
...
bool Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x2D1A / 11546
{
	bool bVar0;
	float fVar1;
	var uVar2;
	...
	bVar0 = Function_62(bParam0);
	if (*iParam2 && !((Global_3378 || HUD_IS_FADING()) || HUD_IS_FADED()))
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar0) && iLocal_3)
		{
			if (DECOR_CHECK_EXIST(bParam1, "BinocularsStart"))
			{
				if (Function_56())
				{
					DECOR_REMOVE(bParam1, "BinocularsStart");
				}
			}
			if (DECOR_CHECK_EXIST(Global_34573, "nquitbinos"))
			{
				UI_POP("BinocularsUI");
				UNK_0xE6C1DBD9(0);
				DESTROY_CAMERA(bLocal_4);
				DESTROY_OBJECT(bLocal_5);
				SET_ACTION_NODE_FOR_ACTOR(bParam1, "item_binoculars/lower");
				DECOR_REMOVE(Global_34573, "nquitbinos");
				return 0;
			}
			if (!GRINGO_IS_ACTOR_PLAYING_ANIM(bParam1, bVar0) && !DECOR_CHECK_EXIST(Global_34573, "anthro04"))
			{
				return 0;
			}
			if ((IS_BUTTON_PRESSED(Function_55(), 5, 1, 0) && !(Function_54() && IS_PS3())) || ((IS_BUTTON_PRESSED(Function_55(), 6, 1, 0) && Function_54()) && IS_PS3()))
			{
				if (!DECOR_CHECK_EXIST(Global_34573, "anthro04"))
				{
			...
			if (IS_OBJECT_VALID(bLocal_4) && UNK_0x00EF33EF())
			{
				fVar1 = GET_CURRENT_GAME_TIME();
				uVar2 = GET_CAMERA_FOV(bLocal_4);
				UPDATE_AIMRAMP(&fVar3, &fVar4, bLocal_5, "roamNew", 1);
				GET_OBJECT_ORIENTATION(bLocal_4, &vVar5);
				fVar8 = (TAN_DEGREE(uVar2) * 57.295f);
				vVar5.x = (vVar5.x + (fVar3 * fVar8));
				vVar5.f_4 = (vVar5.y + (fVar4 * fVar8));
				Function_53(&vVar5, 60.0f, -20.0f);
				SET_OBJECT_ORIENTATION(bLocal_4, vVar5);
				bVar9 = GET_OBJECT_FROM_ACTOR(bParam1);
				GET_OBJECT_NAMED_BONE_POSITION(bVar9, "head", &vVar10);
				GET_OBJECT_POSITION(bVar9, &vVar13);
				vVar19 = { 0.0f, 0.0f, 0.1f };
				UNK_0xB89CC342(bParam1, &vVar19, &vVar22);
				vVar10 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(StackVal, StackVal, StackVal) - Vector(vVar13, vVar10, vVar22), StackVal, StackVal) };
				SET_CAMERA_POSITION(bLocal_4, vVar10);
			}
		}
		else if (!iLocal_3)
		{
			...
			{
				uVar25 = GET_CAMERA_FOV(bLocal_4);
				fVar26 = GET_CURRENT_GAME_TIME();
				if (IS_BUTTON_PRESSED(Function_55(), 5, 1, 0))
				{
					if (!DECOR_CHECK_EXIST(Global_34573, "anthro04"))
					{
						PLAY_SOUND_FRONTEND("HUD_MENU_SELECT_MASTER");
				...
				UPDATE_AIMRAMP(&fVar27, &fVar28, bLocal_5, "roamNew", 1);
				GET_OBJECT_ORIENTATION(bLocal_4, &vVar29);
				fVar32 = (TAN_DEGREE(uVar25) * 57.295f);
				vVar29.x = (vVar29.x + (fVar27 * fVar32));
				vVar29.f_4 = (vVar29.y + (fVar28 * fVar32));
				Function_53(&vVar29, 89.0f, -89.0f);
				SET_OBJECT_ORIENTATION(bLocal_4, vVar29);
				bVar33 = GET_OBJECT_FROM_ACTOR(bParam1);
				GET_OBJECT_NAMED_BONE_POSITION(bVar33, "head", &vVar34);
				GET_OBJECT_POSITION(bVar33, &vVar37);
				vVar43 = { 0.0f, 0.0f, 0.1f };
				UNK_0xB89CC342(bParam1, &vVar43, &vVar46);
				vVar34 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(StackVal, StackVal, StackVal) - Vector(vVar37, vVar34, vVar46), StackVal, StackVal) };
				SET_CAMERA_POSITION(bLocal_4, vVar34);
			}
		}
		else
		{
...
void Function_53(var uParam0, float fParam1, float fParam2) //Position: 0x30DC / 12508
{
	if (*uParam0 > fParam2)
	{
		*uParam0 = fParam2;
...
var Function_54() //Position: 0x3101 / 12545
{
	return HAS_STRING_TABLE_LOADED("jp");
}

int Function_55() //Position: 0x310F / 12559
{
	bool bVar0;
...
bool Function_56() //Position: 0x3129 / 12585
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (!IS_OBJECT_VALID(bLocal_4))
	{
		bLocal_4 = CREATE_CAMERA_IN_LAYOUT(Function_57(), "bino_camera", 0);
	}
	if (!IS_OBJECT_VALID(bLocal_5))
	{
		bLocal_5 = CREATE_AIMRAMP_IN_LAYOUT(Function_57(), "bino_camera_ar");
	}
	if (IS_OBJECT_VALID(bLocal_4))
	{
		if (UNK_0x00EF33EF())
		{
			INIT_CAMERA_FROM_GAME_CAMERA(bLocal_4);
			SET_CURRENT_CAMERA_ON_CHANNEL(bLocal_4, 0, 0f, 0f, 0, 0, 0, 0, 0, 0);
			bVar0 = GET_OBJECT_FROM_ACTOR(Global_34573);
			GET_OBJECT_NAMED_BONE_POSITION(bVar0, "head", &vVar1);
			GET_OBJECT_POSITION(bVar0, &vVar4);
			vVar10 = { 0.0f, 0.0f, -0.1f };
			UNK_0xB89CC342(Global_34573, &vVar10, &vVar13);
			vVar1 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(StackVal, StackVal, StackVal) - Vector(vVar4, vVar1, vVar13), StackVal, StackVal) };
			SET_CAMERA_POSITION(bLocal_4, vVar1);
			SET_CAMERA_NEAR_CLIP_PLANE(bLocal_4, 0.35f);
			SET_CAMERA_FOV(bLocal_4, 7.6f);
			if (!DECOR_CHECK_EXIST(Global_34573, "anthro04"))
			{
				UI_PUSH("BinocularsUI");
			}
			UNK_0xE6C1DBD9(1);
			iLocal_6 = GET_GAME_CAMERA_AUTO_TILTING_STATE(2);
			iLocal_7 = GET_GAME_CAMERA_AUTO_CENTERING_STATE(2);
			iLocal_8 = GET_GAME_CAMERA_AUTO_TILTING_STATE(0);
			iLocal_9 = GET_GAME_CAMERA_AUTO_CENTERING_STATE(0);
			iLocal_10 = GET_GAME_CAMERA_AUTO_TILTING_STATE(1);
			iLocal_11 = GET_GAME_CAMERA_AUTO_CENTERING_STATE(1);
			ALLOW_GAME_CAMERA_AUTO_TILTING(0, 2);
			ALLOW_GAME_CAMERA_AUTO_CENTERING(0, 2);
			ALLOW_GAME_CAMERA_AUTO_TILTING(0, 0);
			ALLOW_GAME_CAMERA_AUTO_CENTERING(0, 0);
			ALLOW_GAME_CAMERA_AUTO_TILTING(0, 1);
			ALLOW_GAME_CAMERA_AUTO_CENTERING(0, 1);
			Global_63096 = 1;
			if (IS_HUD_MAP_DRAW_ENABLED())
			{
...
var Function_57() //Position: 0x3285 / 12933
{
	bool bVar0;
...
void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x32F1 / 13041
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(uParam1, bVar1, Function_60(bVar1, "AttachBone", &iVar2), Function_60(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_59(bVar1, uParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_59(bool bParam0, int iParam1) //Position: 0x337B / 13179
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_60(bool bParam0, bool bParam1, int iParam2) //Position: 0x3429 / 13353
{
	int iVar0;
	bool bVar1;
...
var Function_61(bool bParam0) //Position: 0x346E / 13422
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_62(bool bParam0) //Position: 0x3484 / 13444
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_63(var uParam0, bool bParam1, int iParam2) //Position: 0x349A / 13466
{
	Function_71("BINOCULARS: StartUse");
	uParam0 = Function_70(uParam0);
	*iParam2 = 0;
	if (DECOR_CHECK_EXIST(bParam1, "BinocularsStart"))
	{
		DECOR_REMOVE(bParam1, "BinocularsStart");
	}
	if ((IS_ACTOR_INSIDE_VEHICLE(bParam1) && Global_34577 == 0) && Global_34577 == 1)
	{
		Function_68("item_binoculars_fail", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
		iLocal_3 = 0;
	}
	else
	{
		if (((Function_64(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || DECOR_CHECK_EXIST(Global_34573, "anthro04"))
		{
			iLocal_3 = 0;
		}
		bLocal_12 = GET_CURRENT_GAME_TIME();
		if (DECOR_CHECK_EXIST(Global_34573, "anthro04"))
		{
			STREAMING_REQUEST_PROP(GET_ASSET_ID("s_binoculars01x", 0), false);
			*iParam2 = 1;
		}
		else if (Function_45(Global_63084.f_32, 1))
		{
			*iParam2 = 0;
			Function_68("item_binoculars_fail", 0x41200000, 1, 0, 2, 1, 0);
		}
		else if (IS_PLAYER_USING_COVER(0))
		{
			*iParam2 = 0;
			Function_68("item_binoculars_fail", 0x41200000, 1, 0, 2, 1, 0);
		}
		else if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(bParam1)) || !IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(bParam1)))
		{
		...
		if (IS_WEAPON_DRAWN(bParam1) && *iParam2)
		{
...
int Function_64(bool bParam0, bool bParam1, bool bParam2) //Position: 0x36B6 / 14006
{
...
bool Function_65() //Position: 0x376C / 14188
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_66(bool bParam0) //Position: 0x3783 / 14211
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_67(bool bParam0) //Position: 0x378E / 14222
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x379C / 14236
{
	struct<4> Var0;
	var uVar4;
	...
	if (Global_3380 != 1 && Global_6269 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_69(Global_6269) };
		}
...
struct<16> Function_69(int iParam0) //Position: 0x3817 / 14359
{
	char* cVar0[16];
...
var Function_70(bool bParam0) //Position: 0x3856 / 14422
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

void Function_71(int iParam0) //Position: 0x3870 / 14448
{
	LOG_OBJECT2(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), iParam0, 0, 0, 0);
	return;
}

bool Function_72(int iParam0, bool bParam1) //Position: 0x3884 / 14468
{
	bool bVar0;
	bool bVar1;
