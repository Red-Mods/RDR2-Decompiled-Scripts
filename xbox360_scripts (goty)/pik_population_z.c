...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Pik", 4);
	Function_12("Loading Pike's Basin population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("PikesBasin_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "pikv_zombies");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 15, 30, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xC2B / 3115
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC3A / 3130
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xC8F / 3215
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD11 / 3345
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD2D / 3373
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD6B / 3435
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD87 / 3463
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xD97 / 3479
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xDDC / 3548
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xDE8 / 3560
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0xE64 / 3684
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xE71 / 3697
{
	if (!Function_4(128))
	{
		return;
