...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = Function_19("pigs", 0);
	Function_17(&uVar2, 1020, 8.0f, 0, 0);
	Function_17(&uVar2, 1021, 8.0f, 0, 0);
	...
	uVar6 = Function_19("cows", 0);
	Function_17(&uVar6, 1008, 8.0f, 0, 0);
	Function_17(&uVar6, 1009, 8.0f, 0, 0);
	Function_17(&uVar6, 1010, 8.0f, 0, 0);
	Function_17(&uVar6, 1011, 8.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar11))
	{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_9(bVar12, uVar8, 2E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (Function_5(57, 0))
		{
			...
			if (IS_VOLUME_VALID(bVar12))
			{
				Function_4(bVar12, uVar8, 3, 5, 1, 0, 1);
			}
			else
			{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_9(bVar12, uVar9, 2E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_9(bVar12, uVar4, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_9(bVar12, uVar5, 2.5E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (Function_5(49, 0))
		{
			...
			if (IS_VOLUME_VALID(bVar12))
			{
				Function_3(bVar12, uVar2, 3, 1, 0, 1);
			}
			else
			{
		...
		if (Function_5(49, 0))
		{
			...
			if (IS_VOLUME_VALID(bVar12))
			{
				Function_3(bVar12, uVar6, 6, 1, 0, 1);
			}
			else
			{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_9(bVar12, uVar10, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x11F3 / 4595
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1273 / 4723
{
	bool bVar0;
...
var Function_9(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1379 / 4985
{
	bool bVar0;
...
var Function_15(int iParam0) //Position: 0x14F7 / 5367
{
	int iVar0;
...
var Function_16(int iParam0) //Position: 0x1563 / 5475
{
	int iVar0;
...
var Function_17(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x15CF / 5583
{
	int iVar0;
	int iVar1;
...
var Function_18(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x164B / 5707
{
	int iVar0;
	int iVar1;
...
var Function_19(int iParam0, int iParam1) //Position: 0x1690 / 5776
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_20(int iParam0) //Position: 0x169D / 5789
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_21(bool bParam0, var uParam1) //Position: 0x16A9 / 5801
{
	if (!Function_10(128))
	{
		return;
