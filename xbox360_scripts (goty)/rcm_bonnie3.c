...
#region Local Var
	...
	var uLocal_294 = 0;
	var uLocal_295 = 0;
	struct<4> Local_296[6];
	int iLocal_321[6] = { 0, 0, 0, 0, 0, 0 };
	int iLocal_328 = 0;
...
void main() //Position: 0x0 / 0
{
	...
	iLocal_268 = 0;
	iLocal_261 = 1000;
	Function_190(&bLocal_248, "p_gen_chair01x", 0, 0);
	Function_190(&bLocal_248, "p_gen_pitchfork01x", 0, 0);
	Function_190(&bLocal_248, "p_gen_shovel02x", 0, 0);
	Function_190(&bLocal_248, "rfl_base", 5, 0);
	bLocal_329 = true;
	Function_189(&iLocal_284);
	Function_189(&iLocal_290);
	Function_189(&iLocal_293);
	while (!IS_EXITFLAG_SET())
	{
		...
		if (IS_ACTOR_VALID(bLocal_271))
		{
			if (GET_LAST_ATTACKER(bLocal_271) == Global_34573)
			{
				SET_ACTOR_FACTION(bLocal_271, 4);
				TASK_PRIORITY_SET(bLocal_271, 0);
				TASK_FLEE_ACTOR(bLocal_271, Global_34573, 200.0f, -1.0f, 0, 0, 0);
				if (!Function_179(14))
				{
					Function_178(14, 1);
				}
				if (IS_VOLUME_VALID(bLocal_283))
				{
		...
		switch (iLocal_268)
		{
			case 0x00000000:
				...
				{
					if (IS_LAYOUTREF_VALID(bLocal_269))
					{
						bLocal_271 = Global_63541[ScriptParam_055].f_204;
						if (IS_ACTOR_VALID(bLocal_271))
						{
							bLocal_283 = CREATE_VOLUME_IN_LAYOUT(bLocal_269, "Bonnie3_StayOut", 2, -788.377f, 93.308f, 2408.42f, 0.0f, -125.742f, 0.0f, 16.979f, 15.246f, 22.388f);
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_283);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_283);
							bLocal_270 = CREATE_OBJECTSET_IN_LAYOUT("Bonnie1_HorseSet", bLocal_269, 15, 1);
							SET_ACTOR_FACTION(bLocal_271, 20);
							TASK_USE_GRINGO(Global_63541[1455].f_204, Global_63541[1455].f_208, "UseCase1", 4294967295, 1);
							TASK_PRIORITY_SET(Global_63541[1455].f_204, 1);
							iLocal_268 = 1;
							Function_169(&iLocal_284);
							Function_189(&iLocal_287);
						}
						else if (Function_166(&iLocal_284) < 5.0f)
						{
							Function_169(&iLocal_284);
						}
						Function_159(&(Global_63541[1455]), 14, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						bLocal_269 = CREATE_LAYOUT("RCM_Bonnie3_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					if (StackVal && FABS((StackVal - !Function_155(Global_34573, 1, 1))) > 2.0f)
					{
						if (Function_151(Global_63541[ScriptParam_055].f_192, 0, 1, 1, 1, 0))
						{
			...
			case 0x00000003:
				if (Function_116("$/cutscene/bonnie_rcm_3_cs/bonnie_rcm_3_cs", &iLocal_261, 30610, 30549, 29308, 29191, 28897, 28881, 1, 1, 2, 2, 0))
				{
					if (IS_ACTOR_VALID(bLocal_271))
					{
						DESTROY_ACTOR(bLocal_271);
					}
					Function_115(1.0f);
					iLocal_268 = 5;
					Function_169(&iLocal_284);
			...
			case 0x00000005:
				...
				{
					Function_177(&Global_63541[1455] + 144, 256);
					Function_114("Bonnie_END", 7.5f, 0, 2, 0, 0, 0, 0);
					Global_3412 = 1;
					Global_3416 = 7;
					Function_113(407, 1, 0, 0);
					Function_59(14, 1, 1, 0);
					Function_1();
					Function_177(&Global_63541[ScriptParam_055] + 144, 128);
					ACTOR_DATA_GRAVITY_LIMIT(0);
					Function_171();
...
void Function_1() //Position: 0x479 / 1145
{
	int iVar0;
	int iVar1;
...
void Function_2(int iParam0) //Position: 0x4AA / 1194
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_3(int iParam0, int iParam1) //Position: 0x64C / 1612
{
	float fVar0;
	bool bVar1;
...
void Function_4(int iParam0) //Position: 0x706 / 1798
{
	float fVar0;
	bool bVar1;
...
int Function_5(var uParam0, int iParam1) //Position: 0x7A8 / 1960
{
	int iVar0;
	var uVar1;
...
void Function_6(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x909 / 2313
{
	struct<8> Var0;
...
struct<32> Function_7(bool bParam0) //Position: 0x9A4 / 2468
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_8(char* cParam0, char* cParam1, char* cParam2) //Position: 0xA0E / 2574
{
	char* cVar0[32];
...
int Function_9(bool bParam0) //Position: 0xA2D / 2605
{
	int iVar0;
	vector3 vVar1;
...
float Function_10(bool bParam0, vector3 vParam1) //Position: 0xB8E / 2958
{
	vector3 vVar0;
...
vector3 Function_11(bool bParam0) //Position: 0xC08 / 3080
{
	vector3 vVar0;
...
void Function_12(int iParam0) //Position: 0xC72 / 3186
{
...
bool Function_13(int iParam0) //Position: 0xCD3 / 3283
{
...
var Function_14() //Position: 0xCE9 / 3305
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1) //Position: 0xCF1 / 3313
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void Function_16(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x1183 / 4483
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_17(int iParam0) //Position: 0x11FE / 4606
{
	char* cVar0[16];
...
bool Function_18() //Position: 0x123D / 4669
{
...
bool Function_19() //Position: 0x1258 / 4696
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(bool bParam0) //Position: 0x1285 / 4741
{
...
var Function_21(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x12B1 / 4785
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_22(int iParam0) //Position: 0x12CD / 4813
{
...
bool Function_23(int iParam0, int iParam1) //Position: 0x12E2 / 4834
{
	...
	if ((Function_44(iParam1) || Function_179(iParam1)) || Function_43(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
...
bool Function_24(int iParam0, int iParam1) //Position: 0x13F7 / 5111
{
	int iVar0;
...
bool Function_25(int iParam0) //Position: 0x153B / 5435
{
...
bool Function_26(int iParam0) //Position: 0x155F / 5471
{
...
bool Function_27(int iParam0) //Position: 0x1574 / 5492
{
...
var Function_28(int iParam0) //Position: 0x158B / 5515
{
...
bool Function_29(int iParam0) //Position: 0x15A5 / 5541
{
...
bool Function_30(int iParam0) //Position: 0x15BB / 5563
{
	return StackVal;
}

bool Function_31(var uParam0, int iParam1) //Position: 0x15CB / 5579
{
	int iVar0;
...
bool Function_32(int iParam0) //Position: 0x15E7 / 5607
{
	if (!iParam0->f_152)
	{
		if (Function_18())
...
bool Function_33(int iParam0) //Position: 0x168B / 5771
{
...
void Function_34(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x16E4 / 5860
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0, int iParam1) //Position: 0x1750 / 5968
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(bool bParam0, var uParam1, int iParam2) //Position: 0x1787 / 6023
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x17FF / 6143
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x18A0 / 6304
{
	int iVar0;
	int iVar1;
...
void Function_39(int iParam0, int iParam1) //Position: 0x18DD / 6365
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_40(var uParam0, int iParam1) //Position: 0x18F0 / 6384
{
...
bool Function_41(int iParam0) //Position: 0x1903 / 6403
{
	int iVar0;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x191F / 6431
{
	int iVar0;
...
int Function_43(int iParam0) //Position: 0x193B / 6459
{
...
int Function_44(int iParam0) //Position: 0x1950 / 6480
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x1965 / 6501
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x1972 / 6514
{
...
var Function_47(int iParam0, int iParam1) //Position: 0x19ED / 6637
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
	...
	switch (iParam0)
	{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_179(26) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_179(25) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_179(24) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_179(23) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
				...
				case 0x00000008:
					if (Function_179(55) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_179(54) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_179(27) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_179(52) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_179(51) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_179(50) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_179(49) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_179(19) && iVar19)
					{
						vVar0 = { -1708.36f, 46.18f, 2175.89f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_49(6, 0) && Function_179(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_179(17) && iVar19)
					{
						vVar0 = { -1687.208f, 53.208f, 2140.491f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_49(9, 0) && Function_179(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_179(15) && iVar19)
					{
...
bool Function_48(vector3 vParam0) //Position: 0x25DE / 9694
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(int iParam0, bool bParam1) //Position: 0x25F6 / 9718
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x2633 / 9779
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x2682 / 9858
{
...
int Function_52(int iParam0) //Position: 0x2698 / 9880
{
...
void Function_53() //Position: 0x2701 / 9985
{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x2775 / 10101
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x27A2 / 10146
{
	if (!Function_51(iParam0))
	{
...
bool Function_57() //Position: 0x27F4 / 10228
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_58(int iParam0) //Position: 0x27FD / 10237
{
	int iVar0;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2837 / 10295
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2C66 / 11366
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_61() //Position: 0x2DD9 / 11737
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2DDF / 11743
{
	if (Global_3381)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2E21 / 11809
{
...
void Function_64() //Position: 0x2E72 / 11890
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2EC4 / 11972
{
...
void Function_66() //Position: 0x2FCA / 12234
{
	float fVar0;
...
void Function_67() //Position: 0x2FFD / 12285
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x318B / 12683
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x333F / 13119
{
	Function_70(&Global_28260, 1, 0);
	return;
}

void Function_70(int iParam0, bool bParam1, var uParam2) //Position: 0x334D / 13133
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x353E / 13630
{
...
struct<8> Function_72(int iParam0) //Position: 0x3553 / 13651
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x35F9 / 13817
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x3894 / 14484
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_75(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_14(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_75(int iParam0) //Position: 0x3EC1 / 16065
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3ED2 / 16082
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0, bool bParam1) //Position: 0x3FC7 / 16327
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3FE0 / 16352
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x4046 / 16454
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x4058 / 16472
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x406A / 16490
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x419A / 16794
{
	return Global_35278[iParam020].f_48;
}

float Function_83(int iParam0) //Position: 0x41A9 / 16809
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x41E2 / 16866
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x421F / 16927
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x43B9 / 17337
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x45FD / 17917
{
...
struct<8> Function_88() //Position: 0x463E / 17982
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x46C7 / 18119
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x475E / 18270
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x47DD / 18397
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x4816 / 18454
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x4A20 / 18976
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_94(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x4ADB / 19163
{
	int iVar0;
...
vector3 Function_95() //Position: 0x4BC2 / 19394
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_96(int iParam0) //Position: 0x4BCB / 19403
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x4BE1 / 19425
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_98(vector3 vParam0, vector3 vParam3) //Position: 0x4CA8 / 19624
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_99(var uParam0, int iParam1) //Position: 0x4CC5 / 19653
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_100(int iParam0) //Position: 0x54EA / 21738
{
	var uVar0;
...
void Function_101(bool bParam0, bool bParam1) //Position: 0x5525 / 21797
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x5532 / 21810
{
	uParam0 = uParam0;
...
void Function_103(int iParam0) //Position: 0x55D6 / 21974
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_179(4) && !Function_107(0))
	{
	...
	if (Function_179(5))
	{
		...
		if (!Function_179(8) && !Function_179(6))
		{
	...
	if (!Function_31(&Global_3422[240] + 128, 2) || ((((((Function_179(14) && Function_179(18)) && Function_179(37)) && Function_179(7)) && Function_179(11)) && Function_179(5)) && Function_179(21)))
	{
	...
	if (!Function_31(&Global_3422[340] + 128, 2) || ((Function_179(27) && Function_179(1)) && Function_179(23)))
	{
	...
	if (!Function_179(7))
	{
		...
		if (((Function_179(6) && Function_104(Global_30735) < 0) && Function_104(Global_30737) < 0) && Function_104(Global_30738) < 0)
		{
...
int Function_104(int iParam0) //Position: 0x5ECB / 24267
{
	if (!Function_27(iParam0))
	{
		return 4294967295;
...
var Function_105() //Position: 0x5EE5 / 24293
{
	return STRING_TO_HASH(Function_106());
}

var Function_106() //Position: 0x5EF1 / 24305
{
	return "ZOMBIE_STORY";
}

bool Function_107(int iParam0) //Position: 0x5F06 / 24326
{
...
int Function_108(int iParam0) //Position: 0x5F6C / 24428
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_109(char* cParam0) //Position: 0x602E / 24622
{
...
void Function_110(char* cParam0, bool bParam1) //Position: 0x6076 / 24694
{
	bool bVar0;
...
void Function_111() //Position: 0x609B / 24731
{
	bool bVar0;
...
void Function_112(bool bParam0) //Position: 0x60F9 / 24825
{
	PRINTSTRING("Day ");
...
int Function_113(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x613F / 24895
{
	int iVar0;
	int iVar1;
...
void Function_114(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x635F / 25439
{
	struct<4> Var0;
	int iVar4;
...
void Function_115(bool bParam0) //Position: 0x63E4 / 25572
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6401 / 25601
{
	var uVar0;
	var uVar7;
	bool bVar8;
	...
	bVar8 = Function_117(uParam0, uParam1, &uVar0, &uVar7, uParam2, uParam3, uParam4, uParam5, uParam6, uParam7, 0, uParam8, uParam9, uParam10, uParam11, uParam12, 1);
	if (bVar8)
	{
...
int Function_117(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, bool bParam15, bool bParam16) //Position: 0x64AA / 25770
{
	if (!bParam15)
	{
	...
	switch (*iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_166(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_118(bool bParam0) //Position: 0x6ABE / 27326
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_119() //Position: 0x6B6D / 27501
{
	bool bVar0;
...
void Function_120() //Position: 0x6BDF / 27615
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_121() //Position: 0x6C24 / 27684
{
...
void Function_122(bool bParam0, bool bParam1) //Position: 0x6C36 / 27702
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_123(bool bParam0) //Position: 0x6CB6 / 27830
{
	int iVar0;
...
int Function_124(bool bParam0) //Position: 0x6CE5 / 27877
{
	int iVar0;
	bool bVar1;
...
bool Function_125() //Position: 0x6D9D / 28061
{
	int iVar0;
	bool bVar1;
...
bool Function_126(int iParam0) //Position: 0x6DD7 / 28119
{
	return iParam0->f_20;
}

void Function_127(var uParam0, int iParam1) //Position: 0x6DE1 / 28129
{
	Function_128(uParam0, iParam1, 0);
	return;
}

void Function_128(var uParam0, bool bParam1, bool bParam2) //Position: 0x6DEF / 28143
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6F3B / 28475
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x6F64 / 28516
{
	bool bVar0;
	bool bVar1;
...
void Function_131() //Position: 0x6FAF / 28591
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_132() //Position: 0x70D1 / 28881
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x70E1 / 28897
{
	Function_134(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_282);
	RESET_ANIM_SET_FOR_ACTOR(Global_34573, 1);
	return 1;
}

void Function_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x7102 / 28930
{
	bool bVar0;
	...
	Function_118(bParam9);
}

void Function_135() //Position: 0x71F2 / 29170
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x7207 / 29191
{
	SET_DRAW_OBJECT(bLocal_280, 1);
	SET_DRAW_OBJECT(bLocal_281, 1);
...
int Function_137() //Position: 0x727C / 29308
{
	if (!iLocal_328)
	{
		SET_DRAW_OBJECT(bLocal_280, 0);
		SET_DRAW_OBJECT(bLocal_281, 0);
		Function_138(-781.843f, 92.467f, 2427.425f, bLocal_282);
		iLocal_328 = 1;
	}
	return 1;
}

void Function_138(vector3 vParam0) //Position: 0x72B1 / 29361
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!Function_48(StackVal, StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			else if (Function_139(bVar1, Global_34573) > 4.0f)
			{
				TELEPORT_ACTOR(bVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1.5f);
				vVar3.f_8 = (vParam0.z + 1.5f);
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (bVar0 != bVar1)
			{
				...
				else if (Function_139(bVar0, Global_34573) > 4.0f)
				{
					TELEPORT_ACTOR(bVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2.5f);
					vVar3.f_8 = (vParam0.z + 2.5f);
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			...
			else if (Function_139(bVar2, Global_34573) > 8.0f)
			{
				TELEPORT_ACTOR(bVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_139(bool bParam0, bool bParam1) //Position: 0x7437 / 29751
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_140(bool bParam0, float fParam1) //Position: 0x7528 / 29992
{
...
void Function_141() //Position: 0x7626 / 30246
{
...
void Function_142() //Position: 0x7658 / 30296
{
...
int Function_143() //Position: 0x7755 / 30549
{
	if (ACTOR_GET_NEXT_EQUIP_SLOT(Global_34573) != 6)
	{
		ACTOR_SET_NEXT_EQUIP_SLOT(Global_34573, 6, 0);
...
int Function_144() //Position: 0x7792 / 30610
{
	bLocal_282 = CREATE_VOLUME_IN_LAYOUT(bLocal_269, "Bonnie3CSVol", 2, -790.0453f, 93.30781f, 2410.738f, 0.0f, -125.742f, 0.0f, 21.22061f, 15.24588f, 22.38816f);
	Function_147(0, 0, 1, 1, 0, 1, 1, bLocal_282, 1, 1, 1, 1);
	Function_145(StackVal, StackVal, bLocal_269, *(&Global_63541[1455] + 112), &bLocal_282, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	return 1;
}

void Function_145(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x7829 / 30761
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_146(bool bParam0, bool bParam1) //Position: 0x7A97 / 31383
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_147(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x7B0C / 31500
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_150(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_14(), 2, Function_150(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_149()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_148(int iParam0) //Position: 0x7DBA / 32186
{
	int iVar0;
...
var Function_149() //Position: 0x7DEE / 32238
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_150(bool bParam0) //Position: 0x7E6D / 32365
{
	vector3 vVar0;
...
bool Function_151(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x7E7E / 32382
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_154(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_153(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_153(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_152(&iVar6, &vVar3);
				}
				else
				{
...
int Function_152(int iParam0, int iParam1) //Position: 0x8091 / 32913
{
	var uVar0;
...
float Function_153(bool bParam0, bool bParam1) //Position: 0x80FC / 33020
{
	vector3 vVar0;
...
void Function_154(bool bParam0, bool bParam1) //Position: 0x811B / 33051
{
	bool bVar0;
	bool bVar1;
	...
	else if (!bParam1 || Function_153(bParam0, 0) < 2.0f)
	{
...
bool Function_155(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8178 / 33144
{
...
bool Function_156() //Position: 0x822E / 33326
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_157(bool bParam0) //Position: 0x8245 / 33349
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_158(bool bParam0) //Position: 0x8250 / 33360
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_159(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) //Position: 0x825E / 33374
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_161(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_161(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
...
float Function_160(float fParam0) //Position: 0x83CE / 33742
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_160(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_161(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x8403 / 33795
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_164(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_165()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
	...
	else if ((!Function_164(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_165()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_164(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_162() //Position: 0x8649 / 34377
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_163(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_163(char* cParam0, vector3 vParam1) //Position: 0x869D / 34461
{
	char* cVar0[64];
...
bool Function_164(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x87C5 / 34757
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_11(bParam0);
...
int Function_165() //Position: 0x884F / 34895
{
	if (IS_PS3())
	{
		return 1;
...
float Function_166(int iParam0) //Position: 0x885E / 34910
{
...
bool Function_167(int iParam0) //Position: 0x8926 / 35110
{
	return Function_45(*iParam0, 2);
}

bool Function_168(int iParam0) //Position: 0x8933 / 35123
{
	return Function_45(*iParam0, 1);
}

void Function_169(int iParam0) //Position: 0x8940 / 35136
{
	Function_170(iParam0, 0.0f);
	return;
}

void Function_170(var uParam0, float fParam1) //Position: 0x894C / 35148
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_177(uParam0, 1);
	Function_39(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

void Function_171() //Position: 0x896D / 35181
{
	Function_173(&bLocal_248);
	if (IS_PHYSINST_VALID(bLocal_280))
	{
		SET_PROP_FIXED(bLocal_280, 0);
		SET_PHYSINST_FROZEN(bLocal_280, 0);
		GIVE_OBJECT_TO_LAYOUT(bLocal_280, Global_30616);
	}
	if (IS_PHYSINST_VALID(bLocal_281))
	{
		SET_PROP_FIXED(bLocal_281, 0);
		SET_PHYSINST_FROZEN(bLocal_281, 0);
		GIVE_OBJECT_TO_LAYOUT(bLocal_281, Global_30616);
	}
	if (IS_LAYOUTREF_VALID(bLocal_269))
	{
		DESTROY_OBJECT(bLocal_269);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
...
int Function_172(bool bParam0, bool bParam1, bool bParam2) //Position: 0x89E2 / 35298
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_173(int iParam0) //Position: 0x8A11 / 35345
{
	int iVar0;
...
void Function_174(var uParam0, int iParam1) //Position: 0x8A37 / 35383
{
...
void Function_175(var uParam0, int iParam1) //Position: 0x8B65 / 35685
{
	int iVar0;
...
bool Function_176(var uParam0, int iParam1) //Position: 0x8B7F / 35711
{
	int iVar0;
...
void Function_177(var uParam0, int iParam1) //Position: 0x8B9C / 35740
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_178(int iParam0, bool bParam1) //Position: 0x8BAB / 35755
{
	char* cVar0[32];
...
bool Function_179(int iParam0) //Position: 0x8D2B / 36139
{
...
void Function_180() //Position: 0x8D40 / 36160
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	
	if (!Function_168(&iLocal_290) || !IS_OBJECTSET_VALID(bLocal_270))
	{
		return;
	}
	if (Function_166(&iLocal_290) > 2.0f)
	{
		return;
	}
	Function_181(bLocal_270);
	if (IS_VOLUME_VALID(bLocal_283))
	{
		iVar1 = LOCATE_ACTORS_IN_VOLUME(bLocal_283, bLocal_270, 0, 1);
	}
	bVar2 = false;
	while (bVar2 <= iVar1)
	{
		bVar0 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(bVar2, bLocal_270));
		if (IS_ACTOR_VALID(bVar0))
		{
			if (IS_ACTOR_HORSE(bVar0))
			{
				SET_ACTOR_STAY_OUTSIDE_OF_VOLUME(bVar0, bLocal_283, 2, 1);
			}
		}
		bVar2++;
	}
...
void Function_181(bool bParam0) //Position: 0x8DBB / 36283
{
	bool bVar0;
...
void Function_182() //Position: 0x8DF3 / 36339
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	vVar0 = { -788.969f, 93.61f, 2406.503f };
	vVar3 = { 0.0f, -33.898f, 0.0f };
	vVar6 = { -789.606f, 93.61f, 2406.053f };
	vVar9 = { 0.0f, -34.091f, 0.0f };
	if (!IS_PHYSINST_VALID(bLocal_280))
	{
		bLocal_280 = LOCATE_PHYSINST_OF_TYPE(vVar0, 3.0f, "p_gen_chair01x", 1);
		if (IS_PHYSINST_VALID(bLocal_280))
		{
			SET_OBJECT_POSITION(bLocal_280, vVar0);
			SET_OBJECT_ORIENTATION(bLocal_280, vVar9);
			SET_PHYSINST_FROZEN(bLocal_280, 1);
		}
		else if (Function_168(&iLocal_287))
		{
			if (Function_166(&iLocal_287) < 5.0f)
			{
				bLocal_280 = GET_PHYSINST_FROM_OBJECT(CREATE_PROP_IN_LAYOUT(bLocal_269, "Bonnie3_Chair01", "p_gen_chair01x", vVar0, vVar3, 1));
				SET_PHYSINST_FROZEN(bLocal_280, 1);
				SET_PROP_FIXED(bLocal_280, 1);
			}
		}
	}
	if (!IS_PHYSINST_VALID(bLocal_281))
	{
		if (Function_168(&iLocal_287))
		{
			if (Function_166(&iLocal_287) < 5.0f)
			{
				bLocal_281 = GET_PHYSINST_FROM_OBJECT(CREATE_PROP_IN_LAYOUT(bLocal_269, "Bonnie3_Chair02", "p_gen_chair01x", vVar6, vVar9, 1));
				SET_PHYSINST_FROZEN(bLocal_281, 1);
				SET_PROP_FIXED(bLocal_281, 1);
			}
		}
	}
	return;
...
void Function_183() //Position: 0x8F43 / 36675
{
	vector3 vVar0;
	int iVar3;
	...
	while (iVar3 <= 6)
	{
		if (!IS_DOOR_VALID(uLocal_272[iVar3]))
		{
			uLocal_272[iVar3] = Function_186("hennigansRanch", &(Local_296[iVar34]), iLocal_321[iVar3]);
		}
		if (IS_DOOR_VALID(uLocal_272[iVar3]))
		{
			if (iVar3 != 0 || iVar3 != 1)
			{
				if (IS_DOOR_LOCKED(uLocal_272[iVar3]))
				{
					Function_185(uLocal_272[iVar3], 1);
				}
			}
			else
			{
				if (!IS_DOOR_CLOSED(uLocal_272[iVar3]))
				{
					if (!IS_DOOR_CLOSING(uLocal_272[iVar3]))
					{
						CLOSE_DOOR_FAST(uLocal_272[iVar3]);
					}
				}
				if (!IS_DOOR_LOCKED(uLocal_272[iVar3]))
				{
					Function_184(uLocal_272[iVar3], 1);
				}
			}
		}
		iVar3++;
	}
	if (!IS_DOOR_VALID(bLocal_279))
	{
		bLocal_279 = FIND_NEAREST_DOOR(&vVar0, 2.0f);
	}
	if (IS_DOOR_VALID(bLocal_279))
	{
		SET_DOOR_LOCK_VISIBLE(bLocal_279, 0);
	}
	return;
}

void Function_184(bool bParam0, bool bParam1) //Position: 0x9049 / 36937
{
...
void Function_185(bool bParam0, bool bParam1) //Position: 0x909D / 37021
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
int Function_186(var uParam0, var uParam1, int iParam2) //Position: 0x90EE / 37102
{
	return Function_187(Global_29006, uParam0, uParam1, iParam2);
}

int Function_187(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x9100 / 37120
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_188(int iParam0) //Position: 0x919C / 37276
{
	if (!Function_13(iParam0))
	{
		return 1;
	}
	return Function_42(&(Global_29008[iParam0]), 4);
}

void Function_189(int iParam0) //Position: 0x91B8 / 37304
{
	if (!Function_168(iParam0))
	{
		Function_170(iParam0, 0.0f);
...
var Function_190(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x91CD / 37325
{
	int iVar0;
	int iVar1;
...
void Function_191(var uParam0, int iParam1) //Position: 0x9205 / 37381
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_192(var uParam0, int iParam1, int iParam2) //Position: 0x9216 / 37398
{
	int iVar0;
...
void Function_193() //Position: 0x92DA / 37594
{
	strcpy(&(Local_296[04]), "barn01", 16);
	strcpy(&(Local_296[14]), "barn01", 16);
	strcpy(&(Local_296[24]), "barn01", 16);
	strcpy(&(Local_296[34]), "barn01", 16);
	strcpy(&(Local_296[44]), "barn01props", 16);
	strcpy(&(Local_296[54]), "barn01props", 16);
	iLocal_321[0] = 1;
	iLocal_321[1] = 2;
	iLocal_321[2] = 3;
	iLocal_321[3] = 4;
