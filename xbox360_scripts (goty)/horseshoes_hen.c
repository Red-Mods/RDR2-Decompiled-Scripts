...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_24(Global_30668[0], &Local_24 + 4, &Local_24 + 68, &Local_24 + 72, &Local_24 + 60, &Local_24 + 64))
			{
				Function_23(&Local_24 + 4);
				Function_22(Global_30668[0], 0);
				*(&Local_24 + 16[03]) = { StackVal, StackVal, Function_22(Global_30668[0], 0) };
				Function_22(Global_30668[0], 1);
				*(&Local_24 + 16[13]) = { StackVal, StackVal, Function_22(Global_30668[0], 1) };
				Local_24 = Local_6;
				Local_24.f_52 = 1;
				if (Function_21())
				{
				...
				Local_24.f_44 = CREATE_VOLUME_IN_LAYOUT(bLocal_5, "StayOutVol", 2, -820.343f, 93.33113f, 2349.59f, 0.0f, -91.07706f, 0.0f, 8.22709f, 3.373459f, 21.7038f);
