...
void Function_75() //Position: 0x1C21 / 7201
{
	...
	Function_76(4, 1);
	uVar0 = uVar0;
	Local_177 = CREATE_LAYOUT("Poker_BEH_layout");
	Local_177.f_4 = CREATE_OBJECTSET_IN_LAYOUT("Cutscene_1Set", Local_177, 8, 0);
	*(&Local_177 + 8[06]) = { -139.135f, 119.2267f, 1345.722f };
	*(&Local_177 + 8[06] + 12) = { 0.0f, 1.746283f, 0.0f };
	bVar1 = CREATE_POINT_IN_LAYOUT(Local_177, "PlayerPosition", -139.135f, 119.2267f, 1345.722f, 0.0f, 1.746283f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar1);
	*(&Local_177 + 8[16]) = { -140.5376f, 119.2267f, 1344.727f };
	*(&Local_177 + 8[16] + 12) = { 0.0f, -50.74146f, 0.0f };
	bVar2 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_0_Position", -140.5376f, 119.2267f, 1344.727f, 0.0f, -50.74146f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar2);
	*(&Local_177 + 8[26]) = { -140.7188f, 119.2267f, 1342.68f };
	*(&Local_177 + 8[26] + 12) = { 0.0f, 245.7885f, 0.0f };
	bVar3 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_1_Position", -140.7188f, 119.2267f, 1342.68f, 0.0f, 245.7885f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar3);
	*(&Local_177 + 8[36]) = { -139.117f, 119.2222f, 1341.368f };
	*(&Local_177 + 8[36] + 12) = { 0.0f, 180.7421f, 0.0f };
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_2_Position", -139.117f, 119.2222f, 1341.368f, 0.0f, 180.7421f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar4);
	*(&Local_177 + 8[46]) = { -137.1698f, 119.2222f, 1342.421f };
	*(&Local_177 + 8[46] + 12) = { 0.0f, 120.8644f, 0.0f };
	bVar5 = CREATE_POINT_IN_LAYOUT(Local_177, "AI_3_Position", -137.1698f, 119.2222f, 1342.421f, 0.0f, 120.8644f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(StackVal, bVar5);
	*(&Local_177 + 132) = { -138.8952f, 120.019f, 1343.499f };
	*(&Local_177 + 132 + 12) = { 0.0f, 189.761f, 0.0f };
	Local_177.f_156 = CREATE_POINT_IN_LAYOUT(Local_177, "TableCenter", -138.8952f, 120.019f, 1343.499f, 0.0f, 189.761f, 0.0f);
	Local_177.f_160 = CREATE_OBJECTSET_IN_LAYOUT("Waitress_PositionsSet", Local_177, 8, 0);
	*(&Local_177 + 164[06]) = { -137.0149f, 119.2222f, 1344.059f };
	*(&Local_177 + 164[06] + 12) = { 0.0f, -285.6316f, 0.0f };
	bVar6 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_0_Pos", -137.0149f, 119.2222f, 1344.059f, 0.0f, -285.6316f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar6, Local_177.f_160);
	*(&Local_177 + 164[16]) = { -137.3732f, 119.2222f, 1344.825f };
	*(&Local_177 + 164[16] + 12) = { 0.0f, 53.60045f, 0.0f };
	bVar7 = CREATE_POINT_IN_LAYOUT(Local_177, "Waitress_1_Pos", -137.3732f, 119.2222f, 1344.825f, 0.0f, 53.60045f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar7, Local_177.f_160);
	Local_177.f_216 = CREATE_OBJECTSET_IN_LAYOUT("DuelerPositionsSet", Local_177, 8, 0);
	*(&Local_177 + 220[06]) = { -136.0f, 118.8691f, 1368f };
	*(&Local_177 + 220[06] + 12) = { 0.0f, 0.0f, 0.0f };
	bVar8 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_0", -136.0f, 118.8691f, 1368f, 0.0f, 0.0f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar8, Local_177.f_216);
	*(&Local_177 + 220[16]) = { -136.0f, 118.8691f, 1356f };
	*(&Local_177 + 220[16] + 12) = { 0.0f, 177.0741f, 0.0f };
	bVar9 = CREATE_POINT_IN_LAYOUT(Local_177, "Dueler_1", -136.0f, 118.8691f, 1356f, 0.0f, 177.0741f, 0.0f);
	ADD_OBJECT_TO_OBJECTSET(bVar9, Local_177.f_216);
	return;
}

void Function_76(int iParam0, int iParam1) //Position: 0x2054 / 8276
{
	switch (iParam1)
	{
		case 0x00000000:
