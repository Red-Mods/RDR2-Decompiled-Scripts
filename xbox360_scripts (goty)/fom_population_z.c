...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Fom", 4);
	Function_13("Loading Fort Mercer population file", 3);
	Global_30839++;
	...
	Function_11(&uVar0, 66, 4.0f, 0, 0);
	Function_11(&uVar0, 67, 4.0f, 0, 0);
	Function_11(&uVar0, 69, 4.0f, 0, 0);
	Function_11(&uVar0, 65, 4.0f, 0, 0);
	Function_11(&uVar0, 71, 4.0f, 0, 0);
	Function_11(&uVar0, 72, 4.0f, 0, 0);
	...
	bVar2 = FIND_NAMED_LAYOUT("FortMercer_layout");
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_01");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		Function_4(bVar3, uVar0, 10, 15, 0, 0, 1);
	}
	else
	{
		LOG_ERROR("FortMercer: Cannot find FortMercer_layout to create population volumes");
	}
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_01");
	if (IS_VOLUME_VALID(bVar3))
	{
		Function_4(bVar3, Global_30750[4], 2, 5, 0, 0, 1);
	}
	else
	{
		LOG_ERROR("FortMercer: Cannot find FortMercer_layout to create population volumes");
	}
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_03");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		Function_4(bVar3, uVar0, 10, 15, 0, 0, 1);
	}
	...
	{
		LOG_ERROR("FortMercer_layout: Cannot find the layout to create population volumes");
	}
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_03");
	if (IS_VOLUME_VALID(bVar3))
	{
	...
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_04");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
	...
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_zombies_05");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		Function_4(bVar3, uVar0, 5, 10, 0, 0, 1);
	}
	...
	bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "fomv_region");
	if (IS_VOLUME_VALID(bVar3))
	{
	...
	{
		LOG_ERROR("FortMercer: Cannot find fomv_region to create population volumes");
	}
	END_POPULATION_DEFINITION();
	Global_30839 = (Global_30839 - 1);
	...
	Function_6("Finished loading Fort Mercer population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xF55 / 3925
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xF64 / 3940
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xFB9 / 4025
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1039 / 4153
{
	bool bVar0;
...
bool Function_5(int iParam0) //Position: 0x10BB / 4283
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0x10D7 / 4311
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x1115 / 4373
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x1131 / 4401
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1141 / 4417
{
	int iVar0;
	int iVar1;
...
void Function_10(int iParam0) //Position: 0x1186 / 4486
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1192 / 4498
{
	int iVar0;
	int iVar1;
...
var Function_12(bool bParam0, int iParam1) //Position: 0x120E / 4622
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_13(bool bParam0, var uParam1) //Position: 0x121B / 4635
{
	if (!Function_5(128))
	{
		return;
