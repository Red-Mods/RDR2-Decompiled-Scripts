...
{
	iParam1 = iParam1;
	if (!IS_ATTACHMENT_VALID(iLocal_0))
	{
		iLocal_0 = ATTACH_OBJECTS_CONTINUOUS(bParam0, GRINGO_GET_MY_OBJECT_REF(), 4294967295);
	}
	return;
}
...
void Function_62(bool bParam0) //Position: 0x255F / 9567
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x281E / 10270
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x287B / 10363
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28D8 / 10456
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28E2 / 10466
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2900 / 10496
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2915 / 10517
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x299C / 10652
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29BF / 10687
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29DD / 10717
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A00 / 10752
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B1B / 11035
{
...
int Function_74(bool bParam0) //Position: 0x2B46 / 11078
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C4B / 11339
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C58 / 11352
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CCB / 11467
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31C9 / 12745
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3200 / 12800
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x321D / 12829
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3255 / 12885
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x325F / 12895
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3280 / 12928
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	if (IS_ATTACHMENT_VALID(iLocal_0))
	{
		REMOVE_OBJECT_ATTACHMENT(iLocal_0);
	}
	return;
}

void Function_84(bool bParam0, bool bParam1) //Position: 0x329B / 12955
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33A3 / 13219
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x33B9 / 13241
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x366F / 13935
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x367D / 13949
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3696 / 13974
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x36B0 / 14000
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36E8 / 14056
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36FF / 14079
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39C8 / 14792
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39E5 / 14821
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A81 / 14977
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3AA0 / 15008
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AAF / 15023
{
...
void Function_98(int iParam0) //Position: 0x3ACB / 15051
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AD5 / 15061
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B37 / 15159
{
...
void Function_101(int iParam0) //Position: 0x3B4B / 15179
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B55 / 15189
{
