...
bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A51 / 10833
{
	bool bVar0;
...
void Function_52(bool bParam0, var uParam1, int iParam2) //Position: 0x2A7D / 10877
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_53(bool bParam0, bool bParam1) //Position: 0x2B07 / 11015
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_54(bool bParam0, bool bParam1, int iParam2) //Position: 0x2BB5 / 11189
{
	int iVar0;
	bool bVar1;
...
var Function_55(bool bParam0) //Position: 0x2BFA / 11258
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_56(bool bParam0) //Position: 0x2C10 / 11280
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_57(bool bParam0, bool bParam1, int iParam2) //Position: 0x2C26 / 11302
{
	float fVar0;
	float fVar1;
	bool bVar2;
	...
	bParam0 = Function_66(bParam0);
	fVar0 = GET_ACTOR_HEALTH(bParam1);
	fVar1 = GET_ACTOR_MAX_HEALTH(bParam1);
	iVar3 = 0;
	*iParam2 = 0;
	bVar4 = false;
	if (IS_ACTOR_VALID(bParam1) && fVar0 > fVar1)
	{
		bVar2 = GET_GRINGO_STRING_ATTR("myItemString", bParam0, &iVar3);
		if (GET_GRINGO_FLOAT_ATTR(&fVar5, "HitPointsCuredPercent", bParam0))
		{
			...
			SET_ACTOR_HEALTH(bParam1, fVar0);
			if (((Function_62(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
			{
				iLocal_3 = 0;
			}
			if (STRING_CONTAINS_STRING(bVar2, "nMeds_Lvl1"))
			{
				Function_61(480, 1, 0, 0);
				if (Function_60())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 3), Global_34573))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 3), Global_34573);
					}
					PLAYSTAT_INT("HC_MEDS", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(bVar2, "Edible_Meat"))
			{
				Function_61(485, 1, 0, 0);
				if (Function_60())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 4), Global_34573))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 4), Global_34573);
					}
	...
	{
		Function_58("user_full_health", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_58(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2DED / 11757
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2E68 / 11880
{
	char* cVar0[16];
...
bool Function_60() //Position: 0x2EA7 / 11943
{
...
int Function_61(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2ED2 / 11986
{
	int iVar0;
	int iVar1;
...
int Function_62(bool bParam0, bool bParam1, bool bParam2) //Position: 0x30F2 / 12530
{
...
bool Function_63() //Position: 0x31A8 / 12712
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_64(bool bParam0) //Position: 0x31BF / 12735
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_65(bool bParam0) //Position: 0x31CA / 12746
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_66(bool bParam0) //Position: 0x31D8 / 12760
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_67(int iParam0, bool bParam1) //Position: 0x31F2 / 12786
{
	bool bVar0;
	bool bVar1;
