...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	vLocal_13 = { -4330.585f, 23.214f, 2742.339f };
	vLocal_16 = { -4326.726f, 23.306f, 2738.884f };
	iLocal_24 = 2;
	iLocal_25 = 4;
	fLocal_26 = 70.0f;
...
void Function_3() //Position: 0x21F / 543
{
	...
	Function_4(2, bLocal_10, bLocal_12, &uLocal_3, bLocal_19, 4294967295);
	return;
}

void Function_4(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x237 / 567
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_5(bool bParam0, bool bParam1) //Position: 0x654 / 1620
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x683 / 1667
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_7(bool bParam0) //Position: 0x9A1 / 2465
{
	bool bVar0;
...
void Function_8(bool bParam0) //Position: 0x9CD / 2509
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_9(int iParam0) //Position: 0x9E2 / 2530
{
...
void Function_10(var uParam0, int iParam1) //Position: 0xA0E / 2574
{
	int iVar0;
...
bool Function_11(var uParam0, bool bParam1) //Position: 0xA25 / 2597
{
	int iVar0;
...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0xA41 / 2625
{
	int iVar0;
	bool bVar1;
...
bool Function_13(bool bParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xAFB / 2811
{
	float fVar0;
...
void Function_14(bool bParam0) //Position: 0xC92 / 3218
{
...
void Function_15(bool bParam0) //Position: 0xCC6 / 3270
{
	SAY_SINGLE_LINE_CONTEXT(bParam0, 60, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_16(var uParam0, int iParam1) //Position: 0xCDD / 3293
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(bool bParam0, bool bParam1) //Position: 0xCEA / 3306
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_18(bool bParam0, bool bParam1) //Position: 0xDDB / 3547
{
	bool bVar0;
	bool bVar1;
...
bool Function_19(bool bParam0, bool bParam1) //Position: 0xE32 / 3634
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_20(bool bParam0) //Position: 0xE8B / 3723
{
	bool bVar0;
...
int Function_21(int iParam0) //Position: 0xEBD / 3773
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(bool bParam0, vector3 vParam1) //Position: 0x1093 / 4243
{
	vector3 vVar0;
...
vector3 Function_23(bool bParam0) //Position: 0x110D / 4365
{
	vector3 vVar0;
...
void Function_24(int iParam0) //Position: 0x1177 / 4471
{
	int iVar0;
...
void Function_25(var uParam0, int iParam1) //Position: 0x119D / 4509
{
...
void Function_26(var uParam0, int iParam1) //Position: 0x12CB / 4811
{
	int iVar0;
...
bool Function_27(var uParam0, bool bParam1) //Position: 0x12E5 / 4837
{
	int iVar0;
...
var Function_28(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x1302 / 4866
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_24 || bParam2) || Global_3370)
			{
				...
				{
					if (((!bParam2 && !Function_149(iParam0 + 200, &fLocal_26, 256, 0)) && !Global_3370) && !Function_155())
					{
						iVar14 = 1000;
					}
					else
		...
		case 0x00000002:
			...
			{
				if (((Function_22(StackVal, StackVal, Global_34573, *(iParam0 + 200)) < 120.0f || bParam2) || Global_3370) || Function_155())
				{
					if (UNK_0x214AFB8C(iParam0->f_16))
					{
						if (IS_OBJECT_VALID(iParam0->f_224))
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_71(StackVal, StackVal, StackVal, StackVal, StackVal, Function_138(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
...
void Function_29(var uParam0) //Position: 0x2300 / 8960
{
	*uParam0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, *uParam0 };
	if (IS_ACTOR_VALID(bLocal_10))
	{
		if (Function_31(Global_34573, bLocal_10, 20.0f))
		{
			if (GET_TASK_STATUS(bLocal_10, 66) != 1)
			{
				CLEAR_ACTOR_STAY_WITHIN_VOLUME(bLocal_10);
				if (!IS_VOLUME_VALID(bLocal_23))
				{
					bLocal_23 = CREATE_VOLUME_IN_LAYOUT(bLocal_19, Function_138(), 2, -4328.211f, 23.386f, 2741.336f, 0.0f, 0.0f, 0.0f, 10.0f, 10.0f, 10.0f);
				}
				TASK_WANDER_IN_VOLUME(bLocal_10, bLocal_23, -1f);
				SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_10, bLocal_23, 1, 1);
			}
		}
		else if (!GET_TASK_STATUS(bLocal_10, 57) == 1)
		{
			CLEAR_ACTOR_STAY_WITHIN_VOLUME(bLocal_10);
			TASK_WANDER_IN_VOLUME(bLocal_10, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), -1f);
			SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_10, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), 1, 1);
		}
		if ((Function_31(bLocal_10, Global_34573, 15.0f) && (GET_CURRENT_GAME_TIME() - fLocal_21) < 60.0f) && MEMORY_GET_IS_VISIBLE(bLocal_10, Global_34573))
		{
			if (Function_30() && !bLocal_22)
			{
				SAY_SINGLE_LINE_CONTEXT(bLocal_10, 43, Global_34573, 1, 0, 0, 4294967295, 4294967295, 0, 1);
			}
			else
			{
				SAY_SINGLE_LINE_STRING_SCRIPTED_INTERRUPT(bLocal_10, "POST_FIGHT_GRATITUDE", "POST_FIGHT_GRATITUDE", false, 1, 1, 3, 1, 0, 0, 1000, 0, 0);
			}
...
bool Function_30() //Position: 0x2479 / 9337
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

bool Function_31(bool bParam0, var uParam1, float fParam2) //Position: 0x248C / 9356
{
	float fVar0;
	
	fVar0 = Function_32(bParam0, uParam1);
	if (fVar0 >= fParam2)
	{
		return 1;
	}
...
var Function_32(bool bParam0, bool bParam1) //Position: 0x24A9 / 9385
{
	var uVar0;
	int iVar3;
	int iVar6;
...
float Function_33(var uParam0, int iParam1) //Position: 0x24C8 / 9416
{
	vector3 vVar0;
	bool bVar3;
...
void Function_34(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x24E6 / 9446
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_35(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x26E4 / 9956
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_36(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x26FE / 9982
{
	bool bVar0;
	bool bVar1;
...
int Function_37(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x27DE / 10206
{
	char* cVar0[32];
...
int Function_38(bool bParam0) //Position: 0x2A2C / 10796
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_39(bool bParam0, bool bParam1) //Position: 0x2A4F / 10831
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_40(bool bParam0, bool bParam1) //Position: 0x2A72 / 10866
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_41(bool bParam0, bool bParam1) //Position: 0x2A96 / 10902
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_42(bool bParam0, bool bParam1) //Position: 0x2ABC / 10940
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_43(bool bParam0) //Position: 0x2ADF / 10975
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_44() //Position: 0x2AFD / 11005
{
...
bool Function_45(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2B47 / 11079
{
	bool bVar0;
	bool bVar1;
...
bool Function_46(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2B99 / 11161
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2BB5 / 11189
{
	bool bVar0;
	bool bVar1;
...
void Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2C07 / 11271
{
	bool bVar0;
	bool bVar1;
...
var Function_49() //Position: 0x2C4C / 11340
{
...
void Function_50(int iParam0, bool bParam1, bool bParam2) //Position: 0x2C61 / 11361
{
	bool bVar0;
	bool bVar1;
...
bool Function_51(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2D84 / 11652
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_52(vector3 vParam0) //Position: 0x2DF2 / 11762
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_53(bool bParam0) //Position: 0x2E0A / 11786
{
	bool bVar0;
	bool bVar1;
...
var Function_54(bool bParam0) //Position: 0x2E61 / 11873
{
	bool bVar0;
	bool bVar1;
...
void Function_55(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2EA7 / 11943
{
	bool bVar0;
	bool bVar1;
...
void Function_56(bool bParam0, bool bParam1) //Position: 0x2F15 / 12053
{
	bool bVar0;
	bool bVar1;
...
void Function_57(bool bParam0) //Position: 0x2F5D / 12125
{
	struct<21> Var0;
...
var Function_58(int iParam0) //Position: 0x301B / 12315
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_59(int iParam0) //Position: 0x30CC / 12492
{
...
bool Function_60(int iParam0) //Position: 0x30EB / 12523
{
...
bool Function_61(int iParam0) //Position: 0x310F / 12559
{
...
bool Function_62(int iParam0) //Position: 0x3124 / 12580
{
...
bool Function_63(int iParam0, bool bParam1) //Position: 0x313B / 12603
{
	int iVar0;
...
var Function_64(int iParam0) //Position: 0x3178 / 12664
{
...
bool Function_65(int iParam0) //Position: 0x3192 / 12690
{
...
int Function_66(int iParam0, int iParam1) //Position: 0x31A8 / 12712
{
	int iVar0;
...
void Function_67(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x31E1 / 12769
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_68(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x32AE / 12974
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_69(bool bParam0, bool bParam1) //Position: 0x3445 / 13381
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_70(bool bParam0) //Position: 0x3467 / 13415
{
	bool bVar0;
	bool bVar1;
...
var Function_71(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x34AB / 13483
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_72(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x35F4 / 13812
{
	var uVar0[5];
	int iVar6;
...
int Function_73(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x3695 / 13973
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_74(int iParam0, int iParam1) //Position: 0x3729 / 14121
{
	Function_146(&uLocal_3, 1202, 3, 0);
	Function_146(&uLocal_3, 1057, 3, 0);
	if (!IS_LAYOUTREF_VALID(bLocal_19))
	{
		bLocal_19 = CREATE_LAYOUT("merchant04campfiregringo");
	}
	if (Function_85(&bLocal_10, &uLocal_3, 17, 0, 1, 1, 1, 0, 1, bLocal_19, 0) && !WOULD_ACTOR_BE_VISIBLE(1202, &vLocal_16, 3212836864))
	{
		if (Function_83(&bLocal_20, "merchant04mobile", iParam1))
		{
			bLocal_12 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_20, Function_138()));
			Global_3422[1740].f_156 = bLocal_12;
			iParam0->f_12 = bLocal_20;
			Function_75();
			return 1;
		}
	}
...
void Function_75() //Position: 0x37D3 / 14291
{
	if (!Function_82(1202, &uLocal_11, bLocal_19, DECOR_CHECK_EXIST(bLocal_10, "bJustFinished03")))
	{
		uLocal_11 = Function_78(bLocal_19, "mercant_coach", 1202, 976, -4326.726f, 23.306f, 2738.884f, 0.0f, 333.806f, 0.0f, 1, 976, 976, 976, 4);
		fLocal_21 = (GET_CURRENT_GAME_TIME() - 60.0f);
		TELEPORT_ACTOR(bLocal_10, &vLocal_13, 1, 1, 1);
		LOG_ERROR("creating new wagon!");
	}
	else
	{
		bLocal_22 = true;
		AI_SPEECH_SET_ALLOW_CONTEXT_FOR_ACTOR(bLocal_10, 43, 0);
		fLocal_21 = (GET_CURRENT_GAME_TIME() - 50.0f);
		LOG_ERROR("found old wagon!");
	}
	Function_76(uLocal_11, &bLocal_12, 1, 1);
	MEMORY_PREFER_RIDING(bLocal_10, false);
	MEMORY_PREFER_WALKING(bLocal_10, 1);
	TASK_WANDER_IN_VOLUME(bLocal_10, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), -1f);
	SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_10, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "gtrp_cueva"), 1, 1);
	AI_IGNORE_ACTOR(bLocal_10);
	RESET_ANIM_SET_FOR_ACTOR(bLocal_10, 1);
	Function_76(bLocal_10, &bLocal_12, 1, 1);
	return;
}

void Function_76(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x391C / 14620
{
	bool bVar0;
	bool bVar1;
...
bool Function_77(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3AA6 / 15014
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
var Function_78(bool bParam0, bool bParam1, bool bParam2, int iParam3, vector3 vParam4, vector3 vParam7, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14) //Position: 0x3AE6 / 15078
{
	bool bVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(bVar0))
	{
		...
		while (iVar9 < (iVar10 - 1))
		{
			...
			bVar15 = "";
			if (Function_81(Global_30750[6], 4, 23, 0) && uParam10)
			{
				bVar16 = Function_80(StackVal, StackVal, Global_30750[6], vParam4, 4, 23, 0);
...
bool Function_79(int iParam0, int iParam1) //Position: 0x3D1A / 15642
{
	int iVar0;
...
var Function_80(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x3D4C / 15692
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(bParam0, bParam4, bParam5, bParam6, 1, vParam1);
}

int Function_81(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x3D64 / 15716
{
...
bool Function_82(int iParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x3D8B / 15755
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_83(var uParam0, char* cParam1, int iParam2) //Position: 0x3E95 / 16021
{
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3EC0 / 16064
{
	int iVar0;
...
int Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3F02 / 16130
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x40CC / 16588
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x45B6 / 17846
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_88(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x45D6 / 17878
{
	bool bVar0;
...
int Function_89(bool bParam0, bool bParam1) //Position: 0x462A / 17962
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x46AA / 18090
{
	Function_92(bParam0);
	Function_91(bParam0);
...
void Function_91(bool bParam0) //Position: 0x46D0 / 18128
{
...
void Function_92(bool bParam0) //Position: 0x46F4 / 18164
{
...
bool Function_93(bool bParam0) //Position: 0x47C3 / 18371
{
...
int Function_94(int iParam0, bool bParam1) //Position: 0x47DA / 18394
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x486D / 18541
{
	bool bVar0;
	bool bVar1;
...
void Function_96(bool bParam0) //Position: 0x4964 / 18788
{
	bool bVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x4990 / 18832
{
	int iVar0;
...
bool Function_98(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x49AC / 18860
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_99() //Position: 0x4A36 / 18998
{
	bool bVar0;
	bool bVar1;
...
bool Function_100(int iParam0) //Position: 0x4A9B / 19099
{
...
bool Function_101(bool bParam0) //Position: 0x4AB7 / 19127
{
...
var Function_102(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x4ACD / 19149
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_103(int iParam0) //Position: 0x4B6D / 19309
{
	bool bVar0;
	int iVar1;
	...
	if (!iParam0->f_128 != 0)
	{
		...
		if (Function_11(iParam0 + 128, 4096))
		{
			...
			{
				bVar0 = Function_59(Function_64(iParam0->f_132));
...
bool Function_104(int iParam0) //Position: 0x4C67 / 19559
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x4FE2 / 20450
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x5022 / 20514
{
	int iVar0;
...
void Function_107(var uParam0, int iParam1) //Position: 0x504D / 20557
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_108() //Position: 0x505E / 20574
{
	if (!Function_152(128))
	{
		return;
...
void Function_109(int iParam0, bool bParam1) //Position: 0x50A0 / 20640
{
	char* cVar0[32];
...
void Function_110(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5124 / 20772
{
	var uVar0;
	var uVar1;
...
void Function_111(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x514D / 20813
{
...
var Function_112(var uParam0, bool bParam1) //Position: 0x519E / 20894
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_113() //Position: 0x51AE / 20910
{
	return "PackedGrass";
}

var Function_114(bool bParam0, bool bParam1, bool bParam2) //Position: 0x51C2 / 20930
{
	int iVar0;
...
var Function_115() //Position: 0x51E7 / 20967
{
	return "PackedMetadata";
}

void Function_116(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x51FE / 20990
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_117() //Position: 0x5329 / 21289
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_118() //Position: 0x533A / 21306
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_119() //Position: 0x534B / 21323
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_120(var uParam0, int iParam1) //Position: 0x535C / 21340
{
...
var Function_121(var uParam0, int iParam1, bool bParam2) //Position: 0x537F / 21375
{
	int iVar0;
...
var Function_122(bool bParam0) //Position: 0x539E / 21406
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_123() //Position: 0x53AA / 21418
{
	return Function_124(39);
}

int Function_124(bool bParam0) //Position: 0x53B5 / 21429
{
	bool bVar0;
...
var Function_125() //Position: 0x53E3 / 21475
{
	return "PackedWeapon";
}

int Function_126(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x53F8 / 21496
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_127() //Position: 0x54FC / 21756
{
	return "MPItemGiver";
}

struct<32> Function_128(bool bParam0) //Position: 0x5510 / 21776
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_129(char* cParam0, char* cParam1, char* cParam2) //Position: 0x557A / 21882
{
	char* cVar0[32];
...
var Function_130() //Position: 0x5599 / 21913
{
	return "PBox_";
}

var Function_131() //Position: 0x55A7 / 21927
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_132() //Position: 0x55CD / 21965
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_133() //Position: 0x55F5 / 22005
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_134(var uParam0, int iParam1) //Position: 0x561B / 22043
{
	int iVar0;
	var uVar1;
...
void Function_135(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x577C / 22396
{
	struct<8> Var0;
...
int Function_136(bool bParam0) //Position: 0x5817 / 22551
{
	int iVar0;
	vector3 vVar1;
...
void Function_137(int iParam0) //Position: 0x5978 / 22904
{
...
var Function_138() //Position: 0x59D9 / 23001
{
	int iVar0;
...
var Function_139(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x59E1 / 23009
{
	return Function_140(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x59FA / 23034
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_141(int iParam0) //Position: 0x5CED / 23789
{
	int iVar0;
...
void Function_142() //Position: 0x5DA1 / 23969
{
	int iVar0;
...
bool Function_143(bool bParam0) //Position: 0x5DDB / 24027
{
	int iVar0;
...
void Function_144(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5E08 / 24072
{
	bool bVar0;
...
void Function_145() //Position: 0x5F59 / 24409
{
	int iVar0;
...
var Function_146(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5FA4 / 24484
{
	int iVar0;
...
int Function_147() //Position: 0x6074 / 24692
{
	int iVar0;
...
int Function_148() //Position: 0x61D0 / 25040
{
	int iVar0;
...
bool Function_149(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x62F0 / 25328
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_150(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x63C0 / 25536
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_151(bool bParam0) //Position: 0x64F2 / 25842
{
	bool bVar0;
...
bool Function_152(int iParam0) //Position: 0x6511 / 25873
{
	int iVar0;
...
int Function_153() //Position: 0x652D / 25901
{
	if (Function_155())
	{
...
int Function_154() //Position: 0x6546 / 25926
{
	return Global_79349.f_16;
}

bool Function_155() //Position: 0x6552 / 25938
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_156(int iParam0, bool bParam1, bool bParam2) //Position: 0x655B / 25947
{
	var uVar0;
	...
	if (IS_STRING_VALID(bParam1))
	{
		if (STRING_LENGTH(bParam1) >= 0)
		{
			...
			Function_157(iParam0 + 60, iParam0->f_16, 0);
		}
	}
	if (IS_STRING_VALID(bParam2))
	{
		if (STRING_LENGTH(bParam2) >= 0)
		{
			...
			Function_157(iParam0 + 60, iParam0->f_20, 7);
		}
	}
	return;
}

var Function_157(var uParam0, int iParam1, int iParam2) //Position: 0x65D8 / 26072
{
	int iVar0;
