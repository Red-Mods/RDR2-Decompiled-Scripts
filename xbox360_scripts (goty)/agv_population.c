...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar10))
	{
		...
		if (IS_VOLUME_VALID(bVar11))
		{
			Function_4(bVar11, uVar9, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6) //Position: 0x11C4 / 4548
{
	var uVar0;
	
	uVar0 = CREATE_ZONE_VOLUME(bParam0);
	SET_ZONE_POPULATION_TYPE(uVar0, uParam1);
	SET_ZONE_POPULATION_COUNT_RANDOM(uVar0, uParam2, uParam3);
...
var Function_4(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1246 / 4678
{
	var uVar0;
...
void Function_5(int iParam0) //Position: 0x12C6 / 4806
{
	Function_6(iParam0);
...
var Function_7(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1394 / 5012
{
	var uVar0;
...
void Function_11(var uParam0, var uParam1) //Position: 0x148A / 5258
{
	SET_DEFAULT_POPULATION_TYPE(uParam0);
	SET_DEFAULT_POPULATION_DENSITY(uParam1);
	return;
}
...
var Function_13(var uParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x14A3 / 5283
{
	int iVar0;
	int iVar1;
	
	iVar0 = Function_14(uParam0, iParam1, fParam2, bParam3, 0);
	if (iVar0 > 0)
	{
...
var Function_14(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x14E8 / 5352
{
	int iVar0;
	int iVar1;
...
void Function_15(bool bParam0) //Position: 0x1564 / 5476
{
	DESTROY_POPULATION_SET(*bParam0);
	return;
}

var Function_16(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1570 / 5488
{
	int iVar0;
	int iVar1;
...
var Function_17(int iParam0) //Position: 0x15E8 / 5608
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x1654 / 5716
{
	int iVar0;
...
var Function_19(int iParam0, int iParam1) //Position: 0x16C0 / 5824
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_20(char* cParam0, var uParam1) //Position: 0x16CD / 5837
{
	if (!Function_8(128))
	{
		return;
