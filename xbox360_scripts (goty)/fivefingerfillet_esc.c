...
bool Function_22() //Position: 0xA23 / 2595
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_29(Global_30685[0], &iLocal_24 + 4, &iLocal_24 + 24, &iLocal_24 + 28))
			{
				Function_28(&(Global_30685[0]));
				Function_27(&iLocal_24 + 4);
				Function_21(Global_30685[0]);
				*(&iLocal_24 + 156[03]) = { StackVal, StackVal, Function_21(Global_30685[0]) };
				Function_20(Global_30685[0]);
				*(&iLocal_24 + 156[13]) = { StackVal, StackVal, Function_20(Global_30685[0]) };
				iLocal_24 = Local_5;
