...
void main() //Position: 0x0 / 0
{
	...
	SET_DUST_LEVEL(2);
	Function_96(ScriptParam_0);
	ALLOW_TUMBLEWEEDS(1);
	Function_95("Initializing Gaptooth Ridge", 3);
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_274)
		{
			...
			case 0x00000002:
				if (Function_85())
				{
					Function_84(&(Global_29008[Local_275]), 32);
					Function_80(Local_0);
					iLocal_274 = 3;
				}
				bLocal_277 = false;
			...
			case 0x00000003:
				...
				Function_79(&Global_6532, &Global_7536, ScriptParam_0);
				iLocal_274 = 5;
				bLocal_277 = false;
				break;
			
			case 0x00000005:
				if (Function_78(&Global_6532, &Global_7536, ScriptParam_0))
				{
					iLocal_274 = 4;
					bLocal_277 = false;
				}
			...
			case 0x00000004:
				if (Function_77(&(Global_29008[Local_275]), 16))
				{
					iLocal_274 = 6;
				}
				bLocal_277 = false;
			...
			case 0x00000006:
				Function_72(&Global_6532, &Global_7536, &uLocal_280, Global_6288, ScriptParam_0);
				Function_84(&(Global_29008[Local_275]), 8);
				if (Function_77(&(Global_29008[ScriptParam_0]), 131072))
				{
					Function_71(&(Global_29008[ScriptParam_0]), 131072);
					iLocal_274 = 10;
				}
				else
				{
			...
			case 0x00000007:
				Function_70(ScriptParam_0);
				if (Function_68(512))
				{
					Function_58(ScriptParam_0);
				}
				Function_57(64);
				iLocal_274 = 8;
				bLocal_277 = false;
			...
			case 0x00000008:
				Function_56(0, Global_30640[0], -2080.289f, 16.962f, 2603.609f);
				if (!Function_55(&Global_30658))
				{
					Function_51(StackVal, 2, 0.5f, 0, Local_0, !Function_55(&Global_30658));
					Function_47(0, 8, 4, 0, 2);
					Function_57(64);
				}
				Function_84(&(Global_29008[Local_275]), 512);
				iLocal_274 = 9;
				bLocal_277 = false;
				break;
			...
			case 0x00000009:
				if (!Function_55(&Global_30658))
				{
					Function_45(Local_0, ScriptParam_0);
				}
				Global_29004 = 0;
				Function_84(&(Global_29008[Local_275]), 4);
				Function_44("Finished Initializing Gaptooth Ridge", 5.0f);
				iLocal_274 = 10;
				bLocal_277 = false;
				break;
			...
			case 0x0000000A:
				...
				Function_31(&(Global_26282[44]), "TWG", 18, Local_0, 4);
				if (Function_24(0))
				{
	...
	SET_DUST_LEVEL(1);
	Function_57(64);
	Function_71(&(Global_29008[Local_275]), 32);
	Function_71(&(Global_29008[Local_275]), 64);
	Function_71(&(Global_29008[Local_275]), 8);
	Function_71(&(Global_29008[Local_275]), 512);
	Function_71(&(Global_29008[Local_275]), 4);
	if (IS_SCRIPT_VALID(bLocal_278))
	{
		TERMINATE_SCRIPT(bLocal_278);
	}
	Function_44("Unloaded Gaptooth Ridge", 5.0f);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(int iParam0) //Position: 0x3E6 / 998
{
	int iVar0;
...
void Function_2(int iParam0) //Position: 0x41C / 1052
{
...
bool Function_3(int iParam0) //Position: 0x43E / 1086
{
...
bool Function_4(int iParam0) //Position: 0x454 / 1108
{
...
void Function_5() //Position: 0x46A / 1130
{
...
void Function_6(int iParam0) //Position: 0x47C / 1148
{
	int iVar0;
...
void Function_7(var uParam0, int iParam1) //Position: 0x4A2 / 1186
{
...
void Function_8(var uParam0, int iParam1) //Position: 0x5D0 / 1488
{
	int iVar0;
...
bool Function_9(int iParam0, int iParam1) //Position: 0x5EA / 1514
{
	int iVar0;
...
void Function_10() //Position: 0x607 / 1543
{
	RELEASE_LAYOUT_REF(Local_0);
	return;
}

void Function_11(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x612 / 1554
{
	char* cVar0[64];
	int iVar16;
	bool bVar17;
	...
	if (Function_77(&(Global_29008[iParam2]), 0x40000000))
	{
		...
		Function_71(&(Global_29008[iParam2]), 0x40000000);
	}
	iVar16 = 0;
	iVar16 = 0;
...
void Function_12(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x812 / 2066
{
...
int Function_13(int iParam0) //Position: 0x961 / 2401
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_14(int iParam0) //Position: 0x98C / 2444
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_15(var uParam0, int iParam1) //Position: 0x9C0 / 2496
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_16(int iParam0) //Position: 0x9CF / 2511
{
	int iVar0;
...
void Function_17(var uParam0, int iParam1) //Position: 0x9EB / 2539
{
	int iVar0;
...
bool Function_18(int iParam0, int iParam1) //Position: 0xA02 / 2562
{
	int iVar0;
...
bool Function_19() //Position: 0xA1E / 2590
{
...
bool Function_20(bool bParam0, int iParam1) //Position: 0xA39 / 2617
{
	return (bParam0 && iParam1) == 0;
}

var Function_21(int iParam0) //Position: 0xA46 / 2630
{
	if (!Function_4(iParam0))
	{
		return "";
...
bool Function_22() //Position: 0xEF4 / 3828
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_23(int iParam0) //Position: 0xEFD / 3837
{
	if (!Function_4(iParam0))
	{
		return;
...
bool Function_24(int iParam0) //Position: 0xF68 / 3944
{
...
bool Function_25(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0xFEB / 4075
{
	uParam0 = uParam0;
...
bool Function_26(int iParam0) //Position: 0x108F / 4239
{
...
int Function_27(int iParam0) //Position: 0x10AA / 4266
{
	if (iParam0 == 1)
	{
		if (Global_3386 == 1)
...
bool Function_28(bool bParam0) //Position: 0x115E / 4446
{
...
bool Function_29() //Position: 0x117C / 4476
{
	return Function_20(StackVal, 1);
}

var Function_30() //Position: 0x118B / 4491
{
	return StackVal;
}

void Function_31(int iParam0, char* cParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x1196 / 4502
{
	bool bVar0;
...
void Function_32() //Position: 0x1391 / 5009
{
	bool bVar0;
...
void Function_33() //Position: 0x13D8 / 5080
{
	int iVar0;
...
void Function_34(int iParam0, bool bParam1) //Position: 0x142A / 5162
{
	if (bParam1 <= 32)
	{
...
void Function_35(var uParam0, int iParam1) //Position: 0x1453 / 5203
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_36(bool bParam0) //Position: 0x1462 / 5218
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_37(char* cParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x146E / 5230
{
	bool bVar0;
	char* cVar1[16];
	bool bVar5;
...
var Function_38() //Position: 0x150E / 5390
{
	int iVar0;
...
int Function_39(int iParam0) //Position: 0x1516 / 5398
{
...
int Function_40(int iParam0) //Position: 0x152B / 5419
{
...
bool Function_41(int iParam0, bool bParam1) //Position: 0x1540 / 5440
{
	if (bParam1 <= 32)
	{
...
void Function_42(int iParam0) //Position: 0x156B / 5483
{
...
void Function_43(bool bParam0) //Position: 0x1597 / 5527
{
	bool bVar0;
...
void Function_44(bool bParam0, float fParam1) //Position: 0x15DC / 5596
{
	if (!Function_16(128))
	{
		return;
...
void Function_45(bool bParam0, bool bParam1) //Position: 0x161A / 5658
{
	char[] cVar0[4];
...
void Function_46(var uParam0, int iParam1) //Position: 0x1714 / 5908
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_47(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x1721 / 5921
{
...
void Function_48() //Position: 0x1805 / 6149
{
	int iVar0;
...
int Function_49(bool bParam0) //Position: 0x1853 / 6227
{
...
bool Function_50(bool bParam0) //Position: 0x186B / 6251
{
...
void Function_51(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x1880 / 6272
{
	bool bVar0;
...
void Function_52(int iParam0) //Position: 0x1993 / 6547
{
	Function_53(&Global_28842, iParam0);
	return;
}

void Function_53(var uParam0, var uParam1) //Position: 0x19A1 / 6561
{
...
void Function_54() //Position: 0x19BC / 6588
{
...
bool Function_55(int iParam0) //Position: 0x19D8 / 6616
{
	int iVar0;
...
void Function_56(int iParam0, var uParam1, vector3 vParam2) //Position: 0x1A25 / 6693
{
...
void Function_57(int iParam0) //Position: 0x1A87 / 6791
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_58(int iParam0) //Position: 0x1A9A / 6810
{
	if (Function_67(349) == 0)
	{
		Function_63(53, 2, 760, 0, 770, 2, 2, 0, 4, iParam0, "$/content/DLC/MoOutfitsPack/event_jackalope", 63, 0, 50.0f, 2, 15, 0);
	}
	else
	{
		Function_63(53, 2, 760, 0, 770, 2, 0, 0, 4, iParam0, "$/content/DLC/MoOutfitsPack/event_jackalope", 63, 0, 50.0f, 2, 45, 0);
	}
	Function_62(&Global_17483[5375] + 120, 2, 8.0f, 1, 704);
	Function_61(&Global_17483[5375] + 120, 19.9f, 0.6f);
	Function_60(&Global_17483[5375] + 120, 0.0f, 2);
	Function_59(&Global_17483[5375] + 120, 10.0f);
	return;
}

void Function_59(int iParam0, int iParam1) //Position: 0x1B92 / 7058
{
	(iParam0 + 60)->f_32 = iParam1;
	return;
}

void Function_60(int iParam0, float fParam1, int iParam2) //Position: 0x1BA0 / 7072
{
...
void Function_61(int iParam0, float fParam1, int iParam2) //Position: 0x1BB6 / 7094
{
...
void Function_62(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1BCC / 7116
{
...
void Function_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1BF2 / 7154
{
	if (!Function_3(iParam0))
	{
		return;
	}
	Function_64(iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, uParam10, iParam11, iParam12, fParam13, iParam14, iParam15, iParam16);
	Global_17483[iParam075].f_92 = iParam9;
}

void Function_64(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, var uParam7, var uParam8, bool bParam9, var uParam10, var uParam11, var uParam12, var uParam13, bool bParam14, var uParam15) //Position: 0x1C34 / 7220
{
	var uVar0;
	int iVar1;
	bool bVar2;
	...
	if (!UNK_0x214AFB8C(Global_16876[iParam06].f_20))
	{
		...
		Function_65(iParam0, Global_17483[iParam075].f_96);
	...
	bParam14 = Function_66(bParam14 * 60);
...
int Function_65(int iParam0, int iParam1) //Position: 0x1FDC / 8156
{
	if (iParam0 >= 4294967295 || iParam0 <= 100)
	{
		return 0;
...
bool Function_66(int iParam0) //Position: 0x1FFD / 8189
{
	return CEIL(((IntToFloat(iParam0) * Global_63398) / 60.0f));
}

int Function_67(int iParam0) //Position: 0x2013 / 8211
{
...
bool Function_68(int iParam0) //Position: 0x2054 / 8276
{
	return Function_69(Global_83864.f_1252, iParam0);
}

int Function_69(var uParam0, int iParam1) //Position: 0x2066 / 8294
{
	return (uParam0 && iParam1) == 0;
}

void Function_70(int iParam0) //Position: 0x2073 / 8307
{
	Function_63(18, 2, 100, 50, 50, 1, 32832, 1, 4, iParam0, "$/content/Ambient/Roaming/event_hangingb", 63, 2, 55.0f, 8, 65, 0);
	Function_62(&Global_17483[1875] + 120, 1, 5.0f, 1, 640);
...
void Function_71(var uParam0, int iParam1) //Position: 0x2108 / 8456
{
	int iVar0;
...
void Function_72(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x211F / 8479
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 >= 0)
	{
		Function_71(&(Global_29008[iParam4]), 2048);
	}
...
bool Function_73(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x21D1 / 8657
{
	int iVar0;
	char* cVar1[16];
...
int Function_74(bool bParam0, int iParam1) //Position: 0x233C / 9020
{
	vector3 vVar0;
	bool bVar20;
...
bool Function_75(vector3 vParam0) //Position: 0x2478 / 9336
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_76(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x2490 / 9360
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x25A9 / 9641
{
	int iVar0;
...
bool Function_78(var uParam0, var uParam1, int iParam2) //Position: 0x25C5 / 9669
{
	int iVar0;
	char* cVar1[64];
...
void Function_79(var uParam0, var uParam1, int iParam2) //Position: 0x26A6 / 9894
{
	int iVar0;
	char* cVar1[64];
...
int Function_80(bool bParam0) //Position: 0x278E / 10126
{
	bool bVar0;
	vector3 vVar1;
	var uVar4;
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x28D7 / 10455
{
	int iVar0;
...
int Function_82() //Position: 0x28F7 / 10487
{
	if (Function_22())
	{
...
int Function_83() //Position: 0x2910 / 10512
{
	return Global_79349.f_16;
}

void Function_84(var uParam0, int iParam1) //Position: 0x291C / 10524
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_85() //Position: 0x292B / 10539
{
	bool bVar0;
	
	Function_93(3, 3);
	bVar0 = bVar0;
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire02", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire03", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire01", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/stand_guntricks_e_any", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/horse_tend", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/sleeping_wall_scripted", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_play_harmonica", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall_shoulder_l", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/lean_rail", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_l", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/lie_sleep_on_bed_l", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire04", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire05", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/sleeping_scripted", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_h_talking", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/stand_dnd_rowdydrink", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/campfire_talk", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/locked_footlocker", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/player_herb_desertsage", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/player_herb_redsage", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/player_herb_wildfeverfew", 1, 0);
	Function_91(&Local_8 + 4, "$/content/scripting/gringo/simplegringo/treasure_hunting_3", 1, 0);
	if (!Function_86(&Local_8 + 4))
	{
		return 0;
	}
...
bool Function_86(int iParam0) //Position: 0x7D42 / 32066
{
	int iVar0;
	int iVar1;
...
void Function_87() //Position: 0x80BF / 32959
{
	if (!Function_16(128))
	{
		return;
...
bool Function_88() //Position: 0x80FF / 33023
{
	int iVar0;
...
void Function_89(var uParam0, int iParam1) //Position: 0x812A / 33066
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_90() //Position: 0x813B / 33083
{
	if (!Function_16(128))
	{
		return;
...
var Function_91(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x817D / 33149
{
	int iVar0;
	var uVar1;
...
var Function_92(var uParam0, int iParam1, int iParam2) //Position: 0x81B5 / 33205
{
	int iVar0;
...
void Function_93(int iParam0, int iParam1) //Position: 0x8279 / 33401
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_94() //Position: 0x82C2 / 33474
{
	var uVar0;
...
void Function_95(bool bParam0, int iParam1) //Position: 0x8367 / 33639
{
	if (!Function_16(128))
	{
		return;
...
void Function_96(int iParam0) //Position: 0x83A2 / 33698
{
	if (!Function_4(iParam0))
	{
		return;
