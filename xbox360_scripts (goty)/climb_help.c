...
void main() //Position: 0x0 / 0
{
	...
	iLocal_78 = 0;
	Function_103(uScriptParam_0, &iLocal_78);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(Local_5[iVar312]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), Local_5[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", Local_5[iVar312].f_16);
							Function_88(Local_5[iVar312].f_16, 1);
							...
							{
								Function_81(&(Local_5[iVar312]), 0);
							}
							else if (Local_5[iVar312].f_44 < 8)
							{
								Function_80(&(Local_5[iVar312]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_78 - 1))
			{
				if (Function_79(Local_5[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_5[iVar012])))
					{
						Function_106("Quitting due to update end");
						Function_81(&(Local_5[iVar012]), 1);
					}
				}
				if (Function_15(&(Local_5[iVar012]), 0))
				{
					Function_5(&(Local_5[iVar012]));
				}
				iVar0++;
			}
		}
	...
	while (iVar0 < (iLocal_78 - 1))
	{
		if (Function_79(Local_5[iVar012].f_40, 2))
		{
			Function_2("Gringo termination calls StopUse", Local_5[iVar012].f_16);
			Function_81(&(Local_5[iVar012]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(Local_5[iVar012].f_12))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", Local_5[iVar012].f_12);
		}
		Function_15(&(Local_5[iVar012]), 1);
		iVar0++;
	}
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_85))
								{
									...
									{
										bLocal_85 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_85 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_83, &cLocal_82);
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_79(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x21F5 / 8693
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
void Function_62(int iParam0) //Position: 0x2552 / 9554
{
	...
	iParam0 = iParam0;
	if ((iLocal_3 && !iLocal_4) && Global_30679[1] != Global_29006)
	{
		iLocal_4 = 1;
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_67("climbHelpCut_Layout") };
		bLocal_1 = CREATE_LAYOUT(&Var0);
		bLocal_2 = Function_63(bLocal_1, 0, 1, 0, 0);
		HUD_ENABLE(0);
		bVar8 = FIND_VOLUME_IN_LAYOUT(Global_30616, "v_frontRestrict");
		if (IS_VOLUME_VALID(bVar8))
		{
			bVar9 = CREATE_OBJECTSET_IN_LAYOUT(Function_39(), bLocal_1, 4294967295, 0);
			iVar10 = LOCATE_ACTORS_IN_VOLUME(bVar8, bVar9, 0, 1);
			if (iVar10 >= 0)
			{
				bVar11 = false;
				while (bVar11 < (iVar10 - 1))
				{
					bVar12 = GET_INDEXED_OBJECT_IN_OBJECTSET(bVar11, bVar9);
					if (!bVar12 != GET_OBJECT_FROM_ACTOR(Global_34573) && !DECOR_CHECK_EXIST(bVar12, "IsHelper"))
					{
						SET_OBJECT_POSITION_ON_GROUND(bVar12, -2661.72f, 67.26f, 3402.27f);
					}
					bVar11++;
				}
			}
			...
			{
				if (IS_ACTOR_IN_VOLUME(Global_12976.f_36, bVar8))
				{
			...
			DESTROY_OBJECTSET(bVar9);
		}
	}
	return;
}

bool Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2691 / 9873
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "ClimbHelp_FortMercer", 2, 1);
	}
	Function_64(&bVar0);
...
void Function_64(int iParam0) //Position: 0x2711 / 10001
{
	bool bVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*iParam0, 0, 4.0f, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_EASE_IN_OUT(*iParam0, 0, 1, 5.0f, 1, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*iParam0, 1, 3.0f, 2);
	return;
}

void Function_65(int iParam0) //Position: 0x275A / 10074
{
	...
	SET_CAMERASHOT_POSITION(*iParam0, -2657.796f, 70.23667f, 3403.237f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0.0432f, -2.926601f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x27C4 / 10180
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -2656.693f, 68.58958f, 3404.863f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.034746f, 2.892083f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

struct<32> Function_67(bool bParam0) //Position: 0x282E / 10286
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2898 / 10392
{
	char* cVar0[32];
...
void Function_69(int iParam0) //Position: 0x28B7 / 10423
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x28C1 / 10433
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x28DF / 10463
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x28F4 / 10484
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x297B / 10619
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x299E / 10654
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x29BC / 10684
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x29DF / 10719
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x2AFA / 11002
{
...
int Function_78(bool bParam0) //Position: 0x2B25 / 11045
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2C2A / 11306
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2C37 / 11319
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2CAA / 11434
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(iParam0->f_16) && Function_79(iParam0->f_40, 32)) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
	{
	...
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		...
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_79(iParam0->f_40, 128) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
			{
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_82));
		iLocal_83 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_82() //Position: 0x31A8 / 12712
{
	iLocal_4 = 0;
...
bool Function_83(bool bParam0) //Position: 0x31BE / 12734
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x31DB / 12763
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x3213 / 12819
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x321D / 12829
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(bool bParam0, bool bParam1) //Position: 0x323E / 12862
{
	bParam1 = bParam1;
	bParam0 = bParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("UseCase1", bParam1))
	{
	...
	if (IS_LAYOUTREF_VALID(bLocal_1))
	{
		DESTROY_LAYOUT_OBJECTS(bLocal_1);
		DESTROY_LAYOUT(bLocal_1);
	}
	return;
}

void Function_88(bool bParam0, bool bParam1) //Position: 0x3286 / 12934
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x338E / 13198
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x33A4 / 13220
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_91(bool bParam0, int iParam1) //Position: 0x365A / 13914
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_92(bool bParam0) //Position: 0x366F / 13935
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x3688 / 13960
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x36A2 / 13986
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_95(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_95(var uParam0, int iParam1) //Position: 0x36DA / 14042
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x36F1 / 14065
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x39BA / 14778
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x39D7 / 14807
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3A73 / 14963
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x3A92 / 14994
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x3AA1 / 15009
{
...
void Function_102(int iParam0) //Position: 0x3ABD / 15037
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x3AC7 / 15047
{
	int iVar0;
	int iVar1;
	...
	{
		Function_104(&(Local_5[iLocal_7812]), bParam0);
		iLocal_78++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x3B29 / 15145
{
...
void Function_105(int iParam0) //Position: 0x3B3D / 15165
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3B47 / 15175
{
