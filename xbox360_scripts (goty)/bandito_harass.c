...
void main() //Position: 0x0 / 0
{
	...
	iLocal_75 = 0;
	Function_99(uScriptParam_0, &iLocal_75);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(Local_2[iVar312]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), Local_2[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", Local_2[iVar312].f_16);
							Function_84(Local_2[iVar312].f_16, 1);
							...
							{
								Function_77(&(Local_2[iVar312]), 0);
							}
							else if (Local_2[iVar312].f_44 < 8)
							{
								Function_76(&(Local_2[iVar312]));
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(iLocal_82))
								{
									...
									{
										iLocal_82 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_82 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_80, &cLocal_79);
...
bool Function_26(bool bParam0, bool bParam1) //Position: 0x1D10 / 7440
{
	bool bVar0;
	bool bVar1;
	...
	if (iLocal_1 == 5)
	{
		if (!Function_7(bParam1, "HasSwappedNode", 0))
		{
			bVar1 = Function_9(bParam1, "NodeToSwap", &bVar0);
			if (bVar0)
			{
				if (SET_ACTION_NODE_FOR_ACTOR(bParam0, bVar1))
				{
					SET_GRINGO_BOOL_ATTR(1, "HasSwappedNode", bParam1);
					return 1;
				}
	...
	else if (Function_7(bParam1, "HasSwappedNode", 0))
	{
		SET_GRINGO_BOOL_ATTR(0, "HasSwappedNode", bParam1);
		return 0;
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x1E03 / 7683
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1E22 / 7714
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1E28 / 7720
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1E36 / 7734
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1E41 / 7745
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1E5B / 7771
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E79 / 7801
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E98 / 7832
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1EEA / 7914
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1F04 / 7940
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1F17 / 7959
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x21FF / 8703
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2207 / 8711
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2224 / 8740
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2233 / 8755
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2255 / 8789
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2279 / 8825
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2296 / 8854
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x22B6 / 8886
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x22D6 / 8918
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2384 / 9092
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x23F4 / 9204
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x240A / 9226
{
...
var Function_51(bool bParam0) //Position: 0x242B / 9259
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x244B / 9291
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x245F / 9311
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2469 / 9321
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2470 / 9328
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x247F / 9343
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x24BE / 9406
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x24E9 / 9449
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24F4 / 9460
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x25EA / 9706
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x260C / 9740
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2633 / 9779
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x28F2 / 10482
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x294F / 10575
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x29AC / 10668
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x29B6 / 10678
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x29D4 / 10708
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x29E9 / 10729
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A70 / 10864
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A93 / 10899
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2AB1 / 10929
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2AD4 / 10964
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2BEF / 11247
{
...
int Function_74(bool bParam0) //Position: 0x2C1A / 11290
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2D1F / 11551
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2D2C / 11564
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D9F / 11679
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_79));
		iLocal_80 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x329D / 12957
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x32D4 / 13012
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x32F1 / 13041
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3329 / 13097
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3333 / 13107
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3354 / 13140
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	iLocal_1 = (iLocal_1 - 1);
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3368 / 13160
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(char* cParam0, bool bParam1) //Position: 0x3470 / 13424
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3486 / 13446
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x373C / 14140
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	iLocal_1++;
...
bool Function_88(bool bParam0) //Position: 0x3750 / 14160
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3769 / 14185
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3783 / 14211
{
	bool bVar0;
	var uVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x37BB / 14267
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x37D2 / 14290
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A9B / 15003
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3AB8 / 15032
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B54 / 15188
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B73 / 15219
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B82 / 15234
{
...
void Function_98(int iParam0) //Position: 0x3B9E / 15262
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3BA8 / 15272
{
	int iVar0;
	int iVar1;
	...
	{
		Function_100(&(Local_2[iLocal_7512]), bParam0);
		iLocal_75++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x3C0A / 15370
{
...
void Function_101(int iParam0) //Position: 0x3C1E / 15390
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3C28 / 15400
{
