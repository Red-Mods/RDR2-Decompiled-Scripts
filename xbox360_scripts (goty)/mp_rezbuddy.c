	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_48(iParam0, bVar8, &iLocal_21, &cLocal_20);
...
void Function_22(bool bParam0, int iParam1) //Position: 0x1CBA / 7354
{
	iParam1 = iParam1;
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_23(var uParam0, int iParam1) //Position: 0x1CFC / 7420
{
	var uVar0[2];
	
	uVar0[0] = uParam0;
	uVar0[1] = iParam1;
	NET_LOG(true, "Rezzing", "I, player #%s, have just rezzed player #%s, whether he believes me or not", I2STR(uVar0[1]), I2STR(uVar0[0]), false, false);
	NET_SCRIPTMSG_SEND(1, 12, &uVar0, 3, 1);
	return;
}

bool Function_24(bool bParam0) //Position: 0x1D8E / 7566
{
	bool bVar0[2];
	...
	if (Function_26(65536, 1))
	{
		...
		NET_LOG(true, "Rezzing", "I, player #%s, have just been rezzed by player #%s", I2STR(bVar0[1]), I2STR(bVar0[0]), false, false);
...
void Function_25(int iParam0, bool bParam1) //Position: 0x1E23 / 7715
{
	if (bParam1)
	{
...
bool Function_26(int iParam0, bool bParam1) //Position: 0x1E5E / 7774
{
	int iVar0;
...
float Function_27(bool bParam0) //Position: 0x1E7E / 7806
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_28() //Position: 0x1E94 / 7828
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_29(bool bParam0) //Position: 0x1EA1 / 7841
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_30(bool bParam0, int iParam1) //Position: 0x1EC1 / 7873
{
	bool bVar0;
	float fVar1;
	bool bVar2;
...
void Function_31(var uParam0, float fParam1) //Position: 0x1F60 / 8032
{
	Function_32(uParam0, (Function_33(uParam0) + fParam1));
	return;
}

void Function_32(int iParam0, int iParam1) //Position: 0x1F73 / 8051
{
...
float Function_33(int iParam0) //Position: 0x1F9C / 8092
{
	return (*&Global_78480 + 176)[iParam0];
}

bool Function_34(bool bParam0, int iParam1, bool bParam2) //Position: 0x1FAC / 8108
{
	char* cVar0[64];
	int iVar16;
...
var Function_35(int iParam0) //Position: 0x202D / 8237
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_36(bool bParam0) //Position: 0x2346 / 9030
{
	char* cVar0[64];
...
bool Function_37(bool bParam0) //Position: 0x23E7 / 9191
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_38() //Position: 0x2406 / 9222
{
	return;
}

void Function_39(var uParam0, int iParam1) //Position: 0x240C / 9228
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_40(int iParam0) //Position: 0x241A / 9242
{
	iParam0 = iParam0;
	return 1;
}

bool Function_41(bool bParam0) //Position: 0x2425 / 9253
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x243F / 9279
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_43(bool bParam0) //Position: 0x245D / 9309
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_44(bool bParam0) //Position: 0x247C / 9340
{
	int iVar0;
	int iVar1;
...
bool Function_45(bool bParam0) //Position: 0x24AF / 9391
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_46(bool bParam0) //Position: 0x24CE / 9422
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_47(var uParam0, int iParam1) //Position: 0x24E8 / 9448
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_48(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x24FB / 9467
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_49() //Position: 0x27E3 / 10211
{
	int iVar0;
...
bool Function_50(bool bParam0, bool bParam1) //Position: 0x27EB / 10219
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_51() //Position: 0x2808 / 10248
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_52(bool bParam0, int iParam1) //Position: 0x2817 / 10263
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_53(bool bParam0, int iParam1) //Position: 0x2839 / 10297
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_54(bool bParam0) //Position: 0x285D / 10333
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_55(bool bParam0, int iParam1) //Position: 0x287A / 10362
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_56(bool bParam0, int iParam1) //Position: 0x289A / 10394
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_57(bool bParam0, bool bParam1) //Position: 0x28BA / 10426
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_58(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2968 / 10600
{
	bool bVar0;
...
void Function_59(int iParam0, float fParam1) //Position: 0x29D8 / 10712
{
	if (!Function_14(iParam0))
	{
...
void Function_60(int iParam0, float fParam1) //Position: 0x29EE / 10734
{
...
var Function_61(bool bParam0) //Position: 0x2A0F / 10767
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_62(int iParam0) //Position: 0x2A2F / 10799
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_63(var uParam0) //Position: 0x2A43 / 10819
{
	uParam0 = uParam0;
	return;
}

int Function_64() //Position: 0x2A4D / 10829
{
	return 1;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2A54 / 10836
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_66(bool bParam0, var uParam1, int iParam2) //Position: 0x2A63 / 10851
{
	bool bVar0;
...
bool Function_67(bool bParam0) //Position: 0x2AA2 / 10914
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_68(bool bParam0) //Position: 0x2ACD / 10957
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_69(bool bParam0) //Position: 0x2AD8 / 10968
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_70(bool bParam0) //Position: 0x2BCE / 11214
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_71(bool bParam0) //Position: 0x2BF0 / 11248
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_72(int iParam0) //Position: 0x2C17 / 11287
{
	iParam0 = iParam0;
	return;
}

void Function_73(int iParam0) //Position: 0x2C21 / 11297
{
	iParam0 = iParam0;
	return;
}

bool Function_74(bool bParam0) //Position: 0x2C2B / 11307
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_75(int iParam0) //Position: 0x2C49 / 11337
{
	if (!Function_14(iParam0))
	{
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x2C5E / 11358
{
	bool bVar0;
	vector3 vVar1;
	struct<9> Var4;
	...
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		...
		TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar16, bVar22, 0, 1, 1);
...
vector3 Function_77(bool bParam0) //Position: 0x2D28 / 11560
{
	vector3 vVar0;
...
vector3 Function_78(bool bParam0) //Position: 0x2D39 / 11577
{
	vector3 vVar0;
...
bool Function_79(bool bParam0, int iParam1) //Position: 0x2D60 / 11616
{
...
int Function_80(bool bParam0) //Position: 0x2D8B / 11659
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_81(var uParam0, int iParam1) //Position: 0x2E90 / 11920
{
	return (uParam0 && iParam1) == 0;
}

void Function_82(int iParam0) //Position: 0x2E9D / 11933
{
	if (Function_81(iParam0->f_40, 16))
	{
...
void Function_83(int iParam0, bool bParam1) //Position: 0x2F10 / 12048
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_84() //Position: 0x340E / 13326
{
	bool bVar0;
...
bool Function_85(bool bParam0) //Position: 0x3445 / 13381
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_86(var uParam0, int iParam1) //Position: 0x3462 / 13410
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_87(int iParam0) //Position: 0x349A / 13466
{
	iParam0 = iParam0;
	return;
}

bool Function_88(bool bParam0) //Position: 0x34A4 / 13476
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_89(bool bParam0, int iParam1) //Position: 0x34C5 / 13509
{
	...
	SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_2, bParam0, 1);
	SET_OBJECT_COLLIDE_WITH_OBJECT(bParam0, bLocal_2, 1);
	iParam1 = iParam1;
	return;
}

void Function_90(bool bParam0, bool bParam1) //Position: 0x352B / 13611
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x3633 / 13875
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_92(int iParam0) //Position: 0x3649 / 13897
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_93(bool bParam0, int iParam1) //Position: 0x38FF / 14591
{
	iParam1 = iParam1;
	bLocal_2 = GET_ACTOR_FROM_OBJECT(GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF()));
	SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_2, bParam0, 0);
	SET_OBJECT_COLLIDE_WITH_OBJECT(bParam0, bLocal_2, 0);
	...
	if (IS_ACTOR_LOCAL_PLAYER(bLocal_2))
	{
		...
		NET_LOG(true, "Rezzing", "%s has started reviving me!", GET_ACTOR_NAME(bParam0), false, false, false);
	}
	else if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		NET_LOG(true, "Rezzing", "I have started reviving %s!", GET_ACTOR_NAME(bLocal_2), false, false, false);
	}
	else
	{
		NET_LOG(true, "Rezzing", "%s started to revive %s!", GET_ACTOR_NAME(bParam0), GET_ACTOR_NAME(bLocal_2), false, false);
	}
	return;
}

bool Function_94(bool bParam0) //Position: 0x3A12 / 14866
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_95(bool bParam0) //Position: 0x3A2B / 14891
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_96(bool bParam0, int iParam1) //Position: 0x3A45 / 14917
{
	bool bVar0;
	bool bVar1;
	...
	if (IS_ACTOR_VALID(bVar0))
	{
		...
		{
			UI_SET_STRING_FORMAT("Generic_Dbuffer64_0", UI_GET_STRING("mp_revivePlayer"), UI_GET_STRING(Function_97(bVar1)), false, false);
...
var Function_97(int iParam0) //Position: 0x3AC6 / 15046
{
	switch (iParam0)
	{
		case 0x00000000:
...
bool Function_98(int iParam0, int iParam1) //Position: 0x3CDA / 15578
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_99(bool bParam0) //Position: 0x3FA3 / 16291
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_100(bool bParam0, bool bParam1) //Position: 0x3FC0 / 16320
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_101(int iParam0) //Position: 0x405E / 16478
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_102(bool bParam0, int iParam1) //Position: 0x407D / 16509
{
	bool bVar0;
...
bool Function_103(int iParam0) //Position: 0x40E8 / 16616
{
...
void Function_104(int iParam0) //Position: 0x4104 / 16644
{
	iParam0 = iParam0;
	return;
}

void Function_105(bool bParam0, int iParam1) //Position: 0x410E / 16654
{
	int iVar0;
	int iVar1;
...
void Function_106(int iParam0, int iParam1) //Position: 0x4170 / 16752
{
...
void Function_107(int iParam0) //Position: 0x4184 / 16772
{
	iParam0 = iParam0;
	return;
}

void Function_108(int iParam0) //Position: 0x418E / 16782
{
