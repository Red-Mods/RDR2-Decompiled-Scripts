...
void main() //Position: 0x0 / 0
{
	...
	ENABLE_WEATHER_SPHERE(17, false);
	UI_EXIT("MPSplash");
	...
	if (Function_149())
	{
		...
		*(&Local_39 + 1896) = { -1372.93f, 13.051f, 4281.811f };
		...
		AUDIO_MUSIC_FORCE_TRACK("TC_MEX_SONG_01", "nIDLE_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
...
var Function_34(var uParam0, int iParam1, bool bParam2) //Position: 0x1ADB / 6875
{
	int iVar0;
...
void Function_61(bool bParam0, int iParam1, bool bParam2) //Position: 0x225D / 8797
{
	if (bParam0)
	{
		if (Function_103())
		...
		else
		{
			...
			if (bVar1)
			{
				...
				if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(Local_39[iVar090].f_356))
				{
					...
					PRINT_SMALL_FORMAT(2.5f, "COOP_Selected", Function_81(Local_39[iVar090].f_324, 0), false, 0, 0, 2, 0, 0);
...
void Function_85(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F74 / 12148
{
	struct<4> Var0;
	int iVar4;
...
bool Function_125() //Position: 0x4030 / 16432
{
	return Function_126(39);
}

int Function_126(bool bParam0) //Position: 0x403B / 16443
{
	int iVar0;
...
var Function_152(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4961 / 18785
{
	...
	iVar0 = Function_153(iParam0, iVar1, iParam2);
	if (bParam3)
	{
		Function_143(iParam0[iVar03], 8);
	}
...
int Function_156(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A75 / 19061
{
	bool bVar0;
	bool bVar1;
	
	Function_61(bParam1, iParam2, bParam3);
	bVar0 = Function_54(bParam0);
	if (!bParam1)
	{
		Function_24(bParam0, bVar0, 0);
