...
bool Function_33(char* cParam0) //Position: 0x1D92 / 7570
{
...
bool Function_35(char* cParam0) //Position: 0x1DE4 / 7652
{
	return Function_7(cParam0, "LinkParentToAnim", 0);
}

bool Function_36(char* cParam0) //Position: 0x1E03 / 7683
{
...
void Function_38(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1E30 / 7728
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
int Function_45(int iParam0, int iParam1) //Position: 0x21AF / 8623
{
	return Function_9(iParam0, "TargetAttachBone", iParam1);
}

int Function_46(int iParam0, int iParam1) //Position: 0x21CF / 8655
{
...
bool Function_60(char* cParam0) //Position: 0x2503 / 9475
{
...
void Function_62(bool bParam0) //Position: 0x254C / 9548
{
	...
	{
		iVar11 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar10, bParam0);
		if (GRINGO_IS_PROP_READY(iVar11))
		{
			iVar12 = GRINGO_GET_PROP_FROM_COMPONENT(iVar11);
...
bool Function_66(char* cParam0) //Position: 0x28CF / 10447
{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2902 / 10498
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29AC / 10668
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29CA / 10698
{
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B08 / 11016
{
...
bool Function_79(bool bParam0) //Position: 0x31ED / 12781
{
...
bool Function_82(char* cParam0) //Position: 0x324C / 12876
{
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x327B / 12923
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(char* cParam0, bool bParam1) //Position: 0x3383 / 13187
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3399 / 13209
{
	int iVar0;
	int iVar1;
	char* cVar2;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x364F / 13903
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_88(char* cParam0) //Position: 0x3678 / 13944
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_89(char* cParam0) //Position: 0x3691 / 13969
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x36AB / 13995
{
	bool bVar0;
	var uVar1;
...
int Function_91(var uParam0, int iParam1) //Position: 0x36E3 / 14051
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36FA / 14074
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39C3 / 14787
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39E0 / 14816
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A7C / 14972
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A9B / 15003
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AAA / 15018
{
...
void Function_98(int iParam0) //Position: 0x3AC6 / 15046
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AD0 / 15056
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B32 / 15154
{
...
void Function_101(int iParam0) //Position: 0x3B46 / 15174
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B50 / 15184
{
