		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (IS_LAYOUTREF_VALID(bLocal_258))
							{
								...
								{
									bLocal_262 = CREATE_VOLUME_IN_LAYOUT(bLocal_258, "sasquatchWandervol", 2, *(&Global_63541[3555] + 100), 0.0f, 0.0f, 0.0f, 50.0f, 20.0f, 50.0f);
									Function_124(StackVal, StackVal, &bLocal_259, *(&Global_63541[3555] + 100), 0.0f, Global_63541[3555].f_124, 0.0f, bLocal_262);
									iVar0 = 1;
								}
							}
							else
					...
					case 0x00000001:
						if (Function_123(StackVal, StackVal, &bLocal_259, *(&Global_63541[3555] + 100), 0.0f, Global_63541[3555].f_124, 0.0f, bLocal_262))
						{
							iVar0 = 5;
						}
					...
					case 0x00000005:
						...
						{
							Function_122("sasquatch5_OBJ", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "sasquatch5_OBJ", 0, 3, false);
