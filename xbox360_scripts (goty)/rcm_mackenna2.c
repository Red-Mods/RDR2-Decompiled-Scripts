...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_248 = 1000;
			Function_219(&bLocal_257, "$/fragments/p_gen_projector01x", 0, 0);
			Function_218(&bLocal_257, 1284, 3, 0);
			Function_218(&bLocal_257, 1205, 3, 0);
			Function_219(&bLocal_257, "$/content/DLC/ZombiePack/Gringos/DLC_McKenna1", 1, 0);
			Function_219(&bLocal_257, "$/content/DLC/ZombiePack/Gringos/DLC_eating_multi", 1, 0);
			while (!IS_EXITFLAG_SET())
			{
				if (Function_217() && iVar0 > 5)
				{
					...
					{
						TASK_FLEE_ACTOR(bLocal_274, Global_34573, -1.0f, -1.0f, 0, 0, 0);
						SET_ACTOR_FACTION(bLocal_274, 3);
					}
				...
				if (iVar0 <= 3)
				{
					Function_204(bLocal_274, 43128, &uLocal_302, &uLocal_305, 5);
				}
				if (!iLocal_299)
				{
					bLocal_301 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(*(&Global_63541[055] + 100), 10.0f, "p_gen_campfire", 1);
					if (IS_PHYSINST_VALID(bLocal_301))
					{
						iLocal_299 = 1;
						HIDE_PHYSINST(bLocal_301);
						SET_PHYSINST_FROZEN(bLocal_301, 1);
						bLocal_283 = GET_OBJECT_FROM_PHYSINST(bLocal_301);
				...
				if (!iLocal_300)
				{
					bLocal_288 = LOCATE_GRINGO_OF_TYPE("fema_stir_cauldron", &Global_63541[055] + 100, 10.0f, 1);
					if (IS_GRINGO_VALID(bLocal_288))
					{
						iLocal_300 = 1;
						DESTROY_OBJECT(GET_OBJECT_FROM_GRINGO(bLocal_288));
					}
				}
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								if (Function_199(&bLocal_257))
								{
									bLocal_277 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "stayPutVol", 2, -3188.779f, 40.92f, 3714.029f, 0.0f, 232.941f, 0.0f, 8.0f, 8.0f, 8.0f);
									...
									bLocal_274 = FIND_ACTOR_IN_LAYOUT(Global_30616, "Mackenna");
									if (!IS_ACTOR_VALID(bLocal_274))
									{
										bLocal_274 = CREATE_ACTOR_IN_LAYOUT(bLocal_256, "Mackenna", 1284, -3192.431f, 40.632f, 3711.572f, 0.0f, 232.941f, 0.0f);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_274, bLocal_256);
									}
									ADD_ACTOR_STAY_WITHIN_VOLUME(bLocal_274, bLocal_277);
									bLocal_273 = FIND_ACTOR_IN_LAYOUT(Global_30616, "MackennaZombie");
									if (!IS_ACTOR_VALID(bLocal_273))
									{
										bLocal_273 = CREATE_ACTOR_IN_LAYOUT(bLocal_256, "MackennaZombie", 1205, -3187.7f, 41.25f, 3723.76f, 0.0f, 55.848f, 0.0f);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_273, bLocal_256);
									}
									if (!IS_ACTOR_HOGTIED(bLocal_273))
									{
										HOGTIE_ACTOR(bLocal_273);
										AI_IGNORE_ACTOR(bLocal_273);
										DECOR_SET_BOOL(bLocal_273, "NoTalk_CutFree", true);
										DECOR_SET_BOOL(bLocal_273, "CutFree_IgnoreObstruction", true);
										SET_MOVER_FROZEN(bLocal_273, 1);
										DECOR_SET_BOOL(bLocal_273, "ActionArea_DisableHogtie", true);
										SET_ACTOR_ALLOW_WEAPON_REACTIONS(bLocal_273, 0);
										SET_ACTOR_OBEY_AMBIENT_MOVE_RESTRICTIONS(bLocal_273, 0);
									}
									TELEPORT_ACTOR_WITH_HEADING(bLocal_273, -3188.157f, 41.35f, 3724.301f, 236.495f, 1, true, 1);
									bLocal_279 = FIND_OBJECT_IN_LAYOUT(Global_30616, "RCM_Mackenna Camera");
									if (!IS_OBJECT_VALID(bLocal_279))
									{
										bLocal_279 = CREATE_PROP_IN_LAYOUT(bLocal_256, "RCM_Mackenna Camera", "$/fragments/p_gen_projector01x", -3183.368f, 41.5f, 3729.427f, 0.0f, 54.55f, 0.0f, 1);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_279, bLocal_256);
									}
									bLocal_280 = FIND_OBJECT_IN_LAYOUT(Global_30616, "RCM_Mackenna Chair");
									if (!IS_OBJECT_VALID(bLocal_279))
									{
										bLocal_280 = CREATE_PROP_IN_LAYOUT(bLocal_256, "RCM_Mackenna Chair", "$/fragments/p_gen_chair04x", -3183.169f, 41.44f, 3724.295f, 0.0f, -51.844f, 0.0f, 1);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_280, bLocal_256);
									}
									DELETE_ALL_WEAPONS_FROM_ACTOR(bLocal_274);
									SET_ACTOR_FACTION(bLocal_274, 20);
									bLocal_276 = FIND_VOLUME_IN_LAYOUT(Global_30616, "zombieStayOut");
									if (!IS_VOLUME_VALID(bLocal_276))
									{
										bLocal_276 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "zombieStayOut", 2, *(&Global_63541[ScriptParam_055] + 100), 0.0f, 0.0f, 0.0f, 50.0f, 10.0f, 50.0f);
										ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_276);
										ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_276);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_276, bLocal_256);
									}
									CLEAR_AREA_OF_TREE_TYPE(-3187.888f, 41.14f, 3719.785f, 5.0f, "");
									CLEAR_AREA_OF_TREE_TYPE(-3182.081f, 41.613f, 3729.982f, 5.0f, "");
									bLocal_278 = FIND_OBJECT_IN_LAYOUT(Global_30616, "mackennaGringo");
									if (!IS_OBJECT_VALID(bLocal_278))
									{
										bLocal_278 = CREATE_GRINGO_IN_LAYOUT(bLocal_256, "mackennaGringo", "$/content/DLC/ZombiePack/Gringos/DLC_McKenna1", -3188.779f, 40.92f, 3714.029f, 0.0f, 215.753f, 0.0f);
										TASK_USE_GRINGO(bLocal_274, GET_GRINGO_FROM_OBJECT(bLocal_278), "UseCase1", 4294967295, 1);
										SNAP_ACTOR_TO_GRINGO(bLocal_274, bLocal_278, "UseCase1", 1, 0, 0);
										SET_ACTOR_ALLOW_BUMP_REACTIONS(bLocal_274, 0);
										SET_ACTOR_ALLOW_NM_BUMP_REACTIONS(bLocal_274, 0);
										SET_MOVER_FROZEN(bLocal_274, 1);
										TASK_PRIORITY_SET(bLocal_274, 2);
										SET_RCM_ACTOR_CALL_OVER_ENABLE(bLocal_274, 1, 0, false, 1, 0, 2, 1101004800, 1088421888, 1);
									}
									else
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_278, bLocal_256);
										SET_ACTOR_ALLOW_BUMP_REACTIONS(bLocal_274, 0);
										SET_ACTOR_ALLOW_NM_BUMP_REACTIONS(bLocal_274, 0);
										SET_MOVER_FROZEN(bLocal_274, 1);
									}
									AI_IGNORE_ACTOR(bLocal_274);
									AI_IGNORE_ACTOR(bLocal_273);
									SET_ACTOR_VISION_MAX_RANGE(bLocal_274, 10.0f, 1);
									SET_ACTOR_HEARING_MAX_RANGE(bLocal_274, 10.0f);
									iVar0 = 1;
								}
							}
							else
					...
					case 0x00000001:
						...
						{
							Function_198(&Global_63541[ScriptParam_055] + 144, 128);
							SET_ACTOR_ALLOW_BUMP_REACTIONS(bLocal_274, 1);
							SET_ACTOR_ALLOW_NM_BUMP_REACTIONS(bLocal_274, 1);
							SET_MOVER_FROZEN(bLocal_274, 0);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_192();
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							break;
						}
						bLocal_255 = Function_191(StackVal, StackVal, *(&Global_63541[155] + 100), 0x3f800000, 0x42960000, 1, 1, 0);
						if (!bLocal_255)
						{
							if (Function_190(StackVal, StackVal, Global_34573, *(&Global_63541[155] + 100)) > 3.5f)
							{
								bLocal_255 = true;
							}
						}
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (bLocal_255)
							{
								...
								{
									if (Function_188(&bLocal_275))
									{
										GIVE_OBJECT_TO_LAYOUT(bLocal_275, bLocal_256);
										SET_ACTOR_ALLOW_BUMP_REACTIONS(bLocal_274, 1);
										SET_ACTOR_ALLOW_NM_BUMP_REACTIONS(bLocal_274, 1);
										SET_MOVER_FROZEN(bLocal_274, 0);
										CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Toxic_06", bLocal_275);
						...
						Function_180(&(Global_63541[155]), 1, 30.0f, 40.0f, 2, 1, 1, 2, 0);
						if (Function_179())
						{
							TASK_MELEE_ATTACK(bLocal_273, Global_34573, -1.0f);
							if (IS_ACTOR_VALID(bLocal_274))
					...
					case 0x00000003:
						if (Function_144("$/cutscene/mckenna_2_pt_a_cs/mckenna_2_pt_a_cs", &iLocal_248, 37530, 37523, 35480, 37523, 35193, 37523, 2, 1, 1, 2, 0))
						{
							iVar0 = 4;
							Function_143(&bLocal_295);
						}
						break;
					
					case 0x00000004:
						if (Function_141(&bLocal_295) <= 2.0f)
						{
							CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Toxic_06", bLocal_275);
							iVar0 = 5;
						}
					...
					case 0x00000005:
						if (Function_144("$/cutscene/mckenna_2_b_cs/mckenna_2_b_cs", &iLocal_248, 37530, 31680, 35480, 29229, 35193, 29222, 1, 1, 2, 2, 0))
						{
							Function_129(1.0f);
							iVar0 = 6;
						}
					...
					case 0x00000006:
						if (!HUD_IS_FADING() && !HUD_IS_FADED())
						{
							...
							SET_RCM_ACTOR_CALL_OVER_ENABLE(bLocal_274, 1, 1, true, 1, 0, 2, 1101004800, 1088421888, 1);
							TASK_PRIORITY_SET(bLocal_274, 2);
							Function_116("Mackenna_END", 7.5f, 0, 2, 0, 0, 0, 0);
							Function_115(407, 1, 0, 0);
							Function_62(1, 1, 1, 0);
							Function_12();
							Function_9(&iLocal_292);
							Function_9(&iLocal_289);
							iVar0 = 13;
						}
						break;
					
					case 0x0000000D:
						if (Function_4(&iLocal_289, 3.0f))
						{
							if (IS_ACTOR_VALID(bLocal_273))
							{
								TASK_CLEAR(bLocal_273);
								DECOR_SET_BOOL(bLocal_273, "Done_Eating", true);
								TASK_MELEE_ATTACK(bLocal_273, Global_34573, -1.0f);
							}
							if (IS_ACTOR_VALID(bLocal_275))
							{
								TASK_CLEAR(bLocal_275);
								DECOR_SET_BOOL(bLocal_275, "Done_Eating", true);
								TASK_PRIORITY_SET(bLocal_275, 1);
							}
						}
						if (Function_4(&iLocal_292, 12.0f))
						{
							if (IS_ACTOR_VALID(bLocal_274))
							{
...
void Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0xB28 / 2856
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_2() //Position: 0xCD8 / 3288
{
	return 0.0f, 0.0f, 0.0f;
}

var Function_3() //Position: 0xCE1 / 3297
{
	int iVar0;
...
bool Function_4(int iParam0, int iParam1) //Position: 0xCE9 / 3305
{
...
void Function_5(int iParam0) //Position: 0xD01 / 3329
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_6(bool bParam0, float fParam1) //Position: 0xD15 / 3349
{
...
bool Function_7(int iParam0) //Position: 0xD31 / 3377
{
	return Function_8(*iParam0, 1);
}

bool Function_8(bool bParam0, int iParam1) //Position: 0xD3E / 3390
{
	return (bParam0 && iParam1) == 0;
}

void Function_9(int iParam0) //Position: 0xD4B / 3403
{
...
void Function_10(var uParam0, float fParam1) //Position: 0xD60 / 3424
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_198(uParam0, 1);
	Function_11(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

void Function_11(var uParam0, int iParam1) //Position: 0xD81 / 3457
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_12() //Position: 0xD94 / 3476
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0xDC5 / 3525
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_8(Global_63541[iVar155].f_144, 2048))
				{
					iVar3 = iVar1;
					if (Function_27(&(Global_63541[iVar155]), iVar3))
					{
						Function_198(&Global_63541[iVar155] + 144, 64);
						...
						if (IS_OBJECT_VALID(Global_63541[iVar155].f_192))
						{
							...
							Function_14(&(Global_63541[iVar155]), 7);
						}
					}
				}
...
void Function_14(int iParam0, int iParam1) //Position: 0xF67 / 3943
{
	float fVar0;
	bool bVar1;
	...
	if ((((Function_8(iParam0->f_144, 2048) || Global_3380) || Global_3382) || Global_3392) || Global_34165.f_28)
	{
		return;
	}
	fVar0 = iParam0->f_96;
...
void Function_15(int iParam0) //Position: 0x1021 / 4129
{
	float fVar0;
	bool bVar1;
...
int Function_16(var uParam0, int iParam1) //Position: 0x10C3 / 4291
{
	int iVar0;
	var uVar1;
...
void Function_17(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x1224 / 4644
{
	struct<8> Var0;
...
struct<32> Function_18(bool bParam0) //Position: 0x12BF / 4799
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_19(char* cParam0, char* cParam1, char* cParam2) //Position: 0x1329 / 4905
{
	char* cVar0[32];
...
int Function_20(bool bParam0) //Position: 0x1348 / 4936
{
	int iVar0;
	vector3 vVar1;
		...
		if (IS_VOLUME_VALID(StackVal))
		{
			if (DECOR_CHECK_EXIST(StackVal, "script"))
			{
				if (!IS_SCRIPT_VALID(DECOR_GET_INT(StackVal, "script")))
				{
					...
					{
						if (Function_190(StackVal, StackVal, Global_34573, vVar1) < 25.0f)
						{
							Function_21(iVar0);
						}
					}
					else if (Function_190(StackVal, StackVal, Global_34573, vVar1) < 55.0f)
					{
						Function_21(iVar0);
					}
				}
...
void Function_21(int iParam0) //Position: 0x14A9 / 5289
{
...
bool Function_22(int iParam0) //Position: 0x150A / 5386
{
...
void Function_23(int iParam0, int iParam1) //Position: 0x1520 / 5408
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_191(StackVal, Function_26(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_25(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_8(Global_63541[iParam155].f_144, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(iParam0->f_212))
		{
			...
			if (Function_8(Global_74542[iParam110].f_24, 1))
			{
				SET_BLIP_COLOR(iParam0->f_188, 0.63f, 0.85f, 0.0f, 0.5f);
				if (Global_29006 != Global_63541[iParam155].f_132 && !Function_24())
				{
...
bool Function_24() //Position: 0x19B2 / 6578
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_25(int iParam0) //Position: 0x19DF / 6623
{
...
bool Function_26(int iParam0) //Position: 0x1A0B / 6667
{
...
bool Function_27(int iParam0, int iParam1) //Position: 0x1A20 / 6688
{
	if (Function_8(Global_63541[iParam155].f_144, 64))
	{
		return 1;
	}
	if (Function_26(iParam1))
	{
		Function_198(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
...
bool Function_28(int iParam0, int iParam1) //Position: 0x1B35 / 6965
{
	int iVar0;
...
bool Function_29(int iParam0) //Position: 0x1C79 / 7289
{
...
bool Function_30(int iParam0) //Position: 0x1C9D / 7325
{
...
bool Function_31(int iParam0) //Position: 0x1CB2 / 7346
{
...
var Function_32(int iParam0) //Position: 0x1CC9 / 7369
{
...
bool Function_33(int iParam0) //Position: 0x1CE3 / 7395
{
...
bool Function_34(int iParam0) //Position: 0x1CF9 / 7417
{
	return StackVal;
}

bool Function_35(var uParam0, int iParam1) //Position: 0x1D09 / 7433
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0x1D25 / 7461
{
	if (!iParam0->f_152)
	{
		if (Function_37())
...
bool Function_37() //Position: 0x1DC9 / 7625
{
...
bool Function_38(int iParam0) //Position: 0x1DE4 / 7652
{
	if (!Function_45(1048576) || Global_3381)
	{
		return 1;
	}
	if (!Function_8(Global_63541[iParam055].f_144, 32768))
	{
...
void Function_39(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1E3D / 7741
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0, int iParam1) //Position: 0x1EA9 / 7849
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(bool bParam0, var uParam1, int iParam2) //Position: 0x1EE0 / 7904
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x1F58 / 8024
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x1FF9 / 8185
{
	int iVar0;
	int iVar1;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x2036 / 8246
{
...
bool Function_45(int iParam0) //Position: 0x2049 / 8265
{
	int iVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x2065 / 8293
{
	int iVar0;
...
int Function_47(int iParam0) //Position: 0x2081 / 8321
{
...
bool Function_48(int iParam0) //Position: 0x2096 / 8342
{
...
int Function_49(int iParam0) //Position: 0x20AB / 8363
{
...
void Function_50() //Position: 0x20C0 / 8384
{
...
var Function_51(int iParam0, int iParam1) //Position: 0x213B / 8507
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_128(6, 0) && Function_48(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_128(9, 0) && Function_48(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
bool Function_52(vector3 vParam0) //Position: 0x2D2C / 11564
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_53(int iParam0) //Position: 0x2D44 / 11588
{
	int iVar0;
	int iVar1;
...
bool Function_54(int iParam0) //Position: 0x2D93 / 11667
{
...
int Function_55(int iParam0) //Position: 0x2DA9 / 11689
{
...
void Function_56() //Position: 0x2E12 / 11794
{
...
bool Function_57(int iParam0) //Position: 0x2E35 / 11829
{
	if (!Function_54(iParam0))
	{
...
bool Function_58(int iParam0, int iParam1) //Position: 0x2E86 / 11910
{
	int iVar0;
...
bool Function_59(int iParam0) //Position: 0x2EB3 / 11955
{
	if (!Function_54(iParam0))
	{
...
bool Function_60() //Position: 0x2F05 / 12037
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_61(int iParam0) //Position: 0x2F0E / 12046
{
	int iVar0;
...
void Function_62(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2F48 / 12104
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_11(&Global_63541[iParam055] + 144, 64);
	...
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_63541[iParam055].f_140, 0))
	{
		Function_13(Global_63541[iParam055].f_140);
	}
...
void Function_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3377 / 13175
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_64() //Position: 0x34EA / 13546
{
	return;
}

void Function_65(bool bParam0, int iParam1) //Position: 0x34F0 / 13552
{
	if (Global_3381)
	{
		return;
...
void Function_66(bool bParam0) //Position: 0x3532 / 13618
{
...
void Function_67() //Position: 0x3583 / 13699
{
	Function_94();
	Function_93();
	Function_93();
...
void Function_68() //Position: 0x35D5 / 13781
{
...
void Function_69() //Position: 0x36DB / 14043
{
	float fVar0;
...
void Function_70() //Position: 0x370E / 14094
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x389C / 14492
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x3A50 / 14928
{
	Function_73(&Global_28260, 1, 0);
	return;
}

void Function_73(int iParam0, bool bParam1, var uParam2) //Position: 0x3A5E / 14942
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_74() //Position: 0x3C4F / 15439
{
...
struct<8> Function_75(int iParam0) //Position: 0x3C64 / 15460
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_76(int iParam0, bool bParam1, bool bParam2) //Position: 0x3D0A / 15626
{
	int iVar0;
...
void Function_77(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x3FA5 / 16293
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_78(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_3(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_78(int iParam0) //Position: 0x45D3 / 17875
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_79(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x45E4 / 17892
{
	char* cVar0[32];
...
struct<32> Function_80(char* cParam0, bool bParam1) //Position: 0x46D9 / 18137
{
	char* cVar0[32];
...
void Function_81(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x46F2 / 18162
{
	float fVar0;
...
var Function_82(int iParam0, int iParam1) //Position: 0x4757 / 18263
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_83(int iParam0, bool bParam1) //Position: 0x4769 / 18281
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_84(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x477B / 18299
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_85(int iParam0) //Position: 0x48AB / 18603
{
	return Global_35278[iParam020].f_48;
}

float Function_86(int iParam0) //Position: 0x48BA / 18618
{
	if (!iParam0 != 4294967295)
	{
...
var Function_87(int iParam0) //Position: 0x48F3 / 18675
{
	if (iParam0 == 4294967295)
	{
...
void Function_88(int iParam0) //Position: 0x4930 / 18736
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x4ACA / 19146
{
	int iVar0;
	int iVar1;
...
int Function_90(bool bParam0) //Position: 0x4D0E / 19726
{
...
struct<8> Function_91() //Position: 0x4D4F / 19791
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_92() //Position: 0x4DD8 / 19928
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x4E6F / 20079
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_94() //Position: 0x4EEE / 20206
{
...
int Function_95(int iParam0, bool bParam1, int iParam2) //Position: 0x4F27 / 20263
{
	int iVar0;
	int iVar1;
...
void Function_96() //Position: 0x5131 / 20785
{
	vector3 vVar0;
	var uVar3;
	...
	if (Function_37())
	{
		Function_101(&Global_34165 + 12, &Global_34165 + 16);
		vVar0 = { StackVal, StackVal, Function_101(&Global_34165 + 12, &Global_34165 + 16) };
	}
	else
	{
...
vector3 Function_97(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x51EC / 20972
{
	int iVar0;
...
bool Function_98(int iParam0) //Position: 0x52D3 / 21203
{
...
int Function_99(bool bParam0, bool bParam1) //Position: 0x52E9 / 21225
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_100(vector3 vParam0, vector3 vParam3) //Position: 0x53B0 / 21424
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_101(var uParam0, int iParam1) //Position: 0x53CD / 21453
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	*uParam0 = *uParam0;
	...
	if (!Function_102(Global_30640[0]))
	{
	...
	if (!Function_102(Global_30640[2]))
	{
	...
	if (!Function_102(Global_30640[1]))
	{
	...
	if (!Function_102(Global_30658[1]))
	{
	...
	if (!Function_102(Global_30658[3]))
	{
	...
	if (!Function_102(Global_30658[2]))
	{
	...
	if (!Function_102(Global_30658[4]))
	{
	...
	if (!Function_102(Global_30668[0]))
	{
	...
	if (!Function_102(Global_30668[1]))
	{
	...
	if (!Function_102(Global_30668[2]))
	{
		GET_VOLUME_CENTER(StackVal, &vVar7);
		bVar10 = VDIST(vVar4, vVar7);
		if (bVar10 > bVar0)
	...
	if (!Function_102(Global_30679[0]))
	{
	...
	if (!Function_102(Global_30685[0]))
	{
	...
	if (!Function_102(Global_30685[1]))
	{
	...
	if (!Function_102(Global_30685[2]))
	{
	...
	if (!Function_102(Global_30693[0]))
	{
	...
	if (!Function_102(Global_30693[1]))
	{
	...
	if (!Function_102(Global_30693[2]))
	{
	...
	if (!Function_102(Global_30707[2]))
	{
	...
	if (!Function_102(Global_30707[3]))
	{
	...
	if (!Function_102(Global_30707[0]))
	{
	...
	if (!Function_102(Global_30723[2]))
	{
	...
	if (!Function_102(Global_30723[1]))
	{
	...
	if (!Function_102(Global_30723[0]))
	{
	...
	if (!Function_102(Global_30679[1]))
	{
	...
	if (!Function_102(Global_30707[1]))
	{
...
bool Function_102(int iParam0) //Position: 0x5BF2 / 23538
{
	var uVar0;
...
void Function_103(bool bParam0, bool bParam1) //Position: 0x5C2D / 23597
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_104(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x5C3A / 23610
{
	iParam0 = iParam0;
...
void Function_105(int iParam0) //Position: 0x5CDE / 23774
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_128(1, 0))
	{
		Function_111("ZOMBIE_STORY_1_OBJ");
		if (!Function_48(2))
		{
			bVar0 = "ZOMBIE_STORY_1_SHORT";
		}
	}
	if (Function_48(4) && !Function_109(0))
	{
		bVar0 = "ZOMBIE_STORY_1a_SHORT";
	}
	if (Function_48(5))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_1_OBJ", 4, 0);
		Function_111("ZOMBIE_STORY_2Nigel_OBJ");
		Function_111("ZOMBIE_STORY_2Seth_OBJ");
	...
	if (Function_48(6))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_2Seth_OBJ", 4, 0);
		if (!Function_48(8))
		{
	...
	if (Function_48(8))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_2Nigel_OBJ", 4, 0);
		if (!Function_48(6))
		{
	...
	{
		Function_111("ZOMBIE_STORY_3_OBJ");
		if (!Function_128(2, 0))
		{
	...
	if (Function_128(2, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_3_OBJ", 4, 0);
		Function_111("ZOMBIE_STORY_4_OBJ");
		if (!Function_48(24))
		{
	...
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_4_OBJ", 4, 0);
		Function_111("ZOMBIE_STORY_5_OBJ");
		if (!Function_128(3, 0))
		{
	...
	if (Function_128(3, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_107(), "ZOMBIE_STORY_5_OBJ", 4, 0);
	}
	if (!Function_48(5))
	{
		...
		if (Function_48(4))
		{
			...
			stradd(&cVar2, I2STR(Function_106(Global_30734)), 64);
			APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[455].f_140, "blackwater3_OBJ", 0, 3, !bVar1);
			if (Function_106(Global_30734) >= 0)
			{
	...
	if (!Function_48(7))
	{
		...
		if (((Function_48(6) && Function_106(Global_30735) < 0) && Function_106(Global_30737) < 0) && Function_106(Global_30738) < 0)
		{
	...
	{
		Function_116(bVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_106(int iParam0) //Position: 0x65D3 / 26067
{
	if (!Function_31(iParam0))
	{
		return 4294967295;
...
var Function_107() //Position: 0x65ED / 26093
{
	return STRING_TO_HASH(Function_108());
}

var Function_108() //Position: 0x65F9 / 26105
{
	return "ZOMBIE_STORY";
}

bool Function_109(int iParam0) //Position: 0x660E / 26126
{
	...
	return Global_13172[Function_110(iParam0)11].f_12 < 0;
}

int Function_110(int iParam0) //Position: 0x6674 / 26228
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_111(char* cParam0) //Position: 0x6736 / 26422
{
	if (!IS_JOURNAL_ENTRY_IN_LIST(Function_107(), 0))
	{
		CREATE_JOURNAL_ENTRY(Function_108(), 2, 38, "Mission_Strangers");
		PREPEND_JOURNAL_ENTRY(Function_107(), false);
	}
	APPEND_JOURNAL_ENTRY_DETAIL(Function_107(), cParam0, 0, 3, false);
	Function_112(Function_107(), 0);
	return;
}

void Function_112(char* cParam0, bool bParam1) //Position: 0x677E / 26494
{
	bool bVar0;
...
void Function_113() //Position: 0x67A3 / 26531
{
	bool bVar0;
...
void Function_114(bool bParam0) //Position: 0x6801 / 26625
{
	PRINTSTRING("Day ");
...
int Function_115(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6847 / 26695
{
	int iVar0;
	int iVar1;
...
void Function_116(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6A67 / 27239
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_117(int iParam0) //Position: 0x6AEC / 27372
{
	char* cVar0[16];
...
void Function_118(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x6B2B / 27435
{
	char* cVar0[32];
	struct<8> Var8;
	...
	if (!Function_58(bParam0, 2))
	{
		...
		if (!bParam2)
		{
			...
			stradd(&Var8, "_tip", 32);
			Function_187(&Var8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_125(bParam0, bParam1))
	{
		...
		if (StackVal && !Function_8(((((!Function_24() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, false, false, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_8((((Function_24() || Global_3380) || Global_3392) || Global_3384), 1))
		{
...
void Function_119(int iParam0, bool bParam1) //Position: 0x6DC1 / 28097
{
	bool bVar0;
...
void Function_120(int iParam0, bool bParam1) //Position: 0x6E28 / 28200
{
...
void Function_121(bool bParam0) //Position: 0x6E93 / 28307
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (Global_27774[bParam013].f_48 == 4294967295 && Global_27774[bParam013].f_48 == 0)
	{
		...
		Function_112(Global_27774[bParam013].f_48, 0);
...
int Function_122(int iParam0) //Position: 0x7043 / 28739
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_123(int iParam0) //Position: 0x709A / 28826
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_124(bool bParam0) //Position: 0x70F0 / 28912
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_125(bool bParam0, int iParam1) //Position: 0x70FC / 28924
{
	int iVar0;
...
void Function_126(int iParam0, int iParam1) //Position: 0x715B / 29019
{
	if (!Function_54(iParam0))
	{
...
bool Function_127(int iParam0) //Position: 0x71B0 / 29104
{
...
bool Function_128(int iParam0, bool bParam1) //Position: 0x71CC / 29132
{
	int iVar0;
...
void Function_129(bool bParam0) //Position: 0x7209 / 29193
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x7226 / 29222
{
	return 1;
}

int Function_131() //Position: 0x722D / 29229
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -3184.228f, 41.436f, 3724.614f, 119.401f, 1, true, 1);
	FREE_FROM_HOGTIE(bLocal_273);
	SET_MOVER_FROZEN(bLocal_273, 0);
	FREE_FROM_HOGTIE(bLocal_275);
	bLocal_281 = CREATE_GRINGO_IN_LAYOUT(bLocal_256, "eatingGringo1", "$/content/DLC/ZombiePack/Gringos/DLC_eating_dynamic", -3181.836f, 41.628f, 3730.043f, 0.0f, 205.385f, 0.0f);
	bLocal_282 = CREATE_GRINGO_IN_LAYOUT(bLocal_256, "eatingGringo2", "$/content/DLC/ZombiePack/Gringos/DLC_eating_dynamic", -3181.768f, 41.635f, 3731.078f, 0.0f, 299.494f, 0.0f);
	SNAP_ACTOR_TO_GRINGO(bLocal_273, bLocal_281, "UseCase1", 1, 0, 0);
	SNAP_ACTOR_TO_GRINGO(bLocal_275, bLocal_282, "UseCase1", 1, 0, 0);
	TASK_USE_GRINGO(bLocal_273, GET_GRINGO_FROM_OBJECT(bLocal_281), "UseCase1", 4294967295, 1);
	TASK_USE_GRINGO(bLocal_275, GET_GRINGO_FROM_OBJECT(bLocal_282), "UseCase1", 4294967295, 1);
	TASK_PRIORITY_SET(bLocal_273, 0);
	TASK_PRIORITY_SET(bLocal_275, 0);
	GIVE_WEAPON_TO_ACTOR(bLocal_275, 32, 0.0f, 0, 1);
	GIVE_OBJECT_TO_LAYOUT(bLocal_281, Global_30616);
	GIVE_OBJECT_TO_LAYOUT(bLocal_282, Global_30616);
	if (!IS_OBJECT_VALID(bLocal_280))
	{
		bLocal_280 = CREATE_PROP_IN_LAYOUT(bLocal_256, "RCM_Mackenna Chair", "$/fragments/p_gen_chair04x", -3183.169f, 41.44f, 3724.295f, 0.0f, -51.844f, 0.0f, 1);
	}
	SET_DRAW_OBJECT(bLocal_280, 1);
	SET_DRAW_OBJECT(bLocal_279, 1);
	ACTOR_RESET_ANIMS(Global_34573, 1);
	Function_133(bLocal_274, 1254, 4294967295, 4294967295, 4294967295, 0, 1, 1);
	SET_ACTION_NODE_FOR_ACTOR(bLocal_274, "zombie/PlayDead/Variant1/PlayDeadLoop");
	Function_132(bLocal_274);
	CREATE_DECAL(0, Function_132(bLocal_274), 0.75f, 1, 0);
	return 1;
}

vector3 Function_132(bool bParam0) //Position: 0x747E / 29822
{
	vector3 vVar0;
...
void Function_133(bool bParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x748F / 29839
{
	int iVar0;
	
	if (Function_139(bParam0) && !Function_138(bParam0, 1))
	{
	...
	Function_134(bParam0, uParam4, uParam5);
}

void Function_134(bool bParam0, bool bParam1, bool bParam2) //Position: 0x76F2 / 30450
{
	switch (bParam1)
	{
		case 0x00000000:
...
void Function_135(bool bParam0) //Position: 0x77A4 / 30628
{
	if (!IS_OBJECT_VALID(bParam0))
	{
		return;
...
void Function_136(bool bParam0) //Position: 0x77D8 / 30680
{
...
bool Function_138(bool bParam0, int iParam1) //Position: 0x7B5E / 31582
{
	bool bVar0;
...
int Function_139(bool bParam0) //Position: 0x7BA0 / 31648
{
	bool bVar0;
...
int Function_140() //Position: 0x7BC0 / 31680
{
	return 1;
}

float Function_141(bool bParam0) //Position: 0x7BC7 / 31687
{
	if (Function_7(bParam0))
	{
...
bool Function_142(int iParam0) //Position: 0x7C8F / 31887
{
	return Function_8(*iParam0, 2);
}

void Function_143(bool bParam0) //Position: 0x7C9C / 31900
{
	Function_10(bParam0, 0.0f);
	return;
}

bool Function_144(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) //Position: 0x7CA8 / 31912
{
	var uVar0;
	var uVar7;
	bool bVar8;
	...
	bVar8 = Function_145(uParam0, iParam1, &uVar0, &uVar7, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 0, iParam8, iParam9, iParam10, iParam11, iParam12, 1);
	if (bVar8)
	{
...
int Function_145(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x7D51 / 32081
{
	if (!bParam15)
	{
	...
	{
		case 0x000003E8:
			if (*uParam3 != 99 && (Function_154(iParam2) || iParam2->f_24 < 1))
			{
				*iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), bParam0) || !Function_153())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_141(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_150(Global_63117, Global_6289);
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && *uParam3 == 99) && !Function_154(iParam2))
			{
...
void Function_146(bool bParam0) //Position: 0x8366 / 33638
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_147() //Position: 0x8415 / 33813
{
	bool bVar0;
...
void Function_148() //Position: 0x8487 / 33927
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_149() //Position: 0x84CC / 33996
{
...
void Function_150(bool bParam0, bool bParam1) //Position: 0x84DE / 34014
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(bVar0))
	{
		...
		if (IS_OBJECT_VALID(bVar2))
		{
			...
			if ((bVar3 == Global_34573 && !Function_151(bVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(bVar3))
			{
...
bool Function_151(bool bParam0) //Position: 0x855E / 34142
{
	int iVar0;
...
int Function_152(bool bParam0) //Position: 0x858D / 34189
{
	int iVar0;
	bool bVar1;
...
bool Function_153() //Position: 0x8645 / 34373
{
	int iVar0;
	bool bVar1;
...
bool Function_154(int iParam0) //Position: 0x867F / 34431
{
	return iParam0->f_20;
}

void Function_155(var uParam0, int iParam1) //Position: 0x8689 / 34441
{
	Function_156(uParam0, iParam1, 0);
	return;
}

void Function_156(var uParam0, bool bParam1, bool bParam2) //Position: 0x8697 / 34455
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_157(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x87E3 / 34787
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_158() //Position: 0x880C / 34828
{
	bool bVar0;
	bool bVar1;
...
void Function_159() //Position: 0x8857 / 34903
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_160() //Position: 0x8979 / 35193
{
	Function_161(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_309);
	return 1;
}

void Function_161(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x8993 / 35219
{
	bool bVar0;
	...
	Function_146(bParam9);
}

void Function_162() //Position: 0x8A83 / 35459
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_163() //Position: 0x8A98 / 35480
{
	if (!iLocal_308)
	{
		Function_167(StackVal, StackVal, vLocal_284, bLocal_309);
		Function_164();
		SET_DRAW_OBJECT(bLocal_279, 0);
...
void Function_164() //Position: 0x8AC6 / 35526
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
...
void Function_165(char* cParam0, vector3 vParam1) //Position: 0x8B5C / 35676
{
	char* cVar0[64];
...
void Function_166(char* cParam0, vector3 vParam1, vector3 vParam10) //Position: 0x8C84 / 35972
{
	char* cVar0[64];
...
void Function_167(vector3 vParam0) //Position: 0x8DEF / 36335
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!Function_52(StackVal, StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			else if (Function_168(bVar1, Global_34573) > 4.0f)
			{
				TELEPORT_ACTOR(bVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1.5f);
				vVar3.f_8 = (vParam0.z + 1.5f);
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (bVar0 != bVar1)
			{
				...
				else if (Function_168(bVar0, Global_34573) > 4.0f)
				{
					TELEPORT_ACTOR(bVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2.5f);
					vVar3.f_8 = (vParam0.z + 2.5f);
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			...
			else if (Function_168(bVar2, Global_34573) > 8.0f)
			{
				TELEPORT_ACTOR(bVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_168(bool bParam0, bool bParam1) //Position: 0x8F75 / 36725
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_169(bool bParam0, float fParam1) //Position: 0x9066 / 36966
{
...
void Function_170() //Position: 0x9164 / 37220
{
...
void Function_171() //Position: 0x9196 / 37270
{
...
int Function_172() //Position: 0x9293 / 37523
{
	return 1;
}

int Function_173() //Position: 0x929A / 37530
{
	bLocal_309 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "tempcutscenevol", 2, *(&Global_63541[155] + 100), 0.0f, 0.0f, 0.0f, 5.0f, 5.0f, 5.0f);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Toxic_06", bLocal_275);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_02", bLocal_273);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	Function_176(0, 0, 1, 1, 0, 1, 1, bLocal_309, 1, 1, 1, 0);
	Function_174(StackVal, StackVal, bLocal_256, *(&Global_63541[155] + 112), &bLocal_309, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_174(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x934D / 37709
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_175(bool bParam0, bool bParam1) //Position: 0x95BB / 38331
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_176(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x9630 / 38448
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_132(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_3(), 2, Function_132(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_178()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_177(bool bParam0) //Position: 0x98DE / 39134
{
	bool bVar0;
	
	if (Function_8(bParam0, 1) && Function_8(Global_26119, 1))
	{
	}
...
var Function_178() //Position: 0x9912 / 39186
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_179() //Position: 0x9991 / 39313
{
	if (IS_ACTOR_VALID(bLocal_273))
	{
		if (!IS_ACTOR_HOGTIED(bLocal_273))
...
int Function_180(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) //Position: 0x99AD / 39341
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_182(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_182(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
...
float Function_181(float fParam0) //Position: 0x9B1D / 39709
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_181(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_182(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x9B52 / 39762
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_184(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_186()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
	...
	else if ((!Function_184(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_186()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_184(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_183() //Position: 0x9D98 / 40344
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
...
bool Function_184(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x9DEC / 40428
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_185(bParam0);
		if (VDIST(Function_185(bParam0), vParam1) >= fParam4)
		{
			return 1;
		}
	}
...
vector3 Function_185(bool bParam0) //Position: 0x9E76 / 40566
{
	vector3 vVar0;
...
int Function_186() //Position: 0x9EE0 / 40672
{
	if (IS_PS3())
	{
		return 1;
...
void Function_187(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x9EEF / 40687
{
	struct<4> Var0;
	int iVar4;
...
bool Function_188(int iParam0) //Position: 0x9F6A / 40810
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		bVar2 = GET_MOUNT(Global_34573);
		bVar0 = GET_ATTACHED_HOGTIE_VICTIM(bVar2);
	}
	else if (IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(Global_34573)))
	{
		bVar0 = GET_ATTACHED_HOGTIE_VICTIM(Global_34573);
	}
	bVar3 = CREATE_OBJECTSET_IN_LAYOUT("searchObjset", bLocal_256, 15, 0);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "nsearchVol", 2, *(&Global_63541[055] + 100), 0.0f, 0.0f, 0.0f, 10.0f, 10.0f, 10.0f);
	LOCATE_ACTORS_IN_VOLUME(bVar4, bVar3, 0, 1);
	if (IS_OBJECTSET_VALID(bVar3))
	{
		bVar5 = false;
		while (bVar5 < (GET_OBJECTSET_SIZE(bVar3) - 1))
		{
			if (!bVar1)
			{
				bVar6 = GET_INDEXED_OBJECT_IN_OBJECTSET(bVar5, bVar3);
				if (Function_189(GET_ACTOR_FROM_OBJECT(bVar6)))
				{
					bVar0 = GET_ACTOR_FROM_OBJECT(bVar6);
					bVar1 = true;
				}
			}
			bVar5++;
	...
	DISBAND_OBJECTSET(bVar3);
	DESTROY_OBJECTSET(bVar3);
	DESTROY_VOLUME(bVar4);
	if (IS_ACTOR_VALID(bVar0))
	{
		if (Function_189(bVar0) && IS_ACTOR_HOGTIED(bVar0))
		{
			*iParam0 = bVar0;
			return 1;
		}
...
bool Function_189(bool bParam0) //Position: 0xA083 / 41091
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (STRING_CONTAINS_STRING(GET_ACTOR_ENUM_STRING(bParam0), "toxic"))
		{
			return 1;
		}
	}
...
float Function_190(bool bParam0, vector3 vParam1) //Position: 0xA0E8 / 41192
{
	vector3 vVar0;
	...
	{
		Function_185(bParam0);
		vVar0 = { StackVal, StackVal, Function_185(bParam0) };
...
int Function_191(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0xA162 / 41314
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_192() //Position: 0xA17E / 41342
{
	if (IS_ACTOR_VALID(bLocal_275))
	{
		DECOR_SET_BOOL(bLocal_275, "CanBeLasso", true);
	}
	Function_194(&bLocal_257);
	if (IS_LAYOUTREF_VALID(bLocal_256))
	{
	...
	if (IS_ACTOR_VALID(bLocal_274))
	{
		REMOVE_ACTOR_STAY_WITHIN_VOLUME(bLocal_274, bLocal_277);
		SET_MOVER_FROZEN(bLocal_274, 0);
	}
	Function_193(0, 0, 1);
	return;
...
int Function_193(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA1D7 / 41431
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_194(int iParam0) //Position: 0xA206 / 41478
{
	int iVar0;
...
void Function_195(var uParam0, int iParam1) //Position: 0xA22C / 41516
{
	if (Function_197(uParam0[iParam13], 4))
	{
		if (Function_197(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_196(uParam0[iParam13], 1);
			Function_196(uParam0[iParam13], 2);
			Function_196(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_196(var uParam0, int iParam1) //Position: 0xA35A / 41818
{
	int iVar0;
...
bool Function_197(var uParam0, int iParam1) //Position: 0xA374 / 41844
{
	int iVar0;
...
void Function_198(var uParam0, int iParam1) //Position: 0xA391 / 41873
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_199(int iParam0) //Position: 0xA3A0 / 41888
{
	int iVar0;
	int iVar1;
	...
	Function_203();
	iVar1 = 0;
	if (!Function_197(iParam0[iVar03], 16))
	{
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_197(iParam0[iVar03], 4))
		{
			if (!Function_197(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP((*iParam0)[iVar03], (Function_197(iParam0[03], 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_197(iParam0[03], 8) || iVar1));
						break;
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_197(iParam0[iVar03], 4))
		{
			if (!Function_197(iParam0[iVar03], 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_200() //Position: 0xA71B / 42779
{
	if (!Function_45(128))
	{
		return;
...
bool Function_201() //Position: 0xA75B / 42843
{
	int iVar0;
...
void Function_202(var uParam0, int iParam1) //Position: 0xA786 / 42886
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_203() //Position: 0xA797 / 42903
{
	if (!Function_45(128))
	{
		return;
...
void Function_204(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4) //Position: 0xA7D9 / 42969
{
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		if (((!IS_SCRIPTED_SPEECH_PLAYING(bParam0) && (MEMORY_GET_IS_VISIBLE(bParam0, Global_34573) || Function_205(bParam0, 0x3f800000, 0x42960000, 1, 1, 0))) && Function_168(Global_34573, bParam0) > 35.0f) && !Global_63096)
		{
...
var Function_205(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xA85E / 43102
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

void Function_206() //Position: 0xA878 / 43128
{
	switch (iLocal_298)
	{
		case 0x00000000:
...
void Function_207() //Position: 0xA8FA / 43258
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AF", "RCMMac_talkPacePre2_v1_AF", 0, 1, 1, 0, 1);
		Function_208(3);
...
void Function_208(bool bParam0) //Position: 0xA955 / 43349
{
	Function_209(0, Global_34573, bParam0, 0);
	Function_209(1, bLocal_274, bParam0, 0);
	return;
}

void Function_209(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0xA96F / 43375
{
	bool bVar0;
...
void Function_210() //Position: 0xA994 / 43412
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AE", "RCMMac_talkPacePre2_v1_AE", 0, 1, 1, 0, 1);
		Function_208(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_211() //Position: 0xA9EF / 43503
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AD", "RCMMac_talkPacePre2_v1_AD", 0, 1, 1, 0, 1);
		Function_208(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_212() //Position: 0xAA4A / 43594
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AC", "RCMMac_talkPacePre2_v1_AC", 0, 1, 1, 0, 1);
		Function_208(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_213() //Position: 0xAAA5 / 43685
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AB", "RCMMac_talkPacePre2_v1_AB", 0, 1, 1, 0, 1);
		Function_208(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_214() //Position: 0xAB00 / 43776
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(1, "RCMMac_talkPacePre2_v1_AA", "RCMMac_talkPacePre2_v1_AA", 0, 1, 1, 0, 1);
		Function_208(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_215() //Position: 0xAB5B / 43867
{
	Function_216(1, 1);
	Function_198(&Global_63541[155] + 144, 128);
	ACTOR_DATA_GRAVITY_LIMIT(0);
	Function_192();
	TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
	return;
...
void Function_216(int iParam0, bool bParam1) //Position: 0xAB80 / 43904
{
	char* cVar0[32];
	...
	{
		Function_39(Global_34573, 8192, 1, 0);
	}
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_63541[iParam055].f_140, 0))
	{
...
int Function_217() //Position: 0xAD00 / 44288
{
	if (IS_ACTOR_VALID(bLocal_274))
	{
	...
	if (IS_ACTOR_VALID(bLocal_273))
	{
		if (GET_LAST_ATTACKER(bLocal_273) == Global_34573)
		{
			return 1;
		}
	}
...
var Function_218(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0xAD35 / 44341
{
	int iVar0;
	...
	{
		if (!Function_197(uParam0[iVar03], 4))
		{
...
var Function_219(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xAE05 / 44549
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_220(uParam0, iVar1, iParam2);
	if (bParam3)
	{
		Function_202(uParam0[iVar03], 8);
	}
...
var Function_220(var uParam0, int iParam1, int iParam2) //Position: 0xAE3D / 44605
{
	int iVar0;
