...
void main() //Position: 0x0 / 0
{
	...
	bVar3 = FIND_NAMED_LAYOUT("RidgewoodFarm_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "rwfv_zombies_01");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar1, 1, 4, 0, 0, 1);
		}
		else
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "rwfv_zombies_02");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar1, 1, 3, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar0, 5, 7, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("RWF_POP: Cannot find rwfv_zombies_02 to create population volumes");
...
void Function_1(var uParam0, var uParam1) //Position: 0xE16 / 3606
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xE25 / 3621
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xE7A / 3706
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xEFC / 3836
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xF18 / 3864
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xF56 / 3926
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xF72 / 3954
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xF82 / 3970
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xFFA / 4090
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1066 / 4198
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x10D2 / 4306
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1117 / 4375
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1123 / 4387
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x119F / 4511
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x11AC / 4524
{
	if (!Function_4(128))
	{
		return;
