...
bool Function_46(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2B19 / 11033
{
...
void Function_55(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2E27 / 11815
{
	bool bVar0;
	bool bVar1;
...
void Function_85(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4196 / 16790
{
	bool bVar0;
...
int Function_86(bool bParam0, bool bParam1) //Position: 0x41EA / 16874
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_91(int iParam0, bool bParam1) //Position: 0x439A / 17306
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_99(int iParam0) //Position: 0x46A3 / 18083
{
	bool bVar0;
	int iVar1;
...
var Function_100(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x479D / 18333
{
	int iVar0;
	int iVar1;
...
void Function_101(var uParam0, int iParam1) //Position: 0x47D5 / 18389
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_102(var uParam0, int iParam1, int iParam2) //Position: 0x47E6 / 18406
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x48AA / 18602
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x4C25 / 19493
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x4C65 / 19557
{
	int iVar0;
...
void Function_106() //Position: 0x4C90 / 19600
{
	if (!Function_151(128))
	{
		return;
...
void Function_107(int iParam0, bool bParam1) //Position: 0x4CD2 / 19666
{
	char* cVar0[32];
...
void Function_108(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4D56 / 19798
{
	var uVar0;
	var uVar1;
...
void Function_109(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4D7F / 19839
{
...
var Function_110(var uParam0, bool bParam1) //Position: 0x4DD0 / 19920
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_111() //Position: 0x4DE0 / 19936
{
	return "PackedGrass";
}

var Function_112(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4DF4 / 19956
{
	int iVar0;
...
var Function_113() //Position: 0x4E19 / 19993
{
	return "PackedMetadata";
}

void Function_114(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4E30 / 20016
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_115() //Position: 0x4F5B / 20315
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_116() //Position: 0x4F6C / 20332
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_117() //Position: 0x4F7D / 20349
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_118(var uParam0, int iParam1) //Position: 0x4F8E / 20366
{
...
var Function_119(var uParam0, int iParam1, bool bParam2) //Position: 0x4FB1 / 20401
{
	int iVar0;
...
var Function_120(bool bParam0) //Position: 0x4FD0 / 20432
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_121() //Position: 0x4FDC / 20444
{
	return Function_122(39);
}

int Function_122(bool bParam0) //Position: 0x4FE7 / 20455
{
	bool bVar0;
...
var Function_123() //Position: 0x5015 / 20501
{
	return "PackedWeapon";
}

int Function_124(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x502A / 20522
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_125() //Position: 0x512E / 20782
{
	return "MPItemGiver";
}

struct<32> Function_126(bool bParam0) //Position: 0x5142 / 20802
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_127(char* cParam0, char* cParam1, char* cParam2) //Position: 0x51AC / 20908
{
	char* cVar0[32];
...
var Function_128() //Position: 0x51CB / 20939
{
	return "PBox_";
}

var Function_129() //Position: 0x51D9 / 20953
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_130() //Position: 0x51FF / 20991
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_131() //Position: 0x5227 / 21031
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_132(var uParam0, int iParam1) //Position: 0x524D / 21069
{
	int iVar0;
	var uVar1;
...
void Function_133(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x53AE / 21422
{
	struct<8> Var0;
...
int Function_134(bool bParam0) //Position: 0x5449 / 21577
{
	int iVar0;
	vector3 vVar1;
...
void Function_135(int iParam0) //Position: 0x55AA / 21930
{
...
var Function_136() //Position: 0x560B / 22027
{
	int iVar0;
...
var Function_137(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5613 / 22035
{
	return Function_138(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x562C / 22060
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_139(int iParam0) //Position: 0x591F / 22815
{
	int iVar0;
...
void Function_140() //Position: 0x59D3 / 22995
{
	int iVar0;
...
bool Function_141(bool bParam0) //Position: 0x5A0D / 23053
{
	int iVar0;
...
void Function_142(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5A3A / 23098
{
	bool bVar0;
...
void Function_143() //Position: 0x5B8B / 23435
{
	int iVar0;
...
var Function_144(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5BD6 / 23510
{
	int iVar0;
...
int Function_145() //Position: 0x5CA6 / 23718
{
	int iVar0;
...
bool Function_147(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5F22 / 24354
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_148(var uParam0, int iParam1) //Position: 0x5FF2 / 24562
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_149(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6010 / 24592
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_150(bool bParam0) //Position: 0x6142 / 24898
{
	bool bVar0;
...
bool Function_151(int iParam0) //Position: 0x6161 / 24929
{
	int iVar0;
...
int Function_152() //Position: 0x617D / 24957
{
	if (Function_154())
	{
...
int Function_153() //Position: 0x6196 / 24982
{
	return Global_79349.f_16;
}

bool Function_154() //Position: 0x61A2 / 24994
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_155(int iParam0, bool bParam1, bool bParam2) //Position: 0x61AB / 25003
{
	var uVar0;
