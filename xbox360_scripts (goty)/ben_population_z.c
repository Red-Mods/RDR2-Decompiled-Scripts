...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Ben", 4);
	Function_12("Loading Benedict's Point population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("BenedictPoint_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "benv_region");
	...
	Function_5("Finished loading Benedict's Point population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC0A / 3082
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC19 / 3097
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC6E / 3182
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xCEE / 3310
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD0A / 3338
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD48 / 3400
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD64 / 3428
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xD74 / 3444
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xDB9 / 3513
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xDC5 / 3525
{
	int iVar0;
	int iVar1;
...
var Function_11(int iParam0, int iParam1) //Position: 0xE41 / 3649
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xE4E / 3662
{
	if (!Function_4(128))
	{
		return;
