...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_39 + 1896) = { 564.206f, 92.859f, 1166.414f };
		...
		AUDIO_MUSIC_FORCE_TRACK("TC_NRT_SONG_02", "nIDLE_DARK", 0, 4294967295, 4294967295, 3212836864, 0);
...
void Function_1() //Position: 0x238 / 568
{
	struct<33> Var0;
...
void Function_2(int iParam0, int iParam1) //Position: 0x88C / 2188
{
	INIT_NATIVE_WEAPONENUM_AMMO(iParam0, iParam1);
	return;
}

void Function_3(int iParam0, int iParam1, int iParam2) //Position: 0x899 / 2201
{
	bool bVar0;
...
void Function_4(int iParam0, bool bParam1, bool bParam2) //Position: 0x97F / 2431
{
	int iVar0;
...
void Function_5() //Position: 0xAF8 / 2808
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_6(bool bParam0) //Position: 0xB04 / 2820
{
	PRINTSTRING("Day ");
...
void Function_7(int iParam0) //Position: 0xB4A / 2890
{
	switch (iParam0)
	{
		case 0x00000000:
...
var Function_8() //Position: 0xB90 / 2960
{
...
void Function_9() //Position: 0xBA5 / 2981
{
...
void Function_10() //Position: 0xBD4 / 3028
{
	Function_11();
	return;
}

void Function_11() //Position: 0xBDD / 3037
{
...
void Function_12(int iParam0, bool bParam1, int iParam2) //Position: 0xCE6 / 3302
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_13(var uParam0, int iParam1) //Position: 0xD0E / 3342
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_14(var uParam0, int iParam1) //Position: 0xD21 / 3361
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_15() //Position: 0xD30 / 3376
{
	bool bVar0;
...
var Function_16(bool bParam0) //Position: 0xD49 / 3401
{
	bool bVar0;
...
var Function_17() //Position: 0xD96 / 3478
{
...
void Function_18(int iParam0) //Position: 0xDC5 / 3525
{
	int iVar0;
...
void Function_19(var uParam0, int iParam1) //Position: 0xDEB / 3563
{
...
void Function_20(var uParam0, int iParam1) //Position: 0xF19 / 3865
{
	int iVar0;
...
bool Function_21(var uParam0, int iParam1) //Position: 0xF33 / 3891
{
	int iVar0;
...
void Function_22(int iParam0, int iParam1, int iParam2) //Position: 0xF50 / 3920
{
...
void Function_23(var uParam0, var uParam1, int iParam2) //Position: 0x10E9 / 4329
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_24(bool bParam0, int iParam1, int iParam2) //Position: 0x1261 / 4705
{
	var uVar0;
...
int Function_25(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x1272 / 4722
{
	char* cVar0[32];
...
bool Function_26(bool bParam0, int iParam1, bool bParam2) //Position: 0x12D7 / 4823
{
	char* cVar0[64];
	int iVar16;
...
var Function_27(int iParam0) //Position: 0x1358 / 4952
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_28(bool bParam0) //Position: 0x1671 / 5745
{
	char* cVar0[64];
...
void Function_29(bool bParam0) //Position: 0x1712 / 5906
{
...
void Function_30() //Position: 0x172C / 5932
{
	Function_12(32768, 1, 0);
	return;
}

int Function_31() //Position: 0x173B / 5947
{
	int iVar0;
	int iVar1;
...
void Function_32(var uParam0, bool bParam1) //Position: 0x175E / 5982
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	while (bVar0 <= 4)
	{
		...
		{
			iVar2 = (iVar2 + Function_57(29, bVar0));
			iVar3 = (iVar3 + Function_57(39, bVar0));
			iVar4 = (iVar4 + Function_57(28, bVar0));
			iVar1 = (iVar1 + Function_54(bVar0));
		}
		bVar0++;
	}
	NET_PLAYER_LIST_ADD_ITEM(UI_GET_STRING("coop_total"), Function_53(bParam1));
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, iVar1);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(true, iVar2);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(2, iVar3);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(3, iVar4);
	*uParam0++;
	if (vLocal_516.x <= 2)
	{
		return;
	}
	NET_PLAYER_LIST_ADD_ITEM("", Function_53(bParam1));
	*uParam0++;
	bVar5 = DECOR_GET_INT(Function_16(1), "nLifeBonus");
	UI_SET_STRING("Generic_Dbuffer10_0", I2STR(bVar5));
	Function_52(bParam1, "MP_GY_NDYBonus", 0, 0);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, bVar5 * 500);
	bVar6 = DECOR_GET_INT(Function_16(1), "nWaveBonus");
	UI_SET_STRING("Generic_Dbuffer10_1", I2STR(bVar6));
	Function_52(bParam1, "MP_GY_WaveBonus", 0, 0);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, bVar6 * 1000);
	Function_52(bParam1, "coop_time_spent", 0, 0);
	*uParam0++;
	if (vLocal_516.x <= 3)
	{
		return;
	...
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, bVar11);
	bVar0 = false;
	while (bVar0 <= iVar8)
	{
		if (bVar0 < vLocal_516.z)
		{
			...
			Function_52(bParam1, "", iVar10, 0);
			*uParam0++;
			if (bVar0 > vLocal_516.z || vLocal_516.x <= 6)
			{
				NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, bVar9);
			}
		}
		bVar0++;
	}
	Function_52(bParam1, "COOP_grandTotal", 0, 0);
	*uParam0++;
	Function_37(&bVar9, &iVar7, &uVar21);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(false, I2STR(bVar9));
	switch (iVar7)
	{
		case 0x00000002:
			bVar22 = "COOP_victory_gold";
			break;
		
		case 0x00000001:
			bVar22 = "COOP_victory_Silver";
			break;
		
		case 0x00000000:
			bVar22 = "COOP_victory_Bronze";
			break;
		
		case 0xFFFFFFFF:
		default:
			bVar22 = "coop_nothing_earned";
			break;
	}
	Function_52(bParam1, bVar22, 0, 0);
	*uParam0++;
	if (iVar7 >= 4294967295)
	{
	...
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(false, &cVar12);
	return;
}

void Function_33(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x1A8A / 6794
{
	bool bVar0;
...
var Function_34(var uParam0, int iParam1, int iParam2) //Position: 0x1ADB / 6875
{
	int iVar0;
...
var Function_35(bool bParam0) //Position: 0x1AFA / 6906
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_36(int iParam0) //Position: 0x1B06 / 6918
{
...
int Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x1B26 / 6950
{
	bool bVar0;
	int iVar1;
...
int Function_38(int iParam0, int iParam1, int iParam2) //Position: 0x1B79 / 7033
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_39(int iParam0, bool bParam1) //Position: 0x1BBA / 7098
{
	int iVar0;
...
void Function_40(int iParam0, var uParam1, int iParam2) //Position: 0x1BE0 / 7136
{
	float fVar0;
...
var Function_41(int iParam0) //Position: 0x1C11 / 7185
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
int Function_42(float fParam0) //Position: 0x1C31 / 7217
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_43() //Position: 0x1C6E / 7278
{
	if (!Function_44())
	{
		return 4294967295;
...
bool Function_44() //Position: 0x1C83 / 7299
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_45(bool bParam0, int iParam1) //Position: 0x1C90 / 7312
{
	struct<13> Var0;
...
struct<16> Function_46(var uParam0) //Position: 0x1EBD / 7869
{
	struct<4> Var0;
	bool bVar4;
...
var Function_47(int iParam0) //Position: 0x1F2E / 7982
{
...
void Function_48() //Position: 0x1FFF / 8191
{
	if (!Function_49())
	{
	}
...
bool Function_49() //Position: 0x200C / 8204
{
	return NET_IS_IN_SESSION();
}

bool Function_50(int iParam0) //Position: 0x2015 / 8213
{
	return Function_108(*iParam0, 2);
}

bool Function_51(int iParam0) //Position: 0x2022 / 8226
{
	return Function_108(*iParam0, 1);
}

void Function_52(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x202F / 8239
{
	if (iParam2 != 0)
	{
		NET_PLAYER_LIST_ADD_ITEM(UI_GET_STRING_BY_HASH(iParam2), Function_53(bParam0));
	}
	else
	{
		NET_PLAYER_LIST_ADD_ITEM(UI_GET_STRING(bParam1), Function_53(bParam0));
	}
...
var Function_53(int iParam0) //Position: 0x207E / 8318
{
	*iParam0 = (*iParam0 - 1);
	return *iParam0 + 1;
}

int Function_54(int iParam0) //Position: 0x2091 / 8337
{
	return Function_55(0, iParam0);
}

int Function_55(int iParam0, bool bParam1) //Position: 0x209D / 8349
{
	char* cVar0[64];
...
int Function_56(int iParam0) //Position: 0x2104 / 8452
{
	return (*&Global_78480 + 132)[iParam0];
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x2114 / 8468
{
	char* cVar0[64];
...
int Function_58(int iParam0) //Position: 0x2182 / 8578
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_59(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x219B / 8603
{
	int iVar0;
	bool bVar1;
	
	Function_61(bParam1, uParam2, uParam3);
	iVar0 = Function_54(bParam0);
	if (!bParam1)
	{
		Function_24(bParam0, iVar0, 0);
	}
	...
	if (!bParam1)
	{
		...
		bVar1++;
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_57(29, bParam0));
		bVar1++;
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_57(39, bParam0));
		bVar1++;
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_57(28, bParam0));
		bVar1++;
		Function_60(bVar1, bParam0);
	}
	else
	{
...
void Function_60(bool bParam0, bool bParam1) //Position: 0x222A / 8746
{
	if (Function_102(4))
	{
...
void Function_61(bool bParam0, int iParam1, char* cParam2) //Position: 0x225D / 8797
{
	if (bParam0)
	{
		if (Function_103())
...
int Function_62() //Position: 0x227E / 8830
{
	if (!Function_65(1))
	{
		return 0;
...
void Function_63() //Position: 0x230D / 8973
{
...
var Function_64() //Position: 0x234A / 9034
{
	int iVar0;
...
bool Function_65(bool bParam0) //Position: 0x2352 / 9042
{
	char* cVar0[64];
...
void Function_66(bool bParam0) //Position: 0x23D3 / 9171
{
...
struct<64> Function_67(int iParam0) //Position: 0x245C / 9308
{
...
int Function_69(bool bParam0, bool bParam1) //Position: 0x24B5 / 9397
{
...
void Function_70() //Position: 0x24E9 / 9449
{
...
bool Function_71(int iParam0) //Position: 0x2523 / 9507
{
	return Function_108(StackVal, iParam0);
}

void Function_72() //Position: 0x2536 / 9526
{
	if (IS_LAYOUTREF_VALID(Local_39.f_1808))
	{
		DESTROY_LAYOUT(Local_39.f_1808);
...
void Function_73(int iParam0) //Position: 0x255A / 9562
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_90(StackVal, StackVal, 12699, *(&Local_39 + 1896), 1, iParam0);
	bVar1 = true;
	if (IS_LOCAL_PLAYER_VALID(0))
	{
	...
	while (iVar0 <= Local_39.f_1804)
	{
		...
		else
		{
			...
			if (bVar1)
			{
				if (!IS_SCRIPT_USE_CONTEXT_VALID(Local_39[iVar090].f_356))
				{
					UI_SET_STRING_FORMAT(Function_82(iVar0), UI_GET_STRING("COOP_Select"), UI_GET_STRING(Function_81(Local_39[iVar090].f_324, 0)), false, false);
					Local_39[iVar090].f_356 = ADD_SCRIPT_USE_CONTEXT_IN_VOLUME(Function_82(iVar0), Local_39[iVar090].f_352, 0, 4, 0, false, 0, 0, 4294967295, 0);
				}
		...
		Function_76(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_39[iVar090]), vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.725f, 0.0f), 1, 10981, 0, iVar6, iVar0, "", iVar7);
		if (Function_75(Local_39[iVar090].f_352))
		{
			Function_76(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_39[iVar090] + 48, vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.25f, 0.0f), Local_39[iVar090].f_344, 10236, 0, iVar6, iVar0, "", iVar7);
		}
		else
		{
			Function_80(&Local_39[iVar090] + 48);
...
var Function_74(int iParam0, int iParam1) //Position: 0x27FC / 10236
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_39[iParam190] + 96)[iParam0 + 12]);
}

bool Function_75(bool bParam0) //Position: 0x2813 / 10259
{
	bool bVar0;
	bool bVar1;
...
void Function_76(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) //Position: 0x2858 / 10328
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_77(float fParam0) //Position: 0x2AD7 / 10967
{
	return (fParam0 * 57.29578f);
}

int Function_78(var uParam0, int iParam1) //Position: 0x2AE5 / 10981
{
	uParam0 = uParam0;
	return Function_81(Local_39[iParam190].f_324, 1);
}

void Function_79(int iParam0, int iParam1) //Position: 0x2AFC / 11004
{
...
void Function_80(int iParam0) //Position: 0x2B25 / 11045
{
	if (IS_OBJECT_VALID(*iParam0))
	{
...
int Function_81(int iParam0, bool bParam1) //Position: 0x2B4B / 11083
{
	if (bParam1)
	{
		switch (iParam0)
...
var Function_82(int iParam0) //Position: 0x2EBE / 11966
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_83(int iParam0) //Position: 0x2F55 / 12117
{
	Function_84(&Global_83864 + 1256, iParam0);
	return;
}

void Function_84(var uParam0, int iParam1) //Position: 0x2F67 / 12135
{
	Function_14(uParam0, iParam1);
	return;
}

void Function_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F74 / 12148
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_86(int iParam0) //Position: 0x2FEF / 12271
{
	char* cVar0[16];
...
bool Function_87() //Position: 0x302E / 12334
{
...
bool Function_88(bool bParam0) //Position: 0x3049 / 12361
{
	return Function_89(Global_83864.f_1256, bParam0);
}

int Function_89(var uParam0, bool bParam1) //Position: 0x305B / 12379
{
	return (uParam0 && bParam1) == 0;
}

void Function_90(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x3068 / 12392
{
	...
	Function_91(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 12598, 1, 125, 0, 0, 0);
...
void Function_91(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x30EB / 12523
{
	vector3 vVar0;
	int iVar3;
...
var Function_92(int iParam0, var uParam1) //Position: 0x3136 / 12598
{
	char* cVar0[64];
...
var Function_93() //Position: 0x319B / 12699
{
	int iVar0;
...
void Function_94(bool bParam0, int iParam1) //Position: 0x3214 / 12820
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_95(var uParam0, var uParam1) //Position: 0x3260 / 12896
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return "GY_BLK_summary";
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x327F / 12927
{
	int iVar0;
...
int Function_97() //Position: 0x329F / 12959
{
	if (Function_100(16))
	{
	}
...
void Function_98(int iParam0) //Position: 0x32BD / 12989
{
...
void Function_99(var uParam0, int iParam1) //Position: 0x32F6 / 13046
{
	Function_13(uParam0, iParam1);
	return;
}

bool Function_100(int iParam0) //Position: 0x3303 / 13059
{
	return Function_89(Global_79336, iParam0);
}

bool Function_101(int iParam0) //Position: 0x3312 / 13074
{
	return Function_108((&Global_83591 + 140)->f_56, iParam0);
}

bool Function_102(int iParam0) //Position: 0x3325 / 13093
{
	return Function_108(Global_76905.f_132, iParam0);
}

bool Function_103() //Position: 0x3336 / 13110
{
	return Function_102(32768);
}

void Function_104(int iParam0, float fParam1, int iParam2) //Position: 0x3343 / 13123
{
	Function_105(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_105(int iParam0, int iParam1) //Position: 0x3359 / 13145
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_106(int iParam0, int iParam1, bool bParam2) //Position: 0x337A / 13178
{
	Function_107(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

void Function_107(int iParam0, int iParam1) //Position: 0x338F / 13199
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
bool Function_108(var uParam0, int iParam1) //Position: 0x33B0 / 13232
{
	return (uParam0 && iParam1) == 0;
}

void Function_109(int iParam0) //Position: 0x33BD / 13245
{
	Function_110(8, iParam0);
	return;
}

void Function_110(int iParam0, bool bParam1) //Position: 0x33CA / 13258
{
	if (bParam1)
	{
...
void Function_111(var uParam0, var uParam1, float fParam2) //Position: 0x33F2 / 13298
{
	vector3 vVar0[5];
...
void Function_112(var uParam0, bool bParam1) //Position: 0x34A9 / 13481
{
	bool bVar1;
	bool bVar2;
...
void Function_113(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x36F2 / 14066
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	*(iParam0 + 96) = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_122(bParam4, iParam0 + 344) };
	...
	*(iParam0 + 332) = { StackVal, StackVal, vParam1 };
	...
	bVar19 = Function_114(bParam4, &vVar13, &vVar16);
...
var Function_114(bool bParam0, var uParam1, int iParam2) //Position: 0x386F / 14447
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_115(float fParam0) //Position: 0x395B / 14683
{
	return (fParam0 * 0.01745329f);
}

var Function_116(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3969 / 14697
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	return CREATE_PROP_IN_LAYOUT(StackVal, StackVal, StackVal, Vector("", uParam0, StackVal) + Vector(vVar6, *iParam1, Function_117()), 0.0f, (bParam2 + 180.0f), 0.0f, 1);
}

bool Function_117() //Position: 0x39D5 / 14805
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_118(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x39FC / 14844
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_119(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x3AEA / 15082
{
...
bool Function_120(int iParam0) //Position: 0x3C7B / 15483
{
...
bool Function_121(bool bParam0, int iParam1) //Position: 0x3C8D / 15501
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<228> Function_122(int iParam0, int iParam1) //Position: 0x3CE9 / 15593
{
	struct<57> Var0;
...
void Function_123(int iParam0, int iParam1) //Position: 0x3ECE / 16078
{
	int iVar0;
	int iVar1[17];
	int iVar19;
...
void Function_124(var uParam0, var uParam1) //Position: 0x400D / 16397
{
...
int Function_125() //Position: 0x4030 / 16432
{
	return Function_126(39);
}

int Function_126(int iParam0) //Position: 0x403B / 16443
{
	int iVar0;
...
int Function_127(int iParam0, int iParam1) //Position: 0x4069 / 16489
{
...
bool Function_128(int iParam0, int iParam1) //Position: 0x4083 / 16515
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

bool Function_129(int iParam0, var uParam1, int iParam2) //Position: 0x4096 / 16534
{
...
void Function_130(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x4176 / 16758
{
...
void Function_131(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4199 / 16793
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_132(int iParam0) //Position: 0x41C3 / 16835
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_133(int iParam0) //Position: 0x41D3 / 16851
{
	int iVar0;
...
void Function_134(var uParam0, int iParam1) //Position: 0x4200 / 16896
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_135(bool bParam0) //Position: 0x420C / 16908
{
	Function_131(bParam0, 4294967295, 0, 1);
	return;
}

float Function_136(vector3 vParam0, vector3 vParam3) //Position: 0x421A / 16922
{
	var uVar0;
...
void Function_137(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x4234 / 16948
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_138() //Position: 0x4257 / 16983
{
...
bool Function_139(int iParam0) //Position: 0x4267 / 16999
{
	int iVar0;
	int iVar1;
...
void Function_140() //Position: 0x45E2 / 17890
{
	if (!Function_141(128))
	{
		return;
...
bool Function_141(int iParam0) //Position: 0x4622 / 17954
{
	int iVar0;
...
bool Function_142() //Position: 0x463E / 17982
{
	int iVar0;
...
void Function_143(var uParam0, int iParam1) //Position: 0x4669 / 18025
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_144() //Position: 0x467A / 18042
{
	if (!Function_141(128))
	{
		return;
...
vector3 Function_145(float fParam0, float fParam1) //Position: 0x46BC / 18108
{
	return (SIN_DEGREE((180.0f + fParam0)) * fParam1), 0.0f, (COS_DEGREE((180.0f + fParam0)) * fParam1);
}

void Function_146(int iParam0) //Position: 0x46DF / 18143
{
...
bool Function_147(int iParam0) //Position: 0x4722 / 18210
{
...
bool Function_148(int iParam0) //Position: 0x4739 / 18233
{
...
bool Function_149() //Position: 0x477C / 18300
{
	var uVar0;
	bool bVar3;
	int iVar4;
...
void Function_150() //Position: 0x48AF / 18607
{
...
void Function_151(char* cParam0, int iParam1) //Position: 0x48CA / 18634
{
	char* cVar0[32];
	char* cVar8[32];
...
var Function_152(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4961 / 18785
{
	int iVar0;
	var uVar1;
...
var Function_153(var uParam0, int iParam1, int iParam2) //Position: 0x4999 / 18841
{
	int iVar0;
...
void Function_154(var uParam0, var uParam1) //Position: 0x4A5D / 19037
{
	Function_22(uParam0, uParam1, 19054);
	return;
}

int Function_155() //Position: 0x4A6E / 19054
{
	return 1;
}

int Function_156(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x4A75 / 19061
{
	bool bVar0;
	bool bVar1;
	...
	if (!bParam1)
	{
		...
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_57(39, bParam0));
		bVar1++;
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_157(bParam0));
		bVar1++;
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(bVar1, Function_57(28, bParam0));
		bVar1++;
		Function_60(bVar1, bParam0);
...
bool Function_157(bool bParam0) //Position: 0x4B15 / 19221
{
	return Function_57(12, bParam0);
}

int Function_158() //Position: 0x4B22 / 19234
{
	if (!Function_65(1))
	{
		return 0;
...
bool Function_159() //Position: 0x4BC0 / 19392
{
	return Function_71(2);
}

void Function_160(int iParam0, int iParam1) //Position: 0x4BCA / 19402
{
	Function_7(iParam0);
...
void Function_161(int iParam0, int iParam1) //Position: 0x4BFB / 19451
{
	int iVar0;
...
void Function_162(int iParam0, bool bParam1) //Position: 0x4C20 / 19488
{
	if (bParam1)
	{
