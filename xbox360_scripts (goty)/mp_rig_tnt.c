...
void Function_62(bool bParam0) //Position: 0x254F / 9551
{
	...
	if (!iLocal_0)
	{
		...
		{
			uLocal_2 = Function_66(cLocal_1, 0, &Var8, 1, 0, 1);
		}
		else
		{
			uLocal_2 = Function_63(cLocal_1, 0, &Var8, 1, 0, 1);
		}
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25CC / 9676
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x264A / 9802
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2675 / 9845
{
	vector3 vVar0;
...
var Function_66(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x272D / 10029
{
	bool bVar0;
...
void Function_67(var uParam0, int iParam1) //Position: 0x27A5 / 10149
{
	bool bVar0;
...
void Function_68(var uParam0, bool bParam1) //Position: 0x27D0 / 10192
{
	vector3 vVar0;
...
struct<32> Function_69(bool bParam0) //Position: 0x2888 / 10376
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_70(char* cParam0, char* cParam1, char* cParam2) //Position: 0x28F2 / 10482
{
	char* cVar0[32];
...
void Function_71(int iParam0) //Position: 0x2911 / 10513
{
	iParam0 = iParam0;
	return;
}

bool Function_72(bool bParam0) //Position: 0x291B / 10523
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_73(int iParam0) //Position: 0x2939 / 10553
{
	if (!Function_14(iParam0))
	{
...
bool Function_74(bool bParam0, bool bParam1) //Position: 0x294E / 10574
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_75(int iParam0) //Position: 0x29D5 / 10709
{
	vector3 vVar0;
...
vector3 Function_76(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29F8 / 10744
{
	vector3 vVar0;
...
bool Function_77(bool bParam0) //Position: 0x2A16 / 10774
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_78(bool bParam0, bool bParam1) //Position: 0x2A39 / 10809
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_79(bool bParam0, int iParam1) //Position: 0x2B54 / 11092
{
...
int Function_80(bool bParam0) //Position: 0x2B7F / 11135
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_81(var uParam0, int iParam1) //Position: 0x2C84 / 11396
{
	return (uParam0 && iParam1) == 0;
}

void Function_82(int iParam0) //Position: 0x2C91 / 11409
{
	if (Function_81(iParam0->f_40, 16))
	{
...
void Function_83(int iParam0, bool bParam1) //Position: 0x2D04 / 11524
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_84() //Position: 0x3202 / 12802
{
	bool bVar0;
...
bool Function_85(bool bParam0) //Position: 0x3239 / 12857
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_86(var uParam0, int iParam1) //Position: 0x3256 / 12886
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_87(int iParam0) //Position: 0x328E / 12942
{
	iParam0 = iParam0;
	return;
}

bool Function_88(bool bParam0) //Position: 0x3298 / 12952
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_89(var uParam0, int iParam1) //Position: 0x32B9 / 12985
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x32D7 / 13015
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x33DF / 13279
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_92(int iParam0) //Position: 0x33F5 / 13301
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_93(var uParam0, int iParam1) //Position: 0x36AB / 13995
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_94(bool bParam0) //Position: 0x36B9 / 14009
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_95(bool bParam0) //Position: 0x36D2 / 14034
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_96(bool bParam0, int iParam1) //Position: 0x36EC / 14060
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_97(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_97(var uParam0, int iParam1) //Position: 0x3724 / 14116
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_98(int iParam0, int iParam1) //Position: 0x373B / 14139
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_99(bool bParam0) //Position: 0x3A04 / 14852
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_100(bool bParam0, bool bParam1) //Position: 0x3A21 / 14881
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_101(int iParam0) //Position: 0x3ABD / 15037
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_102(var uParam0, int iParam1) //Position: 0x3ADC / 15068
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_103(int iParam0) //Position: 0x3AEB / 15083
{
...
void Function_104(int iParam0) //Position: 0x3B07 / 15111
{
	iParam0 = iParam0;
	return;
}

void Function_105(bool bParam0, int iParam1) //Position: 0x3B11 / 15121
{
	int iVar0;
	int iVar1;
...
void Function_106(int iParam0, int iParam1) //Position: 0x3B73 / 15219
{
...
void Function_107(int iParam0) //Position: 0x3B87 / 15239
{
	iParam0 = iParam0;
	return;
}

void Function_108(int iParam0) //Position: 0x3B91 / 15249
{
