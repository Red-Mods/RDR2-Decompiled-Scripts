...
void Function_90(bool bParam0, int iParam1) //Position: 0x3690 / 13968
{
	bool bVar0;
	char* cVar1;
...
bool Function_96(var uParam0, int iParam1) //Position: 0x3A80 / 14976
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3A8F / 14991
{
...
void Function_98(int iParam0) //Position: 0x3AAB / 15019
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AB5 / 15029
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B17 / 15127
{
...
void Function_101(int iParam0) //Position: 0x3B2B / 15147
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (!DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "MadePhoneCord"))
	{
		...
		bVar3 = GRINGO_GET_PROP_FROM_COMPONENT_EXT(iVar2, GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()));
		if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
		{
...
void Function_102(int iParam0) //Position: 0x3C5A / 15450
{
