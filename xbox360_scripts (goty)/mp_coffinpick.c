...
void main() //Position: 0x0 / 0
{
	...
	iLocal_50 = 0;
	Function_97(uScriptParam_0, &iLocal_50);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_51);
		}
		iVar2 = 0;
		bLocal_56 = false;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_57))
	{
		Function_100("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(bLocal_57);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_50 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_57))
								{
									...
									{
										bLocal_57 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_57 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_57))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_57))
		{
			Function_100("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_57);
		}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_55, &cLocal_54);
...
bool Function_27(bool bParam0) //Position: 0x1D3C / 7484
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D5B / 7515
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D61 / 7521
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D6F / 7535
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D7A / 7546
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D94 / 7572
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DB2 / 7602
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DD1 / 7633
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E04 / 7684
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E23 / 7715
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E3D / 7741
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E50 / 7760
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2138 / 8504
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2140 / 8512
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x215D / 8541
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x216C / 8556
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x218E / 8590
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21B2 / 8626
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21CF / 8655
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21EF / 8687
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x220F / 8719
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22BD / 8893
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x232D / 9005
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2343 / 9027
{
...
var Function_51(bool bParam0) //Position: 0x2364 / 9060
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2384 / 9092
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2398 / 9112
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23A2 / 9122
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23A9 / 9129
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23B8 / 9144
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x23F7 / 9207
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2422 / 9250
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x242D / 9261
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2523 / 9507
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2545 / 9541
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x256C / 9580
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x2576 / 9590
{
	iParam0 = iParam0;
	return;
}

bool Function_64(bool bParam0) //Position: 0x2580 / 9600
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x259E / 9630
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x25B3 / 9651
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x263A / 9786
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x265D / 9821
{
	vector3 vVar0;
...
bool Function_69(bool bParam0) //Position: 0x267B / 9851
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x269E / 9886
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_71(bool bParam0, int iParam1) //Position: 0x27B9 / 10169
{
...
int Function_72(bool bParam0) //Position: 0x27E4 / 10212
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x28E9 / 10473
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x28F6 / 10486
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x2969 / 10601
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_55)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_54));
		iLocal_55 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_76() //Position: 0x2E67 / 11879
{
	bool bVar0;
...
bool Function_77(bool bParam0) //Position: 0x2E9E / 11934
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2EBB / 11963
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_79(int iParam0) //Position: 0x2EF3 / 12019
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x2EFD / 12029
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(bool bParam0, int iParam1) //Position: 0x2F1E / 12062
{
	if (DECOR_CHECK_EXIST(bParam0, "iLockerOpen"))
	{
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			SET_FORCED_LOOK_ENABLE(bParam0, 1);
		}
	}
	iParam1 = iParam1;
	return;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F68 / 12136
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3070 / 12400
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x3086 / 12422
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(bool bParam0, int iParam1) //Position: 0x333C / 13116
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		ACTOR_HOLSTER_WEAPON(bParam0, 0);
		SET_FORCED_LOOK_ENABLE(bParam0, 0);
	}
	return;
}

bool Function_86(bool bParam0) //Position: 0x335B / 13147
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x3374 / 13172
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x338E / 13198
{
	bool bVar0;
	char* cVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x33C6 / 13254
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x33DD / 13277
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x36A6 / 13990
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x36C3 / 14019
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x375F / 14175
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(bool bParam0, int iParam1) //Position: 0x377E / 14206
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
bool Function_95(int iParam0) //Position: 0x37BC / 14268
{
...
void Function_96(int iParam0) //Position: 0x37D8 / 14296
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x37E2 / 14306
{
	int iVar0;
	int iVar1;
	...
	{
		Function_98(&(Local_1[iLocal_5012]), bParam0);
		iLocal_50++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3844 / 14404
{
...
void Function_99(int iParam0) //Position: 0x3858 / 14424
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3862 / 14434
{
