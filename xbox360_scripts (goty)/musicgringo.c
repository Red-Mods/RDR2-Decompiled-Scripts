...
void main() //Position: 0x0 / 0
{
	...
	iLocal_28 = 0;
	Function_99(uScriptParam_0, &iLocal_28);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_29);
		}
		iVar2 = 0;
		bLocal_34 = false;
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_35))
								{
									...
									{
										bLocal_35 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_35 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_33, &cLocal_32);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D13 / 7443
{
	bool bVar0;
	...
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
		if (!DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "ForceMusicGringoUse"))
		{
			if (AUDIO_IS_SCRIPTED_MUSIC_PLAYING())
			{
				...
				if (STRING_CONTAINS_STRING(bVar0, "nsit_piano"))
				{
					if (!iLocal_1)
					{
						iLocal_1 = 1;
						SET_ACTION_NODE_FOR_ACTOR(bParam0, "piano_sit/leave/stand");
					}
				}
				else
				{
...
bool Function_27(bool bParam0) //Position: 0x1D99 / 7577
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DB8 / 7608
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DBE / 7614
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DCC / 7628
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DD7 / 7639
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DF1 / 7665
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E0F / 7695
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E2E / 7726
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E61 / 7777
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E80 / 7808
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E9A / 7834
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EAD / 7853
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2195 / 8597
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x219D / 8605
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21BA / 8634
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21C9 / 8649
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21EB / 8683
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x220F / 8719
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x222C / 8748
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x224C / 8780
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x226C / 8812
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x231A / 8986
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x238A / 9098
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23A0 / 9120
{
...
var Function_51(bool bParam0) //Position: 0x23C1 / 9153
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23E1 / 9185
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23F5 / 9205
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23FF / 9215
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2406 / 9222
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2415 / 9237
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x2454 / 9300
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x247F / 9343
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x248A / 9354
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2580 / 9600
{
...
void Function_62(bool bParam0) //Position: 0x25C9 / 9673
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2888 / 10376
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28E5 / 10469
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2942 / 10562
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x294C / 10572
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x296A / 10602
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x297F / 10623
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A06 / 10758
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A29 / 10793
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A47 / 10823
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A6A / 10858
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B85 / 11141
{
...
int Function_74(bool bParam0) //Position: 0x2BB0 / 11184
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CB5 / 11445
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CC2 / 11458
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D35 / 11573
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_33)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_32));
		iLocal_33 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x3233 / 12851
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x326A / 12906
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3287 / 12935
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32BF / 12991
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32C9 / 13001
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x32EA / 13034
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (bLocal_0)
	...
	SET_ACTOR_CAN_PLAY_GESTURES(bParam0, true);
	return;
}

void Function_84(bool bParam0, bool bParam1) //Position: 0x3309 / 13065
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3411 / 13329
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3427 / 13351
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x36DD / 14045
{
	bool bVar0;
	...
	bParam0 = bParam0;
	bVar0 = GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF());
	if (STRING_CONTAINS_STRING(bVar0, "nharmonica"))
	{
		AI_SPEECH_SET_ALLOW_FOR_ACTOR(bParam0, 0);
		bLocal_0 = true;
	}
...
bool Function_88(bool bParam0) //Position: 0x3716 / 14102
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x372F / 14127
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x3749 / 14153
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3781 / 14209
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3798 / 14232
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A61 / 14945
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A7E / 14974
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B1A / 15130
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B39 / 15161
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
...
bool Function_97(int iParam0) //Position: 0x3B79 / 15225
{
...
void Function_98(int iParam0) //Position: 0x3B95 / 15253
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B9F / 15263
{
	int iVar0;
	int iVar1;
	...
	{
		Function_100(&(Local_3[iLocal_2812]), bParam0);
		iLocal_28++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x3C01 / 15361
{
...
void Function_101(int iParam0) //Position: 0x3C15 / 15381
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3C1F / 15391
{
