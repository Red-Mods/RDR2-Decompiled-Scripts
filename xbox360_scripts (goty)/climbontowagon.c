...
void main() //Position: 0x0 / 0
{
	...
	iLocal_76 = 0;
	Function_103(uScriptParam_0, &iLocal_76);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_77);
		}
		iVar2 = 0;
		bLocal_82 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(Local_3[iVar312]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), Local_3[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", Local_3[iVar312].f_16);
							Function_88(Local_3[iVar312].f_16, 1);
							...
							{
								Function_81(&(Local_3[iVar312]), 0);
							}
							else if (Local_3[iVar312].f_44 < 8)
							{
								Function_80(&(Local_3[iVar312]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_83))
	{
		Function_106("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(bLocal_83);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_76 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_83))
								{
									...
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_83))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_83))
		{
			Function_106("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_83);
		}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_81, &cLocal_80);
...
void Function_62(bool bParam0) //Position: 0x254C / 9548
{
	...
	bParam0 = bParam0;
	if (!(NET_IS_IN_SESSION() || Function_68()))
	{
		if (!IS_LAYOUTREF_VALID(cLocal_0))
		{
			bLocal_0 = CREATE_LAYOUT("ClimbOntoWagon_Layout");
			Function_67(GET_TARGET_OBJECT());
			*(&Var0 + 12) = { StackVal, StackVal, Function_67(GET_TARGET_OBJECT()) };
			Function_66(GET_TARGET_OBJECT());
			Var0 = { StackVal, StackVal, Function_66(GET_TARGET_OBJECT()) };
			Var0.f_24 = 0;
			uLocal_1 = Function_63(bLocal_0, 0, &Var0, 1, 0, 0);
		}
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25AF / 9647
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "ClimbOntoWagon", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x262B / 9771
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2652 / 9810
{
	vector3 vVar0;
	...
	vVar0 = { -1.154559f, 3.143767f, 0.875406f };
	...
	vVar0 = { -0.756029f, 0.499827f, -0.422603f };
	UNK_0xF76F2BB3(&vVar0, bParam1, bParam1->f_24, 4);
...
vector3 Function_66(bool bParam0) //Position: 0x270A / 9994
{
	vector3 vVar0;
...
vector3 Function_67(bool bParam0) //Position: 0x2731 / 10033
{
	vector3 vVar0;
...
var Function_68() //Position: 0x2758 / 10072
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_69(int iParam0) //Position: 0x2761 / 10081
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x276B / 10091
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2789 / 10121
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x279E / 10142
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2825 / 10277
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2848 / 10312
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x2866 / 10342
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x2889 / 10377
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x29A4 / 10660
{
...
int Function_78(bool bParam0) //Position: 0x29CF / 10703
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2AD4 / 10964
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2AE1 / 10977
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2B54 / 11092
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_81)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_80));
		iLocal_81 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_82() //Position: 0x3052 / 12370
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x3089 / 12425
{
...
void Function_85(int iParam0) //Position: 0x30DE / 12510
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x30E8 / 12520
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(bool bParam0, int iParam1) //Position: 0x3109 / 12553
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	...
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT()), 0);
	return;
}

void Function_88(bool bParam0, bool bParam1) //Position: 0x3142 / 12610
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x324A / 12874
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x3260 / 12896
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_91(bool bParam0, int iParam1) //Position: 0x3516 / 13590
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	...
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT()), 1);
	return;
}

bool Function_92(bool bParam0) //Position: 0x353E / 13630
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x3557 / 13655
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x3571 / 13681
{
	bool bVar0;
	var uVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x35A9 / 13737
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x35C0 / 13760
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x3889 / 14473
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x38A6 / 14502
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3942 / 14658
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(bool bParam0, int iParam1) //Position: 0x3961 / 14689
{
	vector3 vVar0;
	struct<5> Var3;
	...
	iParam1 = iParam1;
	bParam0 = bParam0;
	GET_ACTOR_VELOCITY(GET_ACTOR_FROM_OBJECT(GET_TARGET_OBJECT()), &vVar0);
	if (VMAG(vVar0) < 0.5f)
	{
		return 0;
	}
	Function_67(GRINGO_GET_MY_OBJECT_REF());
	Var3 = { StackVal, StackVal, Function_67(GRINGO_GET_MY_OBJECT_REF()) };
	Function_67(bParam0);
	Var6 = { StackVal, StackVal, Function_67(bParam0) };
	if ((StackVal - StackVal) < 0.3f)
	{
		return 0;
	}
	return 1;
...
bool Function_101(int iParam0) //Position: 0x39B5 / 14773
{
...
void Function_102(int iParam0) //Position: 0x39D1 / 14801
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x39DB / 14811
{
	int iVar0;
	int iVar1;
	...
	{
		Function_104(&(Local_3[iLocal_7612]), bParam0);
		iLocal_76++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x3A3D / 14909
{
...
void Function_105(int iParam0) //Position: 0x3A51 / 14929
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3A5B / 14939
{
