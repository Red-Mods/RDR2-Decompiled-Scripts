...
void main() //Position: 0x0 / 0
{
	...
	bVar12 = FIND_NAMED_LAYOUT("TallTrees_layout");
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "talv_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar14 = Function_3(bVar13, uVar0, 4E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar14, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar14, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar14, 5);
			uVar15 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar15, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar15, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar15, 1);
			uVar16 = Function_3(bVar13, uVar5, 1E-05f, 0, 0, 1);
			...
			uVar17 = Function_3(bVar13, uVar6, 1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar17, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar17, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar17, 4);
			uVar18 = Function_3(bVar13, uVar7, 1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar18, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar18, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar18, 6);
			uVar19 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar19, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar19, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar19, 3);
			uVar20 = Function_3(bVar13, uVar3, 1E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(bVar13, uVar4, 1E-05f, 0, 0, 1);
			...
			Function_3(bVar13, Global_30750[7], 2E-05f, 0, 0, 1);
			Function_3(bVar13, uVar1, 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("hgn_pop: Cannot find talv_flk_ALL_set to create population volumes");
		}
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "talv_flk_NORTH_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar22 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar22, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar22, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar22, 10);
			uVar23 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar24 = Function_3(bVar13, uVar5, 1E-05f, 0, 0, 1);
			...
			uVar25 = Function_3(bVar13, uVar6, 1E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(bVar13, uVar7, 1E-05f, 0, 0, 1);
			...
			uVar27 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(bVar13, uVar3, 1E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(bVar13, uVar4, 1E-05f, 0, 0, 1);
		...
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "talv_flk_SOUTH_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar30 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar30, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar30, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar30, 20);
			uVar31 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar32 = Function_3(bVar13, uVar5, 1E-05f, 0, 0, 1);
			...
			uVar33 = Function_3(bVar13, uVar6, 1E-05f, 0, 0, 1);
			...
			uVar34 = Function_3(bVar13, uVar7, 1E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(bVar13, uVar3, 1E-05f, 0, 0, 1);
			...
			uVar37 = Function_3(bVar13, uVar4, 1E-05f, 0, 0, 1);
...
void Function_1(var uParam0, var uParam1) //Position: 0x1182 / 4482
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1191 / 4497
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x11E6 / 4582
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0x1266 / 4710
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0x1282 / 4738
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x12C0 / 4800
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x12DC / 4828
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x12EC / 4844
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x1364 / 4964
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x13D0 / 5072
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x143C / 5180
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1481 / 5249
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x148D / 5261
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x1509 / 5385
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x1516 / 5398
{
	if (!Function_4(128))
	{
		return;
