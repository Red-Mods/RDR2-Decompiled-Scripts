...
void Function_30(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x185E / 6238
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_33(char* cParam0, bool bParam1) //Position: 0x1F91 / 8081
{
	char* cVar0[32];
...
void Function_57(bool bParam0, bool bParam1) //Position: 0x34FD / 13565
{
...
var Function_63() //Position: 0x3EF0 / 16112
{
...
void Function_85(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4DE5 / 19941
{
	struct<4> Var0;
	int iVar4;
...
var Function_89(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4EF8 / 20216
{
...
void Function_121(char* cParam0, bool bParam1) //Position: 0x6669 / 26217
{
	bool bVar0;
...
void Function_122(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x668E / 26254
{
	struct<4> Var0;
	int iVar4;
...
void Function_125(bool bParam0) //Position: 0x6DD0 / 28112
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_129(bool bParam0) //Position: 0x6F48 / 28488
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_143(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x7442 / 29762
{
	bool bVar0;
...
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, 743.202f, 78.425f, 1300.785f, 181.303f, 1, true, 1);
	...
	SET_DRAW_ACTOR(bLocal_273, true);
	TELEPORT_ACTOR_WITH_HEADING(bLocal_273, 742.896f, 78.41f, 1308.258f, 2.335f, 1, true, 1);
...
void Function_146(bool bParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x7700 / 30464
{
	int iVar0;
...
int Function_153() //Position: 0x7E31 / 32305
{
	if (!iLocal_282)
	{
		...
		SET_DRAW_ACTOR(bLocal_273, false);
...
void Function_156(bool bParam0, float fParam1) //Position: 0x810F / 33039
{
...
int Function_168(int iParam0, int iParam1) //Position: 0x8CD5 / 36053
{
	var uVar0;
...
bool Function_173(bool bParam0) //Position: 0x8E89 / 36489
{
...
int Function_182(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x9099 / 37017
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_195(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x9AD6 / 39638
{
	...
	iVar0 = Function_196(uParam0, iVar1, iParam2);
	if (bParam3)
	{
