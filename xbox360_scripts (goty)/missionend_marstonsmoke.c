...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F26 / 12070
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x302E / 12334
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x3044 / 12356
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32FA / 13050
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	HUD_ENABLE(false);
...
bool Function_86(bool bParam0) //Position: 0x3317 / 13079
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x3330 / 13104
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x334A / 13130
{
	bool bVar0;
	char* cVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3382 / 13186
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3399 / 13209
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3662 / 13922
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x367F / 13951
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x371B / 14107
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x373A / 14138
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3749 / 14153
{
...
void Function_96(int iParam0) //Position: 0x3765 / 14181
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x376F / 14191
{
	int iVar0;
	int iVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x37D1 / 14289
{
...
void Function_99(int iParam0) //Position: 0x37E5 / 14309
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37EF / 14319
{
