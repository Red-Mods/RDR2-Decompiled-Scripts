...
void main() //Position: 0x0 / 0
{
	...
	bVar7 = FIND_NAMED_LAYOUT("Sepulcro_layout");
	if (IS_LAYOUTREF_VALID(bVar7))
	{
		bVar8 = FIND_VOLUME_IN_LAYOUT(bVar7, "sepv_region");
		if (IS_VOLUME_VALID(bVar8))
		{
			Function_4(bVar8, uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xCD9 / 3289
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCE8 / 3304
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD3D / 3389
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xDBD / 3517
{
	bool bVar0;
...
bool Function_5(int iParam0) //Position: 0xE3F / 3647
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0xE5B / 3675
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xE99 / 3737
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xEB5 / 3765
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xEC5 / 3781
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xF3D / 3901
{
	int iVar0;
...
var Function_11(int iParam0) //Position: 0xFA9 / 4009
{
	int iVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1015 / 4117
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0x105A / 4186
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_14(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1066 / 4198
{
	int iVar0;
	int iVar1;
...
var Function_15(bool bParam0, int iParam1) //Position: 0x10E2 / 4322
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_16(bool bParam0, var uParam1) //Position: 0x10EF / 4335
{
	if (!Function_5(128))
	{
		return;
