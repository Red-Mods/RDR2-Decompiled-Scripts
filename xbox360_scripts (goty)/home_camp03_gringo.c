...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	vLocal_14 = { -70.441f, 116.972f, 1415.828f };
	vLocal_17 = { -73.11f, 117.869f, 1367.464f };
	fLocal_20 = -1.0f;
	iLocal_21 = 0;
	iLocal_22 = 2;
	iLocal_23 = 4;
...
void Function_1(int iParam0) //Position: 0xAA / 170
{
	bool bVar0;
...
void Function_2() //Position: 0x21C / 540
{
	Function_3();
	return;
}

void Function_3() //Position: 0x225 / 549
{
	Function_21(57);
	RELEASE_LAYOUT_REF(bLocal_11);
	SQUAD_LEAVE(bLocal_7);
	CLEAR_ACTOR_STAY_WITHIN_VOLUME(bLocal_7);
	MEMORY_ALLOW_SHOOTING(bLocal_7, 0);
	MEMORY_PREFER_MELEE(bLocal_7, 0);
	SET_ACTOR_FACTION(bLocal_7, 20);
	MEMORY_CONSIDER_AS(bLocal_7, Global_34573, false);
	Function_18(13, 0, 1, 1, 1);
	Function_4(12, bLocal_7, bLocal_9, &uLocal_3, bLocal_10, 57);
	return;
}

void Function_4(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x274 / 628
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (SQUAD_IS_VALID(bParam2))
	{
		if (bParam5 > 0)
		{
			Function_15(&(Global_3422[bParam540]));
		}
		bVar0 = false;
		...
		if (Function_13(bParam2, Global_34573))
		{
			bVar1 = true;
		}
		bVar0 = false;
		while (bVar0 <= SQUAD_GET_SIZE(bParam2))
		{
			...
			if (IS_ACTOR_VALID(bVar5))
			{
				...
				{
					if (Function_12(GET_OBJECT_FROM_GRINGO(bVar6), bParam4))
					{
	...
	switch (bParam5)
	{
		...
		case 0x00000033:
		case 0x00000039:
			if (GET_LAST_ATTACKER(bParam1) != Global_34573 || ((((Global_3422[bParam540].f_152 && !Function_7(bParam1, &uVar8, &uVar7, 0, 0, 0x40400000)) && !HUD_IS_FADED()) && !HUD_IS_FADING()) && !Global_3395))
			{
				UI_SET_TEXT("Death_Explanation", "kill_family_help");
				KILL_ACTOR(Global_34573);
			}
			else if (Global_3422[bParam540].f_152 && Function_7(bParam1, &uVar8, &uVar7, 0, 0, 0x40400000))
			{
				if (bParam0 == 11)
				{
					Function_6(bParam1, -105.606f, 119.513f, 1362.295f, 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 12)
				{
					Function_6(bParam1, -104.413f, 119.521f, 1367.917f, 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 13)
				{
					Function_6(bParam1, -102.615f, 119.513f, 1364.342f, 10.0f, 1, 120.0f, 0x40c00000);
				}
	...
	Function_18(bParam0, DECOR_CHECK_EXIST(bParam1, "hidden"), (Global_3378 || bVar9), 1, 1);
...
void Function_5(bool bParam0, bool bParam1) //Position: 0x691 / 1681
{
...
void Function_6(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0x6C0 / 1728
{
	int iVar0;
	bool bVar1;
...
bool Function_7(bool bParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0x77A / 1914
{
	float fVar0;
...
void Function_8(bool bParam0) //Position: 0x911 / 2321
{
...
void Function_9(bool bParam0) //Position: 0x945 / 2373
{
	SAY_SINGLE_LINE_CONTEXT(bParam0, 60, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_10(var uParam0, int iParam1) //Position: 0x95C / 2396
{
	return (uParam0 && iParam1) == 0;
}

var Function_11(bool bParam0, bool bParam1) //Position: 0x969 / 2409
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_12(bool bParam0, bool bParam1) //Position: 0xA5A / 2650
{
	bool bVar0;
	bool bVar1;
...
bool Function_13(bool bParam0, bool bParam1) //Position: 0xAB1 / 2737
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_14(bool bParam0) //Position: 0xB0A / 2826
{
	bool bVar0;
...
int Function_15(int iParam0) //Position: 0xB3C / 2876
{
	int iVar0;
	var uVar1;
	var uVar2;
			...
			while (bVar3 <= SQUAD_GET_SIZE(iParam0->f_156))
			{
				...
				if (IS_ACTOR_VALID(bVar4))
				{
					if (!IS_ACTOR_VEHICLE(bVar4))
					{
						...
						if (Function_7(bVar4, &uVar2, &uVar1, 0, 0, 0x40400000) && ((iParam0->f_36 != 11 || iParam0->f_36 != 12) || iParam0->f_36 != 13))
						{
							Function_14(iParam0->f_156);
							SQUAD_GOALS_CLEAR(iParam0->f_156);
							iParam0->f_152 = 1;
	...
	else if (Function_16(StackVal, StackVal, Global_34573, *(iParam0 + 52)) < 100.0f)
	{
		iParam0->f_152 = 0;
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(iParam0->f_40)))
		{
...
float Function_16(bool bParam0, vector3 vParam1) //Position: 0xD12 / 3346
{
	vector3 vVar0;
...
vector3 Function_17(bool bParam0) //Position: 0xD8C / 3468
{
	vector3 vVar0;
...
int Function_18(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0xDF6 / 3574
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_19(bool bParam0) //Position: 0x1114 / 4372
{
	bool bVar0;
...
void Function_20(bool bParam0) //Position: 0x1140 / 4416
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_21(bool bParam0) //Position: 0x1155 / 4437
{
	if (Function_23(&Global_3422[bParam040] + 128, 8388608))
	{
		Function_22(&Global_3422[bParam040] + 128, 8388608);
	}
	return;
}

void Function_22(var uParam0, int iParam1) //Position: 0x1181 / 4481
{
	int iVar0;
...
bool Function_23(var uParam0, int iParam1) //Position: 0x1198 / 4504
{
	int iVar0;
...
void Function_24(int iParam0) //Position: 0x11B4 / 4532
{
	int iVar0;
...
void Function_25(var uParam0, int iParam1) //Position: 0x11DA / 4570
{
...
void Function_26(var uParam0, int iParam1) //Position: 0x1308 / 4872
{
	int iVar0;
...
bool Function_27(var uParam0, bool bParam1) //Position: 0x1322 / 4898
{
	int iVar0;
...
var Function_28(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x133F / 4927
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if (Global_3370)
			{
				if (Function_16(StackVal, StackVal, Global_34573, vVar7) < 10.0f)
				{
					break;
				}
			}
			if ((Global_26154 + 1 > iLocal_22 || bParam2) || Global_3370)
			{
				...
				{
					if (((!bParam2 && !Function_145(iParam0 + 200, &fLocal_24, 256, 0)) && !Global_3370) && !Function_152())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_134(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_24, 20.0f, fLocal_24);
		...
		case 0x00000002:
			...
			{
				if (((Function_16(StackVal, StackVal, Global_34573, *(iParam0 + 200)) < 120.0f || bParam2) || Global_3370) || Function_152())
				{
					if (UNK_0x214AFB8C(iParam0->f_16))
					{
						if (IS_OBJECT_VALID(iParam0->f_224))
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_7(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_25, iParam0 + 312, 0, 0, 0x40400000))
						{
...
void Function_29(int iParam0) //Position: 0x233D / 9021
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x234D / 9037
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_31(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x254B / 9547
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_32(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2565 / 9573
{
	bool bVar0;
	bool bVar1;
...
int Function_33(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2645 / 9797
{
	char* cVar0[32];
...
int Function_34(bool bParam0) //Position: 0x2893 / 10387
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_35(bool bParam0, bool bParam1) //Position: 0x28B6 / 10422
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(bool bParam0, bool bParam1) //Position: 0x28D9 / 10457
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_37(bool bParam0, bool bParam1) //Position: 0x28FD / 10493
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(bool bParam0, bool bParam1) //Position: 0x2923 / 10531
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x2946 / 10566
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2964 / 10596
{
...
bool Function_41(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x29AE / 10670
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2A00 / 10752
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_43(bool bParam0, bool bParam1) //Position: 0x2A1C / 10780
{
	bool bVar0;
	bool bVar1;
...
void Function_44(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2A6E / 10862
{
	bool bVar0;
	bool bVar1;
...
var Function_45() //Position: 0x2AB3 / 10931
{
...
void Function_46(int iParam0, bool bParam1, bool bParam2) //Position: 0x2AC8 / 10952
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2BEB / 11243
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			{
				Function_17(bVar1);
				if (VDIST(Function_17(bVar1), vParam1) >= fParam4)
				{
					iVar2 = 1;
				}
			}
...
bool Function_48(vector3 vParam0) //Position: 0x2C59 / 11353
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(bool bParam0) //Position: 0x2C71 / 11377
{
	bool bVar0;
	bool bVar1;
...
var Function_50(bool bParam0) //Position: 0x2CC8 / 11464
{
	bool bVar0;
	bool bVar1;
...
void Function_51(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2D0E / 11534
{
	bool bVar0;
	bool bVar1;
...
void Function_52(bool bParam0, bool bParam1) //Position: 0x2D7C / 11644
{
	bool bVar0;
	bool bVar1;
...
void Function_53(bool bParam0) //Position: 0x2DC4 / 11716
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x2E82 / 11906
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(int iParam0) //Position: 0x2E95 / 11925
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_56(int iParam0) //Position: 0x2F46 / 12102
{
...
bool Function_57(int iParam0) //Position: 0x2F65 / 12133
{
...
bool Function_58(int iParam0) //Position: 0x2F89 / 12169
{
...
bool Function_59(int iParam0) //Position: 0x2F9E / 12190
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x2FB5 / 12213
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x2FF2 / 12274
{
...
bool Function_62(int iParam0) //Position: 0x300C / 12300
{
...
int Function_63(int iParam0, int iParam1) //Position: 0x3022 / 12322
{
	int iVar0;
...
void Function_64(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x305B / 12379
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_65(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x3128 / 12584
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_66(bool bParam0, bool bParam1) //Position: 0x32BF / 12991
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x32E1 / 13025
{
	bool bVar0;
	bool bVar1;
...
var Function_68(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x3325 / 13093
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x346E / 13422
{
	var uVar0[5];
	int iVar6;
...
int Function_70(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x350F / 13583
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x35A3 / 13731
{
	iParam1 = iParam1;
	if ((StackVal && IS_PERS_CHAR_VALID(Global_8492[1214]) != 638) || (iLocal_21 && (GET_CURRENT_GAME_TIME() - fLocal_20) < 15.0f))
	{
		Function_98(&uLocal_3, "$/content/scripting/gringo/simplegringo/repair_kneel_nospawn", 1, 0);
		if (Function_91(&bLocal_7, &uLocal_3, 57, 1, 1, 0, 1, 0, 0, 0, 0))
		{
			if (!IS_ACTOR_VALID(bLocal_8))
			{
				bLocal_8 = Function_79(13, 0, 1, 0, 0, 0, 0, 0, 0);
			}
			else
			{
				bLocal_12 = LOCATE_GRINGO_OF_TYPE("hammer", &vLocal_14, 2.0f, 1);
				if (IS_GRINGO_VALID(bLocal_12))
				{
					if (Function_77(&bLocal_11, "home03mobile", iParam1))
					{
						bLocal_9 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_11, Function_134()));
						Global_3422[5740].f_156 = bLocal_9;
...
void Function_72() //Position: 0x36CB / 14027
{
	bLocal_10 = CREATE_LAYOUT("home02son01campfirelayout");
	bLocal_13 = CREATE_GRINGO_IN_LAYOUT(bLocal_10, "home03hammer", "repair_kneel_nospawn", vLocal_17, 0.0f, 242.821f, 0.0f);
	TELEPORT_ACTOR(bLocal_7, &vLocal_14, 1, 1, 1);
	SNAP_ACTOR_TO_GRINGO(bLocal_7, GET_OBJECT_FROM_GRINGO(bLocal_12), "UseCase1", 1, 0, 0);
	TASK_USE_GRINGO(bLocal_7, bLocal_12, "UseCase1", 4294967295, 1);
	Function_75(57);
	TELEPORT_ACTOR(bLocal_8, &vLocal_17, 1, 1, 1);
	SNAP_ACTOR_TO_GRINGO(bLocal_8, bLocal_13, "UseCase1", 1, 0, 0);
	TASK_USE_GRINGO(bLocal_8, GET_GRINGO_FROM_OBJECT(bLocal_13), "UseCase1", 4294967295, 1);
	Function_73(bLocal_7, &bLocal_9, 1, 1);
	Function_75(57);
	return;
}

void Function_73(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x37AB / 14251
{
	bool bVar0;
	bool bVar1;
	...
	if (!Function_74(bParam0, *uParam1, 1))
	{
	...
	else if (IS_ACTOR_VEHICLE(bParam0))
	{
		...
		while (bVar0 <= GET_NUM_DRAFT_POSITIONS(bParam0))
		{
			...
			if (IS_ACTOR_VALID(bVar1))
			{
				if (!Function_74(bVar1, *uParam1, 1))
				{
...
bool Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3935 / 14645
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
void Function_75(int iParam0) //Position: 0x3975 / 14709
{
	if (!Function_23(&Global_3422[iParam040] + 128, 8388608))
	{
		Function_76(&Global_3422[iParam040] + 128, 8388608);
	}
	return;
}

void Function_76(var uParam0, int iParam1) //Position: 0x39A2 / 14754
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_77(var uParam0, var uParam1, int iParam2) //Position: 0x39B1 / 14769
{
...
void Function_78(bool bParam0, bool bParam1) //Position: 0x39DC / 14812
{
	var uVar0;
...
bool Function_79(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8) //Position: 0x3A1E / 14878
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		if (!Function_90(&(Global_29008[Global_30621[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(Global_8492[iParam014]))
	...
	else
	{
		if (bParam6)
		{
			bVar1 = Function_87(StackVal, iParam7);
		}
		if (bParam8)
		{
			bVar1 = Function_82(StackVal, iParam7);
		}
		if (!IS_ACTOR_VALID(bVar1))
		{
			vVar3.x = iParam3;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x3F08 / 16136
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_81(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3F28 / 16168
{
	bool bVar0;
...
int Function_82(bool bParam0, bool bParam1) //Position: 0x3F7C / 16252
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x4000 / 16384
{
	Function_85(bParam0);
	Function_84(bParam0);
...
void Function_84(bool bParam0) //Position: 0x4026 / 16422
{
...
void Function_85(bool bParam0) //Position: 0x404A / 16458
{
...
bool Function_86(bool bParam0) //Position: 0x4119 / 16665
{
...
int Function_87(int iParam0, bool bParam1) //Position: 0x4130 / 16688
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(int iParam0, bool bParam1, bool bParam2) //Position: 0x41C3 / 16835
{
	bool bVar0;
	bool bVar1;
...
void Function_89(bool bParam0) //Position: 0x42BA / 17082
{
	bool bVar0;
...
bool Function_90(var uParam0, bool bParam1) //Position: 0x42E6 / 17126
{
	int iVar0;
...
bool Function_91(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4302 / 17154
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
		...
		if (Function_94(iVar1))
		{
			if (Function_101(iParam1))
			{
				if (!IS_ACTOR_VALID(*uParam0))
				{
					...
					*uParam0 = Function_79(Global_3422[iParam240].f_36, 0, 1, vVar2.x, vVar2.y, vVar2.z, uParam8, uParam9, uParam10);
				}
			}
		}
	}
...
bool Function_92(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x44CB / 17611
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_17(bParam0);
...
void Function_93() //Position: 0x4555 / 17749
{
	bool bVar0;
	bool bVar1;
...
bool Function_94(int iParam0) //Position: 0x45BA / 17850
{
...
bool Function_95(bool bParam0) //Position: 0x45D6 / 17878
{
...
var Function_96(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x45EC / 17900
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_97(int iParam0) //Position: 0x468C / 18060
{
	bool bVar0;
	int iVar1;
	...
	if (!iParam0->f_128 != 0)
	{
		switch (Global_63399)
		{
			...
			case 0x00000004:
				if (!Function_23(iParam0 + 128, 128))
				{
					return 0;
				}
				break;
			...
			case 0x00000008:
				if (!Function_23(iParam0 + 128, 256))
				{
					return 0;
				}
				break;
			...
			case 0x00000010:
				if (!Function_23(iParam0 + 128, 512))
				{
					return 0;
				}
				break;
			...
			case 0x00000020:
				if (!Function_23(iParam0 + 128, 1024))
				{
					return 0;
				}
				break;
		}
		if (Function_23(iParam0 + 128, 4096))
		{
			if (Function_23(iParam0 + 128, 1))
			{
...
var Function_98(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4786 / 18310
{
	int iVar0;
	int iVar1;
...
void Function_99(var uParam0, int iParam1) //Position: 0x47BE / 18366
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_100(var uParam0, int iParam1, int iParam2) //Position: 0x47CF / 18383
{
	int iVar0;
...
bool Function_101(int iParam0) //Position: 0x4893 / 18579
{
	int iVar0;
	int iVar1;
...
void Function_102() //Position: 0x4C0E / 19470
{
	if (!Function_149(128))
	{
		return;
...
bool Function_103() //Position: 0x4C4E / 19534
{
	int iVar0;
...
void Function_104() //Position: 0x4C79 / 19577
{
	if (!Function_149(128))
	{
		return;
...
void Function_105(int iParam0, bool bParam1) //Position: 0x4CBB / 19643
{
	char* cVar0[32];
...
void Function_106(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4D3F / 19775
{
	var uVar0;
	var uVar1;
...
void Function_107(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4D68 / 19816
{
...
var Function_108(var uParam0, bool bParam1) //Position: 0x4DB9 / 19897
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_109() //Position: 0x4DC9 / 19913
{
	return "PackedGrass";
}

var Function_110(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4DDD / 19933
{
	int iVar0;
...
var Function_111() //Position: 0x4E02 / 19970
{
	return "PackedMetadata";
}

void Function_112(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4E19 / 19993
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_113() //Position: 0x4F44 / 20292
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_114() //Position: 0x4F55 / 20309
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_115() //Position: 0x4F66 / 20326
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_116(var uParam0, int iParam1) //Position: 0x4F77 / 20343
{
...
var Function_117(var uParam0, int iParam1, bool bParam2) //Position: 0x4F9A / 20378
{
	int iVar0;
...
var Function_118(bool bParam0) //Position: 0x4FB9 / 20409
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_119() //Position: 0x4FC5 / 20421
{
	return Function_120(39);
}

int Function_120(bool bParam0) //Position: 0x4FD0 / 20432
{
	bool bVar0;
...
var Function_121() //Position: 0x4FFE / 20478
{
	return "PackedWeapon";
}

int Function_122(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5013 / 20499
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_123() //Position: 0x5117 / 20759
{
	return "MPItemGiver";
}

struct<32> Function_124(bool bParam0) //Position: 0x512B / 20779
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_125(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5195 / 20885
{
	char* cVar0[32];
...
var Function_126() //Position: 0x51B4 / 20916
{
	return "PBox_";
}

var Function_127() //Position: 0x51C2 / 20930
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_128() //Position: 0x51E8 / 20968
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_129() //Position: 0x5210 / 21008
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_130(var uParam0, int iParam1) //Position: 0x5236 / 21046
{
	int iVar0;
	var uVar1;
...
void Function_131(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5397 / 21399
{
	struct<8> Var0;
...
int Function_132(bool bParam0) //Position: 0x5432 / 21554
{
	int iVar0;
	vector3 vVar1;
...
void Function_133(int iParam0) //Position: 0x5593 / 21907
{
...
var Function_134() //Position: 0x55F4 / 22004
{
	int iVar0;
...
var Function_135(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x55FC / 22012
{
	return Function_136(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_136(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x5615 / 22037
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_137(int iParam0) //Position: 0x5908 / 22792
{
	int iVar0;
...
void Function_138() //Position: 0x59BC / 22972
{
	int iVar0;
...
bool Function_139(bool bParam0) //Position: 0x59F6 / 23030
{
	int iVar0;
...
void Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5A23 / 23075
{
	bool bVar0;
...
void Function_141() //Position: 0x5B74 / 23412
{
	int iVar0;
...
var Function_142(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5BBF / 23487
{
	int iVar0;
...
int Function_143() //Position: 0x5C8F / 23695
{
	int iVar0;
...
int Function_144() //Position: 0x5DEB / 24043
{
	int iVar0;
...
bool Function_145(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5F0B / 24331
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_146(var uParam0, int iParam1) //Position: 0x5FDB / 24539
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_147(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5FF9 / 24569
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_148(bool bParam0) //Position: 0x612B / 24875
{
	bool bVar0;
...
bool Function_149(int iParam0) //Position: 0x614A / 24906
{
	int iVar0;
...
int Function_150() //Position: 0x6166 / 24934
{
	if (Function_152())
	{
...
int Function_151() //Position: 0x617F / 24959
{
	return Global_79349.f_16;
}

bool Function_152() //Position: 0x618B / 24971
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_153(int iParam0, bool bParam1, bool bParam2) //Position: 0x6194 / 24980
{
	var uVar0;
