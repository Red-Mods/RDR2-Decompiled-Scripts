...
vector3 Function_63(vector3 vParam0) //Position: 0x283A / 10298
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2897 / 10391
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28F4 / 10484
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28FE / 10494
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x291C / 10524
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2931 / 10545
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29B8 / 10680
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29DB / 10715
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29F9 / 10745
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A1C / 10780
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B37 / 11063
{
...
int Function_74(bool bParam0) //Position: 0x2B62 / 11106
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C67 / 11367
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C74 / 11380
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CE7 / 11495
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31E5 / 12773
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x321C / 12828
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3239 / 12857
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3271 / 12913
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x327B / 12923
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x329C / 12956
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (bLocal_1)
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32E8 / 13032
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33F0 / 13296
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3406 / 13318
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x36BC / 14012
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_96(var uParam0, int iParam1) //Position: 0x3AF8 / 15096
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B07 / 15111
{
...
void Function_98(int iParam0) //Position: 0x3B23 / 15139
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B2D / 15149
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B8F / 15247
{
...
void Function_101(int iParam0) //Position: 0x3BA3 / 15267
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BAD / 15277
{
