...
void Function_29(var uParam0, int iParam1) //Position: 0x1D41 / 7489
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	bLocal_1 = GRINGO_GET_MY_OBJECT_REF();
	return;
}

bool Function_30(int iParam0) //Position: 0x1D54 / 7508
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D5F / 7519
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D79 / 7545
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1D97 / 7575
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DB6 / 7606
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DE9 / 7657
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E08 / 7688
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E22 / 7714
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E35 / 7733
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x211D / 8477
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2125 / 8485
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2142 / 8514
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2151 / 8529
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2173 / 8563
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2197 / 8599
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21B4 / 8628
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21D4 / 8660
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x21F4 / 8692
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22A2 / 8866
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2312 / 8978
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2328 / 9000
{
...
var Function_51(bool bParam0) //Position: 0x2349 / 9033
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2369 / 9065
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x237D / 9085
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2387 / 9095
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x238E / 9102
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x239D / 9117
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x23DC / 9180
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2407 / 9223
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2412 / 9234
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2508 / 9480
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x252A / 9514
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2551 / 9553
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2810 / 10256
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x286D / 10349
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28CA / 10442
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28D4 / 10452
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28F2 / 10482
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2907 / 10503
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x298E / 10638
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29B1 / 10673
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29CF / 10703
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29F2 / 10738
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B0D / 11021
{
...
int Function_74(bool bParam0) //Position: 0x2B38 / 11064
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C3D / 11325
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C4A / 11338
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CBD / 11453
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31BB / 12731
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x31F2 / 12786
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x320F / 12815
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3247 / 12871
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3251 / 12881
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3272 / 12914
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3280 / 12928
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3388 / 13192
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x339E / 13214
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3654 / 13908
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x3662 / 13922
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x367B / 13947
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x3695 / 13973
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36CD / 14029
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36E4 / 14052
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39AD / 14765
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39CA / 14794
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A66 / 14950
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A85 / 14981
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3A94 / 14996
{
...
void Function_98(int iParam0) //Position: 0x3AB0 / 15024
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3ABA / 15034
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B1C / 15132
{
...
void Function_101(int iParam0) //Position: 0x3B30 / 15152
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B3A / 15162
{
