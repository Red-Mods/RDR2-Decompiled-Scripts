...
void main() //Position: 0x0 / 0
{
	...
	iLocal_2 = 33;
	iLocal_3 = 1;
	vLocal_12 = { -57.72f, 116.695f, 1391.078f };
	iLocal_17 = 2;
	iLocal_18 = 4;
	fLocal_19 = 70.0f;
...
void Function_3() //Position: 0x20C / 524
{
	Function_22(52);
	Function_21();
	Function_4(12, bLocal_8, bLocal_9, &uLocal_4, bLocal_10, 52);
	return;
}
...
var Function_29(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x12FF / 4863
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_17 || bParam2) || Global_3370)
			{
				if (Function_151(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					if (((!bParam2 && !Function_150(iParam0 + 200, &fLocal_19, 256, 0)) && !Global_3370) && !Function_156())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_139(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_19, 20.0f, fLocal_19);
		...
		case 0x0000000B:
			...
			if ((iParam0->f_268 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player")) && !iParam0->f_276)
			{
				if (SQUAD_IS_VALID(iParam0->f_244) && SQUAD_GET_SIZE(iParam0->f_244) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_21) < 10.0f)
						{
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_10(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_20, iParam0 + 312, 0, 0, 0x40400000))
						{
...
void Function_30(int iParam0) //Position: 0x22FD / 8957
{
	*iParam0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, *iParam0 };
	...
	{
		if (Function_36(StackVal, StackVal, bLocal_8, vLocal_12, 5.0f) && !GET_TASK_STATUS(bLocal_8, 19) != 1)
		{
			TASK_USE_GRINGO(bLocal_8, GET_GRINGO_FROM_OBJECT(bLocal_11), "UseCase1", 4294967295, 1);
			if (!IS_ACTOR_IN_VOLUME(Global_34573, FIND_VOLUME_IN_LAYOUT(FIND_NAMED_LAYOUT("regions_layout"), "launch_Home02Son01")))
			{
				Function_34(52);
			}
		}
		else if ((GET_CURRENT_GAME_TIME() - fLocal_16) < 300.0f)
		{
			Function_34(52);
		}
		if ((Function_31(bLocal_8, Global_34573, 15.0f) && (GET_CURRENT_GAME_TIME() - fLocal_15) < 60.0f) && MEMORY_GET_IS_VISIBLE(bLocal_8, Global_34573))
		{
...
int Function_31(var uParam0, var uParam1, float fParam2) //Position: 0x23D8 / 9176
{
	float fVar0;
...
var Function_32(bool bParam0, bool bParam1) //Position: 0x23F5 / 9205
{
	var uVar0;
	int iVar3;
	int iVar6;
...
float Function_33(var uParam0, int iParam1) //Position: 0x2414 / 9236
{
	vector3 vVar0;
	bool bVar3;
...
void Function_34(int iParam0) //Position: 0x2432 / 9266
{
...
void Function_35(var uParam0, int iParam1) //Position: 0x245F / 9311
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_36(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x246E / 9326
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_20(bParam0);
...
void Function_37(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x24F8 / 9464
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_38(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x26F6 / 9974
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_39(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2710 / 10000
{
	bool bVar0;
	bool bVar1;
...
int Function_40(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x27F0 / 10224
{
	char* cVar0[32];
...
int Function_41(bool bParam0) //Position: 0x2A3E / 10814
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_42(bool bParam0, bool bParam1) //Position: 0x2A61 / 10849
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_43(bool bParam0, bool bParam1) //Position: 0x2A84 / 10884
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_44(bool bParam0, bool bParam1) //Position: 0x2AA8 / 10920
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x2ACE / 10958
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_46(bool bParam0) //Position: 0x2AF1 / 10993
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_47() //Position: 0x2B0F / 11023
{
...
bool Function_48(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2B59 / 11097
{
	bool bVar0;
	bool bVar1;
...
bool Function_49(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2BAB / 11179
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x2BC7 / 11207
{
	bool bVar0;
	bool bVar1;
...
void Function_51(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2C19 / 11289
{
	bool bVar0;
	bool bVar1;
...
var Function_52() //Position: 0x2C5E / 11358
{
...
void Function_53(int iParam0, bool bParam1, bool bParam2) //Position: 0x2C73 / 11379
{
	bool bVar0;
	bool bVar1;
...
bool Function_54(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2D96 / 11670
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_55(vector3 vParam0) //Position: 0x2E04 / 11780
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_56(bool bParam0) //Position: 0x2E1C / 11804
{
	bool bVar0;
	bool bVar1;
...
var Function_57(bool bParam0) //Position: 0x2E73 / 11891
{
	bool bVar0;
	bool bVar1;
...
void Function_58(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2EB9 / 11961
{
	bool bVar0;
	bool bVar1;
...
void Function_59(bool bParam0, bool bParam1) //Position: 0x2F27 / 12071
{
	bool bVar0;
	bool bVar1;
...
void Function_60(bool bParam0) //Position: 0x2F6F / 12143
{
	struct<21> Var0;
...
bool Function_61() //Position: 0x302D / 12333
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_62(int iParam0) //Position: 0x3040 / 12352
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_63(int iParam0) //Position: 0x30F1 / 12529
{
...
bool Function_64(int iParam0) //Position: 0x3110 / 12560
{
...
bool Function_65(int iParam0) //Position: 0x3134 / 12596
{
...
bool Function_66(int iParam0) //Position: 0x3149 / 12617
{
...
bool Function_67(int iParam0, bool bParam1) //Position: 0x3160 / 12640
{
	int iVar0;
...
var Function_68(int iParam0) //Position: 0x319D / 12701
{
...
bool Function_69(int iParam0) //Position: 0x31B7 / 12727
{
...
int Function_70(int iParam0, int iParam1) //Position: 0x31CD / 12749
{
	int iVar0;
...
void Function_71(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x3206 / 12806
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_72(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x32D3 / 13011
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_73(bool bParam0, bool bParam1) //Position: 0x346A / 13418
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_74(bool bParam0) //Position: 0x348C / 13452
{
	bool bVar0;
	bool bVar1;
...
var Function_75(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x34D0 / 13520
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_76(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x3619 / 13849
{
	var uVar0[5];
	int iVar6;
...
int Function_77(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x36BA / 14010
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_78(int iParam0, int iParam1) //Position: 0x374E / 14158
{
	iParam1 = iParam1;
	Function_103(&uLocal_4, "$/content/scripting/gringo/simplegringo/jake_read", 1, 0);
	if (Function_85(&bLocal_8, &uLocal_4, 52, 1, 1, 0, 1, 0, 0, 0, 0))
	{
		if (Function_82(iParam1))
		{
			bLocal_9 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_0, Function_139()));
			Global_3422[5240].f_156 = bLocal_9;
...
void Function_79() //Position: 0x37D7 / 14295
{
	vector3 vVar0;
	
	bLocal_10 = CREATE_LAYOUT("home02son01campfirelayout");
	bLocal_11 = CREATE_GRINGO_IN_LAYOUT(bLocal_10, "home02son01eat", "njake_read", -57.594f, 116.589f, 1390.992f, 0.0f, 15.0f, 0.0f);
	SNAP_OBJECT_TO_GROUND(bLocal_11, 2.0f, false, 1092616192);
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bLocal_11), 0);
	if (!Function_36(StackVal, StackVal, Global_34573, vLocal_12, 100.0f))
	{
	...
	fLocal_15 = (GET_CURRENT_GAME_TIME() - 50.0f);
	fLocal_16 = GET_CURRENT_GAME_TIME();
	return;
}

void Function_80(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x38EE / 14574
{
	bool bVar0;
	bool bVar1;
...
bool Function_81(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3A78 / 14968
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_82(int iParam0) //Position: 0x3AB8 / 15032
{
	var uVar0;
	
	Function_84(3, 2);
	uVar0 = uVar0;
	bLocal_0 = GET_LAYOUT_FROM_OBJECT(CREATE_MOBILE_LAYOUT("home02son_camp01_mobile"));
	Function_83(bLocal_0, iParam0);
	return 1;
}

void Function_83(bool bParam0, bool bParam1) //Position: 0x3AF1 / 15089
{
	var uVar0;
...
void Function_84(int iParam0, bool bParam1) //Position: 0x3B33 / 15155
{
	switch (bParam1)
	{
		case 0x00000000:
...
bool Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3B7C / 15228
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3D45 / 15685
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x4230 / 16944
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_88(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4250 / 16976
{
	bool bVar0;
...
int Function_89(bool bParam0, bool bParam1) //Position: 0x42A4 / 17060
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x4324 / 17188
{
	Function_92(bParam0);
	Function_91(bParam0);
...
void Function_91(bool bParam0) //Position: 0x434A / 17226
{
...
void Function_92(bool bParam0) //Position: 0x436E / 17262
{
...
bool Function_93(bool bParam0) //Position: 0x443D / 17469
{
...
int Function_94(int iParam0, bool bParam1) //Position: 0x4454 / 17492
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x44E7 / 17639
{
	bool bVar0;
	bool bVar1;
...
void Function_96(bool bParam0) //Position: 0x45DE / 17886
{
	bool bVar0;
...
bool Function_97(int iParam0, int iParam1) //Position: 0x460A / 17930
{
	int iVar0;
...
void Function_98() //Position: 0x4626 / 17958
{
	bool bVar0;
	bool bVar1;
...
bool Function_99(int iParam0) //Position: 0x468B / 18059
{
...
bool Function_100(bool bParam0) //Position: 0x46A7 / 18087
{
...
var Function_101(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x46BD / 18109
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_102(int iParam0) //Position: 0x475D / 18269
{
	bool bVar0;
	int iVar1;
...
var Function_103(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4857 / 18519
{
	int iVar0;
	int iVar1;
...
void Function_104(var uParam0, int iParam1) //Position: 0x488F / 18575
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_105(var uParam0, int iParam1, int iParam2) //Position: 0x48A0 / 18592
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x4964 / 18788
{
	int iVar0;
	int iVar1;
...
void Function_107() //Position: 0x4CDF / 19679
{
	if (!Function_153(128))
	{
		return;
...
bool Function_108() //Position: 0x4D1F / 19743
{
	int iVar0;
...
void Function_109() //Position: 0x4D4A / 19786
{
	if (!Function_153(128))
	{
		return;
...
void Function_110(int iParam0, bool bParam1) //Position: 0x4D8C / 19852
{
	char* cVar0[32];
...
void Function_111(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4E10 / 19984
{
	var uVar0;
	var uVar1;
...
void Function_112(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4E39 / 20025
{
...
var Function_113(var uParam0, bool bParam1) //Position: 0x4E8A / 20106
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_114() //Position: 0x4E9A / 20122
{
	return "PackedGrass";
}

var Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4EAE / 20142
{
	int iVar0;
...
var Function_116() //Position: 0x4ED3 / 20179
{
	return "PackedMetadata";
}

void Function_117(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4EEA / 20202
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_118() //Position: 0x5015 / 20501
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_119() //Position: 0x5026 / 20518
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_120() //Position: 0x5037 / 20535
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_121(var uParam0, int iParam1) //Position: 0x5048 / 20552
{
...
var Function_122(var uParam0, int iParam1, bool bParam2) //Position: 0x506B / 20587
{
	int iVar0;
...
var Function_123(bool bParam0) //Position: 0x508A / 20618
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_124() //Position: 0x5096 / 20630
{
	return Function_125(39);
}

int Function_125(bool bParam0) //Position: 0x50A1 / 20641
{
	bool bVar0;
...
var Function_126() //Position: 0x50CF / 20687
{
	return "PackedWeapon";
}

int Function_127(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x50E4 / 20708
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
struct<32> Function_129(bool bParam0) //Position: 0x51FC / 20988
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_130(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5266 / 21094
{
	char* cVar0[32];
...
var Function_131() //Position: 0x5285 / 21125
{
	return "PBox_";
}

var Function_132() //Position: 0x5293 / 21139
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_133() //Position: 0x52B9 / 21177
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_134() //Position: 0x52E1 / 21217
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_135(var uParam0, int iParam1) //Position: 0x5307 / 21255
{
	int iVar0;
	var uVar1;
...
void Function_136(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5468 / 21608
{
	struct<8> Var0;
...
int Function_137(bool bParam0) //Position: 0x5503 / 21763
{
	int iVar0;
	vector3 vVar1;
...
void Function_138(int iParam0) //Position: 0x5664 / 22116
{
...
var Function_139() //Position: 0x56C5 / 22213
{
	int iVar0;
...
var Function_140(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x56CD / 22221
{
	return Function_141(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_141(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x56E6 / 22246
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_142(int iParam0) //Position: 0x59D9 / 23001
{
	int iVar0;
...
void Function_143() //Position: 0x5A8D / 23181
{
	int iVar0;
...
bool Function_144(bool bParam0) //Position: 0x5AC7 / 23239
{
	int iVar0;
...
void Function_145(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5AF4 / 23284
{
	bool bVar0;
...
void Function_146() //Position: 0x5C45 / 23621
{
	int iVar0;
...
var Function_147(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5C90 / 23696
{
	int iVar0;
...
int Function_148() //Position: 0x5D60 / 23904
{
	int iVar0;
...
int Function_149() //Position: 0x5EBC / 24252
{
	int iVar0;
...
bool Function_150(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5FDC / 24540
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_151(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x60AC / 24748
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_152(bool bParam0) //Position: 0x61DE / 25054
{
	bool bVar0;
...
bool Function_153(int iParam0) //Position: 0x61FD / 25085
{
	int iVar0;
...
int Function_154() //Position: 0x6219 / 25113
{
	if (Function_156())
	{
...
int Function_155() //Position: 0x6232 / 25138
{
	return Global_79349.f_16;
}

bool Function_156() //Position: 0x623E / 25150
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_157(int iParam0, bool bParam1, bool bParam2) //Position: 0x6247 / 25159
{
	var uVar0;
