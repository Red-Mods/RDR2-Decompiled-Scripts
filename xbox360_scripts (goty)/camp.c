...
void Function_57(var uParam0, var uParam1, int iParam2) //Position: 0x2C1F / 11295
{
	uParam0 = Function_60(uParam0);
	uParam1 = uParam1;
	if (!Function_45(Global_63084.f_32, 1))
	{
		Function_39(&Global_63084 + 32, 1);
	}
	if (!Function_59(Global_76846, 4096))
	{
		Function_58(&Global_76846, 4096);
	}
	if (!Function_59(Global_76846, 8192))
	{
		Function_58(&Global_76846, 8192);
	}
	iLocal_3 = 0;
	*iParam2 = 1;
	return;
...
void Function_58(var uParam0, int iParam1) //Position: 0x2C7D / 11389
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_59(var uParam0, int iParam1) //Position: 0x2C8C / 11404
{
...
var Function_60(bool bParam0) //Position: 0x2C9F / 11423
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_61(int iParam0, bool bParam1) //Position: 0x2CB9 / 11449
{
	bool bVar0;
	bool bVar1;
