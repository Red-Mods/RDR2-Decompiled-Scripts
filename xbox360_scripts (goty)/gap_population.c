...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		...
		if (IS_VOLUME_VALID(bVar2))
		{
			...
			Function_3(bVar2, uVar3, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xE8C / 3724
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0x100A / 4106
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1076 / 4214
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x10E2 / 4322
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1127 / 4391
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1133 / 4403
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x11AF / 4527
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x11BC / 4540
{
	if (!Function_4(128))
	{
		return;
