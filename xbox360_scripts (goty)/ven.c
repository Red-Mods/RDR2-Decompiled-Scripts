...
void Function_1() //Position: 0x77 / 119
{
	if (NET_SCRIPT_GET_NUM_PARTICIPANTS() == 1)
	{
		...
		{
			Function_88(bLocal_19, Global_78576, -1.0f, -1.0f, 1, 1);
		}
	}
...
void Function_11(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x54C / 1356
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
void Function_44(bool bParam0, bool bParam1) //Position: 0x14BE / 5310
{
...
void Function_83(bool bParam0) //Position: 0x1A9C / 6812
{
	bool bVar0;
...
void Function_88(bool bParam0, var uParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x1C72 / 7282
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_89(var uParam0, bool bParam1) //Position: 0x1CC2 / 7362
{
	bool bVar0;
	bool bVar1;
	float fVar2;
	...
	while (bVar0 < (GET_ACTORSET_SIZE(bParam1) - 1))
	{
		...
		{
			fVar3 = Function_90(uParam0, GET_ACTOR_FROM_ACTORSET(bParam1, bVar0));
			if (fVar3 > fVar2)
			{
				fVar2 = fVar3;
				bVar1 = bVar0;
...
{
	if (!Function_359(&Local_103, &bLocal_130, 47265, 1, 0))
	{
		return 0;
	}
	if (StackVal != 11)
...
void Function_179(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4E12 / 19986
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_183(iParam0), fParam1, true, 0);
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_183(iParam0), &cVar0, 2, 2, true);
	}
...
void Function_180(bool bParam0, bool bParam1) //Position: 0x4EC9 / 20169
{
	bool bVar0;
...
void Function_185(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x50EE / 20718
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_183(iParam0), 1.0f, false, 0);
...
void Function_198(bool bParam0, bool bParam1) //Position: 0x5D2D / 23853
{
...
void Function_210(int iParam0, int iParam1) //Position: 0x5F80 / 24448
{
	...
	if (!bVar0)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_183(iParam0), &Var7, 0, 2, false);
		PREPEND_JOURNAL_ENTRY(Function_183(iParam0), true);
		SET_JOURNAL_ENTRY_PROGRESS(Function_183(iParam0), 1.0f, false, 0);
	}
	return;
}
...
void Function_219(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x640C / 25612
{
	...
	if ((bParam3 && Function_181(iParam0, 4)) || !bParam3)
	{
		if (!bVar0)
		{
			PREPEND_JOURNAL_ENTRY(Function_183(iParam0), false);
			Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_212(iParam0) };
			Var7 = { StackVal, StackVal, StackVal, Function_182(iParam0) };
			UI_SET_STRING(&Var1, UI_GET_STRING(&Var7));
...
void Function_235(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6AA3 / 27299
{
	struct<4> Var0;
	int iVar4;
...
int Function_243(bool bParam0) //Position: 0x6CDC / 27868
{
	float fVar0;
...
void Function_270() //Position: 0x777B / 30587
{
	...
	{
		case 0x00000000:
			Function_281(&Local_103, 0);
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				NET_OBJECT_REPLICATION_MODE_START(15, 5);
				Function_272(1, "d");
				NET_OBJECT_REPLICATION_MODE_END(15);
				Function_271(bLocal_164, bLocal_19, 0, 0);
			}
			if (Function_67(&iLocal_165))
			{
				Function_353(&iLocal_165, 15.0f);
			}
			Function_235("aa_ven_kill_bosses", 0x40f00000, 1, 2, 0, 0, 0, 0);
			Local_103.f_8 = 6;
...
void Function_271(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x7860 / 30816
{
	bool bVar0;
	bool bVar1;
...
void Function_272(char* cParam0, bool bParam1) //Position: 0x78E2 / 30946
{
	...
	iLocal_131 = Function_280();
	AMBIENT_SET_ONESHOT_QUERIES(0);
	AMBIENT_SET_RANDOM_SEARCH_ORDER(1);
	vVar0 = { -2013.617f, 42.041f, 3033.526f };
	fVar3 = 30.0f;
	fVar4 = 75.0f;
	switch (iLocal_131)
	{
...
var Function_273(int iParam0, char* cParam1, vector3 vParam2, var uParam5, char* cParam6, float fParam7, float fParam8, bool bParam9, bool bParam10) //Position: 0x7A52 / 31314
{
	struct<4> Var0;
	bool bVar4;
...
void Function_274(bool bParam0, bool bParam1) //Position: 0x7AA6 / 31398
{
...
void Function_275(bool bParam0, bool bParam1) //Position: 0x7ADE / 31454
{
	switch (bParam1)
	{
		case 0x00000000:
...
bool Function_276(bool bParam0, bool bParam1, bool bParam2) //Position: 0x7BD0 / 31696
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
var Function_277(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x7C10 / 31760
{
	var uVar0;
	vector3 vVar3;
	var uVar6;
...
void Function_278(char* cParam0, bool bParam1) //Position: 0x7CAF / 31919
{
...
var Function_279() //Position: 0x7CE9 / 31977
{
	return cLocal_99;
}

int Function_280() //Position: 0x7CF1 / 31985
{
	int iVar0;
	int iVar1;
...
void Function_281(var uParam0, bool bParam1) //Position: 0x7D20 / 32032
{
	struct<9> Var0;
...
void Function_282() //Position: 0x7D57 / 32087
{
	bool bVar0;
...
void Function_283(bool bParam0) //Position: 0x7E1C / 32284
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_284(char* cParam0, int iParam1) //Position: 0x7EB9 / 32441
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	switch (iLocal_131)
	{
		case 0x00000003:
			...
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 493, "drunkndirty_drunkndirty_02", fVar3, fVar4, 1, 1);
			...
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 491, "drunkndirty_drunkndirty_05", fVar3, fVar4, 1, 9);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 486, "drunkndirty_drunkndirty_06", fVar3, fVar4, 1, 18);
		
		case 0x00000002:
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 486, "drunkndirty_drunkndirty_07", fVar3, fVar4, 1, 16);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 487, "drunkndirty_drunkndirty_08", fVar3, fVar4, 1, 17);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 488, "drunkndirty_drunkndirty_09", fVar3, fVar4, 1, 5);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 492, "drunkndirty_drunkndirty_10", fVar3, fVar4, 1, 9);
		...
		case 0x00000001:
			...
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 490, "drunkndirty_drunkndirty_13", fVar3, fVar4, 1, 1);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 486, "drunkndirty_drunkndirty_14", fVar3, fVar4, 1, 9);
			Function_273(StackVal, StackVal, cParam0, iParam1, vVar0, 487, "drunkndirty_drunkndirty_15", fVar3, fVar4, 1, 9);
			break;
	}
	return;
}

void Function_285() //Position: 0x8204 / 33284
{
	bool bVar0;
...
void Function_286() //Position: 0x82C9 / 33481
{
	bool bVar0;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			Function_353(&iLocal_165, 15.0f);
			Function_235("aa_ven_kill_reinf", 0x40f00000, 1, 2, 0, 0, 0, 0);
			Local_103.f_8 = 6;
			bVar0 = SQUAD_GET_SIZE(bLocal_164);
			PRINTSTRING("ENEMY SQUAD CONTAINS: ");
			PRINTINT(bVar0);
...
void Function_287(var uParam0, int iParam1) //Position: 0x83AF / 33711
{
	bool bVar0;
	bool bVar1;
...
void Function_288() //Position: 0x844B / 33867
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	switch (StackVal)
	{
		case 0x00000000:
			Function_281(&Local_103, 0);
			Function_235("aa_ven_kill_bandits", 0x40f00000, 1, 2, 0, 0, 0, 0);
			vVar0 = { -2007.166f, 42.04128f, 3047.166f };
			vVar3 = { -2008f, 42.04128f, 3048.0f };
			vVar6 = { -2004f, 42.04128f, 3049.478f };
			vVar9 = { -2009.954f, 42.04128f, 3046.045f };
			vVar12 = { -2009.355f, 42.04128f, 3046.645f };
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				...
				GIVE_WEAPON_TO_ACTOR(bVar31, 16, 0, 1, 1);
...
void Function_289() //Position: 0x868C / 34444
{
	switch (StackVal)
	{
		case 0x00000000:
		...
		case 0x00000006:
			...
			Function_323();
			Local_323 = { -2013.597f, 42.041f, 3031.012f };
			*(&Local_323 + 12) = { 0.0f, 308.821f, 0.0f };
			Function_314(bLocal_130, &uLocal_178, 1, 1);
			Function_312(&Local_103, bLocal_130);
			Function_306();
			Function_305();
			bLocal_172 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "teleportVolume", 2, -2016.27f, 42.04128f, 3009.743f, 0.0f, 12.01753f, 0.0f, 9.681952f, 6.335802f, 4.606471f);
			bLocal_177 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "defendVolume", 3, -2013.19f, 42.041f, 3032.39f, 0.0f, 20.0f, 0.0f, 35.0f, 35.0f, 35.0f);
...
void Function_290(var uParam0) //Position: 0x87F0 / 34800
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_293(int iParam0) //Position: 0x8970 / 35184
{
...
void Function_294(int iParam0, bool bParam1) //Position: 0x8A05 / 35333
{
...
void Function_295(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x8A4D / 35405
{
	bool bVar0;
...
void Function_296(int iParam0) //Position: 0x8B60 / 35680
{
	Function_297(&Global_28842, iParam0);
	return;
}

void Function_297(var uParam0, var uParam1) //Position: 0x8B6E / 35694
{
...
void Function_298() //Position: 0x8B89 / 35721
{
...
void Function_299(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x8BA5 / 35749
{
...
void Function_300() //Position: 0x8C89 / 35977
{
	int iVar0;
...
int Function_301(int iParam0) //Position: 0x8CD7 / 36055
{
...
bool Function_302(int iParam0) //Position: 0x8CEF / 36079
{
...
void Function_303(bool bParam0, bool bParam1) //Position: 0x8D04 / 36100
{
	char[] cVar0[4];
...
void Function_304(var uParam0, var uParam1) //Position: 0x8DFE / 36350
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &uParam1);
	return;
}

void Function_305() //Position: 0x8E0B / 36363
{
	bLocal_173 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_130, "SpawnVol_0_set");
	bLocal_174 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "spawnVol_0_sub_0", 2, -2036.415f, 43.77168f, 3058.239f, 0.0f, -231.2987f, 0.0f, 5.0f, 5.0f, 5.0f);
	ADD_TO_VOLUME_SET(bLocal_173, bLocal_174);
	bLocal_175 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "spawnVol_0_sub_1", 2, -1992f, 44.24364f, 3060.0f, 0.0f, -126.5316f, 0.0f, 5.0f, 5.0f, 5.0f);
	ADD_TO_VOLUME_SET(bLocal_173, bLocal_175);
	bLocal_176 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "spawnVol_0_sub_2", 2, -1996f, 41.96558f, 2996.0f, 0.0f, -30.54318f, 0.0f, 5.0f, 5.0f, 5.0f);
	ADD_TO_VOLUME_SET(bLocal_173, bLocal_176);
	return;
}

void Function_306() //Position: 0x8EDA / 36570
{
	bLocal_164 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_130, "enemySquad"));
	SQUAD_GOAL_ADD_BATTLE_DEFEND_VOLUME(bLocal_164, false, bLocal_177, 4294967295);
	Function_311(0, Global_78576);
	SQUAD_GOAL_ADD_SHARE_PERCEPTION(bLocal_164, 0);
	SQUAD_SET_NOT_ELIMINATED_IMPAIRMENT_MASK(bLocal_164, 690824);
	Function_307(&bLocal_164);
	return;
}

void Function_307(int iParam0) //Position: 0x8F1E / 36638
{
	bool bVar0;
	...
	if (SQUAD_IS_VALID(*iParam0))
	{
		...
		while (bVar0 < 15)
		{
			if (IS_SLOT_VALID(bVar0))
			{
				...
				{
					Function_310(*iParam0, GET_SLOT_ACTOR(bVar0));
					Function_309(*iParam0, GET_SLOT_ACTOR(bVar0), 0);
					Function_308(*iParam0, GET_SLOT_ACTOR(bVar0), 4);
				}
			}
			bVar0++;
		}
...
void Function_308(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8FB4 / 36788
{
	bool bVar0;
	bool bVar1;
...
void Function_309(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8FF9 / 36857
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
void Function_310(bool bParam0, bool bParam1) //Position: 0x9064 / 36964
{
	bool bVar0;
	bool bVar1;
...
void Function_311(bool bParam0, bool bParam1) //Position: 0x90B6 / 37046
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_312(var uParam0, bool bParam1) //Position: 0x9178 / 37240
{
	Function_313(bParam1);
...
void Function_313(int iParam0) //Position: 0x91E9 / 37353
{
	Global_83591.f_140 = iParam0;
	return;
}

int Function_314(bool bParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x91F7 / 37367
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	while (bVar6 <= iVar13)
	{
		...
		bVar49 = false;
		if (DECOR_GET_INT_VERBOSE(bVar14, Function_321(), &iVar2))
		{
			if (iVar2 == 6)
			{
			}
			...
			{
				Function_320(bVar14);
				vVar7 = { StackVal, StackVal, Function_320(bVar14) };
				iVar3 = CLEAR_AREA_OF_GRASS(vVar7, 2.5f);
				iVar4 = CLEAR_AREA_OF_TREE_TYPE(vVar7, 2.5f, "");
				Function_319(bVar14);
				vVar10 = { StackVal, StackVal, Function_319(bVar14) };
				strcpy(&cVar17, GET_OBJECT_NAME(bVar14), 64);
				if (Function_317(iParam1, iVar2))
				{
					switch (iVar2)
					{
						case 0x00000001:
							bVar5 = DECOR_GET_INT(bVar14, Function_316());
							if (Function_264(bVar5))
							{
								if (Function_263((*iParam1 + 228)[bVar52]))
								{
									Function_244(StackVal, StackVal, StackVal, StackVal, &bVar15, &bVar16, bParam0, vVar7, vVar10, iVar2, bParam2, uParam3, &cVar17, iVar3, iVar4);
...
var Function_315() //Position: 0x942B / 37931
{
	return "XPBonus";
}

var Function_316() //Position: 0x943B / 37947
{
	return "ID";
}

bool Function_317(bool bParam0, int iParam1) //Position: 0x9446 / 37958
{
	switch (iParam1)
	{
		case 0x00000003:
...
bool Function_318() //Position: 0x949B / 38043
{
	return Function_40(Global_79962, 1024);
}

vector3 Function_319(bool bParam0) //Position: 0x94AB / 38059
{
	vector3 vVar0;
...
vector3 Function_320(bool bParam0) //Position: 0x94D2 / 38098
{
	vector3 vVar0;
...
var Function_321() //Position: 0x94F9 / 38137
{
	return "Type";
}

var Function_322() //Position: 0x9506 / 38150
{
	return "PickupFlagsSet";
}

void Function_323() //Position: 0x951D / 38173
{
	bLocal_320 = CREATE_OBJECTSET_IN_LAYOUT("PickupFlagsSet", bLocal_130, 8, 0);
	bLocal_321 = CREATE_POINT_IN_LAYOUT(bLocal_130, "f_Ammo_Pickup", -2010.618f, 42.04128f, 3009.274f, 0.0f, 100.4058f, 0.0f);
	Function_324(bLocal_321, 2, 4294967286);
	ADD_OBJECT_TO_OBJECTSET(bLocal_321, bLocal_320);
	bLocal_322 = CREATE_POINT_IN_LAYOUT(bLocal_130, "f_Ammo_Pickup1", -2003.564f, 42.04128f, 3044.436f, 0.0f, -396.9413f, 0.0f);
	Function_324(bLocal_322, 2, 4294967286);
	ADD_OBJECT_TO_OBJECTSET(bLocal_322, bLocal_320);
	return;
}

void Function_324(bool bParam0, bool bParam1, bool bParam2) //Position: 0x95C4 / 38340
{
	DECOR_SET_INT(iParam0, Function_321(), bParam1);
	if (bParam2 != 4294967286)
	{
		DECOR_SET_INT(bParam0, Function_316(), bParam2);
	}
	return;
}

var Function_325(int iParam0) //Position: 0x95E8 / 38376
{
...
bool Function_326() //Position: 0x9720 / 38688
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_327(int iParam0) //Position: 0x9739 / 38713
{
	int iVar0;
	int iVar1;
		...
		if (Function_87(iParam0[iVar03], 4))
		{
			if (!Function_87(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_87(iParam0[03], 8) || iVar1));
						break;
...
void Function_328() //Position: 0x9AB4 / 39604
{
	if (!Function_329(128))
	{
		return;
...
bool Function_329(int iParam0) //Position: 0x9AF4 / 39668
{
	int iVar0;
...
bool Function_330() //Position: 0x9B10 / 39696
{
	int iVar0;
...
void Function_331(var uParam0, int iParam1) //Position: 0x9B3B / 39739
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_332() //Position: 0x9B4C / 39756
{
	if (!Function_329(128))
	{
		return;
...
void Function_333(int iParam0, bool bParam1) //Position: 0x9B8E / 39822
{
...
void Function_334(int iParam0) //Position: 0x9BAA / 39850
{
	int iVar0;
...
void Function_335(var uParam0, int iParam1) //Position: 0x9BCA / 39882
{
	Function_336(uParam0, iParam1, 0);
	return;
}

void Function_336(int iParam0, int iParam1, int iParam2) //Position: 0x9BD8 / 39896
{
	(*iParam0 + 456)[iParam1] = iParam2;
	return;
}

void Function_337(int iParam0) //Position: 0x9BE9 / 39913
{
	int iVar0;
...
void Function_338(var uParam0, int iParam1) //Position: 0x9C16 / 39958
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_339(var uParam0) //Position: 0x9C22 / 39970
{
	Function_267(uParam0, 4294967295, 0, 1);
	return;
}

void Function_340() //Position: 0x9C30 / 39984
{
	...
	Function_341(&uLocal_132, 981, 2, 1);
	return;
}

var Function_341(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x9CB4 / 40116
{
	int iVar0;
...
var Function_342(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x9D84 / 40324
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_343(uParam0, iVar1, iParam2);
	if (bParam3)
	{
		Function_331(uParam0[iVar03], 8);
	}
...
var Function_343(var uParam0, int iParam1, int iParam2) //Position: 0x9DBC / 40380
{
	int iVar0;
...
bool Function_344(int iParam0) //Position: 0x9E80 / 40576
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
bool Function_345(int iParam0) //Position: 0x9F2C / 40748
{
...
void Function_346(int iParam0) //Position: 0x9F42 / 40770
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_347(int iParam0) //Position: 0x9F56 / 40790
{
	if (Function_67(iParam0))
	{
...
float Function_348(int iParam0) //Position: 0x9F71 / 40817
{
	return -Function_63(iParam0);
}

bool Function_349() //Position: 0x9F7D / 40829
{
	return iLocal_20;
}

void Function_350() //Position: 0x9F85 / 40837
{
	struct<13> Var0;
...
void Function_351(bool bParam0) //Position: 0x9FB1 / 40881
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 40963);
	return;
}

void Function_352(bool bParam0) //Position: 0xA003 / 40963
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
void Function_353(int iParam0, float fParam1) //Position: 0xA106 / 41222
{
	if (!Function_67(iParam0))
	{
...
void Function_354(int iParam0, float fParam1) //Position: 0xA11C / 41244
{
	Function_355(iParam0, -fParam1);
	return;
}

void Function_355(var uParam0, float fParam1) //Position: 0xA12A / 41258
{
	Function_64();
...
void Function_356(var uParam0, int iParam1) //Position: 0xA13E / 41278
{
	uParam0->f_4 = iParam1;
...
void Function_357(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4) //Position: 0xA15B / 41307
{
	int iVar0;
...
int Function_358(float fParam0) //Position: 0xA1A1 / 41377
{
	if (IS_PLAYER_IN_COMBAT(0))
	{
...
bool Function_359(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0xA1D5 / 41429
{
	if (!Function_401())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_372(45327, 44675);
			break;
		
		case 0x00000002:
			Function_372(42052, 41628);
			break;
...
int Function_360(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0xA29C / 41628
{
	bool bVar0;
	bool bVar1;
...
bool Function_361(bool bParam0, bool bParam1, int iParam2) //Position: 0xA33F / 41791
{
	var uVar0;
...
int Function_362(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0xA350 / 41808
{
	char* cVar0[32];
...
int Function_363(int iParam0, bool bParam1) //Position: 0xA3B5 / 41909
{
	char* cVar0[64];
...
void Function_364(bool bParam0, int iParam1, bool bParam2) //Position: 0xA423 / 42019
{
	if (bParam0)
	{
		if (Function_130())
...
int Function_365() //Position: 0xA444 / 42052
{
	if (!Function_366(1))
	{
		return 0;
...
bool Function_366(bool bParam0) //Position: 0xA500 / 42240
{
	char* cVar0[64];
...
void Function_367(bool bParam0) //Position: 0xA581 / 42369
{
...
var Function_368(int iParam0, bool bParam1) //Position: 0xA60A / 42506
{
	int iVar0;
...
struct<64> Function_369(var uParam0) //Position: 0xA62A / 42538
{
...
struct<64> Function_370(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0xA63E / 42558
{
	char* cVar0[64];
...
int Function_371(bool bParam0, bool bParam1) //Position: 0xA683 / 42627
{
...
void Function_372(int iParam0, int iParam1) //Position: 0xA6B7 / 42679
{
	Function_373(iParam0, iParam1, 44668);
	return;
}

void Function_373(var uParam0, var uParam1, int iParam2) //Position: 0xA6C8 / 42696
{
...
void Function_374() //Position: 0xA861 / 43105
{
	if (Function_39(4194304))
	{
...
void Function_375(var uParam0, var uParam1, int iParam2) //Position: 0xA96A / 43370
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_376(bool bParam0, int iParam1, bool bParam2) //Position: 0xAAE2 / 43746
{
	char* cVar0[64];
	int iVar16;
...
var Function_377(int iParam0) //Position: 0xAB63 / 43875
{
	switch (iParam0)
	{
		case 0x00000002:
...
int Function_378() //Position: 0xAE7C / 44668
{
	return 1;
}

int Function_379(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xAE83 / 44675
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_364(bParam1, iParam2, bParam3);
...
var Function_380(int iParam0) //Position: 0xB044 / 45124
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_381(int iParam0) //Position: 0xB057 / 45143
{
...
float Function_382(int iParam0, bool bParam1) //Position: 0xB077 / 45175
{
	char* cVar0[64];
...
int Function_383(bool bParam0) //Position: 0xB0E0 / 45280
{
	if (!Function_140(bParam0))
	{
		return 4294967295;
...
var Function_384() //Position: 0xB105 / 45317
{
	return Global_78480;
}

int Function_385() //Position: 0xB10F / 45327
{
	bool bVar0;
	int iVar1;
...
void Function_386() //Position: 0xB232 / 45618
{
	if (Function_39(4096))
	{
...
void Function_387(int iParam0) //Position: 0xB26F / 45679
{
	int iVar0;
	int iVar1;
...
void Function_388(int iParam0) //Position: 0xB2E8 / 45800
{
	struct<13> Var0;
...
void Function_389(int iParam0) //Position: 0xB313 / 45843
{
	bool bVar0;
...
void Function_390(var uParam0, bool bParam1) //Position: 0xB35A / 45914
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_391(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0xB4A5 / 46245
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_392(bool bParam0) //Position: 0xB587 / 46471
{
	bool bVar0;
...
void Function_393() //Position: 0xB5E1 / 46561
{
	Function_394(4);
	return;
}

void Function_394(int iParam0) //Position: 0xB5EB / 46571
{
	var uVar0;
	var uVar1;
...
void Function_395(bool bParam0) //Position: 0xB61D / 46621
{
	var uVar0;
...
void Function_396() //Position: 0xB62C / 46636
{
	bool bVar0;
	...
	if (!iLocal_22)
	{
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (IS_ACTORSET_VALID(bLocal_19))
			{
				if (Function_398(bVar0, bLocal_19, 1, 0, 0, -1.0f))
				{
					Function_397();
					iLocal_22 = 1;
				}
...
void Function_397() //Position: 0xB661 / 46689
{
	int iVar0;
...
bool Function_398(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0xB67A / 46714
{
	bool bVar0;
	...
	if (Function_400(bParam1, 0, 0, 0, 0, 0) < 0)
	{
		return 0;
	}
...
bool Function_399(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0xB6E3 / 46819
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_400(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xB7D0 / 47056
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_401() //Position: 0xB87E / 47230
{
	int iVar0;
...
void Function_402(bool bParam0) //Position: 0xB8A1 / 47265
{
	if (Function_403(bParam0))
	{
		Function_275(bParam0, NET_ACTOR_GET_SCRIPT_INT(bParam0));
		ADD_ACTOR_STAY_WITHIN_VOLUME(bParam0, bLocal_177);
...
bool Function_403(bool bParam0) //Position: 0xB8CC / 47308
{
	bool bVar0;
...
bool Function_404(bool bParam0) //Position: 0xB919 / 47385
{
...
bool Function_405(var uParam0, int iParam1) //Position: 0xB946 / 47430
{
	if (!Function_28())
	{
		return 0;
...
bool Function_406(int iParam0) //Position: 0xB966 / 47462
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 47779);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 47740);
	return 1;
}

void Function_407(bool bParam0) //Position: 0xBA7C / 47740
{
	int iVar0;
...
void Function_408(bool bParam0) //Position: 0xBAA3 / 47779
{
	struct<13> Var0;
...
void Function_409(bool bParam0) //Position: 0xBB1A / 47898
{
	struct<13> Var0;
...
void Function_410(var uParam0, int iParam1) //Position: 0xBB67 / 47975
{
	bool bVar0;
	bool bVar1;
...
void Function_411(int iParam0) //Position: 0xBBBC / 48060
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_412(int iParam0) //Position: 0xBBCE / 48078
{
...
void Function_413() //Position: 0xBC92 / 48274
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_414(bool bParam0, bool bParam1) //Position: 0xBCAB / 48299
{
	var uVar0;
...
void Function_415() //Position: 0xBCF7 / 48375
{
...
void Function_416() //Position: 0xBD16 / 48406
{
	Function_417(&Global_78480 + 220);
	return;
}

void Function_417(int iParam0) //Position: 0xBD25 / 48421
{
	int iVar0;
...
void Function_418(int iParam0) //Position: 0xBD46 / 48454
{
	int iVar0;
...
void Function_419(int iParam0) //Position: 0xBD6A / 48490
{
	int iVar0;
...
void Function_420(var uParam0, int iParam1) //Position: 0xBD8E / 48526
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_421(var uParam0) //Position: 0xBD9A / 48538
{
	uParam0 = uParam0;
	return;
}

void Function_422(int iParam0) //Position: 0xBDA4 / 48548
{
	if (!Function_67(iParam0))
	{
...
bool Function_423(var uParam0, bool bParam1) //Position: 0xBDB9 / 48569
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_424(bool bParam0) //Position: 0xBE6C / 48748
{
	bool bVar0;
