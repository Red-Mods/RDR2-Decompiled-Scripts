...
bool Function_9(var uParam0, int iParam1) //Position: 0x1D2 / 466
{
	var uVar0;
	bool bVar4;
	
	RAND_SET_SEED(FLOOR(GET_CURRENT_GAME_TIME()));
	*uParam0 = RAND_FLOAT_RANGE(-4267.259f, 708.6751f);
	uParam0->f_4 = 85.0f;
	uParam0->f_8 = RAND_FLOAT_RANGE(1228.936f, 4447.987f);
	RAND_SET_SEED(FLOOR(GET_CURRENT_GAME_TIME()));
	*iParam1 = RAND_FLOAT_RANGE(-4267.259f, 708.6751f);
	...
	while (Function_12(StackVal, StackVal, StackVal, StackVal, *uParam0, *iParam1))
	{
		*iParam1 = RAND_FLOAT_RANGE(-4267.259f, 708.6751f);
		iParam1->f_4 = RAND_FLOAT_RANGE(25.39853f, 100.5493f);
		iParam1->f_8 = RAND_FLOAT_RANGE(1228.936f, 4447.987f);
	...
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_38.f_24, &uVar0, *uParam0, *iParam1);
	if (IS_OBJECT_VALID(bVar4))
	{
		if (SNAP_OBJECT_TO_GROUND(bVar4, 100.0f, false, 1092616192))
		{
			GET_OBJECT_POSITION(bVar4, uParam0);
			uParam0->f_4 = (StackVal + 8.0f);
			return 1;
		}
...
bool Function_15(bool bParam0, float fParam1) //Position: 0x3D0 / 976
{
	if (Function_18(bParam0))
	{
		if (Function_16(bParam0) < fParam1)
		{
			return 1;
		}
	}
...
float Function_16(bool bParam0) //Position: 0x3EC / 1004
{
	if (Function_18(bParam0))
	{
...
bool Function_18(bool bParam0) //Position: 0x4C1 / 1217
{
...
void Function_20(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x580 / 1408
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_21(int iParam0) //Position: 0x5FB / 1531
{
	char* cVar0[16];
...
bool Function_22() //Position: 0x63A / 1594
{
...
void Function_23(var uParam0) //Position: 0x655 / 1621
{
	Function_6(uParam0, 0.0f);
	return;
}

void Function_24() //Position: 0x661 / 1633
{
	struct<13> Var0;
...
void Function_25() //Position: 0x767 / 1895
{
...
void Function_26() //Position: 0x796 / 1942
{
	Function_27(4096);
	return;
}

void Function_27(var uParam0) //Position: 0x7A2 / 1954
{
	int iVar0;
...
void Function_28() //Position: 0x7D6 / 2006
{
	Local_38.f_40 = 0;
