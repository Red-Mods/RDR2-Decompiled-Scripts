...
int Function_28(int iParam0, float fParam1, bool bParam2) //Position: 0x170C / 5900
{
	int iVar0;
	int iVar1;
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x1B69 / 7017
{
	...
	{
		Function_15(iParam0, 1, fParam1, 0, 1, 0x40400000, 0, 0);
	}
	if (Global_35278[iParam020].f_48 == 2)
	{
		iVar1 = 0;
...
void Function_53(int iParam0, int iParam1) //Position: 0x2B00 / 11008
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
int Function_54(int iParam0, bool bParam1, int iParam2) //Position: 0x2BAE / 11182
{
	int iVar0;
	bool bVar1;
	
	bVar1 = GET_GRINGO_STRING_ATTR(bParam1, iParam0, &iVar0);
	*iParam2 = iVar0 < 0;
	if (*iParam2)
	{
...
void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	...
	fVar1 = Function_64(uParam0, "HorseStaminaBoost", 0.0f);
	if ((IS_ACTOR_VALID(bVar0) && IS_ACTOR_ALIVE(bVar0)) && IS_ACTOR_MOUNTED(bVar0))
	{
		fVar2 = HORSE_GET_CURR_FRESHNESS(bVar0);
		if (fVar2 > fVar1)
		{
			HORSE_SET_CURR_FRESHNESS(bVar0, fVar1);
			fVar3 = GET_ACTOR_MAX_FRESHNESS(bVar0);
			if (fVar3 > 100.0f)
			{
				fVar3 = (fVar3 + 5.0f);
				if (fVar3 < 100.0f)
				...
				SET_ACTOR_MAX_FRESHNESS(bVar0, fVar3);
			}
			if ((Function_60(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
			{
				iLocal_3 = 0;
			}
			*iParam2 = 1;
		...
		{
			Function_58("horse_full_stamina", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
	{
		Function_58("apple_feed_horse", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2D1B / 11547
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2D96 / 11670
{
	char* cVar0[16];
...
int Function_60(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2DD5 / 11733
{
...
bool Function_61() //Position: 0x2E8B / 11915
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_62(int iParam0) //Position: 0x2EA2 / 11938
{
	return IS_ACTOR_IN_HOGTIE(iParam0);
}

bool Function_63(int iParam0) //Position: 0x2EAD / 11949
{
	return IS_ACTOR_VALID(GET_LASSO_USER(iParam0));
}

var Function_64(bool bParam0, bool bParam1, int iParam2) //Position: 0x2EBB / 11963
{
	int iVar0;
...
var Function_65(bool bParam0) //Position: 0x2ED1 / 11985
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_66(int iParam0, bool bParam1) //Position: 0x2EEB / 12011
{
	bool bVar0;
	bool bVar1;
