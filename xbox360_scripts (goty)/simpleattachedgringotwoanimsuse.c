...
bool Function_6(var uParam0, int iParam1) //Position: 0x400 / 1024
{
...
struct<16> Function_16(int iParam0) //Position: 0x615 / 1557
{
	char* cVar0[16];
...
bool Function_17() //Position: 0x654 / 1620
{
...
void Function_18(bool bParam0, bool bParam1) //Position: 0x66F / 1647
{
	int iVar0;
