...
void Function_5(bool bParam0, bool bParam1, int iParam2) //Position: 0x42B / 1067
{
	bool bVar0;
...
void Function_6(int iParam0, bool bParam1, bool bParam2) //Position: 0x511 / 1297
{
	int iVar0;
...
void Function_7() //Position: 0x68A / 1674
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_8(bool bParam0) //Position: 0x696 / 1686
{
	PRINTSTRING("Day ");
...
void Function_9(int iParam0) //Position: 0x6DC / 1756
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_10(var uParam0, int iParam1) //Position: 0x722 / 1826
{
	int iVar0;
...
bool Function_11(var uParam0, int iParam1) //Position: 0x73C / 1852
{
	int iVar0;
...
void Function_12(var uParam0, bool bParam1) //Position: 0x759 / 1881
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_13(var uParam0, int iParam1) //Position: 0xB25 / 2853
{
	int iVar0;
...
int Function_14(int iParam0, bool bParam1) //Position: 0xB3F / 2879
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
bool Function_15() //Position: 0xB51 / 2897
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_16(var uParam0, var uParam1, bool bParam2, var uParam3) //Position: 0xB5A / 2906
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_17(var uParam0, bool bParam1, int iParam2, var uParam3, bool bParam4) //Position: 0xBDB / 3035
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_18(int iParam0) //Position: 0xFF4 / 4084
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_19(int iParam0) //Position: 0x10F3 / 4339
{
...
float Function_20(int iParam0) //Position: 0x1130 / 4400
{
	if (!iParam0 != 4294967295)
	{
...
void Function_21(int iParam0, bool bParam1) //Position: 0x1169 / 4457
{
	bool bVar0;
...
var Function_22(int iParam0) //Position: 0x11D0 / 4560
{
	int iVar0;
...
int Function_23(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x1228 / 4648
{
	int iVar0;
	int iVar1;
...
void Function_24(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x1448 / 5192
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_25() //Position: 0x1A75 / 6773
{
	int iVar0;
...
var Function_26(int iParam0) //Position: 0x1A7D / 6781
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_27(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1A8E / 6798
{
	char* cVar0[32];
...
struct<32> Function_28(char* cParam0, bool bParam1) //Position: 0x1B83 / 7043
{
	char* cVar0[32];
...
void Function_29(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1B9C / 7068
{
	float fVar0;
...
var Function_30(int iParam0, int iParam1) //Position: 0x1C01 / 7169
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_31(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C13 / 7187
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_32(int iParam0) //Position: 0x1D43 / 7491
{
	return Global_35278[iParam020].f_48;
}

void Function_33(int iParam0) //Position: 0x1D52 / 7506
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_34(int iParam0, float fParam1, bool bParam2) //Position: 0x1EEC / 7916
{
	int iVar0;
	int iVar1;
...
void Function_35(var uParam0, int iParam1) //Position: 0x2130 / 8496
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_36(struct<5> Param0) //Position: 0x213D / 8509
{
...
bool Function_37(var uParam0, int iParam1) //Position: 0x2163 / 8547
{
	int iVar0;
...
var Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x217F / 8575
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_39() //Position: 0x240F / 9231
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_40(bool bParam0, bool bParam1) //Position: 0x2472 / 9330
{
...
bool Function_41(bool bParam0) //Position: 0x24A1 / 9377
{
	if (Function_46(256))
	{
		return 0;
...
int Function_42(int iParam0) //Position: 0x2517 / 9495
{
...
bool Function_43() //Position: 0x2528 / 9512
{
	if (Global_30619 == 2)
	{
		if (StackVal == 1)
...
bool Function_44(int iParam0) //Position: 0x2541 / 9537
{
...
bool Function_45(int iParam0) //Position: 0x2557 / 9559
{
...
bool Function_46(int iParam0) //Position: 0x256C / 9580
{
	int iVar0;
...
bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x258A / 9610
{
	uParam0 = uParam0;
...
bool Function_48(int iParam0) //Position: 0x262E / 9774
{
...
void Function_49(var uParam0, int iParam1) //Position: 0x2644 / 9796
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_50(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x2655 / 9813
{
	int iVar0;
	bool bVar1;
...
void Function_51(int iParam0, int iParam1) //Position: 0x26C7 / 9927
{
	int iVar0;
...
bool Function_52(int iParam0) //Position: 0x26EC / 9964
{
	if (*iParam0 == 0)
	{
		return 0;
...
void Function_54(bool bParam0, float fParam1) //Position: 0x2725 / 10021
{
	if (!Function_53(128))
	{
		return;
...
void Function_56(var uParam0, bool bParam1) //Position: 0x2772 / 10098
{
	uParam0->f_8 = (StackVal || bParam1);
	return;
}

int Function_57(var uParam0, bool bParam1, bool bParam2, int iParam3, char* cParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x2783 / 10115
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_58(int iParam0) //Position: 0x2862 / 10338
{
	int iVar0;
...
bool Function_59(bool bParam0) //Position: 0x2890 / 10384
{
...
void Function_60(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x28AE / 10414
{
...
void Function_61(int iParam0) //Position: 0x2989 / 10633
{
	*iParam0 = 0;
	iParam0->f_4 = 0;
	return;
...
var Function_62(bool bParam0, bool bParam1, int iParam2) //Position: 0x2998 / 10648
{
	Global_29155[iParam210].f_32 = CREATE_WORLD_SECTOR(bParam0, bParam1);
	return Global_29155[iParam210].f_32;
}

bool Function_63() //Position: 0x29B7 / 10679
{
	var uVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x324E / 12878
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_65() //Position: 0x3297 / 12951
{
...
void Function_66(bool bParam0, var uParam1) //Position: 0x32AC / 12972
{
	if (!Function_53(128))
	{
		return;
