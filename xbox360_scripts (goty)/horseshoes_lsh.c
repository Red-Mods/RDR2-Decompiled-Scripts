...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_24(Global_30693[1], &Local_24 + 4, &Local_24 + 68, &Local_24 + 72, &Local_24 + 60, &Local_24 + 64))
			{
				Function_23(&Local_24 + 4);
				Function_22(Global_30693[1], 0);
				*(&Local_24 + 16[03]) = { StackVal, StackVal, Function_22(Global_30693[1], 0) };
				Function_22(Global_30693[1], 1);
				*(&Local_24 + 16[13]) = { StackVal, StackVal, Function_22(Global_30693[1], 1) };
				Local_24 = Local_6;
				Local_24.f_52 = 1;
				if (Function_21())
				{
				...
				Local_24.f_44 = CREATE_VOLUME_IN_LAYOUT(bLocal_5, "StayOutVol", 2, -1715.489f, 9.14139f, 4259.397f, 0.0f, -91.07706f, 0.0f, 8.22709f, 3.373459f, 21.7038f);
...
void Function_17() //Position: 0x5F3 / 1523
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5FC / 1532
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x61D / 1565
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, var uParam1) //Position: 0x653 / 1619
{
	if (!Function_8(iParam0))
	{
		return;
...
bool Function_21() //Position: 0x66E / 1646
{
...
vector3 Function_22(int iParam0, int iParam1) //Position: 0x699 / 1689
{
...
void Function_23(bool bParam0) //Position: 0x7C5 / 1989
{
	int iVar0;
	bool bVar1;
...
bool Function_24(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x81A / 2074
{
	vector3 vVar0;
	int iVar3;
...
bool Function_25(bool bParam0, bool bParam1, bool bParam2) //Position: 0x967 / 2407
{
...
bool Function_26() //Position: 0xA1D / 2589
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_27(bool bParam0) //Position: 0xA34 / 2612
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_28(bool bParam0) //Position: 0xA3F / 2623
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

float Function_29(vector3 vParam0, vector3 vParam3) //Position: 0xA4D / 2637
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_30(int iParam0, bool bParam1) //Position: 0xA6A / 2666
{
	if (iParam0 == Global_30668[0])
	{
		if (bParam1 == 0)
...
void Function_31(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xB81 / 2945
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_32(int iParam0) //Position: 0xBF8 / 3064
{
	char* cVar0[16];
...
bool Function_33() //Position: 0xC37 / 3127
{
...
bool Function_34(var uParam0, bool bParam1) //Position: 0xC52 / 3154
{
	return (uParam0 && bParam1) == 0;
}

int Function_35() //Position: 0xC5F / 3167
{
	return Function_36(0);
}

int Function_36(int iParam0) //Position: 0xC69 / 3177
{
...
var Function_37(int iParam0) //Position: 0xCAA / 3242
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_38(int iParam0) //Position: 0xCC4 / 3268
{
...
int Function_39(var uParam0, int iParam1) //Position: 0xCE0 / 3296
{
	int iVar0;
...
bool Function_40(int iParam0) //Position: 0xCFC / 3324
{
...
void Function_41() //Position: 0xD12 / 3346
{
	Function_1();
	return;
}

void Function_42() //Position: 0xD1B / 3355
{
...
void Function_43(int iParam0) //Position: 0xD67 / 3431
{
...
void Function_44(var uParam0, float fParam1) //Position: 0xD7C / 3452
{
...
void Function_45(var uParam0, int iParam1) //Position: 0xD9D / 3485
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_46(var uParam0, int iParam1) //Position: 0xDB0 / 3504
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_47(var uParam0) //Position: 0xDBF / 3519
{
	return Function_34(*uParam0, 1);
}

void Function_48() //Position: 0xDCC / 3532
{
	return;
}

void Function_49(bool bParam0, bool bParam1) //Position: 0xDD2 / 3538
{
	bool bVar0;
...
void Function_50(var uParam0) //Position: 0xE29 / 3625
{
	int iVar0;
...
var Function_51() //Position: 0xE46 / 3654
{
	var uVar0;
