...
void Function_65(bool bParam0) //Position: 0x28C5 / 10437
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 >= 4294967295)
	{
		...
		UNK_0x6BA667B5(iVar1);
		iVar0 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, bParam0, iVar0 + 1);
	}
	return;
}

bool Function_66(bool bParam0) //Position: 0x2911 / 10513
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x292F / 10543
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2944 / 10564
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29CB / 10699
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29EE / 10734
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A0C / 10764
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A2F / 10799
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B4A / 11082
{
...
int Function_74(bool bParam0) //Position: 0x2B75 / 11125
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C7A / 11386
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C87 / 11399
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CFA / 11514
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31F8 / 12792
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x322F / 12847
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x324C / 12876
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3284 / 12932
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x328E / 12942
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x32AF / 12975
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32BD / 12989
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33C5 / 13253
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x33DB / 13275
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3691 / 13969
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x369F / 13983
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x36B8 / 14008
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x36D2 / 14034
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x370A / 14090
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3721 / 14113
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39EA / 14826
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A07 / 14855
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3AA3 / 15011
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3AC2 / 15042
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AD1 / 15057
{
...
void Function_98(int iParam0) //Position: 0x3AED / 15085
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AF7 / 15095
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B59 / 15193
{
...
void Function_101(int iParam0) //Position: 0x3B6D / 15213
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B77 / 15223
{
