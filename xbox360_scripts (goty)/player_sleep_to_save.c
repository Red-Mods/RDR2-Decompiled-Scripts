	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_55(iParam0, bVar8, &iLocal_85, &cLocal_84);
...
void Function_30(bool bParam0, int iParam1) //Position: 0x20EE / 8430
{
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_31(var uParam0, var uParam1) //Position: 0x2103 / 8451
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_32() //Position: 0x2111 / 8465
{
	bool bVar0;
...
void Function_33(var uParam0, bool bParam1) //Position: 0x2142 / 8514
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_34(var uParam0, bool bParam1) //Position: 0x21B6 / 8630
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_35(var uParam0, int iParam1) //Position: 0x2228 / 8744
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_36(bool bParam0) //Position: 0x2236 / 8758
{
	return Function_24(bParam0, "UseTime", 5.0f);
}

bool Function_37() //Position: 0x224C / 8780
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_38(bool bParam0) //Position: 0x2259 / 8793
{
	return Function_24(bParam0, "MoveAllowance", 1.5f);
}

bool Function_39(bool bParam0, bool bParam1) //Position: 0x2279 / 8825
{
...
bool Function_40(bool bParam0) //Position: 0x2321 / 8993
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_41() //Position: 0x2340 / 9024
{
	return;
}

void Function_42(bool bParam0, bool bParam1) //Position: 0x2346 / 9030
{
	bool bVar0;
...
void Function_43(bool bParam0) //Position: 0x2422 / 9250
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_44(bool bParam0) //Position: 0x24E2 / 9442
{
	PRINTSTRING("Day ");
...
void Function_45(int iParam0, int iParam1) //Position: 0x2528 / 9512
{
	int iVar0;
	int iVar1;
...
void Function_46(int iParam0) //Position: 0x25AA / 9642
{
	iParam0->f_92 = 0;
	iParam0->f_4 = 0;
...
bool Function_47(int iParam0) //Position: 0x25F8 / 9720
{
	iParam0 = iParam0;
	return 1;
}

bool Function_48(bool bParam0) //Position: 0x2603 / 9731
{
	return Function_20(bParam0, "OneShotKill", 0);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x261D / 9757
{
	return Function_22(bParam0, "ParentAnimNode", iParam1);
}

bool Function_50(bool bParam0) //Position: 0x263B / 9787
{
	return Function_20(bParam0, "LinkToParentAnim", 0);
}

bool Function_51(bool bParam0) //Position: 0x265A / 9818
{
	int iVar0;
	int iVar1;
...
bool Function_52(bool bParam0) //Position: 0x268D / 9869
{
	return Function_20(bParam0, "LinkParentToAnim", 0);
}

bool Function_53(bool bParam0) //Position: 0x26AC / 9900
{
	return Function_20(bParam0, "SingularUse", 0);
}

void Function_54(var uParam0, int iParam1) //Position: 0x26C6 / 9926
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_55(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x26D9 / 9945
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_63(uParam0->f_12, &bVar0);
...
var Function_56() //Position: 0x29C1 / 10689
{
	int iVar0;
...
bool Function_57(bool bParam0, bool bParam1) //Position: 0x29C9 / 10697
{
	return Function_22(bParam0, "TargetLocator", bParam1);
}

void Function_58() //Position: 0x29E6 / 10726
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_59(bool bParam0, int iParam1) //Position: 0x29F5 / 10741
{
	return Function_22(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_60(bool bParam0, int iParam1) //Position: 0x2A17 / 10775
{
	return Function_22(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_61(bool bParam0) //Position: 0x2A3B / 10811
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_62(bool bParam0, int iParam1) //Position: 0x2A58 / 10840
{
	return Function_22(bParam0, "TargetAttachBone", iParam1);
}

bool Function_63(bool bParam0, int iParam1) //Position: 0x2A78 / 10872
{
	return Function_22(bParam0, "TargetAttachSlot", iParam1);
}

void Function_64(bool bParam0, bool bParam1) //Position: 0x2A98 / 10904
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_65(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2B46 / 11078
{
	bool bVar0;
...
void Function_66(int iParam0, float fParam1) //Position: 0x2BB6 / 11190
{
	if (!Function_27(iParam0))
	{
...
void Function_67(int iParam0, float fParam1) //Position: 0x2BCC / 11212
{
...
var Function_68(bool bParam0) //Position: 0x2BED / 11245
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_24(bParam0, "RandUseTime", 0.0f));
}

void Function_69(int iParam0) //Position: 0x2C0D / 11277
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_70(var uParam0) //Position: 0x2C21 / 11297
{
	uParam0 = uParam0;
	return;
}

int Function_71() //Position: 0x2C2B / 11307
{
	return 1;
}

void Function_72(var uParam0, int iParam1) //Position: 0x2C32 / 11314
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_73(bool bParam0, var uParam1, int iParam2) //Position: 0x2C41 / 11329
{
	bool bVar0;
...
bool Function_74(bool bParam0) //Position: 0x2C80 / 11392
{
	return Function_24(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_75(bool bParam0) //Position: 0x2CAB / 11435
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_76(bool bParam0) //Position: 0x2CB6 / 11446
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_77(bool bParam0) //Position: 0x2DAC / 11692
{
	return Function_20(bParam0, "UsePosActorRelative", 0);
}

bool Function_78(bool bParam0) //Position: 0x2DCE / 11726
{
	return Function_24(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_79(bool bParam0) //Position: 0x2DF5 / 11765
{
	struct<25> Var0;
...
var Function_80(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2E5E / 11870
{
	bool bVar0;
...
void Function_81(var uParam0, int iParam1) //Position: 0x2ED5 / 11989
{
	bool bVar0;
	bool bVar1;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x2F0D / 12045
{
	vector3 vVar0;
...
var Function_83(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2FB1 / 12209
{
	bool bVar0;
...
void Function_84(var uParam0, int iParam1) //Position: 0x3028 / 12328
{
	bool bVar0;
	bool bVar1;
...
void Function_85(var uParam0, bool bParam1) //Position: 0x3060 / 12384
{
	vector3 vVar0;
...
vector3 Function_86(bool bParam0) //Position: 0x3104 / 12548
{
	vector3 vVar0;
...
vector3 Function_87(bool bParam0) //Position: 0x312B / 12587
{
	vector3 vVar0;
...
void Function_88(int iParam0) //Position: 0x3152 / 12626
{
	iParam0 = iParam0;
	return;
}

bool Function_89(bool bParam0) //Position: 0x315C / 12636
{
	return Function_20(bParam0, "MaintainPosture", 0);
}

void Function_90(int iParam0) //Position: 0x317A / 12666
{
	if (!Function_27(iParam0))
	{
...
bool Function_91(bool bParam0, bool bParam1) //Position: 0x318F / 12687
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_92(int iParam0) //Position: 0x3216 / 12822
{
	vector3 vVar0;
...
vector3 Function_93(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x3239 / 12857
{
	vector3 vVar0;
...
bool Function_94(bool bParam0) //Position: 0x3257 / 12887
{
	return Function_24(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_95(bool bParam0, bool bParam1) //Position: 0x327A / 12922
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_96(bool bParam0, int iParam1) //Position: 0x3395 / 13205
{
...
int Function_97(bool bParam0) //Position: 0x33C0 / 13248
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x34C5 / 13509
{
	return (uParam0 && iParam1) == 0;
}

void Function_99(int iParam0) //Position: 0x34D2 / 13522
{
	if (Function_98(iParam0->f_40, 16))
	{
...
void Function_100(int iParam0, bool bParam1) //Position: 0x3545 / 13637
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_101() //Position: 0x3A43 / 14915
{
	bool bVar0;
...
var Function_102() //Position: 0x3A90 / 14992
{
...
bool Function_103(bool bParam0) //Position: 0x3AA5 / 15013
{
	return Function_24(bParam0, "ReuseDelay", 15.0f);
}

void Function_104(var uParam0, int iParam1) //Position: 0x3AC2 / 15042
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_105(int iParam0) //Position: 0x3AFA / 15098
{
	iParam0 = iParam0;
	return;
}

bool Function_106(bool bParam0) //Position: 0x3B04 / 15108
{
	return Function_20(bParam0, "BlockBumpReactions", 0);
}

void Function_107(bool bParam0, var uParam1) //Position: 0x3B25 / 15141
{
	uParam1 = uParam1;
	bParam0 = bParam0;
	if (IS_LAYOUTREF_VALID(bLocal_6))
...
void Function_108() //Position: 0x3BEE / 15342
{
	int iVar0;
...
void Function_109(bool bParam0) //Position: 0x3C34 / 15412
{
	int iVar0;
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x3C91 / 15505
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_111(bool bParam0, bool bParam1) //Position: 0x3D99 / 15769
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_112(int iParam0) //Position: 0x3DAF / 15791
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_113(bool bParam0, int iParam1) //Position: 0x4067 / 16487
{
	bool bVar0;
...
bool Function_114(bool bParam0) //Position: 0x40BB / 16571
{
	return Function_20(bParam0, "DrawWeapon", 0);
}

bool Function_115(bool bParam0) //Position: 0x40D4 / 16596
{
	return Function_20(bParam0, "AllowWeapon", 0);
}

void Function_116(bool bParam0, int iParam1) //Position: 0x40EE / 16622
{
	var uVar0;
	char* cVar1;
...
bool Function_117(var uParam0, int iParam1) //Position: 0x4133 / 16691
{
	return Function_22(uParam0, "UseName", iParam1);
}

bool Function_118(int iParam0, int iParam1) //Position: 0x414A / 16714
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_119(bool bParam0) //Position: 0x4413 / 17427
{
	return Function_24(bParam0, "ActivationCone", 0.0f);
}

bool Function_120(bool bParam0, bool bParam1) //Position: 0x4430 / 17456
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_121(int iParam0) //Position: 0x44CC / 17612
{
	return Function_24(iParam0, "ActivationRadius", 2.0f);
}

bool Function_122(bool bParam0, int iParam1) //Position: 0x44EB / 17643
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (NET_IS_IN_SESSION() || Function_10())
	{
		return 0;
	}
	if (((Global_3403 || Global_3404) || Global_3381) || Function_9(0, 0, 1, 1))
	{
		return 0;
	}
...
bool Function_123(int iParam0) //Position: 0x45AD / 17837
{
...
void Function_124(int iParam0) //Position: 0x45C9 / 17865
{
	iParam0 = iParam0;
	return;
}

void Function_125(bool bParam0, int iParam1) //Position: 0x45D3 / 17875
{
	int iVar0;
	int iVar1;
...
void Function_126(int iParam0, int iParam1) //Position: 0x4635 / 17973
{
...
void Function_127(int iParam0) //Position: 0x4649 / 17993
{
	iParam0 = iParam0;
	return;
}

void Function_128(int iParam0) //Position: 0x4653 / 18003
{
