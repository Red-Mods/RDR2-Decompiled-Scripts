...
#region Local Var
	...
	bool bLocal_7 = false;
	bool bLocal_8 = false;
	bool bLocal_9[6] = { false, false, false, false, false, false };
	bool bLocal_16 = false;
	int iLocal_17 = 0;
	int iLocal_18 = 0;
	bool bLocal_19 = false;
	struct<12> Local_20[6];
	int iLocal_93 = 0;
	var uLocal_94 = 0;
	var uLocal_95 = 0;
	var uLocal_96 = 0;
...
void main() //Position: 0x0 / 0
{
	...
	iLocal_93 = 0;
	Function_100(uScriptParam_0, &iLocal_93);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_94);
		}
		iVar2 = 0;
		bLocal_99 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(Local_20[iVar312]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), Local_20[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", Local_20[iVar312].f_16);
							Function_84(Local_20[iVar312].f_16, 1);
							...
							{
								Function_77(&(Local_20[iVar312]), 0);
							}
							else if (Local_20[iVar312].f_44 < 8)
							{
								Function_76(&(Local_20[iVar312]));
		...
		else
		{
			...
			while (iVar0 < (iLocal_93 - 1))
			{
				if (Function_75(Local_20[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_20[iVar012])))
					{
						Function_103("Quitting due to update end");
						Function_77(&(Local_20[iVar012]), 1);
					}
				}
				if (Function_15(&(Local_20[iVar012]), 0))
				{
					Function_5(&(Local_20[iVar012]));
				}
				iVar0++;
			}
		}
...
void Function_5(int iParam0) //Position: 0x479 / 1145
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_100))
								{
									...
									{
										bLocal_100 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_100 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_100))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_100))
		{
			Function_103("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_100);
		}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_98, &cLocal_97);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0E / 7438
{
	bool bVar0;
	var uVar1;
	...
	iParam1 = iParam1;
	bParam0 = bParam0;
	GET_OBJECT_POSITION(bLocal_9[iLocal_17], &vLocal_1);
	GET_OBJECT_ORIENTATION(bLocal_9[iLocal_17], &uLocal_4);
	bVar0 = UNK_0x9C40E671(&uLocal_4);
	if (iLocal_17 <= 6)
	{
		if (IS_OBJECT_VALID(bLocal_9[iLocal_17]))
		{
			if (GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vLocal_1, 0.1f, 0.1f, 1, bVar0, 5.0f, 1, 0))
			{
				if (iLocal_18)
				{
					iLocal_18 = 0;
	...
	{
		GET_OBJECT_POSITION(bLocal_16, &uVar1);
		if (GRINGO_ACTOR_MOVE_TO(bParam0, &uVar1, 0.5f, 1, 1))
		{
			return 0;
		}
	}
...
bool Function_27(bool bParam0) //Position: 0x1D94 / 7572
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DB3 / 7603
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DB9 / 7609
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DC7 / 7623
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DD2 / 7634
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DEC / 7660
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E0A / 7690
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E29 / 7721
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E5C / 7772
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E7B / 7803
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E95 / 7829
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EA8 / 7848
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2190 / 8592
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2198 / 8600
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21B5 / 8629
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21C4 / 8644
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21E6 / 8678
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x220A / 8714
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2227 / 8743
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2247 / 8775
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2267 / 8807
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2315 / 8981
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2385 / 9093
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x239B / 9115
{
...
var Function_51(bool bParam0) //Position: 0x23BC / 9148
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23DC / 9180
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23F0 / 9200
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23FA / 9210
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2401 / 9217
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2410 / 9232
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x244F / 9295
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x247A / 9338
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2485 / 9349
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x257B / 9595
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x259D / 9629
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25C4 / 9668
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2883 / 10371
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28E0 / 10464
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x293D / 10557
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2947 / 10567
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2965 / 10597
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x297A / 10618
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A01 / 10753
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A24 / 10788
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A42 / 10818
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A65 / 10853
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B80 / 11136
{
...
int Function_74(bool bParam0) //Position: 0x2BAB / 11179
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CB0 / 11440
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CBD / 11453
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D30 / 11568
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_98)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_97));
		iLocal_98 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x322E / 12846
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3265 / 12901
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3282 / 12930
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32BA / 12986
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32C4 / 12996
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x32E5 / 13029
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32F3 / 13043
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33FB / 13307
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3411 / 13329
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36C7 / 14023
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x36D5 / 14037
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x36EE / 14062
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x3708 / 14088
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3740 / 14144
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3757 / 14167
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A20 / 14880
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A3D / 14909
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3AD9 / 15065
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x3AF8 / 15096
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	iParam1 = iParam1;
	iParam0 = iParam0;
	Function_97(iParam0, &vVar0);
	iLocal_0 = 0;
	if (!IS_ITERATOR_VALID(bLocal_7))
	{
		if (Global_3380)
		{
			bLocal_8 = GET_LAYOUT_FROM_OBJECT(GET_OBJECT_OWNER(GET_TARGET_OBJECT()));
		}
		else
		{
			bLocal_8 = Global_30616;
		}
		bLocal_7 = CREATE_OBJECT_ITERATOR(bLocal_8);
	}
	GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &uVar5);
	ITERATE_EVERYWHERE(bLocal_7);
	ITERATE_ON_OBJECT_TYPE(bLocal_7, 8);
	bVar4 = START_OBJECT_ITERATOR(bLocal_7);
	while (IS_OBJECT_VALID(bVar4))
	{
		bVar3 = GET_OBJECT_NAME(bVar4);
		if (STRING_CONTAINS_STRING(bVar3, "moveobjflag"))
		{
			if (iLocal_0 <= 6)
			{
				bLocal_9[iLocal_0] = bVar4;
			}
			GET_OBJECT_POSITION(bVar4, &vLocal_1);
			iLocal_0++;
		}
		else if (STRING_CONTAINS_STRING(bVar3, "lastmoveobjflag"))
		{
			bLocal_16 = bVar4;
		}
		bVar4 = OBJECT_ITERATOR_NEXT(bLocal_7);
	}
	DESTROY_ITERATOR(bLocal_7);
	if (VDIST(vVar0, vLocal_1) > 1.0f)
	{
		return 0;
	}
	if (iLocal_0 >= 0)
...
void Function_97(bool bParam0, bool bParam1) //Position: 0x3BE1 / 15329
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_98(int iParam0) //Position: 0x3BEE / 15342
{
...
void Function_99(int iParam0) //Position: 0x3C0A / 15370
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C14 / 15380
{
	int iVar0;
	int iVar1;
	...
	{
		Function_101(&(Local_20[iLocal_9312]), bParam0);
		iLocal_93++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3C76 / 15478
{
...
void Function_102(int iParam0) //Position: 0x3C8A / 15498
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3C94 / 15508
{
