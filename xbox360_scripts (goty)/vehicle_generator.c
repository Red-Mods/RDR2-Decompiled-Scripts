...
bool Function_5(bool bParam0, float fParam1) //Position: 0x284 / 644
{
	...
	if (!Function_4(fParam1[03], 4))
	{
		...
		bVar2 = Function_18(bVar1, *bParam0);
		bVar0 = GET_ACTORENUM_FROM_STRING(bVar2);
...
var Function_18(bool bParam0, bool bParam1) //Position: 0xBC3 / 3011
{
	...
	uVar2 = GRINGO_GET_ATTRIBUTE(bVar0, bParam0);
	return GRINGO_GET_STRING_ATTR_BY_HANDLE(uVar2, &bParam0);
}
...
var Function_20(bool bParam0) //Position: 0xC30 / 3120
{
	...
	return MAKE_TIME_OF_DAY(bVar0, bVar2, 0);
}
