...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Ser", 4);
	Function_16("Loading WotS population file", 3);
	Global_30839++;
	...
	bVar3 = FIND_NAMED_LAYOUT("WreckSerendipity_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "serv_birdVol");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar0, 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("SER_Pop: Cannot find serv_birdVol to create bird volumes");
	...
	Function_6("Finished loading WotS population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC16 / 3094
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC25 / 3109
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC7A / 3194
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xCFA / 3322
{
	bool bVar0;
...
bool Function_5(int iParam0) //Position: 0xD7C / 3452
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0xD98 / 3480
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0xDD6 / 3542
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0xDF2 / 3570
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xE02 / 3586
{
	int iVar0;
	int iVar1;
...
var Function_10(int iParam0) //Position: 0xE7A / 3706
{
	int iVar0;
...
var Function_11(int iParam0) //Position: 0xEE6 / 3814
{
	int iVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xF52 / 3922
{
	int iVar0;
	int iVar1;
...
void Function_13(int iParam0) //Position: 0xF97 / 3991
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_14(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xFA3 / 4003
{
	int iVar0;
	int iVar1;
...
var Function_15(bool bParam0, int iParam1) //Position: 0x101F / 4127
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_16(bool bParam0, var uParam1) //Position: 0x102C / 4140
{
	if (!Function_5(128))
	{
		return;
