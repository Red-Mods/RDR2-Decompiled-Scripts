	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_51(iParam0, bVar8, &iLocal_58, &cLocal_57);
...
bool Function_45(bool bParam0, int iParam1) //Position: 0x28F0 / 10480
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_46(bool bParam0) //Position: 0x290E / 10510
{
...
bool Function_48(bool bParam0) //Position: 0x2960 / 10592
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_49(bool bParam0) //Position: 0x297F / 10623
{
...
void Function_51(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x29AC / 10668
{
	...
	PRINTNL();
	iVar2 = Function_58(uParam0->f_12, &bVar0);
...
bool Function_52(bool bParam0, bool bParam1) //Position: 0x2C94 / 11412
{
...
bool Function_54(bool bParam0, int iParam1) //Position: 0x2CC0 / 11456
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_55(bool bParam0, int iParam1) //Position: 0x2CE2 / 11490
{
...
bool Function_57(bool bParam0, int iParam1) //Position: 0x2D23 / 11555
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_58(bool bParam0, int iParam1) //Position: 0x2D43 / 11587
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_59(bool bParam0, bool bParam1) //Position: 0x2D63 / 11619
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_72(bool bParam0) //Position: 0x3077 / 12407
{
...
void Function_86(var uParam0, int iParam1) //Position: 0x3771 / 14193
{
	...
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(bVar1, 1.5f, 1, 0f);
	return;
}
...
bool Function_96(bool bParam0) //Position: 0x3C10 / 15376
{
...
void Function_106(int iParam0, bool bParam1) //Position: 0x3F69 / 16233
{
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_57));
		iLocal_58 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_49(iParam0->f_12))
...
int Function_119(bool bParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x51C1 / 20929
{
	int iVar0;
	int iVar1;
...
void Function_120(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x53E1 / 21473
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_123(char* cParam0, bool bParam1) //Position: 0x5B14 / 23316
{
	char* cVar0[32];
...
void Function_142(bool bParam0, bool bParam1) //Position: 0x68AF / 26799
{
...
void Function_143(int iParam0) //Position: 0x68C5 / 26821
{
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_144(iParam0->f_16, bVar0);
...
var Function_146(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6E70 / 28272
{
	...
	iVar0 = Function_147(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
int Function_148(var uParam0, bool bParam1) //Position: 0x6F6C / 28524
{
...
bool Function_151(bool bParam0) //Position: 0x71D7 / 29143
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_152(bool bParam0) //Position: 0x71F0 / 29168
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_153(bool bParam0, int iParam1) //Position: 0x720A / 29194
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_154(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_154(var uParam0, int iParam1) //Position: 0x7242 / 29250
{
