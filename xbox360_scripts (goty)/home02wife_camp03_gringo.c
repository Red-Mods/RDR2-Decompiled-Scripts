...
void main() //Position: 0x0 / 0
{
	...
	iLocal_1 = 33;
	iLocal_2 = 1;
	vLocal_6 = { -107.198f, 119.702f, 1348.402f };
	iLocal_12 = 2;
	iLocal_13 = 4;
	fLocal_14 = 70.0f;
...
void Function_3() //Position: 0x20C / 524
{
	...
	Function_4(11, bLocal_3, bLocal_4, bLocal_11, 51);
	return;
}

void Function_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x229 / 553
{
	int iVar0;
...
void Function_5(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x24A / 586
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (SQUAD_IS_VALID(bParam2))
	{
		if (bParam5 > 0)
		{
			Function_19(&(Global_3422[bParam540]));
		}
		bVar0 = false;
		...
		if (Function_17(bParam2, Global_34573))
		{
			bVar1 = true;
		}
		bVar0 = false;
		while (bVar0 <= SQUAD_GET_SIZE(bParam2))
		{
			...
			if (IS_ACTOR_VALID(bVar5))
			{
				...
				{
					if (Function_16(GET_OBJECT_FROM_GRINGO(bVar6), bParam4))
					{
	...
	switch (bParam5)
	{
		...
		case 0x00000033:
		case 0x00000039:
			if (GET_LAST_ATTACKER(bParam1) != Global_34573 || ((((Global_3422[bParam540].f_152 && !Function_11(bParam1, &uVar8, &uVar7, 0, 0, 0x40400000)) && !HUD_IS_FADED()) && !HUD_IS_FADING()) && !Global_3395))
			{
				UI_SET_TEXT("Death_Explanation", "kill_family_help");
				KILL_ACTOR(Global_34573);
			}
			else if (Global_3422[bParam540].f_152 && Function_11(bParam1, &uVar8, &uVar7, 0, 0, 0x40400000))
			{
				if (bParam0 == 11)
				{
					Function_10(bParam1, -105.606f, 119.513f, 1362.295f, 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 12)
				{
					Function_10(bParam1, -104.413f, 119.521f, 1367.917f, 10.0f, 1, 120.0f, 0x40c00000);
				}
				if (bParam0 == 13)
				{
					Function_10(bParam1, -102.615f, 119.513f, 1364.342f, 10.0f, 1, 120.0f, 0x40c00000);
				}
	...
	Function_7(bParam0, DECOR_CHECK_EXIST(bParam1, "hidden"), (Global_3378 || bVar9), 1, 1);
...
void Function_6(bool bParam0, bool bParam1) //Position: 0x667 / 1639
{
...
int Function_7(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x696 / 1686
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_8(bool bParam0) //Position: 0x9B4 / 2484
{
	bool bVar0;
...
void Function_9(bool bParam0) //Position: 0x9E0 / 2528
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_10(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0x9F5 / 2549
{
	int iVar0;
	bool bVar1;
...
bool Function_11(bool bParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xAAF / 2735
{
	float fVar0;
...
void Function_12(bool bParam0) //Position: 0xC46 / 3142
{
...
void Function_13(bool bParam0) //Position: 0xC7A / 3194
{
	SAY_SINGLE_LINE_CONTEXT(bParam0, 60, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_14(var uParam0, int iParam1) //Position: 0xC91 / 3217
{
	return (uParam0 && iParam1) == 0;
}

var Function_15(bool bParam0, bool bParam1) //Position: 0xC9E / 3230
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_16(bool bParam0, bool bParam1) //Position: 0xD8F / 3471
{
	bool bVar0;
	bool bVar1;
...
bool Function_17(bool bParam0, bool bParam1) //Position: 0xDE6 / 3558
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_18(bool bParam0) //Position: 0xE3F / 3647
{
	bool bVar0;
...
int Function_19(int iParam0) //Position: 0xE71 / 3697
{
	int iVar0;
	var uVar1;
	var uVar2;
			...
			while (bVar3 <= SQUAD_GET_SIZE(iParam0->f_156))
			{
				...
				if (IS_ACTOR_VALID(bVar4))
				{
					if (!IS_ACTOR_VEHICLE(bVar4))
					{
						...
						if (Function_11(bVar4, &uVar2, &uVar1, 0, 0, 0x40400000) && ((iParam0->f_36 != 11 || iParam0->f_36 != 12) || iParam0->f_36 != 13))
						{
							Function_18(iParam0->f_156);
							SQUAD_GOALS_CLEAR(iParam0->f_156);
							iParam0->f_152 = 1;
	...
	else if (Function_20(StackVal, StackVal, Global_34573, *(iParam0 + 52)) < 100.0f)
	{
		iParam0->f_152 = 0;
		if (IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(iParam0->f_40)))
		{
...
float Function_20(bool bParam0, vector3 vParam1) //Position: 0x1047 / 4167
{
	vector3 vVar0;
...
vector3 Function_21(bool bParam0) //Position: 0x10C1 / 4289
{
	vector3 vVar0;
...
void Function_22(bool bParam0) //Position: 0x112B / 4395
{
...
void Function_23(var uParam0, int iParam1) //Position: 0x1157 / 4439
{
	int iVar0;
...
bool Function_24(var uParam0, int iParam1) //Position: 0x116E / 4462
{
	int iVar0;
...
void Function_25(int iParam0) //Position: 0x118A / 4490
{
	int iVar0;
...
void Function_26(var uParam0, int iParam1) //Position: 0x11B0 / 4528
{
...
void Function_27(var uParam0, int iParam1) //Position: 0x12DE / 4830
{
	int iVar0;
...
bool Function_28(var uParam0, bool bParam1) //Position: 0x12F8 / 4856
{
	int iVar0;
...
var Function_29(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x1315 / 4885
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if (Global_3370)
			{
				if (Function_20(StackVal, StackVal, Global_34573, vVar7) < 10.0f)
				{
					break;
				}
			}
			if ((Global_26154 + 1 > iLocal_12 || bParam2) || Global_3370)
			{
				if (Function_149(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					if (((!bParam2 && !Function_148(iParam0 + 200, &fLocal_14, 256, 0)) && !Global_3370) && !Function_154())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_137(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_14, 20.0f, fLocal_14);
		...
		case 0x00000002:
			...
			{
				if (((Function_20(StackVal, StackVal, Global_34573, *(iParam0 + 200)) < 120.0f || bParam2) || Global_3370) || Function_154())
				{
					if (UNK_0x214AFB8C(iParam0->f_16))
					{
						if (IS_OBJECT_VALID(iParam0->f_224))
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_75(StackVal, StackVal, StackVal, StackVal, StackVal, Function_137(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
		...
		case 0x0000000B:
			...
			if ((iParam0->f_268 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player")) && !iParam0->f_276)
			{
				if (SQUAD_IS_VALID(iParam0->f_244) && SQUAD_GET_SIZE(iParam0->f_244) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_16) < 10.0f)
						{
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_11(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_15, iParam0 + 312, 0, 0, 0x40400000))
						{
...
void Function_30(int iParam0) //Position: 0x2313 / 8979
{
	*iParam0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, *iParam0 };
	if (IS_ACTOR_VALID(bLocal_3) && fLocal_10 < 0.0f)
	{
		if (Function_36(StackVal, StackVal, bLocal_3, vLocal_6, 5.0f))
		{
			if (!GET_TASK_STATUS(bLocal_3, 19) != 1)
			{
				TASK_USE_GRINGO(bLocal_3, bLocal_5, "UseCase1", 4294967295, 1);
				Function_34(51);
			}
		}
		else if ((GET_CURRENT_GAME_TIME() - fLocal_10) < 300.0f)
		{
			Function_34(51);
		}
		if ((Function_31(bLocal_3, Global_34573, 15.0f) && (GET_CURRENT_GAME_TIME() - fLocal_9) < 60.0f) && MEMORY_GET_IS_VISIBLE(bLocal_3, Global_34573))
		{
			SAY_SINGLE_LINE_CONTEXT(bLocal_3, 44, Global_34573, 1, 0, 0, 4294967295, 4294967295, 0, 1);
...
int Function_31(var uParam0, var uParam1, float fParam2) //Position: 0x23B6 / 9142
{
	float fVar0;
...
var Function_32(bool bParam0, bool bParam1) //Position: 0x23D3 / 9171
{
	var uVar0;
	int iVar3;
	int iVar6;
...
float Function_33(var uParam0, int iParam1) //Position: 0x23F2 / 9202
{
	vector3 vVar0;
	bool bVar3;
...
void Function_34(int iParam0) //Position: 0x2410 / 9232
{
...
void Function_35(var uParam0, int iParam1) //Position: 0x243D / 9277
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_36(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x244C / 9292
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_21(bParam0);
		if (VDIST(Function_21(bParam0), vParam1) >= fParam4)
		{
			return 1;
		}
	}
...
void Function_37(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x24D6 / 9430
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_38(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x26D4 / 9940
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_39(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x26EE / 9966
{
	bool bVar0;
	bool bVar1;
...
int Function_40(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x27CE / 10190
{
	char* cVar0[32];
...
int Function_41(bool bParam0) //Position: 0x2A1C / 10780
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_42(bool bParam0, bool bParam1) //Position: 0x2A3F / 10815
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_43(bool bParam0, bool bParam1) //Position: 0x2A62 / 10850
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_44(bool bParam0, bool bParam1) //Position: 0x2A86 / 10886
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_45(bool bParam0, bool bParam1) //Position: 0x2AAC / 10924
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_46(bool bParam0) //Position: 0x2ACF / 10959
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_47() //Position: 0x2AED / 10989
{
...
bool Function_48(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2B37 / 11063
{
	bool bVar0;
	bool bVar1;
...
bool Function_49(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2B89 / 11145
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x2BA5 / 11173
{
	bool bVar0;
	bool bVar1;
...
void Function_51(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2BF7 / 11255
{
	bool bVar0;
	bool bVar1;
...
var Function_52() //Position: 0x2C3C / 11324
{
...
void Function_53(int iParam0, bool bParam1, bool bParam2) //Position: 0x2C51 / 11345
{
	bool bVar0;
	bool bVar1;
...
bool Function_54(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2D74 / 11636
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	while (bVar0 < (SQUAD_GET_SIZE(bParam0) - 1))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			{
				Function_21(bVar1);
				if (VDIST(Function_21(bVar1), vParam1) >= fParam4)
				{
					iVar2 = 1;
				}
			}
...
bool Function_55(vector3 vParam0) //Position: 0x2DE2 / 11746
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_56(bool bParam0) //Position: 0x2DFA / 11770
{
	bool bVar0;
	bool bVar1;
...
var Function_57(bool bParam0) //Position: 0x2E51 / 11857
{
	bool bVar0;
	bool bVar1;
...
void Function_58(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2E97 / 11927
{
	bool bVar0;
	bool bVar1;
...
void Function_59(bool bParam0, bool bParam1) //Position: 0x2F05 / 12037
{
	bool bVar0;
	bool bVar1;
...
void Function_60(bool bParam0) //Position: 0x2F4D / 12109
{
	struct<21> Var0;
...
bool Function_61() //Position: 0x300B / 12299
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_62(int iParam0) //Position: 0x301E / 12318
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_63(int iParam0) //Position: 0x30CF / 12495
{
...
bool Function_64(int iParam0) //Position: 0x30EE / 12526
{
...
bool Function_65(int iParam0) //Position: 0x3112 / 12562
{
...
bool Function_66(int iParam0) //Position: 0x3127 / 12583
{
...
bool Function_67(int iParam0, bool bParam1) //Position: 0x313E / 12606
{
	int iVar0;
...
var Function_68(int iParam0) //Position: 0x317B / 12667
{
...
bool Function_69(int iParam0) //Position: 0x3195 / 12693
{
...
int Function_70(int iParam0, int iParam1) //Position: 0x31AB / 12715
{
	int iVar0;
...
void Function_71(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x31E4 / 12772
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_72(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x32B1 / 12977
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_73(bool bParam0, bool bParam1) //Position: 0x3448 / 13384
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_74(bool bParam0) //Position: 0x346A / 13418
{
	bool bVar0;
	bool bVar1;
...
var Function_75(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x34AE / 13486
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_76(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x35F7 / 13815
{
	var uVar0[5];
	int iVar6;
...
int Function_77(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x3698 / 13976
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_78(int iParam0, int iParam1) //Position: 0x372C / 14124
{
	if (Function_84(&bLocal_3, 51, 0))
	{
		bLocal_5 = LOCATE_GRINGO_OF_TYPE("cooking", &vLocal_6, 1.0f, 1);
		if (IS_GRINGO_VALID(bLocal_5))
		{
			if (Function_82(&bLocal_11, "home02wife03mobile", iParam1))
			{
				bLocal_4 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_11, Function_137()));
				Global_3422[5140].f_156 = bLocal_4;
...
void Function_79() //Position: 0x37A1 / 14241
{
	TELEPORT_ACTOR(bLocal_3, &vLocal_6, 1, 1, 1);
	if (!Function_36(StackVal, StackVal, Global_34573, vLocal_6, 100.0f))
	{
		SNAP_ACTOR_TO_GRINGO(bLocal_3, GET_OBJECT_FROM_GRINGO(bLocal_5), "UseCase1", 1, 0, 0);
		TASK_USE_GRINGO(bLocal_3, bLocal_5, "UseCase1", 4294967295, 1);
		Function_34(51);
	}
	else
	{
		TASK_GO_NEAR_COORD(bLocal_3, &vLocal_6, 2.0f, 1);
	}
	Function_80(bLocal_3, &bLocal_4, 1, 1);
	fLocal_9 = (GET_CURRENT_GAME_TIME() - 50.0f);
	fLocal_10 = GET_CURRENT_GAME_TIME();
	return;
}

void Function_80(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x381B / 14363
{
	bool bVar0;
	bool bVar1;
...
bool Function_81(bool bParam0, bool bParam1, bool bParam2) //Position: 0x39A5 / 14757
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_82(var uParam0, char* cParam1, int iParam2) //Position: 0x39E5 / 14821
{
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3A10 / 14864
{
	var uVar0;
...
bool Function_84(var uParam0, var uParam1, bool bParam2) //Position: 0x3A52 / 14930
{
	var uVar0;
...
int Function_85(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3A6F / 14959
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_86(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3C38 / 15416
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x4129 / 16681
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_88(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4149 / 16713
{
	bool bVar0;
...
int Function_89(bool bParam0, bool bParam1) //Position: 0x419D / 16797
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, bool bParam1) //Position: 0x421D / 16925
{
	Function_92(bParam0);
	Function_91(bParam0);
...
void Function_91(bool bParam0) //Position: 0x4243 / 16963
{
...
void Function_92(bool bParam0) //Position: 0x4267 / 16999
{
...
bool Function_93(bool bParam0) //Position: 0x4336 / 17206
{
...
int Function_94(int iParam0, bool bParam1) //Position: 0x434D / 17229
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_95(int iParam0, bool bParam1, bool bParam2) //Position: 0x43E0 / 17376
{
	bool bVar0;
	bool bVar1;
...
void Function_96(bool bParam0) //Position: 0x44D7 / 17623
{
	bool bVar0;
...
bool Function_97(int iParam0, int iParam1) //Position: 0x4503 / 17667
{
	int iVar0;
...
void Function_98() //Position: 0x451F / 17695
{
	bool bVar0;
	bool bVar1;
...
bool Function_99(int iParam0) //Position: 0x4584 / 17796
{
...
bool Function_100(bool bParam0) //Position: 0x45A0 / 17824
{
...
var Function_101(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x45B6 / 17846
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_102(int iParam0) //Position: 0x4656 / 18006
{
	bool bVar0;
	int iVar1;
...
bool Function_103(int iParam0) //Position: 0x4750 / 18256
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x4ACB / 19147
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x4B0B / 19211
{
	int iVar0;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4B36 / 19254
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_107() //Position: 0x4B47 / 19271
{
	if (!Function_151(128))
	{
		return;
...
void Function_108(int iParam0, bool bParam1) //Position: 0x4B89 / 19337
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4C0D / 19469
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C36 / 19510
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x4C87 / 19591
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x4C97 / 19607
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4CAB / 19627
{
	int iVar0;
...
var Function_114() //Position: 0x4CD0 / 19664
{
	return "PackedMetadata";
}

void Function_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CE7 / 19687
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_116() //Position: 0x4E12 / 19986
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_117() //Position: 0x4E23 / 20003
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_118() //Position: 0x4E34 / 20020
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_119(var uParam0, int iParam1) //Position: 0x4E45 / 20037
{
...
var Function_120(var uParam0, int iParam1, bool bParam2) //Position: 0x4E68 / 20072
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x4E87 / 20103
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122() //Position: 0x4E93 / 20115
{
	return Function_123(39);
}

int Function_123(bool bParam0) //Position: 0x4E9E / 20126
{
	bool bVar0;
...
var Function_124() //Position: 0x4ECC / 20172
{
	return "PackedWeapon";
}

int Function_125(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4EE1 / 20193
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_126() //Position: 0x4FE5 / 20453
{
	return "MPItemGiver";
}

struct<32> Function_127(bool bParam0) //Position: 0x4FF9 / 20473
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5063 / 20579
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5082 / 20610
{
	return "PBox_";
}

var Function_130() //Position: 0x5090 / 20624
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x50B6 / 20662
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x50DE / 20702
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5104 / 20740
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5265 / 21093
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x5300 / 21248
{
	int iVar0;
	vector3 vVar1;
...
void Function_136(int iParam0) //Position: 0x5461 / 21601
{
...
var Function_137() //Position: 0x54C2 / 21698
{
	int iVar0;
...
var Function_138(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54CA / 21706
{
	return Function_139(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_139(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x54E3 / 21731
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x57D6 / 22486
{
	int iVar0;
...
void Function_141() //Position: 0x588A / 22666
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x58C4 / 22724
{
	int iVar0;
...
void Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58F1 / 22769
{
	bool bVar0;
...
void Function_144() //Position: 0x5A42 / 23106
{
	int iVar0;
...
var Function_145(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A8D / 23181
{
	int iVar0;
...
int Function_146() //Position: 0x5B5D / 23389
{
	int iVar0;
...
int Function_147() //Position: 0x5CB9 / 23737
{
	int iVar0;
...
bool Function_148(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DD9 / 24025
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_149(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5EA9 / 24233
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_150(bool bParam0) //Position: 0x5FDB / 24539
{
	bool bVar0;
...
bool Function_151(int iParam0) //Position: 0x5FFA / 24570
{
	int iVar0;
...
int Function_152() //Position: 0x6016 / 24598
{
	if (Function_154())
	{
...
int Function_153() //Position: 0x602F / 24623
{
	return Global_79349.f_16;
}

bool Function_154() //Position: 0x603B / 24635
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_155(int iParam0, bool bParam1, bool bParam2) //Position: 0x6044 / 24644
{
	var uVar0;
	...
	if (IS_STRING_VALID(bParam1))
	{
		if (STRING_LENGTH(bParam1) >= 0)
		{
			...
			Function_156(iParam0 + 60, iParam0->f_16, 0);
		}
	}
	if (IS_STRING_VALID(bParam2))
	{
		if (STRING_LENGTH(bParam2) >= 0)
		{
			...
			Function_156(iParam0 + 60, iParam0->f_20, 7);
		}
	}
	return;
}

var Function_156(var uParam0, int iParam1, int iParam2) //Position: 0x60C1 / 24769
{
	int iVar0;
