...
bool Function_17() //Position: 0x420 / 1056
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30693[0], &Local_24 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_30693[0], 0);
				*(&Local_24 + 148) = { StackVal, StackVal, Function_26(Global_30693[0], 0) };
				Function_25(&Local_24 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_24 + 40)[iVar0] = iLocal_4 * 10;
					Function_24(Global_30693[0], iVar0, 0);
					*(&Local_24 + 72[iVar03]) = { StackVal, StackVal, Function_24(Global_30693[0], iVar0, 0) };
					iVar0++;
				}
				if (Function_36())
				{
				...
				Function_23(Global_30693[0]);
				*(&Local_24 + 184) = { StackVal, StackVal, Function_23(Global_30693[0]) };
				Function_22(Global_30693[0]);
				*(&Local_24 + 196) = { StackVal, StackVal, Function_22(Global_30693[0]) };
...
void Function_18() //Position: 0x5DF / 1503
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5E8 / 1512
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x609 / 1545
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x63F / 1599
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x65A / 1626
{
...
vector3 Function_23(int iParam0) //Position: 0x754 / 1876
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x84E / 2126
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xDC8 / 3528
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xE1D / 3613
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF2F / 3887
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x111E / 4382
{
...
bool Function_29() //Position: 0x11D4 / 4564
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11EB / 4587
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11F6 / 4598
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x1204 / 4612
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x1211 / 4625
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1253 / 4691
{
	return Function_35(0);
}

int Function_35(bool bParam0) //Position: 0x125D / 4701
{
...
bool Function_36() //Position: 0x129E / 4766
{
...
var Function_37(int iParam0) //Position: 0x12C9 / 4809
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_38(int iParam0) //Position: 0x12E3 / 4835
{
...
int Function_39(var uParam0, int iParam1) //Position: 0x12FF / 4863
{
	int iVar0;
...
bool Function_40(int iParam0) //Position: 0x131B / 4891
{
...
void Function_41() //Position: 0x1331 / 4913
{
	Function_1();
	return;
}

void Function_42() //Position: 0x133A / 4922
{
...
void Function_43(int iParam0) //Position: 0x1389 / 5001
{
...
void Function_44(var uParam0, float fParam1) //Position: 0x139E / 5022
{
...
void Function_45(var uParam0, int iParam1) //Position: 0x13BF / 5055
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_46(var uParam0, int iParam1) //Position: 0x13D2 / 5074
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_47(int iParam0) //Position: 0x13E1 / 5089
{
	return Function_48(*iParam0, 1);
}

int Function_48(var uParam0, bool bParam1) //Position: 0x13EE / 5102
{
	return (uParam0 && bParam1) == 0;
}

void Function_49() //Position: 0x13FB / 5115
{
	return;
}

void Function_50() //Position: 0x1401 / 5121
{
	return;
}

void Function_51(bool bParam0, bool bParam1) //Position: 0x1407 / 5127
{
	bool bVar0;
...
void Function_52(var uParam0) //Position: 0x145E / 5214
{
	int iVar0;
...
var Function_53() //Position: 0x147B / 5243
{
	var uVar0;
