...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_25(Global_30679[0], &iLocal_24 + 4, &iLocal_24 + 20, &iLocal_24 + 24))
			{
				Function_24(&iLocal_24 + 4);
				Function_23(Global_30679[0]);
				*(&iLocal_24 + 40[03]) = { StackVal, StackVal, Function_23(Global_30679[0]) };
				Function_22(Global_30679[0]);
				*(&iLocal_24 + 40[13]) = { StackVal, StackVal, Function_22(Global_30679[0]) };
				Function_21(Global_30679[0]);
				*(&iLocal_24 + 28) = { StackVal, StackVal, Function_21(Global_30679[0]) };
				iLocal_24 = Local_6;
