...
void main() //Position: 0x0 / 0
{
	...
	iLocal_74 = 0;
	Function_103(uScriptParam_0, &iLocal_74);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_96(&(Local_1[iVar312]), &bVar4))
						{
							Function_94(GRINGO_GET_REQUESTING_ACTOR(), Local_1[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_89("eGRINGO_EndUse: Stop use by request", Local_1[iVar312].f_16);
							Function_88(Local_1[iVar312].f_16, 1);
							...
							{
								Function_81(&(Local_1[iVar312]), 0);
							}
							else if (Local_1[iVar312].f_44 < 8)
							{
								Function_80(&(Local_1[iVar312]));
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_42(iParam0, bVar8, &iLocal_79, &cLocal_78);
		...
		case 0x00000006:
			...
			bVar0 = Function_52(iParam0->f_16, iParam0->f_12, Function_79(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_22(bool bParam0, int iParam1) //Position: 0x1CBC / 7356
{
	bool bVar0;
	bool bVar1;
	
	bVar0 = false;
	bVar1 = Function_26(iParam1, &bVar0);
	if (bVar0)
	{
		if (STRING_CONTAINS_STRING(bVar1, "Item"))
		{
			ADD_ITEM(Function_25(iParam1), bParam0, 1);
		}
		else
		{
			GRINGO_REWARD_ACTOR(bVar1, Function_23(iParam1), bParam0);
		}
	}
	return;
}

int Function_23(int iParam0) //Position: 0x1CFE / 7422
{
	return Function_24(iParam0, "CompletionRewardAmount", 0);
}

int Function_24(bool bParam0, bool bParam1, int iParam2) //Position: 0x1D23 / 7459
{
	int iVar0;
...
var Function_25(bool bParam0) //Position: 0x1D39 / 7481
{
	bool bVar0;
	bool bVar1;
	
	bVar0 = false;
	bVar1 = Function_9(bParam0, "ItemReward", &bVar0);
	if (bVar0)
	{
		return bVar1;
	}
	return "FAILED_TO_DEFINE_ITEM_IN_GRINGO";
}

bool Function_26(bool bParam0, int iParam1) //Position: 0x1D82 / 7554
{
	return Function_9(bParam0, "CompletionReward", iParam1);
}

float Function_27(bool bParam0) //Position: 0x1DA2 / 7586
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_28() //Position: 0x1DB8 / 7608
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_29(bool bParam0) //Position: 0x1DC5 / 7621
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_30(var uParam0, int iParam1) //Position: 0x1DE5 / 7653
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_31(bool bParam0) //Position: 0x1DF4 / 7668
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_32() //Position: 0x1E13 / 7699
{
	return;
}

void Function_33(var uParam0, int iParam1) //Position: 0x1E19 / 7705
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34(int iParam0) //Position: 0x1E27 / 7719
{
	iParam0 = iParam0;
	return 1;
}

bool Function_35(bool bParam0) //Position: 0x1E32 / 7730
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_36(bool bParam0, int iParam1) //Position: 0x1E4C / 7756
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_37(bool bParam0) //Position: 0x1E6A / 7786
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1E89 / 7817
{
	int iVar0;
	int iVar1;
...
bool Function_39(bool bParam0) //Position: 0x1EBC / 7868
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_40(bool bParam0) //Position: 0x1EDB / 7899
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x1EF5 / 7925
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1F08 / 7944
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_43() //Position: 0x21F0 / 8688
{
	int iVar0;
...
bool Function_44(bool bParam0, bool bParam1) //Position: 0x21F8 / 8696
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_45() //Position: 0x2215 / 8725
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2224 / 8740
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2246 / 8774
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_48(bool bParam0) //Position: 0x226A / 8810
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x2287 / 8839
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x22A7 / 8871
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_51(bool bParam0, bool bParam1) //Position: 0x22C7 / 8903
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_52(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2375 / 9077
{
	bool bVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x23E5 / 9189
{
	if (!Function_14(iParam0))
	{
...
void Function_54(int iParam0, float fParam1) //Position: 0x23FB / 9211
{
...
var Function_55(bool bParam0) //Position: 0x241C / 9244
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_56(int iParam0) //Position: 0x243C / 9276
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x2450 / 9296
{
	uParam0 = uParam0;
	return;
}

int Function_58() //Position: 0x245A / 9306
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x2461 / 9313
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_60(bool bParam0, var uParam1, int iParam2) //Position: 0x2470 / 9328
{
	bool bVar0;
...
bool Function_61(bool bParam0) //Position: 0x24AF / 9391
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(bool bParam0) //Position: 0x24DA / 9434
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_63(bool bParam0) //Position: 0x24E5 / 9445
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_64(bool bParam0) //Position: 0x25DB / 9691
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_65(bool bParam0) //Position: 0x25FD / 9725
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(bool bParam0) //Position: 0x2624 / 9764
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	while (iVar10 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(bVar11))
		{
			...
			{
				Function_68(StackVal, StackVal, StackVal, StackVal, vVar3, vVar14);
				vVar3 = { StackVal, StackVal, Function_68(StackVal, StackVal, StackVal, StackVal, vVar3, vVar14) };
				Function_67(StackVal, StackVal, StackVal, StackVal, vVar0, vVar14);
				vVar0 = { StackVal, StackVal, Function_67(StackVal, StackVal, StackVal, StackVal, vVar0, vVar14) };
			}
		}
	...
	if (IS_OBJECT_VALID(bVar24))
	{
		...
		bVar26 = CREATE_POINT_IN_LAYOUT(bVar25, Function_43(), vVar17, 0.0f, 0.0f, 0.0f);
		...
		if (bVar28)
		{
			...
			ATTACH_OBJECTS(bVar26, GRINGO_GET_MY_OBJECT_REF(), Function_43(), vVar36, 0.0f, 0.0f, 0.0f, 4294967295);
		}
...
vector3 Function_67(vector3 vParam0) //Position: 0x28E3 / 10467
{
	vector3 vVar0;
...
vector3 Function_68(vector3 vParam0) //Position: 0x2940 / 10560
{
	vector3 vVar0;
...
void Function_69(int iParam0) //Position: 0x299D / 10653
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x29A7 / 10663
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x29C5 / 10693
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x29DA / 10714
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2A61 / 10849
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A84 / 10884
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x2AA2 / 10914
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x2AC5 / 10949
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x2BE0 / 11232
{
...
int Function_78(bool bParam0) //Position: 0x2C0B / 11275
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2D10 / 11536
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2D1D / 11549
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2D90 / 11664
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x328E / 12942
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x32C5 / 12997
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32E2 / 13026
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x331A / 13082
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x3324 / 13092
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(var uParam0, int iParam1) //Position: 0x3345 / 13125
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x3353 / 13139
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x345B / 13403
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x3471 / 13425
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x3727 / 14119
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_92(bool bParam0) //Position: 0x3735 / 14133
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x374E / 14158
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(bool bParam0, int iParam1) //Position: 0x3768 / 14184
{
	bool bVar0;
	char* cVar1;
	...
	if (!bVar0)
	{
		if (IS_ACTOR_PLAYER(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_95(var uParam0, int iParam1) //Position: 0x3797 / 14231
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x37AE / 14254
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x3A77 / 14967
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x3A94 / 14996
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3B30 / 15152
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x3B4F / 15183
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x3B5E / 15198
{
...
void Function_102(int iParam0) //Position: 0x3B7A / 15226
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x3B84 / 15236
{
	int iVar0;
	int iVar1;
	...
	{
		Function_104(&(Local_1[iLocal_7412]), bParam0);
		iLocal_74++;
	}
...
void Function_104(int iParam0, int iParam1) //Position: 0x3BE6 / 15334
{
...
void Function_105(int iParam0) //Position: 0x3BFA / 15354
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3C04 / 15364
{
