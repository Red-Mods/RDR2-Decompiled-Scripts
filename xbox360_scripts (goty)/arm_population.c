...
void main() //Position: 0x0 / 0
{
	...
	uVar0 = Function_26("ped_generic", 0);
	Function_23(&uVar0, 202, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 87, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 235, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 217, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 140, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 137, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 46, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 50, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 22, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 311, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 33, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 34, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 76, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 79, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 141, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 204, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 155, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 142, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 49, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 56, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 74, 4.0f, 14, 0, 0);
	Function_23(&uVar0, 178, 4.0f, 14, 0, 0);
	...
	uVar3 = Function_26("ped_saloon", 0);
	Function_23(&uVar3, 48, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 203, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 203, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 202, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 87, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 235, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 140, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 137, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 46, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 50, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 311, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 33, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 34, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 141, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 204, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 155, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 142, 4.0f, 48, 0, 0);
	Function_23(&uVar3, 178, 4.0f, 48, 0, 0);
	uVar4 = Function_26("ped_saloonD", 0);
	Function_23(&uVar4, 48, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 203, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 203, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 202, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 87, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 235, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 140, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 137, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 46, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 50, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 311, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 33, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 34, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 141, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 204, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 155, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 142, 4.0f, 14, 0, 0);
	Function_23(&uVar4, 178, 4.0f, 14, 0, 0);
	if (!Function_21())
	{
		if (Global_25974[0])
		{
			uVar5 = Function_26("nped_poker", 0);
			Function_22(&uVar5, 399, 1.0f, 0, 0);
			Function_22(&uVar5, 118, 1.0f, 0, 0);
			Function_22(&uVar5, 144, 1.0f, 0, 0);
			Function_22(&uVar5, 158, 1.0f, 0, 0);
			Function_22(&uVar5, 488, 1.0f, 0, 0);
			Function_22(&uVar5, 37, 1.0f, 0, 0);
		}
		if (Global_25974[8])
		{
			uVar6 = Function_26("ped_fivefinger", 0);
			Function_22(&uVar6, 84, 1.0f, 0, 0);
			Function_22(&uVar6, 175, 1.0f, 0, 0);
			Function_22(&uVar6, 422, 1.0f, 0, 0);
			Function_22(&uVar6, 174, 1.0f, 0, 0);
			Function_22(&uVar6, 506, 1.0f, 0, 0);
		}
	}
	uVar7 = Function_26("ped_storyTeller", 0);
	Function_23(&uVar7, 180, 4.0f, 62, 0, 0);
	Function_23(&uVar7, 183, 4.0f, 62, 0, 0);
	uVar8 = Function_26("ped_storyListen", 0);
	Function_23(&uVar8, 164, 4.0f, 62, 0, 0);
	Function_23(&uVar8, 217, 4.0f, 62, 0, 0);
	uVar9 = Function_26("ped_prostitute", 0);
	Function_22(&uVar9, 250, 5.0f, 0, 0);
	Function_22(&uVar9, 66, 5.0f, 0, 0);
	Function_22(&uVar9, 67, 5.0f, 0, 0);
	Function_22(&uVar9, 69, 5.0f, 0, 0);
	Function_22(&uVar9, 65, 5.0f, 0, 0);
	Function_22(&uVar9, 71, 5.0f, 0, 0);
	Function_22(&uVar9, 72, 5.0f, 0, 0);
	...
	uVar11 = Function_26("ped_worker", 0);
	Function_23(&uVar11, 33, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 34, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 298, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 288, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 153, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 154, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 33, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 34, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 155, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 142, 8.0f, 15, 0, 0);
	Function_23(&uVar11, 178, 8.0f, 15, 0, 0);
	uVar12 = Function_26("ped_prisoner", 0);
	Function_20(&uVar12, 33, 8.0f, 0, 0);
	Function_20(&uVar12, 34, 8.0f, 0, 0);
	Function_20(&uVar12, 298, 8.0f, 0, 0);
	Function_20(&uVar12, 288, 8.0f, 0, 0);
	Function_20(&uVar12, 153, 8.0f, 0, 0);
	Function_20(&uVar12, 154, 8.0f, 0, 0);
	Function_20(&uVar12, 33, 8.0f, 0, 0);
	Function_20(&uVar12, 34, 8.0f, 0, 0);
	Function_20(&uVar12, 155, 8.0f, 0, 0);
	Function_20(&uVar12, 142, 8.0f, 0, 0);
	Function_20(&uVar12, 178, 8.0f, 0, 0);
	uVar13 = Function_26("nped_tough", 0);
	Function_23(&uVar13, 486, 5.0f, 14, 0, 0);
	Function_23(&uVar13, 487, 5.0f, 14, 0, 0);
	Function_23(&uVar13, 489, 5.0f, 14, 0, 0);
	Function_23(&uVar13, 490, 5.0f, 14, 0, 0);
	Function_23(&uVar13, 491, 5.0f, 14, 0, 0);
	Function_23(&uVar13, 493, 5.0f, 14, 0, 0);
	uVar14 = Function_26("ped_toughN", 0);
	Function_23(&uVar14, 486, 5.0f, 48, 0, 0);
	Function_23(&uVar14, 487, 5.0f, 48, 0, 0);
	Function_23(&uVar14, 489, 5.0f, 48, 0, 0);
	Function_23(&uVar14, 490, 5.0f, 48, 0, 0);
	Function_23(&uVar14, 491, 5.0f, 48, 0, 0);
	Function_23(&uVar14, 493, 5.0f, 48, 0, 0);
	...
	uVar16 = Function_26("timed_horse", 0);
	Function_23(&uVar16, 977, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 981, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 983, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 984, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 985, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 986, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 987, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 988, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 989, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 990, 100.0f, 15, 0, 0);
	Function_23(&uVar16, 991, 100.0f, 15, 0, 0);
	uVar17 = Function_26("critter", 0);
	Function_23(&uVar17, 1082, 100.0f, 48, 0, 0);
	Function_23(&uVar17, 1082, 100.0f, 48, 0, 0);
	Function_23(&uVar17, 1082, 100.0f, 48, 0, 0);
	Function_23(&uVar17, 1084, 100.0f, 48, 0, 0);
	Function_23(&uVar17, 1085, 100.0f, 48, 0, 0);
	Function_23(&uVar17, 1086, 100.0f, 48, 0, 0);
	uVar18 = Function_26("sheep", 0);
	Function_23(&uVar18, 1023, 100.0f, 15, 0, 0);
	Function_23(&uVar18, 1024, 100.0f, 15, 0, 0);
	Function_23(&uVar18, 1024, 100.0f, 15, 0, 0);
	Function_23(&uVar18, 1025, 100.0f, 15, 0, 0);
	uVar19 = Function_26("chickens", 0);
	Function_23(&uVar19, 1015, 100.0f, 15, 0, 0);
	Function_23(&uVar19, 1016, 100.0f, 15, 0, 0);
	uVar20 = Function_26("dogs", 0);
	Function_22(&uVar20, 1043, 100.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar22))
	{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar24 = Function_8(bVar23, uVar0, 5, 10, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar25 = Function_8(bVar23, uVar3, 2, 5, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar0, 2, 3, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar0, 2, 5, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar3, 3, 6, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar8, 1, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_saloon_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar9, 4, 6, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_saloon_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar26 = Function_8(bVar23, uVar3, 4, 6, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar27 = Function_8(bVar23, uVar4, 2, 4, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar28 = Function_8(bVar23, uVar9, 2, 3, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar3, 2, 3, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar4, 2, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_saloonBalcony_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar4, 2, 3, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_saloon_set to create population volumes");
		...
		if (!Function_21())
		{
			...
			if (IS_VOLUME_VALID(bVar23))
			{
				if (Global_25974[0])
				{
					bVar29 = Function_7(bVar23, uVar5, 4, 1, 0, 0);
					Function_6(bVar29);
			...
			if (IS_VOLUME_VALID(bVar23))
			{
				if (Global_25974[8])
				{
					bVar30 = Function_7(bVar23, uVar6, 5, 1, 0, 0);
					Function_4(bVar30);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar31 = Function_8(bVar23, uVar13, 3, 5, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			bVar32 = Function_8(bVar23, uVar14, 4, 7, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_8(bVar23, uVar11, 4, 6, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar12, 1, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_workers_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar16, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar18, 1, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar18, 2, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar20, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar17, 1, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("arm_pop: Cannot find armv_dogs_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_7(bVar23, uVar19, 4, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			Function_3(bVar23, uVar21, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x2371 / 9073
{
	bool bVar0;
...
var Function_7(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x24C6 / 9414
{
	var uVar0;
...
var Function_8(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x2546 / 9542
{
	var uVar0;
...
void Function_12(var uParam0, int iParam1) //Position: 0x263E / 9790
{
...
var Function_20(var uParam0, int iParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x2710 / 10000
{
	int iVar0;
	int iVar1;
	
	iVar0 = Function_22(uParam0, iParam1, fParam2, bParam3, 0);
	if (iVar0 > 0)
	{
...
var Function_22(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x275E / 10078
{
	int iVar0;
	int iVar1;
...
var Function_23(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x27DA / 10202
{
	int iVar0;
	int iVar1;
	...
	LINK_ACTORENUM_TO_POPULATION_TIMED(*uParam0, iParam1, fParam2, Function_25(iParam3), Function_24(iParam3));
	if (bParam4)
	{
	}
	return (GET_NUM_ACTORENUMS_IN_POPULATION(*uParam0) - 1);
...
var Function_24(int iParam0) //Position: 0x2852 / 10322
{
	int iVar0;
...
var Function_25(int iParam0) //Position: 0x28BE / 10430
{
	int iVar0;
...
var Function_26(int iParam0, int iParam1) //Position: 0x292A / 10538
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_27(bool bParam0, var uParam1) //Position: 0x2937 / 10551
{
	if (!Function_9(128))
	{
		return;
