...
void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	...
	uParam0 = Function_67(uParam0);
	*iParam2 = 0;
	iLocal_3 = 0;
	if (!IS_ACTOR_VALID(bParam1) || !IS_ACTOR_ALIVE(Global_34573))
	{
		return;
	}
	Global_30741 = Function_62(0, Global_30685[2], 3);
	bVar0 = false;
	if (Global_13172[Global_3074111].f_16 == 0)
	{
		bVar0 = true;
	}
	else if (IS_EARLIER_THAN(Global_13172[Global_3074111].f_16, 0))
	{
		bVar0 = true;
	}
	if (bVar0)
	{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(Global_34573, 16) - _GET_AMMO_AMOUNT(Global_34573, 16, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(Global_34573, 16));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(Global_34573, 5) - _GET_AMMO_AMOUNT(Global_34573, 5, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(Global_34573, 5));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		{
			fVar1 = (_GET_MAX_AMMO_AMOUNT(Global_34573, 4) - _GET_AMMO_AMOUNT(Global_34573, 4, 1));
			fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(Global_34573, 4));
			if (fVar2 < fVar7)
			{
				if (fVar7 < fVar8)
				{
		...
		if (!IS_WEAPONENUM_LOCKED(31))
		{
			...
			{
				fVar1 = (_GET_MAX_AMMO_AMOUNT(Global_34573, 13) - _GET_AMMO_AMOUNT(Global_34573, 13, 1));
				fVar2 = (fVar1 / _GET_MAX_AMMO_AMOUNT(Global_34573, 13));
				if (fVar2 < fVar7)
				{
					if (fVar7 < fVar8)
					{
		...
		if (bVar3 != 4294967295)
		{
			_ADD_AMMO_OF_TYPE(Global_34573, bVar3, bVar5, 1, 1);
		}
		if (bVar4 != 4294967295)
		{
			_ADD_AMMO_OF_TYPE(Global_34573, bVar4, (fVar6 / 2.0f), 1, 1);
		}
		iVar9 = 0;
		iVar10 = 0;
		bVar11 = 4294967295;
		iVar9 = (GET_MAX_ITEM_COUNT(Function_61(3)) - GET_ITEM_COUNT(Function_61(3), Global_34573));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = 3;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_61(1)) - GET_ITEM_COUNT(Function_61(1), Global_34573));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = true;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_61(0)) - GET_ITEM_COUNT(Function_61(0), Global_34573));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = false;
		}
		iVar9 = (GET_MAX_ITEM_COUNT(Function_61(2)) - GET_ITEM_COUNT(Function_61(2), Global_34573));
		if (iVar9 >= iVar10)
		{
			iVar10 = iVar9;
			bVar11 = 2;
		...
		{
			ADD_ITEM(Function_61(bVar11), Global_34573, 1);
		}
		iVar12 = GET_TIME_OF_DAY();
		ADD_TIME(&iVar12, 1, 0, false, 0);
		Global_13172[Global_3074111].f_16 = iVar12;
		Function_60(iVar12);
		PRINTNL();
		*iParam2 = 1;
	}
	...
	{
		Function_58("tut_holy_relic_wait", 0x41200000, 1, 0, 2, 1, 0);
	}
	return;
}

void Function_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2F56 / 12118
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2FD1 / 12241
{
	char* cVar0[16];
...
void Function_60(bool bParam0) //Position: 0x3010 / 12304
{
	PRINTSTRING("Day ");
...
var Function_61(bool bParam0) //Position: 0x3056 / 12374
{
	bool bVar0;
...
int Function_62(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3147 / 12615
{
	int iVar0;
	int iVar1;
...
int Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x31A5 / 12709
{
	var uVar0;
...
int Function_64(int iParam0) //Position: 0x32FA / 13050
{
	int iVar0;
...
bool Function_65(int iParam0) //Position: 0x3338 / 13112
{
...
var Function_66(int iParam0, int iParam1, int iParam2) //Position: 0x334D / 13133
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

var Function_67(bool bParam0) //Position: 0x336D / 13165
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_68(int iParam0, bool bParam1) //Position: 0x3387 / 13191
{
	bool bVar0;
	bool bVar1;
