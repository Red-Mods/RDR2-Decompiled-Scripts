...
void main() //Position: 0x0 / 0
{
	...
	iLocal_523 = 0;
	iLocal_525 = 0;
	bLocal_524 = NET_GET_FREE_ROAM_MODE();
	Function_705(8);
	fVar1 = 0.0f;
	bVar2 = false;
	...
	while (!IS_EXITFLAG_SET() && !bVar9)
	{
		...
		switch (Local_286)
		{
			...
			case 0x00000004:
				if (bLocal_524 != NET_GET_FREE_ROAM_MODE())
				{
					bVar9 = true;
				}
				Function_544();
...
void Function_13() //Position: 0xD97 / 3479
{
	...
	if (IS_ACTORSET_VALID(Local_201.f_96))
	{
		...
		while (bVar0 <= iVar1)
		{
			bVar2 = GET_ACTOR_FROM_ACTORSET(Local_201.f_96, bVar0);
			if (IS_ACTOR_VALID(bVar2))
			{
				AI_GLOBAL_SET_PERMANENT_DANGER(bVar2, 0);
				NET_LOG(1, "FRD Client", "Actor %s removed from avoidance set.", GET_ACTOR_NAME(bVar2), false, false, false);
			}
			bVar0++;
		}
...
void Function_18(bool bParam0, int iParam1) //Position: 0xEAB / 3755
{
	if (bParam0 != Function_19(0x8000000, 1))
	{
		...
		NET_LOG(1, "FRD Client", iParam1, false, false, false, false);
	}
	return;
}
...
void Function_32(bool bParam0, bool bParam1) //Position: 0x10C3 / 4291
{
	bool bVar0;
...
var Function_40(bool bParam0, vector3 vParam1, bool bParam4) //Position: 0x1337 / 4919
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam4)
	{
		...
		Function_41(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &bVar4, vParam1, vVar5, vVar11);
	...
	while (iVar3 <= iVar0)
	{
		...
		Function_41(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &bVar4, vParam1, vVar8, vVar11);
		iVar3++;
	}
	iVar3 = 0;
	while (iVar3 <= iVar0 * 3)
...
void Function_41(bool bParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7) //Position: 0x1470 / 5232
{
...
vector3 Function_42(var uParam0, bool bParam1) //Position: 0x14C5 / 5317
{
	vector3 vVar0;
...
void Function_60(char* cParam0, int iParam1) //Position: 0x1A73 / 6771
{
	bool bVar0;
...
void Function_65(int iParam0) //Position: 0x1B08 / 6920
{
	...
	bVar0[13] = FLOOR(Function_67(8));
	bVar0[0] = FLOOR(Function_67(8));
...
void Function_74(bool bParam0) //Position: 0x1C2C / 7212
{
	...
	{
		NET_LOG(1, "FRD Client", "Host FRD Region has changed from %s to %s", Function_155(Local_201.f_48), Function_155(bParam0->f_68), false, false);
		Function_154(1, Function_20(bParam0->f_68));
		if (bParam0->f_68 == 4294967295)
		{
			if (Function_24(1))
			{
				NET_LOG(1, "FRD Client", "Instance destroyed!", false, false, false, false);
			}
			Function_3(0);
		}
		else if (!Function_24(1))
		{
			...
			NET_LOG(1, "FRD Client", "Instance instantiated!", false, false, false, false);
			if (Function_156())
			{
	...
	{
		NET_LOG(1, "FRD Client", "Host FRD Active Player has changed from %s to %s", I2STR(Local_201.f_44), I2STR(bParam0->f_48), false, false);
		...
		else if (Function_24(1))
		{
			...
			if (bParam0->f_48 == 4294967294)
			{
				if (bVar3)
				{
					if (UI_ISFOCUSED("HudSceneOnline"))
					{
						if (!Function_24(2))
						{
							PRINT_HELP_FORMAT(10.0f, "mp_FRD_UpForGrabsHelp", Function_155(bParam0->f_68), false, 0, 0, 2, 0, 0);
							Function_152(2);
						}
						else
						{
			...
			else if (bParam0->f_48 == bVar1)
			{
				...
				if (UI_ISFOCUSED("HudSceneOnline"))
				{
					if (!Function_24(4))
					{
						PRINT_HELP_FORMAT(10.0f, "mp_FRD_DefendingHelp", Function_155(bParam0->f_68), false, 0, 0, 2, 0, 0);
						Function_152(4);
					}
					else
					{
				...
				if (bVar3)
				{
					if (!Function_19(2, 1))
					{
						...
						if (bParam0->f_48 > 0)
						{
							...
							{
								HUD_CLEAR_OBJECTIVE_QUEUE();
								PRINT_OBJECTIVE_FORMAT(7.5f, "mp_FRD_Obj_KillThatGuy", Function_112(bParam0->f_48), false, 0, 0, 0, 2, 0, 0, 0);
							}
						}
					}
					if (bParam0->f_48 > 0)
			...
			if (bParam0->f_48 > 0)
			{
				if (bParam0->f_56 && IS_SLOT_VALID(bParam0->f_48))
				{
					...
					{
						SAY_SINGLE_LINE_STRING(bVar18, "MPTAUNT", true, true, 3, 0, true, false);
					}
				}
	...
	if (bParam0->f_48 > 0)
	{
		...
		{
			NET_LOG(1, "FRD Client", "Updating UI because the color of the guy has changed from %s to %s", V2STR(&Local_201 + 56), V2STR(&vVar19), false, false);
	...
	if (bParam0->f_48 != 4294967295)
	{
		if (bVar5 && !Function_157(16384))
		{
			if (Function_110(&Local_201 + 84, iLocal_194) && Function_131(bParam0 + 24) < fLocal_196)
			{
				if (!Function_109())
				{
					NET_LOG(1, "FRD Host", "Nobody's in the same area... killing it off", false, false, false, false);
	...
	switch (bParam0->f_48)
	{
		case 0xFFFFFFFE:
			...
			bVar6 = Function_103(bParam0 + 12);
			if (bVar5)
			{
				if (bVar6 >= 0.0f)
				{
					NET_LOG(1, "FRD Host", "Spoon has been on ground long enough. Dropping it forever.", false, false, false, false);
			...
			if (Function_105(&Local_201 + 116))
			{
				if (!Function_91(&Local_201 + 116))
				{
					...
					Function_89();
					NET_LOG(1, "FRD Client", "Pausing due to dropped spoon with %s seconds of Spoonership.", F2STR(Function_67(2), 3, 2), false, false, false);
				}
			}
			break;
		...
		default:
			if (!IS_SLOT_VALID(bParam0->f_48))
			{
				if (bVar5)
				{
					NET_LOG(1, "FRD Host", "Currently running player #%s has gone invalid. Dropping spoon", I2STR(bParam0->f_48), false, false, false);
					Function_88(bParam0);
				}
			}
			else
			{
				...
				if (bVar5)
				{
					if (bVar6 >= 0.0f)
					{
						NET_LOG(1, "FRD Host", "Timer's ran out, awarding Player #%s, %s, %s XP!", I2STR(bParam0->f_48), GET_SLOT_NAME(bParam0->f_48), I2STR(CEIL(bParam0->f_64)), false);
					...
					{
						NET_LOG(1, "FRD Host", "Spoonholder, #%s, %s, has left the area, dropping!", I2STR(bParam0->f_48), GET_SLOT_NAME(bParam0->f_48), false, false);
						Function_88(bParam0);
					}
				}
				if (bParam0->f_48 == GET_LOCAL_SLOT())
				{
					...
					if (!Function_105(&Local_201 + 116))
					{
						...
						NET_LOG(1, "FRD Client", "Kicking off Spoonership with 0.0 seconds", false, false, false, false);
					...
					else if (Function_91(&Local_201 + 116))
					{
						...
						Function_49(&Local_201 + 128);
						NET_LOG(1, "FRD Client", "Unpausing Spoonership with %s left.", F2STR(Function_131(&Local_201 + 116), 3, 2), false, false, false);
					}
					if (bVar6 >= fLocal_199 || Function_110(&Local_201 + 128, fLocal_198))
					{
						Function_89();
					}
				}
				else
				{
					...
					if (Function_105(&Local_201 + 116))
					{
						...
						{
							Function_90(&Local_201 + 116);
							NET_LOG(1, "FRD Client", "Pausing Spoonership with %s left.", F2STR(Function_67(2), 3, 2), false, false, false);
							Function_89();
						}
					}
				}
	...
	if ((iVar0 && bVar6 <= 0.0f) && bVar3)
	{
		...
		if (FABS((UI_ANIM_GET_TIME("NetTimer") - bVar6)) < 1.0f)
		{
			Function_80(bVar6);
		}
		iVar23 = 1;
...
void Function_80(bool bParam0) //Position: 0x2CE2 / 11490
{
...
void Function_89() //Position: 0x32C8 / 13000
{
	...
	if (Function_105(&Local_201 + 116))
	{
		bVar0 = Function_131(&Local_201 + 116);
		Function_15(2, bVar0);
		bVar1 = CEIL(bVar0);
...
void Function_92(bool bParam0, bool bParam1) //Position: 0x345E / 13406
{
	...
	if (bParam1)
	{
		if (Function_157(1))
		{
			NET_LOG(1, "FRD Host", "Nobody gets payout. That's %s just evaporating!", I2STR(CEIL(bParam0->f_64)), false, false, false);
			return;
		}
	}
...
void Function_93(bool bParam0, bool bParam1, int iParam2) //Position: 0x3601 / 13825
{
	struct<9> Var0;
	...
	NET_LOG(1, "FRD Host", "SEND Payout for player #%s for %s XP, bTheyWon: %s", I2STR(vVar0.x), I2STR(CEIL(vVar0.y)), false, false);
	return;
}
...
bool Function_94(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x3677 / 13943
{
	...
	if (bParam0 || (Function_157(8) && bVar0))
	{
		...
		else
		{
			...
			if (bParam4)
			{
				NET_LOG(1, "FRD Host", "#%s Eligible: %s. Volume and posse: %s", I2STR(bParam1), Function_95(bVar1), Function_95(bVar0), false);
			}
		}
	}
	else if (bParam4)
	{
		NET_LOG(1, "FRD Host", "#%s Eligible: %s. Just Posse: %s", I2STR(bParam1), Function_95(bVar1), Function_95(bVar0), false);
	}
	return bVar1;
}
...
void Function_100(int iParam0) //Position: 0x384D / 14413
{
	...
	bVar4 = false;
	NET_LOG(1, "FRD Host", "Getting Data for involved players", false, false, false, false);
	...
	while (bVar1 <= 16)
	{
		if (Function_99(bVar1))
		{
			if (Function_96(bVar1) == iVar0)
			{
				...
				bVar3 = (StackVal + bVar3);
				NET_LOG(StackVal, 1, "FRD Host", "     %s) Slot %s reports %s seconds", I2STR(bVar2), F2STR(I2STR(bVar1), 4, 2), false);
	...
	NET_LOG(1, "FRD Host", "     Total Time is %s", F2STR(bVar3, 4, 2), false, false, false);
	NET_LOG(1, "FRD Host", "Calculating first draft payouts", false, false, false, false);
	bVar1 = false;
	while (bVar1 <= bVar2)
	{
		Var5[bVar14].f_12 = ((StackVal / bVar3) * iParam0->f_64);
		bVar70 = (bVar70 + Var5[bVar14].f_12);
		NET_LOG(1, "FRD Host", "     %s) Slot %s gets %s", I2STR(bVar1), I2STR(Var5[bVar14]), F2STR(Var5[bVar14].f_12, 4, 2), false);
		bVar1++;
	}
	bVar71 = (iParam0->f_64 - bVar70);
	NET_LOG(1, "FRD Host", "     %s awarded of %s (PotSize) with difference of %s", F2STR(bVar70, 4, 2), F2STR(iParam0->f_64, 4, 2), F2STR(bVar71, 4, 2), false);
	if (!Function_157(4))
	{
		NET_LOG(1, "FRD Host", "Slot %s is the highest scorer.  Adding remaineder (%s) if there is any", I2STR(Var5[bVar44]), F2STR(bVar71, 4, 2), false, false);
		if (bVar71 < 0.0f)
		{
			Var5[bVar44].f_12 = (Var5[bVar44].f_12 + bVar71);
		}
	}
		...
		while (bVar1 <= bVar2)
		{
			...
			if (StackVal > 0)
			{
				...
				while (iVar73 <= bVar2)
				{
					if (StackVal == StackVal)
					{
						bVar72 = (bVar72 + Var5[iVar734].f_12);
						bVar74++;
					}
					iVar73++;
				}
				if (bVar74 >= 1)
				{
					NET_LOG(StackVal, 1, "FRD Host", I2STR("Updating posse scores for posse %s.  %s members divvying %s"), I2STR(bVar74), F2STR(bVar72, 4, 2), false);
					bVar72 = (bVar72 / IntToFloat(bVar74));
					iVar75 = StackVal;
					iVar73 = 0;
					while (iVar73 <= bVar2)
					{
						if (StackVal == iVar75)
						{
							NET_LOG(1, "FRD Host", "     Updating Slot %s award to %s", I2STR(Var5[iVar734]), F2STR(bVar72, 4, 2), false, false);
							Var5[iVar734].f_12 = bVar72;
...
void Function_107(bool bParam0) //Position: 0x3E02 / 15874
{
	...
	if (!IS_ACTOR_IN_ACTORSET(Local_201.f_96, bParam0))
	{
		...
		NET_LOG(1, "FRD Client", "Actor %s added to avoidance set.", GET_ACTOR_NAME(bParam0), false, false, false);
	}
	return;
}
...
void Function_114(bool bParam0, var uParam1, int iParam2) //Position: 0x41E9 / 16873
{
	var uVar0;
...
struct<32> Function_116(char* cParam0, bool bParam1) //Position: 0x421E / 16926
{
	char* cVar0[32];
...
void Function_117(bool bParam0, bool bParam1) //Position: 0x4237 / 16951
{
	if (Function_570(1024))
	{
		NET_LOG(1, "FRD Client", "Making the VO guy say %s", bParam0, false, false, false);
		Function_32(bParam0, 0);
	}
	else if (IS_STRING_VALID(bParam1))
	{
		NET_LOG(1, "FRD Client", "Making the VO guy say %s instead of %s", bParam1, bParam0, false, false);
		Function_32(bParam1, 0);
	}
	else
	{
		NET_LOG(1, "FRD Client", "Making the VO guy say %s, but couldn't (not installed)", bParam0, false, false, false);
	}
	return;
}

void Function_118(bool bParam0, bool bParam1) //Position: 0x4320 / 17184
{
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), bParam1, 0, 0, 0, 0, 0);
	return;
}

void Function_119(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4335 / 17205
{
	struct<4> Var0;
	int iVar4;
...
void Function_122(bool bParam0, int iParam1) //Position: 0x4414 / 17428
{
	...
	if (!IS_BLIP_VALID(Local_201.f_36))
	{
		...
		Local_201.f_36 = ADD_BLIP_FOR_OBJECT(bParam0, 440, 0f, 2, 0);
...
void Function_123(bool bParam0, int iParam1, float fParam2, bool bParam3) //Position: 0x4483 / 17539
{
	struct<9> Var0;
...
void Function_124() //Position: 0x45BE / 17854
{
	...
	{
		bVar0[13] = FLOOR(Local_201.f_104);
		bVar0[0] = FLOOR(Local_201.f_104);
		bVar0[14] = 1;
		bVar0[12] = Local_201.f_112;
		bVar0[11] = Local_201.f_108;
		bVar0[66] = FLOOR((Function_67(2) * 1000.0f));
		iVar68 = 152;
		if (Function_66())
		{
			iVar68 = 153;
		...
		NET_START_LB_UPDATE(0);
		NET_UPDATE_LEADERBOARD(GET_LOCAL_SLOT(), iVar68, 4294967295, &bVar0);
		NET_END_LB_UPDATE();
	}
	Function_125();
	return;
...
void Function_126(var uParam0, int iParam1) //Position: 0x4654 / 18004
{
	...
	if (Function_157(65536))
	{
		...
		{
			NET_LOG(1, "FRD Client", "Splashing winner message for %s", GET_SLOT_NAME(uParam0->f_76), false, false, false);
			if (Function_132(uParam0->f_76))
			{
				Function_32("GENMESS_GAMEWON", 0);
				iVar1 = "HUD_MP_OVERTIME_WIN_MASTER";
			}
			else
			{
				Function_32("GENMESS_GAMELOST", 0);
				iVar1 = "HUD_MP_OVERTIME_LOSE_MASTER";
			}
			PRINT_BIG_FORMAT(4.0f, "mp_FRD_Wins", Function_112(uParam0->f_76), Function_155(iParam1), iVar0, iVar0, 0, iVar1);
		}
		else
		{
			NET_LOG(1, "FRD Client", "Splashing Nobody win message cause non-valid high scorer", false, false, false, false);
...
void Function_127(int iParam0) //Position: 0x4906 / 18694
{
	...
	else if (iParam0 != 4294967295)
	{
		...
		{
			UI_SET_STRING_FORMAT("FRD_BlipColor", "%s<MP_DEFEND></0x>", Function_128(iParam0, 1), false, false);
		}
...
void Function_134(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5140 / 20800
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar1 = CREATE_OBJECTSET_IN_LAYOUT(Function_135(), bParam0, 4294967295, 1);
...
void Function_137(bool bParam0, bool bParam1, bool bParam2) //Position: 0x51C1 / 20929
{
	...
	if (bParam0 > 0)
	{
		NET_LOG(1, "FRD Invite", "SENDing invite to PR_multiplayer from %s, %s, at barker %s", I2STR(bParam0), GET_SLOT_NAME(bParam0), I2STR(bParam1), false);
	}
	else
	{
		NET_LOG(1, "FRD Invite", "SENDing invite to PR_multiplayer from %s, --Invalid--, at barker %s", I2STR(bParam0), GET_SLOT_NAME(bParam0), I2STR(bParam1), false);
	}
	return;
}
...
void Function_140(char* cParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5383 / 21379
{
	AUDIO_MUSIC_FORCE_TRACK(uParam0, Function_130(uParam1), iParam2, iParam3, iParam4, iParam5, iParam6);
}
...
int Function_144(int iParam0) //Position: 0x559B / 21915
{
	...
	uVar0 = uVar0;
	bLocal_177 = iParam0;
	CREATE_VOLUME_IN_LAYOUT(bLocal_177, "Defense_Volume", 3, -1700.528f, 10.47344f, 4226.433f, 0.0f, -37.6365f, 0.0f, 21.93562f, 12.67413f, 21.51064f);
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_177, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_0", 2, -1678.539f, 11.23122f, 4250.337f, 0.0f, -181.1415f, 0.0f, 1.822228f, 1.0f, 6.190878f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_1", 3, -1742.453f, 9.28788f, 4187.162f, 0.0f, -630.7231f, 0.0f, 0.8521102f, 0.9324868f, 0.8521102f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_2", 3, -1721.454f, 11.23147f, 4252.247f, 0.0f, -194.697f, 0.0f, 0.7925131f, 0.8672681f, 0.7925131f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_3", 3, -1684.705f, 11.42213f, 4198.116f, 0.0f, -657.2018f, 0.0f, 0.8660001f, 0.9476869f, 0.8660001f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_4", 3, -1733.83f, 8.205861f, 4220.664f, 0.0f, -596.8854f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_5", 3, -1709.49f, 11.72357f, 4186.356f, 0.0f, -757.7119f, 0.0f, 1.417508f, 0.3476295f, 1.448981f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_6", 3, -1698.603f, 8.07091f, 4258.942f, 0.0f, 193.7598f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_7", 3, -1686.876f, 8.106473f, 4199.681f, 0.0f, -733.7842f, 0.0f, 1.548491f, 0.8296183f, 1.486551f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_8", 3, -1743.21f, 9.287154f, 4209.956f, 0.0f, -537.5621f, 0.0f, 1.247992f, 0.9146472f, 1.308093f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_9", 3, -1678.546f, 11.23586f, 4231.047f, 0.0f, -721.4225f, 0.0f, 0.7064732f, 0.7731124f, 0.7064732f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_11", 3, -1707.741f, 17.41178f, 4199.205f, 0.0f, -627.4625f, 0.0f, 2.142498f, 0.9476869f, 2.344801f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_12", 3, -1709.057f, 11.63805f, 4193.896f, 0.0f, -856.5405f, 0.0f, 1.137298f, 0.3187335f, 1.319873f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_13", 3, -1697.034f, 12.00094f, 4258.991f, 0.0f, -91.47185f, 0.0f, 0.7381514f, 0.8077787f, 0.7381514f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_14", 3, -1733.705f, 11.26626f, 4185.059f, 0.0f, -653.0002f, 0.0f, 1.3959f, 0.8198009f, 1.477618f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_15", 3, -1717.947f, 8.031364f, 4184.902f, 0.0f, 8.687687f, 0.0f, 0.8660001f, 0.9476869f, 0.8660001f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_16", 3, -1714.692f, 11.28081f, 4214.787f, 0.0f, -451.3032f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_17", 3, -1718.596f, 8.031358f, 4252.0f, 0.0f, -256.2474f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_18", 2, -1684.332f, 11.18858f, 4252.177f, 0.0f, -179.686f, 0.0f, 2.561617f, 1.0f, 2.112239f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_19", 3, -1700.025f, 13.77437f, 4251.741f, 0.0f, -163.295f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_20", 3, -1706.325f, 11.04855f, 4252.162f, 0.0f, -179.9845f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_21", 3, -1700.265f, 8.07091f, 4263.071f, 0.0f, 178.8806f, 0.0f, 1.36225f, 0.7527589f, 0.6878741f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	bVar23 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_23", 3, -1721.484f, 11.24403f, 4224.455f, 0.0f, -307.8875f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar23);
	bVar24 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_24", 3, -1713.556f, 11.28081f, 4221.56f, 0.0f, -490.32f, 0.0f, 0.6383516f, 0.6985651f, 0.6383516f);
	ADD_TO_VOLUME_SET(bVar1, bVar24);
	bVar25 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_25", 3, -1704.473f, 8.031363f, 4187.081f, 0.0f, -335.7577f, 0.0f, 1.503884f, 0.8581703f, 1.477348f);
	ADD_TO_VOLUME_SET(bVar1, bVar25);
	bVar26 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_26", 3, -1684.0f, 8.031361f, 4252.0f, 0.0f, -141.8529f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar26);
	bVar27 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_27", 3, -1707.261f, 8.03136f, 4252.0f, 0.0f, -181.5903f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar27);
	bVar28 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_28", 3, -1724.721f, 11.28081f, 4212.497f, 0.0f, -612.9294f, 0.0f, 0.7987055f, 0.8740447f, 0.7987055f);
	ADD_TO_VOLUME_SET(bVar1, bVar28);
	bVar29 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_29", 3, -1734.643f, 11.28081f, 4212.792f, 0.0f, -577.1346f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar29);
	bVar30 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_30", 3, -1734.126f, 14.16805f, 4221.208f, 0.0f, -597.4125f, 0.0f, 1.437195f, 0.7585974f, 1.542515f);
	ADD_TO_VOLUME_SET(bVar1, bVar30);
	bVar31 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_31", 3, -1693.02f, 13.16173f, 4186.859f, 0.0f, -721.1874f, 0.0f, 2.232815f, 0.7585974f, 2.638756f);
	ADD_TO_VOLUME_SET(bVar1, bVar31);
	bVar32 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_32", 3, -1676.258f, 8.338675f, 4225.855f, 0.0f, -847.5884f, 0.0f, 1.440719f, 0.9476869f, 0.937914f);
	ADD_TO_VOLUME_SET(bVar1, bVar32);
	bVar33 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_33", 3, -1720.11f, 8.207294f, 4221.409f, 0.0f, -572.591f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar33);
	bVar34 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_34", 3, -1676.773f, 11.42063f, 4225.947f, 0.0f, -810.5008f, 0.0f, 1.255111f, 0.9476869f, 1.542937f);
	ADD_TO_VOLUME_SET(bVar1, bVar34);
	bVar35 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_35", 3, -1724.771f, 8.207294f, 4212.745f, 0.0f, -621.2491f, 0.0f, 0.9115245f, 0.9975055f, 0.9115245f);
	ADD_TO_VOLUME_SET(bVar1, bVar35);
	bVar36 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_36", 3, -1734.352f, 8.176961f, 4187.887f, 0.0f, -588.9538f, 0.0f, 0.7268851f, 0.7954496f, 0.7268851f);
	ADD_TO_VOLUME_SET(bVar1, bVar36);
	bVar37 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_38", 3, -1739.959f, 7.300356f, 4206.479f, 0.0f, 90.09533f, 0.0f, 2.015636f, 0.9975055f, 1.09129f);
	ADD_TO_VOLUME_SET(bVar1, bVar37);
	bVar38 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_39", 3, -1738.095f, 7.33384f, 4191.57f, 0.0f, -653.0002f, 0.0f, 2.070623f, 0.9975055f, 2.015033f);
	ADD_TO_VOLUME_SET(bVar1, bVar38);
	bVar39 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_40", 2, -1690.174f, 11.18858f, 4250.331f, 0.0f, -166.8669f, 0.0f, 5.420168f, 1.0f, 5.962139f);
	ADD_TO_VOLUME_SET(bVar1, bVar39);
	bVar40 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_41", 2, -1742.776f, 9.619265f, 4191.415f, 76.12954f, 88.84176f, 76.63393f, 5.565413f, 1.0f, 1.168585f);
	ADD_TO_VOLUME_SET(bVar1, bVar40);
	bVar41 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_42", 2, -1742.812f, 9.698732f, 4198.682f, 76.12954f, 88.84176f, 76.63393f, 5.565413f, 1.0f, 1.168585f);
	ADD_TO_VOLUME_SET(bVar1, bVar41);
	bVar42 = CREATE_VOLUME_IN_LAYOUT(bLocal_177, "SpawnVol_43", 2, -1742.843f, 9.604905f, 4205.212f, 76.12954f, 88.84176f, 76.63393f, 5.539093f, 1.0f, 1.168585f);
	ADD_TO_VOLUME_SET(bVar1, bVar42);
	return 1;
}
...
int Function_146(int iParam0) //Position: 0x60D8 / 24792
{
	...
	uVar0 = uVar0;
	bLocal_176 = iParam0;
	CREATE_VOLUME_IN_LAYOUT(bLocal_176, "Defense_Volume", 3, -4295.403f, 33.01773f, 4410.761f, 0.0f, -37.6365f, 0.0f, 28.8377f, 24.13157f, 28.279f);
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_176, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_0", 3, -4335.921f, 19.07746f, 4479.539f, 0.0f, 236.0073f, 0.0f, 1.728941f, 2.075261f, 1.728941f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_1", 3, -4300.848f, 18.0706f, 4459.596f, 0.0f, 123.5088f, 0.0f, 0.8253789f, 0.9907081f, 0.8253789f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_2", 3, -4280.566f, 18.22794f, 4465.846f, 0.0f, 135.1432f, 0.0f, 0.8526884f, 1.023488f, 0.8526884f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_3", 3, -4279.006f, 22.74587f, 4381.741f, 0.0f, 30.77226f, 0.0f, 1.490163f, 1.788653f, 1.490163f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_4", 3, -4244.776f, 22.78407f, 4371.674f, 0.0f, 2.84242f, 0.0f, 0.9407431f, 0.8382427f, 0.9407431f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_5", 3, -4264.64f, 18.07059f, 4443.685f, 0.0f, -53.83153f, 0.0f, 1.507544f, 1.809515f, 1.507544f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_6", 3, -4260.016f, 24.95712f, 4331.824f, 0.0f, -84.60384f, 0.0f, 1.728941f, 2.075261f, 1.728941f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_7", 3, -4311.848f, 31.70709f, 4374.23f, 0.0f, -10.65867f, 0.0f, 1.501884f, 0.5731589f, 1.501884f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_8", 3, -4329.582f, 27.64485f, 4411.813f, 0.0f, -51.53185f, 0.0f, 1.288239f, 0.3481335f, 1.288239f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_9", 3, -4360.919f, 30.23645f, 4388.051f, 0.0f, 46.04944f, 0.0f, 1.336139f, 0.7509382f, 1.336139f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_10", 3, -4331.715f, 22.48272f, 4464.491f, 0.0f, 52.2365f, 0.0f, 0.7263988f, 0.8719015f, 0.7263988f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_11", 3, -4290.286f, 18.28778f, 4457.1f, 0.0f, 131.2531f, 0.0f, 0.5238062f, 0.5406335f, 0.5404987f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_12", 3, -4271.064f, 18.07059f, 4448.095f, 0.0f, 124.4667f, 0.0f, 1.507544f, 1.809515f, 1.507544f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_13", 3, -4264.638f, 21.92659f, 4397.713f, 0.0f, 272.6876f, 0.0f, 1.728941f, 2.075261f, 1.728941f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_14", 3, -4258.166f, 26.25237f, 4361.932f, 0.0f, -33.0556f, 0.0f, 1.728941f, 2.075261f, 1.728941f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_15", 3, -4405.673f, 34.78413f, 4416.313f, 0.0f, 91.34052f, 0.0f, 2.140898f, 1.20323f, 2.140898f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_16", 3, -4311.877f, 31.70709f, 4381.509f, 0.0f, 118.8577f, 0.0f, 1.501884f, 0.5731589f, 1.501884f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_17", 3, -4335.903f, 22.34797f, 4459.782f, 0.0f, 191.0454f, 0.0f, 0.7263988f, 0.8719015f, 0.7263988f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_18", 3, -4284.072f, 18.50686f, 4456.616f, 0.0f, 205.6215f, 0.0f, 0.7271153f, 0.7384764f, 0.7271153f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_19", 3, -4280.566f, 18.22794f, 4465.846f, 0.0f, 135.1432f, 0.0f, 0.8526884f, 1.023488f, 0.8526884f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_20", 3, -4263.382f, 19.12264f, 4455.153f, 0.0f, -54.78981f, 0.0f, 1.410503f, 1.693037f, 1.410503f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	bVar23 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_21", 3, -4351.787f, 18.99342f, 4494.982f, 0.0f, 139.8281f, 0.0f, 3.684973f, 3.018145f, 3.684973f);
	ADD_TO_VOLUME_SET(bVar1, bVar23);
	bVar24 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_22", 3, -4243.849f, 22.27629f, 4349.88f, 0.0f, -3.45362f, 0.0f, 1.728941f, 2.075261f, 1.728941f);
	ADD_TO_VOLUME_SET(bVar1, bVar24);
	bVar25 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_23", 3, -4305.67f, 31.11509f, 4360.742f, 0.0f, 39.3694f, 0.0f, 2.106963f, 2.529002f, 2.106963f);
	ADD_TO_VOLUME_SET(bVar1, bVar25);
	bVar26 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_24", 3, -4276.169f, 30.1767f, 4351.824f, 0.0f, -29.01862f, 0.0f, 2.106963f, 2.529002f, 2.106963f);
	ADD_TO_VOLUME_SET(bVar1, bVar26);
	bVar27 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_25", 3, -4270.711f, 27.43315f, 4368.194f, 2.971155f, -45.59039f, 0.7849898f, 1.490163f, 1.788653f, 1.490163f);
	ADD_TO_VOLUME_SET(bVar1, bVar27);
	bVar28 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_26", 3, -4406.357f, 18.99342f, 4477.839f, 0.0f, 89.35223f, 0.0f, 4.713051f, 3.018145f, 4.713051f);
	ADD_TO_VOLUME_SET(bVar1, bVar28);
	bVar29 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_27", 3, -4265.999f, 18.99342f, 4505.105f, 0.0f, 200.6565f, 0.0f, 4.713051f, 3.018145f, 4.713051f);
	ADD_TO_VOLUME_SET(bVar1, bVar29);
	bVar30 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_28", 3, -4283.144f, 18.99342f, 4517.908f, 0.0f, 184.24f, 0.0f, 4.713051f, 3.018145f, 4.713051f);
	ADD_TO_VOLUME_SET(bVar1, bVar30);
	bVar31 = CREATE_VOLUME_IN_LAYOUT(bLocal_176, "SpawnVol_29", 3, -4367.55f, 18.99342f, 4475.954f, 0.0f, 117.5588f, 0.0f, 4.713051f, 3.018145f, 4.713051f);
	ADD_TO_VOLUME_SET(bVar1, bVar31);
	return 1;
}
...
int Function_147(int iParam0) //Position: 0x68FE / 26878
{
	...
	uVar0 = uVar0;
	bLocal_175 = iParam0;
	CREATE_VOLUME_IN_LAYOUT(bLocal_175, "Defense_Volume", 3, 764.5848f, 80.782f, 1314.62f, 0.0f, 14.90262f, 0.0f, 19.56264f, 9.706238f, 19.56264f);
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_175, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_0", 3, 813.1932f, 78.471f, 1270.206f, 0.0f, -42.77343f, 0.0f, 0.8397177f, 0.8736401f, 0.8397177f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_1", 3, 672.7479f, 77.84531f, 1318.569f, 0.0f, 127.6531f, 0.0f, 0.8397177f, 0.8736401f, 0.8397177f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_2", 3, 705.7951f, 78.30585f, 1267.145f, 0.0f, 127.6531f, 0.0f, 0.8397177f, 0.8736401f, 0.8397177f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_3", 3, 710.1257f, 78.30585f, 1309.012f, 0.0f, 200.7917f, 0.0f, 0.8397177f, 0.8736401f, 0.8397177f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_4", 3, 680.5995f, 78.30585f, 1365.438f, 0.0f, 162.4858f, 0.0f, 1.119613f, 1.164842f, 1.119613f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_5", 3, 780.6464f, 78.30585f, 1228.0f, 0.0f, 357.1966f, 0.0f, 1.119613f, 1.164842f, 1.119613f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_6", 3, 755.1655f, 78.30585f, 1363.146f, 0.0f, 483.2696f, 0.0f, 0.8312305f, 0.8648101f, 0.8312305f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_7", 3, 697.2882f, 78.30585f, 1228.852f, 0.0f, 366.5947f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_8", 3, 701.3563f, 78.30585f, 1359.133f, 0.0f, 521.6205f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_9", 3, 762.4905f, 78.38076f, 1224.0f, 0.0f, 643.3622f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_10", 3, 810.7064f, 78.471f, 1303.057f, 0.0f, 626.6191f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_11", 3, 657.325f, 78.16015f, 1274.664f, 0.0f, 451.4027f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_12", 3, 750.1956f, 78.30585f, 1365.805f, 0.0f, 453.1971f, 0.0f, 1.097924f, 1.142277f, 1.097924f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_13", 3, 736.9054f, 78.87982f, 1223.318f, 0.0f, 366.189f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_14", 3, 780.5359f, 78.30585f, 1362.74f, 0.0f, 174.9852f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_15", 3, 674.2471f, 78.30585f, 1228.0f, 0.0f, -5.333569f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_16", 3, 812.2103f, 79.56858f, 1233.079f, 0.0f, -94.42254f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_17", 3, 675.7842f, 78.30585f, 1344.0f, 0.0f, 88.75424f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_18", 3, 812.2593f, 78.30585f, 1356.679f, 0.0f, 215.5624f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_19", 3, 806.312f, 78.30585f, 1360.931f, 0.0f, 215.5624f, 0.0f, 1.23048f, 1.280189f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(bLocal_175, "SpawnVol_20", 3, 805.6031f, 78.30585f, 1382.199f, 0.0f, 215.5624f, 0.0f, 1.23048f, 3.910332f, 1.23048f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	return 1;
}
...
int Function_148(int iParam0) //Position: 0x6ECA / 28362
{
	...
	uVar0 = uVar0;
	bLocal_174 = iParam0;
	CREATE_VOLUME_IN_LAYOUT(bLocal_174, "Defense_Volume", 3, 134.0985f, 81.05609f, 2337.494f, 0.0f, 20.0f, 0.0f, 23.24967f, 13.33089f, 23.24967f);
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_174, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_0", 3, 124.7039f, 73.28625f, 2392.0f, 0.0f, 140.6321f, 0.0f, 1.784259f, 5.228127f, 1.784259f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_1", 3, 150.4786f, 73.28625f, 2381.521f, 0.0f, -120.8779f, 0.0f, 1.887448f, 5.530484f, 1.887448f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_2", 3, 84.22247f, 73.28625f, 2291.777f, 0.0f, 100.4313f, 0.0f, 1.684196f, 3.050434f, 1.684196f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_3", 3, 137.8256f, 73.84786f, 2310.655f, 0.0f, 275.7021f, 0.0f, 0.8092422f, 1.267242f, 0.8092422f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_4", 3, 132.6836f, 73.28625f, 2383.165f, 0.0f, 208.9608f, 0.0f, 1.784259f, 5.228127f, 1.784259f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_5", 3, 93.76576f, 73.65821f, 2270.044f, 0.0f, -7.073559f, 0.0f, 1.226203f, 1.68419f, 1.226203f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_6", 3, 80.50367f, 74.24982f, 2304.045f, 0.0f, 88.78371f, 0.0f, 1.238919f, 1.591931f, 1.238919f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_7", 3, 73.77852f, 73.4857f, 2290.221f, 0.0f, 67.02595f, 0.0f, 1.684196f, 3.050434f, 1.684196f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_8", 3, 98.2511f, 74.52679f, 2344.97f, 0.0f, 28.12626f, 0.0f, 0.6678761f, 0.3214595f, 0.6678761f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_9", 3, 58.61261f, 71.9895f, 2356.374f, 0.0f, 108.4973f, 0.0f, 4.048919f, 6.348159f, 4.048919f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_10", 3, 130.1538f, 74.16968f, 2289.688f, 0.0f, 323.1199f, 0.0f, 0.8092422f, 1.267242f, 0.8092422f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_11", 3, 80.50367f, 74.24982f, 2310.526f, 0.0f, 32.51496f, 0.0f, 1.238919f, 1.591931f, 1.238919f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(bLocal_174, "SpawnVol_12", 3, 63.54552f, 71.9895f, 2371.119f, 0.0f, 108.4973f, 0.0f, 3.022411f, 6.348159f, 3.022411f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	return 1;
}
...
int Function_149(int iParam0) //Position: 0x7286 / 29318
{
	...
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(Local_172, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_0", 3, -817.7644f, 92.36078f, 2356.241f, 0.0f, 257.614f, 0.0f, 0.6626928f, 0.7619622f, 0.6626928f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_1", 3, -797.9971f, 92.60523f, 2370.066f, 0.0f, 50.56062f, 0.0f, 0.6626928f, 0.7619622f, 0.6626928f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_2", 3, -942.0309f, 90.35291f, 2474.402f, 0.0f, 188.858f, 0.0f, 0.6626928f, 0.7619622f, 0.6626928f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_3", 3, -956.8411f, 90.71284f, 2431.56f, 0.0f, 21.9239f, 0.0f, 0.6626928f, 0.7619622f, 0.6626928f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_4", 3, -863.5199f, 91.35687f, 2364.794f, 0.0f, -58.96709f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_5", 3, -877.2281f, 91.35687f, 2393.228f, 0.0f, -144.8857f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_6", 3, -881.7861f, 91.35687f, 2396.0f, 0.0f, -143.6582f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_7", 3, -900.0001f, 90.35291f, 2437.428f, 0.0f, 17.82667f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_8", 3, -898.0054f, 91.35687f, 2405.104f, 0.0f, 210.8967f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_9", 3, -902.5246f, 91.35687f, 2408.0f, 0.0f, -148.5523f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_10", 3, -858.9274f, 90.35294f, 2466.075f, 0.0f, -159.9448f, 0.0f, 0.8132938f, 0.9351226f, 7.009917f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_11", 3, -839.5899f, 92.54645f, 2370.257f, 0.0f, 3.767457f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_12", 3, -911.3191f, 90.35291f, 2442.739f, 0.0f, 15.93598f, 0.0f, 0.6577268f, 0.7562522f, 0.6577268f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_13", 3, -866.2332f, 91.35687f, 2360.0f, 0.0f, -62.59444f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_14", 3, -803.8776f, 92.56953f, 2376.849f, 0.0f, -105.2951f, 0.0f, 1.801808f, 0.9351226f, 1.801808f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_15", 3, -871.1148f, 91.35687f, 2352.721f, 0.0f, -74.46162f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_16", 3, -906.3019f, 90.35291f, 2440.0f, 0.0f, 21.22196f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_17", 3, -888.0756f, 91.07147f, 2433.381f, 0.0f, 108.0659f, 0.0f, 0.5904461f, 0.678893f, 0.5904461f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_18", 3, -954.3661f, 90.35291f, 2420.0f, 0.0f, 129.1342f, 0.0f, 1.156655f, 1.329918f, 1.156655f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_19", 3, -864.14f, 90.35291f, 2451.645f, 0.0f, 22.32719f, 0.0f, 0.7483366f, 0.860435f, 2.703511f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_20", 3, -846.5788f, 90.35291f, 2470.348f, 0.0f, 145.6762f, 0.0f, 1.305717f, 0.9351226f, 1.305717f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	bVar23 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_21", 3, -903.887f, 90.35291f, 2440.319f, 0.0f, 14.41094f, 0.0f, 0.7432537f, 0.8545907f, 0.7432537f);
	ADD_TO_VOLUME_SET(bVar1, bVar23);
	bVar24 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_22", 3, -843.2527f, 90.35291f, 2452.484f, 0.0f, -233.0104f, 0.0f, 1.578806f, 0.9351226f, 1.578806f);
	ADD_TO_VOLUME_SET(bVar1, bVar24);
	bVar25 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_23", 3, -852.3418f, 90.35294f, 2454.473f, 0.0f, 101.1046f, 0.0f, 1.396349f, 0.8413346f, 1.469087f);
	ADD_TO_VOLUME_SET(bVar1, bVar25);
	bVar26 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_24", 3, -830.5043f, 92.54638f, 2358.676f, 0.0f, 13.15314f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar26);
	bVar27 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_25", 3, -864.6239f, 91.63651f, 2381.855f, 0.0f, 91.59521f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar27);
	bVar28 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_26", 3, -823.1486f, 92.36078f, 2389.426f, 0.0f, -12.68404f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar28);
	bVar29 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_27", 3, -867.1241f, 90.35291f, 2444.078f, 0.0f, -159.008f, 0.0f, 0.8132938f, 0.9351226f, 3.754489f);
	ADD_TO_VOLUME_SET(bVar1, bVar29);
	bVar30 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_28", 3, -913.8144f, 90.35291f, 2442.85f, 0.0f, 34.00362f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar30);
	bVar31 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_29", 3, -889.8019f, 91.35687f, 2400.663f, 0.0f, -147.6535f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar31);
	bVar32 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_30", 3, -838.7493f, 90.35291f, 2465.923f, 0.0f, -70.00797f, 0.0f, 0.6870878f, 0.7900114f, 0.6870878f);
	ADD_TO_VOLUME_SET(bVar1, bVar32);
	bVar33 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_31", 3, -771.4444f, 93.36469f, 2398.056f, 0.0f, -38.06047f, 0.0f, 1.958284f, 0.9351226f, 1.958284f);
	ADD_TO_VOLUME_SET(bVar1, bVar33);
	bVar34 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_32", 3, -875.3961f, 91.36105f, 2344.317f, 0.0f, -55.93968f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar34);
	bVar35 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_33", 3, -878.7861f, 91.07147f, 2430.055f, 0.0f, -246.014f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar35);
	bVar36 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_34", 3, -964.7426f, 90.35291f, 2393.901f, 0.0f, 84.48253f, 0.0f, 0.6626928f, 0.7619622f, 0.6626928f);
	ADD_TO_VOLUME_SET(bVar1, bVar36);
	bVar37 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_35", 3, -830.1868f, 92.36078f, 2387.998f, 0.0f, 9.239779f, 0.0f, 0.8132938f, 0.9351226f, 0.8132938f);
	ADD_TO_VOLUME_SET(bVar1, bVar37);
	bVar38 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_36", 3, -745.0301f, 92.361f, 2440.354f, 0.0f, -101.2035f, 0.0f, 2.182904f, 2.689942f, 2.182904f);
	ADD_TO_VOLUME_SET(bVar1, bVar38);
	bVar39 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_37", 3, -815.9114f, 93.42899f, 2327.169f, 0.0f, -372.8771f, 0.0f, 3.347799f, 5.147401f, 3.347799f);
	ADD_TO_VOLUME_SET(bVar1, bVar39);
	bVar40 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_38", 3, -878.152f, 90.75146f, 2492.801f, 0.0f, -223.7806f, 0.0f, 4.754608f, 2.689942f, 4.754608f);
	ADD_TO_VOLUME_SET(bVar1, bVar40);
	bVar41 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_39", 3, -853.1545f, 90.75146f, 2509.17f, 0.0f, -223.7806f, 0.0f, 4.192278f, 2.689942f, 4.192278f);
	ADD_TO_VOLUME_SET(bVar1, bVar41);
	bVar42 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_40", 3, -858.5275f, 90.75146f, 2491.592f, 0.0f, -223.7806f, 0.0f, 4.192278f, 2.689942f, 4.192278f);
	ADD_TO_VOLUME_SET(bVar1, bVar42);
	bVar43 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_41", 3, -871.7704f, 90.75146f, 2509.12f, 0.0f, -223.7806f, 0.0f, 4.192278f, 2.689942f, 4.192278f);
	ADD_TO_VOLUME_SET(bVar1, bVar43);
	bVar44 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_42", 3, -827.3336f, 90.21899f, 2501.808f, 0.0f, -182.4503f, 0.0f, 6.387031f, 2.689942f, 6.472105f);
	ADD_TO_VOLUME_SET(bVar1, bVar44);
	bVar45 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_43", 3, -821.9771f, 99.18549f, 2544.449f, 0.0f, -168.3465f, 0.0f, 6.387031f, 2.689942f, 6.472105f);
	ADD_TO_VOLUME_SET(bVar1, bVar45);
	bVar46 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_44", 3, -803.6876f, 94.55854f, 2518.386f, 0.0f, -168.3465f, 0.0f, 6.387031f, 2.689942f, 6.472105f);
	ADD_TO_VOLUME_SET(bVar1, bVar46);
	bVar47 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_45", 3, -779.0264f, 92.04891f, 2475.499f, 0.0f, -135.295f, 0.0f, 4.88823f, 2.689942f, 4.88823f);
	ADD_TO_VOLUME_SET(bVar1, bVar47);
	bVar48 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_46", 3, -778.9647f, 92.04891f, 2485.408f, 0.0f, -135.295f, 0.0f, 4.88823f, 2.689942f, 4.88823f);
	ADD_TO_VOLUME_SET(bVar1, bVar48);
	bVar49 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_47", 3, -769.1495f, 92.04891f, 2485.314f, 0.0f, -135.295f, 0.0f, 4.88823f, 2.689942f, 4.88823f);
	ADD_TO_VOLUME_SET(bVar1, bVar49);
	bVar50 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_48", 3, -768.9102f, 92.04891f, 2475.515f, 0.0f, -135.295f, 0.0f, 4.88823f, 2.689942f, 4.88823f);
	ADD_TO_VOLUME_SET(bVar1, bVar50);
	bVar51 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_49", 3, -772.1108f, 93.47188f, 2348.005f, 0.0f, -386.7786f, 0.0f, 3.864763f, 5.147401f, 3.864763f);
	ADD_TO_VOLUME_SET(bVar1, bVar51);
	bVar52 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_50", 3, -770.111f, 93.47188f, 2339.405f, 0.0f, -386.7786f, 0.0f, 3.864763f, 5.147401f, 3.864763f);
	ADD_TO_VOLUME_SET(bVar1, bVar52);
	bVar53 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_51", 3, -787.0292f, 93.47188f, 2332.507f, 0.0f, -386.7786f, 0.0f, 3.864763f, 5.147401f, 3.864763f);
	ADD_TO_VOLUME_SET(bVar1, bVar53);
	bVar54 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_52", 3, -789.4606f, 93.47188f, 2345.892f, 0.0f, -386.7786f, 0.0f, 3.864763f, 5.147401f, 3.864763f);
	ADD_TO_VOLUME_SET(bVar1, bVar54);
	bVar55 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_53", 3, -818.6615f, 93.42899f, 2333.719f, 0.0f, -372.8771f, 0.0f, 3.23241f, 5.147401f, 3.23241f);
	ADD_TO_VOLUME_SET(bVar1, bVar55);
	bVar56 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_54", 3, -746.2285f, 92.361f, 2444.275f, 0.0f, -101.2035f, 0.0f, 1.661863f, 2.689942f, 1.661863f);
	ADD_TO_VOLUME_SET(bVar1, bVar56);
	bVar57 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_55", 3, -774.6917f, 93.36469f, 2383.227f, 0.0f, 281.5919f, 0.0f, 2.164809f, 1.004039f, 2.164809f);
	ADD_TO_VOLUME_SET(bVar1, bVar57);
	bVar58 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_56", 3, -773.7627f, 93.36469f, 2378.932f, 0.0f, 281.5919f, 0.0f, 2.164809f, 1.004039f, 2.164809f);
	ADD_TO_VOLUME_SET(bVar1, bVar58);
	bVar59 = CREATE_VOLUME_IN_LAYOUT(Local_172, "SpawnVol_57", 3, -741.0922f, 92.361f, 2443.828f, 0.0f, -101.2035f, 0.0f, 2.182904f, 2.689942f, 2.182904f);
	ADD_TO_VOLUME_SET(bVar1, bVar59);
	return 1;
}
...
int Function_150(int iParam0) //Position: 0x81E1 / 33249
{
	...
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(Local_170, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_0", 3, -2760.512f, 32.12549f, 4256f, 0.0f, 9.233223f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_1", 3, -2748.588f, 32.12549f, 4251.412f, 0.0f, 46.20432f, 0.0f, 0.9022594f, 0.9034847f, 0.9022594f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_2", 3, -2737.67f, 33.12256f, 4244.289f, 0.0f, 49.67945f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_3", 3, -2738.575f, 37.05106f, 4239.249f, 0.0f, 49.19656f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_4", 3, -2734.75f, 36.39109f, 4227.83f, 0.0f, 34.35859f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_5", 3, -2729.205f, 32.12549f, 4224.676f, 0.0f, -61.05159f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_6", 3, -2721.499f, 32.27308f, 4240.707f, 0.0f, -57.00735f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_7", 3, -2724.598f, 32.01712f, 4212.325f, 0.0f, 98.80845f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_8", 3, -2699.351f, 32.04588f, 4209.363f, 0.0f, -86.14007f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_9", 3, -2700.719f, 32.278f, 4217.393f, 0.0f, -13.28103f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_10", 3, -2693.202f, 32.42036f, 4220.326f, 0.0f, -10.46397f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_11", 3, -2685.337f, 37.30204f, 4222.66f, 0.0f, -12.02485f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_12", 3, -2682.895f, 32.46119f, 4223.428f, 0.0f, -0.2914835f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_13", 3, -2671.783f, 32.0428f, 4222.503f, 0.0f, -10.38336f, 0.0f, 0.6935719f, 0.6945138f, 0.6935719f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_14", 3, -2648.276f, 31.74105f, 4224.108f, 0.0f, 23.81742f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_15", 3, -2641.641f, 30.95173f, 4246.359f, 0.0f, 187.2254f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_16", 3, -2641.966f, 30.50269f, 4269.966f, 0.0f, 149.6369f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_17", 3, -2657.712f, 31.26224f, 4278.634f, 0.0f, -43.77999f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_18", 3, -2669.73f, 31.25181f, 4282.102f, 0.0f, -176.702f, 0.0f, 0.7241939f, 0.7251773f, 0.7241939f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_19", 3, -2650.365f, 37.47691f, 4275.292f, 0.0f, -135.0193f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_20", 3, -2682.648f, 31.51851f, 4293.608f, 0.0f, 93.46996f, 0.0f, 0.9461301f, 0.9474149f, 0.9461301f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	bVar23 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_21", 3, -2706.759f, 31.1852f, 4291.589f, 0.9350824f, -182.6491f, -1.598515f, 0.8757765f, 0.8769658f, 0.8757765f);
	ADD_TO_VOLUME_SET(bVar1, bVar23);
	bVar24 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_22", 3, -2682.453f, 31.92464f, 4286.938f, 0.0f, 88.61055f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar24);
	bVar25 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_23", 3, -2698.622f, 32.07688f, 4287.92f, 0.0f, 179.3026f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar25);
	bVar26 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_24", 3, -2719.374f, 32.82863f, 4296f, 0.0f, 90.42851f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar26);
	bVar27 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_25", 3, -2733.317f, 33.04647f, 4291.812f, 0.0f, 133.1982f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar27);
	bVar28 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_26", 3, -2753.526f, 32.66684f, 4281.099f, 0.0f, -161.4441f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar28);
	bVar29 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_27", 3, -2630.424f, 30.27378f, 4269.654f, 0.0f, 196.3942f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar29);
	bVar30 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_28", 3, -2616.55f, 30.62609f, 4256.363f, 0.0f, 248.8268f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar30);
	bVar31 = CREATE_VOLUME_IN_LAYOUT(Local_170, "SpawnVol_29", 3, -2616.329f, 29.26509f, 4243.254f, 0.0f, 264.1773f, 0.0f, 1.045797f, 1.047217f, 1.045797f);
	ADD_TO_VOLUME_SET(bVar1, bVar31);
	return 1;
}
...
int Function_151(int iParam0) //Position: 0x8A0A / 35338
{
	...
	uVar0 = uVar0;
	bLocal_169 = iParam0;
	CREATE_VOLUME_IN_LAYOUT(bLocal_169, "Defense_Volume", 3, -2166.842f, 20.91559f, 2599.401f, 0.0f, 20.0f, 0.0f, 23.66759f, 15.74754f, 23.66759f);
	bVar1 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_169, "SpawnVolGroup_set");
	bVar2 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_0", 3, -2162.351f, 16.34795f, 2521.649f, 0.0f, 0.05228467f, 0.0f, 1.541307f, 1.975699f, 1.541307f);
	ADD_TO_VOLUME_SET(bVar1, bVar2);
	bVar3 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_1", 3, -2144.51f, 16.41612f, 2535.491f, 0.0f, 297.4826f, 0.0f, 1.530316f, 1.96161f, 1.530316f);
	ADD_TO_VOLUME_SET(bVar1, bVar3);
	bVar4 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_2", 3, -2127.331f, 16.28618f, 2545.701f, 0.0f, 10.13893f, 0.0f, 1.377995f, 1.766359f, 1.377995f);
	ADD_TO_VOLUME_SET(bVar1, bVar4);
	bVar5 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_3", 3, -2106.168f, 16.06273f, 2554.168f, 0.0f, -41.25896f, 0.0f, 1.725682f, 2.212037f, 1.725682f);
	ADD_TO_VOLUME_SET(bVar1, bVar5);
	bVar6 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_4", 3, -2084.015f, 15.81276f, 2584.698f, 0.0f, -68.6739f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar6);
	bVar7 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_5", 3, -2076.0f, 16.44941f, 2604.0f, 0.0f, -61.70661f, 0.0f, 0.8652607f, 1.750756f, 1.365822f);
	ADD_TO_VOLUME_SET(bVar1, bVar7);
	bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_6", 3, -2075.648f, 16.20653f, 2625.021f, 0.0f, -88.64908f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar8);
	bVar9 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_7", 3, -2058.058f, 18.93071f, 2646.03f, 0.0f, -135.7061f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar9);
	bVar10 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_8", 3, -2104.0f, 16.00696f, 2653.806f, 0.0f, -179.9427f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar10);
	bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_9", 3, -2148f, 16.44941f, 2654.184f, 0.0f, 180.8005f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar11);
	bVar12 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_10", 3, -2190.656f, 16.40293f, 2640.169f, 0.0f, 145.4984f, 0.0f, 1.260149f, 1.615301f, 1.260149f);
	ADD_TO_VOLUME_SET(bVar1, bVar12);
	bVar13 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_11", 3, -2215.472f, 16.35969f, 2603.036f, 0.0f, 89.57423f, 0.0f, 1.62741f, 2.086068f, 1.62741f);
	ADD_TO_VOLUME_SET(bVar1, bVar13);
	bVar14 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_12", 3, -2211.47f, 16.38527f, 2572.32f, 0.0f, 108.963f, 0.0f, 1.647036f, 2.111226f, 1.647036f);
	ADD_TO_VOLUME_SET(bVar1, bVar14);
	bVar15 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_13", 3, -2206.753f, 16.16532f, 2557.132f, 0.0f, 99.86391f, 0.0f, 1.469378f, 1.883498f, 1.469378f);
	ADD_TO_VOLUME_SET(bVar1, bVar15);
	bVar16 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_14", 3, -2200f, 16.33816f, 2544f, 0.0f, 54.41577f, 0.0f, 1.631281f, 2.09103f, 1.631281f);
	ADD_TO_VOLUME_SET(bVar1, bVar16);
	bVar17 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_15", 3, -2193.606f, 16.26402f, 2558.866f, 0.0f, 4.191174f, 0.0f, 1.43347f, 1.837469f, 1.43347f);
	ADD_TO_VOLUME_SET(bVar1, bVar17);
	bVar18 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_16", 3, -2173.271f, 16.53027f, 2543.441f, 0.0f, 91.57569f, 0.0f, 1.392081f, 1.784416f, 1.392081f);
	ADD_TO_VOLUME_SET(bVar1, bVar18);
	bVar19 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_17", 3, -2144.488f, 17.16976f, 2540.982f, 0.0f, 266.9426f, 0.0f, 0.5674518f, 0.7273786f, 0.5674518f);
	ADD_TO_VOLUME_SET(bVar1, bVar19);
	bVar20 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_18", 3, -2132.972f, 17.10097f, 2545.113f, 0.0f, 0.05228467f, 0.0f, 0.6450346f, 0.8268269f, 0.6450346f);
	ADD_TO_VOLUME_SET(bVar1, bVar20);
	bVar21 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_19", 3, -2154.693f, 16.63584f, 2559.684f, 0.0f, 9.831319f, 0.0f, 0.7560618f, 0.9691452f, 0.7560618f);
	ADD_TO_VOLUME_SET(bVar1, bVar21);
	bVar22 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_20", 3, -2146.118f, 16.63344f, 2557.882f, 0.0f, 32.38064f, 0.0f, 0.7341444f, 0.9410508f, 0.7341444f);
	ADD_TO_VOLUME_SET(bVar1, bVar22);
	bVar23 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_21", 3, -2168.56f, 16.56466f, 2567.37f, 0.0f, 0.05228467f, 0.0f, 0.6201649f, 0.794948f, 0.6201649f);
	ADD_TO_VOLUME_SET(bVar1, bVar23);
	bVar24 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_22", 3, -2168.176f, 19.57925f, 2571.821f, 0.0f, 80.57937f, 0.0f, 0.6679758f, 0.8562336f, 0.6679758f);
	ADD_TO_VOLUME_SET(bVar1, bVar24);
	bVar25 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_23", 3, -2195.589f, 16.96554f, 2599.106f, 0.0f, 0.05228467f, 0.0f, 0.832998f, 1.067765f, 0.832998f);
	ADD_TO_VOLUME_SET(bVar1, bVar25);
	bVar26 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_24", 3, -2191.433f, 16.95088f, 2610.71f, 0.0f, -191.0736f, 0.0f, 0.6917561f, 0.886716f, 0.6917561f);
	ADD_TO_VOLUME_SET(bVar1, bVar26);
	bVar27 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_25", 3, -2163.903f, 16.909f, 2631.824f, 0.0f, -177.5938f, 0.0f, 0.7694689f, 0.9863309f, 0.7694689f);
	ADD_TO_VOLUME_SET(bVar1, bVar27);
	bVar28 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_26", 3, -2148.094f, 16.77384f, 2625.596f, 0.0f, 135.4297f, 0.0f, 0.8150952f, 1.044816f, 0.8150952f);
	ADD_TO_VOLUME_SET(bVar1, bVar28);
	bVar29 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_27", 3, -2142.998f, 19.90847f, 2626.977f, 0.0f, 168.0672f, 0.0f, 0.5276877f, 0.6343777f, 0.5276877f);
	ADD_TO_VOLUME_SET(bVar1, bVar29);
	bVar30 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_28", 3, -2132.26f, 16.612f, 2625.073f, 0.0f, 144.4726f, 0.0f, 1.152722f, 0.6717942f, 1.152722f);
	ADD_TO_VOLUME_SET(bVar1, bVar30);
	bVar31 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_30", 3, -2086.002f, 16.96188f, 2603.537f, 0.0f, -65.40534f, 0.0f, 0.8166552f, 1.046816f, 0.8166552f);
	ADD_TO_VOLUME_SET(bVar1, bVar31);
	bVar32 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_31", 3, -2113.162f, 16.64206f, 2584.0f, 0.0f, -89.32012f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar32);
	bVar33 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_32", 3, -2111.177f, 22.16126f, 2598.696f, 0.0f, -71.9375f, 0.0f, 1.42253f, 1.230905f, 1.42253f);
	ADD_TO_VOLUME_SET(bVar1, bVar33);
	bVar34 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_33", 3, -2143.166f, 16.86635f, 2594.939f, 0.0f, 176.6415f, 0.0f, 0.5206611f, 0.7999916f, 0.6240996f);
	ADD_TO_VOLUME_SET(bVar1, bVar34);
	bVar35 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_34", 3, -2173.487f, 16.56466f, 2567.375f, 0.0f, 0.05228467f, 0.0f, 0.6201649f, 0.794948f, 0.6201649f);
	ADD_TO_VOLUME_SET(bVar1, bVar35);
	bVar36 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_35", 3, -2194.833f, 16.95088f, 2611.279f, 0.0f, -227.0958f, 0.0f, 0.6917561f, 0.886716f, 0.6917561f);
	ADD_TO_VOLUME_SET(bVar1, bVar36);
	bVar37 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_36", 3, -2164.537f, 16.909f, 2639.31f, 0.0f, -248.3953f, 0.0f, 0.7694689f, 0.9863309f, 0.7694689f);
	ADD_TO_VOLUME_SET(bVar1, bVar37);
	bVar38 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_37", 3, -2129.216f, 16.612f, 2625.431f, 0.0f, 173.8015f, 0.0f, 1.152722f, 0.6717942f, 1.152722f);
	ADD_TO_VOLUME_SET(bVar1, bVar38);
	bVar39 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_38", 3, -2137.042f, 16.86635f, 2597.063f, 0.0f, 361.4528f, 0.0f, 0.6240996f, 0.7999916f, 0.6240996f);
	ADD_TO_VOLUME_SET(bVar1, bVar39);
	bVar40 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_39", 3, -2125.0f, 16.64206f, 2590.118f, 0.0f, -99.75868f, 0.0f, 2.004817f, 2.569842f, 2.004817f);
	ADD_TO_VOLUME_SET(bVar1, bVar40);
	bVar41 = CREATE_VOLUME_IN_LAYOUT(bLocal_169, "SpawnVol_40", 3, -2215.53f, 16.35969f, 2610.852f, 0.0f, 89.57423f, 0.0f, 1.62741f, 2.086068f, 1.62741f);
	ADD_TO_VOLUME_SET(bVar1, bVar41);
	return 1;
}
...
vector3 Function_164(vector3 vParam0) //Position: 0x977F / 38783
{
	...
	if (Function_35(iVar6))
	{
		...
		bVar7 = Function_101(iVar9, bVar7);
	}
...
var Function_189(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0xB0C2 / 45250
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(*bParam0))
	{
		...
		while (iVar1 <= 17)
		{
			...
			{
				bVar3 = iVar1;
				_ADD_AMMO_OF_TYPE(*bParam0, bVar3, TO_FLOAT(Function_197(&Global_83591 + 276, bVar3)), 1, 0);
				iVar0 = 1;
			}
			iVar1++;
		}
			...
			case 0x00000002:
				...
				while (bVar2 <= 40)
				{
					if (Global_84559[bVar2])
					{
						...
						if (Function_198(bVar3, 1))
						{
							bVar24 = (Function_197(&Global_83591 + 276, bVar3) - CEIL(_GET_AMMO_AMOUNT(*bParam0, bVar3, 1)));
							if (bVar24 >= 0)
							{
								_ADD_AMMO_OF_TYPE(*bParam0, bVar3, TO_FLOAT(bVar24), 1, 0);
							}
...
var Function_191(var uParam0, int iParam1, bool bParam2) //Position: 0xB3C8 / 46024
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_192((iParam1 - 1)), true) - 1);
	return SHIFT_RIGHT((iVar0 && uParam0), bParam2);
}

bool Function_192(bool bParam0) //Position: 0xB3E7 / 46055
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_193() //Position: 0xB3F3 / 46067
{
	return Function_194(39);
}

int Function_194(bool bParam0) //Position: 0xB3FE / 46078
{
	int iVar0;
...
bool Function_195(bool bParam0) //Position: 0xB42C / 46124
{
...
bool Function_196(bool bParam0) //Position: 0xB44E / 46158
{
...
int Function_197(int iParam0, bool bParam1) //Position: 0xB460 / 46176
{
	if (Function_198(bParam1, 1))
	{
...
bool Function_198(bool bParam0, int iParam1) //Position: 0xB47A / 46202
{
...
void Function_201(int iParam0, int iParam1) //Position: 0xB5B4 / 46516
{
	...
	if (IS_ACTOR_VALID(bVar2))
	{
		...
		if (bVar3)
		{
			bVar4 = Function_181(bVar2, 40);
			if (bVar4 == 4294967295)
			{
				bVar4 = Function_181(bVar2, 39);
			}
...
void Function_211(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBD66 / 48486
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
	...
	if (!Global_49306)
	{
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_218(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_216(iParam0, bVar19, bVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_213(bVar19, bParam2, &iVar17, &iVar18);
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_212(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_135(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
int Function_215(int iParam0, bool bParam1) //Position: 0xC41D / 50205
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_221(int iParam0, bool bParam1, bool bParam2) //Position: 0xC77E / 51070
{
	int iVar0;
	int iVar1;
...
var Function_242(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0xD2EF / 53999
{
	bool bVar0;
	
	if (bParam5)
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, Function_135(), 6, 1);
	}
	else
	{
...
void Function_244(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD48C / 54412
{
...
void Function_245(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD5A1 / 54689
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.02f);
...
void Function_246(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD6BA / 54970
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
...
void Function_247(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD7C4 / 55236
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_248(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD8CA / 55498
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_249(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xD97A / 55674
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
var Function_250(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0xDA31 / 55857
{
	bool bVar0;
	...
	if (!Function_351(iParam0->f_48, 2048))
	{
		...
		else if (IS_ACTOR_PLAYER(iParam0->f_112))
		{
			if (IS_SLOT_VALID(StackVal))
			{
				...
				if (Function_196(bVar2) && RAND_INT_RANGE(0, 1000) > 500)
				{
					bVar1 = true;
				}
				else
...
void Function_258(bool bParam0, bool bParam1) //Position: 0xE08F / 57487
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	
	bVar0 = CREATE_NAMED_OBJECT_ITERATOR(Function_548(), "PickupGoldener");
...
{
	NET_LOG(1, "FREEMODE", "Enabling the Ambient World", false, false, false, false);
	Function_705(1);
...
int Function_289(bool bParam0) //Position: 0xE460 / 58464
{
	if (bParam0 > 0 || bParam0 <= 16)
	{
		return 0;
...
bool Function_293(bool bParam0, bool bParam1, int iParam2) //Position: 0xE7A4 / 59300
{
	var uVar0;
	
	return Function_294(bParam0, bParam1, &uVar0, iParam2);
}
...
int Function_298(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0xE848 / 59464
{
	...
	if (bLocal_168)
	{
		...
		bVar1 = (bVar1 + Function_215((CEIL(Function_102(1, bParam0)) / 1000), 9999));
	}
	else
	{
		bVar1 = FLOOR(Function_102(8, bParam0));
	}
	if (!bParam1)
	{
		Function_293(bParam0, bVar1, 0);
	}
	iVar6 = 0;
	if (Function_136(1) > 0)
	{
	...
	bVar24 = Function_102(8, bParam0);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(Function_300(&iVar6), FLOOR(bVar24));
	if (bLocal_168)
	{
		if (bVar4)
		{
...
var Function_323(bool bParam0, int iParam1, float fParam2) //Position: 0xF5FA / 62970
{
	bool bVar0;
...
bool Function_331(int iParam0) //Position: 0xFA06 / 64006
{
	switch (iParam0)
	{
		case 0x000003E8:
...
void Function_341(var uParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6) //Position: 0xFD14 / 64788
{
	if (iParam6 != 0)
	{
...
void Function_358(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, float fParam5, int iParam6, float fParam7, int iParam8, float fParam9, int iParam10, float fParam11, int iParam12, int iParam13) //Position: 0x10599 / 66969
{
	...
	{
		Function_344(iParam0, bVar0, CEIL(bVar1), 0);
...
bool Function_362(bool bParam0) //Position: 0x107F9 / 67577
{
	if (bParam0)
	{
...
bool Function_363(bool bParam0) //Position: 0x1083B / 67643
{
	if (bParam0)
	{
...
bool Function_364(bool bParam0) //Position: 0x1087B / 67707
{
	if (bParam0)
	{
...
var Function_366(int iParam0, int iParam1, int iParam2) //Position: 0x109C3 / 68035
{
	struct<6> Var0;
	struct<4> Var6;
...
bool Function_367() //Position: 0x10A01 / 68097
{
...
bool Function_370(bool bParam0) //Position: 0x10A40 / 68160
{
	if (bParam0)
	{
...
bool Function_375(bool bParam0) //Position: 0x10E01 / 69121
{
	if (bParam0)
	{
...
bool Function_376(bool bParam0) //Position: 0x10E37 / 69175
{
	if (bParam0)
	{
...
bool Function_377(bool bParam0) //Position: 0x10E74 / 69236
{
	if (bParam0)
	{
...
bool Function_378(bool bParam0) //Position: 0x10EA4 / 69284
{
	if (bParam0)
	{
		return "gotLives_64";
...
bool Function_379(bool bParam0) //Position: 0x10ED0 / 69328
{
	if (bParam0)
	{
		return "timeAttacking_64";
...
bool Function_380(bool bParam0) //Position: 0x10F06 / 69382
{
	if (bParam0)
	{
...
bool Function_381(bool bParam0) //Position: 0x10F46 / 69446
{
	if (bParam0)
	{
		return "matchWins_64";
...
bool Function_386(bool bParam0) //Position: 0x1129F / 70303
{
	if (bParam0)
	{
		return "MP_KillStreak_Icon";
...
bool Function_387(bool bParam0) //Position: 0x112DC / 70364
{
	if (bParam0)
	{
		return "dontShoot_64";
...
bool Function_388(bool bParam0) //Position: 0x1130A / 70410
{
	if (bParam0)
	{
		return "dontShoot_64";
...
bool Function_389(bool bParam0) //Position: 0x11338 / 70456
{
	if (bParam0)
	{
...
bool Function_390(bool bParam0) //Position: 0x11368 / 70504
{
	if (bParam0)
	{
...
bool Function_391(bool bParam0) //Position: 0x113A2 / 70562
{
	if (bParam0)
	{
...
bool Function_396() //Position: 0x11683 / 71299
{
	return "SC_LiarsDice_Icon";
}

bool Function_397() //Position: 0x1169D / 71325
{
...
void Function_399(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, int iParam10, bool bParam11) //Position: 0x116FB / 71419
{
	bool bVar0;
	bool bVar1;
...
bool Function_402() //Position: 0x11861 / 71777
{
	return "challenge_01lvl2";
}

bool Function_403() //Position: 0x1187A / 71802
{
	return "challenge_01";
}
...
void Function_404(var uParam0, int iParam1) //Position: 0x1188F / 71823
{
	...
	bVar0 = DECOR_GET_INT(Function_548(), "DLCFM_Weapon");
	DECOR_SET_INT(Function_548(), "DLCFM_Weapon", bVar0 + 1);
...
{
	return ((StackVal || SHIFT_LEFT(Param0, Function_193())) || SHIFT_LEFT(bParam2, Function_193() + 8));
}
...
bool Function_409() //Position: 0x11A54 / 72276
{
	return "MP_Revenge_Icon";
}

bool Function_410() //Position: 0x11A6C / 72300
{
...
void Function_414() //Position: 0x11DB9 / 73145
{
	...
	Local_40.f_24 = CREATE_JOURNAL_ENTRY(&uVar0, 3, false, "challenge_01");
	if (Function_423(5))
	{
...
int Function_426(bool bParam0, bool bParam1, bool bParam2) //Position: 0x12081 / 73857
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	iVar1 = Function_430(bParam0, bParam1, bParam2);
	iVar0 = 0;
	while (iVar0 <= 275)
	{
		...
		{
			return Function_427(bParam0, bParam1, bParam2, iVar0);
		}
		iVar0++;
	}
	return Function_427(bParam0, bParam1, bParam2, 4294967295);
}

int Function_427(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x120DF / 73951
{
	var uVar0;
	
	if (!Function_429(bParam2))
	{
		return 4294967295;
	}
	...
	uVar0 = Function_430(bParam0, bParam1, bParam2);
	if (bParam3 != 4294967295 || bParam3 <= 275)
	{
		bParam3 = Function_428(uVar0);
	}
	if (bParam3 == 4294967295)
	{
		return 4294967295;
...
var Function_430(int iParam0, int iParam1, bool bParam2) //Position: 0x12287 / 74375
{
...
void Function_431() //Position: 0x122A7 / 74407
{
	...
	Local_18.f_24 = CREATE_JOURNAL_ENTRY(&uVar0, 3, false, "challenge_01");
	if (Function_423(5))
	{
...
bool Function_437() //Position: 0x12471 / 74865
{
	return "challenge_04lvl2";
}

bool Function_438() //Position: 0x1248A / 74890
{
	return "challenge_04";
}

bool Function_439() //Position: 0x1249F / 74911
{
	return "challenge_03lvl2";
}

bool Function_440() //Position: 0x124B8 / 74936
{
	return "challenge_02lvl2";
}

bool Function_441() //Position: 0x124D1 / 74961
{
	return "challenge_05";
}

bool Function_442() //Position: 0x124E6 / 74982
{
	return "challenge_03";
}

bool Function_443() //Position: 0x124FB / 75003
{
	return "challenge_02";
}
...
bool Function_466() //Position: 0x14E42 / 85570
{
	return "COOP_advanced_icon";
}

bool Function_467() //Position: 0x14E5D / 85597
{
	return "SC_AA_Nosalida_Icon";
}

bool Function_468() //Position: 0x14E79 / 85625
{
	return "SC_AA_TwinRocks_Icon";
}

bool Function_469() //Position: 0x14E96 / 85654
{
	return "SC_AA_Gaptooth_Icon";
}

bool Function_470() //Position: 0x14EB2 / 85682
{
	return "SC_AA_Tesoro_Icon";
}

bool Function_471() //Position: 0x14ECC / 85708
{
	return "SC_AA_Mercer_Icon";
}

bool Function_472() //Position: 0x14EE6 / 85734
{
	return "SC_AA_Pikes_Icon";
}

bool Function_473() //Position: 0x14EFF / 85759
{
	return "nCOOP_icon";
}

bool Function_474() //Position: 0x14F11 / 85777
{
	return "MP_HeavyWeapons_Icon";
}

bool Function_475() //Position: 0x14F2E / 85806
{
	return "MP_Goldrush_icon";
}

bool Function_476() //Position: 0x14F47 / 85831
{
	return "MP_GrabTheBagII_icon";
}

bool Function_477() //Position: 0x14F64 / 85860
{
	return "MP_GrabTheBag_Icon";
}

bool Function_478() //Position: 0x14F7F / 85887
{
	return "MP_HoldYourOwn_Icon";
}

bool Function_479() //Position: 0x14F9B / 85915
{
	return "MP_Unstoppable_Icon";
}

bool Function_480() //Position: 0x14FB7 / 85943
{
	return "MP_KDR_Icon";
}

bool Function_481() //Position: 0x14FCB / 85963
{
	return "KillStreakII_Icon";
}

bool Function_482() //Position: 0x14FE5 / 85989
{
	return "MP_KillStreak_Icon";
}

bool Function_483() //Position: 0x15000 / 86016
{
	return "MP_TDM_Icon";
}

bool Function_484() //Position: 0x15014 / 86036
{
	return "MP_DM_Icon";
}
...
void Function_489(int iParam0) //Position: 0x150F8 / 86264
{
	var uVar0;
...
int Function_492(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x151A7 / 86439
{
	int iVar0;
	int iVar1;
	...
	if (iParam2 && bParam1 == 0)
	{
		Function_211(iParam0, 1, TO_FLOAT(bParam1), 1, 1, 3.0f, 0, bParam3);
	}
	if (Global_35278[iParam020].f_48 == 2)
	{
		iVar1 = 0;
...
void Function_495() //Position: 0x153EC / 87020
{
	...
	if (iLocal_525 >= 5)
	{
		...
		while (bVar0 <= 16)
		{
			if (Function_99(bVar0))
			{
				if ((iLocal_269[bVar0] && !Function_496(GET_LOCAL_SLOT(), bVar0)) && bLocal_524 == 1)
				{
				...
				{
					if (bLocal_524 != 1 && Function_496(GET_LOCAL_SLOT(), bVar0))
					{
...
void Function_513(bool bParam0) //Position: 0x157E3 / 88035
{
	if (!Function_512(bParam0))
	{
		return;
	}
...
void Function_545(bool bParam0) //Position: 0x160F3 / 90355
{
...
bool Function_547(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x1613B / 90427
{
	bool bVar0;
	bool bVar1;
...
void Function_549(int iParam0) //Position: 0x161C3 / 90563
{
	struct<9> Var0;
	
	NET_SCRIPTMSG_GETNEXT(iParam0, &vVar0, 3);
	NET_LOG(1, "FRD Client", "RECV Payout for player #%s for %s XP, pType: %s", I2STR(vVar0.x), I2STR(CEIL(vVar0.y)), I2STR(vVar0.z), false);
...
void Function_551(int iParam0, bool bParam1, bool bParam2) //Position: 0x162F9 / 90873
{
	Function_492(iParam0, CEIL(bParam1), 1, bParam2);
	Global_83864.f_1280 = 1;
	return;
}
...
void Function_554(bool bParam0, int iParam1) //Position: 0x16336 / 90934
{
	...
	if (NET_IS_SESSION_HOST())
	{
		NET_LOG(1, "FRD Host", "RECV FRD Start Request for %s received from Player #%s, %s", Function_155(vVar0.z), I2STR(vVar0.x), GET_SLOT_NAME(vVar0.x), false);
		switch (bParam0->f_48)
		{
			case 0xFFFFFFFF:
				if (!Function_105(bParam0))
				{
					NET_LOG(1, "FRD Host", "He has now started the FRD for the first time ever!", false, false, false, false);
					Function_562(bParam0, vVar0.z, vVar0.y, vVar0.x);
				}
				else if (vVar0.z != bParam0->f_72)
				{
					NET_LOG(1, "FRD Host", "He has now started the FRD in ANOTHER region", false, false, false, false);
					Function_562(bParam0, vVar0.z, vVar0.y, vVar0.x);
				}
				else if (Function_104(bParam0))
				{
					NET_LOG(1, "FRD Host", "He has now started the FRD in the SAME region because the timer's expired", false, false, false, false);
					Function_562(bParam0, vVar0.z, vVar0.y, vVar0.x);
				}
				else
				{
					NET_LOG(1, "FRD Host", "Nothing happened--the cooldown timer ain't ready.", false, false, false, false);
				}
				break;
			...
			case 0xFFFFFFFE:
				...
				{
					NET_LOG(1, "FRD Host", "He has now picked up the spoon!", false, false, false, false);
					Function_555(bParam0, vVar0.x, 1);
				}
				else
				{
					NET_LOG(1, "FRD Host", "Package came in for the wrong region. Ignoring.", false, false, false, false);
				}
				break;
			...
			default:
				if (vVar0.z == bParam0->f_68)
				{
					NET_LOG(1, "FRD Host", "And they've snagged it away from #%s, %s!", I2STR(bParam0->f_48), GET_SLOT_NAME(bParam0->f_48), false, false);
					Function_555(bParam0, vVar0.x, 1);
				}
				else
				{
	...
	{
		NET_LOG(1, "FRD Client", "RECV FRD Start Request for %s received from Player #%s, %s, but ignored 'cuz we're not the host.", Function_155(vVar0.z), I2STR(vVar0.x), GET_SLOT_NAME(vVar0.x), false);
	}
	return;
}
...
void Function_555(bool bParam0, bool bParam1, bool bParam2) //Position: 0x16709 / 91913
{
	...
	if (bParam0->f_52 != bParam1)
	{
		...
		if (Function_560(bParam0 + 36, Function_561(bParam2, iLocal_186, iLocal_187)))
		{
			...
			NET_LOG(1, "FRD Host", "Pot Increased by %s from %s to %s.", I2STR(bVar0), I2STR((CEIL(bParam0->f_64) - bVar0)), I2STR(CEIL(bParam0->f_64)), false);
			if (bParam2)
			{
				Function_93(bParam1, bLocal_183, 2);
			}
			bVar1 = Function_274(Function_557(bParam0), Function_101(0.0f, (fLocal_190 - Function_103(bParam0 + 12))));
			Function_556(bParam0 + 12, bVar1);
			NET_LOG(1, "FRD Host", "Time Increased by %s to %s.", F2STR(bVar1, 3, 2), F2STR(Function_103(bParam0 + 12), 3, 2), false, false);
		}
		else
		{
			NET_LOG(1, "FRD Host", "Pot Left @%s and Time left @%s because it's too soon for turnover", I2STR(CEIL(bParam0->f_64)), F2STR(Function_103(bParam0 + 12), 3, 2), false, false);
		}
	}
	else
	{
		NET_LOG(1, "FRD Host", "Didn't add time or pot because last owner is the same guy again (Old: %s v. New: %s)", I2STR(bParam0->f_52), I2STR(bParam1), false, false);
	}
	bParam0->f_52 = bParam0->f_48;
...
int Function_559(int iParam0) //Position: 0x16984 / 92548
{
	if (Function_157(64))
	{
		return CEIL(Function_558(iParam0, bLocal_181, bLocal_181, 1));
	}
	return CEIL(bLocal_181);
}
...
void Function_564(int iParam0) //Position: 0x16A2C / 92716
{
	...
	NET_SCRIPTMSG_GETNEXT(iParam0, &vVar0, 11);
...
void Function_567(var uParam0, int iParam1) //Position: 0x16E1C / 93724
{
	...
	while (bVar0 > 0)
	{
		if (Function_351(uParam0, Function_192(bVar0)))
		{
			PRINTINT(true);
		}
		else
...
void Function_568(int iParam0) //Position: 0x16E63 / 93795
{
	...
	NET_LOG(1, "FRD Host", "Pot Increased 'cuz of Defender Kill by %s from %s to %s.", I2STR(bVar0), I2STR((CEIL(iParam0->f_64) - bVar0)), I2STR(CEIL(iParam0->f_64)), false);
	return;
}
...
void Function_569(bool bParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x16EE3 / 93923
{
	...
	{
		Function_88(bParam0);
		NET_LOG(1, "FRD Host", "Player #%s, %s up and died, dropping the spoon.", I2STR(bParam2), GET_SLOT_NAME(bParam2), false, false);
	}
	else
	{
...
bool Function_580() //Position: 0x172F1 / 94961
{
	...
	Function_582(StackVal, "TMS_FRD_KILL_DEFENDER_POT", &bLocal_181);
	...
	Function_582(StackVal, "TMS_FRD_TAG_XP", &bLocal_183);
...
void Function_586() //Position: 0x177F6 / 96246
{
	...
	{
		bLocal_239 = LAUNCH_NEW_SCRIPT("$/content/Ambient/CrimeResponse/mplaw_response_thread", 0);
	}
	return;
}
	...
	switch (iLocal_67)
	{
		...
		case 0x00000002:
			if (STREAMING_IS_WORLD_LOADED())
			{
				...
				if (!bLocal_79)
				{
					Function_620(StackVal, StackVal, vLocal_71, bLocal_77, 20.0f, bLocal_80);
				}
				iLocal_67 = 3;
			}
			break;
		...
		case 0x00000003:
			...
			else
			{
				...
				{
					Function_620(StackVal, StackVal, Global_76888[13], bLocal_77, -1.0f, bLocal_80);
...
bool Function_618(int iParam0, int iParam1) //Position: 0x18665 / 99941
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_620(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x187D9 / 100313
{
	int iVar0;
...
var Function_624(bool bParam0) //Position: 0x189B3 / 100787
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
var Function_660(bool bParam0) //Position: 0x190CB / 102603
{
	bool bVar0;
...
void Function_661() //Position: 0x190EE / 102638
{
	...
	bVar1 = ROUND((GET_TIME_SINCE_LAST_INPUT(Function_662()) * 100000.0f));
...
void Function_676(int iParam0, int iParam1, int iParam2) //Position: 0x193AE / 103342
{
	int iVar0;
	...
	if (!StackVal != Global_16524)
	{
		...
		Function_677(Global_16524, iVar0, 1);
	}
	return;
}

void Function_677(int iParam0, bool bParam1, bool bParam2) //Position: 0x19494 / 103572
{
	int iVar0;
	
	Function_680(iParam0);
	Function_679(bParam1);
	PRINTNL();
	if (StackVal == iParam0)
	{
...
void Function_679(bool bParam0) //Position: 0x19619 / 103961
{
	PRINTSTRING("Day ");
...
void Function_691(bool bParam0, bool bParam1) //Position: 0x19CAB / 105643
{
	if (bParam1)
	{
...
bool Function_695(bool bParam0) //Position: 0x19D7B / 105851
{
	bool bVar0;
...
var Function_702(bool bParam0) //Position: 0x19ED8 / 106200
{
	bool bVar0;
