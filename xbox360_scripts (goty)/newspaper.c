...
void Function_1(var uParam0, var uParam1) //Position: 0x119 / 281
{
	if (Global_3381)
	{
		return;
...
bool Function_2() //Position: 0x15B / 347
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_3(bool bParam0) //Position: 0x164 / 356
{
...
void Function_4(var uParam0, int iParam1) //Position: 0x1B5 / 437
{
...
void Function_6() //Position: 0x21A / 538
{
...
void Function_7() //Position: 0x320 / 800
{
	float fVar0;
...
void Function_8() //Position: 0x353 / 851
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x4E1 / 1249
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x695 / 1685
{
	Function_11(&Global_28260, 1, 0);
	return;
}

void Function_11(int iParam0, bool bParam1, var uParam2) //Position: 0x6A3 / 1699
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_12() //Position: 0x894 / 2196
{
...
struct<8> Function_13(int iParam0) //Position: 0x8A9 / 2217
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_14(int iParam0, bool bParam1, bool bParam2) //Position: 0x94F / 2383
{
	int iVar0;
...
void Function_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBEA / 3050
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_16() //Position: 0x1217 / 4631
{
	int iVar0;
...
var Function_17(int iParam0) //Position: 0x121F / 4639
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1230 / 4656
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0, bool bParam1) //Position: 0x1325 / 4901
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x133E / 4926
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x13A3 / 5027
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x13B5 / 5045
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x13C7 / 5063
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x14F7 / 5367
{
	return Global_35278[iParam020].f_48;
}

float Function_25(int iParam0) //Position: 0x1506 / 5382
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x153F / 5439
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x157C / 5500
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x1716 / 5910
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x195A / 6490
{
...
struct<8> Function_30() //Position: 0x199B / 6555
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x1A24 / 6692
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x1ABB / 6843
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x1B3A / 6970
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x1B73 / 7027
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x1D7D / 7549
{
	vector3 vVar0;
	var uVar3;
...
bool Function_36(vector3 vParam0) //Position: 0x1E38 / 7736
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_37(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1E50 / 7760
{
	int iVar0;
...
vector3 Function_38() //Position: 0x1F37 / 7991
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_39(var uParam0, int iParam1) //Position: 0x1F40 / 8000
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_40(int iParam0) //Position: 0x1F4F / 8015
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x1F65 / 8037
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x202C / 8236
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_43(var uParam0, int iParam1) //Position: 0x2049 / 8265
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_44(int iParam0) //Position: 0x286E / 10350
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x28A9 / 10409
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(bool bParam0, bool bParam1) //Position: 0x28B6 / 10422
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_47() //Position: 0x28C3 / 10435
{
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28DE / 10462
{
	uParam0 = uParam0;
...
int Function_49(bool bParam0) //Position: 0x2982 / 10626
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
void Function_50(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A2B / 10795
{
	bool bVar0;
...
bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A52 / 10834
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (*iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar0) && iLocal_3)
		{
			if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
			{
				if (!iLocal_6)
				{
					...
					if (bLocal_4 == 200)
					{
						...
						SHOW_NEWSPAPER(200, bLocal_5, 1, 1);
					}
					else if (bLocal_4 == 202)
					{
						SHOW_NEWSPAPER(202, bLocal_5, 1, 1);
					}
					else if (bLocal_4 == 201)
					{
					...
					{
						CLEAR_NEWSPAPER();
						bLocal_4 = Function_29(472);
						bLocal_4 = (bLocal_4 || SHIFT_LEFT(true, false));
						bVar1 = false;
						while (bVar1 < 9)
						{
							bVar2 = SHIFT_LEFT(true, bVar1);
							if ((bVar2 && bLocal_4) == bVar2)
							{
			...
			if (DECOR_CHECK_EXIST(bParam1, "NewspaperClosed"))
			{
				...
				if (iLocal_7)
				{
					SET_ACTION_NODE_FOR_ACTOR(bParam1, "dirty_photos/pst");
				}
				else if (bLocal_4 == 200)
				{
					SET_ACTION_NODE_FOR_ACTOR(bParam1, "treasure_map/human/map_pst");
				}
				else
				{
					SET_ACTION_NODE_FOR_ACTOR(bParam1, "wanted_poster/human/poster_pst");
				}
			}
...
void Function_52(bool bParam0, var uParam1, int iParam2) //Position: 0x2D1D / 11549
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_53(bool bParam0, bool bParam1) //Position: 0x2DA7 / 11687
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_54(bool bParam0, bool bParam1, int iParam2) //Position: 0x2E55 / 11861
{
	int iVar0;
	bool bVar1;
...
var Function_55(bool bParam0) //Position: 0x2E9A / 11930
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_56(bool bParam0) //Position: 0x2EB0 / 11952
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_57(bool bParam0, bool bParam1, int iParam2) //Position: 0x2EC6 / 11974
{
	bParam0 = Function_64(bParam0);
	*iParam2 = 0;
	if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
	{
		DECOR_REMOVE(bParam1, "NewspaperStart");
	...
	if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(Global_34573)))
	{
		...
		{
			if (GET_GRINGO_INT_ATTR(&bLocal_4, "ngraphicID", bParam0))
			{
				if (((Function_60(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
				{
					iLocal_3 = 0;
				}
				*iParam2 = 1;
		...
		{
			Function_58("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
	{
		Function_58("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	iLocal_6 = 0;
	return;
...
void Function_58(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2FE6 / 12262
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x3061 / 12385
{
	char* cVar0[16];
...
int Function_60(bool bParam0, bool bParam1, bool bParam2) //Position: 0x30A0 / 12448
{
...
bool Function_61() //Position: 0x3156 / 12630
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_62(bool bParam0) //Position: 0x316D / 12653
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_63(bool bParam0) //Position: 0x3178 / 12664
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_64(bool bParam0) //Position: 0x3186 / 12678
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_65(int iParam0, bool bParam1) //Position: 0x31A0 / 12704
{
	bool bVar0;
	bool bVar1;
