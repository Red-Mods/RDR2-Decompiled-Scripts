...
void main() //Position: 0x0 / 0
{
	...
	iLocal_76 = 0;
	Function_101(uScriptParam_0, &iLocal_76);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(Local_3[iVar312]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), Local_3[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_87("eGRINGO_EndUse: Stop use by request", Local_3[iVar312].f_16);
							Function_86(Local_3[iVar312].f_16, 1);
...
void Function_29(var uParam0, int iParam1) //Position: 0x1D41 / 7489
{
	...
	if (IS_OBJECT_VALID(bVar0))
	{
		GET_OBJECT_POSITION(bVar0, &uVar1);
		if (!IS_DOOR_CLOSED(bLocal_0[0]))
		{
			CLOSE_DOOR(bLocal_0[0], 1.0f);
		}
		bLocal_0[0] = FIND_NEAREST_DOOR(&uVar1, 1.0f);
		if (IS_DOOR_VALID(bLocal_0[0]))
		{
			if (!IS_DOOR_LOCKED(bLocal_0[0]))
			{
				SET_DOOR_LOCK(bLocal_0[0], 1);
			}
		}
	}
	return;
...
bool Function_30(int iParam0) //Position: 0x1DA4 / 7588
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DAF / 7599
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DC9 / 7625
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DE7 / 7655
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E06 / 7686
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E39 / 7737
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E58 / 7768
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E72 / 7794
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E85 / 7813
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x216D / 8557
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2175 / 8565
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2192 / 8594
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21A1 / 8609
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21C3 / 8643
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21E7 / 8679
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2204 / 8708
{
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x2244 / 8772
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22F2 / 8946
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2362 / 9058
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2378 / 9080
{
...
var Function_51(bool bParam0) //Position: 0x2399 / 9113
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23B9 / 9145
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23CD / 9165
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23D7 / 9175
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23DE / 9182
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23ED / 9197
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x242C / 9260
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2457 / 9303
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2462 / 9314
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2558 / 9560
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x257A / 9594
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25A1 / 9633
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2860 / 10336
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28BD / 10429
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x291A / 10522
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2924 / 10532
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2942 / 10562
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2957 / 10583
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29DE / 10718
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A01 / 10753
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A1F / 10783
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A42 / 10818
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B5D / 11101
{
...
int Function_74(bool bParam0) //Position: 0x2B88 / 11144
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C8D / 11405
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C9A / 11418
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D0D / 11533
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x320B / 12811
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3242 / 12866
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x325F / 12895
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3297 / 12951
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32A1 / 12961
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x32C2 / 12994
{
	var uVar0;
	...
	bLocal_0[0] = FIND_NEAREST_DOOR(&uVar0, 1.0f);
	if (IS_DOOR_VALID(bLocal_0[0]))
	{
		Function_84(&bLocal_0, 0);
	}
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(var uParam0, int iParam1) //Position: 0x32FB / 13051
{
	int iVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x333B / 13115
{
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x338C / 13196
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3494 / 13460
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x34AA / 13482
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x3760 / 14176
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x376E / 14190
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x3787 / 14215
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x37A1 / 14241
{
	bool bVar0;
	char* cVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x37D9 / 14297
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x37F0 / 14320
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3AB9 / 15033
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3AD6 / 15062
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3B72 / 15218
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3B91 / 15249
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3BA0 / 15264
{
...
void Function_100(int iParam0) //Position: 0x3BBC / 15292
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3BC6 / 15302
{
	int iVar0;
	int iVar1;
	...
	{
		Function_102(&(Local_3[iLocal_7612]), bParam0);
		iLocal_76++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x3C28 / 15400
{
...
void Function_103(int iParam0) //Position: 0x3C3C / 15420
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3C46 / 15430
{
