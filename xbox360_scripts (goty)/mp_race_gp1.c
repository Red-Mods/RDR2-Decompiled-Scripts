...
void Function_49(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x241E / 9246
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_52(char* cParam0, bool bParam1) //Position: 0x2B51 / 11089
{
	char* cVar0[32];
...
var Function_55(int iParam0, bool bParam1) //Position: 0x2BE1 / 11233
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_61(int iParam0, bool bParam1, bool bParam2) //Position: 0x2F42 / 12098
{
	int iVar0;
	int iVar1;
...
int Function_62(bool bParam0) //Position: 0x3186 / 12678
{
...
int Function_67(int iParam0, bool bParam1, int iParam2) //Position: 0x339F / 13215
{
	int iVar0;
	int iVar1;
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x4178 / 16760
{
...
void Function_104(char* cParam0, bool bParam1) //Position: 0x48CC / 18636
{
	bool bVar0;
...
int Function_116(bool bParam0, int iParam1, bool bParam2) //Position: 0x4B9F / 19359
{
	if (!Function_122())
	{
		Global_83822 = 1;
...
void Function_145(var uParam0, bool bParam1) //Position: 0x583D / 22589
{
...
bool Function_213(bool bParam0, int iParam1, bool bParam2) //Position: 0x88CF / 35023
{
	char* cVar0[64];
...
void Function_232(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x90BD / 37053
{
	vector3 vVar0;
	int iVar3;
...
void Function_260(bool bParam0) //Position: 0x9EAB / 40619
{
	var uVar0;
