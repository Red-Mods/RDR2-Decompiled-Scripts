...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Tor", 4);
	Function_12("Loading Torquemada population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("Torquemada_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "torv_region_set");
	...
	Function_5("Finished loading Torquemada population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC5B / 3163
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC6A / 3178
{
	int iVar0;
...
var Function_3(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xCBF / 3263
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD41 / 3393
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD5D / 3421
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD9B / 3483
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDB7 / 3511
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDC7 / 3527
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE0C / 3596
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE18 / 3608
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0xE94 / 3732
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xEA1 / 3745
{
	if (!Function_4(128))
	{
		return;
