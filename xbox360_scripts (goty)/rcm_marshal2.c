...
void main() //Position: 0x0 / 0
{
	...
	iLocal_271 = 0;
	iLocal_264 = 1000;
	Function_200(&bLocal_248, "tend_counter_and_patron", 1, 0);
	Function_200(&bLocal_248, "dlc_eating_dynamic", 1, 0);
	Function_199(&bLocal_248, 1210, 3, 0);
	Function_199(&bLocal_248, 1204, 3, 0);
	Function_199(&bLocal_248, 1212, 3, 0);
	Function_198(&iLocal_294);
	while (!IS_EXITFLAG_SET())
	{
		Function_192();
		if (IS_ACTOR_VALID(bLocal_274))
		{
			if (GET_LAST_ATTACKER(bLocal_274) == Global_34573)
			{
				SET_ACTOR_FACTION(bLocal_274, 4);
				TASK_PRIORITY_SET(bLocal_274, 0);
				TASK_FLEE_ACTOR(bLocal_274, Global_34573, 200.0f, -1.0f, 0, 0, 0);
				if (!Function_191(16))
				{
					Function_190(16, 1);
				}
				if (IS_VOLUME_VALID(bLocal_286))
				{
					DESTROY_VOLUME(bLocal_286);
				}
				Function_189(&Global_63541[ScriptParam_055] + 144, 128);
		...
		switch (iLocal_271)
		{
			case 0x00000000:
				...
				{
					if (IS_LAYOUTREF_VALID(bLocal_272))
					{
						bLocal_274 = Global_63541[ScriptParam_055].f_204;
						if (IS_ACTOR_VALID(bLocal_274) && Function_178(&bLocal_248))
						{
							bLocal_286 = CREATE_VOLUME_IN_LAYOUT(bLocal_272, "Marshal2_StayOut", 2, -2087.249f, 20.071f, 2602.065f, 0.0f, 24.353f, 0.0f, 19.13f, 8.597f, 15.587f);
							CLEAR_AMBIENT_OBJECTS_VOLUME(bLocal_286, 15);
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_286);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_286);
							bLocal_279 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(bLocal_272, "Marshal2_ShopGringo", "tend_counter_and_patron", -2150.842f, 17.666f, 2623.209f, 0.0f, -89.972f, 0.0f));
							SET_ACTOR_FACTION(bLocal_274, 20);
							TASK_PRIORITY_SET(bLocal_274, 1);
							SNAP_ACTOR_TO_GRINGO(bLocal_274, GET_OBJECT_FROM_GRINGO(bLocal_279), "UseCase1", 1, 0, 0);
							TASK_USE_GRINGO(bLocal_274, bLocal_279, "UseCase1", 4294967295, 1);
							DECOR_SET_INT(bLocal_274, "iSpecificItem", true);
							iLocal_271 = 1;
							Function_176(&iLocal_294);
						}
						else if (Function_173(&iLocal_294) < 5.0f)
						{
							Function_176(&iLocal_294);
						}
						Function_166(&(Global_63541[1655]), 16, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						bLocal_272 = CREATE_LAYOUT("RCM_Marshal2_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					if (StackVal && FABS((StackVal - !Function_162(Global_34573, 1, 1))) > 2.0f)
					{
						if (Function_158(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0))
						{
			...
			case 0x00000003:
				if (Function_114("$/cutscene/MARSHAL_RCM_2_CS_SEQ/MARSHAL_RCM_2_CS_SEQ", &iLocal_264, 33953, 33946, 32055, 29929, 29633, 29617, 1, 1, 2, 2, 0))
				{
					iLocal_300 = 0;
					iLocal_271 = 5;
					Function_176(&iLocal_294);
			...
			case 0x00000005:
				if (!HUD_IS_FADING() && !HUD_IS_FADED())
				{
					...
					Function_113("Marshal2_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
					iLocal_297 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_63541[ScriptParam_055].f_140);
					iVar0 = 0;
					while (iVar0 <= iLocal_297)
					{
					...
					APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "Marshal2_OBJ", 0, 3, false);
			...
			case 0x0000000D:
				...
				{
					case 0x00000000:
						if (Function_173(&iLocal_294) < 0.3f)
						{
							Function_1(bLocal_275[0], 4294967295, 0);
							TASK_CLEAR(bLocal_275[0]);
							iLocal_298 = 1;
						}
						break;
					
					case 0x00000001:
						if (Function_173(&iLocal_294) < 1.0f)
						{
							Function_1(bLocal_275[1], 4294967295, 0);
							TASK_CLEAR(bLocal_275[1]);
							iLocal_298 = 2;
						}
						break;
					
					case 0x00000002:
						if (Function_173(&iLocal_294) < 1.9f)
						{
							Function_1(bLocal_275[2], 4294967295, 0);
							TASK_CLEAR(bLocal_275[2]);
							iLocal_298 = 3;
						}
						break;
					
					case 0x00000003:
						if (Function_173(&iLocal_294) < 4.0f)
						{
							Function_1(bLocal_274, 0, 0);
							TASK_MELEE_ATTACK(bLocal_274, Global_34573, -1.0f);
							Function_189(&Global_63541[ScriptParam_055] + 144, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_184();
							TERMINATE_THIS_SCRIPT();
...
void Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5CE / 1486
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	switch (bParam1)
	{
		case 0x00000001:
			...
			bVar9 = CREATE_RMPTFX_EMITTER_IN_LAYOUT(bParam0, Function_3(), "script_zombie_emerge", vVar3);
			if (IS_OBJECT_VALID(bVar9))
			{
				Function_2();
				bVar10 = CREATE_POINT_IN_LAYOUT(bParam0, Function_3(), vVar3, Function_2());
		...
		case 0x00000002:
			...
			GET_ACTOR_AXIS(bParam0, &vVar3, 2);
			vVar0 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(Vector(vVar3, vVar0, StackVal) * Vector(0.75f, 0.75f, 0.75f), StackVal, StackVal) };
			bVar9 = CREATE_RMPTFX_EMITTER_IN_LAYOUT(bParam0, Function_3(), "script_zombie_emerge", vVar0);
			if (IS_OBJECT_VALID(bVar9))
			{
				Function_2();
				bVar10 = CREATE_POINT_IN_LAYOUT(bParam0, Function_3(), vVar0, Function_2());
				SNAP_OBJECT_TO_GROUND(bVar10, 2.5f, true, 1092616192);
				GET_OBJECT_ORIENTATION(bVar10, &vVar6);
				DESTROY_OBJECT(bVar10);
				UNK_0x6745191B(bVar9, vVar6);
...
vector3 Function_2() //Position: 0x77E / 1918
{
	return 0.0f, 0.0f, 0.0f;
}

var Function_3() //Position: 0x787 / 1927
{
	int iVar0;
...
void Function_4(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x78F / 1935
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_5(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xBBE / 3006
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_6() //Position: 0xD31 / 3377
{
	return;
}

void Function_7(var uParam0, var uParam1) //Position: 0xD37 / 3383
{
	if (Global_3381)
	{
		return;
...
bool Function_8() //Position: 0xD79 / 3449
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_9(bool bParam0) //Position: 0xD82 / 3458
{
...
void Function_10() //Position: 0xDD3 / 3539
{
	Function_37();
	Function_36();
	Function_36();
...
void Function_11() //Position: 0xE25 / 3621
{
...
void Function_12() //Position: 0xF2B / 3883
{
	float fVar0;
...
void Function_13() //Position: 0xF5E / 3934
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_14() //Position: 0x10EC / 4332
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_15() //Position: 0x12A0 / 4768
{
	Function_16(&Global_28260, 1, 0);
	return;
}

void Function_16(int iParam0, bool bParam1, var uParam2) //Position: 0x12AE / 4782
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_17() //Position: 0x149F / 5279
{
...
struct<8> Function_18(int iParam0) //Position: 0x14B4 / 5300
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_19(int iParam0, bool bParam1, bool bParam2) //Position: 0x155A / 5466
{
	int iVar0;
...
void Function_20(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x17F5 / 6133
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_21(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_3(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_21(int iParam0) //Position: 0x1E22 / 7714
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_22(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1E33 / 7731
{
	char* cVar0[32];
...
struct<32> Function_23(char* cParam0, bool bParam1) //Position: 0x1F28 / 7976
{
	char* cVar0[32];
...
void Function_24(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1F41 / 8001
{
	float fVar0;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1FA6 / 8102
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_26(int iParam0, bool bParam1) //Position: 0x1FB8 / 8120
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_27(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1FCA / 8138
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_28(int iParam0) //Position: 0x20FA / 8442
{
	return Global_35278[iParam020].f_48;
}

float Function_29(int iParam0) //Position: 0x2109 / 8457
{
	if (!iParam0 != 4294967295)
	{
...
var Function_30(int iParam0) //Position: 0x2142 / 8514
{
	if (iParam0 == 4294967295)
	{
...
void Function_31(int iParam0) //Position: 0x217F / 8575
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_32(int iParam0, bool bParam1, bool bParam2) //Position: 0x2319 / 8985
{
	int iVar0;
	int iVar1;
...
int Function_33(bool bParam0) //Position: 0x255D / 9565
{
...
struct<8> Function_34() //Position: 0x259E / 9630
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_35() //Position: 0x2627 / 9767
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_36() //Position: 0x26BE / 9918
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_37() //Position: 0x273D / 10045
{
...
int Function_38(int iParam0, bool bParam1, int iParam2) //Position: 0x2776 / 10102
{
	int iVar0;
	int iVar1;
...
void Function_39() //Position: 0x2980 / 10624
{
	vector3 vVar0;
	var uVar3;
...
bool Function_40(vector3 vParam0) //Position: 0x2A3B / 10811
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_41(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2A53 / 10835
{
	int iVar0;
...
bool Function_42(int iParam0) //Position: 0x2B3A / 11066
{
...
int Function_43(bool bParam0, bool bParam1) //Position: 0x2B50 / 11088
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_44(vector3 vParam0, vector3 vParam3) //Position: 0x2C17 / 11287
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_45(var uParam0, int iParam1) //Position: 0x2C34 / 11316
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	*uParam0 = *uParam0;
	...
	Function_48(Global_34573, &vVar4);
...
bool Function_46(int iParam0) //Position: 0x3459 / 13401
{
	var uVar0;
...
bool Function_47(var uParam0, int iParam1) //Position: 0x3494 / 13460
{
	return (uParam0 && iParam1) == 0;
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x34A1 / 13473
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_49(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x34AE / 13486
{
	uParam0 = uParam0;
...
void Function_50(int iParam0) //Position: 0x3552 / 13650
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_191(4) && !Function_56(0))
	{
	...
	if (!Function_53(&Global_3422[240] + 128, 2) || ((((((Function_191(14) && Function_191(18)) && Function_191(37)) && Function_191(7)) && Function_191(11)) && Function_191(5)) && Function_191(21)))
	{
	...
	if (!Function_53(&Global_3422[340] + 128, 2) || ((Function_191(27) && Function_191(1)) && Function_191(23)))
	{
	...
	if (!Function_191(7))
	{
		...
		if (((Function_191(6) && Function_51(Global_30735) < 0) && Function_51(Global_30737) < 0) && Function_51(Global_30738) < 0)
		{
	...
	if (!Function_191(11))
	{
		if (Function_191(8))
		{
			...
			strcpy(&cVar30, INT_TO_STRING((5 - Function_33(491))), 24);
			stradd(&cVar30, " ", 24);
			strcpy(&cVar36, INT_TO_STRING((5 - Function_33(497))), 24);
			stradd(&cVar36, " ", 24);
	...
	{
		Function_113(bVar0, 0x40f00000, 1, 2, 0, 0, 0, 0);
	}
	return;
}

int Function_51(int iParam0) //Position: 0x3E47 / 15943
{
...
bool Function_52(int iParam0) //Position: 0x3E61 / 15969
{
...
bool Function_53(int iParam0, int iParam1) //Position: 0x3E78 / 15992
{
	int iVar0;
...
var Function_54() //Position: 0x3E94 / 16020
{
	return STRING_TO_HASH(Function_55());
}

var Function_55() //Position: 0x3EA0 / 16032
{
	return "ZOMBIE_STORY";
}

bool Function_56(int iParam0) //Position: 0x3EB5 / 16053
{
	...
	return Global_13172[Function_57(iParam0)11].f_12 < 0;
}
...
void Function_58(char* cParam0) //Position: 0x3FDD / 16349
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_54(), cParam0, 0, 3, false);
	Function_112(Function_54(), 0);
	return;
}

bool Function_59(int iParam0, bool bParam1) //Position: 0x4032 / 16434
{
	int iVar0;
...
var Function_60(int iParam0) //Position: 0x406F / 16495
{
...
bool Function_61(int iParam0) //Position: 0x4089 / 16521
{
...
void Function_62(int iParam0) //Position: 0x409F / 16543
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_47(Global_63541[iVar155].f_144, 2048))
				{
					...
					{
						Function_189(&Global_63541[iVar155] + 144, 64);
...
void Function_63(int iParam0, int iParam1) //Position: 0x4241 / 16961
{
	float fVar0;
	bool bVar1;
	...
	fVar0 = iParam0->f_96;
	iParam0->f_192 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(Global_63535, Function_3(), *(iParam0 + 112), 0.0f, 0.0f, 0.0f, fVar0, fVar0, fVar0, 0, Global_34573, iParam1, iParam0->f_92, 0, 1, 1);
	Function_64(iParam0);
...
void Function_64(int iParam0) //Position: 0x42FB / 17147
{
	float fVar0;
	bool bVar1;
	...
	iParam0->f_216 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_3(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, 2.0f, 2.0f, 2.0f);
	...
	bVar1 = CREATE_VOLUME_IN_LAYOUT(iParam0->f_216, Function_3(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, fVar0, fVar0, fVar0);
	DECOR_SET_INT(bVar1, "category", 512);
	Function_65(&bVar1, 0);
	return;
}

int Function_65(var uParam0, int iParam1) //Position: 0x439D / 17309
{
	int iVar0;
	var uVar1;
...
void Function_66(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x44FE / 17662
{
	struct<8> Var0;
...
struct<32> Function_67(bool bParam0) //Position: 0x4599 / 17817
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4603 / 17923
{
	char* cVar0[32];
...
int Function_69(bool bParam0) //Position: 0x4622 / 17954
{
	int iVar0;
	vector3 vVar1;
...
float Function_70(bool bParam0, vector3 vParam1) //Position: 0x4783 / 18307
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0) //Position: 0x47FD / 18429
{
	vector3 vVar0;
...
void Function_72(int iParam0) //Position: 0x4867 / 18535
{
...
bool Function_73(int iParam0) //Position: 0x48C8 / 18632
{
...
void Function_74(int iParam0, int iParam1) //Position: 0x48DE / 18654
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_79(StackVal, Function_80(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_78(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_47(Global_63541[iParam155].f_144, 64))
	{
...
void Function_75(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4D70 / 19824
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_76(int iParam0) //Position: 0x4DEB / 19947
{
	char* cVar0[16];
...
bool Function_77() //Position: 0x4E2A / 20010
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_78(bool bParam0) //Position: 0x4E57 / 20055
{
...
var Function_79(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4E83 / 20099
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_80(int iParam0) //Position: 0x4E9F / 20127
{
...
bool Function_81(int iParam0, int iParam1) //Position: 0x4EB4 / 20148
{
	...
	{
		Function_189(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
	if ((Function_91(iParam1) || Function_191(iParam1)) || Function_90(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
...
bool Function_82(int iParam0, int iParam1) //Position: 0x4FC9 / 20425
{
	int iVar0;
	
	if (!iParam0->f_172 != 0)
	{
		if (Function_53(iParam0 + 172, 4))
		{
		...
		if (Function_53(iParam0 + 172, 1))
		{
			if (!Function_191(iParam0->f_168))
			{
				return 0;
			}
		}
		if (Function_53(iParam0 + 172, 2) && Global_3365)
		{
		...
		if (Function_53(iParam0 + 172, 8) && Global_3365)
		{
		...
		switch (Global_63399)
		{
			...
			case 0x00000004:
				if (!Function_53(iParam0 + 172, 128))
				{
					return 0;
				}
				break;
			...
			case 0x00000008:
				if (!Function_53(iParam0 + 172, 256))
				{
					return 0;
				}
				break;
			...
			case 0x00000010:
				if (!Function_53(iParam0 + 172, 512))
				{
					return 0;
				}
				break;
			...
			case 0x00000020:
				if (!Function_53(iParam0 + 172, 1024))
				{
					return 0;
				}
				break;
...
bool Function_83(int iParam0) //Position: 0x510D / 20749
{
	if (!Function_52(iParam0))
	{
		return 0;
...
bool Function_84(int iParam0) //Position: 0x5131 / 20785
{
...
bool Function_85(int iParam0) //Position: 0x5146 / 20806
{
	return StackVal;
}

bool Function_86(int iParam0) //Position: 0x5156 / 20822
{
	if (!iParam0->f_152)
	{
		if (Function_111())
...
bool Function_87(int iParam0) //Position: 0x51FA / 20986
{
...
bool Function_88(int iParam0) //Position: 0x5253 / 21075
{
	int iVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x526F / 21103
{
	int iVar0;
...
int Function_90(int iParam0) //Position: 0x528B / 21131
{
...
int Function_91(int iParam0) //Position: 0x52A0 / 21152
{
...
void Function_92() //Position: 0x52B5 / 21173
{
...
var Function_93(int iParam0, int iParam1) //Position: 0x5330 / 21296
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
	...
	switch (iParam0)
	{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_191(26) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_191(25) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_191(24) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_191(23) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
				...
				case 0x00000008:
					if (Function_191(55) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_191(54) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_191(27) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_191(52) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_191(51) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_191(50) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_191(49) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_191(19) && iVar19)
					{
						vVar0 = { -1708.36f, 46.18f, 2175.89f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_59(6, 0) && Function_191(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_191(17) && iVar19)
					{
						vVar0 = { -1687.208f, 53.208f, 2140.491f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_59(9, 0) && Function_191(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_191(15) && iVar19)
					{
...
int Function_94(int iParam0) //Position: 0x5F21 / 24353
{
	int iVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x5F70 / 24432
{
...
int Function_96(int iParam0) //Position: 0x5F86 / 24454
{
...
void Function_97() //Position: 0x5FEF / 24559
{
...
bool Function_98(int iParam0) //Position: 0x6012 / 24594
{
	if (!Function_95(iParam0))
	{
...
bool Function_99(int iParam0, int iParam1) //Position: 0x6063 / 24675
{
	int iVar0;
...
bool Function_100(int iParam0) //Position: 0x6090 / 24720
{
	if (!Function_95(iParam0))
	{
...
void Function_101(int iParam0) //Position: 0x60E2 / 24802
{
	int iVar0;
...
void Function_102() //Position: 0x611C / 24860
{
	bool bVar0;
...
void Function_103(int iParam0, int iParam1) //Position: 0x617A / 24954
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_104(bool bParam0) //Position: 0x618D / 24973
{
	PRINTSTRING("Day ");
...
void Function_105(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x61D3 / 25043
{
	bool bVar0;
	char* cVar1[16];
...
void Function_106(char* cParam0, int iParam1) //Position: 0x623F / 25151
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_107(bool bParam0, var uParam1, int iParam2) //Position: 0x6276 / 25206
{
	var uVar0;
	char* cVar1[16];
...
int Function_108(char* cParam0) //Position: 0x62EE / 25326
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_109(int iParam0) //Position: 0x638F / 25487
{
	int iVar0;
	int iVar1;
...
bool Function_110(int iParam0, int iParam1) //Position: 0x63CC / 25548
{
...
bool Function_111() //Position: 0x63DF / 25567
{
...
void Function_112(char* cParam0, bool bParam1) //Position: 0x63FA / 25594
{
	bool bVar0;
...
void Function_113(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x641F / 25631
{
	struct<4> Var0;
	int iVar4;
...
bool Function_114(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x64A4 / 25764
{
	var uVar0;
	var uVar7;
	bool bVar8;
	...
	bVar8 = Function_115(uParam0, uParam1, &uVar0, &uVar7, uParam2, uParam3, uParam4, uParam5, uParam6, uParam7, 0, uParam8, uParam9, uParam10, uParam11, uParam12, 1);
	if (bVar8)
	{
...
int Function_115(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x654D / 25933
{
	if (!bParam15)
	{
	...
	{
		case 0x000003E8:
			if (*uParam3 != 99 && (Function_125(iParam2) || iParam2->f_24 < 1))
			{
				*iParam1 = 1106;
				return 0;
			}
			...
			else if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
			{
				...
				{
					if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), bParam0) || !Function_124())
					{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_173(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
			...
			if (STREAMING_IS_WORLD_LOADED() || !HUD_IS_FADED())
			{
				if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
				{
					...
					if (StackVal)
					{
						Function_121(Global_63117, Global_6289);
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && *uParam3 == 99) && !Function_125(iParam2))
			{
...
void Function_116(bool bParam0) //Position: 0x6B61 / 27489
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_117() //Position: 0x6C10 / 27664
{
	bool bVar0;
...
void Function_118() //Position: 0x6C82 / 27778
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_119() //Position: 0x6CC7 / 27847
{
...
void Function_120(bool bParam0) //Position: 0x6CD9 / 27865
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_121(bool bParam0, bool bParam1) //Position: 0x6CF6 / 27894
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_3(), bParam1, 4294967295, 1);
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(bVar0))
	{
		...
		if (IS_OBJECT_VALID(bVar2))
		{
			...
			if ((bVar3 == Global_34573 && !Function_122(bVar3)) && !ACTOR_IS_GRABBED_BY_CUTSCENE(bVar3))
			{
...
bool Function_122(bool bParam0) //Position: 0x6D76 / 28022
{
	int iVar0;
...
int Function_123(bool bParam0) //Position: 0x6DA5 / 28069
{
	int iVar0;
	bool bVar1;
...
bool Function_124() //Position: 0x6E5D / 28253
{
	int iVar0;
	bool bVar1;
...
bool Function_125(int iParam0) //Position: 0x6E97 / 28311
{
	return iParam0->f_20;
}

void Function_126(var uParam0, int iParam1) //Position: 0x6EA1 / 28321
{
	Function_127(uParam0, iParam1, 0);
	return;
}

void Function_127(var uParam0, bool bParam1, bool bParam2) //Position: 0x6EAF / 28335
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_128(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6FFB / 28667
{
	int iVar0;
	int iVar1;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x721B / 29211
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x7244 / 29252
{
	bool bVar0;
	bool bVar1;
...
void Function_131() //Position: 0x728F / 29327
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_3(), Global_63535, 15, 0);
	vVar3 = { StackVal, StackVal, Global_34574 };
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_3(), 2, vVar3, 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
...
int Function_132() //Position: 0x73B1 / 29617
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x73C1 / 29633
{
	Function_134(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	if (IS_VOLUME_VALID(bLocal_285))
	{
		DESTROY_VOLUME(bLocal_285);
	}
	return 1;
}

void Function_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x73E4 / 29668
{
	bool bVar0;
	...
	Function_116(bParam9);
}

void Function_135() //Position: 0x74D4 / 29908
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x74E9 / 29929
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -2142.677f, 16.774f, 2623.614f, -155.974f, 1, true, 1);
	TASK_CLEAR(bLocal_274);
	TELEPORT_ACTOR_WITH_HEADING(bLocal_274, -2141.006f, 16.659f, 2630.398f, 171.734f, 1, true, 1);
	Function_137(bLocal_274, 1254, 4294967295, 4294967295, 4294967295, 1, 1, 1);
	SET_ACTOR_FACTION(bLocal_274, 32);
	MEMORY_CONSIDER_AS_ENEMY(bLocal_274, Global_34573);
	SET_ACTION_NODE_FOR_ACTOR(bLocal_274, "zombie/PlayDead/Variant1/PlayDeadLoop");
	CREATE_DECAL(0, -2141.006f, 16.659f, 2630.398f, 0.75f, 1, 0);
	SET_DRAW_ACTOR(bLocal_275[0], true);
	SET_DRAW_ACTOR(bLocal_275[1], true);
	SET_DRAW_ACTOR(bLocal_275[2], true);
	DECOR_REMOVE(bLocal_275[0], "IsCutscene");
	DECOR_REMOVE(bLocal_275[1], "IsCutscene");
	DECOR_REMOVE(bLocal_275[2], "IsCutscene");
	Global_63541[1655].f_152 = 1;
	return 1;
}

void Function_137(bool bParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x7606 / 30214
{
	int iVar0;
	
	if (Function_143(bParam0) && !Function_142(bParam0, 1))
	{
	...
	Function_138(bParam0, uParam4, uParam5);
}

void Function_138(bool bParam0, bool bParam1, bool bParam2) //Position: 0x7869 / 30825
{
	switch (bParam1)
	{
		case 0x00000000:
...
void Function_139(bool bParam0) //Position: 0x791B / 31003
{
	if (!IS_OBJECT_VALID(bParam0))
	{
		return;
...
void Function_140(bool bParam0) //Position: 0x794F / 31055
{
...
bool Function_142(bool bParam0, int iParam1) //Position: 0x7CD5 / 31957
{
	bool bVar0;
...
int Function_143(bool bParam0) //Position: 0x7D17 / 32023
{
	bool bVar0;
...
int Function_144() //Position: 0x7D37 / 32055
{
	bool bVar0;
	
	if (!iLocal_300)
	{
		bVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(bLocal_272, "Marshal2_ChowGringo01", "DLC_eating_dynamic", -2141.397f, 16.449f, 2631.667f, 0.0f, -16.967f, 0.0f));
		bLocal_275[0] = CREATE_ACTOR_IN_LAYOUT(bLocal_272, "Marshal2_Zombie1", 1210, -2141.397f, 16.449f, 2631.667f, 0.0f, -16.967f, 0.0f);
		SET_DRAW_ACTOR(bLocal_275[0], false);
		SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_275[0], bLocal_274, 0);
		TASK_USE_GRINGO(bLocal_275[0], bVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(bLocal_275[0], GET_OBJECT_FROM_GRINGO(bVar0), "UseCase1", 1, 0, 0);
		SET_ACTOR_FACTION(bLocal_275[0], 32);
		bVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(bLocal_272, "Marshal2_ChowGringo02", "DLC_eating_dynamic", -2140.475f, 16.659f, 2631.447f, 0.0f, 26.095f, 0.0f));
		bLocal_275[1] = CREATE_ACTOR_IN_LAYOUT(bLocal_272, "Marshal2_Zombie2", 1204, -2140.475f, 16.659f, 2631.447f, 0.0f, 26.095f, 0.0f);
		SET_DRAW_ACTOR(bLocal_275[1], false);
		SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_275[1], bLocal_274, 0);
		TASK_USE_GRINGO(bLocal_275[1], bVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(bLocal_275[1], GET_OBJECT_FROM_GRINGO(bVar0), "UseCase1", 1, 0, 0);
		SET_ACTOR_FACTION(bLocal_275[1], 32);
		bVar0 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(bLocal_272, "Marshal2_ChowGringo03", "DLC_eating_dynamic", -2139.871f, 16.659f, 2630.563f, 0.0f, 80.959f, 0.0f));
		bLocal_275[2] = CREATE_ACTOR_IN_LAYOUT(bLocal_272, "Marshal2_Zombie3", 1212, -2139.871f, 16.659f, 2630.563f, 0.0f, 80.959f, 0.0f);
		SET_DRAW_ACTOR(bLocal_275[2], false);
		SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_275[2], bLocal_274, 0);
		TASK_USE_GRINGO(bLocal_275[2], bVar0, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(bLocal_275[2], GET_OBJECT_FROM_GRINGO(bVar0), "UseCase1", 1, 0, 0);
		SET_ACTOR_FACTION(bLocal_275[2], 32);
		Function_145(-2152.67f, 15.992f, 2613.229f, bLocal_285);
		iLocal_300 = 1;
	}
	return 1;
}

void Function_145(vector3 vParam0) //Position: 0x7FF5 / 32757
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!Function_40(StackVal, StackVal, vParam0))
	{
		bVar0 = GET_MOST_RECENT_MOUNT(Global_34573);
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			else if (Function_146(bVar1, Global_34573) > 4.0f)
			{
				TELEPORT_ACTOR(bVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1.5f);
				vVar3.f_8 = (vParam0.z + 1.5f);
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (bVar0 != bVar1)
			{
				...
				else if (Function_146(bVar0, Global_34573) > 4.0f)
				{
					TELEPORT_ACTOR(bVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2.5f);
					vVar3.f_8 = (vParam0.z + 2.5f);
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			...
			else if (Function_146(bVar2, Global_34573) > 8.0f)
			{
				TELEPORT_ACTOR(bVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_146(bool bParam0, bool bParam1) //Position: 0x817C / 33148
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_147(bool bParam0, float fParam1) //Position: 0x826D / 33389
{
...
void Function_148() //Position: 0x836B / 33643
{
...
void Function_149() //Position: 0x839D / 33693
{
...
int Function_150() //Position: 0x849A / 33946
{
	return 1;
}

int Function_151() //Position: 0x84A1 / 33953
{
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0, 4294967295, 4294967295, 3212836864, 0);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("MISC_HerbertMoon", bLocal_274);
	bLocal_285 = CREATE_VOLUME_IN_LAYOUT(bLocal_272, "Marshal2_CSVol", 2, -2147.343f, 16.774f, 2623.743f, 0.0f, 1.118f, 0.0f, 19.13f, 8.597f, 16.361f);
	Function_154(0, 0, 1, 1, 0, 1, 1, bLocal_285, 1, 1, 1, 1);
	Function_152(StackVal, StackVal, bLocal_272, *(&Global_63541[1655] + 112), &bLocal_285, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	DECOR_SET_BOOL(bLocal_275[0], "IsCutscene", true);
	DECOR_SET_BOOL(bLocal_275[1], "IsCutscene", true);
	DECOR_SET_BOOL(bLocal_275[2], "IsCutscene", true);
	return 1;
}

void Function_152(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x859B / 34203
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_VOLUME_VALID(*uParam4))
	{
		...
		if (!Global_3380)
		{
			...
			if (IS_ACTOR_VALID(bVar1))
			{
				Function_153(bVar1, bParam0);
			}
		}
		if (!Function_40(StackVal, StackVal, vVar2))
		{
			if (!IS_ACTOR_VALID(bVar0))
			{
...
void Function_153(bool bParam0, bool bParam1) //Position: 0x8809 / 34825
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_154(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x887E / 34942
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_157(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_3(), 2, Function_157(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
				DELETE_PROJECTILES_IN_VOLUME(bVar0);
			}
		}
		Function_128(19, 1, 0, 0);
	}
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_156()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_155(int iParam0) //Position: 0x8B2C / 35628
{
	int iVar0;
...
var Function_156() //Position: 0x8B60 / 35680
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_157(bool bParam0) //Position: 0x8BDF / 35807
{
	vector3 vVar0;
...
bool Function_158(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x8BF0 / 35824
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_161(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_160(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_160(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_159(&iVar6, &vVar3);
				}
				else
				{
...
int Function_159(int iParam0, int iParam1) //Position: 0x8E02 / 36354
{
	var uVar0;
	...
	{
		if (!Function_40(StackVal, StackVal, *iParam1))
		{
			return 1;
		}
	}
...
float Function_160(bool bParam0, bool bParam1) //Position: 0x8E6D / 36461
{
	vector3 vVar0;
...
void Function_161(bool bParam0, bool bParam1) //Position: 0x8E8C / 36492
{
	bool bVar0;
	bool bVar1;
	...
	else if (!bParam1 || Function_160(bParam0, 0) < 2.0f)
	{
...
bool Function_162(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8EE9 / 36585
{
...
bool Function_163() //Position: 0x8F9F / 36767
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_164(bool bParam0) //Position: 0x8FB6 / 36790
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_165(bool bParam0) //Position: 0x8FC1 / 36801
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_166(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) //Position: 0x8FCF / 36815
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_168(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_168(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0, 1);
...
float Function_167(float fParam0) //Position: 0x913F / 37183
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_167(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_168(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x9174 / 37236
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_171(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_172()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
		...
		if ((iParam13 && Global_3380) && CUTSCENE_MANAGER_IS_CUTFILE_LOADED())
		{
			...
			{
				if (!Function_40(StackVal, StackVal, vVar16))
				{
					if (HUD_IS_FADED())
					{
	...
	else if ((!Function_171(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_172()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_171(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_169() //Position: 0x93BA / 37818
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_170(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_170(char* cParam0, vector3 vParam1) //Position: 0x940E / 37902
{
	char* cVar0[64];
...
bool Function_171(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x9536 / 38198
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_71(bParam0);
...
int Function_172() //Position: 0x95C0 / 38336
{
	if (IS_PS3())
	{
		return 1;
...
float Function_173(int iParam0) //Position: 0x95CF / 38351
{
...
bool Function_174(int iParam0) //Position: 0x9697 / 38551
{
	return Function_47(*iParam0, 2);
}

bool Function_175(int iParam0) //Position: 0x96A4 / 38564
{
	return Function_47(*iParam0, 1);
}

void Function_176(int iParam0) //Position: 0x96B1 / 38577
{
	Function_177(iParam0, 0.0f);
	return;
}

void Function_177(var uParam0, float fParam1) //Position: 0x96BD / 38589
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_189(uParam0, 1);
	Function_103(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

int Function_178(int iParam0) //Position: 0x96DE / 38622
{
	int iVar0;
	int iVar1;
		...
		if (Function_182(iParam0[iVar03], 4))
		{
			if (!Function_182(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_182(iParam0[03], 8) || iVar1));
						break;
...
void Function_179() //Position: 0x9A59 / 39513
{
	if (!Function_88(128))
	{
		return;
...
bool Function_180() //Position: 0x9A99 / 39577
{
	int iVar0;
...
void Function_181(var uParam0, int iParam1) //Position: 0x9AC4 / 39620
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_182(int iParam0, int iParam1) //Position: 0x9AD5 / 39637
{
	int iVar0;
...
void Function_183() //Position: 0x9AF2 / 39666
{
	if (!Function_88(128))
	{
		return;
...
void Function_184() //Position: 0x9B34 / 39732
{
	if (IS_LAYOUTREF_VALID(bLocal_272))
	{
		RELEASE_LAYOUT_REF(bLocal_272);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_186(&bLocal_248);
	if (bLocal_299)
	{
	}
	Function_185(0, 0, 1);
...
int Function_185(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9B60 / 39776
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_186(int iParam0) //Position: 0x9B8F / 39823
{
	int iVar0;
...
void Function_187(var uParam0, int iParam1) //Position: 0x9BB5 / 39861
{
	if (Function_182(uParam0[iParam13], 4))
	{
		if (Function_182(uParam0[iParam13], 1))
		{
			...
			Function_188(uParam0[iParam13], 1);
			Function_188(uParam0[iParam13], 2);
			Function_188(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_188(var uParam0, int iParam1) //Position: 0x9CE3 / 40163
{
	int iVar0;
...
void Function_189(var uParam0, int iParam1) //Position: 0x9CFD / 40189
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_190(int iParam0, bool bParam1) //Position: 0x9D0C / 40204
{
	char* cVar0[32];
...
bool Function_191(int iParam0) //Position: 0x9E8C / 40588
{
...
void Function_192() //Position: 0x9EA1 / 40609
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!iLocal_301)
	{
		bVar0 = FIND_NAMED_LAYOUT("Armadillo_layout");
		if (IS_LAYOUTREF_VALID(bVar0))
		{
			bLocal_273 = CREATE_WORLD_SECTOR(bVar0, "dlc06x");
			iLocal_301 = 1;
		}
		return;
	}
	if (!IS_DOOR_VALID(bLocal_284))
	{
		bLocal_284 = Function_195("narmadillo", "sheriff", 1);
	}
	if (IS_DOOR_VALID(bLocal_284))
	{
		SET_DOOR_LOCK_VISIBLE(bLocal_284, 0);
		if (!IS_DOOR_CLOSED(bLocal_284))
		{
			if (!IS_DOOR_CLOSING(bLocal_284))
			{
				CLOSE_DOOR_FAST(bLocal_284);
			}
		}
		if (!IS_DOOR_LOCKED(bLocal_284))
		{
			Function_194(bLocal_284, 1);
		}
	}
	if (!IS_WORLD_SECTOR_LOADED(bLocal_273))
	{
		return;
	}
	iVar2 = 0;
	while (iVar2 <= 3)
	{
		if (!IS_DOOR_VALID(uLocal_280[iVar2]))
		{
			bVar1 = GET_WORLD_SECTOR_CHILD_OBJECT(bLocal_273, "dlc_arm_generalStoreProps01x", &(Local_287[iVar22]));
			if (IS_OBJECT_VALID(bVar1))
			{
				uLocal_280[iVar2] = GET_DOOR_FROM_OBJECT(bVar1);
			}
		}
		if (IS_DOOR_VALID(uLocal_280[iVar2]))
		{
			if (iVar2 != 0 || iVar2 != 1)
			{
				if (IS_DOOR_LOCKED(uLocal_280[iVar2]))
				{
					Function_193(uLocal_280[iVar2], 1);
				}
				if (!IS_DOOR_OPEN_IN_DIRECTION(uLocal_280[iVar2], iVar2 != 0))
				{
					if (IS_DOOR_OPEN_IN_DIRECTION(uLocal_280[iVar2], iVar2 != 1))
					{
						CLOSE_DOOR_FAST(uLocal_280[iVar2]);
					}
					OPEN_DOOR_DIRECTION_FAST(uLocal_280[iVar2], iVar2 != 0);
				}
			}
			else
			{
				if (!IS_DOOR_CLOSED(uLocal_280[iVar2]))
				{
					if (!IS_DOOR_CLOSING(uLocal_280[iVar2]))
					{
						CLOSE_DOOR_FAST(uLocal_280[iVar2]);
					}
				}
				if (!IS_DOOR_LOCKED(uLocal_280[iVar2]))
				{
					Function_194(uLocal_280[iVar2], 1);
				}
			}
		}
		iVar2++;
...
void Function_193(bool bParam0, bool bParam1) //Position: 0xA07A / 41082
{
...
void Function_194(bool bParam0, bool bParam1) //Position: 0xA0CB / 41163
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_195(var uParam0, var uParam1, int iParam2) //Position: 0xA11F / 41247
{
	return Function_196(Global_29006, uParam0, uParam1, iParam2);
}

int Function_196(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0xA131 / 41265
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_197(int iParam0) //Position: 0xA1CD / 41421
{
	if (!Function_73(iParam0))
	{
		return 1;
...
void Function_198(int iParam0) //Position: 0xA1E9 / 41449
{
	if (!Function_175(iParam0))
	{
		Function_177(iParam0, 0.0f);
...
var Function_199(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0xA1FE / 41470
{
	int iVar0;
	...
	{
		if (!Function_182(bParam0[iVar03], 4))
		{
			(*bParam0)[iVar03] = iParam1;
			bParam0[iVar03]->f_4 = 3;
			Function_181(bParam0[iVar03], 4);
			if (bParam3)
			{
				Function_181(bParam0[iVar03], 8);
			}
			return iVar0;
		}
...
var Function_200(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xA2CE / 41678
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_201(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_201(var uParam0, int iParam1, int iParam2) //Position: 0xA306 / 41734
{
	int iVar0;
...
void Function_202() //Position: 0xA3CA / 41930
{
	strcpy(&(Local_287[02]), "door01", 8);
	strcpy(&(Local_287[12]), "door02", 8);
	strcpy(&(Local_287[22]), "door03", 8);
	return;
}
