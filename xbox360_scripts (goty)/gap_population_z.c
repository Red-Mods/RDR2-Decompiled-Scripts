...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Gap", 4);
	Function_12("Loading Gaptooth Breach population file", 3);
	Global_30839++;
	...
	Function_10(&uVar0, 311, 4.0f, 0, 0);
	...
	Function_10(&uVar0, 250, 4.0f, 0, 0);
	Function_10(&uVar0, 66, 4.0f, 0, 0);
	Function_10(&uVar0, 67, 4.0f, 0, 0);
	Function_10(&uVar0, 69, 4.0f, 0, 0);
	Function_10(&uVar0, 65, 4.0f, 0, 0);
	Function_10(&uVar0, 71, 4.0f, 0, 0);
	Function_10(&uVar0, 72, 4.0f, 0, 0);
	Function_10(&uVar0, 298, 4.0f, 0, 0);
	Function_10(&uVar0, 288, 4.0f, 0, 0);
	Function_10(&uVar0, 153, 4.0f, 0, 0);
	Function_10(&uVar0, 154, 4.0f, 0, 0);
	Function_10(&uVar0, 486, 4.0f, 0, 0);
	Function_10(&uVar0, 487, 4.0f, 0, 0);
	Function_10(&uVar0, 489, 4.0f, 0, 0);
	Function_10(&uVar0, 490, 4.0f, 0, 0);
	Function_10(&uVar0, 491, 4.0f, 0, 0);
	Function_10(&uVar0, 493, 4.0f, 0, 0);
	Function_10(&uVar0, 1204, 5.0f, 0, 0);
	Function_10(&uVar0, 1205, 5.0f, 0, 0);
	Function_10(&uVar0, 1206, 5.0f, 0, 0);
	Function_10(&uVar0, 1207, 5.0f, 0, 0);
	Function_10(&uVar0, 1208, 5.0f, 0, 0);
	Function_10(&uVar0, 1209, 5.0f, 0, 0);
	Function_10(&uVar0, 1210, 5.0f, 0, 0);
	Function_10(&uVar0, 1211, 5.0f, 0, 0);
	Function_10(&uVar0, 1212, 5.0f, 0, 0);
	Function_10(&uVar0, 1213, 5.0f, 0, 0);
	Function_10(&uVar0, 1214, 5.0f, 0, 0);
	Function_10(&uVar0, 1215, 5.0f, 0, 0);
	Function_10(&uVar0, 1216, 5.0f, 0, 0);
	Function_10(&uVar0, 1217, 5.0f, 0, 0);
	Function_10(&uVar0, 1218, 5.0f, 0, 0);
	Function_10(&uVar0, 1219, 5.0f, 0, 0);
	Function_10(&uVar0, 1220, 5.0f, 0, 0);
	Function_10(&uVar0, 1222, 5.0f, 0, 0);
	Function_10(&uVar0, 1223, 5.0f, 0, 0);
	Function_10(&uVar0, 1224, 5.0f, 0, 0);
	Function_10(&uVar0, 1225, 5.0f, 0, 0);
	Function_10(&uVar0, 1226, 5.0f, 0, 0);
	Function_10(&uVar0, 1227, 5.0f, 0, 0);
	...
	Function_10(&(Global_30750[0]), 288, 4.0f, 0, 0);
	Function_10(&(Global_30750[0]), 51, 4.0f, 0, 0);
	Function_10(&(Global_30750[0]), 289, 4.0f, 0, 0);
	...
	Function_10(&(Global_30750[0]), 311, 4.0f, 0, 0);
	...
	bVar2 = FIND_NAMED_LAYOUT("GaptoothBreach_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "gap_zombie_01");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 30, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("GAP_Pop: Cannot find gap_zombie_01 to create population volumes");
		}
	}
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "gap_zombie_02");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 30, 0, 0, 1);
		}
		...
		{
			LOG_ERROR("GAP_Pop: Cannot find gap_zombie_02 to create population volumes");
		}
	}
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "gap_zombie_03");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 3, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("GAP_Pop: Cannot find gap_zombie_03 to create population volumes");
		}
	}
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "gap_zombie_04");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 5, 10, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("GAP_Pop: Cannot find gap_zombie_04 to create population volumes");
		}
	}
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "gap_zombie_05");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 5, 10, 0, 0, 1);
		}
		...
		{
			LOG_ERROR("GAP_Pop: Cannot find gap_zombie_05 to create population volumes");
		}
	}
	END_POPULATION_DEFINITION();
	Global_30839 = (Global_30839 - 1);
...
void Function_1(var uParam0, var uParam1) //Position: 0xEBF / 3775
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xECE / 3790
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xF23 / 3875
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xFA5 / 4005
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xFC1 / 4033
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xFFF / 4095
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x101B / 4123
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x102B / 4139
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0x1070 / 4208
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x107C / 4220
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0x10F8 / 4344
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0x1105 / 4357
{
	if (!Function_4(128))
	{
		return;
