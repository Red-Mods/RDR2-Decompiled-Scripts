...
void Function_2(int iParam0) //Position: 0x73 / 115
{
	Function_3(iParam0);
	return;
}

void Function_3(int iParam0) //Position: 0x7E / 126
{
	var uVar0;
...
int Function_4(int iParam0) //Position: 0xA2 / 162
{
...
bool Function_5(int iParam0) //Position: 0xBD / 189
{
...
void Function_6() //Position: 0xD4 / 212
{
	int iVar0;
	int iVar1;
	char* cVar2[64];
...
void Function_7(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0x31B / 795
{
	*uParam3 = (bParam0 && 15);
...
bool Function_8(int iParam0) //Position: 0x344 / 836
{
	if (!Function_5(iParam0))
	{
		return 0;
...
bool Function_9(int iParam0) //Position: 0x368 / 872
{
...
bool Function_10(int iParam0) //Position: 0x37D / 893
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_11() //Position: 0x39E / 926
{
	return;
}

void Function_12(int iParam0) //Position: 0x3A4 / 932
{
...
bool Function_13(var uParam0, bool bParam1) //Position: 0x3D1 / 977
{
	return (uParam0 && bParam1) == 0;
}

void Function_14() //Position: 0x3DE / 990
{
...
bool Function_15() //Position: 0x431 / 1073
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_16(var uParam0) //Position: 0x43A / 1082
{
	Global_26316.f_56 = (Global_26316.f_56 || uParam0);
	return;
}

var Function_17() //Position: 0x44D / 1101
{
...
void Function_18(int iParam0) //Position: 0x462 / 1122
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	Function_21(*iParam0);
	vVar0 = { StackVal, StackVal, Function_21(*iParam0) };
	...
	Function_20(*iParam0);
	vVar0 = { StackVal, StackVal, Function_20(*iParam0) };
	...
	while (iVar4 <= 3)
	{
		Function_19(*iParam0, iVar4);
		vVar0 = { StackVal, StackVal, Function_19(*iParam0, iVar4) };
...
vector3 Function_19(int iParam0, int iParam1) //Position: 0x69D / 1693
{
...
vector3 Function_20(int iParam0) //Position: 0x883 / 2179
{
	if (iParam0 == Global_30640[0])
	{
...
vector3 Function_21(int iParam0) //Position: 0x955 / 2389
{
	if (iParam0 == Global_30640[0])
	{
...
bool Function_22() //Position: 0xA23 / 2595
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_36(Global_30640[0]))
			{
				iLocal_12 = Function_35(Local_5);
				if (iLocal_12 <= 1)
				{
					iLocal_12 = 1;
				}
				if (Function_33() <= iLocal_12)
				{
					Function_30("FiveFingerFillet_NotEnoughMoney", 4.0f, 0, 2, 1, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_29(Global_30640[0], &iLocal_24 + 4, &iLocal_24 + 24, &iLocal_24 + 28))
			{
				Function_28(&(Global_30640[0]));
				Function_27(&iLocal_24 + 4);
				Function_21(Global_30640[0]);
				*(&iLocal_24 + 156[03]) = { StackVal, StackVal, Function_21(Global_30640[0]) };
				Function_20(Global_30640[0]);
				*(&iLocal_24 + 156[13]) = { StackVal, StackVal, Function_20(Global_30640[0]) };
				iLocal_24 = Local_5;
				Function_26(Local_5, 0);
		...
		case 0x00000065:
			if (Function_25(Local_5, 0))
			{
				bLocal_2 = true;
			}
			else if (Function_24(Local_5))
			{
				bLocal_3 = true;
			}
			else
...
void Function_23() //Position: 0xBBA / 3002
{
	Function_1();
	return;
}

bool Function_24(int iParam0) //Position: 0xBC3 / 3011
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_25(int iParam0, bool bParam1) //Position: 0xBE4 / 3044
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_26(int iParam0, int iParam1) //Position: 0xC1A / 3098
{
	if (!Function_8(iParam0))
	{
		return;
...
void Function_27(int iParam0) //Position: 0xC35 / 3125
{
	int iVar0;
	bool bVar1;
...
void Function_28(int iParam0) //Position: 0xC8A / 3210
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
bool Function_29(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0xEC8 / 3784
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	while (iVar5 <= 3)
	{
		Function_19(iParam0, iVar5);
		vVar0 = { StackVal, StackVal, Function_19(iParam0, iVar5) };
	...
	*uParam3 = iVar4;
	Function_20(iParam0);
	vVar6 = { StackVal, StackVal, Function_20(iParam0) };
...
void Function_30(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x11F4 / 4596
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_31(int iParam0) //Position: 0x126B / 4715
{
	char* cVar0[16];
...
bool Function_32() //Position: 0x12AA / 4778
{
...
int Function_33() //Position: 0x12C5 / 4805
{
	return Function_34(0);
}

int Function_34(int iParam0) //Position: 0x12CF / 4815
{
...
var Function_35(int iParam0) //Position: 0x1310 / 4880
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_36(int iParam0) //Position: 0x132A / 4906
{
...
int Function_37(var uParam0, int iParam1) //Position: 0x1346 / 4934
{
	int iVar0;
...
bool Function_38(int iParam0) //Position: 0x1362 / 4962
{
...
void Function_39() //Position: 0x1378 / 4984
{
	Function_1();
	return;
}

void Function_40() //Position: 0x1381 / 4993
{
	bLocal_4 = CREATE_LAYOUT(Function_50());
	Function_49(1);
	Function_49(2);
	Function_47(0, 1);
	Function_46();
...
void Function_41(int iParam0) //Position: 0x13D5 / 5077
{
...
void Function_42(var uParam0, float fParam1) //Position: 0x13EA / 5098
{
...
void Function_43(var uParam0, int iParam1) //Position: 0x140B / 5131
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x141E / 5150
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_45(var uParam0) //Position: 0x142D / 5165
{
	return Function_13(*uParam0, 1);
}

void Function_46() //Position: 0x143A / 5178
{
	return;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x1440 / 5184
{
	bool bVar0;
...
void Function_48(int iParam0) //Position: 0x1497 / 5271
{
	int iVar0;
...
void Function_49(int iParam0) //Position: 0x14B4 / 5300
{
	int iVar0;
...
var Function_50() //Position: 0x14E8 / 5352
{
	var uVar0;
