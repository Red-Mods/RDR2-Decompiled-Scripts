...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Emt", 4);
	Function_12("Loading El Matadero population file", 3);
	Global_30839++;
	BEGIN_POPULATION_DEFINITION();
	uVar0 = Function_11("ped_generic", 0);
	Function_10(&uVar0, 240, 4.0f, 0, 0);
	Function_10(&uVar0, 241, 4.0f, 0, 0);
	Function_10(&uVar0, 295, 4.0f, 0, 0);
	Function_10(&uVar0, 296, 4.0f, 0, 0);
	Function_10(&uVar0, 313, 4.0f, 0, 0);
	Function_10(&uVar0, 269, 4.0f, 0, 0);
	Function_10(&uVar0, 270, 4.0f, 0, 0);
	Function_10(&uVar0, 271, 4.0f, 0, 0);
	Function_10(&uVar0, 272, 4.0f, 0, 0);
	Function_10(&uVar0, 311, 4.0f, 0, 0);
	Function_10(&uVar0, 279, 4.0f, 0, 0);
	Function_10(&uVar0, 284, 4.0f, 0, 0);
	Function_10(&uVar0, 287, 4.0f, 0, 0);
	Function_10(&uVar0, 292, 4.0f, 0, 0);
	Function_10(&uVar0, 297, 4.0f, 0, 0);
	Function_10(&uVar0, 299, 4.0f, 0, 0);
	Function_10(&uVar0, 314, 4.0f, 0, 0);
	Function_10(&uVar0, 317, 4.0f, 0, 0);
	Function_10(&uVar0, 322, 4.0f, 0, 0);
	Function_10(&uVar0, 323, 4.0f, 0, 0);
	...
	bVar2 = FIND_NAMED_LAYOUT("ElMataderoTown_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_Cell2");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 1, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("emt_pop: Cannot find emtv_Cell2 to create population volumes");
		}
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_cave1");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 1, 10, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("emt_pop: Cannot find emtv_Cave1 to create population volumes");
		}
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_cave2");
		if (IS_VOLUME_VALID(bVar3))
		{
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_region");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 20, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("agvv_pop: Cannot find henv_region to create population volumes");
		}
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_zombies_01");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 20, 0, 0, 1);
		}
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_zombies_02");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 5, 10, 0, 0, 1);
		}
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_zombies_03");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 5, 10, 0, 0, 1);
		}
		...
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "emtv_zombies_04");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 5, 10, 0, 0, 1);
		}
...
void Function_1(var uParam0, var uParam1) //Position: 0xF2A / 3882
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xF39 / 3897
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xF8E / 3982
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0x1010 / 4112
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0x102C / 4140
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x106A / 4202
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x1086 / 4230
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1096 / 4246
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0x10DB / 4315
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x10E7 / 4327
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0x1163 / 4451
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0x1170 / 4464
{
	if (!Function_4(128))
	{
		return;
