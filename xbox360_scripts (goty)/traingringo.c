...
bool Function_30(int iParam0) //Position: 0x1D62 / 7522
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D6D / 7533
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D87 / 7559
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DA5 / 7589
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DC4 / 7620
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x1E16 / 7702
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E30 / 7728
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E43 / 7747
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x212B / 8491
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2133 / 8499
{
...
bool Function_42(bool bParam0, int iParam1) //Position: 0x215F / 8543
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2181 / 8577
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21A5 / 8613
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21C2 / 8642
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21E2 / 8674
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2202 / 8706
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22B0 / 8880
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2320 / 8992
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2336 / 9014
{
...
var Function_51(bool bParam0) //Position: 0x2357 / 9047
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2377 / 9079
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x238B / 9099
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2395 / 9109
{
	return 0;
}

void Function_55(var uParam0, int iParam1) //Position: 0x239C / 9116
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23AB / 9131
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23EA / 9194
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2415 / 9237
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2420 / 9248
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2516 / 9494
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2538 / 9528
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x255F / 9567
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x2569 / 9577
{
	iParam0 = iParam0;
	return;
}

bool Function_64(bool bParam0) //Position: 0x2573 / 9587
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2591 / 9617
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x25A6 / 9638
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x262D / 9773
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2650 / 9808
{
	vector3 vVar0;
...
bool Function_69(bool bParam0) //Position: 0x266E / 9838
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x2691 / 9873
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_71(bool bParam0, int iParam1) //Position: 0x27AC / 10156
{
...
int Function_72(bool bParam0) //Position: 0x27D7 / 10199
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x28DC / 10460
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x28E9 / 10473
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x295C / 10588
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x2E5A / 11866
{
	return;
}

bool Function_77(bool bParam0) //Position: 0x2E60 / 11872
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2E7D / 11901
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
bool Function_80(bool bParam0) //Position: 0x2EBF / 11967
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2EE0 / 12000
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_ATTACHMENT_VALID(iLocal_1))
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F3D / 12093
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3045 / 12357
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x305B / 12379
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x3311 / 13073
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x331F / 13087
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x3338 / 13112
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x3352 / 13138
{
	bool bVar0;
	char* cVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x338A / 13194
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x33A1 / 13217
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x366A / 13930
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3687 / 13959
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x3723 / 14115
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3742 / 14146
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3751 / 14161
{
...
void Function_96(int iParam0) //Position: 0x376D / 14189
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3777 / 14199
{
	int iVar0;
	int iVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x37D9 / 14297
{
...
void Function_99(int iParam0) //Position: 0x37ED / 14317
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_100(int iParam0) //Position: 0x3853 / 14419
{
