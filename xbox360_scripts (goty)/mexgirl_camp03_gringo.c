...
{
	ENABLE_MOVER(bLocal_13);
	RELEASE_LAYOUT_REF(bLocal_16);
	Function_4(8, bLocal_13, bLocal_14, &bLocal_3, cLocal_15, 4294967295);
	return;
}

void Function_4(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x217 / 535
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_5(bool bParam0, bool bParam1) //Position: 0x634 / 1588
{
...
int Function_6(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x663 / 1635
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_7(bool bParam0) //Position: 0x981 / 2433
{
	bool bVar0;
...
void Function_8(bool bParam0) //Position: 0x9AD / 2477
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_9(int iParam0) //Position: 0x9C2 / 2498
{
...
void Function_10(var uParam0, int iParam1) //Position: 0x9EE / 2542
{
	int iVar0;
...
bool Function_11(var uParam0, bool bParam1) //Position: 0xA05 / 2565
{
	int iVar0;
...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0xA21 / 2593
{
	int iVar0;
	bool bVar1;
...
bool Function_13(bool bParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5) //Position: 0xADB / 2779
{
	float fVar0;
...
void Function_14(bool bParam0) //Position: 0xC72 / 3186
{
...
bool Function_16(var uParam0, int iParam1) //Position: 0xCBD / 3261
{
	return (uParam0 && iParam1) == 0;
}

var Function_17(bool bParam0, bool bParam1) //Position: 0xCCA / 3274
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_18(bool bParam0, bool bParam1) //Position: 0xDBB / 3515
{
	bool bVar0;
	bool bVar1;
...
bool Function_19(bool bParam0, bool bParam1) //Position: 0xE12 / 3602
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_20(bool bParam0) //Position: 0xE6B / 3691
{
	bool bVar0;
...
int Function_21(int iParam0) //Position: 0xE9D / 3741
{
	int iVar0;
	var uVar1;
	var uVar2;
...
float Function_22(bool bParam0, vector3 vParam1) //Position: 0x1073 / 4211
{
	vector3 vVar0;
...
vector3 Function_23(bool bParam0) //Position: 0x10ED / 4333
{
	vector3 vVar0;
...
void Function_24(int iParam0) //Position: 0x1157 / 4439
{
	int iVar0;
...
void Function_25(var uParam0, int iParam1) //Position: 0x117D / 4477
{
...
void Function_26(var uParam0, int iParam1) //Position: 0x12AB / 4779
{
	int iVar0;
...
bool Function_27(var uParam0, bool bParam1) //Position: 0x12C5 / 4805
{
	int iVar0;
...
var Function_28(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x12E2 / 4834
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_17 || bParam2) || Global_3370)
			{
				...
				{
					if (((!bParam2 && !Function_148(iParam0 + 200, &fLocal_19, 256, 0)) && !Global_3370) && !Function_155())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_137(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_19, 20.0f, fLocal_19);
		...
		case 0x0000000B:
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_20, iParam0 + 312, 0, 0, 0x40400000))
						{
...
void Function_29(int iParam0) //Position: 0x22E0 / 8928
{
...
void Function_30(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x22F0 / 8944
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_31(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x24EE / 9454
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_32(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2508 / 9480
{
	bool bVar0;
	bool bVar1;
...
int Function_33(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x25E8 / 9704
{
	char* cVar0[32];
...
int Function_34(bool bParam0) //Position: 0x2836 / 10294
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_35(bool bParam0, bool bParam1) //Position: 0x2859 / 10329
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_36(bool bParam0, bool bParam1) //Position: 0x287C / 10364
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_37(bool bParam0, bool bParam1) //Position: 0x28A0 / 10400
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_38(bool bParam0, bool bParam1) //Position: 0x28C6 / 10438
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_39(bool bParam0) //Position: 0x28E9 / 10473
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_40() //Position: 0x2907 / 10503
{
...
bool Function_41(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2951 / 10577
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x29A3 / 10659
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_43(bool bParam0, bool bParam1) //Position: 0x29BF / 10687
{
	bool bVar0;
	bool bVar1;
...
void Function_44(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2A11 / 10769
{
	bool bVar0;
	bool bVar1;
...
var Function_45() //Position: 0x2A56 / 10838
{
...
void Function_46(int iParam0, bool bParam1, bool bParam2) //Position: 0x2A6B / 10859
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x2B8E / 11150
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_48(vector3 vParam0) //Position: 0x2BFC / 11260
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(bool bParam0) //Position: 0x2C14 / 11284
{
	bool bVar0;
	bool bVar1;
...
var Function_50(bool bParam0) //Position: 0x2C6B / 11371
{
	bool bVar0;
	bool bVar1;
...
void Function_51(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2CB1 / 11441
{
	bool bVar0;
	bool bVar1;
...
void Function_52(bool bParam0, bool bParam1) //Position: 0x2D1F / 11551
{
	bool bVar0;
	bool bVar1;
...
void Function_53(bool bParam0) //Position: 0x2D67 / 11623
{
	struct<21> Var0;
...
bool Function_54() //Position: 0x2E25 / 11813
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

var Function_55(int iParam0) //Position: 0x2E38 / 11832
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_56(int iParam0) //Position: 0x2EE9 / 12009
{
...
bool Function_57(int iParam0) //Position: 0x2F08 / 12040
{
...
bool Function_58(int iParam0) //Position: 0x2F2C / 12076
{
...
bool Function_59(int iParam0) //Position: 0x2F41 / 12097
{
...
bool Function_60(int iParam0, bool bParam1) //Position: 0x2F58 / 12120
{
	int iVar0;
...
var Function_61(int iParam0) //Position: 0x2F95 / 12181
{
...
bool Function_62(int iParam0) //Position: 0x2FAF / 12207
{
...
int Function_63(int iParam0, int iParam1) //Position: 0x2FC5 / 12229
{
	int iVar0;
...
void Function_64(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x2FFE / 12286
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_65(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x30CB / 12491
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_66(bool bParam0, bool bParam1) //Position: 0x3262 / 12898
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x3284 / 12932
{
	bool bVar0;
	bool bVar1;
...
var Function_68(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x32C8 / 13000
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_69(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x3411 / 13329
{
	var uVar0[5];
	int iVar6;
...
int Function_70(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x34B2 / 13490
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3546 / 13638
{
	Function_101(&bLocal_3, "sobbing", 5, 0);
	Function_101(&bLocal_3, "custom/sobbing", 8, 0);
	Function_145(&bLocal_3, 1199, 3, 0);
	if (Function_82(&bLocal_13, &bLocal_3, 35, 1, 1, 0, 0, 0, 0, 0, 0))
	{
		if (Function_80(&bLocal_16, "mexgirl03mobile", iParam1))
		{
			bLocal_14 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_16, Function_137()));
			Global_3422[3540].f_156 = bLocal_14;
...
void Function_72() //Position: 0x35DD / 13789
{
	vector3 vVar0;
	bool bVar3;
	
	cLocal_15 = CREATE_LAYOUT("mexgirlcamp01campfirelayout");
	vVar0 = { -2146.16f, 18.261f, 4964.794f };
	TELEPORT_ACTOR_WITH_HEADING(bLocal_13, vVar0, 0.0f, 1, 1, 1);
	SUSPEND_MOVER(bLocal_13);
	TASK_STAND_STILL(bLocal_13, -1.0f, 0, 0);
	SET_ANIM_SET_FOR_ACTOR(bLocal_13, "sobbing", 0);
	SET_ACTION_NODE_FOR_ACTOR(bLocal_13, "sobbing/sobbing");
	Function_78(bLocal_13, &bLocal_14, 1, 0);
	if (!Function_77("MexGirl03Wagon", &bVar3, cLocal_15, 0))
	{
		bVar3 = Function_73(cLocal_15, "MexGirl03Wagon", 1199, 977, -2169.263f, 17.372f, 4944.214f, 0.0f, -3.0f, 0.0f, 1, 976, 976, 976, 4);
	}
	Function_78(bVar3, &bLocal_14, 1, 1);
	return;
}

var Function_73(bool bParam0, bool bParam1, bool bParam2, int iParam3, vector3 vParam4, vector3 vParam7, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14) //Position: 0x36CA / 14026
{
	bool bVar0;
	int iVar1[6];
	bool bVar8;
...
bool Function_74(int iParam0, int iParam1) //Position: 0x38FE / 14590
{
	int iVar0;
...
var Function_75(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x3930 / 14640
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(bParam0, bParam4, bParam5, bParam6, 1, vParam1);
}

int Function_76(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x3948 / 14664
{
...
bool Function_77(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x396F / 14703
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_78(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x3A7C / 14972
{
	bool bVar0;
	bool bVar1;
...
bool Function_79(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3C06 / 15366
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_80(var uParam0, char* cParam1, int iParam2) //Position: 0x3C46 / 15430
{
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x3C71 / 15473
{
	int iVar0;
...
bool Function_82(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x3CB3 / 15539
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_83(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3E7C / 15996
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x4389 / 17289
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_85(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x43A9 / 17321
{
	bool bVar0;
...
int Function_86(bool bParam0, bool bParam1) //Position: 0x43FD / 17405
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x447D / 17533
{
	Function_89(bParam0);
	Function_88(bParam0);
...
void Function_88(bool bParam0) //Position: 0x44A3 / 17571
{
...
void Function_89(bool bParam0) //Position: 0x44C7 / 17607
{
...
bool Function_90(bool bParam0) //Position: 0x4596 / 17814
{
...
int Function_91(int iParam0, bool bParam1) //Position: 0x45AD / 17837
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x4640 / 17984
{
	bool bVar0;
	bool bVar1;
...
void Function_93(bool bParam0) //Position: 0x4737 / 18231
{
	bool bVar0;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x4763 / 18275
{
	int iVar0;
...
bool Function_95(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x477F / 18303
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_96() //Position: 0x4809 / 18441
{
	bool bVar0;
	bool bVar1;
...
bool Function_97(int iParam0) //Position: 0x486E / 18542
{
...
bool Function_98(bool bParam0) //Position: 0x488A / 18570
{
...
var Function_99(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x48A0 / 18592
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_100(int iParam0) //Position: 0x4940 / 18752
{
	bool bVar0;
	int iVar1;
...
var Function_101(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A3A / 19002
{
	int iVar0;
	int iVar1;
...
void Function_102(var uParam0, int iParam1) //Position: 0x4A72 / 19058
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_103(var uParam0, int iParam1, int iParam2) //Position: 0x4A83 / 19075
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x4B47 / 19271
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x4EC2 / 20162
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x4F02 / 20226
{
	int iVar0;
...
void Function_107() //Position: 0x4F2D / 20269
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(int iParam0, bool bParam1) //Position: 0x4F6F / 20335
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4FF3 / 20467
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x501C / 20508
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x506D / 20589
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x507D / 20605
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5091 / 20625
{
	int iVar0;
...
var Function_114() //Position: 0x50B6 / 20662
{
	return "PackedMetadata";
}

void Function_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x50CD / 20685
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_116() //Position: 0x51F8 / 20984
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_117() //Position: 0x5209 / 21001
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_118() //Position: 0x521A / 21018
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_119(var uParam0, int iParam1) //Position: 0x522B / 21035
{
...
var Function_120(var uParam0, int iParam1, bool bParam2) //Position: 0x524E / 21070
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x526D / 21101
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122() //Position: 0x5279 / 21113
{
	return Function_123(39);
}

int Function_123(bool bParam0) //Position: 0x5284 / 21124
{
	bool bVar0;
...
var Function_124() //Position: 0x52B2 / 21170
{
	return "PackedWeapon";
}

int Function_125(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x52C7 / 21191
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_126() //Position: 0x53CB / 21451
{
	return "MPItemGiver";
}

struct<32> Function_127(bool bParam0) //Position: 0x53DF / 21471
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5449 / 21577
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5468 / 21608
{
	return "PBox_";
}

var Function_130() //Position: 0x5476 / 21622
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x549C / 21660
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x54C4 / 21700
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x54EA / 21738
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x564B / 22091
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x56E6 / 22246
{
	int iVar0;
	vector3 vVar1;
...
void Function_136(int iParam0) //Position: 0x5847 / 22599
{
...
var Function_137() //Position: 0x58A8 / 22696
{
	int iVar0;
...
var Function_138(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x58B0 / 22704
{
	return Function_139(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_139(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x58C9 / 22729
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x5BBC / 23484
{
	int iVar0;
...
void Function_141() //Position: 0x5C70 / 23664
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x5CAA / 23722
{
	int iVar0;
...
void Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5CD7 / 23767
{
	bool bVar0;
...
void Function_144() //Position: 0x5E28 / 24104
{
	int iVar0;
...
var Function_145(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5E73 / 24179
{
	int iVar0;
...
int Function_146() //Position: 0x5F43 / 24387
{
	int iVar0;
...
int Function_147() //Position: 0x609F / 24735
{
	int iVar0;
...
bool Function_148(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x61BF / 25023
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_149(var uParam0, int iParam1) //Position: 0x628F / 25231
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_150(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x62AD / 25261
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_151(bool bParam0) //Position: 0x63DF / 25567
{
	bool bVar0;
...
bool Function_152(int iParam0) //Position: 0x63FE / 25598
{
	int iVar0;
...
int Function_153() //Position: 0x641A / 25626
{
	if (Function_155())
	{
...
int Function_154() //Position: 0x6433 / 25651
{
	return Global_79349.f_16;
}

bool Function_155() //Position: 0x643F / 25663
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_156(int iParam0, bool bParam1, bool bParam2) //Position: 0x6448 / 25672
{
	var uVar0;
