...
var Function_11(int iParam0) //Position: 0x561 / 1377
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LAYOUTREF_VALID(bVar4))
	{
		...
		SNAP_ACTOR_TO_GRINGO(bVar5, GET_OBJECT_FROM_GRINGO(bVar0), "UseCase1", 1, 0, 0);
...
int Function_15(int iParam0, int iParam1) //Position: 0x80B / 2059
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_16(int iParam0) //Position: 0x84A / 2122
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_23(bool bParam0, bool bParam1, int iParam2) //Position: 0xB1B / 2843
{
	...
	uVar1 = GRINGO_GET_ATTRIBUTE(bVar0, bParam0);
	if (!GRINGO_GET_VECTOR_ATTR_BY_HANDLE(uVar1, iParam2))
	{
		Function_24();
...
void Function_29(int iParam0) //Position: 0x1075 / 4213
{
	...
	PLAY_SOUND_FROM_OBJECT(TRAIN_GET_CAR(*iParam0, 0), "TRAIN_BELL_MASTER");
...
void Function_30(int iParam0) //Position: 0x11E1 / 4577
{
	...
	if ((7 != iParam0->f_376 || 0 != iParam0->f_376) || 2 != iParam0->f_376)
	{
		if (!Function_41(iParam0 + 104))
		{
			...
			if (TRAIN_GET_LOD_LEVEL(*iParam0) != 1 && TRAIN_GET_NUM_CARS(*iParam0) < 0)
			{
				PLAY_SOUND_FROM_OBJECT(TRAIN_GET_CAR(*iParam0, 0), "TRAIN_BELL_ALL_A_BOARD_MASTER");
			}
			if (IS_ACTOR_VALID(StackVal))
			{
		...
		if (!iParam0->f_644 && Function_33(iParam0 + 104) < 16.0f)
		{
			...
			if (TRAIN_GET_LOD_LEVEL(*iParam0) != 1 && TRAIN_GET_NUM_CARS(*iParam0) < 0)
			{
				PLAY_SOUND_FROM_OBJECT(TRAIN_GET_CAR(*iParam0, 0), "TRAIN_BELL_DEPART_MASTER");
			}
		}
...
void Function_45(int iParam0, int iParam1) //Position: 0x19D0 / 6608
{
	bool bVar0;
...
var Function_48(int iParam0) //Position: 0x1C57 / 7255
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_49(int iParam0) //Position: 0x1CE2 / 7394
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_50(int iParam0) //Position: 0x1D8C / 7564
{
	if (!Function_51(iParam0, "TRAIN_HAS_BEEN_STOLEN"))
	{
		return 0;
	}
	if (!TRAIN_GET_NUM_CARS(iParam0) < 0)
					...
					else if (Function_31(iParam0 + 104, 75.0f))
					{
						while (GET_ACTORSET_SIZE(iParam0->f_608) != 0)
						{
							...
							else
							{
								...
								TASK_GO_TO_COORD(bVar13, &vVar23, 1);
						...
						while (GET_ACTORSET_SIZE(iParam0->f_612) != 0)
						{
							...
							else
							{
								...
								TASK_GO_TO_COORD(bVar13, &vVar28, 1);
								RELEASE_ACTOR_AS_AMBIENT(bVar13);
							}
						}
					}
...
int Function_57(int iParam0, bool bParam1, bool bParam2) //Position: 0x2CD2 / 11474
{
	...
	TASK_GO_TO_COORD(false, &iVar2, 1);
...
void Function_62(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3044 / 12356
{
	if (IS_ACTOR_VALID(bParam0))
	{
