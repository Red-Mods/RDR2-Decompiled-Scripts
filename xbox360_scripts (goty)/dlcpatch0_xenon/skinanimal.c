...
void main() //Position: 0x0 / 0
{
	...
	iLocal_53 = 0;
	Function_166(uScriptParam_0, &iLocal_53);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_155(&(Local_40[iVar312]), &bVar4))
						{
							Function_153(GRINGO_GET_REQUESTING_ACTOR(), Local_40[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_142("eGRINGO_EndUse: Stop use by request", Local_40[iVar312].f_16);
							Function_141(Local_40[iVar312].f_16, 1);
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_60))
								{
									...
									{
										bLocal_60 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_60 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
int Function_8(int iParam0, int iParam1) //Position: 0x896 / 2198
{
	return Function_9(iParam0, "UseQuit", iParam1);
}

int Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x8AD / 2221
{
	int iVar0;
	bool bVar1;
	
	bVar1 = GET_GRINGO_STRING_ATTR(iParam1, iParam0, &iVar0);
	*iParam2 = iVar0 < 0;
	if (*iParam2)
	{
...
bool Function_16(int iParam0) //Position: 0xA4F / 2639
{
	...
	{
		Function_142("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_142("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_142("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000001:
			...
			if (Function_104(iParam0->f_40, 1))
			{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, 1, Function_66());
				}
		...
		case 0x00000004:
			...
			else if (bVar12)
			{
				if (GRINGO_PLAY_ANIM_ON_ACTOR(iParam0->f_16, bVar0, bVar33))
				{
					...
					{
						iVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar11, iParam0->f_12);
						if (GRINGO_ATTACH_PROP_TO_ANIM(iParam0->f_16, iVar1, Function_9(iVar1, "AttachBone", &bVar10), Function_9(iVar1, "AttachLocator", &bVar10), 1))
						{
							Function_59(iVar1, iParam0->f_16);
							if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
							{
								bVar34 = GRINGO_GET_PROP_FROM_COMPONENT(iVar1);
						...
						if (GRINGO_IS_ATTRIBUTE_VALID(uVar15))
						{
							if (GRINGO_GET_ATTR_TYPE_BY_HANDLE(uVar15) == 2)
							{
								if (iVar23 == GRINGO_GET_ATTRIBUTE_HASH(uVar15))
								{
									...
									while (iVar11 >= 4294967295)
									{
										iVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar11, GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 0));
										if (GRINGO_ATTACH_PROP_TO_ANIM(iParam0->f_16, iVar1, Function_9(iVar1, "AttachBone", &bVar10), Function_9(iVar1, "AttachLocator", &bVar10), 1))
										{
											if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
											{
												bVar35 = GRINGO_GET_PROP_FROM_COMPONENT(iVar1);
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_51(iParam0, bVar8, &iLocal_58, &uLocal_57);
				...
				iVar37 = Function_9(iParam0->f_12, "CustomReactNode", &bVar36);
				if (bVar36)
				{
					SET_REACT_NODE_FOR_ACTOR(iParam0->f_16, iVar37);
				}
				iVar38 = 1;
					...
					if (IS_GRINGO_COMPONENT_VALID(bVar41))
					{
						...
						else
						{
							...
							if (iVar43 >= 0)
							{
								...
								{
									DECOR_SET_FLOAT(GRINGO_GET_MY_OBJECT_REF(), "Gringo_SpeechTime", GET_CURRENT_GAME_TIME());
									bVar51 = RAND_INT_RANGE(0, (iVar43 - 1));
...
void Function_17(bool bParam0, int iParam1) //Position: 0x1BA3 / 7075
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1BB8 / 7096
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1BC6 / 7110
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BF7 / 7159
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C6B / 7275
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CDD / 7389
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CEB / 7403
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1D01 / 7425
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1D0E / 7438
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_26(bool bParam0, int iParam1) //Position: 0x1D2E / 7470
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (DECOR_CHECK_EXIST(bParam0, "Skinning_TriggerCam") && !Function_104(iLocal_3, 16))
	{
		...
		END_CURRENT_TRANSITION_FROM_CUTSCENEOBJECT(uLocal_36);
...
void Function_27() //Position: 0x1FF6 / 8182
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
	...
	if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()), "skin"))
	{
		...
		SNAP_OBJECT_TO_GROUND(bVar6, 3.5f, 1, 1092616192);
		RELEASE_OBJECT_REF(bVar6);
		if (!bLocal_4)
		{
			if (4294967295 != iLocal_13)
			{
				SET_OBJECT_COLLIDE_WITH_OBJECT(Global_34573, GRINGO_GET_TARGET(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF())), 0);
			}
		}
		CREATE_DECAL(2, vVar0, fVar7, 1, 1);
		vVar0.x = (vVar0.x + fVar8);
		CREATE_DECAL(3, vVar0, fVar7, 1, 1);
	}
	return;
}

vector3 Function_28(bool bParam0) //Position: 0x2369 / 9065
{
	vector3 vVar0;
...
vector3 Function_29(bool bParam0) //Position: 0x2390 / 9104
{
	vector3 vVar0;
...
bool Function_30(int iParam0, int iParam1) //Position: 0x23B7 / 9143
{
...
bool Function_31(int iParam0, float fParam1) //Position: 0x23CF / 9167
{
	if (Function_14(iParam0))
	{
...
var Function_32() //Position: 0x23EB / 9195
{
	int iVar0;
...
int Function_33(int iParam0) //Position: 0x23F3 / 9203
{
	int iVar0;
	int iVar1;
		...
		if (Function_38(iParam0[iVar03], 4))
		{
			if (!Function_38(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], 1, (Function_38(iParam0[03], 8) || iVar1));
						break;
...
void Function_34() //Position: 0x276E / 10094
{
	if (!Function_35(128))
	{
		return;
...
bool Function_35(int iParam0) //Position: 0x27AE / 10158
{
	int iVar0;
...
bool Function_36() //Position: 0x27CA / 10186
{
	int iVar0;
...
void Function_37(var uParam0, int iParam1) //Position: 0x27F5 / 10229
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_38(int iParam0, int iParam1) //Position: 0x2806 / 10246
{
	int iVar0;
...
void Function_39() //Position: 0x2823 / 10275
{
	if (!Function_35(128))
	{
		return;
...
bool Function_40(bool bParam0) //Position: 0x2865 / 10341
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_41() //Position: 0x2884 / 10372
{
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x288A / 10378
{
	int iVar0;
	...
	if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()), "skin"))
	{
		iVar0 = GET_CORPSE_ACTOR_ENUM(GET_TARGET_OBJECT());
		if (!bLocal_4)
		{
...
bool Function_43(int iParam0) //Position: 0x28CB / 10443
{
	iParam0 = iParam0;
	return 1;
}

bool Function_44(bool bParam0) //Position: 0x28D6 / 10454
{
	return Function_7(bParam0, "OneShotKill", 0);
}

int Function_45(int iParam0, int iParam1) //Position: 0x28F0 / 10480
{
	return Function_9(iParam0, "ParentAnimNode", iParam1);
}

bool Function_46(char* cParam0) //Position: 0x290E / 10510
{
	return Function_7(cParam0, "LinkToParentAnim", 0);
}

bool Function_47(bool bParam0) //Position: 0x292D / 10541
{
	int iVar0;
	int iVar1;
...
bool Function_48(char* cParam0) //Position: 0x2960 / 10592
{
	return Function_7(cParam0, "LinkParentToAnim", 0);
}

bool Function_49(char* cParam0) //Position: 0x297F / 10623
{
	return Function_7(cParam0, "SingularUse", 0);
}

void Function_50(int iParam0, int iParam1) //Position: 0x2999 / 10649
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_51(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x29AC / 10668
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_52(uParam0->f_12, &iVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_32(), Function_52(uParam0->f_12, &iVar10), 0, bVar9);
	}
	if (IS_GRINGO_COMPONENT_VALID(bVar4))
	{
		...
		cVar13 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar4);
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bParam1, uVar11, cVar12, cVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
...
int Function_52(int iParam0, int iParam1) //Position: 0x2C94 / 11412
{
	return Function_9(iParam0, "TargetLocator", iParam1);
}

void Function_53() //Position: 0x2CB1 / 11441
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

int Function_54(int iParam0, int iParam1) //Position: 0x2CC0 / 11456
{
	return Function_9(iParam0, "UserPhysAttachBone", iParam1);
}

int Function_55(int iParam0, int iParam1) //Position: 0x2CE2 / 11490
{
	return Function_9(iParam0, "TargetPhysAttachBone", iParam1);
}

var Function_56(bool bParam0) //Position: 0x2D06 / 11526
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

int Function_57(int iParam0, int iParam1) //Position: 0x2D23 / 11555
{
	return Function_9(iParam0, "TargetAttachBone", iParam1);
}

int Function_58(int iParam0, int iParam1) //Position: 0x2D43 / 11587
{
	return Function_9(iParam0, "TargetAttachSlot", iParam1);
}

void Function_59(int iParam0, bool bParam1) //Position: 0x2D63 / 11619
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	bVar0 = GRINGO_GET_FIRST_CHILD(2, iParam0);
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		uVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(bVar0, bParam1);
		cVar3 = GRINGO_ANIM_GET_ACT_FILENAME(bVar0);
		cVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar0);
		bVar1 = GRINGO_GET_PHYSINST(iParam0);
		if (IS_PHYSINST_VALID(bVar1))
		{
			uVar5 = GET_OBJECT_ANIMATOR_ON_OBJECT(bVar1);
			if (IS_OBJECT_ANIMATOR_VALID(uVar5))
			{
				LOG_ERROR("Previous object animator not cleared - destroying now!");
				DESTROY_OBJECT_ANIMATOR(uVar5);
			}
			uVar6 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bVar1, uVar2, cVar3, cVar4);
			if (IS_OBJECT_ANIMATOR_VALID(uVar6))
			{
				LINK_OBJECT_ANIMATOR_TO_ACTOR(uVar6, bParam1, GRINGO_GET_PROP_ATTACH_SLOT(iParam0));
			}
		}
	}
	return;
...
bool Function_60(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2E11 / 11793
{
	bool bVar0;
...
void Function_61(int iParam0, float fParam1) //Position: 0x2E81 / 11905
{
	if (!Function_14(iParam0))
	{
...
void Function_62(int iParam0, float fParam1) //Position: 0x2E97 / 11927
{
...
var Function_63(bool bParam0) //Position: 0x2EB8 / 11960
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_64(int iParam0) //Position: 0x2ED8 / 11992
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_65(var uParam0) //Position: 0x2EEC / 12012
{
	uParam0 = uParam0;
	return;
}

int Function_66() //Position: 0x2EF6 / 12022
{
	return 1;
}

void Function_67(int iParam0, int iParam1) //Position: 0x2EFD / 12029
{
	*iParam0 = (*iParam0 || iParam1);
	return;
}

void Function_68(bool bParam0, var uParam1, int iParam2) //Position: 0x2F0C / 12044
{
	float fVar0;
...
bool Function_69(bool bParam0) //Position: 0x2F4B / 12107
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_70(bool bParam0) //Position: 0x2F76 / 12150
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_71(bool bParam0) //Position: 0x2F81 / 12161
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_72(char* cParam0) //Position: 0x3077 / 12407
{
	return Function_7(cParam0, "UsePosActorRelative", 0);
}

bool Function_73(bool bParam0) //Position: 0x3099 / 12441
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_74(bool bParam0) //Position: 0x30C0 / 12480
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
		...
		if (Function_104(iLocal_3, 4) && !Function_104(iLocal_3, 8))
		{
			...
			if (STRING_CONTAINS_STRING(bVar0, "skin"))
			{
				if (Function_104(iLocal_3, 2))
				{
					...
					{
						uLocal_36 = Function_90(bLocal_37, 0, Global_34573, 1, 0, 0);
					}
					else
					{
						uLocal_36 = Function_85(bLocal_37, 0, Global_34573, 1, 0, 0);
					}
				}
				else
				{
					uLocal_36 = Function_80(bLocal_37, 0, Global_34573, 1, 0, 0);
				}
			}
			else
			{
				uLocal_36 = Function_75(bLocal_37, 0, Global_34573, 1, 0, 0);
			}
...
var Function_75(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x31EC / 12780
{
	bool bVar0;
...
void Function_76(var uParam0, int iParam1) //Position: 0x3266 / 12902
{
	var uVar0;
...
void Function_77(var uParam0, bool bParam1) //Position: 0x32C8 / 13000
{
...
void Function_78(var uParam0, bool bParam1) //Position: 0x3358 / 13144
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_79(var uParam0, bool bParam1) //Position: 0x33E4 / 13284
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
var Function_80(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, int iParam5) //Position: 0x3470 / 13424
{
	bool bVar0;
...
void Function_81(var uParam0, int iParam1) //Position: 0x34F2 / 13554
{
	var uVar0;
...
void Function_82(var uParam0, bool bParam1) //Position: 0x354A / 13642
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
...
void Function_83(var uParam0, bool bParam1) //Position: 0x35D6 / 13782
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 43.15054f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_84(var uParam0, bool bParam1) //Position: 0x3662 / 13922
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 43.15054f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
var Function_85(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, int iParam5) //Position: 0x36EE / 14062
{
	bool bVar0;
...
void Function_86(var uParam0, int iParam1) //Position: 0x3771 / 14193
{
	var uVar0;
	var uVar1;
	
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_89(&uVar0, iParam1);
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_88(&uVar0, iParam1);
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_87(&uVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(*uParam0, 0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(*uParam0, 1, 1);
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 2, 2.0f, 2);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(uVar1, 1.5f, 1, 0);
	return;
}

void Function_87(var uParam0, bool bParam1) //Position: 0x37D7 / 14295
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_88(var uParam0, bool bParam1) //Position: 0x3863 / 14435
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_89(var uParam0, bool bParam1) //Position: 0x38EF / 14575
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
var Function_90(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, int iParam5) //Position: 0x397B / 14715
{
	bool bVar0;
...
void Function_91(var uParam0, int iParam1) //Position: 0x39FC / 14844
{
	var uVar0;
	var uVar1;
	...
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_93(&uVar0, iParam1);
	uVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_92(&uVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(*uParam0, 0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_INDEFINITE(*uParam0, 1, 1);
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 2, 2.0f, 2);
...
void Function_92(var uParam0, bool bParam1) //Position: 0x3A62 / 14946
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_93(var uParam0, bool bParam1) //Position: 0x3AEE / 15086
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_94(var uParam0, bool bParam1) //Position: 0x3B7A / 15226
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 42.97919f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_95(int iParam0) //Position: 0x3C06 / 15366
{
	iParam0 = iParam0;
	return;
}

bool Function_96(char* cParam0) //Position: 0x3C10 / 15376
{
	return Function_7(cParam0, "MaintainPosture", 0);
}

void Function_97(int iParam0) //Position: 0x3C2E / 15406
{
	if (!Function_14(iParam0))
	{
...
bool Function_98(bool bParam0, bool bParam1) //Position: 0x3C43 / 15427
{
	vector3 vVar0;
	float fVar3;
	vector3 vVar4;
	...
	if (IS_ACTOR_PLAYER(bParam0))
	{
		if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()), "skin"))
		{
			...
			fVar10 = Function_100(StackVal, StackVal, StackVal, StackVal, vVar4, vVar7);
			TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar4, fVar10, 1, 1, 1);
		}
		else
		{
			...
			fVar23 = Function_100(StackVal, StackVal, StackVal, StackVal, vVar14, vVar17);
			TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar14, fVar23, 1, 1, 1);
		}
		return 1;
	}
	fVar24 = Function_99(bParam1);
	fVar25 = Function_69(bParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vVar0, fVar24, 0.2f, 1, fVar3, fVar25, 0, 0);
}

bool Function_99(bool bParam0) //Position: 0x3D59 / 15705
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

var Function_100(vector3 vParam0, vector3 vParam3) //Position: 0x3D7C / 15740
{
	var uVar0;
...
void Function_101(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3D96 / 15766
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

bool Function_102(bool bParam0, int iParam1) //Position: 0x3DB9 / 15801
{
...
int Function_103(bool bParam0) //Position: 0x3DE4 / 15844
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_104(int iParam0, int iParam1) //Position: 0x3EE9 / 16105
{
	return (iParam0 && iParam1) == 0;
}

void Function_105(int iParam0) //Position: 0x3EF6 / 16118
{
	if (Function_104(iParam0->f_40, 16))
	{
...
void Function_106(int iParam0, bool bParam1) //Position: 0x3F69 / 16233
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		iVar6 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar5, iParam0->f_12);
		bVar7 = GRINGO_GET_PHYSINST(iVar6);
		if (IS_PHYSINST_VALID(bVar7))
		{
			uVar8 = GET_OBJECT_ANIMATOR_ON_OBJECT(GET_OBJECT_FROM_PHYSINST(bVar7));
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(uLocal_57));
		iLocal_58 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_49(iParam0->f_12))
...
bool Function_111(char* cParam0) //Position: 0x4501 / 17665
{
	return Function_7(cParam0, "BlockBumpReactions", 0);
}
...
void Function_112(bool bParam0, int iParam1) //Position: 0x4522 / 17698
{
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		{
			iVar0 = (RAND_INT_RANGE(0, 10000) % 100);
			iVar1 = (RAND_INT_RANGE(0, 10000) % 100);
			iVar2 = (RAND_INT_RANGE(0, 10000) % 100);
			iVar3 = GET_CORPSE_ACTOR_ENUM(GET_TARGET_OBJECT());
			bVar4 = true;
			if (Function_140(16))
			{
				bVar4 = 2;
			}
			bVar5 = GET_ACTORENUM_SPECIES(iVar3);
			...
			switch (bVar5)
			{
				case 0x0000001B:
					if (iVar3 == 1080)
					{
						...
						Global_34581[304] = (Global_34581[304] - 1.0f);
					}
					else
					{
						Function_134(572, bVar4);
				...
				case 0x00000003:
					if ((((((1098 != iVar3 || 1099 != iVar3) || 1100 != iVar3) || 1101 != iVar3) || 1102 != iVar3) || 1103 != iVar3) || 1104 != iVar3)
					{
				...
				case 0x00000002:
					...
					{
						Function_134(502, RAND_INT_RANGE(1, 2));
					}
					break;
			...
			if (Function_117(1) >= 9)
			{
				if (GET_ITEM_COUNT(Function_116(4), bParam0) <= 5)
				{
					...
					if (iVar7 != iVar6)
					{
						if ((iVar7 - iVar6) > 100)
						{
							ADD_ITEM(Function_116(4), bParam0, 1);
						}
		...
		{
			ACTOR_SET_NEXT_EQUIP_SLOT(bParam0, iLocal_2, 0);
			ACTOR_SET_NEXT_WEAPON(bParam0, iLocal_1);
			iLocal_1 = 4294967295;
		}
		else if (iLocal_2 != 4294967295)
		{
			ACTOR_SET_NEXT_EQUIP_SLOT(bParam0, iLocal_2, 0);
		}
	...
	{
		iVar8 = GET_CORPSE_ACTOR_ENUM(GET_TARGET_OBJECT());
		if (GET_ACTORENUM_SPECIES(iVar8) == 19)
		{
			Function_134(540, 1);
			Function_134(541, 1);
		}
...
void Function_113(int iParam0) //Position: 0x4F31 / 20273
{
	int iVar0;
...
void Function_114(var uParam0, int iParam1) //Position: 0x4F57 / 20311
{
...
void Function_115(var uParam0, int iParam1) //Position: 0x5085 / 20613
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x509F / 20639
{
	bool bVar0;
...
int Function_117(int iParam0) //Position: 0x5190 / 20880
{
...
bool Function_118() //Position: 0x51B8 / 20920
{
	return NET_IS_MANAGER_INITIALIZED();
}

int Function_119(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x51C1 / 20929
{
	int iVar0;
	int iVar1;
...
void Function_120(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x53E1 / 21473
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_121(int iParam0) //Position: 0x5A0E / 23054
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_122(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x5A1F / 23071
{
	char* cVar0[32];
...
struct<32> Function_123(char* cParam0, char* cParam1) //Position: 0x5B14 / 23316
{
	char* cVar0[32];
...
void Function_124(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x5B2D / 23341
{
	float fVar0;
...
var Function_125(int iParam0, int iParam1) //Position: 0x5B92 / 23442
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_126(int iParam0, bool bParam1) //Position: 0x5BA4 / 23460
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_127(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x5BB6 / 23478
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_128(int iParam0) //Position: 0x5CE6 / 23782
{
	return Global_35278[iParam020].f_48;
}

float Function_129(int iParam0) //Position: 0x5CF5 / 23797
{
	if (!iParam0 != 4294967295)
	{
...
var Function_130(int iParam0) //Position: 0x5D2E / 23854
{
	if (iParam0 == 4294967295)
	{
...
void Function_131(int iParam0) //Position: 0x5D6B / 23915
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_132(int iParam0, float fParam1, bool bParam2) //Position: 0x5F05 / 24325
{
	int iVar0;
	int iVar1;
...
int Function_133(bool bParam0) //Position: 0x6149 / 24905
{
	switch (bParam0)
	{
		case 0x00000000:
...
int Function_134(int iParam0, bool bParam1) //Position: 0x63CB / 25547
{
	bool bVar0;
	int iVar1;
...
int Function_135() //Position: 0x6568 / 25960
{
	int iVar0;
...
void Function_136() //Position: 0x6607 / 26119
{
	int iVar0;
	int iVar1;
...
void Function_137(int iParam0) //Position: 0x66B6 / 26294
{
...
var Function_138(int iParam0, int iParam1) //Position: 0x6714 / 26388
{
	int iVar0;
...
int Function_139(int iParam0) //Position: 0x6755 / 26453
{
	if (iParam0 == 4294967295)
	{
...
bool Function_140(int iParam0) //Position: 0x6796 / 26518
{
...
void Function_141(bool bParam0, bool bParam1) //Position: 0x67A7 / 26535
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_142(char* cParam0, bool bParam1) //Position: 0x68AF / 26799
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_143(int iParam0) //Position: 0x68C5 / 26821
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_144(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_144(bool bParam0, int iParam1) //Position: 0x6B7B / 27515
{
	bool bVar0;
	int iVar1;
	struct<8> Var2;
	...
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		...
		bVar0 = GET_TARGET_OBJECT();
		iVar1 = GET_CORPSE_ACTOR_ENUM(bVar0);
		Global_3384 = 1;
	...
	else
	{
		...
		if (GET_ACTOR_ENUM(bParam0) == 638)
		{
			...
			iVar11 = GET_CORPSE_ACTOR_ENUM(bVar10);
			Global_3384 = 1;
	...
	else if (!GET_WEAPON_IN_HAND(bParam0) != 22)
	{
		ACTOR_HOLSTER_WEAPON(bParam0, 0);
	...
	iLocal_13 = Function_148(&bParam0, GET_CORPSE_ACTOR_ENUM(GET_TARGET_OBJECT()));
	if (STRING_CONTAINS_STRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()), "skin"))
	{
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassSmall01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassSnake01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassMedium01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassHorse01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassMediumExtra01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassLarge01x", 0, 0);
		Function_146(&bLocal_14, "$/fragments/p_gen_carcassElk01x", 0, 0);
	}
	if (Function_104(iLocal_3, 32))
	{
		Function_67(&iLocal_3, 8);
		...
		if (Function_104(iLocal_3, 2))
		{
			if (Function_104(iLocal_3, 256))
			{
				uLocal_36 = Function_90(bLocal_37, 0, bParam0, 1, 0, 0);
			}
			else
			{
				uLocal_36 = Function_85(bLocal_37, 0, bParam0, 1, 0, 0);
			}
		}
		else
		{
			uLocal_36 = Function_80(bLocal_37, 0, bParam0, 1, 0, 0);
		}
	}
	Function_145(&uLocal_10);
	return;
}

void Function_145(int iParam0) //Position: 0x6E64 / 28260
{
	Function_62(iParam0, 0.0f);
	return;
}

var Function_146(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6E70 / 28272
{
	int iVar0;
	var uVar1;
...
var Function_147(var uParam0, int iParam1, int iParam2) //Position: 0x6EA8 / 28328
{
	int iVar0;
...
int Function_148(var uParam0, int iParam1) //Position: 0x6F6C / 28524
{
	switch (GET_ACTORENUM_SPECIES(iParam1))
	{
		case 0x0000001B:
		case 0x00000001:
		case 0x0000001C:
...
struct<32> Function_149(bool bParam0) //Position: 0x714E / 29006
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_150(char* cParam0, char* cParam1, char* cParam2) //Position: 0x71B8 / 29112
{
	char* cVar0[32];
...
bool Function_151(char* cParam0) //Position: 0x71D7 / 29143
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_152(char* cParam0) //Position: 0x71F0 / 29168
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_153(int iParam0, int iParam1) //Position: 0x720A / 29194
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_154(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
int Function_154(var uParam0, int iParam1) //Position: 0x7242 / 29250
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_155(int iParam0, int iParam1) //Position: 0x7259 / 29273
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_159(bVar1, iParam0->f_12))
		{
		...
		if (!Function_104(iParam0->f_40, 2))
		{
			...
			if (Function_104(iParam0->f_40, 1))
			{
				Function_142("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_158(iParam0->f_12);
				bVar16 = VMAG(vVar12);
				...
				if (!Function_157(bVar1, iParam0->f_12))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar33 = Function_156(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
...
bool Function_156(bool bParam0) //Position: 0x7522 / 29986
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_157(bool bParam0, bool bParam1) //Position: 0x753F / 30015
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_158(int iParam0) //Position: 0x75DB / 30171
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_159(bool bParam0, int iParam1) //Position: 0x75FA / 30202
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		if (!Function_104(iLocal_3, 1))
		{
			...
			if (iVar1 != 4294967295)
			{
				if (Function_162(&vVar2))
				{
					if (Function_160(StackVal, StackVal, bParam0, vVar2) > 6.0f)
					{
						bVar5 = 100000.0f;
						TRAIN_GET_POSITION(iVar1, &vVar6);
						if (IS_ACTOR_VALID(Global_34573))
						{
							GET_POSITION(Global_34573, &vVar9);
							bVar5 = VDIST(vVar9, vVar6);
						}
						if (bVar5 > (TRAIN_GET_VELOCITY(iVar1) * 16.0f))
						{
							return 0;
						}
					}
			...
			if ((GET_OBJECT_NAMED_BONE_POSITION(bVar0, "pelvis", &vVar12) && GET_OBJECT_NAMED_BONE_POSITION(bVar0, "neck", &vVar15)) && GET_OBJECT_NAMED_BONE_POSITION(bVar0, "root", &vVar18))
			{
				...
				if (Function_160(StackVal, StackVal, bParam0, vVar21) >= 1.5f)
				{
					if (GET_WEAPON_IN_HAND(bParam0) != 4294967295)
					{
						iLocal_1 = GET_WEAPON_IN_HAND(bParam0);
						iLocal_2 = ACTOR_GET_CURRENT_EQUIP_SLOT(bParam0);
					}
					else
					{
						iLocal_2 = ACTOR_GET_NEXT_EQUIP_SLOT(bParam0);
						iLocal_1 = 4294967295;
					}
					return 1;
				}
...
float Function_160(bool bParam0, vector3 vParam1) //Position: 0x77A9 / 30633
{
	vector3 vVar0;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		vVar0 = { StackVal, StackVal, Function_161(bParam0) };
...
vector3 Function_161(bool bParam0) //Position: 0x7823 / 30755
{
	vector3 vVar0;
...
bool Function_162(int iParam0) //Position: 0x788D / 30861
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	bVar3 = START_CURVE_QUERY(Global_30616, vVar0, 8, 0.0f, 3.0f, 0.5f, 0);
	iVar5 = 4294967295;
	bVar10 = 100000.0f;
	iVar4 = 0;
	...
	if (IS_CURVE_QUERY_VALID(bVar3) && GET_NUM_CURVES_IN_CURVE_QUERY(bVar3) < 0)
	{
		if (iVar5 >= 4294967295)
		{
			bVar11 = GET_CURVE_FROM_CURVE_INDEX_IN_CURVE_QUERY(bVar3, iVar5);
			if (IS_OBJECT_VALID(bVar11))
			{
				GET_POINT_FROM_CURVE_QUERY(bVar3, iVar5, &uVar12);
				Function_163(&uVar12);
				*iParam0 = { StackVal, StackVal, Function_163(&uVar12) };
...
vector3 Function_163(int iParam0) //Position: 0x7948 / 31048
{
	vector3 vVar0;
...
bool Function_164(int iParam0) //Position: 0x7967 / 31079
{
...
void Function_165(int iParam0) //Position: 0x7983 / 31107
{
	iParam0 = iParam0;
	return;
}

void Function_166(bool bParam0, int iParam1) //Position: 0x798D / 31117
{
	int iVar0;
	int iVar1;
	...
	{
		Function_167(&(Local_40[iLocal_5312]), bParam0);
		iLocal_53++;
	}
...
void Function_167(int iParam0, int iParam1) //Position: 0x79EF / 31215
{
...
void Function_168(int iParam0) //Position: 0x7A03 / 31235
{
	iParam0 = iParam0;
	return;
}

void Function_169(int iParam0) //Position: 0x7A0D / 31245
{
