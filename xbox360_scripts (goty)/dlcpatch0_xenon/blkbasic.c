...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_39 + 1896) = { 564.206f, 92.859f, 1166.414f };
		...
		AUDIO_MUSIC_FORCE_TRACK("TC_NRT_SONG_02", "nIDLE_DARK", 0f, 4294967295, 4294967295, 3212836864, 0);
...
void Function_32(var uParam0, int iParam1) //Position: 0x175E / 5982
{
	...
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(0, iVar1);
	NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(1, iVar2);
...
var Function_35(int iParam0) //Position: 0x1AFA / 6906
{
...
int Function_59(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x219B / 8603
{
	...
	if (!bParam1)
	{
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(iVar1, iVar0);
		iVar1++;
...
void Function_61(bool bParam0, int iParam1, char* cParam2) //Position: 0x225D / 8797
{
	if (bParam0)
	{
		if (Function_103())
		{
			NET_PLAYER_LIST_ADD_ITEM(cParam2, uParam1);
		}
		else
		{
...
void Function_113(int iParam0, vector3 vParam1, int iParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x36F2 / 14066
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_114(int iParam0, var uParam1, int iParam2) //Position: 0x386F / 14447
{
	switch (iParam0)
	{
		case 0x00000004:
...
var Function_116(var uParam0, var uParam1, float fParam2, bool bParam3) //Position: 0x3969 / 14697
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_117() //Position: 0x39D5 / 14805
{
...
bool Function_119(int iParam0, var uParam1, var uParam2, int iParam3) //Position: 0x3AEA / 15082
{
...
bool Function_121(int iParam0, int iParam1) //Position: 0x3C8D / 15501
{
	switch (UNK_0xDB679ED9(iParam0))
	{
		case 0x00000027:
...
int Function_156(bool bParam0, bool bParam1, var uParam2, char* cParam3) //Position: 0x4A75 / 19061
{
	bool bVar0;
	char* cVar1;
	
	Function_61(bParam1, uParam2, cParam3);
