...
void main() //Position: 0x0 / 0
{
	...
	if (Function_149())
	{
		...
		*(&Local_39 + 1896) = { -1372.93f, 13.051f, 4281.811f };
		...
		AUDIO_MUSIC_FORCE_TRACK("TC_MEX_SONG_01", "nIDLE_DARK", 0f, 4294967295, 4294967295, 3212836864, 0);
...
void Function_32(var uParam0, int iParam1) //Position: 0x175E / 5982
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_45(int iParam0, int iParam1) //Position: 0x1C90 / 7312
{
	struct<13> Var0;
...
void Function_52(int iParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x202F / 8239
{
	if (iParam2 != 0)
	{
...
void Function_60(char* cParam0, bool bParam1) //Position: 0x222A / 8746
{
	if (Function_102(4))
	{
...
void Function_91(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) //Position: 0x30EB / 12523
{
	vector3 vVar0;
	int iVar3;
...
void Function_106(int iParam0, int iParam1, int iParam2) //Position: 0x337A / 13178
{
