...
#region Local Var
	...
	vector3 vLocal_276 = { 0.0f, 0.0f, 0.0f };
	var uLocal_279 = 0;
	var uLocal_280 = 0;
	var uLocal_281 = 0;
	int iLocal_282 = 0;
...
void main() //Position: 0x0 / 0
{
	...
	iLocal_247 = 0;
	bLocal_255 = false;
	vLocal_276 = { 731.98f, 78.307f, 1251.799f };
	iLocal_282 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			bVar0 = false;
			iLocal_248 = 1000;
			Function_197(&bLocal_257, 1234, 3, 0);
			Function_197(&bLocal_257, 561, 3, 0);
			Function_195(&bLocal_257, "ptl_base", 5, 0);
			Function_195(&bLocal_257, "rfl_base", 5, 0);
			Function_195(&bLocal_257, "cali_dreaming_dead", 5, 0);
			while (!IS_EXITFLAG_SET())
			{
				switch (bVar0)
				{
					case 0x00000000:
						if (DECOR_CHECK_EXIST(Global_34573, "GP_Dismount"))
						{
							if (IS_SCRIPT_VALID(DECOR_GET_INT(Global_34573, "GP_Dismount")))
							{
								break;
							}
						}
						else if (!Function_194(Global_76846, 32768))
						{
							break;
						}
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								if (Function_189(&bLocal_257))
								{
									bLocal_275 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "ZombieStayOut", 2, 735.689f, 78.306f, 1298.782f, 0.0f, 0.0f, 0.0f, 25.0f, 15.0f, 30.0f);
									ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_275);
									ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_275);
									Function_182(&(Global_63541[255]), 2, 0x41f00000, 0x42200000, 0);
									bVar0 = true;
								}
							}
							else
							{
								bLocal_256 = CREATE_LAYOUT("RCM_Blackwater_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						{
							Function_181(&Global_63541[ScriptParam_055] + 144, 128);
					...
					case 0x00000003:
						if (Function_123("$/cutscene/fenway_1_cs/fenway_1_cs", &iLocal_248, 33748, 33596, 32305, 30023, 29724, 29708, 1, 1, 2, 2, 0))
						{
							bVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						...
						{
							Function_122("Blackwater1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "blackwater1_OBJ", 0, 3, false);
							Function_121(Global_63541[ScriptParam_055].f_140, 0);
							if (!Function_194(Global_76846, 512))
							{
								Function_116(Global_34573, 512, 1, 0);
							}
							if (!Function_194(Global_76846, 1024))
							{
								Function_116(Global_34573, 1024, 1, 0);
							}
							if (DECOR_CHECK_EXIST(Global_34573, "PlayerHorse_DeathTime"))
							{
								DECOR_REMOVE(Global_34573, "PlayerHorse_DeathTime");
							}
							Function_115(406, 1, 0, 0);
							Function_14(2, 1, 1, 0);
							Function_11(&uLocal_279);
							SET_ACTOR_CAN_BE_AIMASSISTED(bLocal_274, 0);
							bVar0 = 13;
						}
						break;
...
void Function_1(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4B7 / 1207
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_2() //Position: 0x667 / 1639
{
	return 0.0f, 0.0f, 0.0f;
}

var Function_3() //Position: 0x670 / 1648
{
	int iVar0;
...
bool Function_4(var uParam0, int iParam1) //Position: 0x678 / 1656
{
	if (Function_6(uParam0, iParam1))
	{
		Function_5(uParam0);
		return 1;
	}
...
void Function_5(int iParam0) //Position: 0x690 / 1680
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_6(int iParam0, float fParam1) //Position: 0x6A4 / 1700
{
	if (Function_10(iParam0))
	{
		if (Function_7(iParam0) < fParam1)
		{
			return 1;
		}
	}
...
float Function_7(int iParam0) //Position: 0x6C0 / 1728
{
	if (Function_10(iParam0))
	{
...
bool Function_8(int iParam0) //Position: 0x788 / 1928
{
	return Function_9(*iParam0, 2);
}

bool Function_9(var uParam0, int iParam1) //Position: 0x795 / 1941
{
	return (uParam0 && iParam1) == 0;
}

bool Function_10(int iParam0) //Position: 0x7A2 / 1954
{
	return Function_9(*iParam0, 1);
}

void Function_11(int iParam0) //Position: 0x7AF / 1967
{
	if (!Function_10(iParam0))
	{
...
void Function_12(int iParam0, float fParam1) //Position: 0x7C4 / 1988
{
	iParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_181(iParam0, 1);
	Function_13(iParam0, 2);
	iParam0->f_8 = 0.0f;
	return;
}

void Function_13(int iParam0, int iParam1) //Position: 0x7E5 / 2021
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_14(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x7F8 / 2040
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	if (!Function_114())
	{
		if (!Function_194(Global_76846, 2097152))
		{
			Function_116(Global_34573, 2097152, 1, 0);
		}
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
	{
		if (Global_63541[iVar0 + 155].f_160)
		{
			...
			iVar3 = (GET_HOUR(GET_TIME_OF_DAY()) + GET_HOUR(Global_63541[iVar0 + 155].f_156));
			...
			uVar1 = MAKE_TIME_OF_DAY_EX(bVar2, iVar3, iVar4, iVar5);
		}
		else
		{
			uVar1 = MAKE_TIME_OF_DAY_EX(false, 0, 0, 0);
		}
		PRINTSTRING("Time next quest leg will be available: ");
		Function_113(uVar1);
		PRINTNL();
		Global_63541[iVar0 + 155].f_156 = uVar1;
	}
	...
	Function_13(&Global_63541[iParam055] + 144, 64);
	...
	if (bVar8)
	{
		if (!bParam3)
		{
			if (IS_JOURNAL_ENTRY_IN_LIST(Global_63541[iParam055].f_140, 0))
			{
				...
				SET_JOURNAL_ENTRY_PROGRESS(Global_63541[iParam055].f_140, -1.0f, 0, 0);
			}
		...
		else
		{
			...
			SET_JOURNAL_ENTRY_PROGRESS(Global_63541[iParam055].f_140, -1.0f, 0, "RCM_InactiveJournal");
		}
	}
	else
	{
	...
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_63541[iParam055].f_140, 0))
	{
		Function_72(Global_63541[iParam055].f_140);
	}
...
void Function_15(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xC27 / 3111
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_16() //Position: 0xD9A / 3482
{
	return;
}

void Function_17(var uParam0, var uParam1) //Position: 0xDA0 / 3488
{
	if (Global_3381)
	{
		return;
...
bool Function_18() //Position: 0xDE2 / 3554
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_19(bool bParam0) //Position: 0xDEB / 3563
{
...
void Function_20() //Position: 0xE3C / 3644
{
	Function_47();
	Function_46();
	Function_46();
...
void Function_21() //Position: 0xE8E / 3726
{
...
void Function_22() //Position: 0xF94 / 3988
{
	float fVar0;
...
void Function_23() //Position: 0xFC7 / 4039
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_24() //Position: 0x1155 / 4437
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_25() //Position: 0x1309 / 4873
{
	Function_26(&Global_28260, 1, 0);
	return;
}

void Function_26(int iParam0, bool bParam1, var uParam2) //Position: 0x1317 / 4887
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_27() //Position: 0x1508 / 5384
{
...
struct<8> Function_28(int iParam0) //Position: 0x151D / 5405
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_29(int iParam0, bool bParam1, bool bParam2) //Position: 0x15C3 / 5571
{
	int iVar0;
...
void Function_30(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x185E / 6238
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_31(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_3(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_31(int iParam0) //Position: 0x1E8B / 7819
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_32(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1E9C / 7836
{
	char* cVar0[32];
...
struct<32> Function_33(char* cParam0, char* cParam1) //Position: 0x1F91 / 8081
{
	char* cVar0[32];
...
void Function_34(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1FAA / 8106
{
	float fVar0;
...
var Function_35(int iParam0, int iParam1) //Position: 0x200F / 8207
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x2021 / 8225
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_37(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2033 / 8243
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_38(int iParam0) //Position: 0x2163 / 8547
{
	return Global_35278[iParam020].f_48;
}

float Function_39(int iParam0) //Position: 0x2172 / 8562
{
	if (!iParam0 != 4294967295)
	{
...
var Function_40(int iParam0) //Position: 0x21AB / 8619
{
	if (iParam0 == 4294967295)
	{
...
void Function_41(int iParam0) //Position: 0x21E8 / 8680
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_42(int iParam0, bool bParam1, bool bParam2) //Position: 0x2382 / 9090
{
	int iVar0;
	int iVar1;
...
int Function_43(bool bParam0) //Position: 0x25C6 / 9670
{
...
struct<8> Function_44() //Position: 0x2607 / 9735
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_45() //Position: 0x2690 / 9872
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_46() //Position: 0x2727 / 10023
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_47() //Position: 0x27A6 / 10150
{
...
int Function_48(int iParam0, bool bParam1, int iParam2) //Position: 0x27DF / 10207
{
	int iVar0;
	int iVar1;
...
void Function_49() //Position: 0x29E9 / 10729
{
	vector3 vVar0;
	var uVar3;
...
bool Function_50(vector3 vParam0) //Position: 0x2AA4 / 10916
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_51(var uParam0, var uParam1, var uParam2, float fParam3) //Position: 0x2ABC / 10940
{
	int iVar0;
...
bool Function_52(int iParam0) //Position: 0x2BA3 / 11171
{
...
int Function_53(bool bParam0, bool bParam1) //Position: 0x2BB9 / 11193
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_54(vector3 vParam0, vector3 vParam3) //Position: 0x2C80 / 11392
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_55(var uParam0, int iParam1) //Position: 0x2C9D / 11421
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_56(int iParam0) //Position: 0x34C2 / 13506
{
	var uVar0;
...
void Function_57(bool bParam0, int iParam1) //Position: 0x34FD / 13565
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_58(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x350A / 13578
{
	uParam0 = uParam0;
...
void Function_59(int iParam0) //Position: 0x35AE / 13742
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_69(1, 0))
	{
		Function_68("ZOMBIE_STORY_1_OBJ");
		if (!Function_67(2))
		{
			bVar0 = "ZOMBIE_STORY_1_SHORT";
		}
	}
	if (Function_67(4) && !Function_65(0))
	{
		bVar0 = "ZOMBIE_STORY_1a_SHORT";
	}
	if (Function_67(5))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_1_OBJ", 4, 0);
		Function_68("ZOMBIE_STORY_2Nigel_OBJ");
		Function_68("ZOMBIE_STORY_2Seth_OBJ");
		if (!Function_67(8) && !Function_67(6))
		{
	...
	if (Function_67(6))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_2Seth_OBJ", 4, 0);
		if (!Function_67(8))
		{
	...
	if (Function_67(8))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_2Nigel_OBJ", 4, 0);
		if (!Function_67(6))
		{
			bVar0 = "ZOMBIE_STORY_2Seth_SHORT";
		}
	}
	if (!Function_62(&Global_3422[240] + 128, 2) || ((((((Function_67(14) && Function_67(18)) && Function_67(37)) && Function_67(7)) && Function_67(11)) && Function_67(5)) && Function_67(21)))
	{
		Function_68("ZOMBIE_STORY_3_OBJ");
		if (!Function_69(2, 0))
		{
	...
	if (Function_69(2, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_3_OBJ", 4, 0);
		Function_68("ZOMBIE_STORY_4_OBJ");
		if (!Function_67(24))
		{
			bVar0 = "ZOMBIE_STORY_4_SHORT";
		}
	}
	if (!Function_62(&Global_3422[340] + 128, 2) || ((Function_67(27) && Function_67(1)) && Function_67(23)))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_4_OBJ", 4, 0);
		Function_68("ZOMBIE_STORY_5_OBJ");
		if (!Function_69(3, 0))
		{
	...
	if (Function_69(3, 0))
	{
		SET_JOURNAL_ENTRY_DETAIL_STYLE(Function_63(), "ZOMBIE_STORY_5_OBJ", 4, 0);
	}
	if (!Function_67(5))
	{
	...
	if (!Function_67(7))
	{
		...
		if (((Function_67(6) && Function_60(Global_30735) < 0) && Function_60(Global_30737) < 0) && Function_60(Global_30738) < 0)
		{
	...
	if (!Function_67(11))
	{
		if (Function_67(8))
		{
			...
			strcpy(&cVar30, INT_TO_STRING((5 - Function_43(491))), 24);
			stradd(&cVar30, " ", 24);
			strcpy(&cVar36, INT_TO_STRING((5 - Function_43(497))), 24);
			stradd(&cVar36, " ", 24);
...
int Function_60(int iParam0) //Position: 0x3EA3 / 16035
{
...
bool Function_61(int iParam0) //Position: 0x3EBD / 16061
{
...
bool Function_62(int iParam0, int iParam1) //Position: 0x3ED4 / 16084
{
	int iVar0;
...
int Function_63() //Position: 0x3EF0 / 16112
{
	return STRING_TO_HASH(Function_64());
}

var Function_64() //Position: 0x3EFC / 16124
{
	return "ZOMBIE_STORY";
}

bool Function_65(int iParam0) //Position: 0x3F11 / 16145
{
	...
	return Global_13172[Function_66(iParam0)11].f_12 < 0;
}

int Function_66(int iParam0) //Position: 0x3F77 / 16247
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_67(int iParam0) //Position: 0x404A / 16458
{
...
void Function_68(char* cParam0) //Position: 0x405F / 16479
{
	if (!IS_JOURNAL_ENTRY_IN_LIST(Function_63(), 0))
	{
		CREATE_JOURNAL_ENTRY(Function_64(), 2, 38, "Mission_Strangers");
		PREPEND_JOURNAL_ENTRY(Function_63(), false);
	}
	APPEND_JOURNAL_ENTRY_DETAIL(Function_63(), cParam0, 0, 3, false);
	Function_121(Function_63(), 0);
	return;
}

bool Function_69(int iParam0, bool bParam1) //Position: 0x40A7 / 16551
{
	int iVar0;
...
var Function_70(int iParam0) //Position: 0x40E4 / 16612
{
...
bool Function_71(int iParam0) //Position: 0x40FE / 16638
{
...
void Function_72(int iParam0) //Position: 0x4114 / 16660
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_111(GET_TARGETED_JOURNAL_ENTRY());
	...
	switch (iVar0)
	{
		case 0x00000004:
			...
			{
				if (Function_110(iVar6) && !Function_108(iVar6))
				{
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_9(Global_63541[iVar155].f_144, 2048))
				{
					iVar3 = iVar1;
					if (Function_91(&(Global_63541[iVar155]), iVar3))
					{
						Function_181(&Global_63541[iVar155] + 144, 64);
						Function_84(&(Global_63541[iVar155]), iVar3);
						if (IS_OBJECT_VALID(Global_63541[iVar155].f_192))
						{
							DESTROY_OBJECT(Global_63541[iVar155].f_192);
							Function_73(&(Global_63541[iVar155]), 7);
						}
					}
				}
...
void Function_73(int iParam0, int iParam1) //Position: 0x42B6 / 17078
{
	float fVar0;
	bool bVar1;
...
void Function_74(int iParam0) //Position: 0x4370 / 17264
{
	float fVar0;
	bool bVar1;
...
int Function_75(var uParam0, int iParam1) //Position: 0x4412 / 17426
{
	int iVar0;
	var uVar1;
...
void Function_76(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x4573 / 17779
{
	struct<8> Var0;
...
struct<32> Function_77(bool bParam0) //Position: 0x460E / 17934
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_78(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4678 / 18040
{
	char* cVar0[32];
...
int Function_79(bool bParam0) //Position: 0x4697 / 18071
{
	int iVar0;
	vector3 vVar1;
		...
		if (IS_VOLUME_VALID(StackVal))
		{
			if (DECOR_CHECK_EXIST(StackVal, "script"))
			{
				if (!IS_SCRIPT_VALID(DECOR_GET_INT(StackVal, "script")))
				{
					...
					{
						if (Function_80(StackVal, StackVal, Global_34573, vVar1) < 25.0f)
						{
							Function_82(iVar0);
						}
					}
					else if (Function_80(StackVal, StackVal, Global_34573, vVar1) < 55.0f)
					{
						Function_82(iVar0);
					}
				}
...
float Function_80(bool bParam0, vector3 vParam1) //Position: 0x47F8 / 18424
{
	vector3 vVar0;
	...
	{
		Function_81(bParam0);
		vVar0 = { StackVal, StackVal, Function_81(bParam0) };
...
vector3 Function_81(bool bParam0) //Position: 0x4872 / 18546
{
	vector3 vVar0;
...
void Function_82(int iParam0) //Position: 0x48DC / 18652
{
...
void Function_84(int iParam0, int iParam1) //Position: 0x4953 / 18771
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_89(StackVal, Function_90(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_88(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_9(Global_63541[iParam155].f_144, 64))
	{
		...
		else if (iParam1 == 23 || !IS_OBJECT_VALID(iParam0->f_212))
		{
			...
			if (Function_9(Global_74542[iParam110].f_24, 1))
			{
				...
				if (Global_29006 != Global_63541[iParam155].f_132 && !Function_87())
				{
					Function_85("TerrCont_RCM", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
			else
			{
...
void Function_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4DE5 / 19941
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_86(int iParam0) //Position: 0x4E60 / 20064
{
	char* cVar0[16];
...
bool Function_87() //Position: 0x4E9F / 20127
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_88(bool bParam0) //Position: 0x4ECC / 20172
{
...
var Function_89(vector3 vParam0, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4EF8 / 20216
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, fParam3, fParam4, iParam5, iParam6, iParam7);
}

bool Function_90(int iParam0) //Position: 0x4F14 / 20244
{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x4F29 / 20265
{
	...
	{
		Function_181(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
	if ((Function_101(iParam1) || Function_67(iParam1)) || Function_100(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
	...
	if (Function_83(iParam0->f_132))
	{
		if (Function_99(&(Global_29008[iParam0->f_132]), 256))
		{
			return 0;
		}
	}
	...
	if (!Function_92(iParam0, iParam1))
	{
		return 0;
	}
	Function_181(&Global_63541[iParam155] + 144, 64);
...
bool Function_92(int iParam0, int iParam1) //Position: 0x503E / 20542
{
	int iVar0;
	
	if (!iParam0->f_172 != 0)
	{
		if (Function_62(iParam0 + 172, 4))
		{
		...
		if (Function_62(iParam0 + 172, 1))
		{
			if (!Function_67(iParam0->f_168))
			{
				return 0;
			}
		}
		if (Function_62(iParam0 + 172, 2) && Global_3365)
		{
		...
		if (Function_62(iParam0 + 172, 8) && Global_3365)
		{
			if (Function_93(iParam0->f_164))
			{
				if (StackVal != 3)
				{
					return 0;
		...
		switch (Global_63399)
		{
			...
			case 0x00000004:
				if (!Function_62(iParam0 + 172, 128))
				{
					return 0;
				}
				break;
			...
			case 0x00000008:
				if (!Function_62(iParam0 + 172, 256))
				{
					return 0;
				}
				break;
			...
			case 0x00000010:
				if (!Function_62(iParam0 + 172, 512))
				{
					return 0;
				}
				break;
			...
			case 0x00000020:
				if (!Function_62(iParam0 + 172, 1024))
				{
					return 0;
				}
				break;
...
bool Function_93(int iParam0) //Position: 0x5182 / 20866
{
	if (!Function_61(iParam0))
	{
		return 0;
...
bool Function_94(int iParam0) //Position: 0x51A6 / 20902
{
...
bool Function_95(int iParam0) //Position: 0x51BB / 20923
{
	return StackVal;
}

bool Function_96(int iParam0) //Position: 0x51CB / 20939
{
	if (!iParam0->f_152)
	{
		if (Function_114())
...
bool Function_97(int iParam0) //Position: 0x526F / 21103
{
	if (!Function_98(1048576) || Global_3381)
	{
		return 1;
	}
	if (!Function_9(Global_63541[iParam055].f_144, 32768))
	{
		if ((Global_3403 || Global_3405) || Global_3404)
		{
			if (!Function_194(Global_76847, 0x8000000))
			{
				Function_116(Global_34573, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
bool Function_98(int iParam0) //Position: 0x52C8 / 21192
{
	int iVar0;
...
bool Function_99(var uParam0, int iParam1) //Position: 0x52E4 / 21220
{
	int iVar0;
...
int Function_100(int iParam0) //Position: 0x5300 / 21248
{
...
int Function_101(int iParam0) //Position: 0x5315 / 21269
{
...
void Function_102() //Position: 0x532A / 21290
{
	if (Function_105(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_4 = Function_104(Global_28180);
			Global_28180.f_8 = Function_103(StackVal, Global_28180);
			Global_28180.f_12 = 0;
		}
...
var Function_103(int iParam0, int iParam1) //Position: 0x53A5 / 21413
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
	...
	switch (iParam0)
	{
		...
		case 0x00000004:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_69(6, 0) || Function_69(12, 0))
					{
						bVar6 = StackVal;
					}
		...
		case 0x00000006:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_67(13) && iVar16)
					{
						bVar6 = StackVal;
						iVar16 = 0;
					}
					else if (iVar16 && Function_69(5, 0))
					{
		...
		case 0x00000008:
			switch (iParam1)
			{
				...
				case 0x00000002:
					if (Function_67(26) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_67(25) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_67(24) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (Function_67(23) && iVar17)
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
					else if (iVar17 && Function_69(26, 0))
					{
						bVar6 = StackVal;
						iVar17 = 0;
					}
				...
				case 0x00000008:
					if (Function_67(55) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_67(54) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
					else if (Function_67(27) && iVar18)
					{
						bVar6 = StackVal;
						iVar18 = 0;
					}
		...
		case 0x00000009:
			switch (iParam1)
			{
				...
				case 0x00000008:
					if (Function_67(52) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_67(51) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_67(50) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_67(49) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
					else if (Function_69(17, 0) && iVar15)
					{
						bVar6 = StackVal;
						iVar15 = 0;
					}
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					if (Function_67(19) && iVar19)
					{
						vVar0 = { -1708.36f, 46.18f, 2175.89f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_69(6, 0) && Function_67(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_67(17) && iVar19)
					{
						vVar0 = { -1687.208f, 53.208f, 2140.491f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if ((Function_69(9, 0) && Function_67(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					else if (Function_67(15) && iVar19)
					{
						vVar0 = { -1709.084f, 55.216f, 2104.631f };
						vVar3 = { 125.0f, 125.0f, 125.0f };
						iVar19 = 0;
					}
					else if (Function_69(8, 0) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_104(int iParam0) //Position: 0x5F96 / 24470
{
	int iVar0;
	int iVar1;
...
bool Function_105(int iParam0) //Position: 0x5FE5 / 24549
{
...
int Function_106(int iParam0) //Position: 0x5FFB / 24571
{
...
void Function_107() //Position: 0x6064 / 24676
{
...
bool Function_108(int iParam0) //Position: 0x6087 / 24711
{
	if (!Function_105(iParam0))
	{
...
bool Function_109(int iParam0, int iParam1) //Position: 0x60D8 / 24792
{
	int iVar0;
...
bool Function_110(int iParam0) //Position: 0x6105 / 24837
{
	if (!Function_105(iParam0))
	{
...
void Function_111(int iParam0) //Position: 0x6157 / 24919
{
	int iVar0;
...
void Function_112() //Position: 0x6191 / 24977
{
	bool bVar0;
...
void Function_113(bool bParam0) //Position: 0x61EF / 25071
{
	PRINTSTRING("Day ");
...
bool Function_114() //Position: 0x6235 / 25141
{
...
int Function_115(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x6250 / 25168
{
	int iVar0;
	int iVar1;
...
void Function_116(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6470 / 25712
{
	bool bVar0;
	char* cVar1[16];
...
void Function_117(char* cParam0, int iParam1) //Position: 0x64DC / 25820
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_118(bool bParam0, var uParam1, int iParam2) //Position: 0x6513 / 25875
{
	var uVar0;
	char* cVar1[16];
	...
	if (iParam2 == 2)
	{
		...
		{
			case 0x00000002:
				if (!Function_194(Global_76847, 1577004))
				{
					return 0;
				}
				break;
...
int Function_119(char* cParam0) //Position: 0x658B / 25995
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_120(int iParam0) //Position: 0x662C / 26156
{
	int iVar0;
	int iVar1;
...
void Function_121(int iParam0, bool bParam1) //Position: 0x6669 / 26217
{
	bool bVar0;
...
void Function_122(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x668E / 26254
{
	struct<4> Var0;
	int iVar4;
...
bool Function_123(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6713 / 26387
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_124(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, bool bParam15, bool bParam16) //Position: 0x67BC / 26556
{
	if (!bParam15)
	{
	...
	{
		case 0x000003E8:
			if (*uParam3 != 99 && (Function_135(iParam2) || iParam2->f_24 < 1))
			{
				*iParam1 = 1106;
				return 0;
			}
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_7(iParam1 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_7(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && *uParam3 == 99) && !Function_135(iParam2))
			{
...
void Function_125(int iParam0) //Position: 0x6DD0 / 28112
{
	iParam0 = iParam0;
	HUD_ENABLE(iParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_126() //Position: 0x6E7F / 28287
{
	bool bVar0;
...
void Function_127() //Position: 0x6EF1 / 28401
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_128() //Position: 0x6F36 / 28470
{
...
void Function_129(float fParam0) //Position: 0x6F48 / 28488
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_130(bool bParam0, bool bParam1) //Position: 0x6F65 / 28517
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_131(bool bParam0) //Position: 0x6FE5 / 28645
{
	int iVar0;
...
int Function_132(bool bParam0) //Position: 0x7014 / 28692
{
	int iVar0;
	bool bVar1;
...
bool Function_133() //Position: 0x70CC / 28876
{
	int iVar0;
	bool bVar1;
...
void Function_134(int iParam0) //Position: 0x7106 / 28934
{
	Function_12(iParam0, 0.0f);
	return;
}

bool Function_135(int iParam0) //Position: 0x7112 / 28946
{
	return iParam0->f_20;
}

void Function_136(var uParam0, int iParam1) //Position: 0x711C / 28956
{
	Function_137(uParam0, iParam1, 0);
	return;
}

void Function_137(var uParam0, bool bParam1, bool bParam2) //Position: 0x712A / 28970
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_138(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x7276 / 29302
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_139() //Position: 0x729F / 29343
{
	bool bVar0;
	bool bVar1;
...
void Function_140() //Position: 0x72EA / 29418
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_141() //Position: 0x740C / 29708
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_142() //Position: 0x741C / 29724
{
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
	Function_143(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_283);
	RESET_ANIM_SET_FOR_ACTOR(Global_34573, 1);
	return 1;
}

void Function_143(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9) //Position: 0x7442 / 29762
{
	bool bVar0;
	...
	Function_125(iParam9);
}

void Function_144() //Position: 0x7532 / 30002
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_145() //Position: 0x7547 / 30023
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, 743.202f, 78.425f, 1300.785f, 181.303f, 1, 1, 1);
	bLocal_274 = CREATE_ACTOR_IN_LAYOUT(bLocal_256, "RCM_BLK MacDougal", 561, 741.667f, 78.41f, 1309.608f, 0.0f, 271.085f, 0.0f);
	Function_146(bLocal_274, 1254, 4294967295, 4294967295, 4294967295, 0, 1, 1);
	SET_ACTION_NODE_FOR_ACTOR(bLocal_274, "zombie/PlayDead/Variant1/PlayDeadLoop");
	CREATE_DECAL(0, 741.677f, 78.41f, 1309.608f, 0.75f, 1, 0);
	SET_DRAW_ACTOR(bLocal_273, 1);
	TELEPORT_ACTOR_WITH_HEADING(bLocal_273, 742.896f, 78.41f, 1308.258f, 2.335f, 1, 1, 1);
	TASK_MELEE_ATTACK(bLocal_273, Global_34573, -1.0f);
	ACTOR_ENABLE_VARIABLE_MESH(bLocal_273, 23, true);
	ACTOR_ENABLE_VARIABLE_MESH(bLocal_273, 24, true);
	ACTOR_ENABLE_VARIABLE_MESH(bLocal_273, 25, true);
	ACTOR_END_FORCE_HOLSTER(Global_34573);
	if (_GET_AMMO_AMOUNT(Global_34573, 10, 1) < 0.0f)
	{
		SET_ANIM_SET_FOR_ACTOR(Global_34573, "rfl_base", 1);
		if (ACTOR_GET_NEXT_EQUIP_SLOT(Global_34573) != 6)
		{
			ACTOR_SET_NEXT_EQUIP_SLOT(Global_34573, 6, 0);
		}
		if (GET_WEAPON_EQUIPPED(Global_34573, 6) != 16)
		{
	...
	else if (_GET_AMMO_AMOUNT(Global_34573, 7, 1) < 0.0f)
	{
...
void Function_146(bool bParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, bool bParam6, bool bParam7) //Position: 0x7700 / 30464
{
	int iVar0;
	
	if (Function_152(bParam0) && !Function_151(bParam0, 1))
	{
	...
	Function_147(bParam0, uParam4, uParam5);
}

void Function_147(bool bParam0, bool bParam1, bool bParam2) //Position: 0x7963 / 31075
{
	switch (bParam1)
	{
		case 0x00000000:
...
void Function_148(bool bParam0) //Position: 0x7A15 / 31253
{
	if (!IS_OBJECT_VALID(bParam0))
	{
		return;
...
void Function_149(bool bParam0) //Position: 0x7A49 / 31305
{
...
bool Function_151(bool bParam0, int iParam1) //Position: 0x7DCF / 32207
{
	int iVar0;
...
int Function_152(bool bParam0) //Position: 0x7E11 / 32273
{
	int iVar0;
...
int Function_153() //Position: 0x7E31 / 32305
{
	if (!iLocal_282)
	{
		Function_154(StackVal, StackVal, vLocal_276, bLocal_283);
		bLocal_273 = CREATE_ACTOR_IN_LAYOUT(bLocal_256, "RCM_BLK zombieNastas", 1234, 742.896f, 78.41f, 1308.258f, 0.0f, 2.335f, 0.0f);
		SET_DRAW_ACTOR(bLocal_273, 0);
		TASK_STAND_STILL(bLocal_273, -1.0f, 0, 0);
		iLocal_282 = 1;
	}
	return 1;
}

void Function_154(vector3 vParam0) //Position: 0x7E97 / 32407
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_155(bool bParam0, bool bParam1) //Position: 0x801E / 32798
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_156(float fParam0, float fParam1) //Position: 0x810F / 33039
{
...
void Function_157() //Position: 0x820D / 33293
{
...
void Function_158() //Position: 0x823F / 33343
{
...
int Function_159() //Position: 0x833C / 33596
{
	if (_GET_AMMO_AMOUNT(Global_34573, 10, 1) < 0.0f)
	{
		if (ACTOR_GET_NEXT_EQUIP_SLOT(Global_34573) != 6)
	...
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(742.896f, 78.41f, 1308.258f, 0, 0);
	return 1;
}

int Function_160() //Position: 0x83D4 / 33748
{
	bLocal_283 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "tempcutscenevol", 2, 735.689f, 78.306f, 1298.782f, 0.0f, 0.0f, 0.0f, 25.0f, 15.0f, 30.0f);
	AUDIO_MUSIC_FORCE_TRACK("NRT_ZMB_SONG_01", "SILENT", 0f, 4294967295, 4294967295, 3212836864, 0);
	Function_163(0, 0, 1, 1, 0, 1, 1, bLocal_283, 1, 1, 1, 1);
	Function_161(bLocal_256, 735.689f, 78.306f, 1298.782f, &bLocal_283, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_161(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x846E / 33902
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_162(bool bParam0, bool bParam1) //Position: 0x86DC / 34524
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_163(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x8751 / 34641
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_166(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_3(), 2, Function_166(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
	...
	if (Function_98(0x4000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
		Function_164(0x4000000);
	}
	if (Function_98(0x8000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
...
void Function_164(int iParam0) //Position: 0x89FF / 35327
{
	int iVar0;
...
var Function_165() //Position: 0x8A33 / 35379
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_166(bool bParam0) //Position: 0x8AB2 / 35506
{
	vector3 vVar0;
...
bool Function_167(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x8AC3 / 35523
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int Function_168(var uParam0, int iParam1) //Position: 0x8CD5 / 36053
{
	var uVar0;
...
float Function_169(bool bParam0, bool bParam1) //Position: 0x8D40 / 36160
{
	vector3 vVar0;
...
void Function_170(bool bParam0, bool bParam1) //Position: 0x8D5F / 36191
{
	bool bVar0;
	bool bVar1;
...
bool Function_171(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8DBC / 36284
{
...
bool Function_172() //Position: 0x8E72 / 36466
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_173(int iParam0) //Position: 0x8E89 / 36489
{
	return IS_ACTOR_IN_HOGTIE(iParam0);
}

bool Function_174(bool bParam0) //Position: 0x8E94 / 36500
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_175() //Position: 0x8EA2 / 36514
{
	Function_177(&bLocal_257);
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_275);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_275);
	if (IS_LAYOUTREF_VALID(bLocal_256))
	{
...
int Function_176(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8ED0 / 36560
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_177(int iParam0) //Position: 0x8EFF / 36607
{
	int iVar0;
...
void Function_178(var uParam0, int iParam1) //Position: 0x8F25 / 36645
{
...
void Function_179(var uParam0, int iParam1) //Position: 0x9053 / 36947
{
	int iVar0;
...
bool Function_180(var uParam0, int iParam1) //Position: 0x906D / 36973
{
	int iVar0;
...
void Function_181(var uParam0, int iParam1) //Position: 0x908A / 37002
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_182(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4) //Position: 0x9099 / 37017
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_184(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_183(iParam0));
							}
						}
						...
						uVar6 = Function_184(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_183(float fParam0) //Position: 0x91FA / 37370
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_183(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_184(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x922F / 37423
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_187(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_188()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
	...
	else if ((!Function_187(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_188()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_187(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_185() //Position: 0x9475 / 38005
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_186(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_186(char* cParam0, vector3 vParam1) //Position: 0x94C9 / 38089
{
	char* cVar0[64];
...
bool Function_187(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x95F1 / 38385
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_81(bParam0);
		if (VDIST(Function_81(bParam0), vParam1) >= fParam4)
		{
			return 1;
		}
	}
...
int Function_188() //Position: 0x967B / 38523
{
	if (IS_PS3())
	{
		return 1;
...
bool Function_189(int iParam0) //Position: 0x968A / 38538
{
	int iVar0;
	int iVar1;
	...
	if (!Function_180(iParam0[iVar03], 16))
	{
		...
		Function_192(iParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*iParam0 - 1))
	{
...
void Function_190() //Position: 0x9A05 / 39429
{
	if (!Function_98(128))
	{
		return;
...
bool Function_191() //Position: 0x9A45 / 39493
{
	int iVar0;
...
void Function_192(var uParam0, int iParam1) //Position: 0x9A70 / 39536
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_193() //Position: 0x9A81 / 39553
{
	if (!Function_98(128))
	{
		return;
...
bool Function_194(var uParam0, int iParam1) //Position: 0x9AC3 / 39619
{
...
var Function_195(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x9AD6 / 39638
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_196(uParam0, uVar1, iParam2);
	if (bParam3)
	{
		Function_192(uParam0[iVar03], 8);
	}
	return iVar0;
}

var Function_196(var uParam0, int iParam1, int iParam2) //Position: 0x9B0E / 39694
{
	int iVar0;
...
var Function_197(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x9BD2 / 39890
{
	int iVar0;
