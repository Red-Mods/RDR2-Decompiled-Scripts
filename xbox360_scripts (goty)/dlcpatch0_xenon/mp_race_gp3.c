...
void Function_49(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x2438 / 9272
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_52(char* cParam0, char* cParam1) //Position: 0x2B6B / 11115
{
	char* cVar0[32];
...
var Function_55(int iParam0, int iParam1) //Position: 0x2BFB / 11259
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
int Function_61(int iParam0, float fParam1, bool bParam2) //Position: 0x2F5C / 12124
{
	int iVar0;
	int iVar1;
...
int Function_62(int iParam0) //Position: 0x31A0 / 12704
{
	if (iParam0 == 4294967295)
	{
...
int Function_67(int iParam0, float fParam1, int iParam2) //Position: 0x33B9 / 13241
{
	int iVar0;
	int iVar1;
...
void Function_81(bool bParam0, int iParam1) //Position: 0x4192 / 16786
{
...
void Function_104(int iParam0, bool bParam1) //Position: 0x48E6 / 18662
{
	bool bVar0;
...
int Function_116(float fParam0, int iParam1, bool bParam2) //Position: 0x4BB9 / 19385
{
	if (!Function_122())
	{
		Global_83822 = 1;
...
void Function_145(var uParam0, int iParam1) //Position: 0x5857 / 22615
{
...
bool Function_213(char* cParam0, int iParam1, bool bParam2) //Position: 0x88E9 / 35049
{
	char* cVar0[64];
...
void Function_232(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) //Position: 0x90D7 / 37079
{
	vector3 vVar0;
	int iVar3;
...
void Function_260(char* cParam0) //Position: 0x9EC5 / 40645
{
	var uVar0;
