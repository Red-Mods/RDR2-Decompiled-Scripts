...
void main() //Position: 0x0 / 0
{
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_31))
	{
		Function_133("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(iLocal_31);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_24 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x479 / 1145
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(iLocal_31))
								{
									...
									{
										iLocal_31 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_31 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(iLocal_31))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_31))
		{
			Function_133("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(iLocal_31);
		}
...
bool Function_7(bool bParam0, int iParam1, int iParam2) //Position: 0x85D / 2141
{
	int iVar0;
	int iVar1;
...
int Function_8(int iParam0, int iParam1) //Position: 0x879 / 2169
{
	return Function_9(iParam0, "UseQuit", iParam1);
}

int Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x890 / 2192
{
	int iVar0;
	bool bVar1;
...
float Function_10(int iParam0) //Position: 0x8D5 / 2261
{
	return Function_11(iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(float fParam0, var uParam1, int iParam2) //Position: 0x8F2 / 2290
{
	int iVar0;
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_29, &uLocal_28);
		...
		case 0x00000006:
			...
			iVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_69(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(iVar0))
			{
...
float Function_23(int iParam0) //Position: 0x1CCB / 7371
{
...
int Function_25(int iParam0) //Position: 0x1CEE / 7406
{
...
bool Function_31(int iParam0) //Position: 0x1D5B / 7515
{
	return Function_7(iParam0, "OneShotKill", 0);
}

int Function_32(int iParam0, int iParam1) //Position: 0x1D75 / 7541
{
	return Function_9(iParam0, "ParentAnimNode", iParam1);
}

bool Function_33(int iParam0) //Position: 0x1D93 / 7571
{
	return Function_7(iParam0, "LinkToParentAnim", 0);
}

bool Function_34(int iParam0) //Position: 0x1DB2 / 7602
{
	int iVar0;
	int iVar1;
	...
	{
		if (Local_11[iVar012].f_12 == iParam0)
		{
...
bool Function_36(int iParam0) //Position: 0x1E04 / 7684
{
...
void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E31 / 7729
{
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_40(uParam0->f_12, &iVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_39(), Function_40(uParam0->f_12, &iVar10), 0, bVar9);
	}
	if (IS_GRINGO_COMPONENT_VALID(iVar4))
	{
		...
		cVar12 = GRINGO_ANIM_GET_ACT_FILENAME(iVar4);
		cVar13 = GRINGO_ANIM_GET_ACT_ROOTNODE(iVar4);
...
int Function_40(int iParam0, int iParam1) //Position: 0x2121 / 8481
{
...
int Function_42(int iParam0, int iParam1) //Position: 0x214D / 8525
{
	return Function_9(iParam0, "UserPhysAttachBone", iParam1);
}

int Function_43(int iParam0, int iParam1) //Position: 0x216F / 8559
{
...
int Function_45(var uParam0, int iParam1) //Position: 0x21B0 / 8624
{
	return Function_9(uParam0, "TargetAttachBone", iParam1);
}

int Function_46(var uParam0, int iParam1) //Position: 0x21D0 / 8656
{
	return Function_9(uParam0, "TargetAttachSlot", iParam1);
}

void Function_47(int iParam0, bool bParam1) //Position: 0x21F0 / 8688
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		uVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(iVar0, bParam1);
		cVar3 = GRINGO_ANIM_GET_ACT_FILENAME(iVar0);
		cVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(iVar0);
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x229E / 8862
{
	int iVar0;
...
var Function_51(int iParam0) //Position: 0x2345 / 9029
{
...
void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2399 / 9113
{
	float fVar0;
...
int Function_57(int iParam0) //Position: 0x23D8 / 9176
{
	return Function_11(iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2403 / 9219
{
	return GRINGO_GET_USE_COMPONENT_HEADING(iParam0);
}

vector3 Function_59(int iParam0) //Position: 0x240E / 9230
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
...
bool Function_60(int iParam0) //Position: 0x2504 / 9476
{
	return Function_7(iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2526 / 9510
{
...
bool Function_64(int iParam0) //Position: 0x2561 / 9569
{
...
bool Function_67(var uParam0, int iParam1) //Position: 0x25A3 / 9635
{
...
int Function_68(bool bParam0) //Position: 0x25CE / 9678
{
	...
	{
		if (!GRINGO_IS_PROP_READY(GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar1, iParam0)))
		{
			return 0;
		}
		iVar1 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, iParam0, iVar1 + 1);
	}
	iVar2 = 0;
	uVar4 = GRINGO_GET_ATTRIBUTE(iParam0, iVar2);
...
void Function_71(int iParam0, bool bParam1) //Position: 0x2753 / 10067
{
	...
	while (iVar5 >= 4294967295)
	{
		...
		bVar7 = GRINGO_GET_PHYSINST(uVar6);
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(uLocal_28));
		iLocal_29 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
int Function_73(int iParam0) //Position: 0x2C88 / 11400
{
...
bool Function_76(int iParam0) //Position: 0x2CE7 / 11495
{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2E1E / 11806
{
...
void Function_83(bool bParam0, bool bParam1, float fParam2) //Position: 0x3288 / 12936
{
	bool bVar0;
	bool bVar1;
	...
	if (!IS_OBJECT_IN_OBJECTSET(bParam0, Function_92()))
	{
		...
		if (bParam1)
		{
			fParam2 = (fParam2 - (NET_GET_NET_TIME() - GET_CURRENT_GAME_TIME()));
		}
		else
		{
		...
		DECOR_SET_FLOAT(bParam0, Function_84(), fParam2);
...
int Function_87(int iParam0, int iParam1, int iParam2) //Position: 0x338D / 13197
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_88((iParam1 - 1)), 1) - 1);
	return SHIFT_RIGHT((iVar0 && iParam0), iParam2);
}

var Function_88(int iParam0) //Position: 0x33AC / 13228
{
...
int Function_90(int iParam0) //Position: 0x33C2 / 13250
{
	int iVar0;
...
int Function_96(int iParam0) //Position: 0x3527 / 13607
{
	if (IS_ACTOR_LOCAL_PLAYER(*iParam0))
	{
		...
		CLEAR_STAT_MESSAGE();
		SET_STAT_MESSAGE(STRING_TO_HASH("pickup_deadeye_header"), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, 0, 0, 0);
	}
	return 1;
}
...
int Function_97(int iParam0) //Position: 0x3574 / 13684
{
	if (IS_ACTOR_LOCAL_PLAYER(*iParam0))
	{
		...
		CLEAR_STAT_MESSAGE();
		SET_STAT_MESSAGE(STRING_TO_HASH("pickup_health_header"), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, 0, 0, 0);
	}
	return 1;
}
...
int Function_98(var uParam0, bool bParam1) //Position: 0x35C2 / 13762
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(*uParam0))
	{
		...
		if (DECOR_GET_INT_VERBOSE(iParam1, Function_102(), &iVar1))
		{
			...
			iVar5 = GET_AMMO_ENUM(Var2);
			if (Function_99(iVar5, 1))
			{
				fVar6 = TO_FLOAT(StackVal);
				if (fVar6 < 0.0f)
				{
					if (!bVar4)
					{
						CLEAR_STAT_MESSAGE();
						SET_STAT_MESSAGE(STRING_TO_HASH(GET_WEAPON_DISPLAY_NAME(Var2)), "", 1084227584, 0, 2, 4294967295, 0, 0, 0, 0, 0, 0, 0);
					}
					_ADD_AMMO_OF_TYPE(*uParam0, iVar5, fVar6, 1, 0);
				}
			}
			if (bVar4)
			{
...
bool Function_99(int iParam0, int iParam1) //Position: 0x3668 / 13928
{
...
int Function_101() //Position: 0x369E / 13982
{
...
int Function_110(var uParam0, var uParam1, bool bParam2, int iParam3) //Position: 0x37D3 / 14291
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(*uParam0))
	{
		...
		while (iVar1 <= 17)
		{
			...
			{
				iVar3 = iVar1;
				_ADD_AMMO_OF_TYPE(*uParam0, iVar3, TO_FLOAT(Function_113(&Global_83591 + 276, iVar3)), 1, 0);
				iVar0 = 1;
			}
			iVar1++;
		}
				...
				while (iVar1 <= 27)
				{
					...
					if (Function_112(bVar2))
					{
						if (Function_111(bVar2))
						{
							...
							if (Function_99(iVar3, 1))
							{
								bVar24 = (StackVal - CEIL(_GET_AMMO_AMOUNT(*uParam0, iVar3, 1)));
								if (bVar24 >= 0)
								{
									_ADD_AMMO_OF_TYPE(*uParam0, iVar3, TO_FLOAT(bVar24), 1, 0);
								}
								if (!ACTOR_HAS_WEAPON(*uParam0, bVar2))
								{
			...
			case 0x00000002:
				...
				while (bVar2 <= 40)
				{
					if (Global_84559[bVar2])
					{
						...
						if (Function_99(iVar3, 1))
						{
							bVar24 = (Function_113(&Global_83591 + 276, iVar3) - CEIL(_GET_AMMO_AMOUNT(*uParam0, iVar3, 1)));
							if (bVar24 >= 0)
							{
								_ADD_AMMO_OF_TYPE(*uParam0, iVar3, TO_FLOAT(bVar24), 1, 0);
							}
...
int Function_113(int iParam0, int iParam1) //Position: 0x3AEA / 15082
{
	if (Function_99(iParam1, 1))
	{
...
bool Function_119(int iParam0) //Position: 0x3B50 / 15184
{
	return Function_7(iParam0, "DrawWeapon", 0);
}

bool Function_120(int iParam0) //Position: 0x3B69 / 15209
{
...
void Function_121(int iParam0, int iParam1) //Position: 0x3B83 / 15235
{
	...
	iParam0 = iParam0;
	uVar1 = Function_122(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
int Function_122(var uParam0, int iParam1) //Position: 0x3BBB / 15291
{
	...
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		...
		if (!Function_69(iParam0->f_40, 2))
		{
			...
			else
			{
				...
				fVar33 = Function_124(iParam0->f_12);
				if (!fVar33 != 0.0f)
				{
					if (fVar33 < 0.0f)
					{
...
int Function_124(int iParam0) //Position: 0x3E9B / 16027
{
	return Function_11(iParam0, "ActivationCone", 0.0f);
}

bool Function_125(bool bParam0, int iParam1) //Position: 0x3EB8 / 16056
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
int Function_126(int iParam0) //Position: 0x3F54 / 16212
{
...
void Function_130(int iParam0, int iParam1) //Position: 0x3FE6 / 16358
{
	int iVar0;
	var uVar1;
	...
	{
		Function_131(&(Local_11[iLocal_2412]), uParam0);
		iLocal_24++;
	}
	if (GRINGO_GET_CHILD_COMPONENT_COUNT(uParam0) >= 0)
	{
		...
		while (iVar0 <= 0 && *iParam1 > 1)
		{
			...
			Function_130(uVar1, iParam1);
			iVar0 = GRINGO_GET_INDEX_OF_NEXT_CHILD(0, iParam0, iVar0 + 1);
		}
	}
	return;
}
