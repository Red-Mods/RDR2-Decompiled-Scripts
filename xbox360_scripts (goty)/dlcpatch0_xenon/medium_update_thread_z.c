	...
	switch (StackVal)
	{
		case 0x00000000:
			switch (StackVal)
			{
				case 0x00000000:
					...
					{
						Function_116();
						SET_JOURNAL_ENTRY_PROGRESS(Local_38.f_24, -1.0f, 1, 0);
						Local_38.f_32 = 1;
					}
					Local_38.f_4 = 1;
					break;
		...
		case 0x00000001:
			switch (StackVal)
			{
				case 0x00000000:
					Function_116();
					SET_JOURNAL_ENTRY_PROGRESS(Local_38.f_24, Local_38.f_12, 1, 0);
...
void Function_5(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0xEB3 / 3763
{
	struct<4> Var0;
	var uVar4;
...
void Function_39(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x1FA6 / 8102
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
	...
	if (!Global_49306)
	{
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				{
					fVar19 = (Function_49(iParam0) - fParam2);
					fVar20 = fParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_47(iParam0, fVar19, fVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_44(fVar19, fParam2, &iVar17, &iVar18);
...
struct<32> Function_43(char* cParam0, char* cParam1) //Position: 0x26E1 / 9953
{
	char* cVar0[32];
...
var Function_46(int iParam0, int iParam1) //Position: 0x2771 / 10097
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
int Function_52(int iParam0, float fParam1, bool bParam2) //Position: 0x2AD2 / 10962
{
	int iVar0;
	int iVar1;
...
int Function_53(int iParam0) //Position: 0x2D16 / 11542
{
	if (iParam0 == 4294967295)
	{
...
int Function_58(int iParam0, float fParam1, int iParam2) //Position: 0x2F2F / 12079
{
	int iVar0;
	int iVar1;
...
void Function_76(bool bParam0, int iParam1) //Position: 0x3D3A / 15674
{
...
var Function_84(int iParam0, int iParam1, var uParam2) //Position: 0x403E / 16446
{
...
void Function_85() //Position: 0x405E / 16478
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Local_38.f_24, 1.0f, 0, 0);
	return;
}
...
void Function_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, bool bParam10) //Position: 0x4BA0 / 19360
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
	...
	switch (StackVal)
	{
		case 0x00000000:
			switch (StackVal)
			{
				case 0x00000000:
					...
					{
						Function_130();
						SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, -1.0f, 1, 0);
						Local_16.f_32 = 1;
					}
					Local_16.f_4 = 1;
					break;
		...
		case 0x00000001:
			switch (StackVal)
			{
				case 0x00000000:
					Function_130();
					SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, Local_16.f_12, 1, 0);
					Local_16.f_4 = 1;
					break;
		...
		case 0x00000003:
			switch (StackVal)
			{
				case 0x00000000:
					...
					SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, 0.0f, 1, 0);
					Local_16.f_4 = 1;
					break;
			...
			switch (StackVal)
			{
				case 0x00000000:
					...
					if (UI_ISACTIVE("ZMeter"))
					{
						...
						Function_123();
						SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, 0.5f, 1, 0);
					}
					Local_16.f_4 = 1;
					break;
...
void Function_128() //Position: 0x607A / 24698
{
	...
	SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, 1.0f, 0, 0);
	return;
}
...
void Function_131() //Position: 0x6123 / 24867
{
	...
	if (Function_117(5))
	{
		CLEAR_JOURNAL_ENTRY(Local_38.f_24);
		PREPEND_JOURNAL_ENTRY(Local_38.f_24, false);
		SET_JOURNAL_ENTRY_PROGRESS(Local_38.f_24, 0.0f, 0, 0);
...
void Function_133() //Position: 0x621A / 25114
{
	...
	if (Function_117(5))
	{
		CLEAR_JOURNAL_ENTRY(Local_16.f_24);
		PREPEND_JOURNAL_ENTRY(Local_16.f_24, false);
		SET_JOURNAL_ENTRY_PROGRESS(Local_16.f_24, 0.0f, 0, 0);
...
bool Function_142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x6B0C / 27404
{
...
void Function_148(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4) //Position: 0x6CD2 / 27858
{
	var uVar0;
	var uVar3;
	var uVar6;
	...
	if (IS_VOLUME_VALID(bParam1))
	{
		...
		{
			TASK_GO_NEAR_COORD(bParam0, &uVar3, iParam3, iParam4);
		}
		else
		{
			TASK_GO_NEAR_COORD(bParam0, &uVar0, iParam3, iParam4);
		}
...
struct<24> Function_179(bool bParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, int iParam7) //Position: 0x7917 / 30999
{
	bool bVar0;
	struct<13> Var1;
	float fVar19;
	...
	Function_178(&Var1);
	fVar20 = VDIST(Function_178(&Var1), vParam1);
	...
	while (Var1.f_12 >= fParam6 && !bVar0)
	{
		...
		UNK_0x19D652F9(bParam0, FABS(fParam4), &Var7, &Var1);
		Function_178(&Var1);
		fVar21 = VDIST(Function_178(&Var1), vParam1);
		if (fVar21 > fVar20)
		{
			fVar20 = fVar21;
			Var13 = { StackVal, StackVal, StackVal, StackVal, StackVal, Var1 };
	...
	{
		UNK_0x19D652F9(bParam0, (fParam4 / 2.0f), &Var13, &Var1);
		UNK_0x19D652F9(bParam0, (-1.0f * (fParam4 / 2.0f)), &Var13, &Var7);
		return StackVal, StackVal, StackVal, StackVal, StackVal, Function_179(StackVal, StackVal, bParam0, vParam1, (fParam4 / 10.0f), Function_181(Var7.f_12, Var1.f_12), Function_180(Var7.f_12, Var1.f_12), (iParam7 - 1));
	}
...
int Function_186() //Position: 0x7B29 / 31529
{
	...
	if (!Global_28179 != Global_28178)
	{
		...
		{
			STREAMING_REQUEST_ACTOR(iVar9, SHIFT_LEFT(1, Global_27774[Global_2817913].f_20), false);
			STREAMING_EVICT_ACTOR(iVar9, SHIFT_LEFT(1, Global_27774[Global_2817813].f_20));
...
void Function_204(bool bParam0) //Position: 0x8A94 / 35476
{
	...
	if (Global_27774[bParam013].f_48 == 4294967295 && Global_27774[bParam013].f_48 == 0)
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_210(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), 0, 0);
...
void Function_206(int iParam0, bool bParam1) //Position: 0x8C9B / 35995
{
	bool bVar0;
...
int Function_245(int iParam0, float fParam1, bool bParam2) //Position: 0xB4B6 / 46262
{
	int iVar0;
	...
	if (bParam2)
	{
		Function_39(iParam0, 1, fParam1, 0, 0, 0x40400000, 0, 0);
	}
	return 1;
}
