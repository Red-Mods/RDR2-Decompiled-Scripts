...
void main() //Position: 0x0 / 0
{
	...
	vVar13 = { -4298.819f, 22.038f, 4407.504f };
	...
	bVar16 = FIND_NAMED_LAYOUT("PuntaOrgullo_layout");
	if (IS_LAYOUTREF_VALID(bVar16))
	{
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "punv_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			...
			uVar20 = Function_3(bVar17, uVar5, 5.5E-06f, 0, 0, 1);
			...
			uVar21 = Function_3(bVar17, uVar6, 1E-05f, 0, 0, 1);
			...
			uVar22 = Function_3(bVar17, uVar7, 2E-05f, 0, 0, 1);
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "punv_flk_EAST_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			...
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar24, 10);
			uVar25 = Function_3(bVar17, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar26 = Function_3(bVar17, uVar5, 5.5E-06f, 0, 0, 1);
			...
			uVar27 = Function_3(bVar17, uVar6, 2E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(bVar17, uVar7, 2E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(bVar17, uVar10, 1E-05f, 0, 0, 1);
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "punv_flk_WEST_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			uVar30 = Function_3(bVar17, uVar0, 3E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(bVar17, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar32 = Function_3(bVar17, uVar5, 5.5E-06f, 0, 0, 1);
			...
			uVar33 = Function_3(bVar17, uVar6, 2E-05f, 0, 0, 1);
			...
			uVar34 = Function_3(bVar17, uVar7, 2.5E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(bVar17, uVar10, 1E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(bVar17, uVar9, 1E-05f, 0, 0, 1);
			...
			Function_3(bVar17, Global_30750[7], 1.5E-05f, 0, 0, 1);
			Function_3(bVar17, uVar1, 3E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0x1478 / 5240
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1487 / 5255
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x14DC / 5340
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0x155C / 5468
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0x1578 / 5496
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x15B6 / 5558
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x15D2 / 5586
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x15E2 / 5602
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x165A / 5722
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x16C6 / 5830
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x1732 / 5938
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1777 / 6007
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1783 / 6019
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x17FF / 6143
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x180C / 6156
{
	if (!Function_4(128))
	{
		return;
