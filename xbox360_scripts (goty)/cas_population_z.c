...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Cas", 4);
	Function_12("Loading Casa Madrugada population file", 3);
	Global_30839++;
	...
	uVar1 = Function_11("zombie_dogs", 0);
	Function_10(&uVar1, 1240, 10.0f, 0, 0);
	...
	bVar3 = FIND_NAMED_LAYOUT("CasaMadrugada_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "casv_region");
	...
	Function_5("Finished loading Casa Madrugada population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC82 / 3202
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC91 / 3217
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCE6 / 3302
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD66 / 3430
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD82 / 3458
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDC0 / 3520
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDDC / 3548
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDEC / 3564
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE31 / 3633
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE3D / 3645
{
	int iVar0;
	int iVar1;
...
var Function_11(int iParam0, int iParam1) //Position: 0xEB9 / 3769
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xEC6 / 3782
{
	if (!Function_4(128))
	{
		return;
