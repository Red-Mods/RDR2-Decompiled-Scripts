...
void main() //Position: 0x0 / 0
{
	...
	uVar0 = Function_18("snakes", 0);
	Function_13(&uVar0, 1059, 3.0f, 15, 1, 0);
	...
	uVar3 = Function_18("nArmadillo", 0);
	Function_16(&uVar3, 1081, 6.5f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar7))
	{
		...
		if (IS_VOLUME_VALID(bVar8))
		{
			Function_8(bVar8, uVar1, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar8))
		{
			Function_8(bVar8, uVar3, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar8))
		{
			Function_8(bVar8, uVar0, 4E-05f, 0, 0, 1);
		}
		else
		{
		...
		else
		{
			...
			if (IS_VOLUME_VALID(bVar8))
			{
				Function_3(bVar8, uVar4, 2, 3, 1, 0, 1);
			}
			else
			{
				LOG_ERROR("fod_pop: Cannot find fodv_soldiers_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar8))
		{
			Function_8(bVar8, uVar6, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xF53 / 3923
{
	bool bVar0;
...
var Function_8(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1059 / 4185
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x11D7 / 4567
{
	int iVar0;
...
var Function_15(int iParam0) //Position: 0x1243 / 4675
{
	int iVar0;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x12AF / 4783
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x132B / 4907
{
	int iVar0;
	int iVar1;
...
var Function_18(bool bParam0, int iParam1) //Position: 0x1370 / 4976
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_19(int iParam0) //Position: 0x137D / 4989
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_20(bool bParam0, var uParam1) //Position: 0x1389 / 5001
{
	if (!Function_9(128))
	{
		return;
