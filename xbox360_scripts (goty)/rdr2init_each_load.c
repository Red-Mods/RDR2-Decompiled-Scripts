...
void main() //Position: 0x0 / 0
{
	...
	AI_SPEECH_REGISTER_TAG(0, "AudioActivityPatrol", 0, 0);
	AI_SPEECH_REGISTER_TAG(1, "nAudioAlly", 1, 0);
	AI_SPEECH_REGISTER_TAG(2, "AudioNeutral", 1, 0);
	AI_SPEECH_REGISTER_TAG(3, "AudioEnemy", 1, 0);
	AI_SPEECH_REGISTER_TAG(6, "CombatRangeWeaponDrawnWhenVisible", 1, 0);
	AI_SPEECH_REGISTER_TAG(7, "Player", 1, 1);
	AI_SPEECH_REGISTER_TAG(8, "Player", 1, 0);
	AI_SPEECH_REGISTER_TAG(9, "AudioDistanceClose", 1, 0);
	AI_SPEECH_REGISTER_TAG(11, "AudioDistanceSomewhatClose", 1, 0);
	AI_SPEECH_REGISTER_TAG(10, "AudioDistanceFar", 1, 0);
	AI_SPEECH_REGISTER_TAG(12, "AnybodyAround", 0, 1);
	AI_SPEECH_REGISTER_TAG(13, "AnybodyAround", 0, 0);
	AI_SPEECH_REGISTER_TAG(14, "AlliesAreAround", 0, 0);
	AI_SPEECH_REGISTER_TAG(15, "AlliesAreAround", 0, 1);
	AI_SPEECH_REGISTER_TAG(16, "ObjectClassGenderFemale", 1, 0);
	AI_SPEECH_REGISTER_TAG(17, "ObjectClassGenderMale", 1, 0);
	AI_SPEECH_REGISTER_TAG(18, "AudioHealthDying", 0, 0);
	AI_SPEECH_REGISTER_TAG(19, "AudioHealthHealthy", 0, 0);
	AI_SPEECH_REGISTER_TAG(20, "AudioHealthHealthy", 0, 1);
	AI_SPEECH_REGISTER_TAG(21, "AudioHealthImmobilized", 0, 0);
	AI_SPEECH_REGISTER_TAG(22, "AudioHitByMeleeRecently", 0, 0);
	AI_SPEECH_REGISTER_TAG(23, "AudioHogtied", 0, 0);
	AI_SPEECH_REGISTER_TAG(24, "CombatShooting", 0, 1);
	AI_SPEECH_REGISTER_TAG(25, "WasVisibleJustNow", 1, 1);
	AI_SPEECH_REGISTER_TAG(26, "WasVisibleJustNow", 1, 0);
	AI_SPEECH_REGISTER_TAG(27, "AudioStateIdle", 0, 0);
	AI_SPEECH_REGISTER_TAG(28, "AudioStateSearching", 0, 0);
	AI_SPEECH_REGISTER_TAG(29, "AudioStateCombat", 0, 0);
	AI_SPEECH_REGISTER_TAG(30, "AudioStateSurrendered", 0, 0);
	AI_SPEECH_REGISTER_TAG(31, "IsZombie", 1, 0);
	AI_SPEECH_REGISTER_TAGS_END();
	uVar1 = CREATE_AI_SPEECH_PACKAGE_IN_LAYOUT(cVar0, "Default");
...
void Function_1() //Position: 0x987 / 2439
{
	int iVar0;
	var uVar1;
...
var Function_2(bool bParam0) //Position: 0xBA4 / 2980
{
	bool bVar0;
...
int Function_3(bool bParam0) //Position: 0xC95 / 3221
{
...
var Function_4() //Position: 0xCBD / 3261
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_5() //Position: 0xCC6 / 3270
{
...
void Function_6() //Position: 0x206E / 8302
{
	int iVar0;
...
int Function_7(var uParam0, bool bParam1) //Position: 0x209E / 8350
{
	int iVar0;
...
bool Function_8(int iParam0) //Position: 0x20DB / 8411
{
...
var Function_9(int iParam0) //Position: 0x20F2 / 8434
{
...
bool Function_10(int iParam0) //Position: 0x210C / 8460
{
...
void Function_11() //Position: 0x2122 / 8482
{
...
void Function_12() //Position: 0x2153 / 8531
{
...
void Function_13() //Position: 0x217C / 8572
{
...
void Function_14() //Position: 0x21A5 / 8613
{
...
void Function_15() //Position: 0x21C1 / 8641
{
...
void Function_16() //Position: 0x21E3 / 8675
{
...
void Function_17() //Position: 0x2205 / 8709
{
...
void Function_18() //Position: 0x2227 / 8743
{
...
void Function_19() //Position: 0x2249 / 8777
{
...
void Function_20() //Position: 0x2296 / 8854
{
...
void Function_21(int iParam0, int iParam1) //Position: 0x2314 / 8980
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_22() //Position: 0x2572 / 9586
{
	return Global_12976.f_156;
}

var Function_23() //Position: 0x257D / 9597
{
	return Global_12976.f_152;
}

void Function_24() //Position: 0x2588 / 9608
{
	SPEECH_CONTEXT_SET_ALLOW_PHRASE_REUSE(29, 1);
	return;
}

void Function_25() //Position: 0x2594 / 9620
{
...
void Function_26() //Position: 0x25BC / 9660
{
...
void Function_27() //Position: 0x2844 / 10308
{
...
void Function_28() //Position: 0x28B6 / 10422
{
...
void Function_29() //Position: 0x28E4 / 10468
{
...
void Function_30() //Position: 0x29B4 / 10676
{
...
void Function_31(int iParam0, int iParam1, int iParam2) //Position: 0x2DC7 / 11719
{
...
bool Function_32(int iParam0) //Position: 0x2EE5 / 12005
{
...
void Function_33(int iParam0, float fParam1, int iParam2) //Position: 0x2EFB / 12027
{
	if (!Function_32(iParam0))
	{
...
void Function_34(int iParam0, int iParam1) //Position: 0x2FBE / 12222
{
	if (!Function_32(iParam0))
	{
...
void Function_35(int iParam0, char* cParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6) //Position: 0x3069 / 12393
{
	if (!Function_32(iParam0))
	{
...
bool Function_36(int iParam0) //Position: 0x318A / 12682
{
...
void Function_37() //Position: 0x319F / 12703
{
...
void Function_38(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x31B7 / 12727
{
...
bool Function_39(int iParam0) //Position: 0x32AB / 12971
{
...
bool Function_40() //Position: 0x32C0 / 12992
{
	if (Function_41(Global_83864.f_1252, 1024))
	{
...
bool Function_41(var uParam0, bool bParam1) //Position: 0x32DB / 13019
{
	return (uParam0 && bParam1) == 0;
}

void Function_42() //Position: 0x32E8 / 13032
{
	int iVar0;
	...
	while (iVar0 < 14)
	{
		Global_26121[iVar0] = Function_43(iVar0);
		iVar0++;
	}
	return;
}

var Function_43(bool bParam0) //Position: 0x3340 / 13120
{
	vector3 vVar0[20];
	int iVar61;
	int iVar62;
	...
	bVar65 = CREATE_FORMATION_IN_LAYOUT(Global_26120, uVar64, iVar63);
