...
void main() //Position: 0x0 / 0
{
	...
	iLocal_74 = 0;
	Function_97(uScriptParam_0, &iLocal_74);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(Local_1[iVar312]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), Local_1[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", Local_1[iVar312].f_16);
							Function_82(Local_1[iVar312].f_16, 1);
							...
							{
								Function_75(&(Local_1[iVar312]), 0);
							}
							else if (Local_1[iVar312].f_44 < 8)
							{
								Function_74(&(Local_1[iVar312]));
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_81))
	{
		Function_100("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(iLocal_81);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_74 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x478 / 1144
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
			...
			if (Function_12(iParam0) <= Function_10(iParam0->f_12))
			{
				if (IS_ACTOR_VALID(iParam0->f_16))
				{
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						...
						{
							uVar1 = Function_8(iParam0->f_12, &bVar0);
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(iLocal_81))
								{
									...
									{
										iLocal_81 = ADD_SCRIPT_USE_CONTEXT(uVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_81 = ADD_SCRIPT_USE_CONTEXT(uVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(iLocal_81))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_81))
		{
			Function_100("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(iLocal_81);
		}
...
bool Function_6(bool bParam0) //Position: 0x762 / 1890
{
	...
	vVar2 = { GET_STICK_X(uVar0, 0, 1), GET_STICK_Y(uVar0, 0, 1), 0.0f };
	fVar5 = VMAG(vVar2);
	if (fVar5 >= 0.2f)
	{
...
bool Function_7(bool bParam0, char* cParam1, int iParam2) //Position: 0x85C / 2140
{
	int iVar0;
	bool bVar1;
	
	bVar1 = GET_GRINGO_BOOL_ATTR(cParam1, bParam0, &iVar0);
	if (iVar0 >= 0)
	{
		return bVar1;
	}
...
int Function_8(int iParam0, int iParam1) //Position: 0x878 / 2168
{
	return Function_9(iParam0, "UseQuit", iParam1);
}

int Function_9(int iParam0, int iParam1, int iParam2) //Position: 0x88F / 2191
{
	int iVar0;
	int iVar1;
...
float Function_10(int iParam0) //Position: 0x8D4 / 2260
{
	return Function_11(iParam0, "MinimumUseTime", 0.0f);
}

int Function_11(bool bParam0, int iParam1, int iParam2) //Position: 0x8F1 / 2289
{
	int iVar0;
	
	iVar0 = iParam2;
	GET_GRINGO_FLOAT_ATTR(&iVar0, iParam1, iParam0);
	return iVar0;
}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	{
		Function_83("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_83("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_83("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			iVar0 = Function_48(iParam0->f_16, iParam0->f_12, bVar33);
			...
			{
				if (GRINGO_PLAY_ANIM_ON_ACTOR(iParam0->f_16, iVar0, bVar33))
				{
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(iParam0->f_12))
					{
						GRINGO_ENABLE_PLAYER_CONTROL(iParam0->f_16, 1);
					...
					while (iVar11 >= 4294967295)
					{
						...
						{
							Function_47(iVar1, iParam0->f_16);
							if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
							{
								iVar34 = GRINGO_GET_PROP_FROM_COMPONENT(iVar1);
								if (IS_PHYSINST_VALID(iVar34))
								{
									ADD_CAMERA_COLLISION_EXCLUSION(GET_GAME_CAMERA(), iVar34, 0);
								}
							}
						}
								...
								if (iVar23 == GRINGO_GET_ATTRIBUTE_HASH(uVar15))
								{
									...
									while (iVar11 >= 4294967295)
									{
										...
										if (GRINGO_ATTACH_PROP_TO_ANIM(iParam0->f_16, iVar1, Function_9(iVar1, "AttachBone", &bVar10), Function_9(iVar1, "AttachLocator", &bVar10), 1))
										{
											if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
											{
												iVar35 = GRINGO_GET_PROP_FROM_COMPONENT(iVar1);
												if (IS_PHYSINST_VALID(iVar35))
												{
													ADD_CAMERA_COLLISION_EXCLUSION(GET_GAME_CAMERA(), iVar35, 0);
												}
											}
											Function_47(iVar1, iParam0->f_16);
										}
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_79, &uLocal_78);
					if (GET_OBJECT_TYPE(bVar8) != 15)
					{
						iVar22 = GET_PHYSINST_FROM_OBJECT(bVar8);
						if (IS_PHYSINST_VALID(iVar22))
						{
							if (!IS_PROP_FIXED(iVar22))
							{
								Function_55(iParam0 + 40, 256);
								SET_PROP_FIXED(iVar22, 1);
							}
							else
							{
				...
				if (IS_GRINGO_COMPONENT_VALID(iVar0))
				{
					...
					{
						iVar2 = GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 3);
						if (IS_GRINGO_COMPONENT_VALID(iVar2))
						{
							bVar9 = Function_34(iVar2);
					...
					bVar10 = false;
					cVar7 = Function_32(iParam0->f_12, &bVar10);
					if (bVar10)
					{
						iVar2 = GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 3);
						if (IS_GRINGO_COMPONENT_VALID(iVar2))
						{
							...
							if (IS_ACTOR_VALID(bVar9))
							{
								SET_ACTION_NODE_FOR_ACTOR(bVar9, cVar7);
							}
						}
					}
				}
		...
		case 0x00000006:
			...
			iVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_73(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(iVar0))
			{
				if (!GRINGO_IS_ACTOR_PLAYING_ANIM(iParam0->f_16, iVar0))
				{
						...
						else
						{
							...
							if (iVar43 >= 0)
							{
								if (GET_CURRENT_GAME_TIME() - fVar42) <= RAND_FLOAT_RANGE(fVar45, fVar44)
								{
									...
									if (iVar55 >= 1)
									{
										cVar56 = STRING_GET_TOKEN(1);
										if (STRINGS_ARE_EQUAL("super", cVar56))
										{
											iVar54 = 3;
										}
										else if (STRINGS_ARE_EQUAL("shout", cVar56))
										{
											iVar54 = 2;
										}
										else
...
void Function_18(bool bParam0, var uParam1) //Position: 0x1B97 / 7063
{
	int iVar0;
	char* cVar1[16];
	int iVar5;
	...
	while (iVar0 < (17 - 1))
	{
		strcpy(&cVar1, "nAmmoType_", 16);
		straddi(&cVar1, iVar0, 16);
		iVar5 = DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "nAmmoType_");
		if (iVar5 != 0)
		{
			PRINTSTRING("Giving ammo type: ");
			PRINTSTRING(GET_AMMO_ENUM_STRING_FROM_ENUM(iVar0));
			PRINTSTRING(", Amount: ");
			PRINTINT(iVar5);
			PRINTSTRING(", to ");
			PRINTSTRING(GET_OBJECT_NAME(bParam0));
			PRINTNL();
			_ADD_AMMO_OF_TYPE(bParam0, iVar0, TO_FLOAT(iVar5), 1, 1);
		}
		iVar0++;
	}
	return;
...
bool Function_19() //Position: 0x1C43 / 7235
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1C74 / 7284
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1CE8 / 7400
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1D5A / 7514
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(int iParam0) //Position: 0x1D68 / 7528
{
	return Function_11(iParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1D7E / 7550
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

int Function_25(int iParam0) //Position: 0x1D8B / 7563
{
	return Function_11(iParam0, "MoveAllowance", 1.5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1DAB / 7595
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1DBA / 7610
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DD9 / 7641
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DDF / 7647
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DED / 7661
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(char* cParam0) //Position: 0x1DF8 / 7672
{
	return Function_7(cParam0, "OneShotKill", 0);
}

int Function_32(int iParam0, int iParam1) //Position: 0x1E12 / 7698
{
	return Function_9(iParam0, "ParentAnimNode", iParam1);
}

bool Function_33(char* cParam0) //Position: 0x1E30 / 7728
{
	return Function_7(cParam0, "LinkToParentAnim", 0);
}

bool Function_34(int iParam0) //Position: 0x1E4F / 7759
{
	int iVar0;
	int iVar1;
	...
	{
		if (Local_1[iVar012].f_12 == iParam0)
		{
...
bool Function_35(char* cParam0) //Position: 0x1E82 / 7810
{
	return Function_7(cParam0, "LinkParentToAnim", 0);
}

bool Function_36(char* cParam0) //Position: 0x1EA1 / 7841
{
	return Function_7(cParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1EBB / 7867
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1ECE / 7886
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	cVar4 = Function_44(uParam0->f_12);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(cVar4)))
	{
		...
		if (bVar5)
		{
			...
			uParam0->f_32 = ATTACH_OBJECTS_PHYSICAL(iParam1, uParam0->f_16, uVar6, uVar8, 0.02f);
		}
		return;
	}
	iVar9 = 1;
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, iParam1, uVar3, Function_40(uParam0->f_12, &iVar10), 0, iVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, iParam1, Function_39(), Function_40(uParam0->f_12, &iVar10), 0, iVar9);
	}
	if (IS_GRINGO_COMPONENT_VALID(bVar4))
	{
		...
		uVar12 = GRINGO_ANIM_GET_ACT_FILENAME(bVar4);
		uVar13 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar4);
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(iParam1, uVar11, uVar12, uVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
...
var Function_39() //Position: 0x21B6 / 8630
{
	int iVar0;
...
int Function_40(int iParam0, int iParam1) //Position: 0x21BE / 8638
{
	return Function_9(iParam0, "TargetLocator", iParam1);
}

void Function_41() //Position: 0x21DB / 8667
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

int Function_42(int iParam0, int iParam1) //Position: 0x21EA / 8682
{
	return Function_9(iParam0, "UserPhysAttachBone", iParam1);
}

int Function_43(int iParam0, int iParam1) //Position: 0x220C / 8716
{
	return Function_9(iParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2230 / 8752
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

int Function_45(int iParam0, int iParam1) //Position: 0x224D / 8781
{
	return Function_9(iParam0, "TargetAttachBone", iParam1);
}

int Function_46(int iParam0, int iParam1) //Position: 0x226D / 8813
{
	return Function_9(iParam0, "TargetAttachSlot", iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x228D / 8845
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	iVar0 = GRINGO_GET_FIRST_CHILD(2, iParam0);
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		uVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(bVar0, iParam1);
		uVar3 = GRINGO_ANIM_GET_ACT_FILENAME(bVar0);
		uVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar0);
		iVar1 = GRINGO_GET_PHYSINST(iParam0);
		if (IS_PHYSINST_VALID(iVar1))
		{
			...
			uVar6 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(iVar1, uVar2, uVar3, uVar4);
			if (IS_OBJECT_ANIMATOR_VALID(uVar6))
			{
				LINK_OBJECT_ANIMATOR_TO_ACTOR(uVar6, iParam1, GRINGO_GET_PROP_ATTACH_SLOT(iParam0));
			}
		}
	}
	return;
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x233B / 9019
{
	int iVar0;
	
	if (bParam2)
	{
		iVar0 = GRINGO_GET_FIRST_NAMED_CHILD("UseAnimMidAction", 2, bParam1);
		if (IS_GRINGO_COMPONENT_VALID(iVar0))
		{
			return bVar0;
		}
...
void Function_49(int iParam0, float fParam1) //Position: 0x23AB / 9131
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23C1 / 9153
{
...
var Function_51(int iParam0) //Position: 0x23E2 / 9186
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(iParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2402 / 9218
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2416 / 9238
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2420 / 9248
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2427 / 9255
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2436 / 9270
{
	float fVar0;
...
int Function_57(bool bParam0) //Position: 0x2475 / 9333
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x24A0 / 9376
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24AB / 9387
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(char* cParam0) //Position: 0x25A1 / 9633
{
	return Function_7(cParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x25C3 / 9667
{
	return Function_11(iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x25EA / 9706
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x25F4 / 9716
{
	iParam0 = iParam0;
	return;
}

bool Function_64(char* cParam0) //Position: 0x25FE / 9726
{
	return Function_7(cParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x261C / 9756
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x2631 / 9777
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x26B8 / 9912
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x26DB / 9947
{
	vector3 vVar0;
...
int Function_69(bool bParam0) //Position: 0x26F9 / 9977
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x271C / 10012
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
	...
	if (!GET_GRINGO_BOOL_ATTR("RandomPointSet", bParam1, &uVar6))
	{
		...
		if (bVar23)
		{
			...
			SET_GRINGO_FLOAT_ATTR(fVar5, "RandomDirection", bParam1);
	...
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vVar2, uVar0, 0.2f, 1, fVar5, uVar1, 1, 0);
}

bool Function_71(int iParam0, int iParam1) //Position: 0x2837 / 10295
{
	*iParam1 = Function_11(iParam0, "AreaClearCheck", -1.0f);
	if (*iParam1 < 0.0f)
	{
		return 1;
	}
...
int Function_72(bool bParam0) //Position: 0x2862 / 10338
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2967 / 10599
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x2974 / 10612
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x29E7 / 10727
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		...
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			...
			{
				iVar4 = GET_PROP_FROM_OBJECT(GET_TARGET_OBJECT());
				if (IS_PHYSINST_VALID(iVar4))
				{
					SUPRESS_MOVER_COLLISIONS(iParam0->f_16, iVar4, 0);
				}
			}
			if (Function_35(iParam0->f_12))
			{
	...
	while (iVar5 >= 4294967295)
	{
		...
		iVar7 = GRINGO_GET_PHYSINST(iVar6);
		if (IS_PHYSINST_VALID(iVar7))
		{
			uVar8 = GET_OBJECT_ANIMATOR_ON_OBJECT(GET_OBJECT_FROM_PHYSINST(iVar7));
	...
	{
		iVar9 = GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 3);
		if (IS_GRINGO_COMPONENT_VALID(iVar9))
		{
	...
	if (IS_OBJECT_VALID(GET_TARGET_OBJECT()))
	{
		...
		iVar12 = GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT());
		if (IS_PHYSINST_VALID(iVar12))
		{
			if (Function_73(iParam0->f_40, 256))
			{
				Function_37(iParam0 + 40, 256);
				SET_PROP_FIXED(iVar12, 0);
			}
		}
	}
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(uLocal_78));
		iLocal_79 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_76() //Position: 0x2EE5 / 12005
{
	return;
}

int Function_77(int iParam0) //Position: 0x2EEB / 12011
{
	return Function_11(iParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2F08 / 12040
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	iVar2 = Function_44(uParam0->f_12);
...
void Function_79(int iParam0) //Position: 0x2F40 / 12096
{
	iParam0 = iParam0;
	return;
}

bool Function_80(char* cParam0) //Position: 0x2F4A / 12106
{
	return Function_7(cParam0, "BlockBumpReactions", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2F6B / 12139
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "UseOnce"))
	{
		DECOR_SET_INT(GRINGO_GET_MY_OBJECT_REF(), "UseOnce", true);
	}
	return;
}

void Function_82(bool bParam0, bool bParam1) //Position: 0x2F9E / 12190
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(char* cParam0, bool bParam1) //Position: 0x30A6 / 12454
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x30BC / 12476
{
	int iVar0;
	int iVar1;
	char* cVar2;
	...
	if (GRINGO_SHOULD_SUSPEND_MOVER(iParam0->f_12) && IS_OBJECT_VALID(GET_TARGET_OBJECT()))
	{
		iVar1 = GET_PROP_FROM_OBJECT(GET_TARGET_OBJECT());
		if (IS_PHYSINST_VALID(iVar1))
		{
			SUPRESS_MOVER_COLLISIONS(iParam0->f_16, iVar1, 1);
		}
	}
	...
	if (Function_86(iParam0->f_12))
	{
		if (!ACTOR_PUT_WEAPON_IN_HAND(iParam0->f_16, GET_WEAPON_EQUIPPED(iParam0->f_16, 5), 1))
		{
			if (ACTOR_PUT_WEAPON_IN_HAND(iParam0->f_16, GET_WEAPON_EQUIPPED(iParam0->f_16, 1), 1))
			{
				Function_55(iParam0 + 40, 128);
			}
		}
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_85(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_85(var uParam0, int iParam1) //Position: 0x3372 / 13170
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(char* cParam0) //Position: 0x3380 / 13184
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_87(char* cParam0) //Position: 0x3399 / 13209
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x33B3 / 13235
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_89(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
int Function_89(var uParam0, int iParam1) //Position: 0x33EB / 13291
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3402 / 13314
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		{
			iVar8 = GET_PROP_FROM_OBJECT(bVar7);
			if (IS_PHYSINST_VALID(iVar8))
			{
				if (HAS_PHYSINST_BROKEN_APART(iVar8))
				{
		...
		if (!Function_73(iParam0->f_40, 2))
		{
			...
			if (Function_73(iParam0->f_40, 1))
			{
				Function_83("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_93(iParam0->f_12);
				fVar16 = VMAG(vVar12);
				...
				fVar33 = Function_91(iParam0->f_12);
				if (!fVar33 != 0.0f)
				{
					if (fVar33 < 0.0f)
					{
...
int Function_91(int iParam0) //Position: 0x36CB / 14027
{
	return Function_11(iParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x36E8 / 14056
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
int Function_93(int iParam0) //Position: 0x3784 / 14212
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x37A3 / 14243
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
	...
	if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "UseOnce"))
	{
		if (DECOR_GET_INT(GRINGO_GET_MY_OBJECT_REF(), "UseOnce") > 1)
		{
			return 0;
		}
	}
	...
	while (iVar1 < (17 - 1))
	{
		strcpy(&cVar2, "nAmmoType_", 16);
		straddi(&cVar2, iVar1, 16);
...
bool Function_95(int iParam0) //Position: 0x381D / 14365
{
...
void Function_96(int iParam0) //Position: 0x3839 / 14393
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3843 / 14403
{
	int iVar0;
	var uVar1;
	...
	{
		Function_98(&(Local_1[iLocal_7412]), bParam0);
		iLocal_74++;
	}
	if (GRINGO_GET_CHILD_COMPONENT_COUNT(bParam0) >= 0)
	{
		...
		{
			uVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar0, bParam0);
...
void Function_98(int iParam0, int iParam1) //Position: 0x38A5 / 14501
{
...
void Function_99(int iParam0) //Position: 0x38B9 / 14521
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x38C3 / 14531
{
