...
void main() //Position: 0x0 / 0
{
	...
	if (Function_132())
	{
		...
		*(&Local_39 + 1896) = { -3261.375f, 38.149f, 4550.599f };
		vVar0[03] = { -3266.802f, 37.999f, 4543.955f };
		vVar0[13] = { -3263.77f, 38.149f, 4541.17f };
		vVar0[23] = { -3258.77f, 38.149f, 4541.17f };
		vVar0[33] = { -3254.814f, 38.132f, 4543.038f };
		vVar0[43] = { -3260.528f, 37.999f, 4543.87f };
		Function_99(&vVar0, 0);
		Function_97(1);
		if (Function_96(Global_79962, 128))
		{
			Function_95(2, 7400, 1200);
			Function_95(1, 6200, 900);
			Function_95(0, 5400, 600);
			Function_93(2, 9.0f, 500);
			Function_93(1, 12.0f, 250);
			Function_93(0, 30.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(91);
		}
		else
		{
			...
			Function_93(2, 8.0f, 500);
			Function_93(1, 10.0f, 250);
			Function_93(0, 12.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(38);
		}
...
void Function_1() //Position: 0x197 / 407
{
...
void Function_2() //Position: 0x1C6 / 454
{
	Function_3();
	return;
}

void Function_3() //Position: 0x1CF / 463
{
...
void Function_4(int iParam0, bool bParam1, int iParam2) //Position: 0x2D8 / 728
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_6(var uParam0, int iParam1) //Position: 0x313 / 787
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_7(int iParam0) //Position: 0x322 / 802
{
	return Function_96(Global_76905.f_132, iParam0);
}

void Function_8() //Position: 0x333 / 819
{
	bool bVar0;
...
var Function_9(bool bParam0) //Position: 0x34C / 844
{
	bool bVar0;
...
var Function_10() //Position: 0x399 / 921
{
...
void Function_11(int iParam0) //Position: 0x3C8 / 968
{
	int iVar0;
...
void Function_12(var uParam0, int iParam1) //Position: 0x3EE / 1006
{
...
void Function_13(var uParam0, int iParam1) //Position: 0x51C / 1308
{
	int iVar0;
...
bool Function_14(var uParam0, int iParam1) //Position: 0x536 / 1334
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1, int iParam2) //Position: 0x553 / 1363
{
...
void Function_16(var uParam0, var uParam1, int iParam2) //Position: 0x6EC / 1772
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_17(bool bParam0, int iParam1, int iParam2) //Position: 0x864 / 2148
{
	var uVar0;
...
int Function_18(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x875 / 2165
{
	char* cVar0[32];
...
bool Function_19(bool bParam0, int iParam1, bool bParam2) //Position: 0x8DA / 2266
{
	char* cVar0[64];
	int iVar16;
...
var Function_20(int iParam0) //Position: 0x95B / 2395
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_21(bool bParam0) //Position: 0xC74 / 3188
{
	char* cVar0[64];
...
void Function_22(bool bParam0) //Position: 0xD15 / 3349
{
...
bool Function_23() //Position: 0xD2F / 3375
{
	return Function_7(32768);
}

void Function_24() //Position: 0xD3C / 3388
{
	Function_4(32768, 1, 0);
	return;
}

int Function_25() //Position: 0xD4B / 3403
{
	int iVar0;
	int iVar1;
...
void Function_26(int iParam0, int iParam1) //Position: 0xD75 / 3445
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_27(bool bParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xEFE / 3838
{
...
int Function_28(int iParam0) //Position: 0xF21 / 3873
{
	*iParam0 = (*iParam0 - 1);
	return *iParam0 + 1;
}

void Function_29(var uParam0, bool bParam1) //Position: 0xF34 / 3892
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_30(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x120C / 4620
{
	bool bVar0;
...
var Function_31(var uParam0, int iParam1, bool bParam2) //Position: 0x125D / 4701
{
	int iVar0;
...
var Function_32(bool bParam0) //Position: 0x127C / 4732
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_33(int iParam0) //Position: 0x1288 / 4744
{
...
int Function_34(int iParam0, var uParam1, int iParam2) //Position: 0x12A8 / 4776
{
	bool bVar0;
	int iVar1;
...
int Function_35(int iParam0, int iParam1, int iParam2) //Position: 0x12FB / 4859
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x133C / 4924
{
	int iVar0;
...
void Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x1362 / 4962
{
	float fVar0;
...
var Function_38(int iParam0) //Position: 0x1393 / 5011
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
var Function_39(float fParam0) //Position: 0x13B3 / 5043
{
	int iVar0;
	float fVar1;
	var uVar2;
...
int Function_40() //Position: 0x13E0 / 5088
{
	if (!Function_41())
	{
		return 4294967295;
...
bool Function_41() //Position: 0x13F5 / 5109
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_42(bool bParam0, int iParam1) //Position: 0x1402 / 5122
{
	struct<13> Var0;
...
struct<16> Function_43(var uParam0) //Position: 0x162F / 5679
{
	struct<4> Var0;
	bool bVar4;
...
var Function_44(int iParam0) //Position: 0x16A0 / 5792
{
...
void Function_45() //Position: 0x1771 / 6001
{
	if (!Function_46())
	{
	}
...
bool Function_46() //Position: 0x177E / 6014
{
	return NET_IS_IN_SESSION();
}

bool Function_47(int iParam0) //Position: 0x1787 / 6023
{
	return Function_96(*iParam0, 2);
}

bool Function_48(int iParam0) //Position: 0x1794 / 6036
{
	return Function_96(*iParam0, 1);
}

void Function_49(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x17A1 / 6049
{
	if (iParam2 != 0)
	{
...
int Function_50(int iParam0) //Position: 0x17F0 / 6128
{
	return Function_51(0, iParam0);
}

int Function_51(int iParam0, bool bParam1) //Position: 0x17FC / 6140
{
	char* cVar0[64];
...
int Function_52(int iParam0) //Position: 0x1863 / 6243
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_53(int iParam0, bool bParam1) //Position: 0x1873 / 6259
{
	char* cVar0[64];
...
int Function_54(int iParam0) //Position: 0x18E1 / 6369
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_55(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x18FA / 6394
{
	bool bVar0;
	bool bVar1;
...
void Function_56(bool bParam0, bool bParam1) //Position: 0x199A / 6554
{
	if (Function_7(4))
	{
...
int Function_57(bool bParam0) //Position: 0x19CD / 6605
{
	return Function_53(12, bParam0);
}

void Function_58(bool bParam0, int iParam1, bool bParam2) //Position: 0x19DA / 6618
{
	if (bParam0)
	{
		if (Function_23())
...
int Function_59() //Position: 0x19FB / 6651
{
	if (!Function_61(1))
	{
		return 0;
...
void Function_60() //Position: 0x1A99 / 6809
{
	if (Function_7(4096))
	{
...
bool Function_61(bool bParam0) //Position: 0x1AD6 / 6870
{
	char* cVar0[64];
...
void Function_62(bool bParam0) //Position: 0x1B57 / 6999
{
...
struct<64> Function_63(int iParam0) //Position: 0x1BE0 / 7136
{
...
int Function_65(bool bParam0, bool bParam1) //Position: 0x1C39 / 7225
{
...
void Function_66() //Position: 0x1C6D / 7277
{
...
bool Function_67(int iParam0) //Position: 0x1CA7 / 7335
{
	return Function_96(StackVal, iParam0);
}

void Function_68() //Position: 0x1CBA / 7354
{
	if (IS_LAYOUTREF_VALID(Local_39.f_1808))
	{
		DESTROY_LAYOUT(Local_39.f_1808);
...
void Function_69(int iParam0) //Position: 0x1CDE / 7390
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_86(StackVal, StackVal, 10527, *(&Local_39 + 1896), 1, iParam0);
	bVar1 = true;
	...
	while (iVar0 <= Local_39.f_1804)
	{
		...
		Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_39[iVar090]), vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.725f, 0.0f), 1, 8809, 0, iVar6, iVar0, "", iVar7);
		if (Function_71(Local_39[iVar090].f_352))
		{
			Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_39[iVar090] + 48, vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.25f, 0.0f), Local_39[iVar090].f_344, 8064, 0, iVar6, iVar0, "", iVar7);
		}
		else
		{
			Function_76(&Local_39[iVar090] + 48);
...
var Function_70(int iParam0, int iParam1) //Position: 0x1F80 / 8064
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_39[iParam190] + 96)[iParam0 + 12]);
}

bool Function_71(bool bParam0) //Position: 0x1F97 / 8087
{
	bool bVar0;
	bool bVar1;
...
void Function_72(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1FDC / 8156
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_73(float fParam0) //Position: 0x225B / 8795
{
	return (fParam0 * 57.29578f);
}

int Function_74(var uParam0, int iParam1) //Position: 0x2269 / 8809
{
	uParam0 = uParam0;
	return Function_77(Local_39[iParam190].f_324, 1);
}

void Function_75(int iParam0, int iParam1) //Position: 0x2280 / 8832
{
...
void Function_76(int iParam0) //Position: 0x22A9 / 8873
{
	if (IS_OBJECT_VALID(*iParam0))
	{
...
int Function_77(int iParam0, bool bParam1) //Position: 0x22CF / 8911
{
	if (bParam1)
	{
		switch (iParam0)
...
var Function_78(int iParam0) //Position: 0x2642 / 9794
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_79(int iParam0) //Position: 0x26D9 / 9945
{
	Function_80(&Global_83864 + 1256, iParam0);
	return;
}

void Function_80(var uParam0, int iParam1) //Position: 0x26EB / 9963
{
	Function_6(uParam0, iParam1);
	return;
}

void Function_81(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x26F8 / 9976
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_82(int iParam0) //Position: 0x2773 / 10099
{
	char* cVar0[16];
...
bool Function_83() //Position: 0x27B2 / 10162
{
...
bool Function_84(int iParam0) //Position: 0x27CD / 10189
{
	return Function_85(Global_83864.f_1256, iParam0);
}

int Function_85(var uParam0, bool bParam1) //Position: 0x27DF / 10207
{
	return (uParam0 && bParam1) == 0;
}

void Function_86(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x27EC / 10220
{
	...
	Function_87(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 10426, 1, 125, 0, 0, 0);
...
void Function_87(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x286F / 10351
{
	vector3 vVar0;
	int iVar3;
...
var Function_88(int iParam0, var uParam1) //Position: 0x28BA / 10426
{
	char* cVar0[64];
...
var Function_89() //Position: 0x291F / 10527
{
	int iVar0;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x2998 / 10648
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_91(var uParam0, var uParam1) //Position: 0x29E4 / 10724
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return "TES_summary";
...
bool Function_92(int iParam0, bool bParam1) //Position: 0x2A00 / 10752
{
	int iVar0;
...
void Function_93(int iParam0, float fParam1, int iParam2) //Position: 0x2A20 / 10784
{
	Function_94(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_94(int iParam0, int iParam1) //Position: 0x2A36 / 10806
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_95(int iParam0, int iParam1, bool bParam2) //Position: 0x2A57 / 10839
{
	Function_140(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

bool Function_96(var uParam0, int iParam1) //Position: 0x2A6C / 10860
{
	return (uParam0 && iParam1) == 0;
}

void Function_97(int iParam0) //Position: 0x2A79 / 10873
{
	Function_98(8, iParam0);
	return;
}

void Function_98(int iParam0, bool bParam1) //Position: 0x2A86 / 10886
{
	if (bParam1)
	{
...
void Function_99(var uParam0, bool bParam1) //Position: 0x2AAE / 10926
{
	bool bVar1;
	bool bVar2;
...
void Function_100(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x2CF7 / 11511
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
var Function_101(bool bParam0, var uParam1, int iParam2) //Position: 0x2E74 / 11892
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_102(float fParam0) //Position: 0x2F60 / 12128
{
	return (fParam0 * 0.01745329f);
}

var Function_103(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2F6E / 12142
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_104() //Position: 0x2FDA / 12250
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x3001 / 12289
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_106(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x30EF / 12527
{
...
bool Function_107(int iParam0) //Position: 0x3280 / 12928
{
...
bool Function_108(bool bParam0, int iParam1) //Position: 0x3292 / 12946
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<228> Function_109(int iParam0, int iParam1) //Position: 0x32EE / 13038
{
	struct<57> Var0;
...
void Function_110(int iParam0, int iParam1) //Position: 0x34D3 / 13523
{
	int iVar0;
	int iVar1[17];
	int iVar19;
...
void Function_111(var uParam0, var uParam1) //Position: 0x3610 / 13840
{
...
bool Function_112() //Position: 0x3633 / 13875
{
	return Function_113(39);
}

int Function_113(bool bParam0) //Position: 0x363E / 13886
{
	int iVar0;
...
int Function_114(int iParam0, int iParam1) //Position: 0x366C / 13932
{
...
bool Function_115(int iParam0, int iParam1) //Position: 0x3686 / 13958
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

bool Function_116(int iParam0, var uParam1, int iParam2) //Position: 0x3699 / 13977
{
...
void Function_117(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x3779 / 14201
{
...
void Function_118(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x379C / 14236
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_119(int iParam0) //Position: 0x37C6 / 14278
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_120(int iParam0) //Position: 0x37D6 / 14294
{
	int iVar0;
...
void Function_121(var uParam0, int iParam1) //Position: 0x3803 / 14339
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_122(bool bParam0) //Position: 0x380F / 14351
{
	Function_118(bParam0, 4294967295, 0, 1);
	return;
}

float Function_123(vector3 vParam0, vector3 vParam3) //Position: 0x381D / 14365
{
	var uVar0;
...
void Function_124(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x3837 / 14391
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_125() //Position: 0x385A / 14426
{
...
bool Function_126(int iParam0) //Position: 0x386A / 14442
{
	int iVar0;
	int iVar1;
...
void Function_127() //Position: 0x3BE5 / 15333
{
	if (!Function_128(128))
	{
		return;
...
bool Function_128(int iParam0) //Position: 0x3C25 / 15397
{
	int iVar0;
...
bool Function_129() //Position: 0x3C41 / 15425
{
	int iVar0;
...
void Function_130(var uParam0, int iParam1) //Position: 0x3C6C / 15468
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_131() //Position: 0x3C7D / 15485
{
	if (!Function_128(128))
	{
		return;
...
bool Function_132() //Position: 0x3CBF / 15551
{
	var uVar0;
	bool bVar3;
	int iVar4;
...
void Function_133() //Position: 0x3DF0 / 15856
{
...
void Function_134(char* cParam0, int iParam1) //Position: 0x3E0B / 15883
{
	char* cVar0[32];
	char* cVar8[32];
...
var Function_135(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3EA2 / 16034
{
	int iVar0;
	int iVar1;
...
var Function_136(var uParam0, int iParam1, int iParam2) //Position: 0x3EDA / 16090
{
	int iVar0;
...
void Function_137(var uParam0, var uParam1) //Position: 0x3F9E / 16286
{
	Function_15(uParam0, uParam1, 16303);
	return;
}

int Function_138() //Position: 0x3FAF / 16303
{
	return 1;
}

bool Function_139() //Position: 0x3FB6 / 16310
{
	return Function_67(2);
}

void Function_140(int iParam0, int iParam1) //Position: 0x3FC0 / 16320
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
