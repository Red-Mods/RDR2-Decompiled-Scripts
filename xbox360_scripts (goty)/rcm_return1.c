			...
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					...
					case 0x00000001:
						...
						bLocal_255 = Function_146(StackVal, StackVal, *(&Global_63541[ScriptParam_055] + 112), 0x3f800000, 0x42960000, 1, 1, 0);
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (bLocal_255)
							{
								if (StackVal && FABS((StackVal - !Function_142(Global_34573, 1, 1))) > 2.0f)
								{
									if (Function_138(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0))
									{
					...
					case 0x00000003:
						if (Function_105("$/cutscene/pale_horse_seq/pale_horse_seq", &iLocal_248, &uLocal_258, &uLocal_265, 25087, 25080, 25073, 25018, 24731, 24724, 0, 2, 1, 1, 2, 0, 1))
						{
							Function_104(1.0f);
							iVar0 = 5;
						}
					...
					case 0x00000005:
						...
						{
							Function_149(&Global_63541[2955] + 144, 256);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "return1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x300 / 768
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x83C / 2108
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_3() //Position: 0x9AF / 2479
{
	return;
}

void Function_4(var uParam0, var uParam1) //Position: 0x9B5 / 2485
{
	if (Global_3381)
	{
		return;
...
bool Function_5() //Position: 0x9F7 / 2551
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_6(bool bParam0) //Position: 0xA00 / 2560
{
...
void Function_7() //Position: 0xA51 / 2641
{
	Function_35();
	Function_34();
	Function_34();
...
void Function_8() //Position: 0xAA3 / 2723
{
...
void Function_9() //Position: 0xBA9 / 2985
{
	float fVar0;
...
void Function_10() //Position: 0xBDC / 3036
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0xD6A / 3434
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0xF1E / 3870
{
	Function_13(&Global_28260, 1, 0);
	return;
}

void Function_13(int iParam0, bool bParam1, var uParam2) //Position: 0xF2C / 3884
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_14() //Position: 0x111D / 4381
{
...
struct<8> Function_15(int iParam0) //Position: 0x1132 / 4402
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x11D8 / 4568
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x1473 / 5235
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18() //Position: 0x1AA0 / 6816
{
	int iVar0;
...
var Function_19(int iParam0) //Position: 0x1AA8 / 6824
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_20(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1AB9 / 6841
{
	char* cVar0[32];
...
struct<32> Function_21(char* cParam0, bool bParam1) //Position: 0x1BAE / 7086
{
	char* cVar0[32];
...
void Function_22(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1BC7 / 7111
{
	float fVar0;
...
var Function_23(int iParam0, int iParam1) //Position: 0x1C2C / 7212
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_24(int iParam0, bool bParam1) //Position: 0x1C3E / 7230
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_25(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C50 / 7248
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_26(int iParam0) //Position: 0x1D80 / 7552
{
	return Global_35278[iParam020].f_48;
}

float Function_27(int iParam0) //Position: 0x1D8F / 7567
{
	if (!iParam0 != 4294967295)
	{
...
var Function_28(int iParam0) //Position: 0x1DC8 / 7624
{
	if (iParam0 == 4294967295)
	{
...
void Function_29(int iParam0) //Position: 0x1E05 / 7685
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_30(int iParam0, bool bParam1, bool bParam2) //Position: 0x1F9F / 8095
{
	int iVar0;
	int iVar1;
...
int Function_31(bool bParam0) //Position: 0x21E3 / 8675
{
...
struct<8> Function_32() //Position: 0x2224 / 8740
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x22AD / 8877
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x2344 / 9028
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_35() //Position: 0x23C3 / 9155
{
...
int Function_36(int iParam0, bool bParam1, int iParam2) //Position: 0x23FC / 9212
{
	int iVar0;
	int iVar1;
...
void Function_37() //Position: 0x2606 / 9734
{
	vector3 vVar0;
	var uVar3;
...
bool Function_38(vector3 vParam0) //Position: 0x26C1 / 9921
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_39(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x26D9 / 9945
{
	int iVar0;
...
vector3 Function_40() //Position: 0x27C0 / 10176
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_41(int iParam0) //Position: 0x27C9 / 10185
{
...
int Function_42(bool bParam0, bool bParam1) //Position: 0x27DF / 10207
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_43(vector3 vParam0, vector3 vParam3) //Position: 0x28A6 / 10406
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_44(var uParam0, int iParam1) //Position: 0x28C3 / 10435
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_45(int iParam0) //Position: 0x30E8 / 12520
{
	var uVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x3123 / 12579
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x3130 / 12592
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x313D / 12605
{
	uParam0 = uParam0;
...
void Function_49(bool bParam0) //Position: 0x31E1 / 12769
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_50(int iParam0, int iParam1) //Position: 0x3383 / 13187
{
	float fVar0;
	bool bVar1;
...
void Function_51(int iParam0) //Position: 0x343D / 13373
{
	float fVar0;
	bool bVar1;
...
int Function_52(var uParam0, int iParam1) //Position: 0x34DF / 13535
{
	int iVar0;
	var uVar1;
...
void Function_53(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3640 / 13888
{
	struct<8> Var0;
...
struct<32> Function_54(bool bParam0) //Position: 0x36DB / 14043
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_55(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3745 / 14149
{
	char* cVar0[32];
...
int Function_56(bool bParam0) //Position: 0x3764 / 14180
{
	int iVar0;
	vector3 vVar1;
...
float Function_57(bool bParam0, vector3 vParam1) //Position: 0x38C5 / 14533
{
	vector3 vVar0;
...
vector3 Function_58(bool bParam0) //Position: 0x393F / 14655
{
	vector3 vVar0;
...
void Function_59(int iParam0) //Position: 0x39A9 / 14761
{
...
bool Function_60(int iParam0) //Position: 0x3A0A / 14858
{
...
void Function_61(int iParam0, int iParam1) //Position: 0x3A20 / 14880
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if (((StackVal && Function_146(StackVal, Function_63(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_62(iParam1)) || Global_74542[iParam110].f_12 != 1)
	{
...
int Function_62(int iParam0) //Position: 0x3B65 / 15205
{
...
bool Function_63(int iParam0) //Position: 0x3B91 / 15249
{
...
bool Function_64(int iParam0, int iParam1) //Position: 0x3BA6 / 15270
{
...
bool Function_65(int iParam0, int iParam1) //Position: 0x3CBB / 15547
{
	int iVar0;
...
bool Function_66(int iParam0) //Position: 0x3DFF / 15871
{
...
bool Function_67(int iParam0) //Position: 0x3E23 / 15907
{
...
bool Function_68(int iParam0) //Position: 0x3E38 / 15928
{
...
var Function_69(int iParam0) //Position: 0x3E4F / 15951
{
...
bool Function_70(int iParam0) //Position: 0x3E69 / 15977
{
...
bool Function_71(int iParam0) //Position: 0x3E7F / 15999
{
	return StackVal;
}

bool Function_72(var uParam0, int iParam1) //Position: 0x3E8F / 16015
{
	int iVar0;
...
bool Function_73(int iParam0) //Position: 0x3EAB / 16043
{
	if (!iParam0->f_152)
	{
		if (Function_100())
...
bool Function_74(int iParam0) //Position: 0x3F4F / 16207
{
...
bool Function_75(int iParam0) //Position: 0x3FA8 / 16296
{
	int iVar0;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x3FC4 / 16324
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x3FE0 / 16352
{
...
bool Function_78(int iParam0) //Position: 0x3FF5 / 16373
{
...
int Function_79(int iParam0) //Position: 0x400E / 16398
{
...
void Function_80() //Position: 0x4023 / 16419
{
...
var Function_81(int iParam0, int iParam1) //Position: 0x409E / 16542
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_82(int iParam0, bool bParam1) //Position: 0x4C8F / 19599
{
	int iVar0;
...
int Function_83(int iParam0) //Position: 0x4CCC / 19660
{
	int iVar0;
	int iVar1;
...
bool Function_84(int iParam0) //Position: 0x4D1B / 19739
{
...
int Function_85(int iParam0) //Position: 0x4D31 / 19761
{
...
void Function_86() //Position: 0x4D9A / 19866
{
...
bool Function_87(int iParam0) //Position: 0x4DBD / 19901
{
	if (!Function_84(iParam0))
	{
...
bool Function_88(int iParam0, int iParam1) //Position: 0x4E0E / 19982
{
	int iVar0;
...
bool Function_89(int iParam0) //Position: 0x4E3B / 20027
{
	if (!Function_84(iParam0))
	{
...
void Function_90(bool bParam0) //Position: 0x4E8D / 20109
{
	int iVar0;
...
void Function_91() //Position: 0x4EC7 / 20167
{
	bool bVar0;
...
void Function_92(int iParam0, int iParam1) //Position: 0x4F25 / 20261
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_93(bool bParam0) //Position: 0x4F38 / 20280
{
	PRINTSTRING("Day ");
...
void Function_94(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x4F7E / 20350
{
	bool bVar0;
	char* cVar1[16];
...
void Function_95(char* cParam0, int iParam1) //Position: 0x4FEA / 20458
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_96(bool bParam0, var uParam1, int iParam2) //Position: 0x5021 / 20513
{
	var uVar0;
	char* cVar1[16];
...
int Function_97(char* cParam0) //Position: 0x5099 / 20633
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_98(int iParam0) //Position: 0x513A / 20794
{
	int iVar0;
	int iVar1;
...
bool Function_99(int iParam0, int iParam1) //Position: 0x5177 / 20855
{
...
bool Function_100() //Position: 0x518A / 20874
{
...
void Function_101(bool bParam0, bool bParam1) //Position: 0x51A5 / 20901
{
	bool bVar0;
...
void Function_102(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x51CA / 20938
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_103(int iParam0) //Position: 0x524F / 21071
{
	char* cVar0[16];
...
void Function_104(bool bParam0) //Position: 0x528E / 21134
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_105(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x52AB / 21163
{
	if (!bParam15)
	{
...
void Function_106(bool bParam0) //Position: 0x58BF / 22719
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_107() //Position: 0x596E / 22894
{
	bool bVar0;
...
void Function_108() //Position: 0x59E0 / 23008
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_109() //Position: 0x5A25 / 23077
{
...
void Function_110(bool bParam0, bool bParam1) //Position: 0x5A37 / 23095
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_111(bool bParam0) //Position: 0x5AB7 / 23223
{
	int iVar0;
...
float Function_112(int iParam0) //Position: 0x5AE6 / 23270
{
...
bool Function_113(int iParam0) //Position: 0x5BAE / 23470
{
	return Function_46(*iParam0, 2);
}

bool Function_114(int iParam0) //Position: 0x5BBB / 23483
{
	return Function_46(*iParam0, 1);
}

int Function_115(bool bParam0) //Position: 0x5BC8 / 23496
{
	int iVar0;
	bool bVar1;
...
bool Function_116() //Position: 0x5C80 / 23680
{
	int iVar0;
	bool bVar1;
...
void Function_117(int iParam0) //Position: 0x5CBA / 23738
{
	Function_118(iParam0, 0.0f);
	return;
}

void Function_118(var uParam0, float fParam1) //Position: 0x5CC6 / 23750
{
...
bool Function_119(int iParam0) //Position: 0x5CE7 / 23783
{
	return iParam0->f_20;
}

void Function_120(var uParam0, int iParam1) //Position: 0x5CF1 / 23793
{
	Function_121(uParam0, iParam1, 0);
	return;
}

void Function_121(var uParam0, bool bParam1, bool bParam2) //Position: 0x5CFF / 23807
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_122(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5E4B / 24139
{
	int iVar0;
	int iVar1;
...
void Function_123(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x606B / 24683
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_124() //Position: 0x6094 / 24724
{
	return 1;
}

int Function_125() //Position: 0x609B / 24731
{
	Function_126(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_257);
	return 1;
}

void Function_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x60B5 / 24757
{
	bool bVar0;
...
void Function_127() //Position: 0x61A5 / 24997
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_128() //Position: 0x61BA / 25018
{
...
int Function_129() //Position: 0x61F1 / 25073
{
	return 1;
}

int Function_130() //Position: 0x61F8 / 25080
{
	return 1;
}

int Function_131() //Position: 0x61FF / 25087
{
	bLocal_257 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "tempcutscenevol", 2, *(&Global_63541[2955] + 100), 0.0f, 0.0f, 0.0f, 5.0f, 5.0f, 5.0f);
	Function_134(0, 0, 1, 1, 0, 1, 1, bLocal_257, 1, 1, 1, 1);
	Function_132(StackVal, StackVal, bLocal_256, *(&Global_63541[2955] + 112), &bLocal_257, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_132(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x625E / 25182
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_133(bool bParam0, bool bParam1) //Position: 0x64CC / 25804
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_134(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x6541 / 25921
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_137(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_18(), 2, Function_137(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_136()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
...
void Function_135(int iParam0) //Position: 0x67EF / 26607
{
	int iVar0;
...
var Function_136() //Position: 0x6823 / 26659
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_137(bool bParam0) //Position: 0x68A2 / 26786
{
	vector3 vVar0;
...
bool Function_138(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x68B3 / 26803
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_139(int iParam0, int iParam1) //Position: 0x6AC5 / 27333
{
	var uVar0;
...
float Function_140(bool bParam0, bool bParam1) //Position: 0x6B30 / 27440
{
	vector3 vVar0;
...
void Function_141(bool bParam0, bool bParam1) //Position: 0x6B4F / 27471
{
	bool bVar0;
	bool bVar1;
...
bool Function_142(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6BAC / 27564
{
...
bool Function_143() //Position: 0x6C62 / 27746
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_144(bool bParam0) //Position: 0x6C79 / 27769
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_145(bool bParam0) //Position: 0x6C84 / 27780
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_146(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6C92 / 27794
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_147() //Position: 0x6CAE / 27822
{
	if (IS_LAYOUTREF_VALID(bLocal_256))
	{
...
int Function_148(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6CCA / 27850
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_149(var uParam0, int iParam1) //Position: 0x6CF9 / 27897
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_150(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x6D08 / 27912
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
float Function_151(float fParam0) //Position: 0x6E69 / 28265
{
...
int Function_152(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x6E9E / 28318
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_153() //Position: 0x70E4 / 28900
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_154(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_154(char* cParam0, vector3 vParam1) //Position: 0x7138 / 28984
{
	char* cVar0[64];
...
bool Function_155(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x7260 / 29280
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_58(bParam0);
...
int Function_156() //Position: 0x72EA / 29418
{
	if (IS_PS3())
	{
		return 1;
