...
bool Function_96(bool bParam0, int iParam1) //Position: 0x3A80 / 14976
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_97(int iParam0) //Position: 0x3A9C / 15004
{
...
void Function_98(int iParam0) //Position: 0x3AB8 / 15032
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AC2 / 15042
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B24 / 15140
{
...
void Function_101(int iParam0) //Position: 0x3B38 / 15160
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B42 / 15170
{
