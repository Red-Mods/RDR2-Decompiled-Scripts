...
var Function_7(int iParam0) //Position: 0x7E3 / 2019
{
	int iVar0;
...
var Function_8(int iParam0) //Position: 0x84F / 2127
{
	int iVar0;
...
var Function_9(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x8BB / 2235
{
	int iVar0;
	int iVar1;
...
var Function_10(bool bParam0, int iParam1) //Position: 0x937 / 2359
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_11(int iParam0) //Position: 0x944 / 2372
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_12(bool bParam0, var uParam1) //Position: 0x950 / 2384
{
	if (!Function_3(128))
	{
		return;
