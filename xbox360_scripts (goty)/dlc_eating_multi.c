						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_82))
								{
									...
									{
										bLocal_82 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_82 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x22D6 / 8918
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3470 / 13424
{
