...
void main() //Position: 0x0 / 0
{
	...
	Function_38(&bLocal_31, "action_areas", 10, 0);
	Function_38(&bLocal_31, "custom/AA_twin_rocks_hostage", 8, 0);
	Function_38(&bLocal_31, "AA_twin_rocks_hostage", 5, 0);
	Function_38(&bLocal_31, "twin_rocks_hostage", 1, 0);
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_21)
		{
			...
			case 0x00000002:
				...
				Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_hostageGringo"));
				vVar0 = { StackVal, StackVal, Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_hostageGringo")) };
				...
				Function_30(bLocal_24, 50.0f, 2.0f, 2.0f);
				AI_COMBAT_SET_NEW_STATE_MACHINE_ENABLED(bLocal_24, 1);
				...
				Function_30(bLocal_25, 50.0f, 2.0f, 2.0f);
				AI_COMBAT_SET_NEW_STATE_MACHINE_ENABLED(bLocal_25, 1);
				Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_badGuy"));
				Function_29(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_badGuy"));
				bLocal_26 = CREATE_ACTOR_IN_LAYOUT(bLocal_22, "HostageGuy", 488, Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_badGuy")), Function_29(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_badGuy")));
				SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_26, FIND_VOLUME_IN_LAYOUT(Global_30616, "v_badGuyStayIn"), 4, 1);
				...
				GIVE_WEAPON_TO_ACTOR(bLocal_24, false, 0, 1, 1);
				Function_28(bLocal_29, Global_34573, 4);
				Function_28(bLocal_30, Global_34573, 0);
				Function_27(bLocal_29, 322, 4294967295, 0, 3212836864, 0x3f800000, 2048, 0);
				Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_hostageGuyShoot"));
				vLocal_63 = { StackVal, StackVal, Function_31(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_hostageGuyShoot")) };
				iLocal_21 = 3;
				Function_25(1);
				Function_24(bLocal_26);
				vVar3 = { StackVal, StackVal, Function_24(bLocal_26) };
			...
			case 0x00000003:
				if (!iLocal_61)
				{
					if (DECOR_CHECK_EXIST(Global_34573, "ReadyForBoss"))
					{
						...
						SET_ACTOR_STAY_WITHIN_VOLUME(bLocal_24, FIND_VOLUME_IN_LAYOUT(Global_30616, "v_bossDefend"), 4, 1);
						...
						Function_23(&iLocal_50);
						Function_19(&iLocal_50);
						Function_18(bLocal_29, Global_34573);
						SQUAD_SET_FACTION(bLocal_29, 19);
						SQUAD_GOAL_ADD_GENERAL_TASK(bLocal_29, 0, 1, 4294967295);
						Function_17(bLocal_29, -1.0f);
						iLocal_61 = 1;
					}
				}
				if (!iLocal_58)
				{
					if (Function_16(&iLocal_50))
					{
						if (Function_14(&iLocal_50) < 5.0f)
						{
				...
				if (DECOR_CHECK_EXIST(Global_34573, "TWR_AA_Key"))
				{
					if (IS_ACTOR_IN_VOLUME(Global_34573, FIND_VOLUME_IN_LAYOUT(Global_30616, "v_hostageCheck")) || IS_ACTOR_IN_VOLUME(Global_34573, FIND_VOLUME_IN_LAYOUT(Global_30616, "v_hostageCheck1")))
					{
						if (!iLocal_53)
						{
							...
							Function_23(&iLocal_44);
							Function_19(&iLocal_44);
							iLocal_21 = 4;
						}
					}
				}
			...
			case 0x00000004:
				if (!iLocal_57)
				{
					if (Function_16(&iLocal_44))
					{
						if (Function_14(&iLocal_44) <= 4.0f)
						{
				...
				if (!iLocal_56)
				{
					if (IS_GRINGO_VALID(bLocal_23))
					{
						...
						Function_28(bLocal_30, Global_34573, 4);
						iLocal_56 = 1;
					}
				}
				if ((IS_PLAYER_TARGETTING_ACTOR(0, bLocal_26, 1) && IS_PLAYER_WEAPON_ZOOMED(Global_34573)) && !iLocal_59)
				{
					...
					Function_23(&iLocal_47);
					Function_19(&iLocal_47);
					iLocal_59 = 1;
				}
				if (!iLocal_55)
				{
					if (!IS_ACTOR_ALIVE(bLocal_27) && IS_ACTOR_ALIVE(bLocal_26))
					{
						...
						MEMORY_REPORT_POSITION_AUTO(bLocal_26, Global_34573, 1);
...
void Function_1(int iParam0) //Position: 0x86F / 2159
{
	int iVar0;
...
void Function_2(var uParam0, int iParam1) //Position: 0x895 / 2197
{
...
void Function_3(var uParam0, int iParam1) //Position: 0x9C3 / 2499
{
	int iVar0;
...
bool Function_4(var uParam0, int iParam1) //Position: 0x9DD / 2525
{
	int iVar0;
...
void Function_5(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9FA / 2554
{
	Function_8(bParam0, bParam1, 1);
	Function_7(bParam0, 1);
	Function_6(bParam0, bParam1, 4);
	Function_18(bParam0, bParam1);
	if (bParam2)
	{
		Function_27(bParam0, 322, 4294967295, 0.0f, 3212836864, 0x3f800000, 2048, 0);
	}
	return;
}

void Function_6(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA3A / 2618
{
	bool bVar0;
	bool bVar1;
...
void Function_7(bool bParam0, int iParam1) //Position: 0xA7F / 2687
{
	bool bVar0;
...
void Function_8(bool bParam0, bool bParam1, bool bParam2) //Position: 0xAC0 / 2752
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
void Function_9(bool bParam0) //Position: 0xB2B / 2859
{
	bool bVar0;
...
void Function_10(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0xB5D / 2909
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_11(int iParam0) //Position: 0xBE2 / 3042
{
	char* cVar0[16];
...
bool Function_12() //Position: 0xC21 / 3105
{
...
bool Function_13(var uParam0, int iParam1) //Position: 0xC3C / 3132
{
	return (uParam0 && iParam1) == 0;
}

float Function_14(int iParam0) //Position: 0xC49 / 3145
{
...
bool Function_15(int iParam0) //Position: 0xD11 / 3345
{
	return Function_13(*iParam0, 2);
}

bool Function_16(int iParam0) //Position: 0xD1E / 3358
{
	return Function_13(*iParam0, 1);
}

void Function_17(bool bParam0, float fParam1) //Position: 0xD2B / 3371
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_18(bool bParam0, bool bParam1) //Position: 0xD74 / 3444
{
	bool bVar0;
	bool bVar1;
...
void Function_19(int iParam0) //Position: 0xDC6 / 3526
{
	Function_20(iParam0, 0.0f);
	return;
}

void Function_20(var uParam0, float fParam1) //Position: 0xDD2 / 3538
{
...
void Function_21(var uParam0, int iParam1) //Position: 0xDF3 / 3571
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_22(var uParam0, int iParam1) //Position: 0xE06 / 3590
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_23(int iParam0) //Position: 0xE15 / 3605
{
	if (!Function_16(iParam0))
	{
		Function_20(iParam0, 0.0f);
...
vector3 Function_24(bool bParam0) //Position: 0xE2A / 3626
{
	vector3 vVar0;
...
bool Function_26() //Position: 0xE70 / 3696
{
	int iVar0;
...
void Function_27(bool bParam0, int iParam1, int iParam2, float fParam3, float fParam4, float fParam5, int iParam6, bool bParam7) //Position: 0xE95 / 3733
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0xF7F / 3967
{
	bool bVar0;
	bool bVar1;
...
vector3 Function_29(bool bParam0) //Position: 0xFED / 4077
{
	vector3 vVar0;
...
void Function_30(bool bParam0, float fParam1, float fParam2, float fParam3) //Position: 0x1014 / 4116
{
...
vector3 Function_31(bool bParam0) //Position: 0x105B / 4187
{
	vector3 vVar0;
...
bool Function_32(int iParam0) //Position: 0x1082 / 4226
{
	int iVar0;
	int iVar1;
...
void Function_33() //Position: 0x13FD / 5117
{
	if (!Function_34(128))
	{
		return;
...
bool Function_34(int iParam0) //Position: 0x143D / 5181
{
	int iVar0;
...
bool Function_35() //Position: 0x1459 / 5209
{
	int iVar0;
...
void Function_36(var uParam0, int iParam1) //Position: 0x1484 / 5252
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_37() //Position: 0x1495 / 5269
{
	if (!Function_34(128))
	{
		return;
...
var Function_38(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x14D7 / 5335
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_39(uParam0, uVar1, iParam2);
	if (bParam3)
	{
...
var Function_39(var uParam0, int iParam1, int iParam2) //Position: 0x150F / 5391
{
	int iVar0;
