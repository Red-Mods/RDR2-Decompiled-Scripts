		...
		if (iLocal_8 != 4294967295)
		{
			...
			if (!IS_EARLIER_THAN(GET_TIME_OF_DAY(), bLocal_5))
			{
				if ((!bVar1 && !bVar0) && !bLocal_12)
				{
					...
					bLocal_3 = ADD_BLIP_FOR_COORD(&vVar2, 409, 0f, 2, 0);
...
int Function_12(var uParam0, int iParam1, vector3 vParam2) //Position: 0x79C / 1948
{
	...
	while (iVar0 <= Global_9975)
	{
		if (Global_9975[iVar03] == 0)
		{
			...
			Global_9975[iVar03].f_8 = MAKE_TIME_OF_DAY_EX(false, true, true, true);
			return iVar0;
		}
		iVar0++;
	}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_82(iParam0, bVar8, &iLocal_48, &cLocal_47);
...
void Function_37(bool bParam0, int iParam1) //Position: 0x22AA / 8874
{
...
void Function_38(var uParam0, var uParam1) //Position: 0x22BF / 8895
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_39() //Position: 0x22CD / 8909
{
	bool bVar0;
...
void Function_40(var uParam0, bool bParam1) //Position: 0x22FE / 8958
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_41(var uParam0, bool bParam1) //Position: 0x2372 / 9074
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_42(bool bParam0, int iParam1) //Position: 0x23E4 / 9188
{
	int iVar0;
	int iVar1;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		{
			iVar0 = GET_CURRENT_GRINGO(bParam0);
			...
			if (!(Function_23() || NET_IS_IN_SESSION()))
			{
				if (Function_44(2) >= 9)
				{
					ADD_ITEM(Function_43(5), bParam0, 1);
				}
			}
		}
	}
...
var Function_43(bool bParam0) //Position: 0x24C6 / 9414
{
	bool bVar0;
...
int Function_44(int iParam0) //Position: 0x25B7 / 9655
{
...
int Function_45(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x25DF / 9695
{
	int iVar0;
	int iVar1;
...
void Function_46(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x27FF / 10239
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_47() //Position: 0x2E2C / 11820
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x2E34 / 11828
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_49(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2E45 / 11845
{
	char* cVar0[32];
...
struct<32> Function_50(char* cParam0, bool bParam1) //Position: 0x2F3A / 12090
{
	char* cVar0[32];
...
void Function_51(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2F53 / 12115
{
	float fVar0;
...
var Function_52(int iParam0, int iParam1) //Position: 0x2FB8 / 12216
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_53(int iParam0, bool bParam1) //Position: 0x2FCA / 12234
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_54(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2FDC / 12252
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_55(int iParam0) //Position: 0x310C / 12556
{
	return Global_35278[iParam020].f_48;
}

float Function_56(int iParam0) //Position: 0x311B / 12571
{
	if (!iParam0 != 4294967295)
	{
...
var Function_57(int iParam0) //Position: 0x3154 / 12628
{
	if (iParam0 == 4294967295)
	{
...
void Function_58(int iParam0) //Position: 0x3191 / 12689
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_59(int iParam0, float fParam1, bool bParam2) //Position: 0x332B / 13099
{
	int iVar0;
	int iVar1;
...
void Function_60(int iParam0) //Position: 0x356F / 13679
{
...
void Function_61(bool bParam0) //Position: 0x359F / 13727
{
	PRINTSTRING("Day ");
...
int Function_62(var uParam0, bool bParam1) //Position: 0x35E5 / 13797
{
	bool bVar0;
	int iVar1;
...
int Function_63() //Position: 0x3782 / 14210
{
	int iVar0;
...
void Function_64() //Position: 0x3821 / 14369
{
	int iVar0;
	int iVar1;
...
void Function_65(int iParam0) //Position: 0x38D0 / 14544
{
...
var Function_66(int iParam0, int iParam1) //Position: 0x392E / 14638
{
	int iVar0;
...
float Function_67(bool bParam0) //Position: 0x396F / 14703
{
	return Function_31(bParam0, "UseTime", 5.0f);
}

bool Function_68() //Position: 0x3985 / 14725
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_69(bool bParam0) //Position: 0x3992 / 14738
{
	return Function_31(bParam0, "MoveAllowance", 1.5f);
}

bool Function_70(var uParam0, int iParam1) //Position: 0x39B2 / 14770
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_71(bool bParam0) //Position: 0x39C1 / 14785
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_72() //Position: 0x39E0 / 14816
{
	return;
}

void Function_73(int iParam0, int iParam1) //Position: 0x39E6 / 14822
{
	iParam1 = iParam1;
	iParam0 = iParam0;
...
bool Function_74(int iParam0) //Position: 0x3A1D / 14877
{
	iParam0 = iParam0;
	return 1;
}

bool Function_75(bool bParam0) //Position: 0x3A28 / 14888
{
	return Function_27(bParam0, "OneShotKill", 0);
}

bool Function_76(bool bParam0, int iParam1) //Position: 0x3A42 / 14914
{
	return Function_29(bParam0, "ParentAnimNode", iParam1);
}

bool Function_77(bool bParam0) //Position: 0x3A60 / 14944
{
	return Function_27(bParam0, "LinkToParentAnim", 0);
}

bool Function_78(bool bParam0) //Position: 0x3A7F / 14975
{
	int iVar0;
	int iVar1;
...
bool Function_79(bool bParam0) //Position: 0x3AB2 / 15026
{
	return Function_27(bParam0, "LinkParentToAnim", 0);
}

bool Function_80(bool bParam0) //Position: 0x3AD1 / 15057
{
	return Function_27(bParam0, "SingularUse", 0);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3AEB / 15083
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_82(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3AFE / 15102
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_89(uParam0->f_12, &bVar0);
...
bool Function_83(bool bParam0, bool bParam1) //Position: 0x3DE6 / 15846
{
	return Function_29(bParam0, "TargetLocator", bParam1);
}

void Function_84() //Position: 0x3E03 / 15875
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_85(bool bParam0, int iParam1) //Position: 0x3E12 / 15890
{
	return Function_29(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_86(bool bParam0, int iParam1) //Position: 0x3E34 / 15924
{
	return Function_29(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_87(bool bParam0) //Position: 0x3E58 / 15960
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_88(bool bParam0, int iParam1) //Position: 0x3E75 / 15989
{
	return Function_29(bParam0, "TargetAttachBone", iParam1);
}

bool Function_89(bool bParam0, int iParam1) //Position: 0x3E95 / 16021
{
	return Function_29(bParam0, "TargetAttachSlot", iParam1);
}

void Function_90(bool bParam0, bool bParam1) //Position: 0x3EB5 / 16053
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_91(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3F63 / 16227
{
	bool bVar0;
...
void Function_92(int iParam0, float fParam1) //Position: 0x3FD3 / 16339
{
	if (!Function_34(iParam0))
	{
...
void Function_93(int iParam0, float fParam1) //Position: 0x3FE9 / 16361
{
...
var Function_94(bool bParam0) //Position: 0x400C / 16396
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_31(bParam0, "RandUseTime", 0.0f));
}

void Function_95(int iParam0) //Position: 0x402C / 16428
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_96(var uParam0) //Position: 0x4040 / 16448
{
	uParam0 = uParam0;
	return;
}

int Function_97() //Position: 0x404A / 16458
{
	return 1;
}

void Function_98(var uParam0, int iParam1) //Position: 0x4051 / 16465
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_99(bool bParam0, var uParam1, int iParam2) //Position: 0x4060 / 16480
{
	bool bVar0;
...
bool Function_100(bool bParam0) //Position: 0x409F / 16543
{
	return Function_31(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_101(bool bParam0) //Position: 0x40CA / 16586
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_102(bool bParam0) //Position: 0x40D5 / 16597
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_103(bool bParam0) //Position: 0x41CB / 16843
{
	return Function_27(bParam0, "UsePosActorRelative", 0);
}

bool Function_104(bool bParam0) //Position: 0x41ED / 16877
{
	return Function_31(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_105(bool bParam0) //Position: 0x4214 / 16916
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		iLocal_16 = 1;
		cLocal_17 = CREATE_LAYOUT("PickHerb_Layout");
		vVar0 = { 0.0f, 0.0f, 0.0f };
		...
		Function_106(cLocal_17, 0, Global_34573, 1, 0, 0);
	}
	return;
}

var Function_106(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x428E / 17038
{
	bool bVar0;
...
void Function_107(var uParam0, int iParam1) //Position: 0x4308 / 17160
{
	bool bVar0;
	bool bVar1;
...
void Function_108(var uParam0, bool bParam1) //Position: 0x435C / 17244
{
...
void Function_109(var uParam0, bool bParam1) //Position: 0x43E0 / 17376
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 51.99636f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_110(int iParam0) //Position: 0x4464 / 17508
{
	iParam0 = iParam0;
	return;
}

bool Function_111(bool bParam0) //Position: 0x446E / 17518
{
	return Function_27(bParam0, "MaintainPosture", 0);
}

void Function_112(int iParam0) //Position: 0x448C / 17548
{
	if (!Function_34(iParam0))
	{
...
bool Function_113(bool bParam0, bool bParam1) //Position: 0x44A1 / 17569
{
	vector3 vVar0;
	bool bVar3;
	vector3 vVar4;
...
vector3 Function_114(int iParam0) //Position: 0x454B / 17739
{
	vector3 vVar0;
...
vector3 Function_115(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x456E / 17774
{
	vector3 vVar0;
...
bool Function_116(bool bParam0) //Position: 0x458C / 17804
{
	return Function_31(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_117(bool bParam0, bool bParam1) //Position: 0x45AF / 17839
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_118(bool bParam0, int iParam1) //Position: 0x46CA / 18122
{
...
int Function_119(bool bParam0) //Position: 0x46F5 / 18165
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_120(var uParam0, int iParam1) //Position: 0x47FA / 18426
{
	return (uParam0 && iParam1) == 0;
}

void Function_121(int iParam0) //Position: 0x4807 / 18439
{
	if (Function_120(iParam0->f_40, 16))
	{
...
void Function_122(int iParam0, bool bParam1) //Position: 0x487A / 18554
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_47));
		iLocal_48 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_80(iParam0->f_12))
...
void Function_123() //Position: 0x4D78 / 19832
{
	bool bVar0;
...
bool Function_124(bool bParam0) //Position: 0x4DAF / 19887
{
	return Function_31(bParam0, "ReuseDelay", 15.0f);
}

void Function_125(var uParam0, int iParam1) //Position: 0x4DCC / 19916
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_126(int iParam0) //Position: 0x4E04 / 19972
{
	iParam0 = iParam0;
	return;
}

bool Function_127(bool bParam0) //Position: 0x4E0E / 19982
{
	return Function_27(bParam0, "BlockBumpReactions", 0);
}

void Function_128(bool bParam0, int iParam1) //Position: 0x4E2F / 20015
{
	iParam1 = iParam1;
	HUD_ENABLE(true);
	if (IS_ACTOR_VALID(bParam0))
...
void Function_129(bool bParam0, bool bParam1) //Position: 0x4E6C / 20076
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_130(bool bParam0, bool bParam1) //Position: 0x4F74 / 20340
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_131(int iParam0) //Position: 0x4F8A / 20362
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_132(bool bParam0, int iParam1) //Position: 0x5240 / 21056
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_133(bool bParam0) //Position: 0x527A / 21114
{
	return Function_27(bParam0, "DrawWeapon", 0);
}

bool Function_134(bool bParam0) //Position: 0x5293 / 21139
{
	return Function_27(bParam0, "AllowWeapon", 0);
}

void Function_135(bool bParam0, int iParam1) //Position: 0x52AD / 21165
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_136(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_136(var uParam0, int iParam1) //Position: 0x52E5 / 21221
{
	return Function_29(uParam0, "UseName", iParam1);
}

bool Function_137(int iParam0, int iParam1) //Position: 0x52FC / 21244
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_138(bool bParam0) //Position: 0x55C5 / 21957
{
	return Function_31(bParam0, "ActivationCone", 0.0f);
}

bool Function_139(bool bParam0, bool bParam1) //Position: 0x55E2 / 21986
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_140(int iParam0) //Position: 0x567E / 22142
{
	return Function_31(iParam0, "ActivationRadius", 2.0f);
}

bool Function_141(bool bParam0, int iParam1) //Position: 0x569D / 22173
{
	iParam1 = iParam1;
	if (!IS_ACTOR_VALID(bParam0))
	{
...
void Function_142(int iParam0) //Position: 0x5739 / 22329
{
	iParam0 = iParam0;
	return;
}

void Function_143(bool bParam0, int iParam1) //Position: 0x5743 / 22339
{
	int iVar0;
	int iVar1;
...
void Function_144(int iParam0, int iParam1) //Position: 0x57A5 / 22437
{
...
void Function_145(int iParam0) //Position: 0x57B9 / 22457
{
	iParam0 = iParam0;
	return;
}

void Function_146(int iParam0) //Position: 0x57C3 / 22467
{
