...
void Function_8(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x531 / 1329
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_12(char* cParam0, bool bParam1) //Position: 0xC6C / 3180
{
	char* cVar0[32];
...
bool Function_43(bool bParam0) //Position: 0x2923 / 10531
{
...
void Function_45(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2975 / 10613
{
	struct<4> Var0;
	int iVar4;
...
void Function_57(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x351C / 13596
{
	...
	if (bVar12)
	{
		if (bVar11)
		{
			...
			if ((Function_59() && DECOR_CHECK_EXIST(bParam0, "Zombie")) || (bVar0 <= 1222 && bVar0 >= 1227))
			{
...
void Function_68(bool bParam0, bool bParam1, bool bParam2) //Position: 0x413A / 16698
{
	int iVar0;
	bool bVar1;
	
	if (Function_82(0) && (!Global_3380 || bParam0 == 100))
	{
		return;
	}
	bVar1 = bParam0;
...
void Function_75(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x4BEA / 19434
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
int Function_112() //Position: 0x700B / 28683
{
	...
	while (iVar0 <= 3)
	{
		...
		if (!IS_SCRIPT_VALID(StackVal) && Function_142(&(Global_62484[iVar014]), 1))
		{
			...
			{
				iVar2 = GET_ACTOR_FROM_PERS_CHAR(Global_62484[iVar014].f_28);
			}
			if (IS_PERS_CHAR_VALID(Global_62484[iVar014].f_28))
			{
				if (IS_PERS_CHAR_ALIVE(Global_62484[iVar014].f_28) && !Function_121(iVar2))
				{
...
int Function_139(int iParam0, int iParam1) //Position: 0x7AE7 / 31463
{
	var uVar0;
...
int Function_149(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x80F6 / 33014
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
vector3 Function_160(bool bParam0) //Position: 0x8AC1 / 35521
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_161(vector3 vParam0) //Position: 0x8B18 / 35608
{
	bool bVar0;
...
bool Function_166(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x8F4E / 36686
{
...
bool Function_189(bool bParam0) //Position: 0xA29A / 41626
{
...
void Function_205(int iParam0) //Position: 0xAB90 / 43920
{
	...
	ADD_TIME(&Global_12976 + 4, 0, false, (iParam0 + Function_206(105)), 0);
	return;
}
...
void Function_207(bool bParam0) //Position: 0xABC7 / 43975
{
...
void Function_208(int iParam0) //Position: 0xAC63 / 44131
{
	...
	ADD_TIME(&Global_12976 + 12, 0, false, (iParam0 + Function_206(90)), 0);
	return;
}
...
void Function_234(bool bParam0, bool bParam1) //Position: 0xC6DC / 50908
{
...
void Function_237(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0xCA54 / 51796
{
	*uParam3 = (bParam0 && 15);
...
void Function_277(bool bParam0) //Position: 0xE361 / 58209
{
	...
	if (Global_27774[bParam013].f_48 == 4294967295 && Global_27774[bParam013].f_48 == 0)
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_280(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), false, 0);
...
void Function_279(bool bParam0, bool bParam1) //Position: 0xE568 / 58728
{
	bool bVar0;
...
void Function_303(bool bParam0, bool bParam1, int iParam2) //Position: 0xFDA7 / 64935
{
	bool bVar0;
...
void Function_318(var uParam0, char* cParam1, var uParam2, var uParam3) //Position: 0x13651 / 79441
{
	...
	Function_321(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_320(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_319(&bVar0, uParam2);
...
void Function_323(var uParam0, char* cParam1, var uParam2, var uParam3) //Position: 0x138C7 / 80071
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_326(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_325(&bVar0, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
...
void Function_328(var uParam0, var uParam1, int iParam2) //Position: 0x13B79 / 80761
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_330(&bVar0, uParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_329(&bVar0, iParam2);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_332(var uParam0, int iParam1) //Position: 0x13D40 / 81216
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_334(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_333(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_336(var uParam0, int iParam1) //Position: 0x13ED3 / 81619
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_338(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_337(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_340(var uParam0, int iParam1) //Position: 0x140B4 / 82100
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_342(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_341(&bVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 0.25f, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_EASE_IN_OUT(*uParam0, 0, 1, 0.9f, 1, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 1, 1.0f, 2);
...
void Function_348(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x14469 / 83049
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_349(&bVar0, uParam1, uParam2, uParam3);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_429(var uParam0, var uParam1, char* cParam2) //Position: 0x168D8 / 92376
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_431(&bVar0, uParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_430(&bVar0, uParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_434(var uParam0, char* cParam1) //Position: 0x16B22 / 92962
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_437(&bVar0, cParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_436(&bVar0, cParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 2);
	Function_435(&bVar0, cParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
int Function_449(bool bParam0) //Position: 0x170DD / 94429
{
	bool bVar0;
