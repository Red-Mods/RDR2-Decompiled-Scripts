	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_38(Global_30658[1]))
			{
				...
				if (Function_35() <= iLocal_4)
				{
					Function_31("HorseShoes_NotEnoughMoney", 4.0f, 0, 2, 1, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_24(Global_30658[1], &Local_24 + 4, &Local_24 + 68, &Local_24 + 72, &Local_24 + 60, &Local_24 + 64))
			{
				Function_23(&Local_24 + 4);
				Function_22(Global_30658[1], 0);
				*(&Local_24 + 16[03]) = { StackVal, StackVal, Function_22(Global_30658[1], 0) };
				Function_22(Global_30658[1], 1);
				*(&Local_24 + 16[13]) = { StackVal, StackVal, Function_22(Global_30658[1], 1) };
				Local_24 = Local_6;
				Local_24.f_52 = 1;
				if (Function_21())
				{
				...
				Local_24.f_44 = CREATE_VOLUME_IN_LAYOUT(bLocal_5, "StayOutVol", 2, -3662.599f, 43.03283f, 2134.773f, 0.0f, -46.61358f, 0.0f, 8.22709f, 3.373459f, 21.7038f);
...
void Function_17() //Position: 0x5F4 / 1524
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5FD / 1533
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x61E / 1566
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, var uParam1) //Position: 0x654 / 1620
{
	if (!Function_8(iParam0))
	{
		return;
	}
	Global_13172[iParam011].f_16 = uParam1;
	return;
}

bool Function_21() //Position: 0x66F / 1647
{
...
vector3 Function_22(int iParam0, int iParam1) //Position: 0x69A / 1690
{
...
void Function_23(bool bParam0) //Position: 0x7C6 / 1990
{
	int iVar0;
	bool bVar1;
...
bool Function_24(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x81B / 2075
{
	vector3 vVar0;
	int iVar3;
	
	Function_30(iParam0, 0);
	vVar0 = { StackVal, StackVal, Function_30(iParam0, 0) };
	*uParam2 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_horseshoe", &vVar0, 1.0f, 0);
	Function_30(iParam0, 1);
	vVar0 = { StackVal, StackVal, Function_30(iParam0, 1) };
	*uParam3 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_horseshoe", &vVar0, 1.0f, 0);
	Function_30(iParam0, 0);
	Function_30(iParam0, 1);
	if (StackVal > Function_29(StackVal, StackVal, StackVal, Function_29(StackVal, StackVal, StackVal, StackVal, Global_34574, Function_30(iParam0, 0)), Global_34574, Function_30(iParam0, 1)))
	{
		iVar3 = 0;
		*uParam4 = 1;
		*uParam5 = 0;
	...
	{
		if (Function_25(Global_34573, 1, 1))
		{
			return 0;
		}
		return 1;
...
bool Function_25(bool bParam0, bool bParam1, bool bParam2) //Position: 0x968 / 2408
{
...
bool Function_26() //Position: 0xA1E / 2590
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_27(bool bParam0) //Position: 0xA35 / 2613
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_28(bool bParam0) //Position: 0xA40 / 2624
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

float Function_29(vector3 vParam0, vector3 vParam3) //Position: 0xA4E / 2638
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_30(int iParam0, bool bParam1) //Position: 0xA6B / 2667
{
	if (iParam0 == Global_30668[0])
	{
		if (bParam1 == 0)
...
void Function_31(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xB82 / 2946
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_32(int iParam0) //Position: 0xBF9 / 3065
{
	char* cVar0[16];
...
bool Function_33() //Position: 0xC38 / 3128
{
...
bool Function_34(var uParam0, bool bParam1) //Position: 0xC53 / 3155
{
	return (uParam0 && bParam1) == 0;
}

int Function_35() //Position: 0xC60 / 3168
{
	return Function_36(0);
}

int Function_36(int iParam0) //Position: 0xC6A / 3178
{
...
var Function_37(int iParam0) //Position: 0xCAB / 3243
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_38(int iParam0) //Position: 0xCC5 / 3269
{
...
int Function_39(var uParam0, int iParam1) //Position: 0xCE1 / 3297
{
	int iVar0;
...
bool Function_40(int iParam0) //Position: 0xCFD / 3325
{
...
void Function_41() //Position: 0xD13 / 3347
{
	Function_1();
	return;
}

void Function_42() //Position: 0xD1C / 3356
{
	bLocal_5 = CREATE_LAYOUT(Function_51());
	Function_49(0, 1);
	Function_48();
...
void Function_43(int iParam0) //Position: 0xD68 / 3432
{
...
void Function_44(var uParam0, float fParam1) //Position: 0xD7D / 3453
{
...
void Function_45(var uParam0, int iParam1) //Position: 0xD9E / 3486
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_46(var uParam0, int iParam1) //Position: 0xDB1 / 3505
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_47(var uParam0) //Position: 0xDC0 / 3520
{
	return Function_34(*uParam0, 1);
}

void Function_48() //Position: 0xDCD / 3533
{
	return;
}

void Function_49(bool bParam0, bool bParam1) //Position: 0xDD3 / 3539
{
	bool bVar0;
...
void Function_50(var uParam0) //Position: 0xE2A / 3626
{
	int iVar0;
...
var Function_51() //Position: 0xE47 / 3655
{
	var uVar0;
