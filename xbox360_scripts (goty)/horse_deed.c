...
void Function_6() //Position: 0x213 / 531
{
...
void Function_7() //Position: 0x319 / 793
{
	float fVar0;
...
void Function_8() //Position: 0x34C / 844
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x4DA / 1242
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x68E / 1678
{
	Function_11(&Global_28260, 1, 0);
	return;
}

void Function_11(int iParam0, bool bParam1, var uParam2) //Position: 0x69C / 1692
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_12() //Position: 0x88D / 2189
{
...
struct<8> Function_13(int iParam0) //Position: 0x8A2 / 2210
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_14(int iParam0, bool bParam1, bool bParam2) //Position: 0x948 / 2376
{
	int iVar0;
...
void Function_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBE3 / 3043
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_16() //Position: 0x1210 / 4624
{
	int iVar0;
...
var Function_17(int iParam0) //Position: 0x1218 / 4632
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1229 / 4649
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0, bool bParam1) //Position: 0x131E / 4894
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1337 / 4919
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x139C / 5020
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x13AE / 5038
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x13C0 / 5056
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x14F0 / 5360
{
	return Global_35278[iParam020].f_48;
}

float Function_25(int iParam0) //Position: 0x14FF / 5375
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x1538 / 5432
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x1575 / 5493
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x170F / 5903
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x1953 / 6483
{
...
struct<8> Function_30() //Position: 0x1994 / 6548
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x1A1D / 6685
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x1AB4 / 6836
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x1B33 / 6963
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x1B6C / 7020
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x1D76 / 7542
{
	vector3 vVar0;
	var uVar3;
...
bool Function_36(vector3 vParam0) //Position: 0x1E31 / 7729
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_37(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1E49 / 7753
{
	int iVar0;
...
vector3 Function_38() //Position: 0x1F30 / 7984
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_39(var uParam0, int iParam1) //Position: 0x1F39 / 7993
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_40(int iParam0) //Position: 0x1F48 / 8008
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x1F5E / 8030
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x2025 / 8229
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_43(var uParam0, int iParam1) //Position: 0x2042 / 8258
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_44(int iParam0) //Position: 0x2867 / 10343
{
	var uVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x28A2 / 10402
{
	return (uParam0 && iParam1) == 0;
}

void Function_46(bool bParam0, int iParam1) //Position: 0x28AF / 10415
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_47() //Position: 0x28BC / 10428
{
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x28D7 / 10455
{
	uParam0 = uParam0;
...
int Function_49(bool bParam0) //Position: 0x297B / 10619
{
	var uVar0;
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_73(bParam0, uVar0))
			{
				Function_66(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_65(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_62(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
...
void Function_50(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A24 / 10788
{
	bool bVar0;
	
	*iParam2 = *iParam2;
	bVar0 = Function_65(bParam0);
...
bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A4D / 10829
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (*iParam2)
	{
		switch (iLocal_4)
		{
			case 0x00000000:
				...
				bVar1 = Function_60(Function_61(bParam0), "nActorEnum", &iVar0);
				iVar2 = GET_ACTOR_ENUM_FROM_STRING(bVar1);
				Function_59(iVar2, 1, 1);
				Function_56(0, 0x40400000);
			...
			case 0x00000001:
				if (Function_55())
				{
					Function_54(4294967295);
					iLocal_4 = 2;
				}
				break;
			
			case 0x00000002:
				Function_52("own_new_horse", 0x41200000, 1, 0, 2, 1, 0);
...
void Function_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2B52 / 11090
{
	struct<4> Var0;
	int iVar4;
	...
	if (Global_3380 != 1 && Global_6269 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_53(Global_6269) };
		}
...
struct<16> Function_53(int iParam0) //Position: 0x2BCD / 11213
{
	char* cVar0[16];
...
void Function_54(bool bParam0) //Position: 0x2C0C / 11276
{
...
bool Function_55() //Position: 0x2C4C / 11340
{
	bool bVar0;
...
void Function_56(bool bParam0, float fParam1) //Position: 0x2C6C / 11372
{
...
void Function_57() //Position: 0x2D6A / 11626
{
...
void Function_58() //Position: 0x2D9C / 11676
{
...
void Function_59(var uParam0, bool bParam1, bool bParam2) //Position: 0x2E99 / 11929
{
...
bool Function_60(bool bParam0, bool bParam1, int iParam2) //Position: 0x2EC6 / 11974
{
	int iVar0;
	bool bVar1;
...
bool Function_61(bool bParam0) //Position: 0x2F0B / 12043
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

void Function_62(bool bParam0, var uParam1, int iParam2) //Position: 0x2F25 / 12069
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_63(bool bParam0, bool bParam1) //Position: 0x2FAF / 12207
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_64(bool bParam0) //Position: 0x305D / 12381
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_65(bool bParam0) //Position: 0x3073 / 12403
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_66(var uParam0, bool bParam1, int iParam2) //Position: 0x3089 / 12425
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	uParam0 = Function_61(uParam0);
	iVar0 = 1;
	if (IS_ACTOR_VALID(Global_12976.f_36))
	{
		uVar1 = Function_60(uParam0, "nActorEnum", &iVar0);
		bVar2 = GET_ACTOR_ENUM_FROM_STRING(uVar1);
		bVar3 = GET_ACTOR_ENUM(Global_12976.f_36);
		iVar4 = 0;
		Function_72(Global_34573);
		vVar5 = { StackVal, StackVal, Function_72(Global_34573) };
		if (GET_ACTORENUM_SPECIES(bVar2) == 23)
		{
			bVar8 = LOCATE_ACTOR_OF_TYPE(vVar5, 140.0f, 23, bVar2);
		}
		else
		{
			bVar8 = LOCATE_ACTOR_OF_TYPE(vVar5, 140.0f, 24, bVar2);
		}
		Function_56(0, 0x40400000);
		if (IS_ACTOR_VALID(Global_12976.f_36))
		{
			TASK_PRIORITY_SET(Global_12976.f_36, 1);
			TASK_FLEE_ACTOR(Global_12976.f_36, Global_34573, 250.0f, -1.0f, 0, 0, 0);
		}
		if (IS_ACTOR_VALID(bVar8))
		{
			if (DECOR_CHECK_EXIST(bVar8, "WasPlayerMount"))
			{
				iVar4 = 1;
				Function_39(&Global_12976 + 36 + 20, 2);
				Function_71(bVar8, 1);
			}
		}
		if (bVar3 != bVar2 || iVar4)
		{
			Function_52("already_have_horse", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
		else
		{
	...
	if ((Function_67(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	return;
...
int Function_67(bool bParam0, bool bParam1, bool bParam2) //Position: 0x31C8 / 12744
{
...
bool Function_68() //Position: 0x327E / 12926
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_69(bool bParam0) //Position: 0x3295 / 12949
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_70(bool bParam0) //Position: 0x32A0 / 12960
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_71(bool bParam0, bool bParam1) //Position: 0x32AE / 12974
{
...
vector3 Function_72(bool bParam0) //Position: 0x32F1 / 13041
{
	vector3 vVar0;
...
bool Function_73(int iParam0, bool bParam1) //Position: 0x3302 / 13058
{
	bool bVar0;
	bool bVar1;
