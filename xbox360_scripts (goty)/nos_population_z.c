...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Nos", 4);
	Function_12("Loading Nosalida population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("Nosalida_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "nosv_dogs_set");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("nos_pop: Cannot find nosv_dogs to create dogs");
		}
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "nosv_goats_set");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, uVar0, 10, 0, 0, 1);
		}
	...
	Function_5("Finished loading Nosalida population file", 5.0f);
	Function_1(&(Global_29008[iScriptParam_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC47 / 3143
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC56 / 3158
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCAB / 3243
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD2B / 3371
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD47 / 3399
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD85 / 3461
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDA1 / 3489
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDB1 / 3505
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xDF6 / 3574
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE02 / 3586
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0xE7E / 3710
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xE8B / 3723
{
	if (!Function_4(128))
	{
		return;
