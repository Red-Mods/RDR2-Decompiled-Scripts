...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Gtr", 4);
	Function_15("Loading Gaptooth Ridge population file", 3);
	Global_30839++;
	...
	bVar12 = FIND_NAMED_LAYOUT("GaptoothRidge_layout");
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "gapv_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			...
			uVar16 = Function_3(bVar13, uVar5, 7E-06f, 0, 0, 1);
		...
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "gapv_flk_SW_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar20 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(bVar13, uVar5, 7E-06f, 0, 0, 1);
			...
			uVar22 = Function_3(bVar13, uVar6, 1.5E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(bVar13, uVar7, 3E-05f, 0, 0, 1);
			...
			uVar24 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
		...
		bVar13 = FIND_VOLUME_IN_LAYOUT(bVar12, "gapv_flk_NORTH_set");
		if (IS_VOLUME_VALID(bVar13))
		{
			uVar25 = Function_3(bVar13, uVar0, 3E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(bVar13, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar27 = Function_3(bVar13, uVar5, 1E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(bVar13, uVar6, 2.5E-05f, 0, 0, 1);
			...
			uVar29 = Function_3(bVar13, uVar7, 3.5E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(bVar13, uVar10, 1E-05f, 0, 0, 1);
			...
			Function_3(bVar13, Global_30750[7], 2E-05f, 0, 0, 1);
			Function_3(bVar13, uVar1, 3.5E-05f, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0x1212 / 4626
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1221 / 4641
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1276 / 4726
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0x12F6 / 4854
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0x1312 / 4882
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0x1350 / 4944
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0x136C / 4972
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x137C / 4988
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0x13F4 / 5108
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0x1460 / 5216
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x14CC / 5324
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0x1511 / 5393
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x151D / 5405
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x1599 / 5529
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0x15A6 / 5542
{
	if (!Function_4(128))
	{
		return;
