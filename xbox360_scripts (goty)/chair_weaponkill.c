...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3383 / 13187
{
...
void Function_87(var uParam0, int iParam1) //Position: 0x364F / 13903
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x365D / 13917
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3676 / 13942
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3690 / 13968
{
	bool bVar0;
	var uVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36C8 / 14024
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36DF / 14047
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39A8 / 14760
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39C5 / 14789
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A61 / 14945
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3A80 / 14976
{
	if (GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill", bParam1))
	{
