...
void main() //Position: 0x0 / 0
{
	...
	if (Function_132())
	{
		Local_39.f_1892 = 15.0f;
		*(&Local_39 + 1896) = { -3637.483f, 7.618f, 4246.973f };
		vVar0[03] = { -3643.954f, 7.911f, 4246.019f };
		vVar0[13] = { -3642.485f, 7.936f, 4240.42f };
		vVar0[23] = { -3636.17f, 7.298f, 4239.763f };
		vVar0[33] = { -3633.193f, 7.44f, 4243.892f };
		vVar0[43] = { -3638.453f, 7.573f, 4242.587f };
		Function_99(&vVar0, 0);
		Function_97(1);
		if (Function_96(Global_79962, 128))
		{
			Function_95(2, 10000, 1700);
			Function_95(1, 8400, 1400);
			Function_95(0, 7500, 1100);
			Function_93(2, 18.0f, 500);
			Function_93(1, 24.0f, 250);
			Function_93(0, 30.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(89);
		}
		else
		{
			Function_95(2, 6700, 1200);
			Function_95(1, 5500, 900);
			Function_95(0, 4800, 600);
			Function_93(2, 18.0f, 500);
			Function_93(1, 24.0f, 250);
			Function_93(0, 30.0f, 100);
			NET_CREATE_FRIEND_SCORE_READER(35);
		}
...
void Function_1() //Position: 0x18D / 397
{
...
void Function_2() //Position: 0x1BC / 444
{
	Function_3();
	return;
}

void Function_3() //Position: 0x1C5 / 453
{
...
void Function_4(int iParam0, bool bParam1, int iParam2) //Position: 0x2CE / 718
{
	iParam2 = iParam2;
	if (bParam1)
	{
...
void Function_5(var uParam0, int iParam1) //Position: 0x2F6 / 758
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_6(var uParam0, int iParam1) //Position: 0x309 / 777
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_7(int iParam0) //Position: 0x318 / 792
{
	return Function_96(Global_76905.f_132, iParam0);
}

void Function_8() //Position: 0x329 / 809
{
	bool bVar0;
...
var Function_9(bool bParam0) //Position: 0x342 / 834
{
	bool bVar0;
...
var Function_10() //Position: 0x38F / 911
{
...
void Function_11(int iParam0) //Position: 0x3BE / 958
{
	int iVar0;
...
void Function_12(var uParam0, int iParam1) //Position: 0x3E4 / 996
{
...
void Function_13(var uParam0, int iParam1) //Position: 0x512 / 1298
{
	int iVar0;
...
bool Function_14(var uParam0, int iParam1) //Position: 0x52C / 1324
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1, int iParam2) //Position: 0x549 / 1353
{
...
void Function_16(var uParam0, var uParam1, int iParam2) //Position: 0x6E2 / 1762
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_17(bool bParam0, int iParam1, int iParam2) //Position: 0x85A / 2138
{
	var uVar0;
...
int Function_18(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x86B / 2155
{
	char* cVar0[32];
...
bool Function_19(bool bParam0, int iParam1, bool bParam2) //Position: 0x8D0 / 2256
{
	char* cVar0[64];
	int iVar16;
...
var Function_20(int iParam0) //Position: 0x951 / 2385
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_21(bool bParam0) //Position: 0xC6A / 3178
{
	char* cVar0[64];
...
void Function_22(bool bParam0) //Position: 0xD0B / 3339
{
...
bool Function_23() //Position: 0xD25 / 3365
{
	return Function_7(32768);
}

void Function_24() //Position: 0xD32 / 3378
{
	Function_4(32768, 1, 0);
	return;
}

int Function_25() //Position: 0xD41 / 3393
{
	int iVar0;
	int iVar1;
...
void Function_26(int iParam0, int iParam1) //Position: 0xD6B / 3435
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_27(bool bParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xEF4 / 3828
{
...
int Function_28(int iParam0) //Position: 0xF17 / 3863
{
	*iParam0 = (*iParam0 - 1);
	return *iParam0 + 1;
}

void Function_29(var uParam0, bool bParam1) //Position: 0xF2A / 3882
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_30(var uParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x1202 / 4610
{
	bool bVar0;
...
var Function_31(var uParam0, int iParam1, bool bParam2) //Position: 0x1253 / 4691
{
	int iVar0;
...
var Function_32(bool bParam0) //Position: 0x1272 / 4722
{
	return SHIFT_LEFT(true, bParam0);
}

var Function_33(int iParam0) //Position: 0x127E / 4734
{
...
int Function_34(int iParam0, var uParam1, int iParam2) //Position: 0x129E / 4766
{
	bool bVar0;
	int iVar1;
...
int Function_35(int iParam0, int iParam1, int iParam2) //Position: 0x12F1 / 4849
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x1332 / 4914
{
	int iVar0;
...
void Function_37(int iParam0, var uParam1, int iParam2) //Position: 0x1358 / 4952
{
	float fVar0;
...
var Function_38(int iParam0) //Position: 0x1389 / 5001
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return -1.0f;
...
var Function_39(float fParam0) //Position: 0x13A9 / 5033
{
	int iVar0;
	float fVar1;
	var uVar2;
...
int Function_40() //Position: 0x13D6 / 5078
{
	if (!Function_41())
	{
		return 4294967295;
...
bool Function_41() //Position: 0x13EB / 5099
{
	return UNK_0xA80C6DE6(&Global_78578);
}

void Function_42(bool bParam0, int iParam1) //Position: 0x13F8 / 5112
{
	struct<13> Var0;
...
struct<16> Function_43(var uParam0) //Position: 0x1625 / 5669
{
	struct<4> Var0;
	bool bVar4;
...
var Function_44(int iParam0) //Position: 0x1696 / 5782
{
...
void Function_45() //Position: 0x1767 / 5991
{
	if (!Function_46())
	{
	}
...
bool Function_46() //Position: 0x1774 / 6004
{
	return NET_IS_IN_SESSION();
}

bool Function_47(int iParam0) //Position: 0x177D / 6013
{
	return Function_96(*iParam0, 2);
}

bool Function_48(int iParam0) //Position: 0x178A / 6026
{
	return Function_96(*iParam0, 1);
}

void Function_49(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x1797 / 6039
{
	if (iParam2 != 0)
	{
...
int Function_50(int iParam0) //Position: 0x17E6 / 6118
{
	return Function_51(0, iParam0);
}

int Function_51(int iParam0, bool bParam1) //Position: 0x17F2 / 6130
{
	char* cVar0[64];
...
int Function_52(int iParam0) //Position: 0x1859 / 6233
{
	return (*&Global_78480 + 132)[iParam0];
}

int Function_53(int iParam0, bool bParam1) //Position: 0x1869 / 6249
{
	char* cVar0[64];
...
int Function_54(int iParam0) //Position: 0x18D7 / 6359
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_55(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x18F0 / 6384
{
	bool bVar0;
	bool bVar1;
...
void Function_56(bool bParam0, bool bParam1) //Position: 0x1990 / 6544
{
	if (Function_7(4))
	{
...
int Function_57(bool bParam0) //Position: 0x19C3 / 6595
{
	return Function_53(12, bParam0);
}

void Function_58(bool bParam0, int iParam1, bool bParam2) //Position: 0x19D0 / 6608
{
	if (bParam0)
	{
		if (Function_23())
...
int Function_59() //Position: 0x19F1 / 6641
{
	if (!Function_61(1))
	{
		return 0;
...
void Function_60() //Position: 0x1A8F / 6799
{
	if (Function_7(4096))
	{
...
bool Function_61(bool bParam0) //Position: 0x1ACC / 6860
{
	char* cVar0[64];
...
void Function_62(bool bParam0) //Position: 0x1B4D / 6989
{
...
struct<64> Function_63(int iParam0) //Position: 0x1BD6 / 7126
{
...
int Function_65(bool bParam0, bool bParam1) //Position: 0x1C2F / 7215
{
...
void Function_66() //Position: 0x1C63 / 7267
{
...
bool Function_67(int iParam0) //Position: 0x1C9D / 7325
{
	return Function_96(StackVal, iParam0);
}

void Function_68() //Position: 0x1CB0 / 7344
{
	if (IS_LAYOUTREF_VALID(Local_39.f_1808))
	{
		DESTROY_LAYOUT(Local_39.f_1808);
...
void Function_69(int iParam0) //Position: 0x1CD4 / 7380
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_86(StackVal, StackVal, 10517, *(&Local_39 + 1896), 1, iParam0);
	bVar1 = true;
	...
	while (iVar0 <= Local_39.f_1804)
	{
		...
		else
		{
			...
			if (bVar1)
			{
				...
				if (WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(Local_39[iVar090].f_356))
				{
					...
					PRINT_SMALL_FORMAT(2.5f, "COOP_Selected", Function_77(Local_39[iVar090].f_324, 0), false, 0, 0, 2, 0, 0);
		...
		Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &(Local_39[iVar090]), vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.725f, 0.0f), 1, 8799, 0, iVar6, iVar0, "", iVar7);
		if (Function_71(Local_39[iVar090].f_352))
		{
			Function_72(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &Local_39[iVar090] + 48, vVar3, fVar8, Vector(*(&Local_39[iVar090] + 332), Local_39[iVar090].f_328, fVar9) + Vector(0.0f, 2.25f, 0.0f), Local_39[iVar090].f_344, 8054, 0, iVar6, iVar0, "", iVar7);
		}
		else
		{
			Function_76(&Local_39[iVar090] + 48);
...
var Function_70(int iParam0, int iParam1) //Position: 0x1F76 / 8054
{
	return GET_WEAPON_DISPLAY_NAME((*&Local_39[iParam190] + 96)[iParam0 + 12]);
}

bool Function_71(bool bParam0) //Position: 0x1F8D / 8077
{
	bool bVar0;
	bool bVar1;
...
void Function_72(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) //Position: 0x1FD2 / 8146
{
	float fVar0;
	vector3 vVar1;
	float fVar4;
...
var Function_73(float fParam0) //Position: 0x2251 / 8785
{
	return (fParam0 * 57.29578f);
}

int Function_74(var uParam0, int iParam1) //Position: 0x225F / 8799
{
	uParam0 = uParam0;
	return Function_77(Local_39[iParam190].f_324, 1);
}

void Function_75(int iParam0, int iParam1) //Position: 0x2276 / 8822
{
...
void Function_76(int iParam0) //Position: 0x229F / 8863
{
	if (IS_OBJECT_VALID(*iParam0))
	{
...
int Function_77(int iParam0, bool bParam1) //Position: 0x22C5 / 8901
{
	if (bParam1)
	{
		switch (iParam0)
...
var Function_78(int iParam0) //Position: 0x2638 / 9784
{
	switch (iParam0)
	{
		case 0x00000001:
...
void Function_79(int iParam0) //Position: 0x26CF / 9935
{
	Function_80(&Global_83864 + 1256, iParam0);
	return;
}

void Function_80(var uParam0, int iParam1) //Position: 0x26E1 / 9953
{
	Function_6(uParam0, iParam1);
	return;
}

void Function_81(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x26EE / 9966
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_82(int iParam0) //Position: 0x2769 / 10089
{
	char* cVar0[16];
...
bool Function_83() //Position: 0x27A8 / 10152
{
...
bool Function_84(int iParam0) //Position: 0x27C3 / 10179
{
	return Function_85(Global_83864.f_1256, iParam0);
}

int Function_85(var uParam0, bool bParam1) //Position: 0x27D5 / 10197
{
	return (uParam0 && bParam1) == 0;
}

void Function_86(var uParam0, vector3 vParam1, var uParam4, var uParam5) //Position: 0x27E2 / 10210
{
	...
	Function_87(StackVal, StackVal, StackVal, StackVal, Vector(vParam1, Local_12.f_104, &Local_12) + Vector(0.0f, 2.45f, 0.0f), 1, 10416, 1, 125, 0, 0, 0);
...
void Function_87(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, int iParam7, bool bParam8, bool bParam9, int iParam10, int iParam11) //Position: 0x2865 / 10341
{
	vector3 vVar0;
	int iVar3;
...
var Function_88(int iParam0, var uParam1) //Position: 0x28B0 / 10416
{
	char* cVar0[64];
...
var Function_89() //Position: 0x2915 / 10517
{
	int iVar0;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x298E / 10638
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_91(var uParam0, var uParam1) //Position: 0x29DA / 10714
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return "NOS_Summary";
...
bool Function_92(int iParam0, bool bParam1) //Position: 0x29F6 / 10742
{
	int iVar0;
...
void Function_93(int iParam0, float fParam1, int iParam2) //Position: 0x2A16 / 10774
{
	Function_94(iParam0, (fParam1 + TO_FLOAT(iParam2 * 1000)));
	return;
}

void Function_94(int iParam0, int iParam1) //Position: 0x2A2C / 10796
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
...
void Function_95(int iParam0, int iParam1, bool bParam2) //Position: 0x2A4D / 10829
{
	Function_140(iParam0, (iParam1 + SHIFT_LEFT(bParam2, 20)));
	return;
}

bool Function_96(var uParam0, int iParam1) //Position: 0x2A62 / 10850
{
	return (uParam0 && iParam1) == 0;
}

void Function_97(int iParam0) //Position: 0x2A6F / 10863
{
	Function_98(8, iParam0);
	return;
}

void Function_98(int iParam0, bool bParam1) //Position: 0x2A7C / 10876
{
	if (bParam1)
	{
...
void Function_99(var uParam0, bool bParam1) //Position: 0x2AA4 / 10916
{
	bool bVar1;
	bool bVar2;
	...
	while (!Function_126(&Local_39 + 1828) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	Function_125();
	...
	{
		Local_39.f_1804 = 5;
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[090]), *uParam0[03], 4, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[03]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[190]), *uParam0[13], 5, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[13]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[290]), *uParam0[23], 6, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[23]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[390]), *uParam0[33], 7, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[33]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[490]), *uParam0[43], 8, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[43]), bParam1);
	}
	else
	{
		Local_39.f_1804 = 4;
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[090]), *uParam0[03], 0, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[03]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[190]), *uParam0[13], 1, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[13]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[290]), *uParam0[23], 2, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[23]), bParam1);
		Function_100(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_123(&(Local_39[390]), *uParam0[33], 3, Local_39.f_1808, *(&Global_79349 + 28), *uParam0[33]), bParam1);
	}
	NET_OBJECT_REPLICATION_MODE_END(17);
	return;
}

void Function_100(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x2CED / 11501
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	*(iParam0 + 96) = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_109(bParam4, iParam0 + 344) };
	iParam0->f_324 = bParam4;
	if (bParam4 != 8)
	{
		iParam0->f_328 = Function_105(bParam5, &vParam1, fParam6, iParam0 + 96, bParam7);
	}
	else
	{
		iParam0->f_328 = Function_103(bParam5, &vParam1, (fParam6 + 180.0f), bParam7);
		...
		CREATE_MP_TEXT(iParam0->f_328, "", "Custom_deco", vVar6, Function_102(vVar9.x), Function_102(vVar9.y), Function_102(vVar9.z), iVar12);
	}
	*(iParam0 + 332) = { StackVal, StackVal, vParam1 };
	...
	bVar19 = Function_101(bParam4, &vVar13, &vVar16);
...
var Function_101(bool bParam0, var uParam1, int iParam2) //Position: 0x2E6A / 11882
{
	switch (bParam0)
	{
		case 0x00000004:
...
float Function_102(float fParam0) //Position: 0x2F56 / 12118
{
	return (fParam0 * 0.01745329f);
}

var Function_103(var uParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2F64 / 12132
{
	var uVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	return CREATE_PROP_IN_LAYOUT(StackVal, StackVal, StackVal, Vector("", uParam0, StackVal) + Vector(vVar6, *iParam1, Function_104()), 0.0f, (bParam2 + 180.0f), 0.0f, 1);
}

bool Function_104() //Position: 0x2FD0 / 12240
{
	return "$/fragments/p_gen_dressForm01x";
}

var Function_105(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x2FF7 / 12279
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	bVar0 = Function_103(uParam0, uParam1, uParam2, uParam4);
	iVar1 = 0;
	while (iVar1 <= 27)
	{
		if (Function_108((*uParam3)[iVar12], &iVar2))
		{
			iVar10[iVar2]++;
			if (iVar10[iVar2] == 2)
			{
	...
	while (iVar1 <= 27)
	{
		if (Function_108((*uParam3)[iVar12], &iVar2))
		{
			if (Function_106((*uParam3)[iVar12], &vVar3, &vVar6, (iVar10[iVar2] - 1)))
			{
...
bool Function_106(bool bParam0, var uParam1, var uParam2, int iParam3) //Position: 0x30E5 / 12517
{
...
bool Function_107(int iParam0) //Position: 0x3276 / 12918
{
...
bool Function_108(bool bParam0, int iParam1) //Position: 0x3288 / 12936
{
	switch (UNK_0xDB679ED9(bParam0))
	{
		case 0x00000027:
...
struct<228> Function_109(int iParam0, int iParam1) //Position: 0x32E4 / 13028
{
	struct<57> Var0;
...
void Function_110(int iParam0, int iParam1) //Position: 0x34C9 / 13513
{
	int iVar0;
	int iVar1[17];
	int iVar19;
	...
	while (iVar0 < Global_83864.f_1264)
	{
		if (StackVal != 4294967295)
		{
			...
			if (Function_115(iVar20, 1))
			{
				if (!iVar1[iVar20])
				{
					iVar19 = Function_114(&Global_83591 + 276, iVar20) * 2;
					iVar1[iVar20] = 1;
				}
			}
			*iParam1++;
...
void Function_111(var uParam0, var uParam1) //Position: 0x3606 / 13830
{
	*uParam1 = Function_31(uParam0, Function_112(), 0);
	uParam1->f_4 = Function_31(uParam0, Function_112() + 8, Function_112());
	return;
}

bool Function_112() //Position: 0x3629 / 13865
{
	return Function_113(39);
}

int Function_113(bool bParam0) //Position: 0x3634 / 13876
{
	int iVar0;
...
int Function_114(int iParam0, int iParam1) //Position: 0x3662 / 13922
{
...
bool Function_115(int iParam0, int iParam1) //Position: 0x367C / 13948
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

bool Function_116(int iParam0, var uParam1, int iParam2) //Position: 0x368F / 13967
{
...
void Function_117(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x376F / 14191
{
	if (!Function_119(iParam1))
	{
		return;
	}
	Function_118(iParam0[iParam12], bParam2, iParam3, bParam4);
}

void Function_118(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3792 / 14226
{
	*uParam0 = bParam1;
	if (bParam3)
	{
...
bool Function_119(int iParam0) //Position: 0x37BC / 14268
{
	return (iParam0 <= 0 && iParam0 > 27);
}

void Function_120(int iParam0) //Position: 0x37CC / 14284
{
	int iVar0;
...
void Function_121(var uParam0, int iParam1) //Position: 0x37F9 / 14329
{
	uParam0->f_224 = iParam1;
	return;
}

void Function_122(bool bParam0) //Position: 0x3805 / 14341
{
	Function_118(bParam0, 4294967295, 0, 1);
	return;
}

float Function_123(vector3 vParam0, vector3 vParam3) //Position: 0x3813 / 14355
{
	var uVar0;
...
void Function_124(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x382D / 14381
{
	*uParam6 = { (GET_X(&uParam3) - GET_X(&uParam0)), 0.0f, (GET_Z(&uParam3) - GET_Z(&uParam0)) };
}

void Function_125() //Position: 0x3850 / 14416
{
...
bool Function_126(int iParam0) //Position: 0x3860 / 14432
{
	int iVar0;
	int iVar1;
...
void Function_127() //Position: 0x3BDB / 15323
{
	if (!Function_128(128))
	{
		return;
...
bool Function_128(int iParam0) //Position: 0x3C1B / 15387
{
	int iVar0;
...
bool Function_129() //Position: 0x3C37 / 15415
{
	int iVar0;
...
void Function_130(var uParam0, int iParam1) //Position: 0x3C62 / 15458
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_131() //Position: 0x3C73 / 15475
{
	if (!Function_128(128))
	{
		return;
...
bool Function_132() //Position: 0x3CB5 / 15541
{
	var uVar0;
	bool bVar3;
	int iVar4;
	...
	Function_135(&Local_39 + 1828, Function_104(), 0, 0);
	iVar4 = 0;
	while (iVar4 <= 5)
	{
		bVar3 = Function_101(iVar4, &uVar0, &uVar0);
	...
	Function_126(&Local_39 + 1828);
	while (!Function_126(&Local_39 + 1812) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
...
void Function_133() //Position: 0x3DE6 / 15846
{
...
void Function_134(char* cParam0, int iParam1) //Position: 0x3E01 / 15873
{
	char* cVar0[32];
	char* cVar8[32];
...
var Function_135(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3E98 / 16024
{
	int iVar0;
	int iVar1;
...
var Function_136(var uParam0, int iParam1, int iParam2) //Position: 0x3ED0 / 16080
{
	int iVar0;
...
void Function_137(var uParam0, var uParam1) //Position: 0x3F94 / 16276
{
	Function_15(uParam0, uParam1, 16293);
	return;
}

int Function_138() //Position: 0x3FA5 / 16293
{
	return 1;
}

bool Function_139() //Position: 0x3FAC / 16300
{
	return Function_67(2);
}

void Function_140(int iParam0, int iParam1) //Position: 0x3FB6 / 16310
{
	if (iParam0 <= 5 || iParam0 > 0)
	{
		return;
