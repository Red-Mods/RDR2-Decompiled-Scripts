...
void Function_3() //Position: 0x1F9 / 505
{
	...
	Function_4(0, bLocal_7, bLocal_8, &uLocal_3, bLocal_9, 4294967295);
	return;
}
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3540 / 13632
{
	...
	if (Function_77(&bLocal_7, &uLocal_3, 19, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_75(&bLocal_10, "outlaw02mobile", iParam1))
		{
			bLocal_8 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_10, Function_132()));
			Global_3422[1940].f_156 = bLocal_8;
...
void Function_72() //Position: 0x35DD / 13789
{
	...
	bLocal_9 = CREATE_LAYOUT("outlaw02campfirelayout");
	vVar0 = { -3668.79f, 8.32f, 3496.28f };
	TELEPORT_ACTOR_WITH_HEADING(bLocal_7, vVar0, 157.073f, 1, 1, 1);
	bVar3 = CREATE_GRINGO_IN_LAYOUT(bLocal_9, "outlaw02drinking", "gun01_drunk", -3669.22f, 8.367f, 3497.462f, 0.065f, -0.107f, 0.992f);
...
void Function_73(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x36B8 / 14008
{
	bool bVar0;
	bool bVar1;
...
bool Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3842 / 14402
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_75(var uParam0, char* cParam1, int iParam2) //Position: 0x3882 / 14466
{
...
void Function_76(bool bParam0, bool bParam1) //Position: 0x38AD / 14509
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x38EF / 14575
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
...
var Function_78(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3AB8 / 15032
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_79(bool bParam0, bool bParam1) //Position: 0x3FA2 / 16290
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_80(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3FC2 / 16322
{
	bool bVar0;
...
int Function_81(bool bParam0, bool bParam1) //Position: 0x4017 / 16407
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x4097 / 16535
{
	Function_84(bParam0);
	Function_83(bParam0);
...
void Function_83(bool bParam0) //Position: 0x40BD / 16573
{
...
void Function_84(bool bParam0) //Position: 0x40E1 / 16609
{
...
bool Function_85(bool bParam0) //Position: 0x41B0 / 16816
{
...
int Function_86(int iParam0, bool bParam1) //Position: 0x41C7 / 16839
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(int iParam0, bool bParam1, bool bParam2) //Position: 0x425A / 16986
{
	bool bVar0;
	bool bVar1;
...
void Function_88(bool bParam0) //Position: 0x4351 / 17233
{
	bool bVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x437D / 17277
{
	int iVar0;
...
bool Function_90(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x4399 / 17305
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_91() //Position: 0x4423 / 17443
{
	bool bVar0;
	bool bVar1;
...
bool Function_92(int iParam0) //Position: 0x4488 / 17544
{
...
bool Function_93(bool bParam0) //Position: 0x44A4 / 17572
{
...
var Function_94(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x44BA / 17594
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_95(int iParam0) //Position: 0x455A / 17754
{
	bool bVar0;
	int iVar1;
...
var Function_96(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4654 / 18004
{
	int iVar0;
	int iVar1;
...
void Function_97(var uParam0, int iParam1) //Position: 0x468C / 18060
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_98(var uParam0, int iParam1, int iParam2) //Position: 0x469D / 18077
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x4761 / 18273
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x4ADC / 19164
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x4B1C / 19228
{
	int iVar0;
...
void Function_102() //Position: 0x4B47 / 19271
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4B89 / 19337
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4C0D / 19469
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C36 / 19510
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4C87 / 19591
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4C97 / 19607
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4CAB / 19627
{
	int iVar0;
...
var Function_109() //Position: 0x4CD0 / 19664
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CE7 / 19687
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4E12 / 19986
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_112() //Position: 0x4E23 / 20003
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_113() //Position: 0x4E34 / 20020
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4E45 / 20037
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4E68 / 20072
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4E87 / 20103
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4E93 / 20115
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4E9E / 20126
{
	bool bVar0;
...
var Function_119() //Position: 0x4ECC / 20172
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4EE1 / 20193
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4FE5 / 20453
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4FF9 / 20473
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5063 / 20579
{
	char* cVar0[32];
...
var Function_124() //Position: 0x5082 / 20610
{
	return "PBox_";
}

var Function_125() //Position: 0x5090 / 20624
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x50B6 / 20662
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x50DE / 20702
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5104 / 20740
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5265 / 21093
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5300 / 21248
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x5461 / 21601
{
...
var Function_132() //Position: 0x54C2 / 21698
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54CA / 21706
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x54E3 / 21731
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x57D6 / 22486
{
	int iVar0;
...
void Function_136() //Position: 0x588A / 22666
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x58C4 / 22724
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58F1 / 22769
{
	bool bVar0;
...
void Function_139() //Position: 0x5A42 / 23106
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A8D / 23181
{
	int iVar0;
...
int Function_141() //Position: 0x5B5D / 23389
{
	int iVar0;
...
int Function_142() //Position: 0x5CB9 / 23737
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DD9 / 24025
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5EA9 / 24233
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5EC7 / 24263
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5FF9 / 24569
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x6018 / 24600
{
	int iVar0;
...
int Function_148() //Position: 0x6034 / 24628
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x604D / 24653
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x6059 / 24665
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x6062 / 24674
{
	var uVar0;
