...
void main() //Position: 0x0 / 0
{
	...
	uVar0 = Function_15("critter_pop", 0);
	Function_13(&uVar0, 1059, 1.0f, 0, 0);
	...
	uVar1 = Function_15("coyote_den", 0);
	Function_13(&uVar1, 1050, 4.0f, 0, 0);
	Function_13(&uVar1, 1050, 4.0f, 0, 0);
	Function_13(&uVar1, 1051, 4.0f, 0, 0);
	Function_13(&uVar1, 1052, 4.0f, 0, 0);
	Function_13(&uVar1, 1052, 4.0f, 0, 0);
	uVar2 = Function_15("cougar_pop", 0);
	Function_13(&uVar2, 1113, 4.0f, 0, 0);
	Function_13(&uVar2, 1113, 4.0f, 0, 0);
	Function_13(&uVar2, 1112, 4.0f, 0, 0);
	uVar3 = Function_15("animal_duck", 0);
	Function_13(&uVar3, 1140, 100.0f, 0, 0);
	Function_13(&uVar3, 1140, 100.0f, 0, 0);
	Function_13(&uVar3, 1140, 100.0f, 0, 0);
	uVar4 = Function_15("deer_pop", 0);
	Function_13(&uVar4, 1119, 4.0f, 0, 0);
	Function_13(&uVar4, 1119, 4.0f, 0, 0);
	Function_13(&uVar4, 1120, 4.0f, 0, 0);
	uVar5 = Function_15("wolf_pop", 0);
	Function_13(&uVar5, 1065, 4.0f, 0, 0);
	Function_13(&uVar5, 1066, 4.0f, 0, 0);
	Function_13(&uVar5, 1067, 4.0f, 0, 0);
	uVar6 = Function_15("fox_pop", 0);
	Function_13(&uVar6, 1026, 4.0f, 0, 0);
	Function_13(&uVar6, 1027, 4.0f, 0, 0);
	Function_13(&uVar6, 1028, 4.0f, 0, 0);
	uVar7 = Function_15("rabbit_pop", 0);
	Function_13(&uVar7, 1078, 4.0f, 0, 0);
	Function_13(&uVar7, 1078, 4.0f, 0, 0);
	Function_13(&uVar7, 1078, 4.0f, 0, 0);
	uVar8 = Function_15("armadillo_pop", 0);
	Function_13(&uVar8, 1081, 4.0f, 0, 0);
	Function_13(&uVar8, 1081, 4.0f, 0, 0);
	Function_13(&uVar8, 1081, 4.0f, 0, 0);
	uVar9 = Function_15("nnight_pop", 0);
	Function_10(&uVar9, 1084, 4.0f, 49, 0, 0);
	...
	uVar10 = Function_15("hawk", 0);
	Function_10(&uVar10, 1145, 3.0f, 15, 0, 0);
	uVar11 = Function_15("vulture", 0);
	Function_10(&uVar11, 1131, 6.0f, 14, 0, 0);
	uVar12 = Function_15("nsmallbird", 0);
	Function_10(&uVar12, 1135, 2.0f, 15, 0, 0);
	Function_10(&uVar12, 1136, 2.0f, 15, 0, 0);
	Function_10(&uVar12, 1136, 2.0f, 15, 0, 0);
	Function_10(&uVar12, 1137, 2.0f, 33, 0, 0);
	...
	uVar14 = Function_15("wildHorses", 0);
	Function_13(&uVar14, 982, 24.0f, 0, 0);
	Function_13(&uVar14, 983, 8.0f, 0, 0);
	Function_13(&uVar14, 984, 8.0f, 0, 0);
	Function_13(&uVar14, 985, 8.0f, 0, 0);
	Function_13(&uVar14, 986, 8.0f, 0, 0);
	Function_13(&uVar14, 987, 8.0f, 0, 0);
	Function_13(&uVar14, 996, 8.0f, 0, 0);
	Function_13(&uVar14, 997, 8.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar19))
	{
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_5())
			{
				uVar21 = Function_4(bVar20, uVar14, 1.5E-05f, 0, 1, 1);
			...
			uVar22 = Function_4(bVar20, uVar1, 2.1E-05f, 0, 0, 1);
			...
			uVar23 = Function_4(bVar20, uVar7, 6E-05f, 0, 0, 1);
			...
			uVar24 = Function_4(bVar20, uVar4, 2.1E-05f, 0, 0, 1);
			...
			uVar25 = Function_4(bVar20, uVar0, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar25, 2);
			uVar26 = Function_4(bVar20, uVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar26, 2);
			uVar27 = Function_4(bVar20, uVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_5())
			{
				uVar28 = Function_4(bVar20, uVar14, 1.5E-05f, 0, 1, 1);
			...
			Function_4(bVar20, uVar2, 1.5E-05f, 0, 0, 1);
			uVar29 = Function_4(bVar20, uVar1, 2.1E-05f, 0, 0, 1);
			...
			uVar30 = Function_4(bVar20, uVar6, 3E-05f, 0, 1, 1);
			...
			uVar31 = Function_4(bVar20, uVar5, 2.1E-05f, 0, 0, 1);
			...
			uVar32 = Function_4(bVar20, uVar7, 6E-05f, 0, 0, 1);
			...
			uVar33 = Function_4(bVar20, uVar4, 2.1E-05f, 0, 0, 1);
			...
			uVar34 = Function_4(bVar20, uVar0, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar34, 2);
			uVar35 = Function_4(bVar20, uVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar35, 2);
			uVar36 = Function_4(bVar20, uVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_5())
			{
				uVar37 = Function_4(bVar20, uVar14, 1.5E-05f, 0, 1, 1);
			...
			uVar38 = Function_4(bVar20, uVar1, 2.1E-05f, 0, 0, 1);
			...
			uVar39 = Function_4(bVar20, uVar5, 2.1E-05f, 0, 0, 1);
			...
			uVar40 = Function_4(bVar20, uVar7, 6E-05f, 0, 0, 1);
			...
			uVar41 = Function_4(bVar20, uVar4, 2.1E-05f, 0, 0, 1);
			...
			uVar42 = Function_4(bVar20, uVar2, 2.1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar42, 1);
			uVar43 = Function_4(bVar20, uVar0, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar43, 2);
			uVar44 = Function_4(bVar20, uVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar44, 2);
			uVar45 = Function_4(bVar20, uVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			Function_4(bVar20, uVar10, 8E-05f, 0, 0, 1);
			Function_4(bVar20, uVar11, 8E-05f, 0, 0, 1);
			Function_4(bVar20, uVar12, 8E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			Function_4(bVar20, uVar3, 6E-05f, 0, 0, 1);
			Function_4(bVar20, uVar8, 6E-05f, 0, 0, 1);
			Function_4(bVar20, uVar9, 6E-05f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1AD1 / 6865
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1B51 / 6993
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1CD8 / 7384
{
	int iVar0;
...
var Function_12(int iParam0) //Position: 0x1D44 / 7492
{
	int iVar0;
...
var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1DB0 / 7600
{
	int iVar0;
	int iVar1;
...
var Function_14(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1E2C / 7724
{
	int iVar0;
	int iVar1;
...
var Function_15(bool bParam0, int iParam1) //Position: 0x1E71 / 7793
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_16(int iParam0) //Position: 0x1E7E / 7806
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_17(bool bParam0, var uParam1) //Position: 0x1E8A / 7818
{
	if (!Function_6(128))
	{
		return;
