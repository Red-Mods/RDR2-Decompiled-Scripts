...
void main() //Position: 0x0 / 0
{
	...
	iLocal_74 = 0;
	Function_100(uScriptParam_0, &iLocal_74);
			...
			if (iVar3 >= 4294967295)
			{
				...
				switch (GRINGO_GET_MESSAGE_TYPE())
				{
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", Local_1[iVar312].f_16);
							Function_85(Local_1[iVar312].f_16, 1);
							...
							{
								Function_78(&(Local_1[iVar312]), 0);
							}
							else if (Local_1[iVar312].f_44 < 8)
							{
								Function_77(&(Local_1[iVar312]));
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000001:
			...
			if (Function_76(iParam0->f_40, 1))
			{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, 1, Function_55());
				}
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_79, &cLocal_78);
		...
		case 0x00000006:
			...
			bVar0 = Function_49(iParam0->f_16, iParam0->f_12, Function_76(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_29(var uParam0, int iParam1) //Position: 0x1D41 / 7489
{
	...
	vVar0 = { StackVal, StackVal, Function_30(GRINGO_GET_MY_OBJECT_REF()) };
	bVar3 = FIND_NEAREST_DOOR(&vVar0, 1.0f);
	OPEN_DOOR_DIRECTION(bVar3, true);
	SET_DOOR_CURRENT_SPEED(bVar3, 2.0f, 2.0f);
	return;
}

vector3 Function_30(bool bParam0) //Position: 0x1D6E / 7534
{
	vector3 vVar0;
...
bool Function_31(int iParam0) //Position: 0x1D95 / 7573
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x1DA0 / 7584
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x1DBA / 7610
{
...
bool Function_35(bool bParam0) //Position: 0x1DF7 / 7671
{
	int iVar0;
	int iVar1;
...
bool Function_37(bool bParam0) //Position: 0x1E49 / 7753
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x1E63 / 7779
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E76 / 7798
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	PRINTNL();
	uVar2 = Function_47(uParam0->f_12, &bVar0);
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_41(uParam0->f_12, &bVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_40(), Function_41(uParam0->f_12, &bVar10), 0, bVar9);
	}
...
var Function_40() //Position: 0x215E / 8542
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x2166 / 8550
{
...
bool Function_43(bool bParam0, int iParam1) //Position: 0x2192 / 8594
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x21B4 / 8628
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x21D8 / 8664
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21F5 / 8693
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2215 / 8725
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x2235 / 8757
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22E3 / 8931
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x2353 / 9043
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x2369 / 9065
{
...
var Function_52(bool bParam0) //Position: 0x238A / 9098
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x23AA / 9130
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x23BE / 9150
{
	uParam0 = uParam0;
	return;
}

int Function_55() //Position: 0x23C8 / 9160
{
	return 1;
}

void Function_56(var uParam0, int iParam1) //Position: 0x23CF / 9167
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x23DE / 9182
{
	float fVar0;
...
bool Function_58(bool bParam0) //Position: 0x241D / 9245
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_59(bool bParam0) //Position: 0x2448 / 9288
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_60(bool bParam0) //Position: 0x2453 / 9299
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_61(bool bParam0) //Position: 0x2549 / 9545
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_62(bool bParam0) //Position: 0x256B / 9579
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_63(bool bParam0) //Position: 0x2592 / 9618
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	while (iVar10 >= 4294967295)
	{
		...
		if (GRINGO_IS_PROP_READY(bVar11))
		{
			...
			{
				Function_65(StackVal, StackVal, StackVal, StackVal, vVar3, vVar14);
				vVar3 = { StackVal, StackVal, Function_65(StackVal, StackVal, StackVal, StackVal, vVar3, vVar14) };
				Function_64(StackVal, StackVal, StackVal, StackVal, vVar0, vVar14);
				vVar0 = { StackVal, StackVal, Function_64(StackVal, StackVal, StackVal, StackVal, vVar0, vVar14) };
			}
		}
...
vector3 Function_64(vector3 vParam0) //Position: 0x2851 / 10321
{
	vector3 vVar0;
...
vector3 Function_65(vector3 vParam0) //Position: 0x28AE / 10414
{
	vector3 vVar0;
...
void Function_66(int iParam0) //Position: 0x290B / 10507
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x2915 / 10517
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x2933 / 10547
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2948 / 10568
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x29CF / 10703
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29F2 / 10738
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2A10 / 10768
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x2A33 / 10803
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2B4E / 11086
{
...
int Function_75(bool bParam0) //Position: 0x2B79 / 11129
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2C7E / 11390
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2C8B / 11403
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2CFE / 11518
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x31FC / 12796
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x3233 / 12851
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3250 / 12880
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3288 / 12936
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x3292 / 12946
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32B3 / 12979
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x32C1 / 12993
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x33C9 / 13257
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x33DF / 13279
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_88(var uParam0, int iParam1) //Position: 0x3695 / 13973
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_89(bool bParam0) //Position: 0x36A3 / 13987
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x36BC / 14012
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(int iParam0, int iParam1) //Position: 0x36D6 / 14038
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_92(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_92(var uParam0, int iParam1) //Position: 0x370E / 14094
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x3725 / 14117
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x39EE / 14830
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3A0B / 14859
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3AA7 / 15015
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3AC6 / 15046
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3AD5 / 15061
{
...
void Function_99(int iParam0) //Position: 0x3AF1 / 15089
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3AFB / 15099
{
	int iVar0;
	int iVar1;
	...
	{
		Function_101(&(Local_1[iLocal_7412]), bParam0);
		iLocal_74++;
	}
...
void Function_101(int iParam0, int iParam1) //Position: 0x3B5D / 15197
{
...
void Function_102(int iParam0) //Position: 0x3B71 / 15217
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3B7B / 15227
{
