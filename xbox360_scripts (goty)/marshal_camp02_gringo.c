...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0xA44 / 2628
{
	int iVar0;
	bool bVar1;
	...
	switch (StackVal)
	{
			...
			if ((Global_26154 + 1 > iLocal_21 || bParam2) || Global_3370)
			{
				if (Function_145(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					...
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_132(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_23, 20.0f, fLocal_23);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_73(StackVal, StackVal, StackVal, StackVal, StackVal, Function_132(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
...
bool Function_47(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x2B6D / 11117
{
...
void Function_56(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2E7B / 11899
{
	bool bVar0;
	bool bVar1;
...
void Function_85(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x425F / 16991
{
	bool bVar0;
...
int Function_86(bool bParam0, bool bParam1) //Position: 0x42B3 / 17075
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_91(int iParam0, bool bParam1) //Position: 0x4463 / 17507
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(int iParam0) //Position: 0x47A8 / 18344
{
	bool bVar0;
	int iVar1;
...
bool Function_98(int iParam0) //Position: 0x48A2 / 18594
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x4C1D / 19485
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x4C5D / 19549
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x4C88 / 19592
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x4C99 / 19609
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4CDB / 19675
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4D5F / 19807
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4D88 / 19848
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4DD9 / 19929
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4DE9 / 19945
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4DFD / 19965
{
	int iVar0;
...
var Function_109() //Position: 0x4E22 / 20002
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4E39 / 20025
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4F64 / 20324
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_112() //Position: 0x4F75 / 20341
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_113() //Position: 0x4F86 / 20358
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4F97 / 20375
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4FBA / 20410
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4FD9 / 20441
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4FE5 / 20453
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4FF0 / 20464
{
	bool bVar0;
...
var Function_119() //Position: 0x501E / 20510
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5033 / 20531
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x5137 / 20791
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x514B / 20811
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x51B5 / 20917
{
	char* cVar0[32];
...
var Function_124() //Position: 0x51D4 / 20948
{
	return "PBox_";
}

var Function_125() //Position: 0x51E2 / 20962
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x5208 / 21000
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x5230 / 21040
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5256 / 21078
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x53B7 / 21431
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5452 / 21586
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x55B3 / 21939
{
...
var Function_132() //Position: 0x5614 / 22036
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x561C / 22044
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x5635 / 22069
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5928 / 22824
{
	int iVar0;
...
void Function_136() //Position: 0x59DC / 23004
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5A16 / 23062
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5A43 / 23107
{
	bool bVar0;
...
void Function_139() //Position: 0x5B94 / 23444
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5BDF / 23519
{
	int iVar0;
...
int Function_141() //Position: 0x5CAF / 23727
{
	int iVar0;
...
int Function_142() //Position: 0x5E0B / 24075
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5F2B / 24363
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5FFB / 24571
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6019 / 24601
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x614B / 24907
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x616A / 24938
{
	int iVar0;
...
int Function_148() //Position: 0x6186 / 24966
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x619F / 24991
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x61AB / 25003
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x61B4 / 25012
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x6231 / 25137
{
	int iVar0;
