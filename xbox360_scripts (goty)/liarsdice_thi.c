...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			iLocal_137 = Function_38(Local_139);
			if (Function_37())
			{
				if (iLocal_137 == 0)
				{
			...
			else if (iLocal_137 == 0)
			{
				iLocal_137 = 20;
			}
			if (Function_35() <= iLocal_137)
			{
...
{
	bLocal_138 = CREATE_LAYOUT(Function_49());
	Function_47(0, 1);
	Function_46();
	Function_41(&uLocal_146);
	Function_41(&iLocal_152);
	Function_41(&iLocal_149);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
