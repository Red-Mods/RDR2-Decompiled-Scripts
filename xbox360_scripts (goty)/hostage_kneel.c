...
void main() //Position: 0x0 / 0
{
	...
	iLocal_55 = 0;
	Function_106(uScriptParam_0, &iLocal_55);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_99(&(Local_6[iVar312]), &bVar4))
						{
							Function_97(GRINGO_GET_REQUESTING_ACTOR(), Local_6[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_86("eGRINGO_EndUse: Stop use by request", Local_6[iVar312].f_16);
							Function_85(Local_6[iVar312].f_16, 1);
							...
							{
								Function_78(&(Local_6[iVar312]), 0);
							}
							else if (Local_6[iVar312].f_44 < 8)
							{
								Function_77(&(Local_6[iVar312]));
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_62))
								{
									...
									{
										bLocal_62 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_62 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_60, &cLocal_59);
...
void Function_62(bool bParam0) //Position: 0x2552 / 9554
{
	struct<25> Var0;
	...
	if (bLocal_0)
	{
		...
		{
			iLocal_1 = 1;
			cLocal_2 = CREATE_LAYOUT("Hostage_Kneel_Layout");
			GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &Var0 + 12);
			Var0.f_4 = GET_OBJECT_HEADING(GRINGO_GET_MY_OBJECT_REF());
			Var0.f_24 = 0;
			Function_63(cLocal_2, 0, &Var0, 1, 0, 0);
		}
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25AC / 9644
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "HostageKneel_CutFree", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x262E / 9774
{
	bool bVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 10.0f, 0);
	return;
}

void Function_65(var uParam0, bool bParam1) //Position: 0x2659 / 9817
{
	vector3 vVar0;
	...
	vVar0 = { 1.085264f, 0.389518f, -1.189705f };
	...
	vVar0 = { 0.717189f, -0.277447f, -0.639267f };
	UNK_0xF76F2BB3(&vVar0, bParam1, bParam1->f_24, 4);
...
void Function_66(int iParam0) //Position: 0x2705 / 9989
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x270F / 9999
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x272D / 10029
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2742 / 10050
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x27C9 / 10185
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27EC / 10220
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x280A / 10250
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x282D / 10285
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2948 / 10568
{
...
int Function_75(bool bParam0) //Position: 0x2973 / 10611
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x2A85 / 10885
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AF8 / 11000
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x2FF6 / 12278
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x302D / 12333
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x304A / 12362
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3082 / 12418
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x308C / 12428
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, bool bParam1) //Position: 0x30AD / 12461
{
	bParam1 = bParam1;
	uParam0 = uParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Cut_Free", bParam1) || GRINGO_COMPONENT_CHECK_NAME("nCut_Free1", bParam1))
	{
		FREE_FROM_HOGTIE(GET_TARGET_ACTOR());
		iLocal_1 = 0;
		...
		if (bLocal_4)
		{
			ACTOR_SET_NEXT_WEAPON(Global_34573, bLocal_3);
		}
	}
	return;
}

void Function_85(bool bParam0, bool bParam1) //Position: 0x3108 / 12552
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3210 / 12816
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x3226 / 12838
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x34DC / 13532
{
	iParam1 = iParam1;
	bLocal_0 = false;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		...
		if (Function_89(41))
		{
			...
			{
				if (GET_WEAPON_IN_HAND(Global_34573) != 22)
				{
					bLocal_3 = GET_WEAPON_IN_HAND(Global_34573);
					bLocal_4 = true;
...
bool Function_89(int iParam0) //Position: 0x3524 / 13604
{
	int iVar0;
	...
	if (!Function_90(Function_93(iParam0)))
	{
		return 0;
	}
	if (StackVal == 2)
...
bool Function_90(int iParam0) //Position: 0x355A / 13658
{
...
bool Function_91(int iParam0) //Position: 0x357E / 13694
{
...
bool Function_92(int iParam0) //Position: 0x3593 / 13715
{
...
var Function_93(int iParam0) //Position: 0x35AA / 13738
{
	if (!Function_94(iParam0))
	{
		return 4294967295;
...
bool Function_94(int iParam0) //Position: 0x35C4 / 13764
{
...
bool Function_95(bool bParam0) //Position: 0x35DA / 13786
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_96(bool bParam0) //Position: 0x35F3 / 13811
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_97(bool bParam0, int iParam1) //Position: 0x360D / 13837
{
	bool bVar0;
	char* cVar1;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x3645 / 13893
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_99(int iParam0, int iParam1) //Position: 0x365C / 13916
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_100(bool bParam0) //Position: 0x3925 / 14629
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_101(bool bParam0, bool bParam1) //Position: 0x3942 / 14658
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_102(int iParam0) //Position: 0x39DE / 14814
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_103(var uParam0, int iParam1) //Position: 0x39FD / 14845
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_104(int iParam0) //Position: 0x3A0C / 14860
{
...
void Function_105(int iParam0) //Position: 0x3A28 / 14888
{
	iParam0 = iParam0;
	return;
}

void Function_106(bool bParam0, int iParam1) //Position: 0x3A32 / 14898
{
	int iVar0;
	int iVar1;
	...
	{
		Function_107(&(Local_6[iLocal_5512]), bParam0);
		iLocal_55++;
	}
...
void Function_107(int iParam0, int iParam1) //Position: 0x3A94 / 14996
{
...
void Function_108(int iParam0) //Position: 0x3AA8 / 15016
{
	iParam0 = iParam0;
	return;
}

void Function_109(int iParam0) //Position: 0x3AB2 / 15026
{
