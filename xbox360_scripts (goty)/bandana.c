...
int Function_49(bool bParam0) //Position: 0x2978 / 10616
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			...
			{
				Function_59(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_58(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_54(bParam0, uVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
...
void Function_50(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A21 / 10785
{
	...
	*iParam2 = *iParam2;
	...
	if (DECOR_CHECK_EXIST(bParam1, "ITEM_ATTACHING"))
	{
		DECOR_REMOVE(bParam1, "ITEM_ATTACHING");
	}
	return;
}

bool Function_51(bool bParam0, bool bParam1, int iParam2) //Position: 0x2A7A / 10874
{
	bool bVar0;
	
	bVar0 = Function_58(bParam0);
	if (!((Global_3378 || HUD_IS_FADING()) || HUD_IS_FADED()))
	{
		if ((IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2) && iLocal_3)
		{
			if (DECOR_CHECK_EXIST(bParam1, "ITEM_DESTROY"))
			{
				Function_53(0, 0);
				DECOR_REMOVE(bParam1, "ITEM_DESTROY");
			}
			if (DECOR_CHECK_EXIST(bParam1, "ITEM_CREATE"))
			{
				Function_53(0, 1);
				DECOR_REMOVE(bParam1, "ITEM_CREATE");
			}
...
bool Function_52(int iParam0) //Position: 0x2B31 / 11057
{
	return (*&Global_12976 + 104)[iParam0];
}

void Function_53(int iParam0, bool bParam1) //Position: 0x2B40 / 11072
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_54(bool bParam0, var uParam1, int iParam2) //Position: 0x2CB3 / 11443
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(uParam1, bVar1, Function_56(bVar1, "AttachBone", &iVar2), Function_56(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_55(bVar1, uParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_55(bool bParam0, int iParam1) //Position: 0x2D3D / 11581
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_56(bool bParam0, bool bParam1, int iParam2) //Position: 0x2DEB / 11755
{
	int iVar0;
	bool bVar1;
...
var Function_57(bool bParam0) //Position: 0x2E30 / 11824
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_58(bool bParam0) //Position: 0x2E46 / 11846
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_59(var uParam0, bool bParam1, int iParam2) //Position: 0x2E5C / 11868
{
	...
	*iParam2 = 0;
	...
	else
	{
		...
		if (!Function_52(0))
		{
			DECOR_SET_BOOL(bParam1, "ITEM_ATTACHING", 1);
		}
		iLocal_3 = 1;
		*iParam2 = 1;
	}
...
int Function_60(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2F07 / 12039
{
...
bool Function_61() //Position: 0x2FBD / 12221
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_62(int iParam0) //Position: 0x2FD4 / 12244
{
	return IS_ACTOR_IN_HOGTIE(iParam0);
}

bool Function_63(bool bParam0) //Position: 0x2FDF / 12255
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_64(bool bParam0) //Position: 0x2FED / 12269
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_65(int iParam0, bool bParam1) //Position: 0x3007 / 12295
{
	bool bVar0;
	bool bVar1;
