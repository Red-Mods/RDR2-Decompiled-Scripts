...
void main() //Position: 0x0 / 0
{
	...
	Function_12(&uVar0, 1058, 1.0f, 0, 0);
	uVar1 = Function_14("nnight_pop", 0);
	Function_9(&uVar1, 1084, 4.0f, 33, 0, 0);
	Function_9(&uVar1, 1082, 4.0f, 33, 0, 0);
	...
	Function_12(&(Global_30750[8]), 1126, 4.0f, 0, 0);
	uVar2 = Function_14("wolfs", 0);
	Function_12(&uVar2, 1069, 8.0f, 0, 0);
	Function_12(&uVar2, 1070, 8.0f, 0, 0);
	Function_12(&uVar2, 1071, 8.0f, 0, 0);
	uVar3 = Function_14("cougars", 0);
	Function_12(&uVar3, 1091, 8.0f, 0, 0);
	Function_12(&uVar3, 1092, 8.0f, 0, 0);
	Function_12(&uVar3, 1093, 8.0f, 0, 0);
	...
	Function_12(&uVar4, 1050, 4.0f, 0, 0);
	uVar5 = Function_14("deer", 0);
	Function_12(&uVar5, 1119, 4.0f, 0, 0);
	Function_12(&uVar5, 1119, 4.0f, 0, 0);
	Function_12(&uVar5, 1120, 4.0f, 0, 0);
	Function_12(&uVar5, 1116, 1.0f, 0, 0);
	Function_12(&uVar5, 1116, 1.0f, 0, 0);
	Function_12(&uVar5, 1117, 1.0f, 0, 0);
	...
	Function_12(&uVar7, 1138, 4.0f, 0, 0);
	uVar8 = Function_14("animal_duck", 0);
	Function_12(&uVar8, 1140, 100.0f, 0, 0);
	uVar9 = Function_14("animal_gull", 0);
	Function_12(&uVar9, 1154, 100.0f, 0, 0);
	uVar10 = Function_14("animal_beaver", 0);
	Function_12(&uVar10, 1107, 100.0f, 0, 0);
	Function_12(&uVar10, 1108, 100.0f, 0, 0);
	uVar11 = Function_14("rabbit_pop", 0);
	Function_12(&uVar11, 1078, 4.0f, 0, 0);
	Function_12(&uVar11, 1078, 4.0f, 0, 0);
	Function_12(&uVar11, 1079, 4.0f, 0, 0);
	uVar12 = Function_14("bear", 0);
	Function_12(&uVar12, 1096, 4.0f, 0, 0);
	Function_12(&uVar12, 1097, 4.0f, 0, 0);
	uVar13 = Function_14("wildBoar_pop", 0);
	Function_12(&uVar13, 1074, 4.0f, 0, 0);
	Function_12(&uVar13, 1075, 4.0f, 0, 0);
	Function_12(&uVar13, 1075, 4.0f, 0, 0);
	Function_12(&uVar13, 1076, 4.0f, 0, 0);
	uVar14 = Function_14("nwildhorse", 0);
	Function_12(&uVar14, 976, 4.0f, 0, 0);
	Function_12(&uVar14, 977, 4.0f, 0, 0);
	Function_12(&uVar14, 980, 4.0f, 0, 0);
	Function_12(&uVar14, 983, 4.0f, 0, 0);
	Function_12(&uVar14, 985, 4.0f, 0, 0);
	Function_12(&uVar14, 989, 4.0f, 0, 0);
	Function_12(&uVar14, 979, 10.0f, 0, 0);
	...
	Function_9(&uVar15, 1138, 3.0f, 33, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar22))
	{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			if (!Function_4())
			{
				uVar24 = Function_3(bVar23, uVar14, 1.5E-05f, 0, 1, 1);
			...
			uVar25 = Function_3(bVar23, uVar5, 2.1E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(bVar23, uVar11, 2.1E-05f, 0, 0, 1);
			...
			uVar27 = Function_3(bVar23, uVar0, 4.5E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar27, 2);
			uVar28 = Function_3(bVar23, uVar1, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			uVar29 = Function_3(bVar23, uVar6, 6E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(bVar23, uVar2, 2.1E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(bVar23, uVar3, 2.1E-05f, 0, 0, 1);
			...
			uVar32 = Function_3(bVar23, uVar11, 6E-05f, 0, 0, 1);
			...
			uVar33 = Function_3(bVar23, uVar5, 2.1E-05f, 0, 0, 1);
			...
			if (!Function_4())
			{
				uVar34 = Function_3(bVar23, uVar14, 1.5E-05f, 0, 1, 1);
			...
			uVar35 = Function_3(bVar23, uVar0, 3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar35, 2);
			uVar36 = Function_3(bVar23, uVar1, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			if (!Function_4())
			{
				uVar37 = Function_3(bVar23, uVar14, 1.5E-05f, 0, 1, 1);
			...
			uVar38 = Function_3(bVar23, uVar6, 6E-05f, 0, 0, 1);
			...
			uVar39 = Function_3(bVar23, uVar13, 2.1E-05f, 0, 0, 1);
			...
			uVar40 = Function_3(bVar23, uVar2, 2.1E-05f, 0, 0, 1);
			...
			uVar41 = Function_3(bVar23, uVar3, 2.1E-05f, 0, 0, 1);
			...
			uVar42 = Function_3(bVar23, uVar5, 2.1E-05f, 0, 0, 1);
			...
			uVar43 = Function_3(bVar23, uVar11, 6E-05f, 0, 0, 1);
			...
			uVar44 = Function_3(bVar23, uVar0, 4.5E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar44, 2);
			uVar45 = Function_3(bVar23, uVar1, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			uVar46 = Function_3(bVar23, uVar10, 6E-05f, 0, 0, 1);
			...
			uVar47 = Function_3(bVar23, uVar8, 6E-05f, 0, 0, 1);
			...
			Function_3(bVar23, uVar0, 4.5E-05f, 0, 0, 1);
			Function_3(bVar23, uVar1, 4.5E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar23))
		{
			uVar48 = Function_3(bVar23, uVar9, 9E-05f, 0, 0, 1);
			...
			uVar49 = Function_3(bVar23, uVar8, 6E-05f, 0, 0, 1);
	...
	if (IS_VOLUME_VALID(bVar23))
	{
		Function_3(bVar23, uVar15, 6E-05f, 0, 0, 1);
		Function_3(bVar23, uVar16, 6E-05f, 0, 0, 1);
		Function_3(bVar23, uVar17, 9E-05f, 0, 0, 1);
	}
	else
	{
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1B43 / 6979
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1CCA / 7370
{
	int iVar0;
...
var Function_11(int iParam0) //Position: 0x1D36 / 7478
{
	int iVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1DA2 / 7586
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1E1E / 7710
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x1E63 / 7779
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0x1E70 / 7792
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0x1E7C / 7804
{
	if (!Function_5(128))
	{
		return;
