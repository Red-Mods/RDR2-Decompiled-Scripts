						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_96))
								{
									...
									{
										bLocal_96 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_96 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	if (!iLocal_13)
	{
		if (IS_ACTOR_PLAYER(bParam0))
		{
			...
			if (VDIST(vVar3, vVar6) >= 1.5f)
			{
				...
				{
					bLocal_3 = ADD_SCRIPT_USE_CONTEXT(GET_GRINGO_STRING_ATTR("MidUse", bParam1, &uVar0), 50, 4, 0, 0, 0, 0, 4294967295, 0);
				}
			...
			{
				bLocal_4 = ADD_SCRIPT_USE_CONTEXT("nDrop_Item", 9, 5, 0, 0, 0, 0, 4294967295, 0);
			}
...
void Function_94(bool bParam0, bool bParam1) //Position: 0x3C49 / 15433
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_95(bool bParam0, bool bParam1) //Position: 0x3D55 / 15701
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_96(bool bParam0, bool bParam1) //Position: 0x3E5D / 15965
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_97(int iParam0) //Position: 0x3E73 / 15987
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_98(var uParam0, int iParam1) //Position: 0x412B / 16683
{
	uParam0 = uParam0;
...
void Function_99(var uParam0, bool bParam1) //Position: 0x413B / 16699
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_100(bool bParam0) //Position: 0x41E7 / 16871
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_101(bool bParam0) //Position: 0x4200 / 16896
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_102(int iParam0, int iParam1) //Position: 0x421A / 16922
{
	bool bVar0;
	char* cVar1;
...
bool Function_103(var uParam0, int iParam1) //Position: 0x4252 / 16978
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_104(int iParam0, int iParam1) //Position: 0x4269 / 17001
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_105(bool bParam0) //Position: 0x4532 / 17714
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_106(bool bParam0, bool bParam1) //Position: 0x454F / 17743
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_107(int iParam0) //Position: 0x45EB / 17899
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_108(var uParam0, int iParam1) //Position: 0x460A / 17930
{
	return Function_31(iParam1, uParam0, &iLocal_15);
}

bool Function_109(int iParam0) //Position: 0x4619 / 17945
{
...
void Function_110(int iParam0) //Position: 0x4635 / 17973
{
	iParam0 = iParam0;
	return;
}

void Function_111(bool bParam0, int iParam1) //Position: 0x463F / 17983
{
	int iVar0;
	int iVar1;
...
void Function_112(int iParam0, int iParam1) //Position: 0x46A1 / 18081
{
...
void Function_113(int iParam0) //Position: 0x46B5 / 18101
{
	iParam0 = iParam0;
	return;
}

void Function_114(int iParam0) //Position: 0x46BF / 18111
{
