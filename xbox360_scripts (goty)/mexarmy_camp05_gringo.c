...
{
	RELEASE_LAYOUT_REF(bLocal_10);
	Function_4(6, bLocal_7, bLocal_8, &uLocal_3, bLocal_9, 4294967295);
	return;
}
...
var Function_28(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x12DC / 4828
{
	...
	switch (StackVal)
	{
		case 0x00000000:
			...
			if ((Global_26154 + 1 > iLocal_11 || bParam2) || Global_3370)
			{
				if (Function_145(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					if (((!bParam2 && !Function_143(iParam0 + 200, &fLocal_13, 256, 0)) && !Global_3370) && !Function_150())
					{
						iVar14 = 1000;
					}
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_132(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_13, 20.0f, fLocal_13);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_68(StackVal, StackVal, StackVal, StackVal, StackVal, Function_132(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
		...
		case 0x0000000B:
			...
			if ((iParam0->f_268 != 1 && !IS_ACTION_NODE_PLAYING_PARTIAL(Global_34573, "rand_idle_sit_ground_player")) && !iParam0->f_276)
			{
				if (SQUAD_IS_VALID(iParam0->f_244) && SQUAD_GET_SIZE(iParam0->f_244) < 0)
				{
					...
					{
						if ((GET_CURRENT_GAME_TIME() - fLocal_15) < 10.0f)
						{
			...
			if (!bParam2 && !bVar13)
			{
				if (SQUAD_IS_VALID(iParam0->f_244))
				{
					...
					{
						if (Function_13(SQUAD_GET_ACTOR_BY_INDEX(iParam0->f_244, bVar1), &iLocal_14, iParam0 + 312, 0, 0, 0x40400000))
						{
...
bool Function_71(int iParam0, int iParam1) //Position: 0x3540 / 13632
{
	...
	if (Function_77(&bLocal_7, &uLocal_3, 36, 1, 1, 1, 0, 0, 0, 0, 0))
	{
		if (Function_75(&bLocal_10, "mexarmy05mobile", iParam1))
		{
			bLocal_8 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_10, Function_132()));
			Global_3422[3640].f_156 = bLocal_8;
			iParam0->f_12 = bLocal_10;
			Function_72();
			return 1;
		}
	}
...
void Function_72() //Position: 0x35E8 / 13800
{
	vector3 vVar0;
	bool bVar3;
	
	bLocal_9 = CREATE_LAYOUT("mexarmy05campfirelayout");
	vVar0 = { -4362.943f, 39.488f, 4350.005f };
	TELEPORT_ACTOR_WITH_HEADING(bLocal_7, vVar0, 157.073f, 1, 1, 1);
	bVar3 = CREATE_GRINGO_IN_LAYOUT(bLocal_9, "mexarmy05smoking", "smoking_stand_nospawn", -4362.63f, 39.624f, 4349.441f, 0.0f, 140.0f, 0.0f);
	SNAP_OBJECT_TO_GROUND(bVar3, 2.0f, false, 1092616192);
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bVar3), 0);
	SNAP_ACTOR_TO_GRINGO(bLocal_7, bVar3, "UseCase1", 1, 0, 0);
	TASK_USE_GRINGO(bLocal_7, GET_GRINGO_FROM_OBJECT(bVar3), "UseCase1", 4294967295, 1);
	Function_73(bLocal_7, &bLocal_8, 1, 1);
	return;
}

void Function_73(bool bParam0, var uParam1, bool bParam2, bool bParam3) //Position: 0x36C6 / 14022
{
	bool bVar0;
	bool bVar1;
...
bool Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3850 / 14416
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		if (bParam2)
...
bool Function_75(var uParam0, char* cParam1, int iParam2) //Position: 0x3890 / 14480
{
...
void Function_76(bool bParam0, bool bParam1) //Position: 0x38BB / 14523
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, var uParam9, var uParam10) //Position: 0x38FD / 14589
{
	var uVar0;
	int iVar1;
	struct<9> Var2;
	...
	if (!Function_95(&(Global_3422[iParam240])) && uParam4)
	{
		return 0;
	}
	if (bParam7)
	{
		uVar0 = Function_94(StackVal, StackVal, *(&Global_3422[iParam240] + 52), 0, 1, 1);
	...
	if (StackVal || !Function_90(StackVal, (!WOULD_ACTOR_BE_VISIBLE(StackVal, &Global_3422[iParam240] + 52, 3212836864) || !bParam5), Global_34573, *(&Global_3422[iParam240] + 52), 50.0f))
	{
		iVar1 = Function_94(StackVal, StackVal, *(&Global_3422[iParam240] + 52), 0, 1, 1);
		if (Function_92(iVar1))
		{
			if (Function_99(iParam1))
			{
				if (!IS_ACTOR_VALID(*uParam0))
				{
					...
					*uParam0 = Function_78(Global_3422[iParam240].f_36, 0, 1, vVar2.x, vVar2.y, vVar2.z, uParam8, uParam9, uParam10);
				}
			}
		}
	}
...
var Function_78(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, var uParam7, bool bParam8) //Position: 0x3AC6 / 15046
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		if (!Function_89(&(Global_29008[Global_30621[3]]), 4))
		{
			return "";
		}
		if (!IS_PERS_CHAR_VALID(Global_8492[iParam014]))
	...
	else
	{
		...
		if (bParam8)
		{
			bVar1 = Function_81(StackVal, uParam7);
		}
		if (!IS_ACTOR_VALID(bVar1))
		{
			vVar3.x = uParam3;
...
void Function_79(bool bParam0, bool bParam1) //Position: 0x3FB0 / 16304
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_80(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3FD0 / 16336
{
	bool bVar0;
...
int Function_81(bool bParam0, bool bParam1) //Position: 0x4025 / 16421
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x40A5 / 16549
{
	Function_84(bParam0);
	Function_83(bParam0);
...
void Function_83(bool bParam0) //Position: 0x40CB / 16587
{
...
void Function_84(bool bParam0) //Position: 0x40EF / 16623
{
...
bool Function_85(bool bParam0) //Position: 0x41BE / 16830
{
...
int Function_86(int iParam0, bool bParam1) //Position: 0x41D5 / 16853
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(int iParam0, bool bParam1, bool bParam2) //Position: 0x4268 / 17000
{
	bool bVar0;
	bool bVar1;
...
void Function_88(bool bParam0) //Position: 0x435F / 17247
{
	bool bVar0;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x438B / 17291
{
	int iVar0;
...
bool Function_90(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x43A7 / 17319
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_23(bParam0);
...
void Function_91() //Position: 0x4431 / 17457
{
	bool bVar0;
	bool bVar1;
...
bool Function_92(int iParam0) //Position: 0x4496 / 17558
{
...
bool Function_93(bool bParam0) //Position: 0x44B2 / 17586
{
...
var Function_94(vector3 vParam0, int iParam3, int iParam4, bool bParam5) //Position: 0x44C8 / 17608
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_95(int iParam0) //Position: 0x4568 / 17768
{
	bool bVar0;
	int iVar1;
...
var Function_96(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4662 / 18018
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_98(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
void Function_97(var uParam0, int iParam1) //Position: 0x469A / 18074
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_98(var uParam0, int iParam1, int iParam2) //Position: 0x46AB / 18091
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x476F / 18287
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x4AEA / 19178
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x4B2A / 19242
{
	int iVar0;
...
void Function_102() //Position: 0x4B55 / 19285
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4B97 / 19351
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4C1B / 19483
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C44 / 19524
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4C95 / 19605
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4CA5 / 19621
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4CB9 / 19641
{
	int iVar0;
...
var Function_109() //Position: 0x4CDE / 19678
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CF5 / 19701
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4E20 / 20000
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_112() //Position: 0x4E31 / 20017
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_113() //Position: 0x4E42 / 20034
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4E53 / 20051
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4E76 / 20086
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4E95 / 20117
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4EA1 / 20129
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4EAC / 20140
{
	bool bVar0;
...
var Function_119() //Position: 0x4EDA / 20186
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4EEF / 20207
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4FF3 / 20467
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x5007 / 20487
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5071 / 20593
{
	char* cVar0[32];
...
var Function_124() //Position: 0x5090 / 20624
{
	return "PBox_";
}

var Function_125() //Position: 0x509E / 20638
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x50C4 / 20676
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x50EC / 20716
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5112 / 20754
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5273 / 21107
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x530E / 21262
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x546F / 21615
{
...
var Function_132() //Position: 0x54D0 / 21712
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54D8 / 21720
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x54F1 / 21745
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x57E4 / 22500
{
	int iVar0;
...
void Function_136() //Position: 0x5898 / 22680
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x58D2 / 22738
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58FF / 22783
{
	bool bVar0;
...
void Function_139() //Position: 0x5A50 / 23120
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A9B / 23195
{
	int iVar0;
...
int Function_141() //Position: 0x5B6B / 23403
{
	int iVar0;
...
int Function_142() //Position: 0x5CC7 / 23751
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DE7 / 24039
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5EB7 / 24247
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5ED5 / 24277
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x6007 / 24583
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x6026 / 24614
{
	int iVar0;
...
int Function_148() //Position: 0x6042 / 24642
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x605B / 24667
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x6067 / 24679
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x6070 / 24688
{
	var uVar0;
	...
	if (IS_STRING_VALID(bParam1))
	{
		if (STRING_LENGTH(bParam1) >= 0)
		{
			...
			Function_98(iParam0 + 60, iParam0->f_16, 0);
		}
	}
	if (IS_STRING_VALID(bParam2))
	{
		if (STRING_LENGTH(bParam2) >= 0)
		{
			...
			Function_98(iParam0 + 60, iParam0->f_20, 7);
		}
	}
	return;
}
