	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_53(iParam0, bVar8, &iLocal_86, &cLocal_85);
...
void Function_32(bool bParam0, int iParam1) //Position: 0x23B6 / 9142
{
...
void Function_33(var uParam0, var uParam1) //Position: 0x23CB / 9163
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34() //Position: 0x23D9 / 9177
{
	bool bVar0;
...
void Function_35(var uParam0, bool bParam1) //Position: 0x240A / 9226
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_36(var uParam0, bool bParam1) //Position: 0x247E / 9342
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_37(var uParam0, int iParam1) //Position: 0x24F0 / 9456
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_38(bool bParam0) //Position: 0x24FE / 9470
{
	return Function_26(bParam0, "UseTime", 5.0f);
}

bool Function_39() //Position: 0x2514 / 9492
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_40(bool bParam0) //Position: 0x2521 / 9505
{
	return Function_26(bParam0, "MoveAllowance", 1.5f);
}

bool Function_41(var uParam0, int iParam1) //Position: 0x2541 / 9537
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_42(bool bParam0) //Position: 0x2550 / 9552
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_43() //Position: 0x256F / 9583
{
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x2575 / 9589
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_45(int iParam0) //Position: 0x2583 / 9603
{
	iParam0 = iParam0;
	return 1;
}

bool Function_46(bool bParam0) //Position: 0x258E / 9614
{
	return Function_22(bParam0, "OneShotKill", 0);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x25A8 / 9640
{
	return Function_24(bParam0, "ParentAnimNode", iParam1);
}

bool Function_48(bool bParam0) //Position: 0x25C6 / 9670
{
	return Function_22(bParam0, "LinkToParentAnim", 0);
}

bool Function_49(bool bParam0) //Position: 0x25E5 / 9701
{
	int iVar0;
	int iVar1;
...
bool Function_50(bool bParam0) //Position: 0x2618 / 9752
{
	return Function_22(bParam0, "LinkParentToAnim", 0);
}

bool Function_51(bool bParam0) //Position: 0x2637 / 9783
{
	return Function_22(bParam0, "SingularUse", 0);
}

void Function_52(var uParam0, int iParam1) //Position: 0x2651 / 9809
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_53(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2664 / 9828
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_61(uParam0->f_12, &bVar0);
...
var Function_54() //Position: 0x294C / 10572
{
	int iVar0;
...
bool Function_55(bool bParam0, bool bParam1) //Position: 0x2954 / 10580
{
	return Function_24(bParam0, "TargetLocator", bParam1);
}

void Function_56() //Position: 0x2971 / 10609
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_57(bool bParam0, int iParam1) //Position: 0x2980 / 10624
{
	return Function_24(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_58(bool bParam0, int iParam1) //Position: 0x29A2 / 10658
{
	return Function_24(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_59(bool bParam0) //Position: 0x29C6 / 10694
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_60(bool bParam0, int iParam1) //Position: 0x29E3 / 10723
{
	return Function_24(bParam0, "TargetAttachBone", iParam1);
}

bool Function_61(bool bParam0, int iParam1) //Position: 0x2A03 / 10755
{
	return Function_24(bParam0, "TargetAttachSlot", iParam1);
}

void Function_62(bool bParam0, bool bParam1) //Position: 0x2A23 / 10787
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_63(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2AD1 / 10961
{
	bool bVar0;
...
void Function_64(int iParam0, float fParam1) //Position: 0x2B41 / 11073
{
	if (!Function_29(iParam0))
	{
...
void Function_65(int iParam0, float fParam1) //Position: 0x2B57 / 11095
{
...
var Function_66(bool bParam0) //Position: 0x2B78 / 11128
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_26(bParam0, "RandUseTime", 0.0f));
}

void Function_67(int iParam0) //Position: 0x2B98 / 11160
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_68(var uParam0) //Position: 0x2BAC / 11180
{
	uParam0 = uParam0;
	return;
}

int Function_69() //Position: 0x2BB6 / 11190
{
	return 1;
}

void Function_70(var uParam0, int iParam1) //Position: 0x2BBD / 11197
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_71(bool bParam0, var uParam1, int iParam2) //Position: 0x2BCC / 11212
{
	bool bVar0;
...
bool Function_72(bool bParam0) //Position: 0x2C0B / 11275
{
	return Function_26(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_73(bool bParam0) //Position: 0x2C36 / 11318
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_74(bool bParam0) //Position: 0x2C41 / 11329
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_75(bool bParam0) //Position: 0x2D37 / 11575
{
	return Function_22(bParam0, "UsePosActorRelative", 0);
}

bool Function_76(bool bParam0) //Position: 0x2D59 / 11609
{
	return Function_26(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_77(bool bParam0) //Position: 0x2D80 / 11648
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_78(vector3 vParam0) //Position: 0x303F / 12351
{
	vector3 vVar0;
...
vector3 Function_79(vector3 vParam0) //Position: 0x309C / 12444
{
	vector3 vVar0;
...
void Function_80(int iParam0) //Position: 0x30F9 / 12537
{
	iParam0 = iParam0;
	return;
}

bool Function_81(bool bParam0) //Position: 0x3103 / 12547
{
	return Function_22(bParam0, "MaintainPosture", 0);
}

void Function_82(int iParam0) //Position: 0x3121 / 12577
{
	if (!Function_29(iParam0))
	{
...
bool Function_83(bool bParam0, bool bParam1) //Position: 0x3136 / 12598
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_84(int iParam0) //Position: 0x31BD / 12733
{
	vector3 vVar0;
...
vector3 Function_85(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x31E0 / 12768
{
	vector3 vVar0;
...
bool Function_86(bool bParam0) //Position: 0x31FE / 12798
{
	return Function_26(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_87(bool bParam0, bool bParam1) //Position: 0x3221 / 12833
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_88(bool bParam0, int iParam1) //Position: 0x333C / 13116
{
...
int Function_89(bool bParam0) //Position: 0x3367 / 13159
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_90(var uParam0, int iParam1) //Position: 0x346C / 13420
{
	return (uParam0 && iParam1) == 0;
}

void Function_91(int iParam0) //Position: 0x3479 / 13433
{
	if (Function_90(iParam0->f_40, 16))
	{
...
void Function_92(int iParam0, bool bParam1) //Position: 0x34EC / 13548
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_85));
		iLocal_86 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_51(iParam0->f_12))
...
void Function_93() //Position: 0x39EA / 14826
{
	bool bVar0;
...
bool Function_94(bool bParam0) //Position: 0x3A21 / 14881
{
	return Function_26(bParam0, "ReuseDelay", 15.0f);
}

void Function_95(var uParam0, int iParam1) //Position: 0x3A3E / 14910
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_96(int iParam0) //Position: 0x3A76 / 14966
{
	iParam0 = iParam0;
	return;
}

bool Function_97(bool bParam0) //Position: 0x3A80 / 14976
{
	return Function_22(bParam0, "BlockBumpReactions", 0);
}

void Function_98(var uParam0, int iParam1) //Position: 0x3AA1 / 15009
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_99(bool bParam0, bool bParam1) //Position: 0x3AAF / 15023
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_100(bool bParam0, bool bParam1) //Position: 0x3BB7 / 15287
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_101(int iParam0) //Position: 0x3BCD / 15309
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_102(var uParam0, int iParam1) //Position: 0x3E83 / 16003
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_103(bool bParam0) //Position: 0x3E91 / 16017
{
	return Function_22(bParam0, "DrawWeapon", 0);
}

bool Function_104(bool bParam0) //Position: 0x3EAA / 16042
{
	return Function_22(bParam0, "AllowWeapon", 0);
}

void Function_105(bool bParam0, int iParam1) //Position: 0x3EC4 / 16068
{
	bool bVar0;
	char* cVar1;
...
bool Function_106(var uParam0, int iParam1) //Position: 0x3EFC / 16124
{
	return Function_24(uParam0, "UseName", iParam1);
}

bool Function_107(int iParam0, int iParam1) //Position: 0x3F13 / 16147
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_108(bool bParam0) //Position: 0x41DD / 16861
{
	return Function_26(bParam0, "ActivationCone", 0.0f);
}

bool Function_109(bool bParam0, bool bParam1) //Position: 0x41FA / 16890
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_110(int iParam0) //Position: 0x4296 / 17046
{
	return Function_26(iParam0, "ActivationRadius", 2.0f);
}

bool Function_111(var uParam0, int iParam1) //Position: 0x42B5 / 17077
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 0;
...
bool Function_112(int iParam0) //Position: 0x42C4 / 17092
{
...
void Function_113(int iParam0) //Position: 0x42E0 / 17120
{
	iParam0 = iParam0;
	return;
}

void Function_114(bool bParam0, int iParam1) //Position: 0x42EA / 17130
{
	int iVar0;
	int iVar1;
...
void Function_115(int iParam0, int iParam1) //Position: 0x434C / 17228
{
...
void Function_116(int iParam0) //Position: 0x4360 / 17248
{
	iParam0 = iParam0;
	return;
}

void Function_117(int iParam0) //Position: 0x436A / 17258
{
