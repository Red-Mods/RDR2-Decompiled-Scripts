						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_84))
								{
									...
									{
										bLocal_84 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_84 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
void Function_62(int iParam0) //Position: 0x2552 / 9554
{
	...
	if (!iLocal_2 && iLocal_1)
	{
		...
		{
			cLocal_0 = CREATE_LAYOUT("Door_Locked_Layout");
			Function_63(cLocal_0, 0, 1, 0, 0);
		}
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x260E / 9742
{
	bool bVar0;
...
void Function_64(int iParam0) //Position: 0x2684 / 9860
{
	bool bVar0;
	var uVar1;
	...
	uVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*iParam0, 0, 10.0f, 0);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(uVar1, 10.0f, 1, 0f);
	return;
}

void Function_65(int iParam0) //Position: 0x26BA / 9914
{
...
void Function_66(int iParam0) //Position: 0x2724 / 10020
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x272E / 10030
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x274C / 10060
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2761 / 10081
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x27E8 / 10216
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x280B / 10251
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x2829 / 10281
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x284C / 10316
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2967 / 10599
{
...
int Function_75(bool bParam0) //Position: 0x2992 / 10642
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A97 / 10903
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2AA4 / 10916
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2B17 / 11031
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x3015 / 12309
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x304C / 12364
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3069 / 12393
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x30A1 / 12449
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x30AB / 12459
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x30CC / 12492
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x30F6 / 12534
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x31FE / 12798
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x3214 / 12820
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x34CA / 13514
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_89(bool bParam0) //Position: 0x34E7 / 13543
{
...
void Function_91(int iParam0, int iParam1) //Position: 0x351A / 13594
{
	bool bVar0;
	var uVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3552 / 13650
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x3569 / 13673
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3832 / 14386
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x384F / 14415
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x38EB / 14571
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x390A / 14602
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x3919 / 14617
{
...
void Function_99(int iParam0) //Position: 0x3935 / 14645
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x393F / 14655
{
	int iVar0;
	int iVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x39A1 / 14753
{
...
void Function_102(int iParam0) //Position: 0x39B5 / 14773
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x39BF / 14783
{
