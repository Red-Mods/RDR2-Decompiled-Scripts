...
float Function_26(int iParam0) //Position: 0x1535 / 5429
{
	if (iParam0 == 4294967295)
	{
...
void Function_57(bool bParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	char* cVar0;
	var uVar1;
	
	bParam0 = Function_74(bParam0);
	if ((Function_70(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	cVar0 = GET_GRINGO_STRING_ATTR("nRegionMap", bParam0, &uVar1);
	if (Function_69(cVar0, "CHOLLA_SPRINGS_REGION"))
	{
		Function_64(Global_30628[0]);
		Function_60(&Global_30640);
		Function_58("discover_cholla", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "GAPTOOTH_RIDGE_REGION"))
	{
		Function_64(Global_30628[1]);
		Function_60(&Global_30658);
		Function_58("discover_gaptooth", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "HENNIGANS_STEAD_REGION"))
	{
		Function_64(Global_30628[2]);
		Function_60(&Global_30668);
		Function_58("discover_hennigans", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "RIO_BRAVO_REGION"))
	{
		Function_64(Global_30628[3]);
		Function_60(&Global_30679);
		Function_58("discover_riobravo", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "PUNTA_ORGULLO_REGION"))
	{
		Function_64(Global_30633[0]);
		Function_60(&Global_30685);
		Function_58("discover_orgullo", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "PERDIDO_REGION"))
	{
		Function_64(Global_30633[2]);
		Function_60(&Global_30693);
		Function_58("discover_perdido", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "DIEZ_CORONAS_REGION"))
	{
		Function_64(Global_30633[1]);
		Function_60(&Global_30707);
		Function_58("discover_diezcoronas", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "GREAT_PLAINS_REGION"))
	{
		Function_64(Global_30637[0]);
		Function_60(&Global_30717);
		Function_58("discover_greatplains", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_69(cVar0, "TALL_TREES_REGION"))
	{
		Function_64(Global_30637[1]);
		Function_60(&Global_30723);
		Function_58("discover_talltrees", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else
	{
		LOG_ERROR("ITEM: Invalid region name for map item.");
		*iParam2 = 0;
	}
	DECOR_SET_BOOL(Global_34573, "ItemSave", true);
	return;
}

void Function_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2FA8 / 12200
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x3023 / 12323
{
	char* cVar0[16];
...
int Function_60(int iParam0) //Position: 0x3062 / 12386
{
	int iVar0;
	...
	while (iVar0 <= *iParam0)
	{
		if (!Function_61((*iParam0)[iVar0]))
		{
			Function_64((*iParam0)[iVar0]);
		}
		iVar0++;
	}
	return 1;
...
bool Function_61(int iParam0) //Position: 0x3093 / 12435
{
	...
	return Function_62(&(Global_29008[iParam0]), 4096);
}

bool Function_62(var uParam0, int iParam1) //Position: 0x30B1 / 12465
{
	int iVar0;
...
void Function_64(int iParam0) //Position: 0x30E3 / 12515
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_62(&(Global_29008[iParam0]), 4096))
	{
		return;
	}
	Function_68(&(Global_29008[iParam0]), 4096);
	if (StackVal != 1)
	{
	...
	if (Function_25(473) <= Function_26(473))
	{
		if (!Function_2())
		{
...
void Function_65(int iParam0, bool bParam1) //Position: 0x31E2 / 12770
{
	bool bVar0;
...
var Function_66(int iParam0) //Position: 0x3249 / 12873
{
	int iVar0;
...
int Function_67(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x32A1 / 12961
{
	int iVar0;
	int iVar1;
...
void Function_68(var uParam0, int iParam1) //Position: 0x34C1 / 13505
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_69(char* cParam0, char* cParam1) //Position: 0x34D0 / 13520
{
	char* cVar0[64];
	char* cVar16[64];
...
int Function_70(bool bParam0, bool bParam1, bool bParam2) //Position: 0x34FB / 13563
{
...
bool Function_71() //Position: 0x35B1 / 13745
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_72(bool bParam0) //Position: 0x35C8 / 13768
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_73(bool bParam0) //Position: 0x35D3 / 13779
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_74(bool bParam0) //Position: 0x35E1 / 13793
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_75(int iParam0, bool bParam1) //Position: 0x35FB / 13819
{
	bool bVar0;
	bool bVar1;
