...
bool Function_51(bool bParam0, int iParam1, int iParam2) //Position: 0x2A4A / 10826
{
	bool bVar0;
...
void Function_53(bool bParam0, int iParam1) //Position: 0x2B00 / 11008
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	...
	bLocal_4 = Function_82(uParam0);
	bParam1 = bParam1;
	*iParam2 = 0;
	fVar0 = 0.0f;
	GET_GRINGO_FLOAT_ATTR(&fVar0, "effectTime", bLocal_4);
	if (!DECOR_CHECK_EXIST(bParam1, "bait"))
	{
		if (!Global_3386)
		{
			if (!Function_81())
			{
				if (Function_80())
				{
					if ((IS_ACTOR_VALID(bParam1) && IS_ACTOR_ALIVE(bParam1)) && !Function_76(Global_34573, 0, 0))
					{
						if (IS_ACTOR_ON_GROUND(bParam1) && !((IS_ACTOR_ON_TRAIN(bParam1, 0) || IS_ACTOR_INSIDE_VEHICLE(bParam1)) || IS_ACTOR_VALID(GET_MOUNT(Global_34573))))
						{
							...
							{
								if ((Function_75(Global_30750[10], 0, 4294967295, 0) && Function_74(Global_30750[10], 0, 0, 0) == 4294967295) && Function_74(Global_30750[10], 0, 0, 0) == 0)
								{
									ACTOR_HOLSTER_WEAPON(Global_34573, 1);
									Function_73(481, 1, 0, 0);
									if (Function_72())
									{
										if (HAS_ITEM(SS_GET_STRING(1, 6), Global_34573))
										{
											iVar1 = GET_ITEM_COUNT(SS_GET_STRING(1, 6), Global_34573);
										}
										PLAYSTAT_INT("HC_BAIT", iVar1);
									}
									DECOR_SET_FLOAT(bParam1, "bait", fVar0);
									DECOR_SET_VECTOR(bParam1, "baitSafePos", vLocal_5);
									Function_69(0, 0x40400000);
									bVar2 = Function_60(0, 0, 0, 0, 0, 0, 1, 0);
									if (IS_ACTOR_VALID(bVar2))
									{
										...
										TASK_SEQUENCE_CLOSE();
										TASK_SEQUENCE_PERFORM(bVar2, uVar3);
										TASK_SEQUENCE_RELEASE(uVar3, 1);
								...
								{
									Function_58("item_bait_no_animals", 0x41200000, 1, 0, 2, 1, 0);
									*iParam2 = 0;
								}
							}
							else
							{
								Function_58("item_bait_attacked", 0x41200000, 1, 0, 2, 1, 0);
								*iParam2 = 0;
							}
						}
						else
						{
							Function_58("item_bait_ground", 0x41200000, 1, 0, 2, 1, 0);
							*iParam2 = 0;
						}
					}
					else
					{
						Function_58("item_bait_disabled", 0x41200000, 1, 0, 2, 1, 0);
						*iParam2 = 0;
					}
				}
				else
			...
			{
				Function_58("item_bait_too_close", 0x41200000, 1, 0, 2, 1, 0);
				*iParam2 = 0;
			}
		}
		else
		{
			Function_58("item_bait_town", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
	{
		Function_58("item_bait_active", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2EEE / 12014
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2F69 / 12137
{
	char* cVar0[16];
...
var Function_60(var uParam0, bool bParam1, float fParam2, float fParam3, float fParam4, float fParam5, var uParam6, bool bParam7) //Position: 0x2FA8 / 12200
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
	...
	{
		Function_63(GET_OBJECT_FROM_ACTOR(Global_12976.f_36));
		vVar2 = { StackVal, StackVal, Function_63(GET_OBJECT_FROM_ACTOR(Global_12976.f_36)) };
		Function_63(GET_OBJECT_FROM_ACTOR(Global_34573));
		vVar5 = { StackVal, StackVal, Function_63(GET_OBJECT_FROM_ACTOR(Global_34573)) };
		iVar8 = Function_62(StackVal, StackVal, vVar2, 0, 1, 1);
		if (iVar8 != 4294967294 || iVar8 != 4294967295)
		{
		}
		else
		{
			iVar9 = Function_62(StackVal, StackVal, vVar5, 0, 1, 1);
			if (iVar8 != iVar9)
			{
				...
				else
				{
					...
					if (!bParam7)
					{
						Global_12976.f_36 = CREATE_ACTOR_IN_LAYOUT(FIND_NAMED_LAYOUT("PlayerLayout"), Function_16(), iVar0, fParam2, fParam3, fParam4, 0.0f, fParam5, 0.0f);
						SNAP_OBJECT_TO_GROUND(Global_12976.f_36, 15.0f, true, 1092616192);
					}
					else
					{
						Global_12976.f_36 = CREATE_ACTOR_IN_LAYOUT(FIND_NAMED_LAYOUT("PlayerLayout"), Function_16(), 993, fParam2, fParam3, fParam4, 0.0f, fParam5, 0.0f);
						SNAP_OBJECT_TO_GROUND(Global_12976.f_36, 15.0f, true, 1092616192);
					}
	...
	if (bVar1)
	{
		...
		Function_61(Global_12976.f_36, 0, 0, 0, 0, 0, 0);
	}
	if (Function_2() || NET_IS_IN_SESSION())
	{
		if (IS_ACTOR_VALID(Global_12976.f_36))
...
void Function_61(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x32FE / 13054
{
...
var Function_62(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x333B / 13115
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
vector3 Function_63(bool bParam0) //Position: 0x33D6 / 13270
{
	vector3 vVar0;
...
void Function_64() //Position: 0x33FD / 13309
{
	bool bVar0;
...
bool Function_65() //Position: 0x346F / 13423
{
	if (Function_66() >= 1)
	{
		return 0;
...
int Function_66() //Position: 0x3485 / 13445
{
	return Global_12976.f_152;
}

bool Function_67() //Position: 0x3490 / 13456
{
	bool bVar0;
...
void Function_68(var uParam0, bool bParam1, bool bParam2) //Position: 0x34B0 / 13488
{
...
void Function_69(float fParam0, float fParam1) //Position: 0x34DD / 13533
{
...
void Function_70() //Position: 0x35DB / 13787
{
...
void Function_71() //Position: 0x360D / 13837
{
...
bool Function_72() //Position: 0x370A / 14090
{
...
int Function_73(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3735 / 14133
{
	int iVar0;
	int iVar1;
...
int Function_74(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x3955 / 14677
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(uParam0, iParam1, iParam2, bParam3, 0, 0.0f, 0.0f, 0.0f);
}

int Function_75(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x396C / 14700
{
...
bool Function_76(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3993 / 14739
{
...
bool Function_77() //Position: 0x3A49 / 14921
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_78(int iParam0) //Position: 0x3A60 / 14944
{
	return IS_ACTOR_IN_HOGTIE(iParam0);
}

bool Function_79(bool bParam0) //Position: 0x3A6B / 14955
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

bool Function_80() //Position: 0x3A79 / 14969
{
...
bool Function_81() //Position: 0x3ADE / 15070
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3B24 / 15140
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_83(int iParam0, bool bParam1) //Position: 0x3B3E / 15166
{
	bool bVar0;
	bool bVar1;
