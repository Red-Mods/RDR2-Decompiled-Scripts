...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Cho", 4);
	Function_17("Loading Cholla Springs population file", 3);
	Global_30839++;
	...
	uVar2 = Function_16("zombie_horse", 0);
	Function_15(&uVar2, 1248, 10.0f, 0, 0);
	Function_15(&uVar2, 1249, 10.0f, 0, 0);
	Function_15(&uVar2, 1250, 10.0f, 0, 0);
	Function_15(&uVar2, 1251, 10.0f, 0, 0);
	uVar3 = Function_16("zombie_bear", 0);
	Function_15(&uVar3, 1246, 10.0f, 0, 0);
	uVar4 = Function_16("zombie_boar", 0);
	Function_15(&uVar4, 1245, 10.0f, 0, 0);
	uVar5 = Function_16("zombie_cougar", 0);
	Function_15(&uVar5, 1244, 10.0f, 0, 0);
	uVar6 = Function_16("zombie_wolf", 0);
	Function_15(&uVar6, 1242, 10.0f, 0, 0);
	uVar7 = Function_16("zombie_coyote", 0);
	Function_15(&uVar7, 1241, 10.0f, 0, 0);
	uVar8 = Function_16("zombie_dog", 0);
	Function_15(&uVar8, 1240, 10.0f, 0, 0);
	uVar9 = Function_16("zombie_bull", 0);
	Function_15(&uVar9, 1243, 10.0f, 0, 0);
	uVar10 = Function_16("nevil_goat", 0);
	Function_15(&uVar10, 1272, 10.0f, 0, 0);
	...
	uVar12 = Function_16("armadillo_prestream", 0);
	Function_15(&uVar12, 202, 4.0f, 0, 0);
	Function_15(&uVar12, 87, 4.0f, 0, 0);
	Function_15(&uVar12, 235, 4.0f, 0, 0);
	Function_15(&uVar12, 217, 4.0f, 0, 0);
	Function_15(&uVar12, 140, 4.0f, 0, 0);
	Function_15(&uVar12, 137, 4.0f, 0, 0);
	Function_15(&uVar12, 46, 4.0f, 0, 0);
	Function_15(&uVar12, 50, 4.0f, 0, 0);
	Function_15(&uVar12, 79, 4.0f, 0, 0);
	Function_15(&uVar12, 136, 4.0f, 0, 0);
	Function_15(&uVar12, 204, 4.0f, 0, 0);
	Function_15(&uVar12, 155, 4.0f, 0, 0);
	Function_15(&uVar12, 142, 4.0f, 0, 0);
	Function_15(&uVar12, 49, 4.0f, 0, 0);
	Function_15(&uVar12, 56, 4.0f, 0, 0);
	Function_15(&uVar12, 74, 4.0f, 0, 0);
	Function_15(&uVar12, 178, 4.0f, 0, 0);
	Function_15(&uVar12, 48, 4.0f, 0, 0);
	Function_15(&uVar12, 203, 4.0f, 0, 0);
	Function_15(&uVar12, 66, 4.0f, 0, 0);
	Function_15(&uVar12, 67, 4.0f, 0, 0);
	Function_15(&uVar12, 69, 4.0f, 0, 0);
	Function_15(&uVar12, 65, 4.0f, 0, 0);
	Function_15(&uVar12, 71, 4.0f, 0, 0);
	Function_15(&uVar12, 72, 4.0f, 0, 0);
	Function_15(&uVar12, 486, 4.0f, 0, 0);
	Function_15(&uVar12, 487, 4.0f, 0, 0);
	Function_15(&uVar12, 489, 4.0f, 0, 0);
	Function_15(&uVar12, 490, 4.0f, 0, 0);
	Function_15(&uVar12, 491, 4.0f, 0, 0);
	Function_15(&uVar12, 493, 4.0f, 0, 0);
	Function_15(&uVar12, 1204, 5.0f, 0, 0);
	Function_15(&uVar12, 1205, 5.0f, 0, 0);
	Function_15(&uVar12, 1206, 5.0f, 0, 0);
	Function_15(&uVar12, 1207, 5.0f, 0, 0);
	Function_15(&uVar12, 1208, 5.0f, 0, 0);
	Function_15(&uVar12, 1209, 5.0f, 0, 0);
	Function_15(&uVar12, 1210, 5.0f, 0, 0);
	Function_15(&uVar12, 1211, 5.0f, 0, 0);
	Function_15(&uVar12, 1212, 5.0f, 0, 0);
	Function_15(&uVar12, 1213, 5.0f, 0, 0);
	Function_15(&uVar12, 1214, 5.0f, 0, 0);
	Function_15(&uVar12, 1215, 5.0f, 0, 0);
	Function_15(&uVar12, 1216, 5.0f, 0, 0);
	Function_15(&uVar12, 1217, 5.0f, 0, 0);
	Function_15(&uVar12, 1218, 5.0f, 0, 0);
	Function_15(&uVar12, 1219, 5.0f, 0, 0);
	Function_15(&uVar12, 1220, 5.0f, 0, 0);
	...
	bVar16 = FIND_NAMED_LAYOUT("ChollaSprings_layout");
	if (IS_LAYOUTREF_VALID(bVar16))
	{
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_narrowZombie_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			uVar18 = Function_5(bVar17, uVar0, 100, 0, 0, 1);
			SET_ZONE_POPULATION_SPAWN_MULTI_PER_POINT(uVar18, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_RepulsionExclusion_set to create population volumes");
		}
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			uVar19 = Function_4(bVar17, uVar0, 4E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar19, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar19, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar19, 10);
			uVar20 = Function_4(bVar17, uVar2, 1E-05f, 0, 1, 1);
			...
			uVar21 = Function_4(bVar17, uVar5, 5E-06f, 0, 0, 1);
			...
			uVar22 = Function_4(bVar17, uVar6, 1.5E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar22, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar22, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar22, 4);
			uVar23 = Function_4(bVar17, uVar7, 2E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_IS_FLOCK(uVar23, 1);
			SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar23, 1);
			SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar23, 6);
			uVar24 = Function_4(bVar17, uVar10, 1E-05f, 0, 0, 1);
			...
			uVar25 = Function_4(bVar17, uVar9, 5E-06f, 0, 0, 1);
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_flk_SE_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			if (!Function_3())
			{
				uVar26 = Function_4(bVar17, uVar0, 4E-05f, 0, 0, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar26, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar26, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar26, 5);
				uVar27 = Function_4(bVar17, uVar2, 1E-05f, 0, 1, 1);
				...
				uVar28 = Function_4(bVar17, uVar5, 5E-06f, 0, 0, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar28, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar28, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar28, 1);
				uVar29 = Function_4(bVar17, uVar6, 1.5E-05f, 0, 0, 1);
				...
				uVar30 = Function_4(bVar17, uVar7, 2E-05f, 0, 0, 1);
				...
				uVar31 = Function_4(bVar17, uVar10, 1E-05f, 0, 0, 1);
				...
				uVar32 = Function_4(bVar17, uVar9, 5E-06f, 0, 0, 1);
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_flk_NW_set");
		if (IS_VOLUME_VALID(bVar17))
		{
			if (!Function_3())
			{
				uVar33 = Function_4(bVar17, uVar0, 4E-05f, 0, 0, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar33, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar33, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar33, 20);
				uVar34 = Function_4(bVar17, uVar2, 1E-05f, 0, 1, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar34, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar34, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar34, 1);
				uVar35 = Function_4(bVar17, uVar5, 1E-05f, 0, 0, 1);
				...
				uVar36 = Function_4(bVar17, uVar6, 1.5E-05f, 0, 0, 1);
				...
				uVar37 = Function_4(bVar17, uVar7, 2E-05f, 0, 0, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar37, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar37, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar37, 6);
				uVar38 = Function_4(bVar17, uVar10, 1E-05f, 0, 0, 1);
				...
				uVar39 = Function_4(bVar17, uVar9, 1E-05f, 0, 0, 1);
				SET_ZONE_POPULATION_IS_FLOCK(uVar39, 1);
				SET_ZONE_POPULATION_MIN_FLOCK_SIZE(uVar39, 1);
				SET_ZONE_POPULATION_MAX_FLOCK_SIZE(uVar39, 1);
				Function_4(bVar17, Global_30750[7], 2E-05f, 0, 0, 1);
				Function_4(bVar17, uVar1, 3E-05f, 0, 0, 1);
			}
		}
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_Venters");
		if (IS_VOLUME_VALID(bVar17))
		{
			Function_4(bVar17, uVar0, 5E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_Venters to create population volumes");
		}
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_critchly");
		if (IS_VOLUME_VALID(bVar17))
		{
			Function_4(bVar17, uVar0, 5E-05f, 0, 0, 1);
		}
		...
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "chov_rileysCharge");
		if (IS_VOLUME_VALID(bVar17))
		{
			Function_5(bVar17, uVar0, 5, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find chov_rileysCharge to create population volumes");
		}
		bVar17 = FIND_VOLUME_IN_LAYOUT(bVar16, "nchov_null");
		if (IS_VOLUME_VALID(bVar17))
		{
	...
	Function_7("Finished loading Cholla Springs population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0x16BA / 5818
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x16C9 / 5833
{
	int iVar0;
...
bool Function_3() //Position: 0x171E / 5918
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_4(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1727 / 5927
{
	bool bVar0;
...
var Function_5(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x17A7 / 6055
{
	bool bVar0;
...
bool Function_6(int iParam0) //Position: 0x1827 / 6183
{
	int iVar0;
...
void Function_7(bool bParam0, float fParam1) //Position: 0x1843 / 6211
{
	if (!Function_6(128))
	{
		return;
...
bool Function_8(var uParam0, int iParam1) //Position: 0x1881 / 6273
{
	int iVar0;
...
void Function_9(var uParam0, bool bParam1) //Position: 0x189D / 6301
{
...
var Function_10(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x18AD / 6317
{
	int iVar0;
	int iVar1;
...
var Function_11(int iParam0) //Position: 0x1925 / 6437
{
	int iVar0;
...
var Function_12(int iParam0) //Position: 0x1991 / 6545
{
	int iVar0;
...
var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x19FD / 6653
{
	int iVar0;
	int iVar1;
...
void Function_14(int iParam0) //Position: 0x1A42 / 6722
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_15(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1A4E / 6734
{
	int iVar0;
	int iVar1;
...
var Function_16(int iParam0, int iParam1) //Position: 0x1ACA / 6858
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_17(bool bParam0, var uParam1) //Position: 0x1AD7 / 6871
{
	if (!Function_6(128))
	{
		return;
