...
bool Function_68(var uParam0, int iParam1) //Position: 0x2970 / 10608
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	return 1;
...
bool Function_69(bool bParam0, int iParam1) //Position: 0x297F / 10623
{
...
int Function_70(bool bParam0) //Position: 0x29AA / 10666
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2AAF / 10927
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(int iParam0) //Position: 0x2ABC / 10940
{
	if (Function_71(iParam0->f_40, 16))
	{
...
void Function_73(int iParam0, bool bParam1) //Position: 0x2B2F / 11055
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(bool bParam0) //Position: 0x3064 / 12388
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_76(var uParam0, int iParam1) //Position: 0x3081 / 12417
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x30B9 / 12473
{
	iParam0 = iParam0;
	return;
}

bool Function_78(bool bParam0) //Position: 0x30C3 / 12483
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_79(bool bParam0, int iParam1) //Position: 0x30E4 / 12516
{
	iParam1 = iParam1;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x30FC / 12540
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x3204 / 12804
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_82(int iParam0) //Position: 0x321A / 12826
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(var uParam0, int iParam1) //Position: 0x34D0 / 13520
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_84(bool bParam0) //Position: 0x34DE / 13534
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_85(bool bParam0) //Position: 0x34F7 / 13559
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_86(bool bParam0, int iParam1) //Position: 0x3511 / 13585
{
	bool bVar0;
	char* cVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x3549 / 13641
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_88(int iParam0, int iParam1) //Position: 0x3560 / 13664
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_89(bool bParam0) //Position: 0x3829 / 14377
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_90(bool bParam0, bool bParam1) //Position: 0x3846 / 14406
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_91(int iParam0) //Position: 0x38E2 / 14562
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x3901 / 14593
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_93(int iParam0) //Position: 0x3910 / 14608
{
...
void Function_94(int iParam0) //Position: 0x392C / 14636
{
	iParam0 = iParam0;
	return;
}

void Function_95(bool bParam0, int iParam1) //Position: 0x3936 / 14646
{
	int iVar0;
	int iVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x3998 / 14744
{
...
void Function_97(int iParam0) //Position: 0x39AC / 14764
{
	iParam0 = iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x39B6 / 14774
{
