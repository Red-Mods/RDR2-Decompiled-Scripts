				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							...
							{
								Function_148(&(Global_63541[2855]), 28, 0x41f00000, 0x42200000, 0);
								iVar0 = 1;
							}
							else
							{
								bLocal_256 = CREATE_LAYOUT("RCM_Return_Layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						{
							Function_147(&Global_63541[ScriptParam_055] + 144, 128);
							ACTOR_DATA_GRAVITY_LIMIT(0);
							Function_145();
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							break;
						}
						bLocal_255 = Function_144(StackVal, StackVal, *(&Global_63541[ScriptParam_055] + 112), 0x3f800000, 0x42960000, 1, 1, 0);
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (bLocal_255)
							{
								if (StackVal && FABS((StackVal - !Function_140(Global_34573, 1, 1))) > 2.0f)
								{
									if (Function_136(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0))
									{
					...
					case 0x00000003:
						if (Function_105("$/cutscene/false_ending_intro_cs/false_ending_intro_cs", "$/cutscene/false_ending_cs/false_ending_cs", &iLocal_248, &uLocal_258, uLocal_265, 25561, 25554, 25547, 25554, 25540, 25554, 25485, 25194, 25187, 0, 2, 1, 1, 2))
						{
							Function_104(1.0f);
							iVar0 = 5;
						}
					...
					case 0x00000005:
						...
						{
							Function_147(&Global_63541[2855] + 144, 256);
							Function_102("Return1_SHORT", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "False1_OBJ", 0, 3, false);
...
void Function_1(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x344 / 836
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_92(&Global_63541[iParam055] + 144, 64);
...
void Function_2(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x880 / 2176
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_3() //Position: 0x9F3 / 2547
{
	return;
}

void Function_4(var uParam0, var uParam1) //Position: 0x9F9 / 2553
{
	if (Global_3381)
	{
		return;
...
bool Function_5() //Position: 0xA3B / 2619
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_6(bool bParam0) //Position: 0xA44 / 2628
{
...
void Function_7() //Position: 0xA95 / 2709
{
	Function_35();
	Function_34();
	Function_34();
...
void Function_8() //Position: 0xAE7 / 2791
{
...
void Function_9() //Position: 0xBED / 3053
{
	float fVar0;
...
void Function_10() //Position: 0xC20 / 3104
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_11() //Position: 0xDAE / 3502
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0xF62 / 3938
{
	Function_13(&Global_28260, 1, 0);
	return;
}

void Function_13(int iParam0, bool bParam1, var uParam2) //Position: 0xF70 / 3952
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_14() //Position: 0x1161 / 4449
{
...
struct<8> Function_15(int iParam0) //Position: 0x1176 / 4470
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x121C / 4636
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x14B7 / 5303
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18() //Position: 0x1AE4 / 6884
{
	int iVar0;
...
var Function_19(int iParam0) //Position: 0x1AEC / 6892
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_20(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1AFD / 6909
{
	char* cVar0[32];
...
struct<32> Function_21(char* cParam0, bool bParam1) //Position: 0x1BF2 / 7154
{
	char* cVar0[32];
...
void Function_22(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1C0B / 7179
{
	float fVar0;
...
var Function_23(int iParam0, int iParam1) //Position: 0x1C70 / 7280
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_24(int iParam0, bool bParam1) //Position: 0x1C82 / 7298
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_25(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C94 / 7316
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_26(int iParam0) //Position: 0x1DC4 / 7620
{
	return Global_35278[iParam020].f_48;
}

float Function_27(int iParam0) //Position: 0x1DD3 / 7635
{
	if (!iParam0 != 4294967295)
	{
...
var Function_28(int iParam0) //Position: 0x1E0C / 7692
{
	if (iParam0 == 4294967295)
	{
...
void Function_29(int iParam0) //Position: 0x1E49 / 7753
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_30(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FE3 / 8163
{
	int iVar0;
	int iVar1;
...
int Function_31(bool bParam0) //Position: 0x2227 / 8743
{
...
struct<8> Function_32() //Position: 0x2268 / 8808
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x22F1 / 8945
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x2388 / 9096
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_35() //Position: 0x2407 / 9223
{
...
int Function_36(int iParam0, bool bParam1, int iParam2) //Position: 0x2440 / 9280
{
	int iVar0;
	int iVar1;
...
void Function_37() //Position: 0x264A / 9802
{
	vector3 vVar0;
	var uVar3;
...
bool Function_38(vector3 vParam0) //Position: 0x2705 / 9989
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_39(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x271D / 10013
{
	int iVar0;
...
vector3 Function_40() //Position: 0x2804 / 10244
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_41(int iParam0) //Position: 0x280D / 10253
{
...
int Function_42(bool bParam0, bool bParam1) //Position: 0x2823 / 10275
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_43(vector3 vParam0, vector3 vParam3) //Position: 0x28EA / 10474
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_44(var uParam0, int iParam1) //Position: 0x2907 / 10503
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_45(int iParam0) //Position: 0x312C / 12588
{
	var uVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x3167 / 12647
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x3174 / 12660
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3181 / 12673
{
	uParam0 = uParam0;
...
void Function_49(int iParam0) //Position: 0x3225 / 12837
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_90(GET_TARGETED_JOURNAL_ENTRY());
	...
	switch (iVar0)
	{
		case 0x00000004:
			...
			{
				if (Function_89(iVar6) && !Function_87(iVar6))
				{
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_46(Global_63541[iVar155].f_144, 2048))
				{
					...
					{
						Function_147(&Global_63541[iVar155] + 144, 64);
...
void Function_50(int iParam0, int iParam1) //Position: 0x33C7 / 13255
{
	float fVar0;
	bool bVar1;
...
void Function_51(int iParam0) //Position: 0x3481 / 13441
{
	float fVar0;
	bool bVar1;
...
int Function_52(var uParam0, int iParam1) //Position: 0x3523 / 13603
{
	int iVar0;
	var uVar1;
...
void Function_53(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3684 / 13956
{
	struct<8> Var0;
...
struct<32> Function_54(bool bParam0) //Position: 0x371F / 14111
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_55(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3789 / 14217
{
	char* cVar0[32];
...
int Function_56(bool bParam0) //Position: 0x37A8 / 14248
{
	int iVar0;
	vector3 vVar1;
...
float Function_57(bool bParam0, vector3 vParam1) //Position: 0x3909 / 14601
{
	vector3 vVar0;
...
vector3 Function_58(bool bParam0) //Position: 0x3983 / 14723
{
	vector3 vVar0;
...
void Function_59(int iParam0) //Position: 0x39ED / 14829
{
...
bool Function_60(int iParam0) //Position: 0x3A4E / 14926
{
...
void Function_61(int iParam0, int iParam1) //Position: 0x3A64 / 14948
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if (((StackVal && Function_144(StackVal, Function_63(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_62(iParam1)) || Global_74542[iParam110].f_12 != 1)
	{
...
int Function_62(int iParam0) //Position: 0x3BA9 / 15273
{
...
bool Function_63(int iParam0) //Position: 0x3BD5 / 15317
{
...
bool Function_64(int iParam0, int iParam1) //Position: 0x3BEA / 15338
{
	...
	{
		Function_147(&Global_63541[iParam155] + 144, 64);
		return 1;
	}
...
bool Function_65(int iParam0, int iParam1) //Position: 0x3CFF / 15615
{
	int iVar0;
...
bool Function_66(int iParam0) //Position: 0x3E43 / 15939
{
...
bool Function_67(int iParam0) //Position: 0x3E67 / 15975
{
...
bool Function_68(int iParam0) //Position: 0x3E7C / 15996
{
...
var Function_69(int iParam0) //Position: 0x3E93 / 16019
{
...
bool Function_70(int iParam0) //Position: 0x3EAD / 16045
{
...
bool Function_71(int iParam0) //Position: 0x3EC3 / 16067
{
	return StackVal;
}

bool Function_72(var uParam0, int iParam1) //Position: 0x3ED3 / 16083
{
	int iVar0;
...
bool Function_73(int iParam0) //Position: 0x3EEF / 16111
{
	if (!iParam0->f_152)
	{
		if (Function_100())
...
bool Function_74(int iParam0) //Position: 0x3F93 / 16275
{
...
bool Function_75(int iParam0) //Position: 0x3FEC / 16364
{
	int iVar0;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x400A / 16394
{
	int iVar0;
...
int Function_77(int iParam0) //Position: 0x4026 / 16422
{
...
bool Function_78(int iParam0) //Position: 0x403B / 16443
{
...
int Function_79(int iParam0) //Position: 0x4050 / 16464
{
...
void Function_80() //Position: 0x4065 / 16485
{
	if (Function_84(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_8 = Function_81(StackVal, Global_28180);
			Global_28180.f_12 = 0;
		}
...
var Function_81(int iParam0, int iParam1) //Position: 0x40E0 / 16608
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_82(6, 0) && Function_78(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_82(9, 0) && Function_78(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_82(int iParam0, bool bParam1) //Position: 0x4CD1 / 19665
{
	int iVar0;
...
int Function_83(int iParam0) //Position: 0x4D0E / 19726
{
	int iVar0;
	int iVar1;
...
bool Function_84(int iParam0) //Position: 0x4D5D / 19805
{
...
int Function_85(int iParam0) //Position: 0x4D73 / 19827
{
...
void Function_86() //Position: 0x4DDC / 19932
{
...
bool Function_87(int iParam0) //Position: 0x4DFF / 19967
{
	if (!Function_84(iParam0))
	{
...
bool Function_88(int iParam0, int iParam1) //Position: 0x4E50 / 20048
{
	int iVar0;
...
bool Function_89(int iParam0) //Position: 0x4E7D / 20093
{
	if (!Function_84(iParam0))
	{
...
void Function_90(int iParam0) //Position: 0x4ECF / 20175
{
	int iVar0;
...
void Function_91() //Position: 0x4F09 / 20233
{
	bool bVar0;
...
void Function_92(int iParam0, int iParam1) //Position: 0x4F67 / 20327
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_93(bool bParam0) //Position: 0x4F7A / 20346
{
	PRINTSTRING("Day ");
...
void Function_94(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x4FC0 / 20416
{
	bool bVar0;
	char* cVar1[16];
...
void Function_95(char* cParam0, int iParam1) //Position: 0x502C / 20524
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_96(bool bParam0, var uParam1, int iParam2) //Position: 0x5063 / 20579
{
	var uVar0;
	char* cVar1[16];
...
int Function_97(char* cParam0) //Position: 0x50DB / 20699
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_98(int iParam0) //Position: 0x517C / 20860
{
	int iVar0;
	int iVar1;
...
bool Function_99(int iParam0, int iParam1) //Position: 0x51B9 / 20921
{
...
bool Function_100() //Position: 0x51CC / 20940
{
...
void Function_101(char* cParam0, bool bParam1) //Position: 0x51E7 / 20967
{
	bool bVar0;
...
void Function_102(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x520C / 21004
{
	struct<4> Var0;
	int iVar4;
	...
	if (Global_3380 != 1 && Global_6269 == 4294967295)
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, Function_103(Global_6269) };
		}
...
struct<16> Function_103(int iParam0) //Position: 0x5291 / 21137
{
	char* cVar0[16];
...
void Function_104(bool bParam0) //Position: 0x52D0 / 21200
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_105(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15, int iParam16, int iParam17, int iParam18) //Position: 0x52ED / 21229
{
	vector3 vVar0;
	vector3 vVar3;
	
	Function_117(iParam2, uParam14);
	switch (*iParam2)
	{
		case 0x000003E8:
			if (iParam4 != 99 && (Function_116(iParam3) || iParam3->f_24 < 1))
			{
				*iParam2 = 1106;
				return 0;
			}
			...
			{
				CUTSCENE_MANAGER_LOAD_CUTSCENE(bParam0, 0, uParam15, uParam16, 1, 2);
				Call_Loc(uParam5);
				Global_63097 = 1;
				...
				Function_114(iParam2 + 4);
				*iParam2 = 1002;
			}
			else if (CUTSCENE_MANAGER_IS_CUTSCENE_LOADED())
			{
				if (!STRINGS_ARE_EQUAL(CUTSCENE_MANAGER_GET_LOADED_CUTFILE(), bParam0) || !Function_113())
				{
		...
		case 0x000003EA:
			if ((CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED() && !CUTSCENE_MANAGER_IS_CUTSCENE_LOADED()) || Function_110(iParam2 + 4) <= 50.0f)
			{
			...
			if (HUD_IS_FADED())
			{
				if ((Function_110(iParam2 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
		...
		case 0x00000452:
			if ((HUD_IS_FADED() && iParam4 == 99) && !Function_116(iParam3))
			{
...
void Function_106(bool bParam0) //Position: 0x5BF5 / 23541
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_107() //Position: 0x5CA4 / 23716
{
	bool bVar0;
...
void Function_108() //Position: 0x5D16 / 23830
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_109() //Position: 0x5D5B / 23899
{
...
float Function_110(int iParam0) //Position: 0x5D6D / 23917
{
...
bool Function_111(int iParam0) //Position: 0x5E35 / 24117
{
	return Function_46(*iParam0, 2);
}

bool Function_112(var uParam0) //Position: 0x5E42 / 24130
{
	return Function_46(*uParam0, 1);
}

bool Function_113() //Position: 0x5E4F / 24143
{
	int iVar0;
	bool bVar1;
...
void Function_114(int iParam0) //Position: 0x5E89 / 24201
{
	Function_115(iParam0, 0.0f);
	return;
}

void Function_115(var uParam0, float fParam1) //Position: 0x5E95 / 24213
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_147(uParam0, 1);
	Function_92(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

bool Function_116(int iParam0) //Position: 0x5EB6 / 24246
{
	return iParam0->f_20;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5EC0 / 24256
{
	Function_118(uParam0, iParam1, 0);
	return;
}

void Function_118(var uParam0, bool bParam1, bool bParam2) //Position: 0x5ECE / 24270
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_119(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x601A / 24602
{
	int iVar0;
	int iVar1;
...
void Function_120(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x623A / 25146
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_121() //Position: 0x6263 / 25187
{
	return 1;
}

int Function_122() //Position: 0x626A / 25194
{
	Function_123(2, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	DESTROY_VOLUME(bLocal_257);
	Function_104(1.0f);
	return 1;
}

void Function_123(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x6288 / 25224
{
	bool bVar0;
...
void Function_124() //Position: 0x6378 / 25464
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_125() //Position: 0x638D / 25485
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -115.751f, 118.869f, 1373.431f, 150.739f, 1, true, 1);
	ACTOR_POP_NEXT_GAIT(Global_34573, 1, 0);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1073741824, 0);
	return 1;
}

int Function_126() //Position: 0x63C4 / 25540
{
	return 1;
}

int Function_127() //Position: 0x63CB / 25547
{
	return 1;
}

int Function_128() //Position: 0x63D2 / 25554
{
	return 1;
}

int Function_129() //Position: 0x63D9 / 25561
{
	bLocal_257 = CREATE_VOLUME_IN_LAYOUT(bLocal_256, "tempcutscenevol", 2, *(&Global_63541[2855] + 100), 0.0f, 0.0f, 0.0f, 5.0f, 5.0f, 5.0f);
	Function_132(0, 0, 1, 1, 0, 1, 1, bLocal_257, 1, 1, 1, 1);
	Function_130(StackVal, StackVal, bLocal_256, *(&Global_63541[2855] + 112), &bLocal_257, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_130(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x6438 / 25656
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_131(bool bParam0, bool bParam1) //Position: 0x66A6 / 26278
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_132(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x671B / 26395
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_133(int iParam0) //Position: 0x69C9 / 27081
{
	int iVar0;
...
var Function_134() //Position: 0x69FD / 27133
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_135(bool bParam0) //Position: 0x6A7C / 27260
{
	vector3 vVar0;
...
bool Function_136(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x6A8D / 27277
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_139(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_138(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_138(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_137(&iVar6, &vVar3);
				}
				else
				{
...
int Function_137(int iParam0, int iParam1) //Position: 0x6C9F / 27807
{
	var uVar0;
...
float Function_138(bool bParam0, bool bParam1) //Position: 0x6D0A / 27914
{
	vector3 vVar0;
...
void Function_139(bool bParam0, bool bParam1) //Position: 0x6D29 / 27945
{
	bool bVar0;
	bool bVar1;
...
bool Function_140(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6D86 / 28038
{
...
bool Function_141() //Position: 0x6E3C / 28220
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_142(bool bParam0) //Position: 0x6E53 / 28243
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_143(bool bParam0) //Position: 0x6E5E / 28254
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_144(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6E6C / 28268
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_145() //Position: 0x6E88 / 28296
{
	if (IS_LAYOUTREF_VALID(bLocal_256))
	{
		DESTROY_OBJECT(bLocal_256);
	}
	Function_146(0, 0, 0);
	return;
}

int Function_146(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6EA4 / 28324
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_147(var uParam0, int iParam1) //Position: 0x6ED3 / 28371
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

int Function_148(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x6EE2 / 28386
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
float Function_149(float fParam0) //Position: 0x7043 / 28739
{
...
int Function_150(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x7078 / 28792
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_151() //Position: 0x72BE / 29374
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_152(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_152(char* cParam0, vector3 vParam1) //Position: 0x7312 / 29458
{
	char* cVar0[64];
...
bool Function_153(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x743A / 29754
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_58(bParam0);
...
int Function_154() //Position: 0x74C4 / 29892
{
	if (IS_PS3())
	{
		return 1;
