...
void main() //Position: 0x0 / 0
{
	...
	iLocal_265 = 0;
	iLocal_258 = 1000;
	Function_191(&bLocal_248, "sit_chr_dsk_wrk", 1, 0);
	Function_191(&bLocal_248, "ptl_base", 5, 0);
	Function_191(&bLocal_248, "shotgun_sawed01x", 0, 0);
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		if (IS_ACTOR_VALID(bLocal_267))
		{
			...
			{
				TASK_CLEAR(bLocal_267);
				SET_ACTOR_FACTION(bLocal_267, 4);
				if (!Function_184(18))
				{
					Function_183(18, 1);
				}
				if (IS_VOLUME_VALID(bLocal_271))
				{
					DESTROY_VOLUME(bLocal_271);
				}
		...
		switch (iLocal_265)
		{
			case 0x00000000:
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					if (IS_LAYOUTREF_VALID(bLocal_266))
					{
						...
						if (IS_ACTOR_VALID(bLocal_267) && Function_171(&bLocal_248))
						{
							bLocal_271 = CREATE_VOLUME_IN_LAYOUT(bLocal_266, "Marshal4_StayOut", 2, -2086.485f, 20.071f, 2603.702f, 0.0f, 24.353f, 0.0f, 13.94f, 8.597f, 8.977f);
							CLEAR_AMBIENT_OBJECTS_VOLUME(bLocal_271, 15);
							...
							bLocal_272 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_266, "RCM_Marshal4_GatewaySet");
							ADD_TO_VOLUME_SET(bLocal_272, CREATE_VOLUME_IN_LAYOUT(bLocal_266, "Marshal4_Gateway01", 3, -2089.727f, 17.042f, 2605.469f, 0.0f, 24.006f, 0.0f, 2.921f, 1.63f, 2.921f));
							ADD_TO_VOLUME_SET(bLocal_272, CREATE_VOLUME_IN_LAYOUT(bLocal_266, "Marshal4_Gateway02", 2, -2084.523f, 17.576f, 2602.944f, 0.0f, 24.353f, 0.0f, 8.337f, 3.409f, 7.715f));
							bVar3 = LOCATE_NAMED_ACTOR(-2088.81f, 17.043f, 2602.282f, 12.0f, "nmarshal15", 0);
							if (IS_ACTOR_VALID(bVar3))
							{
								Global_63541[ScriptParam_055].f_204 = bVar3;
								DESTROY_ACTOR(bLocal_267);
								bLocal_267 = bVar3;
							}
							TASK_PRIORITY_SET(bLocal_267, 1);
							SET_ACTOR_FACTION(bLocal_267, 20);
							if (!ACTOR_HAS_WEAPON(bLocal_267, 4))
							{
								GIVE_WEAPON_TO_ACTOR(bLocal_267, 4, 0, 1, 1);
							}
							ACTOR_PUT_WEAPON_IN_HAND(bLocal_267, 4, 0);
							MEMORY_SET_WEAPON_DRAW_PREFERENCE(bLocal_267, 0);
							TELEPORT_ACTOR_WITH_HEADING(bLocal_267, -2084.073f, 16.965f, 2606.185f, 73.721f, 1, true, 1);
							TASK_STAND_STILL(bLocal_267, -1.0f, 1, 0);
							iLocal_265 = 1;
							Function_169(&iLocal_273);
						}
						else if (Function_166(&iLocal_273) < 5.0f)
						{
							Function_169(&iLocal_273);
						}
						Function_159(&(Global_63541[1855]), 18, 0x41f00000, 0x42200000, 2, 1, 2, 2, 0);
					}
					else
					{
						bLocal_266 = CREATE_LAYOUT("RCM_Marshal4_Layout");
					}
				}
				break;
			...
			case 0x00000001:
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
				{
					...
					{
						if (IS_ACTOR_IN_VOLUME(Global_34573, bLocal_272))
						{
							Function_151(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0);
			...
			case 0x00000003:
				if (Function_115("$/cutscene/marshal_rcm_4_cs/marshal_rcm_4_cs", &iLocal_258, 30954, 30927, 29696, 29325, 29022, 29006, 1, 1, 2, 2, 0))
				{
					iLocal_265 = 5;
					Function_169(&iLocal_273);
				}
...
void Function_1() //Position: 0x4F6 / 1270
{
	int iVar0;
	int iVar1;
...
void Function_2(int iParam0) //Position: 0x527 / 1319
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_3(int iParam0, int iParam1) //Position: 0x6C9 / 1737
{
	float fVar0;
	bool bVar1;
...
void Function_4(int iParam0) //Position: 0x783 / 1923
{
	float fVar0;
	bool bVar1;
...
int Function_5(var uParam0, int iParam1) //Position: 0x825 / 2085
{
	int iVar0;
	var uVar1;
...
void Function_6(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x986 / 2438
{
	struct<8> Var0;
...
struct<32> Function_7(bool bParam0) //Position: 0xA21 / 2593
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_8(char* cParam0, char* cParam1, char* cParam2) //Position: 0xA8B / 2699
{
	char* cVar0[32];
...
int Function_9(bool bParam0) //Position: 0xAAA / 2730
{
	int iVar0;
	vector3 vVar1;
...
float Function_10(bool bParam0, vector3 vParam1) //Position: 0xC0B / 3083
{
	vector3 vVar0;
...
vector3 Function_11(bool bParam0) //Position: 0xC85 / 3205
{
	vector3 vVar0;
...
void Function_12(int iParam0) //Position: 0xCEF / 3311
{
...
bool Function_13(int iParam0) //Position: 0xD50 / 3408
{
...
var Function_14() //Position: 0xD66 / 3430
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1) //Position: 0xD6E / 3438
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void Function_16(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x1200 / 4608
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_17(int iParam0) //Position: 0x127B / 4731
{
	char* cVar0[16];
...
bool Function_18() //Position: 0x12BA / 4794
{
...
bool Function_19() //Position: 0x12D5 / 4821
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(bool bParam0) //Position: 0x1302 / 4866
{
...
var Function_21(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x132E / 4910
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_22(int iParam0) //Position: 0x134A / 4938
{
...
bool Function_23(int iParam0, int iParam1) //Position: 0x135F / 4959
{
...
bool Function_24(int iParam0, int iParam1) //Position: 0x1474 / 5236
{
	int iVar0;
...
bool Function_25(int iParam0) //Position: 0x15B8 / 5560
{
...
bool Function_26(int iParam0) //Position: 0x15DC / 5596
{
...
bool Function_27(int iParam0) //Position: 0x15F1 / 5617
{
...
var Function_28(int iParam0) //Position: 0x1608 / 5640
{
...
bool Function_29(int iParam0) //Position: 0x1622 / 5666
{
...
bool Function_30(int iParam0) //Position: 0x1638 / 5688
{
	return StackVal;
}

bool Function_31(var uParam0, int iParam1) //Position: 0x1648 / 5704
{
	int iVar0;
...
bool Function_32(int iParam0) //Position: 0x1664 / 5732
{
	if (!iParam0->f_152)
	{
		if (Function_18())
...
bool Function_33(int iParam0) //Position: 0x1708 / 5896
{
...
void Function_34(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1761 / 5985
{
	bool bVar0;
	char* cVar1[16];
...
void Function_35(char* cParam0, int iParam1) //Position: 0x17CD / 6093
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_36(bool bParam0, var uParam1, int iParam2) //Position: 0x1804 / 6148
{
	var uVar0;
	char* cVar1[16];
...
int Function_37(char* cParam0) //Position: 0x187C / 6268
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_38(int iParam0) //Position: 0x191D / 6429
{
	int iVar0;
	int iVar1;
...
void Function_39(int iParam0, int iParam1) //Position: 0x195A / 6490
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_40(var uParam0, int iParam1) //Position: 0x196D / 6509
{
...
bool Function_41(int iParam0) //Position: 0x1980 / 6528
{
	int iVar0;
...
bool Function_42(var uParam0, int iParam1) //Position: 0x199C / 6556
{
	int iVar0;
...
int Function_43(int iParam0) //Position: 0x19B8 / 6584
{
...
int Function_44(int iParam0) //Position: 0x19CD / 6605
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x19E2 / 6626
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x19EF / 6639
{
...
var Function_47(int iParam0, int iParam1) //Position: 0x1A6A / 6762
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_49(6, 0) && Function_184(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_49(9, 0) && Function_184(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
bool Function_48(vector3 vParam0) //Position: 0x265B / 9819
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_49(int iParam0, bool bParam1) //Position: 0x2673 / 9843
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x26B0 / 9904
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x26FF / 9983
{
...
int Function_52(int iParam0) //Position: 0x2715 / 10005
{
...
void Function_53() //Position: 0x277E / 10110
{
...
bool Function_54(int iParam0) //Position: 0x27A1 / 10145
{
	if (!Function_51(iParam0))
	{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x27F2 / 10226
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x281F / 10271
{
	if (!Function_51(iParam0))
	{
...
bool Function_57() //Position: 0x2871 / 10353
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_58(int iParam0) //Position: 0x287A / 10362
{
	int iVar0;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x28B4 / 10420
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2CE3 / 11491
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_61() //Position: 0x2E56 / 11862
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2E5C / 11868
{
	if (Global_3381)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2E9E / 11934
{
...
void Function_64() //Position: 0x2EEF / 12015
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2F41 / 12097
{
...
void Function_66() //Position: 0x3047 / 12359
{
	float fVar0;
...
void Function_67() //Position: 0x307A / 12410
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3208 / 12808
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x33BC / 13244
{
	Function_70(&Global_28260, 1, 0);
	return;
}

void Function_70(int iParam0, bool bParam1, var uParam2) //Position: 0x33CA / 13258
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x35BB / 13755
{
...
struct<8> Function_72(int iParam0) //Position: 0x35D0 / 13776
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x3911 / 14609
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_75(int iParam0) //Position: 0x3F3E / 16190
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3F4F / 16207
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0, bool bParam1) //Position: 0x4045 / 16453
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x405E / 16478
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x40C3 / 16579
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x40D5 / 16597
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x40E7 / 16615
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x4217 / 16919
{
	return Global_35278[iParam020].f_48;
}

float Function_83(int iParam0) //Position: 0x4226 / 16934
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x425F / 16991
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x429C / 17052
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x4436 / 17462
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x467A / 18042
{
...
struct<8> Function_88() //Position: 0x46BB / 18107
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x4744 / 18244
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x47DB / 18395
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x485A / 18522
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x4893 / 18579
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x4A9D / 19101
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_94(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x4B58 / 19288
{
	int iVar0;
...
vector3 Function_95() //Position: 0x4C3F / 19519
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_96(int iParam0) //Position: 0x4C48 / 19528
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x4C5E / 19550
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_98(vector3 vParam0, vector3 vParam3) //Position: 0x4D25 / 19749
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_99(var uParam0, int iParam1) //Position: 0x4D42 / 19778
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_100(int iParam0) //Position: 0x5567 / 21863
{
	var uVar0;
...
void Function_101(bool bParam0, bool bParam1) //Position: 0x55A2 / 21922
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x55AF / 21935
{
	uParam0 = uParam0;
...
void Function_103(int iParam0) //Position: 0x5653 / 22099
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_184(4) && !Function_107(0))
	{
	...
	if (!Function_31(&Global_3422[240] + 128, 2) || ((((((Function_184(14) && Function_184(18)) && Function_184(37)) && Function_184(7)) && Function_184(11)) && Function_184(5)) && Function_184(21)))
	{
	...
	if (!Function_31(&Global_3422[340] + 128, 2) || ((Function_184(27) && Function_184(1)) && Function_184(23)))
	{
	...
	if (!Function_184(7))
	{
		...
		if (((Function_184(6) && Function_104(Global_30735) < 0) && Function_104(Global_30737) < 0) && Function_104(Global_30738) < 0)
		{
...
int Function_104(int iParam0) //Position: 0x5F48 / 24392
{
	if (!Function_27(iParam0))
	{
		return 4294967295;
...
var Function_105() //Position: 0x5F62 / 24418
{
	return STRING_TO_HASH(Function_106());
}

var Function_106() //Position: 0x5F6E / 24430
{
	return "ZOMBIE_STORY";
}

bool Function_107(int iParam0) //Position: 0x5F83 / 24451
{
...
int Function_108(int iParam0) //Position: 0x5FE9 / 24553
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_109(char* cParam0) //Position: 0x60AB / 24747
{
...
void Function_110(char* cParam0, bool bParam1) //Position: 0x60F3 / 24819
{
	bool bVar0;
...
void Function_111() //Position: 0x6118 / 24856
{
	bool bVar0;
...
void Function_112(bool bParam0) //Position: 0x6176 / 24950
{
	PRINTSTRING("Day ");
...
int Function_113(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x61BC / 25020
{
	int iVar0;
	int iVar1;
...
void Function_114(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x63DC / 25564
{
	struct<4> Var0;
	int iVar4;
...
bool Function_115(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x6461 / 25697
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_116(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x650A / 25866
{
	if (!bParam15)
	{
...
void Function_117(bool bParam0) //Position: 0x6B1E / 27422
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_118() //Position: 0x6BCD / 27597
{
	bool bVar0;
...
void Function_119() //Position: 0x6C3F / 27711
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_120() //Position: 0x6C84 / 27780
{
...
void Function_121(bool bParam0) //Position: 0x6C96 / 27798
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_122(bool bParam0, bool bParam1) //Position: 0x6CB3 / 27827
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_123(bool bParam0) //Position: 0x6D33 / 27955
{
	int iVar0;
...
int Function_124(bool bParam0) //Position: 0x6D62 / 28002
{
	int iVar0;
	bool bVar1;
...
bool Function_125() //Position: 0x6E1A / 28186
{
	int iVar0;
	bool bVar1;
...
bool Function_126(int iParam0) //Position: 0x6E54 / 28244
{
	return iParam0->f_20;
}

void Function_127(var uParam0, int iParam1) //Position: 0x6E5E / 28254
{
	Function_128(uParam0, iParam1, 0);
	return;
}

void Function_128(var uParam0, bool bParam1, bool bParam2) //Position: 0x6E6C / 28268
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_129(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x6FB8 / 28600
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_130() //Position: 0x6FE1 / 28641
{
	bool bVar0;
	bool bVar1;
...
void Function_131() //Position: 0x702C / 28716
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_132() //Position: 0x714E / 29006
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_133() //Position: 0x715E / 29022
{
...
void Function_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x7188 / 29064
{
	bool bVar0;
...
void Function_135() //Position: 0x7278 / 29304
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_136() //Position: 0x728D / 29325
{
	vector3 vVar0;
	bool bVar3;
	
	vVar0 = { -2089.209f, 16.982f, 2602.014f };
	RESET_PROPS_IN_VOLUME(bLocal_272, 1);
	bVar3 = LOCATE_PHYSINST_OF_TYPE(vVar0, 2.0f, "p_gen_chair01x", 1);
	if (!IS_PHYSINST_VALID(bVar3))
	{
		bVar3 = GET_PHYSINST_FROM_OBJECT(CREATE_PROP_IN_LAYOUT(bLocal_266, "Marshal1_Chair", "p_gen_chair01x", vVar0, 0.0f, 34.5365f, 0.0f, 0));
	}
	if (IS_PHYSINST_VALID(bVar3))
	{
		bLocal_268 = LOCATE_GRINGO_OF_TYPE("sit_chr_dsk_wrk", &vVar0, 4.0f, 0);
	}
	MEMORY_CLEAR_WEAPON_DRAW_PREFERENCE(bLocal_267);
	ACTOR_HOLSTER_WEAPON(bLocal_267, 0);
	if (IS_GRINGO_VALID(bLocal_268))
	{
		AI_SET_NAV_PATHFINDING_ENABLED(bLocal_267, 0);
		TASK_USE_GRINGO(bLocal_267, bLocal_268, "UseCase1", 4294967295, 1);
		SNAP_ACTOR_TO_GRINGO(bLocal_267, GET_OBJECT_FROM_GRINGO(bLocal_268), "UseCase1", 1, 0, 0);
	}
...
int Function_137() //Position: 0x7400 / 29696
{
	if (!iLocal_277)
	{
		Function_138(-2089.776f, 16.309f, 2593.775f, bLocal_270);
		Function_121(1.0f);
		iLocal_277 = 1;
	}
	return 1;
...
void Function_138(vector3 vParam0) //Position: 0x742B / 29739
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_139(bool bParam0, bool bParam1) //Position: 0x75B1 / 30129
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_140(bool bParam0, float fParam1) //Position: 0x76A2 / 30370
{
...
void Function_141() //Position: 0x77A0 / 30624
{
...
void Function_142() //Position: 0x77D2 / 30674
{
...
int Function_143() //Position: 0x78CF / 30927
{
...
int Function_144() //Position: 0x78EA / 30954
{
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("COMPANION_Marshal", bLocal_267);
	...
	bLocal_270 = CREATE_VOLUME_IN_LAYOUT(bLocal_266, "Marshal4_CSVol", 2, -2085.967f, 19.627f, 2603.78f, 0.0f, 24.353f, 0.0f, 13.105f, 8.597f, 9.176f);
	Function_147(0, 0, 1, 1, 0, 1, 1, bLocal_270, 1, 1, 1, 1);
	Function_145(StackVal, StackVal, bLocal_266, *(&Global_63541[1855] + 112), &bLocal_270, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_145(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x79A1 / 31137
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_146(bool bParam0, bool bParam1) //Position: 0x7C0F / 31759
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_147(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x7C84 / 31876
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_148(int iParam0) //Position: 0x7F32 / 32562
{
	int iVar0;
...
var Function_149() //Position: 0x7F66 / 32614
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_150(bool bParam0) //Position: 0x7FE5 / 32741
{
	vector3 vVar0;
...
int Function_151(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x7FF6 / 32758
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_152(int iParam0, int iParam1) //Position: 0x820B / 33291
{
	var uVar0;
...
float Function_153(bool bParam0, bool bParam1) //Position: 0x8276 / 33398
{
	vector3 vVar0;
...
void Function_154(bool bParam0, bool bParam1) //Position: 0x8295 / 33429
{
	bool bVar0;
	bool bVar1;
...
bool Function_155(bool bParam0, bool bParam1, bool bParam2) //Position: 0x82F2 / 33522
{
...
bool Function_156() //Position: 0x83A8 / 33704
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_157(bool bParam0) //Position: 0x83BF / 33727
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_158(bool bParam0) //Position: 0x83CA / 33738
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_159(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) //Position: 0x83D8 / 33752
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
float Function_160(float fParam0) //Position: 0x8548 / 34120
{
...
int Function_161(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x857D / 34173
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_162() //Position: 0x87C3 / 34755
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
...
void Function_163(char* cParam0, vector3 vParam1) //Position: 0x8817 / 34839
{
	char* cVar0[64];
...
bool Function_164(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x893F / 35135
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_11(bParam0);
...
int Function_165() //Position: 0x89C9 / 35273
{
	if (IS_PS3())
	{
		return 1;
...
float Function_166(int iParam0) //Position: 0x89D8 / 35288
{
...
bool Function_167(int iParam0) //Position: 0x8AA0 / 35488
{
	return Function_45(*iParam0, 2);
}

bool Function_168(int iParam0) //Position: 0x8AAD / 35501
{
	return Function_45(*iParam0, 1);
}

void Function_169(int iParam0) //Position: 0x8ABA / 35514
{
	Function_170(iParam0, 0.0f);
	return;
}

void Function_170(var uParam0, float fParam1) //Position: 0x8AC6 / 35526
{
...
int Function_171(int iParam0) //Position: 0x8AE7 / 35559
{
	int iVar0;
	int iVar1;
...
void Function_172() //Position: 0x8E62 / 36450
{
	if (!Function_41(128))
	{
		return;
...
bool Function_173() //Position: 0x8EA2 / 36514
{
	int iVar0;
...
void Function_174(var uParam0, int iParam1) //Position: 0x8ECD / 36557
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_175(int iParam0, int iParam1) //Position: 0x8EDE / 36574
{
	int iVar0;
...
void Function_176() //Position: 0x8EFB / 36603
{
	if (!Function_41(128))
	{
		return;
...
void Function_177() //Position: 0x8F3D / 36669
{
	if (IS_LAYOUTREF_VALID(Global_30616))
	{
		GIVE_OBJECT_TO_LAYOUT(bLocal_271, Global_30616);
		GIVE_OBJECT_TO_LAYOUT(bLocal_267, Global_30616);
	}
	if (IS_LAYOUTREF_VALID(bLocal_266))
	{
		RELEASE_OBJECT_REF(bLocal_266);
	}
	AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
...
int Function_178(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8F86 / 36742
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_179(int iParam0) //Position: 0x8FB5 / 36789
{
	int iVar0;
...
void Function_180(var uParam0, int iParam1) //Position: 0x8FDB / 36827
{
...
void Function_181(var uParam0, int iParam1) //Position: 0x9109 / 37129
{
	int iVar0;
...
void Function_182(var uParam0, int iParam1) //Position: 0x9123 / 37155
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_183(int iParam0, bool bParam1) //Position: 0x9132 / 37170
{
	char* cVar0[32];
...
bool Function_184(int iParam0) //Position: 0x92B2 / 37554
{
...
void Function_185() //Position: 0x92C7 / 37575
{
	if (!Function_189(Global_30640[0]))
	{
		return;
	}
	if (!IS_DOOR_VALID(bLocal_269))
	{
		bLocal_269 = Function_187("narmadillo", "sheriff", 1);
	}
	if (IS_DOOR_VALID(bLocal_269))
	{
		SET_DOOR_LOCK_VISIBLE(bLocal_269, 0);
		if (!IS_DOOR_CLOSED(bLocal_269))
		{
			if (!IS_DOOR_CLOSING(bLocal_269))
			{
				CLOSE_DOOR_FAST(bLocal_269);
			}
		}
		if (!IS_DOOR_LOCKED(bLocal_269))
		{
			Function_186(bLocal_269, 1);
		}
	}
	return;
}

void Function_186(bool bParam0, bool bParam1) //Position: 0x933D / 37693
{
...
bool Function_187(var uParam0, var uParam1, int iParam2) //Position: 0x9391 / 37777
{
	return Function_188(Global_29006, uParam0, uParam1, iParam2);
}

int Function_188(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x93A3 / 37795
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_189(int iParam0) //Position: 0x943F / 37951
{
	if (!Function_13(iParam0))
	{
		return 1;
...
void Function_190(int iParam0) //Position: 0x945B / 37979
{
	if (!Function_168(iParam0))
	{
		Function_170(iParam0, 0.0f);
...
var Function_191(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x9470 / 38000
{
	int iVar0;
	int iVar1;
...
var Function_192(var uParam0, int iParam1, int iParam2) //Position: 0x94A8 / 38056
{
	int iVar0;
