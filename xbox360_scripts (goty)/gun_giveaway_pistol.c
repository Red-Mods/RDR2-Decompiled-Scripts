...
void Function_83(var uParam0, bool bParam1) //Position: 0x326D / 12909
{
	bool bVar0;
	...
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
	{
		...
		if (STRING_CONTAINS_STRING(bVar0, "high_power"))
		{
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32CF / 13007
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33D7 / 13271
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x33ED / 13293
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x36A3 / 13987
{
	bParam1 = bParam1;
	uParam0 = uParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
...
bool Function_88(bool bParam0) //Position: 0x36C6 / 14022
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x36DF / 14047
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x36F9 / 14073
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3731 / 14129
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3748 / 14152
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A11 / 14865
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A2E / 14894
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3ACA / 15050
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3AE9 / 15081
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AF8 / 15096
{
...
void Function_98(int iParam0) //Position: 0x3B14 / 15124
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B1E / 15134
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B80 / 15232
{
...
void Function_101(int iParam0) //Position: 0x3B94 / 15252
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B9E / 15262
{
