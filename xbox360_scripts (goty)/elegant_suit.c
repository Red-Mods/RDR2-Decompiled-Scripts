...
void Function_57(var uParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	...
	*iParam2 = 0;
	if ((Function_91(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	if (!Function_90(3, 1))
	{
		Function_58(3, 1, 1, 0, 0);
		*iParam2 = 1;
	}
	return;
}

void Function_58(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x2C60 / 11360
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_87(bParam0, 2))
	{
		...
		if (!bParam2)
		{
			...
			Function_83(&cVar8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_82(bParam0, bParam1))
	{
		...
		Function_76(bParam0);
		if (StackVal && !Function_45(((((!Function_75() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_45((((Function_75() || Global_3380) || Global_3392) || Global_3384), 1))
		{
		...
		if (!Function_47())
		{
			...
			{
				Function_69(Global_34573, 2, 1, 0);
			}
		}
...
void Function_59(int iParam0, bool bParam1) //Position: 0x2EF6 / 12022
{
	bool bVar0;
...
void Function_60(int iParam0, bool bParam1) //Position: 0x2F5D / 12125
{
...
void Function_61() //Position: 0x2FC8 / 12232
{
	if (Function_89(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_4 = Function_68(Global_28180);
...
var Function_62(int iParam0, int iParam1) //Position: 0x3043 / 12355
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_63(int iParam0) //Position: 0x3C34 / 15412
{
...
int Function_64(int iParam0, bool bParam1) //Position: 0x3C49 / 15433
{
	int iVar0;
...
bool Function_65(int iParam0) //Position: 0x3C86 / 15494
{
...
var Function_66(int iParam0) //Position: 0x3C9D / 15517
{
...
bool Function_67(int iParam0) //Position: 0x3CB7 / 15543
{
...
int Function_68(int iParam0) //Position: 0x3CCD / 15565
{
	int iVar0;
	int iVar1;
...
void Function_69(bool bParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3D1C / 15644
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_71(bParam0, uParam1, uParam2) && !bParam3)
	{
		return;
	}
...
void Function_70(char* cParam0, int iParam1) //Position: 0x3D88 / 15752
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_71(bool bParam0, var uParam1, int iParam2) //Position: 0x3DBF / 15807
{
	var uVar0;
	char* cVar1[16];
	...
	if (DECOR_CHECK_EXIST(bParam0, &cVar1))
	{
		if (Function_73(DECOR_GET_INT(bParam0, &cVar1)) > 3)
		{
			return 0;
		}
	}
...
int Function_72(char* cParam0) //Position: 0x3E37 / 15927
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_73(int iParam0) //Position: 0x3ED8 / 16088
{
	int iVar0;
	int iVar1;
...
bool Function_74(int iParam0, int iParam1) //Position: 0x3F15 / 16149
{
...
bool Function_75() //Position: 0x3F28 / 16168
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_76(bool bParam0) //Position: 0x3F55 / 16213
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (!IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 0) && !IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 1))
	{
		...
		while (bVar24 <= Global_27774[bParam013].f_28)
		{
			...
			if (Function_82(bParam0, Function_80(bVar24)))
			{
	...
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_79(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), 0, 0);
		Function_78(Global_27774[bParam013].f_48, 0);
		straddi(&cVar8, Function_77(bParam0), 32);
		SET_JOURNAL_ENTRY_CURRENT_OBJECTIVE(Global_27774[bParam013].f_48, &cVar8, 3);
	}
	return;
}

int Function_77(int iParam0) //Position: 0x4106 / 16646
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_78(var uParam0, int iParam1) //Position: 0x415D / 16733
{
	bool bVar0;
...
var Function_79(int iParam0) //Position: 0x4182 / 16770
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_80(bool bParam0) //Position: 0x41D8 / 16856
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_81() //Position: 0x41E4 / 16868
{
	return;
}

bool Function_82(bool bParam0, int iParam1) //Position: 0x41EA / 16874
{
	int iVar0;
...
void Function_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4249 / 16969
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_84(int iParam0) //Position: 0x42C4 / 17092
{
	char* cVar0[16];
...
void Function_85(int iParam0, int iParam1) //Position: 0x4303 / 17155
{
	if (!Function_89(iParam0))
	{
...
int Function_86(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x4358 / 17240
{
	int iVar0;
	int iVar1;
...
bool Function_87(int iParam0, int iParam1) //Position: 0x4578 / 17784
{
	int iVar0;
...
bool Function_88(int iParam0) //Position: 0x45A5 / 17829
{
...
bool Function_89(int iParam0) //Position: 0x45C1 / 17857
{
...
bool Function_90(int iParam0, int iParam1) //Position: 0x45D7 / 17879
{
	int iVar0;
...
int Function_91(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4636 / 17974
{
...
bool Function_92() //Position: 0x46EC / 18156
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_93(bool bParam0) //Position: 0x4703 / 18179
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_94(bool bParam0) //Position: 0x470E / 18190
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_95(bool bParam0) //Position: 0x471C / 18204
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_96(int iParam0, bool bParam1) //Position: 0x4736 / 18230
{
	bool bVar0;
	bool bVar1;
