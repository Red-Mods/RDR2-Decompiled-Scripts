			...
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					...
					case 0x00000001:
						...
						bLocal_255 = Function_139(StackVal, StackVal, *(&Global_63541[ScriptParam_055] + 112), 0x3f800000, 0x42960000, 1, 1, 0);
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (bLocal_255)
							{
								if (StackVal && FABS((StackVal - !Function_135(Global_34573, 1, 1))) > 2.0f)
								{
									if (Function_131(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0))
									{
					...
					case 0x00000003:
						if (Function_109(&iLocal_248, bLocal_256, "Cutscene description goes here.", 0x41200000))
						{
							iVar0 = 5;
						}
						break;
...
void Function_1() //Position: 0x236 / 566
{
	bool bVar0;
	int iVar1;
...
void Function_2(bool bParam0) //Position: 0x267 / 615
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_3(int iParam0, int iParam1) //Position: 0x409 / 1033
{
	float fVar0;
	bool bVar1;
...
void Function_4(int iParam0) //Position: 0x4C3 / 1219
{
	float fVar0;
	bool bVar1;
...
int Function_5(var uParam0, int iParam1) //Position: 0x565 / 1381
{
	int iVar0;
	var uVar1;
...
void Function_6(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x6C6 / 1734
{
	struct<8> Var0;
...
struct<32> Function_7(bool bParam0) //Position: 0x761 / 1889
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_8(char* cParam0, char* cParam1, char* cParam2) //Position: 0x7CB / 1995
{
	char* cVar0[32];
...
int Function_9(bool bParam0) //Position: 0x7EA / 2026
{
	int iVar0;
	vector3 vVar1;
...
float Function_10(bool bParam0, vector3 vParam1) //Position: 0x94B / 2379
{
	vector3 vVar0;
...
vector3 Function_11(bool bParam0) //Position: 0x9C5 / 2501
{
	vector3 vVar0;
...
void Function_12(int iParam0) //Position: 0xA2F / 2607
{
...
var Function_14() //Position: 0xAA6 / 2726
{
	int iVar0;
...
void Function_15(int iParam0, int iParam1) //Position: 0xAAE / 2734
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if ((((StackVal && Function_139(StackVal, Function_21(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_20(iParam1)) || Global_74542[iParam110].f_12 != 1) || Function_45(Global_63541[iParam155].f_144, 64))
	{
...
void Function_16(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0xF40 / 3904
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_17(int iParam0) //Position: 0xFBB / 4027
{
	char* cVar0[16];
...
bool Function_18() //Position: 0xFFA / 4090
{
...
bool Function_19() //Position: 0x1015 / 4117
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_20(int iParam0) //Position: 0x1042 / 4162
{
...
bool Function_21(int iParam0) //Position: 0x106E / 4206
{
...
bool Function_22(int iParam0, int iParam1) //Position: 0x1083 / 4227
{
...
bool Function_23(int iParam0, int iParam1) //Position: 0x1198 / 4504
{
	int iVar0;
...
bool Function_24(int iParam0) //Position: 0x12DC / 4828
{
...
bool Function_25(int iParam0) //Position: 0x1300 / 4864
{
...
bool Function_26(int iParam0) //Position: 0x1315 / 4885
{
...
var Function_27(int iParam0) //Position: 0x132C / 4908
{
...
bool Function_28(int iParam0) //Position: 0x1346 / 4934
{
...
bool Function_29(int iParam0) //Position: 0x135C / 4956
{
	return StackVal;
}

bool Function_30(var uParam0, int iParam1) //Position: 0x136C / 4972
{
	int iVar0;
...
bool Function_31(int iParam0) //Position: 0x1388 / 5000
{
	if (!iParam0->f_152)
	{
		if (Function_18())
...
bool Function_32(int iParam0) //Position: 0x142C / 5164
{
...
void Function_33(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x1485 / 5253
{
	bool bVar0;
	char* cVar1[16];
...
void Function_34(char* cParam0, int iParam1) //Position: 0x14F1 / 5361
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_35(bool bParam0, var uParam1, int iParam2) //Position: 0x1528 / 5416
{
	var uVar0;
	char* cVar1[16];
...
int Function_36(char* cParam0) //Position: 0x15A0 / 5536
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_37(int iParam0) //Position: 0x1641 / 5697
{
	int iVar0;
	int iVar1;
...
void Function_38(int iParam0, int iParam1) //Position: 0x167E / 5758
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_39(var uParam0, int iParam1) //Position: 0x1691 / 5777
{
...
bool Function_40(int iParam0) //Position: 0x16A4 / 5796
{
	int iVar0;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x16C0 / 5824
{
	int iVar0;
...
bool Function_43(int iParam0) //Position: 0x16F1 / 5873
{
...
int Function_44(int iParam0) //Position: 0x1706 / 5894
{
...
bool Function_45(var uParam0, bool bParam1) //Position: 0x171B / 5915
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x1728 / 5928
{
...
var Function_47(int iParam0, int iParam1) //Position: 0x17A3 / 6051
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_48(vector3 vParam0) //Position: 0x2394 / 9108
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_49(int iParam0, bool bParam1) //Position: 0x23AC / 9132
{
	int iVar0;
...
int Function_50(int iParam0) //Position: 0x23E9 / 9193
{
	int iVar0;
	int iVar1;
...
bool Function_51(int iParam0) //Position: 0x2438 / 9272
{
...
int Function_52(int iParam0) //Position: 0x244E / 9294
{
...
void Function_53() //Position: 0x24B7 / 9399
{
...
bool Function_55(int iParam0, int iParam1) //Position: 0x252B / 9515
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x2558 / 9560
{
	if (!Function_51(iParam0))
	{
...
bool Function_57() //Position: 0x25AA / 9642
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_58(bool bParam0) //Position: 0x25B3 / 9651
{
	int iVar0;
...
void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x25ED / 9709
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_38(&Global_63541[iParam055] + 144, 64);
	...
	if (IS_JOURNAL_ENTRY_IN_LIST(Global_63541[iParam055].f_140, 0))
	{
		Function_103(Global_63541[iParam055].f_140);
	}
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2B29 / 11049
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_61() //Position: 0x2C9C / 11420
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2CA2 / 11426
{
	if (Global_3381)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2CE4 / 11492
{
...
void Function_64() //Position: 0x2D35 / 11573
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2D87 / 11655
{
...
void Function_66() //Position: 0x2E8D / 11917
{
	float fVar0;
...
void Function_67() //Position: 0x2EC0 / 11968
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x3202 / 12802
{
	Function_70(&Global_28260, 1, 0);
	return;
}

void Function_70(int iParam0, bool bParam1, var uParam2) //Position: 0x3210 / 12816
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x3401 / 13313
{
...
struct<8> Function_72(int iParam0) //Position: 0x3416 / 13334
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x34BC / 13500
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x3757 / 14167
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_75(int iParam0) //Position: 0x3D84 / 15748
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3D95 / 15765
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0, bool bParam1) //Position: 0x3E8A / 16010
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3EA3 / 16035
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x3F08 / 16136
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x3F1A / 16154
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3F2C / 16172
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x405D / 16477
{
	return Global_35278[iParam020].f_48;
}

float Function_83(int iParam0) //Position: 0x406C / 16492
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x40A5 / 16549
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x40E2 / 16610
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x427C / 17020
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x44C0 / 17600
{
...
struct<8> Function_88() //Position: 0x4501 / 17665
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x458A / 17802
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x4621 / 17953
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x46A0 / 18080
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x46D9 / 18137
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x48E3 / 18659
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_94(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x499E / 18846
{
	int iVar0;
...
vector3 Function_95() //Position: 0x4A85 / 19077
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_96(int iParam0) //Position: 0x4A8E / 19086
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x4AA4 / 19108
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_98(vector3 vParam0, vector3 vParam3) //Position: 0x4B6B / 19307
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_99(var uParam0, int iParam1) //Position: 0x4B88 / 19336
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_100(int iParam0) //Position: 0x53AD / 21421
{
	var uVar0;
...
void Function_101(bool bParam0, bool bParam1) //Position: 0x53E8 / 21480
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x53F5 / 21493
{
	uParam0 = uParam0;
...
void Function_103(bool bParam0) //Position: 0x5499 / 21657
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 0x00000002:
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_45(Global_63541[iVar155].f_144, 2048))
				{
					...
					{
						Function_143(&Global_63541[iVar155] + 144, 64);
						Function_104(&(Global_63541[iVar155]), iVar3);
						if (IS_OBJECT_VALID(Global_63541[iVar155].f_192))
						{
							DESTROY_OBJECT(Global_63541[iVar155].f_192);
							Function_3(&(Global_63541[iVar155]), 7);
...
void Function_104(int iParam0, int iParam1) //Position: 0x563B / 22075
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if (((StackVal && Function_139(StackVal, Function_21(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_20(iParam1)) || Global_74542[iParam110].f_12 != 1)
	{
...
void Function_105() //Position: 0x5780 / 22400
{
	bool bVar0;
...
void Function_106(bool bParam0) //Position: 0x57DE / 22494
{
	PRINTSTRING("Day ");
...
int Function_107(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5824 / 22564
{
	int iVar0;
	int iVar1;
...
void Function_108(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x5A44 / 23108
{
	struct<4> Var0;
	int iVar4;
...
bool Function_109(int iParam0, var uParam1, var uParam2, float fParam3) //Position: 0x5AC9 / 23241
{
	if (*iParam0 == 1000 && (Function_130(6, 1, 0) || Function_129(6, 1, 0)))
	{
		HUD_CLEAR_HELP_QUEUE();
		*iParam0 = 1000;
		Function_128();
		Function_125(2, 0, 1, 1, 1, 1, 1, 1, 1, 1);
		return 1;
	}
	switch (*iParam0)
	{
		case 0x000003E8:
			...
			Function_118(1, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1, 1);
			Function_115(Global_34573, 0.0f, 1.0f, -1.0f, 0.0f, 1.7f, 0.0f, fParam3, 0, 0);
...
float Function_110(int iParam0) //Position: 0x5B9E / 23454
{
...
bool Function_111(int iParam0) //Position: 0x5C66 / 23654
{
	return Function_45(*iParam0, 2);
}

bool Function_112(int iParam0) //Position: 0x5C73 / 23667
{
	return Function_45(*iParam0, 1);
}

void Function_113(int iParam0) //Position: 0x5C80 / 23680
{
	Function_114(iParam0, 0.0f);
	return;
}

void Function_114(var uParam0, bool bParam1) //Position: 0x5C8C / 23692
{
...
void Function_115(bool bParam0, vector3 vParam1, vector3 vParam4, var uParam7, var uParam8, var uParam9) //Position: 0x5CAD / 23725
{
	Function_116(StackVal, StackVal, StackVal, StackVal, GET_OBJECT_FROM_ACTOR(bParam0), vParam1, vParam4, uParam7, uParam8, uParam9);
}

void Function_116(bool bParam0, vector3 vParam1, vector3 vParam4, float fParam7, bool bParam8, bool bParam9) //Position: 0x5CCB / 23755
{
	Function_117(GET_CAMERASHOT_FROM_CUTSCENEOBJECT(Global_63098, 0));
...
void Function_117(bool bParam0) //Position: 0x5DD0 / 24016
{
...
void Function_118(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x5DE1 / 24033
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_121(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_14(), 2, Function_121(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_119(int iParam0) //Position: 0x608F / 24719
{
	int iVar0;
...
var Function_120() //Position: 0x60C3 / 24771
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_121(bool bParam0) //Position: 0x6142 / 24898
{
	vector3 vVar0;
...
void Function_122() //Position: 0x6153 / 24915
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_123(bool bParam0, float fParam1, bool bParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) //Position: 0x6168 / 24936
{
	Function_124(0, 1);
	Global_63098 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, Function_14(), 2, 1);
...
void Function_124(bool bParam0, bool bParam1) //Position: 0x6241 / 25153
{
	if (bParam0)
	{
...
void Function_125(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9) //Position: 0x628D / 25229
{
	bool bVar0;
	...
	Function_126(iParam9);
}

void Function_126(bool bParam0) //Position: 0x637D / 25469
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
...
void Function_127() //Position: 0x642C / 25644
{
	bool bVar0;
...
void Function_128() //Position: 0x649E / 25758
{
	if (VMAG(*(&Global_63098 + 44)) < 0.0f)
	{
		ENABLE_GAME_CAMERA_FOCUS(*(&Global_63098 + 44), -1.0f, 6, 1, 1, 0);
...
int Function_129(bool bParam0, int iParam1, bool bParam2) //Position: 0x65B8 / 26040
{
	int iVar0;
	bool bVar1;
...
int Function_130(int iParam0, int iParam1, bool bParam2) //Position: 0x6635 / 26165
{
	int iVar0;
	bool bVar1;
...
bool Function_131(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x66B2 / 26290
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_134(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_133(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
			...
			if (bParam4 && IS_ACTOR_RIDING(bVar1))
			{
				...
				if (Function_133(bVar1, 0) < 12.0f)
				{
					vVar3 = { 0.0f, 0.0f, -4.0f };
					UNK_0xB89CC342(bVar1, &vVar3, &iVar6);
					Function_132(&iVar6, &vVar3);
				}
				else
				{
...
int Function_132(int iParam0, int iParam1) //Position: 0x68C4 / 26820
{
	var uVar0;
...
float Function_133(bool bParam0, bool bParam1) //Position: 0x692F / 26927
{
	vector3 vVar0;
...
void Function_134(bool bParam0, bool bParam1) //Position: 0x694E / 26958
{
	bool bVar0;
	bool bVar1;
...
bool Function_135(bool bParam0, bool bParam1, bool bParam2) //Position: 0x69AB / 27051
{
...
bool Function_136() //Position: 0x6A61 / 27233
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_137(bool bParam0) //Position: 0x6A78 / 27256
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_138(bool bParam0) //Position: 0x6A83 / 27267
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_139(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6A91 / 27281
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_140() //Position: 0x6AAD / 27309
{
	if (IS_LAYOUTREF_VALID(bLocal_256))
	{
...
int Function_141(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6AC9 / 27337
{
	if (bParam2)
	{
...
void Function_142(bool bParam0) //Position: 0x6AF8 / 27384
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_143(var uParam0, int iParam1) //Position: 0x6B15 / 27413
{
