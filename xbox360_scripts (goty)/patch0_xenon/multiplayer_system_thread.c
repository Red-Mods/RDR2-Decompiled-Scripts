...
bool Function_20(var uParam0, bool bParam1) //Position: 0x6F9 / 1785
{
...
bool Function_24(int iParam0, int iParam1, int iParam2) //Position: 0x76F / 1903
{
	var uVar0;
	bool bVar1;
...
void Function_26() //Position: 0x7FF / 2047
{
	...
	fVar0 = 0.0f;
	bVar1 = Function_48();
	iVar3 = GET_OBJECTSET_SIZE(bVar1);
				...
				if (DECOR_GET_INT_VERBOSE(bVar11, Function_46(), &uVar7))
				{
					...
					if (fVar4 - fVar0) <= Function_41(iVar5, iVar6)
					{
						...
						if (Function_38(StackVal, StackVal, Function_40(bVar11), &uVar9, 0) <= fVar14)
						{
							...
							PLAY_SIMPLE_PROP_ANIMATION(bVar15, "crateMultiplayer_close", 0, 0, 1065353216, 0);
...
void Function_27(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x96C / 2412
{
	...
	switch (iParam2)
	{
		case 0x00000001:
			if (bParam3)
			{
				fVar3 = ADD_BLIP_FOR_OBJECT(bParam0, 379, 0, 2, 0);
				fVar4 = ADD_BLIP_FOR_OBJECT(bParam1, 379, 0, 2, 0);
				if (DECOR_GET_INT_VERBOSE(bParam1, Function_43(), &uVar5))
				{
					Function_31(uVar5, &iVar6);
					SET_BLIP_NAME(fVar4, GET_WEAPON_DISPLAY_NAME(iVar6));
				}
			}
			if (bParam4)
			{
		...
		case 0x00000002:
			if (bParam3)
			{
				fVar3 = ADD_BLIP_FOR_OBJECT(bParam0, 380, 0, 2, 0);
				fVar4 = ADD_BLIP_FOR_OBJECT(bParam1, 380, 0, 2, 0);
			}
			if (bParam4)
			{
				Function_29();
		...
		case 0x00000005:
			if (bParam3)
			{
				fVar3 = ADD_BLIP_FOR_OBJECT(bParam0, 381, 0, 2, 0);
				fVar4 = ADD_BLIP_FOR_OBJECT(bParam1, 381, 0, 2, 0);
			}
			if (bParam4)
			{
				Function_28();
	...
	if (bParam3)
	{
		SET_BLIP_MAX_DISTANCE(fVar3, 1.0f);
		UNK_0x1E98AFEC(fVar3, 1);
		UNK_0xFF3DB575(fVar4, 1);
	}
}
...
var Function_32(var uParam0, int iParam1, int iParam2) //Position: 0xAED / 2797
{
	int iVar0;
...
int Function_34() //Position: 0xB18 / 2840
{
...
void Function_39(bool bParam0, int iParam1) //Position: 0xBF0 / 3056
{
				...
				if (bVar28)
				{
					if (Function_70(bLocal_70, 4194304, 1))
					{
						if (!Local_78[bLocal_7027].f_96)
						{
							...
							DECOR_SET_BOOL(bVar26, "NoMelee", 1);
						}
					}
	...
	if (Function_70(bParam0, 65536, 1))
	{
		if (!Local_78[bParam027].f_84)
		{
			...
			if (bParam0 != GET_LOCAL_SLOT())
			{
				...
				{
					PRINT_BIG_FORMAT(4.0f, "mp_needs_rez_big", Function_57(bParam0), 0, 0, 0, 2, 0);
...
void Function_56(char* cParam0, bool bParam1) //Position: 0x13F9 / 5113
{
	int iVar0;
...
var Function_58(var uParam0, int iParam1) //Position: 0x164D / 5709
{
...
struct<32> Function_69(char* cParam0, char* cParam1) //Position: 0x180D / 6157
{
	char* cVar0[32];
...
void Function_101(int iParam0) //Position: 0x2147 / 8519
{
	var uVar0;
...
void Function_114() //Position: 0x23F9 / 9209
{
	...
	iVar0 = CREATE_OBJECT_ITERATOR(FIND_NAMED_LAYOUT("Playerlayout"));
	ITERATE_ON_OBJECT_TYPE(iVar0, 15);
	ITERATE_IN_LAYOUT(iVar0, GET_GC_LAYOUT());
	...
	switch (GET_EVENT_TYPE(bParam0))
	{
		...
		case 0x00000001:
			if (((bVar13 && (bVar15 || iVar18)) && !bVar16) && !bVar29)
			{
				if (IS_ACTOR_ALIVE(bVar2))
				{
					uVar43 = GET_LAST_HIT_FLAGS(bVar2);
					if (!Function_98(uVar43, 65814))
					{
						Function_258();
					}
				}
		...
		case 0x00000002:
			if (DECOR_GET_INT_VERBOSE(bParam0, "Weapon", &iVar38))
			{
			}
			else
			{
				iVar38 = GET_LAST_HIT_WEAPON(bVar2);
				if (iVar38 == 4294967295)
				{
					iVar38 = GET_WEAPON_IN_HAND(bVar4);
				}
			}
			...
			if (bVar13)
			{
				...
				{
					Function_259(StackVal, StackVal, 1, vVar8, bVar24, iVar38, bVar22, bVar19, 0);
				}
			...
			else if (bVar16 || bVar17)
			{
				...
				if (bVar12)
				{
					if (bVar29)
					{
						Function_259(StackVal, StackVal, 2, vVar8, bVar23, iVar38, bVar22, bVar19, 0);
					}
					else
					{
						Function_259(StackVal, StackVal, 1, vVar8, bVar23, iVar38, bVar22, bVar19, bVar20);
					}
				}
				...
				{
					Function_259(StackVal, StackVal, 4, vVar8, bVar7, iVar38, bVar22, bVar19, 0);
				}
...
void Function_123(bool bParam0, bool bParam1, int iParam2) //Position: 0x33C6 / 13254
{
	struct<9> Var0;
	...
	{
		PLAYSTAT_INT("Killstreak", iParam2);
	}
	return;
}
...
void Function_124(float fParam0) //Position: 0x342C / 13356
{
	...
	{
		UI_ANIM_SETUP("XpComboTimer", 10.0f, 32, 0);
...
void Function_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x379D / 14237
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
int Function_137(int iParam0, int iParam1) //Position: 0x3F4F / 16207
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
{
	NET_LOG(true, "SaveLoad", "Multiplayer Save Triggered, will be picked up by Multiplayer_update_thread soon enough", false, 0, false, 0);
	Function_167(2);
	if (bParam0)
	{
		Function_167(1);
...
int Function_160(int iParam0) //Position: 0x53EB / 21483
{
	if (iParam0 == 4294967295)
	{
...
struct<16> Function_182(int iParam0) //Position: 0x6506 / 25862
{
	char* cVar0[16];
...
struct<16> Function_183(int iParam0) //Position: 0x6527 / 25895
{
	char* cVar0[16];
...
struct<16> Function_184(int iParam0) //Position: 0x6548 / 25928
{
	char* cVar0[16];
...
void Function_187(bool bParam0, int iParam1) //Position: 0x65B2 / 26034
{
	...
	if (!bVar0)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_190(bParam0), &Var7, 0, 2, 0);
		PREPEND_JOURNAL_ENTRY(Function_190(bParam0), 1);
...
int Function_190(bool bParam0) //Position: 0x6685 / 26245
{
...
void Function_198(bool bParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6) //Position: 0x6B4D / 27469
{
	...
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_190(bParam0), &cVar0, 2, 2, 1);
		Function_199(Function_190(bParam0), 0);
	}
}

void Function_199(int iParam0, int iParam1) //Position: 0x6C41 / 27713
{
	bool bVar0;
...
void Function_239(bool bParam0, vector3 vParam1, bool bParam4) //Position: 0x7CB3 / 31923
{
	...
	uVar0 = GET_LAST_HIT_FLAGS(bParam0);
	bVar1 = false;
	if (bParam4)
	{
	...
	if (Global_30842[46])
	{
		Function_240(uVar0, 4);
		PRINTNL();
	}
	if (DECOR_CHECK_EXIST(bParam0, "Drowned") || Function_98(uVar0, 8192))
	{
...
void Function_240(var uParam0, int iParam1) //Position: 0x7D94 / 32148
{
	bool bVar0;
	...
	while (bVar0 > 0)
	{
		if (Function_98(uParam0, Function_33(bVar0)))
		{
			PRINTINT(true);
		}
		else
...
void Function_244() //Position: 0x7F39 / 32569
{
	...
	if (StackVal <= 998)
	{
		...
		if (StackVal > 2)
		{
			...
			UI_ANIM_SETUP("XpComboSpin", 0.2f, 180, 0);
...
void Function_256(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5, bool bParam6) //Position: 0x85B7 / 34231
{
	...
	*uParam3 = 1.0f;
	...
	if (iParam5 != 5)
	{
		...
		CLEAR_JOURNAL_ENTRY(Function_190(iParam0));
		REMOVE_JOURNAL_ENTRY(Function_190(iParam0), 0);
...
void Function_258() //Position: 0x8982 / 35202
{
	...
	FLASH_SET_INT("mp_hud", "Reticle.Refresh", 1);
	FLASH_SET_INT("mp_hud", "Refresh", 1);
	return;
}

void Function_259(int iParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x89FA / 35322
{
	bool bVar0;
	bool bVar1;
	...
	Function_260(StackVal, StackVal, bVar0, bParam4, iParam0, vParam1, iParam5, bParam6, bParam7, bParam8);
}
...
void Function_275(int iParam0) //Position: 0x8EA5 / 36517
{
	...
	if (!iParam0 != "")
	{
		ITERATE_IN_SET(Global_26149, iParam0);
	}
	else
	{
	...
	if (Global_83864.f_1272)
	{
		...
		else
		{
			if (Function_217(&iLocal_511))
			{
				...
				if (iLocal_514 < 1)
				{
					iVar0 = Function_288(iLocal_521 + 1);
				}
				else
				{
					iVar0 = Function_288(Global_83864.f_1264 + 1);
				}
				UI_SET_TEXT("MPRewardItem.s1", iVar0);
...
void Function_283(bool bParam0, bool bParam1) //Position: 0x960B / 38411
{
	...
	if (IS_STRING_VALID(bParam1))
	{
		UI_SET_STRING_FORMAT("Generic_Dbuffer128_1", UI_GET_STRING(iParam0), UI_GET_STRING(bParam1), false, 0);
...
void Function_291(var uParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6) //Position: 0x99AB / 39339
{
	if (iParam6 != 0)
	{
...
void Function_295() //Position: 0x9C06 / 39942
{
	...
	switch (iLocal_518)
	{
		...
		case 0x00000001:
			...
			iVar2 = SHIFT_RIGHT(bVar1, 20);
			bVar1 = (bVar1 && 1023);
			Var5 = { StackVal, StackVal, StackVal, Function_184(iVar2) };
			bVar3 = DECOR_GET_INT(bVar0, &Var5);
			Var5 = { StackVal, StackVal, StackVal, Function_182(iVar2) };
			bLocal_520 = DECOR_GET_INT(bVar0, &Var5);
			Var5 = { StackVal, StackVal, StackVal, Function_183(iVar2) };
...
int Function_306(int iParam0) //Position: 0xA1CC / 41420
{
...
void Function_308(int iParam0, bool bParam1) //Position: 0xA225 / 41509
{
	...
	{
		PREPEND_JOURNAL_ENTRY(Function_306(iParam0), 0);
...
var Function_376(char* cParam0) //Position: 0xB4BC / 46268
{
	bool bVar0;
...
void Function_379(int iParam0) //Position: 0xB542 / 46402
{
	struct<5> Var0;
	struct<8> Var5;
...
void Function_383(int iParam0) //Position: 0xB684 / 46724
{
	struct<5> Var0;
	int iVar5;
	var uVar6;
...
void Function_384(int iParam0) //Position: 0xB6D9 / 46809
{
	var uVar0;
...
void Function_385(int iParam0) //Position: 0xB6E8 / 46824
{
	struct<9> Var0;
...
void Function_388(int iParam0) //Position: 0xB83F / 47167
{
	struct<33> Var0;
	bool bVar33;
	int iVar34;
...
struct<32> Function_389(bool bParam0, bool bParam1, bool bParam2) //Position: 0xC22A / 49706
{
	...
	if (bParam2)
	{
		UI_SET_STRING_FORMAT(&cVar0, UI_GET_STRING(bVar8), "<0xAA3311>WWWWWWWWWWWWWWWW</0x>", false, 0);
	}
	else
	{
		UI_SET_STRING_FORMAT(&cVar0, UI_GET_STRING(bVar8), UI_GET_STRING(Function_57(bParam0)), false, 0);
	}
	return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, cVar0;
}
...
struct<32> Function_390(bool bParam0, int iParam1, bool bParam2) //Position: 0xC2D1 / 49873
{
	...
	if (bParam2)
	{
		UI_SET_STRING_FORMAT(&cVar0, UI_GET_STRING(bVar8), Function_95(bParam0, 1), "WWWWWWWWWWWWWWWW", 0);
	}
	else
	{
		UI_SET_STRING_FORMAT(&cVar0, UI_GET_STRING(bVar8), Function_95(bParam0, 1), GET_SLOT_NAME(bParam0), 0);
	}
	return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, cVar0;
}
...
void Function_401(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7) //Position: 0xC7ED / 51181
{
	PLAYSTAT_STRING("Kill", iParam3);
	PLAYSTAT_STRING("nKill_meth", iParam7);
...
void Function_408(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0xD1B3 / 53683
{
	...
	if (bParam2)
	{
		if (((iParam0 != 12 || iParam0 != 13) || iParam0 != 10) || iParam0 != 11)
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_306(iParam0), &cVar0, 2, 2, 0);
		...
		else
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_306(iParam0), &cVar20, 2, 2, 1);
			Function_199(Function_306(iParam0), 0);
		}
	}
}
...
void Function_416(int iParam0) //Position: 0xD6C8 / 54984
{
	...
	UI_SET_STRING(&Var0, UI_GET_STRING(&Var6));
	Var6 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_309(iParam0) };
	APPEND_JOURNAL_ENTRY_DETAIL(Function_306(iParam0), &Var6, 0, 2, 0);
	PREPEND_JOURNAL_ENTRY(Function_306(iParam0), 1);
...
void Function_419(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, float fParam8, bool bParam9, float fParam10, int iParam11, var uParam12) //Position: 0xD793 / 55187
{
	if (Global_83864.f_1264 > iParam2)
	{
		...
		if (StackVal == 10)
		{
			SET_WEAPON_GOLD(Function_116(), iParam1, 1);
			Global_83823[iParam1] = 1;
	...
	if (bParam0 == GET_LOCAL_SLOT())
	{
		...
		switch (iVar0)
		{
			case 0x00000003:
				...
				Function_123(bParam0, bParam1, iVar0);
				break;
...
void Function_460(int iParam0) //Position: 0xFB86 / 64390
{
	struct<69> Var0;
...
void Function_461(bool bParam0, bool bParam1, bool bParam2) //Position: 0xFBC1 / 64449
{
	...
	if (!IS_OBJECT_IN_OBJECTSET(bParam0, Function_48()))
	{
		...
		uVar1 = GET_BLIP_ON_OBJECT(bVar0);
		if (IS_BLIP_VALID(uVar1))
		{
			REMOVE_BLIP(uVar1);
		}
		uVar1 = GET_BLIP_ON_OBJECT(bParam0);
		if (IS_BLIP_VALID(uVar1))
		{
			REMOVE_BLIP(uVar1);
		}
...
void Function_465(int iParam0) //Position: 0xFCFD / 64765
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_469(int iParam0, int iParam1) //Position: 0xFE4D / 65101
{
	bool bVar0;
...
void Function_476(int iParam0) //Position: 0xFF48 / 65352
{
	struct<5> Var0;
...
void Function_477(int iParam0) //Position: 0xFF77 / 65399
{
	var uVar0[2];
...
void Function_478(int iParam0) //Position: 0x1001A / 65562
{
	var uVar0[2];
	bool bVar3;
...
void Function_479(int iParam0) //Position: 0x101B8 / 65976
{
	bool bVar0;
