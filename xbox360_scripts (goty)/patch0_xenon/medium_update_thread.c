...
int Function_5() //Position: 0x20B / 523
{
	...
	iVar18 = GET_OBJECTSET_SIZE(Global_16516);
	bVar6 = false;
	while (bVar6 < (iVar18 - 1))
	{
		iVar7 = 0;
						...
						else
						{
							...
							switch (iVar9)
							{
								...
								case 0x00000001:
									...
									{
										TASK_CLEAR(bVar13);
										TASK_WANDER_IN_VOLUME(bVar13, GET_VOLUME_FROM_OBJECT(bVar11), 3212836864);
										TASK_PRIORITY_SET(bVar13, 2);
									}
									else
									{
										TASK_CLEAR(bVar13);
										TASK_WANDER(bVar13, -1f);
										TASK_PRIORITY_SET(bVar13, 2);
									}
	...
	{
		iVar18 = GET_OBJECTSET_SIZE(bVar10);
		bVar6 = false;
		while (bVar6 < (iVar18 - 1))
		{
...
bool Function_10(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x99F / 2463
{
...
void Function_16(bool bParam0, bool bParam1, int iParam2, float fParam3, int iParam4) //Position: 0xB65 / 2917
{
	var uVar0;
	var uVar3;
	var uVar6;
...
struct<24> Function_50(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, int iParam7) //Position: 0x17F4 / 6132
{
	bool bVar0;
	struct<13> Var1;
	float fVar19;
	...
	if (iParam7 < 1 && fParam4 < 1.0f)
	{
		...
		return StackVal, StackVal, StackVal, StackVal, StackVal, Function_50(StackVal, StackVal, uParam0, vParam1, (fParam4 / 10.0f), Function_52(Var7.f_12, Var1.f_12), Function_51(Var7.f_12, Var1.f_12), (iParam7 - 1));
	}
...
int Function_69() //Position: 0x1F89 / 8073
{
	...
	{
		iVar9 = GET_ACTOR_ENUM(Global_34573);
		if (iVar9 != 0 && ((Global_28179 != 10 || Global_28179 != 9) || Global_28179 != 12))
		{
		...
		else
		{
			...
			{
				STREAMING_REQUEST_ACTOR(iVar9, SHIFT_LEFT(true, Global_27774[Global_2817913].f_20), false);
				STREAMING_EVICT_ACTOR(iVar9, SHIFT_LEFT(true, Global_27774[Global_2817813].f_20));
			...
			{
				if (STREAMING_IS_ACTOR_LOADED(iVar9, 4294967295))
				{
	...
	if (Function_2(0x1000000))
	{
		...
		{
			STREAMING_REQUEST_ACTOR(1, SHIFT_LEFT(true, Global_27774[Global_2817913].f_20), false);
		...
		if (HUD_IS_FADED() && STREAMING_IS_ACTOR_LOADED(1, 4294967295))
		{
...
void Function_102(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x3881 / 14465
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
	...
	if (!Global_49306)
	{
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				{
					fVar19 = (Function_112(iParam0) - fParam2);
					fVar20 = fParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_110(iParam0, fVar19, fVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_107(fVar19, fParam2, &iVar17, &iVar18);
...
struct<32> Function_106(char* cParam0, char* cParam1) //Position: 0x3FBC / 16316
{
	char* cVar0[32];
...
var Function_109(int iParam0, int iParam1) //Position: 0x404F / 16463
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
float Function_112(int iParam0) //Position: 0x41A0 / 16800
{
	if (!iParam0 != 4294967295)
	{
...
int Function_115(int iParam0, float fParam1, bool bParam2) //Position: 0x43B0 / 17328
{
	int iVar0;
	int iVar1;
...
int Function_116(int iParam0) //Position: 0x45F4 / 17908
{
	if (iParam0 == 4294967295)
	{
...
int Function_121(int iParam0, float fParam1, int iParam2) //Position: 0x480D / 18445
{
	int iVar0;
	int iVar1;
	...
	Function_115(iParam0, fParam1, 1);
	Function_114(iParam0);
	if (iParam2 && fParam1 == 0.0f)
	{
		Function_102(iParam0, 1, fParam1, 0, 1, 0x40400000, 0, 0);
	}
	if (Global_35278[iParam020].f_48 == 2)
	{
		iVar1 = 0;
...
void Function_130(bool bParam0, int iParam1) //Position: 0x550E / 21774
{
...
void Function_142(int iParam0) //Position: 0x5F74 / 24436
{
	...
	iVar3 = GET_WEAPON_EQUIPPED(bVar0, 6);
	if (iVar3 == 4294967295)
	{
		if (GET_ITEM_IN_HAND_EQUIPSLOT(bVar0) == 6)
		{
			iVar3 = GET_WEAPON_IN_HAND(bVar0);
		}
	}
	...
	if (!Function_144(1))
	{
		...
		while (iVar1 <= 7)
		{
			ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1, 0);
			iVar1++;
		}
	}
	else if (bVar2 != 4294967295)
	{
		...
		if (bVar7 == Global_12976.f_84 || bVar5 == Global_12976.f_88)
		{
			...
			while (iVar1 <= 7)
			{
				...
				{
					ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1, 1);
				}
				else
				{
					ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1, 0);
	...
	while (iVar1 <= 10)
	{
		ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1 + 7, 0);
		iVar1++;
	}
	if (bVar4 != 4294967295)
	{
		...
		if (bVar8 == Global_12976.f_92 || bVar6 == Global_12976.f_96)
		{
			...
			while (iVar1 <= 5)
			{
				...
				{
					ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1 + 17, 1);
				}
				else
				{
					ACTOR_ENABLE_VARIABLE_MESH(bVar0, iVar1 + 17, 0);
				}
				iVar1++;
			}
		}
...
void Function_174(int iParam0, int iParam1) //Position: 0x7DDD / 32221
{
	bool bVar0;
...
int Function_203(int iParam0, float fParam1, bool bParam2) //Position: 0xAA75 / 43637
{
	int iVar0;
	...
	{
		Function_115(iParam0, fParam1, 0);
	}
	Global_34581[iParam0] = fParam1;
	Function_114(iParam0);
	if (bParam2)
	{
		Function_102(iParam0, 1, fParam1, 0, 0, 0x40400000, 0, 0);
	}
	return 1;
}
...
void Function_239(float fParam0) //Position: 0x111A3 / 70051
{
	if (fParam0 < 0.0f)
	{
...
var Function_250(int iParam0) //Position: 0x114D0 / 70864
{
	bool bVar0;
	int iVar1;
...
bool Function_251(int iParam0, bool bParam1, float fParam2, var uParam3) //Position: 0x11516 / 70934
{
	int iVar0;
	bool bVar1;
...
void Function_282() //Position: 0x12C5D / 76893
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Local_38.f_24, &Var0, 0, 2, 0);
	PREPEND_JOURNAL_ENTRY(Local_38.f_24, 1);
...
void Function_291(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, bool bParam10) //Position: 0x1379F / 79775
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
void Function_298(int iParam0, bool bParam1) //Position: 0x13B10 / 80656
{
	...
	if (!Global_49306)
	{
		SET_STAT_MESSAGE(STRING_TO_HASH(bParam1), UI_GET_STRING(&cVar0), 3.0f, "", 0, 4294967295, 0, 0, 0, 0, 0, 0, 0);
	}
	return;
}
...
void Function_304() //Position: 0x13D5D / 81245
{
	...
	CLEAR_JOURNAL_ENTRY(Local_38.f_24);
	PREPEND_JOURNAL_ENTRY(Local_38.f_24, 0);
...
void Function_315() //Position: 0x147EB / 83947
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Local_16.f_24, &Var0, 0, 2, 0);
	PREPEND_JOURNAL_ENTRY(Local_16.f_24, 1);
...
void Function_317() //Position: 0x14865 / 84069
{
	...
	CLEAR_JOURNAL_ENTRY(Local_16.f_24);
	PREPEND_JOURNAL_ENTRY(Local_16.f_24, 0);
...
void Function_321(bool bParam0) //Position: 0x1500C / 86028
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_325(bParam0), &Var6, 0, 2, 0);
	PREPEND_JOURNAL_ENTRY(Function_325(bParam0), 1);
...
int Function_325(bool bParam0) //Position: 0x151BA / 86458
{
	if (Function_1() || Global_34165.f_44)
	{
...
void Function_326(bool bParam0, bool bParam1) //Position: 0x151E2 / 86498
{
	...
	{
		PREPEND_JOURNAL_ENTRY(Function_325(bParam0), 0);
		Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_324(bParam0) };
		Var6 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_323(bParam0) };
		UI_SET_STRING(&Var0, UI_GET_STRING(&Var6));
		Var6 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_322(bParam0) };
	...
	switch (*uParam1)
	{
		case 0x00000000:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					...
					fVar0 = (Function_112(272) - Function_336(2, 1, 1));
					if (fVar0 <= 6.0f)
					{
						Function_333(2, 1);
						*uParam0 = 2;
					...
					else
					{
						...
						*uParam2 = (fVar0 / 6.0f);
						if (*uParam2 == fVar4)
						{
							Function_335(2, *uParam2, 1, ROUND(fVar0), 4294967295, 4294967295, 0);
						}
					}
					break;
		...
		case 0x00000001:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(264) - Function_336(2, 1, 1));
					if (fVar0 <= 6.0f)
					{
						Function_333(2, 2);
						*uParam0 = 2;
		...
		case 0x00000002:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(271) - Function_336(2, 1, 1));
					if (fVar0 <= 4.0f)
					{
						Function_333(2, 3);
						*uParam0 = 2;
		...
		case 0x00000003:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(263) - Function_336(2, 1, 1));
					if (fVar0 <= 8.0f)
					{
						Function_333(2, 4);
						*uParam0 = 2;
		...
		case 0x00000004:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(268) - Function_336(2, 1, 1));
					if (fVar0 <= 7.0f)
					{
						Function_333(2, 5);
						*uParam0 = 2;
		...
		case 0x00000005:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(265) - Function_336(2, 1, 1));
					if (fVar0 <= 8.0f)
					{
						Function_333(2, 6);
						*uParam0 = 2;
		...
		case 0x00000006:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(269) - Function_336(2, 1, 1));
					if (fVar0 <= 10.0f)
					{
						Function_333(2, 7);
						*uParam0 = 2;
		...
		case 0x00000007:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(266) - Function_336(2, 1, 1));
					if (fVar0 <= 12.0f)
					{
						Function_333(2, 8);
						*uParam0 = 2;
		...
		case 0x00000008:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(2);
					fVar0 = (Function_112(267) - Function_336(2, 1, 1));
					if (fVar0 <= 15.0f)
					{
						Function_333(2, 9);
						*uParam0 = 2;
		...
		case 0x00000009:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					...
					while (iVar5 <= 273)
					{
						fVar2 = Function_112(iVar5);
						fVar3 = Function_336(2, bVar6, 1);
						if (iVar5 == 270)
						{
							if ((fVar2 - fVar3) < 0.0f)
							{
								if ((fVar2 - fVar3) <= 10.0f)
								{
									fVar1 = (fVar1 + 10.0f);
									fVar0 = (fVar0 + 1.0f);
								}
					...
					else
					{
						*uParam2 = (fVar1 / 28.0f);
						if (*uParam2 == fVar4)
						{
							...
							UI_SET_STRING(&cVar11, INT_TO_STRING(ROUND(fVar0)));
...
void Function_335(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x16368 / 90984
{
	...
	if (bParam2)
	{
		if (((iParam0 != 12 || iParam0 != 13) || iParam0 != 10) || iParam0 != 11)
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_325(iParam0), &cVar0, 2, 2, 0);
		...
		else
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_325(iParam0), &cVar20, 2, 2, 1);
			Function_174(Function_325(iParam0), 0);
		}
	}
}
...
int Function_338(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x165DD / 91613
{
	...
	if (bParam3)
	{
		if (Function_1() || Global_34165.f_44)
		{
			(*&Global_49399[bParam022] + 36)[bParam1] = fParam2;
		}
		else
		{
			(*&Global_49310[bParam022] + 36)[bParam1] = fParam2;
		}
		return 1;
	}
	strcpy(&cVar0, INT_TO_STRING(bParam0), 16);
	...
	if (IS_LAYOUTREF_VALID(bVar4))
	{
		return DECOR_SET_FLOAT(bVar4, &cVar0, fParam2);
	}
				...
				case 0x00000001:
					...
					else
					{
						if (bVar1 > 1)
						{
							...
							{
								Function_327(1, 8);
								APPEND_JOURNAL_ENTRY_DETAIL(Function_325(1), "AM_MH_7_info", 0, 2, 1);
								bVar1 = true;
							}
						}
						*uParam2 = TO_FLOAT(bVar1);
						...
						if (bVar1 > 1)
						{
							...
							{
								Function_327(1, 16);
								APPEND_JOURNAL_ENTRY_DETAIL(Function_325(1), "AM_MH_7_info2", 0, 2, 1);
								bVar1 = true;
							}
						}
				...
				case 0x00000001:
					...
					else
					{
						...
						if (bVar1 > 1)
						{
							...
							{
								Function_327(1, 8);
								APPEND_JOURNAL_ENTRY_DETAIL(Function_325(1), "AM_MH_9_info", 0, 2, 1);
								bVar1 = true;
							}
						}
						*uParam2 = TO_FLOAT(bVar1);
						...
						if (bVar1 > 1)
						{
							...
							{
								Function_327(1, 16);
								APPEND_JOURNAL_ENTRY_DETAIL(Function_325(1), "AM_MH_9_info2", 0, 2, 1);
								bVar1 = true;
							}
						}
						*uParam2 = (*uParam2 + TO_FLOAT(bVar1));
						...
						if (bVar1 > 1)
						{
							...
							{
								Function_327(1, 32);
								APPEND_JOURNAL_ENTRY_DETAIL(Function_325(1), "AM_MH_9_info3", 0, 2, 1);
								bVar1 = true;
							}
						}
						*uParam2 = (*uParam2 + TO_FLOAT(bVar1));
		...
		if (!IS_OBJECT_IN_OBJECTSET(bVar2, *uParam2))
		{
			if (GET_EVENT_TYPE(GET_EVENT_FROM_OBJECT(bVar2)) == iParam0)
			{
				...
				if (IS_ACTOR_LOCAL_PLAYER(GET_ACTOR_FROM_OBJECT(bVar3)))
				{
					...
					if (IS_ACTOR_VALID(GET_ACTOR_FROM_OBJECT(bVar4)))
					{
						iVar5 = GET_ACTOR_ENUM(GET_ACTOR_FROM_OBJECT(bVar4));
						if (iVar5 == iParam1)
						{
							if (DECOR_CHECK_EXIST(bVar2, "AM_NO_PURGE"))
							{
							...
							if (IS_OBJECT_VALID(bVar3))
							{
								...
								else if (IS_OBJECT_VALID(GET_EVENT_TARGET_AS_OBJECT(GET_EVENT_FROM_OBJECT(bVar3))))
								{
									...
									if (IS_ACTOR_VALID(bVar5))
									{
										...
										{
											DECOR_SET_BOOL(bVar5, "bearWounded", 1);
											Function_343(uParam3, &bVar3);
											iVar0 = (iVar0 - 1);
										}
...
bool Function_347() //Position: 0x189FC / 100860
{
	...
	if (bVar0 == 4294967295)
	{
		if (iVar2 != 4294967295)
		{
			bVar4 = FLOOR(ACTOR_GET_WEAPON_AMMO(Global_34573, iVar2));
			if (bVar4 >= iVar3)
			{
				Function_330(0, 1, (SHIFT_LEFT(bVar4, 8) || iVar2));
				return 1;
			}
		}
		return 0;
...
int Function_348(bool bParam0, bool bParam1, float fParam2, bool bParam3) //Position: 0x18AE2 / 101090
{
	...
	if (IS_LAYOUTREF_VALID(bVar5))
	{
		...
		{
			fVar4 = DECOR_GET_FLOAT(bVar5, &cVar0);
			fVar4 = (fVar4 + fParam2);
			return DECOR_SET_FLOAT(bVar5, &cVar0, fVar4);
		}
	}
	LOG_ERROR("AM_RETRIEVE_FLOAT: failed to retrieve float value from slot");
	return 0;
...
void Function_355(var uParam0, int iParam1, var uParam2, float fParam3, int iParam4, float fParam5, int iParam6, float fParam7, bool bParam8, int iParam9) //Position: 0x19348 / 103240
{
	switch (StackVal)
	{
		case 0x00000000:
			switch (StackVal)
			{
				...
				case 0x00000002:
					Function_368(uParam0, 1, fParam3, bParam8, 4294967295, 0);
					break;
			}
			break;
		...
		case 0x00000001:
			switch (StackVal)
			{
				...
				case 0x00000002:
					Function_368(uParam0, 2, fParam5, bParam8, 4294967295, 0);
					break;
			}
			break;
		...
		case 0x00000002:
			switch (StackVal)
			{
				...
				case 0x00000002:
					Function_356(uParam0, fParam7, iParam9, 0);
					break;
			}
			break;
	}
...
void Function_356(var uParam0, float fParam1, int iParam2, bool bParam3) //Position: 0x19434 / 103476
{
	...
	Function_359(&Global_49399[*uParam022] + 16, CEIL(fParam1), bParam3);
...
void Function_368(var uParam0, int iParam1, float fParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x196A2 / 104098
{
	bool bVar0;
	...
	Function_359(&bVar0, CEIL(fParam2), bParam5);
	uParam0->f_8 = iParam1;
	uParam0->f_4 = 0;
	uParam0->f_12 = 0.0f;
...
void Function_369(var uParam0, int iParam1, int iParam2) //Position: 0x19704 / 104196
{
	...
	Function_96();
	fVar0 = Function_370((Function_112(iParam1) - Function_336(*uParam0, 1, 0)), *uParam0, 1);
	if (fVar0 <= IntToFloat(iParam2))
	{
		uParam0->f_4 = 2;
	}
	else
	{
		iVar1 = Function_325(*uParam0);
		fVar2 = (fVar0 / IntToFloat(iParam2));
		if (fVar2 < GET_JOURNAL_ENTRY_PROGRESS(iVar1))
		{
			SET_JOURNAL_ENTRY_PROGRESS(iVar1, fVar2, Function_328(*uParam0, 4), 0);
		}
	}
	return;
}

float Function_370(float fParam0, int iParam1, bool bParam2) //Position: 0x1975F / 104287
{
	if (Function_1() || Global_34165.f_44)
	{
...
void Function_374(var uParam0, float fParam1, bool bParam2) //Position: 0x19C2F / 105519
{
	Function_332(*uParam0, 1);
	uParam0->f_8 = 10;
	uParam0->f_4 = 2;
	...
	Function_359(&Global_49399[*uParam022] + 16, CEIL(fParam1), bParam2);
	Function_276();
	return;
}
...
void Function_380(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x19F6C / 106348
{
	bool bVar0;
	...
	memcpy(&bVar0, StackVal, StackVal, StackVal, StackVal, StackVal, Function_323(*uParam0), 4);
	Function_359(&bVar0, CEIL(fParam2), bParam4);
	uParam0->f_8 = iParam1;
	uParam0->f_4 = 0;
	uParam0->f_12 = 0.0f;
...
void Function_405(var uParam0, var uParam1, var uParam2, bool bParam3, float fParam4, bool bParam5, var uParam6, bool bParam7, var uParam8, int iParam9, var uParam10) //Position: 0x1ACAF / 109743
{
	switch (StackVal)
	{
		case 0x00000000:
		...
		case 0x00000001:
			switch (StackVal)
			{
				...
				case 0x00000002:
					Function_368(uParam0, 2, fParam4, bParam7, iParam9, Function_406());
					break;
			}
			break;
...
void Function_411(var uParam0, bool bParam1) //Position: 0x1AEE9 / 110313
{
	...
	{
		iVar0 = Function_325(*uParam0);
		fVar1 = (TO_FLOAT(Function_410()) / TO_FLOAT(bParam1));
		if (fVar1 == GET_JOURNAL_ENTRY_PROGRESS(iVar0))
		{
			SET_JOURNAL_ENTRY_PROGRESS(iVar0, fVar1, false, 0);
		}
	}
	return;
}
...
void Function_412(var uParam0, bool bParam1) //Position: 0x1AF29 / 110377
{
	...
	if (bVar0 <= bParam1)
	{
		...
		else
		{
			...
			if (fVar2 == GET_JOURNAL_ENTRY_PROGRESS(iVar1))
			{
				SET_JOURNAL_ENTRY_PROGRESS(iVar1, fVar2, false, 0);
			}
		}
	}
	return;
...
void Function_414(var uParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5, bool bParam6) //Position: 0x1B8F5 / 112885
{
	bool bVar0;
	...
	*uParam3 = 2;
	...
	Function_359(&bVar0, CEIL(fParam5), bParam6);
...
void Function_417(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4, int iParam5, int iParam6, float fParam7, bool bParam8) //Position: 0x1B9B9 / 113081
{
	var uVar0;
	...
	Function_359(&uVar0, CEIL(fParam7), bParam8);
	*uParam2 = iParam3;
	*uParam4 = iParam5;
	...
	switch (*uParam1)
	{
		case 0x00000000:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					...
					fVar0 = Function_370((Function_112(265) - Function_336(6, 1, 0)), 6, 1);
					if (fVar0 <= 8.0f)
					{
						*uParam0 = 2;
					}
					else
					{
						*uParam2 = (fVar0 / 8.0f);
						if (*uParam2 == fVar6)
						{
							Function_335(6, *uParam2, 1, ROUND(fVar0), 4294967295, 4294967295, 21);
						}
					}
					break;
		...
		case 0x00000001:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar6 = Function_337(6);
					fVar0 = Function_370((Function_112(269) - Function_336(6, 1, 0)), 6, 1);
					if (fVar0 <= 10.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000002:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar6 = Function_337(6);
					fVar0 = Function_370((Function_112(266) - Function_336(6, 1, 0)), 6, 1);
					if (fVar0 <= 12.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000003:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar6 = Function_337(6);
					fVar0 = Function_370((Function_112(267) - Function_336(6, 1, 0)), 6, 1);
					if (fVar0 <= 15.0f)
					{
						*uParam0 = 2;
					}
					...
					else
					{
						*uParam2 = (fVar3 / 28.0f);
						if (*uParam2 == fVar6)
						{
							...
							UI_SET_STRING(&cVar13, INT_TO_STRING(ROUND(fVar0)));
	...
	switch (*uParam1)
	{
		case 0x00000000:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					...
					fVar0 = Function_370((Function_112(272) - Function_336(2, 1, 0)), 2, 1);
					if (fVar0 <= 6.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000001:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar1 = Function_337(2);
					fVar0 = Function_370((Function_112(264) - Function_336(2, 1, 0)), 2, 1);
					if (fVar0 <= 6.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000002:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar1 = Function_337(2);
					fVar0 = Function_370((Function_112(271) - Function_336(2, 1, 0)), 2, 1);
					if (fVar0 <= 4.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000003:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar1 = Function_337(2);
					fVar0 = Function_370((Function_112(263) - Function_336(2, 1, 0)), 2, 1);
					if (fVar0 <= 8.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000004:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar1 = Function_337(2);
					fVar0 = Function_370((Function_112(268) - Function_336(2, 1, 0)), 2, 1);
					if (fVar0 <= 7.0f)
					{
						*uParam0 = 2;
					}
	...
	switch (*uParam1)
	{
		case 0x00000000:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					...
					fVar5 = Function_370((Function_112(326) - Function_336(1, 1, 0)), 1, 1);
					if (fVar5 <= 5.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000001:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(1);
					fVar5 = Function_370((Function_112(324) - Function_336(1, 1, 0)), 1, 1);
					if (fVar5 <= 5.0f)
					{
						*uParam0 = 2;
					}
		...
		case 0x00000004:
			switch (*uParam0)
			{
				...
				case 0x00000001:
					fVar4 = Function_337(1);
					fVar5 = Function_370((Function_112(330) - Function_336(1, 1, 0)), 1, 1);
					fVar6 = Function_370((Function_112(317) - Function_336(1, 2, 0)), 1, 2);
					if (fVar5 <= 5.0f && fVar6 <= 5.0f)
					{
						*uParam0 = 2;
					}
					else
							...
							if (IS_OBJECT_VALID(bVar2))
							{
								...
								else if (IS_OBJECT_VALID(GET_EVENT_TARGET_AS_OBJECT(GET_EVENT_FROM_OBJECT(bVar2))))
								{
									...
									if (IS_ACTOR_VALID(bVar4))
									{
										...
										{
											DECOR_SET_BOOL(bVar4, "bearWounded", 1);
											Function_343(uParam3, &bVar2);
											iVar0 = (iVar0 - 1);
										}
...
void Function_468(bool bParam0, int iParam1) //Position: 0x1F800 / 129024
{
	if (Global_34165.f_44)
	{
		REMOVE_JOURNAL_ENTRY(Global_49399[bParam022].f_24, iParam1);
	}
	else
	{
		REMOVE_JOURNAL_ENTRY(Global_49310[bParam022].f_24, iParam1);
	}
	return;
}
