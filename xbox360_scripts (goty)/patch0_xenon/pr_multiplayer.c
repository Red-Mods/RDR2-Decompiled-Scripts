...
bool Function_10(char* cParam0, int iParam1, bool bParam2) //Position: 0xF47 / 3911
{
	char* cVar0[64];
...
bool Function_33(bool bParam0) //Position: 0x162A / 5674
{
	...
	if (!IS_SCRIPT_USE_CONTEXT_VALID(Local_69.f_1256))
	{
		Local_69.f_1256 = ADD_SCRIPT_USE_CONTEXT(bParam0, 4294967096, 4, 0, 0, 0, 0, 4294967295, 0);
		Local_69.f_1252 = -1.0f;
	}
	else if (UI_ISFOCUSED("HudSceneOnline"))
	{
		uVar0 = GET_PLAYER_PADINDEX_NO_ACTOR(0);
		if (IS_BUTTON_DOWN(uVar0, 4, 1, 0))
		{
...
var Function_85(int iParam0) //Position: 0x1FA6 / 8102
{
						...
						else if (Function_24(Local_427[Local_69.f_484]))
						{
							if (Function_102(Local_69.f_48))
							{
								if (StackVal == 4294967295)
								{
									...
									PRINT_HELP_FORMAT(10.0f, &cVar8, Function_100(Local_69.f_48), 0, 0, 0, 2, 0, 0);
								}
								NET_PLAYER_BARKER_RESET(Local_69.f_48, 4294967295, 4294967295, 3212836864);
	...
	if (iVar28 && !bVar7)
	{
		if (!IS_SCRIPT_USE_CONTEXT_VALID(Local_69.f_1260))
		{
			if (bVar29)
			{
				Local_69.f_1260 = ADD_SCRIPT_USE_CONTEXT("mp_FRD_Invite", 100, 8, 0, 0, 0, 0, 4294967295, 0);
			}
			else
			{
				Local_69.f_1260 = ADD_SCRIPT_USE_CONTEXT("net_invite_openMenu", 100, 8, 0, 0, 0, 0, 4294967295, 0);
			}
		}
	}
	return iVar1;
...
void Function_89(char* cParam0, bool bParam1) //Position: 0x2B8A / 11146
{
	int iVar0;
...
var Function_106(var uParam0, int iParam1, int iParam2) //Position: 0x3028 / 12328
{
	int iVar0;
...
bool Function_132(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x359D / 13725
{
	...
	*uParam1 = 4294967295;
	...
	if ((StackVal || bParam0->f_1072 == Global_29006 == iVar0) || bVar4)
	{
		...
		NET_LOG(StackVal, 1, "BARKERS", Function_162("Status changed from %s to %s"), Function_162(iVar0), false, false);
	...
	while (iVar1 <= bParam0->f_1068)
	{
		...
		{
			Function_141(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam0 + 504[iVar114], vVar29, fVar32, Vector(*(&Global_78617 + 196[(bParam0 + 504[iVar114])->f_4810]), (bParam0 + 504[iVar114])->f_52, uVar33) + Vector(0.0f, 2.25f, 0.0f), 1, 18962, 0, iVar34, (bParam0 + 504[iVar114])->f_48, "barkerText", 0);
		}
		else if (Function_153(bParam0, (bParam0 + 504[iVar114])->f_48, iVar0, 0, 0))
		{
			if (Function_151((bParam0 + 504[iVar114])->f_48) && Function_44())
			{
				Function_141(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam0 + 504[iVar114], vVar29, fVar32, Vector(*(&Global_78617 + 196[(bParam0 + 504[iVar114])->f_4810]), (bParam0 + 504[iVar114])->f_52, uVar33) + Vector(0.0f, 2.25f, 0.0f), 1, 17590, 0, iVar36, (bParam0 + 504[iVar114])->f_48, "barkerText", 0);
			}
			else
			{
				Function_141(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam0 + 504[iVar114], vVar29, fVar32, Vector(*(&Global_78617 + 196[(bParam0 + 504[iVar114])->f_4810]), (bParam0 + 504[iVar114])->f_52, uVar33) + Vector(0.0f, 2.25f, 0.0f), 1, 18962, 0, iVar35, (bParam0 + 504[iVar114])->f_48, "barkerText", 0);
			}
		}
...
void Function_136(int iParam0, bool bParam1) //Position: 0x413A / 16698
{
	...
	{
		iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_TELEPORT", 30, 4, 0, 0, 0, 0, 4294967295, 0);
	}
	else if ((&Global_78617 + 196[bParam110])->f_36 == 73)
	{
		iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_HelpBarker", 30, 4, 0, 0, 0, 0, 4294967295, 0);
	}
	else if (Function_151(bParam1))
	{
		if (Function_44())
		{
			if (Function_121())
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_FreeRoamDefense_Disabled", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
			else
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_FreeRoamDefense_claim", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
		}
		else
		{
			...
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_barker_fmt_specific_disabled", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
			else
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_barker_fmt_specific", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
		}
	}
	else
	{
		...
		else
		{
			...
			if (bVar20)
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_barker_fmt_disabled", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
			else
			{
				iParam0->f_8 = ADD_SCRIPT_USE_CONTEXT("mp_barker_fmt", 30, 4, 0, 0, 0, 0, 4294967295, 0);
			}
		}
...
var Function_138(var uParam0, var uParam1) //Position: 0x44B6 / 17590
{
	...
	if (Function_140())
	{
		UI_SET_STRING_FORMAT("Generic_Dbuffer128_2", "%s<nl>%s", UI_GET_STRING("mp_FreeRoamDefense_owner"), UI_GET_STRING(Function_139(Function_45(2))), 0);
	}
	else
	{
		UI_SET_STRING_FORMAT("Generic_Dbuffer128_2", "%s<nl><fs6>%s", UI_GET_STRING("mp_FreeRoamDefense_owner"), UI_GET_STRING(Function_139(Function_45(2))), 0);
	}
...
var Function_143(var uParam0, bool bParam1) //Position: 0x4A12 / 18962
{
	...
	{
		UI_SET_STRING_FORMAT("Generic_Dbuffer128_2", UI_GET_STRING("mp_barker_tis_fmt"), UI_GET_STRING(&cVar16), UI_GET_STRING(&iVar0), 0);
	}
	else
	{
...
void Function_156(int iParam0, int iParam1, int iParam2) //Position: 0x4F9B / 20379
{
	...
	while (iVar0 <= iParam0->f_1068)
	{
		...
		{
			bVar148 = ADD_BLIP_FOR_OBJECT((iParam0 + 504[iVar014])->f_52, Function_152((&Global_78617 + 196[(iParam0 + 504[iVar014])->f_4810])->f_36), 0, 2, 0);
...
var Function_157(bool bParam0, bool bParam1) //Position: 0x5357 / 21335
{
	...
	if (!IS_BLIP_VALID(bVar3))
	{
		bVar3 = ADD_BLIP_FOR_OBJECT(bVar2, bParam1, 0, 2, 0);
	}
	DESTROY_ITERATOR(iVar1);
	return bVar3;
}
...
var Function_160(var uParam0, int iParam1, int iParam2) //Position: 0x53F0 / 21488
{
	...
	{
		case 0x00000048:
			uVar0 = "$/tune/refGroups/refGroups/mp_transport";
			break;
		
		case 0x00000049:
			uVar0 = "$/tune/refGroups/refGroups/mp_help";
			break;
		
		case 0x0000003D:
			uVar0 = "$/tune/refGroups/refGroups/mp_ffa";
			break;
		...
		default:
			if (uParam0->f_1112 != iVar1)
			{
				...
				uVar0 = GET_ASSET_NAME(iVar2, 7);
				uParam0->f_1112 = iVar1;
				uParam0->f_1116 = uVar0;
			}
			else
			{
				uVar0 = uParam0->f_1116;
			}
			break;
	}
	*iParam2 = 1;
	return CREATE_PROPSET_IN_LAYOUT(uParam0->f_12, Function_158(), uVar0, *(&Global_78617 + 196[iParam110]), 0.0f, (&Global_78617 + 196[iParam110])->f_12, 0.0f);
}
...
bool Function_172(bool bParam0, int iParam1, int iParam2) //Position: 0x5AC9 / 23241
{
	var uVar0;
	
	return Function_173(bParam0, iParam1, &uVar0, iParam2);
}
...
int Function_180(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x6021 / 24609
{
	...
	if (bLocal_68)
	{
		...
		iVar1 = (iVar1 + Function_182((CEIL(Function_183(1, bParam0)) / 1000), 9999));
	}
	else
	{
		iVar1 = FLOOR(Function_183(8, bParam0));
	}
	if (!bParam1)
	{
		Function_172(bParam0, iVar1, 0);
	}
	iVar6 = 0;
	if (Function_45(1) > 0)
	{
...
var Function_223(char* cParam0) //Position: 0x6A9F / 27295
{
	bool bVar0;
