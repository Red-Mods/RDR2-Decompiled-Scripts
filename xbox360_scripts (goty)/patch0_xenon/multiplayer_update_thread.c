...
void Function_19(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, bool bParam7) //Position: 0x1895 / 6293
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_26(int iParam0, int iParam1) //Position: 0x2060 / 8288
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
bool Function_51(bool bParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, int iParam11) //Position: 0x371E / 14110
{
	bool bVar0;
	bool bVar1;
	
	bVar0 = CREATE_VOLUME_IN_LAYOUT(*bParam0, Function_20(), iParam11, vParam2, vParam5, vParam8);
...
void Function_62(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x3954 / 14676
{
	...
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_67(iParam0), &cVar0, 2, 2, 1);
	}
...
void Function_63(int iParam0, int iParam1) //Position: 0x3A0B / 14859
{
	bool bVar0;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x47B0 / 18352
{
...
void Function_98(int iParam0, int iParam1) //Position: 0x49D4 / 18900
{
	...
	if (!bVar0)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_67(iParam0), &Var7, 0, 2, 0);
		PREPEND_JOURNAL_ENTRY(Function_67(iParam0), 1);
		SET_JOURNAL_ENTRY_PROGRESS(Function_67(iParam0), 1.0f, false, 0);
	}
	return;
}
...
void Function_140() //Position: 0x5930 / 22832
{
	...
	{
		iVar0 = CREATE_NAMED_OBJECT_ITERATOR(Global_30616, "nBoxKiller");
		ITERATE_IN_LAYOUT(iVar0, Global_30616);
		ITERATE_ON_OBJECT_TYPE(iVar0, 12);
		ITERATE_ON_PARTIAL_MODEL_NAME(iVar0, "locked_footlocker");
...
void Function_148() //Position: 0x5A39 / 23097
{
	...
	ITERATE_ON_OBJECT_TYPE(iVar1, 17);
	ITERATE_ON_PARTIAL_NAME(iVar1, "CTFBag_");
...
void Function_156(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x5E13 / 24083
{
	...
	if ((bParam3 && Function_64(iParam0, 4)) || !bParam3)
	{
		if (!bVar0)
		{
			PREPEND_JOURNAL_ENTRY(Function_67(iParam0), 0);
			Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_100(iParam0) };
			Var7 = { StackVal, StackVal, StackVal, Function_66(iParam0) };
			UI_SET_STRING(&Var1, UI_GET_STRING(&Var7));
...
void Function_166(bool bParam0) //Position: 0x61D8 / 25048
{
	...
	{
		iVar0 = CREATE_NAMED_OBJECT_ITERATOR(cParam0, "NETReplicationItr");
		if (!IS_ITERATOR_VALID(iVar0))
		{
			Function_167();
			return;
		}
		ITERATE_IN_EVENT_TRAP(iVar0, bLocal_10);
		bVar1 = START_OBJECT_ITERATOR(iVar0);
		while (IS_OBJECT_VALID(bVar1))
		{
...
{
	if (!IS_SCRIPT_VALID(uLocal_134))
	{
		uLocal_134 = LAUNCH_NEW_SCRIPT("$/content/multiplayer/PR_Multiplayer", 0);
	}
	if (!IS_SCRIPT_VALID(uLocal_133))
	{
		uLocal_133 = LAUNCH_NEW_SCRIPT("$/content/multiplayer/multiplayer_system_thread", 0);
	}
	return;
}
...
void Function_185(var uParam0, bool bParam1, int iParam2) //Position: 0x69BA / 27066
{
	int iVar0;
	bool bVar1;
	...
	{
		bVar1 = GET_ACTOR_FROM_ACTORSET(uParam0, iVar0);
...
var Function_210(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6F6A / 28522
{
	...
	iVar0 = Function_211(iParam0, uVar1, iParam2);
	if (bParam3)
	{
		Function_179(iParam0[iVar03], 8);
	}
...
var Function_282(char* cParam0) //Position: 0x8366 / 33638
{
	bool bVar0;
...
bool Function_285(bool bParam0) //Position: 0x83B3 / 33715
{
	...
	{
		NET_LOG(true, "SaveLoad", "Multiplayer Save Called", false, 0, false, 0);
		if (bParam0)
		{
			Function_286();
		}
...
void Function_292() //Position: 0x8605 / 34309
{
	...
	bVar0 = Function_3();
	iVar4 = CREATE_OBJECT_ITERATOR(bVar0);
	if (!IS_ITERATOR_VALID(iVar4))
	{
	}
	else
	{
		iVar5 = CREATE_OBJECT_ITERATOR(bVar0);
		if (!IS_ITERATOR_VALID(iVar5))
		{
		}
		else
		{
			ITERATE_ON_OBJECT_TYPE(iVar4, 2);
			ITERATE_IN_LAYOUT(iVar4, bVar0);
			if (GET_NUM_ITERATOR_MATCHES(iVar4) == 0)
			{
				Function_43();
				return;
			}
			ITERATE_ON_OBJECT_TYPE(iVar5, 3);
			ITERATE_IN_LAYOUT(iVar5, bVar0);
			bVar1 = START_OBJECT_ITERATOR(iVar5);
			bVar2 = "";
			bVar3 = false;
			while (IS_OBJECT_VALID(bVar1))
			{
				bVar3 = false;
				bVar2 = START_OBJECT_ITERATOR(iVar4);
				while (IS_OBJECT_VALID(bVar2) && !bVar3)
				{
					bVar3 = IS_OBJECT_IN_OBJECTSET(bVar1, GET_OBJECTSET_FROM_OBJECT(bVar2));
					bVar2 = OBJECT_ITERATOR_NEXT(iVar4);
				}
				if (!bVar3)
				{
					DESTROY_OBJECT(bVar1);
				}
				bVar1 = OBJECT_ITERATOR_NEXT(iVar5);
			}
		}
	}
	if (IS_ITERATOR_VALID(iVar5))
...
void Function_302(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5, bool bParam6) //Position: 0x9FE9 / 40937
{
	...
	*uParam3 = 1.0f;
	...
	if (iParam5 != 5)
	{
		...
		CLEAR_JOURNAL_ENTRY(Function_67(iParam0));
		REMOVE_JOURNAL_ENTRY(Function_67(iParam0), 0);
		Function_155(iParam0, 4);
	}
	else
	{
...
void Function_311(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0xAF7F / 44927
{
	...
	if (bParam2)
	{
		if (((iParam0 != 12 || iParam0 != 13) || iParam0 != 10) || iParam0 != 11)
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_313(iParam0), &cVar0, 2, 2, 0);
		...
		else
		{
			...
			APPEND_JOURNAL_ENTRY_DETAIL(Function_313(iParam0), &cVar20, 2, 2, 1);
			Function_63(Function_313(iParam0), 0);
		}
	}
}
...
int Function_313(int iParam0) //Position: 0xB17C / 45436
{
	if (Function_16() || Global_34165.f_44)
	{
...
void Function_314(int iParam0) //Position: 0xB1A4 / 45476
{
	...
	APPEND_JOURNAL_ENTRY_DETAIL(Function_313(iParam0), &Var6, 0, 2, 0);
	PREPEND_JOURNAL_ENTRY(Function_313(iParam0), 1);
...
void Function_344(int iParam0, int iParam1, char* cParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xC9B3 / 51635
{
	...
	if (Global_83864.f_1276)
	{
		...
		REMOVE_JOURNAL_ENTRY(Function_67(iParam0), 1);
	}
...
void Function_347(int iParam0, int iParam1) //Position: 0xCB18 / 51992
{
