...
void Function_57(bool bParam0, bool bParam1, int iParam2) //Position: 0x2C1F / 11295
{
	...
	*iParam2 = 0;
	...
	iVar3 = 0;
	bVar4 = false;
	if (!DECOR_CHECK_EXIST(bParam1, "nmoonshine"))
	{
		if (IS_ACTOR_VALID(bParam1) && IS_ACTOR_ALIVE(bParam1))
		{
			GET_GRINGO_FLOAT_ATTR(&bVar0, "effectTime", bParam0);
			GET_GRINGO_FLOAT_ATTR(&fVar1, "DeadEyeRestorePercent", bParam0);
			bVar2 = GET_GRINGO_STRING_ATTR("myItemString", bParam0, &iVar3);
			if (STRING_CONTAINS_STRING(bVar2, "nMOONSHINE"))
			{
				DECOR_SET_FLOAT(bParam1, "nmoonshine", bVar0);
			}
			if (((Function_62(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
			{
				iLocal_3 = 0;
			}
			SET_PLAYER_DEADEYE_POINTS(0, fVar1, 1);
			if (STRING_CONTAINS_STRING(bVar2, "nMOONSHINE"))
			{
				Function_61(478, 1, 0, 0);
				if (Function_60())
				{
					if (HAS_ITEM(SS_GET_STRING(1, true), Global_34573))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, true), Global_34573);
					}
					PLAYSTAT_INT("HC_MOONSHINE", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(bVar2, "nSNAKE_OIL"))
			{
				Function_61(477, 1, 0, 0);
				if (Function_60())
				{
					if (HAS_ITEM(SS_GET_STRING(1, false), Global_34573))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, false), Global_34573);
					}
					PLAYSTAT_INT("HC_SNAKE_OIL", bVar4);
				}
			}
			else if (STRING_CONTAINS_STRING(bVar2, "TONIC"))
			{
				Function_61(486, 1, 0, 0);
				if (Function_60())
				{
					if (HAS_ITEM(SS_GET_STRING(1, 5), Global_34573))
					{
						bVar4 = GET_ITEM_COUNT(SS_GET_STRING(1, 5), Global_34573);
					}
	...
	{
		Function_58("already_moonshine", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_58(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2E1F / 11807
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_59(int iParam0) //Position: 0x2E9A / 11930
{
	char* cVar0[16];
...
bool Function_60() //Position: 0x2ED9 / 11993
{
...
int Function_61(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2F04 / 12036
{
	int iVar0;
	int iVar1;
...
int Function_62(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3124 / 12580
{
...
bool Function_63() //Position: 0x31DA / 12762
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_64(bool bParam0) //Position: 0x31F1 / 12785
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_65(bool bParam0) //Position: 0x31FC / 12796
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_66(bool bParam0) //Position: 0x320A / 12810
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_67(int iParam0, bool bParam1) //Position: 0x3224 / 12836
{
	bool bVar0;
	bool bVar1;
