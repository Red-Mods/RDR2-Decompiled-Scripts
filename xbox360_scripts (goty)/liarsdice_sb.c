...
void Function_20(bool bParam0, bool bParam1) //Position: 0xA10 / 2576
{
	if (Function_16(4))
	{
...
void Function_21(bool bParam0, int iParam1) //Position: 0xA43 / 2627
{
	struct<13> Var0;
...
struct<16> Function_22(var uParam0) //Position: 0xC70 / 3184
{
	struct<4> Var0;
	bool bVar4;
...
bool Function_23() //Position: 0xCE1 / 3297
{
	return (Function_16(4096) || Function_16(4));
}

int Function_24(int iParam0) //Position: 0xCF2 / 3314
{
	return Function_25(0, iParam0);
}

int Function_25(int iParam0, bool bParam1) //Position: 0xCFE / 3326
{
	char* cVar0[64];
...
var Function_26(int iParam0) //Position: 0xD67 / 3431
{
	return (*&Global_78480 + 176)[iParam0];
}

int Function_27(int iParam0) //Position: 0xD77 / 3447
{
	return Function_28(0, iParam0);
}

int Function_28(int iParam0, bool bParam1) //Position: 0xD83 / 3459
{
	char* cVar0[64];
...
var Function_29(int iParam0) //Position: 0xDEA / 3562
{
	return (*&Global_78480 + 132)[iParam0];
}

void Function_30(bool bParam0, int iParam1, char* cParam2) //Position: 0xDFA / 3578
{
	if (bParam0)
	{
		if (Function_11())
...
int Function_31() //Position: 0xE1B / 3611
{
	if (!Function_33(1))
	{
		return 0;
...
void Function_32() //Position: 0xECE / 3790
{
	if (Function_16(4096))
	{
...
bool Function_33(bool bParam0) //Position: 0xF0B / 3851
{
	char* cVar0[64];
...
void Function_34(bool bParam0) //Position: 0xF8C / 3980
{
...
struct<64> Function_35(var uParam0) //Position: 0x1015 / 4117
{
...
int Function_37(bool bParam0, bool bParam1) //Position: 0x106E / 4206
{
...
bool Function_38(int iParam0, bool bParam1) //Position: 0x10A2 / 4258
{
	int iVar0;
...
void Function_39(int iParam0) //Position: 0x10C2 / 4290
{
	Function_40(8, iParam0);
	return;
}

void Function_40(var uParam0, bool bParam1) //Position: 0x10CF / 4303
{
	if (bParam1)
	{
