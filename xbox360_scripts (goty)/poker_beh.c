...
bool Function_17() //Position: 0x420 / 1056
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30717[1], &Local_24 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_30717[1], 0);
				*(&Local_24 + 148) = { StackVal, StackVal, Function_26(Global_30717[1], 0) };
				Function_25(&Local_24 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_24 + 40)[iVar0] = iLocal_4 * 10;
					Function_24(Global_30717[1], iVar0, 0);
					*(&Local_24 + 72[iVar03]) = { StackVal, StackVal, Function_24(Global_30717[1], iVar0, 0) };
					iVar0++;
				}
				Local_24.f_168 = 2;
				Local_24.f_160 = 0;
				Local_24.f_8 = Local_6;
				Function_23(Global_30717[1]);
				*(&Local_24 + 184) = { StackVal, StackVal, Function_23(Global_30717[1]) };
				Function_22(Global_30717[1]);
				*(&Local_24 + 196) = { StackVal, StackVal, Function_22(Global_30717[1]) };
...
void Function_18() //Position: 0x5BC / 1468
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5C5 / 1477
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x5E6 / 1510
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x61C / 1564
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x637 / 1591
{
...
vector3 Function_23(int iParam0) //Position: 0x731 / 1841
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x82B / 2091
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xDA5 / 3493
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xDFA / 3578
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF0C / 3852
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x10FB / 4347
{
...
bool Function_29() //Position: 0x11B1 / 4529
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11C8 / 4552
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11D3 / 4563
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x11E1 / 4577
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x11EE / 4590
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1230 / 4656
{
	return Function_35(0);
}

int Function_35(int iParam0) //Position: 0x123A / 4666
{
...
var Function_36(int iParam0) //Position: 0x127B / 4731
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_37(int iParam0) //Position: 0x1295 / 4757
{
...
int Function_38(var uParam0, int iParam1) //Position: 0x12B1 / 4785
{
	int iVar0;
...
bool Function_39(int iParam0) //Position: 0x12CD / 4813
{
...
void Function_40() //Position: 0x12E3 / 4835
{
	Function_1();
	return;
}

void Function_41() //Position: 0x12EC / 4844
{
...
void Function_42(int iParam0) //Position: 0x133B / 4923
{
...
void Function_43(var uParam0, float fParam1) //Position: 0x1350 / 4944
{
...
void Function_44(var uParam0, int iParam1) //Position: 0x1371 / 4977
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, int iParam1) //Position: 0x1384 / 4996
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_46(int iParam0) //Position: 0x1393 / 5011
{
	return Function_47(*iParam0, 1);
}

int Function_47(var uParam0, bool bParam1) //Position: 0x13A0 / 5024
{
	return (uParam0 && bParam1) == 0;
}

void Function_48() //Position: 0x13AD / 5037
{
	return;
}

void Function_49() //Position: 0x13B3 / 5043
{
	return;
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x13B9 / 5049
{
	bool bVar0;
...
void Function_51(var uParam0) //Position: 0x1410 / 5136
{
	int iVar0;
...
var Function_52() //Position: 0x142D / 5165
{
	var uVar0;
