...
void main() //Position: 0x0 / 0
{
	...
	iLocal_77 = 0;
	Function_101(uScriptParam_0, &iLocal_77);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(Local_4[iVar312]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), Local_4[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_87("eGRINGO_EndUse: Stop use by request", Local_4[iVar312].f_16);
							Function_86(Local_4[iVar312].f_16, 1);
							...
							{
								Function_79(&(Local_4[iVar312]), 0);
							}
							else if (Local_4[iVar312].f_44 < 8)
							{
								Function_78(&(Local_4[iVar312]));
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_82, &cLocal_81);
		...
		case 0x00000006:
			...
			bVar0 = Function_49(iParam0->f_16, iParam0->f_12, Function_77(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0B / 7435
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		if (!DECOR_CHECK_EXIST(bParam0, "NumTNT"))
		{
			if (IS_ACTION_NODE_PLAYING(bParam0, "dynamite/Detonator/idle_high"))
			{
				if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_1))
				{
					bLocal_2 = ADD_SCRIPT_USE_CONTEXT("Quit_Detonator", 50, 4, false, 0, 0, 0, 4294967295, 0);
					bLocal_1 = ADD_SCRIPT_USE_CONTEXT("Push_Detonator", 50, 1, false, 0, 0, 0, 4294967295, 0);
				}
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_1))
				{
					RELEASE_SCRIPT_USE_CONTEXT(bLocal_1);
					RELEASE_SCRIPT_USE_CONTEXT(bLocal_2);
					if (IS_ACTION_NODE_PLAYING(bParam0, "dynamite/Detonator/idle_high"))
					{
						SET_ACTION_NODE_FOR_ACTOR(bParam0, "dynamite/Detonator/Down");
					}
					DECOR_SET_INT(bParam0, "UsedDetonator", true);
				}
				else if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_2))
				{
					RELEASE_SCRIPT_USE_CONTEXT(bLocal_1);
					RELEASE_SCRIPT_USE_CONTEXT(bLocal_2);
					return 0;
		...
		if (bLocal_3 <= DECOR_GET_INT(bParam0, "NumTNT"))
		{
			if (IS_ACTION_NODE_PLAYING_PARTIAL(bParam0, "dynamite/Detonator/idle_high") && DECOR_CHECK_EXIST(bParam0, "wagoncutfinished"))
			{
				...
				else if (Function_27(1, 1, 0))
				{
					SET_ACTION_NODE_FOR_ACTOR(bParam0, "dynamite/Detonator/Down");
					DECOR_SET_INT(bParam0, "UsedDetonator", true);
					UI_EXIT("Rebel04_Detonator");
				}
				else if (Function_27(4, 1, 0))
				{
...
bool Function_27(int iParam0, int iParam1, bool bParam2) //Position: 0x1F46 / 8006
{
	int iVar0;
	bool bVar1;
...
bool Function_28(bool bParam0) //Position: 0x1FF3 / 8179
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x2012 / 8210
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x2018 / 8216
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x2026 / 8230
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x2031 / 8241
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x204B / 8267
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x2069 / 8297
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x2088 / 8328
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x20BB / 8379
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x20DA / 8410
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x20F4 / 8436
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2107 / 8455
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_40() //Position: 0x23EF / 9199
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x23F7 / 9207
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x2414 / 9236
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2423 / 9251
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x2445 / 9285
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x2469 / 9321
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2486 / 9350
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x24A6 / 9382
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x24C6 / 9414
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2574 / 9588
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x25E4 / 9700
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x25FA / 9722
{
...
var Function_52(bool bParam0) //Position: 0x261B / 9755
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x263B / 9787
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x264F / 9807
{
	uParam0 = uParam0;
	return;
}

var Function_55() //Position: 0x2659 / 9817
{
	return !Function_56();
}

bool Function_56() //Position: 0x2663 / 9827
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_57(var uParam0, int iParam1) //Position: 0x266C / 9836
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x267B / 9851
{
	bool bVar0;
...
bool Function_59(bool bParam0) //Position: 0x26BA / 9914
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x26E5 / 9957
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x26F0 / 9968
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x27E6 / 10214
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x2808 / 10248
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(bool bParam0) //Position: 0x282F / 10287
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (!DECOR_CHECK_EXIST(GET_PLAYER_ACTOR(0), "NumTNT") && !Function_56())
	{
		...
		if (IS_OBJECT_VALID(bVar24))
		{
			...
			bVar26 = CREATE_POINT_IN_LAYOUT(bVar25, Function_40(), vVar17, 0.0f, 0.0f, 0.0f);
			...
			if (bVar28)
			{
				...
				ATTACH_OBJECTS(bVar26, GRINGO_GET_MY_OBJECT_REF(), Function_40(), vVar36, 0.0f, 0.0f, 0.0f, 4294967295);
			}
...
vector3 Function_65(vector3 vParam0) //Position: 0x2B07 / 11015
{
	vector3 vVar0;
...
vector3 Function_66(vector3 vParam0) //Position: 0x2B64 / 11108
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x2BC1 / 11201
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x2BCB / 11211
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2BE9 / 11241
{
	if (!Function_14(iParam0))
	{
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x2BFE / 11262
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x2C85 / 11397
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2CA8 / 11432
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x2CC6 / 11462
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x2CE9 / 11497
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x2E04 / 11780
{
...
int Function_76(bool bParam0) //Position: 0x2E2F / 11823
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2F34 / 12084
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2F41 / 12097
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2FB4 / 12212
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x34B2 / 13490
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x34E9 / 13545
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x3506 / 13574
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x353E / 13630
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x3548 / 13640
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x3569 / 13673
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	SET_AUTO_CONVERSATION_LOOK(Global_34573, 1);
	...
	if (DECOR_CHECK_EXIST(bParam0, "removepushdetonator"))
	{
		DECOR_REMOVE(bParam0, "removepushdetonator");
	}
	return;
}

void Function_86(bool bParam0, bool bParam1) //Position: 0x361A / 13850
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3722 / 14114
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x3738 / 14136
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x39EE / 14830
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x39FC / 14844
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x3A15 / 14869
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x3A2F / 14895
{
	bool bVar0;
	char* cVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3A67 / 14951
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x3A7E / 14974
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3D47 / 15687
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3D64 / 15716
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3E00 / 15872
{
...
bool Function_99(int iParam0) //Position: 0x3E2E / 15918
{
...
void Function_100(int iParam0) //Position: 0x3E4A / 15946
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3E54 / 15956
{
	int iVar0;
	int iVar1;
	...
	{
		Function_102(&(Local_4[iLocal_7712]), bParam0);
		iLocal_77++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x3EB6 / 16054
{
...
void Function_103(int iParam0) //Position: 0x3ECA / 16074
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3ED4 / 16084
{
