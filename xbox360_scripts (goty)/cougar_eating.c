...
void main() //Position: 0x0 / 0
{
	...
	iLocal_84 = 0;
	Function_101(uScriptParam_0, &iLocal_84);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_94(&(Local_11[iVar312]), &bVar4))
						{
							Function_92(GRINGO_GET_REQUESTING_ACTOR(), Local_11[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_87("eGRINGO_EndUse: Stop use by request", Local_11[iVar312].f_16);
							Function_86(Local_11[iVar312].f_16, 1);
							...
							{
								Function_79(&(Local_11[iVar312]), 0);
							}
							else if (Local_11[iVar312].f_44 < 8)
							{
								Function_78(&(Local_11[iVar312]));
	...
	while (iVar0 < (iLocal_84 - 1))
	{
		if (Function_77(Local_11[iVar012].f_40, 2))
		{
			...
			Function_79(&(Local_11[iVar012]), 0);
		}
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_91))
								{
									...
									{
										bLocal_91 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_91 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			bLocal_90 = true;
			Function_54(iParam0);
			Function_52(iParam0, Function_53(iParam0->f_12));
			if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
			{
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_41(iParam0, bVar8, &iLocal_89, &cLocal_88);
		...
		case 0x00000006:
			...
			bVar0 = Function_51(iParam0->f_16, iParam0->f_12, Function_77(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0D / 7437
{
	int iVar0;
	...
	bParam0 = bParam0;
	iVar0 = 1;
	while (!GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &uLocal_3, 2.0f, 2.0f, 1, 0.0f, 0.0f, 1, 0) && iVar0)
	{
		GRINGO_WAIT(false);
		Function_27(GET_PLAYER_ACTOR(0), &uLocal_3);
		if (Function_12(&iLocal_7) < 10.0f)
		{
			iVar0 = 0;
		}
	}
	REMOVE_OBJECT_ATTACHMENT(uLocal_6);
	return 1;
}

void Function_27(bool bParam0, int iParam1) //Position: 0x1D5A / 7514
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_28(bool bParam0) //Position: 0x1D67 / 7527
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1D86 / 7558
{
	return;
}

void Function_30(bool bParam0, int iParam1) //Position: 0x1D8C / 7564
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	ITERATE_IN_SPHERE(bVar3, vVar0, 1.0f);
	ITERATE_ON_OBJECT_TYPE(bVar3, 29);
	...
	GRINGO_SET_TARGET_OBJECT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), bVar4, 1);
	while (!REQUEST_ARTICULATED_CORPSE(GET_TARGET_OBJECT()))
	{
		WAIT(10);
	}
	uLocal_6 = ATTACH_OBJECTS_PHYSICAL(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), "spine00", "Jaw_Attachment", 0.0f);
	if (IS_ATTACHMENT_VALID(uLocal_6))
	{
		ATTACH_SET_ROTATIONAL_CONSTRAINT(uLocal_6, 45.0f, 0.0f, 45.0f, 100.0f, 40.0f);
		SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), 0);
	}
	else
	{
		SCRIPT_BREAKPOINT("Attachment not valid");
	}
	GET_OBJECT_POSITION(bParam0, &vLocal_0);
	vLocal_0 = (vLocal_0.x + 10.0f);
	vLocal_0.f_8 = (vLocal_0.z + 10.0f);
	FIND_GROUND_INTERSECTION(&vLocal_0, 10.0f, &uLocal_3, &uVar5);
	Function_31(&iLocal_7);
	return;
}

void Function_31(int iParam0) //Position: 0x1EA6 / 7846
{
	Function_32(iParam0, 0.0f);
	return;
}

void Function_32(int iParam0, float fParam1) //Position: 0x1EB2 / 7858
{
...
bool Function_33(int iParam0) //Position: 0x1ED3 / 7891
{
	iParam0 = iParam0;
	return 1;
}

bool Function_34(bool bParam0) //Position: 0x1EDE / 7902
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_35(bool bParam0, int iParam1) //Position: 0x1EF8 / 7928
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_36(bool bParam0) //Position: 0x1F16 / 7958
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1F35 / 7989
{
	int iVar0;
	int iVar1;
...
bool Function_38(bool bParam0) //Position: 0x1F68 / 8040
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_39(bool bParam0) //Position: 0x1F87 / 8071
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x1FA1 / 8097
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_41(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1FB4 / 8116
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_43(uParam0->f_12, &bVar10), 0, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_42(), Function_43(uParam0->f_12, &bVar10), 0, bVar9);
	}
...
var Function_42() //Position: 0x229C / 8860
{
	int iVar0;
...
bool Function_43(bool bParam0, bool bParam1) //Position: 0x22A4 / 8868
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_44() //Position: 0x22C1 / 8897
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x22D0 / 8912
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x22F2 / 8946
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_47(bool bParam0) //Position: 0x2316 / 8982
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x2333 / 9011
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x2353 / 9043
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x2373 / 9075
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_51(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2421 / 9249
{
	bool bVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x2491 / 9361
{
	if (!Function_14(iParam0))
	{
...
var Function_53(bool bParam0) //Position: 0x24A7 / 9383
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_54(int iParam0) //Position: 0x24C7 / 9415
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x24DB / 9435
{
	uParam0 = uParam0;
	return;
}

int Function_56() //Position: 0x24E5 / 9445
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x24EC / 9452
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x24FB / 9467
{
	float fVar0;
...
bool Function_59(bool bParam0) //Position: 0x253A / 9530
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x2565 / 9573
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x2570 / 9584
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x2666 / 9830
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x2688 / 9864
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(bool bParam0) //Position: 0x26AF / 9903
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_65(vector3 vParam0) //Position: 0x296E / 10606
{
	vector3 vVar0;
...
vector3 Function_66(vector3 vParam0) //Position: 0x29CB / 10699
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x2A28 / 10792
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x2A32 / 10802
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2A50 / 10832
{
	if (!Function_14(iParam0))
	{
		Function_32(iParam0, 0.0f);
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x2A65 / 10853
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x2AEC / 10988
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2B0F / 11023
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x2B2D / 11053
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x2B50 / 11088
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
	...
	uVar0 = Function_73(bParam1);
	uVar1 = Function_59(bParam1);
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x2C6B / 11371
{
...
int Function_76(bool bParam0) //Position: 0x2C96 / 11414
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2D9B / 11675
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2DA8 / 11688
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2E1B / 11803
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x3319 / 13081
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x3350 / 13136
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x336D / 13165
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x33A5 / 13221
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x33AF / 13231
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x33D0 / 13264
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	RESET_ANIM_SET_FOR_ACTOR(bParam0, 0);
	SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), 1);
	REQUEST_FIXED_CORPSE(GET_TARGET_OBJECT(), 1);
	return;
}

void Function_86(bool bParam0, bool bParam1) //Position: 0x33F8 / 13304
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3500 / 13568
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x3516 / 13590
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x37CC / 14284
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x37DA / 14298
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x37F3 / 14323
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, int iParam1) //Position: 0x380D / 14349
{
	bool bVar0;
	var uVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3845 / 14405
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x385C / 14428
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3B25 / 15141
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3B42 / 15170
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3BDE / 15326
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3BFD / 15357
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3C0C / 15372
{
...
void Function_100(int iParam0) //Position: 0x3C28 / 15400
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3C32 / 15410
{
	int iVar0;
	int iVar1;
	...
	{
		Function_102(&(Local_11[iLocal_8412]), bParam0);
		iLocal_84++;
	}
...
void Function_102(int iParam0, int iParam1) //Position: 0x3C94 / 15508
{
...
void Function_103(int iParam0) //Position: 0x3CA8 / 15528
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3CB2 / 15538
{
