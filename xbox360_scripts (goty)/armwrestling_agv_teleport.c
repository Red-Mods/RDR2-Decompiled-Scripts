...
void main() //Position: 0x0 / 0
{
	...
	vVar0 = { -1474.477f, 16.545f, 3943.473f };
	fVar3 = 215.327f;
	CAMERA_RESET(0);
	TELEPORT_ACTOR_WITH_HEADING(GET_PLAYER_ACTOR(0), vVar0, fVar3, 1, 1, 1);
	...
	CAMERA_RESET(0);
	Function_4(1, 0, 1);
	while ((!Function_1(Global_30693[2]) || !STREAMING_IS_WORLD_LOADED()) && !IS_EXITFLAG_SET())
	{
		WAIT(0);
	}
	if (HUD_IS_FADED())
...
void Function_8(var uParam0, int iParam1) //Position: 0x2DD / 733
{
	int iVar0;
...
void Function_9(var uParam0, int iParam1) //Position: 0x2F4 / 756
{
