...
void main() //Position: 0x0 / 0
{
	...
	bVar3 = FIND_NAMED_LAYOUT("ThievesLanding_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_streetSpawn_set");
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_pop_southdocks_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			bVar5 = Function_5(bVar4, uVar0, 5, 10, 0, 0, 1);
			if (IS_ZONE_VALID(bVar5))
			{
				SET_ZONE_SPAWN_ONLY_AT_GRINGOS(bVar5, 1);
			}
		}
		else
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_pop_northdocks_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			bVar6 = Function_5(bVar4, uVar0, 2, 5, 0, 0, 1);
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_pop_crateyard_set");
		if (IS_VOLUME_VALID(bVar4))
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_pop_south_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			bVar7 = Function_5(bVar4, uVar0, 10, 20, 0, 0, 1);
			if (IS_ZONE_VALID(bVar7))
			{
				SET_ZONE_SPAWN_ONLY_AT_GRINGOS(bVar7, 1);
			}
		}
		else
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_pop_north_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			bVar8 = Function_5(bVar4, uVar0, 5, 10, 0, 0, 1);
			if (IS_ZONE_VALID(bVar8))
			{
				SET_ZONE_SPAWN_ONLY_AT_GRINGOS(bVar8, 1);
			}
		}
		else
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_brothel1_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			bVar9 = Function_4(bVar4, uVar0, 3, 0, 0, 1);
			SET_ZONE_PRIORITY(bVar9, 2);
			SET_ZONE_FORCE_SPAWN_DISTANCE(bVar9, 40.0f);
			SET_ZONE_SPAWN_ONLY_AT_GRINGOS(bVar9, 1);
		}
		else
		{
			LOG_ERROR("thi_pop: Cannot find thiv_brothel1_set to create population volumes");
		}
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_brothel_more_set");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_4(bVar4, uVar0, 2, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("thi_pop: Cannot find thiv_brothel_more_set to create population volumes");
		}
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_saloon_set");
		if (IS_VOLUME_VALID(bVar4))
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_warehouse_set");
		if (IS_VOLUME_VALID(bVar4))
		{
		...
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "thiv_region");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_5(bVar4, uVar1, 2, 5, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0x1172 / 4466
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x1181 / 4481
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x11D6 / 4566
{
	bool bVar0;
...
var Function_4(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1256 / 4694
{
	bool bVar0;
...
var Function_5(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x12D6 / 4822
{
	bool bVar0;
...
bool Function_6(int iParam0) //Position: 0x1358 / 4952
{
	int iVar0;
...
void Function_7(bool bParam0, float fParam1) //Position: 0x1374 / 4980
{
	if (!Function_6(128))
	{
		return;
...
bool Function_8(var uParam0, int iParam1) //Position: 0x13B2 / 5042
{
	int iVar0;
...
void Function_9(var uParam0, bool bParam1) //Position: 0x13CE / 5070
{
...
var Function_10(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0x13DE / 5086
{
	int iVar0;
	int iVar1;
...
var Function_11(int iParam0) //Position: 0x1456 / 5206
{
	bool bVar0;
...
var Function_12(int iParam0) //Position: 0x14C2 / 5314
{
	bool bVar0;
...
var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0x152E / 5422
{
	int iVar0;
	int iVar1;
...
void Function_14(int iParam0) //Position: 0x1573 / 5491
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_15(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x157F / 5503
{
	int iVar0;
	int iVar1;
...
var Function_16(bool bParam0, int iParam1) //Position: 0x15FB / 5627
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_17(bool bParam0, var uParam1) //Position: 0x1608 / 5640
{
	if (!Function_6(128))
	{
		return;
