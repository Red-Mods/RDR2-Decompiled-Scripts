...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2EDB / 11995
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x2FE3 / 12259
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x2FF9 / 12281
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32AF / 12975
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x32BD / 12989
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x32D6 / 13014
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x32F0 / 13040
{
	bool bVar0;
	char* cVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3328 / 13096
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x333F / 13119
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3608 / 13832
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3625 / 13861
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36C1 / 14017
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x36E0 / 14048
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x36EF / 14063
{
...
void Function_96(int iParam0) //Position: 0x370B / 14091
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3715 / 14101
{
	int iVar0;
	int iVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x3777 / 14199
{
...
void Function_99(int iParam0) //Position: 0x378B / 14219
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x3795 / 14229
{
