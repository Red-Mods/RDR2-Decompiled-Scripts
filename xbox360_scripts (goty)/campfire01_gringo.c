...
void main() //Position: 0x0 / 0
{
	...
	{
		if (DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "DontRun"))
		{
		}
		if (Function_119(8))
		{
	...
	*(&iVar3 + 228) = 2;
	if (bVar2)
	{
		Function_118(&iVar3, "$/fragments/p_gen_campfire03x", "$/tune/refGroups/campsiteSets/cam_campfireSmall01x");
...
void Function_1(int iParam0) //Position: 0x153 / 339
{
	bool bVar0;
...
void Function_2() //Position: 0x2C5 / 709
{
	return;
}

void Function_3() //Position: 0x2CB / 715
{
	Function_4();
	return;
}

void Function_4() //Position: 0x2D4 / 724
{
...
void Function_5(int iParam0) //Position: 0x2E6 / 742
{
	int iVar0;
...
void Function_6(var uParam0, int iParam1) //Position: 0x30C / 780
{
...
void Function_7(var uParam0, int iParam1) //Position: 0x43A / 1082
{
	int iVar0;
...
bool Function_8(var uParam0, bool bParam1) //Position: 0x454 / 1108
{
	int iVar0;
...
int Function_9(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, bool bParam6, float fParam7, int iParam8, float fParam9) //Position: 0x471 / 1137
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_10(int iParam0) //Position: 0x146F / 5231
{
...
void Function_11(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x147F / 5247
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_12(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x167D / 5757
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

int Function_13(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1697 / 5783
{
	int iVar0;
	bool bVar1;
...
int Function_14(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x1777 / 6007
{
	char* cVar0[32];
...
int Function_15(bool bParam0) //Position: 0x19C5 / 6597
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_16(bool bParam0, bool bParam1) //Position: 0x19E8 / 6632
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_17(bool bParam0, bool bParam1) //Position: 0x1A0B / 6667
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_18(bool bParam0, bool bParam1) //Position: 0x1A2F / 6703
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_19(bool bParam0, bool bParam1) //Position: 0x1A55 / 6741
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_20(bool bParam0) //Position: 0x1A78 / 6776
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_21() //Position: 0x1A96 / 6806
{
...
bool Function_22(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1AE0 / 6880
{
	bool bVar0;
	bool bVar1;
...
bool Function_23(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x1B32 / 6962
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

void Function_24(bool bParam0, bool bParam1) //Position: 0x1B4E / 6990
{
	bool bVar0;
	bool bVar1;
...
void Function_25(bool bParam0, bool bParam1, int iParam2) //Position: 0x1BA0 / 7072
{
	bool bVar0;
	bool bVar1;
...
void Function_27(int iParam0, bool bParam1, bool bParam2) //Position: 0x1BFA / 7162
{
	bool bVar0;
	bool bVar1;
...
bool Function_28(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x1D1D / 7453
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
vector3 Function_29(bool bParam0) //Position: 0x1D8B / 7563
{
	vector3 vVar0;
...
bool Function_30(vector3 vParam0) //Position: 0x1DF5 / 7669
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_31(bool bParam0) //Position: 0x1E0D / 7693
{
	bool bVar0;
	bool bVar1;
...
var Function_32(bool bParam0) //Position: 0x1E64 / 7780
{
	bool bVar0;
	bool bVar1;
...
void Function_33(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x1EAA / 7850
{
	bool bVar0;
	bool bVar1;
...
void Function_34(bool bParam0, bool bParam1) //Position: 0x1F18 / 7960
{
	bool bVar0;
	bool bVar1;
...
bool Function_35(bool bParam0, var uParam1, var uParam2, var uParam3, bool bParam4, float fParam5) //Position: 0x1F60 / 8032
{
	float fVar0;
...
void Function_36(bool bParam0) //Position: 0x20F7 / 8439
{
...
void Function_37(bool bParam0) //Position: 0x212B / 8491
{
	SAY_SINGLE_LINE_CONTEXT(bParam0, 60, Global_34573, 1, 0, 2, 4294967295, 4294967295, 0, 1);
	return;
}

bool Function_38(var uParam0, int iParam1) //Position: 0x2142 / 8514
{
	return (uParam0 && iParam1) == 0;
}

var Function_39(bool bParam0, bool bParam1) //Position: 0x214F / 8527
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_40(bool bParam0) //Position: 0x2240 / 8768
{
	struct<21> Var0;
...
bool Function_41() //Position: 0x22FE / 8958
{
	return (RAND_INT_RANGE(0, 1999) / 1000) != 0;
}

var Function_42(int iParam0) //Position: 0x2311 / 8977
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_43(int iParam0) //Position: 0x23C2 / 9154
{
...
bool Function_44(int iParam0) //Position: 0x23E1 / 9185
{
...
bool Function_45(int iParam0) //Position: 0x2405 / 9221
{
...
bool Function_46(int iParam0) //Position: 0x241A / 9242
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x2431 / 9265
{
	int iVar0;
...
var Function_48(int iParam0) //Position: 0x246E / 9326
{
...
bool Function_49(int iParam0) //Position: 0x2488 / 9352
{
...
int Function_50(int iParam0, int iParam1) //Position: 0x249E / 9374
{
	int iVar0;
...
void Function_51(bool bParam0, bool bParam1, var uParam2, int iParam3, var uParam4) //Position: 0x24D7 / 9431
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void Function_52(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6) //Position: 0x25A4 / 9636
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
void Function_53(bool bParam0, bool bParam1) //Position: 0x273B / 10043
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_54(bool bParam0) //Position: 0x275D / 10077
{
	bool bVar0;
	bool bVar1;
...
var Function_55(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x27A1 / 10145
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_56(var uParam0, var uParam1, var uParam2, float fParam3, vector3 vParam4) //Position: 0x28EA / 10474
{
	var uVar0[5];
	int iVar6;
...
int Function_57(bool bParam0, bool bParam1, var uParam2, float fParam3, int iParam4, vector3 vParam5) //Position: 0x298B / 10635
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
bool Function_58(var uParam0, int iParam1) //Position: 0x2A1F / 10783
{
...
bool Function_59(int iParam0) //Position: 0x2A68 / 10856
{
	bool bVar0;
...
void Function_60(bool bParam0, bool bParam1) //Position: 0x3142 / 12610
{
	var uVar0;
...
var Function_61(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3184 / 12676
{
	int iVar0;
	int iVar1;
...
void Function_62(var uParam0, int iParam1) //Position: 0x31BC / 12732
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_63(var uParam0, int iParam1, int iParam2) //Position: 0x31CD / 12749
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3291 / 12945
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_65(int iParam0) //Position: 0x32DA / 13018
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x3655 / 13909
{
	if (!Function_119(128))
	{
		return;
...
bool Function_67() //Position: 0x3695 / 13973
{
	int iVar0;
...
void Function_68() //Position: 0x36C0 / 14016
{
	if (!Function_119(128))
	{
		return;
...
void Function_69(int iParam0, bool bParam1) //Position: 0x3702 / 14082
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x3786 / 14214
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x37AF / 14255
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x3800 / 14336
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x3810 / 14352
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3824 / 14372
{
	int iVar0;
...
var Function_75() //Position: 0x3849 / 14409
{
	return "PackedMetadata";
}

void Function_76(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3860 / 14432
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_77() //Position: 0x398B / 14731
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_78() //Position: 0x399C / 14748
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_79() //Position: 0x39AD / 14765
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_80(var uParam0, int iParam1) //Position: 0x39BE / 14782
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x39E1 / 14817
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3A00 / 14848
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3A0C / 14860
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3A17 / 14871
{
	int iVar0;
...
var Function_85() //Position: 0x3A45 / 14917
{
	return "PackedWeapon";
}

int Function_86(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x3A5A / 14938
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_87() //Position: 0x3B5E / 15198
{
	return "MPItemGiver";
}

struct<32> Function_88(bool bParam0) //Position: 0x3B72 / 15218
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3BDC / 15324
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3BFB / 15355
{
	return "PBox_";
}

var Function_91() //Position: 0x3C09 / 15369
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3C2F / 15407
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3C57 / 15447
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3C7D / 15485
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3DDE / 15838
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3E79 / 15993
{
	int iVar0;
	vector3 vVar1;
...
void Function_97(int iParam0) //Position: 0x3FDA / 16346
{
...
var Function_98() //Position: 0x403E / 16446
{
	int iVar0;
...
var Function_99(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x4046 / 16454
{
	return Function_100(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_100(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x405F / 16479
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x4352 / 17234
{
	int iVar0;
...
void Function_102() //Position: 0x4406 / 17414
{
	int iVar0;
...
bool Function_103(bool bParam0) //Position: 0x4440 / 17472
{
	int iVar0;
...
void Function_104(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x446D / 17517
{
	int iVar0;
...
bool Function_105(bool bParam0) //Position: 0x45BE / 17854
{
...
void Function_106() //Position: 0x45D5 / 17877
{
	int iVar0;
...
var Function_107(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x4620 / 17952
{
	int iVar0;
...
int Function_108() //Position: 0x46F0 / 18160
{
	int iVar0;
...
int Function_109() //Position: 0x484C / 18508
{
	int iVar0;
...
bool Function_110(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x496C / 18796
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_111(var uParam0, int iParam1) //Position: 0x4A3C / 19004
{
	vector3 vVar0;
	int iVar3;
...
bool Function_112(var uParam0, float fParam1, int iParam2, int iParam3) //Position: 0x4A5A / 19034
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
float Function_113(bool bParam0, vector3 vParam1) //Position: 0x4B8C / 19340
{
	vector3 vVar0;
...
bool Function_114(char* cParam0) //Position: 0x4C06 / 19462
{
	bool bVar0;
...
int Function_115() //Position: 0x4C25 / 19493
{
	if (Function_117())
	{
...
int Function_116() //Position: 0x4C3E / 19518
{
	return Global_79349.f_16;
}

bool Function_117() //Position: 0x4C4A / 19530
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_118(int iParam0, bool bParam1, bool bParam2) //Position: 0x4C53 / 19539
{
	var uVar0;
...
bool Function_119(int iParam0) //Position: 0x4CD0 / 19664
{
	int iVar0;
