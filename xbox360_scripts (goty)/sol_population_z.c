...
void main() //Position: 0x0 / 0
{
	...
	strcpy(&Global_13171, "Sol", 4);
	Function_12("Loading Solomons Folly population file", 3);
	Global_30839++;
	...
	bVar2 = FIND_NAMED_LAYOUT("SolomonsFolly_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "solv_region");
...
void Function_1(var uParam0, var uParam1) //Position: 0xC8A / 3210
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC99 / 3225
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCEE / 3310
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD6E / 3438
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD8A / 3466
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDC8 / 3528
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDE4 / 3556
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xDF4 / 3572
{
	int iVar0;
	int iVar1;
...
void Function_9(int iParam0) //Position: 0xE39 / 3641
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE45 / 3653
{
	int iVar0;
	int iVar1;
...
var Function_11(bool bParam0, int iParam1) //Position: 0xEC1 / 3777
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_12(bool bParam0, var uParam1) //Position: 0xECE / 3790
{
	if (!Function_4(128))
	{
		return;
