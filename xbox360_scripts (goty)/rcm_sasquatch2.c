		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					case 0x00000000:
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (IS_LAYOUTREF_VALID(bLocal_258))
							{
								...
								{
									bLocal_262 = CREATE_VOLUME_IN_LAYOUT(bLocal_258, "sasquatchWandervol", 2, *(&Global_63541[3255] + 100), 0.0f, 0.0f, 0.0f, 50.0f, 20.0f, 50.0f);
									Function_124(StackVal, StackVal, &bLocal_259, *(&Global_63541[3255] + 100), 0.0f, Global_63541[3255].f_124, 0.0f, bLocal_262);
									iVar0 = 1;
								}
							}
							else
					...
					case 0x00000001:
						if (Function_123(StackVal, StackVal, &bLocal_259, *(&Global_63541[3255] + 100), 0.0f, Global_63541[3255].f_124, 0.0f, bLocal_262))
						{
					...
					case 0x00000005:
						...
						{
							Function_122("sasquatch2_OBJ", 0x40f00000, 1, 2, 0, 0, 0, 0);
							...
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "sasquatch2_OBJ", 0, 3, false);
...
void Function_1() //Position: 0x2C9 / 713
{
...
int Function_2(bool bParam0, bool bParam1, bool bParam2) //Position: 0x327 / 807
{
	if (bParam2)
	{
...
void Function_3(bool bParam0) //Position: 0x356 / 854
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_4(int iParam0) //Position: 0x373 / 883
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x399 / 921
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x4C7 / 1223
{
	int iVar0;
...
bool Function_7(int iParam0, bool bParam1) //Position: 0x4E1 / 1249
{
	int iVar0;
...
bool Function_8(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x4FE / 1278
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

void Function_9(var uParam0, int iParam1) //Position: 0x518 / 1304
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_10(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x527 / 1319
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_11(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x956 / 2390
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_12() //Position: 0xAC9 / 2761
{
	return;
}

void Function_13(var uParam0, var uParam1) //Position: 0xACF / 2767
{
	if (Global_3381)
	{
		return;
...
bool Function_14() //Position: 0xB11 / 2833
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_15(bool bParam0) //Position: 0xB1A / 2842
{
...
void Function_18() //Position: 0xCC3 / 3267
{
	float fVar0;
...
void Function_19() //Position: 0xCF6 / 3318
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_20() //Position: 0xE84 / 3716
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21() //Position: 0x1038 / 4152
{
	Function_22(&Global_28260, 1, 0);
	return;
}

void Function_22(int iParam0, bool bParam1, var uParam2) //Position: 0x1046 / 4166
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_23() //Position: 0x1237 / 4663
{
...
struct<8> Function_24(int iParam0) //Position: 0x124C / 4684
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_25(int iParam0, bool bParam1, bool bParam2) //Position: 0x12F2 / 4850
{
	int iVar0;
...
void Function_26(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x158D / 5517
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_27() //Position: 0x1BBA / 7098
{
	int iVar0;
...
var Function_28(int iParam0) //Position: 0x1BC2 / 7106
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_29(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1BD3 / 7123
{
	char* cVar0[32];
...
struct<32> Function_30(char* cParam0, bool bParam1) //Position: 0x1CC8 / 7368
{
	char* cVar0[32];
...
void Function_31(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1CE1 / 7393
{
	float fVar0;
...
var Function_32(int iParam0, int iParam1) //Position: 0x1D46 / 7494
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_33(int iParam0, bool bParam1) //Position: 0x1D58 / 7512
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_34(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1D6A / 7530
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_35(int iParam0) //Position: 0x1E9A / 7834
{
	return Global_35278[iParam020].f_48;
}

float Function_36(int iParam0) //Position: 0x1EA9 / 7849
{
	if (!iParam0 != 4294967295)
	{
...
var Function_37(int iParam0) //Position: 0x1EE2 / 7906
{
	if (iParam0 == 4294967295)
	{
...
void Function_38(int iParam0) //Position: 0x1F1F / 7967
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_39(int iParam0, bool bParam1, bool bParam2) //Position: 0x20B9 / 8377
{
	int iVar0;
	int iVar1;
...
int Function_40(bool bParam0) //Position: 0x22FD / 8957
{
...
struct<8> Function_41() //Position: 0x233E / 9022
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_42() //Position: 0x23C7 / 9159
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_43() //Position: 0x245E / 9310
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_44() //Position: 0x24DD / 9437
{
...
int Function_45(int iParam0, bool bParam1, int iParam2) //Position: 0x2516 / 9494
{
	int iVar0;
	int iVar1;
...
void Function_46() //Position: 0x2720 / 10016
{
	vector3 vVar0;
	var uVar3;
...
bool Function_47(vector3 vParam0) //Position: 0x27DB / 10203
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_48(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x27F3 / 10227
{
	int iVar0;
...
vector3 Function_49() //Position: 0x28DA / 10458
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_50(int iParam0) //Position: 0x28E3 / 10467
{
...
int Function_51(bool bParam0, bool bParam1) //Position: 0x28F9 / 10489
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_52(vector3 vParam0, vector3 vParam3) //Position: 0x29C0 / 10688
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_53(var uParam0, int iParam1) //Position: 0x29DD / 10717
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_54(int iParam0) //Position: 0x3202 / 12802
{
	var uVar0;
...
bool Function_55(var uParam0, int iParam1) //Position: 0x323D / 12861
{
	return (uParam0 && iParam1) == 0;
}

void Function_56(bool bParam0, bool bParam1) //Position: 0x324A / 12874
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_57(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3257 / 12887
{
	uParam0 = uParam0;
...
void Function_58(int iParam0) //Position: 0x32FB / 13051
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
...
int Function_59(int iParam0) //Position: 0x3BF0 / 15344
{
...
bool Function_60(int iParam0) //Position: 0x3C0A / 15370
{
...
bool Function_61(int iParam0, int iParam1) //Position: 0x3C21 / 15393
{
	int iVar0;
...
bool Function_62() //Position: 0x3C3D / 15421
{
	return STRING_TO_HASH(Function_63());
}

var Function_63() //Position: 0x3C49 / 15433
{
	return "ZOMBIE_STORY";
}

bool Function_64(int iParam0) //Position: 0x3C5E / 15454
{
...
int Function_65(int iParam0) //Position: 0x3CC4 / 15556
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
bool Function_66(int iParam0) //Position: 0x3D86 / 15750
{
...
void Function_67(char* cParam0) //Position: 0x3D9B / 15771
{
...
bool Function_68(int iParam0, bool bParam1) //Position: 0x3DE3 / 15843
{
	int iVar0;
...
var Function_69(int iParam0) //Position: 0x3E20 / 15904
{
...
bool Function_70(int iParam0) //Position: 0x3E3A / 15930
{
...
void Function_71(bool bParam0) //Position: 0x3E50 / 15952
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72(int iParam0, int iParam1) //Position: 0x3FF2 / 16370
{
	float fVar0;
	bool bVar1;
...
void Function_73(int iParam0) //Position: 0x40AE / 16558
{
	float fVar0;
	bool bVar1;
...
int Function_74(var uParam0, int iParam1) //Position: 0x4150 / 16720
{
	int iVar0;
	var uVar1;
...
void Function_75(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x42B1 / 17073
{
	struct<8> Var0;
...
struct<32> Function_76(bool bParam0) //Position: 0x434C / 17228
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_77(char* cParam0, char* cParam1, char* cParam2) //Position: 0x43B6 / 17334
{
	char* cVar0[32];
...
int Function_78(bool bParam0) //Position: 0x43D5 / 17365
{
	int iVar0;
	vector3 vVar1;
...
float Function_79(bool bParam0, vector3 vParam1) //Position: 0x4536 / 17718
{
	vector3 vVar0;
...
vector3 Function_80(bool bParam0) //Position: 0x45B0 / 17840
{
	vector3 vVar0;
...
void Function_81(int iParam0) //Position: 0x461A / 17946
{
...
bool Function_82(int iParam0) //Position: 0x467B / 18043
{
...
void Function_83(int iParam0, int iParam1) //Position: 0x4691 / 18065
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void Function_84(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4B23 / 19235
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_85(int iParam0) //Position: 0x4B9E / 19358
{
	char* cVar0[16];
...
bool Function_86() //Position: 0x4BDD / 19421
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_87(bool bParam0) //Position: 0x4C0A / 19466
{
...
var Function_88(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4C36 / 19510
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_89(int iParam0) //Position: 0x4C52 / 19538
{
...
bool Function_90(int iParam0, int iParam1) //Position: 0x4C67 / 19559
{
...
bool Function_91(int iParam0, int iParam1) //Position: 0x4D7C / 19836
{
	int iVar0;
...
bool Function_92(int iParam0) //Position: 0x4EC0 / 20160
{
	if (!Function_60(iParam0))
	{
		return 0;
...
bool Function_93(int iParam0) //Position: 0x4EE4 / 20196
{
...
bool Function_94(int iParam0) //Position: 0x4EF9 / 20217
{
	return StackVal;
}

bool Function_95(int iParam0) //Position: 0x4F09 / 20233
{
	if (!iParam0->f_152)
	{
		if (Function_120())
...
bool Function_96(int iParam0) //Position: 0x4FAD / 20397
{
...
bool Function_97(int iParam0) //Position: 0x5006 / 20486
{
	int iVar0;
...
bool Function_98(var uParam0, int iParam1) //Position: 0x5022 / 20514
{
	int iVar0;
...
int Function_99(int iParam0) //Position: 0x503E / 20542
{
...
int Function_100(int iParam0) //Position: 0x5053 / 20563
{
...
void Function_101() //Position: 0x5068 / 20584
{
...
var Function_102(int iParam0, int iParam1) //Position: 0x50E3 / 20707
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_103(int iParam0) //Position: 0x5CD4 / 23764
{
	int iVar0;
	int iVar1;
...
bool Function_104(int iParam0) //Position: 0x5D23 / 23843
{
...
int Function_105(int iParam0) //Position: 0x5D39 / 23865
{
...
void Function_106() //Position: 0x5DA2 / 23970
{
...
bool Function_107(int iParam0) //Position: 0x5DC5 / 24005
{
	if (!Function_104(iParam0))
	{
...
bool Function_108(int iParam0, int iParam1) //Position: 0x5E16 / 24086
{
	int iVar0;
...
bool Function_109(int iParam0) //Position: 0x5E43 / 24131
{
	if (!Function_104(iParam0))
	{
...
void Function_110(bool bParam0) //Position: 0x5E95 / 24213
{
	int iVar0;
...
void Function_111() //Position: 0x5ECF / 24271
{
	bool bVar0;
...
void Function_112(int iParam0, int iParam1) //Position: 0x5F2D / 24365
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_113(bool bParam0) //Position: 0x5F40 / 24384
{
	PRINTSTRING("Day ");
...
void Function_114(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5F86 / 24454
{
	bool bVar0;
	char* cVar1[16];
...
void Function_115(char* cParam0, int iParam1) //Position: 0x5FF2 / 24562
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_116(bool bParam0, var uParam1, int iParam2) //Position: 0x6029 / 24617
{
	var uVar0;
	char* cVar1[16];
...
int Function_117(char* cParam0) //Position: 0x60A1 / 24737
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_118(int iParam0) //Position: 0x6142 / 24898
{
	int iVar0;
	int iVar1;
...
bool Function_119(int iParam0, int iParam1) //Position: 0x617F / 24959
{
...
bool Function_120() //Position: 0x6192 / 24978
{
...
void Function_121(bool bParam0, bool bParam1) //Position: 0x61AD / 25005
{
	bool bVar0;
...
void Function_122(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x61D2 / 25042
{
	struct<4> Var0;
	int iVar4;
...
bool Function_123(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7) //Position: 0x6257 / 25175
{
...
void Function_124(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7) //Position: 0x62BB / 25275
{
	bool bVar0;
	bool bVar1;
...
bool Function_125(int iParam0) //Position: 0x6404 / 25604
{
	int iVar0;
	int iVar1;
...
void Function_126() //Position: 0x677F / 26495
{
	if (!Function_97(128))
	{
		return;
...
bool Function_127() //Position: 0x67BF / 26559
{
	int iVar0;
...
void Function_128(var uParam0, int iParam1) //Position: 0x67EA / 26602
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_129() //Position: 0x67FB / 26619
{
	if (!Function_97(128))
	{
		return;
...
void Function_130(var uParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x683D / 26685
{
	vector3 vVar0;
...
void Function_131(int iParam0) //Position: 0x6901 / 26881
{
	Function_132(iParam0, 0.0f);
	return;
}

void Function_132(var uParam0, float fParam1) //Position: 0x690D / 26893
{
...
float Function_133(int iParam0) //Position: 0x692E / 26926
{
...
bool Function_134(int iParam0) //Position: 0x69F6 / 27126
{
	return Function_55(*iParam0, 2);
}

void Function_135(int iParam0) //Position: 0x6A03 / 27139
{
	if (!Function_136(iParam0))
	{
		Function_132(iParam0, 0.0f);
...
bool Function_136(int iParam0) //Position: 0x6A18 / 27160
{
	return Function_55(*iParam0, 1);
}

var Function_137(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x6A25 / 27173
{
	int iVar0;
