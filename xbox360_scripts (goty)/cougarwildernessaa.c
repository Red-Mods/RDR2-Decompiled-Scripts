...
void main() //Position: 0x0 / 0
{
	...
	iLocal_98 = 0;
	iLocal_132 = 1;
	vLocal_99 = Global_30723[4];
	if (!Function_208(&vLocal_99))
	{
...
void Function_1() //Position: 0x6B / 107
{
	...
	Function_70(bLocal_126);
	Function_68(iLocal_19);
	DESTROY_ACTORSET(iLocal_19);
...
int Function_18(int iParam0, bool bParam1) //Position: 0xCCC / 3276
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_73(bool bParam0, bool bParam1) //Position: 0x1931 / 6449
{
	int iVar0;
	int iVar1;
...
{
	if (!Function_156(&vLocal_99, &bLocal_126, 20588, 1, 0))
	{
		return 0;
	}
	switch (vLocal_99.y)
		...
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				if ((&vLocal_99 + 16)->f_32)
				{
					Function_119(1, "a");
					Function_112(0, "b");
					Function_109("AM_MH_8_help", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
...
bool Function_88(bool bParam0, bool bParam1, float fParam2) //Position: 0x1D81 / 7553
{
	struct<17> Var0;
...
bool Function_89(int iParam0) //Position: 0x1FD4 / 8148
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_90(bool bParam0) //Position: 0x2017 / 8215
{
	int iVar0;
...
int Function_91(int iParam0) //Position: 0x203E / 8254
{
	return *iParam0;
}

void Function_92(var uParam0, int iParam1) //Position: 0x2047 / 8263
{
	*uParam0 = Local_51[iParam12];
	return;
}

void Function_93(int iParam0) //Position: 0x2056 / 8278
{
	Function_60(iParam0, 4294967286);
	return;
}

bool Function_94(bool bParam0) //Position: 0x2064 / 8292
{
	return _IS_CLIENT_DATA_VALID_FOR_SLOT(&Local_51, bParam0);
}

void Function_95(var uParam0, bool bParam1) //Position: 0x2071 / 8305
{
	if (bParam1)
	{
...
bool Function_96(bool bParam0) //Position: 0x208B / 8331
{
	return Function_40(*bParam0, 2);
}

bool Function_97() //Position: 0x2098 / 8344
{
...
bool Function_98(int iParam0, var uParam1, int iParam2) //Position: 0x20B6 / 8374
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_99(int iParam0, bool bParam1) //Position: 0x2107 / 8455
{
	if (bParam1)
	{
...
bool Function_100(int iParam0) //Position: 0x2121 / 8481
{
	return Function_40(*iParam0, 1);
}

void Function_101(int iParam0) //Position: 0x212E / 8494
{
	bool bVar0;
	int iVar1;
	struct<13> Var2;
...
int Function_102(bool bParam0) //Position: 0x222B / 8747
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_103(int iParam0, float fParam1) //Position: 0x227B / 8827
{
	Function_104(iParam0, -fParam1);
	return;
}

void Function_104(var uParam0, float fParam1) //Position: 0x2289 / 8841
{
	Function_64();
...
void Function_105(var uParam0, var uParam1) //Position: 0x229D / 8861
{
	uParam0->f_4 = uParam1;
...
void Function_106() //Position: 0x22BA / 8890
{
	bool bVar0;
	
	bVar0 = false;
	while (bVar0 <= SQUAD_GET_SIZE(bLocal_133))
	{
		Function_107(SQUAD_GET_ACTOR_BY_INDEX(bLocal_133, bVar0), Global_78576);
		bVar0++;
	}
	return;
}

void Function_107(bool bParam0, int iParam1) //Position: 0x22E4 / 8932
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_108(int iParam0, int iParam1) //Position: 0x23A6 / 9126
{
	if (!Function_67(iParam0))
	{
...
void Function_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x23BC / 9148
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_110(int iParam0) //Position: 0x2437 / 9271
{
	char* cVar0[16];
...
bool Function_111() //Position: 0x2476 / 9334
{
...
void Function_112(char* cParam0, bool bParam1) //Position: 0x2491 / 9361
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	
	iLocal_127 = Function_118();
	...
	{
		case 0x00000003:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_01", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_02", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_03", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_04", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_05", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_06", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_07", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_08", fVar3, fVar4);
		
		case 0x00000002:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_09", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_10", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_11", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_12", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_13", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_14", fVar3, fVar4);
		
		case 0x00000001:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1091, "cougar_cougar_15", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1093, "cougar_cougar_16", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1087, "cougar_cougar_17", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1092, "cougar_cougar_18", fVar3, fVar4);
			break;
	}
	return;
}

void Function_113(var uParam0, char* cParam1, vector3 vParam2, var uParam5, char* cParam6, float fParam7, float fParam8) //Position: 0x276F / 10095
{
	char* cVar0[32];
	var uVar8;
	...
	uVar8 = Function_116(StackVal, StackVal, vParam2, &bLocal_126, uParam5, &cVar0, fParam7, fParam8);
	Function_114(uVar8, uParam0);
}

void Function_114(bool bParam0, int iParam1) //Position: 0x279D / 10141
{
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_115(bool bParam0, bool bParam1) //Position: 0x27C0 / 10176
{
	switch (bParam1)
	{
		case 0x00000000:
		...
		case 0x00000001:
			SQUAD_JOIN(bParam0, bLocal_133);
			SET_ACTOR_MAX_HEALTH(bParam0, 250.0f);
			SET_ACTOR_HEALTH(bParam0, 250.0f);
...
var Function_116(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x2859 / 10329
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool Function_117(vector3 vParam0) //Position: 0x28E5 / 10469
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_118() //Position: 0x28FD / 10493
{
	int iVar0;
	int iVar1;
...
void Function_119(char* cParam0, int iParam1) //Position: 0x292C / 10540
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 5.0f;
	fVar4 = 75.0f;
	Function_113(StackVal, StackVal, cParam0, iParam1, vVar0, 1094, "named_cougar_01", fVar3, fVar4);
	return;
}

void Function_120(var uParam0, bool bParam1) //Position: 0x2973 / 10611
{
	struct<9> Var0;
...
void Function_121() //Position: 0x29AA / 10666
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
...
void Function_122(int iParam0) //Position: 0x2A62 / 10850
{
	var uVar0;
	
	uVar0 = iParam0;
	NET_SCRIPTMSG_SEND(3, 94, &uVar0, 1, 1);
	return;
}

int Function_123(int iParam0) //Position: 0x2A77 / 10871
{
...
void Function_124(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x2A9F / 10911
{
	bool bVar0;
	bool bVar1;
...
void Function_125() //Position: 0x2B21 / 11041
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
...
void Function_126(var uParam0, int iParam1) //Position: 0x2BCC / 11212
{
	bool bVar0;
	bool bVar1;
...
void Function_127() //Position: 0x2C68 / 11368
{
	int iVar0;
	...
	switch (vLocal_99.z)
	{
		...
		case 0x00000006:
			bLocal_126 = CREATE_LAYOUT("cougarWilderness");
			Function_134(&vLocal_99, bLocal_126);
			Function_133();
			Global_78480.f_24 = 4294967294;
			Function_51(256);
			iVar0 = 12053;
			NET_SCRIPTMSG_REGISTER_HANDLER(94, iVar0);
			vLocal_99.f_8 = 106;
			break;
...
void Function_128(var uParam0) //Position: 0x2D00 / 11520
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_131(int iParam0) //Position: 0x2E80 / 11904
{
...
void Function_132(var uParam0) //Position: 0x2F15 / 12053
{
	int iVar0;
...
void Function_133() //Position: 0x2F3B / 12091
{
	bLocal_133 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_126, "squad_cougar"));
...
void Function_134(var uParam0, bool bParam1) //Position: 0x2F83 / 12163
{
...
void Function_135(int iParam0) //Position: 0x2FF4 / 12276
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

void Function_136(var uParam0) //Position: 0x3005 / 12293
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_137() //Position: 0x3013 / 12307
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_138(int iParam0) //Position: 0x302C / 12332
{
	int iVar0;
	int iVar1;
...
void Function_139() //Position: 0x33A7 / 13223
{
	if (!Function_140(128))
	{
		return;
...
bool Function_140(int iParam0) //Position: 0x33E7 / 13287
{
	int iVar0;
...
bool Function_141() //Position: 0x3403 / 13315
{
	int iVar0;
...
void Function_142(var uParam0, int iParam1) //Position: 0x342E / 13358
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_143() //Position: 0x343F / 13375
{
	if (!Function_140(128))
	{
		return;
...
void Function_144() //Position: 0x3481 / 13441
{
	Function_145(&uLocal_128, "mp_action_areas", 10, 0);
	return;
}

var Function_145(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x34A2 / 13474
{
	int iVar0;
	var uVar1;
...
var Function_146(var uParam0, int iParam1, int iParam2) //Position: 0x34DA / 13530
{
	int iVar0;
...
bool Function_147(int iParam0) //Position: 0x359E / 13726
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
bool Function_148(int iParam0) //Position: 0x364A / 13898
{
...
void Function_149(int iParam0) //Position: 0x3660 / 13920
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_150(int iParam0) //Position: 0x3674 / 13940
{
	if (Function_67(iParam0))
	{
...
float Function_151(float fParam0) //Position: 0x368F / 13967
{
	return -Function_63(fParam0);
}

bool Function_152() //Position: 0x369B / 13979
{
	return iLocal_20;
}

void Function_153() //Position: 0x36A3 / 13987
{
	struct<13> Var0;
...
void Function_154(bool bParam0) //Position: 0x36CF / 14031
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 14113);
	return;
}

void Function_155(var uParam0) //Position: 0x3721 / 14113
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
bool Function_156(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x3824 / 14372
{
	if (!Function_206())
	{
		return 0;
	...
	if (StackVal != 0)
	{
		Function_195(bLocal_41, *uParam1, uParam2, 1);
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_174(18608, 17956);
			break;
		
		case 0x00000002:
			Function_174(15300, 14571);
			break;
...
int Function_157(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x38EB / 14571
{
	bool bVar0;
	bool bVar1;
	...
	if (Global_76943[bParam096].f_24 == Global_78480.f_24)
	{
		...
		bVar0 = Function_164(29, bParam0);
		bVar1 = false;
		if (!bParam1)
		{
			Function_162(bParam0, bVar0, 0);
...
int Function_158(int iParam0) //Position: 0x398E / 14734
{
	return Function_159(0, iParam0);
}

int Function_159(int iParam0, bool bParam1) //Position: 0x399A / 14746
{
	char* cVar0[64];
...
bool Function_160(bool bParam0) //Position: 0x3A01 / 14849
{
	char* cVar0[64];
...
var Function_161(int iParam0) //Position: 0x3AA2 / 15010
{
	return (*&Global_78480 + 132)[iParam0];
}

bool Function_162(bool bParam0, bool bParam1, int iParam2) //Position: 0x3AB2 / 15026
{
	var uVar0;
	
	return Function_163(bParam0, bParam1, &uVar0, iParam2);
}

int Function_163(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x3AC3 / 15043
{
	char* cVar0[32];
...
int Function_164(int iParam0, bool bParam1) //Position: 0x3B28 / 15144
{
	char* cVar0[64];
...
void Function_165(bool bParam0, int iParam1, char* cParam2) //Position: 0x3B96 / 15254
{
	if (bParam0)
	{
		if (Function_166())
...
bool Function_166() //Position: 0x3BB7 / 15287
{
	return Function_39(32768);
}

int Function_167() //Position: 0x3BC4 / 15300
{
	if (!Function_168(1))
	{
		return 0;
...
bool Function_168(bool bParam0) //Position: 0x3C80 / 15488
{
	char* cVar0[64];
...
void Function_169(bool bParam0) //Position: 0x3D01 / 15617
{
...
var Function_170(int iParam0, bool bParam1) //Position: 0x3D8A / 15754
{
	int iVar0;
...
struct<64> Function_171(var uParam0) //Position: 0x3DAA / 15786
{
...
struct<64> Function_172(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x3DBE / 15806
{
	char* cVar0[64];
...
int Function_173(bool bParam0, bool bParam1) //Position: 0x3E03 / 15875
{
...
void Function_174(int iParam0, int iParam1) //Position: 0x3E37 / 15927
{
	Function_175(iParam0, iParam1, 17949);
	return;
}

void Function_175(var uParam0, var uParam1, int iParam2) //Position: 0x3E48 / 15944
{
...
void Function_176() //Position: 0x3FE1 / 16353
{
	if (Function_39(4194304))
	{
...
void Function_177(var uParam0, var uParam1, int iParam2) //Position: 0x40F1 / 16625
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_178(bool bParam0, int iParam1, bool bParam2) //Position: 0x4269 / 17001
{
	char* cVar0[64];
	int iVar16;
...
var Function_179(int iParam0) //Position: 0x42EA / 17130
{
	switch (iParam0)
	{
		case 0x00000002:
...
void Function_180(bool bParam0) //Position: 0x4603 / 17923
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
int Function_181() //Position: 0x461D / 17949
{
	return 1;
}

int Function_182(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x4624 / 17956
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (bLocal_16)
	{
		...
		bVar1 = (bVar1 + Function_18((CEIL(Function_185(1, bParam0)) / 1000), 9999));
	}
	else
	{
		bVar1 = FLOOR(Function_185(8, bParam0));
	}
	if (!bParam1)
	{
		Function_162(bParam0, bVar1, 0);
	}
	iVar6 = 0;
	if (Function_184(1) > 0)
	{
...
var Function_183(int iParam0) //Position: 0x47E5 / 18405
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_184(int iParam0) //Position: 0x47F8 / 18424
{
...
float Function_185(int iParam0, bool bParam1) //Position: 0x4818 / 18456
{
	char* cVar0[64];
...
int Function_186(bool bParam0) //Position: 0x4881 / 18561
{
	if (!Function_160(bParam0))
	{
		return 4294967295;
...
var Function_187() //Position: 0x48A6 / 18598
{
	return Global_78480;
}

int Function_188() //Position: 0x48B0 / 18608
{
	bool bVar0;
	int iVar1;
...
void Function_189() //Position: 0x49D3 / 18899
{
	if (Function_39(4096))
	{
...
void Function_190(int iParam0) //Position: 0x4A10 / 18960
{
	int iVar0;
	int iVar1;
...
void Function_191(int iParam0) //Position: 0x4A89 / 19081
{
	struct<13> Var0;
...
void Function_192(int iParam0) //Position: 0x4AB4 / 19124
{
	int iVar0;
...
void Function_193(var uParam0, bool bParam1) //Position: 0x4AFB / 19195
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_194(bool bParam0) //Position: 0x4C46 / 19526
{
	vector3 vVar0;
...
int Function_195(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4C57 / 19543
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_196(bool bParam0) //Position: 0x4D39 / 19769
{
	bool bVar0;
...
void Function_197() //Position: 0x4D93 / 19859
{
	Function_198(4);
	return;
}

void Function_198(int iParam0) //Position: 0x4D9D / 19869
{
	var uVar0;
	var uVar1;
...
void Function_199(var uParam0) //Position: 0x4DCF / 19919
{
	var uVar0;
...
void Function_200() //Position: 0x4DDE / 19934
{
	bool bVar0;
...
void Function_201() //Position: 0x4E13 / 19987
{
	int iVar0;
...
bool Function_202(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x4E2C / 20012
{
	bool bVar0;
...
bool Function_203(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x4E95 / 20117
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_204(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4F82 / 20354
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int Function_205(int iParam0) //Position: 0x5030 / 20528
{
	if (iParam0 > 40)
	{
		return 0;
...
bool Function_206() //Position: 0x5049 / 20553
{
	int iVar0;
...
void Function_207(bool bParam0) //Position: 0x506C / 20588
{
	Function_115(bParam0, NET_ACTOR_GET_SCRIPT_INT(bParam0));
	return;
}

bool Function_208(int iParam0) //Position: 0x507C / 20604
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	Function_234(iParam0 + 16 + 8);
	Function_232(iParam0, 22236);
	iVar1 = 0;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 20921);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 20882);
	return 1;
}

void Function_209(var uParam0) //Position: 0x5192 / 20882
{
	int iVar0;
...
void Function_210(var uParam0) //Position: 0x51B9 / 20921
{
	struct<13> Var0;
...
void Function_211(var uParam0) //Position: 0x5230 / 21040
{
	struct<13> Var0;
...
void Function_212(var uParam0, int iParam1) //Position: 0x527D / 21117
{
	bool bVar0;
	int iVar1;
...
void Function_213(int iParam0) //Position: 0x52D2 / 21202
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_214(int iParam0) //Position: 0x52E4 / 21220
{
...
void Function_215() //Position: 0x53A8 / 21416
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_216(bool bParam0, bool bParam1) //Position: 0x53C1 / 21441
{
	var uVar0;
	...
	if (!bParam0)
	{
		Function_219(37, uVar0);
	}
	Function_218(18264, 0);
	Function_217();
	return;
}

void Function_217() //Position: 0x540D / 21517
{
...
void Function_218(int iParam0, bool bParam1) //Position: 0x542C / 21548
{
	if (bParam1)
	{
...
void Function_219(int iParam0, var uParam1) //Position: 0x5467 / 21607
{
	if (iParam0 > 40)
	{
		return;
...
void Function_220() //Position: 0x5481 / 21633
{
	Function_221(&Global_78480 + 220);
	return;
}

void Function_221(int iParam0) //Position: 0x5490 / 21648
{
	int iVar0;
...
void Function_222(int iParam0) //Position: 0x54B1 / 21681
{
	int iVar0;
...
void Function_223(int iParam0) //Position: 0x54D5 / 21717
{
	int iVar0;
...
void Function_224() //Position: 0x54F9 / 21753
{
...
void Function_225(bool bParam0) //Position: 0x5559 / 21849
{
...
void Function_226(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x5573 / 21875
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
...
void Function_227(var uParam0, int iParam1) //Position: 0x562A / 22058
{
	bool bVar0;
...
bool Function_228(int iParam0, bool bParam1) //Position: 0x564F / 22095
{
	return Function_40(Global_50170[iParam022].f_32, bParam1);
}

struct<16> Function_229(int iParam0) //Position: 0x5663 / 22115
{
	char* cVar0[16];
...
var Function_230(int iParam0) //Position: 0x5697 / 22167
{
	return Global_50170[iParam022].f_24;
}

void Function_231() //Position: 0x56A6 / 22182
{
	int iVar0;
...
void Function_232(var uParam0, int iParam1) //Position: 0x56D0 / 22224
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_233(var uParam0) //Position: 0x56DC / 22236
{
	uParam0 = uParam0;
	return;
}

void Function_234(int iParam0) //Position: 0x56E6 / 22246
{
	if (!Function_67(iParam0))
	{
...
bool Function_235(var uParam0, bool bParam1) //Position: 0x56FB / 22267
{
	float fVar0;
	int iVar1;
	bool bVar2;
	...
	bVar2 = Function_236("freemodetest");
...
int Function_236(char* cParam0) //Position: 0x57AE / 22446
{
	bool bVar0;
