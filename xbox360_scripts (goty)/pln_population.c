...
void main() //Position: 0x0 / 0
{
	...
	Function_13(&uVar0, 1131, 6.0f, 14, 0, 0);
	...
	uVar2 = Function_18("Business_night", 0);
	Function_13(&uVar2, 87, 1.0f, 48, 1, 0);
	Function_13(&uVar2, 230, 1.0f, 48, 1, 0);
	Function_13(&uVar2, 16, 1.0f, 48, 1, 0);
	Function_13(&uVar2, 136, 1.0f, 48, 1, 0);
	uVar3 = Function_18("People_night", 0);
	Function_13(&uVar3, 203, 1.0f, 52, 1, 0);
	Function_13(&uVar3, 204, 1.0f, 52, 1, 0);
	Function_13(&uVar3, 87, 1.0f, 52, 1, 0);
	Function_13(&uVar3, 48, 1.0f, 52, 1, 0);
	Function_13(&uVar3, 230, 1.0f, 52, 1, 0);
	Function_13(&uVar3, 312, 1.0f, 52, 1, 0);
	uVar4 = Function_18("generic_workers", 0);
	Function_13(&uVar4, 152, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 153, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 154, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 155, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 164, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 165, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 166, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 167, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 43, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 41, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 40, 1.0f, 14, 1, 0);
	Function_13(&uVar4, 38, 1.0f, 14, 1, 0);
	...
	uVar6 = Function_18("snakes", 0);
	Function_13(&uVar6, 1057, 8.0f, 14, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar13))
	{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_7(bVar14, uVar0, 4E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_6(bVar14, uVar2, 1, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_6(bVar14, uVar3, 1, 2, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_6(bVar14, uVar4, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_7(bVar14, uVar6, 0.001f, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar14))
		{
			Function_7(bVar14, uVar12, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_5(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1478 / 5240
{
	bool bVar0;
...
var Function_6(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x14F8 / 5368
{
	bool bVar0;
...
var Function_7(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x157A / 5498
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x1701 / 5889
{
	int iVar0;
...
var Function_15(int iParam0) //Position: 0x176D / 5997
{
	int iVar0;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x17D9 / 6105
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1855 / 6229
{
	int iVar0;
	int iVar1;
...
var Function_18(bool bParam0, int iParam1) //Position: 0x189A / 6298
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_19(int iParam0) //Position: 0x18A7 / 6311
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_20(bool bParam0, var uParam1) //Position: 0x18B3 / 6323
{
	if (!Function_8(128))
	{
		return;
