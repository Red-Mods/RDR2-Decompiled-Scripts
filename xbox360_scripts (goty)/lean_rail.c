						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_83))
								{
									...
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_40(iParam0, bVar8, &iLocal_81, &cLocal_80);
...
void Function_29(bool bParam0, bool bParam1) //Position: 0x1D41 / 7489
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		if ((GRINGO_COMPONENT_CHECK_NAME("Push_Lft", bParam1) || GRINGO_COMPONENT_CHECK_NAME("Push_For", bParam1)) || GRINGO_COMPONENT_CHECK_NAME("Push_Rgt", bParam1))
		{
			...
			uVar2 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(bVar0, 0, 3.0f, 0);
			ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(uVar2, 3.0f, 1, 0f);
...
var Function_30(bool bParam0, bool bParam1) //Position: 0x1ED8 / 7896
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

vector3 Function_31(bool bParam0) //Position: 0x1EE5 / 7909
{
	vector3 vVar0;
...
bool Function_32(int iParam0) //Position: 0x1F0C / 7948
{
	iParam0 = iParam0;
	return 1;
}

bool Function_33(bool bParam0) //Position: 0x1F17 / 7959
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_34(bool bParam0, int iParam1) //Position: 0x1F31 / 7985
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_35(bool bParam0) //Position: 0x1F4F / 8015
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1F6E / 8046
{
	int iVar0;
	int iVar1;
...
bool Function_37(bool bParam0) //Position: 0x1FA1 / 8097
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1FC0 / 8128
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_39(var uParam0, int iParam1) //Position: 0x1FDA / 8154
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_40(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1FED / 8173
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_41() //Position: 0x22D5 / 8917
{
	int iVar0;
...
bool Function_42(bool bParam0, bool bParam1) //Position: 0x22DD / 8925
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_43() //Position: 0x22FA / 8954
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x2309 / 8969
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x232B / 9003
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_46(bool bParam0) //Position: 0x234F / 9039
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x236C / 9068
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x238C / 9100
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_49(bool bParam0, bool bParam1) //Position: 0x23AC / 9132
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_50(bool bParam0, bool bParam1, bool bParam2) //Position: 0x245A / 9306
{
	bool bVar0;
...
void Function_51(int iParam0, float fParam1) //Position: 0x24CA / 9418
{
	if (!Function_14(iParam0))
	{
...
void Function_52(int iParam0, float fParam1) //Position: 0x24E0 / 9440
{
...
var Function_53(bool bParam0) //Position: 0x2501 / 9473
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_54(int iParam0) //Position: 0x2521 / 9505
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x2535 / 9525
{
	uParam0 = uParam0;
	return;
}

int Function_56() //Position: 0x253F / 9535
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x2546 / 9542
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x2555 / 9557
{
	float fVar0;
...
bool Function_59(bool bParam0) //Position: 0x2594 / 9620
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x25BF / 9663
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x25CA / 9674
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x26C0 / 9920
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x26E2 / 9954
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(int iParam0) //Position: 0x2709 / 9993
{
	iParam0 = iParam0;
	return;
}

void Function_65(int iParam0) //Position: 0x2713 / 10003
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x271D / 10013
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x273B / 10043
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2750 / 10064
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x27D7 / 10199
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27FA / 10234
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2818 / 10264
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x283B / 10299
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2956 / 10582
{
...
int Function_74(bool bParam0) //Position: 0x2981 / 10625
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2A86 / 10886
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2A93 / 10899
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2B06 / 11014
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3004 / 12292
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x303B / 12347
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3058 / 12376
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3090 / 12432
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x309A / 12442
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, bool bParam1) //Position: 0x30BB / 12475
{
	bool bVar0;
	bool bVar1;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3195 / 12693
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x329D / 12957
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x32B3 / 12979
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3569 / 13673
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x3577 / 13687
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3590 / 13712
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x35AA / 13738
{
	bool bVar0;
	char* cVar1;
	
	bParam0 = bParam0;
	cVar1 = Function_91(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_91(var uParam0, int iParam1) //Position: 0x35E2 / 13794
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x35F9 / 13817
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x38C2 / 14530
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x38DF / 14559
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x397B / 14715
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, bool bParam1) //Position: 0x399A / 14746
{
	bool bVar0;
	bool bVar1;
...
bool Function_97(int iParam0) //Position: 0x3A17 / 14871
{
...
void Function_98(int iParam0) //Position: 0x3A33 / 14899
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3A3D / 14909
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3A9F / 15007
{
...
void Function_101(int iParam0) //Position: 0x3AB3 / 15027
{
	iParam0 = iParam0;
	return;
}
