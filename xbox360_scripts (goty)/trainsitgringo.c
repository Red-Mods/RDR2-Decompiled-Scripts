...
void Function_17(bool bParam0, int iParam1) //Position: 0x1BD7 / 7127
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1BEC / 7148
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1BFA / 7162
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1C2B / 7211
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C9F / 7327
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1D11 / 7441
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1D1F / 7455
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1D35 / 7477
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1D42 / 7490
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_26(bool bParam0, int iParam1) //Position: 0x1D62 / 7522
{
	iParam1 = iParam1;
		...
		if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(bParam0), "DECOR_TICKET"))
		{
			if (IS_ACTOR_PLAYING_NODE_IN_TREE(bParam0, "train_sit/Player/ride"))
			{
				if (!DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(bParam0), "nTRAIN_NAP"))
				{
					...
					{
						bLocal_2 = ADD_SCRIPT_USE_CONTEXT("train_take_nap", 1, 12, false, 0, 0, 0, 4294967295, 0);
					}
...
bool Function_27(bool bParam0) //Position: 0x1E3C / 7740
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1E5B / 7771
{
	return;
}

void Function_29(bool bParam0, int iParam1) //Position: 0x1E61 / 7777
{
	iParam1 = iParam1;
	if (!IS_ATTACHMENT_VALID(iLocal_1))
	{
		iLocal_1 = ATTACH_OBJECTS_CONTINUOUS(bParam0, GRINGO_GET_MY_OBJECT_REF(), 4294967295);
	}
	return;
}

bool Function_30(int iParam0) //Position: 0x1E82 / 7810
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1E8D / 7821
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1EA7 / 7847
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1EC5 / 7877
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1EE4 / 7908
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1F17 / 7959
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1F36 / 7990
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1F50 / 8016
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1F63 / 8035
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x224B / 8779
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2253 / 8787
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2270 / 8816
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x227F / 8831
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x22A1 / 8865
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x22C5 / 8901
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x22E2 / 8930
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2302 / 8962
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2322 / 8994
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x23D0 / 9168
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2440 / 9280
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2456 / 9302
{
...
var Function_51(bool bParam0) //Position: 0x2477 / 9335
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2497 / 9367
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x24AB / 9387
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x24B5 / 9397
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x24BC / 9404
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x24CB / 9419
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x250A / 9482
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2535 / 9525
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2540 / 9536
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2636 / 9782
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2658 / 9816
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x267F / 9855
{
	bool bVar7;
	...
	if (iLocal_5 && !iLocal_4)
	{
		...
		bVar7 = LOCATE_ACTOR_OF_TYPE(Function_66(Global_34573), 30.0f, 4294967295, 1165);
		cLocal_3 = CREATE_LAYOUT("TrainSit_Layout");
		Function_63(cLocal_3, 0, bVar7, 1, 0, 0);
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x26CC / 9932
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2748 / 10056
{
	bool bVar0;
	bool bVar1;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2781 / 10113
{
...
vector3 Function_66(bool bParam0) //Position: 0x280A / 10250
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x2831 / 10289
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x283B / 10299
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2859 / 10329
{
	if (!Function_14(iParam0))
	{
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x286E / 10350
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x28F5 / 10485
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2918 / 10520
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x2936 / 10550
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x2959 / 10585
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x2A74 / 10868
{
...
int Function_76(bool bParam0) //Position: 0x2A9F / 10911
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2BA4 / 11172
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2BB1 / 11185
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2C24 / 11300
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x3122 / 12578
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x3159 / 12633
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x3176 / 12662
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x31AE / 12718
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x31B8 / 12728
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x31D9 / 12761
{
	iParam1 = iParam1;
	...
	if (IS_LAYOUTREF_VALID(cLocal_3))
	{
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3209 / 12809
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3311 / 13073
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x3327 / 13095
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(bool bParam0, int iParam1) //Position: 0x35DD / 13789
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_90(bool bParam0) //Position: 0x35F2 / 13810
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x360B / 13835
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x3625 / 13861
{
	bool bVar0;
	char* cVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x365D / 13917
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x3674 / 13940
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x393D / 14653
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x395A / 14682
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x39F6 / 14838
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3A15 / 14869
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3A24 / 14884
{
...
void Function_100(int iParam0) //Position: 0x3A40 / 14912
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3A4A / 14922
{
	int iVar0;
	int iVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x3AAC / 15020
{
...
void Function_103(int iParam0) //Position: 0x3AC0 / 15040
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_104(int iParam0) //Position: 0x3B26 / 15142
{
