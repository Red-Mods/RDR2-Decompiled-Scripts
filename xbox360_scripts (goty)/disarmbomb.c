...
float Function_23(bool bParam0) //Position: 0x1CDF / 7391
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CF5 / 7413
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1D02 / 7426
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D22 / 7458
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1D31 / 7473
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D50 / 7504
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D56 / 7510
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D64 / 7524
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D6F / 7535
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D89 / 7561
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1DA7 / 7591
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DC6 / 7622
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DF9 / 7673
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E18 / 7704
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E32 / 7730
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E45 / 7749
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
var Function_39() //Position: 0x212D / 8493
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2135 / 8501
{
...
bool Function_42(bool bParam0, int iParam1) //Position: 0x2161 / 8545
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2183 / 8579
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x21A7 / 8615
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21C4 / 8644
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21E4 / 8676
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2204 / 8708
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22B2 / 8882
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2322 / 8994
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2338 / 9016
{
...
var Function_51(bool bParam0) //Position: 0x2359 / 9049
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2379 / 9081
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x238D / 9101
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2397 / 9111
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x239E / 9118
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23AD / 9133
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x23EC / 9196
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2417 / 9239
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2422 / 9250
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2518 / 9496
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x253A / 9530
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2561 / 9569
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2820 / 10272
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x287D / 10365
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28DA / 10458
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28E4 / 10468
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2902 / 10498
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2917 / 10519
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x299E / 10654
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29C1 / 10689
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29DF / 10719
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A02 / 10754
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B1D / 11037
{
...
int Function_74(bool bParam0) //Position: 0x2B48 / 11080
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C4D / 11341
{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CCD / 11469
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31CC / 12748
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3203 / 12803
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3220 / 12832
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3258 / 12888
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3262 / 12898
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

int Function_83(bool bParam0, int iParam1) //Position: 0x3283 / 12931
{
	bool bVar0;
	...
	GIVE_WEAPON_TO_ACTOR(GET_PLAYER_ACTOR(0), 24, 0, 1, 1);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	if (bParam0 == GET_PLAYER_ACTOR(0))
	{
		if (!DECOR_CHECK_EXIST(bParam0, "mexArmy02_bombsDisarmed"))
		{
			DECOR_SET_INT(bParam0, "mexArmy02_bombsDisarmed", true);
		}
		else
		{
			bVar0 = DECOR_GET_INT(bParam0, "mexArmy02_bombsDisarmed");
			bVar0++;
			DECOR_SET_INT(bParam0, "mexArmy02_bombsDisarmed", bVar0);
		}
	}
	return 1;
}

void Function_84(bool bParam0, bool bParam1) //Position: 0x3343 / 13123
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x344B / 13387
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3461 / 13409
{
	int iVar0;
	bool bVar1;
	char* cVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3717 / 14103
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x3725 / 14117
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x373E / 14142
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3758 / 14168
{
	bool bVar0;
	var uVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3790 / 14224
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x37A7 / 14247
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A70 / 14960
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A8D / 14989
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B29 / 15145
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B48 / 15176
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B57 / 15191
{
...
void Function_98(int iParam0) //Position: 0x3B73 / 15219
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B7D / 15229
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BDF / 15327
{
...
void Function_101(int iParam0) //Position: 0x3BF3 / 15347
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BFD / 15357
{
