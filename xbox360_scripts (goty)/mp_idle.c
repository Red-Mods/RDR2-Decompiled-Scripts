...
void Function_34(var uParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x3F09 / 16137
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void Function_37(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x40AF / 16559
{
	vector3 vVar0;
...
void Function_125(var uParam0, bool bParam1) //Position: 0x676B / 26475
{
	vector3 vVar0;
...
void Function_126(var uParam0, bool bParam1) //Position: 0x680A / 26634
{
	vector3 vVar0;
...
void Function_144(bool bParam0, int iParam1) //Position: 0x6F07 / 28423
{
...
var Function_148(bool bParam0) //Position: 0x6F72 / 28530
{
	if (!Function_145(bParam0))
	{
		return 4294967295;
...
bool Function_149(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6F8C / 28556
{
	int iVar0;
	int iVar1;
...
void Function_155(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x744D / 29773
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_158(char* cParam0, bool bParam1) //Position: 0x7B80 / 31616
{
	char* cVar0[32];
...
int Function_161(int iParam0, bool bParam1) //Position: 0x7C10 / 31760
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
int Function_167(int iParam0, bool bParam1, bool bParam2) //Position: 0x7F71 / 32625
{
	int iVar0;
	int iVar1;
...
int Function_168(bool bParam0) //Position: 0x81C7 / 33223
{
...
void Function_178(var uParam0, char* cParam1, bool bParam2, int iParam3) //Position: 0x840A / 33802
{
	vector3 vVar0;
...
var Function_185(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x8B3D / 35645
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(bParam0, bParam4, bParam5, bParam6, 1, vParam1);
}

int Function_186(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8B55 / 35669
{
...
void Function_197(int iParam0, bool bParam1) //Position: 0x9644 / 38468
{
	if (Function_196())
	{
...
void Function_199(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) //Position: 0x969E / 38558
{
	...
	cVar4 = GUI_WINDOWS_WITH_VALUES(Global_13043, &cVar13);
	if (!GUI_WINDOW_VALID(cVar4))
	{
		Var0 = 0.0f;
		Var0.f_4 = 0.0f;
...
void Function_229(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0xAC38 / 44088
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if (Function_350(bParam0) == 1)
	{
		iVar2 = Function_349(bParam0);
		...
		if (bParam1)
		{
			Function_280(iVar2, bParam0, bVar1);
			Function_279();
		}
	}
...
void Function_235(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xB0B9 / 45241
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	{
		Global_6269 = Function_349(bParam0);
	...
	if (StackVal == 2)
	{
		Function_267("DEED_COMPLETE", bParam0);
	}
	if (bParam1)
	{
...
void Function_260(bool bParam0, bool bParam1) //Position: 0xC842 / 51266
{
...
void Function_262(bool bParam0) //Position: 0xC86A / 51306
{
	int iVar0;
	int iVar1;
	...
	switch (Function_350(bParam0))
	{
		case 0x00000001:
			iVar1 = Function_349(bParam0);
			if (iVar1 <= 1 && iVar1 >= 24)
			{
		...
		case 0x00000002:
			...
			{
				case 0x00000000:
					if (Function_264(bParam0) == 1)
					{
						iVar0 = Function_263(bParam0);
		...
		case 0x00000003:
			if (Function_263(bParam0) == 0)
			{
				if (Function_264(bParam0) == 1)
				{
					Function_266(458, 1, 0, 0);
					iVar0 = Function_349(bParam0);
					if (Function_216(iVar0))
					{
...
int Function_263(bool bParam0) //Position: 0xCD46 / 52550
{
	if (!Function_147(bParam0))
	{
		return 4294967295;
...
int Function_264(bool bParam0) //Position: 0xCD65 / 52581
{
	if (!Function_147(bParam0))
	{
		return 4294967295;
...
void Function_267(char* cParam0, bool bParam1) //Position: 0xD006 / 53254
{
	struct<4> Var0;
	...
	switch (Function_350(bParam1))
	{
		case 0x00000001:
			Var0 = { StackVal, StackVal, StackVal, Function_268(Function_349(bParam1)) };
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, &Var0, Function_350(bParam1), Function_349(bParam1));
			break;
		
		case 0x00000002:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "PROCEDURAL", Function_350(bParam1), bParam1);
			break;
		
		case 0x00000003:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "LOCATION", Function_350(bParam1), bParam1);
			break;
		
		case 0x00000004:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "MINIGAME", Function_350(bParam1), bParam1);
			break;
		
		case 0x00000005:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "ACTIONAREA_EVENT", Function_350(bParam1), bParam1);
			break;
		
		case 0x00000006:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "JOB", Function_350(bParam1), bParam1);
			break;
...
void Function_272(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0xD68E / 54926
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
void Function_278(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0xDC32 / 56370
{
	*uParam3 = (bParam0 && 15);
...
void Function_280(int iParam0, int iParam1, bool bParam2) //Position: 0xDC89 / 56457
{
	...
	if (!bParam2)
	{
		...
		iVar15 = Function_290(iParam0, iVar14, Global_34165.f_140, bVar8, bVar0);
		if (iVar15 == 1)
		{
			Function_281(50, 1, 0);
			if (iVar14 == 0)
...
vector3 Function_303(bool bParam0) //Position: 0x102AC / 66220
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_305(bool bParam0, bool bParam1) //Position: 0x10351 / 66385
{
...
void Function_319(char* cParam0, bool bParam1) //Position: 0x10AEA / 68330
{
	bool bVar0;
...
void Function_336(bool bParam0, bool bParam1) //Position: 0x1206A / 73834
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
void Function_344(int iParam0, int iParam1, int iParam2) //Position: 0x12363 / 74595
{
	bool bVar0;
...
int Function_349(bool bParam0) //Position: 0x1265A / 75354
{
	if (!Function_147(bParam0))
	{
		return 4294967295;
...
int Function_350(bool bParam0) //Position: 0x1267A / 75386
{
	if (!Function_147(bParam0))
	{
		return 0;
...
void Function_351(int iParam0) //Position: 0x12695 / 75413
{
	...
	ADD_TIME(&Global_12976 + 4, 0, false, (iParam0 + Function_352(105)), 0);
	return;
}
...
void Function_353(bool bParam0) //Position: 0x126CC / 75468
{
...
void Function_354(int iParam0) //Position: 0x12768 / 75624
{
	...
	ADD_TIME(&Global_12976 + 12, 0, false, (iParam0 + Function_352(90)), 0);
	return;
}

void Function_355(bool bParam0) //Position: 0x12789 / 75657
{
...
bool Function_365(int iParam0) //Position: 0x12F58 / 77656
{
	...
	if (Function_366(bVar0, "streamanddropactorlineup"))
	{
...
bool Function_366(char* cParam0, bool bParam1) //Position: 0x130AF / 77999
{
	char* cVar0[64];
	char* cVar16[64];
...
bool Function_367(bool bParam0) //Position: 0x130DA / 78042
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = GET_CONSOLE_COMMAND_TOKEN(0);
	if (Function_366(bVar0, "streamanddropactor"))
	{
		bParam0 = GET_CONSOLE_COMMAND_TOKEN(1);
...
var Function_385(int iParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5) //Position: 0x146C2 / 83650
{
	...
	{
		Function_388(&iVar1, &bVar304, bVar601);
		Function_388(&iVar148, &bVar451, bVar602);
	}
...
int Function_391(bool bParam0) //Position: 0x14F47 / 85831
{
	int iVar0;
	int iVar1;
...
bool Function_402(int iParam0, int iParam1) //Position: 0x15B93 / 88979
{
	var uVar0;
...
var Function_404(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x15CA4 / 89252
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_411(int iParam0, bool bParam1) //Position: 0x16357 / 90967
{
	...
	Function_412(iParam0, bParam1, 0);
	bVar0 = iParam0;
	if (bVar0 >= 696)
	{
...
void Function_420(bool bParam0, bool bParam1) //Position: 0x16DBC / 93628
{
...
void Function_428(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4) //Position: 0x16F89 / 94089
{
	int iVar0;
	bool bVar1;
...
void Function_429(int iParam0, int iParam1) //Position: 0x16FFB / 94203
{
	...
	Function_347(iVar0);
	PRINTNL();
	Function_345(iParam0, iVar0, iParam1);
	return;
}
...
bool Function_449(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x17949 / 96585
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
	...
	while (IS_OBJECT_VALID(OBJECT_ITERATOR_CURRENT(bLocal_13)))
	{
		...
		if (GET_OBJECT_TYPE(bVar0) == 15)
		{
			...
			if (IS_ACTOR_VALID(bVar1))
			{
				...
				{
					Function_480(bVar1, bLocal_13);
				}
				else
				{
					Function_460(bVar1, bLocal_13);
				}
			}
		}
...
var Function_461(var uParam0, var uParam1, var uParam2, float fParam3, bool bParam4, bool bParam5) //Position: 0x184F0 / 99568
{
	bool bVar0;
	vector3 vVar1;
	var uVar4;
...
void Function_469(bool bParam0) //Position: 0x18B2C / 101164
{
	if (bParam0 < 0.1f)
	{
...
void Function_508(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x195F6 / 103926
{
	...
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_511(iParam0), &cVar0, 2, 2, true);
	}
...
void Function_516(bool bParam0) //Position: 0x197D5 / 104405
{
	var uVar0;
...
void Function_517(bool bParam0) //Position: 0x197E4 / 104420
{
	var uVar0;
...
void Function_518(bool bParam0) //Position: 0x19812 / 104466
{
	var uVar0;
