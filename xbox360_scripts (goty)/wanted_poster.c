...
int Function_49(bool bParam0) //Position: 0x2978 / 10616
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_79(bParam0, bVar0))
			{
				Function_71(bParam0, bVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_70(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_66(bParam0, bVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
...
void Function_52() //Position: 0x2B7E / 11134
{
	var uVar0;
	var uVar16;
	var uVar32;
	...
	Function_65(Global_26303.f_12, &uVar0);
	uVar64 = Function_64(Global_26303.f_20);
	Function_63(uVar64, &uVar16);
	Function_62(Global_26303.f_24, &uVar32);
	Function_57(&uVar48);
	SET_NEWSPAPER_INFO(0, &uVar16);
	SET_NEWSPAPER_INFO(1, &uVar0);
	SET_NEWSPAPER_INFO(2, &uVar32);
	SET_NEWSPAPER_INFO(3, &uVar48);
	if (!Function_53(Function_54(Global_26303.f_20)))
	{
...
bool Function_53(bool bParam0) //Position: 0x2C1E / 11294
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_54(int iParam0) //Position: 0x2C70 / 11376
{
	int iVar0;
	int iVar1;
	struct<21> Var2;
...
var Function_55(var uParam0, int iParam1) //Position: 0x2CAE / 11438
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x3421 / 13345
{
...
{
	memcpy(iParam0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_58(&Global_26303), 16);
	return;
}

struct<32> Function_58(int iParam0) //Position: 0x344A / 13386
{
	char* cVar0[32];
	bool bVar8;
	bool bVar9;
	
	bVar8 = Function_59(iParam0, 0);
	bVar9 = Function_59(iParam0, 1);
...
var Function_59(int iParam0, bool bParam1) //Position: 0x34DA / 13530
{
	bool bVar0;
	char* cVar1[32];
...
bool Function_60() //Position: 0x35FD / 13821
{
...
int Function_61() //Position: 0x3628 / 13864
{
	return Global_12976.f_152;
}

void Function_62(int iParam0, char* cParam1) //Position: 0x3633 / 13875
{
	strcpy(cParam1, GET_OBJECT_NAME(StackVal), 64);
	return;
}

void Function_63(char* cParam0, char* cParam1) //Position: 0x3649 / 13897
{
	switch (cParam0)
	{
		case 0x00000004:
...
var Function_64(bool bParam0) //Position: 0x3731 / 14129
{
	int iVar0;
	int iVar1;
...
void Function_65(char* cParam0, char* cParam1) //Position: 0x37E0 / 14304
{
	switch (cParam0)
	{
		case 0x00000001:
...
void Function_66(bool bParam0, var uParam1, int iParam2) //Position: 0x38B7 / 14519
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(uParam1, bVar1, Function_68(bVar1, "AttachBone", &iVar2), Function_68(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_67(bVar1, uParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_67(bool bParam0, bool bParam1) //Position: 0x3941 / 14657
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_68(bool bParam0, bool bParam1, int iParam2) //Position: 0x39EF / 14831
{
	int iVar0;
	bool bVar1;
...
var Function_69(bool bParam0) //Position: 0x3A34 / 14900
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_70(bool bParam0) //Position: 0x3A4A / 14922
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_71(var uParam0, bool bParam1, int iParam2) //Position: 0x3A60 / 14944
{
	uParam0 = Function_78(uParam0);
	*iParam2 = 0;
	if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
	{
		DECOR_REMOVE(bParam1, "NewspaperStart");
	...
	if (!Global_3380)
	{
		if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(Global_34573)))
		{
			...
			{
				if (((Function_74(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
				{
					iLocal_3 = 0;
				}
				*iParam2 = 1;
			...
			{
				Function_72("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
				*iParam2 = 0;
			}
		}
		else
		{
			Function_72("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
...
void Function_72(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3B6E / 15214
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_73(int iParam0) //Position: 0x3BE9 / 15337
{
	char* cVar0[16];
...
int Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3C28 / 15400
{
...
bool Function_75() //Position: 0x3CDE / 15582
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_76(bool bParam0) //Position: 0x3CF5 / 15605
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_77(bool bParam0) //Position: 0x3D00 / 15616
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_78(bool bParam0) //Position: 0x3D0E / 15630
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_79(int iParam0, bool bParam1) //Position: 0x3D28 / 15656
{
	bool bVar0;
	bool bVar1;
