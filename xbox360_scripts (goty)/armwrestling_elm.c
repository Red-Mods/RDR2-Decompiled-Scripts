	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_37(Global_30707[0]))
			{
				...
				{
					Function_31("ArmWrestling_NotEnoughMoney", 4.0f, 0, 2, 1, 0);
					bLocal_3 = true;
				}
				else
				{
		...
		case 0x00000001:
			if (Function_25(Global_30707[0], &iLocal_24 + 4, &iLocal_24 + 20, &iLocal_24 + 24))
			{
				Function_24(&iLocal_24 + 4);
				Function_23(Global_30707[0]);
				*(&iLocal_24 + 40[03]) = { StackVal, StackVal, Function_23(Global_30707[0]) };
				Function_22(Global_30707[0]);
				*(&iLocal_24 + 40[13]) = { StackVal, StackVal, Function_22(Global_30707[0]) };
				Function_21(Global_30707[0]);
				*(&iLocal_24 + 28) = { StackVal, StackVal, Function_21(Global_30707[0]) };
				iLocal_24 = Local_6;
...
void Function_17() //Position: 0x5AB / 1451
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5B4 / 1460
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x5D5 / 1493
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x60B / 1547
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_21(int iParam0) //Position: 0x626 / 1574
{
...
vector3 Function_22(int iParam0) //Position: 0x6D1 / 1745
{
	if (iParam0 == Global_30693[2])
	{
...
vector3 Function_23(int iParam0) //Position: 0x780 / 1920
{
	if (iParam0 == Global_30693[2])
	{
...
void Function_24(int iParam0) //Position: 0x82B / 2091
{
	int iVar0;
	bool bVar1;
...
bool Function_25(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x880 / 2176
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
bool Function_26(bool bParam0, bool bParam1, bool bParam2) //Position: 0xB4D / 2893
{
...
bool Function_27() //Position: 0xC03 / 3075
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_28(int iParam0) //Position: 0xC1A / 3098
{
	return IS_ACTOR_IN_HOGTIE(iParam0);
}

bool Function_29(int iParam0) //Position: 0xC25 / 3109
{
	return IS_ACTOR_VALID(GET_LASSO_USER(iParam0));
}

vector3 Function_30(int iParam0, bool bParam1) //Position: 0xC33 / 3123
{
	if (iParam0 == Global_30693[2])
	{
		if (bParam1 == 0)
...
void Function_31(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xD5A / 3418
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_32(int iParam0) //Position: 0xDD1 / 3537
{
	char* cVar0[16];
...
bool Function_33() //Position: 0xE10 / 3600
{
...
bool Function_34(var uParam0, int iParam1) //Position: 0xE2B / 3627
{
	return (uParam0 && iParam1) == 0;
}

float Function_35(int iParam0) //Position: 0xE38 / 3640
{
...
var Function_36(int iParam0) //Position: 0xE71 / 3697
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_37(int iParam0) //Position: 0xE8B / 3723
{
...
int Function_38(var uParam0, int iParam1) //Position: 0xEA7 / 3751
{
	int iVar0;
...
bool Function_39(int iParam0) //Position: 0xEC3 / 3779
{
...
void Function_40() //Position: 0xED9 / 3801
{
	Function_1();
	return;
}

void Function_41() //Position: 0xEE2 / 3810
{
...
void Function_42(int iParam0) //Position: 0xF2E / 3886
{
...
void Function_43(var uParam0, float fParam1) //Position: 0xF43 / 3907
{
...
void Function_44(var uParam0, int iParam1) //Position: 0xF64 / 3940
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, int iParam1) //Position: 0xF77 / 3959
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_46(var uParam0) //Position: 0xF86 / 3974
{
	return Function_34(*uParam0, 1);
}

void Function_47() //Position: 0xF93 / 3987
{
	return;
}

void Function_48(bool bParam0, bool bParam1) //Position: 0xF99 / 3993
{
	bool bVar0;
...
void Function_49(var uParam0) //Position: 0xFF0 / 4080
{
	int iVar0;
...
var Function_50() //Position: 0x100D / 4109
{
	var uVar0;
