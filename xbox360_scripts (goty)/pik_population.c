...
void main() //Position: 0x0 / 0
{
	...
	Function_15("Loading Pike's Basin population file", 3);
	Global_30839++;
	...
	Function_8(&(Global_30750[5]), 1128, 8.0f, 30, 1, 0);
	Function_8(&(Global_30750[5]), 1057, 2.0f, 14, 1, 0);
	...
	Function_8(&(Global_30750[5]), 1082, 5.0f, 33, 0, 0);
	Function_8(&(Global_30750[5]), 1084, 5.0f, 33, 0, 0);
	...
	Function_11(&(Global_30750[11]), 1052, 3.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1061, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1062, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1063, 2.0f, 0, 0);
	Function_14(&(Global_30750[8]));
	Global_30750[8] = Function_13("animal_herd", 1);
	Function_11(&(Global_30750[8]), 1012, 10.0f, 0, 0);
	Function_11(&(Global_30750[8]), 1009, 10.0f, 0, 0);
	Function_11(&(Global_30750[8]), 1010, 10.0f, 0, 0);
	Function_11(&(Global_30750[8]), 1011, 10.0f, 0, 0);
	Function_14(&(Global_30750[7]));
	Global_30750[7] = Function_13("animal_bird", 1);
	Function_8(&(Global_30750[7]), 1131, 2.0f, 15, 0, 0);
	Function_8(&(Global_30750[7]), 1135, 1.0f, 15, 0, 0);
	Function_8(&(Global_30750[7]), 1136, 1.0f, 15, 0, 0);
	Function_8(&(Global_30750[7]), 1136, 1.0f, 15, 0, 0);
	...
	Function_11(&(Global_30750[2]), 441, 8.0f, 0, 0);
	Function_14(&(Global_30750[3]));
	Global_30750[3] = Function_13("ped_bad_guys_local", 1);
	Function_11(&(Global_30750[3]), 477, 1.0f, 1, 0);
	Function_11(&(Global_30750[3]), 478, 1.0f, 1, 0);
	Function_11(&(Global_30750[3]), 479, 1.0f, 1, 0);
	...
	Function_11(&(Global_30750[9]), 1183, 8.0f, 0, 0);
	...
	bVar1 = FIND_NAMED_LAYOUT("PikesBasin_layout");
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "pikv_mainCamp");
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, Global_30750[8], 0.0f, 0, 0, 1);
		}
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "pikv_birdVol");
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, Global_30750[7], 3E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("PIK_Pop: Cannot find pikv_birdVol to create bird volumes");
		}
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "pik_null");
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, uVar0, 0.0f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("pik_pop: Cannot find pik_null to create population volumes");
		}
	}
	END_POPULATION_DEFINITION();
	Global_30839 = (Global_30839 - 1);
	...
	Function_5("Finished loading Pikes Basin population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xC7A / 3194
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC89 / 3209
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCDE / 3294
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xD5E / 3422
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD7A / 3450
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xDB8 / 3512
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xDD4 / 3540
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xDE4 / 3556
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xE5C / 3676
{
	int iVar0;
...
var Function_10(int iParam0) //Position: 0xEC8 / 3784
{
	int iVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF34 / 3892
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xFB0 / 4016
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xFF5 / 4085
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0x1002 / 4098
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0x100E / 4110
{
	if (!Function_4(128))
	{
		return;
