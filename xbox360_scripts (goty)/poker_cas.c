...
bool Function_17() //Position: 0x420 / 1056
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30707[2], &Local_24 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_30707[2], 0);
				*(&Local_24 + 148) = { StackVal, StackVal, Function_26(Global_30707[2], 0) };
				Function_25(&Local_24 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_24 + 40)[iVar0] = iLocal_4 * 10;
					Function_24(Global_30707[2], iVar0, 0);
					*(&Local_24 + 72[iVar03]) = { StackVal, StackVal, Function_24(Global_30707[2], iVar0, 0) };
					iVar0++;
				}
				if (Function_36())
				{
				...
				Function_23(Global_30707[2]);
				*(&Local_24 + 184) = { StackVal, StackVal, Function_23(Global_30707[2]) };
				Function_22(Global_30707[2]);
				*(&Local_24 + 196) = { StackVal, StackVal, Function_22(Global_30707[2]) };
