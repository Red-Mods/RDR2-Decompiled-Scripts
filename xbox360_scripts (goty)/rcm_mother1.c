...
void main() //Position: 0x0 / 0
{
	...
	iLocal_275 = 0;
	iLocal_268 = 1000;
	Function_200(&bLocal_249, 613, 3, 0);
	Function_200(&bLocal_249, 1208, 3, 0);
	Function_198(&bLocal_249, "$/content/DLC/ZombiePack/Gringos/DLC_RCM_mother_superior", 1, 0);
	Function_198(&bLocal_249, "repeater_winchester01x", 0, 0);
	Function_198(&bLocal_249, "dead_ground_male", 5, 0);
	Function_198(&bLocal_249, "custom/dead_ground_male", 8, 0);
	Function_197(&iLocal_281);
	bVar0 = false;
	while (!IS_EXITFLAG_SET())
	{
		if (iLocal_275 <= 1 && iLocal_275 > 7)
		{
			if (!bVar0)
			{
				bVar0 = Function_196();
			}
			if (!IS_ACTOR_ALIVE(bLocal_277) || bVar0)
			{
				if (Function_195(24))
				{
					Function_194(25, 1);
		...
		{
			if (GET_LAST_ATTACKER(bLocal_277) == Function_187())
			{
				SET_ACTOR_FACTION(bLocal_277, 0);
				TASK_FLEE_ACTOR(bLocal_277, Global_34573, -1.0f, -1.0f, 0, 0, 0);
				if (IS_ACTOR_VALID(bLocal_278))
				{
					TASK_MELEE_ATTACK(bLocal_278, Global_34573, -1.0f);
				}
				if (Function_195(24))
				{
					Function_194(25, 1);
		...
		switch (iLocal_275)
		{
			case 0x00000000:
				...
				{
					if (IS_LAYOUTREF_VALID(bLocal_276))
					{
						if (Function_181(&bLocal_249))
						{
							bLocal_277 = CREATE_ACTOR_IN_LAYOUT(bLocal_276, "mothersuperior", 613, *(&Global_63541[ScriptParam_055] + 100), 0.0f, 0.0f, 0.0f);
							SET_ACTOR_FACTION(bLocal_277, 20);
							MEMORY_CLEAR_EVENTS(bLocal_277, 0);
							CLEAR_LAST_HIT(bLocal_277);
							SET_ACTOR_HEALTH(bLocal_277, GET_ACTOR_MAX_HEALTH(bLocal_277));
							bLocal_280 = CREATE_VOLUME_IN_LAYOUT(bLocal_276, "Marshal1_StayOut", 2, *(&Global_63541[ScriptParam_055] + 100), 0.0f, 45.725f, 0.0f, 50.93f, 10.928f, 50.716f);
							ADD_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_280);
							ADD_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_280);
							vVar4 = { -1663.506f, 8.535f, 4283.549f };
							bLocal_286 = CREATE_PROP_IN_LAYOUT(bLocal_276, "gun", "repeater_winchester01x", vVar4, 0.0f, 0.0f, 0.0f, 1);
							vVar7 = { 0.0f, 0.0f, 1.0f };
							ROTATE_OBJECT_AROUND_AXIS(bLocal_286, &vVar7, 270.0f);
							vVar7 = { 0.0f, 1.0f, 0.0f };
							ROTATE_OBJECT_AROUND_AXIS(bLocal_286, &vVar7, 270.0f);
							bLocal_278 = CREATE_ACTOR_IN_LAYOUT(bLocal_276, "Mother1_Zombie", 1208, *(&Global_63541[ScriptParam_055] + 100), 0.0f, 152.0f, 0.0f);
							MEMORY_CLEAR_EVENTS(bLocal_278, 0);
							CLEAR_LAST_HIT(bLocal_278);
							SET_ACTOR_HEALTH(bLocal_278, GET_ACTOR_MAX_HEALTH(bLocal_278));
							SET_ACTOR_OVERHEALTH_MODE(bLocal_278, true);
							bLocal_285 = GET_GRINGO_FROM_OBJECT(CREATE_GRINGO_IN_LAYOUT(bLocal_276, "grapplegringo", "DLC_RCM_mother_superior", *(&Global_63541[ScriptParam_055] + 100), 0.0f, 152.0f, 0.0f));
							AI_IGNORE_ACTOR(bLocal_278);
							SNAP_ACTOR_TO_GRINGO(bLocal_278, GET_OBJECT_FROM_GRINGO(bLocal_285), "UseCase1", 1, 0, 0);
							TASK_USE_GRINGO(bLocal_278, bLocal_285, "UseCase1", 4294967295, 1);
							TASK_PRIORITY_SET(bLocal_278, 1);
							SNAP_ACTOR_TO_GRINGO(bLocal_277, GET_OBJECT_FROM_GRINGO(bLocal_285), "Mom", 1, 0, 0);
							TASK_USE_GRINGO(bLocal_277, bLocal_285, "Mom", 4294967295, 1);
							TASK_PRIORITY_SET(bLocal_277, 1);
							AI_IGNORE_ACTOR(bLocal_277);
							iLocal_275 = 1;
							Function_179(&iLocal_281);
						}
						else if (Function_176(&iLocal_281) < 5.0f)
						{
							Function_179(&iLocal_281);
						}
						Function_169(&(Global_63541[2455]), 24, 0x41f00000, 0x42200000, 0);
					}
					else
					{
						bLocal_276 = CREATE_LAYOUT("RCM_Mother_Layout");
					}
				}
				break;
			
			case 0x00000001:
				if (GET_LAST_ATTACKER(bLocal_278) != Function_187() && !bVar0)
				{
					iVar10 = 1;
				}
				...
				if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192) || iVar10)
				{
					if (!Function_165(Global_34573, 1, 1) || iVar10)
					{
						if (FABS((StackVal - StackVal)) > 2.0f || iVar10)
						{
							if (Function_161(Global_63541[ScriptParam_055].f_192, 0, 1, 0, 1, 0) || iVar10)
							{
			...
			case 0x00000003:
				if ((IS_ACTOR_ALIVE(bLocal_277) && !bVar0) && Function_176(&iVar1) < 0.2f)
				{
					if (Function_114("$/cutscene/MOTHER_SUPERIOR_1_CS_SEQ/MOTHER_SUPERIOR_1_CS_SEQ", &iLocal_268, 32944, 32937, 30949, 30256, 29832, 29816, 1, 1, 2, 1, 0))
					{
						iLocal_275 = 5;
						Function_179(&iLocal_281);
					}
			...
			case 0x00000005:
				...
				{
					Function_193(&Global_63541[2455] + 144, 256);
					...
					AUDIO_ADD_ALTERNATE_CONTEXT(bLocal_277, "RCM_STILL_HERE", "RCM_STILL_HERE_POST1");
					APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "mother1_OBJ", 0, 3, false);
					Function_112(Global_63541[ScriptParam_055].f_140, 0);
					Global_63541[2555].f_204 = bLocal_277;
			...
			case 0x00000006:
				if (IS_ACTOR_VALID(bLocal_277))
				{
					if (VDIST(Global_34574, *(&Global_63541[ScriptParam_055] + 112)) < 35.0f)
					{
						if (!Function_1(bLocal_277, 0x3f800000, 0x42960000, 1, 1, 0))
						{
							DESTROY_ACTOR(bLocal_277);
							iLocal_275 = 7;
						}
					}
				}
...
bool Function_1(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x802 / 2050
{
	return CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam0, iParam1, iParam2, iParam3, iParam4, iParam5);
}

void Function_2(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x81C / 2076
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_3(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xC4B / 3147
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_4() //Position: 0xDBE / 3518
{
	return;
}

void Function_5(var uParam0, var uParam1) //Position: 0xDC4 / 3524
{
	if (Global_3381)
	{
		return;
...
bool Function_6() //Position: 0xE06 / 3590
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_7(bool bParam0) //Position: 0xE0F / 3599
{
...
void Function_8() //Position: 0xE60 / 3680
{
	Function_35();
	Function_34();
	Function_34();
...
void Function_9() //Position: 0xEB2 / 3762
{
...
void Function_10() //Position: 0xFB8 / 4024
{
	float fVar0;
...
void Function_11() //Position: 0xFEB / 4075
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_12() //Position: 0x1179 / 4473
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_13() //Position: 0x132D / 4909
{
	Function_14(&Global_28260, 1, 0);
	return;
}

void Function_14(int iParam0, bool bParam1, int iParam2) //Position: 0x133B / 4923
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_15(int iParam0) //Position: 0x152C / 5420
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_16(int iParam0, bool bParam1, bool bParam2) //Position: 0x15D2 / 5586
{
	int iVar0;
...
void Function_17(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x186D / 6253
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_18() //Position: 0x1E9A / 7834
{
	int iVar0;
...
var Function_19(int iParam0) //Position: 0x1EA2 / 7842
{
	return (2.0f + (0.07f * IntToFloat(iParam0)));
}

struct<32> Function_20(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1EB3 / 7859
{
	char* cVar0[32];
...
struct<32> Function_21(char* cParam0, bool bParam1) //Position: 0x1FA8 / 8104
{
	char* cVar0[32];
...
void Function_22(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1FC1 / 8129
{
	float fVar0;
...
var Function_23(int iParam0, int iParam1) //Position: 0x2026 / 8230
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_24(int iParam0, bool bParam1) //Position: 0x2038 / 8248
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_25(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x204A / 8266
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_26(int iParam0) //Position: 0x217A / 8570
{
	return Global_35278[iParam020].f_48;
}

float Function_27(int iParam0) //Position: 0x2189 / 8585
{
	if (!iParam0 != 4294967295)
	{
...
var Function_28(int iParam0) //Position: 0x21C2 / 8642
{
	if (iParam0 == 4294967295)
	{
...
void Function_29(int iParam0) //Position: 0x21FF / 8703
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_30(int iParam0, bool bParam1, bool bParam2) //Position: 0x2399 / 9113
{
	int iVar0;
	int iVar1;
...
int Function_31(bool bParam0) //Position: 0x25DD / 9693
{
...
struct<8> Function_32() //Position: 0x261E / 9758
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_33() //Position: 0x26A7 / 9895
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_34() //Position: 0x273E / 10046
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_35() //Position: 0x27BD / 10173
{
...
int Function_36(int iParam0, bool bParam1, int iParam2) //Position: 0x27F6 / 10230
{
	int iVar0;
	int iVar1;
...
void Function_37() //Position: 0x2A00 / 10752
{
	vector3 vVar0;
	var uVar3;
...
bool Function_38(vector3 vParam0) //Position: 0x2ABB / 10939
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_39(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2AD3 / 10963
{
	int iVar0;
...
vector3 Function_40() //Position: 0x2BBA / 11194
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_41(int iParam0) //Position: 0x2BC3 / 11203
{
...
int Function_42(bool bParam0, bool bParam1) //Position: 0x2BD9 / 11225
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_43(vector3 vParam0, vector3 vParam3) //Position: 0x2CA0 / 11424
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_44(var uParam0, int iParam1) //Position: 0x2CBD / 11453
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_45(int iParam0) //Position: 0x34E2 / 13538
{
	var uVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x351D / 13597
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x352A / 13610
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x3537 / 13623
{
	uParam0 = uParam0;
...
void Function_49(int iParam0) //Position: 0x35DB / 13787
{
	bool bVar0;
	bool bVar1;
	char* cVar2[64];
	...
	if (Function_195(4) && !Function_55(0))
	{
	...
	if (!Function_52(&Global_3422[240] + 128, 2) || ((((((Function_195(14) && Function_195(18)) && Function_195(37)) && Function_195(7)) && Function_195(11)) && Function_195(5)) && Function_195(21)))
	{
	...
	if (!Function_52(&Global_3422[340] + 128, 2) || ((Function_195(27) && Function_195(1)) && Function_195(23)))
	{
	...
	if (!Function_195(7))
	{
		...
		if (((Function_195(6) && Function_50(Global_30735) < 0) && Function_50(Global_30737) < 0) && Function_50(Global_30738) < 0)
		{
...
int Function_50(int iParam0) //Position: 0x3ED0 / 16080
{
...
bool Function_51(int iParam0) //Position: 0x3EEA / 16106
{
...
bool Function_52(int iParam0, int iParam1) //Position: 0x3F01 / 16129
{
	int iVar0;
...
bool Function_53() //Position: 0x3F1D / 16157
{
	return STRING_TO_HASH(Function_54());
}

var Function_54() //Position: 0x3F29 / 16169
{
	return "ZOMBIE_STORY";
}

bool Function_55(int iParam0) //Position: 0x3F3E / 16190
{
...
int Function_56(int iParam0) //Position: 0x3FA4 / 16292
{
	if (iParam0 > 0 || iParam0 < 4)
	{
...
void Function_57(char* cParam0) //Position: 0x40B1 / 16561
{
...
bool Function_58(int iParam0, bool bParam1) //Position: 0x40F9 / 16633
{
	int iVar0;
...
var Function_59(int iParam0) //Position: 0x4136 / 16694
{
...
bool Function_60(int iParam0) //Position: 0x4150 / 16720
{
...
void Function_61(bool bParam0) //Position: 0x4166 / 16742
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_62(int iParam0, int iParam1) //Position: 0x4308 / 17160
{
	float fVar0;
	bool bVar1;
...
void Function_63(int iParam0) //Position: 0x43C2 / 17346
{
	float fVar0;
	bool bVar1;
...
int Function_64(var uParam0, int iParam1) //Position: 0x4464 / 17508
{
	int iVar0;
	var uVar1;
...
void Function_65(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x45C5 / 17861
{
	struct<8> Var0;
...
struct<32> Function_66(bool bParam0) //Position: 0x4660 / 18016
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0, char* cParam1, char* cParam2) //Position: 0x46CA / 18122
{
	char* cVar0[32];
...
int Function_68(bool bParam0) //Position: 0x46E9 / 18153
{
	int iVar0;
	vector3 vVar1;
...
float Function_69(bool bParam0, vector3 vParam1) //Position: 0x484A / 18506
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0) //Position: 0x48C4 / 18628
{
	vector3 vVar0;
...
void Function_71(int iParam0) //Position: 0x492E / 18734
{
...
bool Function_72(int iParam0) //Position: 0x498F / 18831
{
...
void Function_73(int iParam0, int iParam1) //Position: 0x49A5 / 18853
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void Function_74(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4E37 / 20023
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_75(int iParam0) //Position: 0x4EB2 / 20146
{
	char* cVar0[16];
...
bool Function_76() //Position: 0x4EF1 / 20209
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

int Function_77(bool bParam0) //Position: 0x4F1E / 20254
{
...
var Function_78(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x4F4A / 20298
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, iParam7);
}

bool Function_79(int iParam0) //Position: 0x4F66 / 20326
{
...
bool Function_80(int iParam0, int iParam1) //Position: 0x4F7B / 20347
{
	...
	if ((Function_90(iParam1) || Function_195(iParam1)) || Function_89(iParam1))
	{
		return 0;
	}
	if (iParam0->f_160)
...
bool Function_81(int iParam0, int iParam1) //Position: 0x5090 / 20624
{
	int iVar0;
...
bool Function_82(int iParam0) //Position: 0x51D4 / 20948
{
	if (!Function_51(iParam0))
	{
		return 0;
...
bool Function_83(int iParam0) //Position: 0x51F8 / 20984
{
...
bool Function_84(int iParam0) //Position: 0x520D / 21005
{
	return StackVal;
}

bool Function_85(int iParam0) //Position: 0x521D / 21021
{
	if (!iParam0->f_152)
	{
		if (Function_110())
...
bool Function_86(int iParam0) //Position: 0x52C1 / 21185
{
...
bool Function_87(int iParam0) //Position: 0x531A / 21274
{
	int iVar0;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x5336 / 21302
{
	int iVar0;
...
bool Function_89(int iParam0) //Position: 0x5352 / 21330
{
...
int Function_90(int iParam0) //Position: 0x5367 / 21351
{
...
void Function_91() //Position: 0x537C / 21372
{
...
var Function_92(int iParam0, int iParam1) //Position: 0x53F7 / 21495
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_58(6, 0) && Function_195(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_58(9, 0) && Function_195(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_93(int iParam0) //Position: 0x5FE8 / 24552
{
	int iVar0;
	int iVar1;
...
bool Function_94(int iParam0) //Position: 0x6037 / 24631
{
...
int Function_95(int iParam0) //Position: 0x604D / 24653
{
...
void Function_96() //Position: 0x60B6 / 24758
{
...
bool Function_97(int iParam0) //Position: 0x60D9 / 24793
{
	if (!Function_94(iParam0))
	{
...
bool Function_98(int iParam0, int iParam1) //Position: 0x612A / 24874
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x6157 / 24919
{
	if (!Function_94(iParam0))
	{
...
void Function_100(bool bParam0) //Position: 0x61A9 / 25001
{
	int iVar0;
...
void Function_101() //Position: 0x61E3 / 25059
{
	bool bVar0;
...
void Function_102(int iParam0, int iParam1) //Position: 0x6241 / 25153
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_103(bool bParam0) //Position: 0x6254 / 25172
{
	PRINTSTRING("Day ");
...
void Function_104(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x629A / 25242
{
	bool bVar0;
	char* cVar1[16];
...
void Function_105(char* cParam0, int iParam1) //Position: 0x6306 / 25350
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_106(bool bParam0, var uParam1, int iParam2) //Position: 0x633D / 25405
{
	var uVar0;
	char* cVar1[16];
...
int Function_107(char* cParam0) //Position: 0x63B5 / 25525
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_108(int iParam0) //Position: 0x6456 / 25686
{
	int iVar0;
	int iVar1;
...
bool Function_109(int iParam0, int iParam1) //Position: 0x6493 / 25747
{
...
bool Function_110() //Position: 0x64A6 / 25766
{
...
int Function_111(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x64C1 / 25793
{
	int iVar0;
	int iVar1;
...
void Function_112(bool bParam0, bool bParam1) //Position: 0x66E1 / 26337
{
	bool bVar0;
...
void Function_113(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x6706 / 26374
{
	struct<4> Var0;
	int iVar4;
...
bool Function_114(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x678B / 26507
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_115(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x6834 / 26676
{
	if (!bParam15)
	{
	...
	switch (*iParam1)
	{
		...
		case 0x000003EA:
			...
			if (HUD_IS_FADED())
			{
				if ((Function_176(iParam1 + 4) < 15.0f && !DECOR_CHECK_EXIST(Global_34573, "globalcutloadscreen")) && !UI_ISACTIVE("LoadingScreen"))
				{
...
void Function_116(bool bParam0) //Position: 0x6E48 / 28232
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_117() //Position: 0x6EF7 / 28407
{
	bool bVar0;
...
void Function_118() //Position: 0x6F69 / 28521
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_119() //Position: 0x6FAE / 28590
{
...
void Function_120(bool bParam0) //Position: 0x6FC0 / 28608
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_121(bool bParam0, bool bParam1) //Position: 0x6FDD / 28637
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_122(bool bParam0) //Position: 0x705D / 28765
{
	int iVar0;
...
int Function_123(bool bParam0) //Position: 0x708C / 28812
{
	int iVar0;
	bool bVar1;
...
bool Function_124() //Position: 0x7144 / 28996
{
	int iVar0;
	bool bVar1;
...
bool Function_125(int iParam0) //Position: 0x717E / 29054
{
	return iParam0->f_20;
}

void Function_126(var uParam0, int iParam1) //Position: 0x7188 / 29064
{
	Function_127(uParam0, iParam1, 0);
	return;
}

void Function_127(var uParam0, bool bParam1, bool bParam2) //Position: 0x7196 / 29078
{
...
void Function_128(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x72E2 / 29410
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_129() //Position: 0x730B / 29451
{
	bool bVar0;
	bool bVar1;
...
void Function_130() //Position: 0x7356 / 29526
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_131() //Position: 0x7478 / 29816
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_132() //Position: 0x7488 / 29832
{
	...
	if (IS_VOLUME_VALID(bLocal_279))
	{
		DESTROY_VOLUME(bLocal_279);
	}
	return 1;
}

void Function_133(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x752B / 29995
{
	bool bVar0;
...
void Function_134() //Position: 0x761B / 30235
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_135() //Position: 0x7630 / 30256
{
	bool bVar0;
	int iVar1;
	var uVar2[2];
	...
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -1672.57f, 8.149f, 4286.12f, 37.0f, 1, true, 1);
	SET_PLAYER_CONTROL(false, 1, 0, 0);
	ACTOR_POP_NEXT_GAIT(Global_34573, 1, 0);
	SIMULATE_PLAYER_INPUT_GAIT(0, 1, 1.5f, 0);
	DESTROY_ACTOR(bLocal_278);
	bLocal_287 = CREATE_CORPSE_IN_LAYOUT_RANDOM(bLocal_276, "zombiecorpse", 1208, -1662.166f, 8.501f, 4278.45f, 0.0f, 55.0f, 180.0f, "dead_ground_male");
	PROP_ENABLE_VARIABLE_MESH(GET_PHYSINST_FROM_OBJECT(bLocal_287), 23, 0);
	PROP_ENABLE_VARIABLE_MESH(GET_PHYSINST_FROM_OBJECT(bLocal_287), 29, 1);
	GIVE_WEAPON_TO_ACTOR(bLocal_277, 9, 0, 1, 1);
	ACTOR_PUT_WEAPON_IN_HAND(bLocal_277, 9, 0);
	ACTOR_DRAW_WEAPON(bLocal_277, 9, 0);
	bVar0 = TASK_SEQUENCE_OPEN();
	TASK_DRAW_HOLSTER_WEAPON(false, 1);
	TASK_GUARD_STAND(0, &Global_63541[2555] + 112, 32.0f);
	TASK_SEQUENCE_CLOSE();
	TASK_SEQUENCE_PERFORM(bLocal_277, bVar0);
	ACTOR_POP_NEXT_GAIT(bLocal_277, 0, 0);
	if (Function_139(Global_30693[1]))
	{
		...
		bVar5 = Function_137("lashermanas", "storageRoom01Props01x", 7);
		if (IS_DOOR_VALID(bVar5))
		{
			Function_136(bVar5, 1);
		}
	}
	return 1;
}

void Function_136(bool bParam0, bool bParam1) //Position: 0x77CA / 30666
{
...
int Function_137(var uParam0, char* cParam1, int iParam2) //Position: 0x781B / 30747
{
	return Function_138(Global_29006, uParam0, cParam1, iParam2);
}

int Function_138(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x782D / 30765
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_139(bool bParam0) //Position: 0x78C9 / 30921
{
	if (!Function_72(bParam0))
	{
		return 1;
	}
	return Function_88(&(Global_29008[bParam0]), 4);
}

int Function_140() //Position: 0x78E5 / 30949
{
	if (!iLocal_284)
	{
		Function_148(-1665.69f, 8.06f, 4276.58f, bLocal_279);
		DESTROY_OBJECT(bLocal_286);
		iLocal_284 = 1;
	}
...
void Function_141() //Position: 0x791F / 31007
{
	int iVar0;
	bool bVar1;
...
void Function_142(bool bParam0, bool bParam1) //Position: 0x7957 / 31063
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		{
			if (((Function_146() || Function_145(bParam0)) || Function_144(bParam0)) || Function_143(bParam0, 1))
			{
			...
			{
				bVar3 = CREATE_VOLUME_IN_LAYOUT(bParam0, Function_18(), 2, vVar0, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 0.5f);
			...
			Function_40();
			bVar5 = CREATE_RMPTFX_EMITTER_ON_BONE(Function_18(), "blood_zombie_shotgun_exit", "head", bParam0, Function_40(), bParam0);
			if (IS_OBJECT_VALID(bVar5))
			{
				Function_40();
				UNK_0x6745191B(bVar5, Function_40());
			}
		}
	}
	return;
...
bool Function_143(bool bParam0, int iParam1) //Position: 0x7B22 / 31522
{
	bool bVar0;
...
int Function_144(bool bParam0) //Position: 0x7B64 / 31588
{
	bool bVar0;
...
int Function_145(bool bParam0) //Position: 0x7B84 / 31620
{
	bool bVar0;
...
var Function_146() //Position: 0x7BA4 / 31652
{
	return (RAND_INT_RANGE(false, 1999) / 1000) != 0;
}

bool Function_147(bool bParam0) //Position: 0x7BB7 / 31671
{
	bool bVar0;
...
void Function_148(vector3 vParam0) //Position: 0x7C02 / 31746
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_149(bool bParam0, bool bParam1) //Position: 0x7D88 / 32136
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_150(bool bParam0, float fParam1) //Position: 0x7E79 / 32377
{
...
void Function_151() //Position: 0x7F77 / 32631
{
...
void Function_152() //Position: 0x7FA9 / 32681
{
...
int Function_153() //Position: 0x80A9 / 32937
{
	return 1;
}

int Function_154() //Position: 0x80B0 / 32944
{
	...
	bLocal_279 = CREATE_VOLUME_IN_LAYOUT(bLocal_276, "Mother1_CSVol", 2, *(&Global_63541[2455] + 100), 0.0f, 0.0f, 0.0f, 50.0f, 20.0f, 50.0f);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("ZOMBIE_Fast_05", bLocal_278);
	CUTSCENE_MANAGER_SET_ASSET_OVERRIDE_ACTOR("MISC_Mother_Superior", bLocal_277);
	Function_157(0, 0, 1, 1, 0, 1, 1, bLocal_279, 1, 1, 1, 1);
	Function_155(StackVal, StackVal, bLocal_276, *(&Global_63541[2455] + 112), &bLocal_279, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_155(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x81EF / 33263
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_156(bool bParam0, bool bParam1) //Position: 0x845D / 33885
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_157(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, var uParam10, bool bParam11) //Position: 0x84D2 / 34002
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_160(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_18(), 2, Function_160(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_158(int iParam0) //Position: 0x8780 / 34688
{
	int iVar0;
...
var Function_159() //Position: 0x87B4 / 34740
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_160(bool bParam0) //Position: 0x8833 / 34867
{
	vector3 vVar0;
...
int Function_161(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x8844 / 34884
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_162(int iParam0, int iParam1) //Position: 0x8A56 / 35414
{
	var uVar0;
...
float Function_163(bool bParam0, bool bParam1) //Position: 0x8AC1 / 35521
{
	vector3 vVar0;
...
void Function_164(bool bParam0, bool bParam1) //Position: 0x8AE0 / 35552
{
	bool bVar0;
	bool bVar1;
...
bool Function_165(bool bParam0, bool bParam1, bool bParam2) //Position: 0x8B3D / 35645
{
...
bool Function_166() //Position: 0x8BF3 / 35827
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_167(bool bParam0) //Position: 0x8C0A / 35850
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_168(bool bParam0) //Position: 0x8C15 / 35861
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

int Function_169(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x8C23 / 35875
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_171(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_171(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_170(float fParam0) //Position: 0x8D84 / 36228
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_170(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_171(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x8DB9 / 36281
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_174(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_175()) * (fParam7 - fParam6)) * 0.5f))) || bParam12)
	{
	...
	else if ((!Function_174(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_175()) * (fParam7 - fParam6)) * 0.5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_174(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_172() //Position: 0x8FFF / 36863
{
	int iVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (iVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(iVar0, &vVar1, &Var4))
		{
			...
			Function_173(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(iVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		iVar0++;
	}
	return;
...
void Function_173(char* cParam0, vector3 vParam1) //Position: 0x9053 / 36947
{
	char* cVar0[64];
...
bool Function_174(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x917B / 37243
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_70(bParam0);
...
int Function_175() //Position: 0x9205 / 37381
{
	if (IS_PS3())
	{
		return 1;
...
float Function_176(int iParam0) //Position: 0x9214 / 37396
{
...
bool Function_177(int iParam0) //Position: 0x92DC / 37596
{
	return Function_46(*iParam0, 2);
}

bool Function_178(int iParam0) //Position: 0x92E9 / 37609
{
	return Function_46(*iParam0, 1);
}

void Function_179(int iParam0) //Position: 0x92F6 / 37622
{
	Function_180(iParam0, 0.0f);
	return;
}

void Function_180(var uParam0, float fParam1) //Position: 0x9302 / 37634
{
...
bool Function_181(int iParam0) //Position: 0x9323 / 37667
{
	int iVar0;
	int iVar1;
	...
	Function_186();
	iVar1 = 0;
	if (!Function_185(iParam0[iVar03], 16))
	{
	...
	{
		if (Function_185(iParam0[iVar03], 4))
		{
			if (!Function_185(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP((*iParam0)[iVar03], (Function_185(iParam0[03], 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_185(iParam0[03], 8) || iVar1));
						break;
	...
	while (iVar0 < (*iParam0 - 1))
	{
		if (Function_185(iParam0[iVar03], 4))
		{
			if (!Function_185(iParam0[iVar03], 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_182() //Position: 0x969E / 38558
{
	if (!Function_87(128))
	{
		return;
...
bool Function_183() //Position: 0x96DE / 38622
{
	int iVar0;
...
void Function_184(var uParam0, int iParam1) //Position: 0x9709 / 38665
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_185(int iParam0, int iParam1) //Position: 0x971A / 38682
{
	int iVar0;
...
void Function_186() //Position: 0x9737 / 38711
{
	if (!Function_87(128))
	{
		return;
...
int Function_187() //Position: 0x9779 / 38777
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return "";
...
void Function_188() //Position: 0x978E / 38798
{
	int iVar0;
	bool bVar1;
	
	GIVE_OBJECT_TO_LAYOUT(bLocal_287, bLocal_277);
	ENABLE_CHILD_SECTOR("lsh_garden01x");
	ENABLE_CHILD_SECTOR("lsh_arches01x");
	ENABLE_CHILD_SECTOR("lsh_shacks01x");
	ENABLE_CHILD_SECTOR("lsh_storageRoom01x");
	ENABLE_CHILD_SECTOR("lsh_prayerRoom01x");
	ENABLE_CHILD_SECTOR("lsh_church01x");
	REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_280);
	REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_280);
	if (IS_LAYOUTREF_VALID(bLocal_276))
	{
		RELEASE_LAYOUT_REF(bLocal_276);
	}
	if (IS_ACTOR_VALID(bLocal_278))
	{
		DESTROY_ACTOR(bLocal_278);
	}
	SET_ACTOR_INVULNERABILITY(bLocal_278, 0);
	SET_ACTOR_INVULNERABILITY(bLocal_277, 0);
	AI_STOP_IGNORING_ACTORS();
	Function_190(&bLocal_249);
	if (!Function_89(24))
	{
		iVar0 = 0;
		while (iVar0 <= 6)
		{
			bVar1 = Function_138(Global_30693[1], "lashermanas", "walls01", iVar0 + 1);
			if (IS_DOOR_VALID(bVar1))
			{
				Function_136(bVar1, 0);
			}
			iVar0++;
		}
...
int Function_189(bool bParam0, bool bParam1, bool bParam2) //Position: 0x98CE / 39118
{
	if (bParam2)
	{
		if (!CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())
...
void Function_190(int iParam0) //Position: 0x98FD / 39165
{
	int iVar0;
...
void Function_191(var uParam0, int iParam1) //Position: 0x9923 / 39203
{
	if (Function_185(uParam0[iParam13], 4))
	{
		if (Function_185(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
...
void Function_192(var uParam0, int iParam1) //Position: 0x9A51 / 39505
{
	int iVar0;
...
void Function_193(var uParam0, int iParam1) //Position: 0x9A6B / 39531
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_194(int iParam0, bool bParam1) //Position: 0x9A7A / 39546
{
	char* cVar0[32];
...
bool Function_195(int iParam0) //Position: 0x9BFA / 39930
{
...
bool Function_196() //Position: 0x9C0F / 39951
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LAYOUTREF_VALID(bLocal_276))
	{
		bVar0 = CREATE_OBJECT_ITERATOR(bLocal_276);
		...
		while (IS_OBJECT_VALID(bVar1))
		{
			...
			{
				if (GET_EVENT_TYPE(bVar2) == 91)
				{
					if (GET_EVENT_TARGET_AS_OBJECT(bVar2) == GET_OBJECT_FROM_ACTOR(bLocal_277))
					{
...
void Function_197(int iParam0) //Position: 0x9C7B / 40059
{
	if (!Function_178(iParam0))
	{
		Function_180(iParam0, 0.0f);
...
var Function_198(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x9C90 / 40080
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_199(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_199(var uParam0, int iParam1, int iParam2) //Position: 0x9CC8 / 40136
{
	int iVar0;
	...
	{
		if (!Function_185(uParam0[iVar03], 4))
		{
...
var Function_200(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x9D8C / 40332
{
	int iVar0;
