...
void Function_81(var uParam0, int iParam1) //Position: 0x2EFE / 12030
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2F0C / 12044
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x3014 / 12308
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x302A / 12330
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32E0 / 13024
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x32EE / 13038
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x3307 / 13063
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x3321 / 13089
{
	bool bVar0;
	char* cVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x3359 / 13145
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3370 / 13168
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3639 / 13881
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3656 / 13910
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36F2 / 14066
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x3711 / 14097
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3720 / 14112
{
...
void Function_96(int iParam0) //Position: 0x373C / 14140
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3746 / 14150
{
	int iVar0;
	int iVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x37A8 / 14248
{
...
void Function_99(int iParam0) //Position: 0x37BC / 14268
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37C6 / 14278
{
