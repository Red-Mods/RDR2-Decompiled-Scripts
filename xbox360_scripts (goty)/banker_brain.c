...
void main() //Position: 0x0 / 0
{
	...
	{
		if (IS_PERS_CHAR_VALID(Function_48()))
		{
			if (!Function_47(&Var0))
			{
				GRINGO_HAS_PENDING_MESSAGE();
				Function_46(StackVal);
				if (IS_PERS_CHAR_ALIVE(Function_48()))
				{
					Function_10(&iVar16, &Var0, 0);
				}
...
void Function_1(int iParam0, bool bParam1) //Position: 0xFA / 250
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
var Function_2(bool bParam0) //Position: 0x197 / 407
{
	int iVar0;
	var uVar1;
	bool bVar2;
	...
	uVar4 = GRINGO_GET_ATTRIBUTE(bVar3, 0);
	return GRINGO_GET_FLOAT_ATTR_BY_HANDLE(uVar4, &uVar1);
}

int Function_3(int iParam0) //Position: 0x303 / 771
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (TIME_IS_IN_RANGE(uVar6, iVar0, iVar1))
	{
		return 1;
	}
	if (TIME_IS_IN_RANGE(uVar6, iVar1, iVar2))
	{
		return 2;
	}
	if (TIME_IS_IN_RANGE(uVar6, iVar2, iVar3))
	{
		return 4;
	}
	if (TIME_IS_IN_RANGE(uVar6, iVar3, iVar4))
	{
		return 8;
	}
	if (TIME_IS_IN_RANGE(uVar6, iVar4, iVar5))
	{
		return 16;
	}
	if (TIME_IS_IN_RANGE(uVar6, iVar5, iVar0))
	{
		return 32;
	}
	return 32;
...
vector3 Function_4(int iParam0, bool bParam1) //Position: 0x3DA / 986
{
	vector3 vVar0;
	int iVar20;
	vector3 vVar21;
	...
	if (Function_5(StackVal, StackVal, vVar21, 0.0f, 0.0f, 0.0f))
	{
		...
		if (IS_ACTOR_VALID(Function_8()))
		{
			GET_POSITION(Function_8(), &vVar21);
			if (Function_9(iParam0))
			{
		...
		else if (IS_PERS_CHAR_VALID(Function_48()))
		{
...
bool Function_5(vector3 vParam0, vector3 vParam3) //Position: 0x6A0 / 1696
{
	vector3 vVar0;
...
bool Function_6(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) //Position: 0x6CD / 1741
{
	int iVar0;
...
int Function_10(int iParam0, bool bParam1, bool bParam2) //Position: 0x7FB / 2043
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
	...
	switch (*iParam0)
	{
		case 0x00000000:
			...
			*(bParam1 + 40) = { StackVal, StackVal, Function_4(bParam1, bParam1->f_16) };
			...
			bParam1->f_56 = Function_44(bParam1);
			bParam1->f_12 = 0;
			bParam1->f_60 = Function_43(bParam1, bParam1 + 12, 0);
			bParam1->f_8 = Function_40(StackVal, StackVal, bParam1, bParam1->f_56, bParam1->f_60, "UseCase1", *(bParam1 + 40), bParam1->f_52, 0, 0);
			if (STRINGS_ARE_EQUAL(bParam1->f_60, "nsleeptime"))
			{
				*bParam1 = 0;
				Function_39(bParam1 + 28);
				Function_35(bParam1 + 28);
				if (bParam2)
				{
				...
				{
					TASK_PRIORITY_SET(bVar6, 3);
					Function_33(StackVal, StackVal, *(bParam1 + 40), bParam1->f_52, -1.0f);
				}
				SET_PERS_CHAR_ENABLED(bVar7, 0);
				...
				if (IS_OBJECT_VALID(StackVal))
				{
					switch (GET_OBJECT_TYPE(StackVal))
					{
						case 0x0000000C:
							...
							{
								Function_32(StackVal, StackVal, vVar1, bVar6, bVar7);
							}
							else
							{
								Function_32(StackVal, StackVal, *(bParam1 + 40), bVar6, bVar7);
							}
							*iParam0 = 1;
							break;
				...
				if (IS_OBJECT_VALID(StackVal))
				{
					switch (GET_OBJECT_TYPE(StackVal))
					{
						case 0x0000000C:
							...
							if (!Function_5(StackVal, StackVal, vVar1, 0.0f, 0.0f, 0.0f))
							{
								Function_30(StackVal, StackVal, vVar1, bVar6, bVar7);
							}
							else
							{
								Function_30(StackVal, StackVal, *(bParam1 + 40), bVar6, bVar7);
							}
							*iParam0 = 1;
							break;
		...
		case 0x00000001:
			...
			bParam1->f_60 = Function_43(bParam1, bParam1 + 12, 0);
			bParam1->f_8 = Function_40(StackVal, StackVal, bParam1, bParam1->f_56, bParam1->f_60, "UseCase1", *(bParam1 + 40), bParam1->f_52, 0, 0);
			Function_28(bParam1, "GB_PERFORM_SCHEDULED_TASK", bParam1->f_60);
			if (IS_ACTOR_VALID(bVar6))
			{
				if (IS_OBJECT_VALID(StackVal))
				{
					switch (GET_OBJECT_TYPE(StackVal))
					{
						...
						default:
							Function_26(bParam1, "GB_PERFORM_SCHEDULED_TASK: Unhandled object! what the hell has come through?");
							*iParam0 = 20;
							break;
					}
				}
				...
				{
					Function_26(bParam1, "WARNING! No valid TASK for this pers char");
					*iParam0 = 9;
				}
			}
			else
		...
		case 0x00000004:
			*bParam1 = 500;
			if (IS_ACTOR_VALID(bVar6))
			{
				...
				{
					if (Function_23(StackVal, bVar6, "UseCase1", Function_9(bParam1)))
					{
						if (Function_22(StackVal, bVar6, "UseCase1", &bVar22))
						{
							Function_39(bParam1 + 28);
							Function_35(bParam1 + 28);
							*iParam0 = 5;
						...
						{
							Function_28(bParam1, "GB_PERFORM_SCHEDULED_TASK", "GB_REACH_AND_USE_GRINGO failed - gringo is inside a restriction volume.");
							*iParam0 = 9;
							break;
						}
					}
					...
					if (Function_18(bParam1 + 28) < 20.0f)
					{
						if ((GET_TASK_STATUS(bVar6, 1) != 4 || GET_TASK_STATUS(bVar6, 19) != 4) || Function_29(bParam1))
						{
							*iParam0 = 20;
						}
					}
		...
		case 0x00000008:
			*bParam1 = 0;
			...
			{
				Function_24(&bVar6);
				fVar5 = Function_17(bParam1->f_60);
				vVar1 = { StackVal, StackVal, *(bParam1 + 40) };
				uVar4 = bParam1->f_52;
				if (Function_16(bParam1, &vVar8, &vVar11))
				{
					vVar14 = { Function_15(vVar8.x, vVar11.x), Function_15(vVar8.y, vVar11.y), Function_15(vVar8.z, vVar11.z) };
					vVar17 = { Function_14(vVar8.x, vVar11.x), Function_14(vVar8.y, vVar11.y), Function_14(vVar8.z, vVar11.z) };
					TASK_PRIORITY_SET(bVar6, 3);
				...
				{
					Function_33(StackVal, StackVal, vVar1, uVar4, fVar5);
					*iParam0 = 11;
				}
			}
			else
		...
		case 0x00000009:
			*bParam1 = 0;
			if (IS_ACTOR_VALID(bVar6))
			{
				...
				if (bParam2)
				{
					Function_26(bParam1, "An error has triggered GB_SCHEDULE_TASK_WANDER_FALLBACK (this is a shopkeeper) - check spew!");
					vVar1 = { StackVal, StackVal, *(bParam1 + 40) };
					uVar4 = bParam1->f_52;
					TASK_PRIORITY_SET(bVar6, 2);
				...
				{
					Function_26(bParam1, "An error has triggered GB_SCHEDULE_TASK_WANDER_FALLBACK - check spew!");
					if (Function_16(bParam1, &vVar8, &vVar11))
					{
						vVar14 = { Function_15(vVar8.x, vVar11.x), Function_15(vVar8.y, vVar11.y), Function_15(vVar8.z, vVar11.z) };
						vVar17 = { Function_14(vVar8.x, vVar11.x), Function_14(vVar8.y, vVar11.y), Function_14(vVar8.z, vVar11.z) };
					...
					else
					{
						vVar1 = { StackVal, StackVal, *(bParam1 + 40) };
						uVar4 = bParam1->f_52;
						Function_33(StackVal, StackVal, vVar1, uVar4, 20.0f);
						*iParam0 = 11;
					}
				}
			}
		...
		case 0x0000000E:
			Function_13(bParam1, bVar7, "STANDING STILL FALLBACK");
			*bParam1 = 500;
			if (IS_ACTOR_VALID(bVar6))
			{
				iVar0 = GET_TASK_STATUS(bVar6, 6);
		...
		case 0x0000000F:
			Function_13(bParam1, bVar7, "nSLEEPTIME");
			if (IS_ACTOR_VALID(bVar6))
			{
			...
			*bParam1 = 500;
			if (IS_ACTOR_VALID(bVar6))
			{
				...
				else
				{
					...
					if (StackVal && Function_12(AI_HAS_ACTOR_BUMPED_INTO_ME(bVar6, Global_34573, 10.0f)))
					{
						*iParam0 = 20;
					}
					if (Function_29(bParam1))
		...
		case 0x00000011:
			Function_13(bParam1, bVar7, "RESPONDING TO RAIN");
			*bParam1 = 0;
			if (!bVar20)
			{
				*iParam0 = 20;
		...
		case 0x00000012:
			Function_13(bParam1, bVar7, "RESPONDING TO RETREAT");
			*bParam1 = 0;
			if (IS_ACTOR_VALID(bVar6))
			{
				if (!AI_GET_IS_RETREATING(bVar6))
		...
		case 0x00000015:
			if (!Function_47(bParam1))
			{
				...
				{
					Function_13(bParam1, bVar7, "STOLEN KEEP_LAST_TASK");
					if (!IS_ACTOR_VALID(bVar6))
					{
			...
			{
				Function_13(bParam1, bVar7, "STOLEN");
			}
			break;
		
		default:
			Function_28(bParam1, "GB_PERFORM_SCHEDULED_TASK", "UNKNOWN STATE!");
			return 0;
			break;
	}
	return 1;
...
bool Function_11(float fParam0, bool bParam1) //Position: 0x177D / 6013
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_12(bool bParam0) //Position: 0x17A8 / 6056
{
	bool bVar0;
	int iVar1;
...
void Function_13(bool bParam0, bool bParam1, bool bParam2) //Position: 0x17EE / 6126
{
	struct<5> Var0;
...
int Function_14(int iParam0, int iParam1) //Position: 0x1815 / 6165
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
int Function_15(int iParam0, int iParam1) //Position: 0x1828 / 6184
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_16(bool bParam0, var uParam1, int iParam2) //Position: 0x183B / 6203
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (iVar8 <= iVar7)
	{
		uVar5 = GRINGO_GET_ATTRIBUTE(bVar4, iVar8);
		if (!bVar1)
		{
			bVar1 = GRINGO_GET_VECTOR_ATTR_BY_HANDLE(uVar5, uParam1);
		}
		else if (!bVar2)
		{
...
var Function_17(bool bParam0) //Position: 0x19FA / 6650
{
	int iVar0;
	int iVar1;
...
float Function_18(int iParam0) //Position: 0x1A28 / 6696
{
...
bool Function_19(int iParam0) //Position: 0x1AF0 / 6896
{
	return Function_20(*iParam0, 2);
}

int Function_20(var uParam0, int iParam1) //Position: 0x1AFD / 6909
{
	return (uParam0 && iParam1) == 0;
}

bool Function_21(int iParam0) //Position: 0x1B0A / 6922
{
	return Function_20(*iParam0, 1);
}

bool Function_22(bool bParam0, bool bParam1, bool bParam2, var uParam3) //Position: 0x1B17 / 6935
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_23(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1B9C / 7068
{
	bool bVar0;
	...
	if (IS_OBJECT_VALID(bParam1))
	{
		if (GET_OBJECT_TYPE(bParam1) == 12)
		{
			...
			{
				if (!GRINGO_ACTOR_CAN_USE(GET_GRINGO_FROM_OBJECT(bParam1), bParam2, iParam0))
				{
					if (bParam3)
					{
...
void Function_24(bool bParam0) //Position: 0x1DD6 / 7638
{
...
void Function_25(bool bParam0) //Position: 0x1DF8 / 7672
{
...
void Function_26(int iParam0, bool bParam1) //Position: 0x1E74 / 7796
{
	if (Function_9(iParam0))
	{
		LOG_ERROR(bParam1);
...
bool Function_27(int iParam0) //Position: 0x1E87 / 7815
{
	bool bVar0;
	var uVar1;
...
void Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x1ECC / 7884
{
	if (Function_9(iParam0))
	{
...
bool Function_29(bool bParam0) //Position: 0x1F26 / 7974
{
...
void Function_30(vector3 vParam0, bool bParam3, var uParam4) //Position: 0x1F40 / 8000
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
	...
	if (IS_ACTOR_VALID(bParam3))
	{
		if (!CAMERA_IS_VISIBLE_ACTOR(GET_GAME_CAMERA(), bParam3, 1065353216, 1117126656, 1, 1, 0))
		{
			...
			if (!Function_31(StackVal, StackVal, vVar0))
			{
			...
			if (!WOULD_ACTOR_BE_VISIBLE(GET_ACTOR_ENUM(bParam3), &vVar7, 3212836864))
			{
				...
				SET_OBJECT_POSITION(uParam4, vVar7);
			}
		}
	}
	else
	{
		SET_OBJECT_POSITION(uParam4, vVar0);
	}
}

bool Function_31(vector3 vParam0) //Position: 0x2084 / 8324
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

void Function_32(vector3 vParam0, bool bParam3, var uParam4) //Position: 0x209C / 8348
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
void Function_33(vector3 vParam0, var uParam3, float fParam4) //Position: 0x21A6 / 8614
{
	var uVar0;
	var uVar3;
	...
	Function_34(StackVal, StackVal, vParam0, uParam3, &uVar0, &uVar3);
	TASK_PRIORITY_SET(Function_8(), 3);
	TASK_WANDER_IN_BOX(Function_8(), &uVar0, &uVar3, fParam4);
}

void Function_34(vector3 vParam0) //Position: 0x21D8 / 8664
{
	if (fParam3 >= 0.0f)
	{
		fParam3 = 1.0f;
...
void Function_35(int iParam0) //Position: 0x2244 / 8772
{
	if (!Function_21(iParam0))
	{
...
void Function_36(var uParam0, float fParam1) //Position: 0x2259 / 8793
{
	uParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_38(uParam0, 1);
	Function_37(uParam0, 2);
	uParam0->f_8 = 0.0f;
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x227A / 8826
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, int iParam1) //Position: 0x228D / 8845
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_39(bool bParam0) //Position: 0x229C / 8860
{
	bParam0->f_4 = 0.0f;
	bParam0->f_8 = 0.0f;
	*bParam0 = 0;
...
var Function_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, vector3 vParam4, float fParam7, bool bParam8, bool bParam9) //Position: 0x22B0 / 8880
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bParam8 || bParam9)
	{
		bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_42(), bParam1, 4294967295, 0);
		bVar1 = CREATE_OBJECT_ITERATOR(bParam1);
		ITERATE_IN_SET(bVar1, bVar2);
		if (LOCATE_GRINGOS_OF_TYPE(bVar2, bParam2, &vParam4, fParam7, 1) >= 0)
		{
			bVar0 = Function_41(bVar1, bParam8, bParam9);
			if (!IS_OBJECT_VALID(bVar0))
			{
				LOG_ERROR("Iteration failed");
			}
		}
		else if (LOCATE_GRINGOS_OF_NAME(bVar2, bParam2, &vParam4, fParam7, 1) >= 0)
		{
			bVar0 = Function_41(bVar1, bParam8, bParam9);
			if (!IS_OBJECT_VALID(bVar0))
			{
	...
	{
		bVar0 = GET_OBJECT_FROM_GRINGO(LOCATE_GRINGO_OF_TYPE(bParam2, &vParam4, fParam7, 1));
		if (IS_OBJECT_VALID(bVar0))
		{
			if (GET_OBJECT_TYPE(GET_OBJECT_OWNER(bVar0)) == 24)
			{
				...
				bVar0 = GET_OBJECT_FROM_GRINGO(LOCATE_GRINGO_OF_TYPE(bParam2, &vParam4, fParam7, 0));
				if (IS_OBJECT_VALID(bVar0))
				{
					if (Function_9(iParam0))
					{
		...
		bVar0 = GET_OBJECT_FROM_GRINGO(LOCATE_GRINGO_OF_NAME(bParam2, &vParam4, fParam7, 1));
		if (IS_OBJECT_VALID(bVar0))
		{
			if (GET_OBJECT_TYPE(GET_OBJECT_OWNER(bVar0)) == 24)
			{
				...
				bVar0 = GET_OBJECT_FROM_GRINGO(LOCATE_GRINGO_OF_NAME(bParam2, &vParam4, fParam7, 0));
				if (IS_OBJECT_VALID(bVar0))
				{
					if (Function_9(iParam0))
					{
...
bool Function_41(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2A2D / 10797
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (IS_OBJECT_VALID(bVar1))
	{
		if (bParam1 || bParam2)
		{
			if (IS_ACTOR_VALID(Function_8()))
			{
				...
				GET_POSITION(Function_8(), &Var7);
				if (bParam1)
				{
					fVar10 = VDIST(Var4, Var7);
					if (fVar10 > fVar11)
					{
						if (bParam2)
						{
...
var Function_42() //Position: 0x2B12 / 11026
{
	int iVar0;
...
var Function_43(int iParam0, var uParam1, int iParam2) //Position: 0x2B1A / 11034
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 <= iVar2)
	{
		uVar6 = GRINGO_GET_ATTRIBUTE(bVar5, iVar1);
...
var Function_44(var uParam0) //Position: 0x2CE1 / 11489
{
	struct<73> Var0;
...
var Function_45() //Position: 0x2D30 / 11568
{
	return StackVal;
}

void Function_46(bool bParam0) //Position: 0x2D3B / 11579
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!IS_VOLUME_VALID(bLocal_4[1]))
	{
		bVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Banker_Vols", 0, bParam0);
		bVar2 = GRINGO_GET_FIRST_NAMED_CHILD("Volumes", 0, bVar1);
		uVar3 = GRINGO_GET_ATTRIBUTE(bVar2, 0);
		bVar5 = GRINGO_GET_STRING_ATTR_BY_HANDLE(uVar3, &uVar4);
		bLocal_4[1] = FIND_VOLUME_IN_LAYOUT(Global_30616, bVar5);
		return;
	}
	if (IS_ACTOR_IN_VOLUME(Global_34573, bLocal_4[1]) && iLocal_2 == Global_34573)
	{
		iLocal_2 = Global_34573;
		fLocal_0 = GET_CURRENT_GAME_TIME();
		SAY_SINGLE_LINE_CONTEXT(bVar0, 341, Global_34573, 0, 0, 0, 4294967295, 4294967295, 0, 1);
		return;
	}
	if (!IS_VOLUME_VALID(bLocal_4[0]))
	{
		bVar6 = GRINGO_GET_FIRST_NAMED_CHILD("Banker_Vols", 0, bParam0);
		bVar7 = GRINGO_GET_FIRST_NAMED_CHILD("Volumes", 0, bVar6);
		uVar8 = GRINGO_GET_ATTRIBUTE(bVar7, 1);
		bVar10 = GRINGO_GET_STRING_ATTR_BY_HANDLE(uVar8, &uVar9);
		bLocal_4[0] = FIND_VOLUME_IN_LAYOUT(Global_30616, bVar10);
		return;
	}
	iVar11 = CREATE_OBJECTSET_IN_LAYOUT(Function_42(), Global_30616, 15, 0);
	LOCATE_ACTORS_IN_VOLUME(bLocal_4[0], iVar11, 0, 1);
	if (GET_OBJECTSET_SIZE(iVar11) != 0)
	{
		bVar12 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(0, iVar11));
		if (bVar12 != bLocal_3)
		{
			bLocal_3 = bVar12;
			fLocal_0 = GET_CURRENT_GAME_TIME();
			GET_POSITION(bVar0, &vVar13);
			GET_ACTOR_AXIS(Global_34573, &uVar19, 0);
			GET_POSITION(Global_34573, &vVar16);
			vVar22 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(vVar16, vVar13, StackVal) };
			VNORMALIZE(&vVar22);
			if (VDOT(&vVar22, &uVar19) <= 0.0f)
			{
				SAY_SINGLE_LINE_CONTEXT(bVar0, 339, bLocal_3, 0, 0, 0, 4294967295, 4294967295, 0, 1);
				return;
			}
			SAY_SINGLE_LINE_CONTEXT(bVar0, 340, bLocal_3, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			return;
		}
		fLocal_0 = GET_CURRENT_GAME_TIME();
		GET_POSITION(bVar0, &vVar25);
		GET_ACTOR_AXIS(Global_34573, &uVar31, 0);
		GET_POSITION(Global_34573, &vVar28);
		vVar34 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(vVar28, vVar25, StackVal) };
		VNORMALIZE(&vVar34);
		fVar37 = VDOT(&vVar34, &uVar31);
		if (fVar37 <= 0.0f && !iLocal_1)
		{
			SAY_SINGLE_LINE_CONTEXT(bVar0, 339, bLocal_3, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			iLocal_1 = 1;
			return;
		}
		if (iLocal_1 && fVar37 > 0.0f)
		{
			SAY_SINGLE_LINE_CONTEXT(bVar0, 340, bLocal_3, 0, 0, 0, 4294967295, 4294967295, 0, 1);
			iLocal_1 = 0;
			return;
	...
	DESTROY_OBJECTSET(iVar11);
	if ((GET_CURRENT_GAME_TIME() - fLocal_0) <= 15.0f)
	{
		fLocal_0 = GET_CURRENT_GAME_TIME();
		SAY_SINGLE_LINE_CONTEXT(bVar0, 338, false, 0, 0, 0, 4294967295, 4294967295, 0, 1);
		return;
	}
	return;
}

bool Function_47(bool bParam0) //Position: 0x2F73 / 12147
{
	bool bVar0;
	var uVar1;
...
var Function_48() //Position: 0x2FB7 / 12215
{
	return GET_PERS_CHAR_FROM_OBJECT(GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF()));
}

bool Function_49(int iParam0) //Position: 0x2FC6 / 12230
{
	bool bVar0;
	int iVar1;
	bool bVar2;
