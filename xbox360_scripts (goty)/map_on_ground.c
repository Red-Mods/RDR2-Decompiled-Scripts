...
void Function_83(bool bParam0, bool bParam1) //Position: 0x326D / 12909
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
	...
	bParam1 = bParam1;
	bParam0 = bParam0;
	bVar6 = GRINGO_GET_FIRST_CHILD(1, bParam1);
	if (IS_GRINGO_COMPONENT_VALID(bVar6))
	{
		GET_OBJECT_ORIENTATION(GRINGO_GET_PHYSINST(bVar6), &vVar0);
		GET_OBJECT_POSITION(GRINGO_GET_PHYSINST(bVar6), &vVar3);
		if (IS_LAYOUTREF_VALID(Global_30616))
		{
			CREATE_PROP_IN_LAYOUT(Global_30616, "local", "p_gen_map02x", vVar3, vVar0, 1);
		}
		else
		{
			CREATE_PROP_IN_LAYOUT(GET_AMBIENT_LAYOUT(), "ambient", "p_gen_map02x", vVar3, vVar0, 1);
		}
		DESTROY_OBJECT(GRINGO_GET_PHYSINST(bVar6));
	}
	DECOR_SET_INT(bParam0, "Player_hasPlacedMap", true);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_84(bool bParam0, bool bParam1) //Position: 0x3328 / 13096
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3430 / 13360
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3446 / 13382
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36FC / 14076
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x370A / 14090
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3723 / 14115
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x373D / 14141
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3775 / 14197
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x378C / 14220
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A55 / 14933
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A72 / 14962
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B0E / 15118
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B2D / 15149
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B3C / 15164
{
...
void Function_98(int iParam0) //Position: 0x3B58 / 15192
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B62 / 15202
{
	int iVar0;
	int iVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BC4 / 15300
{
...
void Function_101(int iParam0) //Position: 0x3BD8 / 15320
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BE2 / 15330
{
