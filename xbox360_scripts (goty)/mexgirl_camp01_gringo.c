...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6, float fParam7) //Position: 0xA1A / 2586
{
	int iVar0;
	bool bVar1;
	...
	switch (StackVal)
	{
			...
			if ((Global_26154 + 1 > iLocal_23 || bParam2) || Global_3370)
			{
				if (Function_154(&vVar7, 50.0f, iParam0 + 200, 4294967295))
				{
					...
					else
					{
						...
						{
							bVar0 = CREATE_VOLUME_IN_LAYOUT(Global_26150, Function_141(), 3, *(iParam0 + 200), 0.0f, 0.0f, 0.0f, fLocal_25, 20.0f, fLocal_25);
		...
		case 0x00000005:
			...
			if (UNK_0x214AFB8C(iParam0->f_20))
			{
				...
				Function_69(StackVal, StackVal, StackVal, StackVal, StackVal, Function_141(), GET_ASSET_NAME(iParam0->f_20, 7), *(iParam0 + 200), *(iParam0 + 212), 4294967295);
...
bool Function_43(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x29A7 / 10663
{
...
void Function_52(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x2CB5 / 11445
{
	bool bVar0;
	bool bVar1;
...
void Function_73() //Position: 0x35F9 / 13817
{
	...
	TELEPORT_ACTOR_WITH_HEADING(bLocal_21, vVar0, 157.073f, 1, 1, 1);
	...
	SET_OBJECT_COLLIDE_WITH_OBJECT(bVar3, bVar4, 0);
	...
	SNAP_ACTOR_TO_GRINGO(bVar3, bVar5, "mom", 1, 0, 0);
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bVar5), 0);
	SNAP_ACTOR_TO_GRINGO(bVar4, bVar5, "sister", 1, 0, 0);
...
void Function_89(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x45F9 / 17913
{
	bool bVar0;
...
int Function_90(bool bParam0, bool bParam1) //Position: 0x464D / 17997
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_95(int iParam0, bool bParam1) //Position: 0x47FD / 18429
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_104(int iParam0) //Position: 0x4B90 / 19344
{
	bool bVar0;
	int iVar1;
...
var Function_105(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4C8A / 19594
{
	int iVar0;
	int iVar1;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4CC2 / 19650
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_107(var uParam0, int iParam1, int iParam2) //Position: 0x4CD3 / 19667
{
	int iVar0;
...
bool Function_108(int iParam0) //Position: 0x4D97 / 19863
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x5112 / 20754
{
	if (!Function_156(128))
	{
		return;
...
bool Function_110() //Position: 0x5152 / 20818
{
	int iVar0;
...
void Function_111() //Position: 0x517D / 20861
{
	if (!Function_156(128))
	{
		return;
...
void Function_112(int iParam0, bool bParam1) //Position: 0x51BF / 20927
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5243 / 21059
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x526C / 21100
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x52BD / 21181
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x52CD / 21197
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x52E1 / 21217
{
	int iVar0;
...
var Function_118() //Position: 0x5306 / 21254
{
	return "PackedMetadata";
}

void Function_119(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x531D / 21277
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_120() //Position: 0x5448 / 21576
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_121() //Position: 0x5459 / 21593
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_122() //Position: 0x546A / 21610
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_123(var uParam0, int iParam1) //Position: 0x547B / 21627
{
...
var Function_124(var uParam0, int iParam1, bool bParam2) //Position: 0x549E / 21662
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x54BD / 21693
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_126() //Position: 0x54C9 / 21705
{
	return Function_127(39);
}

int Function_127(bool bParam0) //Position: 0x54D4 / 21716
{
	bool bVar0;
...
var Function_128() //Position: 0x5502 / 21762
{
	return "PackedWeapon";
}

int Function_129(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5517 / 21783
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_130() //Position: 0x561B / 22043
{
	return "MPItemGiver";
}

struct<32> Function_131(bool bParam0) //Position: 0x562F / 22063
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5699 / 22169
{
	char* cVar0[32];
...
var Function_133() //Position: 0x56B8 / 22200
{
	return "PBox_";
}

var Function_134() //Position: 0x56C6 / 22214
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x56EC / 22252
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5714 / 22292
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(var uParam0, int iParam1) //Position: 0x573A / 22330
{
	int iVar0;
	var uVar1;
...
void Function_138(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x589B / 22683
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x5936 / 22838
{
	int iVar0;
	vector3 vVar1;
...
void Function_140(int iParam0) //Position: 0x5A97 / 23191
{
...
var Function_141() //Position: 0x5AF8 / 23288
{
	int iVar0;
...
var Function_142(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5B00 / 23296
{
	return Function_143(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x5B19 / 23321
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x5E0C / 24076
{
	int iVar0;
...
void Function_145() //Position: 0x5EC0 / 24256
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x5EFA / 24314
{
	int iVar0;
...
void Function_147(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5F27 / 24359
{
	bool bVar0;
...
void Function_148() //Position: 0x6078 / 24696
{
	int iVar0;
...
var Function_149(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x60C3 / 24771
{
	int iVar0;
...
int Function_150() //Position: 0x6193 / 24979
{
	int iVar0;
...
int Function_151() //Position: 0x62EF / 25327
{
	int iVar0;
...
bool Function_152(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x640F / 25615
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_153(var uParam0, int iParam1) //Position: 0x64DF / 25823
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_154(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x64FD / 25853
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_155(bool bParam0) //Position: 0x662F / 26159
{
	bool bVar0;
...
bool Function_156(int iParam0) //Position: 0x664E / 26190
{
	int iVar0;
...
int Function_157() //Position: 0x666A / 26218
{
	if (Function_159())
	{
...
int Function_158() //Position: 0x6683 / 26243
{
	return Global_79349.f_16;
}

bool Function_159() //Position: 0x668F / 26255
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_160(int iParam0, bool bParam1, bool bParam2) //Position: 0x6698 / 26264
{
	var uVar0;
