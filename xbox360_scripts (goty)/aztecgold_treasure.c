...
void main() //Position: 0x0 / 0
{
	...
	iLocal_79 = 0;
	Function_112(uScriptParam_0, &iLocal_79);
	while (IS_GRINGO_ACTIVE())
	{
		Function_111(uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_105(&(Local_6[iVar312]), &bVar4))
						{
							Function_103(GRINGO_GET_REQUESTING_ACTOR(), Local_6[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_98("eGRINGO_EndUse: Stop use by request", Local_6[iVar312].f_16);
							Function_97(Local_6[iVar312].f_16, 1);
							...
							{
								Function_90(&(Local_6[iVar312]), 0);
							}
							else if (Local_6[iVar312].f_44 < 8)
							{
								Function_89(&(Local_6[iVar312]));
						...
						{
							Function_115("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_79 - 1))
			{
				if (Function_88(Local_6[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_6[iVar012])))
					{
						Function_115("Quitting due to update end");
						Function_90(&(Local_6[iVar012]), 1);
					}
				}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
	{
		Function_115("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_79 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x47E / 1150
{
	...
	if (!Function_88(iParam0->f_40, 2))
	{
		Function_97(iParam0->f_16, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
								{
									Function_115("ManagePlayerQuit: Create quit context");
									if (Function_7(iParam0->f_12, "UseQuitBOverride", 0))
									{
										iLocal_86 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 5, 0, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										iLocal_86 = ADD_SCRIPT_USE_CONTEXT(iVar1, 500, 4, 0, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(iLocal_86))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
									{
										Function_115("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
										{
											Function_115("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
							{
								Function_115("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
							}
						}
					}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
		{
			Function_115("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
		}
...
bool Function_6(bool bParam0) //Position: 0x768 / 1896
{
	...
	if (fVar5 >= 0.2f)
	{
		DECOR_SET_BOOL(bParam0, "StickReset", 1);
	}
	else if (fVar5 < 0.75f && DECOR_CHECK_EXIST(bParam0, "StickReset"))
	{
...
bool Function_16(int iParam0) //Position: 0xA37 / 2615
{
	...
	bVar12 = Function_87(iParam0->f_12);
	if (!(IS_ACTOR_VALID(iParam0->f_16) && IS_ACTOR_ALIVE(iParam0->f_16)))
	{
		Function_98("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_98("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_98("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		case 0x00000002:
			...
			{
				if (Function_86(iParam0->f_12, &fVar24))
				{
			...
			{
				if (Function_81(iParam0->f_16, iParam0->f_12))
				{
			...
			if (!Function_79(iParam0->f_12) && iParam0->f_44 != 1)
			{
		...
		case 0x00000001:
			bLocal_85 = true;
			Function_78(iParam0->f_12);
			if (((!Global_63096 && IS_ACTOR_LOCAL_PLAYER(iParam0->f_16)) && !Function_88(iParam0->f_40, 1)) && !DECOR_CHECK_EXIST(iParam0->f_16, "NoGringoCamera"))
			{
			...
			if (Function_88(iParam0->f_40, 1))
			{
				Function_56(iParam0->f_12, &vVar3, &uVar6);
				if (!Function_88(iParam0->f_40, 16))
				{
				...
				if (!Function_88(iParam0->f_40, 1024))
				{
			...
			else if (Function_81(iParam0->f_16, iParam0->f_12))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 1);
			...
			if (iParam0->f_44 != 3 && !Function_88(iParam0->f_40, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(iParam0->f_12))
				{
					Function_2("SUSPEND MOVER", iParam0->f_16);
		...
		case 0x00000003:
			if (Function_88(iParam0->f_40, 32))
			{
				bLocal_85 = true;
		...
		case 0x00000004:
			...
			if (iVar32 == 0)
			{
				bVar33 = Function_88(iParam0->f_40, 1);
			}
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_84, &cLocal_83);
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_88(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
			...
			if (iParam0->f_44 == 6)
			{
				fVar60 = Function_25(iParam0->f_12);
				if (fVar60 <= 0.0f)
				{
					GET_POSITION_OBJECT_SPACE(GRINGO_GET_MY_OBJECT_REF(), vVar17, &vVar57);
					if (VDIST(vVar57, *(iParam0 + 20)) < fVar60)
					{
...
void Function_17(bool bParam0, int iParam1) //Position: 0x1B88 / 7048
{
...
void Function_18(var uParam0, var uParam1) //Position: 0x1B9D / 7069
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_19() //Position: 0x1BAB / 7083
{
	bool bVar0;
...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BDC / 7132
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1C50 / 7248
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CC2 / 7362
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CD0 / 7376
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CE6 / 7398
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CF3 / 7411
{
	return Function_11(bParam0, "MoveAllowance", 1.5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D13 / 7443
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1D22 / 7458
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D41 / 7489
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D47 / 7495
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D55 / 7509
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D60 / 7520
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D7A / 7546
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1D98 / 7576
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DB7 / 7607
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DEA / 7658
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E09 / 7689
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E23 / 7715
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E36 / 7734
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	{
		uVar6 = Function_43(uParam0->f_12, &bVar5);
		if (bVar5)
		{
			uVar8 = Function_42(uParam0->f_12, &bVar7);
			if (!bVar7)
			{
	...
	if (bVar0)
	{
		iVar9 = ATTACH_SLOT_FROM_STRING(uVar2);
		if (Function_24())
		{
			Function_41();
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_40(uParam0->f_12, &bVar10), 0, iVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_39(), Function_40(uParam0->f_12, &bVar10), 0, iVar9);
	}
		...
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bParam1, uVar11, cVar12, bVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
			if (Function_7(bVar4, "LinkToUser", 0))
			{
				...
				LINK_OBJECT_ANIMATOR_TO_ACTOR(*uParam3, uParam0->f_16, iVar9);
			}
		}
		else
		{
...
var Function_39() //Position: 0x211E / 8478
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2126 / 8486
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2143 / 8515
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2152 / 8530
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2174 / 8564
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2198 / 8600
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21B5 / 8629
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21D5 / 8661
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x21F5 / 8693
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22A3 / 8867
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2313 / 8979
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2329 / 9001
{
...
var Function_51(bool bParam0) //Position: 0x234A / 9034
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x236A / 9066
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x237E / 9086
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2388 / 9096
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x238F / 9103
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x239E / 9118
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x23DD / 9181
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2408 / 9224
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2413 / 9235
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2509 / 9481
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x252B / 9515
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(int iParam0) //Position: 0x2552 / 9554
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	iParam0 = iParam0;
	if (iLocal_0 && !iLocal_1)
	{
		iLocal_1 = 1;
		bLocal_4 = CREATE_LAYOUT("AG_TreasureGringo_Layout");
		bVar0 = true;
		bVar1 = StackVal;
		if (IS_VOLUME_VALID(bVar1))
		{
			...
			{
				bVar0 = false;
				bLocal_2 = Function_73(bLocal_4, 0, 1, 0, 0);
			}
		}
		if (bVar0)
		{
			...
			if (IS_VOLUME_VALID(bVar1))
			{
				...
				{
					bVar0 = false;
					bLocal_2 = Function_68(bLocal_4, 0, 1, 0, 0);
				}
			}
		}
		if (bVar0)
		{
			...
			if (IS_VOLUME_VALID(bVar1))
			{
				...
				{
					bVar0 = false;
					bLocal_2 = Function_63(bLocal_4, 0, 1, 0, 0);
				}
			}
		}
		if (!IS_OBJECTSET_VALID(iLocal_3))
		{
			GET_ACTOR_AXIS(Global_34573, &vVar2, 2);
			GET_POSITION(Global_34573, &vVar5);
			iLocal_3 = CREATE_OBJECTSET_IN_LAYOUT(Function_39(), bLocal_4, 4294967295, 0);
			bVar8 = CREATE_VOLUME_IN_LAYOUT(bLocal_4, Function_39(), 3, vVar5, 0.0f, 0.0f, 0.0f, 4.0f, 6.0f, 4.0f);
			vVar5 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(vVar2, vVar5, StackVal) * Vector(4.0f, 4.0f, 4.0f), StackVal, StackVal) };
			iVar9 = LOCATE_ACTORS_IN_VOLUME(bVar8, iLocal_3, 0, 1);
			if (iVar9 >= 0)
			{
				iVar10 = 0;
				iVar10 = 0;
				...
				{
					iVar11 = GET_INDEXED_OBJECT_IN_OBJECTSET(iVar10, iLocal_3);
					if (!iVar11 != GET_OBJECT_FROM_ACTOR(Global_34573))
					{
						SET_OBJECT_POSITION_ON_GROUND(iVar11, vVar5);
						vVar5.x = (vVar5.x + 0.5f);
					}
					iVar10++;
				}
			}
			DESTROY_OBJECTSET(iLocal_3);
...
bool Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x26D4 / 9940
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "AztecGold_Treasure3", 3, 1);
	}
	Function_64(&bVar0);
...
void Function_64(int iParam0) //Position: 0x2753 / 10067
{
	bool bVar0;
	...
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*iParam0, 2, 100.0f, 2);
	return;
}

void Function_65(int iParam0) //Position: 0x27B4 / 10164
{
	...
	SET_CAMERASHOT_POSITION(*iParam0, -545.3259f, 17.40562f, 3989.449f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.014153f, 2.645533f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_66(int iParam0) //Position: 0x281E / 10270
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -545.6757f, 16.55864f, 3988.855f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.249252f, 2.840503f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_67(int iParam0) //Position: 0x2888 / 10376
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -547.4234f, 17.80982f, 3991.774f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0.216602f, -0.653991f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

bool Function_68(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x28F2 / 10482
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "AztecGold_Treasure2", 3, 1);
	}
	Function_69(&bVar0);
	if (uParam4 && CHECK_CUTSCENE_COLLISIONS(bVar0))
	{
...
void Function_69(int iParam0) //Position: 0x2971 / 10609
{
	bool bVar0;
...
void Function_70(int iParam0) //Position: 0x29D2 / 10706
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -1199.886f, 20.46942f, 4964.45f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0.127372f, -0.869504f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_71(int iParam0) //Position: 0x2A3C / 10812
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -1198.401f, 19.57088f, 4965.13f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.088678f, 0.620804f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_72(int iParam0) //Position: 0x2AA6 / 10918
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -1199.479f, 19.73318f, 4966.04f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.02078f, -0.20798f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

bool Function_73(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2B10 / 11024
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "AztecGold_Treasure1", 3, 1);
	}
	Function_74(&bVar0);
	if (uParam4 && CHECK_CUTSCENE_COLLISIONS(bVar0))
	{
...
void Function_74(int iParam0) //Position: 0x2B8F / 11151
{
	bool bVar0;
...
void Function_75(int iParam0) //Position: 0x2BF0 / 11248
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -3626.443f, 29.52776f, 4746.663f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, 0.004438f, 2.664227f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_76(int iParam0) //Position: 0x2C5A / 11354
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -3627.891f, 28.78153f, 4746.347f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0.018663f, -1.966126f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_77(int iParam0) //Position: 0x2CC4 / 11460
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0.1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0.3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, -3629.594f, 30.00947f, 4745.89f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0.458419f, 2.331954f, 0.0f, 1);
	RESET_CAMERASHOT_TARGET(*iParam0, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_78(int iParam0) //Position: 0x2D2E / 11566
{
	iParam0 = iParam0;
	return;
}

bool Function_79(bool bParam0) //Position: 0x2D38 / 11576
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_80(int iParam0) //Position: 0x2D56 / 11606
{
	if (!Function_14(iParam0))
	{
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x2D6B / 11627
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
	...
	{
		return Function_85(bParam0, bParam1);
	}
	uVar4 = Function_84(bParam1);
	uVar5 = Function_57(bParam1);
	Function_82(bParam1);
	vVar6 = { StackVal, StackVal, Function_82(bParam1) };
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(bParam0, &vVar0, &vVar6, uVar4, 0.2f, 1, fVar3, uVar5, 0, 0);
}

vector3 Function_82(int iParam0) //Position: 0x2DF2 / 11762
{
	vector3 vVar0;
	
	vVar0 = { 0.0f, 0.0f, 0.0f };
	Function_83(StackVal, StackVal, iParam0, "UserOffset", vVar0);
	return StackVal, StackVal, Function_83(StackVal, StackVal, iParam0, "UserOffset", vVar0);
}

vector3 Function_83(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2E15 / 11797
{
	vector3 vVar0;
...
bool Function_84(bool bParam0) //Position: 0x2E33 / 11827
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_85(bool bParam0, bool bParam1) //Position: 0x2E56 / 11862
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
	...
	uVar0 = Function_84(bParam1);
	uVar1 = Function_57(bParam1);
...
bool Function_86(bool bParam0, int iParam1) //Position: 0x2F71 / 12145
{
...
int Function_87(bool bParam0) //Position: 0x2F9C / 12188
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x30A1 / 12449
{
	return (uParam0 && iParam1) == 0;
}

void Function_89(int iParam0) //Position: 0x30AE / 12462
{
	if (Function_88(iParam0->f_40, 16))
	{
...
void Function_90(int iParam0, bool bParam1) //Position: 0x3121 / 12577
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(iParam0->f_16) && Function_88(iParam0->f_40, 32)) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
	{
	...
	Function_96(iParam0->f_16, iParam0->f_12);
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		GRINGO_REPORT_USE_FINISHED(iParam0->f_16, Function_88(iParam0->f_40, 64));
		Function_17(iParam0->f_16, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_88(iParam0->f_40, 128) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
			{
			...
			if (Function_95(iParam0->f_12) && Function_88(iParam0->f_40, 512))
			{
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_83));
		iLocal_84 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
	...
	if (IS_ACTOR_VALID(iParam0->f_16) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_92(iParam0->f_12), iParam0->f_12);
	}
...
void Function_91() //Position: 0x361F / 13855
{
	bool bVar0;
...
bool Function_92(bool bParam0) //Position: 0x3656 / 13910
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_93(var uParam0, int iParam1) //Position: 0x3673 / 13939
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_94(int iParam0) //Position: 0x36AB / 13995
{
	iParam0 = iParam0;
	return;
}

bool Function_95(bool bParam0) //Position: 0x36B5 / 14005
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_96(var uParam0, int iParam1) //Position: 0x36D6 / 14038
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_97(bool bParam0, bool bParam1) //Position: 0x36FC / 14076
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_115("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_115("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(iLocal_86))
			{
				if (bParam1)
				{
					Function_115("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(iLocal_86);
			}
		}
	...
	if (bParam1)
	{
		Function_115("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_98(char* cParam0, bool bParam1) //Position: 0x3804 / 14340
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, cParam0, 0, 0, 0);
	return;
}

void Function_99(int iParam0) //Position: 0x381A / 14362
{
	int iVar0;
	bool bVar1;
	char* cVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_100(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3AD0 / 15056
{
	iParam1 = iParam1;
	iLocal_0 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_101(bool bParam0) //Position: 0x3AE8 / 15080
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_102(bool bParam0) //Position: 0x3B01 / 15105
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_103(int iParam0, int iParam1) //Position: 0x3B1B / 15131
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_104(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_104(var uParam0, int iParam1) //Position: 0x3B53 / 15187
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_105(int iParam0, int iParam1) //Position: 0x3B6A / 15210
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_88(iParam0->f_40, 2))
		{
			...
			if (Function_88(iParam0->f_40, 1))
			{
				Function_98("MIDACTION REQUEST", bVar1);
			}
			else
			{
				...
				fVar15 = Function_108(iParam0->f_12);
				fVar16 = VMAG(vVar12);
				if (fVar16 < fVar15 && !GRINGO_HANDLES_MOVEMENT(bVar0))
				{
					strcpy(&cVar17, "nTOO FAR (", 64);
					straddi(&cVar17, FLOOR((fVar16 * 10.0f)), 64);
					stradd(&cVar17, " > ", 64);
				...
				if (!Function_107(bVar1, iParam0->f_12))
				{
					GRINGO_SET_REQUEST_FAILURE_REASON(6);
					return 0;
				}
				bVar33 = Function_106(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
...
bool Function_106(bool bParam0) //Position: 0x3E33 / 15923
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_107(bool bParam0, bool bParam1) //Position: 0x3E50 / 15952
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_108(int iParam0) //Position: 0x3EEC / 16108
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_109(var uParam0, int iParam1) //Position: 0x3F0B / 16139
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_110(int iParam0) //Position: 0x3F1A / 16154
{
...
void Function_111(int iParam0) //Position: 0x3F36 / 16182
{
	iParam0 = iParam0;
	return;
}

void Function_112(bool bParam0, int iParam1) //Position: 0x3F40 / 16192
{
	int iVar0;
	int iVar1;
	...
	{
		Function_113(&(Local_6[iLocal_7912]), bParam0);
		iLocal_79++;
	}
...
void Function_113(int iParam0, int iParam1) //Position: 0x3FA2 / 16290
{
...
void Function_114(int iParam0) //Position: 0x3FB6 / 16310
{
	iParam0 = iParam0;
	return;
}

void Function_115(int iParam0) //Position: 0x3FC0 / 16320
{
