...
void main() //Position: 0x0 / 0
{
	...
	bVar3 = FIND_NAMED_LAYOUT("TesoroAzul_layout");
	if (IS_LAYOUTREF_VALID(bVar3))
	{
		bVar4 = FIND_VOLUME_IN_LAYOUT(bVar3, "tesv_region");
		if (IS_VOLUME_VALID(bVar4))
		{
			Function_3(bVar4, uVar1, 1, 5, 0, 0, 1);
		}
		else
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xBCD / 3021
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xBDC / 3036
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xC31 / 3121
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xCB3 / 3251
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xCCF / 3279
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xD0D / 3341
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD29 / 3369
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, var uParam3, bool bParam4, bool bParam5) //Position: 0xD39 / 3385
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xDB1 / 3505
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE1D / 3613
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xE89 / 3721
{
	int iVar0;
	int iVar1;
...
void Function_12(int iParam0) //Position: 0xECE / 3790
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xEDA / 3802
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0xF56 / 3926
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(bool bParam0, var uParam1) //Position: 0xF63 / 3939
{
	if (!Function_4(128))
	{
		return;
