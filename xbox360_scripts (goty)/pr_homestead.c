...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		switch (iLocal_303)
		{
			...
			case 0x00000002:
				Function_9(&(Global_29008[ScriptParam_0]), 4);
				bLocal_320 = false;
				iLocal_303 = 3;
				break;
			...
			case 0x00000003:
				...
				if (Function_31(57, 0))
				{
					Function_9(&(Global_29008[Global_30621[3]]), 1024);
					iLocal_303 = 4;
					bLocal_320 = false;
				}
...
void Function_1(int iParam0) //Position: 0x413 / 1043
{
	int iVar0;
...
void Function_2(var uParam0, int iParam1) //Position: 0x439 / 1081
{
...
void Function_3(var uParam0, int iParam1) //Position: 0x567 / 1383
{
	int iVar0;
...
bool Function_4(var uParam0, int iParam1) //Position: 0x581 / 1409
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x59E / 1438
{
	int iVar0;
...
void Function_6() //Position: 0x5B5 / 1461
{
	bool bVar0;
	...
	if (IS_ACTOR_VALID(bVar0))
	{
		if (!Function_31(53, 0))
		{
			if (StackVal || Function_7(bVar0, -68.16f, 127.217f, 1371.621f, 5.0f) != 640)
			{
				Function_10();
			}
		}
...
int Function_7(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x6B6 / 1718
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_8(bParam0);
		if (VDIST(Function_8(bParam0), vParam1) >= fParam4)
		{
			return 1;
		}
	}
...
vector3 Function_8(bool bParam0) //Position: 0x740 / 1856
{
	vector3 vVar0;
...
void Function_9(var uParam0, int iParam1) //Position: 0x7AA / 1962
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_10() //Position: 0x7B9 / 1977
{
	vector3 vVar0;
	...
	Function_11(GET_ACTOR_FROM_PERS_CHAR(Global_8492[1214]));
	vVar0 = { StackVal, StackVal, Function_11(GET_ACTOR_FROM_PERS_CHAR(Global_8492[1214])) };
	return;
}

vector3 Function_11(bool bParam0) //Position: 0x897 / 2199
{
	vector3 vVar0;
...
void Function_12(int iParam0) //Position: 0x8A8 / 2216
{
	int iVar0;
...
void Function_13() //Position: 0x941 / 2369
{
	Function_12(12);
...
bool Function_14(int iParam0) //Position: 0xA12 / 2578
{
	int iVar0;
...
bool Function_15(int iParam0) //Position: 0xA48 / 2632
{
...
bool Function_16(int iParam0) //Position: 0xA6C / 2668
{
...
bool Function_17(int iParam0) //Position: 0xA81 / 2689
{
...
var Function_18(int iParam0) //Position: 0xA98 / 2712
{
	if (!Function_19(iParam0))
	{
		return 4294967295;
...
bool Function_19(int iParam0) //Position: 0xAB2 / 2738
{
...
int Function_20(bool bParam0, int iParam1) //Position: 0xAC8 / 2760
{
	vector3 vVar0;
	bool bVar20;
...
bool Function_21(vector3 vParam0) //Position: 0xC04 / 3076
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

void Function_22(int iParam0, var uParam1, vector3 vParam2) //Position: 0xC1C / 3100
{
	bool bVar0;
...
bool Function_23(vector3 vParam0, vector3 vParam3) //Position: 0xC82 / 3202
{
	vector3 vVar0;
...
void Function_24(int iParam0, var uParam1, vector3 vParam2) //Position: 0xCAF / 3247
{
	bool bVar0;
...
void Function_25(int iParam0, var uParam1, vector3 vParam2) //Position: 0xD17 / 3351
{
	bool bVar0;
...
void Function_26(int iParam0, var uParam1, vector3 vParam2) //Position: 0xD81 / 3457
{
	bool bVar0;
...
void Function_27(int iParam0, var uParam1, vector3 vParam2) //Position: 0xDE6 / 3558
{
	bool bVar0;
...
void Function_28(int iParam0, var uParam1, vector3 vParam2) //Position: 0xE4E / 3662
{
	bool bVar0;
...
bool Function_29(int iParam0, bool bParam1, int iParam2, bool bParam3, vector3 vParam4, bool bParam7) //Position: 0xEB1 / 3761
{
	bool bVar0;
	int iVar1;
	vector3 vVar2;
...
var Function_30() //Position: 0x134A / 4938
{
	int iVar0;
...
bool Function_31(int iParam0, bool bParam1) //Position: 0x1352 / 4946
{
	int iVar0;
...
bool Function_32(int iParam0) //Position: 0x138F / 5007
{
	int iVar0;
	int iVar1;
...
void Function_33() //Position: 0x170A / 5898
{
	if (!Function_34(128))
	{
		return;
...
bool Function_34(int iParam0) //Position: 0x174A / 5962
{
	int iVar0;
...
bool Function_35() //Position: 0x1766 / 5990
{
	int iVar0;
...
void Function_36(var uParam0, int iParam1) //Position: 0x1791 / 6033
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_37() //Position: 0x17A2 / 6050
{
	if (!Function_34(128))
	{
		return;
...
var Function_38(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x17E4 / 6116
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_39(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_39(var uParam0, int iParam1, int iParam2) //Position: 0x181C / 6172
{
	int iVar0;
