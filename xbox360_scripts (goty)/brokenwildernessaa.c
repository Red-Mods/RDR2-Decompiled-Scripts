...
void Function_11(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x54E / 1358
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
void Function_44(bool bParam0, int iParam1) //Position: 0x14C0 / 5312
{
...
void Function_81(int iParam0) //Position: 0x1A63 / 6755
{
	int iVar0;
...
void Function_87(int iParam0, var uParam1, float fParam2, float fParam3, int iParam4, int iParam5) //Position: 0x1C45 / 7237
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_88(var uParam0, int iParam1) //Position: 0x1C95 / 7317
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int Function_93() //Position: 0x1DD4 / 7636
{
	...
	if (!Function_304(&vLocal_103, &bLocal_130, 41401, 1, 1))
	{
		return 0;
	}
			...
			if (iLocal_166)
			{
				if (!bVar0)
				{
					if (!Function_302())
					{
						if (IS_ACTOR_ALIVE(Function_41()))
						{
							Function_300("broken_MP_return", 0x40f00000, 1, 2, 0, 0, 0, 0);
...
void Function_94() //Position: 0x1EF3 / 7923
{
	int iVar0;
	...
	{
		case 0x00000000:
			iVar0 = (Function_230(318) - iLocal_164);
...
var Function_95(int iParam0) //Position: 0x1F49 / 8009
{
	int iVar0;
	int iVar1;
	char* cVar2[16];
...
void Function_96(var uParam0, bool bParam1, int iParam2) //Position: 0x2483 / 9347
{
	int iVar0;
...
bool Function_97(var uParam0, int iParam1) //Position: 0x258E / 9614
{
	int iVar0;
...
void Function_98(int iParam0) //Position: 0x25AA / 9642
{
...
bool Function_99() //Position: 0x2629 / 9769
{
	int iVar0;
...
void Function_100(var uParam0, int iParam1) //Position: 0x2692 / 9874
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_101(int iParam0, bool bParam1) //Position: 0x26A1 / 9889
{
	if (bParam1)
	{
...
bool Function_102(int iParam0) //Position: 0x26DC / 9948
{
	return Function_78(Global_78617.f_52, iParam0);
}

bool Function_103(vector3 vParam0) //Position: 0x26ED / 9965
{
	var uVar0[8];
	int iVar9;
	int iVar10;
...
var Function_104(vector3 vParam0, bool bParam3, bool bParam4, bool bParam5) //Position: 0x2761 / 10081
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_105(int iParam0) //Position: 0x27FC / 10236
{
...
vector3 Function_106(bool bParam0) //Position: 0x285A / 10330
{
	vector3 vVar0;
...
void Function_107(int iParam0) //Position: 0x286B / 10347
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

bool Function_108(bool bParam0, bool bParam1, float fParam2) //Position: 0x287C / 10364
{
	struct<17> Var0;
...
bool Function_109(int iParam0) //Position: 0x2ACF / 10959
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int Function_110(bool bParam0) //Position: 0x2B12 / 11026
{
	int iVar0;
...
int Function_111(int iParam0) //Position: 0x2B39 / 11065
{
	return *iParam0;
}

void Function_112(var uParam0, int iParam1) //Position: 0x2B42 / 11074
{
	*uParam0 = Local_51[iParam12];
	return;
}

void Function_113(int iParam0) //Position: 0x2B51 / 11089
{
	Function_60(iParam0, 4294967286);
	return;
}

bool Function_114(bool bParam0) //Position: 0x2B5F / 11103
{
	return _IS_CLIENT_DATA_VALID_FOR_SLOT(&Local_51, bParam0);
}

void Function_115(var uParam0, bool bParam1) //Position: 0x2B6C / 11116
{
	if (bParam1)
	{
...
bool Function_116(bool bParam0) //Position: 0x2B86 / 11142
{
	return Function_40(*bParam0, 2);
}

bool Function_117() //Position: 0x2B93 / 11155
{
...
bool Function_118(int iParam0, var uParam1, int iParam2) //Position: 0x2BB1 / 11185
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_119(int iParam0, bool bParam1) //Position: 0x2C02 / 11266
{
	if (bParam1)
	{
...
bool Function_120(int iParam0) //Position: 0x2C1C / 11292
{
	return Function_40(*iParam0, 1);
}

void Function_121(int iParam0) //Position: 0x2C29 / 11305
{
	bool bVar0;
	int iVar1;
	struct<13> Var2;
...
bool Function_122(int iParam0) //Position: 0x2D26 / 11558
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_123(int iParam0) //Position: 0x2F62 / 12130
{
	return StackVal;
}

bool Function_124(bool bParam0) //Position: 0x2F70 / 12144
{
	if (!IS_SLOT_VALID(bParam0))
	{
		return 0;
...
void Function_125() //Position: 0x2F86 / 12166
{
	Function_126(8);
...
void Function_126(int iParam0) //Position: 0x2F98 / 12184
{
	Function_43(&Global_79338, iParam0);
	return;
}

bool Function_127() //Position: 0x2FA7 / 12199
{
	return Function_39(32768);
}

void Function_128(bool bParam0) //Position: 0x2FB4 / 12212
{
...
bool Function_129(int iParam0, int iParam1, bool bParam2) //Position: 0x2FDF / 12255
{
	int iVar0;
	bool bVar1;
...
void Function_130() //Position: 0x308C / 12428
{
...
void Function_131() //Position: 0x30C7 / 12487
{
	Function_33(1025, 1, 0);
	return;
}

void Function_132() //Position: 0x30D5 / 12501
{
	if (!Function_38())
	{
		Function_37();
...
void Function_133(var uParam0, var uParam1) //Position: 0x30ED / 12525
{
	struct<8> Var0;
	struct<5> Var8;
...
var Function_134() //Position: 0x3112 / 12562
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_135(bool bParam0) //Position: 0x3151 / 12625
{
	return Function_136(0, bParam0);
}

int Function_136(int iParam0, bool bParam1) //Position: 0x315D / 12637
{
	char* cVar0[64];
...
bool Function_137(bool bParam0) //Position: 0x31C4 / 12740
{
	char* cVar0[64];
...
int Function_138(int iParam0) //Position: 0x3265 / 12901
{
	return (*&Global_78480 + 132)[iParam0];
}

void Function_139(int iParam0) //Position: 0x3275 / 12917
{
	char* cVar0[32];
	int iVar8;
	bool bVar9;
...
void Function_140(bool bParam0, int iParam1) //Position: 0x3699 / 13977
{
	struct<13> Var0;
...
struct<16> Function_141(var uParam0) //Position: 0x38C6 / 14534
{
	struct<4> Var0;
	bool bVar4;
...
int Function_142() //Position: 0x3937 / 14647
{
	return Function_226(12);
}

void Function_143(bool bParam0) //Position: 0x3942 / 14658
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
void Function_144(bool bParam0, bool bParam1) //Position: 0x395C / 14684
{
	bool bVar0;
	bool bVar1;
...
float Function_145(bool bParam0, bool bParam1) //Position: 0x39B9 / 14777
{
	vector3 vVar0;
...
var Function_146(int iParam0) //Position: 0x39D8 / 14808
{
...
void Function_147(bool bParam0) //Position: 0x3A36 / 14902
{
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), 0, 0, 0, 0, 0, 0);
	return;
}

bool Function_148() //Position: 0x3A4A / 14922
{
	if (IS_PS3())
	{
		return 1;
...
void Function_149(int iParam0) //Position: 0x3A59 / 14937
{
...
void Function_150(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3B4F / 15183
{
...
void Function_151(var uParam0, int iParam1, var uParam2, int iParam3) //Position: 0x3C13 / 15379
{
...
void Function_152(int iParam0) //Position: 0x3C54 / 15444
{
	struct<5> Var0;
...
void Function_153(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x3CC9 / 15561
{
	var uVar0[67];
	int iVar68;
...
void Function_154(bool bParam0) //Position: 0x3DE5 / 15845
{
...
void Function_155() //Position: 0x3E6E / 15982
{
	Function_167();
	Function_166();
	Function_166();
...
void Function_156() //Position: 0x3EC0 / 16064
{
...
void Function_157() //Position: 0x3FC6 / 16326
{
	float fVar0;
...
void Function_158() //Position: 0x3FF9 / 16377
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_176(var uParam0, int iParam1) //Position: 0x4EB0 / 20144
{
	bool bVar0;
...
void Function_194(bool bParam0, int iParam1) //Position: 0x5D14 / 23828
{
	...
	switch (vLocal_103.z)
	{
		...
		case 0x00000006:
			...
			else
			{
				...
				if (!iLocal_169)
				{
					Function_300("broken_MP_killRemainder", 7.5f, 1, 2, 1, 0, 0, 0);
					iLocal_169 = 1;
				}
			}
			break;
...
int Function_232(bool bParam0) //Position: 0x6B0C / 27404
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_233(int iParam0) //Position: 0x6B5C / 27484
{
...
void Function_234(int iParam0, float fParam1) //Position: 0x6B71 / 27505
{
...
bool Function_235(int iParam0) //Position: 0x6B92 / 27538
{
	return Function_40(*iParam0, 1);
}

void Function_236(var uParam0, bool bParam1) //Position: 0x6B9F / 27551
{
	struct<9> Var0;
...
void Function_237() //Position: 0x6BD6 / 27606
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
		...
		case 0x00000006:
			...
			else
			{
				...
				if (!iLocal_171)
				{
					...
					{
						Function_300("broken_MP_obj02", 7.5f, 1, 2, 1, 0, 0, 0);
						iLocal_171 = 1;
					}
				}
			}
...
void Function_238(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x6CB4 / 27828
{
	bool bVar0;
	bool bVar1;
...
void Function_239() //Position: 0x6D36 / 27958
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	vVar1 = { 176.7479f, 129.7517f, 1378.254f };
	fVar4 = 20.0f;
	fVar5 = 90.0f;
	switch (iVar0)
	{
		case 0x00000003:
			Function_240(StackVal, StackVal, vVar1, 1074, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1076, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1075, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1074, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1076, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1075, 16834, fVar4, fVar5);
			Function_240(StackVal, StackVal, vVar1, 1074, 16834, fVar4, fVar5);
...
var Function_240(vector3 vParam0, int iParam3, int iParam4, float fParam5, float fParam6) //Position: 0x6F00 / 28416
{
	var uVar0;
	bool bVar4;
...
int Function_241(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6F89 / 28553
{
...
void Function_242(bool bParam0) //Position: 0x6FCF / 28623
{
...
var Function_243(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x6FF6 / 28662
{
	var uVar0;
	vector3 vVar3;
	var uVar6;
...
void Function_244(char* cParam0, bool bParam1) //Position: 0x7095 / 28821
{
...
var Function_245() //Position: 0x70CF / 28879
{
	return cLocal_99;
}

var Function_246() //Position: 0x70D7 / 28887
{
	int iVar0;
	int iVar1;
...
void Function_247() //Position: 0x7106 / 28934
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	
	vVar0 = { 176.7479f, 129.7517f, 1378.254f };
	fVar3 = 20.0f;
	fVar4 = 90.0f;
	bLocal_149 = Function_240(StackVal, StackVal, vVar0, 1073, 93841, fVar3, fVar4);
	if (IS_ACTOR_VALID(bLocal_149))
	{
		SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bLocal_149, 392, 0, 2, 0), "broken_MP_BossName");
		SET_ACTOR_MAX_HEALTH(bLocal_149, (GET_ACTOR_MAX_HEALTH(bLocal_149) * 2.5f));
	}
	return;
}

void Function_248() //Position: 0x717C / 29052
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
			...
			if (!iLocal_170)
			{
				Function_300("broken_MP_obj01", 7.5f, 1, 2, 1, 0, 0, 0);
				iLocal_170 = 1;
			}
			vLocal_103.f_8 = 6;
			break;
...
void Function_249() //Position: 0x7241 / 29249
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_250() //Position: 0x7306 / 29446
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_251(var uParam0, int iParam1) //Position: 0x73CC / 29644
{
	bool bVar0;
	bool bVar1;
...
void Function_252() //Position: 0x7468 / 29800
{
	switch (vLocal_103.z)
	{
		case 0x00000000:
...
void Function_253(var uParam0) //Position: 0x7507 / 29959
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_256(int iParam0) //Position: 0x7687 / 30343
{
...
void Function_257(int iParam0, bool bParam1) //Position: 0x771C / 30492
{
...
void Function_258(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x7764 / 30564
{
	bool bVar0;
...
void Function_259(int iParam0) //Position: 0x7877 / 30839
{
	Function_260(&Global_28842, iParam0);
	return;
}

void Function_260(var uParam0, var uParam1) //Position: 0x7885 / 30853
{
...
void Function_261() //Position: 0x78A0 / 30880
{
...
void Function_262(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x78BC / 30908
{
...
void Function_263() //Position: 0x79A0 / 31136
{
	int iVar0;
...
int Function_264(int iParam0) //Position: 0x79EE / 31214
{
...
bool Function_265(int iParam0) //Position: 0x7A06 / 31238
{
...
void Function_266(bool bParam0, bool bParam1) //Position: 0x7A1B / 31259
{
	char[] cVar0[4];
...
void Function_267(var uParam0, var uParam1) //Position: 0x7B15 / 31509
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &uParam1);
	return;
}

void Function_268() //Position: 0x7B22 / 31522
{
...
void Function_269() //Position: 0x7B91 / 31633
{
	var uVar0;
	bool bVar1;
	
	uVar0 = CREATE_VOLUME_SET_IN_LAYOUT(bLocal_130, "SpawnVol_0_set");
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_0", 2, 177.7822f, 127.3513f, 1406.218f, 0.0f, 258.355f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_1", 2, 167.5503f, 127.2203f, 1451.55f, 0.0f, 560.948f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_2", 2, 116.0501f, 131.3754f, 1440.095f, 0.0f, 138.833f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_3", 2, 108f, 126.9886f, 1394.345f, 0.0f, 439.887f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_4", 2, 130.5605f, 121.0728f, 1323.889f, 0.0f, 382.121f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_5", 2, 166.3284f, 123.5101f, 1322.305f, 0.0f, -4.285f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_6", 2, 204.8818f, 127.0737f, 1340f, 0.0f, -401.716f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_7", 2, 221.9561f, 124.4863f, 1409.956f, 0.0f, 252.031f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_8", 2, 209.0502f, 121.7078f, 1454.95f, 0.0f, 218.11f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_9", 2, 230.5038f, 124.8452f, 1372.0f, 0.0f, 287.58f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_10", 2, 92.0f, 123.1786f, 1364f, 0.0f, 63.676f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "SpawnVol_0_sub_11", 2, 193.1894f, 125.2735f, 1310.811f, 0.0f, 333.443f, 0.0f, 4.0f, 8.0f, 4.0f);
	ADD_TO_VOLUME_SET(uVar0, bVar1);
	bLocal_150 = CREATE_VOLUME_IN_LAYOUT(bLocal_130, "mpaa_warning_vol", 3, 173.7221f, 128.655f, 1378.211f, 0.0f, 71.373f, 0.0f, 95.99599f, 50.0f, 88.98166f);
	bLocal_151 = Function_270(bLocal_150, 330, 0.0f);
	SET_BLIP_VISIBLE(bLocal_151, false);
	return;
}

bool Function_270(bool bParam0, int iParam1, float fParam2) //Position: 0x7EF6 / 32502
{
	bool bVar0;
...
void Function_271(var uParam0, bool bParam1) //Position: 0x7F43 / 32579
{
...
void Function_272(var uParam0) //Position: 0x7FB4 / 32692
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_273() //Position: 0x7FC2 / 32706
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_274(int iParam0) //Position: 0x7FDB / 32731
{
	int iVar0;
	int iVar1;
...
void Function_275() //Position: 0x8357 / 33623
{
	if (!Function_276(128))
	{
		return;
...
bool Function_276(int iParam0) //Position: 0x8397 / 33687
{
	int iVar0;
...
bool Function_277() //Position: 0x83B3 / 33715
{
	int iVar0;
...
void Function_278(var uParam0, int iParam1) //Position: 0x83DE / 33758
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_279() //Position: 0x83EF / 33775
{
	if (!Function_276(128))
	{
		return;
...
void Function_280() //Position: 0x8431 / 33841
{
	Function_282(&uLocal_131, "mp_action_areas", 10, 0);
	Function_281(&uLocal_131, 1073, 3, 0);
	Function_281(&uLocal_131, 1074, 3, 0);
	Function_281(&uLocal_131, 1075, 3, 0);
	Function_281(&uLocal_131, 1076, 3, 0);
	return;
}

var Function_281(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x847E / 33918
{
	int iVar0;
...
var Function_282(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x854E / 34126
{
	int iVar0;
	var uVar1;
...
var Function_283(var uParam0, int iParam1, int iParam2) //Position: 0x8586 / 34182
{
	int iVar0;
...
bool Function_284(int iParam0) //Position: 0x864A / 34378
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
void Function_285(var uParam0, float fParam1) //Position: 0x86F6 / 34550
{
	Function_286(uParam0, -fParam1);
	return;
}

void Function_286(var uParam0, float fParam1) //Position: 0x8704 / 34564
{
	Function_64();
...
void Function_287(var uParam0, int iParam1) //Position: 0x8718 / 34584
{
	uParam0->f_4 = iParam1;
...
bool Function_288(int iParam0) //Position: 0x8735 / 34613
{
...
void Function_289(int iParam0) //Position: 0x874B / 34635
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_290(int iParam0) //Position: 0x875F / 34655
{
	if (Function_67(iParam0))
	{
...
float Function_291(float fParam0) //Position: 0x877A / 34682
{
	return -Function_63(fParam0);
}

bool Function_292() //Position: 0x8786 / 34694
{
	return iLocal_20;
}

void Function_293(int iParam0, var uParam1) //Position: 0x878E / 34702
{
	if (!Function_67(iParam0))
	{
...
void Function_294() //Position: 0x87A4 / 34724
{
	struct<13> Var0;
...
void Function_295(bool bParam0) //Position: 0x87D0 / 34768
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 34850);
	return;
}

void Function_296(var uParam0) //Position: 0x8822 / 34850
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
float Function_297(bool bParam0) //Position: 0x8925 / 35109
{
...
bool Function_298(int iParam0) //Position: 0x89ED / 35309
{
	return Function_40(*iParam0, 2);
}

void Function_299(bool bParam0) //Position: 0x89FA / 35322
{
	Function_234(bParam0, 0.0f);
	return;
}

void Function_300(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0x8A06 / 35334
{
	struct<4> Var0;
	int iVar4;
...
struct<16> Function_301(int iParam0) //Position: 0x8A8B / 35467
{
	char* cVar0[16];
...
bool Function_302() //Position: 0x8ACA / 35530
{
	return (HUD_IS_SHOWING_OBJECTIVE() || HUD_IS_SHOWING_SMALL_TEXT());
}

void Function_303(var uParam0, int iParam1) //Position: 0x8AD7 / 35543
{
...
bool Function_304(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x8AED / 35565
{
	if (!Function_346())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_317(39463, 38811);
			break;
		
		case 0x00000002:
			Function_317(36188, 35764);
			break;
...
int Function_305(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x8BB4 / 35764
{
	bool bVar0;
	bool bVar1;
...
bool Function_306(bool bParam0, bool bParam1, int iParam2) //Position: 0x8C57 / 35927
{
	var uVar0;
...
int Function_307(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x8C68 / 35944
{
	char* cVar0[32];
...
int Function_308(int iParam0, bool bParam1) //Position: 0x8CCD / 36045
{
	char* cVar0[64];
...
void Function_309(bool bParam0, int iParam1, char* cParam2) //Position: 0x8D3B / 36155
{
	if (bParam0)
	{
		if (Function_127())
...
int Function_310() //Position: 0x8D5C / 36188
{
	if (!Function_311(1))
	{
		return 0;
...
bool Function_311(bool bParam0) //Position: 0x8E18 / 36376
{
	char* cVar0[64];
...
void Function_312(bool bParam0) //Position: 0x8E99 / 36505
{
...
var Function_313(int iParam0, bool bParam1) //Position: 0x8F22 / 36642
{
	int iVar0;
...
struct<64> Function_314(var uParam0) //Position: 0x8F42 / 36674
{
...
struct<64> Function_315(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x8F56 / 36694
{
	char* cVar0[64];
...
int Function_316(bool bParam0, bool bParam1) //Position: 0x8F9B / 36763
{
...
void Function_317(int iParam0, int iParam1) //Position: 0x8FCF / 36815
{
	Function_318(iParam0, iParam1, 38804);
	return;
}

void Function_318(var uParam0, var uParam1, int iParam2) //Position: 0x8FE0 / 36832
{
...
void Function_319() //Position: 0x9179 / 37241
{
	if (Function_39(4194304))
	{
...
void Function_320(var uParam0, var uParam1, int iParam2) //Position: 0x9282 / 37506
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_321(bool bParam0, int iParam1, bool bParam2) //Position: 0x93FA / 37882
{
	char* cVar0[64];
	int iVar16;
...
var Function_322(int iParam0) //Position: 0x947B / 38011
{
	switch (iParam0)
	{
		case 0x00000002:
...
int Function_323() //Position: 0x9794 / 38804
{
	return 1;
}

int Function_324(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x979B / 38811
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
var Function_325(int iParam0) //Position: 0x995C / 39260
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_326(int iParam0) //Position: 0x996F / 39279
{
...
float Function_327(int iParam0, bool bParam1) //Position: 0x998F / 39311
{
	char* cVar0[64];
...
int Function_328(bool bParam0) //Position: 0x99F8 / 39416
{
	if (!Function_137(bParam0))
	{
		return 4294967295;
...
var Function_329() //Position: 0x9A1D / 39453
{
	return Global_78480;
}

int Function_330() //Position: 0x9A27 / 39463
{
	bool bVar0;
	int iVar1;
...
void Function_331() //Position: 0x9B4A / 39754
{
	if (Function_39(4096))
	{
...
void Function_332(int iParam0) //Position: 0x9B87 / 39815
{
	int iVar0;
	int iVar1;
...
void Function_333(int iParam0) //Position: 0x9C00 / 39936
{
	struct<13> Var0;
...
void Function_334(int iParam0) //Position: 0x9C2B / 39979
{
	int iVar0;
...
void Function_335(var uParam0, bool bParam1) //Position: 0x9C72 / 40050
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_336(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x9DBD / 40381
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_337(bool bParam0) //Position: 0x9E9F / 40607
{
	bool bVar0;
...
void Function_338() //Position: 0x9EF9 / 40697
{
	Function_339(4);
	return;
}

void Function_339(int iParam0) //Position: 0x9F03 / 40707
{
	var uVar0;
	var uVar1;
...
void Function_340(var uParam0) //Position: 0x9F35 / 40757
{
	var uVar0;
...
void Function_341() //Position: 0x9F44 / 40772
{
	bool bVar0;
...
void Function_342() //Position: 0x9F79 / 40825
{
	int iVar0;
...
bool Function_343(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x9F92 / 40850
{
	bool bVar0;
...
bool Function_344(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x9FFB / 40955
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_345(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0xA0E8 / 41192
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool Function_346() //Position: 0xA196 / 41366
{
	int iVar0;
...
void Function_347(bool bParam0) //Position: 0xA1B9 / 41401
{
	bool bVar0;
	
	bVar0 = NET_ACTOR_GET_SCRIPT_INT(bParam0);
	if (bVar0 != 16834 || bVar0 != 93841)
	{
		TASK_CLEAR(bParam0);
		...
		if (bVar0 == 93841)
		{
			...
			{
				SET_BLIP_NAME(ADD_BLIP_FOR_ACTOR(bParam0, 392, 0.0f, 2, 0), "broken_MP_bossName");
			}
			if (bLocal_149 == "")
			{
				bLocal_149 = bParam0;
...
bool Function_348(var uParam0, int iParam1) //Position: 0xA2A7 / 41639
{
	if (!Function_28())
	{
		return 0;
...
bool Function_349(int iParam0) //Position: 0xA2C7 / 41671
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 41988);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 41949);
	return 1;
}

void Function_350(var uParam0) //Position: 0xA3DD / 41949
{
	int iVar0;
...
void Function_351(var uParam0) //Position: 0xA404 / 41988
{
	struct<13> Var0;
...
void Function_352(var uParam0) //Position: 0xA47B / 42107
{
	struct<13> Var0;
...
void Function_353(var uParam0, int iParam1) //Position: 0xA4C8 / 42184
{
	bool bVar0;
	int iVar1;
...
void Function_354(int iParam0) //Position: 0xA51D / 42269
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_355(int iParam0) //Position: 0xA52F / 42287
{
...
void Function_356() //Position: 0xA5F3 / 42483
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_357(bool bParam0, bool bParam1) //Position: 0xA60C / 42508
{
	var uVar0;
...
void Function_358() //Position: 0xA658 / 42584
{
...
void Function_359() //Position: 0xA677 / 42615
{
	Function_360(&Global_78480 + 220);
	return;
}

void Function_360(int iParam0) //Position: 0xA686 / 42630
{
	int iVar0;
...
void Function_361(int iParam0) //Position: 0xA6A7 / 42663
{
	int iVar0;
...
void Function_362(int iParam0) //Position: 0xA6CB / 42699
{
	int iVar0;
...
void Function_363(var uParam0, int iParam1) //Position: 0xA6EF / 42735
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_364(var uParam0) //Position: 0xA6FB / 42747
{
	uParam0 = uParam0;
	return;
}

void Function_365(int iParam0) //Position: 0xA705 / 42757
{
	if (!Function_67(iParam0))
	{
...
bool Function_366(var uParam0, bool bParam1) //Position: 0xA71A / 42778
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_367(char* cParam0) //Position: 0xA7CD / 42957
{
	bool bVar0;
