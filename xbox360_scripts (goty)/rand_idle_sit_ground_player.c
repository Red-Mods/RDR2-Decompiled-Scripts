...
void main() //Position: 0x0 / 0
{
	...
	iLocal_30 = 0;
	Function_102(uScriptParam_0, &iLocal_30);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_31);
		}
		iVar2 = 0;
		bLocal_36 = false;
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_37))
	{
		Function_105("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(bLocal_37);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_30 - 1))
	{
...
void Function_5(int iParam0) //Position: 0x47E / 1150
{
	...
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_37))
								{
									...
									{
										bLocal_37 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_37 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_37))
								{
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_37))
		{
			Function_105("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_37);
		}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_35, &cLocal_34);
...
void Function_62(bool bParam0) //Position: 0x2552 / 9554
{
	...
	{
		iLocal_4 = 1;
		if (!IS_LAYOUTREF_VALID(cLocal_1))
		{
			Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_66("sitCampLayout") };
			bLocal_1 = CREATE_LAYOUT(&Var0);
		}
		bLocal_2 = Function_63(bLocal_1, 0, Global_34573, 1, 0, 0);
	}
	return;
}

bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x259E / 9630
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2627 / 9767
{
	bool bVar0;
...
struct<32> Function_66(bool bParam0) //Position: 0x26DE / 9950
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2748 / 10056
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x2767 / 10087
{
	iParam0 = iParam0;
	return;
}

bool Function_69(bool bParam0) //Position: 0x2771 / 10097
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x278F / 10127
{
	if (!Function_14(iParam0))
	{
...
bool Function_71(bool bParam0, bool bParam1) //Position: 0x27A4 / 10148
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_72(int iParam0) //Position: 0x282B / 10283
{
	vector3 vVar0;
...
vector3 Function_73(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x284E / 10318
{
	vector3 vVar0;
...
bool Function_74(bool bParam0) //Position: 0x286C / 10348
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(bool bParam0, bool bParam1) //Position: 0x288F / 10383
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x29AA / 10666
{
...
int Function_77(bool bParam0) //Position: 0x29D5 / 10709
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2ADA / 10970
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(int iParam0) //Position: 0x2AE7 / 10983
{
	if (Function_78(iParam0->f_40, 16))
	{
...
void Function_80(int iParam0, bool bParam1) //Position: 0x2B5A / 11098
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam0->f_12 == iLocal_35)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(cLocal_34));
		iLocal_35 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_81() //Position: 0x3058 / 12376
{
	iLocal_4 = 0;
...
bool Function_82(bool bParam0) //Position: 0x306E / 12398
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_83(var uParam0, int iParam1) //Position: 0x308B / 12427
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_84(int iParam0) //Position: 0x30C3 / 12483
{
	iParam0 = iParam0;
	return;
}

bool Function_85(bool bParam0) //Position: 0x30CD / 12493
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, int iParam1) //Position: 0x30EE / 12526
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3115 / 12565
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x321D / 12829
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_89(int iParam0) //Position: 0x3233 / 12851
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_90(iParam0->f_16, bVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_90(bool bParam0, int iParam1) //Position: 0x34E9 / 13545
{
	struct<8> Var0;
	vector3 vVar8;
	bool bVar11;
	...
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		...
		GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &vVar8);
		bVar11 = CREATE_VOLUME_IN_LAYOUT(bLocal_1, Function_39(), 3, vVar8, 0.0f, 0.0f, 0.0f, 3.0f, 7.0f, 3.0f);
		ADD_CORPSE_REMOVAL_VOLUME_OBJ(bVar11);
		DESTROY_VOLUME(bVar11);
		Global_3418 = 0;
...
bool Function_91(bool bParam0) //Position: 0x3559 / 13657
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_92(bool bParam0) //Position: 0x3572 / 13682
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_93(bool bParam0, int iParam1) //Position: 0x358C / 13708
{
	bool bVar0;
	char* cVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x35C4 / 13764
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_95(int iParam0, int iParam1) //Position: 0x35DB / 13787
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_96(bool bParam0) //Position: 0x38A4 / 14500
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_97(bool bParam0, bool bParam1) //Position: 0x38C1 / 14529
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_98(int iParam0) //Position: 0x395D / 14685
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(bool bParam0, int iParam1) //Position: 0x397C / 14716
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
		if ((GET_CURRENT_GAME_TIME() - GET_LAST_ATTACK_TIME(bParam0)) > 8.0f)
		{
			return 0;
		}
...
bool Function_100(int iParam0) //Position: 0x39BA / 14778
{
...
void Function_101(int iParam0) //Position: 0x39D6 / 14806
{
	iParam0 = iParam0;
	return;
}

void Function_102(bool bParam0, int iParam1) //Position: 0x39E0 / 14816
{
	int iVar0;
	int iVar1;
	...
	{
		Function_103(&(Local_5[iLocal_3012]), bParam0);
		iLocal_30++;
	}
...
void Function_103(int iParam0, int iParam1) //Position: 0x3A42 / 14914
{
...
void Function_104(int iParam0) //Position: 0x3A56 / 14934
{
	iParam0 = iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x3A60 / 14944
{
