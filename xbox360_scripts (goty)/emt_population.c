...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = Function_17("vultures", 0);
	Function_12(&uVar2, 1128, 10.0f, 14, 0, 0);
	...
	uVar6 = Function_17("Rabbits", 0);
	Function_12(&uVar6, 1078, 6.5f, 49, 0, 0);
	uVar7 = Function_17("Pigs", 0);
	Function_15(&uVar7, 1020, 8.0f, 0, 0);
	uVar8 = Function_17("Jail", 1);
	Function_15(&uVar8, 9, 8.0f, 0, 0);
	Function_15(&uVar8, 10, 8.0f, 0, 0);
	uVar9 = Function_17("Army", 1);
	Function_15(&uVar9, 380, 8.0f, 0, 0);
	Function_15(&uVar9, 379, 8.0f, 0, 0);
	Function_15(&uVar9, 381, 8.0f, 0, 0);
	Function_15(&uVar9, 392, 8.0f, 0, 0);
	Function_15(&uVar9, 391, 8.0f, 0, 0);
	if (!Function_11() && Global_25974[4])
	{
		uVar10 = Function_17("ped_armwrestling", 0);
		Function_15(&uVar10, 408, 1.0f, 0, 0);
		Function_15(&uVar10, 457, 1.0f, 0, 0);
		Function_15(&uVar10, 258, 1.0f, 0, 0);
		Function_15(&uVar10, 136, 1.0f, 0, 0);
		Function_15(&uVar10, 138, 1.0f, 0, 0);
		Function_15(&uVar10, 162, 1.0f, 0, 0);
	}
	uVar11 = Function_17("Goats", 0);
	Function_15(&uVar11, 1029, 8.0f, 0, 0);
	uVar12 = Function_17("Dogs", 0);
	Function_15(&uVar12, 1032, 8.0f, 0, 0);
	Function_15(&uVar12, 1032, 8.0f, 0, 0);
	...
	uVar14 = CREATE_POPULATION_SET(1);
	...
	if (IS_LAYOUTREF_VALID(bVar15))
	{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_6(bVar16, uVar2, 0.0006f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_6(bVar16, uVar6, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_5(bVar16, uVar12, 1, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_5(bVar16, uVar8, 1, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_6(bVar16, uVar9, 0.1f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_6(bVar16, uVar9, 0.2f, 0, 0, 1);
		}
		else
		{
		...
		if (!Function_11() && Global_25974[4])
		{
			...
			bVar17 = Function_5(bVar16, uVar10, 3, 1, 0, 0);
		...
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_6(bVar16, uVar14, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_5(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x125B / 4699
{
	bool bVar0;
...
var Function_6(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x12DB / 4827
{
	bool bVar0;
...
var Function_13(int iParam0) //Position: 0x1462 / 5218
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0x14CE / 5326
{
	int iVar0;
...
var Function_15(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x153A / 5434
{
	int iVar0;
	int iVar1;
...
var Function_16(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x15B6 / 5558
{
	int iVar0;
	int iVar1;
...
var Function_17(bool bParam0, int iParam1) //Position: 0x15FB / 5627
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_18(int iParam0) //Position: 0x1608 / 5640
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_19(bool bParam0, var uParam1) //Position: 0x1614 / 5652
{
	if (!Function_7(128))
	{
		return;
