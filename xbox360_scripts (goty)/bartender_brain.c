...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = true;
	Var1 = false;
	Var1.f_4 = bScriptParam_0;
	iVar17 = 0;
	if (Function_48(&Var1))
	{
		Var1.f_24 = 0;
		Var1.f_20 = RAND_INT_RANGE(0, 20);
	}
	else
	{
		Var1.f_24 = 0;
	...
	while (IS_GRINGO_ACTIVE())
	{
		if (IS_PERS_CHAR_VALID(Function_47()))
		{
			if (!Function_46(&Var1))
			{
				...
				{
					Function_10(&iVar17, &Var1, 0);
				}
				Function_2(iVar17, &Var1);
				bVar18 = Function_1();
				if (IS_ACTOR_VALID(bVar18))
				{
					if (bVar0)
					{
						AI_CONVERSE_DISABLE(bVar18);
						bVar0 = false;
					}
				}
				else if (!bVar0)
...
void Function_2(int iParam0, bool bParam1) //Position: 0x128 / 296
{
	...
	if (Function_9(bParam1))
	{
		if (IS_ACTOR_VALID(Function_1()))
		{
			...
			GET_POSITION(Function_1(), &vVar0);
		}
		else
		{
			GET_OBJECT_POSITION(Function_8(), &vVar0);
		}
		SET_DEBUG_DRAW(1);
		GET_POSITION(GET_PLAYER_ACTOR(0), &vVar3);
		Function_5(StackVal, Function_7(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam1, *bParam1));
		vVar0 = { StackVal, StackVal, Function_5(StackVal, Function_7(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam1, *bParam1)) };
		uVar6 = Function_3(bParam1);
...
var Function_3(bool bParam0) //Position: 0x1C5 / 453
{
	int iVar0;
	var uVar1;
	bool bVar2;
...
int Function_4(int iParam0) //Position: 0x331 / 817
{
	int iVar0;
	int iVar1;
	int iVar2;
...
vector3 Function_5(int iParam0, bool bParam1) //Position: 0x408 / 1032
{
	vector3 vVar0;
	int iVar20;
	vector3 vVar21;
	...
	if (Function_6(StackVal, StackVal, vVar21, 0.0f, 0.0f, 0.0f))
	{
		...
		if (IS_ACTOR_VALID(Function_1()))
		{
			GET_POSITION(Function_1(), &vVar21);
			if (Function_9(iParam0))
			{
		...
		{
			GET_OBJECT_POSITION(Function_8(), &vVar21);
			if (Function_9(iParam0))
			{
...
bool Function_6(vector3 vParam0, vector3 vParam3) //Position: 0x6CE / 1742
{
	vector3 vVar0;
...
bool Function_7(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) //Position: 0x6FB / 1787
{
	int iVar0;
...
var Function_8() //Position: 0x7C8 / 1992
{
	return GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF());
}

bool Function_9(bool bParam0) //Position: 0x7D4 / 2004
{
	bool bVar0;
	var uVar1;
...
int Function_10(int iParam0, bool bParam1, bool bParam2) //Position: 0x817 / 2071
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
	...
	{
		case 0x00000000:
			bParam1->f_16 = Function_7(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, *bParam1);
			Function_5(bParam1, bParam1->f_16);
			*(bParam1 + 40) = { StackVal, StackVal, Function_5(bParam1, bParam1->f_16) };
			bParam1->f_52 = Function_3(bParam1);
				...
				if (IS_OBJECT_VALID(StackVal))
				{
					switch (GET_OBJECT_TYPE(StackVal))
					{
						case 0x0000000C:
							...
							if (!Function_6(StackVal, StackVal, vVar1, 0.0f, 0.0f, 0.0f))
							{
...
bool Function_11(float fParam0, bool bParam1) //Position: 0x1799 / 6041
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_12(bool bParam0) //Position: 0x17C4 / 6084
{
	bool bVar0;
	int iVar1;
...
void Function_13(bool bParam0, bool bParam1, bool bParam2) //Position: 0x180A / 6154
{
	struct<5> Var0;
...
int Function_14(int iParam0, int iParam1) //Position: 0x1831 / 6193
{
	if (iParam0 < iParam1)
	{
		return iParam0;
...
int Function_15(int iParam0, int iParam1) //Position: 0x1844 / 6212
{
	if (iParam0 > iParam1)
	{
		return iParam0;
...
bool Function_16(bool bParam0, int iParam1, int iParam2) //Position: 0x1857 / 6231
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_17(bool bParam0) //Position: 0x1A16 / 6678
{
	int iVar0;
	int iVar1;
...
float Function_18(int iParam0) //Position: 0x1A44 / 6724
{
...
bool Function_19(int iParam0) //Position: 0x1B0C / 6924
{
	return Function_20(*iParam0, 2);
}

int Function_20(var uParam0, int iParam1) //Position: 0x1B19 / 6937
{
	return (uParam0 && iParam1) == 0;
}

bool Function_21(int iParam0) //Position: 0x1B26 / 6950
{
	return Function_20(*iParam0, 1);
}

bool Function_22(bool bParam0, bool bParam1, bool bParam2, var uParam3) //Position: 0x1B33 / 6963
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_23(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x1BB8 / 7096
{
	bool bVar0;
...
void Function_24(bool bParam0) //Position: 0x1DF2 / 7666
{
...
void Function_25(bool bParam0) //Position: 0x1E14 / 7700
{
...
void Function_26(int iParam0, bool bParam1) //Position: 0x1E90 / 7824
{
	if (Function_9(iParam0))
	{
		LOG_ERROR(bParam1);
...
bool Function_27(int iParam0) //Position: 0x1EA3 / 7843
{
	bool bVar0;
	var uVar1;
...
void Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x1EE8 / 7912
{
	if (Function_9(iParam0))
	{
...
bool Function_29(bool bParam0) //Position: 0x1F42 / 8002
{
	if (!StackVal != Function_7(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, bParam0->f_16, *bParam0))
	{
		return 1;
	}
	return 0;
...
void Function_30(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x1F5C / 8028
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
bool Function_31(vector3 vParam0) //Position: 0x20A0 / 8352
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

void Function_32(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x20B8 / 8376
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
void Function_33(vector3 vParam0, var uParam3, float fParam4) //Position: 0x21C2 / 8642
{
	var uVar0;
	var uVar3;
	...
	TASK_WANDER_IN_BOX(Function_1(), &uVar0, &uVar3, fParam4);
}

void Function_34(vector3 vParam0) //Position: 0x21F4 / 8692
{
	if (fParam3 >= 0.0f)
	{
		fParam3 = 1.0f;
...
void Function_35(int iParam0) //Position: 0x2260 / 8800
{
	if (!Function_21(iParam0))
	{
...
void Function_36(var uParam0, float fParam1) //Position: 0x2275 / 8821
{
...
void Function_37(var uParam0, int iParam1) //Position: 0x2296 / 8854
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, int iParam1) //Position: 0x22A9 / 8873
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_39(bool bParam0) //Position: 0x22B8 / 8888
{
	bParam0->f_4 = 0.0f;
	bParam0->f_8 = 0.0f;
	*bParam0 = 0;
...
var Function_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, vector3 vParam4, float fParam7, bool bParam8, bool bParam9) //Position: 0x22CC / 8908
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_41(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2A49 / 10825
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_42() //Position: 0x2B2E / 11054
{
	int iVar0;
...
var Function_43(int iParam0, var uParam1, int iParam2) //Position: 0x2B36 / 11062
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_44(var uParam0) //Position: 0x2CFD / 11517
{
	struct<73> Var0;
...
var Function_45() //Position: 0x2D4C / 11596
{
	return StackVal;
}

bool Function_46(bool bParam0) //Position: 0x2D57 / 11607
{
	bool bVar0;
	var uVar1;
...
var Function_47() //Position: 0x2D9B / 11675
{
	return GET_PERS_CHAR_FROM_OBJECT(GET_OBJECT_OWNER(GRINGO_GET_MY_OBJECT_REF()));
}

bool Function_48(int iParam0) //Position: 0x2DAA / 11690
{
	bool bVar0;
	int iVar1;
	bool bVar2;
