...
void Function_1(bool bParam0) //Position: 0x41F / 1055
{
	...
	{
		SET_OBJECT_COLLIDE_WITH_OBJECT(bLocal_3, bLocal_2, 1);
	...
	{
		SET_GRINGO_INT_ATTR(0, "CurrentState", bVar0);
	}
	return;
}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_45(iParam0, bVar8, &iLocal_83, &cLocal_82);
...
void Function_18(bool bParam0, int iParam1) //Position: 0x1CDE / 7390
{
...
void Function_19(var uParam0, var uParam1) //Position: 0x1CF3 / 7411
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_20() //Position: 0x1D01 / 7425
{
	bool bVar0;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1D32 / 7474
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_22(var uParam0, bool bParam1) //Position: 0x1DA6 / 7590
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_23(var uParam0, bool bParam1) //Position: 0x1E18 / 7704
{
	bParam1 = bParam1;
	uParam0 = uParam0;
...
int Function_24(bool bParam0, bool bParam1) //Position: 0x1E8A / 7818
{
	bool bVar0;
	bool bVar1;
	var uVar2;
...
vector3 Function_25() //Position: 0x1F79 / 8057
{
	return 0.0f, 0.0f, 0.0f;
}

vector3 Function_26(bool bParam0, bool bParam1) //Position: 0x1F82 / 8066
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
vector3 Function_27(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2049 / 8265
{
	vector3 vVar0;
...
int Function_29(bool bParam0, int iParam1) //Position: 0x20BD / 8381
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_30(bool bParam0) //Position: 0x213B / 8507
{
	return Function_12(bParam0, "UseTime", 5.0f);
}

bool Function_31() //Position: 0x2151 / 8529
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_32(bool bParam0) //Position: 0x215E / 8542
{
	return Function_12(bParam0, "MoveAllowance", 1.5f);
}

bool Function_33(var uParam0, int iParam1) //Position: 0x217E / 8574
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_34(bool bParam0) //Position: 0x218D / 8589
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_35() //Position: 0x21AC / 8620
{
	return;
}

void Function_36(var uParam0, int iParam1) //Position: 0x21B2 / 8626
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_37(int iParam0) //Position: 0x21C0 / 8640
{
	iParam0 = iParam0;
	return 1;
}

bool Function_38(bool bParam0) //Position: 0x21CB / 8651
{
	return Function_8(bParam0, "OneShotKill", 0);
}

bool Function_39(bool bParam0, int iParam1) //Position: 0x21E5 / 8677
{
	return Function_10(bParam0, "ParentAnimNode", iParam1);
}

bool Function_40(bool bParam0) //Position: 0x2203 / 8707
{
	return Function_8(bParam0, "LinkToParentAnim", 0);
}

bool Function_41(bool bParam0) //Position: 0x2222 / 8738
{
	int iVar0;
	int iVar1;
...
bool Function_42(bool bParam0) //Position: 0x2255 / 8789
{
	return Function_8(bParam0, "LinkParentToAnim", 0);
}

bool Function_43(bool bParam0) //Position: 0x2274 / 8820
{
	return Function_8(bParam0, "SingularUse", 0);
}

void Function_44(var uParam0, int iParam1) //Position: 0x228E / 8846
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_45(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x22A1 / 8865
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	PRINTNL();
	iVar2 = Function_53(uParam0->f_12, &bVar0);
...
var Function_46() //Position: 0x2589 / 9609
{
	int iVar0;
...
bool Function_47(bool bParam0, bool bParam1) //Position: 0x2591 / 9617
{
	return Function_10(bParam0, "TargetLocator", bParam1);
}

void Function_48() //Position: 0x25AE / 9646
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x25BD / 9661
{
	return Function_10(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x25DF / 9695
{
	return Function_10(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_51(bool bParam0) //Position: 0x2603 / 9731
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_52(bool bParam0, int iParam1) //Position: 0x2620 / 9760
{
	return Function_10(bParam0, "TargetAttachBone", iParam1);
}

bool Function_53(bool bParam0, int iParam1) //Position: 0x2640 / 9792
{
	return Function_10(bParam0, "TargetAttachSlot", iParam1);
}

void Function_54(bool bParam0, bool bParam1) //Position: 0x2660 / 9824
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_55(bool bParam0, bool bParam1, bool bParam2) //Position: 0x270E / 9998
{
	bool bVar0;
...
void Function_56(int iParam0, float fParam1) //Position: 0x277E / 10110
{
	if (!Function_15(iParam0))
	{
...
void Function_57(int iParam0, float fParam1) //Position: 0x2794 / 10132
{
...
var Function_58(bool bParam0) //Position: 0x27B5 / 10165
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_12(bParam0, "RandUseTime", 0.0f));
}

void Function_59(int iParam0) //Position: 0x27D5 / 10197
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_60(var uParam0) //Position: 0x27E9 / 10217
{
	uParam0 = uParam0;
	return;
}

int Function_61() //Position: 0x27F3 / 10227
{
	return 1;
}

void Function_62(var uParam0, int iParam1) //Position: 0x27FA / 10234
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_63(bool bParam0, var uParam1, int iParam2) //Position: 0x2809 / 10249
{
	bool bVar0;
...
bool Function_64(bool bParam0) //Position: 0x2848 / 10312
{
	return Function_12(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_65(bool bParam0) //Position: 0x2873 / 10355
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_66(bool bParam0) //Position: 0x287E / 10366
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_67(bool bParam0) //Position: 0x2974 / 10612
{
	return Function_8(bParam0, "UsePosActorRelative", 0);
}

bool Function_68(bool bParam0) //Position: 0x2996 / 10646
{
	return Function_12(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_69(bool bParam0) //Position: 0x29BD / 10685
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_70(vector3 vParam0) //Position: 0x2C7C / 11388
{
	vector3 vVar0;
...
vector3 Function_71(vector3 vParam0) //Position: 0x2CD9 / 11481
{
	vector3 vVar0;
...
void Function_72(int iParam0) //Position: 0x2D36 / 11574
{
	iParam0 = iParam0;
	return;
}

bool Function_73(bool bParam0) //Position: 0x2D40 / 11584
{
	return Function_8(bParam0, "MaintainPosture", 0);
}

void Function_74(int iParam0) //Position: 0x2D5E / 11614
{
	if (!Function_15(iParam0))
	{
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2D73 / 11635
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	return 1;
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x2D82 / 11650
{
...
int Function_77(bool bParam0) //Position: 0x2DAD / 11693
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2EB2 / 11954
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(int iParam0) //Position: 0x2EBF / 11967
{
	if (Function_78(iParam0->f_40, 16))
	{
...
void Function_80(int iParam0, bool bParam1) //Position: 0x2F32 / 12082
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x33C6 / 13254
{
	bool bVar0;
...
bool Function_82(bool bParam0) //Position: 0x33FD / 13309
{
	return Function_12(bParam0, "ReuseDelay", 15.0f);
}

void Function_83(int iParam0) //Position: 0x341A / 13338
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x3424 / 13348
{
	return Function_8(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x3445 / 13381
{
	iParam1 = iParam1;
	SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_ACTOR(), bParam0, 1);
	SET_OBJECT_COLLIDE_WITH_MOVABLES(GET_TARGET_ACTOR(), 1);
	return;
}

void Function_86(bool bParam0, bool bParam1) //Position: 0x345F / 13407
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3567 / 13671
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x357D / 13693
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(bool bParam0, int iParam1) //Position: 0x3833 / 14387
{
	iParam1 = iParam1;
	bLocal_2 = bParam0;
	...
	SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_ACTOR(), bParam0, 0);
...
void Function_90(bool bParam0) //Position: 0x3898 / 14488
{
	vector3 vVar0;
...
bool Function_91(bool bParam0) //Position: 0x38DF / 14559
{
	return Function_8(bParam0, "DrawWeapon", 0);
}

bool Function_92(bool bParam0) //Position: 0x38F8 / 14584
{
	return Function_8(bParam0, "AllowWeapon", 0);
}

void Function_93(bool bParam0, int iParam1) //Position: 0x3912 / 14610
{
	bool bVar0;
	char* cVar1;
...
bool Function_94(bool bParam0, int iParam1) //Position: 0x394A / 14666
{
	return Function_10(bParam0, "UseName", iParam1);
}

bool Function_95(int iParam0, int iParam1) //Position: 0x3961 / 14689
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_96(bool bParam0) //Position: 0x3C2A / 15402
{
	return Function_12(bParam0, "ActivationCone", 0.0f);
}

bool Function_97(bool bParam0, bool bParam1) //Position: 0x3C47 / 15431
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_98(bool bParam0) //Position: 0x3CE3 / 15587
{
	return Function_12(bParam0, "ActivationRadius", 2.0f);
}

bool Function_99(bool bParam0, bool bParam1) //Position: 0x3D02 / 15618
{
	bool bVar0;
	var uVar1;
	vector3 vVar2;
...
bool Function_100(bool bParam0, bool bParam1) //Position: 0x3DCE / 15822
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar1))
	{
		fVar3 = Function_10(bVar1, "WaterSourceName", &bVar2);
		if (bVar2)
		{
			fVar4 = 2.0f;
			GET_POSITION(bParam0, &vVar5);
			bVar8 = LOCATE_NAMED_VOLUME(vVar5, fVar4, fVar3, 1);
			if (IS_OBJECT_VALID(bVar8))
			{
...
bool Function_101(bool bParam0, bool bParam1) //Position: 0x3ED9 / 16089
{
	if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_1))
	{
...
void Function_102() //Position: 0x3F56 / 16214
{
	bool bVar0;
...
var Function_103(bool bParam0) //Position: 0x3F8E / 16270
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var Function_104(bool bParam0, bool bParam1, int iParam2) //Position: 0x4069 / 16489
{
	int iVar0;
...
bool Function_105(int iParam0) //Position: 0x407F / 16511
{
...
void Function_106(int iParam0) //Position: 0x409B / 16539
{
	iParam0 = iParam0;
	return;
}

void Function_107(bool bParam0, int iParam1) //Position: 0x40A5 / 16549
{
	int iVar0;
	int iVar1;
...
void Function_108(int iParam0, int iParam1) //Position: 0x4107 / 16647
{
...
void Function_109(int iParam0) //Position: 0x411B / 16667
{
	iParam0 = iParam0;
	return;
}

void Function_110(int iParam0) //Position: 0x4125 / 16677
{
