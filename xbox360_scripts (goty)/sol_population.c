...
void main() //Position: 0x0 / 0
{
	...
	Function_11(&(Global_30750[0]), 40, 2.0f, 0, 0);
	...
	Function_8(&(Global_30750[5]), 1128, 12.0f, 14, 1, 0);
	...
	Function_11(&(Global_30750[11]), 1088, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1089, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1090, 2.0f, 0, 0);
	...
	Function_11(&(Global_30750[8]), 1057, 1.0f, 0, 0);
	Function_11(&(Global_30750[8]), 1078, 2.0f, 0, 0);
	Function_11(&(Global_30750[8]), 1049, 1.0f, 0, 0);
	...
	Function_14(&(Global_30750[4]));
	Global_30750[4] = Function_13("ped_bad_guys_generic", 1);
	Function_11(&(Global_30750[4]), 486, 1.0f, 0, 0);
	...
	bVar1 = FIND_NAMED_LAYOUT("SolomonsFolly_layout");
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "solv_animal_set");
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, Global_30750[8], 1E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("sol_pop: Cannot find solv_animal_set to create population volumes");
		}
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "solv_birds");
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, Global_30750[7], 1E-05f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("sol_pop: Cannot find solv_birds to create population volumes");
		}
		bVar2 = FIND_VOLUME_IN_LAYOUT(bVar1, "solv_region");
		if (IS_VOLUME_VALID(bVar2))
		{
...
void Function_1(var uParam0, var uParam1) //Position: 0xC18 / 3096
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xC27 / 3111
{
	int iVar0;
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC7C / 3196
{
	bool bVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xD18 / 3352
{
	if (!Function_4(128))
	{
		return;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD72 / 3442
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD82 / 3458
{
	int iVar0;
	int iVar1;
...
var Function_9(int iParam0) //Position: 0xDFA / 3578
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE66 / 3686
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xED2 / 3794
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF4E / 3918
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xF93 / 3987
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0xFA0 / 4000
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0xFAC / 4012
{
	if (!Function_4(128))
	{
		return;
