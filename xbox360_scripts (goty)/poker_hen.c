...
bool Function_17() //Position: 0x420 / 1056
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_27(Global_30668[0], &Local_24 + 12, GET_PLAYER_ACTOR(0), 1, 0))
			{
				Function_26(Global_30668[0], 0);
				*(&Local_24 + 148) = { StackVal, StackVal, Function_26(Global_30668[0], 0) };
				Function_25(&Local_24 + 12);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					(*&Local_24 + 40)[iVar0] = iLocal_4 * 10;
					Function_24(Global_30668[0], iVar0, 0);
					*(&Local_24 + 72[iVar03]) = { StackVal, StackVal, Function_24(Global_30668[0], iVar0, 0) };
					iVar0++;
				}
				Local_24.f_168 = 2;
				Local_24.f_160 = 0;
				Local_24.f_8 = Local_6;
				Function_23(Global_30668[0]);
				*(&Local_24 + 184) = { StackVal, StackVal, Function_23(Global_30668[0]) };
				Function_22(Global_30668[0]);
				*(&Local_24 + 196) = { StackVal, StackVal, Function_22(Global_30668[0]) };
...
void Function_18() //Position: 0x5C2 / 1474
{
	Function_1();
	return;
}

bool Function_19(int iParam0) //Position: 0x5CB / 1483
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_20(int iParam0, bool bParam1) //Position: 0x5EC / 1516
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_21(int iParam0, int iParam1) //Position: 0x622 / 1570
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_22(int iParam0) //Position: 0x63D / 1597
{
...
vector3 Function_23(int iParam0) //Position: 0x737 / 1847
{
	if (iParam0 == Global_30668[0])
	{
...
vector3 Function_24(int iParam0, int iParam1, bool bParam2) //Position: 0x831 / 2097
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
void Function_25(int iParam0) //Position: 0xDAB / 3499
{
	int iVar0;
	bool bVar1;
...
vector3 Function_26(int iParam0, bool bParam1) //Position: 0xE00 / 3584
{
	if (iParam0 == Global_30668[0])
	{
...
bool Function_27(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xF12 / 3858
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool Function_28(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1101 / 4353
{
...
bool Function_29() //Position: 0x11B7 / 4535
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_30(bool bParam0) //Position: 0x11CE / 4558
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_31(bool bParam0) //Position: 0x11D9 / 4569
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_32(bool bParam0, bool bParam1) //Position: 0x11E7 / 4583
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_33(var uParam0, var uParam1, bool bParam2) //Position: 0x11F4 / 4596
{
	return LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/fake_poker", &uParam0, 1.0f, 0);
}

int Function_34() //Position: 0x1236 / 4662
{
	return Function_35(0);
}

int Function_35(bool bParam0) //Position: 0x1240 / 4672
{
...
bool Function_36() //Position: 0x1281 / 4737
{
...
var Function_37(int iParam0) //Position: 0x12AC / 4780
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
void Function_38() //Position: 0x12C6 / 4806
{
	Function_1();
	return;
}

void Function_39() //Position: 0x12CF / 4815
{
...
void Function_40(int iParam0) //Position: 0x131E / 4894
{
...
void Function_41(var uParam0, float fParam1) //Position: 0x1333 / 4915
{
...
void Function_42(var uParam0, int iParam1) //Position: 0x1354 / 4948
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_43(var uParam0, int iParam1) //Position: 0x1367 / 4967
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_44(int iParam0) //Position: 0x1376 / 4982
{
	return Function_45(*iParam0, 1);
}

int Function_45(var uParam0, bool bParam1) //Position: 0x1383 / 4995
{
	return (uParam0 && bParam1) == 0;
}

void Function_46() //Position: 0x1390 / 5008
{
	return;
}

void Function_47() //Position: 0x1396 / 5014
{
	return;
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x139C / 5020
{
	bool bVar0;
...
void Function_49(var uParam0) //Position: 0x13F3 / 5107
{
	int iVar0;
...
var Function_50() //Position: 0x1410 / 5136
{
	var uVar0;
