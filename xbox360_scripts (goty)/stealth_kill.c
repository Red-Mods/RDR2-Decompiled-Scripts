...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000006:
			...
			bVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_71(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x2593 / 9619
{
	...
	if (IS_ACTOR_PLAYER(bParam0) && GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Chair", bParam1))
	{
		bVar7 = GRINGO_GET_PARENT_COMPONENT(bParam1, 3);
		if (IS_GRINGO_COMPONENT_VALID(bVar7))
		{
			bVar8 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(bVar7));
			if (IS_ACTOR_VALID(bVar8))
			{
				GET_OBJECT_RELATIVE_POSITION(GET_OBJECT_FROM_ACTOR(bVar8), 0.0f, 0.0f, 1.5f, &vVar4);
				TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar4, bVar3, 0, true, 1);
			}
		}
		return 1;
	}
	if (IS_ACTOR_PLAYER(bParam0) && (GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Head", bParam1) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Feet", bParam1)))
	{
		TELEPORT_ACTOR_WITH_HEADING(bParam0, vVar0, bVar3, 0, true, 1);
		return 1;
	}
	if ((GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill", bParam1) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Head", bParam1)) || GRINGO_COMPONENT_CHECK_NAME("Stealth_Kill_Feet", bParam1))
	{
		return 1;
	}
	if (GRINGO_HANDLES_MOVEMENT(bParam1))
	{
		return Function_68(bParam0, bParam1);
	}
	bVar9 = Function_67(bParam1);
	fVar10 = Function_57(bParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vVar0, bVar9, 0.2f, 1, bVar3, fVar10, 0, 0);
	return 1;
}

bool Function_67(bool bParam0) //Position: 0x26DE / 9950
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_68(bool bParam0, bool bParam1) //Position: 0x2701 / 9985
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_69(bool bParam0, int iParam1) //Position: 0x281C / 10268
{
...
int Function_70(bool bParam0) //Position: 0x2847 / 10311
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x294C / 10572
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(int iParam0) //Position: 0x2959 / 10585
{
	if (Function_71(iParam0->f_40, 16))
	{
...
void Function_73(int iParam0, bool bParam1) //Position: 0x29CC / 10700
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x2ECA / 11978
{
	bool bVar0;
...
bool Function_75(bool bParam0) //Position: 0x2F01 / 12033
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_76(var uParam0, int iParam1) //Position: 0x2F1E / 12062
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x2F56 / 12118
{
	iParam0 = iParam0;
	return;
}

bool Function_78(bool bParam0) //Position: 0x2F60 / 12128
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_79(var uParam0, int iParam1) //Position: 0x2F81 / 12161
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x2F8F / 12175
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x3097 / 12439
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_82(int iParam0) //Position: 0x30AD / 12461
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(var uParam0, int iParam1) //Position: 0x3363 / 13155
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_84(bool bParam0) //Position: 0x3371 / 13169
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_85(bool bParam0) //Position: 0x338A / 13194
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_86(bool bParam0, int iParam1) //Position: 0x33A4 / 13220
{
	bool bVar0;
	char* cVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x33DC / 13276
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_88(int iParam0, int iParam1) //Position: 0x33F3 / 13299
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_89(bool bParam0) //Position: 0x36BC / 14012
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_90(bool bParam0, bool bParam1) //Position: 0x36D9 / 14041
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_91(int iParam0) //Position: 0x3775 / 14197
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3794 / 14228
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	
	bVar0 = GRINGO_GET_COMPONENT_HASH(bParam1);
	if (((bVar0 != STRING_TO_HASH("Stealth_Kill") || bVar0 != STRING_TO_HASH("Stealth_Kill_Feet")) || bVar0 != STRING_TO_HASH("Stealth_Kill_Head")) || bVar0 != STRING_TO_HASH("Stealth_Kill_Chair"))
	{
		if (GET_WEAPON_IN_HAND(bParam0) == 22)
		{
			bVar1 = GRINGO_GET_PARENT_COMPONENT(bParam1, 3);
			if (IS_GRINGO_COMPONENT_VALID(bVar1))
			{
				bVar2 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(bVar1));
				if (IS_ACTOR_VALID(bVar2))
				{
					if (((GET_ACTOR_ENUM(bVar2) != 638 || GET_ACTOR_ENUM(bVar2) != 640) || GET_ACTOR_ENUM(bVar2) != 698) || GET_ACTOR_ENUM(bVar2) != 646)
					{
						return 0;
					}
				}
...
bool Function_93(int iParam0) //Position: 0x3871 / 14449
{
...
void Function_94(int iParam0) //Position: 0x388D / 14477
{
	iParam0 = iParam0;
	return;
}

void Function_95(bool bParam0, int iParam1) //Position: 0x3897 / 14487
{
	int iVar0;
	int iVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x38F9 / 14585
{
...
void Function_97(int iParam0) //Position: 0x390D / 14605
{
	iParam0 = iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x3917 / 14615
{
