	...
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(Local_4[iVar312]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), Local_4[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", Local_4[iVar312].f_16);
							Function_84(Local_4[iVar312].f_16, 1);
							...
							{
								Function_77(&(Local_4[iVar312]), 0);
							}
							else if (Local_4[iVar312].f_44 < 8)
							{
								Function_76(&(Local_4[iVar312]));
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D0B / 7435
{
	...
	{
		if (!DECOR_CHECK_EXIST(bParam0, "MoveObj_AllowRun"))
		{
			if (GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vLocal_0, 0.1f, 0.1f, 1, 0.0f, 180.0f, 1, 0))
			{
				vLocal_0 = { 0.0f, 0.0f, 0.0f };
				return 0;
			}
		}
		SET_ACTOR_MIN_SPEED(bParam0, 2);
		SET_ACTOR_MAX_SPEED(bParam0, 2);
		if (GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vLocal_0, 0.1f, 0.1f, 2, 0.0f, 180.0f, 1, 0))
		{
			vLocal_0 = { 0.0f, 0.0f, 0.0f };
			return 0;
		}
	...
	if (!DECOR_CHECK_EXIST(bParam0, "MoveObj_AllowRun"))
	{
		SET_ACTOR_MAX_SPEED(bParam0, 1);
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x1DBF / 7615
{
...
void Function_29(var uParam0, int iParam1) //Position: 0x1DE4 / 7652
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DF2 / 7666
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DFD / 7677
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1E17 / 7703
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E35 / 7733
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E54 / 7764
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E87 / 7815
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1EA6 / 7846
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1EC0 / 7872
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1ED3 / 7891
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x21BB / 8635
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x21C3 / 8643
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21E0 / 8672
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21EF / 8687
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2211 / 8721
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2235 / 8757
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2252 / 8786
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2272 / 8818
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2292 / 8850
{
	bool bVar0;
	bool bVar1;
	char* cVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2340 / 9024
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x23B0 / 9136
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23C6 / 9158
{
...
var Function_51(bool bParam0) //Position: 0x23E7 / 9191
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2407 / 9223
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x241B / 9243
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2425 / 9253
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x242C / 9260
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x243B / 9275
{
	float fVar0;
...
bool Function_57(bool bParam0) //Position: 0x247A / 9338
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x24A5 / 9381
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24B0 / 9392
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x25A6 / 9638
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x25C8 / 9672
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25EF / 9711
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x28AE / 10414
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x290B / 10507
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2968 / 10600
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2972 / 10610
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2990 / 10640
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x29A5 / 10661
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A2C / 10796
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A4F / 10831
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A6D / 10861
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A90 / 10896
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2BAB / 11179
{
...
int Function_74(bool bParam0) //Position: 0x2BD6 / 11222
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CDB / 11483
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CE8 / 11496
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D5B / 11611
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3259 / 12889
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3290 / 12944
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x32AD / 12973
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32E5 / 13029
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32EF / 13039
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x3310 / 13072
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_VALID(bParam0))
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3333 / 13107
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x343B / 13371
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3451 / 13393
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3707 / 14087
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x3715 / 14101
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x372E / 14126
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x3748 / 14152
{
	bool bVar0;
	char* cVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3780 / 14208
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x3797 / 14231
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A60 / 14944
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A7D / 14973
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B19 / 15129
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(bool bParam0, int iParam1) //Position: 0x3B38 / 15160
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!IS_ACTOR_PLAYER(bParam0))
	{
		if (!DECOR_CHECK_EXIST(bParam0, "MoveObj_Dest"))
		{
			if (Global_3380)
			{
				bVar0 = GET_LAYOUT_FROM_OBJECT(GET_OBJECT_OWNER(GET_TARGET_OBJECT()));
			}
			else
			{
				bVar0 = Global_30616;
			...
			{
				bVar4 = GET_OBJECT_NAME(bVar2);
				if (STRING_CONTAINS_STRING(bVar4, "moveobj"))
				{
					GET_OBJECT_POSITION(bVar2, &vLocal_0);
					bVar3 = true;
				}
			...
			if (VDIST(vLocal_0, vVar5) > 2.0f)
			{
				vLocal_0 = { 0.0f, 0.0f, 0.0f };
				return 0;
			}
			if (Function_97(StackVal, StackVal, vLocal_0))
			{
				return 0;
			}
		}
		bVar8 = DECOR_GET_OBJECT(bParam0, "MoveObj_Dest");
		GET_OBJECT_POSITION(bVar8, &vLocal_0);
		if (Function_97(StackVal, StackVal, vLocal_0))
		{
			return 0;
		}
...
bool Function_97(vector3 vParam0) //Position: 0x3C3D / 15421
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_98(int iParam0) //Position: 0x3C55 / 15445
{
...
void Function_99(int iParam0) //Position: 0x3C71 / 15473
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C7B / 15483
{
	int iVar0;
	int iVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3CDD / 15581
{
...
void Function_102(int iParam0) //Position: 0x3CF1 / 15601
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3CFB / 15611
{
