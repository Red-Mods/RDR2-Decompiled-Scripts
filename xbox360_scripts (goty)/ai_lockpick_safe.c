...
bool Function_7(bool bParam0, int iParam1, int iParam2) //Position: 0x85C / 2140
{
	int iVar0;
	int iVar1;
	
	iVar1 = GET_GRINGO_BOOL_ATTR(iParam1, bParam0, &iVar0);
	if (iVar0 >= 0)
	{
		return iVar1;
	}
...
int Function_11(float fParam0, int iParam1, int iParam2) //Position: 0x8F1 / 2289
{
	int iVar0;
	
	iVar0 = iParam2;
	GET_GRINGO_FLOAT_ATTR(&iVar0, iParam1, fParam0);
	return iVar0;
}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				if (IS_OBJECT_VALID(bVar8))
				{
					...
					{
						uVar22 = GET_PHYSINST_FROM_OBJECT(bVar8);
						if (IS_PHYSINST_VALID(uVar22))
						{
		...
		case 0x00000006:
			...
			iVar0 = Function_48(iParam0->f_16, iParam0->f_12, Function_75(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(iVar0))
			{
			...
			if (!IS_ACTOR_PLAYER(iParam0->f_16))
			{
				...
				{
					iVar41 = GRINGO_GET_FIRST_NAMED_CHILD("SpeechConts", 4, iParam0->f_12);
					if (IS_GRINGO_COMPONENT_VALID(iVar41))
					{
						...
						{
							iVar43 = GRINGO_GET_ATTRIBUTE_COUNT(iVar41);
							if (!GET_GRINGO_FLOAT_ATTR(&fVar45, "MinDelay", iVar41))
							{
								fVar45 = 10.0f;
							}
							else
							...
							if (!GET_GRINGO_FLOAT_ATTR(&fVar44, "MaxDelay", iVar41))
							{
								fVar44 = 30.0f;
							}
							else
							...
							bVar48 = GET_GRINGO_BOOL_ATTR("nForcePlay", iVar41, &iVar46);
							if (iVar46 != 0)
							{
								iVar43 = (iVar43 - 1);
							}
							...
							if (iVar43 >= 0)
							{
								if (GET_CURRENT_GAME_TIME() - fVar42) <= RAND_FLOAT_RANGE(fVar45, fVar44)
								{
									...
									if (iVar55 >= 1)
									{
										iVar56 = STRING_GET_TOKEN(1);
										if (STRINGS_ARE_EQUAL("super", iVar56))
										{
											iVar54 = 3;
										}
										else if (STRINGS_ARE_EQUAL("shout", iVar56))
										{
											iVar54 = 2;
										}
										else
...
float Function_23(int iParam0) //Position: 0x1CCA / 7370
{
...
int Function_25(int iParam0) //Position: 0x1CED / 7405
{
...
void Function_29(var uParam0, int iParam1) //Position: 0x1D41 / 7489
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D4F / 7503
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(int iParam0) //Position: 0x1D5A / 7514
{
	return Function_7(iParam0, "OneShotKill", 0);
}

int Function_32(int iParam0, int iParam1) //Position: 0x1D74 / 7540
{
	return Function_9(iParam0, "ParentAnimNode", iParam1);
}

bool Function_33(int iParam0) //Position: 0x1D92 / 7570
{
	return Function_7(iParam0, "LinkToParentAnim", 0);
}

bool Function_34(int iParam0) //Position: 0x1DB1 / 7601
{
	int iVar0;
	int iVar1;
...
bool Function_35(int iParam0) //Position: 0x1DE4 / 7652
{
	return Function_7(iParam0, "LinkParentToAnim", 0);
}

bool Function_36(int iParam0) //Position: 0x1E03 / 7683
{
	return Function_7(iParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E1D / 7709
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1E30 / 7728
{
	bool bVar0;
	bool bVar1;
	var uVar2;
	...
	iVar4 = Function_44(uParam0->f_12);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(iVar4)))
	{
		...
		if (bVar5)
		{
			...
			uParam0->f_32 = ATTACH_OBJECTS_PHYSICAL(uParam1, uParam0->f_16, uVar6, uVar8, 0.02f);
		}
		return;
	}
	iVar9 = 1;
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, uParam1, uVar3, Function_40(uParam0->f_12, &iVar10), 0, iVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, uParam1, Function_39(), Function_40(uParam0->f_12, &iVar10), 0, iVar9);
	}
	if (IS_GRINGO_COMPONENT_VALID(iVar4))
	{
		...
		uVar11 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(iVar4, uParam0->f_16);
		uVar12 = GRINGO_ANIM_GET_ACT_FILENAME(iVar4);
		uVar13 = GRINGO_ANIM_GET_ACT_ROOTNODE(iVar4);
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(uParam1, uVar11, uVar12, uVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
			if (Function_7(iVar4, "LinkToUser", 0))
			{
				if (Function_24())
				{
					Function_41();
...
var Function_39() //Position: 0x2118 / 8472
{
	int iVar0;
...
int Function_40(int iParam0, int iParam1) //Position: 0x2120 / 8480
{
	return Function_9(iParam0, "TargetLocator", iParam1);
}

void Function_41() //Position: 0x213D / 8509
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

int Function_42(int iParam0, int iParam1) //Position: 0x214C / 8524
{
	return Function_9(iParam0, "UserPhysAttachBone", iParam1);
}

int Function_43(int iParam0, int iParam1) //Position: 0x216E / 8558
{
	return Function_9(iParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2192 / 8594
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, iParam0);
}

int Function_45(var uParam0, int iParam1) //Position: 0x21AF / 8623
{
	return Function_9(uParam0, "TargetAttachBone", iParam1);
}

int Function_46(var uParam0, int iParam1) //Position: 0x21CF / 8655
{
	return Function_9(uParam0, "TargetAttachSlot", iParam1);
}

void Function_47(int iParam0, int iParam1) //Position: 0x21EF / 8687
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		uVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(iVar0, iParam1);
		uVar3 = GRINGO_ANIM_GET_ACT_FILENAME(iVar0);
		uVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(iVar0);
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x229D / 8861
{
	int iVar0;
	
	if (bParam2)
	{
		iVar0 = GRINGO_GET_FIRST_NAMED_CHILD("UseAnimMidAction", 2, uParam1);
		if (IS_GRINGO_COMPONENT_VALID(iVar0))
		{
			return iVar0;
		}
	...
	{
		iVar0 = GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam1);
		if (IS_GRINGO_COMPONENT_VALID(iVar0))
		{
			return iVar0;
		}
	}
	iVar0 = GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam1);
	return iVar0;
}

void Function_49(int iParam0, float fParam1) //Position: 0x230D / 8973
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2323 / 8995
{
...
var Function_51(int iParam0) //Position: 0x2344 / 9028
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(iParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2364 / 9060
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2378 / 9080
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x2382 / 9090
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2389 / 9097
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(int iParam0, var uParam1, int iParam2) //Position: 0x2398 / 9112
{
	float fVar0;
	
	Function_59(iParam0);
	*uParam1 = { StackVal, StackVal, Function_59(iParam0) };
...
int Function_57(int iParam0) //Position: 0x23D7 / 9175
{
	return Function_11(iParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x2402 / 9218
{
	return GRINGO_GET_USE_COMPONENT_HEADING(iParam0);
}

vector3 Function_59(int iParam0) //Position: 0x240D / 9229
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
	...
	{
		iVar3 = GRINGO_GET_PARENT_COMPONENT(iParam0, 3);
		if (IS_GRINGO_COMPONENT_VALID(iVar3))
		{
			bVar4 = GET_ACTOR_FROM_OBJECT(GRINGO_GET_COMPONENT_USER(iVar3));
			if (IS_ACTOR_VALID(bVar4))
			{
				GRINGO_GET_USE_COMPONENT_POSITION_LOCAL(&vVar0, iParam0);
	...
	else if (!GET_GRINGO_RELATIVE_POSITION_ATTR(&vVar0, "CentreLocator", iParam0))
	{
		if (!GET_GRINGO_RELATIVE_POSITION_ATTR(&vVar0, "UseLocator", iParam0))
		{
			if (!GRINGO_GET_USE_COMPONENT_POSITION(&vVar0, iParam0))
			{
...
bool Function_60(int iParam0) //Position: 0x2503 / 9475
{
	return Function_7(iParam0, "UsePosActorRelative", 0);
}

int Function_61(int iParam0) //Position: 0x2525 / 9509
{
	return Function_11(iParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x254C / 9548
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		uVar11 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar10, bParam0);
		if (GRINGO_IS_PROP_READY(uVar11))
		{
			uVar12 = GRINGO_GET_PROP_FROM_COMPONENT(uVar11);
			bVar13 = GET_OBJECT_FROM_PHYSINST(uVar12);
	...
	if (IS_OBJECT_VALID(bVar24))
	{
		...
		PLAY_CUTSCENEOBJECT(bVar24, 0, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
	}
	else
	{
...
vector3 Function_63(vector3 vParam0) //Position: 0x280B / 10251
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2868 / 10344
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28C5 / 10437
{
	iParam0 = iParam0;
	return;
}

bool Function_66(int iParam0) //Position: 0x28CF / 10447
{
	return Function_7(iParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28ED / 10477
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, int iParam1) //Position: 0x2902 / 10498
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
	...
	Function_59(iParam1);
	vVar0 = { StackVal, StackVal, Function_59(iParam1) };
	fVar3 = Function_58(iParam1);
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
	}
	...
	{
		return Function_72(bParam0, iParam1);
	}
	uVar4 = Function_71(iParam1);
	uVar5 = Function_57(iParam1);
	Function_69(iParam1);
	vVar6 = { StackVal, StackVal, Function_69(iParam1) };
	return GRINGO_ACTOR_MOVE_TO_AND_FACE_WITH_USER_OFFSET(bParam0, &vVar0, &vVar6, uVar4, 0.2f, 1, fVar3, uVar5, 0, 0);
}

vector3 Function_69(int iParam0) //Position: 0x2989 / 10633
{
	vector3 vVar0;
...
vector3 Function_70(int iParam0, var uParam1, vector3 vParam2) //Position: 0x29AC / 10668
{
	vector3 vVar0;
	
	vVar0 = { StackVal, StackVal, vParam2 };
	GET_GRINGO_VECTOR_ATTR(&vVar0, uParam1, iParam0);
	return StackVal, StackVal, vVar0;
}

int Function_71(int iParam0) //Position: 0x29CA / 10698
{
	return Function_11(iParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29ED / 10733
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
	...
	uVar1 = Function_57(iParam1);
	if (!GET_GRINGO_BOOL_ATTR("RandomPointSet", iParam1, &uVar6))
	{
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2B08 / 11016
{
...
int Function_74(bool bParam0) //Position: 0x2B33 / 11059
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, iParam0, 0);
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C38 / 11320
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C45 / 11333
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CB8 / 11448
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		uVar6 = GRINGO_GET_INDEXED_CHILD_COMPONENT(iVar5, iParam0->f_12);
	...
	SET_GRINGO_OBJECT_REF_ATTR(uVar14, "UserObject", iParam0->f_12);
	Function_52(iParam0);
	Function_67(iParam0);
...
void Function_78() //Position: 0x31B6 / 12726
{
	bool bVar0;
...
int Function_79(int iParam0) //Position: 0x31ED / 12781
{
	return Function_11(iParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x320A / 12810
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void Function_81(int iParam0) //Position: 0x3242 / 12866
{
	iParam0 = iParam0;
	return;
}

bool Function_82(int iParam0) //Position: 0x324C / 12876
{
	return Function_7(iParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x326D / 12909
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3281 / 12929
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(int iParam0, bool bParam1) //Position: 0x3389 / 13193
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), iParam1, iParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x339F / 13215
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	SET_GRINGO_OBJECT_REF_ATTR(uVar2, "LastUserObject", iParam0->f_12);
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_87(iParam0->f_16, iVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_87(var uParam0, int iParam1) //Position: 0x3655 / 13909
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(int iParam0) //Position: 0x3663 / 13923
{
	return Function_7(iParam0, "DrawWeapon", 0);
}

bool Function_89(int iParam0) //Position: 0x367C / 13948
{
	return Function_7(iParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3696 / 13974
{
	bool bVar0;
	var uVar1;
	
	iParam0 = iParam0;
	uVar1 = Function_91(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
int Function_91(var uParam0, int iParam1) //Position: 0x36CE / 14030
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36E5 / 14053
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
	...
	GRINGO_GET_USER_POS_WITH_OFFSET(&vVar2, bVar1, iVar0);
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		bVar5 = GRINGO_IS_CHARACTER_BLEND_PAUSED(iVar0);
		...
		if (IS_ACTOR_LOCAL_PLAYER(bVar1))
		{
			...
			{
				iVar6 = 0;
				GET_GRINGO_BOOL_ATTR("IsHogtieFriendly", iVar0, &iVar6);
				if (iVar6 == 0)
				{
					return 0;
				}
		...
		{
			uVar8 = GET_PROP_FROM_OBJECT(bVar7);
			if (IS_PHYSINST_VALID(uVar8))
			{
		...
		if (!Function_75(iParam0->f_40, 2))
		{
			...
			else
			{
				...
				fVar33 = Function_93(iParam0->f_12);
				if (!fVar33 != 0.0f)
				{
					if (fVar33 < 0.0f)
					{
...
int Function_93(int iParam0) //Position: 0x39AE / 14766
{
	return Function_11(iParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, int iParam1) //Position: 0x39CB / 14795
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
	
	fVar3 = GRINGO_GET_USE_COMPONENT_HEADING(iParam1);
	fVar4 = GET_HEADING(bParam0);
	fVar5 = Function_11(iParam1, "HeadingTolerance", -1.0f);
	fVar6 = (fVar3 - fVar4);
	if (fVar5 != -1.0f)
	{
		return 1;
	...
	Function_59(iParam1);
	Var0 = { StackVal, StackVal, Function_59(iParam1) };
...
int Function_95(int iParam0) //Position: 0x3A67 / 14951
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A86 / 14982
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3A95 / 14997
{
...
void Function_98(int iParam0) //Position: 0x3AB1 / 15025
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3ABB / 15035
{
	int iVar0;
	var uVar1;
	...
	{
		Function_100(&(Local_1[iLocal_7412]), uParam0);
		iLocal_74++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B1D / 15133
{
...
void Function_101(int iParam0) //Position: 0x3B31 / 15153
{
	var uVar0;
	bool bVar3;
	...
	bVar3 = LOCATE_GRINGO_OF_TYPE("$/content/scripting/gringo/SimpleGringo/Player_Lockpick_Footlocker", &uVar0, 0.5f, 0);
...
void Function_102(int iParam0) //Position: 0x3BA6 / 15270
{
