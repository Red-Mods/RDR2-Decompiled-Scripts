...
var Function_3(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC0B / 3083
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xD89 / 3465
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xDF5 / 3573
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE61 / 3681
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xEDD / 3805
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xF22 / 3874
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0xF2F / 3887
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0xF3B / 3899
{
	if (!Function_4(128))
	{
		return;
