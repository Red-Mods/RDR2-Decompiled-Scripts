...
void main() //Position: 0x0 / 0
{
	...
	iLocal_76 = 0;
	Function_97(uScriptParam_0, &iLocal_76);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_90(&(Local_3[iVar312]), &bVar4))
						{
							Function_88(GRINGO_GET_REQUESTING_ACTOR(), Local_3[iVar312].f_12);
							iVar5 = 1;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_83("eGRINGO_EndUse: Stop use by request", Local_3[iVar312].f_16);
							Function_82(Local_3[iVar312].f_16, 1);
...
void Function_62(bool bParam0) //Position: 0x254C / 9548
{
	...
	{
		iLocal_2 = 1;
		bLocal_1 = Function_63(GRINGO_GET_MY_OBJECT_REF(), 0, Global_34573, 1, 0, 0);
		CUTSCENEOBJECT_ADD_TRANSITION_HOLD(bLocal_1, 0, 9.0f, 4294967295);
	}
	return;
}

bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x257B / 9595
{
	bool bVar0;
	...
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "handoff_cutscene", 1, 1);
	}
...
void Function_64(var uParam0, int iParam1) //Position: 0x25ED / 9709
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2617 / 9751
{
	...
	ATTACH_CAMERASHOT(*uParam0, bParam1, 0.776195f, 1.958444f, 1.22306f, -16.60814f, 25.83153f, 0.000145f, 0.0f, 0.0f, 0.0f, 0);
	SET_CAMERASHOT_TARGET_OBJECT(*uParam0, bParam1, 0);
	SET_CAMERASHOT_TARGET_OBJECT_OFFSETS(*uParam0, -0.033495f, 1.404306f, -0.449202f, 0.0f, 0.0f, 0.0f, 0);
	return;
}

void Function_66(int iParam0) //Position: 0x26AC / 9900
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26B6 / 9910
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26D4 / 9940
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26E9 / 9961
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	bVar4 = Function_70(bParam1);
	fVar5 = Function_57(bParam1);
	return GRINGO_ACTOR_MOVE_TO_AND_FACE(bParam0, &vVar0, bVar4, 0.2f, 1, bVar3, fVar5, 0, 0);
}

bool Function_70(bool bParam0) //Position: 0x273A / 10042
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

bool Function_71(bool bParam0, int iParam1) //Position: 0x275D / 10077
{
...
int Function_72(bool bParam0) //Position: 0x2788 / 10120
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x288D / 10381
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x289A / 10394
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x290D / 10509
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x2E0B / 11787
{
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
...
bool Function_77(bool bParam0) //Position: 0x2E23 / 11811
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2E40 / 11840
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_79(int iParam0) //Position: 0x2E78 / 11896
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x2E82 / 11906
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(bool bParam0, int iParam1) //Position: 0x2EA3 / 11939
{
	DECOR_SET_BOOL(bParam0, "bIsFinished", true);
	iParam1 = iParam1;
	bParam0 = bParam0;
	return;
}

void Function_82(bool bParam0, bool bParam1) //Position: 0x2EC6 / 11974
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x2FCE / 12238
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x2FE4 / 12260
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x329A / 12954
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x32A8 / 12968
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x32C1 / 12993
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x32DB / 13019
{
	bool bVar0;
	char* cVar1;
	...
	if (DECOR_CHECK_EXIST(bParam0, "handoffAmmo"))
	{
		if (DECOR_GET_BOOL(bParam0, "handoffAmmo"))
		{
			GRINGO_SET_REQUEST_STRING("nTake_Ammo");
		}
	}
	return;
}

bool Function_89(var uParam0, int iParam1) //Position: 0x3345 / 13125
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x335C / 13148
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x3625 / 13861
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3642 / 13890
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36DE / 14046
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x36FD / 14077
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x370C / 14092
{
...
void Function_96(int iParam0) //Position: 0x3728 / 14120
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3732 / 14130
{
	int iVar0;
	int iVar1;
	...
	{
		Function_98(&(Local_3[iLocal_7612]), bParam0);
		iLocal_76++;
	}
...
void Function_98(int iParam0, int iParam1) //Position: 0x3794 / 14228
{
...
void Function_99(int iParam0) //Position: 0x37A8 / 14248
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37B2 / 14258
{
