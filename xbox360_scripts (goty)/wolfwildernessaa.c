...
void Function_11(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x501 / 1281
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
void Function_44(bool bParam0, bool bParam1) //Position: 0x1473 / 5235
{
...
void Function_68(bool bParam0) //Position: 0x17AB / 6059
{
	bool bVar0;
...
void Function_80(bool bParam0) //Position: 0x1A5F / 6751
{
	bool bVar0;
...
{
	if (!Function_156(&vLocal_99, &bLocal_126, 20476, 1, 0))
	{
		return 0;
	}
	switch (vLocal_99.y)
		...
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				if ((&vLocal_99 + 16)->f_32)
				{
					Function_119(1, "a");
					Function_112(0, "b");
					Function_109("AM_MH_9_wolf_help", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
...
void Function_107(bool bParam0, bool bParam1) //Position: 0x22E9 / 8937
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_109(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x23C1 / 9153
{
	struct<4> Var0;
	int iVar4;
...
void Function_112(char* cParam0, bool bParam1) //Position: 0x2496 / 9366
{
	...
	{
		case 0x00000003:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1068, "wolf_wolf_01", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_02", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_03", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_04", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_05", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_06", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_07", fVar3, fVar4);
		
		case 0x00000002:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1069, "wolf_wolf_08", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1068, "wolf_wolf_09", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_10", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_11", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_12", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_13", fVar3, fVar4);
		
		case 0x00000001:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_14", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_15", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1071, "wolf_wolf_16", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1070, "wolf_wolf_17", fVar3, fVar4);
			break;
	}
	return;
}

void Function_113(var uParam0, char* cParam1, vector3 vParam2, var uParam5, char* cParam6, float fParam7, float fParam8) //Position: 0x270B / 9995
{
	char* cVar0[32];
	var uVar8;
...
void Function_114(bool bParam0, bool bParam1) //Position: 0x2739 / 10041
{
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_115(bool bParam0, bool bParam1) //Position: 0x275C / 10076
{
	switch (bParam1)
	{
		case 0x00000000:
...
var Function_116(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x27F5 / 10229
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool Function_117(vector3 vParam0) //Position: 0x2881 / 10369
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_118() //Position: 0x2899 / 10393
{
	int iVar0;
	int iVar1;
...
void Function_119(char* cParam0, int iParam1) //Position: 0x28C8 / 10440
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 5.0f;
	fVar4 = 75.0f;
	Function_113(StackVal, StackVal, cParam0, iParam1, vVar0, 1072, "named_wolf_01", fVar3, fVar4);
	return;
}

void Function_120(var uParam0, bool bParam1) //Position: 0x290D / 10509
{
	struct<9> Var0;
...
void Function_121() //Position: 0x2944 / 10564
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				...
				Function_124(bLocal_133, bLocal_19, 0, 0);
			}
			if (Function_67(&iLocal_134))
			{
				Function_108(&iLocal_134, 15.0f);
...
void Function_122(int iParam0) //Position: 0x29FC / 10748
{
	var uVar0;
	
	uVar0 = iParam0;
	NET_SCRIPTMSG_SEND(3, 95, &uVar0, 1, 1);
	return;
}

int Function_123(int iParam0) //Position: 0x2A11 / 10769
{
...
void Function_124(bool bParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x2A39 / 10809
{
	bool bVar0;
	bool bVar1;
...
void Function_125() //Position: 0x2ABB / 10939
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
...
void Function_126(var uParam0, int iParam1) //Position: 0x2B66 / 11110
{
	bool bVar0;
	bool bVar1;
...
void Function_127() //Position: 0x2C02 / 11266
{
	int iVar0;
	...
	switch (vLocal_99.z)
	{
		...
		case 0x00000006:
			bLocal_126 = CREATE_LAYOUT("wolfWilderness");
			Function_134(&vLocal_99, bLocal_126);
			Function_133();
			Global_78480.f_24 = 4294967294;
			Function_51(256);
			iVar0 = 11949;
			NET_SCRIPTMSG_REGISTER_HANDLER(95, iVar0);
			vLocal_99.f_8 = 106;
			break;
...
void Function_128(var uParam0) //Position: 0x2C98 / 11416
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_131(int iParam0) //Position: 0x2E18 / 11800
{
...
void Function_132(bool bParam0) //Position: 0x2EAD / 11949
{
	int iVar0;
...
void Function_133() //Position: 0x2ED3 / 11987
{
	bLocal_133 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_126, "squad_wolf"));
...
void Function_134(var uParam0, bool bParam1) //Position: 0x2F19 / 12057
{
...
void Function_135(int iParam0) //Position: 0x2F8A / 12170
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

void Function_136(var uParam0) //Position: 0x2F9B / 12187
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_137() //Position: 0x2FA9 / 12201
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_138(int iParam0) //Position: 0x2FC2 / 12226
{
	int iVar0;
	int iVar1;
...
void Function_139() //Position: 0x333D / 13117
{
	if (!Function_140(128))
	{
		return;
...
bool Function_140(int iParam0) //Position: 0x337D / 13181
{
	int iVar0;
...
bool Function_141() //Position: 0x3399 / 13209
{
	int iVar0;
...
void Function_142(var uParam0, int iParam1) //Position: 0x33C4 / 13252
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_143() //Position: 0x33D5 / 13269
{
	if (!Function_140(128))
	{
		return;
...
void Function_144() //Position: 0x3417 / 13335
{
	Function_145(&uLocal_128, "mp_action_areas", 10, 0);
	return;
}

var Function_145(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3438 / 13368
{
	int iVar0;
	int iVar1;
	...
	iVar0 = Function_146(uParam0, iVar1, iParam2);
	if (bParam3)
	{
...
var Function_146(var uParam0, int iParam1, int iParam2) //Position: 0x3470 / 13424
{
	int iVar0;
...
bool Function_147(int iParam0) //Position: 0x3534 / 13620
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
bool Function_148(int iParam0) //Position: 0x35E0 / 13792
{
...
void Function_149(int iParam0) //Position: 0x35F6 / 13814
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_150(int iParam0) //Position: 0x360A / 13834
{
	if (Function_67(iParam0))
	{
...
float Function_151(float fParam0) //Position: 0x3625 / 13861
{
	return -Function_63(fParam0);
}

bool Function_152() //Position: 0x3631 / 13873
{
	return iLocal_20;
}

void Function_153() //Position: 0x3639 / 13881
{
	struct<13> Var0;
...
void Function_154(bool bParam0) //Position: 0x3665 / 13925
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 14007);
	return;
}

void Function_155(bool bParam0) //Position: 0x36B7 / 14007
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
bool Function_156(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x37BA / 14266
{
	if (!Function_206())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_174(18496, 17844);
			break;
		
		case 0x00000002:
			Function_174(15194, 14465);
			break;
...
int Function_157(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3881 / 14465
{
	bool bVar0;
	bool bVar1;
...
int Function_158(int iParam0) //Position: 0x3924 / 14628
{
	return Function_159(0, iParam0);
}

int Function_159(int iParam0, bool bParam1) //Position: 0x3930 / 14640
{
	char* cVar0[64];
...
bool Function_160(bool bParam0) //Position: 0x3997 / 14743
{
	char* cVar0[64];
...
var Function_161(int iParam0) //Position: 0x3A38 / 14904
{
	return (*&Global_78480 + 132)[iParam0];
}

bool Function_162(bool bParam0, bool bParam1, int iParam2) //Position: 0x3A48 / 14920
{
	var uVar0;
...
int Function_163(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x3A59 / 14937
{
	char* cVar0[32];
...
int Function_164(int iParam0, bool bParam1) //Position: 0x3ABE / 15038
{
	char* cVar0[64];
...
void Function_165(bool bParam0, int iParam1, bool bParam2) //Position: 0x3B2C / 15148
{
	if (bParam0)
	{
		if (Function_166())
...
bool Function_166() //Position: 0x3B4D / 15181
{
	return Function_39(32768);
}

int Function_167() //Position: 0x3B5A / 15194
{
	if (!Function_168(1))
	{
		return 0;
...
bool Function_168(bool bParam0) //Position: 0x3C16 / 15382
{
	char* cVar0[64];
...
void Function_169(bool bParam0) //Position: 0x3C97 / 15511
{
...
var Function_170(int iParam0, bool bParam1) //Position: 0x3D20 / 15648
{
	int iVar0;
...
struct<64> Function_171(var uParam0) //Position: 0x3D40 / 15680
{
...
struct<64> Function_172(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x3D54 / 15700
{
	char* cVar0[64];
...
int Function_173(bool bParam0, bool bParam1) //Position: 0x3D99 / 15769
{
...
void Function_174(int iParam0, int iParam1) //Position: 0x3DCD / 15821
{
	Function_175(iParam0, iParam1, 17837);
	return;
}

void Function_175(var uParam0, var uParam1, int iParam2) //Position: 0x3DDE / 15838
{
...
void Function_176() //Position: 0x3F77 / 16247
{
	if (Function_39(4194304))
	{
...
void Function_177(var uParam0, var uParam1, int iParam2) //Position: 0x4081 / 16513
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_178(bool bParam0, int iParam1, bool bParam2) //Position: 0x41F9 / 16889
{
	char* cVar0[64];
	int iVar16;
...
var Function_179(int iParam0) //Position: 0x427A / 17018
{
	switch (iParam0)
	{
		case 0x00000002:
...
void Function_180(bool bParam0) //Position: 0x4593 / 17811
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
int Function_181() //Position: 0x45AD / 17837
{
	return 1;
}

int Function_182(bool bParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x45B4 / 17844
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	Function_165(bParam1, iParam2, bParam3);
...
var Function_183(int iParam0) //Position: 0x4775 / 18293
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_184(int iParam0) //Position: 0x4788 / 18312
{
...
float Function_185(int iParam0, bool bParam1) //Position: 0x47A8 / 18344
{
	char* cVar0[64];
...
int Function_186(bool bParam0) //Position: 0x4811 / 18449
{
	if (!Function_160(bParam0))
	{
		return 4294967295;
...
var Function_187() //Position: 0x4836 / 18486
{
	return Global_78480;
}

int Function_188() //Position: 0x4840 / 18496
{
	bool bVar0;
	int iVar1;
...
void Function_189() //Position: 0x4963 / 18787
{
	if (Function_39(4096))
	{
...
void Function_190(int iParam0) //Position: 0x49A0 / 18848
{
	int iVar0;
	int iVar1;
...
void Function_191(int iParam0) //Position: 0x4A19 / 18969
{
	struct<13> Var0;
...
void Function_192(int iParam0) //Position: 0x4A44 / 19012
{
	bool bVar0;
...
void Function_193(var uParam0, bool bParam1) //Position: 0x4A8B / 19083
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_194(bool bParam0) //Position: 0x4BD6 / 19414
{
	vector3 vVar0;
...
int Function_195(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4BE7 / 19431
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_196(bool bParam0) //Position: 0x4CC9 / 19657
{
	bool bVar0;
...
void Function_197() //Position: 0x4D23 / 19747
{
	Function_198(4);
	return;
}

void Function_198(int iParam0) //Position: 0x4D2D / 19757
{
	var uVar0;
	var uVar1;
...
void Function_199(bool bParam0) //Position: 0x4D5F / 19807
{
	var uVar0;
...
void Function_200() //Position: 0x4D6E / 19822
{
	bool bVar0;
	...
	if (!iLocal_22)
	{
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (IS_ACTORSET_VALID(bLocal_19))
			{
				if (Function_202(bVar0, bLocal_19, 1, 0, 0, -1.0f))
				{
					Function_201();
					iLocal_22 = 1;
				}
...
void Function_201() //Position: 0x4DA3 / 19875
{
	int iVar0;
...
bool Function_202(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x4DBC / 19900
{
	bool bVar0;
	...
	if (Function_204(bParam1, 0, 0, 0, 0, 0) < 0)
	{
		return 0;
	}
...
bool Function_203(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x4E25 / 20005
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_204(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4F12 / 20242
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_205(int iParam0) //Position: 0x4FC0 / 20416
{
	if (iParam0 > 40)
	{
		return 0;
...
bool Function_206() //Position: 0x4FD9 / 20441
{
	int iVar0;
...
void Function_207(bool bParam0) //Position: 0x4FFC / 20476
{
	Function_115(bParam0, NET_ACTOR_GET_SCRIPT_INT(bParam0));
	return;
}

bool Function_208(int iParam0) //Position: 0x500C / 20492
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 20809);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 20770);
	return 1;
}

void Function_209(bool bParam0) //Position: 0x5122 / 20770
{
	int iVar0;
...
void Function_210(bool bParam0) //Position: 0x5149 / 20809
{
	struct<13> Var0;
...
void Function_211(bool bParam0) //Position: 0x51C0 / 20928
{
	struct<13> Var0;
...
void Function_212(var uParam0, int iParam1) //Position: 0x520D / 21005
{
	bool bVar0;
	bool bVar1;
...
void Function_213(int iParam0) //Position: 0x5262 / 21090
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_214(int iParam0) //Position: 0x5274 / 21108
{
...
void Function_215() //Position: 0x5338 / 21304
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_216(bool bParam0, bool bParam1) //Position: 0x5351 / 21329
{
	var uVar0;
...
void Function_217() //Position: 0x539D / 21405
{
...
void Function_218(int iParam0, bool bParam1) //Position: 0x53BC / 21436
{
	if (bParam1)
	{
...
void Function_219(int iParam0, var uParam1) //Position: 0x53F7 / 21495
{
	if (iParam0 > 40)
	{
		return;
...
void Function_220() //Position: 0x5411 / 21521
{
	Function_221(&Global_78480 + 220);
	return;
}

void Function_221(int iParam0) //Position: 0x5420 / 21536
{
	int iVar0;
...
void Function_222(int iParam0) //Position: 0x5441 / 21569
{
	int iVar0;
...
void Function_223(int iParam0) //Position: 0x5465 / 21605
{
	int iVar0;
...
void Function_224() //Position: 0x5489 / 21641
{
...
void Function_225(bool bParam0) //Position: 0x54E9 / 21737
{
...
void Function_226(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x5503 / 21763
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
	...
	SET_JOURNAL_ENTRY_PROGRESS(Function_230(iParam0), fParam1, true, 0);
	if (bParam2)
	{
		...
		APPEND_JOURNAL_ENTRY_DETAIL(Function_230(iParam0), &cVar0, 2, 2, true);
	}
...
void Function_227(bool bParam0, bool bParam1) //Position: 0x55BA / 21946
{
	bool bVar0;
...
bool Function_228(int iParam0, bool bParam1) //Position: 0x55DF / 21983
{
	return Function_40(Global_50170[iParam022].f_32, bParam1);
}

struct<16> Function_229(int iParam0) //Position: 0x55F3 / 22003
{
	char* cVar0[16];
...
var Function_230(int iParam0) //Position: 0x5627 / 22055
{
	return Global_50170[iParam022].f_24;
}

void Function_231() //Position: 0x5636 / 22070
{
	int iVar0;
...
void Function_232(var uParam0, int iParam1) //Position: 0x5660 / 22112
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_233(var uParam0) //Position: 0x566C / 22124
{
	uParam0 = uParam0;
	return;
}

void Function_234(int iParam0) //Position: 0x5676 / 22134
{
	if (!Function_67(iParam0))
	{
...
bool Function_235(var uParam0, bool bParam1) //Position: 0x568B / 22155
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_236(bool bParam0) //Position: 0x573E / 22334
{
	bool bVar0;
