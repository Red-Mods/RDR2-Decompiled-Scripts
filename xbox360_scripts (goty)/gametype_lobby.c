...
void main() //Position: 0x0 / 0
{
		...
		switch (iVar11)
		{
			...
			case 0x00000002:
				...
				if (IS_ACTOR_VALID(bVar6))
				{
					...
					{
						NET_LOG(true, "State Gametype_lobby", "Player is not on foot, forcing them to dismount", false, false, false, false);
						ACTOR_DISMOUNT_NOW(bVar6);
					}
				}
				else
				{
					NET_LOG(true, "State Gametype_lobby", "Player is invalid; allowing them in anyway", false, false, false, false);
					Function_580(6);
					Local_118.f_8 = 0.0f;
				}
				break;
			...
			case 0x00000006:
				...
				if (NET_IS_BUSY())
				{
					NET_LOG(true, "Lobby Session", "Networking is busy, hanging out", false, false, false, false);
				}
				else if (NET_IS_SEARCHBOT_BUSY())
				{
					NET_LOG(true, "Lobby Session", "Searchbot is busy, hanging out", false, false, false, false);
				}
				else
				{
					Function_580(7);
			...
			case 0x00000007:
				...
				if (NET_GET_PLAYMODE() == 1)
				{
					if (NET_IS_IN_SESSION())
					{
						...
						if (bVar8)
						{
							NET_LOG(true, "Lobby Session", "Starting lobby for private session.  No sessioning", false, false, false, false);
							Function_580(10);
						}
						else
						{
							NET_LOG(true, "Lobby Session", "Starting Lobby in private mode as non-host.  Leaving the current private session", false, false, false, false);
				...
				{
					NET_SESSION_LEAVE_SESSION();
					NET_LOG(true, "Lobby Session", "Leaving Previous Session", false, false, false, false);
					Function_580(8);
				}
				else
				{
					NET_LOG(true, "Lobby Session", "Not in a previous session", false, false, false, false);
					Function_580(9);
				}
				break;
			...
			case 0x00000008:
				...
				if (StackVal <= 15.0f)
				{
					NET_LOG(true, "Lobby Session", "Giving up, still in a session/busy after %s seconds!", I2STR(CEIL(15.0f)), false, false, false);
					Function_580(9);
				}
				else if (NET_IS_IN_SESSION())
				{
				...
				{
					NET_LOG(true, "Lobby Session", "No longer in a session", false, false, false, false);
					Local_118.f_8 = 0.0f;
					Function_580(9);
				}
				break;
			...
			case 0x00000009:
				...
				switch (ScriptParam_0.f_28)
				{
					case 0x00000004:
						...
						{
							NET_LOG(true, "Lobby Session", "NET_SESSION_CREATE_SESSION returned true", false, false, false, false);
						}
						else
						{
							NET_LOG(true, "Lobby Session", "NET_SESSION_CREATE_SESSION returned false", false, false, false, false);
						}
						break;
					...
					case 0x00000000:
						...
						{
							NET_LOG(true, "Lobby Session", "NET_SESSION_QUICK_JOIN returned true", false, false, false, false);
						}
						else
						{
							NET_LOG(true, "Lobby Session", "NET_SESSION_QUICK_JOIN returned false", false, false, false, false);
						}
						break;
					...
					case 0x00000002:
						if (Function_541())
						{
							NET_LOG(true, "Lobby Session", "LOBBY_JOIN_GAME_INVITE_SESSION returned true", false, false, false, false);
						}
						else
						{
							NET_LOG(true, "Lobby Session", "LOBBY_JOIN_GAME_INVITE_SESSION returned false", false, false, false, false);
							if (Function_540())
							{
				...
				if (!NET_IS_IN_SESSION())
				{
					...
					if (!(NET_IS_BUSY() || NET_IS_SEARCHBOT_BUSY()))
					{
						if (Function_539(&iVar1))
						{
							...
							{
								NET_LOG(true, "Lobby Session", "Net's not busy, and searchbot's inactive. STARTING OVER", false, false, false, false);
								bVar0 = true;
							}
							else
							{
								NET_LOG(true, "Lobby Session", "WAITING while Net's not busy, and searchbot's inactive.", false, false, false, false);
								bVar0 = false;
							}
						}
						else
					...
					{
						NET_LOG(true, "Lobby Session", "Invite Join Failed", false, false, false, false);
						Function_580(43);
						bVar0 = false;
					}
					else if (Function_532(Local_118.f_412, 63))
					{
						NET_LOG(true, "Lobby Session", "Join Failed", false, false, false, false);
						bVar0 = true;
					}
					else if (Function_532(Local_118.f_412, 65))
					{
						NET_LOG(true, "Lobby Session", "Creation Failed", false, false, false, false);
						bVar0 = true;
					}
					...
					if (bVar0)
					{
						NET_LOG(true, "Lobby Session", "Sessioning Problem found", false, false, false, false);
						Function_580(6);
					}
				}
				else
			...
			case 0x0000000B:
				...
				if (!NET_IS_IN_SESSION())
				{
					NET_LOG(true, "Lobby Session", "In WAITING TO JOIN but not in a session!", false, false, false, false);
					Function_580(6);
				}
				else if (!Function_572())
				{
					if (StackVal > 15.0f)
					{
						NET_LOG(true, "Lobby Session", "Haven't Received Host Data yet", false, false, false, false);
					}
					else
					{
						NET_LOG(true, "Lobby Session", "Gave Up on this session, trying another", false, false, false, false);
						Function_580(6);
					}
				}
				else
				{
					if (NET_IS_SESSION_HOST())
					{
						NET_LOG(false, "Lobby Session", "Got into a session as host", false, false, false, false);
					}
					else
					{
						NET_LOG(false, "Lobby Session", "Got into a session as client", false, false, false, false);
					}
					Function_580(12);
				}
				break;
				...
				else
				{
					...
					if (!Function_435(&Local_91 + 44))
					{
						if (NET_IS_SESSION_HOST())
						{
							...
							{
								Function_432(&Local_91 + 44, (bLocal_88 + 3.0f));
							}
						}
						else
						{
					...
					else
					{
						...
						if (Local_118.f_1008 != bVar16)
						{
							...
							if (Local_118.f_1008 >= FLOOR(bLocal_88) && Local_118.f_1008 < 4294967291)
							{
								if (StackVal == 0)
								{
			...
			case 0x0000001E:
				...
				if (Function_326(&Global_79349))
				{
					...
					{
						NET_LOG(true, "Lobby Gametype", "GAME REGION SCRIPT ('%s') failed!", GET_ASSET_NAME(Global_79349.f_24, 4), false, false, false);
			...
			case 0x00000029:
				...
				if (!Function_502(2048))
				{
					...
					{
						Function_495(2048, 1);
						NET_LOG(true, "Lobby State", "Game script successfully launched!", false, false, false, false);
					}
				}
				else if (Function_577(64))
				{
					NET_LOG(true, "Gametype Lobby", "Told to ditch, and doing so!", false, false, false, false);
					Function_60();
					Function_404(64);
				...
				{
					NET_LOG(true, "Lobby State", "Game script is no longer valid, deemed over!", false, false, false, false);
					Function_60();
					if (NET_IS_SESSION_HOST())
					{
						Function_503(2, 0);
	...
	{
		NET_LOG(true, "LOBBY", "Lobby leaving session", false, false, false, false);
		NET_SESSION_LEAVE_SESSION();
	}
...
int Function_3(bool bParam0) //Position: 0x2005 / 8197
{
	bool bVar0;
	bool bVar1;
...
void Function_13(char* cParam0, int iParam1) //Position: 0x22A4 / 8868
{
	bool bVar0;
...
bool Function_48(bool bParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2BEF / 11247
{
	bool bVar0;
	bool bVar1;
...
int Function_83(bool bParam0, int iParam1, bool bParam2, var uParam3) //Position: 0x35F1 / 13809
{
	...
	bVar0 = GET_OBJECTSET_FROM_OBJECT(FIND_OBJECT_IN_LAYOUT(bParam0, Function_120()));
	if (!IS_OBJECTSET_VALID(bVar0))
	{
		return 4294967295;
	}
	bVar1 = GET_OBJECTSET_FROM_OBJECT(FIND_OBJECT_IN_LAYOUT(bParam0, Function_119()));
	if (!IS_OBJECTSET_VALID(bVar1))
	{
		bVar1 = CREATE_OBJECTSET_IN_LAYOUT(Function_119(), bParam0, 17, 0);
	}
	iVar2 = 0;
	iVar4 = 0;
	bVar5 = false;
	bVar6 = false;
	iVar13 = Function_118(32, GET_OBJECTSET_SIZE(bVar0));
	bVar6 = false;
	while (bVar6 <= iVar13)
	{
					...
					switch (iVar2)
					{
						case 0x00000001:
							...
							if (Function_111(bVar5))
							{
								...
								{
									Function_90(StackVal, StackVal, StackVal, StackVal, &bVar15, &bVar16, bParam0, vVar7, vVar10, iVar2, bParam2, uParam3, &cVar17, iVar3, iVar4);
...
bool Function_88() //Position: 0x388E / 14478
{
	return Function_89(39);
}

int Function_89(bool bParam0) //Position: 0x3899 / 14489
{
	float fVar0;
...
void Function_90(var uParam0, bool bParam1, bool bParam2, vector3 vParam3, vector3 vParam6, int iParam9, bool bParam10, var uParam11, char* cParam12, int iParam13, int iParam14) //Position: 0x38C7 / 14535
{
	...
	DECOR_SET_INT(*bParam1, Function_92(), Function_91(iParam13, iParam14));
}
...
int Function_100(int iParam0, int iParam1, bool bParam2) //Position: 0x3AF9 / 15097
{
	int iVar0;
	
	iVar0 = (SHIFT_LEFT(Function_101((iParam1 - 1)), true) - 1);
...
int Function_102(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x3B24 / 15140
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
bool Function_110(bool bParam0) //Position: 0x3D47 / 15687
{
...
var Function_118(int iParam0, bool bParam1) //Position: 0x3E34 / 15924
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_128() //Position: 0x401F / 16415
{
	...
	{
		NET_LOG(true, "Host VBA", "HOST VARIABLES CLEARED", false, false, false, false);
	...
	{
		NET_LOG(true, "Host VBA", "HOST VARIABLES NOT CLEARED, %s is the host, not me", Function_129(), false, false, false);
	}
	return;
}
...
bool Function_143(int iParam0, int iParam1) //Position: 0x45BC / 17852
{
...
var Function_148(bool bParam0, vector3 vParam1, bool bParam4) //Position: 0x46C0 / 18112
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam4)
	{
		...
		Function_149(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &bVar4, vParam1, vVar5, vVar11);
	...
	while (iVar3 <= iVar0)
	{
		...
		Function_149(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, &bVar4, vParam1, vVar8, vVar11);
		iVar3++;
	}
	iVar3 = 0;
	while (iVar3 <= iVar0 * 3)
...
void Function_149(bool bParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7) //Position: 0x47F9 / 18425
{
...
vector3 Function_150(var uParam0, bool bParam1) //Position: 0x484E / 18510
{
	vector3 vVar0;
...
void Function_154(char* cParam0) //Position: 0x48C0 / 18624
{
	...
	{
		bVar0 = Function_427(&Local_91 + 32);
		bVar1 = CEIL(bVar0);
	...
	{
		bVar0 = Function_427(&Local_91 + 20);
		bVar1 = CEIL(bVar0);
...
var Function_182(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x6154 / 24916
{
	...
	if (IS_ACTOR_LOCAL_PLAYER(*bParam0))
	{
		...
		while (iVar1 <= 17)
		{
			...
			{
				bVar3 = iVar1;
				_ADD_AMMO_OF_TYPE(*bParam0, bVar3, TO_FLOAT(Function_184(&Global_83591 + 276, bVar3)), 1, 0);
				iVar0 = 1;
			}
			iVar1++;
		}
		switch (iParam3)
		{
			...
			case 0x00000001:
				...
				while (iVar1 <= 27)
				{
					...
					if (Function_110(bVar2))
					{
						if (Function_183(bVar2))
						{
							bVar3 = GET_AMMO_ENUM(bVar2);
							if (Function_185(bVar3, 1))
							{
			...
			case 0x00000002:
				...
				while (bVar2 <= 40)
				{
					if (Global_84559[bVar2])
					{
						...
						if (Function_185(bVar3, 1))
						{
							bVar24 = (Function_184(&Global_83591 + 276, bVar3) - CEIL(_GET_AMMO_AMOUNT(*bParam0, bVar3, 1)));
							if (bVar24 >= 0)
							{
								_ADD_AMMO_OF_TYPE(*bParam0, bVar3, TO_FLOAT(bVar24), 1, 0);
							}
...
bool Function_183(bool bParam0) //Position: 0x6437 / 25655
{
...
int Function_184(int iParam0, bool bParam1) //Position: 0x6459 / 25689
{
	if (Function_185(bParam1, 1))
	{
...
bool Function_185(bool bParam0, int iParam1) //Position: 0x6473 / 25715
{
...
void Function_188(int iParam0, int iParam1) //Position: 0x65AD / 26029
{
	...
	if (IS_ACTOR_VALID(bVar2))
	{
		...
		if (bVar3)
		{
			bVar4 = Function_173(bVar2, 40);
			if (bVar4 == 4294967295)
			{
				bVar4 = Function_173(bVar2, 39);
			}
...
void Function_200(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x6E17 / 28183
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_205(iParam0, bVar19, bVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_204(bVar19, bParam2, &iVar17, &iVar18);
...
struct<32> Function_203(char* cParam0, bool bParam1) //Position: 0x754A / 30026
{
	char* cVar0[32];
...
var Function_231(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x846A / 33898
{
	bool bVar0;
	
	if (bParam5)
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, Function_222(), 6, 1);
	}
	else
	{
...
void Function_232(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x84EC / 34028
{
	...
	Function_238(&bVar0, uParam1, uParam2, uParam3);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_237(&bVar0, uParam1, uParam2, uParam3);
...
void Function_233(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8607 / 34311
{
...
void Function_234(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x871C / 34588
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.02f);
...
void Function_235(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8835 / 34869
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
...
void Function_236(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x893F / 35135
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_237(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8A45 / 35397
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
void Function_238(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x8AF5 / 35573
{
	SET_CAMERASHOT_PERSPECTIVE(*uParam0, 1);
	SET_CAMERASHOT_FOV(*uParam0, 55.51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*uParam0, 0.1f);
...
var Function_239(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x8BAC / 35756
{
	bool bVar0;
	
	if (bParam3)
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, Function_222(), 2, 1);
	}
	else
	{
...
void Function_240(var uParam0, int iParam1) //Position: 0x8C23 / 35875
{
	...
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_242(&bVar0, iParam1);
	bVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_241(&bVar0, iParam1);
	...
	if (!Function_15(iParam0->f_48, 2048))
	{
		...
		else if (IS_ACTOR_PLAYER(iParam0->f_112))
		{
			if (IS_SLOT_VALID(StackVal))
			{
				...
				if (Function_110(bVar2) && RAND_INT_RANGE(false, 1000) > 500)
				{
					bVar1 = true;
				}
				else
...
void Function_250(bool bParam0, bool bParam1) //Position: 0x961F / 38431
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	
	bVar0 = CREATE_NAMED_OBJECT_ITERATOR(Function_151(), "PickupGoldener");
...
void Function_266(bool bParam0) //Position: 0x982A / 38954
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_272(int iParam0, int iParam1) //Position: 0x998D / 39309
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_274(bool bParam0) //Position: 0x9B01 / 39681
{
	switch (bParam0)
	{
		case 0x00000004:
...
var Function_305(int iParam0, var uParam1, vector3 vParam2, bool bParam5, int iParam6) //Position: 0x9F41 / 40769
{
	bool bVar0;
	...
	PRINTSTRING(bVar0);
	PRINTNL();
	return GET_GAME_CAMERA_RESET_POSITION(iParam0, uParam1, vParam2, bParam5, bVar0);
}
...
bool Function_306() //Position: 0xA068 / 41064
{
	...
	Function_308(bVar1);
	Function_307(&bVar14, &bVar1);
	DESTROY_OBJECTSET(bVar13);
	DESTROY_OBJECTSET(bVar14);
	iVar2 = GET_OBJECTSET_SIZE(bVar1);
	bVar16 = ((GET_LOCAL_SLOT() + Local_91.f_92) % iVar2);
...
void Function_308(bool bParam0) //Position: 0xA289 / 41609
{
	bool bVar0;
...
void Function_336() //Position: 0xA8CE / 43214
{
	...
	while (iVar6 > 10 && iVar4)
	{
		...
		if (bVar9 && iVar6 != 0)
		{
			bVar3 = (60.0f * TO_FLOAT(GET_LOCAL_SLOT()));
		}
		else
		{
...
void Function_340(int iParam0, int iParam1, int iParam2) //Position: 0xAAEF / 43759
{
	...
	if (!StackVal != Global_16524)
	{
		...
		Function_341(Global_16524, iVar0, 1);
	}
	return;
}

void Function_341(int iParam0, bool bParam1, bool bParam2) //Position: 0xABD5 / 43989
{
	int iVar0;
...
void Function_343(bool bParam0) //Position: 0xAD5A / 44378
{
	PRINTSTRING("Day ");
...
void Function_347(bool bParam0) //Position: 0xAE2B / 44587
{
	...
	{
		bVar0 = GET_OBJECTSET_FROM_OBJECT(FIND_OBJECT_IN_LAYOUT(bParam0, Function_119()));
		if (IS_OBJECTSET_VALID(bVar0))
		{
			...
			while (bVar2 <= iVar1)
			{
				...
				if (IS_OBJECT_VALID(bVar7))
				{
					...
					{
						iVar4 = Function_349(uVar3);
						iVar5 = Function_348(uVar3);
...
void Function_355() //Position: 0xAF32 / 44850
{
	...
	if (!NET_IS_IN_SESSION() || NET_IS_SESSION_HOST())
	{
		NET_LOG(true, "Host VBA", "HOST VARIABLES RESET", false, false, false, false);
		Function_504(&Global_78578 + 96);
		Global_78578.f_108 = 4294967295;
		iVar0 = 0;
		while (iVar0 <= 2)
	...
	{
		NET_LOG(true, "Host VBA", "HOST VARIABLES NOT RESET, %s is the host, not me", Function_129(), false, false, false);
	}
	return;
}
...
void Function_387(bool bParam0, bool bParam1) //Position: 0xB967 / 47463
{
	if (bParam1)
	{
...
void Function_401() //Position: 0xBC70 / 48240
{
	...
	else
	{
		...
		UI_SET_STRING_FORMAT("Generic_Dbuffer128_0", UI_GET_STRING("mp_lobby_loading"), UI_GET_STRING(&Global_79349 + 48), UI_GET_STRING(&Var8), false);
...
int Function_414(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0xC25D / 49757
{
	...
	if (Function_410(bParam0, bParam0 * -2, &uVar0, 0))
	{
		...
		{
			NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(bVar2, UI_GET_STRING(Function_415((Function_70(8, bParam0) - 1), 0)));
			bVar2++;
		}
		if (Function_29(0x1000000))
		{
			if (Function_492(8))
			{
				if (NET_GET_PLAYMODE() == 0)
				{
					...
					{
						NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(bVar2, "<red><MP_KO></red>");
					}
					else
					{
						NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(bVar2, "<green><MONEY></green>");
					}
					bVar2++;
				}
			}
	...
	switch (iParam0->f_92)
	{
		...
		default:
			...
			else
			{
				...
				iVar5 = (fVar4 / 3.0f);
				fVar7 = Function_265(FABS(bVar6), iVar5);
				if (bVar6 > 0.0f)
				{
					fVar7 = (fVar7 * -1.0f);
				}
	...
	switch (iParam0->f_92)
	{
		...
		default:
			...
			else
			{
				...
				fVar12 = Function_265(FABS(bVar11), fVar10);
				if (bVar11 > 0.0f)
				{
					fVar12 = (fVar12 * -1.0f);
				}
		...
		if (NET_IS_IN_SESSION())
		{
			if (IS_ACTOR_PLAYER(bParam1) && !IS_ACTOR_LOCAL_PLAYER(bParam1))
			{
				...
				if (IS_SLOT_VALID(bVar9))
				{
					...
					{
						bVar7 = Function_465(StackVal, StackVal, vVar10, bParam1);
					}
				}
			}
		}
		...
		if (NET_IS_IN_SESSION())
		{
			if (IS_ACTOR_PLAYER(bParam1) && !IS_ACTOR_LOCAL_PLAYER(bParam1))
			{
				...
				if (IS_SLOT_VALID(bVar12))
				{
					...
					{
						bVar10 = Function_465(StackVal, StackVal, vVar13, bParam1);
						bVar11 = false;
					}
				}
			}
...
void Function_471(bool bParam0, bool bParam1, float fParam2) //Position: 0xEC08 / 60424
{
	bool bVar0;
	...
	if (IS_LAYOUTREF_VALID(Global_6289))
	{
		...
		Function_473(bVar0, bParam1, 2, fParam2);
		Function_472(bVar0, bParam0);
		Function_473(bVar0, bParam1, 1, fParam2);
		Function_472(bVar0, bParam0);
		Function_473(bVar0, bParam1, 3, fParam2);
		Function_472(bVar0, bParam0);
		Function_473(bVar0, bParam1, 4, fParam2);
		Function_472(bVar0, bParam0);
		Function_473(bVar0, bParam1, 5, fParam2);
		Function_472(bVar0, bParam0);
		DESTROY_ITERATOR(bVar0);
	}
	return;
...
void Function_472(bool bParam0, bool bParam1) //Position: 0xEC7C / 60540
{
	bool bVar0;
...
void Function_473(bool bParam0, bool bParam1, bool bParam2, float fParam3) //Position: 0xECAE / 60590
{
	vector3 vVar0;
...
var Function_476(bool bParam0, int iParam1) //Position: 0xF167 / 61799
{
	...
	if (Global_29007 != 2)
	{
		...
		Function_473(StackVal, bVar2, 6, bParam0->f_76);
...
struct<16> Function_497(bool bParam0, var uParam1) //Position: 0xFA79 / 64121
{
	char* cVar0[16];
	int iVar4;
	int iVar172;
	...
	strcpy(&cVar0, "", 16);
	*(&iVar4 + 76) = 36;
	if (!Function_143(bParam0, &iVar4))
	{
		return StackVal, StackVal, StackVal, cVar0;
	}
	if (Function_500(bParam0))
	{
		*uParam1++;
	}
...
bool Function_500(bool bParam0) //Position: 0xFB03 / 64259
{
	struct<73> Var0;
	
	*(&Var0 + 76) = 36;
	if (Function_143(bParam0, &Var0))
	{
		if (Var0.f_72 >= 0)
		{
			return 1;
		}
		if ((bParam0 != 33 || bParam0 != 32) || bParam0 != 31)
		{
			return 1;
		}
	}
...
bool Function_532(bool bParam0, int iParam1) //Position: 0xFED0 / 65232
{
	bool bVar0;
	bool bVar1;
...
bool Function_541() //Position: 0x10080 / 65664
{
	...
	if (Function_542(&uVar0))
	{
		...
		NET_LOG(true, "Lobby Session", "LOBBY_JOIN_GAME_INVITE_SESSION Posse Session found BUT join failed", false, false, false, false);
	}
	else
	{
		NET_LOG(true, "Lobby Session", "LOBBY_JOIN_GAME_INVITE_SESSION No POSSE SESSION FOUND", false, false, false, false);
	}
	return 0;
}
...
void Function_551() //Position: 0x10319 / 66329
{
	...
	if (IS_LAYOUTREF_VALID(bVar0))
	{
		...
		{
			NET_LOG(true, "Lobby Cleanup", "Destroyed a minecart named: %s", GET_OBJECT_NAME(bVar3), false, false, false);
...
bool Function_554(int iParam0, int iParam1) //Position: 0x104CF / 66767
{
	struct<657> Var0;
...
var Function_556() //Position: 0x10516 / 66838
{
	...
	while (!bVar0)
	{
		...
		if (Function_500(bVar1))
		{
			bVar0 = !Function_554(bVar1, 4);
		}
	}
	return bVar1;
}
...
void Function_558(bool bParam0) //Position: 0x10586 / 66950
{
	if (IS_OBJECTSET_VALID(bParam0))
	{
...
var Function_568(bool bParam0) //Position: 0x10A85 / 68229
{
	bool bVar0;
...
{
	NET_LOG(true, "Lobby State", "Moving to: %s (%s)", Function_581(bParam0), I2STR(bParam0), false, false);
...
bool Function_582(bool bParam0) //Position: 0x112D7 / 70359
{
	bool bVar0;
...
var Function_585(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x1147C / 70780
{
	int iVar0;
	var uVar1;
