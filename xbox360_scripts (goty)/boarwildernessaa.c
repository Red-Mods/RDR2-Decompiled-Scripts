...
{
	if (!Function_156(&vLocal_99, &bLocal_126, 20424, 1, 0))
	{
		return 0;
	}
	switch (vLocal_99.y)
		...
		case 0x00000000:
			...
			if (NET_IS_HOST_OF_THIS_SCRIPT())
			{
				if ((&vLocal_99 + 16)->f_32)
				{
					Function_119(1, "a");
					Function_112(0, "C");
					Function_109("AM_MH_9_boar_help", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
...
void Function_112(char* cParam0, bool bParam1) //Position: 0x2496 / 9366
{
	...
	{
		case 0x00000003:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1075, "boar_boar_01", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1074, "boar_boar_02", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1073, "boar_boar_03", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1076, "boar_boar_04", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1075, "boar_boar_05", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1074, "boar_boar_06", fVar3, fVar4);
		
		case 0x00000002:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1076, "boar_boar_10", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1074, "boar_boar_11", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1076, "boar_boar_12", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1075, "boar_boar_13", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1076, "boar_boar_14", fVar3, fVar4);
		
		case 0x00000001:
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1076, "boar_boar_18", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1074, "boar_boar_19", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1075, "boar_boar_20", fVar3, fVar4);
			Function_113(StackVal, StackVal, cParam0, bParam1, vVar0, 1073, "boar_boar_21", fVar3, fVar4);
			break;
	}
	return;
}

void Function_113(var uParam0, char* cParam1, vector3 vParam2, var uParam5, char* cParam6, float fParam7, float fParam8) //Position: 0x26CD / 9933
{
	char* cVar0[32];
	var uVar8;
...
void Function_114(bool bParam0, int iParam1) //Position: 0x26FB / 9979
{
	if (IS_ACTOR_VALID(bParam0))
	{
...
void Function_115(bool bParam0, bool bParam1) //Position: 0x271E / 10014
{
	switch (bParam1)
	{
		case 0x00000000:
		...
		case 0x00000001:
			SQUAD_JOIN(bParam0, bLocal_133);
			SET_ACTOR_MAX_HEALTH(bParam0, 275.0f);
			SET_ACTOR_HEALTH(bParam0, 275.0f);
...
var Function_116(vector3 vParam0, var uParam3, bool bParam4, bool bParam5, float fParam6, bool bParam7) //Position: 0x27B7 / 10167
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool Function_117(vector3 vParam0) //Position: 0x2843 / 10307
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_118() //Position: 0x285B / 10331
{
	int iVar0;
	int iVar1;
...
void Function_119(char* cParam0, int iParam1) //Position: 0x288A / 10378
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 25.0f;
	fVar4 = 75.0f;
	Function_113(StackVal, StackVal, cParam0, iParam1, vVar0, 1077, "named_boar_01", fVar3, fVar4);
	return;
}

void Function_120(var uParam0, bool bParam1) //Position: 0x28D3 / 10451
{
	struct<9> Var0;
...
void Function_121() //Position: 0x290A / 10506
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
...
void Function_122(int iParam0) //Position: 0x29C2 / 10690
{
	var uVar0;
	
	uVar0 = iParam0;
	NET_SCRIPTMSG_SEND(3, 96, &uVar0, 1, 1);
	return;
}

int Function_123(int iParam0) //Position: 0x29D7 / 10711
{
...
void Function_124(bool bParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x29FF / 10751
{
	bool bVar0;
	bool bVar1;
...
void Function_125() //Position: 0x2A81 / 10881
{
	switch (vLocal_99.z)
	{
		case 0x00000000:
...
void Function_126(var uParam0, int iParam1) //Position: 0x2B2C / 11052
{
	bool bVar0;
	bool bVar1;
...
void Function_127() //Position: 0x2BC8 / 11208
{
	int iVar0;
	...
	switch (vLocal_99.z)
	{
		...
		case 0x00000006:
			bLocal_126 = CREATE_LAYOUT("boarWilderness");
			Function_134(&vLocal_99, bLocal_126);
			Function_133();
			Global_78480.f_24 = 4294967294;
			Function_51(256);
			iVar0 = 11891;
			NET_SCRIPTMSG_REGISTER_HANDLER(96, iVar0);
			vLocal_99.f_8 = 106;
			break;
...
void Function_128(var uParam0) //Position: 0x2C5E / 11358
{
	uParam0->f_8 = 0;
	if (uParam0->f_16 != 0)
	{
...
void Function_131(int iParam0) //Position: 0x2DDE / 11742
{
...
void Function_132(var uParam0) //Position: 0x2E73 / 11891
{
	int iVar0;
...
void Function_133() //Position: 0x2E99 / 11929
{
	bLocal_133 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(bLocal_126, "squad_boar"));
...
void Function_134(var uParam0, bool bParam1) //Position: 0x2EDF / 11999
{
...
void Function_135(int iParam0) //Position: 0x2F50 / 12112
{
	Function_43(&Global_78617 + 52, iParam0);
	return;
}

void Function_136(var uParam0) //Position: 0x2F61 / 12129
{
	Global_83591.f_140 = uParam0;
	return;
}

bool Function_137() //Position: 0x2F6F / 12143
{
	if (!IS_EXITFLAG_SET())
	{
...
bool Function_138(int iParam0) //Position: 0x2F88 / 12168
{
	int iVar0;
	int iVar1;
...
void Function_139() //Position: 0x3303 / 13059
{
	if (!Function_140(128))
	{
		return;
...
bool Function_140(int iParam0) //Position: 0x3343 / 13123
{
	int iVar0;
...
bool Function_141() //Position: 0x335F / 13151
{
	int iVar0;
...
void Function_142(var uParam0, int iParam1) //Position: 0x338A / 13194
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_143() //Position: 0x339B / 13211
{
	if (!Function_140(128))
	{
		return;
...
void Function_144() //Position: 0x33DD / 13277
{
	Function_145(&uLocal_128, "mp_action_areas", 10, 0);
	return;
}

var Function_145(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x33FE / 13310
{
	int iVar0;
	var uVar1;
...
var Function_146(var uParam0, int iParam1, int iParam2) //Position: 0x3436 / 13366
{
	int iVar0;
...
bool Function_147(int iParam0) //Position: 0x34FA / 13562
{
	switch (iLocal_98)
	{
		case 0x00000000:
...
bool Function_148(int iParam0) //Position: 0x35A6 / 13734
{
...
void Function_149(int iParam0) //Position: 0x35BC / 13756
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
bool Function_150(int iParam0) //Position: 0x35D0 / 13776
{
	if (Function_67(iParam0))
	{
...
float Function_151(float fParam0) //Position: 0x35EB / 13803
{
	return -Function_63(fParam0);
}

bool Function_152() //Position: 0x35F7 / 13815
{
	return iLocal_20;
}

void Function_153() //Position: 0x35FF / 13823
{
	struct<13> Var0;
...
void Function_154(bool bParam0) //Position: 0x362B / 13867
{
	struct<17> Var0;
	...
	Function_54(&Var0);
	Function_55();
	NET_SCRIPTMSG_REGISTER_HANDLER(14, 13949);
	return;
}

void Function_155(var uParam0) //Position: 0x367D / 13949
{
	struct<5> Var0;
	int iVar7;
	bool bVar8;
...
bool Function_156(var uParam0, var uParam1, var uParam2, bool bParam3, var uParam4) //Position: 0x3780 / 14208
{
	if (!Function_206())
	{
		return 0;
	...
	switch (iLocal_17)
	{
		case 0x00000000:
		case 0x00000003:
			Function_174(18444, 17792);
			break;
		
		case 0x00000002:
			Function_174(15136, 14407);
			break;
...
int Function_157(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x3847 / 14407
{
	bool bVar0;
	bool bVar1;
...
int Function_158(int iParam0) //Position: 0x38EA / 14570
{
	return Function_159(0, iParam0);
}

int Function_159(int iParam0, bool bParam1) //Position: 0x38F6 / 14582
{
	char* cVar0[64];
...
bool Function_160(bool bParam0) //Position: 0x395D / 14685
{
	char* cVar0[64];
...
var Function_161(int iParam0) //Position: 0x39FE / 14846
{
	return (*&Global_78480 + 132)[iParam0];
}

bool Function_162(bool bParam0, bool bParam1, int iParam2) //Position: 0x3A0E / 14862
{
	var uVar0;
...
int Function_163(bool bParam0, int iParam1, var uParam2, bool bParam3) //Position: 0x3A1F / 14879
{
	char* cVar0[32];
...
int Function_164(int iParam0, bool bParam1) //Position: 0x3A84 / 14980
{
	char* cVar0[64];
...
void Function_165(bool bParam0, int iParam1, char* cParam2) //Position: 0x3AF2 / 15090
{
	if (bParam0)
	{
		if (Function_166())
...
bool Function_166() //Position: 0x3B13 / 15123
{
	return Function_39(32768);
}

int Function_167() //Position: 0x3B20 / 15136
{
	if (!Function_168(1))
	{
		return 0;
...
bool Function_168(bool bParam0) //Position: 0x3BDC / 15324
{
	char* cVar0[64];
...
void Function_169(bool bParam0) //Position: 0x3C5D / 15453
{
...
var Function_170(int iParam0, bool bParam1) //Position: 0x3CE6 / 15590
{
	int iVar0;
...
struct<64> Function_171(var uParam0) //Position: 0x3D06 / 15622
{
...
struct<64> Function_172(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0x3D1A / 15642
{
	char* cVar0[64];
...
int Function_173(bool bParam0, bool bParam1) //Position: 0x3D5F / 15711
{
...
void Function_174(int iParam0, int iParam1) //Position: 0x3D93 / 15763
{
	Function_175(iParam0, iParam1, 17785);
	return;
}

void Function_175(var uParam0, var uParam1, int iParam2) //Position: 0x3DA4 / 15780
{
...
void Function_176() //Position: 0x3F3D / 16189
{
	if (Function_39(4194304))
	{
...
void Function_177(var uParam0, var uParam1, int iParam2) //Position: 0x404D / 16461
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_178(bool bParam0, int iParam1, bool bParam2) //Position: 0x41C5 / 16837
{
	char* cVar0[64];
	int iVar16;
...
var Function_179(int iParam0) //Position: 0x4246 / 16966
{
	switch (iParam0)
	{
		case 0x00000002:
...
void Function_180(bool bParam0) //Position: 0x455F / 17759
{
	NET_PLAYER_LIST_RESET();
	if (bParam0)
	{
...
int Function_181() //Position: 0x4579 / 17785
{
	return 1;
}

int Function_182(bool bParam0, bool bParam1, int iParam2, char* cParam3) //Position: 0x4580 / 17792
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
var Function_183(int iParam0) //Position: 0x4741 / 18241
{
	*iParam0++;
	return (*iParam0 - 1);
}

int Function_184(int iParam0) //Position: 0x4754 / 18260
{
...
float Function_185(int iParam0, bool bParam1) //Position: 0x4774 / 18292
{
	char* cVar0[64];
...
int Function_186(bool bParam0) //Position: 0x47DD / 18397
{
	if (!Function_160(bParam0))
	{
		return 4294967295;
...
var Function_187() //Position: 0x4802 / 18434
{
	return Global_78480;
}

int Function_188() //Position: 0x480C / 18444
{
	bool bVar0;
	int iVar1;
...
void Function_189() //Position: 0x492F / 18735
{
	if (Function_39(4096))
	{
...
void Function_190(int iParam0) //Position: 0x496C / 18796
{
	int iVar0;
	int iVar1;
...
void Function_191(int iParam0) //Position: 0x49E5 / 18917
{
	struct<13> Var0;
...
void Function_192(int iParam0) //Position: 0x4A10 / 18960
{
	int iVar0;
...
void Function_193(var uParam0, bool bParam1) //Position: 0x4A57 / 19031
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_194(bool bParam0) //Position: 0x4BA2 / 19362
{
	vector3 vVar0;
...
int Function_195(bool bParam0, bool bParam1, var uParam2, bool bParam3) //Position: 0x4BB3 / 19379
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_196(bool bParam0) //Position: 0x4C95 / 19605
{
	bool bVar0;
...
void Function_197() //Position: 0x4CEF / 19695
{
	Function_198(4);
	return;
}

void Function_198(int iParam0) //Position: 0x4CF9 / 19705
{
	var uVar0;
	var uVar1;
...
void Function_199(var uParam0) //Position: 0x4D2B / 19755
{
	var uVar0;
...
void Function_200() //Position: 0x4D3A / 19770
{
	bool bVar0;
...
void Function_201() //Position: 0x4D6F / 19823
{
	int iVar0;
...
bool Function_202(bool bParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x4D88 / 19848
{
	bool bVar0;
...
bool Function_203(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5) //Position: 0x4DF1 / 19953
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
int Function_204(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x4EDE / 20190
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int Function_205(int iParam0) //Position: 0x4F8C / 20364
{
	if (iParam0 > 40)
	{
		return 0;
...
bool Function_206() //Position: 0x4FA5 / 20389
{
	int iVar0;
...
void Function_207(bool bParam0) //Position: 0x4FC8 / 20424
{
	Function_115(bParam0, NET_ACTOR_GET_SCRIPT_INT(bParam0));
	return;
}

bool Function_208(int iParam0) //Position: 0x4FD8 / 20440
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	NET_SCRIPTMSG_REGISTER_HANDLER(77, 20757);
	NET_SCRIPTMSG_REGISTER_HANDLER(80, 20718);
	return 1;
}

void Function_209(var uParam0) //Position: 0x50EE / 20718
{
	int iVar0;
...
void Function_210(var uParam0) //Position: 0x5115 / 20757
{
	struct<13> Var0;
...
void Function_211(var uParam0) //Position: 0x518C / 20876
{
	struct<13> Var0;
...
void Function_212(var uParam0, int iParam1) //Position: 0x51D9 / 20953
{
	bool bVar0;
	int iVar1;
...
void Function_213(int iParam0) //Position: 0x522E / 21038
{
	Function_43(&Global_83864 + 1252, iParam0);
	return;
}

void Function_214(int iParam0) //Position: 0x5240 / 21056
{
...
void Function_215() //Position: 0x5304 / 21252
{
	Global_76939.f_12 = 0;
	Global_76939.f_8 = 0;
	Global_76939 = 0.0f;
...
void Function_216(bool bParam0, bool bParam1) //Position: 0x531D / 21277
{
	var uVar0;
...
void Function_217() //Position: 0x5369 / 21353
{
...
void Function_218(int iParam0, bool bParam1) //Position: 0x5388 / 21384
{
	if (bParam1)
	{
...
void Function_219(int iParam0, var uParam1) //Position: 0x53C3 / 21443
{
	if (iParam0 > 40)
	{
		return;
...
void Function_220() //Position: 0x53DD / 21469
{
	Function_221(&Global_78480 + 220);
	return;
}

void Function_221(int iParam0) //Position: 0x53EC / 21484
{
	int iVar0;
...
void Function_222(int iParam0) //Position: 0x540D / 21517
{
	int iVar0;
...
void Function_223(int iParam0) //Position: 0x5431 / 21553
{
	int iVar0;
...
void Function_224() //Position: 0x5455 / 21589
{
...
void Function_225(bool bParam0) //Position: 0x54B5 / 21685
{
...
void Function_226(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x54CF / 21711
{
	char* cVar0[24];
	char* cVar6[24];
	char* cVar12[16];
...
void Function_227(var uParam0, int iParam1) //Position: 0x5586 / 21894
{
	bool bVar0;
...
bool Function_228(int iParam0, bool bParam1) //Position: 0x55AB / 21931
{
	return Function_40(Global_50170[iParam022].f_32, bParam1);
}

struct<16> Function_229(int iParam0) //Position: 0x55BF / 21951
{
	char* cVar0[16];
...
var Function_230(int iParam0) //Position: 0x55F3 / 22003
{
	return Global_50170[iParam022].f_24;
}

void Function_231() //Position: 0x5602 / 22018
{
	int iVar0;
...
void Function_232(var uParam0, int iParam1) //Position: 0x562C / 22060
{
	uParam0->f_96 = iParam1;
	return;
}

void Function_233(var uParam0) //Position: 0x5638 / 22072
{
	uParam0 = uParam0;
	return;
}

void Function_234(int iParam0) //Position: 0x5642 / 22082
{
	if (!Function_67(iParam0))
	{
...
bool Function_235(var uParam0, bool bParam1) //Position: 0x5657 / 22103
{
	float fVar0;
	int iVar1;
	bool bVar2;
...
int Function_236(char* cParam0) //Position: 0x570A / 22282
{
	bool bVar0;
