...
void main() //Position: 0x0 / 0
{
	...
	uVar2 = Function_27("ped_workerN", 0);
	Function_24(&uVar2, 170, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 171, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 38, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 39, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 172, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 173, 8.0f, 16, 0, 0);
	Function_24(&uVar2, 174, 8.0f, 16, 0, 0);
	...
	if (!Function_22())
	{
		if (Global_25974[0])
		{
			if (Function_21(22, 0))
			{
				uVar4 = Function_27("nped_poker", 0);
				Function_20(&uVar4, 37, 1.0f, 0, 0);
				Function_20(&uVar4, 39, 1.0f, 0, 0);
				Function_20(&uVar4, 87, 1.0f, 0, 0);
				Function_20(&uVar4, 167, 1.0f, 0, 0);
				Function_20(&uVar4, 550, 1.0f, 0, 0);
				Function_20(&uVar4, 438, 1.0f, 0, 0);
			}
			else
			{
				uVar4 = Function_27("nped_poker", 0);
		...
		if (Global_25974[5])
		{
			uVar5 = Function_27("ped_horseshoes", 0);
			Function_20(&uVar5, 107, 1.0f, 0, 0);
			Function_20(&uVar5, 35, 1.0f, 0, 0);
			Function_20(&uVar5, 85, 1.0f, 0, 0);
			Function_20(&uVar5, 212, 1.0f, 0, 0);
		}
	}
	...
	uVar6 = Function_27("ped_dayTraveller", 0);
	Function_24(&uVar6, 87, 8.0f, 30, 0, 0);
	Function_24(&uVar6, 89, 8.0f, 30, 0, 0);
	Function_24(&uVar6, 90, 8.0f, 30, 0, 0);
	Function_24(&uVar6, 52, 8.0f, 30, 0, 0);
	Function_24(&uVar6, 54, 8.0f, 30, 0, 0);
	...
	uVar7 = Function_27("bulls", 0);
	Function_20(&uVar7, 1012, 100.0f, 0, 0);
	...
	uVar8 = Function_27("chickens", 0);
	Function_24(&uVar8, 1015, 100.0f, 15, 0, 0);
	Function_24(&uVar8, 1016, 100.0f, 15, 0, 0);
	uVar9 = Function_27("dogs", 0);
	Function_20(&uVar9, 1037, 100.0f, 0, 0);
	Function_20(&uVar9, 1038, 100.0f, 0, 0);
	Function_20(&uVar9, 1039, 100.0f, 0, 0);
	uVar10 = Function_27("nped_women", 0);
	Function_24(&uVar10, 73, 100.0f, 15, 0, 0);
	Function_24(&uVar10, 74, 100.0f, 15, 0, 0);
	Function_24(&uVar10, 56, 100.0f, 15, 0, 0);
	Function_24(&uVar10, 55, 100.0f, 15, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, uVar2, 1, 2, 1, 0, 1);
		}
		else
		{
		...
		if (!Function_22())
		{
			if (Global_25974[0])
			{
				...
				bVar15 = Function_7(bVar13, uVar4, 5, 1, 0, 0);
			...
			if (Global_25974[5])
			{
				...
				bVar16 = Function_7(bVar13, uVar5, 1, 1, 1, 0);
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, uVar8, 4, 6, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, uVar8, 2, 4, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("hen_pop: Cannot find henv_pop_chickens_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_7(bVar13, uVar10, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_7(bVar13, uVar7, 1, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, uVar9, 1, 1, 1, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, var uParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x19D3 / 6611
{
	bool bVar0;
...
var Function_7(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1AC1 / 6849
{
	bool bVar0;
...
var Function_8(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1B41 / 6977
{
	bool bVar0;
...
bool Function_21(int iParam0, bool bParam1) //Position: 0x1D87 / 7559
{
	int iVar0;
...
bool Function_22() //Position: 0x1DC4 / 7620
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_23(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1DCD / 7629
{
	int iVar0;
	int iVar1;
...
var Function_24(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1E12 / 7698
{
	int iVar0;
	int iVar1;
...
var Function_25(int iParam0) //Position: 0x1E8A / 7818
{
	int iVar0;
...
var Function_26(int iParam0) //Position: 0x1EF6 / 7926
{
	int iVar0;
...
var Function_27(bool bParam0, int iParam1) //Position: 0x1F62 / 8034
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_28(bool bParam0, var uParam1) //Position: 0x1F6F / 8047
{
	if (!Function_9(128))
	{
		return;
