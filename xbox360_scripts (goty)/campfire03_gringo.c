...
void Function_60(bool bParam0, bool bParam1) //Position: 0x2FE3 / 12259
{
	var uVar0;
...
var Function_61(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x3025 / 12325
{
	int iVar0;
	int iVar1;
...
void Function_62(var uParam0, int iParam1) //Position: 0x305D / 12381
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_63(var uParam0, int iParam1, int iParam2) //Position: 0x306E / 12398
{
	int iVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3132 / 12594
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_65(int iParam0) //Position: 0x317B / 12667
{
	int iVar0;
	int iVar1;
...
void Function_66() //Position: 0x34F6 / 13558
{
	if (!Function_119(128))
	{
		return;
...
bool Function_67() //Position: 0x3536 / 13622
{
	int iVar0;
...
void Function_68() //Position: 0x3561 / 13665
{
	if (!Function_119(128))
	{
		return;
...
void Function_69(int iParam0, bool bParam1) //Position: 0x35A3 / 13731
{
	char* cVar0[32];
...
void Function_70(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x3627 / 13863
{
	var uVar0;
	var uVar1;
...
void Function_71(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x3650 / 13904
{
...
var Function_72(var uParam0, bool bParam1) //Position: 0x36A1 / 13985
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_73() //Position: 0x36B1 / 14001
{
	return "PackedGrass";
}

var Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x36C5 / 14021
{
	int iVar0;
...
var Function_75() //Position: 0x36EA / 14058
{
	return "PackedMetadata";
}

void Function_76(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x3701 / 14081
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_77() //Position: 0x382C / 14380
{
	return 0.0f, 0.101f, -0.195f;
}

vector3 Function_78() //Position: 0x383D / 14397
{
	return 0.0f, 0.127f, -0.177f;
}

vector3 Function_79() //Position: 0x384E / 14414
{
	return 0.0f, 0.158f, -0.163f;
}

void Function_80(var uParam0, int iParam1) //Position: 0x385F / 14431
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3882 / 14466
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x38A1 / 14497
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x38AD / 14509
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x38B8 / 14520
{
	int iVar0;
...
var Function_85() //Position: 0x38E6 / 14566
{
	return "PackedWeapon";
}

int Function_86(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x38FB / 14587
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_87() //Position: 0x39FF / 14847
{
	return "MPItemGiver";
}

struct<32> Function_88(bool bParam0) //Position: 0x3A13 / 14867
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3A7D / 14973
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3A9C / 15004
{
	return "PBox_";
}

var Function_91() //Position: 0x3AAA / 15018
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3AD0 / 15056
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3AF8 / 15096
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3B1E / 15134
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3C7F / 15487
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3D1A / 15642
{
	int iVar0;
	vector3 vVar1;
...
var Function_98() //Position: 0x3EDC / 16092
{
	int iVar0;
...
var Function_99(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3EE4 / 16100
{
	return Function_100(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_100(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x3EFD / 16125
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_101(int iParam0) //Position: 0x41F2 / 16882
{
	int iVar0;
...
void Function_102() //Position: 0x42A6 / 17062
{
	int iVar0;
...
bool Function_103(bool bParam0) //Position: 0x42E0 / 17120
{
	int iVar0;
...
void Function_104(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x430D / 17165
{
	int iVar0;
...
bool Function_105(bool bParam0) //Position: 0x445E / 17502
{
...
void Function_106() //Position: 0x4475 / 17525
{
	int iVar0;
...
var Function_107(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x44C0 / 17600
{
	int iVar0;
...
int Function_108() //Position: 0x4590 / 17808
{
	int iVar0;
...
int Function_109() //Position: 0x46EC / 18156
{
	int iVar0;
...
bool Function_110(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x480C / 18444
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_111(var uParam0, int iParam1) //Position: 0x48DC / 18652
{
	vector3 vVar0;
	int iVar3;
...
bool Function_112(var uParam0, float fParam1, int iParam2, int iParam3) //Position: 0x48FA / 18682
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
float Function_113(bool bParam0, vector3 vParam1) //Position: 0x4A2C / 18988
{
	vector3 vVar0;
...
bool Function_114(char* cParam0) //Position: 0x4AA6 / 19110
{
	bool bVar0;
...
int Function_115() //Position: 0x4AC5 / 19141
{
	if (Function_117())
	{
...
int Function_116() //Position: 0x4ADE / 19166
{
	return Global_79349.f_16;
}

bool Function_117() //Position: 0x4AEA / 19178
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_118(int iParam0, bool bParam1, bool bParam2) //Position: 0x4AF3 / 19187
{
	var uVar0;
...
bool Function_119(int iParam0) //Position: 0x4B70 / 19312
{
	int iVar0;
