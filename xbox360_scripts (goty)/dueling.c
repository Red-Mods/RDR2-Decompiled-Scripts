...
void main() //Position: 0x0 / 0
{
	...
	{
		iLocal_162 = RAND_INT_RANGE(0, true);
	}
	else
	{
		iLocal_162 = RAND_INT_RANGE(0, 2);
	}
	Function_278(&ScriptParam_0 + 60, ScriptParam_0.f_40, !IS_ACTOR_ALIVE(ScriptParam_0.f_44), ScriptParam_0);
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iVar4)
		{
			...
			case 0x00000002:
				if (Function_235(&ScriptParam_0) || Function_226(&uVar12) < 2.0f)
				{
					iVar4 = 3;
				}
				break;
			...
			case 0x00000005:
				...
				else
				{
					...
					if (Function_195(StackVal, &iVar15, &bVar9, ScriptParam_0, !ScriptParam_0.f_36))
					{
						if (ScriptParam_0.f_92 && DECOR_CHECK_EXIST(ScriptParam_0, "unpauseduel"))
						{
...
struct<32> Function_17(char* cParam0, bool bParam1) //Position: 0x16CC / 5836
{
	char* cVar0[32];
...
void Function_27(var uParam0, int iParam1) //Position: 0x1D01 / 7425
{
	switch (Function_189())
	{
		case 0x0000138A:
			Function_118(Function_184(GET_ACTOR_ENUM(*uParam0), 6, 4), (!Global_3380 && !Function_183()), 1, 1, 0);
			DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(*uParam0), "iDuelResult", 5002);
			MEMORY_CLEAR_ALL(StackVal);
			SET_ACTOR_FACE_STYLE(StackVal, 2);
			SET_ACTOR_ALLOW_WEAPON_REACTIONS(StackVal, 0);
			...
			if (!Global_3380 && !(((Function_117(48) || Function_117(74)) || Function_117(51)) || Function_117(67)))
			{
...
void Function_28(int iParam0, int iParam1) //Position: 0x1F05 / 7941
{
	if (!Function_96(3))
	{
		return;
...
bool Function_29(int iParam0) //Position: 0x2017 / 8215
{
...
bool Function_30(int iParam0, int iParam1) //Position: 0x2068 / 8296
{
	int iVar0;
...
bool Function_31(int iParam0) //Position: 0x2095 / 8341
{
...
bool Function_32(int iParam0) //Position: 0x20AB / 8363
{
	if (!Function_31(iParam0))
	{
...
void Function_33(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x20FD / 8445
{
	char* cVar0[32];
	struct<8> Var8;
	...
	if (!Function_30(bParam0, 2))
	{
		...
		if (!bParam2)
		{
			...
			stradd(&Var8, "_tip", 32);
			Function_91(&Var8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_90(bParam0, bParam1))
	{
		Global_27774[bParam013].f_4 = (StackVal || bParam1);
		Function_93(bParam0, 1048576);
		if (bParam4)
		{
		...
		Function_55(bParam0);
		if (StackVal && !Function_53(((((!Function_54() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_53((((Function_54() || Global_3380) || Global_3392) || Global_3384), 1))
		{
...
void Function_34(int iParam0, bool bParam1) //Position: 0x2393 / 9107
{
	bool bVar0;
...
void Function_35(int iParam0, bool bParam1) //Position: 0x23FA / 9210
{
...
void Function_36() //Position: 0x2465 / 9317
{
...
var Function_37(int iParam0, int iParam1) //Position: 0x24E0 / 9440
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_38(vector3 vParam0) //Position: 0x30D1 / 12497
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_39(int iParam0) //Position: 0x30E9 / 12521
{
...
int Function_40(int iParam0, bool bParam1) //Position: 0x30FE / 12542
{
	int iVar0;
...
bool Function_41(int iParam0) //Position: 0x313B / 12603
{
...
int Function_42(int iParam0) //Position: 0x3152 / 12626
{
...
bool Function_43(int iParam0) //Position: 0x316C / 12652
{
...
int Function_44(int iParam0) //Position: 0x3182 / 12674
{
	int iVar0;
	int iVar1;
...
void Function_45(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x31D1 / 12753
{
	bool bVar0;
	char* cVar1[16];
...
void Function_46(char* cParam0, int iParam1) //Position: 0x323D / 12861
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_47(bool bParam0, var uParam1, int iParam2) //Position: 0x3274 / 12916
{
	var uVar0;
	char* cVar1[16];
...
int Function_48(char* cParam0) //Position: 0x32EC / 13036
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_49(int iParam0) //Position: 0x338D / 13197
{
	int iVar0;
	int iVar1;
...
void Function_50(int iParam0, int iParam1) //Position: 0x33CA / 13258
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_51(int iParam0, int iParam1) //Position: 0x33DD / 13277
{
...
bool Function_52() //Position: 0x33F0 / 13296
{
	if (Function_53(Global_83864.f_1252, 1024))
	{
...
bool Function_53(bool bParam0, bool bParam1) //Position: 0x340B / 13323
{
	return (bParam0 && bParam1) == 0;
}

bool Function_54() //Position: 0x3418 / 13336
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_55(bool bParam0) //Position: 0x3445 / 13381
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (!IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 0) && !IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 1))
	{
		...
		while (bVar24 <= Global_27774[bParam013].f_28)
		{
			...
			if (Function_90(bParam0, Function_59(bVar24)))
			{
	...
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_58(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), 0, 0);
		Function_57(Global_27774[bParam013].f_48, 0);
		straddi(&cVar8, Function_56(bParam0), 32);
		SET_JOURNAL_ENTRY_CURRENT_OBJECTIVE(Global_27774[bParam013].f_48, &cVar8, 3);
	}
	return;
}

int Function_56(int iParam0) //Position: 0x35F5 / 13813
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_57(var uParam0, int iParam1) //Position: 0x364C / 13900
{
	bool bVar0;
...
var Function_58(int iParam0) //Position: 0x3671 / 13937
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_59(bool bParam0) //Position: 0x36C7 / 14023
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_60() //Position: 0x36D3 / 14035
{
	return;
}

void Function_61(bool bParam0, int iParam1) //Position: 0x36D9 / 14041
{
	if (Global_3381)
	{
		return;
...
void Function_62(bool bParam0) //Position: 0x371B / 14107
{
...
void Function_63() //Position: 0x376C / 14188
{
	Function_77();
	Function_76();
	Function_76();
...
void Function_64() //Position: 0x37BE / 14270
{
...
void Function_65() //Position: 0x38C4 / 14532
{
	float fVar0;
...
void Function_66() //Position: 0x38F7 / 14583
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_67() //Position: 0x3A85 / 14981
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x3C39 / 15417
{
	Function_69(&Global_28260, 1, 0);
	return;
}

void Function_69(int iParam0, bool bParam1, var uParam2) //Position: 0x3C47 / 15431
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_70() //Position: 0x3E38 / 15928
{
...
struct<8> Function_71(int iParam0) //Position: 0x3E4D / 15949
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_72(int iParam0, bool bParam1, bool bParam2) //Position: 0x3EF3 / 16115
{
	int iVar0;
...
int Function_73(bool bParam0) //Position: 0x41CB / 16843
{
...
struct<8> Function_74() //Position: 0x420C / 16908
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_75() //Position: 0x4295 / 17045
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_76() //Position: 0x432C / 17196
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_77() //Position: 0x43AB / 17323
{
...
int Function_78(int iParam0, bool bParam1, int iParam2) //Position: 0x43E4 / 17380
{
	int iVar0;
	int iVar1;
...
void Function_79() //Position: 0x45EE / 17902
{
	vector3 vVar0;
	var uVar3;
	...
	if (Function_52())
	{
		Function_86(&Global_34165 + 12, &Global_34165 + 16);
		vVar0 = { StackVal, StackVal, Function_86(&Global_34165 + 12, &Global_34165 + 16) };
	}
	else
	{
...
vector3 Function_80(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x46A9 / 18089
{
	int iVar0;
	
	iVar0 = Function_84(uParam2, uParam3);
...
vector3 Function_81() //Position: 0x4790 / 18320
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_82(var uParam0, int iParam1) //Position: 0x4799 / 18329
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_83(int iParam0) //Position: 0x47A8 / 18344
{
...
int Function_84(bool bParam0, bool bParam1) //Position: 0x47BE / 18366
{
	bool bVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar3 <= Global_16537)
	{
		if (((Global_16537[iVar321].f_40 != 3 || Global_16537[iVar321].f_40 != 4) || (iVar3 != 15 && !bParam0)) && (Global_16537[iVar321].f_52 != Global_29004 || bParam1))
		{
			...
			{
				fVar2 = Function_85(StackVal, StackVal, StackVal, StackVal, Global_34574, Global_16537[iVar321]);
				if (fVar2 > fVar1)
				{
					fVar1 = fVar2;
					bVar0 = iVar3;
	...
	if (Global_16875)
	{
		fVar2 = Function_85(StackVal, StackVal, Global_34574, -2833.843f, 50.332f, 2418.003f);
		if (fVar2 > fVar1)
		{
			return 4294967295;
		}
	}
	if (!Function_83(bVar0) && !bParam1)
	{
		bVar0 = Function_84(bParam0, 1);
	}
	return bVar0;
}

float Function_85(vector3 vParam0, vector3 vParam3) //Position: 0x4885 / 18565
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_86(var uParam0, int iParam1) //Position: 0x48A2 / 18594
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	*uParam0 = *uParam0;
	...
	Function_88(Global_34573, &vVar4);
	if (!Function_87(Global_30640[0]))
	{
...
bool Function_87(int iParam0) //Position: 0x50C7 / 20679
{
	var uVar0;
	
	uVar0 = Global_29008[iParam0];
	return (((Function_53(uVar0, 0x1000000) || Function_53(uVar0, 0x2000000)) || Function_53(uVar0, 0x4000000)) || !Function_53(uVar0, 0x10000000));
}

void Function_88(bool bParam0, int iParam1) //Position: 0x5102 / 20738
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_89(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x510F / 20751
{
	iParam0 = iParam0;
...
bool Function_90(bool bParam0, int iParam1) //Position: 0x51B3 / 20915
{
	int iVar0;
...
void Function_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x5212 / 21010
{
	struct<4> Var0;
	var uVar4;
...
struct<16> Function_92(int iParam0) //Position: 0x528D / 21133
{
	char* cVar0[16];
...
void Function_93(bool bParam0, int iParam1) //Position: 0x52CC / 21196
{
	if (!Function_31(bParam0))
	{
...
bool Function_94() //Position: 0x5321 / 21281
{
	if (IS_STRING_VALID(UI_GET_STRING("HAS_GET_GAME_EDITION")))
	{
		return Function_53(GET_GAME_EDITION(), 16);
	}
	return 0;
}

bool Function_95() //Position: 0x5351 / 21329
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_96(int iParam0) //Position: 0x535A / 21338
{
...
void Function_97(int iParam0, bool bParam1, bool bParam2) //Position: 0x5376 / 21366
{
	int iVar0;
	bool bVar1;
	...
	switch (Global_12976.f_152)
	{
		case 0x00000000:
			if (iVar0 >= 4294962796)
			{
				...
				Function_99(2, Function_105(Global_12976.f_152), 1);
			}
			break;
		...
		case 0x00000001:
			if (iVar0 < 4294962796)
			{
				...
				Function_99(2, Function_105(Global_12976.f_152), 0);
...
void Function_98(int iParam0, int iParam1) //Position: 0x5697 / 22167
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_99(int iParam0, char* cParam1, bool bParam2) //Position: 0x58F5 / 22773
{
	bool bVar0;
	int iVar1;
...
int Function_100() //Position: 0x5A7A / 23162
{
	int iVar0;
...
void Function_101() //Position: 0x5B19 / 23321
{
	int iVar0;
	int iVar1;
...
void Function_102(int iParam0) //Position: 0x5BC8 / 23496
{
...
int Function_103(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x5C26 / 23590
{
	int iVar0;
	var uVar1;
...
void Function_104(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0x5F78 / 24440
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
var Function_105(int iParam0) //Position: 0x5FFB / 24571
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_106(int iParam0, bool bParam1, int iParam2) //Position: 0x609E / 24734
{
	int iVar0;
	int iVar1;
...
int Function_107(int iParam0, bool bParam1) //Position: 0x6299 / 25241
{
	bool bVar0;
	int iVar1;
...
var Function_108(int iParam0, int iParam1) //Position: 0x6435 / 25653
{
	int iVar0;
...
int Function_109(int iParam0, bool bParam1) //Position: 0x6476 / 25718
{
	bool bVar0;
	int iVar1;
...
bool Function_110() //Position: 0x6613 / 26131
{
	if (IS_STRING_VALID(UI_GET_STRING("HAS_GET_GAME_EDITION")))
	{
...
var Function_111(int iParam0) //Position: 0x663E / 26174
{
	return (*&Global_12976 + 104)[iParam0];
}

void Function_112(int iParam0, bool bParam1, bool bParam2) //Position: 0x664D / 26189
{
	int iVar0;
	bool bVar1;
	...
	switch (Global_12976.f_156)
	{
		case 0x00000000:
			if (iVar0 > 1000)
			{
				...
				Function_99(4, Function_113(Global_12976.f_156), 1);
				Function_98(Global_12976.f_152, Global_12976.f_156);
			}
			break;
...
var Function_113(int iParam0) //Position: 0x681C / 26652
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_114() //Position: 0x68AB / 26795
{
	Function_116(3, 0.0f);
...
int Function_115(int iParam0, int iParam1) //Position: 0x68C1 / 26817
{
	if (iParam0 == 4294967295)
	{
...
int Function_116(int iParam0, int iParam1) //Position: 0x6901 / 26881
{
	if (iParam0 == 4294967295)
	{
...
bool Function_117(int iParam0) //Position: 0x6941 / 26945
{
...
void Function_118(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x6956 / 26966
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
void Function_119() //Position: 0x6A43 / 27203
{
	int iVar0;
...
void Function_120(int iParam0, bool bParam1) //Position: 0x6A73 / 27251
{
	int iVar0;
	int iVar1;
...
void Function_121(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6D6A / 28010
{
	bool bVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	{
		Global_6269 = Function_176(iParam0);
		Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_132(Global_6269) };
...
void Function_122(int iParam0, int iParam1) //Position: 0x6FBE / 28606
{
...
void Function_123(int iParam0) //Position: 0x6FF8 / 28664
{
	int iVar0;
	int iVar1;
...
bool Function_124(int iParam0) //Position: 0x74D4 / 29908
{
...
int Function_125(int iParam0) //Position: 0x74EA / 29930
{
	if (!Function_41(iParam0))
	{
		return 4294967295;
...
int Function_126(int iParam0) //Position: 0x7509 / 29961
{
	if (!Function_41(iParam0))
	{
		return 4294967295;
...
void Function_127(char* cParam0, int iParam1) //Position: 0x7523 / 29987
{
	struct<4> Var0;
	...
	switch (Function_177(iParam1))
	{
		case 0x00000001:
			...
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, &Var0, Function_177(iParam1), Function_176(iParam1));
			break;
		
		case 0x00000002:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "PROCEDURAL", Function_177(iParam1), iParam1);
			break;
		
		case 0x00000003:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "LOCATION", Function_177(iParam1), iParam1);
			break;
		
		case 0x00000004:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "MINIGAME", Function_177(iParam1), iParam1);
			break;
		
		case 0x00000005:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "ACTIONAREA_EVENT", Function_177(iParam1), iParam1);
			break;
		
		case 0x00000006:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "JOB", Function_177(iParam1), iParam1);
			break;
...
struct<16> Function_128(int iParam0) //Position: 0x7647 / 30279
{
	char* cVar0[16];
...
void Function_129() //Position: 0x7681 / 30337
{
...
void Function_130() //Position: 0x77D9 / 30681
{
	int iVar0;
	int iVar1;
	...
	if (!Function_43(iVar0) && Function_131(iVar1) < 0)
	{
		Function_72(24, Global_6269, 0);
		Function_103(24, &Global_3422[Global_626940] + 12, 0, 1);
	}
	else if (StackVal <= Function_131(Function_42(iVar0)))
	{
		Function_72(24, Global_6269, 0);
		Function_103(24, &Global_3422[Global_626940] + 12, 0, 1);
	}
...
int Function_131(int iParam0) //Position: 0x7859 / 30809
{
	if (!Function_135(iParam0))
	{
		return 4294967295;
...
struct<24> Function_132(char* cParam0) //Position: 0x7873 / 30835
{
	char* cVar0[24];
...
void Function_133() //Position: 0x7AC9 / 31433
{
	int iVar0;
	int iVar1;
	char* cVar2[64];
	...
	while (iVar0 <= Global_13172)
	{
		...
		{
			Function_134(Global_13172[iVar011], &iVar18, &iVar19, &iVar20);
...
void Function_134(bool bParam0, var uParam1, var uParam2, var uParam3) //Position: 0x7D10 / 32016
{
	*uParam3 = (bParam0 && 15);
...
bool Function_135(int iParam0) //Position: 0x7D39 / 32057
{
	if (!Function_41(iParam0))
	{
		return 0;
...
bool Function_136(int iParam0) //Position: 0x7D5D / 32093
{
...
void Function_137() //Position: 0x7D72 / 32114
{
	struct<73> Var0;
...
void Function_138(int iParam0, int iParam1, bool bParam2) //Position: 0x7DA0 / 32160
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!bParam2)
	{
		...
		{
			case 0x00000000:
				bVar0 = (Function_73(42) - Global_34165.f_116);
				bVar1 = (Function_73(27) - Global_34165.f_120);
			...
			case 0x00000001:
				...
				bVar3 = (Function_73(49) - Global_34165.f_128);
			...
			case 0x00000002:
				bVar4 = (Function_73(355) - Global_34165.f_116);
		...
		iVar15 = Function_139(iParam0, iVar14, Global_34165.f_140, bVar8, bVar0);
		if (iVar15 == 1)
		{
			Function_112(50, 1, 0);
			if (iVar14 == 0)
		...
		if (((Global_6269 != 11 || Global_6269 != 16) || Global_6269 != 15) || Global_6269 != 43)
		{
			Var16 = { StackVal, StackVal, StackVal, Function_92(iParam0) };
		}
...
int Function_139(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4) //Position: 0x803D / 32829
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_140(int iParam0) //Position: 0x8205 / 33285
{
	switch (iParam0)
	{
		case 0x00000002:
...
var Function_141() //Position: 0x829A / 33434
{
	struct<73> Var0;
...
void Function_142(int iParam0) //Position: 0x82BF / 33471
{
	if (!Function_43(iParam0))
	{
		return;
...
int Function_143(bool bParam0, bool bParam1) //Position: 0x877A / 34682
{
	bool bVar0;
...
void Function_144(int iParam0, var uParam1, bool bParam2) //Position: 0x8845 / 34885
{
	struct<4> Var0;
	...
	switch (iParam0)
	{
		...
		case 0x00000009:
			...
			Function_154(&(Global_29008[Global_30668[2]]), 32768);
			Function_153(&(Global_29008[Global_30668[2]]), 256);
			break;
		...
		case 0x00000017:
			...
			Function_154(&(Global_29008[Global_30658[0]]), 32768);
			Function_153(&(Global_29008[Global_30658[0]]), 256);
			break;
		...
		case 0x0000000C:
			...
			Function_152(&Global_76847, 0x2000000);
			Function_152(&Global_76847, 0x4000000);
			Function_152(&Global_76847, 4096);
			Function_152(&Global_76847, 8);
			Function_152(&Global_76847, 8388608);
			Function_152(&Global_76847, 524288);
			Function_152(&Global_76847, 1048576);
			break;
		...
		case 0x0000000E:
			Function_153(&(Global_29008[Global_30640[4]]), 256);
			Function_164(Global_30640[4]);
			Function_164(Global_30658[0]);
			Function_154(&(Global_29008[Global_30658[0]]), 32768);
			Function_153(&(Global_29008[Global_30658[0]]), 256);
		...
		case 0x00000013:
			...
			Function_154(&(Global_29008[Global_30658[3]]), 32768);
			Function_153(&(Global_29008[Global_30658[3]]), 256);
			break;
		...
		case 0x00000018:
			Function_154(&(Global_29008[Global_30679[1]]), 32768);
			Function_164(Global_30679[1]);
			break;
		
		case 0x00000019:
			Function_162(12, bParam2, 4);
			Function_153(&(Global_29008[Global_30679[1]]), 256);
		...
		case 0x0000001B:
			...
			Function_154(&(Global_29008[Global_30685[2]]), 32768);
			Function_153(&(Global_29008[Global_30685[2]]), 256);
			break;
		...
		case 0x00000031:
			...
			Function_34(2, 26);
			Function_153(&(Global_29008[Global_30717[1]]), 256);
			Function_160(11);
...
void Function_145(int iParam0) //Position: 0x9143 / 37187
{
	bool bVar0;
	...
	switch (Global_16537[iParam021].f_40)
	{
		case 0x00000002:
			...
			Function_146(Global_16537[iParam021].f_48, 16, 0, 0);
...
void Function_146(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x92B2 / 37554
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	{
		Function_148(Function_149(iParam2, 0.0f, iParam3));
		vVar4 = { StackVal, StackVal, Function_148(Function_149(iParam2, 0.0f, iParam3)) };
		iVar0 = 0;
		while (iVar0 <= Global_9724)
		{
			if (StackVal == iParam1)
			{
				...
				vVar1 = { StackVal, StackVal, Function_148(StackVal) };
				if (Function_147(StackVal, StackVal, StackVal, StackVal, vVar1, vVar4))
				{
					Global_8723[iVar04] = 4294967294;
					Global_8723[iVar04].f_4 = 0;
					Global_8723[iVar04].f_8 = 0;
...
bool Function_147(vector3 vParam0, vector3 vParam3) //Position: 0x93B8 / 37816
{
	vector3 vVar0;
...
vector3 Function_148(bool bParam0) //Position: 0x93E5 / 37861
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_149(vector3 vParam0) //Position: 0x943C / 37948
{
	bool bVar0;
...
void Function_150(bool bParam0, bool bParam1) //Position: 0x948A / 38026
{
...
void Function_151(bool bParam0, bool bParam1, bool bParam2) //Position: 0x94DE / 38110
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_152(var uParam0, int iParam1) //Position: 0x967D / 38525
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_153(var uParam0, int iParam1) //Position: 0x968C / 38540
{
	int iVar0;
...
void Function_154(var uParam0, int iParam1) //Position: 0x96A3 / 38563
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_155(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x96B2 / 38578
{
	struct<8> Var0;
	...
	if (!Function_32(bParam0))
	{
		...
		{
			stradd(&Var0, "_tip", 32);
			Function_91(&Var0, 10.0f, 1, 0, 0, 1, 0);
		}
		if (!Function_52())
		{
			if (!Function_51(Global_76846, 2))
...
int Function_156(int iParam0, int iParam1) //Position: 0x9807 / 38919
{
	if (iParam0 == 4294967295)
	{
...
int Function_157(int iParam0, int iParam1) //Position: 0x987A / 39034
{
	if (iParam0 == 4294967295)
	{
...
int Function_158(int iParam0, int iParam1) //Position: 0x98D6 / 39126
{
	if (iParam0 == 4294967295)
	{
...
int Function_159(int iParam0, int iParam1) //Position: 0x9947 / 39239
{
	if (iParam0 == 4294967295)
	{
...
void Function_160(int iParam0) //Position: 0x99A1 / 39329
{
	bool bVar0;
	bool bVar1;
	...
	switch (Global_16537[iParam021].f_40)
	{
		case 0x00000002:
			...
			Function_91("house_purchased", 0x41200000, 1, 0, 2, 1, 0);
			Function_146(Global_16537[iParam021].f_48, 17, 0, 0);
		...
		case 0x00000001:
			...
			Function_91("house_rented", 0x41200000, 1, 0, 2, 1, 0);
			break;
...
void Function_161(bool bParam0, bool bParam1) //Position: 0x9C4E / 40014
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
void Function_162(bool bParam0, bool bParam1, int iParam2) //Position: 0x9C9F / 40095
{
	bool bVar0;
...
bool Function_163(int iParam0, int iParam1) //Position: 0x9D0D / 40205
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

void Function_164(int iParam0) //Position: 0x9D20 / 40224
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Function_154(&(Global_29008[iParam0]), 4096);
	if (StackVal != 1)
	{
...
var Function_165(int iParam0) //Position: 0x9E1F / 40479
{
	int iVar0;
...
bool Function_166(var uParam0, int iParam1) //Position: 0x9E77 / 40567
{
	int iVar0;
...
int Function_167(bool bParam0, bool bParam1, int iParam2) //Position: 0x9E93 / 40595
{
	...
	if (!ACTOR_HAS_WEAPON(Function_70(), bParam0))
	{
		GIVE_WEAPON_TO_ACTOR(Function_70(), bParam0, 1.0f, iParam2, 1);
		return 1;
	}
	if (bParam1)
	{
		_ADD_AMMO_OF_TYPE(Function_70(), GET_AMMO_ENUM(bParam0), GET_WEAPON_MAX_AMMO(bParam0), 0, iParam2);
		return 1;
	}
	return 1;
}

bool Function_168(int iParam0) //Position: 0x9EEA / 40682
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void Function_169(int iParam0) //Position: 0x9EFC / 40700
{
	int iVar0;
	
	if (Function_53(iParam0, 1) && Function_53(Global_26119, 1))
	{
	}
...
void Function_170(int iParam0) //Position: 0x9F30 / 40752
{
...
void Function_171(int iParam0, int iParam1, int iParam2) //Position: 0x9F97 / 40855
{
	int iVar0;
...
void Function_172(int iParam0, bool bParam1, bool bParam2) //Position: 0xA07D / 41085
{
	int iVar0;
...
void Function_173() //Position: 0xA1F6 / 41462
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_174(bool bParam0) //Position: 0xA202 / 41474
{
	PRINTSTRING("Day ");
...
void Function_175(int iParam0) //Position: 0xA248 / 41544
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_176(int iParam0) //Position: 0xA28E / 41614
{
	if (!Function_41(iParam0))
	{
		return 4294967295;
...
int Function_177(int iParam0) //Position: 0xA2AE / 41646
{
	if (!Function_41(iParam0))
	{
		return 0;
...
void Function_178(int iParam0) //Position: 0xA2C9 / 41673
{
	Global_12976.f_4 = GET_TIME_OF_DAY();
	ADD_TIME(&Global_12976 + 4, 0, 0, (iParam0 + Function_179(105)), 0);
	return;
}

int Function_179(int iParam0) //Position: 0xA2EA / 41706
{
	return CEIL(((IntToFloat(iParam0) * Global_63398) / 60.0f));
}

void Function_180(bool bParam0) //Position: 0xA300 / 41728
{
	PRINTSTRING("Old TOD after LAST MISSION - ");
	Function_174(Global_12976.f_24);
	PRINTNL();
...
void Function_181(int iParam0) //Position: 0xA39C / 41884
{
	Global_12976.f_12 = GET_TIME_OF_DAY();
	ADD_TIME(&Global_12976 + 12, 0, 0, (iParam0 + Function_179(90)), 0);
	return;
}

void Function_182(bool bParam0) //Position: 0xA3BD / 41917
{
...
bool Function_183() //Position: 0xA3D8 / 41944
{
	int iVar0;
...
int Function_184(bool bParam0, bool bParam1, bool bParam2) //Position: 0xA3FD / 41981
{
	int iVar0;
	int iVar1;
...
int Function_185(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xA45B / 42075
{
	var uVar0;
...
int Function_186(int iParam0) //Position: 0xA5B0 / 42416
{
	int iVar0;
...
bool Function_187(int iParam0) //Position: 0xA5EE / 42478
{
...
var Function_188(int iParam0, int iParam1, bool bParam2) //Position: 0xA603 / 42499
{
	return (((bParam2 && 15) || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

int Function_189() //Position: 0xA623 / 42531
{
	int iVar0;
	int iVar1;
...
bool Function_190() //Position: 0xA68F / 42639
{
	int iVar0;
	int iVar1;
...
void Function_191(bool bParam0) //Position: 0xA6C3 / 42691
{
	if (iLocal_154 == 0)
	{
...
void Function_192(int iParam0) //Position: 0xA6DF / 42719
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_193(int iParam0) //Position: 0xA779 / 42873
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_194(float fParam0, int iParam1, float fParam2, bool bParam3, int iParam4, int iParam5, int iParam6) //Position: 0xA817 / 43031
{
...
bool Function_195(var uParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0xA847 / 43079
{
	...
	switch (*uParam0)
	{
		case 0x000003EC:
			...
			{
				Function_91("RCM_Gunslinger_Warning", 10.0f, 1, 0, 0, 1, 0);
			}
...
void Function_196() //Position: 0xAA53 / 43603
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_197(int iParam0) //Position: 0xAAE6 / 43750
{
	Function_198(iParam0, 0.0f);
	return;
}

void Function_198(int iParam0, float fParam1) //Position: 0xAAF2 / 43762
{
...
bool Function_199(int iParam0) //Position: 0xAB13 / 43795
{
	return Function_53(*iParam0, 1);
}

void Function_200(bool bParam0) //Position: 0xAB20 / 43808
{
...
void Function_201(int iParam0) //Position: 0xAB33 / 43827
{
	var uVar0;
	bool bVar1;
	struct<61> Var2;
	...
	if (IS_VOLUME_VALID(iParam0->f_32))
	{
		...
		Function_225(iParam0->f_32);
		Function_223(iParam0->f_32, bLocal_161, 0);
	}
	else
	{
		FIRE_STOP_ALL_FIRES();
	...
	if (!Function_217(GET_ACTOR_ENUM(*iParam0), 6, 4))
	{
		Function_185(GET_ACTOR_ENUM(*iParam0), 6, 4, 4294967295);
		iParam0->f_36 = 1;
	}
	else if (Function_126(Function_184(GET_ACTOR_ENUM(*iParam0), 6, 4)) < 0)
	{
		if (!iParam0->f_36)
		{
		}
	...
	if (!BEGIN_DUEL(StackVal, *iParam0, *(iParam0 + 8), *(iParam0 + 20), "duel_player", bLocal_156, "duel_player", bLocal_157, uVar0))
	{
	...
	if (iParam0->f_40)
	{
		...
		Function_214(iParam0->f_44);
		TELEPORT_ACTOR_WITH_HEADING(StackVal, StackVal, StackVal, StackVal, GET_OBJECT_HEADING(Function_214(iParam0->f_44)), 1, 1, 1);
	...
	{
		bVar1 = CREATE_OBJECTSET_IN_LAYOUT(Function_14(), bLocal_161, 4294967295, 1);
	...
	*(&Var2 + 140) = 6;
	uVar44 = 6;
	if (Function_211(&Var2, iParam0->f_64))
	{
		...
		if (Var2.f_60 >= 0)
		{
			if (Var2.f_56 == 1)
			{
				Function_210(bLocal_161, &Var2, iParam0, &uVar44);
			}
			else if (Var2.f_56 == 2)
			{
				Function_207(50.0f, bLocal_161, &Var2, iParam0, &uVar44);
			}
		}
	}
	Function_204(iParam0, bLocal_161);
	...
	if (iParam0->f_36)
	{
		if (!SET_DUEL_DIFFICULTY(*iParam0, (fVar51 * 2.0f), iParam0->f_52, iParam0->f_48))
		{
			LOG_ERROR("Duel could not set difficulty");
		}
	}
	else if (!SET_DUEL_DIFFICULTY(*iParam0, fVar51, iParam0->f_52, iParam0->f_48))
	{
		LOG_ERROR("Duel could not set difficulty");
	}
	...
	Global_62993 = 1;
	uVar52 = GET_OBJECT_MODEL_NAME(*iParam0);
	ADD_NEW_EVENT_RESPONSE(5001, 38, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5002, 39, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5003, 40, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5004, 41, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5000, 44, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5006, 43, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5005, 42, 15, uVar52);
	ADD_NEW_EVENT_RESPONSE(5007, 46, 15, uVar52);
	...
	MEMORY_ALLOW_SHOOTING(StackVal, 1);
	...
	Function_202(&uLocal_158, 0.0f);
	return;
}

void Function_202(int iParam0, float fParam1) //Position: 0xB11F / 45343
{
...
void Function_203(int iParam0) //Position: 0xB135 / 45365
{
	int iVar0;
...
int Function_204(int iParam0, bool bParam1) //Position: 0xB152 / 45394
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	while (bVar3 <= iVar2)
	{
		...
		if (((((StackVal == bVar4 && bVar4 == iParam0->f_44) && bVar4 == *iParam0) && IS_ACTOR_HUMAN(bVar4)) && !IS_OBJECT_IN_OBJECTSET(bVar4, bLocal_152)) && !DECOR_CHECK_EXIST(bVar4, "ignoreactorinduel"))
		{
			...
			{
				Function_205(bVar4, iParam0, bParam1);
...
void Function_205(bool bParam0, var uParam1, int iParam2) //Position: 0xB2AF / 45743
{
	bool bVar0;
	var uVar1[2];
...
void Function_206(var uParam0, int iParam1) //Position: 0xB326 / 45862
{
	bool bVar0;
...
int Function_207(var uParam0, bool bParam1, int iParam2, int iParam3, var uParam4) //Position: 0xB4C3 / 46275
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	while (bVar7 <= iVar5)
	{
		...
		{
			(*uParam4)[iVar6] = bVar8;
			Function_209(GET_PERS_CHAR_FROM_ACTOR(bVar8), 1);
			vVar9 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(*(iParam2 + 64[iVar63]), *(iParam3 + 20), StackVal) };
			fVar12 = UNK_0x9C40E671(&vVar9);
			TELEPORT_ACTOR_WITH_HEADING(bVar8, *(iParam2 + 64[iVar63]), fVar12, 1, 1, 1);
			TASK_CLEAR(bVar8);
	...
	Function_208(uParam4, iVar6, 0, iParam2);
	if (IS_VOLUME_VALID(bVar0))
	{
		DESTROY_VOLUME(bVar0);
	}
...
int Function_208(var uParam0, int iParam1, bool bParam2, int iParam3) //Position: 0xB68A / 46730
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_209(bool bParam0, bool bParam1) //Position: 0xB7CD / 47053
{
	bool bVar0;
	bool bVar1;
...
void Function_210(bool bParam0, int iParam1, int iParam2, var uParam3) //Position: 0xB86F / 47215
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	*iParam2 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, *iParam2 };
	...
	while (iVar1 <= iParam1->f_60)
	{
		...
		if (uVar2 & 32768 == 0)
		{
			...
			(*uParam3)[iVar0] = CREATE_ACTOR_IN_LAYOUT(bParam0, Function_14(), uLocal_167[iVar0], *(iParam1 + 64[iVar13]), 0.0f, bVar6, 0.0f);
			TASK_FACE_COORD((*uParam3)[iVar0], iParam1 + 36, 1);
			TASK_PRIORITY_SET((*uParam3)[iVar0], 1);
			uVar7 = GET_OBJECT_MODEL_NAME((*uParam3)[iVar0]);
			PRINTFLOAT(bVar6);
			PRINTNL();
			iVar0++;
		}
	...
	Function_208(uParam3, iVar0, 0, iParam1);
}

bool Function_211(int iParam0, int iParam1) //Position: 0xB928 / 47400
{
	if (iParam1 <= 0)
	{
		return Function_212(iParam0, iParam1);
	}
...
int Function_212(int iParam0, int iParam1) //Position: 0xE3F2 / 58354
{
	if (iLocal_4 != 0)
	{
		iParam0->f_56 = 1;
...
void Function_213(bool bParam0) //Position: 0xEC10 / 60432
{
	bool bVar0;
...
vector3 Function_214(bool bParam0) //Position: 0xEC55 / 60501
{
	vector3 vVar0;
...
void Function_215(bool bParam0) //Position: 0xEC7C / 60540
{
	float fVar0;
	bool bVar1;
	float fVar2;
	...
	{
		bVar1 = GET_WEAPON_EQUIPPED(bParam0, true);
		if (Function_168(bVar1))
		{
			fVar2 = ACTOR_GET_WEAPON_AMMO(bParam0, bVar1);
			fVar3 = (GET_WEAPON_MAX_AMMO(bVar1) - fVar2);
			fVar4 = _GET_AMMO_AMOUNT(bParam0, GET_AMMO_ENUM(bVar1), 0);
			if (fVar3 < fVar4)
			{
				fVar0 = (_GET_AMMO_AMOUNT(bParam0, GET_AMMO_ENUM(bVar1), 0) + GET_WEAPON_MAX_AMMO(bVar1));
				if (fVar0 <= 0.0f)
				{
					_SET_ACTOR_AMMO_OF_TYPE(bParam0, GET_AMMO_ENUM(bVar1), fVar0, 0);
				}
			}
			ACTOR_ADD_WEAPON_AMMO(bParam0, bVar1, fVar3);
			fVar0 = (_GET_AMMO_AMOUNT(bParam0, GET_AMMO_ENUM(bVar1), 0) - fVar3);
			if (fVar0 <= 0.0f)
			{
				_SET_ACTOR_AMMO_OF_TYPE(bParam0, GET_AMMO_ENUM(bVar1), fVar0, 0);
			}
...
void Function_216(bool bParam0, bool bParam1) //Position: 0xED1C / 60700
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
bool Function_217(bool bParam0, int iParam1, int iParam2) //Position: 0xED3C / 60732
{
	var uVar0;
...
void Function_218(bool bParam0) //Position: 0xED52 / 60754
{
	if (!IS_OBJECT_VALID(bParam0))
	{
		return;
...
void Function_219(int iParam0) //Position: 0xED86 / 60806
{
	Function_220(&Global_28842, iParam0);
	return;
}

void Function_220(var uParam0, int iParam1) //Position: 0xED94 / 60820
{
	int iVar0;
...
bool Function_221(int iParam0) //Position: 0xEDB7 / 60855
{
	return Function_222(&Global_28842, iParam0);
}

int Function_222(var uParam0, int iParam1) //Position: 0xEDC5 / 60869
{
	int iVar0;
...
void Function_223(bool bParam0, bool bParam1, int iParam2) //Position: 0xEDE1 / 60897
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar1 <= GET_OBJECTSET_SIZE(bVar0))
	{
		...
		if (IS_OBJECT_VALID(bVar2))
		{
			...
			if (((!ACTOR_IS_GRABBED_BY_CUTSCENE(bVar3) && IS_ACTOR_VEHICLE(bVar3)) && bVar3 == iParam2) && !Function_224(bVar3))
			{
				bVar4 = false;
...
bool Function_224(bool bParam0) //Position: 0xEECE / 61134
{
	bool bVar0;
...
void Function_225(bool bParam0) //Position: 0xEEF3 / 61171
{
	bool bVar0;
	bool bVar1;
...
float Function_226(int iParam0) //Position: 0xEF35 / 61237
{
	if (Function_199(iParam0))
	{
...
bool Function_227(int iParam0) //Position: 0xEFFD / 61437
{
	return Function_53(*iParam0, 2);
}

bool Function_228() //Position: 0xF00A / 61450
{
	bool bVar0;
	int iVar1;
...
bool Function_229() //Position: 0xF04B / 61515
{
	return Function_230(4, 1);
}

int Function_230(int iParam0, bool bParam1) //Position: 0xF056 / 61526
{
	int iVar0;
...
int Function_231(int iParam0) //Position: 0xF076 / 61558
{
	return Function_232(iParam0, 4, 1);
}

int Function_232(bool bParam0, int iParam1, bool bParam2) //Position: 0xF083 / 61571
{
	char* cVar0[64];
	int iVar16;
...
var Function_233(int iParam0) //Position: 0xF104 / 61700
{
	switch (iParam0)
	{
		case 0x00000002:
...
bool Function_234(bool bParam0) //Position: 0xF41D / 62493
{
	char* cVar0[64];
...
int Function_235(bool bParam0) //Position: 0xF4BE / 62654
{
	bool bVar0;
	char* cVar1[32];
	bool bVar9;
...
void Function_236(bool bParam0) //Position: 0xF676 / 63094
{
	bool bVar0;
...
void Function_237(int iParam0) //Position: 0xF6AE / 63150
{
	Function_238(4, iParam0);
	return;
}

void Function_238(int iParam0, bool bParam1) //Position: 0xF6BA / 63162
{
	if (bParam1)
	{
		Function_82(&Global_78480 + 124, iParam0);
	}
	else
	{
...
void Function_239(int iParam0) //Position: 0xF6F5 / 63221
{
	if (!Function_199(iParam0))
	{
		Function_198(iParam0, 0.0f);
...
bool Function_240(bool bParam0) //Position: 0xF70A / 63242
{
	int iVar0;
	int iVar1;
	...
	Function_246();
	iVar1 = 0;
	if (!Function_245(bParam0[iVar03], 16))
	{
		...
		Function_244(bParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*bParam0 - 1))
	{
		if (Function_245(bParam0[iVar03], 4))
		{
			if (!Function_245(bParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					case 0x00000000:
						if (!STREAMING_REQUEST_PROP((*bParam0)[iVar03], (Function_245(bParam0[03], 8) || iVar1)))
						{
						}
						break;
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*bParam0)[iVar03], 1, (Function_245(bParam0[03], 8) || iVar1));
						break;
	...
	while (iVar0 < (*bParam0 - 1))
	{
		if (Function_245(bParam0[iVar03], 4))
		{
			if (!Function_245(bParam0[iVar03], 2))
			{
				switch (StackVal)
				{
					case 0x00000000:
...
void Function_241() //Position: 0xFA85 / 64133
{
	if (!Function_242(128))
	{
		return;
...
bool Function_242(int iParam0) //Position: 0xFAC5 / 64197
{
	int iVar0;
...
bool Function_243() //Position: 0xFAE1 / 64225
{
	int iVar0;
...
void Function_244(var uParam0, int iParam1) //Position: 0xFB0C / 64268
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

bool Function_245(int iParam0, int iParam1) //Position: 0xFB1D / 64285
{
	int iVar0;
...
void Function_246() //Position: 0xFB3A / 64314
{
	if (!Function_242(128))
	{
		return;
...
void Function_247(bool bParam0) //Position: 0xFB7C / 64380
{
	if (!bLocal_164)
	{
		Function_5(bParam0);
...
void Function_248(int iParam0) //Position: 0xFB98 / 64408
{
...
void Function_249(int iParam0) //Position: 0xFCDE / 64734
{
	int iVar0;
...
void Function_250(var uParam0, int iParam1) //Position: 0xFD04 / 64772
{
	if (Function_245(uParam0[iParam13], 4))
	{
		if (Function_245(uParam0[iParam13], 1))
		{
			switch (StackVal)
			{
				case 0x00000000:
			...
			Function_251(uParam0[iParam13], 1);
			Function_251(uParam0[iParam13], 2);
			Function_251(uParam0[iParam13], 4);
		}
	}
	return;
}

void Function_251(var uParam0, int iParam1) //Position: 0xFE32 / 65074
{
	int iVar0;
...
int Function_252(int iParam0) //Position: 0xFE4C / 65100
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (bVar1 <= iVar0)
	{
		...
		if (DECOR_CHECK_EXIST(bVar2, "DuelIsCrowdActor"))
		{
			...
			else if (iLocal_166 == 2)
			{
				...
				if ((bVar3 && 4) != 0)
				{
					Function_265(GET_PERS_CHAR_FROM_ACTOR(bVar2));
				}
			}
			...
			else if (iLocal_166 == 0)
			{
				...
				if ((bVar3 && 64) != 0)
				{
					Function_253(bVar2, bVar3, iParam0 + 8);
				}
				else
				{
					TASK_CLEAR(bVar2);
...
void Function_253(bool bParam0, var uParam1, int iParam2) //Position: 0x10002 / 65538
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	vVar4 = { StackVal, StackVal, Function_255(bParam0) };
	Function_254(iParam2, &vVar4, &vVar1);
...
void Function_254(var uParam0, var uParam1, int iParam2) //Position: 0x10067 / 65639
{
...
vector3 Function_255(bool bParam0) //Position: 0x100BB / 65723
{
	vector3 vVar0;
...
int Function_256(bool bParam0, int iParam1, int iParam2, int iParam3) //Position: 0x10125 / 65829
{
	int iVar0;
	bool bVar1;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		else
		{
			...
			while (iVar0 < (GET_NUM_DRAFT_POSITIONS(bParam0) - 1))
			{
				...
				if (IS_ACTOR_VALID(bVar1))
				{
					Function_257(bVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_257(bParam0, iParam1, iParam2, iParam3, 1);
	}
	else
	{
		return 0;
...
int Function_257(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x10205 / 66053
{
	char* cVar0[32];
	...
	Function_261(bParam0, iParam1);
	Function_260(bParam0, uParam2);
	Function_259(bParam0, uParam3);
	if (Function_258(bParam0) != 5)
	{
...
int Function_258(bool bParam0) //Position: 0x10453 / 66643
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_259(bool bParam0, bool bParam1) //Position: 0x10476 / 66678
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_260(bool bParam0, bool bParam1) //Position: 0x10499 / 66713
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_261(bool bParam0, bool bParam1) //Position: 0x104BD / 66749
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_262(bool bParam0, bool bParam1) //Position: 0x104E3 / 66787
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_263(bool bParam0) //Position: 0x10506 / 66822
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_264() //Position: 0x10524 / 66852
{
...
int Function_265(bool bParam0) //Position: 0x1056E / 66926
{
	bool bVar0;
	bool bVar1;
...
void Function_266(bool bParam0) //Position: 0x10608 / 67080
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_267(int iParam0) //Position: 0x10625 / 67109
{
	struct<61> Var0;
	...
	*(&Var0 + 140) = 6;
	if (iParam0->f_64 <= 0)
	{
		if (Function_211(&Var0, iParam0->f_64))
		{
			if (Var0.f_56 == 1)
			{
				iVar43 = 0;
				...
				while (iVar42 <= Var0.f_60)
				{
					...
					if (uVar44 & 32768 == 0)
					{
						uLocal_167[iVar43] = Function_269(Global_30750[0], 1, 0, 1);
						Function_268(&bLocal_90, uLocal_167[iVar43], 3, 0);
						iVar43++;
					}
					iVar42++;
				}
...
var Function_268(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x106AC / 67244
{
	int iVar0;
...
var Function_269(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1077C / 67452
{
	return Function_270(uParam0, uParam1, uParam2, 4294967295, uParam3);
}

var Function_270(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x10790 / 67472
{
	return Function_271(uParam0, uParam1, uParam2, uParam3, uParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_271(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, vector3 vParam6) //Position: 0x107A9 / 67497
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (!Function_276(bVar1))
	{
		...
		{
			Function_275(bParam0, bParam1, bParam2, bParam3, bParam4);
	...
	if (bParam1 || (!bParam3 != 4294967295 && !bParam3 != GET_ACTORENUM_SPECIES(bVar1)))
	{
		...
		{
			while (Function_274(bVar0) && iVar2 > 20)
			{
...
void Function_272(int iParam0) //Position: 0x10A9C / 68252
{
	int iVar0;
...
void Function_273() //Position: 0x10B50 / 68432
{
	int iVar0;
...
bool Function_274(bool bParam0) //Position: 0x10B8A / 68490
{
	int iVar0;
...
void Function_275(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x10BB7 / 68535
{
	int iVar0;
...
bool Function_276(bool bParam0) //Position: 0x10D08 / 68872
{
...
void Function_277() //Position: 0x10D1F / 68895
{
	int iVar0;
...
void Function_278(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x10D6A / 68970
{
	Function_279(&bLocal_90, "duel_player", 5, 0);
	Function_279(&bLocal_90, "Dueling/duel_player", 8, 0);
	if (bParam1)
	{
		if (bParam2)
		{
			Function_268(&bLocal_90, 59, 2, 0);
		}
		Function_279(&bLocal_90, "duel_hostage", 5, 0);
		Function_279(&bLocal_90, "Dueling/duel_hostage", 8, 0);
		bLocal_156 = "duel_hostage";
	}
	else
	{
		if ((Function_217(GET_ACTOR_ENUM(bParam3), 6, 4) && *uParam0 != 0) && !Global_3380)
		{
			if (Function_126(Function_184(GET_ACTOR_ENUM(bParam3), 6, 4)) > 10)
			{
				*uParam0 = 2;
			}
			else if (Function_126(Function_184(GET_ACTOR_ENUM(bParam3), 6, 4)) > 5)
			{
				*uParam0 = 1;
			}
		}
		switch (*uParam0)
		{
			...
			case 0x00000000:
				...
				{
					case 0x00000000:
						Function_279(&bLocal_90, "duel_easy_A_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Easy_A_npc", 8, 0);
						bLocal_156 = "duel_Easy_A_npc";
						break;
					
					case 0x00000001:
						Function_279(&bLocal_90, "duel_easy_B_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Easy_B_npc", 8, 0);
			...
			case 0x00000001:
				...
				{
					case 0x00000000:
						Function_279(&bLocal_90, "duel_mid_A_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Mid_A_npc", 8, 0);
						bLocal_156 = "duel_Mid_A_npc";
						break;
					
					case 0x00000001:
						Function_279(&bLocal_90, "duel_mid_B_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Mid_B_npc", 8, 0);
						bLocal_156 = "duel_Mid_B_npc";
						break;
					
					case 0x00000002:
						Function_279(&bLocal_90, "duel_mid_C_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Mid_C_npc", 8, 0);
			...
			case 0x00000002:
				...
				{
					case 0x00000000:
						Function_279(&bLocal_90, "duel_hard_A_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Hard_A_npc", 8, 0);
						bLocal_156 = "duel_Hard_A_npc";
						break;
					
					case 0x00000001:
						Function_279(&bLocal_90, "duel_hard_B_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Hard_B_npc", 8, 0);
						bLocal_156 = "duel_Hard_B_npc";
						break;
					
					case 0x00000002:
						Function_279(&bLocal_90, "duel_hard_C_npc", 5, 0);
						Function_279(&bLocal_90, "Dueling/duel_Hard_C_npc", 8, 0);
	...
	Function_279(&bLocal_90, "nminigames", 10, 0);
	Function_279(&bLocal_90, "crowd_duel", 5, 0);
	Function_279(&bLocal_90, "custom/crowd_duel_center", 8, 0);
	Function_279(&bLocal_90, "custom/crowd_duel_left", 8, 0);
	Function_279(&bLocal_90, "custom/crowd_duel_right", 8, 0);
}

var Function_279(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x111FB / 70139
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Function_280(iParam0, uVar1, iParam2);
	if (bParam3)
	{
...
var Function_280(var uParam0, int iParam1, int iParam2) //Position: 0x11233 / 70195
{
	int iVar0;
	...
	{
		if (!Function_245(uParam0[iVar03], 4))
		{
