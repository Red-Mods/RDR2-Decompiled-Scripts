...
bool Function_23(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x1B1C / 6940
{
...
void Function_33(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x1E94 / 7828
{
	bool bVar0;
	bool bVar1;
...
var Function_55(var uParam0, var uParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x278B / 10123
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_63(var uParam0, bool bParam1, int iParam2) //Position: 0x3133 / 12595
{
	int iVar0;
...
vector3 Function_77() //Position: 0x38EC / 14572
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_78() //Position: 0x38FD / 14589
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_79() //Position: 0x390E / 14606
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_80(var uParam0, int iParam1) //Position: 0x391F / 14623
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x3942 / 14658
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x3961 / 14689
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x396D / 14701
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3978 / 14712
{
	int iVar0;
...
var Function_85() //Position: 0x39A6 / 14758
{
	return "PackedWeapon";
}

int Function_86(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x39BB / 14779
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_87() //Position: 0x3ABF / 15039
{
	return "MPItemGiver";
}

struct<32> Function_88(bool bParam0) //Position: 0x3AD3 / 15059
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3B3D / 15165
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3B5C / 15196
{
	return "PBox_";
}

var Function_91() //Position: 0x3B6A / 15210
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3B90 / 15248
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3BB8 / 15288
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3BDE / 15326
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3D3F / 15679
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3DDA / 15834
{
	int iVar0;
	vector3 vVar1;
...
void Function_97(int iParam0) //Position: 0x3F3B / 16187
{
...
var Function_98() //Position: 0x3F9C / 16284
{
	int iVar0;
...
var Function_99(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3FA4 / 16292
{
	return Function_100(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_100(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x3FBD / 16317
{
	bool bVar0;
	bool bVar1;
	int iVar2;
