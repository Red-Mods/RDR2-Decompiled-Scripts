	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_42(iParam0, bVar8, &iLocal_83, &bLocal_82);
...
void Function_22(var uParam0, int iParam1) //Position: 0x1CB0 / 7344
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_23(bool bParam0) //Position: 0x1CBE / 7358
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CD4 / 7380
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CE1 / 7393
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D01 / 7425
{
	var uVar0[2];
...
void Function_27(bool bParam0, bool bParam1) //Position: 0x1DD2 / 7634
{
...
int Function_28(var uParam0, var uParam1, int iParam2) //Position: 0x1E23 / 7715
{
	return Function_29(Global_29006, uParam0, uParam1, iParam2);
}

int Function_29(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x1E35 / 7733
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
bool Function_30(int iParam0) //Position: 0x1ED1 / 7889
{
...
bool Function_31(bool bParam0) //Position: 0x1EE7 / 7911
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_32() //Position: 0x1F06 / 7942
{
	return;
}

void Function_33(var uParam0, int iParam1) //Position: 0x1F0C / 7948
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34(int iParam0) //Position: 0x1F1A / 7962
{
	iParam0 = iParam0;
	return 1;
}

bool Function_35(bool bParam0) //Position: 0x1F25 / 7973
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_36(bool bParam0, int iParam1) //Position: 0x1F3F / 7999
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_37(bool bParam0) //Position: 0x1F5D / 8029
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1F7C / 8060
{
	int iVar0;
	int iVar1;
...
bool Function_39(bool bParam0) //Position: 0x1FAF / 8111
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_40(bool bParam0) //Position: 0x1FCE / 8142
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x1FE8 / 8168
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1FFB / 8187
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_43() //Position: 0x22E3 / 8931
{
	int iVar0;
...
bool Function_44(bool bParam0, bool bParam1) //Position: 0x22EB / 8939
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_45() //Position: 0x2308 / 8968
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2317 / 8983
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2339 / 9017
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_48(bool bParam0) //Position: 0x235D / 9053
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x237A / 9082
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x239A / 9114
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_51(bool bParam0, bool bParam1) //Position: 0x23BA / 9146
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_52(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2468 / 9320
{
	bool bVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x24D8 / 9432
{
	if (!Function_14(iParam0))
	{
...
void Function_54(int iParam0, float fParam1) //Position: 0x24EE / 9454
{
...
var Function_55(bool bParam0) //Position: 0x250F / 9487
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_56(int iParam0) //Position: 0x252F / 9519
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x2543 / 9539
{
	uParam0 = uParam0;
	return;
}

int Function_58() //Position: 0x254D / 9549
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x2554 / 9556
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_60(bool bParam0, var uParam1, int iParam2) //Position: 0x2563 / 9571
{
	bool bVar0;
...
bool Function_61(bool bParam0) //Position: 0x25A2 / 9634
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(bool bParam0) //Position: 0x25CD / 9677
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_63(bool bParam0) //Position: 0x25D8 / 9688
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_64(bool bParam0) //Position: 0x26CE / 9934
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_65(bool bParam0) //Position: 0x26F0 / 9968
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(int iParam0) //Position: 0x2717 / 10007
{
	struct<8> Var0;
	...
	if (iLocal_1 && !iLocal_0)
	{
		...
		iLocal_2 = CREATE_LAYOUT(&Var0);
		bLocal_3 = Function_67(iLocal_2, 0, 1, 0, 0);
	}
	return;
}

bool Function_67(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2758 / 10072
{
	bool bVar0;
...
void Function_68(int iParam0) //Position: 0x27CF / 10191
{
	bool bVar0;
...
void Function_69(int iParam0) //Position: 0x27F8 / 10232
{
...
struct<32> Function_70(bool bParam0) //Position: 0x2862 / 10338
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_71(char* cParam0, char* cParam1, char* cParam2) //Position: 0x28CC / 10444
{
	char* cVar0[32];
...
void Function_72(int iParam0) //Position: 0x28EB / 10475
{
	iParam0 = iParam0;
	return;
}

bool Function_73(bool bParam0) //Position: 0x28F5 / 10485
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_74(int iParam0) //Position: 0x2913 / 10515
{
	if (!Function_14(iParam0))
	{
...
bool Function_75(bool bParam0, bool bParam1) //Position: 0x2928 / 10536
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_76(int iParam0) //Position: 0x29AF / 10671
{
	vector3 vVar0;
...
vector3 Function_77(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29D2 / 10706
{
	vector3 vVar0;
...
bool Function_78(bool bParam0) //Position: 0x29F0 / 10736
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_79(bool bParam0, bool bParam1) //Position: 0x2A13 / 10771
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_80(bool bParam0, int iParam1) //Position: 0x2B2E / 11054
{
...
int Function_81(bool bParam0) //Position: 0x2B59 / 11097
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_82(var uParam0, int iParam1) //Position: 0x2C5E / 11358
{
	return (uParam0 && iParam1) == 0;
}

void Function_83(int iParam0) //Position: 0x2C6B / 11371
{
	if (Function_82(iParam0->f_40, 16))
	{
...
void Function_84(int iParam0, bool bParam1) //Position: 0x2CDE / 11486
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_85() //Position: 0x31DC / 12764
{
	bool bVar0;
...
bool Function_86(bool bParam0) //Position: 0x3213 / 12819
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_87(var uParam0, int iParam1) //Position: 0x3230 / 12848
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_88(int iParam0) //Position: 0x3268 / 12904
{
	iParam0 = iParam0;
	return;
}

bool Function_89(bool bParam0) //Position: 0x3272 / 12914
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_90(var uParam0, int iParam1) //Position: 0x3293 / 12947
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	HUD_ENABLE(true);
...
void Function_91(bool bParam0, bool bParam1) //Position: 0x32CA / 13002
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_92(bool bParam0, bool bParam1) //Position: 0x33D2 / 13266
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_93(int iParam0) //Position: 0x33E8 / 13288
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_94(bool bParam0, int iParam1) //Position: 0x369E / 13982
{
	iParam1 = iParam1;
	iLocal_1 = 0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_95(bool bParam0) //Position: 0x36BA / 14010
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_96(bool bParam0) //Position: 0x36D3 / 14035
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_97(bool bParam0, int iParam1) //Position: 0x36ED / 14061
{
	bool bVar0;
	int iVar1;
	
	bParam0 = bParam0;
	iVar1 = Function_98(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_98(var uParam0, int iParam1) //Position: 0x3725 / 14117
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_99(int iParam0, int iParam1) //Position: 0x373C / 14140
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_100(bool bParam0) //Position: 0x3A05 / 14853
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_101(bool bParam0, bool bParam1) //Position: 0x3A22 / 14882
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_102(int iParam0) //Position: 0x3ABE / 15038
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_103(bool bParam0, int iParam1) //Position: 0x3ADD / 15069
{
	bool bVar0;
...
bool Function_104(int iParam0) //Position: 0x3B23 / 15139
{
...
void Function_105(int iParam0) //Position: 0x3B3F / 15167
{
	iParam0 = iParam0;
	return;
}

void Function_106(bool bParam0, int iParam1) //Position: 0x3B49 / 15177
{
	bool bVar0;
	bool bVar1;
...
void Function_107(int iParam0, int iParam1) //Position: 0x3BAB / 15275
{
...
void Function_108(int iParam0) //Position: 0x3BBF / 15295
{
	iParam0 = iParam0;
	return;
}

void Function_109(int iParam0) //Position: 0x3BC9 / 15305
{
