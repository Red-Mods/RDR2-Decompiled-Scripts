...
bool Function_46(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2B17 / 11031
{
...
void Function_55(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2E25 / 11813
{
	bool bVar0;
	bool bVar1;
...
void Function_85(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x418B / 16779
{
	bool bVar0;
...
bool Function_86(bool bParam0, bool bParam1) //Position: 0x41DF / 16863
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_91(int iParam0, bool bParam1) //Position: 0x438F / 17295
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_99(int iParam0) //Position: 0x4688 / 18056
{
	bool bVar0;
	bool bVar1;
...
var Function_100(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4782 / 18306
{
	int iVar0;
	bool bVar1;
...
void Function_101(var uParam0, int iParam1) //Position: 0x47BA / 18362
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_102(var uParam0, bool bParam1, int iParam2) //Position: 0x47CB / 18379
{
	int iVar0;
...
bool Function_103(int iParam0) //Position: 0x488F / 18575
{
	int iVar0;
	int iVar1;
...
void Function_104() //Position: 0x4C0A / 19466
{
	if (!Function_151(128))
	{
		return;
...
bool Function_105() //Position: 0x4C4A / 19530
{
	int iVar0;
...
void Function_106() //Position: 0x4C75 / 19573
{
	if (!Function_151(128))
	{
		return;
...
void Function_107(int iParam0, bool bParam1) //Position: 0x4CB7 / 19639
{
	char* cVar0[32];
...
void Function_108(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4D3B / 19771
{
	var uVar0;
	var uVar1;
...
void Function_109(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4D64 / 19812
{
...
var Function_110(var uParam0, bool bParam1) //Position: 0x4DB5 / 19893
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_111() //Position: 0x4DC5 / 19909
{
	return "PackedGrass";
}

var Function_112(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4DD9 / 19929
{
	int iVar0;
...
var Function_113() //Position: 0x4DFE / 19966
{
	return "PackedMetadata";
}

void Function_114(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4E15 / 19989
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_115() //Position: 0x4F3B / 20283
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_116() //Position: 0x4F4C / 20300
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_117() //Position: 0x4F5D / 20317
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_118(var uParam0, int iParam1) //Position: 0x4F6E / 20334
{
...
var Function_119(var uParam0, int iParam1, bool bParam2) //Position: 0x4F91 / 20369
{
	int iVar0;
...
var Function_120(bool bParam0) //Position: 0x4FB0 / 20400
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_121() //Position: 0x4FBC / 20412
{
	return Function_122(39);
}

int Function_122(int iParam0) //Position: 0x4FC7 / 20423
{
	int iVar0;
...
var Function_123() //Position: 0x4FF5 / 20469
{
	return "PackedWeapon";
}

int Function_124(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x500A / 20490
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_125() //Position: 0x510E / 20750
{
	return "MPItemGiver";
}

struct<32> Function_126(bool bParam0) //Position: 0x5122 / 20770
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_127(char* cParam0, char* cParam1, char* cParam2) //Position: 0x518C / 20876
{
	char* cVar0[32];
...
var Function_128() //Position: 0x51AB / 20907
{
	return "PBox_";
}

var Function_129() //Position: 0x51B9 / 20921
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_130() //Position: 0x51DF / 20959
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_131() //Position: 0x5207 / 20999
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_132(var uParam0, int iParam1) //Position: 0x522D / 21037
{
	int iVar0;
	var uVar1;
...
void Function_133(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x538E / 21390
{
	struct<8> Var0;
...
int Function_134(bool bParam0) //Position: 0x5429 / 21545
{
	int iVar0;
	vector3 vVar1;
...
void Function_135(int iParam0) //Position: 0x558A / 21898
{
...
var Function_136() //Position: 0x55EB / 21995
{
	int iVar0;
...
var Function_137(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x55F3 / 22003
{
	return Function_138(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x560C / 22028
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_139(int iParam0) //Position: 0x58FF / 22783
{
	int iVar0;
...
void Function_140() //Position: 0x59B3 / 22963
{
	int iVar0;
...
bool Function_141(bool bParam0) //Position: 0x59ED / 23021
{
	int iVar0;
...
void Function_142(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5A1A / 23066
{
	bool bVar0;
...
void Function_143() //Position: 0x5B6B / 23403
{
	int iVar0;
...
var Function_144(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5BB6 / 23478
{
	int iVar0;
...
int Function_145() //Position: 0x5C86 / 23686
{
	int iVar0;
...
int Function_146() //Position: 0x5DE2 / 24034
{
	int iVar0;
...
bool Function_147(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5F02 / 24322
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_148(var uParam0, int iParam1) //Position: 0x5FD2 / 24530
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_149(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5FF0 / 24560
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_150(bool bParam0) //Position: 0x6122 / 24866
{
	bool bVar0;
...
bool Function_151(int iParam0) //Position: 0x6141 / 24897
{
	int iVar0;
...
int Function_152() //Position: 0x615D / 24925
{
	if (Function_154())
	{
...
int Function_153() //Position: 0x6176 / 24950
{
	return Global_79349.f_16;
}

bool Function_154() //Position: 0x6182 / 24962
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_155(int iParam0, bool bParam1, bool bParam2) //Position: 0x618B / 24971
{
	var uVar0;
