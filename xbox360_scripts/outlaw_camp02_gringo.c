...
bool Function_75(var uParam0, bool bParam1, int iParam2) //Position: 0x3882 / 14466
{
...
void Function_80(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3FC2 / 16322
{
	bool bVar0;
...
bool Function_81(bool bParam0, bool bParam1) //Position: 0x4017 / 16407
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_86(int iParam0, bool bParam1) //Position: 0x41C7 / 16839
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0) //Position: 0x454A / 17738
{
	bool bVar0;
	bool bVar1;
...
var Function_96(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4644 / 17988
{
	int iVar0;
	bool bVar1;
...
void Function_97(var uParam0, int iParam1) //Position: 0x467C / 18044
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_98(var uParam0, bool bParam1, int iParam2) //Position: 0x468D / 18061
{
	int iVar0;
...
bool Function_99(int iParam0) //Position: 0x4751 / 18257
{
	int iVar0;
	int iVar1;
...
void Function_100() //Position: 0x4ACC / 19148
{
	if (!Function_147(128))
	{
		return;
...
bool Function_101() //Position: 0x4B0C / 19212
{
	int iVar0;
...
void Function_102() //Position: 0x4B37 / 19255
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4B79 / 19321
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4BFD / 19453
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4C26 / 19494
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4C77 / 19575
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4C87 / 19591
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4C9B / 19611
{
	int iVar0;
...
var Function_109() //Position: 0x4CC0 / 19648
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4CD7 / 19671
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4DFD / 19965
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4E0E / 19982
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4E1F / 19999
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4E30 / 20016
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4E53 / 20051
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4E72 / 20082
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4E7E / 20094
{
	return Function_118(39);
}

int Function_118(bool bParam0) //Position: 0x4E89 / 20105
{
	bool bVar0;
...
var Function_119() //Position: 0x4EB7 / 20151
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4ECC / 20172
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4FD0 / 20432
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4FE4 / 20452
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x504E / 20558
{
	char* cVar0[32];
...
var Function_124() //Position: 0x506D / 20589
{
	return "PBox_";
}

var Function_125() //Position: 0x507B / 20603
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x50A1 / 20641
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x50C9 / 20681
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x50EF / 20719
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5250 / 21072
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x52EB / 21227
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x544C / 21580
{
...
var Function_132() //Position: 0x54AD / 21677
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x54B5 / 21685
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x54CE / 21710
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x57C1 / 22465
{
	int iVar0;
...
void Function_136() //Position: 0x5875 / 22645
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x58AF / 22703
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x58DC / 22748
{
	bool bVar0;
...
void Function_139() //Position: 0x5A2D / 23085
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5A78 / 23160
{
	int iVar0;
...
int Function_141() //Position: 0x5B48 / 23368
{
	int iVar0;
...
int Function_142() //Position: 0x5CA4 / 23716
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5DC4 / 24004
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5E94 / 24212
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5EB2 / 24242
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5FE4 / 24548
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x6003 / 24579
{
	int iVar0;
...
int Function_148() //Position: 0x601F / 24607
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x6038 / 24632
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x6044 / 24644
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x604D / 24653
{
	var uVar0;
