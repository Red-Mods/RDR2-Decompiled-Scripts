...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = Function_20("crows", 0);
	Function_17(&bVar0, 1132, 10.0f, 14, 0, 0);
	Function_17(&bVar0, 1133, 10.0f, 14, 0, 0);
	uVar1 = Function_20("pigs", 0);
	Function_16(&uVar1, 1020, 10.0f, 0, 0);
	Function_16(&uVar1, 1021, 10.0f, 0, 0);
	Function_16(&uVar1, 1021, 10.0f, 0, 0);
	bVar2 = Function_20("whores", 0);
	Function_17(&bVar2, 70, 7.0f, 48, 0, 0);
	Function_17(&bVar2, 71, 7.0f, 48, 0, 0);
	Function_17(&bVar2, 72, 7.0f, 48, 0, 0);
	bVar3 = Function_20("saloon", 0);
	Function_17(&bVar3, 203, 8.0f, 48, 1, 0);
	Function_17(&bVar3, 136, 8.0f, 48, 1, 0);
	Function_17(&bVar3, 142, 8.0f, 48, 1, 0);
	Function_17(&bVar3, 143, 8.0f, 48, 1, 0);
	Function_17(&bVar3, 398, 8.0f, 48, 1, 0);
	Function_17(&bVar3, 487, 8.0f, 48, 1, 0);
	if (!Function_15())
	{
		if (Global_25974[2])
		{
			bVar4 = Function_20("pop_blackjack", 1);
			Function_16(&bVar4, 104, 5.0f, 1, 0);
			Function_16(&bVar4, 80, 5.0f, 1, 0);
			Function_16(&bVar4, 135, 5.0f, 1, 0);
			Function_16(&bVar4, 142, 1.0f, 1, 0);
			Function_16(&bVar4, 202, 1.0f, 1, 0);
			Function_16(&bVar4, 204, 1.0f, 1, 0);
			Function_16(&bVar4, 486, 1.0f, 1, 0);
			Function_16(&bVar4, 487, 1.0f, 1, 0);
			Function_16(&bVar4, 286, 1.0f, 1, 0);
			Function_16(&bVar4, 425, 1.0f, 1, 0);
		}
		if (Global_25974[5])
		{
			bVar5 = Function_20("pop_horseshoes", 1);
			Function_16(&bVar5, 209, 1.0f, 1, 0);
			Function_16(&bVar5, 51, 1.0f, 1, 0);
			Function_16(&bVar5, 194, 1.0f, 1, 0);
			Function_16(&bVar5, 232, 1.0f, 1, 0);
			Function_16(&bVar5, 490, 1.0f, 1, 0);
		}
	}
	bVar6 = Function_20("snakes", 0);
	Function_17(&bVar6, 1057, 8.0f, 14, 0, 0);
	...
	bVar8 = Function_20("owls", 0);
	Function_17(&bVar8, 1137, 10.0f, 49, 0, 0);
	Function_17(&bVar8, 1138, 10.0f, 49, 0, 0);
	Function_17(&bVar8, 1139, 10.0f, 49, 0, 0);
	bVar9 = Function_20("dogs", 0);
	Function_16(&bVar9, 1038, 10.0f, 0, 0);
	Function_16(&bVar9, 1039, 10.0f, 0, 0);
	Function_16(&bVar9, 1040, 10.0f, 0, 0);
	bVar10 = Function_20("racoons", 0);
	Function_17(&bVar10, 1082, 10.0f, 49, 0, 0);
	Function_17(&bVar10, 1083, 10.0f, 49, 0, 0);
	Function_17(&bVar10, 1082, 10.0f, 49, 0, 0);
	bVar11 = Function_20("rabbits", 0);
	Function_17(&bVar11, 1078, 10.0f, 49, 0, 0);
	Function_17(&bVar11, 1078, 10.0f, 49, 0, 0);
	Function_17(&bVar11, 1078, 10.0f, 49, 0, 0);
	bVar12 = Function_20("chickens", 0);
	Function_17(&bVar12, 1015, 100.0f, 15, 0, 0);
	Function_17(&bVar12, 1016, 100.0f, 15, 0, 0);
	...
	bVar13 = CREATE_POPULATION_SET(1);
	...
	if (IS_LAYOUTREF_VALID(bVar14))
	{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar0, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_8(bVar15, bVar9, 2, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("rat_pop: Cannot find ratv_vultures_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_8(bVar15, bVar12, 6, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar10, 0,00025f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar8, 0,0005f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar11, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar6, 1E-05f, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_6(bVar15, bVar3, 3, 4, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("rat_pop: Cannot find ratv_saloon to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_6(bVar15, bVar2, 2, 3, 1, 0, 1);
		}
		else
		{
		...
		if (!Function_15())
		{
			if (Global_25974[2])
			{
				...
				bVar17 = Function_8(bVar15, bVar4, 2, 1, 0, 0);
			...
			if (Global_25974[5])
			{
				...
				bVar18 = Function_8(bVar15, bVar5, 1, 1, 0, 0);
		...
		if (IS_VOLUME_VALID(bVar15))
		{
			Function_7(bVar15, bVar13, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_6(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x17DA / 6106
{
	bool bVar0;
...
var Function_7(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x185C / 6236
{
	bool bVar0;
...
var Function_8(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x18DC / 6364
{
	bool bVar0;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1AB1 / 6833
{
...
var Function_18(int iParam0) //Position: 0x1B13 / 6931
{
	bool bVar0;
...
var Function_19(int iParam0) //Position: 0x1B7F / 7039
{
	bool bVar0;
...
var Function_20(bool bParam0, int iParam1) //Position: 0x1BEB / 7147
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_21(bool bParam0, var uParam1) //Position: 0x1BF8 / 7160
{
	if (!Function_9(128))
	{
		return;
