...
void Function_72() //Position: 0x3634 / 13876
{
	...
	SNAP_ACTOR_TO_GRINGO(bLocal_19, bVar3, "UseCAse1", true, 0, 0);
...
bool Function_80(var uParam0, bool bParam1, int iParam2) //Position: 0x3B25 / 15141
{
...
void Function_85(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4268 / 17000
{
	bool bVar0;
...
bool Function_86(bool bParam0, bool bParam1) //Position: 0x42BC / 17084
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_91(int iParam0, bool bParam1) //Position: 0x446C / 17516
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_100(int iParam0) //Position: 0x47EF / 18415
{
	bool bVar0;
	bool bVar1;
...
var Function_101(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x48E9 / 18665
{
	int iVar0;
	bool bVar1;
...
void Function_102(var uParam0, int iParam1) //Position: 0x4921 / 18721
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_103(var uParam0, bool bParam1, int iParam2) //Position: 0x4932 / 18738
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x49F6 / 18934
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x4D71 / 19825
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x4DB1 / 19889
{
	int iVar0;
...
void Function_107() //Position: 0x4DDC / 19932
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(int iParam0, bool bParam1) //Position: 0x4E1E / 19998
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4EA2 / 20130
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4ECB / 20171
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x4F1C / 20252
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x4F2C / 20268
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4F40 / 20288
{
	int iVar0;
...
var Function_114() //Position: 0x4F65 / 20325
{
	return "PackedMetadata";
}

void Function_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4F7C / 20348
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_116() //Position: 0x50A2 / 20642
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_117() //Position: 0x50B3 / 20659
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_118() //Position: 0x50C4 / 20676
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_119(var uParam0, int iParam1) //Position: 0x50D5 / 20693
{
...
var Function_120(var uParam0, int iParam1, bool bParam2) //Position: 0x50F8 / 20728
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x5117 / 20759
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122() //Position: 0x5123 / 20771
{
	return Function_123(39);
}

int Function_123(bool bParam0) //Position: 0x512E / 20782
{
	bool bVar0;
...
var Function_124() //Position: 0x515C / 20828
{
	return "PackedWeapon";
}

int Function_125(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5171 / 20849
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_126() //Position: 0x5275 / 21109
{
	return "MPItemGiver";
}

struct<32> Function_127(bool bParam0) //Position: 0x5289 / 21129
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0, char* cParam1, char* cParam2) //Position: 0x52F3 / 21235
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5312 / 21266
{
	return "PBox_";
}

var Function_130() //Position: 0x5320 / 21280
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5346 / 21318
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x536E / 21358
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x5394 / 21396
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x54F5 / 21749
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x5590 / 21904
{
	int iVar0;
	vector3 vVar1;
...
void Function_136(int iParam0) //Position: 0x56F1 / 22257
{
...
var Function_137() //Position: 0x5752 / 22354
{
	int iVar0;
...
var Function_138(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x575A / 22362
{
	return Function_139(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_139(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5773 / 22387
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x5A66 / 23142
{
	int iVar0;
...
void Function_141() //Position: 0x5B1A / 23322
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x5B54 / 23380
{
	int iVar0;
...
void Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5B81 / 23425
{
	bool bVar0;
...
void Function_144() //Position: 0x5CD2 / 23762
{
	int iVar0;
...
var Function_145(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5D1D / 23837
{
	int iVar0;
...
int Function_146() //Position: 0x5DED / 24045
{
	int iVar0;
...
int Function_147() //Position: 0x5F49 / 24393
{
	int iVar0;
...
bool Function_148(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x6069 / 24681
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_149(var uParam0, int iParam1) //Position: 0x6139 / 24889
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_150(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6157 / 24919
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_151(bool bParam0) //Position: 0x6289 / 25225
{
	bool bVar0;
...
bool Function_152(int iParam0) //Position: 0x62A8 / 25256
{
	int iVar0;
...
int Function_153() //Position: 0x62C4 / 25284
{
	if (Function_155())
	{
...
int Function_154() //Position: 0x62DD / 25309
{
	return Global_79349.f_16;
}

bool Function_155() //Position: 0x62E9 / 25321
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_156(int iParam0, bool bParam1, bool bParam2) //Position: 0x62F2 / 25330
{
	var uVar0;
