...
var Function_63(var uParam0, bool bParam1, int iParam2) //Position: 0x3097 / 12439
{
	int iVar0;
...
vector3 Function_77() //Position: 0x3850 / 14416
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_78() //Position: 0x3861 / 14433
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_79() //Position: 0x3872 / 14450
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_80(var uParam0, int iParam1) //Position: 0x3883 / 14467
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x38A6 / 14502
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x38C5 / 14533
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x38D1 / 14545
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x38DC / 14556
{
	int iVar0;
...
var Function_85() //Position: 0x390A / 14602
{
	return "PackedWeapon";
}

int Function_86(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x391F / 14623
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_87() //Position: 0x3A23 / 14883
{
	return "MPItemGiver";
}

struct<32> Function_88(bool bParam0) //Position: 0x3A37 / 14903
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3AA1 / 15009
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3AC0 / 15040
{
	return "PBox_";
}

var Function_91() //Position: 0x3ACE / 15054
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3AF4 / 15092
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3B1C / 15132
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3B42 / 15170
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3CA3 / 15523
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3D3E / 15678
{
	int iVar0;
	vector3 vVar1;
...
void Function_97(int iParam0) //Position: 0x3E9F / 16031
{
...
var Function_98() //Position: 0x3F00 / 16128
{
	int iVar0;
...
var Function_99(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3F08 / 16136
{
	return Function_100(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_100(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x3F21 / 16161
{
	bool bVar0;
	bool bVar1;
	int iVar2;
