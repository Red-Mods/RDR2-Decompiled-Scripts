...
void main() //Position: 0x0 / 0
{
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_355)
		{
			...
			case 0x00000003:
				bLocal_357 = LAUNCH_NEW_SCRIPT_WITH_ARGS("AgaveViejoVol", &iScriptParam_0, 2, 0);
				Function_81(&Global_6907, &Global_8091, iScriptParam_0);
				iLocal_355 = 5;
				bLocal_356 = false;
				break;
			
			case 0x00000005:
				if (Function_80(&Global_6907, &Global_8091, iScriptParam_0))
				{
					iLocal_355 = 4;
					bLocal_356 = false;
				}
			...
			case 0x00000004:
				if (Function_79(&(Global_29008[iScriptParam_0]), 16) && Function_78(Global_29155[iScriptParam_010]))
				{
					iLocal_355 = 6;
				}
				bLocal_356 = false;
			...
			case 0x00000006:
				Function_77(0, &uLocal_358, -1483,586f, 20,894f, 3914,605f);
				Function_76(0, &uLocal_358, -1481,873f, 20,902f, 3917,322f);
				Function_75(0, &uLocal_358, -1476,716f, 17,302f, 3906,466f);
				Function_74(0, &uLocal_358, -1503,194f, 17,702f, 3908,495f);
				Function_73(0, &uLocal_358, -1481,873f, 20,902f, 3917,322f);
				Function_72(0, &uLocal_358, -1483,586f, 20,894f, 3914,605f);
				Function_71(0, &uLocal_358, Local_49);
				Function_77(1, &uLocal_358, -1502,441f, 17,702f, 3908,643f);
				Function_76(1, &uLocal_358, -1528,322f, 15,549f, 3914,941f);
				Function_75(1, &uLocal_358, -1461,306f, 16,545f, 3943,836f);
				Function_74(1, &uLocal_358, -1518,804f, 15,227f, 3932,349f);
				Function_73(1, &uLocal_358, -1461,306f, 16,545f, 3943,836f);
				Function_72(1, &uLocal_358, -1484,237f, 17,202f, 3915,965f);
				Function_71(1, &uLocal_358, Local_49);
				Function_77(2, &uLocal_358, -1508,558f, 15,069f, 3886,614f);
				Function_76(2, &uLocal_358, -1515,017f, 15,175f, 3879,03f);
				Function_75(2, &uLocal_358, -1465,326f, 16,545f, 3947,066f);
				Function_74(2, &uLocal_358, -1462,262f, 14,804f, 3850,746f);
				Function_73(2, &uLocal_358, -1465,326f, 16,545f, 3947,066f);
				Function_72(2, &uLocal_358, -1482,069f, 17,202f, 3906,694f);
				Function_71(2, &uLocal_358, Local_49);
				Function_77(3, &uLocal_358, -1465,326f, 16,545f, 3947,066f);
				Function_76(3, &uLocal_358, -1511,724f, 15,18f, 3879,456f);
				Function_75(3, &uLocal_358, -1467,337f, 16,545f, 3942,122f);
				Function_74(3, &uLocal_358, -1509,094f, 15,18f, 3882,661f);
				Function_73(3, &uLocal_358, -1457,124f, 16,545f, 3946,441f);
				Function_72(3, &uLocal_358, -1478,075f, 16,546f, 3951,656f);
				Function_71(3, &uLocal_358, Local_49);
				Function_77(4, &uLocal_358, -1462,267f, 16,546f, 3944,521f);
				Function_76(4, &uLocal_358, -1508,92f, 15,069f, 3887,885f);
				Function_75(4, &uLocal_358, -1468.0f, 16,545f, 3944,168f);
				Function_74(4, &uLocal_358, -1508,92f, 15,069f, 3887,885f);
				Function_73(4, &uLocal_358, -1468.0f, 16,545f, 3944,168f);
				Function_72(4, &uLocal_358, -1480,001f, 16,546f, 3945,905f);
				Function_71(4, &uLocal_358, Local_49);
				Function_77(5, &uLocal_358, -1492,125f, 17,202f, 3900,201f);
				Function_76(5, &uLocal_358, -1469,88f, 17,202f, 3906,603f);
				Function_75(5, &uLocal_358, -1510,918f, 15,069f, 3880,18f);
				Function_74(5, &uLocal_358, -1469,88f, 17,202f, 3906,603f);
				Function_73(5, &uLocal_358, -1473,648f, 16,546f, 3958,927f);
				Function_72(5, &uLocal_358, -1482,005f, 16,546f, 3947,177f);
				Function_71(5, &uLocal_358, Local_49);
				Function_77(6, &uLocal_358, -1483,919f, 17,194f, 3898,009f);
				Function_76(6, &uLocal_358, -1469,685f, 17,202f, 3917,537f);
				Function_75(6, &uLocal_358, -1540.0f, 14,033f, 3840,001f);
				Function_74(6, &uLocal_358, -1520,461f, 15,107f, 3931,652f);
				Function_73(3, &uLocal_358, -1509,841f, 17,416f, 3906,289f);
				Function_72(6, &uLocal_358, -1466,942f, 16,564f, 3939,209f);
				Function_71(6, &uLocal_358, Local_49);
				Function_77(7, &uLocal_358, -1502,475f, 15,034f, 3873,255f);
				Function_76(7, &uLocal_358, -1502,475f, 15,034f, 3873,255f);
				Function_75(7, &uLocal_358, -1457,509f, 16,545f, 3943,039f);
				Function_74(7, &uLocal_358, -1502,475f, 15,034f, 3873,255f);
				Function_73(7, &uLocal_358, -1457,509f, 16,545f, 3943,039f);
				Function_72(7, &uLocal_358, -1465,222f, 16,546f, 3935,87f);
				Function_71(7, &uLocal_358, Local_49);
				Function_77(8, &uLocal_358, -1452f, 16,54457f, 3937,624f);
				Function_76(8, &uLocal_358, -1546,715f, 15,034f, 3918,657f);
				Function_75(8, &uLocal_358, -1583,672f, 15,233f, 3841,704f);
				Function_74(8, &uLocal_358, -1546,715f, 15,034f, 3918,657f);
				Function_73(8, &uLocal_358, -1477,84f, 16,545f, 3937,601f);
				Function_72(8, &uLocal_358, -1509,841f, 17,416f, 3906,289f);
				Function_71(8, &uLocal_358, Local_49);
				Function_77(9, &uLocal_358, -1465,222f, 16,546f, 3935,87f);
				Function_76(9, &uLocal_358, -1583,672f, 15,233f, 3841,704f);
				Function_75(9, &uLocal_358, -1546,715f, 15,034f, 3918,657f);
				Function_74(9, &uLocal_358, -1583,672f, 15,233f, 3841,704f);
				Function_73(9, &uLocal_358, -1546,715f, 15,034f, 3918,657f);
				Function_72(9, &uLocal_358, -1477,84f, 16,545f, 3937,601f);
				Function_71(9, &uLocal_358, Local_49);
				Function_67(&Global_6907, &Global_8091, &uLocal_358, Global_6289, iScriptParam_0);
				if (Function_79(&(Global_29008[iScriptParam_0]), 256) || !Function_66(2))
				{
					iLocal_559 = 1;
				}
				if (!Function_60(3, 2, "$/content/Ambient/JobSystem/job_HorseBreaking", -1459,919f, 14,803f, 3848,309f, 327, iScriptParam_0, 15, -1.0f, 15, 0))
				{
				}
				Function_59("Initializing AgaveViejo", GET_OBJECT_FROM_PERS_CHAR(&Local_49 + 1112));
			...
			case 0x00000007:
				...
				Function_44(&Global_62527, 4, Global_30693[2], "$/content/Mexico/Mini_Games/ArmWrestling_AGV/ArmWrestling_AGV", 4294967295, 0, "AgvArmWrestling", 351, -1470,591f, 16,545f, 3946,4f, 2,5f, 0, 0);
				Function_43(&Global_62527, 4, 1);
				Function_42(&Global_62527, 4);
				iLocal_355 = 8;
				bLocal_356 = false;
				break;
			...
			case 0x00000008:
				Function_41(64);
				if (Function_36(iScriptParam_0, &Global_6907, iLocal_559))
				{
					Function_32(StackVal, 0, 0,1f, 4, Local_4, 1);
				...
				else
				{
					...
					switch (Global_30619)
					{
						case 0x00000000:
						case 0x00000001:
							Function_32(StackVal, 2, 0,5f, 4, Local_4, 1);
							break;
						
						case 0x00000002:
							Function_32(StackVal, 0, 0,5f, 4, Local_4, 1);
							break;
			...
			case 0x00000009:
				Function_23(Local_4, iScriptParam_0);
			...
			case 0x0000000A:
				if (!Function_21(Global_62981, 16))
				{
					if (Function_18(&(Global_30693[2])))
					{
						Function_17(&Global_62981, 16);
					}
				}
				if (Function_79(&(Global_29008[iScriptParam_0]), 131072))
				{
	...
	if (IS_SCRIPT_VALID(bLocal_357))
	{
		TERMINATE_SCRIPT(bLocal_357);
	}
...
void Function_7(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xCCD / 3277
{
	...
	if (StackVal != 5 && Function_16())
	{
		return;
	}
	if (Function_79(&(Global_29008[iParam2]), 0x40000000))
	{
		STREAMING_EVICT_GRINGO_DICTIONARY(GET_ASSET_ID(Function_14(iParam2), 12));
	...
	if (!Function_79(&(Global_29008[iParam2]), 8))
	{
		bParam3 = true;
	}
	bVar1 = true;
	if (!Function_66(2) || Function_79(&(Global_29008[iParam2]), 256))
	{
		bVar1 = false;
	}
	iVar0 = 0;
	...
	while (iVar0 <= *uParam0)
	{
		if (Function_13(uParam0[iVar02], 2) && !Function_13(uParam0[iVar02], 4))
		{
			Function_8(uParam0, uParam1, iVar0, bParam3);
		}
		if (bVar1)
		{
			if (Function_13(uParam0[iVar02], 2) && !Function_13(uParam0[iVar02], 4))
	...
	if (bVar1)
	{
		...
		iVar5 = GET_OBJECTSET_FROM_OBJECT(bVar4);
		if (IS_OBJECTSET_VALID(iVar5))
		{
			iVar0 = 0;
			while (GET_OBJECTSET_SIZE(iVar5) >= 0)
			{
				DESTROY_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(false, iVar5));
				CLEAN_OBJECTSET(iVar5);
			}
			DESTROY_OBJECTSET(iVar5);
		}
		if (StackVal && !(((iVar2 != 0 && iVar3 < 0) && !iParam2 != 4294967295) && !bParam3) != 3)
		{
			Function_82(&(Global_29008[iParam2]), 2048);
		}
	}
}

void Function_8(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xEB8 / 3768
{
...
int Function_9(int iParam0) //Position: 0x1007 / 4103
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_10(int iParam0) //Position: 0x1032 / 4146
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_11(var uParam0, int iParam1) //Position: 0x1066 / 4198
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_12(var uParam0, int iParam1) //Position: 0x1075 / 4213
{
	int iVar0;
...
bool Function_13(var uParam0, int iParam1) //Position: 0x108C / 4236
{
	int iVar0;
...
var Function_14(int iParam0) //Position: 0x10A8 / 4264
{
...
bool Function_15(int iParam0) //Position: 0x1556 / 5462
{
...
bool Function_16() //Position: 0x156C / 5484
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_17(var uParam0, int iParam1) //Position: 0x1575 / 5493
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_18(int iParam0) //Position: 0x1584 / 5508
{
	bool bVar0;
	
	Function_20(*iParam0);
	bVar0 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Function_20(*iParam0), 1.0f, "p_gen_chair01x", 1);
...
vector3 Function_19(int iParam0) //Position: 0x167F / 5759
{
	if (iParam0 == Global_30693[2])
	{
...
vector3 Function_20(int iParam0) //Position: 0x172E / 5934
{
	if (iParam0 == Global_30693[2])
	{
...
bool Function_21(var uParam0, int iParam1) //Position: 0x17D9 / 6105
{
	return (uParam0 && iParam1) == 0;
}

void Function_22(char* cParam0, float fParam1) //Position: 0x17E6 / 6118
{
	if (!Function_66(128))
	{
		return;
...
void Function_23(bool bParam0, bool bParam1) //Position: 0x1824 / 6180
{
	char[] cVar0[4];
...
void Function_24(var uParam0, int iParam1) //Position: 0x191E / 6430
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_25(bool bParam0) //Position: 0x192B / 6443
{
	vector3 vVar0;
...
void Function_26(var uParam0) //Position: 0x1A16 / 6678
{
	int iVar0;
...
var Function_27() //Position: 0x1A33 / 6707
{
	int iVar0;
...
void Function_28(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x1A3B / 6715
{
...
void Function_29() //Position: 0x1B1F / 6943
{
	int iVar0;
...
int Function_30(int iParam0) //Position: 0x1B6D / 7021
{
...
bool Function_31(bool bParam0) //Position: 0x1B85 / 7045
{
...
void Function_32(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x1B9A / 7066
{
	char* cVar0;
...
void Function_33(int iParam0) //Position: 0x1CAD / 7341
{
	Function_34(&Global_28842, iParam0);
	return;
}

void Function_34(var uParam0, var uParam1) //Position: 0x1CBB / 7355
{
...
void Function_35() //Position: 0x1CD6 / 7382
{
...
bool Function_36(int iParam0, var uParam1, bool bParam2) //Position: 0x1CF2 / 7410
{
	char* cVar0[64];
	struct<5> Var16;
	...
	*uParam1[02] = { StackVal, *uParam1[02] };
	...
	if (!Function_79(&(Global_29008[iParam0]), 2048))
	{
		return 0;
	}
	if (iParam0 != Global_30717[1] && Function_37(49, 0))
	{
		return 0;
	}
	if (bParam2)
...
int Function_37(var uParam0, bool bParam1) //Position: 0x1DB2 / 7602
{
	int iVar0;
...
bool Function_38(int iParam0) //Position: 0x1DEF / 7663
{
...
var Function_39(int iParam0) //Position: 0x1E06 / 7686
{
...
bool Function_40(int iParam0) //Position: 0x1E20 / 7712
{
...
void Function_41(int iParam0) //Position: 0x1E36 / 7734
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0x1E49 / 7753
{
	uParam0[iParam140]->f_128 |= 2097152;
	return;
}

void Function_43(var uParam0, int iParam1, float fParam2) //Position: 0x1E64 / 7780
{
...
void Function_44(var uParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, char* cParam6, int iParam7, vector3 vParam8, int iParam11, bool bParam12, int iParam13) //Position: 0x1E88 / 7816
{
	if (Function_16() && !bParam12)
	{
		return;
	}
	if (!Function_16() && bParam12)
	...
	uParam0[bParam140]->f_4 = Function_53(bParam2, bParam1, 4);
	...
	*(uParam0[bParam140] + 52) = { StackVal, StackVal, vParam8 };
	...
	if (Global_25974[bParam1] && Function_52(bParam1))
	{
		Function_45(StackVal, StackVal, bParam2, (1 + bParam1), vParam8, 63);
	}
	uParam0[bParam140]->f_140 = 1;
	uParam0[bParam140]->f_128 |= 8192;
}

int Function_45(int iParam0, int iParam1, vector3 vParam2, int iParam5) //Position: 0x1FD4 / 8148
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_51(StackVal, StackVal, vParam2))
	{
		return 0;
	}
	iVar2 = Function_50(iParam1);
	iVar1 = 4294967295;
	uVar3 = Function_49(StackVal, StackVal, vParam2);
	...
	{
		Function_48(uVar3);
		vVar7 = { StackVal, StackVal, Function_48(uVar3) };
		iVar0 = 0;
		while (iVar0 <= Global_9724)
		{
			if (StackVal != 0 && iVar1 != 4294967295)
			...
			else if (StackVal == iParam1)
			{
				...
				vVar4 = { StackVal, StackVal, Function_48(StackVal) };
				if (Function_47(StackVal, StackVal, StackVal, StackVal, vVar4, vVar7))
				{
					return iVar0;
				}
			}
	...
	if (iVar1 != 4294967295)
	{
		...
		Global_9724[iVar1] = ADD_BLIP_FOR_COORD(&vParam2, Function_46(iParam1), 0.0f, 2, iVar2);
		if (iParam1 == 23)
		{
...
int Function_46(bool bParam0) //Position: 0x21B7 / 8631
{
	switch (bParam0)
	{
		case 0x00000001:
...
bool Function_47(vector3 vParam0, vector3 vParam3) //Position: 0x22EE / 8942
{
	vector3 vVar0;
...
vector3 Function_48(int iParam0) //Position: 0x231B / 8987
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_49(vector3 vParam0) //Position: 0x2372 / 9074
{
	bool bVar0;
...
int Function_50(int iParam0) //Position: 0x23C0 / 9152
{
	switch (iParam0)
	{
		case 0x00000001:
...
bool Function_51(vector3 vParam0) //Position: 0x2478 / 9336
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_52(int iParam0) //Position: 0x2490 / 9360
{
	int iVar0;
...
int Function_53(bool bParam0, bool bParam1, bool bParam2) //Position: 0x24B3 / 9395
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	iVar1 = Function_57(bParam0, bParam1, bParam2);
	iVar0 = 0;
	while (iVar0 <= 275)
	{
		...
		{
			return Function_54(bParam0, bParam1, bParam2, iVar0);
		}
		iVar0++;
	}
	return Function_54(bParam0, bParam1, bParam2, 4294967295);
}

int Function_54(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2511 / 9489
{
	var uVar0;
	
	if (!Function_56(bParam2))
	{
		return 4294967295;
	}
	...
	uVar0 = Function_57(bParam0, bParam1, bParam2);
	if (bParam3 != 4294967295 || bParam3 <= 275)
	{
		bParam3 = Function_55(uVar0);
	}
...
int Function_55(int iParam0) //Position: 0x2666 / 9830
{
	int iVar0;
...
bool Function_56(int iParam0) //Position: 0x26A4 / 9892
{
...
var Function_57(int iParam0, int iParam1, int iParam2) //Position: 0x26B9 / 9913
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_58(var uParam0, int iParam1) //Position: 0x26D9 / 9945
{
	int iVar0;
...
void Function_59(var uParam0, bool bParam1) //Position: 0x26F0 / 9968
{
	bool bVar0;
...
bool Function_60(int iParam0, bool bParam1, vector3 vParam2, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) //Position: 0x2738 / 10040
{
	var uVar0;
	...
	*(&Global_62484[iParam014] + 36) = { StackVal, StackVal, vParam2 };
	...
	uVar0 = Function_53(uParam7, iParam0, 6);
	if (Function_65(uVar0) == 0)
	{
		Function_62(uVar0, MAKE_TIME_OF_DAY_EX(true, false, 0, 0));
	}
	uParam11 = uParam11;
	Function_61(&(Global_62484[iParam014]), 24);
	return 1;
}

void Function_61(var uParam0, int iParam1) //Position: 0x27DB / 10203
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_62(int iParam0, int iParam1) //Position: 0x27EA / 10218
{
...
bool Function_63(int iParam0) //Position: 0x2805 / 10245
{
...
bool Function_64(int iParam0) //Position: 0x2829 / 10281
{
...
int Function_65(int iParam0) //Position: 0x283E / 10302
{
	if (!Function_38(iParam0))
	{
		return 4294967295;
...
bool Function_66(int iParam0) //Position: 0x2858 / 10328
{
	int iVar0;
...
void Function_67(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2874 / 10356
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_79(&(Global_29008[iParam4]), 256))
	{
		return;
	}
	iVar0 = 0;
...
bool Function_68(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x2926 / 10534
{
	int iVar0;
	char* cVar1[16];
	
	iVar0 = uParam2;
	if (Function_79(&(Global_29008[iParam5]), 256))
	{
		return 1;
	}
	if (!Function_13(uParam0, 2))
	{
		return 1;
	}
	if (Function_13(uParam0, 4))
	{
	...
	if (!IS_PERS_CHAR_VALID(StackVal))
	{
		uParam1->f_8 = Function_70(StackVal, StackVal, StackVal, uParam4, &cVar1, *uParam1, *uParam3[iVar020], uParam3[iVar020]->f_76);
		PRINTSTRING("Creating guy with a position of: ");
		PRINTVECTOR(*uParam3[iVar020]);
		PRINTNL();
		if (Function_51(StackVal, StackVal, *uParam3[iVar020]))
		{
...
int Function_69(int iParam0, bool bParam1) //Position: 0x2A91 / 10897
{
	vector3 vVar0;
	bool bVar20;
	...
	{
		if (!Function_51(StackVal, StackVal, *bParam1))
		{
			vVar0 = { StackVal, StackVal, *bParam1 };
		}
		if (!Function_51(StackVal, StackVal, *(bParam1 + 12)))
		{
			*(&vVar0 + 12) = { StackVal, StackVal, *(bParam1 + 12) };
		}
		if (!Function_51(StackVal, StackVal, *(bParam1 + 24)))
		{
			*(&vVar0 + 24) = { StackVal, StackVal, *(bParam1 + 24) };
		}
		if (!Function_51(StackVal, StackVal, *(bParam1 + 36)))
		{
			*(&vVar0 + 36) = { StackVal, StackVal, *(bParam1 + 36) };
		}
		if (!Function_51(StackVal, StackVal, *(bParam1 + 48)))
		{
			*(&vVar0 + 48) = { StackVal, StackVal, *(bParam1 + 48) };
		}
		if (!Function_51(StackVal, StackVal, *(bParam1 + 60)))
		{
...
var Function_70(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x2BCD / 11213
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
...
void Function_71(int iParam0, var uParam1, bool bParam2) //Position: 0x2CE6 / 11494
{
	bool bVar0;
...
void Function_72(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2D41 / 11585
{
	bool bVar0;
	
	bVar0 = iParam0;
	if (Function_47(StackVal, StackVal, vParam2, 0.0f, 0.0f, 0.0f))
	{
...
void Function_73(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2DA7 / 11687
{
	bool bVar0;
...
void Function_74(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2E0F / 11791
{
	bool bVar0;
...
void Function_75(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2E79 / 11897
{
	bool bVar0;
...
void Function_76(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2EDE / 11998
{
	bool bVar0;
...
void Function_77(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2F46 / 12102
{
	bool bVar0;
...
int Function_78(int iParam0) //Position: 0x2FA9 / 12201
{
	if (!Function_15(iParam0))
	{
		return 1;
	}
	return Function_79(&(Global_29008[iParam0]), 4);
}

bool Function_79(var uParam0, int iParam1) //Position: 0x2FC5 / 12229
{
	int iVar0;
...
bool Function_80(var uParam0, var uParam1, int iParam2) //Position: 0x2FE1 / 12257
{
	int iVar0;
	
	iVar0 = 0;
	if (!Function_15(iParam2))
	{
		return 1;
	}
	if (StackVal != 5 && Function_16())
	...
	if (Function_79(&(Global_29008[iParam2]), 0x40000000))
	{
		if (!STREAMING_IS_GRINGO_DICTIONARY_LOADED(GET_ASSET_ID(Function_14(iParam2), 12)))
		{
			return 0;
		}
	}
...
void Function_81(var uParam0, var uParam1, int iParam2) //Position: 0x30AD / 12461
{
	int iVar0;
	...
	if (!Function_79(&(Global_29008[iParam2]), 0x40000000))
	{
		if (_IS_TYPE_ID_VALID_BY_STRING(Function_14(iParam2), 12))
		{
			STREAMING_REQUEST_GRINGO_DICTIONARY(GET_ASSET_ID(Function_14(iParam2), 12));
...
void Function_82(var uParam0, int iParam1) //Position: 0x3183 / 12675
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_83() //Position: 0x3192 / 12690
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_91(3, 3);
	bVar0 = bVar0;
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/lean_rail", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_table", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/knl_hoe_soil", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand_nospawn", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/mex_washcloths", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_guntricks_e_any", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_pocketwatch_e_any", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/repair_kneel", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_horseshoe", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_l_talking", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_h_talking", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/multistage_hoe", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/horse_tend", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/multistage_bucket", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/milk_cow", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_wall", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_l", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/sleeping_wall_scripted", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_yawning_n_any", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/sit_no_table", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/skin_scraper", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_drink", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/sit_camp_coffee_drink", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_l", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_r", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/multistage_sweeping", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/arm_wrestling_spectate", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/lean_table", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/fivefingerfillet_spectate_c", 1, 0);
	Function_89(&Local_49 + 4, "$/content/scripting/gringo/simplegringo/mex_stool_sit", 1, 0);
	if (!Function_84(&Local_49 + 4))
	{
		return 0;
	}
	...
	*(&Local_49 + 492[06] + 12) = { 0.0f, 204,9791f, 0.0f };
	bVar1 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag9", -1468,988f, 17,2016f, 3905,636f, 0.0f, 204,9791f, 0.0f);
	DECOR_SET_STRING(bVar1, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar1, Local_49.f_488);
	*(&Local_49 + 492[16]) = { -1471,727f, 17,2016f, 3908,184f };
	*(&Local_49 + 492[16] + 12) = { 0.0f, 202,8735f, 0.0f };
	bVar2 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag1", -1471,727f, 17,2016f, 3908,184f, 0.0f, 202,8735f, 0.0f);
	DECOR_SET_STRING(bVar2, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar2, Local_49.f_488);
	*(&Local_49 + 492[26]) = { -1468,956f, 17,2016f, 3910,515f };
	*(&Local_49 + 492[26] + 12) = { 0.0f, 202,4568f, 0.0f };
	bVar3 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag2", -1468,956f, 17,2016f, 3910,515f, 0.0f, 202,4568f, 0.0f);
	DECOR_SET_STRING(bVar3, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar3, Local_49.f_488);
	*(&Local_49 + 492[36]) = { -1470,302f, 17,2016f, 3919,103f };
	*(&Local_49 + 492[36] + 12) = { 0.0f, 64,63643f, 0.0f };
	bVar4 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag3", -1470,302f, 17,2016f, 3919,103f, 0.0f, 64,63643f, 0.0f);
	DECOR_SET_STRING(bVar4, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar4, Local_49.f_488);
	*(&Local_49 + 492[46]) = { -1470,819f, 17,2016f, 3920,492f };
	*(&Local_49 + 492[46] + 12) = { 0.0f, -223,0396f, 0.0f };
	bVar5 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag4", -1470,819f, 17,2016f, 3920,492f, 0.0f, -223,0396f, 0.0f);
	DECOR_SET_STRING(bVar5, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar5, Local_49.f_488);
	*(&Local_49 + 492[56]) = { -1482,949f, 17,2016f, 3919,032f };
	*(&Local_49 + 492[56] + 12) = { 0.0f, 522,4911f, 0.0f };
	bVar6 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag5", -1482,949f, 17,2016f, 3919,032f, 0.0f, 522,4911f, 0.0f);
	DECOR_SET_STRING(bVar6, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar6, Local_49.f_488);
	*(&Local_49 + 492[66]) = { -1481,847f, 17,2016f, 3904,302f };
	*(&Local_49 + 492[66] + 12) = { 0.0f, 350,8373f, 0.0f };
	bVar7 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag6", -1481,847f, 17,2016f, 3904,302f, 0.0f, 350,8373f, 0.0f);
	DECOR_SET_STRING(bVar7, "UseAnim", "work");
	ADD_OBJECT_TO_OBJECTSET(bVar7, Local_49.f_488);
	*(&Local_49 + 492[76]) = { -1469,644f, 17,202f, 3904,231f };
	*(&Local_49 + 492[76] + 12) = { 0.0f, -0,1112507f, 0.0f };
	bVar8 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag102", -1469,644f, 17,202f, 3904,231f, 0.0f, -0,1112507f, 0.0f);
	DECOR_SET_STRING(bVar8, "UseAnim", "exit");
	ADD_OBJECT_TO_OBJECTSET(bVar8, Local_49.f_488);
	...
	*(&Local_49 + 692[06] + 12) = { 0.0f, -1,757305f, 0.0f };
	bVar9 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag15", -1522,798f, 14,99596f, 3930,805f, 0.0f, -1,757305f, 0.0f);
	DECOR_SET_STRING(bVar9, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar9, Local_49.f_688);
	*(&Local_49 + 692[16]) = { -1515,347f, 15,50746f, 3931,501f };
	*(&Local_49 + 692[16] + 12) = { 0.0f, -112,0334f, 0.0f };
	bVar10 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag11", -1515,347f, 15,50746f, 3931,501f, 0.0f, -112,0334f, 0.0f);
	DECOR_SET_STRING(bVar10, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar10, Local_49.f_688);
	*(&Local_49 + 692[26]) = { -1520.0f, 15,03867f, 3928,006f };
	*(&Local_49 + 692[26] + 12) = { 0.0f, 0.0f, 0.0f };
	bVar11 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag12", -1520.0f, 15,03867f, 3928,006f, 0.0f, 0.0f, 0.0f);
	DECOR_SET_STRING(bVar11, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar11, Local_49.f_688);
	*(&Local_49 + 692[36]) = { -1514,47f, 15,65978f, 3930,477f };
	*(&Local_49 + 692[36] + 12) = { 0.0f, 0.0f, 0.0f };
	bVar12 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag13", -1514,47f, 15,65978f, 3930,477f, 0.0f, 0.0f, 0.0f);
	DECOR_SET_STRING(bVar12, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar12, Local_49.f_688);
	*(&Local_49 + 692[46]) = { -1525,43f, 15,43945f, 3916,006f };
	*(&Local_49 + 692[46] + 12) = { 0.0f, -196,1929f, 0.0f };
	bVar13 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag14", -1525,43f, 15,43945f, 3916,006f, 0.0f, -196,1929f, 0.0f);
	DECOR_SET_STRING(bVar13, "UseAnim", "DropBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar13, Local_49.f_688);
	...
	*(&Local_49 + 820[06] + 12) = { 0.0f, 26,758f, 0.0f };
	bVar14 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag97", -1468,873f, 14,804f, 3846,249f, 0.0f, 26,758f, 0.0f);
	DECOR_SET_STRING(bVar14, "UseAnim", "putdown");
	ADD_OBJECT_TO_OBJECTSET(bVar14, Local_49.f_816);
	...
	*(&Local_49 + 852[06] + 12) = { 0.0f, 16,139f, 0.0f };
	bVar15 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag96", -1547,739f, 14,195f, 3838,161f, 0.0f, 16,139f, 0.0f);
	DECOR_SET_STRING(bVar15, "UseAnim", "putdown");
	ADD_OBJECT_TO_OBJECTSET(bVar15, Local_49.f_848);
	...
	*(&Local_49 + 884[06] + 12) = { 0.0f, 352,2283f, 0.0f };
	bVar16 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag108", -1468,104f, 17,202f, 3905,31f, 0.0f, 352,2283f, 0.0f);
	DECOR_SET_STRING(bVar16, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar16, Local_49.f_880);
	*(&Local_49 + 884[16]) = { -1468,743f, 17,2016f, 3913,167f };
	*(&Local_49 + 884[16] + 12) = { 0.0f, 358,0765f, 0.0f };
	bVar17 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag105", -1468,743f, 17,2016f, 3913,167f, 0.0f, 358,0765f, 0.0f);
	DECOR_SET_STRING(bVar17, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar17, Local_49.f_880);
	*(&Local_49 + 884[26]) = { -1471,062f, 17,202f, 3918,815f };
	*(&Local_49 + 884[26] + 12) = { 0.0f, 63,388f, 0.0f };
	bVar18 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag106", -1471,062f, 17,202f, 3918,815f, 0.0f, 63,388f, 0.0f);
	DECOR_SET_STRING(bVar18, "UseAnim", "PourBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar18, Local_49.f_880);
	*(&Local_49 + 884[36]) = { -1484f, 17,18989f, 3897,185f };
	*(&Local_49 + 884[36] + 12) = { 0.0f, -183,3923f, 0.0f };
	bVar19 = CREATE_POINT_IN_LAYOUT(Local_49, "Flag107", -1484f, 17,18989f, 3897,185f, 0.0f, -183,3923f, 0.0f);
	DECOR_SET_STRING(bVar19, "UseAnim", "DropBucket");
	ADD_OBJECT_TO_OBJECTSET(bVar19, Local_49.f_880);
	...
	*(&Local_49 + 988[46] + 12) = { 0.0f, 352,9069f, 0.0f };
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bVar0), 1);
	Local_49.f_1112 = CREATE_OBJECTSET_IN_LAYOUT(Function_27(), Local_49, 12, 0);
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(false, Local_49.f_1112)), 0);
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(true, Local_49.f_1112)), 0);
...
bool Function_84(int iParam0) //Position: 0x6AA9 / 27305
{
	int iVar0;
	int iVar1;
...
void Function_85() //Position: 0x6E24 / 28196
{
	if (!Function_66(128))
	{
		return;
...
bool Function_86() //Position: 0x6E64 / 28260
{
	int iVar0;
...
void Function_87(var uParam0, int iParam1) //Position: 0x6E8F / 28303
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_88() //Position: 0x6EA0 / 28320
{
	if (!Function_66(128))
	{
		return;
...
var Function_89(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x6EE2 / 28386
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_90(uParam0, bVar1, iParam2);
	if (bParam3)
	{
		Function_87(uParam0[iVar03], 8);
	}
	return iVar0;
}

var Function_90(var uParam0, int iParam1, int iParam2) //Position: 0x6F1A / 28442
{
	int iVar0;
...
void Function_91(int iParam0, int iParam1) //Position: 0x6FDE / 28638
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_92() //Position: 0x7027 / 28711
{
	var uVar0;
