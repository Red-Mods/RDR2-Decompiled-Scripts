...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			iLocal_131 = Function_34(Local_133);
			if (iLocal_131 == 0)
			{
				iLocal_131 = 20;
			}
			if (Function_32() <= iLocal_131)
			{
		...
		case 0x00000001:
			if (Function_25(Global_30685[0], &Local_151 + 4, GET_PLAYER_ACTOR(0)))
			{
				Function_24(Global_30685[0]);
				*(&Local_151 + 32) = { StackVal, StackVal, Function_24(Global_30685[0]) };
				Local_151.f_44 = Function_23(Global_30685[0]);
				Function_22(&Local_151 + 4);
				iVar0 = 0;
				while (iVar0 <= 6)
				{
					Function_21(Global_30685[0], iVar0);
					*(&Local_151 + 56[iVar03]) = { StackVal, StackVal, Function_21(Global_30685[0], iVar0) };
					iVar0++;
				}
...
{
	bLocal_132 = CREATE_LAYOUT(Function_46());
	Function_44(0, 1);
	Function_43();
	Function_37(&uLocal_140);
	Function_37(&iLocal_146);
	Function_37(&iLocal_143);
	iLocal_0 = 0;
	iLocal_1 = 0;
	if (!iLocal_1 != 0)
	{
