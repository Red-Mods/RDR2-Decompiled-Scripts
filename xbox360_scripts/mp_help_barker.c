...
void Function_1(char* cParam0, int iParam1) //Position: 0x4C / 76
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_2(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0xBD / 189
{
	int iVar0;
