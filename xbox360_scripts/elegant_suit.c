...
{
	uParam0 = Function_90(uParam0);
	*iParam2 = 0;
	if ((Function_86(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	if (!Function_85(3, 1))
	{
		Function_53(3, 1, 1, 0, 0);
		*iParam2 = 1;
	}
	return;
}

void Function_53(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x234A / 9034
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_82(bParam0, 2))
	{
		...
		Function_80(bParam0, 2);
		if (!bParam2)
		{
			cVar8 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, cVar0 };
			stradd(&cVar8, "_tip", 32);
			Function_79(&cVar8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_78(bParam0, bParam1))
	{
		Global_27774[bParam013].f_4 = (StackVal || bParam1);
		Function_80(bParam0, 1048576);
		if (bParam4)
		{
		...
		Function_72(bParam0);
		if (StackVal && !Function_70(((((!Function_71() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, 0, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_70((((Function_71() || Global_3380) || Global_3392) || Global_3384), 1))
		{
		...
		{
			Function_64(Global_34573, 2, 1, 0);
		}
...
void Function_54(int iParam0, bool bParam1) //Position: 0x25D9 / 9689
{
	bool bVar0;
...
void Function_55(int iParam0, bool bParam1) //Position: 0x2640 / 9792
{
	if (iParam0 >= 16)
	{
		LOG_ERROR("STAT_SET_BIT: Attempting to use a Stat out of bounds.");
...
void Function_56() //Position: 0x269F / 9887
{
	if (Function_84(Global_28180))
	{
		if (Global_28180.f_12)
		{
			...
			Global_28180.f_4 = Function_63(Global_28180);
...
var Function_57(int iParam0, int iParam1) //Position: 0x271A / 10010
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_58(int iParam0) //Position: 0x330B / 13067
{
...
int Function_59(int iParam0, bool bParam1) //Position: 0x3320 / 13088
{
	int iVar0;
...
bool Function_60(int iParam0) //Position: 0x335D / 13149
{
...
var Function_61(int iParam0) //Position: 0x3374 / 13172
{
...
bool Function_62(int iParam0) //Position: 0x338E / 13198
{
...
int Function_63(int iParam0) //Position: 0x33A4 / 13220
{
	int iVar0;
	int iVar1;
...
void Function_64(bool bParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x33F3 / 13299
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_66(bParam0, uParam1, uParam2) && !bParam3)
	{
		return;
	}
...
void Function_65(char* cParam0, int iParam1) //Position: 0x345F / 13407
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_66(bool bParam0, var uParam1, int iParam2) //Position: 0x3496 / 13462
{
	var uVar0;
	char* cVar1[16];
...
int Function_67(char* cParam0) //Position: 0x350E / 13582
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_68(int iParam0) //Position: 0x35AF / 13743
{
	int iVar0;
	int iVar1;
...
bool Function_69(var uParam0, int iParam1) //Position: 0x35EC / 13804
{
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x35FF / 13823
{
	return (bParam0 && bParam1) == 0;
}

bool Function_71() //Position: 0x360C / 13836
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_72(bool bParam0) //Position: 0x3639 / 13881
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (!IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 0) && !IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 1))
	{
		...
		while (bVar24 <= Global_27774[bParam013].f_28)
		{
			...
			if (Function_78(bParam0, Function_76(bVar24)))
			{
	...
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_75(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), false, 0);
		Function_74(Global_27774[bParam013].f_48, 0);
		straddi(&cVar8, Function_73(bParam0), 32);
		SET_JOURNAL_ENTRY_CURRENT_OBJECTIVE(Global_27774[bParam013].f_48, &cVar8, 3);
	}
	return;
}

int Function_73(int iParam0) //Position: 0x37E9 / 14313
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_74(bool bParam0, bool bParam1) //Position: 0x3840 / 14400
{
	bool bVar0;
...
var Function_75(int iParam0) //Position: 0x3865 / 14437
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_76(bool bParam0) //Position: 0x38BB / 14523
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_77() //Position: 0x38C7 / 14535
{
	return;
}

bool Function_78(bool bParam0, int iParam1) //Position: 0x38CD / 14541
{
	int iVar0;
...
void Function_79(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x392C / 14636
{
	int iVar0;
...
void Function_80(int iParam0, int iParam1) //Position: 0x3977 / 14711
{
	if (!Function_84(iParam0))
	{
...
int Function_81(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x39CC / 14796
{
	int iVar0;
	int iVar1;
...
bool Function_82(int iParam0, int iParam1) //Position: 0x3BEC / 15340
{
	int iVar0;
...
bool Function_83(int iParam0) //Position: 0x3C19 / 15385
{
...
bool Function_84(int iParam0) //Position: 0x3C35 / 15413
{
...
bool Function_85(int iParam0, int iParam1) //Position: 0x3C4B / 15435
{
	int iVar0;
...
int Function_86(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3CAA / 15530
{
...
bool Function_87() //Position: 0x3D60 / 15712
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_88(bool bParam0) //Position: 0x3D77 / 15735
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_89(bool bParam0) //Position: 0x3D82 / 15746
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_90(bool bParam0) //Position: 0x3D90 / 15760
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_91(int iParam0, bool bParam1) //Position: 0x3DAA / 15786
{
	bool bVar0;
	bool bVar1;
