	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_98, &bLocal_97);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D04 / 7428
{
	bool bVar0;
	var uVar1;
...
void Function_62(bool bParam0) //Position: 0x25BA / 9658
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2879 / 10361
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28D6 / 10454
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2933 / 10547
{
	iParam0 = iParam0;
	return;
}
...
void Function_67(int iParam0) //Position: 0x295B / 10587
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2970 / 10608
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29F7 / 10743
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A1A / 10778
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A38 / 10808
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A5B / 10843
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B76 / 11126
{
...
int Function_74(bool bParam0) //Position: 0x2BA1 / 11169
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CA6 / 11430
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CB3 / 11443
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D26 / 11558
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_97));
		iLocal_98 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x3224 / 12836
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x325B / 12891
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3278 / 12920
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32B0 / 12976
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32BA / 12986
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x32DB / 13019
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32E9 / 13033
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33F1 / 13297
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3407 / 13319
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36BD / 14013
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x36CB / 14027
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x36E4 / 14052
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x36FE / 14078
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3736 / 14134
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x374D / 14157
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A16 / 14870
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A33 / 14899
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3ACF / 15055
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x3AEE / 15086
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_97(bool bParam0, bool bParam1) //Position: 0x3BD7 / 15319
{
	GET_POSITION(bParam0, bParam1);
	return;
}

bool Function_98(int iParam0) //Position: 0x3BE4 / 15332
{
...
void Function_99(int iParam0) //Position: 0x3C00 / 15360
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C0A / 15370
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3C6C / 15468
{
...
void Function_102(int iParam0) //Position: 0x3C80 / 15488
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3C8A / 15498
{
