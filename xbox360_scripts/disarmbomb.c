...
float Function_23(bool bParam0) //Position: 0x1CD5 / 7381
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_24() //Position: 0x1CEB / 7403
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_25(bool bParam0) //Position: 0x1CF8 / 7416
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_26(var uParam0, int iParam1) //Position: 0x1D18 / 7448
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1D27 / 7463
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D46 / 7494
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D4C / 7500
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D5A / 7514
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D65 / 7525
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D7F / 7551
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1D9D / 7581
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DBC / 7612
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DEF / 7663
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E0E / 7694
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E28 / 7720
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E3B / 7739
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2123 / 8483
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x212B / 8491
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2148 / 8520
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2157 / 8535
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2179 / 8569
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x219D / 8605
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21BA / 8634
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21DA / 8666
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x21FA / 8698
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x22A8 / 8872
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2318 / 8984
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x232E / 9006
{
...
var Function_51(bool bParam0) //Position: 0x234F / 9039
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x236F / 9071
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2383 / 9091
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x238D / 9101
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2394 / 9108
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x23A3 / 9123
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x23E2 / 9186
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x240D / 9229
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2418 / 9240
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x250E / 9486
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2530 / 9520
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2557 / 9559
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x2816 / 10262
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2873 / 10355
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28D0 / 10448
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28DA / 10458
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x28F8 / 10488
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x290D / 10509
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2994 / 10644
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29B7 / 10679
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29D5 / 10709
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x29F8 / 10744
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B13 / 11027
{
...
int Function_74(bool bParam0) //Position: 0x2B3E / 11070
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C43 / 11331
{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CC3 / 11459
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31C2 / 12738
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x31F9 / 12793
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3216 / 12822
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x324E / 12878
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3258 / 12888
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

int Function_83(bool bParam0, int iParam1) //Position: 0x3279 / 12921
{
	bool bVar0;
	...
	GIVE_WEAPON_TO_ACTOR(GET_PLAYER_ACTOR(0), 24, false, 1, 1);
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3339 / 13113
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3441 / 13377
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3457 / 13399
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x370D / 14093
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x371B / 14107
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3734 / 14132
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x374E / 14158
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3786 / 14214
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x379D / 14237
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A66 / 14950
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A83 / 14979
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B1F / 15135
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B3E / 15166
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B4D / 15181
{
...
void Function_98(int iParam0) //Position: 0x3B69 / 15209
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B73 / 15219
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BD5 / 15317
{
...
void Function_101(int iParam0) //Position: 0x3BE9 / 15337
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BF3 / 15347
{
