...
void Function_26(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xC00 / 3072
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
struct<32> Function_30(char* cParam0, char* cParam1) //Position: 0x133B / 4923
{
	char* cVar0[32];
...
int Function_38(int iParam0) //Position: 0x18D0 / 6352
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
struct<32> Function_39(bool bParam0) //Position: 0x19F4 / 6644
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_40(char* cParam0, char* cParam1, char* cParam2) //Position: 0x1A5E / 6750
{
	char* cVar0[32];
...
vector3 Function_41(bool bParam0) //Position: 0x1A7D / 6781
{
	vector3 vVar0;
...
int Function_42(char* cParam0, var uParam1, var uParam2, var uParam3, char* cParam4, var uParam5) //Position: 0x1AA4 / 6820
{
	int iVar0;
...
void Function_43() //Position: 0x1B23 / 6947
{
	int iVar0;
...
bool Function_44(int iParam0) //Position: 0x1B8C / 7052
{
	if (!Function_6(iParam0))
	{
		return 0;
...
void Function_45(bool bParam0, float fParam1) //Position: 0x1BAA / 7082
{
	if (!Function_46(128))
	{
		return;
...
bool Function_46(int iParam0) //Position: 0x1BE8 / 7144
{
	int iVar0;
...
void Function_47(bool bParam0, bool bParam1) //Position: 0x1C04 / 7172
{
	char[] cVar0[4];
...
void Function_48(var uParam0, bool bParam1) //Position: 0x1CFE / 7422
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &bParam1);
	return;
}

void Function_49(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x1D0B / 7435
{
	bool bVar0;
...
void Function_50(int iParam0) //Position: 0x1E1E / 7710
{
	Function_51(&Global_28842, iParam0);
	return;
}

void Function_51(var uParam0, var uParam1) //Position: 0x1E2C / 7724
{
...
void Function_52() //Position: 0x1E47 / 7751
{
...
bool Function_53() //Position: 0x1E63 / 7779
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_54(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x1E6C / 7788
{
...
void Function_55() //Position: 0x1F50 / 8016
{
	int iVar0;
...
int Function_56(int iParam0) //Position: 0x1F9E / 8094
{
...
bool Function_57(int iParam0) //Position: 0x1FB6 / 8118
{
...
void Function_58(int iParam0) //Position: 0x1FCB / 8139
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_59(var uParam0, int iParam1) //Position: 0x1FDE / 8158
{
	int iVar0;
...
int Function_60(int iParam0) //Position: 0x1FF5 / 8181
{
	if (!Function_6(iParam0))
	{
		return 1;
...
bool Function_61(var uParam0, int iParam1) //Position: 0x2011 / 8209
{
	int iVar0;
...
void Function_62(var uParam0, int iParam1) //Position: 0x202D / 8237
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_63() //Position: 0x203C / 8252
{
	bool bVar0;
...
bool Function_64(int iParam0) //Position: 0x318D / 12685
{
	int iVar0;
	int iVar1;
...
void Function_65() //Position: 0x3508 / 13576
{
	if (!Function_46(128))
	{
		return;
...
bool Function_66() //Position: 0x3548 / 13640
{
	int iVar0;
...
void Function_67(var uParam0, int iParam1) //Position: 0x3573 / 13683
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_68() //Position: 0x3584 / 13700
{
	if (!Function_46(128))
	{
		return;
...
var Function_69(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x35C6 / 13766
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_70(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_70(var uParam0, int iParam1, int iParam2) //Position: 0x35FE / 13822
{
	int iVar0;
...
void Function_71(int iParam0, int iParam1) //Position: 0x36C2 / 14018
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_72() //Position: 0x370B / 14091
{
	var uVar0;
...
var Function_73(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9) //Position: 0x5017 / 20503
{
	uParam0 = uParam0;
	uParam1 = uParam1;
	uParam2 = uParam2;
...
void Function_74(bool bParam0, int iParam1) //Position: 0x5041 / 20545
{
	if (!Function_46(128))
	{
		return;
...
int Function_75(int iParam0) //Position: 0x507C / 20604
{
	if (Global_3421)
	{
		return 0;
