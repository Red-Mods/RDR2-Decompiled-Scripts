	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_22, &bLocal_21);
...
void Function_62(bool bParam0) //Position: 0x2548 / 9544
{
	...
	if (bLocal_0)
	{
		...
		{
			iLocal_1 = 1;
			iLocal_2 = CREATE_LAYOUT("PickupMolotov_Layout");
			Function_63(iLocal_2, 0, Global_34573, 1, 0, 0);
		}
	}
	return;
}
...
void Function_64(var uParam0, int iParam1) //Position: 0x2602 / 9730
{
	bool bVar0;
	bool bVar1;
	...
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 10.0f, 0);
	ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(bVar1, 10.0f, 1, 0);
	return;
}

void Function_65(var uParam0, bool bParam1) //Position: 0x263A / 9786
{
...
void Function_66(int iParam0) //Position: 0x26C6 / 9926
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26D0 / 9936
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26EE / 9966
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x2703 / 9987
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x278A / 10122
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27AD / 10157
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x27CB / 10187
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x27EE / 10222
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2909 / 10505
{
...
int Function_75(bool bParam0) //Position: 0x2934 / 10548
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A39 / 10809
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2A46 / 10822
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AB9 / 10937
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_21));
		iLocal_22 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_79() //Position: 0x2FB7 / 12215
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x2FEE / 12270
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x300B / 12299
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3043 / 12355
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x304D / 12365
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(bool bParam0, int iParam1) //Position: 0x306E / 12398
{
	bool bVar0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x30E0 / 12512
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x31E8 / 12776
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x31FE / 12798
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x34B4 / 13492
{
	iParam1 = iParam1;
	bLocal_0 = false;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_89(bool bParam0) //Position: 0x34CC / 13516
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x34E5 / 13541
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x34FF / 13567
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x3537 / 13623
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x354E / 13646
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3817 / 14359
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x3834 / 14388
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x38D0 / 14544
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(bool bParam0, int iParam1) //Position: 0x38EF / 14575
{
	bool bVar0;
	bool bVar1;
...
bool Function_98(int iParam0) //Position: 0x39C7 / 14791
{
...
void Function_99(int iParam0) //Position: 0x39E3 / 14819
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x39ED / 14829
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3A4F / 14927
{
...
void Function_102(int iParam0) //Position: 0x3A63 / 14947
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3A6D / 14957
{
