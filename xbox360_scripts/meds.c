...
bool Function_46(bool bParam0, bool bParam1, int iParam2) //Position: 0x213B / 8507
{
	bool bVar0;
...
void Function_47(bool bParam0, bool bParam1, int iParam2) //Position: 0x2167 / 8551
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_48(bool bParam0, bool bParam1) //Position: 0x21F1 / 8689
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, int iParam2) //Position: 0x229F / 8863
{
	int iVar0;
	bool bVar1;
...
var Function_50(bool bParam0) //Position: 0x22E4 / 8932
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_51(bool bParam0) //Position: 0x22FA / 8954
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x2310 / 8976
{
	bool bVar0;
	float fVar1;
	bool bVar2;
	...
	bParam0 = Function_59(bParam0);
	bVar0 = GET_ACTOR_HEALTH(bParam1);
	fVar1 = GET_ACTOR_MAX_HEALTH(bParam1);
	iVar3 = 0;
	*iParam2 = 0;
	if (IS_ACTOR_VALID(bParam1) && bVar0 > fVar1)
	{
		bVar2 = GET_GRINGO_STRING_ATTR("myItemString", bParam0, &iVar3);
		if (GET_GRINGO_FLOAT_ATTR(&fVar4, "HitPointsCuredPercent", bParam0))
		{
			fVar5 = ((fVar1 * fVar4) / 100.0f);
			bVar0 = (bVar0 + fVar5);
			if (bVar0 < fVar1)
			{
				bVar0 = fVar1;
			}
			SET_ACTOR_HEALTH(bParam1, bVar0);
	...
	{
		Function_53("user_full_health", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_53(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2471 / 9329
{
	int iVar0;
...
int Function_54(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x24BC / 9404
{
	int iVar0;
	int iVar1;
...
int Function_55(bool bParam0, bool bParam1, bool bParam2) //Position: 0x26DC / 9948
{
...
bool Function_56() //Position: 0x2792 / 10130
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_57(bool bParam0) //Position: 0x27A9 / 10153
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_58(bool bParam0) //Position: 0x27B4 / 10164
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_59(bool bParam0) //Position: 0x27C2 / 10178
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_60(int iParam0, bool bParam1) //Position: 0x27DC / 10204
{
	bool bVar0;
	bool bVar1;
