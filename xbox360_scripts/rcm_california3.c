...
void main() //Position: 0x0 / 0
{
	...
	bLocal_196 = false;
	iLocal_197 = 0;
	vLocal_199 = { -3764,832f, 25,428f, 2716,325f };
	switch (StackVal)
	{
		case 0x00000001:
			break;
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				{
					case 0x00000003:
						Function_147(&(Global_63541[ScriptParam_055]), ScriptParam_0, 0x41f00000, 0x42200000, 0);
						iVar0 = 5;
						break;
					
					case 0x00000005:
						if (Function_106("$/cutscene/RCM_08_CS03/RCM_08_CS03", &iLocal_188, 24278, 24251, 23025, 22961, 22538, 22502, 1, 1, 2, 2, 0))
						{
							iVar0 = 6;
						}
						break;
					...
					case 0x00000006:
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "California3_OBJ", 0, 4, false);
						Function_103(Global_63541[ScriptParam_055].f_140, 0);
						Function_102(&Global_63541[1155] + 144, 256);
						Function_59(12, 1, 1, 1);
						Function_8(Global_27774[613].f_48);
						Function_5();
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x22C / 556
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x247 / 583
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x264 / 612
{
	RELEASE_LAYOUT_REF(bLocal_204);
	return;
}

void Function_4(var uParam0, int iParam1) //Position: 0x26F / 623
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_5() //Position: 0x27E / 638
{
	bool bVar0;
	bool bVar1;
...
void Function_6(bool bParam0) //Position: 0x2AF / 687
{
	bool bVar0;
...
void Function_7() //Position: 0x2E9 / 745
{
...
void Function_8(bool bParam0) //Position: 0x30C / 780
{
	bool bVar0;
	int iVar1;
	int iVar2;
			...
			while (Global_63541[iVar155].f_20 == iVar2)
			{
				...
				if (!Function_47(Global_63541[iVar155].f_144, 2048))
				{
					...
					if (Function_25(&(Global_63541[iVar155]), iVar3))
					{
						...
						Function_21(&(Global_63541[iVar155]), iVar3);
...
void Function_9(int iParam0, int iParam1) //Position: 0x4AE / 1198
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = iParam0->f_96;
	iParam0->f_192 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(Global_63535, Function_20(), *(iParam0 + 112), 0.0f, 0.0f, 0.0f, iVar0, iVar0, iVar0, 0, Global_34573, iParam1, iParam0->f_92, 0, 1, 1);
	Function_10(iParam0);
...
void Function_10(int iParam0) //Position: 0x568 / 1384
{
	float fVar0;
	bool bVar1;
...
int Function_11(var uParam0, int iParam1) //Position: 0x60A / 1546
{
	int iVar0;
	var uVar1;
...
void Function_12(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x76B / 1899
{
	struct<8> Var0;
...
struct<32> Function_13(bool bParam0) //Position: 0x806 / 2054
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_14(char* cParam0, char* cParam1, char* cParam2) //Position: 0x870 / 2160
{
	char* cVar0[32];
...
int Function_15(bool bParam0) //Position: 0x88F / 2191
{
	int iVar0;
	vector3 vVar1;
...
float Function_16(bool bParam0, vector3 vParam1) //Position: 0x9F0 / 2544
{
	vector3 vVar0;
...
vector3 Function_17(bool bParam0) //Position: 0xA6A / 2666
{
	vector3 vVar0;
...
void Function_18(int iParam0) //Position: 0xAD4 / 2772
{
...
bool Function_19(int iParam0) //Position: 0xB35 / 2869
{
...
var Function_20() //Position: 0xB4B / 2891
{
	int iVar0;
...
void Function_21(int iParam0, int iParam1) //Position: 0xB53 / 2899
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	fVar3 = 1.0f;
	fVar4 = 50.0f;
	if (((StackVal && Function_23(StackVal, Function_24(iParam1), vVar0, 0x3f800000, 0x42960000, 1, 1, 0)) || Function_22(iParam1)) || Global_74542[iParam110].f_12 != 1)
	{
...
int Function_22(bool bParam0) //Position: 0xC98 / 3224
{
...
var Function_23(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0xCC4 / 3268
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_24(int iParam0) //Position: 0xCE0 / 3296
{
...
bool Function_25(int iParam0, int iParam1) //Position: 0xCF5 / 3317
{
...
bool Function_26(int iParam0, int iParam1) //Position: 0xE0A / 3594
{
	int iVar0;
...
bool Function_27(int iParam0) //Position: 0xF4E / 3918
{
...
bool Function_28(int iParam0) //Position: 0xF72 / 3954
{
...
bool Function_29(int iParam0) //Position: 0xF87 / 3975
{
...
var Function_30(int iParam0) //Position: 0xF9E / 3998
{
...
bool Function_31(int iParam0) //Position: 0xFB8 / 4024
{
...
bool Function_32(int iParam0) //Position: 0xFCE / 4046
{
	return StackVal;
}

bool Function_33(var uParam0, int iParam1) //Position: 0xFDE / 4062
{
	int iVar0;
...
bool Function_34(int iParam0) //Position: 0xFFA / 4090
{
	if (!iParam0->f_152)
	{
...
bool Function_35(int iParam0) //Position: 0x1041 / 4161
{
	...
	if (!Function_47(Global_63541[iParam055].f_144, 32768))
	{
		if ((Global_3403 || Global_3405) || Global_3404)
		{
			...
			{
				Function_36(Global_34573, 0x8000000, 2, 0);
			}
			return 1;
		}
	}
...
void Function_36(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x109A / 4250
{
	bool bVar0;
	char* cVar1[16];
...
void Function_37(char* cParam0, int iParam1) //Position: 0x1106 / 4358
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_38(bool bParam0, var uParam1, int iParam2) //Position: 0x113D / 4413
{
	var uVar0;
	char* cVar1[16];
...
int Function_39(char* cParam0) //Position: 0x11B5 / 4533
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_40(int iParam0) //Position: 0x1256 / 4694
{
	int iVar0;
	int iVar1;
...
bool Function_41(var uParam0, int iParam1) //Position: 0x1293 / 4755
{
...
bool Function_42(int iParam0) //Position: 0x12A6 / 4774
{
	int iVar0;
...
bool Function_43(var uParam0, int iParam1) //Position: 0x12C2 / 4802
{
	int iVar0;
...
int Function_44(int iParam0) //Position: 0x12DE / 4830
{
...
bool Function_45(int iParam0) //Position: 0x12F3 / 4851
{
...
int Function_46(int iParam0) //Position: 0x1308 / 4872
{
...
bool Function_47(var uParam0, bool bParam1) //Position: 0x131D / 4893
{
	return (uParam0 && bParam1) == 0;
}

void Function_48() //Position: 0x132A / 4906
{
...
var Function_49(int iParam0, int iParam1) //Position: 0x13A5 / 5029
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_50(vector3 vParam0) //Position: 0x1F96 / 8086
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_51(int iParam0, bool bParam1) //Position: 0x1FAE / 8110
{
	int iVar0;
...
int Function_52(int iParam0) //Position: 0x1FEB / 8171
{
	int iVar0;
	int iVar1;
...
bool Function_53(int iParam0) //Position: 0x203A / 8250
{
...
int Function_54(int iParam0) //Position: 0x2050 / 8272
{
...
bool Function_55(int iParam0) //Position: 0x20B9 / 8377
{
	if (!Function_53(iParam0))
	{
...
bool Function_56(int iParam0, int iParam1) //Position: 0x210A / 8458
{
	int iVar0;
...
bool Function_57(int iParam0) //Position: 0x2137 / 8503
{
	if (!Function_53(iParam0))
	{
...
bool Function_58() //Position: 0x2189 / 8585
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_59(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2192 / 8594
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	{
		Function_36(Global_34573, 2097152, 1, 0);
	}
	iVar0 = iParam0;
	if (iVar0 + 1 <= 77)
	{
...
void Function_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x26C7 / 9927
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_61() //Position: 0x283A / 10298
{
	return;
}

void Function_62(var uParam0, int iParam1) //Position: 0x2840 / 10304
{
	if (Global_3381)
	{
		return;
...
void Function_63(bool bParam0) //Position: 0x2882 / 10370
{
...
void Function_64() //Position: 0x28D3 / 10451
{
	Function_91();
	Function_90();
	Function_90();
...
void Function_65() //Position: 0x2906 / 10502
{
...
void Function_66() //Position: 0x2A0C / 10764
{
	float fVar0;
...
void Function_67() //Position: 0x2A3F / 10815
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_68() //Position: 0x2BCD / 11213
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_69() //Position: 0x2D81 / 11649
{
	Function_70(&Global_28260, 1, 0);
	return;
}

void Function_70(int iParam0, bool bParam1, var uParam2) //Position: 0x2D8F / 11663
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_71() //Position: 0x2F80 / 12160
{
...
struct<8> Function_72() //Position: 0x2F95 / 12181
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_73(int iParam0, bool bParam1, bool bParam2) //Position: 0x3030 / 12336
{
	int iVar0;
...
void Function_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x32CB / 13003
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_75(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_20(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_75(int iParam0) //Position: 0x38F8 / 14584
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_76(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3909 / 14601
{
	char* cVar0[32];
...
struct<32> Function_77(char* cParam0, char* cParam1) //Position: 0x39FE / 14846
{
	char* cVar0[32];
...
void Function_78(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3A17 / 14871
{
	float fVar0;
...
var Function_79(int iParam0, int iParam1) //Position: 0x3A7C / 14972
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_80(int iParam0, bool bParam1) //Position: 0x3A8E / 14990
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_81(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3AA0 / 15008
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_82(int iParam0) //Position: 0x3BD0 / 15312
{
	return Global_35278[iParam020].f_48;
}

float Function_83(int iParam0) //Position: 0x3BDF / 15327
{
	if (!iParam0 != 4294967295)
	{
...
var Function_84(int iParam0) //Position: 0x3C18 / 15384
{
	if (iParam0 == 4294967295)
	{
...
void Function_85(int iParam0) //Position: 0x3C55 / 15445
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_86(int iParam0, bool bParam1, bool bParam2) //Position: 0x3DEF / 15855
{
	int iVar0;
	int iVar1;
...
int Function_87(bool bParam0) //Position: 0x400B / 16395
{
...
struct<8> Function_88() //Position: 0x404C / 16460
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_89() //Position: 0x40D5 / 16597
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_90() //Position: 0x416C / 16748
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_91() //Position: 0x41EB / 16875
{
...
int Function_92(int iParam0, bool bParam1, int iParam2) //Position: 0x4211 / 16913
{
	int iVar0;
	int iVar1;
...
void Function_93() //Position: 0x441B / 17435
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_94(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x44BC / 17596
{
	int iVar0;
...
vector3 Function_95() //Position: 0x45A3 / 17827
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_96(int iParam0) //Position: 0x45AC / 17836
{
...
int Function_97(bool bParam0, bool bParam1) //Position: 0x45C2 / 17858
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_98(vector3 vParam0, vector3 vParam3) //Position: 0x4689 / 18057
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_99(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x46A6 / 18086
{
	uParam0 = uParam0;
...
void Function_100() //Position: 0x474A / 18250
{
	bool bVar0;
...
void Function_101(bool bParam0) //Position: 0x47A8 / 18344
{
	PRINTSTRING("Day ");
...
void Function_102(int iParam0, int iParam1) //Position: 0x47EE / 18414
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_103(bool bParam0, bool bParam1) //Position: 0x4801 / 18433
{
	bool bVar0;
...
void Function_104(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4826 / 18470
{
...
void Function_105(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4860 / 18528
{
	int iVar0;
...
bool Function_106(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x48AB / 18603
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_107(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x4954 / 18772
{
	if (!bParam15)
	{
...
void Function_108(bool bParam0) //Position: 0x4F68 / 20328
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_109() //Position: 0x500D / 20493
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_110() //Position: 0x5052 / 20562
{
...
void Function_111(bool bParam0, bool bParam1) //Position: 0x5064 / 20580
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_112(bool bParam0) //Position: 0x50E4 / 20708
{
	bool bVar0;
...
float Function_113(int iParam0) //Position: 0x5113 / 20755
{
...
bool Function_114(int iParam0) //Position: 0x51DB / 20955
{
	return Function_47(*iParam0, 2);
}

bool Function_115(int iParam0) //Position: 0x51E8 / 20968
{
	return Function_47(*iParam0, 1);
}

int Function_116(bool bParam0) //Position: 0x51F5 / 20981
{
	bool bVar0;
	bool bVar1;
...
bool Function_117() //Position: 0x52AD / 21165
{
	bool bVar0;
	bool bVar1;
...
void Function_118(int iParam0) //Position: 0x52E7 / 21223
{
	Function_119(iParam0, 0.0f);
	return;
}

void Function_119(var uParam0, float fParam1) //Position: 0x52F3 / 21235
{
...
bool Function_120(int iParam0) //Position: 0x5314 / 21268
{
	return iParam0->f_20;
}

void Function_121(var uParam0, int iParam1) //Position: 0x531E / 21278
{
	Function_122(uParam0, iParam1, 0);
	return;
}

void Function_122(var uParam0, bool bParam1, bool bParam2) //Position: 0x532C / 21292
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_123(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5478 / 21624
{
	int iVar0;
	int iVar1;
...
void Function_124(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5698 / 22168
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_125() //Position: 0x56C1 / 22209
{
	bool bVar0;
	bool bVar1;
...
void Function_126() //Position: 0x570C / 22284
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_127() //Position: 0x57E6 / 22502
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(-3761,149f, 30,131f, 2721,602f, 0, 0);
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_128() //Position: 0x580A / 22538
{
	Function_130(1, 0, 1, 1, 0, 1, 0, 1, 1, 1);
	Function_129(Global_63541[1255].f_208, 1);
	DESTROY_VOLUME(fLocal_198);
	return 1;
}

void Function_129(bool bParam0, bool bParam1) //Position: 0x5830 / 22576
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_130(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x58AC / 22700
{
	bool bVar0;
...
void Function_131() //Position: 0x599C / 22940
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_132() //Position: 0x59B1 / 22961
{
	TELEPORT_ACTOR_WITH_HEADING(Global_34573, -3753,35f, 26,75f, 2730,74f, 66,33f, 1, true, 1);
	TELEPORT_ACTOR_WITH_HEADING(bLocal_195, -3756,15f, 26,75f, 2738,11f, 397,85f, 1, true, 1);
	return 1;
}

int Function_133() //Position: 0x59F1 / 23025
{
	if (!iLocal_197)
	{
		Function_134(StackVal, StackVal, vLocal_199, bLocal_198);
		Function_129(Global_63541[1255].f_208, 0);
		iLocal_197 = 1;
	}
	return 1;
}

void Function_134(vector3 vParam0) //Position: 0x5A17 / 23063
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_135(bool bParam0, bool bParam1) //Position: 0x5B9D / 23453
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_136(bool bParam0, float fParam1) //Position: 0x5C8E / 23694
{
...
void Function_137() //Position: 0x5D8C / 23948
{
...
void Function_138() //Position: 0x5DBE / 23998
{
...
int Function_140() //Position: 0x5ED6 / 24278
{
	bLocal_198 = CREATE_VOLUME_IN_LAYOUT(bLocal_204, "tempcutscenevol", 2, *(&Global_63541[1255] + 100), 0.0f, 0.0f, 0.0f, 10.0f, 10.0f, 10.0f);
	Function_143(0, 0, 1, 1, 0, 1, 1, bLocal_198, 1, 1, 1, 1);
	Function_141(StackVal, StackVal, bLocal_204, *(&Global_63541[1255] + 112), &bLocal_198, 0, 0, 0, 0, 1, 1);
	return 1;
}

void Function_141(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x5F3C / 24380
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_142(bool bParam0, bool bParam1) //Position: 0x61AA / 25002
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_143(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x621F / 25119
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_146(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_20(), 2, Function_146(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_144(int iParam0) //Position: 0x64C8 / 25800
{
	int iVar0;
...
var Function_145() //Position: 0x64FC / 25852
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_146(bool bParam0) //Position: 0x657B / 25979
{
	vector3 vVar0;
...
int Function_147(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x658C / 25996
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_149(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						if (iVar3 == 0)
						{
							...
							{
								CUTSCENE_MANAGER_SET_WAS_JOHN_NOW_JACK_IN_RCM_CUTSCENE(Function_148(iParam0));
							}
						}
						...
						uVar6 = Function_149(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_148(float fParam0) //Position: 0x66ED / 26349
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_148(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_149(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x6722 / 26402
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_152(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_153()) * (fParam7 - fParam6)) * 0,5f))) || bParam12)
	{
	...
	else if ((!Function_152(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_153()) * (fParam7 - fParam6)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_152(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_150() //Position: 0x6968 / 26984
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &vVar1, &Var4))
		{
			...
			Function_151(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_151(char* cParam0, vector3 vParam1) //Position: 0x69BC / 27068
{
	char* cVar0[64];
...
bool Function_152(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x6AE4 / 27364
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_17(bParam0);
...
int Function_153() //Position: 0x6B6E / 27502
{
	if (IS_PS3())
	{
		return 1;
...
void Function_154() //Position: 0x6B7D / 27517
{
	var uVar0;
...
void Function_155(int iParam0, int iParam1) //Position: 0x6BA5 / 27557
{
	switch (iParam1)
	{
		case 0x00000000:
