...
{
	Function_24();
	Function_4(12, bLocal_8, bLocal_9, &uLocal_4, iLocal_10, 53);
	return;
}
...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA2E / 2606
{
	bool bVar0;
	bool bVar1;
...
bool Function_43(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x29BB / 10683
{
...
void Function_52(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2CC9 / 11465
{
	bool bVar0;
	bool bVar1;
...
{
	iLocal_10 = CREATE_LAYOUT("home02son03campfirelayout");
...
void Function_82(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x3F65 / 16229
{
	bool bVar0;
...
bool Function_83(bool bParam0, bool bParam1) //Position: 0x3FB9 / 16313
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_88(int iParam0, bool bParam1) //Position: 0x416B / 16747
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(int iParam0) //Position: 0x44EE / 17646
{
	bool bVar0;
	bool bVar1;
...
bool Function_98(int iParam0) //Position: 0x45E8 / 17896
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x4963 / 18787
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x49A3 / 18851
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x49CE / 18894
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x49DF / 18911
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4A21 / 18977
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4AA5 / 19109
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4ACE / 19150
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4B1F / 19231
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4B2F / 19247
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4B43 / 19267
{
	int iVar0;
...
var Function_109() //Position: 0x4B68 / 19304
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4B7F / 19327
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4CA5 / 19621
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4CB6 / 19638
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4CC7 / 19655
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4CD8 / 19672
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4CFB / 19707
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4D1A / 19738
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4D26 / 19750
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x4D31 / 19761
{
	int iVar0;
...
var Function_119() //Position: 0x4D5F / 19807
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4D74 / 19828
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4E78 / 20088
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4E8C / 20108
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4EF6 / 20214
{
	char* cVar0[32];
...
var Function_124() //Position: 0x4F15 / 20245
{
	return "PBox_";
}

var Function_125() //Position: 0x4F23 / 20259
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x4F49 / 20297
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x4F71 / 20337
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x4F97 / 20375
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x50F8 / 20728
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5193 / 20883
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x52F4 / 21236
{
...
var Function_132() //Position: 0x5355 / 21333
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x535D / 21341
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5376 / 21366
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x5669 / 22121
{
	int iVar0;
...
void Function_136() //Position: 0x571D / 22301
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5757 / 22359
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5784 / 22404
{
	bool bVar0;
...
void Function_139() //Position: 0x58D5 / 22741
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5920 / 22816
{
	int iVar0;
...
int Function_141() //Position: 0x59F0 / 23024
{
	int iVar0;
...
int Function_142() //Position: 0x5B4C / 23372
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5C6C / 23660
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5D3C / 23868
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5D5A / 23898
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5E8C / 24204
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x5EAB / 24235
{
	int iVar0;
...
int Function_148() //Position: 0x5EC7 / 24263
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x5EE0 / 24288
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x5EEC / 24300
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x5EF5 / 24309
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x5F72 / 24434
{
	int iVar0;
