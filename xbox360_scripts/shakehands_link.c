...
vector3 Function_63(vector3 vParam0) //Position: 0x2830 / 10288
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x288D / 10381
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x28EA / 10474
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x28F4 / 10484
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2912 / 10514
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2927 / 10535
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29AE / 10670
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x29D1 / 10705
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x29EF / 10735
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A12 / 10770
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B2D / 11053
{
...
int Function_74(bool bParam0) //Position: 0x2B58 / 11096
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C5D / 11357
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2C6A / 11370
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2CDD / 11485
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x31DB / 12763
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3212 / 12818
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x322F / 12847
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3267 / 12903
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3271 / 12913
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3292 / 12946
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (bLocal_1)
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32DE / 13022
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x33E6 / 13286
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x33FC / 13308
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x36B2 / 14002
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_96(var uParam0, int iParam1) //Position: 0x3AEE / 15086
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AFD / 15101
{
...
void Function_98(int iParam0) //Position: 0x3B19 / 15129
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B23 / 15139
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B85 / 15237
{
...
void Function_101(int iParam0) //Position: 0x3B99 / 15257
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3BA3 / 15267
{
