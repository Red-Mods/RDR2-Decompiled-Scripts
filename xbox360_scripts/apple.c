...
void Function_47(bool bParam0, bool bParam1, int iParam2) //Position: 0x2160 / 8544
{
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(uParam1, bVar1, Function_49(bVar1, "AttachBone", &iVar2), Function_49(bVar1, "AttachLocator", &iVar2), 1))
				{
...
void Function_52(var uParam0, bool bParam1, int iParam2) //Position: 0x2309 / 8969
{
	...
	fVar1 = Function_58(uParam0, "HorseStaminaBoost", 0.0f);
	if ((IS_ACTOR_VALID(bVar0) && IS_ACTOR_ALIVE(bVar0)) && IS_ACTOR_MOUNTED(bVar0))
	{
		...
		if (fVar2 > fVar1)
		{
			...
			if ((Function_54(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
			{
				iLocal_3 = 0;
			}
			*iParam2 = 1;
		...
		{
			Function_53("horse_full_stamina", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
	{
		Function_53("apple_feed_horse", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 0;
	}
	return;
}

void Function_53(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2405 / 9221
{
	int iVar0;
...
int Function_54(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2450 / 9296
{
...
bool Function_55() //Position: 0x2506 / 9478
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_56(bool bParam0) //Position: 0x251D / 9501
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_57(int iParam0) //Position: 0x2528 / 9512
{
	return IS_ACTOR_VALID(GET_LASSO_USER(iParam0));
}

var Function_58(bool bParam0, bool bParam1, int iParam2) //Position: 0x2536 / 9526
{
	int iVar0;
...
var Function_59(bool bParam0) //Position: 0x254C / 9548
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_60(int iParam0, bool bParam1) //Position: 0x2566 / 9574
{
	bool bVar0;
	bool bVar1;
