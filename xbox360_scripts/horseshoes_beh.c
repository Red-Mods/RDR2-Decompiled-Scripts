	...
	switch (iLocal_0)
	{
		...
		case 0x00000000:
			if (Function_34(Global_30717[1]))
			{
				...
				{
					Function_30("HorseShoes_NotEnoughMoney", 4.0f, 1, 2, 0, 0, 0);
					bLocal_3 = true;
				}
				else
				{
...
void Function_17() //Position: 0x5E7 / 1511
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5F0 / 1520
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x611 / 1553
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x647 / 1607
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_21(int iParam0, int iParam1) //Position: 0x662 / 1634
{
...
void Function_22(bool bParam0) //Position: 0x78E / 1934
{
	int iVar0;
	bool bVar1;
...
bool Function_23(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x7E3 / 2019
{
	vector3 vVar0;
	int iVar3;
...
bool Function_24(bool bParam0, bool bParam1, bool bParam2) //Position: 0x930 / 2352
{
...
bool Function_25() //Position: 0x9E6 / 2534
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_26(bool bParam0) //Position: 0x9FD / 2557
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_27(bool bParam0) //Position: 0xA08 / 2568
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

float Function_28(vector3 vParam0, vector3 vParam3) //Position: 0xA16 / 2582
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_29(int iParam0, int iParam1) //Position: 0xA33 / 2611
{
	if (iParam0 == Global_30668[0])
	{
		if (iParam1 == 0)
...
void Function_30(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0xB4A / 2890
{
	int iVar0;
...
int Function_31() //Position: 0xB9D / 2973
{
	return Function_32(0);
}

int Function_32(int iParam0) //Position: 0xBA7 / 2983
{
...
var Function_33(int iParam0) //Position: 0xBE8 / 3048
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_34(int iParam0) //Position: 0xC02 / 3074
{
...
int Function_35(var uParam0, int iParam1) //Position: 0xC1E / 3102
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0xC3A / 3130
{
...
void Function_37() //Position: 0xC50 / 3152
{
	Function_1();
	return;
}

void Function_38() //Position: 0xC59 / 3161
{
...
void Function_39(int iParam0) //Position: 0xCA5 / 3237
{
...
void Function_40(var uParam0, float fParam1) //Position: 0xCBA / 3258
{
...
void Function_41(var uParam0, int iParam1) //Position: 0xCDB / 3291
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0xCEE / 3310
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0xCFD / 3325
{
	return Function_44(*iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0xD0A / 3338
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0xD17 / 3351
{
	return;
}

void Function_46(bool bParam0, bool bParam1) //Position: 0xD1D / 3357
{
	bool bVar0;
...
void Function_47(var uParam0) //Position: 0xD74 / 3444
{
	int iVar0;
...
var Function_48() //Position: 0xD91 / 3473
{
	var uVar0;
