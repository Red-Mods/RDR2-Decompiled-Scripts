	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_35, &bLocal_34);
...
bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2594 / 9620
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x261D / 9757
{
	bool bVar0;
...
struct<32> Function_66(bool bParam0) //Position: 0x26D4 / 9940
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_67(char* cParam0, char* cParam1, char* cParam2) //Position: 0x273E / 10046
{
	char* cVar0[32];
...
void Function_68(int iParam0) //Position: 0x275D / 10077
{
	iParam0 = iParam0;
	return;
}

bool Function_69(bool bParam0) //Position: 0x2767 / 10087
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2785 / 10117
{
	if (!Function_14(iParam0))
	{
...
bool Function_71(bool bParam0, bool bParam1) //Position: 0x279A / 10138
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_72(int iParam0) //Position: 0x2821 / 10273
{
	vector3 vVar0;
...
vector3 Function_73(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2844 / 10308
{
	vector3 vVar0;
...
bool Function_74(bool bParam0) //Position: 0x2862 / 10338
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(bool bParam0, bool bParam1) //Position: 0x2885 / 10373
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x29A0 / 10656
{
...
int Function_77(bool bParam0) //Position: 0x29CB / 10699
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2AD0 / 10960
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(int iParam0) //Position: 0x2ADD / 10973
{
	if (Function_78(iParam0->f_40, 16))
	{
...
void Function_80(int iParam0, bool bParam1) //Position: 0x2B50 / 11088
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_34));
		iLocal_35 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_81() //Position: 0x304E / 12366
{
	iLocal_4 = 0;
...
bool Function_82(bool bParam0) //Position: 0x3064 / 12388
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3081 / 12417
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_84(int iParam0) //Position: 0x30B9 / 12473
{
	iParam0 = iParam0;
	return;
}

bool Function_85(bool bParam0) //Position: 0x30C3 / 12483
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, int iParam1) //Position: 0x30E4 / 12516
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x310B / 12555
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x3213 / 12819
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_89(int iParam0) //Position: 0x3229 / 12841
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x34DF / 13535
{
	struct<8> Var0;
	vector3 vVar8;
	bool bVar11;
...
bool Function_91(bool bParam0) //Position: 0x354F / 13647
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_92(bool bParam0) //Position: 0x3568 / 13672
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_93(bool bParam0, int iParam1) //Position: 0x3582 / 13698
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x35BA / 13754
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_95(int iParam0, int iParam1) //Position: 0x35D1 / 13777
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_96(bool bParam0) //Position: 0x389A / 14490
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_97(bool bParam0, bool bParam1) //Position: 0x38B7 / 14519
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_98(int iParam0) //Position: 0x3953 / 14675
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(bool bParam0, int iParam1) //Position: 0x3972 / 14706
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_100(int iParam0) //Position: 0x39B0 / 14768
{
...
void Function_101(int iParam0) //Position: 0x39CC / 14796
{
	iParam0 = iParam0;
	return;
}

void Function_102(bool bParam0, int iParam1) //Position: 0x39D6 / 14806
{
	bool bVar0;
	bool bVar1;
...
void Function_103(int iParam0, int iParam1) //Position: 0x3A38 / 14904
{
...
void Function_104(int iParam0) //Position: 0x3A4C / 14924
{
	iParam0 = iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x3A56 / 14934
{
