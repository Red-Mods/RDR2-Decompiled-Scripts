...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = Function_25("snakes", 0);
	Function_20(&bVar0, 1059, 8.0f, 14, 0, 0);
	bVar1 = Function_25("vultures", 0);
	Function_20(&bVar1, 1128, 10.0f, 14, 0, 0);
	Function_20(&bVar1, 1129, 10.0f, 14, 0, 0);
	Function_20(&bVar1, 1130, 10.0f, 14, 0, 0);
	...
	bVar4 = Function_25("Train", 0);
	Function_20(&bVar4, 47, 3.0f, 15, 0, 0);
	Function_20(&bVar4, 311, 4.0f, 15, 0, 0);
	Function_20(&bVar4, 306, 1.0f, 15, 0, 0);
	Function_20(&bVar4, 87, 3.0f, 15, 0, 0);
	Function_20(&bVar4, 207, 2.0f, 15, 0, 0);
	Function_20(&bVar4, 138, 3.0f, 15, 0, 0);
	Function_20(&bVar4, 203, 2.0f, 15, 0, 0);
	Function_20(&bVar4, 208, 2.0f, 15, 0, 0);
	Function_20(&bVar4, 263, 2.0f, 15, 0, 0);
	Function_20(&bVar4, 265, 2.0f, 15, 0, 0);
	bVar5 = Function_25("BarFolk", 0);
	Function_20(&bVar5, 245, 8.0f, 57, 0, 0);
	Function_20(&bVar5, 247, 8.0f, 57, 0, 0);
	Function_20(&bVar5, 87, 5.0f, 57, 0, 0);
	Function_20(&bVar5, 207, 2.0f, 57, 0, 0);
	Function_20(&bVar5, 311, 4.0f, 57, 0, 0);
	Function_20(&bVar5, 280, 3.0f, 57, 0, 0);
	Function_20(&bVar5, 249, 8.0f, 57, 0, 0);
	Function_20(&bVar5, 248, 8.0f, 57, 0, 0);
	Function_20(&bVar5, 263, 5.0f, 57, 0, 0);
	Function_20(&bVar5, 265, 5.0f, 57, 0, 0);
	Function_20(&bVar5, 498, 6.0f, 48, 0, 0);
	Function_20(&bVar5, 501, 6.0f, 48, 0, 0);
	Function_20(&bVar5, 502, 6.0f, 48, 0, 0);
	Function_20(&bVar5, 503, 6.0f, 48, 0, 0);
	bVar6 = Function_25("Folk", 0);
	Function_20(&bVar6, 247, 12.0f, 57, 0, 0);
	Function_20(&bVar6, 248, 8.0f, 57, 0, 0);
	Function_20(&bVar6, 245, 12.0f, 57, 0, 0);
	Function_20(&bVar6, 263, 4.0f, 57, 0, 0);
	Function_20(&bVar6, 265, 8.0f, 57, 0, 0);
	Function_20(&bVar6, 230, 6.0f, 57, 0, 0);
	Function_20(&bVar6, 204, 4.0f, 57, 0, 0);
	Function_20(&bVar6, 203, 5.0f, 57, 0, 0);
	Function_20(&bVar6, 278, 6.0f, 57, 0, 0);
	Function_20(&bVar6, 497, 6.0f, 49, 0, 0);
	Function_20(&bVar6, 499, 6.0f, 49, 0, 0);
	Function_20(&bVar6, 502, 6.0f, 49, 0, 0);
	Function_20(&bVar6, 504, 6.0f, 49, 0, 0);
	bVar7 = Function_25("DayFolk", 0);
	Function_20(&bVar7, 285, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 286, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 288, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 290, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 294, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 296, 6.0f, 11, 0, 0);
	Function_20(&bVar7, 298, 6.0f, 11, 0, 0);
	if (!Function_19() && !Function_13(26))
	{
		...
		if (Global_25974[7])
		{
			bVar9 = Function_25("ped_liarsdice", 0);
			Function_23(&bVar9, 258, 1.0f, 0, 0);
			Function_23(&bVar9, 498, 1.0f, 0, 0);
			Function_23(&bVar9, 406, 1.0f, 0, 0);
			Function_23(&bVar9, 38, 1.0f, 0, 0);
			Function_23(&bVar9, 138, 1.0f, 0, 0);
			Function_23(&bVar9, 200, 1.0f, 0, 0);
			Function_23(&bVar9, 207, 1.0f, 0, 0);
		}
	}
	...
	if (IS_LAYOUTREF_VALID(bVar12))
	{
		...
		{
			Function_8(bVar13, bVar5, 4, 8, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar7, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar7, 2, 3, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("cas_pop: Cannot find casv_CourtYrd_set to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar4, 5, 8, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar6, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar6, 4, 6, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("cas_pop: Cannot find casv_patio to create population volumes");
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar5, 2, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_8(bVar13, bVar5, 2, 4, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("cas_pop: Cannot find casv_walkway_set to create population volumes");
		...
		if (!Function_19())
		{
			...
			if (Global_25974[7])
			{
				...
				bVar15 = Function_7(bVar13, bVar9, 3, 1, 0, 0);
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_3(bVar13, bVar1, 0,0001f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar13))
		{
			Function_3(bVar13, bVar0, 1E-05f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1610 / 5648
{
	bool bVar0;
...
var Function_7(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x16F8 / 5880
{
	bool bVar0;
...
var Function_8(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x1778 / 6008
{
	bool bVar0;
...
var Function_21(int iParam0) //Position: 0x19A1 / 6561
{
	bool bVar0;
...
var Function_22(int iParam0) //Position: 0x1A0D / 6669
{
	bool bVar0;
...
var Function_23(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1A79 / 6777
{
	int iVar0;
	int iVar1;
...
var Function_24(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1AEE / 6894
{
	int iVar0;
	int iVar1;
...
var Function_25(int iParam0, int iParam1) //Position: 0x1B33 / 6963
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_26(int iParam0) //Position: 0x1B40 / 6976
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_27(bool bParam0, var uParam1) //Position: 0x1B4C / 6988
{
	if (!Function_9(128))
	{
		return;
