...
void Function_5(bool bParam0, bool bParam1, bool bParam2) //Position: 0xAF9 / 2809
{
	bool bVar0;
...
void Function_6(bool bParam0, bool bParam1, bool bParam2) //Position: 0xBD6 / 3030
{
	int iVar0;
...
void Function_7() //Position: 0xD4F / 3407
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_8(bool bParam0) //Position: 0xD5B / 3419
{
	PRINTSTRING("Day ");
...
void Function_9(int iParam0) //Position: 0xDA1 / 3489
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_10(var uParam0, int iParam1) //Position: 0xDE7 / 3559
{
	int iVar0;
...
bool Function_11(var uParam0, int iParam1) //Position: 0xE01 / 3585
{
	int iVar0;
...
void Function_12(var uParam0, bool bParam1) //Position: 0xE1E / 3614
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_13(var uParam0, int iParam1) //Position: 0x11EA / 4586
{
	int iVar0;
...
int Function_14(int iParam0, bool bParam1) //Position: 0x1204 / 4612
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
bool Function_15() //Position: 0x1216 / 4630
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_16(var uParam0, var uParam1, bool bParam2, var uParam3) //Position: 0x121F / 4639
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_17(var uParam0, bool bParam1, int iParam2, var uParam3, bool bParam4) //Position: 0x12A0 / 4768
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_18(int iParam0) //Position: 0x16B9 / 5817
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_19(int iParam0) //Position: 0x17B8 / 6072
{
...
float Function_20(int iParam0) //Position: 0x17F5 / 6133
{
	if (!iParam0 != 4294967295)
	{
...
void Function_21(int iParam0, bool bParam1) //Position: 0x182E / 6190
{
	bool bVar0;
...
var Function_22(int iParam0) //Position: 0x1895 / 6293
{
	int iVar0;
...
int Function_23(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x18ED / 6381
{
	int iVar0;
	int iVar1;
...
void Function_24(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1B0D / 6925
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_25() //Position: 0x213A / 8506
{
	int iVar0;
...
var Function_26(int iParam0) //Position: 0x2142 / 8514
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_27(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2153 / 8531
{
	char* cVar0[32];
...
struct<32> Function_28(char* cParam0, char* cParam1) //Position: 0x2248 / 8776
{
	char* cVar0[32];
...
void Function_29(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2261 / 8801
{
	float fVar0;
...
var Function_30(int iParam0, int iParam1) //Position: 0x22C6 / 8902
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_31(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x22D8 / 8920
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_32(int iParam0) //Position: 0x2408 / 9224
{
	return Global_35278[iParam020].f_48;
}

void Function_33(int iParam0) //Position: 0x2417 / 9239
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_34(int iParam0, float fParam1, bool bParam2) //Position: 0x25B1 / 9649
{
	int iVar0;
	int iVar1;
...
void Function_35(var uParam0, int iParam1) //Position: 0x27CB / 10187
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_36(struct<5> Param0) //Position: 0x27D8 / 10200
{
...
bool Function_37(var uParam0, int iParam1) //Position: 0x27FE / 10238
{
	int iVar0;
...
var Function_38(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x281A / 10266
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_39() //Position: 0x2AAA / 10922
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_40(bool bParam0, bool bParam1) //Position: 0x2B0D / 11021
{
...
bool Function_41(bool bParam0) //Position: 0x2B3C / 11068
{
	if (Function_46(256))
	{
		return 0;
...
int Function_42(int iParam0) //Position: 0x2BB2 / 11186
{
...
bool Function_43() //Position: 0x2BC3 / 11203
{
	if (Global_30619 == 2)
	{
		if (StackVal == 1)
...
bool Function_44(int iParam0) //Position: 0x2BDC / 11228
{
...
bool Function_45(int iParam0) //Position: 0x2BF2 / 11250
{
...
bool Function_46(int iParam0) //Position: 0x2C07 / 11271
{
	int iVar0;
...
bool Function_47(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2C25 / 11301
{
	uParam0 = uParam0;
...
bool Function_48(int iParam0) //Position: 0x2CC9 / 11465
{
...
void Function_49(var uParam0, int iParam1) //Position: 0x2CDF / 11487
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_50(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x2CF0 / 11504
{
	int iVar0;
	bool bVar1;
...
void Function_51(int iParam0, int iParam1) //Position: 0x2D62 / 11618
{
	int iVar0;
...
bool Function_52(int iParam0) //Position: 0x2D87 / 11655
{
	if (*iParam0 == 0)
	{
		return 0;
...
bool Function_53(int iParam0) //Position: 0x2DA4 / 11684
{
	int iVar0;
...
void Function_54(bool bParam0, float fParam1) //Position: 0x2DC0 / 11712
{
	if (!Function_53(128))
	{
		return;
...
void Function_55(var uParam0, int iParam1) //Position: 0x2DFE / 11774
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(var uParam0, bool bParam1) //Position: 0x2E0D / 11789
{
	uParam0->f_8 = (StackVal || bParam1);
	return;
}

int Function_57(var uParam0, int iParam1, bool bParam2, int iParam3, char* cParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x2E1E / 11806
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_58(int iParam0) //Position: 0x2EFD / 12029
{
	int iVar0;
...
bool Function_59(bool bParam0) //Position: 0x2F2B / 12075
{
...
void Function_60(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x2F49 / 12105
{
...
void Function_61(int iParam0) //Position: 0x3024 / 12324
{
	*iParam0 = 0;
	iParam0->f_4 = 0;
	return;
...
var Function_62(bool bParam0, bool bParam1, int iParam2) //Position: 0x3033 / 12339
{
	Global_29155[iParam210].f_32 = CREATE_WORLD_SECTOR(bParam0, bParam1);
	return Global_29155[iParam210].f_32;
}

bool Function_63() //Position: 0x3052 / 12370
{
	var uVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x4301 / 17153
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_65() //Position: 0x434A / 17226
{
...
void Function_66(bool bParam0, var uParam1) //Position: 0x435F / 17247
{
	if (!Function_53(128))
	{
		return;
