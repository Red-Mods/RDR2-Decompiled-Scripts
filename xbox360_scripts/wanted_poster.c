...
int Function_44(bool bParam0) //Position: 0x2062 / 8290
{
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_72(bParam0, bVar0))
			{
				Function_65(bParam0, bVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			bVar2 = Function_64(bParam0);
			if (IS_GRINGO_COMPONENT_VALID(bVar2) && iLocal_3)
			{
				Function_60(bParam0, bVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
		...
		if (IS_GRINGO_COMPONENT_VALID(bVar0) && iLocal_3)
		{
			if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
			{
				if (!iLocal_13)
				{
					...
					ENABLE_USE_CONTEXTS(1);
					Function_47();
					SHOW_NEWSPAPER(202, &cLocal_4, 1, 0);
					iLocal_13 = 1;
				}
			}
...
void Function_47() //Position: 0x2268 / 8808
{
	var uVar0;
	var uVar16;
	var uVar32;
	...
	Function_59(Global_26303.f_12, &uVar0);
	uVar64 = Function_58(Global_26303.f_20);
	Function_57(uVar64, &uVar16);
	Function_56(Global_26303.f_24, &uVar32);
	Function_52(&uVar48);
	SET_NEWSPAPER_INFO(0, &uVar16);
	SET_NEWSPAPER_INFO(1, &uVar0);
	SET_NEWSPAPER_INFO(2, &uVar32);
	SET_NEWSPAPER_INFO(3, &uVar48);
	if (!Function_48(Function_49(Global_26303.f_20)))
	{
		strcpy(&cLocal_4, "p_pos_wanted", 32);
		if (Global_26303.f_40 <= 10)
		{
			stradd(&cLocal_4, "0", 32);
		}
		stradd(&cLocal_4, INT_TO_STRING(Global_26303.f_40), 32);
	}
	else
	{
		strcpy(&cLocal_4, "p_pos_wanted61", 32);
	}
	return;
}

bool Function_48(bool bParam0) //Position: 0x2308 / 8968
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_49(int iParam0) //Position: 0x235A / 9050
{
	int iVar0;
	int iVar1;
	struct<21> Var2;
...
var Function_50(var uParam0, int iParam1) //Position: 0x2398 / 9112
{
	int iVar0;
...
bool Function_51(int iParam0) //Position: 0x2B0B / 11019
{
...
void Function_52(int iParam0) //Position: 0x2B22 / 11042
{
	memcpy(iParam0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_53(&Global_26303), 16);
	return;
}

struct<32> Function_53(var uParam0) //Position: 0x2B34 / 11060
{
	char* cVar0[32];
	bool bVar8;
	bool bVar9;
...
var Function_54(var uParam0, bool bParam1) //Position: 0x2BC4 / 11204
{
	bool bVar0;
	char* cVar1[32];
...
int Function_55() //Position: 0x2CDC / 11484
{
	return Global_12976.f_152;
}

void Function_56(int iParam0, char* cParam1) //Position: 0x2CE7 / 11495
{
	strcpy(cParam1, GET_OBJECT_NAME(StackVal), 64);
	return;
}

void Function_57(char* cParam0, char* cParam1) //Position: 0x2CFD / 11517
{
	switch (cParam0)
	{
		case 0x00000004:
...
var Function_58(bool bParam0) //Position: 0x2DE5 / 11749
{
	int iVar0;
	int iVar1;
...
void Function_59(char* cParam0, char* cParam1) //Position: 0x2E94 / 11924
{
	switch (cParam0)
	{
		case 0x00000001:
...
void Function_60(bool bParam0, bool bParam1, int iParam2) //Position: 0x2F6B / 12139
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0) && *iParam2)
	{
		if (IS_GRINGO_COMPONENT_VALID(bVar1))
		{
			...
			{
				if (GRINGO_ATTACH_PROP_TO_ANIM(bParam1, bVar1, Function_62(bVar1, "AttachBone", &iVar2), Function_62(bVar1, "AttachLocator", &iVar2), 1))
				{
					Function_61(bVar1, bParam1);
					*iParam2 = 1;
				}
			}
		}
...
void Function_61(bool bParam0, bool bParam1) //Position: 0x2FF5 / 12277
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_62(bool bParam0, bool bParam1, int iParam2) //Position: 0x30A3 / 12451
{
	int iVar0;
	bool bVar1;
...
var Function_63(bool bParam0) //Position: 0x30E8 / 12520
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_64(bool bParam0) //Position: 0x30FE / 12542
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_65(var uParam0, bool bParam1, int iParam2) //Position: 0x3114 / 12564
{
	...
	*iParam2 = 0;
	...
	if (!Global_3380)
	{
		if (!IS_ACTOR_VALID(GET_ATTACHED_HOGTIE_VICTIM(Global_34573)))
		{
			...
			{
				if (((Function_67(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295) || IS_ACTOR_INSIDE_VEHICLE(bParam1))
				{
					iLocal_3 = 0;
				}
				*iParam2 = 1;
			...
			{
				Function_66("item_combat_fail", 0x41200000, 1, 0, 2, 1, 0);
				*iParam2 = 0;
			}
		}
		else
		{
			Function_66("item_hogtie_fail", 0x41200000, 1, 0, 2, 1, 0);
			*iParam2 = 0;
		}
	}
	else
...
void Function_66(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3222 / 12834
{
	int iVar0;
...
int Function_67(bool bParam0, bool bParam1, bool bParam2) //Position: 0x326D / 12909
{
...
bool Function_68() //Position: 0x3323 / 13091
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_69(bool bParam0) //Position: 0x333A / 13114
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_70(bool bParam0) //Position: 0x3345 / 13125
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_71(bool bParam0) //Position: 0x3353 / 13139
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_72(int iParam0, bool bParam1) //Position: 0x336D / 13165
{
	bool bVar0;
	bool bVar1;
