...
void main() //Position: 0x0 / 0
{
	...
	{
		Function_52(3);
		Function_48(Function_49());
		Function_47(Global_13111);
		Function_19();
		uVar0 = Function_15(bLocal_10, Global_79341, 1517, 1);
		Function_11(Function_12());
		if (iLocal_14 < 80 || uVar0)
		{
			iLocal_14 = 0;
			Function_2();
		}
...
void Function_2() //Position: 0x7C / 124
{
	...
	if (Global_13111 != iLocal_13 && IS_SCRIPT_VALID(Global_26316.f_60))
	{
		iLocal_12 = Global_13111;
		return;
	}
	if (!Global_3403 && iLocal_12 == 4294967295)
	{
		iLocal_13 = iLocal_12;
		iLocal_12 = 4294967295;
	}
	...
	bVar3 = Function_10(iLocal_13, &uVar0);
	bVar4 = false;
...
{
	if (!Function_45(2097152))
	{
		return;
	}
	if ((Function_44() <= 1000 || bLocal_11) && !Function_43(131072, 1))
	{
		Function_26();
		Function_25(Function_44(), 4294967295);
	}
	else if ((Function_44() > 1000 && !bLocal_11) && Function_43(131072, 1))
	{
		Function_20(1);
...
void Function_21(char* cParam0, bool bParam1) //Position: 0x710 / 1808
{
	int iVar0;
...
void Function_26() //Position: 0x7D6 / 2006
{
	...
	Function_28(386, 1, 0, 0);
	PRINT_BIG("net_player_most_wanted_notif", 1084227584, 0, 2, 0);
	Function_27("net_help_most_wanted_inform", 0x41200000, 1, 0, 2, 1, 0);
	Function_21("GENMESS_LOCALMOSTWANTED", 0);
	return;
}

void Function_27(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x861 / 2145
{
	int iVar0;
...
int Function_28(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x8AC / 2220
{
	int iVar0;
	int iVar1;
...
void Function_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xACC / 2764
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_30() //Position: 0x10F9 / 4345
{
	int iVar0;
...
var Function_31(int iParam0) //Position: 0x1101 / 4353
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_32(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1112 / 4370
{
	char* cVar0[32];
...
struct<32> Function_33(char* cParam0, char* cParam1) //Position: 0x1207 / 4615
{
	char* cVar0[32];
...
void Function_34(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1220 / 4640
{
	float fVar0;
...
var Function_35(int iParam0, int iParam1) //Position: 0x1285 / 4741
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_36(int iParam0, bool bParam1) //Position: 0x1297 / 4759
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_37(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x12A9 / 4777
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_38(int iParam0) //Position: 0x13D9 / 5081
{
	return Global_35278[iParam020].f_48;
}

float Function_39(int iParam0) //Position: 0x13E8 / 5096
{
	if (!iParam0 != 4294967295)
	{
...
var Function_40(int iParam0) //Position: 0x1421 / 5153
{
	if (iParam0 == 4294967295)
	{
...
void Function_41(int iParam0) //Position: 0x145E / 5214
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_42(int iParam0, float fParam1, bool bParam2) //Position: 0x15F8 / 5624
{
	int iVar0;
	int iVar1;
...
bool Function_43(bool bParam0, bool bParam1) //Position: 0x1812 / 6162
{
	int iVar0;
...
int Function_44() //Position: 0x1832 / 6194
{
	return Global_78480.f_108;
}

bool Function_45(int iParam0) //Position: 0x183E / 6206
{
	return Function_46(Global_79336, iParam0);
}

int Function_46(var uParam0, int iParam1) //Position: 0x184D / 6221
{
	return (uParam0 && iParam1) == 0;
}

void Function_47(int iParam0) //Position: 0x185A / 6234
{
...
void Function_48(var uParam0) //Position: 0x187B / 6267
{
...
var Function_49() //Position: 0x189C / 6300
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar2 = iVar1;
		if (Function_51(iVar2))
		{
			iVar3 = Function_50(iVar2);
			if (iVar3 >= iVar0)
			{
				iVar0 = iVar3;
			}
...
int Function_50(int iParam0) //Position: 0x18D7 / 6359
{
...
bool Function_51(int iParam0) //Position: 0x18EF / 6383
{
...
void Function_52(int iParam0) //Position: 0x1904 / 6404
{
	var uVar0;
	var uVar1;
...
void Function_53(int iParam0) //Position: 0x1936 / 6454
{
	var uVar0;
...
void Function_54() //Position: 0x1945 / 6469
{
	...
	bLocal_10 = CREATE_EVENT_TRAP("MPLAWReplication", 77, Global_79341);
	EVENT_TRAP_STORE_EVENTS(bLocal_10, 1);
	NET_SCRIPTMSG_REGISTER_HANDLER(69, 6593);
	return;
}

void Function_55(int iParam0) //Position: 0x19C1 / 6593
{
	struct<9> Var0;
	...
	if (vVar0.y >= 0)
	{
		Function_59(vVar0.x, 1);
		Function_58("net_player_most_wanted_on", vVar0.x);
		if (!Function_43(2097152, 1))
		{
	...
	{
		Function_59(vVar0.x, 0);
		if (IS_SLOT_VALID(vVar0.z))
		{
			Function_56("net_player_most_wanted_killed", vVar0.x, vVar0.z);
		}
		else
		{
			Function_58("net_player_most_wanted_clear", vVar0.x);
		}
	}
	return;
}

void Function_56(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1AA1 / 6817
{
	var uVar0;
	var uVar2;
	
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_57(bParam1), 2);
	memcpy(&uVar2, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_57(bParam2), 2);
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), &uVar0, &uVar2, 0, 0, 0, 0);
	return;
}

struct<32> Function_57(bool bParam0) //Position: 0x1ACD / 6861
{
	return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_33("g", I2STR(bParam0));
}

void Function_58(bool bParam0, int iParam1) //Position: 0x1AE1 / 6881
{
	var uVar0;
	
	memcpy(&uVar0, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_57(iParam1), 2);
	NET_TICKER_REPORTF(UI_GET_STRING(bParam0), &uVar0, 0, 0, 0, 0, 0);
	return;
}

void Function_59(bool bParam0, bool bParam1) //Position: 0x1B01 / 6913
{
