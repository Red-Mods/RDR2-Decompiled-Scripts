...
void main() //Position: 0x0 / 0
{
	...
	iLocal_85 = 0;
	Function_113(uScriptParam_0, &iLocal_85);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_106(&(Local_12[iVar312]), &bVar4))
						{
							Function_104(GRINGO_GET_REQUESTING_ACTOR(), Local_12[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_99("eGRINGO_EndUse: Stop use by request", Local_12[iVar312].f_16);
							Function_98(Local_12[iVar312].f_16, 1);
							...
							{
								Function_77(&(Local_12[iVar312]), 0);
							}
							else if (Local_12[iVar312].f_44 < 8)
							{
								Function_76(&(Local_12[iVar312]));
	...
	while (iVar0 < (iLocal_85 - 1))
	{
		if (Function_75(Local_12[iVar012].f_40, 2))
		{
			...
			Function_77(&(Local_12[iVar012]), 0);
		}
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_92))
								{
									...
									{
										bLocal_92 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_92 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_90, &bLocal_89);
...
void Function_29(bool bParam0, int iParam1) //Position: 0x1D37 / 7479
{
	bool bVar0;
	void fVar1[8];
	int iVar10;
	...
	{
		fVar1[0] = GET_WEAPON_IN_HAND(bVar0);
		fVar1[1] = GET_WEAPON_EQUIPPED(bVar0, false);
		fVar1[2] = GET_WEAPON_EQUIPPED(bVar0, true);
		fVar1[3] = GET_WEAPON_EQUIPPED(bVar0, 2);
		fVar1[4] = GET_WEAPON_EQUIPPED(bVar0, 3);
		fVar1[5] = GET_WEAPON_EQUIPPED(bVar0, 4);
		fVar1[6] = GET_WEAPON_EQUIPPED(bVar0, 5);
		fVar1[7] = GET_WEAPON_EQUIPPED(bVar0, 6);
		iVar10 = 0;
		while (iVar10 < 7)
		{
			if (fVar1[iVar10] != 4294967295)
			{
				DELETE_WEAPON_FROM_ACTOR(bVar0, fVar1[iVar10]);
				if (!DECOR_CHECK_EXIST(bVar0, "Hogtie_DontGiveWeapons"))
				{
					if (IS_ACTOR_LOCAL_PLAYER(bParam0))
					{
						SET_WEAPONENUM_LOCKED(fVar1[iVar10], 0);
					}
					if (GET_AMMO_ENUM(fVar1[iVar10]) != 4294967295)
					{
						bVar11 = GET_AMMO_ENUM(fVar1[iVar10]);
						if (!ACTOR_HAS_WEAPON(bParam0, fVar1[iVar10]))
						{
							GIVE_WEAPON_TO_ACTOR(bParam0, fVar1[iVar10], 0.0f, 1, 0);
							if ((_GET_MAX_AMMO_AMOUNT(bParam0, bVar11) - _GET_AMMO_AMOUNT(bParam0, bVar11, 0)) < 5.0f)
							{
								_ADD_AMMO_OF_TYPE(bParam0, bVar11, GET_WEAPON_MAX_AMMO(fVar1[iVar10]), 1, 1);
							}
						}
...
bool Function_30(int iParam0) //Position: 0x1F63 / 8035
{
	iParam0 = iParam0;
	return 0;
}

bool Function_31(bool bParam0) //Position: 0x1F6E / 8046
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1F88 / 8072
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1FA6 / 8102
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1FC5 / 8133
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1FF8 / 8184
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x2017 / 8215
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x2031 / 8241
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x2044 / 8260
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x232C / 9004
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2334 / 9012
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x2351 / 9041
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2360 / 9056
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2382 / 9090
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x23A6 / 9126
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x23C3 / 9155
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x23E3 / 9187
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2403 / 9219
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x24B1 / 9393
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2521 / 9505
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2537 / 9527
{
...
var Function_51(bool bParam0) //Position: 0x2558 / 9560
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2578 / 9592
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(bool bParam0) //Position: 0x258C / 9612
{
	bParam0 = bParam0;
	if (iLocal_2 && !iLocal_3)
	{
		iLocal_3 = 1;
		iLocal_0 = CREATE_LAYOUT("hogtieGringo_Layout");
		...
		*(&Local_4 + 12) = { StackVal, StackVal, Function_59(Global_34573) };
		...
		bLocal_1 = Function_54(iLocal_0, 0, &Local_4, Global_34573, GET_TARGET_ACTOR(), 1, 0, 1);
		UI_PUSH("nCutscenes");
	}
	return;
}

bool Function_54(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, var uParam7) //Position: 0x2602 / 9730
{
	bool bVar0;
...
void Function_55(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x267A / 9850
{
	bool bVar0;
	bool bVar1;
	...
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_EASE_IN_OUT(*uParam0, 0, 1, 2,5f, 1, 1);
	SET_TRANSITION_COLLISION_PARAMS(bVar1, 1, 0);
	bVar1 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 1, 1.0f, 2);
	SET_TRANSITION_COLLISION_PARAMS(bVar1, 1, 0);
}

void Function_56(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x26ED / 9965
{
	vector3 vVar0;
...
void Function_57(var uParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x27D5 / 10197
{
	vector3 vVar0;
...
vector3 Function_58(bool bParam0) //Position: 0x28E0 / 10464
{
	vector3 vVar0;
...
vector3 Function_59(bool bParam0) //Position: 0x2907 / 10503
{
	vector3 vVar0;
...
int Function_60() //Position: 0x292E / 10542
{
	return 1;
}

void Function_61(var uParam0, int iParam1) //Position: 0x2935 / 10549
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_62(bool bParam0, var uParam1, int iParam2) //Position: 0x2944 / 10564
{
	bool bVar0;
...
bool Function_63(bool bParam0) //Position: 0x2983 / 10627
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_64(bool bParam0) //Position: 0x29AE / 10670
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_65(bool bParam0) //Position: 0x29B9 / 10681
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_66(bool bParam0) //Position: 0x2AAF / 10927
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_67(bool bParam0) //Position: 0x2AD1 / 10961
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_68(int iParam0) //Position: 0x2AF8 / 11000
{
	iParam0 = iParam0;
	return;
}

void Function_69(int iParam0) //Position: 0x2B02 / 11010
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x2B0C / 11020
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x2B2A / 11050
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, int iParam1) //Position: 0x2B3F / 11071
{
	bool bVar0;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B63 / 11107
{
...
int Function_74(bool bParam0) //Position: 0x2B8E / 11150
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2C93 / 11411
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CA0 / 11424
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D13 / 11539
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_89));
		iLocal_90 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x3211 / 12817
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3248 / 12872
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x3265 / 12901
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x329D / 12957
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32A7 / 12967
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x32C8 / 13000
{
	bool bVar0;
...
int Function_84(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x33DC / 13276
{
	int iVar0;
	int iVar1;
	...
	{
		Function_85(iParam0, 1, TO_FLOAT(bParam1), 1, 1, 3.0f, 0, uParam3);
	}
...
void Function_85(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x35FC / 13820
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_86(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_39(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_86(int iParam0) //Position: 0x3C29 / 15401
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_87(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3C3A / 15418
{
	char* cVar0[32];
...
struct<32> Function_88(char* cParam0, char* cParam1) //Position: 0x3D2F / 15663
{
	char* cVar0[32];
...
void Function_89(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3D48 / 15688
{
	float fVar0;
...
var Function_90(int iParam0, int iParam1) //Position: 0x3DAD / 15789
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_91(int iParam0, bool bParam1) //Position: 0x3DBF / 15807
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_92(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3DD1 / 15825
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float Function_94(int iParam0) //Position: 0x3F10 / 16144
{
	if (!iParam0 != 4294967295)
	{
...
var Function_95(int iParam0) //Position: 0x3F49 / 16201
{
	if (iParam0 == 4294967295)
	{
...
void Function_96(int iParam0) //Position: 0x3F86 / 16262
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_97(int iParam0, float fParam1, bool bParam2) //Position: 0x4122 / 16674
{
	int iVar0;
	int iVar1;
...
void Function_98(bool bParam0, bool bParam1) //Position: 0x433C / 17212
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_99(bool bParam0, bool bParam1) //Position: 0x4444 / 17476
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_100(int iParam0) //Position: 0x445A / 17498
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_101(bool bParam0, int iParam1) //Position: 0x4710 / 18192
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	...
	SET_ACTOR_INVULNERABILITY(GET_TARGET_ACTOR(), true);
	return;
}

bool Function_102(bool bParam0) //Position: 0x4741 / 18241
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_103(bool bParam0) //Position: 0x475A / 18266
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_104(bool bParam0, int iParam1) //Position: 0x4774 / 18292
{
	bool bVar0;
	int iVar1;
	
	bParam0 = bParam0;
	iVar1 = Function_105(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_105(var uParam0, int iParam1) //Position: 0x47AC / 18348
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_106(int iParam0, int iParam1) //Position: 0x47C3 / 18371
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_107(bool bParam0) //Position: 0x4A8C / 19084
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_108(bool bParam0, bool bParam1) //Position: 0x4AA9 / 19113
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_109(int iParam0) //Position: 0x4B45 / 19269
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_110(bool bParam0, int iParam1) //Position: 0x4B64 / 19300
{
	int iVar0;
...
bool Function_111(int iParam0) //Position: 0x4BB2 / 19378
{
...
void Function_112(int iParam0) //Position: 0x4BCE / 19406
{
	iParam0 = iParam0;
	return;
}

void Function_113(bool bParam0, int iParam1) //Position: 0x4BD8 / 19416
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_114(&(Local_12[iLocal_8512]), bParam0);
		iLocal_85++;
	}
...
void Function_114(int iParam0, int iParam1) //Position: 0x4C3A / 19514
{
...
void Function_115(int iParam0) //Position: 0x4C4E / 19534
{
	iParam0 = iParam0;
	return;
}

void Function_116(int iParam0) //Position: 0x4C58 / 19544
{
