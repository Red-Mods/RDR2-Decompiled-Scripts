...
void main() //Position: 0x0 / 0
{
	...
	bLocal_331 = false;
	iLocal_307 = 0;
	if ((!Function_81(49, 0) && !Function_75(49)) && Global_3365)
	{
		iLocal_332 = 1;
		Function_74(&(Global_29008[iScriptParam_0]), 2048);
	}
	else
	{
		iLocal_332 = 0;
	...
	while (!IS_EXITFLAG_SET())
	{
		...
		switch (iLocal_307)
		{
			...
			case 0x00000003:
				...
				Function_60(&Global_7032, &Global_8275, iScriptParam_0);
				iLocal_307 = 5;
				bLocal_308 = false;
				break;
			
			case 0x00000005:
				if (Function_59(&Global_7032, &Global_8275, iScriptParam_0))
				{
					iLocal_307 = 4;
					bLocal_308 = false;
				}
			...
			case 0x00000006:
				if (IS_PERS_CHAR_VALID(Global_8492[1214]))
				{
					if (Function_81(53, 0) && (!Function_81(56, 0) || !Function_81(51, 0)))
					{
						...
						Function_52(12, &Local_333, -104,413f, 119,521f, 1367,917f);
						Function_50(12, &Local_333, -104,826f, 119,489f, 1368,328f);
						Function_49(Global_8492[1214], &(Local_333[1220]));
					}
					else
					{
						Function_56(12, &Local_333, -108,119f, 119,477f, 1357,974f);
						Function_55(12, &Local_333, -116,552f, 118,869f, 1346,602f);
						Function_54(12, &Local_333, -108,119f, 119,477f, 1357,974f);
						Function_53(12, &Local_333, -116,552f, 118,869f, 1346,602f);
						Function_52(12, &Local_333, -108,119f, 119,477f, 1357,974f);
						Function_50(12, &Local_333, -104,826f, 119,489f, 1368,328f);
						Function_49(Global_8492[1214], &(Local_333[1220]));
					}
				}
				Function_45(&Global_7032, &Global_8275, &uLocal_310, Global_6289, iScriptParam_0);
				if (Function_58(&(Global_29008[iScriptParam_0]), 256) || !Function_73(2))
				{
					iLocal_332 = 1;
				}
				Function_40(11, Local_13.f_1036, Local_13.f_528, 0, 0, 0, Local_4.f_32);
				if (Function_81(49, 0))
				{
				...
				Function_40(12, Local_13.f_1168, Local_13.f_500, 0, 0, 0, Local_4.f_32);
				Function_74(&(Global_29008[iScriptParam_0]), 8);
				if (Function_58(&(Global_29008[iScriptParam_0]), 131072))
				{
					Function_39(&(Global_29008[iScriptParam_0]), 131072);
					iLocal_307 = 10;
				}
				else
				{
			...
			case 0x00000008:
				Function_35(StackVal, 2, 0,5f, 4, Local_4, 1);
			...
			case 0x0000000A:
				if (!Function_23(Global_62981, 1))
				{
					if (Function_21(&(Global_30717[1]), 0))
					{
						Function_20(&Global_62981, 1);
					}
				}
				if (!bLocal_331)
				{
					if (!Function_81(48, 0))
					{
						bLocal_331 = Function_17(-75,95f, 116,86f, 1418,33f, 0, 0);
					}
				}
				if (Function_58(&(Global_29008[iScriptParam_0]), 131072))
				{
	...
	Function_6();
	Function_1();
	Function_39(&(Global_29008[iScriptParam_0]), 32);
	Function_39(&(Global_29008[iScriptParam_0]), 64);
	Function_39(&(Global_29008[iScriptParam_0]), 8);
	Function_39(&(Global_29008[iScriptParam_0]), 512);
	Function_39(&(Global_29008[iScriptParam_0]), 4);
...
void Function_7(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x743 / 1859
{
	...
	if (Function_58(&(Global_29008[iParam2]), 0x40000000))
	{
		...
		Function_39(&(Global_29008[iParam2]), 0x40000000);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= *uParam0)
	...
	bVar1 = true;
	if (!Function_73(2) || Function_58(&(Global_29008[iParam2]), 256))
	{
		bVar1 = false;
	}
	iVar0 = 0;
...
void Function_8(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x92E / 2350
{
...
int Function_9(int iParam0) //Position: 0xA7D / 2685
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_10(int iParam0) //Position: 0xAA8 / 2728
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_11(var uParam0, int iParam1) //Position: 0xADC / 2780
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_12(var uParam0, int iParam1) //Position: 0xAEB / 2795
{
	int iVar0;
...
bool Function_13(var uParam0, int iParam1) //Position: 0xB02 / 2818
{
	int iVar0;
...
bool Function_15(int iParam0) //Position: 0xFCC / 4044
{
...
bool Function_16() //Position: 0xFE2 / 4066
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_17(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0xFEB / 4075
{
	var uVar0[2];
	int iVar3;
	bool bVar4;
	...
	Function_19(StackVal, StackVal, vParam0, &(uVar0[0]), &(uVar0[1]));
	iVar3 = 0;
	if (bParam3)
	{
	...
	else
	{
		if (IS_GRINGO_VALID(uVar0[0]))
		{
			bVar4 = GET_ACTOR_FROM_OBJECT(Function_18(uVar0[0], "UseCase1"));
		...
		if (IS_GRINGO_VALID(uVar0[1]))
		{
			bVar5 = GET_ACTOR_FROM_OBJECT(Function_18(uVar0[1], "UseCase1"));
...
var Function_18(bool bParam0, bool bParam1) //Position: 0x114C / 4428
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_19(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x1159 / 4441
{
	bool bVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1203 / 4611
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_21(float fParam0, bool bParam1) //Position: 0x1212 / 4626
{
	bool bVar0;
	int iVar1;
	...
	while (iVar1 <= 6)
	{
		if (bParam1)
		{
			Function_22(*fParam0, iVar1, bParam1);
			bVar0 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Function_22(*fParam0, iVar1, bParam1), 1.0f, "p_gen_chairpokerfancy01x", 1);
		}
		else
		{
			Function_22(*fParam0, iVar1, 0);
			bVar0 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Function_22(*fParam0, iVar1, 0), 1.0f, "p_gen_chair05x", 1);
		}
...
vector3 Function_22(int iParam0, int iParam1, bool bParam2) //Position: 0x12D5 / 4821
{
	if (iParam0 == Global_30668[0])
	{
		switch (iParam1)
...
bool Function_23(var uParam0, int iParam1) //Position: 0x184F / 6223
{
	return (uParam0 && iParam1) == 0;
}

void Function_24(bool bParam0, float fParam1) //Position: 0x185C / 6236
{
	if (!Function_73(128))
	{
		return;
...
void Function_25(bool bParam0, bool bParam1) //Position: 0x189A / 6298
{
	char[] cVar0[4];
...
void Function_26(var uParam0, int iParam1) //Position: 0x1994 / 6548
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_27(bool bParam0) //Position: 0x19A1 / 6561
{
	vector3 vVar0;
...
void Function_28(var uParam0) //Position: 0x1A8C / 6796
{
	int iVar0;
...
var Function_29() //Position: 0x1AA9 / 6825
{
	int iVar0;
...
void Function_30(int iParam0) //Position: 0x1AB1 / 6833
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_31(var uParam0, int iParam1, int iParam2, var uParam3, int iParam4) //Position: 0x1AC4 / 6852
{
...
void Function_32() //Position: 0x1BA8 / 7080
{
	int iVar0;
...
int Function_33(int iParam0) //Position: 0x1BF6 / 7158
{
...
bool Function_34(bool bParam0) //Position: 0x1C0E / 7182
{
...
void Function_35(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x1C23 / 7203
{
	bool bVar0;
...
void Function_36(int iParam0) //Position: 0x1D36 / 7478
{
	Function_37(&Global_28842, iParam0);
	return;
}

void Function_37(var uParam0, var uParam1) //Position: 0x1D44 / 7492
{
...
void Function_38() //Position: 0x1D5F / 7519
{
...
void Function_39(var uParam0, int iParam1) //Position: 0x1D7B / 7547
{
	int iVar0;
...
void Function_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6) //Position: 0x1D92 / 7570
{
	var uVar0;
	bool bVar3[2];
	bool bVar6;
	...
	if (IS_DOOR_VALID(bParam4))
	{
		...
		{
			Function_42(bParam4, 0);
		}
		else
		{
			Function_41(bParam4, 1);
		}
	}
	if (IS_DOOR_VALID(bParam5))
	{
		if (Global_16537[iParam021].f_40 == 3)
		{
			Function_42(bParam5, 0);
		}
		else
		{
			Function_41(bParam5, 1);
		}
	}
	...
	if (IS_OBJECT_VALID(bParam6))
	{
		...
		{
			bVar6 = GET_ACTOR_FROM_OBJECT(Function_18(bVar3[0], "UseCase1"));
		...
		{
			bVar7 = GET_ACTOR_FROM_OBJECT(Function_18(bVar3[1], "UseCase1"));
...
void Function_41(bool bParam0, bool bParam1) //Position: 0x2125 / 8485
{
...
void Function_42(bool bParam0, bool bParam1) //Position: 0x2179 / 8569
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_43(int iParam0) //Position: 0x21CA / 8650
{
...
int Function_44(bool bParam0, bool bParam1) //Position: 0x21E0 / 8672
{
	if (!IS_OBJECT_VALID(bParam1))
	{
...
void Function_45(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x233A / 9018
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 >= 0)
	{
		Function_39(&(Global_29008[iParam4]), 2048);
	}
...
bool Function_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x23EC / 9196
{
	int iVar0;
	char* cVar1[16];
	...
	Function_49(StackVal, uParam3[iVar020]);
	return 1;
}

bool Function_47(vector3 vParam0) //Position: 0x2557 / 9559
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

var Function_48(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x256F / 9583
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
int Function_49(bool bParam0, int iParam1) //Position: 0x2688 / 9864
{
	vector3 vVar0;
	bool bVar20;
...
void Function_50(int iParam0, var uParam1, vector3 vParam2) //Position: 0x27C4 / 10180
{
	bool bVar0;
...
bool Function_51(vector3 vParam0, vector3 vParam3) //Position: 0x282A / 10282
{
	vector3 vVar0;
...
void Function_52(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2857 / 10327
{
	bool bVar0;
...
void Function_53(int iParam0, var uParam1, vector3 vParam2) //Position: 0x28BF / 10431
{
	bool bVar0;
...
void Function_54(int iParam0, var uParam1, vector3 vParam2) //Position: 0x2929 / 10537
{
	bool bVar0;
...
void Function_55(int iParam0, var uParam1, vector3 vParam2) //Position: 0x298E / 10638
{
	bool bVar0;
...
void Function_56(int iParam0, var uParam1, vector3 vParam2) //Position: 0x29F6 / 10742
{
	bool bVar0;
...
int Function_57(int iParam0) //Position: 0x2A59 / 10841
{
	if (!Function_15(iParam0))
	{
		return 1;
...
bool Function_58(var uParam0, int iParam1) //Position: 0x2A75 / 10869
{
	int iVar0;
...
bool Function_59(var uParam0, var uParam1, int iParam2) //Position: 0x2A91 / 10897
{
	int iVar0;
...
void Function_60(var uParam0, var uParam1, int iParam2) //Position: 0x2B5D / 11101
{
	int iVar0;
	...
	if (!Function_58(&(Global_29008[iParam2]), 0x40000000))
	{
		if (_IS_TYPE_ID_VALID_BY_STRING(Function_14(iParam2), 12))
		{
			...
			Function_74(&(Global_29008[iParam2]), 0x40000000);
		}
	}
	iVar0 = 0;
	while (iVar0 <= *uParam0)
...
bool Function_61() //Position: 0x2C33 / 11315
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_69(3, 3);
	bVar0 = bVar0;
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_horseshoe", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/repair_kneel", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_smoke", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_pocketwatch_e_any", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_wall", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_table", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_docks", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/lean_fence_l_talking", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/horse_tend", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/cow_knl", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_drink", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_throwbottle", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/campfire_talk", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_l", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/player_sleep_bed_l", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/use_shelf", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/kneel_hammer", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_yawning_n_any", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/lie_sleep_on_bed_l", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_play_harmonica", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/fake_horseshoe", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/locked_footlocker", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/dog_sleeping", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/dog_begging", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/lean_table", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/dog_sitting", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/pet_dog", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_cleanwindow_w_any", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/stand_stirringpot_w_any", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/multistage_bucket", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/multistage_hay_bale", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/multistage_sweeping", 1, 0);
	Function_67(&Local_13 + 4, "$/content/scripting/gringo/simplegringo/multistage_dusting", 1, 0);
	if (!Function_62(&Local_13 + 4))
	{
		return 0;
	}
	...
	*(&Local_13 + 936[36] + 12) = { 0.0f, -34,14276f, 0.0f };
	...
	Local_13.f_1056 = CREATE_OBJECTSET_IN_LAYOUT(Function_29(), Local_13, 12, 0);
	...
	Local_13.f_1060 = CREATE_OBJECTSET_IN_LAYOUT(Function_29(), Local_13, 12, 0);
	...
	DECOR_SET_BOOL(Local_13.f_1068, "PlayerHouseChest", true);
	...
	Local_13.f_1144 = CREATE_OBJECTSET_IN_LAYOUT(Function_29(), Local_13, 12, 0);
...
bool Function_62(int iParam0) //Position: 0x589A / 22682
{
	int iVar0;
	int iVar1;
...
void Function_63() //Position: 0x5C15 / 23573
{
	if (!Function_73(128))
	{
		return;
...
bool Function_64() //Position: 0x5C55 / 23637
{
	int iVar0;
...
void Function_65(var uParam0, int iParam1) //Position: 0x5C80 / 23680
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_66() //Position: 0x5C91 / 23697
{
	if (!Function_73(128))
	{
		return;
...
var Function_67(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5CD3 / 23763
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_68(uParam0, bVar1, iParam2);
	if (bParam3)
	{
		Function_65(uParam0[iVar03], 8);
	}
	return iVar0;
}

var Function_68(var uParam0, int iParam1, int iParam2) //Position: 0x5D0B / 23819
{
	int iVar0;
...
void Function_69(int iParam0, int iParam1) //Position: 0x5DCF / 24015
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_70() //Position: 0x5E18 / 24088
{
	var uVar0;
...
void Function_71(bool bParam0, int iParam1) //Position: 0x604B / 24651
{
	if (!Function_73(128))
	{
		return;
...
void Function_72(int iParam0) //Position: 0x6086 / 24710
{
	int iVar0;
...
bool Function_73(int iParam0) //Position: 0x60BA / 24762
{
	int iVar0;
...
void Function_74(var uParam0, int iParam1) //Position: 0x60D6 / 24790
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_75(int iParam0) //Position: 0x60E5 / 24805
{
	int iVar0;
...
bool Function_76(int iParam0) //Position: 0x611B / 24859
{
...
bool Function_77(int iParam0) //Position: 0x613F / 24895
{
...
bool Function_78(int iParam0) //Position: 0x6154 / 24916
{
...
var Function_79(int iParam0) //Position: 0x616B / 24939
{
	if (!Function_80(iParam0))
	{
		return 4294967295;
...
bool Function_80(int iParam0) //Position: 0x6185 / 24965
{
...
bool Function_81(int iParam0, bool bParam1) //Position: 0x619B / 24987
{
	int iVar0;
