...
void main() //Position: 0x0 / 0
{
	...
	bVar4 = Function_25("Dogs", 0);
	Function_23(&bVar4, 1032, 8.0f, 0, 0);
	Function_23(&bVar4, 1032, 8.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar6))
	{
		...
		if (IS_VOLUME_VALID(bVar7))
		{
			Function_6(bVar7, bVar1, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar7))
		{
			Function_6(bVar7, bVar4, 1, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar7))
		{
			Function_7(bVar7, bVar5, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0xF1C / 3868
{
	bool bVar0;
...
var Function_6(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1051 / 4177
{
	bool bVar0;
...
var Function_7(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x10D1 / 4305
{
	bool bVar0;
...
var Function_13(int iParam0) //Position: 0x1239 / 4665
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x12A5 / 4773
{
	bool bVar0;
...
int Function_15(int iParam0) //Position: 0x1311 / 4881
{
	int iVar0;
...
bool Function_16(int iParam0) //Position: 0x1347 / 4935
{
...
bool Function_17(int iParam0) //Position: 0x136B / 4971
{
...
bool Function_18(int iParam0) //Position: 0x1380 / 4992
{
...
var Function_19(int iParam0) //Position: 0x1397 / 5015
{
	if (!Function_20(iParam0))
	{
		return 4294967295;
...
bool Function_20(int iParam0) //Position: 0x13B1 / 5041
{
...
int Function_21(int iParam0, bool bParam1) //Position: 0x13C7 / 5063
{
	int iVar0;
...
bool Function_22() //Position: 0x1404 / 5124
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_23(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x140D / 5133
{
	int iVar0;
	int iVar1;
...
var Function_24(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1482 / 5250
{
	int iVar0;
	int iVar1;
...
int Function_25(bool bParam0, int iParam1) //Position: 0x14C7 / 5319
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_26(int iParam0) //Position: 0x14D4 / 5332
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_27(bool bParam0, var uParam1) //Position: 0x14E0 / 5344
{
	if (!Function_8(128))
	{
		return;
