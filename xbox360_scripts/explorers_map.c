...
float Function_26(int iParam0) //Position: 0x150B / 5387
{
	if (iParam0 == 4294967295)
	{
...
void Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x2309 / 8969
{
	char* cVar0;
	var uVar1;
	
	bParam0 = Function_68(bParam0);
	if ((Function_64(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	cVar0 = GET_GRINGO_STRING_ATTR("nRegionMap", bParam0, &uVar1);
	if (Function_63(cVar0, "CHOLLA_SPRINGS_REGION"))
	{
		Function_58(Global_30628[0]);
		Function_54(&Global_30640);
		Function_53("discover_cholla", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "GAPTOOTH_RIDGE_REGION"))
	{
		Function_58(Global_30628[1]);
		Function_54(&Global_30658);
		Function_53("discover_gaptooth", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "HENNIGANS_STEAD_REGION"))
	{
		Function_58(Global_30628[2]);
		Function_54(&Global_30668);
		Function_53("discover_hennigans", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "RIO_BRAVO_REGION"))
	{
		Function_58(Global_30628[3]);
		Function_54(&Global_30679);
		Function_53("discover_riobravo", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "PUNTA_ORGULLO_REGION"))
	{
		Function_58(Global_30633[0]);
		Function_54(&Global_30685);
		Function_53("discover_orgullo", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "PERDIDO_REGION"))
	{
		Function_58(Global_30633[2]);
		Function_54(&Global_30693);
		Function_53("discover_perdido", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "DIEZ_CORONAS_REGION"))
	{
		Function_58(Global_30633[1]);
		Function_54(&Global_30707);
		Function_53("discover_diezcoronas", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "GREAT_PLAINS_REGION"))
	{
		Function_58(Global_30637[0]);
		Function_54(&Global_30717);
		Function_53("discover_greatplains", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else if (Function_63(cVar0, "TALL_TREES_REGION"))
	{
		Function_58(Global_30637[1]);
		Function_54(&Global_30723);
		Function_53("discover_talltrees", 0x41200000, 1, 0, 2, 1, 0);
		*iParam2 = 1;
	}
	else
	{
...
void Function_53(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x2692 / 9874
{
	int iVar0;
...
int Function_54(int iParam0) //Position: 0x26DD / 9949
{
	int iVar0;
	...
	while (iVar0 <= *iParam0)
	{
		if (!Function_55((*iParam0)[iVar0]))
		{
			Function_58((*iParam0)[iVar0]);
		}
		iVar0++;
	}
	return 1;
...
bool Function_55(int iParam0) //Position: 0x270E / 9998
{
	if (!Function_57(iParam0))
	{
		return 0;
	}
	return Function_56(&(Global_29008[iParam0]), 4096);
}

bool Function_56(var uParam0, int iParam1) //Position: 0x272C / 10028
{
	int iVar0;
...
bool Function_57(int iParam0) //Position: 0x2748 / 10056
{
...
void Function_58(int iParam0) //Position: 0x275E / 10078
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_56(&(Global_29008[iParam0]), 4096))
	{
		return;
	}
...
void Function_59(int iParam0, bool bParam1) //Position: 0x285D / 10333
{
	bool bVar0;
...
var Function_60(int iParam0) //Position: 0x28C4 / 10436
{
	int iVar0;
	
	iVar0 = 4294967295;
	if (!iParam0 != 4294967295 && Function_57(iParam0))
	{
		if (StackVal == 1)
		{
			iVar0 = iParam0;
...
int Function_61(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x291C / 10524
{
	int iVar0;
	int iVar1;
...
void Function_62(var uParam0, int iParam1) //Position: 0x2B3C / 11068
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_63(char* cParam0, char* cParam1) //Position: 0x2B4B / 11083
{
	char* cVar0[64];
	char* cVar16[64];
...
int Function_64(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2B76 / 11126
{
...
bool Function_65() //Position: 0x2C2C / 11308
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_66(bool bParam0) //Position: 0x2C43 / 11331
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_67(bool bParam0) //Position: 0x2C4E / 11342
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_68(bool bParam0) //Position: 0x2C5C / 11356
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_69(int iParam0, bool bParam1) //Position: 0x2C76 / 11382
{
	bool bVar0;
	bool bVar1;
