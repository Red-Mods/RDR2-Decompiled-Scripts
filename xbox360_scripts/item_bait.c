...
void Function_62(bool bParam0) //Position: 0x2548 / 9544
{
	...
	{
		iLocal_1 = 1;
		iLocal_2 = CREATE_LAYOUT("item_bait_Layout");
		bLocal_3 = Function_63(iLocal_2, 0, Global_34573, 1, 0, 0);
	}
	return;
}

bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2584 / 9604
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x25FB / 9723
{
	bool bVar0;
	bool bVar1;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x2633 / 9779
{
...
void Function_66(int iParam0) //Position: 0x26BF / 9919
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26C9 / 9929
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26E7 / 9959
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26FC / 9980
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x2783 / 10115
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27A6 / 10150
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x27C4 / 10180
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x27E7 / 10215
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x2902 / 10498
{
...
int Function_75(bool bParam0) //Position: 0x292D / 10541
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A32 / 10802
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2A3F / 10815
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AB2 / 10930
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x2FB0 / 12208
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x2FE7 / 12263
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x3004 / 12292
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x303C / 12348
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x3046 / 12358
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(var uParam0, int iParam1) //Position: 0x3067 / 12391
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3098 / 12440
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x31A0 / 12704
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_87(int iParam0) //Position: 0x31B6 / 12726
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_88(bool bParam0, int iParam1) //Position: 0x346C / 13420
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_89(bool bParam0) //Position: 0x3489 / 13449
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x34A2 / 13474
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x34BC / 13500
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x34F4 / 13556
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x350B / 13579
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x37D4 / 14292
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x37F1 / 14321
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x388D / 14477
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x38AC / 14508
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_98(int iParam0) //Position: 0x38BB / 14523
{
...
void Function_99(int iParam0) //Position: 0x38D7 / 14551
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x38E1 / 14561
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3943 / 14659
{
...
void Function_102(int iParam0) //Position: 0x3957 / 14679
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3961 / 14689
{
