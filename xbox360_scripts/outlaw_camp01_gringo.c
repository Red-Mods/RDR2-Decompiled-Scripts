...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA1B / 2587
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x299D / 10653
{
...
void Function_51(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2CAB / 11435
{
	bool bVar0;
	bool bVar1;
...
bool Function_81(var uParam0, bool bParam1, int iParam2) //Position: 0x3CEB / 15595
{
...
void Function_88(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x44FE / 17662
{
	bool bVar0;
...
bool Function_89(bool bParam0, bool bParam1) //Position: 0x4552 / 17746
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_94(int iParam0, bool bParam1) //Position: 0x4702 / 18178
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_102(int iParam0) //Position: 0x4A6F / 19055
{
	bool bVar0;
	bool bVar1;
...
var Function_103(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4B69 / 19305
{
	int iVar0;
	bool bVar1;
...
void Function_104(var uParam0, int iParam1) //Position: 0x4BA1 / 19361
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_105(var uParam0, bool bParam1, int iParam2) //Position: 0x4BB2 / 19378
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x4C76 / 19574
{
	int iVar0;
	int iVar1;
...
void Function_107() //Position: 0x4FF1 / 20465
{
	if (!Function_154(128))
	{
		return;
...
bool Function_108() //Position: 0x5031 / 20529
{
	int iVar0;
...
void Function_109() //Position: 0x505C / 20572
{
	if (!Function_154(128))
	{
		return;
...
void Function_110(int iParam0, bool bParam1) //Position: 0x509E / 20638
{
	char* cVar0[32];
...
void Function_111(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5122 / 20770
{
	var uVar0;
	var uVar1;
...
void Function_112(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x514B / 20811
{
...
var Function_113(var uParam0, bool bParam1) //Position: 0x519C / 20892
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_114() //Position: 0x51AC / 20908
{
	return "PackedGrass";
}

var Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x51C0 / 20928
{
	int iVar0;
...
var Function_116() //Position: 0x51E5 / 20965
{
	return "PackedMetadata";
}

void Function_117(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x51FC / 20988
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_118() //Position: 0x5322 / 21282
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_119() //Position: 0x5333 / 21299
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_120() //Position: 0x5344 / 21316
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_121(var uParam0, int iParam1) //Position: 0x5355 / 21333
{
...
var Function_122(var uParam0, int iParam1, bool bParam2) //Position: 0x5378 / 21368
{
	int iVar0;
...
var Function_123(bool bParam0) //Position: 0x5397 / 21399
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_124() //Position: 0x53A3 / 21411
{
	return Function_125(39);
}

int Function_125(bool bParam0) //Position: 0x53AE / 21422
{
	bool bVar0;
...
var Function_126() //Position: 0x53DC / 21468
{
	return "PackedWeapon";
}

int Function_127(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x53F1 / 21489
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_128() //Position: 0x54F5 / 21749
{
	return "MPItemGiver";
}

struct<32> Function_129(bool bParam0) //Position: 0x5509 / 21769
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_130(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5573 / 21875
{
	char* cVar0[32];
...
var Function_132() //Position: 0x55A0 / 21920
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_133() //Position: 0x55C6 / 21958
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_134() //Position: 0x55EE / 21998
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_135(var uParam0, int iParam1) //Position: 0x5614 / 22036
{
	int iVar0;
	var uVar1;
...
void Function_136(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5775 / 22389
{
	struct<8> Var0;
...
int Function_137(bool bParam0) //Position: 0x5810 / 22544
{
	int iVar0;
	vector3 vVar1;
...
void Function_138(int iParam0) //Position: 0x5971 / 22897
{
...
var Function_139() //Position: 0x59D2 / 22994
{
	int iVar0;
...
var Function_140(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x59DA / 23002
{
	return Function_141(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_141(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x59F3 / 23027
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_142(int iParam0) //Position: 0x5CE6 / 23782
{
	int iVar0;
...
void Function_143() //Position: 0x5D9A / 23962
{
	int iVar0;
...
bool Function_144(bool bParam0) //Position: 0x5DD4 / 24020
{
	int iVar0;
...
void Function_145(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5E01 / 24065
{
	bool bVar0;
...
void Function_146() //Position: 0x5F52 / 24402
{
	int iVar0;
...
var Function_147(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5F9D / 24477
{
	int iVar0;
...
int Function_148() //Position: 0x606D / 24685
{
	int iVar0;
...
int Function_149() //Position: 0x61C9 / 25033
{
	int iVar0;
...
bool Function_150(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x62E9 / 25321
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_151(var uParam0, int iParam1) //Position: 0x63B9 / 25529
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_152(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x63D7 / 25559
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_153(bool bParam0) //Position: 0x6509 / 25865
{
	bool bVar0;
...
bool Function_154(int iParam0) //Position: 0x6528 / 25896
{
	int iVar0;
...
int Function_155() //Position: 0x6544 / 25924
{
	if (Function_157())
	{
...
int Function_156() //Position: 0x655D / 25949
{
	return Global_79349.f_16;
}

bool Function_157() //Position: 0x6569 / 25961
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_158(int iParam0, bool bParam1, bool bParam2) //Position: 0x6572 / 25970
{
	var uVar0;
