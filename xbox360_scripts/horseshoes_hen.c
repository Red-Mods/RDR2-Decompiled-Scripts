...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_23(Global_30668[0], &Local_24 + 4, &Local_24 + 68, &Local_24 + 72, &Local_24 + 60, &Local_24 + 64))
			{
				Function_22(&Local_24 + 4);
				Function_21(Global_30668[0], 0);
				*(&Local_24 + 16[03]) = { StackVal, StackVal, Function_21(Global_30668[0], 0) };
				Function_21(Global_30668[0], 1);
				*(&Local_24 + 16[13]) = { StackVal, StackVal, Function_21(Global_30668[0], 1) };
				Local_24 = Local_6;
				Local_24.f_52 = 1;
				Local_24.f_56 = 10;
