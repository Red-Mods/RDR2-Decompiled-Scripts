...
void main() //Position: 0x0 / 0
{
	...
	iLocal_76 = 0;
	Function_99(uScriptParam_0, &iLocal_76);
	while (IS_GRINGO_ACTIVE())
	{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_92(&(Local_3[iVar312]), &bVar4))
						{
							Function_90(GRINGO_GET_REQUESTING_ACTOR(), Local_3[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_85("eGRINGO_EndUse: Stop use by request", Local_3[iVar312].f_16);
							Function_84(Local_3[iVar312].f_16, 1);
							...
							{
								Function_77(&(Local_3[iVar312]), 0);
							}
							else if (Local_3[iVar312].f_44 < 8)
							{
								Function_76(&(Local_3[iVar312]));
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_83))
								{
									...
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_83 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_40(iParam0, bVar8, &iLocal_81, &bLocal_80);
		...
		case 0x00000006:
			...
			bVar0 = Function_50(iParam0->f_16, iParam0->f_12, Function_75(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
...
void Function_29(bool bParam0, bool bParam1) //Position: 0x1D37 / 7479
{
	...
	{
		if ((GRINGO_COMPONENT_CHECK_NAME("Push_Lft", bParam1) || GRINGO_COMPONENT_CHECK_NAME("Push_For", bParam1)) || GRINGO_COMPONENT_CHECK_NAME("Push_Rgt", bParam1))
		{
			bLocal_1 = CREATE_LAYOUT("LeanRail_Layout");
			bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bLocal_1, "LEANRAIL", 1, 1);
			bVar1 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(bVar0, 0);
			bVar2 = CUTSCENEOBJECT_ADD_TRANSITION_HOLD(bVar0, 0, 3.0f, 0);
			ADD_CAMERATRANSITION_EVENT_GAMECAMERARESET(bVar2, 3.0f, 1, 0);
			SET_CAMERASHOT_ASPECT_RATIO(bVar1, 0.0f);
			SET_CAMERASHOT_PERSPECTIVE(bVar1, 1);
			SET_CAMERASHOT_FOV(bVar1, 42,97919f);
			SET_CAMERASHOT_COLLISION_PARAMETERS(bVar1, 0,3f, 1);
			SET_CAMERASHOT_COLLISION_ENABLED(bVar1, 0);
			Function_31(GRINGO_GET_MY_OBJECT_REF());
			vVar3 = { StackVal, StackVal, Function_31(GRINGO_GET_MY_OBJECT_REF()) };
			GET_OBJECT_AXIS(GRINGO_GET_MY_OBJECT_REF(), &vVar6, 2);
			GET_OBJECT_AXIS(GRINGO_GET_MY_OBJECT_REF(), &vVar9, 0);
			vVar3 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(vVar6, vVar3, StackVal) * Vector(-3,2f, -3,2f, -3,2f), StackVal, StackVal) };
			vVar3 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) + Vector(Vector(vVar9, vVar3, StackVal) * Vector(0,75f, 0,75f, 0,75f), StackVal, StackVal) };
			vVar3.f_4 = (vVar3.y + 1,3f);
			SET_CAMERASHOT_POSITION(bVar1, vVar3);
			Function_31(GRINGO_GET_MY_OBJECT_REF());
			vVar3 = { StackVal, StackVal, Function_31(GRINGO_GET_MY_OBJECT_REF()) };
			vVar3.f_4 = (vVar3.y + 0,9f);
			SET_CAMERASHOT_TARGET_POSITION(bVar1, vVar3, 0);
			RESET_CAMERASHOT_TARGETDOF(bVar1);
			PLAY_CUTSCENEOBJECT(bVar0, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
			AI_GLOBAL_REPORT_DANGER(bParam0);
			bVar12 = GET_ACTOR_FROM_OBJECT(Function_30(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1"));
			if (!IS_ACTOR_VALID(bVar12))
			{
				bVar12 = GET_ACTOR_FROM_OBJECT(Function_30(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase2"));
			}
			if (IS_ACTOR_VALID(bVar12))
			{
				MEMORY_CONSIDER_AS_ENEMY(GET_ACTOR_FROM_OBJECT(bVar12), bParam0);
			}
		}
	}
	return;
...
var Function_30(bool bParam0, bool bParam1) //Position: 0x1ECE / 7886
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

vector3 Function_31(bool bParam0) //Position: 0x1EDB / 7899
{
	vector3 vVar0;
...
bool Function_32(int iParam0) //Position: 0x1F02 / 7938
{
	iParam0 = iParam0;
	return 1;
}

bool Function_33(bool bParam0) //Position: 0x1F0D / 7949
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_34(bool bParam0, int iParam1) //Position: 0x1F27 / 7975
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_35(bool bParam0) //Position: 0x1F45 / 8005
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1F64 / 8036
{
	int iVar0;
	int iVar1;
...
bool Function_37(bool bParam0) //Position: 0x1F97 / 8087
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1FB6 / 8118
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_39(var uParam0, int iParam1) //Position: 0x1FD0 / 8144
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_40(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1FE3 / 8163
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	PRINTNL();
	bVar2 = Function_48(uParam0->f_12, &bVar0);
...
var Function_41() //Position: 0x22CB / 8907
{
	int iVar0;
...
bool Function_42(bool bParam0, bool bParam1) //Position: 0x22D3 / 8915
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_43() //Position: 0x22F0 / 8944
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x22FF / 8959
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2321 / 8993
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_46(bool bParam0) //Position: 0x2345 / 9029
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2362 / 9058
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x2382 / 9090
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_49(bool bParam0, bool bParam1) //Position: 0x23A2 / 9122
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_50(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2450 / 9296
{
	bool bVar0;
...
void Function_51(int iParam0, float fParam1) //Position: 0x24C0 / 9408
{
	if (!Function_14(iParam0))
	{
...
void Function_52(int iParam0, float fParam1) //Position: 0x24D6 / 9430
{
...
var Function_53(bool bParam0) //Position: 0x24F7 / 9463
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_54(int iParam0) //Position: 0x2517 / 9495
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x252B / 9515
{
	uParam0 = uParam0;
	return;
}

int Function_56() //Position: 0x2535 / 9525
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x253C / 9532
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x254B / 9547
{
	bool bVar0;
...
bool Function_59(bool bParam0) //Position: 0x258A / 9610
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x25B5 / 9653
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x25C0 / 9664
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x26B6 / 9910
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x26D8 / 9944
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(int iParam0) //Position: 0x26FF / 9983
{
	iParam0 = iParam0;
	return;
}

void Function_65(int iParam0) //Position: 0x2709 / 9993
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2713 / 10003
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2731 / 10033
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2746 / 10054
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x27CD / 10189
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x27F0 / 10224
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x280E / 10254
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2831 / 10289
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x294C / 10572
{
...
int Function_74(bool bParam0) //Position: 0x2977 / 10615
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2A7C / 10876
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2A89 / 10889
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2AFC / 11004
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_80));
		iLocal_81 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_38(iParam0->f_12))
...
void Function_78() //Position: 0x2FFA / 12282
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3031 / 12337
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x304E / 12366
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x3086 / 12422
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3090 / 12432
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, bool bParam1) //Position: 0x30B1 / 12465
{
	bool bVar0;
	bool bVar1;
	...
	if ((GRINGO_COMPONENT_CHECK_NAME("Push_Lft", bParam1) || GRINGO_COMPONENT_CHECK_NAME("Push_For", bParam1)) || GRINGO_COMPONENT_CHECK_NAME("Push_Rgt", bParam1))
	{
		GRINGO_SET_REUSE_DELAY(20.0f, bParam1);
		bVar0 = GRINGO_GET_PARENT_COMPONENT(bParam1, 3);
		if (IS_GRINGO_COMPONENT_VALID(bVar0))
		{
			bVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_Lft", 3, bVar0);
			if (IS_GRINGO_COMPONENT_VALID(bVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, bVar1);
			}
			bVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_For", 3, bVar0);
			if (IS_GRINGO_COMPONENT_VALID(bVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, bVar1);
			}
			bVar1 = GRINGO_GET_FIRST_NAMED_CHILD("Push_Rgt", 3, bVar0);
			if (IS_GRINGO_COMPONENT_VALID(bVar1))
			{
				GRINGO_SET_REUSE_DELAY(20.0f, bVar1);
			}
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x318B / 12683
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3293 / 12947
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x32A9 / 12969
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x355F / 13663
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x356D / 13677
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3586 / 13702
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x35A0 / 13728
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x35D8 / 13784
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x35EF / 13807
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x38B8 / 14520
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x38D5 / 14549
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3971 / 14705
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, bool bParam1) //Position: 0x3990 / 14736
{
	bool bVar0;
	bool bVar1;
	
	uParam0 = uParam0;
	if (!IS_GRINGO_VALID(bLocal_2))
	{
		bLocal_2 = GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	}
	if (!(GRINGO_COMPONENT_CHECK_NAME("UseCase1", bParam1) || GRINGO_COMPONENT_CHECK_NAME("UseCase2", bParam1)))
	{
		bVar0 = GRINGO_GET_PARENT_COMPONENT(bParam1, 3);
		bVar1 = GRINGO_GET_COMPONENT_USER(bVar0);
		if (IS_OBJECT_VALID(bVar1))
		{
			if (!IS_ACTOR_MALE(GET_ACTOR_FROM_OBJECT(bVar1)))
			{
				return 0;
			}
			if (DECOR_CHECK_EXIST(bVar1, "CannotPush"))
			{
				return 0;
			}
		}
...
bool Function_97(int iParam0) //Position: 0x3A0D / 14861
{
...
void Function_98(int iParam0) //Position: 0x3A29 / 14889
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3A33 / 14899
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_100(&(Local_3[iLocal_7612]), bParam0);
		iLocal_76++;
	}
...
void Function_100(int iParam0, int iParam1) //Position: 0x3A95 / 14997
{
...
void Function_101(int iParam0) //Position: 0x3AA9 / 15017
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3AB3 / 15027
{
