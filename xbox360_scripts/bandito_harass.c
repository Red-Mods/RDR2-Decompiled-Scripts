...
bool Function_26(bool bParam0, bool bParam1) //Position: 0x1D06 / 7430
{
	bool bVar0;
	bool bVar1;
...
bool Function_27(bool bParam0) //Position: 0x1DF9 / 7673
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1E18 / 7704
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1E1E / 7710
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1E2C / 7724
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1E37 / 7735
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1E51 / 7761
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E6F / 7791
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E8E / 7822
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1EC1 / 7873
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1EE0 / 7904
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1EFA / 7930
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1F0D / 7949
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x21F5 / 8693
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x21FD / 8701
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x221A / 8730
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x2229 / 8745
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x224B / 8779
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x226F / 8815
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x228C / 8844
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x22AC / 8876
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x22CC / 8908
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x237A / 9082
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x23EA / 9194
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2400 / 9216
{
...
var Function_51(bool bParam0) //Position: 0x2421 / 9249
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2441 / 9281
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2455 / 9301
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x245F / 9311
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2466 / 9318
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2475 / 9333
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x24B4 / 9396
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x24DF / 9439
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24EA / 9450
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x25E0 / 9696
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2602 / 9730
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x2629 / 9769
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x28E8 / 10472
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2945 / 10565
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x29A2 / 10658
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x29AC / 10668
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x29CA / 10698
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x29DF / 10719
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A66 / 10854
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A89 / 10889
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2AA7 / 10919
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2ACA / 10954
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2BE5 / 11237
{
...
int Function_74(bool bParam0) //Position: 0x2C10 / 11280
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2D15 / 11541
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2D22 / 11554
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D95 / 11669
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x3293 / 12947
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x32CA / 13002
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x32E7 / 13031
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x331F / 13087
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x3329 / 13097
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(var uParam0, int iParam1) //Position: 0x334A / 13130
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	iLocal_1 = (iLocal_1 - 1);
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x335E / 13150
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3466 / 13414
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x347C / 13436
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x3732 / 14130
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	iLocal_1++;
...
bool Function_88(bool bParam0) //Position: 0x3746 / 14150
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x375F / 14175
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x3779 / 14201
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x37B1 / 14257
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x37C8 / 14280
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A91 / 14993
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3AAE / 15022
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B4A / 15178
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B69 / 15209
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3B78 / 15224
{
...
void Function_98(int iParam0) //Position: 0x3B94 / 15252
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B9E / 15262
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3C00 / 15360
{
...
void Function_101(int iParam0) //Position: 0x3C14 / 15380
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3C1E / 15390
{
