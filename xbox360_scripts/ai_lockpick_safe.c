...
void Function_20(var uParam0, bool bParam1) //Position: 0x1BCC / 7116
{
	...
	while (bVar1 < (iVar0 - 1))
	{
		bVar3 = GRINGO_GET_ATTRIBUTE(iParam1, bVar1);
...
float Function_23(char* cParam0) //Position: 0x1CC0 / 7360
{
...
var Function_25(char* cParam0) //Position: 0x1CE3 / 7395
{
...
bool Function_31(char* cParam0) //Position: 0x1D50 / 7504
{
...
bool Function_33(char* cParam0) //Position: 0x1D88 / 7560
{
	return Function_7(cParam0, "LinkToParentAnim", 0);
}

bool Function_34(int iParam0) //Position: 0x1DA7 / 7591
{
	int iVar0;
	int iVar1;
...
bool Function_35(char* cParam0) //Position: 0x1DDA / 7642
{
	return Function_7(cParam0, "LinkParentToAnim", 0);
}

bool Function_36(char* cParam0) //Position: 0x1DF9 / 7673
{
...
void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E26 / 7718
{
	...
	if (IS_GRINGO_COMPONENT_VALID(cVar4))
	{
		...
		bVar11 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(cVar4, uParam0->f_16);
		cVar12 = GRINGO_ANIM_GET_ACT_FILENAME(cVar4);
		iVar13 = GRINGO_ANIM_GET_ACT_ROOTNODE(cVar4);
		*uParam3 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bParam1, bVar11, cVar12, iVar13);
		if (IS_OBJECT_ANIMATOR_VALID(*uParam3))
		{
			if (Function_7(cVar4, "LinkToUser", 0))
			{
				if (Function_24())
				{
					Function_41();
...
bool Function_45(char* cParam0, int iParam1) //Position: 0x21A5 / 8613
{
	return Function_9(cParam0, "TargetAttachBone", iParam1);
}

bool Function_46(char* cParam0, int iParam1) //Position: 0x21C5 / 8645
{
	return Function_9(cParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, int iParam1) //Position: 0x21E5 / 8677
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(iVar0))
	{
		bVar2 = GRINGO_GET_ACTOR_SPECIFIC_AST_FILENAME(iVar0, iParam1);
		cVar3 = GRINGO_ANIM_GET_ACT_FILENAME(iVar0);
		iVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(iVar0);
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2293 / 8851
{
	int iVar0;
...
var Function_51(char* cParam0) //Position: 0x233A / 9018
{
...
void Function_56(char* cParam0, var uParam1, int iParam2) //Position: 0x238E / 9102
{
	bool bVar0;
	
	Function_59(cParam0);
	*uParam1 = { StackVal, StackVal, Function_59(cParam0) };
	*iParam2 = Function_58(cParam0);
	bVar0 = Function_57(cParam0);
	if (bVar0 < 180.0f)
	{
		bVar0 = 180.0f;
	}
...
var Function_57(char* cParam0) //Position: 0x23CD / 9165
{
	return Function_11(cParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(int iParam0) //Position: 0x23F8 / 9208
{
	return GRINGO_GET_USE_COMPONENT_HEADING(iParam0);
}

vector3 Function_59(int iParam0) //Position: 0x2403 / 9219
{
	vector3 vVar0;
	int iVar3;
	bool bVar4;
...
bool Function_60(char* cParam0) //Position: 0x24F9 / 9465
{
	return Function_7(cParam0, "UsePosActorRelative", 0);
}

var Function_61(char* cParam0) //Position: 0x251B / 9499
{
...
bool Function_66(char* cParam0) //Position: 0x28C5 / 10437
{
...
bool Function_68(bool bParam0, char* cParam1) //Position: 0x28F8 / 10488
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
	...
	Function_59(cParam1);
	vVar0 = { StackVal, StackVal, Function_59(cParam1) };
	bVar3 = Function_58(cParam1);
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
	}
	...
	if (GRINGO_HANDLES_MOVEMENT(cParam1) && DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "Volume"))
	{
		return Function_72(bParam0, cParam1);
	}
	uVar4 = Function_71(cParam1);
	uVar5 = Function_57(cParam1);
	Function_69(cParam1);
	vVar6 = { StackVal, StackVal, Function_69(cParam1) };
...
var Function_71(char* cParam0) //Position: 0x29C0 / 10688
{
	return Function_11(cParam0, "UseLocationTolerance", 0.0f);
}
...
bool Function_73(char* cParam0, int iParam1) //Position: 0x2AFE / 11006
{
...
int Function_74(bool bParam0) //Position: 0x2B29 / 11049
{
	...
	bVar1 = GRINGO_GET_INDEX_OF_NEXT_NAMED_CHILD("AttachProp", 1, iParam0, 0);
...
var Function_79(char* cParam0) //Position: 0x31E3 / 12771
{
...
bool Function_82(char* cParam0) //Position: 0x3242 / 12866
{
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3277 / 12919
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x337F / 13183
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3395 / 13205
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x364B / 13899
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(char* cParam0) //Position: 0x3659 / 13913
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_89(char* cParam0) //Position: 0x3672 / 13938
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x368C / 13964
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36C4 / 14020
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36DB / 14043
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
...
var Function_93(char* cParam0) //Position: 0x39A4 / 14756
{
	return Function_11(cParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, int iParam1) //Position: 0x39C1 / 14785
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
var Function_95(int iParam0) //Position: 0x3A5D / 14941
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A7C / 14972
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3A8B / 14987
{
...
void Function_98(int iParam0) //Position: 0x3AA7 / 15015
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AB1 / 15025
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_100(&(Local_1[iLocal_7412]), iParam0);
		iLocal_74++;
	}
	if (GRINGO_GET_CHILD_COMPONENT_COUNT(iParam0) >= 0)
	{
		bVar0 = false;
		bVar0 = GRINGO_GET_INDEX_OF_NEXT_CHILD(0, iParam0, bVar0);
		while (bVar0 <= 0 && *iParam1 > 6)
		{
			bVar1 = GRINGO_GET_INDEXED_CHILD_COMPONENT(bVar0, iParam0);
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B13 / 15123
{
...
void Function_101(int iParam0) //Position: 0x3B27 / 15143
{
	var uVar0;
	bool bVar3;
...
void Function_102(int iParam0) //Position: 0x3B9C / 15260
{
