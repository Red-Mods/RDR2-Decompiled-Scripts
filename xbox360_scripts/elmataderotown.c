		...
		switch (iLocal_456)
		{
			...
			case 0x00000001:
				if (Function_94())
				{
					...
					{
						Function_88(&(Global_7002[112]), 2);
						Function_88(&(Global_7002[12]), 2);
						Function_88(&(Global_7002[22]), 2);
					}
					iLocal_456 = 2;
			...
			case 0x00000003:
				...
				Function_77(&Global_7002, &Global_8231, iScriptParam_0);
				iLocal_456 = 5;
				bLocal_457 = false;
				break;
			
			case 0x00000005:
				if (Function_76(&Global_7002, &Global_8231, iScriptParam_0))
				{
					iLocal_456 = 4;
					bLocal_457 = false;
				}
			...
			case 0x00000006:
				...
				Function_68(1, &uLocal_459, -362,487f, 17,351f, 3945,686f);
				Function_67(1, &uLocal_459, Local_12);
				...
				Function_68(2, &uLocal_459, -287,557f, 24,147f, 3981,423f);
				Function_67(2, &uLocal_459, Local_12);
				Function_73(3, &uLocal_459, -461,111f, 20,61f, 3915,448f);
				Function_72(3, &uLocal_459, -498,128f, 17,815f, 3874,257f);
				Function_71(3, &uLocal_459, -441,189f, 25,867f, 3922,419f);
				Function_70(3, &uLocal_459, -473,888f, 20,591f, 3910,805f);
				Function_69(3, &uLocal_459, -477,125f, 20,59f, 3916,037f);
				Function_68(3, &uLocal_459, -441,189f, 25,867f, 3922,419f);
				Function_67(3, &uLocal_459, Local_12);
				Function_73(4, &uLocal_459, -473,9f, 20,605f, 3912,723f);
				Function_72(4, &uLocal_459, -411,211f, 23,888f, 3914,334f);
				Function_71(4, &uLocal_459, -431,954f, 22,839f, 4002,249f);
				Function_70(4, &uLocal_459, -441,189f, 25,867f, 3922,419f);
				Function_69(4, &uLocal_459, -466,945f, 20,586f, 3916,015f);
				Function_68(4, &uLocal_459, -431,954f, 22,839f, 4002,249f);
				Function_67(4, &uLocal_459, Local_12);
				Function_73(0, &uLocal_459, -441,189f, 25,867f, 3922,419f);
				Function_72(0, &uLocal_459, -443,101f, 22,456f, 3919,692f);
				Function_71(0, &uLocal_459, -439,336f, 22,537f, 3925,833f);
				Function_70(0, &uLocal_459, -443,101f, 22,456f, 3919,692f);
				Function_69(0, &uLocal_459, -439,336f, 22,537f, 3925,833f);
				Function_68(0, &uLocal_459, -439,336f, 22,537f, 3925,833f);
				Function_67(0, &uLocal_459, Local_12);
				Function_73(5, &uLocal_459, -466,5159f, 21,13641f, 3872,297f);
				Function_72(5, &uLocal_459, -469,0941f, 21,08241f, 3935,253f);
				Function_71(5, &uLocal_459, -460,99f, 20,579f, 3918,446f);
				Function_70(5, &uLocal_459, -469,0941f, 21,08241f, 3935,253f);
				Function_69(5, &uLocal_459, -459,691f, 21,064f, 3874,933f);
				Function_68(5, &uLocal_459, -463,847f, 21,16f, 3866,903f);
				Function_67(5, &uLocal_459, Local_12);
				Function_73(6, &uLocal_459, -478,024f, 20,16f, 3875,573f);
				Function_72(6, &uLocal_459, -403,488f, 24,17f, 3892,889f);
				Function_71(6, &uLocal_459, -404,066f, 23,891f, 3885,175f);
				Function_70(6, &uLocal_459, -403,488f, 24,17f, 3892,889f);
				Function_69(6, &uLocal_459, -403,488f, 24,17f, 3892,889f);
				Function_68(6, &uLocal_459, -467,765f, 21,083f, 3875,348f);
				Function_67(6, &uLocal_459, Local_12);
				Function_73(7, &uLocal_459, -464,043f, 21,082f, 3870,21f);
				Function_72(7, &uLocal_459, -429,991f, 22,537f, 3933,109f);
				Function_71(7, &uLocal_459, -401,24f, 24,094f, 3882,343f);
				Function_70(7, &uLocal_459, -469,479f, 20,586f, 3916,448f);
				Function_69(7, &uLocal_459, -464,616f, 21,083f, 3871,633f);
				Function_68(7, &uLocal_459, -460,739f, 21,116f, 3878,095f);
				Function_67(7, &uLocal_459, Local_12);
				Function_73(8, &uLocal_459, -473,92f, 21,082f, 3945,912f);
				Function_72(8, &uLocal_459, -473,92f, 21,082f, 3945,912f);
				Function_71(8, &uLocal_459, -460,99f, 20,579f, 3916,999f);
				Function_70(8, &uLocal_459, -473,92f, 21,082f, 3945,912f);
				Function_69(8, &uLocal_459, -466,516f, 21,121f, 3872,297f);
				Function_68(8, &uLocal_459, -462,927f, 21,106f, 3879,357f);
				Function_67(8, &uLocal_459, Local_12);
				Function_73(9, &uLocal_459, -417,204f, 24,094f, 3953,031f);
				Function_72(9, &uLocal_459, -401,222f, 24,1f, 3905,002f);
				Function_71(9, &uLocal_459, -400,343f, 24,094f, 3886,531f);
				Function_70(9, &uLocal_459, -401,222f, 24,1f, 3905,002f);
				Function_69(9, &uLocal_459, -467,765f, 21,083f, 3875,348f);
				Function_68(9, &uLocal_459, -478,024f, 20,16f, 3875,573f);
				Function_67(9, &uLocal_459, Local_12);
				Function_73(10, &uLocal_459, -465,4743f, 21,08235f, 3870,993f);
				Function_72(10, &uLocal_459, -417,204f, 24,094f, 3953,031f);
				Function_71(10, &uLocal_459, -460,99f, 20,655f, 3915,621f);
				Function_70(10, &uLocal_459, -417,204f, 24,094f, 3953,031f);
				Function_69(10, &uLocal_459, -465,474f, 21,082f, 3870,993f);
				Function_68(10, &uLocal_459, -461,381f, 21,118f, 3864,773f);
				Function_67(10, &uLocal_459, Local_12);
				...
				Function_68(11, &uLocal_459, -277,782f, 24,835f, 3979,783f);
				Function_67(11, &uLocal_459, Local_12);
				Function_63(&Global_7002, &Global_8231, &uLocal_459, Global_6289, iScriptParam_0);
				if (Function_75(&(Global_29008[iScriptParam_0]), 256) || !Function_62(2))
				{
					iLocal_700 = 1;
				}
				Function_61(StackVal, GET_OBJECT_FROM_PERS_CHAR(&Local_12 + 1716));
				Function_54(8, Local_12.f_1712, Local_12.f_1652, Local_12.f_1680, Function_60(iScriptParam_0, "elMatadero", "guardHouse01", 2), 0, Local_4.f_28);
			...
			case 0x00000007:
				...
				Function_39(&Global_62527, 4, Global_30707[0], "$/content/Mexico/Mini_Games/ArmWrestling_ELM/ArmWrestling_ELM", 4294967295, 0, "ElmArmWrestling", 351, -466,434f, 21,015f, 3882,245f, 2,5f, 0, 0);
				Function_38(&Global_62527, 4, 1);
				Function_37(&Global_62527, 4);
				iLocal_456 = 8;
				bLocal_457 = false;
				break;
			...
			case 0x00000008:
				Function_36(64);
				if (Function_35(iScriptParam_0, &Global_7002, iLocal_700))
				{
					Function_31(StackVal, 0, 0,2f, 3, Local_4, 1);
				...
				else
				{
					...
					switch (Global_30619)
					{
						case 0x00000000:
						case 0x00000001:
							Function_31(StackVal, 2, 0,5f, 3, Local_4, 1);
							break;
						
						case 0x00000002:
							Function_31(StackVal, 0, 0,5f, 3, Local_4, 1);
							break;
			...
			case 0x00000009:
				Function_21(Local_4, iScriptParam_0);
			...
			case 0x0000000A:
				if (!Function_19(Global_62981, 16))
				{
					if (Function_16(&(Global_30707[0])))
					{
						Function_15(&Global_62981, 16);
					}
				}
				if (Function_75(&(Global_29008[iScriptParam_0]), 131072))
				{
...
void Function_7(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xF39 / 3897
{
	...
	{
		STREAMING_EVICT_GRINGO_DICTIONARY(GET_ASSET_ID(Function_12(iParam2), 12));
	...
	while (iVar0 <= *uParam0)
	{
		if (!Function_11(uParam0[iVar02], 1))
		{
	...
	while (iVar0 <= *uParam0)
	{
		if (Function_11(uParam0[iVar02], 2) && !Function_11(uParam0[iVar02], 4))
		{
...
void Function_8(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x1124 / 4388
{
	if (IS_PERS_CHAR_VALID(StackVal))
	{
		if (!IS_PERS_CHAR_ALIVE(StackVal))
		{
			...
			{
				Function_88(uParam0[iParam22], 4);
...
int Function_9(int iParam0) //Position: 0x1273 / 4723
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_10(int iParam0) //Position: 0x129E / 4766
{
	switch (iParam0)
	{
		case 0x00000003:
...
bool Function_11(var uParam0, int iParam1) //Position: 0x12D2 / 4818
{
	int iVar0;
...
var Function_12(int iParam0) //Position: 0x12EE / 4846
{
...
bool Function_13(int iParam0) //Position: 0x179C / 6044
{
...
bool Function_14() //Position: 0x17B2 / 6066
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_15(var uParam0, int iParam1) //Position: 0x17BB / 6075
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_16(int iParam0) //Position: 0x17CA / 6090
{
	bool bVar0;
	...
	Function_17(*iParam0);
	bVar0 = LOCATE_PHYSINST_OF_PARTIAL_TYPE(Function_17(*iParam0), 1.0f, "p_gen_chair01x", 1);
	if (IS_PHYSINST_VALID(bVar0))
	{
		SET_PROP_FIXED(bVar0, 1);
	}
...
vector3 Function_17(int iParam0) //Position: 0x18C5 / 6341
{
	if (iParam0 == Global_30693[2])
	{
...
vector3 Function_18(int iParam0) //Position: 0x1974 / 6516
{
	if (iParam0 == Global_30693[2])
	{
...
bool Function_19(var uParam0, int iParam1) //Position: 0x1A1F / 6687
{
	return (uParam0 && iParam1) == 0;
}

void Function_20(bool bParam0, float fParam1) //Position: 0x1A2C / 6700
{
	if (!Function_62(128))
	{
		return;
...
void Function_21(bool bParam0, bool bParam1) //Position: 0x1A6A / 6762
{
	char[] cVar0[4];
	...
	{
		strcpy(&cVar0, "", 4);
		Function_22(Global_29155[bParam110].f_20, cVar0);
	}
...
void Function_22(var uParam0, int iParam1) //Position: 0x1B64 / 7012
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

int Function_23(bool bParam0, bool bParam1) //Position: 0x1B71 / 7025
{
	bool bVar0;
	bool bVar1;
...
void Function_24(bool bParam0) //Position: 0x1BEA / 7146
{
	vector3 vVar0;
	...
	if (GET_NUM_ITERATOR_MATCHES(Global_26361.f_20) >= 0)
	{
		...
		Global_26361.f_24 = GET_OBJECT_FROM_VOLUME(CREATE_VOLUME_IN_LAYOUT(Global_26361.f_16, Function_26(), 3, vVar0, 0.0f, 0.0f, 0.0f, 2.0f, 5.0f, 2.0f));
		Function_25(2097152);
	}
...
void Function_25(var uParam0) //Position: 0x1CD5 / 7381
{
	int iVar0;
...
var Function_26() //Position: 0x1CF2 / 7410
{
	int iVar0;
...
void Function_27(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x1CFA / 7418
{
...
void Function_28() //Position: 0x1DDE / 7646
{
	int iVar0;
	
	Global_26960 = Function_29(StackVal);
	iVar0 = 0;
...
int Function_29(int iParam0) //Position: 0x1E2C / 7724
{
...
bool Function_30(bool bParam0) //Position: 0x1E44 / 7748
{
...
void Function_31(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x1E59 / 7769
{
	bool bVar0;
...
void Function_32(int iParam0) //Position: 0x1F6C / 8044
{
	Function_33(&Global_28842, iParam0);
	return;
}

void Function_33(var uParam0, var uParam1) //Position: 0x1F7A / 8058
{
...
void Function_34() //Position: 0x1F95 / 8085
{
...
bool Function_35(int iParam0, int iParam1, bool bParam2) //Position: 0x1FB1 / 8113
{
	char* cVar0[64];
	struct<5> Var16;
...
void Function_36(int iParam0) //Position: 0x2071 / 8305
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_37(var uParam0, int iParam1) //Position: 0x2084 / 8324
{
	uParam0[iParam140]->f_128 |= 2097152;
	return;
}

void Function_38(var uParam0, int iParam1, float fParam2) //Position: 0x209F / 8351
{
...
void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, char* cParam6, int iParam7, vector3 vParam8, int iParam11, bool bParam12, int iParam13) //Position: 0x20C3 / 8387
{
	if (Function_14() && !bParam12)
	{
		return;
	}
	if (!Function_14() && bParam12)
	...
	uParam0[iParam140]->f_4 = Function_48(iParam2, iParam1, 4);
	...
	*(uParam0[iParam140] + 52) = { StackVal, StackVal, vParam8 };
	...
	if (Global_25974[iParam1] && Function_47(iParam1))
	{
		Function_40(StackVal, StackVal, iParam2, (1 + iParam1), vParam8, 63);
	}
	uParam0[iParam140]->f_140 = 1;
	uParam0[iParam140]->f_128 |= 8192;
}

int Function_40(int iParam0, int iParam1, vector3 vParam2, int iParam5) //Position: 0x220F / 8719
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_46(StackVal, StackVal, vParam2))
	{
		return 0;
	}
	iVar2 = Function_45(iParam1);
	iVar1 = 4294967295;
	uVar3 = Function_44(StackVal, StackVal, vParam2);
	...
	{
		Function_43(uVar3);
		vVar7 = { StackVal, StackVal, Function_43(uVar3) };
		iVar0 = 0;
		while (iVar0 <= Global_9724)
		{
			if (StackVal != 0 && iVar1 != 4294967295)
			...
			else if (StackVal == iParam1)
			{
				...
				vVar4 = { StackVal, StackVal, Function_43(StackVal) };
				if (Function_42(StackVal, StackVal, StackVal, StackVal, vVar4, vVar7))
				{
					return iVar0;
				}
			}
	...
	if (iVar1 != 4294967295)
	{
		...
		Global_9724[iVar1] = ADD_BLIP_FOR_COORD(&vParam2, Function_41(iParam1), 0.0f, 2, iVar2);
		if (iParam1 == 23)
		{
...
int Function_41(bool bParam0) //Position: 0x23F2 / 9202
{
	switch (bParam0)
	{
		case 0x00000001:
...
bool Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x2529 / 9513
{
	vector3 vVar0;
...
vector3 Function_43(int iParam0) //Position: 0x2556 / 9558
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_44(vector3 vParam0) //Position: 0x25AD / 9645
{
	bool bVar0;
...
int Function_45(int iParam0) //Position: 0x25FB / 9723
{
	switch (iParam0)
	{
		case 0x00000001:
...
bool Function_46(vector3 vParam0) //Position: 0x26B3 / 9907
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_47(int iParam0) //Position: 0x26CB / 9931
{
	int iVar0;
...
int Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x26EE / 9966
{
	int iVar0;
	int iVar1;
...
int Function_49(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x274C / 10060
{
	var uVar0;
...
int Function_50(int iParam0) //Position: 0x28A1 / 10401
{
	int iVar0;
...
bool Function_51(int iParam0) //Position: 0x28DF / 10463
{
...
var Function_52(int iParam0, int iParam1, int iParam2) //Position: 0x28F4 / 10484
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_53(var uParam0, int iParam1) //Position: 0x2914 / 10516
{
	int iVar0;
...
void Function_54(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6) //Position: 0x292B / 10539
{
	var uVar0;
	bool bVar3[2];
	bool bVar6;
	...
	if (IS_DOOR_VALID(bParam4))
	{
		...
		{
			Function_57(bParam4, 0);
		}
		else
		{
			Function_56(bParam4, 1);
		}
	}
	if (IS_DOOR_VALID(bParam5))
	{
		if (Global_16537[iParam021].f_40 == 3)
		{
			Function_57(bParam5, 0);
		}
		else
		{
			Function_56(bParam5, 1);
		}
	}
	...
	if (IS_OBJECT_VALID(bParam6))
	{
		...
		{
			bVar6 = GET_ACTOR_FROM_OBJECT(Function_55(bVar3[0], "UseCase1"));
		...
		{
			bVar7 = GET_ACTOR_FROM_OBJECT(Function_55(bVar3[1], "UseCase1"));
...
var Function_55(bool bParam0, bool bParam1) //Position: 0x2CBE / 11454
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_56(bool bParam0, bool bParam1) //Position: 0x2CCB / 11467
{
...
void Function_57(bool bParam0, bool bParam1) //Position: 0x2D1F / 11551
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_58(int iParam0) //Position: 0x2D70 / 11632
{
...
int Function_59(bool bParam0, bool bParam1) //Position: 0x2D86 / 11654
{
	if (!IS_OBJECT_VALID(bParam1))
	{
...
var Function_60(int iParam0, var uParam1, char* cParam2, int iParam3) //Position: 0x2EE0 / 12000
{
	char* cVar0[8];
	char* cVar2[32];
	bool bVar10;
...
void Function_61(var uParam0, bool bParam1) //Position: 0x2F7C / 12156
{
	bool bVar0;
...
bool Function_62(int iParam0) //Position: 0x2FC4 / 12228
{
	int iVar0;
...
void Function_63(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x2FE0 / 12256
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_64(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x3092 / 12434
{
	int iVar0;
	char* cVar1[16];
	...
	if (!IS_PERS_CHAR_VALID(StackVal))
	{
		...
		PRINTNL();
		if (Function_46(StackVal, StackVal, *uParam3[iVar020]))
		{
			LOG_ERROR("A regional character is being created at <<0,0,0>>. Please give this guy a schedule or notify CC.");
		}
		Function_89(uParam0, 4);
	}
	Function_65(StackVal, uParam3[iVar020]);
	return 1;
}

int Function_65(bool bParam0, bool bParam1) //Position: 0x31FD / 12797
{
	vector3 vVar0;
	bool bVar20;
	...
	{
		if (!Function_46(StackVal, StackVal, *bParam1))
		{
			vVar0 = { StackVal, StackVal, *bParam1 };
		}
		if (!Function_46(StackVal, StackVal, *(bParam1 + 12)))
		{
			*(&vVar0 + 12) = { StackVal, StackVal, *(bParam1 + 12) };
		}
		if (!Function_46(StackVal, StackVal, *(bParam1 + 24)))
		{
			*(&vVar0 + 24) = { StackVal, StackVal, *(bParam1 + 24) };
		}
		if (!Function_46(StackVal, StackVal, *(bParam1 + 36)))
		{
			*(&vVar0 + 36) = { StackVal, StackVal, *(bParam1 + 36) };
		}
		if (!Function_46(StackVal, StackVal, *(bParam1 + 48)))
		{
			*(&vVar0 + 48) = { StackVal, StackVal, *(bParam1 + 48) };
		}
		if (!Function_46(StackVal, StackVal, *(bParam1 + 60)))
		{
...
var Function_66(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x3339 / 13113
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_67(int iParam0, var uParam1, bool bParam2) //Position: 0x3452 / 13394
{
	bool bVar0;
...
void Function_68(int iParam0, var uParam1, vector3 vParam2) //Position: 0x34AD / 13485
{
	bool bVar0;
	
	bVar0 = iParam0;
	if (Function_42(StackVal, StackVal, vParam2, 0.0f, 0.0f, 0.0f))
	{
...
void Function_69(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3513 / 13587
{
	bool bVar0;
...
void Function_70(int iParam0, var uParam1, vector3 vParam2) //Position: 0x357B / 13691
{
	bool bVar0;
...
void Function_71(int iParam0, var uParam1, vector3 vParam2) //Position: 0x35E5 / 13797
{
	bool bVar0;
...
void Function_72(int iParam0, var uParam1, vector3 vParam2) //Position: 0x364A / 13898
{
	bool bVar0;
...
void Function_73(int iParam0, var uParam1, vector3 vParam2) //Position: 0x36B2 / 14002
{
	bool bVar0;
...
int Function_74(int iParam0) //Position: 0x3715 / 14101
{
	if (!Function_13(iParam0))
	{
		return 1;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x3731 / 14129
{
	int iVar0;
...
bool Function_76(var uParam0, var uParam1, int iParam2) //Position: 0x374D / 14157
{
	int iVar0;
	...
	if (Function_75(&(Global_29008[iParam2]), 0x40000000))
	{
		if (!STREAMING_IS_GRINGO_DICTIONARY_LOADED(GET_ASSET_ID(Function_12(iParam2), 12)))
		{
			return 0;
		}
	}
...
void Function_77(var uParam0, var uParam1, int iParam2) //Position: 0x3819 / 14361
{
	int iVar0;
	...
	if (!Function_75(&(Global_29008[iParam2]), 0x40000000))
	{
		if (_IS_TYPE_ID_VALID_BY_STRING(Function_12(iParam2), 12))
		{
			STREAMING_REQUEST_GRINGO_DICTIONARY(GET_ASSET_ID(Function_12(iParam2), 12));
...
void Function_78(var uParam0, int iParam1) //Position: 0x38EF / 14575
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_79() //Position: 0x38FE / 14590
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_87(3, 3);
	bVar0 = bVar0;
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_gateguards", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand_nospawn", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/lean_rail", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sleeping_wall_scripted", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_hammerground_w_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/repair_kneel", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_sweeping_w_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sleeping_scripted", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_no_table", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_talking_soldiers_link", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_worried_n_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/lean_table", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_r", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_sleepbed_l", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_l", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_guntricks_e_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_cleanpistol", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_cleanrifle", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_pocketwatch_e_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/player_sleep_bed_l", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/look_out_window_r", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/horse_stay", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_wall", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_sitground_tlkpsnt_hrassol_link", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/multistage_bucket", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/multistage_sweeping", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/locked_footlocker", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/arm_wrestling_spectate", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_docks", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/use_shelf", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/kneel_hammer", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/mex_chair_sit", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_embroidery_e_any", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/opium_pipe", 1, 0);
	Function_85(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/fivefingerfillet_spectate_b", 1, 0);
	if (!Function_80(&Local_12 + 4))
	{
		return 0;
	}
	...
	*(&Local_12 + 1684 + 12) = { 0.0f, 86,96138f, 0.0f };
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bVar0), 1);
	Local_12.f_1716 = CREATE_OBJECTSET_IN_LAYOUT(Function_26(), Local_12, 12, 0);
...
bool Function_80(int iParam0) //Position: 0x8866 / 34918
{
	int iVar0;
	int iVar1;
...
void Function_81() //Position: 0x8BE1 / 35809
{
	if (!Function_62(128))
	{
		return;
...
bool Function_82() //Position: 0x8C21 / 35873
{
	int iVar0;
...
void Function_83(var uParam0, int iParam1) //Position: 0x8C4C / 35916
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_84() //Position: 0x8C5D / 35933
{
	if (!Function_62(128))
	{
		return;
...
var Function_85(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x8C9F / 35999
{
	int iVar0;
	bool bVar1;
...
var Function_86(var uParam0, int iParam1, int iParam2) //Position: 0x8CD7 / 36055
{
	int iVar0;
...
void Function_87(int iParam0, int iParam1) //Position: 0x8D9B / 36251
{
	switch (iParam1)
	{
		case 0x00000000:
...
void Function_88(var uParam0, int iParam1) //Position: 0x8DE4 / 36324
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_89(var uParam0, int iParam1) //Position: 0x8DF3 / 36339
{
	int iVar0;
...
int Function_90(int iParam0, bool bParam1) //Position: 0x8E0A / 36362
{
	int iVar0;
...
bool Function_91(int iParam0) //Position: 0x8E47 / 36423
{
...
var Function_92(int iParam0) //Position: 0x8E5E / 36446
{
...
bool Function_93(int iParam0) //Position: 0x8E78 / 36472
{
...
bool Function_94() //Position: 0x8E8E / 36494
{
	var uVar0;
...
void Function_95(bool bParam0, var uParam1) //Position: 0x8F2C / 36652
{
	if (!Function_62(128))
	{
		return;
