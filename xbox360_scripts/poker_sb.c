...
bool Function_7(bool bParam0, int iParam1, bool bParam2) //Position: 0x4D0 / 1232
{
	...
	{
		return Function_34(iParam1, bParam2);
	}
...
{
	Function_26(bParam1, uParam2, uParam3);
	if (!bParam1)
	{
		Function_5(bParam0, 0, 0);
	}
	if (Function_7(bParam0, 8, 1))
	{
		NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(false, UI_GET_STRING("mp_plist_folded"));
		NET_PLAYER_LIST_SET_CURRENT_ITEM_TEAM(2);
	}
	else
	{
		NET_PLAYER_LIST_SET_CURRENT_ITEM_TEAM(4);
		if (Function_23(bParam0) == 4294967295)
		{
			NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(false, UI_GET_STRING("mp_plist_bust"));
		}
		else
		{
			if (Function_23(bParam0) >= 0)
			{
				NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(false, Function_23(bParam0));
			}
			else
			{
				NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(false, UI_GET_STRING("mp_plist_allin"));
			}
			NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(true, Function_20(bParam0));
		}
	}
	return 0;
}

int Function_20(int iParam0) //Position: 0x9CF / 2511
{
	return Function_21(11, iParam0);
}

int Function_21(int iParam0, bool bParam1) //Position: 0x9DC / 2524
{
	char* cVar0[64];
...
int Function_22(int iParam0) //Position: 0xA4A / 2634
{
	if (iParam0 > 40)
	{
		return 0;
...
int Function_23(bool bParam0) //Position: 0xA63 / 2659
{
	return Function_24(0, bParam0);
}

int Function_24(int iParam0, bool bParam1) //Position: 0xA6F / 2671
{
	char* cVar0[64];
	
	if (bParam1 == GET_LOCAL_SLOT())
	{
		return Function_25(iParam0);
	}
	if (!Function_9(bParam1))
	{
...
var Function_25(int iParam0) //Position: 0xAD6 / 2774
{
	return (*&Global_78480 + 132)[iParam0];
}

void Function_26(bool bParam0, int iParam1, char* cParam2) //Position: 0xAE6 / 2790
{
	if (bParam0)
	{
		if (Function_11())
...
int Function_27() //Position: 0xB07 / 2823
{
	if (!Function_29(1))
	{
		return 0;
	...
	NET_PLAYER_LIST_SET_HEADER(3, "mp_plist_pot");
...
void Function_28() //Position: 0xB8D / 2957
{
	if (Function_16(4096))
	{
...
bool Function_29(bool bParam0) //Position: 0xBCA / 3018
{
	char* cVar0[64];
	
	if (bParam0)
	{
		if (Function_11() || Function_33(&Global_76905 + 64, &Global_79349))
		{
			cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_31(1) };
	...
	Function_30(Function_11());
	return 1;
}

void Function_30(bool bParam0) //Position: 0xC4B / 3147
{
	...
	if (bParam0 || Function_16(0x20000000))
	{
		...
		if ((Global_76905.f_128 <= 0 && !bParam0) && ((Function_16(1048576) || Function_16(4)) || Function_34(1, 1)))
		{
...
struct<64> Function_31(var uParam0) //Position: 0xCD4 / 3284
{
	return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_32(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Global_79349, uParam0);
}

struct<64> Function_32(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, bool bParam29) //Position: 0xCE8 / 3304
{
	char* cVar0[64];
...
int Function_33(bool bParam0, bool bParam1) //Position: 0xD2D / 3373
{
...
bool Function_34(int iParam0, bool bParam1) //Position: 0xD61 / 3425
{
	int iVar0;
...
void Function_35(int iParam0) //Position: 0xD81 / 3457
{
	Function_36(8, iParam0);
	return;
}

void Function_36(var uParam0, bool bParam1) //Position: 0xD8E / 3470
{
	if (bParam1)
	{
