...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			Function_127(&bLocal_188, "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", 1, 0);
			Function_127(&bLocal_188, "RandomCharMissions", 10, 0);
			Function_127(&bLocal_188, "$/fragments/p_gen_hat02x", 0, 0);
			Function_127(&bLocal_188, "$/fragments/p_gen_bodyPartArm01x", 0, 0);
			while (!IS_EXITFLAG_SET())
			{
				switch (iVar0)
				{
					case 0x00000000:
						if (!Function_124(&(Global_63541[ScriptParam_055]), 18, 0, 1))
						{
							Function_123(&Global_63541[ScriptParam_055] + 144, 64);
							Function_121(&(Global_63541[ScriptParam_055]), 18, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_116(&bLocal_188) && IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (IS_LAYOUTREF_VALID(bLocal_201))
							{
								bLocal_202 = CREATE_GRINGO_IN_LAYOUT(bLocal_201, "SearchClues1", "$/content/scripting/gringo/SimpleGringo/Cannibal_fam_clue_search", *(&Global_63541[ScriptParam_055] + 100), 0.0f, 0.0f, 0.0f);
								CREATE_DECAL(2, -1687,427f, 53,208f, 2140,068f, 1.0f, 1, 1);
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(bLocal_201, "RCM_Cannibal2_Hat")))
								{
									CREATE_PROP_IN_LAYOUT(bLocal_201, "RCM_Cannibal2_Hat", "$/fragments/p_gen_hat02x", -1686,165f, 53,208f, 2140,195f, 0.0f, 50.0f, 0.0f, 1);
								}
								if (!IS_OBJECT_VALID(FIND_OBJECT_IN_LAYOUT(bLocal_201, "RCM_Cannibal4_Arm")))
								{
									CREATE_PROP_IN_LAYOUT(bLocal_201, "RCM_Cannibal4_Arm", "$/fragments/p_gen_bodyPartArm01x", -1688,349f, 53,208f, 2139,711f, 0.0f, 113.0f, 0.0f, 1);
								}
								if (IS_OBJECT_VALID(bLocal_202))
								{
									iVar0 = 5;
								}
							}
							...
							{
								Function_114();
								bLocal_201 = bLocal_206;
							}
							else
							{
								bLocal_201 = FIND_NAMED_LAYOUT("CannibalFamily_layout");
							}
						}
						break;
					
					case 0x00000005:
						if (GET_CURRENT_GRINGO(Global_34573) == GET_GRINGO_FROM_OBJECT(bLocal_202))
						{
							bVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_201, Function_113(), 2, *(&Global_63541[1855] + 100), 0.0f, 0.0f, 0.0f, 10.0f, 10.0f, 10.0f);
							Function_108(-1675,043f, 55,781f, 2134,299f, bVar1);
					...
					case 0x00000006:
						if (!IS_GRINGO_VALID(GET_CURRENT_GRINGO(Global_34573)))
						{
							...
							Function_106("RCM_Cannibal_Not_Complete", 0x41200000, 1, 0, 2, 1, 0);
							iLocal_204 = GET_JOURNAL_ENTRY_NUM_DETAILS(Global_63541[ScriptParam_055].f_140);
							bLocal_205 = false;
							while (bLocal_205 <= iLocal_204)
							{
								SET_JOURNAL_ENTRY_DETAIL_STYLE_BY_HASH(Global_63541[ScriptParam_055].f_140, GET_JOURNAL_ENTRY_DETAIL_HASH_BY_INDEX(Global_63541[ScriptParam_055].f_140, bLocal_205), 4, 0);
								bLocal_205++;
							}
							APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "Cannibal4_OBJ", 0, 4, false);
	...
	if (IS_OBJECT_VALID(bLocal_202))
	{
		RELEASE_OBJECT_REF(bLocal_202);
	}
	if (IS_LAYOUTREF_VALID(bLocal_201))
	{
		RELEASE_LAYOUT_OBJECTS(bLocal_201);
	}
	Function_4(&bLocal_188);
	if (bLocal_203)
	{
		Function_3();
	}
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x4F3 / 1267
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x50E / 1294
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x52B / 1323
{
	RELEASE_LAYOUT_REF(bLocal_206);
	return;
}

void Function_4(int iParam0) //Position: 0x536 / 1334
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x55C / 1372
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x68A / 1674
{
	int iVar0;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x6A4 / 1700
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x6C1 / 1729
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_9() //Position: 0x6D0 / 1744
{
	bool bVar0;
	bool bVar1;
...
void Function_10(bool bParam0) //Position: 0x701 / 1793
{
	bool bVar0;
...
void Function_11() //Position: 0x73B / 1851
{
...
void Function_12(bool bParam0) //Position: 0x75E / 1886
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_13(int iParam0, int iParam1) //Position: 0x900 / 2304
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = iParam0->f_96;
	iParam0->f_192 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(Global_63535, Function_113(), *(iParam0 + 112), 0.0f, 0.0f, 0.0f, iVar0, iVar0, iVar0, 0, Global_34573, iParam1, iParam0->f_92, 0, 1, 1);
	Function_14(iParam0);
...
void Function_14(int iParam0) //Position: 0x9BA / 2490
{
	float fVar0;
	bool bVar1;
	...
	iParam0->f_216 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_113(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, 2.0f, 2.0f, 2.0f);
...
int Function_15(var uParam0, int iParam1) //Position: 0xA5C / 2652
{
	int iVar0;
	var uVar1;
...
void Function_16(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xBBD / 3005
{
	struct<8> Var0;
...
struct<32> Function_17(bool bParam0) //Position: 0xC58 / 3160
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_18(char* cParam0, char* cParam1, char* cParam2) //Position: 0xCC2 / 3266
{
	char* cVar0[32];
...
int Function_19(bool bParam0) //Position: 0xCE1 / 3297
{
	int iVar0;
	vector3 vVar1;
...
float Function_20(bool bParam0, vector3 vParam1) //Position: 0xE42 / 3650
{
	vector3 vVar0;
...
vector3 Function_21(bool bParam0) //Position: 0xEBC / 3772
{
	vector3 vVar0;
...
void Function_22(int iParam0) //Position: 0xF26 / 3878
{
...
bool Function_23(int iParam0) //Position: 0xF87 / 3975
{
...
void Function_24(int iParam0, int iParam1) //Position: 0xF9D / 3997
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_25(bool bParam0) //Position: 0x10E2 / 4322
{
...
var Function_26(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x110E / 4366
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_27(int iParam0) //Position: 0x112A / 4394
{
...
bool Function_28(int iParam0, int iParam1) //Position: 0x113F / 4415
{
...
bool Function_29(int iParam0, int iParam1) //Position: 0x1254 / 4692
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x1398 / 5016
{
...
bool Function_31(int iParam0) //Position: 0x13BC / 5052
{
...
bool Function_32(int iParam0) //Position: 0x13D1 / 5073
{
...
var Function_33(int iParam0) //Position: 0x13E8 / 5096
{
...
bool Function_34(int iParam0) //Position: 0x1402 / 5122
{
...
bool Function_35(int iParam0) //Position: 0x1418 / 5144
{
	return StackVal;
}

bool Function_36(var uParam0, int iParam1) //Position: 0x1428 / 5160
{
	int iVar0;
...
bool Function_37(int iParam0) //Position: 0x1444 / 5188
{
	if (!iParam0->f_152)
	{
...
bool Function_38(int iParam0) //Position: 0x148B / 5259
{
...
void Function_39(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x14E4 / 5348
{
	bool bVar0;
	char* cVar1[16];
...
void Function_40(char* cParam0, int iParam1) //Position: 0x1550 / 5456
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_41(bool bParam0, var uParam1, int iParam2) //Position: 0x1587 / 5511
{
	var uVar0;
	char* cVar1[16];
...
int Function_42(char* cParam0) //Position: 0x15FF / 5631
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_43(int iParam0) //Position: 0x16A0 / 5792
{
	int iVar0;
	int iVar1;
...
bool Function_44(var uParam0, int iParam1) //Position: 0x16DD / 5853
{
...
bool Function_45(int iParam0) //Position: 0x16F0 / 5872
{
	int iVar0;
...
bool Function_46(var uParam0, int iParam1) //Position: 0x170C / 5900
{
	int iVar0;
...
int Function_47(int iParam0) //Position: 0x1728 / 5928
{
...
bool Function_48(int iParam0) //Position: 0x173D / 5949
{
...
int Function_49(int iParam0) //Position: 0x1752 / 5970
{
...
bool Function_50(var uParam0, bool bParam1) //Position: 0x1767 / 5991
{
	return (uParam0 && bParam1) == 0;
}

void Function_51() //Position: 0x1774 / 6004
{
...
var Function_52(int iParam0, int iParam1) //Position: 0x17EF / 6127
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_53(vector3 vParam0) //Position: 0x23E0 / 9184
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_54(int iParam0, bool bParam1) //Position: 0x23F8 / 9208
{
	int iVar0;
...
int Function_55(int iParam0) //Position: 0x2435 / 9269
{
	int iVar0;
	int iVar1;
...
bool Function_56(int iParam0) //Position: 0x2484 / 9348
{
...
int Function_57(int iParam0) //Position: 0x249A / 9370
{
...
bool Function_58(int iParam0) //Position: 0x2503 / 9475
{
	if (!Function_56(iParam0))
	{
...
bool Function_59(int iParam0, int iParam1) //Position: 0x2554 / 9556
{
	int iVar0;
...
bool Function_60(int iParam0) //Position: 0x2581 / 9601
{
	if (!Function_56(iParam0))
	{
...
bool Function_61() //Position: 0x25D3 / 9683
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_62(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x25DC / 9692
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_123(&Global_63541[iParam055] + 144, 64);
...
void Function_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2B11 / 11025
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_64() //Position: 0x2C84 / 11396
{
	return;
}

void Function_65(var uParam0, int iParam1) //Position: 0x2C8A / 11402
{
	if (Global_3381)
	{
		return;
...
void Function_66(bool bParam0) //Position: 0x2CCC / 11468
{
...
void Function_67() //Position: 0x2D1D / 11549
{
	Function_94();
	Function_93();
	Function_93();
...
void Function_68() //Position: 0x2D50 / 11600
{
...
void Function_69() //Position: 0x2E56 / 11862
{
	float fVar0;
...
void Function_70() //Position: 0x2E89 / 11913
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x3017 / 12311
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x31CB / 12747
{
	Function_73(&Global_28260, 1, 0);
	return;
}

void Function_73(int iParam0, bool bParam1, var uParam2) //Position: 0x31D9 / 12761
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_74() //Position: 0x33CA / 13258
{
...
struct<8> Function_75() //Position: 0x33DF / 13279
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_76(int iParam0, bool bParam1, bool bParam2) //Position: 0x347A / 13434
{
	int iVar0;
...
void Function_77(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x3715 / 14101
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_78(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_113(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_78(int iParam0) //Position: 0x3D42 / 15682
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_79(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3D53 / 15699
{
	char* cVar0[32];
...
struct<32> Function_80(char* cParam0, char* cParam1) //Position: 0x3E48 / 15944
{
	char* cVar0[32];
...
void Function_81(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3E61 / 15969
{
	float fVar0;
...
var Function_82(int iParam0, int iParam1) //Position: 0x3EC6 / 16070
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_83(int iParam0, bool bParam1) //Position: 0x3ED8 / 16088
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_84(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3EEA / 16106
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_85(int iParam0) //Position: 0x401B / 16411
{
	return Global_35278[iParam020].f_48;
}

float Function_86(int iParam0) //Position: 0x402A / 16426
{
	if (!iParam0 != 4294967295)
	{
...
var Function_87(int iParam0) //Position: 0x4063 / 16483
{
	if (iParam0 == 4294967295)
	{
...
void Function_88(int iParam0) //Position: 0x40A0 / 16544
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_89(int iParam0, bool bParam1, bool bParam2) //Position: 0x423A / 16954
{
	int iVar0;
	int iVar1;
...
int Function_90(bool bParam0) //Position: 0x4454 / 17492
{
...
struct<8> Function_91() //Position: 0x4495 / 17557
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_92() //Position: 0x451E / 17694
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x45B5 / 17845
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_94() //Position: 0x4634 / 17972
{
...
int Function_95(int iParam0, bool bParam1, int iParam2) //Position: 0x465A / 18010
{
	int iVar0;
	int iVar1;
...
void Function_96() //Position: 0x4864 / 18532
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_97(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x4905 / 18693
{
	int iVar0;
...
vector3 Function_98() //Position: 0x49EC / 18924
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_99(int iParam0) //Position: 0x49F5 / 18933
{
...
int Function_100(bool bParam0, bool bParam1) //Position: 0x4A0B / 18955
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_101(vector3 vParam0, vector3 vParam3) //Position: 0x4AD2 / 19154
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_102(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4AEF / 19183
{
	uParam0 = uParam0;
...
void Function_103() //Position: 0x4B93 / 19347
{
	bool bVar0;
...
void Function_104(bool bParam0) //Position: 0x4BF1 / 19441
{
	PRINTSTRING("Day ");
...
void Function_105(bool bParam0, bool bParam1) //Position: 0x4C37 / 19511
{
	bool bVar0;
...
void Function_106(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x4C5C / 19548
{
	int iVar0;
...
void Function_107(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x4CA7 / 19623
{
	int iVar0;
...
void Function_108(vector3 vParam0) //Position: 0x4CFA / 19706
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!Function_53(StackVal, StackVal, vParam0))
	{
		...
		if (IS_ACTOR_VALID(bVar1))
		{
			...
			else if (Function_109(bVar1, Global_34573) > 4.0f)
			{
				TELEPORT_ACTOR(bVar1, &vVar3, 1, 1, 1);
				vVar3 = (vParam0.x + 1,5f);
				vVar3.f_8 = (vParam0.z + 1,5f);
		...
		if (IS_ACTOR_VALID(bVar0))
		{
			if (bVar0 != bVar1)
			{
				...
				else if (Function_109(bVar0, Global_34573) > 4.0f)
				{
					TELEPORT_ACTOR(bVar0, &vVar3, 1, 1, 1);
					vVar3 = (vParam0.x + 2,5f);
					vVar3.f_8 = (vParam0.z + 2,5f);
		...
		if (IS_ACTOR_VALID(bVar2))
		{
			...
			else if (Function_109(bVar2, Global_34573) > 8.0f)
			{
				TELEPORT_ACTOR(bVar2, &vVar3, 1, 1, 1);
			}
		}
...
float Function_109(bool bParam0, bool bParam1) //Position: 0x4E80 / 20096
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_110(bool bParam0, float fParam1) //Position: 0x4F71 / 20337
{
...
void Function_111() //Position: 0x506F / 20591
{
...
void Function_112() //Position: 0x50A1 / 20641
{
...
void Function_114() //Position: 0x51A6 / 20902
{
	var uVar0;
	
	Function_115(4, 1);
	uVar0 = uVar0;
	bLocal_206 = CREATE_LAYOUT("CannibalFamily_layout");
	return;
}

void Function_115(int iParam0, int iParam1) //Position: 0x51D2 / 20946
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_116(int iParam0) //Position: 0x521B / 21019
{
	int iVar0;
	int iVar1;
	...
	if (!Function_7(iParam0[iVar03], 16))
	{
		...
		Function_119(iParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*iParam0 - 1))
	{
...
void Function_117() //Position: 0x5596 / 21910
{
	if (!Function_45(128))
	{
		return;
...
bool Function_118() //Position: 0x55D6 / 21974
{
	int iVar0;
...
void Function_119(var uParam0, int iParam1) //Position: 0x5601 / 22017
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_120() //Position: 0x5612 / 22034
{
	if (!Function_45(128))
	{
		return;
...
void Function_121(int iParam0, int iParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x5654 / 22100
{
...
void Function_122(int iParam0) //Position: 0x57FE / 22526
{
	if (Function_50(iParam0->f_144, 1))
	{
		STREAMING_EVICT_ACTOR(iParam0->f_136, 4294967295);
		Function_123(iParam0 + 144, 1);
	}
	if (Function_50(iParam0->f_144, 8))
	{
		REMOVE_STRING_TABLE("RandomCharMissions");
		Function_123(iParam0 + 144, 8);
	}
	if (Function_50(iParam0->f_144, 2))
	{
		STREAMING_EVICT_GRINGO(iParam0->f_60);
		Function_123(iParam0 + 144, 2);
	}
	if (Function_50(iParam0->f_144, 4))
	{
		STREAMING_EVICT_PROP(iParam0->f_64);
		Function_123(iParam0 + 144, 4);
	}
	return;
}

void Function_123(int iParam0, int iParam1) //Position: 0x5880 / 22656
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_124(int iParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x5893 / 22675
{
	if (!iParam0->f_172 != 0)
	{
		if (Function_36(iParam0 + 172, 4))
		...
		if (Function_36(iParam0 + 172, 8) && Global_3365)
		{
			if (!Function_126(iParam0->f_164, 0))
			{
				return 0;
			}
		}
		...
		return Function_125(iParam0);
	}
	return 1;
}

int Function_125(int iParam0) //Position: 0x5947 / 22855
{
	if (!iParam0->f_172 != 0)
	{
		switch (Global_63399)
...
bool Function_126(int iParam0, bool bParam1) //Position: 0x59F3 / 23027
{
...
var Function_127(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5A29 / 23081
{
	int iVar0;
	bool bVar1;
	...
	if (bParam3)
	{
		Function_119(uParam0[iVar03], 8);
	}
	return iVar0;
}

var Function_128(var uParam0, int iParam1, int iParam2) //Position: 0x5A61 / 23137
{
	int iVar0;
