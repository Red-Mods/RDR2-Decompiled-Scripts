...
void main() //Position: 0x0 / 0
{
	...
	Function_15("Loading Tumbleweed population file", 3);
	Global_30839++;
	...
	Global_30750[8] = Function_13("farmyard_animals", 1);
	Function_8(&(Global_30750[8]), 1128, 10.0f, 30, 0, 0);
	...
	Function_11(&(Global_30750[3]), 398, 1.0f, 0, 0);
	Function_11(&(Global_30750[3]), 397, 4.0f, 0, 0);
	...
	bVar0 = FIND_NAMED_LAYOUT("Tumbleweed_layout");
	if (IS_LAYOUTREF_VALID(bVar0))
	{
		bVar1 = FIND_VOLUME_IN_LAYOUT(bVar0, "TumPopArea_1_set");
		if (IS_VOLUME_VALID(bVar1))
		{
			Function_3(bVar1, Global_30750[5], 5E-05f, 0, 0, 1);
		}
		else
		{
		...
		{
			LOG_ERROR("tum_pop: Cannot find TumPopArea_1 to create bird volumes");
		}
	}
	else
	{
	...
	Function_5("Finished loading Tumbleweed population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0xBA7 / 2983
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xBB6 / 2998
{
	int iVar0;
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC0B / 3083
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xC8B / 3211
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xCA7 / 3239
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xCE5 / 3301
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xD01 / 3329
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD11 / 3345
{
...
var Function_9(int iParam0) //Position: 0xD73 / 3443
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xDDF / 3551
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE4B / 3659
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xEC0 / 3776
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xF05 / 3845
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0xF12 / 3858
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0xF1E / 3870
{
	if (!Function_4(128))
	{
		return;
