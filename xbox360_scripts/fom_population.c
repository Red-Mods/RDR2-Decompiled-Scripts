...
void main() //Position: 0x0 / 0
{
	...
	Function_8(&bVar0, 1137, 4.0f, 33, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		...
		if (IS_VOLUME_VALID(bVar2))
		{
			...
			Function_3(bVar2, bVar0, 0,0001f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xC5F / 3167
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xDC7 / 3527
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xE33 / 3635
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xE9F / 3743
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF14 / 3860
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xF59 / 3929
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(var uParam0) //Position: 0xF66 / 3942
{
