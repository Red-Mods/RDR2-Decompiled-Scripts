...
void Function_83(var uParam0, bool bParam1) //Position: 0x3263 / 12899
{
	bool bVar0;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32C5 / 12997
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_86(int iParam0) //Position: 0x33E3 / 13283
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, bool bParam1) //Position: 0x3699 / 13977
{
	bParam1 = bParam1;
	uParam0 = uParam0;
	if (GRINGO_COMPONENT_CHECK_NAME("Player", bParam1))
...
bool Function_88(bool bParam0) //Position: 0x36BC / 14012
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x36D5 / 14037
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x36EF / 14063
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3727 / 14119
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x373E / 14142
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A07 / 14855
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A24 / 14884
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3AC0 / 15040
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3ADF / 15071
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AEE / 15086
{
...
void Function_98(int iParam0) //Position: 0x3B0A / 15114
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B14 / 15124
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B76 / 15222
{
...
void Function_101(int iParam0) //Position: 0x3B8A / 15242
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B94 / 15252
{
