...
int Function_8(int iParam0) //Position: 0x636 / 1590
{
	...
	else if (!DECOR_CHECK_EXIST(GRINGO_GET_MY_OBJECT_REF(), "SpawnedDucks"))
	{
		if (Function_13(&uLocal_2))
		{
			...
			bVar15 = ROUND((vVar11.x + IntToFloat(RAND_INT_RANGE(true, 3))));
			vVar16 = { 0.0f, 0.0f, 0.0f };
			GET_VOLUME_CENTER(bLocal_1, &vVar16);
			bVar19 = RAND_INT_RANGE(5, 8);
			iVar20 = 0;
			while (iVar20 < bVar19)
			{
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_93))
								{
									...
									{
										bLocal_93 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_93 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000001:
			...
			if (Function_89(iParam0->f_40, 1))
			{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, true, Function_68());
				}
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_53(iParam0, bVar8, &iLocal_91, &bLocal_90);
...
void Function_32(bool bParam0, int iParam1) //Position: 0x24B0 / 9392
{
...
void Function_33(var uParam0, var uParam1) //Position: 0x24C5 / 9413
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34() //Position: 0x24D3 / 9427
{
	bool bVar0;
...
void Function_35(var uParam0, bool bParam1) //Position: 0x2504 / 9476
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_36(var uParam0, bool bParam1) //Position: 0x2578 / 9592
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_37(var uParam0, int iParam1) //Position: 0x25EA / 9706
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_38(bool bParam0) //Position: 0x25F8 / 9720
{
	return Function_26(bParam0, "UseTime", 5.0f);
}

bool Function_39() //Position: 0x260E / 9742
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_40(bool bParam0) //Position: 0x261B / 9755
{
	return Function_26(bParam0, "MoveAllowance", 1,5f);
}

bool Function_41(var uParam0, int iParam1) //Position: 0x263B / 9787
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_42(bool bParam0) //Position: 0x264A / 9802
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_43() //Position: 0x2669 / 9833
{
	return;
}

void Function_44(var uParam0, int iParam1) //Position: 0x266F / 9839
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_45(int iParam0) //Position: 0x267D / 9853
{
	iParam0 = iParam0;
	return 1;
}

bool Function_46(bool bParam0) //Position: 0x2688 / 9864
{
	return Function_22(bParam0, "OneShotKill", 0);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x26A2 / 9890
{
	return Function_24(bParam0, "ParentAnimNode", iParam1);
}

bool Function_48(bool bParam0) //Position: 0x26C0 / 9920
{
	return Function_22(bParam0, "LinkToParentAnim", 0);
}

bool Function_49(bool bParam0) //Position: 0x26DF / 9951
{
	int iVar0;
	int iVar1;
...
bool Function_50(bool bParam0) //Position: 0x2712 / 10002
{
	return Function_22(bParam0, "LinkParentToAnim", 0);
}

bool Function_51(bool bParam0) //Position: 0x2731 / 10033
{
	return Function_22(bParam0, "SingularUse", 0);
}

void Function_52(var uParam0, int iParam1) //Position: 0x274B / 10059
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_53(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x275E / 10078
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_54(bool bParam0, bool bParam1) //Position: 0x2A46 / 10822
{
	return Function_24(bParam0, "TargetLocator", bParam1);
}

void Function_55() //Position: 0x2A63 / 10851
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_56(bool bParam0, int iParam1) //Position: 0x2A72 / 10866
{
	return Function_24(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_57(bool bParam0, int iParam1) //Position: 0x2A94 / 10900
{
	return Function_24(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_58(bool bParam0) //Position: 0x2AB8 / 10936
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_59(bool bParam0, int iParam1) //Position: 0x2AD5 / 10965
{
	return Function_24(bParam0, "TargetAttachBone", iParam1);
}

bool Function_60(bool bParam0, int iParam1) //Position: 0x2AF5 / 10997
{
	return Function_24(bParam0, "TargetAttachSlot", iParam1);
}

void Function_61(bool bParam0, bool bParam1) //Position: 0x2B15 / 11029
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_62(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2BC3 / 11203
{
	bool bVar0;
...
void Function_63(int iParam0, float fParam1) //Position: 0x2C33 / 11315
{
	if (!Function_29(iParam0))
	{
...
void Function_64(int iParam0, float fParam1) //Position: 0x2C49 / 11337
{
...
var Function_65(bool bParam0) //Position: 0x2C6A / 11370
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_26(bParam0, "RandUseTime", 0.0f));
}

void Function_66(int iParam0) //Position: 0x2C8A / 11402
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_67(var uParam0) //Position: 0x2C9E / 11422
{
	uParam0 = uParam0;
	return;
}

int Function_68() //Position: 0x2CA8 / 11432
{
	return 1;
}

void Function_69(var uParam0, int iParam1) //Position: 0x2CAF / 11439
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_70(bool bParam0, var uParam1, int iParam2) //Position: 0x2CBE / 11454
{
	bool bVar0;
...
bool Function_71(bool bParam0) //Position: 0x2CFD / 11517
{
	return Function_26(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_72(bool bParam0) //Position: 0x2D28 / 11560
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_73(bool bParam0) //Position: 0x2D33 / 11571
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_74(bool bParam0) //Position: 0x2E29 / 11817
{
	return Function_22(bParam0, "UsePosActorRelative", 0);
}

bool Function_75(bool bParam0) //Position: 0x2E4B / 11851
{
	return Function_26(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_76(bool bParam0) //Position: 0x2E72 / 11890
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_77(vector3 vParam0) //Position: 0x3131 / 12593
{
	vector3 vVar0;
...
vector3 Function_78(vector3 vParam0) //Position: 0x318E / 12686
{
	vector3 vVar0;
...
void Function_79(int iParam0) //Position: 0x31EB / 12779
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x31F5 / 12789
{
	return Function_22(bParam0, "MaintainPosture", 0);
}

void Function_81(int iParam0) //Position: 0x3213 / 12819
{
	if (!Function_29(iParam0))
	{
...
bool Function_82(bool bParam0, bool bParam1) //Position: 0x3228 / 12840
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_83(int iParam0) //Position: 0x32AF / 12975
{
	vector3 vVar0;
...
vector3 Function_84(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x32D2 / 13010
{
	vector3 vVar0;
...
bool Function_85(bool bParam0) //Position: 0x32F0 / 13040
{
	return Function_26(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_86(bool bParam0, bool bParam1) //Position: 0x3313 / 13075
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_87(bool bParam0, int iParam1) //Position: 0x342E / 13358
{
...
int Function_88(bool bParam0) //Position: 0x3459 / 13401
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x355E / 13662
{
	return (uParam0 && iParam1) == 0;
}

void Function_90(int iParam0) //Position: 0x356B / 13675
{
	if (Function_89(iParam0->f_40, 16))
	{
...
void Function_91(int iParam0, bool bParam1) //Position: 0x35DE / 13790
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_90));
		iLocal_91 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_51(iParam0->f_12))
...
void Function_92() //Position: 0x3ADC / 15068
{
	bool bVar0;
...
bool Function_93(bool bParam0) //Position: 0x3B13 / 15123
{
	return Function_26(bParam0, "ReuseDelay", 15.0f);
}

void Function_94(var uParam0, int iParam1) //Position: 0x3B30 / 15152
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_95(int iParam0) //Position: 0x3B68 / 15208
{
	iParam0 = iParam0;
	return;
}

bool Function_96(bool bParam0) //Position: 0x3B72 / 15218
{
	return Function_22(bParam0, "BlockBumpReactions", 0);
}

void Function_97(var uParam0, int iParam1) //Position: 0x3B93 / 15251
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_98(bool bParam0, bool bParam1) //Position: 0x3BA1 / 15265
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_99(bool bParam0, bool bParam1) //Position: 0x3CA9 / 15529
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_100(int iParam0) //Position: 0x3CBF / 15551
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_101(var uParam0, int iParam1) //Position: 0x3F75 / 16245
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_102(bool bParam0) //Position: 0x3F83 / 16259
{
	return Function_22(bParam0, "DrawWeapon", 0);
}

bool Function_103(bool bParam0) //Position: 0x3F9C / 16284
{
	return Function_22(bParam0, "AllowWeapon", 0);
}

void Function_104(int iParam0, int iParam1) //Position: 0x3FB6 / 16310
{
	bool bVar0;
	int iVar1;
...
bool Function_105(var uParam0, int iParam1) //Position: 0x3FEE / 16366
{
	return Function_24(uParam0, "UseName", iParam1);
}

bool Function_106(int iParam0, int iParam1) //Position: 0x4006 / 16390
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_107(bool bParam0) //Position: 0x42CF / 17103
{
	return Function_26(bParam0, "ActivationCone", 0.0f);
}

bool Function_108(bool bParam0, bool bParam1) //Position: 0x42EC / 17132
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_109(int iParam0) //Position: 0x4388 / 17288
{
	return Function_26(iParam0, "ActivationRadius", 2.0f);
}

bool Function_110(var uParam0, int iParam1) //Position: 0x43A7 / 17319
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_111(int iParam0) //Position: 0x43B6 / 17334
{
...
void Function_112(int iParam0) //Position: 0x43D2 / 17362
{
	iParam0 = iParam0;
	return;
}

void Function_113(bool bParam0, int iParam1) //Position: 0x43DC / 17372
{
	bool bVar0;
	bool bVar1;
...
void Function_114(int iParam0, int iParam1) //Position: 0x443E / 17470
{
...
void Function_115(int iParam0) //Position: 0x4452 / 17490
{
	iParam0 = iParam0;
	return;
}

void Function_116(int iParam0) //Position: 0x445C / 17500
{
