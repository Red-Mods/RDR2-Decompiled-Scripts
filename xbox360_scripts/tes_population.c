...
void main() //Position: 0x0 / 0
{
	...
	Function_11(&(Global_30750[0]), 239, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 240, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 241, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 292, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 295, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 297, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 269, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 270, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 271, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 272, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 278, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 279, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 280, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 281, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 282, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 284, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 306, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 317, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 322, 2.0f, 0, 0);
	Function_11(&(Global_30750[0]), 323, 2.0f, 0, 0);
	Function_14(&(Global_30750[1]));
	Global_30750[1] = Function_13("ped_traveller", 3);
	Function_11(&(Global_30750[1]), 63, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 62, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 253, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 263, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 265, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 275, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 302, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 303, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 311, 10.0f, 0, 0);
	Function_11(&(Global_30750[1]), 318, 10.0f, 0, 0);
	...
	Function_11(&(Global_30750[11]), 1049, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1050, 2.0f, 0, 0);
	Function_11(&(Global_30750[11]), 1050, 2.0f, 0, 0);
	Function_14(&(Global_30750[5]));
	Global_30750[5] = Function_13("animal_wilderness", 1);
	Function_11(&(Global_30750[5]), 1081, 12.0f, 0, 0);
	Function_8(&(Global_30750[5]), 1059, 3.0f, 14, 1, 0);
	Function_11(&(Global_30750[5]), 1078, 4.0f, 0, 0);
	Function_11(&(Global_30750[5]), 1079, 4.0f, 0, 0);
	Function_11(&(Global_30750[5]), 1078, 4.0f, 0, 0);
	Function_8(&(Global_30750[5]), 1128, 8.0f, 30, 0, 0);
	...
	bVar0 = Function_13("chickens", 0);
	Function_8(&bVar0, 1015, 100.0f, 15, 0, 0);
	Function_8(&bVar0, 1017, 100.0f, 15, 0, 0);
	switch (Global_30619)
	{
		case 0x00000000:
		case 0x00000001:
		case 0x00000002:
			...
			Function_11(&(Global_30750[2]), 465, 8.0f, 0, 0);
			Function_11(&(Global_30750[2]), 462, 8.0f, 0, 0);
			Function_11(&(Global_30750[2]), 464, 8.0f, 0, 0);
			Function_14(&(Global_30750[3]));
			Global_30750[3] = Function_13("ped_bad_guys_local", 1);
			Function_11(&(Global_30750[3]), 407, 1.0f, 0, 0);
			Function_11(&(Global_30750[3]), 406, 4.0f, 0, 0);
			Function_14(&(Global_30750[4]));
			Global_30750[4] = Function_13("ped_bad_guys_generic", 1);
			Function_11(&(Global_30750[4]), 516, 1.0f, 0, 0);
			Function_11(&(Global_30750[4]), 518, 1.0f, 0, 0);
			Function_11(&(Global_30750[4]), 521, 1.0f, 0, 0);
			break;
		
		case 0x00000003:
			Function_14(&(Global_30750[2]));
			Global_30750[2] = Function_13("ped_law", 1);
			Function_11(&(Global_30750[2]), 516, 8.0f, 0, 0);
			Function_11(&(Global_30750[2]), 521, 8.0f, 0, 0);
			Function_11(&(Global_30750[2]), 518, 8.0f, 0, 0);
			Function_14(&(Global_30750[3]));
			Global_30750[3] = Function_13("ped_bad_guys_local", 1);
			Function_11(&(Global_30750[3]), 407, 1.0f, 0, 0);
			Function_11(&(Global_30750[3]), 406, 4.0f, 0, 0);
			Function_14(&(Global_30750[4]));
			Global_30750[4] = Function_13("ped_bad_guys_generic", 1);
			Function_11(&(Global_30750[4]), 462, 1.0f, 0, 0);
			break;
	}
	...
	bVar1 = CREATE_POPULATION_SET(1);
	while (!Function_6(&(Global_29008[iScriptParam_0]), 16) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	if (IS_EXITFLAG_SET())
	...
	bVar2 = FIND_NAMED_LAYOUT("TesoroAzul_layout");
	if (IS_LAYOUTREF_VALID(bVar2))
	{
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "tesv_stable02");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, Global_30750[15], 0,0004f, 1, 0, 1);
		}
		else
		{
			LOG_ERROR("tes_pop: Cannot find tesv_stable_set to create population volumes");
		}
		bVar3 = FIND_VOLUME_IN_LAYOUT(bVar2, "tesv_region");
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, bVar0, 2E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar3))
		{
			Function_3(bVar3, bVar1, 0,00015f, 0, 0, 1);
		}
		else
		{
	...
	if (!Function_6(&(Global_29008[iScriptParam_0]), 128) && Global_30839 != 0)
	{
		ENABLE_AMBIENT_SPAWNING(Function_4(1));
	}
	SET_AMBIENT_FORCE_WAIT_STATE(0);
...
void Function_1(var uParam0, var uParam1) //Position: 0xCD8 / 3288
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0xCE7 / 3303
{
	int iVar0;
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xD3C / 3388
{
	bool bVar0;
...
bool Function_4(int iParam0) //Position: 0xDBC / 3516
{
	int iVar0;
...
void Function_5(bool bParam0, float fParam1) //Position: 0xDD8 / 3544
{
	if (!Function_4(128))
	{
		return;
...
bool Function_6(var uParam0, int iParam1) //Position: 0xE16 / 3606
{
	int iVar0;
...
void Function_7(var uParam0, bool bParam1) //Position: 0xE32 / 3634
{
...
var Function_8(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xE42 / 3650
{
...
var Function_9(int iParam0) //Position: 0xEA4 / 3748
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xF10 / 3856
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF7C / 3964
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xFF1 / 4081
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0x1036 / 4150
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0x1043 / 4163
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0x104F / 4175
{
	if (!Function_4(128))
	{
		return;
