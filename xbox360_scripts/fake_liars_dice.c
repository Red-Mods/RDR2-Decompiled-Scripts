...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2ED1 / 11985
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x2FD9 / 12249
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x2FEF / 12271
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x32A5 / 12965
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x32B3 / 12979
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x32CC / 13004
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(int iParam0, int iParam1) //Position: 0x32E6 / 13030
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x331E / 13086
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3335 / 13109
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x35FE / 13822
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x361B / 13851
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36B7 / 14007
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x36D6 / 14038
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x36E5 / 14053
{
...
void Function_96(int iParam0) //Position: 0x3701 / 14081
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x370B / 14091
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x376D / 14189
{
...
void Function_99(int iParam0) //Position: 0x3781 / 14209
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x378B / 14219
{
