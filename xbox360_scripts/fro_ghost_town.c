...
var Function_3(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x81A / 2074
{
	bool bVar0;
...
var Function_13(int iParam0) //Position: 0xB9B / 2971
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0xC07 / 3079
{
	bool bVar0;
...
var Function_15(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4) //Position: 0xC73 / 3187
{
	int iVar0;
	int iVar1;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xCB8 / 3256
{
	int iVar0;
	int iVar1;
...
var Function_17(bool bParam0, int iParam1) //Position: 0xD2D / 3373
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_18(int iParam0) //Position: 0xD3A / 3386
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_19(bool bParam0, var uParam1) //Position: 0xD46 / 3398
{
	if (!Function_8(128))
	{
		return;
