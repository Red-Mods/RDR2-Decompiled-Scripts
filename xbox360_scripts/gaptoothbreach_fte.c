...
void main() //Position: 0x0 / 0
{
	...
	iLocal_74 = 0;
	iLocal_89 = 0;
	Function_130(&uLocal_37);
	while (!IS_EXITFLAG_SET())
	{
		if (!Function_119(&uLocal_72, &uLocal_36))
		{
			iLocal_71 = 5;
		}
		...
		switch (iLocal_71)
		{
			...
			case 0x00000001:
				Function_113(&bLocal_75, &bLocal_79, &bLocal_80, &uLocal_81, &uLocal_88, &uLocal_77, &bLocal_78);
				iLocal_71 = 2;
				break;
			...
			case 0x00000003:
				...
				Function_76(&bLocal_80, &uLocal_36, &iLocal_73, &bLocal_79, &bLocal_78, &bLocal_75);
...
bool Function_6(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) //Position: 0x4BF / 1215
{
	...
	if (DECOR_CHECK_EXIST(Global_34573, "FloydIsFree") && Function_75(*iParam2, 32768))
	{
		if (!Function_75(*iParam2, 16384))
		{
			...
			if (IS_VOLUME_VALID(bVar3))
			{
				if (IS_ACTOR_IN_VOLUME(Global_34573, bVar3) && IS_ACTOR_IN_VOLUME(*iParam0, bVar4))
				{
					...
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot01"));
					vVar5 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot01")) };
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot02"));
					vVar8 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot02")) };
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot03"));
					vVar11 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot03")) };
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot04"));
					vVar14 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_GoToSpot04")) };
	...
	if (Function_72(*iParam0))
	{
		...
		switch (*uParam3)
		{
			case 0x00000000:
				if (!iLocal_17)
				{
					if (Function_71(*iParam0, Global_34573) > 8.0f && IS_ACTOR_IN_VOLUME(Global_34573, FIND_VOLUME_IN_LAYOUT(Global_30616, "v_topFloor")))
					{
						Function_70();
				...
				if (!IS_ACTOR_HOGTIED(*iParam0) || DECOR_CHECK_EXIST(Global_34573, "RunNewCamera"))
				{
					...
					if (Function_72(*uParam1))
					{
						SET_ACTOR_INVULNERABILITY(*uParam1, false);
						KILL_ACTOR(*uParam1);
					}
					if (!Function_69(&bLocal_30))
					{
						Function_68(&bLocal_30);
					}
					Function_64(1, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1);
					Function_58(*uParam8, 0, 1, 0, 0);
					AI_IGNORE_ACTOR(Global_34573);
					AI_IGNORE_ACTOR(*iParam0);
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonFF"));
					vVar18 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonFF")) };
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportFloydFF"));
					vVar21 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportFloydFF")) };
					TELEPORT_ACTOR(Global_34573, &vVar18, 0, 0, 0);
					TELEPORT_ACTOR(*iParam0, &vVar21, 0, 0, 0);
					Function_54(Global_34573, *iParam0);
					Function_54(*iParam0, Global_34573);
			...
			case 0x00000002:
				if (Function_69(&bLocal_30))
				{
					if (Function_51(&bLocal_30) < 10.0f)
					{
						Function_49();
						*uParam3 = 3;
					}
			...
			case 0x00000003:
				if (Function_69(&bLocal_30))
				{
					if (Function_51(&bLocal_30) < 17.0f)
					{
						Function_30(2, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(GET_JOURNAL_ENTRY("GAPJournalID"), "GAP_FTE_ObjAfterRescue", 0, 0, false);
						...
						*uParam7 = Function_27(*uParam8, "EntranceGateway", FIND_VOLUME_IN_LAYOUT(Global_30616, "v_atCaveMouth"), Global_34573, 2, 330, 4294967295, 0, 0, 1);
						...
						SET_ACTOR_MAX_SPEED(*iParam0, true);
						TASK_CLEAR(*iParam0);
			...
			case 0x00000007:
				...
				if (GATEWAY_UPDATE(*uParam7))
				{
					...
					if (!Function_69(&bLocal_33))
					{
						Function_68(&bLocal_33);
					}
					Function_64(1, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1);
					Function_15(*uParam8, 0, 1, 0, 0);
					AI_DONT_HARM_ACTOR(Global_34573);
					AI_DONT_HARM_ACTOR(*iParam0);
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonCave"));
					vVar29 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonCave")) };
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportFloydCave"));
					vVar32 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportFloydCave")) };
					...
					if (Function_71(*iParam0, Global_34573) >= 10.0f)
					{
						Function_14();
					}
					Function_21(&bLocal_21);
			...
			case 0x00000008:
				...
				if (Function_51(&bLocal_33) < 6.0f)
				{
					Function_30(0, 1, 1, 1, 1, 1, 0, 1, 1, 1);
					...
					CLEAR_JOURNAL_ENTRY_DETAIL_LIST(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
					APPEND_JOURNAL_ENTRY_DETAIL(GET_JOURNAL_ENTRY("GAPJournalID"), "GAP_FTE_Obj_GetTreasure", 0, 0, false);
					APPEND_JOURNAL_ENTRY(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
					iLocal_9++;
					*uParam3 = 9;
				}
...
void Function_8() //Position: 0x110F / 4367
{
	...
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_ReachTreasure", "GaptBreach_ReachTreasure", false, 2, 1, 0, 1);
		Function_9(5);
...
void Function_12(var uParam0, int iParam1, var uParam2) //Position: 0x11FA / 4602
{
	if (IS_ACTOR_IN_VOLUME(*iParam1, (*uParam2)[0]) && !Function_75(*uParam0, 128))
	{
		...
		{
			if (Function_71(*iParam1, Global_34573) >= 10.0f)
			{
				Function_13();
	...
	if (IS_ACTOR_IN_VOLUME(Global_34573, (*uParam2)[3]) && !Function_75(*uParam0, 2048))
	{
		if (SQUAD_GET_NUM_NOT_ELIMINATED_ACTORS(Function_25("GAP_MineCore2Sq", FIND_NAMED_LAYOUT("GAP_Layout"))) == 0)
		{
			if (Function_71(*iParam1, Global_34573) >= 10.0f)
...
void Function_13() //Position: 0x13E8 / 5096
{
	...
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_closerTreasure", "GaptBreach_closerTreasure", false, 2, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_14() //Position: 0x1443 / 5187
{
	...
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_ReachesMouth", "GaptBreach_ReachesMouth", false, 2, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_20(int iParam0) //Position: 0x1645 / 5701
{
	...
	if (!IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		if (Function_72(*iParam0))
		{
			if (Function_72(Global_34573))
			{
				if (!IS_ACTOR_HOGTIED(*iParam0))
				{
					fVar0 = Function_71(*iParam0, Global_34573);
					if (fVar0 < 15.0f && fVar0 > 35.0f)
					{
						if (Function_51(&bLocal_24) < 25.0f)
						{
...
var Function_27(bool bParam0, bool bParam1, bool bParam2, var uParam3, int iParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, int iParam9) //Position: 0x1859 / 6233
{
	bool bVar0;
...
void Function_28(int iParam0) //Position: 0x18D6 / 6358
{
	if (HUD_IS_SHOWING_OBJECTIVE())
	{
		HUD_CLEAR_OBJECTIVE();
	...
	Function_29(iParam0, 0x40f00000, 1, 2, 0, 0, 0);
	return;
}

void Function_29(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x18F7 / 6391
{
	int iVar0;
...
void Function_30(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9) //Position: 0x194A / 6474
{
	bool bVar0;
...
void Function_31(bool bParam0) //Position: 0x1A3A / 6714
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
...
void Function_32() //Position: 0x1ADF / 6879
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_33(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x1AF4 / 6900
{
	int iVar0;
	int iVar1;
...
void Function_34(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1D14 / 7444
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_35(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_19(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_35(int iParam0) //Position: 0x2341 / 9025
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_36(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2352 / 9042
{
	char* cVar0[32];
...
struct<32> Function_37(char* cParam0, char* cParam1) //Position: 0x2447 / 9287
{
	char* cVar0[32];
...
void Function_38(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2460 / 9312
{
	float fVar0;
...
var Function_39(int iParam0, int iParam1) //Position: 0x24C5 / 9413
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_40(int iParam0, bool bParam1) //Position: 0x24D7 / 9431
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_41(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x24E9 / 9449
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_42(int iParam0) //Position: 0x2619 / 9753
{
	return Global_35278[iParam020].f_48;
}

float Function_43(int iParam0) //Position: 0x2628 / 9768
{
	if (!iParam0 != 4294967295)
	{
...
var Function_44(int iParam0) //Position: 0x2661 / 9825
{
	if (iParam0 == 4294967295)
	{
...
void Function_45(int iParam0) //Position: 0x269E / 9886
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_46(int iParam0, bool bParam1, bool bParam2) //Position: 0x2838 / 10296
{
	int iVar0;
	int iVar1;
...
bool Function_47() //Position: 0x2A52 / 10834
{
	return NET_IS_MANAGER_INITIALIZED();
}

var Function_48() //Position: 0x2A5B / 10843
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return "";
...
void Function_49() //Position: 0x2A70 / 10864
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_GetMouthCave", "GaptBreach_GetMouthCave", false, 4, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_50() //Position: 0x2AC7 / 10951
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_WhereIsTreasure", "GaptBreach_WhereIsTreasure", false, 4, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
float Function_51(bool bParam0) //Position: 0x2B24 / 11044
{
...
bool Function_52(bool bParam0) //Position: 0x2BEC / 11244
{
	return Function_75(*bParam0, 2);
}

void Function_53() //Position: 0x2BF9 / 11257
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_JonUntiesCapt", "GaptBreach_JonUntiesCapt", false, 4, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_54(var uParam0, bool bParam1) //Position: 0x2C52 / 11346
{
	vector3 vVar0;
	
	GET_OBJECT_POSITION(GET_OBJECT_FROM_ACTOR(bParam1), &vVar0);
	Function_55(StackVal, StackVal, uParam0, vVar0);
	return;
}

void Function_55(bool bParam0, vector3 vParam1) //Position: 0x2C6C / 11372
{
	if (!IS_ACTOR_VALID(GET_MOUNT(bParam0)))
	{
		SET_ACTOR_HEADING(StackVal, Function_56(StackVal, bParam0, bParam0, vParam1), 1);
	}
	else
	{
		SET_ACTOR_HEADING(StackVal, Function_56(StackVal, GET_MOUNT(bParam0), bParam0, vParam1), 1);
	}
}

var Function_56(bool bParam0, vector3 vParam1) //Position: 0x2CA4 / 11428
{
	vector3 vVar0;
	
	Function_57(bParam0);
	vVar0 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(Function_57(bParam0), vParam1, StackVal) };
	VNORMALIZE(&vVar0);
...
vector3 Function_57(bool bParam0) //Position: 0x2D27 / 11559
{
	vector3 vVar0;
...
var Function_58(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2D38 / 11576
{
	bool bVar0;
...
void Function_59(int iParam0) //Position: 0x2DB1 / 11697
{
	bool bVar0;
...
void Function_60(int iParam0) //Position: 0x2E26 / 11814
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
...
void Function_61(int iParam0) //Position: 0x2E90 / 11920
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 43,23481f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
void Function_62(int iParam0) //Position: 0x2EFA / 12026
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
...
void Function_63(bool bParam0) //Position: 0x2F64 / 12132
{
...
void Function_64(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x2FCE / 12238
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_57(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_19(), 2, Function_57(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
				DELETE_PROJECTILES_IN_VOLUME(bVar0);
			}
		}
		Function_33(19, 1, 0, 0);
	}
	...
	if (Function_66(0x4000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
		Function_65(0x4000000);
	}
	if (Function_66(0x8000000))
	{
		AUDIO_MUSIC_SUSPEND(6000);
		AUDIO_MUSIC_RELEASE_CONTROL(0, 0);
		Function_65(0x8000000);
	}
}

void Function_65(int iParam0) //Position: 0x3277 / 12919
{
	int iVar0;
	
	if (Function_75(iParam0, 1) && Function_75(Global_26119, 1))
	{
	}
...
bool Function_66(int iParam0) //Position: 0x32AB / 12971
{
	int iVar0;
...
var Function_67() //Position: 0x32C7 / 12999
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_68(bool bParam0) //Position: 0x3346 / 13126
{
	if (!Function_69(bParam0))
	{
		Function_22(bParam0, 0.0f);
...
bool Function_69(bool bParam0) //Position: 0x335B / 13147
{
	return Function_75(*bParam0, 1);
}

void Function_70() //Position: 0x3368 / 13160
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(2, "GaptBreach_CaptiveSpotsJon", "GaptBreach_CaptiveSpotsJon", false, 2, 1, 0, 1);
		Function_9(5);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
float Function_71(bool bParam0, bool bParam1) //Position: 0x33C5 / 13253
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_72(bool bParam0) //Position: 0x34B6 / 13494
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
void Function_73(var uParam0, int iParam1) //Position: 0x34D3 / 13523
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

vector3 Function_74(bool bParam0) //Position: 0x34E2 / 13538
{
	vector3 vVar0;
...
bool Function_75(var uParam0, bool bParam1) //Position: 0x3509 / 13577
{
	return (uParam0 && bParam1) == 0;
}

void Function_76(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x3516 / 13590
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (IS_ACTOR_VALID(*uParam0))
	{
		...
		{
			if (Function_112(*uParam0, Global_34573) && !Function_75(*uParam1, 64))
			{
				Function_73(uParam1, 64);
				Function_90(4294967246, 1, 0);
	...
	switch (*uParam2)
	{
		case 0x00000000:
			if (IS_OBJECT_VALID(*uParam4))
			{
				if (Function_83(*uParam4, 0, 1, 1, 1, 0))
				{
					...
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_TeleportHorse"));
					vVar1 = { StackVal, StackVal, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_TeleportHorse")) };
					...
					Function_64(1, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1);
					if (!Function_69(&bLocal_27))
					{
						Function_68(&bLocal_27);
						Function_21(&bLocal_27);
					}
					Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonIntro"));
					TELEPORT_ACTOR_WITH_HEADING(Global_34573, Function_74(FIND_OBJECT_IN_LAYOUT(Global_30616, "f_teleportMarstonIntro")), -39,515f, 0, false, 0);
				...
				else if (Function_51(&bLocal_18) < 15.0f)
				{
		...
		case 0x00000003:
			...
			if (Function_69(&bLocal_27))
			{
				if (Function_51(&bLocal_27) < 16.0f)
				{
					Function_30(2, 0, 1, 1, 1, 1, 0, 1, 1, 1);
					AI_STOP_IGNORING_ACTOR(Global_34573);
					...
					CLEAR_JOURNAL_ENTRY_DETAIL_LIST(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
					APPEND_JOURNAL_ENTRY_DETAIL(GET_JOURNAL_ENTRY("GAPJournalID"), "GAP_Obj_HelpFloyd", 0, 0, false);
					APPEND_JOURNAL_ENTRY(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
...
void Function_77() //Position: 0x3907 / 14599
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "GaptBreach_HesRailHouse", "GaptBreach_HesRailHouse", false, 1, 1, 0, 1);
		Function_9(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
void Function_78() //Position: 0x395E / 14686
{
	ABORT_SCRIPTED_CONVERSATION(1);
	if (NEW_SCRIPTED_CONVERSATION())
	{
		ADD_LINE_TO_CONVERSATION(true, "GaptBreach_PleaseHelp", "GaptBreach_PleaseHelp", false, 3, 1, 0, 1);
		Function_9(3);
		START_SCRIPT_CONVERSATION(true, 1);
	}
	return;
...
var Function_79(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x39B1 / 14769
{
	bool bVar0;
...
void Function_80(int iParam0) //Position: 0x3A26 / 14886
{
	bool bVar0;
...
void Function_81(int iParam0) //Position: 0x3A69 / 14953
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
...
void Function_82(bool bParam0) //Position: 0x3AD7 / 15063
{
	SET_CAMERASHOT_PERSPECTIVE(*bParam0, 1);
...
bool Function_83(bool bParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x3B45 / 15173
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (GATEWAY_UPDATE(bParam0))
	{
		...
		if (IS_OBJECT_VALID(bVar0))
		{
			...
			if (bParam3)
			{
				Function_87(bVar1, uParam5);
			}
			else if (IS_ACTOR_RIDING(bVar1))
			{
				if (Function_86(bVar1, 0) < 10.0f && IS_ACTOR_VALID(GET_MOUNT(bVar1)))
				{
...
int Function_84(int iParam0, int iParam1) //Position: 0x3D57 / 15703
{
	var uVar0;
	...
	{
		if (!Function_85(StackVal, StackVal, *iParam1))
		{
			return 1;
		}
	}
...
bool Function_85(vector3 vParam0) //Position: 0x3DC2 / 15810
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

float Function_86(bool bParam0, bool bParam1) //Position: 0x3DDA / 15834
{
	vector3 vVar0;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3DF9 / 15865
{
	bool bVar0;
	bool bVar1;
...
void Function_88(var uParam0, int iParam1) //Position: 0x3E56 / 15958
{
	HUD_CLEAR_HELP();
...
void Function_89(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x3E6E / 15982
{
	int iVar0;
...
void Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x3EB9 / 16057
{
	int iVar0;
	bool bVar1;
	...
	if (bParam1)
	{
		if (bVar1 >= 0)
		{
			...
			if (!bParam2)
			{
				if (!Function_108(Global_76848, 1))
				{
					Function_103(Global_34573, 1, 3, 0);
				}
			}
		}
		else
		{
			...
			if (!Global_3380)
			{
				if (!Function_108(Global_76848, 2))
				{
					Function_103(Global_34573, 2, 3, 0);
				}
			}
		}
	}
	...
	{
		Function_33(1, bVar1, 0, 0);
	}
	else
	{
		Function_100(1, (4294967295 * bVar1), 0);
	}
	if (Function_110(1) <= 4294962296)
	{
		Function_99(1, 4294962296, 0);
	}
	else if (Function_110(1) >= 5000)
	{
		Function_99(1, 5000, 0);
	}
	...
	switch (Global_12976.f_152)
	{
		case 0x00000000:
			if (iVar0 >= 4294962796)
			{
				...
				Function_92(2, Function_98(Global_12976.f_152), 1);
			}
			break;
		...
		case 0x00000001:
			if (iVar0 < 4294962796)
			{
				...
				Function_92(2, Function_98(Global_12976.f_152), 0);
...
void Function_91(int iParam0, int iParam1) //Position: 0x41D1 / 16849
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_92(int iParam0, char* cParam1, bool bParam2) //Position: 0x442F / 17455
{
	bool bVar0;
	int iVar1;
...
int Function_93() //Position: 0x45B4 / 17844
{
	int iVar0;
...
void Function_94() //Position: 0x4653 / 18003
{
	int iVar0;
	int iVar1;
...
void Function_95(int iParam0) //Position: 0x4702 / 18178
{
...
int Function_96(int iParam0, bool bParam1, bool bParam2, var uParam3) //Position: 0x4760 / 18272
{
	int iVar0;
	var uVar1;
	...
	if (bParam2)
	{
		...
		Function_97(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, iParam0, *(&Global_35278[iParam020] + 16), 3.0f, uParam3);
	}
	return 1;
}

void Function_97(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0x4AB2 / 19122
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
var Function_98(int iParam0) //Position: 0x4B35 / 19253
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_99(int iParam0, bool bParam1, bool bParam2) //Position: 0x4BD8 / 19416
{
	int iVar0;
...
int Function_100(int iParam0, bool bParam1, int iParam2) //Position: 0x4E73 / 20083
{
	int iVar0;
	int iVar1;
...
int Function_101(int iParam0, bool bParam1) //Position: 0x506E / 20590
{
	bool bVar0;
	int iVar1;
...
var Function_102(int iParam0, int iParam1) //Position: 0x520A / 21002
{
	int iVar0;
...
void Function_103(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x524B / 21067
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_105(bParam0, iParam1, iParam2) && !bParam3)
	{
		return;
	}
	if (!IS_OBJECT_VALID(bParam0))
...
void Function_104(char* cParam0, int iParam1) //Position: 0x52B7 / 21175
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_105(bool bParam0, var uParam1, int iParam2) //Position: 0x52EE / 21230
{
	var uVar0;
	char* cVar1[16];
	...
	if (DECOR_CHECK_EXIST(bParam0, &cVar1))
	{
		if (Function_107(DECOR_GET_INT(bParam0, &cVar1)) > 3)
		{
			return 0;
		}
	}
	...
	if (iParam2 == 2)
	{
		...
		{
			case 0x00000002:
				if (!Function_108(Global_76847, 1577004))
				{
					return 0;
				}
				break;
...
int Function_106(char* cParam0) //Position: 0x5366 / 21350
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_107(int iParam0) //Position: 0x5407 / 21511
{
	int iVar0;
	int iVar1;
...
bool Function_108(var uParam0, int iParam1) //Position: 0x5444 / 21572
{
...
int Function_109(var uParam0, bool bParam1) //Position: 0x5457 / 21591
{
	bool bVar0;
	int iVar1;
	
	Function_33(uParam0, bParam1, 0, 0);
	bVar0 = uParam0;
	if (bVar0 >= 696)
	{
	...
	iVar1 = Function_102(uParam0, 4294967295);
	if (iVar1 > 0)
	{
...
int Function_110(int iParam0) //Position: 0x55F4 / 22004
{
	if (iParam0 == 4294967295)
	{
...
var Function_111(int iParam0) //Position: 0x5635 / 22069
{
	return (*&Global_12976 + 104)[iParam0];
}

int Function_112(bool bParam0, bool bParam1) //Position: 0x5644 / 22084
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
void Function_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x5675 / 22133
{
	vector3 vVar0;
	vector3 vVar3;
	...
	*uParam2 = CREATE_ACTOR_IN_LAYOUT(*uParam0, "InjuredGuy", 235, vVar0, vVar3);
	...
	SET_MOVER_FROZEN(*uParam2, true);
	SET_ACTOR_ONE_SHOT_DEATH(*uParam2, true);
	Function_68(&bLocal_18);
	...
	*uParam4 = GET_SQUAD_FROM_OBJECT(CREATE_SQUAD_IN_LAYOUT(*uParam0, "hostageSquad"));
	...
	CLEAR_JOURNAL_ENTRY_DETAIL_LIST(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
	APPEND_JOURNAL_ENTRY_DETAIL(GET_JOURNAL_ENTRY("GAPJournalID"), "GAP_FTE_ObjGoAttr", 0, 0, false);
	APPEND_JOURNAL_ENTRY(GET_JOURNAL_ENTRY("GAPJournalID"), 0);
...
bool Function_114(int iParam0) //Position: 0x5AF1 / 23281
{
	int iVar0;
	int iVar1;
	...
	if (!Function_5(iParam0[iVar03], 16))
	{
		...
		Function_117(iParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*iParam0 - 1))
	{
...
void Function_115() //Position: 0x5E6C / 24172
{
	if (!Function_66(128))
	{
		return;
...
bool Function_116() //Position: 0x5EAC / 24236
{
	int iVar0;
...
void Function_117(var uParam0, int iParam1) //Position: 0x5ED7 / 24279
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_118() //Position: 0x5EE8 / 24296
{
	if (!Function_66(128))
	{
		return;
...
bool Function_119(var uParam0, int iParam1) //Position: 0x5F2A / 24362
{
	if (!Function_75(*iParam1, 1))
	{
		*uParam0 = Function_125(3, 4294967197, 5);
		if (Function_123(*uParam0) >= 0)
		{
			return 0;
		}
...
bool Function_120(int iParam0) //Position: 0x5F68 / 24424
{
	if (!Function_122(iParam0))
	{
		return 1;
	}
	return Function_121(&(Global_29008[iParam0]), 4);
}

int Function_121(var uParam0, int iParam1) //Position: 0x5F84 / 24452
{
	int iVar0;
...
bool Function_122(int iParam0) //Position: 0x5FA0 / 24480
{
...
int Function_123(int iParam0) //Position: 0x5FB6 / 24502
{
...
bool Function_124(int iParam0) //Position: 0x5FD0 / 24528
{
...
int Function_125(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5FE7 / 24551
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	iVar1 = Function_129(bParam0, bParam1, bParam2);
	iVar0 = 0;
	while (iVar0 <= 275)
	{
		...
		{
			return Function_126(bParam0, bParam1, bParam2, iVar0);
		}
		iVar0++;
	}
	return Function_126(bParam0, bParam1, bParam2, 4294967295);
}

int Function_126(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6045 / 24645
{
	var uVar0;
	
	if (!Function_128(bParam2))
	{
		return 4294967295;
	}
	...
	uVar0 = Function_129(bParam0, bParam1, bParam2);
	if (bParam3 != 4294967295 || bParam3 <= 275)
	{
		bParam3 = Function_127(uVar0);
	}
...
int Function_127(int iParam0) //Position: 0x619A / 24986
{
	int iVar0;
...
bool Function_128(int iParam0) //Position: 0x61D8 / 25048
{
...
var Function_129(int iParam0, int iParam1, int iParam2) //Position: 0x61ED / 25069
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_130(bool bParam0) //Position: 0x620D / 25101
{
	Function_133(bParam0, 142, 3, 1);
	Function_133(bParam0, 235, 3, 1);
	Function_131(bParam0, "action_areas", 10, 0);
	Function_131(bParam0, "custom/uncle_injured", 8, 0);
	Function_131(bParam0, "uncle_injured", 5, 0);
	Function_131(bParam0, "excited_return", 5, 0);
	Function_131(bParam0, "custom/excited_return", 8, 0);
	Function_131(bParam0, "pointing", 5, 0);
	Function_131(bParam0, "custom/pointing", 8, 0);
	Function_131(bParam0, "sheriff_rub_wrist", 5, 0);
	Function_131(bParam0, "custom/sheriff_rub_wrist", 8, 0);
	return;
}

var Function_131(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x631F / 25375
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_132(uParam0, bVar1, iParam2);
	if (bParam3)
	{
		Function_117(uParam0[iVar03], 8);
	}
	return iVar0;
}

var Function_132(var uParam0, int iParam1, int iParam2) //Position: 0x6357 / 25431
{
	int iVar0;
...
var Function_133(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x641B / 25627
{
	int iVar0;
