...
void Function_3() //Position: 0x20C / 524
{
	...
	Function_4(5, bLocal_3, bLocal_4, iLocal_10, 4294967295);
	return;
}
...
void Function_13(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA99 / 2713
{
	bool bVar0;
	bool bVar1;
...
bool Function_43(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2A1B / 10779
{
...
void Function_52(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2D29 / 11561
{
	bool bVar0;
	bool bVar1;
...
{
	iLocal_10 = CREATE_LAYOUT("gun02campfirelayout");
	...
	SNAP_ACTOR_TO_GRINGO(bLocal_3, GET_OBJECT_FROM_GRINGO(bLocal_6), "UseCase1", false, 0, 0);
...
bool Function_76(var uParam0, char* cParam1, int iParam2) //Position: 0x38BA / 14522
{
...
void Function_82(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4019 / 16409
{
	bool bVar0;
...
bool Function_83(bool bParam0, bool bParam1) //Position: 0x406D / 16493
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_88(int iParam0, bool bParam1) //Position: 0x421D / 16925
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(int iParam0) //Position: 0x45A0 / 17824
{
	bool bVar0;
	bool bVar1;
...
bool Function_98(int iParam0) //Position: 0x469A / 18074
{
	int iVar0;
	int iVar1;
...
void Function_99() //Position: 0x4A15 / 18965
{
	if (!Function_147(128))
	{
		return;
...
bool Function_100() //Position: 0x4A55 / 19029
{
	int iVar0;
...
void Function_101(var uParam0, int iParam1) //Position: 0x4A80 / 19072
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_102() //Position: 0x4A91 / 19089
{
	if (!Function_147(128))
	{
		return;
...
void Function_103(int iParam0, bool bParam1) //Position: 0x4AD3 / 19155
{
	char* cVar0[32];
...
void Function_104(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4B57 / 19287
{
	var uVar0;
	var uVar1;
...
void Function_105(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4B80 / 19328
{
...
var Function_106(var uParam0, bool bParam1) //Position: 0x4BD1 / 19409
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_107() //Position: 0x4BE1 / 19425
{
	return "PackedGrass";
}

var Function_108(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4BF5 / 19445
{
	int iVar0;
...
var Function_109() //Position: 0x4C1A / 19482
{
	return "PackedMetadata";
}

void Function_110(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4C31 / 19505
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_111() //Position: 0x4D57 / 19799
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_112() //Position: 0x4D68 / 19816
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_113() //Position: 0x4D79 / 19833
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_114(var uParam0, int iParam1) //Position: 0x4D8A / 19850
{
...
var Function_115(var uParam0, int iParam1, bool bParam2) //Position: 0x4DAD / 19885
{
	int iVar0;
...
var Function_116(bool bParam0) //Position: 0x4DCC / 19916
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_117() //Position: 0x4DD8 / 19928
{
	return Function_118(39);
}

int Function_118(int iParam0) //Position: 0x4DE3 / 19939
{
	int iVar0;
...
var Function_119() //Position: 0x4E11 / 19985
{
	return "PackedWeapon";
}

int Function_120(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x4E26 / 20006
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_121() //Position: 0x4F2A / 20266
{
	return "MPItemGiver";
}

struct<32> Function_122(bool bParam0) //Position: 0x4F3E / 20286
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_123(char* cParam0, char* cParam1, char* cParam2) //Position: 0x4FA8 / 20392
{
	char* cVar0[32];
...
var Function_124() //Position: 0x4FC7 / 20423
{
	return "PBox_";
}

var Function_125() //Position: 0x4FD5 / 20437
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_126() //Position: 0x4FFB / 20475
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_127() //Position: 0x5023 / 20515
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_128(var uParam0, int iParam1) //Position: 0x5049 / 20553
{
	int iVar0;
	var uVar1;
...
void Function_129(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x51AA / 20906
{
	struct<8> Var0;
...
int Function_130(bool bParam0) //Position: 0x5245 / 21061
{
	int iVar0;
	vector3 vVar1;
...
void Function_131(int iParam0) //Position: 0x53A6 / 21414
{
...
var Function_132() //Position: 0x5407 / 21511
{
	int iVar0;
...
var Function_133(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x540F / 21519
{
	return Function_134(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_134(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5428 / 21544
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_135(int iParam0) //Position: 0x571B / 22299
{
	int iVar0;
...
void Function_136() //Position: 0x57CF / 22479
{
	int iVar0;
...
bool Function_137(bool bParam0) //Position: 0x5809 / 22537
{
	int iVar0;
...
void Function_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5836 / 22582
{
	bool bVar0;
...
void Function_139() //Position: 0x5987 / 22919
{
	int iVar0;
...
var Function_140(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x59D2 / 22994
{
	int iVar0;
...
int Function_141() //Position: 0x5AA2 / 23202
{
	int iVar0;
...
int Function_142() //Position: 0x5BFE / 23550
{
	int iVar0;
...
bool Function_143(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5D1E / 23838
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_144(var uParam0, int iParam1) //Position: 0x5DEE / 24046
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_145(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x5E0C / 24076
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_146(bool bParam0) //Position: 0x5F3E / 24382
{
	bool bVar0;
...
bool Function_147(int iParam0) //Position: 0x5F5D / 24413
{
	int iVar0;
...
int Function_148() //Position: 0x5F79 / 24441
{
	if (Function_150())
	{
...
int Function_149() //Position: 0x5F92 / 24466
{
	return Global_79349.f_16;
}

bool Function_150() //Position: 0x5F9E / 24478
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_151(int iParam0, bool bParam1, bool bParam2) //Position: 0x5FA7 / 24487
{
	var uVar0;
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x6024 / 24612
{
	int iVar0;
