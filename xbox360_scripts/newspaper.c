...
void Function_7() //Position: 0x301 / 769
{
	float fVar0;
...
void Function_8() //Position: 0x334 / 820
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x4C2 / 1218
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x676 / 1654
{
	Function_11(&Global_28260, 1, 0);
	return;
}

void Function_11(int iParam0, bool bParam1, var uParam2) //Position: 0x684 / 1668
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_12() //Position: 0x875 / 2165
{
...
struct<8> Function_13() //Position: 0x88A / 2186
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_14(int iParam0, bool bParam1, bool bParam2) //Position: 0x925 / 2341
{
	int iVar0;
...
void Function_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBC0 / 3008
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_16() //Position: 0x11ED / 4589
{
	int iVar0;
...
var Function_17(int iParam0) //Position: 0x11F5 / 4597
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1206 / 4614
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0, char* cParam1) //Position: 0x12FB / 4859
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1314 / 4884
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x1379 / 4985
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x138B / 5003
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x139D / 5021
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x14CD / 5325
{
	return Global_35278[iParam020].f_48;
}

float Function_25(int iParam0) //Position: 0x14DC / 5340
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x1515 / 5397
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x1552 / 5458
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x16EC / 5868
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x1906 / 6406
{
...
struct<8> Function_30() //Position: 0x1947 / 6471
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x19D0 / 6608
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x1A67 / 6759
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x1AE6 / 6886
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x1B0C / 6924
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x1D16 / 7446
{
	vector3 vVar0;
	var uVar3;
...
bool Function_36(vector3 vParam0) //Position: 0x1DB7 / 7607
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_37(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1DCF / 7631
{
	int iVar0;
...
vector3 Function_38() //Position: 0x1EB6 / 7862
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_39(var uParam0, int iParam1) //Position: 0x1EBF / 7871
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_40(int iParam0) //Position: 0x1ECE / 7886
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x1EE4 / 7908
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x1FAB / 8107
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_43(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1FC8 / 8136
{
	uParam0 = uParam0;
...
int Function_44(bool bParam0) //Position: 0x206C / 8300
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_45(bool bParam0, bool bParam1, int iParam2) //Position: 0x2115 / 8469
{
	bool bVar0;
...
bool Function_46(bool bParam0, bool bParam1, int iParam2) //Position: 0x213C / 8508
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_47(bool bParam0, bool bParam1, int iParam2) //Position: 0x2407 / 9223
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_48(bool bParam0, bool bParam1) //Position: 0x2491 / 9361
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, int iParam2) //Position: 0x253F / 9535
{
	int iVar0;
	bool bVar1;
...
var Function_50(bool bParam0) //Position: 0x2584 / 9604
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_51(bool bParam0) //Position: 0x259A / 9626
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_52(bool bParam0, bool bParam1, int iParam2) //Position: 0x25B0 / 9648
{
	bParam0 = Function_58(bParam0);
	*iParam2 = 0;
	if (DECOR_CHECK_EXIST(bParam1, "NewspaperStart"))
	{
		DECOR_REMOVE(bParam1, "NewspaperStart");
...
void Function_53(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x26D0 / 9936
{
	int iVar0;
...
int Function_54(bool bParam0, bool bParam1, bool bParam2) //Position: 0x271B / 10011
{
...
bool Function_55() //Position: 0x27D1 / 10193
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_56(bool bParam0) //Position: 0x27E8 / 10216
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_57(bool bParam0) //Position: 0x27F3 / 10227
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_58(bool bParam0) //Position: 0x2801 / 10241
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_59(int iParam0, bool bParam1) //Position: 0x281B / 10267
{
	bool bVar0;
	bool bVar1;
