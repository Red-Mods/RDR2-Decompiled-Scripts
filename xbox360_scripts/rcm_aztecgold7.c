...
void main() //Position: 0x0 / 0
{
	...
	iLocal_187 = 0;
	bLocal_196 = false;
	vLocal_199 = { -391,564f, 24,116f, 3901,06f };
	iLocal_203 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (iVar0)
				{
					...
					case 0x00000005:
						Function_146(&(Global_63541[855]), 8, 0x41f00000, 0x42200000, 0);
						iVar0 = 6;
						break;
					
					case 0x00000006:
						if (Function_106("$/cutscene/RCM_23_CS03/RCM_23_CS03", &iLocal_188, 24251, 24224, 23011, 22992, 22706, 22690, 1, 1, 2, 2, 0))
						{
							iVar0 = 7;
						}
						break;
					...
					case 0x00000007:
						Function_105("AztecGold7_SHORT", 0x40f00000, 1, 2, 0, 0, 0);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "AztecGold7_OBJ", 0, 3, false);
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x204 / 516
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x21F / 543
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_5(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x256 / 598
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_6(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x78B / 1931
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_7() //Position: 0x8FE / 2302
{
	return;
}

void Function_8(var uParam0, var uParam1) //Position: 0x904 / 2308
{
	if (Global_3381)
	{
		return;
...
bool Function_9() //Position: 0x946 / 2374
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_10(bool bParam0) //Position: 0x94F / 2383
{
...
void Function_11() //Position: 0x9A0 / 2464
{
	Function_39();
	Function_38();
	Function_38();
...
void Function_12() //Position: 0x9D3 / 2515
{
...
void Function_13() //Position: 0xAD9 / 2777
{
	float fVar0;
...
void Function_14() //Position: 0xB0C / 2828
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_15() //Position: 0xC9A / 3226
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_16() //Position: 0xE4E / 3662
{
	Function_17(&Global_28260, 1, 0);
	return;
}

void Function_17(int iParam0, bool bParam1, var uParam2) //Position: 0xE5C / 3676
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_18() //Position: 0x104D / 4173
{
...
struct<8> Function_19() //Position: 0x1062 / 4194
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_20(int iParam0, bool bParam1, bool bParam2) //Position: 0x10FD / 4349
{
	int iVar0;
...
void Function_21(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1398 / 5016
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_22() //Position: 0x19C5 / 6597
{
	int iVar0;
...
var Function_23(int iParam0) //Position: 0x19CD / 6605
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_24(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x19DE / 6622
{
	char* cVar0[32];
...
struct<32> Function_25(char* cParam0, char* cParam1) //Position: 0x1AD3 / 6867
{
	char* cVar0[32];
...
void Function_26(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1AEC / 6892
{
	float fVar0;
...
var Function_27(int iParam0, int iParam1) //Position: 0x1B51 / 6993
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_28(int iParam0, bool bParam1) //Position: 0x1B63 / 7011
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_29(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1B75 / 7029
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_30(int iParam0) //Position: 0x1CA5 / 7333
{
	return Global_35278[iParam020].f_48;
}

float Function_31(int iParam0) //Position: 0x1CB4 / 7348
{
	if (!iParam0 != 4294967295)
	{
...
var Function_32(int iParam0) //Position: 0x1CED / 7405
{
	if (iParam0 == 4294967295)
	{
...
void Function_33(int iParam0) //Position: 0x1D2A / 7466
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_34(int iParam0, bool bParam1, bool bParam2) //Position: 0x1EC4 / 7876
{
	int iVar0;
	int iVar1;
...
int Function_35(bool bParam0) //Position: 0x20DE / 8414
{
...
struct<8> Function_36() //Position: 0x211F / 8479
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_37() //Position: 0x21A8 / 8616
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_38() //Position: 0x223F / 8767
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_39() //Position: 0x22BE / 8894
{
...
int Function_40(int iParam0, bool bParam1, int iParam2) //Position: 0x22E4 / 8932
{
	int iVar0;
	int iVar1;
...
void Function_41() //Position: 0x24EE / 9454
{
	vector3 vVar0;
	var uVar3;
...
bool Function_42(vector3 vParam0) //Position: 0x258F / 9615
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_43(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x25A7 / 9639
{
	int iVar0;
...
vector3 Function_44() //Position: 0x268E / 9870
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_45(int iParam0) //Position: 0x2697 / 9879
{
...
int Function_46(bool bParam0, bool bParam1) //Position: 0x26AD / 9901
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_47(vector3 vParam0, vector3 vParam3) //Position: 0x2774 / 10100
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2791 / 10129
{
	uParam0 = uParam0;
...
void Function_49(bool bParam0) //Position: 0x2835 / 10293
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_50(int iParam0, int iParam1) //Position: 0x29D7 / 10711
{
	int iVar0;
	bool bVar1;
...
void Function_51(int iParam0) //Position: 0x2A91 / 10897
{
	float fVar0;
	bool bVar1;
...
int Function_52(var uParam0, int iParam1) //Position: 0x2B33 / 11059
{
	int iVar0;
	var uVar1;
...
void Function_53(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x2C94 / 11412
{
	struct<8> Var0;
...
struct<32> Function_54(bool bParam0) //Position: 0x2D2F / 11567
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_55(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2D99 / 11673
{
	char* cVar0[32];
...
int Function_56(bool bParam0) //Position: 0x2DB8 / 11704
{
	int iVar0;
	vector3 vVar1;
...
float Function_57(bool bParam0, vector3 vParam1) //Position: 0x2F19 / 12057
{
	vector3 vVar0;
...
vector3 Function_58(bool bParam0) //Position: 0x2F93 / 12179
{
	vector3 vVar0;
...
void Function_59(int iParam0) //Position: 0x2FFD / 12285
{
...
bool Function_60(int iParam0) //Position: 0x305E / 12382
{
...
void Function_61(int iParam0, int iParam1) //Position: 0x3074 / 12404
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_62(bool bParam0) //Position: 0x31B9 / 12729
{
...
var Function_63(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x31E5 / 12773
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_64(int iParam0) //Position: 0x3201 / 12801
{
...
bool Function_65(int iParam0, int iParam1) //Position: 0x3216 / 12822
{
...
bool Function_66(int iParam0, int iParam1) //Position: 0x332B / 13099
{
	int iVar0;
...
bool Function_68(int iParam0) //Position: 0x3493 / 13459
{
...
bool Function_69(int iParam0) //Position: 0x34A8 / 13480
{
...
var Function_70(int iParam0) //Position: 0x34BF / 13503
{
...
bool Function_71(int iParam0) //Position: 0x34D9 / 13529
{
...
bool Function_72(int iParam0) //Position: 0x34EF / 13551
{
	return StackVal;
}

bool Function_73(var uParam0, int iParam1) //Position: 0x34FF / 13567
{
	int iVar0;
...
bool Function_74(int iParam0) //Position: 0x351B / 13595
{
	if (!iParam0->f_152)
	{
...
bool Function_75(int iParam0) //Position: 0x3562 / 13666
{
...
bool Function_76(int iParam0) //Position: 0x35BB / 13755
{
	int iVar0;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x35D7 / 13783
{
	int iVar0;
...
int Function_78(int iParam0) //Position: 0x35F3 / 13811
{
...
bool Function_79(int iParam0) //Position: 0x3608 / 13832
{
...
int Function_80(int iParam0) //Position: 0x361D / 13853
{
...
bool Function_81(var uParam0, bool bParam1) //Position: 0x3632 / 13874
{
	return (uParam0 && bParam1) == 0;
}

void Function_82() //Position: 0x363F / 13887
{
...
var Function_83(int iParam0, int iParam1) //Position: 0x36BA / 14010
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_102(bool bParam0, bool bParam1) //Position: 0x47B7 / 18359
{
	...
	if (bParam1)
	{
		if (GET_ITEM_COUNT(Function_103(bParam0), Function_18()) >= 0)
		{
			DELETE_ITEM(Function_103(bParam0), Function_18(), 0);
			return 1;
		}
	}
	DELETE_ITEM(Function_103(bParam0), Function_18(), 1);
	return 1;
}

var Function_103(bool bParam0) //Position: 0x47FE / 18430
{
	bool bVar0;
...
void Function_104(bool bParam0, bool bParam1) //Position: 0x48EF / 18671
{
	bool bVar0;
...
void Function_105(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x4914 / 18708
{
	int iVar0;
...
bool Function_106(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x4967 / 18791
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_107(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x4A10 / 18960
{
	if (!bParam15)
	{
...
void Function_108(bool bParam0) //Position: 0x5024 / 20516
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_109() //Position: 0x50C9 / 20681
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_110() //Position: 0x510E / 20750
{
...
void Function_111(bool bParam0, bool bParam1) //Position: 0x5120 / 20768
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_112(bool bParam0) //Position: 0x51A0 / 20896
{
	bool bVar0;
...
float Function_113(int iParam0) //Position: 0x51CF / 20943
{
...
bool Function_114(int iParam0) //Position: 0x5297 / 21143
{
	return Function_81(*iParam0, 2);
}

bool Function_115(int iParam0) //Position: 0x52A4 / 21156
{
	return Function_81(*iParam0, 1);
}

int Function_116(bool bParam0) //Position: 0x52B1 / 21169
{
	bool bVar0;
	bool bVar1;
...
bool Function_117() //Position: 0x5369 / 21353
{
	bool bVar0;
	bool bVar1;
...
void Function_118(int iParam0) //Position: 0x53A3 / 21411
{
	Function_119(iParam0, 0.0f);
	return;
}

void Function_119(var uParam0, float fParam1) //Position: 0x53AF / 21423
{
...
bool Function_120(int iParam0) //Position: 0x53D0 / 21456
{
	return iParam0->f_20;
}

void Function_121(var uParam0, int iParam1) //Position: 0x53DA / 21466
{
	Function_122(uParam0, iParam1, 0);
	return;
}

void Function_122(var uParam0, bool bParam1, bool bParam2) //Position: 0x53E8 / 21480
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_123(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5534 / 21812
{
	int iVar0;
	int iVar1;
...
void Function_124(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5754 / 22356
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_125() //Position: 0x577D / 22397
{
	bool bVar0;
	bool bVar1;
...
void Function_126() //Position: 0x57C8 / 22472
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int Function_127() //Position: 0x58A2 / 22690
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_128() //Position: 0x58B2 / 22706
{
...
void Function_129(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x58CB / 22731
{
	bool bVar0;
...
void Function_130() //Position: 0x59BB / 22971
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_131() //Position: 0x59D0 / 22992
{
...
int Function_132() //Position: 0x59E3 / 23011
{
	if (!iLocal_203)
	{
		Function_133(StackVal, StackVal, vLocal_199, bLocal_204);
		iLocal_203 = 1;
	}
	return 1;
}

void Function_133(vector3 vParam0) //Position: 0x59FC / 23036
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
float Function_134(bool bParam0, bool bParam1) //Position: 0x5B82 / 23426
{
	vector3 vVar0;
	vector3 vVar3;
...
void Function_135(bool bParam0, float fParam1) //Position: 0x5C73 / 23667
{
...
void Function_136() //Position: 0x5D71 / 23921
{
...
void Function_137() //Position: 0x5DA3 / 23971
{
...
int Function_138() //Position: 0x5EA0 / 24224
{
	CUTSCENE_MANAGER_ORIENT_GAMECAMERA_ON_EXIT(-382,721f, 25,832f, 3903,337f, 0, 0);
	return 1;
}

int Function_139() //Position: 0x5EBB / 24251
{
	bLocal_204 = CREATE_VOLUME_IN_LAYOUT(bLocal_202, "tempcutscenevol", 2, *(&Global_63541[855] + 100), 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
	Function_142(0, 0, 1, 1, 0, 1, 1, bLocal_204, 1, 1, 1, 1);
	Function_140(StackVal, StackVal, bLocal_202, *(&Global_63541[855] + 112), &bLocal_204, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_140(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x5F21 / 24353
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_141(bool bParam0, bool bParam1) //Position: 0x618F / 24975
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_142(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x6204 / 25092
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_145(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_22(), 2, Function_145(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_143(int iParam0) //Position: 0x64AD / 25773
{
	int iVar0;
...
var Function_144() //Position: 0x64E1 / 25825
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_145(bool bParam0) //Position: 0x6560 / 25952
{
	vector3 vVar0;
...
int Function_146(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x6571 / 25969
{
	bool bVar0;
	var uVar1;
	var uVar2;
		...
		if (!(((Global_3380 || Global_3382) || Global_3392) || Global_34165.f_28))
		{
			if (UNK_0x214AFB8C(iParam0->f_68))
			{
				...
				if (Global_63535.f_12 == iParam1)
				{
					...
					uVar2 = Function_148(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &uVar1, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
				...
				if (bVar0 > fParam2)
				{
					if (Global_63535.f_12 != 4294967295 || (Global_63535.f_12 == iParam1 && bVar0 > Global_63535.f_16))
					{
						...
						uVar6 = Function_148(StackVal, StackVal, GET_ASSET_NAME(iParam0->f_68, 9), &iVar3, *(iParam0 + 100), 0, fParam2, fParam3, 2, 1, 2, 2, 0, 1);
...
float Function_147(float fParam0) //Position: 0x66D2 / 26322
{
	if (fParam0->f_168 != 4294967295)
	{
		...
		return Function_147(&(Global_63541[fParam0->f_16855]));
	}
	return 0;
}

int Function_148(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x6707 / 26375
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
	
	if (Function_151(StackVal, StackVal, Global_34573, vParam2, (fParam6 + ((IntToFloat(Function_152()) * (fParam7 - fParam6)) * 0,5f))) || bParam12)
	{
	...
	else if ((!Function_151(StackVal, StackVal, Global_34573, vParam2, (fParam7 + ((IntToFloat(Function_152()) * (fParam7 - fParam6)) * 0,5f))) && ((CUTSCENE_MANAGER_IS_CUTSCENE_LOADED() || CUTSCENE_MANAGER_IS_CUTFILE_LOADED()) || !CUTSCENE_MANAGER_IS_CUTSCENE_FINISHED())) && !bParam12)
	{
		CUTSCENE_MANAGER_STOP_CUTSCENE(2, 2);
		*iParam1 = 0;
	}
	else if (!Function_151(StackVal, StackVal, Global_34573, vParam2, fParam6))
	{
	}
	return 0;
}

void Function_149() //Position: 0x694D / 26957
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
	...
	while (bVar0 <= CUTSCENE_MANAGER_GET_NUM_CUTSCENE_ACTORS())
	{
		if (CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_BY_INDEX_START_ORIENT(bVar0, &vVar1, &Var4))
		{
			...
			Function_150(StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, CUTSCENE_MANAGER_GET_CUTSCENE_ACTOR_NAME(bVar0), (vVar1 + 180.0f), (vVar7 + 180.0f));
		}
		bVar0++;
	}
	return;
...
void Function_150(char* cParam0, vector3 vParam1) //Position: 0x69A1 / 27041
{
	char* cVar0[64];
...
bool Function_151(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x6AC9 / 27337
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_58(bParam0);
...
int Function_152() //Position: 0x6B53 / 27475
{
	if (IS_PS3())
	{
		return 1;
...
void Function_153() //Position: 0x6B62 / 27490
{
	var uVar0;
	
	Function_154(4, 1);
	uVar0 = uVar0;
	bLocal_202 = CREATE_LAYOUT("AztecGold_layout");
	return;
}

void Function_154(int iParam0, int iParam1) //Position: 0x6B89 / 27529
{
	switch (iParam1)
	{
		case 0x00000000:
