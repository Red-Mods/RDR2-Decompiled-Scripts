	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_42(iParam0, bVar8, &iLocal_79, &bLocal_78);
...
void Function_22(bool bParam0, int iParam1) //Position: 0x1CB2 / 7346
{
	bool bVar0;
	bool bVar1;
	...
	if (bVar0)
	{
		...
		{
			ADD_ITEM(Function_25(iParam1), bParam0, true);
		}
		else
		{
...
int Function_23(int iParam0) //Position: 0x1CF4 / 7412
{
	return Function_24(iParam0, "CompletionRewardAmount", 0);
}

int Function_24(bool bParam0, bool bParam1, int iParam2) //Position: 0x1D19 / 7449
{
	int iVar0;
...
var Function_25(bool bParam0) //Position: 0x1D2F / 7471
{
	bool bVar0;
	bool bVar1;
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D78 / 7544
{
	return Function_9(bParam0, "CompletionReward", iParam1);
}

float Function_27(bool bParam0) //Position: 0x1D98 / 7576
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_28() //Position: 0x1DAE / 7598
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_29(bool bParam0) //Position: 0x1DBB / 7611
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_30(var uParam0, int iParam1) //Position: 0x1DDB / 7643
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_31(bool bParam0) //Position: 0x1DEA / 7658
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_32() //Position: 0x1E09 / 7689
{
	return;
}

void Function_33(var uParam0, int iParam1) //Position: 0x1E0F / 7695
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_34(int iParam0) //Position: 0x1E1D / 7709
{
	iParam0 = iParam0;
	return 1;
}

bool Function_35(bool bParam0) //Position: 0x1E28 / 7720
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_36(bool bParam0, int iParam1) //Position: 0x1E42 / 7746
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_37(bool bParam0) //Position: 0x1E60 / 7776
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x1E7F / 7807
{
	int iVar0;
	int iVar1;
...
bool Function_39(bool bParam0) //Position: 0x1EB2 / 7858
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_40(bool bParam0) //Position: 0x1ED1 / 7889
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_41(var uParam0, int iParam1) //Position: 0x1EEB / 7915
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EFE / 7934
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_43() //Position: 0x21E6 / 8678
{
	int iVar0;
...
bool Function_44(bool bParam0, bool bParam1) //Position: 0x21EE / 8686
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_45() //Position: 0x220B / 8715
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x221A / 8730
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x223C / 8764
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_48(bool bParam0) //Position: 0x2260 / 8800
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x227D / 8829
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_50(bool bParam0, int iParam1) //Position: 0x229D / 8861
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_51(bool bParam0, bool bParam1) //Position: 0x22BD / 8893
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_52(bool bParam0, bool bParam1, bool bParam2) //Position: 0x236B / 9067
{
	bool bVar0;
...
void Function_53(int iParam0, float fParam1) //Position: 0x23DB / 9179
{
	if (!Function_14(iParam0))
	{
...
void Function_54(int iParam0, float fParam1) //Position: 0x23F1 / 9201
{
...
var Function_55(bool bParam0) //Position: 0x2412 / 9234
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_56(int iParam0) //Position: 0x2432 / 9266
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_57(var uParam0) //Position: 0x2446 / 9286
{
	uParam0 = uParam0;
	return;
}

int Function_58() //Position: 0x2450 / 9296
{
	return 1;
}

void Function_59(var uParam0, int iParam1) //Position: 0x2457 / 9303
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_60(bool bParam0, var uParam1, int iParam2) //Position: 0x2466 / 9318
{
	bool bVar0;
...
bool Function_61(bool bParam0) //Position: 0x24A5 / 9381
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_62(bool bParam0) //Position: 0x24D0 / 9424
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_63(bool bParam0) //Position: 0x24DB / 9435
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_64(bool bParam0) //Position: 0x25D1 / 9681
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_65(bool bParam0) //Position: 0x25F3 / 9715
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_66(bool bParam0) //Position: 0x261A / 9754
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_67(vector3 vParam0) //Position: 0x28D9 / 10457
{
	vector3 vVar0;
...
vector3 Function_68(vector3 vParam0) //Position: 0x2936 / 10550
{
	vector3 vVar0;
...
void Function_69(int iParam0) //Position: 0x2993 / 10643
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x299D / 10653
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x29BB / 10683
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x29D0 / 10704
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2A57 / 10839
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A7A / 10874
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x2A98 / 10904
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x2ABB / 10939
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x2BD6 / 11222
{
...
int Function_78(bool bParam0) //Position: 0x2C01 / 11265
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2D06 / 11526
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2D13 / 11539
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2D86 / 11654
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x3284 / 12932
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x32BB / 12987
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x32D8 / 13016
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x3310 / 13072
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x331A / 13082
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(var uParam0, int iParam1) //Position: 0x333B / 13115
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x3349 / 13129
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x3451 / 13393
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x3467 / 13415
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x371D / 14109
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_92(bool bParam0) //Position: 0x372B / 14123
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x3744 / 14148
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(bool bParam0, int iParam1) //Position: 0x375E / 14174
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x378D / 14221
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x37A4 / 14244
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x3A6D / 14957
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x3A8A / 14986
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3B26 / 15142
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x3B45 / 15173
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x3B54 / 15188
{
...
void Function_102(int iParam0) //Position: 0x3B70 / 15216
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x3B7A / 15226
{
	bool bVar0;
	bool bVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x3BDC / 15324
{
...
void Function_105(int iParam0) //Position: 0x3BF0 / 15344
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3BFA / 15354
{
