...
void Function_1(var uParam0, var uParam1) //Position: 0x112 / 274
{
	if (Global_3381)
	{
		return;
...
bool Function_2() //Position: 0x154 / 340
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_3(bool bParam0) //Position: 0x15D / 349
{
...
void Function_4(var uParam0, int iParam1) //Position: 0x1AE / 430
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_5() //Position: 0x1C1 / 449
{
	Function_33();
	Function_32();
	Function_32();
...
void Function_6() //Position: 0x1F4 / 500
{
...
void Function_7() //Position: 0x2FA / 762
{
	float fVar0;
...
void Function_8() //Position: 0x32D / 813
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_9() //Position: 0x4BB / 1211
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_10() //Position: 0x66F / 1647
{
	Function_11(&Global_28260, 1, 0);
	return;
}

void Function_11(int iParam0, bool bParam1, var uParam2) //Position: 0x67D / 1661
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_12() //Position: 0x86E / 2158
{
...
struct<8> Function_13() //Position: 0x883 / 2179
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_14(int iParam0, bool bParam1, bool bParam2) //Position: 0x91E / 2334
{
	int iVar0;
...
void Function_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0xBB9 / 3001
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_16() //Position: 0x11E6 / 4582
{
	int iVar0;
...
var Function_17(int iParam0) //Position: 0x11EE / 4590
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_18(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x11FF / 4607
{
	char* cVar0[32];
...
struct<32> Function_19(char* cParam0, char* cParam1) //Position: 0x12F4 / 4852
{
	char* cVar0[32];
...
void Function_20(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x130D / 4877
{
	float fVar0;
...
var Function_21(int iParam0, int iParam1) //Position: 0x1372 / 4978
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_22(int iParam0, bool bParam1) //Position: 0x1384 / 4996
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_23(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1396 / 5014
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_24(int iParam0) //Position: 0x14C6 / 5318
{
	return Global_35278[iParam020].f_48;
}

float Function_25(int iParam0) //Position: 0x14D5 / 5333
{
	if (!iParam0 != 4294967295)
	{
...
var Function_26(int iParam0) //Position: 0x150E / 5390
{
	if (iParam0 == 4294967295)
	{
...
void Function_27(int iParam0) //Position: 0x154B / 5451
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x16E5 / 5861
{
	int iVar0;
	int iVar1;
...
int Function_29(bool bParam0) //Position: 0x18FF / 6399
{
...
struct<8> Function_30() //Position: 0x1940 / 6464
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_31() //Position: 0x19C9 / 6601
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_32() //Position: 0x1A60 / 6752
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_33() //Position: 0x1ADF / 6879
{
...
int Function_34(int iParam0, bool bParam1, int iParam2) //Position: 0x1B05 / 6917
{
	int iVar0;
	int iVar1;
...
void Function_35() //Position: 0x1D0F / 7439
{
	vector3 vVar0;
	var uVar3;
...
bool Function_36(vector3 vParam0) //Position: 0x1DB0 / 7600
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_37(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x1DC8 / 7624
{
	int iVar0;
...
vector3 Function_38() //Position: 0x1EAF / 7855
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_39(var uParam0, int iParam1) //Position: 0x1EB8 / 7864
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_40(int iParam0) //Position: 0x1EC7 / 7879
{
...
int Function_41(bool bParam0, bool bParam1) //Position: 0x1EDD / 7901
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_42(vector3 vParam0, vector3 vParam3) //Position: 0x1FA4 / 8100
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_43(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x1FC1 / 8129
{
	uParam0 = uParam0;
...
int Function_44(bool bParam0) //Position: 0x2065 / 8293
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_1)
	{
		...
		case 0x00000001:
			if (Function_67(bParam0, iVar0))
			{
				Function_60(bParam0, iVar0, &iLocal_2);
				iLocal_1 = 2;
			}
			iVar1 = 0;
			break;
		...
		case 0x00000002:
			...
			{
				Function_56(bParam0, iVar0, &iLocal_2);
				iLocal_1 = 3;
			}
			else
			{
...
void Function_45(bool bParam0, bool bParam1, int iParam2) //Position: 0x210E / 8462
{
	bool bVar0;
...
bool Function_46(bool bParam0, bool bParam1, int iParam2) //Position: 0x2137 / 8503
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (*iParam2)
	{
		switch (iLocal_4)
		{
			case 0x00000000:
				...
				bVar1 = Function_54(Function_55(bParam0), "nActorEnum", &iVar0);
				iVar2 = GET_ACTOR_ENUM_FROM_STRING(bVar1);
				Function_53(iVar2, 1, 1);
				Function_50(0, 0x40400000);
				iLocal_4 = 1;
				break;
			...
			case 0x00000001:
				if (Function_49())
				{
					Function_48(4294967295);
					iLocal_4 = 2;
				}
				break;
			
			case 0x00000002:
				Function_47("own_new_horse", 0x41200000, 1, 0, 2, 1, 0);
...
void Function_47(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x21FC / 8700
{
	int iVar0;
...
void Function_48(bool bParam0) //Position: 0x2247 / 8775
{
...
bool Function_49() //Position: 0x2287 / 8839
{
	bool bVar0;
...
void Function_50(bool bParam0, float fParam1) //Position: 0x22A7 / 8871
{
...
void Function_51() //Position: 0x23A5 / 9125
{
...
void Function_52() //Position: 0x23D7 / 9175
{
...
void Function_53(var uParam0, bool bParam1, bool bParam2) //Position: 0x24D4 / 9428
{
...
bool Function_54(bool bParam0, bool bParam1, int iParam2) //Position: 0x2501 / 9473
{
	int iVar0;
	bool bVar1;
...
bool Function_55(bool bParam0) //Position: 0x2546 / 9542
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

void Function_56(bool bParam0, bool bParam1, int iParam2) //Position: 0x2560 / 9568
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_57(bool bParam0, bool bParam1) //Position: 0x25EA / 9706
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_58(bool bParam0) //Position: 0x2698 / 9880
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseProp", 1, bParam0);
}

var Function_59(bool bParam0) //Position: 0x26AE / 9902
{
	return GRINGO_GET_FIRST_NAMED_CHILD("UseAnim", 2, bParam0);
}

void Function_60(var uParam0, bool bParam1, int iParam2) //Position: 0x26C4 / 9924
{
	int iVar0;
	char* cVar1;
	bool bVar2;
	...
	uParam0 = Function_55(uParam0);
	iVar0 = 1;
	if (IS_ACTOR_VALID(Global_12976.f_36))
	{
		cVar1 = Function_54(uParam0, "nActorEnum", &iVar0);
		bVar2 = GET_ACTOR_ENUM_FROM_STRING(cVar1);
		bVar3 = GET_ACTOR_ENUM(Global_12976.f_36);
		iVar4 = 0;
		Function_66(Global_34573);
		vVar5 = { StackVal, StackVal, Function_66(Global_34573) };
...
int Function_61(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2803 / 10243
{
...
bool Function_62() //Position: 0x28B9 / 10425
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_63(bool bParam0) //Position: 0x28D0 / 10448
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_64(bool bParam0) //Position: 0x28DB / 10459
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_65(bool bParam0, bool bParam1) //Position: 0x28E9 / 10473
{
...
vector3 Function_66(bool bParam0) //Position: 0x292C / 10540
{
	vector3 vVar0;
...
bool Function_67(int iParam0, bool bParam1) //Position: 0x293D / 10557
{
	bool bVar0;
	bool bVar1;
