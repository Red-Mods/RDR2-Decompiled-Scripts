...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = Function_13("crows", 0);
	Function_8(&bVar0, 1132, 10.0f, 14, 0, 0);
	Function_8(&bVar0, 1133, 10.0f, 14, 0, 0);
	bVar1 = Function_13("snakes", 0);
	Function_8(&bVar1, 1057, 8.0f, 14, 0, 0);
	...
	bVar3 = Function_13("owls", 0);
	Function_8(&bVar3, 1137, 10.0f, 49, 0, 0);
	Function_8(&bVar3, 1138, 10.0f, 49, 0, 0);
	Function_8(&bVar3, 1139, 10.0f, 49, 0, 0);
	bVar4 = Function_13("racoons", 0);
	Function_8(&bVar4, 1082, 10.0f, 49, 0, 0);
	Function_8(&bVar4, 1082, 10.0f, 49, 0, 0);
	Function_8(&bVar4, 1082, 10.0f, 49, 0, 0);
	bVar5 = Function_13("rabbits", 0);
	Function_8(&bVar5, 1078, 10.0f, 49, 0, 0);
	Function_8(&bVar5, 1078, 10.0f, 49, 0, 0);
	Function_8(&bVar5, 1078, 10.0f, 49, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar11))
	{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar0, 3E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar4, 0,00015f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar3, 5E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar5, 4E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar1, 5E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_3(bVar12, bVar6, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x119D / 4509
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0x1305 / 4869
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1371 / 4977
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x13DD / 5085
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1452 / 5202
{
	int iVar0;
	int iVar1;
...
var Function_13(int iParam0, int iParam1) //Position: 0x1497 / 5271
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0x14A4 / 5284
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0x14B0 / 5296
{
	if (!Function_4(128))
	{
		return;
