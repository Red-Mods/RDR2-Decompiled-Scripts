...
void Function_3() //Position: 0x1F9 / 505
{
	...
	Function_4(8, bLocal_13, bLocal_14, &bLocal_3, iLocal_15, 4294967295);
	return;
}
...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA21 / 2593
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x29A3 / 10659
{
...
void Function_51(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2CB1 / 11441
{
	bool bVar0;
	bool bVar1;
...
void Function_72() //Position: 0x35DD / 13789
{
	...
	iLocal_15 = CREATE_LAYOUT("mexgirlcamp01campfirelayout");
	vVar0 = { -2146,16f, 18,261f, 4964,794f };
	TELEPORT_ACTOR_WITH_HEADING(bLocal_13, vVar0, 0.0f, 1, true, 1);
	...
	if (!Function_77("MexGirl03Wagon", &bVar3, iLocal_15, 0))
	{
		bVar3 = Function_73(iLocal_15, "MexGirl03Wagon", 1199, 977, -2169,263f, 17,372f, 4944,214f, 0.0f, -3.0f, 0.0f, 1, 976, 976, 976, 4);
	}
...
bool Function_80(var uParam0, bool bParam1, int iParam2) //Position: 0x3C46 / 15430
{
...
void Function_85(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x43A9 / 17321
{
	bool bVar0;
...
bool Function_86(bool bParam0, bool bParam1) //Position: 0x43FD / 17405
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_91(int iParam0, bool bParam1) //Position: 0x45AD / 17837
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_100(int iParam0) //Position: 0x4930 / 18736
{
	bool bVar0;
	bool bVar1;
...
var Function_101(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A2A / 18986
{
	int iVar0;
	bool bVar1;
...
void Function_102(var uParam0, int iParam1) //Position: 0x4A62 / 19042
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_103(var uParam0, bool bParam1, int iParam2) //Position: 0x4A73 / 19059
{
	int iVar0;
...
bool Function_104(int iParam0) //Position: 0x4B37 / 19255
{
	int iVar0;
	int iVar1;
...
void Function_105() //Position: 0x4EB2 / 20146
{
	if (!Function_152(128))
	{
		return;
...
bool Function_106() //Position: 0x4EF2 / 20210
{
	int iVar0;
...
void Function_107() //Position: 0x4F1D / 20253
{
	if (!Function_152(128))
	{
		return;
...
void Function_108(int iParam0, bool bParam1) //Position: 0x4F5F / 20319
{
	char* cVar0[32];
...
void Function_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4FE3 / 20451
{
	var uVar0;
	var uVar1;
...
void Function_110(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x500C / 20492
{
...
var Function_111(var uParam0, bool bParam1) //Position: 0x505D / 20573
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_112() //Position: 0x506D / 20589
{
	return "PackedGrass";
}

var Function_113(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5081 / 20609
{
	int iVar0;
...
var Function_114() //Position: 0x50A6 / 20646
{
	return "PackedMetadata";
}

void Function_115(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x50BD / 20669
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_116() //Position: 0x51E3 / 20963
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_117() //Position: 0x51F4 / 20980
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_118() //Position: 0x5205 / 20997
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_119(var uParam0, int iParam1) //Position: 0x5216 / 21014
{
...
var Function_120(var uParam0, int iParam1, bool bParam2) //Position: 0x5239 / 21049
{
	int iVar0;
...
var Function_121(bool bParam0) //Position: 0x5258 / 21080
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_122() //Position: 0x5264 / 21092
{
	return Function_123(39);
}

int Function_123(int iParam0) //Position: 0x526F / 21103
{
	int iVar0;
...
var Function_124() //Position: 0x529D / 21149
{
	return "PackedWeapon";
}

int Function_125(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x52B2 / 21170
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_126() //Position: 0x53B6 / 21430
{
	return "MPItemGiver";
}

struct<32> Function_127(bool bParam0) //Position: 0x53CA / 21450
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_128(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5434 / 21556
{
	char* cVar0[32];
...
var Function_129() //Position: 0x5453 / 21587
{
	return "PBox_";
}

var Function_130() //Position: 0x5461 / 21601
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_131() //Position: 0x5487 / 21639
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_132() //Position: 0x54AF / 21679
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_133(var uParam0, int iParam1) //Position: 0x54D5 / 21717
{
	int iVar0;
	var uVar1;
...
void Function_134(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5636 / 22070
{
	struct<8> Var0;
...
int Function_135(bool bParam0) //Position: 0x56D1 / 22225
{
	int iVar0;
	vector3 vVar1;
...
void Function_136(int iParam0) //Position: 0x5832 / 22578
{
...
var Function_137() //Position: 0x5893 / 22675
{
	int iVar0;
...
var Function_138(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x589B / 22683
{
	return Function_139(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_139(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x58B4 / 22708
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_140(int iParam0) //Position: 0x5BA7 / 23463
{
	int iVar0;
...
void Function_141() //Position: 0x5C5B / 23643
{
	int iVar0;
...
bool Function_142(bool bParam0) //Position: 0x5C95 / 23701
{
	int iVar0;
...
void Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5CC2 / 23746
{
	bool bVar0;
...
void Function_144() //Position: 0x5E13 / 24083
{
	int iVar0;
...
var Function_145(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5E5E / 24158
{
	int iVar0;
...
int Function_146() //Position: 0x5F2E / 24366
{
	int iVar0;
...
int Function_147() //Position: 0x608A / 24714
{
	int iVar0;
...
bool Function_148(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x61AA / 25002
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_149(var uParam0, int iParam1) //Position: 0x627A / 25210
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_150(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6298 / 25240
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_151(bool bParam0) //Position: 0x63CA / 25546
{
	bool bVar0;
...
bool Function_152(int iParam0) //Position: 0x63E9 / 25577
{
	int iVar0;
...
int Function_153() //Position: 0x6405 / 25605
{
	if (Function_155())
	{
...
int Function_154() //Position: 0x641E / 25630
{
	return Global_79349.f_16;
}

bool Function_155() //Position: 0x642A / 25642
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_156(int iParam0, bool bParam1, bool bParam2) //Position: 0x6433 / 25651
{
	var uVar0;
