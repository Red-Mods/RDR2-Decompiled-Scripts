...
void main() //Position: 0x0 / 0
{
	...
	Function_16("Loading Diez Coronas population file", 3);
	Global_30839++;
	...
	Function_12(&(Global_30750[5]), 1081, 9.0f, 0, 0);
	Function_9(&(Global_30750[5]), 1059, 3.0f, 15, 1, 0);
	bVar0 = Function_14("critter_pop", 0);
	Function_9(&bVar0, 1059, 2.0f, 14, 1, 0);
	...
	Function_12(&(Global_30750[10]), 1052, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1119, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1119, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1120, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1065, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1066, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1067, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1113, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1113, 1.0f, 0, 0);
	Function_12(&(Global_30750[10]), 1112, 1.0f, 0, 0);
	...
	Function_12(&(Global_30750[11]), 1050, 2.0f, 0, 0);
	Function_12(&(Global_30750[11]), 1050, 1.0f, 0, 0);
	Function_12(&(Global_30750[11]), 1051, 1.0f, 0, 0);
	Function_12(&(Global_30750[11]), 1052, 1.0f, 0, 0);
	Function_12(&(Global_30750[11]), 1052, 1.0f, 0, 0);
	...
	bVar3 = Function_14("deer_pop", 0);
	Function_12(&bVar3, 1119, 4.0f, 0, 0);
	Function_12(&bVar3, 1119, 4.0f, 0, 0);
	Function_12(&bVar3, 1120, 4.0f, 0, 0);
	Function_12(&bVar3, 1116, 1.0f, 0, 0);
	Function_12(&bVar3, 1117, 1.0f, 0, 0);
	Function_12(&bVar3, 1116, 1.0f, 0, 0);
	bVar4 = Function_14("animal_duck", 0);
	Function_12(&bVar4, 1140, 100.0f, 0, 0);
	Function_12(&bVar4, 1140, 100.0f, 0, 0);
	Function_12(&bVar4, 1140, 100.0f, 0, 0);
	...
	Function_9(&(Global_30750[7]), 1137, 6.0f, 33, 0, 0);
	...
	bVar12 = Function_14("crow", 0);
	Function_9(&bVar12, 1131, 6.0f, 14, 0, 0);
	bVar13 = Function_14("nsmallbird", 0);
	Function_9(&bVar13, 1135, 2.0f, 15, 0, 0);
	Function_9(&bVar13, 1136, 2.0f, 15, 0, 0);
	Function_9(&bVar13, 1136, 2.0f, 15, 0, 0);
	Function_9(&bVar13, 1137, 2.0f, 33, 0, 0);
	...
	bVar14 = Function_14("wildHorses", 1);
	Function_12(&bVar14, 987, 8.0f, 0, 0);
	Function_12(&bVar14, 988, 8.0f, 0, 0);
	Function_12(&bVar14, 982, 16.0f, 0, 0);
	Function_12(&bVar14, 997, 8.0f, 0, 0);
	Function_12(&bVar14, 998, 8.0f, 0, 0);
	...
	Function_12(&(Global_30750[3]), 499, 10.0f, 0, 0);
	Function_12(&(Global_30750[3]), 500, 10.0f, 0, 0);
	Function_12(&(Global_30750[3]), 501, 10.0f, 0, 0);
	Function_12(&(Global_30750[3]), 502, 10.0f, 0, 0);
	Function_12(&(Global_30750[3]), 503, 10.0f, 0, 0);
	Function_12(&(Global_30750[3]), 504, 10.0f, 0, 0);
	...
	Function_12(&(Global_30750[4]), 409, 10.0f, 0, 0);
	Function_12(&(Global_30750[4]), 410, 10.0f, 0, 0);
	Function_12(&(Global_30750[4]), 411, 10.0f, 0, 0);
	Function_12(&(Global_30750[4]), 412, 10.0f, 0, 0);
	Function_12(&(Global_30750[4]), 413, 10.0f, 0, 0);
	Function_12(&(Global_30750[4]), 414, 10.0f, 0, 0);
	Function_15(&(Global_30750[9]));
	Global_30750[9] = Function_14("ped_vehicle", 1);
	Function_12(&(Global_30750[9]), 1185, 1.0f, 0, 0);
	Function_12(&(Global_30750[9]), 1184, 1.0f, 0, 0);
	...
	bVar15 = FIND_NAMED_LAYOUT("DiezCoronas_layout");
	if (IS_LAYOUTREF_VALID(bVar15))
	{
		bVar16 = FIND_VOLUME_IN_LAYOUT(bVar15, "dzcv_flk_CENTER_set");
		if (IS_VOLUME_VALID(bVar16))
		{
			...
			uVar18 = Function_3(bVar16, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar19 = Function_3(bVar16, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar20 = Function_3(bVar16, bVar3, 2,1E-05f, 0, 0, 1);
			...
			uVar21 = Function_3(bVar16, bVar0, 4,5E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar21, 2);
			uVar22 = Function_3(bVar16, bVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar22, 2);
			uVar23 = Function_3(bVar16, bVar8, 6E-05f, 0, 0, 1);
		...
		bVar16 = FIND_VOLUME_IN_LAYOUT(bVar15, "dzcv_flk_SOUTH_set");
		if (IS_VOLUME_VALID(bVar16))
		{
			if (!Function_4())
			{
			...
			uVar25 = Function_3(bVar16, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar26 = Function_3(bVar16, bVar6, 3E-05f, 0, 0, 1);
			...
			uVar27 = Function_3(bVar16, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar28 = Function_3(bVar16, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(bVar16, bVar0, 4,5E-05f, 0, 0, 1);
		...
		bVar16 = FIND_VOLUME_IN_LAYOUT(bVar15, "dzcv_flk_NORTH_set");
		if (IS_VOLUME_VALID(bVar16))
		{
			if (!Function_4())
			{
			...
			uVar34 = Function_3(bVar16, bVar1, 2,7E-05f, 0, 0, 1);
			...
			uVar35 = Function_3(bVar16, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar36 = Function_3(bVar16, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar37 = Function_3(bVar16, bVar3, 2,1E-05f, 0, 0, 1);
			...
			uVar38 = Function_3(bVar16, bVar2, 2,1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar38, 1);
			uVar39 = Function_3(bVar16, bVar0, 4,5E-05f, 0, 0, 1);
			...
			uVar41 = Function_3(bVar16, bVar8, 6E-05f, 0, 0, 1);
		...
		bVar16 = FIND_VOLUME_IN_LAYOUT(bVar15, "dzcv_flk_BIRD_set");
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_3(bVar16, bVar10, 6E-05f, 0, 0, 1);
			Function_3(bVar16, bVar11, 9E-05f, 0, 0, 1);
			Function_3(bVar16, bVar12, 6E-05f, 0, 0, 1);
			Function_3(bVar16, bVar13, 0,00012f, 0, 0, 1);
		}
		else
		{
			LOG_ERROR("cho_pop: Cannot find dzcv_flk_BIRD_set to create population volumes");
		}
		bVar16 = FIND_VOLUME_IN_LAYOUT(bVar15, "dzcv_aquaticWildlife_set");
		if (IS_VOLUME_VALID(bVar16))
		{
			Function_3(bVar16, bVar4, 0,00024f, 0, 0, 1);
			Function_3(bVar16, bVar8, 6E-05f, 0, 0, 1);
			Function_3(bVar16, bVar0, 4,5E-05f, 0, 0, 1);
	...
	Function_6("Finished loading Diez Coronas population file", 5.0f);
	Function_1(&(Global_29008[Local_0]), 64);
	TERMINATE_THIS_SCRIPT();
	return;
}

void Function_1(var uParam0, var uParam1) //Position: 0x192F / 6447
{
	*uParam0 = (*uParam0 || uParam1);
	return;
}

bool Function_2() //Position: 0x193E / 6462
{
	int iVar0;
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1993 / 6547
{
	bool bVar0;
...
bool Function_4() //Position: 0x1A13 / 6675
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_5(int iParam0) //Position: 0x1A1C / 6684
{
	int iVar0;
...
void Function_6(bool bParam0, float fParam1) //Position: 0x1A38 / 6712
{
	if (!Function_5(128))
	{
		return;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x1A76 / 6774
{
	int iVar0;
...
void Function_8(var uParam0, bool bParam1) //Position: 0x1A92 / 6802
{
...
var Function_9(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1AA2 / 6818
{
...
var Function_10(int iParam0) //Position: 0x1B04 / 6916
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1B70 / 7024
{
	bool bVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1BDC / 7132
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1C51 / 7249
{
	int iVar0;
	int iVar1;
...
var Function_14(int iParam0, int iParam1) //Position: 0x1C96 / 7318
{
	return CREATE_NAMED_POPULATION_SET(iParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0x1CA3 / 7331
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0x1CAF / 7343
{
	if (!Function_5(128))
	{
		return;
