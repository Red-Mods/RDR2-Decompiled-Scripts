...
void main() //Position: 0x0 / 0
{
	...
	switch (StackVal)
	{
		...
		case 0x00000004:
			iVar0 = 0;
			iLocal_194 = 1000;
			Function_151(&bLocal_201, "$/content/scripting/gringo/SimpleGringo/money_handoff", 1, 0);
			Function_151(&bLocal_201, "money_handoff", 5, 0);
			Function_151(&bLocal_201, "RandomCharMissions", 10, 0);
			bLocal_190 = true;
			while (!IS_EXITFLAG_SET())
			{
				bLocal_191 = Global_63541[5955].f_204;
				switch (iVar0)
				{
					case 0x00000000:
						if (!Function_148(&(Global_63541[ScriptParam_055]), 59, 0, 1))
						{
							Function_147(&Global_63541[ScriptParam_055] + 144, 64);
							Function_145(&(Global_63541[ScriptParam_055]), 59, 0, 1, 1);
							iVar0 = 13;
						}
						else if (Function_140(&bLocal_201) && IS_ACTOR_VALID(bLocal_191))
						{
							if (IS_LAYOUTREF_VALID(bLocal_188))
							{
								bLocal_189 = FIND_OBJECT_IN_LAYOUT(bLocal_188, "Politician3Handover");
								bLocal_192 = FIND_VOLUME_IN_LAYOUT(bLocal_188, "Politician3Vol");
								if (!IS_OBJECT_VALID(bLocal_189))
								{
									bLocal_189 = CREATE_GRINGO_IN_LAYOUT(bLocal_188, "Politician3Handover", "$/content/scripting/gringo/SimpleGringo/money_handoff", *(&Global_63541[5955] + 100), 0.0f, 225,3f, 0.0f);
								}
								if (!IS_VOLUME_VALID(bLocal_192))
								{
									bLocal_192 = CREATE_VOLUME_IN_LAYOUT(bLocal_188, "Politician3Vol", 2, *(&Global_63541[5955] + 100), 0.0f, 0.0f, 0.0f, 8.0f, 8.0f, 8.0f);
								}
								SET_ACTOR_CAN_PLAY_GESTURES(bLocal_191, false);
								if ((IS_ACTOR_VALID(bLocal_191) && IS_GRINGO_VALID(GET_GRINGO_FROM_OBJECT(bLocal_189))) && IS_VOLUME_VALID(bLocal_192))
								{
									iVar0 = 1;
								}
							}
							...
							{
								Function_138();
								bLocal_188 = bLocal_211;
							}
							else
							{
								bLocal_188 = FIND_NAMED_LAYOUT("Politician_layout");
							}
						}
						break;
					...
					case 0x00000001:
						...
						else if (IS_ACTOR_VALID(bLocal_191))
						{
							if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
							{
								if (IS_SCRIPT_USE_CONTEXT_VALID(Global_63541[ScriptParam_055].f_200) && Global_74542[ScriptParam_010] != 5)
								{
									...
									{
										if ((StackVal && FABS((StackVal - !Function_134(Global_34573, 0, 1))) > 2.0f) && IS_SCRIPT_USE_CONTEXT_PRESSED(Global_63541[ScriptParam_055].f_200))
										{
											if (!IS_ANY_SPEECH_PLAYING(bLocal_191))
											{
								...
								else if (((!IS_SCRIPT_USE_CONTEXT_VALID(Global_63541[ScriptParam_055].f_200) && HAS_STRING_TABLE_LOADED("RandomCharMissions")) && IS_LAYOUTREF_VALID(bLocal_188)) && !Function_134(Global_34573, 0, 1))
								{
								...
								else if (Function_134(Global_34573, 0, 1) && IS_SCRIPT_USE_CONTEXT_VALID(Global_63541[ScriptParam_055].f_200))
								{
									RELEASE_SCRIPT_USE_CONTEXT(Global_63541[ScriptParam_055].f_200);
								}
							}
					...
					case 0x00000003:
						if (MAKE_ACTOR_READY_FOR_ACTION(Global_34573, 1) && MAKE_ACTOR_READY_FOR_ACTION(bLocal_191, 1))
						{
							iVar0 = 5;
						}
						break;
					...
					case 0x00000005:
						if (Function_111(&uLocal_193))
						{
							Global_3412 = 1;
							Global_3416 = 7;
							Function_108(Function_109(1, 1, 1, 0, 0), 1);
							Function_107("Politician_END", 7,5f, 0, 2, 0, 0, 0);
							...
							Function_8(&Global_63541[5755] + 144, 256);
							iVar0 = 13;
						}
						break;
				}
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x4AF / 1199
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x4CA / 1226
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x4E7 / 1255
{
	RELEASE_LAYOUT_REF(bLocal_211);
	return;
}

void Function_4(int iParam0) //Position: 0x4F2 / 1266
{
	int iVar0;
...
void Function_5(var uParam0, int iParam1) //Position: 0x518 / 1304
{
...
void Function_6(var uParam0, int iParam1) //Position: 0x646 / 1606
{
	int iVar0;
...
bool Function_7(var uParam0, int iParam1) //Position: 0x660 / 1632
{
	int iVar0;
...
void Function_8(var uParam0, int iParam1) //Position: 0x67D / 1661
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_9() //Position: 0x68C / 1676
{
	bool bVar0;
	bool bVar1;
...
void Function_10(bool bParam0) //Position: 0x6BD / 1725
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_11(int iParam0, int iParam1) //Position: 0x85F / 2143
{
	int iVar0;
	bool bVar1;
...
void Function_12(int iParam0) //Position: 0x919 / 2329
{
	float fVar0;
	bool bVar1;
...
int Function_13(var uParam0, int iParam1) //Position: 0x9BB / 2491
{
	int iVar0;
	var uVar1;
...
void Function_14(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xB1C / 2844
{
	struct<8> Var0;
...
struct<32> Function_15(bool bParam0) //Position: 0xBB7 / 2999
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_16(char* cParam0, char* cParam1, char* cParam2) //Position: 0xC21 / 3105
{
	char* cVar0[32];
...
int Function_17(bool bParam0) //Position: 0xC40 / 3136
{
	int iVar0;
	vector3 vVar1;
...
float Function_18(bool bParam0, vector3 vParam1) //Position: 0xDA1 / 3489
{
	vector3 vVar0;
...
vector3 Function_19(bool bParam0) //Position: 0xE1B / 3611
{
	vector3 vVar0;
...
void Function_20(int iParam0) //Position: 0xE85 / 3717
{
...
bool Function_21(int iParam0) //Position: 0xEE6 / 3814
{
...
var Function_22() //Position: 0xEFC / 3836
{
	int iVar0;
...
void Function_23(int iParam0, int iParam1) //Position: 0xF04 / 3844
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_24(bool bParam0) //Position: 0x1049 / 4169
{
...
var Function_25(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x1075 / 4213
{
	return CAMERA_IS_VISIBLE_POINT(GET_GAME_CAMERA(), vParam0, iParam3, iParam4, iParam5, iParam6, uParam7);
}

bool Function_26(int iParam0) //Position: 0x1091 / 4241
{
...
bool Function_27(int iParam0, int iParam1) //Position: 0x10A6 / 4262
{
...
bool Function_28(int iParam0, int iParam1) //Position: 0x11BB / 4539
{
	int iVar0;
...
bool Function_30(int iParam0) //Position: 0x1323 / 4899
{
...
bool Function_31(int iParam0) //Position: 0x1338 / 4920
{
...
var Function_32(int iParam0) //Position: 0x134F / 4943
{
...
bool Function_33(int iParam0) //Position: 0x1369 / 4969
{
...
bool Function_34(int iParam0) //Position: 0x137F / 4991
{
	return StackVal;
}

bool Function_35(var uParam0, int iParam1) //Position: 0x138F / 5007
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0x13AB / 5035
{
	if (!iParam0->f_152)
	{
...
bool Function_37(int iParam0) //Position: 0x13F2 / 5106
{
...
void Function_38(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x144B / 5195
{
	bool bVar0;
	char* cVar1[16];
...
void Function_39(char* cParam0, int iParam1) //Position: 0x14B7 / 5303
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_40(bool bParam0, var uParam1, int iParam2) //Position: 0x14EE / 5358
{
	var uVar0;
	char* cVar1[16];
...
int Function_41(char* cParam0) //Position: 0x1566 / 5478
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_42(int iParam0) //Position: 0x1607 / 5639
{
	int iVar0;
	int iVar1;
...
bool Function_43(var uParam0, int iParam1) //Position: 0x1644 / 5700
{
...
bool Function_44(int iParam0) //Position: 0x1657 / 5719
{
	int iVar0;
...
bool Function_45(var uParam0, int iParam1) //Position: 0x1673 / 5747
{
	int iVar0;
...
int Function_46(int iParam0) //Position: 0x168F / 5775
{
...
bool Function_47(int iParam0) //Position: 0x16A4 / 5796
{
...
int Function_48(int iParam0) //Position: 0x16B9 / 5817
{
...
bool Function_49(var uParam0, bool bParam1) //Position: 0x16CE / 5838
{
	return (uParam0 && bParam1) == 0;
}

void Function_50() //Position: 0x16DB / 5851
{
...
var Function_51(int iParam0, int iParam1) //Position: 0x1756 / 5974
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
bool Function_52(vector3 vParam0) //Position: 0x2347 / 9031
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_53(int iParam0, bool bParam1) //Position: 0x235F / 9055
{
	int iVar0;
...
int Function_54(int iParam0) //Position: 0x239C / 9116
{
	int iVar0;
	int iVar1;
...
bool Function_55(int iParam0) //Position: 0x23EB / 9195
{
...
int Function_56(int iParam0) //Position: 0x2401 / 9217
{
...
void Function_57() //Position: 0x246A / 9322
{
...
bool Function_58(int iParam0) //Position: 0x248D / 9357
{
	if (!Function_55(iParam0))
	{
...
bool Function_59(int iParam0, int iParam1) //Position: 0x24DE / 9438
{
	int iVar0;
...
bool Function_60(int iParam0) //Position: 0x250B / 9483
{
	if (!Function_55(iParam0))
	{
...
bool Function_61() //Position: 0x255D / 9565
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_62(bool bParam0) //Position: 0x2566 / 9574
{
	bool bVar0;
...
void Function_63(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x25A0 / 9632
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	Function_147(&Global_63541[iParam055] + 144, 64);
...
void Function_64(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x2AD5 / 10965
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_65() //Position: 0x2C48 / 11336
{
	return;
}

void Function_66(var uParam0, int iParam1) //Position: 0x2C4E / 11342
{
	if (Global_3381)
	{
		return;
...
void Function_67(bool bParam0) //Position: 0x2C90 / 11408
{
...
void Function_68() //Position: 0x2CE1 / 11489
{
	Function_95();
	Function_94();
	Function_94();
...
void Function_69() //Position: 0x2D14 / 11540
{
...
void Function_70() //Position: 0x2E1A / 11802
{
	float fVar0;
...
void Function_71() //Position: 0x2E4D / 11853
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_72() //Position: 0x2FDB / 12251
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_73() //Position: 0x318F / 12687
{
	Function_74(&Global_28260, 1, 0);
	return;
}

void Function_74(int iParam0, bool bParam1, var uParam2) //Position: 0x319D / 12701
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_75() //Position: 0x338E / 13198
{
...
struct<8> Function_76() //Position: 0x33A3 / 13219
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_77(int iParam0, bool bParam1, bool bParam2) //Position: 0x343E / 13374
{
	int iVar0;
...
void Function_78(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x36D9 / 14041
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_79(int iParam0) //Position: 0x3D06 / 15622
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_80(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3D17 / 15639
{
	char* cVar0[32];
...
struct<32> Function_81(char* cParam0, char* cParam1) //Position: 0x3E0C / 15884
{
	char* cVar0[32];
...
void Function_82(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3E25 / 15909
{
	float fVar0;
...
var Function_83(int iParam0, int iParam1) //Position: 0x3E8A / 16010
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_84(int iParam0, bool bParam1) //Position: 0x3E9C / 16028
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_85(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3EAE / 16046
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_86(int iParam0) //Position: 0x3FDE / 16350
{
	return Global_35278[iParam020].f_48;
}

float Function_87(int iParam0) //Position: 0x3FED / 16365
{
	if (!iParam0 != 4294967295)
	{
...
var Function_88(int iParam0) //Position: 0x4027 / 16423
{
	if (iParam0 == 4294967295)
	{
...
void Function_89(int iParam0) //Position: 0x4064 / 16484
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_90(int iParam0, bool bParam1, bool bParam2) //Position: 0x41FE / 16894
{
	int iVar0;
	int iVar1;
...
int Function_91(bool bParam0) //Position: 0x4418 / 17432
{
...
struct<8> Function_92() //Position: 0x4459 / 17497
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_93() //Position: 0x44E2 / 17634
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_94() //Position: 0x4579 / 17785
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_95() //Position: 0x45F8 / 17912
{
...
int Function_96(int iParam0, bool bParam1, int iParam2) //Position: 0x461E / 17950
{
	int iVar0;
	int iVar1;
...
void Function_97() //Position: 0x4828 / 18472
{
	vector3 vVar0;
	var uVar3;
...
vector3 Function_98(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x48C9 / 18633
{
	int iVar0;
...
vector3 Function_99() //Position: 0x49B0 / 18864
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_100(int iParam0) //Position: 0x49B9 / 18873
{
...
int Function_101(bool bParam0, bool bParam1) //Position: 0x49CF / 18895
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_102(vector3 vParam0, vector3 vParam3) //Position: 0x4A96 / 19094
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_103(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x4AB3 / 19123
{
	uParam0 = uParam0;
...
void Function_104() //Position: 0x4B57 / 19287
{
	bool bVar0;
...
void Function_105(bool bParam0) //Position: 0x4BB5 / 19381
{
	PRINTSTRING("Day ");
...
int Function_106(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x4BFB / 19451
{
	int iVar0;
	int iVar1;
...
void Function_107(bool bParam0, float fParam1, bool bParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x4E1B / 19995
{
	int iVar0;
...
int Function_108(bool bParam0, bool bParam1) //Position: 0x4E6E / 20078
{
	bool bVar0;
...
var Function_109(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x4F39 / 20281
{
	bool bVar0;
...
var Function_110(bool bParam0) //Position: 0x503B / 20539
{
	bool bVar0;
...
bool Function_111(bool bParam0) //Position: 0x512C / 20780
{
	Function_132(&iLocal_194, 1, 0);
	switch (iLocal_194)
	{
		case 0x000003E8:
			Function_128(1, 0, 1, 1, 1, 1, 1, bLocal_192, 1, 1, 1, 1);
			Function_126(StackVal, StackVal, bLocal_188, *(&Global_63541[5955] + 112), &bLocal_192, 0, 0, 0, 0, 1, 1);
			Function_125(Global_34573, 1, 1);
			Function_125(bLocal_191, 1, 1);
			*bParam0 = Function_121(bLocal_211, 0, 1, 0, 0);
			TASK_USE_GRINGO(bLocal_191, GET_GRINGO_FROM_OBJECT(bLocal_189), "UseCase1", true, 1);
			SNAP_ACTOR_TO_GRINGO(bLocal_191, bLocal_189, "UseCase1", false, 0, 0);
			TASK_USE_GRINGO(Global_34573, GET_GRINGO_FROM_OBJECT(bLocal_189), "handoff", true, 1);
			SNAP_ACTOR_TO_GRINGO(Global_34573, bLocal_189, "handoff", false, 0, 0);
			Function_120(&iLocal_194 + 4);
			Function_118(&iLocal_194 + 4);
			iLocal_194 = 1104;
			break;
		
		case 0x00000450:
			if (Function_117(&iLocal_194 + 4))
			{
				if (Function_115(&iLocal_194 + 4) <= 5.0f)
				{
					Function_125(Global_34573, 0, 1);
					Function_125(bLocal_191, 0, 1);
					RESET_ANIM_SET_FOR_ACTOR(Global_34573, 0);
					RESET_ANIM_SET_FOR_ACTOR(bLocal_191, 0);
					TASK_WANDER(bLocal_191, -1.0f);
					REMOVE_AMBIENT_MOVE_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_192);
					REMOVE_AMBIENT_SPAWN_RESTRICTION_STAY_OUTSIDE_OF_VOLUME(bLocal_192);
					SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(bLocal_191, 0);
					SET_ACTOR_EXEMPT_FROM_AMBIENT_RESTRICTIONS(Global_34573, 0);
					AI_STOP_IGNORING_ACTORS();
					Function_112(1, 0, 1, 1, 0, 1, 0, 1, 1, 1);
					ENABLE_USE_CONTEXTS(1);
					DESTROY_VOLUME(bLocal_192);
					if (HUD_IS_FADED())
					{
...
void Function_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, var uParam9) //Position: 0x529E / 21150
{
	bool bVar0;
	...
	Function_113(uParam9);
}

void Function_113(bool bParam0) //Position: 0x538E / 21390
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
...
void Function_114() //Position: 0x5433 / 21555
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
float Function_115(int iParam0) //Position: 0x5448 / 21576
{
...
bool Function_116(int iParam0) //Position: 0x5510 / 21776
{
	return Function_49(*iParam0, 2);
}

bool Function_117(int iParam0) //Position: 0x551D / 21789
{
	return Function_49(*iParam0, 1);
}

void Function_118(int iParam0) //Position: 0x552A / 21802
{
	Function_119(iParam0, 0.0f);
	return;
}

void Function_119(var uParam0, float fParam1) //Position: 0x5536 / 21814
{
...
void Function_120(int iParam0) //Position: 0x5557 / 21847
{
	if (!Function_117(iParam0))
	{
		Function_119(iParam0, 0.0f);
...
var Function_121(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x556C / 21868
{
	bool bVar0;
	
	if (bParam2)
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, Function_22(), 2, 1);
	}
	else
	{
		bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(bParam0, "RCM_Politician3_1", 2, 1);
	}
	Function_122(&bVar0);
...
void Function_122(int iParam0) //Position: 0x55E9 / 21993
{
	bool bVar0;
...
void Function_123(int iParam0) //Position: 0x561E / 22046
{
	...
	SET_CAMERASHOT_POSITION(*iParam0, 741,1596f, 80,5979f, 1217,719f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0,007212f, 2,717844f, 0,000306f, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_124(int iParam0) //Position: 0x5685 / 22149
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 36,27574f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
	SET_CAMERASHOT_COLLISION_PARAMETERS(*iParam0, 0,3f, 1);
	SET_CAMERASHOT_COLLISION_ENABLED(*iParam0, 0);
	SET_CAMERASHOT_POSITION(*iParam0, 739,5024f, 80,59855f, 1217,244f);
	SET_CAMERASHOT_ORIENTATION(*iParam0, -0,009873f, 3,134097f, 0,000306f, 1);
	RESET_CAMERASHOT_TARGETDOF(*iParam0);
	return;
}

void Function_125(bool bParam0, bool bParam1, bool bParam2) //Position: 0x56EC / 22252
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return;
...
void Function_126(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x5786 / 22406
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_127(bool bParam0, bool bParam1) //Position: 0x59F4 / 23028
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_128(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x5A69 / 23145
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_131(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_22(), 2, Function_131(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
	...
	CLEAR_TUMBLEWEEDS();
	if ((IS_OBJECT_VALID(Function_130()) || DECOR_CHECK_EXIST(Global_34573, "BinocularsStart")) || UNK_0x4417C9F2("$content/scripting/gringo/ItemScripts/Binoculars"))
	{
		DESTROY_CAMERA(GET_CAMERA_FROM_OBJECT(Function_130()));
...
void Function_129(int iParam0) //Position: 0x5D12 / 23826
{
	int iVar0;
...
var Function_130() //Position: 0x5D46 / 23878
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
vector3 Function_131(bool bParam0) //Position: 0x5DC5 / 24005
{
	vector3 vVar0;
...
void Function_132(var uParam0, bool bParam1, bool bParam2) //Position: 0x5DD6 / 24022
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
void Function_133(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5F22 / 24354
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
bool Function_134(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5F4B / 24395
{
...
bool Function_135() //Position: 0x6001 / 24577
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_136(bool bParam0) //Position: 0x6018 / 24600
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_137(bool bParam0) //Position: 0x6023 / 24611
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

void Function_138() //Position: 0x6031 / 24625
{
	var uVar0;
	
	Function_139(4, 1);
	uVar0 = uVar0;
	bLocal_211 = CREATE_LAYOUT("Politician_layout");
	return;
}

void Function_139(int iParam0, int iParam1) //Position: 0x6059 / 24665
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_140(int iParam0) //Position: 0x60A2 / 24738
{
	int iVar0;
	int iVar1;
...
void Function_141() //Position: 0x641D / 25629
{
	if (!Function_44(128))
	{
		return;
...
bool Function_142() //Position: 0x645D / 25693
{
	int iVar0;
...
void Function_143(var uParam0, int iParam1) //Position: 0x6488 / 25736
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_144() //Position: 0x6499 / 25753
{
	if (!Function_44(128))
	{
		return;
...
void Function_145(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x64DB / 25819
{
...
void Function_146(int iParam0) //Position: 0x6685 / 26245
{
	if (Function_49(iParam0->f_144, 1))
	{
		STREAMING_EVICT_ACTOR(iParam0->f_136, 4294967295);
		Function_147(iParam0 + 144, 1);
	}
	if (Function_49(iParam0->f_144, 8))
	{
		REMOVE_STRING_TABLE("RandomCharMissions");
		Function_147(iParam0 + 144, 8);
	}
	if (Function_49(iParam0->f_144, 2))
	{
		STREAMING_EVICT_GRINGO(iParam0->f_60);
		Function_147(iParam0 + 144, 2);
	}
	if (Function_49(iParam0->f_144, 4))
	{
		STREAMING_EVICT_PROP(iParam0->f_64);
		Function_147(iParam0 + 144, 4);
	}
	return;
}

void Function_147(int iParam0, int iParam1) //Position: 0x6707 / 26375
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

bool Function_148(int iParam0, int iParam1, bool bParam2, int iParam3) //Position: 0x671A / 26394
{
	if (!iParam0->f_172 != 0)
	{
		if (Function_35(iParam0 + 172, 4))
		...
		if (Function_35(iParam0 + 172, 8) && Global_3365)
		{
			if (!Function_150(iParam0->f_164, 0))
			{
				return 0;
			}
		}
...
int Function_149(int iParam0) //Position: 0x67CE / 26574
{
	if (!iParam0->f_172 != 0)
	{
		switch (Global_63399)
...
bool Function_150(int iParam0, bool bParam1) //Position: 0x687A / 26746
{
...
var Function_151(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x68B0 / 26800
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_152(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_152(var uParam0, int iParam1, int iParam2) //Position: 0x68E8 / 26856
{
	int iVar0;
