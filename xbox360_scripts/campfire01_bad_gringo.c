...
void main() //Position: 0x0 / 0
{
	...
	*(&iVar3 + 228) = 2;
	...
	while (((IS_GRINGO_ACTIVE() && !IS_EXITFLAG_SET()) && !HUD_IS_FADED()) && !HUD_IS_FADING())
	{
		if (bVar2)
		{
			bVar0 = Function_9(&iVar3, GRINGO_GET_MY_OBJECT_REF(), 0, bVar1, 0, 0, "ped_bad_guys_generic", 2,5f, 1, 0x43160000);
		}
		if (!IS_EXITFLAG_SET())
		{
			GRINGO_WAIT(bVar0);
...
var Function_64(var uParam0, bool bParam1, int iParam2) //Position: 0x2F7C / 12156
{
	int iVar0;
...
vector3 Function_78() //Position: 0x3735 / 14133
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_79() //Position: 0x3746 / 14150
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_80() //Position: 0x3757 / 14167
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_81(var uParam0, int iParam1) //Position: 0x3768 / 14184
{
...
var Function_82(var uParam0, int iParam1, int iParam2) //Position: 0x378B / 14219
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x37AA / 14250
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_84() //Position: 0x37B6 / 14262
{
	return Function_85(39);
}

int Function_85(int iParam0) //Position: 0x37C1 / 14273
{
	int iVar0;
...
var Function_86() //Position: 0x37EF / 14319
{
	return "PackedWeapon";
}

int Function_87(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x3804 / 14340
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_88() //Position: 0x3908 / 14600
{
	return "MPItemGiver";
}

struct<32> Function_89(bool bParam0) //Position: 0x391C / 14620
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3986 / 14726
{
	char* cVar0[32];
...
var Function_91() //Position: 0x39A5 / 14757
{
	return "PBox_";
}

var Function_92() //Position: 0x39B3 / 14771
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x39D9 / 14809
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x3A01 / 14849
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3A27 / 14887
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3B88 / 15240
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x3C23 / 15395
{
	int iVar0;
	vector3 vVar1;
...
void Function_98(int iParam0) //Position: 0x3D84 / 15748
{
...
var Function_99() //Position: 0x3DE5 / 15845
{
	int iVar0;
...
var Function_100(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3DED / 15853
{
	return Function_101(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_101(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x3E06 / 15878
{
	bool bVar0;
	bool bVar1;
	int iVar2;
