...
void main() //Position: 0x0 / 0
{
	...
	bVar2 = 5;
	Function_311(&bVar2, 976, 3, 0);
	Function_311(&bVar2, 1177, 3, 0);
	Function_311(&bVar2, 1194, 3, 0);
	Function_309(&bVar2, "p_gen_treeStump01x", 0, 0);
	Function_309(&bVar2, "p_gen_moneybag03x", 0, 0);
	while (!Function_304(&bVar2))
	{
		WAIT(false);
	}
	...
	GIVE_WEAPON_TO_ACTOR(bVar35, iVar36[RAND_INT_RANGE(false, 2)], false, 1, 1);
	...
	Function_300(StackVal, StackVal, bVar18, "coach1", 1177, 976, vVar25, 0.0f, 224.0f, 0.0f, 1, 976, 976, 976, 4);
	Function_300(StackVal, StackVal, bVar18, "coach2", 1177, 976, vVar28, 0.0f, 234.0f, 0.0f, 1, 976, 976, 976, 4);
...
void Function_6() //Position: 0x5F4 / 1524
{
	...
	if (Function_289(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	if (Function_288(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	if (Function_286(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	...
	if (Function_249(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	if (Function_248(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	...
	if (Function_237(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
	if (Function_235(bVar0))
	{
		RESET_LATEST_CONSOLE_COMMAND();
		return;
	}
...
void Function_19(var uParam0, int iParam1) //Position: 0xD0F / 3343
{
	int iVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0xD26 / 3366
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_21(int iParam0) //Position: 0xD35 / 3381
{
...
bool Function_22(bool bParam0) //Position: 0xD4B / 3403
{
...
bool Function_23(bool bParam0) //Position: 0xE2D / 3629
{
	char* cVar0[32];
	bool bVar8;
	vector3 vVar9;
...
bool Function_24(bool bParam0) //Position: 0xEDA / 3802
{
	bool bVar0;
	bool bVar1;
...
int Function_25(int iParam0, bool bParam1) //Position: 0xF17 / 3863
{
	bool bVar0;
	int iVar1;
...
int Function_26() //Position: 0x10A3 / 4259
{
	int iVar0;
...
void Function_27() //Position: 0x1142 / 4418
{
	int iVar0;
	int iVar1;
...
void Function_28(int iParam0) //Position: 0x11F1 / 4593
{
...
var Function_29(int iParam0, int iParam1) //Position: 0x124F / 4687
{
	int iVar0;
...
int Function_30(int iParam0, bool bParam1, bool bParam2) //Position: 0x1290 / 4752
{
	int iVar0;
	int iVar1;
...
void Function_31(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x149A / 5274
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
bool Function_32() //Position: 0x1AC7 / 6855
{
	int iVar0;
...
var Function_33(int iParam0) //Position: 0x1ACF / 6863
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_34(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1AE0 / 6880
{
	char* cVar0[32];
...
struct<32> Function_35(char* cParam0, char* cParam1) //Position: 0x1BD5 / 7125
{
	char* cVar0[32];
...
void Function_36(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1BEE / 7150
{
	float fVar0;
...
var Function_37(int iParam0, int iParam1) //Position: 0x1C53 / 7251
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
int Function_38(int iParam0, bool bParam1) //Position: 0x1C65 / 7269
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_39(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1C77 / 7287
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_40(int iParam0) //Position: 0x1DA7 / 7591
{
	return Global_35278[iParam020].f_48;
}

float Function_41(int iParam0) //Position: 0x1DB6 / 7606
{
	if (!iParam0 != 4294967295)
	{
...
float Function_42(int iParam0) //Position: 0x1DEF / 7663
{
	if (iParam0 == 4294967295)
	{
...
void Function_43(int iParam0) //Position: 0x1E2C / 7724
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_44(int iParam0, bool bParam1, bool bParam2) //Position: 0x1FC6 / 8134
{
	int iVar0;
	int iVar1;
...
bool Function_45(bool bParam0) //Position: 0x21E0 / 8672
{
	bool bVar0;
	bool bVar1;
...
bool Function_46(bool bParam0) //Position: 0x2217 / 8727
{
	bool bVar0;
	bool bVar1;
...
bool Function_47(bool bParam0) //Position: 0x2269 / 8809
{
	char* cVar0[64];
	...
	if (STRING_CONTAINS_STRING(cParam0, "pass_all"))
	{
		...
		if (IS_STRING_VALID(bParam0))
		{
			if (STRING_LENGTH(bParam0) >= 0)
			{
				...
				{
					Function_48(Function_184(0, 1, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "FORT"))
				{
					Function_48(Function_184(0, 24, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 25, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "GRAVE"))
				{
					Function_48(Function_184(0, 12, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 13, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 14, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "MARSHAL"))
				{
					Function_48(Function_184(0, 8, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 9, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 23, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 21, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "MERCHANT"))
				{
					Function_48(Function_184(0, 10, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 11, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 17, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 15, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "OUTLAW"))
				{
					Function_48(Function_184(0, 18, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 19, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 20, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "RANCH"))
				{
					Function_48(Function_184(0, 2, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 3, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 22, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 6, 1), 0, 1, 1, 0);
					Function_48(Function_184(0, 5, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "GUN"))
				{
					Function_48(Function_184(1, 30, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 33, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 32, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 31, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "MEXGIRL"))
				{
					Function_48(Function_184(1, 34, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 35, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "MEXARMY"))
				{
					Function_48(Function_184(1, 27, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 26, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 28, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 29, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 36, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "REBEL"))
				{
					Function_48(Function_184(1, 39, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 37, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 38, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 41, 1), 0, 1, 1, 0);
					Function_48(Function_184(1, 40, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "ANTHRO"))
				{
					Function_48(Function_184(2, 45, 1), 0, 1, 1, 0);
					Function_48(Function_184(2, 46, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "FBI"))
				{
					Function_48(Function_184(2, 43, 1), 0, 1, 1, 0);
					Function_48(Function_184(2, 47, 1), 0, 1, 1, 0);
					Function_48(Function_184(2, 48, 1), 0, 1, 1, 0);
					Function_48(Function_184(2, 42, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "NATIVE"))
				{
					Function_48(Function_184(2, 44, 1), 0, 1, 1, 0);
					return 1;
				}
				if (STRING_CONTAINS_STRING(&cVar0, "HOME"))
				{
					Function_48(Function_184(3, 49, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 55, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 56, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 52, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 53, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 54, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 50, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 51, 1), 0, 1, 1, 0);
					Function_48(Function_184(3, 57, 1), 0, 1, 1, 0);
					return 1;
				}
			}
		}
...
void Function_48(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x2701 / 9985
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	Function_183(12);
	Function_181(2);
	Function_179((15 - Function_180(105)));
	if (Function_178(bParam0) == 1)
	{
		iVar2 = Function_177(bParam0);
		...
		if (bParam1)
		{
			Function_106(iVar2, bParam0, bVar1);
			Function_105();
		}
	}
...
void Function_49() //Position: 0x27EE / 10222
{
	int iVar0;
...
int Function_50(int iParam0, bool bParam1) //Position: 0x281E / 10270
{
	int iVar0;
...
bool Function_51(int iParam0) //Position: 0x285B / 10331
{
...
int Function_52(int iParam0) //Position: 0x2872 / 10354
{
...
bool Function_53(int iParam0) //Position: 0x288C / 10380
{
...
void Function_54(int iParam0, bool bParam1) //Position: 0x28A2 / 10402
{
	int iVar0;
	int iVar1;
...
void Function_55(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x2B99 / 11161
{
	bool bVar0;
	char* cVar1[16];
...
void Function_56(char* cParam0, int iParam1) //Position: 0x2C05 / 11269
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_57(bool bParam0, var uParam1, int iParam2) //Position: 0x2C3C / 11324
{
	var uVar0;
	char* cVar1[16];
...
bool Function_58(var uParam0, int iParam1) //Position: 0x2CB4 / 11444
{
...
int Function_59(char* cParam0) //Position: 0x2CC7 / 11463
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_60(int iParam0) //Position: 0x2D68 / 11624
{
	int iVar0;
	int iVar1;
...
void Function_61(int iParam0, int iParam1) //Position: 0x2DA5 / 11685
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_62(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2DB8 / 11704
{
	int iVar0;
	struct<6> Var1;
	struct<4> Var7;
	...
	{
		Global_6269 = Function_177(bParam0);
		Var1 = { StackVal, StackVal, StackVal, StackVal, StackVal, Function_100(Global_6269) };
		Var7 = { StackVal, StackVal, StackVal, *(&Global_3422[Global_626940] + 12) };
		if (((Global_6269 != 11 || Global_6269 != 16) || Global_6269 != 15) || Global_6269 != 43)
		{
			Var7 = { StackVal, StackVal, StackVal, Function_99(Global_6269) };
		}
	...
	if (StackVal == 2)
	{
		Function_93("DEED_COMPLETE", bParam0);
	}
	if (bParam1)
	{
...
void Function_63(int iParam0, int iParam1) //Position: 0x2FCA / 12234
{
...
void Function_64(bool bParam0, int iParam1) //Position: 0x3004 / 12292
{
	if (Global_3381)
	{
		return;
...
void Function_65(bool bParam0) //Position: 0x3046 / 12358
{
...
void Function_66() //Position: 0x3097 / 12439
{
	Function_79();
	Function_78();
	Function_78();
...
void Function_67() //Position: 0x30CA / 12490
{
...
void Function_68() //Position: 0x31D0 / 12752
{
	float fVar0;
...
void Function_69() //Position: 0x3203 / 12803
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_70() //Position: 0x3391 / 13201
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_71() //Position: 0x3545 / 13637
{
	Function_72(&Global_28260, 1, 0);
	return;
}

void Function_72(int iParam0, bool bParam1, var uParam2) //Position: 0x3553 / 13651
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_73() //Position: 0x3744 / 14148
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_74(int iParam0, bool bParam1, bool bParam2) //Position: 0x37DF / 14303
{
	int iVar0;
...
int Function_75(bool bParam0) //Position: 0x3A7A / 14970
{
...
struct<8> Function_76() //Position: 0x3ABB / 15035
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_77() //Position: 0x3B44 / 15172
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_78() //Position: 0x3BDB / 15323
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_79() //Position: 0x3C5A / 15450
{
...
void Function_80() //Position: 0x3C80 / 15488
{
	vector3 vVar0;
	var uVar3;
...
bool Function_81(vector3 vParam0) //Position: 0x3D21 / 15649
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_82(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x3D39 / 15673
{
	int iVar0;
...
vector3 Function_83() //Position: 0x3E20 / 15904
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_84(var uParam0, int iParam1) //Position: 0x3E29 / 15913
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_85(int iParam0) //Position: 0x3E38 / 15928
{
...
int Function_86(bool bParam0, bool bParam1) //Position: 0x3E4E / 15950
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_87(vector3 vParam0, vector3 vParam3) //Position: 0x3F15 / 16149
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
void Function_88(bool bParam0) //Position: 0x3F32 / 16178
{
	int iVar0;
	int iVar1;
	...
	switch (Function_178(bParam0))
	{
		case 0x00000001:
			iVar1 = Function_177(bParam0);
			if (iVar1 <= 1 && iVar1 >= 24)
			{
...
int Function_89(bool bParam0) //Position: 0x440F / 17423
{
	if (!Function_51(bParam0))
	{
		return 4294967295;
...
int Function_90(bool bParam0) //Position: 0x442E / 17454
{
	if (!Function_51(bParam0))
	{
		return 4294967295;
...
void Function_91(int iParam0, bool bParam1) //Position: 0x4448 / 17480
{
	bool bVar0;
...
int Function_92(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x44AF / 17583
{
	int iVar0;
	int iVar1;
...
void Function_93(char* cParam0, bool bParam1) //Position: 0x46CF / 18127
{
	struct<4> Var0;
	...
	switch (Function_178(bParam1))
	{
		case 0x00000001:
			Var0 = { StackVal, StackVal, StackVal, Function_94(Function_177(bParam1)) };
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, &Var0, Function_178(bParam1), Function_177(bParam1));
			break;
		
		case 0x00000002:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "PROCEDURAL", Function_178(bParam1), bParam1);
			break;
		
		case 0x00000003:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "LOCATION", Function_178(bParam1), bParam1);
			break;
		
		case 0x00000004:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "MINIGAME", Function_178(bParam1), bParam1);
			break;
		
		case 0x00000005:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "ACTIONAREA_EVENT", Function_178(bParam1), bParam1);
			break;
		
		case 0x00000006:
			PLAYSTAT_DEED_NAMED(StackVal, cParam0, "JOB", Function_178(bParam1), bParam1);
			break;
...
struct<16> Function_94(int iParam0) //Position: 0x47F3 / 18419
{
	char* cVar0[16];
...
void Function_95() //Position: 0x4818 / 18456
{
	int iVar0;
	int iVar1;
	...
	if (!Function_53(iVar0) && Function_98(iVar1) < 0)
	{
		Function_74(24, Global_6269, 0);
		Function_96(24, &Global_3422[Global_626940] + 12, 0, 1);
	}
	else if (StackVal <= Function_98(Function_52(iVar0)))
	{
		Function_74(24, Global_6269, 0);
		Function_96(24, &Global_3422[Global_626940] + 12, 0, 1);
	}
...
int Function_96(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x4898 / 18584
{
	int iVar0;
	var uVar1;
...
void Function_97(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0x4BEA / 19434
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
int Function_98(int iParam0) //Position: 0x4C6D / 19565
{
...
struct<16> Function_99(int iParam0) //Position: 0x4C87 / 19591
{
	char* cVar0[16];
...
struct<24> Function_100(char* cParam0) //Position: 0x4CB1 / 19633
{
	char* cVar0[24];
...
void Function_101() //Position: 0x4F07 / 20231
{
	int iVar0;
	int iVar1;
	char* cVar2[64];
	...
	while (iVar0 <= Global_13172)
	{
		...
		{
			Function_102(Global_13172[iVar011], &iVar18, &iVar19, &iVar20);
...
void Function_102(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0x514E / 20814
{
	*uParam3 = iParam0 & 15;
...
bool Function_103(int iParam0) //Position: 0x5177 / 20855
{
	if (!Function_51(iParam0))
	{
		return 0;
	}
	if (!Function_104(StackVal))
	{
		return 0;
	}
	return 1;
...
bool Function_104(int iParam0) //Position: 0x519B / 20891
{
...
void Function_105() //Position: 0x51B0 / 20912
{
	struct<73> Var0;
...
void Function_106(int iParam0, int iParam1, bool bParam2) //Position: 0x51DE / 20958
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!bParam2)
	{
		...
		if (Global_13172[iParam111].f_32 != 0.0f || Global_34165.f_140 > Global_13172[iParam111].f_32)
		{
			...
			cVar10 = { StackVal, StackVal, StackVal, Function_94(iParam0) };
		...
		iVar15 = Function_116(iParam0, iVar14, Global_34165.f_140, bVar8, bVar0);
		if (iVar15 == 1)
		{
			Function_107(50, 1, 0);
			if (iVar14 == 0)
		...
		if (((Global_6269 != 11 || Global_6269 != 16) || Global_6269 != 15) || Global_6269 != 43)
		{
			Var16 = { StackVal, StackVal, StackVal, Function_99(iParam0) };
		}
...
void Function_107(int iParam0, bool bParam1, bool bParam2) //Position: 0x547A / 21626
{
	int iVar0;
	bool bVar1;
	
	if (Function_115(0) && (!Global_3380 || iParam0 == 100))
	{
		return;
	}
	bVar1 = iParam0;
	...
	switch (Global_12976.f_156)
	{
		case 0x00000000:
			if (iVar0 > 1000)
			{
				...
				Function_109(4, Function_110(Global_12976.f_156), 1);
...
void Function_108(int iParam0, int iParam1) //Position: 0x563D / 22077
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_109(int iParam0, char* cParam1, bool bParam2) //Position: 0x589B / 22683
{
	bool bVar0;
	int iVar1;
...
var Function_110(int iParam0) //Position: 0x5A20 / 23072
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_111(int iParam0, bool bParam1) //Position: 0x5AAF / 23215
{
	bool bVar0;
	int iVar1;
...
void Function_112() //Position: 0x5C4C / 23628
{
	Function_114(3, 0.0f);
...
int Function_113(int iParam0, int iParam1) //Position: 0x5C62 / 23650
{
	if (iParam0 == 4294967295)
	{
...
int Function_114(int iParam0, int iParam1) //Position: 0x5CA2 / 23714
{
	if (iParam0 == 4294967295)
	{
...
var Function_115(int iParam0) //Position: 0x5CE2 / 23778
{
	return (*&Global_12976 + 104)[iParam0];
}

int Function_116(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4) //Position: 0x5CF1 / 23793
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_117(int iParam0) //Position: 0x5EB9 / 24249
{
	switch (iParam0)
	{
		case 0x00000002:
...
var Function_118() //Position: 0x5F4E / 24398
{
	struct<73> Var0;
...
void Function_119(int iParam0) //Position: 0x5F73 / 24435
{
	if (!Function_53(iParam0))
	{
		return;
...
void Function_120(int iParam0, bool bParam1, bool bParam2) //Position: 0x642E / 25646
{
	int iVar0;
	bool bVar1;
	...
	switch (Global_12976.f_152)
	{
		case 0x00000000:
			if (iVar0 >= 4294962796)
			{
				...
				Function_109(2, Function_121(Global_12976.f_152), 1);
			}
			break;
		...
		case 0x00000001:
			if (iVar0 < 4294962796)
			{
				...
				Function_109(2, Function_121(Global_12976.f_152), 0);
...
var Function_121(int iParam0) //Position: 0x6743 / 26435
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_122(int iParam0, bool bParam1, int iParam2) //Position: 0x67E6 / 26598
{
	int iVar0;
	int iVar1;
...
int Function_123(int iParam0, bool bParam1) //Position: 0x69E1 / 27105
{
	bool bVar0;
	int iVar1;
...
int Function_124(bool bParam0, bool bParam1) //Position: 0x6B7D / 27517
{
	bool bVar0;
...
void Function_125(int iParam0, var uParam1, bool bParam2) //Position: 0x6C48 / 27720
{
	struct<4> Var0;
	...
	switch (iParam0)
	{
		case 0x00000001:
			...
			Function_166(Global_30640[0]);
			Function_166(Global_30679[1]);
			break;
		...
		case 0x00000008:
			if (!bParam2)
			{
				if (IS_PS3())
				{
					if (!Function_150(4))
					{
						Function_140(4, 0, 0, 1);
					}
				}
			}
			Function_166(Global_30640[0]);
			Function_166(Global_30640[10]);
			break;
		
		case 0x00000009:
			Function_166(Global_30640[0]);
			Function_166(Global_30668[2]);
		...
		case 0x0000000B:
			...
			Function_166(Global_30640[0]);
			Function_166(Global_30640[1]);
			break;
		
		case 0x0000000F:
			Function_166(Global_30640[1]);
			Function_166(Global_30679[0]);
			break;
		
		case 0x00000010:
			Function_166(Global_30679[0]);
			Function_166(Global_30658[5]);
			break;
		
		case 0x00000011:
			Function_166(Global_30658[5]);
			Function_166(Global_30658[1]);
			break;
		
		case 0x0000000C:
			Function_164(21, bParam2, 4);
			Function_166(Global_30640[4]);
			Function_166(Global_30658[4]);
			Function_139(&Global_76847, 0x2000000);
			Function_139(&Global_76847, 0x4000000);
			Function_139(&Global_76847, 4096);
			Function_139(&Global_76847, 8);
			Function_139(&Global_76847, 8388608);
			Function_139(&Global_76847, 524288);
			Function_139(&Global_76847, 1048576);
			break;
		...
		case 0x00000012:
			Function_166(Global_30640[0]);
			Function_166(Global_30640[5]);
			Function_164(16, bParam2, 4);
			break;
		
		case 0x00000013:
			Function_166(Global_30658[3]);
		...
		case 0x00000019:
			...
			Function_166(Global_30668[3]);
			Function_166(Global_30693[0]);
			Function_166(Global_30685[0]);
			Function_155(4);
			Function_151(13, 1);
			Function_151(1, 1);
			Function_151(18, 1);
		...
		case 0x0000001A:
			Function_166(Global_30685[0]);
			Function_166(Global_30693[0]);
			Function_166(Global_30693[1]);
			Function_166(Global_30707[2]);
			break;
		...
		case 0x00000024:
			Function_166(Global_30685[0]);
			Function_166(Global_30685[3]);
			break;
		
		case 0x00000022:
			Function_166(Global_30693[12]);
			Function_166(Global_30685[1]);
			break;
		
		case 0x00000023:
			Function_166(Global_30693[12]);
			Function_166(Global_30707[1]);
			break;
		
		case 0x00000025:
			Function_164(25, bParam2, 10);
			Function_166(Global_30693[2]);
			break;
		...
		case 0x0000002A:
			...
			Function_166(Global_30717[0]);
			Function_166(Global_30717[3]);
			break;
		...
		case 0x00000039:
			...
			if (!bParam2)
			{
				if (!Function_150(9))
				{
					Function_140(9, 0, 0, 0);
				}
				if (!Function_150(10))
				{
					Function_140(10, 0, 0, 1);
				}
			}
			break;
	}
	Var0 = { StackVal, StackVal, StackVal, Function_94(iParam0) };
...
void Function_126(int iParam0) //Position: 0x7538 / 30008
{
	bool bVar0;
	...
	{
		Function_131(Global_16537[iParam021].f_68, 0);
	}
	if (IS_DOOR_VALID(Global_16537[iParam021].f_72))
	{
		Function_131(Global_16537[iParam021].f_72, 0);
	}
	...
	switch (Global_16537[iParam021].f_40)
	{
		case 0x00000002:
			...
			Function_127(Global_16537[iParam021].f_48, 16, 0, 0);
...
void Function_127(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x76A7 / 30375
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	{
		Function_129(Function_130(iParam2, 0.0f, iParam3));
		vVar4 = { StackVal, StackVal, Function_129(Function_130(iParam2, 0.0f, iParam3)) };
		iVar0 = 0;
		while (iVar0 <= Global_9724)
		{
			if (StackVal == iParam1)
			{
				...
				vVar1 = { StackVal, StackVal, Function_129(StackVal) };
				if (Function_128(StackVal, StackVal, StackVal, StackVal, vVar1, vVar4))
				{
					Global_8723[iVar04] = 4294967294;
					Global_8723[iVar04].f_4 = 0;
					Global_8723[iVar04].f_8 = 0;
...
bool Function_128(vector3 vParam0, vector3 vParam3) //Position: 0x77AD / 30637
{
	vector3 vVar0;
...
vector3 Function_129(int iParam0) //Position: 0x77DA / 30682
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_130(vector3 vParam0) //Position: 0x7831 / 30769
{
	bool bVar0;
...
void Function_131(bool bParam0, bool bParam1) //Position: 0x787F / 30847
{
...
void Function_132(bool bParam0, bool bParam1, bool bParam2) //Position: 0x78D3 / 30931
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_133() //Position: 0x7A71 / 31345
{
	return;
}

bool Function_134(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x7A77 / 31351
{
	iParam0 = iParam0;
...
void Function_135(bool bParam0, int iParam1) //Position: 0x7B1B / 31515
{
	if (!Function_136(bParam0))
	{
...
bool Function_136(int iParam0) //Position: 0x7B70 / 31600
{
...
bool Function_137(int iParam0) //Position: 0x7B86 / 31622
{
...
bool Function_138(int iParam0, int iParam1) //Position: 0x7BD7 / 31703
{
	int iVar0;
...
void Function_139(var uParam0, int iParam1) //Position: 0x7C04 / 31748
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_140(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x7C13 / 31763
{
	struct<8> Var0;
	...
	if (!Function_150(bParam0))
	{
		...
		{
			stradd(&Var0, "_tip", 32);
			Function_141(&Var0, 10.0f, 1, 0, 0, 1, 0);
		}
...
void Function_141(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x7D5D / 32093
{
	int iVar0;
...
bool Function_142() //Position: 0x7DA8 / 32168
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_143(bool bParam0) //Position: 0x7DD5 / 32213
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (Global_27774[bParam013].f_48 == 4294967295 && Global_27774[bParam013].f_48 == 0)
	{
		SET_JOURNAL_ENTRY_PROGRESS(Global_27774[bParam013].f_48, (TO_FLOAT(Function_146(bParam0)) / TO_FLOAT(Global_27774[bParam013].f_28)), false, 0);
		Function_145(Global_27774[bParam013].f_48, 0);
...
int Function_144(int iParam0) //Position: 0x7F85 / 32645
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_145(bool bParam0, bool bParam1) //Position: 0x7FDC / 32732
{
	bool bVar0;
...
var Function_146(int iParam0) //Position: 0x8004 / 32772
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_147(bool bParam0, int iParam1) //Position: 0x805A / 32858
{
	int iVar0;
...
int Function_148(bool bParam0) //Position: 0x80B9 / 32953
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_149(int iParam0) //Position: 0x80C5 / 32965
{
...
bool Function_150(int iParam0) //Position: 0x80E1 / 32993
{
	if (!Function_136(iParam0))
	{
...
int Function_151(int iParam0, int iParam1) //Position: 0x8133 / 33075
{
	if (iParam0 == 4294967295)
	{
...
int Function_152(int iParam0, int iParam1) //Position: 0x81A6 / 33190
{
	if (iParam0 == 4294967295)
	{
...
int Function_153(int iParam0, int iParam1) //Position: 0x8202 / 33282
{
	if (iParam0 == 4294967295)
	{
...
int Function_154(int iParam0, int iParam1) //Position: 0x8273 / 33395
{
	if (iParam0 == 4294967295)
	{
...
void Function_155(int iParam0) //Position: 0x82CD / 33485
{
	bool bVar0;
	bool bVar1;
	...
	if (IS_DOOR_VALID(Global_16537[iParam021].f_68))
	{
		Function_163(Global_16537[iParam021].f_68, 0);
	}
	if (IS_DOOR_VALID(Global_16537[iParam021].f_72))
	{
		Function_163(Global_16537[iParam021].f_72, 0);
	}
	if (IS_OBJECT_VALID(Global_16537[iParam021].f_80))
	{
	...
	switch (Global_16537[iParam021].f_40)
	{
		case 0x00000002:
			...
			Function_127(Global_16537[iParam021].f_48, 17, 0, 0);
...
void Function_156(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x8579 / 34169
{
	char* cVar0[32];
	struct<8> Var8;
	...
	if (!Function_138(bParam0, 2))
	{
		...
		if (!bParam2)
		{
			...
			stradd(&Var8, "_tip", 32);
			Function_141(&Var8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_147(bParam0, bParam1))
	{
		...
		Function_143(bParam0);
		if (StackVal && !Function_162(((((!Function_142() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_162((((Function_142() || Global_3380) || Global_3392) || Global_3384), 1))
		{
...
void Function_157(int iParam0, bool bParam1) //Position: 0x8808 / 34824
{
	if (iParam0 >= 16)
	{
		LOG_ERROR("STAT_SET_BIT: Attempting to use a Stat out of bounds.");
...
void Function_158() //Position: 0x8867 / 34919
{
...
var Function_159(int iParam0, int iParam1) //Position: 0x88E2 / 35042
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_50(6, 0) && Function_160(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_50(9, 0) && Function_160(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_160(int iParam0) //Position: 0x94D3 / 38099
{
...
int Function_161(int iParam0) //Position: 0x94E8 / 38120
{
	int iVar0;
	int iVar1;
...
bool Function_162(bool bParam0, int iParam1) //Position: 0x9537 / 38199
{
	return (bParam0 && iParam1) == 0;
}

void Function_163(bool bParam0, bool bParam1) //Position: 0x9544 / 38212
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
void Function_164(bool bParam0, bool bParam1, int iParam2) //Position: 0x9595 / 38293
{
	bool bVar0;
...
bool Function_165(int iParam0, int iParam1) //Position: 0x9603 / 38403
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

void Function_166(int iParam0) //Position: 0x9616 / 38422
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_167(int iParam0) //Position: 0x9715 / 38677
{
	int iVar0;
...
int Function_168(bool bParam0, bool bParam1, int iParam2) //Position: 0x976D / 38765
{
...
bool Function_169(int iParam0) //Position: 0x97C4 / 38852
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void Function_170(int iParam0) //Position: 0x97D6 / 38870
{
	int iVar0;
	
	if (Function_162(iParam0, 1) && Function_162(Global_26119, 1))
	{
	}
...
void Function_171(int iParam0) //Position: 0x980A / 38922
{
...
void Function_172(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9871 / 39025
{
	bool bVar0;
...
void Function_173(bool bParam0, bool bParam1, bool bParam2) //Position: 0x994E / 39246
{
	int iVar0;
...
void Function_174() //Position: 0x9AC7 / 39623
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_175(bool bParam0) //Position: 0x9AD3 / 39635
{
	PRINTSTRING("Day ");
...
void Function_176(int iParam0) //Position: 0x9B19 / 39705
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_177(bool bParam0) //Position: 0x9B5F / 39775
{
	if (!Function_51(bParam0))
	{
		return 4294967295;
...
int Function_178(bool bParam0) //Position: 0x9B7F / 39807
{
	if (!Function_51(bParam0))
	{
		return 0;
...
void Function_179(int iParam0) //Position: 0x9B9A / 39834
{
	Global_12976.f_4 = GET_TIME_OF_DAY();
	ADD_TIME(&Global_12976 + 4, 0, false, (iParam0 + Function_180(105)), 0);
	return;
}

int Function_180(int iParam0) //Position: 0x9BBB / 39867
{
	return CEIL(((IntToFloat(iParam0) * Global_63398) / 60.0f));
}

void Function_181(bool bParam0) //Position: 0x9BD1 / 39889
{
	PRINTSTRING("Old TOD after LAST MISSION - ");
	Function_175(Global_12976.f_24);
	PRINTNL();
...
void Function_182(int iParam0) //Position: 0x9C6D / 40045
{
	Global_12976.f_12 = GET_TIME_OF_DAY();
	ADD_TIME(&Global_12976 + 12, 0, false, (iParam0 + Function_180(90)), 0);
	return;
}

void Function_183(bool bParam0) //Position: 0x9C8E / 40078
{
...
bool Function_184(bool bParam0, bool bParam1, bool bParam2) //Position: 0x9CA9 / 40105
{
	int iVar0;
	int iVar1;
...
int Function_185(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x9D07 / 40199
{
	var uVar0;
...
int Function_186(int iParam0) //Position: 0x9E5C / 40540
{
	int iVar0;
...
bool Function_187(int iParam0) //Position: 0x9E9A / 40602
{
...
var Function_188(int iParam0, int iParam1, int iParam2) //Position: 0x9EAF / 40623
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

bool Function_189(bool bParam0) //Position: 0x9ECF / 40655
{
...
bool Function_190(bool bParam0) //Position: 0xA143 / 41283
{
	bool bVar0;
	char* cVar1[64];
...
bool Function_191(bool bParam0) //Position: 0xA336 / 41782
{
	if (bParam0 != 4)
	{
		if (Function_192("xmlsave"))
		{
			if (IS_DEV_BUILD())
			{
...
bool Function_192(bool bParam0) //Position: 0xA382 / 41858
{
	bool bVar0;
...
void Function_193() //Position: 0xA3A1 / 41889
{
	struct<5> Var0;
...
bool Function_194(bool bParam0) //Position: 0xA434 / 42036
{
	bool bVar0;
	char* cVar1[64];
...
int Function_195(bool bParam0) //Position: 0xA54E / 42318
{
	if (bParam0 != 4)
	{
		if (Function_192("xmlsave"))
...
bool Function_197(int iParam0) //Position: 0xA5CC / 42444
{
	...
	if (Function_198(cVar0, "streamanddropactorlineup"))
	{
...
bool Function_198(char* cParam0, char* cParam1) //Position: 0xA723 / 42787
{
	char* cVar0[64];
	char* cVar16[64];
...
bool Function_199(char* cParam0) //Position: 0xA74E / 42830
{
	char* cVar0;
	bool bVar1;
	bool bVar2;
	...
	cVar0 = GET_CONSOLE_COMMAND_TOKEN(0);
	if (Function_198(cVar0, "streamanddropactor"))
	{
...
bool Function_200(bool bParam0) //Position: 0xA851 / 43089
{
	bool bVar0;
...
bool Function_201(bool bParam0) //Position: 0xA87E / 43134
{
...
bool Function_202(bool bParam0) //Position: 0xA8C8 / 43208
{
	bool bVar0;
...
bool Function_203(bool bParam0) //Position: 0xA8FB / 43259
{
...
bool Function_204(bool bParam0) //Position: 0xA9B6 / 43446
{
	int iVar0;
...
bool Function_205(bool bParam0) //Position: 0xAA1A / 43546
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_206(bool bParam0) //Position: 0xAAD1 / 43729
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_207(bool bParam0) //Position: 0xABEA / 44010
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_208(bool bParam0) //Position: 0xACE5 / 44261
{
	var uVar0;
...
bool Function_209(bool bParam0) //Position: 0xAD39 / 44345
{
	char* cVar0[32];
	char* cVar8[24];
...
bool Function_210(bool bParam0) //Position: 0xADE3 / 44515
{
	bool bVar0;
...
bool Function_211(bool bParam0) //Position: 0xAE58 / 44632
{
	char* cVar0[64];
...
bool Function_212(bool bParam0) //Position: 0xAF3D / 44861
{
	char* cVar0[64];
	bool bVar16;
	bool bVar17;
...
bool Function_213(bool bParam0) //Position: 0xB302 / 45826
{
	char* cVar0[64];
	bool bVar16;
	bool bVar17;
		...
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 1)
		{
			...
			else if (STRING_CONTAINS_STRING(&cVar0, "ITEM_"))
			{
				...
				while (bVar17 < (79 - 1))
				{
					...
					if (STRINGS_ARE_EQUAL(&cVar52, &cVar0))
					{
						...
						if (bVar72 == 13)
						{
							Function_215(&Global_26303, Function_228(), 4294967294, 0, 0, 1);
						}
			...
			else if (STRING_CONTAINS_STRING(&cVar0, "$"))
			{
				...
				if (STRING_NUM_TOKENS() >= 0)
				{
					...
					if (bVar75 >= 0)
					{
						Function_124(ABS(bVar75), 1);
					}
					else
					{
						Function_214(ABS(bVar75), 1);
					}
				}
				else
				{
...
int Function_214(int iParam0, bool bParam1) //Position: 0xB9AE / 47534
{
	bool bVar0;
...
int Function_215(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xBA3E / 47678
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	uParam0->f_16 = Function_226(iParam1);
	if (iParam3 == 0)
	{
		iParam3 = 0;
	}
	...
	while (iVar1 < (45 - 1))
	{
		if (Function_225(&Var96, iVar1) == 1)
		{
			if (Function_224(Var96.f_24) == Global_30621[Global_29004])
			{
				if (Var96.f_32 == iParam3)
				{
					if (((iParam1 != 4294967295 || iParam1 >= Var96.f_12) || (iParam1 != 0 && Var96.f_12 != 3)) || (iParam1 != 0 && Var96.f_12 != 4))
					{
						if (iParam4 != 0 || iParam4 != Function_223(Var96.f_20))
						{
							iVar4[iVar2] = iVar1;
							iVar2++;
							if (iParam5 == 1)
							{
								if (!Function_222(iVar1))
								{
									iVar50[iVar3] = iVar1;
									iVar3++;
								}
...
var Function_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0xBCA8 / 48296
{
	var uVar0;
	var uVar1;
...
var Function_217(int iParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5) //Position: 0xBD33 / 48435
{
	int iVar0;
	int iVar1[146];
	int iVar148[146];
	...
	while (iVar598 < 145)
	{
		...
		vVar296 = { StackVal, StackVal, Function_221(StackVal) };
		bVar302 = VDIST(vVar299, vVar296);
		if (iParam3 == 0)
		{
			iParam3 = 0;
		}
		if (((StackVal && !(IS_VOLUME_VALID(StackVal) && (iVar295 != Function_224(Global_29155[iVar59810]) || iParam0 != 4294967295)) != 1) && Function_16(&(Global_29008[iVar598]), 8192)) && iVar598 == 0)
		{
			if (iVar598 == 146)
			{
			...
			if (bVar302 < fParam1 && bVar302 > fParam2)
			{
				...
				bVar601++;
				if (Function_90(Function_184(iVar598, 0, 2)) == 0)
				{
	...
	if (bVar602 < 0 && iParam4 != 1)
	{
		...
		Var604 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_218(iVar0) };
		PRINTSTRING(&Var604);
...
struct<32> Function_218(int iParam0) //Position: 0xC3DD / 50141
{
	char* cVar0[32];
...
int Function_219() //Position: 0xC49A / 50330
{
	if (Global_29004 == 0)
	{
...
void Function_220(int iParam0, bool bParam1, int iParam2) //Position: 0xC4C8 / 50376
{
	int iVar0;
	int iVar1;
	var uVar2;
...
vector3 Function_221(bool bParam0) //Position: 0xC556 / 50518
{
	vector3 vVar0;
...
bool Function_222(bool bParam0) //Position: 0xC567 / 50535
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int Function_223(bool bParam0) //Position: 0xC5B9 / 50617
{
	int iVar0;
	int iVar1;
...
int Function_224(int iParam0) //Position: 0xC668 / 50792
{
	return Function_167(iParam0);
}

bool Function_225(var uParam0, int iParam1) //Position: 0xC673 / 50803
{
	int iVar0;
...
var Function_226(int iParam0) //Position: 0xCDE6 / 52710
{
	int iVar0;
...
bool Function_227() //Position: 0xCEB4 / 52916
{
	return Function_162(StackVal, 1);
}

int Function_228() //Position: 0xCEC3 / 52931
{
	int iVar0;
	
	iVar0 = Function_229(0);
	return iVar0;
}

var Function_229(int iParam0) //Position: 0xCED1 / 52945
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_230(bool bParam0) //Position: 0xCF55 / 53077
{
	var uVar0;
...
bool Function_231(bool bParam0) //Position: 0xCFAF / 53167
{
	var uVar0;
	struct<5> Var3;
	vector3 vVar9;
	...
	if (STRING_CONTAINS_STRING(bParam0, "dropcougar"))
	{
		...
		bVar15 = Function_232(StackVal, StackVal, StackVal, bVar18, Function_32(), 1118, vVar9, (0.0f + 180.0f), 0.0f, GET_OBJECT_FROM_ACTOR(bVar17));
		bVar16 = Function_232(StackVal, StackVal, StackVal, bVar18, Function_32(), 1087, vVar12, (0.0f + 180.0f), 0.0f, GET_OBJECT_FROM_ACTOR(bVar17));
...
var Function_232(bool bParam0, bool bParam1, bool bParam2, vector3 vParam3, vector3 vParam6, bool bParam9) //Position: 0xD092 / 53394
{
	vector3 vVar0;
	vector3 vVar3;
	bool bVar6;
	...
	Function_233(bParam9, 0, &vVar0, &vVar3);
...
void Function_233(bool bParam0, bool bParam1, var uParam2, var uParam3) //Position: 0xD0DD / 53469
{
	vector3 vVar0;
...
bool Function_234(int iParam0, int iParam1) //Position: 0xD205 / 53765
{
	var uVar0;
...
bool Function_235(bool bParam0) //Position: 0xD270 / 53872
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (STRING_CONTAINS_STRING(bParam0, "nbattleset"))
	{
		...
		Function_236(StackVal, StackVal, StackVal, StackVal, GET_AMBIENT_LAYOUT(), Function_32(), bParam0, vVar1, vVar4, 4294967295);
...
var Function_236(var uParam0, bool bParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0xD316 / 54038
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_237(bool bParam0) //Position: 0xD45F / 54367
{
	bool bVar0;
	bool bVar1;
...
bool Function_238(bool bParam0) //Position: 0xD49E / 54430
{
	bool bVar1;
	struct<5> Var2;
...
bool Function_239(bool bParam0) //Position: 0xD724 / 55076
{
	var uVar0;
	struct<5> Var3;
	vector3 vVar9;
	...
	if (STRING_CONTAINS_STRING(bParam0, "dropai"))
	{
		...
		Var17 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_240(&Var17) };
		...
		bVar12 = Function_232(StackVal, StackVal, StackVal, bVar25, &Var17, iVar15, vVar9, (0.0f + 180.0f), 0.0f, GET_OBJECT_FROM_ACTOR(bVar14));
		...
		else if (STRINGS_ARE_EQUAL(bVar16, "horse"))
		{
			...
			Var17 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_240(&Var17) };
			bVar13 = Function_232(StackVal, StackVal, StackVal, bVar25, &Var17, 976, vVar9, (0.0f + 180.0f), 0.0f, GET_OBJECT_FROM_ACTOR(bVar14));
...
struct<32> Function_240(bool bParam0) //Position: 0xD8BD / 55485
{
	char* cVar0[32];
	char* cVar8[16];
	...
	else
	{
		...
		{
			memcpy(&cVar8, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_241("0", &cVar8, ""), 4);
		}
...
struct<32> Function_241(char* cParam0, char* cParam1, char* cParam2) //Position: 0xD927 / 55591
{
	char* cVar0[32];
...
bool Function_242(int iParam0) //Position: 0xD946 / 55622
{
	iParam0 = iParam0;
	return 0;
}

bool Function_243(bool bParam0) //Position: 0xD951 / 55633
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_244(bool bParam0) //Position: 0xD9E0 / 55776
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int Function_245(int iParam0, bool bParam1) //Position: 0xDA52 / 55890
{
	bool bVar0;
	int iVar1;
	
	Function_246(iParam0, bParam1, 0);
	bVar0 = iParam0;
	if (bVar0 >= 696)
	{
...
int Function_246(int iParam0, bool bParam1, int iParam2) //Position: 0xDBDE / 56286
{
	int iVar0;
	int iVar1;
...
bool Function_247(bool bParam0) //Position: 0xDDC9 / 56777
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_248(bool bParam0) //Position: 0xDE4F / 56911
{
...
bool Function_249(bool bParam0) //Position: 0xDE71 / 56945
{
	bool bVar0;
	bool bVar1;
...
bool Function_250(bool bParam0) //Position: 0xDED8 / 57048
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool Function_251(bool bParam0) //Position: 0xDF4B / 57163
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
		...
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 0)
		{
			...
			if (STRING_CONTAINS_STRING(bVar0, "new"))
			{
				...
				if (GET_NUM_ITERATOR_MATCHES(bVar3) < 0 && IS_LAYOUTREF_VALID(Global_26314))
				{
					...
					{
						Function_252(1, 0, GET_PLAYER_ACTOR(0), bVar7, 0);
			...
			else if (STRING_CONTAINS_STRING(bVar0, "upgrade"))
			{
				...
				if (GET_NUM_ITERATOR_MATCHES(bVar3) < 0 && IS_LAYOUTREF_VALID(Global_26314))
				{
					...
					if (IS_OBJECT_VALID(bVar7))
					{
						Function_252(2, 0, GET_PLAYER_ACTOR(0), bVar7, 0);
						GET_OBJECT_POSITION(bVar7, &vVar4);
						PRINTSTRING(GET_SHORT_SCRIPT_NAME());
						PRINTSTRING(": New Console Crime!");
						PRINTVECTOR(vVar4);
...
var Function_252(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0xE1C4 / 57796
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_253() //Position: 0xE454 / 58452
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_254(bool bParam0, bool bParam1) //Position: 0xE4B7 / 58551
{
...
bool Function_255(bool bParam0) //Position: 0xE4E6 / 58598
{
	if (Function_258(256))
	{
		return 0;
	}
	if (Function_258(262144))
	{
		return 0;
	}
	if (Function_257())
	...
	if (!Function_258(4096))
	{
		return 0;
	}
	if (bParam0 && Function_256(12))
	{
		return 0;
	}
	if (Global_3378)
...
int Function_256(int iParam0) //Position: 0xE55C / 58716
{
...
bool Function_257() //Position: 0xE56D / 58733
{
	if (Global_30619 == 2)
	{
		if (StackVal == 1)
...
bool Function_258(int iParam0) //Position: 0xE586 / 58758
{
	int iVar0;
...
bool Function_259(int iParam0) //Position: 0xE5A4 / 58788
{
...
bool Function_260(int iParam0) //Position: 0xE5BA / 58810
{
...
bool Function_261(bool bParam0) //Position: 0xE5CF / 58831
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "setweather"))
	{
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 2)
		{
			...
			Function_262(iVar2, FLOOR(STRING_TO_FLOAT(bVar1)), 0, 0, 0);
		}
		return 1;
	}
	return 0;
...
void Function_262(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0xE684 / 59012
{
	int iVar0;
	bool bVar1;
...
void Function_263(int iParam0, int iParam1) //Position: 0xE6F6 / 59126
{
	int iVar0;
	...
	Function_175(iVar0);
	PRINTNL();
	Function_173(iParam0, iVar0, iParam1);
	return;
}

bool Function_264(bool bParam0) //Position: 0xE71B / 59163
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_265(bool bParam0) //Position: 0xE77F / 59263
{
...
bool Function_266(bool bParam0) //Position: 0xE7BC / 59324
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "gps"))
	{
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 3)
		{
			...
			Function_270(1.0f, 0.0f, 1.0f);
			Function_268(STRING_TO_FLOAT(bVar0), STRING_TO_FLOAT(bVar1), STRING_TO_FLOAT(bVar2));
		}
		else if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 1)
		{
			bVar3 = GET_CONSOLE_COMMAND_TOKEN(1);
			iVar4 = Function_267(bVar3);
			if (Function_21(iVar4))
			{
				GET_OBJECT_POSITION(StackVal, &vVar5);
				Var8 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_218(iVar4) };
				Function_268(StackVal, StackVal, vVar5);
			}
		}
		return 1;
	}
...
var Function_267(bool bParam0) //Position: 0xE859 / 59481
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_268(vector3 vParam0) //Position: 0xE912 / 59666
{
	...
	*(&Global_28210 + 36) = { StackVal, StackVal, vParam0 };
	...
	{
		Function_269(Global_28210.f_12);
...
void Function_269(bool bParam0) //Position: 0xE999 / 59801
{
	bool bVar0;
...
void Function_270(var uParam0, var uParam1, int iParam2) //Position: 0xE9D9 / 59865
{
	Global_28185.f_60 = 5;
...
bool Function_271(bool bParam0) //Position: 0xE9FA / 59898
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "teleport"))
	{
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 3)
		{
			...
			bVar1 = GET_CONSOLE_COMMAND_TOKEN(2);
			bVar2 = GET_CONSOLE_COMMAND_TOKEN(3);
			Function_272(STRING_TO_FLOAT(bVar0), STRING_TO_FLOAT(bVar1), STRING_TO_FLOAT(bVar2), "TELEPORTING...", "", 1, 1);
		}
		return 1;
	}
	return 0;
...
void Function_272(vector3 vParam0, char* cParam3, char* cParam4, var uParam5, var uParam6) //Position: 0xEA5A / 59994
{
...
bool Function_273(bool bParam0) //Position: 0xEA91 / 60049
{
	char* cVar0;
	var uVar1;
	var uVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "nvteleport"))
	{
		if (GET_NUM_CONSOLE_COMMAND_TOKENS() >= 1)
		{
			...
			uVar1 = Function_267(cVar0);
			if (Function_21(uVar1))
			{
				memcpy(&uVar2, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_218(uVar1), 4);
				Function_274(uVar1, "Teleporting to %s...", &uVar2, 1, 1);
			}
		}
		return 1;
	}
...
void Function_274(var uParam0, char* cParam1, char* cParam2, var uParam3, var uParam4) //Position: 0xEAF8 / 60152
{
...
bool Function_275(bool bParam0) //Position: 0xEB2F / 60207
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool Function_276(bool bParam0) //Position: 0xEB8E / 60302
{
	bool bVar0;
...
int Function_277() //Position: 0xEBE7 / 60391
{
	bool bVar0;
	...
	else if (STRINGS_ARE_EQUAL(bVar0, "ambientpop"))
	{
		...
		ENABLE_AMBIENT_SPAWNING(Function_281(1));
	}
...
void Function_278(int iParam0) //Position: 0xED44 / 60740
{
	int iVar0;
...
void Function_279(int iParam0) //Position: 0xED61 / 60769
{
	Global_26316.f_56 = (Global_26316.f_56 || iParam0);
	return;
}

void Function_280(int iParam0) //Position: 0xED74 / 60788
{
	if (Function_162(iParam0, 1) && !Function_162(Global_26119, 1))
	{
	}
...
bool Function_281(int iParam0) //Position: 0xEDA1 / 60833
{
	int iVar0;
...
int Function_282() //Position: 0xEDBD / 60861
{
	int iVar0;
	bool bVar1;
...
bool Function_283(bool bParam0) //Position: 0xEF2A / 61226
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "stamb"))
	{
		...
		*(&iVar2 + 64 + 20) = 1;
		while (iVar1 < 6)
		{
			bVar0 = Function_285(iVar1, bParam0);
			if (DOES_SCRIPT_EXIST(bVar0))
			{
				...
				if (!Function_284(&vVar53, 50.0f, &iVar2 + 8, 4294967295))
				{
...
bool Function_284(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0xF060 / 61536
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
var Function_285(char* cParam0, bool bParam1) //Position: 0xF192 / 61842
{
	char* cVar0[64];
...
bool Function_286(bool bParam0) //Position: 0xF1C6 / 61894
{
	bool bVar0;
	int iVar1;
	...
	if (STRING_CONTAINS_STRING(bParam0, "end"))
	{
		...
		while (iVar1 < 6)
		{
			bVar0 = Function_287(iVar1, bParam0);
...
var Function_287(char* cParam0, bool bParam1) //Position: 0xF2A0 / 62112
{
	char* cVar0[64];
...
bool Function_288(bool bParam0) //Position: 0xF3B2 / 62386
{
	bool bVar0;
	int iVar1;
	char* cVar2[64];
...
bool Function_289(bool bParam0) //Position: 0xF542 / 62786
{
	bool bVar0;
	int iVar1;
...
bool Function_290(bool bParam0) //Position: 0xF6E9 / 63209
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (STRING_CONTAINS_STRING(bParam0, "run"))
	{
		...
		else
		{
			...
			while (iVar2 < 6)
			{
				bVar0 = Function_287(iVar2, bParam0);
				if (DOES_SCRIPT_EXIST(bVar0))
				{
					if (iVar1 == 1)
					{
...
bool Function_291(bool bParam0) //Position: 0xF989 / 63881
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_292(int iParam0) //Position: 0xFA37 / 64055
{
...
bool Function_293(bool bParam0) //Position: 0xFA4E / 64078
{
...
void Function_294(bool bParam0) //Position: 0xFA78 / 64120
{
	if (bParam0)
	{
		Function_297(1);
...
void Function_295(int iParam0) //Position: 0xFA8E / 64142
{
	Function_296(&Global_78617 + 52, iParam0);
	return;
}

void Function_296(var uParam0, int iParam1) //Position: 0xFA9F / 64159
{
	Function_61(uParam0, iParam1);
	return;
}

void Function_297(int iParam0) //Position: 0xFAAC / 64172
{
	Function_298(&Global_78617 + 52, iParam0);
	return;
}

void Function_298(var uParam0, var uParam1) //Position: 0xFABD / 64189
{
	Function_84(uParam0, uParam1);
	return;
}

void Function_299() //Position: 0xFACA / 64202
{
	struct<13> Var0;
	struct<13> Var16;
	struct<13> Var32;
...
var Function_300(bool bParam0, bool bParam1, bool bParam2, int iParam3, vector3 vParam4, vector3 vParam7, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14) //Position: 0xFEF8 / 65272
{
	bool bVar0;
	int iVar1[6];
	bool bVar8;
	...
	if (IS_ACTOR_DRAFT_VEHICLE(bVar0))
	{
		...
		while (bVar9 < (iVar10 - 1))
		{
			...
			bVar15 = "";
			if (Function_303(Global_30750[6], 4, 23, 0) && iParam10)
			{
				bVar16 = Function_302(StackVal, StackVal, Global_30750[6], vParam4, 4, 23, 0);
				if (Function_301(bVar16, &iVar1))
				{
					bVar16 = 976;
				}
				iVar1[bVar9] = bVar16;
...
bool Function_301(int iParam0, int iParam1) //Position: 0x1012E / 65838
{
	int iVar0;
...
var Function_302(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6) //Position: 0x10160 / 65888
{
	return GET_RAND_ACTORENUM_FROM_POPULATION_NATIVE(bParam0, bParam4, bParam5, bParam6, 1,401298E-45f, vParam1);
}

int Function_303(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x10178 / 65912
{
...
bool Function_304(int iParam0) //Position: 0x1019F / 65951
{
	int iVar0;
	int iVar1;
	...
	if (!Function_5(iParam0[iVar03], 16))
	{
		...
		Function_307(iParam0[iVar03], 16);
	}
	iVar0 = 0;
	while (iVar0 < (*iParam0 - 1))
	{
...
void Function_305() //Position: 0x1051A / 66842
{
	if (!Function_281(128))
	{
		return;
...
bool Function_306() //Position: 0x1055A / 66906
{
	int iVar0;
...
void Function_307(var uParam0, int iParam1) //Position: 0x10585 / 66949
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_308() //Position: 0x10596 / 66966
{
	if (!Function_281(128))
	{
		return;
...
var Function_309(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x105D8 / 67032
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_310(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_310(var uParam0, int iParam1, int iParam2) //Position: 0x10610 / 67088
{
	int iVar0;
...
var Function_311(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x106D4 / 67284
{
	int iVar0;
...
var Function_312() //Position: 0x107A4 / 67492
{
	bool bVar0;
