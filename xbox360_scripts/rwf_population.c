...
void main() //Position: 0x0 / 0
{
	...
	bVar0 = Function_16("Business", 0);
	Function_13(&bVar0, 87, 10.0f, 8, 0, 0);
	Function_13(&bVar0, 230, 10.0f, 8, 0, 0);
	Function_13(&bVar0, 16, 10.0f, 8, 0, 0);
	Function_13(&bVar0, 135, 10.0f, 8, 0, 0);
	bVar1 = Function_16("owls", 0);
	Function_13(&bVar1, 1137, 10.0f, 49, 0, 0);
	Function_13(&bVar1, 1138, 10.0f, 49, 0, 0);
	Function_13(&bVar1, 1139, 10.0f, 49, 0, 0);
	...
	Function_13(&uVar3, 1082, 10.0f, 49, 0, 0);
	bVar4 = Function_16("chickens", 0);
	Function_13(&bVar4, 1015, 100.0f, 15, 0, 0);
	Function_13(&bVar4, 1016, 100.0f, 15, 0, 0);
	...
	bVar5 = Function_16("animal_cow_day", 0);
	Function_13(&bVar5, 1008, 1.0f, 14, 0, 0);
	Function_13(&bVar5, 1009, 1.0f, 14, 0, 0);
	Function_13(&bVar5, 1010, 1.0f, 14, 0, 0);
	Function_13(&bVar5, 1011, 1.0f, 14, 0, 0);
	bVar6 = Function_16("animal_cow_night", 0);
	Function_13(&bVar6, 1008, 1.0f, 49, 0, 0);
	Function_13(&bVar6, 1009, 1.0f, 49, 0, 0);
	Function_13(&bVar6, 1010, 1.0f, 49, 0, 0);
	Function_13(&bVar6, 1011, 1.0f, 49, 0, 0);
	bVar7 = CREATE_POPULATION_SET(1);
	...
	if (IS_LAYOUTREF_VALID(bVar8))
	{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_5(bVar9, bVar5, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_5(bVar9, bVar6, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_5(bVar9, bVar4, 3, 5, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_5(bVar9, bVar0, 2, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_3(bVar9, bVar1, 2E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar9))
		{
			Function_3(bVar9, bVar7, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x12FC / 4860
{
	bool bVar0;
...
var Function_4(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x137C / 4988
{
	bool bVar0;
...
var Function_5(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x13FC / 5116
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1579 / 5497
{
	int iVar0;
	int iVar1;
...
void Function_12(bool bParam0) //Position: 0x15BE / 5566
{
	DESTROY_POPULATION_SET(*bParam0);
	return;
}

var Function_13(var uParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x15CA / 5578
{
...
var Function_14(int iParam0) //Position: 0x162C / 5676
{
	bool bVar0;
...
var Function_15(int iParam0) //Position: 0x1698 / 5784
{
	bool bVar0;
...
var Function_16(bool bParam0, int iParam1) //Position: 0x1704 / 5892
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_17(bool bParam0, var uParam1) //Position: 0x1711 / 5905
{
	if (!Function_6(128))
	{
		return;
