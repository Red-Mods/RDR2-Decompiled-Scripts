...
void Function_1(int iParam0) //Position: 0x428 / 1064
{
	...
	if (IS_OBJECT_ANIMATOR_VALID(bLocal_4))
	{
		DESTROY_OBJECT_ANIMATOR(bLocal_4);
	}
	if (IS_OBJECT_ANIMATOR_VALID(bLocal_5))
	{
		DESTROY_OBJECT_ANIMATOR(bLocal_5);
	}
	return;
}
...
int Function_4(bool bParam0) //Position: 0x499 / 1177
{
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		else if (!iLocal_8)
		{
			...
			if (IS_OBJECT_VALID(bVar1))
			{
				...
				if (IS_GRINGO_COMPONENT_VALID(bVar2))
				{
					...
					{
						bLocal_5 = GET_OBJECT_ANIMATOR_ON_OBJECT(bVar3);
						if (IS_OBJECT_ANIMATOR_VALID(bLocal_5))
						{
							if (IS_OBJECT_ANIMATOR_READY(bLocal_5))
							{
								if (GET_OBJECT_ANIMATOR_PHASE(bLocal_5) < 0,022f)
								{
		...
		else
		{
			...
			if (IS_PHYSINST_VALID(bLocal_2))
			{
				bLocal_4 = GET_OBJECT_ANIMATOR_ON_OBJECT(bLocal_2);
				if (IS_OBJECT_ANIMATOR_VALID(bLocal_4))
				{
					if (IS_OBJECT_ANIMATOR_READY(bLocal_4))
					{
						if (GET_OBJECT_ANIMATOR_PHASE(bLocal_4) != 1.0f)
						{
							iLocal_8 = 0;
							Function_5(bVar0, 0);
...
int Function_5(bool bParam0, bool bParam1) //Position: 0x7CE / 1998
{
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		{
			bVar2 = GRINGO_ANIM_GET_AST_FILENAME(bVar1);
			bVar3 = GRINGO_ANIM_GET_ACT_FILENAME(bVar1);
			bVar4 = GRINGO_ANIM_GET_ACT_ROOTNODE(bVar1);
			bVar5 = GRINGO_GET_PHYSINST(bVar0);
			if (IS_PHYSINST_VALID(bVar5))
			{
				bLocal_5 = GET_OBJECT_ANIMATOR_ON_OBJECT(bVar5);
				if (!IS_OBJECT_ANIMATOR_VALID(bLocal_5))
				{
					bLocal_5 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bVar5, bVar2, bVar3, bVar4);
				}
				if (IS_OBJECT_ANIMATOR_VALID(bLocal_5))
				{
					if (IS_OBJECT_ANIMATOR_READY(bLocal_5))
					{
						if (bParam1)
						{
							SET_OBJECT_ANIMATOR_NODE(bLocal_5, "/global/old_winch/lever/lever");
						}
						else
						{
							DESTROY_OBJECT_ANIMATOR(bLocal_5);
...
bool Function_6(bool bParam0, bool bParam1, bool bParam2) //Position: 0x989 / 2441
{
	...
	if (IS_PHYSINST_VALID(bLocal_2))
	{
		...
		if (!IS_OBJECT_ANIMATOR_VALID(bLocal_4))
		{
			bLocal_4 = CREATE_OBJECT_ANIMATOR_ON_OBJECT(bLocal_2, "", "nold_winch", "old_winch/winch");
		}
		if (IS_OBJECT_ANIMATOR_VALID(bLocal_4))
		{
			if (IS_OBJECT_ANIMATOR_READY(bLocal_4))
			{
				if (bParam1 == 1)
				{
					...
					EVENT_TRAP_CLEAR_TRAP_FLAG(bLocal_3);
					SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_top");
				}
				else if (bParam1 == 2)
				{
					iLocal_6 = 2;
					...
					Function_5(bParam0, 0);
					EVENT_TRAP_CLEAR_TRAP_FLAG(bLocal_3);
					SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_middle");
				}
				else if (bParam1 == 3)
				{
					iLocal_6 = 3;
					...
					Function_5(bParam0, 0);
					EVENT_TRAP_CLEAR_TRAP_FLAG(bLocal_3);
					SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_bottom");
				}
				if (bParam2 == 1)
				{
					if (iLocal_6 == 1)
					{
						iLocal_8 = 1;
						iLocal_6 = 3;
						SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_down");
					}
					else if (iLocal_6 == 2)
					{
						iLocal_8 = 1;
						iLocal_6 = 3;
						SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_middle_down");
					}
					else if (iLocal_6 == 3)
					{
						iLocal_8 = 1;
						iLocal_6 = 1;
						SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_up");
					}
				}
				else if (bParam2 == 2)
				{
				...
				else if (bParam2 == 3)
				{
					if (iLocal_6 == 2)
					{
						iLocal_8 = 1;
						iLocal_6 = 1;
						SET_OBJECT_ANIMATOR_NODE(bLocal_4, "/global/old_winch/winch/winch_middle_up");
					}
					else if (iLocal_6 == 3)
					{
						iLocal_8 = 1;
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_40(iParam0, bVar8, &iLocal_87, &bLocal_86);
...
void Function_19(bool bParam0, int iParam1) //Position: 0x2403 / 9219
{
...
void Function_20(var uParam0, var uParam1) //Position: 0x2418 / 9240
{
	uParam1 = uParam1;
	uParam0 = uParam0;
	return;
...
bool Function_21() //Position: 0x2426 / 9254
{
	bool bVar0;
...
void Function_22(var uParam0, bool bParam1) //Position: 0x2457 / 9303
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_23(var uParam0, bool bParam1) //Position: 0x24CB / 9419
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_24(var uParam0, int iParam1) //Position: 0x253D / 9533
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_25(bool bParam0) //Position: 0x254B / 9547
{
	return Function_13(bParam0, "UseTime", 5.0f);
}

bool Function_26() //Position: 0x2561 / 9569
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_27(bool bParam0) //Position: 0x256E / 9582
{
	return Function_13(bParam0, "MoveAllowance", 1,5f);
}

bool Function_28(var uParam0, int iParam1) //Position: 0x258E / 9614
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_29(bool bParam0) //Position: 0x259D / 9629
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_30() //Position: 0x25BC / 9660
{
	return;
}

void Function_31(var uParam0, int iParam1) //Position: 0x25C2 / 9666
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_32(int iParam0) //Position: 0x25D0 / 9680
{
	iParam0 = iParam0;
	return 1;
}

bool Function_33(bool bParam0) //Position: 0x25DB / 9691
{
	return Function_9(bParam0, "OneShotKill", 0);
}

bool Function_34(bool bParam0, int iParam1) //Position: 0x25F5 / 9717
{
	return Function_11(bParam0, "ParentAnimNode", iParam1);
}

bool Function_35(bool bParam0) //Position: 0x2613 / 9747
{
	return Function_9(bParam0, "LinkToParentAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x2632 / 9778
{
	int iVar0;
	int iVar1;
...
bool Function_37(bool bParam0) //Position: 0x2665 / 9829
{
	return Function_9(bParam0, "LinkParentToAnim", 0);
}

bool Function_38(bool bParam0) //Position: 0x2684 / 9860
{
	return Function_9(bParam0, "SingularUse", 0);
}

void Function_39(var uParam0, int iParam1) //Position: 0x269E / 9886
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_40(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x26B1 / 9905
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_41() //Position: 0x2999 / 10649
{
	int iVar0;
...
bool Function_42(bool bParam0, bool bParam1) //Position: 0x29A1 / 10657
{
	return Function_11(bParam0, "TargetLocator", bParam1);
}

void Function_43() //Position: 0x29BE / 10686
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x29CD / 10701
{
	return Function_11(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x29EF / 10735
{
	return Function_11(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_46(bool bParam0) //Position: 0x2A13 / 10771
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x2A30 / 10800
{
	return Function_11(bParam0, "TargetAttachBone", iParam1);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x2A50 / 10832
{
	return Function_11(bParam0, "TargetAttachSlot", iParam1);
}

void Function_49(bool bParam0, bool bParam1) //Position: 0x2A70 / 10864
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_50(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2B1E / 11038
{
	bool bVar0;
...
void Function_51(int iParam0, float fParam1) //Position: 0x2B8E / 11150
{
	if (!Function_16(iParam0))
	{
...
void Function_52(int iParam0, float fParam1) //Position: 0x2BA4 / 11172
{
...
var Function_53(bool bParam0) //Position: 0x2BC5 / 11205
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_13(bParam0, "RandUseTime", 0.0f));
}

void Function_54(int iParam0) //Position: 0x2BE5 / 11237
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x2BF9 / 11257
{
	uParam0 = uParam0;
	return;
}

int Function_56() //Position: 0x2C03 / 11267
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x2C0A / 11274
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x2C19 / 11289
{
	bool bVar0;
...
bool Function_59(bool bParam0) //Position: 0x2C58 / 11352
{
	return Function_13(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x2C83 / 11395
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x2C8E / 11406
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x2D84 / 11652
{
	return Function_9(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x2DA6 / 11686
{
	return Function_13(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(bool bParam0) //Position: 0x2DCD / 11725
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_65(vector3 vParam0) //Position: 0x308C / 12428
{
	vector3 vVar0;
...
vector3 Function_66(vector3 vParam0) //Position: 0x30E9 / 12521
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x3146 / 12614
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x3150 / 12624
{
	return Function_9(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x316E / 12654
{
	if (!Function_16(iParam0))
	{
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x3183 / 12675
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x320A / 12810
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x322D / 12845
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x324B / 12875
{
	return Function_13(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x326E / 12910
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x3389 / 13193
{
...
int Function_76(bool bParam0) //Position: 0x33B4 / 13236
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x34B9 / 13497
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x34C6 / 13510
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x3539 / 13625
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_86));
		iLocal_87 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_38(iParam0->f_12))
...
void Function_80() //Position: 0x3A37 / 14903
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x3A6E / 14958
{
	return Function_13(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x3A8B / 14987
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x3AC3 / 15043
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x3ACD / 15053
{
	return Function_9(bParam0, "BlockBumpReactions", 0);
}

void Function_85(var uParam0, int iParam1) //Position: 0x3AEE / 15086
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3AFC / 15100
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3C04 / 15364
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x3C1A / 15386
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x3ED0 / 16080
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x3EDE / 16094
{
	return Function_9(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x3EF7 / 16119
{
	return Function_9(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x3F11 / 16145
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3F49 / 16201
{
	return Function_11(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x3F60 / 16224
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x422A / 16938
{
	return Function_13(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x4247 / 16967
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x42E3 / 17123
{
	return Function_13(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x4302 / 17154
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x4311 / 17169
{
...
void Function_100(int iParam0) //Position: 0x432D / 17197
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x4337 / 17207
{
	bool bVar0;
	bool bVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x4399 / 17305
{
...
void Function_103(int iParam0) //Position: 0x43AD / 17325
{
	vector3 vVar0;
	bool bVar3;
...
void Function_104(int iParam0) //Position: 0x44B2 / 17586
{
