...
void main() //Position: 0x0 / 0
{
	...
	iLocal_80 = 0;
	Function_126(uScriptParam_0, &iLocal_80);
	while (IS_GRINGO_ACTIVE())
	{
		Function_125(uScriptParam_0);
		if (UNK_0xBBB2780E() && GRINGO_DEBUG_IS_SELECTED())
		{
		...
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_117(&(Local_7[iVar312]), &bVar4))
						{
							Function_115(GRINGO_GET_REQUESTING_ACTOR(), Local_7[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						...
						{
							Function_110("eGRINGO_EndUse: Stop use by request", Local_7[iVar312].f_16);
							Function_109(Local_7[iVar312].f_16, 1);
						...
						{
							Function_129("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_80 - 1))
			{
				if (Function_76(Local_7[iVar012].f_40, 2))
				{
					...
					{
						Function_129("Quitting due to update end");
	...
	{
		Function_129("Removing quit context at script termination");
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_87))
								{
									Function_129("ManagePlayerQuit: Create quit context");
								...
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_87))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_87))
									{
										Function_129("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(bLocal_87);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_87))
										{
											Function_129("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(bLocal_87);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_87))
							{
								Function_129("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(bLocal_87);
							}
						}
					}
...
bool Function_16(int iParam0) //Position: 0xA31 / 2609
{
	...
	{
		Function_110("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_110("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_110("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_85, &bLocal_84);
...
void Function_62(bool bParam0) //Position: 0x2542 / 9538
{
	...
	{
		iLocal_2 = 1;
		iLocal_0 = CREATE_LAYOUT("openHouseObjLayout");
		Function_63(iLocal_0, 0, Global_34573, 1, 0, 0);
	}
	return;
}

var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x257F / 9599
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x25F4 / 9716
{
	bool bVar0;
	bool bVar1;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x262C / 9772
{
...
void Function_66(int iParam0) //Position: 0x26B8 / 9912
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26C2 / 9922
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26E0 / 9952
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26F5 / 9973
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_70(int iParam0) //Position: 0x277C / 10108
{
	vector3 vVar0;
...
vector3 Function_71(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x279F / 10143
{
	vector3 vVar0;
...
bool Function_72(bool bParam0) //Position: 0x27BD / 10173
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_73(bool bParam0, bool bParam1) //Position: 0x27E0 / 10208
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_74(bool bParam0, int iParam1) //Position: 0x28FB / 10491
{
...
int Function_75(bool bParam0) //Position: 0x2926 / 10534
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_76(var uParam0, int iParam1) //Position: 0x2A2B / 10795
{
	return (uParam0 && iParam1) == 0;
}

void Function_77(int iParam0) //Position: 0x2A38 / 10808
{
	if (Function_76(iParam0->f_40, 16))
	{
...
void Function_78(int iParam0, bool bParam1) //Position: 0x2AAB / 10923
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_79() //Position: 0x2FA9 / 12201
{
	bool bVar0;
...
bool Function_80(bool bParam0) //Position: 0x2FE0 / 12256
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_81(var uParam0, int iParam1) //Position: 0x2FFD / 12285
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_82(int iParam0) //Position: 0x3035 / 12341
{
	iParam0 = iParam0;
	return;
}

bool Function_83(bool bParam0) //Position: 0x303F / 12351
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_84(bool bParam0, int iParam1) //Position: 0x3060 / 12384
{
	int iVar0;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		if (IS_ACTOR_PLAYER(bParam0))
		{
			...
			if (iVar0 <= 0 && iVar0 >= 40)
			{
				Function_92(Function_108(0, 0, 1, 1, 0), 1);
			}
			...
			else if (Function_86(11, 0))
			{
				...
				{
					ADD_ITEM(Function_85(0), bParam0, true);
				}
				else if (Function_86(4, 0))
				{
					ADD_ITEM(Function_85(3), bParam0, true);
				}
				else
				{
					Function_92(Function_108(0, 0, 1, 1, 1), 1);
				}
			}
			else if (Function_86(4, 0))
			{
...
var Function_85(bool bParam0) //Position: 0x315D / 12637
{
	bool bVar0;
...
bool Function_86(int iParam0, bool bParam1) //Position: 0x324E / 12878
{
	int iVar0;
...
bool Function_87(int iParam0) //Position: 0x328B / 12939
{
...
var Function_88(int iParam0) //Position: 0x32A2 / 12962
{
...
bool Function_89(int iParam0) //Position: 0x32BC / 12988
{
...
bool Function_90(bool bParam0) //Position: 0x32D2 / 13010
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		_ADD_AMMO_OF_TYPE(bParam0, GET_AMMO_ENUM(bVar4), TO_FLOAT(RAND_INT_RANGE(true, 15)), 1, 1);
		return 1;
	}
	return 0;
}

int Function_91(bool bParam0, int iParam1) //Position: 0x3437 / 13367
{
	int iVar0;
...
int Function_92(bool bParam0, bool bParam1) //Position: 0x3448 / 13384
{
	bool bVar0;
	
	bVar0 = Function_107(0);
	if ((Function_107(0) + bParam0) >= 999999)
	{
	...
	UI_SET_MONEY("nMoneyText", "Dmoney_amount", Function_107(0));
	if (bParam1)
	{
	...
	if ((Function_107(597) + Function_107(450)) >= 10000)
	{
...
int Function_93(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3513 / 13587
{
	int iVar0;
	int iVar1;
	...
	Function_106(iParam0, TO_FLOAT(bParam1), 1);
	Function_105(iParam0);
	if (iParam2 && bParam1 == 0)
	{
		Function_94(iParam0, 1, TO_FLOAT(bParam1), 1, 1, 3.0f, 0, iParam3);
	}
...
void Function_94(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x3733 / 14131
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
	...
	switch (Global_35278[iParam020].f_48)
	{
		...
		case 0x0000000F:
			if (iParam0 == 390)
			{
				...
				stradd(&Global_35278[iParam020] + 16, INT_TO_STRING(FLOOR(Function_104(390))), 32);
			}
			break;
	}
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_103(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
				...
				switch (iParam0)
				{
					case 0x00000003:
						iVar21 = 1;
						Function_101(iParam0, bVar19, bVar20, &iVar17, &iVar18);
					...
					case 0x000001E7:
						...
						{
							Function_98(bVar19, bParam2, &iVar17, &iVar18);
							if (!IS_STRING_VALID(bParam7))
							{
								bParam7 = "Common_Null";
							}
							Var9 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_96(Global_83864.f_1264, Global_84364.f_708, 0, 1) };
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_95(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_39(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_95(int iParam0) //Position: 0x3D60 / 15712
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_96(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x3D71 / 15729
{
	char* cVar0[32];
	...
	if (bParam3)
	{
		...
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_97("icon_prestige_award_", I2STR((iParam1 - 1))) };
	}
	if (iParam1 < 0)
	{
		cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_97("icon_prestige_", I2STR((iParam0 / 5))) };
	}
...
struct<32> Function_97(char* cParam0, char* cParam1) //Position: 0x3E66 / 15974
{
	char* cVar0[32];
...
void Function_98(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3E7F / 15999
{
	float fVar0;
	
	fVar0 = (Global_83864[Global_83864.f_1264 + 16] - Global_83864[Global_83864.f_12646]);
	*uParam2 = Function_100(100, FLOOR((((fParam0 - Global_83864[Global_83864.f_12646]) / fVar0) * 100.0f)));
	*uParam3 = Function_99(Function_100(100, FLOOR(((fParam1 / fVar0) * 100.0f))), 1);
}

var Function_99(int iParam0, int iParam1) //Position: 0x3EE4 / 16100
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_100(int iParam0, bool bParam1) //Position: 0x3EF6 / 16118
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_101(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3F08 / 16136
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (((Function_102(iParam0) != 19 || Function_102(iParam0) != 17) || Function_102(iParam0) != 10) || Function_102(iParam0) != 9)
	{
		if (fParam1 > fVar1)
		{
			fParam1 = fVar1;
...
int Function_102(int iParam0) //Position: 0x4039 / 16441
{
	return Global_35278[iParam020].f_48;
}

float Function_103(int iParam0) //Position: 0x4048 / 16456
{
	if (!iParam0 != 4294967295)
	{
...
var Function_104(int iParam0) //Position: 0x4081 / 16513
{
	if (iParam0 == 4294967295)
	{
...
void Function_105(int iParam0) //Position: 0x40BE / 16574
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_106(int iParam0, float fParam1, bool bParam2) //Position: 0x4258 / 16984
{
	int iVar0;
	int iVar1;
...
int Function_107(int iParam0) //Position: 0x4472 / 17522
{
	if (iParam0 == 4294967295)
	{
...
bool Function_108(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x44B3 / 17587
{
	bool bVar0;
	...
	if (bParam2)
	{
		bVar0 = (bVar0 * (0,75f + ((TO_FLOAT(Function_107(5)) / 100.0f) * 0,5f)));
	}
	if (bParam3)
	{
...
void Function_109(bool bParam0, bool bParam1) //Position: 0x45B5 / 17845
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_129("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_129("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_87))
			{
				if (bParam1)
				{
					Function_129("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(bLocal_87);
			}
		}
	...
	if (bParam1)
	{
		Function_129("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_110(bool bParam0, bool bParam1) //Position: 0x46BD / 18109
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_111(int iParam0) //Position: 0x46D3 / 18131
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_112(iParam0->f_16, bVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_112(bool bParam0, int iParam1) //Position: 0x4989 / 18825
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_113(bool bParam0) //Position: 0x499E / 18846
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_114(bool bParam0) //Position: 0x49B7 / 18871
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_115(bool bParam0, int iParam1) //Position: 0x49D1 / 18897
{
	bool bVar0;
	int iVar1;
...
bool Function_116(var uParam0, int iParam1) //Position: 0x4A09 / 18953
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_117(int iParam0, int iParam1) //Position: 0x4A20 / 18976
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_76(iParam0->f_40, 2))
		{
			...
			if (Function_76(iParam0->f_40, 1))
			{
				Function_110("MIDACTION REQUEST", bVar1);
			}
			else
			{
...
bool Function_118(bool bParam0) //Position: 0x4CE9 / 19689
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_119(bool bParam0, bool bParam1) //Position: 0x4D06 / 19718
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_120(int iParam0) //Position: 0x4DA2 / 19874
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_121(int iParam0, int iParam1) //Position: 0x4DC1 / 19905
{
	iParam1 = iParam1;
	iParam0 = iParam0;
	if (Function_123(StackVal, StackVal, vLocal_3))
	{
...
var Function_122() //Position: 0x4E1F / 19999
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_123(vector3 vParam0) //Position: 0x4E28 / 20008
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_124(int iParam0) //Position: 0x4E40 / 20032
{
...
void Function_125(int iParam0) //Position: 0x4E5C / 20060
{
	iParam0 = iParam0;
	return;
}

void Function_126(bool bParam0, int iParam1) //Position: 0x4E66 / 20070
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_127(&(Local_7[iLocal_8012]), bParam0);
		iLocal_80++;
	}
...
void Function_127(int iParam0, int iParam1) //Position: 0x4EC8 / 20168
{
...
void Function_128(int iParam0) //Position: 0x4EDC / 20188
{
	iParam0 = iParam0;
	return;
}

void Function_129(int iParam0) //Position: 0x4EE6 / 20198
{
