...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA47 / 2631
{
	bool bVar0;
	bool bVar1;
...
bool Function_45(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2A66 / 10854
{
...
void Function_54(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2D74 / 11636
{
	bool bVar0;
	bool bVar1;
...
void Function_76() //Position: 0x3800 / 14336
{
	...
	MEMORY_ALLOW_SHOOTING(bLocal_26, false);
	...
	Function_23(bLocal_26);
	fVar1 = CREATE_VOLUME_IN_LAYOUT(bLocal_27, "merchantcampfire_vol", 2, Function_23(bLocal_26), 0.0f, 0.0f, 0.0f, 125.0f, 50.0f, 125.0f);
	Function_137(&fVar1, 0);
...
void Function_89(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x461C / 17948
{
	bool bVar0;
...
bool Function_90(bool bParam0, bool bParam1) //Position: 0x4670 / 18032
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(int iParam0, bool bParam1) //Position: 0x4820 / 18464
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_104(int iParam0) //Position: 0x4BA3 / 19363
{
	bool bVar0;
	bool bVar1;
...
var Function_105(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4C9D / 19613
{
	int iVar0;
	bool bVar1;
...
void Function_106(var uParam0, int iParam1) //Position: 0x4CD5 / 19669
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_107(var uParam0, bool bParam1, int iParam2) //Position: 0x4CE6 / 19686
{
	int iVar0;
...
bool Function_108(int iParam0) //Position: 0x4DAA / 19882
{
	int iVar0;
	int iVar1;
...
void Function_109() //Position: 0x5125 / 20773
{
	if (!Function_155(128))
	{
		return;
...
bool Function_110() //Position: 0x5165 / 20837
{
	int iVar0;
...
void Function_111() //Position: 0x5190 / 20880
{
	if (!Function_155(128))
	{
		return;
...
void Function_112(int iParam0, bool bParam1) //Position: 0x51D2 / 20946
{
	char* cVar0[32];
...
void Function_113(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x5256 / 21078
{
	var uVar0;
	var uVar1;
...
void Function_114(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x527F / 21119
{
...
var Function_115(var uParam0, bool bParam1) //Position: 0x52D0 / 21200
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_116() //Position: 0x52E0 / 21216
{
	return "PackedGrass";
}

var Function_117(bool bParam0, bool bParam1, bool bParam2) //Position: 0x52F4 / 21236
{
	int iVar0;
...
var Function_118() //Position: 0x5319 / 21273
{
	return "PackedMetadata";
}

void Function_119(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x5330 / 21296
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_120() //Position: 0x5456 / 21590
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_121() //Position: 0x5467 / 21607
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_122() //Position: 0x5478 / 21624
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_123(var uParam0, int iParam1) //Position: 0x5489 / 21641
{
...
var Function_124(var uParam0, int iParam1, bool bParam2) //Position: 0x54AC / 21676
{
	int iVar0;
...
var Function_125(bool bParam0) //Position: 0x54CB / 21707
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_126() //Position: 0x54D7 / 21719
{
	return Function_127(39);
}

int Function_127(int iParam0) //Position: 0x54E2 / 21730
{
	int iVar0;
...
var Function_128() //Position: 0x5510 / 21776
{
	return "PackedWeapon";
}

int Function_129(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x5525 / 21797
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_130() //Position: 0x5629 / 22057
{
	return "MPItemGiver";
}

struct<32> Function_131(bool bParam0) //Position: 0x563D / 22077
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_132(char* cParam0, char* cParam1, char* cParam2) //Position: 0x56A7 / 22183
{
	char* cVar0[32];
...
var Function_133() //Position: 0x56C6 / 22214
{
	return "PBox_";
}

var Function_134() //Position: 0x56D4 / 22228
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_135() //Position: 0x56FA / 22266
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_136() //Position: 0x5722 / 22306
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_137(float fParam0, int iParam1) //Position: 0x5748 / 22344
{
	int iVar0;
	var uVar1;
	...
	if (DECOR_CHECK_EXIST(*fParam0, "script"))
	{
		if (!IS_SCRIPT_VALID(DECOR_GET_INT(*fParam0, "script")))
		{
			LOG_ERROR("Passed an invalid script ID into ADD_AMBIENT_VOLUME_RESTRICTION");
		}
	}
	GET_VOLUME_CENTER(*fParam0, &uVar1);
	Function_139(DECOR_GET_INT(*fParam0, "script"));
	iVar0 = 0;
	while (iVar0 <= 25)
	{
		if (IS_VOLUME_VALID(StackVal))
		...
		{
			Function_138(iVar0, fParam0, &uVar1, iParam1);
			return 1;
		}
		iVar0++;
	}
	LOG_ERROR("No room to add another volume... this really shouldn't happen tell steve");
	RELEASE_VOLUME(*fParam0);
	return 0;
}

void Function_138(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x58A9 / 22697
{
	struct<8> Var0;
...
int Function_139(bool bParam0) //Position: 0x5944 / 22852
{
	int iVar0;
	vector3 vVar1;
...
void Function_140(int iParam0) //Position: 0x5AA5 / 23205
{
...
var Function_141() //Position: 0x5B06 / 23302
{
	int iVar0;
...
var Function_142(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x5B0E / 23310
{
	return Function_143(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_143(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x5B27 / 23335
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_144(int iParam0) //Position: 0x5E1A / 24090
{
	int iVar0;
...
void Function_145() //Position: 0x5ECE / 24270
{
	int iVar0;
...
bool Function_146(bool bParam0) //Position: 0x5F08 / 24328
{
	int iVar0;
...
void Function_147(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5F35 / 24373
{
	bool bVar0;
...
void Function_148() //Position: 0x6086 / 24710
{
	int iVar0;
...
var Function_149(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x60D1 / 24785
{
	int iVar0;
...
int Function_150() //Position: 0x61A1 / 24993
{
	int iVar0;
...
int Function_151() //Position: 0x62FD / 25341
{
	int iVar0;
...
bool Function_152(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x641D / 25629
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_153(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x64ED / 25837
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_154(bool bParam0) //Position: 0x661F / 26143
{
	bool bVar0;
...
bool Function_155(int iParam0) //Position: 0x663E / 26174
{
	int iVar0;
...
int Function_156() //Position: 0x665A / 26202
{
	if (Function_158())
	{
...
int Function_157() //Position: 0x6673 / 26227
{
	return Global_79349.f_16;
}

bool Function_158() //Position: 0x667F / 26239
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_159(int iParam0, bool bParam1, bool bParam2) //Position: 0x6688 / 26248
{
	var uVar0;
