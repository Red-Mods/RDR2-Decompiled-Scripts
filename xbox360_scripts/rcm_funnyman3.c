...
void main() //Position: 0x0 / 0
{
	...
	iLocal_187 = 0;
	bLocal_198 = false;
	vLocal_204 = { -3693,671f, 9,547f, 3464,691f };
	iLocal_212 = 0;
	switch (StackVal)
	{
		case 0x00000001:
		...
		case 0x00000004:
			...
			while (!IS_EXITFLAG_SET())
			{
				...
				switch (bVar0)
				{
						...
						if (IS_OBJECT_VALID(Global_63541[ScriptParam_055].f_192))
						{
							if (IS_LAYOUTREF_VALID(bLocal_197))
							{
								if (!IS_ACTOR_HOGTIED(bLocal_195))
								{
									...
									DECOR_SET_BOOL(bLocal_195, "CheckForCamera", true);
									MEMORY_ALLOW_PICKUP_WEAPONS(bLocal_195, 0);
									FIRE_STOP_FLAMES_IN_VOLUME(CREATE_VOLUME_IN_LAYOUT(bLocal_197, Function_164(), 2, *(&Global_63541[ScriptParam_055] + 100), 0.0f, Global_63541[ScriptParam_055].f_124, 0.0f, 2.0f, 3.0f, 2.0f));
								...
								{
									Function_157(&(Global_63541[3055]), 30, 0x41f00000, 0x42200000, 0);
									bVar0 = true;
								}
							}
					...
					case 0x00000001:
						if ((IS_ACTOR_VALID(bLocal_195) && !IS_ACTOR_DEAD(bLocal_195)) && !Function_154(Global_34573, bLocal_195, 1, 0, 0, 3212836864))
						{
							if (DECOR_CHECK_EXIST(Global_34573, "RunNewCamera") || !IS_ACTOR_HOGTIED(bLocal_195))
							{
								if (DECOR_CHECK_EXIST(Global_34573, "RunNewCamera"))
								{
									DECOR_REMOVE(Global_34573, "RunNewCamera");
								}
								if (DECOR_CHECK_EXIST(Global_34573, "CheckForCamera"))
								{
									DECOR_REMOVE(Global_34573, "CheckForCamera");
								}
								TASK_PRIORITY_SET(bLocal_195, true);
								TASK_STAND_STILL(bLocal_195, -1.0f, 0, 0);
								Function_153(&uLocal_201);
					...
					case 0x00000003:
						if (Function_113("$/cutscene/RCM_19_CS02/RCM_19_CS02", &iLocal_188, 25976, 25969, 24997, 24990, 24704, 24688, 1, 1, 2, 2, 0))
						{
					...
					case 0x00000005:
						Function_112("RCM_Journal_Edit", &Global_63541[ScriptParam_055] + 4, 0x40f00000);
						...
						APPEND_JOURNAL_ENTRY_DETAIL(Global_63541[ScriptParam_055].f_140, "FunnyMan3_OBJ", 0, 4, false);
						Function_111(Global_63541[ScriptParam_055].f_140, 0);
						ACTOR_DATA_GRAVITY_LIMIT(0);
						Function_151(&Global_63541[ScriptParam_055] + 144, 128);
						Function_16(30, 1, 1, 1);
						bLocal_196 = Global_63541[3055].f_204;
						Global_63541[3055].f_204 = "";
						TASK_PRIORITY_SET(bLocal_195, 2);
						Function_7(StackVal, bLocal_195, GET_OBJECT_FROM_VOLUME(4), 2);
						bVar0 = 13;
						break;
					
					case 0x0000000D:
						Function_6(bLocal_196);
						vLocal_207 = { StackVal, StackVal, Function_6(bLocal_196) };
						if (IS_ACTOR_VALID(bLocal_196))
						{
							if (StackVal && !Function_4(StackVal, Function_5(Global_34573, bLocal_196) < 150.0f, vLocal_207, 0x3f800000, 0x42960000, 1, 1, 0))
							{
								DESTROY_ACTOR(bLocal_196);
								TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
							}
							if (Function_154(Global_34573, bLocal_196, 1, 0, 0, 3212836864))
							{
								Function_152(30);
								if (IS_ACTOR_VALID(bLocal_196))
								{
						...
						else if (VDIST(Global_34574, *(&Global_63541[3055] + 100)) < 100.0f)
						{
							TERMINATE_SCRIPT(GET_THIS_SCRIPT_ID());
						}
						break;
...
void Function_1(bool bParam0, bool bParam1) //Position: 0x5E6 / 1510
{
	if (bParam0)
	{
		CAMERA_RESET(0);
...
void Function_2(bool bParam0) //Position: 0x601 / 1537
{
	if (HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
void Function_3() //Position: 0x61E / 1566
{
	RELEASE_LAYOUT_REF(bLocal_211);
	return;
}

bool Function_4(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) //Position: 0x629 / 1577
{
}

float Function_5(bool bParam0, bool bParam1) //Position: 0x645 / 1605
{
	vector3 vVar0;
	vector3 vVar3;
...
vector3 Function_6(bool bParam0) //Position: 0x736 / 1846
{
	vector3 vVar0;
...
int Function_7(bool bParam0, int iParam1, var uParam2, var uParam3) //Position: 0x747 / 1863
{
	bool bVar0;
	bool bVar1;
	...
	if (IS_ACTOR_VALID(bParam0))
	{
		...
		else
		{
			...
			while (bVar0 < (GET_NUM_DRAFT_POSITIONS(bParam0) - 1))
			{
				...
				{
					Function_8(bVar1, 0, 0, 0, 1);
				}
				bVar0++;
			}
		}
		Function_8(bParam0, iParam1, uParam2, uParam3, 1);
	}
	else
	{
		return 0;
...
int Function_8(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4) //Position: 0x827 / 2087
{
	char* cVar0[32];
	...
	Function_12(bParam0, iParam1);
	Function_11(bParam0, uParam2);
	Function_10(bParam0, uParam3);
	if (Function_9(bParam0) != 5)
	{
...
int Function_9(bool bParam0) //Position: 0xA75 / 2677
{
	return DECOR_GET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior");
}

void Function_10(bool bParam0, bool bParam1) //Position: 0xA98 / 2712
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_speed", bParam1);
	return;
}

void Function_11(bool bParam0, bool bParam1) //Position: 0xABB / 2747
{
	DECOR_SET_OBJECT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_target", bParam1);
	return;
}

void Function_12(bool bParam0, bool bParam1) //Position: 0xADF / 2783
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_behavior", bParam1);
	return;
}

void Function_13(bool bParam0, bool bParam1) //Position: 0xB05 / 2821
{
	DECOR_SET_INT(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_state", bParam1);
	return;
}

int Function_14(bool bParam0) //Position: 0xB28 / 2856
{
	return DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(bParam0), "actorRoam_ref");
}

void Function_15() //Position: 0xB46 / 2886
{
...
void Function_16(int iParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0xB90 / 2960
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_17(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0x10C5 / 4293
{
	*uParam3 = 2;
	*uParam4 = 20.0f;
	*uParam5 = 7.0f;
...
void Function_18() //Position: 0x1238 / 4664
{
	return;
}

void Function_19(var uParam0, var uParam1) //Position: 0x123E / 4670
{
	if (Global_3381)
	{
		return;
...
bool Function_20() //Position: 0x1280 / 4736
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_21(bool bParam0) //Position: 0x1289 / 4745
{
...
void Function_22() //Position: 0x12DA / 4826
{
	Function_49();
	Function_48();
	Function_48();
...
void Function_23() //Position: 0x130D / 4877
{
...
void Function_24() //Position: 0x1413 / 5139
{
	float fVar0;
...
void Function_25() //Position: 0x1446 / 5190
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_26() //Position: 0x15D4 / 5588
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_27() //Position: 0x1788 / 6024
{
	Function_28(&Global_28260, 1, 0);
	return;
}

void Function_28(int iParam0, bool bParam1, var uParam2) //Position: 0x1796 / 6038
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
var Function_29() //Position: 0x1987 / 6535
{
...
struct<8> Function_30() //Position: 0x199C / 6556
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_31(int iParam0, bool bParam1, bool bParam2) //Position: 0x1A37 / 6711
{
	int iVar0;
...
void Function_32(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1CD2 / 7378
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_33(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_164(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_33(int iParam0) //Position: 0x22FF / 8959
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_34(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2310 / 8976
{
	char* cVar0[32];
...
struct<32> Function_35(char* cParam0, char* cParam1) //Position: 0x2405 / 9221
{
	char* cVar0[32];
...
void Function_36(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x241E / 9246
{
	float fVar0;
...
var Function_37(int iParam0, int iParam1) //Position: 0x2483 / 9347
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_38(int iParam0, bool bParam1) //Position: 0x2495 / 9365
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_39(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x24A7 / 9383
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_40(int iParam0) //Position: 0x25D7 / 9687
{
	return Global_35278[iParam020].f_48;
}

float Function_41(int iParam0) //Position: 0x25E6 / 9702
{
	if (!iParam0 != 4294967295)
	{
...
var Function_42(int iParam0) //Position: 0x261F / 9759
{
	if (iParam0 == 4294967295)
	{
...
void Function_43(int iParam0) //Position: 0x265C / 9820
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_44(int iParam0, bool bParam1, bool bParam2) //Position: 0x27F6 / 10230
{
	int iVar0;
	int iVar1;
...
int Function_45(bool bParam0) //Position: 0x2A10 / 10768
{
...
struct<8> Function_46() //Position: 0x2A51 / 10833
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_47() //Position: 0x2ADA / 10970
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_48() //Position: 0x2B71 / 11121
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_49() //Position: 0x2BF0 / 11248
{
...
int Function_50(int iParam0, bool bParam1, int iParam2) //Position: 0x2C16 / 11286
{
	int iVar0;
	int iVar1;
...
void Function_51() //Position: 0x2E20 / 11808
{
	vector3 vVar0;
	var uVar3;
...
bool Function_52(vector3 vParam0) //Position: 0x2EC1 / 11969
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_53(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x2ED9 / 11993
{
	int iVar0;
...
vector3 Function_54() //Position: 0x2FC0 / 12224
{
	return 0.0f, 0.0f, 0.0f;
}

bool Function_55(int iParam0) //Position: 0x2FC9 / 12233
{
...
int Function_56(bool bParam0, bool bParam1) //Position: 0x2FDF / 12255
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_57(vector3 vParam0, vector3 vParam3) //Position: 0x30A6 / 12454
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
bool Function_58(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x30C3 / 12483
{
	uParam0 = uParam0;
...
void Function_59(bool bParam0) //Position: 0x3167 / 12647
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void Function_60(int iParam0, int iParam1) //Position: 0x3309 / 13065
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = iParam0->f_96;
	iParam0->f_192 = CREATE_GATEWAY_FROM_PARAMS_IN_LAYOUT(Global_63535, Function_164(), *(iParam0 + 112), 0.0f, 0.0f, 0.0f, iVar0, iVar0, iVar0, 0, Global_34573, iParam1, iParam0->f_92, 0, 1, 1);
	Function_61(iParam0);
...
void Function_61(int iParam0) //Position: 0x33C3 / 13251
{
	float fVar0;
	bool bVar1;
	...
	iParam0->f_216 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_164(), 2, *(iParam0 + 112), 0.0f, 0.0f, 0.0f, 2.0f, 2.0f, 2.0f);
...
int Function_62(var uParam0, int iParam1) //Position: 0x3465 / 13413
{
	int iVar0;
	var uVar1;
...
void Function_63(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x35C6 / 13766
{
	struct<8> Var0;
...
struct<32> Function_64(bool bParam0) //Position: 0x3661 / 13921
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_65(char* cParam0, char* cParam1, char* cParam2) //Position: 0x36CB / 14027
{
	char* cVar0[32];
...
int Function_66(bool bParam0) //Position: 0x36EA / 14058
{
	int iVar0;
	vector3 vVar1;
...
float Function_67(bool bParam0, vector3 vParam1) //Position: 0x384B / 14411
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0) //Position: 0x38C5 / 14533
{
	vector3 vVar0;
...
void Function_69(int iParam0) //Position: 0x392F / 14639
{
...
bool Function_70(int iParam0) //Position: 0x3990 / 14736
{
...
void Function_71(int iParam0, int iParam1) //Position: 0x39A6 / 14758
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int Function_72(int iParam0) //Position: 0x3AEB / 15083
{
...
bool Function_73(int iParam0) //Position: 0x3B17 / 15127
{
...
bool Function_74(int iParam0, int iParam1) //Position: 0x3B2C / 15148
{
...
bool Function_75(int iParam0, int iParam1) //Position: 0x3C41 / 15425
{
	int iVar0;
...
bool Function_76(int iParam0) //Position: 0x3D85 / 15749
{
...
bool Function_77(int iParam0) //Position: 0x3DA9 / 15785
{
...
bool Function_78(int iParam0) //Position: 0x3DBE / 15806
{
...
var Function_79(int iParam0) //Position: 0x3DD5 / 15829
{
...
bool Function_80(int iParam0) //Position: 0x3DEF / 15855
{
...
bool Function_81(int iParam0) //Position: 0x3E05 / 15877
{
	return StackVal;
}

bool Function_82(var uParam0, int iParam1) //Position: 0x3E15 / 15893
{
	int iVar0;
...
bool Function_83(int iParam0) //Position: 0x3E31 / 15921
{
	if (!iParam0->f_152)
	{
...
bool Function_84(int iParam0) //Position: 0x3E78 / 15992
{
...
bool Function_85(int iParam0) //Position: 0x3ED1 / 16081
{
	int iVar0;
...
bool Function_86(var uParam0, int iParam1) //Position: 0x3EED / 16109
{
	int iVar0;
...
int Function_87(int iParam0) //Position: 0x3F09 / 16137
{
...
bool Function_88(int iParam0) //Position: 0x3F1E / 16158
{
...
int Function_89(int iParam0) //Position: 0x3F33 / 16179
{
...
bool Function_90(var uParam0, bool bParam1) //Position: 0x3F48 / 16200
{
	return (uParam0 && bParam1) == 0;
}

void Function_91() //Position: 0x3F55 / 16213
{
...
var Function_92(int iParam0, int iParam1) //Position: 0x3FD0 / 16336
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_93(int iParam0, bool bParam1) //Position: 0x4BDB / 19419
{
	int iVar0;
...
int Function_94(int iParam0) //Position: 0x4C18 / 19480
{
	int iVar0;
	int iVar1;
...
bool Function_95(int iParam0) //Position: 0x4C67 / 19559
{
...
int Function_96(int iParam0) //Position: 0x4C7D / 19581
{
...
void Function_97() //Position: 0x4CE6 / 19686
{
...
bool Function_98(int iParam0) //Position: 0x4D09 / 19721
{
	if (!Function_95(iParam0))
	{
...
bool Function_99(int iParam0, int iParam1) //Position: 0x4D5A / 19802
{
	int iVar0;
...
bool Function_100(int iParam0) //Position: 0x4D87 / 19847
{
	if (!Function_95(iParam0))
	{
...
void Function_101(bool bParam0) //Position: 0x4DD9 / 19929
{
	bool bVar0;
...
void Function_102() //Position: 0x4E13 / 19987
{
	bool bVar0;
...
void Function_103(int iParam0, int iParam1) //Position: 0x4E71 / 20081
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_104(bool bParam0) //Position: 0x4E84 / 20100
{
	PRINTSTRING("Day ");
...
void Function_105(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x4ECA / 20170
{
	bool bVar0;
	char* cVar1[16];
...
void Function_106(char* cParam0, int iParam1) //Position: 0x4F36 / 20278
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_107(bool bParam0, var uParam1, int iParam2) //Position: 0x4F6D / 20333
{
	var uVar0;
	char* cVar1[16];
...
int Function_108(char* cParam0) //Position: 0x4FE5 / 20453
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_109(int iParam0) //Position: 0x5086 / 20614
{
	int iVar0;
	int iVar1;
...
bool Function_110(var uParam0, int iParam1) //Position: 0x50C3 / 20675
{
...
void Function_111(bool bParam0, bool bParam1) //Position: 0x50D6 / 20694
{
	bool bVar0;
...
void Function_112(bool bParam0, bool bParam1, bool bParam2) //Position: 0x50FB / 20731
{
...
bool Function_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) //Position: 0x5135 / 20789
{
	var uVar0;
	var uVar7;
	bool bVar8;
...
int Function_114(bool bParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16) //Position: 0x51DE / 20958
{
	if (!bParam15)
	{
...
void Function_115(bool bParam0) //Position: 0x57F2 / 22514
{
	bParam0 = bParam0;
	HUD_ENABLE(bParam0);
	HUD_CLEAR_SMALL_TEXT_QUEUE();
...
void Function_116() //Position: 0x5897 / 22679
{
	if (UI_ISACTIVE("nCutscenes"))
	{
		UI_POP("nCutscenes");
...
void Function_117() //Position: 0x58DC / 22748
{
...
void Function_118(bool bParam0, bool bParam1) //Position: 0x58EE / 22766
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar0 = CREATE_OBJECTSET_IN_LAYOUT(Function_164(), bParam1, 4294967295, 1);
...
bool Function_119(bool bParam0) //Position: 0x596E / 22894
{
	bool bVar0;
...
float Function_120(int iParam0) //Position: 0x599D / 22941
{
...
bool Function_121(int iParam0) //Position: 0x5A65 / 23141
{
	return Function_90(*iParam0, 2);
}

bool Function_122(int iParam0) //Position: 0x5A72 / 23154
{
	return Function_90(*iParam0, 1);
}

int Function_123(bool bParam0) //Position: 0x5A7F / 23167
{
	bool bVar0;
	bool bVar1;
...
bool Function_124() //Position: 0x5B37 / 23351
{
	bool bVar0;
	bool bVar1;
...
void Function_125(int iParam0) //Position: 0x5B71 / 23409
{
	Function_126(iParam0, 0.0f);
	return;
}

void Function_126(var uParam0, float fParam1) //Position: 0x5B7D / 23421
{
...
bool Function_127(int iParam0) //Position: 0x5B9E / 23454
{
	return iParam0->f_20;
}

void Function_128(var uParam0, int iParam1) //Position: 0x5BA8 / 23464
{
	Function_129(uParam0, iParam1, 0);
	return;
}

void Function_129(var uParam0, bool bParam1, bool bParam2) //Position: 0x5BB6 / 23478
{
	if (!IS_LOCAL_PLAYER_VALID(0))
	{
		return;
...
int Function_130(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x5D02 / 23810
{
	int iVar0;
	int iVar1;
...
void Function_131(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) //Position: 0x5F22 / 24354
{
	if (!HUD_IS_FADED())
	{
		if (!HUD_IS_FADING())
...
int Function_132() //Position: 0x5F4B / 24395
{
	bool bVar0;
	bool bVar1;
...
void Function_133() //Position: 0x5F96 / 24470
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = CREATE_OBJECTSET_IN_LAYOUT(Function_164(), Global_63535, 15, 0);
	vVar3 = { StackVal, StackVal, Global_34574 };
	bVar6 = CREATE_VOLUME_IN_LAYOUT(Global_63535, Function_164(), 2, vVar3, 0.0f, 0.0f, 0.0f, 20.0f, 20.0f, 20.0f);
...
int Function_134() //Position: 0x6070 / 24688
{
	HUD_FADE_IN(1.0f, 1065353216);
	return 1;
}

int Function_135() //Position: 0x6080 / 24704
{
...
void Function_136(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9) //Position: 0x6099 / 24729
{
	bool bVar0;
...
void Function_137() //Position: 0x6189 / 24969
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
int Function_138() //Position: 0x619E / 24990
{
	return 1;
}

int Function_139() //Position: 0x61A5 / 24997
{
	if (!iLocal_212)
	{
		Function_140(StackVal, StackVal, vLocal_204, bLocal_210);
		iLocal_212 = 1;
	}
	return 1;
}

void Function_140(vector3 vParam0) //Position: 0x61BE / 25022
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_141(bool bParam0, float fParam1) //Position: 0x6344 / 25412
{
...
void Function_142() //Position: 0x6442 / 25666
{
...
void Function_143() //Position: 0x6474 / 25716
{
...
int Function_144() //Position: 0x6571 / 25969
{
	return 1;
}

int Function_145() //Position: 0x6578 / 25976
{
	bLocal_210 = CREATE_VOLUME_IN_LAYOUT(bLocal_211, "tempcutscenevol", 2, *(&Global_63541[3055] + 100), 0.0f, 0.0f, 0.0f, 5.0f, 5.0f, 5.0f);
	Function_148(0, 0, 1, 1, 0, 1, 1, bLocal_210, 1, 1, 1, 1);
	Function_146(StackVal, StackVal, bLocal_211, *(&Global_63541[3055] + 112), &bLocal_210, 0, 0.0f, 0.0f, 0.0f, 1, 1);
	return 1;
}

void Function_146(bool bParam0, vector3 vParam1, var uParam4, bool bParam5, var uParam6, var uParam7, var uParam8, bool bParam9, bool bParam10) //Position: 0x65D2 / 26066
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
void Function_147(bool bParam0, bool bParam1) //Position: 0x6840 / 26688
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void Function_148(bool bParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11) //Position: 0x68B5 / 26805
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (IS_LOCAL_PLAYER_VALID(0))
	{
		...
		if (bParam8)
		{
			...
			else
			{
				FIRE_STOP_ALL_FIRES();
				Function_6(bVar1);
				bVar0 = CREATE_VOLUME_IN_LAYOUT(GET_AMBIENT_LAYOUT(), Function_164(), 2, Function_6(bVar1), 0.0f, 0.0f, 0.0f, 100.0f, 100.0f, 100.0f);
...
void Function_149(int iParam0) //Position: 0x6B5E / 27486
{
	int iVar0;
...
var Function_150() //Position: 0x6B92 / 27538
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_151(var uParam0, int iParam1) //Position: 0x6C11 / 27665
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_152(int iParam0) //Position: 0x6C20 / 27680
{
	char* cVar0[32];
...
void Function_153(bool bParam0) //Position: 0x6D82 / 28034
{
	bParam0->f_4 = 0.0f;
	bParam0->f_8 = 0.0f;
	*bParam0 = 0;
...
bool Function_154(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x6D96 / 28054
{
	if (!IS_ACTOR_VALID(bParam0))
	{
		return 0;
...
void Function_155() //Position: 0x6E83 / 28291
{
	var uVar0;
...
void Function_156(int iParam0, int iParam1) //Position: 0x6EA9 / 28329
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_157(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4) //Position: 0x6EF2 / 28402
{
	bool bVar0;
	var uVar1;
	var uVar2;
...
float Function_158(float fParam0) //Position: 0x7053 / 28755
{
...
int Function_159(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, int iParam13) //Position: 0x7088 / 28808
{
	char* cVar0[64];
	vector3 vVar16;
	vector3 vVar19;
...
void Function_160() //Position: 0x72CE / 29390
{
	bool bVar0;
	vector3 vVar1;
	struct<5> Var4;
...
void Function_161(char* cParam0, vector3 vParam1) //Position: 0x7322 / 29474
{
	char* cVar0[64];
...
bool Function_162(bool bParam0, vector3 vParam1, float fParam4) //Position: 0x744A / 29770
{
	if (IS_ACTOR_VALID(bParam0))
	{
		Function_68(bParam0);
...
int Function_163() //Position: 0x74D4 / 29908
{
	if (IS_PS3())
	{
		return 1;
...
var Function_164() //Position: 0x74E3 / 29923
{
	bool bVar0;
