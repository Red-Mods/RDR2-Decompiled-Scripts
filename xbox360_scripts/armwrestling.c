...
void Function_1() //Position: 0x6A / 106
{
	...
	while (StackVal <= iVar0)
	{
		if (IS_ACTOR_VALID((*&Local_49 + 4)[iVar0]))
		{
			...
			SET_DRAW_ACTOR((*&Local_49 + 4)[iVar0], true);
	...
	DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmWinning", false);
	DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmLosing", false);
	DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmWinning", false);
	DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmLosing", false);
	Function_177();
	...
	if (iLocal_2)
	{
		Function_24(Local_49, 1, 1, 1, 0);
	}
	else if (bLocal_3)
	{
		Function_20(Local_49);
	}
	else
	{
		Function_2(Local_49);
...
void Function_3(bool bParam0) //Position: 0x216 / 534
{
...
void Function_6(bool bParam0) //Position: 0x268 / 616
{
...
void Function_10(bool bParam0) //Position: 0x384 / 900
{
	int iVar0;
...
void Function_11(char* cParam0, bool bParam1) //Position: 0x3D7 / 983
{
	struct<4> Var0;
...
int Function_13(bool bParam0) //Position: 0x520 / 1312
{
...
bool Function_14(int iParam0) //Position: 0x540 / 1344
{
...
int Function_15(bool bParam0) //Position: 0x557 / 1367
{
	if (!Function_14(bParam0))
	{
		return 0;
...
void Function_16() //Position: 0x572 / 1394
{
	int iVar0;
	int iVar1;
	char* cVar2[64];
...
void Function_17(int iParam0, var uParam1, var uParam2, var uParam3) //Position: 0x7B9 / 1977
{
	*uParam3 = iParam0 & 15;
...
bool Function_18(int iParam0) //Position: 0x7E2 / 2018
{
...
bool Function_19(int iParam0) //Position: 0x806 / 2054
{
...
void Function_20(int iParam0) //Position: 0x81B / 2075
{
	Function_21(iParam0);
	Function_6(2);
	Function_3(12);
...
struct<16> Function_22(int iParam0) //Position: 0x8DF / 2271
{
	char* cVar0[16];
...
struct<24> Function_23(char* cParam0) //Position: 0x909 / 2313
{
	char* cVar0[24];
...
void Function_24(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4) //Position: 0xB5F / 2911
{
	var uVar0;
	bool bVar1;
	int iVar2;
...
int Function_26(int iParam0, bool bParam1) //Position: 0xC7C / 3196
{
	int iVar0;
...
int Function_27(int iParam0) //Position: 0xCB9 / 3257
{
...
bool Function_28(int iParam0) //Position: 0xCD3 / 3283
{
...
void Function_29(int iParam0, bool bParam1) //Position: 0xCE9 / 3305
{
	int iVar0;
	int iVar1;
...
void Function_30(bool bParam0, int iParam1, int iParam2, bool bParam3) //Position: 0xFE0 / 4064
{
	bool bVar0;
	char* cVar1[16];
...
void Function_31(char* cParam0, int iParam1) //Position: 0x104C / 4172
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_32(bool bParam0, var uParam1, int iParam2) //Position: 0x1083 / 4227
{
	var uVar0;
	char* cVar1[16];
...
bool Function_33(var uParam0, int iParam1) //Position: 0x10FB / 4347
{
...
int Function_34(char* cParam0) //Position: 0x110E / 4366
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_35(int iParam0) //Position: 0x11AF / 4527
{
	int iVar0;
	int iVar1;
...
void Function_36(int iParam0, int iParam1) //Position: 0x11EC / 4588
{
	*iParam0 = (*iParam0 - (*iParam0 && iParam1));
	return;
}

void Function_37(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x11FF / 4607
{
	int iVar0;
	struct<6> Var1;
	struct<4> Var7;
...
void Function_38(int iParam0, int iParam1) //Position: 0x1411 / 5137
{
...
void Function_39(bool bParam0, int iParam1) //Position: 0x144B / 5195
{
	if (Global_3381)
	{
		return;
...
bool Function_40() //Position: 0x148D / 5261
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_41(bool bParam0) //Position: 0x1496 / 5270
{
...
void Function_42() //Position: 0x14E7 / 5351
{
	Function_70();
	Function_69();
	Function_69();
...
void Function_43() //Position: 0x151A / 5402
{
...
void Function_44() //Position: 0x1620 / 5664
{
	float fVar0;
...
void Function_45() //Position: 0x1653 / 5715
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_46() //Position: 0x17E1 / 6113
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_47() //Position: 0x1995 / 6549
{
	Function_48(&Global_28260, 1, 0);
	return;
}

void Function_48(int iParam0, bool bParam1, var uParam2) //Position: 0x19A3 / 6563
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int Function_49() //Position: 0x1B94 / 7060
{
...
struct<8> Function_50() //Position: 0x1BA9 / 7081
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_51(int iParam0, bool bParam1, bool bParam2) //Position: 0x1C44 / 7236
{
	int iVar0;
...
void Function_52(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1EDF / 7903
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_53() //Position: 0x250C / 9484
{
	int iVar0;
...
var Function_54(int iParam0) //Position: 0x2514 / 9492
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_55(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x2525 / 9509
{
	char* cVar0[32];
...
struct<32> Function_56(char* cParam0, char* cParam1) //Position: 0x261A / 9754
{
	char* cVar0[32];
...
void Function_57(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2633 / 9779
{
	float fVar0;
...
var Function_58(int iParam0, int iParam1) //Position: 0x2698 / 9880
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_59(int iParam0, bool bParam1) //Position: 0x26AA / 9898
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_60(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x26BC / 9916
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_61(int iParam0) //Position: 0x27EC / 10220
{
	return Global_35278[iParam020].f_48;
}

float Function_62(int iParam0) //Position: 0x27FB / 10235
{
	if (!iParam0 != 4294967295)
	{
...
float Function_63(int iParam0) //Position: 0x2834 / 10292
{
	if (iParam0 == 4294967295)
	{
...
void Function_64(int iParam0) //Position: 0x2871 / 10353
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_65(int iParam0, bool bParam1, bool bParam2) //Position: 0x2A0B / 10763
{
	int iVar0;
	int iVar1;
...
int Function_66(bool bParam0) //Position: 0x2C25 / 11301
{
...
struct<8> Function_67() //Position: 0x2C66 / 11366
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_68() //Position: 0x2CEF / 11503
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_69() //Position: 0x2D86 / 11654
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_70() //Position: 0x2E05 / 11781
{
...
int Function_71(int iParam0, bool bParam1, int iParam2) //Position: 0x2E2B / 11819
{
	int iVar0;
	int iVar1;
...
void Function_72() //Position: 0x3035 / 12341
{
	vector3 vVar0;
	var uVar3;
...
bool Function_73(vector3 vParam0) //Position: 0x30D6 / 12502
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

vector3 Function_74(var uParam0, var uParam1, var uParam2, var uParam3) //Position: 0x30EE / 12526
{
	int iVar0;
...
vector3 Function_75() //Position: 0x31D5 / 12757
{
	return 0.0f, 0.0f, 0.0f;
}

void Function_76(int iParam0, int iParam1) //Position: 0x31DE / 12766
{
	*iParam0 = (*iParam0 || iParam1);
	return;
}

bool Function_77(int iParam0) //Position: 0x31ED / 12781
{
...
int Function_78(bool bParam0, bool bParam1) //Position: 0x3203 / 12803
{
	bool bVar0;
	float fVar1;
	float fVar2;
...
float Function_79(vector3 vParam0, vector3 vParam3) //Position: 0x32CA / 13002
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
void Function_80(bool bParam0) //Position: 0x32E7 / 13031
{
	int iVar0;
	int iVar1;
...
bool Function_81(int iParam0) //Position: 0x37C3 / 14275
{
...
int Function_82(bool bParam0) //Position: 0x37D9 / 14297
{
	if (!Function_14(bParam0))
	{
		return 4294967295;
...
int Function_83(bool bParam0) //Position: 0x37F8 / 14328
{
	if (!Function_14(bParam0))
	{
		return 4294967295;
...
void Function_84(int iParam0, bool bParam1) //Position: 0x3812 / 14354
{
	bool bVar0;
...
int Function_85(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x3879 / 14457
{
	int iVar0;
	int iVar1;
...
void Function_86() //Position: 0x3A99 / 15001
{
	int iVar0;
	int iVar1;
...
int Function_87(int iParam0, bool bParam1, bool bParam2, int iParam3) //Position: 0x3B19 / 15129
{
	int iVar0;
	var uVar1;
...
void Function_88(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, char* cParam9, bool bParam10) //Position: 0x3E6B / 15979
{
	CLEAR_STAT_MESSAGE();
	if (!Global_49306)
	{
...
int Function_89(int iParam0) //Position: 0x3EEE / 16110
{
...
void Function_90() //Position: 0x3F08 / 16136
{
	struct<73> Var0;
...
void Function_91(int iParam0, int iParam1, bool bParam2) //Position: 0x3F36 / 16182
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_92(int iParam0, bool bParam1, bool bParam2) //Position: 0x41D3 / 16851
{
	int iVar0;
	bool bVar1;
...
void Function_93(int iParam0, int iParam1) //Position: 0x4396 / 17302
{
	switch (iParam1)
	{
		case 0x00000000:
...
int Function_94(int iParam0, char* cParam1, bool bParam2) //Position: 0x45F4 / 17908
{
	bool bVar0;
	int iVar1;
...
int Function_95() //Position: 0x4779 / 18297
{
	int iVar0;
...
void Function_96() //Position: 0x4818 / 18456
{
	int iVar0;
	int iVar1;
...
void Function_97(int iParam0) //Position: 0x48C7 / 18631
{
...
var Function_98(int iParam0) //Position: 0x4925 / 18725
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_99(int iParam0, bool bParam1) //Position: 0x49B4 / 18868
{
	bool bVar0;
	int iVar1;
...
var Function_100(int iParam0, int iParam1) //Position: 0x4B51 / 19281
{
	int iVar0;
...
void Function_101() //Position: 0x4B92 / 19346
{
	Function_103(3, 0.0f);
...
int Function_102(int iParam0, int iParam1) //Position: 0x4BA8 / 19368
{
	if (iParam0 == 4294967295)
	{
...
int Function_103(int iParam0, int iParam1) //Position: 0x4BE8 / 19432
{
	if (iParam0 == 4294967295)
	{
...
var Function_104(int iParam0) //Position: 0x4C28 / 19496
{
	return (*&Global_12976 + 104)[iParam0];
}

int Function_105(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4) //Position: 0x4C37 / 19511
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_106(int iParam0) //Position: 0x4DFF / 19967
{
	switch (iParam0)
	{
		case 0x00000002:
...
var Function_107() //Position: 0x4E94 / 20116
{
	struct<73> Var0;
...
void Function_108(int iParam0) //Position: 0x4EB9 / 20153
{
	if (!Function_28(iParam0))
	{
		return;
...
void Function_109(int iParam0, bool bParam1, bool bParam2) //Position: 0x5374 / 21364
{
	int iVar0;
	bool bVar1;
...
var Function_110(int iParam0) //Position: 0x5689 / 22153
{
	switch (iParam0)
	{
		case 0x00000000:
...
int Function_111(int iParam0, bool bParam1, int iParam2) //Position: 0x572C / 22316
{
	int iVar0;
	int iVar1;
...
int Function_112(int iParam0, bool bParam1) //Position: 0x5927 / 22823
{
	bool bVar0;
	int iVar1;
...
int Function_113(bool bParam0, bool bParam1) //Position: 0x5AC3 / 23235
{
	bool bVar0;
...
void Function_114(int iParam0, var uParam1, bool bParam2) //Position: 0x5B8E / 23438
{
	struct<4> Var0;
...
void Function_115(int iParam0) //Position: 0x647E / 25726
{
	bool bVar0;
...
void Function_116(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x65ED / 26093
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
bool Function_117(vector3 vParam0, vector3 vParam3) //Position: 0x66F3 / 26355
{
	vector3 vVar0;
...
vector3 Function_118(int iParam0) //Position: 0x6720 / 26400
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_119(vector3 vParam0) //Position: 0x6777 / 26487
{
	bool bVar0;
...
void Function_120(bool bParam0, bool bParam1) //Position: 0x67C5 / 26565
{
...
void Function_121(bool bParam0, bool bParam1, bool bParam2) //Position: 0x6819 / 26649
{
	char* cVar0[32];
	char* cVar8[32];
...
void Function_122() //Position: 0x69B7 / 27063
{
	return;
}

bool Function_123(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x69BD / 27069
{
	iParam0 = iParam0;
...
void Function_124(bool bParam0, int iParam1) //Position: 0x6A61 / 27233
{
	if (!Function_125(bParam0))
	{
...
bool Function_125(int iParam0) //Position: 0x6AB6 / 27318
{
...
bool Function_126(int iParam0) //Position: 0x6ACC / 27340
{
...
bool Function_127(int iParam0, int iParam1) //Position: 0x6B1D / 27421
{
	int iVar0;
...
void Function_128(var uParam0, int iParam1) //Position: 0x6B4A / 27466
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_129(var uParam0, int iParam1) //Position: 0x6B59 / 27481
{
	int iVar0;
...
void Function_130(var uParam0, int iParam1) //Position: 0x6B70 / 27504
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_131(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x6B7F / 27519
{
	struct<8> Var0;
...
void Function_132(int iParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x6CC9 / 27849
{
	int iVar0;
...
bool Function_133() //Position: 0x6D14 / 27924
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_134(bool bParam0) //Position: 0x6D41 / 27969
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
...
int Function_135(int iParam0) //Position: 0x6EF1 / 28401
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_136(bool bParam0, bool bParam1) //Position: 0x6F48 / 28488
{
	bool bVar0;
...
var Function_137(int iParam0) //Position: 0x6F6D / 28525
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool Function_138(bool bParam0, int iParam1) //Position: 0x6FC3 / 28611
{
	int iVar0;
...
int Function_139(bool bParam0) //Position: 0x7022 / 28706
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_140(int iParam0) //Position: 0x702E / 28718
{
...
bool Function_141(int iParam0) //Position: 0x704A / 28746
{
	if (!Function_125(iParam0))
	{
...
int Function_142(int iParam0, int iParam1) //Position: 0x709C / 28828
{
	if (iParam0 == 4294967295)
	{
...
int Function_143(int iParam0, int iParam1) //Position: 0x710F / 28943
{
	if (iParam0 == 4294967295)
	{
...
int Function_144(int iParam0, int iParam1) //Position: 0x716B / 29035
{
	if (iParam0 == 4294967295)
	{
...
int Function_145(int iParam0, int iParam1) //Position: 0x71DC / 29148
{
	if (iParam0 == 4294967295)
	{
...
void Function_146(int iParam0) //Position: 0x7236 / 29238
{
	bool bVar0;
	bool bVar1;
...
void Function_147(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4) //Position: 0x74E2 / 29922
{
	char* cVar0[32];
	struct<8> Var8;
...
void Function_148(int iParam0, bool bParam1) //Position: 0x7771 / 30577
{
	if (iParam0 >= 16)
	{
		LOG_ERROR("STAT_SET_BIT: Attempting to use a Stat out of bounds.");
...
void Function_149() //Position: 0x77D0 / 30672
{
...
var Function_150(int iParam0, int iParam1) //Position: 0x784B / 30795
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
...
int Function_151(int iParam0) //Position: 0x8443 / 33859
{
...
int Function_152(int iParam0) //Position: 0x8458 / 33880
{
	int iVar0;
	int iVar1;
...
bool Function_153(bool bParam0, int iParam1) //Position: 0x84A7 / 33959
{
	return (bParam0 && iParam1) == 0;
}

void Function_154(bool bParam0, bool bParam1) //Position: 0x84B4 / 33972
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
void Function_155(bool bParam0, bool bParam1, int iParam2) //Position: 0x8505 / 34053
{
	bool bVar0;
...
bool Function_156(int iParam0, int iParam1) //Position: 0x8573 / 34163
{
	return !(iParam0 != 4294967295 || (iParam1 && iParam0 != 0));
}

void Function_157(int iParam0) //Position: 0x8586 / 34182
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_158(int iParam0) //Position: 0x8685 / 34437
{
	int iVar0;
...
bool Function_159(var uParam0, int iParam1) //Position: 0x86DD / 34525
{
	int iVar0;
...
int Function_160(bool bParam0, bool bParam1, int iParam2) //Position: 0x86F9 / 34553
{
...
bool Function_161(int iParam0) //Position: 0x8750 / 34640
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void Function_162(int iParam0) //Position: 0x8762 / 34658
{
	int iVar0;
...
void Function_163(int iParam0) //Position: 0x8796 / 34710
{
...
void Function_164(bool bParam0, bool bParam1, bool bParam2) //Position: 0x87FD / 34813
{
	bool bVar0;
...
void Function_165(bool bParam0, bool bParam1, bool bParam2) //Position: 0x88DA / 35034
{
	int iVar0;
...
void Function_166() //Position: 0x8A53 / 35411
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_167(int iParam0) //Position: 0x8A5F / 35423
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_168() //Position: 0x8AA5 / 35493
{
	return;
}

void Function_169() //Position: 0x8AAB / 35499
{
	MISSION_AUDIO_BANK_NO_LONGER_NEEDED();
	Function_170(&bLocal_201);
	return;
}

void Function_170(int iParam0) //Position: 0x8AB9 / 35513
{
	int iVar0;
...
void Function_171(var uParam0, int iParam1) //Position: 0x8ADF / 35551
{
...
void Function_172(var uParam0, int iParam1) //Position: 0x8C0D / 35853
{
	int iVar0;
...
bool Function_173(var uParam0, int iParam1) //Position: 0x8C27 / 35879
{
	int iVar0;
...
void Function_174(int iParam0) //Position: 0x8C44 / 35908
{
	if (Function_153(iParam0, 1) && !Function_153(Global_26119, 1))
	{
	}
...
void Function_175(int iParam0) //Position: 0x8C71 / 35953
{
	Function_176(&Global_28842, iParam0);
	return;
}

void Function_176(var uParam0, var uParam1) //Position: 0x8C7F / 35967
{
...
void Function_177() //Position: 0x8C9A / 35994
{
...
void Function_178() //Position: 0x8DB4 / 36276
{
	FLASH_SET_INT("numberSystem", "showBar", false);
	UI_EXIT("Scorebox");
	UI_EXIT("Scorebox_Cash");
	UI_EXIT("Scorebox_Bet");
	Function_179();
...
void Function_179() //Position: 0x8E0E / 36366
{
	Function_180(0);
	Function_180(1);
	Function_180(2);
...
int Function_180(bool bParam0) //Position: 0x8E32 / 36402
{
	UI_HIDE_PROMPT(bParam0);
	return 1;
}

void Function_181(bool bParam0, bool bParam1) //Position: 0x8E3E / 36414
{
	switch (bParam0)
	{
		case 0x00000000:
...
void Function_182() //Position: 0x8FB1 / 36785
{
	SET_AMBIENT_NUM_ACTORS_REQUESTED_FOR_MISSIONS(0);
	SET_ACTOR_UPDATE_PRIORITY(Function_49(), true);
	Function_185(1);
	SET_RETICLE_DRAW_DISABLED_BY_SCRIPT(0, 0);
	AUDIO_MG_STOP();
	SET_POP_DENSITY_MULTIPLIER(1.0f);
	SET_TIME_ACCELERATION(Global_63398);
	DECOR_REMOVE(GET_OBJECT_FROM_ACTOR(Function_49()), "iQuitMinigame");
	RESET_FACTIONS();
	Function_184();
	SET_PLAYER_CONTROL(0, 1, 0, 0);
	HUD_ENABLE(true);
...
void Function_183() //Position: 0x9033 / 36915
{
	HUD_CLEAR_BIG_TEXT();
	HUD_CLEAR_COUNTER();
	HUD_CLEAR_HELP();
...
void Function_184() //Position: 0x9048 / 36936
{
...
void Function_185(var uParam0) //Position: 0x905C / 36956
{
	Global_26316.f_56 = (Global_26316.f_56 || uParam0);
	return;
}

void Function_186() //Position: 0x906F / 36975
{
	int iVar0[3];
	int iVar4;
	...
	if (Function_208(0))
	{
		...
		iVar0[1] = "Fail";
		iVar0[2] = "Cancel";
		iVar4 = Function_194(&uLocal_9, &iVar0, "RDR MISSION MENU", GET_DEBUG_PADINDEX(), 0);
		if (iVar4 == 0)
		{
			Function_187();
			iLocal_0 = 3;
...
void Function_187() //Position: 0x9103 / 37123
{
	Function_189();
	Function_188(10, 3);
	return;
...
void Function_188(int iParam0, int iParam1) //Position: 0x9112 / 37138
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_189() //Position: 0x9249 / 37449
{
...
void Function_190() //Position: 0x9294 / 37524
{
	Function_191(25, 2);
	return;
}

void Function_191(int iParam0, int iParam1) //Position: 0x92A0 / 37536
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_192(int iParam0, int iParam1) //Position: 0x949E / 38046
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_193() //Position: 0x95D5 / 38357
{
	if (Global_3380)
	{
		return 1;
...
var Function_194(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x963C / 38460
{
	struct<33> Var0;
...
void Function_195(int iParam0, int iParam1, int iParam2) //Position: 0x9703 / 38659
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool Function_196(var uParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, int iParam5, int iParam6) //Position: 0x975F / 38751
{
	char* cVar0[64];
...
void Function_197(bool bParam0) //Position: 0x98E5 / 39141
{
	bool bVar0;
	char* cVar1[16];
...
void Function_198(bool bParam0, var uParam1, var uParam2, char* cParam3, var uParam4, var uParam5, var uParam6, float fParam7, float fParam8, bool bParam9) //Position: 0x991F / 39199
{
	struct<13> Var0;
	char* cVar13[64];
...
var Function_199(int iParam0, var uParam1, int iParam2) //Position: 0x99CD / 39373
{
	int iVar0;
...
void Function_200(var uParam0, int iParam1, int iParam2) //Position: 0x99F1 / 39409
{
	switch (Function_201())
	{
		case 0x000000C8:
...
int Function_201() //Position: 0x9A8D / 39565
{
...
void Function_202(var uParam0, int iParam1, int iParam2) //Position: 0x9AC9 / 39625
{
...
int Function_203(int iParam0) //Position: 0x9B61 / 39777
{
	float fVar0;
	float fVar1;
...
var Function_204(var uParam0, int iParam1) //Position: 0x9CAC / 40108
{
	int iVar0;
...
void Function_205(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x9DFB / 40443
{
	struct<13> Var0;
...
var Function_206(int iParam0, int iParam1) //Position: 0x9E8E / 40590
{
	int iVar0;
	int iVar1;
...
void Function_207(var uParam0, int iParam1) //Position: 0x9EA8 / 40616
{
	iParam1->f_36 = 100.0f;
	iParam1->f_40 = 110.0f;
	iParam1->f_44 = 1.0f;
...
bool Function_208(int iParam0) //Position: 0x9EF6 / 40694
{
...
bool Function_209(int iParam0) //Position: 0x9F0A / 40714
{
...
bool Function_210() //Position: 0x9F2E / 40750
{
	int iVar0;
	bool bVar1;
	...
	while (StackVal <= iVar0)
	{
		if (IS_ACTOR_VALID((*&Local_49 + 4)[iVar0]))
		{
			if (GET_LAST_ATTACKER((*&Local_49 + 4)[iVar0]) == Function_49())
			{
				Function_265();
				return 0;
			}
...
void Function_211() //Position: 0xA0CA / 41162
{
	if (Global_29006 == Global_30723[2])
	{
		Function_212(4, Global_30723[2]);
	}
	iLocal_2 = 1;
	Function_1();
	return;
...
void Function_212(int iParam0, int iParam1) //Position: 0xA0EC / 41196
{
	if (!Function_140(3))
	{
		return;
...
void Function_213() //Position: 0xA1FA / 41466
{
	int iVar0;
	...
	switch (iLocal_1)
	{
		case 0x00000000:
			...
			Function_178();
			Function_183();
			if (iLocal_16 != 0 && !Function_216(Function_15(Local_49), Function_13(Local_49)))
			{
		...
		case 0x00000006:
			...
			{
				SET_DRAW_ACTOR(Local_73[037], false);
				Function_215(StackVal, GET_GRINGO_FROM_OBJECT(&iLocal_18));
				Function_214(&Local_73, 1);
			}
			iLocal_1 = 7;
			break;
		...
		case 0x00000008:
			if (!IS_ACTION_NODE_PLAYING_PARTIAL(Function_49(), "arm_wrestling/Stand"))
			{
				if (iLocal_16 == 0)
				{
					iLocal_2 = 1;
...
void Function_214(int iParam0, int iParam1) //Position: 0xA3C8 / 41928
{
...
void Function_215(var uParam0, bool bParam1) //Position: 0xA479 / 42105
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool Function_216(int iParam0, int iParam1) //Position: 0xA5F5 / 42485
{
	int iVar0;
...
bool Function_217(int iParam0) //Position: 0xA63A / 42554
{
...
void Function_218() //Position: 0xA64F / 42575
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		Function_254(5, 6, "ArmWrestling_SkipHelp", 1, 0, 0, 0, 0);
		if (IS_BUTTON_PRESSED(Function_253(), 3, 1, 0))
		{
			Function_183();
			HUD_CLEAR_HELP_QUEUE();
			Function_252(&uLocal_23);
		}
	}
	else
	{
	...
	switch (iLocal_1)
	{
		case 0x00000023:
			Local_73.f_500 = 1;
			SET_DRAW_ACTOR(Local_73[037], true);
			switch (bLocal_22)
			{
				case 0x00000000:
					Function_251(Local_73[137], &iLocal_18);
					break;
				
				case 0x00000001:
					Function_250(Local_73[137], &iLocal_18);
					break;
				
				case 0x00000002:
					Function_249(Local_73[137], &iLocal_18);
					break;
			}
		...
		case 0x0000002D:
			...
			Function_248("ArmWrestling_EnterBet", 0,1f, 0, 2, 0, 0, 0);
			if (Function_246(&uLocal_23, 0))
			{
				Function_132("ArmWrestling_BetHelp", 0x41200000, 1, 0, 2, 1, 0);
			}
			iVar0 = Local_73.f_500;
			if ((GET_STICK_Y(Function_253(), 0, 1) > -0,2f || IS_BUTTON_PRESSED(Function_253(), 12, 1, 0)) || IS_BUTTON_DOWN(Function_253(), 12, 1, 0))
			{
				if (Function_243(&iLocal_70) < fLocal_44)
				{
					Local_73.f_500++;
					Local_73.f_500 = Function_242(Local_73.f_500, &Local_73);
					Function_240(&iLocal_70);
				}
				fLocal_44 = (fLocal_44 - 0,008f);
			}
			else if ((GET_STICK_Y(Function_253(), 0, 1) < 0,2f || IS_BUTTON_PRESSED(Function_253(), 14, 1, 0)) || IS_BUTTON_DOWN(Function_253(), 14, 1, 0))
			{
				if (Function_243(&iLocal_70) < fLocal_44)
				{
			...
			Function_254(4, 2, "ArmWrestling_Quit", 1, 0, 0, 0, 0);
			Function_254(3, 4, "ArmWrestling_Camera", 1, 0, 0, 0, 0);
			Function_254(2, 12, "ArmWrestling_ChangeBet", 1, 0, 0, 0, 0);
			Function_254(0, 1, "ArmWrestling_EnterBet", 1, 0, 0, 0, 0);
			if (IS_BUTTON_RELEASED(Function_253(), 5, 1, 1))
			{
				if (!DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(Function_49()), "bQuitMinigame"))
				{
			...
			if (IS_BUTTON_PRESSED(Function_253(), 4, 1, 0))
			{
				bLocal_22++;
				if (bLocal_22 == 3)
				{
			...
			if (IS_BUTTON_PRESSED(Function_253(), 6, 1, 0))
			{
				Function_180(4);
				Function_180(3);
				Function_180(2);
			...
			UI_LABEL_SET_VALUE("Scorebox_Cash", Function_238());
		...
		case 0x00000000:
			if (!HUD_IS_SHOWING_HELP_TEXT())
			{
				...
				Function_240(&iLocal_31);
				if (Function_246(&uLocal_23, 5))
				{
					Function_132("ArmWrestling_ArmWrestlingHelp", 0x41200000, 1, 0, 2, 1, 0);
				}
				iLocal_1 = 15;
			}
			break;
		...
		case 0x00000006:
			Function_254(3, 4, "ArmWrestling_Camera", 1, 0, 0, 0, 0);
			Function_254(0, 1, "ArmWrestling_Push", 1, 0, 0, 0, 0);
			FLASH_SET_INT("numberSystem", "showBar", true);
			...
			{
				if (Function_246(&uLocal_23, 4))
				{
					Function_132("ArmWrestling_SlamHelp", 0x41200000, 1, 0, 2, 1, 0);
				}
				if (Local_73[137].f_72 != 1.0f)
				{
					Function_254(1, 3, "ArmWrestling_Slam", 1, 0, 0, 0, 0);
				}
				else
				{
					Function_180(1);
			...
			{
				if (Function_243(&iLocal_31) < IntToFloat(RAND_INT_RANGE(5, 20)))
				{
					bVar2 = RAND_INT_RANGE(false, 100);
					if (bVar2 <= 50)
					{
			...
			if (Function_243(&iLocal_31) < 21.0f)
			{
				Function_240(&iLocal_31);
			...
			{
				if (IS_BUTTON_PRESSED(Function_253(), 6, 1, 0) || Function_243(&iLocal_70) > 0,5f)
				{
					if (IS_BUTTON_PRESSED(Function_253(), 6, 1, 0))
					{
						Function_240(&iLocal_70);
				...
				else if (IS_BUTTON_DOWN(Function_253(), 6, 1, 0))
				{
					if (Local_73[137].f_72 >= 1.0f && iLocal_40 == 0)
					{
						if (Function_243(&iLocal_70) < 0,2f)
						{
				...
				if (IS_BUTTON_PRESSED(Function_253(), 7, 1, 0))
				{
					if (Local_73[137].f_72 != 1.0f)
					{
						if (Local_73.f_484 < 0,8f)
			...
			if (Function_243(&iLocal_37) < bLocal_45)
			{
				Function_240(&iLocal_37);
				...
				if (fLocal_46 > Local_73[037].f_84)
				{
					...
					if (!HUD_IS_SHOWING_HELP_TEXT())
					{
						if (Function_246(&uLocal_23, 3))
						{
							Function_132("ArmWrestling_AIPushingHelp", 0x41200000, 1, 0, 2, 1, 0);
							fLocal_46 = 7,5f;
						}
					}
				}
				else if (fLocal_46 > Local_73[037].f_88)
				{
					...
					if (!HUD_IS_SHOWING_HELP_TEXT())
					{
						if (Function_246(&uLocal_23, 2))
						{
							Function_132("ArmWrestling_AIChargingHelp", 0x41200000, 1, 0, 2, 1, 0);
							fLocal_46 = 7,5f;
						}
					}
				}
				else
				{
					...
					if (!HUD_IS_SHOWING_HELP_TEXT())
					{
						if (Function_246(&uLocal_23, 1))
						{
							Function_132("ArmWrestling_AINothingHelp", 0x41200000, 1, 0, 2, 1, 0);
							fLocal_46 = 7,5f;
						}
					}
				}
			...
			if (!HUD_IS_SHOWING_HELP_TEXT() && ((Function_235(&uLocal_23, 1) || Function_235(&uLocal_23, 3)) || Function_235(&uLocal_23, 2)))
			{
				if (Function_246(&uLocal_23, 6))
				{
					Function_132("ArmWrestling_StrengthHelp", 0x41200000, 1, 0, 2, 1, 0);
				}
			}
			fVar3 = 0,8f;
			fVar4 = 1,2f;
			...
			switch (iLocal_40)
			{
				case 0x00000000:
					...
					if (iLocal_42 == 0)
					{
						...
						bVar6 = (Local_73[037].f_120 * Local_73[037].f_72);
					...
					else if (iLocal_42 == 1)
					{
						...
						bVar6 = (Local_73[037].f_116 * (Local_73[137].f_72 - (1,1f - Local_73[037].f_72)));
					...
					else if (iLocal_42 == 4294967295)
					{
						...
						bVar6 = (Local_73[037].f_112 * Local_73[137].f_72);
					}
					else if (iLocal_42 != 2 || iLocal_42 != 3)
					{
						bVar6 = (Local_73[037].f_144 * 2.0f);
						Local_73[037].f_72 = (Local_73[037].f_72 - Local_73[037].f_104);
					}
					if (iLocal_42 == 0)
					{
				...
				case 0x00000001:
					...
					if (iLocal_42 == 0)
					{
						...
						bVar6 = (Local_73[037].f_132 * (Local_73[037].f_72 - (1,1f - Local_73[137].f_72)));
						Local_73[037].f_72 = (Local_73[037].f_72 - Local_73[037].f_104);
					}
					else if (iLocal_42 == 1)
					{
						...
						bVar6 = (Local_73[037].f_128 * ((1,1f - Local_73[137].f_72) - (1,1f - Local_73[037].f_72)));
						Local_73[037].f_72 = (Local_73[037].f_72 + Local_73[037].f_108);
					}
					else if (iLocal_42 == 4294967295)
					{
						...
						bVar6 = (Local_73[037].f_124 * (1,1f - Local_73[137].f_72));
					}
					else if (iLocal_42 != 2 || iLocal_42 != 3)
					{
						bVar6 = (Local_73[037].f_144 * 2.0f);
				...
				case 0xFFFFFFFF:
					...
					if (iLocal_42 == 0)
					{
						...
						bVar6 = (Local_73[037].f_144 * Local_73[037].f_72);
						Local_73[037].f_72 = (Local_73[037].f_72 - Local_73[037].f_104);
					}
					else if (iLocal_42 == 1)
					{
						...
						bVar6 = (Local_73[037].f_140 * (1,1f - Local_73[037].f_72));
						Local_73[037].f_72 = (Local_73[037].f_72 + Local_73[037].f_108);
					}
					else if (iLocal_42 == 4294967295)
					{
			...
			{
				bVar10 = (0,015f * (1.0f - FABS(bLocal_27)));
			}
			else
			{
				bVar10 = 0.0f;
			}
			fLocal_28 = (fLocal_28 + RAND_FLOAT_RANGE(-bVar10, bVar10));
			...
			{
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmWinning", true);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmLosing", false);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmWinning", false);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmLosing", true);
			}
			else if (Local_73.f_484 > 0,5f)
			{
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmWinning", false);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmLosing", true);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmWinning", true);
				DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmLosing", false);
			}
			if (IS_BUTTON_RELEASED(Function_253(), 5, 1, 1))
			{
		...
		case 0x00000007:
			...
			if (Function_243(&iLocal_34) < Function_62(444))
			{
				Function_233(444, Function_243(&iLocal_34), 0);
			}
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmWinning", false);
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[137]), "bArmLosing", false);
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Local_73[037]), "bArmWinning", false);
		...
		case 0x00000009:
			if (Function_243(&iLocal_31) < 4,5f)
			{
				Function_113(Local_73.f_500 * 2, 0);
				DECOR_SET_INT(Local_73[037], "iAdditionalMoney", false);
				UI_LABEL_SET_TEXT("Scorebox_Cash", "ArmWrestling_CashLabel");
				UI_LABEL_SET_VALUE("Scorebox_Cash", Function_238());
				UI_REFRESH("Scorebox_Cash");
				PLAY_SOUND_FRONTEND("HUD_MINIGAME_WIN_MASTER");
				UI_LABEL_SET_VALUE("Scorebox_Bet", false);
				Local_73[137].f_76++;
				Function_85(441, Local_73.f_500, 0, 0);
				Function_85(450, Local_73.f_500, 0, 0);
				if ((Function_66(597) + Function_66(450)) >= 10000)
				{
					if (!HAS_ACHIEVEMENT_BEEN_PASSED(24))
					{
		...
		case 0x0000000A:
			...
			{
				Local_73[037].f_76++;
				Function_85(443, 1, 0, 0);
				Function_111(441, Local_73.f_500, 0);
				Function_111(450, Local_73.f_500, 0);
				iLocal_1 = 106;
			}
			break;
		...
		case 0x0000006A:
			...
			if (Local_73[137].f_76 > 2)
			{
				...
				{
					Function_232(GET_PLAYER_ACTOR(0));
					*(&Var12 + 12) = { StackVal, StackVal, Function_232(GET_PLAYER_ACTOR(0)) };
					Function_231(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0)));
					Var12 = { StackVal, StackVal, Function_231(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0))) };
					Var12.f_24 = 0;
					...
					bLocal_17 = Function_228(bLocal_25, 0, &Var12, 1, 0, 0);
					SAY_SINGLE_LINE_CONTEXT((*&Local_49 + 4)[Local_73.f_508], 160, Function_49(), 0, 0, 0, 4294967295, 4294967295, 0, 1);
					bLocal_47 = Local_73[037];
					Function_214(&Local_73, 0);
					Function_240(&iLocal_31);
					iLocal_1 = 65;
				}
			}
			else if (Local_73[037].f_76 <= 2 || Function_238() >= 0)
			{
				iLocal_0 = 3;
				iLocal_1 = 0;
				iLocal_16 = 1;
			...
			else
			{
				if (Local_73.f_508 <= Local_49.f_24)
				{
					SAY_SINGLE_LINE_CONTEXT((*&Local_49 + 4)[Local_73.f_508], 161, Function_49(), 0, 0, 0, 4294967295, 4294967295, 0, 1);
				}
				iLocal_1 = 35;
			}
			break;
		...
		case 0x00000022:
			...
			{
				Function_225((*&Local_49 + 4)[Local_73.f_508], &Local_73, 0, GET_ACTOR_ENUM_STRING((*&Local_49 + 4)[Local_73.f_508]), Local_73.f_508, 1);
				Local_73[137].f_76 = 0;
				Local_73.f_508++;
				iLocal_1 = 36;
			}
		...
		case 0x00000024:
			if (IS_ACTION_NODE_PLAYING_PARTIAL(Local_73[037], "arm_wrestling/Fake/Sit"))
			{
				...
				Function_232(GET_PLAYER_ACTOR(0));
				*(&Var19 + 12) = { StackVal, StackVal, Function_232(GET_PLAYER_ACTOR(0)) };
				Function_231(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0)));
				Var19 = { StackVal, StackVal, Function_231(GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0))) };
				Var19.f_24 = 0;
				DESTROY_OBJECT(bLocal_17);
				while (IS_OBJECT_VALID(bLocal_17) && !IS_EXITFLAG_SET())
				{
				...
				bLocal_17 = Function_221(bLocal_25, 0, &Var19, 1, 0, 0);
				iLocal_1 = 46;
			}
			break;
		...
		case 0x00000030:
			if (DECOR_CHECK_EXIST(GET_OBJECT_FROM_ACTOR(Function_49()), "bQuitMinigame"))
			{
				if (DECOR_GET_BOOL(GET_OBJECT_FROM_ACTOR(Function_49()), "bQuitMinigame"))
				{
					iLocal_0 = 3;
					iLocal_1 = 0;
					iLocal_16 = 1;
				...
				DECOR_REMOVE(GET_OBJECT_FROM_ACTOR(Function_49()), "bQuitMinigame");
			}
			break;
...
void Function_219(int iParam0) //Position: 0xCD75 / 52597
{
	vector3 vVar0;
	vector3 vVar3;
	
	Function_220(Function_49(), &vVar0, &vVar3);
	SET_OBJECT_POSITION((*iParam0)[037], vVar0);
	SET_OBJECT_ORIENTATION((*iParam0)[037], vVar3);
	return;
}

void Function_220(bool bParam0, var uParam1, bool bParam2) //Position: 0xCD9F / 52639
{
	vector3 vVar0;
	vector3 vVar3;
...
bool Function_221(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0xCDDF / 52703
{
	bool bVar0;
...
void Function_222(var uParam0, int iParam1) //Position: 0xCE63 / 52835
{
	int iVar0;
	
	iVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_224(&iVar0, iParam1);
	iVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 1);
	Function_223(&iVar0, iParam1);
...
void Function_223(var uParam0, int iParam1) //Position: 0xCEA5 / 52901
{
	vector3 vVar0;
...
void Function_224(var uParam0, bool bParam1) //Position: 0xCF95 / 53141
{
	vector3 vVar0;
...
void Function_225(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5) //Position: 0xD085 / 53381
{
	int iVar0;
	int iVar1;
	...
	if (!iParam2 != 4294967295 && !(*bParam1 + 448)[iParam23])
	{
		...
		Function_227(bParam1[iVar137], bParam0, iParam2, iParam3, iParam4);
		...
		if (bParam0 == GET_PLAYER_ACTOR(0))
		{
			...
			Function_226(StackVal, GET_GRINGO_FROM_OBJECT(&iLocal_18));
		}
		else
		{
			SET_ACTOR_ALLOW_BUMP_REACTIONS(bParam0, 0);
...
void Function_226(var uParam0, bool bParam1) //Position: 0xD264 / 53860
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void Function_227(int iParam0, bool bParam1, var uParam2, char* cParam3, int iParam4) //Position: 0xD3D7 / 54231
{
...
bool Function_228(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0xD669 / 54889
{
	bool bVar0;
...
void Function_229(var uParam0, int iParam1) //Position: 0xD6F5 / 55029
{
	int iVar0;
	
	iVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_230(&iVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
...
void Function_230(var uParam0, bool bParam1) //Position: 0xD725 / 55077
{
	vector3 vVar0;
...
vector3 Function_231(bool bParam0) //Position: 0xD81D / 55325
{
	vector3 vVar0;
...
vector3 Function_232(bool bParam0) //Position: 0xD844 / 55364
{
	vector3 vVar0;
...
int Function_233(int iParam0, bool bParam1, bool bParam2) //Position: 0xD855 / 55381
{
	int iVar0;
...
bool Function_234() //Position: 0xDAC1 / 56001
{
	bool bVar0;
...
bool Function_235(var uParam0, int iParam1) //Position: 0xDADC / 56028
{
	return Function_153((*uParam0)[Function_237(iParam1)], Function_236(iParam1));
}

int Function_236(int iParam0) //Position: 0xDAF3 / 56051
{
	return Function_139((iParam0 % 32));
}

int Function_237(int iParam0) //Position: 0xDB01 / 56065
{
	return (iParam0 / 32);
}

int Function_238() //Position: 0xDB0C / 56076
{
	return Function_66(0);
}

int Function_239(bool bParam0, bool bParam1) //Position: 0xDB16 / 56086
{
	bool bVar0;
...
void Function_240(int iParam0) //Position: 0xDBA6 / 56230
{
	Function_241(iParam0, 0.0f);
	return;
}

void Function_241(var uParam0, float fParam1) //Position: 0xDBB2 / 56242
{
...
var Function_242(int iParam0, int iParam1) //Position: 0xDBD3 / 56275
{
	if (iParam0 < 1)
	{
		iParam0 = 1;
	...
	{
		if (iParam0 > Function_66(0))
		{
			iParam0 = Function_66(0);
		}
	}
...
bool Function_243(int iParam0) //Position: 0xDC16 / 56342
{
...
bool Function_244(int iParam0) //Position: 0xDCDE / 56542
{
	return Function_153(*iParam0, 2);
}

bool Function_245(int iParam0) //Position: 0xDCEB / 56555
{
	return Function_153(*iParam0, 1);
}

bool Function_246(var uParam0, int iParam1) //Position: 0xDCF8 / 56568
{
	if (!Function_235(uParam0, iParam1))
	{
		Function_247(uParam0, iParam1);
		return 1;
	}
	return 0;
}

void Function_247(var uParam0, int iParam1) //Position: 0xDD13 / 56595
{
	Function_76(uParam0[Function_237(iParam1)], Function_236(iParam1));
	return;
}

void Function_248(bool bParam0, float fParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6) //Position: 0xDD2A / 56618
{
	int iVar0;
...
void Function_249(bool bParam0, int iParam1) //Position: 0xDD7D / 56701
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void Function_250(bool bParam0, int iParam1) //Position: 0xDE42 / 56898
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void Function_251(bool bParam0, int iParam1) //Position: 0xDF03 / 57091
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void Function_252(var uParam0) //Position: 0xDFCC / 57292
{
	int iVar0;
...
int Function_253() //Position: 0xDFEB / 57323
{
	bool bVar0;
...
int Function_254(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7) //Position: 0xE005 / 57349
{
	if (!Function_257(uParam0, iParam1))
	{
		return 0;
	}
	if (IS_STRING_VALID(bParam4))
	{
		return Function_256(uParam0, iParam2, iParam3, bParam4, iParam5, iParam6, iParam7);
	}
	return Function_255(uParam0, iParam2);
}

int Function_255(var uParam0, int iParam1) //Position: 0xE03F / 57407
{
	UI_SET_PROMPT_STRING(uParam0, iParam1);
	return 1;
}

var Function_256(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) //Position: 0xE04D / 57421
{
...
bool Function_257(var uParam0, int iParam1) //Position: 0xE087 / 57479
{
	UI_SET_PROMPT_ICON(uParam0, iParam1);
	return 1;
}

void Function_258() //Position: 0xE095 / 57493
{
	switch (iLocal_1)
	{
		case 0x00000000:
		...
		case 0x00000006:
			if (!HUD_IS_FADING())
			{
				Function_248("Poker_PlayerChooseSeat_Objective", 4.0f, 1, 2, 0, 0, 0);
				Function_240(&iLocal_31);
				iLocal_1 = 7;
			}
			break;
		...
		case 0x00000008:
			if (Function_243(&iLocal_31) < 1.0f)
			{
				iLocal_1 = 106;
			}
			break;
...
bool Function_259(int iParam0) //Position: 0xE163 / 57699
{
	int iVar0;
	...
	while (iVar0 <= iParam0->f_448)
	{
		if (StackVal && GRINGO_QUERY_NAMED_COMPONENT_USER(GET_GRINGO_FROM_OBJECT(!(*iParam0 + 448)[iVar03]), "UseCase1") != GET_OBJECT_FROM_ACTOR(GET_PLAYER_ACTOR(0)))
		{
			...
			{
				Function_225(GET_PLAYER_ACTOR(0), iParam0, iVar0, "", 4294967295, 0);
				return 1;
			}
		}
		iVar0++;
...
bool Function_260() //Position: 0xE1E3 / 57827
{
	int iVar0;
	...
	switch (iLocal_8)
	{
		case 0x000003E8:
			...
			{
				Function_225((*&Local_49 + 4)[0], &Local_73, 0, GET_ACTOR_ENUM_STRING((*&Local_49 + 4)[0]), 0, 0);
			}
			if (IS_ACTOR_VALID(Local_49.f_20))
			{
				Function_225(Local_49.f_20, &Local_73, 1, GET_ACTOR_ENUM_STRING(Local_49.f_20), 4294967295, 0);
			}
			SET_DRAW_ACTOR(Local_73[037], false);
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				Function_262(GET_GRINGO_FROM_OBJECT(StackVal));
				iVar0++;
			}
			Function_261();
		...
		case 0x000003EC:
			if (IS_ACTION_NODE_PLAYING_PARTIAL(Function_49(), "arm_wrestling/Idle"))
			{
				Function_219(&Local_73);
				return 1;
			}
...
void Function_261() //Position: 0xE2B2 / 58034
{
	int iVar0;
	...
	while (iVar0 <= Local_49.f_24)
	{
		if (IS_ACTOR_VALID((*&Local_49 + 4)[iVar0]))
		{
			ACTOR_ENABLE_VARIABLE_MESH((*&Local_49 + 4)[iVar0], 1, false);
			ACTOR_ENABLE_VARIABLE_MESH((*&Local_49 + 4)[iVar0], 2, false);
			ACTOR_ENABLE_VARIABLE_MESH((*&Local_49 + 4)[iVar0], 3, true);
			ACTOR_ENABLE_VARIABLE_MESH((*&Local_49 + 4)[iVar0], 4, true);
...
void Function_262(bool bParam0) //Position: 0xE31F / 58143
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_263(int iParam0) //Position: 0xE407 / 58375
{
	iParam0->f_476 = 0;
	Function_264(iParam0 + 448);
	iParam0->f_484 = 0,5f;
	iParam0->f_508 = 1;
	return;
}

void Function_264(var uParam0) //Position: 0xE42B / 58411
{
	int iVar0;
	vector3 vVar1;
...
void Function_265() //Position: 0xE631 / 58929
{
	bLocal_3 = true;
	Function_1();
	return;
...
void Function_266() //Position: 0xE63D / 58941
{
	int iVar0;
	...
	Function_162(1);
	Function_280();
	bLocal_25 = CREATE_LAYOUT(Function_53());
	Function_279();
	Function_270();
	Function_269(&iLocal_31);
	Function_269(&iLocal_70);
	Function_269(&iLocal_37);
	Function_269(&iLocal_34);
...
void Function_267(int iParam0) //Position: 0xE75D / 59229
{
	Function_268(iParam0);
	return;
}

void Function_268(int iParam0) //Position: 0xE768 / 59240
{
	int iVar0;
...
void Function_269(var uParam0) //Position: 0xE787 / 59271
{
	if (!Function_245(uParam0))
	{
		Function_241(uParam0, 0.0f);
	}
	return;
}

void Function_270() //Position: 0xE79C / 59292
{
	Function_277(&bLocal_201, "fake_arm_wrestling", 1, 0);
	Function_277(&bLocal_201, "arm_wrestling", 1, 0);
	Function_277(&bLocal_201, "nminigames", 10, 0);
	REQUEST_MISSION_AUDIO_BANK("MINI_GAMES_AND_JOBS\\ARM_WRESTLING");
	while ((!Function_271(&bLocal_201) || !REQUEST_MISSION_AUDIO_BANK("MINI_GAMES_AND_JOBS\\ARM_WRESTLING")) && !IS_EXITFLAG_SET())
	{
		WAIT(false);
	}
	UI_PUSH("Minigame");
...
bool Function_271(int iParam0) //Position: 0xE882 / 59522
{
	int iVar0;
	int iVar1;
...
void Function_272() //Position: 0xEBFD / 60413
{
	if (!Function_273(128))
	{
		return;
...
bool Function_273(int iParam0) //Position: 0xEC3D / 60477
{
	int iVar0;
...
bool Function_274() //Position: 0xEC59 / 60505
{
	int iVar0;
...
void Function_275(var uParam0, int iParam1) //Position: 0xEC84 / 60548
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_276() //Position: 0xEC95 / 60565
{
	if (!Function_273(128))
	{
		return;
...
var Function_277(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0xECD7 / 60631
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_278(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_278(var uParam0, int iParam1, int iParam2) //Position: 0xED0F / 60687
{
	int iVar0;
...
void Function_279() //Position: 0xEDD3 / 60883
{
	return;
}

void Function_280() //Position: 0xEDD9 / 60889
{
	Global_27768 = 1;
...
void Function_281() //Position: 0xEE09 / 60937
{
	if (Global_30921 == "")
	{
...
void Function_282(int iParam0) //Position: 0xEE1D / 60957
{
	Function_283(&Global_28842, iParam0);
	return;
}

void Function_283(var uParam0, var uParam1) //Position: 0xEE2B / 60971
{
	int iVar0;
