...
void main() //Position: 0x0 / 0
{
	...
	iLocal_14 = 0;
	Function_104(uScriptParam_0, &iLocal_14);
						...
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_21))
								{
									...
									{
										bLocal_21 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_21 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_19, &bLocal_18);
...
void Function_62(int iParam0) //Position: 0x2542 / 9538
{
	iParam0 = iParam0;
	return;
}

void Function_63(int iParam0) //Position: 0x254C / 9548
{
	iParam0 = iParam0;
	return;
}

bool Function_64(bool bParam0) //Position: 0x2556 / 9558
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_65(int iParam0) //Position: 0x2574 / 9588
{
	if (!Function_14(iParam0))
	{
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x2589 / 9609
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_67(int iParam0) //Position: 0x2610 / 9744
{
	vector3 vVar0;
...
vector3 Function_68(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2633 / 9779
{
	vector3 vVar0;
...
bool Function_69(bool bParam0) //Position: 0x2651 / 9809
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_70(bool bParam0, bool bParam1) //Position: 0x2674 / 9844
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_71(bool bParam0, int iParam1) //Position: 0x278F / 10127
{
...
int Function_72(bool bParam0) //Position: 0x27BA / 10170
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x28BF / 10431
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x28CC / 10444
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x293F / 10559
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_18));
		iLocal_19 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_76() //Position: 0x2E3D / 11837
{
	bool bVar0;
...
bool Function_77(bool bParam0) //Position: 0x2E74 / 11892
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2E91 / 11921
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_79(int iParam0) //Position: 0x2EC9 / 11977
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x2ED3 / 11987
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(bool bParam0, int iParam1) //Position: 0x2EF4 / 12020
{
	bool bVar0;
	bool bVar1;
...
float Function_82(bool bParam0, bool bParam1) //Position: 0x2FC5 / 12229
{
	vector3 vVar0;
	vector3 vVar3;
...
vector3 Function_83(bool bParam0) //Position: 0x3060 / 12384
{
	vector3 vVar0;
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x30CC / 12492
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x31D4 / 12756
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x31EA / 12778
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int Function_87(bool bParam0, int iParam1) //Position: 0x34A1 / 13473
{
	vector3 vVar0;
	bool bVar3;
	vector3 vVar4;
...
vector3 Function_88(bool bParam0) //Position: 0x3626 / 13862
{
	vector3 vVar0;
...
bool Function_89(bool bParam0) //Position: 0x364D / 13901
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_90(bool bParam0) //Position: 0x3666 / 13926
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_91(bool bParam0, int iParam1) //Position: 0x3680 / 13952
{
	bool bVar0;
	int iVar1;
...
bool Function_92(var uParam0, int iParam1) //Position: 0x36B8 / 14008
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_93(int iParam0, int iParam1) //Position: 0x36CF / 14031
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_94(bool bParam0) //Position: 0x3998 / 14744
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_95(bool bParam0, bool bParam1) //Position: 0x39B5 / 14773
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_96(int iParam0) //Position: 0x3A51 / 14929
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_97(var uParam0, int iParam1) //Position: 0x3A70 / 14960
{
	vector3 vVar0;
...
int Function_98(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x3A9A / 15002
{
	var uVar0[2];
	int iVar3;
	bool bVar4;
...
var Function_99(bool bParam0, bool bParam1) //Position: 0x3BFB / 15355
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_100(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x3C08 / 15368
{
	bool bVar0;
...
bool Function_101() //Position: 0x3CB2 / 15538
{
	return NET_IS_MANAGER_INITIALIZED();
}

bool Function_102(int iParam0) //Position: 0x3CBB / 15547
{
...
void Function_103(int iParam0) //Position: 0x3CD7 / 15575
{
	iParam0 = iParam0;
	return;
}

void Function_104(bool bParam0, int iParam1) //Position: 0x3CE1 / 15585
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_105(&(Local_1[iLocal_1412]), bParam0);
		iLocal_14++;
	}
...
void Function_105(int iParam0, int iParam1) //Position: 0x3D43 / 15683
{
...
void Function_106(int iParam0) //Position: 0x3D57 / 15703
{
	iParam0 = iParam0;
	return;
}

void Function_107(int iParam0) //Position: 0x3D61 / 15713
{
