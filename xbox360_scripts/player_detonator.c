	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_39(iParam0, bVar8, &iLocal_82, &bLocal_81);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D01 / 7425
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_27(int iParam0, int iParam1, bool bParam2) //Position: 0x1F3C / 7996
{
	int iVar0;
	bool bVar1;
...
bool Function_28(bool bParam0) //Position: 0x1FE9 / 8169
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x2008 / 8200
{
	return;
}

void Function_30(var uParam0, int iParam1) //Position: 0x200E / 8206
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_31(int iParam0) //Position: 0x201C / 8220
{
	iParam0 = iParam0;
	return 1;
}

bool Function_32(bool bParam0) //Position: 0x2027 / 8231
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_33(bool bParam0, int iParam1) //Position: 0x2041 / 8257
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_34(bool bParam0) //Position: 0x205F / 8287
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_35(bool bParam0) //Position: 0x207E / 8318
{
	int iVar0;
	int iVar1;
...
bool Function_36(bool bParam0) //Position: 0x20B1 / 8369
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x20D0 / 8400
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_38(var uParam0, int iParam1) //Position: 0x20EA / 8426
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_39(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x20FD / 8445
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_40() //Position: 0x23E5 / 9189
{
	int iVar0;
...
bool Function_41(bool bParam0, bool bParam1) //Position: 0x23ED / 9197
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_42() //Position: 0x240A / 9226
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2419 / 9241
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_44(bool bParam0, int iParam1) //Position: 0x243B / 9275
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_45(bool bParam0) //Position: 0x245F / 9311
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x247C / 9340
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_47(bool bParam0, int iParam1) //Position: 0x249C / 9372
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_48(bool bParam0, bool bParam1) //Position: 0x24BC / 9404
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_49(bool bParam0, bool bParam1, bool bParam2) //Position: 0x256A / 9578
{
	bool bVar0;
...
void Function_50(int iParam0, float fParam1) //Position: 0x25DA / 9690
{
	if (!Function_14(iParam0))
	{
...
void Function_51(int iParam0, float fParam1) //Position: 0x25F0 / 9712
{
...
var Function_52(bool bParam0) //Position: 0x2611 / 9745
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_53(int iParam0) //Position: 0x2631 / 9777
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_54(var uParam0) //Position: 0x2645 / 9797
{
	uParam0 = uParam0;
	return;
}

var Function_55() //Position: 0x264F / 9807
{
	return !Function_56();
}

bool Function_56() //Position: 0x2659 / 9817
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_57(var uParam0, int iParam1) //Position: 0x2662 / 9826
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x2671 / 9841
{
	bool bVar0;
...
bool Function_59(bool bParam0) //Position: 0x26B0 / 9904
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x26DB / 9947
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x26E6 / 9958
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x27DC / 10204
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x27FE / 10238
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(bool bParam0) //Position: 0x2825 / 10277
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_65(vector3 vParam0) //Position: 0x2AFD / 11005
{
	vector3 vVar0;
...
vector3 Function_66(vector3 vParam0) //Position: 0x2B5A / 11098
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x2BB7 / 11191
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x2BC1 / 11201
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2BDF / 11231
{
	if (!Function_14(iParam0))
	{
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x2BF4 / 11252
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x2C7B / 11387
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2C9E / 11422
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x2CBC / 11452
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x2CDF / 11487
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x2DFA / 11770
{
...
int Function_76(bool bParam0) //Position: 0x2E25 / 11813
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2F2A / 12074
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2F37 / 12087
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2FAA / 12202
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x34A8 / 13480
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x34DF / 13535
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x34FC / 13564
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x3534 / 13620
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x353E / 13630
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x355F / 13663
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	SET_AUTO_CONVERSATION_LOOK(Global_34573, 1);
...
void Function_86(bool bParam0, bool bParam1) //Position: 0x3610 / 13840
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3718 / 14104
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x372E / 14126
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x39E4 / 14820
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x39F2 / 14834
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x3A0B / 14859
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(bool bParam0, int iParam1) //Position: 0x3A25 / 14885
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x3A5D / 14941
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x3A74 / 14964
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3D3D / 15677
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3D5A / 15706
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3DF6 / 15862
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3E15 / 15893
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3E24 / 15908
{
...
void Function_100(int iParam0) //Position: 0x3E40 / 15936
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3E4A / 15946
{
	bool bVar0;
	bool bVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x3EAC / 16044
{
...
void Function_103(int iParam0) //Position: 0x3EC0 / 16064
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3ECA / 16074
{
