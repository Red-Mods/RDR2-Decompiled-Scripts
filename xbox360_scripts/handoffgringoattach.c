...
bool Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x2571 / 9585
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x25E3 / 9699
{
	bool bVar0;
...
void Function_65(var uParam0, bool bParam1) //Position: 0x260D / 9741
{
...
void Function_66(int iParam0) //Position: 0x26A2 / 9890
{
	iParam0 = iParam0;
	return;
}

bool Function_67(bool bParam0) //Position: 0x26AC / 9900
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_68(int iParam0) //Position: 0x26CA / 9930
{
	if (!Function_14(iParam0))
	{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x26DF / 9951
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_70(bool bParam0) //Position: 0x2730 / 10032
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

bool Function_71(bool bParam0, int iParam1) //Position: 0x2753 / 10067
{
...
int Function_72(bool bParam0) //Position: 0x277E / 10110
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_73(var uParam0, int iParam1) //Position: 0x2883 / 10371
{
	return (uParam0 && iParam1) == 0;
}

void Function_74(int iParam0) //Position: 0x2890 / 10384
{
	if (Function_73(iParam0->f_40, 16))
	{
...
void Function_75(int iParam0, bool bParam1) //Position: 0x2903 / 10499
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_76() //Position: 0x2E01 / 11777
{
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
	{
...
bool Function_77(bool bParam0) //Position: 0x2E19 / 11801
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2E36 / 11830
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_79(int iParam0) //Position: 0x2E6E / 11886
{
	iParam0 = iParam0;
	return;
}

bool Function_80(bool bParam0) //Position: 0x2E78 / 11896
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_81(bool bParam0, int iParam1) //Position: 0x2E99 / 11929
{
...
void Function_82(bool bParam0, bool bParam1) //Position: 0x2EBC / 11964
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_83(bool bParam0, bool bParam1) //Position: 0x2FC4 / 12228
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_84(int iParam0) //Position: 0x2FDA / 12250
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_85(var uParam0, int iParam1) //Position: 0x3290 / 12944
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_86(bool bParam0) //Position: 0x329E / 12958
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_87(bool bParam0) //Position: 0x32B7 / 12983
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_88(bool bParam0, int iParam1) //Position: 0x32D1 / 13009
{
	bool bVar0;
	int iVar1;
...
bool Function_89(var uParam0, int iParam1) //Position: 0x333B / 13115
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_90(int iParam0, int iParam1) //Position: 0x3352 / 13138
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_91(bool bParam0) //Position: 0x361B / 13851
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x3638 / 13880
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_93(int iParam0) //Position: 0x36D4 / 14036
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_94(var uParam0, int iParam1) //Position: 0x36F3 / 14067
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_95(int iParam0) //Position: 0x3702 / 14082
{
...
void Function_96(int iParam0) //Position: 0x371E / 14110
{
	iParam0 = iParam0;
	return;
}

void Function_97(bool bParam0, int iParam1) //Position: 0x3728 / 14120
{
	bool bVar0;
	bool bVar1;
...
void Function_98(int iParam0, int iParam1) //Position: 0x378A / 14218
{
...
void Function_99(int iParam0) //Position: 0x379E / 14238
{
	iParam0 = iParam0;
	return;
}

void Function_100(int iParam0) //Position: 0x37A8 / 14248
{
