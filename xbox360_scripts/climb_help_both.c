...
int Function_69(bool bParam0) //Position: 0x261B / 9755
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_70(var uParam0, int iParam1) //Position: 0x2720 / 10016
{
	return (uParam0 && iParam1) == 0;
}

void Function_71(int iParam0) //Position: 0x272D / 10029
{
	if (Function_70(iParam0->f_40, 16))
	{
...
void Function_72(int iParam0, bool bParam1) //Position: 0x27A0 / 10144
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_73() //Position: 0x2C9E / 11422
{
	bool bVar0;
...
bool Function_74(bool bParam0) //Position: 0x2CD5 / 11477
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_75(var uParam0, int iParam1) //Position: 0x2CF2 / 11506
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_76(int iParam0) //Position: 0x2D2A / 11562
{
	iParam0 = iParam0;
	return;
}

bool Function_77(bool bParam0) //Position: 0x2D34 / 11572
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_78(var uParam0, int iParam1) //Position: 0x2D55 / 11605
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_79(bool bParam0, bool bParam1) //Position: 0x2D63 / 11619
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x2E6B / 11883
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_81(int iParam0) //Position: 0x2E81 / 11905
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_82(var uParam0, int iParam1) //Position: 0x3137 / 12599
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_83(bool bParam0) //Position: 0x3145 / 12613
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_84(bool bParam0) //Position: 0x315E / 12638
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_85(int iParam0, int iParam1) //Position: 0x3178 / 12664
{
	bool bVar0;
	int iVar1;
	
	iParam0 = iParam0;
	iVar1 = Function_86(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_86(var uParam0, int iParam1) //Position: 0x31B0 / 12720
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_87(int iParam0, int iParam1) //Position: 0x31C7 / 12743
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_88(bool bParam0) //Position: 0x3490 / 13456
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_89(bool bParam0, bool bParam1) //Position: 0x34AD / 13485
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_90(int iParam0) //Position: 0x3549 / 13641
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_91(var uParam0, int iParam1) //Position: 0x3568 / 13672
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_92(int iParam0) //Position: 0x3577 / 13687
{
...
void Function_93(int iParam0) //Position: 0x3593 / 13715
{
	iParam0 = iParam0;
	return;
}

void Function_94(bool bParam0, int iParam1) //Position: 0x359D / 13725
{
	bool bVar0;
	bool bVar1;
...
void Function_95(int iParam0, int iParam1) //Position: 0x35FF / 13823
{
...
void Function_96(int iParam0) //Position: 0x3613 / 13843
{
	iParam0 = iParam0;
	return;
}

void Function_97(int iParam0) //Position: 0x361D / 13853
{
