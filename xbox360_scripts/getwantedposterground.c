	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_83, &bLocal_82);
...
bool Function_26(var uParam0, int iParam1) //Position: 0x1D0C / 7436
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_27(bool bParam0) //Position: 0x1D1B / 7451
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1D3A / 7482
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1D40 / 7488
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1D4E / 7502
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1D59 / 7513
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1D73 / 7539
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1D91 / 7569
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1DB0 / 7600
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1DE3 / 7651
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E02 / 7682
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E1C / 7708
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1E2F / 7727
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
var Function_39() //Position: 0x2117 / 8471
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x211F / 8479
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x213C / 8508
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x214B / 8523
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x216D / 8557
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2191 / 8593
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x21AE / 8622
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x21CE / 8654
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x21EE / 8686
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x229C / 8860
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x230C / 8972
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2322 / 8994
{
...
var Function_51(bool bParam0) //Position: 0x2343 / 9027
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x2363 / 9059
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(bool bParam0) //Position: 0x2377 / 9079
{
	struct<8> Var0;
	...
	if (iLocal_1 && !iLocal_2)
	{
		...
		iLocal_0 = CREATE_LAYOUT(&Var0);
		Function_54(iLocal_0, 0, Global_34573, 1, 0, 0);
	}
	return;
}

var Function_54(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x23B8 / 9144
{
	bool bVar0;
...
void Function_56(var uParam0, bool bParam1) //Position: 0x245E / 9310
{
...
struct<32> Function_57(bool bParam0) //Position: 0x24DE / 9438
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_58(char* cParam0, char* cParam1, char* cParam2) //Position: 0x2548 / 9544
{
	char* cVar0[32];
...
int Function_59() //Position: 0x2567 / 9575
{
	return 1;
}

void Function_60(var uParam0, int iParam1) //Position: 0x256E / 9582
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_61(bool bParam0, var uParam1, int iParam2) //Position: 0x257D / 9597
{
	bool bVar0;
...
bool Function_62(bool bParam0) //Position: 0x25BC / 9660
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_63(bool bParam0) //Position: 0x25E7 / 9703
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_64(bool bParam0) //Position: 0x25F2 / 9714
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_65(bool bParam0) //Position: 0x26E8 / 9960
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_66(bool bParam0) //Position: 0x270A / 9994
{
...
void Function_68(int iParam0) //Position: 0x273B / 10043
{
	iParam0 = iParam0;
	return;
}

bool Function_69(bool bParam0) //Position: 0x2745 / 10053
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_70(int iParam0) //Position: 0x2763 / 10083
{
	if (!Function_14(iParam0))
	{
...
bool Function_71(bool bParam0, bool bParam1) //Position: 0x2778 / 10104
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_72(int iParam0) //Position: 0x27FF / 10239
{
	vector3 vVar0;
...
vector3 Function_73(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2822 / 10274
{
	vector3 vVar0;
...
bool Function_74(bool bParam0) //Position: 0x2840 / 10304
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_75(bool bParam0, bool bParam1) //Position: 0x2863 / 10339
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_76(bool bParam0, int iParam1) //Position: 0x297E / 10622
{
...
int Function_77(bool bParam0) //Position: 0x29A9 / 10665
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_78(var uParam0, int iParam1) //Position: 0x2AAE / 10926
{
	return (uParam0 && iParam1) == 0;
}

void Function_79(int iParam0) //Position: 0x2ABB / 10939
{
	if (Function_78(iParam0->f_40, 16))
	{
...
void Function_80(int iParam0, bool bParam1) //Position: 0x2B2E / 11054
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_81() //Position: 0x302C / 12332
{
	bool bVar0;
...
bool Function_82(bool bParam0) //Position: 0x3063 / 12387
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_83(var uParam0, int iParam1) //Position: 0x3080 / 12416
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_84(int iParam0) //Position: 0x30B8 / 12472
{
	iParam0 = iParam0;
	return;
}

bool Function_85(bool bParam0) //Position: 0x30C2 / 12482
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_86(var uParam0, int iParam1) //Position: 0x30E3 / 12515
{
	iParam1 = iParam1;
	uParam0 = uParam0;
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3113 / 12563
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x321B / 12827
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_89(int iParam0) //Position: 0x3231 / 12849
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_90(bool bParam0, int iParam1) //Position: 0x34E7 / 13543
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
...
bool Function_91(bool bParam0) //Position: 0x3507 / 13575
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_92(bool bParam0) //Position: 0x3520 / 13600
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_93(int iParam0, int iParam1) //Position: 0x353A / 13626
{
	bool bVar0;
	int iVar1;
...
bool Function_94(var uParam0, int iParam1) //Position: 0x3572 / 13682
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_95(int iParam0, int iParam1) //Position: 0x3589 / 13705
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_96(bool bParam0) //Position: 0x3852 / 14418
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_97(bool bParam0, bool bParam1) //Position: 0x386F / 14447
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_98(int iParam0) //Position: 0x390B / 14603
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_99(bool bParam0, int iParam1) //Position: 0x392A / 14634
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_100(int iParam0) //Position: 0x394C / 14668
{
...
void Function_101(int iParam0) //Position: 0x3968 / 14696
{
	iParam0 = iParam0;
	return;
}

void Function_102(bool bParam0, int iParam1) //Position: 0x3972 / 14706
{
	bool bVar0;
	bool bVar1;
...
void Function_103(int iParam0, int iParam1) //Position: 0x39D4 / 14804
{
...
void Function_104(int iParam0) //Position: 0x39E8 / 14824
{
	iParam0 = iParam0;
	return;
}

void Function_105(int iParam0) //Position: 0x39F2 / 14834
{
