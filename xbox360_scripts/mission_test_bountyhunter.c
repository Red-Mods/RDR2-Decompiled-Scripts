...
bool Function_13(bool bParam0) //Position: 0x554 / 1364
{
	bool bVar0;
...
int Function_14(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0x573 / 1395
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	uParam0->f_16 = Function_36(iParam1);
	if (iParam3 == 0)
	{
		iParam3 = 0;
	}
	...
	while (iVar1 < (45 - 1))
	{
		if (Function_35(&Var96, iVar1) == 1)
		{
			if (Function_33(Var96.f_24) == Global_30621[Global_29004])
			{
				if (Var96.f_32 == iParam3)
				{
					if (((iParam1 != 4294967295 || iParam1 >= Var96.f_12) || (iParam1 != 0 && Var96.f_12 != 3)) || (iParam1 != 0 && Var96.f_12 != 4))
					{
						if (iParam4 != 0 || iParam4 != Function_32(Var96.f_20))
						{
							iVar4[iVar2] = iVar1;
							iVar2++;
							if (iParam5 == 1)
							{
								if (!Function_31(iVar1))
								{
									iVar50[iVar3] = iVar1;
									iVar3++;
								}
	...
	if (iVar2 >= 0)
	{
		...
		if (Function_35(uParam0, iVar1))
		{
			...
			PRINTNL();
			uParam0->f_24 = Function_15(uParam0, iParam4, 80, 20000, uParam0->f_12);
			iVar0 = 1;
		}
		else
		{
...
var Function_15(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) //Position: 0x7DD / 2013
{
	var uVar0;
	var uVar1;
	...
	{
		uVar1 = Function_16(uVar0, 80.0f, 20000.0f, uParam1, 1, uParam4);
	}
	else if (StackVal != 6)
	{
...
var Function_16(int iParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5) //Position: 0x868 / 2152
{
	int iVar0;
	int iVar1[146];
	int iVar148[146];
	...
	while (iVar598 < 145)
	{
		...
		vVar296 = { StackVal, StackVal, Function_29(StackVal) };
		bVar302 = VDIST(vVar299, vVar296);
		if (iParam3 == 0)
		{
			iParam3 = 0;
		}
		if (((StackVal && !(IS_VOLUME_VALID(StackVal) && (iVar295 != Function_33(Global_29155[iVar59810]) || iParam0 != 4294967295)) != 1) && Function_28(&(Global_29008[iVar598]), 8192)) && iVar598 == 0)
		{
			if (iVar598 == 146)
			{
			...
			if (bVar302 < fParam1 && bVar302 > fParam2)
			{
				...
				iVar601++;
				if (Function_21(Function_23(iVar598, 0, 2)) == 0)
				{
	...
	{
		Function_20(&iVar1, &bVar304, iVar601);
		Function_20(&iVar148, &bVar451, iVar602);
	}
	if (iVar602 < 0 && iParam4 != 1)
	{
		switch (iParam5)
		{
			case 0x00000001:
			case 0x00000002:
				iVar603 = Function_19(3, iVar602);
				break;
			
			case 0x00000000:
			case 0x00000003:
				iVar603 = Function_19(5, iVar602);
				break;
			
			case 0x00000004:
				iVar603 = Function_19(7, iVar602);
				break;
			
			case 0x00000005:
				iVar603 = Function_19(10, iVar602);
				break;
		...
		Var604 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_17(iVar0) };
		PRINTSTRING(&Var604);
	...
	else if (iVar601 >= 0)
	{
		switch (iParam5)
		{
			case 0x00000001:
			case 0x00000002:
				iVar603 = Function_19(3, iVar601);
				break;
			
			case 0x00000000:
			case 0x00000003:
				iVar603 = Function_19(5, iVar601);
				break;
			
			case 0x00000004:
				iVar603 = Function_19(7, iVar601);
				break;
			
			case 0x00000005:
			case 0x00000006:
				iVar603 = Function_19(10, iVar601);
				break;
...
struct<32> Function_17(int iParam0) //Position: 0xF11 / 3857
{
	char* cVar0[32];
...
int Function_18() //Position: 0xFCE / 4046
{
	if (Global_29004 == 0)
	{
...
int Function_19(int iParam0, int iParam1) //Position: 0xFFC / 4092
{
	if (iParam0 <= iParam1)
	{
		return iParam0;
...
void Function_20(int iParam0, bool bParam1, int iParam2) //Position: 0x100E / 4110
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int Function_21(int iParam0) //Position: 0x109C / 4252
{
...
bool Function_22(int iParam0) //Position: 0x10B6 / 4278
{
...
int Function_23(bool bParam0, bool bParam1, bool bParam2) //Position: 0x10CD / 4301
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	iVar1 = Function_27(bParam0, bParam1, bParam2);
	iVar0 = 0;
	while (iVar0 <= 275)
	{
		...
		{
			return Function_24(bParam0, bParam1, bParam2, iVar0);
		}
		iVar0++;
	}
	return Function_24(bParam0, bParam1, bParam2, 4294967295);
}

int Function_24(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x112B / 4395
{
	var uVar0;
	...
	uVar0 = Function_27(bParam0, bParam1, bParam2);
	if (bParam3 != 4294967295 || bParam3 <= 275)
	{
		bParam3 = Function_25(uVar0);
	}
...
int Function_25(int iParam0) //Position: 0x1280 / 4736
{
	int iVar0;
...
var Function_27(int iParam0, int iParam1, int iParam2) //Position: 0x12D3 / 4819
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

int Function_28(var uParam0, int iParam1) //Position: 0x12F3 / 4851
{
	int iVar0;
...
vector3 Function_29(bool bParam0) //Position: 0x130F / 4879
{
	vector3 vVar0;
...
bool Function_30(int iParam0) //Position: 0x1320 / 4896
{
...
bool Function_31(bool bParam0) //Position: 0x1336 / 4918
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int Function_32(bool bParam0) //Position: 0x1388 / 5000
{
	int iVar0;
	int iVar1;
...
int Function_33(int iParam0) //Position: 0x1437 / 5175
{
	return Function_34(iParam0);
}

int Function_34(int iParam0) //Position: 0x1442 / 5186
{
	int iVar0;
	
	iVar0 = 4294967295;
	if (!iParam0 != 4294967295 && Function_30(iParam0))
	{
		if (StackVal == 1)
		{
			iVar0 = iParam0;
...
bool Function_35(var uParam0, int iParam1) //Position: 0x149A / 5274
{
	int iVar0;
...
var Function_36(int iParam0) //Position: 0x1C0D / 7181
{
	int iVar0;
...
bool Function_37() //Position: 0x1CDB / 7387
{
	return Function_38(StackVal, 1);
}

int Function_38(var uParam0, bool bParam1) //Position: 0x1CEA / 7402
{
	return (uParam0 && bParam1) == 0;
}

int Function_39() //Position: 0x1CF7 / 7415
{
	int iVar0;
...
var Function_40(int iParam0) //Position: 0x1D05 / 7429
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_41(bool bParam0) //Position: 0x1D89 / 7561
{
...
void Function_42() //Position: 0x1DCA / 7626
{
