...
void main() //Position: 0x0 / 0
{
	...
	bVar1 = Function_18("refugees", 0);
	Function_13(&bVar1, 287, 3.0f, 10, 0, 0);
	Function_13(&bVar1, 62, 5.0f, 10, 0, 0);
	Function_13(&bVar1, 243, 5.0f, 10, 0, 0);
	Function_13(&bVar1, 320, 4.0f, 10, 0, 0);
	Function_13(&bVar1, 319, 4.0f, 10, 0, 0);
	Function_13(&bVar1, 313, 4.0f, 10, 0, 0);
	Function_13(&bVar1, 314, 4.0f, 10, 0, 0);
	Function_13(&bVar1, 63, 5.0f, 10, 0, 0);
	Function_13(&bVar1, 317, 5.0f, 2, 0, 0);
	bVar2 = Function_18("people", 0);
	Function_13(&bVar2, 287, 3.0f, 7, 0, 0);
	Function_13(&bVar2, 293, 2.0f, 7, 0, 0);
	Function_13(&bVar2, 292, 2.0f, 7, 0, 0);
	Function_13(&bVar2, 314, 5.0f, 7, 0, 0);
	Function_13(&bVar2, 313, 5.0f, 7, 0, 0);
	Function_13(&bVar2, 251, 3.0f, 7, 0, 0);
	Function_13(&bVar2, 297, 3.0f, 7, 0, 0);
	Function_13(&bVar2, 299, 3.0f, 7, 0, 0);
	bVar3 = Function_18("people1", 0);
	Function_13(&bVar3, 295, 3.0f, 24, 0, 0);
	Function_13(&bVar3, 296, 2.0f, 24, 0, 0);
	Function_13(&bVar3, 297, 2.0f, 24, 0, 0);
	Function_13(&bVar3, 314, 5.0f, 24, 0, 0);
	Function_13(&bVar3, 313, 5.0f, 24, 0, 0);
	Function_13(&bVar3, 319, 3.0f, 24, 0, 0);
	Function_13(&bVar3, 320, 3.0f, 24, 0, 0);
	Function_13(&bVar3, 251, 5.0f, 24, 0, 0);
	Function_13(&bVar3, 252, 5.0f, 24, 0, 0);
	...
	bVar6 = Function_18("vultures", 0);
	Function_13(&bVar6, 1128, 10.0f, 14, 0, 0);
	uVar7 = Function_18("Mules", 0);
	Function_16(&uVar7, 1000, 10.0f, 0, 0);
	uVar8 = Function_18("Crows", 0);
	Function_13(&uVar8, 1131, 10.0f, 14, 0, 0);
	bVar9 = Function_18("Rabbits", 0);
	Function_13(&bVar9, 1078, 6,5f, 49, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar11))
	{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_7(bVar12, bVar6, 1E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_7(bVar12, bVar9, 4E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar3, 5, 8, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar3, 3, 5, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar1, 2, 5, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar3, 2, 3, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar2, 1, 3, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_6(bVar12, bVar2, 1, 2, 1, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar12))
		{
			Function_7(bVar12, bVar10, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_5(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1420 / 5152
{
	bool bVar0;
...
var Function_6(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) //Position: 0x14A0 / 5280
{
	bool bVar0;
...
var Function_7(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1522 / 5410
{
	bool bVar0;
...
var Function_14(int iParam0) //Position: 0x1693 / 5779
{
	bool bVar0;
...
var Function_15(int iParam0) //Position: 0x16FF / 5887
{
	bool bVar0;
...
var Function_16(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x176B / 5995
{
	int iVar0;
	int iVar1;
...
var Function_17(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x17E0 / 6112
{
	int iVar0;
	int iVar1;
...
var Function_18(bool bParam0, int iParam1) //Position: 0x1825 / 6181
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_19(int iParam0) //Position: 0x1832 / 6194
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_20(bool bParam0, var uParam1) //Position: 0x183E / 6206
{
	if (!Function_8(128))
	{
		return;
