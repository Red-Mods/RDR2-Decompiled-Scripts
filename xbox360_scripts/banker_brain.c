...
bool Function_16(bool bParam0, var uParam1, int iParam2) //Position: 0x183B / 6203
{
	...
	while (bVar8 <= iVar7)
	{
		...
		if (!bVar1)
		{
			bVar1 = GRINGO_GET_VECTOR_ATTR_BY_HANDLE(bVar5, uParam1);
		}
		else if (!bVar2)
		{
...
var Function_17(char* cParam0) //Position: 0x19FA / 6650
{
	int iVar0;
	int iVar1;
...
void Function_30(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x1F40 / 8000
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
void Function_32(vector3 vParam0, bool bParam3, bool bParam4) //Position: 0x209C / 8348
{
	vector3 vVar0;
	var uVar3;
	float fVar6;
...
var Function_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, vector3 vParam4, bool bParam7, bool bParam8, bool bParam9) //Position: 0x22B0 / 8880
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_46(bool bParam0) //Position: 0x2D3B / 11579
{
	...
	if (!IS_VOLUME_VALID(bLocal_4[1]))
	{
		...
		bVar3 = GRINGO_GET_ATTRIBUTE(bVar2, false);
		bVar5 = GRINGO_GET_STRING_ATTR_BY_HANDLE(bVar3, &uVar4);
	...
	if (!IS_VOLUME_VALID(bLocal_4[0]))
	{
		...
		bVar8 = GRINGO_GET_ATTRIBUTE(bVar7, true);
		bVar10 = GRINGO_GET_STRING_ATTR_BY_HANDLE(bVar8, &uVar9);
		bLocal_4[0] = FIND_VOLUME_IN_LAYOUT(Global_30616, bVar10);
		return;
	}
	bVar11 = CREATE_OBJECTSET_IN_LAYOUT(Function_42(), Global_30616, 15, 0);
	LOCATE_ACTORS_IN_VOLUME(bLocal_4[0], bVar11, 0, 1);
	if (GET_OBJECTSET_SIZE(bVar11) != 0)
	{
		bVar12 = GET_ACTOR_FROM_OBJECT(GET_INDEXED_OBJECT_IN_OBJECTSET(false, bVar11));
		if (bVar12 != bLocal_3)
		{
			bLocal_3 = bVar12;
			fLocal_0 = GET_CURRENT_GAME_TIME();
