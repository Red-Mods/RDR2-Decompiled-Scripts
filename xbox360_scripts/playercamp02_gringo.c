...
void main() //Position: 0x0 / 0
{
	...
	*(&Var1 + 228) = 2;
	if (bVar0)
	{
		Function_120(&Var1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp02x");
	}
	else
	{
...
bool Function_59(int iParam0) //Position: 0x2A7E / 10878
{
	...
	*(&Local_0 + 4) = { 1,786425f, 0,008248952f, 1,086883f };
	*(&Local_0 + 4 + 12) = { 0.0f, 111,2571f, 0.0f };
	Function_61(iParam0, &Local_0 + 4);
	Local_0.f_28 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_horse_stay", 1,786425f, 0,008248952f, 1,086883f, 0.0f, 111,2571f, 0.0f);
	*(&Local_0 + 32) = { 0,6116906f, 0,002102481f, -1,21826f };
	*(&Local_0 + 32 + 12) = { 0.0f, 188,8444f, 0.0f };
	Function_61(iParam0, &Local_0 + 32);
	Local_0.f_56 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_sit", 0,6116906f, 0,002102481f, -1,21826f, 0.0f, 188,8444f, 0.0f);
