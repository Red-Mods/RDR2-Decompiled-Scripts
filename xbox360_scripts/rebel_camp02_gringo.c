...
{
	if (IS_SOUND_ID_VALID(bLocal_30))
	{
		STOP_SOUND(bLocal_30);
	}
...
void Function_12(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0xA2C / 2604
{
	bool bVar0;
	bool bVar1;
...
bool Function_42(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x29AE / 10670
{
...
void Function_51(bool bParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x2CBC / 11452
{
	bool bVar0;
	bool bVar1;
...
void Function_72() //Position: 0x3610 / 13840
{
	...
	SET_ACTION_NODE_FOR_ACTOR(bVar6, "Gather/Listener/Idle");
	Function_76(bVar6, &bLocal_27, 1, 1);
	bLocal_30 = GET_SOUND_ID();
	PLAY_WALLA_SOUND_FROM_POSITION_PERSISTENT(bLocal_30, "VOCAL_MEX_CROWD_MASTER", -2289,171f, 22,609f, 4959,531f);
	return;
}
...
bool Function_78(var uParam0, bool bParam1, int iParam2) //Position: 0x3C58 / 15448
{
...
void Function_83(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x43A9 / 17321
{
	bool bVar0;
...
bool Function_84(bool bParam0, bool bParam1) //Position: 0x43FD / 17405
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_89(int iParam0, bool bParam1) //Position: 0x45AD / 17837
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_98(int iParam0) //Position: 0x4930 / 18736
{
	bool bVar0;
	bool bVar1;
...
var Function_99(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4A2A / 18986
{
	int iVar0;
	bool bVar1;
...
void Function_100(var uParam0, int iParam1) //Position: 0x4A62 / 19042
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_101(var uParam0, bool bParam1, int iParam2) //Position: 0x4A73 / 19059
{
	int iVar0;
...
bool Function_102(int iParam0) //Position: 0x4B37 / 19255
{
	int iVar0;
	int iVar1;
...
void Function_103() //Position: 0x4EB2 / 20146
{
	if (!Function_150(128))
	{
		return;
...
bool Function_104() //Position: 0x4EF2 / 20210
{
	int iVar0;
...
void Function_105() //Position: 0x4F1D / 20253
{
	if (!Function_150(128))
	{
		return;
...
void Function_106(int iParam0, bool bParam1) //Position: 0x4F5F / 20319
{
	char* cVar0[32];
...
void Function_107(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4FE3 / 20451
{
	var uVar0;
	var uVar1;
...
void Function_108(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x500C / 20492
{
...
var Function_109(var uParam0, bool bParam1) //Position: 0x505D / 20573
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_110() //Position: 0x506D / 20589
{
	return "PackedGrass";
}

var Function_111(bool bParam0, bool bParam1, bool bParam2) //Position: 0x5081 / 20609
{
	int iVar0;
...
var Function_112() //Position: 0x50A6 / 20646
{
	return "PackedMetadata";
}

void Function_113(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x50BD / 20669
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_114() //Position: 0x51E3 / 20963
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_115() //Position: 0x51F4 / 20980
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_116() //Position: 0x5205 / 20997
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_117(var uParam0, int iParam1) //Position: 0x5216 / 21014
{
...
var Function_118(var uParam0, int iParam1, bool bParam2) //Position: 0x5239 / 21049
{
	int iVar0;
...
var Function_119(bool bParam0) //Position: 0x5258 / 21080
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_120() //Position: 0x5264 / 21092
{
	return Function_121(39);
}

int Function_121(bool bParam0) //Position: 0x526F / 21103
{
	bool bVar0;
...
var Function_122() //Position: 0x529D / 21149
{
	return "PackedWeapon";
}

int Function_123(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x52B2 / 21170
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_124() //Position: 0x53B6 / 21430
{
	return "MPItemGiver";
}

struct<32> Function_125(bool bParam0) //Position: 0x53CA / 21450
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_126(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5434 / 21556
{
	char* cVar0[32];
...
var Function_127() //Position: 0x5453 / 21587
{
	return "PBox_";
}

var Function_128() //Position: 0x5461 / 21601
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_129() //Position: 0x5487 / 21639
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_130() //Position: 0x54AF / 21679
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_131(var uParam0, int iParam1) //Position: 0x54D5 / 21717
{
	int iVar0;
	var uVar1;
...
void Function_132(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5636 / 22070
{
	struct<8> Var0;
...
int Function_133(bool bParam0) //Position: 0x56D1 / 22225
{
	int iVar0;
	vector3 vVar1;
...
void Function_134(int iParam0) //Position: 0x5832 / 22578
{
...
var Function_135() //Position: 0x5893 / 22675
{
	int iVar0;
...
var Function_136(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x589B / 22683
{
	return Function_137(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_137(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x58B4 / 22708
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_138(int iParam0) //Position: 0x5BA7 / 23463
{
	int iVar0;
...
void Function_139() //Position: 0x5C5B / 23643
{
	int iVar0;
...
bool Function_140(bool bParam0) //Position: 0x5C95 / 23701
{
	int iVar0;
...
void Function_141(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5CC2 / 23746
{
	bool bVar0;
...
void Function_142() //Position: 0x5E13 / 24083
{
	int iVar0;
...
var Function_143(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5E5E / 24158
{
	int iVar0;
...
int Function_144() //Position: 0x5F2E / 24366
{
	int iVar0;
...
int Function_145() //Position: 0x608A / 24714
{
	int iVar0;
...
bool Function_146(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x61AA / 25002
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
float Function_147(var uParam0, int iParam1) //Position: 0x627A / 25210
{
	vector3 vVar0;
	bool bVar3;
...
bool Function_148(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6298 / 25240
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_149(bool bParam0) //Position: 0x63CA / 25546
{
	bool bVar0;
...
bool Function_150(int iParam0) //Position: 0x63E9 / 25577
{
	int iVar0;
...
int Function_151() //Position: 0x6405 / 25605
{
	if (Function_153())
	{
...
int Function_152() //Position: 0x641E / 25630
{
	return Global_79349.f_16;
}

bool Function_153() //Position: 0x642A / 25642
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_154(int iParam0, bool bParam1, bool bParam2) //Position: 0x6433 / 25651
{
	var uVar0;
