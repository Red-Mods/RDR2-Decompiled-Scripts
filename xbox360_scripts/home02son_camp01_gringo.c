...
void Function_9(bool bParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7) //Position: 0x9D4 / 2516
{
	bool bVar0;
	bool bVar1;
...
bool Function_49(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x2BAB / 11179
{
...
void Function_58(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x2EB9 / 11961
{
	bool bVar0;
	bool bVar1;
...
void Function_79() //Position: 0x37D7 / 14295
{
	...
	{
		SNAP_ACTOR_TO_GRINGO(bLocal_8, bLocal_11, "UseCase1", true, 0, 0);
		TASK_USE_GRINGO(bLocal_8, GET_GRINGO_FROM_OBJECT(bLocal_11), "UseCase1", 4294967295, 1);
		Function_34(52);
	}
	else
	{
		...
		TASK_GO_NEAR_COORD(bLocal_8, &vLocal_12, 2.0f, true);
	}
...
void Function_88(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4) //Position: 0x4250 / 16976
{
	bool bVar0;
...
bool Function_89(bool bParam0, bool bParam1) //Position: 0x42A4 / 17060
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_94(int iParam0, bool bParam1) //Position: 0x4454 / 17492
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_102(int iParam0) //Position: 0x474D / 18253
{
	bool bVar0;
	bool bVar1;
...
var Function_103(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x4847 / 18503
{
	int iVar0;
	bool bVar1;
...
void Function_104(var uParam0, int iParam1) //Position: 0x487F / 18559
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

var Function_105(var uParam0, bool bParam1, int iParam2) //Position: 0x4890 / 18576
{
	int iVar0;
...
bool Function_106(int iParam0) //Position: 0x4954 / 18772
{
	int iVar0;
	int iVar1;
...
void Function_107() //Position: 0x4CCF / 19663
{
	if (!Function_153(128))
	{
		return;
...
bool Function_108() //Position: 0x4D0F / 19727
{
	int iVar0;
...
void Function_109() //Position: 0x4D3A / 19770
{
	if (!Function_153(128))
	{
		return;
...
void Function_110(int iParam0, bool bParam1) //Position: 0x4D7C / 19836
{
	char* cVar0[32];
...
void Function_111(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, char* cParam8) //Position: 0x4E00 / 19968
{
	var uVar0;
	var uVar1;
...
void Function_112(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) //Position: 0x4E29 / 20009
{
...
var Function_113(var uParam0, bool bParam1) //Position: 0x4E7A / 20090
{
	return (uParam0 || SHIFT_LEFT(bParam1, 16));
}

var Function_114() //Position: 0x4E8A / 20106
{
	return "PackedGrass";
}

var Function_115(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4E9E / 20126
{
	int iVar0;
...
var Function_116() //Position: 0x4EC3 / 20163
{
	return "PackedMetadata";
}

void Function_117(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4) //Position: 0x4EDA / 20186
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
vector3 Function_118() //Position: 0x5000 / 20480
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_119() //Position: 0x5011 / 20497
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_120() //Position: 0x5022 / 20514
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_121(var uParam0, int iParam1) //Position: 0x5033 / 20531
{
...
var Function_122(var uParam0, int iParam1, bool bParam2) //Position: 0x5056 / 20566
{
	int iVar0;
...
var Function_123(bool bParam0) //Position: 0x5075 / 20597
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_124() //Position: 0x5081 / 20609
{
	return Function_125(39);
}

int Function_125(int iParam0) //Position: 0x508C / 20620
{
	int iVar0;
...
var Function_126() //Position: 0x50BA / 20666
{
	return "PackedWeapon";
}

int Function_127(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x50CF / 20687
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_128() //Position: 0x51D3 / 20947
{
	return "MPItemGiver";
}

struct<32> Function_129(bool bParam0) //Position: 0x51E7 / 20967
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_130(char* cParam0, char* cParam1, char* cParam2) //Position: 0x5251 / 21073
{
	char* cVar0[32];
...
var Function_131() //Position: 0x5270 / 21104
{
	return "PBox_";
}

var Function_132() //Position: 0x527E / 21118
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_133() //Position: 0x52A4 / 21156
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_134() //Position: 0x52CC / 21196
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_135(var uParam0, int iParam1) //Position: 0x52F2 / 21234
{
	int iVar0;
	var uVar1;
...
void Function_136(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5453 / 21587
{
	struct<8> Var0;
...
int Function_137(bool bParam0) //Position: 0x54EE / 21742
{
	int iVar0;
	vector3 vVar1;
...
void Function_138(int iParam0) //Position: 0x564F / 22095
{
...
var Function_139() //Position: 0x56B0 / 22192
{
	int iVar0;
...
var Function_140(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x56B8 / 22200
{
	return Function_141(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_141(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x56D1 / 22225
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_142(int iParam0) //Position: 0x59C4 / 22980
{
	int iVar0;
...
void Function_143() //Position: 0x5A78 / 23160
{
	int iVar0;
...
bool Function_144(bool bParam0) //Position: 0x5AB2 / 23218
{
	int iVar0;
...
void Function_145(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x5ADF / 23263
{
	bool bVar0;
...
void Function_146() //Position: 0x5C30 / 23600
{
	int iVar0;
...
var Function_147(var uParam0, int iParam1, int iParam2, bool bParam3) //Position: 0x5C7B / 23675
{
	int iVar0;
...
int Function_148() //Position: 0x5D4B / 23883
{
	int iVar0;
...
int Function_149() //Position: 0x5EA7 / 24231
{
	int iVar0;
...
bool Function_150(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x5FC7 / 24519
{
	var uVar0;
	int iVar3;
	bool bVar4;
...
bool Function_151(int iParam0, float fParam1, int iParam2, int iParam3) //Position: 0x6097 / 24727
{
	var uVar0;
	int iVar3;
	vector3 vVar4;
...
bool Function_152(bool bParam0) //Position: 0x61C9 / 25033
{
	bool bVar0;
...
bool Function_153(int iParam0) //Position: 0x61E8 / 25064
{
	int iVar0;
...
int Function_154() //Position: 0x6204 / 25092
{
	if (Function_156())
	{
...
int Function_155() //Position: 0x621D / 25117
{
	return Global_79349.f_16;
}

bool Function_156() //Position: 0x6229 / 25129
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_157(int iParam0, bool bParam1, bool bParam2) //Position: 0x6232 / 25138
{
	var uVar0;
