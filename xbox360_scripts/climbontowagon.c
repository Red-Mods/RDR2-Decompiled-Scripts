	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_81, &bLocal_80);
...
var Function_63(bool bParam0, bool bParam1, var uParam2, bool bParam3, bool bParam4, var uParam5) //Position: 0x25A5 / 9637
{
	bool bVar0;
...
void Function_64(var uParam0, int iParam1) //Position: 0x2621 / 9761
{
	int iVar0;
	
	iVar0 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(*uParam0, 0);
	Function_65(&iVar0, iParam1);
	CUTSCENEOBJECT_SET_RECENTER_GAMECAM(*uParam0, 0);
	CUTSCENEOBJECT_ADD_TRANSITION_HOLD(*uParam0, 0, 2.0f, 0);
	return;
}

void Function_65(var uParam0, bool bParam1) //Position: 0x2648 / 9800
{
	vector3 vVar0;
...
vector3 Function_66(bool bParam0) //Position: 0x2700 / 9984
{
	vector3 vVar0;
...
vector3 Function_67(bool bParam0) //Position: 0x2727 / 10023
{
	vector3 vVar0;
...
var Function_68() //Position: 0x274E / 10062
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_69(int iParam0) //Position: 0x2757 / 10071
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x2761 / 10081
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x277F / 10111
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x2794 / 10132
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x281B / 10267
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x283E / 10302
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x285C / 10332
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x287F / 10367
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x299A / 10650
{
...
int Function_78(bool bParam0) //Position: 0x29C5 / 10693
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2ACA / 10954
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2AD7 / 10967
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2B4A / 11082
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x3048 / 12360
{
	bool bVar0;
...
bool Function_83(bool bParam0) //Position: 0x307F / 12415
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x309C / 12444
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x30D4 / 12500
{
	iParam0 = iParam0;
	return;
}

bool Function_86(bool bParam0) //Position: 0x30DE / 12510
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_87(var uParam0, int iParam1) //Position: 0x30FF / 12543
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	...
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT()), false);
	return;
}

void Function_88(bool bParam0, bool bParam1) //Position: 0x3130 / 12592
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x3238 / 12856
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x324E / 12878
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(var uParam0, int iParam1) //Position: 0x3504 / 13572
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	HUD_ENABLE(false);
	ENABLE_USE_CONTEXTS(0);
	SET_PHYSINST_FROZEN(GET_PHYSINST_FROM_OBJECT(GET_TARGET_OBJECT()), true);
	return;
}

bool Function_92(bool bParam0) //Position: 0x3524 / 13604
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x353D / 13629
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x3557 / 13655
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x358F / 13711
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x35A6 / 13734
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x386F / 14447
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x388C / 14476
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3928 / 14632
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(bool bParam0, int iParam1) //Position: 0x3947 / 14663
{
	vector3 vVar0;
	struct<5> Var3;
...
bool Function_101(int iParam0) //Position: 0x399B / 14747
{
...
void Function_102(int iParam0) //Position: 0x39B7 / 14775
{
	iParam0 = iParam0;
	return;
}

void Function_103(bool bParam0, int iParam1) //Position: 0x39C1 / 14785
{
	bool bVar0;
	bool bVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x3A23 / 14883
{
...
void Function_105(int iParam0) //Position: 0x3A37 / 14903
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3A41 / 14913
{
