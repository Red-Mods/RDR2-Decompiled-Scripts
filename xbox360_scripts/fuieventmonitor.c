...
void Function_2(bool bParam0) //Position: 0x18B / 395
{
	...
	if (UI_ISACTIVE("Net_titles"))
	{
		...
		{
			Var0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_9(UI_GET_SELECTED_INDEX("Net_titles", 0)) };
			UI_SET_TEXT("MPP_TitleValue", &Var0);
			Function_6(Function_8(UI_GET_SELECTED_INDEX("Net_titles", 0)));
...
void Function_6(int iParam0) //Position: 0x70A / 1802
{
	...
	cVar0 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_7(iParam0) };
...
struct<64> Function_7(int iParam0) //Position: 0x78C / 1932
{
	int iVar0;
	struct<16> Var1;
...
var Function_8(int iParam0) //Position: 0x7BE / 1982
{
	int iVar0;
	bool bVar1;
...
struct<64> Function_9(var uParam0) //Position: 0x857 / 2135
{
	return StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_7(Function_8(uParam0));
}

void Function_10() //Position: 0x867 / 2151
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Var5 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_14(Global_83864.f_1264, 0, 1, 0) };
	...
	if (Global_83864.f_1264 <= 49)
	{
		...
		bVar4 = (Global_83864[Global_83864.f_1264 + 16] - Function_13(487));
		bVar2 = ((fVar3 - bVar4) / fVar3);
		UI_SET_STRING("MMP_nxtLvl", I2STR(bVar1));
		UI_SET_STRING("MMP_deltaXP", I2STR(ROUND(bVar4)));
		bVar13 = Function_11(bVar0);
		bVar14 = Function_11(bVar1);
		UI_SET_TEXT("currentRankLevel", bVar13);
		UI_SET_TEXT("nextRankLevel", bVar14);
		Var15 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_14(Global_83864.f_1264, 0, 0, 1) };
		UI_TEXTURE_SET_NAME("currentRankIcon", &Var15);
		Var15 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_14(Global_83864.f_1264 + 1, 0, 0, 1) };
		UI_TEXTURE_SET_NAME("nextRankIcon", &Var15);
		UI_SET_PROGRESS_BAR_VAL("rankProgress", bVar2);
	}
	else
	{
		...
		bVar0 = Global_83864.f_1264 + 1;
		UI_SET_TEXT("currentRankLevel", Function_11(bVar0));
		Var23 = { StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, StackVal, Function_14(Global_83864.f_1264, Global_84364.f_708, 0, 1) };
		UI_TEXTURE_SET_NAME("currentRankIcon", &Var23);
	}
	return;
}

var Function_11(bool bParam0) //Position: 0xB23 / 2851
{
	bool bVar0;
...
var Function_12() //Position: 0xB3A / 2874
{
...
float Function_13(int iParam0) //Position: 0xBF6 / 3062
{
...
struct<32> Function_14(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0xC2F / 3119
{
	char* cVar0[32];
...
struct<32> Function_15(char* cParam0, char* cParam1) //Position: 0xD24 / 3364
{
	char* cVar0[32];
...
bool Function_16() //Position: 0xD3D / 3389
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_17(bool bParam0) //Position: 0xD46 / 3398
{
	struct<4> Var0;
	int iVar4;
	vector3 vVar5;
	...
	if (UI_ISACTIVE("Poker_Quit_Confirmation_Popup"))
	{
		...
		{
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Function_79()), "bQuitMinigame", true);
			UI_EXIT("Poker_Quit_Confirmation_Popup");
		}
		else if (DECOR_CHECK_STRING(bParam0, "Param", "RollOver_No"))
		{
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Function_79()), "bQuitMinigame", false);
			UI_EXIT("Poker_Quit_Confirmation_Popup");
		}
	}
	...
	else if (UI_ISACTIVE("Merchant05_Retry_Confirmation_Popup"))
	{
		if (DECOR_CHECK_STRING(bParam0, "Param", "RollOver_Yes"))
		{
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Function_79()), "bRetryMerchant05", true);
			UI_EXIT("Merchant05_Retry_Confirmation_Popup");
		}
		else if (DECOR_CHECK_STRING(bParam0, "Param", "RollOver_No"))
		{
			DECOR_SET_BOOL(GET_OBJECT_FROM_ACTOR(Function_79()), "bRetryMerchant05", false);
			UI_EXIT("Merchant05_Retry_Confirmation_Popup");
		}
	}
	...
	else if (UI_ISACTIVE("MP_AvatarQuit"))
	{
		if (DECOR_CHECK_STRING(bParam0, "Param", "RollOver_Yes"))
		{
			DECOR_SET_BOOL(Function_79(), "AvatarQuit", true);
	...
	else if (UI_ISACTIVE("MP_BarkerPosseLeave"))
	{
		if (DECOR_CHECK_STRING(bParam0, "Param", "RollOver_Yes"))
		{
			DECOR_SET_BOOL(Function_73(), "BarkerPosseLeave", true);
	...
	else if (UI_ISACTIVE("MissionFailedMenu"))
	{
		...
		if (UI_ISACTIVE("Mission_Failed_Jump_Confirmation_Popup"))
		{
			...
			if (DECOR_CHECK_STRING(bParam0, "Param", "Jump_Yes") || Global_62478)
			{
				...
				Function_72();
				Function_71(1);
				Var0 = { StackVal, StackVal, StackVal, Function_70(Global_34165.f_20) };
				iVar4 = 0;
				Function_69(&uVar14, &iVar4);
				vVar11 = { StackVal, StackVal, Function_69(&uVar14, &iVar4) };
				Function_68(StackVal, StackVal, &vVar5, &vVar8, vVar11, uVar14, iVar4);
		...
		if (DECOR_CHECK_STRING(bParam0, "Param", "Restart"))
		{
			...
			Function_65();
			cVar15 = { StackVal, StackVal, StackVal, Function_64(Global_34165.f_20) };
			stradd(&cVar15, "_Retry", 16);
			UPDATE_PROFILE_STAT(&cVar15, 1.0f, 0);
			if (Global_34165.f_28)
			{
				Var0 = { StackVal, StackVal, StackVal, Function_70(Global_34165.f_20) };
				Function_68(StackVal, StackVal, &vVar19, &vVar22, Global_34165, Global_34165.f_12, Global_34165.f_16);
		...
		else if (DECOR_CHECK_STRING(bParam0, "Param", "cancelMission"))
		{
			...
			if (!Global_3381)
			{
				Function_68(StackVal, StackVal, &vVar25, &vVar28, *(&Global_34165 + 144), Global_34165.f_156, Global_34165.f_160);
		...
		else if (DECOR_CHECK_STRING(bParam0, "Param", "InTransitionComplete"))
		{
			if (!Function_16())
			{
				...
				if (iVar31 != (3 - 1) && 2 == GET_PLAYER_COMBATMODE())
				{
	...
	else if (UI_ISACTIVE("DeathScreen"))
	{
		if (DECOR_CHECK_STRING(bParam0, "Param", "InTransitionComplete"))
		{
			...
			{
				iVar4 = 1;
				Function_68(StackVal, StackVal, &vVar32, &vVar35, *(&Global_34165 + 144), Global_34165.f_156, Global_34165.f_160);
			}
			else
			{
				Function_53(Function_54(Global_26316[Global_26401.f_2216]));
				vVar32 = { StackVal, StackVal, Function_53(Function_54(Global_26316[Global_26401.f_2216])) };
				Function_51(Function_54(Global_26316[Global_26401.f_2216]));
				vVar35 = { StackVal, StackVal, Function_51(Function_54(Global_26316[Global_26401.f_2216])) };
			}
		...
		if (DECOR_CHECK_STRING(bParam0, "Param", "fileSaveInSelectedSlotBeginNew") || DECOR_CHECK_STRING(bParam0, "Param", "fileSaveInSelectedSlotBeginOverwrite"))
		{
			...
			else
			{
				...
				if (IS_OBJECT_VALID(bVar38))
				{
					...
					bVar42 = GET_OBJECT_HEADING(bVar38);
					Function_46(StackVal, StackVal, vVar39, bVar42);
		...
		else if ((DECOR_CHECK_STRING(bParam0, "Param", "fileSelectedSaveSuccess") || DECOR_CHECK_STRING(bParam0, "Param", "CancelSave")) || DECOR_CHECK_STRING(bParam0, "Param", "fileNoSaveEvent"))
		{
			if (!Function_50(Global_63095, 1))
			{
				...
				if (IS_OBJECT_VALID(bVar43))
				{
					...
					bVar47 = GET_OBJECT_HEADING(bVar43);
					MAKE_ACTOR_READY_FOR_ACTION(Global_34573, 1);
					TELEPORT_ACTOR_WITH_HEADING(Global_34573, vVar44, bVar47, 0, true, 1);
				}
				else
				{
					LOG_ERROR("No valid wake up flag found!");
					fVar48 = GET_CURRENT_GRINGO(GET_PLAYER_ACTOR(0));
					if (IS_GRINGO_VALID(fVar48))
					{
						GRINGO_DEACTIVATE(fVar48);
					}
				}
			}
			else
			{
				fVar49 = GET_CURRENT_GRINGO(GET_PLAYER_ACTOR(0));
				if (IS_GRINGO_VALID(fVar49))
				{
					GRINGO_DEACTIVATE(fVar49);
				}
			}
...
void Function_18() //Position: 0x2240 / 8768
{
...
void Function_19(var uParam0, int iParam1) //Position: 0x234C / 9036
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_20() //Position: 0x235F / 9055
{
	Function_44();
	Function_43();
	Function_43();
...
void Function_21() //Position: 0x2392 / 9106
{
...
void Function_22() //Position: 0x2498 / 9368
{
	float fVar0;
...
void Function_23() //Position: 0x24CB / 9419
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_24() //Position: 0x2659 / 9817
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void Function_25() //Position: 0x280D / 10253
{
	Function_26(&Global_28260, 1, 0);
	return;
}

void Function_26(int iParam0, bool bParam1, var uParam2) //Position: 0x281B / 10267
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<8> Function_27() //Position: 0x2A0C / 10764
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
int Function_28(int iParam0, bool bParam1, bool bParam2) //Position: 0x2AA7 / 10919
{
	int iVar0;
...
void Function_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x2D42 / 11586
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
	...
	if (!Global_49306)
	{
		...
		switch (Global_35278[iParam020].f_48)
		{
			...
			case 0x00000006:
				...
				{
					bVar19 = (Function_13(iParam0) - bParam2);
					bVar20 = bParam2;
				}
				else
				{
...
var Function_30() //Position: 0x336F / 13167
{
	int iVar0;
...
var Function_31(int iParam0) //Position: 0x3377 / 13175
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

void Function_32(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x3388 / 13192
{
	float fVar0;
...
var Function_33(int iParam0, int iParam1) //Position: 0x33ED / 13293
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_34(int iParam0, bool bParam1) //Position: 0x33FF / 13311
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_35(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x3411 / 13329
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_36(int iParam0) //Position: 0x3541 / 13633
{
	return Global_35278[iParam020].f_48;
}

var Function_37(int iParam0) //Position: 0x3550 / 13648
{
	if (iParam0 == 4294967295)
	{
...
void Function_38(int iParam0) //Position: 0x358D / 13709
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_39(int iParam0, bool bParam1, bool bParam2) //Position: 0x3727 / 14119
{
	int iVar0;
	int iVar1;
...
int Function_40(bool bParam0) //Position: 0x3941 / 14657
{
...
struct<8> Function_41() //Position: 0x3982 / 14722
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_42() //Position: 0x3A0B / 14859
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
struct<8> Function_43() //Position: 0x3AA2 / 15010
{
	char* cVar0[8];
	int iVar2;
	int iVar3;
...
void Function_44() //Position: 0x3B21 / 15137
{
...
int Function_45(int iParam0, bool bParam1, int iParam2) //Position: 0x3B47 / 15175
{
	int iVar0;
	int iVar1;
...
void Function_46(struct<5> Param0) //Position: 0x3D51 / 15697
{
	var uVar0;
	...
	if (Function_47(Global_29005))
	{
	}
	Global_34165.f_52 = GET_TIME_OF_DAY();
}

bool Function_47(int iParam0) //Position: 0x3DAE / 15790
{
...
var Function_48() //Position: 0x3DC4 / 15812
{
	if (DECOR_CHECK_EXIST(Global_34573, "SAVE_restartFlag"))
	{
...
void Function_49() //Position: 0x3E02 / 15874
{
	struct<5> Var0;
...
bool Function_50(var uParam0, int iParam1) //Position: 0x3E95 / 16021
{
	return (uParam0 && iParam1) == 0;
}

vector3 Function_51(int iParam0) //Position: 0x3EA2 / 16034
{
	switch (iParam0)
	{
		case 0x00000001:
...
vector3 Function_52() //Position: 0x3F30 / 16176
{
	return 0.0f, 0.0f, 0.0f;
}

vector3 Function_53(int iParam0) //Position: 0x3F39 / 16185
{
	switch (iParam0)
	{
		case 0x00000001:
...
int Function_54(int iParam0) //Position: 0x3FDF / 16351
{
...
bool Function_55(int iParam0) //Position: 0x4044 / 16452
{
	int iVar0;
...
void Function_56() //Position: 0x4062 / 16482
{
	HUD_CLEAR_BIG_TEXT();
...
void Function_57() //Position: 0x4077 / 16503
{
	struct<145> Var0;
	...
	*(&Var0 + 80) = 3;
	...
	Var0.f_140 = Function_40(11);
	Var0.f_144 = Function_58(Function_62(Global_6269));
	if (Var0.f_16)
	{
		Var0.f_16 = 0;
		Var0.f_24 = 0;
...
int Function_58(int iParam0) //Position: 0x40C9 / 16585
{
...
bool Function_59(int iParam0) //Position: 0x40E3 / 16611
{
...
bool Function_60(int iParam0) //Position: 0x4107 / 16647
{
...
bool Function_61(int iParam0) //Position: 0x411C / 16668
{
...
int Function_62(int iParam0) //Position: 0x4133 / 16691
{
...
bool Function_63(int iParam0) //Position: 0x414D / 16717
{
...
struct<16> Function_64(int iParam0) //Position: 0x4163 / 16739
{
	char* cVar0[16];
...
void Function_65() //Position: 0x4188 / 16776
{
	struct<145> Var0;
	...
	*(&Var0 + 80) = 3;
	...
	Var0.f_140 = Function_40(11);
	Var0.f_144 = Function_58(Function_62(Global_6269)) + 1;
	STORE_GAME_STATE(&Var0, 44, 1);
	return;
}

int Function_66(int iParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x41C4 / 16836
{
	int iVar0;
	int iVar1;
...
void Function_67() //Position: 0x43E4 / 17380
{
...
var Function_68(var uParam0, var uParam1, vector3 vParam2, bool bParam5, int iParam6) //Position: 0x444B / 17483
{
	bool bVar0;
...
vector3 Function_69(var uParam0, int iParam1) //Position: 0x4572 / 17778
{
	struct<61> Var0;
...
struct<16> Function_70(int iParam0) //Position: 0x45BE / 17854
{
	char* cVar0[16];
...
void Function_71(bool bParam0) //Position: 0x45EF / 17903
{
	struct<73> Var0;
...
void Function_72() //Position: 0x461E / 17950
{
	struct<133> Var0;
...
var Function_73() //Position: 0x4661 / 18017
{
...
void Function_74(bool bParam0) //Position: 0x4690 / 18064
{
...
void Function_75(int iParam0) //Position: 0x4719 / 18201
{
	Function_76(&Global_79338, iParam0);
	return;
}

void Function_76(var uParam0, int iParam1) //Position: 0x4728 / 18216
{
	Function_19(uParam0, iParam1);
	return;
}

void Function_77(int iParam0) //Position: 0x4735 / 18229
{
	Function_78(&Global_79338, iParam0);
	return;
}

void Function_78(var uParam0, var uParam1) //Position: 0x4744 / 18244
{
	Function_4(uParam0, uParam1);
	return;
}

var Function_79() //Position: 0x4751 / 18257
{
...
void Function_80(bool bParam0) //Position: 0x4766 / 18278
{
	if (!IS_EVENT_VALID(bParam0))
	{
		return;
...
void Function_81() //Position: 0x47FC / 18428
{
	Function_82(532);
	return;
}

void Function_82(var uParam0) //Position: 0x4808 / 18440
{
	Function_78(&Global_78617 + 52, uParam0);
	return;
}

void Function_83() //Position: 0x4819 / 18457
{
