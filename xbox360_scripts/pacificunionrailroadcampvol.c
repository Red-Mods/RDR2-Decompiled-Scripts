...
void Function_5(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3FB / 1019
{
	bool bVar0;
...
void Function_6(bool bParam0, bool bParam1, bool bParam2) //Position: 0x4D8 / 1240
{
	int iVar0;
...
void Function_7() //Position: 0x651 / 1617
{
	Global_16517.f_20 = 0.0f;
	return;
}

void Function_8(bool bParam0) //Position: 0x65D / 1629
{
	PRINTSTRING("Day ");
...
void Function_9(int iParam0) //Position: 0x6A3 / 1699
{
	switch (iParam0)
	{
		case 0x00000000:
...
void Function_10(var uParam0, int iParam1) //Position: 0x6E9 / 1769
{
	int iVar0;
...
bool Function_11(var uParam0, int iParam1) //Position: 0x703 / 1795
{
	int iVar0;
...
void Function_12(var uParam0, bool bParam1) //Position: 0x720 / 1824
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_13(var uParam0, int iParam1) //Position: 0xAEC / 2796
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_14(var uParam0, int iParam1) //Position: 0xAFD / 2813
{
	int iVar0;
...
int Function_15(int iParam0, bool bParam1) //Position: 0xB17 / 2839
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
bool Function_16() //Position: 0xB29 / 2857
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_17(var uParam0, var uParam1, bool bParam2, var uParam3) //Position: 0xB32 / 2866
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool Function_18(var uParam0, bool bParam1, int iParam2, var uParam3, bool bParam4) //Position: 0xBB3 / 2995
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_19(int iParam0) //Position: 0xFCC / 4044
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float Function_20(int iParam0) //Position: 0x10CB / 4299
{
...
float Function_21(int iParam0) //Position: 0x1108 / 4360
{
	if (!iParam0 != 4294967295)
	{
...
void Function_22(int iParam0, bool bParam1) //Position: 0x1141 / 4417
{
	bool bVar0;
...
var Function_23(int iParam0) //Position: 0x11A8 / 4520
{
	int iVar0;
...
int Function_24(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x1200 / 4608
{
	int iVar0;
	int iVar1;
...
void Function_25(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x1420 / 5152
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
...
var Function_26() //Position: 0x1A4D / 6733
{
	int iVar0;
...
var Function_27(int iParam0) //Position: 0x1A55 / 6741
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_28(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x1A66 / 6758
{
	char* cVar0[32];
...
struct<32> Function_29(char* cParam0, char* cParam1) //Position: 0x1B5B / 7003
{
	char* cVar0[32];
...
void Function_30(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x1B74 / 7028
{
	float fVar0;
...
var Function_31(int iParam0, int iParam1) //Position: 0x1BD9 / 7129
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
void Function_32(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x1BEB / 7147
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_33(int iParam0) //Position: 0x1D1B / 7451
{
	return Global_35278[iParam020].f_48;
}

void Function_34(int iParam0) //Position: 0x1D2A / 7466
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_35(int iParam0, float fParam1, bool bParam2) //Position: 0x1EC4 / 7876
{
	int iVar0;
	int iVar1;
...
void Function_36(var uParam0, int iParam1) //Position: 0x20DE / 8414
{
	AMBIENCE_AUDIO_ENTITY_UPDATE_LOCATION(&uParam0, &iParam1);
	return;
}

void Function_37(struct<5> Param0) //Position: 0x20EB / 8427
{
...
bool Function_38(var uParam0, int iParam1) //Position: 0x2111 / 8465
{
	int iVar0;
...
var Function_39(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x212D / 8493
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_40() //Position: 0x23BD / 9149
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_41(bool bParam0, bool bParam1) //Position: 0x2420 / 9248
{
...
bool Function_42(bool bParam0) //Position: 0x244F / 9295
{
	if (Function_47(256))
	{
		return 0;
...
int Function_43(int iParam0) //Position: 0x24C5 / 9413
{
...
bool Function_44() //Position: 0x24D6 / 9430
{
	if (Global_30619 == 2)
	{
		if (StackVal == 1)
...
bool Function_45(int iParam0) //Position: 0x24EF / 9455
{
...
bool Function_46(int iParam0) //Position: 0x2505 / 9477
{
...
bool Function_47(int iParam0) //Position: 0x251A / 9498
{
	int iVar0;
...
bool Function_48(var uParam0, int iParam1, var uParam2, var uParam3) //Position: 0x2538 / 9528
{
	uParam0 = uParam0;
...
bool Function_49(int iParam0) //Position: 0x25DC / 9692
{
...
void Function_50(var uParam0, int iParam1) //Position: 0x25F2 / 9714
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_51(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x2603 / 9731
{
	int iVar0;
	bool bVar1;
...
void Function_52(int iParam0, int iParam1) //Position: 0x2675 / 9845
{
	int iVar0;
...
bool Function_53(int iParam0) //Position: 0x269A / 9882
{
	if (*iParam0 == 0)
	{
		return 0;
...
bool Function_54(int iParam0) //Position: 0x26B7 / 9911
{
	int iVar0;
...
void Function_55(bool bParam0, float fParam1) //Position: 0x26D3 / 9939
{
	if (!Function_54(128))
	{
		return;
...
void Function_56(var uParam0, int iParam1) //Position: 0x2711 / 10001
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_57(var uParam0, bool bParam1) //Position: 0x2720 / 10016
{
...
var Function_58(var uParam0, bool bParam1, bool bParam2, int iParam3, char* cParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8) //Position: 0x2732 / 10034
{
	int iVar0;
	char* cVar1[32];
	char* cVar9[8];
...
var Function_59(bool bParam0) //Position: 0x2811 / 10257
{
	int iVar0;
...
void Function_60(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5) //Position: 0x283F / 10303
{
...
void Function_61(int iParam0) //Position: 0x291A / 10522
{
	*iParam0 = 0;
	iParam0->f_4 = 0;
	return;
...
var Function_62(bool bParam0, bool bParam1, int iParam2) //Position: 0x2929 / 10537
{
	Global_29155[iParam210].f_32 = CREATE_WORLD_SECTOR(bParam0, bParam1);
	return Global_29155[iParam210].f_32;
}

bool Function_63() //Position: 0x2948 / 10568
{
	var uVar0;
...
void Function_64(int iParam0, int iParam1) //Position: 0x3CAC / 15532
{
	switch (iParam1)
	{
		case 0x00000000:
...
var Function_65() //Position: 0x3CF5 / 15605
{
...
void Function_66(bool bParam0, var uParam1) //Position: 0x3D0A / 15626
{
	if (!Function_54(128))
	{
		return;
