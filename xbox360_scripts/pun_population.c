...
void main() //Position: 0x0 / 0
{
	...
	Function_12(&bVar1, 1052, 4.0f, 0, 0);
	bVar2 = Function_14("animal_duck", 0);
	Function_12(&bVar2, 1140, 100.0f, 0, 0);
	Function_12(&bVar2, 1140, 100.0f, 0, 0);
	Function_12(&bVar2, 1140, 100.0f, 0, 0);
	bVar3 = Function_14("cougar_pop", 0);
	Function_12(&bVar3, 1113, 4.0f, 0, 0);
	Function_12(&bVar3, 1113, 4.0f, 0, 0);
	Function_12(&bVar3, 1112, 4.0f, 0, 0);
	...
	Function_12(&bVar14, 981, 8.0f, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar19))
	{
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_4())
			{
				uVar21 = Function_3(bVar20, bVar14, 1,5E-05f, 0, 1, 1);
			...
			uVar22 = Function_3(bVar20, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar23 = Function_3(bVar20, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar24 = Function_3(bVar20, bVar4, 2,1E-05f, 0, 0, 1);
			...
			uVar25 = Function_3(bVar20, bVar0, 9E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar25, 2);
			uVar26 = Function_3(bVar20, bVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar26, 2);
			uVar27 = Function_3(bVar20, bVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_4())
			{
				uVar28 = Function_3(bVar20, bVar14, 1,5E-05f, 0, 1, 1);
			...
			uVar29 = Function_3(bVar20, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar30 = Function_3(bVar20, bVar6, 2,1E-05f, 0, 0, 1);
			...
			uVar31 = Function_3(bVar20, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar32 = Function_3(bVar20, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar33 = Function_3(bVar20, bVar4, 2,1E-05f, 0, 0, 1);
			...
			uVar34 = Function_3(bVar20, bVar0, 9E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar34, 2);
			uVar35 = Function_3(bVar20, bVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar35, 2);
			uVar36 = Function_3(bVar20, bVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			if (!Function_4())
			{
				uVar37 = Function_3(bVar20, bVar14, 1,5E-05f, 0, 1, 1);
			...
			uVar38 = Function_3(bVar20, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar39 = Function_3(bVar20, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar40 = Function_3(bVar20, bVar7, 6E-05f, 0, 0, 1);
			...
			uVar41 = Function_3(bVar20, bVar4, 2,1E-05f, 0, 0, 1);
			...
			uVar42 = Function_3(bVar20, bVar3, 2,1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar42, 1);
			uVar43 = Function_3(bVar20, bVar0, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar43, 2);
			uVar44 = Function_3(bVar20, bVar9, 6E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar44, 2);
			uVar45 = Function_3(bVar20, bVar8, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			Function_3(bVar20, bVar10, 8E-05f, 0, 0, 1);
			Function_3(bVar20, bVar11, 8E-05f, 0, 0, 1);
			Function_3(bVar20, bVar12, 8E-05f, 0, 0, 1);
			Function_3(bVar20, bVar13, 6E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar20))
		{
			Function_3(bVar20, bVar2, 0,00012f, 0, 0, 1);
			Function_3(bVar20, bVar8, 6E-05f, 0, 0, 1);
			Function_3(bVar20, bVar0, 6E-05f, 0, 0, 1);
			Function_3(bVar20, bVar9, 6E-05f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1AD0 / 6864
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1C41 / 7233
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1CAD / 7341
{
	bool bVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1D19 / 7449
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1D8E / 7566
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x1DD3 / 7635
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0x1DE0 / 7648
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0x1DEC / 7660
{
	if (!Function_5(128))
	{
		return;
