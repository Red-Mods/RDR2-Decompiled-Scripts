...
bool Function_23(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7) //Position: 0x1B32 / 6962
{
...
void Function_25(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1BA0 / 7072
{
	bool bVar0;
	bool bVar1;
...
void Function_33(bool bParam0, bool bParam1, float fParam2, float fParam3, int iParam4, bool bParam5) //Position: 0x1EAA / 7850
{
	bool bVar0;
	bool bVar1;
...
var Function_55(var uParam0, var uParam1, char* cParam2, vector3 vParam3, vector3 vParam6, int iParam9) //Position: 0x27A1 / 10145
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_63(var uParam0, bool bParam1, int iParam2) //Position: 0x31CD / 12749
{
	int iVar0;
...
vector3 Function_77() //Position: 0x3986 / 14726
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_78() //Position: 0x3997 / 14743
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_79() //Position: 0x39A8 / 14760
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_80(var uParam0, int iParam1) //Position: 0x39B9 / 14777
{
...
var Function_81(var uParam0, int iParam1, int iParam2) //Position: 0x39DC / 14812
{
	int iVar0;
...
var Function_82(bool bParam0) //Position: 0x39FB / 14843
{
	return SHIFT_LEFT(true, bParam0);
}

int Function_83() //Position: 0x3A07 / 14855
{
	return Function_84(39);
}

int Function_84(int iParam0) //Position: 0x3A12 / 14866
{
	int iVar0;
...
var Function_85() //Position: 0x3A40 / 14912
{
	return "PackedWeapon";
}

int Function_86(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x3A55 / 14933
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_87() //Position: 0x3B59 / 15193
{
	return "MPItemGiver";
}

struct<32> Function_88(bool bParam0) //Position: 0x3B6D / 15213
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_89(char* cParam0, char* cParam1, char* cParam2) //Position: 0x3BD7 / 15319
{
	char* cVar0[32];
...
var Function_90() //Position: 0x3BF6 / 15350
{
	return "PBox_";
}

var Function_91() //Position: 0x3C04 / 15364
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_92() //Position: 0x3C2A / 15402
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_93() //Position: 0x3C52 / 15442
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_94(var uParam0, int iParam1) //Position: 0x3C78 / 15480
{
	int iVar0;
	var uVar1;
...
void Function_95(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x3DD9 / 15833
{
	struct<8> Var0;
...
int Function_96(bool bParam0) //Position: 0x3E74 / 15988
{
	int iVar0;
	vector3 vVar1;
...
void Function_97(int iParam0) //Position: 0x3FD5 / 16341
{
...
var Function_100(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x4058 / 16472
{
	bool bVar0;
	bool bVar1;
	int iVar2;
