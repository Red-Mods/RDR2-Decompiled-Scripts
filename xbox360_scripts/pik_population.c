...
void main() //Position: 0x0 / 0
{
	...
	if (IS_LAYOUTREF_VALID(bVar1))
	{
		...
		if (IS_VOLUME_VALID(bVar2))
		{
			Function_3(bVar2, bVar0, 0.0f, 0, 0, 1);
		}
		else
		{
...
var Function_3(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0xCDE / 3294
{
	bool bVar0;
...
var Function_9(int iParam0) //Position: 0xE46 / 3654
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0xEB2 / 3762
{
	bool bVar0;
...
var Function_11(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0xF1E / 3870
{
	int iVar0;
	int iVar1;
...
var Function_12(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0xF93 / 3987
{
	int iVar0;
	int iVar1;
...
var Function_13(bool bParam0, int iParam1) //Position: 0xFD8 / 4056
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_14(int iParam0) //Position: 0xFE5 / 4069
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_15(bool bParam0, var uParam1) //Position: 0xFF1 / 4081
{
	if (!Function_4(128))
	{
		return;
