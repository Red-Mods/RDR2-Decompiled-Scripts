...
void main() //Position: 0x0 / 0
{
	...
	iLocal_79 = 0;
	Function_127(uScriptParam_0, &iLocal_79);
	while (IS_GRINGO_ACTIVE())
	{
		...
		{
			GET_OBJECT_POSITION(bVar1, &uLocal_80);
		}
		iVar2 = 0;
		bLocal_85 = false;
		if (GRINGO_HAS_PENDING_MESSAGE())
		{
			...
			{
				if (Local_6[iVar012].f_12 == GRINGO_GET_MSG_COMPONENT_CONTEXT())
				{
					iVar3 = iVar0;
					iVar0 = iLocal_79;
				}
			...
			if (iVar3 >= 4294967295)
			{
				...
				{
					case 0x00000000:
						if (Function_120(&(Local_6[iVar312]), &bVar4))
						{
							Function_118(GRINGO_GET_REQUESTING_ACTOR(), Local_6[iVar312].f_12);
							bVar5 = true;
						}
						break;
					...
					case 0x00000002:
						if (Local_6[iVar312].f_16 == GRINGO_GET_REQUESTING_ACTOR())
						{
							Function_105("eGRINGO_EndUse: Stop use by request", Local_6[iVar312].f_16);
							Function_104(Local_6[iVar312].f_16, 1);
							if (IS_ACTOR_VALID(Local_6[iVar312].f_16))
							{
								if (IS_ACTOR_LOCAL_PLAYER(Local_6[iVar312].f_16) && !GRINGO_IS_CHARACTER_BLEND_PAUSED(Local_6[iVar312].f_12))
								{
									GRINGO_ENABLE_PLAYER_CONTROL(Local_6[iVar312].f_16, 1);
								}
							}
							if (GRINGO_IS_FORCE_QUITTING())
							{
								Function_97(&(Local_6[iVar312]), 0);
							}
							else if (Local_6[iVar312].f_44 < 8)
							{
								Function_96(&(Local_6[iVar312]));
								Local_6[iVar312].f_44 = 8;
							}
							bVar5 = true;
						}
						else
						{
							Function_130("Stop use request actor mismatch!!");
						}
						break;
				}
		...
		else
		{
			...
			while (iVar0 < (iLocal_79 - 1))
			{
				if (Function_95(Local_6[iVar012].f_40, 2))
				{
					if (!Function_16(&(Local_6[iVar012])))
					{
						Function_130("Quitting due to update end");
						Function_97(&(Local_6[iVar012]), 1);
					}
				}
				if (Function_15(&(Local_6[iVar012]), 0))
				{
					Function_5(&(Local_6[iVar012]));
				}
				iVar0++;
			}
		}
	...
	if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
	{
		Function_130("Removing quit context at script termination");
		RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
	}
	iVar0 = 0;
	while (iVar0 < (iLocal_79 - 1))
	{
		if (Function_95(Local_6[iVar012].f_40, 2))
		{
			Function_2("Gringo termination calls StopUse", Local_6[iVar012].f_16);
			Function_97(&(Local_6[iVar012]), 0);
		}
		if (GRINGO_HANDLES_MOVEMENT(Local_6[iVar012].f_12))
		{
			SET_GRINGO_BOOL_ATTR(0, "RandomPointSet", Local_6[iVar012].f_12);
		}
		Function_15(&(Local_6[iVar012]), 1);
		iVar0++;
	}
...
void Function_5(int iParam0) //Position: 0x47B / 1147
{
	...
	if (!Function_95(iParam0->f_40, 2))
	{
		Function_104(iParam0->f_16, 0);
	}
	else if (UNK_0x0A0E660E() || Function_14(iParam0))
	{
					...
					if (IS_ACTOR_LOCAL_PLAYER(iParam0->f_16))
					{
						if (UNK_0x0A0E660E() || !Global_3418)
						{
							...
							if (bVar0)
							{
								...
								if (!IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
								{
									Function_130("ManagePlayerQuit: Create quit context");
									if (Function_7(iParam0->f_12, "UseQuitBOverride", 0))
									{
										bLocal_86 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 5, false, 0, 0, 0, 4294967295, 0);
									}
									else
									{
										bLocal_86 = ADD_SCRIPT_USE_CONTEXT(bVar1, 500, 4, false, 0, 0, 0, 4294967295, 0);
									}
								}
								if (IS_SCRIPT_USE_CONTEXT_PRESSED(bLocal_86))
								{
									...
									if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
									{
										Function_130("ManagePlayerQuit: Release quit context - already pressed");
										RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
										iVar2 = 0;
								...
								if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
								{
									if (Function_6(iParam0->f_16))
									{
										...
										if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
										{
											Function_130("ManagePlayerQuit: Release quit context - used stick");
											RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
										}
									}
								}
						...
						else if (Global_3418)
						{
							if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
							{
								Function_130("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
								RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
							}
						}
					}
		...
		else if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
		{
			Function_130("ManagePlayerQuit: Release quit context - due to wrong phase for quit");
			RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
		}
...
bool Function_16(int iParam0) //Position: 0xA34 / 2612
{
	...
	bVar12 = Function_94(iParam0->f_12);
	if (!(IS_ACTOR_VALID(iParam0->f_16) && IS_ACTOR_ALIVE(iParam0->f_16)))
	{
		Function_105("UpdateUse with invalid actor", iParam0->f_16);
		return 0;
	}
	if (!Function_7(iParam0->f_12, "DenyDamageTermination", 0))
	{
		...
		{
			Function_105("Damage quit", iParam0->f_16);
			return 0;
		}
	}
	if (GET_ACTOR_INCAPACITATED(iParam0->f_16))
	{
		Function_105("Incapacitation quit", iParam0->f_16);
		return 0;
	}
	...
	switch (iParam0->f_44)
	{
		case 0x00000002:
			...
			{
				if (Function_93(iParam0->f_12, &fVar24))
				{
			...
			{
				if (Function_92(iParam0->f_16, iParam0->f_12))
				{
			...
			if (!Function_90(iParam0->f_12) && iParam0->f_44 != 1)
			{
		...
		case 0x00000001:
			...
			if (((!Global_63096 && IS_ACTOR_LOCAL_PLAYER(iParam0->f_16)) && !Function_95(iParam0->f_40, 1)) && !DECOR_CHECK_EXIST(iParam0->f_16, "NoGringoCamera"))
			{
				Function_88(iParam0->f_12);
			}
			fVar20 = Function_87(iParam0->f_12);
			if (Function_12(iParam0) < fVar20)
			{
				Function_2("INTRO TIMED OUT - ABORTING", iParam0->f_16);
				return 0;
			}
			if (Function_95(iParam0->f_40, 1))
			{
				Function_82(iParam0->f_12, &vVar3, &uVar6);
				if (!Function_95(iParam0->f_40, 16))
				{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, true, Function_80());
				}
				if (!Function_95(iParam0->f_40, 1024))
				{
			...
			else if (Function_92(iParam0->f_16, iParam0->f_12))
			{
				NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 1);
			...
			if (iParam0->f_44 != 3 && !Function_95(iParam0->f_40, 16))
			{
				if (GRINGO_SHOULD_SUSPEND_MOVER(iParam0->f_12))
				{
					Function_2("SUSPEND MOVER", iParam0->f_16);
		...
		case 0x00000003:
			if (Function_95(iParam0->f_40, 32))
			{
				bLocal_85 = true;
		...
		case 0x00000004:
			...
			bLocal_85 = true;
			Function_78(iParam0);
			Function_75(iParam0, Function_77(iParam0->f_12));
			if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
			{
			...
			if (iVar32 == 0)
			{
				bVar33 = Function_95(iParam0->f_40, 1);
			}
			bVar0 = Function_74(iParam0->f_16, iParam0->f_12, bVar33);
			...
			else if (bVar12)
			{
				if (GRINGO_PLAY_ANIM_ON_ACTOR(iParam0->f_16, bVar0, bVar33))
				{
					...
					while (bVar11 >= 4294967295)
					{
						...
						{
							Function_73(bVar1, iParam0->f_16);
							if (DECOR_CHECK_EXIST(iParam0->f_16, "LobbyGringo"))
							{
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_65(iParam0, bVar8, &iLocal_84, &bLocal_83);
				...
				if (IS_GRINGO_COMPONENT_VALID(bVar0))
				{
					...
					else if (Function_60(iParam0->f_12))
					{
						bVar2 = GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 3);
						if (IS_GRINGO_COMPONENT_VALID(bVar2))
						{
					...
					bVar10 = false;
					bVar7 = Function_59(iParam0->f_12, &bVar10);
					if (bVar10)
					{
						bVar2 = GRINGO_GET_PARENT_COMPONENT(iParam0->f_12, 3);
						if (IS_GRINGO_COMPONENT_VALID(bVar2))
				...
				if (Function_58(iParam0->f_12))
				{
					...
					{
						Function_64(iParam0 + 40, 8);
					}
					if (Function_95(iParam0->f_40, 8))
					{
				...
				Function_56(iParam0->f_16, iParam0->f_12);
		...
		case 0x00000006:
			...
			bVar0 = Function_74(iParam0->f_16, iParam0->f_12, Function_95(iParam0->f_40, 1));
			if (IS_GRINGO_COMPONENT_VALID(bVar0))
			{
			...
			if (iParam0->f_44 == 6)
			{
				...
				if (bVar21)
				{
					...
					{
						if (Function_12(iParam0) < Function_50(iParam0->f_12))
						{
...
void Function_17(bool bParam0, int iParam1) //Position: 0x1B7B / 7035
{
...
void Function_18(bool bParam0, int iParam1) //Position: 0x1B90 / 7056
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	{
		DECOR_SET_BOOL(bParam0, "Grave01_DugGrave", true);
	}
	vVar0 = { 0.0f, 0.0f, 0.0f };
	GET_OBJECT_POSITION(GRINGO_GET_MY_OBJECT_REF(), &vVar0);
	bVar3 = LOCATE_PHYSINST_OF_TYPE(vVar0, 2.0f, "p_gen_graveDug01x", 1);
	DESTROY_OBJECT(bVar3);
	bVar4 = LOCATE_PHYSINST_OF_TYPE(vVar0, 3.0f, "p_gen_openGrave01x", 1);
	if (IS_PHYSINST_VALID(bVar4))
	{
		SET_PHYSINST_FROZEN(bVar4, true);
	}
	Function_45(bVar4);
	vVar5 = { StackVal, StackVal, Function_45(bVar4) };
	GET_OBJECT_RELATIVE_POSITION(bVar4, -0,3f, 0,2f, -0,5f, &vVar5);
	bVar8 = CREATE_GRINGO_IN_LAYOUT(Global_30616, Function_44(), "$/content/scripting/gringo/simpleGringo/loot_corpse", vVar5, 0.0f, 0.0f, 0.0f);
	DECOR_SET_INT(bVar8, "IsDugGrave", false);
	bVar9 = Function_42(Global_29006);
	if (STRING_CONTAINS_STRING(bVar9, "Coot"))
	{
		bVar10 = LOCATE_NAMED_POINT(vVar0, 2,25f, "f_grave_", 1);
		bVar11 = GET_OBJECT_NAME(bVar10);
		STRING_CLEAR_TOKENIZER();
		SET_OWNERSHIP_STRAGGLER(bVar11, "_");
		bVar12 = STRING_GET_TOKEN(2);
		bVar13 = STRING_TO_INT(bVar12);
		bVar14 = FLOOR(POW(2.0f, TO_FLOAT(bVar13)));
		if (DECOR_CHECK_EXIST(bVar10, "Grave_Money"))
		{
			Function_26(DECOR_GET_INT(bVar10, "Grave_Money"), 1);
		}
		else if (DECOR_CHECK_EXIST(bVar10, "Grave_Weapon"))
		{
			SET_WEAPONENUM_LOCKED(DECOR_GET_INT(bVar10, "Grave_Weapon"), 0);
			GIVE_WEAPON_TO_ACTOR(bParam0, DECOR_GET_INT(bVar10, "Grave_Weapon"), false, 1, 1);
		}
		else if (DECOR_CHECK_EXIST(bVar10, "Grave_Item"))
		{
			Function_23(DECOR_GET_INT(bVar10, "Grave_Item"), 0, 0);
		}
	}
	Function_19(&uLocal_1);
	DESTROY_OBJECT(GRINGO_GET_MY_OBJECT_REF());
	return;
}

void Function_19(int iParam0) //Position: 0x1DE1 / 7649
{
	int iVar0;
...
void Function_20(var uParam0, int iParam1) //Position: 0x1E07 / 7687
{
...
void Function_21(var uParam0, int iParam1) //Position: 0x1F35 / 7989
{
	int iVar0;
...
bool Function_22(var uParam0, int iParam1) //Position: 0x1F4F / 8015
{
	int iVar0;
...
int Function_23(bool bParam0, bool bParam1, bool bParam2) //Position: 0x1F6C / 8044
{
	...
	if (bParam1)
	{
		...
		{
			ADD_ITEM(Function_25(bParam0), Function_24(), bParam2);
			return 1;
		}
	}
	ADD_ITEM(Function_25(bParam0), Function_24(), bParam2);
...
var Function_24() //Position: 0x1FB7 / 8119
{
...
var Function_25(bool bParam0) //Position: 0x1FCC / 8140
{
	bool bVar0;
...
int Function_26(bool bParam0, bool bParam1) //Position: 0x20BD / 8381
{
	bool bVar0;
...
int Function_27(int iParam0, bool bParam1, int iParam2, int iParam3) //Position: 0x2188 / 8584
{
	int iVar0;
	int iVar1;
...
void Function_28(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, char* cParam5, bool bParam6, bool bParam7) //Position: 0x23A8 / 9128
{
	char* cVar0;
	char* cVar1[32];
	struct<8> Var9;
				...
				switch (iParam0)
				{
					...
					case 0x000001E7:
						...
						if (Global_83864.f_1264 <= 49)
						{
							...
							SET_STAT_MESSAGE(STRING_TO_HASH(bParam7), &Global_35278[iParam020] + 16, Function_29(iVar18), "", 0, iVar17, iVar18, 4, 2, 0, Global_83864.f_1264 + 1, Function_44(), &Var9);
						}
						break;
						break;
						if (iParam0 == 0)
...
var Function_29(int iParam0) //Position: 0x29D5 / 10709
{
	return (2.0f + (0,07f * IntToFloat(iParam0)));
}

struct<32> Function_30(int iParam0, int iParam1, bool bParam2, bool bParam3) //Position: 0x29E6 / 10726
{
	char* cVar0[32];
...
struct<32> Function_31(char* cParam0, char* cParam1) //Position: 0x2ADB / 10971
{
	char* cVar0[32];
...
void Function_32(float fParam0, float fParam1, var uParam2, var uParam3) //Position: 0x2AF4 / 10996
{
	float fVar0;
...
var Function_33(int iParam0, int iParam1) //Position: 0x2B59 / 11097
{
	if (iParam0 >= iParam1)
	{
		return iParam0;
...
var Function_34(int iParam0, bool bParam1) //Position: 0x2B6B / 11115
{
	if (iParam0 <= bParam1)
	{
		return iParam0;
...
void Function_35(int iParam0, float fParam1, float fParam2, var uParam3, var uParam4) //Position: 0x2B7D / 11133
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int Function_36(int iParam0) //Position: 0x2CAD / 11437
{
	return Global_35278[iParam020].f_48;
}

float Function_37(int iParam0) //Position: 0x2CBC / 11452
{
	if (!iParam0 != 4294967295)
	{
...
var Function_38(int iParam0) //Position: 0x2CF5 / 11509
{
	if (iParam0 == 4294967295)
	{
...
void Function_39(int iParam0) //Position: 0x2D32 / 11570
{
	if (Global_35278[iParam020].f_64 == 0.0f)
	{
...
int Function_40(int iParam0, float fParam1, bool bParam2) //Position: 0x2ECC / 11980
{
	int iVar0;
	int iVar1;
...
int Function_41(int iParam0) //Position: 0x30E6 / 12518
{
	if (iParam0 == 4294967295)
	{
...
var Function_42(int iParam0) //Position: 0x3127 / 12583
{
...
bool Function_43(int iParam0) //Position: 0x35D5 / 13781
{
...
var Function_44() //Position: 0x35EB / 13803
{
	int iVar0;
...
vector3 Function_45(bool bParam0) //Position: 0x35F3 / 13811
{
	vector3 vVar0;
...
bool Function_46() //Position: 0x361A / 13850
{
	bool bVar0;
...
void Function_47(var uParam0, bool bParam1) //Position: 0x364B / 13899
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_48(var uParam0, bool bParam1) //Position: 0x36BF / 14015
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void Function_49(var uParam0, int iParam1) //Position: 0x3731 / 14129
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
float Function_50(bool bParam0) //Position: 0x373F / 14143
{
	return Function_11(bParam0, "UseTime", 5.0f);
}

bool Function_51() //Position: 0x3755 / 14165
{
	return (GET_DEBUG_DRAW_STATE() && GRINGO_DEBUG_IS_SELECTED());
}

bool Function_52(bool bParam0) //Position: 0x3762 / 14178
{
	return Function_11(bParam0, "MoveAllowance", 1,5f);
}

bool Function_53(var uParam0, int iParam1) //Position: 0x3782 / 14210
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_54(bool bParam0) //Position: 0x3791 / 14225
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_55() //Position: 0x37B0 / 14256
{
	return;
}

void Function_56(bool bParam0, int iParam1) //Position: 0x37B6 / 14262
{
	bool bVar0;
	...
	{
		bVar0 = GET_BLIP_ON_OBJECT(GRINGO_GET_MY_OBJECT_REF());
...
bool Function_57(int iParam0) //Position: 0x37E5 / 14309
{
	iParam0 = iParam0;
	return 1;
}

bool Function_58(bool bParam0) //Position: 0x37F0 / 14320
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_59(bool bParam0, int iParam1) //Position: 0x380A / 14346
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_60(bool bParam0) //Position: 0x3828 / 14376
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_61(bool bParam0) //Position: 0x3847 / 14407
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	while (iVar0 < (Local_6 - 1))
	{
		if (Local_6[iVar012].f_12 == bParam0)
		{
			return Local_6[iVar012].f_16;
		}
		iVar0++;
	}
	return iVar1;
...
bool Function_62(bool bParam0) //Position: 0x387A / 14458
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_63(bool bParam0) //Position: 0x3899 / 14489
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_64(var uParam0, int iParam1) //Position: 0x38B3 / 14515
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_65(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x38C6 / 14534
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	PRINTNL();
	bVar2 = Function_72(uParam0->f_12, &bVar0);
	uVar3 = Function_71(uParam0->f_12, &bVar1);
	bVar4 = Function_70(uParam0->f_12);
	if (!((bVar0 || bVar1) || IS_GRINGO_COMPONENT_VALID(bVar4)))
	{
		bVar6 = Function_69(uParam0->f_12, &bVar5);
		if (bVar5)
		{
			bVar8 = Function_68(uParam0->f_12, &bVar7);
			if (!bVar7)
			{
	...
	if (bVar1)
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, uVar3, Function_66(uParam0->f_12, &bVar10), false, bVar9);
	}
	else
	{
		ATTACH_PROP_TO_ANIM(uParam0->f_16, bParam1, Function_44(), Function_66(uParam0->f_12, &bVar10), false, bVar9);
	}
...
bool Function_66(bool bParam0, bool bParam1) //Position: 0x3BAE / 15278
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_67() //Position: 0x3BCB / 15307
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_68(bool bParam0, int iParam1) //Position: 0x3BDA / 15322
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_69(bool bParam0, int iParam1) //Position: 0x3BFC / 15356
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_70(bool bParam0) //Position: 0x3C20 / 15392
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_71(bool bParam0, int iParam1) //Position: 0x3C3D / 15421
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_72(bool bParam0, int iParam1) //Position: 0x3C5D / 15453
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_73(bool bParam0, bool bParam1) //Position: 0x3C7D / 15485
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_74(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3D2B / 15659
{
	bool bVar0;
...
void Function_75(int iParam0, float fParam1) //Position: 0x3D9B / 15771
{
	if (!Function_14(iParam0))
	{
		Function_76(iParam0, fParam1);
	}
	return;
}

void Function_76(int iParam0, float fParam1) //Position: 0x3DB1 / 15793
{
	iParam0->f_4 = (GET_CURRENT_GAME_TIME() - fParam1);
	Function_81(iParam0, 1);
	Function_64(iParam0, 2);
	iParam0->f_8 = 0.0f;
	return;
}

var Function_77(bool bParam0) //Position: 0x3DD2 / 15826
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_78(int iParam0) //Position: 0x3DF2 / 15858
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_79(var uParam0) //Position: 0x3E06 / 15878
{
	uParam0 = uParam0;
	return;
}

int Function_80() //Position: 0x3E10 / 15888
{
	return 1;
}

void Function_81(var uParam0, int iParam1) //Position: 0x3E17 / 15895
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_82(bool bParam0, var uParam1, int iParam2) //Position: 0x3E26 / 15910
{
	bool bVar0;
	
	Function_85(bParam0);
	*uParam1 = { StackVal, StackVal, Function_85(bParam0) };
	*iParam2 = Function_84(bParam0);
...
bool Function_83(bool bParam0) //Position: 0x3E65 / 15973
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_84(bool bParam0) //Position: 0x3E90 / 16016
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_85(bool bParam0) //Position: 0x3E9B / 16027
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_86(bool bParam0) //Position: 0x3F91 / 16273
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_87(bool bParam0) //Position: 0x3FB3 / 16307
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_88(int iParam0) //Position: 0x3FDA / 16346
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	iParam0 = iParam0;
	bVar0 = CREATE_CUTSCENEOBJECT_IN_LAYOUT(GRINGO_GET_MY_OBJECT_REF(), "GraveGringoCamera", 2, 1);
	if (IS_OBJECT_VALID(bVar0))
	{
		bVar1 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(bVar0, 0);
		bVar2 = GET_CAMERASHOT_FROM_CUTSCENEOBJECT(bVar0, 1);
		GRINGO_GET_USE_COMPONENT_OFFSET_POSITION_EXT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1", -1,5f, 1,7f, -1,78f, &vVar3);
		GRINGO_GET_USE_COMPONENT_OFFSET_POSITION_EXT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1", 0.0f, 1,45f, -0,65f, &vVar6);
		GRINGO_GET_USE_COMPONENT_OFFSET_POSITION_EXT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1", 0,52f, 0,65f, -0,72f, &vVar9);
		GRINGO_GET_USE_COMPONENT_OFFSET_POSITION_EXT(GET_GRINGO_FROM_OBJECT(GRINGO_GET_MY_OBJECT_REF()), "UseCase1", 2.0f, 0,57f, -0,65f, &vVar12);
		INIT_CAMERASHOT_FROM_GAME_CAMERA(bVar1);
		SET_CAMERASHOT_POSITION(bVar1, vVar3);
		SET_CAMERASHOT_TARGET_POSITION(bVar1, vVar6, 0);
		SET_CAMERASHOT_COLLISION_ENABLED(bVar1, 0);
		SET_CAMERASHOT_TARGETDOF_FIXED_DISTANCE(bVar1, 2,5f);
		INIT_CAMERASHOT_FROM_GAME_CAMERA(bVar2);
		SET_CAMERASHOT_POSITION(bVar2, vVar9);
		SET_CAMERASHOT_TARGET_POSITION(bVar2, vVar12, 0);
		SET_CAMERASHOT_COLLISION_ENABLED(bVar2, 0);
		SET_CAMERASHOT_TARGETDOF_FIXED_DISTANCE(bVar2, 1,5f);
		CUTSCENEOBJECT_ADD_TRANSITION_HOLD(bVar0, 0, 3.0f, 4294967295);
		CUTSCENEOBJECT_ADD_TRANSITION_LERP(bVar0, 0, 1, 3,5f, 4294967295, 0);
		CUTSCENEOBJECT_ADD_TRANSITION_HOLD(bVar0, 1, 60.0f, 4294967295);
		SET_CAMERASHOT_FROM_LENS(bVar1, 7);
		FORCE_CAMERASHOT_UPDATE(bVar1);
		PLAY_CUTSCENEOBJECT(bVar0, false, 0.0f, 0.0f, 0, 0, 0, 0, 0, 0);
	}
	return;
}

void Function_89(int iParam0) //Position: 0x4139 / 16697
{
	iParam0 = iParam0;
	return;
}

bool Function_90(bool bParam0) //Position: 0x4143 / 16707
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_91(int iParam0) //Position: 0x4161 / 16737
{
	if (!Function_14(iParam0))
	{
		Function_76(iParam0, 0.0f);
	}
	return;
}

bool Function_92(bool bParam0, bool bParam1) //Position: 0x4176 / 16758
{
	vector3 vVar0;
	float fVar3;
	vector3 vVar4;
	...
	Function_85(bParam1);
	vVar0 = { StackVal, StackVal, Function_85(bParam1) };
	fVar3 = Function_84(bParam1);
	SET_OBJECT_POSITION(bParam0, vVar0);
	vVar4 = { 0.0f, fVar3, 0.0f };
	SET_OBJECT_ORIENTATION(bParam0, vVar4);
	return 1;
}

bool Function_93(bool bParam0, int iParam1) //Position: 0x41A9 / 16809
{
...
int Function_94(bool bParam0) //Position: 0x41D4 / 16852
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x42D9 / 17113
{
	return (uParam0 && iParam1) == 0;
}

void Function_96(int iParam0) //Position: 0x42E6 / 17126
{
	if (Function_95(iParam0->f_40, 16))
	{
...
void Function_97(int iParam0, bool bParam1) //Position: 0x4359 / 17241
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if ((HAS_INVENTORY_COMPONENT(iParam0->f_16) && Function_95(iParam0->f_40, 32)) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
	{
	...
	Function_103(iParam0->f_16, iParam0->f_12);
	if (IS_ACTOR_VALID(iParam0->f_16))
	{
		GRINGO_REPORT_USE_FINISHED(iParam0->f_16, Function_95(iParam0->f_40, 64));
		Function_17(iParam0->f_16, 0);
		NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
		if (!Function_7(iParam0->f_12, "DoNotCleanUpUserSettings", 0))
		{
			if (Function_95(iParam0->f_40, 128) && Function_7(iParam0->f_12, "RedrawWeapon", 1))
			{
			...
			{
				Function_96(iParam0);
				Function_64(iParam0 + 40, 16);
			}
			if (Function_95(iParam0->f_40, 8))
			{
				SET_ACTOR_ONE_SHOT_DEATH(iParam0->f_16, false);
			}
			if (Function_102(iParam0->f_12) && Function_95(iParam0->f_40, 512))
			{
				Function_64(iParam0 + 40, 512);
	...
	if (iParam0->f_12 == iLocal_84)
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_83));
		iLocal_84 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_63(iParam0->f_12))
	...
	if (IS_ACTOR_VALID(iParam0->f_16) && bParam1)
	{
		...
		GRINGO_SET_REUSE_DELAY(Function_99(iParam0->f_12), iParam0->f_12);
	}
	Function_64(iParam0 + 40, 2);
	if (GRINGO_HANDLES_MOVEMENT(iParam0->f_12))
	{
...
void Function_98() //Position: 0x4857 / 18519
{
	return;
}

bool Function_99(bool bParam0) //Position: 0x485D / 18525
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_100(var uParam0, int iParam1) //Position: 0x487A / 18554
{
	var uVar0;
	var uVar1;
	bool bVar2;
	
	Function_72(uParam0->f_12, &uVar0);
	Function_71(uParam0->f_12, &uVar1);
	bVar2 = Function_70(uParam0->f_12);
...
void Function_101(int iParam0) //Position: 0x48B2 / 18610
{
	iParam0 = iParam0;
	return;
}

bool Function_102(bool bParam0) //Position: 0x48BC / 18620
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_103(var uParam0, int iParam1) //Position: 0x48DD / 18653
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
void Function_104(bool bParam0, bool bParam1) //Position: 0x48EB / 18667
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
		{
			Function_130("CheckRemoveQuitAction: Actor valid!");
		}
		if (IS_ACTOR_LOCAL_PLAYER(bParam0))
		{
			if (bParam1)
			{
				Function_130("CheckRemoveQuitAction: Tested for player!");
			}
			if (IS_SCRIPT_USE_CONTEXT_VALID(bLocal_86))
			{
				if (bParam1)
				{
					Function_130("CheckRemoveQuitAction: Release quit context - component no longer in use");
				}
				RELEASE_SCRIPT_USE_CONTEXT(bLocal_86);
			}
		}
	...
	if (bParam1)
	{
		Function_130("CheckRemoveQuitAction: Finished check");
	}
	return;
}

void Function_105(bool bParam0, bool bParam1) //Position: 0x49F3 / 18931
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_106(int iParam0) //Position: 0x4A09 / 18953
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	NET_ACTOR_SET_GRINGO_NAVIGATION_COMPLETE(iParam0->f_16, 0);
	Function_107(iParam0->f_16, bVar0);
	Function_2("START: ", iParam0->f_16);
	return;
}

void Function_107(var uParam0, int iParam1) //Position: 0x4CBF / 19647
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	Function_114(&uLocal_1, "$/content/scripting/gringo/simplegringo/loot_corpse", 1, 0);
	Function_108(&uLocal_1);
	return;
}

int Function_108(int iParam0) //Position: 0x4D11 / 19729
{
	int iVar0;
	int iVar1;
		...
		if (Function_22(iParam0[iVar03], 4))
		{
			if (!Function_22(iParam0[iVar03], 1))
			{
				switch (StackVal)
				{
					...
					case 0x00000002:
					case 0x00000003:
						STREAMING_REQUEST_ACTOR((*iParam0)[iVar03], true, (Function_22(iParam0[03], 8) || iVar1));
						break;
...
void Function_109() //Position: 0x508C / 20620
{
	if (!Function_110(128))
	{
		return;
...
bool Function_110(int iParam0) //Position: 0x50CC / 20684
{
	int iVar0;
...
bool Function_111() //Position: 0x50E8 / 20712
{
	int iVar0;
...
void Function_112(var uParam0, int iParam1) //Position: 0x5113 / 20755
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_113() //Position: 0x5124 / 20772
{
	if (!Function_110(128))
	{
		return;
...
var Function_114(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x5166 / 20838
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = Function_115(uParam0, bVar1, iParam2);
	if (bParam3)
	{
...
var Function_115(var uParam0, int iParam1, int iParam2) //Position: 0x519E / 20894
{
	int iVar0;
...
bool Function_116(bool bParam0) //Position: 0x5262 / 21090
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_117(bool bParam0) //Position: 0x527B / 21115
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_118(bool bParam0, int iParam1) //Position: 0x5295 / 21141
{
	bool bVar0;
	int iVar1;
	
	bParam0 = bParam0;
	iVar1 = Function_119(iParam1, &bVar0);
	if (!bVar0)
	{
		if (IS_ACTOR_VALID(GRINGO_GET_REQUESTING_ACTOR()))
		{
...
bool Function_119(var uParam0, int iParam1) //Position: 0x52CD / 21197
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_120(int iParam0, int iParam1) //Position: 0x52E4 / 21220
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (IS_GRINGO_COMPONENT_VALID(bVar0))
	{
		...
		if (!Function_124(bVar1, iParam0->f_12))
		{
		...
		if (!Function_95(iParam0->f_40, 2))
		{
			...
			{
				Function_64(iParam0 + 40, 1);
			}
			if (Function_95(iParam0->f_40, 1))
			{
				Function_105("MIDACTION REQUEST", bVar1);
			}
			else
			{
				Function_85(iParam0->f_12);
				vVar9 = { StackVal, StackVal, Function_85(iParam0->f_12) };
				vVar12 = { StackVal, StackVal, Vector(StackVal, StackVal, StackVal) - Vector(vVar2, vVar9, StackVal) };
				fVar15 = Function_123(iParam0->f_12);
				bVar16 = VMAG(vVar12);
				...
				bVar33 = Function_121(iParam0->f_12);
				if (!bVar33 != 0.0f)
				{
					if (bVar33 < 0.0f)
					{
						fVar34 = (UNK_0x9C40E671(&vVar12) - Function_84(iParam0->f_12));
					}
					else
					{
						fVar34 = ((180.0f + UNK_0x9C40E671(&vVar12)) - Function_84(iParam0->f_12));
					}
					if (fVar34 < 180.0f)
					{
...
bool Function_121(bool bParam0) //Position: 0x55AD / 21933
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_122(bool bParam0, bool bParam1) //Position: 0x55CA / 21962
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
	...
	Function_85(bParam1);
	Var0 = { StackVal, StackVal, Function_85(bParam1) };
...
bool Function_123(int iParam0) //Position: 0x5666 / 22118
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_124(bool bParam0, int iParam1) //Position: 0x5685 / 22149
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (!IS_ACTOR_PLAYER(bParam0))
	...
	return 0;
	if (DECOR_CHECK_EXIST(bParam0, "Grave01_DisableDigging"))
	{
		return 0;
	}
	return 1;
...
bool Function_125(int iParam0) //Position: 0x56C4 / 22212
{
...
void Function_126(int iParam0) //Position: 0x56E0 / 22240
{
	iParam0 = iParam0;
	return;
}

void Function_127(bool bParam0, int iParam1) //Position: 0x56EA / 22250
{
	bool bVar0;
	bool bVar1;
	...
	{
		Function_128(&(Local_6[iLocal_7912]), bParam0);
		iLocal_79++;
	}
...
void Function_128(int iParam0, int iParam1) //Position: 0x574C / 22348
{
...
void Function_129(int iParam0) //Position: 0x5760 / 22368
{
	iParam0 = iParam0;
	return;
}

void Function_130(int iParam0) //Position: 0x576A / 22378
{
