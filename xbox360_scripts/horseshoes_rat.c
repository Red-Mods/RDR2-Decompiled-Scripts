...
bool Function_16() //Position: 0x417 / 1047
{
	...
	switch (iLocal_0)
	{
		...
		case 0x00000001:
			if (Function_23(Global_30658[1], &Local_24 + 4, &Local_24 + 68, &Local_24 + 72, &Local_24 + 60, &Local_24 + 64))
			{
				Function_22(&Local_24 + 4);
				Function_21(Global_30658[1], 0);
				*(&Local_24 + 16[03]) = { StackVal, StackVal, Function_21(Global_30658[1], 0) };
				Function_21(Global_30658[1], 1);
				*(&Local_24 + 16[13]) = { StackVal, StackVal, Function_21(Global_30658[1], 1) };
				Local_24 = Local_6;
				Local_24.f_52 = 1;
				Local_24.f_56 = 10;
...
void Function_17() //Position: 0x5E6 / 1510
{
	Function_1();
	return;
}

bool Function_18(int iParam0) //Position: 0x5EF / 1519
{
	if (!Function_8(iParam0))
	{
		return 0;
...
bool Function_19(int iParam0, bool bParam1) //Position: 0x610 / 1552
{
	if (!Function_8(iParam0))
	{
		return 0;
...
void Function_20(int iParam0, int iParam1) //Position: 0x646 / 1606
{
	if (!Function_8(iParam0))
	{
		return;
...
vector3 Function_21(int iParam0, int iParam1) //Position: 0x661 / 1633
{
...
void Function_22(bool bParam0) //Position: 0x78D / 1933
{
	int iVar0;
	bool bVar1;
...
bool Function_23(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) //Position: 0x7E2 / 2018
{
	vector3 vVar0;
	int iVar3;
...
bool Function_24(bool bParam0, bool bParam1, bool bParam2) //Position: 0x92F / 2351
{
...
bool Function_25() //Position: 0x9E5 / 2533
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_26(bool bParam0) //Position: 0x9FC / 2556
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_27(bool bParam0) //Position: 0xA07 / 2567
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

float Function_28(vector3 vParam0, vector3 vParam3) //Position: 0xA15 / 2581
{
	vParam0.f_4 = 0.0f;
	vParam3.f_4 = 0.0f;
...
vector3 Function_29(int iParam0, bool bParam1) //Position: 0xA32 / 2610
{
	if (iParam0 == Global_30668[0])
	{
		if (bParam1 == 0)
...
void Function_30(char* cParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5) //Position: 0xB49 / 2889
{
	int iVar0;
...
int Function_31() //Position: 0xB90 / 2960
{
	return Function_32(0);
}

int Function_32(int iParam0) //Position: 0xB9A / 2970
{
...
var Function_33(int iParam0) //Position: 0xBDB / 3035
{
	if (!Function_8(iParam0))
	{
		return 4294967295;
...
bool Function_34(int iParam0) //Position: 0xBF5 / 3061
{
...
int Function_35(var uParam0, int iParam1) //Position: 0xC11 / 3089
{
	int iVar0;
...
bool Function_36(int iParam0) //Position: 0xC2D / 3117
{
...
void Function_37() //Position: 0xC43 / 3139
{
	Function_1();
	return;
}

void Function_38() //Position: 0xC4C / 3148
{
...
void Function_39(int iParam0) //Position: 0xC98 / 3224
{
...
void Function_40(var uParam0, float fParam1) //Position: 0xCAD / 3245
{
...
void Function_41(var uParam0, int iParam1) //Position: 0xCCE / 3278
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_42(var uParam0, int iParam1) //Position: 0xCE1 / 3297
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_43(int iParam0) //Position: 0xCF0 / 3312
{
	return Function_44(*iParam0, 1);
}

int Function_44(var uParam0, bool bParam1) //Position: 0xCFD / 3325
{
	return (uParam0 && bParam1) == 0;
}

void Function_45() //Position: 0xD0A / 3338
{
	return;
}

void Function_46(bool bParam0, bool bParam1) //Position: 0xD10 / 3344
{
	bool bVar0;
...
void Function_47(var uParam0) //Position: 0xD67 / 3431
{
	int iVar0;
...
var Function_48() //Position: 0xD84 / 3460
{
	var uVar0;
