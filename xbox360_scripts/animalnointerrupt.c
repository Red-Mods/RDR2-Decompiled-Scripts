...
void Function_87(bool bParam0, int iParam1) //Position: 0x3645 / 13893
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_88(char* cParam0) //Position: 0x366E / 13934
{
	return Function_7(cParam0, "DrawWeapon", 0);
}

bool Function_89(char* cParam0) //Position: 0x3687 / 13959
{
	return Function_7(cParam0, "AllowWeapon", 0);
}

void Function_90(int iParam0, int iParam1) //Position: 0x36A1 / 13985
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x36D9 / 14041
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x36F0 / 14064
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x39B9 / 14777
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x39D6 / 14806
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3A72 / 14962
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3A91 / 14993
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_97(int iParam0) //Position: 0x3AA0 / 15008
{
...
void Function_98(int iParam0) //Position: 0x3ABC / 15036
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AC6 / 15046
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B28 / 15144
{
...
void Function_101(int iParam0) //Position: 0x3B3C / 15164
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B46 / 15174
{
