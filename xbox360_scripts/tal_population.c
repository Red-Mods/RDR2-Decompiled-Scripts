...
void main() //Position: 0x0 / 0
{
	...
	Function_12(&(Global_30750[5]), 1078, 4.0f, 0, 0);
	bVar0 = Function_14("nnight_pop", 0);
	Function_9(&bVar0, 1084, 4.0f, 33, 0, 0);
	Function_9(&bVar0, 1082, 4.0f, 33, 0, 0);
	...
	Function_12(&(Global_30750[8]), 1125, 4.0f, 0, 0);
	bVar1 = Function_14("wolfs", 0);
	Function_12(&bVar1, 1069, 8.0f, 0, 0);
	Function_12(&bVar1, 1070, 8.0f, 0, 0);
	Function_12(&bVar1, 1071, 8.0f, 0, 0);
	bVar2 = Function_14("cougars", 0);
	Function_12(&bVar2, 1114, 8.0f, 0, 0);
	Function_12(&bVar2, 1114, 8.0f, 0, 0);
	Function_12(&bVar2, 1115, 8.0f, 0, 0);
	...
	Function_12(&uVar3, 1052, 4.0f, 0, 0);
	bVar4 = Function_14("deer", 0);
	Function_12(&bVar4, 1119, 4.0f, 0, 0);
	Function_12(&bVar4, 1119, 4.0f, 0, 0);
	Function_12(&bVar4, 1120, 4.0f, 0, 0);
	Function_12(&bVar4, 1116, 1.0f, 0, 0);
	Function_12(&bVar4, 1117, 1.0f, 0, 0);
	Function_12(&bVar4, 1116, 1.0f, 0, 0);
	bVar5 = Function_14("elk_pop", 0);
	Function_12(&bVar5, 1110, 4.0f, 0, 0);
	Function_12(&bVar5, 1111, 4.0f, 0, 0);
	Function_12(&bVar5, 1111, 4.0f, 0, 0);
	...
	bVar8 = Function_14("rabbit_pop", 0);
	Function_12(&bVar8, 1078, 4.0f, 0, 0);
	Function_12(&bVar8, 1078, 4.0f, 0, 0);
	Function_12(&bVar8, 1078, 4.0f, 0, 0);
	bVar9 = Function_14("bear", 0);
	Function_12(&bVar9, 1099, 4.0f, 0, 0);
	Function_12(&bVar9, 1100, 4.0f, 0, 0);
	Function_12(&bVar9, 1101, 4.0f, 0, 0);
	bVar10 = Function_14("bigHorn", 0);
	Function_12(&bVar10, 1122, 4.0f, 0, 0);
	Function_12(&bVar10, 1123, 4.0f, 0, 0);
	Function_12(&bVar10, 1123, 4.0f, 0, 0);
	bVar11 = Function_14("wildBoar_pop", 0);
	Function_12(&bVar11, 1074, 4.0f, 0, 0);
	Function_12(&bVar11, 1075, 4.0f, 0, 0);
	Function_12(&bVar11, 1076, 4.0f, 0, 0);
	Function_12(&bVar11, 1076, 4.0f, 0, 0);
	bVar12 = Function_14("nwildhorse", 0);
	Function_12(&bVar12, 977, 4.0f, 0, 0);
	Function_12(&bVar12, 980, 4.0f, 0, 0);
	Function_12(&bVar12, 979, 10.0f, 0, 0);
	Function_12(&bVar12, 984, 4.0f, 0, 0);
	Function_12(&bVar12, 985, 4.0f, 0, 0);
	Function_12(&bVar12, 988, 4.0f, 0, 0);
	Function_12(&bVar12, 990, 4.0f, 0, 0);
	Function_12(&bVar12, 979, 4.0f, 0, 0);
	bVar13 = Function_14("animal_duck", 0);
	Function_9(&bVar13, 1140, 100.0f, 31, 0, 0);
	Function_9(&bVar13, 1140, 100.0f, 31, 0, 0);
	Function_9(&bVar13, 1140, 100.0f, 31, 0, 0);
	bVar14 = Function_14("animal_beaver", 0);
	Function_12(&bVar14, 1106, 100.0f, 0, 0);
	...
	Function_9(&bVar15, 1148, 2.0f, 15, 0, 0);
	Function_9(&bVar15, 1137, 1.0f, 33, 0, 0);
	...
	if (IS_LAYOUTREF_VALID(bVar18))
	{
		...
		{
			uVar20 = Function_4(bVar19, bVar9, 1,5E-05f, 0, 0, 1);
			...
			if (!Function_3())
			{
				uVar21 = Function_4(bVar19, bVar12, 1E-05f, 0, 1, 1);
			...
			uVar22 = Function_4(bVar19, bVar11, 1,5E-05f, 0, 0, 1);
			...
			uVar23 = Function_4(bVar19, bVar6, 6E-05f, 0, 0, 1);
			...
			uVar24 = Function_4(bVar19, bVar10, 2,1E-05f, 0, 0, 1);
			...
			uVar25 = Function_4(bVar19, bVar4, 2,1E-05f, 0, 0, 1);
			...
			uVar26 = Function_4(bVar19, bVar8, 6E-05f, 0, 0, 1);
			...
			uVar27 = Function_4(bVar19, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar28 = Function_4(bVar19, bVar2, 2,3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar28, 1);
			uVar29 = Function_4(bVar19, bVar0, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar19))
		{
			uVar30 = Function_4(bVar19, bVar10, 1,5E-05f, 0, 0, 1);
			...
			if (!Function_3())
			{
				uVar31 = Function_4(bVar19, bVar12, 1E-05f, 0, 1, 1);
			...
			uVar32 = Function_4(bVar19, bVar6, 3E-05f, 0, 0, 1);
			...
			uVar33 = Function_4(bVar19, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar34 = Function_4(bVar19, bVar8, 3E-05f, 0, 0, 1);
			...
			uVar35 = Function_4(bVar19, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar36 = Function_4(bVar19, bVar4, 2,1E-05f, 0, 0, 1);
			...
			Function_4(bVar19, bVar14, 5E-05f, 0, 0, 1);
			uVar37 = Function_4(bVar19, bVar9, 2,1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar37, 1);
			uVar38 = Function_4(bVar19, bVar2, 2,3E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar38, 1);
			uVar39 = Function_4(bVar19, bVar0, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar19))
		{
			if (!Function_3())
			{
				uVar40 = Function_4(bVar19, bVar12, 1E-05f, 0, 1, 1);
			...
			uVar41 = Function_4(bVar19, bVar6, 3E-05f, 0, 0, 1);
			...
			Function_4(bVar19, bVar14, 5E-05f, 0, 0, 1);
			uVar42 = Function_4(bVar19, bVar11, 2,1E-05f, 0, 0, 1);
			...
			uVar43 = Function_4(bVar19, bVar1, 2,1E-05f, 0, 0, 1);
			...
			uVar44 = Function_4(bVar19, bVar4, 2,1E-05f, 0, 0, 1);
			...
			uVar45 = Function_4(bVar19, bVar5, 2,1E-05f, 0, 0, 1);
			...
			uVar46 = Function_4(bVar19, bVar8, 2,7E-05f, 0, 0, 1);
			...
			uVar47 = Function_4(bVar19, bVar10, 2,1E-05f, 0, 0, 1);
			...
			uVar48 = Function_4(bVar19, bVar2, 2,1E-05f, 0, 0, 1);
			SET_ZONE_POPULATION_MAX_PER_CELL(uVar48, 1);
			uVar49 = Function_4(bVar19, bVar0, 6E-05f, 0, 0, 1);
		...
		if (IS_VOLUME_VALID(bVar19))
		{
			Function_4(bVar19, bVar15, 6E-05f, 0, 0, 1);
			Function_4(bVar19, bVar16, 6E-05f, 0, 0, 1);
			Function_4(bVar19, bVar17, 9E-05f, 0, 0, 1);
		}
		else
		{
		...
		if (IS_VOLUME_VALID(bVar19))
		{
			Function_4(bVar19, bVar14, 6E-05f, 0, 0, 1);
			uVar50 = Function_4(bVar19, bVar13, 0,00012f, 0, 0, 1);
			...
			Function_4(bVar19, bVar0, 4,5E-05f, 0, 0, 1);
		}
		else
		{
...
var Function_4(bool bParam0, bool bParam1, float fParam2, int iParam3, bool bParam4, bool bParam5) //Position: 0x1BA8 / 7080
{
	bool bVar0;
...
var Function_10(int iParam0) //Position: 0x1D10 / 7440
{
	bool bVar0;
...
var Function_11(int iParam0) //Position: 0x1D7C / 7548
{
	bool bVar0;
...
var Function_12(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4) //Position: 0x1DE8 / 7656
{
	int iVar0;
	int iVar1;
...
var Function_13(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4) //Position: 0x1E5D / 7773
{
	int iVar0;
	int iVar1;
...
var Function_14(bool bParam0, int iParam1) //Position: 0x1EA2 / 7842
{
	return CREATE_NAMED_POPULATION_SET(bParam0, iParam1);
}

void Function_15(int iParam0) //Position: 0x1EAF / 7855
{
	DESTROY_POPULATION_SET(*iParam0);
	return;
}

void Function_16(bool bParam0, var uParam1) //Position: 0x1EBB / 7867
{
	if (!Function_5(128))
	{
		return;
