...
bool Function_63(bool bParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) //Position: 0x2687 / 9863
{
	bool bVar0;
...
void Function_64(int iParam0) //Position: 0x2707 / 9991
{
	int iVar0;
...
void Function_65(int iParam0) //Position: 0x2750 / 10064
{
...
void Function_66(int iParam0) //Position: 0x27BA / 10170
{
	SET_CAMERASHOT_PERSPECTIVE(*iParam0, 1);
	SET_CAMERASHOT_FOV(*iParam0, 55,51708f);
	SET_CAMERASHOT_NEAR_CLIP_PLANE(*iParam0, 0,1f);
...
struct<32> Function_67(bool bParam0) //Position: 0x2824 / 10276
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_68(char* cParam0, char* cParam1, char* cParam2) //Position: 0x288E / 10382
{
	char* cVar0[32];
...
void Function_69(int iParam0) //Position: 0x28AD / 10413
{
	iParam0 = iParam0;
	return;
}

bool Function_70(bool bParam0) //Position: 0x28B7 / 10423
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_71(int iParam0) //Position: 0x28D5 / 10453
{
	if (!Function_14(iParam0))
	{
...
bool Function_72(bool bParam0, bool bParam1) //Position: 0x28EA / 10474
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_73(int iParam0) //Position: 0x2971 / 10609
{
	vector3 vVar0;
...
vector3 Function_74(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2994 / 10644
{
	vector3 vVar0;
...
bool Function_75(bool bParam0) //Position: 0x29B2 / 10674
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_76(bool bParam0, bool bParam1) //Position: 0x29D5 / 10709
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_77(bool bParam0, int iParam1) //Position: 0x2AF0 / 10992
{
...
int Function_78(bool bParam0) //Position: 0x2B1B / 11035
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_79(var uParam0, int iParam1) //Position: 0x2C20 / 11296
{
	return (uParam0 && iParam1) == 0;
}

void Function_80(int iParam0) //Position: 0x2C2D / 11309
{
	if (Function_79(iParam0->f_40, 16))
	{
...
void Function_81(int iParam0, bool bParam1) //Position: 0x2CA0 / 11424
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_82() //Position: 0x319E / 12702
{
	iLocal_4 = 0;
...
bool Function_83(bool bParam0) //Position: 0x31B4 / 12724
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_84(var uParam0, int iParam1) //Position: 0x31D1 / 12753
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_85(int iParam0) //Position: 0x3209 / 12809
{
	iParam0 = iParam0;
	return;
}
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x3234 / 12852
{
	bParam1 = bParam1;
	bParam0 = bParam0;
...
void Function_88(bool bParam0, bool bParam1) //Position: 0x327C / 12924
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_89(bool bParam0, bool bParam1) //Position: 0x3384 / 13188
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_90(int iParam0) //Position: 0x339A / 13210
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_91(bool bParam0, int iParam1) //Position: 0x3650 / 13904
{
	iParam1 = iParam1;
	if (IS_ACTOR_LOCAL_PLAYER(bParam0))
	{
...
bool Function_92(bool bParam0) //Position: 0x3665 / 13925
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_93(bool bParam0) //Position: 0x367E / 13950
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_94(int iParam0, int iParam1) //Position: 0x3698 / 13976
{
	bool bVar0;
	int iVar1;
...
bool Function_95(var uParam0, int iParam1) //Position: 0x36D0 / 14032
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_96(int iParam0, int iParam1) //Position: 0x36E7 / 14055
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_97(bool bParam0) //Position: 0x39B0 / 14768
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_98(bool bParam0, bool bParam1) //Position: 0x39CD / 14797
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_99(int iParam0) //Position: 0x3A69 / 14953
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_100(var uParam0, int iParam1) //Position: 0x3A88 / 14984
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_101(int iParam0) //Position: 0x3A97 / 14999
{
...
void Function_103(bool bParam0, int iParam1) //Position: 0x3ABD / 15037
{
	bool bVar0;
	bool bVar1;
...
void Function_104(int iParam0, int iParam1) //Position: 0x3B1F / 15135
{
...
void Function_105(int iParam0) //Position: 0x3B33 / 15155
{
	iParam0 = iParam0;
	return;
}

void Function_106(int iParam0) //Position: 0x3B3D / 15165
{
