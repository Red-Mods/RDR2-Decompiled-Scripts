...
void main() //Position: 0x0 / 0
{
	...
	*(&Var1 + 228) = 2;
	if (bVar0)
	{
		Function_120(&Var1, "", "$/tune/refGroups/campsiteSets/cam_playerCamp01x");
	}
	else
	{
...
bool Function_59(int iParam0) //Position: 0x2A7E / 10878
{
	...
	*(&Local_0 + 4) = { 1,844061f, 0,008248952f, 1,429237f };
	*(&Local_0 + 4 + 12) = { 0.0f, 109,9417f, 0.0f };
	Function_61(iParam0, &Local_0 + 4);
	Local_0.f_28 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_horse_stay", 1,844061f, 0,008248952f, 1,429237f, 0.0f, 109,9417f, 0.0f);
	*(&Local_0 + 32) = { 0,6116906f, 0,002102481f, -1,21826f };
	*(&Local_0 + 32 + 12) = { 0.0f, 187,4159f, 0.0f };
	Function_61(iParam0, &Local_0 + 32);
	Local_0.f_56 = CREATE_POINT_IN_LAYOUT(Local_0, "player_camp_sit", 0,6116906f, 0,002102481f, -1,21826f, 0.0f, 187,4159f, 0.0f);
...
vector3 Function_78() //Position: 0x3450 / 13392
{
	return 0.0f, 0,101f, -0,195f;
}

vector3 Function_79() //Position: 0x3461 / 13409
{
	return 0.0f, 0,127f, -0,177f;
}

vector3 Function_80() //Position: 0x3472 / 13426
{
	return 0.0f, 0,158f, -0,163f;
}

void Function_81(var uParam0, int iParam1) //Position: 0x3483 / 13443
{
...
var Function_82(var uParam0, int iParam1, bool bParam2) //Position: 0x34A6 / 13478
{
	int iVar0;
...
var Function_83(bool bParam0) //Position: 0x34C5 / 13509
{
	return SHIFT_LEFT(true, bParam0);
}

bool Function_84() //Position: 0x34D1 / 13521
{
	return Function_85(39);
}

int Function_85(bool bParam0) //Position: 0x34DC / 13532
{
	bool bVar0;
...
var Function_86() //Position: 0x350A / 13578
{
	return "PackedWeapon";
}

int Function_87(var uParam0, var uParam1, int iParam2, bool bParam3, vector3 vParam4, vector3 vParam7, bool bParam10) //Position: 0x351F / 13599
{
	bool bVar0;
	vector3 vVar1;
	char* cVar4[64];
...
var Function_88() //Position: 0x3623 / 13859
{
	return "MPItemGiver";
}

struct<32> Function_89(bool bParam0) //Position: 0x3637 / 13879
{
	char* cVar0[32];
	char* cVar8[16];
...
struct<32> Function_90(char* cParam0, char* cParam1, char* cParam2) //Position: 0x36A1 / 13985
{
	char* cVar0[32];
...
var Function_91() //Position: 0x36C0 / 14016
{
	return "PBox_";
}

var Function_92() //Position: 0x36CE / 14030
{
	return "p_gen_crateMultiplayerItem01x";
}

var Function_93() //Position: 0x36F4 / 14068
{
	return "p_gen_crateMultiplayerWeapon01x";
}

var Function_94() //Position: 0x371C / 14108
{
	return "p_gen_crateMultiplayerAmmo01x";
}

int Function_95(var uParam0, int iParam1) //Position: 0x3742 / 14146
{
	int iVar0;
	var uVar1;
...
void Function_96(int iParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x38A3 / 14499
{
	struct<8> Var0;
...
int Function_97(bool bParam0) //Position: 0x393E / 14654
{
	int iVar0;
	vector3 vVar1;
...
void Function_98(int iParam0) //Position: 0x3A9F / 15007
{
...
var Function_99() //Position: 0x3B00 / 15104
{
	int iVar0;
...
var Function_100(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x3B08 / 15112
{
	return Function_101(bParam0, iParam1, iParam2, iParam3, iParam4, 0, 0.0f, 0.0f, 0.0f);
}

var Function_101(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, vector3 vParam6) //Position: 0x3B21 / 15137
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
void Function_102(int iParam0) //Position: 0x3E14 / 15892
{
	int iVar0;
...
void Function_103() //Position: 0x3EC8 / 16072
{
	int iVar0;
...
bool Function_104(bool bParam0) //Position: 0x3F02 / 16130
{
	int iVar0;
...
void Function_105(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) //Position: 0x3F2F / 16175
{
	bool bVar0;
