	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000001:
			...
			if (Function_77(iParam0->f_40, 1))
			{
				...
				{
					TELEPORT_ACTOR_WITH_HEADING(iParam0->f_16, vVar3, uVar6, 1, true, Function_56());
				}
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_41(iParam0, bVar8, &iLocal_89, &bLocal_88);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D03 / 7427
{
	int iVar0;
	...
	REMOVE_OBJECT_ATTACHMENT(bLocal_6);
	return 1;
}

void Function_27(bool bParam0, int iParam1) //Position: 0x1D50 / 7504
{
	GET_POSITION(bParam0, iParam1);
	return;
}

bool Function_28(bool bParam0) //Position: 0x1D5D / 7517
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_29() //Position: 0x1D7C / 7548
{
	return;
}

void Function_30(bool bParam0, int iParam1) //Position: 0x1D82 / 7554
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	bLocal_6 = ATTACH_OBJECTS_PHYSICAL(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), "spine00", "Jaw_Attachment", 0.0f);
	if (IS_ATTACHMENT_VALID(bLocal_6))
	{
		ATTACH_SET_ROTATIONAL_CONSTRAINT(bLocal_6, 45.0f, 0.0f, 45.0f, 100.0f, 40.0f);
		SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), false);
	}
	else
	{
...
void Function_31(int iParam0) //Position: 0x1E9C / 7836
{
	Function_32(iParam0, 0.0f);
	return;
}

void Function_32(int iParam0, float fParam1) //Position: 0x1EA8 / 7848
{
...
bool Function_33(int iParam0) //Position: 0x1EC9 / 7881
{
	iParam0 = iParam0;
	return 1;
}

bool Function_34(bool bParam0) //Position: 0x1ED4 / 7892
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_35(bool bParam0, int iParam1) //Position: 0x1EEE / 7918
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_36(bool bParam0) //Position: 0x1F0C / 7948
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_37(bool bParam0) //Position: 0x1F2B / 7979
{
	int iVar0;
	int iVar1;
...
bool Function_38(bool bParam0) //Position: 0x1F5E / 8030
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_39(bool bParam0) //Position: 0x1F7D / 8061
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_40(var uParam0, int iParam1) //Position: 0x1F97 / 8087
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_41(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1FAA / 8106
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	{
		iVar6 = Function_46(uParam0->f_12, &bVar5);
		if (bVar5)
		{
			iVar8 = Function_45(uParam0->f_12, &bVar7);
			if (!bVar7)
			{
...
var Function_42() //Position: 0x2292 / 8850
{
	int iVar0;
...
bool Function_43(bool bParam0, bool bParam1) //Position: 0x229A / 8858
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_44() //Position: 0x22B7 / 8887
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x22C6 / 8902
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x22E8 / 8936
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_47(bool bParam0) //Position: 0x230C / 8972
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_48(bool bParam0, int iParam1) //Position: 0x2329 / 9001
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_49(bool bParam0, int iParam1) //Position: 0x2349 / 9033
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_50(bool bParam0, bool bParam1) //Position: 0x2369 / 9065
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_51(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2417 / 9239
{
	bool bVar0;
...
void Function_52(int iParam0, float fParam1) //Position: 0x2487 / 9351
{
	if (!Function_14(iParam0))
	{
...
var Function_53(bool bParam0) //Position: 0x249D / 9373
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_54(int iParam0) //Position: 0x24BD / 9405
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_55(var uParam0) //Position: 0x24D1 / 9425
{
	uParam0 = uParam0;
	return;
}

int Function_56() //Position: 0x24DB / 9435
{
	return 1;
}

void Function_57(var uParam0, int iParam1) //Position: 0x24E2 / 9442
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_58(bool bParam0, var uParam1, int iParam2) //Position: 0x24F1 / 9457
{
	bool bVar0;
...
bool Function_59(bool bParam0) //Position: 0x2530 / 9520
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_60(bool bParam0) //Position: 0x255B / 9563
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_61(bool bParam0) //Position: 0x2566 / 9574
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_62(bool bParam0) //Position: 0x265C / 9820
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_63(bool bParam0) //Position: 0x267E / 9854
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_64(bool bParam0) //Position: 0x26A5 / 9893
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_65(vector3 vParam0) //Position: 0x2964 / 10596
{
	vector3 vVar0;
...
vector3 Function_66(vector3 vParam0) //Position: 0x29C1 / 10689
{
	vector3 vVar0;
...
void Function_67(int iParam0) //Position: 0x2A1E / 10782
{
	iParam0 = iParam0;
	return;
}

bool Function_68(bool bParam0) //Position: 0x2A28 / 10792
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_69(int iParam0) //Position: 0x2A46 / 10822
{
	if (!Function_14(iParam0))
	{
		Function_32(iParam0, 0.0f);
...
bool Function_70(bool bParam0, bool bParam1) //Position: 0x2A5B / 10843
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_71(int iParam0) //Position: 0x2AE2 / 10978
{
	vector3 vVar0;
...
vector3 Function_72(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2B05 / 11013
{
	vector3 vVar0;
...
bool Function_73(bool bParam0) //Position: 0x2B23 / 11043
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_74(bool bParam0, bool bParam1) //Position: 0x2B46 / 11078
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_75(bool bParam0, int iParam1) //Position: 0x2C61 / 11361
{
...
int Function_76(bool bParam0) //Position: 0x2C8C / 11404
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_77(var uParam0, int iParam1) //Position: 0x2D91 / 11665
{
	return (uParam0 && iParam1) == 0;
}

void Function_78(int iParam0) //Position: 0x2D9E / 11678
{
	if (Function_77(iParam0->f_40, 16))
	{
...
void Function_79(int iParam0, bool bParam1) //Position: 0x2E11 / 11793
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_80() //Position: 0x330F / 13071
{
	bool bVar0;
...
bool Function_81(bool bParam0) //Position: 0x3346 / 13126
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_82(var uParam0, int iParam1) //Position: 0x3363 / 13155
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_83(int iParam0) //Position: 0x339B / 13211
{
	iParam0 = iParam0;
	return;
}

bool Function_84(bool bParam0) //Position: 0x33A5 / 13221
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_85(bool bParam0, int iParam1) //Position: 0x33C6 / 13254
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	RESET_ANIM_SET_FOR_ACTOR(bParam0, 0);
	SET_OBJECT_COLLIDE_WITH_OBJECT(GET_TARGET_OBJECT(), GET_OBJECT_FROM_ACTOR(bParam0), true);
	REQUEST_FIXED_CORPSE(GET_TARGET_OBJECT(), 1);
	return;
}

void Function_86(bool bParam0, bool bParam1) //Position: 0x33EE / 13294
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_87(bool bParam0, bool bParam1) //Position: 0x34F6 / 13558
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_88(int iParam0) //Position: 0x350C / 13580
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_89(var uParam0, int iParam1) //Position: 0x37C2 / 14274
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_90(bool bParam0) //Position: 0x37D0 / 14288
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_91(bool bParam0) //Position: 0x37E9 / 14313
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_92(int iParam0, int iParam1) //Position: 0x3803 / 14339
{
	bool bVar0;
	int iVar1;
...
bool Function_93(var uParam0, int iParam1) //Position: 0x383B / 14395
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_94(int iParam0, int iParam1) //Position: 0x3852 / 14418
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_95(bool bParam0) //Position: 0x3B1B / 15131
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_96(bool bParam0, bool bParam1) //Position: 0x3B38 / 15160
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_97(int iParam0) //Position: 0x3BD4 / 15316
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_98(var uParam0, int iParam1) //Position: 0x3BF3 / 15347
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_99(int iParam0) //Position: 0x3C02 / 15362
{
...
void Function_100(int iParam0) //Position: 0x3C1E / 15390
{
	iParam0 = iParam0;
	return;
}

void Function_101(bool bParam0, int iParam1) //Position: 0x3C28 / 15400
{
	bool bVar0;
	bool bVar1;
...
void Function_102(int iParam0, int iParam1) //Position: 0x3C8A / 15498
{
...
void Function_103(int iParam0) //Position: 0x3C9E / 15518
{
	iParam0 = iParam0;
	return;
}

void Function_104(int iParam0) //Position: 0x3CA8 / 15528
{
