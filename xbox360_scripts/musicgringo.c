	...
	switch (iParam0->f_44)
	{
		...
		case 0x00000004:
			...
			if (iParam0->f_44 == 5)
			{
				...
				{
					Function_38(iParam0, bVar8, &iLocal_33, &bLocal_32);
...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D09 / 7433
{
	bool bVar0;
...
bool Function_27(bool bParam0) //Position: 0x1D8F / 7567
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DAE / 7598
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DB4 / 7604
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DC2 / 7618
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DCD / 7629
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1DE7 / 7655
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E05 / 7685
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E24 / 7716
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E57 / 7767
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E76 / 7798
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1E90 / 7824
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EA3 / 7843
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x218B / 8587
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x2193 / 8595
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21B0 / 8624
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21BF / 8639
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x21E1 / 8673
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x2205 / 8709
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2222 / 8738
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2242 / 8770
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2262 / 8802
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2310 / 8976
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x2380 / 9088
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x2396 / 9110
{
...
var Function_51(bool bParam0) //Position: 0x23B7 / 9143
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23D7 / 9175
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x23EB / 9195
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x23F5 / 9205
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x23FC / 9212
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x240B / 9227
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x244A / 9290
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x2475 / 9333
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x2480 / 9344
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x2576 / 9590
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x2598 / 9624
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25BF / 9663
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x287E / 10366
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28DB / 10459
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2938 / 10552
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2942 / 10562
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2960 / 10592
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x2975 / 10613
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x29FC / 10748
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A1F / 10783
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A3D / 10813
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A60 / 10848
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2B7B / 11131
{
...
int Function_74(bool bParam0) //Position: 0x2BA6 / 11174
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_75(var uParam0, int iParam1) //Position: 0x2CAB / 11435
{
	return (uParam0 && iParam1) == 0;
}

void Function_76(int iParam0) //Position: 0x2CB8 / 11448
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D2B / 11563
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		RELEASE_OBJECT_REF(GET_OBJECT_FROM_ANIMATOR(bLocal_32));
		iLocal_33 = iVar13;
	}
	GRINGO_SET_CHILD_USE_ACTIVATIONS(iParam0->f_12, 0);
	if (Function_36(iParam0->f_12))
...
void Function_78() //Position: 0x3229 / 12841
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3260 / 12896
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x327D / 12925
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32B5 / 12981
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32BF / 12991
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x32E0 / 13024
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (bLocal_0)
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x32FF / 13055
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3407 / 13319
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x341D / 13341
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(bool bParam0, int iParam1) //Position: 0x36D3 / 14035
{
	bool bVar0;
...
bool Function_88(bool bParam0) //Position: 0x370C / 14092
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3725 / 14117
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x373F / 14143
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3777 / 14199
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x378E / 14222
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A57 / 14935
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A74 / 14964
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B10 / 15120
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(var uParam0, int iParam1) //Position: 0x3B2F / 15151
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	if (IS_OBJECT_VALID(GRINGO_GET_MY_OBJECT_REF()))
...
bool Function_97(int iParam0) //Position: 0x3B6F / 15215
{
...
void Function_98(int iParam0) //Position: 0x3B8B / 15243
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3B95 / 15253
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3BF7 / 15351
{
...
void Function_101(int iParam0) //Position: 0x3C0B / 15371
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3C15 / 15381
{
