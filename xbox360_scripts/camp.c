...
void Function_52(var uParam0, var uParam1, int iParam2) //Position: 0x2309 / 8969
{
	uParam0 = Function_56(uParam0);
	uParam1 = uParam1;
	if (!Function_55(Global_63084.f_32, 1))
	{
		Function_39(&Global_63084 + 32, 1);
	}
	if (!Function_54(Global_76846, 4096))
	{
		Function_53(&Global_76846, 4096);
	}
	if (!Function_54(Global_76846, 8192))
	{
		Function_53(&Global_76846, 8192);
	}
	iLocal_3 = 0;
	*iParam2 = 1;
	return;
...
void Function_53(var uParam0, int iParam1) //Position: 0x2367 / 9063
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_54(var uParam0, int iParam1) //Position: 0x2376 / 9078
{
...
bool Function_55(var uParam0, int iParam1) //Position: 0x2389 / 9097
{
	return (uParam0 && iParam1) == 0;
}

var Function_56(bool bParam0) //Position: 0x2396 / 9110
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_57(int iParam0, bool bParam1) //Position: 0x23B0 / 9136
{
	bool bVar0;
	bool bVar1;
