...
bool Function_96(bool bParam0, int iParam1) //Position: 0x3A76 / 14966
{
	iParam1 = iParam1;
	bParam0 = bParam0;
...
bool Function_97(int iParam0) //Position: 0x3A92 / 14994
{
...
void Function_98(int iParam0) //Position: 0x3AAE / 15022
{
	iParam0 = iParam0;
	return;
}

void Function_99(bool bParam0, int iParam1) //Position: 0x3AB8 / 15032
{
	bool bVar0;
	bool bVar1;
...
void Function_100(int iParam0, int iParam1) //Position: 0x3B1A / 15130
{
...
void Function_101(int iParam0) //Position: 0x3B2E / 15150
{
	iParam0 = iParam0;
	return;
}

void Function_102(int iParam0) //Position: 0x3B38 / 15160
{
