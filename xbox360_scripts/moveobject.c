...
bool Function_26(bool bParam0, int iParam1) //Position: 0x1D01 / 7425
{
	...
	if (!DECOR_CHECK_EXIST(bParam0, "MoveObj_AllowRun"))
	{
		SET_ACTOR_MAX_SPEED(bParam0, true);
	}
	return 1;
}

bool Function_27(bool bParam0) //Position: 0x1DB5 / 7605
{
	return IS_GRINGO_COMPONENT_VALID(GRINGO_GET_FIRST_NAMED_CHILD("PlayerUseAnim", 2, bParam0));
}

void Function_28() //Position: 0x1DD4 / 7636
{
	return;
}

void Function_29(var uParam0, int iParam1) //Position: 0x1DDA / 7642
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_30(int iParam0) //Position: 0x1DE8 / 7656
{
	iParam0 = iParam0;
	return 1;
}

bool Function_31(bool bParam0) //Position: 0x1DF3 / 7667
{
	return Function_7(bParam0, "OneShotKill", 0);
}

bool Function_32(bool bParam0, int iParam1) //Position: 0x1E0D / 7693
{
	return Function_9(bParam0, "ParentAnimNode", iParam1);
}

bool Function_33(bool bParam0) //Position: 0x1E2B / 7723
{
	return Function_7(bParam0, "LinkToParentAnim", 0);
}

bool Function_34(bool bParam0) //Position: 0x1E4A / 7754
{
	int iVar0;
	int iVar1;
...
bool Function_35(bool bParam0) //Position: 0x1E7D / 7805
{
	return Function_7(bParam0, "LinkParentToAnim", 0);
}

bool Function_36(bool bParam0) //Position: 0x1E9C / 7836
{
	return Function_7(bParam0, "SingularUse", 0);
}

void Function_37(var uParam0, int iParam1) //Position: 0x1EB6 / 7862
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
	return;
}

void Function_38(var uParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x1EC9 / 7881
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
var Function_39() //Position: 0x21B1 / 8625
{
	int iVar0;
...
bool Function_40(bool bParam0, bool bParam1) //Position: 0x21B9 / 8633
{
	return Function_9(bParam0, "TargetLocator", bParam1);
}

void Function_41() //Position: 0x21D6 / 8662
{
	PRINTSTRING(GET_OBJECT_MODEL_NAME(GRINGO_GET_MY_OBJECT_REF()));
	return;
}

bool Function_42(bool bParam0, int iParam1) //Position: 0x21E5 / 8677
{
	return Function_9(bParam0, "UserPhysAttachBone", iParam1);
}

bool Function_43(bool bParam0, int iParam1) //Position: 0x2207 / 8711
{
	return Function_9(bParam0, "TargetPhysAttachBone", iParam1);
}

var Function_44(bool bParam0) //Position: 0x222B / 8747
{
	return GRINGO_GET_FIRST_NAMED_CHILD("TargetSkelAnim", 2, bParam0);
}

bool Function_45(bool bParam0, int iParam1) //Position: 0x2248 / 8776
{
	return Function_9(bParam0, "TargetAttachBone", iParam1);
}

bool Function_46(bool bParam0, int iParam1) //Position: 0x2268 / 8808
{
	return Function_9(bParam0, "TargetAttachSlot", iParam1);
}

void Function_47(bool bParam0, bool bParam1) //Position: 0x2288 / 8840
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_48(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2336 / 9014
{
	bool bVar0;
...
void Function_49(int iParam0, float fParam1) //Position: 0x23A6 / 9126
{
	if (!Function_14(iParam0))
	{
...
void Function_50(int iParam0, float fParam1) //Position: 0x23BC / 9148
{
...
var Function_51(bool bParam0) //Position: 0x23DD / 9181
{
	return (RAND_FLOAT_RANGE(0.0f, 1.0f) * Function_11(bParam0, "RandUseTime", 0.0f));
}

void Function_52(int iParam0) //Position: 0x23FD / 9213
{
	iParam0->f_4 = 0.0f;
	iParam0->f_8 = 0.0f;
	*iParam0 = 0;
...
void Function_53(var uParam0) //Position: 0x2411 / 9233
{
	uParam0 = uParam0;
	return;
}

int Function_54() //Position: 0x241B / 9243
{
	return 1;
}

void Function_55(var uParam0, int iParam1) //Position: 0x2422 / 9250
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_56(bool bParam0, var uParam1, int iParam2) //Position: 0x2431 / 9265
{
	bool bVar0;
...
bool Function_57(bool bParam0) //Position: 0x2470 / 9328
{
	return Function_11(bParam0, "UseDirectionToleranceDegrees", 0.0f);
}

float Function_58(bool bParam0) //Position: 0x249B / 9371
{
	return GRINGO_GET_USE_COMPONENT_HEADING(bParam0);
}

vector3 Function_59(bool bParam0) //Position: 0x24A6 / 9382
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
bool Function_60(bool bParam0) //Position: 0x259C / 9628
{
	return Function_7(bParam0, "UsePosActorRelative", 0);
}

bool Function_61(bool bParam0) //Position: 0x25BE / 9662
{
	return Function_11(bParam0, "StartingPhaseTimeout", 10.0f);
}

void Function_62(bool bParam0) //Position: 0x25E5 / 9701
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x28A4 / 10404
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x2901 / 10497
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x295E / 10590
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2968 / 10600
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2986 / 10630
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(bool bParam0, bool bParam1) //Position: 0x299B / 10651
{
	vector3 vVar0;
	bool bVar3;
	var uVar4;
...
vector3 Function_69(int iParam0) //Position: 0x2A22 / 10786
{
	vector3 vVar0;
...
vector3 Function_70(bool bParam0, char* cParam1, vector3 vParam2) //Position: 0x2A45 / 10821
{
	vector3 vVar0;
...
bool Function_71(bool bParam0) //Position: 0x2A63 / 10851
{
	return Function_11(bParam0, "UseLocationTolerance", 0.0f);
}

int Function_72(bool bParam0, bool bParam1) //Position: 0x2A86 / 10886
{
	bool bVar0;
	float fVar1;
	vector3 vVar2;
...
bool Function_73(bool bParam0, int iParam1) //Position: 0x2BA1 / 11169
{
...
int Function_74(bool bParam0) //Position: 0x2BCC / 11212
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_76(int iParam0) //Position: 0x2CDE / 11486
{
	if (Function_75(iParam0->f_40, 16))
	{
...
void Function_77(int iParam0, bool bParam1) //Position: 0x2D51 / 11601
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_78() //Position: 0x324F / 12879
{
	bool bVar0;
...
bool Function_79(bool bParam0) //Position: 0x3286 / 12934
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_80(var uParam0, int iParam1) //Position: 0x32A3 / 12963
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_81(int iParam0) //Position: 0x32DB / 13019
{
	iParam0 = iParam0;
	return;
}

bool Function_82(bool bParam0) //Position: 0x32E5 / 13029
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_83(bool bParam0, int iParam1) //Position: 0x3306 / 13062
{
	iParam1 = iParam1;
	bParam0 = bParam0;
	if (IS_ACTOR_VALID(bParam0))
...
void Function_84(bool bParam0, bool bParam1) //Position: 0x3329 / 13097
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_85(bool bParam0, bool bParam1) //Position: 0x3431 / 13361
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_86(int iParam0) //Position: 0x3447 / 13383
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_87(var uParam0, int iParam1) //Position: 0x36FD / 14077
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_88(bool bParam0) //Position: 0x370B / 14091
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_89(bool bParam0) //Position: 0x3724 / 14116
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_90(bool bParam0, int iParam1) //Position: 0x373E / 14142
{
	bool bVar0;
	int iVar1;
...
bool Function_91(var uParam0, int iParam1) //Position: 0x3776 / 14198
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_92(int iParam0, int iParam1) //Position: 0x378D / 14221
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_93(bool bParam0) //Position: 0x3A56 / 14934
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_94(bool bParam0, bool bParam1) //Position: 0x3A73 / 14963
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_95(int iParam0) //Position: 0x3B0F / 15119
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_96(bool bParam0, int iParam1) //Position: 0x3B2E / 15150
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_97(vector3 vParam0) //Position: 0x3C33 / 15411
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

bool Function_98(int iParam0) //Position: 0x3C4B / 15435
{
...
void Function_99(int iParam0) //Position: 0x3C67 / 15463
{
	iParam0 = iParam0;
	return;
}

void Function_100(bool bParam0, int iParam1) //Position: 0x3C71 / 15473
{
	bool bVar0;
	bool bVar1;
...
void Function_101(int iParam0, int iParam1) //Position: 0x3CD3 / 15571
{
...
void Function_102(int iParam0) //Position: 0x3CE7 / 15591
{
	iParam0 = iParam0;
	return;
}

void Function_103(int iParam0) //Position: 0x3CF1 / 15601
{
