...
void main() //Position: 0x0 / 0
{
		...
		switch (iLocal_237)
		{
			...
			case 0x00000002:
				if (Function_93())
				{
					...
					Local_361[04] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid2"), FIND_OBJECT_IN_LAYOUT(Local_12, "smoking_stand"), 1, 0, 0, 0, 0, 1) };
					Local_361[14] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid2"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand10"), 1, 0, 0, 0, 0, 1) };
					Local_361[24] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid2"), FIND_OBJECT_IN_LAYOUT(Local_12, "smoking_stand1"), 1, 0, 0, 0, 0, 1) };
					Local_361[34] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid2"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand9"), 1, 0, 0, 0, 0, 1) };
					Local_361[44] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid3"), FIND_OBJECT_IN_LAYOUT(Local_12, "smoking_stand2"), 1, 0, 0, 0, 0, 1) };
					Local_361[54] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid3"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand11"), 1, 0, 0, 0, 0, 1) };
					Local_361[64] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid3"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand12"), 1, 0, 0, 0, 0, 1) };
					Local_361[74] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid3"), FIND_OBJECT_IN_LAYOUT(Local_12, "smoking_stand3"), 1, 0, 0, 0, 0, 1) };
					Local_361[84] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid1"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand8"), 1, 0, 0, 0, 0, 1) };
					Local_361[94] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid1"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand13"), 1, 0, 0, 0, 0, 1) };
					Local_361[104] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid1"), FIND_OBJECT_IN_LAYOUT(Local_12, "rand_idle_stand14"), 1, 0, 0, 0, 0, 1) };
					Local_361[114] = { StackVal, StackVal, StackVal, Function_91(FIND_OBJECT_IN_LAYOUT(Local_12, "stand_yelling_mid1"), FIND_OBJECT_IN_LAYOUT(Local_12, "smoking_stand4"), 1, 0, 0, 0, 0, 1) };
					iLocal_237 = 3;
				}
				bLocal_238 = false;
				break;
			...
			case 0x00000003:
				...
				Function_90(&Global_6654, &Global_7716, iScriptParam_0);
				iLocal_237 = 5;
				bLocal_238 = false;
				break;
			
			case 0x00000005:
				if (Function_89(&Global_6654, &Global_7716, iScriptParam_0))
				{
					iLocal_237 = 4;
					bLocal_238 = false;
				}
			...
			case 0x00000004:
				if (Function_88(&(Global_29008[iScriptParam_0]), 16) && Function_87(Global_29155[iScriptParam_010]))
				{
					iLocal_237 = 6;
				}
				bLocal_238 = false;
			...
			case 0x00000006:
				Function_86(0, &uLocal_240, Local_12.f_864);
				Function_85(0, &uLocal_240, -3244,171f, 39,716f, 3764,044f);
				Function_84(0, &uLocal_240, -3244,171f, 39,716f, 3764,044f);
				Function_83(0, &uLocal_240, -3244,171f, 39,716f, 3764,044f);
				Function_82(0, &uLocal_240, Local_12.f_864);
				Function_81(0, &uLocal_240, Local_12.f_876);
				Function_80(0, &uLocal_240, Local_4);
				Function_86(1, &uLocal_240, Local_12.f_880);
				Function_85(1, &uLocal_240, -3132,029f, 43,474f, 3648,082f);
				Function_84(1, &uLocal_240, -3189,534f, 40,83f, 3712.0f);
				Function_83(1, &uLocal_240, -3132,029f, 43,474f, 3648,082f);
				Function_79(1, &uLocal_240, -3189,534f, 40,83f, 3712.0f);
				Function_81(1, &uLocal_240, Local_12.f_880);
				Function_80(1, &uLocal_240, Local_4);
				Function_86(2, &uLocal_240, Local_12.f_884);
				Function_85(2, &uLocal_240, -3214,415f, 40,157f, 3726,164f);
				Function_84(2, &uLocal_240, -3188,018f, 40,971f, 3714,524f);
				Function_83(2, &uLocal_240, -3103,037f, 45,199f, 3753,386f);
				Function_79(2, &uLocal_240, -3188,018f, 40,971f, 3714,524f);
				Function_78(2, &uLocal_240, -3188,018f, 40,971f, 3714,524f);
				Function_80(2, &uLocal_240, Local_4);
				Function_77(3, &uLocal_240, -3191,546f, 40,401f, 3775,018f);
				Function_85(3, &uLocal_240, -3223,475f, 40,152f, 3726,323f);
				Function_84(3, &uLocal_240, -3191,546f, 40,401f, 3775,018f);
				Function_83(3, &uLocal_240, -3223,475f, 40,152f, 3726,323f);
				Function_79(3, &uLocal_240, -3191,546f, 40,401f, 3775,018f);
				Function_81(3, &uLocal_240, Local_12.f_872);
				Function_80(3, &uLocal_240, Local_4);
				Function_77(4, &uLocal_240, -3186,631f, 42,496f, 3726,175f);
				Function_85(4, &uLocal_240, -3147,338f, 43,172f, 3731,099f);
				Function_84(4, &uLocal_240, -3196,765f, 41,298f, 3745,842f);
				Function_83(4, &uLocal_240, -3147,338f, 43,172f, 3731,099f);
				Function_79(4, &uLocal_240, -3196,765f, 41,298f, 3745,842f);
				Function_78(4, &uLocal_240, -3217,51f, 40,193f, 3749,765f);
				Function_80(4, &uLocal_240, Local_4);
				Function_77(5, &uLocal_240, -3195,162f, 41,378f, 3739,869f);
				Function_85(5, &uLocal_240, -3092,851f, 61,055f, 3755,599f);
				Function_84(5, &uLocal_240, -3196,765f, 41,298f, 3745,842f);
				Function_83(5, &uLocal_240, -3092,851f, 61,055f, 3755,599f);
				Function_79(5, &uLocal_240, -3217,51f, 40,193f, 3749,765f);
				Function_78(5, &uLocal_240, -3196,765f, 41,298f, 3745,842f);
				Function_80(5, &uLocal_240, Local_4);
				Function_76(StackVal, GET_OBJECT_FROM_PERS_CHAR(&Local_12 + 888));
				Function_72(&Global_6654, &Global_7716, &uLocal_240, Global_6289, iScriptParam_0);
				if (Function_88(&(Global_29008[iScriptParam_0]), 256) || !Function_71(2))
				{
					iLocal_410 = 1;
				}
				if (Global_3380)
				...
				Function_65(14, Local_12.f_868, Local_12.f_832, Local_12.f_860, 0, 0, Local_4.f_28);
				...
				{
					Function_64(&(Global_29008[iScriptParam_0]), 131072);
					iLocal_237 = 10;
				}
				else
				{
			...
			case 0x00000007:
				Function_50(&Global_62527, 4, Global_30679[0], "$/content/Frontier/Mini_Games/ArmWrestling_PLN/ArmWrestling_PLN", 4294967295, 0, "PLNArmWrestling", 351, -3143,472f, 43,179f, 3720,854f, 2,5f, 0, 0);
				Function_49(&Global_62527, 4, 1);
				Function_48(&Global_62527, 4);
				iLocal_237 = 8;
				bLocal_238 = false;
				break;
			
			case 0x00000008:
				if (Function_43(iScriptParam_0, &Global_6654, iLocal_410))
				{
					Function_39(StackVal, 0, 0,1f, 4, Local_4, 1);
					Function_35(2, 4294967295, 4294967295, 0, 3);
					Function_32(Local_4);
				}
				else
				{
					Function_39(StackVal, 1, 0,5f, 4, Local_4, 1);
					Function_31(64);
			...
			case 0x00000009:
				Function_29(Local_4, iScriptParam_0);
			...
			case 0x0000000A:
				...
				{
					if (Function_24(&(Global_30679[0])))
					{
						Function_23(&Global_62981, 16);
					}
				}
				Function_20(&Local_361);
				if (Function_88(&(Global_29008[iScriptParam_0]), 131072))
				{
					iLocal_237 = 6;
				}
	...
	Function_31(64);
	Function_64(&(Global_29008[iScriptParam_0]), 32);
	Function_64(&(Global_29008[iScriptParam_0]), 64);
	Function_64(&(Global_29008[iScriptParam_0]), 8);
	Function_64(&(Global_29008[iScriptParam_0]), 512);
	Function_64(&(Global_29008[iScriptParam_0]), 4);
...
void Function_11(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0xE15 / 3605
{
	...
	if (Function_88(&(Global_29008[iParam2]), 0x40000000))
	{
		...
		Function_64(&(Global_29008[iParam2]), 0x40000000);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= *uParam0)
	...
	bVar1 = true;
	if (!Function_71(2) || Function_88(&(Global_29008[iParam2]), 256))
	{
		bVar1 = false;
	}
	iVar0 = 0;
	...
	if (bVar1)
	{
		...
		{
			Function_92(&(Global_29008[iParam2]), 2048);
		}
	}
}

void Function_12(var uParam0, var uParam1, int iParam2, bool bParam3) //Position: 0x1000 / 4096
{
...
int Function_13(int iParam0) //Position: 0x114F / 4431
{
	switch (iParam0)
	{
		case 0x00000003:
...
int Function_14(int iParam0) //Position: 0x117A / 4474
{
	switch (iParam0)
	{
		case 0x00000003:
...
void Function_15(var uParam0, int iParam1) //Position: 0x11AE / 4526
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

void Function_16(var uParam0, int iParam1) //Position: 0x11BD / 4541
{
	int iVar0;
...
bool Function_17(var uParam0, int iParam1) //Position: 0x11D4 / 4564
{
	int iVar0;
...
var Function_18(int iParam0) //Position: 0x11F0 / 4592
{
	if (!Function_4(iParam0))
	{
		return "";
...
bool Function_19() //Position: 0x169E / 5790
{
	return NET_IS_MANAGER_INITIALIZED();
}

void Function_20(int iParam0) //Position: 0x16A7 / 5799
{
	bool bVar0;
	int iVar1;
...
void Function_21(var uParam0, bool bParam1) //Position: 0x1E37 / 7735
{
	*uParam0 = (*uParam0 - (*uParam0 && bParam1));
	return;
}

void Function_22(vector3 vParam0) //Position: 0x1E4A / 7754
{
...
void Function_23(var uParam0, int iParam1) //Position: 0x1E71 / 7793
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_24(int iParam0) //Position: 0x1E80 / 7808
{
	bool bVar0;
...
vector3 Function_25(int iParam0) //Position: 0x1F7B / 8059
{
	if (iParam0 == Global_30693[2])
	{
...
vector3 Function_26(int iParam0) //Position: 0x202A / 8234
{
	if (iParam0 == Global_30693[2])
	{
...
bool Function_27(bool bParam0, int iParam1) //Position: 0x20D5 / 8405
{
	return (bParam0 && iParam1) == 0;
}

void Function_28(bool bParam0, float fParam1) //Position: 0x20E2 / 8418
{
	if (!Function_71(128))
	{
		return;
...
void Function_29(bool bParam0, bool bParam1) //Position: 0x2120 / 8480
{
	char[] cVar0[4];
...
void Function_30(var uParam0, int iParam1) //Position: 0x221A / 8730
{
...
void Function_32(bool bParam0) //Position: 0x223A / 8762
{
	vector3 vVar0;
...
void Function_33(var uParam0) //Position: 0x2325 / 8997
{
	int iVar0;
...
var Function_34() //Position: 0x2342 / 9026
{
	int iVar0;
...
void Function_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) //Position: 0x234A / 9034
{
...
void Function_36() //Position: 0x242E / 9262
{
	int iVar0;
...
int Function_37(int iParam0) //Position: 0x247C / 9340
{
...
bool Function_38(bool bParam0) //Position: 0x2494 / 9364
{
...
void Function_39(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5) //Position: 0x24A9 / 9385
{
	bool bVar0;
...
void Function_40(int iParam0) //Position: 0x25BC / 9660
{
	Function_41(&Global_28842, iParam0);
	return;
}

void Function_41(var uParam0, var uParam1) //Position: 0x25CA / 9674
{
...
void Function_42() //Position: 0x25E5 / 9701
{
...
bool Function_43(int iParam0, var uParam1, bool bParam2) //Position: 0x2601 / 9729
{
	char* cVar0[64];
	struct<5> Var16;
	...
	*uParam1[02] = { StackVal, *uParam1[02] };
	...
	if (iParam0 != Global_30717[1] && Function_44(49, 0))
	{
		return 0;
	}
	if (bParam2)
...
int Function_44(var uParam0, bool bParam1) //Position: 0x26C1 / 9921
{
	int iVar0;
...
bool Function_45(int iParam0) //Position: 0x26FE / 9982
{
...
var Function_46(int iParam0) //Position: 0x2715 / 10005
{
...
void Function_48(var uParam0, int iParam1) //Position: 0x2745 / 10053
{
	uParam0[iParam140]->f_128 |= 2097152;
	return;
}

void Function_49(var uParam0, int iParam1, float fParam2) //Position: 0x2760 / 10080
{
...
void Function_50(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, char* cParam6, int iParam7, vector3 vParam8, int iParam11, bool bParam12, int iParam13) //Position: 0x2784 / 10116
{
	...
	uParam0[iParam140]->f_4 = Function_59(iParam2, iParam1, 4);
	...
	*(uParam0[iParam140] + 52) = { StackVal, StackVal, vParam8 };
	...
	if (Global_25974[iParam1] && Function_58(iParam1))
	{
		Function_51(StackVal, StackVal, iParam2, (1 + iParam1), vParam8, 63);
	}
	uParam0[iParam140]->f_140 = 1;
	uParam0[iParam140]->f_128 |= 8192;
}

int Function_51(int iParam0, int iParam1, vector3 vParam2, int iParam5) //Position: 0x28D0 / 10448
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Function_57(StackVal, StackVal, vParam2))
	{
		return 0;
	}
	iVar2 = Function_56(iParam1);
	iVar1 = 4294967295;
	uVar3 = Function_55(StackVal, StackVal, vParam2);
	...
	if (iVar1 != 4294967295)
	{
		...
		Global_9724[iVar1] = ADD_BLIP_FOR_COORD(&vParam2, Function_52(iParam1), 0.0f, 2, iVar2);
		if (iParam1 == 23)
		{
...
int Function_52(bool bParam0) //Position: 0x2AB3 / 10931
{
	switch (bParam0)
	{
		case 0x00000001:
...
bool Function_53(vector3 vParam0, vector3 vParam3) //Position: 0x2BEA / 11242
{
	vector3 vVar0;
...
vector3 Function_54(bool bParam0) //Position: 0x2C17 / 11287
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
var Function_55(vector3 vParam0) //Position: 0x2C6E / 11374
{
	bool bVar0;
...
int Function_56(int iParam0) //Position: 0x2CBC / 11452
{
	switch (iParam0)
	{
		case 0x00000001:
...
bool Function_57(vector3 vParam0) //Position: 0x2D74 / 11636
{
	return ((vParam0.x != 0.0f && vParam0.y != 0.0f) && vParam0.z != 0.0f);
}

int Function_58(int iParam0) //Position: 0x2D8C / 11660
{
	int iVar0;
...
int Function_59(bool bParam0, bool bParam1, bool bParam2) //Position: 0x2DAF / 11695
{
	int iVar0;
	int iVar1;
...
int Function_60(bool bParam0, bool bParam1, bool bParam2, bool bParam3) //Position: 0x2E0D / 11789
{
	var uVar0;
...
int Function_61(int iParam0) //Position: 0x2F62 / 12130
{
	int iVar0;
...
bool Function_62(int iParam0) //Position: 0x2FA0 / 12192
{
...
var Function_63(int iParam0, int iParam1, int iParam2) //Position: 0x2FB5 / 12213
{
	return ((iParam2 & 15 || SHIFT_LEFT(iParam0 & 255, 4)) || SHIFT_LEFT(iParam1 & 255, 12));
}

void Function_64(var uParam0, int iParam1) //Position: 0x2FD5 / 12245
{
	int iVar0;
...
void Function_65(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6) //Position: 0x2FEC / 12268
{
	var uVar0;
	bool bVar3[2];
	bool bVar6;
	...
	if (IS_DOOR_VALID(bParam4))
	{
		...
		{
			Function_68(bParam4, 0);
		}
		else
		{
			Function_67(bParam4, 1);
		}
	}
	if (IS_DOOR_VALID(bParam5))
	{
		if (Global_16537[iParam021].f_40 == 3)
		{
			Function_68(bParam5, 0);
		}
		else
		{
			Function_67(bParam5, 1);
		}
	}
...
var Function_66(bool bParam0, bool bParam1) //Position: 0x337F / 13183
{
	return GRINGO_QUERY_NAMED_COMPONENT_USER(bParam0, bParam1);
}

void Function_67(bool bParam0, bool bParam1) //Position: 0x338C / 13196
{
...
void Function_68(bool bParam0, bool bParam1) //Position: 0x33E0 / 13280
{
	if (!IS_DOOR_VALID(bParam0))
	{
		return;
...
bool Function_69(int iParam0) //Position: 0x3431 / 13361
{
...
int Function_70(bool bParam0, bool bParam1) //Position: 0x3447 / 13383
{
	if (!IS_OBJECT_VALID(bParam1))
	{
...
bool Function_71(int iParam0) //Position: 0x35A1 / 13729
{
	int iVar0;
...
void Function_72(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) //Position: 0x35BD / 13757
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 >= 0)
	{
		Function_64(&(Global_29008[iParam4]), 2048);
	}
...
bool Function_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) //Position: 0x366F / 13935
{
	int iVar0;
	char* cVar1[16];
	...
	if (!IS_PERS_CHAR_VALID(StackVal))
	{
		...
		PRINTNL();
		if (Function_57(StackVal, StackVal, *uParam3[iVar020]))
		{
...
int Function_74(bool bParam0, bool bParam1) //Position: 0x37DA / 14298
{
	vector3 vVar0;
	bool bVar20;
	...
	{
		if (!Function_57(StackVal, StackVal, *bParam1))
		{
			vVar0 = { StackVal, StackVal, *bParam1 };
		}
		if (!Function_57(StackVal, StackVal, *(bParam1 + 12)))
		{
			*(&vVar0 + 12) = { StackVal, StackVal, *(bParam1 + 12) };
		}
		if (!Function_57(StackVal, StackVal, *(bParam1 + 24)))
		{
			*(&vVar0 + 24) = { StackVal, StackVal, *(bParam1 + 24) };
		}
		if (!Function_57(StackVal, StackVal, *(bParam1 + 36)))
		{
			*(&vVar0 + 36) = { StackVal, StackVal, *(bParam1 + 36) };
		}
		if (!Function_57(StackVal, StackVal, *(bParam1 + 48)))
		{
			*(&vVar0 + 48) = { StackVal, StackVal, *(bParam1 + 48) };
		}
		if (!Function_57(StackVal, StackVal, *(bParam1 + 60)))
		{
...
var Function_75(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, float fParam7) //Position: 0x3916 / 14614
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
...
void Function_76(var uParam0, bool bParam1) //Position: 0x3A2F / 14895
{
	bool bVar0;
...
void Function_77(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3A77 / 14967
{
	bool bVar0;
...
void Function_78(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3ADA / 15066
{
	bool bVar0;
...
void Function_79(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3B40 / 15168
{
	bool bVar0;
...
void Function_80(int iParam0, var uParam1, bool bParam2) //Position: 0x3BA8 / 15272
{
	bool bVar0;
...
void Function_81(int iParam0, var uParam1, bool bParam2) //Position: 0x3C03 / 15363
{
	bool bVar0;
...
void Function_82(var uParam0, var uParam1, bool bParam2) //Position: 0x3C67 / 15463
{
	bool bVar0;
...
void Function_83(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3CCD / 15565
{
	bool bVar0;
...
void Function_84(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3D37 / 15671
{
	bool bVar0;
...
void Function_85(int iParam0, var uParam1, vector3 vParam2) //Position: 0x3D9C / 15772
{
	bool bVar0;
...
void Function_86(int iParam0, var uParam1, bool bParam2) //Position: 0x3E04 / 15876
{
	bool bVar0;
...
int Function_87(int iParam0) //Position: 0x3E73 / 15987
{
	if (!Function_4(iParam0))
	{
		return 1;
...
bool Function_88(var uParam0, int iParam1) //Position: 0x3E8F / 16015
{
	int iVar0;
...
bool Function_89(var uParam0, var uParam1, int iParam2) //Position: 0x3EAB / 16043
{
	int iVar0;
...
void Function_90(var uParam0, var uParam1, bool bParam2) //Position: 0x3F77 / 16247
{
	int iVar0;
	...
	if (!Function_88(&(Global_29008[bParam2]), 0x40000000))
	{
		if (_IS_TYPE_ID_VALID_BY_STRING(Function_18(bParam2), 12))
		{
			...
			Function_92(&(Global_29008[bParam2]), 0x40000000);
		}
	}
	iVar0 = 0;
	while (iVar0 <= *uParam0)
...
struct<16> Function_91(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7) //Position: 0x404F / 16463
{
	struct<4> Var0;
...
void Function_92(var uParam0, int iParam1) //Position: 0x4118 / 16664
{
	*uParam0 = (*uParam0 || iParam1);
	return;
}

bool Function_93() //Position: 0x4127 / 16679
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	Function_101(3, 3);
	bVar0 = bVar0;
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_sit_ground", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_campfire_tend", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_stand", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_play_harmonica", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_drunk_rowdydrink", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sleeping_scripted", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/player_sleep_on_ground", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_lookdistance_w_any", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/look_distance_binocs", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_hammer_wall", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/repair_kneel", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_hammerground_w_any", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_pocketwatch_e_any", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_docks", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_only", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/rand_idle_nearwall_shoulder_r", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_drunkdancing_e_any", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/pee", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/lean_table", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/smoking_stand", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/sit_ground_drink", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_yelling_mid", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_check_clipboard", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/stand_yelling_up", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/fivefingerfillet_spectate_b", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/fivefingerfillet_spectate_c", 1, 0);
	Function_99(&Local_12 + 4, "$/content/scripting/gringo/simplegringo/leaning_stand", 1, 0);
	if (!Function_94(&Local_12 + 4))
	{
		return 0;
	}
	...
	*(&Local_12 + 836 + 12) = { 0.0f, 88,186f, 0.0f };
	...
	GRINGO_ENABLE_SPAWN(GET_GRINGO_FROM_OBJECT(bVar0), 1);
	Local_12.f_888 = CREATE_OBJECTSET_IN_LAYOUT(Function_34(), Local_12, 12, 0);
...
bool Function_94(int iParam0) //Position: 0x7917 / 30999
{
	int iVar0;
	int iVar1;
...
void Function_95() //Position: 0x7C92 / 31890
{
	if (!Function_71(128))
	{
		return;
...
bool Function_96() //Position: 0x7CD2 / 31954
{
	int iVar0;
...
void Function_97(var uParam0, int iParam1) //Position: 0x7CFD / 31997
{
	uParam0->f_8 = (StackVal || iParam1);
	return;
}

void Function_98() //Position: 0x7D0E / 32014
{
	if (!Function_71(128))
	{
		return;
...
var Function_99(var uParam0, bool bParam1, int iParam2, bool bParam3) //Position: 0x7D50 / 32080
{
	int iVar0;
	bool bVar1;
...
var Function_100(var uParam0, int iParam1, int iParam2) //Position: 0x7D88 / 32136
{
	int iVar0;
...
void Function_101(int iParam0, int iParam1) //Position: 0x7E4C / 32332
{
	switch (iParam1)
	{
		case 0x00000000:
...
bool Function_102() //Position: 0x7E95 / 32405
{
	var uVar0;
...
void Function_103(bool bParam0, var uParam1) //Position: 0x7F31 / 32561
{
	if (!Function_71(128))
	{
		return;
