...
bool Function_43(int iParam0, int iParam1, int iParam2, int iParam3) //Position: 0x1FBE / 8126
{
	iParam0 = iParam0;
...
bool Function_46(bool bParam0, bool bParam1, int iParam2) //Position: 0x2134 / 8500
{
	bool bVar0;
...
void Function_48(bool bParam0, bool bParam1) //Position: 0x21EA / 8682
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void Function_52(var uParam0, bool bParam1, int iParam2) //Position: 0x2309 / 8969
{
	...
	iVar1 = 1;
	uParam0 = Function_89(uParam0);
	bVar0 = Function_49(uParam0, "OutfitEnum", &iVar1);
	if ((Function_85(bParam1, 0, 0) || IS_WEAPON_DRAWN(bParam1)) || GET_WEAPON_IN_HAND(bParam1) == 4294967295)
	{
		iLocal_3 = 0;
	}
	iVar2 = 0;
	while (iVar2 <= Global_27774)
	{
		if (iVar2 != 4294967295)
		{
			...
			{
				if (Function_84(iVar2) != 32)
				{
					DECOR_SET_BOOL(bParam1, "ItemSave", true);
				}
				Function_53(Global_27774[iVar213], 32, 0, 0, 0);
				*iParam2 = 1;
			}
		}
		iVar2++;
...
void Function_53(bool bParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4) //Position: 0x23A7 / 9127
{
	char* cVar0[32];
	char* cVar8[32];
	...
	if (!Function_81(bParam0, 2))
	{
		...
		if (!bParam2)
		{
			...
			Function_78(&cVar8, 10.0f, 1, 0, 0, 1, 0);
		}
	}
	bParam2 = bParam2;
	if (!Function_77(bParam0, bParam1))
	{
		...
		Function_71(bParam0);
		if (StackVal && !Function_69(((((!Function_70() && !Global_3380) && !Global_3392) && !Global_3384) && !bParam2), 1))
		{
			PRINT_OBJECTIVE_FORMAT(15.0f, "out_Journal_Edit", &cVar0, false, 0, 0, 0, 2, 0, 0, 0);
		}
		else if (StackVal || Function_69((((Function_70() || Global_3380) || Global_3392) || Global_3384), 1))
		{
		...
		{
			Function_63(Global_34573, 2, 1, 0);
		}
...
void Function_54(int iParam0, bool bParam1) //Position: 0x2636 / 9782
{
	bool bVar0;
...
void Function_55(int iParam0, bool bParam1) //Position: 0x269D / 9885
{
	if (iParam0 >= 16)
	{
		LOG_ERROR("STAT_SET_BIT: Attempting to use a Stat out of bounds.");
...
void Function_56() //Position: 0x26FC / 9980
{
	if (Function_83(Global_28180))
	{
...
var Function_57(int iParam0, int iParam1) //Position: 0x2777 / 10103
{
	vector3 vVar0;
	struct<9> Var3;
	int iVar15;
		...
		case 0x00000002:
			switch (iParam1)
			{
				...
				case 0x00000010:
					...
					else if ((Function_59(6, 0) && Function_58(18)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
					...
					else if ((Function_59(9, 0) && Function_58(16)) && iVar19)
					{
						bVar6 = StackVal;
						iVar19 = 0;
					}
...
int Function_58(int iParam0) //Position: 0x3368 / 13160
{
...
int Function_59(int iParam0, bool bParam1) //Position: 0x337D / 13181
{
	int iVar0;
...
bool Function_60(int iParam0) //Position: 0x33BA / 13242
{
...
var Function_61(int iParam0) //Position: 0x33D1 / 13265
{
...
bool Function_62(int iParam0) //Position: 0x33EB / 13291
{
...
void Function_63(bool bParam0, var uParam1, var uParam2, bool bParam3) //Position: 0x3401 / 13313
{
	bool bVar0;
	char* cVar1[16];
	
	if (!Function_65(bParam0, uParam1, uParam2) && !bParam3)
	{
		return;
	}
...
void Function_64(char* cParam0, int iParam1) //Position: 0x346D / 13421
{
	if (iParam1 == 1)
	{
		return;
...
bool Function_65(bool bParam0, var uParam1, int iParam2) //Position: 0x34A4 / 13476
{
	var uVar0;
	char* cVar1[16];
...
int Function_66(char* cParam0) //Position: 0x351C / 13596
{
	switch (cParam0)
	{
		case 0x00000001:
...
int Function_67(int iParam0) //Position: 0x35BD / 13757
{
	int iVar0;
	int iVar1;
...
bool Function_68(var uParam0, int iParam1) //Position: 0x35FA / 13818
{
...
bool Function_69(bool bParam0, bool bParam1) //Position: 0x360D / 13837
{
	return (bParam0 && bParam1) == 0;
}

bool Function_70() //Position: 0x361A / 13850
{
	return ((((HUD_IS_SHOWING_BIG_TEXT() || HUD_IS_SHOWING_HELP_TEXT()) || HUD_IS_SHOWING_OBJECTIVE()) || HUD_IS_SHOWING_SMALL_TEXT()) || UI_ISACTIVE("MissionFailedMenu"));
}

void Function_71(bool bParam0) //Position: 0x3647 / 13895
{
	char* cVar0[32];
	char* cVar8[32];
	struct<8> Var16;
	...
	if (!IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 0) && !IS_JOURNAL_ENTRY_IN_LIST(Global_27774[bParam013].f_48, 1))
	{
		...
		while (bVar24 <= Global_27774[bParam013].f_28)
		{
			...
			if (Function_77(bParam0, Function_75(bVar24)))
			{
...
int Function_72(int iParam0) //Position: 0x37F7 / 14327
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var Function_74(int iParam0) //Position: 0x3873 / 14451
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int Function_75(bool bParam0) //Position: 0x38C9 / 14537
{
	return SHIFT_LEFT(true, bParam0);
}

void Function_76() //Position: 0x38D5 / 14549
{
	return;
}

bool Function_77(bool bParam0, int iParam1) //Position: 0x38DB / 14555
{
	int iVar0;
...
void Function_78(bool bParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) //Position: 0x393A / 14650
{
	int iVar0;
...
void Function_79(int iParam0, int iParam1) //Position: 0x3985 / 14725
{
	if (!Function_83(iParam0))
	{
...
int Function_80(int iParam0, bool bParam1, var uParam2, var uParam3) //Position: 0x39DA / 14810
{
	int iVar0;
	int iVar1;
...
bool Function_81(int iParam0, int iParam1) //Position: 0x3BFA / 15354
{
	int iVar0;
...
bool Function_82(int iParam0) //Position: 0x3C27 / 15399
{
...
bool Function_83(int iParam0) //Position: 0x3C43 / 15427
{
...
int Function_84(int iParam0) //Position: 0x3C59 / 15449
{
	int iVar0;
	int iVar1;
...
int Function_85(bool bParam0, bool bParam1, bool bParam2) //Position: 0x3CA8 / 15528
{
...
bool Function_86() //Position: 0x3D5E / 15710
{
	return ((Global_34578 != 0 || Global_34578 != 2) || Global_34578 != 3);
}

bool Function_87(bool bParam0) //Position: 0x3D75 / 15733
{
	return IS_ACTOR_IN_HOGTIE(bParam0);
}

bool Function_88(bool bParam0) //Position: 0x3D80 / 15744
{
	return IS_ACTOR_VALID(GET_LASSO_USER(bParam0));
}

var Function_89(bool bParam0) //Position: 0x3D8E / 15758
{
	return GRINGO_GET_FIRST_NAMED_CHILD("ItemAttribs", 4, bParam0);
}

bool Function_90(int iParam0, bool bParam1) //Position: 0x3DA8 / 15784
{
	bool bVar0;
	bool bVar1;
