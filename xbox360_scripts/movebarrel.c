...
void Function_29(bool bParam0, int iParam1) //Position: 0x1D37 / 7479
{
	...
	{
		if (DECOR_GET_BOOL(bParam0, "MoveObj_AllowRun"))
		{
	...
	{
		if (DECOR_GET_BOOL(bParam0, "MSMove_Run"))
		{
			SET_ACTOR_MAX_SPEED(bParam0, 2);
		}
	}
...
void Function_62(bool bParam0) //Position: 0x25B0 / 9648
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
vector3 Function_63(vector3 vParam0) //Position: 0x286F / 10351
{
	vector3 vVar0;
...
vector3 Function_64(vector3 vParam0) //Position: 0x28CC / 10444
{
	vector3 vVar0;
...
void Function_65(int iParam0) //Position: 0x2929 / 10537
{
	iParam0 = iParam0;
	return;
}

bool Function_66(bool bParam0) //Position: 0x2933 / 10547
{
	return Function_7(bParam0, "MaintainPosture", 0);
}

void Function_67(int iParam0) //Position: 0x2951 / 10577
{
	if (!Function_14(iParam0))
	{
...
bool Function_68(var uParam0, int iParam1) //Position: 0x2966 / 10598
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	return 1;
...
bool Function_69(bool bParam0, int iParam1) //Position: 0x2975 / 10613
{
...
int Function_70(bool bParam0) //Position: 0x29A0 / 10656
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool Function_71(var uParam0, int iParam1) //Position: 0x2AA5 / 10917
{
	return (uParam0 && iParam1) == 0;
}

void Function_72(int iParam0) //Position: 0x2AB2 / 10930
{
	if (Function_71(iParam0->f_40, 16))
	{
...
void Function_73(int iParam0, bool bParam1) //Position: 0x2B25 / 11045
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void Function_74() //Position: 0x3023 / 12323
{
	bool bVar0;
...
bool Function_75(bool bParam0) //Position: 0x305A / 12378
{
	return Function_11(bParam0, "ReuseDelay", 15.0f);
}

void Function_76(var uParam0, int iParam1) //Position: 0x3077 / 12407
{
	var uVar0;
	var uVar1;
	bool bVar2;
...
void Function_77(int iParam0) //Position: 0x30AF / 12463
{
	iParam0 = iParam0;
	return;
}

bool Function_78(bool bParam0) //Position: 0x30B9 / 12473
{
	return Function_7(bParam0, "BlockBumpReactions", 0);
}

void Function_79(bool bParam0, int iParam1) //Position: 0x30DA / 12506
{
	iParam1 = iParam1;
...
void Function_80(bool bParam0, bool bParam1) //Position: 0x30F2 / 12530
{
	if (IS_ACTOR_VALID(bParam0))
	{
		if (bParam1)
...
void Function_81(bool bParam0, bool bParam1) //Position: 0x31FA / 12794
{
	LOG_OBJECT3(GRINGO_GET_MY_OBJECT_REF(), GET_TARGET_OBJECT(), bParam1, bParam0, 0, 0, 0);
	return;
}

void Function_82(int iParam0) //Position: 0x3210 / 12816
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void Function_83(var uParam0, int iParam1) //Position: 0x34C6 / 13510
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return;
...
bool Function_84(bool bParam0) //Position: 0x34D4 / 13524
{
	return Function_7(bParam0, "DrawWeapon", 0);
}

bool Function_85(bool bParam0) //Position: 0x34ED / 13549
{
	return Function_7(bParam0, "AllowWeapon", 0);
}

void Function_86(bool bParam0, int iParam1) //Position: 0x3507 / 13575
{
	bool bVar0;
	int iVar1;
...
bool Function_87(var uParam0, int iParam1) //Position: 0x353F / 13631
{
	return Function_9(uParam0, "UseName", iParam1);
}

bool Function_88(int iParam0, int iParam1) //Position: 0x3556 / 13654
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
...
bool Function_89(bool bParam0) //Position: 0x381F / 14367
{
	return Function_11(bParam0, "ActivationCone", 0.0f);
}

bool Function_90(bool bParam0, bool bParam1) //Position: 0x383C / 14396
{
	struct<5> Var0;
	float fVar5;
	float fVar6;
...
bool Function_91(int iParam0) //Position: 0x38D8 / 14552
{
	return Function_11(iParam0, "ActivationRadius", 2.0f);
}

bool Function_92(var uParam0, int iParam1) //Position: 0x38F7 / 14583
{
	iParam1 = iParam1;
	uParam0 = uParam0;
	return 1;
...
bool Function_93(int iParam0) //Position: 0x3906 / 14598
{
...
void Function_94(int iParam0) //Position: 0x3922 / 14626
{
	iParam0 = iParam0;
	return;
}

void Function_95(bool bParam0, int iParam1) //Position: 0x392C / 14636
{
	bool bVar0;
	bool bVar1;
...
void Function_96(int iParam0, int iParam1) //Position: 0x398E / 14734
{
...
void Function_97(int iParam0) //Position: 0x39A2 / 14754
{
	iParam0 = iParam0;
	return;
}

void Function_98(int iParam0) //Position: 0x39AC / 14764
{
